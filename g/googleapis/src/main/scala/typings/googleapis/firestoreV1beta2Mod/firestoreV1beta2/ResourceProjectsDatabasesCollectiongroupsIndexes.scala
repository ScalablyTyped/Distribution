...
open class ResourceProjectsDatabasesCollectiongroupsIndexes protected () extends StObject {
  ...
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleFirestoreAdminV1beta2Index] = js.native
  ...
  def get(
    params: ParamsResourceProjectsDatabasesCollectiongroupsIndexesGet,
    options: BodyResponseCallback[Readable | SchemaGoogleFirestoreAdminV1beta2Index],
    callback: BodyResponseCallback[Readable | SchemaGoogleFirestoreAdminV1beta2Index]
  ): Unit = js.native
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleFirestoreAdminV1beta2ListIndexesResponse] = js.native
  ...
  def list(
    params: ParamsResourceProjectsDatabasesCollectiongroupsIndexesList,
    options: BodyResponseCallback[Readable | SchemaGoogleFirestoreAdminV1beta2ListIndexesResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleFirestoreAdminV1beta2ListIndexesResponse]
  ): Unit = js.native
