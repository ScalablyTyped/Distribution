...
object ParamsResourceProjectsDatabasesCollectiongroupsIndexesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsDatabasesCollectiongroupsIndexesCreateOps[Self <: ParamsResourceProjectsDatabasesCollectiongroupsIndexesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleFirestoreAdminV1beta2Index): Self = this.set("requestBody", value.asInstanceOf[js.Any])
