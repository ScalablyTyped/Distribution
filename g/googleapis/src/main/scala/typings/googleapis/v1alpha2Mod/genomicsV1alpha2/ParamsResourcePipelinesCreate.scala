...
object ParamsResourcePipelinesCreate {
  ...
  @scala.inline
  implicit class ParamsResourcePipelinesCreateOps[Self <: ParamsResourcePipelinesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaPipeline): Self = this.set("requestBody", value.asInstanceOf[js.Any])
