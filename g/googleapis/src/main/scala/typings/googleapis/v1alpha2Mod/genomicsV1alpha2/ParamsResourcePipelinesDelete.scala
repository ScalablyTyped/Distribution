...
@js.native
trait ParamsResourcePipelinesDelete extends StandardParameters {
  /**
...
object ParamsResourcePipelinesDelete {
  ...
  @scala.inline
  implicit class ParamsResourcePipelinesDeleteOps[Self <: ParamsResourcePipelinesDelete] (val x: Self) extends AnyVal {
    @scala.inline
