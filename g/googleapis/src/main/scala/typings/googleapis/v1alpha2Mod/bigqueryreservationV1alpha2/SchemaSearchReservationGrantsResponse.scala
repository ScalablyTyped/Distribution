...
trait SchemaSearchReservationGrantsResponse extends StObject {
...
object SchemaSearchReservationGrantsResponse {
  
  inline def apply(): SchemaSearchReservationGrantsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSearchReservationGrantsResponse]
  }
  
  extension [Self <: SchemaSearchReservationGrantsResponse](x: Self) {
