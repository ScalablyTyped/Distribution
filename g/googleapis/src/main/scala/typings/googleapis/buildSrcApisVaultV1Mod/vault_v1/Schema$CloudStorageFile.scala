...
/**
  ...
  */
@js.native
trait Schema$CloudStorageFile extends js.Object {
  /**
...
object Schema$CloudStorageFile {
  @scala.inline
  def apply(bucketName: String = null, md5Hash: String = null, objectName: String = null, size: String = null): Schema$CloudStorageFile = {
    ...
    __obj.asInstanceOf[Schema$CloudStorageFile]
  }
}
