...
/**
  ...
  */
@js.native
trait Schema$HeldMailQuery extends js.Object {
  /**
...
object Schema$HeldMailQuery {
  @scala.inline
  def apply(endTime: String = null, startTime: String = null, terms: String = null): Schema$HeldMailQuery = {
    val __obj = js.Dynamic.literal()
    if (endTime != null) __obj.updateDynamic("endTime")(endTime.asInstanceOf[js.Any])
    if (startTime != null) __obj.updateDynamic("startTime")(startTime.asInstanceOf[js.Any])
    if (terms != null) __obj.updateDynamic("terms")(terms.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$HeldMailQuery]
  }
}
