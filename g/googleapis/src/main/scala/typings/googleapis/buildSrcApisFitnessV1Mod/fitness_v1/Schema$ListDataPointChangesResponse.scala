...
@js.native
trait Schema$ListDataPointChangesResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var deletedDataPoint: js.UndefOr[js.Array[Schema$DataPoint]] = js.native
  /**
    * Inserted data points for the user.
    */
  var insertedDataPoint: js.UndefOr[js.Array[Schema$DataPoint]] = js.native
  /**
...
object Schema$ListDataPointChangesResponse {
  @scala.inline
  def apply(
    dataSourceId: String = null,
    deletedDataPoint: js.Array[Schema$DataPoint] = null,
    insertedDataPoint: js.Array[Schema$DataPoint] = null,
    nextPageToken: String = null
  ): Schema$ListDataPointChangesResponse = {
    ...
    __obj.asInstanceOf[Schema$ListDataPointChangesResponse]
  }
}
