...
/**
  ...
  */
@js.native
trait Schema$AggregateBy extends js.Object {
  /**
...
object Schema$AggregateBy {
  @scala.inline
  def apply(dataSourceId: String = null, dataTypeName: String = null): Schema$AggregateBy = {
    ...
    __obj.asInstanceOf[Schema$AggregateBy]
  }
}
