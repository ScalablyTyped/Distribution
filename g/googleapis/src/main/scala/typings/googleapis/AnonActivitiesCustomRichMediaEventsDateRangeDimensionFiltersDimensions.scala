...
@js.native
trait AnonActivitiesCustomRichMediaEventsDateRangeDimensionFiltersDimensions extends js.Object {
...
object AnonActivitiesCustomRichMediaEventsDateRangeDimensionFiltersDimensions {
  @scala.inline
  def apply(
  ...
  ): AnonActivitiesCustomRichMediaEventsDateRangeDimensionFiltersDimensions = {
    ...
    __obj.asInstanceOf[AnonActivitiesCustomRichMediaEventsDateRangeDimensionFiltersDimensions]
  }
}
