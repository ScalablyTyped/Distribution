...
/**
  ...
  */
@js.native
trait Schema$OAuthRequirements extends js.Object {
  /**
...
object Schema$OAuthRequirements {
  @scala.inline
  def apply(canonicalScopes: String = null): Schema$OAuthRequirements = {
    val __obj = js.Dynamic.literal()
    if (canonicalScopes != null) __obj.updateDynamic("canonicalScopes")(canonicalScopes.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$OAuthRequirements]
  }
}
