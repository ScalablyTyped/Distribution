...
class Resource$Services protected () extends js.Object {
  ...
  /**
    ...
    * @return {object} Request object
    */
  def updateConnections(): GaxiosPromise[Schema$Operation] = js.native
  def updateConnections(callback: BodyResponseCallback[Schema$Operation]): Unit = js.native
  def updateConnections(params: ParamsDollarResourceDollarServicesDollarUpdateconnections): GaxiosPromise[Schema$Operation] = js.native
  def updateConnections(
    params: ParamsDollarResourceDollarServicesDollarUpdateconnections,
    callback: BodyResponseCallback[Schema$Operation]
  ): Unit = js.native
  def updateConnections(
    params: ParamsDollarResourceDollarServicesDollarUpdateconnections,
  ...
  def updateConnections(params: ParamsDollarResourceDollarServicesDollarUpdateconnections, options: MethodOptions): GaxiosPromise[Schema$Operation] = js.native
  def updateConnections(
    params: ParamsDollarResourceDollarServicesDollarUpdateconnections,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Operation]
