...
trait SchemaGoogleCloudBillingBudgetsV1Filter extends StObject {
  ...
  /**
    ...
    */
  var customPeriod: js.UndefOr[SchemaGoogleCloudBillingBudgetsV1CustomPeriod] = js.undefined
...
object SchemaGoogleCloudBillingBudgetsV1Filter {
  
  inline def apply(): SchemaGoogleCloudBillingBudgetsV1Filter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBillingBudgetsV1Filter]
  }
  
  extension [Self <: SchemaGoogleCloudBillingBudgetsV1Filter](x: Self) {
    ...
    inline def setCustomPeriod(value: SchemaGoogleCloudBillingBudgetsV1CustomPeriod): Self = StObject.set(x, "customPeriod", value.asInstanceOf[js.Any])
