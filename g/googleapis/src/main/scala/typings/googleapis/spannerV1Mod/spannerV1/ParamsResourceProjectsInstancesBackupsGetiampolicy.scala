...
trait ParamsResourceProjectsInstancesBackupsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsInstancesBackupsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsInstancesBackupsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesBackupsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsInstancesBackupsGetiampolicy](x: Self) {
