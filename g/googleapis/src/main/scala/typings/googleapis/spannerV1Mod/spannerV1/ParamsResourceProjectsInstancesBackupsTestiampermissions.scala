...
trait ParamsResourceProjectsInstancesBackupsTestiampermissions
  extends StObject
...
object ParamsResourceProjectsInstancesBackupsTestiampermissions {
  
  inline def apply(): ParamsResourceProjectsInstancesBackupsTestiampermissions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesBackupsTestiampermissions]
  }
  
  extension [Self <: ParamsResourceProjectsInstancesBackupsTestiampermissions](x: Self) {
