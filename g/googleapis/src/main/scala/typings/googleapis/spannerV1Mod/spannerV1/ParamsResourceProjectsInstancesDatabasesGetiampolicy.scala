...
object ParamsResourceProjectsInstancesDatabasesGetiampolicy {
  @scala.inline
  def apply(): ParamsResourceProjectsInstancesDatabasesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesDatabasesGetiampolicy]
  }
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesGetiampolicyOps[Self <: ParamsResourceProjectsInstancesDatabasesGetiampolicy] (val x: Self) extends AnyVal {
    @scala.inline
