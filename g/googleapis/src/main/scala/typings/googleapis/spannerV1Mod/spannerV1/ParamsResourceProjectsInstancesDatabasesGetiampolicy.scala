...
object ParamsResourceProjectsInstancesDatabasesGetiampolicy {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesGetiampolicyMutableBuilder[Self <: ParamsResourceProjectsInstancesDatabasesGetiampolicy] (val x: Self) extends AnyVal {
