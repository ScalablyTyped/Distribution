...
trait ParamsResourceProjectsInstancesDatabasesTestiampermissions
  extends StObject
...
object ParamsResourceProjectsInstancesDatabasesTestiampermissions {
  ...
  inline def apply(): ParamsResourceProjectsInstancesDatabasesTestiampermissions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesDatabasesTestiampermissions]
  }
  
  extension [Self <: ParamsResourceProjectsInstancesDatabasesTestiampermissions](x: Self) {
