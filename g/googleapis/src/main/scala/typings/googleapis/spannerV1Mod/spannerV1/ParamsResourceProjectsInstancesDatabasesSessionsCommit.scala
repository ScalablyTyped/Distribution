...
@js.native
trait ParamsResourceProjectsInstancesDatabasesSessionsCommit extends StandardParameters {
...
object ParamsResourceProjectsInstancesDatabasesSessionsCommit {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsInstancesDatabasesSessionsCommit = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesDatabasesSessionsCommit]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesSessionsCommitMutableBuilder[Self <: ParamsResourceProjectsInstancesDatabasesSessionsCommit] (val x: Self) extends AnyVal {
