...
object ParamsResourceProjectsInstancesDatabasesSessionsCommit {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesSessionsCommitOps[Self <: ParamsResourceProjectsInstancesDatabasesSessionsCommit] (val x: Self) extends AnyVal {
    @scala.inline
