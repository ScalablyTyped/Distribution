...
trait SchemaCopyBackupEncryptionConfig extends StObject {
...
object SchemaCopyBackupEncryptionConfig {
  
  inline def apply(): SchemaCopyBackupEncryptionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCopyBackupEncryptionConfig]
  }
  
  extension [Self <: SchemaCopyBackupEncryptionConfig](x: Self) {
