...
trait ParamsResourceProjectsInstancesDatabaseoperationsList
  extends StObject
...
object ParamsResourceProjectsInstancesDatabaseoperationsList {
  
  inline def apply(): ParamsResourceProjectsInstancesDatabaseoperationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesDatabaseoperationsList]
  }
  
  extension [Self <: ParamsResourceProjectsInstancesDatabaseoperationsList](x: Self) {
