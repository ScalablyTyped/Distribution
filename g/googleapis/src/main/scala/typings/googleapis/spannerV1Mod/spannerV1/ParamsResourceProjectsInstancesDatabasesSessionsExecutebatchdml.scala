...
object ParamsResourceProjectsInstancesDatabasesSessionsExecutebatchdml {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesSessionsExecutebatchdmlMutableBuilder[Self <: ParamsResourceProjectsInstancesDatabasesSessionsExecutebatchdml] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaExecuteBatchDmlRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
