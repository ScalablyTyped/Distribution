...
object ParamsResourceProjectsInstancesDatabasesSetiampolicy {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesSetiampolicyOps[Self <: ParamsResourceProjectsInstancesDatabasesSetiampolicy] (val x: Self) extends AnyVal {
