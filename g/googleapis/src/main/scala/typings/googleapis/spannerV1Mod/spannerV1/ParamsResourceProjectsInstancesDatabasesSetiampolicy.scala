...
trait ParamsResourceProjectsInstancesDatabasesSetiampolicy
  extends StObject
...
object ParamsResourceProjectsInstancesDatabasesSetiampolicy {
  ...
  inline def apply(): ParamsResourceProjectsInstancesDatabasesSetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesDatabasesSetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsInstancesDatabasesSetiampolicy](x: Self) {
