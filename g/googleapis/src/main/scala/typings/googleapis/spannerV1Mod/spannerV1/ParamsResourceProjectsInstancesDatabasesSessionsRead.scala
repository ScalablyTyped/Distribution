...
object ParamsResourceProjectsInstancesDatabasesSessionsRead {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsInstancesDatabasesSessionsRead = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesDatabasesSessionsRead]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsInstancesDatabasesSessionsReadMutableBuilder[Self <: ParamsResourceProjectsInstancesDatabasesSessionsRead] (val x: Self) extends AnyVal {
