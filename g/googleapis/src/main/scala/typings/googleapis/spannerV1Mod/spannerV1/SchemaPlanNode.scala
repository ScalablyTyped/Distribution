...
trait SchemaPlanNode extends StObject {
  ...
  /**
    ...
    */
  var executionStats: js.UndefOr[StringDictionary[Any] | Null] = js.undefined
...
object SchemaPlanNode {
  ...
  extension [Self <: SchemaPlanNode](x: Self) {
    ...
    inline def setChildLinksVarargs(value: SchemaChildLink*): Self = StObject.set(x, "childLinks", js.Array(value*))
    ...
    inline def setExecutionStats(value: StringDictionary[Any]): Self = StObject.set(x, "executionStats", value.asInstanceOf[js.Any])
