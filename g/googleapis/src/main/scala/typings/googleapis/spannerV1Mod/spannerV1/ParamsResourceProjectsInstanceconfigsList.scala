...
object ParamsResourceProjectsInstanceconfigsList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsInstanceconfigsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstanceconfigsList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsInstanceconfigsListMutableBuilder[Self <: ParamsResourceProjectsInstanceconfigsList] (val x: Self) extends AnyVal {
