...
trait SchemaQueryOptions extends StObject {
...
object SchemaQueryOptions {
  
  inline def apply(): SchemaQueryOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaQueryOptions]
  }
  
  extension [Self <: SchemaQueryOptions](x: Self) {
