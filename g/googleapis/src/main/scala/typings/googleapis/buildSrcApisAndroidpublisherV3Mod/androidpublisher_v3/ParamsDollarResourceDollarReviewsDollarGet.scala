...
@js.native
trait ParamsDollarResourceDollarReviewsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarReviewsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarReviewsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarReviewsDollarGet]
  }
}
