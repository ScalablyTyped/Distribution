...
@js.native
trait ParamsDollarResourceDollarEditsDollarTracksDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarTracksDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    track: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarTracksDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarTracksDollarGet]
  }
}
