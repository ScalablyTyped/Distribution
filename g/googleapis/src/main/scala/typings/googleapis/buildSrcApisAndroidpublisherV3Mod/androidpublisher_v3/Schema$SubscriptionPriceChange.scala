...
/**
  ...
  */
@js.native
trait Schema$SubscriptionPriceChange extends js.Object {
  /**
    * The new price the subscription will renew with if the price change is
    * accepted by the user.
    */
  var newPrice: js.UndefOr[Schema$Price] = js.native
  /**
...
object Schema$SubscriptionPriceChange {
  @scala.inline
  def apply(newPrice: Schema$Price = null, state: Int | Double = null): Schema$SubscriptionPriceChange = {
    val __obj = js.Dynamic.literal()
    if (newPrice != null) __obj.updateDynamic("newPrice")(newPrice.asInstanceOf[js.Any])
    if (state != null) __obj.updateDynamic("state")(state.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$SubscriptionPriceChange]
  }
}
