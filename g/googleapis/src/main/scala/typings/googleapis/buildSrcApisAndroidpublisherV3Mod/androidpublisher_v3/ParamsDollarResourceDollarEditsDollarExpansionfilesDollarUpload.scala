...
@js.native
trait ParamsDollarResourceDollarEditsDollarExpansionfilesDollarUpload extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarExpansionfilesDollarUpload {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarExpansionfilesDollarUpload = {
    ...
    if (expansionFileType != null) __obj.updateDynamic("expansionFileType")(expansionFileType.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarExpansionfilesDollarUpload]
  }
}
