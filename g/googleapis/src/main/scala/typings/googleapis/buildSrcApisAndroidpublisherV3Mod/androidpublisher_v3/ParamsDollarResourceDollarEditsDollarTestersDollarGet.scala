...
@js.native
trait ParamsDollarResourceDollarEditsDollarTestersDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarTestersDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    track: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarTestersDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarTestersDollarGet]
  }
}
