...
@js.native
trait ParamsDollarResourceDollarEditsDollarImagesDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarImagesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarImagesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarImagesDollarDelete]
  }
}
