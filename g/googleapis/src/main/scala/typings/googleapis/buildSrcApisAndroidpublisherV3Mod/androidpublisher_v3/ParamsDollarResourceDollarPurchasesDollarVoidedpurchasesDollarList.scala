...
@js.native
trait ParamsDollarResourceDollarPurchasesDollarVoidedpurchasesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPurchasesDollarVoidedpurchasesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    token: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarPurchasesDollarVoidedpurchasesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPurchasesDollarVoidedpurchasesDollarList]
  }
}
