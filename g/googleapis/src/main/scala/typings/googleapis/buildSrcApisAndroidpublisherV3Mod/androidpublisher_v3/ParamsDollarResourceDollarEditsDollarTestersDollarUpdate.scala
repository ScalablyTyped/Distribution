...
@js.native
trait ParamsDollarResourceDollarEditsDollarTestersDollarUpdate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Testers] = js.native
  /**
...
object ParamsDollarResourceDollarEditsDollarTestersDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$Testers = null,
    track: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarTestersDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarTestersDollarUpdate]
  }
}
