...
trait ParamsResourcePlatformsPropertiesIdeaactivitiesCreate
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleSearchIdeahubV1betaIdeaActivity] = js.undefined
}
object ParamsResourcePlatformsPropertiesIdeaactivitiesCreate {
  ...
  extension [Self <: ParamsResourcePlatformsPropertiesIdeaactivitiesCreate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleSearchIdeahubV1betaIdeaActivity): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
