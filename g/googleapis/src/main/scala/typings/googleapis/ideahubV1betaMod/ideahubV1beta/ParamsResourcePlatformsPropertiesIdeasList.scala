...
trait ParamsResourcePlatformsPropertiesIdeasList
  extends StObject
...
object ParamsResourcePlatformsPropertiesIdeasList {
  
  inline def apply(): ParamsResourcePlatformsPropertiesIdeasList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePlatformsPropertiesIdeasList]
  }
  
  extension [Self <: ParamsResourcePlatformsPropertiesIdeasList](x: Self) {
