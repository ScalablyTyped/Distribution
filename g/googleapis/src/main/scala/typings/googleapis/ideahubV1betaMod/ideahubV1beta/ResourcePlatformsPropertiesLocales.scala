...
@JSImport("googleapis/build/src/apis/ideahub/v1beta", "ideahub_v1beta.Resource$Platforms$Properties$Locales")
@js.native
open class ResourcePlatformsPropertiesLocales protected () extends StObject {
  ...
  def list(): GaxiosPromise[SchemaGoogleSearchIdeahubV1betaListAvailableLocalesResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleSearchIdeahubV1betaListAvailableLocalesResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleSearchIdeahubV1betaListAvailableLocalesResponse] = js.native
  def list(params: ParamsResourcePlatformsPropertiesLocalesList): GaxiosPromise[SchemaGoogleSearchIdeahubV1betaListAvailableLocalesResponse] = js.native
  def list(
    params: ParamsResourcePlatformsPropertiesLocalesList,
    callback: BodyResponseCallback[SchemaGoogleSearchIdeahubV1betaListAvailableLocalesResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourcePlatformsPropertiesLocalesList,
    options: BodyResponseCallback[Readable | SchemaGoogleSearchIdeahubV1betaListAvailableLocalesResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleSearchIdeahubV1betaListAvailableLocalesResponse]
  ): Unit = js.native
  def list(params: ParamsResourcePlatformsPropertiesLocalesList, options: MethodOptions): GaxiosPromise[SchemaGoogleSearchIdeahubV1betaListAvailableLocalesResponse] = js.native
  def list(
    params: ParamsResourcePlatformsPropertiesLocalesList,
