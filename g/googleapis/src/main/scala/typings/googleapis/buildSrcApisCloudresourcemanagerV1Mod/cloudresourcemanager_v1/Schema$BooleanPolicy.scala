...
/**
  ...
  */
@js.native
trait Schema$BooleanPolicy extends js.Object {
  /**
...
object Schema$BooleanPolicy {
  @scala.inline
  def apply(enforced: js.UndefOr[Boolean] = js.undefined): Schema$BooleanPolicy = {
    val __obj = js.Dynamic.literal()
    if (!js.isUndefined(enforced)) __obj.updateDynamic("enforced")(enforced.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$BooleanPolicy]
  }
}
