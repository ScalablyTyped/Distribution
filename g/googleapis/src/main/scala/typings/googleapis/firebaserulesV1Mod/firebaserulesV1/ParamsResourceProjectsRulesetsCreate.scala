...
object ParamsResourceProjectsRulesetsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsRulesetsCreateOps[Self <: ParamsResourceProjectsRulesetsCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRuleset): Self = this.set("requestBody", value.asInstanceOf[js.Any])
