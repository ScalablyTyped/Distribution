...
@js.native
open class ResourceProjectsImage protected () extends StObject {
  ...
  /**
    ...
    */
  def redact(params: ParamsResourceProjectsImageRedact, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def redact(
    params: ParamsResourceProjectsImageRedact,
