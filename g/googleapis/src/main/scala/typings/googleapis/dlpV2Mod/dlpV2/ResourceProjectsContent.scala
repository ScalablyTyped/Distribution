...
@js.native
open class ResourceProjectsContent protected () extends StObject {
  ...
  /**
    ...
    */
  def deidentify(params: ParamsResourceProjectsContentDeidentify, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def deidentify(
    params: ParamsResourceProjectsContentDeidentify,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def inspect(params: ParamsResourceProjectsContentInspect, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def inspect(
    params: ParamsResourceProjectsContentInspect,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def reidentify(params: ParamsResourceProjectsContentReidentify, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def reidentify(
    params: ParamsResourceProjectsContentReidentify,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
