...
trait ParamsResourceProjectsLocationsDeidentifytemplatesPatch
  extends StObject
...
object ParamsResourceProjectsLocationsDeidentifytemplatesPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsDeidentifytemplatesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDeidentifytemplatesPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDeidentifytemplatesPatch](x: Self) {
