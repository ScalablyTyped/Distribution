...
trait SchemaGooglePrivacyDlpV2TransformationConfig extends StObject {
  ...
  /**
    ...
    */
  var imageRedactTemplate: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var structuredDeidentifyTemplate: js.UndefOr[String | Null] = js.undefined
}
object SchemaGooglePrivacyDlpV2TransformationConfig {
  
  inline def apply(): SchemaGooglePrivacyDlpV2TransformationConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePrivacyDlpV2TransformationConfig]
  }
  
  extension [Self <: SchemaGooglePrivacyDlpV2TransformationConfig](x: Self) {
    ...
    inline def setImageRedactTemplateNull: Self = StObject.set(x, "imageRedactTemplate", null)
    ...
    inline def setStructuredDeidentifyTemplateNull: Self = StObject.set(x, "structuredDeidentifyTemplate", null)
