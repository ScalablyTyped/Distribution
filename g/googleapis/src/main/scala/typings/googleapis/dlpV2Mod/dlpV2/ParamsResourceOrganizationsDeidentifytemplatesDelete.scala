...
trait ParamsResourceOrganizationsDeidentifytemplatesDelete
  extends StObject
...
object ParamsResourceOrganizationsDeidentifytemplatesDelete {
  ...
  inline def apply(): ParamsResourceOrganizationsDeidentifytemplatesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsDeidentifytemplatesDelete]
  }
  
  extension [Self <: ParamsResourceOrganizationsDeidentifytemplatesDelete](x: Self) {
