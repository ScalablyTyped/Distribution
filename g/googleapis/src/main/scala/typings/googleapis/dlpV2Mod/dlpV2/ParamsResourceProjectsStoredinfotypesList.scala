...
object ParamsResourceProjectsStoredinfotypesList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsStoredinfotypesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsStoredinfotypesList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsStoredinfotypesListMutableBuilder[Self <: ParamsResourceProjectsStoredinfotypesList] (val x: Self) extends AnyVal {
