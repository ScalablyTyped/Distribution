...
trait ParamsResourceLocationsInfotypesList
  extends StObject
...
object ParamsResourceLocationsInfotypesList {
  
  inline def apply(): ParamsResourceLocationsInfotypesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLocationsInfotypesList]
  }
  
  extension [Self <: ParamsResourceLocationsInfotypesList](x: Self) {
