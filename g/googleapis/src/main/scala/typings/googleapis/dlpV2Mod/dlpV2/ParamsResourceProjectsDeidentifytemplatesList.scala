...
trait ParamsResourceProjectsDeidentifytemplatesList
  extends StObject
...
object ParamsResourceProjectsDeidentifytemplatesList {
  ...
  inline def apply(): ParamsResourceProjectsDeidentifytemplatesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsDeidentifytemplatesList]
  }
  
  extension [Self <: ParamsResourceProjectsDeidentifytemplatesList](x: Self) {
