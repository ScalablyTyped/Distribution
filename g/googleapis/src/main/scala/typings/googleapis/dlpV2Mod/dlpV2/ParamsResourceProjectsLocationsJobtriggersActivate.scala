...
trait ParamsResourceProjectsLocationsJobtriggersActivate
  extends StObject
...
object ParamsResourceProjectsLocationsJobtriggersActivate {
  
  inline def apply(): ParamsResourceProjectsLocationsJobtriggersActivate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsJobtriggersActivate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsJobtriggersActivate](x: Self) {
