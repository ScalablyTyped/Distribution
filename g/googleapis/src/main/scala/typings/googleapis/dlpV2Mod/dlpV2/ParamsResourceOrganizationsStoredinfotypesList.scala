...
trait ParamsResourceOrganizationsStoredinfotypesList
  extends StObject
...
object ParamsResourceOrganizationsStoredinfotypesList {
  ...
  inline def apply(): ParamsResourceOrganizationsStoredinfotypesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsStoredinfotypesList]
  }
  
  extension [Self <: ParamsResourceOrganizationsStoredinfotypesList](x: Self) {
