...
trait ParamsResourceProjectsLocationsStoredinfotypesPatch
  extends StObject
...
object ParamsResourceProjectsLocationsStoredinfotypesPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsStoredinfotypesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsStoredinfotypesPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsStoredinfotypesPatch](x: Self) {
