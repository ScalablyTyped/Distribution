...
trait SchemaGooglePrivacyDlpV2DateShiftConfig extends StObject {
  ...
  /**
    ...
    */
  var lowerBoundDays: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var upperBoundDays: js.UndefOr[Double | Null] = js.undefined
}
object SchemaGooglePrivacyDlpV2DateShiftConfig {
  ...
  extension [Self <: SchemaGooglePrivacyDlpV2DateShiftConfig](x: Self) {
    ...
    inline def setLowerBoundDaysNull: Self = StObject.set(x, "lowerBoundDays", null)
    ...
    inline def setUpperBoundDaysNull: Self = StObject.set(x, "upperBoundDays", null)
