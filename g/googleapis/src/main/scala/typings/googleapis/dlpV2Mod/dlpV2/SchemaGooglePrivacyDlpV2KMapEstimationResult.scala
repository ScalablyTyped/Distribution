...
object SchemaGooglePrivacyDlpV2KMapEstimationResult {
  ...
  extension [Self <: SchemaGooglePrivacyDlpV2KMapEstimationResult](x: Self) {
    ...
    inline def setKMapEstimationHistogramVarargs(value: SchemaGooglePrivacyDlpV2KMapEstimationHistogramBucket*): Self = StObject.set(x, "kMapEstimationHistogram", js.Array(value*))
  }
}
