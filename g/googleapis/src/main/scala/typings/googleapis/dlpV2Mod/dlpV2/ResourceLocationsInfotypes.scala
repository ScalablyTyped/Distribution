...
@JSImport("googleapis/build/src/apis/dlp/v2", "dlp_v2.Resource$Locations$Infotypes")
@js.native
open class ResourceLocationsInfotypes protected () extends StObject {
  ...
  def list(params: ParamsResourceLocationsInfotypesList): GaxiosPromise[SchemaGooglePrivacyDlpV2ListInfoTypesResponse] = js.native
  def list(
    params: ParamsResourceLocationsInfotypesList,
  ...
  def list(params: ParamsResourceLocationsInfotypesList, options: MethodOptions): GaxiosPromise[SchemaGooglePrivacyDlpV2ListInfoTypesResponse] = js.native
  def list(
    params: ParamsResourceLocationsInfotypesList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceLocationsInfotypesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceLocationsInfotypesList,
