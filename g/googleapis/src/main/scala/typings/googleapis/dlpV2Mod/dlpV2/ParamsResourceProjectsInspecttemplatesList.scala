...
@js.native
trait ParamsResourceProjectsInspecttemplatesList extends StandardParameters {
...
object ParamsResourceProjectsInspecttemplatesList {
  
  @scala.inline
  def apply(): ParamsResourceProjectsInspecttemplatesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInspecttemplatesList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsInspecttemplatesListMutableBuilder[Self <: ParamsResourceProjectsInspecttemplatesList] (val x: Self) extends AnyVal {
