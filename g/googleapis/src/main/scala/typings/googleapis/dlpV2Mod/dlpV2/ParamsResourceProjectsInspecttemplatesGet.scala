...
trait ParamsResourceProjectsInspecttemplatesGet
  extends StObject
...
object ParamsResourceProjectsInspecttemplatesGet {
  ...
  inline def apply(): ParamsResourceProjectsInspecttemplatesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInspecttemplatesGet]
  }
  
  extension [Self <: ParamsResourceProjectsInspecttemplatesGet](x: Self) {
