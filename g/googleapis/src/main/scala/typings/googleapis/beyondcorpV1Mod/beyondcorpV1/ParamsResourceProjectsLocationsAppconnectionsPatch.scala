...
trait ParamsResourceProjectsLocationsAppconnectionsPatch
  extends StObject
...
object ParamsResourceProjectsLocationsAppconnectionsPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsAppconnectionsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAppconnectionsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAppconnectionsPatch](x: Self) {
