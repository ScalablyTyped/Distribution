...
trait SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnectionGateway extends StObject {
...
object SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnectionGateway {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnectionGateway = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnectionGateway]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnectionGateway](x: Self) {
