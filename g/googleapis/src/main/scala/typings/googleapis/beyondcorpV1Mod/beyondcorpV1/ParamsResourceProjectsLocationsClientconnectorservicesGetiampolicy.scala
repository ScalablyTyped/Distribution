...
trait ParamsResourceProjectsLocationsClientconnectorservicesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsClientconnectorservicesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsClientconnectorservicesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsClientconnectorservicesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsClientconnectorservicesGetiampolicy](x: Self) {
