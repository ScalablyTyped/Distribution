...
trait SchemaClientGatewayOperationMetadata extends StObject {
...
object SchemaClientGatewayOperationMetadata {
  
  inline def apply(): SchemaClientGatewayOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaClientGatewayOperationMetadata]
  }
  
  extension [Self <: SchemaClientGatewayOperationMetadata](x: Self) {
