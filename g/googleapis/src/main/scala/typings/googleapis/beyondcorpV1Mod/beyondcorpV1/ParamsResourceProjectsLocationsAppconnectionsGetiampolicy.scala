...
trait ParamsResourceProjectsLocationsAppconnectionsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsAppconnectionsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsAppconnectionsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAppconnectionsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAppconnectionsGetiampolicy](x: Self) {
