...
trait SchemaGoogleCloudBeyondcorpAppconnectorsV1AppConnectorOperationMetadata extends StObject {
...
object SchemaGoogleCloudBeyondcorpAppconnectorsV1AppConnectorOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpAppconnectorsV1AppConnectorOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpAppconnectorsV1AppConnectorOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpAppconnectorsV1AppConnectorOperationMetadata](x: Self) {
