...
trait SchemaGoogleCloudBeyondcorpApplicationsV1alphaApplicationOperationMetadata extends StObject {
...
object SchemaGoogleCloudBeyondcorpApplicationsV1alphaApplicationOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpApplicationsV1alphaApplicationOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpApplicationsV1alphaApplicationOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpApplicationsV1alphaApplicationOperationMetadata](x: Self) {
