...
trait SchemaGoogleCloudBeyondcorpConnectionsV1alphaConnectionOperationMetadata extends StObject {
...
object SchemaGoogleCloudBeyondcorpConnectionsV1alphaConnectionOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpConnectionsV1alphaConnectionOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpConnectionsV1alphaConnectionOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpConnectionsV1alphaConnectionOperationMetadata](x: Self) {
