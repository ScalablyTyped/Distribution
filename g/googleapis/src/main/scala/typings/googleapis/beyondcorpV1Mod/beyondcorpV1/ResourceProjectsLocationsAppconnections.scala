...
@JSImport("googleapis/build/src/apis/beyondcorp/v1", "beyondcorp_v1.Resource$Projects$Locations$Appconnections")
@js.native
open class ResourceProjectsLocationsAppconnections protected () extends StObject {
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnection] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnection]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnection] = js.native
  def get(params: ParamsResourceProjectsLocationsAppconnectionsGet): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnection] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAppconnectionsGet,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnection]
  ): Unit = js.native
  def get(
    params: ParamsResourceProjectsLocationsAppconnectionsGet,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnection],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnection]
  ): Unit = js.native
  def get(params: ParamsResourceProjectsLocationsAppconnectionsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnection] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAppconnectionsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnection]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1ListAppConnectionsResponse] = js.native
  def list(
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectionsV1ListAppConnectionsResponse]
  ): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1ListAppConnectionsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsAppconnectionsList): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1ListAppConnectionsResponse] = js.native
  def list(
  ...
  def list(
    params: ParamsResourceProjectsLocationsAppconnectionsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudBeyondcorpAppconnectionsV1ListAppConnectionsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudBeyondcorpAppconnectionsV1ListAppConnectionsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsAppconnectionsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1ListAppConnectionsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAppconnectionsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectionsV1ListAppConnectionsResponse]
  ...
  def resolve(): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1ResolveAppConnectionsResponse] = js.native
  def resolve(
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectionsV1ResolveAppConnectionsResponse]
  ): Unit = js.native
  def resolve(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1ResolveAppConnectionsResponse] = js.native
  def resolve(params: ParamsResourceProjectsLocationsAppconnectionsResolve): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1ResolveAppConnectionsResponse] = js.native
  def resolve(
  ...
  def resolve(
    ...
    options: BodyResponseCallback[
      Readable | SchemaGoogleCloudBeyondcorpAppconnectionsV1ResolveAppConnectionsResponse
    ],
    callback: BodyResponseCallback[
      Readable | SchemaGoogleCloudBeyondcorpAppconnectionsV1ResolveAppConnectionsResponse
    ]
  ): Unit = js.native
  def resolve(params: ParamsResourceProjectsLocationsAppconnectionsResolve, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudBeyondcorpAppconnectionsV1ResolveAppConnectionsResponse] = js.native
  def resolve(
    params: ParamsResourceProjectsLocationsAppconnectionsResolve,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudBeyondcorpAppconnectionsV1ResolveAppConnectionsResponse]
