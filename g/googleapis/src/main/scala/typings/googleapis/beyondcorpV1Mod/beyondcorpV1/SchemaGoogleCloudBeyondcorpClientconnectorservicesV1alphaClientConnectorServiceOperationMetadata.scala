...
trait SchemaGoogleCloudBeyondcorpClientconnectorservicesV1alphaClientConnectorServiceOperationMetadata extends StObject {
...
object SchemaGoogleCloudBeyondcorpClientconnectorservicesV1alphaClientConnectorServiceOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpClientconnectorservicesV1alphaClientConnectorServiceOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpClientconnectorservicesV1alphaClientConnectorServiceOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpClientconnectorservicesV1alphaClientConnectorServiceOperationMetadata](x: Self) {
