...
trait SchemaGoogleCloudBeyondcorpConnectorsV1alphaConnectorOperationMetadata extends StObject {
...
object SchemaGoogleCloudBeyondcorpConnectorsV1alphaConnectorOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpConnectorsV1alphaConnectorOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpConnectorsV1alphaConnectorOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpConnectorsV1alphaConnectorOperationMetadata](x: Self) {
