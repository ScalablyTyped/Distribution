...
trait SchemaGoogleCloudBeyondcorpAppconnectorsV1ContainerHealthDetails extends StObject {
...
object SchemaGoogleCloudBeyondcorpAppconnectorsV1ContainerHealthDetails {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpAppconnectorsV1ContainerHealthDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpAppconnectorsV1ContainerHealthDetails]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpAppconnectorsV1ContainerHealthDetails](x: Self) {
