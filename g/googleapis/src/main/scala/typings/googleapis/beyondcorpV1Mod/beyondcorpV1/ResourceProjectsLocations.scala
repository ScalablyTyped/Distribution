...
@JSImport("googleapis/build/src/apis/beyondcorp/v1", "beyondcorp_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var appConnections: ResourceProjectsLocationsAppconnections = js.native
  
  var appConnectors: ResourceProjectsLocationsAppconnectors = js.native
  
  var appGateways: ResourceProjectsLocationsAppgateways = js.native
  
  var clientConnectorServices: ResourceProjectsLocationsClientconnectorservices = js.native
  
  var clientGateways: ResourceProjectsLocationsClientgateways = js.native
