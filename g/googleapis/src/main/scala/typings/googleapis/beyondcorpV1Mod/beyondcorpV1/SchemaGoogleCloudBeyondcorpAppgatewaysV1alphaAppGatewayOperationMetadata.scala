...
trait SchemaGoogleCloudBeyondcorpAppgatewaysV1alphaAppGatewayOperationMetadata extends StObject {
...
object SchemaGoogleCloudBeyondcorpAppgatewaysV1alphaAppGatewayOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpAppgatewaysV1alphaAppGatewayOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpAppgatewaysV1alphaAppGatewayOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpAppgatewaysV1alphaAppGatewayOperationMetadata](x: Self) {
