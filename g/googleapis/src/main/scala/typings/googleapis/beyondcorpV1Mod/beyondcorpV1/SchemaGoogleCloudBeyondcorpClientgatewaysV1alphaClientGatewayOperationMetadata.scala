...
trait SchemaGoogleCloudBeyondcorpClientgatewaysV1alphaClientGatewayOperationMetadata extends StObject {
...
object SchemaGoogleCloudBeyondcorpClientgatewaysV1alphaClientGatewayOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpClientgatewaysV1alphaClientGatewayOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpClientgatewaysV1alphaClientGatewayOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpClientgatewaysV1alphaClientGatewayOperationMetadata](x: Self) {
