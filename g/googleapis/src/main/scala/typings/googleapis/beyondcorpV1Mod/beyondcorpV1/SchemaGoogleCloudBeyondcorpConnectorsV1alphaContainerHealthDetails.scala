...
trait SchemaGoogleCloudBeyondcorpConnectorsV1alphaContainerHealthDetails extends StObject {
...
object SchemaGoogleCloudBeyondcorpConnectorsV1alphaContainerHealthDetails {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpConnectorsV1alphaContainerHealthDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpConnectorsV1alphaContainerHealthDetails]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpConnectorsV1alphaContainerHealthDetails](x: Self) {
