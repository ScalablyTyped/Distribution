...
trait SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnectionOperationMetadata extends StObject {
...
object SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnectionOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnectionOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnectionOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudBeyondcorpAppconnectionsV1AppConnectionOperationMetadata](x: Self) {
