...
/**
  ...
  */
@js.native
trait Schema$ServicePerimeter extends js.Object {
  /**
  ...
  /**
    ...
    * and boundaries.
    */
  var status: js.UndefOr[Schema$ServicePerimeterConfig] = js.native
  /**
...
object Schema$ServicePerimeter {
  @scala.inline
  def apply(
    ...
    status: Schema$ServicePerimeterConfig = null,
    title: String = null,
    ...
    __obj.asInstanceOf[Schema$ServicePerimeter]
  }
}
