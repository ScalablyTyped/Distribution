...
trait ParamsResourceProjectsLocationsLakesContentList
  extends StObject
...
object ParamsResourceProjectsLocationsLakesContentList {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesContentList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesContentList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesContentList](x: Self) {
