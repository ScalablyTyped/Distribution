...
@JSImport("googleapis/build/src/apis/dataplex/v1", "dataplex_v1.Resource$Projects$Locations$Lakes$Zones$Actions")
@js.native
open class ResourceProjectsLocationsLakesZonesActions protected () extends StObject {
  ...
  def list(params: ParamsResourceProjectsLocationsLakesZonesActionsList): GaxiosPromise[SchemaGoogleCloudDataplexV1ListActionsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsLakesZonesActionsList,
  ...
  def list(params: ParamsResourceProjectsLocationsLakesZonesActionsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDataplexV1ListActionsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsLakesZonesActionsList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceProjectsLocationsLakesZonesActionsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsLocationsLakesZonesActionsList,
