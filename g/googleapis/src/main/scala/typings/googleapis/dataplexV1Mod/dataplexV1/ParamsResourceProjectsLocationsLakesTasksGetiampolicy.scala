...
trait ParamsResourceProjectsLocationsLakesTasksGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsLakesTasksGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesTasksGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesTasksGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesTasksGetiampolicy](x: Self) {
