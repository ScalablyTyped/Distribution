...
trait ParamsResourceProjectsLocationsLakesEnvironmentsPatch
  extends StObject
...
object ParamsResourceProjectsLocationsLakesEnvironmentsPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesEnvironmentsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesEnvironmentsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesEnvironmentsPatch](x: Self) {
