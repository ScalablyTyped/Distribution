...
trait ParamsResourceProjectsLocationsLakesContentGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsLakesContentGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesContentGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesContentGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesContentGetiampolicy](x: Self) {
