...
trait SchemaGoogleCloudDataplexV1OperationMetadata extends StObject {
...
object SchemaGoogleCloudDataplexV1OperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDataplexV1OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDataplexV1OperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDataplexV1OperationMetadata](x: Self) {
