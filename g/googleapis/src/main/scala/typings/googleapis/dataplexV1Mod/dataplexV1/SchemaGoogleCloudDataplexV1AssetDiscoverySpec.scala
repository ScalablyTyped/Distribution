...
trait SchemaGoogleCloudDataplexV1AssetDiscoverySpec extends StObject {
  
  /**
    * Optional. Configuration for CSV data.
    */
  var csvOptions: js.UndefOr[SchemaGoogleCloudDataplexV1AssetDiscoverySpecCsvOptions] = js.undefined
  ...
  /**
    ...
    */
  var jsonOptions: js.UndefOr[SchemaGoogleCloudDataplexV1AssetDiscoverySpecJsonOptions] = js.undefined
...
object SchemaGoogleCloudDataplexV1AssetDiscoverySpec {
  
  inline def apply(): SchemaGoogleCloudDataplexV1AssetDiscoverySpec = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDataplexV1AssetDiscoverySpec]
  }
  
  extension [Self <: SchemaGoogleCloudDataplexV1AssetDiscoverySpec](x: Self) {
    
    inline def setCsvOptions(value: SchemaGoogleCloudDataplexV1AssetDiscoverySpecCsvOptions): Self = StObject.set(x, "csvOptions", value.asInstanceOf[js.Any])
    ...
    inline def setJsonOptions(value: SchemaGoogleCloudDataplexV1AssetDiscoverySpecJsonOptions): Self = StObject.set(x, "jsonOptions", value.asInstanceOf[js.Any])
