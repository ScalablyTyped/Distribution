...
trait SchemaGoogleCloudDataplexV1AssetDiscoverySpecCsvOptions extends StObject {
...
object SchemaGoogleCloudDataplexV1AssetDiscoverySpecCsvOptions {
  
  inline def apply(): SchemaGoogleCloudDataplexV1AssetDiscoverySpecCsvOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDataplexV1AssetDiscoverySpecCsvOptions]
  }
  
  extension [Self <: SchemaGoogleCloudDataplexV1AssetDiscoverySpecCsvOptions](x: Self) {
