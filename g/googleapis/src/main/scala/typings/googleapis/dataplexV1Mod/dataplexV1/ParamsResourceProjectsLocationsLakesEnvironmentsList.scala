...
trait ParamsResourceProjectsLocationsLakesEnvironmentsList
  extends StObject
...
object ParamsResourceProjectsLocationsLakesEnvironmentsList {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesEnvironmentsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesEnvironmentsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesEnvironmentsList](x: Self) {
