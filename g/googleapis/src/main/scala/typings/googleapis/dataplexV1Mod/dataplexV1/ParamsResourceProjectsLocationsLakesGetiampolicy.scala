...
trait ParamsResourceProjectsLocationsLakesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsLakesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesGetiampolicy](x: Self) {
