...
@JSImport("googleapis/build/src/apis/dataplex/v1", "dataplex_v1.Resource$Projects$Locations$Lakes$Actions")
@js.native
open class ResourceProjectsLocationsLakesActions protected () extends StObject {
  ...
  def list(params: ParamsResourceProjectsLocationsLakesActionsList): GaxiosPromise[SchemaGoogleCloudDataplexV1ListActionsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsLakesActionsList,
  ...
  def list(params: ParamsResourceProjectsLocationsLakesActionsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDataplexV1ListActionsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsLakesActionsList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceProjectsLocationsLakesActionsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsLocationsLakesActionsList,
