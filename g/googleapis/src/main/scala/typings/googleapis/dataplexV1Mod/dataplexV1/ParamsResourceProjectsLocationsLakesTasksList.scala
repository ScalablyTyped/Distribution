...
trait ParamsResourceProjectsLocationsLakesTasksList
  extends StObject
...
object ParamsResourceProjectsLocationsLakesTasksList {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesTasksList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesTasksList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesTasksList](x: Self) {
