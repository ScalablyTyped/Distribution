...
trait ParamsResourceProjectsLocationsLakesZonesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsLakesZonesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesZonesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesZonesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesZonesGetiampolicy](x: Self) {
