...
trait ParamsResourceProjectsLocationsLakesContentitemsPatch
  extends StObject
...
object ParamsResourceProjectsLocationsLakesContentitemsPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesContentitemsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesContentitemsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesContentitemsPatch](x: Self) {
