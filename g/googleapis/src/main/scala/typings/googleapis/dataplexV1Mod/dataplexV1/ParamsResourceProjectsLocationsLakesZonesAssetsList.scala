...
trait ParamsResourceProjectsLocationsLakesZonesAssetsList
  extends StObject
...
object ParamsResourceProjectsLocationsLakesZonesAssetsList {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesZonesAssetsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesZonesAssetsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesZonesAssetsList](x: Self) {
