...
trait ParamsResourceProjectsLocationsLakesZonesAssetsActionsList
  extends StObject
...
object ParamsResourceProjectsLocationsLakesZonesAssetsActionsList {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesZonesAssetsActionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesZonesAssetsActionsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesZonesAssetsActionsList](x: Self) {
