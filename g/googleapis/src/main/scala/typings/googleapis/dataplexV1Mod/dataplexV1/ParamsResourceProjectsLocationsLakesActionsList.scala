...
trait ParamsResourceProjectsLocationsLakesActionsList
  extends StObject
...
object ParamsResourceProjectsLocationsLakesActionsList {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesActionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesActionsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesActionsList](x: Self) {
