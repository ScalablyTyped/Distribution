...
trait ParamsResourceProjectsLocationsLakesTasksJobsList
  extends StObject
...
object ParamsResourceProjectsLocationsLakesTasksJobsList {
  
  inline def apply(): ParamsResourceProjectsLocationsLakesTasksJobsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsLakesTasksJobsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsLakesTasksJobsList](x: Self) {
