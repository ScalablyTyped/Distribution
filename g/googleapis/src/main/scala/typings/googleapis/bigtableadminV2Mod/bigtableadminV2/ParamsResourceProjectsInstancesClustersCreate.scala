...
object ParamsResourceProjectsInstancesClustersCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesClustersCreateMutableBuilder[Self <: ParamsResourceProjectsInstancesClustersCreate] (val x: Self) extends AnyVal {
