...
object ParamsResourceProjectsInstancesTablesDroprowrange {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsInstancesTablesDroprowrange = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesTablesDroprowrange]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsInstancesTablesDroprowrangeMutableBuilder[Self <: ParamsResourceProjectsInstancesTablesDroprowrange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaDropRowRangeRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
