...
object ParamsResourceProjectsInstancesTablesDroprowrange {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesTablesDroprowrangeOps[Self <: ParamsResourceProjectsInstancesTablesDroprowrange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaDropRowRangeRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
