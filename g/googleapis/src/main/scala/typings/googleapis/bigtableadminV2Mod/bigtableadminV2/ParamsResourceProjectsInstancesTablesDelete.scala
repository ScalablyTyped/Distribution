...
object ParamsResourceProjectsInstancesTablesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsInstancesTablesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesTablesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsInstancesTablesDeleteMutableBuilder[Self <: ParamsResourceProjectsInstancesTablesDelete] (val x: Self) extends AnyVal {
