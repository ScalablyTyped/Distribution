...
object ParamsResourceProjectsInstancesClustersUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsInstancesClustersUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInstancesClustersUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsInstancesClustersUpdateMutableBuilder[Self <: ParamsResourceProjectsInstancesClustersUpdate] (val x: Self) extends AnyVal {
