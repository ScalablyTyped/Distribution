...
object ParamsResourceProjectsInstancesPartialupdateinstance {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsInstancesPartialupdateinstanceOps[Self <: ParamsResourceProjectsInstancesPartialupdateinstance] (val x: Self) extends AnyVal {
    @scala.inline
