...
@JSImport("googleapis/build/src/apis/documentai/v1beta2", "documentai_v1beta2.Resource$Projects$Documents")
@js.native
open class ResourceProjectsDocuments protected () extends StObject {
  ...
  def batchProcess(params: ParamsResourceProjectsDocumentsBatchprocess): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def batchProcess(
    params: ParamsResourceProjectsDocumentsBatchprocess,
  ...
  def batchProcess(params: ParamsResourceProjectsDocumentsBatchprocess, options: MethodOptions): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def batchProcess(
    params: ParamsResourceProjectsDocumentsBatchprocess,
  ...
  /**
    ...
    */
  def batchProcess(params: ParamsResourceProjectsDocumentsBatchprocess, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def batchProcess(
    params: ParamsResourceProjectsDocumentsBatchprocess,
  ...
  def process(params: ParamsResourceProjectsDocumentsProcess): GaxiosPromise[SchemaGoogleCloudDocumentaiV1beta2Document] = js.native
  def process(
    params: ParamsResourceProjectsDocumentsProcess,
  ...
  def process(params: ParamsResourceProjectsDocumentsProcess, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1beta2Document] = js.native
  def process(
    params: ParamsResourceProjectsDocumentsProcess,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1beta2Document]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def process(params: ParamsResourceProjectsDocumentsProcess, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def process(
    params: ParamsResourceProjectsDocumentsProcess,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
