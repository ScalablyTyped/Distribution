...
trait SchemaGoogleCloudDocumentaiV1beta2DocumentTextChange extends StObject {
  ...
  /**
    ...
    */
  var provenance: js.UndefOr[js.Array[SchemaGoogleCloudDocumentaiV1beta2DocumentProvenance]] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1beta2DocumentTextChange {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta2DocumentTextChange = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta2DocumentTextChange]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta2DocumentTextChange](x: Self) {
    ...
    inline def setProvenance(value: js.Array[SchemaGoogleCloudDocumentaiV1beta2DocumentProvenance]): Self = StObject.set(x, "provenance", value.asInstanceOf[js.Any])
    
    inline def setProvenanceUndefined: Self = StObject.set(x, "provenance", js.undefined)
    
    inline def setProvenanceVarargs(value: SchemaGoogleCloudDocumentaiV1beta2DocumentProvenance*): Self = StObject.set(x, "provenance", js.Array(value*))
