...
trait ParamsResourceProjectsDocumentsProcess
  extends StObject
...
object ParamsResourceProjectsDocumentsProcess {
  
  inline def apply(): ParamsResourceProjectsDocumentsProcess = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsDocumentsProcess]
  }
  
  extension [Self <: ParamsResourceProjectsDocumentsProcess](x: Self) {
