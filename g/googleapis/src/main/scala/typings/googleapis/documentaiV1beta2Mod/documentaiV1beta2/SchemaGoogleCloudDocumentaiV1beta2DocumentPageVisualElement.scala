...
trait SchemaGoogleCloudDocumentaiV1beta2DocumentPageVisualElement extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta2DocumentPageVisualElement {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta2DocumentPageVisualElement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta2DocumentPageVisualElement]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta2DocumentPageVisualElement](x: Self) {
