...
trait SchemaGoogleCloudDocumentaiV1beta1DocumentPageTableTableCell extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta1DocumentPageTableTableCell {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta1DocumentPageTableTableCell = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta1DocumentPageTableTableCell]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta1DocumentPageTableTableCell](x: Self) {
