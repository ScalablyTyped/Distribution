...
trait SchemaGoogleCloudDocumentaiV1beta2DocumentEntity extends StObject {
  ...
  /**
    ...
    */
  var normalizedValue: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue] = js.undefined
  
  /**
    * Optional. Represents the provenance of this entity wrt. the location on the page where it was found.
    */
  var pageAnchor: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta2DocumentPageAnchor] = js.undefined
  
  /**
    * Optional. Entities can be nested to form a hierarchical data structure representing the content in the document.
    */
  var properties: js.UndefOr[js.Array[SchemaGoogleCloudDocumentaiV1beta2DocumentEntity]] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1beta2DocumentEntity {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta2DocumentEntity = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta2DocumentEntity]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta2DocumentEntity](x: Self) {
    ...
    inline def setNormalizedValue(value: SchemaGoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue): Self = StObject.set(x, "normalizedValue", value.asInstanceOf[js.Any])
    
    inline def setNormalizedValueUndefined: Self = StObject.set(x, "normalizedValue", js.undefined)
    
    inline def setPageAnchor(value: SchemaGoogleCloudDocumentaiV1beta2DocumentPageAnchor): Self = StObject.set(x, "pageAnchor", value.asInstanceOf[js.Any])
    
    inline def setPageAnchorUndefined: Self = StObject.set(x, "pageAnchor", js.undefined)
    
    inline def setProperties(value: js.Array[SchemaGoogleCloudDocumentaiV1beta2DocumentEntity]): Self = StObject.set(x, "properties", value.asInstanceOf[js.Any])
    
    inline def setPropertiesUndefined: Self = StObject.set(x, "properties", js.undefined)
    
    inline def setPropertiesVarargs(value: SchemaGoogleCloudDocumentaiV1beta2DocumentEntity*): Self = StObject.set(x, "properties", js.Array(value*))
