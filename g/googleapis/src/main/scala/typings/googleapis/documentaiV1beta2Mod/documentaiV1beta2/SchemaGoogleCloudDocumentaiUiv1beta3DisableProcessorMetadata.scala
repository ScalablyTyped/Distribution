...
trait SchemaGoogleCloudDocumentaiUiv1beta3DisableProcessorMetadata extends StObject {
...
object SchemaGoogleCloudDocumentaiUiv1beta3DisableProcessorMetadata {
  
  inline def apply(): SchemaGoogleCloudDocumentaiUiv1beta3DisableProcessorMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiUiv1beta3DisableProcessorMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiUiv1beta3DisableProcessorMetadata](x: Self) {
