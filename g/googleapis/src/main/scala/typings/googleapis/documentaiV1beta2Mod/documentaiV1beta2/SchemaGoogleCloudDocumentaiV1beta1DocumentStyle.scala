...
trait SchemaGoogleCloudDocumentaiV1beta1DocumentStyle extends StObject {
  ...
  /**
    * Font size.
    */
  var fontSize: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta1DocumentStyleFontSize] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1beta1DocumentStyle {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta1DocumentStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta1DocumentStyle]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta1DocumentStyle](x: Self) {
    ...
    inline def setFontSize(value: SchemaGoogleCloudDocumentaiV1beta1DocumentStyleFontSize): Self = StObject.set(x, "fontSize", value.asInstanceOf[js.Any])
