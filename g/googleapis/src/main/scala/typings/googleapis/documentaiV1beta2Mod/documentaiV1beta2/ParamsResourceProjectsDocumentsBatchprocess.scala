...
trait ParamsResourceProjectsDocumentsBatchprocess
  extends StObject
...
object ParamsResourceProjectsDocumentsBatchprocess {
  
  inline def apply(): ParamsResourceProjectsDocumentsBatchprocess = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsDocumentsBatchprocess]
  }
  
  extension [Self <: ParamsResourceProjectsDocumentsBatchprocess](x: Self) {
