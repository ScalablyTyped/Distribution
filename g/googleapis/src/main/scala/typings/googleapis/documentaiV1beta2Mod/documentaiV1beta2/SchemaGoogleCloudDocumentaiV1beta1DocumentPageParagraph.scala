...
trait SchemaGoogleCloudDocumentaiV1beta1DocumentPageParagraph extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta1DocumentPageParagraph {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta1DocumentPageParagraph = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta1DocumentPageParagraph]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta1DocumentPageParagraph](x: Self) {
