...
trait SchemaGoogleCloudDocumentaiUiv1beta3DeleteProcessorMetadata extends StObject {
...
object SchemaGoogleCloudDocumentaiUiv1beta3DeleteProcessorMetadata {
  
  inline def apply(): SchemaGoogleCloudDocumentaiUiv1beta3DeleteProcessorMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiUiv1beta3DeleteProcessorMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiUiv1beta3DeleteProcessorMetadata](x: Self) {
