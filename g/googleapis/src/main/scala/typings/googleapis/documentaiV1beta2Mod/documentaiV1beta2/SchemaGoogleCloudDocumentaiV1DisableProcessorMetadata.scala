...
trait SchemaGoogleCloudDocumentaiV1DisableProcessorMetadata extends StObject {
...
object SchemaGoogleCloudDocumentaiV1DisableProcessorMetadata {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1DisableProcessorMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1DisableProcessorMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1DisableProcessorMetadata](x: Self) {
