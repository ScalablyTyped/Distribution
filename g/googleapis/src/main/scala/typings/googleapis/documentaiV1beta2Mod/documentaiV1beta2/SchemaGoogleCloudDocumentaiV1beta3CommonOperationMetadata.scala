...
trait SchemaGoogleCloudDocumentaiV1beta3CommonOperationMetadata extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta3CommonOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3CommonOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3CommonOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3CommonOperationMetadata](x: Self) {
