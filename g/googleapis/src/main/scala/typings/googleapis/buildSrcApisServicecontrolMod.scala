...
import typings.googleapis.buildSrcApisServicecontrolV1Mod.servicecontrol_v1.Options
import typings.googleapis.buildSrcApisServicecontrolV1Mod.servicecontrol_v1.Servicecontrol
...
@js.native
object buildSrcApisServicecontrolMod extends js.Object {
  def servicecontrol(options: Options): Servicecontrol = js.native
  @JSName("servicecontrol")
  def servicecontrol_v1(version: v1): Servicecontrol = js.native
  @js.native
  object VERSIONS extends js.Object {
    @js.native
    class v1 protected () extends Servicecontrol {
