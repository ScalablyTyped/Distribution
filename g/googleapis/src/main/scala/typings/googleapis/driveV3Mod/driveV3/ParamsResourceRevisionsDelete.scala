...
object ParamsResourceRevisionsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceRevisionsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRevisionsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceRevisionsDeleteMutableBuilder[Self <: ParamsResourceRevisionsDelete] (val x: Self) extends AnyVal {
