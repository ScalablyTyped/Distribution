...
@JSImport("googleapis/build/src/apis/drive/v3", "drive_v3.Resource$Drives")
@js.native
open class ResourceDrives protected () extends StObject {
  ...
  def create(): GaxiosPromise[SchemaDrive] = js.native
  def create(callback: BodyResponseCallback[SchemaDrive]): Unit = js.native
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaDrive] = js.native
  def create(params: ParamsResourceDrivesCreate): GaxiosPromise[SchemaDrive] = js.native
  def create(params: ParamsResourceDrivesCreate, callback: BodyResponseCallback[SchemaDrive]): Unit = js.native
  def create(
    params: ParamsResourceDrivesCreate,
    options: BodyResponseCallback[Readable | SchemaDrive],
    callback: BodyResponseCallback[Readable | SchemaDrive]
  ): Unit = js.native
  def create(params: ParamsResourceDrivesCreate, options: MethodOptions): GaxiosPromise[SchemaDrive] = js.native
  def create(
    params: ParamsResourceDrivesCreate,
  ...
  /**
    ...
    */
  def create(params: ParamsResourceDrivesCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceDrivesCreate,
