...
import typings.googleapis.anon.PermissionType
import typings.googleapis.anon.Role
...
trait SchemaPermission extends StObject {
  ...
  /**
    ...
    */
  var allowFileDiscovery: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var permissionDetails: js.UndefOr[js.Array[PermissionType] | Null] = js.undefined
  ...
  /**
    ...
    */
  var teamDrivePermissionDetails: js.UndefOr[js.Array[Role] | Null] = js.undefined
...
object SchemaPermission {
  ...
  extension [Self <: SchemaPermission](x: Self) {
    ...
    inline def setAllowFileDiscoveryNull: Self = StObject.set(x, "allowFileDiscovery", null)
    ...
    inline def setPermissionDetails(value: js.Array[PermissionType]): Self = StObject.set(x, "permissionDetails", value.asInstanceOf[js.Any])
    ...
    inline def setPermissionDetailsVarargs(value: PermissionType*): Self = StObject.set(x, "permissionDetails", js.Array(value*))
    ...
    inline def setTeamDrivePermissionDetails(value: js.Array[Role]): Self = StObject.set(x, "teamDrivePermissionDetails", value.asInstanceOf[js.Any])
    ...
    inline def setTeamDrivePermissionDetailsVarargs(value: Role*): Self = StObject.set(x, "teamDrivePermissionDetails", js.Array(value*))
