...
import typings.googleapis.anon.CanAddFolderFromAnotherDrive
...
trait SchemaFile extends StObject {
  ...
  /**
    ...
    */
  var appProperties: js.UndefOr[StringDictionary[String] | Null] = js.undefined
  
  /**
    * Capabilities the current user has on this file. Each capability corresponds to a fine-grained action that a user may take.
    */
  var capabilities: js.UndefOr[CanAddFolderFromAnotherDrive | Null] = js.undefined
  
  /**
    * Additional information about the content of the file. These fields are never populated in responses.
    */
  var contentHints: js.UndefOr[IndexableText | Null] = js.undefined
  ...
  /**
    ...
    */
  var imageMediaMetadata: js.UndefOr[CameraMake | Null] = js.undefined
  ...
  /**
    ...
    */
  var labelInfo: js.UndefOr[`11` | Null] = js.undefined
  ...
  /**
    ...
    */
  var modifiedByMe: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * The last time the file was modified by the user (RFC 3339 date-time).
    */
  var modifiedByMeTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var parents: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var sharedWithMeTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var trashed: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * The time that the item was trashed (RFC 3339 date-time). Only populated for items in shared drives.
    */
  var trashedTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var viewedByMe: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * The last time the file was viewed by the user (RFC 3339 date-time).
    */
  var viewedByMeTime: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Deprecated - use copyRequiresWriterPermission instead.
    */
  var viewersCanCopyContent: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaFile {
  ...
  extension [Self <: SchemaFile](x: Self) {
    ...
    inline def setAppPropertiesNull: Self = StObject.set(x, "appProperties", null)
    ...
    inline def setContentHintsNull: Self = StObject.set(x, "contentHints", null)
    ...
    inline def setLabelInfo(value: `11`): Self = StObject.set(x, "labelInfo", value.asInstanceOf[js.Any])
    ...
    inline def setModifiedByMeNull: Self = StObject.set(x, "modifiedByMe", null)
    
    inline def setModifiedByMeTime(value: String): Self = StObject.set(x, "modifiedByMeTime", value.asInstanceOf[js.Any])
    
    inline def setModifiedByMeTimeNull: Self = StObject.set(x, "modifiedByMeTime", null)
    ...
    inline def setParentsNull: Self = StObject.set(x, "parents", null)
    ...
    inline def setSharedWithMeTimeNull: Self = StObject.set(x, "sharedWithMeTime", null)
    ...
    inline def setTrashedTimeNull: Self = StObject.set(x, "trashedTime", null)
    ...
    inline def setViewedByMeNull: Self = StObject.set(x, "viewedByMe", null)
    
    inline def setViewedByMeTime(value: String): Self = StObject.set(x, "viewedByMeTime", value.asInstanceOf[js.Any])
    
    inline def setViewedByMeTimeNull: Self = StObject.set(x, "viewedByMeTime", null)
    ...
    inline def setViewersCanCopyContentNull: Self = StObject.set(x, "viewersCanCopyContent", null)
