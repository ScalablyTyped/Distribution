...
trait ParamsResourceRepliesCreate
  extends StObject
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaReply] = js.undefined
}
object ParamsResourceRepliesCreate {
  
  inline def apply(): ParamsResourceRepliesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRepliesCreate]
  }
  
  extension [Self <: ParamsResourceRepliesCreate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaReply): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
