...
@JSImport("googleapis/build/src/apis/artifactregistry/v1beta2", "artifactregistry_v1beta2.Resource$Projects$Locations$Repositories")
@js.native
open class ResourceProjectsLocationsRepositories protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var aptArtifacts: ResourceProjectsLocationsRepositoriesAptartifacts = js.native
  ...
  var yumArtifacts: ResourceProjectsLocationsRepositoriesYumartifacts = js.native
}
