...
trait ParamsResourceProjectsLocationsRepositoriesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsRepositoriesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsRepositoriesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRepositoriesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRepositoriesGetiampolicy](x: Self) {
