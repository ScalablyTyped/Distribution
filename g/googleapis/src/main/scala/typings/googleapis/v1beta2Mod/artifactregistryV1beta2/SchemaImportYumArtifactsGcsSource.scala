...
trait SchemaImportYumArtifactsGcsSource extends StObject {
...
object SchemaImportYumArtifactsGcsSource {
  
  inline def apply(): SchemaImportYumArtifactsGcsSource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaImportYumArtifactsGcsSource]
  }
  
  extension [Self <: SchemaImportYumArtifactsGcsSource](x: Self) {
