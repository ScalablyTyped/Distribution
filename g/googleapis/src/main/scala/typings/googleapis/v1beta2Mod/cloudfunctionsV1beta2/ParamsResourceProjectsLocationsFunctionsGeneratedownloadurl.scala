...
object ParamsResourceProjectsLocationsFunctionsGeneratedownloadurl {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsFunctionsGeneratedownloadurlMutableBuilder[Self <: ParamsResourceProjectsLocationsFunctionsGeneratedownloadurl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGenerateDownloadUrlRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
