...
@js.native
trait Schema$GenerateIdentityBindingAccessTokenRequest extends js.Object {
  /**
...
object Schema$GenerateIdentityBindingAccessTokenRequest {
  @scala.inline
  def apply(jwt: String = null, scope: js.Array[String] = null): Schema$GenerateIdentityBindingAccessTokenRequest = {
    val __obj = js.Dynamic.literal()
    if (jwt != null) __obj.updateDynamic("jwt")(jwt.asInstanceOf[js.Any])
    if (scope != null) __obj.updateDynamic("scope")(scope.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GenerateIdentityBindingAccessTokenRequest]
  }
}
