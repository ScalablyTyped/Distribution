...
object ParamsResourcePartnersDevicesClaim {
  ...
  @scala.inline
  implicit class ParamsResourcePartnersDevicesClaimMutableBuilder[Self <: ParamsResourcePartnersDevicesClaim] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaClaimDeviceRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
