...
@js.native
trait ParamsResourceCustomersConfigurationsCreate extends StandardParameters {
...
object ParamsResourceCustomersConfigurationsCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceCustomersConfigurationsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomersConfigurationsCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceCustomersConfigurationsCreateMutableBuilder[Self <: ParamsResourceCustomersConfigurationsCreate] (val x: Self) extends AnyVal {
