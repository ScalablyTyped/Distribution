...
object ParamsResourcePartnersDevicesUnclaim {
  ...
  @scala.inline
  implicit class ParamsResourcePartnersDevicesUnclaimOps[Self <: ParamsResourcePartnersDevicesUnclaim] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaUnclaimDeviceRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
