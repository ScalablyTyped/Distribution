...
object ParamsResourcePartnersDevicesUpdatemetadataasync {
  ...
  @scala.inline
  implicit class ParamsResourcePartnersDevicesUpdatemetadataasyncOps[Self <: ParamsResourcePartnersDevicesUpdatemetadataasync] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaUpdateDeviceMetadataInBatchRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
