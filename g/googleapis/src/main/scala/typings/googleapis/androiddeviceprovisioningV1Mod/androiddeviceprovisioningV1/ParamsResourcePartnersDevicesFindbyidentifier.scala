...
object ParamsResourcePartnersDevicesFindbyidentifier {
  ...
  @scala.inline
  implicit class ParamsResourcePartnersDevicesFindbyidentifierOps[Self <: ParamsResourcePartnersDevicesFindbyidentifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaFindDevicesByDeviceIdentifierRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
