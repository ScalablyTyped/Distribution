...
@js.native
open class ResourcePartnersVendors protected () extends StObject {
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaListVendorsResponse] = js.native
  ...
  def list(
    params: ParamsResourcePartnersVendorsList,
    options: BodyResponseCallback[Readable | SchemaListVendorsResponse],
    callback: BodyResponseCallback[Readable | SchemaListVendorsResponse]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def list(params: ParamsResourcePartnersVendorsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourcePartnersVendorsList,
