...
object ParamsResourcePartnersDevicesMetadata {
  ...
  def apply(
    ...
    fields: String = null,
    key: String = null,
    metadataOwnerId: String = null,
    oauth_token: String = null,
    prettyPrint: js.UndefOr[Boolean] = js.undefined,
    quotaUser: String = null,
    requestBody: SchemaUpdateDeviceMetadataRequest = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourcePartnersDevicesMetadata = {
    ...
    if (metadataOwnerId != null) __obj.updateDynamic("metadataOwnerId")(metadataOwnerId.asInstanceOf[js.Any])
