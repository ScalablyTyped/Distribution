...
@JSImport("googleapis/build/src/apis/servicedirectory/v1beta1", "servicedirectory_v1beta1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var registrationPolicies: ResourceProjectsLocationsRegistrationpolicies = js.native
}
