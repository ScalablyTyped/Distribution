...
@JSImport("googleapis/build/src/apis/servicedirectory/v1beta1", "servicedirectory_v1beta1.Resource$Projects$Locations$Namespaces")
@js.native
open class ResourceProjectsLocationsNamespaces protected () extends StObject {
  ...
  var serviceWorkloads: ResourceProjectsLocationsNamespacesServiceworkloads = js.native
