...
object ParamsResourceRelyingpartySetaccountinfo {
  ...
  @scala.inline
  implicit class ParamsResourceRelyingpartySetaccountinfoOps[Self <: ParamsResourceRelyingpartySetaccountinfo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaIdentitytoolkitRelyingpartySetAccountInfoRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
