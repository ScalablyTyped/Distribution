...
object SchemaSetAccountInfoResponse {
  ...
  @scala.inline
  implicit class SchemaSetAccountInfoResponseMutableBuilder[Self <: SchemaSetAccountInfoResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProviderUserInfo(value: js.Array[FederatedId]): Self = StObject.set(x, "providerUserInfo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProviderUserInfoUndefined: Self = StObject.set(x, "providerUserInfo", js.undefined)
    
    @scala.inline
    def setProviderUserInfoVarargs(value: FederatedId*): Self = StObject.set(x, "providerUserInfo", js.Array(value :_*))
