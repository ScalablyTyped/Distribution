...
object ParamsResourceRelyingpartyVerifypassword {
  ...
  @scala.inline
  implicit class ParamsResourceRelyingpartyVerifypasswordOps[Self <: ParamsResourceRelyingpartyVerifypassword] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaIdentitytoolkitRelyingpartyVerifyPasswordRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
