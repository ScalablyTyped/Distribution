...
object ParamsResourceRelyingpartyGetoobconfirmationcode {
  ...
  @scala.inline
  implicit class ParamsResourceRelyingpartyGetoobconfirmationcodeOps[Self <: ParamsResourceRelyingpartyGetoobconfirmationcode] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaRelyingparty): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
