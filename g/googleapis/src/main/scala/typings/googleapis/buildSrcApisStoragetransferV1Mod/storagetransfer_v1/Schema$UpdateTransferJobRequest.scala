...
/**
  ...
  */
@js.native
trait Schema$UpdateTransferJobRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var transferJob: js.UndefOr[Schema$TransferJob] = js.native
  /**
...
object Schema$UpdateTransferJobRequest {
  @scala.inline
  def apply(
    projectId: String = null,
    transferJob: Schema$TransferJob = null,
    updateTransferJobFieldMask: String = null
  ): Schema$UpdateTransferJobRequest = {
    ...
    __obj.asInstanceOf[Schema$UpdateTransferJobRequest]
  }
}
