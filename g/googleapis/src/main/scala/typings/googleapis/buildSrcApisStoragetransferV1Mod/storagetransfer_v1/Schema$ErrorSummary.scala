...
/**
  ...
  */
@js.native
trait Schema$ErrorSummary extends js.Object {
  /**
    * Required.
    */
  ...
  /**
    ...
    */
  var errorLogEntries: js.UndefOr[js.Array[Schema$ErrorLogEntry]] = js.native
}

object Schema$ErrorSummary {
  @scala.inline
  def apply(
    errorCode: String = null,
    errorCount: String = null,
    errorLogEntries: js.Array[Schema$ErrorLogEntry] = null
  ): Schema$ErrorSummary = {
    ...
    __obj.asInstanceOf[Schema$ErrorSummary]
  }
}
