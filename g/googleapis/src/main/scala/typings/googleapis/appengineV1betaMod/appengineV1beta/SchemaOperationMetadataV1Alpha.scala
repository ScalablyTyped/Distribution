...
trait SchemaOperationMetadataV1Alpha extends StObject {
  ...
  var createVersionMetadata: js.UndefOr[SchemaCreateVersionMetadataV1Alpha] = js.undefined
...
object SchemaOperationMetadataV1Alpha {
  ...
  inline def apply(): SchemaOperationMetadataV1Alpha = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOperationMetadataV1Alpha]
  }
  
  extension [Self <: SchemaOperationMetadataV1Alpha](x: Self) {
    
    inline def setCreateVersionMetadata(value: SchemaCreateVersionMetadataV1Alpha): Self = StObject.set(x, "createVersionMetadata", value.asInstanceOf[js.Any])
