...
trait SchemaFeatureSettings extends StObject {
  ...
  /**
    ...
    */
  var splitHealthChecks: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * If true, use Container-Optimized OS (https://cloud.google.com/container-optimized-os/) base image for VMs, rather than a base Debian image.
    */
  var useContainerOptimizedOs: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaFeatureSettings {
  ...
  extension [Self <: SchemaFeatureSettings](x: Self) {
    ...
    inline def setSplitHealthChecksNull: Self = StObject.set(x, "splitHealthChecks", null)
    ...
    inline def setUseContainerOptimizedOsNull: Self = StObject.set(x, "useContainerOptimizedOs", null)
