...
@js.native
open class ResourceAppsOperations protected () extends StObject {
  ...
  /**
    ...
    */
  def get(params: ParamsResourceAppsOperationsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceAppsOperationsGet,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceAppsOperationsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceAppsOperationsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
