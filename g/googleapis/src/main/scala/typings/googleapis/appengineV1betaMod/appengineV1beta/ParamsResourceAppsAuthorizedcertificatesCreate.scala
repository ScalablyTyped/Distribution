...
@js.native
trait ParamsResourceAppsAuthorizedcertificatesCreate extends StandardParameters {
...
object ParamsResourceAppsAuthorizedcertificatesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceAppsAuthorizedcertificatesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAppsAuthorizedcertificatesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceAppsAuthorizedcertificatesCreateMutableBuilder[Self <: ParamsResourceAppsAuthorizedcertificatesCreate] (val x: Self) extends AnyVal {
