...
trait SchemaIdentityAwareProxy extends StObject {
  ...
  /**
    ...
    * IAP.
    */
  var oauth2ClientInfo: js.UndefOr[SchemaOAuth2ClientInfo] = js.undefined
...
object SchemaIdentityAwareProxy {
  ...
  extension [Self <: SchemaIdentityAwareProxy](x: Self) {
    ...
    inline def setOauth2ClientInfo(value: SchemaOAuth2ClientInfo): Self = StObject.set(x, "oauth2ClientInfo", value.asInstanceOf[js.Any])
