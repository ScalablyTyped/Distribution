...
trait SchemaAclFixStatus extends StObject {
  
  var fixability: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var fixableEmailAddress: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var outOfDomainWarningEmailAddress: js.UndefOr[js.Array[String] | Null] = js.undefined
}
object SchemaAclFixStatus {
  
  inline def apply(): SchemaAclFixStatus = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAclFixStatus]
  }
  
  extension [Self <: SchemaAclFixStatus](x: Self) {
    
    inline def setFixability(value: String): Self = StObject.set(x, "fixability", value.asInstanceOf[js.Any])
    
    inline def setFixabilityNull: Self = StObject.set(x, "fixability", null)
    ...
    inline def setFixableEmailAddressNull: Self = StObject.set(x, "fixableEmailAddress", null)
    ...
    inline def setOutOfDomainWarningEmailAddressNull: Self = StObject.set(x, "outOfDomainWarningEmailAddress", null)
