...
trait SchemaCircleProto extends StObject {
  
  /**
    * Circle ID is unique only relative to the owner's Gaia ID. Currently required.
    */
  var circleId: js.UndefOr[String | Null] = js.undefined
...
object SchemaCircleProto {
  
  inline def apply(): SchemaCircleProto = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCircleProto]
  }
  
  extension [Self <: SchemaCircleProto](x: Self) {
    
    inline def setCircleId(value: String): Self = StObject.set(x, "circleId", value.asInstanceOf[js.Any])
    
    inline def setCircleIdNull: Self = StObject.set(x, "circleId", null)
