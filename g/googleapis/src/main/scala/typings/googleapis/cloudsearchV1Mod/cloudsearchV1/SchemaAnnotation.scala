...
trait SchemaAnnotation extends StObject {
  ...
  var babelPlaceholderMetadata: js.UndefOr[SchemaBabelPlaceholderMetadata] = js.undefined
  
  /**
    * LINT.ThenChange(//depot/google3/java/com/google/apps/dynamite/v1/backend/action/common/SystemMessageHelper.java)
    */
  var cardCapabilityMetadata: js.UndefOr[SchemaCardCapabilityMetadata] = js.undefined
  ...
  /**
    ...
    */
  var chipRenderType: js.UndefOr[String | Null] = js.undefined
  
  var consentedAppUnfurlMetadata: js.UndefOr[SchemaConsentedAppUnfurlMetadata] = js.undefined
  
  var customEmojiMetadata: js.UndefOr[SchemaCustomEmojiMetadata] = js.undefined
  
  var dataLossPreventionMetadata: js.UndefOr[SchemaDataLossPreventionMetadata] = js.undefined
  
  /**
    * Chip annotations
    */
  var driveMetadata: js.UndefOr[SchemaDriveMetadata] = js.undefined
  
  var formatMetadata: js.UndefOr[SchemaFormatMetadata] = js.undefined
  
  var groupRetentionSettingsUpdated: js.UndefOr[SchemaGroupRetentionSettingsUpdatedMetaData] = js.undefined
  ...
  /**
    ...
    */
  var gsuiteIntegrationMetadata: js.UndefOr[SchemaGsuiteIntegrationMetadata] = js.undefined
  
  var incomingWebhookChangedMetadata: js.UndefOr[SchemaIncomingWebhookChangedMetadata] = js.undefined
  
  /**
    * LINT.ThenChange(//depot/google3/java/com/google/apps/dynamite/v1/backend/action/common/SystemMessageHelper.java)
    */
  var integrationConfigUpdated: js.UndefOr[SchemaIntegrationConfigUpdatedMetadata] = js.undefined
  ...
  /**
    ...
    */
  var membershipChanged: js.UndefOr[SchemaMembershipChangedMetadata] = js.undefined
  
  var readReceiptsSettingsMetadata: js.UndefOr[SchemaReadReceiptsSettingsUpdatedMetadata] = js.undefined
  ...
  /**
    ...
    */
  var requiredMessageFeaturesMetadata: js.UndefOr[SchemaRequiredMessageFeaturesMetadata] = js.undefined
  
  var roomUpdated: js.UndefOr[SchemaRoomUpdatedMetadata] = js.undefined
  ...
  /**
    ...
    */
  var serverInvalidated: js.UndefOr[Boolean | Null] = js.undefined
  
  var slashCommandMetadata: js.UndefOr[SchemaSlashCommandMetadata] = js.undefined
  ...
  var urlMetadata: js.UndefOr[SchemaUrlMetadata] = js.undefined
  
  /**
    * Metadata that clients can set for annotations. LINT.IfChange In-text annotations
    */
  var userMentionMetadata: js.UndefOr[SchemaUserMentionMetadata] = js.undefined
  
  var videoCallMetadata: js.UndefOr[SchemaVideoCallMetadata] = js.undefined
  
  var youtubeMetadata: js.UndefOr[SchemaYoutubeMetadata] = js.undefined
}
object SchemaAnnotation {
  ...
  extension [Self <: SchemaAnnotation](x: Self) {
    ...
    inline def setBabelPlaceholderMetadata(value: SchemaBabelPlaceholderMetadata): Self = StObject.set(x, "babelPlaceholderMetadata", value.asInstanceOf[js.Any])
    
    inline def setBabelPlaceholderMetadataUndefined: Self = StObject.set(x, "babelPlaceholderMetadata", js.undefined)
    
    inline def setCardCapabilityMetadata(value: SchemaCardCapabilityMetadata): Self = StObject.set(x, "cardCapabilityMetadata", value.asInstanceOf[js.Any])
    ...
    inline def setChipRenderTypeNull: Self = StObject.set(x, "chipRenderType", null)
    
    inline def setChipRenderTypeUndefined: Self = StObject.set(x, "chipRenderType", js.undefined)
    
    inline def setConsentedAppUnfurlMetadata(value: SchemaConsentedAppUnfurlMetadata): Self = StObject.set(x, "consentedAppUnfurlMetadata", value.asInstanceOf[js.Any])
    
    inline def setConsentedAppUnfurlMetadataUndefined: Self = StObject.set(x, "consentedAppUnfurlMetadata", js.undefined)
    
    inline def setCustomEmojiMetadata(value: SchemaCustomEmojiMetadata): Self = StObject.set(x, "customEmojiMetadata", value.asInstanceOf[js.Any])
    
    inline def setCustomEmojiMetadataUndefined: Self = StObject.set(x, "customEmojiMetadata", js.undefined)
    
    inline def setDataLossPreventionMetadata(value: SchemaDataLossPreventionMetadata): Self = StObject.set(x, "dataLossPreventionMetadata", value.asInstanceOf[js.Any])
    
    inline def setDataLossPreventionMetadataUndefined: Self = StObject.set(x, "dataLossPreventionMetadata", js.undefined)
    
    inline def setDriveMetadata(value: SchemaDriveMetadata): Self = StObject.set(x, "driveMetadata", value.asInstanceOf[js.Any])
    
    inline def setDriveMetadataUndefined: Self = StObject.set(x, "driveMetadata", js.undefined)
    
    inline def setFormatMetadata(value: SchemaFormatMetadata): Self = StObject.set(x, "formatMetadata", value.asInstanceOf[js.Any])
    
    inline def setFormatMetadataUndefined: Self = StObject.set(x, "formatMetadata", js.undefined)
    
    inline def setGroupRetentionSettingsUpdated(value: SchemaGroupRetentionSettingsUpdatedMetaData): Self = StObject.set(x, "groupRetentionSettingsUpdated", value.asInstanceOf[js.Any])
    
    inline def setGroupRetentionSettingsUpdatedUndefined: Self = StObject.set(x, "groupRetentionSettingsUpdated", js.undefined)
    
    inline def setGsuiteIntegrationMetadata(value: SchemaGsuiteIntegrationMetadata): Self = StObject.set(x, "gsuiteIntegrationMetadata", value.asInstanceOf[js.Any])
    
    inline def setGsuiteIntegrationMetadataUndefined: Self = StObject.set(x, "gsuiteIntegrationMetadata", js.undefined)
    
    inline def setIncomingWebhookChangedMetadata(value: SchemaIncomingWebhookChangedMetadata): Self = StObject.set(x, "incomingWebhookChangedMetadata", value.asInstanceOf[js.Any])
    
    inline def setIncomingWebhookChangedMetadataUndefined: Self = StObject.set(x, "incomingWebhookChangedMetadata", js.undefined)
    
    inline def setIntegrationConfigUpdated(value: SchemaIntegrationConfigUpdatedMetadata): Self = StObject.set(x, "integrationConfigUpdated", value.asInstanceOf[js.Any])
    ...
    inline def setMembershipChanged(value: SchemaMembershipChangedMetadata): Self = StObject.set(x, "membershipChanged", value.asInstanceOf[js.Any])
    
    inline def setMembershipChangedUndefined: Self = StObject.set(x, "membershipChanged", js.undefined)
    
    inline def setReadReceiptsSettingsMetadata(value: SchemaReadReceiptsSettingsUpdatedMetadata): Self = StObject.set(x, "readReceiptsSettingsMetadata", value.asInstanceOf[js.Any])
    
    inline def setReadReceiptsSettingsMetadataUndefined: Self = StObject.set(x, "readReceiptsSettingsMetadata", js.undefined)
    
    inline def setRequiredMessageFeaturesMetadata(value: SchemaRequiredMessageFeaturesMetadata): Self = StObject.set(x, "requiredMessageFeaturesMetadata", value.asInstanceOf[js.Any])
    
    inline def setRequiredMessageFeaturesMetadataUndefined: Self = StObject.set(x, "requiredMessageFeaturesMetadata", js.undefined)
    
    inline def setRoomUpdated(value: SchemaRoomUpdatedMetadata): Self = StObject.set(x, "roomUpdated", value.asInstanceOf[js.Any])
    ...
    inline def setServerInvalidatedNull: Self = StObject.set(x, "serverInvalidated", null)
    
    inline def setServerInvalidatedUndefined: Self = StObject.set(x, "serverInvalidated", js.undefined)
    
    inline def setSlashCommandMetadata(value: SchemaSlashCommandMetadata): Self = StObject.set(x, "slashCommandMetadata", value.asInstanceOf[js.Any])
    ...
    inline def setUrlMetadata(value: SchemaUrlMetadata): Self = StObject.set(x, "urlMetadata", value.asInstanceOf[js.Any])
    
    inline def setUrlMetadataUndefined: Self = StObject.set(x, "urlMetadata", js.undefined)
    
    inline def setUserMentionMetadata(value: SchemaUserMentionMetadata): Self = StObject.set(x, "userMentionMetadata", value.asInstanceOf[js.Any])
    
    inline def setUserMentionMetadataUndefined: Self = StObject.set(x, "userMentionMetadata", js.undefined)
    
    inline def setVideoCallMetadata(value: SchemaVideoCallMetadata): Self = StObject.set(x, "videoCallMetadata", value.asInstanceOf[js.Any])
    
    inline def setVideoCallMetadataUndefined: Self = StObject.set(x, "videoCallMetadata", js.undefined)
    
    inline def setYoutubeMetadata(value: SchemaYoutubeMetadata): Self = StObject.set(x, "youtubeMetadata", value.asInstanceOf[js.Any])
