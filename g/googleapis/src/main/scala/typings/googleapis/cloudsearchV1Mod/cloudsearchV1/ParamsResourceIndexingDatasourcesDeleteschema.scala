...
object ParamsResourceIndexingDatasourcesDeleteschema {
  ...
  @scala.inline
  implicit class ParamsResourceIndexingDatasourcesDeleteschemaMutableBuilder[Self <: ParamsResourceIndexingDatasourcesDeleteschema] (val x: Self) extends AnyVal {
