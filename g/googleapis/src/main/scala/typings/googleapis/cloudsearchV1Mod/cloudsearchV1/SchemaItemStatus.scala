...
object SchemaItemStatus {
  ...
  extension [Self <: SchemaItemStatus](x: Self) {
    ...
    inline def setProcessingErrorsVarargs(value: SchemaProcessingError*): Self = StObject.set(x, "processingErrors", js.Array(value*))
    ...
    inline def setRepositoryErrorsVarargs(value: SchemaRepositoryError*): Self = StObject.set(x, "repositoryErrors", js.Array(value*))
  }
}
