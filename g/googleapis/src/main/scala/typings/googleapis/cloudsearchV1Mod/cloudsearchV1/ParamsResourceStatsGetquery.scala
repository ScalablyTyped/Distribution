...
trait ParamsResourceStatsGetquery
  extends StObject
...
object ParamsResourceStatsGetquery {
  
  inline def apply(): ParamsResourceStatsGetquery = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceStatsGetquery]
  }
  
  extension [Self <: ParamsResourceStatsGetquery](x: Self) {
