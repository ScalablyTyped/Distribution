...
trait ParamsResourceStatsQuerySearchapplicationsGet
  extends StObject
...
object ParamsResourceStatsQuerySearchapplicationsGet {
  
  inline def apply(): ParamsResourceStatsQuerySearchapplicationsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceStatsQuerySearchapplicationsGet]
  }
  
  extension [Self <: ParamsResourceStatsQuerySearchapplicationsGet](x: Self) {
