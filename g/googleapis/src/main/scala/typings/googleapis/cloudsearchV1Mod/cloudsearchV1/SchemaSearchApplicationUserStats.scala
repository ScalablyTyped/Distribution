...
trait SchemaSearchApplicationUserStats extends StObject {
...
object SchemaSearchApplicationUserStats {
  
  inline def apply(): SchemaSearchApplicationUserStats = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSearchApplicationUserStats]
  }
  
  extension [Self <: SchemaSearchApplicationUserStats](x: Self) {
