...
trait SchemaAppsDynamiteSharedBorderStyle extends StObject {
...
object SchemaAppsDynamiteSharedBorderStyle {
  
  inline def apply(): SchemaAppsDynamiteSharedBorderStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAppsDynamiteSharedBorderStyle]
  }
  
  extension [Self <: SchemaAppsDynamiteSharedBorderStyle](x: Self) {
