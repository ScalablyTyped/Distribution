...
trait SchemaCustomerQueryStats extends StObject {
...
object SchemaCustomerQueryStats {
  
  inline def apply(): SchemaCustomerQueryStats = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCustomerQueryStats]
  }
  
  extension [Self <: SchemaCustomerQueryStats](x: Self) {
