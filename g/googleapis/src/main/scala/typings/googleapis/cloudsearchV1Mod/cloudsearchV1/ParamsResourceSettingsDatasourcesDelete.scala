...
trait ParamsResourceSettingsDatasourcesDelete
  extends StObject
...
object ParamsResourceSettingsDatasourcesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceSettingsDatasourcesDeleteMutableBuilder[Self <: ParamsResourceSettingsDatasourcesDelete] (val x: Self) extends AnyVal {
