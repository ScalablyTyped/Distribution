...
@js.native
open class ResourceStatsIndexDatasources protected () extends StObject {
  ...
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGetDataSourceIndexStatsResponse] = js.native
  ...
  def get(
    params: ParamsResourceStatsIndexDatasourcesGet,
    options: BodyResponseCallback[Readable | SchemaGetDataSourceIndexStatsResponse],
    callback: BodyResponseCallback[Readable | SchemaGetDataSourceIndexStatsResponse]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def get(params: ParamsResourceStatsIndexDatasourcesGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceStatsIndexDatasourcesGet,
