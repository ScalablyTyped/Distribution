...
trait SchemaRecordingEvent extends StObject {
...
object SchemaRecordingEvent {
  
  inline def apply(): SchemaRecordingEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRecordingEvent]
  }
  
  extension [Self <: SchemaRecordingEvent](x: Self) {
