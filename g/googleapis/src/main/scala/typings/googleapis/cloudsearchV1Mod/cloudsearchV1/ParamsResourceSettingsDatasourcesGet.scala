...
trait ParamsResourceSettingsDatasourcesGet
  extends StObject
...
object ParamsResourceSettingsDatasourcesGet {
  ...
  inline def apply(): ParamsResourceSettingsDatasourcesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSettingsDatasourcesGet]
  }
  
  extension [Self <: ParamsResourceSettingsDatasourcesGet](x: Self) {
