...
object ParamsResourceIndexingDatasourcesItemsPush {
  ...
  @scala.inline
  implicit class ParamsResourceIndexingDatasourcesItemsPushOps[Self <: ParamsResourceIndexingDatasourcesItemsPush] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaPushItemRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
