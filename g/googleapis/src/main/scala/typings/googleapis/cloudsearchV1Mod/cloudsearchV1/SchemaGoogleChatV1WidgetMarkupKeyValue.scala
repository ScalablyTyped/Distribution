...
trait SchemaGoogleChatV1WidgetMarkupKeyValue extends StObject {
  ...
  /**
    ...
    */
  var button: js.UndefOr[SchemaGoogleChatV1WidgetMarkupButton] = js.undefined
...
object SchemaGoogleChatV1WidgetMarkupKeyValue {
  
  inline def apply(): SchemaGoogleChatV1WidgetMarkupKeyValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleChatV1WidgetMarkupKeyValue]
  }
  
  extension [Self <: SchemaGoogleChatV1WidgetMarkupKeyValue](x: Self) {
    ...
    inline def setButton(value: SchemaGoogleChatV1WidgetMarkupButton): Self = StObject.set(x, "button", value.asInstanceOf[js.Any])
