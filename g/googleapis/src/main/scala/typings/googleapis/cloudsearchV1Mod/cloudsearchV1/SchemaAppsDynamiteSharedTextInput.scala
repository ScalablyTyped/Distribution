...
trait SchemaAppsDynamiteSharedTextInput extends StObject {
  ...
  /**
    ...
    */
  var autoCompleteAction: js.UndefOr[SchemaAppsDynamiteSharedAction] = js.undefined
  ...
  /**
    ...
    */
  var initialSuggestions: js.UndefOr[SchemaAppsDynamiteSharedSuggestions] = js.undefined
...
object SchemaAppsDynamiteSharedTextInput {
  
  inline def apply(): SchemaAppsDynamiteSharedTextInput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAppsDynamiteSharedTextInput]
  }
  
  extension [Self <: SchemaAppsDynamiteSharedTextInput](x: Self) {
    
    inline def setAutoCompleteAction(value: SchemaAppsDynamiteSharedAction): Self = StObject.set(x, "autoCompleteAction", value.asInstanceOf[js.Any])
    ...
    inline def setInitialSuggestions(value: SchemaAppsDynamiteSharedSuggestions): Self = StObject.set(x, "initialSuggestions", value.asInstanceOf[js.Any])
