...
trait ParamsResourceStatsSessionSearchapplicationsGet
  extends StObject
...
object ParamsResourceStatsSessionSearchapplicationsGet {
  
  inline def apply(): ParamsResourceStatsSessionSearchapplicationsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceStatsSessionSearchapplicationsGet]
  }
  
  extension [Self <: ParamsResourceStatsSessionSearchapplicationsGet](x: Self) {
