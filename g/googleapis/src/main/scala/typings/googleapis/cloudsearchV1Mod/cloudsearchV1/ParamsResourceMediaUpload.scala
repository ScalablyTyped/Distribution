...
trait ParamsResourceMediaUpload
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaMedia] = js.undefined
...
object ParamsResourceMediaUpload {
  ...
  extension [Self <: ParamsResourceMediaUpload](x: Self) {
    ...
    inline def setRequestBody(value: SchemaMedia): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
