...
object ParamsResourceSettingsSearchapplicationsReset {
  ...
  @scala.inline
  implicit class ParamsResourceSettingsSearchapplicationsResetOps[Self <: ParamsResourceSettingsSearchapplicationsReset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaResetSearchApplicationRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
