...
trait SchemaAppsDynamiteSharedWidget extends StObject {
  ...
  /**
    ...
    */
  var columns: js.UndefOr[SchemaAppsDynamiteSharedColumns] = js.undefined
  ...
  /**
    ...
    */
  var divider: js.UndefOr[SchemaAppsDynamiteSharedDivider] = js.undefined
  ...
  /**
    ...
    */
  var grid: js.UndefOr[SchemaAppsDynamiteSharedGrid] = js.undefined
...
object SchemaAppsDynamiteSharedWidget {
  
  inline def apply(): SchemaAppsDynamiteSharedWidget = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAppsDynamiteSharedWidget]
  }
  
  extension [Self <: SchemaAppsDynamiteSharedWidget](x: Self) {
    ...
    inline def setColumns(value: SchemaAppsDynamiteSharedColumns): Self = StObject.set(x, "columns", value.asInstanceOf[js.Any])
    ...
    inline def setDivider(value: SchemaAppsDynamiteSharedDivider): Self = StObject.set(x, "divider", value.asInstanceOf[js.Any])
    
    inline def setDividerUndefined: Self = StObject.set(x, "divider", js.undefined)
    
    inline def setGrid(value: SchemaAppsDynamiteSharedGrid): Self = StObject.set(x, "grid", value.asInstanceOf[js.Any])
