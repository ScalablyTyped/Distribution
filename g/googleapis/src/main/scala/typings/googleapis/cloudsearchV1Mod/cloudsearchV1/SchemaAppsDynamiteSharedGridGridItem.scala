...
trait SchemaAppsDynamiteSharedGridGridItem extends StObject {
  ...
  /**
    ...
    */
  var image: js.UndefOr[SchemaAppsDynamiteSharedImageComponent] = js.undefined
...
object SchemaAppsDynamiteSharedGridGridItem {
  
  inline def apply(): SchemaAppsDynamiteSharedGridGridItem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAppsDynamiteSharedGridGridItem]
  }
  
  extension [Self <: SchemaAppsDynamiteSharedGridGridItem](x: Self) {
    ...
    inline def setImage(value: SchemaAppsDynamiteSharedImageComponent): Self = StObject.set(x, "image", value.asInstanceOf[js.Any])
