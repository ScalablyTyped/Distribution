...
trait SchemaItemAcl extends StObject {
  ...
  /**
    ...
    */
  var aclInheritanceType: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var inheritAclFrom: js.UndefOr[String | Null] = js.undefined
...
object SchemaItemAcl {
  ...
  extension [Self <: SchemaItemAcl](x: Self) {
    ...
    inline def setAclInheritanceTypeNull: Self = StObject.set(x, "aclInheritanceType", null)
    ...
    inline def setDeniedReadersVarargs(value: SchemaPrincipal*): Self = StObject.set(x, "deniedReaders", js.Array(value*))
    
    inline def setInheritAclFrom(value: String): Self = StObject.set(x, "inheritAclFrom", value.asInstanceOf[js.Any])
    
    inline def setInheritAclFromNull: Self = StObject.set(x, "inheritAclFrom", null)
    ...
    inline def setOwnersVarargs(value: SchemaPrincipal*): Self = StObject.set(x, "owners", js.Array(value*))
    ...
    inline def setReadersVarargs(value: SchemaPrincipal*): Self = StObject.set(x, "readers", js.Array(value*))
  }
}
