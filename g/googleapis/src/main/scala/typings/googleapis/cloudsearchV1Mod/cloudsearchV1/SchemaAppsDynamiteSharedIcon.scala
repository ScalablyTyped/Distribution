...
trait SchemaAppsDynamiteSharedIcon extends StObject {
...
object SchemaAppsDynamiteSharedIcon {
  
  inline def apply(): SchemaAppsDynamiteSharedIcon = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAppsDynamiteSharedIcon]
  }
  
  extension [Self <: SchemaAppsDynamiteSharedIcon](x: Self) {
