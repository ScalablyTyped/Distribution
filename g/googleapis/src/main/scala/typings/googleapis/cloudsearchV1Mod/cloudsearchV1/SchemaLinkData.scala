...
trait SchemaLinkData extends StObject {
  ...
  /**
    ...
    */
  var attachment: js.UndefOr[SchemaSocialCommonAttachmentAttachment] = js.undefined
  
  /**
    * The hint to use when rendering the associated attachment. Ignored if there is no associated attachment.
    */
  var attachmentRenderHint: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var displayUrl: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var linkTarget: js.UndefOr[String | Null] = js.undefined
...
object SchemaLinkData {
  
  inline def apply(): SchemaLinkData = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaLinkData]
  }
  
  extension [Self <: SchemaLinkData](x: Self) {
    
    inline def setAttachment(value: SchemaSocialCommonAttachmentAttachment): Self = StObject.set(x, "attachment", value.asInstanceOf[js.Any])
    
    inline def setAttachmentRenderHint(value: String): Self = StObject.set(x, "attachmentRenderHint", value.asInstanceOf[js.Any])
    
    inline def setAttachmentRenderHintNull: Self = StObject.set(x, "attachmentRenderHint", null)
    ...
    inline def setDisplayUrlNull: Self = StObject.set(x, "displayUrl", null)
    ...
    inline def setLinkTargetNull: Self = StObject.set(x, "linkTarget", null)
