...
trait SchemaBabelMessageProps extends StObject {
  
  /**
    * Babel clients locally generate this ID to dedupe against the async fanout.
    */
  var clientGeneratedId: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Stores additional Babel-specific properties (such as event metadata).
    */
  var contentExtension: js.UndefOr[SchemaChatContentExtension] = js.undefined
  
  /**
    * Stores the delivery source of messages (such as phone number for SMS).
    */
  var deliveryMedium: js.UndefOr[SchemaDeliveryMedium] = js.undefined
  ...
  /**
    ...
    */
  var messageContent: js.UndefOr[SchemaChatConserverMessageContent] = js.undefined
  
  /**
    * Whether or not these message properties were backfilled by go/dinnertrain.
    */
  var wasUpdatedByBackfill: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaBabelMessageProps {
  
  inline def apply(): SchemaBabelMessageProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBabelMessageProps]
  }
  
  extension [Self <: SchemaBabelMessageProps](x: Self) {
    
    inline def setClientGeneratedId(value: String): Self = StObject.set(x, "clientGeneratedId", value.asInstanceOf[js.Any])
    
    inline def setClientGeneratedIdNull: Self = StObject.set(x, "clientGeneratedId", null)
    
    inline def setClientGeneratedIdUndefined: Self = StObject.set(x, "clientGeneratedId", js.undefined)
    
    inline def setContentExtension(value: SchemaChatContentExtension): Self = StObject.set(x, "contentExtension", value.asInstanceOf[js.Any])
    
    inline def setContentExtensionUndefined: Self = StObject.set(x, "contentExtension", js.undefined)
    
    inline def setDeliveryMedium(value: SchemaDeliveryMedium): Self = StObject.set(x, "deliveryMedium", value.asInstanceOf[js.Any])
    ...
    inline def setMessageContent(value: SchemaChatConserverMessageContent): Self = StObject.set(x, "messageContent", value.asInstanceOf[js.Any])
    ...
    inline def setWasUpdatedByBackfillNull: Self = StObject.set(x, "wasUpdatedByBackfill", null)
