...
object ParamsResourceIndexingDatasourcesUpdateschema {
  ...
  @scala.inline
  implicit class ParamsResourceIndexingDatasourcesUpdateschemaOps[Self <: ParamsResourceIndexingDatasourcesUpdateschema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaUpdateSchemaRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
