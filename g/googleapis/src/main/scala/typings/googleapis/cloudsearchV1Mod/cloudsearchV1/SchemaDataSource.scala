...
trait SchemaDataSource extends StObject {
  ...
  /**
    ...
    */
  var disableModifications: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * Disable serving any search or assist results.
    */
  var disableServing: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var indexingServiceAccounts: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var returnThumbnailUrls: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaDataSource {
  ...
  extension [Self <: SchemaDataSource](x: Self) {
    ...
    inline def setDisableModificationsNull: Self = StObject.set(x, "disableModifications", null)
    ...
    inline def setDisableServingNull: Self = StObject.set(x, "disableServing", null)
    ...
    inline def setIndexingServiceAccountsNull: Self = StObject.set(x, "indexingServiceAccounts", null)
    ...
    inline def setItemsVisibilityVarargs(value: SchemaGSuitePrincipal*): Self = StObject.set(x, "itemsVisibility", js.Array(value*))
    ...
    inline def setReturnThumbnailUrlsNull: Self = StObject.set(x, "returnThumbnailUrls", null)
