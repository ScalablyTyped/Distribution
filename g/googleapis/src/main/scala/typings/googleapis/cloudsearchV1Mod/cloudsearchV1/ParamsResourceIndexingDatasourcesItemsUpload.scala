...
object ParamsResourceIndexingDatasourcesItemsUpload {
  ...
  @scala.inline
  implicit class ParamsResourceIndexingDatasourcesItemsUploadOps[Self <: ParamsResourceIndexingDatasourcesItemsUpload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaStartUploadItemRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
