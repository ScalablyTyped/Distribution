...
trait SchemaSessionStateInfo extends StObject {
  
  /**
    * Output only. The ack info of the session.
    */
  var ackInfo: js.UndefOr[SchemaAckInfo] = js.undefined
  ...
  /**
    ...
    */
  var languageConfig: js.UndefOr[SchemaLanguageConfig] = js.undefined
  
  /**
    * Output only. The device id of the actor is set if the current state is a result of a user action, is empty otherwise.
    */
  var lastActorDeviceId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var maxEndTime: js.UndefOr[String | Null] = js.undefined
  
  /**
    * State of the session.
    */
  var sessionState: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Output only. The reason the session was transitioned to STOPPED state.
    */
  var sessionStopReason: js.UndefOr[String | Null] = js.undefined
}
object SchemaSessionStateInfo {
  
  inline def apply(): SchemaSessionStateInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSessionStateInfo]
  }
  
  extension [Self <: SchemaSessionStateInfo](x: Self) {
    
    inline def setAckInfo(value: SchemaAckInfo): Self = StObject.set(x, "ackInfo", value.asInstanceOf[js.Any])
    
    inline def setAckInfoUndefined: Self = StObject.set(x, "ackInfo", js.undefined)
    
    inline def setLanguageConfig(value: SchemaLanguageConfig): Self = StObject.set(x, "languageConfig", value.asInstanceOf[js.Any])
    ...
    inline def setLastActorDeviceIdNull: Self = StObject.set(x, "lastActorDeviceId", null)
    ...
    inline def setMaxEndTimeNull: Self = StObject.set(x, "maxEndTime", null)
    ...
    inline def setSessionStateNull: Self = StObject.set(x, "sessionState", null)
    ...
    inline def setSessionStopReasonNull: Self = StObject.set(x, "sessionStopReason", null)
