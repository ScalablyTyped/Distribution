...
trait SchemaAppsDynamiteSharedChatItemGroupInfo extends StObject {
  
  /**
    * This is needed to determine what type of group the source message came from to support click-to-source.
    */
  var attributeCheckerGroupType: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var groupReadTimeUsec: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Indicates whether the group has inline replies enabled. If enabled, clients will render the space with inline replies.
    */
  var inlineThreadingEnabled: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaAppsDynamiteSharedChatItemGroupInfo {
  
  inline def apply(): SchemaAppsDynamiteSharedChatItemGroupInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAppsDynamiteSharedChatItemGroupInfo]
  }
  
  extension [Self <: SchemaAppsDynamiteSharedChatItemGroupInfo](x: Self) {
    ...
    inline def setAttributeCheckerGroupTypeNull: Self = StObject.set(x, "attributeCheckerGroupType", null)
    ...
    inline def setGroupReadTimeUsecNull: Self = StObject.set(x, "groupReadTimeUsec", null)
    ...
    inline def setInlineThreadingEnabledNull: Self = StObject.set(x, "inlineThreadingEnabled", null)
