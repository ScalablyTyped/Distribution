...
trait SchemaMeetingSpace extends StObject {
  ...
  /**
    ...
    */
  var acceptedNumberClass: js.UndefOr[js.Array[String] | Null] = js.undefined
  
  /**
    * Broadcast access information for this meeting space.
    */
  var broadcastAccess: js.UndefOr[SchemaBroadcastAccess] = js.undefined
  ...
  /**
    ...
    */
  var callInfo: js.UndefOr[SchemaCallInfo] = js.undefined
  ...
  /**
    ...
    */
  var gatewayAccess: js.UndefOr[SchemaGatewayAccess] = js.undefined
  
  /**
    * The SIP based access methods that can be used to join the conference.
    */
  var gatewaySipAccess: js.UndefOr[js.Array[SchemaGatewaySipAccess]] = js.undefined
  ...
  /**
    ...
    */
  var meetingAlias: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var meetingSpaceId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var moreJoinUrl: js.UndefOr[String | Null] = js.undefined
  
  /**
    * All regional phone access methods for this meeting space. Can be empty.
    */
  var phoneAccess: js.UndefOr[js.Array[SchemaPhoneAccess]] = js.undefined
  ...
  /**
    ...
    */
  var universalPhoneAccess: js.UndefOr[SchemaUniversalPhoneAccess] = js.undefined
}
object SchemaMeetingSpace {
  
  inline def apply(): SchemaMeetingSpace = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaMeetingSpace]
  }
  
  extension [Self <: SchemaMeetingSpace](x: Self) {
    ...
    inline def setAcceptedNumberClassNull: Self = StObject.set(x, "acceptedNumberClass", null)
    ...
    inline def setBroadcastAccess(value: SchemaBroadcastAccess): Self = StObject.set(x, "broadcastAccess", value.asInstanceOf[js.Any])
    
    inline def setBroadcastAccessUndefined: Self = StObject.set(x, "broadcastAccess", js.undefined)
    
    inline def setCallInfo(value: SchemaCallInfo): Self = StObject.set(x, "callInfo", value.asInstanceOf[js.Any])
    
    inline def setCallInfoUndefined: Self = StObject.set(x, "callInfo", js.undefined)
    
    inline def setGatewayAccess(value: SchemaGatewayAccess): Self = StObject.set(x, "gatewayAccess", value.asInstanceOf[js.Any])
    
    inline def setGatewayAccessUndefined: Self = StObject.set(x, "gatewayAccess", js.undefined)
    
    inline def setGatewaySipAccess(value: js.Array[SchemaGatewaySipAccess]): Self = StObject.set(x, "gatewaySipAccess", value.asInstanceOf[js.Any])
    
    inline def setGatewaySipAccessUndefined: Self = StObject.set(x, "gatewaySipAccess", js.undefined)
    
    inline def setGatewaySipAccessVarargs(value: SchemaGatewaySipAccess*): Self = StObject.set(x, "gatewaySipAccess", js.Array(value*))
    
    inline def setMeetingAlias(value: String): Self = StObject.set(x, "meetingAlias", value.asInstanceOf[js.Any])
    
    inline def setMeetingAliasNull: Self = StObject.set(x, "meetingAlias", null)
    ...
    inline def setMeetingSpaceIdNull: Self = StObject.set(x, "meetingSpaceId", null)
    ...
    inline def setMoreJoinUrlNull: Self = StObject.set(x, "moreJoinUrl", null)
    
    inline def setMoreJoinUrlUndefined: Self = StObject.set(x, "moreJoinUrl", js.undefined)
    
    inline def setPhoneAccess(value: js.Array[SchemaPhoneAccess]): Self = StObject.set(x, "phoneAccess", value.asInstanceOf[js.Any])
    
    inline def setPhoneAccessUndefined: Self = StObject.set(x, "phoneAccess", js.undefined)
    
    inline def setPhoneAccessVarargs(value: SchemaPhoneAccess*): Self = StObject.set(x, "phoneAccess", js.Array(value*))
    
    inline def setSettings(value: SchemaSettings): Self = StObject.set(x, "settings", value.asInstanceOf[js.Any])
    
    inline def setSettingsUndefined: Self = StObject.set(x, "settings", js.undefined)
    
    inline def setUniversalPhoneAccess(value: SchemaUniversalPhoneAccess): Self = StObject.set(x, "universalPhoneAccess", value.asInstanceOf[js.Any])
