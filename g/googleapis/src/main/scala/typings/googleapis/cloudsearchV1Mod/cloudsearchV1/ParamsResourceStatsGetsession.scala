...
trait ParamsResourceStatsGetsession
  extends StObject
...
object ParamsResourceStatsGetsession {
  
  inline def apply(): ParamsResourceStatsGetsession = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceStatsGetsession]
  }
  
  extension [Self <: ParamsResourceStatsGetsession](x: Self) {
