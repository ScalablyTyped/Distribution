...
trait SchemaEmbedClientItem extends StObject {
  ...
  /**
    ...
    */
  var canonicalId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var deepLinkData: js.UndefOr[SchemaDeepLinkData] = js.undefined
  ...
  /**
    ...
    */
  var provenance: js.UndefOr[SchemaProvenance] = js.undefined
  ...
  /**
    ...
    */
  var renderId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var transientData: js.UndefOr[SchemaTransientData] = js.undefined
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[js.Array[String] | Null] = js.undefined
}
object SchemaEmbedClientItem {
  
  inline def apply(): SchemaEmbedClientItem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaEmbedClientItem]
  }
  
  extension [Self <: SchemaEmbedClientItem](x: Self) {
    
    inline def setCanonicalId(value: String): Self = StObject.set(x, "canonicalId", value.asInstanceOf[js.Any])
    
    inline def setCanonicalIdNull: Self = StObject.set(x, "canonicalId", null)
    
    inline def setCanonicalIdUndefined: Self = StObject.set(x, "canonicalId", js.undefined)
    
    inline def setDeepLinkData(value: SchemaDeepLinkData): Self = StObject.set(x, "deepLinkData", value.asInstanceOf[js.Any])
    ...
    inline def setProvenance(value: SchemaProvenance): Self = StObject.set(x, "provenance", value.asInstanceOf[js.Any])
    ...
    inline def setRenderIdNull: Self = StObject.set(x, "renderId", null)
    ...
    inline def setTransientData(value: SchemaTransientData): Self = StObject.set(x, "transientData", value.asInstanceOf[js.Any])
