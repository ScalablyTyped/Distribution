...
object ParamsResourceSettingsDatasourcesUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceSettingsDatasourcesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSettingsDatasourcesUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceSettingsDatasourcesUpdateMutableBuilder[Self <: ParamsResourceSettingsDatasourcesUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaUpdateDataSourceRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
