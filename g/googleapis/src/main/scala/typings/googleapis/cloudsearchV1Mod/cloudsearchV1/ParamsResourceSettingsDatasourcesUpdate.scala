...
object ParamsResourceSettingsDatasourcesUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceSettingsDatasourcesUpdateOps[Self <: ParamsResourceSettingsDatasourcesUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaUpdateDataSourceRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
