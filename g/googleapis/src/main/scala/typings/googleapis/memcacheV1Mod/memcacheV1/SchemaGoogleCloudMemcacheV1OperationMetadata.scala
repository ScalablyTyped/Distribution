...
trait SchemaGoogleCloudMemcacheV1OperationMetadata extends StObject {
...
object SchemaGoogleCloudMemcacheV1OperationMetadata {
  
  inline def apply(): SchemaGoogleCloudMemcacheV1OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudMemcacheV1OperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudMemcacheV1OperationMetadata](x: Self) {
