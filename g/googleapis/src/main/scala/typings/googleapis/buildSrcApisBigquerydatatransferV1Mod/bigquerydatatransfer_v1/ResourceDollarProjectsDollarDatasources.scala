...
@js.native
class ResourceDollarProjectsDollarDatasources protected () extends js.Object {
  ...
  def checkValidCreds(params: ParamsDollarResourceDollarProjectsDollarDatasourcesDollarCheckvalidcreds): GaxiosPromise[Schema$CheckValidCredsResponse] = js.native
  def checkValidCreds(
    params: ParamsDollarResourceDollarProjectsDollarDatasourcesDollarCheckvalidcreds,
  ...
  def get(params: ParamsDollarResourceDollarProjectsDollarDatasourcesDollarGet): GaxiosPromise[Schema$DataSource] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatasourcesDollarGet,
  ...
  def get(params: ParamsDollarResourceDollarProjectsDollarDatasourcesDollarGet, options: MethodOptions): GaxiosPromise[Schema$DataSource] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarDatasourcesDollarGet,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$DataSource]
  ...
  def list(params: ParamsDollarResourceDollarProjectsDollarDatasourcesDollarList): GaxiosPromise[Schema$ListDataSourcesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatasourcesDollarList,
  ...
  def list(params: ParamsDollarResourceDollarProjectsDollarDatasourcesDollarList, options: MethodOptions): GaxiosPromise[Schema$ListDataSourcesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarDatasourcesDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListDataSourcesResponse]
