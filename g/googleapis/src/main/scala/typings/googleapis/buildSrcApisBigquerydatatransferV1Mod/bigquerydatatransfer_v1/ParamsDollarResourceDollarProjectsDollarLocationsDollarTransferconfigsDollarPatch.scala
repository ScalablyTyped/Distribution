...
@js.native
trait ParamsDollarResourceDollarProjectsDollarLocationsDollarTransferconfigsDollarPatch extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$TransferConfig] = js.native
  /**
