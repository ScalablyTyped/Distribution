...
@js.native
trait ParamsDollarResourceDollarEventsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEventsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEventsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEventsDollarUpdate]
  }
}
