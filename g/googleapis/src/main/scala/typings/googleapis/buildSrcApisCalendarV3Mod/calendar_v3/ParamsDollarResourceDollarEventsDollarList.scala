...
@js.native
trait ParamsDollarResourceDollarEventsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEventsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEventsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEventsDollarList]
  }
}
