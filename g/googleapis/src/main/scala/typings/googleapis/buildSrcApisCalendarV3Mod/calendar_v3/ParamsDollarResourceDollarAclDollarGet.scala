...
@js.native
trait ParamsDollarResourceDollarAclDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAclDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    ruleId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarAclDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAclDollarGet]
  }
}
