...
@js.native
trait ParamsDollarResourceDollarAclDollarInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$AclRule] = js.native
  /**
...
object ParamsDollarResourceDollarAclDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$AclRule = null,
    sendNotifications: js.UndefOr[Boolean] = js.undefined,
    userIp: String = null
  ): ParamsDollarResourceDollarAclDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAclDollarInsert]
  }
}
