...
@js.native
trait Schema$AclRule extends js.Object {
  /**
  ...
  /**
    ...
    */
  var scope: js.UndefOr[Anon_TypeValue] = js.native
}

object Schema$AclRule {
  @scala.inline
  def apply(
    etag: String = null,
    id: String = null,
    ...
    __obj.asInstanceOf[Schema$AclRule]
  }
}
