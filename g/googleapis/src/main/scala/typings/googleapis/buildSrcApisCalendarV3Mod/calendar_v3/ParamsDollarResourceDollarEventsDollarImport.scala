...
@js.native
trait ParamsDollarResourceDollarEventsDollarImport extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEventsDollarImport {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEventsDollarImport = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEventsDollarImport]
  }
}
