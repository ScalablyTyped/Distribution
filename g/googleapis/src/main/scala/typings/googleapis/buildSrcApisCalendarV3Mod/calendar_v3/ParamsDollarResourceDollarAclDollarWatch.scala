...
@js.native
trait ParamsDollarResourceDollarAclDollarWatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAclDollarWatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAclDollarWatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAclDollarWatch]
  }
}
