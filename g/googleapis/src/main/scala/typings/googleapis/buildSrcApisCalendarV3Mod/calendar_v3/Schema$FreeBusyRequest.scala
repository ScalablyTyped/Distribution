...
@js.native
trait Schema$FreeBusyRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$FreeBusyRequestItem]] = js.native
  /**
...
object Schema$FreeBusyRequest {
  @scala.inline
  def apply(
    calendarExpansionMax: Int | Double = null,
    groupExpansionMax: Int | Double = null,
    items: js.Array[Schema$FreeBusyRequestItem] = null,
    timeMax: String = null,
    timeMin: String = null,
    ...
    __obj.asInstanceOf[Schema$FreeBusyRequest]
  }
}
