...
@js.native
trait ParamsDollarResourceDollarSettingsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSettingsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSettingsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSettingsDollarList]
  }
}
