...
@js.native
trait ParamsDollarResourceDollarCalendarlistDollarInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$CalendarListEntry] = js.native
}

object ParamsDollarResourceDollarCalendarlistDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$CalendarListEntry = null,
    userIp: String = null
  ): ParamsDollarResourceDollarCalendarlistDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCalendarlistDollarInsert]
  }
}
