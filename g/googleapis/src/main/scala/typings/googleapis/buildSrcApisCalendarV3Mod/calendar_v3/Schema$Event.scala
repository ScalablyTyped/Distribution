...
import typings.googleapis.Anon_Display
import typings.googleapis.Anon_DisplayNameEmail
import typings.googleapis.Anon_KeyPrivate
import typings.googleapis.Anon_Overrides
import typings.googleapis.Anon_TitleUrl
...
trait Schema$Event extends js.Object {
  ...
  /**
    ...
    */
  var attachments: js.UndefOr[js.Array[Schema$EventAttachment]] = js.native
  /**
    ...
    */
  var attendees: js.UndefOr[js.Array[Schema$EventAttendee]] = js.native
  /**
  ...
  /**
    ...
    */
  var conferenceData: js.UndefOr[Schema$ConferenceData] = js.native
  /**
  ...
  /**
    ...
    */
  var creator: js.UndefOr[Anon_DisplayNameEmail] = js.native
  /**
  ...
  /**
    ...
    */
  var end: js.UndefOr[Schema$EventDateTime] = js.native
  /**
  ...
  /**
    ...
    */
  var extendedProperties: js.UndefOr[Anon_KeyPrivate] = js.native
  /**
    * A gadget that extends this event.
    */
  var gadget: js.UndefOr[Anon_Display] = js.native
  /**
  ...
  /**
    ...
    */
  var organizer: js.UndefOr[Anon_DisplayNameEmail] = js.native
  /**
    ...
    */
  var originalStartTime: js.UndefOr[Schema$EventDateTime] = js.native
  /**
  ...
  /**
    ...
    */
  var reminders: js.UndefOr[Anon_Overrides] = js.native
  /**
...
object Schema$Event {
  ...
  def apply(
    ...
    attachments: js.Array[Schema$EventAttachment] = null,
    attendees: js.Array[Schema$EventAttendee] = null,
    attendeesOmitted: js.UndefOr[Boolean] = js.undefined,
    colorId: String = null,
    conferenceData: Schema$ConferenceData = null,
    created: String = null,
    creator: Anon_DisplayNameEmail = null,
    description: String = null,
    end: Schema$EventDateTime = null,
    endTimeUnspecified: js.UndefOr[Boolean] = js.undefined,
    etag: String = null,
    extendedProperties: Anon_KeyPrivate = null,
    ...
    organizer: Anon_DisplayNameEmail = null,
    originalStartTime: Schema$EventDateTime = null,
