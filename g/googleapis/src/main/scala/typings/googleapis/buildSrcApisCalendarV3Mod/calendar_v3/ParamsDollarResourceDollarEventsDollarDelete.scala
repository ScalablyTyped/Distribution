...
@js.native
trait ParamsDollarResourceDollarEventsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEventsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEventsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEventsDollarDelete]
  }
}
