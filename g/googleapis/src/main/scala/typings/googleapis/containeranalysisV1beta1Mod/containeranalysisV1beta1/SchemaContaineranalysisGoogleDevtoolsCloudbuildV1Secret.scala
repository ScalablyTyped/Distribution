...
trait SchemaContaineranalysisGoogleDevtoolsCloudbuildV1Secret extends StObject {
...
object SchemaContaineranalysisGoogleDevtoolsCloudbuildV1Secret {
  
  inline def apply(): SchemaContaineranalysisGoogleDevtoolsCloudbuildV1Secret = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaContaineranalysisGoogleDevtoolsCloudbuildV1Secret]
  }
  
  extension [Self <: SchemaContaineranalysisGoogleDevtoolsCloudbuildV1Secret](x: Self) {
