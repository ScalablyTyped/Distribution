...
object ParamsResourceProjectsNotesBatchcreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsNotesBatchcreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsNotesBatchcreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsNotesBatchcreateMutableBuilder[Self <: ParamsResourceProjectsNotesBatchcreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchCreateNotesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
