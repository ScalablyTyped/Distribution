...
object ParamsResourceProjectsNotesBatchcreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsNotesBatchcreateOps[Self <: ParamsResourceProjectsNotesBatchcreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchCreateNotesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
