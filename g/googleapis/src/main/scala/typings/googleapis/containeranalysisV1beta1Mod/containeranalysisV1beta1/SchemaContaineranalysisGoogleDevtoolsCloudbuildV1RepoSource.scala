...
trait SchemaContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource extends StObject {
...
object SchemaContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource {
  
  inline def apply(): SchemaContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource]
  }
  
  extension [Self <: SchemaContaineranalysisGoogleDevtoolsCloudbuildV1RepoSource](x: Self) {
