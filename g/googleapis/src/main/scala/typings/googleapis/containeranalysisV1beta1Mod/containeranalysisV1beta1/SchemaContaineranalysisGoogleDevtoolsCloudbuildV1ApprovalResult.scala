...
trait SchemaContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult extends StObject {
...
object SchemaContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult {
  
  inline def apply(): SchemaContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult]
  }
  
  extension [Self <: SchemaContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult](x: Self) {
