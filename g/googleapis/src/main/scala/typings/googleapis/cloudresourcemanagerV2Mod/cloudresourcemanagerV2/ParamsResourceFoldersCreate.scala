...
object ParamsResourceFoldersCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceFoldersCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceFoldersCreateMutableBuilder[Self <: ParamsResourceFoldersCreate] (val x: Self) extends AnyVal {
