...
object ParamsResourceFoldersMove {
  ...
  @scala.inline
  def apply(): ParamsResourceFoldersMove = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersMove]
  }
  
  @scala.inline
  implicit class ParamsResourceFoldersMoveMutableBuilder[Self <: ParamsResourceFoldersMove] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaMoveFolderRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
