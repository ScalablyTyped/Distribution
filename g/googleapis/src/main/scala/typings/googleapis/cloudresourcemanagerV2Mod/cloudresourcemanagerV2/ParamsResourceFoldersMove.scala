...
object ParamsResourceFoldersMove {
  ...
  @scala.inline
  implicit class ParamsResourceFoldersMoveOps[Self <: ParamsResourceFoldersMove] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaMoveFolderRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
