...
trait SchemaGoogleTypeColor extends StObject {
...
object SchemaGoogleTypeColor {
  
  inline def apply(): SchemaGoogleTypeColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleTypeColor]
  }
  
  extension [Self <: SchemaGoogleTypeColor](x: Self) {
