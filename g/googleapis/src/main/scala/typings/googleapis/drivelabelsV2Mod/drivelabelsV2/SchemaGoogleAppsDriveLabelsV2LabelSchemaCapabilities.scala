...
trait SchemaGoogleAppsDriveLabelsV2LabelSchemaCapabilities extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2LabelSchemaCapabilities {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2LabelSchemaCapabilities = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2LabelSchemaCapabilities]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2LabelSchemaCapabilities](x: Self) {
