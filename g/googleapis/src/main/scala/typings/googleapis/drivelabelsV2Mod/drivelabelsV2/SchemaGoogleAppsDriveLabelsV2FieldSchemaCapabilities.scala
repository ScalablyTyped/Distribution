...
trait SchemaGoogleAppsDriveLabelsV2FieldSchemaCapabilities extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2FieldSchemaCapabilities {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2FieldSchemaCapabilities = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2FieldSchemaCapabilities]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2FieldSchemaCapabilities](x: Self) {
