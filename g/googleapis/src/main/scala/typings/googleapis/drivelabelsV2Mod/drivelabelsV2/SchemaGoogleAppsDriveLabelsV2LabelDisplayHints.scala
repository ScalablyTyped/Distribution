...
trait SchemaGoogleAppsDriveLabelsV2LabelDisplayHints extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2LabelDisplayHints {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2LabelDisplayHints = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2LabelDisplayHints]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2LabelDisplayHints](x: Self) {
