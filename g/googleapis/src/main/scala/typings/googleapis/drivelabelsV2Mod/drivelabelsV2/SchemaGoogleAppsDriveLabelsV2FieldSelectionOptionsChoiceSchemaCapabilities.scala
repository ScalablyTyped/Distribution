...
trait SchemaGoogleAppsDriveLabelsV2FieldSelectionOptionsChoiceSchemaCapabilities extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2FieldSelectionOptionsChoiceSchemaCapabilities {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2FieldSelectionOptionsChoiceSchemaCapabilities = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2FieldSelectionOptionsChoiceSchemaCapabilities]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2FieldSelectionOptionsChoiceSchemaCapabilities](x: Self) {
