...
trait SchemaGoogleAppsDriveLabelsV2BadgeConfig extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2BadgeConfig {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2BadgeConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2BadgeConfig]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2BadgeConfig](x: Self) {
