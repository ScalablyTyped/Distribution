...
trait SchemaGoogleAppsDriveLabelsV2FieldDateOptions extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2FieldDateOptions {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2FieldDateOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2FieldDateOptions]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2FieldDateOptions](x: Self) {
