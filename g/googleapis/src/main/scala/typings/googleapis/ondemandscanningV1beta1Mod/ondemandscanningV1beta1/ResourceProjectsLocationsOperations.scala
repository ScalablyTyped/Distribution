...
@JSImport("googleapis/build/src/apis/ondemandscanning/v1beta1", "ondemandscanning_v1beta1.Resource$Projects$Locations$Operations")
@js.native
open class ResourceProjectsLocationsOperations protected () extends StObject {
  ...
  def wait(params: ParamsResourceProjectsLocationsOperationsWait): GaxiosPromise[SchemaOperation] = js.native
  def wait(
    params: ParamsResourceProjectsLocationsOperationsWait,
    callback: BodyResponseCallback[SchemaOperation]
  ): Unit = js.native
  def wait(
    params: ParamsResourceProjectsLocationsOperationsWait,
  ...
  def wait(params: ParamsResourceProjectsLocationsOperationsWait, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def wait(
    params: ParamsResourceProjectsLocationsOperationsWait,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def wait(params: ParamsResourceProjectsLocationsOperationsWait, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def wait(
    params: ParamsResourceProjectsLocationsOperationsWait,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
