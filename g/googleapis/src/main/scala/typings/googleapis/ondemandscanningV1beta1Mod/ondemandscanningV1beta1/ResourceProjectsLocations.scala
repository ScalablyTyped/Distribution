...
@JSImport("googleapis/build/src/apis/ondemandscanning/v1beta1", "ondemandscanning_v1beta1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var scans: ResourceProjectsLocationsScans = js.native
}
