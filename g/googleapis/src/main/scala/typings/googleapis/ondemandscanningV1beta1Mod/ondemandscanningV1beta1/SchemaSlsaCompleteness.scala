...
trait SchemaSlsaCompleteness extends StObject {
...
object SchemaSlsaCompleteness {
  
  inline def apply(): SchemaSlsaCompleteness = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSlsaCompleteness]
  }
  
  extension [Self <: SchemaSlsaCompleteness](x: Self) {
