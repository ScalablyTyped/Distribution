...
object ParamsResourceProjectsReposDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsReposDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsReposDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsReposDeleteMutableBuilder[Self <: ParamsResourceProjectsReposDelete] (val x: Self) extends AnyVal {
