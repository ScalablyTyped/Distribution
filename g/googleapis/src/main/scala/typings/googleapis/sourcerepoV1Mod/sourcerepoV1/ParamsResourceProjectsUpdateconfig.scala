...
object ParamsResourceProjectsUpdateconfig {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsUpdateconfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsUpdateconfig]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsUpdateconfigMutableBuilder[Self <: ParamsResourceProjectsUpdateconfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaUpdateProjectConfigRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
