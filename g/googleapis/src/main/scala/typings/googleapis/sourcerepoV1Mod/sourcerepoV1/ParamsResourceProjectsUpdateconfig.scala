...
object ParamsResourceProjectsUpdateconfig {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsUpdateconfigOps[Self <: ParamsResourceProjectsUpdateconfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaUpdateProjectConfigRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
