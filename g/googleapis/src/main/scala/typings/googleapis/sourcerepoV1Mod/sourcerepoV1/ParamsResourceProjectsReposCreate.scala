...
object ParamsResourceProjectsReposCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsReposCreateOps[Self <: ParamsResourceProjectsReposCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRepo): Self = this.set("requestBody", value.asInstanceOf[js.Any])
