...
trait ParamsResourceAdminProjectsLocationsTopicsSubscriptionsList
  extends StObject
...
object ParamsResourceAdminProjectsLocationsTopicsSubscriptionsList {
  
  inline def apply(): ParamsResourceAdminProjectsLocationsTopicsSubscriptionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAdminProjectsLocationsTopicsSubscriptionsList]
  }
  
  extension [Self <: ParamsResourceAdminProjectsLocationsTopicsSubscriptionsList](x: Self) {
