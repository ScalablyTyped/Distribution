...
trait ParamsResourceTagkeysGetiampolicy
  extends StObject
...
object ParamsResourceTagkeysGetiampolicy {
  
  inline def apply(): ParamsResourceTagkeysGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTagkeysGetiampolicy]
  }
  
  extension [Self <: ParamsResourceTagkeysGetiampolicy](x: Self) {
