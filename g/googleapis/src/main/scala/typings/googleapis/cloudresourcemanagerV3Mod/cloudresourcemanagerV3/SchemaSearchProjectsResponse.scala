...
trait SchemaSearchProjectsResponse extends StObject {
...
object SchemaSearchProjectsResponse {
  
  inline def apply(): SchemaSearchProjectsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSearchProjectsResponse]
  }
  
  extension [Self <: SchemaSearchProjectsResponse](x: Self) {
