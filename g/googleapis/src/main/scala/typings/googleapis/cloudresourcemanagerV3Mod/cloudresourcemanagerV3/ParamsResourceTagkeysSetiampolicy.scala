...
trait ParamsResourceTagkeysSetiampolicy
  extends StObject
...
object ParamsResourceTagkeysSetiampolicy {
  
  inline def apply(): ParamsResourceTagkeysSetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTagkeysSetiampolicy]
  }
  
  extension [Self <: ParamsResourceTagkeysSetiampolicy](x: Self) {
