...
trait ParamsResourceTagvaluesGetiampolicy
  extends StObject
...
object ParamsResourceTagvaluesGetiampolicy {
  
  inline def apply(): ParamsResourceTagvaluesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTagvaluesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceTagvaluesGetiampolicy](x: Self) {
