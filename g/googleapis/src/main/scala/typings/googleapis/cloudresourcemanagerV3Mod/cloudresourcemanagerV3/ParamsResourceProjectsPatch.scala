...
trait ParamsResourceProjectsPatch
  extends StObject
...
object ParamsResourceProjectsPatch {
  
  inline def apply(): ParamsResourceProjectsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsPatch](x: Self) {
