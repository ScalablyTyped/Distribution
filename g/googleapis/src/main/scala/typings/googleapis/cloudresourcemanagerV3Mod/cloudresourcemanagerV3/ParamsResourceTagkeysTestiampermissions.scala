...
trait ParamsResourceTagkeysTestiampermissions
  extends StObject
...
object ParamsResourceTagkeysTestiampermissions {
  
  inline def apply(): ParamsResourceTagkeysTestiampermissions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTagkeysTestiampermissions]
  }
  
  extension [Self <: ParamsResourceTagkeysTestiampermissions](x: Self) {
