...
trait ParamsResourceProjectsSetiampolicy
  extends StObject
...
object ParamsResourceProjectsSetiampolicy {
  
  inline def apply(): ParamsResourceProjectsSetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsSetiampolicy](x: Self) {
