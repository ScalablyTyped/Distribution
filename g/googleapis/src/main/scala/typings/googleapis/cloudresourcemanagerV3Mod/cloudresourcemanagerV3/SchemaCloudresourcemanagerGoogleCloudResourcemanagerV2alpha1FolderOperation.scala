...
trait SchemaCloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation extends StObject {
...
object SchemaCloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation {
  
  inline def apply(): SchemaCloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation]
  }
  
  extension [Self <: SchemaCloudresourcemanagerGoogleCloudResourcemanagerV2alpha1FolderOperation](x: Self) {
