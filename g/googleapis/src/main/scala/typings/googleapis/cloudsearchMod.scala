...
import typings.googleapis.cloudsearchV1Mod.cloudsearchV1.Options
...
object cloudsearchMod {
  ...
  object VERSIONS {
    ...
    @js.native
    class v1 protected () extends Cloudsearch {
  ...
  object auth extends Shortcut {
    ...
    @JSImport("googleapis/build/src/apis/cloudsearch", "auth")
    @js.native
    val ^ : AuthPlus = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/cloudsearch", "auth.Compute")
    @js.native
    /**
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/cloudsearch", "auth.JWT")
    @js.native
    class JWT protected ()
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/cloudsearch", "auth.OAuth2")
    @js.native
    /**
