...
object ParamsResourceAmpurlsBatchget {
  ...
  @scala.inline
  implicit class ParamsResourceAmpurlsBatchgetOps[Self <: ParamsResourceAmpurlsBatchget] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchGetAmpUrlsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
