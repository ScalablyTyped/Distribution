...
trait SchemaAddSubnetworkRequest extends StObject {
  ...
  /**
    ...
    */
  var computeIdempotencyWindow: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var secondaryIpRangeSpecs: js.UndefOr[js.Array[SchemaSecondaryIpRangeSpec]] = js.undefined
  ...
  /**
    ...
    */
  var useCustomComputeIdempotencyWindow: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaAddSubnetworkRequest {
  ...
  extension [Self <: SchemaAddSubnetworkRequest](x: Self) {
    ...
    inline def setComputeIdempotencyWindowNull: Self = StObject.set(x, "computeIdempotencyWindow", null)
    ...
    inline def setSecondaryIpRangeSpecs(value: js.Array[SchemaSecondaryIpRangeSpec]): Self = StObject.set(x, "secondaryIpRangeSpecs", value.asInstanceOf[js.Any])
    
    inline def setSecondaryIpRangeSpecsUndefined: Self = StObject.set(x, "secondaryIpRangeSpecs", js.undefined)
    
    inline def setSecondaryIpRangeSpecsVarargs(value: SchemaSecondaryIpRangeSpec*): Self = StObject.set(x, "secondaryIpRangeSpecs", js.Array(value*))
    ...
    inline def setUseCustomComputeIdempotencyWindowNull: Self = StObject.set(x, "useCustomComputeIdempotencyWindow", null)
