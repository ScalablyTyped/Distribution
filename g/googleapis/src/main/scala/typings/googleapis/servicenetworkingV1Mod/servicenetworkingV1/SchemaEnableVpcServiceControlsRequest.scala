...
trait SchemaEnableVpcServiceControlsRequest extends StObject {
...
object SchemaEnableVpcServiceControlsRequest {
  
  inline def apply(): SchemaEnableVpcServiceControlsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaEnableVpcServiceControlsRequest]
  }
  
  extension [Self <: SchemaEnableVpcServiceControlsRequest](x: Self) {
