...
trait SchemaRemoveDnsZoneRequest extends StObject {
...
object SchemaRemoveDnsZoneRequest {
  
  inline def apply(): SchemaRemoveDnsZoneRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRemoveDnsZoneRequest]
  }
  
  extension [Self <: SchemaRemoveDnsZoneRequest](x: Self) {
