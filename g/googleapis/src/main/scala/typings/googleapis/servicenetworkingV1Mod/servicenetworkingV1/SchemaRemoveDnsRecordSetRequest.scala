...
trait SchemaRemoveDnsRecordSetRequest extends StObject {
...
object SchemaRemoveDnsRecordSetRequest {
  
  inline def apply(): SchemaRemoveDnsRecordSetRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRemoveDnsRecordSetRequest]
  }
  
  extension [Self <: SchemaRemoveDnsRecordSetRequest](x: Self) {
