...
trait SchemaMetricDescriptor extends StObject {
  ...
  /**
    ...
    */
  var monitoredResourceTypes: js.UndefOr[js.Array[String] | Null] = js.undefined
...
object SchemaMetricDescriptor {
  ...
  extension [Self <: SchemaMetricDescriptor](x: Self) {
    ...
    inline def setMonitoredResourceTypesNull: Self = StObject.set(x, "monitoredResourceTypes", null)
