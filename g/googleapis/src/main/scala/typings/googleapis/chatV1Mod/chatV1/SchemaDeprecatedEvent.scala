...
trait SchemaDeprecatedEvent extends StObject {
  ...
  /**
    ...
    */
  var common: js.UndefOr[SchemaCommonEventObject] = js.undefined
  ...
  /**
    ...
    */
  var configCompleteRedirectUrl: js.UndefOr[String | Null] = js.undefined
  
  /**
    * The type of [dialog](https://developers.google.com/chat/how-tos/dialogs) event received.
    */
  var dialogEventType: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var isDialogEvent: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var threadKey: js.UndefOr[String | Null] = js.undefined
...
object SchemaDeprecatedEvent {
  ...
  extension [Self <: SchemaDeprecatedEvent](x: Self) {
    ...
    inline def setCommon(value: SchemaCommonEventObject): Self = StObject.set(x, "common", value.asInstanceOf[js.Any])
    ...
    inline def setConfigCompleteRedirectUrlNull: Self = StObject.set(x, "configCompleteRedirectUrl", null)
    ...
    inline def setDialogEventTypeNull: Self = StObject.set(x, "dialogEventType", null)
    ...
    inline def setIsDialogEventNull: Self = StObject.set(x, "isDialogEvent", null)
    ...
    inline def setThreadKeyNull: Self = StObject.set(x, "threadKey", null)
