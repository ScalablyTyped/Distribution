...
trait ParamsResourceDmsMessages
  extends StObject
...
object ParamsResourceDmsMessages {
  
  inline def apply(): ParamsResourceDmsMessages = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceDmsMessages]
  }
  
  extension [Self <: ParamsResourceDmsMessages](x: Self) {
