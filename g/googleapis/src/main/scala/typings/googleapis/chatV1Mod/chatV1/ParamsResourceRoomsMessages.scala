...
trait ParamsResourceRoomsMessages
  extends StObject
...
object ParamsResourceRoomsMessages {
  
  inline def apply(): ParamsResourceRoomsMessages = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRoomsMessages]
  }
  
  extension [Self <: ParamsResourceRoomsMessages](x: Self) {
