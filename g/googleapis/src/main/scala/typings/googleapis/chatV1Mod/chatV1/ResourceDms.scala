...
@JSImport("googleapis/build/src/apis/chat/v1", "chat_v1.Resource$Dms")
@js.native
open class ResourceDms protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var context: APIRequestContext = js.native
  
  var conversations: ResourceDmsConversations = js.native
  ...
  def messages(params: ParamsResourceDmsMessages): GaxiosPromise[SchemaMessage] = js.native
  def messages(params: ParamsResourceDmsMessages, callback: BodyResponseCallback[SchemaMessage]): Unit = js.native
  def messages(
    params: ParamsResourceDmsMessages,
    options: BodyResponseCallback[Readable | SchemaMessage],
    callback: BodyResponseCallback[Readable | SchemaMessage]
  ): Unit = js.native
  def messages(params: ParamsResourceDmsMessages, options: MethodOptions): GaxiosPromise[SchemaMessage] = js.native
  def messages(
    params: ParamsResourceDmsMessages,
  ...
  /**
    ...
    */
  def messages(params: ParamsResourceDmsMessages, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def messages(
    params: ParamsResourceDmsMessages,
  ...
  def webhooks(params: ParamsResourceDmsWebhooks): GaxiosPromise[SchemaMessage] = js.native
  def webhooks(params: ParamsResourceDmsWebhooks, callback: BodyResponseCallback[SchemaMessage]): Unit = js.native
  def webhooks(
    params: ParamsResourceDmsWebhooks,
    options: BodyResponseCallback[Readable | SchemaMessage],
    callback: BodyResponseCallback[Readable | SchemaMessage]
  ): Unit = js.native
  def webhooks(params: ParamsResourceDmsWebhooks, options: MethodOptions): GaxiosPromise[SchemaMessage] = js.native
  def webhooks(
    params: ParamsResourceDmsWebhooks,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaMessage]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def webhooks(params: ParamsResourceDmsWebhooks, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def webhooks(
    params: ParamsResourceDmsWebhooks,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
