...
trait ParamsResourceRoomsWebhooks
  extends StObject
...
object ParamsResourceRoomsWebhooks {
  
  inline def apply(): ParamsResourceRoomsWebhooks = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRoomsWebhooks]
  }
  
  extension [Self <: ParamsResourceRoomsWebhooks](x: Self) {
