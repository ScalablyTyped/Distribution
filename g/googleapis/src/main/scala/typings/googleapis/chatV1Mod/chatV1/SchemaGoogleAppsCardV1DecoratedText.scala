...
trait SchemaGoogleAppsCardV1DecoratedText extends StObject {
  ...
  /**
    ...
    */
  var button: js.UndefOr[SchemaGoogleAppsCardV1Button] = js.undefined
  
  /**
    * An icon displayed after the text.
    */
  var endIcon: js.UndefOr[SchemaGoogleAppsCardV1Icon] = js.undefined
  ...
  /**
    ...
    */
  var startIcon: js.UndefOr[SchemaGoogleAppsCardV1Icon] = js.undefined
  
  /**
    * A switch widget can be clicked to change its state or trigger an action.
    */
  var switchControl: js.UndefOr[SchemaGoogleAppsCardV1SwitchControl] = js.undefined
...
object SchemaGoogleAppsCardV1DecoratedText {
  
  inline def apply(): SchemaGoogleAppsCardV1DecoratedText = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsCardV1DecoratedText]
  }
  
  extension [Self <: SchemaGoogleAppsCardV1DecoratedText](x: Self) {
    ...
    inline def setButton(value: SchemaGoogleAppsCardV1Button): Self = StObject.set(x, "button", value.asInstanceOf[js.Any])
    
    inline def setButtonUndefined: Self = StObject.set(x, "button", js.undefined)
    
    inline def setEndIcon(value: SchemaGoogleAppsCardV1Icon): Self = StObject.set(x, "endIcon", value.asInstanceOf[js.Any])
    ...
    inline def setStartIcon(value: SchemaGoogleAppsCardV1Icon): Self = StObject.set(x, "startIcon", value.asInstanceOf[js.Any])
    
    inline def setStartIconUndefined: Self = StObject.set(x, "startIcon", js.undefined)
    
    inline def setSwitchControl(value: SchemaGoogleAppsCardV1SwitchControl): Self = StObject.set(x, "switchControl", value.asInstanceOf[js.Any])
