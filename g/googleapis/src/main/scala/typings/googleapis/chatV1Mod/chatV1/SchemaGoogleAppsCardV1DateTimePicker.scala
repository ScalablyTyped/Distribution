...
trait SchemaGoogleAppsCardV1DateTimePicker extends StObject {
...
object SchemaGoogleAppsCardV1DateTimePicker {
  
  inline def apply(): SchemaGoogleAppsCardV1DateTimePicker = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsCardV1DateTimePicker]
  }
  
  extension [Self <: SchemaGoogleAppsCardV1DateTimePicker](x: Self) {
