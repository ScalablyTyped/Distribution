...
object ParamsResourceSpacesMessagesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceSpacesMessagesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSpacesMessagesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceSpacesMessagesDeleteMutableBuilder[Self <: ParamsResourceSpacesMessagesDelete] (val x: Self) extends AnyVal {
