...
trait ParamsResourceDmsConversationsMessages
  extends StObject
...
object ParamsResourceDmsConversationsMessages {
  
  inline def apply(): ParamsResourceDmsConversationsMessages = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceDmsConversationsMessages]
  }
  
  extension [Self <: ParamsResourceDmsConversationsMessages](x: Self) {
