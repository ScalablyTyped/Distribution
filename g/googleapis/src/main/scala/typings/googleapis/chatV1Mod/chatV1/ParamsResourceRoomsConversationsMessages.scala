...
trait ParamsResourceRoomsConversationsMessages
  extends StObject
...
object ParamsResourceRoomsConversationsMessages {
  
  inline def apply(): ParamsResourceRoomsConversationsMessages = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRoomsConversationsMessages]
  }
  
  extension [Self <: ParamsResourceRoomsConversationsMessages](x: Self) {
