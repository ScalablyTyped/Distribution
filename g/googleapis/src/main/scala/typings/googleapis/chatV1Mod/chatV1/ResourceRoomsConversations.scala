...
@JSImport("googleapis/build/src/apis/chat/v1", "chat_v1.Resource$Rooms$Conversations")
@js.native
open class ResourceRoomsConversations protected () extends StObject {
  ...
  def messages(params: ParamsResourceRoomsConversationsMessages): GaxiosPromise[SchemaMessage] = js.native
  def messages(params: ParamsResourceRoomsConversationsMessages, callback: BodyResponseCallback[SchemaMessage]): Unit = js.native
  def messages(
    params: ParamsResourceRoomsConversationsMessages,
    options: BodyResponseCallback[Readable | SchemaMessage],
    callback: BodyResponseCallback[Readable | SchemaMessage]
  ): Unit = js.native
  def messages(params: ParamsResourceRoomsConversationsMessages, options: MethodOptions): GaxiosPromise[SchemaMessage] = js.native
  def messages(
    params: ParamsResourceRoomsConversationsMessages,
  ...
  /**
    ...
    */
  def messages(params: ParamsResourceRoomsConversationsMessages, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def messages(
    params: ParamsResourceRoomsConversationsMessages,
