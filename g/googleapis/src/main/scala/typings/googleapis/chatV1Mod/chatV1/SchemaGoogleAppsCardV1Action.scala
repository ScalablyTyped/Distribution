...
trait SchemaGoogleAppsCardV1Action extends StObject {
  ...
  /**
    ...
    */
  var parameters: js.UndefOr[js.Array[SchemaGoogleAppsCardV1ActionParameter]] = js.undefined
  ...
  /**
    ...
    */
  var persistValues: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaGoogleAppsCardV1Action {
  
  inline def apply(): SchemaGoogleAppsCardV1Action = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsCardV1Action]
  }
  
  extension [Self <: SchemaGoogleAppsCardV1Action](x: Self) {
    ...
    inline def setParameters(value: js.Array[SchemaGoogleAppsCardV1ActionParameter]): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setParametersUndefined: Self = StObject.set(x, "parameters", js.undefined)
    
    inline def setParametersVarargs(value: SchemaGoogleAppsCardV1ActionParameter*): Self = StObject.set(x, "parameters", js.Array(value*))
    
    inline def setPersistValues(value: Boolean): Self = StObject.set(x, "persistValues", value.asInstanceOf[js.Any])
    
    inline def setPersistValuesNull: Self = StObject.set(x, "persistValues", null)
