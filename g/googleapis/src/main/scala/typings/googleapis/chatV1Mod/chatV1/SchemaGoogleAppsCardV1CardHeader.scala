...
trait SchemaGoogleAppsCardV1CardHeader extends StObject {
...
object SchemaGoogleAppsCardV1CardHeader {
  
  inline def apply(): SchemaGoogleAppsCardV1CardHeader = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsCardV1CardHeader]
  }
  
  extension [Self <: SchemaGoogleAppsCardV1CardHeader](x: Self) {
