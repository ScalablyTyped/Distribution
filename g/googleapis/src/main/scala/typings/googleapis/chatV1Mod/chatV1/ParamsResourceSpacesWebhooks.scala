...
trait ParamsResourceSpacesWebhooks
  extends StObject
...
object ParamsResourceSpacesWebhooks {
  
  inline def apply(): ParamsResourceSpacesWebhooks = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSpacesWebhooks]
  }
  
  extension [Self <: ParamsResourceSpacesWebhooks](x: Self) {
