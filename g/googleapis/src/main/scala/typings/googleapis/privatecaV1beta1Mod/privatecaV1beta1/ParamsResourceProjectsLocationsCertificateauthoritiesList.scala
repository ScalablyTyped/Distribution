...
trait ParamsResourceProjectsLocationsCertificateauthoritiesList
  extends StObject
...
object ParamsResourceProjectsLocationsCertificateauthoritiesList {
  
  inline def apply(): ParamsResourceProjectsLocationsCertificateauthoritiesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCertificateauthoritiesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCertificateauthoritiesList](x: Self) {
