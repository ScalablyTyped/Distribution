...
trait ParamsResourceProjectsLocationsCertificateauthoritiesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsCertificateauthoritiesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsCertificateauthoritiesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCertificateauthoritiesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCertificateauthoritiesGetiampolicy](x: Self) {
