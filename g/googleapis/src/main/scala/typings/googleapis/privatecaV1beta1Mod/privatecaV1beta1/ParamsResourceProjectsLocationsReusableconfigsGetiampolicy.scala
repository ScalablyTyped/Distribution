...
trait ParamsResourceProjectsLocationsReusableconfigsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsReusableconfigsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsReusableconfigsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsReusableconfigsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsReusableconfigsGetiampolicy](x: Self) {
