...
@JSImport("googleapis/build/src/apis/privateca/v1beta1", "privateca_v1beta1.Resource$Projects$Locations$Certificateauthorities$Certificaterevocationlists")
@js.native
open class ResourceProjectsLocationsCertificateauthoritiesCertificaterevocationlists protected () extends StObject {
  ...
  def get(params: ParamsResourceProjectsLocationsCertificateauthoritiesCertificaterevocationlistsGet): GaxiosPromise[SchemaCertificateRevocationList] = js.native
  def get(
    params: ParamsResourceProjectsLocationsCertificateauthoritiesCertificaterevocationlistsGet,
  ...
  def getIamPolicy(
    params: ParamsResourceProjectsLocationsCertificateauthoritiesCertificaterevocationlistsGetiampolicy
  ...
  def list(params: ParamsResourceProjectsLocationsCertificateauthoritiesCertificaterevocationlistsList): GaxiosPromise[SchemaListCertificateRevocationListsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCertificateauthoritiesCertificaterevocationlistsList,
  ...
  def patch(params: ParamsResourceProjectsLocationsCertificateauthoritiesCertificaterevocationlistsPatch): GaxiosPromise[SchemaOperation] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsCertificateauthoritiesCertificaterevocationlistsPatch,
  ...
  def setIamPolicy(
    params: ParamsResourceProjectsLocationsCertificateauthoritiesCertificaterevocationlistsSetiampolicy
  ): GaxiosPromise[SchemaPolicy] = js.native
  def setIamPolicy(
    params: ParamsResourceProjectsLocationsCertificateauthoritiesCertificaterevocationlistsSetiampolicy,
    callback: BodyResponseCallback[SchemaPolicy]
  ...
  def testIamPermissions(
    params: ParamsResourceProjectsLocationsCertificateauthoritiesCertificaterevocationlistsTestiampermissions
