...
@JSImport("googleapis/build/src/apis/privateca/v1beta1", "privateca_v1beta1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var certificateAuthorities: ResourceProjectsLocationsCertificateauthorities = js.native
  ...
  var reusableConfigs: ResourceProjectsLocationsReusableconfigs = js.native
}
