...
trait ParamsResourceProjectsLocationsReusableconfigsList
  extends StObject
...
object ParamsResourceProjectsLocationsReusableconfigsList {
  
  inline def apply(): ParamsResourceProjectsLocationsReusableconfigsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsReusableconfigsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsReusableconfigsList](x: Self) {
