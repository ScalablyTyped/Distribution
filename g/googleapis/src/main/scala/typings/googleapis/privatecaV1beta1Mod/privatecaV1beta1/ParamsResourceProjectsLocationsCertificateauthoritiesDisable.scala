...
trait ParamsResourceProjectsLocationsCertificateauthoritiesDisable
  extends StObject
...
object ParamsResourceProjectsLocationsCertificateauthoritiesDisable {
  
  inline def apply(): ParamsResourceProjectsLocationsCertificateauthoritiesDisable = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCertificateauthoritiesDisable]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCertificateauthoritiesDisable](x: Self) {
