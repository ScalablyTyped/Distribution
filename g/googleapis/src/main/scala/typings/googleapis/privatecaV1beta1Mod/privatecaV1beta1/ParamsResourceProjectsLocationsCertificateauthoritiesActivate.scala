...
trait ParamsResourceProjectsLocationsCertificateauthoritiesActivate
  extends StObject
...
object ParamsResourceProjectsLocationsCertificateauthoritiesActivate {
  
  inline def apply(): ParamsResourceProjectsLocationsCertificateauthoritiesActivate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCertificateauthoritiesActivate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCertificateauthoritiesActivate](x: Self) {
