...
trait ParamsResourceProjectsLocationsCertificateauthoritiesPatch
  extends StObject
...
object ParamsResourceProjectsLocationsCertificateauthoritiesPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsCertificateauthoritiesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCertificateauthoritiesPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCertificateauthoritiesPatch](x: Self) {
