...
trait SchemaActivateCertificateAuthorityRequest extends StObject {
  
  /**
    * Required. The signed CA certificate issued from FetchCertificateAuthorityCsrResponse.pem_csr.
    */
  var pemCaCertificate: js.UndefOr[String | Null] = js.undefined
...
object SchemaActivateCertificateAuthorityRequest {
  
  inline def apply(): SchemaActivateCertificateAuthorityRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaActivateCertificateAuthorityRequest]
  }
  
  extension [Self <: SchemaActivateCertificateAuthorityRequest](x: Self) {
    
    inline def setPemCaCertificate(value: String): Self = StObject.set(x, "pemCaCertificate", value.asInstanceOf[js.Any])
    
    inline def setPemCaCertificateNull: Self = StObject.set(x, "pemCaCertificate", null)
