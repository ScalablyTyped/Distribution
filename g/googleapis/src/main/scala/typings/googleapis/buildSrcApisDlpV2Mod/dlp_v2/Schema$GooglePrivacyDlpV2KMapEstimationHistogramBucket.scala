...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2KMapEstimationHistogramBucket extends js.Object {
  /**
  ...
  /**
    ...
    */
  var bucketValues: js.UndefOr[js.Array[Schema$GooglePrivacyDlpV2KMapEstimationQuasiIdValues]] = js.native
  /**
...
object Schema$GooglePrivacyDlpV2KMapEstimationHistogramBucket {
  @scala.inline
  def apply(
    bucketSize: String = null,
    bucketValueCount: String = null,
    bucketValues: js.Array[Schema$GooglePrivacyDlpV2KMapEstimationQuasiIdValues] = null,
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2KMapEstimationHistogramBucket]
  }
}
