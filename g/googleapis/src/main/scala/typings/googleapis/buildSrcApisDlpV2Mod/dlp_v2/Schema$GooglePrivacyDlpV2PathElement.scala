...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2PathElement extends js.Object {
  /**
...
object Schema$GooglePrivacyDlpV2PathElement {
  @scala.inline
  def apply(id: String = null, kind: String = null, name: String = null): Schema$GooglePrivacyDlpV2PathElement = {
    val __obj = js.Dynamic.literal()
    if (id != null) __obj.updateDynamic("id")(id.asInstanceOf[js.Any])
    if (kind != null) __obj.updateDynamic("kind")(kind.asInstanceOf[js.Any])
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2PathElement]
  }
}
