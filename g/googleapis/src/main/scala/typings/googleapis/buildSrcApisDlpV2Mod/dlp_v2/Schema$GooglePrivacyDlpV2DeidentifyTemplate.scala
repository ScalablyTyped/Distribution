...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2DeidentifyTemplate extends js.Object {
  /**
...
object Schema$GooglePrivacyDlpV2DeidentifyTemplate {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2DeidentifyTemplate]
  }
}
