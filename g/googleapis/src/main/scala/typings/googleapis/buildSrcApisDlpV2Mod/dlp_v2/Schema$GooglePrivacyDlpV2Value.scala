...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2Value extends js.Object {
  var booleanValue: js.UndefOr[Boolean] = js.native
  var dateValue: js.UndefOr[Schema$GoogleTypeDate] = js.native
  ...
  var timeValue: js.UndefOr[Schema$GoogleTypeTimeOfDay] = js.native
  var timestampValue: js.UndefOr[String] = js.native
}

object Schema$GooglePrivacyDlpV2Value {
  @scala.inline
  def apply(
    booleanValue: js.UndefOr[Boolean] = js.undefined,
    dateValue: Schema$GoogleTypeDate = null,
    dayOfWeekValue: String = null,
    floatValue: Int | Double = null,
    integerValue: String = null,
    stringValue: String = null,
    timeValue: Schema$GoogleTypeTimeOfDay = null,
    timestampValue: String = null
  ): Schema$GooglePrivacyDlpV2Value = {
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2Value]
  }
}
