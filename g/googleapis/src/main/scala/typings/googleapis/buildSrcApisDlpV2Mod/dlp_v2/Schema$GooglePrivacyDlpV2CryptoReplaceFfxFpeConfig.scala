...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2CryptoReplaceFfxFpeConfig extends js.Object {
  ...
  /**
    ...
    */
  var surrogateInfoType: js.UndefOr[Schema$GooglePrivacyDlpV2InfoType] = js.native
}

object Schema$GooglePrivacyDlpV2CryptoReplaceFfxFpeConfig {
  @scala.inline
  def apply(
    ...
    surrogateInfoType: Schema$GooglePrivacyDlpV2InfoType = null
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2CryptoReplaceFfxFpeConfig]
  }
}
