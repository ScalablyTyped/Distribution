...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2Schedule extends js.Object {
  /**
...
object Schema$GooglePrivacyDlpV2Schedule {
  @scala.inline
  def apply(recurrencePeriodDuration: String = null): Schema$GooglePrivacyDlpV2Schedule = {
    ...
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2Schedule]
  }
}
