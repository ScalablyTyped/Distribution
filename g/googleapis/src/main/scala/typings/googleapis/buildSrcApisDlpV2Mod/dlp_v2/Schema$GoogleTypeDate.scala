...
/**
  ...
  */
@js.native
trait Schema$GoogleTypeDate extends js.Object {
  /**
...
object Schema$GoogleTypeDate {
  @scala.inline
  def apply(day: Int | Double = null, month: Int | Double = null, year: Int | Double = null): Schema$GoogleTypeDate = {
    val __obj = js.Dynamic.literal()
    if (day != null) __obj.updateDynamic("day")(day.asInstanceOf[js.Any])
    if (month != null) __obj.updateDynamic("month")(month.asInstanceOf[js.Any])
    if (year != null) __obj.updateDynamic("year")(year.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleTypeDate]
  }
}
