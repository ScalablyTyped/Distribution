...
/**
  ...
  */
@js.native
trait Schema$GooglePrivacyDlpV2QuasiIdField extends js.Object {
  var customTag: js.UndefOr[String] = js.native
  var field: js.UndefOr[Schema$GooglePrivacyDlpV2FieldId] = js.native
}

object Schema$GooglePrivacyDlpV2QuasiIdField {
  @scala.inline
  def apply(customTag: String = null, field: Schema$GooglePrivacyDlpV2FieldId = null): Schema$GooglePrivacyDlpV2QuasiIdField = {
    val __obj = js.Dynamic.literal()
    if (customTag != null) __obj.updateDynamic("customTag")(customTag.asInstanceOf[js.Any])
    if (field != null) __obj.updateDynamic("field")(field.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GooglePrivacyDlpV2QuasiIdField]
  }
}
