...
/**
  ...
  */
@js.native
trait Schema$LiveBroadcastContentDetails extends js.Object {
  /**
  ...
  /**
    ...
    */
  var monitorStream: js.UndefOr[Schema$MonitorStreamInfo] = js.native
  /**
...
object Schema$LiveBroadcastContentDetails {
  @scala.inline
  def apply(
    ...
    mesh: String = null,
    monitorStream: Schema$MonitorStreamInfo = null,
  ...
  ): Schema$LiveBroadcastContentDetails = {
    ...
    __obj.asInstanceOf[Schema$LiveBroadcastContentDetails]
  }
}
