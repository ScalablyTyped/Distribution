...
@js.native
trait ParamsDollarResourceDollarWatermarksDollarSet extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$InvideoBranding] = js.native
}

object ParamsDollarResourceDollarWatermarksDollarSet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$InvideoBranding = null,
    userIp: String = null
  ): ParamsDollarResourceDollarWatermarksDollarSet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarWatermarksDollarSet]
  }
}
