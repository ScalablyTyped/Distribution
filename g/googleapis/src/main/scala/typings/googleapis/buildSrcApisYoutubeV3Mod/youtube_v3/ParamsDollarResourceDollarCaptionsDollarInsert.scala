...
@js.native
trait ParamsDollarResourceDollarCaptionsDollarInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Caption] = js.native
  /**
...
object ParamsDollarResourceDollarCaptionsDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$Caption = null,
    sync: js.UndefOr[Boolean] = js.undefined,
    userIp: String = null
  ): ParamsDollarResourceDollarCaptionsDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCaptionsDollarInsert]
  }
}
