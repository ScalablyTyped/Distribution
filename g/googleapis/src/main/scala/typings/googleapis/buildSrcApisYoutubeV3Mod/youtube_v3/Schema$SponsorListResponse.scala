...
@js.native
trait Schema$SponsorListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$Sponsor]] = js.native
  /**
...
object Schema$SponsorListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$Sponsor] = null,
    kind: String = null,
    nextPageToken: String = null,
    pageInfo: Schema$PageInfo = null,
    tokenPagination: Schema$TokenPagination = null,
    visitorId: String = null
  ): Schema$SponsorListResponse = {
    ...
    __obj.asInstanceOf[Schema$SponsorListResponse]
  }
}
