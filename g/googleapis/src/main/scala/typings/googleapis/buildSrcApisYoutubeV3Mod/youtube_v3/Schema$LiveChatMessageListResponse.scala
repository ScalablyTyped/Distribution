...
@js.native
trait Schema$LiveChatMessageListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$LiveChatMessage]] = js.native
  /**
...
object Schema$LiveChatMessageListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$LiveChatMessage] = null,
    kind: String = null,
  ...
  ): Schema$LiveChatMessageListResponse = {
    ...
    __obj.asInstanceOf[Schema$LiveChatMessageListResponse]
  }
}
