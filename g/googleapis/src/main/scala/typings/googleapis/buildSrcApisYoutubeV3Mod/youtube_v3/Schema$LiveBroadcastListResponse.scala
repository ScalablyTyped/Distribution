...
@js.native
trait Schema$LiveBroadcastListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$LiveBroadcast]] = js.native
  /**
...
object Schema$LiveBroadcastListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$LiveBroadcast] = null,
    kind: String = null,
  ...
  ): Schema$LiveBroadcastListResponse = {
    ...
    __obj.asInstanceOf[Schema$LiveBroadcastListResponse]
  }
}
