...
/**
  ...
  */
@js.native
trait Schema$VideoSnippet extends js.Object {
  /**
  ...
  /**
    ...
    */
  var localized: js.UndefOr[Schema$VideoLocalization] = js.native
  /**
...
object Schema$VideoSnippet {
  ...
  def apply(
    ...
    localized: Schema$VideoLocalization = null,
    ...
    __obj.asInstanceOf[Schema$VideoSnippet]
  }
}
