...
@js.native
trait ParamsDollarResourceDollarSubscriptionsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSubscriptionsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSubscriptionsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSubscriptionsDollarList]
  }
}
