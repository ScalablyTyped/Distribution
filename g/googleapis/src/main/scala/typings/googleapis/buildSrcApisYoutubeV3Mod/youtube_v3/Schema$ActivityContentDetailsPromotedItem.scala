...
/**
  ...
  */
@js.native
trait Schema$ActivityContentDetailsPromotedItem extends js.Object {
  /**
...
object Schema$ActivityContentDetailsPromotedItem {
  @scala.inline
  def apply(
    adTag: String = null,
    ...
    videoId: String = null
  ): Schema$ActivityContentDetailsPromotedItem = {
    ...
    __obj.asInstanceOf[Schema$ActivityContentDetailsPromotedItem]
  }
}
