...
@js.native
trait Schema$LiveBroadcastSnippet extends js.Object {
  /**
...
object Schema$LiveBroadcastSnippet {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$LiveBroadcastSnippet]
  }
}
