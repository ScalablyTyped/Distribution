...
@js.native
trait ParamsDollarResourceDollarPlaylistsDollarUpdate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Playlist] = js.native
}

object ParamsDollarResourceDollarPlaylistsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$Playlist = null,
    userIp: String = null
  ): ParamsDollarResourceDollarPlaylistsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPlaylistsDollarUpdate]
  }
}
