...
@js.native
trait ParamsDollarResourceDollarPlaylistsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPlaylistsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPlaylistsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPlaylistsDollarList]
  }
}
