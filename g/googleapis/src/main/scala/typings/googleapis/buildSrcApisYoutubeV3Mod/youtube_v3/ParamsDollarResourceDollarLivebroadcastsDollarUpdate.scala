...
@js.native
trait ParamsDollarResourceDollarLivebroadcastsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLivebroadcastsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarLivebroadcastsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivebroadcastsDollarUpdate]
  }
}
