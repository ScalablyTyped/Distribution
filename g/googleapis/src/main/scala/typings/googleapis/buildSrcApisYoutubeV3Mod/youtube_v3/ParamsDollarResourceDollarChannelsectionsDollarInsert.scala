...
@js.native
trait ParamsDollarResourceDollarChannelsectionsDollarInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$ChannelSection] = js.native
}

object ParamsDollarResourceDollarChannelsectionsDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$ChannelSection = null,
    userIp: String = null
  ): ParamsDollarResourceDollarChannelsectionsDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChannelsectionsDollarInsert]
  }
}
