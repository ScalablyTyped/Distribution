...
@js.native
trait ParamsDollarResourceDollarSuperchateventsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSuperchateventsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSuperchateventsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSuperchateventsDollarList]
  }
}
