...
@js.native
trait ParamsDollarResourceDollarChannelsectionsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarChannelsectionsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarChannelsectionsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChannelsectionsDollarList]
  }
}
