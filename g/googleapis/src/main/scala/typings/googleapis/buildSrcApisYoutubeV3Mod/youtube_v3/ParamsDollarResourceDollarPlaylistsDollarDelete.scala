...
@js.native
trait ParamsDollarResourceDollarPlaylistsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPlaylistsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPlaylistsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPlaylistsDollarDelete]
  }
}
