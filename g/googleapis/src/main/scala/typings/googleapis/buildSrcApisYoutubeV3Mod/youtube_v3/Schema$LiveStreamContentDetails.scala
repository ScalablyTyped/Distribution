...
/**
  ...
  */
@js.native
trait Schema$LiveStreamContentDetails extends js.Object {
  /**
...
object Schema$LiveStreamContentDetails {
  @scala.inline
  def apply(closedCaptionsIngestionUrl: String = null, isReusable: js.UndefOr[Boolean] = js.undefined): Schema$LiveStreamContentDetails = {
    ...
    __obj.asInstanceOf[Schema$LiveStreamContentDetails]
  }
}
