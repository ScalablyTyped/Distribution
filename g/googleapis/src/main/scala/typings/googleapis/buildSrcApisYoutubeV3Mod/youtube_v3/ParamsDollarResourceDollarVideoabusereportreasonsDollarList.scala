...
@js.native
trait ParamsDollarResourceDollarVideoabusereportreasonsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarVideoabusereportreasonsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarVideoabusereportreasonsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarVideoabusereportreasonsDollarList]
  }
}
