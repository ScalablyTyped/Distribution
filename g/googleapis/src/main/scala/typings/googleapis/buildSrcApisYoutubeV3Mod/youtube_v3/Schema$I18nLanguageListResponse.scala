...
@js.native
trait Schema$I18nLanguageListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$I18nLanguage]] = js.native
  /**
...
object Schema$I18nLanguageListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$I18nLanguage] = null,
    kind: String = null,
    visitorId: String = null
  ): Schema$I18nLanguageListResponse = {
    ...
    __obj.asInstanceOf[Schema$I18nLanguageListResponse]
  }
}
