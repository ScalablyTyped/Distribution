...
@js.native
trait Schema$ChannelListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$Channel]] = js.native
  /**
...
object Schema$ChannelListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$Channel] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$ChannelListResponse]
  }
}
