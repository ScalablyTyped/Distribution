...
@js.native
trait Schema$PlaylistItemListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$PlaylistItem]] = js.native
  /**
...
object Schema$PlaylistItemListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[Schema$PlaylistItem] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$PlaylistItemListResponse]
  }
}
