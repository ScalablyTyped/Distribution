...
class Resource$Activities protected () extends js.Object {
  ...
  /**
    ...
    */
  def insert(): GaxiosPromise[Schema$Activity] = js.native
  def insert(callback: BodyResponseCallback[Schema$Activity]): Unit = js.native
  def insert(params: ParamsDollarResourceDollarActivitiesDollarInsert): GaxiosPromise[Schema$Activity] = js.native
  def insert(
    params: ParamsDollarResourceDollarActivitiesDollarInsert,
  ...
  def insert(params: ParamsDollarResourceDollarActivitiesDollarInsert, options: MethodOptions): GaxiosPromise[Schema$Activity] = js.native
  def insert(
    params: ParamsDollarResourceDollarActivitiesDollarInsert,
  ...
  /**
    ...
    * @return {object} Request object
    */
  def list(): GaxiosPromise[Schema$ActivityListResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ActivityListResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarActivitiesDollarList): GaxiosPromise[Schema$ActivityListResponse] = js.native
  def list(
  ...
  def list(
    params: ParamsDollarResourceDollarActivitiesDollarList,
    options: BodyResponseCallback[Schema$ActivityListResponse],
    callback: BodyResponseCallback[Schema$ActivityListResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarActivitiesDollarList, options: MethodOptions): GaxiosPromise[Schema$ActivityListResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarActivitiesDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ActivityListResponse]
