...
@js.native
trait ParamsDollarResourceDollarChannelbannersDollarInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$ChannelBannerResource] = js.native
}

object ParamsDollarResourceDollarChannelbannersDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$ChannelBannerResource = null,
    userIp: String = null
  ): ParamsDollarResourceDollarChannelbannersDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChannelbannersDollarInsert]
  }
}
