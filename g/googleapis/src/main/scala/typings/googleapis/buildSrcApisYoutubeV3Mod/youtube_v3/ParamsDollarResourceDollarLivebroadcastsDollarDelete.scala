...
@js.native
trait ParamsDollarResourceDollarLivebroadcastsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLivebroadcastsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarLivebroadcastsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivebroadcastsDollarDelete]
  }
}
