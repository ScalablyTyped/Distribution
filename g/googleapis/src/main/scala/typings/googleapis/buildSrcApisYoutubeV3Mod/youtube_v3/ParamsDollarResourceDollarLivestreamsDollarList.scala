...
@js.native
trait ParamsDollarResourceDollarLivestreamsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLivestreamsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarLivestreamsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivestreamsDollarList]
  }
}
