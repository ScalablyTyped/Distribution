...
@js.native
trait ParamsDollarResourceDollarChannelsectionsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarChannelsectionsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarChannelsectionsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChannelsectionsDollarDelete]
  }
}
