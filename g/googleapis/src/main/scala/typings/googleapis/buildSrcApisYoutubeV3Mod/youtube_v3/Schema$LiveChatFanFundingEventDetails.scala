...
@js.native
trait Schema$LiveChatFanFundingEventDetails extends js.Object {
  /**
...
object Schema$LiveChatFanFundingEventDetails {
  @scala.inline
  def apply(
  ...
  ): Schema$LiveChatFanFundingEventDetails = {
    ...
    __obj.asInstanceOf[Schema$LiveChatFanFundingEventDetails]
  }
}
