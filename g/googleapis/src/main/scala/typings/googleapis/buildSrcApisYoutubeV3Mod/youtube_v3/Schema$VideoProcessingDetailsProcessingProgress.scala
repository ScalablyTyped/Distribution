...
/**
  ...
  */
@js.native
trait Schema$VideoProcessingDetailsProcessingProgress extends js.Object {
  /**
...
object Schema$VideoProcessingDetailsProcessingProgress {
  @scala.inline
  def apply(partsProcessed: String = null, partsTotal: String = null, timeLeftMs: String = null): Schema$VideoProcessingDetailsProcessingProgress = {
    ...
    __obj.asInstanceOf[Schema$VideoProcessingDetailsProcessingProgress]
  }
}
