...
@js.native
trait ParamsDollarResourceDollarLivebroadcastsDollarControl extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLivebroadcastsDollarControl {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarLivebroadcastsDollarControl = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLivebroadcastsDollarControl]
  }
}
