...
@js.native
trait ParamsDollarResourceDollarGuidecategoriesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarGuidecategoriesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarGuidecategoriesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarGuidecategoriesDollarList]
  }
}
