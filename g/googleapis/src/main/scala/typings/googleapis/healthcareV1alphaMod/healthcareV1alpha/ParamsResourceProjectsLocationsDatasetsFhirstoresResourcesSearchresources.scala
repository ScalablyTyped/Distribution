...
object ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesSearchresources {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesSearchresourcesOps[Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesSearchresources] (val x: Self) extends AnyVal {
