...
trait ParamsResourceProjectsLocationsDatasetsDicomstoresSetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsDatasetsDicomstoresSetiampolicy {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresSetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresSetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresSetiampolicy](x: Self) {
