...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsListMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsList] (val x: Self) extends AnyVal {
