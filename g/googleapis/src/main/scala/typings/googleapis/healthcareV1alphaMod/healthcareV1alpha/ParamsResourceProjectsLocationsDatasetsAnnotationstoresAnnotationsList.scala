...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsListOps[Self <: ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsList] (val x: Self) extends AnyVal {
