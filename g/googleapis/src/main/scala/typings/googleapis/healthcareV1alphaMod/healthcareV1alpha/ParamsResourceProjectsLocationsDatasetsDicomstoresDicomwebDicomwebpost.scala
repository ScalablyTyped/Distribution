...
object ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebDicomwebpost {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebDicomwebpost = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebDicomwebpost]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebDicomwebpost](x: Self) {
