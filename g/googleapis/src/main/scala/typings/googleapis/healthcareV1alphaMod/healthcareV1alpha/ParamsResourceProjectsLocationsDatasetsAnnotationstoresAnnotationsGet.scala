...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsGetOps[Self <: ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsGet] (val x: Self) extends AnyVal {
