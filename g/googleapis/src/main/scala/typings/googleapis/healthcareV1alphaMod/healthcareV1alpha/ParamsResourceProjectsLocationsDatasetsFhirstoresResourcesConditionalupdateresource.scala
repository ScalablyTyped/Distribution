...
trait ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesConditionalupdateresource
  extends StObject
...
object ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesConditionalupdateresource {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesConditionalupdateresource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesConditionalupdateresource]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresResourcesConditionalupdateresource](x: Self) {
