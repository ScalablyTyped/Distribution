...
object ParamsResourceProjectsLocationsDatasetsFhirstoresCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsFhirstoresCreateOps[Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFhirStoreId(value: String): Self = this.set("fhirStoreId", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFhirStoreId: Self = this.set("fhirStoreId", js.undefined)
    @scala.inline
    def setParent(value: String): Self = this.set("parent", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteParent: Self = this.set("parent", js.undefined)
    @scala.inline
    def setRequestBody(value: SchemaFhirStore): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
