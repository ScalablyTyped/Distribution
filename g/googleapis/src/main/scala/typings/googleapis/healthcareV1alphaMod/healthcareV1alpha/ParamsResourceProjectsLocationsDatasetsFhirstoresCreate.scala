...
object ParamsResourceProjectsLocationsDatasetsFhirstoresCreate {
  ...
  def apply(
    ...
    requestBody: SchemaFhirStore = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceProjectsLocationsDatasetsFhirstoresCreate = {
    ...
    if (fhirStoreId != null) __obj.updateDynamic("fhirStoreId")(fhirStoreId.asInstanceOf[js.Any])
