...
trait ParamsResourceChannelsectionsDelete
  extends StObject
...
object ParamsResourceChannelsectionsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceChannelsectionsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceChannelsectionsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceChannelsectionsDeleteMutableBuilder[Self <: ParamsResourceChannelsectionsDelete] (val x: Self) extends AnyVal {
