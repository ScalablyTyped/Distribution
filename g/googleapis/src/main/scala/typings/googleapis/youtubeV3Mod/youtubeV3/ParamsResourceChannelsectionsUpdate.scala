...
trait ParamsResourceChannelsectionsUpdate
  extends StObject
...
object ParamsResourceChannelsectionsUpdate {
  ...
  inline def apply(): ParamsResourceChannelsectionsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceChannelsectionsUpdate]
  }
  
  extension [Self <: ParamsResourceChannelsectionsUpdate](x: Self) {
