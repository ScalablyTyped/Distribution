...
object SchemaSearchListResponse {
  ...
  @scala.inline
  implicit class SchemaSearchListResponseOps[Self <: SchemaSearchListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaSearchResult*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaSearchResult]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
