...
object SchemaSearchListResponse {
  ...
  @scala.inline
  def apply(): SchemaSearchListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSearchListResponse]
  }
  
  @scala.inline
  implicit class SchemaSearchListResponseMutableBuilder[Self <: SchemaSearchListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SchemaSearchResult]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SchemaSearchResult*): Self = StObject.set(x, "items", js.Array(value :_*))
