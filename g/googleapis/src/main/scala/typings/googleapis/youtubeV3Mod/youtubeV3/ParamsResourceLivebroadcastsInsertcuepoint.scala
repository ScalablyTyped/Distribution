...
trait ParamsResourceLivebroadcastsInsertcuepoint
  extends StObject
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaCuepoint] = js.undefined
}
object ParamsResourceLivebroadcastsInsertcuepoint {
  
  inline def apply(): ParamsResourceLivebroadcastsInsertcuepoint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLivebroadcastsInsertcuepoint]
  }
  
  extension [Self <: ParamsResourceLivebroadcastsInsertcuepoint](x: Self) {
    ...
    inline def setRequestBody(value: SchemaCuepoint): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
