...
object ParamsResourceLivestreamsInsert {
  ...
  inline def apply(): ParamsResourceLivestreamsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLivestreamsInsert]
  }
  
  extension [Self <: ParamsResourceLivestreamsInsert](x: Self) {
    ...
    inline def setRequestBody(value: SchemaLiveStream): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
