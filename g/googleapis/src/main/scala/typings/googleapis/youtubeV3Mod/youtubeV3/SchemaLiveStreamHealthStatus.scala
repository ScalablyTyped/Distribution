...
object SchemaLiveStreamHealthStatus {
  ...
  @scala.inline
  implicit class SchemaLiveStreamHealthStatusMutableBuilder[Self <: SchemaLiveStreamHealthStatus] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setConfigurationIssues(value: js.Array[SchemaLiveStreamConfigurationIssue]): Self = StObject.set(x, "configurationIssues", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setConfigurationIssuesUndefined: Self = StObject.set(x, "configurationIssues", js.undefined)
    
    @scala.inline
    def setConfigurationIssuesVarargs(value: SchemaLiveStreamConfigurationIssue*): Self = StObject.set(x, "configurationIssues", js.Array(value :_*))
