...
trait SchemaVideoCategoryListResponse extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaVideoCategory]] = js.undefined
...
object SchemaVideoCategoryListResponse {
  ...
  inline def apply(): SchemaVideoCategoryListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaVideoCategoryListResponse]
  }
  
  extension [Self <: SchemaVideoCategoryListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaVideoCategory]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaVideoCategory*): Self = StObject.set(x, "items", js.Array(value :_*))
