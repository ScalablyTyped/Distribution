...
trait SchemaSponsorListResponse extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaSponsor]] = js.undefined
...
object SchemaSponsorListResponse {
  ...
  inline def apply(): SchemaSponsorListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSponsorListResponse]
  }
  
  extension [Self <: SchemaSponsorListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaSponsor]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaSponsor*): Self = StObject.set(x, "items", js.Array(value :_*))
