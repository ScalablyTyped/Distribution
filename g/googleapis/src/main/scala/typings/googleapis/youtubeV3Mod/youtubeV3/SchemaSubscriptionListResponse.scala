...
@js.native
trait SchemaSubscriptionListResponse extends js.Object {
  /**
...
object SchemaSubscriptionListResponse {
  ...
  @scala.inline
  implicit class SchemaSubscriptionListResponseOps[Self <: SchemaSubscriptionListResponse] (val x: Self) extends AnyVal {
    @scala.inline
