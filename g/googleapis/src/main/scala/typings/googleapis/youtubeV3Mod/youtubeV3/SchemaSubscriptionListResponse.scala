...
object SchemaSubscriptionListResponse {
  ...
  @scala.inline
  def apply(): SchemaSubscriptionListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSubscriptionListResponse]
  }
  
  @scala.inline
  implicit class SchemaSubscriptionListResponseMutableBuilder[Self <: SchemaSubscriptionListResponse] (val x: Self) extends AnyVal {
