...
trait SchemaSubscriptionListResponse extends StObject {
...
object SchemaSubscriptionListResponse {
  
  inline def apply(): SchemaSubscriptionListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSubscriptionListResponse]
  }
  
  extension [Self <: SchemaSubscriptionListResponse](x: Self) {
    ...
    inline def setItemsVarargs(value: SchemaSubscription*): Self = StObject.set(x, "items", js.Array(value*))
