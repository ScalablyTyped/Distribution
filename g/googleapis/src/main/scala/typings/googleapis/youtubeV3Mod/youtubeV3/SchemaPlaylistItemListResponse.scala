...
object SchemaPlaylistItemListResponse {
  ...
  @scala.inline
  implicit class SchemaPlaylistItemListResponseOps[Self <: SchemaPlaylistItemListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaPlaylistItem*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaPlaylistItem]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
