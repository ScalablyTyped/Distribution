...
trait SchemaPlaylistItemListResponse extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaPlaylistItem]] = js.undefined
...
object SchemaPlaylistItemListResponse {
  ...
  @scala.inline
  def apply(): SchemaPlaylistItemListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPlaylistItemListResponse]
  }
  
  @scala.inline
  implicit class SchemaPlaylistItemListResponseMutableBuilder[Self <: SchemaPlaylistItemListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SchemaPlaylistItem]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SchemaPlaylistItem*): Self = StObject.set(x, "items", js.Array(value :_*))
