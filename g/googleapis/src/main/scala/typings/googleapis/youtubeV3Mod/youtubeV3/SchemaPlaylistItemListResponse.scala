...
object SchemaPlaylistItemListResponse {
  ...
  inline def apply(): SchemaPlaylistItemListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPlaylistItemListResponse]
  }
  
  extension [Self <: SchemaPlaylistItemListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaPlaylistItem]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaPlaylistItem*): Self = StObject.set(x, "items", js.Array(value :_*))
