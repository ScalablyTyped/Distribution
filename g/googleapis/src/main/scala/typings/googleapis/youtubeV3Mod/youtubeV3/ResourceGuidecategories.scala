...
@js.native
class ResourceGuidecategories protected () extends StObject {
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGuideCategoryListResponse] = js.native
