...
object SchemaVideoListResponse {
  ...
  @scala.inline
  implicit class SchemaVideoListResponseOps[Self <: SchemaVideoListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaVideo*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaVideo]): Self = this.set("items", value.asInstanceOf[js.Any])
