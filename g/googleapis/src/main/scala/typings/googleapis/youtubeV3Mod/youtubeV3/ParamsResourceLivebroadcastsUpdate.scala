...
trait ParamsResourceLivebroadcastsUpdate extends StandardParameters {
  ...
  /**
    ...
    * includes the status part, the broadcast's privacy setting will be updated
    * to whatever value the request body specifies. If the request body does
...
object ParamsResourceLivebroadcastsUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceLivebroadcastsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLivebroadcastsUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceLivebroadcastsUpdateMutableBuilder[Self <: ParamsResourceLivebroadcastsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaLiveBroadcast): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
