...
object ParamsResourceLivebroadcastsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceLivebroadcastsUpdateOps[Self <: ParamsResourceLivebroadcastsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaLiveBroadcast): Self = this.set("requestBody", value.asInstanceOf[js.Any])
