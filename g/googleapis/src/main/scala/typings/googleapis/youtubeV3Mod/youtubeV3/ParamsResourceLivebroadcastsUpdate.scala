...
object ParamsResourceLivebroadcastsUpdate {
  ...
  inline def apply(): ParamsResourceLivebroadcastsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLivebroadcastsUpdate]
  }
  
  extension [Self <: ParamsResourceLivebroadcastsUpdate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaLiveBroadcast): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
