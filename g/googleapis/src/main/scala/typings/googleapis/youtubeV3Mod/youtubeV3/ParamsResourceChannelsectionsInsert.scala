...
object ParamsResourceChannelsectionsInsert {
  ...
  @scala.inline
  implicit class ParamsResourceChannelsectionsInsertOps[Self <: ParamsResourceChannelsectionsInsert] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaChannelSection): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
