...
@js.native
open class ResourceI18nregions protected () extends StObject {
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaI18nRegionListResponse] = js.native
  ...
  def list(
    params: ParamsResourceI18nregionsList,
    options: BodyResponseCallback[Readable | SchemaI18nRegionListResponse],
    callback: BodyResponseCallback[Readable | SchemaI18nRegionListResponse]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def list(params: ParamsResourceI18nregionsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceI18nregionsList,
