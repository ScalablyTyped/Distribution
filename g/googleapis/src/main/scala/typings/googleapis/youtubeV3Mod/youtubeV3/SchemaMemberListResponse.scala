...
trait SchemaMemberListResponse extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaMember]] = js.undefined
...
object SchemaMemberListResponse {
  
  inline def apply(): SchemaMemberListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaMemberListResponse]
  }
  
  extension [Self <: SchemaMemberListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaMember]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaMember*): Self = StObject.set(x, "items", js.Array(value*))
