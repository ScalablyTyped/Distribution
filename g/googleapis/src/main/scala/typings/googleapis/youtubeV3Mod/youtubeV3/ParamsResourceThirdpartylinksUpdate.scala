...
trait ParamsResourceThirdpartylinksUpdate
  extends StObject
...
object ParamsResourceThirdpartylinksUpdate {
  
  inline def apply(): ParamsResourceThirdpartylinksUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceThirdpartylinksUpdate]
  }
  
  extension [Self <: ParamsResourceThirdpartylinksUpdate](x: Self) {
