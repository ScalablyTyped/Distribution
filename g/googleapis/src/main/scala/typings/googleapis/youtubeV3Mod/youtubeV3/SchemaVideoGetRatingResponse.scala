...
object SchemaVideoGetRatingResponse {
  ...
  @scala.inline
  implicit class SchemaVideoGetRatingResponseOps[Self <: SchemaVideoGetRatingResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaVideoRating*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaVideoRating]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
