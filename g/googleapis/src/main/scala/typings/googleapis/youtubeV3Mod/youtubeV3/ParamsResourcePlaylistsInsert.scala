...
trait ParamsResourcePlaylistsInsert
  extends StObject
...
object ParamsResourcePlaylistsInsert {
  ...
  @scala.inline
  implicit class ParamsResourcePlaylistsInsertMutableBuilder[Self <: ParamsResourcePlaylistsInsert] (val x: Self) extends AnyVal {
