...
trait SchemaVideoContentDetails extends StObject {
  ...
  /**
    ...
    */
  var hasCustomThumbnail: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * The value of is_license_content indicates whether the video is licensed content.
    */
  var licensedContent: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaVideoContentDetails {
  ...
  extension [Self <: SchemaVideoContentDetails](x: Self) {
    ...
    inline def setHasCustomThumbnailNull: Self = StObject.set(x, "hasCustomThumbnail", null)
    ...
    inline def setLicensedContentNull: Self = StObject.set(x, "licensedContent", null)
