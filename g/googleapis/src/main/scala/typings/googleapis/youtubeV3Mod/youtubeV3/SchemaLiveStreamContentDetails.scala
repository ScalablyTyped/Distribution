...
trait SchemaLiveStreamContentDetails extends StObject {
  ...
  /**
    ...
    */
  var closedCaptionsIngestionUrl: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var isReusable: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaLiveStreamContentDetails {
  ...
  extension [Self <: SchemaLiveStreamContentDetails](x: Self) {
    ...
    inline def setClosedCaptionsIngestionUrlNull: Self = StObject.set(x, "closedCaptionsIngestionUrl", null)
    ...
    inline def setIsReusableNull: Self = StObject.set(x, "isReusable", null)
