...
object SchemaPlaylistListResponse {
  ...
  inline def apply(): SchemaPlaylistListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPlaylistListResponse]
  }
  
  extension [Self <: SchemaPlaylistListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaPlaylist]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaPlaylist*): Self = StObject.set(x, "items", js.Array(value :_*))
