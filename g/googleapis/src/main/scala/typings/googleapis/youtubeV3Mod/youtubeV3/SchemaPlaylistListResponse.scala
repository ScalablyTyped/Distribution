...
trait SchemaPlaylistListResponse extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaPlaylist]] = js.undefined
...
object SchemaPlaylistListResponse {
  ...
  @scala.inline
  implicit class SchemaPlaylistListResponseMutableBuilder[Self <: SchemaPlaylistListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SchemaPlaylist]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SchemaPlaylist*): Self = StObject.set(x, "items", js.Array(value :_*))
