...
object SchemaCaptionListResponse {
  ...
  implicit class SchemaCaptionListResponseOps[Self <: SchemaCaptionListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaCaption*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaCaption]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
