...
object SchemaCaptionListResponse {
  ...
  @scala.inline
  implicit class SchemaCaptionListResponseMutableBuilder[Self <: SchemaCaptionListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SchemaCaption]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SchemaCaption*): Self = StObject.set(x, "items", js.Array(value :_*))
