...
object SchemaCaptionListResponse {
  ...
  inline def apply(): SchemaCaptionListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCaptionListResponse]
  }
  
  extension [Self <: SchemaCaptionListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaCaption]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaCaption*): Self = StObject.set(x, "items", js.Array(value :_*))
