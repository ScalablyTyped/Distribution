...
trait SchemaLiveStreamListResponse extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaLiveStream]] = js.undefined
...
object SchemaLiveStreamListResponse {
  ...
  inline def apply(): SchemaLiveStreamListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaLiveStreamListResponse]
  }
  
  extension [Self <: SchemaLiveStreamListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaLiveStream]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaLiveStream*): Self = StObject.set(x, "items", js.Array(value :_*))
