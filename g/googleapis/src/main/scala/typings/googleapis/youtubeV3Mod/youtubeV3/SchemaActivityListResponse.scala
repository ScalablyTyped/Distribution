...
@js.native
trait SchemaActivityListResponse extends js.Object {
  /**
...
object SchemaActivityListResponse {
  ...
  @scala.inline
  implicit class SchemaActivityListResponseOps[Self <: SchemaActivityListResponse] (val x: Self) extends AnyVal {
    @scala.inline
