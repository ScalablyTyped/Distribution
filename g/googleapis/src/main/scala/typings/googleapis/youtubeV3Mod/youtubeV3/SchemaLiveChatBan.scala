...
object SchemaLiveChatBan {
  ...
  @scala.inline
  implicit class SchemaLiveChatBanOps[Self <: SchemaLiveChatBan] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSnippet(value: SchemaLiveChatBanSnippet): Self = this.set("snippet", value.asInstanceOf[js.Any])
    @scala.inline
