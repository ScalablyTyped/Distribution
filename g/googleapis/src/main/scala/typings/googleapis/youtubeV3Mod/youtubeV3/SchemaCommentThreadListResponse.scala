...
object SchemaCommentThreadListResponse {
  ...
  @scala.inline
  implicit class SchemaCommentThreadListResponseOps[Self <: SchemaCommentThreadListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaCommentThread*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaCommentThread]): Self = this.set("items", value.asInstanceOf[js.Any])
