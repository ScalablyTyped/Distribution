...
object SchemaCommentThreadListResponse {
  ...
  inline def apply(): SchemaCommentThreadListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCommentThreadListResponse]
  }
  
  extension [Self <: SchemaCommentThreadListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaCommentThread]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaCommentThread*): Self = StObject.set(x, "items", js.Array(value :_*))
