...
trait SchemaCommentThreadListResponse extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaCommentThread]] = js.undefined
...
object SchemaCommentThreadListResponse {
  ...
  @scala.inline
  def apply(): SchemaCommentThreadListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCommentThreadListResponse]
  }
  
  @scala.inline
  implicit class SchemaCommentThreadListResponseMutableBuilder[Self <: SchemaCommentThreadListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SchemaCommentThread]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SchemaCommentThread*): Self = StObject.set(x, "items", js.Array(value :_*))
