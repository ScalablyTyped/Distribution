...
object SchemaLiveChatModeratorListResponse {
  ...
  @scala.inline
  implicit class SchemaLiveChatModeratorListResponseOps[Self <: SchemaLiveChatModeratorListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaLiveChatModerator*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaLiveChatModerator]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
