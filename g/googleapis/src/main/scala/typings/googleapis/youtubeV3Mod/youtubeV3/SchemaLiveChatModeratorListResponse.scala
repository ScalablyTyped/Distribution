...
object SchemaLiveChatModeratorListResponse {
  ...
  inline def apply(): SchemaLiveChatModeratorListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaLiveChatModeratorListResponse]
  }
  
  extension [Self <: SchemaLiveChatModeratorListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaLiveChatModerator]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaLiveChatModerator*): Self = StObject.set(x, "items", js.Array(value :_*))
