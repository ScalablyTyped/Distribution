...
trait SchemaLiveChatModeratorListResponse extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaLiveChatModerator]] = js.undefined
...
object SchemaLiveChatModeratorListResponse {
  ...
  @scala.inline
  def apply(): SchemaLiveChatModeratorListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaLiveChatModeratorListResponse]
  }
  
  @scala.inline
  implicit class SchemaLiveChatModeratorListResponseMutableBuilder[Self <: SchemaLiveChatModeratorListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SchemaLiveChatModerator]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SchemaLiveChatModerator*): Self = StObject.set(x, "items", js.Array(value :_*))
