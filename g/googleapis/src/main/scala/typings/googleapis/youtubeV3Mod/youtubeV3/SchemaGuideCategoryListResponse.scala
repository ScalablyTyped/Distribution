...
object SchemaGuideCategoryListResponse {
  ...
  inline def apply(): SchemaGuideCategoryListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGuideCategoryListResponse]
  }
  
  extension [Self <: SchemaGuideCategoryListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaGuideCategory]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaGuideCategory*): Self = StObject.set(x, "items", js.Array(value :_*))
