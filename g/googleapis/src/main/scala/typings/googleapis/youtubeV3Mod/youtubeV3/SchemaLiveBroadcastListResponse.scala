...
trait SchemaLiveBroadcastListResponse extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaLiveBroadcast]] = js.undefined
...
object SchemaLiveBroadcastListResponse {
  ...
  @scala.inline
  def apply(): SchemaLiveBroadcastListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaLiveBroadcastListResponse]
  }
  
  @scala.inline
  implicit class SchemaLiveBroadcastListResponseMutableBuilder[Self <: SchemaLiveBroadcastListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: js.Array[SchemaLiveBroadcast]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    @scala.inline
    def setItemsVarargs(value: SchemaLiveBroadcast*): Self = StObject.set(x, "items", js.Array(value :_*))
