...
object SchemaLiveBroadcastListResponse {
  ...
  @scala.inline
  implicit class SchemaLiveBroadcastListResponseOps[Self <: SchemaLiveBroadcastListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaLiveBroadcast*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaLiveBroadcast]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
