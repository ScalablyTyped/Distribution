...
object SchemaLiveBroadcastListResponse {
  ...
  inline def apply(): SchemaLiveBroadcastListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaLiveBroadcastListResponse]
  }
  
  extension [Self <: SchemaLiveBroadcastListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaLiveBroadcast]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaLiveBroadcast*): Self = StObject.set(x, "items", js.Array(value :_*))
