...
trait ParamsResourceProjectsLocationsGlobalPeeringsList
  extends StObject
...
object ParamsResourceProjectsLocationsGlobalPeeringsList {
  
  inline def apply(): ParamsResourceProjectsLocationsGlobalPeeringsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGlobalPeeringsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGlobalPeeringsList](x: Self) {
