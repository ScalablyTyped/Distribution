...
trait ParamsResourceProjectsLocationsGlobalDomainsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsGlobalDomainsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsGlobalDomainsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGlobalDomainsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGlobalDomainsCreate](x: Self) {
