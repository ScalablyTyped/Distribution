...
trait ParamsResourceProjectsLocationsGlobalDomainsBackupsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsGlobalDomainsBackupsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsGlobalDomainsBackupsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGlobalDomainsBackupsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGlobalDomainsBackupsGetiampolicy](x: Self) {
