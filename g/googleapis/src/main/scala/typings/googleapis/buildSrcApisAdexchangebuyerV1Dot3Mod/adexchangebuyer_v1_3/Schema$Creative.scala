...
import typings.googleapis.Anon_Advertiser
import typings.googleapis.Anon_Date
import typings.googleapis.Anon_Details
...
trait Schema$Creative extends js.Object {
  ...
  /**
    ...
    */
  var corrections: js.UndefOr[js.Array[Anon_Details]] = js.native
  /**
  ...
  /**
    ...
    */
  var nativeAd: js.UndefOr[Anon_Advertiser] = js.native
  /**
...
object Schema$Creative {
  ...
  def apply(
    ...
    corrections: js.Array[Anon_Details] = null,
