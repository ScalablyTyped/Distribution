...
@js.native
trait ParamsDollarResourceDollarSitemapsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSitemapsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    siteUrl: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarSitemapsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSitemapsDollarDelete]
  }
}
