...
@js.native
trait ParamsDollarResourceDollarSitemapsDollarSubmit extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSitemapsDollarSubmit {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    siteUrl: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarSitemapsDollarSubmit = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSitemapsDollarSubmit]
  }
}
