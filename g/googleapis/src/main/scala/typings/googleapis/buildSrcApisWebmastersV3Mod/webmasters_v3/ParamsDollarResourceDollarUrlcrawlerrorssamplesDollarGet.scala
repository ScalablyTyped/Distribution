...
@js.native
trait ParamsDollarResourceDollarUrlcrawlerrorssamplesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarUrlcrawlerrorssamplesDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    url: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarUrlcrawlerrorssamplesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarUrlcrawlerrorssamplesDollarGet]
  }
}
