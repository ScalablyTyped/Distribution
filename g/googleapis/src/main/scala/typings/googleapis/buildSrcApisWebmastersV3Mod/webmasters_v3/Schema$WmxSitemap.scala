...
/**
  ...
  */
@js.native
trait Schema$WmxSitemap extends js.Object {
  /**
    * The various content types in the sitemap.
    */
  var contents: js.UndefOr[js.Array[Schema$WmxSitemapContent]] = js.native
  /**
...
object Schema$WmxSitemap {
  @scala.inline
  def apply(
    contents: js.Array[Schema$WmxSitemapContent] = null,
    errors: String = null,
    ...
    __obj.asInstanceOf[Schema$WmxSitemap]
  }
}
