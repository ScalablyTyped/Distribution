...
trait Schema$Statement extends js.Object {
  ...
  /**
    ...
    */
  var source: js.UndefOr[Schema$Asset] = js.native
  /**
    * Every statement has a target asset. REQUIRED
    */
  var target: js.UndefOr[Schema$Asset] = js.native
}

object Schema$Statement {
  @scala.inline
  def apply(relation: String = null, source: Schema$Asset = null, target: Schema$Asset = null): Schema$Statement = {
