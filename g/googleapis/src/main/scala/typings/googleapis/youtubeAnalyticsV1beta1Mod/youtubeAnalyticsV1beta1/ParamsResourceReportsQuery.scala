...
object ParamsResourceReportsQuery {
  ...
  extension [Self <: ParamsResourceReportsQuery](x: Self) {
    ...
    inline def `setInclude-historical-channel-data`(value: Boolean): Self = StObject.set(x, "include-historical-channel-data", value.asInstanceOf[js.Any])
    
    inline def `setInclude-historical-channel-dataUndefined`: Self = StObject.set(x, "include-historical-channel-data", js.undefined)
