...
@js.native
trait ParamsResourceGoogleserviceaccountsGet extends StandardParameters {
...
object ParamsResourceGoogleserviceaccountsGet {
  ...
  @scala.inline
  implicit class ParamsResourceGoogleserviceaccountsGetOps[Self <: ParamsResourceGoogleserviceaccountsGet] (val x: Self) extends AnyVal {
