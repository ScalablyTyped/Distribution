...
trait SchemaMetadataOptions extends StObject {
  
  /**
    * Specifies how each object's ACLs should be preserved for transfers between Google Cloud Storage buckets. If unspecified, the default behavior is the same as ACL_DESTINATION_BUCKET_DEFAULT.
    */
  var acl: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var symlink: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Specifies how each object's temporary hold status should be preserved for transfers between Google Cloud Storage buckets. If unspecified, the default behavior is the same as TEMPORARY_HOLD_PRESERVE.
    */
  var temporaryHold: js.UndefOr[String | Null] = js.undefined
...
object SchemaMetadataOptions {
  
  inline def apply(): SchemaMetadataOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaMetadataOptions]
  }
  
  extension [Self <: SchemaMetadataOptions](x: Self) {
    ...
    inline def setSymlinkNull: Self = StObject.set(x, "symlink", null)
