...
trait SchemaAwsS3CompatibleData extends StObject {
  ...
  /**
    ...
    */
  var s3Metadata: js.UndefOr[SchemaS3CompatibleMetadata] = js.undefined
}
object SchemaAwsS3CompatibleData {
  
  inline def apply(): SchemaAwsS3CompatibleData = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAwsS3CompatibleData]
  }
  
  extension [Self <: SchemaAwsS3CompatibleData](x: Self) {
    ...
    inline def setS3Metadata(value: SchemaS3CompatibleMetadata): Self = StObject.set(x, "s3Metadata", value.asInstanceOf[js.Any])
