...
trait SchemaGoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta2DocumentEntityNormalizedValue](x: Self) {
