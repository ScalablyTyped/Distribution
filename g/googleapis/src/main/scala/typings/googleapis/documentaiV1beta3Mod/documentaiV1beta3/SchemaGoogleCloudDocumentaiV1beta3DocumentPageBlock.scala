...
trait SchemaGoogleCloudDocumentaiV1beta3DocumentPageBlock extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta3DocumentPageBlock {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3DocumentPageBlock = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3DocumentPageBlock]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3DocumentPageBlock](x: Self) {
