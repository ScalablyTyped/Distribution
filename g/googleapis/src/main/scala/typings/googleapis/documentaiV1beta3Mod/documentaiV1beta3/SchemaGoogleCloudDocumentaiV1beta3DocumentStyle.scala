...
trait SchemaGoogleCloudDocumentaiV1beta3DocumentStyle extends StObject {
  ...
  /**
    * Font size.
    */
  var fontSize: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta3DocumentStyleFontSize] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1beta3DocumentStyle {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3DocumentStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3DocumentStyle]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3DocumentStyle](x: Self) {
    ...
    inline def setFontSize(value: SchemaGoogleCloudDocumentaiV1beta3DocumentStyleFontSize): Self = StObject.set(x, "fontSize", value.asInstanceOf[js.Any])
