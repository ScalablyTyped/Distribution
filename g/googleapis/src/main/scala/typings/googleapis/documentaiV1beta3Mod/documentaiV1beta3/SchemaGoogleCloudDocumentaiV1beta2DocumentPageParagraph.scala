...
trait SchemaGoogleCloudDocumentaiV1beta2DocumentPageParagraph extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta2DocumentPageParagraph {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta2DocumentPageParagraph = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta2DocumentPageParagraph]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta2DocumentPageParagraph](x: Self) {
