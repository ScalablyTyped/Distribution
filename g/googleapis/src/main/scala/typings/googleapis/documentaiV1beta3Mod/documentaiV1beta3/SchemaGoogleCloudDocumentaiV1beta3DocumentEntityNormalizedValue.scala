...
trait SchemaGoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3DocumentEntityNormalizedValue](x: Self) {
