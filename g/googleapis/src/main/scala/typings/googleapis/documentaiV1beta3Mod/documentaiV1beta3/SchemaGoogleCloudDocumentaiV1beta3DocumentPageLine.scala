...
trait SchemaGoogleCloudDocumentaiV1beta3DocumentPageLine extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta3DocumentPageLine {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3DocumentPageLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3DocumentPageLine]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3DocumentPageLine](x: Self) {
