...
trait SchemaGoogleCloudDocumentaiV1beta1DocumentTextAnchorTextSegment extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta1DocumentTextAnchorTextSegment {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta1DocumentTextAnchorTextSegment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta1DocumentTextAnchorTextSegment]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta1DocumentTextAnchorTextSegment](x: Self) {
