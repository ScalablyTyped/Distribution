...
trait SchemaGoogleCloudDocumentaiV1beta3DocumentRevision extends StObject {
  ...
  /**
    ...
    */
  var humanReview: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1beta3DocumentRevision {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3DocumentRevision = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3DocumentRevision]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3DocumentRevision](x: Self) {
    ...
    inline def setHumanReview(value: SchemaGoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview): Self = StObject.set(x, "humanReview", value.asInstanceOf[js.Any])
