...
trait SchemaGoogleCloudDocumentaiV1beta1DocumentPageLine extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta1DocumentPageLine {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta1DocumentPageLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta1DocumentPageLine]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta1DocumentPageLine](x: Self) {
