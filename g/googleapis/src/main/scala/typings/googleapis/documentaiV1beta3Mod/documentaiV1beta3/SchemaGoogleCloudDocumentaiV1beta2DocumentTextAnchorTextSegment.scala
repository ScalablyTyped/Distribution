...
trait SchemaGoogleCloudDocumentaiV1beta2DocumentTextAnchorTextSegment extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta2DocumentTextAnchorTextSegment {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta2DocumentTextAnchorTextSegment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta2DocumentTextAnchorTextSegment]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta2DocumentTextAnchorTextSegment](x: Self) {
