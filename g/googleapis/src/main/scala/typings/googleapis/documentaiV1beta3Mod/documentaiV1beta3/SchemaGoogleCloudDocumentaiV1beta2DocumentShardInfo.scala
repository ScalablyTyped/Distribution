...
trait SchemaGoogleCloudDocumentaiV1beta2DocumentShardInfo extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta2DocumentShardInfo {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta2DocumentShardInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta2DocumentShardInfo]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta2DocumentShardInfo](x: Self) {
