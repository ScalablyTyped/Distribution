...
trait SchemaGoogleCloudDocumentaiV1beta2DocumentPageAnchorPageRef extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta2DocumentPageAnchorPageRef {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta2DocumentPageAnchorPageRef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta2DocumentPageAnchorPageRef]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta2DocumentPageAnchorPageRef](x: Self) {
