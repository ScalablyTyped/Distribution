...
trait SchemaGoogleTypeDateTime extends StObject {
...
object SchemaGoogleTypeDateTime {
  
  inline def apply(): SchemaGoogleTypeDateTime = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleTypeDateTime]
  }
  
  extension [Self <: SchemaGoogleTypeDateTime](x: Self) {
