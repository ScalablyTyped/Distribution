...
trait SchemaGoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3DocumentPageAnchorPageRef](x: Self) {
