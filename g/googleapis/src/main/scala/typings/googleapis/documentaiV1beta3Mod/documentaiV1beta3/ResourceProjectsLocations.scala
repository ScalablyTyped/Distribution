...
@JSImport("googleapis/build/src/apis/documentai/v1beta3", "documentai_v1beta3.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  def fetchProcessorTypes(): GaxiosPromise[SchemaGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse] = js.native
  def fetchProcessorTypes(callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse]): Unit = js.native
  def fetchProcessorTypes(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse] = js.native
  def fetchProcessorTypes(params: ParamsResourceProjectsLocationsFetchprocessortypes): GaxiosPromise[SchemaGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse] = js.native
  def fetchProcessorTypes(
    params: ParamsResourceProjectsLocationsFetchprocessortypes,
    callback: BodyResponseCallback[SchemaGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse]
  ): Unit = js.native
  def fetchProcessorTypes(
    params: ParamsResourceProjectsLocationsFetchprocessortypes,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse]
  ): Unit = js.native
  def fetchProcessorTypes(params: ParamsResourceProjectsLocationsFetchprocessortypes, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse] = js.native
  def fetchProcessorTypes(
    params: ParamsResourceProjectsLocationsFetchprocessortypes,
