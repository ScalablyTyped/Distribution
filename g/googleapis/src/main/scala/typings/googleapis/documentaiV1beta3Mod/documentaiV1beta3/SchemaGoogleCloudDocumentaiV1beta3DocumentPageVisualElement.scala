...
trait SchemaGoogleCloudDocumentaiV1beta3DocumentPageVisualElement extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta3DocumentPageVisualElement {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3DocumentPageVisualElement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3DocumentPageVisualElement]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3DocumentPageVisualElement](x: Self) {
