...
trait SchemaGoogleTypePostalAddress extends StObject {
...
object SchemaGoogleTypePostalAddress {
  
  inline def apply(): SchemaGoogleTypePostalAddress = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleTypePostalAddress]
  }
  
  extension [Self <: SchemaGoogleTypePostalAddress](x: Self) {
