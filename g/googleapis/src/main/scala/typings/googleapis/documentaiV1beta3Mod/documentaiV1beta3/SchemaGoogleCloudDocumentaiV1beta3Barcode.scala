...
trait SchemaGoogleCloudDocumentaiV1beta3Barcode extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta3Barcode {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3Barcode = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3Barcode]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3Barcode](x: Self) {
