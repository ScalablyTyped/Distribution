...
trait SchemaGoogleCloudDocumentaiV1CommonOperationMetadata extends StObject {
...
object SchemaGoogleCloudDocumentaiV1CommonOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1CommonOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1CommonOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1CommonOperationMetadata](x: Self) {
