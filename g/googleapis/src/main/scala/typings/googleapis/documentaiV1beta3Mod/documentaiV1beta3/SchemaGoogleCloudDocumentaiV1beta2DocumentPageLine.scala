...
trait SchemaGoogleCloudDocumentaiV1beta2DocumentPageLine extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta2DocumentPageLine {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta2DocumentPageLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta2DocumentPageLine]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta2DocumentPageLine](x: Self) {
