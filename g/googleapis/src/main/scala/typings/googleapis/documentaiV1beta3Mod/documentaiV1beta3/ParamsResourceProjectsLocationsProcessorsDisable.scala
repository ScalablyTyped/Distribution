...
trait ParamsResourceProjectsLocationsProcessorsDisable
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta3DisableProcessorRequest] = js.undefined
}
object ParamsResourceProjectsLocationsProcessorsDisable {
  ...
  extension [Self <: ParamsResourceProjectsLocationsProcessorsDisable](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDocumentaiV1beta3DisableProcessorRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
