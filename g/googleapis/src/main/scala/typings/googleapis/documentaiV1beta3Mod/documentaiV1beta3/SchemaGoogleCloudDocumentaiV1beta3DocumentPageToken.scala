...
trait SchemaGoogleCloudDocumentaiV1beta3DocumentPageToken extends StObject {
  
  /**
    * Detected break at the end of a Token.
    */
  var detectedBreak: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak] = js.undefined
...
object SchemaGoogleCloudDocumentaiV1beta3DocumentPageToken {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3DocumentPageToken = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3DocumentPageToken]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3DocumentPageToken](x: Self) {
    
    inline def setDetectedBreak(value: SchemaGoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak): Self = StObject.set(x, "detectedBreak", value.asInstanceOf[js.Any])
