...
trait SchemaGoogleCloudDocumentaiV1beta3DocumentPageSymbol extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta3DocumentPageSymbol {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3DocumentPageSymbol = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3DocumentPageSymbol]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3DocumentPageSymbol](x: Self) {
