...
trait ParamsResourceProjectsLocationsProcessorsProcessorversionsDeploy
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDocumentaiV1beta3DeployProcessorVersionRequest] = js.undefined
}
object ParamsResourceProjectsLocationsProcessorsProcessorversionsDeploy {
  ...
  extension [Self <: ParamsResourceProjectsLocationsProcessorsProcessorversionsDeploy](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDocumentaiV1beta3DeployProcessorVersionRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
