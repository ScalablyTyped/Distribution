...
trait SchemaGoogleCloudDocumentaiV1beta3DocumentPageTableTableCell extends StObject {
...
object SchemaGoogleCloudDocumentaiV1beta3DocumentPageTableTableCell {
  
  inline def apply(): SchemaGoogleCloudDocumentaiV1beta3DocumentPageTableTableCell = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDocumentaiV1beta3DocumentPageTableTableCell]
  }
  
  extension [Self <: SchemaGoogleCloudDocumentaiV1beta3DocumentPageTableTableCell](x: Self) {
