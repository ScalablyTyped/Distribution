...
@js.native
trait ParamsDollarResourceDollarAccountsDollarContainersDollarVersionsDollarList extends StandardParameters {
  /**
    * The GTM Account ID.
    */
...
object ParamsDollarResourceDollarAccountsDollarContainersDollarVersionsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarContainersDollarVersionsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarContainersDollarVersionsDollarList]
  }
}
