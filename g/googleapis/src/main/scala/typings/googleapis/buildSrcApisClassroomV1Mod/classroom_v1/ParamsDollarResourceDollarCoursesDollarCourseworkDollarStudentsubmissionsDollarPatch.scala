...
@js.native
trait ParamsDollarResourceDollarCoursesDollarCourseworkDollarStudentsubmissionsDollarPatch extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$StudentSubmission] = js.native
  /**
