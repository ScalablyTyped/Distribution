...
object ParamsResourceProjectsDatabasesDocumentsWrite {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsDatabasesDocumentsWriteOps[Self <: ParamsResourceProjectsDatabasesDocumentsWrite] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaWriteRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
