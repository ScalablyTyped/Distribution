...
object ParamsResourceProjectsDatabasesDocumentsRollback {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsDatabasesDocumentsRollbackMutableBuilder[Self <: ParamsResourceProjectsDatabasesDocumentsRollback] (val x: Self) extends AnyVal {
