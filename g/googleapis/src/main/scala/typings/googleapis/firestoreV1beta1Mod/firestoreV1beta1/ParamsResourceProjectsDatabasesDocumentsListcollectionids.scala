...
object ParamsResourceProjectsDatabasesDocumentsListcollectionids {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsDatabasesDocumentsListcollectionidsOps[Self <: ParamsResourceProjectsDatabasesDocumentsListcollectionids] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaListCollectionIdsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
