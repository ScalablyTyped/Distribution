...
object ParamsResourceProjectsDatabasesDocumentsDelete {
  ...
  def apply(
  ...
  ): ParamsResourceProjectsDatabasesDocumentsDelete = {
    ...
    if (!js.isUndefined(currentDocumentDotexists)) __obj.updateDynamic("currentDocument.exists")(currentDocumentDotexists.asInstanceOf[js.Any])
