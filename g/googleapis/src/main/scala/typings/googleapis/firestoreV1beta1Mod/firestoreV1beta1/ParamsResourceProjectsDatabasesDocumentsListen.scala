...
object ParamsResourceProjectsDatabasesDocumentsListen {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsDatabasesDocumentsListenOps[Self <: ParamsResourceProjectsDatabasesDocumentsListen] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaListenRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
