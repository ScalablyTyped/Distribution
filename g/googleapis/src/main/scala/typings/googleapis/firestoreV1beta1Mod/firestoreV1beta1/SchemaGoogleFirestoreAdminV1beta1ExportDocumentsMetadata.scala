...
object SchemaGoogleFirestoreAdminV1beta1ExportDocumentsMetadata {
  ...
  inline def apply(): SchemaGoogleFirestoreAdminV1beta1ExportDocumentsMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirestoreAdminV1beta1ExportDocumentsMetadata]
  }
  
  extension [Self <: SchemaGoogleFirestoreAdminV1beta1ExportDocumentsMetadata](x: Self) {
