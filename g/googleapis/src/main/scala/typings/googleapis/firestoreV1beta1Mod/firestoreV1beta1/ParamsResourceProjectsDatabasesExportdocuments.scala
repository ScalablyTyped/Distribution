...
trait ParamsResourceProjectsDatabasesExportdocuments
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleFirestoreAdminV1beta1ExportDocumentsRequest] = js.undefined
}
object ParamsResourceProjectsDatabasesExportdocuments {
  ...
  extension [Self <: ParamsResourceProjectsDatabasesExportdocuments](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleFirestoreAdminV1beta1ExportDocumentsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
