...
import typings.googleapis.Anon_ProjectNumber
...
/**
  ...
  */
@js.native
trait Schema$ObjectAccessControl extends js.Object {
  /**
  ...
  /**
    ...
    */
  var projectTeam: js.UndefOr[Anon_ProjectNumber] = js.native
  /**
...
object Schema$ObjectAccessControl {
  @scala.inline
  def apply(
    bucket: String = null,
    domain: String = null,
    ...
    __obj.asInstanceOf[Schema$ObjectAccessControl]
  }
}
