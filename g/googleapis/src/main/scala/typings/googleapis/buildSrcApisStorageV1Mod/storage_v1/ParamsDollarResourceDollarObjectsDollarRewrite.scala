...
@js.native
trait ParamsDollarResourceDollarObjectsDollarRewrite extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarObjectsDollarRewrite {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarObjectsDollarRewrite = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarObjectsDollarRewrite]
  }
}
