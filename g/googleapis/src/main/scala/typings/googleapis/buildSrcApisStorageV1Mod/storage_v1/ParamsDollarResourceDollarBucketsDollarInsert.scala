...
@js.native
trait ParamsDollarResourceDollarBucketsDollarInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Bucket] = js.native
  /**
...
object ParamsDollarResourceDollarBucketsDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$Bucket = null,
    userIp: String = null,
    userProject: String = null
  ): ParamsDollarResourceDollarBucketsDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarBucketsDollarInsert]
  }
}
