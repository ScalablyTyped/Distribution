...
@js.native
trait ParamsDollarResourceDollarBucketsDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarBucketsDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarBucketsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarBucketsDollarPatch]
  }
}
