...
object ParamsResourceProjectsLocationsAutoscalingpoliciesCreate {
  ...
  inline def apply(): ParamsResourceProjectsLocationsAutoscalingpoliciesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAutoscalingpoliciesCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAutoscalingpoliciesCreate](x: Self) {
