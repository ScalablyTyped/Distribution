...
object ParamsResourceProjectsRegionsWorkflowtemplatesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsRegionsWorkflowtemplatesDeleteMutableBuilder[Self <: ParamsResourceProjectsRegionsWorkflowtemplatesDelete] (val x: Self) extends AnyVal {
