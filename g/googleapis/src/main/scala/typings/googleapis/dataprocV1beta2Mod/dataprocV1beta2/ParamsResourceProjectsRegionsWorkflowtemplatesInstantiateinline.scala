...
object ParamsResourceProjectsRegionsWorkflowtemplatesInstantiateinline {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsRegionsWorkflowtemplatesInstantiateinlineOps[Self <: ParamsResourceProjectsRegionsWorkflowtemplatesInstantiateinline] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaWorkflowTemplate): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
