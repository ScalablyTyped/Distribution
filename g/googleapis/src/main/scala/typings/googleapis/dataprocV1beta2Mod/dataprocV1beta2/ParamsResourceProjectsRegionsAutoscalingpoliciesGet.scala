...
object ParamsResourceProjectsRegionsAutoscalingpoliciesGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsRegionsAutoscalingpoliciesGetOps[Self <: ParamsResourceProjectsRegionsAutoscalingpoliciesGet] (val x: Self) extends AnyVal {
    @scala.inline
