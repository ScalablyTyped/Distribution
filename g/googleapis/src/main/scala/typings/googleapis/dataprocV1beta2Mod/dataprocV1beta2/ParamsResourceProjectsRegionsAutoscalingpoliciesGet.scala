...
object ParamsResourceProjectsRegionsAutoscalingpoliciesGet {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsRegionsAutoscalingpoliciesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsRegionsAutoscalingpoliciesGet]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsRegionsAutoscalingpoliciesGetMutableBuilder[Self <: ParamsResourceProjectsRegionsAutoscalingpoliciesGet] (val x: Self) extends AnyVal {
