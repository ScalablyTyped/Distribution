...
object ParamsResourceProjectsRegionsAutoscalingpoliciesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsRegionsAutoscalingpoliciesDeleteOps[Self <: ParamsResourceProjectsRegionsAutoscalingpoliciesDelete] (val x: Self) extends AnyVal {
    @scala.inline
