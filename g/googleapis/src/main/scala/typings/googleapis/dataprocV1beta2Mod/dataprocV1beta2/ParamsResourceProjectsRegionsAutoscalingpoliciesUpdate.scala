...
object ParamsResourceProjectsRegionsAutoscalingpoliciesUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsRegionsAutoscalingpoliciesUpdateOps[Self <: ParamsResourceProjectsRegionsAutoscalingpoliciesUpdate] (val x: Self) extends AnyVal {
    @scala.inline
