...
object ParamsResourceProjectsLocationsWorkflowtemplatesTestiampermissions {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsWorkflowtemplatesTestiampermissions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsWorkflowtemplatesTestiampermissions]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsWorkflowtemplatesTestiampermissionsMutableBuilder[Self <: ParamsResourceProjectsLocationsWorkflowtemplatesTestiampermissions] (val x: Self) extends AnyVal {
