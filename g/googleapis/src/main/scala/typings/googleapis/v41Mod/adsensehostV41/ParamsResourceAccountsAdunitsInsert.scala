...
object ParamsResourceAccountsAdunitsInsert {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsAdunitsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsAdunitsInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsAdunitsInsertMutableBuilder[Self <: ParamsResourceAccountsAdunitsInsert] (val x: Self) extends AnyVal {
