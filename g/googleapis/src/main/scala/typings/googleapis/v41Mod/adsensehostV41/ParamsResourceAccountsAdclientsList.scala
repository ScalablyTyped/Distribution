...
object ParamsResourceAccountsAdclientsList {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsAdclientsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsAdclientsList]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsAdclientsListMutableBuilder[Self <: ParamsResourceAccountsAdclientsList] (val x: Self) extends AnyVal {
