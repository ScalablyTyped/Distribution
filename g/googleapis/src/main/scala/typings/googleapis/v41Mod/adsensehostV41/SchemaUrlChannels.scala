...
object SchemaUrlChannels {
  ...
  @scala.inline
  implicit class SchemaUrlChannelsOps[Self <: SchemaUrlChannels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaUrlChannel*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaUrlChannel]): Self = this.set("items", value.asInstanceOf[js.Any])
