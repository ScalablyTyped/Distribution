...
object SchemaUrlChannels {
  ...
  inline def apply(): SchemaUrlChannels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaUrlChannels]
  }
  
  extension [Self <: SchemaUrlChannels](x: Self) {
    
    inline def setEtag(value: String): Self = StObject.set(x, "etag", value.asInstanceOf[js.Any])
    
    inline def setEtagUndefined: Self = StObject.set(x, "etag", js.undefined)
    
    inline def setItems(value: js.Array[SchemaUrlChannel]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaUrlChannel*): Self = StObject.set(x, "items", js.Array(value :_*))
