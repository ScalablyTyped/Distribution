...
@js.native
trait ParamsResourceAccountsAdclientsGet extends StandardParameters {
  /**
...
object ParamsResourceAccountsAdclientsGet {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsAdclientsGetOps[Self <: ParamsResourceAccountsAdclientsGet] (val x: Self) extends AnyVal {
    @scala.inline
