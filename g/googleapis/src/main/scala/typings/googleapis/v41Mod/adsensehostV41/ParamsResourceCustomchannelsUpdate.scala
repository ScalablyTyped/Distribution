...
object ParamsResourceCustomchannelsUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceCustomchannelsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomchannelsUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceCustomchannelsUpdateMutableBuilder[Self <: ParamsResourceCustomchannelsUpdate] (val x: Self) extends AnyVal {
