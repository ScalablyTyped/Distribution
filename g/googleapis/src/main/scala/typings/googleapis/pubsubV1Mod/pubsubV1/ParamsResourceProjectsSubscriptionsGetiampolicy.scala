...
trait ParamsResourceProjectsSubscriptionsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsSubscriptionsGetiampolicy {
  ...
  inline def apply(): ParamsResourceProjectsSubscriptionsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSubscriptionsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsSubscriptionsGetiampolicy](x: Self) {
