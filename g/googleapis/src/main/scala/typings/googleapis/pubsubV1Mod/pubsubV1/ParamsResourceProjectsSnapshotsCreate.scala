...
object ParamsResourceProjectsSnapshotsCreate {
  ...
  inline def apply(): ParamsResourceProjectsSnapshotsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSnapshotsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsSnapshotsCreate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaCreateSnapshotRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
