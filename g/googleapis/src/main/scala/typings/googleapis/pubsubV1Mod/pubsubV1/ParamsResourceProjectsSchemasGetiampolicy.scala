...
trait ParamsResourceProjectsSchemasGetiampolicy
  extends StObject
...
object ParamsResourceProjectsSchemasGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsSchemasGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSchemasGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsSchemasGetiampolicy](x: Self) {
