...
@js.native
trait ParamsResourceProjectsSnapshotsGet extends StandardParameters {
...
object ParamsResourceProjectsSnapshotsGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsSnapshotsGetOps[Self <: ParamsResourceProjectsSnapshotsGet] (val x: Self) extends AnyVal {
