...
trait ParamsResourceProjectsSubscriptionsCreate
  extends StObject
...
object ParamsResourceProjectsSubscriptionsCreate {
  ...
  inline def apply(): ParamsResourceProjectsSubscriptionsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSubscriptionsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsSubscriptionsCreate](x: Self) {
