...
object ParamsResourceProjectsSubscriptionsPull {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsSubscriptionsPullMutableBuilder[Self <: ParamsResourceProjectsSubscriptionsPull] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaPullRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
