...
object ParamsResourceProjectsSubscriptionsAcknowledge {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsSubscriptionsAcknowledgeOps[Self <: ParamsResourceProjectsSubscriptionsAcknowledge] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaAcknowledgeRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
