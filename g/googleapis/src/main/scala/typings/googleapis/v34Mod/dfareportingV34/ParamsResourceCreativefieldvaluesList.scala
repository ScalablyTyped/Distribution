...
trait ParamsResourceCreativefieldvaluesList
  extends StObject
...
object ParamsResourceCreativefieldvaluesList {
  
  inline def apply(): ParamsResourceCreativefieldvaluesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCreativefieldvaluesList]
  }
  
  extension [Self <: ParamsResourceCreativefieldvaluesList](x: Self) {
