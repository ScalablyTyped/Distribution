...
@JSImport("googleapis/build/src/apis/dfareporting/v3.4", "dfareporting_v3_4.Dfareporting")
@js.native
open class Dfareporting protected () extends StObject {
  ...
  var customEvents: ResourceCustomevents = js.native
