...
/**
  ...
  */
@js.native
trait Schema$GqlQuery extends js.Object {
  /**
  ...
  /**
    ...
    * be `&quot;&quot;`.
    */
  var namedBindings: js.UndefOr[StringDictionary[Schema$GqlQueryParameter]] = js.native
  /**
    ...
    */
  var positionalBindings: js.UndefOr[js.Array[Schema$GqlQueryParameter]] = js.native
  /**
...
object Schema$GqlQuery {
  @scala.inline
  def apply(
    allowLiterals: js.UndefOr[Boolean] = js.undefined,
    namedBindings: StringDictionary[Schema$GqlQueryParameter] = null,
    positionalBindings: js.Array[Schema$GqlQueryParameter] = null,
    ...
    __obj.asInstanceOf[Schema$GqlQuery]
  }
}
