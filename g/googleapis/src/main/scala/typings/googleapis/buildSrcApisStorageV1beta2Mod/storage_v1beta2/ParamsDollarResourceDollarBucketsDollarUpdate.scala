...
@js.native
trait ParamsDollarResourceDollarBucketsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarBucketsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarBucketsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarBucketsDollarUpdate]
  }
}
