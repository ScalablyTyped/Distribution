...
@js.native
trait ParamsDollarResourceDollarDefaultobjectaccesscontrolsDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDefaultobjectaccesscontrolsDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDefaultobjectaccesscontrolsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDefaultobjectaccesscontrolsDollarPatch]
  }
}
