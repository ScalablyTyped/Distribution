...
@js.native
trait ParamsDollarResourceDollarObjectsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarObjectsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarObjectsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarObjectsDollarList]
  }
}
