...
import typings.googleapis.dfareportingV4Mod.dfareportingV4.SchemaRecipient
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait EmailOwnerEmailOwnerDeliveryType extends StObject {
...
object EmailOwnerEmailOwnerDeliveryType {
  
  inline def apply(): EmailOwnerEmailOwnerDeliveryType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EmailOwnerEmailOwnerDeliveryType]
  }
  
  extension [Self <: EmailOwnerEmailOwnerDeliveryType](x: Self) {
