...
trait Fn85 extends StObject {
  ...
  def apply(options: typings.googleapis.deploymentmanagerV2betaMod.deploymentmanagerV2beta.Options): typings.googleapis.deploymentmanagerV2betaMod.deploymentmanagerV2beta.Deploymentmanager = js.native
  ...
  def apply(version: v2beta): typings.googleapis.deploymentmanagerV2betaMod.deploymentmanagerV2beta.Deploymentmanager = js.native
}
