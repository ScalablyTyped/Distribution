...
trait Conjugations extends StObject {
  ...
  var conjugations: js.UndefOr[js.Array[Value]] = js.undefined
...
object Conjugations {
  ...
  extension [Self <: Conjugations](x: Self) {
    ...
    inline def setConjugations(value: js.Array[Value]): Self = StObject.set(x, "conjugations", value.asInstanceOf[js.Any])
