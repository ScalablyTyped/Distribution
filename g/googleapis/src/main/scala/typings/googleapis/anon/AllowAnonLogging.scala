...
object AllowAnonLogging {
  ...
  extension [Self <: AllowAnonLogging](x: Self) {
    ...
    inline def setDimensions(value: Thickness): Self = StObject.set(x, "dimensions", value.asInstanceOf[js.Any])
    ...
    inline def setSeriesInfo(value: SchemaVolumeseriesinfo): Self = StObject.set(x, "seriesInfo", value.asInstanceOf[js.Any])
