...
import typings.googleapis.v34Mod.dfareportingV34.SchemaChannelGrouping
...
import typings.googleapis.v34Mod.dfareportingV34.SchemaPathFilter
import typings.googleapis.v34Mod.dfareportingV34.SchemaSortedDimension
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait CustomChannelGrouping extends StObject {
...
object CustomChannelGrouping {
  
  inline def apply(): CustomChannelGrouping = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CustomChannelGrouping]
  }
  
  extension [Self <: CustomChannelGrouping](x: Self) {
