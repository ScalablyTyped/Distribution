...
import typings.googleapis.dfareportingV4Mod.dfareportingV4.SchemaChannelGrouping
...
import typings.googleapis.dfareportingV4Mod.dfareportingV4.SchemaPathFilter
import typings.googleapis.dfareportingV4Mod.dfareportingV4.SchemaSortedDimension
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ActivityFiltersCustomChannelGrouping extends StObject {
...
object ActivityFiltersCustomChannelGrouping {
  
  inline def apply(): ActivityFiltersCustomChannelGrouping = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ActivityFiltersCustomChannelGrouping]
  }
  
  extension [Self <: ActivityFiltersCustomChannelGrouping](x: Self) {
