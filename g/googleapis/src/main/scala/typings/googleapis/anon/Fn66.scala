...
trait Fn66 extends StObject {
  ...
  def apply(options: typings.googleapis.cloudtraceV2beta1Mod.cloudtraceV2beta1.Options): typings.googleapis.cloudtraceV2beta1Mod.cloudtraceV2beta1.Cloudtrace = js.native
  ...
  def apply(version: v2beta1): typings.googleapis.cloudtraceV2beta1Mod.cloudtraceV2beta1.Cloudtrace = js.native
}
