...
trait PerInteractionDimensions extends StObject {
...
object PerInteractionDimensions {
  
  inline def apply(): PerInteractionDimensions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PerInteractionDimensions]
  }
  
  extension [Self <: PerInteractionDimensions](x: Self) {
