...
@js.native
trait ReachByFrequencyMetricNames extends js.Object {
...
object ReachByFrequencyMetricNames {
  ...
  @scala.inline
  implicit class ReachByFrequencyMetricNamesOps[Self <: ReachByFrequencyMetricNames] (val x: Self) extends AnyVal {
