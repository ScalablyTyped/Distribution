...
trait Fn18 extends StObject {
  ...
  def apply(options: typings.googleapis.androidpublisherV2Mod.androidpublisherV2.Options): typings.googleapis.androidpublisherV2Mod.androidpublisherV2.Androidpublisher = js.native
  ...
  def apply(version: v2): typings.googleapis.androidpublisherV2Mod.androidpublisherV2.Androidpublisher = js.native
