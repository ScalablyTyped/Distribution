...
object AcquiredTime {
  ...
  extension [Self <: AcquiredTime](x: Self) {
    ...
    inline def setReadingPosition(value: SchemaReadingPosition): Self = StObject.set(x, "readingPosition", value.asInstanceOf[js.Any])
    ...
    inline def setReview(value: SchemaReview): Self = StObject.set(x, "review", value.asInstanceOf[js.Any])
