...
trait ParamsResourceAccountsAdclientsCustomchannelsListlinkedadunits
  extends StObject
...
object ParamsResourceAccountsAdclientsCustomchannelsListlinkedadunits {
  
  inline def apply(): ParamsResourceAccountsAdclientsCustomchannelsListlinkedadunits = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsAdclientsCustomchannelsListlinkedadunits]
  }
  
  extension [Self <: ParamsResourceAccountsAdclientsCustomchannelsListlinkedadunits](x: Self) {
