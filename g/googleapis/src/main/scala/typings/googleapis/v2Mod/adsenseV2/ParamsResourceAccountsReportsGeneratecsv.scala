...
trait ParamsResourceAccountsReportsGeneratecsv
  extends StObject
...
object ParamsResourceAccountsReportsGeneratecsv {
  
  inline def apply(): ParamsResourceAccountsReportsGeneratecsv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsReportsGeneratecsv]
  }
  
  extension [Self <: ParamsResourceAccountsReportsGeneratecsv](x: Self) {
