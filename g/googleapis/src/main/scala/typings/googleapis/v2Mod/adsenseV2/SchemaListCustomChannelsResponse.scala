...
trait SchemaListCustomChannelsResponse extends StObject {
...
object SchemaListCustomChannelsResponse {
  
  inline def apply(): SchemaListCustomChannelsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaListCustomChannelsResponse]
  }
  
  extension [Self <: SchemaListCustomChannelsResponse](x: Self) {
