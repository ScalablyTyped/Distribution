...
@js.native
trait ParamsResourceEditsListingsUpdate extends StandardParameters {
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaListing] = js.native
}
object ParamsResourceEditsListingsUpdate {
  
  @scala.inline
  def apply(): ParamsResourceEditsListingsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsListingsUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceEditsListingsUpdateMutableBuilder[Self <: ParamsResourceEditsListingsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaListing): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
