...
object ParamsResourceEditsListingsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceEditsListingsUpdateOps[Self <: ParamsResourceEditsListingsUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaListing): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
