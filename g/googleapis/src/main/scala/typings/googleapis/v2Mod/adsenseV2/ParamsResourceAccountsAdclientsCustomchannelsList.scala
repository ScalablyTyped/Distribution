...
trait ParamsResourceAccountsAdclientsCustomchannelsList
  extends StObject
...
object ParamsResourceAccountsAdclientsCustomchannelsList {
  
  inline def apply(): ParamsResourceAccountsAdclientsCustomchannelsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsAdclientsCustomchannelsList]
  }
  
  extension [Self <: ParamsResourceAccountsAdclientsCustomchannelsList](x: Self) {
