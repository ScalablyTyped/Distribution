...
object ParamsResourceEditsTracksList {
  ...
  @scala.inline
  def apply(): ParamsResourceEditsTracksList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsTracksList]
  }
  
  @scala.inline
  implicit class ParamsResourceEditsTracksListMutableBuilder[Self <: ParamsResourceEditsTracksList] (val x: Self) extends AnyVal {
