...
trait ParamsResourceEditsTracksUpdate
  extends StObject
...
object ParamsResourceEditsTracksUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceEditsTracksUpdateMutableBuilder[Self <: ParamsResourceEditsTracksUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaTrack): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
