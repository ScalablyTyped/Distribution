...
trait ParamsResourceEditsApklistingsPatch
  extends StObject
...
object ParamsResourceEditsApklistingsPatch {
  ...
  inline def apply(): ParamsResourceEditsApklistingsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsApklistingsPatch]
  }
  
  extension [Self <: ParamsResourceEditsApklistingsPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaApkListing): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
