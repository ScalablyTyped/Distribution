...
trait ParamsResourceEditsApklistingsGet
  extends StObject
...
object ParamsResourceEditsApklistingsGet {
  ...
  @scala.inline
  implicit class ParamsResourceEditsApklistingsGetMutableBuilder[Self <: ParamsResourceEditsApklistingsGet] (val x: Self) extends AnyVal {
