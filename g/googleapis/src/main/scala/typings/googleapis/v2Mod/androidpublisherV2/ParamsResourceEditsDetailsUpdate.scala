...
object ParamsResourceEditsDetailsUpdate {
  ...
  inline def apply(): ParamsResourceEditsDetailsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsDetailsUpdate]
  }
  
  extension [Self <: ParamsResourceEditsDetailsUpdate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaAppDetails): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
