...
object SchemaApkListingsListResponse {
  ...
  @scala.inline
  implicit class SchemaApkListingsListResponseOps[Self <: SchemaApkListingsListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setListingsVarargs(value: SchemaApkListing*): Self = this.set("listings", js.Array(value :_*))
    @scala.inline
    def setListings(value: js.Array[SchemaApkListing]): Self = this.set("listings", value.asInstanceOf[js.Any])
    @scala.inline
