...
trait ParamsResourceEditsApklistingsDelete
  extends StObject
...
object ParamsResourceEditsApklistingsDelete {
  ...
  inline def apply(): ParamsResourceEditsApklistingsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEditsApklistingsDelete]
  }
  
  extension [Self <: ParamsResourceEditsApklistingsDelete](x: Self) {
