...
trait ParamsResourcePretargetingconfigGet
  extends StObject
...
object ParamsResourcePretargetingconfigGet {
  ...
  inline def apply(): ParamsResourcePretargetingconfigGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePretargetingconfigGet]
  }
  
  extension [Self <: ParamsResourcePretargetingconfigGet](x: Self) {
