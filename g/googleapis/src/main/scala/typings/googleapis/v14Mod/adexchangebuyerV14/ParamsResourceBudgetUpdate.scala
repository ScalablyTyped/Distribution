...
@js.native
trait ParamsResourceBudgetUpdate extends StandardParameters {
...
object ParamsResourceBudgetUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceBudgetUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBudgetUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceBudgetUpdateOps[Self <: ParamsResourceBudgetUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBudget): Self = this.set("requestBody", value.asInstanceOf[js.Any])
