...
object ParamsResourceProposalsSearch {
  ...
  @scala.inline
  def apply(): ParamsResourceProposalsSearch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProposalsSearch]
  }
  
  @scala.inline
  implicit class ParamsResourceProposalsSearchMutableBuilder[Self <: ParamsResourceProposalsSearch] (val x: Self) extends AnyVal {
