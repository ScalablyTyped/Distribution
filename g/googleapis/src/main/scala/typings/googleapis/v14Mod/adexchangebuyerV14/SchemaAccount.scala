...
trait SchemaAccount extends StObject {
  ...
  /**
    ...
    */
  var applyPretargetingToNonGuaranteedDeals: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * Your bidder locations that have distinct URLs.
    */
  var bidderLocation: js.UndefOr[js.Array[BidProtocol] | Null] = js.undefined
...
object SchemaAccount {
  ...
  extension [Self <: SchemaAccount](x: Self) {
    ...
    inline def setApplyPretargetingToNonGuaranteedDealsNull: Self = StObject.set(x, "applyPretargetingToNonGuaranteedDeals", null)
