...
trait SchemaGoogleCloudChannelV1TrialSettings extends StObject {
...
object SchemaGoogleCloudChannelV1TrialSettings {
  
  inline def apply(): SchemaGoogleCloudChannelV1TrialSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudChannelV1TrialSettings]
  }
  
  extension [Self <: SchemaGoogleCloudChannelV1TrialSettings](x: Self) {
