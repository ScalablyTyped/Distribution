...
trait ParamsResourceAccountsCustomersList
  extends StObject
...
object ParamsResourceAccountsCustomersList {
  
  inline def apply(): ParamsResourceAccountsCustomersList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsCustomersList]
  }
  
  extension [Self <: ParamsResourceAccountsCustomersList](x: Self) {
