...
trait SchemaGoogleCloudChannelV1alpha1Value extends StObject {
...
object SchemaGoogleCloudChannelV1alpha1Value {
  
  inline def apply(): SchemaGoogleCloudChannelV1alpha1Value = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudChannelV1alpha1Value]
  }
  
  extension [Self <: SchemaGoogleCloudChannelV1alpha1Value](x: Self) {
