...
trait SchemaGoogleCloudChannelV1ProvisionedService extends StObject {
...
object SchemaGoogleCloudChannelV1ProvisionedService {
  
  inline def apply(): SchemaGoogleCloudChannelV1ProvisionedService = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudChannelV1ProvisionedService]
  }
  
  extension [Self <: SchemaGoogleCloudChannelV1ProvisionedService](x: Self) {
