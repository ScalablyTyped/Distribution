...
trait SchemaGoogleCloudChannelV1ChangeParametersRequest extends StObject {
...
object SchemaGoogleCloudChannelV1ChangeParametersRequest {
  
  inline def apply(): SchemaGoogleCloudChannelV1ChangeParametersRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudChannelV1ChangeParametersRequest]
  }
  
  extension [Self <: SchemaGoogleCloudChannelV1ChangeParametersRequest](x: Self) {
