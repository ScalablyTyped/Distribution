...
trait SchemaGoogleCloudChannelV1Period extends StObject {
...
object SchemaGoogleCloudChannelV1Period {
  
  inline def apply(): SchemaGoogleCloudChannelV1Period = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudChannelV1Period]
  }
  
  extension [Self <: SchemaGoogleCloudChannelV1Period](x: Self) {
