...
trait SchemaGoogleCloudChannelV1EntitlementEvent extends StObject {
...
object SchemaGoogleCloudChannelV1EntitlementEvent {
  
  inline def apply(): SchemaGoogleCloudChannelV1EntitlementEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudChannelV1EntitlementEvent]
  }
  
  extension [Self <: SchemaGoogleCloudChannelV1EntitlementEvent](x: Self) {
