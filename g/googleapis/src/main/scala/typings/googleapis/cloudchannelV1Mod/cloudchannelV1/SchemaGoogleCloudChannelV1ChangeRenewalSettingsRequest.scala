...
trait SchemaGoogleCloudChannelV1ChangeRenewalSettingsRequest extends StObject {
...
object SchemaGoogleCloudChannelV1ChangeRenewalSettingsRequest {
  
  inline def apply(): SchemaGoogleCloudChannelV1ChangeRenewalSettingsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudChannelV1ChangeRenewalSettingsRequest]
  }
  
  extension [Self <: SchemaGoogleCloudChannelV1ChangeRenewalSettingsRequest](x: Self) {
