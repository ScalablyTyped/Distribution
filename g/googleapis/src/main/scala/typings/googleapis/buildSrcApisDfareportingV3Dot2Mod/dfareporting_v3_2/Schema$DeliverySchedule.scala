...
/**
  ...
  */
@js.native
trait Schema$DeliverySchedule extends js.Object {
  /**
    * Limit on the number of times an individual user can be served the ad
    * within a specified period of time.
    */
  var frequencyCap: js.UndefOr[Schema$FrequencyCap] = js.native
  /**
...
object Schema$DeliverySchedule {
  @scala.inline
  def apply(
    frequencyCap: Schema$FrequencyCap = null,
    hardCutoff: js.UndefOr[Boolean] = js.undefined,
    impressionRatio: String = null,
    priority: String = null
  ): Schema$DeliverySchedule = {
    ...
    __obj.asInstanceOf[Schema$DeliverySchedule]
  }
}
