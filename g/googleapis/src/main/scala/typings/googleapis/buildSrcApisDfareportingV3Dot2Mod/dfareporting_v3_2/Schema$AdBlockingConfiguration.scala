...
/**
  ...
  */
@js.native
trait Schema$AdBlockingConfiguration extends js.Object {
  /**
...
object Schema$AdBlockingConfiguration {
  @scala.inline
  def apply(
  ...
  ): Schema$AdBlockingConfiguration = {
    ...
    __obj.asInstanceOf[Schema$AdBlockingConfiguration]
  }
}
