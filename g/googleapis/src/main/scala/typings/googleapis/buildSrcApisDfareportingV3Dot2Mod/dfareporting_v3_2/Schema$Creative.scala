...
/**
  ...
  */
@js.native
trait Schema$Creative extends js.Object {
  /**
  ...
  /**
    ...
    */
  var backupImageClickThroughUrl: js.UndefOr[Schema$CreativeClickThroughUrl] = js.native
  /**
  ...
  /**
    ...
    */
  var backupImageTargetWindow: js.UndefOr[Schema$TargetWindow] = js.native
  /**
  ...
  /**
    ...
    */
  var counterCustomEvents: js.UndefOr[js.Array[Schema$CreativeCustomEvent]] = js.native
  /**
    * Required if dynamicAssetSelection is true.
    */
  var creativeAssetSelection: js.UndefOr[Schema$CreativeAssetSelection] = js.native
  /**
    ...
    * REDIRECT
    */
  var creativeAssets: js.UndefOr[js.Array[Schema$CreativeAsset]] = js.native
  /**
    * Creative field assignments for this creative. Applicable to all creative
    * types.
    */
  var creativeFieldAssignments: js.UndefOr[js.Array[Schema$CreativeFieldAssignment]] = js.native
  /**
  ...
  /**
    ...
    */
  var exitCustomEvents: js.UndefOr[js.Array[Schema$CreativeCustomEvent]] = js.native
  /**
    ...
    * Applicable to the following creative types: FLASH_INPAGE.
    */
  var fsCommand: js.UndefOr[Schema$FsCommand] = js.native
  /**
  ...
  /**
    ...
    */
  var renderingIdDimensionValue: js.UndefOr[Schema$DimensionValue] = js.native
  /**
  ...
  /**
    ...
    * all VPAID.
    */
  var thirdPartyUrls: js.UndefOr[js.Array[Schema$ThirdPartyTrackingUrl]] = js.native
  /**
    ...
    */
  var timerCustomEvents: js.UndefOr[js.Array[Schema$CreativeCustomEvent]] = js.native
  /**
  ...
  /**
    ...
    */
  var universalAdId: js.UndefOr[Schema$UniversalAdId] = js.native
  /**
...
object Schema$Creative {
  ...
  def apply(
    ...
    backupImageClickThroughUrl: Schema$CreativeClickThroughUrl = null,
    backupImageFeatures: js.Array[String] = null,
    backupImageReportingLabel: String = null,
    backupImageTargetWindow: Schema$TargetWindow = null,
    ...
    counterCustomEvents: js.Array[Schema$CreativeCustomEvent] = null,
    creativeAssetSelection: Schema$CreativeAssetSelection = null,
    creativeAssets: js.Array[Schema$CreativeAsset] = null,
    creativeFieldAssignments: js.Array[Schema$CreativeFieldAssignment] = null,
    customKeyValues: js.Array[String] = null,
    dynamicAssetSelection: js.UndefOr[Boolean] = js.undefined,
    exitCustomEvents: js.Array[Schema$CreativeCustomEvent] = null,
    fsCommand: Schema$FsCommand = null,
    ...
    renderingIdDimensionValue: Schema$DimensionValue = null,
    ...
    thirdPartyUrls: js.Array[Schema$ThirdPartyTrackingUrl] = null,
    timerCustomEvents: js.Array[Schema$CreativeCustomEvent] = null,
    totalFileSize: String = null,
    `type`: String = null,
    universalAdId: Schema$UniversalAdId = null,
    ...
    __obj.asInstanceOf[Schema$Creative]
  }
}
