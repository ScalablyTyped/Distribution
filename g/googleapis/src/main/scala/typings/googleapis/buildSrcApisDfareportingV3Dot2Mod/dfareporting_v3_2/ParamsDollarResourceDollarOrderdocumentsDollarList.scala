...
@js.native
trait ParamsDollarResourceDollarOrderdocumentsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarOrderdocumentsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarOrderdocumentsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarOrderdocumentsDollarList]
  }
}
