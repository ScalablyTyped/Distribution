...
@js.native
trait ParamsDollarResourceDollarSitesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSitesDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSitesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSitesDollarList]
  }
}
