...
@js.native
trait ParamsDollarResourceDollarCreativefieldvaluesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCreativefieldvaluesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCreativefieldvaluesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCreativefieldvaluesDollarList]
  }
}
