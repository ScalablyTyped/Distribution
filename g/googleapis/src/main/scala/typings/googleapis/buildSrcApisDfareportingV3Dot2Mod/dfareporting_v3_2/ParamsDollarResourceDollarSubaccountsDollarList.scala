...
@js.native
trait ParamsDollarResourceDollarSubaccountsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSubaccountsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSubaccountsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSubaccountsDollarList]
  }
}
