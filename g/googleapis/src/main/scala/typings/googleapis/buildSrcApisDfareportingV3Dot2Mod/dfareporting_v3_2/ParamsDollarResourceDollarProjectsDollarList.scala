...
@js.native
trait ParamsDollarResourceDollarProjectsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarProjectsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarProjectsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarProjectsDollarList]
  }
}
