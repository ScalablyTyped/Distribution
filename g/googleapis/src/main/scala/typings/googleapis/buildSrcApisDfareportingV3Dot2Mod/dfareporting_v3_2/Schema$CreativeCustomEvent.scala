...
/**
  ...
  */
@js.native
trait Schema$CreativeCustomEvent extends js.Object {
  /**
  ...
  /**
    ...
    * events.
    */
  var exitClickThroughUrl: js.UndefOr[Schema$CreativeClickThroughUrl] = js.native
  /**
  ...
  /**
    ...
    * events.
    */
  var popupWindowProperties: js.UndefOr[Schema$PopupWindowProperties] = js.native
  /**
...
object Schema$CreativeCustomEvent {
  @scala.inline
  def apply(
    ...
    exitClickThroughUrl: Schema$CreativeClickThroughUrl = null,
    id: String = null,
    popupWindowProperties: Schema$PopupWindowProperties = null,
    targetType: String = null,
    videoReportingId: String = null
  ): Schema$CreativeCustomEvent = {
    ...
    __obj.asInstanceOf[Schema$CreativeCustomEvent]
  }
}
