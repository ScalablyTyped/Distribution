...
/**
  ...
  */
@js.native
trait Schema$CreativeAssignment extends js.Object {
  /**
  ...
  /**
    ...
    * video ads.
    */
  var companionCreativeOverrides: js.UndefOr[js.Array[Schema$CompanionClickThroughOverride]] = js.native
  /**
  ...
  /**
    ...
    */
  var creativeIdDimensionValue: js.UndefOr[Schema$DimensionValue] = js.native
  /**
  ...
  /**
    ...
    */
  var richMediaExitOverrides: js.UndefOr[js.Array[Schema$RichMediaExitOverride]] = js.native
  /**
...
object Schema$CreativeAssignment {
  @scala.inline
  def apply(
    active: js.UndefOr[Boolean] = js.undefined,
    applyEventTags: js.UndefOr[Boolean] = js.undefined,
    clickThroughUrl: Schema$ClickThroughUrl = null,
    companionCreativeOverrides: js.Array[Schema$CompanionClickThroughOverride] = null,
    creativeGroupAssignments: js.Array[Schema$CreativeGroupAssignment] = null,
    creativeId: String = null,
    creativeIdDimensionValue: Schema$DimensionValue = null,
    endTime: String = null,
    richMediaExitOverrides: js.Array[Schema$RichMediaExitOverride] = null,
    sequence: Int | Double = null,
    sslCompliant: js.UndefOr[Boolean] = js.undefined,
    startTime: String = null,
    weight: Int | Double = null
  ): Schema$CreativeAssignment = {
    val __obj = js.Dynamic.literal()
    if (!js.isUndefined(active)) __obj.updateDynamic("active")(active.asInstanceOf[js.Any])
    if (!js.isUndefined(applyEventTags)) __obj.updateDynamic("applyEventTags")(applyEventTags.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[Schema$CreativeAssignment]
  }
}
