...
/**
  ...
  */
@js.native
trait Schema$OrderDocument extends js.Object {
  /**
  ...
  /**
    ...
    */
  var createdInfo: js.UndefOr[Schema$LastModifiedInfo] = js.native
  /**
...
object Schema$OrderDocument {
  ...
  def apply(
    ...
    createdInfo: Schema$LastModifiedInfo = null,
    ...
    __obj.asInstanceOf[Schema$OrderDocument]
  }
}
