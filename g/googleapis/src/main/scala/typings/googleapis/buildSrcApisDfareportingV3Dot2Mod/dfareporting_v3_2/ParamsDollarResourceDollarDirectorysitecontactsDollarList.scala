...
@js.native
trait ParamsDollarResourceDollarDirectorysitecontactsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDirectorysitecontactsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDirectorysitecontactsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDirectorysitecontactsDollarList]
  }
}
