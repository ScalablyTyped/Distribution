...
@js.native
trait ParamsDollarResourceDollarPlacementstrategiesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPlacementstrategiesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPlacementstrategiesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPlacementstrategiesDollarList]
  }
}
