...
trait SchemaV2LogEntrySourceLocation extends StObject {
...
object SchemaV2LogEntrySourceLocation {
  
  inline def apply(): SchemaV2LogEntrySourceLocation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaV2LogEntrySourceLocation]
  }
  
  extension [Self <: SchemaV2LogEntrySourceLocation](x: Self) {
