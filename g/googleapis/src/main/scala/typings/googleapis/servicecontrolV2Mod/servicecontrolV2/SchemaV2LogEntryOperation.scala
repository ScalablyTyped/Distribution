...
trait SchemaV2LogEntryOperation extends StObject {
...
object SchemaV2LogEntryOperation {
  
  inline def apply(): SchemaV2LogEntryOperation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaV2LogEntryOperation]
  }
  
  extension [Self <: SchemaV2LogEntryOperation](x: Self) {
