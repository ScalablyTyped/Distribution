...
trait SchemaV2HttpRequest extends StObject {
...
object SchemaV2HttpRequest {
  
  inline def apply(): SchemaV2HttpRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaV2HttpRequest]
  }
  
  extension [Self <: SchemaV2HttpRequest](x: Self) {
