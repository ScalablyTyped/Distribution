...
@js.native
trait ParamsDollarResourceDollarTaskDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTaskDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    taskId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarTaskDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTaskDollarGet]
  }
}
