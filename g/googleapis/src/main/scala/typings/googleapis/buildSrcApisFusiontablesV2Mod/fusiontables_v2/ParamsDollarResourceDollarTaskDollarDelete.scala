...
@js.native
trait ParamsDollarResourceDollarTaskDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTaskDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    taskId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarTaskDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTaskDollarDelete]
  }
}
