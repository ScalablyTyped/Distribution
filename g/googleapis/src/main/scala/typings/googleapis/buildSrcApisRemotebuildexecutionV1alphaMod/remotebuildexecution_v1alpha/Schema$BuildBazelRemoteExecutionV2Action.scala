...
/**
  ...
  */
@js.native
trait Schema$BuildBazelRemoteExecutionV2Action extends js.Object {
  /**
    * The digest of the Command to run, which MUST be present in the
    * ContentAddressableStorage.
    */
  var commandDigest: js.UndefOr[Schema$BuildBazelRemoteExecutionV2Digest] = js.native
  /**
  ...
  /**
    ...
    * ContentAddressableStorage.
    */
  var inputRootDigest: js.UndefOr[Schema$BuildBazelRemoteExecutionV2Digest] = js.native
  /**
...
object Schema$BuildBazelRemoteExecutionV2Action {
  @scala.inline
  def apply(
    commandDigest: Schema$BuildBazelRemoteExecutionV2Digest = null,
    doNotCache: js.UndefOr[Boolean] = js.undefined,
    inputRootDigest: Schema$BuildBazelRemoteExecutionV2Digest = null,
    timeout: String = null
  ): Schema$BuildBazelRemoteExecutionV2Action = {
    ...
    __obj.asInstanceOf[Schema$BuildBazelRemoteExecutionV2Action]
  }
}
