...
/**
  ...
  */
@js.native
trait Schema$GoogleDevtoolsRemoteworkersV1test2CommandResult extends js.Object {
  /**
...
object Schema$GoogleDevtoolsRemoteworkersV1test2CommandResult {
  @scala.inline
  def apply(
    duration: String = null,
    exitCode: Int | Double = null,
    metadata: js.Array[StringDictionary[_]] = null,
    outputs: Schema$GoogleDevtoolsRemoteworkersV1test2Digest = null,
    overhead: String = null,
    status: Schema$GoogleRpcStatus = null
  ): Schema$GoogleDevtoolsRemoteworkersV1test2CommandResult = {
    ...
    __obj.asInstanceOf[Schema$GoogleDevtoolsRemoteworkersV1test2CommandResult]
  }
}
