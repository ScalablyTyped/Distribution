...
/**
  ...
  */
@js.native
trait Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs extends js.Object {
  /**
...
object Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs]
  }
}
