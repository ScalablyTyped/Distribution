...
/**
  ...
  */
@js.native
trait Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts extends js.Object {
  /**
...
object Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts {
  @scala.inline
  def apply(execution: String = null, idle: String = null, shutdown: String = null): Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts = {
    ...
    __obj.asInstanceOf[Schema$GoogleDevtoolsRemoteworkersV1test2CommandTaskTimeouts]
  }
}
