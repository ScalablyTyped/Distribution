...
trait ParamsResourcePartnersProductsList
  extends StObject
...
object ParamsResourcePartnersProductsList {
  
  inline def apply(): ParamsResourcePartnersProductsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePartnersProductsList]
  }
  
  extension [Self <: ParamsResourcePartnersProductsList](x: Self) {
