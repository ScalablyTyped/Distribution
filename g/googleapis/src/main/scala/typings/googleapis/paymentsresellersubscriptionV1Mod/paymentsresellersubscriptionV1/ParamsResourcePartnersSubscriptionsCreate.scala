...
trait ParamsResourcePartnersSubscriptionsCreate
  extends StObject
...
object ParamsResourcePartnersSubscriptionsCreate {
  
  inline def apply(): ParamsResourcePartnersSubscriptionsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePartnersSubscriptionsCreate]
  }
  
  extension [Self <: ParamsResourcePartnersSubscriptionsCreate](x: Self) {
