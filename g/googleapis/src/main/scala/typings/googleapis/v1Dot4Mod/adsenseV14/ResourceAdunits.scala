...
@js.native
open class ResourceAdunits protected () extends StObject {
  ...
  /**
    ...
    */
  def get(params: ParamsResourceAdunitsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceAdunitsGet,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def getAdCode(params: ParamsResourceAdunitsGetadcode, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def getAdCode(
    params: ParamsResourceAdunitsGetadcode,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceAdunitsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceAdunitsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
