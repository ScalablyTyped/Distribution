...
@js.native
open class ResourceSavedadstyles protected () extends StObject {
  ...
  /**
    ...
    */
  def get(params: ParamsResourceSavedadstylesGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceSavedadstylesGet,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceSavedadstylesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceSavedadstylesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
