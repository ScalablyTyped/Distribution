...
@js.native
open class ResourceCustomchannelsAdunits protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceCustomchannelsAdunitsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceCustomchannelsAdunitsList,
