...
object SchemaSavedAdStyles {
  ...
  @scala.inline
  implicit class SchemaSavedAdStylesOps[Self <: SchemaSavedAdStyles] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaSavedAdStyle*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaSavedAdStyle]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
