...
@js.native
trait ParamsResourceAccountsUrlchannelsList extends StandardParameters {
...
object ParamsResourceAccountsUrlchannelsList {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsUrlchannelsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsUrlchannelsList]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsUrlchannelsListMutableBuilder[Self <: ParamsResourceAccountsUrlchannelsList] (val x: Self) extends AnyVal {
