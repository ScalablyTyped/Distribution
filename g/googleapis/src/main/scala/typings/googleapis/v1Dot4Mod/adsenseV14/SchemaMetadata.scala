...
object SchemaMetadata {
  ...
  extension [Self <: SchemaMetadata](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaReportingMetadataEntry]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaReportingMetadataEntry*): Self = StObject.set(x, "items", js.Array(value :_*))
