...
@js.native
open class ResourceAccountsUrlchannels protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceAccountsUrlchannelsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceAccountsUrlchannelsList,
