...
object ParamsResourceReportsGenerate {
  @scala.inline
  def apply(
    accountId: js.Array[String] = null,
    alt: String = null,
    ...
    if (!js.isUndefined(useTimezoneReporting)) __obj.updateDynamic("useTimezoneReporting")(useTimezoneReporting.get.asInstanceOf[js.Any])
