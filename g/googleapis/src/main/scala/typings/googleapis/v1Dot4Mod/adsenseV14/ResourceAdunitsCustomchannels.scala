...
@js.native
open class ResourceAdunitsCustomchannels protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceAdunitsCustomchannelsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceAdunitsCustomchannelsList,
