...
@js.native
open class ResourceMetadataDimensions protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceMetadataDimensionsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceMetadataDimensionsList,
