...
trait ParamsResourceCustomchannelsAdunitsList
  extends StObject
...
object ParamsResourceCustomchannelsAdunitsList {
  ...
  @scala.inline
  def apply(): ParamsResourceCustomchannelsAdunitsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomchannelsAdunitsList]
  }
  
  @scala.inline
  implicit class ParamsResourceCustomchannelsAdunitsListMutableBuilder[Self <: ParamsResourceCustomchannelsAdunitsList] (val x: Self) extends AnyVal {
