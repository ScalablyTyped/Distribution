...
@JSImport("googleapis/build/src/apis/servicedirectory/v1", "servicedirectory_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var namespaces: ResourceProjectsLocationsNamespaces = js.native
}
