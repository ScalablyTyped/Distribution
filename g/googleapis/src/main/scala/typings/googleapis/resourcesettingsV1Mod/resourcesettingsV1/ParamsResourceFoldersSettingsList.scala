...
trait ParamsResourceFoldersSettingsList
  extends StObject
...
object ParamsResourceFoldersSettingsList {
  
  inline def apply(): ParamsResourceFoldersSettingsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersSettingsList]
  }
  
  extension [Self <: ParamsResourceFoldersSettingsList](x: Self) {
