...
@JSImport("googleapis/build/src/apis/resourcesettings/v1", "resourcesettings_v1.Resource$Projects$Settings")
@js.native
open class ResourceProjectsSettings protected () extends StObject {
  ...
  def get(params: ParamsResourceProjectsSettingsGet): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1Setting] = js.native
  def get(
    params: ParamsResourceProjectsSettingsGet,
  ...
  def get(params: ParamsResourceProjectsSettingsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1Setting] = js.native
  def get(
    params: ParamsResourceProjectsSettingsGet,
  ...
  /**
    ...
    */
  def get(params: ParamsResourceProjectsSettingsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceProjectsSettingsGet,
  ...
  def list(params: ParamsResourceProjectsSettingsList): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1ListSettingsResponse] = js.native
  def list(
    params: ParamsResourceProjectsSettingsList,
  ...
  def list(params: ParamsResourceProjectsSettingsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1ListSettingsResponse] = js.native
  def list(
    params: ParamsResourceProjectsSettingsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudResourcesettingsV1ListSettingsResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceProjectsSettingsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsSettingsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def patch(params: ParamsResourceProjectsSettingsPatch): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1Setting] = js.native
  def patch(
    params: ParamsResourceProjectsSettingsPatch,
    callback: BodyResponseCallback[SchemaGoogleCloudResourcesettingsV1Setting]
  ): Unit = js.native
  def patch(
    params: ParamsResourceProjectsSettingsPatch,
  ...
  def patch(params: ParamsResourceProjectsSettingsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1Setting] = js.native
  def patch(
    params: ParamsResourceProjectsSettingsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudResourcesettingsV1Setting]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def patch(params: ParamsResourceProjectsSettingsPatch, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def patch(
    params: ParamsResourceProjectsSettingsPatch,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
