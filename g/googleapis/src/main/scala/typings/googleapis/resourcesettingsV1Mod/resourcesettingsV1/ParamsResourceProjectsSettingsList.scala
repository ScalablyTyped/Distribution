...
trait ParamsResourceProjectsSettingsList
  extends StObject
...
object ParamsResourceProjectsSettingsList {
  
  inline def apply(): ParamsResourceProjectsSettingsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSettingsList]
  }
  
  extension [Self <: ParamsResourceProjectsSettingsList](x: Self) {
