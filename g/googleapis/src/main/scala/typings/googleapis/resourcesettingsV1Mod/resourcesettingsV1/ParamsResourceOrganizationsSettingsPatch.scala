...
trait ParamsResourceOrganizationsSettingsPatch
  extends StObject
...
object ParamsResourceOrganizationsSettingsPatch {
  
  inline def apply(): ParamsResourceOrganizationsSettingsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsSettingsPatch]
  }
  
  extension [Self <: ParamsResourceOrganizationsSettingsPatch](x: Self) {
