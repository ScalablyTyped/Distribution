...
trait ParamsResourceProjectsSettingsPatch
  extends StObject
...
object ParamsResourceProjectsSettingsPatch {
  
  inline def apply(): ParamsResourceProjectsSettingsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSettingsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsSettingsPatch](x: Self) {
