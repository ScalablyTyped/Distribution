...
@JSImport("googleapis/build/src/apis/resourcesettings/v1", "resourcesettings_v1.Resource$Folders$Settings")
@js.native
open class ResourceFoldersSettings protected () extends StObject {
  ...
  def get(params: ParamsResourceFoldersSettingsGet): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1Setting] = js.native
  def get(
    params: ParamsResourceFoldersSettingsGet,
  ...
  def get(params: ParamsResourceFoldersSettingsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1Setting] = js.native
  def get(
    params: ParamsResourceFoldersSettingsGet,
  ...
  /**
    ...
    */
  def get(params: ParamsResourceFoldersSettingsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceFoldersSettingsGet,
  ...
  def list(params: ParamsResourceFoldersSettingsList): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1ListSettingsResponse] = js.native
  def list(
    params: ParamsResourceFoldersSettingsList,
  ...
  def list(params: ParamsResourceFoldersSettingsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1ListSettingsResponse] = js.native
  def list(
    params: ParamsResourceFoldersSettingsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudResourcesettingsV1ListSettingsResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceFoldersSettingsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceFoldersSettingsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def patch(params: ParamsResourceFoldersSettingsPatch): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1Setting] = js.native
  def patch(
    params: ParamsResourceFoldersSettingsPatch,
    callback: BodyResponseCallback[SchemaGoogleCloudResourcesettingsV1Setting]
  ): Unit = js.native
  def patch(
    params: ParamsResourceFoldersSettingsPatch,
  ...
  def patch(params: ParamsResourceFoldersSettingsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudResourcesettingsV1Setting] = js.native
  def patch(
    params: ParamsResourceFoldersSettingsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudResourcesettingsV1Setting]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def patch(params: ParamsResourceFoldersSettingsPatch, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def patch(
    params: ParamsResourceFoldersSettingsPatch,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
