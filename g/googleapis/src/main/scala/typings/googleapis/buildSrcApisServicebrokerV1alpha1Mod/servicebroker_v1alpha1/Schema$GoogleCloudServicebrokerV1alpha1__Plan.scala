...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudServicebrokerV1alpha1__Plan extends js.Object {
  /**
...
object Schema$GoogleCloudServicebrokerV1alpha1__Plan {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleCloudServicebrokerV1alpha1__Plan = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudServicebrokerV1alpha1__Plan]
  }
}
