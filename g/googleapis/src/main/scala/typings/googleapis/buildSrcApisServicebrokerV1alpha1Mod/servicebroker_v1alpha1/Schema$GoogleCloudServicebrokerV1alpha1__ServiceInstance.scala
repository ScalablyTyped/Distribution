...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudServicebrokerV1alpha1__ServiceInstance extends js.Object {
  /**
...
object Schema$GoogleCloudServicebrokerV1alpha1__ServiceInstance {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudServicebrokerV1alpha1__ServiceInstance]
  }
}
