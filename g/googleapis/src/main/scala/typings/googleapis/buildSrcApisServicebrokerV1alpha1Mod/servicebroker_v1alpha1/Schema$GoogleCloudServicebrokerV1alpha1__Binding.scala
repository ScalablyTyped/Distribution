...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudServicebrokerV1alpha1__Binding extends js.Object {
  /**
...
object Schema$GoogleCloudServicebrokerV1alpha1__Binding {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleCloudServicebrokerV1alpha1__Binding = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudServicebrokerV1alpha1__Binding]
  }
}
