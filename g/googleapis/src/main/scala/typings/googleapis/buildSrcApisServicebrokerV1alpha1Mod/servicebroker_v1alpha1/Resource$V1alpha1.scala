...
@js.native
class Resource$V1alpha1 protected () extends js.Object {
  ...
  def getIamPolicy(params: ParamsDollarResourceDollarV1alpha1DollarGetiampolicy): GaxiosPromise[Schema$GoogleIamV1__Policy] = js.native
  def getIamPolicy(
    params: ParamsDollarResourceDollarV1alpha1DollarGetiampolicy,
  ...
  def getIamPolicy(params: ParamsDollarResourceDollarV1alpha1DollarGetiampolicy, options: MethodOptions): GaxiosPromise[Schema$GoogleIamV1__Policy] = js.native
  def getIamPolicy(
    params: ParamsDollarResourceDollarV1alpha1DollarGetiampolicy,
  ...
  def setIamPolicy(params: ParamsDollarResourceDollarV1alpha1DollarSetiampolicy): GaxiosPromise[Schema$GoogleIamV1__Policy] = js.native
  def setIamPolicy(
    params: ParamsDollarResourceDollarV1alpha1DollarSetiampolicy,
    callback: BodyResponseCallback[Schema$GoogleIamV1__Policy]
  ): Unit = js.native
  def setIamPolicy(
    params: ParamsDollarResourceDollarV1alpha1DollarSetiampolicy,
  ...
  def setIamPolicy(params: ParamsDollarResourceDollarV1alpha1DollarSetiampolicy, options: MethodOptions): GaxiosPromise[Schema$GoogleIamV1__Policy] = js.native
  def setIamPolicy(
    params: ParamsDollarResourceDollarV1alpha1DollarSetiampolicy,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$GoogleIamV1__Policy]
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarV1alpha1DollarTestiampermissions): GaxiosPromise[Schema$GoogleIamV1__TestIamPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsDollarResourceDollarV1alpha1DollarTestiampermissions,
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarV1alpha1DollarTestiampermissions, options: MethodOptions): GaxiosPromise[Schema$GoogleIamV1__TestIamPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsDollarResourceDollarV1alpha1DollarTestiampermissions,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$GoogleIamV1__TestIamPermissionsResponse]
