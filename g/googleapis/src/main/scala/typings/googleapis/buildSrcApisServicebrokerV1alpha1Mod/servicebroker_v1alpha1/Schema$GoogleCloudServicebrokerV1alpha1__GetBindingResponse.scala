...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudServicebrokerV1alpha1__GetBindingResponse extends js.Object {
  /**
...
object Schema$GoogleCloudServicebrokerV1alpha1__GetBindingResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudServicebrokerV1alpha1__GetBindingResponse]
  }
}
