...
@js.native
trait Anon_BenchmarkIndex extends js.Object {
...
object Anon_BenchmarkIndex {
  @scala.inline
  def apply(benchmarkIndex: Int | Double = null, hostUserAgent: String = null, networkUserAgent: String = null): Anon_BenchmarkIndex = {
    ...
    __obj.asInstanceOf[Anon_BenchmarkIndex]
  }
}
