...
trait ParamsResourceAccountsUserlinksBatchupdate
  extends StObject
...
object ParamsResourceAccountsUserlinksBatchupdate {
  
  inline def apply(): ParamsResourceAccountsUserlinksBatchupdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsUserlinksBatchupdate]
  }
  
  extension [Self <: ParamsResourceAccountsUserlinksBatchupdate](x: Self) {
