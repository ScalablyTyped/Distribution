...
trait SchemaGoogleAnalyticsAdminV1alphaAudience extends StObject {
  ...
  /**
    ...
    */
  var eventTrigger: js.UndefOr[SchemaGoogleAnalyticsAdminV1alphaAudienceEventTrigger] = js.undefined
  ...
  /**
    ...
    */
  var exclusionDurationMode: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Required. Immutable. null Filter clauses that define the Audience. All clauses will be AND’ed together.
    */
  var filterClauses: js.UndefOr[js.Array[SchemaGoogleAnalyticsAdminV1alphaAudienceFilterClause]] = js.undefined
...
object SchemaGoogleAnalyticsAdminV1alphaAudience {
  
  inline def apply(): SchemaGoogleAnalyticsAdminV1alphaAudience = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAnalyticsAdminV1alphaAudience]
  }
  
  extension [Self <: SchemaGoogleAnalyticsAdminV1alphaAudience](x: Self) {
    ...
    inline def setEventTrigger(value: SchemaGoogleAnalyticsAdminV1alphaAudienceEventTrigger): Self = StObject.set(x, "eventTrigger", value.asInstanceOf[js.Any])
    ...
    inline def setExclusionDurationModeNull: Self = StObject.set(x, "exclusionDurationMode", null)
    
    inline def setExclusionDurationModeUndefined: Self = StObject.set(x, "exclusionDurationMode", js.undefined)
    
    inline def setFilterClauses(value: js.Array[SchemaGoogleAnalyticsAdminV1alphaAudienceFilterClause]): Self = StObject.set(x, "filterClauses", value.asInstanceOf[js.Any])
    
    inline def setFilterClausesUndefined: Self = StObject.set(x, "filterClauses", js.undefined)
    
    inline def setFilterClausesVarargs(value: SchemaGoogleAnalyticsAdminV1alphaAudienceFilterClause*): Self = StObject.set(x, "filterClauses", js.Array(value*))
