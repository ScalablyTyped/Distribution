...
object ParamsResourceAppsDomainmappingsCreate {
  ...
  def apply(
  ...
  ): ParamsResourceAppsDomainmappingsCreate = {
    ...
    if (!js.isUndefined(noManagedCertificate)) __obj.updateDynamic("noManagedCertificate")(noManagedCertificate.asInstanceOf[js.Any])
    if (oauth_token != null) __obj.updateDynamic("oauth_token")(oauth_token.asInstanceOf[js.Any])
    if (overrideStrategy != null) __obj.updateDynamic("overrideStrategy")(overrideStrategy.asInstanceOf[js.Any])
