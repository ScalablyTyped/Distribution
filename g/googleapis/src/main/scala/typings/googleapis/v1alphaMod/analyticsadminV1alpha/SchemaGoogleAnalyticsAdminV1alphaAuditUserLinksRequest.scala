...
trait SchemaGoogleAnalyticsAdminV1alphaAuditUserLinksRequest extends StObject {
...
object SchemaGoogleAnalyticsAdminV1alphaAuditUserLinksRequest {
  
  inline def apply(): SchemaGoogleAnalyticsAdminV1alphaAuditUserLinksRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAnalyticsAdminV1alphaAuditUserLinksRequest]
  }
  
  extension [Self <: SchemaGoogleAnalyticsAdminV1alphaAuditUserLinksRequest](x: Self) {
