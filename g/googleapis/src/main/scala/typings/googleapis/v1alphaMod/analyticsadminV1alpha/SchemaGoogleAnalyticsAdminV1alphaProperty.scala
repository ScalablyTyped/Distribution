...
trait SchemaGoogleAnalyticsAdminV1alphaProperty extends StObject {
  ...
  /**
    ...
    */
  var serviceLevel: js.UndefOr[String | Null] = js.undefined
...
object SchemaGoogleAnalyticsAdminV1alphaProperty {
  
  inline def apply(): SchemaGoogleAnalyticsAdminV1alphaProperty = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAnalyticsAdminV1alphaProperty]
  }
  
  extension [Self <: SchemaGoogleAnalyticsAdminV1alphaProperty](x: Self) {
    ...
    inline def setServiceLevelNull: Self = StObject.set(x, "serviceLevel", null)
