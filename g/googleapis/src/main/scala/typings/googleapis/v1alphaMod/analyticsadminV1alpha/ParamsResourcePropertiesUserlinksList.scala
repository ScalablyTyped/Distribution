...
trait ParamsResourcePropertiesUserlinksList
  extends StObject
...
object ParamsResourcePropertiesUserlinksList {
  
  inline def apply(): ParamsResourcePropertiesUserlinksList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePropertiesUserlinksList]
  }
  
  extension [Self <: ParamsResourcePropertiesUserlinksList](x: Self) {
