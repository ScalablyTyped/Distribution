...
trait ParamsResourceAccountsUserlinksCreate
  extends StObject
...
object ParamsResourceAccountsUserlinksCreate {
  
  inline def apply(): ParamsResourceAccountsUserlinksCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsUserlinksCreate]
  }
  
  extension [Self <: ParamsResourceAccountsUserlinksCreate](x: Self) {
