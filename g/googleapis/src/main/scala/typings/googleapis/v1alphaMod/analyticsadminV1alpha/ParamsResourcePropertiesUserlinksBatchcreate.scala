...
trait ParamsResourcePropertiesUserlinksBatchcreate
  extends StObject
...
object ParamsResourcePropertiesUserlinksBatchcreate {
  
  inline def apply(): ParamsResourcePropertiesUserlinksBatchcreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePropertiesUserlinksBatchcreate]
  }
  
  extension [Self <: ParamsResourcePropertiesUserlinksBatchcreate](x: Self) {
