...
trait SchemaGoogleAnalyticsAdminV1alphaAudienceDimensionOrMetricFilterNumericValue extends StObject {
...
object SchemaGoogleAnalyticsAdminV1alphaAudienceDimensionOrMetricFilterNumericValue {
  
  inline def apply(): SchemaGoogleAnalyticsAdminV1alphaAudienceDimensionOrMetricFilterNumericValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAnalyticsAdminV1alphaAudienceDimensionOrMetricFilterNumericValue]
  }
  
  extension [Self <: SchemaGoogleAnalyticsAdminV1alphaAudienceDimensionOrMetricFilterNumericValue](x: Self) {
