...
trait ParamsResourcePropertiesUserlinksBatchget
  extends StObject
...
object ParamsResourcePropertiesUserlinksBatchget {
  
  inline def apply(): ParamsResourcePropertiesUserlinksBatchget = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePropertiesUserlinksBatchget]
  }
  
  extension [Self <: ParamsResourcePropertiesUserlinksBatchget](x: Self) {
