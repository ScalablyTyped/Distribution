...
trait ParamsResourceOrganizationsExportassets
  extends StObject
...
object ParamsResourceOrganizationsExportassets {
  ...
  inline def apply(): ParamsResourceOrganizationsExportassets = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsExportassets]
  }
  
  extension [Self <: ParamsResourceOrganizationsExportassets](x: Self) {
