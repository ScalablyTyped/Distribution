...
open class ResourceProjects protected () extends StObject {
  ...
  /**
    ...
    */
  def batchGetAssetsHistory(params: ParamsResourceProjectsBatchgetassetshistory, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def batchGetAssetsHistory(
    params: ParamsResourceProjectsBatchgetassetshistory,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def exportAssets(params: ParamsResourceProjectsExportassets, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def exportAssets(
    params: ParamsResourceProjectsExportassets,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
