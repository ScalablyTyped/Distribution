...
object ParamsResourceFoldersExportassets {
  ...
  @scala.inline
  implicit class ParamsResourceFoldersExportassetsOps[Self <: ParamsResourceFoldersExportassets] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaExportAssetsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
