...
object ParamsResourceProjectsExportassets {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsExportassets = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsExportassets]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsExportassetsMutableBuilder[Self <: ParamsResourceProjectsExportassets] (val x: Self) extends AnyVal {
