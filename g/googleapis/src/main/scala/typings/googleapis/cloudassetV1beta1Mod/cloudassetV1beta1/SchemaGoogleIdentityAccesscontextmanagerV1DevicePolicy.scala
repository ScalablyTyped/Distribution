...
trait SchemaGoogleIdentityAccesscontextmanagerV1DevicePolicy extends StObject {
  ...
  /**
    ...
    */
  var osConstraints: js.UndefOr[js.Array[SchemaGoogleIdentityAccesscontextmanagerV1OsConstraint]] = js.undefined
...
object SchemaGoogleIdentityAccesscontextmanagerV1DevicePolicy {
  
  inline def apply(): SchemaGoogleIdentityAccesscontextmanagerV1DevicePolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleIdentityAccesscontextmanagerV1DevicePolicy]
  }
  
  extension [Self <: SchemaGoogleIdentityAccesscontextmanagerV1DevicePolicy](x: Self) {
    ...
    inline def setOsConstraints(value: js.Array[SchemaGoogleIdentityAccesscontextmanagerV1OsConstraint]): Self = StObject.set(x, "osConstraints", value.asInstanceOf[js.Any])
    
    inline def setOsConstraintsUndefined: Self = StObject.set(x, "osConstraints", js.undefined)
    
    inline def setOsConstraintsVarargs(value: SchemaGoogleIdentityAccesscontextmanagerV1OsConstraint*): Self = StObject.set(x, "osConstraints", js.Array(value*))
