...
trait ParamsResourceOrganizationsBatchgetassetshistory
  extends StObject
...
object ParamsResourceOrganizationsBatchgetassetshistory {
  ...
  inline def apply(): ParamsResourceOrganizationsBatchgetassetshistory = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsBatchgetassetshistory]
  }
  
  extension [Self <: ParamsResourceOrganizationsBatchgetassetshistory](x: Self) {
