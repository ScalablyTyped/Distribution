...
@js.native
open class ResourceFoldersOperations protected () extends StObject {
  ...
  /**
    ...
    */
  def get(params: ParamsResourceFoldersOperationsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceFoldersOperationsGet,
