...
trait SchemaPropertyQuota extends StObject {
  ...
  /**
    ...
    */
  var potentiallyThresholdedRequestsPerHour: js.UndefOr[SchemaQuotaStatus] = js.undefined
...
object SchemaPropertyQuota {
  ...
  extension [Self <: SchemaPropertyQuota](x: Self) {
    ...
    inline def setPotentiallyThresholdedRequestsPerHour(value: SchemaQuotaStatus): Self = StObject.set(x, "potentiallyThresholdedRequestsPerHour", value.asInstanceOf[js.Any])
