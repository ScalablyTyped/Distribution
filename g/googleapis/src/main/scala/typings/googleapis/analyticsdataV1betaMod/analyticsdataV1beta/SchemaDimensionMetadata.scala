...
trait SchemaDimensionMetadata extends StObject {
...
object SchemaDimensionMetadata {
  
  inline def apply(): SchemaDimensionMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDimensionMetadata]
  }
  
  extension [Self <: SchemaDimensionMetadata](x: Self) {
