...
trait SchemaCheckCompatibilityRequest extends StObject {
  ...
  /**
    ...
    */
  var compatibilityFilter: js.UndefOr[String | Null] = js.undefined
...
object SchemaCheckCompatibilityRequest {
  
  inline def apply(): SchemaCheckCompatibilityRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCheckCompatibilityRequest]
  }
  
  extension [Self <: SchemaCheckCompatibilityRequest](x: Self) {
    
    inline def setCompatibilityFilter(value: String): Self = StObject.set(x, "compatibilityFilter", value.asInstanceOf[js.Any])
    
    inline def setCompatibilityFilterNull: Self = StObject.set(x, "compatibilityFilter", null)
