...
trait SchemaRunRealtimeReportResponse extends StObject {
...
object SchemaRunRealtimeReportResponse {
  
  inline def apply(): SchemaRunRealtimeReportResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRunRealtimeReportResponse]
  }
  
  extension [Self <: SchemaRunRealtimeReportResponse](x: Self) {
