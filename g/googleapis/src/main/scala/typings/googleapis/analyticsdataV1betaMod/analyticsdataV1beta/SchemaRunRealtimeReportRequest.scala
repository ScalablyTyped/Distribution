...
trait SchemaRunRealtimeReportRequest extends StObject {
  ...
  /**
    ...
    */
  var minuteRanges: js.UndefOr[js.Array[SchemaMinuteRange]] = js.undefined
...
object SchemaRunRealtimeReportRequest {
  ...
  extension [Self <: SchemaRunRealtimeReportRequest](x: Self) {
    ...
    inline def setMinuteRanges(value: js.Array[SchemaMinuteRange]): Self = StObject.set(x, "minuteRanges", value.asInstanceOf[js.Any])
    
    inline def setMinuteRangesUndefined: Self = StObject.set(x, "minuteRanges", js.undefined)
    
    inline def setMinuteRangesVarargs(value: SchemaMinuteRange*): Self = StObject.set(x, "minuteRanges", js.Array(value*))
