...
trait ParamsResourceCasesCreate
  extends StObject
...
object ParamsResourceCasesCreate {
  
  inline def apply(): ParamsResourceCasesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCasesCreate]
  }
  
  extension [Self <: ParamsResourceCasesCreate](x: Self) {
