...
trait SchemaAes128Encryption extends StObject {
...
object SchemaAes128Encryption {
  
  inline def apply(): SchemaAes128Encryption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAes128Encryption]
  }
  
  extension [Self <: SchemaAes128Encryption](x: Self) {
