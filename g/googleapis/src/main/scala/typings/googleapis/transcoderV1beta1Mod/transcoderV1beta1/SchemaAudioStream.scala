...
trait SchemaAudioStream extends StObject {
  ...
  /**
    ...
    */
  var mapping: js.UndefOr[js.Array[SchemaAudioAtom]] = js.undefined
...
object SchemaAudioStream {
  ...
  extension [Self <: SchemaAudioStream](x: Self) {
    ...
    inline def setMapping(value: js.Array[SchemaAudioAtom]): Self = StObject.set(x, "mapping", value.asInstanceOf[js.Any])
    
    inline def setMappingUndefined: Self = StObject.set(x, "mapping", js.undefined)
    
    inline def setMappingVarargs(value: SchemaAudioAtom*): Self = StObject.set(x, "mapping", js.Array(value*))
