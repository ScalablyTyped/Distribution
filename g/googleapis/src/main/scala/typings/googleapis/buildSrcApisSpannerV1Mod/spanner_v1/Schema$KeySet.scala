...
/**
  ...
  */
@js.native
trait Schema$KeySet extends js.Object {
  /**
  ...
  /**
    ...
    * specifications.
    */
  var ranges: js.UndefOr[js.Array[Schema$KeyRange]] = js.native
}

object Schema$KeySet {
  @scala.inline
  def apply(
    all: js.UndefOr[Boolean] = js.undefined,
    keys: js.Array[js.Array[_]] = null,
    ranges: js.Array[Schema$KeyRange] = null
  ): Schema$KeySet = {
    val __obj = js.Dynamic.literal()
    if (!js.isUndefined(all)) __obj.updateDynamic("all")(all.asInstanceOf[js.Any])
    if (keys != null) __obj.updateDynamic("keys")(keys.asInstanceOf[js.Any])
    if (ranges != null) __obj.updateDynamic("ranges")(ranges.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$KeySet]
  }
}
