...
/**
  ...
  */
@js.native
trait Schema$CreateDatabaseRequest extends js.Object {
  /**
...
object Schema$CreateDatabaseRequest {
  @scala.inline
  def apply(createStatement: String = null, extraStatements: js.Array[String] = null): Schema$CreateDatabaseRequest = {
    ...
    __obj.asInstanceOf[Schema$CreateDatabaseRequest]
  }
}
