...
trait ParamsResourceProjectsLocationsInstanceospoliciescompliancesList
  extends StObject
...
object ParamsResourceProjectsLocationsInstanceospoliciescompliancesList {
  
  inline def apply(): ParamsResourceProjectsLocationsInstanceospoliciescompliancesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsInstanceospoliciescompliancesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsInstanceospoliciescompliancesList](x: Self) {
