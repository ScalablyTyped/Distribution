...
trait SchemaOSPolicyAssignmentInstanceFilter extends StObject {
  ...
  /**
    ...
    */
  var osShortNames: js.UndefOr[js.Array[String] | Null] = js.undefined
}
object SchemaOSPolicyAssignmentInstanceFilter {
  ...
  extension [Self <: SchemaOSPolicyAssignmentInstanceFilter](x: Self) {
    ...
    inline def setOsShortNames(value: js.Array[String]): Self = StObject.set(x, "osShortNames", value.asInstanceOf[js.Any])
    
    inline def setOsShortNamesNull: Self = StObject.set(x, "osShortNames", null)
    
    inline def setOsShortNamesUndefined: Self = StObject.set(x, "osShortNames", js.undefined)
    
    inline def setOsShortNamesVarargs(value: String*): Self = StObject.set(x, "osShortNames", js.Array(value*))
  }
}
