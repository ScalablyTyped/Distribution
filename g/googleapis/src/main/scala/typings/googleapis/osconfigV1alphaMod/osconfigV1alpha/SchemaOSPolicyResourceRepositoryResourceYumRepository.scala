...
trait SchemaOSPolicyResourceRepositoryResourceYumRepository extends StObject {
...
object SchemaOSPolicyResourceRepositoryResourceYumRepository {
  
  inline def apply(): SchemaOSPolicyResourceRepositoryResourceYumRepository = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOSPolicyResourceRepositoryResourceYumRepository]
  }
  
  extension [Self <: SchemaOSPolicyResourceRepositoryResourceYumRepository](x: Self) {
