...
class ResourceTable protected () extends StObject {
  ...
  def refetchSheet(params: Unit, options: MethodOptions): GaxiosPromise[SchemaTask] = js.native
  ...
  def replaceRows(params: Unit, options: MethodOptions): GaxiosPromise[SchemaTask] = js.native
