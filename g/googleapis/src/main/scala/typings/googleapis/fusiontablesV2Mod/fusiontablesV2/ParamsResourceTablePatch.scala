...
object ParamsResourceTablePatch {
  ...
  def apply(
    ...
    if (!js.isUndefined(replaceViewDefinition)) __obj.updateDynamic("replaceViewDefinition")(replaceViewDefinition.get.asInstanceOf[js.Any])
