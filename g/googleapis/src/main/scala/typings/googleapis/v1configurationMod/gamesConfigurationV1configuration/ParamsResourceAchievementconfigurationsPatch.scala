...
object ParamsResourceAchievementconfigurationsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceAchievementconfigurationsPatchOps[Self <: ParamsResourceAchievementconfigurationsPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaAchievementConfiguration): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
