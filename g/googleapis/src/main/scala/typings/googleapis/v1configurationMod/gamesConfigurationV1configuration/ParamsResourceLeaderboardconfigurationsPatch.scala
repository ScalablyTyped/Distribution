...
@js.native
trait ParamsResourceLeaderboardconfigurationsPatch extends StandardParameters {
...
object ParamsResourceLeaderboardconfigurationsPatch {
  
  @scala.inline
  def apply(): ParamsResourceLeaderboardconfigurationsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLeaderboardconfigurationsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceLeaderboardconfigurationsPatchMutableBuilder[Self <: ParamsResourceLeaderboardconfigurationsPatch] (val x: Self) extends AnyVal {
