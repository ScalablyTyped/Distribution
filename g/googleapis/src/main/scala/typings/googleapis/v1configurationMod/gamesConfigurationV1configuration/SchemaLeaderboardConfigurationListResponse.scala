...
object SchemaLeaderboardConfigurationListResponse {
  ...
  @scala.inline
  implicit class SchemaLeaderboardConfigurationListResponseOps[Self <: SchemaLeaderboardConfigurationListResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaLeaderboardConfiguration*): Self = this.set("items", js.Array(value :_*))
    @scala.inline
    def setItems(value: js.Array[SchemaLeaderboardConfiguration]): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
