...
object SchemaAchievementConfigurationListResponse {
  ...
  implicit class SchemaAchievementConfigurationListResponseOps[Self <: SchemaAchievementConfigurationListResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaAchievementConfiguration*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaAchievementConfiguration]): Self = this.set("items", value.asInstanceOf[js.Any])
