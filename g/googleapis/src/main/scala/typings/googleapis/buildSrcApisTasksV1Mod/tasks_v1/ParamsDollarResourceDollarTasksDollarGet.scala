...
@js.native
trait ParamsDollarResourceDollarTasksDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTasksDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTasksDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTasksDollarGet]
  }
}
