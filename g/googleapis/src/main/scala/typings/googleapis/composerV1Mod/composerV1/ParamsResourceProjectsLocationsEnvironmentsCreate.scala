...
object ParamsResourceProjectsLocationsEnvironmentsCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsEnvironmentsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsEnvironmentsCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsEnvironmentsCreateMutableBuilder[Self <: ParamsResourceProjectsLocationsEnvironmentsCreate] (val x: Self) extends AnyVal {
