...
trait SchemaPrivateEnvironmentConfig extends StObject {
  ...
  /**
    ...
    */
  var cloudComposerConnectionSubnetwork: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Optional. The CIDR block from which IP range for Cloud Composer Network in tenant project will be reserved. Needs to be disjoint from private_cluster_config.master_ipv4_cidr_block and cloud_sql_ipv4_cidr_block. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.
    */
  var cloudComposerNetworkIpv4CidrBlock: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var cloudComposerNetworkIpv4ReservedRange: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Optional. The CIDR block from which IP range in tenant project will be reserved for Cloud SQL. Needs to be disjoint from `web_server_ipv4_cidr_block`.
    */
  var cloudSqlIpv4CidrBlock: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Optional. If `true`, a Private IP Cloud Composer environment is created. If this field is set to true, `IPAllocationPolicy.use_ip_aliases` must be set to true for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
    */
  var enablePrivateEnvironment: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * Optional. When enabled, IPs from public (non-RFC1918) ranges can be used for `IPAllocationPolicy.cluster_ipv4_cidr_block` and `IPAllocationPolicy.service_ipv4_cidr_block`.
    */
  var enablePrivatelyUsedPublicIps: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var webServerIpv4CidrBlock: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var webServerIpv4ReservedRange: js.UndefOr[String | Null] = js.undefined
}
object SchemaPrivateEnvironmentConfig {
  ...
  extension [Self <: SchemaPrivateEnvironmentConfig](x: Self) {
    ...
    inline def setCloudComposerConnectionSubnetworkNull: Self = StObject.set(x, "cloudComposerConnectionSubnetwork", null)
    ...
    inline def setCloudComposerNetworkIpv4CidrBlockNull: Self = StObject.set(x, "cloudComposerNetworkIpv4CidrBlock", null)
    ...
    inline def setCloudComposerNetworkIpv4ReservedRangeNull: Self = StObject.set(x, "cloudComposerNetworkIpv4ReservedRange", null)
    ...
    inline def setCloudSqlIpv4CidrBlockNull: Self = StObject.set(x, "cloudSqlIpv4CidrBlock", null)
    ...
    inline def setEnablePrivateEnvironmentNull: Self = StObject.set(x, "enablePrivateEnvironment", null)
    ...
    inline def setEnablePrivatelyUsedPublicIpsNull: Self = StObject.set(x, "enablePrivatelyUsedPublicIps", null)
    ...
    inline def setWebServerIpv4CidrBlockNull: Self = StObject.set(x, "webServerIpv4CidrBlock", null)
    ...
    inline def setWebServerIpv4ReservedRangeNull: Self = StObject.set(x, "webServerIpv4ReservedRange", null)
