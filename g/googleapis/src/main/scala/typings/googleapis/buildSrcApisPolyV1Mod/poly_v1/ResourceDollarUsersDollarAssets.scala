...
@js.native
class ResourceDollarUsersDollarAssets protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$ListUserAssetsResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListUserAssetsResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarUsersDollarAssetsDollarList): GaxiosPromise[Schema$ListUserAssetsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarUsersDollarAssetsDollarList,
    callback: BodyResponseCallback[Schema$ListUserAssetsResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarUsersDollarAssetsDollarList,
    options: BodyResponseCallback[Schema$ListUserAssetsResponse],
    callback: BodyResponseCallback[Schema$ListUserAssetsResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarUsersDollarAssetsDollarList, options: MethodOptions): GaxiosPromise[Schema$ListUserAssetsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarUsersDollarAssetsDollarList,
