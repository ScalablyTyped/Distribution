...
@js.native
trait ParamsDollarResourceDollarProjectsDollarInstancesDollarTablesDollarModifycolumnfamilies extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$ModifyColumnFamiliesRequest] = js.native
}
