...
trait SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet](x: Self) {
