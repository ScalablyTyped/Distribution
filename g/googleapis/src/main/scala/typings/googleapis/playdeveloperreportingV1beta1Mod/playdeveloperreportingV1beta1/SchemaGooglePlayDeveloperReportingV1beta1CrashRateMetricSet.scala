...
trait SchemaGooglePlayDeveloperReportingV1beta1CrashRateMetricSet extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1beta1CrashRateMetricSet {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1beta1CrashRateMetricSet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1beta1CrashRateMetricSet]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1beta1CrashRateMetricSet](x: Self) {
