...
trait ParamsResourceVitalsExcessivewakeuprateQuery
  ...
  var requestBody: js.UndefOr[
    SchemaGooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest
  ] = js.undefined
}
object ParamsResourceVitalsExcessivewakeuprateQuery {
  ...
  extension [Self <: ParamsResourceVitalsExcessivewakeuprateQuery](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
