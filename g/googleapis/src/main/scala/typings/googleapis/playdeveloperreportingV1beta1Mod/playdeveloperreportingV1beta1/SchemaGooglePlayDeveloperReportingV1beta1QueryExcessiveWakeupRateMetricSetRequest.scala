...
trait SchemaGooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetRequest](x: Self) {
