...
@JSImport("googleapis/build/src/apis/playdeveloperreporting/v1beta1", "playdeveloperreporting_v1beta1.Resource$Vitals$Excessivewakeuprate")
@js.native
open class ResourceVitalsExcessivewakeuprate protected () extends StObject {
  ...
  def get(): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet] = js.native
  def get(
    callback: BodyResponseCallback[SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet]
  ): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet] = js.native
  def get(params: ParamsResourceVitalsExcessivewakeuprateGet): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet] = js.native
  def get(
  ...
  def get(
    params: ParamsResourceVitalsExcessivewakeuprateGet,
    options: BodyResponseCallback[Readable | SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet],
    callback: BodyResponseCallback[Readable | SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet]
  ): Unit = js.native
  def get(params: ParamsResourceVitalsExcessivewakeuprateGet, options: MethodOptions): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1ExcessiveWakeupRateMetricSet] = js.native
  def get(
    params: ParamsResourceVitalsExcessivewakeuprateGet,
  ...
  def query(): GaxiosPromise[
    SchemaGooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetResponse
  ] = js.native
  def query(
  ...
  def query(
    ...
    options: BodyResponseCallback[
      Readable | SchemaGooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetResponse
    ],
    callback: BodyResponseCallback[
      Readable | SchemaGooglePlayDeveloperReportingV1beta1QueryExcessiveWakeupRateMetricSetResponse
    ]
