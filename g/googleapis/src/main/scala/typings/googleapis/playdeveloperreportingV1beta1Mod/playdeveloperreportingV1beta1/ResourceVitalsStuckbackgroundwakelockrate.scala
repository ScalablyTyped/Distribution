...
@JSImport("googleapis/build/src/apis/playdeveloperreporting/v1beta1", "playdeveloperreporting_v1beta1.Resource$Vitals$Stuckbackgroundwakelockrate")
@js.native
open class ResourceVitalsStuckbackgroundwakelockrate protected () extends StObject {
  ...
  def get(): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet] = js.native
  def get(
    callback: BodyResponseCallback[SchemaGooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet]
  ): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet] = js.native
  def get(params: ParamsResourceVitalsStuckbackgroundwakelockrateGet): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet] = js.native
  def get(
  ...
  def get(
    ...
    options: BodyResponseCallback[
      Readable | SchemaGooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet
    ],
    callback: BodyResponseCallback[
      Readable | SchemaGooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet
    ]
  ): Unit = js.native
  def get(params: ParamsResourceVitalsStuckbackgroundwakelockrateGet, options: MethodOptions): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet] = js.native
  def get(
    params: ParamsResourceVitalsStuckbackgroundwakelockrateGet,
  ...
  def query(): GaxiosPromise[
    SchemaGooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse
  ] = js.native
  def query(
    callback: BodyResponseCallback[
      SchemaGooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse
  ...
  def query(
    params: ParamsResourceVitalsStuckbackgroundwakelockrateQuery,
    options: BodyResponseCallback[
      Readable | SchemaGooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse
    ],
    callback: BodyResponseCallback[
      Readable | SchemaGooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetResponse
    ]
