...
trait SchemaGooglePlayDeveloperReportingV1beta1TimelineSpec extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1beta1TimelineSpec {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1beta1TimelineSpec = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1beta1TimelineSpec]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1beta1TimelineSpec](x: Self) {
