...
@JSImport("googleapis/build/src/apis/playdeveloperreporting/v1beta1", "playdeveloperreporting_v1beta1.Resource$Anomalies")
@js.native
open class ResourceAnomalies protected () extends StObject {
  ...
  def list(): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1ListAnomaliesResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGooglePlayDeveloperReportingV1beta1ListAnomaliesResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1ListAnomaliesResponse] = js.native
  def list(params: ParamsResourceAnomaliesList): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1ListAnomaliesResponse] = js.native
  def list(
    params: ParamsResourceAnomaliesList,
    callback: BodyResponseCallback[SchemaGooglePlayDeveloperReportingV1beta1ListAnomaliesResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceAnomaliesList,
    options: BodyResponseCallback[Readable | SchemaGooglePlayDeveloperReportingV1beta1ListAnomaliesResponse],
    callback: BodyResponseCallback[Readable | SchemaGooglePlayDeveloperReportingV1beta1ListAnomaliesResponse]
  ): Unit = js.native
  def list(params: ParamsResourceAnomaliesList, options: MethodOptions): GaxiosPromise[SchemaGooglePlayDeveloperReportingV1beta1ListAnomaliesResponse] = js.native
  def list(
    params: ParamsResourceAnomaliesList,
