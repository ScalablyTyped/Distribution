...
trait SchemaGooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetResponse extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetResponse {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetResponse]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetResponse](x: Self) {
