...
trait SchemaGooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest extends StObject {
...
object SchemaGooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest {
  
  inline def apply(): SchemaGooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest]
  }
  
  extension [Self <: SchemaGooglePlayDeveloperReportingV1beta1QueryAnrRateMetricSetRequest](x: Self) {
