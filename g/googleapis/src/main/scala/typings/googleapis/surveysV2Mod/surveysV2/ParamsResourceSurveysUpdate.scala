...
@js.native
trait ParamsResourceSurveysUpdate extends StandardParameters {
...
object ParamsResourceSurveysUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceSurveysUpdateOps[Self <: ParamsResourceSurveysUpdate] (val x: Self) extends AnyVal {
