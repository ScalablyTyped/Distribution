...
object SchemaSource {
  ...
  extension [Self <: SchemaSource](x: Self) {
    ...
    inline def setAdditionalContextsVarargs(value: SchemaGoogleDevtoolsContaineranalysisV1alpha1SourceContext*): Self = StObject.set(x, "additionalContexts", js.Array(value*))
