...
object ParamsResourceProjectsNotesPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsNotesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsNotesPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsNotesPatchMutableBuilder[Self <: ParamsResourceProjectsNotesPatch] (val x: Self) extends AnyVal {
