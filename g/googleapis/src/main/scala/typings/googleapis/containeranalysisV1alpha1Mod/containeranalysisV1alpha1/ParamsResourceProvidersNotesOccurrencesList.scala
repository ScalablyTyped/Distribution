...
trait ParamsResourceProvidersNotesOccurrencesList
  extends StObject
...
object ParamsResourceProvidersNotesOccurrencesList {
  ...
  inline def apply(): ParamsResourceProvidersNotesOccurrencesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProvidersNotesOccurrencesList]
  }
  
  extension [Self <: ParamsResourceProvidersNotesOccurrencesList](x: Self) {
