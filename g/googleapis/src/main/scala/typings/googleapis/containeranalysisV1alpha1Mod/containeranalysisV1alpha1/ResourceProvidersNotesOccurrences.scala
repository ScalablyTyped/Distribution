...
@js.native
open class ResourceProvidersNotesOccurrences protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceProvidersNotesOccurrencesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProvidersNotesOccurrencesList,
