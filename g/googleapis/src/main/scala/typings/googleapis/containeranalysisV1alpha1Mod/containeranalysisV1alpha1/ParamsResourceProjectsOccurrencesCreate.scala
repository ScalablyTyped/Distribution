...
object ParamsResourceProjectsOccurrencesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsOccurrencesCreateOps[Self <: ParamsResourceProjectsOccurrencesCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaOccurrence): Self = this.set("requestBody", value.asInstanceOf[js.Any])
