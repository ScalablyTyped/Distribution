...
@js.native
trait ParamsResourceProvidersNotesPatch extends StandardParameters {
...
object ParamsResourceProvidersNotesPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceProvidersNotesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProvidersNotesPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceProvidersNotesPatchMutableBuilder[Self <: ParamsResourceProvidersNotesPatch] (val x: Self) extends AnyVal {
