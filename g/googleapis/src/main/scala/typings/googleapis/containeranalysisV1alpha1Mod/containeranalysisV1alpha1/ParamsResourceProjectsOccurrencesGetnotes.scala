...
object ParamsResourceProjectsOccurrencesGetnotes {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsOccurrencesGetnotes = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsOccurrencesGetnotes]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsOccurrencesGetnotesMutableBuilder[Self <: ParamsResourceProjectsOccurrencesGetnotes] (val x: Self) extends AnyVal {
