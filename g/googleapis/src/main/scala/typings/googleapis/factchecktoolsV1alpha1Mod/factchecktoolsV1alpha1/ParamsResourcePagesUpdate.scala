...
object ParamsResourcePagesUpdate {
  ...
  implicit class ParamsResourcePagesUpdateMutableBuilder[Self <: ParamsResourcePagesUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
