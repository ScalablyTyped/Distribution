...
trait SchemaAggregation extends StObject {
  ...
  /**
    ...
    */
  var alignmentPeriod: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var crossSeriesReducer: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var groupByFields: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var perSeriesAligner: js.UndefOr[String | Null] = js.undefined
}
object SchemaAggregation {
  ...
  extension [Self <: SchemaAggregation](x: Self) {
    ...
    inline def setAlignmentPeriodNull: Self = StObject.set(x, "alignmentPeriod", null)
    ...
    inline def setCrossSeriesReducerNull: Self = StObject.set(x, "crossSeriesReducer", null)
    ...
    inline def setGroupByFieldsNull: Self = StObject.set(x, "groupByFields", null)
    ...
    inline def setPerSeriesAlignerNull: Self = StObject.set(x, "perSeriesAligner", null)
