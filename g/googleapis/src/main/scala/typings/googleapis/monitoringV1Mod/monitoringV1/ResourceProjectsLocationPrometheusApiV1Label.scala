...
@JSImport("googleapis/build/src/apis/monitoring/v1", "monitoring_v1.Resource$Projects$Location$Prometheus$Api$V1$Label")
@js.native
open class ResourceProjectsLocationPrometheusApiV1Label protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var context: APIRequestContext = js.native
  
  def values(): GaxiosPromise[SchemaHttpBody] = js.native
  def values(callback: BodyResponseCallback[SchemaHttpBody]): Unit = js.native
  def values(params: Unit, options: MethodOptions): GaxiosPromise[SchemaHttpBody] = js.native
  def values(params: ParamsResourceProjectsLocationPrometheusApiV1LabelValues): GaxiosPromise[SchemaHttpBody] = js.native
  def values(
    params: ParamsResourceProjectsLocationPrometheusApiV1LabelValues,
  ...
  def values(params: ParamsResourceProjectsLocationPrometheusApiV1LabelValues, options: MethodOptions): GaxiosPromise[SchemaHttpBody] = js.native
  def values(
    params: ParamsResourceProjectsLocationPrometheusApiV1LabelValues,
  ...
  /**
    ...
    */
  def values(params: ParamsResourceProjectsLocationPrometheusApiV1LabelValues, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def values(
    params: ParamsResourceProjectsLocationPrometheusApiV1LabelValues,
