...
@JSImport("googleapis/build/src/apis/sasportal/v1alpha1", "sasportal_v1alpha1.Resource$Nodes$Nodes$Devices")
@js.native
open class ResourceNodesNodesDevices protected () extends StObject {
  ...
  def create(params: ParamsResourceNodesNodesDevicesCreate): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def create(
    params: ParamsResourceNodesNodesDevicesCreate,
  ...
  def create(params: ParamsResourceNodesNodesDevicesCreate, options: MethodOptions): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def create(
    params: ParamsResourceNodesNodesDevicesCreate,
  ...
  /**
    ...
    */
  def create(params: ParamsResourceNodesNodesDevicesCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceNodesNodesDevicesCreate,
  ...
  def createSigned(params: ParamsResourceNodesNodesDevicesCreatesigned): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def createSigned(
    params: ParamsResourceNodesNodesDevicesCreatesigned,
    callback: BodyResponseCallback[SchemaSasPortalDevice]
  ): Unit = js.native
  def createSigned(
    params: ParamsResourceNodesNodesDevicesCreatesigned,
  ...
  def createSigned(params: ParamsResourceNodesNodesDevicesCreatesigned, options: MethodOptions): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def createSigned(
    params: ParamsResourceNodesNodesDevicesCreatesigned,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaSasPortalDevice]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def createSigned(params: ParamsResourceNodesNodesDevicesCreatesigned, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def createSigned(
    params: ParamsResourceNodesNodesDevicesCreatesigned,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def list(params: ParamsResourceNodesNodesDevicesList): GaxiosPromise[SchemaSasPortalListDevicesResponse] = js.native
  def list(
    params: ParamsResourceNodesNodesDevicesList,
  ...
  def list(params: ParamsResourceNodesNodesDevicesList, options: MethodOptions): GaxiosPromise[SchemaSasPortalListDevicesResponse] = js.native
  def list(
    params: ParamsResourceNodesNodesDevicesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaSasPortalListDevicesResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceNodesNodesDevicesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceNodesNodesDevicesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
