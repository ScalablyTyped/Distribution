...
trait SchemaSasPortalOperation extends StObject {
  ...
  /**
    ...
    */
  var error: js.UndefOr[SchemaSasPortalStatus] = js.undefined
...
object SchemaSasPortalOperation {
  
  inline def apply(): SchemaSasPortalOperation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSasPortalOperation]
  }
  
  extension [Self <: SchemaSasPortalOperation](x: Self) {
    ...
    inline def setError(value: SchemaSasPortalStatus): Self = StObject.set(x, "error", value.asInstanceOf[js.Any])
