...
trait ParamsResourceNodesDevicesCreate
  extends StObject
...
object ParamsResourceNodesDevicesCreate {
  
  inline def apply(): ParamsResourceNodesDevicesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodesDevicesCreate]
  }
  
  extension [Self <: ParamsResourceNodesDevicesCreate](x: Self) {
