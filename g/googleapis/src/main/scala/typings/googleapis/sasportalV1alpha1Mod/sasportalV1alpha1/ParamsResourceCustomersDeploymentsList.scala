...
trait ParamsResourceCustomersDeploymentsList
  extends StObject
...
object ParamsResourceCustomersDeploymentsList {
  
  inline def apply(): ParamsResourceCustomersDeploymentsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomersDeploymentsList]
  }
  
  extension [Self <: ParamsResourceCustomersDeploymentsList](x: Self) {
