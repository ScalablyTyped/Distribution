...
trait ParamsResourceDeploymentsDevicesMove
  extends StObject
...
object ParamsResourceDeploymentsDevicesMove {
  
  inline def apply(): ParamsResourceDeploymentsDevicesMove = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceDeploymentsDevicesMove]
  }
  
  extension [Self <: ParamsResourceDeploymentsDevicesMove](x: Self) {
