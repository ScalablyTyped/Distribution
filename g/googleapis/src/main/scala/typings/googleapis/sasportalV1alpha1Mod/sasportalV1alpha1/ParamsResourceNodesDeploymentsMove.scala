...
trait ParamsResourceNodesDeploymentsMove
  extends StObject
...
object ParamsResourceNodesDeploymentsMove {
  
  inline def apply(): ParamsResourceNodesDeploymentsMove = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodesDeploymentsMove]
  }
  
  extension [Self <: ParamsResourceNodesDeploymentsMove](x: Self) {
