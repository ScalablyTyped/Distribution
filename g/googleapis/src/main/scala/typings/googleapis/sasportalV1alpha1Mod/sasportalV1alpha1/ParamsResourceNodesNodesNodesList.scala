...
trait ParamsResourceNodesNodesNodesList
  extends StObject
...
object ParamsResourceNodesNodesNodesList {
  
  inline def apply(): ParamsResourceNodesNodesNodesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodesNodesNodesList]
  }
  
  extension [Self <: ParamsResourceNodesNodesNodesList](x: Self) {
