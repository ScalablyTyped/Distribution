...
trait ParamsResourceNodesDeploymentsDevicesList
  extends StObject
...
object ParamsResourceNodesDeploymentsDevicesList {
  
  inline def apply(): ParamsResourceNodesDeploymentsDevicesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodesDeploymentsDevicesList]
  }
  
  extension [Self <: ParamsResourceNodesDeploymentsDevicesList](x: Self) {
