...
@JSImport("googleapis/build/src/apis/sasportal/v1alpha1", "sasportal_v1alpha1.Resource$Customers$Deployments$Devices")
@js.native
open class ResourceCustomersDeploymentsDevices protected () extends StObject {
  ...
  def create(params: ParamsResourceCustomersDeploymentsDevicesCreate): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def create(
    params: ParamsResourceCustomersDeploymentsDevicesCreate,
  ...
  def create(params: ParamsResourceCustomersDeploymentsDevicesCreate, options: MethodOptions): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def create(
    params: ParamsResourceCustomersDeploymentsDevicesCreate,
  ...
  /**
    ...
    */
  def create(params: ParamsResourceCustomersDeploymentsDevicesCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceCustomersDeploymentsDevicesCreate,
  ...
  def createSigned(params: ParamsResourceCustomersDeploymentsDevicesCreatesigned): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def createSigned(
    params: ParamsResourceCustomersDeploymentsDevicesCreatesigned,
    callback: BodyResponseCallback[SchemaSasPortalDevice]
  ): Unit = js.native
  def createSigned(
    params: ParamsResourceCustomersDeploymentsDevicesCreatesigned,
  ...
  def createSigned(params: ParamsResourceCustomersDeploymentsDevicesCreatesigned, options: MethodOptions): GaxiosPromise[SchemaSasPortalDevice] = js.native
  def createSigned(
    params: ParamsResourceCustomersDeploymentsDevicesCreatesigned,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaSasPortalDevice]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def createSigned(params: ParamsResourceCustomersDeploymentsDevicesCreatesigned, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def createSigned(
    params: ParamsResourceCustomersDeploymentsDevicesCreatesigned,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def list(params: ParamsResourceCustomersDeploymentsDevicesList): GaxiosPromise[SchemaSasPortalListDevicesResponse] = js.native
  def list(
    params: ParamsResourceCustomersDeploymentsDevicesList,
  ...
  def list(params: ParamsResourceCustomersDeploymentsDevicesList, options: MethodOptions): GaxiosPromise[SchemaSasPortalListDevicesResponse] = js.native
  def list(
    params: ParamsResourceCustomersDeploymentsDevicesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaSasPortalListDevicesResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceCustomersDeploymentsDevicesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceCustomersDeploymentsDevicesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
