...
trait ParamsResourceNodesNodesDevicesList
  extends StObject
...
object ParamsResourceNodesNodesDevicesList {
  
  inline def apply(): ParamsResourceNodesNodesDevicesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodesNodesDevicesList]
  }
  
  extension [Self <: ParamsResourceNodesNodesDevicesList](x: Self) {
