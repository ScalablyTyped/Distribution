...
trait ParamsResourceNodesDevicesPatch
  extends StObject
...
object ParamsResourceNodesDevicesPatch {
  
  inline def apply(): ParamsResourceNodesDevicesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNodesDevicesPatch]
  }
  
  extension [Self <: ParamsResourceNodesDevicesPatch](x: Self) {
