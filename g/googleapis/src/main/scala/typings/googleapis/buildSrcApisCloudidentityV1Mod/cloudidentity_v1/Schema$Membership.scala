...
trait Schema$Membership extends js.Object {
  ...
  /**
    ...
    * types: `Users`, `Groups`.
    */
  var preferredMemberKey: js.UndefOr[Schema$EntityKey] = js.native
  /**
    * Roles for a member within the Group.  Currently supported
    * MembershipRoles: `&quot;MEMBER&quot;`.
    */
  var roles: js.UndefOr[js.Array[Schema$MembershipRole]] = js.native
  /**
...
object Schema$Membership {
  ...
  def apply(
    ...
    name: String = null,
    preferredMemberKey: Schema$EntityKey = null,
    roles: js.Array[Schema$MembershipRole] = null,
