...
class Resource$Media protected () extends js.Object {
  ...
  /**
    ...
    */
  def upload(): GaxiosPromise[Schema$Media] = js.native
  def upload(callback: BodyResponseCallback[Schema$Media]): Unit = js.native
  def upload(params: ParamsDollarResourceDollarMediaDollarUpload): GaxiosPromise[Schema$Media] = js.native
  def upload(params: ParamsDollarResourceDollarMediaDollarUpload, callback: BodyResponseCallback[Schema$Media]): Unit = js.native
  def upload(
  ...
  def upload(params: ParamsDollarResourceDollarMediaDollarUpload, options: MethodOptions): GaxiosPromise[Schema$Media] = js.native
  def upload(
    params: ParamsDollarResourceDollarMediaDollarUpload,
