...
/**
  ...
  */
@js.native
trait Schema$FacetBucket extends js.Object {
  /**
...
object Schema$FacetBucket {
  @scala.inline
  def apply(count: Int | Double = null, percentage: Int | Double = null, value: Schema$Value = null): Schema$FacetBucket = {
    val __obj = js.Dynamic.literal()
    if (count != null) __obj.updateDynamic("count")(count.asInstanceOf[js.Any])
    if (percentage != null) __obj.updateDynamic("percentage")(percentage.asInstanceOf[js.Any])
    if (value != null) __obj.updateDynamic("value")(value.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$FacetBucket]
  }
}
