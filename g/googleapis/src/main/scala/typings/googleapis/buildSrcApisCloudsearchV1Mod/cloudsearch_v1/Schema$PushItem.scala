...
/**
  ...
  */
@js.native
trait Schema$PushItem extends js.Object {
  /**
  ...
  /**
    ...
    */
  var repositoryError: js.UndefOr[Schema$RepositoryError] = js.native
  /**
...
object Schema$PushItem {
  ...
  def apply(
    ...
    payload: String = null,
    queue: String = null,
    repositoryError: Schema$RepositoryError = null,
    ...
    __obj.asInstanceOf[Schema$PushItem]
  }
}
