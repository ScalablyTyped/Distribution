...
trait Schema$SearchResult extends js.Object {
  /**
    ...
    */
  var clusteredResults: js.UndefOr[js.Array[Schema$SearchResult]] = js.native
  /**
    * Debugging information about this search result.
    */
  var debugInfo: js.UndefOr[Schema$ResultDebugInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var snippet: js.UndefOr[Schema$Snippet] = js.native
  /**
...
object Schema$SearchResult {
  @scala.inline
  def apply(
    clusteredResults: js.Array[Schema$SearchResult] = null,
    debugInfo: Schema$ResultDebugInfo = null,
    metadata: Schema$Metadata = null,
    snippet: Schema$Snippet = null,
    title: String = null,
    url: String = null
  ): Schema$SearchResult = {
