...
/**
  ...
  */
@js.native
trait Schema$BooleanOperatorOptions extends js.Object {
  /**
...
object Schema$BooleanOperatorOptions {
  @scala.inline
  def apply(operatorName: String = null): Schema$BooleanOperatorOptions = {
    val __obj = js.Dynamic.literal()
    if (operatorName != null) __obj.updateDynamic("operatorName")(operatorName.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$BooleanOperatorOptions]
  }
}
