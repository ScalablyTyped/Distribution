...
/**
  ...
  */
@js.native
trait Schema$PropertyDisplayOptions extends js.Object {
  /**
...
object Schema$PropertyDisplayOptions {
  @scala.inline
  def apply(displayLabel: String = null): Schema$PropertyDisplayOptions = {
    val __obj = js.Dynamic.literal()
    if (displayLabel != null) __obj.updateDynamic("displayLabel")(displayLabel.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$PropertyDisplayOptions]
  }
}
