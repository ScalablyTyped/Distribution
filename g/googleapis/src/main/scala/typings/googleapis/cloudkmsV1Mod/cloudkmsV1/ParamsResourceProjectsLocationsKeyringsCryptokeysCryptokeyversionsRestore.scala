...
object ParamsResourceProjectsLocationsKeyringsCryptokeysCryptokeyversionsRestore {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsKeyringsCryptokeysCryptokeyversionsRestoreOps[Self <: ParamsResourceProjectsLocationsKeyringsCryptokeysCryptokeyversionsRestore] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaRestoreCryptoKeyVersionRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
