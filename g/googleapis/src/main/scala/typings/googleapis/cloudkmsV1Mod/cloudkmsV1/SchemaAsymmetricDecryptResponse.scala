...
trait SchemaAsymmetricDecryptResponse extends StObject {
  ...
  /**
    ...
    */
  var verifiedCiphertextCrc32c: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaAsymmetricDecryptResponse {
  ...
  extension [Self <: SchemaAsymmetricDecryptResponse](x: Self) {
    ...
    inline def setVerifiedCiphertextCrc32cNull: Self = StObject.set(x, "verifiedCiphertextCrc32c", null)
