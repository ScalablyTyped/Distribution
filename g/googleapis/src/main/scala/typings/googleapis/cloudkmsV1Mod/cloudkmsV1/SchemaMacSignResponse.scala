...
trait SchemaMacSignResponse extends StObject {
...
object SchemaMacSignResponse {
  
  inline def apply(): SchemaMacSignResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaMacSignResponse]
  }
  
  extension [Self <: SchemaMacSignResponse](x: Self) {
