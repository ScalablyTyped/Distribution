...
object ParamsResourceProjectsLocationsKeyringsCryptokeysEncrypt {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsKeyringsCryptokeysEncryptOps[Self <: ParamsResourceProjectsLocationsKeyringsCryptokeysEncrypt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaEncryptRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
