...
trait ParamsResourceProjectsLocationsKeyringsImportjobsList
  extends StObject
...
object ParamsResourceProjectsLocationsKeyringsImportjobsList {
  
  inline def apply(): ParamsResourceProjectsLocationsKeyringsImportjobsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsKeyringsImportjobsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsKeyringsImportjobsList](x: Self) {
