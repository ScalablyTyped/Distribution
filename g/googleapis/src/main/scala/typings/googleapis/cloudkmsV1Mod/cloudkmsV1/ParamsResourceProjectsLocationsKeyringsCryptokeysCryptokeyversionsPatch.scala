...
object ParamsResourceProjectsLocationsKeyringsCryptokeysCryptokeyversionsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsKeyringsCryptokeysCryptokeyversionsPatchOps[Self <: ParamsResourceProjectsLocationsKeyringsCryptokeysCryptokeyversionsPatch] (val x: Self) extends AnyVal {
    @scala.inline
