...
trait ParamsResourceProjectsLocationsEkmconnectionsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsEkmconnectionsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsEkmconnectionsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsEkmconnectionsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsEkmconnectionsGetiampolicy](x: Self) {
