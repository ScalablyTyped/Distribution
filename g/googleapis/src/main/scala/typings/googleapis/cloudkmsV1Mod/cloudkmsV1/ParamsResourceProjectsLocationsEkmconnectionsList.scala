...
trait ParamsResourceProjectsLocationsEkmconnectionsList
  extends StObject
...
object ParamsResourceProjectsLocationsEkmconnectionsList {
  
  inline def apply(): ParamsResourceProjectsLocationsEkmconnectionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsEkmconnectionsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsEkmconnectionsList](x: Self) {
