...
trait SchemaImportCryptoKeyVersionRequest extends StObject {
  ...
  /**
    ...
    */
  var cryptoKeyVersion: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var rsaAesWrappedKey: js.UndefOr[String | Null] = js.undefined
...
object SchemaImportCryptoKeyVersionRequest {
  
  inline def apply(): SchemaImportCryptoKeyVersionRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaImportCryptoKeyVersionRequest]
  }
  
  extension [Self <: SchemaImportCryptoKeyVersionRequest](x: Self) {
    ...
    inline def setCryptoKeyVersionNull: Self = StObject.set(x, "cryptoKeyVersion", null)
    ...
    inline def setRsaAesWrappedKeyNull: Self = StObject.set(x, "rsaAesWrappedKey", null)
