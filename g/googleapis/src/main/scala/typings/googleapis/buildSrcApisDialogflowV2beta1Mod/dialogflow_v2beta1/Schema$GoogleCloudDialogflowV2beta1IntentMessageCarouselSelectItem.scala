...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1IntentMessageCarouselSelectItem]
  }
}
