...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1IntentParameter extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1IntentParameter {
  @scala.inline
  def apply(
    ...
    value: String = null
  ): Schema$GoogleCloudDialogflowV2beta1IntentParameter = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1IntentParameter]
  }
}
