...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1InputAudioConfig extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1InputAudioConfig {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1InputAudioConfig]
  }
}
