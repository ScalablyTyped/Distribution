...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1RestoreAgentRequest extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1RestoreAgentRequest {
  @scala.inline
  def apply(agentContent: String = null, agentUri: String = null): Schema$GoogleCloudDialogflowV2beta1RestoreAgentRequest = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1RestoreAgentRequest]
  }
}
