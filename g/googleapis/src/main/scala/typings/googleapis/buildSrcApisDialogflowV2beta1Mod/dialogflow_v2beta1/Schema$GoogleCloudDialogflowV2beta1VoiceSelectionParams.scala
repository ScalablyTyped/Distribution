...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1VoiceSelectionParams extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1VoiceSelectionParams {
  @scala.inline
  def apply(name: String = null, ssmlGender: String = null): Schema$GoogleCloudDialogflowV2beta1VoiceSelectionParams = {
    val __obj = js.Dynamic.literal()
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    if (ssmlGender != null) __obj.updateDynamic("ssmlGender")(ssmlGender.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1VoiceSelectionParams]
  }
}
