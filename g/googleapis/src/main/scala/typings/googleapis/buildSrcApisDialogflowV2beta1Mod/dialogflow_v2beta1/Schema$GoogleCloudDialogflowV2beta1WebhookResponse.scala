...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1WebhookResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var followupEventInput: js.UndefOr[Schema$GoogleCloudDialogflowV2beta1EventInput] = js.native
  /**
...
object Schema$GoogleCloudDialogflowV2beta1WebhookResponse {
  @scala.inline
  def apply(
    endInteraction: js.UndefOr[Boolean] = js.undefined,
    followupEventInput: Schema$GoogleCloudDialogflowV2beta1EventInput = null,
    ...
    source: String = null
  ): Schema$GoogleCloudDialogflowV2beta1WebhookResponse = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1WebhookResponse]
  }
}
