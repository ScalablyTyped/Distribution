...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1BatchUpdateEntityTypesRequest extends js.Object {
  /**
    * The collection of entity types to update or create.
    */
  var entityTypeBatchInline: js.UndefOr[Schema$GoogleCloudDialogflowV2beta1EntityTypeBatch] = js.native
  /**
...
object Schema$GoogleCloudDialogflowV2beta1BatchUpdateEntityTypesRequest {
  @scala.inline
  def apply(
    entityTypeBatchInline: Schema$GoogleCloudDialogflowV2beta1EntityTypeBatch = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1BatchUpdateEntityTypesRequest]
  }
}
