...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1Context extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1Context {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1Context]
  }
}
