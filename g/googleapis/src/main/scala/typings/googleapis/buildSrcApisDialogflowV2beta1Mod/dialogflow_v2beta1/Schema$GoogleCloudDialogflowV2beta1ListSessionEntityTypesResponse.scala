...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1ListSessionEntityTypesResponse extends js.Object {
  /**
...
object Schema$GoogleCloudDialogflowV2beta1ListSessionEntityTypesResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1ListSessionEntityTypesResponse]
  }
}
