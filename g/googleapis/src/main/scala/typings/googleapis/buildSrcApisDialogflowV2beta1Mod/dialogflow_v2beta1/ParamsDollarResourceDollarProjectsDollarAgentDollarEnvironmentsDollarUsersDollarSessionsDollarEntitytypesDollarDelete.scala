...
@js.native
trait ParamsDollarResourceDollarProjectsDollarAgentDollarEnvironmentsDollarUsersDollarSessionsDollarEntitytypesDollarDelete extends StandardParameters {
  /**
