...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudDialogflowV2beta1BatchUpdateIntentsRequest extends js.Object {
  /**
    * The collection of intents to update or create.
    */
  var intentBatchInline: js.UndefOr[Schema$GoogleCloudDialogflowV2beta1IntentBatch] = js.native
  /**
...
object Schema$GoogleCloudDialogflowV2beta1BatchUpdateIntentsRequest {
  @scala.inline
  def apply(
    intentBatchInline: Schema$GoogleCloudDialogflowV2beta1IntentBatch = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudDialogflowV2beta1BatchUpdateIntentsRequest]
  }
}
