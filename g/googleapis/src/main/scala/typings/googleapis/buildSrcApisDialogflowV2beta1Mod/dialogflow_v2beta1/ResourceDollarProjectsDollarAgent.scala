...
class ResourceDollarProjectsDollarAgent protected () extends js.Object {
  ...
  var environments: ResourceDollarProjectsDollarAgentDollarEnvironments = js.native
  var intents: ResourceDollarProjectsDollarAgentDollarIntents = js.native
  var knowledgeBases: ResourceDollarProjectsDollarAgentDollarKnowledgebases = js.native
  ...
  /**
    ...
    * @return {object} Request object
    */
  def search(): GaxiosPromise[Schema$GoogleCloudDialogflowV2beta1SearchAgentsResponse] = js.native
  def search(callback: BodyResponseCallback[Schema$GoogleCloudDialogflowV2beta1SearchAgentsResponse]): Unit = js.native
  def search(params: ParamsDollarResourceDollarProjectsDollarAgentDollarSearch): GaxiosPromise[Schema$GoogleCloudDialogflowV2beta1SearchAgentsResponse] = js.native
  def search(
  ...
  def search(
    params: ParamsDollarResourceDollarProjectsDollarAgentDollarSearch,
    options: BodyResponseCallback[Schema$GoogleCloudDialogflowV2beta1SearchAgentsResponse],
    callback: BodyResponseCallback[Schema$GoogleCloudDialogflowV2beta1SearchAgentsResponse]
  ): Unit = js.native
  def search(params: ParamsDollarResourceDollarProjectsDollarAgentDollarSearch, options: MethodOptions): GaxiosPromise[Schema$GoogleCloudDialogflowV2beta1SearchAgentsResponse] = js.native
  def search(
    params: ParamsDollarResourceDollarProjectsDollarAgentDollarSearch,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$GoogleCloudDialogflowV2beta1SearchAgentsResponse]
