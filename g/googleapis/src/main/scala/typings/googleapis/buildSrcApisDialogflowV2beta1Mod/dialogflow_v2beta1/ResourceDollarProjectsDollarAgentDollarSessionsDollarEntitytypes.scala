...
class ResourceDollarProjectsDollarAgentDollarSessionsDollarEntitytypes protected () extends js.Object {
  ...
  def create(params: ParamsDollarResourceDollarProjectsDollarAgentDollarSessionsDollarEntitytypesDollarCreate): GaxiosPromise[Schema$GoogleCloudDialogflowV2beta1SessionEntityType] = js.native
  def create(
  ...
  def get(params: ParamsDollarResourceDollarProjectsDollarAgentDollarSessionsDollarEntitytypesDollarGet): GaxiosPromise[Schema$GoogleCloudDialogflowV2beta1SessionEntityType] = js.native
  def get(
  ...
  def list(params: ParamsDollarResourceDollarProjectsDollarAgentDollarSessionsDollarEntitytypesDollarList): GaxiosPromise[Schema$GoogleCloudDialogflowV2beta1ListSessionEntityTypesResponse] = js.native
  def list(
  ...
  def patch(params: ParamsDollarResourceDollarProjectsDollarAgentDollarSessionsDollarEntitytypesDollarPatch): GaxiosPromise[Schema$GoogleCloudDialogflowV2beta1SessionEntityType] = js.native
  def patch(
