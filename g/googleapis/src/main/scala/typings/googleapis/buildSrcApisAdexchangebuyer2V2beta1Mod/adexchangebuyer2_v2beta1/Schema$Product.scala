...
trait Schema$Product extends js.Object {
  ...
  /**
    ...
    */
  var creatorContacts: js.UndefOr[js.Array[Schema$ContactInformation]] = js.native
  /**
  ...
  /**
    ...
    */
  var targetingCriterion: js.UndefOr[js.Array[Schema$TargetingCriteria]] = js.native
  /**
...
object Schema$Product {
  ...
  def apply(
    ...
    creatorContacts: js.Array[Schema$ContactInformation] = null,
    ...
    targetingCriterion: js.Array[Schema$TargetingCriteria] = null,
