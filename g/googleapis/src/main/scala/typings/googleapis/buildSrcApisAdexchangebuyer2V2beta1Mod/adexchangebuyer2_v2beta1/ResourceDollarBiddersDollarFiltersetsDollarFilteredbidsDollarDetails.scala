...
@js.native
class ResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarDetails protected () extends js.Object {
  ...
  def list(params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarDetailsDollarList): GaxiosPromise[Schema$ListCreativeStatusBreakdownByDetailResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarFiltersetsDollarFilteredbidsDollarDetailsDollarList,
