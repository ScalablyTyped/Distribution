...
@js.native
class ResourceDollarBiddersDollarAccountsDollarFiltersetsDollarBidmetrics protected () extends js.Object {
  ...
  def list(params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarBidmetricsDollarList): GaxiosPromise[Schema$ListBidMetricsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarBidmetricsDollarList,
