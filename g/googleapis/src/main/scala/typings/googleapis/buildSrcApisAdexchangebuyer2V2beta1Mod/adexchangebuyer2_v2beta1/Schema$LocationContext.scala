...
/**
  ...
  */
@js.native
trait Schema$LocationContext extends js.Object {
  /**
...
object Schema$LocationContext {
  @scala.inline
  def apply(geoCriteriaIds: js.Array[Double] = null): Schema$LocationContext = {
    val __obj = js.Dynamic.literal()
    if (geoCriteriaIds != null) __obj.updateDynamic("geoCriteriaIds")(geoCriteriaIds.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$LocationContext]
  }
}
