...
@js.native
class ResourceDollarBiddersDollarAccountsDollarFiltersetsDollarFilteredbidsDollarCreatives protected () extends js.Object {
  ...
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarFilteredbidsDollarCreativesDollarList
