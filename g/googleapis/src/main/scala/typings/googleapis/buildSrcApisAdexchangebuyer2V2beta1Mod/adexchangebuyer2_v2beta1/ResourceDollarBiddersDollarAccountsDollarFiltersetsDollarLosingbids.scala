...
@js.native
class ResourceDollarBiddersDollarAccountsDollarFiltersetsDollarLosingbids protected () extends js.Object {
  ...
  def list(params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarLosingbidsDollarList): GaxiosPromise[Schema$ListLosingBidsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarLosingbidsDollarList,
