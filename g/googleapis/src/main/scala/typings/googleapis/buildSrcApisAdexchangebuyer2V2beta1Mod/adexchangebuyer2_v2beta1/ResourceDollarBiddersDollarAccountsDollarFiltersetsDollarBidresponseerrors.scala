...
@js.native
class ResourceDollarBiddersDollarAccountsDollarFiltersetsDollarBidresponseerrors protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$ListBidResponseErrorsResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListBidResponseErrorsResponse]): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarBidresponseerrorsDollarList
  ): GaxiosPromise[Schema$ListBidResponseErrorsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarBidresponseerrorsDollarList,
  ...
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarBidresponseerrorsDollarList,
    options: BodyResponseCallback[Schema$ListBidResponseErrorsResponse],
    callback: BodyResponseCallback[Schema$ListBidResponseErrorsResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarBidresponseerrorsDollarList,
