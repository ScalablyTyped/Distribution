...
@js.native
class ResourceDollarBiddersDollarAccountsDollarFiltersetsDollarNonbillablewinningbids protected () extends js.Object {
  ...
  def list(
    params: ParamsDollarResourceDollarBiddersDollarAccountsDollarFiltersetsDollarNonbillablewinningbidsDollarList
