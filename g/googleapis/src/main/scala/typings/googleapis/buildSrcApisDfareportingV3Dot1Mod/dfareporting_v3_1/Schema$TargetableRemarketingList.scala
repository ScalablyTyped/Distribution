...
/**
  ...
  */
@js.native
trait Schema$TargetableRemarketingList extends js.Object {
  /**
...
object Schema$TargetableRemarketingList {
  @scala.inline
  def apply(
  ...
  ): Schema$TargetableRemarketingList = {
    ...
    __obj.asInstanceOf[Schema$TargetableRemarketingList]
  }
}
