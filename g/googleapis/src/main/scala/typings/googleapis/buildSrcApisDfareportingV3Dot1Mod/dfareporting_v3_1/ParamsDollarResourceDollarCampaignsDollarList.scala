...
@js.native
trait ParamsDollarResourceDollarCampaignsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCampaignsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCampaignsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCampaignsDollarList]
  }
}
