...
/**
  ...
  */
@js.native
trait Schema$DimensionValueList extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$DimensionValue]] = js.native
  /**
...
object Schema$DimensionValueList {
  @scala.inline
  def apply(
    etag: String = null,
    items: js.Array[Schema$DimensionValue] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$DimensionValueList]
  }
}
