...
/**
  ...
  */
@js.native
trait Schema$PricingSchedulePricingPeriod extends js.Object {
  /**
...
object Schema$PricingSchedulePricingPeriod {
  @scala.inline
  def apply(
    endDate: String = null,
    ...
    units: String = null
  ): Schema$PricingSchedulePricingPeriod = {
    ...
    __obj.asInstanceOf[Schema$PricingSchedulePricingPeriod]
  }
}
