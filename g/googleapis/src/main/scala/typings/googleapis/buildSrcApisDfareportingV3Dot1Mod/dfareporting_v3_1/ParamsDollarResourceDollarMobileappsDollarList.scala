...
@js.native
trait ParamsDollarResourceDollarMobileappsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarMobileappsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarMobileappsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMobileappsDollarList]
  }
}
