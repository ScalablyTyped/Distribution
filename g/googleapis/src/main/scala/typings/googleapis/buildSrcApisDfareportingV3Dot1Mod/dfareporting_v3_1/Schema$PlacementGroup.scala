...
/**
  ...
  */
@js.native
trait Schema$PlacementGroup extends js.Object {
  /**
  ...
  /**
    ...
    * insertion.
    */
  var pricingSchedule: js.UndefOr[Schema$PricingSchedule] = js.native
  /**
  ...
  /**
    ...
    * auto-generated field.
    */
  var primaryPlacementIdDimensionValue: js.UndefOr[Schema$DimensionValue] = js.native
  /**
...
object Schema$PlacementGroup {
  ...
  def apply(
    ...
    pricingSchedule: Schema$PricingSchedule = null,
    primaryPlacementId: String = null,
    primaryPlacementIdDimensionValue: Schema$DimensionValue = null,
    siteId: String = null,
    ...
    __obj.asInstanceOf[Schema$PlacementGroup]
  }
}
