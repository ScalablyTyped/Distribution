...
object ParamsResourceUrlnotificationsPublish {
  ...
  @scala.inline
  implicit class ParamsResourceUrlnotificationsPublishOps[Self <: ParamsResourceUrlnotificationsPublish] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaUrlNotification): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
