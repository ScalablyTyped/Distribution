...
@js.native
trait ParamsDollarResourceDollarSubscriptionsDollarSuspend extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSubscriptionsDollarSuspend {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSubscriptionsDollarSuspend = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSubscriptionsDollarSuspend]
  }
}
