...
@js.native
trait ParamsDollarResourceDollarResellernotifyDollarRegister extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarResellernotifyDollarRegister {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarResellernotifyDollarRegister = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarResellernotifyDollarRegister]
  }
}
