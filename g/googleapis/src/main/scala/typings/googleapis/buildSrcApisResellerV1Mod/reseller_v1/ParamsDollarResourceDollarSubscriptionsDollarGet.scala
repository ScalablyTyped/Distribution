...
@js.native
trait ParamsDollarResourceDollarSubscriptionsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSubscriptionsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSubscriptionsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSubscriptionsDollarGet]
  }
}
