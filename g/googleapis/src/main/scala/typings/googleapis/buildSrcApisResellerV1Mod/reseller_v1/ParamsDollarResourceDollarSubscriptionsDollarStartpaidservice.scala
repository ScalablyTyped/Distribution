...
@js.native
trait ParamsDollarResourceDollarSubscriptionsDollarStartpaidservice extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSubscriptionsDollarStartpaidservice {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSubscriptionsDollarStartpaidservice = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSubscriptionsDollarStartpaidservice]
  }
}
