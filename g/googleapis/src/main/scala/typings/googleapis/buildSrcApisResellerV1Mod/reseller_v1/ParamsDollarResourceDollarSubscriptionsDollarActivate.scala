...
@js.native
trait ParamsDollarResourceDollarSubscriptionsDollarActivate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSubscriptionsDollarActivate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSubscriptionsDollarActivate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSubscriptionsDollarActivate]
  }
}
