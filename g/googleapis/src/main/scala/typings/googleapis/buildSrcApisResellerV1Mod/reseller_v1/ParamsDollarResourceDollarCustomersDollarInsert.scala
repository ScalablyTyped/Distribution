...
@js.native
trait ParamsDollarResourceDollarCustomersDollarInsert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCustomersDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCustomersDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCustomersDollarInsert]
  }
}
