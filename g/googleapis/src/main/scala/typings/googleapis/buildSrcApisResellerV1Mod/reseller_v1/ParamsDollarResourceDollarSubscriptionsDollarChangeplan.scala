...
@js.native
trait ParamsDollarResourceDollarSubscriptionsDollarChangeplan extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$ChangePlanRequest] = js.native
  /**
...
object ParamsDollarResourceDollarSubscriptionsDollarChangeplan {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$ChangePlanRequest = null,
    subscriptionId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarSubscriptionsDollarChangeplan = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSubscriptionsDollarChangeplan]
  }
}
