...
@js.native
trait AnonIdInitialurl extends js.Object {
  var id: js.UndefOr[String] = js.native
  var initial_url: js.UndefOr[String] = js.native
  var metrics: js.UndefOr[StringDictionary[AnonCategoryDistributions]] = js.native
  var overall_category: js.UndefOr[String] = js.native
}

object AnonIdInitialurl {
  @scala.inline
  def apply(
    id: String = null,
    initial_url: String = null,
    metrics: StringDictionary[AnonCategoryDistributions] = null,
    ...
    __obj.asInstanceOf[AnonIdInitialurl]
  }
}
