...
trait ParamsResourceProjectsLocationsHttproutesList
  extends StObject
...
object ParamsResourceProjectsLocationsHttproutesList {
  
  inline def apply(): ParamsResourceProjectsLocationsHttproutesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsHttproutesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsHttproutesList](x: Self) {
