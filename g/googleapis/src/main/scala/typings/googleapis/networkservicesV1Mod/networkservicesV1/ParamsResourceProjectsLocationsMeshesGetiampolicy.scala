...
trait ParamsResourceProjectsLocationsMeshesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsMeshesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsMeshesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsMeshesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsMeshesGetiampolicy](x: Self) {
