...
@JSImport("googleapis/build/src/apis/networkservices/v1", "networkservices_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var edgeCacheKeysets: ResourceProjectsLocationsEdgecachekeysets = js.native
  
  var edgeCacheOrigins: ResourceProjectsLocationsEdgecacheorigins = js.native
  
  var edgeCacheServices: ResourceProjectsLocationsEdgecacheservices = js.native
