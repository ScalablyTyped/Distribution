...
trait ParamsResourceProjectsLocationsTlsroutesList
  extends StObject
...
object ParamsResourceProjectsLocationsTlsroutesList {
  
  inline def apply(): ParamsResourceProjectsLocationsTlsroutesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsTlsroutesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsTlsroutesList](x: Self) {
