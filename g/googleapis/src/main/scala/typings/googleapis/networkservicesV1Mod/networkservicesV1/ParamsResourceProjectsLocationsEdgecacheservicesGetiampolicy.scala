...
trait ParamsResourceProjectsLocationsEdgecacheservicesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsEdgecacheservicesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsEdgecacheservicesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsEdgecacheservicesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsEdgecacheservicesGetiampolicy](x: Self) {
