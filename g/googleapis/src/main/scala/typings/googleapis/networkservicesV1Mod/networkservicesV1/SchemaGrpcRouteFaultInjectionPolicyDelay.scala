...
trait SchemaGrpcRouteFaultInjectionPolicyDelay extends StObject {
...
object SchemaGrpcRouteFaultInjectionPolicyDelay {
  
  inline def apply(): SchemaGrpcRouteFaultInjectionPolicyDelay = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGrpcRouteFaultInjectionPolicyDelay]
  }
  
  extension [Self <: SchemaGrpcRouteFaultInjectionPolicyDelay](x: Self) {
