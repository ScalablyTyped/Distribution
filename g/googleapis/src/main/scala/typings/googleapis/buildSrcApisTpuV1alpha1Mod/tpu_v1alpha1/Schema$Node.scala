...
/**
  ...
  */
@js.native
trait Schema$Node extends js.Object {
  /**
  ...
  var schedulingConfig: js.UndefOr[Schema$SchedulingConfig] = js.native
  /**
...
object Schema$Node {
  ...
  def apply(
    ...
    name: String = null,
    network: String = null,
    networkEndpoints: js.Array[Schema$NetworkEndpoint] = null,
    port: String = null,
    schedulingConfig: Schema$SchedulingConfig = null,
    ...
    __obj.asInstanceOf[Schema$Node]
  }
}
