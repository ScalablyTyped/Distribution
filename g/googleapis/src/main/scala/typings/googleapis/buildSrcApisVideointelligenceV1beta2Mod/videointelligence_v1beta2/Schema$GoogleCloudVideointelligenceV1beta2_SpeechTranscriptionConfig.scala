...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig extends js.Object {
  /**
  ...
  /**
    ...
    */
  var speechContexts: js.UndefOr[js.Array[Schema$GoogleCloudVideointelligenceV1beta2_SpeechContext]] = js.native
}

object Schema$GoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig {
  @scala.inline
  def apply(
    ...
    speechContexts: js.Array[Schema$GoogleCloudVideointelligenceV1beta2_SpeechContext] = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1beta2_SpeechTranscriptionConfig]
  }
}
