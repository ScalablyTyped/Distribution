...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1beta2_LabelDetectionConfig extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1beta2_LabelDetectionConfig {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1beta2_LabelDetectionConfig]
  }
}
