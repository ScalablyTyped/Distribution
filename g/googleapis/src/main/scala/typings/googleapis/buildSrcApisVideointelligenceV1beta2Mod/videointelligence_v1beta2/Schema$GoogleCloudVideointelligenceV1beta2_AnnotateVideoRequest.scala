...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1beta2_AnnotateVideoRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var videoContext: js.UndefOr[Schema$GoogleCloudVideointelligenceV1beta2_VideoContext] = js.native
}

object Schema$GoogleCloudVideointelligenceV1beta2_AnnotateVideoRequest {
  @scala.inline
  def apply(
    ...
    videoContext: Schema$GoogleCloudVideointelligenceV1beta2_VideoContext = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1beta2_AnnotateVideoRequest]
  }
}
