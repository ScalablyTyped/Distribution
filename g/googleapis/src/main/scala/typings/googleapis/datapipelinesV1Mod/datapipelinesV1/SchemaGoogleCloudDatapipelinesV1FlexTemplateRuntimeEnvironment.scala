...
trait SchemaGoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment extends StObject {
...
object SchemaGoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment {
  
  inline def apply(): SchemaGoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment]
  }
  
  extension [Self <: SchemaGoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment](x: Self) {
