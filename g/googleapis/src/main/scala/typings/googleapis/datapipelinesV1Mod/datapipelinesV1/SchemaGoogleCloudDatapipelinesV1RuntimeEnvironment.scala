...
trait SchemaGoogleCloudDatapipelinesV1RuntimeEnvironment extends StObject {
...
object SchemaGoogleCloudDatapipelinesV1RuntimeEnvironment {
  
  inline def apply(): SchemaGoogleCloudDatapipelinesV1RuntimeEnvironment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatapipelinesV1RuntimeEnvironment]
  }
  
  extension [Self <: SchemaGoogleCloudDatapipelinesV1RuntimeEnvironment](x: Self) {
