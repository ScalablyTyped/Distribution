...
object ParamsResourceDocumentsBatchupdate {
  ...
  @scala.inline
  implicit class ParamsResourceDocumentsBatchupdateOps[Self <: ParamsResourceDocumentsBatchupdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchUpdateDocumentRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
