...
trait SchemaNestingLevel extends StObject {
  ...
  /**
    ...
    */
  var bulletAlignment: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var glyphFormat: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var glyphSymbol: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var glyphType: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var startNumber: js.UndefOr[Double | Null] = js.undefined
...
object SchemaNestingLevel {
  ...
  extension [Self <: SchemaNestingLevel](x: Self) {
    ...
    inline def setBulletAlignmentNull: Self = StObject.set(x, "bulletAlignment", null)
    ...
    inline def setGlyphFormatNull: Self = StObject.set(x, "glyphFormat", null)
    ...
    inline def setGlyphSymbolNull: Self = StObject.set(x, "glyphSymbol", null)
    ...
    inline def setGlyphTypeNull: Self = StObject.set(x, "glyphType", null)
    ...
    inline def setStartNumberNull: Self = StObject.set(x, "startNumber", null)
