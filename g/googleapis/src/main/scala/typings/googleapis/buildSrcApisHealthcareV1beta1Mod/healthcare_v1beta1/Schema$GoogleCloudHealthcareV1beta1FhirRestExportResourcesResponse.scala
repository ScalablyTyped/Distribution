...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudHealthcareV1beta1FhirRestExportResourcesResponse extends js.Object {
  /**
...
object Schema$GoogleCloudHealthcareV1beta1FhirRestExportResourcesResponse {
  @scala.inline
  def apply(fhirStore: String = null, resourceCount: String = null): Schema$GoogleCloudHealthcareV1beta1FhirRestExportResourcesResponse = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudHealthcareV1beta1FhirRestExportResourcesResponse]
  }
}
