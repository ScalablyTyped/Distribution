...
trait Schema$ImportResourcesRequest extends js.Object {
  ...
  /**
    ...
    */
  var gcsSource: js.UndefOr[Schema$GoogleCloudHealthcareV1beta1FhirRestGcsSource] = js.native
}
...
object Schema$ImportResourcesRequest {
  ...
  def apply(
    ...
    gcsSource: Schema$GoogleCloudHealthcareV1beta1FhirRestGcsSource = null
