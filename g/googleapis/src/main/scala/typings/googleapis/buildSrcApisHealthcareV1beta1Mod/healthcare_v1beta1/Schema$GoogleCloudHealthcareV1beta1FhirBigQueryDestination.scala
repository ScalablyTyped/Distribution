...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudHealthcareV1beta1FhirBigQueryDestination extends js.Object {
  /**
...
object Schema$GoogleCloudHealthcareV1beta1FhirBigQueryDestination {
  @scala.inline
  def apply(datasetUri: String = null, schemaConfig: Schema$SchemaConfig = null): Schema$GoogleCloudHealthcareV1beta1FhirBigQueryDestination = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudHealthcareV1beta1FhirBigQueryDestination]
  }
}
