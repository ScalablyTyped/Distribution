...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudHealthcareV1beta1FhirRestImportResourcesErrorDetails extends js.Object {
  /**
...
object Schema$GoogleCloudHealthcareV1beta1FhirRestImportResourcesErrorDetails {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleCloudHealthcareV1beta1FhirRestImportResourcesErrorDetails = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudHealthcareV1beta1FhirRestImportResourcesErrorDetails]
  }
}
