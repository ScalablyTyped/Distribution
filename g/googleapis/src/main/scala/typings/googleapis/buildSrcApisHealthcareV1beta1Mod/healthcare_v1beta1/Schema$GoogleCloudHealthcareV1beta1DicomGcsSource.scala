...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudHealthcareV1beta1DicomGcsSource extends js.Object {
  /**
...
object Schema$GoogleCloudHealthcareV1beta1DicomGcsSource {
  @scala.inline
  def apply(uri: String = null): Schema$GoogleCloudHealthcareV1beta1DicomGcsSource = {
    val __obj = js.Dynamic.literal()
    if (uri != null) __obj.updateDynamic("uri")(uri.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleCloudHealthcareV1beta1DicomGcsSource]
  }
}
