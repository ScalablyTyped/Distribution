...
trait ParamsResourceProjectsLocationsCustomclassesList
  extends StObject
...
object ParamsResourceProjectsLocationsCustomclassesList {
  
  inline def apply(): ParamsResourceProjectsLocationsCustomclassesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCustomclassesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCustomclassesList](x: Self) {
