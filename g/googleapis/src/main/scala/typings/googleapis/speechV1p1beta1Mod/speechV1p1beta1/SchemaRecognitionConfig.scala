...
trait SchemaRecognitionConfig extends StObject {
  ...
  /**
    ...
    */
  var transcriptNormalization: js.UndefOr[SchemaTranscriptNormalization] = js.undefined
...
object SchemaRecognitionConfig {
  ...
  extension [Self <: SchemaRecognitionConfig](x: Self) {
    ...
    inline def setTranscriptNormalization(value: SchemaTranscriptNormalization): Self = StObject.set(x, "transcriptNormalization", value.asInstanceOf[js.Any])
    
    inline def setTranscriptNormalizationUndefined: Self = StObject.set(x, "transcriptNormalization", js.undefined)
