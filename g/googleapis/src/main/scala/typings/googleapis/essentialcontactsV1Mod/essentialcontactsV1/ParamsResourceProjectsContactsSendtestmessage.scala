...
trait ParamsResourceProjectsContactsSendtestmessage
  extends StObject
...
object ParamsResourceProjectsContactsSendtestmessage {
  
  inline def apply(): ParamsResourceProjectsContactsSendtestmessage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsContactsSendtestmessage]
  }
  
  extension [Self <: ParamsResourceProjectsContactsSendtestmessage](x: Self) {
