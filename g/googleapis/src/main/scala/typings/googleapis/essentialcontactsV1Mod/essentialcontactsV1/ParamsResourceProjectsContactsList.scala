...
trait ParamsResourceProjectsContactsList
  extends StObject
...
object ParamsResourceProjectsContactsList {
  
  inline def apply(): ParamsResourceProjectsContactsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsContactsList]
  }
  
  extension [Self <: ParamsResourceProjectsContactsList](x: Self) {
