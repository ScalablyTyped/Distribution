...
trait SchemaGoogleCloudEssentialcontactsV1ListContactsResponse extends StObject {
...
object SchemaGoogleCloudEssentialcontactsV1ListContactsResponse {
  
  inline def apply(): SchemaGoogleCloudEssentialcontactsV1ListContactsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudEssentialcontactsV1ListContactsResponse]
  }
  
  extension [Self <: SchemaGoogleCloudEssentialcontactsV1ListContactsResponse](x: Self) {
