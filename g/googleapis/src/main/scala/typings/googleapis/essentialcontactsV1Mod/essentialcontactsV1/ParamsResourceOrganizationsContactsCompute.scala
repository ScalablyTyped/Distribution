...
trait ParamsResourceOrganizationsContactsCompute
  extends StObject
...
object ParamsResourceOrganizationsContactsCompute {
  
  inline def apply(): ParamsResourceOrganizationsContactsCompute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsContactsCompute]
  }
  
  extension [Self <: ParamsResourceOrganizationsContactsCompute](x: Self) {
