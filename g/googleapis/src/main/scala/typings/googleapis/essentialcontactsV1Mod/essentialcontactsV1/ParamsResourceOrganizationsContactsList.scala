...
trait ParamsResourceOrganizationsContactsList
  extends StObject
...
object ParamsResourceOrganizationsContactsList {
  
  inline def apply(): ParamsResourceOrganizationsContactsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsContactsList]
  }
  
  extension [Self <: ParamsResourceOrganizationsContactsList](x: Self) {
