...
trait ParamsResourceFoldersContactsSendtestmessage
  extends StObject
...
object ParamsResourceFoldersContactsSendtestmessage {
  
  inline def apply(): ParamsResourceFoldersContactsSendtestmessage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersContactsSendtestmessage]
  }
  
  extension [Self <: ParamsResourceFoldersContactsSendtestmessage](x: Self) {
