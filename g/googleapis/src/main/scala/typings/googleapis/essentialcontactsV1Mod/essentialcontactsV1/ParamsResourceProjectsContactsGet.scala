...
trait ParamsResourceProjectsContactsGet
  extends StObject
...
object ParamsResourceProjectsContactsGet {
  
  inline def apply(): ParamsResourceProjectsContactsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsContactsGet]
  }
  
  extension [Self <: ParamsResourceProjectsContactsGet](x: Self) {
