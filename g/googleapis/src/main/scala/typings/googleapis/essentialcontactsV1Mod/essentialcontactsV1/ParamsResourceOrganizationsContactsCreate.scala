...
trait ParamsResourceOrganizationsContactsCreate
  extends StObject
...
object ParamsResourceOrganizationsContactsCreate {
  
  inline def apply(): ParamsResourceOrganizationsContactsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsContactsCreate]
  }
  
  extension [Self <: ParamsResourceOrganizationsContactsCreate](x: Self) {
