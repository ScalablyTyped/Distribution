...
trait ParamsResourceProjectsContactsCompute
  extends StObject
...
object ParamsResourceProjectsContactsCompute {
  
  inline def apply(): ParamsResourceProjectsContactsCompute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsContactsCompute]
  }
  
  extension [Self <: ParamsResourceProjectsContactsCompute](x: Self) {
