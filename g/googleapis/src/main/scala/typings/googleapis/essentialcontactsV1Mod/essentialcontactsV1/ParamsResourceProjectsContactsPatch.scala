...
trait ParamsResourceProjectsContactsPatch
  extends StObject
...
object ParamsResourceProjectsContactsPatch {
  
  inline def apply(): ParamsResourceProjectsContactsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsContactsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsContactsPatch](x: Self) {
