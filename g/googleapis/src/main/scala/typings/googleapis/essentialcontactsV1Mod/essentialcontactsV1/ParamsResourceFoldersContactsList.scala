...
trait ParamsResourceFoldersContactsList
  extends StObject
...
object ParamsResourceFoldersContactsList {
  
  inline def apply(): ParamsResourceFoldersContactsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersContactsList]
  }
  
  extension [Self <: ParamsResourceFoldersContactsList](x: Self) {
