...
/**
  ...
  */
@js.native
trait Schema$Usage extends js.Object {
  /**
  ...
  /**
    ...
    */
  var rules: js.UndefOr[js.Array[Schema$UsageRule]] = js.native
}
...
object Schema$Usage {
  ...
  def apply(
    ...
    rules: js.Array[Schema$UsageRule] = null
  ): Schema$Usage = {
    ...
    __obj.asInstanceOf[Schema$Usage]
  }
}
