...
object SchemaType {
  ...
  extension [Self <: SchemaType](x: Self) {
    ...
    inline def setConfigurableService(value: SchemaConfigurableService): Self = StObject.set(x, "configurableService", value.asInstanceOf[js.Any])
    
    inline def setConfigurableServiceUndefined: Self = StObject.set(x, "configurableService", js.undefined)
    ...
    inline def setLabelsVarargs(value: SchemaTypeLabelEntry*): Self = StObject.set(x, "labels", js.Array(value :_*))
