...
object SchemaResource {
  ...
  implicit class SchemaResourceOps[Self <: SchemaResource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLastUsedCredential(value: SchemaCredential): Self = this.set("lastUsedCredential", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLastUsedCredential: Self = this.set("lastUsedCredential", js.undefined)
