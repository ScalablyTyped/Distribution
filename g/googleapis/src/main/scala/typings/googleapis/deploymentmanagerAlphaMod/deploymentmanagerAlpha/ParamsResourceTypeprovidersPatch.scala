...
@js.native
trait ParamsResourceTypeprovidersPatch extends StandardParameters {
...
object ParamsResourceTypeprovidersPatch {
  
  @scala.inline
  def apply(): ParamsResourceTypeprovidersPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTypeprovidersPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceTypeprovidersPatchMutableBuilder[Self <: ParamsResourceTypeprovidersPatch] (val x: Self) extends AnyVal {
