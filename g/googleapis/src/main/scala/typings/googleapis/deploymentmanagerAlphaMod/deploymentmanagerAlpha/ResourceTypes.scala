...
open class ResourceTypes protected () extends StObject {
  ...
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaType] = js.native
  ...
  def get(
    ...
    options: BodyResponseCallback[Readable | SchemaType],
    callback: BodyResponseCallback[Readable | SchemaType]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def get(params: ParamsResourceTypesGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceTypesGet,
