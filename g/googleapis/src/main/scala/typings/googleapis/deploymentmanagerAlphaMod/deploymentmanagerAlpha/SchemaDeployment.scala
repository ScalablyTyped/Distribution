...
object SchemaDeployment {
  ...
  extension [Self <: SchemaDeployment](x: Self) {
    ...
    inline def setOutputs(value: js.Array[SchemaDeploymentOutputsEntry]): Self = StObject.set(x, "outputs", value.asInstanceOf[js.Any])
    
    inline def setOutputsUndefined: Self = StObject.set(x, "outputs", js.undefined)
    
    inline def setOutputsVarargs(value: SchemaDeploymentOutputsEntry*): Self = StObject.set(x, "outputs", js.Array(value :_*))
