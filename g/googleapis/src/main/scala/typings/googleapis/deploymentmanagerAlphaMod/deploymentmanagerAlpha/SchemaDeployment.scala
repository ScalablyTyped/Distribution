...
object SchemaDeployment {
  ...
  implicit class SchemaDeploymentOps[Self <: SchemaDeployment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOutputsVarargs(value: SchemaDeploymentOutputsEntry*): Self = this.set("outputs", js.Array(value :_*))
    @scala.inline
    def setOutputs(value: js.Array[SchemaDeploymentOutputsEntry]): Self = this.set("outputs", value.asInstanceOf[js.Any])
    @scala.inline
