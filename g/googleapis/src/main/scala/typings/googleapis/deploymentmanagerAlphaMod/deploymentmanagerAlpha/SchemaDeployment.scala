...
trait SchemaDeployment extends StObject {
  ...
  /**
    ...
    */
  var outputs: js.UndefOr[js.Array[SchemaDeploymentOutputEntry]] = js.undefined
...
object SchemaDeployment {
  ...
  extension [Self <: SchemaDeployment](x: Self) {
    ...
    inline def setOutputs(value: js.Array[SchemaDeploymentOutputEntry]): Self = StObject.set(x, "outputs", value.asInstanceOf[js.Any])
    
    inline def setOutputsUndefined: Self = StObject.set(x, "outputs", js.undefined)
    
    inline def setOutputsVarargs(value: SchemaDeploymentOutputEntry*): Self = StObject.set(x, "outputs", js.Array(value*))
