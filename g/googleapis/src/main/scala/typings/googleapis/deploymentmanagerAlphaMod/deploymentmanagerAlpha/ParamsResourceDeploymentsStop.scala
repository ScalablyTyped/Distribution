...
object ParamsResourceDeploymentsStop {
  ...
  @scala.inline
  implicit class ParamsResourceDeploymentsStopOps[Self <: ParamsResourceDeploymentsStop] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaDeploymentsStopRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
