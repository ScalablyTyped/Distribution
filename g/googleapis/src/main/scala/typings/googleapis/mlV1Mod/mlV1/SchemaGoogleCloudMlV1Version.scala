...
trait SchemaGoogleCloudMlV1Version extends StObject {
  ...
  /**
    ...
    */
  var container: js.UndefOr[SchemaGoogleCloudMlV1ContainerSpec] = js.undefined
  ...
  /**
    ...
    */
  var deploymentUri: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var explanationConfig: js.UndefOr[SchemaGoogleCloudMlV1ExplanationConfig] = js.undefined
  ...
  /**
    ...
    */
  var lastMigrationModelId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var lastMigrationTime: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Output only. The time the version was last used for prediction.
    */
  var lastUseTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var predictionClass: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var requestLoggingConfig: js.UndefOr[SchemaGoogleCloudMlV1RequestLoggingConfig] = js.undefined
  ...
  /**
    ...
    */
  var routes: js.UndefOr[SchemaGoogleCloudMlV1RouteMap] = js.undefined
...
object SchemaGoogleCloudMlV1Version {
  ...
  extension [Self <: SchemaGoogleCloudMlV1Version](x: Self) {
    ...
    inline def setContainer(value: SchemaGoogleCloudMlV1ContainerSpec): Self = StObject.set(x, "container", value.asInstanceOf[js.Any])
    ...
    inline def setDeploymentUriNull: Self = StObject.set(x, "deploymentUri", null)
    ...
    inline def setExplanationConfig(value: SchemaGoogleCloudMlV1ExplanationConfig): Self = StObject.set(x, "explanationConfig", value.asInstanceOf[js.Any])
    ...
    inline def setLastMigrationModelIdNull: Self = StObject.set(x, "lastMigrationModelId", null)
    ...
    inline def setLastMigrationTimeNull: Self = StObject.set(x, "lastMigrationTime", null)
    ...
    inline def setLastUseTimeNull: Self = StObject.set(x, "lastUseTime", null)
    ...
    inline def setPredictionClassNull: Self = StObject.set(x, "predictionClass", null)
    ...
    inline def setRequestLoggingConfig(value: SchemaGoogleCloudMlV1RequestLoggingConfig): Self = StObject.set(x, "requestLoggingConfig", value.asInstanceOf[js.Any])
    
    inline def setRequestLoggingConfigUndefined: Self = StObject.set(x, "requestLoggingConfig", js.undefined)
    
    inline def setRoutes(value: SchemaGoogleCloudMlV1RouteMap): Self = StObject.set(x, "routes", value.asInstanceOf[js.Any])
