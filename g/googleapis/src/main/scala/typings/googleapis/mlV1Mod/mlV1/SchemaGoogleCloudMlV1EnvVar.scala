...
trait SchemaGoogleCloudMlV1EnvVar extends StObject {
...
object SchemaGoogleCloudMlV1EnvVar {
  
  inline def apply(): SchemaGoogleCloudMlV1EnvVar = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudMlV1EnvVar]
  }
  
  extension [Self <: SchemaGoogleCloudMlV1EnvVar](x: Self) {
