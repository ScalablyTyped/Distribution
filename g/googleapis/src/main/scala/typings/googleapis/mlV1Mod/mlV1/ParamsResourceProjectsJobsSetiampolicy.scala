...
trait ParamsResourceProjectsJobsSetiampolicy
  extends StObject
...
object ParamsResourceProjectsJobsSetiampolicy {
  ...
  inline def apply(): ParamsResourceProjectsJobsSetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsJobsSetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsJobsSetiampolicy](x: Self) {
