...
object ParamsResourceProjectsModelsVersionsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsModelsVersionsPatchOps[Self <: ParamsResourceProjectsModelsVersionsPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleCloudMlV1Version): Self = this.set("requestBody", value.asInstanceOf[js.Any])
