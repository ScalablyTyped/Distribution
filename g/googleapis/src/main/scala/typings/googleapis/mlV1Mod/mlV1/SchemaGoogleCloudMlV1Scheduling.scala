...
trait SchemaGoogleCloudMlV1Scheduling extends StObject {
  ...
  /**
    ...
    */
  var maxRunningTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var maxWaitTime: js.UndefOr[String | Null] = js.undefined
...
object SchemaGoogleCloudMlV1Scheduling {
  
  inline def apply(): SchemaGoogleCloudMlV1Scheduling = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudMlV1Scheduling]
  }
  
  extension [Self <: SchemaGoogleCloudMlV1Scheduling](x: Self) {
    
    inline def setMaxRunningTime(value: String): Self = StObject.set(x, "maxRunningTime", value.asInstanceOf[js.Any])
    
    inline def setMaxRunningTimeNull: Self = StObject.set(x, "maxRunningTime", null)
    ...
    inline def setMaxWaitTimeNull: Self = StObject.set(x, "maxWaitTime", null)
