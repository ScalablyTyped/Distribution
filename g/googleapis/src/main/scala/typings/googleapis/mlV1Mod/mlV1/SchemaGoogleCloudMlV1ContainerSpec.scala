...
trait SchemaGoogleCloudMlV1ContainerSpec extends StObject {
  ...
  /**
    ...
    */
  var env: js.UndefOr[js.Array[SchemaGoogleCloudMlV1EnvVar]] = js.undefined
  ...
  /**
    ...
    */
  var ports: js.UndefOr[js.Array[SchemaGoogleCloudMlV1ContainerPort]] = js.undefined
}
object SchemaGoogleCloudMlV1ContainerSpec {
  
  inline def apply(): SchemaGoogleCloudMlV1ContainerSpec = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudMlV1ContainerSpec]
  }
  
  extension [Self <: SchemaGoogleCloudMlV1ContainerSpec](x: Self) {
    ...
    inline def setEnv(value: js.Array[SchemaGoogleCloudMlV1EnvVar]): Self = StObject.set(x, "env", value.asInstanceOf[js.Any])
    
    inline def setEnvUndefined: Self = StObject.set(x, "env", js.undefined)
    
    inline def setEnvVarargs(value: SchemaGoogleCloudMlV1EnvVar*): Self = StObject.set(x, "env", js.Array(value*))
    ...
    inline def setPorts(value: js.Array[SchemaGoogleCloudMlV1ContainerPort]): Self = StObject.set(x, "ports", value.asInstanceOf[js.Any])
    
    inline def setPortsUndefined: Self = StObject.set(x, "ports", js.undefined)
    
    inline def setPortsVarargs(value: SchemaGoogleCloudMlV1ContainerPort*): Self = StObject.set(x, "ports", js.Array(value*))
  }
}
