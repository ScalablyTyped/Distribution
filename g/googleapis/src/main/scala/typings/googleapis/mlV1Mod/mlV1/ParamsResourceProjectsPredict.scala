...
object ParamsResourceProjectsPredict {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsPredictMutableBuilder[Self <: ParamsResourceProjectsPredict] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleCloudMlV1PredictRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
