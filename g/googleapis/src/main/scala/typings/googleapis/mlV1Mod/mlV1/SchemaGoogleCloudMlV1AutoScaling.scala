...
trait SchemaGoogleCloudMlV1AutoScaling extends StObject {
  ...
  /**
    ...
    */
  var metrics: js.UndefOr[js.Array[SchemaGoogleCloudMlV1MetricSpec]] = js.undefined
...
object SchemaGoogleCloudMlV1AutoScaling {
  ...
  extension [Self <: SchemaGoogleCloudMlV1AutoScaling](x: Self) {
    ...
    inline def setMetrics(value: js.Array[SchemaGoogleCloudMlV1MetricSpec]): Self = StObject.set(x, "metrics", value.asInstanceOf[js.Any])
    
    inline def setMetricsUndefined: Self = StObject.set(x, "metrics", js.undefined)
    
    inline def setMetricsVarargs(value: SchemaGoogleCloudMlV1MetricSpec*): Self = StObject.set(x, "metrics", js.Array(value*))
