...
object ParamsResourceProjectsModelsVersionsList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsModelsVersionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsModelsVersionsList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsModelsVersionsListMutableBuilder[Self <: ParamsResourceProjectsModelsVersionsList] (val x: Self) extends AnyVal {
