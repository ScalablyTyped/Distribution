...
trait ParamsResourceProjectsInboundsamlconfigsPatch
  extends StObject
...
object ParamsResourceProjectsInboundsamlconfigsPatch {
  
  inline def apply(): ParamsResourceProjectsInboundsamlconfigsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsInboundsamlconfigsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsInboundsamlconfigsPatch](x: Self) {
