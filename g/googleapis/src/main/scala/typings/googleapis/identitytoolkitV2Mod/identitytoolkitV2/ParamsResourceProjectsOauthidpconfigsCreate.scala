...
trait ParamsResourceProjectsOauthidpconfigsCreate
  extends StObject
...
object ParamsResourceProjectsOauthidpconfigsCreate {
  
  inline def apply(): ParamsResourceProjectsOauthidpconfigsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsOauthidpconfigsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsOauthidpconfigsCreate](x: Self) {
