...
trait ParamsResourceProjectsTenantsInboundsamlconfigsPatch
  extends StObject
...
object ParamsResourceProjectsTenantsInboundsamlconfigsPatch {
  
  inline def apply(): ParamsResourceProjectsTenantsInboundsamlconfigsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsTenantsInboundsamlconfigsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsTenantsInboundsamlconfigsPatch](x: Self) {
