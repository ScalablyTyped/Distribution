...
trait ParamsResourceProjectsDefaultsupportedidpconfigsCreate
  extends StObject
...
object ParamsResourceProjectsDefaultsupportedidpconfigsCreate {
  
  inline def apply(): ParamsResourceProjectsDefaultsupportedidpconfigsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsDefaultsupportedidpconfigsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsDefaultsupportedidpconfigsCreate](x: Self) {
