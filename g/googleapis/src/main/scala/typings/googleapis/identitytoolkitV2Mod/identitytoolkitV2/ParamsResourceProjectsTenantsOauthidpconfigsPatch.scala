...
trait ParamsResourceProjectsTenantsOauthidpconfigsPatch
  extends StObject
...
object ParamsResourceProjectsTenantsOauthidpconfigsPatch {
  
  inline def apply(): ParamsResourceProjectsTenantsOauthidpconfigsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsTenantsOauthidpconfigsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsTenantsOauthidpconfigsPatch](x: Self) {
