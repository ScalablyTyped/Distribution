...
trait ParamsResourceProjectsTenantsInboundsamlconfigsCreate
  extends StObject
...
object ParamsResourceProjectsTenantsInboundsamlconfigsCreate {
  
  inline def apply(): ParamsResourceProjectsTenantsInboundsamlconfigsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsTenantsInboundsamlconfigsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsTenantsInboundsamlconfigsCreate](x: Self) {
