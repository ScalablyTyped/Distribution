...
trait SchemaGoogleCloudIdentitytoolkitAdminV2Permissions extends StObject {
...
object SchemaGoogleCloudIdentitytoolkitAdminV2Permissions {
  
  inline def apply(): SchemaGoogleCloudIdentitytoolkitAdminV2Permissions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudIdentitytoolkitAdminV2Permissions]
  }
  
  extension [Self <: SchemaGoogleCloudIdentitytoolkitAdminV2Permissions](x: Self) {
