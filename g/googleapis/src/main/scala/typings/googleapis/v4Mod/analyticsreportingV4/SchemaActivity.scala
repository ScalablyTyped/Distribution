...
object SchemaActivity {
  ...
  extension [Self <: SchemaActivity](x: Self) {
    ...
    inline def setAppview(value: SchemaScreenviewData): Self = StObject.set(x, "appview", value.asInstanceOf[js.Any])
    ...
    inline def setEvent(value: SchemaEventData): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
    
    inline def setEventUndefined: Self = StObject.set(x, "event", js.undefined)
    
    inline def setGoals(value: SchemaGoalSetData): Self = StObject.set(x, "goals", value.asInstanceOf[js.Any])
    ...
    inline def setPageview(value: SchemaPageviewData): Self = StObject.set(x, "pageview", value.asInstanceOf[js.Any])
