...
object SchemaMetricFilterClause {
  ...
  implicit class SchemaMetricFilterClauseOps[Self <: SchemaMetricFilterClause] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFiltersVarargs(value: SchemaMetricFilter*): Self = this.set("filters", js.Array(value :_*))
    
    @scala.inline
    def setFilters(value: js.Array[SchemaMetricFilter]): Self = this.set("filters", value.asInstanceOf[js.Any])
