...
import typings.googleapis.AnonCategoryDistributionsPercentile
...
trait SchemaPagespeedApiLoadingExperienceV5 extends js.Object {
  ...
  var metrics: js.UndefOr[StringDictionary[AnonCategoryDistributionsPercentile]] = js.native
...
object SchemaPagespeedApiLoadingExperienceV5 {
  ...
  def apply(
    ...
    metrics: StringDictionary[AnonCategoryDistributionsPercentile] = null,
