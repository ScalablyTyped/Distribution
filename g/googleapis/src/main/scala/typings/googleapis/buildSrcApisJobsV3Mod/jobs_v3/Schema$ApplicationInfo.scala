...
/**
  ...
  */
@js.native
trait Schema$ApplicationInfo extends js.Object {
  /**
...
object Schema$ApplicationInfo {
  @scala.inline
  def apply(emails: js.Array[String] = null, instruction: String = null, uris: js.Array[String] = null): Schema$ApplicationInfo = {
    ...
    __obj.asInstanceOf[Schema$ApplicationInfo]
  }
}
