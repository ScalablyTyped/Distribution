...
/**
  ...
  */
@js.native
trait Schema$UserOwnedDrydockNote extends js.Object {
  /**
  ...
  /**
    ...
    */
  var publicKeys: js.UndefOr[js.Array[Schema$AttestorPublicKey]] = js.native
}

object Schema$UserOwnedDrydockNote {
  @scala.inline
  def apply(
    delegationServiceAccountEmail: String = null,
    noteReference: String = null,
    publicKeys: js.Array[Schema$AttestorPublicKey] = null
  ): Schema$UserOwnedDrydockNote = {
    ...
    __obj.asInstanceOf[Schema$UserOwnedDrydockNote]
  }
}
