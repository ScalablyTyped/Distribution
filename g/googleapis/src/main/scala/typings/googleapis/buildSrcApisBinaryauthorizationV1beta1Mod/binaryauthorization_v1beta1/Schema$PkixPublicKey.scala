...
/**
  ...
  */
@js.native
trait Schema$PkixPublicKey extends js.Object {
  /**
...
object Schema$PkixPublicKey {
  @scala.inline
  def apply(publicKeyPem: String = null, signatureAlgorithm: String = null): Schema$PkixPublicKey = {
    ...
    __obj.asInstanceOf[Schema$PkixPublicKey]
  }
}
