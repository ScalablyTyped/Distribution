...
object ParamsResourceManagedzonesGet {
  ...
  @scala.inline
  def apply(): ParamsResourceManagedzonesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceManagedzonesGet]
  }
  
  @scala.inline
  implicit class ParamsResourceManagedzonesGetMutableBuilder[Self <: ParamsResourceManagedzonesGet] (val x: Self) extends AnyVal {
