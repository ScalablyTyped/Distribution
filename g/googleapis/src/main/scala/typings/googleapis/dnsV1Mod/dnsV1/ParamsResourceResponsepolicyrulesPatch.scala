...
trait ParamsResourceResponsepolicyrulesPatch
  extends StObject
...
object ParamsResourceResponsepolicyrulesPatch {
  
  inline def apply(): ParamsResourceResponsepolicyrulesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResponsepolicyrulesPatch]
  }
  
  extension [Self <: ParamsResourceResponsepolicyrulesPatch](x: Self) {
