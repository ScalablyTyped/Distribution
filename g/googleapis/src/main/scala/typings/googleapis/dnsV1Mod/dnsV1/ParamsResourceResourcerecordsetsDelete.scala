...
trait ParamsResourceResourcerecordsetsDelete
  extends StObject
...
object ParamsResourceResourcerecordsetsDelete {
  
  inline def apply(): ParamsResourceResourcerecordsetsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResourcerecordsetsDelete]
  }
  
  extension [Self <: ParamsResourceResourcerecordsetsDelete](x: Self) {
