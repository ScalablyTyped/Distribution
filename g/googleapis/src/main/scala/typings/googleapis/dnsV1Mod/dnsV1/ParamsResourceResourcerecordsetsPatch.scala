...
trait ParamsResourceResourcerecordsetsPatch
  extends StObject
...
object ParamsResourceResourcerecordsetsPatch {
  
  inline def apply(): ParamsResourceResourcerecordsetsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResourcerecordsetsPatch]
  }
  
  extension [Self <: ParamsResourceResourcerecordsetsPatch](x: Self) {
