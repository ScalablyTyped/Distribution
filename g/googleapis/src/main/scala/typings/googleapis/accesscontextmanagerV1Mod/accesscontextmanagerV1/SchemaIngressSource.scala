...
trait SchemaIngressSource extends StObject {
...
object SchemaIngressSource {
  
  inline def apply(): SchemaIngressSource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaIngressSource]
  }
  
  extension [Self <: SchemaIngressSource](x: Self) {
