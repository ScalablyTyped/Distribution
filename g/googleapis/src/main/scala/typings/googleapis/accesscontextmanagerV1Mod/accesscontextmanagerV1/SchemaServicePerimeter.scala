...
trait SchemaServicePerimeter extends StObject {
  ...
  /**
    ...
    */
  var spec: js.UndefOr[SchemaServicePerimeterConfig] = js.undefined
...
object SchemaServicePerimeter {
  ...
  extension [Self <: SchemaServicePerimeter](x: Self) {
    ...
    inline def setSpec(value: SchemaServicePerimeterConfig): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
