...
trait SchemaIngressFrom extends StObject {
  ...
  /**
    ...
    */
  var sources: js.UndefOr[js.Array[SchemaIngressSource]] = js.undefined
}
object SchemaIngressFrom {
  
  inline def apply(): SchemaIngressFrom = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaIngressFrom]
  }
  
  extension [Self <: SchemaIngressFrom](x: Self) {
    ...
    inline def setSources(value: js.Array[SchemaIngressSource]): Self = StObject.set(x, "sources", value.asInstanceOf[js.Any])
    
    inline def setSourcesUndefined: Self = StObject.set(x, "sources", js.undefined)
    
    inline def setSourcesVarargs(value: SchemaIngressSource*): Self = StObject.set(x, "sources", js.Array(value*))
  }
}
