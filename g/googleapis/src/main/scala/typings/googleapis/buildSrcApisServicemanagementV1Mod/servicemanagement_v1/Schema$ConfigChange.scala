...
/**
  ...
  */
@js.native
trait Schema$ConfigChange extends js.Object {
  /**
    * Collection of advice provided for this change, useful for determining the
    * possible impact of this change.
    */
  var advices: js.UndefOr[js.Array[Schema$Advice]] = js.native
  /**
...
object Schema$ConfigChange {
  @scala.inline
  def apply(
    advices: js.Array[Schema$Advice] = null,
    ...
    __obj.asInstanceOf[Schema$ConfigChange]
  }
}
