...
/**
  ...
  */
@js.native
trait Schema$TrafficPercentStrategy extends js.Object {
  /**
...
object Schema$TrafficPercentStrategy {
  @scala.inline
  def apply(percentages: StringDictionary[Double] = null): Schema$TrafficPercentStrategy = {
    val __obj = js.Dynamic.literal()
    if (percentages != null) __obj.updateDynamic("percentages")(percentages.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$TrafficPercentStrategy]
  }
}
