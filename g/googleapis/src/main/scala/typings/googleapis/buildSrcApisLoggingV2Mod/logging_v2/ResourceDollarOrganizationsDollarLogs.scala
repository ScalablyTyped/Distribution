...
@js.native
class ResourceDollarOrganizationsDollarLogs protected () extends js.Object {
  ...
  def delete(params: ParamsDollarResourceDollarOrganizationsDollarLogsDollarDelete): GaxiosPromise[Schema$Empty] = js.native
  def delete(
    params: ParamsDollarResourceDollarOrganizationsDollarLogsDollarDelete,
  ...
  def delete(params: ParamsDollarResourceDollarOrganizationsDollarLogsDollarDelete, options: MethodOptions): GaxiosPromise[Schema$Empty] = js.native
  def delete(
    params: ParamsDollarResourceDollarOrganizationsDollarLogsDollarDelete,
  ...
  def list(params: ParamsDollarResourceDollarOrganizationsDollarLogsDollarList): GaxiosPromise[Schema$ListLogsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarOrganizationsDollarLogsDollarList,
  ...
  def list(params: ParamsDollarResourceDollarOrganizationsDollarLogsDollarList, options: MethodOptions): GaxiosPromise[Schema$ListLogsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarOrganizationsDollarLogsDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListLogsResponse]
