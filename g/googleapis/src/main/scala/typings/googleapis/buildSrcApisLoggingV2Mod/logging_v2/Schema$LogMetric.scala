...
/**
  ...
  */
@js.native
trait Schema$LogMetric extends js.Object {
  /**
  ...
  /**
    ...
    */
  var metricDescriptor: js.UndefOr[Schema$MetricDescriptor] = js.native
  /**
...
object Schema$LogMetric {
  ...
  def apply(
    ...
    metricDescriptor: Schema$MetricDescriptor = null,
    name: String = null,
    ...
    __obj.asInstanceOf[Schema$LogMetric]
  }
}
