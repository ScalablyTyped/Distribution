...
/**
  ...
  */
@js.native
trait Schema$MetricDescriptor extends js.Object {
  /**
  ...
  /**
    ...
    */
  var metadata: js.UndefOr[Schema$MetricDescriptorMetadata] = js.native
  /**
...
object Schema$MetricDescriptor {
  @scala.inline
  def apply(
    description: String = null,
    displayName: String = null,
    labels: js.Array[Schema$LabelDescriptor] = null,
    metadata: Schema$MetricDescriptorMetadata = null,
    ...
    __obj.asInstanceOf[Schema$MetricDescriptor]
  }
}
