...
trait ParamsResourceAccountreportsSearch
  extends StObject
...
object ParamsResourceAccountreportsSearch {
  
  inline def apply(): ParamsResourceAccountreportsSearch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountreportsSearch]
  }
  
  extension [Self <: ParamsResourceAccountreportsSearch](x: Self) {
