...
trait SchemaArea extends StObject {
  ...
  /**
    ...
    */
  var hasExternalEdges: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var internalEdges: js.UndefOr[js.Array[Double] | Null] = js.undefined
  ...
  /**
    ...
    */
  var loopBreaks: js.UndefOr[js.Array[Double] | Null] = js.undefined
  ...
  /**
    ...
    */
  var triangleIndices: js.UndefOr[js.Array[Double] | Null] = js.undefined
...
object SchemaArea {
  ...
  inline def apply(): SchemaArea = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaArea]
  }
  
  extension [Self <: SchemaArea](x: Self) {
    ...
    inline def setHasExternalEdgesNull: Self = StObject.set(x, "hasExternalEdges", null)
    ...
    inline def setInternalEdgesNull: Self = StObject.set(x, "internalEdges", null)
    ...
    inline def setLoopBreaksNull: Self = StObject.set(x, "loopBreaks", null)
    ...
    inline def setTriangleIndicesNull: Self = StObject.set(x, "triangleIndices", null)
