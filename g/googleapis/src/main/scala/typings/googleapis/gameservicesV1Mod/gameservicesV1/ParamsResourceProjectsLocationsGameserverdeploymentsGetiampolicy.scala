...
trait ParamsResourceProjectsLocationsGameserverdeploymentsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsGameserverdeploymentsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsGameserverdeploymentsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGameserverdeploymentsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGameserverdeploymentsGetiampolicy](x: Self) {
