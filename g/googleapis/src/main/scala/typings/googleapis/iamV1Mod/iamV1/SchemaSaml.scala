...
trait SchemaSaml extends StObject {
  ...
  /**
    ...
    */
  var idpMetadataXml: js.UndefOr[String | Null] = js.undefined
}
object SchemaSaml {
  
  inline def apply(): SchemaSaml = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSaml]
  }
  
  extension [Self <: SchemaSaml](x: Self) {
    
    inline def setIdpMetadataXml(value: String): Self = StObject.set(x, "idpMetadataXml", value.asInstanceOf[js.Any])
    
    inline def setIdpMetadataXmlNull: Self = StObject.set(x, "idpMetadataXml", null)
