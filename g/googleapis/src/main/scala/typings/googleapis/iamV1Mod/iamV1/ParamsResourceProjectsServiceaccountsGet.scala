...
trait ParamsResourceProjectsServiceaccountsGet
  extends StObject
...
object ParamsResourceProjectsServiceaccountsGet {
  ...
  inline def apply(): ParamsResourceProjectsServiceaccountsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsServiceaccountsGet]
  }
  
  extension [Self <: ParamsResourceProjectsServiceaccountsGet](x: Self) {
