...
object ParamsResourceProjectsServiceaccountsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsServiceaccountsPatchOps[Self <: ParamsResourceProjectsServiceaccountsPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaPatchServiceAccountRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
