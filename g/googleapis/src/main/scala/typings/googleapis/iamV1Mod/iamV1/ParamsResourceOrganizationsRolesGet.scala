...
@js.native
trait ParamsResourceOrganizationsRolesGet extends StandardParameters {
...
object ParamsResourceOrganizationsRolesGet {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsRolesGetOps[Self <: ParamsResourceOrganizationsRolesGet] (val x: Self) extends AnyVal {
