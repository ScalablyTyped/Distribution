...
object ParamsResourceIampoliciesQueryauditableservices {
  ...
  @scala.inline
  implicit class ParamsResourceIampoliciesQueryauditableservicesMutableBuilder[Self <: ParamsResourceIampoliciesQueryauditableservices] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaQueryAuditableServicesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
