...
object ParamsResourceProjectsServiceaccountsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsServiceaccountsUpdateOps[Self <: ParamsResourceProjectsServiceaccountsUpdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaServiceAccount): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
