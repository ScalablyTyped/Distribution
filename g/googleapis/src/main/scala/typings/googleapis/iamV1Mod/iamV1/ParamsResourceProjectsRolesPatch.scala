...
object ParamsResourceProjectsRolesPatch {
  @scala.inline
  def apply(): ParamsResourceProjectsRolesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsRolesPatch]
  }
  @scala.inline
  implicit class ParamsResourceProjectsRolesPatchOps[Self <: ParamsResourceProjectsRolesPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaRole): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
