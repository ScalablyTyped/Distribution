...
object ParamsResourceOrganizationsRolesList {
  ...
  @scala.inline
  def apply(): ParamsResourceOrganizationsRolesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsRolesList]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsRolesListMutableBuilder[Self <: ParamsResourceOrganizationsRolesList] (val x: Self) extends AnyVal {
