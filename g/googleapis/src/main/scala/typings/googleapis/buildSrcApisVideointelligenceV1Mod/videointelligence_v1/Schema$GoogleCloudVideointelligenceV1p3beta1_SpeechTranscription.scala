...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechTranscription extends js.Object {
  /**
  ...
  var alternatives: js.UndefOr[
    js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechRecognitionAlternative]
  ] = js.native
  /**
...
object Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechTranscription {
  @scala.inline
  def apply(
    alternatives: js.Array[Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechRecognitionAlternative] = null,
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p3beta1_SpeechTranscription]
  }
}
