...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1_LabelDetectionConfig extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1_LabelDetectionConfig {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1_LabelDetectionConfig]
  }
}
