...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1beta2_VideoSegment extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1beta2_VideoSegment {
  @scala.inline
  def apply(endTimeOffset: String = null, startTimeOffset: String = null): Schema$GoogleCloudVideointelligenceV1beta2_VideoSegment = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1beta2_VideoSegment]
  }
}
