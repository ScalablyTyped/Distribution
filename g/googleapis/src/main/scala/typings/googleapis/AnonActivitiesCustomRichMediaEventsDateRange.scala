...
@js.native
trait AnonActivitiesCustomRichMediaEventsDateRange extends js.Object {
...
object AnonActivitiesCustomRichMediaEventsDateRange {
  @scala.inline
  def apply(
  ...
  ): AnonActivitiesCustomRichMediaEventsDateRange = {
    ...
    __obj.asInstanceOf[AnonActivitiesCustomRichMediaEventsDateRange]
  }
}
