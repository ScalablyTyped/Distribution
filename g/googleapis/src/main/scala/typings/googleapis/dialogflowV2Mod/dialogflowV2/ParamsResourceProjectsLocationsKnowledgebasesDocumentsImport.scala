...
trait ParamsResourceProjectsLocationsKnowledgebasesDocumentsImport
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowV2ImportDocumentsRequest] = js.undefined
}
object ParamsResourceProjectsLocationsKnowledgebasesDocumentsImport {
  ...
  extension [Self <: ParamsResourceProjectsLocationsKnowledgebasesDocumentsImport](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowV2ImportDocumentsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
