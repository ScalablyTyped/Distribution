...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Conversations$Messages")
@js.native
open class ResourceProjectsConversationsMessages protected () extends StObject {
  ...
  def list(params: ParamsResourceProjectsConversationsMessagesList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListMessagesResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsConversationsMessagesList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListMessagesResponse] = js.native
  def list(
    params: ParamsResourceProjectsConversationsMessagesList,
