...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Knowledgebases$Documents")
@js.native
open class ResourceProjectsKnowledgebasesDocuments protected () extends StObject {
  ...
  def `export`(params: ParamsResourceProjectsKnowledgebasesDocumentsExport): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def `export`(
    params: ParamsResourceProjectsKnowledgebasesDocumentsExport,
    callback: BodyResponseCallback[SchemaGoogleLongrunningOperation]
  ): Unit = js.native
  def `export`(
    params: ParamsResourceProjectsKnowledgebasesDocumentsExport,
  ...
  def `export`(params: ParamsResourceProjectsKnowledgebasesDocumentsExport, options: MethodOptions): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def `export`(
    params: ParamsResourceProjectsKnowledgebasesDocumentsExport,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleLongrunningOperation]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def `export`(params: ParamsResourceProjectsKnowledgebasesDocumentsExport, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def `export`(
    params: ParamsResourceProjectsKnowledgebasesDocumentsExport,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def get(params: ParamsResourceProjectsKnowledgebasesDocumentsGet): GaxiosPromise[SchemaGoogleCloudDialogflowV2Document] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsKnowledgebasesDocumentsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2Document] = js.native
  def get(
    params: ParamsResourceProjectsKnowledgebasesDocumentsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Document]
  ...
  def list(params: ParamsResourceProjectsKnowledgebasesDocumentsList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListDocumentsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsKnowledgebasesDocumentsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListDocumentsResponse] = js.native
  def list(
    params: ParamsResourceProjectsKnowledgebasesDocumentsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2ListDocumentsResponse]
