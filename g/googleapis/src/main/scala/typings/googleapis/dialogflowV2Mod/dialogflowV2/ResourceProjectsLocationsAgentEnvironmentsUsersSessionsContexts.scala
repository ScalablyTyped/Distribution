...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Locations$Agent$Environments$Users$Sessions$Contexts")
@js.native
open class ResourceProjectsLocationsAgentEnvironmentsUsersSessionsContexts protected () extends StObject {
  ...
  def create(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsCreate): GaxiosPromise[SchemaGoogleCloudDialogflowV2Context] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsCreate,
  ...
  ): GaxiosPromise[SchemaGoogleCloudDialogflowV2Context] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsCreate,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Context]
  ...
  def delete(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsDelete): GaxiosPromise[SchemaGoogleProtobufEmpty] = js.native
  def delete(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsDelete,
  ...
  def get(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsGet): GaxiosPromise[SchemaGoogleCloudDialogflowV2Context] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsGet,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Context]
  ): Unit = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsGet,
  ...
  def list(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListContextsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsList,
  ...
  def list(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsList,
    options: MethodOptions
  ): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListContextsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2ListContextsResponse]
  ...
  def patch(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsPatch): GaxiosPromise[SchemaGoogleCloudDialogflowV2Context] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsPatch,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Context]
  ): Unit = js.native
  def patch(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsPatch,
