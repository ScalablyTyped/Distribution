...
trait ParamsResourceProjectsAgentExport
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowV2ExportAgentRequest] = js.undefined
}
object ParamsResourceProjectsAgentExport {
  ...
  extension [Self <: ParamsResourceProjectsAgentExport](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowV2ExportAgentRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
