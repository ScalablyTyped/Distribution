...
trait SchemaGoogleCloudDialogflowCxV3beta1InputAudioConfig extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1InputAudioConfig {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1InputAudioConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1InputAudioConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1InputAudioConfig](x: Self) {
