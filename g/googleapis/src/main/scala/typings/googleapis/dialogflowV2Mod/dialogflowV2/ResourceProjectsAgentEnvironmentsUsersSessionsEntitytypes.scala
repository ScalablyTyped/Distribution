...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Agent$Environments$Users$Sessions$Entitytypes")
@js.native
open class ResourceProjectsAgentEnvironmentsUsersSessionsEntitytypes protected () extends StObject {
  ...
  def create(params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesCreate): GaxiosPromise[SchemaGoogleCloudDialogflowV2SessionEntityType] = js.native
  def create(
  ...
  ): GaxiosPromise[SchemaGoogleCloudDialogflowV2SessionEntityType] = js.native
  def create(
    params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesCreate,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2SessionEntityType]
  ...
  def get(params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesGet): GaxiosPromise[SchemaGoogleCloudDialogflowV2SessionEntityType] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2SessionEntityType] = js.native
  def get(
    params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2SessionEntityType]
  ...
  def list(params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListSessionEntityTypesResponse] = js.native
  def list(
  ...
  def list(
    params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesList,
    options: MethodOptions
  ): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListSessionEntityTypesResponse] = js.native
  def list(
    params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2ListSessionEntityTypesResponse]
  ...
  def patch(params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesPatch): GaxiosPromise[SchemaGoogleCloudDialogflowV2SessionEntityType] = js.native
  def patch(
