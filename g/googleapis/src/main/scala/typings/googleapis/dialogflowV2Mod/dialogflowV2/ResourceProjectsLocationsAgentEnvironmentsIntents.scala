...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Locations$Agent$Environments$Intents")
@js.native
open class ResourceProjectsLocationsAgentEnvironmentsIntents protected () extends StObject {
  ...
  def list(params: ParamsResourceProjectsLocationsAgentEnvironmentsIntentsList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListIntentsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsLocationsAgentEnvironmentsIntentsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListIntentsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsIntentsList,
