...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Knowledgebases")
@js.native
open class ResourceProjectsKnowledgebases protected () extends StObject {
  ...
  def create(params: ParamsResourceProjectsKnowledgebasesCreate): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def create(
  ...
  def create(params: ParamsResourceProjectsKnowledgebasesCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def create(
    params: ParamsResourceProjectsKnowledgebasesCreate,
  ...
  def get(params: ParamsResourceProjectsKnowledgebasesGet): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsKnowledgebasesGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def get(
    params: ParamsResourceProjectsKnowledgebasesGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2KnowledgeBase]
  ...
  def list(params: ParamsResourceProjectsKnowledgebasesList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListKnowledgeBasesResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsKnowledgebasesList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListKnowledgeBasesResponse] = js.native
  def list(
    params: ParamsResourceProjectsKnowledgebasesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2ListKnowledgeBasesResponse]
  ...
  def patch(params: ParamsResourceProjectsKnowledgebasesPatch): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsKnowledgebasesPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def patch(
    params: ParamsResourceProjectsKnowledgebasesPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2KnowledgeBase]
