...
open class ResourceProjectsAgent protected () extends StObject {
  ...
  def getFulfillment(): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  def getFulfillment(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Fulfillment]): Unit = js.native
  def getFulfillment(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  def getFulfillment(params: ParamsResourceProjectsAgentGetfulfillment): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  def getFulfillment(
    params: ParamsResourceProjectsAgentGetfulfillment,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Fulfillment]
  ): Unit = js.native
  def getFulfillment(
    params: ParamsResourceProjectsAgentGetfulfillment,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowV2Fulfillment],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowV2Fulfillment]
  ): Unit = js.native
  def getFulfillment(params: ParamsResourceProjectsAgentGetfulfillment, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  def getFulfillment(
    params: ParamsResourceProjectsAgentGetfulfillment,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Fulfillment]
  ...
  def getValidationResult(): GaxiosPromise[SchemaGoogleCloudDialogflowV2ValidationResult] = js.native
  def getValidationResult(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2ValidationResult]): Unit = js.native
  def getValidationResult(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ValidationResult] = js.native
  def getValidationResult(params: ParamsResourceProjectsAgentGetvalidationresult): GaxiosPromise[SchemaGoogleCloudDialogflowV2ValidationResult] = js.native
  def getValidationResult(
    params: ParamsResourceProjectsAgentGetvalidationresult,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2ValidationResult]
  ): Unit = js.native
  def getValidationResult(
    params: ParamsResourceProjectsAgentGetvalidationresult,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowV2ValidationResult],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowV2ValidationResult]
  ): Unit = js.native
  def getValidationResult(params: ParamsResourceProjectsAgentGetvalidationresult, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ValidationResult] = js.native
  def getValidationResult(
    params: ParamsResourceProjectsAgentGetvalidationresult,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2ValidationResult]
  ...
  def search(
    params: ParamsResourceProjectsAgentSearch,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowV2SearchAgentsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowV2SearchAgentsResponse]
  ): Unit = js.native
  ...
  def updateFulfillment(): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  def updateFulfillment(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Fulfillment]): Unit = js.native
  def updateFulfillment(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  def updateFulfillment(params: ParamsResourceProjectsAgentUpdatefulfillment): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  ...
  def updateFulfillment(params: ParamsResourceProjectsAgentUpdatefulfillment, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  def updateFulfillment(
    params: ParamsResourceProjectsAgentUpdatefulfillment,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Fulfillment]
