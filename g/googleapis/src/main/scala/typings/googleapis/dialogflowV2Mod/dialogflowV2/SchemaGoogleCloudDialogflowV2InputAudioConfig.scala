...
trait SchemaGoogleCloudDialogflowV2InputAudioConfig extends StObject {
  ...
  /**
    ...
    */
  var speechContexts: js.UndefOr[js.Array[SchemaGoogleCloudDialogflowV2SpeechContext]] = js.undefined
}
object SchemaGoogleCloudDialogflowV2InputAudioConfig {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2InputAudioConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2InputAudioConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2InputAudioConfig](x: Self) {
    ...
    inline def setSpeechContexts(value: js.Array[SchemaGoogleCloudDialogflowV2SpeechContext]): Self = StObject.set(x, "speechContexts", value.asInstanceOf[js.Any])
    
    inline def setSpeechContextsUndefined: Self = StObject.set(x, "speechContexts", js.undefined)
    
    inline def setSpeechContextsVarargs(value: SchemaGoogleCloudDialogflowV2SpeechContext*): Self = StObject.set(x, "speechContexts", js.Array(value*))
  }
}
