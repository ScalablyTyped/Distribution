...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Locations$Agent$Sessions$Contexts")
@js.native
open class ResourceProjectsLocationsAgentSessionsContexts protected () extends StObject {
  ...
  def create(params: ParamsResourceProjectsLocationsAgentSessionsContextsCreate): GaxiosPromise[SchemaGoogleCloudDialogflowV2Context] = js.native
  def create(
  ...
  def create(params: ParamsResourceProjectsLocationsAgentSessionsContextsCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2Context] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentSessionsContextsCreate,
  ...
  def get(params: ParamsResourceProjectsLocationsAgentSessionsContextsGet): GaxiosPromise[SchemaGoogleCloudDialogflowV2Context] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsAgentSessionsContextsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2Context] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentSessionsContextsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Context]
  ...
  def list(params: ParamsResourceProjectsLocationsAgentSessionsContextsList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListContextsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsLocationsAgentSessionsContextsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListContextsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentSessionsContextsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2ListContextsResponse]
  ...
  def patch(params: ParamsResourceProjectsLocationsAgentSessionsContextsPatch): GaxiosPromise[SchemaGoogleCloudDialogflowV2Context] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsAgentSessionsContextsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2Context] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsAgentSessionsContextsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Context]
