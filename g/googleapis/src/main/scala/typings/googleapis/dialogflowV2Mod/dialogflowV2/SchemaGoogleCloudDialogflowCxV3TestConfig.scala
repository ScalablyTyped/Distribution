...
trait SchemaGoogleCloudDialogflowCxV3TestConfig extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3TestConfig {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3TestConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3TestConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3TestConfig](x: Self) {
