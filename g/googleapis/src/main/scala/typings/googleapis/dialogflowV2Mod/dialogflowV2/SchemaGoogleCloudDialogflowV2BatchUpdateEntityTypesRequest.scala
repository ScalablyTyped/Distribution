...
object SchemaGoogleCloudDialogflowV2BatchUpdateEntityTypesRequest {
  ...
  inline def apply(): SchemaGoogleCloudDialogflowV2BatchUpdateEntityTypesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2BatchUpdateEntityTypesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2BatchUpdateEntityTypesRequest](x: Self) {
    
    inline def setEntityTypeBatchInline(value: SchemaGoogleCloudDialogflowV2EntityTypeBatch): Self = StObject.set(x, "entityTypeBatchInline", value.asInstanceOf[js.Any])
