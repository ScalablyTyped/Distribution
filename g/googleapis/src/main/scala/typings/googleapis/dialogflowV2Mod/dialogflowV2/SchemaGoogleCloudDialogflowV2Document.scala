...
trait SchemaGoogleCloudDialogflowV2Document extends StObject {
  ...
  /**
    ...
    */
  var latestReloadStatus: js.UndefOr[SchemaGoogleCloudDialogflowV2DocumentReloadStatus] = js.undefined
...
object SchemaGoogleCloudDialogflowV2Document {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2Document = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2Document]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2Document](x: Self) {
    ...
    inline def setLatestReloadStatus(value: SchemaGoogleCloudDialogflowV2DocumentReloadStatus): Self = StObject.set(x, "latestReloadStatus", value.asInstanceOf[js.Any])
