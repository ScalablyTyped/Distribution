...
trait SchemaGoogleCloudLocationLocation extends StObject {
...
object SchemaGoogleCloudLocationLocation {
  
  inline def apply(): SchemaGoogleCloudLocationLocation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudLocationLocation]
  }
  
  extension [Self <: SchemaGoogleCloudLocationLocation](x: Self) {
