...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Locations$Knowledgebases")
@js.native
open class ResourceProjectsLocationsKnowledgebases protected () extends StObject {
  ...
  def create(params: ParamsResourceProjectsLocationsKnowledgebasesCreate): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def create(
  ...
  def create(params: ParamsResourceProjectsLocationsKnowledgebasesCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def create(
    params: ParamsResourceProjectsLocationsKnowledgebasesCreate,
  ...
  def get(params: ParamsResourceProjectsLocationsKnowledgebasesGet): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsKnowledgebasesGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def get(
    params: ParamsResourceProjectsLocationsKnowledgebasesGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2KnowledgeBase]
  ...
  def list(params: ParamsResourceProjectsLocationsKnowledgebasesList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListKnowledgeBasesResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsLocationsKnowledgebasesList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListKnowledgeBasesResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsKnowledgebasesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2ListKnowledgeBasesResponse]
  ...
  def patch(params: ParamsResourceProjectsLocationsKnowledgebasesPatch): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsKnowledgebasesPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2KnowledgeBase] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsKnowledgebasesPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2KnowledgeBase]
