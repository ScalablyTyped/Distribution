...
trait ParamsResourceProjectsAgentSessionsContextsCreate
  extends StObject
...
object ParamsResourceProjectsAgentSessionsContextsCreate {
  ...
  inline def apply(): ParamsResourceProjectsAgentSessionsContextsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentSessionsContextsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsAgentSessionsContextsCreate](x: Self) {
