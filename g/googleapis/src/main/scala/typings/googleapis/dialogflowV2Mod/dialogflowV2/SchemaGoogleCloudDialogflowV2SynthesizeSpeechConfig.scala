...
object SchemaGoogleCloudDialogflowV2SynthesizeSpeechConfig {
  ...
  inline def apply(): SchemaGoogleCloudDialogflowV2SynthesizeSpeechConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2SynthesizeSpeechConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2SynthesizeSpeechConfig](x: Self) {
    ...
    inline def setVoice(value: SchemaGoogleCloudDialogflowV2VoiceSelectionParams): Self = StObject.set(x, "voice", value.asInstanceOf[js.Any])
