...
object ParamsResourceProjectsAgentSessionsEntitytypesList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentSessionsEntitytypesListOps[Self <: ParamsResourceProjectsAgentSessionsEntitytypesList] (val x: Self) extends AnyVal {
    @scala.inline
