...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Agent$Environments$Intents")
@js.native
open class ResourceProjectsAgentEnvironmentsIntents protected () extends StObject {
  ...
  def list(params: ParamsResourceProjectsAgentEnvironmentsIntentsList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListIntentsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsAgentEnvironmentsIntentsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListIntentsResponse] = js.native
  def list(
    params: ParamsResourceProjectsAgentEnvironmentsIntentsList,
