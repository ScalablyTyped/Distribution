...
object ParamsResourceProjectsAgentTrain {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentTrainOps[Self <: ParamsResourceProjectsAgentTrain] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleCloudDialogflowV2TrainAgentRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
