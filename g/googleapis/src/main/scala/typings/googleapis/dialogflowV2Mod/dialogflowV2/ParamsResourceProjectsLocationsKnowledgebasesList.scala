...
trait ParamsResourceProjectsLocationsKnowledgebasesList
  extends StObject
...
object ParamsResourceProjectsLocationsKnowledgebasesList {
  
  inline def apply(): ParamsResourceProjectsLocationsKnowledgebasesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsKnowledgebasesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsKnowledgebasesList](x: Self) {
