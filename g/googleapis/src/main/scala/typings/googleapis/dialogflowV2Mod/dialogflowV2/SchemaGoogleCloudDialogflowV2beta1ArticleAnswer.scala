...
trait SchemaGoogleCloudDialogflowV2beta1ArticleAnswer extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1ArticleAnswer {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1ArticleAnswer = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1ArticleAnswer]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1ArticleAnswer](x: Self) {
