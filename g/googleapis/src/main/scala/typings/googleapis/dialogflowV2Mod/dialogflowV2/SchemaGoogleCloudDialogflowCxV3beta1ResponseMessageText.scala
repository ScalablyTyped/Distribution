...
trait SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageText extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageText {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageText = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageText]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageText](x: Self) {
