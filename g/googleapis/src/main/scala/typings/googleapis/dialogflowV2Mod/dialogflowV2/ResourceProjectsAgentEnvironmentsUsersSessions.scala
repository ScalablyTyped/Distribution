...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Agent$Environments$Users$Sessions")
@js.native
open class ResourceProjectsAgentEnvironmentsUsersSessions protected () extends StObject {
  ...
  def detectIntent(params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsDetectintent): GaxiosPromise[SchemaGoogleCloudDialogflowV2DetectIntentResponse] = js.native
  def detectIntent(
  ...
  def detectIntent(params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsDetectintent, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2DetectIntentResponse] = js.native
  def detectIntent(
    params: ParamsResourceProjectsAgentEnvironmentsUsersSessionsDetectintent,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2DetectIntentResponse]
