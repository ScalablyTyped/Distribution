...
trait SchemaGoogleCloudDialogflowV2SuggestArticlesRequest extends StObject {
...
object SchemaGoogleCloudDialogflowV2SuggestArticlesRequest {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2SuggestArticlesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2SuggestArticlesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2SuggestArticlesRequest](x: Self) {
