...
trait ParamsResourceProjectsAgentSessionsEntitytypesCreate
  extends StObject
...
object ParamsResourceProjectsAgentSessionsEntitytypesCreate {
  ...
  inline def apply(): ParamsResourceProjectsAgentSessionsEntitytypesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentSessionsEntitytypesCreate]
  }
  
  extension [Self <: ParamsResourceProjectsAgentSessionsEntitytypesCreate](x: Self) {
