...
trait ParamsResourceProjectsLocationsConversationsCreate
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowV2Conversation] = js.undefined
}
object ParamsResourceProjectsLocationsConversationsCreate {
  ...
  extension [Self <: ParamsResourceProjectsLocationsConversationsCreate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowV2Conversation): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
