...
trait SchemaGoogleCloudDialogflowV2ImportDocumentTemplate extends StObject {
...
object SchemaGoogleCloudDialogflowV2ImportDocumentTemplate {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2ImportDocumentTemplate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2ImportDocumentTemplate]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2ImportDocumentTemplate](x: Self) {
