...
object SchemaGoogleCloudDialogflowV2BatchDeleteEntityTypesRequest {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudDialogflowV2BatchDeleteEntityTypesRequestOps[Self <: SchemaGoogleCloudDialogflowV2BatchDeleteEntityTypesRequest] (val x: Self) extends AnyVal {
