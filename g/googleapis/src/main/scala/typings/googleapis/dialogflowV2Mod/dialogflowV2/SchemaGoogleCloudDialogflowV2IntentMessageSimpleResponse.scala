...
object SchemaGoogleCloudDialogflowV2IntentMessageSimpleResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudDialogflowV2IntentMessageSimpleResponseOps[Self <: SchemaGoogleCloudDialogflowV2IntentMessageSimpleResponse] (val x: Self) extends AnyVal {
    @scala.inline
