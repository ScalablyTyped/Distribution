...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Locations$Agent$Environments$Users$Sessions")
@js.native
open class ResourceProjectsLocationsAgentEnvironmentsUsersSessions protected () extends StObject {
  ...
  def detectIntent(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsDetectintent): GaxiosPromise[SchemaGoogleCloudDialogflowV2DetectIntentResponse] = js.native
  def detectIntent(
  ...
  def detectIntent(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsDetectintent,
    options: MethodOptions
  ): GaxiosPromise[SchemaGoogleCloudDialogflowV2DetectIntentResponse] = js.native
  def detectIntent(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsDetectintent,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2DetectIntentResponse]
