...
trait SchemaGoogleCloudDialogflowCxV3beta1ContinuousTestResult extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1ContinuousTestResult {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1ContinuousTestResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1ContinuousTestResult]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1ContinuousTestResult](x: Self) {
