...
trait ParamsResourceProjectsAgentKnowledgebasesDocumentsDelete
  extends StObject
...
object ParamsResourceProjectsAgentKnowledgebasesDocumentsDelete {
  ...
  inline def apply(): ParamsResourceProjectsAgentKnowledgebasesDocumentsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentKnowledgebasesDocumentsDelete]
  }
  
  extension [Self <: ParamsResourceProjectsAgentKnowledgebasesDocumentsDelete](x: Self) {
