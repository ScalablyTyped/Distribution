...
trait ParamsResourceProjectsLocationsAgentEntitytypesPatch
  extends StObject
...
object ParamsResourceProjectsLocationsAgentEntitytypesPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsAgentEntitytypesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAgentEntitytypesPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAgentEntitytypesPatch](x: Self) {
