...
trait ParamsResourceProjectsAgentKnowledgebasesGet
  extends StObject
...
object ParamsResourceProjectsAgentKnowledgebasesGet {
  ...
  inline def apply(): ParamsResourceProjectsAgentKnowledgebasesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentKnowledgebasesGet]
  }
  
  extension [Self <: ParamsResourceProjectsAgentKnowledgebasesGet](x: Self) {
