...
trait ParamsResourceProjectsConversationmodelsUndeploy
  extends StObject
...
object ParamsResourceProjectsConversationmodelsUndeploy {
  
  inline def apply(): ParamsResourceProjectsConversationmodelsUndeploy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsConversationmodelsUndeploy]
  }
  
  extension [Self <: ParamsResourceProjectsConversationmodelsUndeploy](x: Self) {
