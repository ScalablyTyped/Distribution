...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Locations$Agent$Environments$Users$Sessions$Entitytypes")
@js.native
open class ResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypes protected () extends StObject {
  ...
  def create(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesCreate): GaxiosPromise[SchemaGoogleCloudDialogflowV2SessionEntityType] = js.native
  def create(
  ...
  def get(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesGet): GaxiosPromise[SchemaGoogleCloudDialogflowV2SessionEntityType] = js.native
  def get(
  ...
  def list(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListSessionEntityTypesResponse] = js.native
  def list(
  ...
  def patch(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesPatch): GaxiosPromise[SchemaGoogleCloudDialogflowV2SessionEntityType] = js.native
  def patch(
