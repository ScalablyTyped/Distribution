...
trait SchemaGoogleCloudDialogflowV2AnalyzeContentResponse extends StObject {
  ...
  /**
    ...
    */
  var automatedAgentReply: js.UndefOr[SchemaGoogleCloudDialogflowV2AutomatedAgentReply] = js.undefined
  
  /**
    * Indicates the parameters of DTMF.
    */
  var dtmfParameters: js.UndefOr[SchemaGoogleCloudDialogflowV2DtmfParameters] = js.undefined
  ...
  /**
    ...
    */
  var endUserSuggestionResults: js.UndefOr[js.Array[SchemaGoogleCloudDialogflowV2SuggestionResult]] = js.undefined
  ...
  /**
    ...
    */
  var humanAgentSuggestionResults: js.UndefOr[js.Array[SchemaGoogleCloudDialogflowV2SuggestionResult]] = js.undefined
  
  /**
    * Message analyzed by CCAI.
    */
  var message: js.UndefOr[SchemaGoogleCloudDialogflowV2Message] = js.undefined
  ...
  /**
    ...
    */
  var replyAudio: js.UndefOr[SchemaGoogleCloudDialogflowV2OutputAudio] = js.undefined
...
object SchemaGoogleCloudDialogflowV2AnalyzeContentResponse {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2AnalyzeContentResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2AnalyzeContentResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2AnalyzeContentResponse](x: Self) {
    
    inline def setAutomatedAgentReply(value: SchemaGoogleCloudDialogflowV2AutomatedAgentReply): Self = StObject.set(x, "automatedAgentReply", value.asInstanceOf[js.Any])
    
    inline def setAutomatedAgentReplyUndefined: Self = StObject.set(x, "automatedAgentReply", js.undefined)
    
    inline def setDtmfParameters(value: SchemaGoogleCloudDialogflowV2DtmfParameters): Self = StObject.set(x, "dtmfParameters", value.asInstanceOf[js.Any])
    
    inline def setDtmfParametersUndefined: Self = StObject.set(x, "dtmfParameters", js.undefined)
    
    inline def setEndUserSuggestionResults(value: js.Array[SchemaGoogleCloudDialogflowV2SuggestionResult]): Self = StObject.set(x, "endUserSuggestionResults", value.asInstanceOf[js.Any])
    
    inline def setEndUserSuggestionResultsUndefined: Self = StObject.set(x, "endUserSuggestionResults", js.undefined)
    
    inline def setEndUserSuggestionResultsVarargs(value: SchemaGoogleCloudDialogflowV2SuggestionResult*): Self = StObject.set(x, "endUserSuggestionResults", js.Array(value*))
    
    inline def setHumanAgentSuggestionResults(value: js.Array[SchemaGoogleCloudDialogflowV2SuggestionResult]): Self = StObject.set(x, "humanAgentSuggestionResults", value.asInstanceOf[js.Any])
    
    inline def setHumanAgentSuggestionResultsUndefined: Self = StObject.set(x, "humanAgentSuggestionResults", js.undefined)
    
    inline def setHumanAgentSuggestionResultsVarargs(value: SchemaGoogleCloudDialogflowV2SuggestionResult*): Self = StObject.set(x, "humanAgentSuggestionResults", js.Array(value*))
    
    inline def setMessage(value: SchemaGoogleCloudDialogflowV2Message): Self = StObject.set(x, "message", value.asInstanceOf[js.Any])
    
    inline def setMessageUndefined: Self = StObject.set(x, "message", js.undefined)
    
    inline def setReplyAudio(value: SchemaGoogleCloudDialogflowV2OutputAudio): Self = StObject.set(x, "replyAudio", value.asInstanceOf[js.Any])
