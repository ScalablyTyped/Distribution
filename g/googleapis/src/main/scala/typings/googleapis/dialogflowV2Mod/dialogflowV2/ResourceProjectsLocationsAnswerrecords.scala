...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Locations$Answerrecords")
@js.native
open class ResourceProjectsLocationsAnswerrecords protected () extends StObject {
  ...
  def list(params: ParamsResourceProjectsLocationsAnswerrecordsList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListAnswerRecordsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsLocationsAnswerrecordsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListAnswerRecordsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAnswerrecordsList,
  ...
  def patch(params: ParamsResourceProjectsLocationsAnswerrecordsPatch): GaxiosPromise[SchemaGoogleCloudDialogflowV2AnswerRecord] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsAnswerrecordsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2AnswerRecord] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsAnswerrecordsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2AnswerRecord]
