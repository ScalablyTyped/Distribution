...
trait SchemaGoogleCloudDialogflowV2AnswerFeedback extends StObject {
  
  /**
    * Detail feedback of agent assist suggestions.
    */
  var agentAssistantDetailFeedback: js.UndefOr[SchemaGoogleCloudDialogflowV2AgentAssistantFeedback] = js.undefined
...
object SchemaGoogleCloudDialogflowV2AnswerFeedback {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2AnswerFeedback = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2AnswerFeedback]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2AnswerFeedback](x: Self) {
    
    inline def setAgentAssistantDetailFeedback(value: SchemaGoogleCloudDialogflowV2AgentAssistantFeedback): Self = StObject.set(x, "agentAssistantDetailFeedback", value.asInstanceOf[js.Any])
