...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Locations$Agent$Sessions")
@js.native
open class ResourceProjectsLocationsAgentSessions protected () extends StObject {
  ...
  def detectIntent(params: ParamsResourceProjectsLocationsAgentSessionsDetectintent): GaxiosPromise[SchemaGoogleCloudDialogflowV2DetectIntentResponse] = js.native
  def detectIntent(
  ...
  def detectIntent(params: ParamsResourceProjectsLocationsAgentSessionsDetectintent, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2DetectIntentResponse] = js.native
  def detectIntent(
    params: ParamsResourceProjectsLocationsAgentSessionsDetectintent,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2DetectIntentResponse]
