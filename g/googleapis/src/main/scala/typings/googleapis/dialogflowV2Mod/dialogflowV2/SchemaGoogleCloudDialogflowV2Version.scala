...
trait SchemaGoogleCloudDialogflowV2Version extends StObject {
...
object SchemaGoogleCloudDialogflowV2Version {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2Version = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2Version]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2Version](x: Self) {
