...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Locations$Agent")
@js.native
open class ResourceProjectsLocationsAgent protected () extends StObject {
  ...
  def getFulfillment(params: ParamsResourceProjectsLocationsAgentGetfulfillment): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  def getFulfillment(
  ...
  def getFulfillment(params: ParamsResourceProjectsLocationsAgentGetfulfillment, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  def getFulfillment(
    params: ParamsResourceProjectsLocationsAgentGetfulfillment,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Fulfillment]
  ...
  def getValidationResult(params: ParamsResourceProjectsLocationsAgentGetvalidationresult): GaxiosPromise[SchemaGoogleCloudDialogflowV2ValidationResult] = js.native
  ...
  def getValidationResult(params: ParamsResourceProjectsLocationsAgentGetvalidationresult, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ValidationResult] = js.native
  def getValidationResult(
    params: ParamsResourceProjectsLocationsAgentGetvalidationresult,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2ValidationResult]
  ...
  def search(params: ParamsResourceProjectsLocationsAgentSearch): GaxiosPromise[SchemaGoogleCloudDialogflowV2SearchAgentsResponse] = js.native
  def search(
  ...
  def search(params: ParamsResourceProjectsLocationsAgentSearch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2SearchAgentsResponse] = js.native
  def search(
    params: ParamsResourceProjectsLocationsAgentSearch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2SearchAgentsResponse]
  ...
  def updateFulfillment(params: ParamsResourceProjectsLocationsAgentUpdatefulfillment): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  ...
  def updateFulfillment(params: ParamsResourceProjectsLocationsAgentUpdatefulfillment, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2Fulfillment] = js.native
  def updateFulfillment(
    params: ParamsResourceProjectsLocationsAgentUpdatefulfillment,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Fulfillment]
