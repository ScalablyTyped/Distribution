...
object SchemaGoogleCloudDialogflowV2IntentMessageSimpleResponses {
  ...
  extension [Self <: SchemaGoogleCloudDialogflowV2IntentMessageSimpleResponses](x: Self) {
    ...
    inline def setSimpleResponsesVarargs(value: SchemaGoogleCloudDialogflowV2IntentMessageSimpleResponse*): Self = StObject.set(x, "simpleResponses", js.Array(value*))
  }
}
