...
trait SchemaGoogleCloudDialogflowCxV3PageInfoFormInfoParameterInfo extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3PageInfoFormInfoParameterInfo {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3PageInfoFormInfoParameterInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3PageInfoFormInfoParameterInfo]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3PageInfoFormInfoParameterInfo](x: Self) {
