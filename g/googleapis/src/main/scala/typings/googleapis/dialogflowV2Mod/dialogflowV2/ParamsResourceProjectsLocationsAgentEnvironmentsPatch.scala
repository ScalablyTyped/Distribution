...
trait ParamsResourceProjectsLocationsAgentEnvironmentsPatch
  extends StObject
...
object ParamsResourceProjectsLocationsAgentEnvironmentsPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsAgentEnvironmentsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAgentEnvironmentsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAgentEnvironmentsPatch](x: Self) {
