...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Locations$Conversations$Participants$Suggestions")
@js.native
open class ResourceProjectsLocationsConversationsParticipantsSuggestions protected () extends StObject {
  ...
  def suggestArticles(params: ParamsResourceProjectsLocationsConversationsParticipantsSuggestionsSuggestarticles): GaxiosPromise[SchemaGoogleCloudDialogflowV2SuggestArticlesResponse] = js.native
  def suggestArticles(
  ...
  def suggestFaqAnswers(params: ParamsResourceProjectsLocationsConversationsParticipantsSuggestionsSuggestfaqanswers): GaxiosPromise[SchemaGoogleCloudDialogflowV2SuggestFaqAnswersResponse] = js.native
  ...
  def suggestSmartReplies(params: ParamsResourceProjectsLocationsConversationsParticipantsSuggestionsSuggestsmartreplies): GaxiosPromise[SchemaGoogleCloudDialogflowV2SuggestSmartRepliesResponse] = js.native
