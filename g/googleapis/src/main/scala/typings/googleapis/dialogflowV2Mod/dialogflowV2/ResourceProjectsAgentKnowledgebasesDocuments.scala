...
@JSImport("googleapis/build/src/apis/dialogflow/v2", "dialogflow_v2.Resource$Projects$Agent$Knowledgebases$Documents")
@js.native
open class ResourceProjectsAgentKnowledgebasesDocuments protected () extends StObject {
  ...
  def get(params: ParamsResourceProjectsAgentKnowledgebasesDocumentsGet): GaxiosPromise[SchemaGoogleCloudDialogflowV2Document] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsAgentKnowledgebasesDocumentsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2Document] = js.native
  def get(
    params: ParamsResourceProjectsAgentKnowledgebasesDocumentsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2Document]
  ...
  def list(params: ParamsResourceProjectsAgentKnowledgebasesDocumentsList): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListDocumentsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsAgentKnowledgebasesDocumentsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2ListDocumentsResponse] = js.native
  def list(
    params: ParamsResourceProjectsAgentKnowledgebasesDocumentsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2ListDocumentsResponse]
