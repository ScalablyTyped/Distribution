...
trait ParamsResourceProjectsLocationsOperationsCancel
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaApigatewayCancelOperationRequest] = js.undefined
}
object ParamsResourceProjectsLocationsOperationsCancel {
  ...
  extension [Self <: ParamsResourceProjectsLocationsOperationsCancel](x: Self) {
    ...
    inline def setRequestBody(value: SchemaApigatewayCancelOperationRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
