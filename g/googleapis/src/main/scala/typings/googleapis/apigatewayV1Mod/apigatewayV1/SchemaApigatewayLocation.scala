...
trait SchemaApigatewayLocation extends StObject {
...
object SchemaApigatewayLocation {
  
  inline def apply(): SchemaApigatewayLocation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaApigatewayLocation]
  }
  
  extension [Self <: SchemaApigatewayLocation](x: Self) {
