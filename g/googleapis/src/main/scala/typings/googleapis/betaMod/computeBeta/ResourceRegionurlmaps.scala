...
@JSImport("googleapis/build/src/apis/compute/beta", "compute_beta.Resource$Regionurlmaps")
@js.native
open class ResourceRegionurlmaps protected () extends StObject {
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def invalidateCache(params: ParamsResourceRegionurlmapsInvalidatecache, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def invalidateCache(
    params: ParamsResourceRegionurlmapsInvalidatecache,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def testIamPermissions(params: ParamsResourceRegionurlmapsTestiampermissions, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def testIamPermissions(
    params: ParamsResourceRegionurlmapsTestiampermissions,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
