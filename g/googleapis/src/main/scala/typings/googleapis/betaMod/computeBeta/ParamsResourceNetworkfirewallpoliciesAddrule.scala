...
trait ParamsResourceNetworkfirewallpoliciesAddrule
  extends StObject
...
object ParamsResourceNetworkfirewallpoliciesAddrule {
  
  inline def apply(): ParamsResourceNetworkfirewallpoliciesAddrule = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNetworkfirewallpoliciesAddrule]
  }
  
  extension [Self <: ParamsResourceNetworkfirewallpoliciesAddrule](x: Self) {
