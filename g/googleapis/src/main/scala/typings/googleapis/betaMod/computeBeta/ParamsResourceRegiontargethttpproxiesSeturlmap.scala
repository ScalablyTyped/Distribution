...
trait ParamsResourceRegiontargethttpproxiesSeturlmap
  extends StObject
...
object ParamsResourceRegiontargethttpproxiesSeturlmap {
  
  inline def apply(): ParamsResourceRegiontargethttpproxiesSeturlmap = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegiontargethttpproxiesSeturlmap]
  }
  
  extension [Self <: ParamsResourceRegiontargethttpproxiesSeturlmap](x: Self) {
