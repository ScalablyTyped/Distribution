...
trait SchemaSecurityPolicyRuleMatcherConfigLayer4Config extends StObject {
...
object SchemaSecurityPolicyRuleMatcherConfigLayer4Config {
  
  inline def apply(): SchemaSecurityPolicyRuleMatcherConfigLayer4Config = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSecurityPolicyRuleMatcherConfigLayer4Config]
  }
  
  extension [Self <: SchemaSecurityPolicyRuleMatcherConfigLayer4Config](x: Self) {
