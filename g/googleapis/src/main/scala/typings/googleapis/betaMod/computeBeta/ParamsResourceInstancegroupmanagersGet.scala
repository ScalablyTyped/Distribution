...
@js.native
trait ParamsResourceInstancegroupmanagersGet extends StandardParameters {
...
object ParamsResourceInstancegroupmanagersGet {
  ...
  @scala.inline
  def apply(): ParamsResourceInstancegroupmanagersGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancegroupmanagersGet]
  }
  
  @scala.inline
  implicit class ParamsResourceInstancegroupmanagersGetMutableBuilder[Self <: ParamsResourceInstancegroupmanagersGet] (val x: Self) extends AnyVal {
