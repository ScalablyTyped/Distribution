...
@js.native
open class ResourceRegiondisktypes protected () extends StObject {
  ...
  /**
    ...
    */
  def get(params: ParamsResourceRegiondisktypesGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceRegiondisktypesGet,
  ...
  def list(
    params: ParamsResourceRegiondisktypesList,
    options: BodyResponseCallback[Readable | SchemaRegionDiskTypeList],
    callback: BodyResponseCallback[Readable | SchemaRegionDiskTypeList]
  ): Unit = js.native
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceRegiondisktypesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceRegiondisktypesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
