...
trait ParamsResourceTargetgrpcproxiesList
  extends StObject
...
object ParamsResourceTargetgrpcproxiesList {
  
  inline def apply(): ParamsResourceTargetgrpcproxiesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTargetgrpcproxiesList]
  }
  
  extension [Self <: ParamsResourceTargetgrpcproxiesList](x: Self) {
