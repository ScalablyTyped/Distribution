...
@JSImport("googleapis/build/src/apis/compute/beta", "compute_beta.Resource$Regiontargethttpproxies")
@js.native
open class ResourceRegiontargethttpproxies protected () extends StObject {
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def testIamPermissions(params: ParamsResourceRegiontargethttpproxiesTestiampermissions, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def testIamPermissions(
    params: ParamsResourceRegiontargethttpproxiesTestiampermissions,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
