...
@js.native
trait ParamsResourceSubnetworksExpandipcidrrange extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaSubnetworksExpandIpCidrRangeRequest] = js.native
  /**
...
object ParamsResourceSubnetworksExpandipcidrrange {
  ...
  @scala.inline
  implicit class ParamsResourceSubnetworksExpandipcidrrangeOps[Self <: ParamsResourceSubnetworksExpandipcidrrange] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaSubnetworksExpandIpCidrRangeRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
