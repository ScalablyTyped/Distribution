...
trait ParamsResourceTargetgrpcproxiesDelete
  extends StObject
...
object ParamsResourceTargetgrpcproxiesDelete {
  
  inline def apply(): ParamsResourceTargetgrpcproxiesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTargetgrpcproxiesDelete]
  }
  
  extension [Self <: ParamsResourceTargetgrpcproxiesDelete](x: Self) {
