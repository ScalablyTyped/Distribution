...
@js.native
trait ParamsResourceForwardingrulesGet extends StandardParameters {
...
object ParamsResourceForwardingrulesGet {
  ...
  @scala.inline
  def apply(): ParamsResourceForwardingrulesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceForwardingrulesGet]
  }
  
  @scala.inline
  implicit class ParamsResourceForwardingrulesGetMutableBuilder[Self <: ParamsResourceForwardingrulesGet] (val x: Self) extends AnyVal {
