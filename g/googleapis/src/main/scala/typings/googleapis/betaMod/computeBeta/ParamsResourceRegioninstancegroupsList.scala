...
trait ParamsResourceRegioninstancegroupsList
  extends StObject
...
object ParamsResourceRegioninstancegroupsList {
  ...
  inline def apply(): ParamsResourceRegioninstancegroupsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegioninstancegroupsList]
  }
  
  extension [Self <: ParamsResourceRegioninstancegroupsList](x: Self) {
