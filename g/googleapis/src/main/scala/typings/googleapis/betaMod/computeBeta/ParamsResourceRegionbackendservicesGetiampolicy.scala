...
trait ParamsResourceRegionbackendservicesGetiampolicy
  extends StObject
...
object ParamsResourceRegionbackendservicesGetiampolicy {
  
  inline def apply(): ParamsResourceRegionbackendservicesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionbackendservicesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceRegionbackendservicesGetiampolicy](x: Self) {
