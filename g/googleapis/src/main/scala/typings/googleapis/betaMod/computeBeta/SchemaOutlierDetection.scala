...
trait SchemaOutlierDetection extends StObject {
  ...
  /**
    ...
    */
  var consecutiveErrors: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * The number of consecutive gateway failures (502, 503, 504 status or connection errors that are mapped to one of those status codes) before a consecutive gateway failure ejection occurs. Defaults to 3.
    */
  var consecutiveGatewayFailure: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var enforcingConsecutiveErrors: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var enforcingConsecutiveGatewayFailure: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * The percentage chance that a host will be actually ejected when an outlier status is detected through success rate statistics. This setting can be used to disable ejection or to ramp it up slowly. Defaults to 100.
    */
  var enforcingSuccessRate: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var maxEjectionPercent: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * The number of hosts in a cluster that must have enough request volume to detect success rate outliers. If the number of hosts is less than this setting, outlier detection via success rate statistics is not performed for any host in the cluster. Defaults to 5.
    */
  var successRateMinimumHosts: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * The minimum number of total requests that must be collected in one interval (as defined by the interval duration above) to include this host in success rate based outlier detection. If the volume is lower than this setting, outlier detection via success rate statistics is not performed for that host. Defaults to 100.
    */
  var successRateRequestVolume: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * This factor is used to determine the ejection threshold for success rate outlier ejection. The ejection threshold is the difference between the mean success rate, and the product of this factor and the standard deviation of the mean success rate: mean - (stdev * success_rate_stdev_factor). This factor is divided by a thousand to get a double. That is, if the desired factor is 1.9, the runtime value should be 1900. Defaults to 1900.
    */
  var successRateStdevFactor: js.UndefOr[Double | Null] = js.undefined
}
object SchemaOutlierDetection {
  ...
  extension [Self <: SchemaOutlierDetection](x: Self) {
    ...
    inline def setConsecutiveErrorsNull: Self = StObject.set(x, "consecutiveErrors", null)
    ...
    inline def setConsecutiveGatewayFailureNull: Self = StObject.set(x, "consecutiveGatewayFailure", null)
    ...
    inline def setEnforcingConsecutiveErrorsNull: Self = StObject.set(x, "enforcingConsecutiveErrors", null)
    ...
    inline def setEnforcingConsecutiveGatewayFailureNull: Self = StObject.set(x, "enforcingConsecutiveGatewayFailure", null)
    ...
    inline def setEnforcingSuccessRateNull: Self = StObject.set(x, "enforcingSuccessRate", null)
    ...
    inline def setMaxEjectionPercentNull: Self = StObject.set(x, "maxEjectionPercent", null)
    ...
    inline def setSuccessRateMinimumHostsNull: Self = StObject.set(x, "successRateMinimumHosts", null)
    ...
    inline def setSuccessRateRequestVolumeNull: Self = StObject.set(x, "successRateRequestVolume", null)
    ...
    inline def setSuccessRateStdevFactorNull: Self = StObject.set(x, "successRateStdevFactor", null)
