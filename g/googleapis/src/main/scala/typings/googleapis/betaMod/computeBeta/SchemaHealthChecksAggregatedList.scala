...
trait SchemaHealthChecksAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaHealthChecksScopedList] | Null] = js.undefined
...
object SchemaHealthChecksAggregatedList {
  ...
  inline def apply(): SchemaHealthChecksAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaHealthChecksAggregatedList]
  }
  
  extension [Self <: SchemaHealthChecksAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaHealthChecksScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
