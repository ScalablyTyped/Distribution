...
trait ParamsResourceRegionautoscalersDelete
  extends StObject
...
object ParamsResourceRegionautoscalersDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceRegionautoscalersDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionautoscalersDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceRegionautoscalersDeleteMutableBuilder[Self <: ParamsResourceRegionautoscalersDelete] (val x: Self) extends AnyVal {
