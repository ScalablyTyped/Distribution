...
trait SchemaNodeTypeAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaNodeTypesScopedList] | Null] = js.undefined
...
object SchemaNodeTypeAggregatedList {
  ...
  inline def apply(): SchemaNodeTypeAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaNodeTypeAggregatedList]
  }
  
  extension [Self <: SchemaNodeTypeAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaNodeTypesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
