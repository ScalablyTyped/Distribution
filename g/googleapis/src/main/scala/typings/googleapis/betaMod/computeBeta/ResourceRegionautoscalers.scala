...
@js.native
class ResourceRegionautoscalers protected () extends js.Object {
  ...
  def list(
    params: ParamsResourceRegionautoscalersList,
    options: BodyResponseCallback[SchemaRegionAutoscalerList],
    callback: BodyResponseCallback[SchemaRegionAutoscalerList]
  ): Unit = js.native
  ...
  /**
    ...
    *   };
    *
    *   compute.regionAutoscalers.testIamPermissions(request, function(err,
