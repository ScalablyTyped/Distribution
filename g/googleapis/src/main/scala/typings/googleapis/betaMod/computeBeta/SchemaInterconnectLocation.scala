...
trait SchemaInterconnectLocation extends StObject {
  ...
  /**
    ...
    */
  var availabilityZone: js.UndefOr[String | Null] = js.undefined
...
object SchemaInterconnectLocation {
  ...
  extension [Self <: SchemaInterconnectLocation](x: Self) {
    ...
    inline def setAvailabilityZoneNull: Self = StObject.set(x, "availabilityZone", null)
    ...
    inline def setRegionInfosVarargs(value: SchemaInterconnectLocationRegionInfo*): Self = StObject.set(x, "regionInfos", js.Array(value*))
