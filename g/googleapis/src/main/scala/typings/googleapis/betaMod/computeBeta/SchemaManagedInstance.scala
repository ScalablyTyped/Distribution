...
trait SchemaManagedInstance extends StObject {
  ...
  /**
    ...
    */
  var allInstancesConfig: js.UndefOr[SchemaManagedInstanceAllInstancesConfig] = js.undefined
...
object SchemaManagedInstance {
  ...
  extension [Self <: SchemaManagedInstance](x: Self) {
    ...
    inline def setAllInstancesConfig(value: SchemaManagedInstanceAllInstancesConfig): Self = StObject.set(x, "allInstancesConfig", value.asInstanceOf[js.Any])
