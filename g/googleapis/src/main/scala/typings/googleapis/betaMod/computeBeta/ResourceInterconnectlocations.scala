...
@js.native
class ResourceInterconnectlocations protected () extends StObject {
  ...
  def get(
    params: ParamsResourceInterconnectlocationsGet,
    options: BodyResponseCallback[SchemaInterconnectLocation],
    callback: BodyResponseCallback[SchemaInterconnectLocation]
  ): Unit = js.native
  ...
  def list(
    params: ParamsResourceInterconnectlocationsList,
    options: BodyResponseCallback[SchemaInterconnectLocationList],
    callback: BodyResponseCallback[SchemaInterconnectLocationList]
  ): Unit = js.native
