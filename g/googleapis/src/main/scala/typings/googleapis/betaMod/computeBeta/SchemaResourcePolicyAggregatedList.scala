...
trait SchemaResourcePolicyAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaResourcePoliciesScopedList] | Null] = js.undefined
...
object SchemaResourcePolicyAggregatedList {
  ...
  inline def apply(): SchemaResourcePolicyAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaResourcePolicyAggregatedList]
  }
  
  extension [Self <: SchemaResourcePolicyAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaResourcePoliciesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
