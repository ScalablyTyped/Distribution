...
@JSImport("googleapis/build/src/apis/compute/beta", "compute_beta.Resource$Targethttpproxies")
@js.native
class ResourceTargethttpproxies protected () extends StObject {
  ...
  /**
    ...
    *   };
    *
    *   compute.targetHttpProxies.testIamPermissions(request, function(err,
