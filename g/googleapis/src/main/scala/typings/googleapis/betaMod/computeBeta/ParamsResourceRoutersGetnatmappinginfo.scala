...
trait ParamsResourceRoutersGetnatmappinginfo
  extends StObject
  ...
  /**
    ...
    */
  var natName: js.UndefOr[String] = js.undefined
...
object ParamsResourceRoutersGetnatmappinginfo {
  ...
  inline def apply(): ParamsResourceRoutersGetnatmappinginfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRoutersGetnatmappinginfo]
  }
  
  extension [Self <: ParamsResourceRoutersGetnatmappinginfo](x: Self) {
    ...
    inline def setNatName(value: String): Self = StObject.set(x, "natName", value.asInstanceOf[js.Any])
    
    inline def setNatNameUndefined: Self = StObject.set(x, "natName", js.undefined)
