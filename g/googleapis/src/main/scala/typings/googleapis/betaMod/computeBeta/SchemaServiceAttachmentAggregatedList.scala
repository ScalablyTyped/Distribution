...
trait SchemaServiceAttachmentAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaServiceAttachmentsScopedList] | Null] = js.undefined
...
object SchemaServiceAttachmentAggregatedList {
  
  inline def apply(): SchemaServiceAttachmentAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaServiceAttachmentAggregatedList]
  }
  
  extension [Self <: SchemaServiceAttachmentAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaServiceAttachmentsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
