...
trait SchemaInstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy extends StObject {
...
object SchemaInstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy {
  
  inline def apply(): SchemaInstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy]
  }
  
  extension [Self <: SchemaInstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy](x: Self) {
