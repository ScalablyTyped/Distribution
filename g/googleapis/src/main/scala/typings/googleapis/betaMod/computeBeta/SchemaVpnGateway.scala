...
trait SchemaVpnGateway extends StObject {
  ...
  /**
    ...
    */
  var vpnInterfaces: js.UndefOr[js.Array[SchemaVpnGatewayVpnGatewayInterface]] = js.undefined
}
object SchemaVpnGateway {
  
  inline def apply(): SchemaVpnGateway = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaVpnGateway]
  }
  
  extension [Self <: SchemaVpnGateway](x: Self) {
    ...
    inline def setVpnInterfaces(value: js.Array[SchemaVpnGatewayVpnGatewayInterface]): Self = StObject.set(x, "vpnInterfaces", value.asInstanceOf[js.Any])
    
    inline def setVpnInterfacesUndefined: Self = StObject.set(x, "vpnInterfaces", js.undefined)
    
    inline def setVpnInterfacesVarargs(value: SchemaVpnGatewayVpnGatewayInterface*): Self = StObject.set(x, "vpnInterfaces", js.Array(value :_*))
  }
}
