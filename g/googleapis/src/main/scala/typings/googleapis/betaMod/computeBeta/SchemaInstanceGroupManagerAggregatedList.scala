...
trait SchemaInstanceGroupManagerAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaInstanceGroupManagersScopedList] | Null] = js.undefined
...
object SchemaInstanceGroupManagerAggregatedList {
  ...
  inline def apply(): SchemaInstanceGroupManagerAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInstanceGroupManagerAggregatedList]
  }
  
  extension [Self <: SchemaInstanceGroupManagerAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaInstanceGroupManagersScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
