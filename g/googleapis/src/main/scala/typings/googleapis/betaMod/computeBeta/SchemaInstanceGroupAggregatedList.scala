...
trait SchemaInstanceGroupAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaInstanceGroupsScopedList] | Null] = js.undefined
...
object SchemaInstanceGroupAggregatedList {
  ...
  inline def apply(): SchemaInstanceGroupAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInstanceGroupAggregatedList]
  }
  
  extension [Self <: SchemaInstanceGroupAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaInstanceGroupsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
