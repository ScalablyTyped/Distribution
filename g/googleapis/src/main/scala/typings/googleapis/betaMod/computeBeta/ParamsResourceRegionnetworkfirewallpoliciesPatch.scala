...
trait ParamsResourceRegionnetworkfirewallpoliciesPatch
  extends StObject
...
object ParamsResourceRegionnetworkfirewallpoliciesPatch {
  
  inline def apply(): ParamsResourceRegionnetworkfirewallpoliciesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionnetworkfirewallpoliciesPatch]
  }
  
  extension [Self <: ParamsResourceRegionnetworkfirewallpoliciesPatch](x: Self) {
