...
object ParamsResourceInstancesAttachdisk {
  ...
  inline def apply(): ParamsResourceInstancesAttachdisk = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancesAttachdisk]
  }
  
  extension [Self <: ParamsResourceInstancesAttachdisk](x: Self) {
    ...
    inline def setRequestBody(value: SchemaAttachedDisk): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
