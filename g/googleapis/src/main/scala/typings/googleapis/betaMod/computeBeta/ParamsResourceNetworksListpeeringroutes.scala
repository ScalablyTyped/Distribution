...
trait ParamsResourceNetworksListpeeringroutes
  extends StObject
...
object ParamsResourceNetworksListpeeringroutes {
  ...
  @scala.inline
  implicit class ParamsResourceNetworksListpeeringroutesMutableBuilder[Self <: ParamsResourceNetworksListpeeringroutes] (val x: Self) extends AnyVal {
