...
trait ParamsResourceInstancetemplatesList
  extends StObject
...
object ParamsResourceInstancetemplatesList {
  ...
  inline def apply(): ParamsResourceInstancetemplatesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancetemplatesList]
  }
  
  extension [Self <: ParamsResourceInstancetemplatesList](x: Self) {
