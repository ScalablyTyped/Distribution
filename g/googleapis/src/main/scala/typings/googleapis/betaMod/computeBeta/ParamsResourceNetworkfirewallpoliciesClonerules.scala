...
trait ParamsResourceNetworkfirewallpoliciesClonerules
  extends StObject
...
object ParamsResourceNetworkfirewallpoliciesClonerules {
  
  inline def apply(): ParamsResourceNetworkfirewallpoliciesClonerules = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNetworkfirewallpoliciesClonerules]
  }
  
  extension [Self <: ParamsResourceNetworkfirewallpoliciesClonerules](x: Self) {
