...
trait ParamsResourceInstancegroupsSetnamedports
  extends StObject
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaInstanceGroupsSetNamedPortsRequest] = js.undefined
...
object ParamsResourceInstancegroupsSetnamedports {
  ...
  inline def apply(): ParamsResourceInstancegroupsSetnamedports = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceInstancegroupsSetnamedports]
  }
  
  extension [Self <: ParamsResourceInstancegroupsSetnamedports](x: Self) {
    ...
    inline def setRequestBody(value: SchemaInstanceGroupsSetNamedPortsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
