...
object ParamsResourceInstancegroupsSetnamedports {
  ...
  @scala.inline
  implicit class ParamsResourceInstancegroupsSetnamedportsOps[Self <: ParamsResourceInstancegroupsSetnamedports] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaInstanceGroupsSetNamedPortsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
