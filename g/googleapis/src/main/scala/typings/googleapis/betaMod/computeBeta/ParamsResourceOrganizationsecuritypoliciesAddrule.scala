...
trait ParamsResourceOrganizationsecuritypoliciesAddrule
  extends StObject
...
object ParamsResourceOrganizationsecuritypoliciesAddrule {
  
  inline def apply(): ParamsResourceOrganizationsecuritypoliciesAddrule = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsecuritypoliciesAddrule]
  }
  
  extension [Self <: ParamsResourceOrganizationsecuritypoliciesAddrule](x: Self) {
