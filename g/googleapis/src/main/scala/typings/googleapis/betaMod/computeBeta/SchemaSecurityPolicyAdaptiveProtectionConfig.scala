...
trait SchemaSecurityPolicyAdaptiveProtectionConfig extends StObject {
  ...
  var autoDeployConfig: js.UndefOr[SchemaSecurityPolicyAdaptiveProtectionConfigAutoDeployConfig] = js.undefined
...
object SchemaSecurityPolicyAdaptiveProtectionConfig {
  ...
  extension [Self <: SchemaSecurityPolicyAdaptiveProtectionConfig](x: Self) {
    ...
    inline def setAutoDeployConfig(value: SchemaSecurityPolicyAdaptiveProtectionConfigAutoDeployConfig): Self = StObject.set(x, "autoDeployConfig", value.asInstanceOf[js.Any])
    
    inline def setAutoDeployConfigUndefined: Self = StObject.set(x, "autoDeployConfig", js.undefined)
