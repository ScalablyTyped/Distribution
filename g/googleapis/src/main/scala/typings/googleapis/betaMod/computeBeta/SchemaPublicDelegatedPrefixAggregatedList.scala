...
trait SchemaPublicDelegatedPrefixAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaPublicDelegatedPrefixesScopedList] | Null] = js.undefined
...
object SchemaPublicDelegatedPrefixAggregatedList {
  
  inline def apply(): SchemaPublicDelegatedPrefixAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPublicDelegatedPrefixAggregatedList]
  }
  
  extension [Self <: SchemaPublicDelegatedPrefixAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaPublicDelegatedPrefixesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
