...
trait SchemaHttpRouteRule extends StObject {
  ...
  /**
    ...
    */
  var httpFilterConfigs: js.UndefOr[js.Array[SchemaHttpFilterConfig]] = js.undefined
  ...
  /**
    ...
    */
  var httpFilterMetadata: js.UndefOr[js.Array[SchemaHttpFilterConfig]] = js.undefined
...
object SchemaHttpRouteRule {
  ...
  extension [Self <: SchemaHttpRouteRule](x: Self) {
    ...
    inline def setHttpFilterConfigs(value: js.Array[SchemaHttpFilterConfig]): Self = StObject.set(x, "httpFilterConfigs", value.asInstanceOf[js.Any])
    
    inline def setHttpFilterConfigsUndefined: Self = StObject.set(x, "httpFilterConfigs", js.undefined)
    
    inline def setHttpFilterConfigsVarargs(value: SchemaHttpFilterConfig*): Self = StObject.set(x, "httpFilterConfigs", js.Array(value*))
    
    inline def setHttpFilterMetadata(value: js.Array[SchemaHttpFilterConfig]): Self = StObject.set(x, "httpFilterMetadata", value.asInstanceOf[js.Any])
    
    inline def setHttpFilterMetadataUndefined: Self = StObject.set(x, "httpFilterMetadata", js.undefined)
    
    inline def setHttpFilterMetadataVarargs(value: SchemaHttpFilterConfig*): Self = StObject.set(x, "httpFilterMetadata", js.Array(value*))
