...
trait ParamsResourceRegionurlmapsList
  extends StObject
...
object ParamsResourceRegionurlmapsList {
  
  inline def apply(): ParamsResourceRegionurlmapsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionurlmapsList]
  }
  
  extension [Self <: ParamsResourceRegionurlmapsList](x: Self) {
