...
trait ParamsResourcePacketmirroringsList
  extends StObject
...
object ParamsResourcePacketmirroringsList {
  
  inline def apply(): ParamsResourcePacketmirroringsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePacketmirroringsList]
  }
  
  extension [Self <: ParamsResourcePacketmirroringsList](x: Self) {
