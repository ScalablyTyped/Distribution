...
@JSImport("googleapis/build/src/apis/compute/beta", "compute_beta.Resource$Globalorganizationoperations")
@js.native
open class ResourceGlobalorganizationoperations protected () extends StObject {
  ...
  /**
    ...
    */
  def delete(params: ParamsResourceGlobalorganizationoperationsDelete, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def delete(
    params: ParamsResourceGlobalorganizationoperationsDelete,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def get(params: ParamsResourceGlobalorganizationoperationsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceGlobalorganizationoperationsGet,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceGlobalorganizationoperationsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceGlobalorganizationoperationsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
