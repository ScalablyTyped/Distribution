...
trait ParamsResourceExternalvpngatewaysList
  extends StObject
...
object ParamsResourceExternalvpngatewaysList {
  ...
  inline def apply(): ParamsResourceExternalvpngatewaysList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceExternalvpngatewaysList]
  }
  
  extension [Self <: ParamsResourceExternalvpngatewaysList](x: Self) {
