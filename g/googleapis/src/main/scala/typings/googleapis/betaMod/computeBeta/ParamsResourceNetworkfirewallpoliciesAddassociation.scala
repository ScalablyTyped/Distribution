...
trait ParamsResourceNetworkfirewallpoliciesAddassociation
  extends StObject
...
object ParamsResourceNetworkfirewallpoliciesAddassociation {
  
  inline def apply(): ParamsResourceNetworkfirewallpoliciesAddassociation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNetworkfirewallpoliciesAddassociation]
  }
  
  extension [Self <: ParamsResourceNetworkfirewallpoliciesAddassociation](x: Self) {
