...
trait ParamsResourceReservationsUpdate
  extends StObject
...
object ParamsResourceReservationsUpdate {
  
  inline def apply(): ParamsResourceReservationsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceReservationsUpdate]
  }
  
  extension [Self <: ParamsResourceReservationsUpdate](x: Self) {
