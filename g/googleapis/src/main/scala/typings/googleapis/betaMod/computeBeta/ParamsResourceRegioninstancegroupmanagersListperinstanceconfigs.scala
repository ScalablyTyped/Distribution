...
trait ParamsResourceRegioninstancegroupmanagersListperinstanceconfigs
  extends StObject
...
object ParamsResourceRegioninstancegroupmanagersListperinstanceconfigs {
  ...
  inline def apply(): ParamsResourceRegioninstancegroupmanagersListperinstanceconfigs = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegioninstancegroupmanagersListperinstanceconfigs]
  }
  
  extension [Self <: ParamsResourceRegioninstancegroupmanagersListperinstanceconfigs](x: Self) {
