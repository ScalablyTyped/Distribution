...
object SchemaTargetHttpProxyList {
  ...
  @scala.inline
  implicit class SchemaTargetHttpProxyListOps[Self <: SchemaTargetHttpProxyList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaTargetHttpProxy*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaTargetHttpProxy]): Self = this.set("items", value.asInstanceOf[js.Any])
