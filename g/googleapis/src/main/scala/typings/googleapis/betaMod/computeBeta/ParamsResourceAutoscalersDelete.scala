...
@js.native
trait ParamsResourceAutoscalersDelete extends StandardParameters {
...
object ParamsResourceAutoscalersDelete {
  
  @scala.inline
  def apply(): ParamsResourceAutoscalersDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAutoscalersDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceAutoscalersDeleteMutableBuilder[Self <: ParamsResourceAutoscalersDelete] (val x: Self) extends AnyVal {
