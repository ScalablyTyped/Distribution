...
open class ResourceInstances protected () extends StObject {
  ...
  def getShieldedVmIdentity(params: Unit, options: MethodOptions): GaxiosPromise[SchemaShieldedVmIdentity] = js.native
  ...
  def getShieldedVmIdentity(
    params: ParamsResourceInstancesGetshieldedvmidentity,
    options: BodyResponseCallback[Readable | SchemaShieldedVmIdentity],
    callback: BodyResponseCallback[Readable | SchemaShieldedVmIdentity]
  ): Unit = js.native
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def getShieldedVmIdentity(params: ParamsResourceInstancesGetshieldedvmidentity, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def getShieldedVmIdentity(
    params: ParamsResourceInstancesGetshieldedvmidentity,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def setName(): GaxiosPromise[SchemaOperation] = js.native
  def setName(callback: BodyResponseCallback[SchemaOperation]): Unit = js.native
  def setName(params: Unit, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def setName(params: ParamsResourceInstancesSetname): GaxiosPromise[SchemaOperation] = js.native
  def setName(params: ParamsResourceInstancesSetname, callback: BodyResponseCallback[SchemaOperation]): Unit = js.native
  def setName(
    params: ParamsResourceInstancesSetname,
    options: BodyResponseCallback[Readable | SchemaOperation],
    callback: BodyResponseCallback[Readable | SchemaOperation]
  ): Unit = js.native
  def setName(params: ParamsResourceInstancesSetname, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def setName(
    params: ParamsResourceInstancesSetname,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def setName(params: ParamsResourceInstancesSetname, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def setName(
    params: ParamsResourceInstancesSetname,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    *       //   "maintenanceInterval": "my_maintenanceInterval",
    *       //   "minNodeCpus": 0,
    *       //   "nodeAffinities": [],
  ...
  def setShieldedVmIntegrityPolicy(params: Unit, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def setShieldedVmIntegrityPolicy(params: ParamsResourceInstancesSetshieldedvmintegritypolicy, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def setShieldedVmIntegrityPolicy(
    params: ParamsResourceInstancesSetshieldedvmintegritypolicy,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def updateShieldedVmConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def updateShieldedVmConfig(params: ParamsResourceInstancesUpdateshieldedvmconfig, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def updateShieldedVmConfig(
    params: ParamsResourceInstancesUpdateshieldedvmconfig,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
