...
trait SchemaNodeTemplateAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaNodeTemplatesScopedList] | Null] = js.undefined
...
object SchemaNodeTemplateAggregatedList {
  ...
  inline def apply(): SchemaNodeTemplateAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaNodeTemplateAggregatedList]
  }
  
  extension [Self <: SchemaNodeTemplateAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaNodeTemplatesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
