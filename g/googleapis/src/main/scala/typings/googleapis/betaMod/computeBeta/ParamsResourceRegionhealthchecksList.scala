...
trait ParamsResourceRegionhealthchecksList
  extends StObject
...
object ParamsResourceRegionhealthchecksList {
  
  inline def apply(): ParamsResourceRegionhealthchecksList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionhealthchecksList]
  }
  
  extension [Self <: ParamsResourceRegionhealthchecksList](x: Self) {
