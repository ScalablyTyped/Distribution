...
trait SchemaDiskTypeAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaDiskTypesScopedList] | Null] = js.undefined
...
object SchemaDiskTypeAggregatedList {
  ...
  inline def apply(): SchemaDiskTypeAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDiskTypeAggregatedList]
  }
  
  extension [Self <: SchemaDiskTypeAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaDiskTypesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
