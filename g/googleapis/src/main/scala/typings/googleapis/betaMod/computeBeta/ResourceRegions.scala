...
@JSImport("googleapis/build/src/apis/compute/beta", "compute_beta.Resource$Regions")
@js.native
class ResourceRegions protected () extends js.Object {
  ...
  def get(
    ...
    options: BodyResponseCallback[SchemaRegion],
  ...
  def list(
    ...
    options: BodyResponseCallback[SchemaRegionList],
