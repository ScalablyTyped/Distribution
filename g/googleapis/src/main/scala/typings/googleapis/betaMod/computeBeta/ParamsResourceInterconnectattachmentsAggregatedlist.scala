...
object ParamsResourceInterconnectattachmentsAggregatedlist {
  ...
  @scala.inline
  implicit class ParamsResourceInterconnectattachmentsAggregatedlistMutableBuilder[Self <: ParamsResourceInterconnectattachmentsAggregatedlist] (val x: Self) extends AnyVal {
