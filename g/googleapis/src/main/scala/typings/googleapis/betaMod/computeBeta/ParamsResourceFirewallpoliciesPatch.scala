...
trait ParamsResourceFirewallpoliciesPatch
  extends StObject
...
object ParamsResourceFirewallpoliciesPatch {
  
  inline def apply(): ParamsResourceFirewallpoliciesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFirewallpoliciesPatch]
  }
  
  extension [Self <: ParamsResourceFirewallpoliciesPatch](x: Self) {
