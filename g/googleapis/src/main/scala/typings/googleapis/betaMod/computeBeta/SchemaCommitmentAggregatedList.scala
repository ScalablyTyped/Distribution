...
trait SchemaCommitmentAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaCommitmentsScopedList] | Null] = js.undefined
...
object SchemaCommitmentAggregatedList {
  ...
  inline def apply(): SchemaCommitmentAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCommitmentAggregatedList]
  }
  
  extension [Self <: SchemaCommitmentAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaCommitmentsScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
