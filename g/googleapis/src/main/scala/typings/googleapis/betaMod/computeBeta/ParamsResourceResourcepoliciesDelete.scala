...
trait ParamsResourceResourcepoliciesDelete
  extends StObject
...
object ParamsResourceResourcepoliciesDelete {
  ...
  inline def apply(): ParamsResourceResourcepoliciesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResourcepoliciesDelete]
  }
  
  extension [Self <: ParamsResourceResourcepoliciesDelete](x: Self) {
