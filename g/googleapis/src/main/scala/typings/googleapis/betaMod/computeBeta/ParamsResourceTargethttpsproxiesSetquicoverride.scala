...
object ParamsResourceTargethttpsproxiesSetquicoverride {
  ...
  inline def apply(): ParamsResourceTargethttpsproxiesSetquicoverride = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTargethttpsproxiesSetquicoverride]
  }
  
  extension [Self <: ParamsResourceTargethttpsproxiesSetquicoverride](x: Self) {
    ...
    inline def setRequestBody(value: SchemaTargetHttpsProxiesSetQuicOverrideRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
