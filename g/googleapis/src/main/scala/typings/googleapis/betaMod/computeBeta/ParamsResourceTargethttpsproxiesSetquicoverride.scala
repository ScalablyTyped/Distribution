...
object ParamsResourceTargethttpsproxiesSetquicoverride {
  ...
  @scala.inline
  implicit class ParamsResourceTargethttpsproxiesSetquicoverrideOps[Self <: ParamsResourceTargethttpsproxiesSetquicoverride] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaTargetHttpsProxiesSetQuicOverrideRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
