...
object ParamsResourceTargethttpsproxiesSetquicoverride {
  ...
  @scala.inline
  def apply(): ParamsResourceTargethttpsproxiesSetquicoverride = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTargethttpsproxiesSetquicoverride]
  }
  
  @scala.inline
  implicit class ParamsResourceTargethttpsproxiesSetquicoverrideMutableBuilder[Self <: ParamsResourceTargethttpsproxiesSetquicoverride] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaTargetHttpsProxiesSetQuicOverrideRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
