...
trait SchemaAddressAggregatedList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaAddressesScopedList] | Null] = js.undefined
...
object SchemaAddressAggregatedList {
  ...
  inline def apply(): SchemaAddressAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAddressAggregatedList]
  }
  
  extension [Self <: SchemaAddressAggregatedList](x: Self) {
    ...
    inline def setItems(value: StringDictionary[SchemaAddressesScopedList]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
