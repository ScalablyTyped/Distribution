...
trait ParamsResourceRegionautoscalersUpdate
  extends StObject
...
object ParamsResourceRegionautoscalersUpdate {
  ...
  inline def apply(): ParamsResourceRegionautoscalersUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRegionautoscalersUpdate]
  }
  
  extension [Self <: ParamsResourceRegionautoscalersUpdate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaAutoscaler): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
