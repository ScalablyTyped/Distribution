...
trait ParamsResourceTargethttpproxiesDelete
  extends StObject
...
object ParamsResourceTargethttpproxiesDelete {
  ...
  inline def apply(): ParamsResourceTargethttpproxiesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTargethttpproxiesDelete]
  }
  
  extension [Self <: ParamsResourceTargethttpproxiesDelete](x: Self) {
