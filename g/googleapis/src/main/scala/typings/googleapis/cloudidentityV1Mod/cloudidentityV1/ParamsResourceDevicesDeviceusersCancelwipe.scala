...
trait ParamsResourceDevicesDeviceusersCancelwipe
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest] = js.undefined
}
object ParamsResourceDevicesDeviceusersCancelwipe {
  ...
  extension [Self <: ParamsResourceDevicesDeviceusersCancelwipe](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleAppsCloudidentityDevicesV1CancelWipeDeviceUserRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
