...
object ParamsResourceGroupsLookup {
  ...
  def apply(
    ...
    fields: String = null,
    groupKeyDotid: String = null,
    groupKeyDotnamespace: String = null,
    key: String = null,
    ...
    if (groupKeyDotid != null) __obj.updateDynamic("groupKey.id")(groupKeyDotid.asInstanceOf[js.Any])
    if (groupKeyDotnamespace != null) __obj.updateDynamic("groupKey.namespace")(groupKeyDotnamespace.asInstanceOf[js.Any])
