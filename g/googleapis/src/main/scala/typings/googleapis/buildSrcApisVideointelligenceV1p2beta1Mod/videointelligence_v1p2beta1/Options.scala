...
import typings.gaxios.buildSrcCommonMod.Headers
import typings.gaxios.buildSrcCommonMod.RetryConfig
...
import typings.googleapisDashCommon.buildSrcApiMod.UserAgentDirective
...
trait Options extends GlobalOptions {
  var version: v1p2beta1 = js.native
}
