...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1_TextFrame extends js.Object {
  /**
    * Bounding polygon of the detected text for this frame.
    */
  var rotatedBoundingBox: js.UndefOr[Schema$GoogleCloudVideointelligenceV1_NormalizedBoundingPoly] = js.native
  /**
...
object Schema$GoogleCloudVideointelligenceV1_TextFrame {
  @scala.inline
  def apply(
    rotatedBoundingBox: Schema$GoogleCloudVideointelligenceV1_NormalizedBoundingPoly = null,
    timeOffset: String = null
  ): Schema$GoogleCloudVideointelligenceV1_TextFrame = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1_TextFrame]
  }
}
