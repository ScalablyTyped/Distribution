...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVideointelligenceV1p1beta1_VideoSegment extends js.Object {
  /**
...
object Schema$GoogleCloudVideointelligenceV1p1beta1_VideoSegment {
  @scala.inline
  def apply(endTimeOffset: String = null, startTimeOffset: String = null): Schema$GoogleCloudVideointelligenceV1p1beta1_VideoSegment = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVideointelligenceV1p1beta1_VideoSegment]
  }
}
