...
import typings.googleapis.Anon_AdvertiserAppIcon
import typings.googleapis.Anon_Contexts
import typings.googleapis.Anon_ContextsDisapprovalReasons
import typings.googleapis.Anon_Date
...
trait Schema$Creative extends js.Object {
  ...
  /**
    ...
    */
  var corrections: js.UndefOr[js.Array[Anon_Contexts]] = js.native
  /**
  ...
  /**
    ...
    * be set in requests.
    */
  var filteringReasons: js.UndefOr[Anon_Date] = js.native
  /**
    * Ad height.
    */
  ...
  /**
    ...
    */
  var nativeAd: js.UndefOr[Anon_AdvertiserAppIcon] = js.native
  /**
  ...
  /**
    ...
    */
  var servingRestrictions: js.UndefOr[js.Array[Anon_ContextsDisapprovalReasons]] = js.native
  /**
...
object Schema$Creative {
  ...
  def apply(
    ...
    servingRestrictions: js.Array[Anon_ContextsDisapprovalReasons] = null,
