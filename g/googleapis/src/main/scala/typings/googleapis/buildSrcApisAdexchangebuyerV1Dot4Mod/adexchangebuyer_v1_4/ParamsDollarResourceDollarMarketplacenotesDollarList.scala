...
@js.native
trait ParamsDollarResourceDollarMarketplacenotesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarMarketplacenotesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    pqlQuery: String = null,
    prettyPrint: js.UndefOr[Boolean] = js.undefined,
    proposalId: String = null,
    quotaUser: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarMarketplacenotesDollarList = {
    ...
    if (pqlQuery != null) __obj.updateDynamic("pqlQuery")(pqlQuery.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMarketplacenotesDollarList]
  }
}
