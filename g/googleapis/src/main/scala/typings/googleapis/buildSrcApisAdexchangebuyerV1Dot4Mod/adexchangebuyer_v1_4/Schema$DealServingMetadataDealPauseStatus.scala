...
/**
  ...
  */
@js.native
trait Schema$DealServingMetadataDealPauseStatus extends js.Object {
...
object Schema$DealServingMetadataDealPauseStatus {
  @scala.inline
  def apply(
  ...
  ): Schema$DealServingMetadataDealPauseStatus = {
    ...
    __obj.asInstanceOf[Schema$DealServingMetadataDealPauseStatus]
  }
}
