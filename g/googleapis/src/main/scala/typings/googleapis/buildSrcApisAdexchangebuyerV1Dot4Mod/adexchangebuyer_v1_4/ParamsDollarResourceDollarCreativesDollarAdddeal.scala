...
@js.native
trait ParamsDollarResourceDollarCreativesDollarAdddeal extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCreativesDollarAdddeal {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCreativesDollarAdddeal = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCreativesDollarAdddeal]
  }
}
