...
@js.native
trait ParamsDollarResourceDollarMarketplacedealsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarMarketplacedealsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarMarketplacedealsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMarketplacedealsDollarList]
  }
}
