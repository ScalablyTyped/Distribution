...
import typings.googleapis.buildSrcApisAppsactivityV1Mod.appsactivity_v1.Appsactivity
import typings.googleapis.buildSrcApisAppsactivityV1Mod.appsactivity_v1.Options
