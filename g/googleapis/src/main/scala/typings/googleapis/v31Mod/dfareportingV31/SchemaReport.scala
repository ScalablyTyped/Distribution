...
trait SchemaReport extends StObject {
  ...
  /**
    ...
    */
  var criteria: js.UndefOr[Activities] = js.undefined
  ...
  /**
    ...
    */
  var floodlightCriteria: js.UndefOr[CustomRichMediaEvents] = js.undefined
  ...
  /**
    ...
    */
  var pathToConversionCriteria: js.UndefOr[ActivityFilters] = js.undefined
  
  /**
    * The report criteria for a report of type &quot;REACH&quot;.
    */
  var reachCriteria: js.UndefOr[DateRange] = js.undefined
...
object SchemaReport {
  ...
  implicit class SchemaReportMutableBuilder[Self <: SchemaReport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCriteria(value: Activities): Self = StObject.set(x, "criteria", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFloodlightCriteria(value: CustomRichMediaEvents): Self = StObject.set(x, "floodlightCriteria", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPathToConversionCriteria(value: ActivityFilters): Self = StObject.set(x, "pathToConversionCriteria", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPathToConversionCriteriaUndefined: Self = StObject.set(x, "pathToConversionCriteria", js.undefined)
    
    @scala.inline
    def setReachCriteria(value: DateRange): Self = StObject.set(x, "reachCriteria", value.asInstanceOf[js.Any])
