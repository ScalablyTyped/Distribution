...
object ParamsResourceConversionsBatchupdate {
  ...
  @scala.inline
  implicit class ParamsResourceConversionsBatchupdateOps[Self <: ParamsResourceConversionsBatchupdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaConversionsBatchUpdateRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
