...
trait SchemaInventoryItem extends StObject {
  ...
  /**
    ...
    */
  var adSlots: js.UndefOr[js.Array[SchemaAdSlot]] = js.undefined
  ...
  /**
    ...
    */
  var pricing: js.UndefOr[SchemaPricing] = js.undefined
...
object SchemaInventoryItem {
  ...
  extension [Self <: SchemaInventoryItem](x: Self) {
    ...
    inline def setAdSlots(value: js.Array[SchemaAdSlot]): Self = StObject.set(x, "adSlots", value.asInstanceOf[js.Any])
    
    inline def setAdSlotsUndefined: Self = StObject.set(x, "adSlots", js.undefined)
    
    inline def setAdSlotsVarargs(value: SchemaAdSlot*): Self = StObject.set(x, "adSlots", js.Array(value :_*))
    ...
    inline def setPricing(value: SchemaPricing): Self = StObject.set(x, "pricing", value.asInstanceOf[js.Any])
