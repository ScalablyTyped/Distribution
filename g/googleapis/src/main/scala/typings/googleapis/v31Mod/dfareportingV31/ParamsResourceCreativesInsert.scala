...
object ParamsResourceCreativesInsert {
  ...
  @scala.inline
  implicit class ParamsResourceCreativesInsertOps[Self <: ParamsResourceCreativesInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreative): Self = this.set("requestBody", value.asInstanceOf[js.Any])
