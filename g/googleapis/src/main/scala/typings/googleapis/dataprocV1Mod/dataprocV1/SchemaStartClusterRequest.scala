...
trait SchemaStartClusterRequest extends StObject {
...
object SchemaStartClusterRequest {
  
  inline def apply(): SchemaStartClusterRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaStartClusterRequest]
  }
  
  extension [Self <: SchemaStartClusterRequest](x: Self) {
