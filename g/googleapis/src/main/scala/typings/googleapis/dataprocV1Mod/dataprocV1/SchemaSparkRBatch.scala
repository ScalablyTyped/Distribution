...
trait SchemaSparkRBatch extends StObject {
...
object SchemaSparkRBatch {
  
  inline def apply(): SchemaSparkRBatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSparkRBatch]
  }
  
  extension [Self <: SchemaSparkRBatch](x: Self) {
