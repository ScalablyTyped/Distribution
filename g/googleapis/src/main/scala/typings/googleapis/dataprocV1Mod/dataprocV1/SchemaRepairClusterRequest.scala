...
trait SchemaRepairClusterRequest extends StObject {
  ...
  /**
    ...
    */
  var parentOperationId: js.UndefOr[String | Null] = js.undefined
...
object SchemaRepairClusterRequest {
  
  inline def apply(): SchemaRepairClusterRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRepairClusterRequest]
  }
  
  extension [Self <: SchemaRepairClusterRequest](x: Self) {
    ...
    inline def setParentOperationIdNull: Self = StObject.set(x, "parentOperationId", null)
