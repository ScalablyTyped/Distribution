...
trait ParamsResourceProjectsRegionsAutoscalingpoliciesUpdate
  extends StObject
...
object ParamsResourceProjectsRegionsAutoscalingpoliciesUpdate {
  ...
  inline def apply(): ParamsResourceProjectsRegionsAutoscalingpoliciesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsRegionsAutoscalingpoliciesUpdate]
  }
  
  extension [Self <: ParamsResourceProjectsRegionsAutoscalingpoliciesUpdate](x: Self) {
