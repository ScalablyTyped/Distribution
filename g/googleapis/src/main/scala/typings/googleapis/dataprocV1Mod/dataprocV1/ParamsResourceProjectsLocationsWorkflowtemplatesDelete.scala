...
object ParamsResourceProjectsLocationsWorkflowtemplatesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsWorkflowtemplatesDeleteOps[Self <: ParamsResourceProjectsLocationsWorkflowtemplatesDelete] (val x: Self) extends AnyVal {
    @scala.inline
