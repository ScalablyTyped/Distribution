...
open class ResourceProjectsRegionsClusters protected () extends StObject {
  ...
  def repair(params: ParamsResourceProjectsRegionsClustersRepair): GaxiosPromise[SchemaOperation] = js.native
  def repair(
    params: ParamsResourceProjectsRegionsClustersRepair,
    callback: BodyResponseCallback[SchemaOperation]
  ): Unit = js.native
  def repair(
    params: ParamsResourceProjectsRegionsClustersRepair,
  ...
  def repair(params: ParamsResourceProjectsRegionsClustersRepair, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def repair(
    params: ParamsResourceProjectsRegionsClustersRepair,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def repair(params: ParamsResourceProjectsRegionsClustersRepair, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def repair(
    params: ParamsResourceProjectsRegionsClustersRepair,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
