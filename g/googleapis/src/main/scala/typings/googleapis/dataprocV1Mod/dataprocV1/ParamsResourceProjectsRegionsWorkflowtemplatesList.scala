...
object ParamsResourceProjectsRegionsWorkflowtemplatesList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsRegionsWorkflowtemplatesListOps[Self <: ParamsResourceProjectsRegionsWorkflowtemplatesList] (val x: Self) extends AnyVal {
