...
object ParamsResourceProjectsRegionsWorkflowtemplatesList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsRegionsWorkflowtemplatesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsRegionsWorkflowtemplatesList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsRegionsWorkflowtemplatesListMutableBuilder[Self <: ParamsResourceProjectsRegionsWorkflowtemplatesList] (val x: Self) extends AnyVal {
