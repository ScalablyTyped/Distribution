...
trait ParamsResourceProjectsLocationsBatchesList
  extends StObject
...
object ParamsResourceProjectsLocationsBatchesList {
  
  inline def apply(): ParamsResourceProjectsLocationsBatchesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsBatchesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsBatchesList](x: Self) {
