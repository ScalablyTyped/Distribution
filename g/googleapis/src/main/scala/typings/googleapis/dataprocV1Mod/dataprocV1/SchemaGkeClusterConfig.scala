...
trait SchemaGkeClusterConfig extends StObject {
  ...
  /**
    ...
    */
  var gkeClusterTarget: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var nodePoolTarget: js.UndefOr[js.Array[SchemaGkeNodePoolTarget]] = js.undefined
}
object SchemaGkeClusterConfig {
  ...
  extension [Self <: SchemaGkeClusterConfig](x: Self) {
    ...
    inline def setGkeClusterTargetNull: Self = StObject.set(x, "gkeClusterTarget", null)
    ...
    inline def setNodePoolTarget(value: js.Array[SchemaGkeNodePoolTarget]): Self = StObject.set(x, "nodePoolTarget", value.asInstanceOf[js.Any])
    
    inline def setNodePoolTargetUndefined: Self = StObject.set(x, "nodePoolTarget", js.undefined)
    
    inline def setNodePoolTargetVarargs(value: SchemaGkeNodePoolTarget*): Self = StObject.set(x, "nodePoolTarget", js.Array(value*))
  }
}
