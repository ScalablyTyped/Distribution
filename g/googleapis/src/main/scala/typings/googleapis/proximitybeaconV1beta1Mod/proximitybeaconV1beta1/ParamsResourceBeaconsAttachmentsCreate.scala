...
object ParamsResourceBeaconsAttachmentsCreate {
  ...
  inline def apply(): ParamsResourceBeaconsAttachmentsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBeaconsAttachmentsCreate]
  }
  
  extension [Self <: ParamsResourceBeaconsAttachmentsCreate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaBeaconAttachment): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
