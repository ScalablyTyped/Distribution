...
trait SchemaGoogleCloudPolicytroubleshooterV1AccessTuple extends StObject {
...
object SchemaGoogleCloudPolicytroubleshooterV1AccessTuple {
  
  inline def apply(): SchemaGoogleCloudPolicytroubleshooterV1AccessTuple = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicytroubleshooterV1AccessTuple]
  }
  
  extension [Self <: SchemaGoogleCloudPolicytroubleshooterV1AccessTuple](x: Self) {
