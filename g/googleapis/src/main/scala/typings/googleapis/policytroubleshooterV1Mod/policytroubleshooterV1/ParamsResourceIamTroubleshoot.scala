...
trait ParamsResourceIamTroubleshoot
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest] = js.undefined
}
object ParamsResourceIamTroubleshoot {
  ...
  extension [Self <: ParamsResourceIamTroubleshoot](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
