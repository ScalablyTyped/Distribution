...
trait SchemaGoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership extends StObject {
...
object SchemaGoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership {
  
  inline def apply(): SchemaGoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership]
  }
  
  extension [Self <: SchemaGoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership](x: Self) {
