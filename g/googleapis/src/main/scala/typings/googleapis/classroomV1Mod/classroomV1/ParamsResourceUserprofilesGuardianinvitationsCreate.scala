...
object ParamsResourceUserprofilesGuardianinvitationsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceUserprofilesGuardianinvitationsCreateOps[Self <: ParamsResourceUserprofilesGuardianinvitationsCreate] (val x: Self) extends AnyVal {
    @scala.inline
