...
object ParamsResourceCoursesCourseworkStudentsubmissionsReturn {
  ...
  @scala.inline
  implicit class ParamsResourceCoursesCourseworkStudentsubmissionsReturnMutableBuilder[Self <: ParamsResourceCoursesCourseworkStudentsubmissionsReturn] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaReturnStudentSubmissionRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
