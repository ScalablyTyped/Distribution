...
object ParamsResourceCoursesTopicsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceCoursesTopicsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCoursesTopicsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceCoursesTopicsGetMutableBuilder[Self <: ParamsResourceCoursesTopicsGet] (val x: Self) extends AnyVal {
