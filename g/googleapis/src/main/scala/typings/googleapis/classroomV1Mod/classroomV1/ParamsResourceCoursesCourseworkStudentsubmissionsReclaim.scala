...
object ParamsResourceCoursesCourseworkStudentsubmissionsReclaim {
  ...
  @scala.inline
  implicit class ParamsResourceCoursesCourseworkStudentsubmissionsReclaimOps[Self <: ParamsResourceCoursesCourseworkStudentsubmissionsReclaim] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaReclaimStudentSubmissionRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
