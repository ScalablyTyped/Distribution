...
object ParamsResourceCoursesCourseworkStudentsubmissionsModifyattachments {
  ...
  inline def apply(): ParamsResourceCoursesCourseworkStudentsubmissionsModifyattachments = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCoursesCourseworkStudentsubmissionsModifyattachments]
  }
  
  extension [Self <: ParamsResourceCoursesCourseworkStudentsubmissionsModifyattachments](x: Self) {
    ...
    inline def setRequestBody(value: SchemaModifyAttachmentsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
