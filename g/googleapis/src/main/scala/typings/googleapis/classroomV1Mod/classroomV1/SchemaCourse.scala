...
/**
  ...
  */
@js.native
trait SchemaCourse extends js.Object {
  /**
  ...
  /**
    ...
    * course.  Read-only.
    */
  var courseMaterialSets: js.UndefOr[js.Array[SchemaCourseMaterialSet]] = js.native
  /**
  ...
  /**
    ...
    */
  var teacherFolder: js.UndefOr[SchemaDriveFolder] = js.native
  /**
...
object SchemaCourse {
  ...
  @scala.inline
  implicit class SchemaCourseOps[Self <: SchemaCourse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setCourseMaterialSetsVarargs(value: SchemaCourseMaterialSet*): Self = this.set("courseMaterialSets", js.Array(value :_*))
    @scala.inline
    def setCourseMaterialSets(value: js.Array[SchemaCourseMaterialSet]): Self = this.set("courseMaterialSets", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTeacherFolder(value: SchemaDriveFolder): Self = this.set("teacherFolder", value.asInstanceOf[js.Any])
    @scala.inline
