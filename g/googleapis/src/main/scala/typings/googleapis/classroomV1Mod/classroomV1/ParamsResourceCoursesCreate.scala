...
@js.native
trait ParamsResourceCoursesCreate extends StandardParameters {
...
object ParamsResourceCoursesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceCoursesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCoursesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceCoursesCreateOps[Self <: ParamsResourceCoursesCreate] (val x: Self) extends AnyVal {
