...
@js.native
trait ParamsResourceCoursesCourseworkCreate extends StandardParameters {
  /**
...
object ParamsResourceCoursesCourseworkCreate {
  ...
  @scala.inline
  implicit class ParamsResourceCoursesCourseworkCreateOps[Self <: ParamsResourceCoursesCourseworkCreate] (val x: Self) extends AnyVal {
    @scala.inline
