...
object ParamsResourceCoursesAnnouncementsList {
  ...
  def apply(
    ...
    alt: String = null,
    announcementStates: js.Array[String] = null,
  ...
  ): ParamsResourceCoursesAnnouncementsList = {
    val __obj = js.Dynamic.literal()
    if ($Dotxgafv != null) __obj.updateDynamic("$.xgafv")($Dotxgafv.asInstanceOf[js.Any])
    if (access_token != null) __obj.updateDynamic("access_token")(access_token.asInstanceOf[js.Any])
    if (alt != null) __obj.updateDynamic("alt")(alt.asInstanceOf[js.Any])
    if (announcementStates != null) __obj.updateDynamic("announcementStates")(announcementStates.asInstanceOf[js.Any])
