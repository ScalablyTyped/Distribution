...
object ParamsResourceCoursesAnnouncementsList {
  ...
  @scala.inline
  implicit class ParamsResourceCoursesAnnouncementsListOps[Self <: ParamsResourceCoursesAnnouncementsList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnnouncementStatesVarargs(value: String*): Self = this.set("announcementStates", js.Array(value :_*))
    
    @scala.inline
    def setAnnouncementStates(value: js.Array[String]): Self = this.set("announcementStates", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAnnouncementStates: Self = this.set("announcementStates", js.undefined)
