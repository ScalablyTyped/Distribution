...
trait ParamsResourceCoursesAnnouncementsList
  extends StObject
...
object ParamsResourceCoursesAnnouncementsList {
  ...
  inline def apply(): ParamsResourceCoursesAnnouncementsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCoursesAnnouncementsList]
  }
  
  extension [Self <: ParamsResourceCoursesAnnouncementsList](x: Self) {
    
    inline def setAnnouncementStates(value: js.Array[String]): Self = StObject.set(x, "announcementStates", value.asInstanceOf[js.Any])
