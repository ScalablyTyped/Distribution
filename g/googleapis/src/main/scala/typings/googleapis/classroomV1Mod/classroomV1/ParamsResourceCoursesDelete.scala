...
object ParamsResourceCoursesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceCoursesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCoursesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceCoursesDeleteMutableBuilder[Self <: ParamsResourceCoursesDelete] (val x: Self) extends AnyVal {
