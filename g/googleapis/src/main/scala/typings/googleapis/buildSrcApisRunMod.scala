...
import typings.googleapis.buildSrcApisRunV1Mod.run_v1.Options
import typings.googleapis.buildSrcApisRunV1Mod.run_v1.Run
...
@js.native
object buildSrcApisRunMod extends js.Object {
  def run(options: Options): Run = js.native
  def run(options: typings.googleapis.buildSrcApisRunV1alpha1Mod.run_v1alpha1.Options): typings.googleapis.buildSrcApisRunV1alpha1Mod.run_v1alpha1.Run = js.native
  @JSName("run")
  def run_v1(version: v1): Run = js.native
  @JSName("run")
  def run_v1alpha1(version: v1alpha1): typings.googleapis.buildSrcApisRunV1alpha1Mod.run_v1alpha1.Run = js.native
  @js.native
    ...
    object v1alpha1
      extends TopLevel[
              Instantiable2[
                ...
                typings.googleapis.buildSrcApisRunV1alpha1Mod.run_v1alpha1.Run
              ]
            ]
