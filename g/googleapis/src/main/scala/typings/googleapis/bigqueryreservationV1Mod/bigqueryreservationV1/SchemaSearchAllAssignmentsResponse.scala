...
trait SchemaSearchAllAssignmentsResponse extends StObject {
...
object SchemaSearchAllAssignmentsResponse {
  
  inline def apply(): SchemaSearchAllAssignmentsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSearchAllAssignmentsResponse]
  }
  
  extension [Self <: SchemaSearchAllAssignmentsResponse](x: Self) {
