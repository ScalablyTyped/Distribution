...
trait SchemaListAssignmentsResponse extends StObject {
...
object SchemaListAssignmentsResponse {
  
  inline def apply(): SchemaListAssignmentsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaListAssignmentsResponse]
  }
  
  extension [Self <: SchemaListAssignmentsResponse](x: Self) {
