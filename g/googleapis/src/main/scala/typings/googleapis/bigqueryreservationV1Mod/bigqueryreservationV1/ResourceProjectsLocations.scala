...
@JSImport("googleapis/build/src/apis/bigqueryreservation/v1", "bigqueryreservation_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  def searchAllAssignments(): GaxiosPromise[SchemaSearchAllAssignmentsResponse] = js.native
  def searchAllAssignments(callback: BodyResponseCallback[SchemaSearchAllAssignmentsResponse]): Unit = js.native
  def searchAllAssignments(params: Unit, options: MethodOptions): GaxiosPromise[SchemaSearchAllAssignmentsResponse] = js.native
  def searchAllAssignments(params: ParamsResourceProjectsLocationsSearchallassignments): GaxiosPromise[SchemaSearchAllAssignmentsResponse] = js.native
  def searchAllAssignments(
    params: ParamsResourceProjectsLocationsSearchallassignments,
    callback: BodyResponseCallback[SchemaSearchAllAssignmentsResponse]
  ): Unit = js.native
  def searchAllAssignments(
    params: ParamsResourceProjectsLocationsSearchallassignments,
    options: BodyResponseCallback[Readable | SchemaSearchAllAssignmentsResponse],
    callback: BodyResponseCallback[Readable | SchemaSearchAllAssignmentsResponse]
  ): Unit = js.native
  def searchAllAssignments(params: ParamsResourceProjectsLocationsSearchallassignments, options: MethodOptions): GaxiosPromise[SchemaSearchAllAssignmentsResponse] = js.native
  def searchAllAssignments(
    params: ParamsResourceProjectsLocationsSearchallassignments,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaSearchAllAssignmentsResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def searchAllAssignments(params: ParamsResourceProjectsLocationsSearchallassignments, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def searchAllAssignments(
    params: ParamsResourceProjectsLocationsSearchallassignments,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
