...
trait SchemaGoogleCloudRetailV2CustomAttribute extends StObject {
...
object SchemaGoogleCloudRetailV2CustomAttribute {
  
  inline def apply(): SchemaGoogleCloudRetailV2CustomAttribute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2CustomAttribute]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2CustomAttribute](x: Self) {
