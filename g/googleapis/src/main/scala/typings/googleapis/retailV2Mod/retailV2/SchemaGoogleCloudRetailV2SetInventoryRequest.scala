...
trait SchemaGoogleCloudRetailV2SetInventoryRequest extends StObject {
  ...
  /**
    ...
    */
  var inventory: js.UndefOr[SchemaGoogleCloudRetailV2Product] = js.undefined
...
object SchemaGoogleCloudRetailV2SetInventoryRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2SetInventoryRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2SetInventoryRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2SetInventoryRequest](x: Self) {
    ...
    inline def setInventory(value: SchemaGoogleCloudRetailV2Product): Self = StObject.set(x, "inventory", value.asInstanceOf[js.Any])
