...
@JSImport("googleapis/build/src/apis/retail/v2", "retail_v2.Resource$Projects$Locations$Catalogs$Branches$Products")
@js.native
open class ResourceProjectsLocationsCatalogsBranchesProducts protected () extends StObject {
  ...
  def create(): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def create(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2Product]): Unit = js.native
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def create(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsCreate): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def create(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsCreate,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2Product]
  ): Unit = js.native
  def create(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsCreate,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2Product],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2Product]
  ): Unit = js.native
  def create(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def create(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsCreate,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2Product]
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2Product]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def get(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsGet): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def get(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2Product]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudRetailV2ListProductsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2ListProductsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2ListProductsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsList): GaxiosPromise[SchemaGoogleCloudRetailV2ListProductsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsList,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2ListProductsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2ListProductsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2ListProductsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2ListProductsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2ListProductsResponse]
  ...
  def patch(): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2Product]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def patch(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPatch): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2Product] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2Product]
