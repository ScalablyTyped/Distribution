...
trait SchemaGoogleCloudRetailV2GcsSource extends StObject {
...
object SchemaGoogleCloudRetailV2GcsSource {
  
  inline def apply(): SchemaGoogleCloudRetailV2GcsSource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2GcsSource]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2GcsSource](x: Self) {
