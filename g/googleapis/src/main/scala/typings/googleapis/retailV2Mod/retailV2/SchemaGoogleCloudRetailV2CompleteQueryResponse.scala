...
trait SchemaGoogleCloudRetailV2CompleteQueryResponse extends StObject {
  ...
  /**
    ...
    */
  var completionResults: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2CompleteQueryResponseCompletionResult]] = js.undefined
  ...
  /**
    ...
    */
  var recentSearchResults: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2CompleteQueryResponseRecentSearchResult]] = js.undefined
}
object SchemaGoogleCloudRetailV2CompleteQueryResponse {
  
  inline def apply(): SchemaGoogleCloudRetailV2CompleteQueryResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2CompleteQueryResponse]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2CompleteQueryResponse](x: Self) {
    ...
    inline def setCompletionResults(value: js.Array[SchemaGoogleCloudRetailV2CompleteQueryResponseCompletionResult]): Self = StObject.set(x, "completionResults", value.asInstanceOf[js.Any])
    
    inline def setCompletionResultsUndefined: Self = StObject.set(x, "completionResults", js.undefined)
    
    inline def setCompletionResultsVarargs(value: SchemaGoogleCloudRetailV2CompleteQueryResponseCompletionResult*): Self = StObject.set(x, "completionResults", js.Array(value*))
    
    inline def setRecentSearchResults(value: js.Array[SchemaGoogleCloudRetailV2CompleteQueryResponseRecentSearchResult]): Self = StObject.set(x, "recentSearchResults", value.asInstanceOf[js.Any])
    
    inline def setRecentSearchResultsUndefined: Self = StObject.set(x, "recentSearchResults", js.undefined)
    
    inline def setRecentSearchResultsVarargs(value: SchemaGoogleCloudRetailV2CompleteQueryResponseRecentSearchResult*): Self = StObject.set(x, "recentSearchResults", js.Array(value*))
  }
}
