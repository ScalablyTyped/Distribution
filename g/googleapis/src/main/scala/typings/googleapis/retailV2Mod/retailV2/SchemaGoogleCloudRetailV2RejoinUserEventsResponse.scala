...
trait SchemaGoogleCloudRetailV2RejoinUserEventsResponse extends StObject {
...
object SchemaGoogleCloudRetailV2RejoinUserEventsResponse {
  
  inline def apply(): SchemaGoogleCloudRetailV2RejoinUserEventsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2RejoinUserEventsResponse]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2RejoinUserEventsResponse](x: Self) {
