...
@JSImport("googleapis/build/src/apis/retail/v2", "retail_v2.Resource$Projects$Locations$Catalogs$Userevents")
@js.native
open class ResourceProjectsLocationsCatalogsUserevents protected () extends StObject {
  ...
  def write(): GaxiosPromise[SchemaGoogleCloudRetailV2UserEvent] = js.native
  def write(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2UserEvent]): Unit = js.native
  def write(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2UserEvent] = js.native
  def write(params: ParamsResourceProjectsLocationsCatalogsUsereventsWrite): GaxiosPromise[SchemaGoogleCloudRetailV2UserEvent] = js.native
  def write(
    params: ParamsResourceProjectsLocationsCatalogsUsereventsWrite,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2UserEvent]
  ): Unit = js.native
  def write(
    params: ParamsResourceProjectsLocationsCatalogsUsereventsWrite,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2UserEvent],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2UserEvent]
  ): Unit = js.native
  def write(params: ParamsResourceProjectsLocationsCatalogsUsereventsWrite, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2UserEvent] = js.native
  def write(
    params: ParamsResourceProjectsLocationsCatalogsUsereventsWrite,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2UserEvent]
