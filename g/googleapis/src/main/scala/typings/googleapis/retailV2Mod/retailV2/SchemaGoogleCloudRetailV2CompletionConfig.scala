...
trait SchemaGoogleCloudRetailV2CompletionConfig extends StObject {
  
  /**
    * Output only. The source data for the latest import of the autocomplete allowlist phrases.
    */
  var allowlistInputConfig: js.UndefOr[SchemaGoogleCloudRetailV2CompletionDataInputConfig] = js.undefined
  ...
  /**
    ...
    */
  var denylistInputConfig: js.UndefOr[SchemaGoogleCloudRetailV2CompletionDataInputConfig] = js.undefined
  ...
  /**
    ...
    */
  var suggestionsInputConfig: js.UndefOr[SchemaGoogleCloudRetailV2CompletionDataInputConfig] = js.undefined
}
object SchemaGoogleCloudRetailV2CompletionConfig {
  
  inline def apply(): SchemaGoogleCloudRetailV2CompletionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2CompletionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2CompletionConfig](x: Self) {
    
    inline def setAllowlistInputConfig(value: SchemaGoogleCloudRetailV2CompletionDataInputConfig): Self = StObject.set(x, "allowlistInputConfig", value.asInstanceOf[js.Any])
    ...
    inline def setDenylistInputConfig(value: SchemaGoogleCloudRetailV2CompletionDataInputConfig): Self = StObject.set(x, "denylistInputConfig", value.asInstanceOf[js.Any])
    ...
    inline def setSuggestionsInputConfig(value: SchemaGoogleCloudRetailV2CompletionDataInputConfig): Self = StObject.set(x, "suggestionsInputConfig", value.asInstanceOf[js.Any])
