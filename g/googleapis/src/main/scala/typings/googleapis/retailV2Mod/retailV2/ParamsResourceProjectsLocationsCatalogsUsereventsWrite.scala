...
trait ParamsResourceProjectsLocationsCatalogsUsereventsWrite
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2UserEvent] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsUsereventsWrite {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsUsereventsWrite](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2UserEvent): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
