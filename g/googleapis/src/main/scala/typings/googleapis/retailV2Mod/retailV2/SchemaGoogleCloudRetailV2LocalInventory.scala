...
trait SchemaGoogleCloudRetailV2LocalInventory extends StObject {
...
object SchemaGoogleCloudRetailV2LocalInventory {
  
  inline def apply(): SchemaGoogleCloudRetailV2LocalInventory = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2LocalInventory]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2LocalInventory](x: Self) {
