...
trait SchemaGoogleCloudRetailV2UserEvent extends StObject {
  ...
  /**
    ...
    */
  var completionDetail: js.UndefOr[SchemaGoogleCloudRetailV2CompletionDetail] = js.undefined
  ...
  /**
    ...
    */
  var productDetails: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2ProductDetail]] = js.undefined
  ...
  /**
    ...
    */
  var purchaseTransaction: js.UndefOr[SchemaGoogleCloudRetailV2PurchaseTransaction] = js.undefined
...
object SchemaGoogleCloudRetailV2UserEvent {
  
  inline def apply(): SchemaGoogleCloudRetailV2UserEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2UserEvent]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2UserEvent](x: Self) {
    ...
    inline def setCompletionDetail(value: SchemaGoogleCloudRetailV2CompletionDetail): Self = StObject.set(x, "completionDetail", value.asInstanceOf[js.Any])
    ...
    inline def setProductDetails(value: js.Array[SchemaGoogleCloudRetailV2ProductDetail]): Self = StObject.set(x, "productDetails", value.asInstanceOf[js.Any])
    
    inline def setProductDetailsUndefined: Self = StObject.set(x, "productDetails", js.undefined)
    
    inline def setProductDetailsVarargs(value: SchemaGoogleCloudRetailV2ProductDetail*): Self = StObject.set(x, "productDetails", js.Array(value*))
    
    inline def setPurchaseTransaction(value: SchemaGoogleCloudRetailV2PurchaseTransaction): Self = StObject.set(x, "purchaseTransaction", value.asInstanceOf[js.Any])
