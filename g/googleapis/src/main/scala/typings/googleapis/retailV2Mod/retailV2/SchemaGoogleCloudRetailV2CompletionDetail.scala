...
trait SchemaGoogleCloudRetailV2CompletionDetail extends StObject {
...
object SchemaGoogleCloudRetailV2CompletionDetail {
  
  inline def apply(): SchemaGoogleCloudRetailV2CompletionDetail = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2CompletionDetail]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2CompletionDetail](x: Self) {
