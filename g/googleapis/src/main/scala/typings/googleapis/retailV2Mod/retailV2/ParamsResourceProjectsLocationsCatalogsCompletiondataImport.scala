...
trait ParamsResourceProjectsLocationsCatalogsCompletiondataImport
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2ImportCompletionDataRequest] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsCompletiondataImport {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsCompletiondataImport](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2ImportCompletionDataRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
