...
trait SchemaGoogleCloudRetailV2Audience extends StObject {
...
object SchemaGoogleCloudRetailV2Audience {
  
  inline def apply(): SchemaGoogleCloudRetailV2Audience = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2Audience]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2Audience](x: Self) {
