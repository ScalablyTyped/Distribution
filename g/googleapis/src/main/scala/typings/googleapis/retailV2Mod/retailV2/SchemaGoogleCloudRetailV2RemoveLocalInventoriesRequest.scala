...
trait SchemaGoogleCloudRetailV2RemoveLocalInventoriesRequest extends StObject {
...
object SchemaGoogleCloudRetailV2RemoveLocalInventoriesRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2RemoveLocalInventoriesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2RemoveLocalInventoriesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2RemoveLocalInventoriesRequest](x: Self) {
