...
@JSImport("googleapis/build/src/apis/retail/v2", "retail_v2.Resource$Projects$Locations$Catalogs")
@js.native
open class ResourceProjectsLocationsCatalogs protected () extends StObject {
  ...
  def completeQuery(): GaxiosPromise[SchemaGoogleCloudRetailV2CompleteQueryResponse] = js.native
  def completeQuery(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2CompleteQueryResponse]): Unit = js.native
  def completeQuery(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2CompleteQueryResponse] = js.native
  def completeQuery(params: ParamsResourceProjectsLocationsCatalogsCompletequery): GaxiosPromise[SchemaGoogleCloudRetailV2CompleteQueryResponse] = js.native
  def completeQuery(
    params: ParamsResourceProjectsLocationsCatalogsCompletequery,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2CompleteQueryResponse]
  ): Unit = js.native
  def completeQuery(
    params: ParamsResourceProjectsLocationsCatalogsCompletequery,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2CompleteQueryResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2CompleteQueryResponse]
  ): Unit = js.native
  def completeQuery(params: ParamsResourceProjectsLocationsCatalogsCompletequery, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2CompleteQueryResponse] = js.native
  def completeQuery(
    params: ParamsResourceProjectsLocationsCatalogsCompletequery,
  ...
  def getAttributesConfig(): GaxiosPromise[SchemaGoogleCloudRetailV2AttributesConfig] = js.native
  def getAttributesConfig(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2AttributesConfig]): Unit = js.native
  def getAttributesConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2AttributesConfig] = js.native
  def getAttributesConfig(params: ParamsResourceProjectsLocationsCatalogsGetattributesconfig): GaxiosPromise[SchemaGoogleCloudRetailV2AttributesConfig] = js.native
  ...
  def getAttributesConfig(params: ParamsResourceProjectsLocationsCatalogsGetattributesconfig, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2AttributesConfig] = js.native
  def getAttributesConfig(
    params: ParamsResourceProjectsLocationsCatalogsGetattributesconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2AttributesConfig]
  ...
  def getCompletionConfig(): GaxiosPromise[SchemaGoogleCloudRetailV2CompletionConfig] = js.native
  def getCompletionConfig(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2CompletionConfig]): Unit = js.native
  def getCompletionConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2CompletionConfig] = js.native
  def getCompletionConfig(params: ParamsResourceProjectsLocationsCatalogsGetcompletionconfig): GaxiosPromise[SchemaGoogleCloudRetailV2CompletionConfig] = js.native
  def getCompletionConfig(
    params: ParamsResourceProjectsLocationsCatalogsGetcompletionconfig,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2CompletionConfig]
  ): Unit = js.native
  def getCompletionConfig(
    params: ParamsResourceProjectsLocationsCatalogsGetcompletionconfig,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2CompletionConfig],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2CompletionConfig]
  ): Unit = js.native
  def getCompletionConfig(params: ParamsResourceProjectsLocationsCatalogsGetcompletionconfig, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2CompletionConfig] = js.native
  def getCompletionConfig(
    params: ParamsResourceProjectsLocationsCatalogsGetcompletionconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2CompletionConfig]
  ...
  def getDefaultBranch(): GaxiosPromise[SchemaGoogleCloudRetailV2GetDefaultBranchResponse] = js.native
  def getDefaultBranch(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2GetDefaultBranchResponse]): Unit = js.native
  def getDefaultBranch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2GetDefaultBranchResponse] = js.native
  def getDefaultBranch(params: ParamsResourceProjectsLocationsCatalogsGetdefaultbranch): GaxiosPromise[SchemaGoogleCloudRetailV2GetDefaultBranchResponse] = js.native
  def getDefaultBranch(
    params: ParamsResourceProjectsLocationsCatalogsGetdefaultbranch,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2GetDefaultBranchResponse]
  ): Unit = js.native
  def getDefaultBranch(
    params: ParamsResourceProjectsLocationsCatalogsGetdefaultbranch,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2GetDefaultBranchResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2GetDefaultBranchResponse]
  ): Unit = js.native
  def getDefaultBranch(params: ParamsResourceProjectsLocationsCatalogsGetdefaultbranch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2GetDefaultBranchResponse] = js.native
  def getDefaultBranch(
    params: ParamsResourceProjectsLocationsCatalogsGetdefaultbranch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2GetDefaultBranchResponse]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudRetailV2ListCatalogsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2ListCatalogsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2ListCatalogsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsCatalogsList): GaxiosPromise[SchemaGoogleCloudRetailV2ListCatalogsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsList,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2ListCatalogsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2ListCatalogsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2ListCatalogsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsCatalogsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2ListCatalogsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2ListCatalogsResponse]
  ...
  def patch(): GaxiosPromise[SchemaGoogleCloudRetailV2Catalog] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2Catalog]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2Catalog] = js.native
  def patch(params: ParamsResourceProjectsLocationsCatalogsPatch): GaxiosPromise[SchemaGoogleCloudRetailV2Catalog] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsCatalogsPatch,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2Catalog]
  ): Unit = js.native
  def patch(
    params: ParamsResourceProjectsLocationsCatalogsPatch,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2Catalog],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2Catalog]
  ): Unit = js.native
  def patch(params: ParamsResourceProjectsLocationsCatalogsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2Catalog] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsCatalogsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2Catalog]
  ...
  def updateAttributesConfig(): GaxiosPromise[SchemaGoogleCloudRetailV2AttributesConfig] = js.native
  def updateAttributesConfig(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2AttributesConfig]): Unit = js.native
  def updateAttributesConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2AttributesConfig] = js.native
  def updateAttributesConfig(params: ParamsResourceProjectsLocationsCatalogsUpdateattributesconfig): GaxiosPromise[SchemaGoogleCloudRetailV2AttributesConfig] = js.native
  ...
  def updateAttributesConfig(params: ParamsResourceProjectsLocationsCatalogsUpdateattributesconfig, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2AttributesConfig] = js.native
  def updateAttributesConfig(
    params: ParamsResourceProjectsLocationsCatalogsUpdateattributesconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2AttributesConfig]
  ...
  def updateCompletionConfig(): GaxiosPromise[SchemaGoogleCloudRetailV2CompletionConfig] = js.native
  def updateCompletionConfig(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2CompletionConfig]): Unit = js.native
  def updateCompletionConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2CompletionConfig] = js.native
  def updateCompletionConfig(params: ParamsResourceProjectsLocationsCatalogsUpdatecompletionconfig): GaxiosPromise[SchemaGoogleCloudRetailV2CompletionConfig] = js.native
  ...
  def updateCompletionConfig(params: ParamsResourceProjectsLocationsCatalogsUpdatecompletionconfig, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2CompletionConfig] = js.native
  def updateCompletionConfig(
    params: ParamsResourceProjectsLocationsCatalogsUpdatecompletionconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2CompletionConfig]
