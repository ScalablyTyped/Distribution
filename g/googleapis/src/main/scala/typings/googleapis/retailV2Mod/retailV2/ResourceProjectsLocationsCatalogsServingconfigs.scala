...
@JSImport("googleapis/build/src/apis/retail/v2", "retail_v2.Resource$Projects$Locations$Catalogs$Servingconfigs")
@js.native
open class ResourceProjectsLocationsCatalogsServingconfigs protected () extends StObject {
  ...
  def predict(params: ParamsResourceProjectsLocationsCatalogsServingconfigsPredict): GaxiosPromise[SchemaGoogleCloudRetailV2PredictResponse] = js.native
  def predict(
  ...
  def predict(params: ParamsResourceProjectsLocationsCatalogsServingconfigsPredict, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2PredictResponse] = js.native
  def predict(
    params: ParamsResourceProjectsLocationsCatalogsServingconfigsPredict,
  ...
  def search(params: ParamsResourceProjectsLocationsCatalogsServingconfigsSearch): GaxiosPromise[SchemaGoogleCloudRetailV2SearchResponse] = js.native
  def search(
  ...
  def search(params: ParamsResourceProjectsLocationsCatalogsServingconfigsSearch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2SearchResponse] = js.native
  def search(
    params: ParamsResourceProjectsLocationsCatalogsServingconfigsSearch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2SearchResponse]
