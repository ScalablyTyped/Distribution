...
trait SchemaGoogleCloudRetailV2SearchRequestFacetSpecFacetKey extends StObject {
  ...
  /**
    ...
    */
  var intervals: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2Interval]] = js.undefined
...
object SchemaGoogleCloudRetailV2SearchRequestFacetSpecFacetKey {
  
  inline def apply(): SchemaGoogleCloudRetailV2SearchRequestFacetSpecFacetKey = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2SearchRequestFacetSpecFacetKey]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2SearchRequestFacetSpecFacetKey](x: Self) {
    ...
    inline def setIntervals(value: js.Array[SchemaGoogleCloudRetailV2Interval]): Self = StObject.set(x, "intervals", value.asInstanceOf[js.Any])
    
    inline def setIntervalsUndefined: Self = StObject.set(x, "intervals", js.undefined)
    
    inline def setIntervalsVarargs(value: SchemaGoogleCloudRetailV2Interval*): Self = StObject.set(x, "intervals", js.Array(value*))
