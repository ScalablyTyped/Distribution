...
trait SchemaGoogleCloudRetailV2AddLocalInventoriesRequest extends StObject {
  ...
  /**
    ...
    */
  var localInventories: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2LocalInventory]] = js.undefined
}
object SchemaGoogleCloudRetailV2AddLocalInventoriesRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2AddLocalInventoriesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2AddLocalInventoriesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2AddLocalInventoriesRequest](x: Self) {
    ...
    inline def setLocalInventories(value: js.Array[SchemaGoogleCloudRetailV2LocalInventory]): Self = StObject.set(x, "localInventories", value.asInstanceOf[js.Any])
    
    inline def setLocalInventoriesUndefined: Self = StObject.set(x, "localInventories", js.undefined)
    
    inline def setLocalInventoriesVarargs(value: SchemaGoogleCloudRetailV2LocalInventory*): Self = StObject.set(x, "localInventories", js.Array(value*))
  }
}
