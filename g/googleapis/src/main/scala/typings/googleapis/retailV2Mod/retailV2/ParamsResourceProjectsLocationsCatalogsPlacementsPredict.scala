...
trait ParamsResourceProjectsLocationsCatalogsPlacementsPredict
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2PredictRequest] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsPlacementsPredict {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsPlacementsPredict](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2PredictRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
