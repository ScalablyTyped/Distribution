...
trait SchemaGoogleCloudRetailV2BigQuerySource extends StObject {
...
object SchemaGoogleCloudRetailV2BigQuerySource {
  
  inline def apply(): SchemaGoogleCloudRetailV2BigQuerySource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2BigQuerySource]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2BigQuerySource](x: Self) {
