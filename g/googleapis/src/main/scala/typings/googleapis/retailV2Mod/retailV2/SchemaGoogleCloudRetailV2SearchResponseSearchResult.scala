...
trait SchemaGoogleCloudRetailV2SearchResponseSearchResult extends StObject {
...
object SchemaGoogleCloudRetailV2SearchResponseSearchResult {
  
  inline def apply(): SchemaGoogleCloudRetailV2SearchResponseSearchResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2SearchResponseSearchResult]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2SearchResponseSearchResult](x: Self) {
