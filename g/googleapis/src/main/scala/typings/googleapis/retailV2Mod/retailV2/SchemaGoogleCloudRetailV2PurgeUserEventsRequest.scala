...
trait SchemaGoogleCloudRetailV2PurgeUserEventsRequest extends StObject {
...
object SchemaGoogleCloudRetailV2PurgeUserEventsRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2PurgeUserEventsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2PurgeUserEventsRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2PurgeUserEventsRequest](x: Self) {
