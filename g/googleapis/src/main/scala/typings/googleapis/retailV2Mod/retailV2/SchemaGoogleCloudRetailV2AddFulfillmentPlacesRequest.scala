...
trait SchemaGoogleCloudRetailV2AddFulfillmentPlacesRequest extends StObject {
...
object SchemaGoogleCloudRetailV2AddFulfillmentPlacesRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2AddFulfillmentPlacesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2AddFulfillmentPlacesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2AddFulfillmentPlacesRequest](x: Self) {
