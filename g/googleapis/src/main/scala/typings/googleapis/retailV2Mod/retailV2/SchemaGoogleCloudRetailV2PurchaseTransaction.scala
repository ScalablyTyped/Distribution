...
trait SchemaGoogleCloudRetailV2PurchaseTransaction extends StObject {
...
object SchemaGoogleCloudRetailV2PurchaseTransaction {
  
  inline def apply(): SchemaGoogleCloudRetailV2PurchaseTransaction = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2PurchaseTransaction]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2PurchaseTransaction](x: Self) {
