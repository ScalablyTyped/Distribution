...
trait SchemaGoogleCloudRetailV2SetDefaultBranchRequest extends StObject {
...
object SchemaGoogleCloudRetailV2SetDefaultBranchRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2SetDefaultBranchRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2SetDefaultBranchRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2SetDefaultBranchRequest](x: Self) {
