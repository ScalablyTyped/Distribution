...
trait SchemaGoogleCloudRetailV2CatalogAttribute extends StObject {
...
object SchemaGoogleCloudRetailV2CatalogAttribute {
  
  inline def apply(): SchemaGoogleCloudRetailV2CatalogAttribute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2CatalogAttribute]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2CatalogAttribute](x: Self) {
