...
trait SchemaGoogleCloudRetailV2Interval extends StObject {
...
object SchemaGoogleCloudRetailV2Interval {
  
  inline def apply(): SchemaGoogleCloudRetailV2Interval = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2Interval]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2Interval](x: Self) {
