...
trait SchemaGoogleCloudRetailV2PredictResponsePredictionResult extends StObject {
...
object SchemaGoogleCloudRetailV2PredictResponsePredictionResult {
  
  inline def apply(): SchemaGoogleCloudRetailV2PredictResponsePredictionResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2PredictResponsePredictionResult]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2PredictResponsePredictionResult](x: Self) {
