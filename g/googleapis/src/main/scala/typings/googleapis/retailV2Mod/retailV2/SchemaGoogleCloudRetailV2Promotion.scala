...
trait SchemaGoogleCloudRetailV2Promotion extends StObject {
...
object SchemaGoogleCloudRetailV2Promotion {
  
  inline def apply(): SchemaGoogleCloudRetailV2Promotion = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2Promotion]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2Promotion](x: Self) {
