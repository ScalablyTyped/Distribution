...
trait SchemaGoogleCloudRetailV2RemoveFulfillmentPlacesRequest extends StObject {
...
object SchemaGoogleCloudRetailV2RemoveFulfillmentPlacesRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2RemoveFulfillmentPlacesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2RemoveFulfillmentPlacesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2RemoveFulfillmentPlacesRequest](x: Self) {
