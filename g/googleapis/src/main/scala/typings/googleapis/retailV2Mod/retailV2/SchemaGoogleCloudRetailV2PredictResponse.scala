...
trait SchemaGoogleCloudRetailV2PredictResponse extends StObject {
  ...
  /**
    ...
    */
  var results: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2PredictResponsePredictionResult]] = js.undefined
...
object SchemaGoogleCloudRetailV2PredictResponse {
  
  inline def apply(): SchemaGoogleCloudRetailV2PredictResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2PredictResponse]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2PredictResponse](x: Self) {
    ...
    inline def setResults(value: js.Array[SchemaGoogleCloudRetailV2PredictResponsePredictionResult]): Self = StObject.set(x, "results", value.asInstanceOf[js.Any])
    
    inline def setResultsUndefined: Self = StObject.set(x, "results", js.undefined)
    
    inline def setResultsVarargs(value: SchemaGoogleCloudRetailV2PredictResponsePredictionResult*): Self = StObject.set(x, "results", js.Array(value*))
