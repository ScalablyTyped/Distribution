...
trait ParamsResourceProjectsLocationsCatalogsPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2Catalog] = js.undefined
...
object ParamsResourceProjectsLocationsCatalogsPatch {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2Catalog): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
