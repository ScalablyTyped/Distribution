...
trait SchemaGoogleCloudRetailV2SearchRequestBoostSpecConditionBoostSpec extends StObject {
...
object SchemaGoogleCloudRetailV2SearchRequestBoostSpecConditionBoostSpec {
  
  inline def apply(): SchemaGoogleCloudRetailV2SearchRequestBoostSpecConditionBoostSpec = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2SearchRequestBoostSpecConditionBoostSpec]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2SearchRequestBoostSpecConditionBoostSpec](x: Self) {
