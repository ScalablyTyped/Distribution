...
trait SchemaGoogleCloudRetailV2PredictRequest extends StObject {
  ...
  /**
    ...
    */
  var userEvent: js.UndefOr[SchemaGoogleCloudRetailV2UserEvent] = js.undefined
...
object SchemaGoogleCloudRetailV2PredictRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2PredictRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2PredictRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2PredictRequest](x: Self) {
    ...
    inline def setUserEvent(value: SchemaGoogleCloudRetailV2UserEvent): Self = StObject.set(x, "userEvent", value.asInstanceOf[js.Any])
