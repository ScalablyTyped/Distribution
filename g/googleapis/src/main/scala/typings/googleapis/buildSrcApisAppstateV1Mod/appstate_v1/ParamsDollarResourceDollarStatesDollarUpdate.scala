...
@js.native
trait ParamsDollarResourceDollarStatesDollarUpdate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$UpdateRequest] = js.native
  /**
...
object ParamsDollarResourceDollarStatesDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$UpdateRequest = null,
    stateKey: Int | Double = null,
    userIp: String = null
  ): ParamsDollarResourceDollarStatesDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarStatesDollarUpdate]
  }
}
