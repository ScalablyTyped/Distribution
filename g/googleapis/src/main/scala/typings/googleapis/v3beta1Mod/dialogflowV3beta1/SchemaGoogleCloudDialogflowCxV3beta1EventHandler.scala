...
trait SchemaGoogleCloudDialogflowCxV3beta1EventHandler extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1EventHandler {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1EventHandler = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1EventHandler]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1EventHandler](x: Self) {
