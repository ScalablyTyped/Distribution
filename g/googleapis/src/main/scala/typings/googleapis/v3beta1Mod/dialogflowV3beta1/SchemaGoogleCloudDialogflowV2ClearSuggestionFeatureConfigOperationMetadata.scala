...
trait SchemaGoogleCloudDialogflowV2ClearSuggestionFeatureConfigOperationMetadata extends StObject {
...
object SchemaGoogleCloudDialogflowV2ClearSuggestionFeatureConfigOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2ClearSuggestionFeatureConfigOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2ClearSuggestionFeatureConfigOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2ClearSuggestionFeatureConfigOperationMetadata](x: Self) {
