...
trait ParamsResourceProjectsLocationsAgentsEnvironmentsDeployflow
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1DeployFlowRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsEnvironmentsDeployflow {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsEnvironmentsDeployflow](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3beta1DeployFlowRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
