...
trait SchemaGoogleCloudDialogflowCxV3WebhookGenericWebService extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3WebhookGenericWebService {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3WebhookGenericWebService = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3WebhookGenericWebService]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3WebhookGenericWebService](x: Self) {
