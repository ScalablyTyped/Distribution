...
trait SchemaGoogleCloudDialogflowCxV3beta1ExportTestCasesRequest extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1ExportTestCasesRequest {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1ExportTestCasesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1ExportTestCasesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1ExportTestCasesRequest](x: Self) {
