...
trait SchemaGoogleCloudDialogflowCxV3beta1ExportAgentRequest extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1ExportAgentRequest {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1ExportAgentRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1ExportAgentRequest]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1ExportAgentRequest](x: Self) {
