...
trait SchemaGoogleCloudDialogflowCxV3beta1EntityTypeEntity extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1EntityTypeEntity {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1EntityTypeEntity = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1EntityTypeEntity]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1EntityTypeEntity](x: Self) {
