...
trait SchemaGoogleCloudDialogflowCxV3beta1VersionVariantsVariant extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1VersionVariantsVariant {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1VersionVariantsVariant = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1VersionVariantsVariant]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1VersionVariantsVariant](x: Self) {
