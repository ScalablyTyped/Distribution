...
trait SchemaGoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings](x: Self) {
