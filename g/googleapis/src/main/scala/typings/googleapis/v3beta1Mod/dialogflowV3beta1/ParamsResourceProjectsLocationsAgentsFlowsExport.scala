...
trait ParamsResourceProjectsLocationsAgentsFlowsExport
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1ExportFlowRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsFlowsExport {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsFlowsExport](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3beta1ExportFlowRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
