...
trait SchemaGoogleCloudDialogflowCxV3beta1TestError extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1TestError {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1TestError = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1TestError]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1TestError](x: Self) {
