...
trait ParamsResourceProjectsLocationsAgentsTestcasesCreate
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsTestcasesCreate {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsTestcasesCreate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3beta1TestCase): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
