...
trait ParamsResourceProjectsLocationsAgentsTestcasesBatchdelete
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1BatchDeleteTestCasesRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsTestcasesBatchdelete {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsTestcasesBatchdelete](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3beta1BatchDeleteTestCasesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
