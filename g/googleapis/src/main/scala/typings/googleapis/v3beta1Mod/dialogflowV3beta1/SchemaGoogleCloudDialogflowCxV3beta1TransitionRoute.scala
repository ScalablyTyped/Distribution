...
trait SchemaGoogleCloudDialogflowCxV3beta1TransitionRoute extends StObject {
  ...
  /**
    ...
    */
  var triggerFulfillment: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1Fulfillment] = js.undefined
}
object SchemaGoogleCloudDialogflowCxV3beta1TransitionRoute {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1TransitionRoute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1TransitionRoute]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1TransitionRoute](x: Self) {
    ...
    inline def setTriggerFulfillment(value: SchemaGoogleCloudDialogflowCxV3beta1Fulfillment): Self = StObject.set(x, "triggerFulfillment", value.asInstanceOf[js.Any])
