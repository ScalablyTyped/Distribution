...
trait ParamsResourceProjectsLocationsAgentsFlowsVersionsLoad
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1LoadVersionRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsFlowsVersionsLoad {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsFlowsVersionsLoad](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3beta1LoadVersionRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
