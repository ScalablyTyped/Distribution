...
trait ParamsResourceProjectsLocationsAgentsTestcasesBatchrun
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1BatchRunTestCasesRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsTestcasesBatchrun {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsTestcasesBatchrun](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3beta1BatchRunTestCasesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
