...
@JSImport("googleapis/build/src/apis/dialogflow/v3beta1", "dialogflow_v3beta1.Resource$Projects$Locations$Agents$Entitytypes")
@js.native
open class ResourceProjectsLocationsAgentsEntitytypes protected () extends StObject {
  ...
  def create(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def create(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1EntityType]): Unit = js.native
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def create(params: ParamsResourceProjectsLocationsAgentsEntitytypesCreate): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsEntitytypesCreate,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1EntityType]
  ): Unit = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsEntitytypesCreate,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1EntityType],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1EntityType]
  ): Unit = js.native
  def create(params: ParamsResourceProjectsLocationsAgentsEntitytypesCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsEntitytypesCreate,
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1EntityType]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def get(params: ParamsResourceProjectsLocationsAgentsEntitytypesGet): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsAgentsEntitytypesGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentsEntitytypesGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1EntityType]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListEntityTypesResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListEntityTypesResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListEntityTypesResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsEntitytypesList): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListEntityTypesResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsEntitytypesList,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListEntityTypesResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsEntitytypesList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1ListEntityTypesResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1ListEntityTypesResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsEntitytypesList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListEntityTypesResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsEntitytypesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListEntityTypesResponse]
  ...
  def patch(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1EntityType]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def patch(params: ParamsResourceProjectsLocationsAgentsEntitytypesPatch): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsAgentsEntitytypesPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1EntityType] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsAgentsEntitytypesPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1EntityType]
