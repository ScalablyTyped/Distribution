...
trait ParamsResourceProjectsLocationsAgentsEnvironmentsRuncontinuoustest
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1RunContinuousTestRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsEnvironmentsRuncontinuoustest {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsEnvironmentsRuncontinuoustest](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3beta1RunContinuousTestRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
