...
trait SchemaGoogleCloudDialogflowCxV3beta1Agent extends StObject {
  
  /**
    * Hierarchical advanced settings for this agent. The settings exposed at the lower level overrides the settings exposed at the higher level.
    */
  var advancedSettings: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1AdvancedSettings] = js.undefined
  ...
  /**
    ...
    */
  var speechToTextSettings: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1SpeechToTextSettings] = js.undefined
...
object SchemaGoogleCloudDialogflowCxV3beta1Agent {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1Agent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1Agent]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1Agent](x: Self) {
    
    inline def setAdvancedSettings(value: SchemaGoogleCloudDialogflowCxV3beta1AdvancedSettings): Self = StObject.set(x, "advancedSettings", value.asInstanceOf[js.Any])
    ...
    inline def setSpeechToTextSettings(value: SchemaGoogleCloudDialogflowCxV3beta1SpeechToTextSettings): Self = StObject.set(x, "speechToTextSettings", value.asInstanceOf[js.Any])
