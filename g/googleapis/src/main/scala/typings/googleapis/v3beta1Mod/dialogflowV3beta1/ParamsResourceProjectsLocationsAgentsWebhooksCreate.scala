...
trait ParamsResourceProjectsLocationsAgentsWebhooksCreate
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1Webhook] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsWebhooksCreate {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsWebhooksCreate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3beta1Webhook): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
