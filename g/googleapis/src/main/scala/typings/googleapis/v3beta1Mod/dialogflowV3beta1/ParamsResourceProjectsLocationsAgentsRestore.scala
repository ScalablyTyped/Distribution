...
trait ParamsResourceProjectsLocationsAgentsRestore
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1RestoreAgentRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsRestore {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsRestore](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3beta1RestoreAgentRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
