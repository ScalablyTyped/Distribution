...
trait SchemaGoogleCloudDialogflowCxV3beta1NluSettings extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1NluSettings {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1NluSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1NluSettings]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1NluSettings](x: Self) {
