...
trait SchemaGoogleCloudDialogflowCxV3beta1CompareVersionsResponse extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1CompareVersionsResponse {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1CompareVersionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1CompareVersionsResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1CompareVersionsResponse](x: Self) {
