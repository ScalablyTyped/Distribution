...
trait SchemaGoogleCloudDialogflowV2beta1FaqAnswer extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1FaqAnswer {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1FaqAnswer = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1FaqAnswer]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1FaqAnswer](x: Self) {
