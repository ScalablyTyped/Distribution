...
@JSImport("googleapis/build/src/apis/dialogflow/v3beta1", "dialogflow_v3beta1.Resource$Projects$Locations$Agents")
@js.native
open class ResourceProjectsLocationsAgents protected () extends StObject {
  ...
  def create(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def create(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Agent]): Unit = js.native
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def create(params: ParamsResourceProjectsLocationsAgentsCreate): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsCreate,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Agent]
  ): Unit = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsCreate,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1Agent],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1Agent]
  ): Unit = js.native
  def create(params: ParamsResourceProjectsLocationsAgentsCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsCreate,
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Agent]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def get(params: ParamsResourceProjectsLocationsAgentsGet): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsAgentsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Agent]
  ...
  def getValidationResult(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult] = js.native
  def getValidationResult(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult]): Unit = js.native
  def getValidationResult(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult] = js.native
  def getValidationResult(params: ParamsResourceProjectsLocationsAgentsGetvalidationresult): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult] = js.native
  def getValidationResult(
    params: ParamsResourceProjectsLocationsAgentsGetvalidationresult,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult]
  ): Unit = js.native
  def getValidationResult(
    params: ParamsResourceProjectsLocationsAgentsGetvalidationresult,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult]
  ): Unit = js.native
  def getValidationResult(params: ParamsResourceProjectsLocationsAgentsGetvalidationresult, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult] = js.native
  def getValidationResult(
    params: ParamsResourceProjectsLocationsAgentsGetvalidationresult,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListAgentsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListAgentsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListAgentsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsList): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListAgentsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsList,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListAgentsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1ListAgentsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1ListAgentsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListAgentsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListAgentsResponse]
  ...
  def patch(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Agent]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def patch(params: ParamsResourceProjectsLocationsAgentsPatch): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsAgentsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Agent] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsAgentsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Agent]
  ...
  def validate(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult] = js.native
  def validate(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult]): Unit = js.native
  def validate(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult] = js.native
  def validate(params: ParamsResourceProjectsLocationsAgentsValidate): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult] = js.native
  def validate(
  ...
  def validate(params: ParamsResourceProjectsLocationsAgentsValidate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult] = js.native
  def validate(
    params: ParamsResourceProjectsLocationsAgentsValidate,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1AgentValidationResult]
