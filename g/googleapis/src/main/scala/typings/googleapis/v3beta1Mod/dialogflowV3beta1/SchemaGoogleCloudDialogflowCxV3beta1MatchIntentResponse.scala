...
trait SchemaGoogleCloudDialogflowCxV3beta1MatchIntentResponse extends StObject {
  ...
  /**
    ...
    */
  var matches: js.UndefOr[js.Array[SchemaGoogleCloudDialogflowCxV3beta1Match]] = js.undefined
...
object SchemaGoogleCloudDialogflowCxV3beta1MatchIntentResponse {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1MatchIntentResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1MatchIntentResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1MatchIntentResponse](x: Self) {
    ...
    inline def setMatches(value: js.Array[SchemaGoogleCloudDialogflowCxV3beta1Match]): Self = StObject.set(x, "matches", value.asInstanceOf[js.Any])
    
    inline def setMatchesUndefined: Self = StObject.set(x, "matches", js.undefined)
    
    inline def setMatchesVarargs(value: SchemaGoogleCloudDialogflowCxV3beta1Match*): Self = StObject.set(x, "matches", js.Array(value*))
