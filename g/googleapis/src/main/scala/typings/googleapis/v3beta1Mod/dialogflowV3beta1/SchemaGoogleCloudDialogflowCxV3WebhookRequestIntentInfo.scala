...
trait SchemaGoogleCloudDialogflowCxV3WebhookRequestIntentInfo extends StObject {
  ...
  var parameters: js.UndefOr[
    StringDictionary[SchemaGoogleCloudDialogflowCxV3WebhookRequestIntentInfoIntentParameterValue] | Null
  ] = js.undefined
}
object SchemaGoogleCloudDialogflowCxV3WebhookRequestIntentInfo {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3WebhookRequestIntentInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3WebhookRequestIntentInfo]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3WebhookRequestIntentInfo](x: Self) {
    ...
    inline def setParameters(
      value: StringDictionary[SchemaGoogleCloudDialogflowCxV3WebhookRequestIntentInfoIntentParameterValue]
