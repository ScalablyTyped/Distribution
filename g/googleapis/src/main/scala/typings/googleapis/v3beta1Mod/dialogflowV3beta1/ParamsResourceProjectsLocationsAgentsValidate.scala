...
trait ParamsResourceProjectsLocationsAgentsValidate
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1ValidateAgentRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsValidate {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsValidate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3beta1ValidateAgentRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
