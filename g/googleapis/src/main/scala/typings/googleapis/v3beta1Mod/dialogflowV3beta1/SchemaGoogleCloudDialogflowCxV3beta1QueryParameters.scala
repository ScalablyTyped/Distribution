...
trait SchemaGoogleCloudDialogflowCxV3beta1QueryParameters extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1QueryParameters {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1QueryParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1QueryParameters]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1QueryParameters](x: Self) {
