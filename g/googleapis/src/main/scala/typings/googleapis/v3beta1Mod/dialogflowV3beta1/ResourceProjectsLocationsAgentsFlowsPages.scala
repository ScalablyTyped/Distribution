...
@JSImport("googleapis/build/src/apis/dialogflow/v3beta1", "dialogflow_v3beta1.Resource$Projects$Locations$Agents$Flows$Pages")
@js.native
open class ResourceProjectsLocationsAgentsFlowsPages protected () extends StObject {
  ...
  def create(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def create(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Page]): Unit = js.native
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def create(params: ParamsResourceProjectsLocationsAgentsFlowsPagesCreate): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsFlowsPagesCreate,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Page]
  ): Unit = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsFlowsPagesCreate,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1Page],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1Page]
  ): Unit = js.native
  def create(params: ParamsResourceProjectsLocationsAgentsFlowsPagesCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsFlowsPagesCreate,
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Page]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def get(params: ParamsResourceProjectsLocationsAgentsFlowsPagesGet): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsAgentsFlowsPagesGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentsFlowsPagesGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Page]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListPagesResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListPagesResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListPagesResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsFlowsPagesList): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListPagesResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsFlowsPagesList,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListPagesResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsFlowsPagesList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1ListPagesResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1ListPagesResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsFlowsPagesList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListPagesResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsFlowsPagesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListPagesResponse]
  ...
  def patch(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Page]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def patch(params: ParamsResourceProjectsLocationsAgentsFlowsPagesPatch): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsAgentsFlowsPagesPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Page] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsAgentsFlowsPagesPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Page]
