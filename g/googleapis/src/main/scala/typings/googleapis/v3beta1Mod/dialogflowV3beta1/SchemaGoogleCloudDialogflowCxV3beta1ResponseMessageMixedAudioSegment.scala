...
trait SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageMixedAudioSegment extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageMixedAudioSegment {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageMixedAudioSegment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageMixedAudioSegment]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageMixedAudioSegment](x: Self) {
