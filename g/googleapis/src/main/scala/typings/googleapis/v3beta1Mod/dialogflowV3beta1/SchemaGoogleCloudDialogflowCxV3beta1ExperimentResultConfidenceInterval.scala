...
trait SchemaGoogleCloudDialogflowCxV3beta1ExperimentResultConfidenceInterval extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1ExperimentResultConfidenceInterval {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1ExperimentResultConfidenceInterval = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1ExperimentResultConfidenceInterval]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1ExperimentResultConfidenceInterval](x: Self) {
