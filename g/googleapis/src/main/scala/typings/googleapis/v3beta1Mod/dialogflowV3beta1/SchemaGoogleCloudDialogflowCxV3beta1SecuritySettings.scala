...
trait SchemaGoogleCloudDialogflowCxV3beta1SecuritySettings extends StObject {
  
  /**
    * Controls audio export settings for post-conversation analytics when ingesting audio to conversations via Participants.AnalyzeContent or Participants.StreamingAnalyzeContent. If retention_strategy is set to REMOVE_AFTER_CONVERSATION or audio_export_settings.gcs_bucket is empty, audio export is disabled. If audio export is enabled, audio is recorded and saved to audio_export_settings.gcs_bucket, subject to retention policy of audio_export_settings.gcs_bucket. This setting won't effect audio input for implicit sessions via Sessions.DetectIntent or Sessions.StreamingDetectIntent.
    */
  var audioExportSettings: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings] = js.undefined
  ...
  /**
    ...
    */
  var insightsExportSettings: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettings] = js.undefined
...
object SchemaGoogleCloudDialogflowCxV3beta1SecuritySettings {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1SecuritySettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1SecuritySettings]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1SecuritySettings](x: Self) {
    
    inline def setAudioExportSettings(value: SchemaGoogleCloudDialogflowCxV3beta1SecuritySettingsAudioExportSettings): Self = StObject.set(x, "audioExportSettings", value.asInstanceOf[js.Any])
    ...
    inline def setInsightsExportSettings(value: SchemaGoogleCloudDialogflowCxV3beta1SecuritySettingsInsightsExportSettings): Self = StObject.set(x, "insightsExportSettings", value.asInstanceOf[js.Any])
