...
trait SchemaGoogleCloudDialogflowCxV3beta1VoiceSelectionParams extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1VoiceSelectionParams {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1VoiceSelectionParams = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1VoiceSelectionParams]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1VoiceSelectionParams](x: Self) {
