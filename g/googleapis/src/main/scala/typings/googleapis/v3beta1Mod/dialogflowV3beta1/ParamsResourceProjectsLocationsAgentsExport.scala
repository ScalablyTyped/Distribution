...
trait ParamsResourceProjectsLocationsAgentsExport
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1ExportAgentRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsExport {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsExport](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3beta1ExportAgentRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
