...
trait SchemaGoogleCloudDialogflowV2SetSuggestionFeatureConfigOperationMetadata extends StObject {
...
object SchemaGoogleCloudDialogflowV2SetSuggestionFeatureConfigOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2SetSuggestionFeatureConfigOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2SetSuggestionFeatureConfigOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2SetSuggestionFeatureConfigOperationMetadata](x: Self) {
