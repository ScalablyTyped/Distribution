...
trait SchemaGoogleCloudDialogflowCxV3beta1ExportFlowRequest extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1ExportFlowRequest {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1ExportFlowRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1ExportFlowRequest]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1ExportFlowRequest](x: Self) {
