...
@JSImport("googleapis/build/src/apis/dialogflow/v3beta1", "dialogflow_v3beta1.Resource$Projects$Locations$Agents$Environments")
@js.native
open class ResourceProjectsLocationsAgentsEnvironments protected () extends StObject {
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Environment] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Environment]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Environment] = js.native
  def get(params: ParamsResourceProjectsLocationsAgentsEnvironmentsGet): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Environment] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentsEnvironmentsGet,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Environment]
  ): Unit = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentsEnvironmentsGet,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1Environment],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1Environment]
  ): Unit = js.native
  def get(params: ParamsResourceProjectsLocationsAgentsEnvironmentsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1Environment] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentsEnvironmentsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1Environment]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListEnvironmentsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListEnvironmentsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListEnvironmentsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsEnvironmentsList): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListEnvironmentsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsEnvironmentsList,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListEnvironmentsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsEnvironmentsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1ListEnvironmentsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1ListEnvironmentsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsEnvironmentsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListEnvironmentsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsEnvironmentsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListEnvironmentsResponse]
  ...
  def lookupEnvironmentHistory(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1LookupEnvironmentHistoryResponse] = js.native
  def lookupEnvironmentHistory(
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1LookupEnvironmentHistoryResponse]
  ): Unit = js.native
  def lookupEnvironmentHistory(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1LookupEnvironmentHistoryResponse] = js.native
  def lookupEnvironmentHistory(params: ParamsResourceProjectsLocationsAgentsEnvironmentsLookupenvironmenthistory): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1LookupEnvironmentHistoryResponse] = js.native
  def lookupEnvironmentHistory(
  ...
  def lookupEnvironmentHistory(
    params: ParamsResourceProjectsLocationsAgentsEnvironmentsLookupenvironmenthistory,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1LookupEnvironmentHistoryResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1LookupEnvironmentHistoryResponse]
  ): Unit = js.native
  def lookupEnvironmentHistory(
    params: ParamsResourceProjectsLocationsAgentsEnvironmentsLookupenvironmenthistory,
    options: MethodOptions
  ): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1LookupEnvironmentHistoryResponse] = js.native
  def lookupEnvironmentHistory(
    params: ParamsResourceProjectsLocationsAgentsEnvironmentsLookupenvironmenthistory,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1LookupEnvironmentHistoryResponse]
