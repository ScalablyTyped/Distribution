...
trait SchemaGoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfoIntentParameterValue extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfoIntentParameterValue {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfoIntentParameterValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfoIntentParameterValue]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfoIntentParameterValue](x: Self) {
