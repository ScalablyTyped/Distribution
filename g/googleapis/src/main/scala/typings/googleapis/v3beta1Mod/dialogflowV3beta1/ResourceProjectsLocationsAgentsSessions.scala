...
@JSImport("googleapis/build/src/apis/dialogflow/v3beta1", "dialogflow_v3beta1.Resource$Projects$Locations$Agents$Sessions")
@js.native
open class ResourceProjectsLocationsAgentsSessions protected () extends StObject {
  ...
  def detectIntent(params: ParamsResourceProjectsLocationsAgentsSessionsDetectintent): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1DetectIntentResponse] = js.native
  def detectIntent(
  ...
  def detectIntent(params: ParamsResourceProjectsLocationsAgentsSessionsDetectintent, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1DetectIntentResponse] = js.native
  def detectIntent(
    params: ParamsResourceProjectsLocationsAgentsSessionsDetectintent,
  ...
  def fulfillIntent(params: ParamsResourceProjectsLocationsAgentsSessionsFulfillintent): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1FulfillIntentResponse] = js.native
  def fulfillIntent(
  ...
  def fulfillIntent(params: ParamsResourceProjectsLocationsAgentsSessionsFulfillintent, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1FulfillIntentResponse] = js.native
  def fulfillIntent(
    params: ParamsResourceProjectsLocationsAgentsSessionsFulfillintent,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1FulfillIntentResponse]
  ...
  def matchIntent(params: ParamsResourceProjectsLocationsAgentsSessionsMatchintent): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1MatchIntentResponse] = js.native
  def matchIntent(
  ...
  def matchIntent(params: ParamsResourceProjectsLocationsAgentsSessionsMatchintent, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1MatchIntentResponse] = js.native
  def matchIntent(
    params: ParamsResourceProjectsLocationsAgentsSessionsMatchintent,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1MatchIntentResponse]
