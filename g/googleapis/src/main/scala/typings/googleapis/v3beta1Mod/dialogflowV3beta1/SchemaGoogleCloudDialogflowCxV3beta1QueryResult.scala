...
trait SchemaGoogleCloudDialogflowCxV3beta1QueryResult extends StObject {
  ...
  /**
    ...
    */
  var responseMessages: js.UndefOr[js.Array[SchemaGoogleCloudDialogflowCxV3beta1ResponseMessage]] = js.undefined
  
  /**
    * The sentiment analyss result, which depends on `analyze_query_text_sentiment`, specified in the request.
    */
  var sentimentAnalysisResult: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1SentimentAnalysisResult] = js.undefined
...
object SchemaGoogleCloudDialogflowCxV3beta1QueryResult {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1QueryResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1QueryResult]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1QueryResult](x: Self) {
    ...
    inline def setResponseMessages(value: js.Array[SchemaGoogleCloudDialogflowCxV3beta1ResponseMessage]): Self = StObject.set(x, "responseMessages", value.asInstanceOf[js.Any])
    
    inline def setResponseMessagesUndefined: Self = StObject.set(x, "responseMessages", js.undefined)
    
    inline def setResponseMessagesVarargs(value: SchemaGoogleCloudDialogflowCxV3beta1ResponseMessage*): Self = StObject.set(x, "responseMessages", js.Array(value*))
    
    inline def setSentimentAnalysisResult(value: SchemaGoogleCloudDialogflowCxV3beta1SentimentAnalysisResult): Self = StObject.set(x, "sentimentAnalysisResult", value.asInstanceOf[js.Any])
