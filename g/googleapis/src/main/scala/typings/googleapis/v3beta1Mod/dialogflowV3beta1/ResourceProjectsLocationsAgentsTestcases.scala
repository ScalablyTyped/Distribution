...
@JSImport("googleapis/build/src/apis/dialogflow/v3beta1", "dialogflow_v3beta1.Resource$Projects$Locations$Agents$Testcases")
@js.native
open class ResourceProjectsLocationsAgentsTestcases protected () extends StObject {
  ...
  def calculateCoverage(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1CalculateCoverageResponse] = js.native
  def calculateCoverage(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1CalculateCoverageResponse]): Unit = js.native
  def calculateCoverage(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1CalculateCoverageResponse] = js.native
  def calculateCoverage(params: ParamsResourceProjectsLocationsAgentsTestcasesCalculatecoverage): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1CalculateCoverageResponse] = js.native
  def calculateCoverage(
    params: ParamsResourceProjectsLocationsAgentsTestcasesCalculatecoverage,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1CalculateCoverageResponse]
  ): Unit = js.native
  def calculateCoverage(
    params: ParamsResourceProjectsLocationsAgentsTestcasesCalculatecoverage,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1CalculateCoverageResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1CalculateCoverageResponse]
  ): Unit = js.native
  def calculateCoverage(params: ParamsResourceProjectsLocationsAgentsTestcasesCalculatecoverage, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1CalculateCoverageResponse] = js.native
  def calculateCoverage(
    params: ParamsResourceProjectsLocationsAgentsTestcasesCalculatecoverage,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1CalculateCoverageResponse]
  ...
  def create(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def create(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1TestCase]): Unit = js.native
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def create(params: ParamsResourceProjectsLocationsAgentsTestcasesCreate): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsTestcasesCreate,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1TestCase]
  ): Unit = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsTestcasesCreate,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1TestCase],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1TestCase]
  ): Unit = js.native
  def create(params: ParamsResourceProjectsLocationsAgentsTestcasesCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsTestcasesCreate,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1TestCase]
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1TestCase]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def get(params: ParamsResourceProjectsLocationsAgentsTestcasesGet): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsAgentsTestcasesGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentsTestcasesGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1TestCase]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListTestCasesResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListTestCasesResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListTestCasesResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsTestcasesList): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListTestCasesResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsTestcasesList,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListTestCasesResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsTestcasesList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1ListTestCasesResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3beta1ListTestCasesResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsTestcasesList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1ListTestCasesResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsTestcasesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1ListTestCasesResponse]
  ...
  def patch(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1TestCase]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def patch(params: ParamsResourceProjectsLocationsAgentsTestcasesPatch): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsAgentsTestcasesPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3beta1TestCase] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsAgentsTestcasesPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3beta1TestCase]
