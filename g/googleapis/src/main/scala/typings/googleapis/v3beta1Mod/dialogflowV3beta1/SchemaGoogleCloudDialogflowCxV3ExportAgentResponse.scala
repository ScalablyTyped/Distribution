...
trait SchemaGoogleCloudDialogflowCxV3ExportAgentResponse extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3ExportAgentResponse {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3ExportAgentResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3ExportAgentResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3ExportAgentResponse](x: Self) {
