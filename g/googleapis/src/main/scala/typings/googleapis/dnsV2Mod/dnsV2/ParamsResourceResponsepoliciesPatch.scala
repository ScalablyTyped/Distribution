...
trait ParamsResourceResponsepoliciesPatch
  extends StObject
...
object ParamsResourceResponsepoliciesPatch {
  
  inline def apply(): ParamsResourceResponsepoliciesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResponsepoliciesPatch]
  }
  
  extension [Self <: ParamsResourceResponsepoliciesPatch](x: Self) {
