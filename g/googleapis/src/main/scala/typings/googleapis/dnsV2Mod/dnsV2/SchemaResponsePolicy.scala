...
trait SchemaResponsePolicy extends StObject {
  ...
  /**
    ...
    */
  var gkeClusters: js.UndefOr[js.Array[SchemaResponsePolicyGKECluster]] = js.undefined
...
object SchemaResponsePolicy {
  ...
  extension [Self <: SchemaResponsePolicy](x: Self) {
    ...
    inline def setGkeClusters(value: js.Array[SchemaResponsePolicyGKECluster]): Self = StObject.set(x, "gkeClusters", value.asInstanceOf[js.Any])
    
    inline def setGkeClustersUndefined: Self = StObject.set(x, "gkeClusters", js.undefined)
    
    inline def setGkeClustersVarargs(value: SchemaResponsePolicyGKECluster*): Self = StObject.set(x, "gkeClusters", js.Array(value*))
