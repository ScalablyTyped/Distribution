...
trait ParamsResourceResponsepoliciesGet
  extends StObject
...
object ParamsResourceResponsepoliciesGet {
  
  inline def apply(): ParamsResourceResponsepoliciesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResponsepoliciesGet]
  }
  
  extension [Self <: ParamsResourceResponsepoliciesGet](x: Self) {
