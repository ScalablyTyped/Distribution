...
trait SchemaResponsePolicyNetwork extends StObject {
...
object SchemaResponsePolicyNetwork {
  
  inline def apply(): SchemaResponsePolicyNetwork = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaResponsePolicyNetwork]
  }
  
  extension [Self <: SchemaResponsePolicyNetwork](x: Self) {
