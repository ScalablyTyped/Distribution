...
trait ParamsResourceResponsepoliciesUpdate
  extends StObject
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaResponsePolicy] = js.undefined
...
object ParamsResourceResponsepoliciesUpdate {
  
  inline def apply(): ParamsResourceResponsepoliciesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResponsepoliciesUpdate]
  }
  
  extension [Self <: ParamsResourceResponsepoliciesUpdate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaResponsePolicy): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
