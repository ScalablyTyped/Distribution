...
trait ParamsResourceResourcerecordsetsGet
  extends StObject
...
object ParamsResourceResourcerecordsetsGet {
  
  inline def apply(): ParamsResourceResourcerecordsetsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResourcerecordsetsGet]
  }
  
  extension [Self <: ParamsResourceResourcerecordsetsGet](x: Self) {
