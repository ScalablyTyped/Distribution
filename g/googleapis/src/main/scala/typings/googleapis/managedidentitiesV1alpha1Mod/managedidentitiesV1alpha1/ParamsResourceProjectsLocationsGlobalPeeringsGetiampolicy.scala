...
trait ParamsResourceProjectsLocationsGlobalPeeringsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsGlobalPeeringsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsGlobalPeeringsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGlobalPeeringsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGlobalPeeringsGetiampolicy](x: Self) {
