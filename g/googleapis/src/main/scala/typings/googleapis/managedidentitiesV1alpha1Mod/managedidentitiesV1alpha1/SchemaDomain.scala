...
trait SchemaDomain extends StObject {
  ...
  /**
    ...
    */
  var managedIdentitiesAdminName: js.UndefOr[String | Null] = js.undefined
...
object SchemaDomain {
  ...
  extension [Self <: SchemaDomain](x: Self) {
    ...
    inline def setManagedIdentitiesAdminName(value: String): Self = StObject.set(x, "managedIdentitiesAdminName", value.asInstanceOf[js.Any])
    
    inline def setManagedIdentitiesAdminNameNull: Self = StObject.set(x, "managedIdentitiesAdminName", null)
    
    inline def setManagedIdentitiesAdminNameUndefined: Self = StObject.set(x, "managedIdentitiesAdminName", js.undefined)
