...
trait SchemaLDAPSSettings extends StObject {
  ...
  /**
    ...
    */
  var certificatePfx: js.UndefOr[String | Null] = js.undefined
...
object SchemaLDAPSSettings {
  
  inline def apply(): SchemaLDAPSSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaLDAPSSettings]
  }
  
  extension [Self <: SchemaLDAPSSettings](x: Self) {
    
    inline def setCertificate(value: SchemaCertificate): Self = StObject.set(x, "certificate", value.asInstanceOf[js.Any])
    ...
    inline def setCertificatePfxNull: Self = StObject.set(x, "certificatePfx", null)
