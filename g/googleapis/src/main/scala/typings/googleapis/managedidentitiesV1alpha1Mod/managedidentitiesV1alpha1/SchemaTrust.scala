...
trait SchemaTrust extends StObject {
  ...
  /**
    ...
    */
  var lastKnownTrustConnectedHeartbeatTime: js.UndefOr[String | Null] = js.undefined
...
object SchemaTrust {
  ...
  extension [Self <: SchemaTrust](x: Self) {
    ...
    inline def setLastKnownTrustConnectedHeartbeatTime(value: String): Self = StObject.set(x, "lastKnownTrustConnectedHeartbeatTime", value.asInstanceOf[js.Any])
    
    inline def setLastKnownTrustConnectedHeartbeatTimeNull: Self = StObject.set(x, "lastKnownTrustConnectedHeartbeatTime", null)
    
    inline def setLastKnownTrustConnectedHeartbeatTimeUndefined: Self = StObject.set(x, "lastKnownTrustConnectedHeartbeatTime", js.undefined)
