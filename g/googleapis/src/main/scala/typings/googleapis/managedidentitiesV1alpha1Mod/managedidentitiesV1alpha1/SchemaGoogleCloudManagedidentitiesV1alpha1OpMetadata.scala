...
trait SchemaGoogleCloudManagedidentitiesV1alpha1OpMetadata extends StObject {
...
object SchemaGoogleCloudManagedidentitiesV1alpha1OpMetadata {
  
  inline def apply(): SchemaGoogleCloudManagedidentitiesV1alpha1OpMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudManagedidentitiesV1alpha1OpMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudManagedidentitiesV1alpha1OpMetadata](x: Self) {
