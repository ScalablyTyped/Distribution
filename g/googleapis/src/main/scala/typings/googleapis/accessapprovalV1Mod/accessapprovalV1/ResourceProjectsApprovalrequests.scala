...
@JSImport("googleapis/build/src/apis/accessapproval/v1", "accessapproval_v1.Resource$Projects$Approvalrequests")
@js.native
open class ResourceProjectsApprovalrequests protected () extends StObject {
  ...
  def invalidate(params: ParamsResourceProjectsApprovalrequestsInvalidate): GaxiosPromise[SchemaApprovalRequest] = js.native
  def invalidate(
    params: ParamsResourceProjectsApprovalrequestsInvalidate,
    callback: BodyResponseCallback[SchemaApprovalRequest]
  ): Unit = js.native
  def invalidate(
    params: ParamsResourceProjectsApprovalrequestsInvalidate,
  ...
  def invalidate(params: ParamsResourceProjectsApprovalrequestsInvalidate, options: MethodOptions): GaxiosPromise[SchemaApprovalRequest] = js.native
  def invalidate(
    params: ParamsResourceProjectsApprovalrequestsInvalidate,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaApprovalRequest]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def invalidate(params: ParamsResourceProjectsApprovalrequestsInvalidate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def invalidate(
    params: ParamsResourceProjectsApprovalrequestsInvalidate,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
