...
trait ParamsResourceProjectsUpdateaccessapprovalsettings
  extends StObject
...
object ParamsResourceProjectsUpdateaccessapprovalsettings {
  
  inline def apply(): ParamsResourceProjectsUpdateaccessapprovalsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsUpdateaccessapprovalsettings]
  }
  
  extension [Self <: ParamsResourceProjectsUpdateaccessapprovalsettings](x: Self) {
