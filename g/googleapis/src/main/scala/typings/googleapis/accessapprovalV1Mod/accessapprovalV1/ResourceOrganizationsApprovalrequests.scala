...
@JSImport("googleapis/build/src/apis/accessapproval/v1", "accessapproval_v1.Resource$Organizations$Approvalrequests")
@js.native
open class ResourceOrganizationsApprovalrequests protected () extends StObject {
  ...
  def invalidate(params: ParamsResourceOrganizationsApprovalrequestsInvalidate): GaxiosPromise[SchemaApprovalRequest] = js.native
  def invalidate(
    params: ParamsResourceOrganizationsApprovalrequestsInvalidate,
    callback: BodyResponseCallback[SchemaApprovalRequest]
  ): Unit = js.native
  def invalidate(
    params: ParamsResourceOrganizationsApprovalrequestsInvalidate,
  ...
  def invalidate(params: ParamsResourceOrganizationsApprovalrequestsInvalidate, options: MethodOptions): GaxiosPromise[SchemaApprovalRequest] = js.native
  def invalidate(
    params: ParamsResourceOrganizationsApprovalrequestsInvalidate,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaApprovalRequest]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def invalidate(params: ParamsResourceOrganizationsApprovalrequestsInvalidate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def invalidate(
    params: ParamsResourceOrganizationsApprovalrequestsInvalidate,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
