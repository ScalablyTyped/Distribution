...
@js.native
trait AnonCanAddChildrenCanChangeCopyRequiresWriterPermissionRestriction extends js.Object {
...
object AnonCanAddChildrenCanChangeCopyRequiresWriterPermissionRestriction {
  @scala.inline
  def apply(
  ...
  ): AnonCanAddChildrenCanChangeCopyRequiresWriterPermissionRestriction = {
    ...
    __obj.asInstanceOf[AnonCanAddChildrenCanChangeCopyRequiresWriterPermissionRestriction]
  }
}
