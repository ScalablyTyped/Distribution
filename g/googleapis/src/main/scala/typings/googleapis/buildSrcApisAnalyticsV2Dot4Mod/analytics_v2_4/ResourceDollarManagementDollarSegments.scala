...
class ResourceDollarManagementDollarSegments protected () extends js.Object {
  ...
  def list(params: ParamsDollarResourceDollarManagementDollarSegmentsDollarList): GaxiosPromise[Unit] = js.native
  def list(
  ...
  def list(params: ParamsDollarResourceDollarManagementDollarSegmentsDollarList, options: MethodOptions): GaxiosPromise[Unit] = js.native
  def list(
    params: ParamsDollarResourceDollarManagementDollarSegmentsDollarList,
