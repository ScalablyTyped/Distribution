...
@js.native
trait ParamsDollarResourceDollarManagementDollarAccountsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarAccountsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarManagementDollarAccountsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarAccountsDollarList]
  }
}
