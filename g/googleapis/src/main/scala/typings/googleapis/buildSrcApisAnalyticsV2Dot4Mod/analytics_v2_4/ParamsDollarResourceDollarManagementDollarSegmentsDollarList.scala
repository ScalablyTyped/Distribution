...
@js.native
trait ParamsDollarResourceDollarManagementDollarSegmentsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarSegmentsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarManagementDollarSegmentsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarSegmentsDollarList]
  }
}
