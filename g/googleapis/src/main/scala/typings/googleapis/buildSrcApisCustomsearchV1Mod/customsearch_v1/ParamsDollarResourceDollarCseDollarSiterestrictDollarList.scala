...
@js.native
trait ParamsDollarResourceDollarCseDollarSiterestrictDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCseDollarSiterestrictDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCseDollarSiterestrictDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCseDollarSiterestrictDollarList]
  }
}
