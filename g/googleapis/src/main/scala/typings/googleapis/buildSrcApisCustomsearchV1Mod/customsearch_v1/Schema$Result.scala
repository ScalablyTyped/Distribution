...
import typings.googleapis.Anon_ByteSize
import typings.googleapis.Anon_DisplayNameLabelwithop
...
trait Schema$Result extends js.Object {
  ...
  var image: js.UndefOr[Anon_ByteSize] = js.native
  var kind: js.UndefOr[String] = js.native
  var labels: js.UndefOr[js.Array[Anon_DisplayNameLabelwithop]] = js.native
...
object Schema$Result {
  ...
  def apply(
    ...
    kind: String = null,
    labels: js.Array[Anon_DisplayNameLabelwithop] = null,
    link: String = null,
    mime: String = null,
