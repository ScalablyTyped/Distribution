...
trait ParamsResourceFoldersTimeseriesList
  extends StObject
...
object ParamsResourceFoldersTimeseriesList {
  
  inline def apply(): ParamsResourceFoldersTimeseriesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersTimeseriesList]
  }
  
  extension [Self <: ParamsResourceFoldersTimeseriesList](x: Self) {
