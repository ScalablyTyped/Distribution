...
object ParamsResourceProjectsMonitoredresourcedescriptorsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsMonitoredresourcedescriptorsListMutableBuilder[Self <: ParamsResourceProjectsMonitoredresourcedescriptorsList] (val x: Self) extends AnyVal {
