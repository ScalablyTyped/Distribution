...
object SchemaAlertPolicy {
  ...
  @scala.inline
  implicit class SchemaAlertPolicyMutableBuilder[Self <: SchemaAlertPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreationRecord(value: SchemaMutationRecord): Self = StObject.set(x, "creationRecord", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMutationRecord(value: SchemaMutationRecord): Self = StObject.set(x, "mutationRecord", value.asInstanceOf[js.Any])
