...
@JSImport("googleapis/build/src/apis/monitoring/v3", "monitoring_v3.Resource$Folders$Timeseries")
@js.native
open class ResourceFoldersTimeseries protected () extends StObject {
  ...
  def list(params: ParamsResourceFoldersTimeseriesList): GaxiosPromise[SchemaListTimeSeriesResponse] = js.native
  def list(
    params: ParamsResourceFoldersTimeseriesList,
  ...
  def list(params: ParamsResourceFoldersTimeseriesList, options: MethodOptions): GaxiosPromise[SchemaListTimeSeriesResponse] = js.native
  def list(
    params: ParamsResourceFoldersTimeseriesList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceFoldersTimeseriesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceFoldersTimeseriesList,
