...
@JSImport("googleapis/build/src/apis/monitoring/v3", "monitoring_v3.Resource$Organizations$Timeseries")
@js.native
open class ResourceOrganizationsTimeseries protected () extends StObject {
  ...
  def list(params: ParamsResourceOrganizationsTimeseriesList): GaxiosPromise[SchemaListTimeSeriesResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsTimeseriesList,
  ...
  def list(params: ParamsResourceOrganizationsTimeseriesList, options: MethodOptions): GaxiosPromise[SchemaListTimeSeriesResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsTimeseriesList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceOrganizationsTimeseriesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceOrganizationsTimeseriesList,
