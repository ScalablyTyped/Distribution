...
object SchemaUptimeCheckConfig {
  ...
  inline def apply(): SchemaUptimeCheckConfig = {
  ...
  extension [Self <: SchemaUptimeCheckConfig](x: Self) {
    ...
    inline def setHttpCheck(value: SchemaHttpCheck): Self = StObject.set(x, "httpCheck", value.asInstanceOf[js.Any])
    
    inline def setHttpCheckUndefined: Self = StObject.set(x, "httpCheck", js.undefined)
    
    inline def setInternalCheckers(value: js.Array[SchemaInternalChecker]): Self = StObject.set(x, "internalCheckers", value.asInstanceOf[js.Any])
    ...
    inline def setResourceGroup(value: SchemaResourceGroup): Self = StObject.set(x, "resourceGroup", value.asInstanceOf[js.Any])
