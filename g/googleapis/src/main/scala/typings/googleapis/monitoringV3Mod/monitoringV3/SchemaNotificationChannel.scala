...
trait SchemaNotificationChannel extends StObject {
  ...
  /**
    ...
    */
  var mutationRecords: js.UndefOr[js.Array[SchemaMutationRecord]] = js.undefined
...
object SchemaNotificationChannel {
  ...
  inline def apply(): SchemaNotificationChannel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaNotificationChannel]
  }
  
  extension [Self <: SchemaNotificationChannel](x: Self) {
    ...
    inline def setMutationRecords(value: js.Array[SchemaMutationRecord]): Self = StObject.set(x, "mutationRecords", value.asInstanceOf[js.Any])
    
    inline def setMutationRecordsUndefined: Self = StObject.set(x, "mutationRecords", js.undefined)
    
    inline def setMutationRecordsVarargs(value: SchemaMutationRecord*): Self = StObject.set(x, "mutationRecords", js.Array(value*))
