...
object ParamsResourceProjectsNotificationchannelsGetverificationcode {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsNotificationchannelsGetverificationcode = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsNotificationchannelsGetverificationcode]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsNotificationchannelsGetverificationcodeMutableBuilder[Self <: ParamsResourceProjectsNotificationchannelsGetverificationcode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGetNotificationChannelVerificationCodeRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
