...
object ParamsResourceProjectsNotificationchannelsGetverificationcode {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsNotificationchannelsGetverificationcodeOps[Self <: ParamsResourceProjectsNotificationchannelsGetverificationcode] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaGetNotificationChannelVerificationCodeRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
