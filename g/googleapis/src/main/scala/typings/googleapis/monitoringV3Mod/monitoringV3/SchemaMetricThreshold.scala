...
trait SchemaMetricThreshold extends StObject {
  ...
  /**
    ...
    */
  var comparison: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var denominatorFilter: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var thresholdValue: js.UndefOr[Double | Null] = js.undefined
...
object SchemaMetricThreshold {
  ...
  inline def apply(): SchemaMetricThreshold = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaMetricThreshold]
  }
  
  extension [Self <: SchemaMetricThreshold](x: Self) {
    
    inline def setAggregations(value: js.Array[SchemaAggregation]): Self = StObject.set(x, "aggregations", value.asInstanceOf[js.Any])
    
    inline def setAggregationsUndefined: Self = StObject.set(x, "aggregations", js.undefined)
    
    inline def setAggregationsVarargs(value: SchemaAggregation*): Self = StObject.set(x, "aggregations", js.Array(value*))
    
    inline def setComparison(value: String): Self = StObject.set(x, "comparison", value.asInstanceOf[js.Any])
    
    inline def setComparisonNull: Self = StObject.set(x, "comparison", null)
    
    inline def setComparisonUndefined: Self = StObject.set(x, "comparison", js.undefined)
    
    inline def setDenominatorAggregations(value: js.Array[SchemaAggregation]): Self = StObject.set(x, "denominatorAggregations", value.asInstanceOf[js.Any])
    
    inline def setDenominatorAggregationsUndefined: Self = StObject.set(x, "denominatorAggregations", js.undefined)
    
    inline def setDenominatorAggregationsVarargs(value: SchemaAggregation*): Self = StObject.set(x, "denominatorAggregations", js.Array(value*))
    
    inline def setDenominatorFilter(value: String): Self = StObject.set(x, "denominatorFilter", value.asInstanceOf[js.Any])
    
    inline def setDenominatorFilterNull: Self = StObject.set(x, "denominatorFilter", null)
    ...
    inline def setThresholdValueNull: Self = StObject.set(x, "thresholdValue", null)
