...
object SchemaMetricThreshold {
  ...
  extension [Self <: SchemaMetricThreshold](x: Self) {
    ...
    inline def setAggregationsVarargs(value: SchemaAggregation*): Self = StObject.set(x, "aggregations", js.Array(value :_*))
    ...
    inline def setDenominatorAggregationsVarargs(value: SchemaAggregation*): Self = StObject.set(x, "denominatorAggregations", js.Array(value :_*))
