...
trait SchemaGkeService extends StObject {
...
object SchemaGkeService {
  
  inline def apply(): SchemaGkeService = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGkeService]
  }
  
  extension [Self <: SchemaGkeService](x: Self) {
