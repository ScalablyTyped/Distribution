...
object ParamsResourceProjectsCreate {
  ...
  def apply(
    ...
    requestBody: SchemaProject = null,
    uploadType: String = null,
    upload_protocol: String = null,
    useLegacyStack: js.UndefOr[Boolean] = js.undefined
  ): ParamsResourceProjectsCreate = {
    ...
    if (!js.isUndefined(useLegacyStack)) __obj.updateDynamic("useLegacyStack")(useLegacyStack.get.asInstanceOf[js.Any])
