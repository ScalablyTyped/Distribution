...
object ParamsResourceProjectsUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsUpdateMutableBuilder[Self <: ParamsResourceProjectsUpdate] (val x: Self) extends AnyVal {
