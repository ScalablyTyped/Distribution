...
@js.native
trait ParamsDollarResourceDollarManagedzonesDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagedzonesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarManagedzonesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagedzonesDollarDelete]
  }
}
