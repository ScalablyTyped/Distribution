...
@js.native
trait ParamsDollarResourceDollarManagedzonesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagedzonesDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarManagedzonesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagedzonesDollarGet]
  }
}
