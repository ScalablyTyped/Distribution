...
@js.native
trait Schema$ManagedZone extends js.Object {
  var creationTime: js.UndefOr[String] = js.native
  var description: js.UndefOr[String] = js.native
  var dnsName: js.UndefOr[String] = js.native
  var dnssecConfig: js.UndefOr[Schema$ManagedZoneDnsSecConfig] = js.native
  var forwardingConfig: js.UndefOr[Schema$ManagedZoneForwardingConfig] = js.native
  ...
  var peeringConfig: js.UndefOr[Schema$ManagedZonePeeringConfig] = js.native
  var privateVisibilityConfig: js.UndefOr[Schema$ManagedZonePrivateVisibilityConfig] = js.native
  var visibility: js.UndefOr[String] = js.native
}

object Schema$ManagedZone {
  @scala.inline
  def apply(
    creationTime: String = null,
    description: String = null,
    dnsName: String = null,
    dnssecConfig: Schema$ManagedZoneDnsSecConfig = null,
    forwardingConfig: Schema$ManagedZoneForwardingConfig = null,
    id: String = null,
    kind: String = null,
    ...
    peeringConfig: Schema$ManagedZonePeeringConfig = null,
    privateVisibilityConfig: Schema$ManagedZonePrivateVisibilityConfig = null,
    ...
    __obj.asInstanceOf[Schema$ManagedZone]
  }
}
