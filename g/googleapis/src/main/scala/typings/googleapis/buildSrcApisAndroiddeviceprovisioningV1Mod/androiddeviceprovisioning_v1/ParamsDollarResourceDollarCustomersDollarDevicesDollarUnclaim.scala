...
@js.native
trait ParamsDollarResourceDollarCustomersDollarDevicesDollarUnclaim extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$CustomerUnclaimDeviceRequest] = js.native
}
