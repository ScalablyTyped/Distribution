...
@js.native
trait ParamsDollarResourceDollarPartnersDollarCustomersDollarCreate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$CreateCustomerRequest] = js.native
}
