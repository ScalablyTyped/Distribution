...
@js.native
trait ParamsDollarResourceDollarPartnersDollarDevicesDollarMetadata extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$UpdateDeviceMetadataRequest] = js.native
}
