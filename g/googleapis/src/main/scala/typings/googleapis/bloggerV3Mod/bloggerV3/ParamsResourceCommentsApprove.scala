...
@js.native
trait ParamsResourceCommentsApprove extends StandardParameters {
  /**
...
object ParamsResourceCommentsApprove {
  @scala.inline
  def apply(): ParamsResourceCommentsApprove = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCommentsApprove]
  }
  @scala.inline
  implicit class ParamsResourceCommentsApproveOps[Self <: ParamsResourceCommentsApprove] (val x: Self) extends AnyVal {
    @scala.inline
