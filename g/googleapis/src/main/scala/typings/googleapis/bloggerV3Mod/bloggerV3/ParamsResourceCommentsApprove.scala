...
trait ParamsResourceCommentsApprove
  extends StObject
...
object ParamsResourceCommentsApprove {
  ...
  @scala.inline
  implicit class ParamsResourceCommentsApproveMutableBuilder[Self <: ParamsResourceCommentsApprove] (val x: Self) extends AnyVal {
