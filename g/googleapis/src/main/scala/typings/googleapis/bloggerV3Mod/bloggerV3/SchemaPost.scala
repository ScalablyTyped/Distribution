...
import typings.googleapis.anon.SelfLinkTotalItems
...
trait SchemaPost extends StObject {
  ...
  /**
    ...
    */
  var replies: js.UndefOr[SelfLinkTotalItems | Null] = js.undefined
...
object SchemaPost {
  ...
  extension [Self <: SchemaPost](x: Self) {
    ...
    inline def setReplies(value: SelfLinkTotalItems): Self = StObject.set(x, "replies", value.asInstanceOf[js.Any])
