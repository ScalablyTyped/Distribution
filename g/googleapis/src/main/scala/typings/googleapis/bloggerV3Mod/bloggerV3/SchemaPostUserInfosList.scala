...
object SchemaPostUserInfosList {
  ...
  implicit class SchemaPostUserInfosListOps[Self <: SchemaPostUserInfosList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaPostUserInfo*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaPostUserInfo]): Self = this.set("items", value.asInstanceOf[js.Any])
