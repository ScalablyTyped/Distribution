...
@js.native
trait ParamsResourceBlogsGetbyurl extends StandardParameters {
...
object ParamsResourceBlogsGetbyurl {
  ...
  @scala.inline
  implicit class ParamsResourceBlogsGetbyurlOps[Self <: ParamsResourceBlogsGetbyurl] (val x: Self) extends AnyVal {
