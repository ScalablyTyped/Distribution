...
object SchemaGoogleCloudServicebrokerV1beta1UpdateServiceInstanceResponse {
  ...
  inline def apply(): SchemaGoogleCloudServicebrokerV1beta1UpdateServiceInstanceResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudServicebrokerV1beta1UpdateServiceInstanceResponse]
  }
  
  extension [Self <: SchemaGoogleCloudServicebrokerV1beta1UpdateServiceInstanceResponse](x: Self) {
