...
trait ParamsResourceProjectsBrokersInstancesGetlastOperation
  extends StObject
...
object ParamsResourceProjectsBrokersInstancesGetlastOperation {
  ...
  inline def apply(): ParamsResourceProjectsBrokersInstancesGetlastOperation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsBrokersInstancesGetlastOperation]
  }
  
  extension [Self <: ParamsResourceProjectsBrokersInstancesGetlastOperation](x: Self) {
