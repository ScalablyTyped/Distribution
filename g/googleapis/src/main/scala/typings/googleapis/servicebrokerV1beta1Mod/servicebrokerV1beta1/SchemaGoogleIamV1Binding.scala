...
/**
  ...
  */
@js.native
trait SchemaGoogleIamV1Binding extends js.Object {
  /**
...
object SchemaGoogleIamV1Binding {
  ...
  @scala.inline
  implicit class SchemaGoogleIamV1BindingOps[Self <: SchemaGoogleIamV1Binding] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setCondition(value: SchemaGoogleTypeExpr): Self = this.set("condition", value.asInstanceOf[js.Any])
    @scala.inline
