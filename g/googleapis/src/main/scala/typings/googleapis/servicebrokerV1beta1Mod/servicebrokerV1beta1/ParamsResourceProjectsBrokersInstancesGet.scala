...
trait ParamsResourceProjectsBrokersInstancesGet
  extends StObject
...
object ParamsResourceProjectsBrokersInstancesGet {
  ...
  inline def apply(): ParamsResourceProjectsBrokersInstancesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsBrokersInstancesGet]
  }
  
  extension [Self <: ParamsResourceProjectsBrokersInstancesGet](x: Self) {
