...
trait SchemaGoogleCloudServicebrokerV1beta1ListCatalogResponse extends StObject {
  ...
  /**
    ...
    */
  var services: js.UndefOr[js.Array[SchemaGoogleCloudServicebrokerV1beta1Service]] = js.undefined
}
object SchemaGoogleCloudServicebrokerV1beta1ListCatalogResponse {
  
  inline def apply(): SchemaGoogleCloudServicebrokerV1beta1ListCatalogResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudServicebrokerV1beta1ListCatalogResponse]
  }
  
  extension [Self <: SchemaGoogleCloudServicebrokerV1beta1ListCatalogResponse](x: Self) {
    ...
    inline def setServices(value: js.Array[SchemaGoogleCloudServicebrokerV1beta1Service]): Self = StObject.set(x, "services", value.asInstanceOf[js.Any])
    
    inline def setServicesUndefined: Self = StObject.set(x, "services", js.undefined)
    
    inline def setServicesVarargs(value: SchemaGoogleCloudServicebrokerV1beta1Service*): Self = StObject.set(x, "services", js.Array(value :_*))
  }
}
