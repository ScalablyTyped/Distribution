...
object SchemaGoogleCloudServicebrokerV1beta1ListServiceInstancesResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudServicebrokerV1beta1ListServiceInstancesResponseMutableBuilder[Self <: SchemaGoogleCloudServicebrokerV1beta1ListServiceInstancesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInstances(value: js.Array[SchemaGoogleCloudServicebrokerV1beta1ServiceInstance]): Self = StObject.set(x, "instances", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInstancesUndefined: Self = StObject.set(x, "instances", js.undefined)
    
    @scala.inline
    def setInstancesVarargs(value: SchemaGoogleCloudServicebrokerV1beta1ServiceInstance*): Self = StObject.set(x, "instances", js.Array(value :_*))
