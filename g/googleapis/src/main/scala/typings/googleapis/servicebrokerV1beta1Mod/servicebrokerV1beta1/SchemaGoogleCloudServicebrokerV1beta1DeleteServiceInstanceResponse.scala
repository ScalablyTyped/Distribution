...
object SchemaGoogleCloudServicebrokerV1beta1DeleteServiceInstanceResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudServicebrokerV1beta1DeleteServiceInstanceResponseOps[Self <: SchemaGoogleCloudServicebrokerV1beta1DeleteServiceInstanceResponse] (val x: Self) extends AnyVal {
    @scala.inline
