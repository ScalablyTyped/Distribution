...
object ParamsResourceProjectsBrokersV2ServiceInstancesServiceBindingsDelete {
  ...
  inline def apply(): ParamsResourceProjectsBrokersV2ServiceInstancesServiceBindingsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsBrokersV2ServiceInstancesServiceBindingsDelete]
  }
  
  extension [Self <: ParamsResourceProjectsBrokersV2ServiceInstancesServiceBindingsDelete](x: Self) {
