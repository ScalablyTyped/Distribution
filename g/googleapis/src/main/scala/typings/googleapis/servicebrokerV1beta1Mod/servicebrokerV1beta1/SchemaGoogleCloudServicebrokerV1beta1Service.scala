...
trait SchemaGoogleCloudServicebrokerV1beta1Service extends StObject {
  ...
  /**
    * Whether the service provides an endpoint to get service bindings.
    */
  var bindings_retrievable: js.UndefOr[Boolean] = js.undefined
  
  /**
    * Information to activate Dashboard SSO feature.
    */
  var dashboard_client: js.UndefOr[SchemaGoogleCloudServicebrokerV1beta1DashboardClient] = js.undefined
  ...
  /**
    ...
    */
  var instances_retrievable: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    */
  var plans: js.UndefOr[js.Array[SchemaGoogleCloudServicebrokerV1beta1Plan]] = js.undefined
...
object SchemaGoogleCloudServicebrokerV1beta1Service {
  ...
  inline def apply(): SchemaGoogleCloudServicebrokerV1beta1Service = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudServicebrokerV1beta1Service]
  }
  
  extension [Self <: SchemaGoogleCloudServicebrokerV1beta1Service](x: Self) {
    ...
    inline def setBinding_retrievable(value: Boolean): Self = StObject.set(x, "binding_retrievable", value.asInstanceOf[js.Any])
    
    inline def setBinding_retrievableUndefined: Self = StObject.set(x, "binding_retrievable", js.undefined)
    
    inline def setBindings_retrievable(value: Boolean): Self = StObject.set(x, "bindings_retrievable", value.asInstanceOf[js.Any])
    
    inline def setBindings_retrievableUndefined: Self = StObject.set(x, "bindings_retrievable", js.undefined)
    
    inline def setDashboard_client(value: SchemaGoogleCloudServicebrokerV1beta1DashboardClient): Self = StObject.set(x, "dashboard_client", value.asInstanceOf[js.Any])
    
    inline def setDashboard_clientUndefined: Self = StObject.set(x, "dashboard_client", js.undefined)
    ...
    inline def setInstances_retrievable(value: Boolean): Self = StObject.set(x, "instances_retrievable", value.asInstanceOf[js.Any])
    
    inline def setInstances_retrievableUndefined: Self = StObject.set(x, "instances_retrievable", js.undefined)
    ...
    inline def setPlan_updateable(value: Boolean): Self = StObject.set(x, "plan_updateable", value.asInstanceOf[js.Any])
    
    inline def setPlan_updateableUndefined: Self = StObject.set(x, "plan_updateable", js.undefined)
    
    inline def setPlans(value: js.Array[SchemaGoogleCloudServicebrokerV1beta1Plan]): Self = StObject.set(x, "plans", value.asInstanceOf[js.Any])
    
    inline def setPlansUndefined: Self = StObject.set(x, "plans", js.undefined)
    
    inline def setPlansVarargs(value: SchemaGoogleCloudServicebrokerV1beta1Plan*): Self = StObject.set(x, "plans", js.Array(value :_*))
