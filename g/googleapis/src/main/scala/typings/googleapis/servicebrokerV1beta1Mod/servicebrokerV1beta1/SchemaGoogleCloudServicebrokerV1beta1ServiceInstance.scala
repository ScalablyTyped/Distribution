...
object SchemaGoogleCloudServicebrokerV1beta1ServiceInstance {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudServicebrokerV1beta1ServiceInstanceMutableBuilder[Self <: SchemaGoogleCloudServicebrokerV1beta1ServiceInstance] (val x: Self) extends AnyVal {
