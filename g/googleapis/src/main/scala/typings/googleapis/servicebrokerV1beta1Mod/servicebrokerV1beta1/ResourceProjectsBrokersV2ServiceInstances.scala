...
class ResourceProjectsBrokersV2ServiceInstances protected () extends StObject {
  ...
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudServicebrokerV1beta1CreateServiceInstanceResponse] = js.native
  ...
  def delete(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudServicebrokerV1beta1DeleteServiceInstanceResponse] = js.native
  ...
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudServicebrokerV1beta1UpdateServiceInstanceResponse] = js.native
