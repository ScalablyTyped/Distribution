...
trait ParamsResourceProjectsBrokersInstancesList
  extends StObject
...
object ParamsResourceProjectsBrokersInstancesList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsBrokersInstancesListMutableBuilder[Self <: ParamsResourceProjectsBrokersInstancesList] (val x: Self) extends AnyVal {
