...
trait ParamsResourceProjectsBrokersInstancesBindingsGetlastOperation
  extends StObject
...
object ParamsResourceProjectsBrokersInstancesBindingsGetlastOperation {
  ...
  inline def apply(): ParamsResourceProjectsBrokersInstancesBindingsGetlastOperation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsBrokersInstancesBindingsGetlastOperation]
  }
  
  extension [Self <: ParamsResourceProjectsBrokersInstancesBindingsGetlastOperation](x: Self) {
