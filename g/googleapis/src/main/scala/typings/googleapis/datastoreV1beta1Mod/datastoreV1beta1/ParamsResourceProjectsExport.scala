...
object ParamsResourceProjectsExport {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsExportOps[Self <: ParamsResourceProjectsExport] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleDatastoreAdminV1beta1ExportEntitiesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
