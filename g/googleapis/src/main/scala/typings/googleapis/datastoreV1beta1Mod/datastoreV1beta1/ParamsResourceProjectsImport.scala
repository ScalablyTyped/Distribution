...
object ParamsResourceProjectsImport {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsImportOps[Self <: ParamsResourceProjectsImport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleDatastoreAdminV1beta1ImportEntitiesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
