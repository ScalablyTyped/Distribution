...
trait SchemaContainerVersionHeader extends StObject {
  ...
  /**
    ...
    */
  var numClients: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Number of custom templates in the container version.
    */
  var numCustomTemplates: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var numZones: js.UndefOr[String | Null] = js.undefined
...
object SchemaContainerVersionHeader {
  ...
  extension [Self <: SchemaContainerVersionHeader](x: Self) {
    ...
    inline def setNumClientsNull: Self = StObject.set(x, "numClients", null)
    ...
    inline def setNumCustomTemplatesNull: Self = StObject.set(x, "numCustomTemplates", null)
    ...
    inline def setNumZonesNull: Self = StObject.set(x, "numZones", null)
