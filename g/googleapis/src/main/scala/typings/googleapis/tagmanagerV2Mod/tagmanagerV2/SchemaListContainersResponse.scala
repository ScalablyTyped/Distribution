...
object SchemaListContainersResponse {
  ...
  implicit class SchemaListContainersResponseOps[Self <: SchemaListContainersResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContainerVarargs(value: SchemaContainer*): Self = this.set("container", js.Array(value :_*))
    
    @scala.inline
    def setContainer(value: js.Array[SchemaContainer]): Self = this.set("container", value.asInstanceOf[js.Any])
