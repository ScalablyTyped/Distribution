...
trait ParamsResourceAccountsContainersEnvironmentsList
  extends StObject
...
object ParamsResourceAccountsContainersEnvironmentsList {
  ...
  inline def apply(): ParamsResourceAccountsContainersEnvironmentsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersEnvironmentsList]
  }
  
  extension [Self <: ParamsResourceAccountsContainersEnvironmentsList](x: Self) {
