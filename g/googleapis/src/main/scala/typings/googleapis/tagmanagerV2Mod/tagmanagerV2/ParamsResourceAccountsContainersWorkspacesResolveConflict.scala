...
trait ParamsResourceAccountsContainersWorkspacesResolveConflict
  extends StObject
...
object ParamsResourceAccountsContainersWorkspacesResolveConflict {
  ...
  inline def apply(): ParamsResourceAccountsContainersWorkspacesResolveConflict = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersWorkspacesResolveConflict]
  }
  
  extension [Self <: ParamsResourceAccountsContainersWorkspacesResolveConflict](x: Self) {
