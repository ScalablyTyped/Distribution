...
object ParamsResourceAccountsContainersVersionsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersVersionsUpdateOps[Self <: ParamsResourceAccountsContainersVersionsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaContainerVersion): Self = this.set("requestBody", value.asInstanceOf[js.Any])
