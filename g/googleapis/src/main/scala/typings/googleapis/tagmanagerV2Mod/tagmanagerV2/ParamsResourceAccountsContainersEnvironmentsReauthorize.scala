...
object ParamsResourceAccountsContainersEnvironmentsReauthorize {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsContainersEnvironmentsReauthorize = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersEnvironmentsReauthorize]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsContainersEnvironmentsReauthorizeMutableBuilder[Self <: ParamsResourceAccountsContainersEnvironmentsReauthorize] (val x: Self) extends AnyVal {
