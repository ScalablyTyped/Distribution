...
object ParamsResourceAccountsContainersWorkspacesBuiltInVariablesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesBuiltInVariablesCreateOps[Self <: ParamsResourceAccountsContainersWorkspacesBuiltInVariablesCreate] (val x: Self) extends AnyVal {
