...
object ParamsResourceAccountsContainersWorkspacesTriggersDelete {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesTriggersDeleteOps[Self <: ParamsResourceAccountsContainersWorkspacesTriggersDelete] (val x: Self) extends AnyVal {
    @scala.inline
