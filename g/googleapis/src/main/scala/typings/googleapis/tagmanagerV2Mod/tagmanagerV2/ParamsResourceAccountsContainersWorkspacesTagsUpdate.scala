...
object ParamsResourceAccountsContainersWorkspacesTagsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesTagsUpdateOps[Self <: ParamsResourceAccountsContainersWorkspacesTagsUpdate] (val x: Self) extends AnyVal {
