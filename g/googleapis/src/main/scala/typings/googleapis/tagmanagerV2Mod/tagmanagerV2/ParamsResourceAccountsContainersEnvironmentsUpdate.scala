...
object ParamsResourceAccountsContainersEnvironmentsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersEnvironmentsUpdateOps[Self <: ParamsResourceAccountsContainersEnvironmentsUpdate] (val x: Self) extends AnyVal {
    @scala.inline
