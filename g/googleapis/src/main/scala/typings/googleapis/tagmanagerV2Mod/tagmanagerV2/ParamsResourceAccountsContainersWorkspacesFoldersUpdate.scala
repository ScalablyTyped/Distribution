...
trait ParamsResourceAccountsContainersWorkspacesFoldersUpdate
  extends StObject
...
object ParamsResourceAccountsContainersWorkspacesFoldersUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesFoldersUpdateMutableBuilder[Self <: ParamsResourceAccountsContainersWorkspacesFoldersUpdate] (val x: Self) extends AnyVal {
