...
object ParamsResourceAccountsContainersWorkspacesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsContainersWorkspacesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersWorkspacesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesCreateMutableBuilder[Self <: ParamsResourceAccountsContainersWorkspacesCreate] (val x: Self) extends AnyVal {
