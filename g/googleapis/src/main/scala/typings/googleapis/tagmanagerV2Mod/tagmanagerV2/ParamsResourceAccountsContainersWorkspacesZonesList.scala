...
object ParamsResourceAccountsContainersWorkspacesZonesList {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesZonesListOps[Self <: ParamsResourceAccountsContainersWorkspacesZonesList] (val x: Self) extends AnyVal {
