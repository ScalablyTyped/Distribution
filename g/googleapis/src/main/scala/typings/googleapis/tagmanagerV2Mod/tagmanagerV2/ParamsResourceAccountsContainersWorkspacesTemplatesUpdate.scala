...
trait ParamsResourceAccountsContainersWorkspacesTemplatesUpdate
  extends StObject
...
object ParamsResourceAccountsContainersWorkspacesTemplatesUpdate {
  
  inline def apply(): ParamsResourceAccountsContainersWorkspacesTemplatesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersWorkspacesTemplatesUpdate]
  }
  
  extension [Self <: ParamsResourceAccountsContainersWorkspacesTemplatesUpdate](x: Self) {
