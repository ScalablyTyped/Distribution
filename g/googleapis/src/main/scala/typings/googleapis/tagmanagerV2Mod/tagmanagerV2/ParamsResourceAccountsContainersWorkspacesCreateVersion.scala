...
object ParamsResourceAccountsContainersWorkspacesCreateVersion {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesCreateVersionOps[Self <: ParamsResourceAccountsContainersWorkspacesCreateVersion] (val x: Self) extends AnyVal {
    @scala.inline
