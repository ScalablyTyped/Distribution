...
object ParamsResourceAccountsContainersWorkspacesList {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsContainersWorkspacesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersWorkspacesList]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesListMutableBuilder[Self <: ParamsResourceAccountsContainersWorkspacesList] (val x: Self) extends AnyVal {
