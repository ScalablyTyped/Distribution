...
object ParamsResourceAccountsContainersWorkspacesZonesUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesZonesUpdateOps[Self <: ParamsResourceAccountsContainersWorkspacesZonesUpdate] (val x: Self) extends AnyVal {
    @scala.inline
