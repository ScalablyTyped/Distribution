...
trait SchemaTag extends StObject {
  ...
  /**
    ...
    */
  var consentSettings: js.UndefOr[SchemaTagConsentSetting] = js.undefined
  ...
  /**
    ...
    */
  var monitoringMetadata: js.UndefOr[SchemaParameter] = js.undefined
  ...
  /**
    ...
    */
  var monitoringMetadataTagNameKey: js.UndefOr[String | Null] = js.undefined
...
object SchemaTag {
  ...
  extension [Self <: SchemaTag](x: Self) {
    ...
    inline def setConsentSettings(value: SchemaTagConsentSetting): Self = StObject.set(x, "consentSettings", value.asInstanceOf[js.Any])
    ...
    inline def setMonitoringMetadata(value: SchemaParameter): Self = StObject.set(x, "monitoringMetadata", value.asInstanceOf[js.Any])
    ...
    inline def setMonitoringMetadataTagNameKeyNull: Self = StObject.set(x, "monitoringMetadataTagNameKey", null)
