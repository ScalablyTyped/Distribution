...
object ParamsResourceAccountsContainersWorkspacesTriggersGet {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsContainersWorkspacesTriggersGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersWorkspacesTriggersGet]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesTriggersGetMutableBuilder[Self <: ParamsResourceAccountsContainersWorkspacesTriggersGet] (val x: Self) extends AnyVal {
