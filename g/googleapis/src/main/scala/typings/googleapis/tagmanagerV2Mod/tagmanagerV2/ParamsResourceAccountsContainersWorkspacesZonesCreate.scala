...
trait ParamsResourceAccountsContainersWorkspacesZonesCreate
  extends StObject
...
object ParamsResourceAccountsContainersWorkspacesZonesCreate {
  ...
  inline def apply(): ParamsResourceAccountsContainersWorkspacesZonesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersWorkspacesZonesCreate]
  }
  
  extension [Self <: ParamsResourceAccountsContainersWorkspacesZonesCreate](x: Self) {
