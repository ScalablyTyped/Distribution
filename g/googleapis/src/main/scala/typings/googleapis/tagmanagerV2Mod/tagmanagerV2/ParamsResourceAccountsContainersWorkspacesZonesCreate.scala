...
object ParamsResourceAccountsContainersWorkspacesZonesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesZonesCreateMutableBuilder[Self <: ParamsResourceAccountsContainersWorkspacesZonesCreate] (val x: Self) extends AnyVal {
