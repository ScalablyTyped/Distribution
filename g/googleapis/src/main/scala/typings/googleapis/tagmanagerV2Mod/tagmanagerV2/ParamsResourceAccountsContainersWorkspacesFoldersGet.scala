...
object ParamsResourceAccountsContainersWorkspacesFoldersGet {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesFoldersGetOps[Self <: ParamsResourceAccountsContainersWorkspacesFoldersGet] (val x: Self) extends AnyVal {
    @scala.inline
