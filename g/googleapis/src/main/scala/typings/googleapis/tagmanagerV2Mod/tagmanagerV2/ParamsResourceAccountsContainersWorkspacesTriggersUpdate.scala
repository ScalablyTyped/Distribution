...
@js.native
trait ParamsResourceAccountsContainersWorkspacesTriggersUpdate extends StandardParameters {
...
object ParamsResourceAccountsContainersWorkspacesTriggersUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsContainersWorkspacesTriggersUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsContainersWorkspacesTriggersUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsContainersWorkspacesTriggersUpdateMutableBuilder[Self <: ParamsResourceAccountsContainersWorkspacesTriggersUpdate] (val x: Self) extends AnyVal {
