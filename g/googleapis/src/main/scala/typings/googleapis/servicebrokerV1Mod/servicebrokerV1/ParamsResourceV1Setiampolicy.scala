...
object ParamsResourceV1Setiampolicy {
  ...
  @scala.inline
  implicit class ParamsResourceV1SetiampolicyOps[Self <: ParamsResourceV1Setiampolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleIamV1SetIamPolicyRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
