...
object ParamsResourceV1Testiampermissions {
  ...
  @scala.inline
  implicit class ParamsResourceV1TestiampermissionsOps[Self <: ParamsResourceV1Testiampermissions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleIamV1TestIamPermissionsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
