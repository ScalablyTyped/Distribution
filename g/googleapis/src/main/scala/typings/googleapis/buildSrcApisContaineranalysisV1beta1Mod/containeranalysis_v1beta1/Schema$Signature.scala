...
/**
  ...
  */
@js.native
trait Schema$Signature extends js.Object {
  /**
...
object Schema$Signature {
  @scala.inline
  def apply(publicKeyId: String = null, signature: String = null): Schema$Signature = {
    val __obj = js.Dynamic.literal()
    if (publicKeyId != null) __obj.updateDynamic("publicKeyId")(publicKeyId.asInstanceOf[js.Any])
    if (signature != null) __obj.updateDynamic("signature")(signature.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$Signature]
  }
}
