...
trait SchemaGoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig](x: Self) {
