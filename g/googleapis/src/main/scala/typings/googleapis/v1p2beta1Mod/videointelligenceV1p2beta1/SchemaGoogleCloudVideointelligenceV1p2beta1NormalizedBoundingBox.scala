...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox extends js.Object {
  /**
    * Bottom Y coordinate.
    */
...
object SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBoxOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1NormalizedBoundingBox] (val x: Self) extends AnyVal {
    @scala.inline
