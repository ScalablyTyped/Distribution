...
object SchemaGoogleCloudVideointelligenceV1p2beta1TextDetectionConfig {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p2beta1TextDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1TextDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1TextDetectionConfig](x: Self) {
