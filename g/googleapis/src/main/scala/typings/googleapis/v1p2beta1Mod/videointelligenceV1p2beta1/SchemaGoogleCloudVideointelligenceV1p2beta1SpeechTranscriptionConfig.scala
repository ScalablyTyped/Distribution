...
object SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfigOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSpeechContextsVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1SpeechContext*): Self = this.set("speechContexts", js.Array(value :_*))
    @scala.inline
    def setSpeechContexts(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1SpeechContext]): Self = this.set("speechContexts", value.asInstanceOf[js.Any])
    @scala.inline
