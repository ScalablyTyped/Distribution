...
/**
  ...
  */
trait SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfig extends StObject {
  ...
  /**
    ...
    */
  var speechContexts: js.UndefOr[js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1SpeechContext]] = js.undefined
}
object SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfig {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfig]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfigMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpeechContexts(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1SpeechContext]): Self = StObject.set(x, "speechContexts", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSpeechContextsUndefined: Self = StObject.set(x, "speechContexts", js.undefined)
    
    @scala.inline
    def setSpeechContextsVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1SpeechContext*): Self = StObject.set(x, "speechContexts", js.Array(value :_*))
  }
}
