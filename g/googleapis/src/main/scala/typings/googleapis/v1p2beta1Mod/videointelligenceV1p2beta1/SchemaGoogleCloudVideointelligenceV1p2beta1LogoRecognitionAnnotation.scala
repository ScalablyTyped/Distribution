...
trait SchemaGoogleCloudVideointelligenceV1p2beta1LogoRecognitionAnnotation extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p2beta1LogoRecognitionAnnotation {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p2beta1LogoRecognitionAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1LogoRecognitionAnnotation]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1LogoRecognitionAnnotation](x: Self) {
    ...
    inline def setSegmentsVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1VideoSegment*): Self = StObject.set(x, "segments", js.Array(value*))
