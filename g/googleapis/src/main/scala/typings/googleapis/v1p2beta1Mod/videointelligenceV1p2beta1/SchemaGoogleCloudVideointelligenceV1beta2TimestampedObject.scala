...
trait SchemaGoogleCloudVideointelligenceV1beta2TimestampedObject extends StObject {
  ...
  /**
    ...
    */
  var landmarks: js.UndefOr[js.Array[SchemaGoogleCloudVideointelligenceV1beta2DetectedLandmark]] = js.undefined
...
object SchemaGoogleCloudVideointelligenceV1beta2TimestampedObject {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1beta2TimestampedObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1beta2TimestampedObject]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1beta2TimestampedObject](x: Self) {
    ...
    inline def setLandmarks(value: js.Array[SchemaGoogleCloudVideointelligenceV1beta2DetectedLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    
    inline def setLandmarksUndefined: Self = StObject.set(x, "landmarks", js.undefined)
    
    inline def setLandmarksVarargs(value: SchemaGoogleCloudVideointelligenceV1beta2DetectedLandmark*): Self = StObject.set(x, "landmarks", js.Array(value*))
