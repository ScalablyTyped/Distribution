...
object SchemaGoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotation {
  ...
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotationOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1ObjectTrackingAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntity(value: SchemaGoogleCloudVideointelligenceV1p2beta1Entity): Self = this.set("entity", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteEntity: Self = this.set("entity", js.undefined)
    
    @scala.inline
    def setFramesVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame*): Self = this.set("frames", js.Array(value :_*))
    
    @scala.inline
    def setFrames(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1ObjectTrackingFrame]): Self = this.set("frames", value.asInstanceOf[js.Any])
