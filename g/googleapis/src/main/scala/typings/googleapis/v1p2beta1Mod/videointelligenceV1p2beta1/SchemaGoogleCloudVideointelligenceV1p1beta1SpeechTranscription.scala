...
object SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscription {
  ...
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscription](x: Self) {
    ...
    inline def setAlternativesVarargs(value: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative*): Self = StObject.set(x, "alternatives", js.Array(value*))
