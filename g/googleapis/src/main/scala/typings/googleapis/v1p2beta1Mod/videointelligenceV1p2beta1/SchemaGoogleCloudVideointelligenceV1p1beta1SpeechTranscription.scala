...
object SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscription {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscription = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscription]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechTranscription](x: Self) {
    
    inline def setAlternatives(value: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative]): Self = StObject.set(x, "alternatives", value.asInstanceOf[js.Any])
    
    inline def setAlternativesUndefined: Self = StObject.set(x, "alternatives", js.undefined)
    
    inline def setAlternativesVarargs(value: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative*): Self = StObject.set(x, "alternatives", js.Array(value :_*))
