...
object SchemaGoogleCloudVideointelligenceV1p3beta1LabelAnnotation {
  @scala.inline
  def apply(
    categoryEntities: js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1Entity] = null,
    entity: SchemaGoogleCloudVideointelligenceV1p3beta1Entity = null,
    frames: js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1LabelFrame] = null,
    segments: js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1LabelSegment] = null
  ): SchemaGoogleCloudVideointelligenceV1p3beta1LabelAnnotation = {
