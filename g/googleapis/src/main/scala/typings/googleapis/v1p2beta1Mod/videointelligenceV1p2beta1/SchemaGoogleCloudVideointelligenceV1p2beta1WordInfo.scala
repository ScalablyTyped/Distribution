...
object SchemaGoogleCloudVideointelligenceV1p2beta1WordInfo {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1WordInfoOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1WordInfo] (val x: Self) extends AnyVal {
