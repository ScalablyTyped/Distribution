...
object SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative](x: Self) {
    ...
    inline def setWords(value: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
    
    inline def setWordsUndefined: Self = StObject.set(x, "words", js.undefined)
    
    inline def setWordsVarargs(value: SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo*): Self = StObject.set(x, "words", js.Array(value :_*))
  }
}
