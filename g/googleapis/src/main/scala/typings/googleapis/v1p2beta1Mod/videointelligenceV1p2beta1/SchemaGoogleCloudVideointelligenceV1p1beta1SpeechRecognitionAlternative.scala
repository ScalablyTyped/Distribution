...
/**
  ...
  */
trait SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative extends StObject {
  ...
  /**
    ...
    */
  var words: js.UndefOr[js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo]] = js.undefined
}
object SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternativeMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWords(value: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordsUndefined: Self = StObject.set(x, "words", js.undefined)
    
    @scala.inline
    def setWordsVarargs(value: SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo*): Self = StObject.set(x, "words", js.Array(value :_*))
  }
}
