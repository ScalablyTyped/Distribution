...
object SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternativeOps[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1SpeechRecognitionAlternative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWordsVarargs(value: SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo*): Self = this.set("words", js.Array(value :_*))
    
    @scala.inline
    def setWords(value: js.Array[SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo]): Self = this.set("words", value.asInstanceOf[js.Any])
