...
/**
  ...
  */
trait SchemaGoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1LabelDetectionConfigMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig] (val x: Self) extends AnyVal {
