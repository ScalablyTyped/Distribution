...
object SchemaGoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig](x: Self) {
