...
trait SchemaGoogleCloudVideointelligenceV1p2beta1VideoContext extends StObject {
  ...
  /**
    ...
    */
  var faceDetectionConfig: js.UndefOr[SchemaGoogleCloudVideointelligenceV1p2beta1FaceDetectionConfig] = js.undefined
  ...
  /**
    ...
    */
  var objectTrackingConfig: js.UndefOr[SchemaGoogleCloudVideointelligenceV1p2beta1ObjectTrackingConfig] = js.undefined
  
  /**
    * Config for PERSON_DETECTION.
    */
  var personDetectionConfig: js.UndefOr[SchemaGoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig] = js.undefined
...
object SchemaGoogleCloudVideointelligenceV1p2beta1VideoContext {
  ...
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1VideoContext](x: Self) {
    ...
    inline def setFaceDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1p2beta1FaceDetectionConfig): Self = StObject.set(x, "faceDetectionConfig", value.asInstanceOf[js.Any])
    ...
    inline def setObjectTrackingConfig(value: SchemaGoogleCloudVideointelligenceV1p2beta1ObjectTrackingConfig): Self = StObject.set(x, "objectTrackingConfig", value.asInstanceOf[js.Any])
    
    inline def setObjectTrackingConfigUndefined: Self = StObject.set(x, "objectTrackingConfig", js.undefined)
    
    inline def setPersonDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig): Self = StObject.set(x, "personDetectionConfig", value.asInstanceOf[js.Any])
