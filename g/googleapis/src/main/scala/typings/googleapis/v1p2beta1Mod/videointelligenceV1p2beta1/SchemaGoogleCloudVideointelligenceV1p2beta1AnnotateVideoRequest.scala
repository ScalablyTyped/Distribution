...
object SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequestOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setVideoContext(value: SchemaGoogleCloudVideointelligenceV1p2beta1VideoContext): Self = this.set("videoContext", value.asInstanceOf[js.Any])
    @scala.inline
