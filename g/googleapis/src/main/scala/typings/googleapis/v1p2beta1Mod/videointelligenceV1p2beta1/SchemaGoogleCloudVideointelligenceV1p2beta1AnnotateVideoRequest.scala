...
object SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest](x: Self) {
    ...
    inline def setVideoContext(value: SchemaGoogleCloudVideointelligenceV1p2beta1VideoContext): Self = StObject.set(x, "videoContext", value.asInstanceOf[js.Any])
