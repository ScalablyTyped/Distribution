...
/**
  ...
  */
trait SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest extends StObject {
  ...
  /**
    ...
    */
  var videoContext: js.UndefOr[SchemaGoogleCloudVideointelligenceV1p2beta1VideoContext] = js.undefined
}
object SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequestMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVideoContext(value: SchemaGoogleCloudVideointelligenceV1p2beta1VideoContext): Self = StObject.set(x, "videoContext", value.asInstanceOf[js.Any])
