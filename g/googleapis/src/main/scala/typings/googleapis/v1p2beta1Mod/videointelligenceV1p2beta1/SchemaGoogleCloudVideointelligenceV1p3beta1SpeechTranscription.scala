...
object SchemaGoogleCloudVideointelligenceV1p3beta1SpeechTranscription {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1SpeechTranscription] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAlternatives(value: js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative]): Self = StObject.set(x, "alternatives", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAlternativesUndefined: Self = StObject.set(x, "alternatives", js.undefined)
    
    @scala.inline
    def setAlternativesVarargs(value: SchemaGoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative*): Self = StObject.set(x, "alternatives", js.Array(value :_*))
