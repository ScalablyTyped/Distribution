...
object SchemaGoogleCloudVideointelligenceV1p3beta1SpeechTranscription {
  ...
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p3beta1SpeechTranscription](x: Self) {
    ...
    inline def setAlternativesVarargs(value: SchemaGoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative*): Self = StObject.set(x, "alternatives", js.Array(value :_*))
