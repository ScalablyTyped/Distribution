...
object SchemaGoogleCloudVideointelligenceV1p3beta1TextSegment {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1TextSegmentMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1TextSegment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFrames(value: js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1TextFrame]): Self = StObject.set(x, "frames", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFramesUndefined: Self = StObject.set(x, "frames", js.undefined)
    
    @scala.inline
    def setFramesVarargs(value: SchemaGoogleCloudVideointelligenceV1p3beta1TextFrame*): Self = StObject.set(x, "frames", js.Array(value :_*))
