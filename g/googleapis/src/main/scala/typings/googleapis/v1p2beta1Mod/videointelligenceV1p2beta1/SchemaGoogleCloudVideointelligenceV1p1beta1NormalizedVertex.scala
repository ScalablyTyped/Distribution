...
object SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedVertex {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedVertex = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedVertex]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedVertex](x: Self) {
