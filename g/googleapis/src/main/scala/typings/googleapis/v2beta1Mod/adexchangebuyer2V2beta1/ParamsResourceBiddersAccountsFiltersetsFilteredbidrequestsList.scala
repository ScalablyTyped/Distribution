...
trait ParamsResourceBiddersAccountsFiltersetsFilteredbidrequestsList
  extends StObject
...
object ParamsResourceBiddersAccountsFiltersetsFilteredbidrequestsList {
  ...
  inline def apply(): ParamsResourceBiddersAccountsFiltersetsFilteredbidrequestsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsFilteredbidrequestsList]
  }
  
  extension [Self <: ParamsResourceBiddersAccountsFiltersetsFilteredbidrequestsList](x: Self) {
