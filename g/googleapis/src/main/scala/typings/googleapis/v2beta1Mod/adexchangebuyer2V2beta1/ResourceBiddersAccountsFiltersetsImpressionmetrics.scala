...
@js.native
open class ResourceBiddersAccountsFiltersetsImpressionmetrics protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList,
