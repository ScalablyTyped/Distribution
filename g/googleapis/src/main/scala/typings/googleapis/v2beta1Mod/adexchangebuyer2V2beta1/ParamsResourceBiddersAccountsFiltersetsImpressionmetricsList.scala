...
trait ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList
  extends StObject
...
object ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList {
  ...
  inline def apply(): ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList]
  }
  
  extension [Self <: ParamsResourceBiddersAccountsFiltersetsImpressionmetricsList](x: Self) {
