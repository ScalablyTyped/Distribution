...
@js.native
open class ResourceBiddersAccountsFiltersets protected () extends StObject {
  ...
  /**
    ...
    */
  def create(params: ParamsResourceBiddersAccountsFiltersetsCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceBiddersAccountsFiltersetsCreate,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def delete(params: ParamsResourceBiddersAccountsFiltersetsDelete, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def delete(
    params: ParamsResourceBiddersAccountsFiltersetsDelete,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def get(params: ParamsResourceBiddersAccountsFiltersetsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceBiddersAccountsFiltersetsGet,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceBiddersAccountsFiltersetsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
