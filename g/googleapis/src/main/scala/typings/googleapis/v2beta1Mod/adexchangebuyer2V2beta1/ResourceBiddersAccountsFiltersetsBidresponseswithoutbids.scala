...
@js.native
open class ResourceBiddersAccountsFiltersetsBidresponseswithoutbids protected () extends StObject {
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaListBidResponsesWithoutBidsResponse] = js.native
  ...
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsBidresponseswithoutbidsList,
    options: BodyResponseCallback[Readable | SchemaListBidResponsesWithoutBidsResponse],
    callback: BodyResponseCallback[Readable | SchemaListBidResponsesWithoutBidsResponse]
  ): Unit = js.native
