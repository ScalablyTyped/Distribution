...
trait ParamsResourceBiddersAccountsFiltersetsFilteredbidsList
  extends StObject
...
object ParamsResourceBiddersAccountsFiltersetsFilteredbidsList {
  ...
  inline def apply(): ParamsResourceBiddersAccountsFiltersetsFilteredbidsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsFilteredbidsList]
  }
  
  extension [Self <: ParamsResourceBiddersAccountsFiltersetsFilteredbidsList](x: Self) {
