...
trait ParamsResourceAccountsProposalsUpdate
  extends StObject
...
object ParamsResourceAccountsProposalsUpdate {
  ...
  inline def apply(): ParamsResourceAccountsProposalsUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsProposalsUpdate]
  }
  
  extension [Self <: ParamsResourceAccountsProposalsUpdate](x: Self) {
