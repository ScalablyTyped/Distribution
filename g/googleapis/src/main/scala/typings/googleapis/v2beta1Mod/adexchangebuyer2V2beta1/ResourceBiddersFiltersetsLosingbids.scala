...
@js.native
open class ResourceBiddersFiltersetsLosingbids protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBiddersFiltersetsLosingbidsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsLosingbidsList,
