...
@js.native
trait ParamsResourceAccountsClientsCreate extends StandardParameters {
...
object ParamsResourceAccountsClientsCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsClientsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsClientsCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsClientsCreateMutableBuilder[Self <: ParamsResourceAccountsClientsCreate] (val x: Self) extends AnyVal {
