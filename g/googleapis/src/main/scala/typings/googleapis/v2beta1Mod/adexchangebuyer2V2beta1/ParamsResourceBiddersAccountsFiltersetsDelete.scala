...
trait ParamsResourceBiddersAccountsFiltersetsDelete
  extends StObject
...
object ParamsResourceBiddersAccountsFiltersetsDelete {
  ...
  inline def apply(): ParamsResourceBiddersAccountsFiltersetsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsDelete]
  }
  
  extension [Self <: ParamsResourceBiddersAccountsFiltersetsDelete](x: Self) {
