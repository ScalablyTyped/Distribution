...
@js.native
open class ResourceBiddersFiltersetsBidmetrics protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBiddersFiltersetsBidmetricsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsBidmetricsList,
