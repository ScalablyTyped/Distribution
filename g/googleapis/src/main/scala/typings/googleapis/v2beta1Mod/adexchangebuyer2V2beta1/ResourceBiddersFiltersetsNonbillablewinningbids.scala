...
@js.native
open class ResourceBiddersFiltersetsNonbillablewinningbids protected () extends StObject {
  ...
  def list(
    params: ParamsResourceBiddersFiltersetsNonbillablewinningbidsList,
    options: BodyResponseCallback[Readable | SchemaListNonBillableWinningBidsResponse],
    callback: BodyResponseCallback[Readable | SchemaListNonBillableWinningBidsResponse]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBiddersFiltersetsNonbillablewinningbidsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsNonbillablewinningbidsList,
