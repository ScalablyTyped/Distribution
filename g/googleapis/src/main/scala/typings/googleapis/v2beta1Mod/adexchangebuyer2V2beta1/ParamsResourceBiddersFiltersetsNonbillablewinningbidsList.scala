...
object ParamsResourceBiddersFiltersetsNonbillablewinningbidsList {
  ...
  inline def apply(): ParamsResourceBiddersFiltersetsNonbillablewinningbidsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersFiltersetsNonbillablewinningbidsList]
  }
  
  extension [Self <: ParamsResourceBiddersFiltersetsNonbillablewinningbidsList](x: Self) {
