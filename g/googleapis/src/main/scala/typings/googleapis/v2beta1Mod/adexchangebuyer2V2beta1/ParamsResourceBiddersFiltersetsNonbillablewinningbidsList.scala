...
trait ParamsResourceBiddersFiltersetsNonbillablewinningbidsList
  extends StObject
...
object ParamsResourceBiddersFiltersetsNonbillablewinningbidsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersFiltersetsNonbillablewinningbidsListMutableBuilder[Self <: ParamsResourceBiddersFiltersetsNonbillablewinningbidsList] (val x: Self) extends AnyVal {
