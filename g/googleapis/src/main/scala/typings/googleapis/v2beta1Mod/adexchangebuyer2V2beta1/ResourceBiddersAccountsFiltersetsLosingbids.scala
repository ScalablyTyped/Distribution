...
@js.native
open class ResourceBiddersAccountsFiltersetsLosingbids protected () extends StObject {
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaListLosingBidsResponse] = js.native
  ...
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsLosingbidsList,
    options: BodyResponseCallback[Readable | SchemaListLosingBidsResponse],
    callback: BodyResponseCallback[Readable | SchemaListLosingBidsResponse]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBiddersAccountsFiltersetsLosingbidsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsLosingbidsList,
