...
trait ParamsResourceBiddersAccountsFiltersetsBidmetricsList
  extends StObject
...
object ParamsResourceBiddersAccountsFiltersetsBidmetricsList {
  
  @scala.inline
  def apply(): ParamsResourceBiddersAccountsFiltersetsBidmetricsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsBidmetricsList]
  }
  
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsBidmetricsListMutableBuilder[Self <: ParamsResourceBiddersAccountsFiltersetsBidmetricsList] (val x: Self) extends AnyVal {
