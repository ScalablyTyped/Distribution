...
object ParamsResourceBiddersAccountsFiltersetsBidmetricsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsBidmetricsListOps[Self <: ParamsResourceBiddersAccountsFiltersetsBidmetricsList] (val x: Self) extends AnyVal {
    @scala.inline
