...
object ParamsResourceBiddersFiltersetsFilteredbidsDetailsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersFiltersetsFilteredbidsDetailsListOps[Self <: ParamsResourceBiddersFiltersetsFilteredbidsDetailsList] (val x: Self) extends AnyVal {
    @scala.inline
