...
@js.native
trait ParamsResourceBiddersAccountsFiltersetsLosingbidsList extends StandardParameters {
...
object ParamsResourceBiddersAccountsFiltersetsLosingbidsList {
  
  @scala.inline
  def apply(): ParamsResourceBiddersAccountsFiltersetsLosingbidsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsLosingbidsList]
  }
  
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsLosingbidsListMutableBuilder[Self <: ParamsResourceBiddersAccountsFiltersetsLosingbidsList] (val x: Self) extends AnyVal {
