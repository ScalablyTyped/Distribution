...
object ParamsResourceBiddersAccountsFiltersetsLosingbidsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsLosingbidsListOps[Self <: ParamsResourceBiddersAccountsFiltersetsLosingbidsList] (val x: Self) extends AnyVal {
    @scala.inline
