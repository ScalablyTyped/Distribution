...
@js.native
trait ParamsResourceBiddersFiltersetsFilteredbidsList extends StandardParameters {
...
object ParamsResourceBiddersFiltersetsFilteredbidsList {
  
  @scala.inline
  def apply(): ParamsResourceBiddersFiltersetsFilteredbidsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersFiltersetsFilteredbidsList]
  }
  
  @scala.inline
  implicit class ParamsResourceBiddersFiltersetsFilteredbidsListMutableBuilder[Self <: ParamsResourceBiddersFiltersetsFilteredbidsList] (val x: Self) extends AnyVal {
