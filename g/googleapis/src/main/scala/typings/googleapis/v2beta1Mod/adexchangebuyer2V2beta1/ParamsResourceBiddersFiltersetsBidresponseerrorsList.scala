...
trait ParamsResourceBiddersFiltersetsBidresponseerrorsList
  extends StObject
...
object ParamsResourceBiddersFiltersetsBidresponseerrorsList {
  ...
  inline def apply(): ParamsResourceBiddersFiltersetsBidresponseerrorsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersFiltersetsBidresponseerrorsList]
  }
  
  extension [Self <: ParamsResourceBiddersFiltersetsBidresponseerrorsList](x: Self) {
