...
trait ParamsResourceBiddersFiltersetsBidmetricsList
  extends StObject
...
object ParamsResourceBiddersFiltersetsBidmetricsList {
  ...
  inline def apply(): ParamsResourceBiddersFiltersetsBidmetricsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersFiltersetsBidmetricsList]
  }
  
  extension [Self <: ParamsResourceBiddersFiltersetsBidmetricsList](x: Self) {
