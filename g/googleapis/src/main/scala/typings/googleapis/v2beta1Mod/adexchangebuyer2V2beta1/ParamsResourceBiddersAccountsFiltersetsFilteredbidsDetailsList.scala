...
object ParamsResourceBiddersAccountsFiltersetsFilteredbidsDetailsList {
  ...
  inline def apply(): ParamsResourceBiddersAccountsFiltersetsFilteredbidsDetailsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsFilteredbidsDetailsList]
  }
  
  extension [Self <: ParamsResourceBiddersAccountsFiltersetsFilteredbidsDetailsList](x: Self) {
