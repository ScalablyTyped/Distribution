...
object ParamsResourceBiddersAccountsFiltersetsFilteredbidsDetailsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsFilteredbidsDetailsListOps[Self <: ParamsResourceBiddersAccountsFiltersetsFilteredbidsDetailsList] (val x: Self) extends AnyVal {
    @scala.inline
