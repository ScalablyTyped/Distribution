...
trait SchemaAdTechnologyProviders extends StObject {
  ...
  /**
    ...
    */
  var hasUnidentifiedProvider: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaAdTechnologyProviders {
  ...
  extension [Self <: SchemaAdTechnologyProviders](x: Self) {
    ...
    inline def setHasUnidentifiedProviderNull: Self = StObject.set(x, "hasUnidentifiedProvider", null)
