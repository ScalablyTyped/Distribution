...
object ParamsResourceBiddersAccountsFiltersetsBidresponseswithoutbidsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsBidresponseswithoutbidsListOps[Self <: ParamsResourceBiddersAccountsFiltersetsBidresponseswithoutbidsList] (val x: Self) extends AnyVal {
