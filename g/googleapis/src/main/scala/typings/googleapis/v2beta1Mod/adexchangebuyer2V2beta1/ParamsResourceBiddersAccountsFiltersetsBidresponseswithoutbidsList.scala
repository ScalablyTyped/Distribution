...
object ParamsResourceBiddersAccountsFiltersetsBidresponseswithoutbidsList {
  ...
  def apply(
  ...
  ): ParamsResourceBiddersAccountsFiltersetsBidresponseswithoutbidsList = {
    ...
    if (filterSetName != null) __obj.updateDynamic("filterSetName")(filterSetName.asInstanceOf[js.Any])
