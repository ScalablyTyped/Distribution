...
trait SchemaClient extends StObject {
  ...
  /**
    ...
    */
  var entityName: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var visibleToSeller: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaClient {
  ...
  extension [Self <: SchemaClient](x: Self) {
    ...
    inline def setEntityNameNull: Self = StObject.set(x, "entityName", null)
    ...
    inline def setVisibleToSellerNull: Self = StObject.set(x, "visibleToSeller", null)
