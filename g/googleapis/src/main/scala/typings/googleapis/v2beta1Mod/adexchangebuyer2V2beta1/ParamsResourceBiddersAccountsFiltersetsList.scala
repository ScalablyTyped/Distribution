...
trait ParamsResourceBiddersAccountsFiltersetsList
  extends StObject
...
object ParamsResourceBiddersAccountsFiltersetsList {
  ...
  inline def apply(): ParamsResourceBiddersAccountsFiltersetsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsList]
  }
  
  extension [Self <: ParamsResourceBiddersAccountsFiltersetsList](x: Self) {
