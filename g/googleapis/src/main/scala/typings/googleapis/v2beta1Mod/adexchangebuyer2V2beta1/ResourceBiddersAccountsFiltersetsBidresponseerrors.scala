...
@js.native
open class ResourceBiddersAccountsFiltersetsBidresponseerrors protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBiddersAccountsFiltersetsBidresponseerrorsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsBidresponseerrorsList,
