...
trait ParamsResourceBiddersFiltersetsBidresponseswithoutbidsList
  extends StObject
...
object ParamsResourceBiddersFiltersetsBidresponseswithoutbidsList {
  ...
  inline def apply(): ParamsResourceBiddersFiltersetsBidresponseswithoutbidsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersFiltersetsBidresponseswithoutbidsList]
  }
  
  extension [Self <: ParamsResourceBiddersFiltersetsBidresponseswithoutbidsList](x: Self) {
