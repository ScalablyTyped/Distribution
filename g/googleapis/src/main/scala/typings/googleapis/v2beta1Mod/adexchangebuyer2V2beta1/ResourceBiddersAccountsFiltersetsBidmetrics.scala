...
@js.native
open class ResourceBiddersAccountsFiltersetsBidmetrics protected () extends StObject {
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaListBidMetricsResponse] = js.native
  ...
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsBidmetricsList,
    options: BodyResponseCallback[Readable | SchemaListBidMetricsResponse],
    callback: BodyResponseCallback[Readable | SchemaListBidMetricsResponse]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBiddersAccountsFiltersetsBidmetricsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsBidmetricsList,
