...
@js.native
open class ResourceBiddersFiltersetsFilteredbidrequests protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBiddersFiltersetsFilteredbidrequestsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsFilteredbidrequestsList,
