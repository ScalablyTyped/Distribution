...
trait ParamsResourceBiddersAccountsFiltersetsGet
  extends StObject
...
object ParamsResourceBiddersAccountsFiltersetsGet {
  ...
  inline def apply(): ParamsResourceBiddersAccountsFiltersetsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsGet]
  }
  
  extension [Self <: ParamsResourceBiddersAccountsFiltersetsGet](x: Self) {
