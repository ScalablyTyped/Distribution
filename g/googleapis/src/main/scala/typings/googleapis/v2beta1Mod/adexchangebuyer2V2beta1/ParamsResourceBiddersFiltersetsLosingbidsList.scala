...
@js.native
trait ParamsResourceBiddersFiltersetsLosingbidsList extends StandardParameters {
...
object ParamsResourceBiddersFiltersetsLosingbidsList {
  
  @scala.inline
  def apply(): ParamsResourceBiddersFiltersetsLosingbidsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersFiltersetsLosingbidsList]
  }
  
  @scala.inline
  implicit class ParamsResourceBiddersFiltersetsLosingbidsListMutableBuilder[Self <: ParamsResourceBiddersFiltersetsLosingbidsList] (val x: Self) extends AnyVal {
