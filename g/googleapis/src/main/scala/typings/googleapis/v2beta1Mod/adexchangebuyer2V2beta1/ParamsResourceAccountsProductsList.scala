...
object ParamsResourceAccountsProductsList {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsProductsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsProductsList]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsProductsListMutableBuilder[Self <: ParamsResourceAccountsProductsList] (val x: Self) extends AnyVal {
