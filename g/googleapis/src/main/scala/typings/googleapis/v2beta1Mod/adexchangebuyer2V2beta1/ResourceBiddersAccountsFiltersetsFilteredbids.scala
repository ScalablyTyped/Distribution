...
@js.native
open class ResourceBiddersAccountsFiltersetsFilteredbids protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBiddersAccountsFiltersetsFilteredbidsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsFilteredbidsList,
