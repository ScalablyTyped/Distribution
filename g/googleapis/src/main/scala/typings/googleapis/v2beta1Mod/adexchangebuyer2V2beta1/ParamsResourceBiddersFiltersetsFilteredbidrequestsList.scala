...
trait ParamsResourceBiddersFiltersetsFilteredbidrequestsList
  extends StObject
...
object ParamsResourceBiddersFiltersetsFilteredbidrequestsList {
  ...
  inline def apply(): ParamsResourceBiddersFiltersetsFilteredbidrequestsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersFiltersetsFilteredbidrequestsList]
  }
  
  extension [Self <: ParamsResourceBiddersFiltersetsFilteredbidrequestsList](x: Self) {
