...
@js.native
open class ResourceBiddersFiltersetsBidresponseswithoutbids protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBiddersFiltersetsBidresponseswithoutbidsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsBidresponseswithoutbidsList,
