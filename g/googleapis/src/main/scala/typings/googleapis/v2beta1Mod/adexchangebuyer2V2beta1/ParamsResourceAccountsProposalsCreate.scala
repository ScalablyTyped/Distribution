...
object ParamsResourceAccountsProposalsCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceAccountsProposalsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsProposalsCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceAccountsProposalsCreateMutableBuilder[Self <: ParamsResourceAccountsProposalsCreate] (val x: Self) extends AnyVal {
