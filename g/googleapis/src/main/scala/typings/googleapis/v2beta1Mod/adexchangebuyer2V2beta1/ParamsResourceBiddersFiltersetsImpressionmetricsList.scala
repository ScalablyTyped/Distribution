...
object ParamsResourceBiddersFiltersetsImpressionmetricsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersFiltersetsImpressionmetricsListOps[Self <: ParamsResourceBiddersFiltersetsImpressionmetricsList] (val x: Self) extends AnyVal {
    @scala.inline
