...
@js.native
trait ParamsResourceBiddersFiltersetsImpressionmetricsList extends StandardParameters {
...
object ParamsResourceBiddersFiltersetsImpressionmetricsList {
  
  @scala.inline
  def apply(): ParamsResourceBiddersFiltersetsImpressionmetricsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersFiltersetsImpressionmetricsList]
  }
  
  @scala.inline
  implicit class ParamsResourceBiddersFiltersetsImpressionmetricsListMutableBuilder[Self <: ParamsResourceBiddersFiltersetsImpressionmetricsList] (val x: Self) extends AnyVal {
