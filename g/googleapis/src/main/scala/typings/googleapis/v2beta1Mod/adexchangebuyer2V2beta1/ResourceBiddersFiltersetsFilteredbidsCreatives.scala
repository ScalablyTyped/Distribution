...
@js.native
open class ResourceBiddersFiltersetsFilteredbidsCreatives protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceBiddersFiltersetsFilteredbidsCreativesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsFilteredbidsCreativesList,
