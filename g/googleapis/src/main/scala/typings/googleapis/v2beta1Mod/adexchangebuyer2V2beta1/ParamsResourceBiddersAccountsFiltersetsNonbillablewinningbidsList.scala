...
object ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsList {
  ...
  inline def apply(): ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsList]
  }
  
  extension [Self <: ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsList](x: Self) {
