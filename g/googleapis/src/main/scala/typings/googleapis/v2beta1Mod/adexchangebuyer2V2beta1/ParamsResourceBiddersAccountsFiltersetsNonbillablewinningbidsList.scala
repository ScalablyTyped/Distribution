...
object ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsListOps[Self <: ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsList] (val x: Self) extends AnyVal {
