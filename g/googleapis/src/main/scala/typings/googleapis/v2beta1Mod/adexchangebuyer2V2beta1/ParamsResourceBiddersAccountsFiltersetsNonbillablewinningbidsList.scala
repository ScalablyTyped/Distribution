...
@js.native
trait ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsList extends StandardParameters {
...
object ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsList {
  
  @scala.inline
  def apply(): ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsList]
  }
  
  @scala.inline
  implicit class ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsListMutableBuilder[Self <: ParamsResourceBiddersAccountsFiltersetsNonbillablewinningbidsList] (val x: Self) extends AnyVal {
