...
object ParamsResourceBiddersFiltersetsFilteredbidsCreativesList {
  ...
  @scala.inline
  implicit class ParamsResourceBiddersFiltersetsFilteredbidsCreativesListOps[Self <: ParamsResourceBiddersFiltersetsFilteredbidsCreativesList] (val x: Self) extends AnyVal {
