...
object ParamsResourceProjectsServiceaccountsSignjwt {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsServiceaccountsSignjwtMutableBuilder[Self <: ParamsResourceProjectsServiceaccountsSignjwt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaSignJwtRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
