...
trait ParamsResourceCustomresourcedefinitionsList
  extends StObject
...
object ParamsResourceCustomresourcedefinitionsList {
  
  inline def apply(): ParamsResourceCustomresourcedefinitionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCustomresourcedefinitionsList]
  }
  
  extension [Self <: ParamsResourceCustomresourcedefinitionsList](x: Self) {
