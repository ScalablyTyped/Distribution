...
class ResourceDollarProjectsDollarLocationsDollarInstances protected () extends js.Object {
  ...
  def failover(params: ParamsDollarResourceDollarProjectsDollarLocationsDollarInstancesDollarFailover): GaxiosPromise[Schema$Operation] = js.native
  def failover(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarInstancesDollarFailover,
    callback: BodyResponseCallback[Schema$Operation]
  ): Unit = js.native
  def failover(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarInstancesDollarFailover,
