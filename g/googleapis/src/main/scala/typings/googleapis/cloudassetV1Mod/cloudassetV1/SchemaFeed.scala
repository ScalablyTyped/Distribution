...
trait SchemaFeed extends StObject {
  ...
  /**
    ...
    */
  var assetNames: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var feedOutputConfig: js.UndefOr[SchemaFeedOutputConfig] = js.undefined
...
object SchemaFeed {
  ...
  extension [Self <: SchemaFeed](x: Self) {
    ...
    inline def setAssetNamesNull: Self = StObject.set(x, "assetNames", null)
    ...
    inline def setFeedOutputConfig(value: SchemaFeedOutputConfig): Self = StObject.set(x, "feedOutputConfig", value.asInstanceOf[js.Any])
