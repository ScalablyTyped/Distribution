...
trait SchemaWindowsApplication extends StObject {
...
object SchemaWindowsApplication {
  
  inline def apply(): SchemaWindowsApplication = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaWindowsApplication]
  }
  
  extension [Self <: SchemaWindowsApplication](x: Self) {
