...
trait ParamsResourceV1Analyzeiampolicy
  extends StObject
...
object ParamsResourceV1Analyzeiampolicy {
  
  inline def apply(): ParamsResourceV1Analyzeiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceV1Analyzeiampolicy]
  }
  
  extension [Self <: ParamsResourceV1Analyzeiampolicy](x: Self) {
