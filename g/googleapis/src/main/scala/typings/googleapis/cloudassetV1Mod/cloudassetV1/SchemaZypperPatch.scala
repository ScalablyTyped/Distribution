...
trait SchemaZypperPatch extends StObject {
...
object SchemaZypperPatch {
  
  inline def apply(): SchemaZypperPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaZypperPatch]
  }
  
  extension [Self <: SchemaZypperPatch](x: Self) {
