...
trait SchemaWindowsUpdatePackage extends StObject {
  
  /**
    * The categories that are associated with this update package.
    */
  var categories: js.UndefOr[js.Array[SchemaWindowsUpdateCategory]] = js.undefined
...
object SchemaWindowsUpdatePackage {
  
  inline def apply(): SchemaWindowsUpdatePackage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaWindowsUpdatePackage]
  }
  
  extension [Self <: SchemaWindowsUpdatePackage](x: Self) {
    
    inline def setCategories(value: js.Array[SchemaWindowsUpdateCategory]): Self = StObject.set(x, "categories", value.asInstanceOf[js.Any])
    
    inline def setCategoriesUndefined: Self = StObject.set(x, "categories", js.undefined)
    
    inline def setCategoriesVarargs(value: SchemaWindowsUpdateCategory*): Self = StObject.set(x, "categories", js.Array(value*))
