...
trait SchemaItem extends StObject {
  ...
  /**
    ...
    */
  var availablePackage: js.UndefOr[SchemaSoftwarePackage] = js.undefined
  ...
  /**
    ...
    */
  var installedPackage: js.UndefOr[SchemaSoftwarePackage] = js.undefined
...
object SchemaItem {
  ...
  extension [Self <: SchemaItem](x: Self) {
    ...
    inline def setAvailablePackage(value: SchemaSoftwarePackage): Self = StObject.set(x, "availablePackage", value.asInstanceOf[js.Any])
    ...
    inline def setInstalledPackage(value: SchemaSoftwarePackage): Self = StObject.set(x, "installedPackage", value.asInstanceOf[js.Any])
