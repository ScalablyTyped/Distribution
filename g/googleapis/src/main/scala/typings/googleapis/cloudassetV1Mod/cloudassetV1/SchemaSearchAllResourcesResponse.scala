...
trait SchemaSearchAllResourcesResponse extends StObject {
  ...
  /**
    ...
    */
  var results: js.UndefOr[js.Array[SchemaResourceSearchResult]] = js.undefined
}
object SchemaSearchAllResourcesResponse {
  ...
  extension [Self <: SchemaSearchAllResourcesResponse](x: Self) {
    ...
    inline def setResults(value: js.Array[SchemaResourceSearchResult]): Self = StObject.set(x, "results", value.asInstanceOf[js.Any])
    
    inline def setResultsUndefined: Self = StObject.set(x, "results", js.undefined)
    
    inline def setResultsVarargs(value: SchemaResourceSearchResult*): Self = StObject.set(x, "results", js.Array(value*))
  }
}
