...
trait SchemaInventory extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[SchemaItem] | Null] = js.undefined
  ...
  /**
    ...
    */
  var osInfo: js.UndefOr[SchemaOsInfo] = js.undefined
...
object SchemaInventory {
  ...
  extension [Self <: SchemaInventory](x: Self) {
    ...
    inline def setOsInfo(value: SchemaOsInfo): Self = StObject.set(x, "osInfo", value.asInstanceOf[js.Any])
