...
trait SchemaWindowsQuickFixEngineeringPackage extends StObject {
...
object SchemaWindowsQuickFixEngineeringPackage {
  
  inline def apply(): SchemaWindowsQuickFixEngineeringPackage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaWindowsQuickFixEngineeringPackage]
  }
  
  extension [Self <: SchemaWindowsQuickFixEngineeringPackage](x: Self) {
