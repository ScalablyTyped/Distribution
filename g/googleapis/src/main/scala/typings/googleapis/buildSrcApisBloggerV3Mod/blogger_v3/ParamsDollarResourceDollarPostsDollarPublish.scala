...
@js.native
trait ParamsDollarResourceDollarPostsDollarPublish extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPostsDollarPublish {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPostsDollarPublish = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPostsDollarPublish]
  }
}
