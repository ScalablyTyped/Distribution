...
@js.native
trait ParamsDollarResourceDollarPostsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPostsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPostsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPostsDollarUpdate]
  }
}
