...
@js.native
trait ParamsDollarResourceDollarPagesDollarRevert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPagesDollarRevert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPagesDollarRevert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPagesDollarRevert]
  }
}
