...
@js.native
trait ParamsDollarResourceDollarPostsDollarRevert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPostsDollarRevert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPostsDollarRevert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPostsDollarRevert]
  }
}
