...
@js.native
trait ParamsDollarResourceDollarCommentsDollarListbyblog extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCommentsDollarListbyblog {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCommentsDollarListbyblog = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCommentsDollarListbyblog]
  }
}
