...
@js.native
trait ParamsDollarResourceDollarPostsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPostsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    view: String = null
  ): ParamsDollarResourceDollarPostsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPostsDollarList]
  }
}
