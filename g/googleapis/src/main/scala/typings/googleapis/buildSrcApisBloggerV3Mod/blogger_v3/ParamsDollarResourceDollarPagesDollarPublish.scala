...
@js.native
trait ParamsDollarResourceDollarPagesDollarPublish extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPagesDollarPublish {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPagesDollarPublish = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPagesDollarPublish]
  }
}
