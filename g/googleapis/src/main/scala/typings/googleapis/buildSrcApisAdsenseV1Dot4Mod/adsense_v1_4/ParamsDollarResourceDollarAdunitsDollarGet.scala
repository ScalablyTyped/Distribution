...
@js.native
trait ParamsDollarResourceDollarAdunitsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAdunitsDollarGet {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAdunitsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAdunitsDollarGet]
  }
}
