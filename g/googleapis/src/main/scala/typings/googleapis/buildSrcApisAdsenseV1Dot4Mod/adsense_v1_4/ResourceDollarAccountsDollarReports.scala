...
@js.native
class ResourceDollarAccountsDollarReports protected () extends js.Object {
  def this(context: APIRequestContext) = this()
  var context: APIRequestContext = js.native
  var saved: ResourceDollarAccountsDollarReportsDollarSaved = js.native
  /**
  ...
  def generate(params: ParamsDollarResourceDollarAccountsDollarReportsDollarGenerate): GaxiosPromise[Schema$AdsenseReportsGenerateResponse] = js.native
  def generate(
    params: ParamsDollarResourceDollarAccountsDollarReportsDollarGenerate,
  ...
  def generate(params: ParamsDollarResourceDollarAccountsDollarReportsDollarGenerate, options: MethodOptions): GaxiosPromise[Schema$AdsenseReportsGenerateResponse] = js.native
  def generate(
    params: ParamsDollarResourceDollarAccountsDollarReportsDollarGenerate,
