...
@js.native
trait Schema$ReportingMetadataEntry extends js.Object {
  /**
...
object Schema$ReportingMetadataEntry {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$ReportingMetadataEntry]
  }
}
