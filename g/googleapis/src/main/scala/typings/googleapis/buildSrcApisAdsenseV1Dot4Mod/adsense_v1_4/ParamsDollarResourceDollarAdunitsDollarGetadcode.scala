...
@js.native
trait ParamsDollarResourceDollarAdunitsDollarGetadcode extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAdunitsDollarGetadcode {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAdunitsDollarGetadcode = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAdunitsDollarGetadcode]
  }
}
