...
@js.native
trait ParamsDollarResourceDollarAdunitsDollarCustomchannelsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAdunitsDollarCustomchannelsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAdunitsDollarCustomchannelsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAdunitsDollarCustomchannelsDollarList]
  }
}
