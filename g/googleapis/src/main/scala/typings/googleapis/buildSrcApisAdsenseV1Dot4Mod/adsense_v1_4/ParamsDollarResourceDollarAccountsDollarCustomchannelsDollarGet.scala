...
@js.native
trait ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarGet {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarGet]
  }
}
