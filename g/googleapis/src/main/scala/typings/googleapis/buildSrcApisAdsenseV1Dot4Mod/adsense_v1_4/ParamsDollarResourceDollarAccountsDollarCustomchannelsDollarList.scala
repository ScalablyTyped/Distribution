...
@js.native
trait ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarList]
  }
}
