...
@js.native
trait ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarAdunitsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarAdunitsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarAdunitsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarCustomchannelsDollarAdunitsDollarList]
  }
}
