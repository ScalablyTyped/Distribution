...
/**
  ...
  */
@js.native
trait Schema$FileShareConfig extends js.Object {
  /**
...
object Schema$FileShareConfig {
  @scala.inline
  def apply(capacityGb: String = null, name: String = null): Schema$FileShareConfig = {
    val __obj = js.Dynamic.literal()
    if (capacityGb != null) __obj.updateDynamic("capacityGb")(capacityGb.asInstanceOf[js.Any])
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$FileShareConfig]
  }
}
