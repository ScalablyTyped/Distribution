...
trait ParamsResourceProjectsWebappsCreate
  extends StObject
...
object ParamsResourceProjectsWebappsCreate {
  
  inline def apply(): ParamsResourceProjectsWebappsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsWebappsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsWebappsCreate](x: Self) {
