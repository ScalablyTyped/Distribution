...
trait SchemaWebAppConfig extends StObject {
  ...
  /**
    ...
    */
  var messagingSenderId: js.UndefOr[String | Null] = js.undefined
...
object SchemaWebAppConfig {
  
  inline def apply(): SchemaWebAppConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaWebAppConfig]
  }
  
  extension [Self <: SchemaWebAppConfig](x: Self) {
    ...
    inline def setMessagingSenderIdNull: Self = StObject.set(x, "messagingSenderId", null)
