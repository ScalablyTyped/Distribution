...
trait ParamsResourceProjectsAddfirebase
  extends StObject
...
object ParamsResourceProjectsAddfirebase {
  
  inline def apply(): ParamsResourceProjectsAddfirebase = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAddfirebase]
  }
  
  extension [Self <: ParamsResourceProjectsAddfirebase](x: Self) {
