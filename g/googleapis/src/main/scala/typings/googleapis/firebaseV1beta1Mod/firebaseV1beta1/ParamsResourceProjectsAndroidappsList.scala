...
trait ParamsResourceProjectsAndroidappsList
  extends StObject
...
object ParamsResourceProjectsAndroidappsList {
  
  inline def apply(): ParamsResourceProjectsAndroidappsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAndroidappsList]
  }
  
  extension [Self <: ParamsResourceProjectsAndroidappsList](x: Self) {
