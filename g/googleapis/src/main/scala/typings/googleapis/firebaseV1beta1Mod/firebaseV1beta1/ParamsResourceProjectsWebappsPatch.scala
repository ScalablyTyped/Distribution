...
trait ParamsResourceProjectsWebappsPatch
  extends StObject
...
object ParamsResourceProjectsWebappsPatch {
  
  inline def apply(): ParamsResourceProjectsWebappsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsWebappsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsWebappsPatch](x: Self) {
