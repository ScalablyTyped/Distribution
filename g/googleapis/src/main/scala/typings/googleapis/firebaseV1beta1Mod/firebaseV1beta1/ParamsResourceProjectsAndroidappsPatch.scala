...
trait ParamsResourceProjectsAndroidappsPatch
  extends StObject
...
object ParamsResourceProjectsAndroidappsPatch {
  
  inline def apply(): ParamsResourceProjectsAndroidappsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAndroidappsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsAndroidappsPatch](x: Self) {
