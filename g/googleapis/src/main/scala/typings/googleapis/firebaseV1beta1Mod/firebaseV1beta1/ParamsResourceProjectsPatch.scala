...
trait ParamsResourceProjectsPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaFirebaseProject] = js.undefined
...
object ParamsResourceProjectsPatch {
  ...
  extension [Self <: ParamsResourceProjectsPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaFirebaseProject): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
