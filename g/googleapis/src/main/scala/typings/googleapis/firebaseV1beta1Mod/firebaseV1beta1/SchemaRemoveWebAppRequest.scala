...
trait SchemaRemoveWebAppRequest extends StObject {
...
object SchemaRemoveWebAppRequest {
  
  inline def apply(): SchemaRemoveWebAppRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRemoveWebAppRequest]
  }
  
  extension [Self <: SchemaRemoveWebAppRequest](x: Self) {
