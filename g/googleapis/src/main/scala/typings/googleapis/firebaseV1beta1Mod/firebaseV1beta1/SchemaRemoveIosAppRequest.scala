...
trait SchemaRemoveIosAppRequest extends StObject {
...
object SchemaRemoveIosAppRequest {
  
  inline def apply(): SchemaRemoveIosAppRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRemoveIosAppRequest]
  }
  
  extension [Self <: SchemaRemoveIosAppRequest](x: Self) {
