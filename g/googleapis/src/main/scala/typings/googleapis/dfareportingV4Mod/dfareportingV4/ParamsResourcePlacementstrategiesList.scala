...
trait ParamsResourcePlacementstrategiesList
  extends StObject
...
object ParamsResourcePlacementstrategiesList {
  
  inline def apply(): ParamsResourcePlacementstrategiesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePlacementstrategiesList]
  }
  
  extension [Self <: ParamsResourcePlacementstrategiesList](x: Self) {
