...
trait SchemaCampaign extends StObject {
  ...
  /**
    ...
    */
  var measurementPartnerLink: js.UndefOr[SchemaMeasurementPartnerCampaignLink] = js.undefined
...
object SchemaCampaign {
  ...
  extension [Self <: SchemaCampaign](x: Self) {
    ...
    inline def setMeasurementPartnerLink(value: SchemaMeasurementPartnerCampaignLink): Self = StObject.set(x, "measurementPartnerLink", value.asInstanceOf[js.Any])
