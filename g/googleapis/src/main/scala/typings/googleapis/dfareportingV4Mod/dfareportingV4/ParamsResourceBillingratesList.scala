...
trait ParamsResourceBillingratesList
  extends StObject
...
object ParamsResourceBillingratesList {
  
  inline def apply(): ParamsResourceBillingratesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingratesList]
  }
  
  extension [Self <: ParamsResourceBillingratesList](x: Self) {
