...
trait ParamsResourcePlacementgroupsList
  ...
  /**
    ...
    */
  var activeStatus: js.UndefOr[js.Array[String]] = js.undefined
...
object ParamsResourcePlacementgroupsList {
  ...
  extension [Self <: ParamsResourcePlacementgroupsList](x: Self) {
    ...
    inline def setActiveStatus(value: js.Array[String]): Self = StObject.set(x, "activeStatus", value.asInstanceOf[js.Any])
