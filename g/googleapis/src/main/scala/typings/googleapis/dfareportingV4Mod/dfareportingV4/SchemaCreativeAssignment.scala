...
trait SchemaCreativeAssignment extends StObject {
  ...
  /**
    ...
    */
  var applyEventTags: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaCreativeAssignment {
  ...
  extension [Self <: SchemaCreativeAssignment](x: Self) {
    ...
    inline def setApplyEventTagsNull: Self = StObject.set(x, "applyEventTags", null)
    ...
    inline def setCompanionCreativeOverridesVarargs(value: SchemaCompanionClickThroughOverride*): Self = StObject.set(x, "companionCreativeOverrides", js.Array(value*))
    ...
    inline def setRichMediaExitOverridesVarargs(value: SchemaRichMediaExitOverride*): Self = StObject.set(x, "richMediaExitOverrides", js.Array(value*))
