...
object ParamsResourceBucketaccesscontrolsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceBucketaccesscontrolsUpdateOps[Self <: ParamsResourceBucketaccesscontrolsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBucketAccessControl): Self = this.set("requestBody", value.asInstanceOf[js.Any])
