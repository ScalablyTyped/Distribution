...
@js.native
trait ParamsResourceObjectaccesscontrolsPatch extends StandardParameters {
...
object ParamsResourceObjectaccesscontrolsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceObjectaccesscontrolsPatchOps[Self <: ParamsResourceObjectaccesscontrolsPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaObjectAccessControl): Self = this.set("requestBody", value.asInstanceOf[js.Any])
