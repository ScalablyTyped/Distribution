...
trait ParamsResourceCatalogsTestiampermissions
  extends StObject
...
object ParamsResourceCatalogsTestiampermissions {
  ...
  inline def apply(): ParamsResourceCatalogsTestiampermissions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCatalogsTestiampermissions]
  }
  
  extension [Self <: ParamsResourceCatalogsTestiampermissions](x: Self) {
