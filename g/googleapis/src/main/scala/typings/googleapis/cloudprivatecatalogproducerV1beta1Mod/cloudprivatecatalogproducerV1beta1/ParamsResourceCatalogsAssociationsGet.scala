...
trait ParamsResourceCatalogsAssociationsGet
  extends StObject
...
object ParamsResourceCatalogsAssociationsGet {
  ...
  inline def apply(): ParamsResourceCatalogsAssociationsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCatalogsAssociationsGet]
  }
  
  extension [Self <: ParamsResourceCatalogsAssociationsGet](x: Self) {
