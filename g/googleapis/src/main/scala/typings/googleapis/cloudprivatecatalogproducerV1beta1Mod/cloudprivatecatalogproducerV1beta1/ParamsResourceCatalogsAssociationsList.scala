...
trait ParamsResourceCatalogsAssociationsList
  extends StObject
...
object ParamsResourceCatalogsAssociationsList {
  ...
  inline def apply(): ParamsResourceCatalogsAssociationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCatalogsAssociationsList]
  }
  
  extension [Self <: ParamsResourceCatalogsAssociationsList](x: Self) {
