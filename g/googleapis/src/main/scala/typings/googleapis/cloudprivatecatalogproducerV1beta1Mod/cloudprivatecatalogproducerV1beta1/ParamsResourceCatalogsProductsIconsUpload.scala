...
object ParamsResourceCatalogsProductsIconsUpload {
  ...
  @scala.inline
  implicit class ParamsResourceCatalogsProductsIconsUploadOps[Self <: ParamsResourceCatalogsProductsIconsUpload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleCloudPrivatecatalogproducerV1beta1UploadIconRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
