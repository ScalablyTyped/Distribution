...
trait ParamsResourceCatalogsAssociationsCreate
  extends StObject
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudPrivatecatalogproducerV1beta1CreateAssociationRequest] = js.undefined
}
