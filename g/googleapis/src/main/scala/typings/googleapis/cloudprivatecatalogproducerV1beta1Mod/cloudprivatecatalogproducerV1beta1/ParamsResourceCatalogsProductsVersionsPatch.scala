...
trait ParamsResourceCatalogsProductsVersionsPatch
  extends StObject
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudPrivatecatalogproducerV1beta1Version] = js.undefined
...
object ParamsResourceCatalogsProductsVersionsPatch {
  ...
  inline def apply(): ParamsResourceCatalogsProductsVersionsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCatalogsProductsVersionsPatch]
  }
  
  extension [Self <: ParamsResourceCatalogsProductsVersionsPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudPrivatecatalogproducerV1beta1Version): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
