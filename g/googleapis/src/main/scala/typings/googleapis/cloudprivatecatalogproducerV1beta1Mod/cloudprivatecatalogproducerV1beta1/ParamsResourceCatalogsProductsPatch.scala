...
object ParamsResourceCatalogsProductsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceCatalogsProductsPatchOps[Self <: ParamsResourceCatalogsProductsPatch] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleCloudPrivatecatalogproducerV1beta1Product): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
