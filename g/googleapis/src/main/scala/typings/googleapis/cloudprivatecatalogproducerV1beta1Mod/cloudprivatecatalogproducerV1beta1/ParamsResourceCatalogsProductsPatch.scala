...
trait ParamsResourceCatalogsProductsPatch
  extends StObject
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudPrivatecatalogproducerV1beta1Product] = js.undefined
...
object ParamsResourceCatalogsProductsPatch {
  ...
  inline def apply(): ParamsResourceCatalogsProductsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCatalogsProductsPatch]
  }
  
  extension [Self <: ParamsResourceCatalogsProductsPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudPrivatecatalogproducerV1beta1Product): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
