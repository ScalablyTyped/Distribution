...
/**
  ...
  */
@js.native
trait Schema$AccountTreeRequest extends js.Object {
...
object Schema$AccountTreeRequest {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$AccountTreeRequest]
  }
}
