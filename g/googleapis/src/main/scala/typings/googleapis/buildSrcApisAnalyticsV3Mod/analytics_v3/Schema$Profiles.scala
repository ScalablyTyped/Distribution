...
/**
  ...
  */
@js.native
trait Schema$Profiles extends js.Object {
  /**
    * A list of views (profiles).
    */
  var items: js.UndefOr[js.Array[Schema$Profile]] = js.native
  /**
...
object Schema$Profiles {
  @scala.inline
  def apply(
    items: js.Array[Schema$Profile] = null,
    ...
    __obj.asInstanceOf[Schema$Profiles]
  }
}
