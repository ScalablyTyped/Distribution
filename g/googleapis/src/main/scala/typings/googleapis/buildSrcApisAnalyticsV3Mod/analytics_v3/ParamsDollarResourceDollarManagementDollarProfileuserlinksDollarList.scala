...
@js.native
trait ParamsDollarResourceDollarManagementDollarProfileuserlinksDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarProfileuserlinksDollarList {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarProfileuserlinksDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarProfileuserlinksDollarList]
  }
}
