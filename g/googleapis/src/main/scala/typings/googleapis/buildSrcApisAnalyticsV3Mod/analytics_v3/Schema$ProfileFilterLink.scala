...
/**
  ...
  */
@js.native
trait Schema$ProfileFilterLink extends js.Object {
  /**
    * Filter for this link.
    */
  var filterRef: js.UndefOr[Schema$FilterRef] = js.native
  /**
...
object Schema$ProfileFilterLink {
  @scala.inline
  def apply(
    filterRef: Schema$FilterRef = null,
    id: String = null,
    kind: String = null,
    profileRef: Schema$ProfileRef = null,
    rank: Int | Double = null,
    selfLink: String = null
  ): Schema$ProfileFilterLink = {
    ...
    __obj.asInstanceOf[Schema$ProfileFilterLink]
  }
}
