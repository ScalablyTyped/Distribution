...
/**
  ...
  */
@js.native
trait Schema$Uploads extends js.Object {
  /**
    * A list of uploads.
    */
  var items: js.UndefOr[js.Array[Schema$Upload]] = js.native
  /**
...
object Schema$Uploads {
  @scala.inline
  def apply(
    items: js.Array[Schema$Upload] = null,
    ...
    __obj.asInstanceOf[Schema$Uploads]
  }
}
