...
@js.native
trait ParamsDollarResourceDollarManagementDollarCustommetricsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarCustommetricsDollarList {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarCustommetricsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarCustommetricsDollarList]
  }
}
