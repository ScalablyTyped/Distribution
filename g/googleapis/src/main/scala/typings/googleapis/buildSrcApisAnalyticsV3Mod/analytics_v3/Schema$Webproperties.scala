...
/**
  ...
  */
@js.native
trait Schema$Webproperties extends js.Object {
  /**
    * A list of web properties.
    */
  var items: js.UndefOr[js.Array[Schema$Webproperty]] = js.native
  /**
...
object Schema$Webproperties {
  @scala.inline
  def apply(
    items: js.Array[Schema$Webproperty] = null,
    ...
    __obj.asInstanceOf[Schema$Webproperties]
  }
}
