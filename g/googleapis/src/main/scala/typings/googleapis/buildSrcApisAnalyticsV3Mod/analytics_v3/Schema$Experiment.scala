...
import typings.googleapis.Anon_NameStatus
...
/**
  ...
  */
@js.native
trait Schema$Experiment extends js.Object {
  /**
  ...
  /**
    ...
    * set to RUNNING.
    */
  var variations: js.UndefOr[js.Array[Anon_NameStatus]] = js.native
  /**
...
object Schema$Experiment {
  ...
  def apply(
    ...
    updated: String = null,
    variations: js.Array[Anon_NameStatus] = null,
    ...
    __obj.asInstanceOf[Schema$Experiment]
  }
}
