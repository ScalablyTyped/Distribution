...
/**
  ...
  */
@js.native
trait Schema$CustomDataSources extends js.Object {
  /**
    * Collection of custom data sources.
    */
  var items: js.UndefOr[js.Array[Schema$CustomDataSource]] = js.native
  /**
...
object Schema$CustomDataSources {
  @scala.inline
  def apply(
    items: js.Array[Schema$CustomDataSource] = null,
    ...
    __obj.asInstanceOf[Schema$CustomDataSources]
  }
}
