...
/**
  ...
  */
@js.native
trait Schema$Segments extends js.Object {
  /**
    * A list of segments.
    */
  var items: js.UndefOr[js.Array[Schema$Segment]] = js.native
  /**
...
object Schema$Segments {
  @scala.inline
  def apply(
    items: js.Array[Schema$Segment] = null,
    ...
    __obj.asInstanceOf[Schema$Segments]
  }
}
