...
@js.native
trait ParamsDollarResourceDollarManagementDollarAccountsummariesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarAccountsummariesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarManagementDollarAccountsummariesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarAccountsummariesDollarList]
  }
}
