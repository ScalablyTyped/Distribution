...
@js.native
trait ParamsDollarResourceDollarManagementDollarUnsampledreportsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarUnsampledreportsDollarList {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarUnsampledreportsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarUnsampledreportsDollarList]
  }
}
