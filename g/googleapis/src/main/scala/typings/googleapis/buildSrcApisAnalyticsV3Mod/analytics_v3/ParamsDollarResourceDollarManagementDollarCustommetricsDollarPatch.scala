...
@js.native
trait ParamsDollarResourceDollarManagementDollarCustommetricsDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarCustommetricsDollarPatch {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarCustommetricsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarCustommetricsDollarPatch]
  }
}
