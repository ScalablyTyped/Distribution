...
@js.native
trait ParamsDollarResourceDollarManagementDollarWebpropertyuserlinksDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarWebpropertyuserlinksDollarList {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarWebpropertyuserlinksDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarWebpropertyuserlinksDollarList]
  }
}
