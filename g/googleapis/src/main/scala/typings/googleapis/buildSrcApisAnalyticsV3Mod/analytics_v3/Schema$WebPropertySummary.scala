...
/**
  ...
  */
@js.native
trait Schema$WebPropertySummary extends js.Object {
  /**
  ...
  /**
    ...
    */
  var profiles: js.UndefOr[js.Array[Schema$ProfileSummary]] = js.native
  /**
...
object Schema$WebPropertySummary {
  @scala.inline
  def apply(
    id: String = null,
    ...
    level: String = null,
    name: String = null,
    profiles: js.Array[Schema$ProfileSummary] = null,
    starred: js.UndefOr[Boolean] = js.undefined,
    websiteUrl: String = null
  ): Schema$WebPropertySummary = {
    ...
    __obj.asInstanceOf[Schema$WebPropertySummary]
  }
}
