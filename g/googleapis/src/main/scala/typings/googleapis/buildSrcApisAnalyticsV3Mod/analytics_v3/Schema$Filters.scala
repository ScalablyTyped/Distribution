...
/**
  ...
  */
@js.native
trait Schema$Filters extends js.Object {
  /**
    * A list of filters.
    */
  var items: js.UndefOr[js.Array[Schema$Filter]] = js.native
  /**
...
object Schema$Filters {
  @scala.inline
  def apply(
    items: js.Array[Schema$Filter] = null,
    ...
    __obj.asInstanceOf[Schema$Filters]
  }
}
