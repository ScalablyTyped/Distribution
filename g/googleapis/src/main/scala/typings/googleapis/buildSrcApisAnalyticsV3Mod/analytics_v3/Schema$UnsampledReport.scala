...
import typings.googleapis.Anon_BucketId
import typings.googleapis.Anon_DocumentId
...
/**
  ...
  */
@js.native
trait Schema$UnsampledReport extends js.Object {
  /**
  ...
  /**
    ...
    */
  var cloudStorageDownloadDetails: js.UndefOr[Anon_BucketId] = js.native
  /**
  ...
  /**
    ...
    */
  var driveDownloadDetails: js.UndefOr[Anon_DocumentId] = js.native
  /**
...
object Schema$UnsampledReport {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$UnsampledReport]
  }
}
