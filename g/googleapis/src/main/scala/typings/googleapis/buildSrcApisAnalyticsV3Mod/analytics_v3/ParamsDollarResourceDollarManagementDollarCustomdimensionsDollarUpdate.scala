...
@js.native
trait ParamsDollarResourceDollarManagementDollarCustomdimensionsDollarUpdate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$CustomDimension] = js.native
  /**
...
object ParamsDollarResourceDollarManagementDollarCustomdimensionsDollarUpdate {
  @scala.inline
  def apply(
    ...
    requestBody: Schema$CustomDimension = null,
    userIp: String = null,
    webPropertyId: String = null
  ): ParamsDollarResourceDollarManagementDollarCustomdimensionsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarCustomdimensionsDollarUpdate]
  }
}
