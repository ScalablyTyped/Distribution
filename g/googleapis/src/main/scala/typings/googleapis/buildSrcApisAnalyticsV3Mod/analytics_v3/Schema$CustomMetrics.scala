...
/**
  ...
  */
@js.native
trait Schema$CustomMetrics extends js.Object {
  /**
    * Collection of custom metrics.
    */
  var items: js.UndefOr[js.Array[Schema$CustomMetric]] = js.native
  /**
...
object Schema$CustomMetrics {
  @scala.inline
  def apply(
    items: js.Array[Schema$CustomMetric] = null,
    ...
    __obj.asInstanceOf[Schema$CustomMetrics]
  }
}
