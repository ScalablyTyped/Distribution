...
@js.native
trait ParamsDollarResourceDollarManagementDollarCustomdatasourcesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagementDollarCustomdatasourcesDollarList {
  @scala.inline
  def apply(
  ...
  ): ParamsDollarResourceDollarManagementDollarCustomdatasourcesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagementDollarCustomdatasourcesDollarList]
  }
}
