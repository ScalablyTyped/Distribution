...
/**
  ...
  */
@js.native
trait Schema$AccountSummary extends js.Object {
  /**
    * Account ID.
    */
  ...
  /**
    ...
    */
  var webProperties: js.UndefOr[js.Array[Schema$WebPropertySummary]] = js.native
}

object Schema$AccountSummary {
  @scala.inline
  def apply(
    id: String = null,
    kind: String = null,
    ...
    webProperties: js.Array[Schema$WebPropertySummary] = null
    ...
    __obj.asInstanceOf[Schema$AccountSummary]
  }
}
