...
@js.native
trait ParamsResourceGroupsInsert extends StandardParameters {
...
object ParamsResourceGroupsInsert {
  ...
  @scala.inline
  def apply(): ParamsResourceGroupsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceGroupsInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceGroupsInsertMutableBuilder[Self <: ParamsResourceGroupsInsert] (val x: Self) extends AnyVal {
