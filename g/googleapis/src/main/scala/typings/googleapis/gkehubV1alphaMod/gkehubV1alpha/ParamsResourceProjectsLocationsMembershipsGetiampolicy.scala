...
trait ParamsResourceProjectsLocationsMembershipsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsMembershipsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsMembershipsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsMembershipsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsMembershipsGetiampolicy](x: Self) {
