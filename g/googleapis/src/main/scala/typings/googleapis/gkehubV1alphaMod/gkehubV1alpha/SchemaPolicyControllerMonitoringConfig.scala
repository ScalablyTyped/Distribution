...
trait SchemaPolicyControllerMonitoringConfig extends StObject {
...
object SchemaPolicyControllerMonitoringConfig {
  
  inline def apply(): SchemaPolicyControllerMonitoringConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPolicyControllerMonitoringConfig]
  }
  
  extension [Self <: SchemaPolicyControllerMonitoringConfig](x: Self) {
