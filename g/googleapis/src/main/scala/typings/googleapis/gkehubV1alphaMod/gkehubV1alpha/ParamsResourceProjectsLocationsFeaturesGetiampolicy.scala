...
trait ParamsResourceProjectsLocationsFeaturesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsFeaturesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsFeaturesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsFeaturesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsFeaturesGetiampolicy](x: Self) {
