...
@JSImport("googleapis/build/src/apis/gkehub/v1alpha", "gkehub_v1alpha.Resource$Projects$Locations$Memberships")
@js.native
open class ResourceProjectsLocationsMemberships protected () extends StObject {
  ...
  def listAdmin(): GaxiosPromise[SchemaListAdminClusterMembershipsResponse] = js.native
  def listAdmin(callback: BodyResponseCallback[SchemaListAdminClusterMembershipsResponse]): Unit = js.native
  def listAdmin(params: Unit, options: MethodOptions): GaxiosPromise[SchemaListAdminClusterMembershipsResponse] = js.native
  def listAdmin(params: ParamsResourceProjectsLocationsMembershipsListadmin): GaxiosPromise[SchemaListAdminClusterMembershipsResponse] = js.native
  def listAdmin(
    params: ParamsResourceProjectsLocationsMembershipsListadmin,
    callback: BodyResponseCallback[SchemaListAdminClusterMembershipsResponse]
  ): Unit = js.native
  def listAdmin(
    params: ParamsResourceProjectsLocationsMembershipsListadmin,
    options: BodyResponseCallback[Readable | SchemaListAdminClusterMembershipsResponse],
    callback: BodyResponseCallback[Readable | SchemaListAdminClusterMembershipsResponse]
  ): Unit = js.native
  def listAdmin(params: ParamsResourceProjectsLocationsMembershipsListadmin, options: MethodOptions): GaxiosPromise[SchemaListAdminClusterMembershipsResponse] = js.native
  def listAdmin(
    params: ParamsResourceProjectsLocationsMembershipsListadmin,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaListAdminClusterMembershipsResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def listAdmin(params: ParamsResourceProjectsLocationsMembershipsListadmin, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def listAdmin(
    params: ParamsResourceProjectsLocationsMembershipsListadmin,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
