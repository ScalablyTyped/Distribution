...
trait SchemaCloudBuildMembershipSpec extends StObject {
...
object SchemaCloudBuildMembershipSpec {
  
  inline def apply(): SchemaCloudBuildMembershipSpec = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCloudBuildMembershipSpec]
  }
  
  extension [Self <: SchemaCloudBuildMembershipSpec](x: Self) {
