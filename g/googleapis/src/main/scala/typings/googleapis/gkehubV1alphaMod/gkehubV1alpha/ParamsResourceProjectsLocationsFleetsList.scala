...
trait ParamsResourceProjectsLocationsFleetsList
  extends StObject
...
object ParamsResourceProjectsLocationsFleetsList {
  
  inline def apply(): ParamsResourceProjectsLocationsFleetsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsFleetsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsFleetsList](x: Self) {
