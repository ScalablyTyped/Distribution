...
trait ParamsResourceProjectsLocationsBackupplansBackupsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsBackupplansBackupsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsBackupplansBackupsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsBackupplansBackupsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsBackupplansBackupsGetiampolicy](x: Self) {
