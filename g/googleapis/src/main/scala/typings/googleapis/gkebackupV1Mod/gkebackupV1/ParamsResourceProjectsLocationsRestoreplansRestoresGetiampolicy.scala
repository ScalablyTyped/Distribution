...
trait ParamsResourceProjectsLocationsRestoreplansRestoresGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsRestoreplansRestoresGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsRestoreplansRestoresGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRestoreplansRestoresGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRestoreplansRestoresGetiampolicy](x: Self) {
