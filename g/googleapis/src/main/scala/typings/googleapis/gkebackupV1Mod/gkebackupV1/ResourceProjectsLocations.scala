...
@JSImport("googleapis/build/src/apis/gkebackup/v1", "gkebackup_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var backupPlans: ResourceProjectsLocationsBackupplans = js.native
  
  var context: APIRequestContext = js.native
  
  def deleteOperations(): GaxiosPromise[SchemaEmpty] = js.native
  def deleteOperations(callback: BodyResponseCallback[SchemaEmpty]): Unit = js.native
  def deleteOperations(params: Unit, options: MethodOptions): GaxiosPromise[SchemaEmpty] = js.native
  def deleteOperations(params: ParamsResourceProjectsLocationsDeleteoperations): GaxiosPromise[SchemaEmpty] = js.native
  def deleteOperations(
    params: ParamsResourceProjectsLocationsDeleteoperations,
  ...
  def deleteOperations(params: ParamsResourceProjectsLocationsDeleteoperations, options: MethodOptions): GaxiosPromise[SchemaEmpty] = js.native
  def deleteOperations(
    params: ParamsResourceProjectsLocationsDeleteoperations,
  ...
  /**
    ...
    */
  def deleteOperations(params: ParamsResourceProjectsLocationsDeleteoperations, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def deleteOperations(
    params: ParamsResourceProjectsLocationsDeleteoperations,
  ...
  var restorePlans: ResourceProjectsLocationsRestoreplans = js.native
}
