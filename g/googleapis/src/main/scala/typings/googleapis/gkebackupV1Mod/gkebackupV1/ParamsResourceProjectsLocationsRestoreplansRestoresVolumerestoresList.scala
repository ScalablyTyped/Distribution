...
trait ParamsResourceProjectsLocationsRestoreplansRestoresVolumerestoresList
  extends StObject
...
object ParamsResourceProjectsLocationsRestoreplansRestoresVolumerestoresList {
  
  inline def apply(): ParamsResourceProjectsLocationsRestoreplansRestoresVolumerestoresList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRestoreplansRestoresVolumerestoresList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRestoreplansRestoresVolumerestoresList](x: Self) {
