...
trait ParamsResourceProjectsLocationsBackupplansList
  extends StObject
...
object ParamsResourceProjectsLocationsBackupplansList {
  
  inline def apply(): ParamsResourceProjectsLocationsBackupplansList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsBackupplansList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsBackupplansList](x: Self) {
