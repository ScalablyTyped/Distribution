...
trait ParamsResourceProjectsLocationsRestoreplansRestoresList
  extends StObject
...
object ParamsResourceProjectsLocationsRestoreplansRestoresList {
  
  inline def apply(): ParamsResourceProjectsLocationsRestoreplansRestoresList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRestoreplansRestoresList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRestoreplansRestoresList](x: Self) {
