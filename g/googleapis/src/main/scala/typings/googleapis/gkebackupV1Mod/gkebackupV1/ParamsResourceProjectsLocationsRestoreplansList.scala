...
trait ParamsResourceProjectsLocationsRestoreplansList
  extends StObject
...
object ParamsResourceProjectsLocationsRestoreplansList {
  
  inline def apply(): ParamsResourceProjectsLocationsRestoreplansList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRestoreplansList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRestoreplansList](x: Self) {
