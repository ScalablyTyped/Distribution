...
trait ParamsResourceProjectsLocationsRestoreplansGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsRestoreplansGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsRestoreplansGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRestoreplansGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRestoreplansGetiampolicy](x: Self) {
