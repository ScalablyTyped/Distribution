...
trait SchemaMetadata extends StObject {
  ...
  /**
    ...
    */
  var completeness: js.UndefOr[SchemaCompleteness] = js.undefined
...
object SchemaMetadata {
  ...
  extension [Self <: SchemaMetadata](x: Self) {
    ...
    inline def setCompleteness(value: SchemaCompleteness): Self = StObject.set(x, "completeness", value.asInstanceOf[js.Any])
