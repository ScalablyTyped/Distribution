...
trait SchemaImageOccurrence extends StObject {
...
object SchemaImageOccurrence {
  
  inline def apply(): SchemaImageOccurrence = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaImageOccurrence]
  }
  
  extension [Self <: SchemaImageOccurrence](x: Self) {
