...
trait SchemaPackageIssue extends StObject {
  ...
  /**
    ...
    */
  var affectedVersion: js.UndefOr[SchemaVersion] = js.undefined
  ...
  /**
    ...
    */
  var fileLocation: js.UndefOr[js.Array[SchemaGrafeasV1FileLocation]] = js.undefined
  
  /**
    * Output only. Whether a fix is available for this package.
    */
  var fixAvailable: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaPackageIssue {
  ...
  extension [Self <: SchemaPackageIssue](x: Self) {
    ...
    inline def setAffectedVersion(value: SchemaVersion): Self = StObject.set(x, "affectedVersion", value.asInstanceOf[js.Any])
    ...
    inline def setFileLocation(value: js.Array[SchemaGrafeasV1FileLocation]): Self = StObject.set(x, "fileLocation", value.asInstanceOf[js.Any])
    
    inline def setFileLocationUndefined: Self = StObject.set(x, "fileLocation", js.undefined)
    
    inline def setFileLocationVarargs(value: SchemaGrafeasV1FileLocation*): Self = StObject.set(x, "fileLocation", js.Array(value*))
    
    inline def setFixAvailable(value: Boolean): Self = StObject.set(x, "fixAvailable", value.asInstanceOf[js.Any])
    
    inline def setFixAvailableNull: Self = StObject.set(x, "fixAvailable", null)
