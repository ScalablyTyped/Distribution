...
/**
  ...
  */
@js.native
trait Schema$NodeConfig extends js.Object {
  /**
    ...
    * support for GPUs.
    */
  var accelerators: js.UndefOr[js.Array[Schema$AcceleratorConfig]] = js.native
  /**
  ...
  /**
    ...
    */
  var taints: js.UndefOr[js.Array[Schema$NodeTaint]] = js.native
}

object Schema$NodeConfig {
  @scala.inline
  def apply(
    accelerators: js.Array[Schema$AcceleratorConfig] = null,
    ...
    taints: js.Array[Schema$NodeTaint] = null
  ): Schema$NodeConfig = {
    ...
    __obj.asInstanceOf[Schema$NodeConfig]
  }
}
