...
/**
  ...
  */
@js.native
trait Schema$SetMonitoringServiceRequest extends js.Object {
  /**
...
object Schema$SetMonitoringServiceRequest {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$SetMonitoringServiceRequest]
  }
}
