...
/**
  ...
  */
@js.native
trait Schema$RollbackNodePoolUpgradeRequest extends js.Object {
  /**
...
object Schema$RollbackNodePoolUpgradeRequest {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$RollbackNodePoolUpgradeRequest]
  }
}
