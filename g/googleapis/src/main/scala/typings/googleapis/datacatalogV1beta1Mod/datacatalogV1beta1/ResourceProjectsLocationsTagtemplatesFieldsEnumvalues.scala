...
@JSImport("googleapis/build/src/apis/datacatalog/v1beta1", "datacatalog_v1beta1.Resource$Projects$Locations$Tagtemplates$Fields$Enumvalues")
@js.native
open class ResourceProjectsLocationsTagtemplatesFieldsEnumvalues protected () extends StObject {
  ...
  def rename(params: ParamsResourceProjectsLocationsTagtemplatesFieldsEnumvaluesRename): GaxiosPromise[SchemaGoogleCloudDatacatalogV1beta1TagTemplateField] = js.native
  def rename(
  ...
  def rename(params: ParamsResourceProjectsLocationsTagtemplatesFieldsEnumvaluesRename, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDatacatalogV1beta1TagTemplateField] = js.native
  def rename(
    params: ParamsResourceProjectsLocationsTagtemplatesFieldsEnumvaluesRename,
