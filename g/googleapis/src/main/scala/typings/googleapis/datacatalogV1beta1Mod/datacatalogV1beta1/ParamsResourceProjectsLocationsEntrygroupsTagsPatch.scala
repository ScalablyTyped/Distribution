...
trait ParamsResourceProjectsLocationsEntrygroupsTagsPatch
  extends StObject
...
object ParamsResourceProjectsLocationsEntrygroupsTagsPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsEntrygroupsTagsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsEntrygroupsTagsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsEntrygroupsTagsPatch](x: Self) {
