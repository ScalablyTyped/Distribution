...
trait ParamsResourceProjectsLocationsTagtemplatesFieldsRename
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDatacatalogV1beta1RenameTagTemplateFieldRequest] = js.undefined
}
object ParamsResourceProjectsLocationsTagtemplatesFieldsRename {
  ...
  extension [Self <: ParamsResourceProjectsLocationsTagtemplatesFieldsRename](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDatacatalogV1beta1RenameTagTemplateFieldRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
