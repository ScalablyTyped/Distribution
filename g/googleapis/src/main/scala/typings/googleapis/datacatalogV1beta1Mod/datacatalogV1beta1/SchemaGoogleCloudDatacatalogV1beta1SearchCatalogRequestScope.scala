...
trait SchemaGoogleCloudDatacatalogV1beta1SearchCatalogRequestScope extends StObject {
...
object SchemaGoogleCloudDatacatalogV1beta1SearchCatalogRequestScope {
  
  inline def apply(): SchemaGoogleCloudDatacatalogV1beta1SearchCatalogRequestScope = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatacatalogV1beta1SearchCatalogRequestScope]
  }
  
  extension [Self <: SchemaGoogleCloudDatacatalogV1beta1SearchCatalogRequestScope](x: Self) {
