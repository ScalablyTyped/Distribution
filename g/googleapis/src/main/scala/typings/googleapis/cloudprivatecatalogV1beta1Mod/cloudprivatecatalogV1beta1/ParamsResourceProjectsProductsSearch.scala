...
trait ParamsResourceProjectsProductsSearch
  extends StObject
...
object ParamsResourceProjectsProductsSearch {
  
  @scala.inline
  def apply(): ParamsResourceProjectsProductsSearch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsProductsSearch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsProductsSearchMutableBuilder[Self <: ParamsResourceProjectsProductsSearch] (val x: Self) extends AnyVal {
