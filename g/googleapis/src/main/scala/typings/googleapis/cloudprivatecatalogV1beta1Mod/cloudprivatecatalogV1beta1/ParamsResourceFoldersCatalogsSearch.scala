...
trait ParamsResourceFoldersCatalogsSearch
  extends StObject
...
object ParamsResourceFoldersCatalogsSearch {
  
  @scala.inline
  def apply(): ParamsResourceFoldersCatalogsSearch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersCatalogsSearch]
  }
  
  @scala.inline
  implicit class ParamsResourceFoldersCatalogsSearchMutableBuilder[Self <: ParamsResourceFoldersCatalogsSearch] (val x: Self) extends AnyVal {
