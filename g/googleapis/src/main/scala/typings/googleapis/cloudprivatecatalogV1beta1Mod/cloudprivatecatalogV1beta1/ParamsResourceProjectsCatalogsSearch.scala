...
trait ParamsResourceProjectsCatalogsSearch
  extends StObject
...
object ParamsResourceProjectsCatalogsSearch {
  ...
  inline def apply(): ParamsResourceProjectsCatalogsSearch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsCatalogsSearch]
  }
  
  extension [Self <: ParamsResourceProjectsCatalogsSearch](x: Self) {
