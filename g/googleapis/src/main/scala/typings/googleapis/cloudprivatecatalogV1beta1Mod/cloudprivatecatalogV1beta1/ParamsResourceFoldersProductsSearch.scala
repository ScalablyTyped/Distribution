...
trait ParamsResourceFoldersProductsSearch
  extends StObject
...
object ParamsResourceFoldersProductsSearch {
  ...
  @scala.inline
  implicit class ParamsResourceFoldersProductsSearchMutableBuilder[Self <: ParamsResourceFoldersProductsSearch] (val x: Self) extends AnyVal {
