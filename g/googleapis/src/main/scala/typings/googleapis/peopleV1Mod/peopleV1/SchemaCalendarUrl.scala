...
trait SchemaCalendarUrl extends StObject {
...
object SchemaCalendarUrl {
  
  inline def apply(): SchemaCalendarUrl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCalendarUrl]
  }
  
  extension [Self <: SchemaCalendarUrl](x: Self) {
