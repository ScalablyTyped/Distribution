...
trait SchemaBatchUpdateContactsRequest extends StObject {
  
  /**
    * Required. A map of resource names to the person data to be updated. Allows up to 200 contacts in a single request.
    */
  var contacts: js.UndefOr[StringDictionary[SchemaPerson] | Null] = js.undefined
...
object SchemaBatchUpdateContactsRequest {
  
  inline def apply(): SchemaBatchUpdateContactsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBatchUpdateContactsRequest]
  }
  
  extension [Self <: SchemaBatchUpdateContactsRequest](x: Self) {
    
    inline def setContacts(value: StringDictionary[SchemaPerson]): Self = StObject.set(x, "contacts", value.asInstanceOf[js.Any])
