...
trait SchemaBatchCreateContactsRequest extends StObject {
  
  /**
    * Required. The contact to create. Allows up to 200 contacts in a single request.
    */
  var contacts: js.UndefOr[js.Array[SchemaContactToCreate]] = js.undefined
...
object SchemaBatchCreateContactsRequest {
  
  inline def apply(): SchemaBatchCreateContactsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBatchCreateContactsRequest]
  }
  
  extension [Self <: SchemaBatchCreateContactsRequest](x: Self) {
    
    inline def setContacts(value: js.Array[SchemaContactToCreate]): Self = StObject.set(x, "contacts", value.asInstanceOf[js.Any])
    
    inline def setContactsUndefined: Self = StObject.set(x, "contacts", js.undefined)
    
    inline def setContactsVarargs(value: SchemaContactToCreate*): Self = StObject.set(x, "contacts", js.Array(value*))
