...
@JSImport("googleapis/build/src/apis/recommender/v1", "recommender_v1.Resource$Projects$Locations$Insighttypes$Insights")
@js.native
open class ResourceProjectsLocationsInsighttypesInsights protected () extends StObject {
  ...
  def get(params: ParamsResourceProjectsLocationsInsighttypesInsightsGet): GaxiosPromise[SchemaGoogleCloudRecommenderV1Insight] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsInsighttypesInsightsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRecommenderV1Insight] = js.native
  def get(
    params: ParamsResourceProjectsLocationsInsighttypesInsightsGet,
  ...
  def list(params: ParamsResourceProjectsLocationsInsighttypesInsightsList): GaxiosPromise[SchemaGoogleCloudRecommenderV1ListInsightsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsLocationsInsighttypesInsightsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRecommenderV1ListInsightsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsInsighttypesInsightsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRecommenderV1ListInsightsResponse]
  ...
  def markAccepted(params: ParamsResourceProjectsLocationsInsighttypesInsightsMarkaccepted): GaxiosPromise[SchemaGoogleCloudRecommenderV1Insight] = js.native
  def markAccepted(
  ...
  def markAccepted(params: ParamsResourceProjectsLocationsInsighttypesInsightsMarkaccepted, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRecommenderV1Insight] = js.native
  def markAccepted(
    params: ParamsResourceProjectsLocationsInsighttypesInsightsMarkaccepted,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRecommenderV1Insight]
