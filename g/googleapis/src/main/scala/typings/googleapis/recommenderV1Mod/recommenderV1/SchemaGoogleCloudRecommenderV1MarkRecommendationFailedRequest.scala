...
trait SchemaGoogleCloudRecommenderV1MarkRecommendationFailedRequest extends StObject {
...
object SchemaGoogleCloudRecommenderV1MarkRecommendationFailedRequest {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1MarkRecommendationFailedRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1MarkRecommendationFailedRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1MarkRecommendationFailedRequest](x: Self) {
