...
trait ParamsResourceProjectsLocationsInsighttypesUpdateconfig
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRecommenderV1InsightTypeConfig] = js.undefined
...
object ParamsResourceProjectsLocationsInsighttypesUpdateconfig {
  ...
  extension [Self <: ParamsResourceProjectsLocationsInsighttypesUpdateconfig](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRecommenderV1InsightTypeConfig): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
