...
trait ParamsResourceProjectsLocationsRecommendersGetconfig
  extends StObject
...
object ParamsResourceProjectsLocationsRecommendersGetconfig {
  
  inline def apply(): ParamsResourceProjectsLocationsRecommendersGetconfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRecommendersGetconfig]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRecommendersGetconfig](x: Self) {
