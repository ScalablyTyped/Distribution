...
trait SchemaGoogleCloudRecommenderV1RecommendationStateInfo extends StObject {
...
object SchemaGoogleCloudRecommenderV1RecommendationStateInfo {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1RecommendationStateInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1RecommendationStateInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1RecommendationStateInfo](x: Self) {
