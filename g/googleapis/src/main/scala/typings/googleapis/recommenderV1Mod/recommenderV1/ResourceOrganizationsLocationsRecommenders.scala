...
@JSImport("googleapis/build/src/apis/recommender/v1", "recommender_v1.Resource$Organizations$Locations$Recommenders")
@js.native
open class ResourceOrganizationsLocationsRecommenders protected () extends StObject {
  ...
  def getConfig(params: ParamsResourceOrganizationsLocationsRecommendersGetconfig): GaxiosPromise[SchemaGoogleCloudRecommenderV1RecommenderConfig] = js.native
  def getConfig(
    params: ParamsResourceOrganizationsLocationsRecommendersGetconfig,
  ...
  def getConfig(params: ParamsResourceOrganizationsLocationsRecommendersGetconfig, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRecommenderV1RecommenderConfig] = js.native
  def getConfig(
    params: ParamsResourceOrganizationsLocationsRecommendersGetconfig,
  ...
  /**
    ...
    */
  def getConfig(params: ParamsResourceOrganizationsLocationsRecommendersGetconfig, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def getConfig(
    params: ParamsResourceOrganizationsLocationsRecommendersGetconfig,
  ...
  var recommendations: ResourceOrganizationsLocationsRecommendersRecommendations = js.native
  ...
  def updateConfig(params: ParamsResourceOrganizationsLocationsRecommendersUpdateconfig): GaxiosPromise[SchemaGoogleCloudRecommenderV1RecommenderConfig] = js.native
  def updateConfig(
    params: ParamsResourceOrganizationsLocationsRecommendersUpdateconfig,
    callback: BodyResponseCallback[SchemaGoogleCloudRecommenderV1RecommenderConfig]
  ): Unit = js.native
  def updateConfig(
    params: ParamsResourceOrganizationsLocationsRecommendersUpdateconfig,
  ...
  def updateConfig(params: ParamsResourceOrganizationsLocationsRecommendersUpdateconfig, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRecommenderV1RecommenderConfig] = js.native
  def updateConfig(
    params: ParamsResourceOrganizationsLocationsRecommendersUpdateconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRecommenderV1RecommenderConfig]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def updateConfig(params: ParamsResourceOrganizationsLocationsRecommendersUpdateconfig, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def updateConfig(
    params: ParamsResourceOrganizationsLocationsRecommendersUpdateconfig,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
