...
trait SchemaGoogleCloudRecommenderV1RecommenderConfig extends StObject {
  ...
  /**
    ...
    */
  var recommenderGenerationConfig: js.UndefOr[SchemaGoogleCloudRecommenderV1RecommenderGenerationConfig] = js.undefined
...
object SchemaGoogleCloudRecommenderV1RecommenderConfig {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1RecommenderConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1RecommenderConfig]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1RecommenderConfig](x: Self) {
    ...
    inline def setRecommenderGenerationConfig(value: SchemaGoogleCloudRecommenderV1RecommenderGenerationConfig): Self = StObject.set(x, "recommenderGenerationConfig", value.asInstanceOf[js.Any])
