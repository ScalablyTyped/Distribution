...
trait ParamsResourceBillingaccountsLocationsInsighttypesInsightsList
  extends StObject
...
object ParamsResourceBillingaccountsLocationsInsighttypesInsightsList {
  
  inline def apply(): ParamsResourceBillingaccountsLocationsInsighttypesInsightsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsLocationsInsighttypesInsightsList]
  }
  
  extension [Self <: ParamsResourceBillingaccountsLocationsInsighttypesInsightsList](x: Self) {
