...
@JSImport("googleapis/build/src/apis/recommender/v1", "recommender_v1.Resource$Organizations$Locations$Insighttypes$Insights")
@js.native
open class ResourceOrganizationsLocationsInsighttypesInsights protected () extends StObject {
  ...
  def get(params: ParamsResourceOrganizationsLocationsInsighttypesInsightsGet): GaxiosPromise[SchemaGoogleCloudRecommenderV1Insight] = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsInsighttypesInsightsGet,
  ...
  def get(params: ParamsResourceOrganizationsLocationsInsighttypesInsightsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRecommenderV1Insight] = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsInsighttypesInsightsGet,
  ...
  /**
    ...
    */
  def get(params: ParamsResourceOrganizationsLocationsInsighttypesInsightsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsInsighttypesInsightsGet,
  ...
  def list(params: ParamsResourceOrganizationsLocationsInsighttypesInsightsList): GaxiosPromise[SchemaGoogleCloudRecommenderV1ListInsightsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsInsighttypesInsightsList,
  ...
  def list(params: ParamsResourceOrganizationsLocationsInsighttypesInsightsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRecommenderV1ListInsightsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsInsighttypesInsightsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRecommenderV1ListInsightsResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceOrganizationsLocationsInsighttypesInsightsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsInsighttypesInsightsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  def markAccepted(params: ParamsResourceOrganizationsLocationsInsighttypesInsightsMarkaccepted): GaxiosPromise[SchemaGoogleCloudRecommenderV1Insight] = js.native
  def markAccepted(
    params: ParamsResourceOrganizationsLocationsInsighttypesInsightsMarkaccepted,
    callback: BodyResponseCallback[SchemaGoogleCloudRecommenderV1Insight]
  ): Unit = js.native
  def markAccepted(
    params: ParamsResourceOrganizationsLocationsInsighttypesInsightsMarkaccepted,
