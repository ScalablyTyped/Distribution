...
trait SchemaGoogleCloudRecommenderV1Insight extends StObject {
  
  /**
    * Recommendations derived from this insight.
    */
  var associatedRecommendations: js.UndefOr[js.Array[SchemaGoogleCloudRecommenderV1InsightRecommendationReference]] = js.undefined
  ...
  /**
    ...
    */
  var stateInfo: js.UndefOr[SchemaGoogleCloudRecommenderV1InsightStateInfo] = js.undefined
...
object SchemaGoogleCloudRecommenderV1Insight {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1Insight = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1Insight]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1Insight](x: Self) {
    
    inline def setAssociatedRecommendations(value: js.Array[SchemaGoogleCloudRecommenderV1InsightRecommendationReference]): Self = StObject.set(x, "associatedRecommendations", value.asInstanceOf[js.Any])
    
    inline def setAssociatedRecommendationsUndefined: Self = StObject.set(x, "associatedRecommendations", js.undefined)
    
    inline def setAssociatedRecommendationsVarargs(value: SchemaGoogleCloudRecommenderV1InsightRecommendationReference*): Self = StObject.set(x, "associatedRecommendations", js.Array(value*))
    ...
    inline def setStateInfo(value: SchemaGoogleCloudRecommenderV1InsightStateInfo): Self = StObject.set(x, "stateInfo", value.asInstanceOf[js.Any])
