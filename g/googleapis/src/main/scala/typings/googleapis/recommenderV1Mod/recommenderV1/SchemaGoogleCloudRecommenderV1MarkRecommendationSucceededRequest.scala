...
trait SchemaGoogleCloudRecommenderV1MarkRecommendationSucceededRequest extends StObject {
...
object SchemaGoogleCloudRecommenderV1MarkRecommendationSucceededRequest {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1MarkRecommendationSucceededRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1MarkRecommendationSucceededRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1MarkRecommendationSucceededRequest](x: Self) {
