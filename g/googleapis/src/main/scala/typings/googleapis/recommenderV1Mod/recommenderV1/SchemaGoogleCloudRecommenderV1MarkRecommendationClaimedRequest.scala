...
trait SchemaGoogleCloudRecommenderV1MarkRecommendationClaimedRequest extends StObject {
...
object SchemaGoogleCloudRecommenderV1MarkRecommendationClaimedRequest {
  
  inline def apply(): SchemaGoogleCloudRecommenderV1MarkRecommendationClaimedRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommenderV1MarkRecommendationClaimedRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRecommenderV1MarkRecommendationClaimedRequest](x: Self) {
