...
@JSImport("googleapis/build/src/apis/recommender/v1", "recommender_v1.Resource$Folders$Locations$Insighttypes$Insights")
@js.native
open class ResourceFoldersLocationsInsighttypesInsights protected () extends StObject {
  ...
  def get(params: ParamsResourceFoldersLocationsInsighttypesInsightsGet): GaxiosPromise[SchemaGoogleCloudRecommenderV1Insight] = js.native
  def get(
  ...
  def get(params: ParamsResourceFoldersLocationsInsighttypesInsightsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRecommenderV1Insight] = js.native
  def get(
    params: ParamsResourceFoldersLocationsInsighttypesInsightsGet,
  ...
  def list(params: ParamsResourceFoldersLocationsInsighttypesInsightsList): GaxiosPromise[SchemaGoogleCloudRecommenderV1ListInsightsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceFoldersLocationsInsighttypesInsightsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRecommenderV1ListInsightsResponse] = js.native
  def list(
    params: ParamsResourceFoldersLocationsInsighttypesInsightsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRecommenderV1ListInsightsResponse]
  ...
  def markAccepted(params: ParamsResourceFoldersLocationsInsighttypesInsightsMarkaccepted): GaxiosPromise[SchemaGoogleCloudRecommenderV1Insight] = js.native
  def markAccepted(
  ...
  def markAccepted(params: ParamsResourceFoldersLocationsInsighttypesInsightsMarkaccepted, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRecommenderV1Insight] = js.native
  def markAccepted(
    params: ParamsResourceFoldersLocationsInsighttypesInsightsMarkaccepted,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRecommenderV1Insight]
