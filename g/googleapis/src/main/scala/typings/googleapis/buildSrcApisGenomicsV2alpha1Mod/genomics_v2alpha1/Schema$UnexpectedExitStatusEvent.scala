...
/**
  ...
  */
@js.native
trait Schema$UnexpectedExitStatusEvent extends js.Object {
  /**
...
object Schema$UnexpectedExitStatusEvent {
  @scala.inline
  def apply(actionId: Int | Double = null, exitStatus: Int | Double = null): Schema$UnexpectedExitStatusEvent = {
    ...
    __obj.asInstanceOf[Schema$UnexpectedExitStatusEvent]
  }
}
