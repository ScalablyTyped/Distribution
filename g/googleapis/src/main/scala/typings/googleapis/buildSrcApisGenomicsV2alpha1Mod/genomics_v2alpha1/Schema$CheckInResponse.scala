...
/**
  ...
  */
@js.native
trait Schema$CheckInResponse extends js.Object {
  /**
...
object Schema$CheckInResponse {
  @scala.inline
  def apply(deadline: String = null, metadata: StringDictionary[js.Any] = null): Schema$CheckInResponse = {
    val __obj = js.Dynamic.literal()
    if (deadline != null) __obj.updateDynamic("deadline")(deadline.asInstanceOf[js.Any])
    if (metadata != null) __obj.updateDynamic("metadata")(metadata.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$CheckInResponse]
  }
}
