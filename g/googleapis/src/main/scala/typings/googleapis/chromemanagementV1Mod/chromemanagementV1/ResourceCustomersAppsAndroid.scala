...
@JSImport("googleapis/build/src/apis/chromemanagement/v1", "chromemanagement_v1.Resource$Customers$Apps$Android")
@js.native
open class ResourceCustomersAppsAndroid protected () extends StObject {
  ...
  def get(params: ParamsResourceCustomersAppsAndroidGet): GaxiosPromise[SchemaGoogleChromeManagementV1AppDetails] = js.native
  def get(
    params: ParamsResourceCustomersAppsAndroidGet,
  ...
  def get(params: ParamsResourceCustomersAppsAndroidGet, options: MethodOptions): GaxiosPromise[SchemaGoogleChromeManagementV1AppDetails] = js.native
  def get(
    params: ParamsResourceCustomersAppsAndroidGet,
  ...
  /**
    ...
    */
  def get(params: ParamsResourceCustomersAppsAndroidGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceCustomersAppsAndroidGet,
