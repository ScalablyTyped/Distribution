...
@JSImport("googleapis/build/src/apis/chromemanagement/v1", "chromemanagement_v1.Resource$Customers$Apps$Web")
@js.native
open class ResourceCustomersAppsWeb protected () extends StObject {
  ...
  def get(params: ParamsResourceCustomersAppsWebGet): GaxiosPromise[SchemaGoogleChromeManagementV1AppDetails] = js.native
  def get(
    params: ParamsResourceCustomersAppsWebGet,
  ...
  def get(params: ParamsResourceCustomersAppsWebGet, options: MethodOptions): GaxiosPromise[SchemaGoogleChromeManagementV1AppDetails] = js.native
  def get(
    params: ParamsResourceCustomersAppsWebGet,
  ...
  /**
    ...
    */
  def get(params: ParamsResourceCustomersAppsWebGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceCustomersAppsWebGet,
