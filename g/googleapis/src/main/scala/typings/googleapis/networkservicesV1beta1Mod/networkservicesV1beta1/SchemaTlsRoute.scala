...
trait SchemaTlsRoute extends StObject {
  ...
  /**
    ...
    */
  var rules: js.UndefOr[js.Array[SchemaTlsRouteRouteRule]] = js.undefined
...
object SchemaTlsRoute {
  
  inline def apply(): SchemaTlsRoute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaTlsRoute]
  }
  
  extension [Self <: SchemaTlsRoute](x: Self) {
    ...
    inline def setRules(value: js.Array[SchemaTlsRouteRouteRule]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
    
    inline def setRulesUndefined: Self = StObject.set(x, "rules", js.undefined)
    
    inline def setRulesVarargs(value: SchemaTlsRouteRouteRule*): Self = StObject.set(x, "rules", js.Array(value*))
