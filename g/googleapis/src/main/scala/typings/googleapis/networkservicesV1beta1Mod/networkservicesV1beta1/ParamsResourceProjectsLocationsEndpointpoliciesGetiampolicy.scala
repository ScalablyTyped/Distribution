...
trait ParamsResourceProjectsLocationsEndpointpoliciesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsEndpointpoliciesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsEndpointpoliciesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsEndpointpoliciesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsEndpointpoliciesGetiampolicy](x: Self) {
