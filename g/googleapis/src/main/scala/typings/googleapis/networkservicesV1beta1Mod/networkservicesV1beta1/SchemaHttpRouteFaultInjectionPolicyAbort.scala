...
trait SchemaHttpRouteFaultInjectionPolicyAbort extends StObject {
...
object SchemaHttpRouteFaultInjectionPolicyAbort {
  
  inline def apply(): SchemaHttpRouteFaultInjectionPolicyAbort = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaHttpRouteFaultInjectionPolicyAbort]
  }
  
  extension [Self <: SchemaHttpRouteFaultInjectionPolicyAbort](x: Self) {
