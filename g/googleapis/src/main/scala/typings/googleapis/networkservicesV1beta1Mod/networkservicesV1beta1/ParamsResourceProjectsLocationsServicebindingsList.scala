...
trait ParamsResourceProjectsLocationsServicebindingsList
  extends StObject
...
object ParamsResourceProjectsLocationsServicebindingsList {
  
  inline def apply(): ParamsResourceProjectsLocationsServicebindingsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsServicebindingsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsServicebindingsList](x: Self) {
