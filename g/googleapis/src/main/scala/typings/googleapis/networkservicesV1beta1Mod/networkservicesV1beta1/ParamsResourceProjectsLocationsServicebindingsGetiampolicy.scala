...
trait ParamsResourceProjectsLocationsServicebindingsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsServicebindingsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsServicebindingsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsServicebindingsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsServicebindingsGetiampolicy](x: Self) {
