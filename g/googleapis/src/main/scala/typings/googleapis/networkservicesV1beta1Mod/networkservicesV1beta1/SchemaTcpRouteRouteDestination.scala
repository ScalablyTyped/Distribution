...
trait SchemaTcpRouteRouteDestination extends StObject {
...
object SchemaTcpRouteRouteDestination {
  
  inline def apply(): SchemaTcpRouteRouteDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaTcpRouteRouteDestination]
  }
  
  extension [Self <: SchemaTcpRouteRouteDestination](x: Self) {
