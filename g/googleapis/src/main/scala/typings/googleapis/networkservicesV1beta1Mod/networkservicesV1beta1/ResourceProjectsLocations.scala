...
@JSImport("googleapis/build/src/apis/networkservices/v1beta1", "networkservices_v1beta1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var endpointPolicies: ResourceProjectsLocationsEndpointpolicies = js.native
  
  var gateways: ResourceProjectsLocationsGateways = js.native
  ...
  var grpcRoutes: ResourceProjectsLocationsGrpcroutes = js.native
  
  var httpRoutes: ResourceProjectsLocationsHttproutes = js.native
  ...
  var meshes: ResourceProjectsLocationsMeshes = js.native
  
  var operations: ResourceProjectsLocationsOperations = js.native
  
  var serviceBindings: ResourceProjectsLocationsServicebindings = js.native
  
  var tcpRoutes: ResourceProjectsLocationsTcproutes = js.native
  
  var tlsRoutes: ResourceProjectsLocationsTlsroutes = js.native
}
