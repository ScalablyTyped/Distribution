...
trait ParamsResourceProjectsLocationsGrpcroutesPatch
  extends StObject
...
object ParamsResourceProjectsLocationsGrpcroutesPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsGrpcroutesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGrpcroutesPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGrpcroutesPatch](x: Self) {
