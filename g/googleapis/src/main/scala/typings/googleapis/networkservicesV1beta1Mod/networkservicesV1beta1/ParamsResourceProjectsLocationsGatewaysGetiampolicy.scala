...
trait ParamsResourceProjectsLocationsGatewaysGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsGatewaysGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsGatewaysGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGatewaysGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGatewaysGetiampolicy](x: Self) {
