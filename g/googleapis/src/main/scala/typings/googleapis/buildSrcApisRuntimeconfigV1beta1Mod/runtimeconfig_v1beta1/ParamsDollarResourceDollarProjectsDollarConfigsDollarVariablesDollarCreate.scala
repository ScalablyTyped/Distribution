...
@js.native
trait ParamsDollarResourceDollarProjectsDollarConfigsDollarVariablesDollarCreate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Variable] = js.native
  /**
