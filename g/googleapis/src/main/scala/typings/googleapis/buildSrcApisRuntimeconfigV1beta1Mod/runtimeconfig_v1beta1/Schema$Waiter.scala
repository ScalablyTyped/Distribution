...
/**
  ...
  */
@js.native
trait Schema$Waiter extends js.Object {
  /**
  ...
  /**
    ...
    */
  var failure: js.UndefOr[Schema$EndCondition] = js.native
  /**
  ...
  /**
    ...
    */
  var success: js.UndefOr[Schema$EndCondition] = js.native
  /**
...
object Schema$Waiter {
  @scala.inline
  def apply(
    createTime: String = null,
    done: js.UndefOr[Boolean] = js.undefined,
    error: Schema$Status = null,
    failure: Schema$EndCondition = null,
    name: String = null,
    success: Schema$EndCondition = null,
    timeout: String = null
  ): Schema$Waiter = {
    ...
    __obj.asInstanceOf[Schema$Waiter]
  }
}
