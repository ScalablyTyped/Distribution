...
@js.native
trait AnonEmailOwnerEmailOwnerDeliveryType extends js.Object {
...
object AnonEmailOwnerEmailOwnerDeliveryType {
  @scala.inline
  def apply(
  ...
  ): AnonEmailOwnerEmailOwnerDeliveryType = {
    ...
    __obj.asInstanceOf[AnonEmailOwnerEmailOwnerDeliveryType]
  }
}
