...
trait SchemaBatchDocumentOutputConfig extends StObject {
...
object SchemaBatchDocumentOutputConfig {
  
  inline def apply(): SchemaBatchDocumentOutputConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBatchDocumentOutputConfig]
  }
  
  extension [Self <: SchemaBatchDocumentOutputConfig](x: Self) {
