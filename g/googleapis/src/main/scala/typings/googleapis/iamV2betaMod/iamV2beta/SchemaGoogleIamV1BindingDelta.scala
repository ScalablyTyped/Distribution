...
trait SchemaGoogleIamV1BindingDelta extends StObject {
...
object SchemaGoogleIamV1BindingDelta {
  
  inline def apply(): SchemaGoogleIamV1BindingDelta = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleIamV1BindingDelta]
  }
  
  extension [Self <: SchemaGoogleIamV1BindingDelta](x: Self) {
