...
trait SchemaYumArtifact extends StObject {
...
object SchemaYumArtifact {
  
  inline def apply(): SchemaYumArtifact = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaYumArtifact]
  }
  
  extension [Self <: SchemaYumArtifact](x: Self) {
