...
@JSImport("googleapis/build/src/apis/artifactregistry/v1", "artifactregistry_v1.Resource$Projects$Locations$Repositories$Files")
@js.native
open class ResourceProjectsLocationsRepositoriesFiles protected () extends StObject {
  ...
  def get(): GaxiosPromise[SchemaGoogleDevtoolsArtifactregistryV1File] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleDevtoolsArtifactregistryV1File]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleDevtoolsArtifactregistryV1File] = js.native
  def get(params: ParamsResourceProjectsLocationsRepositoriesFilesGet): GaxiosPromise[SchemaGoogleDevtoolsArtifactregistryV1File] = js.native
  def get(
    params: ParamsResourceProjectsLocationsRepositoriesFilesGet,
    callback: BodyResponseCallback[SchemaGoogleDevtoolsArtifactregistryV1File]
  ): Unit = js.native
  def get(
    params: ParamsResourceProjectsLocationsRepositoriesFilesGet,
    options: BodyResponseCallback[Readable | SchemaGoogleDevtoolsArtifactregistryV1File],
    callback: BodyResponseCallback[Readable | SchemaGoogleDevtoolsArtifactregistryV1File]
  ): Unit = js.native
  def get(params: ParamsResourceProjectsLocationsRepositoriesFilesGet, options: MethodOptions): GaxiosPromise[SchemaGoogleDevtoolsArtifactregistryV1File] = js.native
  def get(
    params: ParamsResourceProjectsLocationsRepositoriesFilesGet,
