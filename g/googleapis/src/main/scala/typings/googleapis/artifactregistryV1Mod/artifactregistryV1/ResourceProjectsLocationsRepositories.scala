...
@JSImport("googleapis/build/src/apis/artifactregistry/v1", "artifactregistry_v1.Resource$Projects$Locations$Repositories")
@js.native
open class ResourceProjectsLocationsRepositories protected () extends StObject {
  ...
  var dockerImages: ResourceProjectsLocationsRepositoriesDockerimages = js.native
  ...
  var mavenArtifacts: ResourceProjectsLocationsRepositoriesMavenartifacts = js.native
  
  var npmPackages: ResourceProjectsLocationsRepositoriesNpmpackages = js.native
  ...
  var pythonPackages: ResourceProjectsLocationsRepositoriesPythonpackages = js.native
