...
trait SchemaDockerImage extends StObject {
...
object SchemaDockerImage {
  
  inline def apply(): SchemaDockerImage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDockerImage]
  }
  
  extension [Self <: SchemaDockerImage](x: Self) {
    
    inline def setBuildTime(value: String): Self = StObject.set(x, "buildTime", value.asInstanceOf[js.Any])
    
    inline def setBuildTimeNull: Self = StObject.set(x, "buildTime", null)
    ...
    inline def setImageSizeBytesNull: Self = StObject.set(x, "imageSizeBytes", null)
