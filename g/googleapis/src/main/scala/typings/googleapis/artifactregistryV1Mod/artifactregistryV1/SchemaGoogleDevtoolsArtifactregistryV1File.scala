...
trait SchemaGoogleDevtoolsArtifactregistryV1File extends StObject {
...
object SchemaGoogleDevtoolsArtifactregistryV1File {
  
  inline def apply(): SchemaGoogleDevtoolsArtifactregistryV1File = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleDevtoolsArtifactregistryV1File]
  }
  
  extension [Self <: SchemaGoogleDevtoolsArtifactregistryV1File](x: Self) {
