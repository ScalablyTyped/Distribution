...
object youtubeMod {
  ...
  object auth extends Shortcut {
    ...
    @JSImport("googleapis/build/src/apis/youtube", "auth")
    @js.native
    val ^ : AuthPlus = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/youtube", "auth.Compute")
    @js.native
    /**
    ...
    /**
      ...
      */
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/youtube", "auth.DefaultTransporter")
    @js.native
    ...
    object DefaultTransporter {
      ...
      @JSImport("googleapis/build/src/apis/youtube", "auth.DefaultTransporter.constructor")
      @js.native
      def constructor(): js.Any = js.native
    }
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/youtube", "auth.JWT")
    @js.native
    class JWT protected ()
    ...
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("googleapis/build/src/apis/youtube", "auth.OAuth2")
    @js.native
    /**
  ...
  @JSImport("googleapis/build/src/apis/youtube", "youtube")
  @js.native
