...
trait SchemaGoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec extends StObject {
...
object SchemaGoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaSearchRequestQueryExpansionSpec](x: Self) {
