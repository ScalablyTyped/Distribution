...
trait ParamsResourceProjectsLocationsCatalogsUpdateattributesconfig
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2alphaAttributesConfig] = js.undefined
...
object ParamsResourceProjectsLocationsCatalogsUpdateattributesconfig {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsUpdateattributesconfig](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2alphaAttributesConfig): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
