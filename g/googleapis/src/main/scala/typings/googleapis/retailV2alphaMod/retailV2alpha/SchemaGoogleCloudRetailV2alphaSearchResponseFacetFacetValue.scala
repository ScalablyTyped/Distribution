...
trait SchemaGoogleCloudRetailV2alphaSearchResponseFacetFacetValue extends StObject {
  ...
  /**
    ...
    */
  var interval: js.UndefOr[SchemaGoogleCloudRetailV2alphaInterval] = js.undefined
...
object SchemaGoogleCloudRetailV2alphaSearchResponseFacetFacetValue {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaSearchResponseFacetFacetValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaSearchResponseFacetFacetValue]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaSearchResponseFacetFacetValue](x: Self) {
    ...
    inline def setInterval(value: SchemaGoogleCloudRetailV2alphaInterval): Self = StObject.set(x, "interval", value.asInstanceOf[js.Any])
