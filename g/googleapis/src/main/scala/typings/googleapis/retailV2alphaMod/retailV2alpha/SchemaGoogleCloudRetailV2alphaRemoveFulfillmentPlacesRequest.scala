...
trait SchemaGoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest extends StObject {
...
object SchemaGoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest](x: Self) {
