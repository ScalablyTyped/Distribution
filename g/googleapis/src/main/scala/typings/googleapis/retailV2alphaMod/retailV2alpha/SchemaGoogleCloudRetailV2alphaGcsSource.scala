...
trait SchemaGoogleCloudRetailV2alphaGcsSource extends StObject {
...
object SchemaGoogleCloudRetailV2alphaGcsSource {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaGcsSource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaGcsSource]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaGcsSource](x: Self) {
