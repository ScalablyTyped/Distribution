...
trait SchemaGoogleCloudRetailV2alphaAudience extends StObject {
...
object SchemaGoogleCloudRetailV2alphaAudience {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaAudience = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaAudience]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaAudience](x: Self) {
