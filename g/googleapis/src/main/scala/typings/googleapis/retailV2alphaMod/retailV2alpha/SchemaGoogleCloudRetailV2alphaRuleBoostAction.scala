...
trait SchemaGoogleCloudRetailV2alphaRuleBoostAction extends StObject {
...
object SchemaGoogleCloudRetailV2alphaRuleBoostAction {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaRuleBoostAction = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaRuleBoostAction]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaRuleBoostAction](x: Self) {
