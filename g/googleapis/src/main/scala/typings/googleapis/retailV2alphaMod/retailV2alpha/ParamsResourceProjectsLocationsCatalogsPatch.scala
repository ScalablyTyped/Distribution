...
trait ParamsResourceProjectsLocationsCatalogsPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2alphaCatalog] = js.undefined
...
object ParamsResourceProjectsLocationsCatalogsPatch {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2alphaCatalog): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
