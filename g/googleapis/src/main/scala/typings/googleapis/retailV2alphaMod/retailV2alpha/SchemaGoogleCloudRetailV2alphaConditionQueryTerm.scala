...
trait SchemaGoogleCloudRetailV2alphaConditionQueryTerm extends StObject {
...
object SchemaGoogleCloudRetailV2alphaConditionQueryTerm {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaConditionQueryTerm = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaConditionQueryTerm]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaConditionQueryTerm](x: Self) {
