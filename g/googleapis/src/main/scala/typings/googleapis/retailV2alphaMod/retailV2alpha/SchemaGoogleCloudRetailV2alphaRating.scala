...
trait SchemaGoogleCloudRetailV2alphaRating extends StObject {
...
object SchemaGoogleCloudRetailV2alphaRating {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaRating = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaRating]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaRating](x: Self) {
