...
trait ParamsResourceProjectsLocationsCatalogsModelsPatch
  extends StObject
...
object ParamsResourceProjectsLocationsCatalogsModelsPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsCatalogsModelsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCatalogsModelsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCatalogsModelsPatch](x: Self) {
