...
trait SchemaGoogleCloudRetailV2ImportUserEventsResponse extends StObject {
  ...
  /**
    ...
    */
  var importSummary: js.UndefOr[SchemaGoogleCloudRetailV2UserEventImportSummary] = js.undefined
}
object SchemaGoogleCloudRetailV2ImportUserEventsResponse {
  
  inline def apply(): SchemaGoogleCloudRetailV2ImportUserEventsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2ImportUserEventsResponse]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2ImportUserEventsResponse](x: Self) {
    ...
    inline def setImportSummary(value: SchemaGoogleCloudRetailV2UserEventImportSummary): Self = StObject.set(x, "importSummary", value.asInstanceOf[js.Any])
