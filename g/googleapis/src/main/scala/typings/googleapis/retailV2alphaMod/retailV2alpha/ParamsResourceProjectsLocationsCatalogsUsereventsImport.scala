...
trait ParamsResourceProjectsLocationsCatalogsUsereventsImport
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2alphaImportUserEventsRequest] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsUsereventsImport {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsUsereventsImport](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2alphaImportUserEventsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
