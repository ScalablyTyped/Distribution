...
@JSImport("googleapis/build/src/apis/retail/v2alpha", "retail_v2alpha.Resource$Projects$Locations$Catalogs$Branches$Products")
@js.native
open class ResourceProjectsLocationsCatalogsBranchesProducts protected () extends StObject {
  ...
  def create(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def create(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaProduct]): Unit = js.native
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def create(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsCreate): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def create(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsCreate,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaProduct]
  ): Unit = js.native
  def create(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsCreate,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaProduct],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaProduct]
  ): Unit = js.native
  def create(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def create(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsCreate,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaProduct]
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaProduct]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def get(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsGet): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def get(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaProduct]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaListProductsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaListProductsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaListProductsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsList): GaxiosPromise[SchemaGoogleCloudRetailV2alphaListProductsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsList,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaListProductsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaListProductsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaListProductsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaListProductsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaListProductsResponse]
  ...
  def patch(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaProduct]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def patch(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPatch): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaProduct] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaProduct]
  ...
  def purge(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPurge): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def purge(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPurge,
    callback: BodyResponseCallback[SchemaGoogleLongrunningOperation]
  ): Unit = js.native
  def purge(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPurge,
  ...
  def purge(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPurge, options: MethodOptions): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def purge(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPurge,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleLongrunningOperation]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def purge(params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPurge, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def purge(
    params: ParamsResourceProjectsLocationsCatalogsBranchesProductsPurge,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
