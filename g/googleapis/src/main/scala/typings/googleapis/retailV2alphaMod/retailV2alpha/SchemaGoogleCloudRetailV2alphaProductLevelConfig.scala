...
trait SchemaGoogleCloudRetailV2alphaProductLevelConfig extends StObject {
...
object SchemaGoogleCloudRetailV2alphaProductLevelConfig {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaProductLevelConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaProductLevelConfig]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaProductLevelConfig](x: Self) {
