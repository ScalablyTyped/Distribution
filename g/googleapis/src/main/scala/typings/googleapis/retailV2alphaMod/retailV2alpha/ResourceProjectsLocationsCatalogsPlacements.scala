...
@JSImport("googleapis/build/src/apis/retail/v2alpha", "retail_v2alpha.Resource$Projects$Locations$Catalogs$Placements")
@js.native
open class ResourceProjectsLocationsCatalogsPlacements protected () extends StObject {
  ...
  def predict(params: ParamsResourceProjectsLocationsCatalogsPlacementsPredict): GaxiosPromise[SchemaGoogleCloudRetailV2alphaPredictResponse] = js.native
  def predict(
  ...
  def predict(params: ParamsResourceProjectsLocationsCatalogsPlacementsPredict, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaPredictResponse] = js.native
  def predict(
    params: ParamsResourceProjectsLocationsCatalogsPlacementsPredict,
  ...
  def search(params: ParamsResourceProjectsLocationsCatalogsPlacementsSearch): GaxiosPromise[SchemaGoogleCloudRetailV2alphaSearchResponse] = js.native
  def search(
  ...
  def search(params: ParamsResourceProjectsLocationsCatalogsPlacementsSearch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaSearchResponse] = js.native
  def search(
    params: ParamsResourceProjectsLocationsCatalogsPlacementsSearch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaSearchResponse]
