...
trait SchemaGoogleCloudRetailV2alphaSearchRequestBoostSpec extends StObject {
  ...
  /**
    ...
    */
  var conditionBoostSpecs: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2alphaSearchRequestBoostSpecConditionBoostSpec]] = js.undefined
...
object SchemaGoogleCloudRetailV2alphaSearchRequestBoostSpec {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaSearchRequestBoostSpec = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaSearchRequestBoostSpec]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaSearchRequestBoostSpec](x: Self) {
    
    inline def setConditionBoostSpecs(value: js.Array[SchemaGoogleCloudRetailV2alphaSearchRequestBoostSpecConditionBoostSpec]): Self = StObject.set(x, "conditionBoostSpecs", value.asInstanceOf[js.Any])
    
    inline def setConditionBoostSpecsUndefined: Self = StObject.set(x, "conditionBoostSpecs", js.undefined)
    
    inline def setConditionBoostSpecsVarargs(value: SchemaGoogleCloudRetailV2alphaSearchRequestBoostSpecConditionBoostSpec*): Self = StObject.set(x, "conditionBoostSpecs", js.Array(value*))
