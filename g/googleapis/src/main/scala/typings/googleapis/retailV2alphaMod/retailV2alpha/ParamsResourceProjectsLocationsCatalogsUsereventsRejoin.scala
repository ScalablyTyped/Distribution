...
trait ParamsResourceProjectsLocationsCatalogsUsereventsRejoin
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2alphaRejoinUserEventsRequest] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsUsereventsRejoin {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsUsereventsRejoin](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2alphaRejoinUserEventsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
