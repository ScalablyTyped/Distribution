...
trait SchemaGoogleCloudRetailV2alphaRuleReplacementAction extends StObject {
...
object SchemaGoogleCloudRetailV2alphaRuleReplacementAction {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaRuleReplacementAction = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaRuleReplacementAction]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaRuleReplacementAction](x: Self) {
