...
trait SchemaGoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey extends StObject {
  ...
  /**
    ...
    */
  var intervals: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2alphaInterval]] = js.undefined
...
object SchemaGoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey](x: Self) {
    ...
    inline def setIntervals(value: js.Array[SchemaGoogleCloudRetailV2alphaInterval]): Self = StObject.set(x, "intervals", value.asInstanceOf[js.Any])
    
    inline def setIntervalsUndefined: Self = StObject.set(x, "intervals", js.undefined)
    
    inline def setIntervalsVarargs(value: SchemaGoogleCloudRetailV2alphaInterval*): Self = StObject.set(x, "intervals", js.Array(value*))
