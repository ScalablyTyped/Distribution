...
@JSImport("googleapis/build/src/apis/retail/v2alpha", "retail_v2alpha.Resource$Projects$Locations$Catalogs")
@js.native
open class ResourceProjectsLocationsCatalogs protected () extends StObject {
  ...
  def completeQuery(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompleteQueryResponse] = js.native
  def completeQuery(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaCompleteQueryResponse]): Unit = js.native
  def completeQuery(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompleteQueryResponse] = js.native
  def completeQuery(params: ParamsResourceProjectsLocationsCatalogsCompletequery): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompleteQueryResponse] = js.native
  def completeQuery(
    params: ParamsResourceProjectsLocationsCatalogsCompletequery,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaCompleteQueryResponse]
  ): Unit = js.native
  def completeQuery(
    params: ParamsResourceProjectsLocationsCatalogsCompletequery,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaCompleteQueryResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaCompleteQueryResponse]
  ): Unit = js.native
  def completeQuery(params: ParamsResourceProjectsLocationsCatalogsCompletequery, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompleteQueryResponse] = js.native
  def completeQuery(
    params: ParamsResourceProjectsLocationsCatalogsCompletequery,
  ...
  def getAttributesConfig(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaAttributesConfig] = js.native
  def getAttributesConfig(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaAttributesConfig]): Unit = js.native
  def getAttributesConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaAttributesConfig] = js.native
  def getAttributesConfig(params: ParamsResourceProjectsLocationsCatalogsGetattributesconfig): GaxiosPromise[SchemaGoogleCloudRetailV2alphaAttributesConfig] = js.native
  ...
  def getAttributesConfig(params: ParamsResourceProjectsLocationsCatalogsGetattributesconfig, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaAttributesConfig] = js.native
  def getAttributesConfig(
    params: ParamsResourceProjectsLocationsCatalogsGetattributesconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaAttributesConfig]
  ...
  def getCompletionConfig(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompletionConfig] = js.native
  def getCompletionConfig(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaCompletionConfig]): Unit = js.native
  def getCompletionConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompletionConfig] = js.native
  def getCompletionConfig(params: ParamsResourceProjectsLocationsCatalogsGetcompletionconfig): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompletionConfig] = js.native
  def getCompletionConfig(
    params: ParamsResourceProjectsLocationsCatalogsGetcompletionconfig,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaCompletionConfig]
  ): Unit = js.native
  def getCompletionConfig(
    params: ParamsResourceProjectsLocationsCatalogsGetcompletionconfig,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaCompletionConfig],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaCompletionConfig]
  ): Unit = js.native
  def getCompletionConfig(params: ParamsResourceProjectsLocationsCatalogsGetcompletionconfig, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompletionConfig] = js.native
  def getCompletionConfig(
    params: ParamsResourceProjectsLocationsCatalogsGetcompletionconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaCompletionConfig]
  ...
  def getDefaultBranch(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaGetDefaultBranchResponse] = js.native
  def getDefaultBranch(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaGetDefaultBranchResponse]): Unit = js.native
  def getDefaultBranch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaGetDefaultBranchResponse] = js.native
  def getDefaultBranch(params: ParamsResourceProjectsLocationsCatalogsGetdefaultbranch): GaxiosPromise[SchemaGoogleCloudRetailV2alphaGetDefaultBranchResponse] = js.native
  def getDefaultBranch(
    params: ParamsResourceProjectsLocationsCatalogsGetdefaultbranch,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaGetDefaultBranchResponse]
  ): Unit = js.native
  def getDefaultBranch(
    params: ParamsResourceProjectsLocationsCatalogsGetdefaultbranch,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaGetDefaultBranchResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaGetDefaultBranchResponse]
  ): Unit = js.native
  def getDefaultBranch(params: ParamsResourceProjectsLocationsCatalogsGetdefaultbranch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaGetDefaultBranchResponse] = js.native
  def getDefaultBranch(
    params: ParamsResourceProjectsLocationsCatalogsGetdefaultbranch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaGetDefaultBranchResponse]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaListCatalogsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaListCatalogsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaListCatalogsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsCatalogsList): GaxiosPromise[SchemaGoogleCloudRetailV2alphaListCatalogsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsList,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaListCatalogsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaListCatalogsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaListCatalogsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsCatalogsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaListCatalogsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaListCatalogsResponse]
  ...
  var models: ResourceProjectsLocationsCatalogsModels = js.native
  
  var operations: ResourceProjectsLocationsCatalogsOperations = js.native
  
  def patch(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCatalog] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaCatalog]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCatalog] = js.native
  def patch(params: ParamsResourceProjectsLocationsCatalogsPatch): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCatalog] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsCatalogsPatch,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaCatalog]
  ): Unit = js.native
  def patch(
    params: ParamsResourceProjectsLocationsCatalogsPatch,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaCatalog],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2alphaCatalog]
  ): Unit = js.native
  def patch(params: ParamsResourceProjectsLocationsCatalogsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCatalog] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsCatalogsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaCatalog]
  ...
  def updateAttributesConfig(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaAttributesConfig] = js.native
  def updateAttributesConfig(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaAttributesConfig]): Unit = js.native
  def updateAttributesConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaAttributesConfig] = js.native
  def updateAttributesConfig(params: ParamsResourceProjectsLocationsCatalogsUpdateattributesconfig): GaxiosPromise[SchemaGoogleCloudRetailV2alphaAttributesConfig] = js.native
  ...
  def updateAttributesConfig(params: ParamsResourceProjectsLocationsCatalogsUpdateattributesconfig, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaAttributesConfig] = js.native
  def updateAttributesConfig(
    params: ParamsResourceProjectsLocationsCatalogsUpdateattributesconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaAttributesConfig]
  ...
  def updateCompletionConfig(): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompletionConfig] = js.native
  def updateCompletionConfig(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaCompletionConfig]): Unit = js.native
  def updateCompletionConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompletionConfig] = js.native
  def updateCompletionConfig(params: ParamsResourceProjectsLocationsCatalogsUpdatecompletionconfig): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompletionConfig] = js.native
  ...
  def updateCompletionConfig(params: ParamsResourceProjectsLocationsCatalogsUpdatecompletionconfig, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2alphaCompletionConfig] = js.native
  def updateCompletionConfig(
    params: ParamsResourceProjectsLocationsCatalogsUpdatecompletionconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2alphaCompletionConfig]
