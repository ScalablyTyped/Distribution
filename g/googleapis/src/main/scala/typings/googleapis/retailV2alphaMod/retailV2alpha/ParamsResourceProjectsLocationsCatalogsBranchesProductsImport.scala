...
trait ParamsResourceProjectsLocationsCatalogsBranchesProductsImport
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2alphaImportProductsRequest] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsBranchesProductsImport {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsBranchesProductsImport](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2alphaImportProductsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
