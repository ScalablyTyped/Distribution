...
trait SchemaGoogleCloudRetailV2alphaUserInfo extends StObject {
...
object SchemaGoogleCloudRetailV2alphaUserInfo {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaUserInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaUserInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaUserInfo](x: Self) {
