...
trait ParamsResourceProjectsLocationsCatalogsBranchesProductsList
  ...
  /**
    ...
    */
  var requireTotalSize: js.UndefOr[Boolean] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsBranchesProductsList {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsBranchesProductsList](x: Self) {
    ...
    inline def setRequireTotalSize(value: Boolean): Self = StObject.set(x, "requireTotalSize", value.asInstanceOf[js.Any])
    
    inline def setRequireTotalSizeUndefined: Self = StObject.set(x, "requireTotalSize", js.undefined)
  }
}
