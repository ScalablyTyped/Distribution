...
trait SchemaGoogleCloudRetailV2alphaCompletionDetail extends StObject {
...
object SchemaGoogleCloudRetailV2alphaCompletionDetail {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaCompletionDetail = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaCompletionDetail]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaCompletionDetail](x: Self) {
