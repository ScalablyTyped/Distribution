...
trait SchemaGoogleCloudRetailV2betaImportMetadata extends StObject {
...
object SchemaGoogleCloudRetailV2betaImportMetadata {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaImportMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaImportMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaImportMetadata](x: Self) {
