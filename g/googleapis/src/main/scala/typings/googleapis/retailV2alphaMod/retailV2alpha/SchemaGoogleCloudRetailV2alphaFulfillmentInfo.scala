...
trait SchemaGoogleCloudRetailV2alphaFulfillmentInfo extends StObject {
...
object SchemaGoogleCloudRetailV2alphaFulfillmentInfo {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaFulfillmentInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaFulfillmentInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaFulfillmentInfo](x: Self) {
