...
trait SchemaGoogleCloudRetailV2alphaRuleOnewaySynonymsAction extends StObject {
...
object SchemaGoogleCloudRetailV2alphaRuleOnewaySynonymsAction {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaRuleOnewaySynonymsAction = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaRuleOnewaySynonymsAction]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaRuleOnewaySynonymsAction](x: Self) {
