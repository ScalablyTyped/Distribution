...
trait SchemaGoogleCloudRetailV2alphaPriceInfo extends StObject {
  ...
  /**
    ...
    */
  var priceRange: js.UndefOr[SchemaGoogleCloudRetailV2alphaPriceInfoPriceRange] = js.undefined
}
object SchemaGoogleCloudRetailV2alphaPriceInfo {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaPriceInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaPriceInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaPriceInfo](x: Self) {
    ...
    inline def setPriceRange(value: SchemaGoogleCloudRetailV2alphaPriceInfoPriceRange): Self = StObject.set(x, "priceRange", value.asInstanceOf[js.Any])
