...
trait SchemaGoogleCloudRetailV2alphaAttributesConfig extends StObject {
  ...
  /**
    ...
    */
  var catalogAttributes: js.UndefOr[StringDictionary[SchemaGoogleCloudRetailV2alphaCatalogAttribute] | Null] = js.undefined
...
object SchemaGoogleCloudRetailV2alphaAttributesConfig {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaAttributesConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaAttributesConfig]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaAttributesConfig](x: Self) {
    ...
    inline def setCatalogAttributes(value: StringDictionary[SchemaGoogleCloudRetailV2alphaCatalogAttribute]): Self = StObject.set(x, "catalogAttributes", value.asInstanceOf[js.Any])
