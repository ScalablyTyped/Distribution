...
trait SchemaGoogleCloudRetailV2alphaColorInfo extends StObject {
...
object SchemaGoogleCloudRetailV2alphaColorInfo {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaColorInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaColorInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaColorInfo](x: Self) {
