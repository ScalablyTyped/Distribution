...
trait SchemaGoogleCloudRetailV2alphaProduct extends StObject {
  ...
  /**
    ...
    */
  var audience: js.UndefOr[SchemaGoogleCloudRetailV2alphaAudience] = js.undefined
  ...
  /**
    ...
    */
  var colorInfo: js.UndefOr[SchemaGoogleCloudRetailV2alphaColorInfo] = js.undefined
  ...
  /**
    ...
    */
  var fulfillmentInfo: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2alphaFulfillmentInfo]] = js.undefined
  ...
  /**
    ...
    */
  var images: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2alphaImage]] = js.undefined
  ...
  /**
    ...
    */
  var promotions: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2alphaPromotion]] = js.undefined
  ...
  /**
    ...
    */
  var rating: js.UndefOr[SchemaGoogleCloudRetailV2alphaRating] = js.undefined
  ...
  /**
    ...
    */
  var variants: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2alphaProduct]] = js.undefined
}
object SchemaGoogleCloudRetailV2alphaProduct {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaProduct = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaProduct]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaProduct](x: Self) {
    ...
    inline def setAudience(value: SchemaGoogleCloudRetailV2alphaAudience): Self = StObject.set(x, "audience", value.asInstanceOf[js.Any])
    ...
    inline def setColorInfo(value: SchemaGoogleCloudRetailV2alphaColorInfo): Self = StObject.set(x, "colorInfo", value.asInstanceOf[js.Any])
    ...
    inline def setFulfillmentInfo(value: js.Array[SchemaGoogleCloudRetailV2alphaFulfillmentInfo]): Self = StObject.set(x, "fulfillmentInfo", value.asInstanceOf[js.Any])
    
    inline def setFulfillmentInfoUndefined: Self = StObject.set(x, "fulfillmentInfo", js.undefined)
    
    inline def setFulfillmentInfoVarargs(value: SchemaGoogleCloudRetailV2alphaFulfillmentInfo*): Self = StObject.set(x, "fulfillmentInfo", js.Array(value*))
    ...
    inline def setImages(value: js.Array[SchemaGoogleCloudRetailV2alphaImage]): Self = StObject.set(x, "images", value.asInstanceOf[js.Any])
    
    inline def setImagesUndefined: Self = StObject.set(x, "images", js.undefined)
    
    inline def setImagesVarargs(value: SchemaGoogleCloudRetailV2alphaImage*): Self = StObject.set(x, "images", js.Array(value*))
    ...
    inline def setPromotions(value: js.Array[SchemaGoogleCloudRetailV2alphaPromotion]): Self = StObject.set(x, "promotions", value.asInstanceOf[js.Any])
    
    inline def setPromotionsUndefined: Self = StObject.set(x, "promotions", js.undefined)
    
    inline def setPromotionsVarargs(value: SchemaGoogleCloudRetailV2alphaPromotion*): Self = StObject.set(x, "promotions", js.Array(value*))
    ...
    inline def setRating(value: SchemaGoogleCloudRetailV2alphaRating): Self = StObject.set(x, "rating", value.asInstanceOf[js.Any])
    ...
    inline def setVariants(value: js.Array[SchemaGoogleCloudRetailV2alphaProduct]): Self = StObject.set(x, "variants", value.asInstanceOf[js.Any])
    
    inline def setVariantsUndefined: Self = StObject.set(x, "variants", js.undefined)
    
    inline def setVariantsVarargs(value: SchemaGoogleCloudRetailV2alphaProduct*): Self = StObject.set(x, "variants", js.Array(value*))
  }
}
