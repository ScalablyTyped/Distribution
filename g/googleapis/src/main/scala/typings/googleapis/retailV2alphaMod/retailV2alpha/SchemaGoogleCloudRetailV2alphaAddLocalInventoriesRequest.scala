...
trait SchemaGoogleCloudRetailV2alphaAddLocalInventoriesRequest extends StObject {
  ...
  /**
    ...
    */
  var localInventories: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2alphaLocalInventory]] = js.undefined
}
object SchemaGoogleCloudRetailV2alphaAddLocalInventoriesRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaAddLocalInventoriesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaAddLocalInventoriesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaAddLocalInventoriesRequest](x: Self) {
    ...
    inline def setLocalInventories(value: js.Array[SchemaGoogleCloudRetailV2alphaLocalInventory]): Self = StObject.set(x, "localInventories", value.asInstanceOf[js.Any])
    
    inline def setLocalInventoriesUndefined: Self = StObject.set(x, "localInventories", js.undefined)
    
    inline def setLocalInventoriesVarargs(value: SchemaGoogleCloudRetailV2alphaLocalInventory*): Self = StObject.set(x, "localInventories", js.Array(value*))
  }
}
