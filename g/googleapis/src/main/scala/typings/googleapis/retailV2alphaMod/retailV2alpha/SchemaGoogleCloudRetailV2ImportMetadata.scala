...
trait SchemaGoogleCloudRetailV2ImportMetadata extends StObject {
...
object SchemaGoogleCloudRetailV2ImportMetadata {
  
  inline def apply(): SchemaGoogleCloudRetailV2ImportMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2ImportMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2ImportMetadata](x: Self) {
