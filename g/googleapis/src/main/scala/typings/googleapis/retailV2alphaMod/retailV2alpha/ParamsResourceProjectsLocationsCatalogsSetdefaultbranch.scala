...
trait ParamsResourceProjectsLocationsCatalogsSetdefaultbranch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2alphaSetDefaultBranchRequest] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsSetdefaultbranch {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsSetdefaultbranch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2alphaSetDefaultBranchRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
