...
trait SchemaGoogleCloudRetailV2alphaCatalogAttribute extends StObject {
...
object SchemaGoogleCloudRetailV2alphaCatalogAttribute {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaCatalogAttribute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaCatalogAttribute]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaCatalogAttribute](x: Self) {
