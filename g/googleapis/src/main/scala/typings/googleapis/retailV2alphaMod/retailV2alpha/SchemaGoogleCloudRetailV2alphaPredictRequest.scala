...
trait SchemaGoogleCloudRetailV2alphaPredictRequest extends StObject {
  ...
  /**
    ...
    */
  var userEvent: js.UndefOr[SchemaGoogleCloudRetailV2alphaUserEvent] = js.undefined
...
object SchemaGoogleCloudRetailV2alphaPredictRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaPredictRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaPredictRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaPredictRequest](x: Self) {
    ...
    inline def setUserEvent(value: SchemaGoogleCloudRetailV2alphaUserEvent): Self = StObject.set(x, "userEvent", value.asInstanceOf[js.Any])
