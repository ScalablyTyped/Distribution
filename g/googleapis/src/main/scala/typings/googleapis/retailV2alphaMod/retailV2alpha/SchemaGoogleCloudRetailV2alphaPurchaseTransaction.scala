...
trait SchemaGoogleCloudRetailV2alphaPurchaseTransaction extends StObject {
...
object SchemaGoogleCloudRetailV2alphaPurchaseTransaction {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaPurchaseTransaction = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaPurchaseTransaction]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaPurchaseTransaction](x: Self) {
