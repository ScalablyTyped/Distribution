...
trait SchemaGoogleCloudRetailV2alphaInterval extends StObject {
...
object SchemaGoogleCloudRetailV2alphaInterval {
  
  inline def apply(): SchemaGoogleCloudRetailV2alphaInterval = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2alphaInterval]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2alphaInterval](x: Self) {
