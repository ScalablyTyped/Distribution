...
object SchemaTimelineListResponse {
  ...
  inline def apply(): SchemaTimelineListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaTimelineListResponse]
  }
  
  extension [Self <: SchemaTimelineListResponse](x: Self) {
    
    inline def setItems(value: js.Array[SchemaTimelineItem]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaTimelineItem*): Self = StObject.set(x, "items", js.Array(value :_*))
