...
object SchemaAccount {
  ...
  extension [Self <: SchemaAccount](x: Self) {
    ...
    inline def setAuthTokens(value: js.Array[SchemaAuthToken]): Self = StObject.set(x, "authTokens", value.asInstanceOf[js.Any])
    
    inline def setAuthTokensUndefined: Self = StObject.set(x, "authTokens", js.undefined)
    
    inline def setAuthTokensVarargs(value: SchemaAuthToken*): Self = StObject.set(x, "authTokens", js.Array(value :_*))
    ...
    inline def setUserData(value: js.Array[SchemaUserData]): Self = StObject.set(x, "userData", value.asInstanceOf[js.Any])
    
    inline def setUserDataUndefined: Self = StObject.set(x, "userData", js.undefined)
    
    inline def setUserDataVarargs(value: SchemaUserData*): Self = StObject.set(x, "userData", js.Array(value :_*))
  }
}
