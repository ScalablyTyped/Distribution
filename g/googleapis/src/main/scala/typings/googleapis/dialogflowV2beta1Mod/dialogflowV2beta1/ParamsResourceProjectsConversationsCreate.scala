...
trait ParamsResourceProjectsConversationsCreate
  extends StObject
...
object ParamsResourceProjectsConversationsCreate {
  
  inline def apply(): ParamsResourceProjectsConversationsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsConversationsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsConversationsCreate](x: Self) {
