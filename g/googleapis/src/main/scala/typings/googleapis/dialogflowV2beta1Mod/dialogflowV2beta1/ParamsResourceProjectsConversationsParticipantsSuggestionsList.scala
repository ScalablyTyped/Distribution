...
trait ParamsResourceProjectsConversationsParticipantsSuggestionsList
  extends StObject
...
object ParamsResourceProjectsConversationsParticipantsSuggestionsList {
  
  inline def apply(): ParamsResourceProjectsConversationsParticipantsSuggestionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsConversationsParticipantsSuggestionsList]
  }
  
  extension [Self <: ParamsResourceProjectsConversationsParticipantsSuggestionsList](x: Self) {
