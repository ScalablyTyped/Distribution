...
object ParamsResourceProjectsKnowledgebasesDocumentsGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsKnowledgebasesDocumentsGetMutableBuilder[Self <: ParamsResourceProjectsKnowledgebasesDocumentsGet] (val x: Self) extends AnyVal {
