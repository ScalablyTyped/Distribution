...
trait SchemaGoogleCloudDialogflowV2beta1ResponseMessageMixedAudioSegment extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1ResponseMessageMixedAudioSegment {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1ResponseMessageMixedAudioSegment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1ResponseMessageMixedAudioSegment]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1ResponseMessageMixedAudioSegment](x: Self) {
