...
trait ParamsResourceProjectsLocationsConversationsParticipantsAnalyzecontent
  extends StObject
...
object ParamsResourceProjectsLocationsConversationsParticipantsAnalyzecontent {
  
  inline def apply(): ParamsResourceProjectsLocationsConversationsParticipantsAnalyzecontent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsConversationsParticipantsAnalyzecontent]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsConversationsParticipantsAnalyzecontent](x: Self) {
