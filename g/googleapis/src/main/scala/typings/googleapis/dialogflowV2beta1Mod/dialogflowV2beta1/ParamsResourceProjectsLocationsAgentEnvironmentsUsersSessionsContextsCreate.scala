...
trait ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsContextsCreate](x: Self) {
