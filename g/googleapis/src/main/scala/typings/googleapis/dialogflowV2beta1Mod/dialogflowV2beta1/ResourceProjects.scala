...
open class ResourceProjects protected () extends StObject {
  ...
  def getAgent(
    params: ParamsResourceProjectsGetagent,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowV2beta1Agent],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowV2beta1Agent]
  ): Unit = js.native
  ...
  def setAgent(): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1Agent] = js.native
  def setAgent(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1Agent]): Unit = js.native
  def setAgent(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1Agent] = js.native
  def setAgent(params: ParamsResourceProjectsSetagent): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1Agent] = js.native
  def setAgent(
  ...
  def setAgent(params: ParamsResourceProjectsSetagent, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1Agent] = js.native
  def setAgent(
    params: ParamsResourceProjectsSetagent,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1Agent]
