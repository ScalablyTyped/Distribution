...
trait ParamsResourceProjectsAgentKnowledgebasesPatch
  extends StObject
...
object ParamsResourceProjectsAgentKnowledgebasesPatch {
  ...
  inline def apply(): ParamsResourceProjectsAgentKnowledgebasesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentKnowledgebasesPatch]
  }
  
  extension [Self <: ParamsResourceProjectsAgentKnowledgebasesPatch](x: Self) {
