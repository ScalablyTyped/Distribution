...
trait ParamsResourceProjectsAnswerrecordsList
  extends StObject
...
object ParamsResourceProjectsAnswerrecordsList {
  
  inline def apply(): ParamsResourceProjectsAnswerrecordsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAnswerrecordsList]
  }
  
  extension [Self <: ParamsResourceProjectsAnswerrecordsList](x: Self) {
