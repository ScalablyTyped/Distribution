...
@JSImport("googleapis/build/src/apis/dialogflow/v2beta1", "dialogflow_v2beta1.Resource$Projects$Locations$Knowledgebases$Documents")
@js.native
open class ResourceProjectsLocationsKnowledgebasesDocuments protected () extends StObject {
  ...
  def get(params: ParamsResourceProjectsLocationsKnowledgebasesDocumentsGet): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1Document] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsKnowledgebasesDocumentsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1Document] = js.native
  def get(
    params: ParamsResourceProjectsLocationsKnowledgebasesDocumentsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1Document]
  ...
  def list(params: ParamsResourceProjectsLocationsKnowledgebasesDocumentsList): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1ListDocumentsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsLocationsKnowledgebasesDocumentsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1ListDocumentsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsKnowledgebasesDocumentsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1ListDocumentsResponse]
