...
trait SchemaGoogleCloudDialogflowCxV3SessionInfo extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3SessionInfo {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3SessionInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3SessionInfo]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3SessionInfo](x: Self) {
