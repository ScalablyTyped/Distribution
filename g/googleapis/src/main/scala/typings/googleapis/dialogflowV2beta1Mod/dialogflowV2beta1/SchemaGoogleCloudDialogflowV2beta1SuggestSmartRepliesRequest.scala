...
trait SchemaGoogleCloudDialogflowV2beta1SuggestSmartRepliesRequest extends StObject {
  ...
  /**
    ...
    */
  var currentTextInput: js.UndefOr[SchemaGoogleCloudDialogflowV2beta1TextInput] = js.undefined
...
object SchemaGoogleCloudDialogflowV2beta1SuggestSmartRepliesRequest {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1SuggestSmartRepliesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1SuggestSmartRepliesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1SuggestSmartRepliesRequest](x: Self) {
    ...
    inline def setCurrentTextInput(value: SchemaGoogleCloudDialogflowV2beta1TextInput): Self = StObject.set(x, "currentTextInput", value.asInstanceOf[js.Any])
