...
trait SchemaGoogleCloudDialogflowV2beta1TextToSpeechSettings extends StObject {
  ...
  /**
    ...
    */
  var synthesizeSpeechConfigs: js.UndefOr[
    StringDictionary[SchemaGoogleCloudDialogflowV2beta1SynthesizeSpeechConfig] | Null
  ] = js.undefined
}
object SchemaGoogleCloudDialogflowV2beta1TextToSpeechSettings {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1TextToSpeechSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1TextToSpeechSettings]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1TextToSpeechSettings](x: Self) {
    ...
    inline def setSynthesizeSpeechConfigs(value: StringDictionary[SchemaGoogleCloudDialogflowV2beta1SynthesizeSpeechConfig]): Self = StObject.set(x, "synthesizeSpeechConfigs", value.asInstanceOf[js.Any])
