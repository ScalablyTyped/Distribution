...
trait SchemaGoogleCloudDialogflowV2beta1SuggestionFaqAnswer extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1SuggestionFaqAnswer {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1SuggestionFaqAnswer = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1SuggestionFaqAnswer]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1SuggestionFaqAnswer](x: Self) {
