...
trait ParamsResourceProjectsLocationsAgentExport
  extends StObject
...
object ParamsResourceProjectsLocationsAgentExport {
  
  inline def apply(): ParamsResourceProjectsLocationsAgentExport = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAgentExport]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAgentExport](x: Self) {
