...
@JSImport("googleapis/build/src/apis/dialogflow/v2beta1", "dialogflow_v2beta1.Resource$Projects$Locations$Agent$Environments$Intents")
@js.native
open class ResourceProjectsLocationsAgentEnvironmentsIntents protected () extends StObject {
  ...
  def list(params: ParamsResourceProjectsLocationsAgentEnvironmentsIntentsList): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1ListIntentsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsIntentsList,
  ...
  def list(params: ParamsResourceProjectsLocationsAgentEnvironmentsIntentsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1ListIntentsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsIntentsList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceProjectsLocationsAgentEnvironmentsIntentsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsIntentsList,
