...
@JSImport("googleapis/build/src/apis/dialogflow/v2beta1", "dialogflow_v2beta1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  def getAgent(params: ParamsResourceProjectsLocationsGetagent): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1Agent] = js.native
  def getAgent(
  ...
  def getAgent(params: ParamsResourceProjectsLocationsGetagent, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1Agent] = js.native
  def getAgent(
    params: ParamsResourceProjectsLocationsGetagent,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1Agent]
  ...
  def setAgent(params: ParamsResourceProjectsLocationsSetagent): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1Agent] = js.native
  def setAgent(
  ...
  def setAgent(params: ParamsResourceProjectsLocationsSetagent, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1Agent] = js.native
  def setAgent(
    params: ParamsResourceProjectsLocationsSetagent,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1Agent]
