...
trait ParamsResourceProjectsAgentEnvironmentsIntentsList
  extends StObject
...
object ParamsResourceProjectsAgentEnvironmentsIntentsList {
  
  inline def apply(): ParamsResourceProjectsAgentEnvironmentsIntentsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentEnvironmentsIntentsList]
  }
  
  extension [Self <: ParamsResourceProjectsAgentEnvironmentsIntentsList](x: Self) {
