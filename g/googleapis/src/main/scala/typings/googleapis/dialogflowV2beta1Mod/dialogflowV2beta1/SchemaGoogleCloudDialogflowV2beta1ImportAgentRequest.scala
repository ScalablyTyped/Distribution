...
object SchemaGoogleCloudDialogflowV2beta1ImportAgentRequest {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudDialogflowV2beta1ImportAgentRequestMutableBuilder[Self <: SchemaGoogleCloudDialogflowV2beta1ImportAgentRequest] (val x: Self) extends AnyVal {
