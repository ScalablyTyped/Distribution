...
trait SchemaGoogleCloudDialogflowV2beta1SuggestFaqAnswersRequest extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1SuggestFaqAnswersRequest {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1SuggestFaqAnswersRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1SuggestFaqAnswersRequest]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1SuggestFaqAnswersRequest](x: Self) {
