...
object ParamsResourceProjectsKnowledgebasesPatch {
  
  @scala.inline
  def apply(): ParamsResourceProjectsKnowledgebasesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsKnowledgebasesPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsKnowledgebasesPatchOps[Self <: ParamsResourceProjectsKnowledgebasesPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGoogleCloudDialogflowV2beta1KnowledgeBase): Self = this.set("requestBody", value.asInstanceOf[js.Any])
