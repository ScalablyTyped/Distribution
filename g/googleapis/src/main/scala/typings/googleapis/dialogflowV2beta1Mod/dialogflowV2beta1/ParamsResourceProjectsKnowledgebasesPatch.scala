...
trait ParamsResourceProjectsKnowledgebasesPatch
  extends StObject
...
object ParamsResourceProjectsKnowledgebasesPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsKnowledgebasesPatchMutableBuilder[Self <: ParamsResourceProjectsKnowledgebasesPatch] (val x: Self) extends AnyVal {
