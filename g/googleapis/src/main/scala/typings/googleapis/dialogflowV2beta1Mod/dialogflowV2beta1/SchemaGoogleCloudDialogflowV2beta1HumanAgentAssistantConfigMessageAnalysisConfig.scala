...
trait SchemaGoogleCloudDialogflowV2beta1HumanAgentAssistantConfigMessageAnalysisConfig extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1HumanAgentAssistantConfigMessageAnalysisConfig {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1HumanAgentAssistantConfigMessageAnalysisConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1HumanAgentAssistantConfigMessageAnalysisConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1HumanAgentAssistantConfigMessageAnalysisConfig](x: Self) {
