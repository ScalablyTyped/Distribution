...
trait SchemaGoogleCloudDialogflowV2beta1HumanAgentHandoffConfigSalesforceLiveAgentConfig extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1HumanAgentHandoffConfigSalesforceLiveAgentConfig {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1HumanAgentHandoffConfigSalesforceLiveAgentConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1HumanAgentHandoffConfigSalesforceLiveAgentConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1HumanAgentHandoffConfigSalesforceLiveAgentConfig](x: Self) {
