...
trait ParamsResourceProjectsLocationsConversationsMessagesList
  extends StObject
...
object ParamsResourceProjectsLocationsConversationsMessagesList {
  
  inline def apply(): ParamsResourceProjectsLocationsConversationsMessagesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsConversationsMessagesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsConversationsMessagesList](x: Self) {
