...
object ParamsResourceProjectsAgentKnowledgebasesDocumentsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentKnowledgebasesDocumentsCreateMutableBuilder[Self <: ParamsResourceProjectsAgentKnowledgebasesDocumentsCreate] (val x: Self) extends AnyVal {
