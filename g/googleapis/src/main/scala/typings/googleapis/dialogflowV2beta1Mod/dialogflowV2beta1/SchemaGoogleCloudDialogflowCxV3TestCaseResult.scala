...
trait SchemaGoogleCloudDialogflowCxV3TestCaseResult extends StObject {
  
  /**
    * The conversation turns uttered during the test case replay in chronological order.
    */
  var conversationTurns: js.UndefOr[js.Array[SchemaGoogleCloudDialogflowCxV3ConversationTurn]] = js.undefined
...
object SchemaGoogleCloudDialogflowCxV3TestCaseResult {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3TestCaseResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3TestCaseResult]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3TestCaseResult](x: Self) {
    
    inline def setConversationTurns(value: js.Array[SchemaGoogleCloudDialogflowCxV3ConversationTurn]): Self = StObject.set(x, "conversationTurns", value.asInstanceOf[js.Any])
    
    inline def setConversationTurnsUndefined: Self = StObject.set(x, "conversationTurns", js.undefined)
    
    inline def setConversationTurnsVarargs(value: SchemaGoogleCloudDialogflowCxV3ConversationTurn*): Self = StObject.set(x, "conversationTurns", js.Array(value*))
