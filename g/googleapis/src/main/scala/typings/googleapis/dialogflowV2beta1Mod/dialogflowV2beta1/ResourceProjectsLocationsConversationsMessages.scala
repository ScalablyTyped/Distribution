...
@JSImport("googleapis/build/src/apis/dialogflow/v2beta1", "dialogflow_v2beta1.Resource$Projects$Locations$Conversations$Messages")
@js.native
open class ResourceProjectsLocationsConversationsMessages protected () extends StObject {
  ...
  def batchCreate(params: ParamsResourceProjectsLocationsConversationsMessagesBatchcreate): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1BatchCreateMessagesResponse] = js.native
  def batchCreate(
    params: ParamsResourceProjectsLocationsConversationsMessagesBatchcreate,
  ...
  def batchCreate(params: ParamsResourceProjectsLocationsConversationsMessagesBatchcreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1BatchCreateMessagesResponse] = js.native
  def batchCreate(
    params: ParamsResourceProjectsLocationsConversationsMessagesBatchcreate,
  ...
  def list(params: ParamsResourceProjectsLocationsConversationsMessagesList): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1ListMessagesResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsLocationsConversationsMessagesList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1ListMessagesResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsConversationsMessagesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1ListMessagesResponse]
