...
trait SchemaGoogleCloudDialogflowV2beta1AnnotatedMessagePart extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1AnnotatedMessagePart {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1AnnotatedMessagePart = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1AnnotatedMessagePart]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1AnnotatedMessagePart](x: Self) {
