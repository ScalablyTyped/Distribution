...
trait ParamsResourceProjectsLocationsAgentSessionsContextsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsAgentSessionsContextsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsAgentSessionsContextsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAgentSessionsContextsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAgentSessionsContextsCreate](x: Self) {
