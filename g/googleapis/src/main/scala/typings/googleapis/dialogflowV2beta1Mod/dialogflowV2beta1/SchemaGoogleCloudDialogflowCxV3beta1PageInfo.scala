...
trait SchemaGoogleCloudDialogflowCxV3beta1PageInfo extends StObject {
  ...
  /**
    ...
    */
  var formInfo: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1PageInfoFormInfo] = js.undefined
}
object SchemaGoogleCloudDialogflowCxV3beta1PageInfo {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1PageInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1PageInfo]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1PageInfo](x: Self) {
    ...
    inline def setFormInfo(value: SchemaGoogleCloudDialogflowCxV3beta1PageInfoFormInfo): Self = StObject.set(x, "formInfo", value.asInstanceOf[js.Any])
