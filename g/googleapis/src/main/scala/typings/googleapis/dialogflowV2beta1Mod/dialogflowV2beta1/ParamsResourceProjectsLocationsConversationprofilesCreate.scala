...
trait ParamsResourceProjectsLocationsConversationprofilesCreate
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowV2beta1ConversationProfile] = js.undefined
}
object ParamsResourceProjectsLocationsConversationprofilesCreate {
  ...
  extension [Self <: ParamsResourceProjectsLocationsConversationprofilesCreate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowV2beta1ConversationProfile): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
