...
trait ParamsResourceProjectsAnswerrecordsPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowV2beta1AnswerRecord] = js.undefined
...
object ParamsResourceProjectsAnswerrecordsPatch {
  ...
  extension [Self <: ParamsResourceProjectsAnswerrecordsPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowV2beta1AnswerRecord): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
