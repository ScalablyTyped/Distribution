...
trait SchemaGoogleCloudDialogflowCxV3beta1ConversationTurnUserInput extends StObject {
  ...
  /**
    ...
    */
  var input: js.UndefOr[SchemaGoogleCloudDialogflowCxV3beta1QueryInput] = js.undefined
...
object SchemaGoogleCloudDialogflowCxV3beta1ConversationTurnUserInput {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1ConversationTurnUserInput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1ConversationTurnUserInput]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1ConversationTurnUserInput](x: Self) {
    ...
    inline def setInput(value: SchemaGoogleCloudDialogflowCxV3beta1QueryInput): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
