...
trait SchemaGoogleCloudDialogflowV2SuggestArticlesResponse extends StObject {
  
  /**
    * Articles ordered by score in descending order.
    */
  var articleAnswers: js.UndefOr[js.Array[SchemaGoogleCloudDialogflowV2ArticleAnswer]] = js.undefined
...
object SchemaGoogleCloudDialogflowV2SuggestArticlesResponse {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2SuggestArticlesResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2SuggestArticlesResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2SuggestArticlesResponse](x: Self) {
    
    inline def setArticleAnswers(value: js.Array[SchemaGoogleCloudDialogflowV2ArticleAnswer]): Self = StObject.set(x, "articleAnswers", value.asInstanceOf[js.Any])
    
    inline def setArticleAnswersUndefined: Self = StObject.set(x, "articleAnswers", js.undefined)
    
    inline def setArticleAnswersVarargs(value: SchemaGoogleCloudDialogflowV2ArticleAnswer*): Self = StObject.set(x, "articleAnswers", js.Array(value*))
