...
object ParamsResourceProjectsAgentKnowledgebasesDocumentsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentKnowledgebasesDocumentsPatchMutableBuilder[Self <: ParamsResourceProjectsAgentKnowledgebasesDocumentsPatch] (val x: Self) extends AnyVal {
