...
@js.native
trait ParamsResourceProjectsAgentKnowledgebasesDocumentsPatch extends StandardParameters {
  /**
...
object ParamsResourceProjectsAgentKnowledgebasesDocumentsPatch {
  @scala.inline
  def apply(): ParamsResourceProjectsAgentKnowledgebasesDocumentsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentKnowledgebasesDocumentsPatch]
  }
  @scala.inline
  implicit class ParamsResourceProjectsAgentKnowledgebasesDocumentsPatchOps[Self <: ParamsResourceProjectsAgentKnowledgebasesDocumentsPatch] (val x: Self) extends AnyVal {
    @scala.inline
