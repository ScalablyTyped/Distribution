...
trait ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsDetectintent
  extends StObject
...
object ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsDetectintent {
  
  inline def apply(): ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsDetectintent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsDetectintent]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsDetectintent](x: Self) {
