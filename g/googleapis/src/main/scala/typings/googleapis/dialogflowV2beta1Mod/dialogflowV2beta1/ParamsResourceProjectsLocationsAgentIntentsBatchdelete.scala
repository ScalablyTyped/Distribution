...
trait ParamsResourceProjectsLocationsAgentIntentsBatchdelete
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowV2beta1BatchDeleteIntentsRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentIntentsBatchdelete {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentIntentsBatchdelete](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowV2beta1BatchDeleteIntentsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
