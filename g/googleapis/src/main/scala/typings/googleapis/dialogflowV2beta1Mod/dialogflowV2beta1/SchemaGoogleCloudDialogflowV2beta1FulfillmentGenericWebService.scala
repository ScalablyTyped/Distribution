...
trait SchemaGoogleCloudDialogflowV2beta1FulfillmentGenericWebService extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1FulfillmentGenericWebService {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1FulfillmentGenericWebService = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1FulfillmentGenericWebService]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1FulfillmentGenericWebService](x: Self) {
