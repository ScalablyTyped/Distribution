...
trait SchemaGoogleCloudDialogflowV2beta1SuggestionArticle extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1SuggestionArticle {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1SuggestionArticle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1SuggestionArticle]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1SuggestionArticle](x: Self) {
