...
trait ParamsResourceProjectsLocationsSetagent
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowV2beta1Agent] = js.undefined
...
object ParamsResourceProjectsLocationsSetagent {
  ...
  extension [Self <: ParamsResourceProjectsLocationsSetagent](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowV2beta1Agent): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
