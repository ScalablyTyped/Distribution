...
trait ParamsResourceProjectsLocationsKnowledgebasesDocumentsList
  extends StObject
...
object ParamsResourceProjectsLocationsKnowledgebasesDocumentsList {
  
  inline def apply(): ParamsResourceProjectsLocationsKnowledgebasesDocumentsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsKnowledgebasesDocumentsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsKnowledgebasesDocumentsList](x: Self) {
