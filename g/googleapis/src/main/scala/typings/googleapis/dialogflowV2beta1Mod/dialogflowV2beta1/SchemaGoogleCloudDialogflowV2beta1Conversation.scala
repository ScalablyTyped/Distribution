...
trait SchemaGoogleCloudDialogflowV2beta1Conversation extends StObject {
  ...
  /**
    ...
    */
  var phoneNumber: js.UndefOr[SchemaGoogleCloudDialogflowV2beta1ConversationPhoneNumber] = js.undefined
...
object SchemaGoogleCloudDialogflowV2beta1Conversation {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1Conversation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1Conversation]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1Conversation](x: Self) {
    ...
    inline def setPhoneNumber(value: SchemaGoogleCloudDialogflowV2beta1ConversationPhoneNumber): Self = StObject.set(x, "phoneNumber", value.asInstanceOf[js.Any])
