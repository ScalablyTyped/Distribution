...
object SchemaGoogleCloudDialogflowV2beta1IntentTrainingPhrasePart {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudDialogflowV2beta1IntentTrainingPhrasePartOps[Self <: SchemaGoogleCloudDialogflowV2beta1IntentTrainingPhrasePart] (val x: Self) extends AnyVal {
