...
object SchemaGoogleCloudDialogflowV2beta1IntentMessageCard {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudDialogflowV2beta1IntentMessageCardOps[Self <: SchemaGoogleCloudDialogflowV2beta1IntentMessageCard] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setButtonsVarargs(value: SchemaGoogleCloudDialogflowV2beta1IntentMessageCardButton*): Self = this.set("buttons", js.Array(value :_*))
    @scala.inline
    def setButtons(value: js.Array[SchemaGoogleCloudDialogflowV2beta1IntentMessageCardButton]): Self = this.set("buttons", value.asInstanceOf[js.Any])
    @scala.inline
