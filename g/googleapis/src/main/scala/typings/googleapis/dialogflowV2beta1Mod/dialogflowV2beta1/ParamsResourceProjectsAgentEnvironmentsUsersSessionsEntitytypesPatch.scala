...
object ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesPatch {
  ...
  inline def apply(): ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesPatch]
  }
  
  extension [Self <: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesPatch](x: Self) {
