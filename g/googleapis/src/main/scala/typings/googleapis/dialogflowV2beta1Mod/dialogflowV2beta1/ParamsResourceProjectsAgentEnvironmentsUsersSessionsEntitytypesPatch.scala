...
object ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesPatchOps[Self <: ParamsResourceProjectsAgentEnvironmentsUsersSessionsEntitytypesPatch] (val x: Self) extends AnyVal {
