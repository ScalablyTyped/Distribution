...
@JSImport("googleapis/build/src/apis/dialogflow/v2beta1", "dialogflow_v2beta1.Resource$Projects$Locations$Agent$Environments$Users$Sessions$Entitytypes")
@js.native
open class ResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypes protected () extends StObject {
  ...
  def create(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesCreate): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1SessionEntityType] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesCreate,
  ...
  def delete(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesDelete): GaxiosPromise[SchemaGoogleProtobufEmpty] = js.native
  def delete(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesDelete,
  ...
  def get(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesGet): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1SessionEntityType] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesGet,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1SessionEntityType]
  ): Unit = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesGet,
  ...
  def list(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesList): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1ListSessionEntityTypesResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesList,
  ...
  def patch(params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesPatch): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1SessionEntityType] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesPatch,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1SessionEntityType]
  ): Unit = js.native
  def patch(
    params: ParamsResourceProjectsLocationsAgentEnvironmentsUsersSessionsEntitytypesPatch,
