...
trait ParamsResourceProjectsLocationsAgentVersionsPatch
  extends StObject
...
object ParamsResourceProjectsLocationsAgentVersionsPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsAgentVersionsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAgentVersionsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAgentVersionsPatch](x: Self) {
