...
object SchemaGoogleCloudDialogflowV2beta1ListEntityTypesResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudDialogflowV2beta1ListEntityTypesResponseMutableBuilder[Self <: SchemaGoogleCloudDialogflowV2beta1ListEntityTypesResponse] (val x: Self) extends AnyVal {
