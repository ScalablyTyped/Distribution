...
trait SchemaGoogleCloudDialogflowV2beta1Environment extends StObject {
  ...
  /**
    ...
    */
  var fulfillment: js.UndefOr[SchemaGoogleCloudDialogflowV2beta1Fulfillment] = js.undefined
  ...
  /**
    ...
    */
  var textToSpeechSettings: js.UndefOr[SchemaGoogleCloudDialogflowV2beta1TextToSpeechSettings] = js.undefined
...
object SchemaGoogleCloudDialogflowV2beta1Environment {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1Environment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1Environment]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1Environment](x: Self) {
    ...
    inline def setFulfillment(value: SchemaGoogleCloudDialogflowV2beta1Fulfillment): Self = StObject.set(x, "fulfillment", value.asInstanceOf[js.Any])
    ...
    inline def setTextToSpeechSettings(value: SchemaGoogleCloudDialogflowV2beta1TextToSpeechSettings): Self = StObject.set(x, "textToSpeechSettings", value.asInstanceOf[js.Any])
