...
trait ParamsResourceProjectsAgentSessionsContextsDelete
  extends StObject
...
object ParamsResourceProjectsAgentSessionsContextsDelete {
  ...
  inline def apply(): ParamsResourceProjectsAgentSessionsContextsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentSessionsContextsDelete]
  }
  
  extension [Self <: ParamsResourceProjectsAgentSessionsContextsDelete](x: Self) {
