...
trait ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsPatch
  extends StObject
...
object ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsPatch {
  ...
  inline def apply(): ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsAgentEnvironmentsUsersSessionsContextsPatch](x: Self) {
