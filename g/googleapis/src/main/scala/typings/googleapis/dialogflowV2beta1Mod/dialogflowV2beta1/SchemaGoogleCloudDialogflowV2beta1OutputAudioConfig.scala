...
object SchemaGoogleCloudDialogflowV2beta1OutputAudioConfig {
  ...
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1OutputAudioConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1OutputAudioConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1OutputAudioConfig](x: Self) {
    ...
    inline def setSynthesizeSpeechConfig(value: SchemaGoogleCloudDialogflowV2beta1SynthesizeSpeechConfig): Self = StObject.set(x, "synthesizeSpeechConfig", value.asInstanceOf[js.Any])
