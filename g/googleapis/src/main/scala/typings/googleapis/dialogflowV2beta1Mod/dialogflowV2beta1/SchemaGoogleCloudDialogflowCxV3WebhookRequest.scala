...
trait SchemaGoogleCloudDialogflowCxV3WebhookRequest extends StObject {
  ...
  /**
    ...
    */
  var fulfillmentInfo: js.UndefOr[SchemaGoogleCloudDialogflowCxV3WebhookRequestFulfillmentInfo] = js.undefined
  
  /**
    * Information about the last matched intent.
    */
  var intentInfo: js.UndefOr[SchemaGoogleCloudDialogflowCxV3WebhookRequestIntentInfo] = js.undefined
  ...
  /**
    ...
    */
  var sentimentAnalysisResult: js.UndefOr[SchemaGoogleCloudDialogflowCxV3WebhookRequestSentimentAnalysisResult] = js.undefined
...
object SchemaGoogleCloudDialogflowCxV3WebhookRequest {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3WebhookRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3WebhookRequest]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3WebhookRequest](x: Self) {
    ...
    inline def setFulfillmentInfo(value: SchemaGoogleCloudDialogflowCxV3WebhookRequestFulfillmentInfo): Self = StObject.set(x, "fulfillmentInfo", value.asInstanceOf[js.Any])
    
    inline def setFulfillmentInfoUndefined: Self = StObject.set(x, "fulfillmentInfo", js.undefined)
    
    inline def setIntentInfo(value: SchemaGoogleCloudDialogflowCxV3WebhookRequestIntentInfo): Self = StObject.set(x, "intentInfo", value.asInstanceOf[js.Any])
    ...
    inline def setSentimentAnalysisResult(value: SchemaGoogleCloudDialogflowCxV3WebhookRequestSentimentAnalysisResult): Self = StObject.set(x, "sentimentAnalysisResult", value.asInstanceOf[js.Any])
