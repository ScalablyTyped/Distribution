...
trait ParamsResourceProjectsLocationsAgentIntentsList
  extends StObject
...
object ParamsResourceProjectsLocationsAgentIntentsList {
  
  inline def apply(): ParamsResourceProjectsLocationsAgentIntentsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAgentIntentsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAgentIntentsList](x: Self) {
