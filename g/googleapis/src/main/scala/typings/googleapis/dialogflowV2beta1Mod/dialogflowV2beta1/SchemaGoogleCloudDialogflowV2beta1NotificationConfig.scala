...
trait SchemaGoogleCloudDialogflowV2beta1NotificationConfig extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1NotificationConfig {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1NotificationConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1NotificationConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1NotificationConfig](x: Self) {
