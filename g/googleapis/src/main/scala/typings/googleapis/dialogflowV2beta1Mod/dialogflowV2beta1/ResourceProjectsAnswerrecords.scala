...
@JSImport("googleapis/build/src/apis/dialogflow/v2beta1", "dialogflow_v2beta1.Resource$Projects$Answerrecords")
@js.native
open class ResourceProjectsAnswerrecords protected () extends StObject {
  ...
  def get(params: ParamsResourceProjectsAnswerrecordsGet): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1AnswerRecord] = js.native
  def get(
    params: ParamsResourceProjectsAnswerrecordsGet,
  ...
  def get(params: ParamsResourceProjectsAnswerrecordsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1AnswerRecord] = js.native
  def get(
    params: ParamsResourceProjectsAnswerrecordsGet,
  ...
  /**
    ...
    */
  def get(params: ParamsResourceProjectsAnswerrecordsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceProjectsAnswerrecordsGet,
  ...
  def list(params: ParamsResourceProjectsAnswerrecordsList): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1ListAnswerRecordsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsAnswerrecordsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1ListAnswerRecordsResponse] = js.native
  def list(
    params: ParamsResourceProjectsAnswerrecordsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1ListAnswerRecordsResponse]
  ...
  def patch(params: ParamsResourceProjectsAnswerrecordsPatch): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1AnswerRecord] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsAnswerrecordsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowV2beta1AnswerRecord] = js.native
  def patch(
    params: ParamsResourceProjectsAnswerrecordsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowV2beta1AnswerRecord]
