...
trait ParamsResourceProjectsSecretsVersionsList
  extends StObject
...
object ParamsResourceProjectsSecretsVersionsList {
  
  inline def apply(): ParamsResourceProjectsSecretsVersionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSecretsVersionsList]
  }
  
  extension [Self <: ParamsResourceProjectsSecretsVersionsList](x: Self) {
