...
trait ParamsResourceProjectsLocationsStreamsList
  extends StObject
...
object ParamsResourceProjectsLocationsStreamsList {
  
  inline def apply(): ParamsResourceProjectsLocationsStreamsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsStreamsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsStreamsList](x: Self) {
