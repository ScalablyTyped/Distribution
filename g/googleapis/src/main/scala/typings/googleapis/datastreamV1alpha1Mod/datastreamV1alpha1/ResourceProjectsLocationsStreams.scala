...
@JSImport("googleapis/build/src/apis/datastream/v1alpha1", "datastream_v1alpha1.Resource$Projects$Locations$Streams")
@js.native
open class ResourceProjectsLocationsStreams protected () extends StObject {
  ...
  def fetchErrors(): GaxiosPromise[SchemaOperation] = js.native
  def fetchErrors(callback: BodyResponseCallback[SchemaOperation]): Unit = js.native
  def fetchErrors(params: Unit, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def fetchErrors(params: ParamsResourceProjectsLocationsStreamsFetcherrors): GaxiosPromise[SchemaOperation] = js.native
  def fetchErrors(
    params: ParamsResourceProjectsLocationsStreamsFetcherrors,
    callback: BodyResponseCallback[SchemaOperation]
  ): Unit = js.native
  def fetchErrors(
    params: ParamsResourceProjectsLocationsStreamsFetcherrors,
  ...
  def fetchErrors(params: ParamsResourceProjectsLocationsStreamsFetcherrors, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def fetchErrors(
    params: ParamsResourceProjectsLocationsStreamsFetcherrors,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def fetchErrors(params: ParamsResourceProjectsLocationsStreamsFetcherrors, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def fetchErrors(
    params: ParamsResourceProjectsLocationsStreamsFetcherrors,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
