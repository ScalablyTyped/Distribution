...
trait SchemaOperationMetadata extends StObject {
  ...
  /**
    ...
    */
  var validationResult: js.UndefOr[SchemaValidationResult] = js.undefined
...
object SchemaOperationMetadata {
  ...
  extension [Self <: SchemaOperationMetadata](x: Self) {
    ...
    inline def setValidationResult(value: SchemaValidationResult): Self = StObject.set(x, "validationResult", value.asInstanceOf[js.Any])
