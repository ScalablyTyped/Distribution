...
trait ParamsResourceServicesConsumerquotametricsLimitsProduceroverridesPatch
  extends StObject
...
object ParamsResourceServicesConsumerquotametricsLimitsProduceroverridesPatch {
  
  inline def apply(): ParamsResourceServicesConsumerquotametricsLimitsProduceroverridesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceServicesConsumerquotametricsLimitsProduceroverridesPatch]
  }
  
  extension [Self <: ParamsResourceServicesConsumerquotametricsLimitsProduceroverridesPatch](x: Self) {
