...
trait SchemaV1Beta1QuotaOverride extends StObject {
...
object SchemaV1Beta1QuotaOverride {
  
  inline def apply(): SchemaV1Beta1QuotaOverride = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaV1Beta1QuotaOverride]
  }
  
  extension [Self <: SchemaV1Beta1QuotaOverride](x: Self) {
