...
@JSImport("googleapis/build/src/apis/datafusion/v1beta1", "datafusion_v1beta1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  def removeIamPolicy(params: ParamsResourceProjectsLocationsRemoveiampolicy): GaxiosPromise[SchemaRemoveIamPolicyResponse] = js.native
  def removeIamPolicy(
    params: ParamsResourceProjectsLocationsRemoveiampolicy,
  ...
  def removeIamPolicy(params: ParamsResourceProjectsLocationsRemoveiampolicy, options: MethodOptions): GaxiosPromise[SchemaRemoveIamPolicyResponse] = js.native
  def removeIamPolicy(
    params: ParamsResourceProjectsLocationsRemoveiampolicy,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaRemoveIamPolicyResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def removeIamPolicy(params: ParamsResourceProjectsLocationsRemoveiampolicy, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def removeIamPolicy(
    params: ParamsResourceProjectsLocationsRemoveiampolicy,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  var versions: ResourceProjectsLocationsVersions = js.native
}
