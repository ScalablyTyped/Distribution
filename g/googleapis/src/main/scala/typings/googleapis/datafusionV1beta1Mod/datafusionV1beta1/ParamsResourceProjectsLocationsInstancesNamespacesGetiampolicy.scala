...
trait ParamsResourceProjectsLocationsInstancesNamespacesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsInstancesNamespacesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsInstancesNamespacesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsInstancesNamespacesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsInstancesNamespacesGetiampolicy](x: Self) {
