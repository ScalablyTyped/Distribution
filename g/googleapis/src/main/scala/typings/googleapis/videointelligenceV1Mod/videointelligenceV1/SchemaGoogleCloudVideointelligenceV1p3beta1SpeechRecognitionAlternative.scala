...
object SchemaGoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternativeMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setWords(value: js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1WordInfo]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordsUndefined: Self = StObject.set(x, "words", js.undefined)
    
    @scala.inline
    def setWordsVarargs(value: SchemaGoogleCloudVideointelligenceV1p3beta1WordInfo*): Self = StObject.set(x, "words", js.Array(value :_*))
  }
}
