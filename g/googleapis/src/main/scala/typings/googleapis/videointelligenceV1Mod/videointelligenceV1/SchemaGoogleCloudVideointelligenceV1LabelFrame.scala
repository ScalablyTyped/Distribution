...
object SchemaGoogleCloudVideointelligenceV1LabelFrame {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1LabelFrame = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1LabelFrame]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1LabelFrameMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1LabelFrame] (val x: Self) extends AnyVal {
