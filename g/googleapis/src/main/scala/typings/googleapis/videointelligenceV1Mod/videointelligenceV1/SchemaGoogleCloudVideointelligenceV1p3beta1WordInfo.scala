...
/**
  ...
  */
trait SchemaGoogleCloudVideointelligenceV1p3beta1WordInfo extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p3beta1WordInfo {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p3beta1WordInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p3beta1WordInfo]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1WordInfoMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1WordInfo] (val x: Self) extends AnyVal {
