...
trait SchemaGoogleCloudVideointelligenceV1VideoContext extends StObject {
  ...
  /**
    ...
    */
  var shotChangeDetectionConfig: js.UndefOr[SchemaGoogleCloudVideointelligenceV1ShotChangeDetectionConfig] = js.undefined
  
  /**
    * Config for SPEECH_TRANSCRIPTION.
    */
  var speechTranscriptionConfig: js.UndefOr[SchemaGoogleCloudVideointelligenceV1SpeechTranscriptionConfig] = js.undefined
  
  /**
    * Config for TEXT_DETECTION.
    */
  var textDetectionConfig: js.UndefOr[SchemaGoogleCloudVideointelligenceV1TextDetectionConfig] = js.undefined
}
object SchemaGoogleCloudVideointelligenceV1VideoContext {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1VideoContext = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1VideoContext]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1VideoContext](x: Self) {
    
    inline def setExplicitContentDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1ExplicitContentDetectionConfig): Self = StObject.set(x, "explicitContentDetectionConfig", value.asInstanceOf[js.Any])
    ...
    inline def setSpeechTranscriptionConfig(value: SchemaGoogleCloudVideointelligenceV1SpeechTranscriptionConfig): Self = StObject.set(x, "speechTranscriptionConfig", value.asInstanceOf[js.Any])
    
    inline def setSpeechTranscriptionConfigUndefined: Self = StObject.set(x, "speechTranscriptionConfig", js.undefined)
    
    inline def setTextDetectionConfig(value: SchemaGoogleCloudVideointelligenceV1TextDetectionConfig): Self = StObject.set(x, "textDetectionConfig", value.asInstanceOf[js.Any])
