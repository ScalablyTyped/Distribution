...
trait SchemaGoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1beta2FaceDetectionAnnotation](x: Self) {
