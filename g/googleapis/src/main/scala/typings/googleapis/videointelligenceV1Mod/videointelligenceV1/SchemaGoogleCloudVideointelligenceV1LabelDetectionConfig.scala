...
object SchemaGoogleCloudVideointelligenceV1LabelDetectionConfig {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1LabelDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1LabelDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1LabelDetectionConfig](x: Self) {
