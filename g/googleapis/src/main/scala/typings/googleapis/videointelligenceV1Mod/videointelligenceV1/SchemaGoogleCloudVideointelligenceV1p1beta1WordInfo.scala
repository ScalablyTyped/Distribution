...
/**
  ...
  */
trait SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p1beta1WordInfoMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p1beta1WordInfo] (val x: Self) extends AnyVal {
