...
trait SchemaGoogleCloudVideointelligenceV1FaceDetectionConfig extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1FaceDetectionConfig {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1FaceDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1FaceDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1FaceDetectionConfig](x: Self) {
