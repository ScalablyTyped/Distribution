...
object SchemaGoogleCloudVideointelligenceV1p3beta1TextAnnotation {
  ...
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1TextAnnotationOps[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1TextAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSegmentsVarargs(value: SchemaGoogleCloudVideointelligenceV1p3beta1TextSegment*): Self = this.set("segments", js.Array(value :_*))
    
    @scala.inline
    def setSegments(value: js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1TextSegment]): Self = this.set("segments", value.asInstanceOf[js.Any])
