...
import typings.googleapis.googleapisStrings.v1dev
...
object v1devMod {
  ...
  object displayvideoV1dev {
    ...
    @JSImport("googleapis/build/src/apis/displayvideo/v1dev", "displayvideo_v1dev.Displayvideo")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/displayvideo/v1dev", "displayvideo_v1dev.Resource$Media")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/displayvideo/v1dev", "displayvideo_v1dev.Resource$Sdfdownloadtasks")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/displayvideo/v1dev", "displayvideo_v1dev.Resource$Sdfdownloadtasks$Operations")
    @js.native
    ...
    object Options {
      ...
      inline def apply(): Options = {
        val __obj = js.Dynamic.literal(version = "v1dev")
        __obj.asInstanceOf[Options]
      }
      
      extension [Self <: Options](x: Self) {
        
        inline def setVersion(value: v1dev): Self = StObject.set(x, "version", value.asInstanceOf[js.Any])
      }
    }
