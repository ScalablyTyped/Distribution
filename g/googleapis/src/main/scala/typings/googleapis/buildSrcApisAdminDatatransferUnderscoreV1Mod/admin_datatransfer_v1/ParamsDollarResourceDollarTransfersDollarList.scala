...
@js.native
trait ParamsDollarResourceDollarTransfersDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTransfersDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    status: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarTransfersDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTransfersDollarList]
  }
}
