...
trait SchemaCreateBitbucketServerConfigOperationMetadata extends StObject {
...
object SchemaCreateBitbucketServerConfigOperationMetadata {
  
  inline def apply(): SchemaCreateBitbucketServerConfigOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCreateBitbucketServerConfigOperationMetadata]
  }
  
  extension [Self <: SchemaCreateBitbucketServerConfigOperationMetadata](x: Self) {
