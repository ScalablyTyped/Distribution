...
trait SchemaGoogleDevtoolsCloudbuildV2OperationMetadata extends StObject {
...
object SchemaGoogleDevtoolsCloudbuildV2OperationMetadata {
  
  inline def apply(): SchemaGoogleDevtoolsCloudbuildV2OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleDevtoolsCloudbuildV2OperationMetadata]
  }
  
  extension [Self <: SchemaGoogleDevtoolsCloudbuildV2OperationMetadata](x: Self) {
