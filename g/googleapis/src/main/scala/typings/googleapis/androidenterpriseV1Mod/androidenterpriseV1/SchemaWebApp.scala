...
trait SchemaWebApp extends StObject {
  ...
  /**
    ...
    */
  var displayMode: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var startUrl: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var webAppId: js.UndefOr[String | Null] = js.undefined
}
object SchemaWebApp {
  ...
  extension [Self <: SchemaWebApp](x: Self) {
    ...
    inline def setDisplayModeNull: Self = StObject.set(x, "displayMode", null)
    ...
    inline def setIconsVarargs(value: SchemaWebAppIcon*): Self = StObject.set(x, "icons", js.Array(value*))
    ...
    inline def setStartUrlNull: Self = StObject.set(x, "startUrl", null)
    ...
    inline def setWebAppIdNull: Self = StObject.set(x, "webAppId", null)
