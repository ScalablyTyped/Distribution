...
class ResourceUsers protected () extends StObject {
  ...
  def generateToken(params: Unit, options: MethodOptions): GaxiosPromise[SchemaUserToken] = js.native
  ...
  def revokeToken(params: Unit, options: MethodOptions): GaxiosPromise[Unit] = js.native
