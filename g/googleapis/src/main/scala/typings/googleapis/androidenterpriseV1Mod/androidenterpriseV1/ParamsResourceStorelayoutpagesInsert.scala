...
@js.native
trait ParamsResourceStorelayoutpagesInsert extends StandardParameters {
...
object ParamsResourceStorelayoutpagesInsert {
  
  @scala.inline
  def apply(): ParamsResourceStorelayoutpagesInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceStorelayoutpagesInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceStorelayoutpagesInsertMutableBuilder[Self <: ParamsResourceStorelayoutpagesInsert] (val x: Self) extends AnyVal {
