...
trait ParamsResourceManagedconfigurationsfordevicePatch
  extends StObject
...
object ParamsResourceManagedconfigurationsfordevicePatch {
  ...
  @scala.inline
  implicit class ParamsResourceManagedconfigurationsfordevicePatchMutableBuilder[Self <: ParamsResourceManagedconfigurationsfordevicePatch] (val x: Self) extends AnyVal {
