...
@js.native
trait ParamsResourceWebappsGet extends StandardParameters {
...
object ParamsResourceWebappsGet {
  
  @scala.inline
  def apply(): ParamsResourceWebappsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceWebappsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceWebappsGetMutableBuilder[Self <: ParamsResourceWebappsGet] (val x: Self) extends AnyVal {
