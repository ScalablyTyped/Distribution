...
trait SchemaAppVersion extends StObject {
  ...
  /**
    ...
    */
  var isProduction: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var trackId: js.UndefOr[js.Array[String] | Null] = js.undefined
...
object SchemaAppVersion {
  ...
  extension [Self <: SchemaAppVersion](x: Self) {
    ...
    inline def setIsProductionNull: Self = StObject.set(x, "isProduction", null)
