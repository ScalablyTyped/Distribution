...
object ParamsResourceEnterprisesUnenroll {
  ...
  @scala.inline
  def apply(): ParamsResourceEnterprisesUnenroll = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEnterprisesUnenroll]
  }
  
  @scala.inline
  implicit class ParamsResourceEnterprisesUnenrollMutableBuilder[Self <: ParamsResourceEnterprisesUnenroll] (val x: Self) extends AnyVal {
