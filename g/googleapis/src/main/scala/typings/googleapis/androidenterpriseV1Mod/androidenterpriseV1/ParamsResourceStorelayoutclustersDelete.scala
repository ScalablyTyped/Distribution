...
@js.native
trait ParamsResourceStorelayoutclustersDelete extends StandardParameters {
...
object ParamsResourceStorelayoutclustersDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceStorelayoutclustersDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceStorelayoutclustersDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceStorelayoutclustersDeleteMutableBuilder[Self <: ParamsResourceStorelayoutclustersDelete] (val x: Self) extends AnyVal {
