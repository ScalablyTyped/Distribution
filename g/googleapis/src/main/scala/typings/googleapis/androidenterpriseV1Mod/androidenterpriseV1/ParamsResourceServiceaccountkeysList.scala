...
object ParamsResourceServiceaccountkeysList {
  ...
  @scala.inline
  def apply(): ParamsResourceServiceaccountkeysList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceServiceaccountkeysList]
  }
  
  @scala.inline
  implicit class ParamsResourceServiceaccountkeysListMutableBuilder[Self <: ParamsResourceServiceaccountkeysList] (val x: Self) extends AnyVal {
