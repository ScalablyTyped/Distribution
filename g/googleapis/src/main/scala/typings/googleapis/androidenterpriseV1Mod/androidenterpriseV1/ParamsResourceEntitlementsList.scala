...
@js.native
trait ParamsResourceEntitlementsList extends StandardParameters {
...
object ParamsResourceEntitlementsList {
  ...
  @scala.inline
  def apply(): ParamsResourceEntitlementsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceEntitlementsList]
  }
  
  @scala.inline
  implicit class ParamsResourceEntitlementsListMutableBuilder[Self <: ParamsResourceEntitlementsList] (val x: Self) extends AnyVal {
