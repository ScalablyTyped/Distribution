...
@js.native
trait ParamsResourceWebappsInsert extends StandardParameters {
...
object ParamsResourceWebappsInsert {
  ...
  @scala.inline
  def apply(): ParamsResourceWebappsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceWebappsInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceWebappsInsertMutableBuilder[Self <: ParamsResourceWebappsInsert] (val x: Self) extends AnyVal {
