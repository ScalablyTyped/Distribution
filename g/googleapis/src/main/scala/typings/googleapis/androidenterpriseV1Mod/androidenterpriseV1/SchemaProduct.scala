...
object SchemaProduct {
  ...
  extension [Self <: SchemaProduct](x: Self) {
    ...
    inline def setAppTracksVarargs(value: SchemaTrackInfo*): Self = StObject.set(x, "appTracks", js.Array(value :_*))
    ...
    inline def setAppVersionVarargs(value: SchemaAppVersion*): Self = StObject.set(x, "appVersion", js.Array(value :_*))
    ...
    inline def setPermissionsVarargs(value: SchemaProductPermission*): Self = StObject.set(x, "permissions", js.Array(value :_*))
