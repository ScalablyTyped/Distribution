...
trait ParamsResourceManagedconfigurationsforuserPatch
  extends StObject
...
object ParamsResourceManagedconfigurationsforuserPatch {
  ...
  @scala.inline
  implicit class ParamsResourceManagedconfigurationsforuserPatchMutableBuilder[Self <: ParamsResourceManagedconfigurationsforuserPatch] (val x: Self) extends AnyVal {
