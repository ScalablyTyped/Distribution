...
trait ParamsResourceStorelayoutclustersUpdate
  extends StObject
...
object ParamsResourceStorelayoutclustersUpdate {
  ...
  inline def apply(): ParamsResourceStorelayoutclustersUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceStorelayoutclustersUpdate]
  }
  
  extension [Self <: ParamsResourceStorelayoutclustersUpdate](x: Self) {
