...
object ParamsResourceDevicesSetstate {
  ...
  @scala.inline
  implicit class ParamsResourceDevicesSetstateMutableBuilder[Self <: ParamsResourceDevicesSetstate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaDeviceState): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
