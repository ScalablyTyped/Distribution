...
object ParamsResourceProductsApprove {
  ...
  @scala.inline
  implicit class ParamsResourceProductsApproveOps[Self <: ParamsResourceProductsApprove] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaProductsApproveRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
