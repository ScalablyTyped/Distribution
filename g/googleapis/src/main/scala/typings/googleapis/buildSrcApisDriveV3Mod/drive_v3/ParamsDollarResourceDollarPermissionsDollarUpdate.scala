...
@js.native
trait ParamsDollarResourceDollarPermissionsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPermissionsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    removeExpiration: js.UndefOr[Boolean] = js.undefined,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPermissionsDollarUpdate = {
    ...
    if (!js.isUndefined(removeExpiration)) __obj.updateDynamic("removeExpiration")(removeExpiration.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPermissionsDollarUpdate]
  }
}
