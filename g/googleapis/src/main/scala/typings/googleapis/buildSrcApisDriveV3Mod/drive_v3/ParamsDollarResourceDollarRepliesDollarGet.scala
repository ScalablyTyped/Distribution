...
@js.native
trait ParamsDollarResourceDollarRepliesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRepliesDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    replyId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarRepliesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRepliesDollarGet]
  }
}
