...
@js.native
trait ParamsDollarResourceDollarTeamdrivesDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTeamdrivesDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTeamdrivesDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTeamdrivesDollarUpdate]
  }
}
