...
/**
  ...
  */
@js.native
trait Schema$Placeholder extends js.Object {
  /**
...
object Schema$Placeholder {
  @scala.inline
  def apply(index: Int | Double = null, parentObjectId: String = null, `type`: String = null): Schema$Placeholder = {
    ...
    __obj.asInstanceOf[Schema$Placeholder]
  }
}
