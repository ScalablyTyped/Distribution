...
/**
  ...
  */
@js.native
trait Schema$WriteControl extends js.Object {
  /**
...
object Schema$WriteControl {
  @scala.inline
  def apply(requiredRevisionId: String = null): Schema$WriteControl = {
    val __obj = js.Dynamic.literal()
    if (requiredRevisionId != null) __obj.updateDynamic("requiredRevisionId")(requiredRevisionId.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$WriteControl]
  }
}
