...
/**
  ...
  */
@js.native
trait Schema$RerouteLineRequest extends js.Object {
  /**
...
object Schema$RerouteLineRequest {
  @scala.inline
  def apply(objectId: String = null): Schema$RerouteLineRequest = {
    val __obj = js.Dynamic.literal()
    if (objectId != null) __obj.updateDynamic("objectId")(objectId.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$RerouteLineRequest]
  }
}
