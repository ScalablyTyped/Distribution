...
/**
  ...
  */
@js.native
trait Schema$WeightedFontFamily extends js.Object {
  /**
...
object Schema$WeightedFontFamily {
  @scala.inline
  def apply(fontFamily: String = null, weight: Int | Double = null): Schema$WeightedFontFamily = {
    val __obj = js.Dynamic.literal()
    if (fontFamily != null) __obj.updateDynamic("fontFamily")(fontFamily.asInstanceOf[js.Any])
    if (weight != null) __obj.updateDynamic("weight")(weight.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$WeightedFontFamily]
  }
}
