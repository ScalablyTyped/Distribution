...
/**
  ...
  */
@js.native
trait Schema$UpdateSlidesPositionRequest extends js.Object {
  /**
...
object Schema$UpdateSlidesPositionRequest {
  @scala.inline
  def apply(insertionIndex: Int | Double = null, slideObjectIds: js.Array[String] = null): Schema$UpdateSlidesPositionRequest = {
    ...
    __obj.asInstanceOf[Schema$UpdateSlidesPositionRequest]
  }
}
