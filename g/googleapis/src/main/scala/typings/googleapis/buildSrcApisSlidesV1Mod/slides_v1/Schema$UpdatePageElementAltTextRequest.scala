...
/**
  ...
  */
@js.native
trait Schema$UpdatePageElementAltTextRequest extends js.Object {
  /**
...
object Schema$UpdatePageElementAltTextRequest {
  @scala.inline
  def apply(description: String = null, objectId: String = null, title: String = null): Schema$UpdatePageElementAltTextRequest = {
    val __obj = js.Dynamic.literal()
    if (description != null) __obj.updateDynamic("description")(description.asInstanceOf[js.Any])
    if (objectId != null) __obj.updateDynamic("objectId")(objectId.asInstanceOf[js.Any])
    if (title != null) __obj.updateDynamic("title")(title.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$UpdatePageElementAltTextRequest]
  }
}
