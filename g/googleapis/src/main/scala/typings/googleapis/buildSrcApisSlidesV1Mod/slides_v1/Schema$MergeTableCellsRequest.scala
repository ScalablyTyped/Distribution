...
/**
  ...
  */
@js.native
trait Schema$MergeTableCellsRequest extends js.Object {
  /**
...
object Schema$MergeTableCellsRequest {
  @scala.inline
  def apply(objectId: String = null, tableRange: Schema$TableRange = null): Schema$MergeTableCellsRequest = {
    val __obj = js.Dynamic.literal()
    if (objectId != null) __obj.updateDynamic("objectId")(objectId.asInstanceOf[js.Any])
    if (tableRange != null) __obj.updateDynamic("tableRange")(tableRange.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$MergeTableCellsRequest]
  }
}
