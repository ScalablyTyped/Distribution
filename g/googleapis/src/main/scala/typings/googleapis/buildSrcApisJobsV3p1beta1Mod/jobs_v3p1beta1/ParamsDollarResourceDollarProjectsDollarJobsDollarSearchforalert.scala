...
@js.native
trait ParamsDollarResourceDollarProjectsDollarJobsDollarSearchforalert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$SearchJobsRequest] = js.native
}
