...
/**
  ...
  */
@js.native
trait Schema$JobDerivedInfo extends js.Object {
  /**
...
object Schema$JobDerivedInfo {
  @scala.inline
  def apply(jobCategories: js.Array[String] = null, locations: js.Array[Schema$Location] = null): Schema$JobDerivedInfo = {
    val __obj = js.Dynamic.literal()
    if (jobCategories != null) __obj.updateDynamic("jobCategories")(jobCategories.asInstanceOf[js.Any])
    if (locations != null) __obj.updateDynamic("locations")(locations.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$JobDerivedInfo]
  }
}
