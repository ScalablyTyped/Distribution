...
/**
  ...
  */
@js.native
trait Schema$HistogramQueryResult extends js.Object {
  /**
...
object Schema$HistogramQueryResult {
  @scala.inline
  def apply(histogram: StringDictionary[String] = null, histogramQuery: String = null): Schema$HistogramQueryResult = {
    ...
    __obj.asInstanceOf[Schema$HistogramQueryResult]
  }
}
