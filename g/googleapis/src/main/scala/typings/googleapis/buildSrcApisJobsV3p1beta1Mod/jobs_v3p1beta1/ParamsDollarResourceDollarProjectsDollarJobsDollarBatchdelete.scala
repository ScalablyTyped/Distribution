...
@js.native
trait ParamsDollarResourceDollarProjectsDollarJobsDollarBatchdelete extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$BatchDeleteJobsRequest] = js.native
}
