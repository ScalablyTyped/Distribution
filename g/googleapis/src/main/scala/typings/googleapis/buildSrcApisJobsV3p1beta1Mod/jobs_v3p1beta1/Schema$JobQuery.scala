...
/**
  ...
  */
@js.native
trait Schema$JobQuery extends js.Object {
  /**
    ...
    */
  var commuteFilter: js.UndefOr[Schema$CommuteFilter] = js.native
  /**
  ...
  /**
    ...
    */
  var compensationFilter: js.UndefOr[Schema$CompensationFilter] = js.native
  /**
  ...
  /**
    ...
    */
  var locationFilters: js.UndefOr[js.Array[Schema$LocationFilter]] = js.native
  /**
    * Optional.  Jobs published within a range specified by this filter are
    * searched against.
    */
  var publishTimeRange: js.UndefOr[Schema$TimestampRange] = js.native
  /**
...
object Schema$JobQuery {
  @scala.inline
  def apply(
    commuteFilter: Schema$CommuteFilter = null,
    companyDisplayNames: js.Array[String] = null,
    companyNames: js.Array[String] = null,
    compensationFilter: Schema$CompensationFilter = null,
    ...
    locationFilters: js.Array[Schema$LocationFilter] = null,
    publishTimeRange: Schema$TimestampRange = null,
    query: String = null
  ): Schema$JobQuery = {
    ...
    __obj.asInstanceOf[Schema$JobQuery]
  }
}
