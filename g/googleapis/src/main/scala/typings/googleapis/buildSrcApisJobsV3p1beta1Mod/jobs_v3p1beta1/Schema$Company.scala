...
/**
  ...
  */
@js.native
trait Schema$Company extends js.Object {
  /**
  ...
  /**
    ...
    */
  var derivedInfo: js.UndefOr[Schema$CompanyDerivedInfo] = js.native
  /**
...
object Schema$Company {
  ...
  def apply(
    ...
    derivedInfo: Schema$CompanyDerivedInfo = null,
    ...
    __obj.asInstanceOf[Schema$Company]
  }
}
