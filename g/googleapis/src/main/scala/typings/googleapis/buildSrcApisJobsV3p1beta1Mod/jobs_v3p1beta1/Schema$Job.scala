...
trait Schema$Job extends js.Object {
  ...
  /**
    ...
    */
  var applicationInfo: js.UndefOr[Schema$ApplicationInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var derivedInfo: js.UndefOr[Schema$JobDerivedInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var processingOptions: js.UndefOr[Schema$ProcessingOptions] = js.native
  /**
...
object Schema$Job {
  ...
  def apply(
    ...
    applicationInfo: Schema$ApplicationInfo = null,
    ...
    derivedInfo: Schema$JobDerivedInfo = null,
    ...
    processingOptions: Schema$ProcessingOptions = null,
