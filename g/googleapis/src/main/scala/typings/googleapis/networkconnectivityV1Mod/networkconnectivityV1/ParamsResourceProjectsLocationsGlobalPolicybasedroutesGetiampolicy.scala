...
trait ParamsResourceProjectsLocationsGlobalPolicybasedroutesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsGlobalPolicybasedroutesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsGlobalPolicybasedroutesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGlobalPolicybasedroutesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGlobalPolicybasedroutesGetiampolicy](x: Self) {
