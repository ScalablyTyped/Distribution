...
trait ParamsResourceProjectsLocationsGlobalHubsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsGlobalHubsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsGlobalHubsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGlobalHubsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGlobalHubsGetiampolicy](x: Self) {
