...
@js.native
trait ParamsDollarResourceDollarActivitiesDollarWatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarActivitiesDollarWatch {
  @scala.inline
  def apply(
    ...
    userIp: String = null,
    userKey: String = null
  ): ParamsDollarResourceDollarActivitiesDollarWatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarActivitiesDollarWatch]
  }
}
