...
@js.native
trait ParamsDollarResourceDollarCustomerusagereportsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCustomerusagereportsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCustomerusagereportsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCustomerusagereportsDollarGet]
  }
}
