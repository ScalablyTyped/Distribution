...
/**
  ...
  */
@js.native
trait Schema$GoogleDatastoreAdminV1beta1EntityFilter extends js.Object {
  /**
...
object Schema$GoogleDatastoreAdminV1beta1EntityFilter {
  @scala.inline
  def apply(kinds: js.Array[String] = null, namespaceIds: js.Array[String] = null): Schema$GoogleDatastoreAdminV1beta1EntityFilter = {
    ...
    __obj.asInstanceOf[Schema$GoogleDatastoreAdminV1beta1EntityFilter]
  }
}
