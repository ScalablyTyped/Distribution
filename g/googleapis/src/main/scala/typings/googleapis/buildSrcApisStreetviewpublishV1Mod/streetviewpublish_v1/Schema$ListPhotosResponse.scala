...
/**
  ...
  */
@js.native
trait Schema$ListPhotosResponse extends js.Object {
  /**
...
object Schema$ListPhotosResponse {
  @scala.inline
  def apply(nextPageToken: String = null, photos: js.Array[Schema$Photo] = null): Schema$ListPhotosResponse = {
    val __obj = js.Dynamic.literal()
    if (nextPageToken != null) __obj.updateDynamic("nextPageToken")(nextPageToken.asInstanceOf[js.Any])
    if (photos != null) __obj.updateDynamic("photos")(photos.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ListPhotosResponse]
  }
}
