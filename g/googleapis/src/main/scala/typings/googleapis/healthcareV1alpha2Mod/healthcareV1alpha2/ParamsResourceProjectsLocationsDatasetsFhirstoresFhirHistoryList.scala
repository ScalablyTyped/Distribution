...
object ParamsResourceProjectsLocationsDatasetsFhirstoresFhirHistoryList {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsFhirstoresFhirHistoryList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsFhirstoresFhirHistoryList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresFhirHistoryList](x: Self) {
