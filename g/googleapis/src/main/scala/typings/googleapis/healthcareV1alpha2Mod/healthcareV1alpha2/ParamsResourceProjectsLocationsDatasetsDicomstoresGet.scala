...
object ParamsResourceProjectsLocationsDatasetsDicomstoresGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresGetOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresGet] (val x: Self) extends AnyVal {
    @scala.inline
