...
object SchemaImportResourcesRequest {
  ...
  extension [Self <: SchemaImportResourcesRequest](x: Self) {
    ...
    inline def setGcsErrorDestination(value: SchemaGoogleCloudHealthcareV1alpha2FhirRestGcsErrorDestination): Self = StObject.set(x, "gcsErrorDestination", value.asInstanceOf[js.Any])
    
    inline def setGcsErrorDestinationUndefined: Self = StObject.set(x, "gcsErrorDestination", js.undefined)
    
    inline def setGcsSource(value: SchemaGoogleCloudHealthcareV1alpha2FhirRestGcsSource): Self = StObject.set(x, "gcsSource", value.asInstanceOf[js.Any])
