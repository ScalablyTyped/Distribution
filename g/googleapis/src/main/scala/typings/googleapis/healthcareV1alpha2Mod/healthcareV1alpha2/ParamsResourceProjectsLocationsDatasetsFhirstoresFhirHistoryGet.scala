...
object ParamsResourceProjectsLocationsDatasetsFhirstoresFhirHistoryGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsFhirstoresFhirHistoryGetOps[Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresFhirHistoryGet] (val x: Self) extends AnyVal {
    @scala.inline
