...
object ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStoreinstances {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStoreinstancesOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStoreinstances] (val x: Self) extends AnyVal {
