...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsCreateOps[Self <: ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsCreate] (val x: Self) extends AnyVal {
