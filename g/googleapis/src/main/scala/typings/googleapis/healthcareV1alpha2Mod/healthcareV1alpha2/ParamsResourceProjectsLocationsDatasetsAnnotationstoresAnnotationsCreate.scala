...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsCreateMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsAnnotationstoresAnnotationsCreate] (val x: Self) extends AnyVal {
