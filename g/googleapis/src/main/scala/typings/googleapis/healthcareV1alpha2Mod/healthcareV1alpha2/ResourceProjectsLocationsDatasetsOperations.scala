...
@JSImport("googleapis/build/src/apis/healthcare/v1alpha2", "healthcare_v1alpha2.Resource$Projects$Locations$Datasets$Operations")
@js.native
class ResourceProjectsLocationsDatasetsOperations protected () extends js.Object {
