...
@js.native
trait ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesSearchforinstances extends StandardParameters {
  /**
...
object ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesSearchforinstances {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesSearchforinstancesOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesSearchforinstances] (val x: Self) extends AnyVal {
    @scala.inline
