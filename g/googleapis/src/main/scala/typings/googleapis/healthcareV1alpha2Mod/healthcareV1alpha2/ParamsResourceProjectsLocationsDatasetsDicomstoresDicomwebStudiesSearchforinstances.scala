...
object ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesSearchforinstances {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesSearchforinstances = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesSearchforinstances]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesSearchforinstances](x: Self) {
