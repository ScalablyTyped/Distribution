...
object ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesStoreinstances {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesStoreinstances = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesStoreinstances]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesStoreinstances](x: Self) {
