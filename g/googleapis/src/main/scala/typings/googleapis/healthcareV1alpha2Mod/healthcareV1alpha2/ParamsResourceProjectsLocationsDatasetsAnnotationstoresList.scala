...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresList {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsAnnotationstoresList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsAnnotationstoresList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsAnnotationstoresList](x: Self) {
