...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsAnnotationstoresListOps[Self <: ParamsResourceProjectsLocationsDatasetsAnnotationstoresList] (val x: Self) extends AnyVal {
