...
@js.native
class ResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesSeriesInstances protected () extends StObject {
  ...
  def metadata(params: Unit, options: MethodOptions): GaxiosPromise[SchemaHttpBody] = js.native
