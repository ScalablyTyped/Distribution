...
object ParamsResourceProjectsLocationsDatasetsFhirstoresExport {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsFhirstoresExportMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresExport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaExportResourcesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
