...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresCreate {
  ...
  implicit class ParamsResourceProjectsLocationsDatasetsAnnotationstoresCreateOps[Self <: ParamsResourceProjectsLocationsDatasetsAnnotationstoresCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnnotationStoreId(value: String): Self = this.set("annotationStoreId", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAnnotationStoreId: Self = this.set("annotationStoreId", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaAnnotationStore): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
