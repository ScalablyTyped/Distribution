...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresCreate {
  ...
  def apply(
    ...
    requestBody: SchemaAnnotationStore = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceProjectsLocationsDatasetsAnnotationstoresCreate = {
    val __obj = js.Dynamic.literal()
    if ($Dotxgafv != null) __obj.updateDynamic("$.xgafv")($Dotxgafv.asInstanceOf[js.Any])
    if (access_token != null) __obj.updateDynamic("access_token")(access_token.asInstanceOf[js.Any])
    if (alt != null) __obj.updateDynamic("alt")(alt.asInstanceOf[js.Any])
    if (annotationStoreId != null) __obj.updateDynamic("annotationStoreId")(annotationStoreId.asInstanceOf[js.Any])
