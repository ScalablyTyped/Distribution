...
object SchemaFhirStore {
  ...
  extension [Self <: SchemaFhirStore](x: Self) {
    ...
    inline def setEnableHistoryImport(value: Boolean): Self = StObject.set(x, "enableHistoryImport", value.asInstanceOf[js.Any])
    
    inline def setEnableHistoryImportUndefined: Self = StObject.set(x, "enableHistoryImport", js.undefined)
