...
object ParamsResourceProjectsLocationsDatasetsDicomstoresExport {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresExportOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresExport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaExportDicomDataRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
