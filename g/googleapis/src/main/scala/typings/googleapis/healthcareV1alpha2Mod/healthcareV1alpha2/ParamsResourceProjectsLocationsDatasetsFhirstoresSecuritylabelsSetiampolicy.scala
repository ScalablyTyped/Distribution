...
object ParamsResourceProjectsLocationsDatasetsFhirstoresSecuritylabelsSetiampolicy {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsFhirstoresSecuritylabelsSetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsFhirstoresSecuritylabelsSetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresSecuritylabelsSetiampolicy](x: Self) {
