...
object ParamsResourceProjectsLocationsDatasetsAnnotationstoresGet {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsDatasetsAnnotationstoresGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsAnnotationstoresGet]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsAnnotationstoresGetMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsAnnotationstoresGet] (val x: Self) extends AnyVal {
