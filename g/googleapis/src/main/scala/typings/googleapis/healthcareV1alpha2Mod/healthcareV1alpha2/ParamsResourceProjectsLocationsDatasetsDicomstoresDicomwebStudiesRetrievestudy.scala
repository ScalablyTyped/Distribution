...
trait ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesRetrievestudy
  extends StObject
...
object ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesRetrievestudy {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesRetrievestudy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesRetrievestudy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresDicomwebStudiesRetrievestudy](x: Self) {
