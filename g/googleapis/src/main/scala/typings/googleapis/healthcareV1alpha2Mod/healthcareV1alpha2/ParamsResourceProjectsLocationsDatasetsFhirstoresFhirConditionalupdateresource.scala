...
object ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdateresource {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdateresourceOps[Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdateresource] (val x: Self) extends AnyVal {
    @scala.inline
