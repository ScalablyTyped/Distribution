...
trait ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdateresource
  extends StObject
...
object ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdateresource {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdateresource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdateresource]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdateresource](x: Self) {
