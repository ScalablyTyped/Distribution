...
trait SchemaCloudSqlSettings extends StObject {
  ...
  /**
    ...
    */
  var autoStorageIncrease: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var databaseFlags: js.UndefOr[StringDictionary[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var ipConfig: js.UndefOr[SchemaSqlIpConfig] = js.undefined
  ...
  /**
    ...
    */
  var rootPasswordSet: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * The Database Migration Service source connection profile ID, in the format: `projects/my_project_name/locations/us-central1/connectionProfiles/connection_profile_ID`
    */
  var sourceId: js.UndefOr[String | Null] = js.undefined
...
object SchemaCloudSqlSettings {
  
  inline def apply(): SchemaCloudSqlSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCloudSqlSettings]
  }
  
  extension [Self <: SchemaCloudSqlSettings](x: Self) {
    ...
    inline def setAutoStorageIncreaseNull: Self = StObject.set(x, "autoStorageIncrease", null)
    ...
    inline def setDatabaseFlags(value: StringDictionary[String]): Self = StObject.set(x, "databaseFlags", value.asInstanceOf[js.Any])
    
    inline def setDatabaseFlagsNull: Self = StObject.set(x, "databaseFlags", null)
    ...
    inline def setIpConfig(value: SchemaSqlIpConfig): Self = StObject.set(x, "ipConfig", value.asInstanceOf[js.Any])
    ...
    inline def setRootPasswordSetNull: Self = StObject.set(x, "rootPasswordSet", null)
