...
trait ParamsResourceProjectsLocationsConnectionprofilesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsConnectionprofilesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsConnectionprofilesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsConnectionprofilesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsConnectionprofilesGetiampolicy](x: Self) {
