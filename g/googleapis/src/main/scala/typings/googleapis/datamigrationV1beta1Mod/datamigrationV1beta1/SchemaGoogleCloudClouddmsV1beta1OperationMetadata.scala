...
trait SchemaGoogleCloudClouddmsV1beta1OperationMetadata extends StObject {
...
object SchemaGoogleCloudClouddmsV1beta1OperationMetadata {
  
  inline def apply(): SchemaGoogleCloudClouddmsV1beta1OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudClouddmsV1beta1OperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudClouddmsV1beta1OperationMetadata](x: Self) {
