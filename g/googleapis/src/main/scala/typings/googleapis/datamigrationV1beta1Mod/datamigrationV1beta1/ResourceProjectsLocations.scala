...
@JSImport("googleapis/build/src/apis/datamigration/v1beta1", "datamigration_v1beta1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var connectionProfiles: ResourceProjectsLocationsConnectionprofiles = js.native
  ...
  var migrationJobs: ResourceProjectsLocationsMigrationjobs = js.native
