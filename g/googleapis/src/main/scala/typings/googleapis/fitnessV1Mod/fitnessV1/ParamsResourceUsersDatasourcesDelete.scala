...
trait ParamsResourceUsersDatasourcesDelete
  extends StObject
...
object ParamsResourceUsersDatasourcesDelete {
  ...
  inline def apply(): ParamsResourceUsersDatasourcesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersDatasourcesDelete]
  }
  
  extension [Self <: ParamsResourceUsersDatasourcesDelete](x: Self) {
