...
trait SchemaGoogleCloudDialogflowCxV3IntentParameter extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3IntentParameter {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3IntentParameter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3IntentParameter]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3IntentParameter](x: Self) {
