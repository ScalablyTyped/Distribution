...
trait SchemaGoogleCloudDialogflowCxV3Changelog extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3Changelog {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3Changelog = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3Changelog]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3Changelog](x: Self) {
