...
trait SchemaGoogleCloudDialogflowV2beta1SmartReplyAnswer extends StObject {
...
object SchemaGoogleCloudDialogflowV2beta1SmartReplyAnswer {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1SmartReplyAnswer = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1SmartReplyAnswer]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1SmartReplyAnswer](x: Self) {
