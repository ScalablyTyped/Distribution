...
trait SchemaGoogleCloudDialogflowV2beta1Message extends StObject {
  ...
  /**
    ...
    */
  var messageAnnotation: js.UndefOr[SchemaGoogleCloudDialogflowV2beta1MessageAnnotation] = js.undefined
  ...
  /**
    ...
    */
  var sentimentAnalysis: js.UndefOr[SchemaGoogleCloudDialogflowV2beta1SentimentAnalysisResult] = js.undefined
}
object SchemaGoogleCloudDialogflowV2beta1Message {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1Message = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1Message]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1Message](x: Self) {
    ...
    inline def setMessageAnnotation(value: SchemaGoogleCloudDialogflowV2beta1MessageAnnotation): Self = StObject.set(x, "messageAnnotation", value.asInstanceOf[js.Any])
    ...
    inline def setSentimentAnalysis(value: SchemaGoogleCloudDialogflowV2beta1SentimentAnalysisResult): Self = StObject.set(x, "sentimentAnalysis", value.asInstanceOf[js.Any])
