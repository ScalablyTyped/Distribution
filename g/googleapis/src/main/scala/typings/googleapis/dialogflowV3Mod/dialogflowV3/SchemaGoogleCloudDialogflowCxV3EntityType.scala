...
trait SchemaGoogleCloudDialogflowCxV3EntityType extends StObject {
  ...
  /**
    ...
    */
  var excludedPhrases: js.UndefOr[js.Array[SchemaGoogleCloudDialogflowCxV3EntityTypeExcludedPhrase]] = js.undefined
...
object SchemaGoogleCloudDialogflowCxV3EntityType {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3EntityType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3EntityType]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3EntityType](x: Self) {
    ...
    inline def setExcludedPhrases(value: js.Array[SchemaGoogleCloudDialogflowCxV3EntityTypeExcludedPhrase]): Self = StObject.set(x, "excludedPhrases", value.asInstanceOf[js.Any])
    
    inline def setExcludedPhrasesUndefined: Self = StObject.set(x, "excludedPhrases", js.undefined)
    
    inline def setExcludedPhrasesVarargs(value: SchemaGoogleCloudDialogflowCxV3EntityTypeExcludedPhrase*): Self = StObject.set(x, "excludedPhrases", js.Array(value*))
