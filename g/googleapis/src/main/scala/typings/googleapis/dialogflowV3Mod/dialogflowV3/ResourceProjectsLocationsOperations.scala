...
@JSImport("googleapis/build/src/apis/dialogflow/v3", "dialogflow_v3.Resource$Projects$Locations$Operations")
@js.native
open class ResourceProjectsLocationsOperations protected () extends StObject {
  ...
  def cancel(params: ParamsResourceProjectsLocationsOperationsCancel): GaxiosPromise[SchemaGoogleProtobufEmpty] = js.native
  def cancel(
  ...
  def cancel(params: ParamsResourceProjectsLocationsOperationsCancel, options: MethodOptions): GaxiosPromise[SchemaGoogleProtobufEmpty] = js.native
  def cancel(
    params: ParamsResourceProjectsLocationsOperationsCancel,
