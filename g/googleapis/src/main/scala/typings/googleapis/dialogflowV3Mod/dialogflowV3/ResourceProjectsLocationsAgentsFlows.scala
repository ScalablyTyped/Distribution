...
@JSImport("googleapis/build/src/apis/dialogflow/v3", "dialogflow_v3.Resource$Projects$Locations$Agents$Flows")
@js.native
open class ResourceProjectsLocationsAgentsFlows protected () extends StObject {
  ...
  def create(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def create(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3Flow]): Unit = js.native
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def create(params: ParamsResourceProjectsLocationsAgentsFlowsCreate): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsFlowsCreate,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3Flow]
  ): Unit = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsFlowsCreate,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3Flow],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3Flow]
  ): Unit = js.native
  def create(params: ParamsResourceProjectsLocationsAgentsFlowsCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def create(
    params: ParamsResourceProjectsLocationsAgentsFlowsCreate,
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3Flow]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def get(params: ParamsResourceProjectsLocationsAgentsFlowsGet): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsAgentsFlowsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def get(
    params: ParamsResourceProjectsLocationsAgentsFlowsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3Flow]
  ...
  def getValidationResult(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3FlowValidationResult] = js.native
  def getValidationResult(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3FlowValidationResult]): Unit = js.native
  def getValidationResult(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3FlowValidationResult] = js.native
  def getValidationResult(params: ParamsResourceProjectsLocationsAgentsFlowsGetvalidationresult): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3FlowValidationResult] = js.native
  def getValidationResult(
    params: ParamsResourceProjectsLocationsAgentsFlowsGetvalidationresult,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3FlowValidationResult]
  ): Unit = js.native
  def getValidationResult(
    params: ParamsResourceProjectsLocationsAgentsFlowsGetvalidationresult,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3FlowValidationResult],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3FlowValidationResult]
  ): Unit = js.native
  def getValidationResult(params: ParamsResourceProjectsLocationsAgentsFlowsGetvalidationresult, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3FlowValidationResult] = js.native
  def getValidationResult(
    params: ParamsResourceProjectsLocationsAgentsFlowsGetvalidationresult,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3FlowValidationResult]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3ListFlowsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3ListFlowsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3ListFlowsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsFlowsList): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3ListFlowsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsFlowsList,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3ListFlowsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsFlowsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3ListFlowsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudDialogflowCxV3ListFlowsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsAgentsFlowsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3ListFlowsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsAgentsFlowsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3ListFlowsResponse]
  ...
  def patch(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3Flow]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def patch(params: ParamsResourceProjectsLocationsAgentsFlowsPatch): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsAgentsFlowsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3Flow] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsAgentsFlowsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3Flow]
  ...
  def validate(): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3FlowValidationResult] = js.native
  def validate(callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3FlowValidationResult]): Unit = js.native
  def validate(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3FlowValidationResult] = js.native
  def validate(params: ParamsResourceProjectsLocationsAgentsFlowsValidate): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3FlowValidationResult] = js.native
  def validate(
  ...
  def validate(params: ParamsResourceProjectsLocationsAgentsFlowsValidate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDialogflowCxV3FlowValidationResult] = js.native
  def validate(
    params: ParamsResourceProjectsLocationsAgentsFlowsValidate,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDialogflowCxV3FlowValidationResult]
