...
trait SchemaGoogleCloudDialogflowCxV3Webhook extends StObject {
  ...
  /**
    ...
    */
  var serviceDirectory: js.UndefOr[SchemaGoogleCloudDialogflowCxV3WebhookServiceDirectoryConfig] = js.undefined
...
object SchemaGoogleCloudDialogflowCxV3Webhook {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3Webhook = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3Webhook]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3Webhook](x: Self) {
    ...
    inline def setServiceDirectory(value: SchemaGoogleCloudDialogflowCxV3WebhookServiceDirectoryConfig): Self = StObject.set(x, "serviceDirectory", value.asInstanceOf[js.Any])
