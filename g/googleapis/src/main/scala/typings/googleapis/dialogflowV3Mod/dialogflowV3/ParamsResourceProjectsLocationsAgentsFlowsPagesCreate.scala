...
trait ParamsResourceProjectsLocationsAgentsFlowsPagesCreate
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3Page] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsFlowsPagesCreate {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsFlowsPagesCreate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3Page): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
