...
trait SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageOutputAudioText extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageOutputAudioText {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageOutputAudioText = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageOutputAudioText]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3beta1ResponseMessageOutputAudioText](x: Self) {
