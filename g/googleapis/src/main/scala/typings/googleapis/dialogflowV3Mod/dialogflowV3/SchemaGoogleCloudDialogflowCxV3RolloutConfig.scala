...
trait SchemaGoogleCloudDialogflowCxV3RolloutConfig extends StObject {
  ...
  /**
    ...
    */
  var rolloutSteps: js.UndefOr[js.Array[SchemaGoogleCloudDialogflowCxV3RolloutConfigRolloutStep]] = js.undefined
}
object SchemaGoogleCloudDialogflowCxV3RolloutConfig {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3RolloutConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3RolloutConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3RolloutConfig](x: Self) {
    ...
    inline def setRolloutSteps(value: js.Array[SchemaGoogleCloudDialogflowCxV3RolloutConfigRolloutStep]): Self = StObject.set(x, "rolloutSteps", value.asInstanceOf[js.Any])
    
    inline def setRolloutStepsUndefined: Self = StObject.set(x, "rolloutSteps", js.undefined)
    
    inline def setRolloutStepsVarargs(value: SchemaGoogleCloudDialogflowCxV3RolloutConfigRolloutStep*): Self = StObject.set(x, "rolloutSteps", js.Array(value*))
  }
}
