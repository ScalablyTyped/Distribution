...
trait SchemaGoogleCloudDialogflowCxV3SentimentAnalysisResult extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3SentimentAnalysisResult {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3SentimentAnalysisResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3SentimentAnalysisResult]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3SentimentAnalysisResult](x: Self) {
