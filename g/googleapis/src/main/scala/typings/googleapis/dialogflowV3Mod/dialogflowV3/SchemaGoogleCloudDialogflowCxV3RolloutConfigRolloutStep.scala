...
trait SchemaGoogleCloudDialogflowCxV3RolloutConfigRolloutStep extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3RolloutConfigRolloutStep {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3RolloutConfigRolloutStep = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3RolloutConfigRolloutStep]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3RolloutConfigRolloutStep](x: Self) {
