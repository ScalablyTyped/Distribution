...
trait SchemaGoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponse extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponse {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3LookupEnvironmentHistoryResponse](x: Self) {
