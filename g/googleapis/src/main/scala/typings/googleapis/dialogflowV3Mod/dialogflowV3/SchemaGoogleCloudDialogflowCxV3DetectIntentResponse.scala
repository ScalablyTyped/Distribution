...
trait SchemaGoogleCloudDialogflowCxV3DetectIntentResponse extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3DetectIntentResponse {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3DetectIntentResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3DetectIntentResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3DetectIntentResponse](x: Self) {
