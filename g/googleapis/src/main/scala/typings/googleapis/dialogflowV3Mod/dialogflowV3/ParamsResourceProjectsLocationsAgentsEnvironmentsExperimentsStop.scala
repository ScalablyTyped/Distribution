...
trait ParamsResourceProjectsLocationsAgentsEnvironmentsExperimentsStop
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3StopExperimentRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsEnvironmentsExperimentsStop {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsEnvironmentsExperimentsStop](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3StopExperimentRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
