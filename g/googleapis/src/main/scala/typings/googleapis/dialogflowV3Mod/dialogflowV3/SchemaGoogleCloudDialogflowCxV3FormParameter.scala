...
trait SchemaGoogleCloudDialogflowCxV3FormParameter extends StObject {
  ...
  /**
    ...
    */
  var fillBehavior: js.UndefOr[SchemaGoogleCloudDialogflowCxV3FormParameterFillBehavior] = js.undefined
...
object SchemaGoogleCloudDialogflowCxV3FormParameter {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3FormParameter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3FormParameter]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3FormParameter](x: Self) {
    ...
    inline def setFillBehavior(value: SchemaGoogleCloudDialogflowCxV3FormParameterFillBehavior): Self = StObject.set(x, "fillBehavior", value.asInstanceOf[js.Any])
