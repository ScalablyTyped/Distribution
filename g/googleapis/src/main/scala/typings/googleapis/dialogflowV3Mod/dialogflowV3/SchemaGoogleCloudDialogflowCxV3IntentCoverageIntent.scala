...
trait SchemaGoogleCloudDialogflowCxV3IntentCoverageIntent extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3IntentCoverageIntent {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3IntentCoverageIntent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3IntentCoverageIntent]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3IntentCoverageIntent](x: Self) {
