...
trait SchemaGoogleCloudDialogflowCxV3ExperimentDefinition extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3ExperimentDefinition {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3ExperimentDefinition = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3ExperimentDefinition]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3ExperimentDefinition](x: Self) {
