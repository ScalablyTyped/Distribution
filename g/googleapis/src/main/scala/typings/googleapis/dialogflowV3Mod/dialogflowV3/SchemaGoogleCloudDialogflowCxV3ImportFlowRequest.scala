...
trait SchemaGoogleCloudDialogflowCxV3ImportFlowRequest extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3ImportFlowRequest {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3ImportFlowRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3ImportFlowRequest]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3ImportFlowRequest](x: Self) {
