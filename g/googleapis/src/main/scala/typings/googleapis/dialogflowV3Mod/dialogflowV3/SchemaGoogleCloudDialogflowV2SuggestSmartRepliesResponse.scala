...
trait SchemaGoogleCloudDialogflowV2SuggestSmartRepliesResponse extends StObject {
  ...
  /**
    ...
    */
  var smartReplyAnswers: js.UndefOr[js.Array[SchemaGoogleCloudDialogflowV2SmartReplyAnswer]] = js.undefined
}
object SchemaGoogleCloudDialogflowV2SuggestSmartRepliesResponse {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2SuggestSmartRepliesResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2SuggestSmartRepliesResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2SuggestSmartRepliesResponse](x: Self) {
    ...
    inline def setSmartReplyAnswers(value: js.Array[SchemaGoogleCloudDialogflowV2SmartReplyAnswer]): Self = StObject.set(x, "smartReplyAnswers", value.asInstanceOf[js.Any])
    
    inline def setSmartReplyAnswersUndefined: Self = StObject.set(x, "smartReplyAnswers", js.undefined)
    
    inline def setSmartReplyAnswersVarargs(value: SchemaGoogleCloudDialogflowV2SmartReplyAnswer*): Self = StObject.set(x, "smartReplyAnswers", js.Array(value*))
  }
}
