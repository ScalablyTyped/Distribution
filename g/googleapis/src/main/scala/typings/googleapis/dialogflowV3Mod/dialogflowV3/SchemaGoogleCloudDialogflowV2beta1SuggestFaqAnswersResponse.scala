...
trait SchemaGoogleCloudDialogflowV2beta1SuggestFaqAnswersResponse extends StObject {
  ...
  /**
    ...
    */
  var faqAnswers: js.UndefOr[js.Array[SchemaGoogleCloudDialogflowV2beta1FaqAnswer]] = js.undefined
...
object SchemaGoogleCloudDialogflowV2beta1SuggestFaqAnswersResponse {
  
  inline def apply(): SchemaGoogleCloudDialogflowV2beta1SuggestFaqAnswersResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowV2beta1SuggestFaqAnswersResponse]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowV2beta1SuggestFaqAnswersResponse](x: Self) {
    ...
    inline def setFaqAnswers(value: js.Array[SchemaGoogleCloudDialogflowV2beta1FaqAnswer]): Self = StObject.set(x, "faqAnswers", value.asInstanceOf[js.Any])
    
    inline def setFaqAnswersUndefined: Self = StObject.set(x, "faqAnswers", js.undefined)
    
    inline def setFaqAnswersVarargs(value: SchemaGoogleCloudDialogflowV2beta1FaqAnswer*): Self = StObject.set(x, "faqAnswers", js.Array(value*))
