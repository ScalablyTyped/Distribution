...
trait SchemaGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverageTransition](x: Self) {
