...
trait SchemaGoogleCloudDialogflowCxV3EnvironmentTestCasesConfig extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3EnvironmentTestCasesConfig {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3EnvironmentTestCasesConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3EnvironmentTestCasesConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3EnvironmentTestCasesConfig](x: Self) {
