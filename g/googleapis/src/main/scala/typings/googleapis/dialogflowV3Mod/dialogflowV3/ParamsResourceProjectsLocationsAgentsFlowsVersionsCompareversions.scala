...
trait ParamsResourceProjectsLocationsAgentsFlowsVersionsCompareversions
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDialogflowCxV3CompareVersionsRequest] = js.undefined
}
object ParamsResourceProjectsLocationsAgentsFlowsVersionsCompareversions {
  ...
  extension [Self <: ParamsResourceProjectsLocationsAgentsFlowsVersionsCompareversions](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDialogflowCxV3CompareVersionsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
