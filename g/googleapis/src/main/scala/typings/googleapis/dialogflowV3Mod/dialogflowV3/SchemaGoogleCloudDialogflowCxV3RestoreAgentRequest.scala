...
trait SchemaGoogleCloudDialogflowCxV3RestoreAgentRequest extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3RestoreAgentRequest {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3RestoreAgentRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3RestoreAgentRequest]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3RestoreAgentRequest](x: Self) {
