...
trait SchemaGoogleCloudDialogflowCxV3RolloutState extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3RolloutState {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3RolloutState = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3RolloutState]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3RolloutState](x: Self) {
