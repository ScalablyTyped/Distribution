...
trait SchemaGoogleCloudDialogflowCxV3SynthesizeSpeechConfig extends StObject {
  ...
  /**
    ...
    */
  var voice: js.UndefOr[SchemaGoogleCloudDialogflowCxV3VoiceSelectionParams] = js.undefined
...
object SchemaGoogleCloudDialogflowCxV3SynthesizeSpeechConfig {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3SynthesizeSpeechConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3SynthesizeSpeechConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3SynthesizeSpeechConfig](x: Self) {
    ...
    inline def setVoice(value: SchemaGoogleCloudDialogflowCxV3VoiceSelectionParams): Self = StObject.set(x, "voice", value.asInstanceOf[js.Any])
