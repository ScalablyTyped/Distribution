...
trait ParamsResourceProjectsLocationsAgentsEntitytypesList
  extends StObject
...
object ParamsResourceProjectsLocationsAgentsEntitytypesList {
  
  inline def apply(): ParamsResourceProjectsLocationsAgentsEntitytypesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsAgentsEntitytypesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsAgentsEntitytypesList](x: Self) {
