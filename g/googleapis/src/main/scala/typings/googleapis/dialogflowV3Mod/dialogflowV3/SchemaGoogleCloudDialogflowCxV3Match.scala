...
trait SchemaGoogleCloudDialogflowCxV3Match extends StObject {
...
object SchemaGoogleCloudDialogflowCxV3Match {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3Match = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3Match]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3Match](x: Self) {
