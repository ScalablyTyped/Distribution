...
trait SchemaGoogleCloudDialogflowCxV3OutputAudioConfig extends StObject {
  ...
  /**
    ...
    */
  var synthesizeSpeechConfig: js.UndefOr[SchemaGoogleCloudDialogflowCxV3SynthesizeSpeechConfig] = js.undefined
}
object SchemaGoogleCloudDialogflowCxV3OutputAudioConfig {
  
  inline def apply(): SchemaGoogleCloudDialogflowCxV3OutputAudioConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDialogflowCxV3OutputAudioConfig]
  }
  
  extension [Self <: SchemaGoogleCloudDialogflowCxV3OutputAudioConfig](x: Self) {
    ...
    inline def setSynthesizeSpeechConfig(value: SchemaGoogleCloudDialogflowCxV3SynthesizeSpeechConfig): Self = StObject.set(x, "synthesizeSpeechConfig", value.asInstanceOf[js.Any])
