...
@JSImport("googleapis/build/src/apis/eventarc/v1beta1", "eventarc_v1beta1.Resource$Projects$Locations$Triggers")
@js.native
open class ResourceProjectsLocationsTriggers protected () extends StObject {
  ...
  def create(params: ParamsResourceProjectsLocationsTriggersCreate): GaxiosPromise[SchemaOperation] = js.native
  def create(
  ...
  def create(params: ParamsResourceProjectsLocationsTriggersCreate, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def create(
    params: ParamsResourceProjectsLocationsTriggersCreate,
  ...
  def delete(params: ParamsResourceProjectsLocationsTriggersDelete): GaxiosPromise[SchemaOperation] = js.native
  def delete(
  ...
  def delete(params: ParamsResourceProjectsLocationsTriggersDelete, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def delete(
    params: ParamsResourceProjectsLocationsTriggersDelete,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
  ...
  def patch(params: ParamsResourceProjectsLocationsTriggersPatch): GaxiosPromise[SchemaOperation] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsTriggersPatch, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsTriggersPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
