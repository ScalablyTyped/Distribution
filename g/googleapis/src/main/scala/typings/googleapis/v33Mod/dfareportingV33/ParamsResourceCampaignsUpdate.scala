...
object ParamsResourceCampaignsUpdate {
  ...
  @scala.inline
  implicit class ParamsResourceCampaignsUpdateOps[Self <: ParamsResourceCampaignsUpdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCampaign): Self = this.set("requestBody", value.asInstanceOf[js.Any])
