...
object ParamsResourceReportsInsert {
  ...
  @scala.inline
  def apply(): ParamsResourceReportsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceReportsInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceReportsInsertMutableBuilder[Self <: ParamsResourceReportsInsert] (val x: Self) extends AnyVal {
