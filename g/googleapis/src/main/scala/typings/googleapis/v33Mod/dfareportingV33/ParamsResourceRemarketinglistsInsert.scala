...
trait ParamsResourceRemarketinglistsInsert
  extends StObject
...
object ParamsResourceRemarketinglistsInsert {
  ...
  inline def apply(): ParamsResourceRemarketinglistsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceRemarketinglistsInsert]
  }
  
  extension [Self <: ParamsResourceRemarketinglistsInsert](x: Self) {
