...
trait SchemaDayPartTargeting extends StObject {
  ...
  /**
    ...
    */
  var daysOfWeek: js.UndefOr[js.Array[String] | Null] = js.undefined
  
  /**
    * Hours of the day when the ad will serve, where 0 is midnight to 1 AM and 23 is 11 PM to midnight. Can be specified with days of week, in which case the ad would serve during these hours on the specified days. For example if Monday, Wednesday, Friday are the days of week specified and 9-10am, 3-5pm (hours 9, 15, and 16) is specified, the ad would serve Monday, Wednesdays, and Fridays at 9-10am and 3-5pm. Acceptable values are 0 to 23, inclusive.
    */
  var hoursOfDay: js.UndefOr[js.Array[Double] | Null] = js.undefined
  
  /**
    * Whether or not to use the user's local time. If false, the America/New York time zone applies.
    */
  var userLocalTime: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaDayPartTargeting {
  ...
  extension [Self <: SchemaDayPartTargeting](x: Self) {
    ...
    inline def setHoursOfDayNull: Self = StObject.set(x, "hoursOfDay", null)
    ...
    inline def setUserLocalTimeNull: Self = StObject.set(x, "userLocalTime", null)
