...
trait ParamsResourceProjectsLocationsGlobalDomainsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsGlobalDomainsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsGlobalDomainsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGlobalDomainsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGlobalDomainsGetiampolicy](x: Self) {
