...
trait SchemaGoogleCloudManagedidentitiesV1beta1OpMetadata extends StObject {
...
object SchemaGoogleCloudManagedidentitiesV1beta1OpMetadata {
  
  inline def apply(): SchemaGoogleCloudManagedidentitiesV1beta1OpMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudManagedidentitiesV1beta1OpMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudManagedidentitiesV1beta1OpMetadata](x: Self) {
