...
trait ParamsResourceProjectsLocationsGlobalDomainsBackupsList
  extends StObject
...
object ParamsResourceProjectsLocationsGlobalDomainsBackupsList {
  
  inline def apply(): ParamsResourceProjectsLocationsGlobalDomainsBackupsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGlobalDomainsBackupsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGlobalDomainsBackupsList](x: Self) {
