...
trait SchemaGoogleCloudManagedidentitiesV1OpMetadata extends StObject {
...
object SchemaGoogleCloudManagedidentitiesV1OpMetadata {
  
  inline def apply(): SchemaGoogleCloudManagedidentitiesV1OpMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudManagedidentitiesV1OpMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudManagedidentitiesV1OpMetadata](x: Self) {
