...
object ParamsResourceSpreadsheetsValuesBatchupdate {
  ...
  @scala.inline
  implicit class ParamsResourceSpreadsheetsValuesBatchupdateOps[Self <: ParamsResourceSpreadsheetsValuesBatchupdate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchUpdateValuesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
