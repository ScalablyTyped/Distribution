...
object SchemaBatchUpdateValuesRequest {
  ...
  inline def apply(): SchemaBatchUpdateValuesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBatchUpdateValuesRequest]
  }
  
  extension [Self <: SchemaBatchUpdateValuesRequest](x: Self) {
    
    inline def setData(value: js.Array[SchemaValueRange]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    inline def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    inline def setDataVarargs(value: SchemaValueRange*): Self = StObject.set(x, "data", js.Array(value :_*))
