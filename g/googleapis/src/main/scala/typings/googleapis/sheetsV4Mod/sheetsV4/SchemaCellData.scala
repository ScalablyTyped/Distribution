...
trait SchemaCellData extends StObject {
  ...
  /**
    ...
    */
  var dataSourceFormula: js.UndefOr[SchemaDataSourceFormula] = js.undefined
  ...
  /**
    ...
    */
  var dataSourceTable: js.UndefOr[SchemaDataSourceTable] = js.undefined
  ...
  /**
    ...
    */
  var hyperlink: js.UndefOr[String | Null] = js.undefined
...
object SchemaCellData {
  ...
  extension [Self <: SchemaCellData](x: Self) {
    ...
    inline def setDataSourceFormula(value: SchemaDataSourceFormula): Self = StObject.set(x, "dataSourceFormula", value.asInstanceOf[js.Any])
    
    inline def setDataSourceFormulaUndefined: Self = StObject.set(x, "dataSourceFormula", js.undefined)
    
    inline def setDataSourceTable(value: SchemaDataSourceTable): Self = StObject.set(x, "dataSourceTable", value.asInstanceOf[js.Any])
    ...
    inline def setHyperlinkNull: Self = StObject.set(x, "hyperlink", null)
    ...
    inline def setTextFormatRunsVarargs(value: SchemaTextFormatRun*): Self = StObject.set(x, "textFormatRuns", js.Array(value*))
