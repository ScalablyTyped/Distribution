...
trait SchemaBubbleChartSpec extends StObject {
  ...
  /**
    ...
    */
  var bubbleBorderColorStyle: js.UndefOr[SchemaColorStyle] = js.undefined
  ...
  /**
    ...
    */
  var bubbleMaxRadiusSize: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * The minimum radius size of the bubbles, in pixels. If specific, the field must be a positive value.
    */
  var bubbleMinRadiusSize: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * The opacity of the bubbles between 0 and 1.0. 0 is fully transparent and 1 is fully opaque.
    */
  var bubbleOpacity: js.UndefOr[Double | Null] = js.undefined
...
object SchemaBubbleChartSpec {
  ...
  extension [Self <: SchemaBubbleChartSpec](x: Self) {
    ...
    inline def setBubbleBorderColorStyle(value: SchemaColorStyle): Self = StObject.set(x, "bubbleBorderColorStyle", value.asInstanceOf[js.Any])
    ...
    inline def setBubbleMaxRadiusSizeNull: Self = StObject.set(x, "bubbleMaxRadiusSize", null)
    ...
    inline def setBubbleMinRadiusSizeNull: Self = StObject.set(x, "bubbleMinRadiusSize", null)
    ...
    inline def setBubbleOpacityNull: Self = StObject.set(x, "bubbleOpacity", null)
