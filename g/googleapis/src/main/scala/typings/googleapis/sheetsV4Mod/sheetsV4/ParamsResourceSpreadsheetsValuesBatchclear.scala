...
object ParamsResourceSpreadsheetsValuesBatchclear {
  ...
  @scala.inline
  implicit class ParamsResourceSpreadsheetsValuesBatchclearOps[Self <: ParamsResourceSpreadsheetsValuesBatchclear] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchClearValuesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
