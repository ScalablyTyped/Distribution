...
object ParamsResourceSpreadsheetsDevelopermetadataGet {
  ...
  @scala.inline
  implicit class ParamsResourceSpreadsheetsDevelopermetadataGetMutableBuilder[Self <: ParamsResourceSpreadsheetsDevelopermetadataGet] (val x: Self) extends AnyVal {
