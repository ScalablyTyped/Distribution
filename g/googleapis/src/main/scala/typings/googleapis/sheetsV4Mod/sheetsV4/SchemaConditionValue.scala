...
trait SchemaConditionValue extends StObject {
  ...
  /**
    ...
    */
  var relativeDate: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var userEnteredValue: js.UndefOr[String | Null] = js.undefined
}
object SchemaConditionValue {
  ...
  extension [Self <: SchemaConditionValue](x: Self) {
    ...
    inline def setRelativeDateNull: Self = StObject.set(x, "relativeDate", null)
    ...
    inline def setUserEnteredValueNull: Self = StObject.set(x, "userEnteredValue", null)
