...
trait SchemaSheetProperties extends StObject {
  ...
  /**
    ...
    */
  var dataSourceSheetProperties: js.UndefOr[SchemaDataSourceSheetProperties] = js.undefined
  ...
  /**
    ...
    */
  var rightToLeft: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var sheetType: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var tabColorStyle: js.UndefOr[SchemaColorStyle] = js.undefined
...
object SchemaSheetProperties {
  ...
  inline def apply(): SchemaSheetProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSheetProperties]
  }
  
  extension [Self <: SchemaSheetProperties](x: Self) {
    
    inline def setDataSourceSheetProperties(value: SchemaDataSourceSheetProperties): Self = StObject.set(x, "dataSourceSheetProperties", value.asInstanceOf[js.Any])
    
    inline def setDataSourceSheetPropertiesUndefined: Self = StObject.set(x, "dataSourceSheetProperties", js.undefined)
    
    inline def setGridProperties(value: SchemaGridProperties): Self = StObject.set(x, "gridProperties", value.asInstanceOf[js.Any])
    ...
    inline def setRightToLeftNull: Self = StObject.set(x, "rightToLeft", null)
    ...
    inline def setSheetTypeNull: Self = StObject.set(x, "sheetType", null)
    
    inline def setSheetTypeUndefined: Self = StObject.set(x, "sheetType", js.undefined)
    
    inline def setTabColor(value: SchemaColor): Self = StObject.set(x, "tabColor", value.asInstanceOf[js.Any])
    
    inline def setTabColorStyle(value: SchemaColorStyle): Self = StObject.set(x, "tabColorStyle", value.asInstanceOf[js.Any])
