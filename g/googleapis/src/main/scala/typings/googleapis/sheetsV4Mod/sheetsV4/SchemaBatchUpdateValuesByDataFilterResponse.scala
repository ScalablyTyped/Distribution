...
object SchemaBatchUpdateValuesByDataFilterResponse {
  ...
  inline def apply(): SchemaBatchUpdateValuesByDataFilterResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBatchUpdateValuesByDataFilterResponse]
  }
  
  extension [Self <: SchemaBatchUpdateValuesByDataFilterResponse](x: Self) {
    
    inline def setResponses(value: js.Array[SchemaUpdateValuesByDataFilterResponse]): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
    
    inline def setResponsesUndefined: Self = StObject.set(x, "responses", js.undefined)
    
    inline def setResponsesVarargs(value: SchemaUpdateValuesByDataFilterResponse*): Self = StObject.set(x, "responses", js.Array(value :_*))
