...
trait SchemaPivotGroup extends StObject {
  ...
  /**
    ...
    */
  var groupLimit: js.UndefOr[SchemaPivotGroupLimit] = js.undefined
  
  /**
    * The group rule to apply to this row/column group.
    */
  var groupRule: js.UndefOr[SchemaPivotGroupRule] = js.undefined
  ...
  /**
    ...
    */
  var repeatHeadings: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * True if the pivot table should include the totals for this grouping.
    */
  var showTotals: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var valueBucket: js.UndefOr[SchemaPivotGroupSortValueBucket] = js.undefined
  
  /**
    * Metadata about values in the grouping.
    */
  var valueMetadata: js.UndefOr[js.Array[SchemaPivotGroupValueMetadata]] = js.undefined
}
object SchemaPivotGroup {
  ...
  extension [Self <: SchemaPivotGroup](x: Self) {
    ...
    inline def setGroupLimit(value: SchemaPivotGroupLimit): Self = StObject.set(x, "groupLimit", value.asInstanceOf[js.Any])
    ...
    inline def setRepeatHeadingsNull: Self = StObject.set(x, "repeatHeadings", null)
    ...
    inline def setShowTotalsNull: Self = StObject.set(x, "showTotals", null)
    ...
    inline def setValueMetadataVarargs(value: SchemaPivotGroupValueMetadata*): Self = StObject.set(x, "valueMetadata", js.Array(value*))
  }
}
