...
trait SchemaUpdateEmbeddedObjectBorderRequest extends StObject {
...
object SchemaUpdateEmbeddedObjectBorderRequest {
  
  inline def apply(): SchemaUpdateEmbeddedObjectBorderRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaUpdateEmbeddedObjectBorderRequest]
  }
  
  extension [Self <: SchemaUpdateEmbeddedObjectBorderRequest](x: Self) {
