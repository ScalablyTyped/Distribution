...
object SchemaBasicChartSpec {
  ...
  extension [Self <: SchemaBasicChartSpec](x: Self) {
    ...
    inline def setAxisVarargs(value: SchemaBasicChartAxis*): Self = StObject.set(x, "axis", js.Array(value :_*))
    ...
    inline def setDomainsVarargs(value: SchemaBasicChartDomain*): Self = StObject.set(x, "domains", js.Array(value :_*))
    ...
    inline def setSeriesVarargs(value: SchemaBasicChartSeries*): Self = StObject.set(x, "series", js.Array(value :_*))
