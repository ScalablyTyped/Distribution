...
@js.native
trait ParamsDollarResourceDollarSslpoliciesDollarPatch extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$SslPolicy] = js.native
  /**
...
object ParamsDollarResourceDollarSslpoliciesDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$SslPolicy = null,
    requestId: String = null,
    sslPolicy: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarSslpoliciesDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSslpoliciesDollarPatch]
  }
}
