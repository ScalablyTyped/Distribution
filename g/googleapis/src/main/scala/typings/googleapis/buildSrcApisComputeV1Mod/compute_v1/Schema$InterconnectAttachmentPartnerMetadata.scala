...
/**
  ...
  */
@js.native
trait Schema$InterconnectAttachmentPartnerMetadata extends js.Object {
  /**
...
object Schema$InterconnectAttachmentPartnerMetadata {
  @scala.inline
  def apply(interconnectName: String = null, partnerName: String = null, portalUrl: String = null): Schema$InterconnectAttachmentPartnerMetadata = {
    ...
    __obj.asInstanceOf[Schema$InterconnectAttachmentPartnerMetadata]
  }
}
