...
@js.native
trait ParamsDollarResourceDollarInstancesDollarInsert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInstancesDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$Instance = null,
    requestId: String = null,
    sourceInstanceTemplate: String = null,
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarInstancesDollarInsert = {
    ...
    if (sourceInstanceTemplate != null) __obj.updateDynamic("sourceInstanceTemplate")(sourceInstanceTemplate.asInstanceOf[js.Any])
    if (userIp != null) __obj.updateDynamic("userIp")(userIp.asInstanceOf[js.Any])
    if (zone != null) __obj.updateDynamic("zone")(zone.asInstanceOf[js.Any])
    __obj.asInstanceOf[ParamsDollarResourceDollarInstancesDollarInsert]
  }
}
