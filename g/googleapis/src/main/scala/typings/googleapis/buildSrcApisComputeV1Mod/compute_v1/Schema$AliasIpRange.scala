...
/**
  ...
  */
@js.native
trait Schema$AliasIpRange extends js.Object {
  /**
...
object Schema$AliasIpRange {
  @scala.inline
  def apply(ipCidrRange: String = null, subnetworkRangeName: String = null): Schema$AliasIpRange = {
    ...
    __obj.asInstanceOf[Schema$AliasIpRange]
  }
}
