...
@js.native
trait ParamsDollarResourceDollarInstancetemplatesDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInstancetemplatesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarInstancetemplatesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInstancetemplatesDollarDelete]
  }
}
