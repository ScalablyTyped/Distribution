...
@js.native
trait ParamsDollarResourceDollarRegioninstancegroupmanagersDollarResize extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRegioninstancegroupmanagersDollarResize {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarRegioninstancegroupmanagersDollarResize = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRegioninstancegroupmanagersDollarResize]
  }
}
