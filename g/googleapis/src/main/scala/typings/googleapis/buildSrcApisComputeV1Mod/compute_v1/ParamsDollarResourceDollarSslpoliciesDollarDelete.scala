...
@js.native
trait ParamsDollarResourceDollarSslpoliciesDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarSslpoliciesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarSslpoliciesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarSslpoliciesDollarDelete]
  }
}
