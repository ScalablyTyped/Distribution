...
@js.native
trait ParamsDollarResourceDollarVpntunnelsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarVpntunnelsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarVpntunnelsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarVpntunnelsDollarDelete]
  }
}
