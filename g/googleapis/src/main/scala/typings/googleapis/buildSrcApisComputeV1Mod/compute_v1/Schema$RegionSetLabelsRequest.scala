...
@js.native
trait Schema$RegionSetLabelsRequest extends js.Object {
  /**
...
object Schema$RegionSetLabelsRequest {
  @scala.inline
  def apply(labelFingerprint: String = null, labels: StringDictionary[String] = null): Schema$RegionSetLabelsRequest = {
    val __obj = js.Dynamic.literal()
    if (labelFingerprint != null) __obj.updateDynamic("labelFingerprint")(labelFingerprint.asInstanceOf[js.Any])
    if (labels != null) __obj.updateDynamic("labels")(labels.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$RegionSetLabelsRequest]
  }
}
