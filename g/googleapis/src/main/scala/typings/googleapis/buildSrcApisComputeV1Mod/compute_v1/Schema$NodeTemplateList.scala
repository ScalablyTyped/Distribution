...
/**
  ...
  */
@js.native
trait Schema$NodeTemplateList extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$NodeTemplate]] = js.native
  /**
...
object Schema$NodeTemplateList {
  @scala.inline
  def apply(
    id: String = null,
    items: js.Array[Schema$NodeTemplate] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$NodeTemplateList]
  }
}
