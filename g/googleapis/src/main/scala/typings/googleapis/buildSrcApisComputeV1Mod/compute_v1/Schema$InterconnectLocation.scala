...
/**
  ...
  */
@js.native
trait Schema$InterconnectLocation extends js.Object {
  /**
  ...
  /**
    ...
    */
  var regionInfos: js.UndefOr[js.Array[Schema$InterconnectLocationRegionInfo]] = js.native
  /**
...
object Schema$InterconnectLocation {
  @scala.inline
  def apply(
    address: String = null,
    ...
    regionInfos: js.Array[Schema$InterconnectLocationRegionInfo] = null,
    ...
    __obj.asInstanceOf[Schema$InterconnectLocation]
  }
}
