...
@js.native
trait ParamsDollarResourceDollarDnskeysDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDnskeysDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDnskeysDollarGet = {
    ...
    if (dnsKeyId != null) __obj.updateDynamic("dnsKeyId")(dnsKeyId.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDnskeysDollarGet]
  }
}
