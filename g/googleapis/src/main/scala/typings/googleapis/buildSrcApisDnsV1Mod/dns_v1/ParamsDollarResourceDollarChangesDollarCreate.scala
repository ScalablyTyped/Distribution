...
@js.native
trait ParamsDollarResourceDollarChangesDollarCreate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$Change] = js.native
}

object ParamsDollarResourceDollarChangesDollarCreate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$Change = null,
    userIp: String = null
  ): ParamsDollarResourceDollarChangesDollarCreate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChangesDollarCreate]
  }
}
