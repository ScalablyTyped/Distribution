...
@js.native
trait ParamsDollarResourceDollarManagedzonesDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagedzonesDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarManagedzonesDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagedzonesDollarPatch]
  }
}
