...
@js.native
trait ParamsDollarResourceDollarChangesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarChangesDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarChangesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChangesDollarGet]
  }
}
