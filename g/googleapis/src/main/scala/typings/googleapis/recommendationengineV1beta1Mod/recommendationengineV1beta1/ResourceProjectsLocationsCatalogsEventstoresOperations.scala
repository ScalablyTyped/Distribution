...
@JSImport("googleapis/build/src/apis/recommendationengine/v1beta1", "recommendationengine_v1beta1.Resource$Projects$Locations$Catalogs$Eventstores$Operations")
@js.native
open class ResourceProjectsLocationsCatalogsEventstoresOperations protected () extends StObject {
  ...
  def get(params: ParamsResourceProjectsLocationsCatalogsEventstoresOperationsGet): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def get(
    params: ParamsResourceProjectsLocationsCatalogsEventstoresOperationsGet,
  ...
  def get(params: ParamsResourceProjectsLocationsCatalogsEventstoresOperationsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def get(
    params: ParamsResourceProjectsLocationsCatalogsEventstoresOperationsGet,
  ...
  def list(params: ParamsResourceProjectsLocationsCatalogsEventstoresOperationsList): GaxiosPromise[SchemaGoogleLongrunningListOperationsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsEventstoresOperationsList,
  ...
  def list(params: ParamsResourceProjectsLocationsCatalogsEventstoresOperationsList, options: MethodOptions): GaxiosPromise[SchemaGoogleLongrunningListOperationsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsEventstoresOperationsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleLongrunningListOperationsResponse]
