...
trait SchemaGoogleCloudRecommendationengineV1beta1UserEvent extends StObject {
  
  /**
    * Optional. User event detailed information common across different recommendation types.
    */
  var eventDetail: js.UndefOr[SchemaGoogleCloudRecommendationengineV1beta1EventDetail] = js.undefined
  ...
  /**
    ...
    */
  var eventSource: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var productEventDetail: js.UndefOr[SchemaGoogleCloudRecommendationengineV1beta1ProductEventDetail] = js.undefined
  
  /**
    * Required. User information.
    */
  var userInfo: js.UndefOr[SchemaGoogleCloudRecommendationengineV1beta1UserInfo] = js.undefined
}
object SchemaGoogleCloudRecommendationengineV1beta1UserEvent {
  
  inline def apply(): SchemaGoogleCloudRecommendationengineV1beta1UserEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommendationengineV1beta1UserEvent]
  }
  
  extension [Self <: SchemaGoogleCloudRecommendationengineV1beta1UserEvent](x: Self) {
    
    inline def setEventDetail(value: SchemaGoogleCloudRecommendationengineV1beta1EventDetail): Self = StObject.set(x, "eventDetail", value.asInstanceOf[js.Any])
    ...
    inline def setEventSourceNull: Self = StObject.set(x, "eventSource", null)
    ...
    inline def setProductEventDetail(value: SchemaGoogleCloudRecommendationengineV1beta1ProductEventDetail): Self = StObject.set(x, "productEventDetail", value.asInstanceOf[js.Any])
    
    inline def setProductEventDetailUndefined: Self = StObject.set(x, "productEventDetail", js.undefined)
    
    inline def setUserInfo(value: SchemaGoogleCloudRecommendationengineV1beta1UserInfo): Self = StObject.set(x, "userInfo", value.asInstanceOf[js.Any])
