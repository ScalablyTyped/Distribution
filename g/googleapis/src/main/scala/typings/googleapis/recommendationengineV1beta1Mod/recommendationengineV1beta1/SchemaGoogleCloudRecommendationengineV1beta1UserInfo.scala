...
trait SchemaGoogleCloudRecommendationengineV1beta1UserInfo extends StObject {
...
object SchemaGoogleCloudRecommendationengineV1beta1UserInfo {
  
  inline def apply(): SchemaGoogleCloudRecommendationengineV1beta1UserInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommendationengineV1beta1UserInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRecommendationengineV1beta1UserInfo](x: Self) {
