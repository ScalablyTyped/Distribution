...
trait SchemaGoogleCloudRecommendationengineV1beta1ProductEventDetail extends StObject {
  ...
  /**
    ...
    */
  var productDetails: js.UndefOr[js.Array[SchemaGoogleCloudRecommendationengineV1beta1ProductDetail]] = js.undefined
  ...
  /**
    ...
    */
  var purchaseTransaction: js.UndefOr[SchemaGoogleCloudRecommendationengineV1beta1PurchaseTransaction] = js.undefined
...
object SchemaGoogleCloudRecommendationengineV1beta1ProductEventDetail {
  
  inline def apply(): SchemaGoogleCloudRecommendationengineV1beta1ProductEventDetail = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRecommendationengineV1beta1ProductEventDetail]
  }
  
  extension [Self <: SchemaGoogleCloudRecommendationengineV1beta1ProductEventDetail](x: Self) {
    ...
    inline def setPageCategories(value: js.Array[SchemaGoogleCloudRecommendationengineV1beta1CatalogItemCategoryHierarchy]): Self = StObject.set(x, "pageCategories", value.asInstanceOf[js.Any])
    
    inline def setPageCategoriesUndefined: Self = StObject.set(x, "pageCategories", js.undefined)
    
    inline def setPageCategoriesVarargs(value: SchemaGoogleCloudRecommendationengineV1beta1CatalogItemCategoryHierarchy*): Self = StObject.set(x, "pageCategories", js.Array(value*))
    
    inline def setProductDetails(value: js.Array[SchemaGoogleCloudRecommendationengineV1beta1ProductDetail]): Self = StObject.set(x, "productDetails", value.asInstanceOf[js.Any])
    
    inline def setProductDetailsUndefined: Self = StObject.set(x, "productDetails", js.undefined)
    
    inline def setProductDetailsVarargs(value: SchemaGoogleCloudRecommendationengineV1beta1ProductDetail*): Self = StObject.set(x, "productDetails", js.Array(value*))
    
    inline def setPurchaseTransaction(value: SchemaGoogleCloudRecommendationengineV1beta1PurchaseTransaction): Self = StObject.set(x, "purchaseTransaction", value.asInstanceOf[js.Any])
