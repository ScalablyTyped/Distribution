...
trait ParamsResourceResourcesList
  extends StObject
...
object ParamsResourceResourcesList {
  
  inline def apply(): ParamsResourceResourcesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResourcesList]
  }
  
  extension [Self <: ParamsResourceResourcesList](x: Self) {
