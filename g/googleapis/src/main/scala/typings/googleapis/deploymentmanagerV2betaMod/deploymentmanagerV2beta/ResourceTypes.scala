...
@js.native
open class ResourceTypes protected () extends StObject {
  ...
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaTypesListResponse] = js.native
  ...
  def list(
    ...
    options: BodyResponseCallback[Readable | SchemaTypesListResponse],
    callback: BodyResponseCallback[Readable | SchemaTypesListResponse]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def list(params: ParamsResourceTypesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceTypesList,
