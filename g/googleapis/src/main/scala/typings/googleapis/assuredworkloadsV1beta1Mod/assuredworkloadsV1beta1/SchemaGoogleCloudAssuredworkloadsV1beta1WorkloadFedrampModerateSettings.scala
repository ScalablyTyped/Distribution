...
trait SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings extends StObject {
...
object SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings {
  
  inline def apply(): SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings]
  }
  
  extension [Self <: SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings](x: Self) {
