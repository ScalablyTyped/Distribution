...
trait SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings extends StObject {
...
object SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings {
  
  inline def apply(): SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings]
  }
  
  extension [Self <: SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings](x: Self) {
