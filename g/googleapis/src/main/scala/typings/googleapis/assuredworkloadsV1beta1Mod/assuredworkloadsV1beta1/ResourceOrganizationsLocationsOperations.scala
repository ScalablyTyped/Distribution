...
@JSImport("googleapis/build/src/apis/assuredworkloads/v1beta1", "assuredworkloads_v1beta1.Resource$Organizations$Locations$Operations")
@js.native
open class ResourceOrganizationsLocationsOperations protected () extends StObject {
  ...
  def get(params: ParamsResourceOrganizationsLocationsOperationsGet): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def get(
  ...
  def get(params: ParamsResourceOrganizationsLocationsOperationsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsOperationsGet,
  ...
  def list(params: ParamsResourceOrganizationsLocationsOperationsList): GaxiosPromise[SchemaGoogleLongrunningListOperationsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceOrganizationsLocationsOperationsList, options: MethodOptions): GaxiosPromise[SchemaGoogleLongrunningListOperationsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsOperationsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleLongrunningListOperationsResponse]
