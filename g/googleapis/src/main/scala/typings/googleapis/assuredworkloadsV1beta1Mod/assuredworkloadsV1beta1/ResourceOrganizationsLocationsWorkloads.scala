...
@JSImport("googleapis/build/src/apis/assuredworkloads/v1beta1", "assuredworkloads_v1beta1.Resource$Organizations$Locations$Workloads")
@js.native
open class ResourceOrganizationsLocationsWorkloads protected () extends StObject {
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1Workload] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudAssuredworkloadsV1beta1Workload]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1Workload] = js.native
  def get(params: ParamsResourceOrganizationsLocationsWorkloadsGet): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1Workload] = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsWorkloadsGet,
    callback: BodyResponseCallback[SchemaGoogleCloudAssuredworkloadsV1beta1Workload]
  ): Unit = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsWorkloadsGet,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudAssuredworkloadsV1beta1Workload],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudAssuredworkloadsV1beta1Workload]
  ): Unit = js.native
  def get(params: ParamsResourceOrganizationsLocationsWorkloadsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1Workload] = js.native
  def get(
    params: ParamsResourceOrganizationsLocationsWorkloadsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudAssuredworkloadsV1beta1Workload]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1ListWorkloadsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudAssuredworkloadsV1beta1ListWorkloadsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1ListWorkloadsResponse] = js.native
  def list(params: ParamsResourceOrganizationsLocationsWorkloadsList): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1ListWorkloadsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsWorkloadsList,
    callback: BodyResponseCallback[SchemaGoogleCloudAssuredworkloadsV1beta1ListWorkloadsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsWorkloadsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudAssuredworkloadsV1beta1ListWorkloadsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudAssuredworkloadsV1beta1ListWorkloadsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceOrganizationsLocationsWorkloadsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1ListWorkloadsResponse] = js.native
  def list(
    params: ParamsResourceOrganizationsLocationsWorkloadsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudAssuredworkloadsV1beta1ListWorkloadsResponse]
  ...
  def patch(): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1Workload] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleCloudAssuredworkloadsV1beta1Workload]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1Workload] = js.native
  def patch(params: ParamsResourceOrganizationsLocationsWorkloadsPatch): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1Workload] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceOrganizationsLocationsWorkloadsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudAssuredworkloadsV1beta1Workload] = js.native
  def patch(
    params: ParamsResourceOrganizationsLocationsWorkloadsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudAssuredworkloadsV1beta1Workload]
