...
@js.native
class Resource$Reporttypes protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$ListReportTypesResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListReportTypesResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarReporttypesDollarList): GaxiosPromise[Schema$ListReportTypesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarReporttypesDollarList,
    callback: BodyResponseCallback[Schema$ListReportTypesResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarReporttypesDollarList,
    options: BodyResponseCallback[Schema$ListReportTypesResponse],
    callback: BodyResponseCallback[Schema$ListReportTypesResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarReporttypesDollarList, options: MethodOptions): GaxiosPromise[Schema$ListReportTypesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarReporttypesDollarList,
