...
@JSImport("googleapis", "language_v1beta1")
@js.native
object language_v1beta1 extends js.Object {
  /**
  ...
  class Resource$Documents protected ()
    extends typings.googleapis.buildSrcApisLanguageV1beta1Mod.language_v1beta1.Resource$Documents {
