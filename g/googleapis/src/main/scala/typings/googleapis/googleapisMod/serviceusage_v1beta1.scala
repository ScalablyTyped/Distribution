...
object serviceusage_v1beta1 extends js.Object {
  ...
  class Resource$Operations protected ()
    extends typings.googleapis.buildSrcApisServiceusageV1beta1Mod.serviceusage_v1beta1.Resource$Operations {
    def this(context: APIRequestContext) = this()
  }
  
  @js.native
  class Resource$Services protected ()
    extends typings.googleapis.buildSrcApisServiceusageV1beta1Mod.serviceusage_v1beta1.Resource$Services {
    def this(context: APIRequestContext) = this()
  }
