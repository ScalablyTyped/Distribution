...
trait Schema$Finding extends js.Object {
  ...
  /**
    ...
    */
  var outdatedLibrary: js.UndefOr[Schema$OutdatedLibrary] = js.native
  /**
  ...
  /**
    ...
    * audio files, etc.
    */
  var violatingResource: js.UndefOr[Schema$ViolatingResource] = js.native
  /**
    * Output only. An addon containing information about vulnerable or missing
    * HTTP headers.
    */
  var vulnerableHeaders: js.UndefOr[Schema$VulnerableHeaders] = js.native
  /**
    * Output only. An addon containing information about request parameters
    * which were found to be vulnerable.
    */
  var vulnerableParameters: js.UndefOr[Schema$VulnerableParameters] = js.native
  /**
    * Output only. An addon containing information reported for an XSS, if any.
    */
  var xss: js.UndefOr[Schema$Xss] = js.native
}
...
object Schema$Finding {
  ...
  def apply(
    ...
    name: String = null,
    outdatedLibrary: Schema$OutdatedLibrary = null,
    reproductionUrl: String = null,
    trackingId: String = null,
    violatingResource: Schema$ViolatingResource = null,
    vulnerableHeaders: Schema$VulnerableHeaders = null,
    vulnerableParameters: Schema$VulnerableParameters = null,
    xss: Schema$Xss = null
  ): Schema$Finding = {
