...
@js.native
trait ParamsDollarResourceDollarProjectsDollarScanconfigsDollarStart extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$StartScanRunRequest] = js.native
}
