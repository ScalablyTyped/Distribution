...
trait ParamsResourceFoldersBigqueryexportsCreate
  extends StObject
...
object ParamsResourceFoldersBigqueryexportsCreate {
  
  inline def apply(): ParamsResourceFoldersBigqueryexportsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersBigqueryexportsCreate]
  }
  
  extension [Self <: ParamsResourceFoldersBigqueryexportsCreate](x: Self) {
