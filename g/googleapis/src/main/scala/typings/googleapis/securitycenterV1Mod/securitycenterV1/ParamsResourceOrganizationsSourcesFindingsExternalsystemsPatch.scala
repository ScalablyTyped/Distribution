...
trait ParamsResourceOrganizationsSourcesFindingsExternalsystemsPatch
  extends StObject
...
object ParamsResourceOrganizationsSourcesFindingsExternalsystemsPatch {
  
  inline def apply(): ParamsResourceOrganizationsSourcesFindingsExternalsystemsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsSourcesFindingsExternalsystemsPatch]
  }
  
  extension [Self <: ParamsResourceOrganizationsSourcesFindingsExternalsystemsPatch](x: Self) {
