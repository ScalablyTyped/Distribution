...
trait ParamsResourceProjectsSourcesFindingsPatch
  extends StObject
...
object ParamsResourceProjectsSourcesFindingsPatch {
  
  inline def apply(): ParamsResourceProjectsSourcesFindingsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSourcesFindingsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsSourcesFindingsPatch](x: Self) {
