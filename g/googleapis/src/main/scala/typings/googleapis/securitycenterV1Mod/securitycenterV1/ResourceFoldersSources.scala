...
@JSImport("googleapis/build/src/apis/securitycenter/v1", "securitycenter_v1.Resource$Folders$Sources")
@js.native
open class ResourceFoldersSources protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var context: APIRequestContext = js.native
  
  var findings: ResourceFoldersSourcesFindings = js.native
  ...
  def list(params: ParamsResourceFoldersSourcesList): GaxiosPromise[SchemaListSourcesResponse] = js.native
  def list(
    params: ParamsResourceFoldersSourcesList,
  ...
  def list(params: ParamsResourceFoldersSourcesList, options: MethodOptions): GaxiosPromise[SchemaListSourcesResponse] = js.native
  def list(
    params: ParamsResourceFoldersSourcesList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceFoldersSourcesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceFoldersSourcesList,
