...
trait ParamsResourceFoldersSourcesFindingsList
  extends StObject
...
object ParamsResourceFoldersSourcesFindingsList {
  
  inline def apply(): ParamsResourceFoldersSourcesFindingsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersSourcesFindingsList]
  }
  
  extension [Self <: ParamsResourceFoldersSourcesFindingsList](x: Self) {
