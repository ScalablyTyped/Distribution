...
trait SchemaGoogleCloudSecuritycenterV1p1beta1SecurityMarks extends StObject {
...
object SchemaGoogleCloudSecuritycenterV1p1beta1SecurityMarks {
  
  inline def apply(): SchemaGoogleCloudSecuritycenterV1p1beta1SecurityMarks = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudSecuritycenterV1p1beta1SecurityMarks]
  }
  
  extension [Self <: SchemaGoogleCloudSecuritycenterV1p1beta1SecurityMarks](x: Self) {
