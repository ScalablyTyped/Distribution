...
trait SchemaGoogleCloudSecuritycenterV1MuteConfig extends StObject {
...
object SchemaGoogleCloudSecuritycenterV1MuteConfig {
  
  inline def apply(): SchemaGoogleCloudSecuritycenterV1MuteConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudSecuritycenterV1MuteConfig]
  }
  
  extension [Self <: SchemaGoogleCloudSecuritycenterV1MuteConfig](x: Self) {
