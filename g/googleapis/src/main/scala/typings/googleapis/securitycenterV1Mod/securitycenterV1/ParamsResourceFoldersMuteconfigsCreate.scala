...
trait ParamsResourceFoldersMuteconfigsCreate
  extends StObject
...
object ParamsResourceFoldersMuteconfigsCreate {
  
  inline def apply(): ParamsResourceFoldersMuteconfigsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersMuteconfigsCreate]
  }
  
  extension [Self <: ParamsResourceFoldersMuteconfigsCreate](x: Self) {
