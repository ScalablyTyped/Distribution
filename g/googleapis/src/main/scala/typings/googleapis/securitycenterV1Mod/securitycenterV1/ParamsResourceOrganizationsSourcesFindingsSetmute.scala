...
trait ParamsResourceOrganizationsSourcesFindingsSetmute
  extends StObject
...
object ParamsResourceOrganizationsSourcesFindingsSetmute {
  
  inline def apply(): ParamsResourceOrganizationsSourcesFindingsSetmute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsSourcesFindingsSetmute]
  }
  
  extension [Self <: ParamsResourceOrganizationsSourcesFindingsSetmute](x: Self) {
