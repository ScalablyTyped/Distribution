...
object ParamsResourceOrganizationsSourcesList {
  ...
  @scala.inline
  def apply(): ParamsResourceOrganizationsSourcesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsSourcesList]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsSourcesListMutableBuilder[Self <: ParamsResourceOrganizationsSourcesList] (val x: Self) extends AnyVal {
