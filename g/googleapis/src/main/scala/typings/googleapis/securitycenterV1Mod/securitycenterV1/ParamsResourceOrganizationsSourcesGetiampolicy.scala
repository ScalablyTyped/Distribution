...
object ParamsResourceOrganizationsSourcesGetiampolicy {
  ...
  @scala.inline
  def apply(): ParamsResourceOrganizationsSourcesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsSourcesGetiampolicy]
  }
  
  @scala.inline
  implicit class ParamsResourceOrganizationsSourcesGetiampolicyMutableBuilder[Self <: ParamsResourceOrganizationsSourcesGetiampolicy] (val x: Self) extends AnyVal {
