...
trait ParamsResourceFoldersSourcesFindingsUpdatesecuritymarks
  extends StObject
...
object ParamsResourceFoldersSourcesFindingsUpdatesecuritymarks {
  
  inline def apply(): ParamsResourceFoldersSourcesFindingsUpdatesecuritymarks = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersSourcesFindingsUpdatesecuritymarks]
  }
  
  extension [Self <: ParamsResourceFoldersSourcesFindingsUpdatesecuritymarks](x: Self) {
