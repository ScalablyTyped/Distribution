...
trait ParamsResourceFoldersSourcesFindingsSetmute
  extends StObject
...
object ParamsResourceFoldersSourcesFindingsSetmute {
  
  inline def apply(): ParamsResourceFoldersSourcesFindingsSetmute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersSourcesFindingsSetmute]
  }
  
  extension [Self <: ParamsResourceFoldersSourcesFindingsSetmute](x: Self) {
