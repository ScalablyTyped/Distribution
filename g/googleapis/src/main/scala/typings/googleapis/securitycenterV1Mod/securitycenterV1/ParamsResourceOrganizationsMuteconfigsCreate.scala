...
trait ParamsResourceOrganizationsMuteconfigsCreate
  extends StObject
...
object ParamsResourceOrganizationsMuteconfigsCreate {
  
  inline def apply(): ParamsResourceOrganizationsMuteconfigsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsMuteconfigsCreate]
  }
  
  extension [Self <: ParamsResourceOrganizationsMuteconfigsCreate](x: Self) {
