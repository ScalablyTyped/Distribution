...
trait ParamsResourceFoldersAssetsList
  extends StObject
...
object ParamsResourceFoldersAssetsList {
  
  inline def apply(): ParamsResourceFoldersAssetsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersAssetsList]
  }
  
  extension [Self <: ParamsResourceFoldersAssetsList](x: Self) {
