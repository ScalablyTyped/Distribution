...
trait ParamsResourceProjectsMuteconfigsList
  extends StObject
...
object ParamsResourceProjectsMuteconfigsList {
  
  inline def apply(): ParamsResourceProjectsMuteconfigsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsMuteconfigsList]
  }
  
  extension [Self <: ParamsResourceProjectsMuteconfigsList](x: Self) {
