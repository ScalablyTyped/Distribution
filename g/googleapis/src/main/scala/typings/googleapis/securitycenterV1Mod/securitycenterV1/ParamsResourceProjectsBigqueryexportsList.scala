...
trait ParamsResourceProjectsBigqueryexportsList
  extends StObject
...
object ParamsResourceProjectsBigqueryexportsList {
  
  inline def apply(): ParamsResourceProjectsBigqueryexportsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsBigqueryexportsList]
  }
  
  extension [Self <: ParamsResourceProjectsBigqueryexportsList](x: Self) {
