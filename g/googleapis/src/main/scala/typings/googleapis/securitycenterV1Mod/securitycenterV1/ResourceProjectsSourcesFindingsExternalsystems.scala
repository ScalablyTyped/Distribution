...
@JSImport("googleapis/build/src/apis/securitycenter/v1", "securitycenter_v1.Resource$Projects$Sources$Findings$Externalsystems")
@js.native
open class ResourceProjectsSourcesFindingsExternalsystems protected () extends StObject {
  ...
  def patch(params: ParamsResourceProjectsSourcesFindingsExternalsystemsPatch): GaxiosPromise[SchemaGoogleCloudSecuritycenterV1ExternalSystem] = js.native
  def patch(
    params: ParamsResourceProjectsSourcesFindingsExternalsystemsPatch,
  ...
  def patch(params: ParamsResourceProjectsSourcesFindingsExternalsystemsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudSecuritycenterV1ExternalSystem] = js.native
  def patch(
    params: ParamsResourceProjectsSourcesFindingsExternalsystemsPatch,
  ...
  /**
    ...
    */
  def patch(params: ParamsResourceProjectsSourcesFindingsExternalsystemsPatch, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def patch(
    params: ParamsResourceProjectsSourcesFindingsExternalsystemsPatch,
