...
trait ParamsResourceProjectsSourcesFindingsUpdatesecuritymarks
  extends StObject
...
object ParamsResourceProjectsSourcesFindingsUpdatesecuritymarks {
  
  inline def apply(): ParamsResourceProjectsSourcesFindingsUpdatesecuritymarks = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSourcesFindingsUpdatesecuritymarks]
  }
  
  extension [Self <: ParamsResourceProjectsSourcesFindingsUpdatesecuritymarks](x: Self) {
