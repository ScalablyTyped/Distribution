...
trait ParamsResourceProjectsAssetsList
  extends StObject
...
object ParamsResourceProjectsAssetsList {
  
  inline def apply(): ParamsResourceProjectsAssetsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAssetsList]
  }
  
  extension [Self <: ParamsResourceProjectsAssetsList](x: Self) {
