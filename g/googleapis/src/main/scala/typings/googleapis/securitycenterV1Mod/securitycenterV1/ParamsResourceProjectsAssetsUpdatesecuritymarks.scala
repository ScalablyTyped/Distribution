...
trait ParamsResourceProjectsAssetsUpdatesecuritymarks
  extends StObject
...
object ParamsResourceProjectsAssetsUpdatesecuritymarks {
  
  inline def apply(): ParamsResourceProjectsAssetsUpdatesecuritymarks = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAssetsUpdatesecuritymarks]
  }
  
  extension [Self <: ParamsResourceProjectsAssetsUpdatesecuritymarks](x: Self) {
