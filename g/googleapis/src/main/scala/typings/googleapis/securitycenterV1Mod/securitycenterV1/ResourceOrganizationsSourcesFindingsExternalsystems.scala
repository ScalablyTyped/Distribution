...
@JSImport("googleapis/build/src/apis/securitycenter/v1", "securitycenter_v1.Resource$Organizations$Sources$Findings$Externalsystems")
@js.native
open class ResourceOrganizationsSourcesFindingsExternalsystems protected () extends StObject {
  ...
  def patch(params: ParamsResourceOrganizationsSourcesFindingsExternalsystemsPatch): GaxiosPromise[SchemaGoogleCloudSecuritycenterV1ExternalSystem] = js.native
  def patch(
    params: ParamsResourceOrganizationsSourcesFindingsExternalsystemsPatch,
  ...
  def patch(params: ParamsResourceOrganizationsSourcesFindingsExternalsystemsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudSecuritycenterV1ExternalSystem] = js.native
  def patch(
    params: ParamsResourceOrganizationsSourcesFindingsExternalsystemsPatch,
