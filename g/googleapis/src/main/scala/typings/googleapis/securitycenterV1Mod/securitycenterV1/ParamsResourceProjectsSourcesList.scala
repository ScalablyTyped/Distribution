...
trait ParamsResourceProjectsSourcesList
  extends StObject
...
object ParamsResourceProjectsSourcesList {
  
  inline def apply(): ParamsResourceProjectsSourcesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSourcesList]
  }
  
  extension [Self <: ParamsResourceProjectsSourcesList](x: Self) {
