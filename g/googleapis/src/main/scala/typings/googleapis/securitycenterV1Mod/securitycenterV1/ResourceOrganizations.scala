...
open class ResourceOrganizations protected () extends StObject {
  ...
  var bigQueryExports: ResourceOrganizationsBigqueryexports = js.native
  
  var context: APIRequestContext = js.native
  
  var findings: ResourceOrganizationsFindings = js.native
  ...
  var muteConfigs: ResourceOrganizationsMuteconfigs = js.native
