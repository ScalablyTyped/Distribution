...
trait ParamsResourceOrganizationsBigqueryexportsList
  extends StObject
...
object ParamsResourceOrganizationsBigqueryexportsList {
  
  inline def apply(): ParamsResourceOrganizationsBigqueryexportsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsBigqueryexportsList]
  }
  
  extension [Self <: ParamsResourceOrganizationsBigqueryexportsList](x: Self) {
