...
trait ParamsResourceProjectsSourcesFindingsExternalsystemsPatch
  extends StObject
...
object ParamsResourceProjectsSourcesFindingsExternalsystemsPatch {
  
  inline def apply(): ParamsResourceProjectsSourcesFindingsExternalsystemsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSourcesFindingsExternalsystemsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsSourcesFindingsExternalsystemsPatch](x: Self) {
