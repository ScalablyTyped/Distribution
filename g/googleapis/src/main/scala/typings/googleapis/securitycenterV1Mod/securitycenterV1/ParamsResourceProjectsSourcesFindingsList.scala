...
trait ParamsResourceProjectsSourcesFindingsList
  extends StObject
...
object ParamsResourceProjectsSourcesFindingsList {
  
  inline def apply(): ParamsResourceProjectsSourcesFindingsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSourcesFindingsList]
  }
  
  extension [Self <: ParamsResourceProjectsSourcesFindingsList](x: Self) {
