...
trait ParamsResourceProjectsBigqueryexportsCreate
  extends StObject
...
object ParamsResourceProjectsBigqueryexportsCreate {
  
  inline def apply(): ParamsResourceProjectsBigqueryexportsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsBigqueryexportsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsBigqueryexportsCreate](x: Self) {
