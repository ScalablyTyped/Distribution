...
trait ParamsResourceProjectsAssetsGroup
  extends StObject
...
object ParamsResourceProjectsAssetsGroup {
  
  inline def apply(): ParamsResourceProjectsAssetsGroup = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAssetsGroup]
  }
  
  extension [Self <: ParamsResourceProjectsAssetsGroup](x: Self) {
