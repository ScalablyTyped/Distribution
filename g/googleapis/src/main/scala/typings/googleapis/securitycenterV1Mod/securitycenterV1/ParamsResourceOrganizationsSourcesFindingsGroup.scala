...
object ParamsResourceOrganizationsSourcesFindingsGroup {
  ...
  @scala.inline
  implicit class ParamsResourceOrganizationsSourcesFindingsGroupOps[Self <: ParamsResourceOrganizationsSourcesFindingsGroup] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaGroupFindingsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
