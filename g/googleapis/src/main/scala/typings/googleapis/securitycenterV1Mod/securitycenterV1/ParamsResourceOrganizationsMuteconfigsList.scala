...
trait ParamsResourceOrganizationsMuteconfigsList
  extends StObject
...
object ParamsResourceOrganizationsMuteconfigsList {
  
  inline def apply(): ParamsResourceOrganizationsMuteconfigsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsMuteconfigsList]
  }
  
  extension [Self <: ParamsResourceOrganizationsMuteconfigsList](x: Self) {
