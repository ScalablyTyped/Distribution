...
trait ParamsResourceProjectsFindingsBulkmute
  extends StObject
...
object ParamsResourceProjectsFindingsBulkmute {
  
  inline def apply(): ParamsResourceProjectsFindingsBulkmute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsFindingsBulkmute]
  }
  
  extension [Self <: ParamsResourceProjectsFindingsBulkmute](x: Self) {
