...
@js.native
trait Anon_ActivitiesCustomRichMediaEventsDateRangeDimensionFilters extends js.Object {
...
object Anon_ActivitiesCustomRichMediaEventsDateRangeDimensionFilters {
  @scala.inline
  def apply(
  ...
  ): Anon_ActivitiesCustomRichMediaEventsDateRangeDimensionFilters = {
    ...
    __obj.asInstanceOf[Anon_ActivitiesCustomRichMediaEventsDateRangeDimensionFilters]
  }
}
