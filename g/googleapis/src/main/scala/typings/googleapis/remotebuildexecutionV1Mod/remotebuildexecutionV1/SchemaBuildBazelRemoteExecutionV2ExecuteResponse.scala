...
trait SchemaBuildBazelRemoteExecutionV2ExecuteResponse extends StObject {
  ...
  /**
    ...
    */
  var cachedResult: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var serverLogs: js.UndefOr[StringDictionary[SchemaBuildBazelRemoteExecutionV2LogFile] | Null] = js.undefined
...
object SchemaBuildBazelRemoteExecutionV2ExecuteResponse {
  ...
  extension [Self <: SchemaBuildBazelRemoteExecutionV2ExecuteResponse](x: Self) {
    ...
    inline def setCachedResultNull: Self = StObject.set(x, "cachedResult", null)
    ...
    inline def setServerLogsNull: Self = StObject.set(x, "serverLogs", null)
