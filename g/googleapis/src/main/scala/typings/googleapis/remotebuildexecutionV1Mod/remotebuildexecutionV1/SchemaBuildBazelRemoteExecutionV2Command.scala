...
trait SchemaBuildBazelRemoteExecutionV2Command extends StObject {
  ...
  /**
    ...
    */
  var outputDirectories: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var outputFiles: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var outputNodeProperties: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var outputPaths: js.UndefOr[js.Array[String] | Null] = js.undefined
...
object SchemaBuildBazelRemoteExecutionV2Command {
  ...
  extension [Self <: SchemaBuildBazelRemoteExecutionV2Command](x: Self) {
    ...
    inline def setEnvironmentVariablesVarargs(value: SchemaBuildBazelRemoteExecutionV2CommandEnvironmentVariable*): Self = StObject.set(x, "environmentVariables", js.Array(value*))
    
    inline def setOutputDirectories(value: js.Array[String]): Self = StObject.set(x, "outputDirectories", value.asInstanceOf[js.Any])
    
    inline def setOutputDirectoriesNull: Self = StObject.set(x, "outputDirectories", null)
    ...
    inline def setOutputFilesNull: Self = StObject.set(x, "outputFiles", null)
    ...
    inline def setOutputNodePropertiesNull: Self = StObject.set(x, "outputNodeProperties", null)
    ...
    inline def setOutputPathsNull: Self = StObject.set(x, "outputPaths", null)
