...
trait ParamsResourcePlatformsChannelsVersionsReleasesList
  extends StObject
...
object ParamsResourcePlatformsChannelsVersionsReleasesList {
  
  inline def apply(): ParamsResourcePlatformsChannelsVersionsReleasesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePlatformsChannelsVersionsReleasesList]
  }
  
  extension [Self <: ParamsResourcePlatformsChannelsVersionsReleasesList](x: Self) {
