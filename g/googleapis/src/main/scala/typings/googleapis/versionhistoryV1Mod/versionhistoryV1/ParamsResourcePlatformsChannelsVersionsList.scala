...
trait ParamsResourcePlatformsChannelsVersionsList
  extends StObject
...
object ParamsResourcePlatformsChannelsVersionsList {
  
  inline def apply(): ParamsResourcePlatformsChannelsVersionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePlatformsChannelsVersionsList]
  }
  
  extension [Self <: ParamsResourcePlatformsChannelsVersionsList](x: Self) {
