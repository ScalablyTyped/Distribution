...
@js.native
trait ParamsResourceMattersExportsGet extends StandardParameters {
...
object ParamsResourceMattersExportsGet {
  ...
  @scala.inline
  implicit class ParamsResourceMattersExportsGetOps[Self <: ParamsResourceMattersExportsGet] (val x: Self) extends AnyVal {
