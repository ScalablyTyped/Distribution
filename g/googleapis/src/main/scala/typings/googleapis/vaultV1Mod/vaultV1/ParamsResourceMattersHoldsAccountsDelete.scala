...
trait ParamsResourceMattersHoldsAccountsDelete
  extends StObject
...
object ParamsResourceMattersHoldsAccountsDelete {
  ...
  inline def apply(): ParamsResourceMattersHoldsAccountsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceMattersHoldsAccountsDelete]
  }
  
  extension [Self <: ParamsResourceMattersHoldsAccountsDelete](x: Self) {
