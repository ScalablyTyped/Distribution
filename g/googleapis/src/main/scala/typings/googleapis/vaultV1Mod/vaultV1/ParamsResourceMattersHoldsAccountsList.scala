...
trait ParamsResourceMattersHoldsAccountsList
  extends StObject
...
object ParamsResourceMattersHoldsAccountsList {
  ...
  inline def apply(): ParamsResourceMattersHoldsAccountsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceMattersHoldsAccountsList]
  }
  
  extension [Self <: ParamsResourceMattersHoldsAccountsList](x: Self) {
