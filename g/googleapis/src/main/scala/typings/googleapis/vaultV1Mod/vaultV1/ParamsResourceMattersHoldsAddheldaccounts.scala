...
object ParamsResourceMattersHoldsAddheldaccounts {
  ...
  @scala.inline
  implicit class ParamsResourceMattersHoldsAddheldaccountsOps[Self <: ParamsResourceMattersHoldsAddheldaccounts] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaAddHeldAccountsRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
