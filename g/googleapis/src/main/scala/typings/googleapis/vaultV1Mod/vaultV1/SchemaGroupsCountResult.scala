...
trait SchemaGroupsCountResult extends StObject {
...
object SchemaGroupsCountResult {
  
  inline def apply(): SchemaGroupsCountResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGroupsCountResult]
  }
  
  extension [Self <: SchemaGroupsCountResult](x: Self) {
