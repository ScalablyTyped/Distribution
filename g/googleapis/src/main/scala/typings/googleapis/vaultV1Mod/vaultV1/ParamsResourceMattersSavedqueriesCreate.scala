...
object ParamsResourceMattersSavedqueriesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceMattersSavedqueriesCreateOps[Self <: ParamsResourceMattersSavedqueriesCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaSavedQuery): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
