...
@js.native
trait ParamsResourceMattersDelete extends StandardParameters {
...
object ParamsResourceMattersDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceMattersDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceMattersDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceMattersDeleteMutableBuilder[Self <: ParamsResourceMattersDelete] (val x: Self) extends AnyVal {
