...
@js.native
trait Anon_AdditionalRolesInherited extends js.Object {
...
object Anon_AdditionalRolesInherited {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AdditionalRolesInherited]
  }
}
