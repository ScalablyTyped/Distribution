...
@JSImport("googleapis/build/src/apis/tpu/v2alpha1", "tpu_v2alpha1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  def generateServiceIdentity(): GaxiosPromise[SchemaGenerateServiceIdentityResponse] = js.native
  def generateServiceIdentity(callback: BodyResponseCallback[SchemaGenerateServiceIdentityResponse]): Unit = js.native
  def generateServiceIdentity(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGenerateServiceIdentityResponse] = js.native
  def generateServiceIdentity(params: ParamsResourceProjectsLocationsGenerateserviceidentity): GaxiosPromise[SchemaGenerateServiceIdentityResponse] = js.native
  def generateServiceIdentity(
    params: ParamsResourceProjectsLocationsGenerateserviceidentity,
    callback: BodyResponseCallback[SchemaGenerateServiceIdentityResponse]
  ): Unit = js.native
  def generateServiceIdentity(
    params: ParamsResourceProjectsLocationsGenerateserviceidentity,
    options: BodyResponseCallback[Readable | SchemaGenerateServiceIdentityResponse],
    callback: BodyResponseCallback[Readable | SchemaGenerateServiceIdentityResponse]
  ): Unit = js.native
  def generateServiceIdentity(params: ParamsResourceProjectsLocationsGenerateserviceidentity, options: MethodOptions): GaxiosPromise[SchemaGenerateServiceIdentityResponse] = js.native
  def generateServiceIdentity(
    params: ParamsResourceProjectsLocationsGenerateserviceidentity,
  ...
  /**
    ...
    */
  def generateServiceIdentity(params: ParamsResourceProjectsLocationsGenerateserviceidentity, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def generateServiceIdentity(
    params: ParamsResourceProjectsLocationsGenerateserviceidentity,
  ...
  var runtimeVersions: ResourceProjectsLocationsRuntimeversions = js.native
}
