...
trait ParamsResourceProjectsLocationsNodesPatch
  extends StObject
...
object ParamsResourceProjectsLocationsNodesPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsNodesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsNodesPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsNodesPatch](x: Self) {
