...
trait SchemaCommentReplyList extends StObject {
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaCommentReply]] = js.undefined
...
object SchemaCommentReplyList {
  ...
  inline def apply(): SchemaCommentReplyList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCommentReplyList]
  }
  
  extension [Self <: SchemaCommentReplyList](x: Self) {
    
    inline def setItems(value: js.Array[SchemaCommentReply]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaCommentReply*): Self = StObject.set(x, "items", js.Array(value :_*))
