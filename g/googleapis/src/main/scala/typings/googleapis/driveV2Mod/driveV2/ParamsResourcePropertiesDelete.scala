...
@js.native
trait ParamsResourcePropertiesDelete extends StandardParameters {
...
object ParamsResourcePropertiesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourcePropertiesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourcePropertiesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourcePropertiesDeleteMutableBuilder[Self <: ParamsResourcePropertiesDelete] (val x: Self) extends AnyVal {
