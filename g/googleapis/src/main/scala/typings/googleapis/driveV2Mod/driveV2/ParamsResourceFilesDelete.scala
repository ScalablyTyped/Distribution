...
@js.native
trait ParamsResourceFilesDelete extends StandardParameters {
...
object ParamsResourceFilesDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceFilesDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFilesDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceFilesDeleteMutableBuilder[Self <: ParamsResourceFilesDelete] (val x: Self) extends AnyVal {
