...
object SchemaChangeList {
  ...
  extension [Self <: SchemaChangeList](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaChange]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaChange*): Self = StObject.set(x, "items", js.Array(value :_*))
