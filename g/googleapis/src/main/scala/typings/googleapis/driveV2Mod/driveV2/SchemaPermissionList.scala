...
object SchemaPermissionList {
  ...
  implicit class SchemaPermissionListOps[Self <: SchemaPermissionList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: SchemaPermission*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[SchemaPermission]): Self = this.set("items", value.asInstanceOf[js.Any])
