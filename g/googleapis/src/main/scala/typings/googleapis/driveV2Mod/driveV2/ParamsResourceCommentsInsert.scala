...
trait ParamsResourceCommentsInsert
  extends StObject
...
object ParamsResourceCommentsInsert {
  ...
  @scala.inline
  def apply(): ParamsResourceCommentsInsert = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceCommentsInsert]
  }
  
  @scala.inline
  implicit class ParamsResourceCommentsInsertMutableBuilder[Self <: ParamsResourceCommentsInsert] (val x: Self) extends AnyVal {
