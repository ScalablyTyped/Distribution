...
trait ParamsResourceFilesTrash
  extends StObject
...
object ParamsResourceFilesTrash {
  ...
  @scala.inline
  def apply(): ParamsResourceFilesTrash = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFilesTrash]
  }
  
  @scala.inline
  implicit class ParamsResourceFilesTrashMutableBuilder[Self <: ParamsResourceFilesTrash] (val x: Self) extends AnyVal {
