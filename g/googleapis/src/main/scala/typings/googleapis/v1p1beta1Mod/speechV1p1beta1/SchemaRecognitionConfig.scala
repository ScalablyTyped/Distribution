...
object SchemaRecognitionConfig {
  ...
  implicit class SchemaRecognitionConfigOps[Self <: SchemaRecognitionConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlternativeLanguageCodesVarargs(value: String*): Self = this.set("alternativeLanguageCodes", js.Array(value :_*))
    
    @scala.inline
    def setAlternativeLanguageCodes(value: js.Array[String]): Self = this.set("alternativeLanguageCodes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAlternativeLanguageCodes: Self = this.set("alternativeLanguageCodes", js.undefined)
    ...
    @scala.inline
    def setDiarizationConfig(value: SchemaSpeakerDiarizationConfig): Self = this.set("diarizationConfig", value.asInstanceOf[js.Any])
