...
@js.native
class ResourceDollarBeaconsDollarDiagnostics protected () extends js.Object {
  ...
  /**
    ...
    */
  def list(): GaxiosPromise[Schema$ListDiagnosticsResponse] = js.native
  def list(callback: BodyResponseCallback[Schema$ListDiagnosticsResponse]): Unit = js.native
  def list(params: ParamsDollarResourceDollarBeaconsDollarDiagnosticsDollarList): GaxiosPromise[Schema$ListDiagnosticsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBeaconsDollarDiagnosticsDollarList,
    callback: BodyResponseCallback[Schema$ListDiagnosticsResponse]
  ): Unit = js.native
  def list(
    params: ParamsDollarResourceDollarBeaconsDollarDiagnosticsDollarList,
    options: BodyResponseCallback[Schema$ListDiagnosticsResponse],
    callback: BodyResponseCallback[Schema$ListDiagnosticsResponse]
  ): Unit = js.native
  def list(params: ParamsDollarResourceDollarBeaconsDollarDiagnosticsDollarList, options: MethodOptions): GaxiosPromise[Schema$ListDiagnosticsResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarBeaconsDollarDiagnosticsDollarList,
