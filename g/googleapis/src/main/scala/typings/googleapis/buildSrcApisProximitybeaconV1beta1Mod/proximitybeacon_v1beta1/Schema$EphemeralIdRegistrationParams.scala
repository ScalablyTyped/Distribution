...
/**
  ...
  */
@js.native
trait Schema$EphemeralIdRegistrationParams extends js.Object {
  /**
...
object Schema$EphemeralIdRegistrationParams {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$EphemeralIdRegistrationParams]
  }
}
