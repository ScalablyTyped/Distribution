...
/**
  ...
  */
@js.native
trait Schema$Beacon extends js.Object {
  /**
  ...
  /**
    ...
    */
  var ephemeralIdRegistration: js.UndefOr[Schema$EphemeralIdRegistration] = js.native
  /**
  ...
  /**
    ...
    */
  var indoorLevel: js.UndefOr[Schema$IndoorLevel] = js.native
  /**
...
object Schema$Beacon {
  @scala.inline
  def apply(
    advertisedId: Schema$AdvertisedId = null,
    beaconName: String = null,
    description: String = null,
    ephemeralIdRegistration: Schema$EphemeralIdRegistration = null,
    expectedStability: String = null,
    indoorLevel: Schema$IndoorLevel = null,
    ...
    __obj.asInstanceOf[Schema$Beacon]
  }
}
