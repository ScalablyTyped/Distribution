...
import typings.googleapis.Anon_Accept
import typings.googleapis.Anon_ParameterName
import typings.googleapis.Anon_RefString
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait Schema$RestMethod extends js.Object {
  /**
  ...
  /**
    ...
    */
  var mediaUpload: js.UndefOr[Anon_Accept] = js.native
  /**
  ...
  /**
    ...
    */
  var parameters: js.UndefOr[StringDictionary[Schema$JsonSchema]] = js.native
  /**
  ...
  /**
    ...
    */
  var request: js.UndefOr[Anon_ParameterName] = js.native
  /**
    * The schema for the response.
    */
  var response: js.UndefOr[Anon_RefString] = js.native
  /**
...
object Schema$RestMethod {
  ...
  def apply(
    ...
    parameters: StringDictionary[Schema$JsonSchema] = null,
    path: String = null,
    ...
    __obj.asInstanceOf[Schema$RestMethod]
  }
}
