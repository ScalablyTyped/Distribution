...
object SchemaPolicy {
  ...
  extension [Self <: SchemaPolicy](x: Self) {
    ...
    inline def setAuditConfigs(value: js.Array[SchemaAuditConfig]): Self = StObject.set(x, "auditConfigs", value.asInstanceOf[js.Any])
    
    inline def setAuditConfigsUndefined: Self = StObject.set(x, "auditConfigs", js.undefined)
    
    inline def setAuditConfigsVarargs(value: SchemaAuditConfig*): Self = StObject.set(x, "auditConfigs", js.Array(value :_*))
