...
trait SchemaGoogleCloudSecuritycenterV1p1beta1Finding extends StObject {
...
object SchemaGoogleCloudSecuritycenterV1p1beta1Finding {
  
  inline def apply(): SchemaGoogleCloudSecuritycenterV1p1beta1Finding = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudSecuritycenterV1p1beta1Finding]
  }
  
  extension [Self <: SchemaGoogleCloudSecuritycenterV1p1beta1Finding](x: Self) {
