...
trait ParamsResourceOrganizationsSourcesFindingsSetstate
  extends StObject
...
object ParamsResourceOrganizationsSourcesFindingsSetstate {
  ...
  inline def apply(): ParamsResourceOrganizationsSourcesFindingsSetstate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsSourcesFindingsSetstate]
  }
  
  extension [Self <: ParamsResourceOrganizationsSourcesFindingsSetstate](x: Self) {
