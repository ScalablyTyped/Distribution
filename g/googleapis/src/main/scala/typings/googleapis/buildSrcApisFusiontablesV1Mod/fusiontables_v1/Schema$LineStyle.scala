...
trait Schema$LineStyle extends js.Object {
  ...
  /**
    ...
    */
  var strokeColorStyler: js.UndefOr[Schema$StyleFunction] = js.native
  /**
  ...
  /**
    ...
    * line.
    */
  var strokeWeightStyler: js.UndefOr[Schema$StyleFunction] = js.native
}
...
object Schema$LineStyle {
  ...
  def apply(
    ...
    strokeColorStyler: Schema$StyleFunction = null,
    strokeOpacity: Int | Double = null,
    strokeWeight: Int | Double = null,
    strokeWeightStyler: Schema$StyleFunction = null
  ): Schema$LineStyle = {
