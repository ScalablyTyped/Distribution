...
@js.native
trait ParamsDollarResourceDollarTableDollarImporttable extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTableDollarImporttable {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTableDollarImporttable = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTableDollarImporttable]
  }
}
