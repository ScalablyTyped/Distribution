...
@js.native
trait ParamsDollarResourceDollarTableDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTableDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    tableId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarTableDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTableDollarUpdate]
  }
}
