...
@js.native
trait ParamsDollarResourceDollarColumnDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarColumnDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    tableId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarColumnDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarColumnDollarUpdate]
  }
}
