...
trait SchemaJob extends StObject {
  ...
  /**
    ...
    */
  var degreeTypes: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var jobBenefits: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var jobEndTime: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Optional. The experience level associated with the job, such as "Entry Level".
    */
  var jobLevel: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var jobStartTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var postingCreateTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var postingExpireTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var postingPublishTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var postingRegion: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Output only. The timestamp when this job posting was last updated.
    */
  var postingUpdateTime: js.UndefOr[String | Null] = js.undefined
...
object SchemaJob {
  ...
  extension [Self <: SchemaJob](x: Self) {
    ...
    inline def setDegreeTypesNull: Self = StObject.set(x, "degreeTypes", null)
    ...
    inline def setJobBenefitsNull: Self = StObject.set(x, "jobBenefits", null)
    ...
    inline def setJobEndTimeNull: Self = StObject.set(x, "jobEndTime", null)
    ...
    inline def setJobLevelNull: Self = StObject.set(x, "jobLevel", null)
    ...
    inline def setJobStartTimeNull: Self = StObject.set(x, "jobStartTime", null)
    ...
    inline def setPostingCreateTimeNull: Self = StObject.set(x, "postingCreateTime", null)
    ...
    inline def setPostingExpireTimeNull: Self = StObject.set(x, "postingExpireTime", null)
    ...
    inline def setPostingPublishTimeNull: Self = StObject.set(x, "postingPublishTime", null)
    ...
    inline def setPostingRegionNull: Self = StObject.set(x, "postingRegion", null)
    ...
    inline def setPostingUpdateTimeNull: Self = StObject.set(x, "postingUpdateTime", null)
