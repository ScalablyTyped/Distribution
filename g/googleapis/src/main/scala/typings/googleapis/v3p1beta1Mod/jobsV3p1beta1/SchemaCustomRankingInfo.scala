...
trait SchemaCustomRankingInfo extends StObject {
  ...
  /**
    ...
    */
  var importanceLevel: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var rankingExpression: js.UndefOr[String | Null] = js.undefined
}
object SchemaCustomRankingInfo {
  ...
  extension [Self <: SchemaCustomRankingInfo](x: Self) {
    ...
    inline def setImportanceLevelNull: Self = StObject.set(x, "importanceLevel", null)
    ...
    inline def setRankingExpressionNull: Self = StObject.set(x, "rankingExpression", null)
