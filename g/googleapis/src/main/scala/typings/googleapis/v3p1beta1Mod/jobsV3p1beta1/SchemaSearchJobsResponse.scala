...
object SchemaSearchJobsResponse {
  ...
  extension [Self <: SchemaSearchJobsResponse](x: Self) {
    ...
    inline def setHistogramQueryResults(value: js.Array[SchemaHistogramQueryResult]): Self = StObject.set(x, "histogramQueryResults", value.asInstanceOf[js.Any])
    
    inline def setHistogramQueryResultsUndefined: Self = StObject.set(x, "histogramQueryResults", js.undefined)
    
    inline def setHistogramQueryResultsVarargs(value: SchemaHistogramQueryResult*): Self = StObject.set(x, "histogramQueryResults", js.Array(value :_*))
