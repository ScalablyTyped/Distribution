...
@js.native
trait Schema$PopulateVersionFilesResponse extends js.Object {
  /**
...
object Schema$PopulateVersionFilesResponse {
  @scala.inline
  def apply(uploadRequiredHashes: js.Array[String] = null, uploadUrl: String = null): Schema$PopulateVersionFilesResponse = {
    ...
    __obj.asInstanceOf[Schema$PopulateVersionFilesResponse]
  }
}
