...
/**
  ...
  */
@js.native
trait Schema$Redirect extends js.Object {
  /**
...
object Schema$Redirect {
  @scala.inline
  def apply(glob: String = null, location: String = null, statusCode: Int | Double = null): Schema$Redirect = {
    val __obj = js.Dynamic.literal()
    if (glob != null) __obj.updateDynamic("glob")(glob.asInstanceOf[js.Any])
    if (location != null) __obj.updateDynamic("location")(location.asInstanceOf[js.Any])
    if (statusCode != null) __obj.updateDynamic("statusCode")(statusCode.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$Redirect]
  }
}
