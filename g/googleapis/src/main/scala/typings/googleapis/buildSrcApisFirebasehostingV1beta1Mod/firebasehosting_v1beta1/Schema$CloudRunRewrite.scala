...
/**
  ...
  */
@js.native
trait Schema$CloudRunRewrite extends js.Object {
  /**
...
object Schema$CloudRunRewrite {
  @scala.inline
  def apply(region: String = null, serviceId: String = null): Schema$CloudRunRewrite = {
    val __obj = js.Dynamic.literal()
    if (region != null) __obj.updateDynamic("region")(region.asInstanceOf[js.Any])
    if (serviceId != null) __obj.updateDynamic("serviceId")(serviceId.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$CloudRunRewrite]
  }
}
