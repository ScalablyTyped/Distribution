...
trait ParamsResourceProjectsAppsSafetynetconfigBatchget
  extends StObject
...
object ParamsResourceProjectsAppsSafetynetconfigBatchget {
  
  inline def apply(): ParamsResourceProjectsAppsSafetynetconfigBatchget = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAppsSafetynetconfigBatchget]
  }
  
  extension [Self <: ParamsResourceProjectsAppsSafetynetconfigBatchget](x: Self) {
