...
trait SchemaGoogleFirebaseAppcheckV1AppAttestConfig extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1AppAttestConfig {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1AppAttestConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1AppAttestConfig]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1AppAttestConfig](x: Self) {
