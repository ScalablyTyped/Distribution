...
trait SchemaGoogleFirebaseAppcheckV1RecaptchaV3Config extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1RecaptchaV3Config {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1RecaptchaV3Config = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1RecaptchaV3Config]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1RecaptchaV3Config](x: Self) {
