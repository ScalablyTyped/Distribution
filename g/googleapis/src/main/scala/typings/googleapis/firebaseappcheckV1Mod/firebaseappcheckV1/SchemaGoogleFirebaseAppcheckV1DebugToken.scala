...
trait SchemaGoogleFirebaseAppcheckV1DebugToken extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1DebugToken {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1DebugToken = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1DebugToken]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1DebugToken](x: Self) {
