...
trait SchemaGoogleFirebaseAppcheckV1RecaptchaEnterpriseConfig extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1RecaptchaEnterpriseConfig {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1RecaptchaEnterpriseConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1RecaptchaEnterpriseConfig]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1RecaptchaEnterpriseConfig](x: Self) {
