...
trait ParamsResourceProjectsServicesPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleFirebaseAppcheckV1Service] = js.undefined
...
object ParamsResourceProjectsServicesPatch {
  ...
  extension [Self <: ParamsResourceProjectsServicesPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleFirebaseAppcheckV1Service): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
