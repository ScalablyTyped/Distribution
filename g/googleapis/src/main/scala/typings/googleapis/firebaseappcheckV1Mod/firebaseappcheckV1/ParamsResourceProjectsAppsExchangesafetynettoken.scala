...
trait ParamsResourceProjectsAppsExchangesafetynettoken
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleFirebaseAppcheckV1ExchangeSafetyNetTokenRequest] = js.undefined
}
object ParamsResourceProjectsAppsExchangesafetynettoken {
  ...
  extension [Self <: ParamsResourceProjectsAppsExchangesafetynettoken](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleFirebaseAppcheckV1ExchangeSafetyNetTokenRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
