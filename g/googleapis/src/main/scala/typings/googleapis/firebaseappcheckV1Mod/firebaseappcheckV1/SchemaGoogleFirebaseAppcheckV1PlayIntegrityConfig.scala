...
trait SchemaGoogleFirebaseAppcheckV1PlayIntegrityConfig extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1PlayIntegrityConfig {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1PlayIntegrityConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1PlayIntegrityConfig]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1PlayIntegrityConfig](x: Self) {
