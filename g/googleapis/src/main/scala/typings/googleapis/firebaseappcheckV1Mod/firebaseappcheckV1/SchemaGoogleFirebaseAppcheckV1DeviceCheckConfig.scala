...
trait SchemaGoogleFirebaseAppcheckV1DeviceCheckConfig extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1DeviceCheckConfig {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1DeviceCheckConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1DeviceCheckConfig]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1DeviceCheckConfig](x: Self) {
