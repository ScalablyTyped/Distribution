...
trait ParamsResourceProjectsAppsGenerateplayintegritychallenge
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeRequest] = js.undefined
}
object ParamsResourceProjectsAppsGenerateplayintegritychallenge {
  ...
  extension [Self <: ParamsResourceProjectsAppsGenerateplayintegritychallenge](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
