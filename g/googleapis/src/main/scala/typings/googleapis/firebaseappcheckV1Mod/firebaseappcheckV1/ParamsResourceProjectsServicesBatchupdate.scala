...
trait ParamsResourceProjectsServicesBatchupdate
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleFirebaseAppcheckV1BatchUpdateServicesRequest] = js.undefined
}
object ParamsResourceProjectsServicesBatchupdate {
  ...
  extension [Self <: ParamsResourceProjectsServicesBatchupdate](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleFirebaseAppcheckV1BatchUpdateServicesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
