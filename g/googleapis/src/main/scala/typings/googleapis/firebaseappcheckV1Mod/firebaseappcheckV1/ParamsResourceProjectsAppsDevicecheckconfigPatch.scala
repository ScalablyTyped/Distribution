...
trait ParamsResourceProjectsAppsDevicecheckconfigPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleFirebaseAppcheckV1DeviceCheckConfig] = js.undefined
...
object ParamsResourceProjectsAppsDevicecheckconfigPatch {
  ...
  extension [Self <: ParamsResourceProjectsAppsDevicecheckconfigPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleFirebaseAppcheckV1DeviceCheckConfig): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
