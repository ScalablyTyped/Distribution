...
trait ParamsResourceProjectsAppsDebugtokensPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.undefined
...
object ParamsResourceProjectsAppsDebugtokensPatch {
  ...
  extension [Self <: ParamsResourceProjectsAppsDebugtokensPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleFirebaseAppcheckV1DebugToken): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
