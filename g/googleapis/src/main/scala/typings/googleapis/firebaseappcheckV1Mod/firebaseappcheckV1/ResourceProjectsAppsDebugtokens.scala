...
@JSImport("googleapis/build/src/apis/firebaseappcheck/v1", "firebaseappcheck_v1.Resource$Projects$Apps$Debugtokens")
@js.native
open class ResourceProjectsAppsDebugtokens protected () extends StObject {
  ...
  def create(): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def create(callback: BodyResponseCallback[SchemaGoogleFirebaseAppcheckV1DebugToken]): Unit = js.native
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def create(params: ParamsResourceProjectsAppsDebugtokensCreate): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def create(
    params: ParamsResourceProjectsAppsDebugtokensCreate,
    callback: BodyResponseCallback[SchemaGoogleFirebaseAppcheckV1DebugToken]
  ): Unit = js.native
  def create(
    params: ParamsResourceProjectsAppsDebugtokensCreate,
    options: BodyResponseCallback[Readable | SchemaGoogleFirebaseAppcheckV1DebugToken],
    callback: BodyResponseCallback[Readable | SchemaGoogleFirebaseAppcheckV1DebugToken]
  ): Unit = js.native
  def create(params: ParamsResourceProjectsAppsDebugtokensCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def create(
    params: ParamsResourceProjectsAppsDebugtokensCreate,
  ...
  def get(): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleFirebaseAppcheckV1DebugToken]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def get(params: ParamsResourceProjectsAppsDebugtokensGet): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsAppsDebugtokensGet, options: MethodOptions): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def get(
    params: ParamsResourceProjectsAppsDebugtokensGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleFirebaseAppcheckV1DebugToken]
  ...
  def list(): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1ListDebugTokensResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleFirebaseAppcheckV1ListDebugTokensResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1ListDebugTokensResponse] = js.native
  def list(params: ParamsResourceProjectsAppsDebugtokensList): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1ListDebugTokensResponse] = js.native
  def list(
    params: ParamsResourceProjectsAppsDebugtokensList,
    callback: BodyResponseCallback[SchemaGoogleFirebaseAppcheckV1ListDebugTokensResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsAppsDebugtokensList,
    options: BodyResponseCallback[Readable | SchemaGoogleFirebaseAppcheckV1ListDebugTokensResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleFirebaseAppcheckV1ListDebugTokensResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsAppsDebugtokensList, options: MethodOptions): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1ListDebugTokensResponse] = js.native
  def list(
    params: ParamsResourceProjectsAppsDebugtokensList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleFirebaseAppcheckV1ListDebugTokensResponse]
  ...
  def patch(): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleFirebaseAppcheckV1DebugToken]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def patch(params: ParamsResourceProjectsAppsDebugtokensPatch): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsAppsDebugtokensPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleFirebaseAppcheckV1DebugToken] = js.native
  def patch(
    params: ParamsResourceProjectsAppsDebugtokensPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleFirebaseAppcheckV1DebugToken]
