...
trait SchemaGoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeResponse extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeResponse {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeResponse]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1GeneratePlayIntegrityChallengeResponse](x: Self) {
