...
trait SchemaGoogleFirebaseAppcheckV1ListServicesResponse extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1ListServicesResponse {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1ListServicesResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1ListServicesResponse]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1ListServicesResponse](x: Self) {
