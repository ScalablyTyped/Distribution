...
trait ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesCertificaterevocationlistsList
  extends StObject
...
object ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesCertificaterevocationlistsList {
  
  inline def apply(): ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesCertificaterevocationlistsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesCertificaterevocationlistsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesCertificaterevocationlistsList](x: Self) {
