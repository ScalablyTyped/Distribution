...
trait ParamsResourceProjectsLocationsCertificatetemplatesPatch
  extends StObject
...
object ParamsResourceProjectsLocationsCertificatetemplatesPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsCertificatetemplatesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCertificatetemplatesPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCertificatetemplatesPatch](x: Self) {
