...
@JSImport("googleapis/build/src/apis/privateca/v1", "privateca_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var caPools: ResourceProjectsLocationsCapools = js.native
  
  var certificateTemplates: ResourceProjectsLocationsCertificatetemplates = js.native
