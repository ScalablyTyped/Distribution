...
trait SchemaCertificate extends StObject {
  ...
  /**
    ...
    */
  var certificateTemplate: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var issuerCertificateAuthority: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var subjectMode: js.UndefOr[String | Null] = js.undefined
...
object SchemaCertificate {
  ...
  extension [Self <: SchemaCertificate](x: Self) {
    ...
    inline def setCertificateTemplateNull: Self = StObject.set(x, "certificateTemplate", null)
    ...
    inline def setIssuerCertificateAuthorityNull: Self = StObject.set(x, "issuerCertificateAuthority", null)
    ...
    inline def setSubjectModeNull: Self = StObject.set(x, "subjectMode", null)
