...
trait SchemaRevokeCertificateRequest extends StObject {
...
object SchemaRevokeCertificateRequest {
  
  inline def apply(): SchemaRevokeCertificateRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaRevokeCertificateRequest]
  }
  
  extension [Self <: SchemaRevokeCertificateRequest](x: Self) {
