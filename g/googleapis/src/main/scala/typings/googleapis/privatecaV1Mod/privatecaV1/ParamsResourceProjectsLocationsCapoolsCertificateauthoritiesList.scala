...
trait ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesList
  extends StObject
...
object ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesList {
  
  inline def apply(): ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesList](x: Self) {
