...
trait ParamsResourceProjectsLocationsCapoolsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsCapoolsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsCapoolsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCapoolsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCapoolsGetiampolicy](x: Self) {
