...
trait ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesCreate
  extends StObject
...
object ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCapoolsCertificateauthoritiesCreate](x: Self) {
