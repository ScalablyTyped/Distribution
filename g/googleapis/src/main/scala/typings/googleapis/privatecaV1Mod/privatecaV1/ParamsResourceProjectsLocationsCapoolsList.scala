...
trait ParamsResourceProjectsLocationsCapoolsList
  extends StObject
...
object ParamsResourceProjectsLocationsCapoolsList {
  
  inline def apply(): ParamsResourceProjectsLocationsCapoolsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCapoolsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCapoolsList](x: Self) {
