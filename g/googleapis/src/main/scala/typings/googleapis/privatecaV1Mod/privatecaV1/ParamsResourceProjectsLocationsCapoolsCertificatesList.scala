...
trait ParamsResourceProjectsLocationsCapoolsCertificatesList
  extends StObject
...
object ParamsResourceProjectsLocationsCapoolsCertificatesList {
  
  inline def apply(): ParamsResourceProjectsLocationsCapoolsCertificatesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCapoolsCertificatesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCapoolsCertificatesList](x: Self) {
