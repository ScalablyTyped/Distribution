...
trait SchemaX509Parameters extends StObject {
...
object SchemaX509Parameters {
  
  inline def apply(): SchemaX509Parameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaX509Parameters]
  }
  
  extension [Self <: SchemaX509Parameters](x: Self) {
