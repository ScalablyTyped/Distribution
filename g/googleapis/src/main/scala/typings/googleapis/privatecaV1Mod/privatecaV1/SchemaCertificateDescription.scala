...
trait SchemaCertificateDescription extends StObject {
  ...
  /**
    ...
    */
  var x509Description: js.UndefOr[SchemaX509Parameters] = js.undefined
}
object SchemaCertificateDescription {
  ...
  extension [Self <: SchemaCertificateDescription](x: Self) {
    ...
    inline def setX509Description(value: SchemaX509Parameters): Self = StObject.set(x, "x509Description", value.asInstanceOf[js.Any])
