...
trait ParamsResourceProjectsLocationsCapoolsPatch
  extends StObject
...
object ParamsResourceProjectsLocationsCapoolsPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsCapoolsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCapoolsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCapoolsPatch](x: Self) {
