...
object SchemaGoogleCloudVisionV1p3beta1ProductSearchResults {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p3beta1ProductSearchResults](x: Self) {
    ...
    inline def setProductGroupedResultsVarargs(value: SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult*): Self = StObject.set(x, "productGroupedResults", js.Array(value :_*))
    ...
    inline def setResultsVarargs(value: SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsResult*): Self = StObject.set(x, "results", js.Array(value :_*))
  }
}
