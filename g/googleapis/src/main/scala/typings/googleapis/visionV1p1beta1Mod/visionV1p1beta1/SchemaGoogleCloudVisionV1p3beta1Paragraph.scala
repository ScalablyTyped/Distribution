...
trait SchemaGoogleCloudVisionV1p3beta1Paragraph extends StObject {
  ...
  /**
    ...
    */
  var words: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p3beta1Word]] = js.undefined
}
object SchemaGoogleCloudVisionV1p3beta1Paragraph {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p3beta1Paragraph](x: Self) {
    ...
    inline def setWordsVarargs(value: SchemaGoogleCloudVisionV1p3beta1Word*): Self = StObject.set(x, "words", js.Array(value*))
  }
}
