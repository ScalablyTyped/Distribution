...
object SchemaGoogleCloudVisionV1p3beta1BatchOperationMetadata {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1BatchOperationMetadataMutableBuilder[Self <: SchemaGoogleCloudVisionV1p3beta1BatchOperationMetadata] (val x: Self) extends AnyVal {
