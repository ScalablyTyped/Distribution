...
object SchemaGoogleCloudVisionV1p2beta1AnnotateFileResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1AnnotateFileResponseOps[Self <: SchemaGoogleCloudVisionV1p2beta1AnnotateFileResponse] (val x: Self) extends AnyVal {
    @scala.inline
