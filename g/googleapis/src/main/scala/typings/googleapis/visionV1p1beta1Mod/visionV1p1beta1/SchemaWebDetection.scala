...
object SchemaWebDetection {
  ...
  extension [Self <: SchemaWebDetection](x: Self) {
    ...
    inline def setBestGuessLabelsVarargs(value: SchemaWebLabel*): Self = StObject.set(x, "bestGuessLabels", js.Array(value :_*))
    ...
    inline def setPagesWithMatchingImagesVarargs(value: SchemaWebPage*): Self = StObject.set(x, "pagesWithMatchingImages", js.Array(value :_*))
    ...
    inline def setVisuallySimilarImagesVarargs(value: SchemaWebImage*): Self = StObject.set(x, "visuallySimilarImages", js.Array(value :_*))
    ...
    inline def setWebEntitiesVarargs(value: SchemaWebEntity*): Self = StObject.set(x, "webEntities", js.Array(value :_*))
  }
}
