...
object SchemaGoogleCloudVisionV1p3beta1WebDetection {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p3beta1WebDetection](x: Self) {
    ...
    inline def setBestGuessLabelsVarargs(value: SchemaGoogleCloudVisionV1p3beta1WebDetectionWebLabel*): Self = StObject.set(x, "bestGuessLabels", js.Array(value :_*))
    ...
    inline def setFullMatchingImagesVarargs(value: SchemaGoogleCloudVisionV1p3beta1WebDetectionWebImage*): Self = StObject.set(x, "fullMatchingImages", js.Array(value :_*))
    ...
    inline def setPagesWithMatchingImagesVarargs(value: SchemaGoogleCloudVisionV1p3beta1WebDetectionWebPage*): Self = StObject.set(x, "pagesWithMatchingImages", js.Array(value :_*))
    ...
    inline def setPartialMatchingImagesVarargs(value: SchemaGoogleCloudVisionV1p3beta1WebDetectionWebImage*): Self = StObject.set(x, "partialMatchingImages", js.Array(value :_*))
    ...
    inline def setVisuallySimilarImagesVarargs(value: SchemaGoogleCloudVisionV1p3beta1WebDetectionWebImage*): Self = StObject.set(x, "visuallySimilarImages", js.Array(value :_*))
    ...
    inline def setWebEntitiesVarargs(value: SchemaGoogleCloudVisionV1p3beta1WebDetectionWebEntity*): Self = StObject.set(x, "webEntities", js.Array(value :_*))
  }
}
