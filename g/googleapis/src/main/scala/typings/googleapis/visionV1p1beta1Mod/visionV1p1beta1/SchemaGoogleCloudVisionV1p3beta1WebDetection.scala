...
object SchemaGoogleCloudVisionV1p3beta1WebDetection {
  @scala.inline
  def apply(
    bestGuessLabels: js.Array[SchemaGoogleCloudVisionV1p3beta1WebDetectionWebLabel] = null,
    fullMatchingImages: js.Array[SchemaGoogleCloudVisionV1p3beta1WebDetectionWebImage] = null,
    pagesWithMatchingImages: js.Array[SchemaGoogleCloudVisionV1p3beta1WebDetectionWebPage] = null,
    partialMatchingImages: js.Array[SchemaGoogleCloudVisionV1p3beta1WebDetectionWebImage] = null,
    visuallySimilarImages: js.Array[SchemaGoogleCloudVisionV1p3beta1WebDetectionWebImage] = null,
    webEntities: js.Array[SchemaGoogleCloudVisionV1p3beta1WebDetectionWebEntity] = null
  ): SchemaGoogleCloudVisionV1p3beta1WebDetection = {
