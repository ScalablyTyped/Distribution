...
trait SchemaGoogleCloudVisionV1p1beta1ImageContext extends StObject {
  ...
  /**
    ...
    */
  var textDetectionParams: js.UndefOr[SchemaGoogleCloudVisionV1p1beta1TextDetectionParams] = js.undefined
...
object SchemaGoogleCloudVisionV1p1beta1ImageContext {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p1beta1ImageContext = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1ImageContext]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p1beta1ImageContext](x: Self) {
    
    inline def setCropHintsParams(value: SchemaGoogleCloudVisionV1p1beta1CropHintsParams): Self = StObject.set(x, "cropHintsParams", value.asInstanceOf[js.Any])
    ...
    inline def setLatLongRect(value: SchemaGoogleCloudVisionV1p1beta1LatLongRect): Self = StObject.set(x, "latLongRect", value.asInstanceOf[js.Any])
    
    inline def setLatLongRectUndefined: Self = StObject.set(x, "latLongRect", js.undefined)
    
    inline def setProductSearchParams(value: SchemaGoogleCloudVisionV1p1beta1ProductSearchParams): Self = StObject.set(x, "productSearchParams", value.asInstanceOf[js.Any])
    
    inline def setProductSearchParamsUndefined: Self = StObject.set(x, "productSearchParams", js.undefined)
    
    inline def setTextDetectionParams(value: SchemaGoogleCloudVisionV1p1beta1TextDetectionParams): Self = StObject.set(x, "textDetectionParams", value.asInstanceOf[js.Any])
    
    inline def setTextDetectionParamsUndefined: Self = StObject.set(x, "textDetectionParams", js.undefined)
    
    inline def setWebDetectionParams(value: SchemaGoogleCloudVisionV1p1beta1WebDetectionParams): Self = StObject.set(x, "webDetectionParams", value.asInstanceOf[js.Any])
