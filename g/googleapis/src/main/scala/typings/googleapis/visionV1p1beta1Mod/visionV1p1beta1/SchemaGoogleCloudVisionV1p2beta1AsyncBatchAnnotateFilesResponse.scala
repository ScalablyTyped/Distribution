...
object SchemaGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesResponse {
  ...
  implicit class SchemaGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesResponseOps[Self <: SchemaGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponsesVarargs(value: SchemaGoogleCloudVisionV1p2beta1AsyncAnnotateFileResponse*): Self = this.set("responses", js.Array(value :_*))
    @scala.inline
    def setResponses(value: js.Array[SchemaGoogleCloudVisionV1p2beta1AsyncAnnotateFileResponse]): Self = this.set("responses", value.asInstanceOf[js.Any])
    @scala.inline
