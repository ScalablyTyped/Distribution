...
object SchemaGoogleCloudVisionV1p2beta1OutputConfig {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p2beta1OutputConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1OutputConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p2beta1OutputConfig](x: Self) {
    
    inline def setBatchSize(value: Double): Self = StObject.set(x, "batchSize", value.asInstanceOf[js.Any])
    
    inline def setBatchSizeUndefined: Self = StObject.set(x, "batchSize", js.undefined)
    
    inline def setGcsDestination(value: SchemaGoogleCloudVisionV1p2beta1GcsDestination): Self = StObject.set(x, "gcsDestination", value.asInstanceOf[js.Any])
