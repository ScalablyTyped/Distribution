...
object SchemaGoogleCloudVisionV1p1beta1WebDetectionWebEntity {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1WebDetectionWebEntityOps[Self <: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebEntity] (val x: Self) extends AnyVal {
    @scala.inline
