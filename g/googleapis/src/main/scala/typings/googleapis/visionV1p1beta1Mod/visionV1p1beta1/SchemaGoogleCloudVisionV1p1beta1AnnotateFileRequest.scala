...
trait SchemaGoogleCloudVisionV1p1beta1AnnotateFileRequest extends StObject {
...
object SchemaGoogleCloudVisionV1p1beta1AnnotateFileRequest {
  
  inline def apply(): SchemaGoogleCloudVisionV1p1beta1AnnotateFileRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1AnnotateFileRequest]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p1beta1AnnotateFileRequest](x: Self) {
