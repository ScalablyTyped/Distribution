...
@JSImport("googleapis/build/src/apis/vision/v1p1beta1", "vision_v1p1beta1.Resource$Projects$Files")
@js.native
open class ResourceProjectsFiles protected () extends StObject {
  ...
  def annotate(params: ParamsResourceProjectsFilesAnnotate): GaxiosPromise[SchemaGoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse] = js.native
  def annotate(
  ...
  def annotate(params: ParamsResourceProjectsFilesAnnotate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse] = js.native
  def annotate(
    params: ParamsResourceProjectsFilesAnnotate,
