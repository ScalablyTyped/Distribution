...
object SchemaGoogleCloudVisionV1p3beta1EntityAnnotation {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p3beta1EntityAnnotation](x: Self) {
    ...
    inline def setLocationsVarargs(value: SchemaGoogleCloudVisionV1p3beta1LocationInfo*): Self = StObject.set(x, "locations", js.Array(value*))
    ...
    inline def setPropertiesVarargs(value: SchemaGoogleCloudVisionV1p3beta1Property*): Self = StObject.set(x, "properties", js.Array(value*))
