...
object SchemaGoogleCloudVisionV1p4beta1LocalizedObjectAnnotation {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p4beta1LocalizedObjectAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p4beta1LocalizedObjectAnnotation]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p4beta1LocalizedObjectAnnotation](x: Self) {
