...
/**
  ...
  */
trait SchemaGoogleCloudVisionV1p4beta1LocalizedObjectAnnotation extends StObject {
...
object SchemaGoogleCloudVisionV1p4beta1LocalizedObjectAnnotation {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p4beta1LocalizedObjectAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p4beta1LocalizedObjectAnnotation]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1LocalizedObjectAnnotationMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1LocalizedObjectAnnotation] (val x: Self) extends AnyVal {
