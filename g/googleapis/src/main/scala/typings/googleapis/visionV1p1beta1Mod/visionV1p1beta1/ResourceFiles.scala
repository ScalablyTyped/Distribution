...
open class ResourceFiles protected () extends StObject {
  ...
  def annotate(params: ParamsResourceFilesAnnotate): GaxiosPromise[SchemaGoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse] = js.native
  def annotate(
  ...
  def annotate(params: ParamsResourceFilesAnnotate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse] = js.native
  def annotate(
    params: ParamsResourceFilesAnnotate,
