...
object SchemaGoogleCloudVisionV1p4beta1ProductSearchResults {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p4beta1ProductSearchResults](x: Self) {
    ...
    inline def setProductGroupedResultsVarargs(value: SchemaGoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult*): Self = StObject.set(x, "productGroupedResults", js.Array(value*))
