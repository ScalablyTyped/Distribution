...
object SchemaGoogleCloudVisionV1p4beta1ProductSearchResults {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1ProductSearchResultsMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1ProductSearchResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProductGroupedResults(value: js.Array[SchemaGoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult]): Self = StObject.set(x, "productGroupedResults", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProductGroupedResultsUndefined: Self = StObject.set(x, "productGroupedResults", js.undefined)
    
    @scala.inline
    def setProductGroupedResultsVarargs(value: SchemaGoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult*): Self = StObject.set(x, "productGroupedResults", js.Array(value :_*))
