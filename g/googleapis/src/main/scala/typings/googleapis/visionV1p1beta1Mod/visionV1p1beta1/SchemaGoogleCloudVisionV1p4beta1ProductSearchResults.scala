...
object SchemaGoogleCloudVisionV1p4beta1ProductSearchResults {
  ...
  implicit class SchemaGoogleCloudVisionV1p4beta1ProductSearchResultsOps[Self <: SchemaGoogleCloudVisionV1p4beta1ProductSearchResults] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProductGroupedResultsVarargs(value: SchemaGoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult*): Self = this.set("productGroupedResults", js.Array(value :_*))
    
    @scala.inline
    def setProductGroupedResults(value: js.Array[SchemaGoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult]): Self = this.set("productGroupedResults", value.asInstanceOf[js.Any])
