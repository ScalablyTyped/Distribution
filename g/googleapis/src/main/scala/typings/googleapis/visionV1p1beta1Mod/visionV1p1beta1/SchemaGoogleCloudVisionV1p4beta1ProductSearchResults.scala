...
object SchemaGoogleCloudVisionV1p4beta1ProductSearchResults {
  ...
  def apply(
    ...
    productGroupedResults: js.Array[SchemaGoogleCloudVisionV1p4beta1ProductSearchResultsGroupedResult] = null,
    results: js.Array[SchemaGoogleCloudVisionV1p4beta1ProductSearchResultsResult] = null
  ): SchemaGoogleCloudVisionV1p4beta1ProductSearchResults = {
