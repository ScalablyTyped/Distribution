...
object SchemaGoogleCloudVisionV1p2beta1ProductSearchResultsResult {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p2beta1ProductSearchResultsResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1ProductSearchResultsResult]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p2beta1ProductSearchResultsResult](x: Self) {
    
    inline def setImage(value: String): Self = StObject.set(x, "image", value.asInstanceOf[js.Any])
    
    inline def setImageUndefined: Self = StObject.set(x, "image", js.undefined)
    
    inline def setProduct(value: SchemaGoogleCloudVisionV1p2beta1Product): Self = StObject.set(x, "product", value.asInstanceOf[js.Any])
