...
trait SchemaGoogleCloudVisionV1p3beta1FaceAnnotation extends StObject {
  ...
  /**
    ...
    */
  var fdBoundingPoly: js.UndefOr[SchemaGoogleCloudVisionV1p3beta1BoundingPoly] = js.undefined
  ...
  /**
    ...
    */
  var landmarks: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p3beta1FaceAnnotationLandmark]] = js.undefined
...
object SchemaGoogleCloudVisionV1p3beta1FaceAnnotation {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p3beta1FaceAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p3beta1FaceAnnotation]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p3beta1FaceAnnotation](x: Self) {
    ...
    inline def setFdBoundingPoly(value: SchemaGoogleCloudVisionV1p3beta1BoundingPoly): Self = StObject.set(x, "fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    inline def setLandmarks(value: js.Array[SchemaGoogleCloudVisionV1p3beta1FaceAnnotationLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    
    inline def setLandmarksUndefined: Self = StObject.set(x, "landmarks", js.undefined)
    
    inline def setLandmarksVarargs(value: SchemaGoogleCloudVisionV1p3beta1FaceAnnotationLandmark*): Self = StObject.set(x, "landmarks", js.Array(value :_*))
