...
@JSImport("googleapis/build/src/apis/vision/v1p1beta1", "vision_v1p1beta1.Resource$Projects$Locations$Images")
@js.native
open class ResourceProjectsLocationsImages protected () extends StObject {
  ...
  def annotate(params: ParamsResourceProjectsLocationsImagesAnnotate): GaxiosPromise[SchemaGoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse] = js.native
  def annotate(
  ...
  def annotate(params: ParamsResourceProjectsLocationsImagesAnnotate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse] = js.native
  def annotate(
    params: ParamsResourceProjectsLocationsImagesAnnotate,
