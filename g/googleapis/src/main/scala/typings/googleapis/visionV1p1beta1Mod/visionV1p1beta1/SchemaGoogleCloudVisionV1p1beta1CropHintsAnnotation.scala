...
object SchemaGoogleCloudVisionV1p1beta1CropHintsAnnotation {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1CropHintsAnnotationMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1CropHintsAnnotation] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setCropHints(value: js.Array[SchemaGoogleCloudVisionV1p1beta1CropHint]): Self = StObject.set(x, "cropHints", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCropHintsUndefined: Self = StObject.set(x, "cropHints", js.undefined)
    
    @scala.inline
    def setCropHintsVarargs(value: SchemaGoogleCloudVisionV1p1beta1CropHint*): Self = StObject.set(x, "cropHints", js.Array(value :_*))
  }
}
