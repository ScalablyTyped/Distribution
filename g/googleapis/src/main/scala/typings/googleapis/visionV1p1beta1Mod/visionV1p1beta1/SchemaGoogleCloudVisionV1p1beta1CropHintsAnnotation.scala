...
object SchemaGoogleCloudVisionV1p1beta1CropHintsAnnotation {
  ...
  implicit class SchemaGoogleCloudVisionV1p1beta1CropHintsAnnotationOps[Self <: SchemaGoogleCloudVisionV1p1beta1CropHintsAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCropHintsVarargs(value: SchemaGoogleCloudVisionV1p1beta1CropHint*): Self = this.set("cropHints", js.Array(value :_*))
    
    @scala.inline
    def setCropHints(value: js.Array[SchemaGoogleCloudVisionV1p1beta1CropHint]): Self = this.set("cropHints", value.asInstanceOf[js.Any])
