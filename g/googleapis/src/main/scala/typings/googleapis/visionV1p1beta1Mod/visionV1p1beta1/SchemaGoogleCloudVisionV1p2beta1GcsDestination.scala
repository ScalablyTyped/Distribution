...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1GcsDestination extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p2beta1GcsDestination {
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p2beta1GcsDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1GcsDestination]
  }
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1GcsDestinationOps[Self <: SchemaGoogleCloudVisionV1p2beta1GcsDestination] (val x: Self) extends AnyVal {
    @scala.inline
