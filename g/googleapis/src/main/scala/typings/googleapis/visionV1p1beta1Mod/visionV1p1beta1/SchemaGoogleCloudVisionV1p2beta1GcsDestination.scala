...
object SchemaGoogleCloudVisionV1p2beta1GcsDestination {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1GcsDestinationMutableBuilder[Self <: SchemaGoogleCloudVisionV1p2beta1GcsDestination] (val x: Self) extends AnyVal {
