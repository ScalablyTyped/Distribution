...
object SchemaGoogleCloudVisionV1p3beta1BoundingPoly {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p3beta1BoundingPoly = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p3beta1BoundingPoly]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p3beta1BoundingPoly](x: Self) {
    
    inline def setNormalizedVertices(value: js.Array[SchemaGoogleCloudVisionV1p3beta1NormalizedVertex]): Self = StObject.set(x, "normalizedVertices", value.asInstanceOf[js.Any])
