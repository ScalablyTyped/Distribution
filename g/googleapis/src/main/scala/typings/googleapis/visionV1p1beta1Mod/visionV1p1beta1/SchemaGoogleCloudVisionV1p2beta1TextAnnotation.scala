...
trait SchemaGoogleCloudVisionV1p2beta1TextAnnotation extends StObject {
  ...
  /**
    ...
    */
  var pages: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p2beta1Page]] = js.undefined
...
object SchemaGoogleCloudVisionV1p2beta1TextAnnotation {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p2beta1TextAnnotation](x: Self) {
    ...
    inline def setPagesVarargs(value: SchemaGoogleCloudVisionV1p2beta1Page*): Self = StObject.set(x, "pages", js.Array(value*))
