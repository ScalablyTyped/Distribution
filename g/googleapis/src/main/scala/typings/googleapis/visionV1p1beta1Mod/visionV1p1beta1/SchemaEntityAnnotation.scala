...
object SchemaEntityAnnotation {
  ...
  inline def apply(): SchemaEntityAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaEntityAnnotation]
  }
  
  extension [Self <: SchemaEntityAnnotation](x: Self) {
    ...
    inline def setLocations(value: js.Array[SchemaLocationInfo]): Self = StObject.set(x, "locations", value.asInstanceOf[js.Any])
    
    inline def setLocationsUndefined: Self = StObject.set(x, "locations", js.undefined)
    
    inline def setLocationsVarargs(value: SchemaLocationInfo*): Self = StObject.set(x, "locations", js.Array(value :_*))
