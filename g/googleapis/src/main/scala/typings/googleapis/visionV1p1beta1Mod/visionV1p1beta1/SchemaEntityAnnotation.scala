...
object SchemaEntityAnnotation {
  ...
  @scala.inline
  implicit class SchemaEntityAnnotationOps[Self <: SchemaEntityAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setLocationsVarargs(value: SchemaLocationInfo*): Self = this.set("locations", js.Array(value :_*))
    @scala.inline
    def setLocations(value: js.Array[SchemaLocationInfo]): Self = this.set("locations", value.asInstanceOf[js.Any])
    @scala.inline
