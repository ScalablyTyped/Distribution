...
object SchemaGoogleCloudVisionV1p2beta1ProductSearchResults {
  ...
  def apply(
    ...
    productGroupedResults: js.Array[SchemaGoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult] = null,
    results: js.Array[SchemaGoogleCloudVisionV1p2beta1ProductSearchResultsResult] = null
  ): SchemaGoogleCloudVisionV1p2beta1ProductSearchResults = {
