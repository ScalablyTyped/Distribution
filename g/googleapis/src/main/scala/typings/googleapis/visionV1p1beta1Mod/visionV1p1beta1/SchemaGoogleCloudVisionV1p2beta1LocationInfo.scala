...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1LocationInfo extends StObject {
...
object SchemaGoogleCloudVisionV1p2beta1LocationInfo {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p2beta1LocationInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1LocationInfo]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1LocationInfoMutableBuilder[Self <: SchemaGoogleCloudVisionV1p2beta1LocationInfo] (val x: Self) extends AnyVal {
