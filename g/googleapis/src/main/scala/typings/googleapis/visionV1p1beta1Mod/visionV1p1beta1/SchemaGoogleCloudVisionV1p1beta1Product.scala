...
object SchemaGoogleCloudVisionV1p1beta1Product {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1ProductOps[Self <: SchemaGoogleCloudVisionV1p1beta1Product] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProductLabelsVarargs(value: SchemaGoogleCloudVisionV1p1beta1ProductKeyValue*): Self = this.set("productLabels", js.Array(value :_*))
    
    @scala.inline
    def setProductLabels(value: js.Array[SchemaGoogleCloudVisionV1p1beta1ProductKeyValue]): Self = this.set("productLabels", value.asInstanceOf[js.Any])
