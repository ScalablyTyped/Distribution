...
/**
  ...
  */
trait SchemaGoogleCloudVisionV1p1beta1Product extends StObject {
  ...
  /**
    ...
    */
  var productLabels: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p1beta1ProductKeyValue]] = js.undefined
}
object SchemaGoogleCloudVisionV1p1beta1Product {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p1beta1Product = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1Product]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1ProductMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1Product] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProductLabels(value: js.Array[SchemaGoogleCloudVisionV1p1beta1ProductKeyValue]): Self = StObject.set(x, "productLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProductLabelsUndefined: Self = StObject.set(x, "productLabels", js.undefined)
    
    @scala.inline
    def setProductLabelsVarargs(value: SchemaGoogleCloudVisionV1p1beta1ProductKeyValue*): Self = StObject.set(x, "productLabels", js.Array(value :_*))
  }
}
