...
@js.native
class ResourceActions protected () extends StObject {
  ...
  def execute(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleLongrunningOperation] = js.native
