...
object displayvideoV1beta2Mod {
  
  object displayvideoV1beta2 {
    
    @JSImport("googleapis/build/src/apis/displayvideo/v1beta2", "displayvideo_v1beta2.Displayvideo")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/displayvideo/v1beta2", "displayvideo_v1beta2.Resource$Media")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/displayvideo/v1beta2", "displayvideo_v1beta2.Resource$Sdfdownloadtasks")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/displayvideo/v1beta2", "displayvideo_v1beta2.Resource$Sdfdownloadtasks$Operations")
    @js.native
