...
trait ParamsResourceProjectsGithubenterpriseconfigsDelete
  extends StObject
...
object ParamsResourceProjectsGithubenterpriseconfigsDelete {
  
  inline def apply(): ParamsResourceProjectsGithubenterpriseconfigsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsGithubenterpriseconfigsDelete]
  }
  
  extension [Self <: ParamsResourceProjectsGithubenterpriseconfigsDelete](x: Self) {
