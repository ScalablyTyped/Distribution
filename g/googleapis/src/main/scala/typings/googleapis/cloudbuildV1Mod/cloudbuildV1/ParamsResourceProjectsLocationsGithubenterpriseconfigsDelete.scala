...
trait ParamsResourceProjectsLocationsGithubenterpriseconfigsDelete
  extends StObject
...
object ParamsResourceProjectsLocationsGithubenterpriseconfigsDelete {
  
  inline def apply(): ParamsResourceProjectsLocationsGithubenterpriseconfigsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGithubenterpriseconfigsDelete]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGithubenterpriseconfigsDelete](x: Self) {
