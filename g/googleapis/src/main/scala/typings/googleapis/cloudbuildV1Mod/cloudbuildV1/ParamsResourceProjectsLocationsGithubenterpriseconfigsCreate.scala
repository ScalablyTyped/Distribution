...
trait ParamsResourceProjectsLocationsGithubenterpriseconfigsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsGithubenterpriseconfigsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsGithubenterpriseconfigsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGithubenterpriseconfigsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGithubenterpriseconfigsCreate](x: Self) {
