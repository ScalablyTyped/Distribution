...
trait SchemaInlineSecret extends StObject {
...
object SchemaInlineSecret {
  
  inline def apply(): SchemaInlineSecret = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInlineSecret]
  }
  
  extension [Self <: SchemaInlineSecret](x: Self) {
