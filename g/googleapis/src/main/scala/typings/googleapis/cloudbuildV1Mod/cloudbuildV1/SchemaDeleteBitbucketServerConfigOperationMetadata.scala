...
trait SchemaDeleteBitbucketServerConfigOperationMetadata extends StObject {
...
object SchemaDeleteBitbucketServerConfigOperationMetadata {
  
  inline def apply(): SchemaDeleteBitbucketServerConfigOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDeleteBitbucketServerConfigOperationMetadata]
  }
  
  extension [Self <: SchemaDeleteBitbucketServerConfigOperationMetadata](x: Self) {
