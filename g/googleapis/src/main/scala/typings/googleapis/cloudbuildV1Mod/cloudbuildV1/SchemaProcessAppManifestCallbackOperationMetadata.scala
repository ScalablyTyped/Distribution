...
trait SchemaProcessAppManifestCallbackOperationMetadata extends StObject {
...
object SchemaProcessAppManifestCallbackOperationMetadata {
  
  inline def apply(): SchemaProcessAppManifestCallbackOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaProcessAppManifestCallbackOperationMetadata]
  }
  
  extension [Self <: SchemaProcessAppManifestCallbackOperationMetadata](x: Self) {
