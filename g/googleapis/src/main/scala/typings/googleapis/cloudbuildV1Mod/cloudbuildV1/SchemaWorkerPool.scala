...
trait SchemaWorkerPool extends StObject {
  ...
  /**
    ...
    */
  var privatePoolV1Config: js.UndefOr[SchemaPrivatePoolV1Config] = js.undefined
...
object SchemaWorkerPool {
  ...
  extension [Self <: SchemaWorkerPool](x: Self) {
    ...
    inline def setPrivatePoolV1Config(value: SchemaPrivatePoolV1Config): Self = StObject.set(x, "privatePoolV1Config", value.asInstanceOf[js.Any])
