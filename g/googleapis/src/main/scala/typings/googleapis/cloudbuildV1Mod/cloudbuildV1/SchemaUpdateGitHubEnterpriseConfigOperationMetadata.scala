...
trait SchemaUpdateGitHubEnterpriseConfigOperationMetadata extends StObject {
...
object SchemaUpdateGitHubEnterpriseConfigOperationMetadata {
  
  inline def apply(): SchemaUpdateGitHubEnterpriseConfigOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaUpdateGitHubEnterpriseConfigOperationMetadata]
  }
  
  extension [Self <: SchemaUpdateGitHubEnterpriseConfigOperationMetadata](x: Self) {
