...
trait ParamsResourceProjectsGithubenterpriseconfigsPatch
  extends StObject
...
object ParamsResourceProjectsGithubenterpriseconfigsPatch {
  
  inline def apply(): ParamsResourceProjectsGithubenterpriseconfigsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsGithubenterpriseconfigsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsGithubenterpriseconfigsPatch](x: Self) {
