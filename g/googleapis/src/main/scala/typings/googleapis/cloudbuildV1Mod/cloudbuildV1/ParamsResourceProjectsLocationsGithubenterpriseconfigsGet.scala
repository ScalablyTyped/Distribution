...
trait ParamsResourceProjectsLocationsGithubenterpriseconfigsGet
  extends StObject
...
object ParamsResourceProjectsLocationsGithubenterpriseconfigsGet {
  
  inline def apply(): ParamsResourceProjectsLocationsGithubenterpriseconfigsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGithubenterpriseconfigsGet]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGithubenterpriseconfigsGet](x: Self) {
