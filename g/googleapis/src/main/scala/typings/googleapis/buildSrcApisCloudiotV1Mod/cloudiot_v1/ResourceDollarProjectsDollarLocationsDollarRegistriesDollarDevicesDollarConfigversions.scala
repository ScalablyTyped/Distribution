...
@js.native
class ResourceDollarProjectsDollarLocationsDollarRegistriesDollarDevicesDollarConfigversions protected () extends js.Object {
  ...
  def list(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarRegistriesDollarDevicesDollarConfigversionsDollarList
