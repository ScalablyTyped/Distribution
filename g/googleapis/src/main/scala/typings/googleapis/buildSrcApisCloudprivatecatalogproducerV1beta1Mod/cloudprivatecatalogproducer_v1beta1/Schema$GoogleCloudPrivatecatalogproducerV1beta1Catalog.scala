...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudPrivatecatalogproducerV1beta1Catalog extends js.Object {
  /**
...
object Schema$GoogleCloudPrivatecatalogproducerV1beta1Catalog {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$GoogleCloudPrivatecatalogproducerV1beta1Catalog]
  }
}
