...
trait SchemaAuthorizedCertificate extends StObject {
  ...
  /**
    ...
    */
  var domainMappingsCount: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var visibleDomainMappings: js.UndefOr[js.Array[String] | Null] = js.undefined
}
object SchemaAuthorizedCertificate {
  ...
  extension [Self <: SchemaAuthorizedCertificate](x: Self) {
    ...
    inline def setDomainMappingsCountNull: Self = StObject.set(x, "domainMappingsCount", null)
    ...
    inline def setVisibleDomainMappingsNull: Self = StObject.set(x, "visibleDomainMappings", null)
