...
object ParamsResourceAppsRepair {
  ...
  @scala.inline
  implicit class ParamsResourceAppsRepairOps[Self <: ParamsResourceAppsRepair] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaRepairApplicationRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
