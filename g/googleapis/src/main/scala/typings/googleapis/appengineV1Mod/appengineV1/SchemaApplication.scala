...
object SchemaApplication {
  ...
  implicit class SchemaApplicationOps[Self <: SchemaApplication] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDispatchRulesVarargs(value: SchemaUrlDispatchRule*): Self = this.set("dispatchRules", js.Array(value :_*))
    
    @scala.inline
    def setDispatchRules(value: js.Array[SchemaUrlDispatchRule]): Self = this.set("dispatchRules", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDispatchRules: Self = this.set("dispatchRules", js.undefined)
    
    @scala.inline
    def setFeatureSettings(value: SchemaFeatureSettings): Self = this.set("featureSettings", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIap(value: SchemaIdentityAwareProxy): Self = this.set("iap", value.asInstanceOf[js.Any])
