...
object ParamsResourceAppsFirewallIngressrulesBatchupdate {
  ...
  @scala.inline
  implicit class ParamsResourceAppsFirewallIngressrulesBatchupdateMutableBuilder[Self <: ParamsResourceAppsFirewallIngressrulesBatchupdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchUpdateIngressRulesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
