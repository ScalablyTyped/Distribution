...
object ParamsResourceAppsFirewallIngressrulesPatch {
  ...
  def apply(
    ...
    fields: String = null,
    ingressRulesId: String = null,
    key: String = null,
    oauth_token: String = null,
    prettyPrint: js.UndefOr[Boolean] = js.undefined,
    quotaUser: String = null,
    requestBody: SchemaFirewallRule = null,
    updateMask: String = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceAppsFirewallIngressrulesPatch = {
    ...
    if (ingressRulesId != null) __obj.updateDynamic("ingressRulesId")(ingressRulesId.asInstanceOf[js.Any])
