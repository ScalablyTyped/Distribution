...
/**
  ...
  */
@js.native
trait Schema$EndpointsApiService extends js.Object {
  /**
...
object Schema$EndpointsApiService {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$EndpointsApiService]
  }
}
