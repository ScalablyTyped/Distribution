...
@js.native
class ResourceDollarProvidersDollarNotesDollarOccurrences protected () extends js.Object {
  ...
  def list(params: ParamsDollarResourceDollarProvidersDollarNotesDollarOccurrencesDollarList): GaxiosPromise[Schema$ListNoteOccurrencesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProvidersDollarNotesDollarOccurrencesDollarList,
