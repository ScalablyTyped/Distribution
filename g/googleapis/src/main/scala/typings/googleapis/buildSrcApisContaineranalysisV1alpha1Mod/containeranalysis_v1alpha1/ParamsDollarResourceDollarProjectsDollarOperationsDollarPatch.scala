...
@js.native
trait ParamsDollarResourceDollarProjectsDollarOperationsDollarPatch extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$UpdateOperationRequest] = js.native
}
