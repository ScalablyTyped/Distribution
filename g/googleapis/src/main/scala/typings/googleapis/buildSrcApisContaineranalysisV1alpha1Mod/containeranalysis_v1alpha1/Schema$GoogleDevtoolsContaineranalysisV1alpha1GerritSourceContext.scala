...
/**
  ...
  */
@js.native
trait Schema$GoogleDevtoolsContaineranalysisV1alpha1GerritSourceContext extends js.Object {
  /**
...
object Schema$GoogleDevtoolsContaineranalysisV1alpha1GerritSourceContext {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleDevtoolsContaineranalysisV1alpha1GerritSourceContext = {
    ...
    __obj.asInstanceOf[Schema$GoogleDevtoolsContaineranalysisV1alpha1GerritSourceContext]
  }
}
