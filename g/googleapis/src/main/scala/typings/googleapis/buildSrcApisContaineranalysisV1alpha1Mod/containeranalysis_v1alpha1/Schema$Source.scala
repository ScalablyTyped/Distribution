...
trait Schema$Source extends js.Object {
  /**
    ...
    */
  var additionalContexts: js.UndefOr[js.Array[Schema$GoogleDevtoolsContaineranalysisV1alpha1SourceContext]] = js.native
  /**
    * If provided, the input binary artifacts for the build came from this
    * location.
    */
  var artifactStorageSource: js.UndefOr[Schema$StorageSource] = js.native
  /**
    * If provided, the source code used for the build came from this location.
    */
  var context: js.UndefOr[Schema$GoogleDevtoolsContaineranalysisV1alpha1SourceContext] = js.native
  /**
...
object Schema$Source {
  @scala.inline
  def apply(
    additionalContexts: js.Array[Schema$GoogleDevtoolsContaineranalysisV1alpha1SourceContext] = null,
    artifactStorageSource: Schema$StorageSource = null,
    context: Schema$GoogleDevtoolsContaineranalysisV1alpha1SourceContext = null,
    fileHashes: StringDictionary[Schema$FileHashes] = null,
    repoSource: Schema$RepoSource = null,
    storageSource: Schema$StorageSource = null
  ): Schema$Source = {
