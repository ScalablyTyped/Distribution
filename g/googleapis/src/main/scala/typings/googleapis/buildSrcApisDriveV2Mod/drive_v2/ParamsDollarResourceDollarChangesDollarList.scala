...
@js.native
trait ParamsDollarResourceDollarChangesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarChangesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarChangesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChangesDollarList]
  }
}
