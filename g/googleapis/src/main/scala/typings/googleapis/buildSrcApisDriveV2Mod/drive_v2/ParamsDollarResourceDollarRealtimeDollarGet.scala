...
@js.native
trait ParamsDollarResourceDollarRealtimeDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRealtimeDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarRealtimeDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRealtimeDollarGet]
  }
}
