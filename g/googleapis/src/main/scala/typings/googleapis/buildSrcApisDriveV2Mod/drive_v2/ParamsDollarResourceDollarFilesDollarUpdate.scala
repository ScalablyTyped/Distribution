...
@js.native
trait ParamsDollarResourceDollarFilesDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarFilesDollarUpdate {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarFilesDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarFilesDollarUpdate]
  }
}
