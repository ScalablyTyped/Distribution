...
@js.native
trait ParamsDollarResourceDollarPermissionsDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPermissionsDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPermissionsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPermissionsDollarPatch]
  }
}
