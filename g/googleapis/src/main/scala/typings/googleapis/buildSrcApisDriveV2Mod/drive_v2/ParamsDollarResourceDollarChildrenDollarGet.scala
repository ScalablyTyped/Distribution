...
@js.native
trait ParamsDollarResourceDollarChildrenDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarChildrenDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarChildrenDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChildrenDollarGet]
  }
}
