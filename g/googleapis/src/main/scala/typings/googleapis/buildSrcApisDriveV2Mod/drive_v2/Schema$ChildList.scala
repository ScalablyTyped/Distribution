...
/**
  ...
  */
@js.native
trait Schema$ChildList extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$ChildReference]] = js.native
  /**
...
object Schema$ChildList {
  @scala.inline
  def apply(
    etag: String = null,
    items: js.Array[Schema$ChildReference] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$ChildList]
  }
}
