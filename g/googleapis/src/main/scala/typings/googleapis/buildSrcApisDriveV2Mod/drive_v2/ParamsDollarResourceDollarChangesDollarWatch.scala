...
@js.native
trait ParamsDollarResourceDollarChangesDollarWatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarChangesDollarWatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarChangesDollarWatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChangesDollarWatch]
  }
}
