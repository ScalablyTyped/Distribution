...
@js.native
trait ParamsDollarResourceDollarPermissionsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPermissionsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPermissionsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPermissionsDollarDelete]
  }
}
