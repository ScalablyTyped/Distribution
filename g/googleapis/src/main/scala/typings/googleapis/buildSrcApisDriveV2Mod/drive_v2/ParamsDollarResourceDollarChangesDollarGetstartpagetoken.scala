...
@js.native
trait ParamsDollarResourceDollarChangesDollarGetstartpagetoken extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarChangesDollarGetstartpagetoken {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarChangesDollarGetstartpagetoken = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarChangesDollarGetstartpagetoken]
  }
}
