...
@js.native
trait ParamsDollarResourceDollarRepliesDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRepliesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    replyId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarRepliesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRepliesDollarDelete]
  }
}
