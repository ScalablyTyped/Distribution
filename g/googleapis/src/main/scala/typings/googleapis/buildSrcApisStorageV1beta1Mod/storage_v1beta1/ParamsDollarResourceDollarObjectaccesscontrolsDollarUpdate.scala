...
@js.native
trait ParamsDollarResourceDollarObjectaccesscontrolsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarObjectaccesscontrolsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarObjectaccesscontrolsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarObjectaccesscontrolsDollarUpdate]
  }
}
