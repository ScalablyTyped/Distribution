...
@js.native
trait ParamsDollarResourceDollarInstallsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInstallsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarInstallsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInstallsDollarDelete]
  }
}
