...
@js.native
trait ParamsDollarResourceDollarInstallsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInstallsDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarInstallsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInstallsDollarGet]
  }
}
