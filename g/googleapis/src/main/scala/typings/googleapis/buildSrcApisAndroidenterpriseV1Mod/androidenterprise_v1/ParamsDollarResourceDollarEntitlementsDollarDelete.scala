...
@js.native
trait ParamsDollarResourceDollarEntitlementsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEntitlementsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarEntitlementsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEntitlementsDollarDelete]
  }
}
