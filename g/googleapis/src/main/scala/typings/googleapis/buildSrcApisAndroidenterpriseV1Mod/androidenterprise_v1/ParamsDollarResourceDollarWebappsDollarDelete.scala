...
@js.native
trait ParamsDollarResourceDollarWebappsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarWebappsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarWebappsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarWebappsDollarDelete]
  }
}
