...
@js.native
trait ParamsDollarResourceDollarWebappsDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarWebappsDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarWebappsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarWebappsDollarPatch]
  }
}
