...
/**
  ...
  */
@js.native
trait Schema$ProductApprovalEvent extends js.Object {
  /**
...
object Schema$ProductApprovalEvent {
  @scala.inline
  def apply(approved: String = null, productId: String = null): Schema$ProductApprovalEvent = {
    val __obj = js.Dynamic.literal()
    if (approved != null) __obj.updateDynamic("approved")(approved.asInstanceOf[js.Any])
    if (productId != null) __obj.updateDynamic("productId")(productId.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ProductApprovalEvent]
  }
}
