...
@js.native
trait ParamsDollarResourceDollarManagedconfigurationsforuserDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagedconfigurationsforuserDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarManagedconfigurationsforuserDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagedconfigurationsforuserDollarUpdate]
  }
}
