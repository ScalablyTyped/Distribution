...
@js.native
trait Schema$AutoInstallPolicy extends js.Object {
  /**
    * The constraints for auto-installing the app. You can specify a maximum of
    * one constraint.
    */
  var autoInstallConstraint: js.UndefOr[js.Array[Schema$AutoInstallConstraint]] = js.native
  /**
...
object Schema$AutoInstallPolicy {
  @scala.inline
  def apply(
    autoInstallConstraint: js.Array[Schema$AutoInstallConstraint] = null,
    autoInstallMode: String = null,
    autoInstallPriority: Int | Double = null,
    minimumVersionCode: Int | Double = null
  ): Schema$AutoInstallPolicy = {
    ...
    __obj.asInstanceOf[Schema$AutoInstallPolicy]
  }
}
