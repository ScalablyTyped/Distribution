...
@js.native
trait ParamsDollarResourceDollarManagedconfigurationsforuserDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarManagedconfigurationsforuserDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarManagedconfigurationsforuserDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarManagedconfigurationsforuserDollarDelete]
  }
}
