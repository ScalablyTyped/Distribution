...
/**
  ...
  */
@js.native
trait Schema$ProductPolicy extends js.Object {
  /**
    * The auto-install policy for the product.
    */
  var autoInstallPolicy: js.UndefOr[Schema$AutoInstallPolicy] = js.native
  /**
    * The managed configuration for the product.
    */
  var managedConfiguration: js.UndefOr[Schema$ManagedConfiguration] = js.native
  /**
...
object Schema$ProductPolicy {
  @scala.inline
  def apply(
    autoInstallPolicy: Schema$AutoInstallPolicy = null,
    managedConfiguration: Schema$ManagedConfiguration = null,
    productId: String = null,
    trackIds: js.Array[String] = null,
    tracks: js.Array[String] = null
  ): Schema$ProductPolicy = {
    ...
    __obj.asInstanceOf[Schema$ProductPolicy]
  }
}
