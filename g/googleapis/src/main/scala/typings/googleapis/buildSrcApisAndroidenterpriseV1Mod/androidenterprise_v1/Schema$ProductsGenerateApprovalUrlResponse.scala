...
@js.native
trait Schema$ProductsGenerateApprovalUrlResponse extends js.Object {
  /**
...
object Schema$ProductsGenerateApprovalUrlResponse {
  @scala.inline
  def apply(url: String = null): Schema$ProductsGenerateApprovalUrlResponse = {
    val __obj = js.Dynamic.literal()
    if (url != null) __obj.updateDynamic("url")(url.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ProductsGenerateApprovalUrlResponse]
  }
}
