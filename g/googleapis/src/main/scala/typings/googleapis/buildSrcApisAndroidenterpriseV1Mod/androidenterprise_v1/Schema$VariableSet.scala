...
/**
  ...
  */
@js.native
trait Schema$VariableSet extends js.Object {
  /**
...
object Schema$VariableSet {
  @scala.inline
  def apply(kind: String = null, placeholder: String = null, userValue: String = null): Schema$VariableSet = {
    val __obj = js.Dynamic.literal()
    if (kind != null) __obj.updateDynamic("kind")(kind.asInstanceOf[js.Any])
    if (placeholder != null) __obj.updateDynamic("placeholder")(placeholder.asInstanceOf[js.Any])
    if (userValue != null) __obj.updateDynamic("userValue")(userValue.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$VariableSet]
  }
}
