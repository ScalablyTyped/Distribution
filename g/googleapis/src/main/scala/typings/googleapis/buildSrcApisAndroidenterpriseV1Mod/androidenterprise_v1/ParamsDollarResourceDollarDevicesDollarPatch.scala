...
@js.native
trait ParamsDollarResourceDollarDevicesDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDevicesDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarDevicesDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDevicesDollarPatch]
  }
}
