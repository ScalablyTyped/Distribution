...
object SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentFrame {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentFrame = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentFrame]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentFrame](x: Self) {
