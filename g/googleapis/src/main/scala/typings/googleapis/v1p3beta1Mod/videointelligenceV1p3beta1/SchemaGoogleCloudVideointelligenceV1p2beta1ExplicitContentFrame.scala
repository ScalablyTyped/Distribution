...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentFrame extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentFrame {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentFrameMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentFrame] (val x: Self) extends AnyVal {
