...
object SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentAnnotation {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentAnnotationOps[Self <: SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentAnnotation] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFramesVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentFrame*): Self = this.set("frames", js.Array(value :_*))
    @scala.inline
    def setFrames(value: js.Array[SchemaGoogleCloudVideointelligenceV1p2beta1ExplicitContentFrame]): Self = this.set("frames", value.asInstanceOf[js.Any])
    @scala.inline
