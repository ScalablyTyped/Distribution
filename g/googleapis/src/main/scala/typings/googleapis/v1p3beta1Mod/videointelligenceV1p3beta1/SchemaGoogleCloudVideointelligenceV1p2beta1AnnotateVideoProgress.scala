...
object SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoProgress {
  ...
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoProgress](x: Self) {
    ...
    inline def setAnnotationProgressVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1VideoAnnotationProgress*): Self = StObject.set(x, "annotationProgress", js.Array(value :_*))
  }
}
