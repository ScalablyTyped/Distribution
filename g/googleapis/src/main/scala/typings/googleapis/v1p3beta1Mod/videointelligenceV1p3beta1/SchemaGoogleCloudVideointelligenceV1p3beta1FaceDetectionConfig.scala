...
trait SchemaGoogleCloudVideointelligenceV1p3beta1FaceDetectionConfig extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p3beta1FaceDetectionConfig {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p3beta1FaceDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p3beta1FaceDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p3beta1FaceDetectionConfig](x: Self) {
