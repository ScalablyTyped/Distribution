...
trait SchemaGoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig extends StObject {
  ...
  /**
    ...
    */
  var speechContexts: js.UndefOr[js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1SpeechContext]] = js.undefined
}
object SchemaGoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig {
  ...
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig](x: Self) {
    ...
    inline def setSpeechContextsVarargs(value: SchemaGoogleCloudVideointelligenceV1p3beta1SpeechContext*): Self = StObject.set(x, "speechContexts", js.Array(value*))
  }
}
