...
trait SchemaGoogleCloudVideointelligenceV1p3beta1PersonDetectionConfig extends StObject {
...
object SchemaGoogleCloudVideointelligenceV1p3beta1PersonDetectionConfig {
  
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p3beta1PersonDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p3beta1PersonDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p3beta1PersonDetectionConfig](x: Self) {
