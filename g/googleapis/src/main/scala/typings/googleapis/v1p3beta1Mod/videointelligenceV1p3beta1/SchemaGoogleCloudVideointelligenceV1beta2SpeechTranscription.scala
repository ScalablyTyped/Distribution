...
object SchemaGoogleCloudVideointelligenceV1beta2SpeechTranscription {
  ...
  extension [Self <: SchemaGoogleCloudVideointelligenceV1beta2SpeechTranscription](x: Self) {
    ...
    inline def setAlternativesVarargs(value: SchemaGoogleCloudVideointelligenceV1beta2SpeechRecognitionAlternative*): Self = StObject.set(x, "alternatives", js.Array(value :_*))
