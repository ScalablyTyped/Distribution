...
object SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfig {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfig](x: Self) {
