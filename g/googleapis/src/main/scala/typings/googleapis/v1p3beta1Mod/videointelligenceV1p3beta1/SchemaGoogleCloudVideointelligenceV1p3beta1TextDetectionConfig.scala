...
object SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfig {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfig]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfigMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfig] (val x: Self) extends AnyVal {
