...
object SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfigOps[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1TextDetectionConfig] (val x: Self) extends AnyVal {
    @scala.inline
