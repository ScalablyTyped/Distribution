...
object SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingPoly {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingPolyOps[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedBoundingPoly] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVerticesVarargs(value: SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedVertex*): Self = this.set("vertices", js.Array(value :_*))
    
    @scala.inline
    def setVertices(value: js.Array[SchemaGoogleCloudVideointelligenceV1p3beta1NormalizedVertex]): Self = this.set("vertices", value.asInstanceOf[js.Any])
