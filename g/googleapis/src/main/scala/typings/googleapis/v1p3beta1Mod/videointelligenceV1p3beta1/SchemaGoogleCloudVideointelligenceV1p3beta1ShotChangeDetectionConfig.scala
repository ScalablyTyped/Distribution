...
object SchemaGoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfig {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfig]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfigMutableBuilder[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfig] (val x: Self) extends AnyVal {
