...
object SchemaGoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfigOps[Self <: SchemaGoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfig] (val x: Self) extends AnyVal {
    @scala.inline
