...
object SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedBoundingBox {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedBoundingBox = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedBoundingBox]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p1beta1NormalizedBoundingBox](x: Self) {
