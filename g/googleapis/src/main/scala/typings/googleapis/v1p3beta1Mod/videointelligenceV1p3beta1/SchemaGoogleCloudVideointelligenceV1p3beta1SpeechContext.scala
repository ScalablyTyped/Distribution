...
object SchemaGoogleCloudVideointelligenceV1p3beta1SpeechContext {
  ...
  inline def apply(): SchemaGoogleCloudVideointelligenceV1p3beta1SpeechContext = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p3beta1SpeechContext]
  }
  
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p3beta1SpeechContext](x: Self) {
