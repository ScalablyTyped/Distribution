...
object SchemaGoogleCloudVideointelligenceV1p2beta1LabelAnnotation {
  ...
  extension [Self <: SchemaGoogleCloudVideointelligenceV1p2beta1LabelAnnotation](x: Self) {
    ...
    inline def setCategoryEntitiesVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1Entity*): Self = StObject.set(x, "categoryEntities", js.Array(value*))
    ...
    inline def setFramesVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1LabelFrame*): Self = StObject.set(x, "frames", js.Array(value*))
    ...
    inline def setSegmentsVarargs(value: SchemaGoogleCloudVideointelligenceV1p2beta1LabelSegment*): Self = StObject.set(x, "segments", js.Array(value*))
