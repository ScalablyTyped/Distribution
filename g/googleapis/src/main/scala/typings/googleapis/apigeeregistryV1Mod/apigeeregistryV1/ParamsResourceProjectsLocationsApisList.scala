...
trait ParamsResourceProjectsLocationsApisList
  extends StObject
...
object ParamsResourceProjectsLocationsApisList {
  
  inline def apply(): ParamsResourceProjectsLocationsApisList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisList](x: Self) {
