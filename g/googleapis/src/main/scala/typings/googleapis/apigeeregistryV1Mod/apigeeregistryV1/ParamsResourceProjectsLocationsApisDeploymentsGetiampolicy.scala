...
trait ParamsResourceProjectsLocationsApisDeploymentsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsApisDeploymentsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsApisDeploymentsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisDeploymentsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisDeploymentsGetiampolicy](x: Self) {
