...
trait ParamsResourceProjectsLocationsApisVersionsSpecsArtifactsList
  extends StObject
...
object ParamsResourceProjectsLocationsApisVersionsSpecsArtifactsList {
  
  inline def apply(): ParamsResourceProjectsLocationsApisVersionsSpecsArtifactsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisVersionsSpecsArtifactsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisVersionsSpecsArtifactsList](x: Self) {
