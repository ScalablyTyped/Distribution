...
trait ParamsResourceProjectsLocationsInstancesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsInstancesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsInstancesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsInstancesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsInstancesGetiampolicy](x: Self) {
