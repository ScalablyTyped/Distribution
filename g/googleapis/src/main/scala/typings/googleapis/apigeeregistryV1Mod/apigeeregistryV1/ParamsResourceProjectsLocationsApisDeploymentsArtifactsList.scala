...
trait ParamsResourceProjectsLocationsApisDeploymentsArtifactsList
  extends StObject
...
object ParamsResourceProjectsLocationsApisDeploymentsArtifactsList {
  
  inline def apply(): ParamsResourceProjectsLocationsApisDeploymentsArtifactsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisDeploymentsArtifactsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisDeploymentsArtifactsList](x: Self) {
