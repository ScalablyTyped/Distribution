...
trait ParamsResourceProjectsLocationsApisArtifactsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsApisArtifactsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsApisArtifactsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisArtifactsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisArtifactsCreate](x: Self) {
