...
trait ParamsResourceProjectsLocationsArtifactsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsArtifactsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsArtifactsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsArtifactsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsArtifactsGetiampolicy](x: Self) {
