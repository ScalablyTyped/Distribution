...
trait SchemaApi extends StObject {
  ...
  /**
    ...
    */
  var recommendedDeployment: js.UndefOr[String | Null] = js.undefined
  
  /**
    * The recommended version of the API. Format: apis/{api\}/versions/{version\}
    */
  var recommendedVersion: js.UndefOr[String | Null] = js.undefined
...
object SchemaApi {
  ...
  extension [Self <: SchemaApi](x: Self) {
    ...
    inline def setRecommendedDeployment(value: String): Self = StObject.set(x, "recommendedDeployment", value.asInstanceOf[js.Any])
    
    inline def setRecommendedDeploymentNull: Self = StObject.set(x, "recommendedDeployment", null)
    
    inline def setRecommendedDeploymentUndefined: Self = StObject.set(x, "recommendedDeployment", js.undefined)
    
    inline def setRecommendedVersion(value: String): Self = StObject.set(x, "recommendedVersion", value.asInstanceOf[js.Any])
    
    inline def setRecommendedVersionNull: Self = StObject.set(x, "recommendedVersion", null)
