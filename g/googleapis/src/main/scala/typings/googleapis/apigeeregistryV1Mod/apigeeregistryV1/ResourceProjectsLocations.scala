...
@JSImport("googleapis/build/src/apis/apigeeregistry/v1", "apigeeregistry_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var artifacts: ResourceProjectsLocationsArtifacts = js.native
  ...
  var runtime: ResourceProjectsLocationsRuntime = js.native
}
