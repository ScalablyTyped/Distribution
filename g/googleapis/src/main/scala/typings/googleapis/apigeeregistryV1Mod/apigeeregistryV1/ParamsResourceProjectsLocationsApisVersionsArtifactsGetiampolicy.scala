...
trait ParamsResourceProjectsLocationsApisVersionsArtifactsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsApisVersionsArtifactsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsApisVersionsArtifactsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisVersionsArtifactsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisVersionsArtifactsGetiampolicy](x: Self) {
