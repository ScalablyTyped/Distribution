...
trait ParamsResourceProjectsLocationsApisVersionsSpecsArtifactsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsApisVersionsSpecsArtifactsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsApisVersionsSpecsArtifactsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisVersionsSpecsArtifactsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisVersionsSpecsArtifactsGetiampolicy](x: Self) {
