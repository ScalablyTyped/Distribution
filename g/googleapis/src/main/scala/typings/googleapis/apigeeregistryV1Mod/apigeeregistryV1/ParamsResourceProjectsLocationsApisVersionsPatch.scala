...
trait ParamsResourceProjectsLocationsApisVersionsPatch
  extends StObject
...
object ParamsResourceProjectsLocationsApisVersionsPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsApisVersionsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisVersionsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisVersionsPatch](x: Self) {
