...
trait ParamsResourceProjectsLocationsApisVersionsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsApisVersionsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsApisVersionsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisVersionsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisVersionsGetiampolicy](x: Self) {
