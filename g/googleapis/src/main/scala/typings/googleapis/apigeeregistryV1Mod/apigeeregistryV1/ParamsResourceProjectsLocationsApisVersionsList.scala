...
trait ParamsResourceProjectsLocationsApisVersionsList
  extends StObject
...
object ParamsResourceProjectsLocationsApisVersionsList {
  
  inline def apply(): ParamsResourceProjectsLocationsApisVersionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisVersionsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisVersionsList](x: Self) {
