...
trait ParamsResourceProjectsLocationsApisArtifactsList
  extends StObject
...
object ParamsResourceProjectsLocationsApisArtifactsList {
  
  inline def apply(): ParamsResourceProjectsLocationsApisArtifactsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisArtifactsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisArtifactsList](x: Self) {
