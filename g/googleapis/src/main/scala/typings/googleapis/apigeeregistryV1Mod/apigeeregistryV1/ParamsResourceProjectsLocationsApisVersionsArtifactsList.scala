...
trait ParamsResourceProjectsLocationsApisVersionsArtifactsList
  extends StObject
...
object ParamsResourceProjectsLocationsApisVersionsArtifactsList {
  
  inline def apply(): ParamsResourceProjectsLocationsApisVersionsArtifactsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisVersionsArtifactsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisVersionsArtifactsList](x: Self) {
