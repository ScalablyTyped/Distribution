...
trait ParamsResourceProjectsLocationsArtifactsList
  extends StObject
...
object ParamsResourceProjectsLocationsArtifactsList {
  
  inline def apply(): ParamsResourceProjectsLocationsArtifactsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsArtifactsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsArtifactsList](x: Self) {
