...
trait ParamsResourceProjectsLocationsApisVersionsSpecsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsApisVersionsSpecsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsApisVersionsSpecsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisVersionsSpecsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisVersionsSpecsGetiampolicy](x: Self) {
