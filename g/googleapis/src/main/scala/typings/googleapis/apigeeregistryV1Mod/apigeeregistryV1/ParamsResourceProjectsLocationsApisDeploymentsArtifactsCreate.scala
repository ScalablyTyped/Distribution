...
trait ParamsResourceProjectsLocationsApisDeploymentsArtifactsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsApisDeploymentsArtifactsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsApisDeploymentsArtifactsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisDeploymentsArtifactsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisDeploymentsArtifactsCreate](x: Self) {
