...
trait ParamsResourceProjectsLocationsRuntimeGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsRuntimeGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsRuntimeGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRuntimeGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRuntimeGetiampolicy](x: Self) {
