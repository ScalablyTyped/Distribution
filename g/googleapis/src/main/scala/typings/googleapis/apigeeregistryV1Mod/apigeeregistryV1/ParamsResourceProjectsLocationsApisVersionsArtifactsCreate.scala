...
trait ParamsResourceProjectsLocationsApisVersionsArtifactsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsApisVersionsArtifactsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsApisVersionsArtifactsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisVersionsArtifactsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisVersionsArtifactsCreate](x: Self) {
