...
trait ParamsResourceProjectsLocationsApisArtifactsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsApisArtifactsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsApisArtifactsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisArtifactsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisArtifactsGetiampolicy](x: Self) {
