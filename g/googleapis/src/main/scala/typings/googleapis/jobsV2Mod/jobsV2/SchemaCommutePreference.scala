...
trait SchemaCommutePreference extends StObject {
  ...
  /**
    ...
    */
  var allowNonStreetLevelAddress: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var departureHourLocal: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var travelTime: js.UndefOr[String | Null] = js.undefined
}
object SchemaCommutePreference {
  ...
  extension [Self <: SchemaCommutePreference](x: Self) {
    ...
    inline def setAllowNonStreetLevelAddressNull: Self = StObject.set(x, "allowNonStreetLevelAddress", null)
    ...
    inline def setDepartureHourLocalNull: Self = StObject.set(x, "departureHourLocal", null)
    ...
    inline def setTravelTimeNull: Self = StObject.set(x, "travelTime", null)
