...
trait SchemaGoogleCloudTalentV4BatchDeleteJobsResponse extends StObject {
...
object SchemaGoogleCloudTalentV4BatchDeleteJobsResponse {
  
  inline def apply(): SchemaGoogleCloudTalentV4BatchDeleteJobsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudTalentV4BatchDeleteJobsResponse]
  }
  
  extension [Self <: SchemaGoogleCloudTalentV4BatchDeleteJobsResponse](x: Self) {
