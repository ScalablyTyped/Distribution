...
trait SchemaGoogleCloudTalentV4JobApplicationInfo extends StObject {
...
object SchemaGoogleCloudTalentV4JobApplicationInfo {
  
  inline def apply(): SchemaGoogleCloudTalentV4JobApplicationInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudTalentV4JobApplicationInfo]
  }
  
  extension [Self <: SchemaGoogleCloudTalentV4JobApplicationInfo](x: Self) {
