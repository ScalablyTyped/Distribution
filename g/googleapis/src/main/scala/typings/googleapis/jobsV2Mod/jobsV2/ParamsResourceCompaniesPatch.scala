...
object ParamsResourceCompaniesPatch {
  ...
  @scala.inline
  implicit class ParamsResourceCompaniesPatchMutableBuilder[Self <: ParamsResourceCompaniesPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUpdateCompanyFields(value: String): Self = StObject.set(x, "updateCompanyFields", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUpdateCompanyFieldsUndefined: Self = StObject.set(x, "updateCompanyFields", js.undefined)
  }
}
