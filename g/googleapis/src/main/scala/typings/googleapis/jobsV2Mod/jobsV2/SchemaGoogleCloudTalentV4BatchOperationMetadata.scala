...
trait SchemaGoogleCloudTalentV4BatchOperationMetadata extends StObject {
...
object SchemaGoogleCloudTalentV4BatchOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudTalentV4BatchOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudTalentV4BatchOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudTalentV4BatchOperationMetadata](x: Self) {
