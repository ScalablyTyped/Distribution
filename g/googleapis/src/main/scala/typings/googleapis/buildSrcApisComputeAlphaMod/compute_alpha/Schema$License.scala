...
/**
  ...
  */
@js.native
trait Schema$License extends js.Object {
  /**
  ...
  var resourceRequirements: js.UndefOr[Schema$LicenseResourceRequirements] = js.native
  /**
...
object Schema$License {
  ...
  def apply(
    ...
    name: String = null,
    resourceRequirements: Schema$LicenseResourceRequirements = null,
    ...
    __obj.asInstanceOf[Schema$License]
  }
}
