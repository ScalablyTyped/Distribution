...
/**
  ...
  */
@js.native
trait Schema$BackendServiceAppEngineBackend extends js.Object {
  /**
...
object Schema$BackendServiceAppEngineBackend {
  @scala.inline
  def apply(appEngineService: String = null, targetProject: String = null, version: String = null): Schema$BackendServiceAppEngineBackend = {
    ...
    __obj.asInstanceOf[Schema$BackendServiceAppEngineBackend]
  }
}
