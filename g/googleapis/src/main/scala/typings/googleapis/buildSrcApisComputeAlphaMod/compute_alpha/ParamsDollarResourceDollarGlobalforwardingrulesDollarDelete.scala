...
@js.native
trait ParamsDollarResourceDollarGlobalforwardingrulesDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarGlobalforwardingrulesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarGlobalforwardingrulesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarGlobalforwardingrulesDollarDelete]
  }
}
