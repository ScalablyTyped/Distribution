...
@js.native
trait Schema$SslPoliciesList extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$SslPolicy]] = js.native
  /**
...
object Schema$SslPoliciesList {
  @scala.inline
  def apply(
    id: String = null,
    items: js.Array[Schema$SslPolicy] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$SslPoliciesList]
  }
}
