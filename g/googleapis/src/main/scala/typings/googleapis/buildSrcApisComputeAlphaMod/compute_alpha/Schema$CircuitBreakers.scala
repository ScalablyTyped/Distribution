...
/**
  ...
  */
@js.native
trait Schema$CircuitBreakers extends js.Object {
  /**
    * The timeout for new network connections to hosts.
    */
  var connectTimeout: js.UndefOr[Schema$Duration] = js.native
  /**
...
object Schema$CircuitBreakers {
  @scala.inline
  def apply(
    connectTimeout: Schema$Duration = null,
    ...
    __obj.asInstanceOf[Schema$CircuitBreakers]
  }
}
