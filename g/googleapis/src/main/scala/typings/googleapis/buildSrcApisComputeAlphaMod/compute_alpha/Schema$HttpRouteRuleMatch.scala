...
/**
  ...
  */
@js.native
trait Schema$HttpRouteRuleMatch extends js.Object {
  /**
  ...
  /**
    ...
    */
  var headerMatches: js.UndefOr[js.Array[Schema$HttpHeaderMatch]] = js.native
  /**
  ...
  /**
    ...
    */
  var queryParameterMatches: js.UndefOr[js.Array[Schema$HttpQueryParameterMatch]] = js.native
  /**
    * For satifying the matchRule condition, the path of the request must
...
object Schema$HttpRouteRuleMatch {
  @scala.inline
  def apply(
    fullPathMatch: String = null,
    headerMatches: js.Array[Schema$HttpHeaderMatch] = null,
    ignoreCase: js.UndefOr[Boolean] = js.undefined,
    metadataFilters: js.Array[Schema$MetadataFilter] = null,
    prefixMatch: String = null,
    queryParameterMatches: js.Array[Schema$HttpQueryParameterMatch] = null,
    ...
    __obj.asInstanceOf[Schema$HttpRouteRuleMatch]
  }
}
