...
/**
  ...
  */
@js.native
trait Schema$CallCredentials extends js.Object {
  /**
  ...
  /**
    ...
    */
  var fromPlugin: js.UndefOr[Schema$MetadataCredentialsFromPlugin] = js.native
  /**
    ...
    * JWT_SERVICE_ACCOUNT.
    */
  var jwtServiceAccount: js.UndefOr[Schema$ServiceAccountJwtAccessCredentials] = js.native
}

object Schema$CallCredentials {
  @scala.inline
  def apply(
    accessToken: String = null,
    callCredentialType: String = null,
    fromPlugin: Schema$MetadataCredentialsFromPlugin = null,
    jwtServiceAccount: Schema$ServiceAccountJwtAccessCredentials = null
  ): Schema$CallCredentials = {
    ...
    __obj.asInstanceOf[Schema$CallCredentials]
  }
}
