...
/**
  ...
  */
@js.native
trait Schema$FixedOrPercent extends js.Object {
  /**
...
object Schema$FixedOrPercent {
  @scala.inline
  def apply(calculated: Int | Double = null, fixed: Int | Double = null, percent: Int | Double = null): Schema$FixedOrPercent = {
    val __obj = js.Dynamic.literal()
    if (calculated != null) __obj.updateDynamic("calculated")(calculated.asInstanceOf[js.Any])
    if (fixed != null) __obj.updateDynamic("fixed")(fixed.asInstanceOf[js.Any])
    if (percent != null) __obj.updateDynamic("percent")(percent.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$FixedOrPercent]
  }
}
