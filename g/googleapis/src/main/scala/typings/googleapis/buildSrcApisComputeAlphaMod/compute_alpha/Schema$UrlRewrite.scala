...
/**
  ...
  */
@js.native
trait Schema$UrlRewrite extends js.Object {
  /**
...
object Schema$UrlRewrite {
  @scala.inline
  def apply(hostRewrite: String = null, pathPrefixRewrite: String = null): Schema$UrlRewrite = {
    ...
    __obj.asInstanceOf[Schema$UrlRewrite]
  }
}
