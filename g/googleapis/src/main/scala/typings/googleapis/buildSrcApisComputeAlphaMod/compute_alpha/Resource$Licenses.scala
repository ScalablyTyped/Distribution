...
class Resource$Licenses protected () extends js.Object {
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarLicensesDollarTestiampermissions): GaxiosPromise[Schema$TestPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsDollarResourceDollarLicensesDollarTestiampermissions,
  ...
  def testIamPermissions(params: ParamsDollarResourceDollarLicensesDollarTestiampermissions, options: MethodOptions): GaxiosPromise[Schema$TestPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsDollarResourceDollarLicensesDollarTestiampermissions,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$TestPermissionsResponse]
