...
@js.native
trait ParamsDollarResourceDollarInstancesDollarSetdiskautodelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInstancesDollarSetdiskautodelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarInstancesDollarSetdiskautodelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInstancesDollarSetdiskautodelete]
  }
}
