...
class Resource$Nodegroups protected () extends js.Object {
  ...
  /**
    ...
    * @return {object} Request object
    */
  def setAutoscalingPolicy(): GaxiosPromise[Schema$Operation] = js.native
  def setAutoscalingPolicy(callback: BodyResponseCallback[Schema$Operation]): Unit = js.native
  def setAutoscalingPolicy(params: ParamsDollarResourceDollarNodegroupsDollarSetautoscalingpolicy): GaxiosPromise[Schema$Operation] = js.native
  def setAutoscalingPolicy(
    params: ParamsDollarResourceDollarNodegroupsDollarSetautoscalingpolicy,
    callback: BodyResponseCallback[Schema$Operation]
  ): Unit = js.native
  def setAutoscalingPolicy(
    params: ParamsDollarResourceDollarNodegroupsDollarSetautoscalingpolicy,
  ...
  def setAutoscalingPolicy(params: ParamsDollarResourceDollarNodegroupsDollarSetautoscalingpolicy, options: MethodOptions): GaxiosPromise[Schema$Operation] = js.native
  def setAutoscalingPolicy(
    params: ParamsDollarResourceDollarNodegroupsDollarSetautoscalingpolicy,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Operation]
