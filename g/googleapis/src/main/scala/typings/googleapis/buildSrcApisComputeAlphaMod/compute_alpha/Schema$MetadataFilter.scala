...
/**
  ...
  */
@js.native
trait Schema$MetadataFilter extends js.Object {
  /**
    * The list of label value pairs that must match labels in the provided
    * metadata based on filterMatchCriteria  This list must not be empty and
    * can have at the most 64 entries.
    */
  var filterLabels: js.UndefOr[js.Array[Schema$MetadataFilterLabelMatch]] = js.native
  /**
...
object Schema$MetadataFilter {
  @scala.inline
  def apply(filterLabels: js.Array[Schema$MetadataFilterLabelMatch] = null, filterMatchCriteria: String = null): Schema$MetadataFilter = {
    ...
    __obj.asInstanceOf[Schema$MetadataFilter]
  }
}
