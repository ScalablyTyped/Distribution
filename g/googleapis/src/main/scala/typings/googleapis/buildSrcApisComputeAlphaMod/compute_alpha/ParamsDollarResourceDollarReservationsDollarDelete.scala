...
@js.native
trait ParamsDollarResourceDollarReservationsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarReservationsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarReservationsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarReservationsDollarDelete]
  }
}
