...
trait Schema$AutoscalingPolicy extends js.Object {
  ...
  /**
    ...
    */
  var cpuUtilization: js.UndefOr[Schema$AutoscalingPolicyCpuUtilization] = js.native
  /**
    * Configuration parameters of autoscaling based on a custom metric.
    */
  var customMetricUtilizations: js.UndefOr[js.Array[Schema$AutoscalingPolicyCustomMetricUtilization]] = js.native
  /**
    * Configuration parameters of autoscaling based on load balancer.
    */
  var loadBalancingUtilization: js.UndefOr[Schema$AutoscalingPolicyLoadBalancingUtilization] = js.native
  /**
  ...
  /**
    ...
    */
  var queueBasedScaling: js.UndefOr[Schema$AutoscalingPolicyQueueBasedScaling] = js.native
}
...
object Schema$AutoscalingPolicy {
  ...
  def apply(
    ...
    cpuUtilization: Schema$AutoscalingPolicyCpuUtilization = null,
    customMetricUtilizations: js.Array[Schema$AutoscalingPolicyCustomMetricUtilization] = null,
    loadBalancingUtilization: Schema$AutoscalingPolicyLoadBalancingUtilization = null,
    maxNumReplicas: Int | Double = null,
    minNumReplicas: Int | Double = null,
    mode: String = null,
    queueBasedScaling: Schema$AutoscalingPolicyQueueBasedScaling = null
