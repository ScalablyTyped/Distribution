...
@js.native
trait ParamsDollarResourceDollarRegionbackendservicesDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRegionbackendservicesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarRegionbackendservicesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRegionbackendservicesDollarDelete]
  }
}
