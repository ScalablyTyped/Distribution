...
/**
  ...
  */
@js.native
trait Schema$AuthenticationPolicy extends js.Object {
  /**
    ...
    * required.
    */
  var origins: js.UndefOr[js.Array[Schema$OriginAuthenticationMethod]] = js.native
  /**
    ...
    */
  var peers: js.UndefOr[js.Array[Schema$PeerAuthenticationMethod]] = js.native
  /**
  ...
  /**
    ...
    */
  var serverTlsContext: js.UndefOr[Schema$TlsContext] = js.native
}

object Schema$AuthenticationPolicy {
  @scala.inline
  def apply(
    origins: js.Array[Schema$OriginAuthenticationMethod] = null,
    peers: js.Array[Schema$PeerAuthenticationMethod] = null,
    principalBinding: String = null,
    serverTlsContext: Schema$TlsContext = null
    ...
    __obj.asInstanceOf[Schema$AuthenticationPolicy]
  }
}
