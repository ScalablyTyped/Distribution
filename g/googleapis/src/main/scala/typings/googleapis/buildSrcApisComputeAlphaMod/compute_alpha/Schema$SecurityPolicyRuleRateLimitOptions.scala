...
@js.native
trait Schema$SecurityPolicyRuleRateLimitOptions extends js.Object {
  /**
...
object Schema$SecurityPolicyRuleRateLimitOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$SecurityPolicyRuleRateLimitOptions]
  }
}
