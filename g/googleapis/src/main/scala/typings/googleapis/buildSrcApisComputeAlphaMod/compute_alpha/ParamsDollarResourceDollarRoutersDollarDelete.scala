...
@js.native
trait ParamsDollarResourceDollarRoutersDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRoutersDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    router: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarRoutersDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRoutersDollarDelete]
  }
}
