...
@js.native
trait Schema$InterconnectDiagnosticsLinkOpticalPower extends js.Object {
  /**
...
object Schema$InterconnectDiagnosticsLinkOpticalPower {
  @scala.inline
  def apply(state: String = null, value: Int | Double = null): Schema$InterconnectDiagnosticsLinkOpticalPower = {
    val __obj = js.Dynamic.literal()
    if (state != null) __obj.updateDynamic("state")(state.asInstanceOf[js.Any])
    if (value != null) __obj.updateDynamic("value")(value.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$InterconnectDiagnosticsLinkOpticalPower]
  }
}
