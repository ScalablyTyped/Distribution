...
/**
  ...
  */
@js.native
trait Schema$NotificationEndpointGrpcSettings extends js.Object {
  /**
...
object Schema$NotificationEndpointGrpcSettings {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$NotificationEndpointGrpcSettings]
  }
}
