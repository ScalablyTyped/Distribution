...
@js.native
trait Schema$NodeTypeAggregatedList extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[StringDictionary[Schema$NodeTypesScopedList]] = js.native
  /**
...
object Schema$NodeTypeAggregatedList {
  @scala.inline
  def apply(
    id: String = null,
    items: StringDictionary[Schema$NodeTypesScopedList] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$NodeTypeAggregatedList]
  }
}
