...
trait Schema$SecurityPolicyRuleMatcherConfig extends js.Object {
  ...
  /**
    ...
    */
  var destPorts: js.UndefOr[js.Array[Schema$SecurityPolicyRuleMatcherConfigDestinationPort]] = js.native
  /**
...
object Schema$SecurityPolicyRuleMatcherConfig {
  ...
  def apply(
    ...
    destPorts: js.Array[Schema$SecurityPolicyRuleMatcherConfigDestinationPort] = null,
