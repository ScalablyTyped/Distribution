...
@js.native
trait ParamsDollarResourceDollarNodetemplatesDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarNodetemplatesDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarNodetemplatesDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarNodetemplatesDollarDelete]
  }
}
