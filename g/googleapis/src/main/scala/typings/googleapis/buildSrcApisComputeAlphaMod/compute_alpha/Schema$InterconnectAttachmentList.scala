...
/**
  ...
  */
@js.native
trait Schema$InterconnectAttachmentList extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[Schema$InterconnectAttachment]] = js.native
  /**
...
object Schema$InterconnectAttachmentList {
  @scala.inline
  def apply(
    id: String = null,
    items: js.Array[Schema$InterconnectAttachment] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[Schema$InterconnectAttachmentList]
  }
}
