...
@js.native
trait Schema$RegionSetPolicyRequest extends js.Object {
  /**
...
object Schema$RegionSetPolicyRequest {
  @scala.inline
  def apply(bindings: js.Array[Schema$Binding] = null, etag: String = null, policy: Schema$Policy = null): Schema$RegionSetPolicyRequest = {
    val __obj = js.Dynamic.literal()
    if (bindings != null) __obj.updateDynamic("bindings")(bindings.asInstanceOf[js.Any])
    if (etag != null) __obj.updateDynamic("etag")(etag.asInstanceOf[js.Any])
    if (policy != null) __obj.updateDynamic("policy")(policy.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$RegionSetPolicyRequest]
  }
}
