...
/**
  ...
  */
@js.native
trait Schema$MachineImage extends js.Object {
  /**
  ...
  /**
    ...
    */
  var machineImageEncryptionKey: js.UndefOr[Schema$CustomerEncryptionKey] = js.native
  /**
  ...
  /**
    ...
    */
  var sourceInstanceProperties: js.UndefOr[Schema$SourceInstanceProperties] = js.native
  /**
...
object Schema$MachineImage {
  ...
  def apply(
    ...
    id: String = null,
    kind: String = null,
    machineImageEncryptionKey: Schema$CustomerEncryptionKey = null,
    name: String = null,
    selfLink: String = null,
    selfLinkWithId: String = null,
    sourceInstance: String = null,
    sourceInstanceProperties: Schema$SourceInstanceProperties = null,
    status: String = null,
    ...
    __obj.asInstanceOf[Schema$MachineImage]
  }
}
