...
/**
  ...
  */
@js.native
trait Schema$InterconnectAttachment extends js.Object {
  /**
  ...
  /**
    ...
    */
  var partnerMetadata: js.UndefOr[Schema$InterconnectAttachmentPartnerMetadata] = js.native
  /**
    ...
    * type DEDICATED.
    */
  var privateInterconnectInfo: js.UndefOr[Schema$InterconnectAttachmentPrivateInfo] = js.native
  /**
...
object Schema$InterconnectAttachment {
  @scala.inline
  def apply(
    ...
    partnerMetadata: Schema$InterconnectAttachmentPartnerMetadata = null,
    privateInterconnectInfo: Schema$InterconnectAttachmentPrivateInfo = null,
    region: String = null,
    router: String = null,
    ...
    __obj.asInstanceOf[Schema$InterconnectAttachment]
  }
}
