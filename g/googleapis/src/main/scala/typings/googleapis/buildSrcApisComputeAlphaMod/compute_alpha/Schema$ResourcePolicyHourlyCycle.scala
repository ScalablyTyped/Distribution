...
/**
  ...
  */
@js.native
trait Schema$ResourcePolicyHourlyCycle extends js.Object {
  /**
...
object Schema$ResourcePolicyHourlyCycle {
  @scala.inline
  def apply(duration: String = null, hoursInCycle: Int | Double = null, startTime: String = null): Schema$ResourcePolicyHourlyCycle = {
    val __obj = js.Dynamic.literal()
    if (duration != null) __obj.updateDynamic("duration")(duration.asInstanceOf[js.Any])
    if (hoursInCycle != null) __obj.updateDynamic("hoursInCycle")(hoursInCycle.asInstanceOf[js.Any])
    if (startTime != null) __obj.updateDynamic("startTime")(startTime.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ResourcePolicyHourlyCycle]
  }
}
