...
/**
  ...
  */
@js.native
trait Schema$HttpHeaderMatch extends js.Object {
  /**
  ...
  /**
    ...
    */
  var rangeMatch: js.UndefOr[Schema$Int64RangeMatch] = js.native
  /**
...
object Schema$HttpHeaderMatch {
  ...
  def apply(
    ...
    rangeMatch: Schema$Int64RangeMatch = null,
    ...
    __obj.asInstanceOf[Schema$HttpHeaderMatch]
  }
}
