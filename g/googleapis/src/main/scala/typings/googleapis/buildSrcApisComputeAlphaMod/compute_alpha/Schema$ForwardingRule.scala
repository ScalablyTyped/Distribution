...
/**
  ...
  */
@js.native
trait Schema$ForwardingRule extends js.Object {
  /**
  ...
  /**
    ...
    */
  var metadataFilters: js.UndefOr[js.Array[Schema$MetadataFilter]] = js.native
  /**
...
object Schema$ForwardingRule {
  ...
  def apply(
    ...
    metadataFilters: js.Array[Schema$MetadataFilter] = null,
    name: String = null,
    network: String = null,
    ...
    __obj.asInstanceOf[Schema$ForwardingRule]
  }
}
