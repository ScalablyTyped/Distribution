...
@js.native
trait ParamsDollarResourceDollarDisksDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDisksDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsDollarResourceDollarDisksDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDisksDollarDelete]
  }
}
