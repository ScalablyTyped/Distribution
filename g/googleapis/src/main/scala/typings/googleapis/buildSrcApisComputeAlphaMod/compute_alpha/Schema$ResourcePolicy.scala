...
trait Schema$ResourcePolicy extends js.Object {
  ...
  /**
    ...
    */
  var groupPlacementPolicy: js.UndefOr[Schema$ResourcePolicyGroupPlacementPolicy] = js.native
  /**
  ...
  /**
    ...
    */
  var vmMaintenancePolicy: js.UndefOr[Schema$ResourcePolicyVmMaintenancePolicy] = js.native
}
...
object Schema$ResourcePolicy {
  ...
  def apply(
    ...
    groupPlacementPolicy: Schema$ResourcePolicyGroupPlacementPolicy = null,
    id: String = null,
    kind: String = null,
    name: String = null,
    region: String = null,
    ...
    vmMaintenancePolicy: Schema$ResourcePolicyVmMaintenancePolicy = null
