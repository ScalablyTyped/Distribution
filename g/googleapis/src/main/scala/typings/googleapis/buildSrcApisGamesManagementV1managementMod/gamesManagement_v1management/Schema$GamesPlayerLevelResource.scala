...
/**
  ...
  */
@js.native
trait Schema$GamesPlayerLevelResource extends js.Object {
  /**
...
object Schema$GamesPlayerLevelResource {
  @scala.inline
  def apply(level: Int | Double = null, maxExperiencePoints: String = null, minExperiencePoints: String = null): Schema$GamesPlayerLevelResource = {
    ...
    __obj.asInstanceOf[Schema$GamesPlayerLevelResource]
  }
}
