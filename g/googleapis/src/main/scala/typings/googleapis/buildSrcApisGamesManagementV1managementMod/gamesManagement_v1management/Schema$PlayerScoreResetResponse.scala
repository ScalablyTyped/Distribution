...
/**
  ...
  */
@js.native
trait Schema$PlayerScoreResetResponse extends js.Object {
  /**
...
object Schema$PlayerScoreResetResponse {
  @scala.inline
  def apply(definitionId: String = null, kind: String = null, resetScoreTimeSpans: js.Array[String] = null): Schema$PlayerScoreResetResponse = {
    ...
    __obj.asInstanceOf[Schema$PlayerScoreResetResponse]
  }
}
