...
import typings.googleapis.Anon_FamilyName
...
/**
  ...
  */
@js.native
trait Schema$Player extends js.Object {
  /**
  ...
  /**
    ...
    */
  var experienceInfo: js.UndefOr[Schema$GamesPlayerExperienceInfoResource] = js.native
  /**
  ...
  /**
    ...
    * collection members.
    */
  var lastPlayedWith: js.UndefOr[Schema$GamesPlayedResource] = js.native
  /**
  ...
  /**
    ...
    */
  var profileSettings: js.UndefOr[Schema$ProfileSettings] = js.native
  /**
...
object Schema$Player {
  ...
  def apply(
    ...
    experienceInfo: Schema$GamesPlayerExperienceInfoResource = null,
    kind: String = null,
    lastPlayedWith: Schema$GamesPlayedResource = null,
    name: Anon_FamilyName = null,
    originalPlayerId: String = null,
    playerId: String = null,
    profileSettings: Schema$ProfileSettings = null,
    title: String = null
  ): Schema$Player = {
    ...
    __obj.asInstanceOf[Schema$Player]
  }
}
