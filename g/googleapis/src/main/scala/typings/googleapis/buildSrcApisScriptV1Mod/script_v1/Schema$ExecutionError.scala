...
/**
  ...
  */
@js.native
trait Schema$ExecutionError extends js.Object {
  /**
  ...
  /**
    ...
    */
  var scriptStackTraceElements: js.UndefOr[js.Array[Schema$ScriptStackTraceElement]] = js.native
}

object Schema$ExecutionError {
  @scala.inline
  def apply(
    errorMessage: String = null,
    errorType: String = null,
    scriptStackTraceElements: js.Array[Schema$ScriptStackTraceElement] = null
    ...
    __obj.asInstanceOf[Schema$ExecutionError]
  }
}
