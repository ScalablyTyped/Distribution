...
trait ParamsResourceProjectsLocationsDeliverypipelinesReleasesCreate
  extends StObject
...
object ParamsResourceProjectsLocationsDeliverypipelinesReleasesCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsDeliverypipelinesReleasesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDeliverypipelinesReleasesCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDeliverypipelinesReleasesCreate](x: Self) {
