...
@JSImport("googleapis/build/src/apis/clouddeploy/v1", "clouddeploy_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var deliveryPipelines: ResourceProjectsLocationsDeliverypipelines = js.native
  ...
  def getConfig(): GaxiosPromise[SchemaConfig] = js.native
  def getConfig(callback: BodyResponseCallback[SchemaConfig]): Unit = js.native
  def getConfig(params: Unit, options: MethodOptions): GaxiosPromise[SchemaConfig] = js.native
  def getConfig(params: ParamsResourceProjectsLocationsGetconfig): GaxiosPromise[SchemaConfig] = js.native
  def getConfig(params: ParamsResourceProjectsLocationsGetconfig, callback: BodyResponseCallback[SchemaConfig]): Unit = js.native
  def getConfig(
    params: ParamsResourceProjectsLocationsGetconfig,
    options: BodyResponseCallback[Readable | SchemaConfig],
    callback: BodyResponseCallback[Readable | SchemaConfig]
  ): Unit = js.native
  def getConfig(params: ParamsResourceProjectsLocationsGetconfig, options: MethodOptions): GaxiosPromise[SchemaConfig] = js.native
  def getConfig(
    params: ParamsResourceProjectsLocationsGetconfig,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaConfig]
  ): Unit = js.native
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def getConfig(params: ParamsResourceProjectsLocationsGetconfig, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def getConfig(
    params: ParamsResourceProjectsLocationsGetconfig,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  var targets: ResourceProjectsLocationsTargets = js.native
}
