...
trait ParamsResourceProjectsLocationsTargetsList
  extends StObject
...
object ParamsResourceProjectsLocationsTargetsList {
  
  inline def apply(): ParamsResourceProjectsLocationsTargetsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsTargetsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsTargetsList](x: Self) {
