...
trait ParamsResourceProjectsLocationsTargetsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsTargetsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsTargetsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsTargetsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsTargetsGetiampolicy](x: Self) {
