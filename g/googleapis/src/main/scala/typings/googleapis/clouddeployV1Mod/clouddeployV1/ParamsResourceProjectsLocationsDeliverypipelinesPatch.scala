...
trait ParamsResourceProjectsLocationsDeliverypipelinesPatch
  extends StObject
...
object ParamsResourceProjectsLocationsDeliverypipelinesPatch {
  
  inline def apply(): ParamsResourceProjectsLocationsDeliverypipelinesPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDeliverypipelinesPatch]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDeliverypipelinesPatch](x: Self) {
