...
trait ParamsResourceProjectsLocationsDeliverypipelinesReleasesList
  extends StObject
...
object ParamsResourceProjectsLocationsDeliverypipelinesReleasesList {
  
  inline def apply(): ParamsResourceProjectsLocationsDeliverypipelinesReleasesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDeliverypipelinesReleasesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDeliverypipelinesReleasesList](x: Self) {
