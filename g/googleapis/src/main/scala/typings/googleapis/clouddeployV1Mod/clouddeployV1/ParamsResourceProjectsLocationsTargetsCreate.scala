...
trait ParamsResourceProjectsLocationsTargetsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsTargetsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsTargetsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsTargetsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsTargetsCreate](x: Self) {
