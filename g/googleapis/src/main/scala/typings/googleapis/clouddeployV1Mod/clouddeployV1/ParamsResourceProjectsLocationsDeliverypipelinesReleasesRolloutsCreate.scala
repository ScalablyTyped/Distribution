...
trait ParamsResourceProjectsLocationsDeliverypipelinesReleasesRolloutsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsDeliverypipelinesReleasesRolloutsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsDeliverypipelinesReleasesRolloutsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDeliverypipelinesReleasesRolloutsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDeliverypipelinesReleasesRolloutsCreate](x: Self) {
