...
trait ParamsResourceProjectsLocationsTargetsDelete
  extends StObject
...
object ParamsResourceProjectsLocationsTargetsDelete {
  
  inline def apply(): ParamsResourceProjectsLocationsTargetsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsTargetsDelete]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsTargetsDelete](x: Self) {
