...
trait ParamsResourceProjectsLocationsDeliverypipelinesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsDeliverypipelinesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsDeliverypipelinesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDeliverypipelinesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDeliverypipelinesGetiampolicy](x: Self) {
