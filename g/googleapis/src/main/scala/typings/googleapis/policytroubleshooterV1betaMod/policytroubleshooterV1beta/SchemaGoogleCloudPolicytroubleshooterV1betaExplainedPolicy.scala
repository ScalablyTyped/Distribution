...
trait SchemaGoogleCloudPolicytroubleshooterV1betaExplainedPolicy extends StObject {
  ...
  /**
    ...
    */
  var bindingExplanations: js.UndefOr[js.Array[SchemaGoogleCloudPolicytroubleshooterV1betaBindingExplanation]] = js.undefined
...
object SchemaGoogleCloudPolicytroubleshooterV1betaExplainedPolicy {
  
  inline def apply(): SchemaGoogleCloudPolicytroubleshooterV1betaExplainedPolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudPolicytroubleshooterV1betaExplainedPolicy]
  }
  
  extension [Self <: SchemaGoogleCloudPolicytroubleshooterV1betaExplainedPolicy](x: Self) {
    ...
    inline def setBindingExplanations(value: js.Array[SchemaGoogleCloudPolicytroubleshooterV1betaBindingExplanation]): Self = StObject.set(x, "bindingExplanations", value.asInstanceOf[js.Any])
    
    inline def setBindingExplanationsUndefined: Self = StObject.set(x, "bindingExplanations", js.undefined)
    
    inline def setBindingExplanationsVarargs(value: SchemaGoogleCloudPolicytroubleshooterV1betaBindingExplanation*): Self = StObject.set(x, "bindingExplanations", js.Array(value*))
