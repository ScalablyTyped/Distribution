...
/**
  ...
  */
@js.native
trait Schema$ReportRequest extends js.Object {
  /**
    ...
    */
  var cohortGroup: js.UndefOr[Schema$CohortGroup] = js.native
  /**
    ...
    */
  var dateRanges: js.UndefOr[js.Array[Schema$DateRange]] = js.native
  /**
    ...
    */
  var dimensionFilterClauses: js.UndefOr[js.Array[Schema$DimensionFilterClause]] = js.native
  /**
  ...
  /**
    ...
    */
  var metricFilterClauses: js.UndefOr[js.Array[Schema$MetricFilterClause]] = js.native
  /**
  ...
  /**
    ...
    */
  var orderBys: js.UndefOr[js.Array[Schema$OrderBy]] = js.native
  /**
  ...
  /**
    ...
    */
  var pivots: js.UndefOr[js.Array[Schema$Pivot]] = js.native
  /**
    * The desired report
...
object Schema$ReportRequest {
  @scala.inline
  def apply(
    cohortGroup: Schema$CohortGroup = null,
    dateRanges: js.Array[Schema$DateRange] = null,
    dimensionFilterClauses: js.Array[Schema$DimensionFilterClause] = null,
    ...
    metricFilterClauses: js.Array[Schema$MetricFilterClause] = null,
    metrics: js.Array[Schema$Metric] = null,
    orderBys: js.Array[Schema$OrderBy] = null,
    pageSize: Int | Double = null,
    pageToken: String = null,
    pivots: js.Array[Schema$Pivot] = null,
    samplingLevel: String = null,
    segments: js.Array[Schema$Segment] = null,
    viewId: String = null
    ...
    __obj.asInstanceOf[Schema$ReportRequest]
  }
}
