...
/**
  ...
  */
@js.native
trait Schema$SearchUserActivityRequest extends js.Object {
  /**
...
object Schema$SearchUserActivityRequest {
  @scala.inline
  def apply(
    ...
    viewId: String = null
  ): Schema$SearchUserActivityRequest = {
    ...
    __obj.asInstanceOf[Schema$SearchUserActivityRequest]
  }
}
