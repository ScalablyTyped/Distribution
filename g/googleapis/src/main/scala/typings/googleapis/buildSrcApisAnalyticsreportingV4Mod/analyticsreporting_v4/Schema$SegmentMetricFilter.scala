...
/**
  ...
  */
@js.native
trait Schema$SegmentMetricFilter extends js.Object {
  /**
...
object Schema$SegmentMetricFilter {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$SegmentMetricFilter]
  }
}
