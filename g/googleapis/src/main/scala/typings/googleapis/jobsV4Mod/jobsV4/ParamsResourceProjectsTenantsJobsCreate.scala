...
trait ParamsResourceProjectsTenantsJobsCreate
  extends StObject
...
object ParamsResourceProjectsTenantsJobsCreate {
  
  inline def apply(): ParamsResourceProjectsTenantsJobsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsTenantsJobsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsTenantsJobsCreate](x: Self) {
