...
trait SchemaSearchJobsRequest extends StObject {
  ...
  /**
    ...
    */
  var keywordMatchMode: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var maxPageSize: js.UndefOr[Double | Null] = js.undefined
...
object SchemaSearchJobsRequest {
  ...
  extension [Self <: SchemaSearchJobsRequest](x: Self) {
    ...
    inline def setKeywordMatchModeNull: Self = StObject.set(x, "keywordMatchMode", null)
    ...
    inline def setMaxPageSizeNull: Self = StObject.set(x, "maxPageSize", null)
