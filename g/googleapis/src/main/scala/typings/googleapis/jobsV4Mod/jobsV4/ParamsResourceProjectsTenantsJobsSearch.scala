...
trait ParamsResourceProjectsTenantsJobsSearch
  extends StObject
...
object ParamsResourceProjectsTenantsJobsSearch {
  
  inline def apply(): ParamsResourceProjectsTenantsJobsSearch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsTenantsJobsSearch]
  }
  
  extension [Self <: ParamsResourceProjectsTenantsJobsSearch](x: Self) {
