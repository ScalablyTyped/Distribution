...
/**
  ...
  */
@js.native
trait Schema$MetricDescriptorMetadata extends js.Object {
  /**
...
object Schema$MetricDescriptorMetadata {
  @scala.inline
  def apply(ingestDelay: String = null, launchStage: String = null, samplePeriod: String = null): Schema$MetricDescriptorMetadata = {
    ...
    __obj.asInstanceOf[Schema$MetricDescriptorMetadata]
  }
}
