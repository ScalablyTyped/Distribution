...
/**
  ...
  */
@js.native
trait Schema$MonitoredResource extends js.Object {
  /**
...
object Schema$MonitoredResource {
  @scala.inline
  def apply(labels: StringDictionary[String] = null, `type`: String = null): Schema$MonitoredResource = {
    val __obj = js.Dynamic.literal()
    if (labels != null) __obj.updateDynamic("labels")(labels.asInstanceOf[js.Any])
    if (`type` != null) __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$MonitoredResource]
  }
}
