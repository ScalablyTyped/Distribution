...
/**
  ...
  */
@js.native
trait Schema$WriteLogEntriesRequest extends js.Object {
  /**
...
object Schema$WriteLogEntriesRequest {
  @scala.inline
  def apply(
    dryRun: js.UndefOr[Boolean] = js.undefined,
    entries: js.Array[Schema$LogEntry] = null,
    labels: StringDictionary[String] = null,
    logName: String = null,
    partialSuccess: js.UndefOr[Boolean] = js.undefined,
    resource: Schema$MonitoredResource = null
  ): Schema$WriteLogEntriesRequest = {
    ...
    __obj.asInstanceOf[Schema$WriteLogEntriesRequest]
  }
}
