...
/**
  ...
  */
@js.native
trait Schema$MenuItem extends js.Object {
  /**
  ...
  /**
    ...
    * be shown.
    */
  var values: js.UndefOr[js.Array[Schema$MenuValue]] = js.native
}

object Schema$MenuItem {
  @scala.inline
  def apply(
    action: String = null,
    ...
    values: js.Array[Schema$MenuValue] = null
  ): Schema$MenuItem = {
    ...
    __obj.asInstanceOf[Schema$MenuItem]
  }
}
