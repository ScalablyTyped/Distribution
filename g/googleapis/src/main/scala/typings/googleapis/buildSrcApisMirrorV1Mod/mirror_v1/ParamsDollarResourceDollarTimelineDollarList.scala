...
@js.native
trait ParamsDollarResourceDollarTimelineDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTimelineDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarTimelineDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTimelineDollarList]
  }
}
