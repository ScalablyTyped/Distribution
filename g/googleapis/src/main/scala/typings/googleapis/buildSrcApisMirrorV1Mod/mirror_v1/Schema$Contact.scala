...
/**
  ...
  */
@js.native
trait Schema$Contact extends js.Object {
  /**
    ...
    * particular command.
    */
  var acceptCommands: js.UndefOr[js.Array[Schema$Command]] = js.native
  /**
...
object Schema$Contact {
  @scala.inline
  def apply(
    acceptCommands: js.Array[Schema$Command] = null,
    ...
    __obj.asInstanceOf[Schema$Contact]
  }
}
