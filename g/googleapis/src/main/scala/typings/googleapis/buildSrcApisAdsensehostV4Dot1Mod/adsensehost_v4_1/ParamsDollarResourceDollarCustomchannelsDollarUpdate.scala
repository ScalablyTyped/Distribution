...
@js.native
trait ParamsDollarResourceDollarCustomchannelsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCustomchannelsDollarUpdate {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCustomchannelsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCustomchannelsDollarUpdate]
  }
}
