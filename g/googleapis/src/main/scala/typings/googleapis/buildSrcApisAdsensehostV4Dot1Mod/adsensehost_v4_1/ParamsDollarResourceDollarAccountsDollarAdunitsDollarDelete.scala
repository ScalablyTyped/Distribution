...
@js.native
trait ParamsDollarResourceDollarAccountsDollarAdunitsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountsDollarAdunitsDollarDelete {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarAdunitsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarAdunitsDollarDelete]
  }
}
