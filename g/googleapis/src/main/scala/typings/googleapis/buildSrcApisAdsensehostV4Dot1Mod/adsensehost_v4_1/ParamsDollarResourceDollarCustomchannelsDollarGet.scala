...
@js.native
trait ParamsDollarResourceDollarCustomchannelsDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarCustomchannelsDollarGet {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarCustomchannelsDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarCustomchannelsDollarGet]
  }
}
