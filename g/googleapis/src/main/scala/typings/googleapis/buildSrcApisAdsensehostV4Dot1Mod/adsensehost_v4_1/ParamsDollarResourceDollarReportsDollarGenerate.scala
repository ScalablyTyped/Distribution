...
@js.native
trait ParamsDollarResourceDollarReportsDollarGenerate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarReportsDollarGenerate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarReportsDollarGenerate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarReportsDollarGenerate]
  }
}
