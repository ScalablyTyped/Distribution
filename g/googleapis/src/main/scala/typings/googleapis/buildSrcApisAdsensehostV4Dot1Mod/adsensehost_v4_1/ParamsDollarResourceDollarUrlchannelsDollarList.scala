...
@js.native
trait ParamsDollarResourceDollarUrlchannelsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarUrlchannelsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarUrlchannelsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarUrlchannelsDollarList]
  }
}
