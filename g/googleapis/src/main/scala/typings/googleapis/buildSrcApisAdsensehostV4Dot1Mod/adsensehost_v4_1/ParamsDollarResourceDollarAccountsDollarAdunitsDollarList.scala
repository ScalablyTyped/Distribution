...
@js.native
trait ParamsDollarResourceDollarAccountsDollarAdunitsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountsDollarAdunitsDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarAdunitsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarAdunitsDollarList]
  }
}
