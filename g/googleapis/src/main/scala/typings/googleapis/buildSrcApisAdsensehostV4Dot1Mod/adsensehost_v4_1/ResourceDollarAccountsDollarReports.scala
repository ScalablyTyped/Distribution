...
class ResourceDollarAccountsDollarReports protected () extends js.Object {
  ...
  def generate(params: ParamsDollarResourceDollarAccountsDollarReportsDollarGenerate): GaxiosPromise[Schema$Report] = js.native
  def generate(
  ...
  def generate(params: ParamsDollarResourceDollarAccountsDollarReportsDollarGenerate, options: MethodOptions): GaxiosPromise[Schema$Report] = js.native
  def generate(
    params: ParamsDollarResourceDollarAccountsDollarReportsDollarGenerate,
