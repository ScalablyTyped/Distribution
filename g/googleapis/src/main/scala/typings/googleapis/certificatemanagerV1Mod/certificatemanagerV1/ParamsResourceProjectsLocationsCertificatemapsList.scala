...
trait ParamsResourceProjectsLocationsCertificatemapsList
  extends StObject
...
object ParamsResourceProjectsLocationsCertificatemapsList {
  
  inline def apply(): ParamsResourceProjectsLocationsCertificatemapsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsCertificatemapsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsCertificatemapsList](x: Self) {
