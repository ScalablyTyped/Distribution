...
@JSImport("googleapis/build/src/apis/certificatemanager/v1", "certificatemanager_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  var certificateMaps: ResourceProjectsLocationsCertificatemaps = js.native
  
  var certificates: ResourceProjectsLocationsCertificates = js.native
  
  var context: APIRequestContext = js.native
  
  var dnsAuthorizations: ResourceProjectsLocationsDnsauthorizations = js.native
