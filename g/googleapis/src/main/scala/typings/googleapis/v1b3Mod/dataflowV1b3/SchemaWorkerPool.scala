...
object SchemaWorkerPool {
  ...
  extension [Self <: SchemaWorkerPool](x: Self) {
    ...
    inline def setDataDisksVarargs(value: SchemaDisk*): Self = StObject.set(x, "dataDisks", js.Array(value :_*))
    ...
    inline def setPoolArgs(value: StringDictionary[js.Any]): Self = StObject.set(x, "poolArgs", value.asInstanceOf[js.Any])
