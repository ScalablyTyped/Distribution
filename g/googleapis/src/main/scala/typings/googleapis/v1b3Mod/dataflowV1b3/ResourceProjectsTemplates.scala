...
@js.native
open class ResourceProjectsTemplates protected () extends StObject {
  ...
  /**
    ...
    */
  def create(params: ParamsResourceProjectsTemplatesCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceProjectsTemplatesCreate,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def get(params: ParamsResourceProjectsTemplatesGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceProjectsTemplatesGet,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def launch(params: ParamsResourceProjectsTemplatesLaunch, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def launch(
    params: ParamsResourceProjectsTemplatesLaunch,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
