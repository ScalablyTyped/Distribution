...
trait SchemaStreamingSetupTask extends StObject {
  ...
  /**
    ...
    */
  var drain: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * The TCP port on which the worker should listen for messages from other streaming computation workers.
    */
  var receiveWorkPort: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var workerHarnessPort: js.UndefOr[Double | Null] = js.undefined
}
object SchemaStreamingSetupTask {
  ...
  extension [Self <: SchemaStreamingSetupTask](x: Self) {
    ...
    inline def setDrainNull: Self = StObject.set(x, "drain", null)
    ...
    inline def setReceiveWorkPortNull: Self = StObject.set(x, "receiveWorkPort", null)
    ...
    inline def setWorkerHarnessPortNull: Self = StObject.set(x, "workerHarnessPort", null)
