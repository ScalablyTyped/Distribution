...
trait ParamsResourceProjectsLocationsJobsMessagesList
  extends StObject
...
object ParamsResourceProjectsLocationsJobsMessagesList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsJobsMessagesListMutableBuilder[Self <: ParamsResourceProjectsLocationsJobsMessagesList] (val x: Self) extends AnyVal {
