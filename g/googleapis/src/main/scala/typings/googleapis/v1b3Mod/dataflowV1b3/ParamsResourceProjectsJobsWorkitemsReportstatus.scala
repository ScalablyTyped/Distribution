...
@js.native
trait ParamsResourceProjectsJobsWorkitemsReportstatus extends StandardParameters {
...
object ParamsResourceProjectsJobsWorkitemsReportstatus {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsJobsWorkitemsReportstatusOps[Self <: ParamsResourceProjectsJobsWorkitemsReportstatus] (val x: Self) extends AnyVal {
