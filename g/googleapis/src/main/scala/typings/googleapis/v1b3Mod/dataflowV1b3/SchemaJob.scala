...
trait SchemaJob extends StObject {
  ...
  /**
    ...
    */
  var clientRequestId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var createdFromSnapshotId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var replaceJobId: js.UndefOr[String | Null] = js.undefined
  
  /**
    * If another job is an update of this job (and thus, this job is in `JOB_STATE_UPDATED`), this field contains the ID of that job.
    */
  var replacedByJobId: js.UndefOr[String | Null] = js.undefined
  
  /**
    * The job's requested state. `UpdateJob` may be used to switch between the `JOB_STATE_STOPPED` and `JOB_STATE_RUNNING` states, by setting requested_state. `UpdateJob` may also be used to directly set a job's requested state to `JOB_STATE_CANCELLED` or `JOB_STATE_DONE`, irrevocably terminating the job if it has not already reached a terminal state.
    */
  var requestedState: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var stepsLocation: js.UndefOr[String | Null] = js.undefined
  
  /**
    * A set of files the system should be aware of that are used for temporary storage. These temporary files will be removed on job completion. No duplicates are allowed. No file patterns are supported. The supported files are: Google Cloud Storage: storage.googleapis.com/{bucket\}/{object\} bucket.storage.googleapis.com/{object\}
    */
  var tempFiles: js.UndefOr[js.Array[String] | Null] = js.undefined
...
object SchemaJob {
  ...
  extension [Self <: SchemaJob](x: Self) {
    ...
    inline def setClientRequestIdNull: Self = StObject.set(x, "clientRequestId", null)
    ...
    inline def setCreatedFromSnapshotIdNull: Self = StObject.set(x, "createdFromSnapshotId", null)
    ...
    inline def setReplaceJobIdNull: Self = StObject.set(x, "replaceJobId", null)
    ...
    inline def setReplacedByJobIdNull: Self = StObject.set(x, "replacedByJobId", null)
    ...
    inline def setRequestedStateNull: Self = StObject.set(x, "requestedState", null)
    ...
    inline def setStageStatesVarargs(value: SchemaExecutionStageState*): Self = StObject.set(x, "stageStates", js.Array(value*))
    ...
    inline def setStepsLocationNull: Self = StObject.set(x, "stepsLocation", null)
    ...
    inline def setTempFilesNull: Self = StObject.set(x, "tempFiles", null)
