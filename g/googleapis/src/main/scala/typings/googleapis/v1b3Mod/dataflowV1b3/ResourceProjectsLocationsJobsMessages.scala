...
@js.native
open class ResourceProjectsLocationsJobsMessages protected () extends StObject {
  ...
  /**
    ...
    */
  def list(params: ParamsResourceProjectsLocationsJobsMessagesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsLocationsJobsMessagesList,
