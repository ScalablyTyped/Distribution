...
object ParamsResourceProjectsTemplatesLaunch {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsTemplatesLaunch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsTemplatesLaunch]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsTemplatesLaunchMutableBuilder[Self <: ParamsResourceProjectsTemplatesLaunch] (val x: Self) extends AnyVal {
