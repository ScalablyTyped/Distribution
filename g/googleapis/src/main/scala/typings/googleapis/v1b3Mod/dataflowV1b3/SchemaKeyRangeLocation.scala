...
trait SchemaKeyRangeLocation extends StObject {
  ...
  /**
    ...
    */
  var deliveryEndpoint: js.UndefOr[String | Null] = js.undefined
  
  /**
    * DEPRECATED. The location of the persistent state for this range, as a persistent directory in the worker local filesystem.
    */
  var deprecatedPersistentDirectory: js.UndefOr[String | Null] = js.undefined
...
object SchemaKeyRangeLocation {
  ...
  extension [Self <: SchemaKeyRangeLocation](x: Self) {
    ...
    inline def setDeliveryEndpointNull: Self = StObject.set(x, "deliveryEndpoint", null)
    ...
    inline def setDeprecatedPersistentDirectoryNull: Self = StObject.set(x, "deprecatedPersistentDirectory", null)
