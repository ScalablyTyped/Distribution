...
@js.native
class ResourceProjectsDatabasesCollectiongroupsFields protected () extends StObject {
  ...
  def get(
    params: ParamsResourceProjectsDatabasesCollectiongroupsFieldsGet,
    options: BodyResponseCallback[SchemaGoogleFirestoreAdminV1Field],
    callback: BodyResponseCallback[SchemaGoogleFirestoreAdminV1Field]
  ): Unit = js.native
  ...
  def list(
    params: ParamsResourceProjectsDatabasesCollectiongroupsFieldsList,
    options: BodyResponseCallback[SchemaGoogleFirestoreAdminV1ListFieldsResponse],
    callback: BodyResponseCallback[SchemaGoogleFirestoreAdminV1ListFieldsResponse]
  ): Unit = js.native
