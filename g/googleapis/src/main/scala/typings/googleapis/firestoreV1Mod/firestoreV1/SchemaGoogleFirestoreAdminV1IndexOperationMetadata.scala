...
/**
  ...
  */
trait SchemaGoogleFirestoreAdminV1IndexOperationMetadata extends StObject {
...
object SchemaGoogleFirestoreAdminV1IndexOperationMetadata {
  ...
  @scala.inline
  implicit class SchemaGoogleFirestoreAdminV1IndexOperationMetadataMutableBuilder[Self <: SchemaGoogleFirestoreAdminV1IndexOperationMetadata] (val x: Self) extends AnyVal {
