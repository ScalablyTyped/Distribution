...
object SchemaGoogleFirestoreAdminV1IndexConfig {
  ...
  inline def apply(): SchemaGoogleFirestoreAdminV1IndexConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirestoreAdminV1IndexConfig]
  }
  
  extension [Self <: SchemaGoogleFirestoreAdminV1IndexConfig](x: Self) {
    ...
    inline def setIndexesVarargs(value: SchemaGoogleFirestoreAdminV1Index*): Self = StObject.set(x, "indexes", js.Array(value :_*))
