...
import typings.googleapis.buildSrcApisOauth2V1Mod.oauth2_v1.Oauth2
import typings.googleapis.buildSrcApisOauth2V1Mod.oauth2_v1.Options
...
object buildSrcApisOauth2Mod extends js.Object {
  ...
  def oauth2(options: typings.googleapis.buildSrcApisOauth2V2Mod.oauth2_v2.Options): typings.googleapis.buildSrcApisOauth2V2Mod.oauth2_v2.Oauth2 = js.native
  @JSName("oauth2")
  def oauth2_v1(version: v1): Oauth2 = js.native
  @JSName("oauth2")
  def oauth2_v2(version: v2): typings.googleapis.buildSrcApisOauth2V2Mod.oauth2_v2.Oauth2 = js.native
  @js.native
    ...
    object v2
      extends TopLevel[
              Instantiable2[
                ...
                typings.googleapis.buildSrcApisOauth2V2Mod.oauth2_v2.Oauth2
              ]
            ]
