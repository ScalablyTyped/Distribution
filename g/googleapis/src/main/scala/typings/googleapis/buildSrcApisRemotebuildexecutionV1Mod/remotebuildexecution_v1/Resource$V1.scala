...
class Resource$V1 protected () extends js.Object {
  ...
  /**
    ...
    */
  def watch(): GaxiosPromise[Schema$GoogleWatcherV1ChangeBatch] = js.native
  def watch(callback: BodyResponseCallback[Schema$GoogleWatcherV1ChangeBatch]): Unit = js.native
  def watch(params: ParamsDollarResourceDollarV1DollarWatch): GaxiosPromise[Schema$GoogleWatcherV1ChangeBatch] = js.native
  def watch(
    params: ParamsDollarResourceDollarV1DollarWatch,
    callback: BodyResponseCallback[Schema$GoogleWatcherV1ChangeBatch]
  ): Unit = js.native
  def watch(
    params: ParamsDollarResourceDollarV1DollarWatch,
    options: BodyResponseCallback[Schema$GoogleWatcherV1ChangeBatch],
    callback: BodyResponseCallback[Schema$GoogleWatcherV1ChangeBatch]
  ): Unit = js.native
  def watch(params: ParamsDollarResourceDollarV1DollarWatch, options: MethodOptions): GaxiosPromise[Schema$GoogleWatcherV1ChangeBatch] = js.native
  def watch(
    params: ParamsDollarResourceDollarV1DollarWatch,
