...
object SchemaGoogleCloudServicebrokerV1alpha1Service {
  ...
  inline def apply(): SchemaGoogleCloudServicebrokerV1alpha1Service = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudServicebrokerV1alpha1Service]
  }
  
  extension [Self <: SchemaGoogleCloudServicebrokerV1alpha1Service](x: Self) {
    ...
    inline def setDashboard_client(value: SchemaGoogleCloudServicebrokerV1alpha1DashboardClient): Self = StObject.set(x, "dashboard_client", value.asInstanceOf[js.Any])
    ...
    inline def setInstance_retrievable(value: Boolean): Self = StObject.set(x, "instance_retrievable", value.asInstanceOf[js.Any])
    
    inline def setInstance_retrievableUndefined: Self = StObject.set(x, "instance_retrievable", js.undefined)
    ...
    inline def setPlans(value: js.Array[SchemaGoogleCloudServicebrokerV1alpha1Plan]): Self = StObject.set(x, "plans", value.asInstanceOf[js.Any])
    
    inline def setPlansUndefined: Self = StObject.set(x, "plans", js.undefined)
    
    inline def setPlansVarargs(value: SchemaGoogleCloudServicebrokerV1alpha1Plan*): Self = StObject.set(x, "plans", js.Array(value :_*))
