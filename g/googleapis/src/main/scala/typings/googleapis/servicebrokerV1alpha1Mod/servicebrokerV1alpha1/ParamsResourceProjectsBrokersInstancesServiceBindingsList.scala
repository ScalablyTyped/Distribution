...
trait ParamsResourceProjectsBrokersInstancesServiceBindingsList
  extends StObject
...
object ParamsResourceProjectsBrokersInstancesServiceBindingsList {
  ...
  inline def apply(): ParamsResourceProjectsBrokersInstancesServiceBindingsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsBrokersInstancesServiceBindingsList]
  }
  
  extension [Self <: ParamsResourceProjectsBrokersInstancesServiceBindingsList](x: Self) {
