...
object SchemaGoogleCloudServicebrokerV1alpha1CreateBindingResponse {
  ...
  inline def apply(): SchemaGoogleCloudServicebrokerV1alpha1CreateBindingResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudServicebrokerV1alpha1CreateBindingResponse]
  }
  
  extension [Self <: SchemaGoogleCloudServicebrokerV1alpha1CreateBindingResponse](x: Self) {
