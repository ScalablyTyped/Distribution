...
object SchemaGoogleCloudServicebrokerV1alpha1GetBindingResponse {
  ...
  inline def apply(): SchemaGoogleCloudServicebrokerV1alpha1GetBindingResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudServicebrokerV1alpha1GetBindingResponse]
  }
  
  extension [Self <: SchemaGoogleCloudServicebrokerV1alpha1GetBindingResponse](x: Self) {
