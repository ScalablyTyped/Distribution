...
object ParamsResourceProjectsConfigsVariablesUpdate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsConfigsVariablesUpdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsConfigsVariablesUpdate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsConfigsVariablesUpdateMutableBuilder[Self <: ParamsResourceProjectsConfigsVariablesUpdate] (val x: Self) extends AnyVal {
