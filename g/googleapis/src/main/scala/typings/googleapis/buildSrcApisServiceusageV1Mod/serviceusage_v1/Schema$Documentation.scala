...
/**
  ...
  */
@js.native
trait Schema$Documentation extends js.Object {
  /**
  ...
  /**
    ...
    */
  var pages: js.UndefOr[js.Array[Schema$Page]] = js.native
  /**
    * A list of documentation rules that apply to individual API elements.
    * **NOTE:** All service configuration rules follow &quot;last one
    * wins&quot; order.
    */
  var rules: js.UndefOr[js.Array[Schema$DocumentationRule]] = js.native
  /**
...
object Schema$Documentation {
  ...
  def apply(
    ...
    pages: js.Array[Schema$Page] = null,
    rules: js.Array[Schema$DocumentationRule] = null,
    summary: String = null
    ...
    __obj.asInstanceOf[Schema$Documentation]
  }
}
