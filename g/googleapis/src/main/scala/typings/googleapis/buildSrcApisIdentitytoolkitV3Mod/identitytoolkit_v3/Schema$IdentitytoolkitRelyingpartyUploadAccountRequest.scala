...
/**
  ...
  */
@js.native
trait Schema$IdentitytoolkitRelyingpartyUploadAccountRequest extends js.Object {
  /**
...
object Schema$IdentitytoolkitRelyingpartyUploadAccountRequest {
  @scala.inline
  def apply(
    ...
    users: js.Array[Schema$UserInfo] = null
  ): Schema$IdentitytoolkitRelyingpartyUploadAccountRequest = {
    ...
    __obj.asInstanceOf[Schema$IdentitytoolkitRelyingpartyUploadAccountRequest]
  }
}
