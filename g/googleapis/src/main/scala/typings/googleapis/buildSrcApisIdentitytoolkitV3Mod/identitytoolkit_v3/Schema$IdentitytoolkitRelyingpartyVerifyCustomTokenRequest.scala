...
/**
  ...
  */
@js.native
trait Schema$IdentitytoolkitRelyingpartyVerifyCustomTokenRequest extends js.Object {
  /**
...
object Schema$IdentitytoolkitRelyingpartyVerifyCustomTokenRequest {
  @scala.inline
  def apply(
    ...
    token: String = null
  ): Schema$IdentitytoolkitRelyingpartyVerifyCustomTokenRequest = {
    ...
    __obj.asInstanceOf[Schema$IdentitytoolkitRelyingpartyVerifyCustomTokenRequest]
  }
}
