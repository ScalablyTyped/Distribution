...
@js.native
trait ParamsDollarResourceDollarRelyingpartyDollarGetprojectconfig extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarRelyingpartyDollarGetprojectconfig {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarRelyingpartyDollarGetprojectconfig = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarRelyingpartyDollarGetprojectconfig]
  }
}
