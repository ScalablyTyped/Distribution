...
/**
  ...
  */
@js.native
trait Schema$SignupNewUserResponse extends js.Object {
  /**
...
object Schema$SignupNewUserResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$SignupNewUserResponse]
  }
}
