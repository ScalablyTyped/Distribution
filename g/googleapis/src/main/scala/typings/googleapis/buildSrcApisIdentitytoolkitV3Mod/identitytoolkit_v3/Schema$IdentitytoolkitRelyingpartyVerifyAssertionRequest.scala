...
/**
  ...
  */
@js.native
trait Schema$IdentitytoolkitRelyingpartyVerifyAssertionRequest extends js.Object {
  /**
...
object Schema$IdentitytoolkitRelyingpartyVerifyAssertionRequest {
  @scala.inline
  def apply(
  ...
  ): Schema$IdentitytoolkitRelyingpartyVerifyAssertionRequest = {
    ...
    __obj.asInstanceOf[Schema$IdentitytoolkitRelyingpartyVerifyAssertionRequest]
  }
}
