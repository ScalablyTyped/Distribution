...
/**
  ...
  */
@js.native
trait Schema$IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest extends js.Object {
...
object Schema$IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest {
  @scala.inline
  def apply(
    code: String = null,
    idToken: String = null,
  ...
  ): Schema$IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest = {
    ...
    __obj.asInstanceOf[Schema$IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest]
  }
}
