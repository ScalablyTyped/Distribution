...
/**
  ...
  */
@js.native
trait Schema$IdentitytoolkitRelyingpartyCreateAuthUriRequest extends js.Object {
  /**
...
object Schema$IdentitytoolkitRelyingpartyCreateAuthUriRequest {
  @scala.inline
  def apply(
    appId: String = null,
  ...
  ): Schema$IdentitytoolkitRelyingpartyCreateAuthUriRequest = {
    ...
    __obj.asInstanceOf[Schema$IdentitytoolkitRelyingpartyCreateAuthUriRequest]
  }
}
