...
/**
  ...
  */
@js.native
trait Schema$IdentitytoolkitRelyingpartyDownloadAccountRequest extends js.Object {
  /**
...
object Schema$IdentitytoolkitRelyingpartyDownloadAccountRequest {
  @scala.inline
  def apply(
  ...
  ): Schema$IdentitytoolkitRelyingpartyDownloadAccountRequest = {
    ...
    __obj.asInstanceOf[Schema$IdentitytoolkitRelyingpartyDownloadAccountRequest]
  }
}
