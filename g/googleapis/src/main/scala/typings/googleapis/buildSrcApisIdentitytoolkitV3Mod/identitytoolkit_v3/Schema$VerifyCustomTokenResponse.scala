...
/**
  ...
  */
@js.native
trait Schema$VerifyCustomTokenResponse extends js.Object {
  /**
...
object Schema$VerifyCustomTokenResponse {
  @scala.inline
  def apply(
  ...
  ): Schema$VerifyCustomTokenResponse = {
    ...
    __obj.asInstanceOf[Schema$VerifyCustomTokenResponse]
  }
}
