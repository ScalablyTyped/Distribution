...
object ParamsResourcePhotoGet {
  ...
  @scala.inline
  implicit class ParamsResourcePhotoGetOps[Self <: ParamsResourcePhotoGet] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setPhotoId(value: String): Self = this.set("photoId", value.asInstanceOf[js.Any])
    @scala.inline
