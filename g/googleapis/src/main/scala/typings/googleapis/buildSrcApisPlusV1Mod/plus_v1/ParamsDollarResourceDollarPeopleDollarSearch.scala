...
@js.native
trait ParamsDollarResourceDollarPeopleDollarSearch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarPeopleDollarSearch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarPeopleDollarSearch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPeopleDollarSearch]
  }
}
