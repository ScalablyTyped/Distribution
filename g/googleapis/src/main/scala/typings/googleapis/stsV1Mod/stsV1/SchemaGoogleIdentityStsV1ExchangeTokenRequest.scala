...
trait SchemaGoogleIdentityStsV1ExchangeTokenRequest extends StObject {
  ...
  /**
    ...
    */
  var grantType: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var requestedTokenType: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var subjectToken: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var subjectTokenType: js.UndefOr[String | Null] = js.undefined
}
object SchemaGoogleIdentityStsV1ExchangeTokenRequest {
  
  inline def apply(): SchemaGoogleIdentityStsV1ExchangeTokenRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleIdentityStsV1ExchangeTokenRequest]
  }
  
  extension [Self <: SchemaGoogleIdentityStsV1ExchangeTokenRequest](x: Self) {
    ...
    inline def setGrantTypeNull: Self = StObject.set(x, "grantType", null)
    ...
    inline def setRequestedTokenTypeNull: Self = StObject.set(x, "requestedTokenType", null)
    ...
    inline def setSubjectTokenNull: Self = StObject.set(x, "subjectToken", null)
    
    inline def setSubjectTokenType(value: String): Self = StObject.set(x, "subjectTokenType", value.asInstanceOf[js.Any])
    
    inline def setSubjectTokenTypeNull: Self = StObject.set(x, "subjectTokenType", null)
