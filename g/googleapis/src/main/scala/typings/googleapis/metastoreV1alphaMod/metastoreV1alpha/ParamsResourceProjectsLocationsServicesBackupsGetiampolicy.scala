...
trait ParamsResourceProjectsLocationsServicesBackupsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsServicesBackupsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsServicesBackupsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsServicesBackupsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsServicesBackupsGetiampolicy](x: Self) {
