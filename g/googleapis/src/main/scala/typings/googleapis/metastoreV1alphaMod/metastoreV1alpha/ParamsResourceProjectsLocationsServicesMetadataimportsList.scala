...
trait ParamsResourceProjectsLocationsServicesMetadataimportsList
  extends StObject
...
object ParamsResourceProjectsLocationsServicesMetadataimportsList {
  
  inline def apply(): ParamsResourceProjectsLocationsServicesMetadataimportsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsServicesMetadataimportsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsServicesMetadataimportsList](x: Self) {
