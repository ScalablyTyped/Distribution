...
trait ParamsResourceProjectsLocationsFederationsList
  extends StObject
...
object ParamsResourceProjectsLocationsFederationsList {
  
  inline def apply(): ParamsResourceProjectsLocationsFederationsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsFederationsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsFederationsList](x: Self) {
