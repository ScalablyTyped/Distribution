...
trait ParamsResourceOrganizationsApprovalrequestsList
  extends StObject
...
object ParamsResourceOrganizationsApprovalrequestsList {
  
  inline def apply(): ParamsResourceOrganizationsApprovalrequestsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrganizationsApprovalrequestsList]
  }
  
  extension [Self <: ParamsResourceOrganizationsApprovalrequestsList](x: Self) {
