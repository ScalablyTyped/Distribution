...
trait ParamsResourceFoldersApprovalrequestsList
  extends StObject
...
object ParamsResourceFoldersApprovalrequestsList {
  
  inline def apply(): ParamsResourceFoldersApprovalrequestsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersApprovalrequestsList]
  }
  
  extension [Self <: ParamsResourceFoldersApprovalrequestsList](x: Self) {
