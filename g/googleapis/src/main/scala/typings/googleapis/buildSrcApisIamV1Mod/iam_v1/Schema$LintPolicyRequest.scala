...
/**
  ...
  */
@js.native
trait Schema$LintPolicyRequest extends js.Object {
  /**
    ...
    * error.
    */
  var binding: js.UndefOr[Schema$Binding] = js.native
  /**
...
object Schema$LintPolicyRequest {
  @scala.inline
  def apply(
    binding: Schema$Binding = null,
    condition: Schema$Expr = null,
    context: StringDictionary[js.Any] = null,
    fullResourceName: String = null,
    policy: Schema$Policy = null
  ): Schema$LintPolicyRequest = {
    ...
    __obj.asInstanceOf[Schema$LintPolicyRequest]
  }
}
