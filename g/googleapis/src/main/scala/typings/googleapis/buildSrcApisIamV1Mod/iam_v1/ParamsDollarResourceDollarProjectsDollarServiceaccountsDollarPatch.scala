...
@js.native
trait ParamsDollarResourceDollarProjectsDollarServiceaccountsDollarPatch extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$PatchServiceAccountRequest] = js.native
}
