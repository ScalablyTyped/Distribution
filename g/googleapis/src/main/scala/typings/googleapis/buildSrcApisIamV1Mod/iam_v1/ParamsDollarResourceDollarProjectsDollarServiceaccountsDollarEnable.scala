...
@js.native
trait ParamsDollarResourceDollarProjectsDollarServiceaccountsDollarEnable extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$EnableServiceAccountRequest] = js.native
}
