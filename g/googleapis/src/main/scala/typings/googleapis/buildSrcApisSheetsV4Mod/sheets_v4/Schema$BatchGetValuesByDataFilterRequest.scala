...
/**
  ...
  */
@js.native
trait Schema$BatchGetValuesByDataFilterRequest extends js.Object {
  /**
...
object Schema$BatchGetValuesByDataFilterRequest {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$BatchGetValuesByDataFilterRequest]
  }
}
