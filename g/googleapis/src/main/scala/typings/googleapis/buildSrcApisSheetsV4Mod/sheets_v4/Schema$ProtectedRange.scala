...
/**
  ...
  */
@js.native
trait Schema$ProtectedRange extends js.Object {
  /**
  ...
  /**
    ...
    */
  var editors: js.UndefOr[Schema$Editors] = js.native
  /**
  ...
  /**
    ...
    */
  var unprotectedRanges: js.UndefOr[js.Array[Schema$GridRange]] = js.native
  /**
...
object Schema$ProtectedRange {
  @scala.inline
  def apply(
    description: String = null,
    editors: Schema$Editors = null,
    ...
    unprotectedRanges: js.Array[Schema$GridRange] = null,
    warningOnly: js.UndefOr[Boolean] = js.undefined
  ): Schema$ProtectedRange = {
    ...
    __obj.asInstanceOf[Schema$ProtectedRange]
  }
}
