...
/**
  ...
  */
@js.native
trait Schema$DeveloperMetadataLookup extends js.Object {
  /**
  ...
  /**
    ...
    */
  var metadataLocation: js.UndefOr[Schema$DeveloperMetadataLocation] = js.native
  /**
    * Limits the selected developer metadata to that which has a matching
...
object Schema$DeveloperMetadataLookup {
  @scala.inline
  def apply(
    ...
    metadataLocation: Schema$DeveloperMetadataLocation = null,
    metadataValue: String = null,
    visibility: String = null
  ): Schema$DeveloperMetadataLookup = {
    ...
    __obj.asInstanceOf[Schema$DeveloperMetadataLookup]
  }
}
