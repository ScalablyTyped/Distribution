...
/**
  ...
  */
@js.native
trait Schema$ManualRule extends js.Object {
  /**
    * The list of group names and the corresponding items from the source data
    * that map to each group name.
    */
  var groups: js.UndefOr[js.Array[Schema$ManualRuleGroup]] = js.native
}

object Schema$ManualRule {
  @scala.inline
  def apply(groups: js.Array[Schema$ManualRuleGroup] = null): Schema$ManualRule = {
    val __obj = js.Dynamic.literal()
    if (groups != null) __obj.updateDynamic("groups")(groups.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ManualRule]
  }
}
