...
/**
  ...
  */
@js.native
trait Schema$DataFilterValueRange extends js.Object {
  /**
...
object Schema$DataFilterValueRange {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$DataFilterValueRange]
  }
}
