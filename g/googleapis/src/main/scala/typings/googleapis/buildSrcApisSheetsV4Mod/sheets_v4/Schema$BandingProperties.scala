...
/**
  ...
  */
@js.native
trait Schema$BandingProperties extends js.Object {
  /**
    * The first color that is alternating. (Required)
    */
  var firstBandColor: js.UndefOr[Schema$Color] = js.native
  /**
    ...
    */
  var footerColor: js.UndefOr[Schema$Color] = js.native
  /**
    ...
    * normally would.
    */
  var headerColor: js.UndefOr[Schema$Color] = js.native
  /**
    * The second color that is alternating. (Required)
    */
  var secondBandColor: js.UndefOr[Schema$Color] = js.native
}

object Schema$BandingProperties {
  @scala.inline
  def apply(
    firstBandColor: Schema$Color = null,
    footerColor: Schema$Color = null,
    headerColor: Schema$Color = null,
    secondBandColor: Schema$Color = null
  ): Schema$BandingProperties = {
    ...
    __obj.asInstanceOf[Schema$BandingProperties]
  }
}
