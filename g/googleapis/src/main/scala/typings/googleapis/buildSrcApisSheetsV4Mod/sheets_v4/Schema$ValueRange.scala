...
/**
  ...
  */
@js.native
trait Schema$ValueRange extends js.Object {
  /**
...
object Schema$ValueRange {
  @scala.inline
  def apply(majorDimension: String = null, range: String = null, values: js.Array[js.Array[_]] = null): Schema$ValueRange = {
    ...
    __obj.asInstanceOf[Schema$ValueRange]
  }
}
