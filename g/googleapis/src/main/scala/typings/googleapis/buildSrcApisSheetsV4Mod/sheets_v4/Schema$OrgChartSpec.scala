...
/**
  ...
  */
@js.native
trait Schema$OrgChartSpec extends js.Object {
  /**
    * The data containing the labels for all the nodes in the chart.  Labels
    * must be unique.
    */
  var labels: js.UndefOr[Schema$ChartData] = js.native
  /**
    * The color of the org chart nodes.
    */
  var nodeColor: js.UndefOr[Schema$Color] = js.native
  /**
  ...
  /**
    ...
    */
  var parentLabels: js.UndefOr[Schema$ChartData] = js.native
  /**
    * The color of the selected org chart nodes.
    */
  var selectedNodeColor: js.UndefOr[Schema$Color] = js.native
  /**
    ...
    * optional.
    */
  var tooltips: js.UndefOr[Schema$ChartData] = js.native
}

object Schema$OrgChartSpec {
  @scala.inline
  def apply(
    labels: Schema$ChartData = null,
    nodeColor: Schema$Color = null,
    nodeSize: String = null,
    parentLabels: Schema$ChartData = null,
    selectedNodeColor: Schema$Color = null,
    tooltips: Schema$ChartData = null
  ): Schema$OrgChartSpec = {
    ...
    __obj.asInstanceOf[Schema$OrgChartSpec]
  }
}
