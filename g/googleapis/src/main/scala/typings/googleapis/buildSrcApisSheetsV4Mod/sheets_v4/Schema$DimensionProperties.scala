...
/**
  ...
  */
@js.native
trait Schema$DimensionProperties extends js.Object {
  /**
...
object Schema$DimensionProperties {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$DimensionProperties]
  }
}
