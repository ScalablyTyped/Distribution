...
@js.native
trait ParamsDollarResourceDollarVolumesDollarMybooksDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarVolumesDollarMybooksDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarVolumesDollarMybooksDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarVolumesDollarMybooksDollarList]
  }
}
