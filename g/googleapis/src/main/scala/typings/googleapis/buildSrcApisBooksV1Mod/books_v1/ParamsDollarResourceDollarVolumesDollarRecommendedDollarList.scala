...
@js.native
trait ParamsDollarResourceDollarVolumesDollarRecommendedDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarVolumesDollarRecommendedDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    source: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarVolumesDollarRecommendedDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarVolumesDollarRecommendedDollarList]
  }
}
