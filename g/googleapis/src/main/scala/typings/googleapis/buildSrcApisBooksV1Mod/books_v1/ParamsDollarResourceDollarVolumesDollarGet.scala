...
@js.native
trait ParamsDollarResourceDollarVolumesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarVolumesDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarVolumesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarVolumesDollarGet]
  }
}
