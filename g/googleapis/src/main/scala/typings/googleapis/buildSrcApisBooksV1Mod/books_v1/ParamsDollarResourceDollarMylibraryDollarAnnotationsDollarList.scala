...
@js.native
trait ParamsDollarResourceDollarMylibraryDollarAnnotationsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarMylibraryDollarAnnotationsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarMylibraryDollarAnnotationsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMylibraryDollarAnnotationsDollarList]
  }
}
