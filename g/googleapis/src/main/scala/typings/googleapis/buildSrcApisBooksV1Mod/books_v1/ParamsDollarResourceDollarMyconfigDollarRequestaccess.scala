...
@js.native
trait ParamsDollarResourceDollarMyconfigDollarRequestaccess extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarMyconfigDollarRequestaccess {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsDollarResourceDollarMyconfigDollarRequestaccess = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarMyconfigDollarRequestaccess]
  }
}
