...
@js.native
trait ParamsDollarResourceDollarVolumesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarVolumesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarVolumesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarVolumesDollarList]
  }
}
