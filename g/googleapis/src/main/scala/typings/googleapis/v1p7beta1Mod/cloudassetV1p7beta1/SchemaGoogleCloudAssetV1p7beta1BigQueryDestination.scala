...
trait SchemaGoogleCloudAssetV1p7beta1BigQueryDestination extends StObject {
  ...
  /**
    ...
    */
  var partitionSpec: js.UndefOr[SchemaGoogleCloudAssetV1p7beta1PartitionSpec] = js.undefined
  ...
  /**
    ...
    */
  var separateTablesPerAssetType: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaGoogleCloudAssetV1p7beta1BigQueryDestination {
  
  inline def apply(): SchemaGoogleCloudAssetV1p7beta1BigQueryDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudAssetV1p7beta1BigQueryDestination]
  }
  
  extension [Self <: SchemaGoogleCloudAssetV1p7beta1BigQueryDestination](x: Self) {
    ...
    inline def setPartitionSpec(value: SchemaGoogleCloudAssetV1p7beta1PartitionSpec): Self = StObject.set(x, "partitionSpec", value.asInstanceOf[js.Any])
    ...
    inline def setSeparateTablesPerAssetTypeNull: Self = StObject.set(x, "separateTablesPerAssetType", null)
