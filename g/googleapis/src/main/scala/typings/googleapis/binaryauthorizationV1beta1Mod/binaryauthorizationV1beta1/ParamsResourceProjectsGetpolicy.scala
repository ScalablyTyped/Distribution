...
object ParamsResourceProjectsGetpolicy {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsGetpolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsGetpolicy]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsGetpolicyMutableBuilder[Self <: ParamsResourceProjectsGetpolicy] (val x: Self) extends AnyVal {
