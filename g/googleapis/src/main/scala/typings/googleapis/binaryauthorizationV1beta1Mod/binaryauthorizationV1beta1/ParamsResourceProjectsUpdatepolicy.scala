...
object ParamsResourceProjectsUpdatepolicy {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsUpdatepolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsUpdatepolicy]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsUpdatepolicyMutableBuilder[Self <: ParamsResourceProjectsUpdatepolicy] (val x: Self) extends AnyVal {
