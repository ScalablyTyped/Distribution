...
trait Schema$Operation extends js.Object {
  /**
    ...
    */
  var clusterConditions: js.UndefOr[js.Array[Schema$StatusCondition]] = js.native
  /**
  ...
  /**
    ...
    */
  var nodepoolConditions: js.UndefOr[js.Array[Schema$StatusCondition]] = js.native
  /**
    * The operation type.
    */
  ...
  /**
    ...
    */
  var progress: js.UndefOr[Schema$OperationProgress] = js.native
  /**
...
object Schema$Operation {
  @scala.inline
  def apply(
    clusterConditions: js.Array[Schema$StatusCondition] = null,
    detail: String = null,
    endTime: String = null,
    location: String = null,
    name: String = null,
    nodepoolConditions: js.Array[Schema$StatusCondition] = null,
    operationType: String = null,
    progress: Schema$OperationProgress = null,
