...
trait Schema$Cluster extends js.Object {
  ...
  /**
    ...
    */
  var authenticatorGroupsConfig: js.UndefOr[Schema$AuthenticatorGroupsConfig] = js.native
  /**
    * Cluster-level autoscaling configuration.
    */
  var autoscaling: js.UndefOr[Schema$ClusterAutoscaling] = js.native
  /**
    * Configuration for Binary Authorization.
    */
  var binaryAuthorization: js.UndefOr[Schema$BinaryAuthorization] = js.native
  /**
  ...
  /**
    ...
    */
  var databaseEncryption: js.UndefOr[Schema$DatabaseEncryption] = js.native
  /**
    * The default constraint on the maximum number of pods that can be run
    * simultaneously on a node in the node pool of this cluster. Only honored
    * if cluster created with IP Alias support.
    */
  var defaultMaxPodsConstraint: js.UndefOr[Schema$MaxPodsConstraint] = js.native
  /**
  ...
  /**
    ...
    */
  var podSecurityPolicyConfig: js.UndefOr[Schema$PodSecurityPolicyConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var resourceUsageExportConfig: js.UndefOr[Schema$ResourceUsageExportConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var verticalPodAutoscaling: js.UndefOr[Schema$VerticalPodAutoscaling] = js.native
  /**
    * [Output only] The name of the Google Compute Engine
...
object Schema$Cluster {
  ...
  def apply(
    ...
    authenticatorGroupsConfig: Schema$AuthenticatorGroupsConfig = null,
    autoscaling: Schema$ClusterAutoscaling = null,
    binaryAuthorization: Schema$BinaryAuthorization = null,
    ...
    databaseEncryption: Schema$DatabaseEncryption = null,
    defaultMaxPodsConstraint: Schema$MaxPodsConstraint = null,
    ...
    podSecurityPolicyConfig: Schema$PodSecurityPolicyConfig = null,
    ...
    resourceUsageExportConfig: Schema$ResourceUsageExportConfig = null,
    ...
    verticalPodAutoscaling: Schema$VerticalPodAutoscaling = null,
    zone: String = null
  ): Schema$Cluster = {
