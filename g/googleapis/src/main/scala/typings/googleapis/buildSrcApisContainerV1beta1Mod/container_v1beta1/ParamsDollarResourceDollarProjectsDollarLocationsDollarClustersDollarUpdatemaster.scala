...
@js.native
trait ParamsDollarResourceDollarProjectsDollarLocationsDollarClustersDollarUpdatemaster extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$UpdateMasterRequest] = js.native
}
