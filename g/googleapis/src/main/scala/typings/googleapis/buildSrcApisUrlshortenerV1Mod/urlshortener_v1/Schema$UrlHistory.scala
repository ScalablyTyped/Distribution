...
@js.native
trait Schema$UrlHistory extends js.Object {
  /**
    * A list of URL resources.
    */
  var items: js.UndefOr[js.Array[Schema$Url]] = js.native
  /**
...
object Schema$UrlHistory {
  @scala.inline
  def apply(
    items: js.Array[Schema$Url] = null,
    ...
    __obj.asInstanceOf[Schema$UrlHistory]
  }
}
