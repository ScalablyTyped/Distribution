...
@js.native
trait ParamsDollarResourceDollarUrlDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarUrlDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarUrlDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarUrlDollarList]
  }
}
