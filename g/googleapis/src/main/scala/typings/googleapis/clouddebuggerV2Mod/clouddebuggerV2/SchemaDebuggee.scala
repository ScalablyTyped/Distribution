...
trait SchemaDebuggee extends StObject {
  ...
  /**
    ...
    */
  var canaryMode: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var isDisabled: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var isInactive: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var uniquifier: js.UndefOr[String | Null] = js.undefined
}
object SchemaDebuggee {
  
  inline def apply(): SchemaDebuggee = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDebuggee]
  }
  
  extension [Self <: SchemaDebuggee](x: Self) {
    ...
    inline def setCanaryModeNull: Self = StObject.set(x, "canaryMode", null)
    ...
    inline def setExtSourceContexts(value: js.Array[SchemaExtendedSourceContext]): Self = StObject.set(x, "extSourceContexts", value.asInstanceOf[js.Any])
    
    inline def setExtSourceContextsUndefined: Self = StObject.set(x, "extSourceContexts", js.undefined)
    
    inline def setExtSourceContextsVarargs(value: SchemaExtendedSourceContext*): Self = StObject.set(x, "extSourceContexts", js.Array(value*))
    ...
    inline def setIsInactiveNull: Self = StObject.set(x, "isInactive", null)
    ...
    inline def setSourceContexts(value: js.Array[SchemaSourceContext]): Self = StObject.set(x, "sourceContexts", value.asInstanceOf[js.Any])
    
    inline def setSourceContextsUndefined: Self = StObject.set(x, "sourceContexts", js.undefined)
    
    inline def setSourceContextsVarargs(value: SchemaSourceContext*): Self = StObject.set(x, "sourceContexts", js.Array(value*))
    ...
    inline def setUniquifierNull: Self = StObject.set(x, "uniquifier", null)
