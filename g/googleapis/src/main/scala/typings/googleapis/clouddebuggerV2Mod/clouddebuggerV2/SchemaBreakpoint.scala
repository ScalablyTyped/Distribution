...
object SchemaBreakpoint {
  ...
  extension [Self <: SchemaBreakpoint](x: Self) {
    ...
    inline def setEvaluatedExpressionsVarargs(value: SchemaVariable*): Self = StObject.set(x, "evaluatedExpressions", js.Array(value :_*))
    ...
    inline def setStackFramesVarargs(value: SchemaStackFrame*): Self = StObject.set(x, "stackFrames", js.Array(value :_*))
    ...
    inline def setVariableTableVarargs(value: SchemaVariable*): Self = StObject.set(x, "variableTable", js.Array(value :_*))
  }
}
