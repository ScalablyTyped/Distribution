...
trait SchemaBreakpoint extends StObject {
  ...
  /**
    ...
    */
  var canaryExpireTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var finalTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var isFinalState: js.UndefOr[Boolean | Null] = js.undefined
  ...
  /**
    ...
    */
  var logMessageFormat: js.UndefOr[String | Null] = js.undefined
...
object SchemaBreakpoint {
  ...
  inline def apply(): SchemaBreakpoint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBreakpoint]
  }
  
  extension [Self <: SchemaBreakpoint](x: Self) {
    ...
    inline def setCanaryExpireTimeNull: Self = StObject.set(x, "canaryExpireTime", null)
    ...
    inline def setEvaluatedExpressions(value: js.Array[SchemaVariable]): Self = StObject.set(x, "evaluatedExpressions", value.asInstanceOf[js.Any])
    
    inline def setEvaluatedExpressionsUndefined: Self = StObject.set(x, "evaluatedExpressions", js.undefined)
    
    inline def setEvaluatedExpressionsVarargs(value: SchemaVariable*): Self = StObject.set(x, "evaluatedExpressions", js.Array(value*))
    ...
    inline def setFinalTimeNull: Self = StObject.set(x, "finalTime", null)
    ...
    inline def setIsFinalStateNull: Self = StObject.set(x, "isFinalState", null)
    ...
    inline def setLogMessageFormatNull: Self = StObject.set(x, "logMessageFormat", null)
    
    inline def setLogMessageFormatUndefined: Self = StObject.set(x, "logMessageFormat", js.undefined)
    
    inline def setStackFrames(value: js.Array[SchemaStackFrame]): Self = StObject.set(x, "stackFrames", value.asInstanceOf[js.Any])
    
    inline def setStackFramesUndefined: Self = StObject.set(x, "stackFrames", js.undefined)
    
    inline def setStackFramesVarargs(value: SchemaStackFrame*): Self = StObject.set(x, "stackFrames", js.Array(value*))
    ...
    inline def setVariableTable(value: js.Array[SchemaVariable]): Self = StObject.set(x, "variableTable", value.asInstanceOf[js.Any])
    
    inline def setVariableTableUndefined: Self = StObject.set(x, "variableTable", js.undefined)
    
    inline def setVariableTableVarargs(value: SchemaVariable*): Self = StObject.set(x, "variableTable", js.Array(value*))
  }
}
