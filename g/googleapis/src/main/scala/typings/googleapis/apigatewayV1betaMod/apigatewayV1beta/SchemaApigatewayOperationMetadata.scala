...
trait SchemaApigatewayOperationMetadata extends StObject {
  ...
  /**
    ...
    */
  var diagnostics: js.UndefOr[js.Array[SchemaApigatewayOperationMetadataDiagnostic]] = js.undefined
...
object SchemaApigatewayOperationMetadata {
  
  inline def apply(): SchemaApigatewayOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaApigatewayOperationMetadata]
  }
  
  extension [Self <: SchemaApigatewayOperationMetadata](x: Self) {
    ...
    inline def setDiagnostics(value: js.Array[SchemaApigatewayOperationMetadataDiagnostic]): Self = StObject.set(x, "diagnostics", value.asInstanceOf[js.Any])
    
    inline def setDiagnosticsUndefined: Self = StObject.set(x, "diagnostics", js.undefined)
    
    inline def setDiagnosticsVarargs(value: SchemaApigatewayOperationMetadataDiagnostic*): Self = StObject.set(x, "diagnostics", js.Array(value*))
