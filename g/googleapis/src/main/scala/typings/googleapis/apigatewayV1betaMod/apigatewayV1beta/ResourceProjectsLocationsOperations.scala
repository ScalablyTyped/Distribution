...
@JSImport("googleapis/build/src/apis/apigateway/v1beta", "apigateway_v1beta.Resource$Projects$Locations$Operations")
@js.native
open class ResourceProjectsLocationsOperations protected () extends StObject {
  ...
  def get(): GaxiosPromise[SchemaApigatewayOperation] = js.native
  def get(callback: BodyResponseCallback[SchemaApigatewayOperation]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaApigatewayOperation] = js.native
  def get(params: ParamsResourceProjectsLocationsOperationsGet): GaxiosPromise[SchemaApigatewayOperation] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsOperationsGet, options: MethodOptions): GaxiosPromise[SchemaApigatewayOperation] = js.native
  def get(
    params: ParamsResourceProjectsLocationsOperationsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaApigatewayOperation]
  ...
  def list(): GaxiosPromise[SchemaApigatewayListOperationsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaApigatewayListOperationsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaApigatewayListOperationsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsOperationsList): GaxiosPromise[SchemaApigatewayListOperationsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsOperationsList,
    callback: BodyResponseCallback[SchemaApigatewayListOperationsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsOperationsList,
    options: BodyResponseCallback[Readable | SchemaApigatewayListOperationsResponse],
    callback: BodyResponseCallback[Readable | SchemaApigatewayListOperationsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsOperationsList, options: MethodOptions): GaxiosPromise[SchemaApigatewayListOperationsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsOperationsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaApigatewayListOperationsResponse]
