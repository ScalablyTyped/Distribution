...
trait ParamsResourceProjectsLocationsApisGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsApisGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsApisGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisGetiampolicy](x: Self) {
