...
trait SchemaApigatewayOperation extends StObject {
  ...
  /**
    ...
    */
  var error: js.UndefOr[SchemaApigatewayStatus] = js.undefined
...
object SchemaApigatewayOperation {
  
  inline def apply(): SchemaApigatewayOperation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaApigatewayOperation]
  }
  
  extension [Self <: SchemaApigatewayOperation](x: Self) {
    ...
    inline def setError(value: SchemaApigatewayStatus): Self = StObject.set(x, "error", value.asInstanceOf[js.Any])
