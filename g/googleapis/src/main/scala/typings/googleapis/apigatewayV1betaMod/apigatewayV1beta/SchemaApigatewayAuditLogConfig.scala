...
trait SchemaApigatewayAuditLogConfig extends StObject {
...
object SchemaApigatewayAuditLogConfig {
  
  inline def apply(): SchemaApigatewayAuditLogConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaApigatewayAuditLogConfig]
  }
  
  extension [Self <: SchemaApigatewayAuditLogConfig](x: Self) {
