...
trait ParamsResourceProjectsLocationsApisConfigsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsApisConfigsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsApisConfigsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsApisConfigsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsApisConfigsGetiampolicy](x: Self) {
