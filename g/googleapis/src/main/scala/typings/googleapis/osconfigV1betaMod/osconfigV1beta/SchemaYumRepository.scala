...
trait SchemaYumRepository extends StObject {
...
object SchemaYumRepository {
  
  inline def apply(): SchemaYumRepository = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaYumRepository]
  }
  
  extension [Self <: SchemaYumRepository](x: Self) {
