...
trait ParamsResourceProjectsGuestpoliciesList
  extends StObject
...
object ParamsResourceProjectsGuestpoliciesList {
  
  inline def apply(): ParamsResourceProjectsGuestpoliciesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsGuestpoliciesList]
  }
  
  extension [Self <: ParamsResourceProjectsGuestpoliciesList](x: Self) {
