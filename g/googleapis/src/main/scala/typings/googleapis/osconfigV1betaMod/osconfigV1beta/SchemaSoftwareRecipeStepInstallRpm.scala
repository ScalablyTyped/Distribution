...
trait SchemaSoftwareRecipeStepInstallRpm extends StObject {
...
object SchemaSoftwareRecipeStepInstallRpm {
  
  inline def apply(): SchemaSoftwareRecipeStepInstallRpm = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaSoftwareRecipeStepInstallRpm]
  }
  
  extension [Self <: SchemaSoftwareRecipeStepInstallRpm](x: Self) {
