...
@js.native
trait ParamsResourceFoldersGet extends StandardParameters {
  /**
...
object ParamsResourceFoldersGet {
  @scala.inline
  def apply(): ParamsResourceFoldersGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceFoldersGet]
  }
  @scala.inline
  implicit class ParamsResourceFoldersGetOps[Self <: ParamsResourceFoldersGet] (val x: Self) extends AnyVal {
    @scala.inline
