...
trait SchemaNode extends StObject {
  ...
  /**
    ...
    */
  var buildVersion: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var clientFeatures: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var extensions: js.UndefOr[js.Array[SchemaExtension]] = js.undefined
  ...
  /**
    ...
    */
  var listeningAddresses: js.UndefOr[js.Array[SchemaAddress]] = js.undefined
  
  /**
    * Locality specifying where the Envoy instance is running.
    */
  var locality: js.UndefOr[SchemaLocality] = js.undefined
  ...
  /**
    ...
    */
  var userAgentBuildVersion: js.UndefOr[SchemaBuildVersion] = js.undefined
  
  /**
    * Free-form string that identifies the entity requesting config. E.g. "envoy" or "grpc"
    */
  var userAgentName: js.UndefOr[String | Null] = js.undefined
  
  /**
    * Free-form string that identifies the version of the entity requesting config. E.g. "1.12.2" or "abcd1234", or "SpecialEnvoyBuild"
    */
  var userAgentVersion: js.UndefOr[String | Null] = js.undefined
}
object SchemaNode {
  ...
  extension [Self <: SchemaNode](x: Self) {
    ...
    inline def setClientFeaturesNull: Self = StObject.set(x, "clientFeatures", null)
    ...
    inline def setExtensions(value: js.Array[SchemaExtension]): Self = StObject.set(x, "extensions", value.asInstanceOf[js.Any])
    
    inline def setExtensionsUndefined: Self = StObject.set(x, "extensions", js.undefined)
    
    inline def setExtensionsVarargs(value: SchemaExtension*): Self = StObject.set(x, "extensions", js.Array(value*))
    ...
    inline def setListeningAddresses(value: js.Array[SchemaAddress]): Self = StObject.set(x, "listeningAddresses", value.asInstanceOf[js.Any])
    
    inline def setListeningAddressesUndefined: Self = StObject.set(x, "listeningAddresses", js.undefined)
    
    inline def setListeningAddressesVarargs(value: SchemaAddress*): Self = StObject.set(x, "listeningAddresses", js.Array(value*))
    
    inline def setLocality(value: SchemaLocality): Self = StObject.set(x, "locality", value.asInstanceOf[js.Any])
    ...
    inline def setUserAgentBuildVersion(value: SchemaBuildVersion): Self = StObject.set(x, "userAgentBuildVersion", value.asInstanceOf[js.Any])
    ...
    inline def setUserAgentNameNull: Self = StObject.set(x, "userAgentName", null)
    ...
    inline def setUserAgentVersionNull: Self = StObject.set(x, "userAgentVersion", null)
