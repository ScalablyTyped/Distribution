...
trait SchemaStringMatcher extends StObject {
  
  /**
    * The input string must match exactly the string specified here. Examples: * *abc* only matches the value *abc*.
    */
  var exact: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var safeRegex: js.UndefOr[SchemaRegexMatcher] = js.undefined
...
object SchemaStringMatcher {
  
  inline def apply(): SchemaStringMatcher = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaStringMatcher]
  }
  
  extension [Self <: SchemaStringMatcher](x: Self) {
    ...
    inline def setSafeRegex(value: SchemaRegexMatcher): Self = StObject.set(x, "safeRegex", value.asInstanceOf[js.Any])
