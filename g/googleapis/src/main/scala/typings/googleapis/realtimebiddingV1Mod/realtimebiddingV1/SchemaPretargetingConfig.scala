...
trait SchemaPretargetingConfig extends StObject {
  ...
  /**
    ...
    */
  var allowedUserTargetingModes: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var appTargeting: js.UndefOr[SchemaAppTargeting] = js.undefined
  ...
  /**
    ...
    */
  var excludedContentLabelIds: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var geoTargeting: js.UndefOr[SchemaNumericTargetingDimension] = js.undefined
  ...
  /**
    ...
    */
  var includedCreativeDimensions: js.UndefOr[js.Array[SchemaCreativeDimensions]] = js.undefined
  ...
  /**
    ...
    */
  var includedEnvironments: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var includedFormats: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var includedLanguages: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var includedMobileOperatingSystemIds: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var includedPlatforms: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var includedUserIdTypes: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var interstitialTargeting: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var invalidGeoIds: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var publisherTargeting: js.UndefOr[SchemaStringTargetingDimension] = js.undefined
  ...
  /**
    ...
    */
  var userListTargeting: js.UndefOr[SchemaNumericTargetingDimension] = js.undefined
  ...
  /**
    ...
    */
  var verticalTargeting: js.UndefOr[SchemaNumericTargetingDimension] = js.undefined
  ...
  /**
    ...
    */
  var webTargeting: js.UndefOr[SchemaStringTargetingDimension] = js.undefined
}
object SchemaPretargetingConfig {
  ...
  extension [Self <: SchemaPretargetingConfig](x: Self) {
    ...
    inline def setAllowedUserTargetingModesNull: Self = StObject.set(x, "allowedUserTargetingModes", null)
    ...
    inline def setAppTargeting(value: SchemaAppTargeting): Self = StObject.set(x, "appTargeting", value.asInstanceOf[js.Any])
    ...
    inline def setExcludedContentLabelIdsNull: Self = StObject.set(x, "excludedContentLabelIds", null)
    ...
    inline def setGeoTargeting(value: SchemaNumericTargetingDimension): Self = StObject.set(x, "geoTargeting", value.asInstanceOf[js.Any])
    
    inline def setGeoTargetingUndefined: Self = StObject.set(x, "geoTargeting", js.undefined)
    
    inline def setIncludedCreativeDimensions(value: js.Array[SchemaCreativeDimensions]): Self = StObject.set(x, "includedCreativeDimensions", value.asInstanceOf[js.Any])
    
    inline def setIncludedCreativeDimensionsUndefined: Self = StObject.set(x, "includedCreativeDimensions", js.undefined)
    
    inline def setIncludedCreativeDimensionsVarargs(value: SchemaCreativeDimensions*): Self = StObject.set(x, "includedCreativeDimensions", js.Array(value*))
    ...
    inline def setIncludedEnvironmentsNull: Self = StObject.set(x, "includedEnvironments", null)
    ...
    inline def setIncludedFormatsNull: Self = StObject.set(x, "includedFormats", null)
    ...
    inline def setIncludedLanguagesNull: Self = StObject.set(x, "includedLanguages", null)
    ...
    inline def setIncludedMobileOperatingSystemIdsNull: Self = StObject.set(x, "includedMobileOperatingSystemIds", null)
    ...
    inline def setIncludedPlatformsNull: Self = StObject.set(x, "includedPlatforms", null)
    ...
    inline def setIncludedUserIdTypesNull: Self = StObject.set(x, "includedUserIdTypes", null)
    ...
    inline def setInterstitialTargetingNull: Self = StObject.set(x, "interstitialTargeting", null)
    ...
    inline def setInvalidGeoIdsNull: Self = StObject.set(x, "invalidGeoIds", null)
    ...
    inline def setPublisherTargeting(value: SchemaStringTargetingDimension): Self = StObject.set(x, "publisherTargeting", value.asInstanceOf[js.Any])
    ...
    inline def setUserListTargeting(value: SchemaNumericTargetingDimension): Self = StObject.set(x, "userListTargeting", value.asInstanceOf[js.Any])
    
    inline def setUserListTargetingUndefined: Self = StObject.set(x, "userListTargeting", js.undefined)
    
    inline def setVerticalTargeting(value: SchemaNumericTargetingDimension): Self = StObject.set(x, "verticalTargeting", value.asInstanceOf[js.Any])
    
    inline def setVerticalTargetingUndefined: Self = StObject.set(x, "verticalTargeting", js.undefined)
    
    inline def setWebTargeting(value: SchemaStringTargetingDimension): Self = StObject.set(x, "webTargeting", value.asInstanceOf[js.Any])
