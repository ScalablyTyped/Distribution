...
trait SchemaPolicyTopicEntry extends StObject {
  
  /**
    * Pieces of evidence associated with this policy topic entry.
    */
  var evidences: js.UndefOr[js.Array[SchemaPolicyTopicEvidence]] = js.undefined
  
  /**
    * URL of the help center article describing this policy topic.
    */
  var helpCenterUrl: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var policyTopic: js.UndefOr[String | Null] = js.undefined
}
object SchemaPolicyTopicEntry {
  
  inline def apply(): SchemaPolicyTopicEntry = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaPolicyTopicEntry]
  }
  
  extension [Self <: SchemaPolicyTopicEntry](x: Self) {
    
    inline def setEvidences(value: js.Array[SchemaPolicyTopicEvidence]): Self = StObject.set(x, "evidences", value.asInstanceOf[js.Any])
    
    inline def setEvidencesUndefined: Self = StObject.set(x, "evidences", js.undefined)
    
    inline def setEvidencesVarargs(value: SchemaPolicyTopicEvidence*): Self = StObject.set(x, "evidences", js.Array(value*))
    
    inline def setHelpCenterUrl(value: String): Self = StObject.set(x, "helpCenterUrl", value.asInstanceOf[js.Any])
    
    inline def setHelpCenterUrlNull: Self = StObject.set(x, "helpCenterUrl", null)
    ...
    inline def setPolicyTopicNull: Self = StObject.set(x, "policyTopic", null)
