...
trait SchemaAdTechnologyProviders extends StObject {
  ...
  /**
    ...
    */
  var detectedGvlIds: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var detectedProviderIds: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var unidentifiedProviderDomains: js.UndefOr[js.Array[String] | Null] = js.undefined
}
object SchemaAdTechnologyProviders {
  
  inline def apply(): SchemaAdTechnologyProviders = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAdTechnologyProviders]
  }
  
  extension [Self <: SchemaAdTechnologyProviders](x: Self) {
    
    inline def setDetectedGvlIds(value: js.Array[String]): Self = StObject.set(x, "detectedGvlIds", value.asInstanceOf[js.Any])
    
    inline def setDetectedGvlIdsNull: Self = StObject.set(x, "detectedGvlIds", null)
    ...
    inline def setDetectedProviderIdsNull: Self = StObject.set(x, "detectedProviderIds", null)
    ...
    inline def setUnidentifiedProviderDomainsNull: Self = StObject.set(x, "unidentifiedProviderDomains", null)
