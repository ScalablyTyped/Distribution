...
trait SchemaBatchRejectPublisherConnectionsResponse extends StObject {
...
object SchemaBatchRejectPublisherConnectionsResponse {
  
  inline def apply(): SchemaBatchRejectPublisherConnectionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBatchRejectPublisherConnectionsResponse]
  }
  
  extension [Self <: SchemaBatchRejectPublisherConnectionsResponse](x: Self) {
