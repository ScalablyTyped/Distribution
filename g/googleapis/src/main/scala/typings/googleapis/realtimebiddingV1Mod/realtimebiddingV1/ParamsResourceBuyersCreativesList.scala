...
trait ParamsResourceBuyersCreativesList
  extends StObject
...
object ParamsResourceBuyersCreativesList {
  
  inline def apply(): ParamsResourceBuyersCreativesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBuyersCreativesList]
  }
  
  extension [Self <: ParamsResourceBuyersCreativesList](x: Self) {
