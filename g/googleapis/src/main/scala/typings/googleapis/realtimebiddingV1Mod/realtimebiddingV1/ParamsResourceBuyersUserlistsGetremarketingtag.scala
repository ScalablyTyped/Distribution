...
trait ParamsResourceBuyersUserlistsGetremarketingtag
  extends StObject
...
object ParamsResourceBuyersUserlistsGetremarketingtag {
  
  inline def apply(): ParamsResourceBuyersUserlistsGetremarketingtag = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBuyersUserlistsGetremarketingtag]
  }
  
  extension [Self <: ParamsResourceBuyersUserlistsGetremarketingtag](x: Self) {
