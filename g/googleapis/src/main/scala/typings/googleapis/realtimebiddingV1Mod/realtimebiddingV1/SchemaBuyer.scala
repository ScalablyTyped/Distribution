...
trait SchemaBuyer extends StObject {
  ...
  /**
    ...
    */
  var activeCreativeCount: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var bidder: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var billingIds: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var maximumActiveCreativeCount: js.UndefOr[String | Null] = js.undefined
...
object SchemaBuyer {
  ...
  extension [Self <: SchemaBuyer](x: Self) {
    ...
    inline def setActiveCreativeCountNull: Self = StObject.set(x, "activeCreativeCount", null)
    ...
    inline def setBidderNull: Self = StObject.set(x, "bidder", null)
    ...
    inline def setBillingIdsNull: Self = StObject.set(x, "billingIds", null)
    ...
    inline def setMaximumActiveCreativeCountNull: Self = StObject.set(x, "maximumActiveCreativeCount", null)
