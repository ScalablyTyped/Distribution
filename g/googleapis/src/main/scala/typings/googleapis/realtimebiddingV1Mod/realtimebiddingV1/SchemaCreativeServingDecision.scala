...
trait SchemaCreativeServingDecision extends StObject {
  ...
  /**
    ...
    */
  var chinaPolicyCompliance: js.UndefOr[SchemaPolicyCompliance] = js.undefined
  ...
  /**
    ...
    */
  var dealsPolicyCompliance: js.UndefOr[SchemaPolicyCompliance] = js.undefined
  
  /**
    * Detected advertisers and brands.
    */
  var detectedAdvertisers: js.UndefOr[js.Array[SchemaAdvertiserAndBrand]] = js.undefined
  
  /**
    * Publisher-excludable attributes that were detected for this creative. Can be used to filter the response of the creatives.list method. If the `excluded_attribute` field of a [bid request](https://developers.google.com/authorized-buyers/rtb/downloads/realtime-bidding-proto) contains one of the attributes that were declared or detected for a given creative, and a bid is submitted with that creative, the bid will be filtered before the auction.
    */
  var detectedAttributes: js.UndefOr[js.Array[String] | Null] = js.undefined
  
  /**
    * The set of detected destination URLs for the creative. Can be used to filter the response of the creatives.list method.
    */
  var detectedClickThroughUrls: js.UndefOr[js.Array[String] | Null] = js.undefined
  ...
  /**
    ...
    */
  var detectedVendorIds: js.UndefOr[js.Array[Double] | Null] = js.undefined
  
  /**
    * The last time the creative status was updated. Can be used to filter the response of the creatives.list method.
    */
  var lastStatusUpdate: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var networkPolicyCompliance: js.UndefOr[SchemaPolicyCompliance] = js.undefined
  ...
  /**
    ...
    */
  var platformPolicyCompliance: js.UndefOr[SchemaPolicyCompliance] = js.undefined
  ...
  /**
    ...
    */
  var russiaPolicyCompliance: js.UndefOr[SchemaPolicyCompliance] = js.undefined
}
object SchemaCreativeServingDecision {
  
  inline def apply(): SchemaCreativeServingDecision = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCreativeServingDecision]
  }
  
  extension [Self <: SchemaCreativeServingDecision](x: Self) {
    ...
    inline def setChinaPolicyCompliance(value: SchemaPolicyCompliance): Self = StObject.set(x, "chinaPolicyCompliance", value.asInstanceOf[js.Any])
    
    inline def setChinaPolicyComplianceUndefined: Self = StObject.set(x, "chinaPolicyCompliance", js.undefined)
    
    inline def setDealsPolicyCompliance(value: SchemaPolicyCompliance): Self = StObject.set(x, "dealsPolicyCompliance", value.asInstanceOf[js.Any])
    
    inline def setDealsPolicyComplianceUndefined: Self = StObject.set(x, "dealsPolicyCompliance", js.undefined)
    
    inline def setDetectedAdvertisers(value: js.Array[SchemaAdvertiserAndBrand]): Self = StObject.set(x, "detectedAdvertisers", value.asInstanceOf[js.Any])
    
    inline def setDetectedAdvertisersUndefined: Self = StObject.set(x, "detectedAdvertisers", js.undefined)
    
    inline def setDetectedAdvertisersVarargs(value: SchemaAdvertiserAndBrand*): Self = StObject.set(x, "detectedAdvertisers", js.Array(value*))
    
    inline def setDetectedAttributes(value: js.Array[String]): Self = StObject.set(x, "detectedAttributes", value.asInstanceOf[js.Any])
    
    inline def setDetectedAttributesNull: Self = StObject.set(x, "detectedAttributes", null)
    ...
    inline def setDetectedClickThroughUrlsNull: Self = StObject.set(x, "detectedClickThroughUrls", null)
    ...
    inline def setDetectedVendorIdsNull: Self = StObject.set(x, "detectedVendorIds", null)
    ...
    inline def setLastStatusUpdateNull: Self = StObject.set(x, "lastStatusUpdate", null)
    
    inline def setLastStatusUpdateUndefined: Self = StObject.set(x, "lastStatusUpdate", js.undefined)
    
    inline def setNetworkPolicyCompliance(value: SchemaPolicyCompliance): Self = StObject.set(x, "networkPolicyCompliance", value.asInstanceOf[js.Any])
    
    inline def setNetworkPolicyComplianceUndefined: Self = StObject.set(x, "networkPolicyCompliance", js.undefined)
    
    inline def setPlatformPolicyCompliance(value: SchemaPolicyCompliance): Self = StObject.set(x, "platformPolicyCompliance", value.asInstanceOf[js.Any])
    
    inline def setPlatformPolicyComplianceUndefined: Self = StObject.set(x, "platformPolicyCompliance", js.undefined)
    
    inline def setRussiaPolicyCompliance(value: SchemaPolicyCompliance): Self = StObject.set(x, "russiaPolicyCompliance", value.asInstanceOf[js.Any])
