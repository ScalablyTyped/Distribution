...
trait ParamsResourceBiddersEndpointsList
  extends StObject
...
object ParamsResourceBiddersEndpointsList {
  
  inline def apply(): ParamsResourceBiddersEndpointsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBiddersEndpointsList]
  }
  
  extension [Self <: ParamsResourceBiddersEndpointsList](x: Self) {
