...
trait ParamsResourceBuyersList
  extends StObject
...
object ParamsResourceBuyersList {
  
  inline def apply(): ParamsResourceBuyersList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBuyersList]
  }
  
  extension [Self <: ParamsResourceBuyersList](x: Self) {
