...
trait Schema$ScanRun extends js.Object {
  ...
  /**
    ...
    * available.
    */
  var errorTrace: js.UndefOr[Schema$ScanRunErrorTrace] = js.native
  /**
  ...
  /**
    ...
    * run.
    */
  var warningTraces: js.UndefOr[js.Array[Schema$ScanRunWarningTrace]] = js.native
}
...
object Schema$ScanRun {
  ...
  def apply(
    endTime: String = null,
    errorTrace: Schema$ScanRunErrorTrace = null,
    ...
    warningTraces: js.Array[Schema$ScanRunWarningTrace] = null
  ): Schema$ScanRun = {
