...
/**
  ...
  */
@js.native
trait Schema$ScanRunErrorTrace extends js.Object {
  /**
  ...
  /**
    ...
    */
  var scanConfigError: js.UndefOr[Schema$ScanConfigError] = js.native
}

object Schema$ScanRunErrorTrace {
  @scala.inline
  def apply(
    code: String = null,
    mostCommonHttpErrorCode: Int | Double = null,
    scanConfigError: Schema$ScanConfigError = null
  ): Schema$ScanRunErrorTrace = {
    ...
    __obj.asInstanceOf[Schema$ScanRunErrorTrace]
  }
}
