...
trait SchemaGoogleCloudAssuredworkloadsV1beta1Workload extends StObject {
  ...
  /**
    ...
    */
  var saaEnrollmentResponse: js.UndefOr[SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse] = js.undefined
}
object SchemaGoogleCloudAssuredworkloadsV1beta1Workload {
  ...
  extension [Self <: SchemaGoogleCloudAssuredworkloadsV1beta1Workload](x: Self) {
    ...
    inline def setSaaEnrollmentResponse(value: SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse): Self = StObject.set(x, "saaEnrollmentResponse", value.asInstanceOf[js.Any])
