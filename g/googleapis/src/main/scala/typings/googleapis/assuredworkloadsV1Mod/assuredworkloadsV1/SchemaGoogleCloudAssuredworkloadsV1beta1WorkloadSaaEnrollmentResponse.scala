...
trait SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse extends StObject {
...
object SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse {
  
  inline def apply(): SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse]
  }
  
  extension [Self <: SchemaGoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse](x: Self) {
