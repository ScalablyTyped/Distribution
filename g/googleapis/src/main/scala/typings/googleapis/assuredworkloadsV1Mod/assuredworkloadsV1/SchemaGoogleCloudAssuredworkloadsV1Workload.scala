...
trait SchemaGoogleCloudAssuredworkloadsV1Workload extends StObject {
  ...
  /**
    ...
    */
  var resourceSettings: js.UndefOr[js.Array[SchemaGoogleCloudAssuredworkloadsV1WorkloadResourceSettings]] = js.undefined
  ...
  /**
    ...
    */
  var saaEnrollmentResponse: js.UndefOr[SchemaGoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponse] = js.undefined
}
object SchemaGoogleCloudAssuredworkloadsV1Workload {
  ...
  extension [Self <: SchemaGoogleCloudAssuredworkloadsV1Workload](x: Self) {
    ...
    inline def setResourceSettings(value: js.Array[SchemaGoogleCloudAssuredworkloadsV1WorkloadResourceSettings]): Self = StObject.set(x, "resourceSettings", value.asInstanceOf[js.Any])
    
    inline def setResourceSettingsUndefined: Self = StObject.set(x, "resourceSettings", js.undefined)
    
    inline def setResourceSettingsVarargs(value: SchemaGoogleCloudAssuredworkloadsV1WorkloadResourceSettings*): Self = StObject.set(x, "resourceSettings", js.Array(value*))
    ...
    inline def setSaaEnrollmentResponse(value: SchemaGoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponse): Self = StObject.set(x, "saaEnrollmentResponse", value.asInstanceOf[js.Any])
