...
trait SchemaGoogleCloudAssuredworkloadsVersioningV1mainWorkloadKMSSettings extends StObject {
...
object SchemaGoogleCloudAssuredworkloadsVersioningV1mainWorkloadKMSSettings {
  
  inline def apply(): SchemaGoogleCloudAssuredworkloadsVersioningV1mainWorkloadKMSSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudAssuredworkloadsVersioningV1mainWorkloadKMSSettings]
  }
  
  extension [Self <: SchemaGoogleCloudAssuredworkloadsVersioningV1mainWorkloadKMSSettings](x: Self) {
