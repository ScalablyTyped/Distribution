...
@JSImport("googleapis/build/src/apis/datastream/v1", "datastream_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  def fetchStaticIps(): GaxiosPromise[SchemaFetchStaticIpsResponse] = js.native
  def fetchStaticIps(callback: BodyResponseCallback[SchemaFetchStaticIpsResponse]): Unit = js.native
  def fetchStaticIps(params: Unit, options: MethodOptions): GaxiosPromise[SchemaFetchStaticIpsResponse] = js.native
  def fetchStaticIps(params: ParamsResourceProjectsLocationsFetchstaticips): GaxiosPromise[SchemaFetchStaticIpsResponse] = js.native
  def fetchStaticIps(
    params: ParamsResourceProjectsLocationsFetchstaticips,
    callback: BodyResponseCallback[SchemaFetchStaticIpsResponse]
  ): Unit = js.native
  def fetchStaticIps(
    params: ParamsResourceProjectsLocationsFetchstaticips,
    options: BodyResponseCallback[Readable | SchemaFetchStaticIpsResponse],
    callback: BodyResponseCallback[Readable | SchemaFetchStaticIpsResponse]
  ): Unit = js.native
  def fetchStaticIps(params: ParamsResourceProjectsLocationsFetchstaticips, options: MethodOptions): GaxiosPromise[SchemaFetchStaticIpsResponse] = js.native
  def fetchStaticIps(
    params: ParamsResourceProjectsLocationsFetchstaticips,
  ...
  /**
    ...
    */
  def fetchStaticIps(params: ParamsResourceProjectsLocationsFetchstaticips, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def fetchStaticIps(
    params: ParamsResourceProjectsLocationsFetchstaticips,
  ...
  var privateConnections: ResourceProjectsLocationsPrivateconnections = js.native
  
  var streams: ResourceProjectsLocationsStreams = js.native
}
