...
@JSImport("googleapis/build/src/apis/datastream/v1", "datastream_v1.Resource$Projects$Locations$Streams$Objects")
@js.native
open class ResourceProjectsLocationsStreamsObjects protected () extends StObject {
  ...
  def lookup(): GaxiosPromise[SchemaStreamObject] = js.native
  def lookup(callback: BodyResponseCallback[SchemaStreamObject]): Unit = js.native
  def lookup(params: Unit, options: MethodOptions): GaxiosPromise[SchemaStreamObject] = js.native
  def lookup(params: ParamsResourceProjectsLocationsStreamsObjectsLookup): GaxiosPromise[SchemaStreamObject] = js.native
  def lookup(
    params: ParamsResourceProjectsLocationsStreamsObjectsLookup,
    callback: BodyResponseCallback[SchemaStreamObject]
  ): Unit = js.native
  def lookup(
    params: ParamsResourceProjectsLocationsStreamsObjectsLookup,
  ...
  def lookup(params: ParamsResourceProjectsLocationsStreamsObjectsLookup, options: MethodOptions): GaxiosPromise[SchemaStreamObject] = js.native
  def lookup(
    params: ParamsResourceProjectsLocationsStreamsObjectsLookup,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaStreamObject]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def lookup(params: ParamsResourceProjectsLocationsStreamsObjectsLookup, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def lookup(
    params: ParamsResourceProjectsLocationsStreamsObjectsLookup,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
