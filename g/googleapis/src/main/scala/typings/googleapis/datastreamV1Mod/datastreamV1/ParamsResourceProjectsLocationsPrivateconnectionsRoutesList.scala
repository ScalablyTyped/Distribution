...
trait ParamsResourceProjectsLocationsPrivateconnectionsRoutesList
  extends StObject
...
object ParamsResourceProjectsLocationsPrivateconnectionsRoutesList {
  
  inline def apply(): ParamsResourceProjectsLocationsPrivateconnectionsRoutesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsPrivateconnectionsRoutesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsPrivateconnectionsRoutesList](x: Self) {
