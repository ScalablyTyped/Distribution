...
trait SchemaGoogleCloudFunctionsV2betaOperationMetadata extends StObject {
  ...
  /**
    ...
    */
  var stages: js.UndefOr[js.Array[SchemaGoogleCloudFunctionsV2betaStage]] = js.undefined
...
object SchemaGoogleCloudFunctionsV2betaOperationMetadata {
  
  inline def apply(): SchemaGoogleCloudFunctionsV2betaOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudFunctionsV2betaOperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudFunctionsV2betaOperationMetadata](x: Self) {
    ...
    inline def setStages(value: js.Array[SchemaGoogleCloudFunctionsV2betaStage]): Self = StObject.set(x, "stages", value.asInstanceOf[js.Any])
    
    inline def setStagesUndefined: Self = StObject.set(x, "stages", js.undefined)
    
    inline def setStagesVarargs(value: SchemaGoogleCloudFunctionsV2betaStage*): Self = StObject.set(x, "stages", js.Array(value*))
