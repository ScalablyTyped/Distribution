...
trait SchemaServiceConfig extends StObject {
  ...
  /**
    ...
    */
  var allTrafficOnLatestRevision: js.UndefOr[Boolean | Null] = js.undefined
  
  /**
    * The amount of memory available for a function. Defaults to 256M. Supported units are k, M, G, Mi, Gi. If no unit is supplied the value is interpreted as bytes. See https://github.com/kubernetes/kubernetes/blob/master/staging/src/k8s.io/apimachinery/pkg/api/resource/quantity.go a full description.
    */
  var availableMemory: js.UndefOr[String | Null] = js.undefined
...
object SchemaServiceConfig {
  ...
  inline def apply(): SchemaServiceConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaServiceConfig]
  }
  
  extension [Self <: SchemaServiceConfig](x: Self) {
    ...
    inline def setAllTrafficOnLatestRevisionNull: Self = StObject.set(x, "allTrafficOnLatestRevision", null)
    ...
    inline def setAvailableMemoryNull: Self = StObject.set(x, "availableMemory", null)
