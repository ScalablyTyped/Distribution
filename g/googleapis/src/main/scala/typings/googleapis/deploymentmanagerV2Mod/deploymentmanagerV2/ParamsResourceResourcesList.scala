...
object ParamsResourceResourcesList {
  ...
  @scala.inline
  def apply(): ParamsResourceResourcesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceResourcesList]
  }
  
  @scala.inline
  implicit class ParamsResourceResourcesListMutableBuilder[Self <: ParamsResourceResourcesList] (val x: Self) extends AnyVal {
