...
object ParamsResourceDeploymentsInsert {
  ...
  implicit class ParamsResourceDeploymentsInsertOps[Self <: ParamsResourceDeploymentsInsert] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreatePolicy(value: String): Self = this.set("createPolicy", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCreatePolicy: Self = this.set("createPolicy", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaDeployment): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
