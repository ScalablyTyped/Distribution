...
trait ParamsResourceProjectsLocationsTaxonomiesImport
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudDatacatalogV1ImportTaxonomiesRequest] = js.undefined
}
object ParamsResourceProjectsLocationsTaxonomiesImport {
  ...
  extension [Self <: ParamsResourceProjectsLocationsTaxonomiesImport](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudDatacatalogV1ImportTaxonomiesRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
