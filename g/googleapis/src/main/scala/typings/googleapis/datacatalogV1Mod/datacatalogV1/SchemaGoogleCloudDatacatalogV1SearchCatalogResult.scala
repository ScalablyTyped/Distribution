...
trait SchemaGoogleCloudDatacatalogV1SearchCatalogResult extends StObject {
...
object SchemaGoogleCloudDatacatalogV1SearchCatalogResult {
  
  inline def apply(): SchemaGoogleCloudDatacatalogV1SearchCatalogResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudDatacatalogV1SearchCatalogResult]
  }
  
  extension [Self <: SchemaGoogleCloudDatacatalogV1SearchCatalogResult](x: Self) {
