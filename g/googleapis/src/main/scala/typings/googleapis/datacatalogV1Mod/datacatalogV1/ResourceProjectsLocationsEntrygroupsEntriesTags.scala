...
@JSImport("googleapis/build/src/apis/datacatalog/v1", "datacatalog_v1.Resource$Projects$Locations$Entrygroups$Entries$Tags")
@js.native
open class ResourceProjectsLocationsEntrygroupsEntriesTags protected () extends StObject {
  ...
  def create(params: ParamsResourceProjectsLocationsEntrygroupsEntriesTagsCreate): GaxiosPromise[SchemaGoogleCloudDatacatalogV1Tag] = js.native
  def create(
  ...
  def create(params: ParamsResourceProjectsLocationsEntrygroupsEntriesTagsCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDatacatalogV1Tag] = js.native
  def create(
    params: ParamsResourceProjectsLocationsEntrygroupsEntriesTagsCreate,
  ...
  def list(params: ParamsResourceProjectsLocationsEntrygroupsEntriesTagsList): GaxiosPromise[SchemaGoogleCloudDatacatalogV1ListTagsResponse] = js.native
  def list(
  ...
  def list(params: ParamsResourceProjectsLocationsEntrygroupsEntriesTagsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDatacatalogV1ListTagsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsEntrygroupsEntriesTagsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDatacatalogV1ListTagsResponse]
  ...
  def patch(params: ParamsResourceProjectsLocationsEntrygroupsEntriesTagsPatch): GaxiosPromise[SchemaGoogleCloudDatacatalogV1Tag] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsEntrygroupsEntriesTagsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudDatacatalogV1Tag] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsEntrygroupsEntriesTagsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudDatacatalogV1Tag]
