...
/**
  ...
  */
@js.native
trait Schema$SurveyRejection extends js.Object {
  /**
...
object Schema$SurveyRejection {
  @scala.inline
  def apply(explanation: String = null, `type`: String = null): Schema$SurveyRejection = {
    val __obj = js.Dynamic.literal()
    if (explanation != null) __obj.updateDynamic("explanation")(explanation.asInstanceOf[js.Any])
    if (`type` != null) __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$SurveyRejection]
  }
}
