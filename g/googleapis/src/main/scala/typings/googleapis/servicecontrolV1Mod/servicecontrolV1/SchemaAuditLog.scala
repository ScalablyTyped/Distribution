...
object SchemaAuditLog {
  ...
  extension [Self <: SchemaAuditLog](x: Self) {
    ...
    inline def setAuthorizationInfoVarargs(value: SchemaAuthorizationInfo*): Self = StObject.set(x, "authorizationInfo", js.Array(value :_*))
    ...
    inline def setResourceOriginalState(value: StringDictionary[js.Any]): Self = StObject.set(x, "resourceOriginalState", value.asInstanceOf[js.Any])
    ...
    inline def setServiceData(value: StringDictionary[js.Any]): Self = StObject.set(x, "serviceData", value.asInstanceOf[js.Any])
