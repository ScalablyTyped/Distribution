...
trait SchemaAuth extends StObject {
  ...
  /**
    ...
    */
  var claims: js.UndefOr[StringDictionary[Any] | Null] = js.undefined
  
  /**
    * The authorized presenter of the credential. Reflects the optional Authorized Presenter (`azp`) claim within a JWT or the OAuth client id. For example, a Google Cloud Platform client id looks as follows: "123456789012.apps.googleusercontent.com".
    */
  var presenter: js.UndefOr[String | Null] = js.undefined
...
object SchemaAuth {
  ...
  extension [Self <: SchemaAuth](x: Self) {
    ...
    inline def setClaimsNull: Self = StObject.set(x, "claims", null)
    ...
    inline def setPresenterNull: Self = StObject.set(x, "presenter", null)
