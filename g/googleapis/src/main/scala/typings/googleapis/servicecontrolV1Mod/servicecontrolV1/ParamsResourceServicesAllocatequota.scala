...
object ParamsResourceServicesAllocatequota {
  ...
  @scala.inline
  implicit class ParamsResourceServicesAllocatequotaOps[Self <: ParamsResourceServicesAllocatequota] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaAllocateQuotaRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
