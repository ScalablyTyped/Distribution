...
trait SchemaV1HttpRequest extends StObject {
...
object SchemaV1HttpRequest {
  
  inline def apply(): SchemaV1HttpRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaV1HttpRequest]
  }
  
  extension [Self <: SchemaV1HttpRequest](x: Self) {
