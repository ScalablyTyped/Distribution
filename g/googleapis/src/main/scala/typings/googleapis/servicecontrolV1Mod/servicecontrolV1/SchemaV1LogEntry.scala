...
trait SchemaV1LogEntry extends StObject {
  
  /**
    * Optional. Information about the HTTP request associated with this log entry, if applicable.
    */
  var httpRequest: js.UndefOr[SchemaV1HttpRequest] = js.undefined
  ...
  /**
    ...
    */
  var operation: js.UndefOr[SchemaV1LogEntryOperation] = js.undefined
  ...
  /**
    ...
    */
  var sourceLocation: js.UndefOr[SchemaV1LogEntrySourceLocation] = js.undefined
...
object SchemaV1LogEntry {
  
  inline def apply(): SchemaV1LogEntry = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaV1LogEntry]
  }
  
  extension [Self <: SchemaV1LogEntry](x: Self) {
    
    inline def setHttpRequest(value: SchemaV1HttpRequest): Self = StObject.set(x, "httpRequest", value.asInstanceOf[js.Any])
    ...
    inline def setOperation(value: SchemaV1LogEntryOperation): Self = StObject.set(x, "operation", value.asInstanceOf[js.Any])
    ...
    inline def setSourceLocation(value: SchemaV1LogEntrySourceLocation): Self = StObject.set(x, "sourceLocation", value.asInstanceOf[js.Any])
