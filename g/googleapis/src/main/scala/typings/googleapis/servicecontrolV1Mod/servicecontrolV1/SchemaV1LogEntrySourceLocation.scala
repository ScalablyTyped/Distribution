...
trait SchemaV1LogEntrySourceLocation extends StObject {
...
object SchemaV1LogEntrySourceLocation {
  
  inline def apply(): SchemaV1LogEntrySourceLocation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaV1LogEntrySourceLocation]
  }
  
  extension [Self <: SchemaV1LogEntrySourceLocation](x: Self) {
