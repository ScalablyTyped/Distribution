...
trait SchemaAttestor extends StObject {
  ...
  /**
    ...
    */
  var userOwnedGrafeasNote: js.UndefOr[SchemaUserOwnedGrafeasNote] = js.undefined
}
object SchemaAttestor {
  ...
  extension [Self <: SchemaAttestor](x: Self) {
    ...
    inline def setUserOwnedGrafeasNote(value: SchemaUserOwnedGrafeasNote): Self = StObject.set(x, "userOwnedGrafeasNote", value.asInstanceOf[js.Any])
