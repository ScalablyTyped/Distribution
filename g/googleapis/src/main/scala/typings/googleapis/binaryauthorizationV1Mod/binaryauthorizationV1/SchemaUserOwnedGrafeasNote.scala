...
trait SchemaUserOwnedGrafeasNote extends StObject {
  
  /**
    * Output only. This field will contain the service account email address that this Attestor will use as the principal when querying Container Analysis. Attestor administrators must grant this service account the IAM role needed to read attestations from the note_reference in Container Analysis (`containeranalysis.notes.occurrences.viewer`). This email address is fixed for the lifetime of the Attestor, but callers should not make any other assumptions about the service account email; future versions may use an email based on a different naming pattern.
    */
  var delegationServiceAccountEmail: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var noteReference: js.UndefOr[String | Null] = js.undefined
...
object SchemaUserOwnedGrafeasNote {
  
  inline def apply(): SchemaUserOwnedGrafeasNote = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaUserOwnedGrafeasNote]
  }
  
  extension [Self <: SchemaUserOwnedGrafeasNote](x: Self) {
    ...
    inline def setDelegationServiceAccountEmailNull: Self = StObject.set(x, "delegationServiceAccountEmail", null)
    ...
    inline def setNoteReferenceNull: Self = StObject.set(x, "noteReference", null)
    ...
    inline def setPublicKeysVarargs(value: SchemaAttestorPublicKey*): Self = StObject.set(x, "publicKeys", js.Array(value*))
  }
}
