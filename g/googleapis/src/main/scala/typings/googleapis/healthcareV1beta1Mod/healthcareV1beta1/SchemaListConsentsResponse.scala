...
trait SchemaListConsentsResponse extends StObject {
...
object SchemaListConsentsResponse {
  
  inline def apply(): SchemaListConsentsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaListConsentsResponse]
  }
  
  extension [Self <: SchemaListConsentsResponse](x: Self) {
