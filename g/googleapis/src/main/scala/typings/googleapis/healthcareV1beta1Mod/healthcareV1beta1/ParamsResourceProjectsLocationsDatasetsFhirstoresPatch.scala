...
object ParamsResourceProjectsLocationsDatasetsFhirstoresPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsFhirstoresPatchOps[Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresPatch] (val x: Self) extends AnyVal {
    @scala.inline
