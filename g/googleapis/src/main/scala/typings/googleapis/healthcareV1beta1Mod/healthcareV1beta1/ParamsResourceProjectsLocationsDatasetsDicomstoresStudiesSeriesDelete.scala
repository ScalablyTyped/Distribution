...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesDeleteOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesDelete] (val x: Self) extends AnyVal {
