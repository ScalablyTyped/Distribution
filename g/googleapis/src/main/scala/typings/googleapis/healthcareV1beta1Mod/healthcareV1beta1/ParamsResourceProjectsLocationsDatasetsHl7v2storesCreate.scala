...
object ParamsResourceProjectsLocationsDatasetsHl7v2storesCreate {
  ...
  def apply(
    ...
    fields: String = null,
    hl7V2StoreId: String = null,
    key: String = null,
    oauth_token: String = null,
    parent: String = null,
    prettyPrint: js.UndefOr[Boolean] = js.undefined,
    quotaUser: String = null,
    requestBody: SchemaHl7V2Store = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceProjectsLocationsDatasetsHl7v2storesCreate = {
    ...
    if (hl7V2StoreId != null) __obj.updateDynamic("hl7V2StoreId")(hl7V2StoreId.asInstanceOf[js.Any])
