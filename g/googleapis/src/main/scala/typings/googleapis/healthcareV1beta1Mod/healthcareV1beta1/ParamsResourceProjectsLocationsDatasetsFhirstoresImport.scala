...
object ParamsResourceProjectsLocationsDatasetsFhirstoresImport {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsFhirstoresImportOps[Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresImport] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaImportResourcesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
