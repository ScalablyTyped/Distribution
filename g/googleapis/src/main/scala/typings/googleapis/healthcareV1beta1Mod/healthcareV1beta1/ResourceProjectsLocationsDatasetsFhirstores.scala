...
open class ResourceProjectsLocationsDatasetsFhirstores protected () extends StObject {
  ...
  def configureSearch(): GaxiosPromise[SchemaOperation] = js.native
  def configureSearch(callback: BodyResponseCallback[SchemaOperation]): Unit = js.native
  def configureSearch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def configureSearch(params: ParamsResourceProjectsLocationsDatasetsFhirstoresConfiguresearch): GaxiosPromise[SchemaOperation] = js.native
  def configureSearch(
    params: ParamsResourceProjectsLocationsDatasetsFhirstoresConfiguresearch,
  ...
  def configureSearch(params: ParamsResourceProjectsLocationsDatasetsFhirstoresConfiguresearch, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def configureSearch(
    params: ParamsResourceProjectsLocationsDatasetsFhirstoresConfiguresearch,
