...
trait SchemaConsent extends StObject {
  ...
  /**
    ...
    */
  var policies: js.UndefOr[js.Array[SchemaGoogleCloudHealthcareV1beta1ConsentPolicy]] = js.undefined
...
object SchemaConsent {
  ...
  extension [Self <: SchemaConsent](x: Self) {
    ...
    inline def setPolicies(value: js.Array[SchemaGoogleCloudHealthcareV1beta1ConsentPolicy]): Self = StObject.set(x, "policies", value.asInstanceOf[js.Any])
    
    inline def setPoliciesUndefined: Self = StObject.set(x, "policies", js.undefined)
    
    inline def setPoliciesVarargs(value: SchemaGoogleCloudHealthcareV1beta1ConsentPolicy*): Self = StObject.set(x, "policies", js.Array(value*))
