...
object ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforstudies {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforstudies = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforstudies]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforstudiesMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforstudies] (val x: Self) extends AnyVal {
