...
object ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforstudies {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforstudiesOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforstudies] (val x: Self) extends AnyVal {
