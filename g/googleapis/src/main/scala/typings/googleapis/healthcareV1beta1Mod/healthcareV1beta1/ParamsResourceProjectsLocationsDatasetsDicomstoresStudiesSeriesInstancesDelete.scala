...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesInstancesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesInstancesDeleteOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesInstancesDelete] (val x: Self) extends AnyVal {
