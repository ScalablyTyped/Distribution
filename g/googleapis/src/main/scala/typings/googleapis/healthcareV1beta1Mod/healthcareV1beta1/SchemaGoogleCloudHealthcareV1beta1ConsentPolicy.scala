...
trait SchemaGoogleCloudHealthcareV1beta1ConsentPolicy extends StObject {
...
object SchemaGoogleCloudHealthcareV1beta1ConsentPolicy {
  
  inline def apply(): SchemaGoogleCloudHealthcareV1beta1ConsentPolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudHealthcareV1beta1ConsentPolicy]
  }
  
  extension [Self <: SchemaGoogleCloudHealthcareV1beta1ConsentPolicy](x: Self) {
