...
trait SchemaQueryAccessibleDataRequest extends StObject {
  ...
  /**
    ...
    */
  var gcsDestination: js.UndefOr[SchemaGoogleCloudHealthcareV1beta1ConsentGcsDestination] = js.undefined
...
object SchemaQueryAccessibleDataRequest {
  ...
  extension [Self <: SchemaQueryAccessibleDataRequest](x: Self) {
    ...
    inline def setGcsDestination(value: SchemaGoogleCloudHealthcareV1beta1ConsentGcsDestination): Self = StObject.set(x, "gcsDestination", value.asInstanceOf[js.Any])
