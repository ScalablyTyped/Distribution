...
trait SchemaNotificationConfig extends StObject {
  ...
  /**
    ...
    */
  var sendForBulkImport: js.UndefOr[Boolean | Null] = js.undefined
}
object SchemaNotificationConfig {
  ...
  extension [Self <: SchemaNotificationConfig](x: Self) {
    ...
    inline def setSendForBulkImport(value: Boolean): Self = StObject.set(x, "sendForBulkImport", value.asInstanceOf[js.Any])
    
    inline def setSendForBulkImportNull: Self = StObject.set(x, "sendForBulkImport", null)
    
    inline def setSendForBulkImportUndefined: Self = StObject.set(x, "sendForBulkImport", js.undefined)
  }
}
