...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesRetrieveseries {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesRetrieveseries = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesRetrieveseries]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesSeriesRetrieveseries](x: Self) {
