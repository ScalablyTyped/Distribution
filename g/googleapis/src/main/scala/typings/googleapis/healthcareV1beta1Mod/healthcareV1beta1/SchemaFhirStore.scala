...
trait SchemaFhirStore extends StObject {
  ...
  /**
    ...
    */
  var notificationConfigs: js.UndefOr[js.Array[SchemaFhirNotificationConfig]] = js.undefined
  
  /**
    * Configuration for how FHIR resources can be searched.
    */
  var searchConfig: js.UndefOr[SchemaSearchConfig] = js.undefined
...
object SchemaFhirStore {
  ...
  extension [Self <: SchemaFhirStore](x: Self) {
    ...
    inline def setNotificationConfigs(value: js.Array[SchemaFhirNotificationConfig]): Self = StObject.set(x, "notificationConfigs", value.asInstanceOf[js.Any])
    
    inline def setNotificationConfigsUndefined: Self = StObject.set(x, "notificationConfigs", js.undefined)
    
    inline def setNotificationConfigsVarargs(value: SchemaFhirNotificationConfig*): Self = StObject.set(x, "notificationConfigs", js.Array(value*))
    
    inline def setSearchConfig(value: SchemaSearchConfig): Self = StObject.set(x, "searchConfig", value.asInstanceOf[js.Any])
    
    inline def setSearchConfigUndefined: Self = StObject.set(x, "searchConfig", js.undefined)
