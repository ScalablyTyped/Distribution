...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesRetrievestudy {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesRetrievestudy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesRetrievestudy]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesRetrievestudyMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesRetrievestudy] (val x: Self) extends AnyVal {
