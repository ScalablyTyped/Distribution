...
object ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesRetrievestudy {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesRetrievestudyOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresStudiesRetrievestudy] (val x: Self) extends AnyVal {
    @scala.inline
