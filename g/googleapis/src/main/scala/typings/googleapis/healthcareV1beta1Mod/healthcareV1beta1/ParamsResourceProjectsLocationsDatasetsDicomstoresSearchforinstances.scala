...
object ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforinstances {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforinstances = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforinstances]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforinstancesMutableBuilder[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforinstances] (val x: Self) extends AnyVal {
