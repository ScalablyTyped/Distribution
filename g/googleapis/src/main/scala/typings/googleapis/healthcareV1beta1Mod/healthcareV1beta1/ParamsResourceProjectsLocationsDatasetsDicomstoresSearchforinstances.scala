...
object ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforinstances {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforinstancesOps[Self <: ParamsResourceProjectsLocationsDatasetsDicomstoresSearchforinstances] (val x: Self) extends AnyVal {
    @scala.inline
