...
trait ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdate
  extends StObject
...
object ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdate {
  
  inline def apply(): ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDatasetsFhirstoresFhirConditionalupdate](x: Self) {
