...
@js.native
trait Anon_CustomRichMediaEventsDateRangeDimensionFilters extends js.Object {
...
object Anon_CustomRichMediaEventsDateRangeDimensionFilters {
  @scala.inline
  def apply(
  ...
  ): Anon_CustomRichMediaEventsDateRangeDimensionFilters = {
    ...
    __obj.asInstanceOf[Anon_CustomRichMediaEventsDateRangeDimensionFilters]
  }
}
