...
trait SchemaDataProvider extends StObject {
...
object SchemaDataProvider {
  
  inline def apply(): SchemaDataProvider = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDataProvider]
  }
  
  extension [Self <: SchemaDataProvider](x: Self) {
