...
@JSImport("googleapis/build/src/apis/analyticshub/v1beta1", "analyticshub_v1beta1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var dataExchanges: ResourceProjectsLocationsDataexchanges = js.native
