...
trait ParamsResourceQueriesCreate
  extends StObject
...
object ParamsResourceQueriesCreate {
  
  inline def apply(): ParamsResourceQueriesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceQueriesCreate]
  }
  
  extension [Self <: ParamsResourceQueriesCreate](x: Self) {
