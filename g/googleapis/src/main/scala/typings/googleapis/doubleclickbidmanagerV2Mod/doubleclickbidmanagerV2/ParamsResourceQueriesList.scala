...
trait ParamsResourceQueriesList
  extends StObject
...
object ParamsResourceQueriesList {
  
  inline def apply(): ParamsResourceQueriesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceQueriesList]
  }
  
  extension [Self <: ParamsResourceQueriesList](x: Self) {
