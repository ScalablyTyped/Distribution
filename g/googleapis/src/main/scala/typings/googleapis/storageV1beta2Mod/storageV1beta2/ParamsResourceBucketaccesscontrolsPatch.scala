...
trait ParamsResourceBucketaccesscontrolsPatch
  extends StObject
...
object ParamsResourceBucketaccesscontrolsPatch {
  ...
  inline def apply(): ParamsResourceBucketaccesscontrolsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBucketaccesscontrolsPatch]
  }
  
  extension [Self <: ParamsResourceBucketaccesscontrolsPatch](x: Self) {
