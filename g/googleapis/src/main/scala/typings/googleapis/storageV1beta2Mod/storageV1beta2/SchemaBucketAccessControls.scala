...
object SchemaBucketAccessControls {
  ...
  inline def apply(): SchemaBucketAccessControls = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaBucketAccessControls]
  }
  
  extension [Self <: SchemaBucketAccessControls](x: Self) {
    
    inline def setItems(value: js.Array[SchemaBucketAccessControl]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
