...
object firebasemlV1Mod {
  
  object firebasemlV1 {
    
    @JSImport("googleapis/build/src/apis/firebaseml/v1", "firebaseml_v1.Firebaseml")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/firebaseml/v1", "firebaseml_v1.Resource$Operations")
    @js.native
