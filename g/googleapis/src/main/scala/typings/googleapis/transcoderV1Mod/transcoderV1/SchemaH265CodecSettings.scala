...
trait SchemaH265CodecSettings extends StObject {
...
object SchemaH265CodecSettings {
  
  inline def apply(): SchemaH265CodecSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaH265CodecSettings]
  }
  
  extension [Self <: SchemaH265CodecSettings](x: Self) {
