...
import typings.googleapis.buildSrcApisSpeechV1Mod.speech_v1.Options
import typings.googleapis.buildSrcApisSpeechV1Mod.speech_v1.Speech
...
object buildSrcApisSpeechMod extends js.Object {
  ...
  def speech(options: typings.googleapis.buildSrcApisSpeechV1p1beta1Mod.speech_v1p1beta1.Options): typings.googleapis.buildSrcApisSpeechV1p1beta1Mod.speech_v1p1beta1.Speech = js.native
  @JSName("speech")
  def speech_v1(version: v1): Speech = js.native
  @JSName("speech")
  def speech_v1p1beta1(version: v1p1beta1): typings.googleapis.buildSrcApisSpeechV1p1beta1Mod.speech_v1p1beta1.Speech = js.native
  @js.native
    ...
    object v1p1beta1
      extends TopLevel[
              Instantiable2[
                ...
                typings.googleapis.buildSrcApisSpeechV1p1beta1Mod.speech_v1p1beta1.Speech
              ]
            ]
