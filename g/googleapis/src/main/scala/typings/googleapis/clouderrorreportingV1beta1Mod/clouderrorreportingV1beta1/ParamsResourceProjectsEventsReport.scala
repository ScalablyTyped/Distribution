...
@js.native
trait ParamsResourceProjectsEventsReport extends StandardParameters {
...
object ParamsResourceProjectsEventsReport {
  ...
  implicit class ParamsResourceProjectsEventsReportOps[Self <: ParamsResourceProjectsEventsReport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaReportedErrorEvent): Self = this.set("requestBody", value.asInstanceOf[js.Any])
