...
trait SchemaErrorGroupStats extends StObject {
  ...
  /**
    ...
    */
  var affectedUsersCount: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var firstSeenTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var lastSeenTime: js.UndefOr[String | Null] = js.undefined
  
  /**
    * The total number of services with a non-zero error count for the given filter criteria.
    */
  var numAffectedServices: js.UndefOr[Double | Null] = js.undefined
...
object SchemaErrorGroupStats {
  ...
  extension [Self <: SchemaErrorGroupStats](x: Self) {
    ...
    inline def setAffectedServicesVarargs(value: SchemaServiceContext*): Self = StObject.set(x, "affectedServices", js.Array(value*))
    
    inline def setAffectedUsersCount(value: String): Self = StObject.set(x, "affectedUsersCount", value.asInstanceOf[js.Any])
    
    inline def setAffectedUsersCountNull: Self = StObject.set(x, "affectedUsersCount", null)
    ...
    inline def setFirstSeenTimeNull: Self = StObject.set(x, "firstSeenTime", null)
    ...
    inline def setLastSeenTimeNull: Self = StObject.set(x, "lastSeenTime", null)
    ...
    inline def setNumAffectedServicesNull: Self = StObject.set(x, "numAffectedServices", null)
    ...
    inline def setTimedCountsVarargs(value: SchemaTimedCount*): Self = StObject.set(x, "timedCounts", js.Array(value*))
  }
}
