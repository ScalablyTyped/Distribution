...
trait ParamsResourceProjectsLocationsGlobalConnectivitytestsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsGlobalConnectivitytestsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsGlobalConnectivitytestsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsGlobalConnectivitytestsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsGlobalConnectivitytestsGetiampolicy](x: Self) {
