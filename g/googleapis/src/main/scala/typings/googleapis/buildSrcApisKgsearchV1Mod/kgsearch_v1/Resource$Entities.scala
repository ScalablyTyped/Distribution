...
@js.native
class Resource$Entities protected () extends js.Object {
  ...
  def search(params: ParamsDollarResourceDollarEntitiesDollarSearch): GaxiosPromise[Schema$SearchResponse] = js.native
  def search(
    params: ParamsDollarResourceDollarEntitiesDollarSearch,
  ...
  def search(params: ParamsDollarResourceDollarEntitiesDollarSearch, options: MethodOptions): GaxiosPromise[Schema$SearchResponse] = js.native
  def search(
    params: ParamsDollarResourceDollarEntitiesDollarSearch,
