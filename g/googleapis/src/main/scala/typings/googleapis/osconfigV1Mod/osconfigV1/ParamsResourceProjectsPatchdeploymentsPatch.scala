...
trait ParamsResourceProjectsPatchdeploymentsPatch
  extends StObject
...
object ParamsResourceProjectsPatchdeploymentsPatch {
  
  inline def apply(): ParamsResourceProjectsPatchdeploymentsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsPatchdeploymentsPatch]
  }
  
  extension [Self <: ParamsResourceProjectsPatchdeploymentsPatch](x: Self) {
