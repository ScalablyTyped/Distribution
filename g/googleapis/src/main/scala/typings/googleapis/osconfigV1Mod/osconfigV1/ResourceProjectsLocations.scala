...
@JSImport("googleapis/build/src/apis/osconfig/v1", "osconfig_v1.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var osPolicyAssignments: ResourceProjectsLocationsOspolicyassignments = js.native
}
