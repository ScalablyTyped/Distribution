...
trait SchemaOSPolicyResourceRepositoryResourceZypperRepository extends StObject {
...
object SchemaOSPolicyResourceRepositoryResourceZypperRepository {
  
  inline def apply(): SchemaOSPolicyResourceRepositoryResourceZypperRepository = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOSPolicyResourceRepositoryResourceZypperRepository]
  }
  
  extension [Self <: SchemaOSPolicyResourceRepositoryResourceZypperRepository](x: Self) {
