...
trait SchemaOSPolicyAssignmentInstanceFilterInventory extends StObject {
...
object SchemaOSPolicyAssignmentInstanceFilterInventory {
  
  inline def apply(): SchemaOSPolicyAssignmentInstanceFilterInventory = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOSPolicyAssignmentInstanceFilterInventory]
  }
  
  extension [Self <: SchemaOSPolicyAssignmentInstanceFilterInventory](x: Self) {
