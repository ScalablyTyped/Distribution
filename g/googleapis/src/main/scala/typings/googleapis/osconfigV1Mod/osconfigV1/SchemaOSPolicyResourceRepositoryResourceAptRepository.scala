...
trait SchemaOSPolicyResourceRepositoryResourceAptRepository extends StObject {
...
object SchemaOSPolicyResourceRepositoryResourceAptRepository {
  
  inline def apply(): SchemaOSPolicyResourceRepositoryResourceAptRepository = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaOSPolicyResourceRepositoryResourceAptRepository]
  }
  
  extension [Self <: SchemaOSPolicyResourceRepositoryResourceAptRepository](x: Self) {
