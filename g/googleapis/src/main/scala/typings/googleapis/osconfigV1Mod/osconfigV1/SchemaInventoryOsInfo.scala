...
trait SchemaInventoryOsInfo extends StObject {
...
object SchemaInventoryOsInfo {
  
  inline def apply(): SchemaInventoryOsInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaInventoryOsInfo]
  }
  
  extension [Self <: SchemaInventoryOsInfo](x: Self) {
