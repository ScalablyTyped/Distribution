...
@js.native
trait AnonBoolValueDatetimeValue extends js.Object {
...
object AnonBoolValueDatetimeValue {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonBoolValueDatetimeValue]
  }
}
