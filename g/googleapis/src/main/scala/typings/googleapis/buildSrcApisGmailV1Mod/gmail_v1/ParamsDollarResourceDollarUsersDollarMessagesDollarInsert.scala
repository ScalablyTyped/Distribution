...
@js.native
trait ParamsDollarResourceDollarUsersDollarMessagesDollarInsert extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarUsersDollarMessagesDollarInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarUsersDollarMessagesDollarInsert = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarUsersDollarMessagesDollarInsert]
  }
}
