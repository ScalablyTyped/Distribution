...
@js.native
trait ParamsDollarResourceDollarUsersDollarMessagesDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarUsersDollarMessagesDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarUsersDollarMessagesDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarUsersDollarMessagesDollarList]
  }
}
