...
@js.native
trait ParamsDollarResourceDollarUsersDollarThreadsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarUsersDollarThreadsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarUsersDollarThreadsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarUsersDollarThreadsDollarList]
  }
}
