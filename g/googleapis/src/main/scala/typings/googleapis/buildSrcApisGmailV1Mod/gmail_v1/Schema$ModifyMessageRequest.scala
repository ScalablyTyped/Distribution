...
@js.native
trait Schema$ModifyMessageRequest extends js.Object {
  /**
...
object Schema$ModifyMessageRequest {
  @scala.inline
  def apply(addLabelIds: js.Array[String] = null, removeLabelIds: js.Array[String] = null): Schema$ModifyMessageRequest = {
    ...
    __obj.asInstanceOf[Schema$ModifyMessageRequest]
  }
}
