...
object ParamsResourceAccountsCustomappsCreate {
  ...
  @scala.inline
  implicit class ParamsResourceAccountsCustomappsCreateOps[Self <: ParamsResourceAccountsCustomappsCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaCustomApp): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
