...
@js.native
trait AnonCanAddChildrenCanChangeCopyRequiresWriterPermission extends js.Object {
...
object AnonCanAddChildrenCanChangeCopyRequiresWriterPermission {
  @scala.inline
  def apply(
  ...
  ): AnonCanAddChildrenCanChangeCopyRequiresWriterPermission = {
    ...
    __obj.asInstanceOf[AnonCanAddChildrenCanChangeCopyRequiresWriterPermission]
  }
}
