...
object ParamsResourceProjectsLocationsTransferconfigsRunsDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsTransferconfigsRunsDeleteOps[Self <: ParamsResourceProjectsLocationsTransferconfigsRunsDelete] (val x: Self) extends AnyVal {
    @scala.inline
