...
object SchemaListDataSourcesResponse {
  ...
  implicit class SchemaListDataSourcesResponseOps[Self <: SchemaListDataSourcesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataSourcesVarargs(value: SchemaDataSource*): Self = this.set("dataSources", js.Array(value :_*))
    @scala.inline
    def setDataSources(value: js.Array[SchemaDataSource]): Self = this.set("dataSources", value.asInstanceOf[js.Any])
    @scala.inline
