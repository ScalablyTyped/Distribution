...
object ParamsResourceProjectsLocationsTransferconfigsDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsTransferconfigsDeleteOps[Self <: ParamsResourceProjectsLocationsTransferconfigsDelete] (val x: Self) extends AnyVal {
    @scala.inline
