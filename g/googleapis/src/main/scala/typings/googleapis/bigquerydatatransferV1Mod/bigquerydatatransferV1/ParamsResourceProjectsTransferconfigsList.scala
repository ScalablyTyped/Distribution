...
trait ParamsResourceProjectsTransferconfigsList
  extends StObject
...
object ParamsResourceProjectsTransferconfigsList {
  ...
  inline def apply(): ParamsResourceProjectsTransferconfigsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsTransferconfigsList]
  }
  
  extension [Self <: ParamsResourceProjectsTransferconfigsList](x: Self) {
