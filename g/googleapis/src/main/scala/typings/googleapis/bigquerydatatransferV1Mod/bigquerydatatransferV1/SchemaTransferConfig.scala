...
trait SchemaTransferConfig extends StObject {
  ...
  /**
    ...
    */
  var dataRefreshWindowDays: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var datasetRegion: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var nextRunTime: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var ownerInfo: js.UndefOr[SchemaUserInfo] = js.undefined
...
object SchemaTransferConfig {
  ...
  inline def apply(): SchemaTransferConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaTransferConfig]
  }
  
  extension [Self <: SchemaTransferConfig](x: Self) {
    
    inline def setDataRefreshWindowDays(value: Double): Self = StObject.set(x, "dataRefreshWindowDays", value.asInstanceOf[js.Any])
    
    inline def setDataRefreshWindowDaysNull: Self = StObject.set(x, "dataRefreshWindowDays", null)
    ...
    inline def setDatasetRegionNull: Self = StObject.set(x, "datasetRegion", null)
    ...
    inline def setNextRunTimeNull: Self = StObject.set(x, "nextRunTime", null)
    ...
    inline def setOwnerInfo(value: SchemaUserInfo): Self = StObject.set(x, "ownerInfo", value.asInstanceOf[js.Any])
    ...
    inline def setScheduleOptions(value: SchemaScheduleOptions): Self = StObject.set(x, "scheduleOptions", value.asInstanceOf[js.Any])
