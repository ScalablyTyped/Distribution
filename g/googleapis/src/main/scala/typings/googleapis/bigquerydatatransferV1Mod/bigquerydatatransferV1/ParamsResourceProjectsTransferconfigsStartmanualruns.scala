...
trait ParamsResourceProjectsTransferconfigsStartmanualruns
  extends StObject
...
object ParamsResourceProjectsTransferconfigsStartmanualruns {
  ...
  inline def apply(): ParamsResourceProjectsTransferconfigsStartmanualruns = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsTransferconfigsStartmanualruns]
  }
  
  extension [Self <: ParamsResourceProjectsTransferconfigsStartmanualruns](x: Self) {
