...
@js.native
open class ResourceProjectsTransferconfigsRuns protected () extends StObject {
  ...
  /**
    ...
    */
  def delete(params: ParamsResourceProjectsTransferconfigsRunsDelete, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def delete(
    params: ParamsResourceProjectsTransferconfigsRunsDelete,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def get(params: ParamsResourceProjectsTransferconfigsRunsGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceProjectsTransferconfigsRunsGet,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceProjectsTransferconfigsRunsList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsTransferconfigsRunsList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
