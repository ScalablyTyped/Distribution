...
object ParamsResourceProjectsDatasourcesList {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsDatasourcesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsDatasourcesList]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsDatasourcesListMutableBuilder[Self <: ParamsResourceProjectsDatasourcesList] (val x: Self) extends AnyVal {
