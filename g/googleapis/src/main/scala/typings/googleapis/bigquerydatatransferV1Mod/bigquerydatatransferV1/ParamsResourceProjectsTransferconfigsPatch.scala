...
trait ParamsResourceProjectsTransferconfigsPatch
  extends StObject
...
object ParamsResourceProjectsTransferconfigsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsTransferconfigsPatchMutableBuilder[Self <: ParamsResourceProjectsTransferconfigsPatch] (val x: Self) extends AnyVal {
