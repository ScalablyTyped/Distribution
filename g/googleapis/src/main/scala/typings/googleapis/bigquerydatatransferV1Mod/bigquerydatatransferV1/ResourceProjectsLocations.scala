...
open class ResourceProjectsLocations protected () extends StObject {
  ...
  def enrollDataSources(params: ParamsResourceProjectsLocationsEnrolldatasources): GaxiosPromise[SchemaEmpty] = js.native
  def enrollDataSources(
    params: ParamsResourceProjectsLocationsEnrolldatasources,
  ...
  def enrollDataSources(params: ParamsResourceProjectsLocationsEnrolldatasources, options: MethodOptions): GaxiosPromise[SchemaEmpty] = js.native
  def enrollDataSources(
    params: ParamsResourceProjectsLocationsEnrolldatasources,
  ...
  /**
    ...
    */
  def enrollDataSources(params: ParamsResourceProjectsLocationsEnrolldatasources, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def enrollDataSources(
    params: ParamsResourceProjectsLocationsEnrolldatasources,
