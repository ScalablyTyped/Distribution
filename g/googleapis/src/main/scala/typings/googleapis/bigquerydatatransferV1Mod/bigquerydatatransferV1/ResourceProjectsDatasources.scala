...
@js.native
open class ResourceProjectsDatasources protected () extends StObject {
  ...
  /**
    ...
    */
  def checkValidCreds(params: ParamsResourceProjectsDatasourcesCheckvalidcreds, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def checkValidCreds(
    params: ParamsResourceProjectsDatasourcesCheckvalidcreds,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def get(params: ParamsResourceProjectsDatasourcesGet, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def get(
    params: ParamsResourceProjectsDatasourcesGet,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceProjectsDatasourcesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsDatasourcesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
