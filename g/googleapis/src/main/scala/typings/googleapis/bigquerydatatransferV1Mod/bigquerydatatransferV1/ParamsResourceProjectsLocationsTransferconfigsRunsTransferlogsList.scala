...
object ParamsResourceProjectsLocationsTransferconfigsRunsTransferlogsList {
  ...
  inline def apply(): ParamsResourceProjectsLocationsTransferconfigsRunsTransferlogsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsTransferconfigsRunsTransferlogsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsTransferconfigsRunsTransferlogsList](x: Self) {
