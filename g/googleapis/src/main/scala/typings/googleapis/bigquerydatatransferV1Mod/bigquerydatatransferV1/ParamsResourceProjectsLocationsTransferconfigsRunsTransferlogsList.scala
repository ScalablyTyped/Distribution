...
object ParamsResourceProjectsLocationsTransferconfigsRunsTransferlogsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsTransferconfigsRunsTransferlogsListOps[Self <: ParamsResourceProjectsLocationsTransferconfigsRunsTransferlogsList] (val x: Self) extends AnyVal {
    @scala.inline
