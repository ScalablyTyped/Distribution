...
trait SchemaGoogleMapsPlayablelocationsV3LogImpressionsRequest extends StObject {
  ...
  /**
    ...
    */
  var impressions: js.UndefOr[js.Array[SchemaGoogleMapsPlayablelocationsV3Impression]] = js.undefined
...
object SchemaGoogleMapsPlayablelocationsV3LogImpressionsRequest {
  
  inline def apply(): SchemaGoogleMapsPlayablelocationsV3LogImpressionsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleMapsPlayablelocationsV3LogImpressionsRequest]
  }
  
  extension [Self <: SchemaGoogleMapsPlayablelocationsV3LogImpressionsRequest](x: Self) {
    ...
    inline def setImpressions(value: js.Array[SchemaGoogleMapsPlayablelocationsV3Impression]): Self = StObject.set(x, "impressions", value.asInstanceOf[js.Any])
    
    inline def setImpressionsUndefined: Self = StObject.set(x, "impressions", js.undefined)
    
    inline def setImpressionsVarargs(value: SchemaGoogleMapsPlayablelocationsV3Impression*): Self = StObject.set(x, "impressions", js.Array(value*))
