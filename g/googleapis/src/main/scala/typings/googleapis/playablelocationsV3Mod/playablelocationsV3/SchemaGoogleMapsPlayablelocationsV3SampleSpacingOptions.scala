...
trait SchemaGoogleMapsPlayablelocationsV3SampleSpacingOptions extends StObject {
  ...
  /**
    ...
    */
  var minSpacingMeters: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var pointType: js.UndefOr[String | Null] = js.undefined
}
object SchemaGoogleMapsPlayablelocationsV3SampleSpacingOptions {
  
  inline def apply(): SchemaGoogleMapsPlayablelocationsV3SampleSpacingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleMapsPlayablelocationsV3SampleSpacingOptions]
  }
  
  extension [Self <: SchemaGoogleMapsPlayablelocationsV3SampleSpacingOptions](x: Self) {
    
    inline def setMinSpacingMeters(value: Double): Self = StObject.set(x, "minSpacingMeters", value.asInstanceOf[js.Any])
    
    inline def setMinSpacingMetersNull: Self = StObject.set(x, "minSpacingMeters", null)
    ...
    inline def setPointTypeNull: Self = StObject.set(x, "pointType", null)
