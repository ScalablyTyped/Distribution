...
trait SchemaGoogleMapsPlayablelocationsV3PlayerReport extends StObject {
  ...
  /**
    ...
    */
  var reasonDetails: js.UndefOr[String | Null] = js.undefined
...
object SchemaGoogleMapsPlayablelocationsV3PlayerReport {
  
  inline def apply(): SchemaGoogleMapsPlayablelocationsV3PlayerReport = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleMapsPlayablelocationsV3PlayerReport]
  }
  
  extension [Self <: SchemaGoogleMapsPlayablelocationsV3PlayerReport](x: Self) {
    ...
    inline def setReasonDetailsNull: Self = StObject.set(x, "reasonDetails", null)
