...
object ParamsResourceProjectsPatchtraces {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsPatchtracesOps[Self <: ParamsResourceProjectsPatchtraces] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaTraces): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
