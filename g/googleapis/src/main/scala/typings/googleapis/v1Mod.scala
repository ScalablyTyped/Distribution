...
object v1Mod {
  ...
  object abusiveexperiencereportV1 {
    ...
    @js.native
    open class Abusiveexperiencereport protected () extends StObject {
    ...
    trait SchemaSiteSummaryResponse extends StObject {
      ...
      /**
        ...
        */
      var abusiveStatus: js.UndefOr[String | Null] = js.undefined
    ...
    object SchemaSiteSummaryResponse {
      ...
      extension [Self <: SchemaSiteSummaryResponse](x: Self) {
        ...
        inline def setAbusiveStatusNull: Self = StObject.set(x, "abusiveStatus", null)
