...
trait SchemaGoogleCloudRetailV2betaUserEvent extends StObject {
  ...
  /**
    ...
    */
  var completionDetail: js.UndefOr[SchemaGoogleCloudRetailV2betaCompletionDetail] = js.undefined
  ...
  /**
    ...
    */
  var productDetails: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2betaProductDetail]] = js.undefined
  ...
  /**
    ...
    */
  var purchaseTransaction: js.UndefOr[SchemaGoogleCloudRetailV2betaPurchaseTransaction] = js.undefined
  ...
  /**
    * User information.
    */
  var userInfo: js.UndefOr[SchemaGoogleCloudRetailV2betaUserInfo] = js.undefined
...
object SchemaGoogleCloudRetailV2betaUserEvent {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaUserEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaUserEvent]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaUserEvent](x: Self) {
    ...
    inline def setCompletionDetail(value: SchemaGoogleCloudRetailV2betaCompletionDetail): Self = StObject.set(x, "completionDetail", value.asInstanceOf[js.Any])
    ...
    inline def setProductDetails(value: js.Array[SchemaGoogleCloudRetailV2betaProductDetail]): Self = StObject.set(x, "productDetails", value.asInstanceOf[js.Any])
    
    inline def setProductDetailsUndefined: Self = StObject.set(x, "productDetails", js.undefined)
    
    inline def setProductDetailsVarargs(value: SchemaGoogleCloudRetailV2betaProductDetail*): Self = StObject.set(x, "productDetails", js.Array(value*))
    
    inline def setPurchaseTransaction(value: SchemaGoogleCloudRetailV2betaPurchaseTransaction): Self = StObject.set(x, "purchaseTransaction", value.asInstanceOf[js.Any])
    ...
    inline def setUserInfo(value: SchemaGoogleCloudRetailV2betaUserInfo): Self = StObject.set(x, "userInfo", value.asInstanceOf[js.Any])
