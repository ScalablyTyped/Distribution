...
trait SchemaGoogleCloudRetailV2betaUserInfo extends StObject {
...
object SchemaGoogleCloudRetailV2betaUserInfo {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaUserInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaUserInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaUserInfo](x: Self) {
