...
@JSImport("googleapis/build/src/apis/retail/v2beta", "retail_v2beta.Resource$Projects$Locations$Catalogs$Placements")
@js.native
open class ResourceProjectsLocationsCatalogsPlacements protected () extends StObject {
  ...
  def predict(): GaxiosPromise[SchemaGoogleCloudRetailV2betaPredictResponse] = js.native
  def predict(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaPredictResponse]): Unit = js.native
  def predict(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaPredictResponse] = js.native
  def predict(params: ParamsResourceProjectsLocationsCatalogsPlacementsPredict): GaxiosPromise[SchemaGoogleCloudRetailV2betaPredictResponse] = js.native
  def predict(
    params: ParamsResourceProjectsLocationsCatalogsPlacementsPredict,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaPredictResponse]
  ): Unit = js.native
  def predict(
    params: ParamsResourceProjectsLocationsCatalogsPlacementsPredict,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2betaPredictResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2betaPredictResponse]
  ): Unit = js.native
  def predict(params: ParamsResourceProjectsLocationsCatalogsPlacementsPredict, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaPredictResponse] = js.native
  def predict(
    params: ParamsResourceProjectsLocationsCatalogsPlacementsPredict,
  ...
  def search(): GaxiosPromise[SchemaGoogleCloudRetailV2betaSearchResponse] = js.native
  def search(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaSearchResponse]): Unit = js.native
  def search(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaSearchResponse] = js.native
  def search(params: ParamsResourceProjectsLocationsCatalogsPlacementsSearch): GaxiosPromise[SchemaGoogleCloudRetailV2betaSearchResponse] = js.native
  def search(
    params: ParamsResourceProjectsLocationsCatalogsPlacementsSearch,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaSearchResponse]
  ): Unit = js.native
  def search(
    params: ParamsResourceProjectsLocationsCatalogsPlacementsSearch,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2betaSearchResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2betaSearchResponse]
  ): Unit = js.native
  def search(params: ParamsResourceProjectsLocationsCatalogsPlacementsSearch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaSearchResponse] = js.native
  def search(
    params: ParamsResourceProjectsLocationsCatalogsPlacementsSearch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaSearchResponse]
