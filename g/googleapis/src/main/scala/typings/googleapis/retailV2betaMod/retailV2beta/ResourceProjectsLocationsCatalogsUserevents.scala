...
@JSImport("googleapis/build/src/apis/retail/v2beta", "retail_v2beta.Resource$Projects$Locations$Catalogs$Userevents")
@js.native
open class ResourceProjectsLocationsCatalogsUserevents protected () extends StObject {
  ...
  def write(): GaxiosPromise[SchemaGoogleCloudRetailV2betaUserEvent] = js.native
  def write(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaUserEvent]): Unit = js.native
  def write(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaUserEvent] = js.native
  def write(params: ParamsResourceProjectsLocationsCatalogsUsereventsWrite): GaxiosPromise[SchemaGoogleCloudRetailV2betaUserEvent] = js.native
  def write(
    params: ParamsResourceProjectsLocationsCatalogsUsereventsWrite,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaUserEvent]
  ): Unit = js.native
  def write(
    params: ParamsResourceProjectsLocationsCatalogsUsereventsWrite,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2betaUserEvent],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2betaUserEvent]
  ): Unit = js.native
  def write(params: ParamsResourceProjectsLocationsCatalogsUsereventsWrite, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaUserEvent] = js.native
  def write(
    params: ParamsResourceProjectsLocationsCatalogsUsereventsWrite,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaUserEvent]
