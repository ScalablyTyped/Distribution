...
trait SchemaGoogleCloudRetailV2betaControl extends StObject {
  ...
  /**
    ...
    */
  var facetSpec: js.UndefOr[SchemaGoogleCloudRetailV2betaSearchRequestFacetSpec] = js.undefined
  ...
  /**
    ...
    */
  var rule: js.UndefOr[SchemaGoogleCloudRetailV2betaRule] = js.undefined
...
object SchemaGoogleCloudRetailV2betaControl {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaControl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaControl]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaControl](x: Self) {
    ...
    inline def setFacetSpec(value: SchemaGoogleCloudRetailV2betaSearchRequestFacetSpec): Self = StObject.set(x, "facetSpec", value.asInstanceOf[js.Any])
    ...
    inline def setRule(value: SchemaGoogleCloudRetailV2betaRule): Self = StObject.set(x, "rule", value.asInstanceOf[js.Any])
