...
trait SchemaGoogleCloudRetailV2betaAttributesConfig extends StObject {
  ...
  /**
    ...
    */
  var catalogAttributes: js.UndefOr[StringDictionary[SchemaGoogleCloudRetailV2betaCatalogAttribute] | Null] = js.undefined
...
object SchemaGoogleCloudRetailV2betaAttributesConfig {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaAttributesConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaAttributesConfig]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaAttributesConfig](x: Self) {
    ...
    inline def setCatalogAttributes(value: StringDictionary[SchemaGoogleCloudRetailV2betaCatalogAttribute]): Self = StObject.set(x, "catalogAttributes", value.asInstanceOf[js.Any])
