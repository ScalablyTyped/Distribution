...
trait SchemaGoogleCloudRetailV2betaCompletionConfig extends StObject {
  
  /**
    * Output only. The source data for the latest import of the autocomplete allowlist phrases.
    */
  var allowlistInputConfig: js.UndefOr[SchemaGoogleCloudRetailV2betaCompletionDataInputConfig] = js.undefined
  ...
  /**
    ...
    */
  var denylistInputConfig: js.UndefOr[SchemaGoogleCloudRetailV2betaCompletionDataInputConfig] = js.undefined
  ...
  /**
    ...
    */
  var suggestionsInputConfig: js.UndefOr[SchemaGoogleCloudRetailV2betaCompletionDataInputConfig] = js.undefined
}
object SchemaGoogleCloudRetailV2betaCompletionConfig {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaCompletionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaCompletionConfig]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaCompletionConfig](x: Self) {
    
    inline def setAllowlistInputConfig(value: SchemaGoogleCloudRetailV2betaCompletionDataInputConfig): Self = StObject.set(x, "allowlistInputConfig", value.asInstanceOf[js.Any])
    ...
    inline def setDenylistInputConfig(value: SchemaGoogleCloudRetailV2betaCompletionDataInputConfig): Self = StObject.set(x, "denylistInputConfig", value.asInstanceOf[js.Any])
    ...
    inline def setSuggestionsInputConfig(value: SchemaGoogleCloudRetailV2betaCompletionDataInputConfig): Self = StObject.set(x, "suggestionsInputConfig", value.asInstanceOf[js.Any])
