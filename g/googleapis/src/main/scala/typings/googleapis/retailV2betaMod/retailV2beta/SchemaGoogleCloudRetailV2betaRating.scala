...
trait SchemaGoogleCloudRetailV2betaRating extends StObject {
...
object SchemaGoogleCloudRetailV2betaRating {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaRating = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaRating]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaRating](x: Self) {
