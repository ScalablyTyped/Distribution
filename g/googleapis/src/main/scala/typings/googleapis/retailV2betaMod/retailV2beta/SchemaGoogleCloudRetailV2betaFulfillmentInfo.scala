...
trait SchemaGoogleCloudRetailV2betaFulfillmentInfo extends StObject {
...
object SchemaGoogleCloudRetailV2betaFulfillmentInfo {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaFulfillmentInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaFulfillmentInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaFulfillmentInfo](x: Self) {
