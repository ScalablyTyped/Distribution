...
trait SchemaGoogleCloudRetailV2betaSearchRequestBoostSpec extends StObject {
  ...
  /**
    ...
    */
  var conditionBoostSpecs: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2betaSearchRequestBoostSpecConditionBoostSpec]] = js.undefined
...
object SchemaGoogleCloudRetailV2betaSearchRequestBoostSpec {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaSearchRequestBoostSpec = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaSearchRequestBoostSpec]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaSearchRequestBoostSpec](x: Self) {
    
    inline def setConditionBoostSpecs(value: js.Array[SchemaGoogleCloudRetailV2betaSearchRequestBoostSpecConditionBoostSpec]): Self = StObject.set(x, "conditionBoostSpecs", value.asInstanceOf[js.Any])
    
    inline def setConditionBoostSpecsUndefined: Self = StObject.set(x, "conditionBoostSpecs", js.undefined)
    
    inline def setConditionBoostSpecsVarargs(value: SchemaGoogleCloudRetailV2betaSearchRequestBoostSpecConditionBoostSpec*): Self = StObject.set(x, "conditionBoostSpecs", js.Array(value*))
