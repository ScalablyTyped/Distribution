...
trait SchemaGoogleCloudRetailV2betaRuleDoNotAssociateAction extends StObject {
...
object SchemaGoogleCloudRetailV2betaRuleDoNotAssociateAction {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaRuleDoNotAssociateAction = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaRuleDoNotAssociateAction]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaRuleDoNotAssociateAction](x: Self) {
