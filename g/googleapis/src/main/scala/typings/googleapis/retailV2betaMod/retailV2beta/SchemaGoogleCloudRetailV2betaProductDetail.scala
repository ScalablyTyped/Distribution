...
trait SchemaGoogleCloudRetailV2betaProductDetail extends StObject {
  ...
  /**
    ...
    */
  var product: js.UndefOr[SchemaGoogleCloudRetailV2betaProduct] = js.undefined
...
object SchemaGoogleCloudRetailV2betaProductDetail {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaProductDetail = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaProductDetail]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaProductDetail](x: Self) {
    
    inline def setProduct(value: SchemaGoogleCloudRetailV2betaProduct): Self = StObject.set(x, "product", value.asInstanceOf[js.Any])
