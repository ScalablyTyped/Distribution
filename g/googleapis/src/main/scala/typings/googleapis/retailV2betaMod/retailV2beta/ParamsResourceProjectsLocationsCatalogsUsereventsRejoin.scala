...
trait ParamsResourceProjectsLocationsCatalogsUsereventsRejoin
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2betaRejoinUserEventsRequest] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsUsereventsRejoin {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsUsereventsRejoin](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2betaRejoinUserEventsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
