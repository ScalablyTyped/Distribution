...
trait SchemaGoogleCloudRetailV2betaRemoveLocalInventoriesRequest extends StObject {
...
object SchemaGoogleCloudRetailV2betaRemoveLocalInventoriesRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaRemoveLocalInventoriesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaRemoveLocalInventoriesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaRemoveLocalInventoriesRequest](x: Self) {
