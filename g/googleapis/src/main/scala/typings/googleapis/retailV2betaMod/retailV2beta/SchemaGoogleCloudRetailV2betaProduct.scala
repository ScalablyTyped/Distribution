...
trait SchemaGoogleCloudRetailV2betaProduct extends StObject {
  ...
  /**
    ...
    */
  var audience: js.UndefOr[SchemaGoogleCloudRetailV2betaAudience] = js.undefined
  ...
  /**
    ...
    */
  var colorInfo: js.UndefOr[SchemaGoogleCloudRetailV2betaColorInfo] = js.undefined
  ...
  /**
    ...
    */
  var fulfillmentInfo: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2betaFulfillmentInfo]] = js.undefined
  ...
  /**
    ...
    */
  var images: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2betaImage]] = js.undefined
  ...
  /**
    ...
    */
  var priceInfo: js.UndefOr[SchemaGoogleCloudRetailV2betaPriceInfo] = js.undefined
  ...
  /**
    ...
    */
  var promotions: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2betaPromotion]] = js.undefined
  ...
  /**
    ...
    */
  var rating: js.UndefOr[SchemaGoogleCloudRetailV2betaRating] = js.undefined
  ...
  /**
    ...
    */
  var variants: js.UndefOr[js.Array[SchemaGoogleCloudRetailV2betaProduct]] = js.undefined
}
object SchemaGoogleCloudRetailV2betaProduct {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaProduct = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaProduct]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaProduct](x: Self) {
    ...
    inline def setAudience(value: SchemaGoogleCloudRetailV2betaAudience): Self = StObject.set(x, "audience", value.asInstanceOf[js.Any])
    ...
    inline def setColorInfo(value: SchemaGoogleCloudRetailV2betaColorInfo): Self = StObject.set(x, "colorInfo", value.asInstanceOf[js.Any])
    ...
    inline def setFulfillmentInfo(value: js.Array[SchemaGoogleCloudRetailV2betaFulfillmentInfo]): Self = StObject.set(x, "fulfillmentInfo", value.asInstanceOf[js.Any])
    
    inline def setFulfillmentInfoUndefined: Self = StObject.set(x, "fulfillmentInfo", js.undefined)
    
    inline def setFulfillmentInfoVarargs(value: SchemaGoogleCloudRetailV2betaFulfillmentInfo*): Self = StObject.set(x, "fulfillmentInfo", js.Array(value*))
    ...
    inline def setImages(value: js.Array[SchemaGoogleCloudRetailV2betaImage]): Self = StObject.set(x, "images", value.asInstanceOf[js.Any])
    
    inline def setImagesUndefined: Self = StObject.set(x, "images", js.undefined)
    
    inline def setImagesVarargs(value: SchemaGoogleCloudRetailV2betaImage*): Self = StObject.set(x, "images", js.Array(value*))
    ...
    inline def setPriceInfo(value: SchemaGoogleCloudRetailV2betaPriceInfo): Self = StObject.set(x, "priceInfo", value.asInstanceOf[js.Any])
    ...
    inline def setPromotions(value: js.Array[SchemaGoogleCloudRetailV2betaPromotion]): Self = StObject.set(x, "promotions", value.asInstanceOf[js.Any])
    
    inline def setPromotionsUndefined: Self = StObject.set(x, "promotions", js.undefined)
    
    inline def setPromotionsVarargs(value: SchemaGoogleCloudRetailV2betaPromotion*): Self = StObject.set(x, "promotions", js.Array(value*))
    ...
    inline def setRating(value: SchemaGoogleCloudRetailV2betaRating): Self = StObject.set(x, "rating", value.asInstanceOf[js.Any])
    ...
    inline def setVariants(value: js.Array[SchemaGoogleCloudRetailV2betaProduct]): Self = StObject.set(x, "variants", value.asInstanceOf[js.Any])
    
    inline def setVariantsUndefined: Self = StObject.set(x, "variants", js.undefined)
    
    inline def setVariantsVarargs(value: SchemaGoogleCloudRetailV2betaProduct*): Self = StObject.set(x, "variants", js.Array(value*))
  }
}
