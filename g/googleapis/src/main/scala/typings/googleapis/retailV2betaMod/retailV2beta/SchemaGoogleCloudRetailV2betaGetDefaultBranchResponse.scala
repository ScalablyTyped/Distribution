...
trait SchemaGoogleCloudRetailV2betaGetDefaultBranchResponse extends StObject {
...
object SchemaGoogleCloudRetailV2betaGetDefaultBranchResponse {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaGetDefaultBranchResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaGetDefaultBranchResponse]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaGetDefaultBranchResponse](x: Self) {
