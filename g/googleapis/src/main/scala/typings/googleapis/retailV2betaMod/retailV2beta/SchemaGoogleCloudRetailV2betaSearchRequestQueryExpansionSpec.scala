...
trait SchemaGoogleCloudRetailV2betaSearchRequestQueryExpansionSpec extends StObject {
...
object SchemaGoogleCloudRetailV2betaSearchRequestQueryExpansionSpec {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaSearchRequestQueryExpansionSpec = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaSearchRequestQueryExpansionSpec]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaSearchRequestQueryExpansionSpec](x: Self) {
