...
trait SchemaGoogleCloudRetailV2betaSetDefaultBranchRequest extends StObject {
...
object SchemaGoogleCloudRetailV2betaSetDefaultBranchRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaSetDefaultBranchRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaSetDefaultBranchRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaSetDefaultBranchRequest](x: Self) {
