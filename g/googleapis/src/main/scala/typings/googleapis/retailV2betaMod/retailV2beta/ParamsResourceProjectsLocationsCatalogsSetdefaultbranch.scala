...
trait ParamsResourceProjectsLocationsCatalogsSetdefaultbranch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2betaSetDefaultBranchRequest] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsSetdefaultbranch {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsSetdefaultbranch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2betaSetDefaultBranchRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
