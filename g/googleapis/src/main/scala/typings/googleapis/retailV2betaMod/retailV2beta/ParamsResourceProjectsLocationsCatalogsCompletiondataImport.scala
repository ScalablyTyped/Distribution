...
trait ParamsResourceProjectsLocationsCatalogsCompletiondataImport
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2betaImportCompletionDataRequest] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsCompletiondataImport {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsCompletiondataImport](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2betaImportCompletionDataRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
