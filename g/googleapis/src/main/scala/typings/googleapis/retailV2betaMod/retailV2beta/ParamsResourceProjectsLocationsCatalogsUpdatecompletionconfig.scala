...
trait ParamsResourceProjectsLocationsCatalogsUpdatecompletionconfig
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2betaCompletionConfig] = js.undefined
...
object ParamsResourceProjectsLocationsCatalogsUpdatecompletionconfig {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsUpdatecompletionconfig](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2betaCompletionConfig): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
