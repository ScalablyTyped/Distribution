...
trait SchemaGoogleCloudRetailV2betaColorInfo extends StObject {
...
object SchemaGoogleCloudRetailV2betaColorInfo {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaColorInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaColorInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaColorInfo](x: Self) {
