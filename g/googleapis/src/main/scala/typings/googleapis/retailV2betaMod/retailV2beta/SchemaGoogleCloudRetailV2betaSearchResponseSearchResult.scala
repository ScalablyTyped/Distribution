...
trait SchemaGoogleCloudRetailV2betaSearchResponseSearchResult extends StObject {
...
object SchemaGoogleCloudRetailV2betaSearchResponseSearchResult {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaSearchResponseSearchResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaSearchResponseSearchResult]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaSearchResponseSearchResult](x: Self) {
