...
trait SchemaGoogleCloudRetailV2betaLocalInventory extends StObject {
...
object SchemaGoogleCloudRetailV2betaLocalInventory {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaLocalInventory = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaLocalInventory]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaLocalInventory](x: Self) {
