...
trait SchemaGoogleCloudRetailV2betaExportProductsResponse extends StObject {
...
object SchemaGoogleCloudRetailV2betaExportProductsResponse {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaExportProductsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaExportProductsResponse]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaExportProductsResponse](x: Self) {
