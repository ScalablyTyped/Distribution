...
trait ParamsResourceProjectsLocationsCatalogsBranchesProductsImport
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2betaImportProductsRequest] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsBranchesProductsImport {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsBranchesProductsImport](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2betaImportProductsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
