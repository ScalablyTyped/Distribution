...
trait SchemaGoogleCloudRetailV2betaServingConfig extends StObject {
...
object SchemaGoogleCloudRetailV2betaServingConfig {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaServingConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaServingConfig]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaServingConfig](x: Self) {
