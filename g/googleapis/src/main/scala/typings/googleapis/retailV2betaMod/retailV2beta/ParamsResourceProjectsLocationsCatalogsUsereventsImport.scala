...
trait ParamsResourceProjectsLocationsCatalogsUsereventsImport
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2betaImportUserEventsRequest] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsUsereventsImport {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsUsereventsImport](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2betaImportUserEventsRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
