...
trait SchemaGoogleCloudRetailV2betaAddFulfillmentPlacesRequest extends StObject {
...
object SchemaGoogleCloudRetailV2betaAddFulfillmentPlacesRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaAddFulfillmentPlacesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaAddFulfillmentPlacesRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaAddFulfillmentPlacesRequest](x: Self) {
