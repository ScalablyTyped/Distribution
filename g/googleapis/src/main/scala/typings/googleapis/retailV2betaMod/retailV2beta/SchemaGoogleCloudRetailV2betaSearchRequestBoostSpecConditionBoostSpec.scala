...
trait SchemaGoogleCloudRetailV2betaSearchRequestBoostSpecConditionBoostSpec extends StObject {
...
object SchemaGoogleCloudRetailV2betaSearchRequestBoostSpecConditionBoostSpec {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaSearchRequestBoostSpecConditionBoostSpec = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaSearchRequestBoostSpecConditionBoostSpec]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaSearchRequestBoostSpecConditionBoostSpec](x: Self) {
