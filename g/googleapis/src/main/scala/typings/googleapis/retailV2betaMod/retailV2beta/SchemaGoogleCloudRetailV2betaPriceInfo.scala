...
trait SchemaGoogleCloudRetailV2betaPriceInfo extends StObject {
  ...
  /**
    ...
    */
  var priceRange: js.UndefOr[SchemaGoogleCloudRetailV2betaPriceInfoPriceRange] = js.undefined
}
object SchemaGoogleCloudRetailV2betaPriceInfo {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaPriceInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaPriceInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaPriceInfo](x: Self) {
    ...
    inline def setPriceRange(value: SchemaGoogleCloudRetailV2betaPriceInfoPriceRange): Self = StObject.set(x, "priceRange", value.asInstanceOf[js.Any])
