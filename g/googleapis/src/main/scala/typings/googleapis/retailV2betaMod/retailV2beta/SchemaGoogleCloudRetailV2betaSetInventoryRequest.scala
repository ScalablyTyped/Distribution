...
trait SchemaGoogleCloudRetailV2betaSetInventoryRequest extends StObject {
  ...
  /**
    ...
    */
  var inventory: js.UndefOr[SchemaGoogleCloudRetailV2betaProduct] = js.undefined
...
object SchemaGoogleCloudRetailV2betaSetInventoryRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaSetInventoryRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaSetInventoryRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaSetInventoryRequest](x: Self) {
    ...
    inline def setInventory(value: SchemaGoogleCloudRetailV2betaProduct): Self = StObject.set(x, "inventory", value.asInstanceOf[js.Any])
