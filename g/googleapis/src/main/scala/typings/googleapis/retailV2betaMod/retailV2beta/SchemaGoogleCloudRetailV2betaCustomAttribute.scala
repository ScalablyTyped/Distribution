...
trait SchemaGoogleCloudRetailV2betaCustomAttribute extends StObject {
...
object SchemaGoogleCloudRetailV2betaCustomAttribute {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaCustomAttribute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaCustomAttribute]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaCustomAttribute](x: Self) {
