...
trait SchemaGoogleCloudRetailV2betaSearchResponseQueryExpansionInfo extends StObject {
...
object SchemaGoogleCloudRetailV2betaSearchResponseQueryExpansionInfo {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaSearchResponseQueryExpansionInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaSearchResponseQueryExpansionInfo]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaSearchResponseQueryExpansionInfo](x: Self) {
