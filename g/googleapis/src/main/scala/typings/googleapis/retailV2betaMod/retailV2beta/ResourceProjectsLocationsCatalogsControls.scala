...
@JSImport("googleapis/build/src/apis/retail/v2beta", "retail_v2beta.Resource$Projects$Locations$Catalogs$Controls")
@js.native
open class ResourceProjectsLocationsCatalogsControls protected () extends StObject {
  ...
  def create(): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def create(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaControl]): Unit = js.native
  def create(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def create(params: ParamsResourceProjectsLocationsCatalogsControlsCreate): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def create(
    params: ParamsResourceProjectsLocationsCatalogsControlsCreate,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaControl]
  ): Unit = js.native
  def create(
    params: ParamsResourceProjectsLocationsCatalogsControlsCreate,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2betaControl],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2betaControl]
  ): Unit = js.native
  def create(params: ParamsResourceProjectsLocationsCatalogsControlsCreate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def create(
    params: ParamsResourceProjectsLocationsCatalogsControlsCreate,
  ...
  def get(): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def get(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaControl]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def get(params: ParamsResourceProjectsLocationsCatalogsControlsGet): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def get(
  ...
  def get(params: ParamsResourceProjectsLocationsCatalogsControlsGet, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def get(
    params: ParamsResourceProjectsLocationsCatalogsControlsGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaControl]
  ...
  def list(): GaxiosPromise[SchemaGoogleCloudRetailV2betaListControlsResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaListControlsResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaListControlsResponse] = js.native
  def list(params: ParamsResourceProjectsLocationsCatalogsControlsList): GaxiosPromise[SchemaGoogleCloudRetailV2betaListControlsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsControlsList,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaListControlsResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsControlsList,
    options: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2betaListControlsResponse],
    callback: BodyResponseCallback[Readable | SchemaGoogleCloudRetailV2betaListControlsResponse]
  ): Unit = js.native
  def list(params: ParamsResourceProjectsLocationsCatalogsControlsList, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaListControlsResponse] = js.native
  def list(
    params: ParamsResourceProjectsLocationsCatalogsControlsList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaListControlsResponse]
  ...
  def patch(): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def patch(callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaControl]): Unit = js.native
  def patch(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def patch(params: ParamsResourceProjectsLocationsCatalogsControlsPatch): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def patch(
  ...
  def patch(params: ParamsResourceProjectsLocationsCatalogsControlsPatch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudRetailV2betaControl] = js.native
  def patch(
    params: ParamsResourceProjectsLocationsCatalogsControlsPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleCloudRetailV2betaControl]
