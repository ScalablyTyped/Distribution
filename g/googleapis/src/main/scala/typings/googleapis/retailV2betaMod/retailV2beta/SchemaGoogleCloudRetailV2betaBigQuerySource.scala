...
trait SchemaGoogleCloudRetailV2betaBigQuerySource extends StObject {
...
object SchemaGoogleCloudRetailV2betaBigQuerySource {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaBigQuerySource = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaBigQuerySource]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaBigQuerySource](x: Self) {
