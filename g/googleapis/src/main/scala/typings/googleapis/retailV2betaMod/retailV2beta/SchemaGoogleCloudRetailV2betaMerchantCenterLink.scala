...
trait SchemaGoogleCloudRetailV2betaMerchantCenterLink extends StObject {
...
object SchemaGoogleCloudRetailV2betaMerchantCenterLink {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaMerchantCenterLink = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaMerchantCenterLink]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaMerchantCenterLink](x: Self) {
