...
trait ParamsResourceProjectsLocationsCatalogsServingconfigsPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2betaServingConfig] = js.undefined
...
object ParamsResourceProjectsLocationsCatalogsServingconfigsPatch {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsServingconfigsPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2betaServingConfig): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
