...
trait SchemaGoogleCloudRetailV2betaProductLevelConfig extends StObject {
...
object SchemaGoogleCloudRetailV2betaProductLevelConfig {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaProductLevelConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaProductLevelConfig]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaProductLevelConfig](x: Self) {
