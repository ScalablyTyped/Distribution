...
trait SchemaGoogleCloudRetailV2betaAddControlRequest extends StObject {
...
object SchemaGoogleCloudRetailV2betaAddControlRequest {
  
  inline def apply(): SchemaGoogleCloudRetailV2betaAddControlRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudRetailV2betaAddControlRequest]
  }
  
  extension [Self <: SchemaGoogleCloudRetailV2betaAddControlRequest](x: Self) {
