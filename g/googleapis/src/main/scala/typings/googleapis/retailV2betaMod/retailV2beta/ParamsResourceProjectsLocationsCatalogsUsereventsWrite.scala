...
trait ParamsResourceProjectsLocationsCatalogsUsereventsWrite
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleCloudRetailV2betaUserEvent] = js.undefined
}
object ParamsResourceProjectsLocationsCatalogsUsereventsWrite {
  ...
  extension [Self <: ParamsResourceProjectsLocationsCatalogsUsereventsWrite](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleCloudRetailV2betaUserEvent): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
