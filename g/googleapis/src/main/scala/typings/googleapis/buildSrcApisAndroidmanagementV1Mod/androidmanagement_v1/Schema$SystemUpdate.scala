...
/**
  ...
  */
@js.native
trait Schema$SystemUpdate extends js.Object {
  /**
...
object Schema$SystemUpdate {
  @scala.inline
  def apply(endMinutes: Int | Double = null, startMinutes: Int | Double = null, `type`: String = null): Schema$SystemUpdate = {
    ...
    __obj.asInstanceOf[Schema$SystemUpdate]
  }
}
