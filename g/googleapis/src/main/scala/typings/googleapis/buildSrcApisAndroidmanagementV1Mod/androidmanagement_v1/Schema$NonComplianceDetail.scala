...
/**
  ...
  */
@js.native
trait Schema$NonComplianceDetail extends js.Object {
  /**
...
object Schema$NonComplianceDetail {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$NonComplianceDetail]
  }
}
