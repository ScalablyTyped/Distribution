...
/**
  ...
  */
@js.native
trait Schema$NonComplianceDetailCondition extends js.Object {
  /**
...
object Schema$NonComplianceDetailCondition {
  @scala.inline
  def apply(nonComplianceReason: String = null, packageName: String = null, settingName: String = null): Schema$NonComplianceDetailCondition = {
    ...
    __obj.asInstanceOf[Schema$NonComplianceDetailCondition]
  }
}
