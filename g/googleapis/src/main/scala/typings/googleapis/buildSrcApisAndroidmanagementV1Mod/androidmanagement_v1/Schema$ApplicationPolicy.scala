...
/**
  ...
  */
@js.native
trait Schema$ApplicationPolicy extends js.Object {
  /**
  ...
  /**
    ...
    * set.
    */
  var managedConfigurationTemplate: js.UndefOr[Schema$ManagedConfigurationTemplate] = js.native
  /**
...
object Schema$ApplicationPolicy {
  @scala.inline
  def apply(
    ...
    managedConfigurationTemplate: Schema$ManagedConfigurationTemplate = null,
    ...
    __obj.asInstanceOf[Schema$ApplicationPolicy]
  }
}
