...
@js.native
trait AnonClientSpecificActorInfoDisplayName extends js.Object {
...
object AnonClientSpecificActorInfoDisplayName {
  @scala.inline
  def apply(
  ...
  ): AnonClientSpecificActorInfoDisplayName = {
    ...
    __obj.asInstanceOf[AnonClientSpecificActorInfoDisplayName]
  }
}
