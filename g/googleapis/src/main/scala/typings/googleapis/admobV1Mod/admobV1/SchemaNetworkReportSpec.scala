...
trait SchemaNetworkReportSpec extends StObject {
  ...
  /**
    ...
    */
  var dimensionFilters: js.UndefOr[js.Array[SchemaNetworkReportSpecDimensionFilter]] = js.undefined
  ...
  /**
    ...
    */
  var sortConditions: js.UndefOr[js.Array[SchemaNetworkReportSpecSortCondition]] = js.undefined
...
object SchemaNetworkReportSpec {
  
  inline def apply(): SchemaNetworkReportSpec = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaNetworkReportSpec]
  }
  
  extension [Self <: SchemaNetworkReportSpec](x: Self) {
    ...
    inline def setDimensionFilters(value: js.Array[SchemaNetworkReportSpecDimensionFilter]): Self = StObject.set(x, "dimensionFilters", value.asInstanceOf[js.Any])
    
    inline def setDimensionFiltersUndefined: Self = StObject.set(x, "dimensionFilters", js.undefined)
    
    inline def setDimensionFiltersVarargs(value: SchemaNetworkReportSpecDimensionFilter*): Self = StObject.set(x, "dimensionFilters", js.Array(value*))
    ...
    inline def setSortConditions(value: js.Array[SchemaNetworkReportSpecSortCondition]): Self = StObject.set(x, "sortConditions", value.asInstanceOf[js.Any])
    
    inline def setSortConditionsUndefined: Self = StObject.set(x, "sortConditions", js.undefined)
    
    inline def setSortConditionsVarargs(value: SchemaNetworkReportSpecSortCondition*): Self = StObject.set(x, "sortConditions", js.Array(value*))
