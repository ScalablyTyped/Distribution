...
trait SchemaGenerateNetworkReportResponse extends StObject {
...
object SchemaGenerateNetworkReportResponse {
  
  inline def apply(): SchemaGenerateNetworkReportResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGenerateNetworkReportResponse]
  }
  
  extension [Self <: SchemaGenerateNetworkReportResponse](x: Self) {
