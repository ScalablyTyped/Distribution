...
@js.native
trait Schema$AccountAdwordsLink extends js.Object {
  /**
...
object Schema$AccountAdwordsLink {
  @scala.inline
  def apply(adwordsId: String = null, status: String = null): Schema$AccountAdwordsLink = {
    val __obj = js.Dynamic.literal()
    if (adwordsId != null) __obj.updateDynamic("adwordsId")(adwordsId.asInstanceOf[js.Any])
    if (status != null) __obj.updateDynamic("status")(status.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$AccountAdwordsLink]
  }
}
