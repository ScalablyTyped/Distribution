...
@js.native
trait ParamsDollarResourceDollarAccountstatusesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountstatusesDollarGet {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountstatusesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountstatusesDollarGet]
  }
}
