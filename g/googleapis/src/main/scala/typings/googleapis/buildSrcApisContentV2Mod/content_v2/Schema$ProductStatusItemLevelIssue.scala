...
@js.native
trait Schema$ProductStatusItemLevelIssue extends js.Object {
  /**
...
object Schema$ProductStatusItemLevelIssue {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$ProductStatusItemLevelIssue]
  }
}
