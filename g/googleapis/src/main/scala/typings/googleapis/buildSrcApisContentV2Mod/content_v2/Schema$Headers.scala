...
/**
  ...
  */
@js.native
trait Schema$Headers extends js.Object {
  /**
    * A list of location ID sets. Must be non-empty. Can only be set if all
    * other fields are not set.
    */
  var locations: js.UndefOr[js.Array[Schema$LocationIdSet]] = js.native
  /**
  ...
  /**
    ...
    * other fields are not set.
    */
  var prices: js.UndefOr[js.Array[Schema$Price]] = js.native
  /**
    ...
    */
  var weights: js.UndefOr[js.Array[Schema$Weight]] = js.native
}

object Schema$Headers {
  @scala.inline
  def apply(
    locations: js.Array[Schema$LocationIdSet] = null,
    numberOfItems: js.Array[String] = null,
    postalCodeGroupNames: js.Array[String] = null,
    prices: js.Array[Schema$Price] = null,
    weights: js.Array[Schema$Weight] = null
  ): Schema$Headers = {
    ...
    __obj.asInstanceOf[Schema$Headers]
  }
}
