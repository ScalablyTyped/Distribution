...
@js.native
trait ParamsDollarResourceDollarPosDollarSale extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$PosSaleRequest] = js.native
  /**
...
object ParamsDollarResourceDollarPosDollarSale {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$PosSaleRequest = null,
    targetMerchantId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarPosDollarSale = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarPosDollarSale]
  }
}
