...
@js.native
trait ParamsDollarResourceDollarDatafeedsDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDatafeedsDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDatafeedsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDatafeedsDollarPatch]
  }
}
