...
@js.native
trait Schema$ProductStatusDataQualityIssue extends js.Object {
...
object Schema$ProductStatusDataQualityIssue {
  @scala.inline
  def apply(
  ...
  ): Schema$ProductStatusDataQualityIssue = {
    ...
    __obj.asInstanceOf[Schema$ProductStatusDataQualityIssue]
  }
}
