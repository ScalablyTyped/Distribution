...
trait Schema$Product extends js.Object {
  ...
  /**
    ...
    */
  var aspects: js.UndefOr[js.Array[Schema$ProductAspect]] = js.native
  /**
  ...
  /**
    ...
    */
  var costOfGoodsSold: js.UndefOr[Schema$Price] = js.native
  /**
  ...
  /**
    ...
    */
  var customGroups: js.UndefOr[js.Array[Schema$CustomGroup]] = js.native
  /**
  ...
  /**
    ...
    */
  var destinations: js.UndefOr[js.Array[Schema$ProductDestination]] = js.native
  /**
  ...
  /**
    ...
    */
  var installment: js.UndefOr[Schema$Installment] = js.native
  /**
  ...
  /**
    ...
    */
  var loyaltyPoints: js.UndefOr[Schema$LoyaltyPoints] = js.native
  /**
  ...
  /**
    * Shipping rules.
    */
  var shipping: js.UndefOr[js.Array[Schema$ProductShipping]] = js.native
  /**
    * Height of the item for shipping.
    */
  var shippingHeight: js.UndefOr[Schema$ProductShippingDimension] = js.native
  /**
  ...
  /**
    ...
    */
  var shippingLength: js.UndefOr[Schema$ProductShippingDimension] = js.native
  /**
    * Weight of the item for shipping.
    */
  var shippingWeight: js.UndefOr[Schema$ProductShippingWeight] = js.native
  /**
    * Width of the item for shipping.
    */
  var shippingWidth: js.UndefOr[Schema$ProductShippingDimension] = js.native
  /**
  ...
  /**
    * Tax information.
    */
  var taxes: js.UndefOr[js.Array[Schema$ProductTax]] = js.native
  /**
    * Title of the item.
    */
  ...
  /**
    ...
    */
  var unitPricingBaseMeasure: js.UndefOr[Schema$ProductUnitPricingBaseMeasure] = js.native
  /**
    * The measure and dimension of an item.
    */
  var unitPricingMeasure: js.UndefOr[Schema$ProductUnitPricingMeasure] = js.native
  /**
  ...
  /**
    * Read-only warnings.
    */
  var warnings: js.UndefOr[js.Array[Schema$Error]] = js.native
}
...
object Schema$Product {
  ...
  def apply(
    ...
    aspects: js.Array[Schema$ProductAspect] = null,
    ...
    costOfGoodsSold: Schema$Price = null,
    customAttributes: js.Array[Schema$CustomAttribute] = null,
    customGroups: js.Array[Schema$CustomGroup] = null,
    ...
    destinations: js.Array[Schema$ProductDestination] = null,
    ...
    installment: Schema$Installment = null,
    isBundle: js.UndefOr[Boolean] = js.undefined,
    itemGroupId: String = null,
    kind: String = null,
    link: String = null,
    loyaltyPoints: Schema$LoyaltyPoints = null,
    ...
    shipping: js.Array[Schema$ProductShipping] = null,
    shippingHeight: Schema$ProductShippingDimension = null,
    shippingLabel: String = null,
    shippingLength: Schema$ProductShippingDimension = null,
    shippingWeight: Schema$ProductShippingWeight = null,
    shippingWidth: Schema$ProductShippingDimension = null,
    sizeSystem: String = null,
    sizeType: String = null,
    sizes: js.Array[String] = null,
    source: String = null,
    targetCountry: String = null,
    taxes: js.Array[Schema$ProductTax] = null,
    title: String = null,
    unitPricingBaseMeasure: Schema$ProductUnitPricingBaseMeasure = null,
    unitPricingMeasure: Schema$ProductUnitPricingMeasure = null,
    validatedDestinations: js.Array[String] = null,
    warnings: js.Array[Schema$Error] = null
  ): Schema$Product = {
