...
@js.native
trait Schema$OrdersReturnRefundLineItemRequest extends js.Object {
  /**
...
object Schema$OrdersReturnRefundLineItemRequest {
  @scala.inline
  def apply(
  ...
  ): Schema$OrdersReturnRefundLineItemRequest = {
    ...
    __obj.asInstanceOf[Schema$OrdersReturnRefundLineItemRequest]
  }
}
