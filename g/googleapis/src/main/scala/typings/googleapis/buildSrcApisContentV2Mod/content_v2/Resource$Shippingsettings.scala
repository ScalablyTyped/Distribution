...
class Resource$Shippingsettings protected () extends js.Object {
  ...
  /**
    ...
    * @return {object} Request object
    */
  def patch(): GaxiosPromise[Schema$ShippingSettings] = js.native
  def patch(callback: BodyResponseCallback[Schema$ShippingSettings]): Unit = js.native
  def patch(params: ParamsDollarResourceDollarShippingsettingsDollarPatch): GaxiosPromise[Schema$ShippingSettings] = js.native
  def patch(
    params: ParamsDollarResourceDollarShippingsettingsDollarPatch,
    callback: BodyResponseCallback[Schema$ShippingSettings]
  ): Unit = js.native
  def patch(
    params: ParamsDollarResourceDollarShippingsettingsDollarPatch,
  ...
  def patch(params: ParamsDollarResourceDollarShippingsettingsDollarPatch, options: MethodOptions): GaxiosPromise[Schema$ShippingSettings] = js.native
  def patch(
    params: ParamsDollarResourceDollarShippingsettingsDollarPatch,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ShippingSettings]
