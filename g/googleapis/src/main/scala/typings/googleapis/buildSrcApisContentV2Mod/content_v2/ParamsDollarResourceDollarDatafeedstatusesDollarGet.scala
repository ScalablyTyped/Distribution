...
@js.native
trait ParamsDollarResourceDollarDatafeedstatusesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDatafeedstatusesDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDatafeedstatusesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDatafeedstatusesDollarGet]
  }
}
