...
@js.native
trait ParamsDollarResourceDollarDatafeedsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDatafeedsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDatafeedsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDatafeedsDollarUpdate]
  }
}
