...
@js.native
trait ParamsDollarResourceDollarAccountsDollarClaimwebsite extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarAccountsDollarClaimwebsite {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarAccountsDollarClaimwebsite = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarAccountsDollarClaimwebsite]
  }
}
