...
@js.native
trait Schema$OrdersCustomBatchRequestEntryInStoreRefundLineItem extends js.Object {
  /**
...
object Schema$OrdersCustomBatchRequestEntryInStoreRefundLineItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$OrdersCustomBatchRequestEntryInStoreRefundLineItem]
  }
}
