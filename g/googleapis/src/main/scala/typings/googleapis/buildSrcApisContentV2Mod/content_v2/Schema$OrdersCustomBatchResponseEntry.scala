...
@js.native
trait Schema$OrdersCustomBatchResponseEntry extends js.Object {
  /**
...
object Schema$OrdersCustomBatchResponseEntry {
  @scala.inline
  def apply(
  ...
  ): Schema$OrdersCustomBatchResponseEntry = {
    ...
    __obj.asInstanceOf[Schema$OrdersCustomBatchResponseEntry]
  }
}
