...
@js.native
trait Schema$OrdersCustomBatchRequestEntryRefund extends js.Object {
  /**
...
object Schema$OrdersCustomBatchRequestEntryRefund {
  @scala.inline
  def apply(
  ...
  ): Schema$OrdersCustomBatchRequestEntryRefund = {
    ...
    __obj.asInstanceOf[Schema$OrdersCustomBatchRequestEntryRefund]
  }
}
