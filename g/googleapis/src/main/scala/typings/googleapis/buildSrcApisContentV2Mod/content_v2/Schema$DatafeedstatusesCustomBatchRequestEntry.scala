...
/**
  ...
  */
@js.native
trait Schema$DatafeedstatusesCustomBatchRequestEntry extends js.Object {
  /**
...
object Schema$DatafeedstatusesCustomBatchRequestEntry {
  @scala.inline
  def apply(
    ...
    method: String = null
  ): Schema$DatafeedstatusesCustomBatchRequestEntry = {
    ...
    __obj.asInstanceOf[Schema$DatafeedstatusesCustomBatchRequestEntry]
  }
}
