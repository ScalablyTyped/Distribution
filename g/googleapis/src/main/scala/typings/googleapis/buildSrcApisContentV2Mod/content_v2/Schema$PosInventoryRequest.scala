...
@js.native
trait Schema$PosInventoryRequest extends js.Object {
  /**
...
object Schema$PosInventoryRequest {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$PosInventoryRequest]
  }
}
