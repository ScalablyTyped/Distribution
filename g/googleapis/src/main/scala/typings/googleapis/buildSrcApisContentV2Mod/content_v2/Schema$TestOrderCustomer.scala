...
@js.native
trait Schema$TestOrderCustomer extends js.Object {
  /**
  ...
  /**
    ...
    */
  var marketingRightsInfo: js.UndefOr[Schema$TestOrderCustomerMarketingRightsInfo] = js.native
}

object Schema$TestOrderCustomer {
  @scala.inline
  def apply(
    email: String = null,
    explicitMarketingPreference: js.UndefOr[Boolean] = js.undefined,
    fullName: String = null,
    marketingRightsInfo: Schema$TestOrderCustomerMarketingRightsInfo = null
  ): Schema$TestOrderCustomer = {
    ...
    __obj.asInstanceOf[Schema$TestOrderCustomer]
  }
}
