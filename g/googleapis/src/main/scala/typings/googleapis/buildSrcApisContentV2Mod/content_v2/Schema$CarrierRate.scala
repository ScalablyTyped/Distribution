...
@js.native
trait Schema$CarrierRate extends js.Object {
  /**
  ...
  /**
    ...
    * Optional.
    */
  var flatAdjustment: js.UndefOr[Schema$Price] = js.native
  /**
...
object Schema$CarrierRate {
  @scala.inline
  def apply(
    carrierName: String = null,
    carrierService: String = null,
    flatAdjustment: Schema$Price = null,
    name: String = null,
    ...
    __obj.asInstanceOf[Schema$CarrierRate]
  }
}
