...
@js.native
trait Schema$OrderLegacyPromotion extends js.Object {
  var benefits: js.UndefOr[js.Array[Schema$OrderLegacyPromotionBenefit]] = js.native
  /**
...
object Schema$OrderLegacyPromotion {
  @scala.inline
  def apply(
    benefits: js.Array[Schema$OrderLegacyPromotionBenefit] = null,
    ...
    __obj.asInstanceOf[Schema$OrderLegacyPromotion]
  }
}
