...
@js.native
trait Schema$OrdersCustomBatchRequestEntryCancelLineItem extends js.Object {
  /**
...
object Schema$OrdersCustomBatchRequestEntryCancelLineItem {
  @scala.inline
  def apply(
  ...
  ): Schema$OrdersCustomBatchRequestEntryCancelLineItem = {
    ...
    __obj.asInstanceOf[Schema$OrdersCustomBatchRequestEntryCancelLineItem]
  }
}
