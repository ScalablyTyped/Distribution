...
object SchemaGoogleCloudVisionV1p2beta1AnnotateFileResponse {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p2beta1AnnotateFileResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1AnnotateFileResponse]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1AnnotateFileResponseMutableBuilder[Self <: SchemaGoogleCloudVisionV1p2beta1AnnotateFileResponse] (val x: Self) extends AnyVal {
