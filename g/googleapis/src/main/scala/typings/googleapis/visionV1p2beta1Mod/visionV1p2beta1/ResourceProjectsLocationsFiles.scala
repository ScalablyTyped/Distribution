...
@JSImport("googleapis/build/src/apis/vision/v1p2beta1", "vision_v1p2beta1.Resource$Projects$Locations$Files")
@js.native
open class ResourceProjectsLocationsFiles protected () extends StObject {
  ...
  def annotate(params: ParamsResourceProjectsLocationsFilesAnnotate): GaxiosPromise[SchemaGoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse] = js.native
  def annotate(
  ...
  def annotate(params: ParamsResourceProjectsLocationsFilesAnnotate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudVisionV1p2beta1BatchAnnotateFilesResponse] = js.native
  def annotate(
    params: ParamsResourceProjectsLocationsFilesAnnotate,
