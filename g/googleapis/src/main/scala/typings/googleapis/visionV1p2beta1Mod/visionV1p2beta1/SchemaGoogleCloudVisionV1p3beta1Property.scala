...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1Property extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p3beta1Property {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1PropertyOps[Self <: SchemaGoogleCloudVisionV1p3beta1Property] (val x: Self) extends AnyVal {
    @scala.inline
