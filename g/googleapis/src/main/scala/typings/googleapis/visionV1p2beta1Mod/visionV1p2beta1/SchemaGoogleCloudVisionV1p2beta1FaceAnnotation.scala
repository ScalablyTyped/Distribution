...
object SchemaGoogleCloudVisionV1p2beta1FaceAnnotation {
  ...
  def apply(
    ...
    fdBoundingPoly: SchemaGoogleCloudVisionV1p2beta1BoundingPoly = null,
    headwearLikelihood: String = null,
    joyLikelihood: String = null,
    landmarkingConfidence: js.UndefOr[Double] = js.undefined,
    landmarks: js.Array[SchemaGoogleCloudVisionV1p2beta1FaceAnnotationLandmark] = null,
  ...
  ): SchemaGoogleCloudVisionV1p2beta1FaceAnnotation = {
