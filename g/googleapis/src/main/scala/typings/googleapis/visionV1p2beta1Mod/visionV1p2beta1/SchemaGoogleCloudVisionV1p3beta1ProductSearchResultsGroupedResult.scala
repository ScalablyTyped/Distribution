...
trait SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult extends StObject {
  ...
  /**
    ...
    */
  var objectAnnotations: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsObjectAnnotation]] = js.undefined
...
object SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult](x: Self) {
    ...
    inline def setObjectAnnotations(value: js.Array[SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsObjectAnnotation]): Self = StObject.set(x, "objectAnnotations", value.asInstanceOf[js.Any])
    
    inline def setObjectAnnotationsUndefined: Self = StObject.set(x, "objectAnnotations", js.undefined)
    
    inline def setObjectAnnotationsVarargs(value: SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsObjectAnnotation*): Self = StObject.set(x, "objectAnnotations", js.Array(value*))
