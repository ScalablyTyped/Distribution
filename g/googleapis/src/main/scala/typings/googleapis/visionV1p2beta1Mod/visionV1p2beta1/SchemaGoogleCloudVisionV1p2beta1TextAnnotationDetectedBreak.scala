...
object SchemaGoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak](x: Self) {
