...
object SchemaGoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest](x: Self) {
