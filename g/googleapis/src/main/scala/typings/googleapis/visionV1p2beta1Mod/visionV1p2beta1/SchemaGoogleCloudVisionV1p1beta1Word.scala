...
trait SchemaGoogleCloudVisionV1p1beta1Word extends StObject {
  ...
  /**
    ...
    * reading order.
    */
  var symbols: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p1beta1Symbol]] = js.undefined
}
object SchemaGoogleCloudVisionV1p1beta1Word {
  
  inline def apply(): SchemaGoogleCloudVisionV1p1beta1Word = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1Word]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p1beta1Word](x: Self) {
    ...
    inline def setSymbols(value: js.Array[SchemaGoogleCloudVisionV1p1beta1Symbol]): Self = StObject.set(x, "symbols", value.asInstanceOf[js.Any])
    
    inline def setSymbolsUndefined: Self = StObject.set(x, "symbols", js.undefined)
    
    inline def setSymbolsVarargs(value: SchemaGoogleCloudVisionV1p1beta1Symbol*): Self = StObject.set(x, "symbols", js.Array(value :_*))
  }
}
