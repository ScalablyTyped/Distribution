...
object SchemaGoogleCloudVisionV1p4beta1WebDetectionWebEntity {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1WebDetectionWebEntityMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1WebDetectionWebEntity] (val x: Self) extends AnyVal {
