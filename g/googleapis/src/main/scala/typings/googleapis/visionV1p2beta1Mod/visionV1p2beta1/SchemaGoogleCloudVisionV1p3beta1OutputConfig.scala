...
/**
  ...
  */
trait SchemaGoogleCloudVisionV1p3beta1OutputConfig extends StObject {
  ...
  /**
    ...
    */
  var gcsDestination: js.UndefOr[SchemaGoogleCloudVisionV1p3beta1GcsDestination] = js.undefined
}
object SchemaGoogleCloudVisionV1p3beta1OutputConfig {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1OutputConfigMutableBuilder[Self <: SchemaGoogleCloudVisionV1p3beta1OutputConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGcsDestination(value: SchemaGoogleCloudVisionV1p3beta1GcsDestination): Self = StObject.set(x, "gcsDestination", value.asInstanceOf[js.Any])
