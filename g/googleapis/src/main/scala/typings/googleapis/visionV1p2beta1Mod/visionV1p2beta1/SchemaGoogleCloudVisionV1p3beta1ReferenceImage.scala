...
object SchemaGoogleCloudVisionV1p3beta1ReferenceImage {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1ReferenceImageMutableBuilder[Self <: SchemaGoogleCloudVisionV1p3beta1ReferenceImage] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBoundingPolys(value: js.Array[SchemaGoogleCloudVisionV1p3beta1BoundingPoly]): Self = StObject.set(x, "boundingPolys", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBoundingPolysUndefined: Self = StObject.set(x, "boundingPolys", js.undefined)
    
    @scala.inline
    def setBoundingPolysVarargs(value: SchemaGoogleCloudVisionV1p3beta1BoundingPoly*): Self = StObject.set(x, "boundingPolys", js.Array(value :_*))
