...
trait SchemaFaceAnnotation extends StObject {
  ...
  /**
    ...
    */
  var fdBoundingPoly: js.UndefOr[SchemaBoundingPoly] = js.undefined
  ...
  /**
    ...
    */
  var landmarks: js.UndefOr[js.Array[SchemaLandmark]] = js.undefined
...
object SchemaFaceAnnotation {
  ...
  inline def apply(): SchemaFaceAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaFaceAnnotation]
  }
  
  extension [Self <: SchemaFaceAnnotation](x: Self) {
    ...
    inline def setFdBoundingPoly(value: SchemaBoundingPoly): Self = StObject.set(x, "fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    inline def setLandmarks(value: js.Array[SchemaLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    
    inline def setLandmarksUndefined: Self = StObject.set(x, "landmarks", js.undefined)
    
    inline def setLandmarksVarargs(value: SchemaLandmark*): Self = StObject.set(x, "landmarks", js.Array(value :_*))
