...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1Position extends StObject {
...
object SchemaGoogleCloudVisionV1p2beta1Position {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1PositionMutableBuilder[Self <: SchemaGoogleCloudVisionV1p2beta1Position] (val x: Self) extends AnyVal {
