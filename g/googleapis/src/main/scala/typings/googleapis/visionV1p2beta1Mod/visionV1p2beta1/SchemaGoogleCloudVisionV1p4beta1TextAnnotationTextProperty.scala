...
object SchemaGoogleCloudVisionV1p4beta1TextAnnotationTextProperty {
  @scala.inline
  def apply(
    detectedBreak: SchemaGoogleCloudVisionV1p4beta1TextAnnotationDetectedBreak = null,
    detectedLanguages: js.Array[SchemaGoogleCloudVisionV1p4beta1TextAnnotationDetectedLanguage] = null
  ): SchemaGoogleCloudVisionV1p4beta1TextAnnotationTextProperty = {
