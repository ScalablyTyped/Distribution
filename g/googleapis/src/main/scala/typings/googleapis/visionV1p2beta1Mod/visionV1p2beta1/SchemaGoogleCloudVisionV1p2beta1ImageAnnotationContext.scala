...
object SchemaGoogleCloudVisionV1p2beta1ImageAnnotationContext {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1ImageAnnotationContextOps[Self <: SchemaGoogleCloudVisionV1p2beta1ImageAnnotationContext] (val x: Self) extends AnyVal {
    @scala.inline
