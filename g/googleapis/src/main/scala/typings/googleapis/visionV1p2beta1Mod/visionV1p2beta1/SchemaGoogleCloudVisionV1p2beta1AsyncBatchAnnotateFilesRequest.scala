...
object SchemaGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequestOps[Self <: SchemaGoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestsVarargs(value: SchemaGoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest*): Self = this.set("requests", js.Array(value :_*))
    @scala.inline
    def setRequests(value: js.Array[SchemaGoogleCloudVisionV1p2beta1AsyncAnnotateFileRequest]): Self = this.set("requests", value.asInstanceOf[js.Any])
    @scala.inline
