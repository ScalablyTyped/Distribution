...
object SchemaGoogleCloudVisionV1p1beta1WebDetection {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p1beta1WebDetection](x: Self) {
    ...
    inline def setBestGuessLabelsVarargs(value: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebLabel*): Self = StObject.set(x, "bestGuessLabels", js.Array(value*))
    ...
    inline def setFullMatchingImagesVarargs(value: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebImage*): Self = StObject.set(x, "fullMatchingImages", js.Array(value*))
    ...
    inline def setPagesWithMatchingImagesVarargs(value: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebPage*): Self = StObject.set(x, "pagesWithMatchingImages", js.Array(value*))
    ...
    inline def setPartialMatchingImagesVarargs(value: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebImage*): Self = StObject.set(x, "partialMatchingImages", js.Array(value*))
    ...
    inline def setVisuallySimilarImagesVarargs(value: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebImage*): Self = StObject.set(x, "visuallySimilarImages", js.Array(value*))
    ...
    inline def setWebEntitiesVarargs(value: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebEntity*): Self = StObject.set(x, "webEntities", js.Array(value*))
  }
}
