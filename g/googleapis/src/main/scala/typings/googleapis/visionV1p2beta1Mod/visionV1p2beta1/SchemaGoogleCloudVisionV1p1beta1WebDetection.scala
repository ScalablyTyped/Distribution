...
object SchemaGoogleCloudVisionV1p1beta1WebDetection {
  ...
  implicit class SchemaGoogleCloudVisionV1p1beta1WebDetectionOps[Self <: SchemaGoogleCloudVisionV1p1beta1WebDetection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBestGuessLabelsVarargs(value: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebLabel*): Self = this.set("bestGuessLabels", js.Array(value :_*))
    
    @scala.inline
    def setBestGuessLabels(value: js.Array[SchemaGoogleCloudVisionV1p1beta1WebDetectionWebLabel]): Self = this.set("bestGuessLabels", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPagesWithMatchingImagesVarargs(value: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebPage*): Self = this.set("pagesWithMatchingImages", js.Array(value :_*))
    
    @scala.inline
    def setPagesWithMatchingImages(value: js.Array[SchemaGoogleCloudVisionV1p1beta1WebDetectionWebPage]): Self = this.set("pagesWithMatchingImages", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVisuallySimilarImagesVarargs(value: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebImage*): Self = this.set("visuallySimilarImages", js.Array(value :_*))
    
    @scala.inline
    def setVisuallySimilarImages(value: js.Array[SchemaGoogleCloudVisionV1p1beta1WebDetectionWebImage]): Self = this.set("visuallySimilarImages", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteVisuallySimilarImages: Self = this.set("visuallySimilarImages", js.undefined)
    
    @scala.inline
    def setWebEntitiesVarargs(value: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebEntity*): Self = this.set("webEntities", js.Array(value :_*))
    
    @scala.inline
    def setWebEntities(value: js.Array[SchemaGoogleCloudVisionV1p1beta1WebDetectionWebEntity]): Self = this.set("webEntities", value.asInstanceOf[js.Any])
