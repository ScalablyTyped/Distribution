...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1SafeSearchAnnotation extends StObject {
...
object SchemaGoogleCloudVisionV1p2beta1SafeSearchAnnotation {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p2beta1SafeSearchAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1SafeSearchAnnotation]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1SafeSearchAnnotationMutableBuilder[Self <: SchemaGoogleCloudVisionV1p2beta1SafeSearchAnnotation] (val x: Self) extends AnyVal {
