...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1SafeSearchAnnotation extends js.Object {
...
object SchemaGoogleCloudVisionV1p2beta1SafeSearchAnnotation {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1SafeSearchAnnotationOps[Self <: SchemaGoogleCloudVisionV1p2beta1SafeSearchAnnotation] (val x: Self) extends AnyVal {
