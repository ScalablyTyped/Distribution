...
trait SchemaGoogleCloudVisionV1p3beta1AnnotateImageResponse extends StObject {
  ...
  /**
    ...
    */
  var imagePropertiesAnnotation: js.UndefOr[SchemaGoogleCloudVisionV1p3beta1ImageProperties] = js.undefined
  
  /**
    * If present, label detection has completed successfully.
    */
  var labelAnnotations: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p3beta1EntityAnnotation]] = js.undefined
  ...
  /**
    ...
    */
  var logoAnnotations: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p3beta1EntityAnnotation]] = js.undefined
  
  /**
    * If present, product search has completed successfully.
    */
  var productSearchResults: js.UndefOr[SchemaGoogleCloudVisionV1p3beta1ProductSearchResults] = js.undefined
  
  /**
    * If present, safe-search annotation has completed successfully.
    */
  var safeSearchAnnotation: js.UndefOr[SchemaGoogleCloudVisionV1p3beta1SafeSearchAnnotation] = js.undefined
  
  /**
    * If present, text (OCR) detection has completed successfully.
    */
  var textAnnotations: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p3beta1EntityAnnotation]] = js.undefined
  
  /**
    * If present, web detection has completed successfully.
    */
  var webDetection: js.UndefOr[SchemaGoogleCloudVisionV1p3beta1WebDetection] = js.undefined
}
object SchemaGoogleCloudVisionV1p3beta1AnnotateImageResponse {
  
  inline def apply(): SchemaGoogleCloudVisionV1p3beta1AnnotateImageResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p3beta1AnnotateImageResponse]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p3beta1AnnotateImageResponse](x: Self) {
    
    inline def setContext(value: SchemaGoogleCloudVisionV1p3beta1ImageAnnotationContext): Self = StObject.set(x, "context", value.asInstanceOf[js.Any])
    
    inline def setContextUndefined: Self = StObject.set(x, "context", js.undefined)
    
    inline def setCropHintsAnnotation(value: SchemaGoogleCloudVisionV1p3beta1CropHintsAnnotation): Self = StObject.set(x, "cropHintsAnnotation", value.asInstanceOf[js.Any])
    ...
    inline def setFaceAnnotations(value: js.Array[SchemaGoogleCloudVisionV1p3beta1FaceAnnotation]): Self = StObject.set(x, "faceAnnotations", value.asInstanceOf[js.Any])
    ...
    inline def setImagePropertiesAnnotation(value: SchemaGoogleCloudVisionV1p3beta1ImageProperties): Self = StObject.set(x, "imagePropertiesAnnotation", value.asInstanceOf[js.Any])
    
    inline def setImagePropertiesAnnotationUndefined: Self = StObject.set(x, "imagePropertiesAnnotation", js.undefined)
    
    inline def setLabelAnnotations(value: js.Array[SchemaGoogleCloudVisionV1p3beta1EntityAnnotation]): Self = StObject.set(x, "labelAnnotations", value.asInstanceOf[js.Any])
    ...
    inline def setSafeSearchAnnotation(value: SchemaGoogleCloudVisionV1p3beta1SafeSearchAnnotation): Self = StObject.set(x, "safeSearchAnnotation", value.asInstanceOf[js.Any])
    
    inline def setSafeSearchAnnotationUndefined: Self = StObject.set(x, "safeSearchAnnotation", js.undefined)
    
    inline def setTextAnnotations(value: js.Array[SchemaGoogleCloudVisionV1p3beta1EntityAnnotation]): Self = StObject.set(x, "textAnnotations", value.asInstanceOf[js.Any])
