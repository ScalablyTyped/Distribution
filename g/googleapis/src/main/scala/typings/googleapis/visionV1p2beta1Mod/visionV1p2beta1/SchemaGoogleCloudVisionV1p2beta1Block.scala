...
trait SchemaGoogleCloudVisionV1p2beta1Block extends StObject {
  ...
  /**
    ...
    */
  var blockType: js.UndefOr[String | Null] = js.undefined
...
object SchemaGoogleCloudVisionV1p2beta1Block {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p2beta1Block = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1Block]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p2beta1Block](x: Self) {
    
    inline def setBlockType(value: String): Self = StObject.set(x, "blockType", value.asInstanceOf[js.Any])
    
    inline def setBlockTypeNull: Self = StObject.set(x, "blockType", null)
    
    inline def setBlockTypeUndefined: Self = StObject.set(x, "blockType", js.undefined)
    
    inline def setBoundingBox(value: SchemaGoogleCloudVisionV1p2beta1BoundingPoly): Self = StObject.set(x, "boundingBox", value.asInstanceOf[js.Any])
    ...
    inline def setParagraphs(value: js.Array[SchemaGoogleCloudVisionV1p2beta1Paragraph]): Self = StObject.set(x, "paragraphs", value.asInstanceOf[js.Any])
    
    inline def setParagraphsUndefined: Self = StObject.set(x, "paragraphs", js.undefined)
    
    inline def setParagraphsVarargs(value: SchemaGoogleCloudVisionV1p2beta1Paragraph*): Self = StObject.set(x, "paragraphs", js.Array(value*))
