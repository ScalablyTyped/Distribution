...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1Block extends js.Object {
...
object SchemaGoogleCloudVisionV1p2beta1Block {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p2beta1Block = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1Block]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1BlockOps[Self <: SchemaGoogleCloudVisionV1p2beta1Block] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundingBox(value: SchemaGoogleCloudVisionV1p2beta1BoundingPoly): Self = this.set("boundingBox", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParagraphsVarargs(value: SchemaGoogleCloudVisionV1p2beta1Paragraph*): Self = this.set("paragraphs", js.Array(value :_*))
    
    @scala.inline
    def setParagraphs(value: js.Array[SchemaGoogleCloudVisionV1p2beta1Paragraph]): Self = this.set("paragraphs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteParagraphs: Self = this.set("paragraphs", js.undefined)
    
    @scala.inline
    def setProperty(value: SchemaGoogleCloudVisionV1p2beta1TextAnnotationTextProperty): Self = this.set("property", value.asInstanceOf[js.Any])
