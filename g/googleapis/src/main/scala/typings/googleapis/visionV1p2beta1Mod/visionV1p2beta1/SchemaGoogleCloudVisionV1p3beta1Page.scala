...
trait SchemaGoogleCloudVisionV1p3beta1Page extends StObject {
  ...
  /**
    ...
    */
  var blocks: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p3beta1Block]] = js.undefined
...
object SchemaGoogleCloudVisionV1p3beta1Page {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p3beta1Page = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p3beta1Page]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p3beta1Page](x: Self) {
    
    inline def setBlocks(value: js.Array[SchemaGoogleCloudVisionV1p3beta1Block]): Self = StObject.set(x, "blocks", value.asInstanceOf[js.Any])
    
    inline def setBlocksUndefined: Self = StObject.set(x, "blocks", js.undefined)
    
    inline def setBlocksVarargs(value: SchemaGoogleCloudVisionV1p3beta1Block*): Self = StObject.set(x, "blocks", js.Array(value :_*))
