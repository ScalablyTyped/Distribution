...
object SchemaGoogleCloudVisionV1p1beta1WebDetectionWebImage {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1WebDetectionWebImageMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebImage] (val x: Self) extends AnyVal {
