...
object SchemaAnnotateImageResponse {
  ...
  extension [Self <: SchemaAnnotateImageResponse](x: Self) {
    ...
    inline def setFaceAnnotationsVarargs(value: SchemaFaceAnnotation*): Self = StObject.set(x, "faceAnnotations", js.Array(value*))
    ...
    inline def setLabelAnnotationsVarargs(value: SchemaEntityAnnotation*): Self = StObject.set(x, "labelAnnotations", js.Array(value*))
    ...
    inline def setLandmarkAnnotationsVarargs(value: SchemaEntityAnnotation*): Self = StObject.set(x, "landmarkAnnotations", js.Array(value*))
    ...
    inline def setLocalizedObjectAnnotationsVarargs(value: SchemaLocalizedObjectAnnotation*): Self = StObject.set(x, "localizedObjectAnnotations", js.Array(value*))
    ...
    inline def setLogoAnnotationsVarargs(value: SchemaEntityAnnotation*): Self = StObject.set(x, "logoAnnotations", js.Array(value*))
    ...
    inline def setTextAnnotationsVarargs(value: SchemaEntityAnnotation*): Self = StObject.set(x, "textAnnotations", js.Array(value*))
