...
object SchemaGoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p1beta1TextAnnotationDetectedBreak](x: Self) {
