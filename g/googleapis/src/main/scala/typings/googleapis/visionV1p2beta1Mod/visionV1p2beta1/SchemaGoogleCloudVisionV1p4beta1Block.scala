...
object SchemaGoogleCloudVisionV1p4beta1Block {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1BlockMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1Block] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setParagraphs(value: js.Array[SchemaGoogleCloudVisionV1p4beta1Paragraph]): Self = StObject.set(x, "paragraphs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setParagraphsUndefined: Self = StObject.set(x, "paragraphs", js.undefined)
    
    @scala.inline
    def setParagraphsVarargs(value: SchemaGoogleCloudVisionV1p4beta1Paragraph*): Self = StObject.set(x, "paragraphs", js.Array(value :_*))
