...
trait SchemaGoogleCloudVisionV1p4beta1Block extends StObject {
  ...
  /**
    ...
    */
  var paragraphs: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p4beta1Paragraph]] = js.undefined
...
object SchemaGoogleCloudVisionV1p4beta1Block {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p4beta1Block = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p4beta1Block]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p4beta1Block](x: Self) {
    ...
    inline def setParagraphs(value: js.Array[SchemaGoogleCloudVisionV1p4beta1Paragraph]): Self = StObject.set(x, "paragraphs", value.asInstanceOf[js.Any])
    
    inline def setParagraphsUndefined: Self = StObject.set(x, "paragraphs", js.undefined)
    
    inline def setParagraphsVarargs(value: SchemaGoogleCloudVisionV1p4beta1Paragraph*): Self = StObject.set(x, "paragraphs", js.Array(value*))
