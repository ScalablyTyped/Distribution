...
object SchemaGoogleCloudVisionV1p2beta1ProductKeyValue {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p2beta1ProductKeyValueMutableBuilder[Self <: SchemaGoogleCloudVisionV1p2beta1ProductKeyValue] (val x: Self) extends AnyVal {
