...
object SchemaGoogleCloudVisionV1p1beta1ProductSearchResults {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p1beta1ProductSearchResults](x: Self) {
    ...
    inline def setProductGroupedResultsVarargs(value: SchemaGoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult*): Self = StObject.set(x, "productGroupedResults", js.Array(value*))
