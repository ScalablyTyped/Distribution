...
object SchemaGoogleCloudVisionV1p4beta1EntityAnnotation {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p4beta1EntityAnnotation](x: Self) {
    ...
    inline def setLocationsVarargs(value: SchemaGoogleCloudVisionV1p4beta1LocationInfo*): Self = StObject.set(x, "locations", js.Array(value*))
    ...
    inline def setPropertiesVarargs(value: SchemaGoogleCloudVisionV1p4beta1Property*): Self = StObject.set(x, "properties", js.Array(value*))
