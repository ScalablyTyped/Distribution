...
object SchemaGoogleCloudVisionV1p4beta1EntityAnnotation {
  ...
  def apply(
    ...
    locale: String = null,
    locations: js.Array[SchemaGoogleCloudVisionV1p4beta1LocationInfo] = null,
    mid: String = null,
    properties: js.Array[SchemaGoogleCloudVisionV1p4beta1Property] = null,
    score: Int | Double = null,
    topicality: Int | Double = null
  ): SchemaGoogleCloudVisionV1p4beta1EntityAnnotation = {
