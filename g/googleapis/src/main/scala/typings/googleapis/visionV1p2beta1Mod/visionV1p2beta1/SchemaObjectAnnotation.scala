...
trait SchemaObjectAnnotation extends StObject {
...
object SchemaObjectAnnotation {
  
  inline def apply(): SchemaObjectAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaObjectAnnotation]
  }
  
  extension [Self <: SchemaObjectAnnotation](x: Self) {
