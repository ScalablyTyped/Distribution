...
trait SchemaGoogleCloudVisionV1p2beta1TextDetectionParams extends StObject {
...
object SchemaGoogleCloudVisionV1p2beta1TextDetectionParams {
  
  inline def apply(): SchemaGoogleCloudVisionV1p2beta1TextDetectionParams = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1TextDetectionParams]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p2beta1TextDetectionParams](x: Self) {
