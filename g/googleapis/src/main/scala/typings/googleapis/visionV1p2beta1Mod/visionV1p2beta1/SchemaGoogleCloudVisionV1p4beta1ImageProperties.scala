...
object SchemaGoogleCloudVisionV1p4beta1ImageProperties {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1ImagePropertiesOps[Self <: SchemaGoogleCloudVisionV1p4beta1ImageProperties] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDominantColors(value: SchemaGoogleCloudVisionV1p4beta1DominantColorsAnnotation): Self = this.set("dominantColors", value.asInstanceOf[js.Any])
    @scala.inline
