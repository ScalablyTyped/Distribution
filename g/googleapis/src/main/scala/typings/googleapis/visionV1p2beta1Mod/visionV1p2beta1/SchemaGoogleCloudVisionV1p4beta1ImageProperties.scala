...
object SchemaGoogleCloudVisionV1p4beta1ImageProperties {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p4beta1ImageProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p4beta1ImageProperties]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1ImagePropertiesMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1ImageProperties] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setDominantColors(value: SchemaGoogleCloudVisionV1p4beta1DominantColorsAnnotation): Self = StObject.set(x, "dominantColors", value.asInstanceOf[js.Any])
