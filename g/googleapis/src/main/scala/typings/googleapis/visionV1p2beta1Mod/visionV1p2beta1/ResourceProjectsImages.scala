...
@JSImport("googleapis/build/src/apis/vision/v1p2beta1", "vision_v1p2beta1.Resource$Projects$Images")
@js.native
open class ResourceProjectsImages protected () extends StObject {
  ...
  def annotate(params: ParamsResourceProjectsImagesAnnotate): GaxiosPromise[SchemaGoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse] = js.native
  def annotate(
  ...
  def annotate(params: ParamsResourceProjectsImagesAnnotate, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse] = js.native
  def annotate(
    params: ParamsResourceProjectsImagesAnnotate,
