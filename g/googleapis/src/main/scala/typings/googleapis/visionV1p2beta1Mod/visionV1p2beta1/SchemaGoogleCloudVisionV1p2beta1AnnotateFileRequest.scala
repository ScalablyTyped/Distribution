...
trait SchemaGoogleCloudVisionV1p2beta1AnnotateFileRequest extends StObject {
...
object SchemaGoogleCloudVisionV1p2beta1AnnotateFileRequest {
  
  inline def apply(): SchemaGoogleCloudVisionV1p2beta1AnnotateFileRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1AnnotateFileRequest]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p2beta1AnnotateFileRequest](x: Self) {
