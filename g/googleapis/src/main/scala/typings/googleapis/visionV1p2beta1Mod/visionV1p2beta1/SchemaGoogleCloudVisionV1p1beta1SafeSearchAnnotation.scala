...
object SchemaGoogleCloudVisionV1p1beta1SafeSearchAnnotation {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1SafeSearchAnnotationMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1SafeSearchAnnotation] (val x: Self) extends AnyVal {
