...
object SchemaGoogleCloudVisionV1p2beta1WebDetectionWebPage {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p2beta1WebDetectionWebPage](x: Self) {
    ...
    inline def setFullMatchingImagesVarargs(value: SchemaGoogleCloudVisionV1p2beta1WebDetectionWebImage*): Self = StObject.set(x, "fullMatchingImages", js.Array(value*))
    ...
    inline def setPartialMatchingImagesVarargs(value: SchemaGoogleCloudVisionV1p2beta1WebDetectionWebImage*): Self = StObject.set(x, "partialMatchingImages", js.Array(value*))
