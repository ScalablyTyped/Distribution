...
object SchemaGoogleCloudVisionV1p1beta1ImageProperties {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p1beta1ImageProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1ImageProperties]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p1beta1ImageProperties](x: Self) {
    
    inline def setDominantColors(value: SchemaGoogleCloudVisionV1p1beta1DominantColorsAnnotation): Self = StObject.set(x, "dominantColors", value.asInstanceOf[js.Any])
