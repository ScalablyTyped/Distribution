...
object SchemaGoogleCloudVisionV1p2beta1Image {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p2beta1Image = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1Image]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p2beta1Image](x: Self) {
    
    inline def setContent(value: String): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
    
    inline def setContentUndefined: Self = StObject.set(x, "content", js.undefined)
    
    inline def setSource(value: SchemaGoogleCloudVisionV1p2beta1ImageSource): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
