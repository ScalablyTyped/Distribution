...
object SchemaDeviceConfig {
  ...
  extension [Self <: SchemaDeviceConfig](x: Self) {
    ...
    inline def setCloudUpdateTimeNull: Self = StObject.set(x, "cloudUpdateTime", null)
    ...
    inline def setDeviceAckTimeNull: Self = StObject.set(x, "deviceAckTime", null)
