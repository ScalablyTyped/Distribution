...
trait ParamsResourceProjectsLocationsRegistriesGroupsDevicesList
  extends StObject
...
object ParamsResourceProjectsLocationsRegistriesGroupsDevicesList {
  ...
  inline def apply(): ParamsResourceProjectsLocationsRegistriesGroupsDevicesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRegistriesGroupsDevicesList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRegistriesGroupsDevicesList](x: Self) {
