...
object ParamsResourceProjectsLocationsRegistriesGroupsDevicesGet {
  ...
  inline def apply(): ParamsResourceProjectsLocationsRegistriesGroupsDevicesGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRegistriesGroupsDevicesGet]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRegistriesGroupsDevicesGet](x: Self) {
