...
trait ParamsResourceProjectsLocationsRegistriesGroupsDevicesGet
  extends StObject
...
object ParamsResourceProjectsLocationsRegistriesGroupsDevicesGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRegistriesGroupsDevicesGetMutableBuilder[Self <: ParamsResourceProjectsLocationsRegistriesGroupsDevicesGet] (val x: Self) extends AnyVal {
