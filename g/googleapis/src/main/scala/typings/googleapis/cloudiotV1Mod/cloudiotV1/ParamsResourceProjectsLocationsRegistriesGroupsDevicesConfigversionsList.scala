...
trait ParamsResourceProjectsLocationsRegistriesGroupsDevicesConfigversionsList
  extends StObject
...
object ParamsResourceProjectsLocationsRegistriesGroupsDevicesConfigversionsList {
  ...
  inline def apply(): ParamsResourceProjectsLocationsRegistriesGroupsDevicesConfigversionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRegistriesGroupsDevicesConfigversionsList]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsRegistriesGroupsDevicesConfigversionsList](x: Self) {
