...
object ParamsResourceProjectsLocationsRegistriesDevicesStatesList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRegistriesDevicesStatesListOps[Self <: ParamsResourceProjectsLocationsRegistriesDevicesStatesList] (val x: Self) extends AnyVal {
