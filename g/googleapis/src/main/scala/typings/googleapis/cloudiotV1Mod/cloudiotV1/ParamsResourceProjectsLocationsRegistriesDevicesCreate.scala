...
object ParamsResourceProjectsLocationsRegistriesDevicesCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRegistriesDevicesCreateOps[Self <: ParamsResourceProjectsLocationsRegistriesDevicesCreate] (val x: Self) extends AnyVal {
