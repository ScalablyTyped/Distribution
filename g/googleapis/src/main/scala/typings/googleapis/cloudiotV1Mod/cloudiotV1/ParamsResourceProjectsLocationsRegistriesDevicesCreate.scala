...
object ParamsResourceProjectsLocationsRegistriesDevicesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsRegistriesDevicesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsRegistriesDevicesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRegistriesDevicesCreateMutableBuilder[Self <: ParamsResourceProjectsLocationsRegistriesDevicesCreate] (val x: Self) extends AnyVal {
