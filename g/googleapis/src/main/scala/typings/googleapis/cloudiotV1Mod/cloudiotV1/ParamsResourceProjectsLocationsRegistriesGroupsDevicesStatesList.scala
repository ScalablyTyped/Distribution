...
object ParamsResourceProjectsLocationsRegistriesGroupsDevicesStatesList {
  ...
  def apply(
    ...
    key: String = null,
    name: String = null,
    numStates: Int | Double = null,
    oauth_token: String = null,
    prettyPrint: js.UndefOr[Boolean] = js.undefined,
    quotaUser: String = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceProjectsLocationsRegistriesGroupsDevicesStatesList = {
    ...
    if (numStates != null) __obj.updateDynamic("numStates")(numStates.asInstanceOf[js.Any])
