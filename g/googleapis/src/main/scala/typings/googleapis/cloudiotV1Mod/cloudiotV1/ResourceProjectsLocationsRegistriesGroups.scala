...
@js.native
open class ResourceProjectsLocationsRegistriesGroups protected () extends StObject {
  ...
  /**
    ...
    */
  def getIamPolicy(params: ParamsResourceProjectsLocationsRegistriesGroupsGetiampolicy, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def getIamPolicy(
    params: ParamsResourceProjectsLocationsRegistriesGroupsGetiampolicy,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def setIamPolicy(params: ParamsResourceProjectsLocationsRegistriesGroupsSetiampolicy, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def setIamPolicy(
    params: ParamsResourceProjectsLocationsRegistriesGroupsSetiampolicy,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
