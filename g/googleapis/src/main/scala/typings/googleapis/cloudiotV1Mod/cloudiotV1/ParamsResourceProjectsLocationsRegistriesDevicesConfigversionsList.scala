...
object ParamsResourceProjectsLocationsRegistriesDevicesConfigversionsList {
  ...
  def apply(
    ...
    key: String = null,
    name: String = null,
    numVersions: js.UndefOr[Double] = js.undefined,
    oauth_token: String = null,
    prettyPrint: js.UndefOr[Boolean] = js.undefined,
    quotaUser: String = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceProjectsLocationsRegistriesDevicesConfigversionsList = {
    ...
    if (!js.isUndefined(numVersions)) __obj.updateDynamic("numVersions")(numVersions.get.asInstanceOf[js.Any])
