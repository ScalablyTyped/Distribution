...
object ParamsResourceProjectsLocationsRegistriesDevicesConfigversionsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRegistriesDevicesConfigversionsListMutableBuilder[Self <: ParamsResourceProjectsLocationsRegistriesDevicesConfigversionsList] (val x: Self) extends AnyVal {
