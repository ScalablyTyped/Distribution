...
object ParamsResourceDeploymentsCancelpreview {
  ...
  @scala.inline
  implicit class ParamsResourceDeploymentsCancelpreviewOps[Self <: ParamsResourceDeploymentsCancelpreview] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaDeploymentsCancelPreviewRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
