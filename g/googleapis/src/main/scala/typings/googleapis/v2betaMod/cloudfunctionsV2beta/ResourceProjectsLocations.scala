...
@JSImport("googleapis/build/src/apis/cloudfunctions/v2beta", "cloudfunctions_v2beta.Resource$Projects$Locations")
@js.native
open class ResourceProjectsLocations protected () extends StObject {
  ...
  var runtimes: ResourceProjectsLocationsRuntimes = js.native
}
