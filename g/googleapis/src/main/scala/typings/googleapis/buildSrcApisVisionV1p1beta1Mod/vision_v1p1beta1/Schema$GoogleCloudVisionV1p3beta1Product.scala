...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p3beta1Product extends js.Object {
  /**
  ...
  /**
    ...
    */
  var productLabels: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p3beta1ProductKeyValue]] = js.native
}

object Schema$GoogleCloudVisionV1p3beta1Product {
  @scala.inline
  def apply(
    ...
    productLabels: js.Array[Schema$GoogleCloudVisionV1p3beta1ProductKeyValue] = null
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p3beta1Product]
  }
}
