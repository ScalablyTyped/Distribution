...
/**
  ...
  */
@js.native
trait Schema$TextAnnotation extends js.Object {
  /**
...
object Schema$TextAnnotation {
  @scala.inline
  def apply(pages: js.Array[Schema$Page] = null, text: String = null): Schema$TextAnnotation = {
    val __obj = js.Dynamic.literal()
    if (pages != null) __obj.updateDynamic("pages")(pages.asInstanceOf[js.Any])
    if (text != null) __obj.updateDynamic("text")(text.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$TextAnnotation]
  }
}
