...
/**
  ...
  */
@js.native
trait Schema$GoogleCloudVisionV1p1beta1Page extends js.Object {
  /**
    * List of blocks of text, images etc on this page.
    */
  var blocks: js.UndefOr[js.Array[Schema$GoogleCloudVisionV1p1beta1Block]] = js.native
  /**
...
object Schema$GoogleCloudVisionV1p1beta1Page {
  @scala.inline
  def apply(
    blocks: js.Array[Schema$GoogleCloudVisionV1p1beta1Block] = null,
    confidence: Int | Double = null,
    height: Int | Double = null,
    property: Schema$GoogleCloudVisionV1p1beta1TextAnnotationTextProperty = null,
    width: Int | Double = null
  ): Schema$GoogleCloudVisionV1p1beta1Page = {
    ...
    __obj.asInstanceOf[Schema$GoogleCloudVisionV1p1beta1Page]
  }
}
