...
trait SchemaGoogleCloudFunctionsV2alphaStage extends StObject {
...
object SchemaGoogleCloudFunctionsV2alphaStage {
  
  inline def apply(): SchemaGoogleCloudFunctionsV2alphaStage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudFunctionsV2alphaStage]
  }
  
  extension [Self <: SchemaGoogleCloudFunctionsV2alphaStage](x: Self) {
