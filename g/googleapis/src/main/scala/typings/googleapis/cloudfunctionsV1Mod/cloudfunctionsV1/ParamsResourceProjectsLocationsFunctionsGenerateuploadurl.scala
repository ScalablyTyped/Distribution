...
object ParamsResourceProjectsLocationsFunctionsGenerateuploadurl {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsFunctionsGenerateuploadurl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsFunctionsGenerateuploadurl]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsFunctionsGenerateuploadurlMutableBuilder[Self <: ParamsResourceProjectsLocationsFunctionsGenerateuploadurl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaGenerateUploadUrlRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
