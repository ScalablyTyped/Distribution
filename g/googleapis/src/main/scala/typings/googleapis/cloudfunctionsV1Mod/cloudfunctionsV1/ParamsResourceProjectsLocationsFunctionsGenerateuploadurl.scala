...
object ParamsResourceProjectsLocationsFunctionsGenerateuploadurl {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsFunctionsGenerateuploadurlOps[Self <: ParamsResourceProjectsLocationsFunctionsGenerateuploadurl] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaGenerateUploadUrlRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
