...
trait SchemaGoogleCloudFunctionsV2OperationMetadata extends StObject {
  ...
  /**
    ...
    */
  var stages: js.UndefOr[js.Array[SchemaGoogleCloudFunctionsV2Stage]] = js.undefined
...
object SchemaGoogleCloudFunctionsV2OperationMetadata {
  
  inline def apply(): SchemaGoogleCloudFunctionsV2OperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudFunctionsV2OperationMetadata]
  }
  
  extension [Self <: SchemaGoogleCloudFunctionsV2OperationMetadata](x: Self) {
    ...
    inline def setStages(value: js.Array[SchemaGoogleCloudFunctionsV2Stage]): Self = StObject.set(x, "stages", value.asInstanceOf[js.Any])
    
    inline def setStagesUndefined: Self = StObject.set(x, "stages", js.undefined)
    
    inline def setStagesVarargs(value: SchemaGoogleCloudFunctionsV2Stage*): Self = StObject.set(x, "stages", js.Array(value*))
