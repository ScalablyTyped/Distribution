...
@js.native
trait Anon_CanAddChildrenCanChangeCopyRequiresWriterPermissionRestriction extends js.Object {
...
object Anon_CanAddChildrenCanChangeCopyRequiresWriterPermissionRestriction {
  @scala.inline
  def apply(
  ...
  ): Anon_CanAddChildrenCanChangeCopyRequiresWriterPermissionRestriction = {
    ...
    __obj.asInstanceOf[Anon_CanAddChildrenCanChangeCopyRequiresWriterPermissionRestriction]
  }
}
