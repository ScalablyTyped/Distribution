...
@js.native
trait Schema$PagespeedApiFormatStringV2 extends js.Object {
  /**
...
object Schema$PagespeedApiFormatStringV2 {
  @scala.inline
  def apply(args: js.Array[Anon_KeyRects] = null, format: String = null): Schema$PagespeedApiFormatStringV2 = {
    val __obj = js.Dynamic.literal()
    if (args != null) __obj.updateDynamic("args")(args.asInstanceOf[js.Any])
    if (format != null) __obj.updateDynamic("format")(format.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$PagespeedApiFormatStringV2]
  }
}
