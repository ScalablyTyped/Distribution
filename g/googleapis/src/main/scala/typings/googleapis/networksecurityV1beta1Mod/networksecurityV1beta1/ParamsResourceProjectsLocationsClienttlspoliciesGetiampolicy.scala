...
trait ParamsResourceProjectsLocationsClienttlspoliciesGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsClienttlspoliciesGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsClienttlspoliciesGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsClienttlspoliciesGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsClienttlspoliciesGetiampolicy](x: Self) {
