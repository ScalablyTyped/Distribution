...
import typings.googleapis.buildSrcApisUrlshortenerV1Mod.urlshortener_v1.Options
import typings.googleapis.buildSrcApisUrlshortenerV1Mod.urlshortener_v1.Urlshortener
