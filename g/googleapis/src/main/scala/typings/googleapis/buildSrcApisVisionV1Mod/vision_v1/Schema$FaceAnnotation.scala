...
/**
  ...
  */
@js.native
trait Schema$FaceAnnotation extends js.Object {
  /**
    * Anger likelihood.
    */
  ...
  /**
    ...
    */
  var fdBoundingPoly: js.UndefOr[Schema$BoundingPoly] = js.native
  /**
    * Headwear likelihood.
    */
  ...
  /**
    ...
    */
  var landmarks: js.UndefOr[js.Array[Schema$Landmark]] = js.native
  /**
...
object Schema$FaceAnnotation {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$FaceAnnotation]
  }
}
