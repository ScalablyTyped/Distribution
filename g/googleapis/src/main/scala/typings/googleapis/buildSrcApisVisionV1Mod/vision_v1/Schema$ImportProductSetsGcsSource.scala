...
/**
  ...
  */
@js.native
trait Schema$ImportProductSetsGcsSource extends js.Object {
  /**
...
object Schema$ImportProductSetsGcsSource {
  @scala.inline
  def apply(csvFileUri: String = null): Schema$ImportProductSetsGcsSource = {
    val __obj = js.Dynamic.literal()
    if (csvFileUri != null) __obj.updateDynamic("csvFileUri")(csvFileUri.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ImportProductSetsGcsSource]
  }
}
