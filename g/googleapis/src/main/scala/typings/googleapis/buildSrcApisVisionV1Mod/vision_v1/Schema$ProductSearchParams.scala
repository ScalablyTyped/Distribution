...
/**
  ...
  */
@js.native
trait Schema$ProductSearchParams extends js.Object {
  /**
...
object Schema$ProductSearchParams {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Schema$ProductSearchParams]
  }
}
