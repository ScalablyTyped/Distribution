...
/**
  ...
  */
@js.native
trait Schema$ReferenceImage extends js.Object {
  /**
...
object Schema$ReferenceImage {
  @scala.inline
  def apply(boundingPolys: js.Array[Schema$BoundingPoly] = null, name: String = null, uri: String = null): Schema$ReferenceImage = {
    val __obj = js.Dynamic.literal()
    if (boundingPolys != null) __obj.updateDynamic("boundingPolys")(boundingPolys.asInstanceOf[js.Any])
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    if (uri != null) __obj.updateDynamic("uri")(uri.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$ReferenceImage]
  }
}
