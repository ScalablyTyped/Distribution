...
/**
  ...
  */
@js.native
trait Schema$ImageSource extends js.Object {
  /**
...
object Schema$ImageSource {
  @scala.inline
  def apply(gcsImageUri: String = null, imageUri: String = null): Schema$ImageSource = {
    ...
    __obj.asInstanceOf[Schema$ImageSource]
  }
}
