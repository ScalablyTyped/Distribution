...
/**
  ...
  */
@js.native
trait Schema$ListMeta extends js.Object {
  /**
...
object Schema$ListMeta {
  @scala.inline
  def apply(continue: String = null, resourceVersion: String = null, selfLink: String = null): Schema$ListMeta = {
    ...
    __obj.asInstanceOf[Schema$ListMeta]
  }
}
