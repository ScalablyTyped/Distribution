...
@js.native
class ResourceDollarProjectsDollarLocationsDollarRoutes protected () extends js.Object {
  ...
  def get(params: ParamsDollarResourceDollarProjectsDollarLocationsDollarRoutesDollarGet): GaxiosPromise[Schema$Route] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarRoutesDollarGet,
  ...
  ): GaxiosPromise[Schema$Route] = js.native
  def get(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarRoutesDollarGet,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$Route]
  ...
  def list(params: ParamsDollarResourceDollarProjectsDollarLocationsDollarRoutesDollarList): GaxiosPromise[Schema$ListRoutesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarRoutesDollarList,
  ...
  def list(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarRoutesDollarList,
    options: MethodOptions
  ): GaxiosPromise[Schema$ListRoutesResponse] = js.native
  def list(
    params: ParamsDollarResourceDollarProjectsDollarLocationsDollarRoutesDollarList,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$ListRoutesResponse]
