...
/**
  ...
  */
@js.native
trait Schema$ObjectMeta extends js.Object {
  /**
  ...
  /**
    ...
    */
  var initializers: js.UndefOr[Schema$Initializers] = js.native
  /**
  ...
  /**
    ...
    */
  var ownerReferences: js.UndefOr[js.Array[Schema$OwnerReference]] = js.native
  /**
...
object Schema$ObjectMeta {
  ...
  def apply(
    ...
    initializers: Schema$Initializers = null,
    labels: StringDictionary[String] = null,
    name: String = null,
    namespace: String = null,
    ownerReferences: js.Array[Schema$OwnerReference] = null,
    ...
    __obj.asInstanceOf[Schema$ObjectMeta]
  }
}
