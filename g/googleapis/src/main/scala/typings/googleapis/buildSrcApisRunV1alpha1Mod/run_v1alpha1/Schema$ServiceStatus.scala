...
/**
  ...
  */
@js.native
trait Schema$ServiceStatus extends js.Object {
  /**
  ...
  /**
    ...
    * of the world.
    */
  var conditions: js.UndefOr[js.Array[Schema$ServiceCondition]] = js.native
  /**
...
object Schema$ServiceStatus {
  @scala.inline
  def apply(
    address: Schema$Addressable = null,
    conditions: js.Array[Schema$ServiceCondition] = null,
    domain: String = null,
    ...
    __obj.asInstanceOf[Schema$ServiceStatus]
  }
}
