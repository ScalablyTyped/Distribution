...
/**
  ...
  */
@js.native
trait Schema$RevisionStatus extends js.Object {
  /**
    ...
    */
  var conditions: js.UndefOr[js.Array[Schema$RevisionCondition]] = js.native
  /**
...
object Schema$RevisionStatus {
  @scala.inline
  def apply(
    conditions: js.Array[Schema$RevisionCondition] = null,
    imageDigest: String = null,
    logUrl: String = null,
    observedGeneration: Int | Double = null,
    serviceName: String = null
  ): Schema$RevisionStatus = {
    ...
    __obj.asInstanceOf[Schema$RevisionStatus]
  }
}
