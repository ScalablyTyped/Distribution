...
trait SchemaRetryConfig extends StObject {
  ...
  /**
    ...
    */
  var maxBackoffDuration: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var minBackoffDuration: js.UndefOr[String | Null] = js.undefined
...
object SchemaRetryConfig {
  ...
  extension [Self <: SchemaRetryConfig](x: Self) {
    ...
    inline def setMaxBackoffDurationNull: Self = StObject.set(x, "maxBackoffDuration", null)
    ...
    inline def setMinBackoffDurationNull: Self = StObject.set(x, "minBackoffDuration", null)
