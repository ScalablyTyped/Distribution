...
object ParamsResourceProjectsLocationsJobsResume {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsJobsResumeMutableBuilder[Self <: ParamsResourceProjectsLocationsJobsResume] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaResumeJobRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
