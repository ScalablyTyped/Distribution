...
trait SchemaIamPolicyAnalysisResult extends StObject {
  ...
  /**
    ...
    */
  var accessControlLists: js.UndefOr[js.Array[SchemaGoogleCloudAssetV1p4beta1AccessControlList]] = js.undefined
  ...
  /**
    ...
    */
  var identityList: js.UndefOr[SchemaGoogleCloudAssetV1p4beta1IdentityList] = js.undefined
}
object SchemaIamPolicyAnalysisResult {
  ...
  extension [Self <: SchemaIamPolicyAnalysisResult](x: Self) {
    ...
    inline def setAccessControlLists(value: js.Array[SchemaGoogleCloudAssetV1p4beta1AccessControlList]): Self = StObject.set(x, "accessControlLists", value.asInstanceOf[js.Any])
    
    inline def setAccessControlListsUndefined: Self = StObject.set(x, "accessControlLists", js.undefined)
    
    inline def setAccessControlListsVarargs(value: SchemaGoogleCloudAssetV1p4beta1AccessControlList*): Self = StObject.set(x, "accessControlLists", js.Array(value*))
    ...
    inline def setIdentityList(value: SchemaGoogleCloudAssetV1p4beta1IdentityList): Self = StObject.set(x, "identityList", value.asInstanceOf[js.Any])
