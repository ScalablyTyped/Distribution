...
trait SchemaGoogleIdentityAccesscontextmanagerV1EgressFrom extends StObject {
...
object SchemaGoogleIdentityAccesscontextmanagerV1EgressFrom {
  
  inline def apply(): SchemaGoogleIdentityAccesscontextmanagerV1EgressFrom = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleIdentityAccesscontextmanagerV1EgressFrom]
  }
  
  extension [Self <: SchemaGoogleIdentityAccesscontextmanagerV1EgressFrom](x: Self) {
