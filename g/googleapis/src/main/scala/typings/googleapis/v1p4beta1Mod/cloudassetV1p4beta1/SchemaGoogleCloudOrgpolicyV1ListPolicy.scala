...
trait SchemaGoogleCloudOrgpolicyV1ListPolicy extends StObject {
  
  /**
    * The policy all_values state.
    */
  var allValues: js.UndefOr[String | Null] = js.undefined
...
object SchemaGoogleCloudOrgpolicyV1ListPolicy {
  
  inline def apply(): SchemaGoogleCloudOrgpolicyV1ListPolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudOrgpolicyV1ListPolicy]
  }
  
  extension [Self <: SchemaGoogleCloudOrgpolicyV1ListPolicy](x: Self) {
    
    inline def setAllValues(value: String): Self = StObject.set(x, "allValues", value.asInstanceOf[js.Any])
    
    inline def setAllValuesNull: Self = StObject.set(x, "allValues", null)
