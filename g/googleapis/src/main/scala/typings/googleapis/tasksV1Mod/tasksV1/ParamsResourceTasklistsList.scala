...
@js.native
trait ParamsResourceTasklistsList extends StandardParameters {
...
object ParamsResourceTasklistsList {
  ...
  @scala.inline
  def apply(): ParamsResourceTasklistsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceTasklistsList]
  }
  
  @scala.inline
  implicit class ParamsResourceTasklistsListMutableBuilder[Self <: ParamsResourceTasklistsList] (val x: Self) extends AnyVal {
