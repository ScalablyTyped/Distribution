...
trait ParamsResourceAccountsAdminsPatch
  extends StObject
...
object ParamsResourceAccountsAdminsPatch {
  
  inline def apply(): ParamsResourceAccountsAdminsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceAccountsAdminsPatch]
  }
  
  extension [Self <: ParamsResourceAccountsAdminsPatch](x: Self) {
