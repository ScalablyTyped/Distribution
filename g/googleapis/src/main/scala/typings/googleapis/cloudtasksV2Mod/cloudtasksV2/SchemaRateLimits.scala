...
trait SchemaRateLimits extends StObject {
  ...
  /**
    ...
    */
  var maxConcurrentDispatches: js.UndefOr[Double | Null] = js.undefined
  
  /**
    * The maximum rate at which tasks are dispatched from this queue. If unspecified when the queue is created, Cloud Tasks will pick the default. * The maximum allowed value is 500. This field has the same meaning as [rate in queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python/config/queueref#rate).
    */
  var maxDispatchesPerSecond: js.UndefOr[Double | Null] = js.undefined
}
object SchemaRateLimits {
  ...
  extension [Self <: SchemaRateLimits](x: Self) {
    ...
    inline def setMaxConcurrentDispatchesNull: Self = StObject.set(x, "maxConcurrentDispatches", null)
    ...
    inline def setMaxDispatchesPerSecondNull: Self = StObject.set(x, "maxDispatchesPerSecond", null)
