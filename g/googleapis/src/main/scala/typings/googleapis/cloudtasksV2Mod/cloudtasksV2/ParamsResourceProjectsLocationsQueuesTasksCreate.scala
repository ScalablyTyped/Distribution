...
object ParamsResourceProjectsLocationsQueuesTasksCreate {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesTasksCreateOps[Self <: ParamsResourceProjectsLocationsQueuesTasksCreate] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreateTaskRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
