...
object ParamsResourceProjectsLocationsQueuesTasksCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsQueuesTasksCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsQueuesTasksCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesTasksCreateMutableBuilder[Self <: ParamsResourceProjectsLocationsQueuesTasksCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaCreateTaskRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
