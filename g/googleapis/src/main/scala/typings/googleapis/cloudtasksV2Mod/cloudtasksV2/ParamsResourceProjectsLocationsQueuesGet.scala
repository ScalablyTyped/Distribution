...
@js.native
trait ParamsResourceProjectsLocationsQueuesGet extends StandardParameters {
...
object ParamsResourceProjectsLocationsQueuesGet {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsQueuesGetOps[Self <: ParamsResourceProjectsLocationsQueuesGet] (val x: Self) extends AnyVal {
