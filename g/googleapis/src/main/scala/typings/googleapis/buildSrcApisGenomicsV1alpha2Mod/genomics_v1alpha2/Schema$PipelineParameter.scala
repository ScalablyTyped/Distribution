...
/**
  ...
  */
@js.native
trait Schema$PipelineParameter extends js.Object {
  /**
  ...
  /**
    ...
    */
  var localCopy: js.UndefOr[Schema$LocalCopy] = js.native
  /**
...
object Schema$PipelineParameter {
  @scala.inline
  def apply(
    defaultValue: String = null,
    description: String = null,
    localCopy: Schema$LocalCopy = null,
    name: String = null
  ): Schema$PipelineParameter = {
    ...
    __obj.asInstanceOf[Schema$PipelineParameter]
  }
}
