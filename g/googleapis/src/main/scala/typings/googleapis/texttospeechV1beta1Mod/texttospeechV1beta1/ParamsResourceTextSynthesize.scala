...
object ParamsResourceTextSynthesize {
  ...
  @scala.inline
  implicit class ParamsResourceTextSynthesizeOps[Self <: ParamsResourceTextSynthesize] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaSynthesizeSpeechRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
