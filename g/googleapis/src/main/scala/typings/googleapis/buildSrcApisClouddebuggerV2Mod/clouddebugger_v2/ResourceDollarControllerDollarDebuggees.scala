...
@js.native
class ResourceDollarControllerDollarDebuggees protected () extends js.Object {
  def this(context: APIRequestContext) = this()
  var breakpoints: ResourceDollarControllerDollarDebuggeesDollarBreakpoints = js.native
  ...
  /**
    ...
    */
  def register(): GaxiosPromise[Schema$RegisterDebuggeeResponse] = js.native
  def register(callback: BodyResponseCallback[Schema$RegisterDebuggeeResponse]): Unit = js.native
  def register(params: ParamsDollarResourceDollarControllerDollarDebuggeesDollarRegister): GaxiosPromise[Schema$RegisterDebuggeeResponse] = js.native
  def register(
    params: ParamsDollarResourceDollarControllerDollarDebuggeesDollarRegister,
    callback: BodyResponseCallback[Schema$RegisterDebuggeeResponse]
  ): Unit = js.native
  def register(
    params: ParamsDollarResourceDollarControllerDollarDebuggeesDollarRegister,
    options: BodyResponseCallback[Schema$RegisterDebuggeeResponse],
    callback: BodyResponseCallback[Schema$RegisterDebuggeeResponse]
  ): Unit = js.native
  def register(params: ParamsDollarResourceDollarControllerDollarDebuggeesDollarRegister, options: MethodOptions): GaxiosPromise[Schema$RegisterDebuggeeResponse] = js.native
  def register(
    params: ParamsDollarResourceDollarControllerDollarDebuggeesDollarRegister,
