...
/**
  ...
  */
@js.native
trait Schema$Debuggee extends js.Object {
  /**
  ...
  /**
    ...
    */
  var extSourceContexts: js.UndefOr[js.Array[Schema$ExtendedSourceContext]] = js.native
  /**
  ...
  /**
    ...
    * deployed application.
    */
  var sourceContexts: js.UndefOr[js.Array[Schema$SourceContext]] = js.native
  /**
...
object Schema$Debuggee {
  @scala.inline
  def apply(
    agentVersion: String = null,
    description: String = null,
    extSourceContexts: js.Array[Schema$ExtendedSourceContext] = null,
    id: String = null,
    isDisabled: js.UndefOr[Boolean] = js.undefined,
    isInactive: js.UndefOr[Boolean] = js.undefined,
    labels: StringDictionary[String] = null,
    project: String = null,
    sourceContexts: js.Array[Schema$SourceContext] = null,
    ...
    __obj.asInstanceOf[Schema$Debuggee]
  }
}
