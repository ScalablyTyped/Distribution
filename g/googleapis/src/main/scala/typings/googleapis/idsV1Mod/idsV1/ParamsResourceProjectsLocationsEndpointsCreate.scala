...
trait ParamsResourceProjectsLocationsEndpointsCreate
  extends StObject
...
object ParamsResourceProjectsLocationsEndpointsCreate {
  
  inline def apply(): ParamsResourceProjectsLocationsEndpointsCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsEndpointsCreate]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsEndpointsCreate](x: Self) {
