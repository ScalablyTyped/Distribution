...
trait ParamsResourceProjectsLocationsEndpointsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsLocationsEndpointsGetiampolicy {
  
  inline def apply(): ParamsResourceProjectsLocationsEndpointsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsEndpointsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsEndpointsGetiampolicy](x: Self) {
