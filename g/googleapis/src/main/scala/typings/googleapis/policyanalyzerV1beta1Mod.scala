...
object policyanalyzerV1beta1Mod {
  
  object policyanalyzerV1beta1 {
    
    @JSImport("googleapis/build/src/apis/policyanalyzer/v1beta1", "policyanalyzer_v1beta1.Policyanalyzer")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/policyanalyzer/v1beta1", "policyanalyzer_v1beta1.Resource$Projects")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/policyanalyzer/v1beta1", "policyanalyzer_v1beta1.Resource$Projects$Locations")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/policyanalyzer/v1beta1", "policyanalyzer_v1beta1.Resource$Projects$Locations$Activitytypes")
    @js.native
    ...
    @JSImport("googleapis/build/src/apis/policyanalyzer/v1beta1", "policyanalyzer_v1beta1.Resource$Projects$Locations$Activitytypes$Activities")
    @js.native
    open class ResourceProjectsLocationsActivitytypesActivities protected () extends StObject {
      ...
      def query(): GaxiosPromise[SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse] = js.native
      def query(callback: BodyResponseCallback[SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse]): Unit = js.native
      def query(params: Unit, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse] = js.native
      def query(params: ParamsResourceProjectsLocationsActivitytypesActivitiesQuery): GaxiosPromise[SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse] = js.native
      def query(
        params: ParamsResourceProjectsLocationsActivitytypesActivitiesQuery,
        callback: BodyResponseCallback[SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse]
      ): Unit = js.native
      def query(
        params: ParamsResourceProjectsLocationsActivitytypesActivitiesQuery,
        options: BodyResponseCallback[Readable | SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse],
        callback: BodyResponseCallback[Readable | SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse]
      ): Unit = js.native
      def query(params: ParamsResourceProjectsLocationsActivitytypesActivitiesQuery, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse] = js.native
      def query(
        params: ParamsResourceProjectsLocationsActivitytypesActivitiesQuery,
    ...
    trait SchemaGoogleCloudPolicyanalyzerV1beta1Activity extends StObject {
      ...
      /**
        ...
        */
      var observationPeriod: js.UndefOr[SchemaGoogleCloudPolicyanalyzerV1beta1ObservationPeriod] = js.undefined
    }
    object SchemaGoogleCloudPolicyanalyzerV1beta1Activity {
      
      inline def apply(): SchemaGoogleCloudPolicyanalyzerV1beta1Activity = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[SchemaGoogleCloudPolicyanalyzerV1beta1Activity]
      }
      
      extension [Self <: SchemaGoogleCloudPolicyanalyzerV1beta1Activity](x: Self) {
        ...
        inline def setObservationPeriod(value: SchemaGoogleCloudPolicyanalyzerV1beta1ObservationPeriod): Self = StObject.set(x, "observationPeriod", value.asInstanceOf[js.Any])
        
        inline def setObservationPeriodUndefined: Self = StObject.set(x, "observationPeriod", js.undefined)
      }
    }
    
    trait SchemaGoogleCloudPolicyanalyzerV1beta1ObservationPeriod extends StObject {
    ...
    object SchemaGoogleCloudPolicyanalyzerV1beta1ObservationPeriod {
      
      inline def apply(): SchemaGoogleCloudPolicyanalyzerV1beta1ObservationPeriod = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[SchemaGoogleCloudPolicyanalyzerV1beta1ObservationPeriod]
      }
      
      extension [Self <: SchemaGoogleCloudPolicyanalyzerV1beta1ObservationPeriod](x: Self) {
    ...
    trait SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse extends StObject {
      
      /**
        * The set of activities that match the filter included in the request.
        */
      var activities: js.UndefOr[js.Array[SchemaGoogleCloudPolicyanalyzerV1beta1Activity]] = js.undefined
    ...
    object SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse {
      
      inline def apply(): SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse]
      }
      
      extension [Self <: SchemaGoogleCloudPolicyanalyzerV1beta1QueryActivityResponse](x: Self) {
        
        inline def setActivities(value: js.Array[SchemaGoogleCloudPolicyanalyzerV1beta1Activity]): Self = StObject.set(x, "activities", value.asInstanceOf[js.Any])
        
        inline def setActivitiesUndefined: Self = StObject.set(x, "activities", js.undefined)
        
        inline def setActivitiesVarargs(value: SchemaGoogleCloudPolicyanalyzerV1beta1Activity*): Self = StObject.set(x, "activities", js.Array(value*))
