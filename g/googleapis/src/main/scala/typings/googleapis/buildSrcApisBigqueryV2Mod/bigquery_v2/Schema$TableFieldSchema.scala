...
import typings.googleapis.Anon_Names
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait Schema$TableFieldSchema extends js.Object {
  /**
    * [Optional] The categories attached to this field, used for field-level
    * access control.
    */
  var categories: js.UndefOr[Anon_Names] = js.native
  /**
...
object Schema$TableFieldSchema {
  @scala.inline
  def apply(
    categories: Anon_Names = null,
    description: String = null,
    fields: js.Array[Schema$TableFieldSchema] = null,
    mode: String = null,
    name: String = null,
    `type`: String = null
    ...
    __obj.asInstanceOf[Schema$TableFieldSchema]
  }
}
