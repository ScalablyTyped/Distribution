...
/**
  ...
  */
@js.native
trait Schema$IterationResult extends js.Object {
  /**
    * [Beta] Information about top clusters for clustering models.
    */
  var clusterInfos: js.UndefOr[js.Array[Schema$ClusterInfo]] = js.native
  /**
...
object Schema$IterationResult {
  @scala.inline
  def apply(
    clusterInfos: js.Array[Schema$ClusterInfo] = null,
    ...
    __obj.asInstanceOf[Schema$IterationResult]
  }
}
