...
@js.native
trait ParamsDollarResourceDollarModelsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarModelsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarModelsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarModelsDollarDelete]
  }
}
