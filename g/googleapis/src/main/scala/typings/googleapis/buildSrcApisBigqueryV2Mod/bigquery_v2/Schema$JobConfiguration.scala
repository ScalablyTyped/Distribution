...
@js.native
trait Schema$JobConfiguration extends js.Object {
  /**
    * [Pick one] Copies a table.
    */
  var copy: js.UndefOr[Schema$JobConfigurationTableCopy] = js.native
  /**
  ...
  /**
    ...
    */
  var extract: js.UndefOr[Schema$JobConfigurationExtract] = js.native
  /**
  ...
  /**
    ...
    */
  var load: js.UndefOr[Schema$JobConfigurationLoad] = js.native
  /**
    * [Pick one] Configures a query job.
    */
  var query: js.UndefOr[Schema$JobConfigurationQuery] = js.native
}

object Schema$JobConfiguration {
  @scala.inline
  def apply(
    copy: Schema$JobConfigurationTableCopy = null,
    dryRun: js.UndefOr[Boolean] = js.undefined,
    extract: Schema$JobConfigurationExtract = null,
    jobTimeoutMs: String = null,
    jobType: String = null,
    labels: StringDictionary[String] = null,
    load: Schema$JobConfigurationLoad = null,
    query: Schema$JobConfigurationQuery = null
    ...
    __obj.asInstanceOf[Schema$JobConfiguration]
  }
}
