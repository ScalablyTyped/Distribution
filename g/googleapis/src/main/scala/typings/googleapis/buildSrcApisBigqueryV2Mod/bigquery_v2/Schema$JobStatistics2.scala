...
import typings.googleapis.Anon_NameSlotMsString
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait Schema$JobStatistics2 extends js.Object {
  /**
  ...
  /**
    ...
    * queries.
    */
  var ddlTargetRoutine: js.UndefOr[Schema$RoutineReference] = js.native
  /**
    * The DDL target table. Present only for CREATE/DROP TABLE/VIEW queries.
    */
  var ddlTargetTable: js.UndefOr[Schema$TableReference] = js.native
  /**
  ...
  /**
    ...
    */
  var modelTraining: js.UndefOr[Schema$BigQueryModelTraining] = js.native
  /**
  ...
  /**
    ...
    */
  var queryPlan: js.UndefOr[js.Array[Schema$ExplainQueryStage]] = js.native
  /**
    * [Output-only] Referenced tables for the job. Queries that reference more
    * than 50 tables will not have a complete list.
    */
  var referencedTables: js.UndefOr[js.Array[Schema$TableReference]] = js.native
  /**
    * [Output-only] Job resource usage breakdown by reservation.
    */
  var reservationUsage: js.UndefOr[js.Array[Anon_NameSlotMsString]] = js.native
  /**
  ...
  /**
    ...
    */
  var timeline: js.UndefOr[js.Array[Schema$QueryTimelineSample]] = js.native
  /**
  ...
  /**
    ...
    * dry run validation.
    */
  var undeclaredQueryParameters: js.UndefOr[js.Array[Schema$QueryParameter]] = js.native
}

object Schema$JobStatistics2 {
  @scala.inline
  def apply(
    billingTier: Int | Double = null,
    cacheHit: js.UndefOr[Boolean] = js.undefined,
    ddlOperationPerformed: String = null,
    ddlTargetRoutine: Schema$RoutineReference = null,
    ddlTargetTable: Schema$TableReference = null,
    estimatedBytesProcessed: String = null,
    modelTraining: Schema$BigQueryModelTraining = null,
    ...
    queryPlan: js.Array[Schema$ExplainQueryStage] = null,
    referencedTables: js.Array[Schema$TableReference] = null,
    reservationUsage: js.Array[Anon_NameSlotMsString] = null,
    schema: Schema$TableSchema = null,
    statementType: String = null,
    timeline: js.Array[Schema$QueryTimelineSample] = null,
    ...
    undeclaredQueryParameters: js.Array[Schema$QueryParameter] = null
    ...
    __obj.asInstanceOf[Schema$JobStatistics2]
  }
}
