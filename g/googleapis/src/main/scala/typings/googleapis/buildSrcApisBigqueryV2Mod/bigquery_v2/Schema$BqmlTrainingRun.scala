...
import typings.googleapis.Anon_EarlyStop
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait Schema$BqmlTrainingRun extends js.Object {
  /**
    * [Output-only, Beta] List of each iteration results.
    */
  var iterationResults: js.UndefOr[js.Array[Schema$BqmlIterationResult]] = js.native
  /**
  ...
  /**
    ...
    * training run.
    */
  var trainingOptions: js.UndefOr[Anon_EarlyStop] = js.native
}

object Schema$BqmlTrainingRun {
  @scala.inline
  def apply(
    iterationResults: js.Array[Schema$BqmlIterationResult] = null,
    startTime: String = null,
    state: String = null,
    trainingOptions: Anon_EarlyStop = null
    ...
    __obj.asInstanceOf[Schema$BqmlTrainingRun]
  }
}
