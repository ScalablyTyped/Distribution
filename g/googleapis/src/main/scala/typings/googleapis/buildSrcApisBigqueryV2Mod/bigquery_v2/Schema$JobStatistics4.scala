...
@js.native
trait Schema$JobStatistics4 extends js.Object {
  /**
...
object Schema$JobStatistics4 {
  @scala.inline
  def apply(destinationUriFileCounts: js.Array[String] = null, inputBytes: String = null): Schema$JobStatistics4 = {
    ...
    __obj.asInstanceOf[Schema$JobStatistics4]
  }
}
