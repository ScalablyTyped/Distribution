...
@js.native
trait ParamsDollarResourceDollarJobsDollarGetqueryresults extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarJobsDollarGetqueryresults {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarJobsDollarGetqueryresults = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarJobsDollarGetqueryresults]
  }
}
