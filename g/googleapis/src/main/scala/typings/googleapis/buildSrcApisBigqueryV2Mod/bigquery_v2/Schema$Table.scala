...
trait Schema$Table extends js.Object {
  ...
  /**
    ...
    */
  var encryptionConfiguration: js.UndefOr[Schema$EncryptionConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var externalDataConfiguration: js.UndefOr[Schema$ExternalDataConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var materializedView: js.UndefOr[Schema$MaterializedViewDefinition] = js.native
  /**
    ...
    * run &#39;PREDICT&#39; queries.
    */
  var model: js.UndefOr[Schema$ModelDefinition] = js.native
  /**
  ...
  /**
    ...
    */
  var streamingBuffer: js.UndefOr[Schema$Streamingbuffer] = js.native
  /**
  ...
  /**
    ...
    */
  var view: js.UndefOr[Schema$ViewDefinition] = js.native
}
...
object Schema$Table {
  ...
  def apply(
    ...
    encryptionConfiguration: Schema$EncryptionConfiguration = null,
    etag: String = null,
    expirationTime: String = null,
    externalDataConfiguration: Schema$ExternalDataConfiguration = null,
    ...
    materializedView: Schema$MaterializedViewDefinition = null,
    model: Schema$ModelDefinition = null,
