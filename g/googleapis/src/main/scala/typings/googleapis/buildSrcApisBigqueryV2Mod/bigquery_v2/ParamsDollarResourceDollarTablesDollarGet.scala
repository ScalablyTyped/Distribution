...
@js.native
trait ParamsDollarResourceDollarTablesDollarGet extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarTablesDollarGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    tableId: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarTablesDollarGet = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarTablesDollarGet]
  }
}
