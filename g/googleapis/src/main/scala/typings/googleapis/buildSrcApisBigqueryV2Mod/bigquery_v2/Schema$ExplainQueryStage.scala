...
@js.native
trait Schema$ExplainQueryStage extends js.Object {
  /**
  ...
  /**
    ...
    * chronological).
    */
  var steps: js.UndefOr[js.Array[Schema$ExplainQueryStep]] = js.native
  /**
...
object Schema$ExplainQueryStage {
  @scala.inline
  def apply(
    ...
    startMs: String = null,
    status: String = null,
    steps: js.Array[Schema$ExplainQueryStep] = null,
    ...
    __obj.asInstanceOf[Schema$ExplainQueryStage]
  }
}
