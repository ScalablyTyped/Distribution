...
/**
  ...
  */
@js.native
trait Schema$GoogleFirestoreAdminV1beta2Index extends js.Object {
  /**
    ...
    * associated field.
    */
  var fields: js.UndefOr[js.Array[Schema$GoogleFirestoreAdminV1beta2IndexField]] = js.native
  /**
...
object Schema$GoogleFirestoreAdminV1beta2Index {
  @scala.inline
  def apply(
    fields: js.Array[Schema$GoogleFirestoreAdminV1beta2IndexField] = null,
    name: String = null,
    queryScope: String = null,
    state: String = null
  ): Schema$GoogleFirestoreAdminV1beta2Index = {
    ...
    __obj.asInstanceOf[Schema$GoogleFirestoreAdminV1beta2Index]
  }
}
