...
/**
  ...
  */
@js.native
trait Schema$GoogleFirestoreAdminV1beta2Field extends js.Object {
  /**
    ...
    */
  var indexConfig: js.UndefOr[Schema$GoogleFirestoreAdminV1beta2IndexConfig] = js.native
  /**
...
object Schema$GoogleFirestoreAdminV1beta2Field {
  @scala.inline
  def apply(indexConfig: Schema$GoogleFirestoreAdminV1beta2IndexConfig = null, name: String = null): Schema$GoogleFirestoreAdminV1beta2Field = {
    val __obj = js.Dynamic.literal()
    if (indexConfig != null) __obj.updateDynamic("indexConfig")(indexConfig.asInstanceOf[js.Any])
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$GoogleFirestoreAdminV1beta2Field]
  }
}
