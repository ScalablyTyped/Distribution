...
/**
  ...
  */
@js.native
trait Schema$GoogleFirestoreAdminV1beta2ImportDocumentsMetadata extends js.Object {
  /**
...
object Schema$GoogleFirestoreAdminV1beta2ImportDocumentsMetadata {
  @scala.inline
  def apply(
  ...
  ): Schema$GoogleFirestoreAdminV1beta2ImportDocumentsMetadata = {
    ...
    __obj.asInstanceOf[Schema$GoogleFirestoreAdminV1beta2ImportDocumentsMetadata]
  }
}
