...
@js.native
trait ParamsDollarResourceDollarProjectsDollarDatabasesDollarCollectiongroupsDollarFieldsDollarPatch extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$GoogleFirestoreAdminV1beta2Field] = js.native
  /**
