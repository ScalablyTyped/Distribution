...
import typings.googleapis.buildSrcApisMonitoringV3Mod.monitoring_v3.Monitoring
import typings.googleapis.buildSrcApisMonitoringV3Mod.monitoring_v3.Options
...
@JSImport("googleapis/build/src/apis/monitoring", JSImport.Namespace)
@js.native
object buildSrcApisMonitoringMod extends js.Object {
  def monitoring(options: Options): Monitoring = js.native
  @JSName("monitoring")
  def monitoring_v3(version: v3): Monitoring = js.native
  @js.native
  object VERSIONS extends js.Object {
    @js.native
    class v3 protected () extends Monitoring {
