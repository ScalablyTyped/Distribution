...
object ParamsResourceProjectsSubscriptionsModifyackdeadline {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsSubscriptionsModifyackdeadlineOps[Self <: ParamsResourceProjectsSubscriptionsModifyackdeadline] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaModifyAckDeadlineRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
