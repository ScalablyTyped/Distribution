...
trait ParamsResourceProjectsTopicsGetiampolicy
  extends StObject
...
object ParamsResourceProjectsTopicsGetiampolicy {
  ...
  inline def apply(): ParamsResourceProjectsTopicsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsTopicsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceProjectsTopicsGetiampolicy](x: Self) {
