...
object ParamsResourceUsersMessagesSend {
  ...
  @scala.inline
  def apply(): ParamsResourceUsersMessagesSend = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersMessagesSend]
  }
  
  @scala.inline
  implicit class ParamsResourceUsersMessagesSendMutableBuilder[Self <: ParamsResourceUsersMessagesSend] (val x: Self) extends AnyVal {
