...
trait ParamsResourceUsersSettingsSendasPatch
  extends StObject
...
object ParamsResourceUsersSettingsSendasPatch {
  ...
  inline def apply(): ParamsResourceUsersSettingsSendasPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersSettingsSendasPatch]
  }
  
  extension [Self <: ParamsResourceUsersSettingsSendasPatch](x: Self) {
