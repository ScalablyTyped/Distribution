...
trait SchemaLabel extends StObject {
  ...
  /**
    ...
    */
  var labelListVisibility: js.UndefOr[String | Null] = js.undefined
  
  /**
    * The visibility of messages with this label in the message list in the Gmail web interface.
    */
  var messageListVisibility: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var messagesUnread: js.UndefOr[Double | Null] = js.undefined
  ...
  /**
    ...
    */
  var threadsUnread: js.UndefOr[Double | Null] = js.undefined
...
object SchemaLabel {
  ...
  extension [Self <: SchemaLabel](x: Self) {
    ...
    inline def setColor(value: SchemaLabelColor): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    inline def setLabelListVisibilityNull: Self = StObject.set(x, "labelListVisibility", null)
    ...
    inline def setMessageListVisibilityNull: Self = StObject.set(x, "messageListVisibility", null)
    ...
    inline def setMessagesUnreadNull: Self = StObject.set(x, "messagesUnread", null)
    ...
    inline def setThreadsUnreadNull: Self = StObject.set(x, "threadsUnread", null)
