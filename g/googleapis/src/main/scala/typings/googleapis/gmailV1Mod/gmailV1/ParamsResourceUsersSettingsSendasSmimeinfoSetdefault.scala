...
object ParamsResourceUsersSettingsSendasSmimeinfoSetdefault {
  ...
  @scala.inline
  def apply(): ParamsResourceUsersSettingsSendasSmimeinfoSetdefault = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceUsersSettingsSendasSmimeinfoSetdefault]
  }
  
  @scala.inline
  implicit class ParamsResourceUsersSettingsSendasSmimeinfoSetdefaultMutableBuilder[Self <: ParamsResourceUsersSettingsSendasSmimeinfoSetdefault] (val x: Self) extends AnyVal {
