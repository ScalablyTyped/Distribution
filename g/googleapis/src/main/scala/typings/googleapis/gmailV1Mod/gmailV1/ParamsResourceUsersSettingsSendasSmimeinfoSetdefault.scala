...
object ParamsResourceUsersSettingsSendasSmimeinfoSetdefault {
  ...
  @scala.inline
  implicit class ParamsResourceUsersSettingsSendasSmimeinfoSetdefaultOps[Self <: ParamsResourceUsersSettingsSendasSmimeinfoSetdefault] (val x: Self) extends AnyVal {
    @scala.inline
