...
@js.native
trait ParamsDollarResourceDollarOrdersDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarOrdersDollarList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarOrdersDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarOrdersDollarList]
  }
}
