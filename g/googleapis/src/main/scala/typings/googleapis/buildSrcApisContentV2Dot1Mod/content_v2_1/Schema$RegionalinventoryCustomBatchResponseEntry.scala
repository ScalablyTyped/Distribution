...
/**
  ...
  */
@js.native
trait Schema$RegionalinventoryCustomBatchResponseEntry extends js.Object {
  /**
...
object Schema$RegionalinventoryCustomBatchResponseEntry {
  @scala.inline
  def apply(
  ...
  ): Schema$RegionalinventoryCustomBatchResponseEntry = {
    ...
    __obj.asInstanceOf[Schema$RegionalinventoryCustomBatchResponseEntry]
  }
}
