...
@js.native
trait Schema$AccountAdsLink extends js.Object {
  /**
...
object Schema$AccountAdsLink {
  @scala.inline
  def apply(adsId: String = null, status: String = null): Schema$AccountAdsLink = {
    val __obj = js.Dynamic.literal()
    if (adsId != null) __obj.updateDynamic("adsId")(adsId.asInstanceOf[js.Any])
    if (status != null) __obj.updateDynamic("status")(status.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$AccountAdsLink]
  }
}
