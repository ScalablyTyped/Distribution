...
@js.native
trait ParamsDollarResourceDollarOrderreturnsDollarList extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarOrderreturnsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarOrderreturnsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarOrderreturnsDollarList]
  }
}
