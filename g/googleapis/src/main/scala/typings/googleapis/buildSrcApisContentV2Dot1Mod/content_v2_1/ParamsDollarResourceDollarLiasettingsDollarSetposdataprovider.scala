...
@js.native
trait ParamsDollarResourceDollarLiasettingsDollarSetposdataprovider extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarLiasettingsDollarSetposdataprovider {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarLiasettingsDollarSetposdataprovider = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarLiasettingsDollarSetposdataprovider]
  }
}
