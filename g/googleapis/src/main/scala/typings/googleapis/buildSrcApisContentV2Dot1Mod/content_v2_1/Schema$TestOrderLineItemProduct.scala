...
@js.native
trait Schema$TestOrderLineItemProduct extends js.Object {
  /**
    * Brand of the item.
    */
...
object Schema$TestOrderLineItemProduct {
  @scala.inline
  def apply(
    brand: String = null,
  ...
  ): Schema$TestOrderLineItemProduct = {
    ...
    __obj.asInstanceOf[Schema$TestOrderLineItemProduct]
  }
}
