...
trait Schema$RequestMetadata extends js.Object {
  ...
  /**
    ...
    */
  var destinationAttributes: js.UndefOr[Schema$Peer] = js.native
  /**
    ...
    */
  var requestAttributes: js.UndefOr[Schema$Request] = js.native
}
...
object Schema$RequestMetadata {
  ...
  def apply(
    ...
    destinationAttributes: Schema$Peer = null,
    requestAttributes: Schema$Request = null
