...
/**
  ...
  */
@js.native
trait Schema$ResourceInfo extends js.Object {
  /**
...
object Schema$ResourceInfo {
  @scala.inline
  def apply(resourceContainer: String = null, resourceLocation: String = null, resourceName: String = null): Schema$ResourceInfo = {
    ...
    __obj.asInstanceOf[Schema$ResourceInfo]
  }
}
