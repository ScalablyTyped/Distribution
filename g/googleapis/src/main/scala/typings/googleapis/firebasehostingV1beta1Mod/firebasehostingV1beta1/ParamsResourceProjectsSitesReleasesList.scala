...
trait ParamsResourceProjectsSitesReleasesList
  extends StObject
...
object ParamsResourceProjectsSitesReleasesList {
  
  inline def apply(): ParamsResourceProjectsSitesReleasesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSitesReleasesList]
  }
  
  extension [Self <: ParamsResourceProjectsSitesReleasesList](x: Self) {
