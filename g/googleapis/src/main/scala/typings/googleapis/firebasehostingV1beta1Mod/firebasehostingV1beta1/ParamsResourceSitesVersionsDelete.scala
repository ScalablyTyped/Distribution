...
object ParamsResourceSitesVersionsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceSitesVersionsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSitesVersionsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceSitesVersionsDeleteMutableBuilder[Self <: ParamsResourceSitesVersionsDelete] (val x: Self) extends AnyVal {
