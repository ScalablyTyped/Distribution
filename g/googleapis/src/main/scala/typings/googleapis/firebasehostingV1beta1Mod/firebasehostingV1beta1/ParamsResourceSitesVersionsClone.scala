...
trait ParamsResourceSitesVersionsClone
  extends StObject
...
object ParamsResourceSitesVersionsClone {
  
  inline def apply(): ParamsResourceSitesVersionsClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSitesVersionsClone]
  }
  
  extension [Self <: ParamsResourceSitesVersionsClone](x: Self) {
