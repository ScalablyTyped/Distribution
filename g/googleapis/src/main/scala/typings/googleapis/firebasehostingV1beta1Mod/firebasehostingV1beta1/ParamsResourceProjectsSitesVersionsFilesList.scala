...
trait ParamsResourceProjectsSitesVersionsFilesList
  extends StObject
...
object ParamsResourceProjectsSitesVersionsFilesList {
  
  inline def apply(): ParamsResourceProjectsSitesVersionsFilesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSitesVersionsFilesList]
  }
  
  extension [Self <: ParamsResourceProjectsSitesVersionsFilesList](x: Self) {
