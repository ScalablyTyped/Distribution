...
@JSImport("googleapis/build/src/apis/firebasehosting/v1beta1", "firebasehosting_v1beta1.Resource$Projects$Sites$Releases")
@js.native
open class ResourceProjectsSitesReleases protected () extends StObject {
  ...
  def create(params: ParamsResourceProjectsSitesReleasesCreate): GaxiosPromise[SchemaRelease] = js.native
  def create(params: ParamsResourceProjectsSitesReleasesCreate, callback: BodyResponseCallback[SchemaRelease]): Unit = js.native
  def create(
    params: ParamsResourceProjectsSitesReleasesCreate,
    options: BodyResponseCallback[Readable | SchemaRelease],
    callback: BodyResponseCallback[Readable | SchemaRelease]
  ): Unit = js.native
  def create(params: ParamsResourceProjectsSitesReleasesCreate, options: MethodOptions): GaxiosPromise[SchemaRelease] = js.native
  def create(
    params: ParamsResourceProjectsSitesReleasesCreate,
  ...
  /**
    ...
    */
  def create(params: ParamsResourceProjectsSitesReleasesCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceProjectsSitesReleasesCreate,
  ...
  def list(params: ParamsResourceProjectsSitesReleasesList): GaxiosPromise[SchemaListReleasesResponse] = js.native
  def list(
    params: ParamsResourceProjectsSitesReleasesList,
  ...
  def list(params: ParamsResourceProjectsSitesReleasesList, options: MethodOptions): GaxiosPromise[SchemaListReleasesResponse] = js.native
  def list(
    params: ParamsResourceProjectsSitesReleasesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaListReleasesResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceProjectsSitesReleasesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsSitesReleasesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
