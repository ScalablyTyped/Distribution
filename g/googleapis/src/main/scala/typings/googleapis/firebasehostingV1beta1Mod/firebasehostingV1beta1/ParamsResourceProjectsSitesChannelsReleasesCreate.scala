...
trait ParamsResourceProjectsSitesChannelsReleasesCreate
  extends StObject
...
object ParamsResourceProjectsSitesChannelsReleasesCreate {
  
  inline def apply(): ParamsResourceProjectsSitesChannelsReleasesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSitesChannelsReleasesCreate]
  }
  
  extension [Self <: ParamsResourceProjectsSitesChannelsReleasesCreate](x: Self) {
