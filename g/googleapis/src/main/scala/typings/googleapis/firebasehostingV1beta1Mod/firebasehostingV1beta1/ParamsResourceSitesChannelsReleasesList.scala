...
trait ParamsResourceSitesChannelsReleasesList
  extends StObject
...
object ParamsResourceSitesChannelsReleasesList {
  
  inline def apply(): ParamsResourceSitesChannelsReleasesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSitesChannelsReleasesList]
  }
  
  extension [Self <: ParamsResourceSitesChannelsReleasesList](x: Self) {
