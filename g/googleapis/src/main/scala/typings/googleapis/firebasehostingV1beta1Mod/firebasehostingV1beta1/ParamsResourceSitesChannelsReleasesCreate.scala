...
trait ParamsResourceSitesChannelsReleasesCreate
  extends StObject
...
object ParamsResourceSitesChannelsReleasesCreate {
  
  inline def apply(): ParamsResourceSitesChannelsReleasesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSitesChannelsReleasesCreate]
  }
  
  extension [Self <: ParamsResourceSitesChannelsReleasesCreate](x: Self) {
