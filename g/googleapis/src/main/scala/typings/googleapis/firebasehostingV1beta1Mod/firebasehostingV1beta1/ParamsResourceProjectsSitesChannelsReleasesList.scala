...
trait ParamsResourceProjectsSitesChannelsReleasesList
  extends StObject
...
object ParamsResourceProjectsSitesChannelsReleasesList {
  
  inline def apply(): ParamsResourceProjectsSitesChannelsReleasesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSitesChannelsReleasesList]
  }
  
  extension [Self <: ParamsResourceProjectsSitesChannelsReleasesList](x: Self) {
