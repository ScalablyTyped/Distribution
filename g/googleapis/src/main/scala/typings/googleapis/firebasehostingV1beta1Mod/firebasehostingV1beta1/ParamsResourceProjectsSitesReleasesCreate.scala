...
trait ParamsResourceProjectsSitesReleasesCreate
  extends StObject
...
object ParamsResourceProjectsSitesReleasesCreate {
  
  inline def apply(): ParamsResourceProjectsSitesReleasesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsSitesReleasesCreate]
  }
  
  extension [Self <: ParamsResourceProjectsSitesReleasesCreate](x: Self) {
