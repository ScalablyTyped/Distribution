...
trait ParamsResourceSitesVersionsList
  extends StObject
...
object ParamsResourceSitesVersionsList {
  
  inline def apply(): ParamsResourceSitesVersionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSitesVersionsList]
  }
  
  extension [Self <: ParamsResourceSitesVersionsList](x: Self) {
