...
@js.native
open class ResourceSitesReleases protected () extends StObject {
  ...
  /**
    ...
    */
  def create(params: ParamsResourceSitesReleasesCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceSitesReleasesCreate,
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceSitesReleasesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceSitesReleasesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
