...
object ParamsResourceSitesReleasesList {
  ...
  @scala.inline
  def apply(): ParamsResourceSitesReleasesList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSitesReleasesList]
  }
  
  @scala.inline
  implicit class ParamsResourceSitesReleasesListMutableBuilder[Self <: ParamsResourceSitesReleasesList] (val x: Self) extends AnyVal {
