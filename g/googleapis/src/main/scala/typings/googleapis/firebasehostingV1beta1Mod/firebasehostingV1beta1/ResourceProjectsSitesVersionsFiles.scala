...
@JSImport("googleapis/build/src/apis/firebasehosting/v1beta1", "firebasehosting_v1beta1.Resource$Projects$Sites$Versions$Files")
@js.native
open class ResourceProjectsSitesVersionsFiles protected () extends StObject {
  ...
  def list(params: ParamsResourceProjectsSitesVersionsFilesList): GaxiosPromise[SchemaListVersionFilesResponse] = js.native
  def list(
    params: ParamsResourceProjectsSitesVersionsFilesList,
  ...
  def list(params: ParamsResourceProjectsSitesVersionsFilesList, options: MethodOptions): GaxiosPromise[SchemaListVersionFilesResponse] = js.native
  def list(
    params: ParamsResourceProjectsSitesVersionsFilesList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceProjectsSitesVersionsFilesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceProjectsSitesVersionsFilesList,
