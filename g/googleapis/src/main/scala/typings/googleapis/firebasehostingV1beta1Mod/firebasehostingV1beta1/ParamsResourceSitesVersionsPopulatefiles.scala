...
object ParamsResourceSitesVersionsPopulatefiles {
  ...
  @scala.inline
  implicit class ParamsResourceSitesVersionsPopulatefilesOps[Self <: ParamsResourceSitesVersionsPopulatefiles] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestBody(value: SchemaPopulateVersionFilesRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
    @scala.inline
