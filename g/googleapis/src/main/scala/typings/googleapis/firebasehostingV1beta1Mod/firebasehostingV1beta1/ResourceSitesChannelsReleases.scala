...
@JSImport("googleapis/build/src/apis/firebasehosting/v1beta1", "firebasehosting_v1beta1.Resource$Sites$Channels$Releases")
@js.native
open class ResourceSitesChannelsReleases protected () extends StObject {
  ...
  def create(params: ParamsResourceSitesChannelsReleasesCreate): GaxiosPromise[SchemaRelease] = js.native
  def create(params: ParamsResourceSitesChannelsReleasesCreate, callback: BodyResponseCallback[SchemaRelease]): Unit = js.native
  def create(
    params: ParamsResourceSitesChannelsReleasesCreate,
    options: BodyResponseCallback[Readable | SchemaRelease],
    callback: BodyResponseCallback[Readable | SchemaRelease]
  ): Unit = js.native
  def create(params: ParamsResourceSitesChannelsReleasesCreate, options: MethodOptions): GaxiosPromise[SchemaRelease] = js.native
  def create(
    params: ParamsResourceSitesChannelsReleasesCreate,
  ...
  /**
    ...
    */
  def create(params: ParamsResourceSitesChannelsReleasesCreate, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def create(
    params: ParamsResourceSitesChannelsReleasesCreate,
  ...
  def list(params: ParamsResourceSitesChannelsReleasesList): GaxiosPromise[SchemaListReleasesResponse] = js.native
  def list(
    params: ParamsResourceSitesChannelsReleasesList,
  ...
  def list(params: ParamsResourceSitesChannelsReleasesList, options: MethodOptions): GaxiosPromise[SchemaListReleasesResponse] = js.native
  def list(
    params: ParamsResourceSitesChannelsReleasesList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaListReleasesResponse]
  ...
  /**
    ...
    * @returns A promise if used with async/await, or void if used with a callback.
    */
  def list(params: ParamsResourceSitesChannelsReleasesList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceSitesChannelsReleasesList,
    options: StreamMethodOptions,
    callback: BodyResponseCallback[Readable]
