...
trait ParamsResourceSitesChannelsList
  extends StObject
...
object ParamsResourceSitesChannelsList {
  
  inline def apply(): ParamsResourceSitesChannelsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSitesChannelsList]
  }
  
  extension [Self <: ParamsResourceSitesChannelsList](x: Self) {
