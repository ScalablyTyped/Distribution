...
trait ParamsResourceNamespacesJobsList
  extends StObject
...
object ParamsResourceNamespacesJobsList {
  
  inline def apply(): ParamsResourceNamespacesJobsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesJobsList]
  }
  
  extension [Self <: ParamsResourceNamespacesJobsList](x: Self) {
