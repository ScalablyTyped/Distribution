...
object ParamsResourceProjectsLocationsServicesReplaceservice {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsServicesReplaceservice = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsServicesReplaceservice]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsServicesReplaceserviceMutableBuilder[Self <: ParamsResourceProjectsLocationsServicesReplaceservice] (val x: Self) extends AnyVal {
