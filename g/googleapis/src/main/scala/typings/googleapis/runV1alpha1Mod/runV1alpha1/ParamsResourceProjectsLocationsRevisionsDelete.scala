...
object ParamsResourceProjectsLocationsRevisionsDelete {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsRevisionsDeleteMutableBuilder[Self <: ParamsResourceProjectsLocationsRevisionsDelete] (val x: Self) extends AnyVal {
