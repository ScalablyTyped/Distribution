...
@js.native
trait ParamsResourceNamespacesDomainmappingsList extends StandardParameters {
...
object ParamsResourceNamespacesDomainmappingsList {
  ...
  @scala.inline
  def apply(): ParamsResourceNamespacesDomainmappingsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesDomainmappingsList]
  }
  
  @scala.inline
  implicit class ParamsResourceNamespacesDomainmappingsListMutableBuilder[Self <: ParamsResourceNamespacesDomainmappingsList] (val x: Self) extends AnyVal {
