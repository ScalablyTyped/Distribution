...
@js.native
trait ParamsResourceProjectsLocationsServicesCreate extends StandardParameters {
...
object ParamsResourceProjectsLocationsServicesCreate {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsServicesCreate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsServicesCreate]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsServicesCreateMutableBuilder[Self <: ParamsResourceProjectsLocationsServicesCreate] (val x: Self) extends AnyVal {
