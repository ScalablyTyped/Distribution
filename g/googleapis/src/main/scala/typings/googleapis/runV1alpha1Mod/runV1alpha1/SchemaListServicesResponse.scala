...
trait SchemaListServicesResponse extends StObject {
  ...
  /**
    * List of Services.
    */
  var items: js.UndefOr[js.Array[SchemaService]] = js.undefined
...
object SchemaListServicesResponse {
  ...
  extension [Self <: SchemaListServicesResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[SchemaService]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SchemaService*): Self = StObject.set(x, "items", js.Array(value :_*))
