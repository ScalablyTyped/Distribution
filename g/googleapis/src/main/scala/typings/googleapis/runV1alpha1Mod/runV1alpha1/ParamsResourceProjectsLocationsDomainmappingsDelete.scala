...
trait ParamsResourceProjectsLocationsDomainmappingsDelete
  extends StObject
...
object ParamsResourceProjectsLocationsDomainmappingsDelete {
  ...
  inline def apply(): ParamsResourceProjectsLocationsDomainmappingsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsDomainmappingsDelete]
  }
  
  extension [Self <: ParamsResourceProjectsLocationsDomainmappingsDelete](x: Self) {
