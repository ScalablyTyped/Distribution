...
object ParamsResourceProjectsLocationsDomainmappingsDelete {
  ...
  def apply(
  ...
  ): ParamsResourceProjectsLocationsDomainmappingsDelete = {
    ...
    if (!js.isUndefined(orphanDependents)) __obj.updateDynamic("orphanDependents")(orphanDependents.asInstanceOf[js.Any])
