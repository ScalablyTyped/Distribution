...
trait ParamsResourceNamespacesServicesDelete
  extends StObject
...
object ParamsResourceNamespacesServicesDelete {
  ...
  @scala.inline
  implicit class ParamsResourceNamespacesServicesDeleteMutableBuilder[Self <: ParamsResourceNamespacesServicesDelete] (val x: Self) extends AnyVal {
