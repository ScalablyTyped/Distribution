...
@js.native
trait ParamsResourceNamespacesDomainmappingsDelete extends StandardParameters {
...
object ParamsResourceNamespacesDomainmappingsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceNamespacesDomainmappingsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceNamespacesDomainmappingsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceNamespacesDomainmappingsDeleteMutableBuilder[Self <: ParamsResourceNamespacesDomainmappingsDelete] (val x: Self) extends AnyVal {
