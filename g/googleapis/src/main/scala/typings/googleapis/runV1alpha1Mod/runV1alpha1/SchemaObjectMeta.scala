...
object SchemaObjectMeta {
  ...
  extension [Self <: SchemaObjectMeta](x: Self) {
    ...
    inline def setInitializers(value: SchemaInitializers): Self = StObject.set(x, "initializers", value.asInstanceOf[js.Any])
    ...
    inline def setOwnerReferencesVarargs(value: SchemaOwnerReference*): Self = StObject.set(x, "ownerReferences", js.Array(value :_*))
