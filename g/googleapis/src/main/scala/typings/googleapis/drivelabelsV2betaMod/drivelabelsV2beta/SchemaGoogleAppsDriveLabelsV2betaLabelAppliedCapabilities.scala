...
trait SchemaGoogleAppsDriveLabelsV2betaLabelAppliedCapabilities extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2betaLabelAppliedCapabilities {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2betaLabelAppliedCapabilities = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2betaLabelAppliedCapabilities]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2betaLabelAppliedCapabilities](x: Self) {
