...
trait SchemaGoogleAppsDriveLabelsV2betaFieldProperties extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2betaFieldProperties {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2betaFieldProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2betaFieldProperties]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2betaFieldProperties](x: Self) {
