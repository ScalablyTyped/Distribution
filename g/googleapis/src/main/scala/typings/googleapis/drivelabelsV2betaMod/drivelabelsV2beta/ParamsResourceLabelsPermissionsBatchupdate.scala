...
trait ParamsResourceLabelsPermissionsBatchupdate
  extends StObject
...
object ParamsResourceLabelsPermissionsBatchupdate {
  
  inline def apply(): ParamsResourceLabelsPermissionsBatchupdate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLabelsPermissionsBatchupdate]
  }
  
  extension [Self <: ParamsResourceLabelsPermissionsBatchupdate](x: Self) {
