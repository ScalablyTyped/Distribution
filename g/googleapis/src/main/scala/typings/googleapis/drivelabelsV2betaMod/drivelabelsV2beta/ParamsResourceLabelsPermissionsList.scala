...
trait ParamsResourceLabelsPermissionsList
  extends StObject
...
object ParamsResourceLabelsPermissionsList {
  
  inline def apply(): ParamsResourceLabelsPermissionsList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceLabelsPermissionsList]
  }
  
  extension [Self <: ParamsResourceLabelsPermissionsList](x: Self) {
