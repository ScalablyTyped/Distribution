...
trait SchemaGoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceDisplayHints extends StObject {
  
  /**
    * The colors to use for the badge. Changed to Google Material colors based on the chosen `properties.badge_config.color`.
    */
  var badgeColors: js.UndefOr[SchemaGoogleAppsDriveLabelsV2betaBadgeColors] = js.undefined
  ...
  /**
    ...
    */
  var darkBadgeColors: js.UndefOr[SchemaGoogleAppsDriveLabelsV2betaBadgeColors] = js.undefined
...
object SchemaGoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceDisplayHints {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceDisplayHints = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceDisplayHints]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceDisplayHints](x: Self) {
    
    inline def setBadgeColors(value: SchemaGoogleAppsDriveLabelsV2betaBadgeColors): Self = StObject.set(x, "badgeColors", value.asInstanceOf[js.Any])
    ...
    inline def setDarkBadgeColors(value: SchemaGoogleAppsDriveLabelsV2betaBadgeColors): Self = StObject.set(x, "darkBadgeColors", value.asInstanceOf[js.Any])
