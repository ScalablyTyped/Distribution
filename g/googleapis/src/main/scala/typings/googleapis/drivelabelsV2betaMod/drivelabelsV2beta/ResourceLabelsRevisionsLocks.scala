...
@JSImport("googleapis/build/src/apis/drivelabels/v2beta", "drivelabels_v2beta.Resource$Labels$Revisions$Locks")
@js.native
open class ResourceLabelsRevisionsLocks protected () extends StObject {
  ...
  def list(params: ParamsResourceLabelsRevisionsLocksList): GaxiosPromise[SchemaGoogleAppsDriveLabelsV2betaListLabelLocksResponse] = js.native
  def list(
    params: ParamsResourceLabelsRevisionsLocksList,
  ...
  def list(params: ParamsResourceLabelsRevisionsLocksList, options: MethodOptions): GaxiosPromise[SchemaGoogleAppsDriveLabelsV2betaListLabelLocksResponse] = js.native
  def list(
    params: ParamsResourceLabelsRevisionsLocksList,
  ...
  /**
    ...
    */
  def list(params: ParamsResourceLabelsRevisionsLocksList, options: StreamMethodOptions): GaxiosPromise[Readable] = js.native
  def list(
    params: ParamsResourceLabelsRevisionsLocksList,
