...
trait SchemaGoogleAppsDriveLabelsV2betaFieldAppliedCapabilities extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2betaFieldAppliedCapabilities {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2betaFieldAppliedCapabilities = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2betaFieldAppliedCapabilities]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2betaFieldAppliedCapabilities](x: Self) {
