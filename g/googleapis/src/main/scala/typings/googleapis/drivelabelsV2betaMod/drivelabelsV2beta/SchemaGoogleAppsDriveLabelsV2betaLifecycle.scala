...
trait SchemaGoogleAppsDriveLabelsV2betaLifecycle extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2betaLifecycle {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2betaLifecycle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2betaLifecycle]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2betaLifecycle](x: Self) {
