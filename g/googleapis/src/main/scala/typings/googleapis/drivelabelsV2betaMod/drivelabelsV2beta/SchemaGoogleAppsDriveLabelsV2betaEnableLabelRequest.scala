...
trait SchemaGoogleAppsDriveLabelsV2betaEnableLabelRequest extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2betaEnableLabelRequest {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2betaEnableLabelRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2betaEnableLabelRequest]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2betaEnableLabelRequest](x: Self) {
