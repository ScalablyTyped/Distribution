...
trait SchemaGoogleAppsDriveLabelsV2betaFieldDisplayHints extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2betaFieldDisplayHints {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2betaFieldDisplayHints = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2betaFieldDisplayHints]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2betaFieldDisplayHints](x: Self) {
