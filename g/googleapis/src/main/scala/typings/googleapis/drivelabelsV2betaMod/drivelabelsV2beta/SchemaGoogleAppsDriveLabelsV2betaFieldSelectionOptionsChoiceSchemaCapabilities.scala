...
trait SchemaGoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceSchemaCapabilities extends StObject {
...
object SchemaGoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceSchemaCapabilities {
  
  inline def apply(): SchemaGoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceSchemaCapabilities = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceSchemaCapabilities]
  }
  
  extension [Self <: SchemaGoogleAppsDriveLabelsV2betaFieldSelectionOptionsChoiceSchemaCapabilities](x: Self) {
