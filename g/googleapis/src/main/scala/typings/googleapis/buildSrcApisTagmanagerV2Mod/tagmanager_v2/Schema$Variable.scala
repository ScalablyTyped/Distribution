...
/**
  ...
  */
@js.native
trait Schema$Variable extends js.Object {
  /**
    * GTM Account ID.
    */
  ...
  /**
    ...
    */
  var formatValue: js.UndefOr[Schema$VariableFormatValue] = js.native
  /**
...
object Schema$Variable {
  ...
  def apply(
    ...
    formatValue: Schema$VariableFormatValue = null,
    name: String = null,
    notes: String = null,
    ...
    __obj.asInstanceOf[Schema$Variable]
  }
}
