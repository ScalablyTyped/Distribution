...
@js.native
trait ParamsDollarResourceDollarDeploymentsDollarUpdate extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDeploymentsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDeploymentsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDeploymentsDollarUpdate]
  }
}
