...
/**
  ...
  */
@js.native
trait Schema$LogConfigDataAccessOptions extends js.Object {
  /**
...
object Schema$LogConfigDataAccessOptions {
  @scala.inline
  def apply(logMode: String = null): Schema$LogConfigDataAccessOptions = {
    val __obj = js.Dynamic.literal()
    if (logMode != null) __obj.updateDynamic("logMode")(logMode.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$LogConfigDataAccessOptions]
  }
}
