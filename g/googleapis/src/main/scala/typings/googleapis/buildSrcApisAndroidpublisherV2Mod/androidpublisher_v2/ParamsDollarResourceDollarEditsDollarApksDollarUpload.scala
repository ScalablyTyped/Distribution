...
@js.native
trait ParamsDollarResourceDollarEditsDollarApksDollarUpload extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarApksDollarUpload {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarApksDollarUpload = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarApksDollarUpload]
  }
}
