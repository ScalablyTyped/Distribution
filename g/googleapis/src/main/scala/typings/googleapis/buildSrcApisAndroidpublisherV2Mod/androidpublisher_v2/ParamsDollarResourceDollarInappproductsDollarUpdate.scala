...
@js.native
trait ParamsDollarResourceDollarInappproductsDollarUpdate extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[Schema$InAppProduct] = js.native
  /**
...
object ParamsDollarResourceDollarInappproductsDollarUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: Schema$InAppProduct = null,
    sku: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarInappproductsDollarUpdate = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInappproductsDollarUpdate]
  }
}
