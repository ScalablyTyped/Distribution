...
@js.native
trait ParamsDollarResourceDollarEditsDollarApklistingsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarApklistingsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarApklistingsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarApklistingsDollarDelete]
  }
}
