...
@js.native
trait ParamsDollarResourceDollarEditsDollarApklistingsDollarDeleteall extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarEditsDollarApklistingsDollarDeleteall {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarEditsDollarApklistingsDollarDeleteall = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarEditsDollarApklistingsDollarDeleteall]
  }
}
