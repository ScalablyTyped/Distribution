...
@js.native
trait ParamsDollarResourceDollarInappproductsDollarPatch extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarInappproductsDollarPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    sku: String = null,
    userIp: String = null
  ): ParamsDollarResourceDollarInappproductsDollarPatch = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarInappproductsDollarPatch]
  }
}
