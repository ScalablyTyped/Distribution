...
@js.native
trait Schema$InAppProduct extends js.Object {
  /**
  ...
  /**
    ...
    */
  var listings: js.UndefOr[StringDictionary[Schema$InAppProductListing]] = js.native
  /**
  ...
  /**
    ...
    */
  var prices: js.UndefOr[StringDictionary[Schema$Price]] = js.native
  /**
  ...
  /**
    ...
    */
  var season: js.UndefOr[Schema$Season] = js.native
  /**
...
object Schema$InAppProduct {
  @scala.inline
  def apply(
    defaultLanguage: String = null,
    defaultPrice: Schema$Price = null,
    gracePeriod: String = null,
    listings: StringDictionary[Schema$InAppProductListing] = null,
    packageName: String = null,
    prices: StringDictionary[Schema$Price] = null,
    purchaseType: String = null,
    season: Schema$Season = null,
    sku: String = null,
    status: String = null,
    ...
    __obj.asInstanceOf[Schema$InAppProduct]
  }
}
