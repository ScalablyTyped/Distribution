...
object ParamsResourceProjectsUpdatebillinginfo {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsUpdatebillinginfoMutableBuilder[Self <: ParamsResourceProjectsUpdatebillinginfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaProjectBillingInfo): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
