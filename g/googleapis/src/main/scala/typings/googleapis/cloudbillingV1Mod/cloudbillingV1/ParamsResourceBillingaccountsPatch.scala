...
object ParamsResourceBillingaccountsPatch {
  ...
  @scala.inline
  def apply(): ParamsResourceBillingaccountsPatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsPatch]
  }
  
  @scala.inline
  implicit class ParamsResourceBillingaccountsPatchMutableBuilder[Self <: ParamsResourceBillingaccountsPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBillingAccount): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
