...
object ParamsResourceBillingaccountsPatch {
  ...
  @scala.inline
  implicit class ParamsResourceBillingaccountsPatchOps[Self <: ParamsResourceBillingaccountsPatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBillingAccount): Self = this.set("requestBody", value.asInstanceOf[js.Any])
