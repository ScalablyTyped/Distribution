...
trait ParamsResourceBillingaccountsGetiampolicy
  extends StObject
...
object ParamsResourceBillingaccountsGetiampolicy {
  ...
  inline def apply(): ParamsResourceBillingaccountsGetiampolicy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceBillingaccountsGetiampolicy]
  }
  
  extension [Self <: ParamsResourceBillingaccountsGetiampolicy](x: Self) {
