...
@js.native
trait ParamsResourceCustomersInsert extends StandardParameters {
...
object ParamsResourceCustomersInsert {
  ...
  @scala.inline
  implicit class ParamsResourceCustomersInsertOps[Self <: ParamsResourceCustomersInsert] (val x: Self) extends AnyVal {
