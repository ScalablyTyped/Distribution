...
@js.native
trait ParamsResourceSubscriptionsSuspend extends StandardParameters {
...
object ParamsResourceSubscriptionsSuspend {
  ...
  @scala.inline
  def apply(): ParamsResourceSubscriptionsSuspend = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSubscriptionsSuspend]
  }
  
  @scala.inline
  implicit class ParamsResourceSubscriptionsSuspendMutableBuilder[Self <: ParamsResourceSubscriptionsSuspend] (val x: Self) extends AnyVal {
