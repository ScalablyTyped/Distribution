...
trait ParamsResourceSubscriptionsChangerenewalsettings
  extends StObject
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaRenewalSettings] = js.undefined
...
object ParamsResourceSubscriptionsChangerenewalsettings {
  ...
  inline def apply(): ParamsResourceSubscriptionsChangerenewalsettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSubscriptionsChangerenewalsettings]
  }
  
  extension [Self <: ParamsResourceSubscriptionsChangerenewalsettings](x: Self) {
    ...
    inline def setRequestBody(value: SchemaRenewalSettings): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
