...
object ParamsResourceSubscriptionsActivate {
  ...
  @scala.inline
  def apply(): ParamsResourceSubscriptionsActivate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSubscriptionsActivate]
  }
  
  @scala.inline
  implicit class ParamsResourceSubscriptionsActivateMutableBuilder[Self <: ParamsResourceSubscriptionsActivate] (val x: Self) extends AnyVal {
