...
object ParamsResourceSubscriptionsChangeplan {
  ...
  @scala.inline
  implicit class ParamsResourceSubscriptionsChangeplanOps[Self <: ParamsResourceSubscriptionsChangeplan] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaChangePlanRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
