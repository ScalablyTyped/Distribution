...
trait ParamsResourceSubscriptionsChangeplan
  extends StObject
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaChangePlanRequest] = js.undefined
...
object ParamsResourceSubscriptionsChangeplan {
  ...
  inline def apply(): ParamsResourceSubscriptionsChangeplan = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceSubscriptionsChangeplan]
  }
  
  extension [Self <: ParamsResourceSubscriptionsChangeplan](x: Self) {
    
    inline def setCustomerId(value: String): Self = StObject.set(x, "customerId", value.asInstanceOf[js.Any])
    
    inline def setCustomerIdUndefined: Self = StObject.set(x, "customerId", js.undefined)
    
    inline def setRequestBody(value: SchemaChangePlanRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
