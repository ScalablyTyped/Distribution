...
@js.native
trait FnOptionsV1V1beta1V2 extends js.Object {
  ...
  def apply(options: typings.googleapis.cloudresourcemanagerV2beta1Mod.cloudresourcemanagerV2beta1.Options): typings.googleapis.cloudresourcemanagerV2beta1Mod.cloudresourcemanagerV2beta1.Cloudresourcemanager = js.native
  def apply(version: v1): Cloudresourcemanager = js.native
  def apply(version: v1beta1): typings.googleapis.cloudresourcemanagerV1beta1Mod.cloudresourcemanagerV1beta1.Cloudresourcemanager = js.native
