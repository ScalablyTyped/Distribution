...
@js.native
trait Anon_CanAddChildrenCanChangeCopyRequiresWriterPermission extends js.Object {
...
object Anon_CanAddChildrenCanChangeCopyRequiresWriterPermission {
  @scala.inline
  def apply(
  ...
  ): Anon_CanAddChildrenCanChangeCopyRequiresWriterPermission = {
    ...
    __obj.asInstanceOf[Anon_CanAddChildrenCanChangeCopyRequiresWriterPermission]
  }
}
