...
@js.native
trait ParamsDollarResourceDollarDeploymentsDollarDelete extends StandardParameters {
  /**
...
object ParamsDollarResourceDollarDeploymentsDollarDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarDeploymentsDollarDelete = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarDeploymentsDollarDelete]
  }
}
