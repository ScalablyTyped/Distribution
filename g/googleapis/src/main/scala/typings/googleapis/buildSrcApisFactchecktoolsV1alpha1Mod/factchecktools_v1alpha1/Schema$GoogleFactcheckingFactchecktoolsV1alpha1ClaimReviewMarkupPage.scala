...
/**
  ...
  */
@js.native
trait Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage extends js.Object {
  /**
    ...
    */
  var claimReviewAuthor: js.UndefOr[Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewAuthor] = js.native
  /**
    * A list of individual claim reviews for this page. Each item in the list
    * corresponds to one `ClaimReview` element.
    */
  var claimReviewMarkups: js.UndefOr[js.Array[Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkup]] = js.native
  /**
...
object Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage {
  @scala.inline
  def apply(
    claimReviewAuthor: Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewAuthor = null,
    claimReviewMarkups: js.Array[Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkup] = null,
    name: String = null,
    pageUrl: String = null,
    ...
    __obj.asInstanceOf[Schema$GoogleFactcheckingFactchecktoolsV1alpha1ClaimReviewMarkupPage]
  }
}
