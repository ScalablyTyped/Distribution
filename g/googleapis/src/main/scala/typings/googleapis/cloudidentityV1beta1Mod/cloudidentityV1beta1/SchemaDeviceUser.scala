...
trait SchemaDeviceUser extends StObject {
...
object SchemaDeviceUser {
  
  inline def apply(): SchemaDeviceUser = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaDeviceUser]
  }
  
  extension [Self <: SchemaDeviceUser](x: Self) {
