...
trait ParamsResourceDevicesDeviceusersGet
  extends StObject
...
object ParamsResourceDevicesDeviceusersGet {
  
  inline def apply(): ParamsResourceDevicesDeviceusersGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceDevicesDeviceusersGet]
  }
  
  extension [Self <: ParamsResourceDevicesDeviceusersGet](x: Self) {
