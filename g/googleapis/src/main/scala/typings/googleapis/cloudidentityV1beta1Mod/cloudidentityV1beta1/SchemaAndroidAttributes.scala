...
trait SchemaAndroidAttributes extends StObject {
...
object SchemaAndroidAttributes {
  
  inline def apply(): SchemaAndroidAttributes = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaAndroidAttributes]
  }
  
  extension [Self <: SchemaAndroidAttributes](x: Self) {
