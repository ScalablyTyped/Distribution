...
trait SchemaGoogleAppsCloudidentityDevicesV1ClientState extends StObject {
  ...
  var keyValuePairs: js.UndefOr[
    StringDictionary[SchemaGoogleAppsCloudidentityDevicesV1CustomAttributeValue] | Null
  ] = js.undefined
...
object SchemaGoogleAppsCloudidentityDevicesV1ClientState {
  
  inline def apply(): SchemaGoogleAppsCloudidentityDevicesV1ClientState = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleAppsCloudidentityDevicesV1ClientState]
  }
  
  extension [Self <: SchemaGoogleAppsCloudidentityDevicesV1ClientState](x: Self) {
    ...
    inline def setKeyValuePairs(value: StringDictionary[SchemaGoogleAppsCloudidentityDevicesV1CustomAttributeValue]): Self = StObject.set(x, "keyValuePairs", value.asInstanceOf[js.Any])
