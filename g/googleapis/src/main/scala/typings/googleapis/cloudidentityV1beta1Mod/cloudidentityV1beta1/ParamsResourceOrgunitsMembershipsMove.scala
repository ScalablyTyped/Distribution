...
trait ParamsResourceOrgunitsMembershipsMove
  extends StObject
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaMoveOrgMembershipRequest] = js.undefined
}
object ParamsResourceOrgunitsMembershipsMove {
  
  inline def apply(): ParamsResourceOrgunitsMembershipsMove = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceOrgunitsMembershipsMove]
  }
  
  extension [Self <: ParamsResourceOrgunitsMembershipsMove](x: Self) {
    
    inline def setName(value: String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    
    inline def setNameUndefined: Self = StObject.set(x, "name", js.undefined)
    
    inline def setRequestBody(value: SchemaMoveOrgMembershipRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
