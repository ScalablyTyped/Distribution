...
trait SchemaWipeDeviceResponse extends StObject {
...
object SchemaWipeDeviceResponse {
  
  inline def apply(): SchemaWipeDeviceResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaWipeDeviceResponse]
  }
  
  extension [Self <: SchemaWipeDeviceResponse](x: Self) {
