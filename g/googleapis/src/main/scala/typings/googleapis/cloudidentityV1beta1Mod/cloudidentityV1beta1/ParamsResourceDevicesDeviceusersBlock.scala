...
trait ParamsResourceDevicesDeviceusersBlock
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaBlockDeviceUserRequest] = js.undefined
}
object ParamsResourceDevicesDeviceusersBlock {
  ...
  extension [Self <: ParamsResourceDevicesDeviceusersBlock](x: Self) {
    ...
    inline def setRequestBody(value: SchemaBlockDeviceUserRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
