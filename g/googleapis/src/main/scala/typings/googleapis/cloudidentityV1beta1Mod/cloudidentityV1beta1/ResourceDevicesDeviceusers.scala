...
@JSImport("googleapis/build/src/apis/cloudidentity/v1beta1", "cloudidentity_v1beta1.Resource$Devices$Deviceusers")
@js.native
open class ResourceDevicesDeviceusers protected () extends StObject {
  ...
  def get(): GaxiosPromise[SchemaDeviceUser] = js.native
  def get(callback: BodyResponseCallback[SchemaDeviceUser]): Unit = js.native
  def get(params: Unit, options: MethodOptions): GaxiosPromise[SchemaDeviceUser] = js.native
  def get(params: ParamsResourceDevicesDeviceusersGet): GaxiosPromise[SchemaDeviceUser] = js.native
  def get(params: ParamsResourceDevicesDeviceusersGet, callback: BodyResponseCallback[SchemaDeviceUser]): Unit = js.native
  def get(
    params: ParamsResourceDevicesDeviceusersGet,
    options: BodyResponseCallback[Readable | SchemaDeviceUser],
    callback: BodyResponseCallback[Readable | SchemaDeviceUser]
  ): Unit = js.native
  def get(params: ParamsResourceDevicesDeviceusersGet, options: MethodOptions): GaxiosPromise[SchemaDeviceUser] = js.native
  def get(
    params: ParamsResourceDevicesDeviceusersGet,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaDeviceUser]
  ): Unit = js.native
  /**
  ...
  def list(): GaxiosPromise[SchemaListDeviceUsersResponse] = js.native
  def list(callback: BodyResponseCallback[SchemaListDeviceUsersResponse]): Unit = js.native
  def list(params: Unit, options: MethodOptions): GaxiosPromise[SchemaListDeviceUsersResponse] = js.native
  def list(params: ParamsResourceDevicesDeviceusersList): GaxiosPromise[SchemaListDeviceUsersResponse] = js.native
  def list(
    params: ParamsResourceDevicesDeviceusersList,
    callback: BodyResponseCallback[SchemaListDeviceUsersResponse]
  ): Unit = js.native
  def list(
    params: ParamsResourceDevicesDeviceusersList,
    options: BodyResponseCallback[Readable | SchemaListDeviceUsersResponse],
    callback: BodyResponseCallback[Readable | SchemaListDeviceUsersResponse]
  ): Unit = js.native
  def list(params: ParamsResourceDevicesDeviceusersList, options: MethodOptions): GaxiosPromise[SchemaListDeviceUsersResponse] = js.native
  def list(
    params: ParamsResourceDevicesDeviceusersList,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaListDeviceUsersResponse]
  ...
  def lookup(): GaxiosPromise[SchemaLookupSelfDeviceUsersResponse] = js.native
  def lookup(callback: BodyResponseCallback[SchemaLookupSelfDeviceUsersResponse]): Unit = js.native
  def lookup(params: Unit, options: MethodOptions): GaxiosPromise[SchemaLookupSelfDeviceUsersResponse] = js.native
  def lookup(params: ParamsResourceDevicesDeviceusersLookup): GaxiosPromise[SchemaLookupSelfDeviceUsersResponse] = js.native
  def lookup(
    params: ParamsResourceDevicesDeviceusersLookup,
    callback: BodyResponseCallback[SchemaLookupSelfDeviceUsersResponse]
  ): Unit = js.native
  def lookup(
    params: ParamsResourceDevicesDeviceusersLookup,
    options: BodyResponseCallback[Readable | SchemaLookupSelfDeviceUsersResponse],
    callback: BodyResponseCallback[Readable | SchemaLookupSelfDeviceUsersResponse]
  ): Unit = js.native
  def lookup(params: ParamsResourceDevicesDeviceusersLookup, options: MethodOptions): GaxiosPromise[SchemaLookupSelfDeviceUsersResponse] = js.native
  def lookup(
    params: ParamsResourceDevicesDeviceusersLookup,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaLookupSelfDeviceUsersResponse]
