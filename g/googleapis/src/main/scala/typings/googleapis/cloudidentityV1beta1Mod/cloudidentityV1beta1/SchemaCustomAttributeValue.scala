...
trait SchemaCustomAttributeValue extends StObject {
...
object SchemaCustomAttributeValue {
  
  inline def apply(): SchemaCustomAttributeValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaCustomAttributeValue]
  }
  
  extension [Self <: SchemaCustomAttributeValue](x: Self) {
