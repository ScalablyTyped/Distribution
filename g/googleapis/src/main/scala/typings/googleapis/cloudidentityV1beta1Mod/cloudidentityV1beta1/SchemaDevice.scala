...
trait SchemaDevice extends StObject {
  ...
  /**
    ...
    */
  var androidSpecificAttributes: js.UndefOr[SchemaAndroidAttributes] = js.undefined
  ...
  /**
    ...
    */
  var endpointVerificationSpecificAttributes: js.UndefOr[SchemaEndpointVerificationSpecificAttributes] = js.undefined
...
object SchemaDevice {
  ...
  extension [Self <: SchemaDevice](x: Self) {
    ...
    inline def setAndroidSpecificAttributes(value: SchemaAndroidAttributes): Self = StObject.set(x, "androidSpecificAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setEndpointVerificationSpecificAttributes(value: SchemaEndpointVerificationSpecificAttributes): Self = StObject.set(x, "endpointVerificationSpecificAttributes", value.asInstanceOf[js.Any])
    
    inline def setEndpointVerificationSpecificAttributesUndefined: Self = StObject.set(x, "endpointVerificationSpecificAttributes", js.undefined)
