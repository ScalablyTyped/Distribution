...
object ParamsResourceGroupsMembershipsLookup {
  ...
  def apply(
    ...
    fields: String = null,
    key: String = null,
    memberKeyDotid: String = null,
    memberKeyDotnamespace: String = null,
  ...
  ): ParamsResourceGroupsMembershipsLookup = {
    ...
    if (memberKeyDotid != null) __obj.updateDynamic("memberKey.id")(memberKeyDotid.asInstanceOf[js.Any])
    if (memberKeyDotnamespace != null) __obj.updateDynamic("memberKey.namespace")(memberKeyDotnamespace.asInstanceOf[js.Any])
