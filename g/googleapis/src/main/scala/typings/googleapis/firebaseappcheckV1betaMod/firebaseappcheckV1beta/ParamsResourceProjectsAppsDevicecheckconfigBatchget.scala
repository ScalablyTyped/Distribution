...
trait ParamsResourceProjectsAppsDevicecheckconfigBatchget
  extends StObject
...
object ParamsResourceProjectsAppsDevicecheckconfigBatchget {
  
  inline def apply(): ParamsResourceProjectsAppsDevicecheckconfigBatchget = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsAppsDevicecheckconfigBatchget]
  }
  
  extension [Self <: ParamsResourceProjectsAppsDevicecheckconfigBatchget](x: Self) {
