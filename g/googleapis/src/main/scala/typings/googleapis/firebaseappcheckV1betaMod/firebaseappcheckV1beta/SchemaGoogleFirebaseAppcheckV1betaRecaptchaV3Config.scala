...
trait SchemaGoogleFirebaseAppcheckV1betaRecaptchaV3Config extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1betaRecaptchaV3Config {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1betaRecaptchaV3Config = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1betaRecaptchaV3Config]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1betaRecaptchaV3Config](x: Self) {
