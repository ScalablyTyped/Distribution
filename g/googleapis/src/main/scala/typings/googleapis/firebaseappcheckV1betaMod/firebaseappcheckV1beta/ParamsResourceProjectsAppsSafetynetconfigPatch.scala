...
trait ParamsResourceProjectsAppsSafetynetconfigPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleFirebaseAppcheckV1betaSafetyNetConfig] = js.undefined
...
object ParamsResourceProjectsAppsSafetynetconfigPatch {
  ...
  extension [Self <: ParamsResourceProjectsAppsSafetynetconfigPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleFirebaseAppcheckV1betaSafetyNetConfig): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
