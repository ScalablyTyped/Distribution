...
trait ParamsResourceProjectsAppsAppattestconfigPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleFirebaseAppcheckV1betaAppAttestConfig] = js.undefined
...
object ParamsResourceProjectsAppsAppattestconfigPatch {
  ...
  extension [Self <: ParamsResourceProjectsAppsAppattestconfigPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleFirebaseAppcheckV1betaAppAttestConfig): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
