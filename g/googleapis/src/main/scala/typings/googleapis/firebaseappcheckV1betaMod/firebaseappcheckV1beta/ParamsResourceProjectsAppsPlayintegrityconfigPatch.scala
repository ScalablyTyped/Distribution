...
trait ParamsResourceProjectsAppsPlayintegrityconfigPatch
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleFirebaseAppcheckV1betaPlayIntegrityConfig] = js.undefined
...
object ParamsResourceProjectsAppsPlayintegrityconfigPatch {
  ...
  extension [Self <: ParamsResourceProjectsAppsPlayintegrityconfigPatch](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleFirebaseAppcheckV1betaPlayIntegrityConfig): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
