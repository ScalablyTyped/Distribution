...
trait SchemaGoogleFirebaseAppcheckV1betaExchangeRecaptchaV3TokenRequest extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1betaExchangeRecaptchaV3TokenRequest {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1betaExchangeRecaptchaV3TokenRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1betaExchangeRecaptchaV3TokenRequest]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1betaExchangeRecaptchaV3TokenRequest](x: Self) {
