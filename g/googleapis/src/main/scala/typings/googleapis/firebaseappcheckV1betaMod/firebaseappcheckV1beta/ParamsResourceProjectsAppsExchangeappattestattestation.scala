...
trait ParamsResourceProjectsAppsExchangeappattestattestation
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGoogleFirebaseAppcheckV1betaExchangeAppAttestAttestationRequest] = js.undefined
}
object ParamsResourceProjectsAppsExchangeappattestattestation {
  ...
  extension [Self <: ParamsResourceProjectsAppsExchangeappattestattestation](x: Self) {
    ...
    inline def setRequestBody(value: SchemaGoogleFirebaseAppcheckV1betaExchangeAppAttestAttestationRequest): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
