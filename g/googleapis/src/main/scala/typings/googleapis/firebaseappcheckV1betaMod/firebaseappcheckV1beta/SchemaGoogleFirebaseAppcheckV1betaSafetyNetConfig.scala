...
trait SchemaGoogleFirebaseAppcheckV1betaSafetyNetConfig extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1betaSafetyNetConfig {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1betaSafetyNetConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1betaSafetyNetConfig]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1betaSafetyNetConfig](x: Self) {
