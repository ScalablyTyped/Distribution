...
trait SchemaGoogleFirebaseAppcheckV1betaAppAttestConfig extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1betaAppAttestConfig {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1betaAppAttestConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1betaAppAttestConfig]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1betaAppAttestConfig](x: Self) {
