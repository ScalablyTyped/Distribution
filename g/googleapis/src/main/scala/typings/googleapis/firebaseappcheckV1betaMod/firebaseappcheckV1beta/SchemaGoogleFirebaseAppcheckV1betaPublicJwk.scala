...
trait SchemaGoogleFirebaseAppcheckV1betaPublicJwk extends StObject {
...
object SchemaGoogleFirebaseAppcheckV1betaPublicJwk {
  
  inline def apply(): SchemaGoogleFirebaseAppcheckV1betaPublicJwk = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleFirebaseAppcheckV1betaPublicJwk]
  }
  
  extension [Self <: SchemaGoogleFirebaseAppcheckV1betaPublicJwk](x: Self) {
