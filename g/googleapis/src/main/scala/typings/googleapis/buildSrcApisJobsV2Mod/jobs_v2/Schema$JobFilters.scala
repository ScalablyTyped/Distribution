...
/**
  ...
  */
@js.native
trait Schema$JobFilters extends js.Object {
  /**
  ...
  /**
    ...
    */
  var customFieldFilters: js.UndefOr[StringDictionary[Schema$CustomFieldFilter]] = js.native
  /**
  ...
  /**
    ...
    */
  var extendedCompensationFilter: js.UndefOr[Schema$ExtendedCompensationFilter] = js.native
  /**
...
object Schema$JobFilters {
  ...
  def apply(
    ...
    customFieldFilters: StringDictionary[Schema$CustomFieldFilter] = null,
    disableSpellCheck: js.UndefOr[Boolean] = js.undefined,
    employmentTypes: js.Array[String] = null,
    extendedCompensationFilter: Schema$ExtendedCompensationFilter = null,
    ...
    __obj.asInstanceOf[Schema$JobFilters]
  }
}
