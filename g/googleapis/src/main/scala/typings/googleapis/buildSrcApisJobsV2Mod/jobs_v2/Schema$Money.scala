...
/**
  ...
  */
@js.native
trait Schema$Money extends js.Object {
  /**
...
object Schema$Money {
  @scala.inline
  def apply(currencyCode: String = null, nanos: Int | Double = null, units: String = null): Schema$Money = {
    val __obj = js.Dynamic.literal()
    if (currencyCode != null) __obj.updateDynamic("currencyCode")(currencyCode.asInstanceOf[js.Any])
    if (nanos != null) __obj.updateDynamic("nanos")(nanos.asInstanceOf[js.Any])
    if (units != null) __obj.updateDynamic("units")(units.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$Money]
  }
}
