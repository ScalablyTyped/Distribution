...
/**
  ...
  */
@js.native
trait Schema$NumericBucketingOption extends js.Object {
  /**
...
object Schema$NumericBucketingOption {
  @scala.inline
  def apply(bucketBounds: js.Array[Double] = null, requiresMinMax: js.UndefOr[Boolean] = js.undefined): Schema$NumericBucketingOption = {
    ...
    __obj.asInstanceOf[Schema$NumericBucketingOption]
  }
}
