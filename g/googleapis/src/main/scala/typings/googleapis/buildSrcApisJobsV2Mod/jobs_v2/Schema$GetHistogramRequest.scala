...
/**
  ...
  */
@js.native
trait Schema$GetHistogramRequest extends js.Object {
  /**
  ...
  /**
    ...
    * the histogram.
    */
  var filters: js.UndefOr[Schema$JobFilters] = js.native
  /**
    * Optional.  Query used to search against jobs, such as keyword, location
    * filters, etc.
    */
  var query: js.UndefOr[Schema$JobQuery] = js.native
  /**
...
object Schema$GetHistogramRequest {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$GetHistogramRequest]
  }
}
