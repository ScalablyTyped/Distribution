...
/**
  ...
  */
@js.native
trait Schema$JobProcessingOptions extends js.Object {
  /**
...
object Schema$JobProcessingOptions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Schema$JobProcessingOptions]
  }
}
