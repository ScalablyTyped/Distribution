...
object ParamsDollarResourceDollarOperationsDollarList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsDollarResourceDollarOperationsDollarList = {
    ...
    __obj.asInstanceOf[ParamsDollarResourceDollarOperationsDollarList]
  }
}
