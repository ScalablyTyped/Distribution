...
object SchemaPresentation {
  ...
  extension [Self <: SchemaPresentation](x: Self) {
    ...
    inline def setLayoutsVarargs(value: SchemaPage*): Self = StObject.set(x, "layouts", js.Array(value*))
    ...
    inline def setMastersVarargs(value: SchemaPage*): Self = StObject.set(x, "masters", js.Array(value*))
    ...
    inline def setSlidesVarargs(value: SchemaPage*): Self = StObject.set(x, "slides", js.Array(value*))
