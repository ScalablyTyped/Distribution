...
object ParamsResourcePresentationsBatchupdate {
  ...
  @scala.inline
  implicit class ParamsResourcePresentationsBatchupdateOps[Self <: ParamsResourcePresentationsBatchupdate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaBatchUpdatePresentationRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
