...
trait SchemaTextStyle extends StObject {
  ...
  /**
    ...
    */
  var baselineOffset: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var smallCaps: js.UndefOr[Boolean | Null] = js.undefined
...
object SchemaTextStyle {
  ...
  extension [Self <: SchemaTextStyle](x: Self) {
    ...
    inline def setBaselineOffsetNull: Self = StObject.set(x, "baselineOffset", null)
    ...
    inline def setSmallCapsNull: Self = StObject.set(x, "smallCaps", null)
