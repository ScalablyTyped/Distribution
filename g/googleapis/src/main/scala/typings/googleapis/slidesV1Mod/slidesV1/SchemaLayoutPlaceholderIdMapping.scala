...
trait SchemaLayoutPlaceholderIdMapping extends StObject {
  ...
  /**
    ...
    */
  var layoutPlaceholderObjectId: js.UndefOr[String | Null] = js.undefined
...
object SchemaLayoutPlaceholderIdMapping {
  ...
  extension [Self <: SchemaLayoutPlaceholderIdMapping](x: Self) {
    ...
    inline def setLayoutPlaceholderObjectIdNull: Self = StObject.set(x, "layoutPlaceholderObjectId", null)
