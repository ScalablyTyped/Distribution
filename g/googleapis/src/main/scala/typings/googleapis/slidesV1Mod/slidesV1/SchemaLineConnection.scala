...
trait SchemaLineConnection extends StObject {
  ...
  /**
    ...
    */
  var connectedObjectId: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var connectionSiteIndex: js.UndefOr[Double | Null] = js.undefined
}
object SchemaLineConnection {
  ...
  extension [Self <: SchemaLineConnection](x: Self) {
    ...
    inline def setConnectedObjectIdNull: Self = StObject.set(x, "connectedObjectId", null)
    ...
    inline def setConnectionSiteIndexNull: Self = StObject.set(x, "connectionSiteIndex", null)
