...
trait SchemaLineProperties extends StObject {
  ...
  /**
    ...
    */
  var endArrow: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    */
  var startArrow: js.UndefOr[String | Null] = js.undefined
...
object SchemaLineProperties {
  ...
  extension [Self <: SchemaLineProperties](x: Self) {
    ...
    inline def setEndArrowNull: Self = StObject.set(x, "endArrow", null)
    ...
    inline def setStartArrowNull: Self = StObject.set(x, "startArrow", null)
