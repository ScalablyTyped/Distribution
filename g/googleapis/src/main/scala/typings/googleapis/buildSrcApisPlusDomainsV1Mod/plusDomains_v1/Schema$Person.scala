...
import typings.googleapis.Anon_CoverInfo
import typings.googleapis.Anon_Department
import typings.googleapis.Anon_FamilyNameFormatted
import typings.googleapis.Anon_IsDefault
import typings.googleapis.Anon_LabelType
import typings.googleapis.Anon_Primary
...
trait Schema$Person extends js.Object {
  ...
  /**
    ...
    */
  var cover: js.UndefOr[Anon_CoverInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var emails: js.UndefOr[js.Array[Anon_TypeValue]] = js.native
  /**
  ...
  /**
    ...
    */
  var image: js.UndefOr[Anon_IsDefault] = js.native
  /**
  ...
  /**
    ...
    * name.
    */
  var name: js.UndefOr[Anon_FamilyNameFormatted] = js.native
  /**
  ...
  /**
    ...
    * associated.
    */
  var organizations: js.UndefOr[js.Array[Anon_Department]] = js.native
  /**
    * A list of places where this person has lived.
    */
  var placesLived: js.UndefOr[js.Array[Anon_Primary]] = js.native
  /**
  ...
  /**
    ...
    */
  var urls: js.UndefOr[js.Array[Anon_LabelType]] = js.native
  /**
...
object Schema$Person {
  ...
  def apply(
    ...
    tagline: String = null,
    url: String = null,
    urls: js.Array[Anon_LabelType] = null,
