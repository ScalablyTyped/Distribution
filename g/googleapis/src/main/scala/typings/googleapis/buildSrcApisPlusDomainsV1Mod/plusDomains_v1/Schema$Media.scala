...
import typings.googleapis.Anon_Time
...
trait Schema$Media extends js.Object {
  ...
  /**
    ...
    */
  var exif: js.UndefOr[Anon_Time] = js.native
  /**
  ...
  /**
    ...
    * various sizes
    */
  var streams: js.UndefOr[js.Array[Schema$Videostream]] = js.native
  /**
...
object Schema$Media {
  ...
  def apply(
    ...
    streams: js.Array[Schema$Videostream] = null,
    summary: String = null,
    updated: String = null,
    url: String = null,
