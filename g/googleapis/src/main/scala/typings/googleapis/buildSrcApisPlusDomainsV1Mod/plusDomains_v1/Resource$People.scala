...
class Resource$People protected () extends js.Object {
  ...
  /**
    ...
    * @return {object} Request object
    */
  def listByCircle(): GaxiosPromise[Schema$PeopleFeed] = js.native
  def listByCircle(callback: BodyResponseCallback[Schema$PeopleFeed]): Unit = js.native
  def listByCircle(params: ParamsDollarResourceDollarPeopleDollarListbycircle): GaxiosPromise[Schema$PeopleFeed] = js.native
  def listByCircle(
    params: ParamsDollarResourceDollarPeopleDollarListbycircle,
    callback: BodyResponseCallback[Schema$PeopleFeed]
  ): Unit = js.native
  def listByCircle(
    params: ParamsDollarResourceDollarPeopleDollarListbycircle,
  ...
  def listByCircle(params: ParamsDollarResourceDollarPeopleDollarListbycircle, options: MethodOptions): GaxiosPromise[Schema$PeopleFeed] = js.native
  def listByCircle(
    params: ParamsDollarResourceDollarPeopleDollarListbycircle,
    options: MethodOptions,
    callback: BodyResponseCallback[Schema$PeopleFeed]
