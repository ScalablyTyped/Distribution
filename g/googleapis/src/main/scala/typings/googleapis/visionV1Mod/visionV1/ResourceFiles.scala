...
open class ResourceFiles protected () extends StObject {
  ...
  def annotate(params: ParamsResourceFilesAnnotate): GaxiosPromise[SchemaBatchAnnotateFilesResponse] = js.native
  def annotate(
  ...
  def annotate(params: ParamsResourceFilesAnnotate, options: MethodOptions): GaxiosPromise[SchemaBatchAnnotateFilesResponse] = js.native
  def annotate(
    params: ParamsResourceFilesAnnotate,
