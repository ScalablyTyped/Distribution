...
object SchemaGoogleCloudVisionV1p3beta1InputConfig {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p3beta1InputConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p3beta1InputConfig]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p3beta1InputConfig](x: Self) {
    ...
    inline def setGcsSource(value: SchemaGoogleCloudVisionV1p3beta1GcsSource): Self = StObject.set(x, "gcsSource", value.asInstanceOf[js.Any])
