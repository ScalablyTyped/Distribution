...
object SchemaGoogleCloudVisionV1p1beta1WebDetectionWebLabel {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1WebDetectionWebLabelOps[Self <: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebLabel] (val x: Self) extends AnyVal {
