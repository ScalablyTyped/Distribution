...
object SchemaGoogleCloudVisionV1p3beta1WebDetectionWebImage {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1WebDetectionWebImageOps[Self <: SchemaGoogleCloudVisionV1p3beta1WebDetectionWebImage] (val x: Self) extends AnyVal {
