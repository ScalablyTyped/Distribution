...
trait SchemaGoogleCloudVisionV1p4beta1FaceAnnotation extends StObject {
  ...
  /**
    ...
    */
  var fdBoundingPoly: js.UndefOr[SchemaGoogleCloudVisionV1p4beta1BoundingPoly] = js.undefined
  ...
  /**
    ...
    */
  var landmarks: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p4beta1FaceAnnotationLandmark]] = js.undefined
  ...
  /**
    ...
    */
  var recognitionResult: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p4beta1FaceRecognitionResult]] = js.undefined
...
object SchemaGoogleCloudVisionV1p4beta1FaceAnnotation {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p4beta1FaceAnnotation](x: Self) {
    ...
    inline def setLandmarksVarargs(value: SchemaGoogleCloudVisionV1p4beta1FaceAnnotationLandmark*): Self = StObject.set(x, "landmarks", js.Array(value*))
    ...
    inline def setRecognitionResult(value: js.Array[SchemaGoogleCloudVisionV1p4beta1FaceRecognitionResult]): Self = StObject.set(x, "recognitionResult", value.asInstanceOf[js.Any])
    
    inline def setRecognitionResultUndefined: Self = StObject.set(x, "recognitionResult", js.undefined)
    
    inline def setRecognitionResultVarargs(value: SchemaGoogleCloudVisionV1p4beta1FaceRecognitionResult*): Self = StObject.set(x, "recognitionResult", js.Array(value*))
