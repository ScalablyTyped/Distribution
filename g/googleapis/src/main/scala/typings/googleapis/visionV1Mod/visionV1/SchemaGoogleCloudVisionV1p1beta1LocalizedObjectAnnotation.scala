...
object SchemaGoogleCloudVisionV1p1beta1LocalizedObjectAnnotation {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p1beta1LocalizedObjectAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1LocalizedObjectAnnotation]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p1beta1LocalizedObjectAnnotation](x: Self) {
