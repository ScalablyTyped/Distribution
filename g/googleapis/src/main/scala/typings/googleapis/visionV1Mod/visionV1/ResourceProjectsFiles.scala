...
@JSImport("googleapis/build/src/apis/vision/v1", "vision_v1.Resource$Projects$Files")
@js.native
open class ResourceProjectsFiles protected () extends StObject {
  ...
  def annotate(params: ParamsResourceProjectsFilesAnnotate): GaxiosPromise[SchemaBatchAnnotateFilesResponse] = js.native
  def annotate(
  ...
  def annotate(params: ParamsResourceProjectsFilesAnnotate, options: MethodOptions): GaxiosPromise[SchemaBatchAnnotateFilesResponse] = js.native
  def annotate(
    params: ParamsResourceProjectsFilesAnnotate,
