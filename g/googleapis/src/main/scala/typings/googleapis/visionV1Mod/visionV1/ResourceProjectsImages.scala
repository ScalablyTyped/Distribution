...
@JSImport("googleapis/build/src/apis/vision/v1", "vision_v1.Resource$Projects$Images")
@js.native
open class ResourceProjectsImages protected () extends StObject {
  ...
  def annotate(params: ParamsResourceProjectsImagesAnnotate): GaxiosPromise[SchemaBatchAnnotateImagesResponse] = js.native
  def annotate(
  ...
  def annotate(params: ParamsResourceProjectsImagesAnnotate, options: MethodOptions): GaxiosPromise[SchemaBatchAnnotateImagesResponse] = js.native
  def annotate(
    params: ParamsResourceProjectsImagesAnnotate,
