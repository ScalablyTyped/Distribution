...
object SchemaGoogleCloudVisionV1p4beta1BoundingPoly {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p4beta1BoundingPoly](x: Self) {
    ...
    inline def setNormalizedVerticesVarargs(value: SchemaGoogleCloudVisionV1p4beta1NormalizedVertex*): Self = StObject.set(x, "normalizedVertices", js.Array(value*))
    ...
    inline def setVerticesVarargs(value: SchemaGoogleCloudVisionV1p4beta1Vertex*): Self = StObject.set(x, "vertices", js.Array(value*))
  }
}
