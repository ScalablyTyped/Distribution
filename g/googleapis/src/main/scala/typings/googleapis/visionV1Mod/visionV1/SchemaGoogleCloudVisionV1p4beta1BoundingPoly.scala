...
object SchemaGoogleCloudVisionV1p4beta1BoundingPoly {
  @scala.inline
  def apply(
    normalizedVertices: js.Array[SchemaGoogleCloudVisionV1p4beta1NormalizedVertex] = null,
    vertices: js.Array[SchemaGoogleCloudVisionV1p4beta1Vertex] = null
  ): SchemaGoogleCloudVisionV1p4beta1BoundingPoly = {
