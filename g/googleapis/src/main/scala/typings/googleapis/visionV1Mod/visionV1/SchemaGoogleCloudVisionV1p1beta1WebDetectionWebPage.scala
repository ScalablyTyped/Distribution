...
object SchemaGoogleCloudVisionV1p1beta1WebDetectionWebPage {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1WebDetectionWebPageMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1WebDetectionWebPage] (val x: Self) extends AnyVal {
