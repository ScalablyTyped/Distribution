...
object SchemaGoogleCloudVisionV1p3beta1ProductSearchResults {
  ...
  def apply(
    ...
    productGroupedResults: js.Array[SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsGroupedResult] = null,
    results: js.Array[SchemaGoogleCloudVisionV1p3beta1ProductSearchResultsResult] = null
  ): SchemaGoogleCloudVisionV1p3beta1ProductSearchResults = {
