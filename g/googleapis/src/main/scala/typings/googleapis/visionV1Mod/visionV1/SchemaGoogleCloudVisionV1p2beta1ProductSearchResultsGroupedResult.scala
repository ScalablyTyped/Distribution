...
object SchemaGoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult {
  ...
  implicit class SchemaGoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResultOps[Self <: SchemaGoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResultsVarargs(value: SchemaGoogleCloudVisionV1p2beta1ProductSearchResultsResult*): Self = this.set("results", js.Array(value :_*))
    @scala.inline
    def setResults(value: js.Array[SchemaGoogleCloudVisionV1p2beta1ProductSearchResultsResult]): Self = this.set("results", value.asInstanceOf[js.Any])
    @scala.inline
