...
object ParamsResourceProjectsLocationsProductsetsGet {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsProductsetsGet = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsProductsetsGet]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsProductsetsGetMutableBuilder[Self <: ParamsResourceProjectsLocationsProductsetsGet] (val x: Self) extends AnyVal {
