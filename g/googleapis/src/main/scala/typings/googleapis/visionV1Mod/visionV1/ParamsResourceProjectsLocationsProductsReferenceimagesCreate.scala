...
object ParamsResourceProjectsLocationsProductsReferenceimagesCreate {
  ...
  def apply(
    ...
    requestBody: SchemaReferenceImage = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceProjectsLocationsProductsReferenceimagesCreate = {
    ...
    if (referenceImageId != null) __obj.updateDynamic("referenceImageId")(referenceImageId.asInstanceOf[js.Any])
