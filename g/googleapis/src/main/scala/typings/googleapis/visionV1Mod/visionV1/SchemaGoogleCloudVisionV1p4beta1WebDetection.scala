...
object SchemaGoogleCloudVisionV1p4beta1WebDetection {
  ...
  extension [Self <: SchemaGoogleCloudVisionV1p4beta1WebDetection](x: Self) {
    ...
    inline def setBestGuessLabelsVarargs(value: SchemaGoogleCloudVisionV1p4beta1WebDetectionWebLabel*): Self = StObject.set(x, "bestGuessLabels", js.Array(value :_*))
    ...
    inline def setPagesWithMatchingImagesVarargs(value: SchemaGoogleCloudVisionV1p4beta1WebDetectionWebPage*): Self = StObject.set(x, "pagesWithMatchingImages", js.Array(value :_*))
    ...
    inline def setVisuallySimilarImagesVarargs(value: SchemaGoogleCloudVisionV1p4beta1WebDetectionWebImage*): Self = StObject.set(x, "visuallySimilarImages", js.Array(value :_*))
    ...
    inline def setWebEntitiesVarargs(value: SchemaGoogleCloudVisionV1p4beta1WebDetectionWebEntity*): Self = StObject.set(x, "webEntities", js.Array(value :_*))
  }
}
