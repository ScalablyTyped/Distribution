...
object SchemaGoogleCloudVisionV1p4beta1WebDetection {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1WebDetectionMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1WebDetection] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setBestGuessLabels(value: js.Array[SchemaGoogleCloudVisionV1p4beta1WebDetectionWebLabel]): Self = StObject.set(x, "bestGuessLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBestGuessLabelsUndefined: Self = StObject.set(x, "bestGuessLabels", js.undefined)
    
    @scala.inline
    def setBestGuessLabelsVarargs(value: SchemaGoogleCloudVisionV1p4beta1WebDetectionWebLabel*): Self = StObject.set(x, "bestGuessLabels", js.Array(value :_*))
    ...
    @scala.inline
    def setPagesWithMatchingImages(value: js.Array[SchemaGoogleCloudVisionV1p4beta1WebDetectionWebPage]): Self = StObject.set(x, "pagesWithMatchingImages", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPagesWithMatchingImagesUndefined: Self = StObject.set(x, "pagesWithMatchingImages", js.undefined)
    
    @scala.inline
    def setPagesWithMatchingImagesVarargs(value: SchemaGoogleCloudVisionV1p4beta1WebDetectionWebPage*): Self = StObject.set(x, "pagesWithMatchingImages", js.Array(value :_*))
    ...
    @scala.inline
    def setVisuallySimilarImages(value: js.Array[SchemaGoogleCloudVisionV1p4beta1WebDetectionWebImage]): Self = StObject.set(x, "visuallySimilarImages", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setVisuallySimilarImagesUndefined: Self = StObject.set(x, "visuallySimilarImages", js.undefined)
    
    @scala.inline
    def setVisuallySimilarImagesVarargs(value: SchemaGoogleCloudVisionV1p4beta1WebDetectionWebImage*): Self = StObject.set(x, "visuallySimilarImages", js.Array(value :_*))
    
    @scala.inline
    def setWebEntities(value: js.Array[SchemaGoogleCloudVisionV1p4beta1WebDetectionWebEntity]): Self = StObject.set(x, "webEntities", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWebEntitiesUndefined: Self = StObject.set(x, "webEntities", js.undefined)
    
    @scala.inline
    def setWebEntitiesVarargs(value: SchemaGoogleCloudVisionV1p4beta1WebDetectionWebEntity*): Self = StObject.set(x, "webEntities", js.Array(value :_*))
  }
}
