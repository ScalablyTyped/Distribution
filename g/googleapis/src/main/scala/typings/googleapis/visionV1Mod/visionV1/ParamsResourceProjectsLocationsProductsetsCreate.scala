...
object ParamsResourceProjectsLocationsProductsetsCreate {
  ...
  def apply(
    ...
    requestBody: SchemaProductSet = null,
    uploadType: String = null,
    upload_protocol: String = null
  ): ParamsResourceProjectsLocationsProductsetsCreate = {
    ...
    if (productSetId != null) __obj.updateDynamic("productSetId")(productSetId.asInstanceOf[js.Any])
