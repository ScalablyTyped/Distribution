...
/**
  ...
  */
trait SchemaGoogleCloudVisionV1p1beta1CropHint extends StObject {
...
object SchemaGoogleCloudVisionV1p1beta1CropHint {
  
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p1beta1CropHint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1CropHint]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1CropHintMutableBuilder[Self <: SchemaGoogleCloudVisionV1p1beta1CropHint] (val x: Self) extends AnyVal {
