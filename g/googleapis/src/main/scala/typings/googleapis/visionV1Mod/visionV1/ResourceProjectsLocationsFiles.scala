...
@JSImport("googleapis/build/src/apis/vision/v1", "vision_v1.Resource$Projects$Locations$Files")
@js.native
open class ResourceProjectsLocationsFiles protected () extends StObject {
  def this(context: APIRequestContext) = this()
  
  def annotate(): GaxiosPromise[SchemaBatchAnnotateFilesResponse] = js.native
  def annotate(callback: BodyResponseCallback[SchemaBatchAnnotateFilesResponse]): Unit = js.native
  def annotate(params: Unit, options: MethodOptions): GaxiosPromise[SchemaBatchAnnotateFilesResponse] = js.native
  def annotate(params: ParamsResourceProjectsLocationsFilesAnnotate): GaxiosPromise[SchemaBatchAnnotateFilesResponse] = js.native
  def annotate(
    params: ParamsResourceProjectsLocationsFilesAnnotate,
    callback: BodyResponseCallback[SchemaBatchAnnotateFilesResponse]
  ): Unit = js.native
  def annotate(
    params: ParamsResourceProjectsLocationsFilesAnnotate,
    options: BodyResponseCallback[Readable | SchemaBatchAnnotateFilesResponse],
    callback: BodyResponseCallback[Readable | SchemaBatchAnnotateFilesResponse]
  ): Unit = js.native
  def annotate(params: ParamsResourceProjectsLocationsFilesAnnotate, options: MethodOptions): GaxiosPromise[SchemaBatchAnnotateFilesResponse] = js.native
  def annotate(
    params: ParamsResourceProjectsLocationsFilesAnnotate,
