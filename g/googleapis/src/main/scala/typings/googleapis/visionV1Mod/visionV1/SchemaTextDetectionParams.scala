...
trait SchemaTextDetectionParams extends StObject {
...
object SchemaTextDetectionParams {
  
  inline def apply(): SchemaTextDetectionParams = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaTextDetectionParams]
  }
  
  extension [Self <: SchemaTextDetectionParams](x: Self) {
