...
object SchemaGoogleCloudVisionV1p4beta1GcsDestination {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1GcsDestinationMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1GcsDestination] (val x: Self) extends AnyVal {
