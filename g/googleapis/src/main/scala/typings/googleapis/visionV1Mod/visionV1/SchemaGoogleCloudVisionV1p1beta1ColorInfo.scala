...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p1beta1ColorInfo extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p1beta1ColorInfo {
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p1beta1ColorInfo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p1beta1ColorInfo]
  }
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1ColorInfoOps[Self <: SchemaGoogleCloudVisionV1p1beta1ColorInfo] (val x: Self) extends AnyVal {
    @scala.inline
