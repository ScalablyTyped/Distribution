...
object SchemaGoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponseOps[Self <: SchemaGoogleCloudVisionV1p3beta1AsyncBatchAnnotateFilesResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponsesVarargs(value: SchemaGoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse*): Self = this.set("responses", js.Array(value :_*))
    
    @scala.inline
    def setResponses(value: js.Array[SchemaGoogleCloudVisionV1p3beta1AsyncAnnotateFileResponse]): Self = this.set("responses", value.asInstanceOf[js.Any])
