...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1LocalizedObjectAnnotation extends js.Object {
...
object SchemaGoogleCloudVisionV1p3beta1LocalizedObjectAnnotation {
  ...
  @scala.inline
  def apply(): SchemaGoogleCloudVisionV1p3beta1LocalizedObjectAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p3beta1LocalizedObjectAnnotation]
  }
  
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1LocalizedObjectAnnotationOps[Self <: SchemaGoogleCloudVisionV1p3beta1LocalizedObjectAnnotation] (val x: Self) extends AnyVal {
