...
object SchemaGoogleCloudVisionV1p3beta1LocalizedObjectAnnotation {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p3beta1LocalizedObjectAnnotationMutableBuilder[Self <: SchemaGoogleCloudVisionV1p3beta1LocalizedObjectAnnotation] (val x: Self) extends AnyVal {
