...
object SchemaGoogleCloudVisionV1p3beta1FaceAnnotationLandmark {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p3beta1FaceAnnotationLandmark = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p3beta1FaceAnnotationLandmark]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p3beta1FaceAnnotationLandmark](x: Self) {
    
    inline def setPosition(value: SchemaGoogleCloudVisionV1p3beta1Position): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
