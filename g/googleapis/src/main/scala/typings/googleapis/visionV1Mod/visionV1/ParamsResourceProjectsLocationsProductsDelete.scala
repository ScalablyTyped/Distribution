...
object ParamsResourceProjectsLocationsProductsDelete {
  ...
  @scala.inline
  def apply(): ParamsResourceProjectsLocationsProductsDelete = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ParamsResourceProjectsLocationsProductsDelete]
  }
  
  @scala.inline
  implicit class ParamsResourceProjectsLocationsProductsDeleteMutableBuilder[Self <: ParamsResourceProjectsLocationsProductsDelete] (val x: Self) extends AnyVal {
