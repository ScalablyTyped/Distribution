...
object SchemaGoogleCloudVisionV1p2beta1Paragraph {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p2beta1Paragraph = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p2beta1Paragraph]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p2beta1Paragraph](x: Self) {
    ...
    inline def setWords(value: js.Array[SchemaGoogleCloudVisionV1p2beta1Word]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
    
    inline def setWordsUndefined: Self = StObject.set(x, "words", js.undefined)
    
    inline def setWordsVarargs(value: SchemaGoogleCloudVisionV1p2beta1Word*): Self = StObject.set(x, "words", js.Array(value :_*))
  }
}
