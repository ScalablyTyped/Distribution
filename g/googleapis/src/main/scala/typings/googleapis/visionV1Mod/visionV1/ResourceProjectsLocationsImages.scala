...
@JSImport("googleapis/build/src/apis/vision/v1", "vision_v1.Resource$Projects$Locations$Images")
@js.native
open class ResourceProjectsLocationsImages protected () extends StObject {
  ...
  def annotate(params: ParamsResourceProjectsLocationsImagesAnnotate): GaxiosPromise[SchemaBatchAnnotateImagesResponse] = js.native
  def annotate(
  ...
  def annotate(params: ParamsResourceProjectsLocationsImagesAnnotate, options: MethodOptions): GaxiosPromise[SchemaBatchAnnotateImagesResponse] = js.native
  def annotate(
    params: ParamsResourceProjectsLocationsImagesAnnotate,
