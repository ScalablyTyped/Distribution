...
object ParamsResourceProjectsLocationsProductsetsProductsList {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsProductsetsProductsListOps[Self <: ParamsResourceProjectsLocationsProductsetsProductsList] (val x: Self) extends AnyVal {
