...
object SchemaGoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p1beta1AsyncAnnotateFileResponseOps[Self <: SchemaGoogleCloudVisionV1p1beta1AsyncAnnotateFileResponse] (val x: Self) extends AnyVal {
    @scala.inline
