...
object ParamsResourceProjectsLocationsProductsetsAddproduct {
  ...
  @scala.inline
  implicit class ParamsResourceProjectsLocationsProductsetsAddproductOps[Self <: ParamsResourceProjectsLocationsProductsetsAddproduct] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRequestBody(value: SchemaAddProductToProductSetRequest): Self = this.set("requestBody", value.asInstanceOf[js.Any])
