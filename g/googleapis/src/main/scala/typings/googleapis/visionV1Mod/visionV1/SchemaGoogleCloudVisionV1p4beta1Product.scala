...
/**
  ...
  */
trait SchemaGoogleCloudVisionV1p4beta1Product extends StObject {
  ...
  /**
    ...
    */
  var productLabels: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p4beta1ProductKeyValue]] = js.undefined
}
object SchemaGoogleCloudVisionV1p4beta1Product {
  ...
  @scala.inline
  implicit class SchemaGoogleCloudVisionV1p4beta1ProductMutableBuilder[Self <: SchemaGoogleCloudVisionV1p4beta1Product] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProductLabels(value: js.Array[SchemaGoogleCloudVisionV1p4beta1ProductKeyValue]): Self = StObject.set(x, "productLabels", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProductLabelsUndefined: Self = StObject.set(x, "productLabels", js.undefined)
    
    @scala.inline
    def setProductLabelsVarargs(value: SchemaGoogleCloudVisionV1p4beta1ProductKeyValue*): Self = StObject.set(x, "productLabels", js.Array(value :_*))
  }
}
