...
object SchemaGoogleCloudVisionV1p4beta1Product {
  ...
  inline def apply(): SchemaGoogleCloudVisionV1p4beta1Product = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaGoogleCloudVisionV1p4beta1Product]
  }
  
  extension [Self <: SchemaGoogleCloudVisionV1p4beta1Product](x: Self) {
    ...
    inline def setProductLabels(value: js.Array[SchemaGoogleCloudVisionV1p4beta1ProductKeyValue]): Self = StObject.set(x, "productLabels", value.asInstanceOf[js.Any])
    
    inline def setProductLabelsUndefined: Self = StObject.set(x, "productLabels", js.undefined)
    
    inline def setProductLabelsVarargs(value: SchemaGoogleCloudVisionV1p4beta1ProductKeyValue*): Self = StObject.set(x, "productLabels", js.Array(value :_*))
  }
}
