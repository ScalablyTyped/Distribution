...
/**
  ...
  */
@js.native
trait Schema$BatchGetAmpUrlsRequest extends js.Object {
  /**
...
object Schema$BatchGetAmpUrlsRequest {
  @scala.inline
  def apply(lookupStrategy: String = null, urls: js.Array[String] = null): Schema$BatchGetAmpUrlsRequest = {
    val __obj = js.Dynamic.literal()
    if (lookupStrategy != null) __obj.updateDynamic("lookupStrategy")(lookupStrategy.asInstanceOf[js.Any])
    if (urls != null) __obj.updateDynamic("urls")(urls.asInstanceOf[js.Any])
    __obj.asInstanceOf[Schema$BatchGetAmpUrlsRequest]
  }
}
