...
/**
  ...
  */
@js.native
trait Schema$AmpUrl extends js.Object {
  /**
...
object Schema$AmpUrl {
  @scala.inline
  def apply(ampUrl: String = null, cdnAmpUrl: String = null, originalUrl: String = null): Schema$AmpUrl = {
    ...
    __obj.asInstanceOf[Schema$AmpUrl]
  }
}
