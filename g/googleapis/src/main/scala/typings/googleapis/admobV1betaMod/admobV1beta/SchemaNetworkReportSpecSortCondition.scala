...
trait SchemaNetworkReportSpecSortCondition extends StObject {
...
object SchemaNetworkReportSpecSortCondition {
  
  inline def apply(): SchemaNetworkReportSpecSortCondition = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SchemaNetworkReportSpecSortCondition]
  }
  
  extension [Self <: SchemaNetworkReportSpecSortCondition](x: Self) {
