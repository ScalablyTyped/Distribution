...
object scalesMod {
  ...
  {readonly [ key in T | glaze.glaze/dist-types/scales.Negate<std.Extract<T, number>> | T extends '1px'? '-1px' : never ]: string | number}
    */ typings.glaze.glazeStrings.symmetricScale & TopLevel[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("symmetricScale")(nonNegativeTokens.asInstanceOf[js.Any]).asInstanceOf[/* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {readonly [ key in T | glaze.glaze/dist-types/scales.Negate<std.Extract<T, number>> | T extends '1px'? '-1px' : never ]: string | number}
    */ typings.glaze.glazeStrings.symmetricScale & TopLevel[js.Any]]
