...
import typings.guacamoleCommonJs.libVideoPlayerMod.VideoPlayer
...
object libClientMod {
  ...
  @JSImport("guacamole-common-js/lib/Client", "Client")
  @js.native
  open class Client protected () extends StObject {
    ...
    /**
      ...
      */
    def sendMouseState(state: typings.guacamoleCommonJs.libMouseMod.Mouse.State): Unit = js.native
  ...
  object Client {
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.guacamoleCommonJs.libClientMod.Client.ExportLayerBase
      - typings.guacamoleCommonJs.anon.ExportLayerBasexnumberynu
    */
    trait ExportLayer extends StObject
    object ExportLayer {
      
      inline def ExportLayerBase(height: Double, width: Double): typings.guacamoleCommonJs.libClientMod.Client.ExportLayerBase = {
        val __obj = js.Dynamic.literal(height = height.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.guacamoleCommonJs.libClientMod.Client.ExportLayerBase]
      }
      ...
      inline def ExportLayerBasexnumberynu(
        ...
        __obj.asInstanceOf[typings.guacamoleCommonJs.anon.ExportLayerBasexnumberynu]
      }
    }
