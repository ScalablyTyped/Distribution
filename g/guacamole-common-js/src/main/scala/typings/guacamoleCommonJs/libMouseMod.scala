...
import typings.guacamoleCommonJs.libMouseMod.Mouse.State
...
object libMouseMod {
  ...
  @JSImport("guacamole-common-js/lib/Mouse", "Mouse")
  @js.native
  ...
  object Mouse {
    ...
    @JSImport("guacamole-common-js/lib/Mouse", "Mouse.GuacTouchDevice")
    @js.native
    ...
    @JSImport("guacamole-common-js/lib/Mouse", "Mouse.State")
    @js.native
    ...
    @JSImport("guacamole-common-js/lib/Mouse", "Mouse.Touchpad")
    @js.native
    ...
    @JSImport("guacamole-common-js/lib/Mouse", "Mouse.Touchscreen")
    @js.native
