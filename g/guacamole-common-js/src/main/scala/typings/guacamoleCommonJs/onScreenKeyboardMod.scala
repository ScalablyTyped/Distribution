...
object onScreenKeyboardMod {
  ...
  object OnScreenKeyboard {
    ...
    type Key = Instantiable2[
        /* template */ typings.guacamoleCommonJs.onScreenKeyboardMod.Key, 
        /* name */ js.UndefOr[String], 
        typings.guacamoleCommonJs.onScreenKeyboardMod.Key
      ]
    
    type Layout = Instantiable1[
        /* template */ typings.guacamoleCommonJs.onScreenKeyboardMod.Layout, 
        typings.guacamoleCommonJs.onScreenKeyboardMod.Layout
      ]
  }
