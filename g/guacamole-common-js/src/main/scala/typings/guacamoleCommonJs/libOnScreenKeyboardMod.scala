...
object libOnScreenKeyboardMod {
  
  @JSImport("guacamole-common-js/lib/OnScreenKeyboard", "OnScreenKeyboard")
  @js.native
  ...
  object OnScreenKeyboard {
    ...
    type Key = Instantiable2[
        /* template */ typings.guacamoleCommonJs.libOnScreenKeyboardMod.Key, 
        /* name */ js.UndefOr[String], 
        typings.guacamoleCommonJs.libOnScreenKeyboardMod.Key
      ]
    
    type Layout = Instantiable1[
        /* template */ typings.guacamoleCommonJs.libOnScreenKeyboardMod.Layout, 
        typings.guacamoleCommonJs.libOnScreenKeyboardMod.Layout
      ]
  }
