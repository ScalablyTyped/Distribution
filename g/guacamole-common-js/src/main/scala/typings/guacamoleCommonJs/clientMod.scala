...
import typings.guacamoleCommonJs.clientMod.Client.ExportedState
...
import typings.guacamoleCommonJs.videoPlayerMod.VideoPlayer
...
object clientMod {
  ...
  open class Client protected () extends StObject {
    ...
    /**
      ...
      */
    def sendMouseState(state: typings.guacamoleCommonJs.mouseMod.Mouse.State): Unit = js.native
  ...
  object Client {
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.guacamoleCommonJs.clientMod.Client.ExportLayerBase
      - typings.guacamoleCommonJs.anon.ExportLayerBasexnumberynu
    */
    trait ExportLayer extends StObject
    object ExportLayer {
      
      inline def ExportLayerBase(height: Double, width: Double): typings.guacamoleCommonJs.clientMod.Client.ExportLayerBase = {
        val __obj = js.Dynamic.literal(height = height.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.guacamoleCommonJs.clientMod.Client.ExportLayerBase]
      }
