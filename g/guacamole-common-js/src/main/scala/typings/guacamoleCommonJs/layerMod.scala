...
import typings.guacamoleCommonJs.anon.FnCall
import typings.guacamoleCommonJs.anon.FnCallPathFillRule
...
import typings.guacamoleCommonJs.layerMod.Layer.LineCap
import typings.guacamoleCommonJs.layerMod.Layer.LineJoin
import typings.guacamoleCommonJs.layerMod.Layer.Pixel
...
object layerMod {
  ...
  object Layer {
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.guacamoleCommonJs.guacamoleCommonJsStrings.round
      - typings.guacamoleCommonJs.guacamoleCommonJsStrings.square
      - typings.guacamoleCommonJs.guacamoleCommonJsStrings.butt
    */
    trait LineCap extends StObject
    object LineCap {
      
      inline def butt: typings.guacamoleCommonJs.guacamoleCommonJsStrings.butt = "butt".asInstanceOf[typings.guacamoleCommonJs.guacamoleCommonJsStrings.butt]
      
      inline def round: typings.guacamoleCommonJs.guacamoleCommonJsStrings.round = "round".asInstanceOf[typings.guacamoleCommonJs.guacamoleCommonJsStrings.round]
      
      inline def square: typings.guacamoleCommonJs.guacamoleCommonJsStrings.square = "square".asInstanceOf[typings.guacamoleCommonJs.guacamoleCommonJsStrings.square]
    }
    
    /* Rewritten from type alias, can be one of: 
      - typings.guacamoleCommonJs.guacamoleCommonJsStrings.round
      - typings.guacamoleCommonJs.guacamoleCommonJsStrings.bevel
      - typings.guacamoleCommonJs.guacamoleCommonJsStrings.mitter
    */
    trait LineJoin extends StObject
    object LineJoin {
      
      inline def bevel: typings.guacamoleCommonJs.guacamoleCommonJsStrings.bevel = "bevel".asInstanceOf[typings.guacamoleCommonJs.guacamoleCommonJsStrings.bevel]
      
      inline def mitter: typings.guacamoleCommonJs.guacamoleCommonJsStrings.mitter = "mitter".asInstanceOf[typings.guacamoleCommonJs.guacamoleCommonJsStrings.mitter]
