...
import typings.guacamoleCommonJs.libLayerMod.Layer
import typings.guacamoleCommonJs.libLayerMod.Layer.LineCap
import typings.guacamoleCommonJs.libLayerMod.Layer.LineJoin
import typings.guacamoleCommonJs.libLayerMod.Layer.Pixel
import typings.guacamoleCommonJs.libVisibleLayerMod.VisibleLayer
...
object libDisplayMod {
  ...
  @JSImport("guacamole-common-js/lib/Display", "Display")
  @js.native
  ...
  object Display {
    ...
    type VisibleLayer = Instantiable2[
        /* width */ Double, 
        /* height */ Double, 
        typings.guacamoleCommonJs.libVisibleLayerMod.VisibleLayer
      ]
  }
}
