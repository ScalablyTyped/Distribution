...
trait AnonAltFieldsKeyOauthtokenParent extends js.Object {
...
object AnonAltFieldsKeyOauthtokenParent {
  @scala.inline
  def apply(
    resource: Task,
    tasklist: String,
    ...
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenParent = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenParent]
  }
}
