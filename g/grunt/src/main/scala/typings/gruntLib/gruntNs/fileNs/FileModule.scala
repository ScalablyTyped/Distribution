...
trait FileModule extends js.Object {
  ...
  /**
               ...
               */
  def arePathsEquivalent(path: java.lang.String, append: java.lang.String*): scala.Boolean = js.native
  /**
               * Copy a source file to a destination path, creating intermediate directories if necessary.
               */
  def copy(srcpath: java.lang.String, destpath: java.lang.String): scala.Unit = js.native
  def copy(srcpath: java.lang.String, destpath: java.lang.String, options: IFileWriteBufferOption): scala.Unit = js.native
  def copy(srcpath: java.lang.String, destpath: java.lang.String, options: IFileWriteStringOption): scala.Unit = js.native
  /**
               ...
               */
  def delete(filepath: java.lang.String): scala.Boolean = js.native
  /**
               * Delete the specified filepath. Will delete files and folders recursively.
               *
               * @return true if the files could be deleted, otherwise false.
               */
  def delete(filepath: java.lang.String, options: gruntLib.Anon_Force): scala.Boolean = js.native
  /**
               * Are all descendant path(s) contained within the specified ancestor path?
               */
  def doesPathContain(ancestorPath: java.lang.String, decendantPaths: js.Array[java.lang.String]): scala.Boolean = js.native
  /*
  ...
  /**
               ...
               */
  def exists(path: java.lang.String, append: java.lang.String*): scala.Boolean = js.native
  ...
  /**
               ...
               */
  def isDir(path: java.lang.String, append: java.lang.String*): scala.Boolean = js.native
  /**
               * Is the given path a file?
               */
  def isFile(path: java.lang.String, append: java.lang.String*): scala.Boolean = js.native
  /**
               * Is the given path a symbolic link?
               */
  def isLink(path: java.lang.String, append: java.lang.String*): scala.Boolean = js.native
  def isMatch(
    options: gruntLib.minimatchNs.IMinimatchOptions,
  ...
  /**
               ...
               */
  def isMatch(pattern: java.lang.String, filepath: java.lang.String): scala.Boolean = js.native
  def isMatch(pattern: java.lang.String, filepaths: js.Array[java.lang.String]): scala.Boolean = js.native
  def isMatch(patterns: js.Array[java.lang.String], filepath: java.lang.String): scala.Boolean = js.native
  def isMatch(patterns: js.Array[java.lang.String], filepaths: js.Array[java.lang.String]): scala.Boolean = js.native
  /**
               * Is a given file path absolute?
               */
  def isPathAbsolute(path: java.lang.String, append: java.lang.String*): scala.Boolean = js.native
  /**
               * Is a given file path the current working directory (CWD)?
               */
  def isPathCwd(path: java.lang.String, append: java.lang.String*): scala.Boolean = js.native
  def `match`(
    options: gruntLib.minimatchNs.IMinimatchOptions,
    pattern: java.lang.String,
    filepath: java.lang.String
  ...
  /**
               ...
               */
  def mkdir(dirpath: java.lang.String): scala.Unit = js.native
  /**
               * Works like mkdir -p. Create a directory along with any intermediate directories.
               * If mode isn't specified, it defaults to 0777 & (~process.umask()).
               */
  def mkdir(dirpath: java.lang.String, mode: java.lang.String): scala.Unit = js.native
  /**
  ...
  def read(filepath: java.lang.String, options: IFileEncodedOption): nodeLib.Buffer = js.native
  /**
  ...
  def readJSON(filepath: java.lang.String, options: IFileEncodedOption): nodeLib.Buffer = js.native
  /**
  ...
  def readYAML(filepath: java.lang.String, options: IFileEncodedOption): nodeLib.Buffer = js.native
  /**
  ...
  /**
               ...
               */
  def setBase(path: java.lang.String, append: java.lang.String*): scala.Unit = js.native
  /**
  ...
  /**
               ...
               * @param options If an encoding is not specified, default to grunt.file.defaultEncoding.
               */
  def write(filepath: java.lang.String, contents: java.lang.String, options: IFileEncodedOption): scala.Unit = js.native
  def write(filepath: java.lang.String, contents: nodeLib.Buffer): scala.Unit = js.native
}
