...
trait CommonTaskModule extends js.Object {
  ...
  def registerMultiTask(
    ...
    taskFunction: js.ThisFunction1[/* this */ IMultiTask[_], /* repeated */ js.Any, scala.Unit]
  ...
  def registerTask(
    ...
    taskFunction: js.ThisFunction1[/* this */ ITask, /* repeated */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  def registerTask(taskName: java.lang.String, description: java.lang.String, taskList: js.Array[java.lang.String]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def registerTask(taskName: java.lang.String, taskList: js.Array[java.lang.String]): scala.Unit = js.native
  /**
    ...
    */
  def renameTask(oldname: java.lang.String, newname: java.lang.String): scala.Unit = js.native
}
