package typings
package gruntLib.gruntNs.configNs
...
trait ConfigModule extends js.Object {
  ...
  /**
    ...
    */
  def init(config: IProjectConfig): scala.Unit = js.native
  /**
    ...
    */
  def merge[T](configObject: T): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def requires(prop: java.lang.String, andProps: java.lang.String*): scala.Unit = js.native
  def requires(prop: js.Array[java.lang.String], andProps: js.Array[java.lang.String]*): scala.Unit = js.native
  /**
