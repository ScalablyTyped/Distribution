...
trait AnonAltFieldsIncludeDeleted extends js.Object {
...
object AnonAltFieldsIncludeDeleted {
  @scala.inline
  def apply(
    parent: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltFieldsIncludeDeleted]
  }
}
