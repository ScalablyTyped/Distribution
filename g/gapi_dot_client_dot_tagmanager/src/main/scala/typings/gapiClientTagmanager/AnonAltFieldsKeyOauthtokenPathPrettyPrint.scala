...
trait AnonAltFieldsKeyOauthtokenPathPrettyPrint extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPathPrettyPrint {
  @scala.inline
  def apply(
    path: String,
    alt: String = null,
  ...
  ): AnonAltFieldsKeyOauthtokenPathPrettyPrint = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPathPrettyPrint]
  }
}
