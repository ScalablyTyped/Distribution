...
trait AnonAltFieldsKeyOauthtokenPath extends js.Object {
...
object AnonAltFieldsKeyOauthtokenPath {
  @scala.inline
  def apply(
    path: String,
    alt: String = null,
    ...
    `type`: String = null,
    userIp: String = null
  ): AnonAltFieldsKeyOauthtokenPath = {
    ...
    __obj.asInstanceOf[AnonAltFieldsKeyOauthtokenPath]
  }
}
