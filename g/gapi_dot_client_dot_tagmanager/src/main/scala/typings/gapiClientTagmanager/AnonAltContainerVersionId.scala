...
trait AnonAltContainerVersionId extends js.Object {
...
object AnonAltContainerVersionId {
  @scala.inline
  def apply(
    path: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltContainerVersionId]
  }
}
