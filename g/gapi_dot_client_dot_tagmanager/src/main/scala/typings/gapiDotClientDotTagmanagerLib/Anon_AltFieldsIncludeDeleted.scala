...
trait Anon_AltFieldsIncludeDeleted extends js.Object {
...
object Anon_AltFieldsIncludeDeleted {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltFieldsIncludeDeleted]
  }
}
