...
trait Anon_AltContainerVersionId extends js.Object {
...
object Anon_AltContainerVersionId {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_AltContainerVersionId]
  }
}
