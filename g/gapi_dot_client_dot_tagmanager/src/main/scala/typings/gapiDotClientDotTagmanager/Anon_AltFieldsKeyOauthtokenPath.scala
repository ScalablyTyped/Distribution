...
trait Anon_AltFieldsKeyOauthtokenPath extends js.Object {
...
object Anon_AltFieldsKeyOauthtokenPath {
  @scala.inline
  def apply(
    path: String,
    alt: String = null,
    ...
    `type`: String = null,
    userIp: String = null
  ): Anon_AltFieldsKeyOauthtokenPath = {
    ...
    __obj.asInstanceOf[Anon_AltFieldsKeyOauthtokenPath]
  }
}
