...
object Ne {
  ...
  inline def apply(ne_ : typings.googleMapReact.mod.Coords, sw: typings.googleMapReact.mod.Coords): Ne = {
  ...
  implicit open class MutableBuilder[Self <: Ne] (val x: Self) extends AnyVal {
    ...
    inline def setSw(value: typings.googleMapReact.mod.Coords): Self = StObject.set(x, "sw", value.asInstanceOf[js.Any])
  }
}
