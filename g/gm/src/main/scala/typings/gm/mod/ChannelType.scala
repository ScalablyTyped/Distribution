...
/* Rewritten from type alias, can be one of: 
  - typings.gm.gmStrings.All
  - typings.gm.gmStrings.Intensity
  - typings.gm.gmStrings.Red
  - typings.gm.gmStrings.Green
  - typings.gm.gmStrings.Blue
  - typings.gm.gmStrings.Cyan
  - typings.gm.gmStrings.Magenta
  - typings.gm.gmStrings.Yellow
  - typings.gm.gmStrings.Black
  - typings.gm.gmStrings.Opacity
*/
