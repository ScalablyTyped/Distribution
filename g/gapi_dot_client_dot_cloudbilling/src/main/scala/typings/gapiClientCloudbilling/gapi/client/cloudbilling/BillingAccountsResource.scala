...
trait BillingAccountsResource extends js.Object {
  ...
  /**
    ...
    */
  def get(request: AnonAccesstokenAlt): Request_[BillingAccount]
  /**
    * Lists the billing accounts that the current authenticated user
    * [owns](https://support.google.com/cloud/answer/4430947).
    */
  def list(request: AnonAccesstokenAltBearertoken): Request_[ListBillingAccountsResponse]
}

object BillingAccountsResource {
  @scala.inline
  def apply(
    get: AnonAccesstokenAlt => Request_[BillingAccount],
    list: AnonAccesstokenAltBearertoken => Request_[ListBillingAccountsResponse],
