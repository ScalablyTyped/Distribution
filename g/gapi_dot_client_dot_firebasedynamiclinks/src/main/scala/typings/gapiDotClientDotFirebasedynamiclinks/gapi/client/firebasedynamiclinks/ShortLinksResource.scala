...
trait ShortLinksResource extends js.Object {
  /**
    ...
    * Firebase project.
    */
  def create(request: Anon_Accesstoken): Request[CreateShortDynamicLinkResponse]
}

object ShortLinksResource {
  @scala.inline
  def apply(create: Anon_Accesstoken => Request[CreateShortDynamicLinkResponse]): ShortLinksResource = {
