...
trait AnonAltBlogIdEndDateFetchBodies extends js.Object {
...
object AnonAltBlogIdEndDateFetchBodies {
  @scala.inline
  def apply(
    blogId: String,
    alt: String = null,
    ...
    status: String = null,
    userIp: String = null
  ): AnonAltBlogIdEndDateFetchBodies = {
    ...
    __obj.asInstanceOf[AnonAltBlogIdEndDateFetchBodies]
  }
}
