...
trait AnonAltBlogIdCommentIdFields extends js.Object {
...
object AnonAltBlogIdCommentIdFields {
  @scala.inline
  def apply(
    blogId: String,
    commentId: String,
    ...
    __obj.asInstanceOf[AnonAltBlogIdCommentIdFields]
  }
}
