...
trait AnonAltBlogIdFetchBodyFetchImagesFields extends js.Object {
...
object AnonAltBlogIdFetchBodyFetchImagesFields {
  @scala.inline
  def apply(
    blogId: String,
    postId: String,
    ...
    userIp: String = null
  ): AnonAltBlogIdFetchBodyFetchImagesFields = {
    ...
    __obj.asInstanceOf[AnonAltBlogIdFetchBodyFetchImagesFields]
  }
}
