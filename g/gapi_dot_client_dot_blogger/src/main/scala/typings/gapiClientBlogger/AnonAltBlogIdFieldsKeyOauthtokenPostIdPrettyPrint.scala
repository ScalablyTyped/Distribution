...
trait AnonAltBlogIdFieldsKeyOauthtokenPostIdPrettyPrint extends js.Object {
...
object AnonAltBlogIdFieldsKeyOauthtokenPostIdPrettyPrint {
  @scala.inline
  def apply(
    blogId: String,
    postId: String,
    ...
    userIp: String = null
  ): AnonAltBlogIdFieldsKeyOauthtokenPostIdPrettyPrint = {
    ...
    __obj.asInstanceOf[AnonAltBlogIdFieldsKeyOauthtokenPostIdPrettyPrint]
  }
}
