...
trait AnonAltBlogIdFieldsIsDraft extends js.Object {
...
object AnonAltBlogIdFieldsIsDraft {
  @scala.inline
  def apply(
    blogId: String,
    alt: String = null,
    ...
    __obj.asInstanceOf[AnonAltBlogIdFieldsIsDraft]
  }
}
