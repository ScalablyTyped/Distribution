...
trait AnonAltBlogIdFieldsKeyMaxComments extends js.Object {
...
object AnonAltBlogIdFieldsKeyMaxComments {
  @scala.inline
  def apply(
    blogId: String,
    postId: String,
    ...
    userIp: String = null
  ): AnonAltBlogIdFieldsKeyMaxComments = {
    ...
    __obj.asInstanceOf[AnonAltBlogIdFieldsKeyMaxComments]
  }
}
