...
@js.native
trait FetchImages extends js.Object {
...
object FetchImages {
  @scala.inline
  def apply(blogId: String): FetchImages = {
    val __obj = js.Dynamic.literal(blogId = blogId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FetchImages]
  }
  @scala.inline
  implicit class FetchImagesOps[Self <: FetchImages] (val x: Self) extends AnyVal {
    @scala.inline
