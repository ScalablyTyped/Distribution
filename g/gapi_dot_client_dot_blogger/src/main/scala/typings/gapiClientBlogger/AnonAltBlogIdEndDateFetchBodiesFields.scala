...
trait AnonAltBlogIdEndDateFetchBodiesFields extends js.Object {
...
object AnonAltBlogIdEndDateFetchBodiesFields {
  @scala.inline
  def apply(
    blogId: String,
    userId: String,
    ...
    userIp: String = null,
    view: String = null
  ): AnonAltBlogIdEndDateFetchBodiesFields = {
    ...
    __obj.asInstanceOf[AnonAltBlogIdEndDateFetchBodiesFields]
  }
}
