...
trait AnonAltBlogIdFieldsKeyOauthtokenPageId extends js.Object {
...
object AnonAltBlogIdFieldsKeyOauthtokenPageId {
  @scala.inline
  def apply(
    blogId: String,
    pageId: String,
    ...
    userIp: String = null
  ): AnonAltBlogIdFieldsKeyOauthtokenPageId = {
    ...
    __obj.asInstanceOf[AnonAltBlogIdFieldsKeyOauthtokenPageId]
  }
}
