...
trait AnonAltBlogIdFetchBodyFetchImages extends js.Object {
...
object AnonAltBlogIdFetchBodyFetchImages {
  @scala.inline
  def apply(
    blogId: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonAltBlogIdFetchBodyFetchImages = {
    ...
    __obj.asInstanceOf[AnonAltBlogIdFetchBodyFetchImages]
  }
}
