...
trait AnonAltBlogIdFetchBodiesFields extends js.Object {
...
object AnonAltBlogIdFetchBodiesFields {
  @scala.inline
  def apply(
    blogId: String,
    q: String,
    ...
    userIp: String = null
  ): AnonAltBlogIdFetchBodiesFields = {
    ...
    __obj.asInstanceOf[AnonAltBlogIdFetchBodiesFields]
  }
}
