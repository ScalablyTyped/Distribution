...
trait AnonAltBlogIdEndDateFetchBodiesFetchImages extends js.Object {
...
object AnonAltBlogIdEndDateFetchBodiesFetchImages {
  @scala.inline
  def apply(
    blogId: String,
    alt: String = null,
    ...
    userIp: String = null,
    view: String = null
  ): AnonAltBlogIdEndDateFetchBodiesFetchImages = {
    ...
    __obj.asInstanceOf[AnonAltBlogIdEndDateFetchBodiesFetchImages]
  }
}
