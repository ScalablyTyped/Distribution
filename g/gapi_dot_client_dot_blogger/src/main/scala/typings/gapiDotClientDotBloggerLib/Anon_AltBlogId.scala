...
trait Anon_AltBlogId extends js.Object {
  ...
  var maxPosts: js.UndefOr[scala.Double] = js.undefined
...
object Anon_AltBlogId {
  ...
  def apply(
    ...
    maxPosts: scala.Int | scala.Double = null,
    ...
    __obj.asInstanceOf[Anon_AltBlogId]
  }
}
