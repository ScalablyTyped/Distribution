...
trait Anon_AltBlogIdFetchBodyFetchImages extends js.Object {
...
object Anon_AltBlogIdFetchBodyFetchImages {
  @scala.inline
  def apply(
  ...
  ): Anon_AltBlogIdFetchBodyFetchImages = {
    ...
    __obj.asInstanceOf[Anon_AltBlogIdFetchBodyFetchImages]
  }
}
