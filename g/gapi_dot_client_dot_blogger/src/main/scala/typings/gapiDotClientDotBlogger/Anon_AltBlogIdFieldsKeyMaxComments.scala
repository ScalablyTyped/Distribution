...
trait Anon_AltBlogIdFieldsKeyMaxComments extends js.Object {
...
object Anon_AltBlogIdFieldsKeyMaxComments {
  @scala.inline
  def apply(
    blogId: String,
    postId: String,
    ...
    userIp: String = null
  ): Anon_AltBlogIdFieldsKeyMaxComments = {
    val __obj = js.Dynamic.literal(blogId = blogId, postId = postId, userId = userId)
    ...
    __obj.asInstanceOf[Anon_AltBlogIdFieldsKeyMaxComments]
  }
}
