...
trait Anon_AccesstokenAltBearertokenCallbackDatabase extends js.Object {
  /** V1 error format. */
  @JSName("$.xgafv")
...
object Anon_AccesstokenAltBearertokenCallbackDatabase {
  @scala.inline
  def apply(
    database: String,
    `$.xgafv`: String = null,
  ...
  ): Anon_AccesstokenAltBearertokenCallbackDatabase = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackDatabase]
  }
}
