...
object Anon_AccesstokenAltBearertokenCallbackDatabaseFields {
  @scala.inline
  def apply(
  ...
  ): Anon_AccesstokenAltBearertokenCallbackDatabaseFields = {
    ...
    __obj.asInstanceOf[Anon_AccesstokenAltBearertokenCallbackDatabaseFields]
  }
}
