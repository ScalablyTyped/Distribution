...
object algNs extends js.Object {
  /**
  		 ...
  		 */
  def components(graph: graphlibLib.graphlibMod.Graph): js.Array[js.Array[java.lang.String]] = js.native
  /**
  ...
  /**
  		 ...
  		 * @returns cycles list.
  		 */
  def findCycles(graph: graphlibLib.graphlibMod.Graph): js.Array[js.Array[java.lang.String]] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def isAcyclic(graph: graphlibLib.graphlibMod.Graph): scala.Boolean = js.native
  /**
  		 ...
  		 */
  def postorder(graph: graphlibLib.graphlibMod.Graph, vs: js.Array[java.lang.String]): js.Array[java.lang.String] = js.native
  /**
  		 ...
  		 * @returns the nodes in the order they were visited as a list of their names.
  		 */
  def preorder(graph: graphlibLib.graphlibMod.Graph, vs: js.Array[java.lang.String]): js.Array[java.lang.String] = js.native
  /**
  ...
  def prim(
    graph: graphlibLib.graphlibMod.Graph,
    weightFn: js.Function1[/* e */ graphlibLib.graphlibMod.Edge, scala.Double]
  ): graphlibLib.graphlibMod.Graph = js.native
  /**
  		 ...
  		 */
  def tarjan(graph: graphlibLib.graphlibMod.Graph): js.Array[js.Array[java.lang.String]] = js.native
  /**
  		 ...
  		 */
  def topsort(graph: graphlibLib.graphlibMod.Graph): js.Array[java.lang.String] = js.native
}
