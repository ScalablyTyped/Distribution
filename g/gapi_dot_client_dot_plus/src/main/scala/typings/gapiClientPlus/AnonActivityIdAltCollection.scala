...
trait AnonActivityIdAltCollection extends js.Object {
...
object AnonActivityIdAltCollection {
  @scala.inline
  def apply(
    activityId: String,
    collection: String,
    ...
    __obj.asInstanceOf[AnonActivityIdAltCollection]
  }
}
