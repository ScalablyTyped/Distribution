...
trait Lutimes extends js.Object {
  ...
  var lutimes_Original: (js.Function4[
    ...
    /* atime */ String | Double | Date, 
    /* mtime */ String | Double | Date, 
    /* callback */ js.UndefOr[js.Function1[/* err */ ErrnoException | Null, Unit]], 
    Unit
  ]) with Typeoflutimes = js.native
  /**
    * Asynchronously change file timestamps of the file referenced by the supplied path.
    * If path refers to a symbolic link, then the link is not dereferenced: instead, the timestamps
    * of the symbolic link are changed.
    ...
    * @param mtime The last modified time. If a string is provided, it will be coerced to number.
    */
  def lutimes(path: PathLike, atime: String, mtime: String): Unit = js.native
  def lutimes(
    path: PathLike,
    atime: String,
    mtime: String,
  ...
  def lutimes(path: PathLike, atime: String, mtime: Double): Unit = js.native
  def lutimes(
    path: PathLike,
    atime: String,
    mtime: Double,
  ...
  def lutimes(path: PathLike, atime: String, mtime: Date): Unit = js.native
  def lutimes(
    path: PathLike,
    atime: String,
    mtime: Date,
  ...
  def lutimes(path: PathLike, atime: Double, mtime: String): Unit = js.native
  def lutimes(
    path: PathLike,
    atime: Double,
    mtime: String,
  ...
  def lutimes(path: PathLike, atime: Double, mtime: Double): Unit = js.native
  def lutimes(
    path: PathLike,
    atime: Double,
    mtime: Double,
  ...
  def lutimes(path: PathLike, atime: Double, mtime: Date): Unit = js.native
  def lutimes(
    path: PathLike,
    atime: Double,
    mtime: Date,
  ...
  def lutimes(path: PathLike, atime: Date, mtime: String): Unit = js.native
  def lutimes(
    path: PathLike,
    atime: Date,
    mtime: String,
  ...
  def lutimes(path: PathLike, atime: Date, mtime: Double): Unit = js.native
  def lutimes(
    path: PathLike,
    atime: Date,
    mtime: Double,
  ...
  def lutimes(path: PathLike, atime: Date, mtime: Date): Unit = js.native
  def lutimes(
    path: PathLike,
    atime: Date,
    mtime: Date,
