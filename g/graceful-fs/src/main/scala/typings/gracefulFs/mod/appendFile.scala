...
object appendFile extends js.Object {
  ...
  @JSName("__promisify__")
  def promisify(file: Double, data: Uint8Array): js.Promise[Unit] = js.native
  @JSName("__promisify__")
  def promisify(file: Double, data: Uint8Array, options: WriteFileOptions): js.Promise[Unit] = js.native
  /**
  ...
  @JSName("__promisify__")
  def promisify(file: PathLike, data: Uint8Array): js.Promise[Unit] = js.native
  @JSName("__promisify__")
  def promisify(file: PathLike, data: Uint8Array, options: WriteFileOptions): js.Promise[Unit] = js.native
}
