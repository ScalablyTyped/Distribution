...
object realpathNs extends js.Object {
  ...
  def __promisify___buffer(path: nodeLib.fsMod.PathLike, options: gracefulDashFsLib.gracefulDashFsLibStrings.buffer): stdLib.Promise[nodeLib.Buffer] = js.native
  def native(
