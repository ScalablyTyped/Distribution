...
@js.native
object getenvModMembers extends js.Object {
  /**
  ...
  /**
    ...
    * ```
    */
  def multi[S /* <: org.scalablytyped.runtime.StringDictionary[java.lang.String | getenvLib.ParseWithFallback | getenvLib.ParseWithEachType] */](spec: S): getenvLib.getenvLibStrings.multi with ParseMappings = js.native
  /**
    * Return as string.
    */
