...
import typings.gridstack.typesMod.GridStackEventHandlerCallback
...
object gridstackMod {
  ...
  open class DDGridStack ()
    extends typings.gridstack.es5DdGridstackMod.DDGridStack
  /* static members */
  object DDGridStack {
    ...
    inline def get(): typings.gridstack.es5DdGridstackMod.DDGridStack = ^.asInstanceOf[js.Dynamic].applyDynamic("get")().asInstanceOf[typings.gridstack.es5DdGridstackMod.DDGridStack]
  }
