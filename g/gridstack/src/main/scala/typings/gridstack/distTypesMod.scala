...
import typings.gridstack.distGridstackEngineMod.GridStackEngine
...
object distTypesMod {
  ...
  / * nodes * / js.Array[typings.gridstack.distTypesMod.GridStackNode], 
  / * oldNodes * / js.Array[typings.gridstack.distTypesMod.GridStackNode], 
  scala.Unit]
  */
