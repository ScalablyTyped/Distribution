...
object GridstackOptions {
  ...
  def apply(
    ...
    if (cellHeightUnit != null) __obj.updateDynamic("cellHeightUnit")(cellHeightUnit)
    ...
    if (verticalMarginUnit != null) __obj.updateDynamic("verticalMarginUnit")(verticalMarginUnit)
