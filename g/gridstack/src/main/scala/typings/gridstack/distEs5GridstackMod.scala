...
object distEs5GridstackMod {
  ...
  object DDGridStack {
    ...
    inline def get(): typings.gridstack.distEs5DdGridstackMod.DDGridStack = ^.asInstanceOf[js.Dynamic].applyDynamic("get")().asInstanceOf[typings.gridstack.distEs5DdGridstackMod.DDGridStack]
  }
