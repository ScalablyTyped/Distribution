...
import typings.gridstack.distEs5TypesMod.AddRemoveFcn
import typings.gridstack.distEs5TypesMod.ColumnOptions
...
import typings.gridstack.distEs5TypesMod.GridStackEventHandlerCallback
...
import typings.gridstack.distEs5TypesMod.SaveFcn
...
object distEs5GridstackMod {
  ...
  open class DDGridStack ()
    extends typings.gridstack.distEs5DdGridstackMod.DDGridStack
  ...
  open class GridStack protected () extends StObject {
    ...
    var engine: typings.gridstack.distEs5GridstackEngineMod.GridStackEngine = js.native
  ...
  object GridStack {
    ...
    def Engine: Instantiable1[
        ...
        typings.gridstack.distEs5GridstackEngineMod.GridStackEngine
      ] = js.native
    inline def Engine_=(
      x: Instantiable1[
          /* opts */ js.UndefOr[GridStackEngineOptions], 
    ...
    /**
      ...
      */
    @JSImport("gridstack/dist/es5/gridstack", "GridStack.addRemoveCB")
    @js.native
    ...
    inline def getDD(): typings.gridstack.distEs5DdGridstackMod.DDGridStack = ^.asInstanceOf[js.Dynamic].applyDynamic("getDD")().asInstanceOf[typings.gridstack.distEs5DdGridstackMod.DDGridStack]
    ...
    /**
      ...
      */
    @JSImport("gridstack/dist/es5/gridstack", "GridStack.saveCB")
    @js.native
  ...
  open class GridStackEngine ()
    extends typings.gridstack.distEs5GridstackEngineMod.GridStackEngine {
  ...
  @js.native
  open class Utils ()
    extends typings.gridstack.distEs5UtilsMod.Utils
  /* static members */
  object Utils {
