...
object LoadBalancingConfig {
  ...
  @scala.inline
  def CdsLoadBalancingConfig(cds: CdsLbConfig): typings.grpcGrpcJs.loadBalancingConfigMod.CdsLoadBalancingConfig = {
  ...
  @scala.inline
  def EdsLoadBalancingConfig(eds: EdsLbConfig): typings.grpcGrpcJs.loadBalancingConfigMod.EdsLoadBalancingConfig = {
  ...
  @scala.inline
  def GrpcLbLoadBalancingConfig(grpclb: GrpcLbConfig): typings.grpcGrpcJs.loadBalancingConfigMod.GrpcLbLoadBalancingConfig = {
  ...
  @scala.inline
  def LrsLoadBalancingConfig(lrs: LrsLbConfig): typings.grpcGrpcJs.loadBalancingConfigMod.LrsLoadBalancingConfig = {
  ...
  @scala.inline
  def PickFirstLoadBalancingConfig(pick_first: PickFirstConfig): typings.grpcGrpcJs.loadBalancingConfigMod.PickFirstLoadBalancingConfig = {
  ...
  @scala.inline
  def PriorityLoadBalancingConfig(priority: PriorityLbConfig): typings.grpcGrpcJs.loadBalancingConfigMod.PriorityLoadBalancingConfig = {
  ...
  @scala.inline
  def RoundRobinLoadBalancingConfig(round_robin: RoundRobinConfig): typings.grpcGrpcJs.loadBalancingConfigMod.RoundRobinLoadBalancingConfig = {
  ...
  @scala.inline
  def WeightedTargetLoadBalancingConfig(weighted_target: WeightedTargetLbConfig): typings.grpcGrpcJs.loadBalancingConfigMod.WeightedTargetLoadBalancingConfig = {
  ...
  @scala.inline
  def XdsLoadBalancingConfig(xds: XdsConfig): typings.grpcGrpcJs.loadBalancingConfigMod.XdsLoadBalancingConfig = {
