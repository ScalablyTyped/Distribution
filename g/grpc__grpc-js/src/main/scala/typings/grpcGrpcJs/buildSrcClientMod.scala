...
import typings.grpcGrpcJs.buildSrcCallMod.SurfaceCall
...
import typings.grpcGrpcJs.buildSrcClientInterceptorsMod.Interceptor
import typings.grpcGrpcJs.buildSrcClientInterceptorsMod.InterceptorProvider
...
import typings.grpcGrpcJs.buildSrcMakeClientMod.ClientMethodDefinition
