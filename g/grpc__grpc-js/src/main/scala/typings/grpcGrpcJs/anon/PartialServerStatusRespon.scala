...
/* Inlined std.Partial<@grpc/grpc-js.@grpc/grpc-js/build/src/server-call.ServerStatusResponse> */
trait PartialServerStatusRespon extends StObject {
...
object PartialServerStatusRespon {
  
  inline def apply(): PartialServerStatusRespon = {
