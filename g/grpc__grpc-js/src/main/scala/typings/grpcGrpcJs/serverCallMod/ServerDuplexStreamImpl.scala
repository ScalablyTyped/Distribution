...
- typings.grpcGrpcJs.objectStreamMod.ObjectWritable because Inheritance from two classes. Inlined _write, write, write, write, write, setDefaultEncoding, end, end, end, end, end
- typings.grpcGrpcJs.objectStreamMod.IntermediateObjectReadable because var conflicts: destroyed, readable. Inlined  */ @JSImport("@grpc/grpc-js/build/src/server-call", "ServerDuplexStreamImpl")
@js.native
