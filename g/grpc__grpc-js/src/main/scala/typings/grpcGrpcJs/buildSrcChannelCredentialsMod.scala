...
object buildSrcChannelCredentialsMod {
  
  /* note: abstract class */ @JSImport("@grpc/grpc-js/build/src/channel-credentials", "ChannelCredentials")
  @js.native
  /* protected */ open class ChannelCredentials () extends StObject {
