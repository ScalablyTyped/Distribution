...
object EmitterAugmentation1 {
  ...
  @scala.inline
  implicit class EmitterAugmentation1Ops[Self <: EmitterAugmentation1[_, _], Name /* <: String | js.Symbol */, Arg] (val x: Self with (EmitterAugmentation1[Name, Arg])) extends AnyVal {
