...
object objectStreamMod {
  ...
  trait IntermediateObjectWritable[T] extends Writable {
    ...
    def _write(chunk: js.Any & T, encoding: String, callback: js.Function): Unit = js.native
    
    def end(chunk: js.Any & T): Unit = js.native
    def end(chunk: js.Any & T, cb: js.Function): Unit = js.native
    def end(chunk: js.Any & T, encoding: js.Any): Unit = js.native
    def end(chunk: js.Any & T, encoding: js.Any, cb: js.Function): Unit = js.native
    def end(chunk: js.Any & T, encoding: Unit, cb: js.Function): Unit = js.native
    
    def setDefaultEncoding(encoding: String): this.type = js.native
    
    def write(chunk: js.Any & T): Boolean = js.native
    def write(chunk: js.Any & T, cb: WriteCallback): Boolean = js.native
    def write(chunk: js.Any & T, encoding: js.Any): Boolean = js.native
    def write(chunk: js.Any & T, encoding: js.Any, cb: WriteCallback): Boolean = js.native
    def write(chunk: js.Any & T, encoding: Unit, cb: WriteCallback): Boolean = js.native
  }
  ...
  trait ObjectDuplex[T, U] extends StObject {
    ...
    def _write(chunk: (js.Any & T) | T, encoding: String, callback: js.Function): Unit = js.native
    def _write(
      chunk: js.Any,
    ...
    def end(chunk: (js.Any & T) | T): Unit = js.native
    def end(chunk: (js.Any & T) | T, cb: js.Function): Unit = js.native
    def end(chunk: (js.Any & T) | T, encoding: js.Any): Unit = js.native
    def end(chunk: (js.Any & T) | T, encoding: js.Any, cb: js.Function): Unit = js.native
    def end(chunk: (js.Any & T) | T, encoding: Unit, cb: js.Function): Unit = js.native
    ...
    @JSName("read")
    def read_Intersection(): js.Any & U = js.native
    @JSName("read")
    def read_Intersection(size: Double): js.Any & U = js.native
    @JSName("read")
    ...
    def write(chunk: js.Any & T, encoding: js.Any, cb: WriteCallback): Boolean = js.native
    def write(chunk: js.Any & T, encoding: Unit, cb: WriteCallback): Boolean = js.native
    def write(chunk: (js.Any & T) | T): Boolean = js.native
    def write(chunk: (js.Any & T) | T, encoding: js.Any): Boolean = js.native
