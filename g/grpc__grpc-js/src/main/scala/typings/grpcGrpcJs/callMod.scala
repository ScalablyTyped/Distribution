...
object callMod {
  ...
  - typings.grpcGrpcJs.callMod.SurfaceCall because Inheritance from two classes. Inlined call, cancel, getPeer */ @JSImport("@grpc/grpc-js/build/src/call", "ClientDuplexStreamImpl")
  @js.native
  open class ClientDuplexStreamImpl[RequestType, ResponseType] protected ()
    ...
    def end(chunk: RequestType, cb: js.Function): Unit | this.type = js.native
    def end(chunk: RequestType, encoding: Any): Unit | this.type = js.native
    def end(chunk: RequestType, encoding: Any, cb: js.Function): Unit | this.type = js.native
    def end(chunk: RequestType, encoding: Unit, cb: js.Function): Unit | this.type = js.native
    ...
    def read(): ResponseType = js.native
    def read(size: Double): ResponseType = js.native
  ...
  - typings.grpcGrpcJs.objectStreamMod.IntermediateObjectReadable because Inheritance from two classes. Inlined 
  - typings.grpcGrpcJs.eventsMod.EmitterAugmentation1 because Already inherited
  - typings.grpcGrpcJs.objectStreamMod.ObjectReadable because Inheritance from two classes. Inlined read, read */ @JSImport("@grpc/grpc-js/build/src/call", "ClientReadableStreamImpl")
  @js.native
  open class ClientReadableStreamImpl[ResponseType] protected ()
    ...
    /* standard dom */
    /* InferMemberOverrides */
    override def cancel(): js.Promise[Unit] & Unit = js.native
  ...
  - typings.grpcGrpcJs.objectStreamMod.IntermediateObjectWritable because Inheritance from two classes. Inlined 
  - typings.grpcGrpcJs.objectStreamMod.ObjectWritable because Inheritance from two classes. Inlined _write, write, write, write, write, write, setDefaultEncoding, end, end, end, end, end, end */ @JSImport("@grpc/grpc-js/build/src/call", "ClientWritableStreamImpl")
  @js.native
  open class ClientWritableStreamImpl[RequestType] protected ()
    ...
    def end(): Unit | this.type = js.native
    def end(chunk: RequestType): Unit | this.type = js.native
    def end(chunk: RequestType, cb: js.Function): Unit | this.type = js.native
    def end(chunk: RequestType, encoding: Any): Unit | this.type = js.native
    def end(chunk: RequestType, encoding: Any, cb: js.Function): Unit | this.type = js.native
    def end(chunk: RequestType, encoding: Unit, cb: js.Function): Unit | this.type = js.native
