...
class PolylineDecorator protected ()
  ...
  def this(paths: js.Array[
      leafletLib.leafletMod.LatLngExpression | leafletLib.leafletMod.Polygon[_] | (leafletLib.leafletMod.Polyline[geojsonLib.geojsonMod.LineString | geojsonLib.geojsonMod.MultiLineString, _]) | js.Array[leafletLib.leafletMod.LatLngExpression]
    ]) = this()
