...
import typings.libraCore.`lib@GeneratedEventsPbMod`.EventWithProof
...
object GetEventsByEventAccessPathResponse {
  ...
  trait AsObject extends StObject {
    ...
    var eventsWithProofList: js.Array[typings.libraCore.`lib@GeneratedEventsPbMod`.EventWithProof.AsObject]
  ...
  object AsObject {
    ...
    inline def apply(
      eventsWithProofList: js.Array[typings.libraCore.`lib@GeneratedEventsPbMod`.EventWithProof.AsObject]
    ): AsObject = {
    ...
    implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      inline def setEventsWithProofListVarargs(value: typings.libraCore.`lib@GeneratedEventsPbMod`.EventWithProof.AsObject*): Self = StObject.set(x, "eventsWithProofList", js.Array(value*))
      
      inline def setProofOfLatestEvent(value: typings.libraCore.`lib@GeneratedAccountStateBlobPbMod`.AccountStateWithProof.AsObject): Self = StObject.set(x, "proofOfLatestEvent", value.asInstanceOf[js.Any])
