...
import typings.libraCore.`lib@GeneratedTransactionPbMod`.TransactionListWithProof
...
object GetTransactionsResponse {
  ...
  trait AsObject extends StObject {
    ...
    var txnListWithProof: js.UndefOr[
        typings.libraCore.`lib@GeneratedTransactionPbMod`.TransactionListWithProof.AsObject
      ] = js.undefined
  }
  object AsObject {
