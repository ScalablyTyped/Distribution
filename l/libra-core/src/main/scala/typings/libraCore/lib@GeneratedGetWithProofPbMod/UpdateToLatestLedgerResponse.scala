...
import typings.libraCore.`lib@GeneratedLedgerInfoPbMod`.LedgerInfoWithSignatures
import typings.libraCore.`lib@GeneratedValidatorChangePbMod`.ValidatorChangeEventWithProof
...
object UpdateToLatestLedgerResponse {
  ...
  trait AsObject extends StObject {
    ...
    var ledgerInfoWithSigs: js.UndefOr[
        typings.libraCore.`lib@GeneratedLedgerInfoPbMod`.LedgerInfoWithSignatures.AsObject
      ] = js.undefined
    
    var responseItemsList: js.Array[typings.libraCore.`lib@GeneratedGetWithProofPbMod`.ResponseItem.AsObject]
    
    var validatorChangeEventsList: js.Array[
        typings.libraCore.`lib@GeneratedValidatorChangePbMod`.ValidatorChangeEventWithProof.AsObject
      ]
  }
  object AsObject {
    
    inline def apply(
      responseItemsList: js.Array[typings.libraCore.`lib@GeneratedGetWithProofPbMod`.ResponseItem.AsObject],
    ...
    implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      inline def setResponseItemsList(value: js.Array[typings.libraCore.`lib@GeneratedGetWithProofPbMod`.ResponseItem.AsObject]): Self = StObject.set(x, "responseItemsList", value.asInstanceOf[js.Any])
      
      inline def setResponseItemsListVarargs(value: typings.libraCore.`lib@GeneratedGetWithProofPbMod`.ResponseItem.AsObject*): Self = StObject.set(x, "responseItemsList", js.Array(value*))
      ...
      inline def setValidatorChangeEventsListVarargs(
        value: typings.libraCore.`lib@GeneratedValidatorChangePbMod`.ValidatorChangeEventWithProof.AsObject*
