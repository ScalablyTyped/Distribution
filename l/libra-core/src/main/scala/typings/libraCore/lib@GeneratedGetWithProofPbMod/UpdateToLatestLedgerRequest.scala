...
object UpdateToLatestLedgerRequest {
  ...
  trait AsObject extends StObject {
    ...
    var requestedItemsList: js.Array[typings.libraCore.`lib@GeneratedGetWithProofPbMod`.RequestItem.AsObject]
  }
  object AsObject {
    
    inline def apply(
      clientKnownVersion: String,
      requestedItemsList: js.Array[typings.libraCore.`lib@GeneratedGetWithProofPbMod`.RequestItem.AsObject]
    ): AsObject = {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setRequestedItemsList(value: js.Array[typings.libraCore.`lib@GeneratedGetWithProofPbMod`.RequestItem.AsObject]): Self = StObject.set(x, "requestedItemsList", value.asInstanceOf[js.Any])
      
      inline def setRequestedItemsListVarargs(value: typings.libraCore.`lib@GeneratedGetWithProofPbMod`.RequestItem.AsObject*): Self = StObject.set(x, "requestedItemsList", js.Array(value*))
    }
  }
}
