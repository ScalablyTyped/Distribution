...
import typings.libraCore.`lib@GeneratedAdmissionControlPbMod`.SubmitTransactionRequest
import typings.libraCore.`lib@GeneratedAdmissionControlPbMod`.SubmitTransactionResponse
import typings.libraCore.`lib@GeneratedGetWithProofPbMod`.UpdateToLatestLedgerRequest
import typings.libraCore.`lib@GeneratedGetWithProofPbMod`.UpdateToLatestLedgerResponse
