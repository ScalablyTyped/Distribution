...
object VMVerificationStatusList {
  ...
  trait AsObject extends StObject {
    ...
    var statusListList: js.Array[typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMVerificationStatus.AsObject]
  }
  object AsObject {
    
    inline def apply(
      statusListList: js.Array[typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMVerificationStatus.AsObject]
    ): AsObject = {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setStatusListListVarargs(value: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMVerificationStatus.AsObject*): Self = StObject.set(x, "statusListList", js.Array(value*))
    }
  }
}
