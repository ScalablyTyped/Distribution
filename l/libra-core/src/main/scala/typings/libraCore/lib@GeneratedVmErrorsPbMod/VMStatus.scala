...
import typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMStatus.ErrorTypeCase
...
object VMStatus {
  ...
  object ErrorTypeCase extends StObject {
    ...
    sealed trait DESERIALIZATION
      extends StObject
         with ErrorTypeCase
    /* 4 */ val DESERIALIZATION: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMStatus.ErrorTypeCase.DESERIALIZATION & Double = js.native
    
    @js.native
    sealed trait ERRORTYPE_NOT_SET
      extends StObject
         with ErrorTypeCase
    /* 0 */ val ERRORTYPE_NOT_SET: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMStatus.ErrorTypeCase.ERRORTYPE_NOT_SET & Double = js.native
    
    @js.native
    sealed trait EXECUTION
      extends StObject
         with ErrorTypeCase
    /* 5 */ val EXECUTION: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMStatus.ErrorTypeCase.EXECUTION & Double = js.native
    
    @js.native
    sealed trait INVARIANT_VIOLATION
      extends StObject
         with ErrorTypeCase
    /* 3 */ val INVARIANT_VIOLATION: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMStatus.ErrorTypeCase.INVARIANT_VIOLATION & Double = js.native
    
    @js.native
    sealed trait VALIDATION
      extends StObject
         with ErrorTypeCase
    /* 1 */ val VALIDATION: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMStatus.ErrorTypeCase.VALIDATION & Double = js.native
    
    @js.native
    sealed trait VERIFICATION
      extends StObject
         with ErrorTypeCase
    /* 2 */ val VERIFICATION: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMStatus.ErrorTypeCase.VERIFICATION & Double = js.native
  }
  ...
  trait AsObject extends StObject {
    ...
    var execution: js.UndefOr[typings.libraCore.`lib@GeneratedVmErrorsPbMod`.ExecutionStatus.AsObject] = js.undefined
    
    var invariantViolation: VMInvariantViolationError
    
    var validation: js.UndefOr[typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMValidationStatus.AsObject] = js.undefined
    
    var verification: js.UndefOr[typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMVerificationStatusList.AsObject] = js.undefined
  }
  object AsObject {
    ...
    implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      inline def setExecution(value: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.ExecutionStatus.AsObject): Self = StObject.set(x, "execution", value.asInstanceOf[js.Any])
      ...
      inline def setValidation(value: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMValidationStatus.AsObject): Self = StObject.set(x, "validation", value.asInstanceOf[js.Any])
      
      inline def setValidationUndefined: Self = StObject.set(x, "validation", js.undefined)
      
      inline def setVerification(value: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.VMVerificationStatusList.AsObject): Self = StObject.set(x, "verification", value.asInstanceOf[js.Any])
