...
import typings.libraCore.`lib@GeneratedVmErrorsPbMod`.DynamicReferenceError.DynamicReferenceErrorType
...
object DynamicReferenceError {
  ...
  object DynamicReferenceErrorType extends StObject {
    ...
    /* 4 */ val GLOBALALREADYBORROWED: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.DynamicReferenceError.DynamicReferenceErrorType.GLOBALALREADYBORROWED & Double = js.native
    
    @js.native
    sealed trait GLOBALREFALREADYRELEASED
      extends StObject
         with DynamicReferenceErrorType
    /* 2 */ val GLOBALREFALREADYRELEASED: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.DynamicReferenceError.DynamicReferenceErrorType.GLOBALREFALREADYRELEASED & Double = js.native
    
    @js.native
    sealed trait MISSINGRELEASEREF
      extends StObject
         with DynamicReferenceErrorType
    /* 3 */ val MISSINGRELEASEREF: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.DynamicReferenceError.DynamicReferenceErrorType.MISSINGRELEASEREF & Double = js.native
    
    @js.native
    sealed trait MOVEOFBORROWEDRESOURCE
      extends StObject
         with DynamicReferenceErrorType
    /* 1 */ val MOVEOFBORROWEDRESOURCE: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.DynamicReferenceError.DynamicReferenceErrorType.MOVEOFBORROWEDRESOURCE & Double = js.native
    
    @js.native
    sealed trait UNKNOWNDYNAMICREFERENCEERROR
      extends StObject
         with DynamicReferenceErrorType
    /* 0 */ val UNKNOWNDYNAMICREFERENCEERROR: typings.libraCore.`lib@GeneratedVmErrorsPbMod`.DynamicReferenceError.DynamicReferenceErrorType.UNKNOWNDYNAMICREFERENCEERROR & Double = js.native
  }
