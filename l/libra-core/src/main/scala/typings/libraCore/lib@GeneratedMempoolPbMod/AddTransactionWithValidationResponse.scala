...
object AddTransactionWithValidationResponse {
  ...
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setStatus(value: typings.libraCore.`lib@GeneratedMempoolStatusPbMod`.MempoolAddTransactionStatus.AsObject): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
