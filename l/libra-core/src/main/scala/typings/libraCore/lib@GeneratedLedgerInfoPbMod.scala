...
object `lib@GeneratedLedgerInfoPbMod` {
  ...
  object LedgerInfoWithSignatures {
    ...
    trait AsObject extends StObject {
      ...
      var ledgerInfo: js.UndefOr[typings.libraCore.`lib@GeneratedLedgerInfoPbMod`.LedgerInfo.AsObject] = js.undefined
      
      var signaturesList: js.Array[typings.libraCore.`lib@GeneratedLedgerInfoPbMod`.ValidatorSignature.AsObject]
    }
    object AsObject {
      
      inline def apply(
        signaturesList: js.Array[typings.libraCore.`lib@GeneratedLedgerInfoPbMod`.ValidatorSignature.AsObject]
      ): AsObject = {
      ...
      implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        inline def setSignaturesList(value: js.Array[typings.libraCore.`lib@GeneratedLedgerInfoPbMod`.ValidatorSignature.AsObject]): Self = StObject.set(x, "signaturesList", value.asInstanceOf[js.Any])
        
        inline def setSignaturesListVarargs(value: typings.libraCore.`lib@GeneratedLedgerInfoPbMod`.ValidatorSignature.AsObject*): Self = StObject.set(x, "signaturesList", js.Array(value*))
      }
    }
  }
