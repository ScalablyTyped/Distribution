...
object CommitTransactionsRequest {
  ...
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setTransactionsListVarargs(value: typings.libraCore.mempoolPbMod.CommittedTransaction.AsObject*): Self = StObject.set(x, "transactionsList", js.Array(value*))
    }
  }
}
