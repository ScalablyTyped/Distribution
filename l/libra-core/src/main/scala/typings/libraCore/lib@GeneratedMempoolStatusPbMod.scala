...
object `lib@GeneratedMempoolStatusPbMod` {
  ...
  object MempoolAddTransactionStatusCode extends StObject {
    ...
    /* 1 */ val INSUFFICIENTBALANCE: typings.libraCore.`lib@GeneratedMempoolStatusPbMod`.MempoolAddTransactionStatusCode.INSUFFICIENTBALANCE & Double = js.native
    
    @js.native
    sealed trait INVALIDSEQNUMBER
      extends StObject
         with MempoolAddTransactionStatusCode
    /* 2 */ val INVALIDSEQNUMBER: typings.libraCore.`lib@GeneratedMempoolStatusPbMod`.MempoolAddTransactionStatusCode.INVALIDSEQNUMBER & Double = js.native
    
    @js.native
    sealed trait INVALIDUPDATE
      extends StObject
         with MempoolAddTransactionStatusCode
    /* 5 */ val INVALIDUPDATE: typings.libraCore.`lib@GeneratedMempoolStatusPbMod`.MempoolAddTransactionStatusCode.INVALIDUPDATE & Double = js.native
    
    @js.native
    sealed trait MEMPOOLISFULL
      extends StObject
         with MempoolAddTransactionStatusCode
    /* 3 */ val MEMPOOLISFULL: typings.libraCore.`lib@GeneratedMempoolStatusPbMod`.MempoolAddTransactionStatusCode.MEMPOOLISFULL & Double = js.native
    
    @js.native
    sealed trait TOOMANYTRANSACTIONS
      extends StObject
         with MempoolAddTransactionStatusCode
    /* 4 */ val TOOMANYTRANSACTIONS: typings.libraCore.`lib@GeneratedMempoolStatusPbMod`.MempoolAddTransactionStatusCode.TOOMANYTRANSACTIONS & Double = js.native
    
    @js.native
    sealed trait VALID
      extends StObject
         with MempoolAddTransactionStatusCode
    /* 0 */ val VALID: typings.libraCore.`lib@GeneratedMempoolStatusPbMod`.MempoolAddTransactionStatusCode.VALID & Double = js.native
  }
}
