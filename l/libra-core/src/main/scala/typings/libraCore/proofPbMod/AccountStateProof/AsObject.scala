...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransactionInfoToAccountProof(value: typings.libraCore.proofPbMod.SparseMerkleProof.AsObject): Self = this.set("transactionInfoToAccountProof", value.asInstanceOf[js.Any])
    @scala.inline
