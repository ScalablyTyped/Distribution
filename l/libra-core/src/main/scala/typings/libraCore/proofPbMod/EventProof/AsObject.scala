...
object AsObject {
  ...
  implicit class AsObjectOps[Self <: AsObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTransactionInfoToEventProof(value: typings.libraCore.proofPbMod.AccumulatorProof.AsObject): Self = this.set("transactionInfoToEventProof", value.asInstanceOf[js.Any])
    @scala.inline
