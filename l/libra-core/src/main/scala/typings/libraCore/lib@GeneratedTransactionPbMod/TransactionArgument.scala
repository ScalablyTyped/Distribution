...
import typings.libraCore.`lib@GeneratedTransactionPbMod`.TransactionArgument.ArgType
...
object TransactionArgument {
  ...
  object ArgType extends StObject {
    ...
    sealed trait ADDRESS
      extends StObject
         with ArgType
    /* 1 */ val ADDRESS: typings.libraCore.`lib@GeneratedTransactionPbMod`.TransactionArgument.ArgType.ADDRESS & Double = js.native
    
    @js.native
    sealed trait BYTEARRAY
      extends StObject
         with ArgType
    /* 3 */ val BYTEARRAY: typings.libraCore.`lib@GeneratedTransactionPbMod`.TransactionArgument.ArgType.BYTEARRAY & Double = js.native
    
    @js.native
    sealed trait STRING
      extends StObject
         with ArgType
    /* 2 */ val STRING: typings.libraCore.`lib@GeneratedTransactionPbMod`.TransactionArgument.ArgType.STRING & Double = js.native
    
    @js.native
    sealed trait U64
      extends StObject
         with ArgType
    /* 0 */ val U64: typings.libraCore.`lib@GeneratedTransactionPbMod`.TransactionArgument.ArgType.U64 & Double = js.native
  }
