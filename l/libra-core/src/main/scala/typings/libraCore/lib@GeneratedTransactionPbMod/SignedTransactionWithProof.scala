...
import typings.libraCore.`lib@GeneratedEventsPbMod`.EventsList
import typings.libraCore.`lib@GeneratedProofPbMod`.SignedTransactionProof
...
object SignedTransactionWithProof {
  ...
  trait AsObject extends StObject {
    ...
    var events: js.UndefOr[typings.libraCore.`lib@GeneratedEventsPbMod`.EventsList.AsObject] = js.undefined
    
    var proof: js.UndefOr[typings.libraCore.`lib@GeneratedProofPbMod`.SignedTransactionProof.AsObject] = js.undefined
    
    var signedTransaction: js.UndefOr[typings.libraCore.`lib@GeneratedTransactionPbMod`.SignedTransaction.AsObject] = js.undefined
  ...
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setProof(value: typings.libraCore.`lib@GeneratedProofPbMod`.SignedTransactionProof.AsObject): Self = StObject.set(x, "proof", value.asInstanceOf[js.Any])
      
      inline def setProofUndefined: Self = StObject.set(x, "proof", js.undefined)
      
      inline def setSignedTransaction(value: typings.libraCore.`lib@GeneratedTransactionPbMod`.SignedTransaction.AsObject): Self = StObject.set(x, "signedTransaction", value.asInstanceOf[js.Any])
