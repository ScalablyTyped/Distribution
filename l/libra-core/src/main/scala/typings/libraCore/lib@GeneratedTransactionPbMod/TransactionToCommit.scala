...
import typings.libraCore.`lib@GeneratedEventsPbMod`.Event
...
object TransactionToCommit {
  ...
  trait AsObject extends StObject {
    ...
    var accountStatesList: js.Array[typings.libraCore.`lib@GeneratedTransactionPbMod`.AccountState.AsObject]
    
    var eventsList: js.Array[typings.libraCore.`lib@GeneratedEventsPbMod`.Event.AsObject]
  ...
  object AsObject {
    ...
    inline def apply(
      accountStatesList: js.Array[typings.libraCore.`lib@GeneratedTransactionPbMod`.AccountState.AsObject],
      eventsList: js.Array[typings.libraCore.`lib@GeneratedEventsPbMod`.Event.AsObject],
      gasUsed: String
    ): AsObject = {
    ...
    implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
      ...
      inline def setAccountStatesListVarargs(value: typings.libraCore.`lib@GeneratedTransactionPbMod`.AccountState.AsObject*): Self = StObject.set(x, "accountStatesList", js.Array(value*))
      ...
      inline def setEventsListVarargs(value: typings.libraCore.`lib@GeneratedEventsPbMod`.Event.AsObject*): Self = StObject.set(x, "eventsList", js.Array(value*))
