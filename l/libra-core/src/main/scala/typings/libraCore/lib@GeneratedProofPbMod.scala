...
object `lib@GeneratedProofPbMod` {
  ...
  object AccountStateProof {
    ...
    trait AsObject extends StObject {
      ...
      var ledgerInfoToTransactionInfoProof: js.UndefOr[typings.libraCore.`lib@GeneratedProofPbMod`.AccumulatorProof.AsObject] = js.undefined
      
      var transactionInfo: js.UndefOr[typings.libraCore.`lib@GeneratedTransactionInfoPbMod`.TransactionInfo.AsObject] = js.undefined
      
      var transactionInfoToAccountProof: js.UndefOr[typings.libraCore.`lib@GeneratedProofPbMod`.SparseMerkleProof.AsObject] = js.undefined
    }
    object AsObject {
      ...
      implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        inline def setTransactionInfo(value: typings.libraCore.`lib@GeneratedTransactionInfoPbMod`.TransactionInfo.AsObject): Self = StObject.set(x, "transactionInfo", value.asInstanceOf[js.Any])
        
        inline def setTransactionInfoToAccountProof(value: typings.libraCore.`lib@GeneratedProofPbMod`.SparseMerkleProof.AsObject): Self = StObject.set(x, "transactionInfoToAccountProof", value.asInstanceOf[js.Any])
  ...
  object EventProof {
    ...
    trait AsObject extends StObject {
      ...
      var transactionInfoToEventProof: js.UndefOr[typings.libraCore.`lib@GeneratedProofPbMod`.AccumulatorProof.AsObject] = js.undefined
    }
    object AsObject {
      ...
      implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        inline def setTransactionInfoToEventProof(value: typings.libraCore.`lib@GeneratedProofPbMod`.AccumulatorProof.AsObject): Self = StObject.set(x, "transactionInfoToEventProof", value.asInstanceOf[js.Any])
