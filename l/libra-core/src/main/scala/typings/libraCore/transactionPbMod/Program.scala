...
object Program {
  ...
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setArgumentsListVarargs(value: typings.libraCore.transactionPbMod.TransactionArgument.AsObject*): Self = StObject.set(x, "argumentsList", js.Array(value*))
