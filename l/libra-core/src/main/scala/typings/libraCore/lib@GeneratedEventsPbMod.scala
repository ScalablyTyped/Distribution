...
import typings.libraCore.`lib@GeneratedProofPbMod`.EventProof
...
object `lib@GeneratedEventsPbMod` {
  ...
  object EventWithProof {
    ...
    trait AsObject extends StObject {
      ...
      var event: js.UndefOr[typings.libraCore.`lib@GeneratedEventsPbMod`.Event.AsObject] = js.undefined
      
      var eventIndex: String
      
      var proof: js.UndefOr[typings.libraCore.`lib@GeneratedProofPbMod`.EventProof.AsObject] = js.undefined
    ...
    object AsObject {
      ...
      implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        inline def setProof(value: typings.libraCore.`lib@GeneratedProofPbMod`.EventProof.AsObject): Self = StObject.set(x, "proof", value.asInstanceOf[js.Any])
  ...
  object EventsForVersions {
    ...
    trait AsObject extends StObject {
      ...
      var eventsForVersionList: js.Array[typings.libraCore.`lib@GeneratedEventsPbMod`.EventsList.AsObject]
    }
    object AsObject {
      
      inline def apply(eventsForVersionList: js.Array[typings.libraCore.`lib@GeneratedEventsPbMod`.EventsList.AsObject]): AsObject = {
      ...
      implicit open class MutableBuilder[Self <: AsObject] (val x: Self) extends AnyVal {
        ...
        inline def setEventsForVersionListVarargs(value: typings.libraCore.`lib@GeneratedEventsPbMod`.EventsList.AsObject*): Self = StObject.set(x, "eventsForVersionList", js.Array(value*))
      }
    }
  }
  ...
  object EventsList {
    ...
    object AsObject {
      ...
      inline def apply(eventsList: js.Array[typings.libraCore.`lib@GeneratedEventsPbMod`.Event.AsObject]): AsObject = {
