...
object `lib@GeneratedValidatorChangePbMod` {
  ...
  object ValidatorChangeEventWithProof {
    ...
    trait AsObject extends StObject {
      ...
      var eventWithProof: js.UndefOr[typings.libraCore.`lib@GeneratedEventsPbMod`.EventWithProof.AsObject] = js.undefined
    ...
    object AsObject {
      ...
      extension [Self <: AsObject](x: Self) {
        ...
        inline def setEventWithProof(value: typings.libraCore.`lib@GeneratedEventsPbMod`.EventWithProof.AsObject): Self = StObject.set(x, "eventWithProof", value.asInstanceOf[js.Any])
