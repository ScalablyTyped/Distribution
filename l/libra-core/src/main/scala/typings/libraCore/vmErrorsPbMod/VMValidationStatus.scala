...
object VMValidationStatus {
  ...
  inline def deserializeBinary(bytes: Uint8Array): VMValidationStatus = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeBinary")(bytes.asInstanceOf[js.Any]).asInstanceOf[VMValidationStatus]
