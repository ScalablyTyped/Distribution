...
trait Anon_Dest extends js.Object {
  var inflate: js.UndefOr[js.Function2[/* src */ js.Object, /* dest */ js.UndefOr[js.Object], scala.Unit]] = js.undefined
...
object Anon_Dest {
  @scala.inline
  def apply(
    inflate: (/* src */ js.Object, /* dest */ js.UndefOr[js.Object]) => scala.Unit = null,
    proto: js.Any = null
  ): Anon_Dest = {
