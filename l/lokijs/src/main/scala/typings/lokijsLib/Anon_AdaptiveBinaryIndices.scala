...
trait Anon_AdaptiveBinaryIndices extends js.Object {
  var adaptiveBinaryIndices: js.UndefOr[scala.Boolean] = js.undefined
}

object Anon_AdaptiveBinaryIndices {
  @scala.inline
  def apply(adaptiveBinaryIndices: js.UndefOr[scala.Boolean] = js.undefined): Anon_AdaptiveBinaryIndices = {
