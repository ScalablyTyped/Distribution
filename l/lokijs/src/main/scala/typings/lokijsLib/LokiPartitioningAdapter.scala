...
class LokiPartitioningAdapter protected () extends LokiPersistenceAdapter {
  ...
  var dbname: java.lang.String = js.native
  var dbref: Loki | scala.Null = js.native
  var dirtyPartitions: js.UndefOr[js.Array[scala.Double]] = js.native
  @JSName("mode")
  var mode_LokiPartitioningAdapter: java.lang.String = js.native
  ...
  def exportDatabase_MLokiPartitioningAdapter(
  ...
  /**
    ...
    * @param callback - adapter callback to return load result to caller
    */
  def loadNextPage(callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    ...
    * @param callback - adapter callback to return load result to caller
    */
  def loadNextPartition(partition: scala.Double, callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    * Helper method used internally to generate and save the next page of the current (dirty) partition.
    *
    * @param callback - adapter callback to return load result to caller
    */
  def saveNextPage(callback: js.Function1[/* err */ stdLib.Error | scala.Null, scala.Unit]): scala.Unit = js.native
  /**
    * Helper method used internally to save each dirty collection, one at a time.
    *
    * @param callback - adapter callback to return load result to caller
    */
  def saveNextPartition(callback: js.Function1[/* err */ stdLib.Error | scala.Null, scala.Unit]): scala.Unit = js.native
}
