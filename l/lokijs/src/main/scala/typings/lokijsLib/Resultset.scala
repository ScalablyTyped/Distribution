...
class Resultset[E /* <: js.Object */] protected () extends js.Object {
  ...
  var filterInitialized: scala.Boolean = js.native
  var filteredrows: js.Array[scala.Double] = js.native
  @JSName("$and")
  ...
  /**
    ...
    */
  def compoundsort(properties: js.Array[js.Tuple2[java.lang.String, scala.Boolean]]): this.type = js.native
  /**
  ...
  def eqJoin(joinData: js.Array[_], leftJoinKey: java.lang.String, rightJoinKey: java.lang.String): Resultset[_] = js.native
  def eqJoin(
    joinData: js.Array[_],
    leftJoinKey: java.lang.String,
    rightJoinKey: java.lang.String,
  ...
  def eqJoin(
    joinData: js.Array[_],
    leftJoinKey: java.lang.String,
    rightJoinKey: js.Function1[/* obj */ js.Any, java.lang.String]
  ): Resultset[_] = js.native
  def eqJoin(
    joinData: js.Array[_],
    leftJoinKey: java.lang.String,
  ...
  def eqJoin(
    joinData: js.Array[_],
    leftJoinKey: js.Function1[/* obj */ js.Any, java.lang.String],
    rightJoinKey: java.lang.String
  ): Resultset[_] = js.native
  def eqJoin(
    joinData: js.Array[_],
  ...
  /**
    ...
    */
  def eqJoin(joinData: Collection[_], leftJoinKey: java.lang.String, rightJoinKey: java.lang.String): Resultset[_] = js.native
  def eqJoin(
  ...
  def eqJoin(joinData: Resultset[_], leftJoinKey: java.lang.String, rightJoinKey: java.lang.String): Resultset[_] = js.native
  def eqJoin(
  ...
  def find(query: LokiQuery[E], firstOnly: scala.Boolean): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def limit(qty: scala.Double): Resultset[E] = js.native
  /**
    ...
    * @param [dataOptions.forceCloneMethod] - Allows overriding the default or collection specified cloning method.
    */
  def map[U /* <: js.Object */](mapFun: js.Function3[/* value */ E, /* index */ scala.Double, /* array */ js.Array[E], U]): Resultset[U] = js.native
  def map[U /* <: js.Object */](
    mapFun: js.Function3[/* value */ E, /* index */ scala.Double, /* array */ js.Array[E], U],
    dataOptions: stdLib.Partial[GetDataOptions]
  ...
  /**
    ...
    */
  def offset(pos: scala.Double): Resultset[E] = js.native
  /**
  ...
  /**
    ...
    * @returns Reference to this resultset, sorted, for future chain operations.
    */
  def simplesort(propname: java.lang.String): this.type = js.native
  def simplesort(propname: java.lang.String, options: scala.Boolean): this.type = js.native
  def simplesort(propname: java.lang.String, options: stdLib.Partial[SimplesortOptions]): this.type = js.native
  /**
    ...
    * @returns Reference to this resultset, sorted, for future chain operations.
    */
  def sort(comparefun: js.Function2[/* a */ E with LokiObj, /* b */ E with LokiObj, scala.Double]): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def transform(transform: java.lang.String): Resultset[_] = js.native
  def transform(transform: java.lang.String, parameters: js.Object): Resultset[_] = js.native
  def transform(transform: js.Array[java.lang.String | Transform]): Resultset[_] = js.native
  def transform(transform: js.Array[java.lang.String | Transform], parameters: js.Object): Resultset[_] = js.native
  /**
    ...
    * @returns this resultset for further chain ops.
    */
  def update(updateFunction: js.Function1[/* obj */ E, scala.Unit]): this.type = js.native
  /**
    ...
    * @returns this resultset for further chain ops.
    */
  def where(fun: js.Function1[/* data */ E with LokiObj, scala.Boolean]): this.type = js.native
}
