...
class DynamicView[E /* <: js.Object */] protected () extends LokiEventEmitter {
  /**
    ...
    */
  def this(collection: Collection[E], name: java.lang.String) = this()
  def this(collection: Collection[E], name: java.lang.String, options: stdLib.Partial[DynamicViewOptions]) = this()
  var cachedresultset: Resultset[E] | scala.Null = js.native
  var collection: Collection[E] = js.native
  var filterPipeline: js.Array[Anon_Find] = js.native
  var name: java.lang.String = js.native
  var options: stdLib.Partial[DynamicViewOptions] = js.native
  var rebuildPending: scala.Boolean = js.native
  var resultdata: js.Array[E with LokiObj] = js.native
  var resultsdirty: scala.Boolean = js.native
  var resultset: Resultset[E] = js.native
  var sortCriteria: (js.Array[js.Tuple2[java.lang.String, scala.Boolean]]) | scala.Null = js.native
  var sortDirty: scala.Boolean = js.native
  var sortFunction: (js.Function2[/* a */ E with LokiObj, /* b */ E with LokiObj, scala.Double]) | scala.Null = js.native
  /**
    ...
    */
  def _addFilter(filter: Anon_Find): scala.Unit = js.native
  /**
    * Implementation detail.
    ...
    */
  def _indexOfFilterWithId(): scala.Double = js.native
  def _indexOfFilterWithId(uid: java.lang.String): scala.Double = js.native
  def _indexOfFilterWithId(uid: scala.Double): scala.Double = js.native
  /**
  ...
  def applyFind(query: js.Any, uid: java.lang.String): this.type = js.native
  def applyFind(query: js.Any, uid: scala.Double): this.type = js.native
  /**
    ...
    * @returns this DynamicView object, for further chain ops.
    */
  def applySimpleSort(propname: java.lang.String): this.type = js.native
  def applySimpleSort(propname: java.lang.String, options: scala.Boolean): this.type = js.native
  def applySimpleSort(propname: java.lang.String, options: stdLib.Partial[SimplesortOptions]): this.type = js.native
  /**
    ...
    * @returns this DynamicView object, for further chain ops.
    */
  def applySort(comparefun: js.Function2[/* a */ E with LokiObj, /* b */ E with LokiObj, scala.Double]): this.type = js.native
  /**
    ...
    */
  def applySortCriteria(criteria: js.Array[js.Tuple2[java.lang.String, scala.Boolean]]): this.type = js.native
  /**
    ...
    * @returns this DynamicView object, for further chain ops.
    */
  def applyWhere(fun: js.Function1[/* obj */ js.Any, scala.Boolean]): this.type = js.native
  def applyWhere(fun: js.Function1[/* obj */ js.Any, scala.Boolean], uid: java.lang.String): this.type = js.native
  def applyWhere(fun: js.Function1[/* obj */ js.Any, scala.Boolean], uid: scala.Double): this.type = js.native
  /**
    ...
    */
  def branchResultset(transform: java.lang.String): Resultset[_] = js.native
  def branchResultset(transform: java.lang.String, parameters: js.Object): Resultset[_] = js.native
  def branchResultset(transform: js.Array[java.lang.String | Transform]): Resultset[_] = js.native
  def branchResultset(transform: js.Array[java.lang.String | Transform], parameters: js.Object): Resultset[_] = js.native
  /**
  ...
  def data(options: stdLib.Partial[GetDataOptions]): js.Array[E with LokiObj] = js.native
  def evaluateDocument(objIndex: java.lang.String): scala.Unit = js.native
  def evaluateDocument(objIndex: java.lang.String, isNew: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def evaluateDocument(objIndex: scala.Double): scala.Unit = js.native
  def evaluateDocument(objIndex: scala.Double, isNew: scala.Boolean): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def performSortPhase(): scala.Unit = js.native
  def performSortPhase(options: Anon_Persistent): scala.Unit = js.native
  /**
    * queueRebuildEvent() - When the view is not sorted we may still wish to be notified of rebuild events.
    *     This event will throttle and queue a single rebuild event when batches of updates affect the view.
    */
  def queueRebuildEvent(): scala.Unit = js.native
  /**
    * queueSortPhase : If the view is sorted we will throttle sorting to either :
    *    (1) passive - when the user calls data(), or
    *    (2) active - once they stop updating and yield js thread control
    */
  def queueSortPhase(): scala.Unit = js.native
  /**
  ...
  def removeDocument(objIndex: java.lang.String): scala.Unit = js.native
  /**
    * removeDocument() - internal function called on collection.delete()
    */
  def removeDocument(objIndex: scala.Double): scala.Unit = js.native
  /**
    ...
    * @returns this DynamicView object, for further chain ops.
    */
  def removeFilter(uid: java.lang.String): this.type = js.native
  def removeFilter(uid: scala.Double): this.type = js.native
  /**
    ...
    */
  def removeFilters(): scala.Unit = js.native
  def removeFilters(options: Anon_QueueSortPhase): scala.Unit = js.native
  /**
