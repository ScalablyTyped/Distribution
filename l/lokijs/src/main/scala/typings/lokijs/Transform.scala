...
object Transform {
  ...
  extension [Self <: Transform](x: Self) {
    ...
    inline def setDataOptions(value: js.Any): Self = StObject.set(x, "dataOptions", value.asInstanceOf[js.Any])
    ...
    inline def setJoinData(value: js.Any): Self = StObject.set(x, "joinData", value.asInstanceOf[js.Any])
    
    inline def setJoinDataUndefined: Self = StObject.set(x, "joinData", js.undefined)
    
    inline def setLeftJoinKey(value: js.Any): Self = StObject.set(x, "leftJoinKey", value.asInstanceOf[js.Any])
    
    inline def setLeftJoinKeyUndefined: Self = StObject.set(x, "leftJoinKey", js.undefined)
    
    inline def setMapFun(value: js.Any): Self = StObject.set(x, "mapFun", value.asInstanceOf[js.Any])
    
    inline def setMapFunUndefined: Self = StObject.set(x, "mapFun", js.undefined)
    
    inline def setMapFunction(value: js.Any): Self = StObject.set(x, "mapFunction", value.asInstanceOf[js.Any])
    ...
    inline def setReduceFunction(value: js.Any): Self = StObject.set(x, "reduceFunction", value.asInstanceOf[js.Any])
    
    inline def setReduceFunctionUndefined: Self = StObject.set(x, "reduceFunction", js.undefined)
    
    inline def setRightJoinKey(value: js.Any): Self = StObject.set(x, "rightJoinKey", value.asInstanceOf[js.Any])
