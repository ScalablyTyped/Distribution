...
object LokiLocalStorageAdapter {
  ...
  inline def apply(
    ...
    loadDatabase: (String, js.Function1[/* dataOrError */ Any | js.Error, Unit]) => Unit,
  ...
  implicit open class MutableBuilder[Self <: LokiLocalStorageAdapter] (val x: Self) extends AnyVal {
    ...
    inline def setLoadDatabase(value: (String, js.Function1[/* dataOrError */ Any | js.Error, Unit]) => Unit): Self = StObject.set(x, "loadDatabase", js.Any.fromFunction2(value))
    
    inline def setSaveDatabase(value: (String, String, js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Unit): Self = StObject.set(x, "saveDatabase", js.Any.fromFunction3(value))
  }
}
