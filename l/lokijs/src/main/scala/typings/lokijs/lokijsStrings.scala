...
object lokijsStrings {
  ...
  @js.native
  sealed trait $aeq extends StObject
  inline def $aeq: $aeq = "$aeq".asInstanceOf[$aeq]
  ...
  @js.native
  sealed trait $dteq extends StObject
  inline def $dteq: $dteq = "$dteq".asInstanceOf[$dteq]
  ...
  @js.native
  sealed trait $gte extends StObject
  ...
  @js.native
  sealed trait $lte extends StObject
  ...
  @js.native
  sealed trait NATIVESCRIPT extends StObject
  ...
  @js.native
  sealed trait adapter extends StObject
  inline def adapter: adapter = "adapter".asInstanceOf[adapter]
  
  @js.native
  sealed trait autosaveHandle extends StObject
  inline def autosaveHandle: autosaveHandle = "autosaveHandle".asInstanceOf[autosaveHandle]
  
  @js.native
  sealed trait compoundsort extends StObject
  inline def compoundsort: compoundsort = "compoundsort".asInstanceOf[compoundsort]
  ...
  @js.native
  sealed trait destructured extends StObject
  inline def destructured: destructured = "destructured".asInstanceOf[destructured]
  
  @js.native
  sealed trait eqJoin extends StObject
  inline def eqJoin: eqJoin = "eqJoin".asInstanceOf[eqJoin]
  ...
  @js.native
  sealed trait `jquery-extend-deep` extends StObject
  inline def `jquery-extend-deep`: `jquery-extend-deep` = "jquery-extend-deep".asInstanceOf[`jquery-extend-deep`]
  ...
  @js.native
  sealed trait mapReduce extends StObject
  inline def mapReduce: mapReduce = "mapReduce".asInstanceOf[mapReduce]
  ...
  @js.native
  sealed trait `parse-stringify` extends StObject
  inline def `parse-stringify`: `parse-stringify` = "parse-stringify".asInstanceOf[`parse-stringify`]
  
  @js.native
  sealed trait passive extends StObject
  inline def passive: passive = "passive".asInstanceOf[passive]
  
  @js.native
  sealed trait persistenceAdapter extends StObject
  inline def persistenceAdapter: persistenceAdapter = "persistenceAdapter".asInstanceOf[persistenceAdapter]
  
  @js.native
  sealed trait pretty extends StObject
  inline def pretty: pretty = "pretty".asInstanceOf[pretty]
  ...
  @js.native
  sealed trait `shallow-assign` extends StObject
  inline def `shallow-assign`: `shallow-assign` = "shallow-assign".asInstanceOf[`shallow-assign`]
  
  @js.native
  sealed trait `shallow-recurse-objects` extends StObject
  inline def `shallow-recurse-objects`: `shallow-recurse-objects` = "shallow-recurse-objects".asInstanceOf[`shallow-recurse-objects`]
  
  @js.native
  sealed trait simplesort extends StObject
  inline def simplesort: simplesort = "simplesort".asInstanceOf[simplesort]
  ...
  @js.native
  sealed trait throttledCallbacks extends StObject
  inline def throttledCallbacks: throttledCallbacks = "throttledCallbacks".asInstanceOf[throttledCallbacks]
  
  @js.native
  sealed trait throttledSavePending extends StObject
  inline def throttledSavePending: throttledSavePending = "throttledSavePending".asInstanceOf[throttledSavePending]
  
  @js.native
  sealed trait ttl extends StObject
