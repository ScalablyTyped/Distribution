...
trait AnonDelimitedDelimiterPartition extends js.Object {
...
object AnonDelimitedDelimiterPartition {
  @scala.inline
  def apply(
  ...
  ): AnonDelimitedDelimiterPartition = {
    ...
    __obj.asInstanceOf[AnonDelimitedDelimiterPartition]
  }
}
