...
@JSImport("lodash-es/string.default", JSImport.Namespace)
@js.native
object stringDefaultMod extends js.Object {
  @js.native
  object default extends js.Object {
    var camelCase: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof camelCase */ js.Any = js.native
    ...
    var split: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof split */ js.Any = js.native
    var startCase: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof startCase */ js.Any = js.native
    var startsWith: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof startsWith */ js.Any = js.native
    var template: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof template */ js.Any = js.native
    var templateSettings: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof templateSettings */ js.Any = js.native
    var toLower: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof toLower */ js.Any = js.native
    var toUpper: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof toUpper */ js.Any = js.native
    var trim: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof trim */ js.Any = js.native
