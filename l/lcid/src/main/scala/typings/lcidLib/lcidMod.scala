...
object lcidMod extends js.Object {
  /**
  	...
  	```
  	*/
  val all: org.scalablytyped.runtime.StringDictionary[scala.Double] = js.native
  /**
  	...
  	```
  	*/
  def from(lcidCode: scala.Double): java.lang.String = js.native
  /**
  	...
  	```
  	*/
  def to(localeId: java.lang.String): scala.Double = js.native
}
