...
class Matrix protected () extends js.Object {
  ...
  def isEqualTo(other: Matrix): scala.Boolean = js.native
  ...
  def setRotation(_axis: Vector3, angleRadians: scala.Double): scala.Unit = js.native
...
object Matrix extends js.Object {
  def identity(): leapmotiontsLib.leapmotiontsMod.Matrix = js.native
}
