...
trait ListrTask extends js.Object {
  ...
  def task(ctx: js.Any, task: ListrTaskWrapper): scala.Unit | java.lang.String | js.Promise[_] | nodeLib.streamMod.Readable | Listr
}

object ListrTask {
  @scala.inline
  def apply(
    task: (js.Any, ListrTaskWrapper) => scala.Unit | java.lang.String | js.Promise[_] | nodeLib.streamMod.Readable | Listr,
