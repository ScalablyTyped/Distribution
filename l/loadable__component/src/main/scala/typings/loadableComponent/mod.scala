...
object mod {
  ...
  inline def loadableReady(done: js.Function0[js.Any]): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadableReady")(done.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  inline def loadableReady(done: js.Function0[js.Any], options: LoadableReadyOptions): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("loadableReady")(done.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  ...
  object OptionsWithoutResolver {
    ...
    extension [Self <: OptionsWithoutResolver[?], Props](x: Self & OptionsWithoutResolver[Props]) {
      ...
      inline def setCacheKey(value: /* props */ Props => js.Any): Self = StObject.set(x, "cacheKey", js.Any.fromFunction1(value))
