...
object srcLtxMod {
  ...
  @JSImport("ltx/src/ltx", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ltx/src/ltx", "Element")
  @js.native
  ...
  @js.native
  open class Parser ()
    extends typings.ltx.srcParserMod.default {
  ...
  object Parser {
    ...
    @JSImport("ltx/src/ltx", "Parser.DefaultElement")
    @js.native
    ...
    @JSImport("ltx/src/ltx", "Parser.DefaultParser")
    @js.native
