...
object Recurrence {
  ...
  /* timeperiodAndModifierName */ StringDictionary[js.UndefOr[js.Array[Double]]] = null,
    ...
    if (D_a != null) __obj.updateDynamic("D_a")(D_a)
    if (D_b != null) __obj.updateDynamic("D_b")(D_b)
    if (M != null) __obj.updateDynamic("M")(M)
    if (M_a != null) __obj.updateDynamic("M_a")(M_a)
    if (M_b != null) __obj.updateDynamic("M_b")(M_b)
    js.Dynamic.global.Object.assign(__obj, StringDictionary)
    if (Y != null) __obj.updateDynamic("Y")(Y)
    if (Y_a != null) __obj.updateDynamic("Y_a")(Y_a)
    if (Y_b != null) __obj.updateDynamic("Y_b")(Y_b)
    if (dc != null) __obj.updateDynamic("dc")(dc)
    if (dc_a != null) __obj.updateDynamic("dc_a")(dc_a)
    if (dc_b != null) __obj.updateDynamic("dc_b")(dc_b)
    if (dw != null) __obj.updateDynamic("dw")(dw)
    if (dw_a != null) __obj.updateDynamic("dw_a")(dw_a)
    if (dw_b != null) __obj.updateDynamic("dw_b")(dw_b)
    if (dy != null) __obj.updateDynamic("dy")(dy)
    if (dy_a != null) __obj.updateDynamic("dy_a")(dy_a)
    if (dy_b != null) __obj.updateDynamic("dy_b")(dy_b)
    if (h != null) __obj.updateDynamic("h")(h)
    if (h_a != null) __obj.updateDynamic("h_a")(h_a)
    if (h_b != null) __obj.updateDynamic("h_b")(h_b)
    if (m != null) __obj.updateDynamic("m")(m)
    if (m_a != null) __obj.updateDynamic("m_a")(m_a)
    if (m_b != null) __obj.updateDynamic("m_b")(m_b)
    if (s != null) __obj.updateDynamic("s")(s)
    if (s_a != null) __obj.updateDynamic("s_a")(s_a)
    if (s_b != null) __obj.updateDynamic("s_b")(s_b)
    if (t != null) __obj.updateDynamic("t")(t)
    if (t_a != null) __obj.updateDynamic("t_a")(t_a)
    if (t_b != null) __obj.updateDynamic("t_b")(t_b)
    if (wm != null) __obj.updateDynamic("wm")(wm)
    if (wm_a != null) __obj.updateDynamic("wm_a")(wm_a)
    if (wm_b != null) __obj.updateDynamic("wm_b")(wm_b)
    if (wy != null) __obj.updateDynamic("wy")(wy)
    if (wy_a != null) __obj.updateDynamic("wy_a")(wy_a)
    if (wy_b != null) __obj.updateDynamic("wy_b")(wy_b)
