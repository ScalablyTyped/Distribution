...
object ^ extends js.Object {
  ...
  def videoOverlay(video: java.lang.String, bounds: LatLngBoundsExpression): VideoOverlay = js.native
  def videoOverlay(video: java.lang.String, bounds: LatLngBoundsExpression, options: VideoOverlayOptions): VideoOverlay = js.native
  def videoOverlay(video: js.Array[java.lang.String], bounds: LatLngBoundsExpression): VideoOverlay = js.native
  def videoOverlay(video: js.Array[java.lang.String], bounds: LatLngBoundsExpression, options: VideoOverlayOptions): VideoOverlay = js.native
  def videoOverlay(video: stdLib.HTMLVideoElement, bounds: LatLngBoundsExpression): VideoOverlay = js.native
  def videoOverlay(video: stdLib.HTMLVideoElement, bounds: LatLngBoundsExpression, options: VideoOverlayOptions): VideoOverlay = js.native
}
