...
class Layer () extends Evented {
  ...
  def getPane(): js.UndefOr[stdLib.HTMLElement] = js.native
  def getPane(name: java.lang.String): js.UndefOr[stdLib.HTMLElement] = js.native
  def getPopup(): js.UndefOr[Popup] = js.native
  def getTooltip(): js.UndefOr[Tooltip] = js.native
  def isPopupOpen(): scala.Boolean = js.native
  def isTooltipOpen(): scala.Boolean = js.native
  // Extension methods
