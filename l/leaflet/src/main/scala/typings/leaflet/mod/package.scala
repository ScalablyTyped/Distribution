...
inline def geoJSON_[P, G /* <: GeometryObject */](): GeoJSON__[P, G] = ^.asInstanceOf[js.Dynamic].applyDynamic("geoJSON")().asInstanceOf[GeoJSON__[P, G]]
inline def geoJSON_[P, G /* <: GeometryObject */](geojson: js.Array[GeoJsonObject]): GeoJSON__[P, G] = ^.asInstanceOf[js.Dynamic].applyDynamic("geoJSON")(geojson.asInstanceOf[js.Any]).asInstanceOf[GeoJSON__[P, G]]
inline def geoJSON_[P, G /* <: GeometryObject */](geojson: js.Array[GeoJsonObject], options: GeoJSONOptions[P, G]): GeoJSON__[P, G] = (^.asInstanceOf[js.Dynamic].applyDynamic("geoJSON")(geojson.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[GeoJSON__[P, G]]
inline def geoJSON_[P, G /* <: GeometryObject */](geojson: Unit, options: GeoJSONOptions[P, G]): GeoJSON__[P, G] = (^.asInstanceOf[js.Dynamic].applyDynamic("geoJSON")(geojson.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[GeoJSON__[P, G]]
inline def geoJSON_[P, G /* <: GeometryObject */](geojson: GeoJsonObject): GeoJSON__[P, G] = ^.asInstanceOf[js.Dynamic].applyDynamic("geoJSON")(geojson.asInstanceOf[js.Any]).asInstanceOf[GeoJSON__[P, G]]
inline def geoJSON_[P, G /* <: GeometryObject */](geojson: GeoJsonObject, options: GeoJSONOptions[P, G]): GeoJSON__[P, G] = (^.asInstanceOf[js.Dynamic].applyDynamic("geoJSON")(geojson.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[GeoJSON__[P, G]]

inline def geoJson[P, G /* <: GeometryObject */](): GeoJSON__[P, G] = ^.asInstanceOf[js.Dynamic].applyDynamic("geoJson")().asInstanceOf[GeoJSON__[P, G]]
inline def geoJson[P, G /* <: GeometryObject */](geojson: js.Array[GeoJsonObject]): GeoJSON__[P, G] = ^.asInstanceOf[js.Dynamic].applyDynamic("geoJson")(geojson.asInstanceOf[js.Any]).asInstanceOf[GeoJSON__[P, G]]
inline def geoJson[P, G /* <: GeometryObject */](geojson: js.Array[GeoJsonObject], options: GeoJSONOptions[P, G]): GeoJSON__[P, G] = (^.asInstanceOf[js.Dynamic].applyDynamic("geoJson")(geojson.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[GeoJSON__[P, G]]
inline def geoJson[P, G /* <: GeometryObject */](geojson: Unit, options: GeoJSONOptions[P, G]): GeoJSON__[P, G] = (^.asInstanceOf[js.Dynamic].applyDynamic("geoJson")(geojson.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[GeoJSON__[P, G]]
inline def geoJson[P, G /* <: GeometryObject */](geojson: GeoJsonObject): GeoJSON__[P, G] = ^.asInstanceOf[js.Dynamic].applyDynamic("geoJson")(geojson.asInstanceOf[js.Any]).asInstanceOf[GeoJSON__[P, G]]
inline def geoJson[P, G /* <: GeometryObject */](geojson: GeoJsonObject, options: GeoJSONOptions[P, G]): GeoJSON__[P, G] = (^.asInstanceOf[js.Dynamic].applyDynamic("geoJson")(geojson.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[GeoJSON__[P, G]]
