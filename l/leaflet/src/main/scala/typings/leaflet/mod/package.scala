...
@scala.inline
def circle(latlng: typings.leaflet.mod.LatLngExpression): typings.leaflet.mod.Circle_[js.Any] = typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("circle")(latlng.asInstanceOf[js.Any]).asInstanceOf[typings.leaflet.mod.Circle_[js.Any]]
@scala.inline
...
@scala.inline
def circle(latlng: typings.leaflet.mod.LatLngExpression, radius: scala.Double): typings.leaflet.mod.Circle_[js.Any] = (typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("circle")(latlng.asInstanceOf[js.Any], radius.asInstanceOf[js.Any])).asInstanceOf[typings.leaflet.mod.Circle_[js.Any]]
@scala.inline
def circle(
...
@scala.inline
def circleMarker(latlng: typings.leaflet.mod.LatLngExpression): typings.leaflet.mod.CircleMarker_[js.Any] = typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("circleMarker")(latlng.asInstanceOf[js.Any]).asInstanceOf[typings.leaflet.mod.CircleMarker_[js.Any]]
@scala.inline
...
@scala.inline
def featureGroup(): typings.leaflet.mod.FeatureGroup_[js.Any] = typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("featureGroup")().asInstanceOf[typings.leaflet.mod.FeatureGroup_[js.Any]]
@scala.inline
def featureGroup(layers: js.Array[typings.leaflet.mod.Layer]): typings.leaflet.mod.FeatureGroup_[js.Any] = typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("featureGroup")(layers.asInstanceOf[js.Any]).asInstanceOf[typings.leaflet.mod.FeatureGroup_[js.Any]]
...
@scala.inline
def geoJSON[P](geojson: scala.Unit, options: typings.leaflet.mod.GeoJSONOptions[P]): typings.leaflet.mod.GeoJSON_[P] = (typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("geoJSON")(geojson.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.leaflet.mod.GeoJSON_[P]]
@scala.inline
...
@scala.inline
def layerGroup(): typings.leaflet.mod.LayerGroup_[js.Any] = typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("layerGroup")().asInstanceOf[typings.leaflet.mod.LayerGroup_[js.Any]]
@scala.inline
def layerGroup(layers: js.Array[typings.leaflet.mod.Layer]): typings.leaflet.mod.LayerGroup_[js.Any] = typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("layerGroup")(layers.asInstanceOf[js.Any]).asInstanceOf[typings.leaflet.mod.LayerGroup_[js.Any]]
@scala.inline
...
@scala.inline
def layerGroup(layers: scala.Unit, options: typings.leaflet.mod.LayerOptions): typings.leaflet.mod.LayerGroup_[js.Any] = (typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("layerGroup")(layers.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.leaflet.mod.LayerGroup_[js.Any]]
...
@scala.inline
def marker(latlng: typings.leaflet.mod.LatLngExpression): typings.leaflet.mod.Marker_[js.Any] = typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("marker")(latlng.asInstanceOf[js.Any]).asInstanceOf[typings.leaflet.mod.Marker_[js.Any]]
@scala.inline
def marker(latlng: typings.leaflet.mod.LatLngExpression, options: typings.leaflet.mod.MarkerOptions): typings.leaflet.mod.Marker_[js.Any] = (typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("marker")(latlng.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.leaflet.mod.Marker_[js.Any]]
...
@scala.inline
def popup(options: scala.Unit, source: typings.leaflet.mod.Layer): typings.leaflet.mod.Popup_ = (typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("popup")(options.asInstanceOf[js.Any], source.asInstanceOf[js.Any])).asInstanceOf[typings.leaflet.mod.Popup_]
@scala.inline
...
@scala.inline
def rectangle(latLngBounds: typings.leaflet.mod.LatLngBoundsExpression): typings.leaflet.mod.Rectangle_[js.Any] = typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("rectangle")(latLngBounds.asInstanceOf[js.Any]).asInstanceOf[typings.leaflet.mod.Rectangle_[js.Any]]
@scala.inline
def rectangle(
...
@scala.inline
def tooltip(options: scala.Unit, source: typings.leaflet.mod.Layer): typings.leaflet.mod.Tooltip_ = (typings.leaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("tooltip")(options.asInstanceOf[js.Any], source.asInstanceOf[js.Any])).asInstanceOf[typings.leaflet.mod.Tooltip_]
@scala.inline
