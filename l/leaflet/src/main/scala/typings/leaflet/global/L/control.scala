...
object control {
  ...
  inline def zoom(): Zoom = ^.asInstanceOf[js.Dynamic].applyDynamic("zoom")().asInstanceOf[Zoom]
  inline def zoom(options: ZoomOptions): Zoom = ^.asInstanceOf[js.Dynamic].applyDynamic("zoom")(options.asInstanceOf[js.Any]).asInstanceOf[Zoom]
}
