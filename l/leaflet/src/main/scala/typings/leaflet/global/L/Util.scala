...
object Util {
  ...
  inline def bind(fn: js.Function1[/* repeated */ js.Any, Unit], obj: js.Any*): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("bind")(fn.asInstanceOf[js.Any], obj.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
  ...
  inline def create(proto: js.Object): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(proto.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  inline def create(proto: js.Object, properties: PropertyDescriptorMap): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(proto.asInstanceOf[js.Any], properties.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  inline def create(proto: Null, properties: PropertyDescriptorMap): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(proto.asInstanceOf[js.Any], properties.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  inline def extend(dest: js.Any, src: js.Any*): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("extend")(dest.asInstanceOf[js.Any], src.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  inline def getParamString(obj: js.Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getParamString")(obj.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def getParamString(obj: js.Any, existingUrl: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("getParamString")(obj.asInstanceOf[js.Any], existingUrl.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def getParamString(obj: js.Any, existingUrl: String, uppercase: Boolean): String = (^.asInstanceOf[js.Dynamic].applyDynamic("getParamString")(obj.asInstanceOf[js.Any], existingUrl.asInstanceOf[js.Any], uppercase.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def getParamString(obj: js.Any, existingUrl: Unit, uppercase: Boolean): String = (^.asInstanceOf[js.Dynamic].applyDynamic("getParamString")(obj.asInstanceOf[js.Any], existingUrl.asInstanceOf[js.Any], uppercase.asInstanceOf[js.Any])).asInstanceOf[String]
  
  inline def indexOf(array: js.Array[js.Any], el: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("indexOf")(array.asInstanceOf[js.Any], el.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def requestAnimFrame(fn: js.Function1[/* timestamp */ Double, Unit], context: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("requestAnimFrame")(fn.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def requestAnimFrame(fn: js.Function1[/* timestamp */ Double, Unit], context: js.Any, immediate: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("requestAnimFrame")(fn.asInstanceOf[js.Any], context.asInstanceOf[js.Any], immediate.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def setOptions(obj: js.Any, options: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setOptions")(obj.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  inline def stamp(obj: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("stamp")(obj.asInstanceOf[js.Any]).asInstanceOf[Double]
  
  inline def template(str: String, data: js.Any): String = (^.asInstanceOf[js.Dynamic].applyDynamic("template")(str.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[String]
  
  inline def throttle(fn: js.Function0[Unit], time: Double, context: js.Any): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("throttle")(fn.asInstanceOf[js.Any], time.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
