...
import typings.leaflet.Anon_ArgsAny
import typings.leaflet.Anon_Attribution
...
object Control extends js.Object {
  def extend[T /* <: js.Object */](props: T): Anon_ArgsAny[T] with Anon_Attribution = js.native
}
