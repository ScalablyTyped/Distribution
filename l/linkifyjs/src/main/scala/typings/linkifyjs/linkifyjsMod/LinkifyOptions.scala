...
trait LinkifyOptions extends js.Object {
  /**
    ...
    */
  var attributes: js.UndefOr[PossiblyFuncOfHrefAndType[AnchorHTMLAttributes[HTMLAnchorElement]] | Null] = js.undefined
  /**
    * className
    ...
    */
  var className: js.UndefOr[PossiblyByType[PossiblyFuncOfHrefAndType[js.UndefOr[String]]]] = js.undefined
  /**
    * defaultProtocol
    * - Type: String
    * - Default: 'http'
    ...
    */
  var defaultProtocol: js.UndefOr[String] = js.undefined
  /**
    * events
    ...
    */
  var events: js.UndefOr[PossiblyFuncOfHrefAndType[StringDictionary[EventHandler]] | Null] = js.undefined
  /**
    * format
    ...
    */
  var format: js.UndefOr[PossiblyByType[js.Function2[/* value */ String, /* type */ String, String]]] = js.undefined
  //
  /**
    * formatHref
    ...
    */
  var formatHref: js.UndefOr[PossiblyByType[js.Function2[/* href */ String, /* type */ String, String]]] = js.undefined
  /**
    * ignoreTags
  ...
  /**
    ...
    */
  var tagName: js.UndefOr[PossiblyByType[PossiblyFuncOfHrefAndType[String]]] = js.undefined
  /**
    * target
    * - Type: String | Function (String href, String type) | Object
    ...
    */
  var target: js.UndefOr[PossiblyByType[PossiblyFuncOfHrefAndType[js.UndefOr[String | Null]]]] = js.undefined
  /**
    * validate
    ...
    */
  var validate: js.UndefOr[PossiblyByType[PossiblyFuncOfHrefAndType[Boolean]]] = js.undefined
}

object LinkifyOptions {
  @scala.inline
  def apply(
    attributes: PossiblyFuncOfHrefAndType[AnchorHTMLAttributes[HTMLAnchorElement]] = null,
    className: PossiblyByType[PossiblyFuncOfHrefAndType[js.UndefOr[String]]] = null,
    defaultProtocol: String = null,
    events: PossiblyFuncOfHrefAndType[StringDictionary[EventHandler]] = null,
    format: PossiblyByType[js.Function2[/* value */ String, /* type */ String, String]] = null,
    formatHref: PossiblyByType[js.Function2[/* href */ String, /* type */ String, String]] = null,
    ignoreTags: js.Array[String] = null,
    nl2br: js.UndefOr[Boolean] = js.undefined,
    tagName: PossiblyByType[PossiblyFuncOfHrefAndType[String]] = null,
    target: PossiblyByType[PossiblyFuncOfHrefAndType[js.UndefOr[String | Null]]] = null,
    validate: PossiblyByType[PossiblyFuncOfHrefAndType[Boolean]] = null
  ): LinkifyOptions = {
