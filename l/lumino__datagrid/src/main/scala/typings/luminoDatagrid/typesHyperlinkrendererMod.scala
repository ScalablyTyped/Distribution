...
import typings.luminoDatagrid.typesHyperlinkrendererMod.HyperlinkRenderer.IOptions
import typings.luminoDatagrid.typesTextrendererMod.TextRenderer
...
object typesHyperlinkrendererMod {
  ...
  object HyperlinkRenderer {
    ...
    */
    ...
    trait IOptions
      extends StObject
         with typings.luminoDatagrid.typesTextrendererMod.TextRenderer.IOptions {
