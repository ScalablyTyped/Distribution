...
import typings.luminoDatagrid.basicmousehandlerMod.PressData.PressData
...
object basicmousehandlerMod {
  ...
  object PressData {
    ...
    trait ColumnResizeData
      extends StObject
         with typings.luminoDatagrid.basicmousehandlerMod.PressData.PressData {
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.luminoDatagrid.basicmousehandlerMod.PressData.RowResizeData
      - typings.luminoDatagrid.basicmousehandlerMod.PressData.ColumnResizeData
      - typings.luminoDatagrid.basicmousehandlerMod.PressData.SelectData
    */
    trait PressData extends StObject
    object PressData {
      
      inline def ColumnResizeData(clientX: Double, index: Double, `override`: IDisposable, region: ColumnRegion, size: Double): typings.luminoDatagrid.basicmousehandlerMod.PressData.ColumnResizeData = {
        val __obj = js.Dynamic.literal(clientX = clientX.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any])
        __obj.updateDynamic("override")(`override`.asInstanceOf[js.Any])
        __obj.updateDynamic("type")("column-resize")
        __obj.asInstanceOf[typings.luminoDatagrid.basicmousehandlerMod.PressData.ColumnResizeData]
      }
      
      inline def RowResizeData(clientY: Double, index: Double, `override`: IDisposable, region: RowRegion, size: Double): typings.luminoDatagrid.basicmousehandlerMod.PressData.RowResizeData = {
        ...
        __obj.asInstanceOf[typings.luminoDatagrid.basicmousehandlerMod.PressData.RowResizeData]
      }
      ...
      inline def SelectData(
        ...
        __obj.asInstanceOf[typings.luminoDatagrid.basicmousehandlerMod.PressData.SelectData]
      }
    }
