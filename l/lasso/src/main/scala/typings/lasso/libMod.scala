...
object libMod {
  ...
  inline def createFlagSet(flags: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("createFlagSet")(flags.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  inline def flushAllCaches(callback: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("flushAllCaches")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def getClientPath(path: String, options: js.Any): String = (^.asInstanceOf[js.Dynamic].applyDynamic("getClientPath")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def isFlagSet(o: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFlagSet")(o.asInstanceOf[js.Any]).asInstanceOf[Boolean]
