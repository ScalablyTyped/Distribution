...
object libLassoMod {
  ...
  trait Lasso extends EventEmitter {
    ...
    def buildLassoCacheKey(lassoContext: typings.lasso.libLassoContextMod.default): Parts = js.native
    
    def buildPageBundles(options: Any, lassoContext: typings.lasso.libLassoContextMod.default, callback: Callback): Unit = js.native
    
    var config: LassoConfig = js.native
    
    def createAppBundleMappings(bundleSetConfig: Any, lassoContext: typings.lasso.libLassoContextMod.default, callback: Callback): Any = js.native
    
    def createLassoContext(): typings.lasso.libLassoContextMod.default = js.native
    def createLassoContext(options: Any): typings.lasso.libLassoContextMod.default = js.native
    
    var dependencies: DependencyRegistry = js.native
    
    def getAppBundleMappingsCached(bundleSetConfig: Any, lassoContext: typings.lasso.libLassoContextMod.default, callback: Callback): Unit = js.native
    ...
    def getLassoCache(lassoContext: typings.lasso.libLassoContextMod.default): Any = js.native
  ...
  object PageConfig {
    ...
    extension [Self <: PageConfig](x: Self) {
      ...
      inline def setLassoContext(value: typings.lasso.libLassoContextMod.default): Self = StObject.set(x, "lassoContext", value.asInstanceOf[js.Any])
