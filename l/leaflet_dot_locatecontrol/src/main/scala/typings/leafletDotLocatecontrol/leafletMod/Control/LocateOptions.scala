...
object LocateOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(cacheLocation)) __obj.updateDynamic("cacheLocation")(cacheLocation.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(drawCircle)) __obj.updateDynamic("drawCircle")(drawCircle.asInstanceOf[js.Any])
    if (!js.isUndefined(drawMarker)) __obj.updateDynamic("drawMarker")(drawMarker.asInstanceOf[js.Any])
    if (!js.isUndefined(flyTo)) __obj.updateDynamic("flyTo")(flyTo.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(keepCurrentZoomLevel)) __obj.updateDynamic("keepCurrentZoomLevel")(keepCurrentZoomLevel.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(returnToPrevBounds)) __obj.updateDynamic("returnToPrevBounds")(returnToPrevBounds.asInstanceOf[js.Any])
