...
import typings.libp2pInterfaceDht.libp2pInterfaceDhtStrings.PEER_RESPONSE
...
trait PeerResponseEvent
  ...
  var `type`: typings.libp2pInterfaceDht.mod.EventTypes.PEER_RESPONSE
}
object PeerResponseEvent {
  ...
  inline def apply(
    ...
    `type`: typings.libp2pInterfaceDht.mod.EventTypes.PEER_RESPONSE
  ): PeerResponseEvent = {
  ...
  implicit open class MutableBuilder[Self <: PeerResponseEvent] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.libp2pInterfaceDht.mod.EventTypes.PEER_RESPONSE): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
