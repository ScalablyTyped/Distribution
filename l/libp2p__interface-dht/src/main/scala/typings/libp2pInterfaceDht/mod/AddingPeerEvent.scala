...
import typings.libp2pInterfaceDht.libp2pInterfaceDhtStrings.ADDING_PEER
...
trait AddingPeerEvent
  ...
  var `type`: typings.libp2pInterfaceDht.mod.EventTypes.ADDING_PEER
}
object AddingPeerEvent {
  
  inline def apply(peer: PeerId, `type`: typings.libp2pInterfaceDht.mod.EventTypes.ADDING_PEER): AddingPeerEvent = {
  ...
  implicit open class MutableBuilder[Self <: AddingPeerEvent] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.libp2pInterfaceDht.mod.EventTypes.ADDING_PEER): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
