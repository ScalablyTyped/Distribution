...
import typings.leafletPolylinemeasure.leafletMod.Control_.PolylineMeasure
import typings.leafletPolylinemeasure.leafletMod.Control_.PolylineMeasureOptions
...
object leafletMod {
  ...
  object Control_ {
    ...
    object PolylineMeasureOptions {
      ...
      @scala.inline
      implicit open class MutableBuilder[Self <: PolylineMeasureOptions] (val x: Self) extends AnyVal {
