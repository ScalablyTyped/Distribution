...
object mod extends Shortcut {
  ...
  type InferDBClear[DB] = LevelUpClear[AbstractClearOptions[Any] | Any]
  
  type InferDBDel[DB] = LevelUpDel[Any, AbstractOptions | Any]
  
  type InferDBGet[DB] = LevelUpGet[Any, Any, AbstractGetOptions | Any]
  
  type InferDBGetMany[DB] = LevelUpGetMany[Any, Any, AbstractGetOptions | Any]
  
  type InferDBPut[DB] = LevelUpPut[Any, Any, AbstractOptions | Any]
  ...
  trait LevelUp[DB, Iterator] extends EventEmitter {
    ...
    def createKeyStream(): ReadableStream[Any] = js.native
    def createKeyStream(options: AbstractIteratorOptions[Any]): ReadableStream[Any] = js.native
    
    def createReadStream(): ReadableStream[Any] = js.native
    def createReadStream(options: AbstractIteratorOptions[Any]): ReadableStream[Any] = js.native
    
    def createValueStream(): ReadableStream[Any] = js.native
    def createValueStream(options: AbstractIteratorOptions[Any]): ReadableStream[Any] = js.native
