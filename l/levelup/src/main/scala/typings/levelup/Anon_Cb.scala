...
object Anon_Cb {
  @scala.inline
  def apply(
    put: (/* import warning: ImportType.apply Failed type conversion: infer K */ js.Any, /* import warning: ImportType.apply Failed type conversion: infer V */ js.Any, /* import warning: ImportType.apply Failed type conversion: infer O */ js.Any, js.Any) => Unit
  ): Anon_Cb = {
