...
package object levelupLib {
  type InferDBDel[DB] = LevelUpDel[
    js.Any, 
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify AbstractOptions */ js.Any
  ]
  type InferDBGet[DB] = LevelUpGet[
    js.Any, 
    js.Any, 
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify AbstractGetOptions */ js.Any
  ]
  ...
  type LevelUpBatch[K, O] = (js.Function2[
    /* key */ K, 
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ErrorCallback */ /* callback */ js.Any, 
    scala.Unit
  ]) with (js.Function3[
    /* key */ K, 
    /* options */ O, 
  ...
  type LevelUpGet[K, V, O] = (js.Function2[
    /* key */ K, 
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ErrorValueCallback<V> */ /* callback */ js.Any, 
    scala.Unit
  ]) with (js.Function3[
    /* key */ K, 
    /* options */ O, 
