...
import typings.libp2pDelegatedContentRouting.libp2pDelegatedContentRoutingStrings.DIALING_PEER
...
trait DialingPeerEvent
  ...
  var `type`: typings.libp2pDelegatedContentRouting.mod.EventTypes.DIALING_PEER
}
object DialingPeerEvent {
  
  inline def apply(peer: PeerId, `type`: typings.libp2pDelegatedContentRouting.mod.EventTypes.DIALING_PEER): DialingPeerEvent = {
  ...
  extension [Self <: DialingPeerEvent](x: Self) {
    ...
    inline def setType(value: typings.libp2pDelegatedContentRouting.mod.EventTypes.DIALING_PEER): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
