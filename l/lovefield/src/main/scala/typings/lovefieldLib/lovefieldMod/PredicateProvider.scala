...
trait PredicateProvider extends js.Object {
  ...
  def eq(operand: lovefieldLib.lovefieldMod.schemaNs.Column): Predicate = js.native
  def gt(operand: Binder): Predicate = js.native
  def gt(operand: ValueLiteral): Predicate = js.native
  def gt(operand: lovefieldLib.lovefieldMod.schemaNs.Column): Predicate = js.native
  def gte(operand: Binder): Predicate = js.native
  def gte(operand: ValueLiteral): Predicate = js.native
  def gte(operand: lovefieldLib.lovefieldMod.schemaNs.Column): Predicate = js.native
  ...
  def lt(operand: lovefieldLib.lovefieldMod.schemaNs.Column): Predicate = js.native
  def lte(operand: Binder): Predicate = js.native
  def lte(operand: ValueLiteral): Predicate = js.native
  def lte(operand: lovefieldLib.lovefieldMod.schemaNs.Column): Predicate = js.native
  ...
  def neq(operand: lovefieldLib.lovefieldMod.schemaNs.Column): Predicate = js.native
}
