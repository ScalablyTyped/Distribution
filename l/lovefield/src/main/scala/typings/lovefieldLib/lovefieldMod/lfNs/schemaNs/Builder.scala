...
trait Builder extends js.Object {
  def connect(): stdLib.Promise[lovefieldLib.lovefieldMod.lfNs.Database] = js.native
  def connect(options: ConnectOptions): stdLib.Promise[lovefieldLib.lovefieldMod.lfNs.Database] = js.native
