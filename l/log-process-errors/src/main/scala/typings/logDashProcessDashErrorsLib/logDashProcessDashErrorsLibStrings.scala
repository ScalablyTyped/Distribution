...
object logDashProcessDashErrorsLibStrings {
  @js.native
  sealed trait ava extends js.Object
  
  @js.native
  sealed trait debug
    extends logDashProcessDashErrorsLib.logDashProcessDashErrorsMod.LogLevel
  ...
  sealed trait multipleResolves
    extends logDashProcessDashErrorsLib.logDashProcessDashErrorsMod.ExceptionType
