...
object PartialContext {
  ...
  def apply(
    ...
    if (!js.isUndefined(callbackWaitsForEmptyEventLoop)) __obj.updateDynamic("callbackWaitsForEmptyEventLoop")(callbackWaitsForEmptyEventLoop.get.asInstanceOf[js.Any])
