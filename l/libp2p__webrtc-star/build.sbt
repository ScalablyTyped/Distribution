...
version := "5.0.3-e0e402"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "dns-over-http-resolver" % "2.1.0-011631",
  "org.scalablytyped" %%% "engine_dot_io-client" % "6.2.3-f3e385",
  ...
  "org.scalablytyped" %%% "libp2p__webrtc-star-protocol" % "2.0.1-a17220",
  "org.scalablytyped" %%% "multiformats" % "10.0.2-cc7cca",
  "org.scalablytyped" %%% "multiformats__multiaddr" % "11.0.5-752b57",
  "org.scalablytyped" %%% "node" % "18.11-dt-20221101Z-d0f137",
  "org.scalablytyped" %%% "socket_dot_io-client" % "4.5.3-a6cec3",
