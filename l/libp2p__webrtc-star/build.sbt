...
version := "3.0.3-f44aa6"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "dns-over-http-resolver" % "2.1.0-7e747b",
  "org.scalablytyped" %%% "engine_dot_io-client" % "6.2.3-7a2032",
  ...
  "org.scalablytyped" %%% "libp2p__webrtc-peer" % "2.0.0-a11bd4",
  "org.scalablytyped" %%% "libp2p__webrtc-star-protocol" % "2.0.1-97ddd2",
  "org.scalablytyped" %%% "multiformats" % "10.0.0-e339c8",
  "org.scalablytyped" %%% "multiformats__multiaddr" % "11.0.1-9c49c7",
  "org.scalablytyped" %%% "node" % "18.11-dt-20221020Z-d73de4",
  "org.scalablytyped" %%% "socket_dot_io-client" % "4.5.3-aa3316",
