...
trait LodashUnionBy extends StObject {
  ...
  def apply[T](iteratee: ValueIteratee[T], arrays1: Unit, arrays2: List[T]): js.Array[T] = js.native
  ...
  def apply[T](iteratee: __, arrays1: Unit, arrays2: List[T]): LodashUnionBy1x6[T] = js.native
