...
trait LodashZipWith extends StObject {
  ...
  def apply[T1](iteratee: __, arrays1: typings.lodash.mod.List[T1]): LodashZipWith1x2[T1] = js.native
  def apply[T2](iteratee: __, arrays1: __, arrays2: typings.lodash.mod.List[T2]): LodashZipWith1x4[T2] = js.native
  def apply[T1, T2](iteratee: __, arrays1: typings.lodash.mod.List[T1], arrays2: typings.lodash.mod.List[T2]): LodashZipWith1x6[T1, T2] = js.native
