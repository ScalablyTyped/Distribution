...
trait LodashFill1x2 extends StObject {
  ...
  def apply[U](start: Double, value: __, array: typings.lodash.mod.List[U]): LodashFill2x11[U] = js.native
  ...
  def apply[U](start: __, value: __, array: typings.lodash.mod.List[U]): LodashFill2x10[U] = js.native
  def apply[T, U](start: Double, value: T, array: js.Array[U]): js.Array[T | U] = js.native
  def apply[T, U](start: Double, value: T, array: typings.lodash.mod.List[U]): typings.lodash.mod.List[T | U] = js.native
  def apply[T, U](start: __, value: T, array: js.Array[U]): LodashFill1x14[T, U] = js.native
  def apply[T, U](start: __, value: T, array: typings.lodash.mod.List[U]): LodashFill2x14[T, U] = js.native
}
