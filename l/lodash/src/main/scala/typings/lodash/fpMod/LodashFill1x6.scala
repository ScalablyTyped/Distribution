...
trait LodashFill1x6[T] extends StObject {
  ...
  def apply[U](start: Double, array: typings.lodash.mod.List[U]): typings.lodash.mod.List[T | U] = js.native
  def apply[U](start: __): LodashFill2x14[T, U] = js.native
  def apply[U](start: __, array: js.Array[U]): LodashFill1x14[T, U] = js.native
  def apply[U](start: __, array: typings.lodash.mod.List[U]): LodashFill2x14[T, U] = js.native
}
