...
trait LodashEvery extends StObject {
  ...
  def apply[T](predicate: ValueIterateeCustom[T, Boolean], collection: typings.lodash.mod.List[T]): Boolean = js.native
  ...
  def apply[T](predicate: __, collection: typings.lodash.mod.List[T]): LodashEvery1x2[T] = js.native
}
