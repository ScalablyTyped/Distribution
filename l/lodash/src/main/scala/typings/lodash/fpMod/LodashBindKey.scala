...
trait LodashBindKey extends StObject {
  ...
  /**
    ...
    **/
  @JSName("placeholder")
  def placeholder_TrapAny_Intersection[TrapAny /* <: typings.lodash.anon.TrapAny */](value: TrapAny): Collection[Any] & Function[Any] & Object[Any] & Primitive[Any] & typings.lodash.mod.String = js.native
}
