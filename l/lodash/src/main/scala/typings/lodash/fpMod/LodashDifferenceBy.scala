...
trait LodashDifferenceBy extends StObject {
  ...
  def apply[T1, T2](iteratee: ValueIteratee[T1 | T2], array: Unit, values: List[T2]): js.Array[T1] = js.native
  ...
  def apply[T1, T2](iteratee: __, array: Unit, values: List[T2]): LodashDifferenceBy1x6[T1, T2] = js.native
