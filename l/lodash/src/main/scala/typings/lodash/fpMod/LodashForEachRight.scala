...
trait LodashForEachRight extends StObject {
  ...
  def apply[T](iteratee: __, collection: typings.lodash.mod.List[T]): LodashForEachRight2x2[T] = js.native
  ...
  def apply[T, TList /* <: js.UndefOr[typings.lodash.mod.List[T] | Null] */](iteratee: __, collection: Unit & TList): LodashForEachRight5x2[T, TList] = js.native
  def apply[T, TList /* <: js.UndefOr[typings.lodash.mod.List[T] | Null] */](iteratee: __, collection: Null & TList): LodashForEachRight5x2[T, TList] = js.native
}
