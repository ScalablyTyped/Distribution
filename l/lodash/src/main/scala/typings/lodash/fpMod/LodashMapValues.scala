...
trait LodashMapValues extends StObject {
  ...
  {[ P in keyof T ]: any}
    */ typings.lodash.lodashStrings.LodashMapValues & TopLevel[js.Any] = js.native
  def apply[T](iteratee: String, obj: Dictionary[T]): Dictionary[js.Any] = js.native
  def apply[T](iteratee: String, obj: NumericDictionary[T]): Dictionary[js.Any] = js.native
