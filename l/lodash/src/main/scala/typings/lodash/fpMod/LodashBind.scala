...
trait LodashBind extends StObject {
  ...
  def apply(func: js.Function1[/* repeated */ js.Any, js.Any]): LodashBind1x1 = js.native
  def apply(func: js.Function1[/* repeated */ js.Any, js.Any], thisArg: js.Any): js.Function1[/* repeated */ js.Any, js.Any] = js.native
