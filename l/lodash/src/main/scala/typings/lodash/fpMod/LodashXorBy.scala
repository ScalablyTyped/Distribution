...
@js.native
trait LodashXorBy extends StObject {
  ...
  def apply[T](iteratee: ValueIteratee[T], arrays: Unit, arrays2: List[T]): js.Array[T] = js.native
  ...
  def apply[T](iteratee: __, arrays: Unit, arrays2: List[T]): LodashXorBy1x6[T] = js.native
