...
@js.native
trait LodashPadCharsEnd extends LodashConvertible {
  ...
  def apply(chars: String, length: __, string: String): LodashPadCharsEnd1x5 = js.native
  def apply(chars: __, length: Double): LodashPadCharsEnd1x2 = js.native
