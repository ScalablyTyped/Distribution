...
trait LodashOrderBy extends StObject {
  ...
  def apply[T](iteratees: Many[ValueIteratee[T]], orders: __, collection: typings.lodash.mod.List[T]): LodashOrderBy2x5[T] = js.native
  def apply[T](
    iteratees: Many[js.Function1[/* value */ T, NotVoid]],
    orders: __,
    collection: typings.lodash.mod.List[T]
  ...
  def apply[T](iteratees: __, orders: Many[Boolean | asc | desc], collection: typings.lodash.mod.List[T]): LodashOrderBy1x6[T] = js.native
  ...
  def apply[T](iteratees: __, orders: __, collection: typings.lodash.mod.List[T]): LodashOrderBy1x4[T] = js.native
}
