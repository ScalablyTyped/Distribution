...
trait LodashPullAllWith3x2[T2] extends StObject {
  ...
  def apply[T1](comparator: Comparator2[T1, T2], array: typings.lodash.mod.List[T1]): typings.lodash.mod.List[T1] = js.native
  def apply[T1](comparator: __, array: js.Array[T1]): LodashPullAllWith3x6[T1, T2] = js.native
  def apply[T1](comparator: __, array: typings.lodash.mod.List[T1]): LodashPullAllWith4x6[T1, T2] = js.native
}
