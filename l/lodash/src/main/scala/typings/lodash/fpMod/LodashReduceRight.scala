...
trait LodashReduceRight extends StObject {
  ...
  def apply[T](callback: __, accumulator: __, collection: typings.lodash.mod.List[T]): LodashReduceRight2x4[T] = js.native
  ...
  def apply[T, TResult](callback: __, accumulator: TResult, collection: typings.lodash.mod.List[T]): LodashReduceRight2x6[T, TResult] = js.native
}
