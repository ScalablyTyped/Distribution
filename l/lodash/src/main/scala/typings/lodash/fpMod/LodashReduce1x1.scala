...
trait LodashReduce1x1[T, TResult] extends StObject {
  ...
  def apply(accumulator: TResult, collection: typings.lodash.mod.List[T]): TResult = js.native
  ...
  def apply(accumulator: __, collection: typings.lodash.mod.List[T]): LodashReduce2x5[TResult] = js.native
}
