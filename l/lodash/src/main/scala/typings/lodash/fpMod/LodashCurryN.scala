...
trait LodashCurryN extends StObject {
  ...
  def apply(arity: Double, func: js.Function1[/* repeated */ js.Any, js.Any]): js.Function1[/* repeated */ js.Any, js.Any] = js.native
  def apply(arity: __, func: js.Function1[/* repeated */ js.Any, js.Any]): LodashCurryN6x2 = js.native
