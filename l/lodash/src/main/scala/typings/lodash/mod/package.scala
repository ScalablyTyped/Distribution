...
{[ P in keyof T ]: T[P] extends (arg : infer A): any? any : any}
  */ typings.lodash.lodashStrings.ConformsPredicateObject & org.scalablytyped.runtime.TopLevel[T]
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.lodash.mod.CollectionChain[js.Any] & typings.lodash.mod.FunctionChain[js.Any] & typings.lodash.mod.ObjectChain[js.Any] & typings.lodash.mod.PrimitiveChain[js.Any] & typings.lodash.mod.StringChain
*/
type ExpChain[T] = typings.lodash.mod._ExpChain[T] | typings.lodash.mod.CollectionChain[js.Any] | (typings.lodash.mod.CollectionChain[js.Any] & typings.lodash.mod.FunctionChain[js.Any] & typings.lodash.mod.ObjectChain[js.Any] & typings.lodash.mod.PrimitiveChain[js.Any] & typings.lodash.mod.StringChain)
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.lodash.mod.Collection[js.Any] & typings.lodash.mod.Function[js.Any] & typings.lodash.mod.Object[js.Any] & typings.lodash.mod.Primitive[js.Any] & typings.lodash.mod.String
*/
type ImpChain[T] = typings.lodash.mod._ImpChain[T] | typings.lodash.mod.Collection[js.Any] | (typings.lodash.mod.Collection[js.Any] & typings.lodash.mod.Function[js.Any] & typings.lodash.mod.Object[js.Any] & typings.lodash.mod.Primitive[js.Any] & typings.lodash.mod.String)
...
{[ P in keyof T ]:? T[P] extends object? object : T[P]}
  */ typings.lodash.lodashStrings.PartialShallow & org.scalablytyped.runtime.TopLevel[js.Any]
