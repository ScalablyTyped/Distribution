...
trait LodashPropOr3x2 extends js.Object {
  ...
  def apply(defaultValue: lodashLib.lodashMod.underscoreNs.`__`): LodashPropOr3x6 = js.native
  def apply(defaultValue: lodashLib.lodashMod.underscoreNs.`__`, `object`: js.Any): LodashPropOr4x6 = js.native
