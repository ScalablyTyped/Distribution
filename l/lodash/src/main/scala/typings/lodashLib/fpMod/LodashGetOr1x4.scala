...
trait LodashGetOr1x4[TObject] extends js.Object {
  ...
  def apply[TKey /* <: java.lang.String */](defaultValue: lodashLib.lodashMod.__, path: TKey): LodashGetOr1x6[TObject, TKey] = js.native
  def apply[TKey /* <: java.lang.String */](defaultValue: lodashLib.lodashMod.__, path: js.Array[TKey]): LodashGetOr1x6[TObject, TKey] = js.native
  ...
  def apply[TKey1 /* <: java.lang.String */, TKey2 /* <: /* import warning: ImportType.apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](defaultValue: lodashLib.lodashMod.__, path: js.Tuple2[TKey1, TKey2]): LodashGetOr2x6[TObject, TKey1, TKey2] = js.native
