...
trait LodashFindLastFrom1x2 extends js.Object {
  def apply[T](predicate: lodashLib.lodashMod.underscoreNs.ValueIterateeCustom[T, scala.Boolean]): LodashFindLastFrom2x3[T] = js.native
  ...
  def apply[T](predicate: lodashLib.lodashMod.underscoreNs.__): LodashFindLastFrom1x6[T] = js.native
  def apply[T /* <: js.Object */](predicate: lodashLib.lodashMod.underscoreNs.__, collection: T): LodashFindLastFrom3x6[T] = js.native
  def apply[T](
