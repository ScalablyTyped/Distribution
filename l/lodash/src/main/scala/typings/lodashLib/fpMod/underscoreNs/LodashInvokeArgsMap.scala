...
trait LodashInvokeArgsMap extends js.Object {
  def apply(methodNameOrMethod: lodashLib.lodashMod.underscoreNs.__, args: js.Array[_]): LodashInvokeArgsMap1x6 = js.native
  def apply(methodNameOrMethod: lodashLib.lodashMod.underscoreNs.__, args: js.Array[_], collection: js.Object): LodashInvokeArgsMap1x6 = js.native
  def apply(methodNameOrMethod: lodashLib.lodashMod.underscoreNs.__, args: lodashLib.lodashMod.underscoreNs.__): LodashInvokeArgsMap1x4 = js.native
  def apply(
    methodNameOrMethod: lodashLib.lodashMod.underscoreNs.__,
    args: lodashLib.lodashMod.underscoreNs.__,
    collection: js.Object
  ): LodashInvokeArgsMap1x4 = js.native
  def apply(methodName: java.lang.String): LodashInvokeArgsMap1x1 = js.native
  def apply(methodName: java.lang.String, args: js.Array[_]): js.Array[_] = js.native
