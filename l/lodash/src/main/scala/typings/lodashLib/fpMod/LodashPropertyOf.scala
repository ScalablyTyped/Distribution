...
trait LodashPropertyOf extends js.Object {
  ...
  def apply(path: lodashLib.lodashMod.__): LodashPropertyOf8x2 = js.native
  def apply(path: lodashLib.lodashMod.__, `object`: js.Any): LodashPropertyOf9x2 = js.native
  def apply(path: scala.Double): LodashPropertyOf6x1 = js.native
  def apply[TObject /* <: js.Object */](path: lodashLib.lodashMod.__, `object`: TObject): LodashPropertyOf2x2[TObject] = js.native
  def apply[T](path: lodashLib.lodashMod.__, `object`: lodashLib.lodashMod.NumericDictionary[T]): LodashPropertyOf7x2[T] = js.native
  ...
  def apply[TObject /* <: js.Object */, TKey1 /* <: java.lang.String */, TKey2 /* <: /* import warning: ImportType.apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](path: js.Tuple2[TKey1, TKey2]): LodashPropertyOf3x1[TObject, TKey1, TKey2] = js.native
