...
trait LodashMapKeys extends js.Object {
  def apply(iteratee: lodashLib.lodashMod.underscoreNs.ValueIteratee[java.lang.String]): LodashMapKeys2x1 = js.native
  def apply[T /* <: js.Object */](iteratee: lodashLib.lodashMod.underscoreNs.ValueIteratee[java.lang.String], `object`: T): lodashLib.lodashMod.underscoreNs.Dictionary[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def apply[T](
