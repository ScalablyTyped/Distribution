...
trait LodashCurryRight extends js.Object {
  ...
  def apply[T1, T2, T3, T4, R](func: js.Function4[/* t1 */ T1, /* t2 */ T2, /* t3 */ T3, /* t4 */ T4, R]): lodashLib.lodashMod.underscoreNs.RightCurriedFunction4[T1, T2, T3, T4, R] = js.native
  def apply[T1, T2, T3, T4, T5, R](func: js.Function5[/* t1 */ T1, /* t2 */ T2, /* t3 */ T3, /* t4 */ T4, /* t5 */ T5, R]): lodashLib.lodashMod.underscoreNs.RightCurriedFunction5[T1, T2, T3, T4, T5, R] = js.native
  /**
