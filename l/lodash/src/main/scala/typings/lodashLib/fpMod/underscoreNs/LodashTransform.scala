...
trait LodashTransform extends js.Object {
  def apply[TResult](iteratee: lodashLib.lodashMod.underscoreNs.__, accumulator: js.Array[TResult]): LodashTransform1x2[TResult] = js.native
  def apply[TResult](
    iteratee: lodashLib.lodashMod.underscoreNs.__,
    accumulator: lodashLib.lodashMod.underscoreNs.Dictionary[TResult]
  ): LodashTransform2x2[TResult] = js.native
  def apply[T](
    iteratee: lodashLib.lodashMod.underscoreNs.__,
    accumulator: lodashLib.lodashMod.underscoreNs.__,
    `object`: js.Array[T]
  ): LodashTransform1x4[T] = js.native
  def apply[T](
    iteratee: lodashLib.lodashMod.underscoreNs.__,
    accumulator: lodashLib.lodashMod.underscoreNs.__,
  ...
  ): LodashTransform2x1[T, TResult] = js.native
  def apply[T, TResult](
  ...
  def apply[T, TResult](
    ...
    accumulator: js.Array[TResult],
    `object`: js.Array[T]
  ): LodashTransform1x6[T, TResult] = js.native
  def apply[T, TResult](
    iteratee: lodashLib.lodashMod.underscoreNs.__,
    accumulator: js.Array[TResult],
    `object`: lodashLib.lodashMod.underscoreNs.Dictionary[T]
