...
trait LodashOmit extends js.Object {
  def apply(paths: lodashLib.lodashMod.underscoreNs.Many[lodashLib.lodashMod.underscoreNs.PropertyName]): LodashOmit1x1 = js.native
  def apply[T /* <: lodashLib.lodashMod.underscoreNs.AnyKindOfDictionary */](
