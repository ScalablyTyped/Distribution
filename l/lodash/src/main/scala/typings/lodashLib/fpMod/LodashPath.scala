...
trait LodashPath extends js.Object {
  ...
  def apply(path: lodashLib.lodashMod.__): LodashPath5x2 = js.native
  def apply(path: lodashLib.lodashMod.__, `object`: js.Any): LodashPath6x2 = js.native
  def apply(path: scala.Double): LodashPath3x1 = js.native
  def apply[TObject /* <: js.Object */](path: lodashLib.lodashMod.__, `object`: TObject): LodashPath1x2[TObject] = js.native
  def apply[T](path: lodashLib.lodashMod.__, `object`: lodashLib.lodashMod.NumericDictionary[T]): LodashPath3x2[T] = js.native
