...
trait LodashPropOr5x2 extends js.Object {
  ...
  def apply[T](defaultValue: lodashLib.lodashMod.__): LodashPropOr5x6[T] = js.native
  def apply[T](defaultValue: lodashLib.lodashMod.__, `object`: lodashLib.lodashMod.NumericDictionary[T]): LodashPropOr5x6[T] = js.native
