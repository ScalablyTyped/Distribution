...
trait LodashFindFrom extends js.Object {
  def apply(predicate: lodashLib.lodashMod.underscoreNs.__, fromIndex: scala.Double): LodashFindFrom1x2 = js.native
  def apply[T](predicate: lodashLib.lodashMod.underscoreNs.ValueIterateeCustom[T, scala.Boolean]): LodashFindFrom2x1[T] = js.native
  ...
  def apply[T](predicate: lodashLib.lodashMod.underscoreNs.__, fromIndex: lodashLib.lodashMod.underscoreNs.__): LodashFindFrom1x4[T] = js.native
  def apply[T /* <: js.Object */](
  ...
  def apply[T /* <: js.Object */](predicate: lodashLib.lodashMod.underscoreNs.__, fromIndex: scala.Double, collection: T): LodashFindFrom3x6[T] = js.native
  def apply[T](
    predicate: lodashLib.lodashMod.underscoreNs.__,
    fromIndex: scala.Double,
    collection: lodashLib.lodashMod.underscoreNs.List[T]
