...
trait LodashOrderBy2x1[T] extends js.Object {
  ...
  def apply(orders: lodashLib.lodashMod.underscoreNs.`__`): LodashOrderBy2x5[T] = js.native
  def apply(
    orders: lodashLib.lodashMod.underscoreNs.`__`,
    collection: lodashLib.lodashMod.underscoreNs.List[T]
  ): LodashOrderBy2x5[T] = js.native
  def apply[T1 /* <: js.Object */](orders: lodashLib.lodashMod.underscoreNs.`__`, collection: T1): LodashOrderBy4x5[T] = js.native
}
