...
trait LodashGet extends js.Object {
  ...
  def apply(path: lodashLib.lodashMod.__): LodashGet8x2 = js.native
  def apply(path: lodashLib.lodashMod.__, `object`: js.Any): LodashGet9x2 = js.native
  def apply(path: scala.Double): LodashGet6x1 = js.native
  def apply[TObject /* <: js.Object */](path: lodashLib.lodashMod.__, `object`: TObject): LodashGet2x2[TObject] = js.native
  def apply[T](path: lodashLib.lodashMod.__, `object`: lodashLib.lodashMod.NumericDictionary[T]): LodashGet7x2[T] = js.native
