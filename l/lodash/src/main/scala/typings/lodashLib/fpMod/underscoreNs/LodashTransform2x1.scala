...
trait LodashTransform2x1[T, TResult] extends js.Object {
  def apply(accumulator: lodashLib.lodashMod.underscoreNs.Dictionary[TResult]): LodashTransform2x3[T, TResult] = js.native
  def apply(accumulator: lodashLib.lodashMod.underscoreNs.Dictionary[TResult], `object`: js.Array[T]): lodashLib.lodashMod.underscoreNs.Dictionary[TResult] = js.native
  def apply(
