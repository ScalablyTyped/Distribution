...
trait LodashFlatMapDeep extends js.Object {
  ...
  def apply(iteratee: lodashLib.lodashMod.__): LodashFlatMapDeep3x2 = js.native
  def apply(iteratee: lodashLib.lodashMod.__, collection: js.Object): LodashFlatMapDeep3x2 = js.native
  def apply[T /* <: js.Object */](iteratee: lodashLib.lodashMod.__, collection: T): LodashFlatMapDeep2x2[T] = js.native
  def apply[T](iteratee: lodashLib.lodashMod.__, collection: lodashLib.lodashMod.List[T]): LodashFlatMapDeep1x2[T] = js.native
  def apply[T, TResult](
