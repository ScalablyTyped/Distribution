...
trait LodashReduceRight1x1[T, TResult] extends js.Object {
  ...
  def apply(accumulator: lodashLib.lodashMod.underscoreNs.__): LodashReduceRight2x5[TResult] = js.native
  def apply(accumulator: lodashLib.lodashMod.underscoreNs.__, collection: js.Array[T]): LodashReduceRight1x5[TResult] = js.native
  def apply(
