...
trait LodashSampleSize extends js.Object {
  ...
  def apply[T /* <: js.Object */](n: lodashLib.lodashMod.underscoreNs.`__`): LodashSampleSize2x2[T] = js.native
  def apply[T /* <: js.Object */](n: lodashLib.lodashMod.underscoreNs.`__`, collection: T): LodashSampleSize2x2[T] = js.native
  def apply[T](
  ...
  def apply[T](n: lodashLib.lodashMod.underscoreNs.`__`, collection: lodashLib.lodashMod.underscoreNs.List[T]): LodashSampleSize1x2[T] = js.native
  def apply[T](
    n: lodashLib.lodashMod.underscoreNs.`__`,
