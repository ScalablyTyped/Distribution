...
trait LodashGet extends js.Object {
  ...
  def apply(path: lodashLib.lodashMod.underscoreNs.`__`): LodashGet5x2 = js.native
  def apply(path: lodashLib.lodashMod.underscoreNs.`__`, `object`: js.Any): LodashGet6x2 = js.native
  def apply(path: scala.Double): LodashGet3x1 = js.native
  def apply[TObject /* <: js.Object */](path: lodashLib.lodashMod.underscoreNs.`__`, `object`: TObject): LodashGet2x2[TObject] = js.native
  def apply[T](
    path: lodashLib.lodashMod.underscoreNs.`__`,
    `object`: lodashLib.lodashMod.underscoreNs.NumericDictionary[T]
  ): LodashGet3x2[T] = js.native
