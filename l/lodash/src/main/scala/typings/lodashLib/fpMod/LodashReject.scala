...
trait LodashReject extends js.Object {
  ...
  def apply[T](predicate: lodashLib.lodashMod.__): LodashReject1x2[T] = js.native
  def apply[T /* <: js.Object */](predicate: lodashLib.lodashMod.__, collection: T): LodashReject2x2[T] = js.native
  def apply[T](predicate: lodashLib.lodashMod.__, collection: lodashLib.lodashMod.List[T]): LodashReject1x2[T] = js.native
}
