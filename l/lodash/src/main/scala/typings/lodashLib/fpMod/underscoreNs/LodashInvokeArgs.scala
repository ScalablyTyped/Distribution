...
trait LodashInvokeArgs extends js.Object {
  def apply(path: lodashLib.lodashMod.underscoreNs.PropertyPath): LodashInvokeArgs1x1 = js.native
  def apply(path: lodashLib.lodashMod.underscoreNs.PropertyPath, args: js.Array[_]): LodashInvokeArgs1x3 = js.native
