...
trait LodashForInRight extends js.Object {
  ...
  def apply[T](iteratee: lodashLib.lodashMod.__): LodashForInRight2x2[T] = js.native
  def apply[T](iteratee: lodashLib.lodashMod.__, `object`: T): LodashForInRight2x2[T] = js.native
}
