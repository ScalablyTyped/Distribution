...
trait LodashOrderBy1x1[T] extends js.Object {
  ...
  def apply(orders: lodashLib.lodashMod.underscoreNs.`__`): LodashOrderBy1x5[T] = js.native
  def apply(
    orders: lodashLib.lodashMod.underscoreNs.`__`,
    collection: lodashLib.lodashMod.underscoreNs.List[T]
  ): LodashOrderBy1x5[T] = js.native
  def apply[T1 /* <: js.Object */](orders: lodashLib.lodashMod.underscoreNs.`__`, collection: T1): LodashOrderBy3x5[T] = js.native
}
