...
trait LodashPullAt extends js.Object {
  def apply(indexes: lodashLib.lodashMod.underscoreNs.Many[scala.Double]): LodashPullAt1x1 = js.native
  def apply[T](indexes: lodashLib.lodashMod.underscoreNs.Many[scala.Double], array: js.Array[T]): js.Array[T] = js.native
  def apply[T](
