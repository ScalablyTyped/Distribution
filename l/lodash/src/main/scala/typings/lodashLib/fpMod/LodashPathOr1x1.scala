...
trait LodashPathOr1x1[TDefault] extends js.Object {
  ...
  def apply(path: lodashLib.lodashMod.__): LodashPathOr6x5[TDefault] = js.native
  def apply(path: scala.Double): LodashPathOr5x3[TDefault] = js.native
  def apply[TObject /* <: js.Object */](path: lodashLib.lodashMod.__, `object`: TObject): LodashPathOr1x5[TObject, TDefault] = js.native
  def apply[T](path: lodashLib.lodashMod.__, `object`: lodashLib.lodashMod.NumericDictionary[T]): LodashPathOr5x5[T, TDefault] = js.native
  ...
  def apply[TObject /* <: js.Object */, TKey1 /* <: java.lang.String */, TKey2 /* <: /* import warning: ImportType.apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](path: js.Tuple2[TKey1, TKey2]): LodashPathOr2x3[TObject, TKey1, TKey2, TDefault] = js.native
