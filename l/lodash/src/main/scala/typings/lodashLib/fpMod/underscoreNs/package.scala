...
package object underscoreNs {
  ...
  type LodashAssignAllWith1x2 = js.Function1[/* customizer */ lodashLib.lodashMod.underscoreNs.AssignCustomizer, js.Any]
  ...
  type LodashAssignInAllWith1x2 = js.Function1[/* customizer */ lodashLib.lodashMod.underscoreNs.AssignCustomizer, js.Any]
  ...
  type LodashAt1x1 = js.Function1[
    /* object */ js.UndefOr[
      lodashLib.lodashMod.underscoreNs.List[js.Any] | lodashLib.lodashMod.underscoreNs.Dictionary[js.Any] | lodashLib.lodashMod.underscoreNs.NumericDictionary[js.Any] | scala.Null
    ], 
    js.Array[js.Any]
  ]
  type LodashAt1x2[T] = js.Function1[/* props */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Array[T]]
  ...
  type LodashBindAll1x2[T] = js.Function1[/* methodNames */ lodashLib.lodashMod.underscoreNs.Many[java.lang.String], T]
  ...
  type LodashCastArray = js.Function1[/* value */ lodashLib.lodashMod.underscoreNs.Many[js.Any], js.Array[js.Any]]
  type LodashCeil = js.Function1[/* n */ scala.Double, scala.Double]
  type LodashChunk1x1 = js.Function1[
    /* array */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[js.Any] | scala.Null], 
  ...
  type LodashCloneDeepWith1x2[T] = js.Function1[
    /* customizer */ lodashLib.lodashMod.underscoreNs.CloneDeepWithCustomizer[T], 
    js.Any
  ]
  ...
  type LodashConcat1x1[T] = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.Many[T], js.Array[T]]
  type LodashConcat1x2[T] = js.Function1[/* array */ lodashLib.lodashMod.underscoreNs.Many[T], js.Array[T]]
  type LodashCond = js.Function1[
    /* pairs */ js.Array[lodashLib.lodashMod.underscoreNs.CondPair[js.Any, js.Any]], 
  ...
  type LodashCountBy1x1[T] = js.Function1[
    ...
    lodashLib.lodashMod.underscoreNs.Dictionary[scala.Double]
  ]
  ...
  type LodashCurryN1x2[T1, R] = js.Function1[/* arity */ scala.Double, lodashLib.lodashMod.underscoreNs.CurriedFunction1[T1, R]]
  type LodashCurryN2x2[T1, T2, R] = js.Function1[
    /* arity */ scala.Double, 
    lodashLib.lodashMod.underscoreNs.CurriedFunction2[T1, T2, R]
  ]
  type LodashCurryN3x2[T1, T2, T3, R] = js.Function1[
    /* arity */ scala.Double, 
    lodashLib.lodashMod.underscoreNs.CurriedFunction3[T1, T2, T3, R]
  ]
  type LodashCurryN4x2[T1, T2, T3, T4, R] = js.Function1[
    /* arity */ scala.Double, 
    lodashLib.lodashMod.underscoreNs.CurriedFunction4[T1, T2, T3, T4, R]
  ]
  type LodashCurryN5x2[T1, T2, T3, T4, T5, R] = js.Function1[
    /* arity */ scala.Double, 
    lodashLib.lodashMod.underscoreNs.CurriedFunction5[T1, T2, T3, T4, T5, R]
  ]
  ...
  type LodashCurryRightN1x2[T1, R] = js.Function1[
    /* arity */ scala.Double, 
    lodashLib.lodashMod.underscoreNs.RightCurriedFunction1[T1, R]
  ]
  type LodashCurryRightN2x2[T1, T2, R] = js.Function1[
    /* arity */ scala.Double, 
    lodashLib.lodashMod.underscoreNs.RightCurriedFunction2[T1, T2, R]
  ]
  type LodashCurryRightN3x2[T1, T2, T3, R] = js.Function1[
    /* arity */ scala.Double, 
    lodashLib.lodashMod.underscoreNs.RightCurriedFunction3[T1, T2, T3, R]
  ]
  type LodashCurryRightN4x2[T1, T2, T3, T4, R] = js.Function1[
    /* arity */ scala.Double, 
    lodashLib.lodashMod.underscoreNs.RightCurriedFunction4[T1, T2, T3, T4, R]
  ]
  type LodashCurryRightN5x2[T1, T2, T3, T4, T5, R] = js.Function1[
    /* arity */ scala.Double, 
    lodashLib.lodashMod.underscoreNs.RightCurriedFunction5[T1, T2, T3, T4, T5, R]
  ]
  ...
  type LodashDebounce1x1 = js.Function1[
    /* func */ js.Function1[/* repeated */js.Any, js.Any], 
    (js.Function1[/* repeated */js.Any, _]) with lodashLib.lodashMod.underscoreNs.Cancelable
  ]
  type LodashDebounce1x2[T] = js.Function1[/* wait */ scala.Double, T with lodashLib.lodashMod.underscoreNs.Cancelable]
  ...
  type LodashDifference1x1[T] = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.List[T], js.Array[T]]
  type LodashDifference1x2[T] = js.Function1[
    /* array */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashDifferenceBy1x3[T1, T2] = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.List[T2], js.Array[T1]]
  type LodashDifferenceBy1x5[T1] = js.Function1[
    /* array */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[T1] | scala.Null], 
    js.Array[T1]
  ]
  ...
  type LodashDifferenceWith1x3[T1, T2] = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.List[T2], js.Array[T1]]
  ...
  type LodashDropRightWhile1x2[T] = js.Function1[/* predicate */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], js.Array[T]]
  type LodashDropWhile1x1[T] = js.Function1[
    /* array */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashDropWhile1x2[T] = js.Function1[/* predicate */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], js.Array[T]]
  ...
  type LodashExtendAllWith1x2 = js.Function1[/* customizer */ lodashLib.lodashMod.underscoreNs.AssignCustomizer, js.Any]
  ...
  type LodashFindKey1x2[T] = js.Function1[
    /* predicate */ lodashLib.lodashMod.underscoreNs.ValueIteratee[
      /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Right(TsTypeKeyOf(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List())))) */js.Any
    ], 
  ...
  type LodashFlatMap1x2[T] = js.Function1[
    /* iteratee */ js.Function1[/* value */ T, lodashLib.lodashMod.underscoreNs.Many[js.Any]], 
    js.Array[js.Any]
  ]
  ...
  type LodashFlatMap2x2[T] = js.Function1[
    /* iteratee */ js.Function1[
      ...
      lodashLib.lodashMod.underscoreNs.Many[js.Any]
    ], 
    js.Array[js.Any]
  ]
  ...
  type LodashFlatMapDeep1x2[T] = js.Function1[
    /* iteratee */ js.Function1[
      /* value */ T, 
      lodashLib.lodashMod.underscoreNs.ListOfRecursiveArraysOrValues[js.Any] | js.Any
    ], 
    js.Array[js.Any]
  ]
  ...
  type LodashFlatten = js.Function1[
    /* array */ js.UndefOr[
      lodashLib.lodashMod.underscoreNs.List[lodashLib.lodashMod.underscoreNs.Many[js.Any]] | scala.Null
    ], 
    js.Array[js.Any]
  ]
  type LodashFlattenDeep = js.Function1[
    /* array */ js.UndefOr[
      lodashLib.lodashMod.underscoreNs.ListOfRecursiveArraysOrValues[js.Any] | scala.Null
    ], 
    js.Array[js.Any]
  ]
  ...
  type LodashGet5x2 = js.Function1[
    /* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, 
    js.UndefOr[scala.Nothing]
  ]
  type LodashGet6x2 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  ...
  type LodashGetOr2x3[TDefault] = js.Function1[
    /* object */ js.UndefOr[lodashLib.lodashMod.underscoreNs.NumericDictionary[js.Any] | scala.Null], 
    js.Any | TDefault
  ]
  ...
  type LodashGetOr3x5[TDefault] = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, TDefault]
  type LodashGetOr3x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashGetOr4x3 = js.Function1[/* object */ js.Any, js.Any]
  type LodashGetOr4x5 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  type LodashGetOr4x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashGroupBy1x1[T] = js.Function1[
    /* collection */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[T] | js.Object | scala.Null], 
    lodashLib.lodashMod.underscoreNs.Dictionary[js.Array[T]]
  ]
  ...
  type LodashHas1x2 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, scala.Boolean]
  type LodashHasIn1x1 = js.Function1[/* object */ js.Any, scala.Boolean]
  type LodashHasIn1x2 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, scala.Boolean]
  ...
  type LodashIntersection1x1[T] = js.Function1[/* arrays */ lodashLib.lodashMod.underscoreNs.List[T], js.Array[T]]
  type LodashIntersection1x2[T] = js.Function1[/* arrays2 */ lodashLib.lodashMod.underscoreNs.List[T], js.Array[T]]
  type LodashIntersectionBy1x3[T1, T2] = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.List[T2], js.Array[T1]]
  type LodashIntersectionBy1x5[T1] = js.Function1[/* array */ lodashLib.lodashMod.underscoreNs.List[T1] | scala.Null, js.Array[T1]]
  type LodashIntersectionBy1x6[T1, T2] = js.Function1[
    /* iteratee */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T1 | T2], 
    js.Array[T1]
  ]
  type LodashIntersectionWith1x3[T1, T2] = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.List[T2], js.Array[T1]]
  ...
  type LodashInvert = js.Function1[
    /* object */ js.Object, 
    lodashLib.lodashMod.underscoreNs.Dictionary[java.lang.String]
  ]
  type LodashInvertBy1x1[T] = js.Function1[
    /* object */ js.UndefOr[
      lodashLib.lodashMod.underscoreNs.List[T] | lodashLib.lodashMod.underscoreNs.Dictionary[T] | lodashLib.lodashMod.underscoreNs.NumericDictionary[T] | js.Object | scala.Null
    ], 
    lodashLib.lodashMod.underscoreNs.Dictionary[js.Array[java.lang.String]]
  ]
  ...
  type LodashInvoke1x2 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  ...
  type LodashInvokeArgs1x6 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  ...
  type LodashIsArguments = js.Function1[/* value */ js.Any, /* is IArguments */scala.Boolean]
  type LodashIsArray = js.Function1[/* value */ js.Any, /* is Array */scala.Boolean]
  type LodashIsArrayBuffer = js.Function1[/* value */ js.Any, /* is ArrayBuffer */scala.Boolean]
  ...
  type LodashIsDate = js.Function1[/* value */ js.Any, /* is Date */scala.Boolean]
  ...
  type LodashIsEqualWith1x6 = js.Function1[/* customizer */ lodashLib.lodashMod.underscoreNs.IsEqualCustomizer, scala.Boolean]
  type LodashIsError = js.Function1[/* value */ js.Any, /* is Error */scala.Boolean]
  ...
  type LodashIsMap = js.Function1[/* value */ js.Any, /* is Map */scala.Boolean]
  ...
  type LodashIsRegExp = js.Function1[/* value */ js.Any, /* is RegExp */scala.Boolean]
  type LodashIsSafeInteger = js.Function1[/* value */ js.Any, scala.Boolean]
  type LodashIsSet = js.Function1[/* value */ js.Any, /* is Set */scala.Boolean]
  ...
  type LodashIsWeakMap = js.Function1[/* value */ js.Any, /* is WeakMap */scala.Boolean]
  type LodashIsWeakSet = js.Function1[/* value */ js.Any, /* is WeakSet */scala.Boolean]
  ...
  type LodashKeyBy1x1[T] = js.Function1[
    /* collection */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[T] | js.Object | scala.Null], 
    lodashLib.lodashMod.underscoreNs.Dictionary[T]
  ]
  ...
  type LodashMap1x1[T, TResult] = js.Function1[
    /* collection */ js.UndefOr[js.Array[T] | lodashLib.lodashMod.underscoreNs.List[T] | scala.Null], 
    js.Array[TResult]
  ]
  ...
  type LodashMapKeys1x1 = js.Function1[
    /* object */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[js.Any] | scala.Null], 
    lodashLib.lodashMod.underscoreNs.Dictionary[js.Any]
  ]
  ...
  type LodashMapKeys2x1 = js.Function1[
    ...
    lodashLib.lodashMod.underscoreNs.Dictionary[
      /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(object))),List()),Right(TsTypeKeyOf(TsTypeRef(TsQIdent(List(TsIdentSimple(object))),List())))) */js.Any
    ]
  ]
  ...
  type LodashMax = js.Function1[
    /* collection */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[js.Any] | scala.Null], 
    js.UndefOr[js.Any]
  ]
  ...
  type LodashMaxBy1x2[T] = js.Function1[/* iteratee */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], js.UndefOr[T]]
  ...
  type LodashMeanBy1x2[T] = js.Function1[/* iteratee */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], scala.Double]
  type LodashMemoize = js.Function1[
    /* func */ js.Function1[/* repeated */js.Any, js.Any], 
    (js.Function1[/* repeated */js.Any, _]) with lodashLib.lodashMod.underscoreNs.MemoizedFunction
  ]
  ...
  type LodashMergeAllWith1x2 = js.Function1[/* customizer */ lodashLib.lodashMod.underscoreNs.MergeWithCustomizer, js.Any]
  ...
  type LodashMethodOf = js.Function1[
    /* object */ js.Object, 
    js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  ]
  ...
  type LodashNoConflict = js.Function0[js.Object]
  ...
  type LodashOmit2x1[T, K /* <: java.lang.String */] = js.Function1[
    /* object */ js.UndefOr[T | scala.Null], 
    lodashLib.lodashMod.underscoreNs.Omit[T, K]
  ]
  ...
  type LodashOmitBy2x2[T] = js.Function1[
    /* predicate */ lodashLib.lodashMod.underscoreNs.ValueKeyIteratee[T], 
    lodashLib.lodashMod.underscoreNs.NumericDictionary[T]
  ]
  type LodashOmitBy3x2[T] = js.Function1[
    /* predicate */ lodashLib.lodashMod.underscoreNs.ValueKeyIteratee[
      /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Right(TsTypeKeyOf(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List())))) */js.Any
    ], 
    lodashLib.lodashMod.underscoreNs.PartialObject[T]
  ]
  ...
  type LodashOrderBy1x6[T] = js.Function1[
    /* iteratees */ (lodashLib.lodashMod.underscoreNs.Many[js.Function1[/* value */ T, lodashLib.lodashMod.underscoreNs.NotVoid]]) | lodashLib.lodashMod.underscoreNs.Many[lodashLib.lodashMod.underscoreNs.ValueIteratee[T]], 
    js.Array[T]
  ]
  ...
  type LodashOrderBy3x6[T] = js.Function1[
    ...
    ]) | (lodashLib.lodashMod.underscoreNs.Many[
  ...
  type LodashOver = js.Function1[
    /* iteratees */ lodashLib.lodashMod.underscoreNs.Many[js.Function1[/* repeated */js.Any, js.Any]], 
    js.Function1[/* repeated */js.Any, js.Array[js.Any]]
  ]
  type LodashOverArgs1x1 = js.Function1[
    /* transforms */ lodashLib.lodashMod.underscoreNs.Many[js.Function1[/* repeated */js.Any, js.Any]], 
    js.Function1[/* repeated */js.Any, js.Any]
  ]
  ...
  type LodashOverEvery = js.Function1[
    /* predicates */ lodashLib.lodashMod.underscoreNs.Many[js.Function1[/* repeated */js.Any, scala.Boolean]], 
  ...
  type LodashPartial19x2[T4] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[js.Any, js.Any, js.Any, T4, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartial1x1[T1, R] = js.Function1[/* arg1 */ js.Array[T1], lodashLib.lodashMod.underscoreNs.Function0[R]]
  type LodashPartial20x2[T1, T4] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[T1, js.Any, js.Any, T4, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartial21x2[T2, T4] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[js.Any, T2, js.Any, T4, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartial22x2[T1, T2, T4] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[T1, T2, js.Any, T4, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function1[js.Any, js.Any]
  ]
  type LodashPartial23x2[T3, T4] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[js.Any, js.Any, T3, T4, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartial24x2[T1, T3, T4] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[T1, js.Any, T3, T4, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function1[js.Any, js.Any]
  ]
  type LodashPartial25x2[T2, T3, T4] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[js.Any, T2, T3, T4, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function1[js.Any, js.Any]
  ]
  type LodashPartial26x2[T1, T2, T3, T4] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[T1, T2, T3, T4, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function0[js.Any]
  ]
  ...
  type LodashPartialRight10x2[T2, T3] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function3[js.Any, T2, T3, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight11x2[T1, T2, T3] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function3[T1, T2, T3, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function0[js.Any]
  ]
  type LodashPartialRight12x2[T1] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[T1, js.Any, js.Any, js.Any, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight13x2[T2] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[js.Any, T2, js.Any, js.Any, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight14x2[T1, T2] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[T1, T2, js.Any, js.Any, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight15x2[T3] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[js.Any, js.Any, T3, js.Any, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function3[js.Any, js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight16x2[T1, T3] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[T1, js.Any, T3, js.Any, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight17x2[T2, T3] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[js.Any, T2, T3, js.Any, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight18x2[T1, T2, T3] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function4[T1, T2, T3, js.Any, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function1[js.Any, js.Any]
  ]
  ...
  type LodashPartialRight1x1[T1, R] = js.Function1[/* arg1 */ js.Array[T1], lodashLib.lodashMod.underscoreNs.Function0[R]]
  type LodashPartialRight1x2[T1] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function1[T1, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function0[js.Any]
  ]
  ...
  type LodashPartialRight2x2[T1] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function2[T1, js.Any, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight3x2[T2] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function2[js.Any, T2, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight4x2[T1, T2] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function2[T1, T2, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function0[js.Any]
  ]
  type LodashPartialRight5x2[T1] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function3[T1, js.Any, js.Any, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight6x2[T2] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function3[js.Any, T2, js.Any, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight7x2[T1, T2] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function3[T1, T2, js.Any, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function1[js.Any, js.Any]
  ]
  type LodashPartialRight8x2[T3] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function3[js.Any, js.Any, T3, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function2[js.Any, js.Any, js.Any]
  ]
  type LodashPartialRight9x2[T1, T3] = js.Function1[
    /* func */ lodashLib.lodashMod.underscoreNs.Function3[T1, js.Any, T3, js.Any], 
    lodashLib.lodashMod.underscoreNs.Function1[js.Any, js.Any]
  ]
  ...
  type LodashPath5x2 = js.Function1[
    /* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, 
    js.UndefOr[scala.Nothing]
  ]
  type LodashPath6x2 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  ...
  type LodashPathOr3x5[TDefault] = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, TDefault]
  type LodashPathOr3x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashPathOr4x3 = js.Function1[/* object */ js.Any, js.Any]
  type LodashPathOr4x5 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  ...
  type LodashPick2x1 = js.Function1[
    ...
    lodashLib.lodashMod.underscoreNs.PartialDeep[js.Any]
  ]
  type LodashPick2x2[T] = js.Function1[
    /* props */ lodashLib.lodashMod.underscoreNs.PropertyPath, 
    lodashLib.lodashMod.underscoreNs.PartialDeep[T]
  ]
  ...
  type LodashProp5x2 = js.Function1[
    /* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, 
    js.UndefOr[scala.Nothing]
  ]
  type LodashProp6x2 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  ...
  type LodashPropOr3x5[TDefault] = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, TDefault]
  type LodashPropOr3x6 = js.Function1[/* defaultValue */ js.Any, js.Any]
  type LodashPropOr4x3 = js.Function1[/* object */ js.Any, js.Any]
  type LodashPropOr4x5 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  ...
  type LodashProperty5x2 = js.Function1[
    /* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, 
    js.UndefOr[scala.Nothing]
  ]
  type LodashProperty6x2 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  ...
  type LodashPropertyOf5x2 = js.Function1[
    /* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, 
    js.UndefOr[scala.Nothing]
  ]
  type LodashPropertyOf6x2 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  type LodashPull1x2[T] = js.Function1[/* values */ T, js.Array[T]]
  type LodashPull2x2[T] = js.Function1[/* values */ T, lodashLib.lodashMod.underscoreNs.List[T]]
  type LodashPullAll1x2[T] = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.List[T], js.Array[T]]
  type LodashPullAll2x2[T] = js.Function1[
    /* values */ lodashLib.lodashMod.underscoreNs.List[T], 
    lodashLib.lodashMod.underscoreNs.List[T]
  ]
  type LodashPullAllBy1x5[T] = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.List[T], js.Array[T]]
  type LodashPullAllBy1x6[T] = js.Function1[/* iteratee */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], js.Array[T]]
  ...
  type LodashPullAllBy3x5[T1, T2] = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.List[T2], js.Array[T1]]
  ...
  type LodashPullAllWith1x5[T] = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.List[T], js.Array[T]]
  type LodashPullAllWith1x6[T] = js.Function1[/* comparator */ lodashLib.lodashMod.underscoreNs.Comparator[T], js.Array[T]]
  ...
  type LodashPullAllWith3x5[T1, T2] = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.List[T2], js.Array[T1]]
  ...
  type LodashPullAt1x2[T] = js.Function1[/* indexes */ lodashLib.lodashMod.underscoreNs.Many[scala.Double], js.Array[T]]
  ...
  type LodashRemove1x1[T] = js.Function1[/* array */ lodashLib.lodashMod.underscoreNs.List[T], js.Array[T]]
  type LodashRemove1x2[T] = js.Function1[/* predicate */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], js.Array[T]]
  ...
  type LodashReplace1x5 = js.Function1[
    /* replacement */ lodashLib.lodashMod.underscoreNs.ReplaceFunction | java.lang.String, 
    java.lang.String
  ]
  ...
  type LodashResult1x2 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  type LodashReverse = js.Function1[
    /* array */ lodashLib.lodashMod.underscoreNs.List[js.Any], 
    lodashLib.lodashMod.underscoreNs.List[js.Any]
  ]
  type LodashRound = js.Function1[/* n */ scala.Double, scala.Double]
  type LodashRunInContext = js.Function1[/* context */ js.Object, lodashLib.lodashMod.underscoreNs.LoDashStatic]
  ...
  type LodashSet1x6[T] = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, T]
  type LodashSet2x5 = js.Function1[/* value */ js.Any, js.Any]
  type LodashSet2x6 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  type LodashSetWith1x11[T] = js.Function1[/* value */ js.Any, T]
  type LodashSetWith1x13[T] = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, T]
  type LodashSetWith1x14[T] = js.Function1[/* customizer */ lodashLib.lodashMod.underscoreNs.SetWithCustomizer[T], T]
  ...
  type LodashSortedIndexBy1x6[T] = js.Function1[/* iteratee */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], scala.Double]
  ...
  type LodashSortedLastIndexBy1x6[T] = js.Function1[/* iteratee */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], scala.Double]
  ...
  type LodashSortedUniqBy1x2[T] = js.Function1[/* iteratee */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], js.Array[T]]
  ...
  type LodashTakeRightWhile1x2[T] = js.Function1[/* predicate */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], js.Array[T]]
  type LodashTakeWhile1x1[T] = js.Function1[
    /* array */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashTakeWhile1x2[T] = js.Function1[/* predicate */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], js.Array[T]]
  type LodashTap1x1[T] = js.Function1[/* value */ T, T]
  type LodashTap1x2[T] = js.Function1[/* interceptor */ js.Function1[/* value */ T, scala.Unit], T]
  type LodashTemplate = js.Function1[/* string */ java.lang.String, lodashLib.lodashMod.underscoreNs.TemplateExecutor]
  type LodashThrottle1x1 = js.Function1[
    /* func */ js.Function1[/* repeated */js.Any, js.Any], 
    (js.Function1[/* repeated */js.Any, _]) with lodashLib.lodashMod.underscoreNs.Cancelable
  ]
  type LodashThrottle1x2[T] = js.Function1[/* wait */ scala.Double, T with lodashLib.lodashMod.underscoreNs.Cancelable]
  ...
  type LodashTransform1x3[T, TResult] = js.Function1[
    /* object */ js.Array[T] | lodashLib.lodashMod.underscoreNs.Dictionary[T], 
    js.Array[TResult]
  ]
  ...
  type LodashTruncate1x2 = js.Function1[/* options */ lodashLib.lodashMod.underscoreNs.TruncateOptions, java.lang.String]
  ...
  type LodashUnion1x2[T] = js.Function1[
    /* arrays2 */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[T] | scala.Null], 
    js.Array[T]
  ]
  ...
  type LodashUnionBy1x5[T] = js.Function1[
    /* arrays1 */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashUnionBy1x6[T] = js.Function1[/* iteratee */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], js.Array[T]]
  ...
  type LodashUnionWith1x6[T] = js.Function1[/* comparator */ lodashLib.lodashMod.underscoreNs.Comparator[T], js.Array[T]]
  ...
  type LodashUniqBy1x2[T] = js.Function1[/* iteratee */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], js.Array[T]]
  type LodashUniqWith1x1[T] = js.Function1[
    /* array */ js.UndefOr[lodashLib.lodashMod.underscoreNs.List[T] | scala.Null], 
    js.Array[T]
  ]
  type LodashUniqWith1x2[T] = js.Function1[/* comparator */ lodashLib.lodashMod.underscoreNs.Comparator[T], js.Array[T]]
  ...
  type LodashUnset1x2[T] = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, T]
  type LodashUnzip = js.Function1[
    /* array */ js.UndefOr[
      js.Array[js.Array[js.Any]] | lodashLib.lodashMod.underscoreNs.List[lodashLib.lodashMod.underscoreNs.List[js.Any]] | scala.Null
    ], 
    js.Array[js.Array[js.Any]]
  ]
  ...
  type LodashUpdate1x6 = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, js.Any]
  type LodashUpdateWith1x11[T] = js.Function1[/* updater */ js.Function1[/* oldValue */ js.Any, js.Any], T]
  type LodashUpdateWith1x13[T] = js.Function1[/* path */ lodashLib.lodashMod.underscoreNs.PropertyPath, T]
  type LodashUpdateWith1x14[T] = js.Function1[/* customizer */ lodashLib.lodashMod.underscoreNs.SetWithCustomizer[T], T]
  ...
  type LodashXorBy1x6[T] = js.Function1[/* iteratee */ lodashLib.lodashMod.underscoreNs.ValueIteratee[T], js.Array[T]]
  ...
  type LodashXorWith1x6[T] = js.Function1[/* comparator */ lodashLib.lodashMod.underscoreNs.Comparator[T], js.Array[T]]
  type LodashZip1x1[T1] = js.Function1[
    /* arrays2 */ lodashLib.lodashMod.underscoreNs.List[js.Any], 
    js.Array[js.Tuple2[js.UndefOr[T1], js.UndefOr[js.Any]]]
  ]
  type LodashZip1x2[T2] = js.Function1[
    /* arrays1 */ lodashLib.lodashMod.underscoreNs.List[js.Any], 
    js.Array[js.Tuple2[js.UndefOr[js.Any], js.UndefOr[T2]]]
  ]
  type LodashZipObject1x1 = js.Function1[
    /* values */ lodashLib.lodashMod.underscoreNs.List[js.Any], 
    lodashLib.lodashMod.underscoreNs.Dictionary[js.Any]
  ]
  ...
  type LodashZipObjectDeep1x1 = js.Function1[/* values */ lodashLib.lodashMod.underscoreNs.List[js.Any], js.Object]
  ...
  type LodashZipWith1x3[T2, TResult] = js.Function1[/* arrays2 */ lodashLib.lodashMod.underscoreNs.List[T2], js.Array[TResult]]
  type LodashZipWith1x5[T1, TResult] = js.Function1[/* arrays1 */ lodashLib.lodashMod.underscoreNs.List[T1], js.Array[TResult]]
