...
trait LodashPartial extends js.Object {
  ...
  def apply[T1, T2, R](func: lodashLib.lodashMod.underscoreNs.Function2[T1, T2, R]): LodashPartial2x1[T1, T2, R] = js.native
  def apply[T1, T2, R](func: lodashLib.lodashMod.underscoreNs.Function2[T1, T2, R], arg1: js.Array[T1]): lodashLib.lodashMod.underscoreNs.Function1[T2, R] = js.native
  ...
  def apply[T1, T2, T3, R](func: lodashLib.lodashMod.underscoreNs.Function3[T1, T2, T3, R]): LodashPartial5x1[T1, T2, T3, R] = js.native
  def apply[T1, T2, T3, R](func: lodashLib.lodashMod.underscoreNs.Function3[T1, T2, T3, R], arg1: js.Array[T1]): lodashLib.lodashMod.underscoreNs.Function2[T2, T3, R] = js.native
  ...
  def apply[T1, T2, T3, T4, R](func: lodashLib.lodashMod.underscoreNs.Function4[T1, T2, T3, T4, R], arg1: js.Tuple2[T1, T2]): lodashLib.lodashMod.underscoreNs.Function2[T3, T4, R] = js.native
