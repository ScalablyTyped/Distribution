...
trait LoDashImplicitWrapper[TValue] extends LoDashWrapper[TValue] {
  ...
  /**
           ...
           */
  @JSName("findLast")
  def findLast_TObject[T /* <: js.Object */](`this`: LoDashImplicitWrapper[js.UndefOr[T | scala.Null]]): js.UndefOr[
    /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Right(TsTypeKeyOf(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List())))) */js.Any
  ] = js.native
  /**
           * @see _.findLast
  ...
  /**
           ...
           */
  @JSName("find")
  def find_TObject[T /* <: js.Object */](`this`: LoDashImplicitWrapper[js.UndefOr[T | scala.Null]]): js.UndefOr[
    /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Right(TsTypeKeyOf(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List())))) */js.Any
  ] = js.native
  /**
           * @see _.find
  ...
  /**
           * @see _.get
           */
  def get[TKey /* <: java.lang.String */](path: TKey): /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(TValue))),List()),Left(TsIdentSimple(TKey))) */js.Any = js.native
  /**
           * @see _.get
           */
  def get[TKey /* <: java.lang.String */](path: js.Array[TKey]): /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(TValue))),List()),Left(TsIdentSimple(TKey))) */js.Any = js.native
  /**
           * @see _.get
           */
  ...
  def get[TObject /* <: js.Object */, TKey /* <: java.lang.String */, TDefault](
    ...
    path: TKey,
    defaultValue: TDefault
  ): (/* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(TObject))),List()),Left(TsIdentSimple(TKey))) */js.Any) | TDefault = js.native
  /**
           * @see _.get
           */
  def get[TObject /* <: js.Object */, TKey /* <: java.lang.String */, TDefault](
  ...
  /**
           ...
           */
  @JSName("mapValues")
  def mapValues_TObject[T /* <: js.Object */](`this`: LoDashImplicitWrapper[js.UndefOr[T | scala.Null]], iteratee: java.lang.String): LoDashImplicitWrapper[lodashLib.lodashLibStrings.LoDashImplicitWrapper with js.Any] = js.native
  /**
           * @see _.mapValues
           */
  @JSName("mapValues")
  def mapValues_TObject[T /* <: js.Object */](`this`: LoDashImplicitWrapper[js.UndefOr[T | scala.Null]], iteratee: js.Object): LoDashImplicitWrapper[lodashLib.lodashLibStrings.LoDashImplicitWrapper with js.Any] = js.native
  /**
           * @see _.mapValues
           */
  @JSName("mapValues")
  def mapValues_TObjectTResult[T /* <: js.Object */, TResult](`this`: LoDashImplicitWrapper[js.UndefOr[T | scala.Null]], callback: ObjectIterator[T, TResult]): LoDashImplicitWrapper[lodashLib.lodashLibStrings.LoDashImplicitWrapper with js.Any] = js.native
  /**
           * @see _.mapValues
           * TODO: This would be better if we had a separate overload for obj: NumericDictionary that returned a NumericDictionary,
           *       but TypeScript cannot select overload signatures based on number vs string index key type.
  ...
  /**
           ...
           */
  @JSName("map")
  def map_TObjectTResult[T /* <: js.Object */, TResult](`this`: LoDashImplicitWrapper[js.UndefOr[T | scala.Null]], iteratee: ObjectIterator[T, TResult]): LoDashImplicitWrapper[js.Array[TResult]] = js.native
  /**
           * @see _.matches
           */
  ...
  /**
           * @see _.omit
           */
  def omit[T /* <: js.Object */](`this`: LoDashImplicitWrapper[js.UndefOr[T | scala.Null]], paths: Many[PropertyName]*): LoDashImplicitWrapper[PartialObject[T]] = js.native
  /**
           * @see _.omitBy
           */
  ...
  /**
           ...
           */
  @JSName("omit")
  def omit_TAnyKindOfDictionary[T /* <: AnyKindOfDictionary */](`this`: LoDashImplicitWrapper[js.UndefOr[T | scala.Null]], paths: Many[PropertyName]*): LoDashImplicitWrapper[T] = js.native
  /**
           * @see _.omit
           */
  @JSName("omit")
  ...
  /**
           ...
           */
  @JSName("sample")
  def sample_TObject[T /* <: js.Object */](`this`: LoDashImplicitWrapper[js.UndefOr[T | scala.Null]]): js.UndefOr[
    /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Right(TsTypeKeyOf(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List())))) */js.Any
  ] = js.native
  /**
           * @see _.set
