...
trait LoDashStatic extends js.Object {
  ...
  /**
    ...
    */
  @JSName("memoize")
  var memoize_Original: lodashLib.Anon_Args = js.native
  /**
  ...
  /**
    ...
    */
  def after[TFunc /* <: js.Function1[/* repeated */ js.Any, _] */](n: scala.Double, func: TFunc): TFunc = js.native
  /**
  ...
  def ary(func: js.Function1[/* repeated */ js.Any, _], n: scala.Double): js.Function1[/* repeated */ js.Any, _] = js.native
  /**
    * @see _.assign
    */
  ...
  /**
    ...
    */
  def attempt[TResult](func: js.Function1[/* repeated */ js.Any, TResult], args: js.Any*): TResult | stdLib.Error = js.native
  /**
    ...
    * @return Returns the new restricted function.
    */
  def before[TFunc /* <: js.Function1[/* repeated */ js.Any, _] */](n: scala.Double, func: TFunc): TFunc = js.native
  /**
    * Creates a function that invokes func with the this binding of thisArg and prepends any additional _.bind
    * arguments to those provided to the bound function.
    *
  ...
  def ceil(n: scala.Double, precision: scala.Double): scala.Double = js.native
  /**
  ...
  def chunk[T](array: js.UndefOr[scala.Nothing], size: scala.Double): js.Array[js.Array[T]] = js.native
  /**
  ...
  def chunk[T](array: List[T], size: scala.Double): js.Array[js.Array[T]] = js.native
  def chunk[T](array: scala.Null, size: scala.Double): js.Array[js.Array[T]] = js.native
  /**
    ...
    * // => 5
    */
  def clamp(number: scala.Double, lower: scala.Double, upper: scala.Double): scala.Double = js.native
  def clamp(number: scala.Double, upper: scala.Double): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("cloneWith")
  def `cloneWith_TTResult<union>TResult`[T, TResult /* <: js.Object | java.lang.String | scala.Double | scala.Boolean | scala.Null */](value: T, customizer: CloneWithCustomizer[T, TResult]): TResult = js.native
  ...
  /**
    ...
    */
  def conforms[T](source: ConformsPredicateObject[T]): js.Function1[/* value */ T, scala.Boolean] = js.native
  /**
    ...
    */
  def conformsTo[T](`object`: T, source: ConformsPredicateObject[T]): scala.Boolean = js.native
  /**
  ...
  def countBy[T](): Dictionary[scala.Double] = js.native
  /**
    * @see _.countBy
    */
  def countBy[T /* <: js.Object */](collection: T): Dictionary[scala.Double] = js.native
  def countBy[T /* <: js.Object */](
    collection: T,
    iteratee: ValueIteratee[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any]
  ): Dictionary[scala.Double] = js.native
  def countBy[T](collection: js.UndefOr[scala.Nothing], iteratee: ValueIteratee[T]): Dictionary[scala.Double] = js.native
  /**
    ...
    */
  def countBy[T](collection: List[T]): Dictionary[scala.Double] = js.native
  def countBy[T](collection: List[T], iteratee: ValueIteratee[T]): Dictionary[scala.Double] = js.native
  def countBy[T](collection: scala.Null, iteratee: ValueIteratee[T]): Dictionary[scala.Double] = js.native
  @JSName("countBy")
  def countBy_TObject[T /* <: js.Object */](): Dictionary[scala.Double] = js.native
  @JSName("countBy")
  ...
  def curry(func: js.Function1[/* repeated */ js.Any, _], arity: scala.Double): js.Function1[/* repeated */ js.Any, _] = js.native
  /**
    * Creates a function that accepts one or more arguments of func that when called either invokes func returning
    * its result, if all func arguments have been provided, or returns a function that accepts one or more of the
    * remaining func arguments, and so on. The arity of func may be specified if func.length is not sufficient.
  ...
  def curry[T1, T2, R](func: js.Function2[/* t1 */ T1, /* t2 */ T2, R], arity: scala.Double): CurriedFunction2[T1, T2, R] = js.native
  /**
    * Creates a function that accepts one or more arguments of func that when called either invokes func returning
    * its result, if all func arguments have been provided, or returns a function that accepts one or more of the
    * remaining func arguments, and so on. The arity of func may be specified if func.length is not sufficient.
  ...
  def curry[T1, T2, T3, R](func: js.Function3[/* t1 */ T1, /* t2 */ T2, /* t3 */ T3, R], arity: scala.Double): CurriedFunction3[T1, T2, T3, R] = js.native
  /**
    * Creates a function that accepts one or more arguments of func that when called either invokes func returning
    * its result, if all func arguments have been provided, or returns a function that accepts one or more of the
    * remaining func arguments, and so on. The arity of func may be specified if func.length is not sufficient.
  ...
  def curry[T1, T2, T3, T4, R](func: js.Function4[/* t1 */ T1, /* t2 */ T2, /* t3 */ T3, /* t4 */ T4, R], arity: scala.Double): CurriedFunction4[T1, T2, T3, T4, R] = js.native
  /**
    * Creates a function that accepts one or more arguments of func that when called either invokes func returning
    * its result, if all func arguments have been provided, or returns a function that accepts one or more of the
    * remaining func arguments, and so on. The arity of func may be specified if func.length is not sufficient.
  ...
  def curryRight(func: js.Function1[/* repeated */ js.Any, _], arity: scala.Double): js.Function1[/* repeated */ js.Any, _] = js.native
  /**
    * This method is like _.curry except that arguments are applied to func in the manner of _.partialRight
    * instead of _.partial.
    * @param func The function to curry.
  ...
  def curryRight[T1, T2, R](func: js.Function2[/* t1 */ T1, /* t2 */ T2, R], arity: scala.Double): RightCurriedFunction2[T1, T2, R] = js.native
  /**
    * This method is like _.curry except that arguments are applied to func in the manner of _.partialRight
    * instead of _.partial.
    * @param func The function to curry.
  ...
  def curryRight[T1, T2, T3, R](func: js.Function3[/* t1 */ T1, /* t2 */ T2, /* t3 */ T3, R], arity: scala.Double): RightCurriedFunction3[T1, T2, T3, R] = js.native
  /**
    * This method is like _.curry except that arguments are applied to func in the manner of _.partialRight
    * instead of _.partial.
    * @param func The function to curry.
  ...
  def curryRight[T1, T2, T3, T4, R](func: js.Function4[/* t1 */ T1, /* t2 */ T2, /* t3 */ T3, /* t4 */ T4, R], arity: scala.Double): RightCurriedFunction4[T1, T2, T3, T4, R] = js.native
  /**
    * This method is like _.curry except that arguments are applied to func in the manner of _.partialRight
    * instead of _.partial.
    * @param func The function to curry.
  ...
  /**
    ...
    */
  @JSName("curryRight")
  def curryRight_T1RRightCurriedFunction1[T1, R](func: js.Function1[/* t1 */ T1, R]): RightCurriedFunction1[T1, R] = js.native
  @JSName("curryRight")
  def curryRight_T1RRightCurriedFunction1[T1, R](func: js.Function1[/* t1 */ T1, R], arity: scala.Double): RightCurriedFunction1[T1, R] = js.native
  /**
    * Creates a function that accepts one or more arguments of func that when called either invokes func returning
    * its result, if all func arguments have been provided, or returns a function that accepts one or more of the
    * remaining func arguments, and so on. The arity of func may be specified if func.length is not sufficient.
    ...
    */
  @JSName("curry")
  def curry_T1RCurriedFunction1[T1, R](func: js.Function1[/* t1 */ T1, R]): CurriedFunction1[T1, R] = js.native
  @JSName("curry")
  def curry_T1RCurriedFunction1[T1, R](func: js.Function1[/* t1 */ T1, R], arity: scala.Double): CurriedFunction1[T1, R] = js.native
  /**
  ...
  def debounce[T /* <: js.Function1[/* repeated */ js.Any, _] */](func: T, wait: scala.Double): T with Cancelable = js.native
  def debounce[T /* <: js.Function1[/* repeated */ js.Any, _] */](func: T, wait: scala.Double, options: DebounceSettings): T with Cancelable = js.native
  /**
  ...
  def defaultTo[T](value: scala.Null, defaultValue: T): T = js.native
  /**
    * @see _.defaultTo
    */
  @JSName("defaultTo")
  def `defaultTo_TTDefault<union>`[T, TDefault](value: T, defaultValue: TDefault): T | TDefault = js.native
  @JSName("defaultTo")
  def `defaultTo_TTDefault<union>`[T, TDefault](value: js.UndefOr[scala.Nothing], defaultValue: TDefault): T | TDefault = js.native
  @JSName("defaultTo")
  def `defaultTo_TTDefault<union>`[T, TDefault](value: scala.Null, defaultValue: TDefault): T | TDefault = js.native
  /**
    * @see _.defaults
    */
  ...
  /**
    ...
    * @return Returns the timer id.
    */
  def delay(func: js.Function1[/* repeated */ js.Any, _], wait: scala.Double, args: js.Any*): scala.Double = js.native
  /**
  ...
  def differenceBy[T1, T2](array: scala.Null, values: List[T2], iteratee: ValueIteratee[T1 | T2]): js.Array[T1] = js.native
  ...
  def differenceBy[T1, T2, T3](array: scala.Null, values1: List[T2], values2: List[T3], iteratee: ValueIteratee[T1 | T2 | T3]): js.Array[T1] = js.native
  ...
  def differenceWith[T1, T2](array: scala.Null, values: List[T2], comparator: Comparator2[T1, T2]): js.Array[T1] = js.native
  ...
  def differenceWith[T1, T2, T3](array: scala.Null, values1: List[T2], values2: List[T3], comparator: Comparator2[T1, T2 | T3]): js.Array[T1] = js.native
  ...
  def drop[T](array: js.UndefOr[scala.Nothing], n: scala.Double): js.Array[T] = js.native
  /**
  ...
  def drop[T](array: scala.Null, n: scala.Double): js.Array[T] = js.native
  def dropRight[T](): js.Array[T] = js.native
  def dropRight[T](array: js.UndefOr[scala.Nothing], n: scala.Double): js.Array[T] = js.native
  /**
  ...
  def dropRight[T](array: List[T], n: scala.Double): js.Array[T] = js.native
  def dropRight[T](array: scala.Null, n: scala.Double): js.Array[T] = js.native
  ...
  def dropRightWhile[T](array: scala.Null, predicate: ListIteratee[T]): js.Array[T] = js.native
  ...
  @JSName("eachRight")
  def eachRight_TTArrayUndefOrTArray[T, TArray /* <: js.UndefOr[js.Array[T] | scala.Null] */](collection: TArray with (js.UndefOr[js.Array[T] | scala.Null]), iteratee: ArrayIterator[T, _]): TArray = js.native
  @JSName("eachRight")
  def eachRight_TTListUndefOrTList[T, TList /* <: js.UndefOr[List[T] | scala.Null] */](collection: TList with (js.UndefOr[List[T] | scala.Null])): TList = js.native
  @JSName("eachRight")
  ...
  @JSName("each")
  def each_TTArrayUndefOrTArray[T, TArray /* <: js.UndefOr[js.Array[T] | scala.Null] */](collection: TArray with (js.UndefOr[js.Array[T] | scala.Null]), iteratee: ArrayIterator[T, _]): TArray = js.native
  @JSName("each")
  def each_TTListUndefOrTList[T, TList /* <: js.UndefOr[List[T] | scala.Null] */](collection: TList with (js.UndefOr[List[T] | scala.Null])): TList = js.native
  @JSName("each")
  def each_TTListUndefOrTList[T, TList /* <: js.UndefOr[List[T] | scala.Null] */](collection: TList with (js.UndefOr[List[T] | scala.Null]), iteratee: ListIterator[T, _]): TList = js.native
  /**
  ...
  def endsWith(string: java.lang.String): scala.Boolean = js.native
  def endsWith(string: java.lang.String, target: java.lang.String): scala.Boolean = js.native
  def endsWith(string: java.lang.String, target: java.lang.String, position: scala.Double): scala.Boolean = js.native
  /**
    * @see _.toPairs
    */
  ...
  def every[T](): scala.Boolean = js.native
  /**
    * @see _.every
    */
  def every[T /* <: js.Object */](collection: T): scala.Boolean = js.native
  def every[T /* <: js.Object */](collection: T, predicate: ObjectIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  def every[T](collection: js.UndefOr[scala.Nothing], predicate: ListIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  /**
    ...
    */
  def every[T](collection: List[T]): scala.Boolean = js.native
  def every[T](collection: List[T], predicate: ListIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  def every[T](collection: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  @JSName("every")
  def every_TObject[T /* <: js.Object */](): scala.Boolean = js.native
  @JSName("every")
  def every_TObject[T /* <: js.Object */](collection: js.UndefOr[scala.Nothing], predicate: ObjectIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  @JSName("every")
  def every_TObject[T /* <: js.Object */](collection: scala.Null, predicate: ObjectIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  /**
    * @see _.extend
    */
  ...
  def fill[T](array: scala.Null, value: T): List[T] = js.native
  def fill[T, U](array: js.Array[U], value: T, start: scala.Double): js.Array[T | U] = js.native
  def fill[T, U](array: js.Array[U], value: T, start: scala.Double, end: scala.Double): js.Array[T | U] = js.native
  def fill[T, U](array: js.UndefOr[scala.Nothing], value: T, start: scala.Double): List[T | U] = js.native
  def fill[T, U](array: js.UndefOr[scala.Nothing], value: T, start: scala.Double, end: scala.Double): List[T | U] = js.native
  def fill[T, U](array: List[U], value: T, start: scala.Double): List[T | U] = js.native
  def fill[T, U](array: List[U], value: T, start: scala.Double, end: scala.Double): List[T | U] = js.native
  def fill[T, U](array: scala.Null, value: T, start: scala.Double): List[T | U] = js.native
  def fill[T, U](array: scala.Null, value: T, start: scala.Double, end: scala.Double): List[T | U] = js.native
  @JSName("fill")
  def fill_TArray[T](array: js.UndefOr[scala.Nothing], value: T): js.Array[T] = js.native
  @JSName("fill")
  def fill_TArray[T](array: scala.Null, value: T): js.Array[T] = js.native
  /**
    * @see _.fill
    */
  @JSName("fill")
  ...
  @JSName("fill")
  def fill_TU[T, U](array: scala.Null, value: T): List[T | U] = js.native
  @JSName("fill")
  def fill_TUArray[T, U](array: js.UndefOr[scala.Nothing], value: T): js.Array[T | U] = js.native
  @JSName("fill")
  def fill_TUArray[T, U](array: js.UndefOr[scala.Nothing], value: T, start: scala.Double): js.Array[T | U] = js.native
  @JSName("fill")
  def fill_TUArray[T, U](array: js.UndefOr[scala.Nothing], value: T, start: scala.Double, end: scala.Double): js.Array[T | U] = js.native
  @JSName("fill")
  def fill_TUArray[T, U](array: scala.Null, value: T): js.Array[T | U] = js.native
  @JSName("fill")
  def fill_TUArray[T, U](array: scala.Null, value: T, start: scala.Double): js.Array[T | U] = js.native
  @JSName("fill")
  def fill_TUArray[T, U](array: scala.Null, value: T, start: scala.Double, end: scala.Double): js.Array[T | U] = js.native
  ...
  def filter(collection: java.lang.String, predicate: StringIterator[scala.Boolean]): js.Array[java.lang.String] = js.native
  def filter(collection: js.UndefOr[scala.Nothing], predicate: StringIterator[scala.Boolean]): js.Array[java.lang.String] = js.native
  def filter(collection: scala.Null, predicate: StringIterator[scala.Boolean]): js.Array[java.lang.String] = js.native
  /**
    * @see _.filter
    */
  def filter[T /* <: js.Object */](collection: T): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def filter[T /* <: js.Object */](collection: T, predicate: ObjectIterateeCustom[T, scala.Boolean]): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def filter[T](collection: js.UndefOr[scala.Nothing], predicate: ListIterateeCustom[T, scala.Boolean]): js.Array[T] = js.native
  /**
    * @see _.filter
    */
  def filter[T](collection: List[T]): js.Array[T] = js.native
  def filter[T](collection: List[T], predicate: ListIterateeCustom[T, scala.Boolean]): js.Array[T] = js.native
  def filter[T](collection: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean]): js.Array[T] = js.native
  /**
    * @see _.filter
    */
  def filter[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: T, predicate: ObjectIteratorTypeGuard[T, S]): js.Array[S] = js.native
  /**
    * @see _.filter
    */
  ...
  @JSName("filter")
  def filter_TObject[T /* <: js.Object */](): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("filter")
  def filter_TObject[T /* <: js.Object */](collection: js.UndefOr[scala.Nothing], predicate: ObjectIterateeCustom[T, scala.Boolean]): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("filter")
  def filter_TObject[T /* <: js.Object */](collection: scala.Null, predicate: ObjectIterateeCustom[T, scala.Boolean]): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("filter")
  def filter_TObjectSAny[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: js.UndefOr[scala.Nothing], predicate: ObjectIteratorTypeGuard[T, S]): js.Array[S] = js.native
  @JSName("filter")
  def filter_TObjectSAny[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: scala.Null, predicate: ObjectIteratorTypeGuard[T, S]): js.Array[S] = js.native
  @JSName("filter")
  def filter_TST[T, S /* <: T */](collection: js.UndefOr[scala.Nothing], predicate: ListIteratorTypeGuard[T, S]): js.Array[S] = js.native
  @JSName("filter")
  def filter_TST[T, S /* <: T */](collection: scala.Null, predicate: ListIteratorTypeGuard[T, S]): js.Array[S] = js.native
  def find[T](): js.UndefOr[T] = js.native
  /**
    * @see _.find
    */
  def find[T /* <: js.Object */](collection: T): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def find[T /* <: js.Object */](collection: T, predicate: ObjectIterateeCustom[T, scala.Boolean]): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def find[T /* <: js.Object */](collection: T, predicate: ObjectIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def find[T](collection: js.UndefOr[scala.Nothing], predicate: ListIterateeCustom[T, scala.Boolean]): js.UndefOr[T] = js.native
  def find[T](
    collection: js.UndefOr[scala.Nothing],
  ...
  def find[T](collection: List[T], predicate: ListIterateeCustom[T, scala.Boolean]): js.UndefOr[T] = js.native
  def find[T](collection: List[T], predicate: ListIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): js.UndefOr[T] = js.native
  def find[T](collection: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean]): js.UndefOr[T] = js.native
  def find[T](collection: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): js.UndefOr[T] = js.native
  /**
    * @see _.find
    */
  def find[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: T, predicate: ObjectIteratorTypeGuard[T, S]): js.UndefOr[S] = js.native
  def find[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: T, predicate: ObjectIteratorTypeGuard[T, S], fromIndex: scala.Double): js.UndefOr[S] = js.native
  ...
  def find[T, S /* <: T */](collection: List[T], predicate: ListIteratorTypeGuard[T, S], fromIndex: scala.Double): js.UndefOr[S] = js.native
  def find[T, S /* <: T */](collection: scala.Null, predicate: ListIteratorTypeGuard[T, S]): js.UndefOr[S] = js.native
  def find[T, S /* <: T */](collection: scala.Null, predicate: ListIteratorTypeGuard[T, S], fromIndex: scala.Double): js.UndefOr[S] = js.native
  def findIndex[T](): scala.Double = js.native
  def findIndex[T](array: js.UndefOr[scala.Nothing], predicate: ListIterateeCustom[T, scala.Boolean]): scala.Double = js.native
  def findIndex[T](
    array: js.UndefOr[scala.Nothing],
    predicate: ListIterateeCustom[T, scala.Boolean],
    fromIndex: scala.Double
  ...
  /**
    ...
    */
  def findIndex[T](array: List[T]): scala.Double = js.native
  def findIndex[T](array: List[T], predicate: ListIterateeCustom[T, scala.Boolean]): scala.Double = js.native
  def findIndex[T](array: List[T], predicate: ListIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): scala.Double = js.native
  def findIndex[T](array: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean]): scala.Double = js.native
  def findIndex[T](array: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): scala.Double = js.native
  ...
  def findKey[T](`object`: scala.Null, predicate: ObjectIteratee[T]): js.UndefOr[java.lang.String] = js.native
  def findLast[T](): js.UndefOr[T] = js.native
  /**
    * @see _.findLast
    */
  def findLast[T /* <: js.Object */](collection: T): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def findLast[T /* <: js.Object */](collection: T, predicate: ObjectIterateeCustom[T, scala.Boolean]): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def findLast[T /* <: js.Object */](collection: T, predicate: ObjectIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def findLast[T](collection: js.UndefOr[scala.Nothing], predicate: ListIterateeCustom[T, scala.Boolean]): js.UndefOr[T] = js.native
  def findLast[T](
    collection: js.UndefOr[scala.Nothing],
    predicate: ListIterateeCustom[T, scala.Boolean],
    fromIndex: scala.Double
  ...
  def findLast[T](collection: List[T], predicate: ListIterateeCustom[T, scala.Boolean]): js.UndefOr[T] = js.native
  def findLast[T](collection: List[T], predicate: ListIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): js.UndefOr[T] = js.native
  def findLast[T](collection: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean]): js.UndefOr[T] = js.native
  def findLast[T](collection: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): js.UndefOr[T] = js.native
  /**
    * @see _.findLast
    */
  def findLast[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: T, predicate: ObjectIteratorTypeGuard[T, S]): js.UndefOr[S] = js.native
  def findLast[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: T, predicate: ObjectIteratorTypeGuard[T, S], fromIndex: scala.Double): js.UndefOr[S] = js.native
  ...
  def findLast[T, S /* <: T */](collection: List[T], predicate: ListIteratorTypeGuard[T, S], fromIndex: scala.Double): js.UndefOr[S] = js.native
  def findLast[T, S /* <: T */](collection: scala.Null, predicate: ListIteratorTypeGuard[T, S]): js.UndefOr[S] = js.native
  def findLast[T, S /* <: T */](collection: scala.Null, predicate: ListIteratorTypeGuard[T, S], fromIndex: scala.Double): js.UndefOr[S] = js.native
  def findLastIndex[T](): scala.Double = js.native
  def findLastIndex[T](array: js.UndefOr[scala.Nothing], predicate: ListIterateeCustom[T, scala.Boolean]): scala.Double = js.native
  def findLastIndex[T](
    array: js.UndefOr[scala.Nothing],
    predicate: ListIterateeCustom[T, scala.Boolean],
    fromIndex: scala.Double
  ...
  /**
    ...
    * @return Returns the index of the found element, else -1.
    */
  def findLastIndex[T](array: List[T]): scala.Double = js.native
  def findLastIndex[T](array: List[T], predicate: ListIterateeCustom[T, scala.Boolean]): scala.Double = js.native
  def findLastIndex[T](array: List[T], predicate: ListIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): scala.Double = js.native
  def findLastIndex[T](array: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean]): scala.Double = js.native
  def findLastIndex[T](array: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): scala.Double = js.native
  ...
  def findLastKey[T](`object`: scala.Null, predicate: ObjectIteratee[T]): js.UndefOr[java.lang.String] = js.native
  @JSName("findLast")
  def findLast_TObject[T /* <: js.Object */](): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("findLast")
  def findLast_TObject[T /* <: js.Object */](collection: js.UndefOr[scala.Nothing], predicate: ObjectIterateeCustom[T, scala.Boolean]): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("findLast")
  ...
  @JSName("findLast")
  def findLast_TObject[T /* <: js.Object */](collection: scala.Null, predicate: ObjectIterateeCustom[T, scala.Boolean]): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("findLast")
  def findLast_TObject[T /* <: js.Object */](collection: scala.Null, predicate: ObjectIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("findLast")
  def findLast_TObjectSAny[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: js.UndefOr[scala.Nothing], predicate: ObjectIteratorTypeGuard[T, S]): js.UndefOr[S] = js.native
  @JSName("findLast")
  ...
  @JSName("findLast")
  def findLast_TObjectSAny[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: scala.Null, predicate: ObjectIteratorTypeGuard[T, S]): js.UndefOr[S] = js.native
  @JSName("findLast")
  def findLast_TObjectSAny[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: scala.Null, predicate: ObjectIteratorTypeGuard[T, S], fromIndex: scala.Double): js.UndefOr[S] = js.native
  @JSName("find")
  def find_TObject[T /* <: js.Object */](): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("find")
  def find_TObject[T /* <: js.Object */](collection: js.UndefOr[scala.Nothing], predicate: ObjectIterateeCustom[T, scala.Boolean]): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("find")
  ...
  @JSName("find")
  def find_TObject[T /* <: js.Object */](collection: scala.Null, predicate: ObjectIterateeCustom[T, scala.Boolean]): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("find")
  def find_TObject[T /* <: js.Object */](collection: scala.Null, predicate: ObjectIterateeCustom[T, scala.Boolean], fromIndex: scala.Double): js.UndefOr[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("find")
  def find_TObjectSAny[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: js.UndefOr[scala.Nothing], predicate: ObjectIteratorTypeGuard[T, S]): js.UndefOr[S] = js.native
  @JSName("find")
  ...
  @JSName("find")
  def find_TObjectSAny[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: scala.Null, predicate: ObjectIteratorTypeGuard[T, S]): js.UndefOr[S] = js.native
  @JSName("find")
  def find_TObjectSAny[T /* <: js.Object */, S /* <: /* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any */](collection: scala.Null, predicate: ObjectIteratorTypeGuard[T, S], fromIndex: scala.Double): js.UndefOr[S] = js.native
  ...
  /**
    * @see _.flatMap
    */
  def flatMap(collection: js.Object, iteratee: js.Object): js.Array[scala.Boolean] = js.native
  def flatMap(collection: js.UndefOr[scala.Nothing], iteratee: java.lang.String): js.Array[_] = js.native
  def flatMap(collection: js.UndefOr[scala.Nothing], iteratee: js.Object): js.Array[scala.Boolean] = js.native
  def flatMap(collection: scala.Null, iteratee: java.lang.String): js.Array[_] = js.native
  def flatMap(collection: scala.Null, iteratee: js.Object): js.Array[scala.Boolean] = js.native
  ...
  def flatMap[T, TResult](collection: scala.Null, iteratee: ListIterator[T, Many[TResult]]): js.Array[TResult] = js.native
  /**
    * @see _.flatMapDeep
    */
  ...
  /**
    * @see _.flatMapDeep
    */
  def flatMapDeep(collection: js.Object, iteratee: js.Object): js.Array[scala.Boolean] = js.native
  def flatMapDeep(collection: js.UndefOr[scala.Nothing], iteratee: java.lang.String): js.Array[_] = js.native
  def flatMapDeep(collection: js.UndefOr[scala.Nothing], iteratee: js.Object): js.Array[scala.Boolean] = js.native
  def flatMapDeep(collection: scala.Null, iteratee: java.lang.String): js.Array[_] = js.native
  def flatMapDeep(collection: scala.Null, iteratee: js.Object): js.Array[scala.Boolean] = js.native
  ...
  def flatMapDepth(collection: js.Object, iteratee: java.lang.String, depth: scala.Double): js.Array[_] = js.native
  /**
    * @see _.flatMapDepth
    */
  def flatMapDepth(collection: js.Object, iteratee: js.Object): js.Array[scala.Boolean] = js.native
  def flatMapDepth(collection: js.Object, iteratee: js.Object, depth: scala.Double): js.Array[scala.Boolean] = js.native
  def flatMapDepth(collection: js.UndefOr[scala.Nothing], iteratee: java.lang.String): js.Array[_] = js.native
  def flatMapDepth(collection: js.UndefOr[scala.Nothing], iteratee: java.lang.String, depth: scala.Double): js.Array[_] = js.native
  def flatMapDepth(collection: js.UndefOr[scala.Nothing], iteratee: js.Object): js.Array[scala.Boolean] = js.native
  def flatMapDepth(collection: js.UndefOr[scala.Nothing], iteratee: js.Object, depth: scala.Double): js.Array[scala.Boolean] = js.native
  def flatMapDepth(collection: scala.Null, iteratee: java.lang.String): js.Array[_] = js.native
  def flatMapDepth(collection: scala.Null, iteratee: java.lang.String, depth: scala.Double): js.Array[_] = js.native
  def flatMapDepth(collection: scala.Null, iteratee: js.Object): js.Array[scala.Boolean] = js.native
  def flatMapDepth(collection: scala.Null, iteratee: js.Object, depth: scala.Double): js.Array[scala.Boolean] = js.native
  ...
  @JSName("flatMap")
  def flatMap_TObjectTResult[T /* <: js.Object */, TResult](collection: js.UndefOr[scala.Nothing], iteratee: ObjectIterator[T, Many[TResult]]): js.Array[TResult] = js.native
  @JSName("flatMap")
  def flatMap_TObjectTResult[T /* <: js.Object */, TResult](collection: scala.Null, iteratee: ObjectIterator[T, Many[TResult]]): js.Array[TResult] = js.native
  ...
  def flattenDepth[T](array: js.UndefOr[scala.Nothing], depth: scala.Double): js.Array[T] = js.native
  /**
  ...
  def flattenDepth[T](array: ListOfRecursiveArraysOrValues[T], depth: scala.Double): js.Array[T] = js.native
  def flattenDepth[T](array: scala.Null, depth: scala.Double): js.Array[T] = js.native
  /**
  ...
  def floor(n: scala.Double, precision: scala.Double): scala.Double = js.native
  ...
  /**
    * @see _.forEach
    */
  def forEach[T /* <: js.Object */](collection: T): js.UndefOr[T | scala.Null] = js.native
  def forEach[T /* <: js.Object */](collection: T, iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  /**
  ...
  /**
    * @see _.forEachRight
    */
  def forEachRight[T /* <: js.Object */](collection: T): js.UndefOr[T | scala.Null] = js.native
  def forEachRight[T /* <: js.Object */](collection: T, iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("forEachRight")
  def forEachRight_TTArrayUndefOrTArray[T, TArray /* <: js.UndefOr[js.Array[T] | scala.Null] */](collection: TArray with (js.UndefOr[js.Array[T] | scala.Null])): TArray = js.native
  @JSName("forEachRight")
  def forEachRight_TTArrayUndefOrTArray[T, TArray /* <: js.UndefOr[js.Array[T] | scala.Null] */](collection: TArray with (js.UndefOr[js.Array[T] | scala.Null]), iteratee: ArrayIterator[T, _]): TArray = js.native
  /**
    * @see _.forEachRight
    */
  @JSName("forEachRight")
  ...
  /**
    ...
    */
  @JSName("forEach")
  def forEach_TTArrayUndefOrTArray[T, TArray /* <: js.UndefOr[js.Array[T] | scala.Null] */](collection: TArray with (js.UndefOr[js.Array[T] | scala.Null])): TArray = js.native
  @JSName("forEach")
  def forEach_TTArrayUndefOrTArray[T, TArray /* <: js.UndefOr[js.Array[T] | scala.Null] */](collection: TArray with (js.UndefOr[js.Array[T] | scala.Null]), iteratee: ArrayIterator[T, _]): TArray = js.native
  /**
    * @see _.forEach
    */
  @JSName("forEach")
  def forEach_TTListUndefOrTList[T, TList /* <: js.UndefOr[List[T] | scala.Null] */](collection: TList with (js.UndefOr[List[T] | scala.Null])): TList = js.native
  @JSName("forEach")
  def forEach_TTListUndefOrTList[T, TList /* <: js.UndefOr[List[T] | scala.Null] */](collection: TList with (js.UndefOr[List[T] | scala.Null]), iteratee: ListIterator[T, _]): TList = js.native
  def forIn[T](): js.UndefOr[T | scala.Null] = js.native
  /**
    * @see _.forIn
    */
  def forIn[T](`object`: T): js.UndefOr[T | scala.Null] = js.native
  def forIn[T](`object`: T, iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  def forIn[T](`object`: js.UndefOr[scala.Nothing], iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  def forIn[T](`object`: scala.Null, iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  def forInRight[T](): js.UndefOr[T | scala.Null] = js.native
  /**
    * @see _.forInRight
    */
  def forInRight[T](`object`: T): js.UndefOr[T | scala.Null] = js.native
  def forInRight[T](`object`: T, iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  def forInRight[T](`object`: js.UndefOr[scala.Nothing], iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  def forInRight[T](`object`: scala.Null, iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  /**
    ...
    */
  @JSName("forInRight")
  def forInRight_TT[T](`object`: T): T = js.native
  @JSName("forInRight")
  def forInRight_TT[T](`object`: T, iteratee: ObjectIterator[T, _]): T = js.native
  /**
    ...
    */
  @JSName("forIn")
  def forIn_TT[T](`object`: T): T = js.native
  @JSName("forIn")
  def forIn_TT[T](`object`: T, iteratee: ObjectIterator[T, _]): T = js.native
  def forOwn[T](): js.UndefOr[T | scala.Null] = js.native
  /**
    * @see _.forOwn
    */
  def forOwn[T](`object`: T): js.UndefOr[T | scala.Null] = js.native
  def forOwn[T](`object`: T, iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  def forOwn[T](`object`: js.UndefOr[scala.Nothing], iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  def forOwn[T](`object`: scala.Null, iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  def forOwnRight[T](): js.UndefOr[T | scala.Null] = js.native
  /**
    * @see _.forOwnRight
    */
  def forOwnRight[T](`object`: T): js.UndefOr[T | scala.Null] = js.native
  def forOwnRight[T](`object`: T, iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  def forOwnRight[T](`object`: js.UndefOr[scala.Nothing], iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  def forOwnRight[T](`object`: scala.Null, iteratee: ObjectIterator[T, _]): js.UndefOr[T | scala.Null] = js.native
  /**
    ...
    */
  @JSName("forOwnRight")
  def forOwnRight_TT[T](`object`: T): T = js.native
  @JSName("forOwnRight")
  def forOwnRight_TT[T](`object`: T, iteratee: ObjectIterator[T, _]): T = js.native
  /**
    ...
    */
  @JSName("forOwn")
  def forOwn_TT[T](`object`: T): T = js.native
  @JSName("forOwn")
  def forOwn_TT[T](`object`: T, iteratee: ObjectIterator[T, _]): T = js.native
  ...
  /**
    * @see _.get
    */
  def get(`object`: scala.Null, path: PropertyPath): js.UndefOr[scala.Nothing] = js.native
  def get[TDefault](`object`: js.UndefOr[scala.Nothing], path: PropertyPath, defaultValue: TDefault): TDefault = js.native
  def get[T](`object`: js.UndefOr[scala.Nothing], path: scala.Double): js.UndefOr[T] = js.native
  /**
    * @see _.get
    */
  def get[T](`object`: NumericDictionary[T], path: scala.Double): js.UndefOr[T] = js.native
  /**
    * @see _.get
    */
  def get[TDefault](`object`: scala.Null, path: PropertyPath, defaultValue: TDefault): TDefault = js.native
  def get[T](`object`: scala.Null, path: scala.Double): js.UndefOr[T] = js.native
  /**
    * @see _.get
    */
  def get[TObject /* <: js.Object */, TKey /* <: java.lang.String */](`object`: TObject, path: TKey): js.UndefOr[
    /* import warning: ImportType.apply Failed type conversion: TObject[TKey] */ js.Any
  ] = js.native
  def get[TObject /* <: js.Object */, TKey /* <: java.lang.String */](`object`: TObject, path: js.Array[TKey]): js.UndefOr[
    /* import warning: ImportType.apply Failed type conversion: TObject[TKey] */ js.Any
  ] = js.native
  def get[TObject /* <: js.Object */, TKey /* <: java.lang.String */](`object`: js.UndefOr[scala.Nothing], path: TKey): js.UndefOr[
    /* import warning: ImportType.apply Failed type conversion: TObject[TKey] */ js.Any
  ] = js.native
  def get[TObject /* <: js.Object */, TKey /* <: java.lang.String */](`object`: js.UndefOr[scala.Nothing], path: js.Array[TKey]): js.UndefOr[
    /* import warning: ImportType.apply Failed type conversion: TObject[TKey] */ js.Any
  ] = js.native
  def get[T, TDefault](`object`: js.UndefOr[scala.Nothing], path: scala.Double, defaultValue: TDefault): T | TDefault = js.native
  /**
    * @see _.get
    */
  def get[T, TDefault](`object`: NumericDictionary[T], path: scala.Double, defaultValue: TDefault): T | TDefault = js.native
  def get[TObject /* <: js.Object */, TKey /* <: java.lang.String */](`object`: scala.Null, path: TKey): js.UndefOr[
    /* import warning: ImportType.apply Failed type conversion: TObject[TKey] */ js.Any
  ] = js.native
  def get[TObject /* <: js.Object */, TKey /* <: java.lang.String */](`object`: scala.Null, path: js.Array[TKey]): js.UndefOr[
    /* import warning: ImportType.apply Failed type conversion: TObject[TKey] */ js.Any
  ] = js.native
  def get[T, TDefault](`object`: scala.Null, path: scala.Double, defaultValue: TDefault): T | TDefault = js.native
  /**
    * @see _.get
    */
  ...
  /**
    ...
    */
  @JSName("get")
  def get_TObjectObjectTKeyStringAny[TObject /* <: js.Object */, TKey /* <: java.lang.String */](`object`: TObject, path: TKey): /* import warning: ImportType.apply Failed type conversion: TObject[TKey] */ js.Any = js.native
  @JSName("get")
  def get_TObjectObjectTKeyStringAny[TObject /* <: js.Object */, TKey /* <: java.lang.String */](`object`: TObject, path: js.Array[TKey]): /* import warning: ImportType.apply Failed type conversion: TObject[TKey] */ js.Any = js.native
  /**
    * @see _.get
    */
  @JSName("get")
  def get_TT[T](`object`: NumericDictionary[T], path: scala.Double): T = js.native
  ...
  def groupBy[T](collection: scala.Null, iteratee: ValueIteratee[T]): Dictionary[js.Array[T]] = js.native
  @JSName("groupBy")
  def groupBy_TObject[T /* <: js.Object */](): Dictionary[
    js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any]
  ] = js.native
  @JSName("groupBy")
  ...
  /**
    ...
    * // => false
    */
  def has[T](`object`: T, path: PropertyPath): scala.Boolean = js.native
  /**
    ...
    * // => false
    */
  def hasIn[T](`object`: T, path: PropertyPath): scala.Boolean = js.native
  ...
  /**
    ...
    */
  def inRange(n: scala.Double, start: scala.Double): scala.Boolean = js.native
  def inRange(n: scala.Double, start: scala.Double, end: scala.Double): scala.Boolean = js.native
  def includes[T](collection: js.UndefOr[scala.Nothing], target: T): scala.Boolean = js.native
  def includes[T](collection: js.UndefOr[scala.Nothing], target: T, fromIndex: scala.Double): scala.Boolean = js.native
  def includes[T](collection: Dictionary[T], target: T): scala.Boolean = js.native
  def includes[T](collection: Dictionary[T], target: T, fromIndex: scala.Double): scala.Boolean = js.native
  /**
    ...
    */
  def includes[T](collection: List[T], target: T): scala.Boolean = js.native
  def includes[T](collection: List[T], target: T, fromIndex: scala.Double): scala.Boolean = js.native
  def includes[T](collection: NumericDictionary[T], target: T): scala.Boolean = js.native
  def includes[T](collection: NumericDictionary[T], target: T, fromIndex: scala.Double): scala.Boolean = js.native
  def includes[T](collection: scala.Null, target: T): scala.Boolean = js.native
  def includes[T](collection: scala.Null, target: T, fromIndex: scala.Double): scala.Boolean = js.native
  def indexOf[T](array: js.UndefOr[scala.Nothing], value: T): scala.Double = js.native
  def indexOf[T](array: js.UndefOr[scala.Nothing], value: T, fromIndex: scala.Double): scala.Double = js.native
  /**
  ...
  def indexOf[T](array: List[T], value: T, fromIndex: scala.Double): scala.Double = js.native
  def indexOf[T](array: scala.Null, value: T): scala.Double = js.native
  def indexOf[T](array: scala.Null, value: T, fromIndex: scala.Double): scala.Double = js.native
  ...
  def intersectionBy[T1, T2](array: scala.Null, values: List[T2], iteratee: ValueIteratee[T1 | T2]): js.Array[T1] = js.native
  /**
    * @see _.intersectionBy
    */
  ...
  def intersectionBy[T1, T2, T3](array: scala.Null, values1: List[T2], values2: List[T3], iteratee: ValueIteratee[T1 | T2 | T3]): js.Array[T1] = js.native
  ...
  def intersectionWith[T1, T2](array: scala.Null, values: List[T2], comparator: Comparator2[T1, T2]): js.Array[T1] = js.native
  ...
  def intersectionWith[T1, T2, T3](array: scala.Null, values1: List[T2], values2: List[T3], comparator: Comparator2[T1, T2 | T3]): js.Array[T1] = js.native
  ...
  def invertBy[T](`object`: js.UndefOr[scala.Nothing], interatee: ValueIteratee[T]): Dictionary[js.Array[java.lang.String]] = js.native
  ...
  /**
    ...
    * @return Returns the new inverted object.
    */
  def invertBy[T](`object`: List[T]): Dictionary[js.Array[java.lang.String]] = js.native
  def invertBy[T](`object`: List[T], interatee: ValueIteratee[T]): Dictionary[js.Array[java.lang.String]] = js.native
  ...
  def invertBy[T](`object`: scala.Null, interatee: ValueIteratee[T]): Dictionary[js.Array[java.lang.String]] = js.native
  @JSName("invertBy")
  def invertBy_TObject[T /* <: js.Object */](): Dictionary[js.Array[java.lang.String]] = js.native
  @JSName("invertBy")
  ...
  def invokeMap(collection: scala.Null, methodName: java.lang.String, args: js.Any*): js.Array[_] = js.native
  /**
    * @see _.invokeMap
    **/
  ...
  def invokeMap[TResult](collection: scala.Null, method: js.Function1[/* repeated */ js.Any, TResult], args: js.Any*): js.Array[TResult] = js.native
  /**
    ...
    */
  def isArguments(): /* is std.IArguments */ scala.Boolean = js.native
  ...
  /**
    ...
    * @return Returns true if value is correctly classified, else false.
    */
  def isArray(): /* is std.Array<any> */ scala.Boolean = js.native
  ...
  /**
    ...
    * @return Returns true if value is correctly classified, else false.
    */
  def isArrayBuffer(): /* is std.ArrayBuffer */ scala.Boolean = js.native
  ...
  /**
    ...
    */
  @JSName("isArray")
  def isArray_T[T](): /* is std.Array<any> */ scala.Boolean = js.native
  @JSName("isArray")
  def isArray_T[T](value: js.Any): /* is std.Array<any> */ scala.Boolean = js.native
  /**
    ...
    * @return Returns true if value is correctly classified, else false.
    */
  def isBoolean(): /* is boolean */ scala.Boolean = js.native
  ...
  /**
    ...
    * @return Returns true if value is correctly classified, else false.
    */
  def isDate(): /* is std.Date */ scala.Boolean = js.native
  ...
  /**
    ...
    * // => true
    */
  def isEqualWith(value: js.Any, other: js.Any): scala.Boolean = js.native
  def isEqualWith(value: js.Any, other: js.Any, customizer: IsEqualCustomizer): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def isMap(): /* is lodash.lodash.Global.Map<any, any> */ scala.Boolean = js.native
  ...
  /**
    ...
    * // => false
    */
  def isMatch(`object`: js.Object, source: js.Object): scala.Boolean = js.native
  /**
    ...
    * // => true
    */
  def isMatchWith(`object`: js.Object, source: js.Object, customizer: isMatchWithCustomizer): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @return Returns true if value is correctly classified, else false.
    */
  def isNumber(): /* is number */ scala.Boolean = js.native
  ...
  /**
    ...
    * @return Returns true if value is correctly classified, else false.
    */
  def isRegExp(): /* is std.RegExp */ scala.Boolean = js.native
  ...
  /**
    ...
    * @returns Returns true if value is correctly classified, else false.
    */
  def isSet(): /* is lodash.lodash.Global.Set<any> */ scala.Boolean = js.native
  ...
  /**
    ...
    * @returns Returns true if value is correctly classified, else false.
    */
  def isWeakMap(): /* is lodash.lodash.Global.WeakMap<object, any> */ scala.Boolean = js.native
  ...
  /**
    ...
    * @returns Returns true if value is correctly classified, else false.
    */
  def isWeakSet(): /* is lodash.lodash.Global.WeakSet<object> */ scala.Boolean = js.native
  ...
  def join(array: scala.Null, separator: java.lang.String): java.lang.String = js.native
  /**
  ...
  /**
    * @see _.keyBy
    */
  def keyBy[T /* <: js.Object */](collection: T): Dictionary[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  ...
  def keyBy[T](collection: scala.Null, iteratee: ValueIterateeCustom[T, PropertyName]): Dictionary[T] = js.native
  @JSName("keyBy")
  def keyBy_TObject[T /* <: js.Object */](): Dictionary[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("keyBy")
  ...
  def map[T](collection: js.UndefOr[scala.Nothing], iteratee: js.Object): js.Array[scala.Boolean] = js.native
  ...
  def map[T](collection: Dictionary[T], iteratee: js.Object): js.Array[scala.Boolean] = js.native
  /**
    * @see _.map
    */
  def map[T](collection: List[T]): js.Array[T] = js.native
  def map[T](collection: List[T], iteratee: java.lang.String): js.Array[_] = js.native
  def map[T](collection: List[T], iteratee: js.Object): js.Array[scala.Boolean] = js.native
  ...
  def map[T](collection: NumericDictionary[T], iteratee: js.Object): js.Array[scala.Boolean] = js.native
  def map[T](collection: scala.Null, iteratee: java.lang.String): js.Array[_] = js.native
  def map[T](collection: scala.Null, iteratee: js.Object): js.Array[scala.Boolean] = js.native
  /**
    * @see _.map
    */
  ...
  def map[T, K /* <: java.lang.String */](collection: js.UndefOr[scala.Nothing], iteratee: K): js.Array[/* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any] = js.native
  def map[T, TResult](
    collection: js.UndefOr[scala.Nothing],
    iteratee: (ArrayIterator[T, TResult]) | (ListIterator[T, TResult])
  ): js.Array[TResult] = js.native
  def map[T, K /* <: java.lang.String */](collection: Dictionary[T], iteratee: K): js.Array[/* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any] = js.native
  /** @see _.map */
  def map[T, K /* <: java.lang.String */](collection: List[T], iteratee: K): js.Array[/* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any] = js.native
  /**
    * @see _.map
    */
  def map[T, TResult](collection: List[T], iteratee: ListIterator[T, TResult]): js.Array[TResult] = js.native
  def map[T, K /* <: java.lang.String */](collection: NumericDictionary[T], iteratee: K): js.Array[/* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any] = js.native
  def map[T, K /* <: java.lang.String */](collection: scala.Null, iteratee: K): js.Array[/* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any] = js.native
  def map[T, TResult](collection: scala.Null, iteratee: (ArrayIterator[T, TResult]) | (ListIterator[T, TResult])): js.Array[TResult] = js.native
  def mapKeys[T](): Dictionary[T] = js.native
  /**
    * @see _.mapKeys
    */
  def mapKeys[T /* <: js.Object */](`object`: T): Dictionary[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def mapKeys[T /* <: js.Object */](`object`: T, iteratee: ObjectIteratee[T]): Dictionary[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  ...
  def mapKeys[T](`object`: scala.Null, iteratee: ListIteratee[T]): Dictionary[T] = js.native
  @JSName("mapKeys")
  def mapKeys_TObject[T /* <: js.Object */](): Dictionary[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("mapKeys")
  def mapKeys_TObject[T /* <: js.Object */](`object`: js.UndefOr[scala.Nothing], iteratee: ObjectIteratee[T]): Dictionary[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("mapKeys")
  def mapKeys_TObject[T /* <: js.Object */](`object`: scala.Null, iteratee: ObjectIteratee[T]): Dictionary[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  ...
  /**
    * @see _.mapValues
    */
  def mapValues[T /* <: js.Object */](obj: T, iteratee: java.lang.String): /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ P in keyof T ]: any}
    */ lodashLib.lodashLibStrings.LoDashStatic with js.Any = js.native
  /**
    * @see _.mapValues
    */
  def mapValues[T /* <: js.Object */](obj: T, iteratee: js.Object): /* import warning: ImportType.apply c Unsupported type mapping: 
  ...
  def mapValues[T](obj: js.UndefOr[scala.Nothing], iteratee: java.lang.String): Dictionary[_] = js.native
  def mapValues[T](obj: js.UndefOr[scala.Nothing], iteratee: js.Object): Dictionary[scala.Boolean] = js.native
  /**
    * @see _.mapValues
  ...
  /**
    ...
    *       but TypeScript cannot select overload signatures based on number vs string index key type.
    */
  def mapValues[T](obj: Dictionary[T], iteratee: js.Object): Dictionary[scala.Boolean] = js.native
  ...
  def mapValues[T](obj: NumericDictionary[T], iteratee: js.Object): Dictionary[scala.Boolean] = js.native
  def mapValues[TResult](obj: scala.Null, callback: StringIterator[TResult]): NumericDictionary[TResult] = js.native
  def mapValues[T](obj: scala.Null, iteratee: java.lang.String): Dictionary[_] = js.native
  def mapValues[T](obj: scala.Null, iteratee: js.Object): Dictionary[scala.Boolean] = js.native
  /**
    * @see _.mapValues
    */
  def mapValues[T /* <: js.Object */, TResult](obj: T, callback: ObjectIterator[T, TResult]): /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ P in keyof T ]: TResult}
    */ lodashLib.lodashLibStrings.LoDashStatic with js.Any = js.native
  def mapValues[T, TKey /* <: java.lang.String */](obj: js.UndefOr[scala.Nothing], iteratee: TKey): Dictionary[/* import warning: ImportType.apply Failed type conversion: T[TKey] */ js.Any] = js.native
  /**
    * @see _.mapValues
    * TODO: This would be better if we had a separate overload for obj: NumericDictionary that returned a NumericDictionary,
    *       but TypeScript cannot select overload signatures based on number vs string index key type.
  ...
  /**
    ...
    *       but TypeScript cannot select overload signatures based on number vs string index key type.
    */
  def mapValues[T, TKey /* <: java.lang.String */](obj: Dictionary[T], iteratee: TKey): Dictionary[/* import warning: ImportType.apply Failed type conversion: T[TKey] */ js.Any] = js.native
  def mapValues[T, TResult](obj: NumericDictionary[T], callback: DictionaryIterator[T, TResult]): Dictionary[TResult] = js.native
  def mapValues[T, TKey /* <: java.lang.String */](obj: NumericDictionary[T], iteratee: TKey): Dictionary[/* import warning: ImportType.apply Failed type conversion: T[TKey] */ js.Any] = js.native
  def mapValues[T, TKey /* <: java.lang.String */](obj: scala.Null, iteratee: TKey): Dictionary[/* import warning: ImportType.apply Failed type conversion: T[TKey] */ js.Any] = js.native
  @JSName("mapValues")
  def mapValues_TDictionary[T](): Dictionary[T] = js.native
  @JSName("mapValues")
  def `mapValues_TObject<intersection>`[T /* <: js.Object */](obj: js.UndefOr[scala.Nothing], iteratee: java.lang.String): /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ P in keyof T ]: any}
    */ lodashLib.lodashLibStrings.LoDashStatic with js.Any = js.native
  @JSName("mapValues")
  def `mapValues_TObject<intersection>`[T /* <: js.Object */](obj: js.UndefOr[scala.Nothing], iteratee: js.Object): /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ P in keyof T ]: boolean}
    */ lodashLib.lodashLibStrings.LoDashStatic with js.Any = js.native
  @JSName("mapValues")
  def `mapValues_TObject<intersection>`[T /* <: js.Object */](obj: scala.Null, iteratee: java.lang.String): /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ P in keyof T ]: any}
    */ lodashLib.lodashLibStrings.LoDashStatic with js.Any = js.native
  @JSName("mapValues")
  def `mapValues_TObject<intersection>`[T /* <: js.Object */](obj: scala.Null, iteratee: js.Object): /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ P in keyof T ]: boolean}
    */ lodashLib.lodashLibStrings.LoDashStatic with js.Any = js.native
  @JSName("mapValues")
  def mapValues_TObjectPartialObject[T /* <: js.Object */](): PartialObject[T] = js.native
  /**
    * @see _.mapValues
    */
  @JSName("mapValues")
  def mapValues_TObjectT[T /* <: js.Object */](obj: T): T = js.native
  @JSName("mapValues")
  def `mapValues_TObjectTResult<intersection>`[T /* <: js.Object */, TResult](obj: js.UndefOr[scala.Nothing], callback: ObjectIterator[T, TResult]): /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ P in keyof T ]: TResult}
    */ lodashLib.lodashLibStrings.LoDashStatic with js.Any = js.native
  @JSName("mapValues")
  def `mapValues_TObjectTResult<intersection>`[T /* <: js.Object */, TResult](obj: scala.Null, callback: ObjectIterator[T, TResult]): /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ P in keyof T ]: TResult}
    */ lodashLib.lodashLibStrings.LoDashStatic with js.Any = js.native
  @JSName("mapValues")
  def mapValues_TTResultDictionary[T, TResult](obj: js.UndefOr[scala.Nothing], callback: DictionaryIterator[T, TResult]): Dictionary[TResult] = js.native
  @JSName("mapValues")
  def mapValues_TTResultDictionary[T, TResult](obj: scala.Null, callback: DictionaryIterator[T, TResult]): Dictionary[TResult] = js.native
  @JSName("map")
  def map_TObjectTResult[T /* <: js.Object */, TResult](collection: js.UndefOr[scala.Nothing], iteratee: ObjectIterator[T, TResult]): js.Array[TResult] = js.native
  @JSName("map")
  def map_TObjectTResult[T /* <: js.Object */, TResult](collection: scala.Null, iteratee: ObjectIterator[T, TResult]): js.Array[TResult] = js.native
  /**
    ...
    * @return Returns the new function.
    */
  def matches[T](source: T): js.Function1[/* value */ js.Any, scala.Boolean] = js.native
  /**
    ...
    * @return Returns the new function.
    */
  def matchesProperty[T](path: PropertyPath, srcValue: T): js.Function1[/* value */ js.Any, scala.Boolean] = js.native
  /**
    * @see _.matchesProperty
    */
  @JSName("matchesProperty")
  def matchesProperty_TV[T, V](path: PropertyPath, srcValue: T): js.Function1[/* value */ V, scala.Boolean] = js.native
  /**
    * @see _.matches
    */
  @JSName("matches")
  def matches_TV[T, V](source: T): js.Function1[/* value */ V, scala.Boolean] = js.native
  ...
  def maxBy[T](collection: scala.Null, iteratee: ValueIteratee[T]): js.UndefOr[T] = js.native
  ...
  /**
    ...
    * // => 5
    */
  def mean(collection: List[_]): scala.Double = js.native
  def meanBy[T](): scala.Double = js.native
  def meanBy[T](collection: js.UndefOr[scala.Nothing], iteratee: ValueIteratee[T]): scala.Double = js.native
  /**
    ...
    * // => 5
    */
  def meanBy[T](collection: List[T]): scala.Double = js.native
  def meanBy[T](collection: List[T], iteratee: ValueIteratee[T]): scala.Double = js.native
  def meanBy[T](collection: scala.Null, iteratee: ValueIteratee[T]): scala.Double = js.native
  /**
    * Creates a function that memoizes the result of func. If resolver is provided it determines the cache key for
    * storing the result based on the arguments provided to the memoized function. By default, the first argument
    * provided to the memoized function is coerced to a string and used as the cache key. The func is invoked with
  ...
  def minBy[T](collection: scala.Null, iteratee: ValueIteratee[T]): js.UndefOr[T] = js.native
  /**
  ...
  def nth[T](array: js.UndefOr[scala.Nothing], n: scala.Double): js.UndefOr[T] = js.native
  /**
  ...
  def nth[T](array: List[T], n: scala.Double): js.UndefOr[T] = js.native
  def nth[T](array: scala.Null, n: scala.Double): js.UndefOr[T] = js.native
  /**
  ...
  def omitBy[T](`object`: scala.Null, predicate: ValueKeyIteratee[T]): NumericDictionary[T] = js.native
  @JSName("omitBy")
  def omitBy_TDictionary[T](): Dictionary[T] = js.native
  @JSName("omitBy")
  def omitBy_TDictionary[T](`object`: js.UndefOr[scala.Nothing], predicate: ValueKeyIteratee[T]): Dictionary[T] = js.native
  @JSName("omitBy")
  def omitBy_TDictionary[T](`object`: scala.Null, predicate: ValueKeyIteratee[T]): Dictionary[T] = js.native
  @JSName("omitBy")
  ...
  /**
    ...
    */
  @JSName("omit")
  def omit_TObjectKStringOmit[T /* <: js.Object */, K /* <: java.lang.String */](`object`: T, paths: Many[K]*): Omit[T, K] = js.native
  @JSName("omit")
  def omit_TObjectKStringOmit[T /* <: js.Object */, K /* <: java.lang.String */](paths: Many[K]*): Omit[T, K] = js.native
  /**
    * @see _.omit
    */
  @JSName("omit")
  def omit_TObjectPartialObject[T /* <: js.Object */](`object`: T, paths: Many[PropertyName]*): PartialObject[T] = js.native
  @JSName("omit")
  def omit_TObjectPartialObject[T /* <: js.Object */](paths: Many[PropertyName]*): PartialObject[T] = js.native
  /**
  ...
  /**
    * @see _.orderBy
    */
  def orderBy[T /* <: js.Object */](collection: T): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def orderBy[T /* <: js.Object */](collection: T, iteratees: Many[ObjectIteratee[T] | (ObjectIterator[T, NotVoid])]): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  ...
  def orderBy[T](collection: scala.Null, iteratees: Many[ListIteratee[T] | (ListIterator[T, NotVoid])]): js.Array[T] = js.native
  def orderBy[T](
    collection: scala.Null,
    iteratees: Many[ListIteratee[T] | (ListIterator[T, NotVoid])],
    orders: Many[scala.Boolean | lodashLib.lodashLibStrings.asc | lodashLib.lodashLibStrings.desc]
  ...
  @JSName("orderBy")
  def orderBy_TObject[T /* <: js.Object */](): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("orderBy")
  ...
  @JSName("orderBy")
  def orderBy_TObject[T /* <: js.Object */](collection: scala.Null, iteratees: Many[ObjectIteratee[T] | (ObjectIterator[T, NotVoid])]): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("orderBy")
  def orderBy_TObject[T /* <: js.Object */](
    collection: scala.Null,
    iteratees: Many[ObjectIteratee[T] | (ObjectIterator[T, NotVoid])],
  ...
  /**
    ...
    * @return Returns the new function.
    */
  def overEvery[T](predicates: (Many[js.Function1[/* repeated */ T, scala.Boolean]])*): js.Function1[/* repeated */ T, scala.Boolean] = js.native
  /**
    ...
    * @return Returns the new function.
    */
  def overSome[T](predicates: (Many[js.Function1[/* repeated */ T, scala.Boolean]])*): js.Function1[/* repeated */ T, scala.Boolean] = js.native
  /**
  ...
  def pad(string: java.lang.String, length: scala.Double): java.lang.String = js.native
  def pad(string: java.lang.String, length: scala.Double, chars: java.lang.String): java.lang.String = js.native
  /**
  ...
  def padEnd(string: java.lang.String, length: scala.Double): java.lang.String = js.native
  def padEnd(string: java.lang.String, length: scala.Double, chars: java.lang.String): java.lang.String = js.native
  /**
  ...
  def padStart(string: java.lang.String, length: scala.Double): java.lang.String = js.native
  def padStart(string: java.lang.String, length: scala.Double, chars: java.lang.String): java.lang.String = js.native
  /**
  ...
  def pickBy[T](`object`: scala.Null, predicate: ValueKeyIteratee[T]): NumericDictionary[T] = js.native
  ...
  def pickBy[T, S /* <: T */](`object`: scala.Null, predicate: ValueKeyIterateeTypeGuard[T, S]): Dictionary[S] = js.native
  @JSName("pickBy")
  def pickBy_TDictionary[T](): Dictionary[T] = js.native
  @JSName("pickBy")
  def pickBy_TDictionary[T](`object`: js.UndefOr[scala.Nothing], predicate: ValueKeyIteratee[T]): Dictionary[T] = js.native
  @JSName("pickBy")
  def pickBy_TDictionary[T](`object`: scala.Null, predicate: ValueKeyIteratee[T]): Dictionary[T] = js.native
  @JSName("pickBy")
  def pickBy_TObjectPartialObject[T /* <: js.Object */](): PartialObject[T] = js.native
  @JSName("pickBy")
  ...
  @JSName("pickBy")
  def pickBy_TSTNumericDictionary[T, S /* <: T */](`object`: js.UndefOr[scala.Nothing], predicate: ValueKeyIterateeTypeGuard[T, S]): NumericDictionary[S] = js.native
  @JSName("pickBy")
  def pickBy_TSTNumericDictionary[T, S /* <: T */](`object`: scala.Null, predicate: ValueKeyIterateeTypeGuard[T, S]): NumericDictionary[S] = js.native
  /**
    ...
    */
  @JSName("pick")
  def pick_TObjectUStringPick[T /* <: js.Object */, U /* <: java.lang.String */](`object`: T, props: Many[U]*): stdLib.Pick[T, U] = js.native
  /**
  ...
  /**
    ...
    */
  def pullAt[T](array: js.Array[T], indexes: Many[scala.Double]*): js.Array[T] = js.native
  /**
    * @see _.pullAt
    */
  def pullAt[T](array: List[T], indexes: Many[scala.Double]*): List[T] = js.native
  /**
  ...
  /**
    ...
    * @return Returns the random number.
    */
  def random(min: scala.Double, index: java.lang.String, guard: js.Object): scala.Double = js.native
  def random(min: scala.Double, index: scala.Double, guard: js.Object): scala.Double = js.native
  /**
    * @see _.random
    */
  def random(min: scala.Double, max: scala.Double): scala.Double = js.native
  def random(min: scala.Double, max: scala.Double, floating: scala.Boolean): scala.Double = js.native
  /**
    ...
    */
  def range(end: scala.Double, index: java.lang.String, guard: js.Object): js.Array[scala.Double] = js.native
  def range(end: scala.Double, index: scala.Double, guard: js.Object): js.Array[scala.Double] = js.native
  /**
    * Creates an array of numbers (positive and/or negative) progressing from start up to, but not including, end.
    * If end is not specified it’s set to start with start then set to 0. If end is less than start a zero-length
    * range is created unless a negative step is specified.
  ...
  def range(start: scala.Double, end: scala.Double, step: scala.Double): js.Array[scala.Double] = js.native
  /**
    ...
    * @return Returns a new range array.
    */
  def rangeRight(end: scala.Double, index: java.lang.String, guard: js.Object): js.Array[scala.Double] = js.native
  def rangeRight(end: scala.Double, index: scala.Double, guard: js.Object): js.Array[scala.Double] = js.native
  /**
    * This method is like `_.range` except that it populates values in
    * descending order.
    *
    ...
    * // => []
    */
  def rangeRight(start: scala.Double): js.Array[scala.Double] = js.native
  def rangeRight(start: scala.Double, end: scala.Double): js.Array[scala.Double] = js.native
  def rangeRight(start: scala.Double, end: scala.Double, step: scala.Double): js.Array[scala.Double] = js.native
  /**
    ...
    * @return Returns the new function.
    */
  def rearg(func: js.Function1[/* repeated */ js.Any, _], indexes: Many[scala.Double]*): js.Function1[/* repeated */ js.Any, _] = js.native
  /**
    * @see _.reduce
    **/
  ...
  def reject(collection: java.lang.String, predicate: StringIterator[scala.Boolean]): js.Array[java.lang.String] = js.native
  def reject(collection: js.UndefOr[scala.Nothing], predicate: StringIterator[scala.Boolean]): js.Array[java.lang.String] = js.native
  def reject(collection: scala.Null, predicate: StringIterator[scala.Boolean]): js.Array[java.lang.String] = js.native
  /**
    * @see _.reject
    */
  def reject[T /* <: js.Object */](collection: T): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def reject[T /* <: js.Object */](collection: T, predicate: ObjectIterateeCustom[T, scala.Boolean]): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def reject[T](collection: js.UndefOr[scala.Nothing], predicate: ListIterateeCustom[T, scala.Boolean]): js.Array[T] = js.native
  /**
    * @see _.reject
    */
  def reject[T](collection: List[T]): js.Array[T] = js.native
  def reject[T](collection: List[T], predicate: ListIterateeCustom[T, scala.Boolean]): js.Array[T] = js.native
  def reject[T](collection: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean]): js.Array[T] = js.native
  @JSName("reject")
  def reject_T[T](): js.Array[T] = js.native
  @JSName("reject")
  def reject_TObject[T /* <: js.Object */](): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("reject")
  def reject_TObject[T /* <: js.Object */](collection: js.UndefOr[scala.Nothing], predicate: ObjectIterateeCustom[T, scala.Boolean]): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("reject")
  def reject_TObject[T /* <: js.Object */](collection: scala.Null, predicate: ObjectIterateeCustom[T, scala.Boolean]): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  /**
  ...
  def repeat(string: java.lang.String, n: scala.Double): java.lang.String = js.native
  ...
  def replace(string: java.lang.String, pattern: stdLib.RegExp, replacement: java.lang.String): java.lang.String = js.native
  /**
    ...
    */
  def replace(string: java.lang.String, pattern: stdLib.RegExp, replacement: ReplaceFunction): java.lang.String = js.native
  /**
  ...
  def rest(func: js.Function1[/* repeated */ js.Any, _], start: scala.Double): js.Function1[/* repeated */ js.Any, _] = js.native
  /**
  ...
  def round(n: scala.Double, precision: scala.Double): scala.Double = js.native
  /**
  ...
  /**
    * @see _.sampleSize
    */
  def sampleSize[T /* <: js.Object */](collection: T): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def sampleSize[T /* <: js.Object */](collection: T, n: scala.Double): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def sampleSize[T](collection: js.UndefOr[scala.Nothing], n: scala.Double): js.Array[T] = js.native
  def sampleSize[T](collection: Dictionary[T]): js.Array[T] = js.native
  def sampleSize[T](collection: Dictionary[T], n: scala.Double): js.Array[T] = js.native
  /**
  ...
  def sampleSize[T](collection: List[T], n: scala.Double): js.Array[T] = js.native
  def sampleSize[T](collection: NumericDictionary[T]): js.Array[T] = js.native
  def sampleSize[T](collection: NumericDictionary[T], n: scala.Double): js.Array[T] = js.native
  def sampleSize[T](collection: scala.Null, n: scala.Double): js.Array[T] = js.native
  @JSName("sampleSize")
  def sampleSize_TObject[T /* <: js.Object */](): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("sampleSize")
  def sampleSize_TObject[T /* <: js.Object */](collection: js.UndefOr[scala.Nothing], n: scala.Double): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("sampleSize")
  def sampleSize_TObject[T /* <: js.Object */](collection: scala.Null, n: scala.Double): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  @JSName("sample")
  ...
  @JSName("setWith")
  def setWith_TObjectTResultTResult[T /* <: js.Object */, TResult](`object`: T, path: PropertyPath, value: js.Any): TResult = js.native
  @JSName("setWith")
  def setWith_TObjectTResultTResult[T /* <: js.Object */, TResult](`object`: T, path: PropertyPath, value: js.Any, customizer: SetWithCustomizer[T]): TResult = js.native
  ...
  def slice[T](array: js.UndefOr[scala.Nothing], start: scala.Double): js.Array[T] = js.native
  def slice[T](array: js.UndefOr[scala.Nothing], start: scala.Double, end: scala.Double): js.Array[T] = js.native
  /**
  ...
  def slice[T](array: List[T], start: scala.Double): js.Array[T] = js.native
  def slice[T](array: List[T], start: scala.Double, end: scala.Double): js.Array[T] = js.native
  def slice[T](array: scala.Null, start: scala.Double): js.Array[T] = js.native
  def slice[T](array: scala.Null, start: scala.Double, end: scala.Double): js.Array[T] = js.native
  /**
  ...
  def some[T](): scala.Boolean = js.native
  /**
    * @see _.some
    */
  def some[T /* <: js.Object */](collection: T): scala.Boolean = js.native
  def some[T /* <: js.Object */](collection: T, predicate: ObjectIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  def some[T](collection: js.UndefOr[scala.Nothing], predicate: ListIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  /**
    ...
    */
  def some[T](collection: List[T]): scala.Boolean = js.native
  def some[T](collection: List[T], predicate: ListIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  def some[T](collection: scala.Null, predicate: ListIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  @JSName("some")
  def some_TObject[T /* <: js.Object */](): scala.Boolean = js.native
  @JSName("some")
  def some_TObject[T /* <: js.Object */](collection: js.UndefOr[scala.Nothing], predicate: ObjectIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  @JSName("some")
  def some_TObject[T /* <: js.Object */](collection: scala.Null, predicate: ObjectIterateeCustom[T, scala.Boolean]): scala.Boolean = js.native
  /**
    * @see _.sortBy
    */
  def sortBy[T /* <: js.Object */](collection: T, iteratees: Many[ObjectIteratee[T]]*): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  /**
  ...
  @JSName("sortBy")
  def sortBy_TObject[T /* <: js.Object */](iteratees: Many[ObjectIteratee[T]]*): js.Array[/* import warning: ImportType.apply Failed type conversion: T[keyof T] */ js.Any] = js.native
  def sortedIndex[T](array: js.UndefOr[scala.Nothing], value: T): scala.Double = js.native
  /**
    ...
    * // => 0
    */
  def sortedIndex[T](array: List[T], value: T): scala.Double = js.native
  def sortedIndex[T](array: scala.Null, value: T): scala.Double = js.native
  def sortedIndexBy[T](array: js.UndefOr[scala.Nothing], value: T): scala.Double = js.native
  def sortedIndexBy[T](array: js.UndefOr[scala.Nothing], value: T, iteratee: ValueIteratee[T]): scala.Double = js.native
  /**
    ...
    * // => 0
    */
  def sortedIndexBy[T](array: List[T], value: T): scala.Double = js.native
  def sortedIndexBy[T](array: List[T], value: T, iteratee: ValueIteratee[T]): scala.Double = js.native
  def sortedIndexBy[T](array: scala.Null, value: T): scala.Double = js.native
  def sortedIndexBy[T](array: scala.Null, value: T, iteratee: ValueIteratee[T]): scala.Double = js.native
  def sortedIndexOf[T](array: js.UndefOr[scala.Nothing], value: T): scala.Double = js.native
  /**
    ...
    * // => 2
    */
  def sortedIndexOf[T](array: List[T], value: T): scala.Double = js.native
  def sortedIndexOf[T](array: scala.Null, value: T): scala.Double = js.native
  def sortedLastIndex[T](array: js.UndefOr[scala.Nothing], value: T): scala.Double = js.native
  /**
    ...
    * // => 1
    */
  def sortedLastIndex[T](array: List[T], value: T): scala.Double = js.native
  def sortedLastIndex[T](array: scala.Null, value: T): scala.Double = js.native
  def sortedLastIndexBy[T](array: js.UndefOr[scala.Nothing], value: T, iteratee: ValueIteratee[T]): scala.Double = js.native
  /**
    ...
    * // => 1
    */
  def sortedLastIndexBy[T](array: List[T], value: T, iteratee: ValueIteratee[T]): scala.Double = js.native
  def sortedLastIndexBy[T](array: scala.Null, value: T, iteratee: ValueIteratee[T]): scala.Double = js.native
  def sortedLastIndexOf[T](array: js.UndefOr[scala.Nothing], value: T): scala.Double = js.native
  /**
    ...
    * // => 3
    */
  def sortedLastIndexOf[T](array: List[T], value: T): scala.Double = js.native
  def sortedLastIndexOf[T](array: scala.Null, value: T): scala.Double = js.native
  ...
  def sortedUniqBy[T](array: scala.Null, iteratee: ValueIteratee[T]): js.Array[T] = js.native
  /**
  ...
  def split(string: java.lang.String, index: scala.Double, guard: js.Object): js.Array[java.lang.String] = js.native
  def split(string: java.lang.String, separator: java.lang.String): js.Array[java.lang.String] = js.native
  def split(string: java.lang.String, separator: java.lang.String, limit: scala.Double): js.Array[java.lang.String] = js.native
  def split(string: java.lang.String, separator: stdLib.RegExp): js.Array[java.lang.String] = js.native
  def split(string: java.lang.String, separator: stdLib.RegExp, limit: scala.Double): js.Array[java.lang.String] = js.native
  /**
  ...
  /**
    * @see _.spread
    */
  def spread[TResult](func: js.Function1[/* repeated */ js.Any, TResult], start: scala.Double): js.Function1[/* repeated */ js.Any, TResult] = js.native
  /**
  ...
  def startsWith(string: java.lang.String): scala.Boolean = js.native
  def startsWith(string: java.lang.String, target: java.lang.String): scala.Boolean = js.native
  def startsWith(string: java.lang.String, target: java.lang.String, position: scala.Double): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * // => 20
    */
  def sum(collection: List[_]): scala.Double = js.native
  def sumBy[T](): scala.Double = js.native
  def sumBy[T](collection: js.UndefOr[scala.Nothing], iteratee: java.lang.String): scala.Double = js.native
  def sumBy[T](collection: js.UndefOr[scala.Nothing], iteratee: js.Function1[/* value */ T, scala.Double]): scala.Double = js.native
  /**
    ...
    * // => 20
    */
  def sumBy[T](collection: List[T]): scala.Double = js.native
  def sumBy[T](collection: List[T], iteratee: java.lang.String): scala.Double = js.native
  def sumBy[T](collection: List[T], iteratee: js.Function1[/* value */ T, scala.Double]): scala.Double = js.native
  def sumBy[T](collection: scala.Null, iteratee: java.lang.String): scala.Double = js.native
  def sumBy[T](collection: scala.Null, iteratee: js.Function1[/* value */ T, scala.Double]): scala.Double = js.native
  ...
  def take[T](array: js.UndefOr[scala.Nothing], n: scala.Double): js.Array[T] = js.native
  /**
  ...
  def take[T](array: scala.Null, n: scala.Double): js.Array[T] = js.native
  def takeRight[T](): js.Array[T] = js.native
  def takeRight[T](array: js.UndefOr[scala.Nothing], n: scala.Double): js.Array[T] = js.native
  /**
  ...
  def takeRight[T](array: List[T], n: scala.Double): js.Array[T] = js.native
  def takeRight[T](array: scala.Null, n: scala.Double): js.Array[T] = js.native
  ...
  def takeRightWhile[T](array: scala.Null, predicate: ListIteratee[T]): js.Array[T] = js.native
  ...
  def takeWhile[T](array: scala.Null, predicate: ListIteratee[T]): js.Array[T] = js.native
  /**
    ...
    * @return Returns value.
    **/
  def tap[T](value: T, interceptor: js.Function1[/* value */ T, scala.Unit]): T = js.native
  /**
  ...
  def throttle[T /* <: js.Function1[/* repeated */ js.Any, _] */](func: T, wait: scala.Double): T with Cancelable = js.native
  def throttle[T /* <: js.Function1[/* repeated */ js.Any, _] */](func: T, wait: scala.Double, options: ThrottleSettings): T with Cancelable = js.native
  /**
  ...
  /**
    * @see _.times
    */
  def times(n: scala.Double): js.Array[scala.Double] = js.native
  /**
    ...
    */
  def times[TResult](n: scala.Double, iteratee: js.Function1[/* num */ scala.Double, TResult]): js.Array[TResult] = js.native
  /**
    * @see _.toArray
    */
  ...
  def trim(string: java.lang.String, index: scala.Double, guard: js.Object): java.lang.String = js.native
  /**
  ...
  def trimEnd(string: java.lang.String, index: scala.Double, guard: js.Object): java.lang.String = js.native
  /**
  ...
  def trimStart(string: java.lang.String, index: scala.Double, guard: js.Object): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def union[T](arrays: (js.UndefOr[List[T] | scala.Null])*): js.Array[T] = js.native
  ...
  def unionBy[T](arrays1: js.UndefOr[scala.Nothing], arrays2: scala.Null, iteratee: ValueIteratee[T]): js.Array[T] = js.native
  ...
  def unionBy[T](arrays1: List[T], arrays2: scala.Null, iteratee: ValueIteratee[T]): js.Array[T] = js.native
  def unionBy[T](arrays1: scala.Null, arrays2: js.UndefOr[scala.Nothing], iteratee: ValueIteratee[T]): js.Array[T] = js.native
  def unionBy[T](arrays1: scala.Null, arrays2: List[T]): js.Array[T] = js.native
  def unionBy[T](arrays1: scala.Null, arrays2: List[T], iteratee: ValueIteratee[T]): js.Array[T] = js.native
  def unionBy[T](arrays1: scala.Null, arrays2: scala.Null, iteratee: ValueIteratee[T]): js.Array[T] = js.native
  ...
  def unionBy[T](arrays: scala.Null, iteratee: ValueIteratee[T]): js.Array[T] = js.native
  ...
  def unionWith[T](arrays: js.UndefOr[scala.Nothing], arrays2: scala.Null, comparator: Comparator[T]): js.Array[T] = js.native
  ...
  def unionWith[T](arrays: List[T], arrays2: scala.Null, comparator: Comparator[T]): js.Array[T] = js.native
  def unionWith[T](arrays: List[T], comparator: Comparator[T]): js.Array[T] = js.native
  def unionWith[T](arrays: scala.Null, arrays2: js.UndefOr[scala.Nothing], comparator: Comparator[T]): js.Array[T] = js.native
  def unionWith[T](arrays: scala.Null, arrays2: List[T]): js.Array[T] = js.native
  def unionWith[T](arrays: scala.Null, arrays2: List[T], comparator: Comparator[T]): js.Array[T] = js.native
  def unionWith[T](arrays: scala.Null, arrays2: scala.Null, comparator: Comparator[T]): js.Array[T] = js.native
  def unionWith[T](arrays: scala.Null, comparator: Comparator[T]): js.Array[T] = js.native
  ...
  def uniqBy[T](array: scala.Null, iteratee: ValueIteratee[T]): js.Array[T] = js.native
  ...
  def uniqWith[T](array: scala.Null, comparator: Comparator[T]): js.Array[T] = js.native
  /**
  ...
  /**
    ...
    */
  def unset(`object`: js.Any, path: PropertyPath): scala.Boolean = js.native
  ...
  def unzipWith[T, TResult](array: scala.Null, iteratee: js.Function1[/* repeated */ T, TResult]): js.Array[TResult] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("updateWith")
  def updateWith_TObjectTResultTResult[T /* <: js.Object */, TResult](`object`: T, path: PropertyPath, updater: js.Function1[/* oldValue */ js.Any, _]): TResult = js.native
  @JSName("updateWith")
  def updateWith_TObjectTResultTResult[T /* <: js.Object */, TResult](
    `object`: T,
    path: PropertyPath,
    updater: js.Function1[/* oldValue */ js.Any, _],
    customizer: SetWithCustomizer[T]
  ...
  def words(string: java.lang.String, index: scala.Double, guard: js.Object): js.Array[java.lang.String] = js.native
  def words(string: java.lang.String, pattern: java.lang.String): js.Array[java.lang.String] = js.native
  def words(string: java.lang.String, pattern: stdLib.RegExp): js.Array[java.lang.String] = js.native
  /**
    * @see _.wrap
    */
  ...
  /**
    ...
    */
  def xor[T](arrays: (js.UndefOr[List[T] | scala.Null])*): js.Array[T] = js.native
  ...
  def xorBy[T](arrays: js.UndefOr[scala.Nothing], arrays2: scala.Null, iteratee: ValueIteratee[T]): js.Array[T] = js.native
  ...
  def xorBy[T](arrays: List[T], arrays2: scala.Null, iteratee: ValueIteratee[T]): js.Array[T] = js.native
  def xorBy[T](arrays: List[T], iteratee: ValueIteratee[T]): js.Array[T] = js.native
  def xorBy[T](arrays: scala.Null, arrays2: js.UndefOr[scala.Nothing], iteratee: ValueIteratee[T]): js.Array[T] = js.native
  def xorBy[T](arrays: scala.Null, arrays2: List[T]): js.Array[T] = js.native
  def xorBy[T](arrays: scala.Null, arrays2: List[T], iteratee: ValueIteratee[T]): js.Array[T] = js.native
  def xorBy[T](arrays: scala.Null, arrays2: scala.Null, iteratee: ValueIteratee[T]): js.Array[T] = js.native
  def xorBy[T](arrays: scala.Null, iteratee: ValueIteratee[T]): js.Array[T] = js.native
  ...
  def xorWith[T](arrays: js.UndefOr[scala.Nothing], arrays2: scala.Null, comparator: Comparator[T]): js.Array[T] = js.native
  ...
  def xorWith[T](arrays: List[T], arrays2: scala.Null, comparator: Comparator[T]): js.Array[T] = js.native
  def xorWith[T](arrays: List[T], comparator: Comparator[T]): js.Array[T] = js.native
  def xorWith[T](arrays: scala.Null, arrays2: js.UndefOr[scala.Nothing], comparator: Comparator[T]): js.Array[T] = js.native
  def xorWith[T](arrays: scala.Null, arrays2: List[T]): js.Array[T] = js.native
  def xorWith[T](arrays: scala.Null, arrays2: List[T], comparator: Comparator[T]): js.Array[T] = js.native
  def xorWith[T](arrays: scala.Null, arrays2: scala.Null, comparator: Comparator[T]): js.Array[T] = js.native
  def xorWith[T](arrays: scala.Null, comparator: Comparator[T]): js.Array[T] = js.native
  /**
    * @see _.zip
    */
  def zip[T](arrays: (js.UndefOr[List[T] | scala.Null])*): js.Array[js.Array[js.UndefOr[T]]] = js.native
  /**
  ...
  /**
    * @see _.zipWith
    */
  def zipWith[T, TResult](iteratee: (js.UndefOr[(js.Function1[/* repeated */ T, TResult]) | List[T] | scala.Null])*): js.Array[TResult] = js.native
  /**
    * @see _.zipWith
    */
