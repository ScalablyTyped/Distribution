...
trait ImplicitPartialRight extends js.Object {
  ...
  def apply[T1, T2, R](`this`: LoDashImplicitWrapper[Function2[T1, T2, R]], arg1: T1, arg2: T2): LoDashImplicitWrapper[Function0[R]] = js.native
  def apply[T1, T2, R](`this`: LoDashImplicitWrapper[Function2[T1, T2, R]], arg1: T1, plc2: __): LoDashImplicitWrapper[Function1[T2, R]] = js.native
  def apply[T1, T2, T3, R](`this`: LoDashImplicitWrapper[Function3[T1, T2, T3, R]], arg1: T1, arg2: T2, arg3: T3): LoDashImplicitWrapper[Function0[R]] = js.native
  def apply[T1, T2, T3, R](`this`: LoDashImplicitWrapper[Function3[T1, T2, T3, R]], arg1: T1, arg2: T2, plc3: __): LoDashImplicitWrapper[Function1[T3, R]] = js.native
  def apply[T1, T2, T3, R](`this`: LoDashImplicitWrapper[Function3[T1, T2, T3, R]], arg1: T1, plc2: __, arg3: T3): LoDashImplicitWrapper[Function1[T2, R]] = js.native
  def apply[T1, T2, T3, R](`this`: LoDashImplicitWrapper[Function3[T1, T2, T3, R]], arg1: T1, plc2: __, plc3: __): LoDashImplicitWrapper[Function2[T2, T3, R]] = js.native
