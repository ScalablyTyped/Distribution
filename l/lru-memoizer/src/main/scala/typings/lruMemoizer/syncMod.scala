...
object syncMod {
  ...
  - typings.lruMemoizer.utilMod.IParamsBase because var conflicts: clone. Inlined hash, hash, hash, hash, hash, hash, hash, hash, hash_Original, bypass, itemMaxAge, itemMaxAge, itemMaxAge, itemMaxAge, itemMaxAge, itemMaxAge, itemMaxAge, itemMaxAge, itemMaxAge_Original, freeze, disable, queueMaxAge */ trait SyncParams[T1, T2, T3, T4, T5, T6, TResult]
    extends StObject
