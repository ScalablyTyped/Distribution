...
object ^ extends js.Object {
  def getCurrentRequest(loaderContext: webpackLib.webpackMod.loaderNs.LoaderContext): java.lang.String = js.native
  ...
  def getOptions(loaderContext: webpackLib.webpackMod.loaderNs.LoaderContext): OptionObject = js.native
  def getRemainingRequest(loaderContext: webpackLib.webpackMod.loaderNs.LoaderContext): java.lang.String = js.native
  def interpolateName(loaderContext: webpackLib.webpackMod.loaderNs.LoaderContext, name: java.lang.String): java.lang.String = js.native
  def interpolateName(
    loaderContext: webpackLib.webpackMod.loaderNs.LoaderContext,
  ...
  def stringifyRequest(loaderContext: webpackLib.webpackMod.loaderNs.LoaderContext, resource: java.lang.String): java.lang.String = js.native
