...
object RecordingAppender {
  ...
  @scala.inline
  implicit class RecordingAppenderOps[Self <: RecordingAppender] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: recording): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
