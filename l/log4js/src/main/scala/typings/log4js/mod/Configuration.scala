...
object Configuration {
  ...
  def apply(
    ...
    categories: StringDictionary[Appenders],
    ...
    if (!js.isUndefined(disableClustering)) __obj.updateDynamic("disableClustering")(disableClustering.get.asInstanceOf[js.Any])
    if (levels != null) __obj.updateDynamic("levels")(levels.asInstanceOf[js.Any])
    if (!js.isUndefined(pm2)) __obj.updateDynamic("pm2")(pm2.get.asInstanceOf[js.Any])
