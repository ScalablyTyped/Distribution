...
object mod {
  ...
  object golang {
    ...
    object strings {
      ...
      inline def Contains(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("Contains")().asInstanceOf[js.Any]
      inline def Contains(s: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("Contains")(s.asInstanceOf[js.Any]).asInstanceOf[js.Any]
      inline def Contains(s: js.Any, substr: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("Contains")(s.asInstanceOf[js.Any], substr.asInstanceOf[js.Any])).asInstanceOf[js.Any]
      inline def Contains(s: Unit, substr: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("Contains")(s.asInstanceOf[js.Any], substr.asInstanceOf[js.Any])).asInstanceOf[js.Any]
      
      inline def Count(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("Count")().asInstanceOf[js.Any]
      inline def Count(s: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("Count")(s.asInstanceOf[js.Any]).asInstanceOf[js.Any]
      inline def Count(s: js.Any, sep: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("Count")(s.asInstanceOf[js.Any], sep.asInstanceOf[js.Any])).asInstanceOf[js.Any]
      inline def Count(s: Unit, sep: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("Count")(s.asInstanceOf[js.Any], sep.asInstanceOf[js.Any])).asInstanceOf[js.Any]
      
      inline def Index(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("Index")().asInstanceOf[js.Any]
      inline def Index(s: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("Index")(s.asInstanceOf[js.Any]).asInstanceOf[js.Any]
      inline def Index(s: js.Any, sep: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("Index")(s.asInstanceOf[js.Any], sep.asInstanceOf[js.Any])).asInstanceOf[js.Any]
      inline def Index(s: Unit, sep: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("Index")(s.asInstanceOf[js.Any], sep.asInstanceOf[js.Any])).asInstanceOf[js.Any]
      
      inline def LastIndex(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("LastIndex")().asInstanceOf[js.Any]
      inline def LastIndex(s: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("LastIndex")(s.asInstanceOf[js.Any]).asInstanceOf[js.Any]
      inline def LastIndex(s: js.Any, sep: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("LastIndex")(s.asInstanceOf[js.Any], sep.asInstanceOf[js.Any])).asInstanceOf[js.Any]
      inline def LastIndex(s: Unit, sep: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("LastIndex")(s.asInstanceOf[js.Any], sep.asInstanceOf[js.Any])).asInstanceOf[js.Any]
    }
  }
