...
object mod {
  ...
  object default {
    ...
    inline def from[K /* <: PropertyKey */, T](obj: Record[K, T]): IEnumerable[Key[K, T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(obj.asInstanceOf[js.Any]).asInstanceOf[IEnumerable[Key[K, T]]]
