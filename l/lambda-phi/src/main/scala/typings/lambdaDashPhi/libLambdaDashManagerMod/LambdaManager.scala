...
trait LambdaManager extends js.Object {
  ...
  def getLambdaByName(name: String): typings.lambdaDashPhi.libLambdaDashModelMod.default
  ...
  def upsertLambdaModel(target: js.Any): typings.lambdaDashPhi.libLambdaDashModelMod.default
}
...
object LambdaManager {
  ...
  def apply(
    ...
    getLambdaByName: String => typings.lambdaDashPhi.libLambdaDashModelMod.default,
    processLambdas: () => Unit,
    rawHandler: js.Any,
    ...
    upsertLambdaModel: js.Any => typings.lambdaDashPhi.libLambdaDashModelMod.default
  ): LambdaManager = {
