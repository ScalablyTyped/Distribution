...
object libLambdaModelMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    var httpVerbs: js.Array[typings.lambdaPhi.libHttpVerbModelMod.default] = js.native
    ...
    /* CompleteClass */
    var pathParams: js.Array[typings.lambdaPhi.libPathParamModelMod.default] = js.native
    
    /* CompleteClass */
    var pathParamsProperty: Any = js.native
    
    /* CompleteClass */
    var paths: js.Array[typings.lambdaPhi.libPathModelMod.default] = js.native
  ...
  trait LambdaModel extends StObject {
    ...
    var httpVerbs: js.Array[typings.lambdaPhi.libHttpVerbModelMod.default]
    ...
    var pathParams: js.Array[typings.lambdaPhi.libPathParamModelMod.default]
    
    var pathParamsProperty: Any
    
    var paths: js.Array[typings.lambdaPhi.libPathModelMod.default]
  ...
  object LambdaModel {
    ...
    inline def apply(
      ...
      handlerMethod: Any,
      headersProperty: Any,
      httpVerbs: js.Array[typings.lambdaPhi.libHttpVerbModelMod.default],
      instance: Any,
      methodProperty: Any,
      name: Any,
      pathParams: js.Array[typings.lambdaPhi.libPathParamModelMod.default],
      pathParamsProperty: Any,
      paths: js.Array[typings.lambdaPhi.libPathModelMod.default],
    ...
    implicit open class MutableBuilder[Self <: LambdaModel] (val x: Self) extends AnyVal {
      ...
      inline def setHttpVerbs(value: js.Array[typings.lambdaPhi.libHttpVerbModelMod.default]): Self = StObject.set(x, "httpVerbs", value.asInstanceOf[js.Any])
      
      inline def setHttpVerbsVarargs(value: typings.lambdaPhi.libHttpVerbModelMod.default*): Self = StObject.set(x, "httpVerbs", js.Array(value*))
      ...
      inline def setPathParams(value: js.Array[typings.lambdaPhi.libPathParamModelMod.default]): Self = StObject.set(x, "pathParams", value.asInstanceOf[js.Any])
      
      inline def setPathParamsProperty(value: Any): Self = StObject.set(x, "pathParamsProperty", value.asInstanceOf[js.Any])
      
      inline def setPathParamsVarargs(value: typings.lambdaPhi.libPathParamModelMod.default*): Self = StObject.set(x, "pathParams", js.Array(value*))
      
      inline def setPaths(value: js.Array[typings.lambdaPhi.libPathModelMod.default]): Self = StObject.set(x, "paths", value.asInstanceOf[js.Any])
      
      inline def setPathsVarargs(value: typings.lambdaPhi.libPathModelMod.default*): Self = StObject.set(x, "paths", js.Array(value*))
