...
import typings.lambdaPhi.libApiGatewayMod.ApiGateway
...
object libLambdaManagerMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    override def getLambdaByName(name: String): typings.lambdaPhi.libLambdaModelMod.default = js.native
    ...
    /* CompleteClass */
    override def upsertLambdaModel(target: Any): typings.lambdaPhi.libLambdaModelMod.default = js.native
  }
  /* static members */
  object default {
  ...
  trait LambdaManager extends StObject {
    ...
    def getLambdaByName(name: String): typings.lambdaPhi.libLambdaModelMod.default
    ...
    def upsertLambdaModel(target: Any): typings.lambdaPhi.libLambdaModelMod.default
  }
  object LambdaManager {
    ...
    inline def apply(
      ...
      getEvent: Any => Any,
      getEventContext: () => Any,
      getLambdaByName: String => typings.lambdaPhi.libLambdaModelMod.default,
      processLambdas: () => Unit,
      rawHandler: Any,
      ...
      upsertLambdaModel: Any => typings.lambdaPhi.libLambdaModelMod.default
    ): LambdaManager = {
    ...
    implicit open class MutableBuilder[Self <: LambdaManager] (val x: Self) extends AnyVal {
      ...
      inline def setGetLambdaByName(value: String => typings.lambdaPhi.libLambdaModelMod.default): Self = StObject.set(x, "getLambdaByName", js.Any.fromFunction1(value))
      ...
      inline def setUpsertLambdaModel(value: Any => typings.lambdaPhi.libLambdaModelMod.default): Self = StObject.set(x, "upsertLambdaModel", js.Any.fromFunction1(value))
