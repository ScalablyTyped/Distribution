...
package object luxonNs {
  type DateObject = DateObjectUnits with LocaleOptions with luxonLib.Anon_Zone
  type DateTimeFormatOptions = stdLib.IntlNs.DateTimeFormatOptions
  type DateTimeJSOptions = LocaleOptions with luxonLib.Anon_Zone
  type DateTimeOptions = LocaleOptions with luxonLib.Anon_SetZone
