...
object InfoNs extends js.Object {
  ...
  def eras(length: luxonLib.luxonMod.StringUnitLength): js.Array[java.lang.String] = js.native
  def eras(length: luxonLib.luxonMod.StringUnitLength, options: luxonLib.luxonMod.InfoOptions): js.Array[java.lang.String] = js.native
  ...
  def months(length: luxonLib.luxonMod.UnitLength, options: luxonLib.luxonMod.InfoCalendarOptions): js.Array[java.lang.String] = js.native
  ...
  def monthsFormat(length: luxonLib.luxonMod.UnitLength, options: luxonLib.luxonMod.InfoCalendarOptions): js.Array[java.lang.String] = js.native
  ...
  def weekdays(length: luxonLib.luxonMod.StringUnitLength): js.Array[java.lang.String] = js.native
  def weekdays(length: luxonLib.luxonMod.StringUnitLength, options: luxonLib.luxonMod.InfoUnitOptions): js.Array[java.lang.String] = js.native
  def weekdaysFormat(): js.Array[java.lang.String] = js.native
  def weekdaysFormat(length: luxonLib.luxonMod.StringUnitLength): js.Array[java.lang.String] = js.native
  def weekdaysFormat(length: luxonLib.luxonMod.StringUnitLength, options: luxonLib.luxonMod.InfoUnitOptions): js.Array[java.lang.String] = js.native
}
