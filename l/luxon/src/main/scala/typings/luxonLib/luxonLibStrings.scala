...
object luxonLibStrings {
  ...
  sealed trait `2-digit`
    extends luxonLib.luxonMod.NumberUnitLength
  ...
  sealed trait buddhist
    extends luxonLib.luxonMod.CalendarSystem
  
  @js.native
  sealed trait casual
    extends luxonLib.luxonMod.ConversionAccuracy
  ...
  @js.native
  sealed trait h11
    extends luxonLib.luxonMod.HourCycle
