...
object luxonMod {
  ...
  open class DateTime protected ()
    extends typings.luxon.datetimeMod.DateTime {
  ...
  open class Duration protected ()
    extends typings.luxon.durationMod.Duration {
    /* private */ def this(config: Any) = this()
  }
  /* static members */
  object Duration {
  ...
  open class FixedOffsetZone ()
    extends typings.luxon.zoneMod.FixedOffsetZone
  /* static members */
  ...
  open class IANAZone protected ()
    extends typings.luxon.zoneMod.IANAZone {
  ...
  open class Interval protected ()
    extends typings.luxon.intervalMod.Interval {
    /* private */ def this(config: Any) = this()
  }
  /* static members */
  object Interval {
  ...
  open class InvalidZone ()
    extends typings.luxon.zoneMod.InvalidZone
  
  @JSImport("luxon/src/luxon", "Settings")
  @js.native
  open class Settings ()
    extends typings.luxon.settingsMod.Settings
  /* static members */
  object Settings {
  ...
  open class SystemZone ()
    extends typings.luxon.zoneMod.SystemZone
  
  @JSImport("luxon/src/luxon", "VERSION")
  @js.native
  val VERSION: String = js.native
  
  @JSImport("luxon/src/luxon", "Zone")
  @js.native
  abstract class Zone ()
    extends typings.luxon.zoneMod.Zone
}
