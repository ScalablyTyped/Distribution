...
object global {
  ...
  object luxon {
    ...
    @JSGlobal("luxon.DateTime")
    @js.native
    open class DateTime protected ()
      extends typings.luxon.mod.DateTime {
    ...
    open class Duration protected ()
      extends typings.luxon.mod.Duration {
      /* private */ def this(config: Any) = this()
    }
    /* static members */
    object Duration {
    ...
    @JSGlobal("luxon.FixedOffsetZone")
    @js.native
    open class FixedOffsetZone ()
      extends typings.luxon.mod.FixedOffsetZone
    /* static members */
    ...
    open class IANAZone protected ()
      extends typings.luxon.mod.IANAZone {
    ...
    @JSGlobal("luxon.Interval")
    @js.native
    open class Interval protected ()
      extends typings.luxon.mod.Interval {
      /* private */ def this(config: Any) = this()
    }
    /* static members */
    object Interval {
    ...
    open class InvalidZone ()
      extends typings.luxon.mod.InvalidZone
    
    @JSGlobal("luxon.Settings")
    @js.native
    open class Settings ()
      extends typings.luxon.mod.Settings
    /* static members */
    object Settings {
      ...
      /**
        ...
        */
      @JSGlobal("luxon.Settings.defaultLocale")
      @js.native
      ...
      /**
        ...
        */
      @JSGlobal("luxon.Settings.defaultNumberingSystem")
      @js.native
      ...
      /**
        ...
        */
      @JSGlobal("luxon.Settings.defaultOutputCalendar")
      @js.native
      ...
      /**
        ...
        * }
        */
      @JSGlobal("luxon.Settings.throwOnInvalid")
      @js.native
    ...
    @JSGlobal("luxon.SystemZone")
    @js.native
    open class SystemZone ()
      extends typings.luxon.mod.SystemZone
    
    @JSGlobal("luxon.VERSION")
    @js.native
