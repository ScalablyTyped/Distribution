...
import typings.luxon.durationMod.DurationUnits
import typings.luxon.intervalMod.Interval
import typings.luxon.intervalMod._DateInput
import typings.luxon.miscMod.DateTimeFormatOptions
import typings.luxon.miscMod.ZoneOptions
...
open class DateTime protected ()
  ...
  /**
    ...
    */
  def get(
    unit: /* keyof luxon.luxon/src/datetime.DateTime */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 117 */ Any
  ): Double = js.native
