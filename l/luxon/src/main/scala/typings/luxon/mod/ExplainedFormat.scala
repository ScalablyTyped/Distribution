...
object ExplainedFormat {
  ...
  extension [Self <: ExplainedFormat](x: Self) {
    ...
    inline def setMatches(value: StringDictionary[js.Any]): Self = StObject.set(x, "matches", value.asInstanceOf[js.Any])
    ...
    inline def setResult(value: StringDictionary[js.Any]): Self = StObject.set(x, "result", value.asInstanceOf[js.Any])
    ...
    inline def setTokensVarargs(value: Literal*): Self = StObject.set(x, "tokens", js.Array(value :_*))
