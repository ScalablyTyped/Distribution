...
import typings.luxon.datetimeMod.DateTime
import typings.luxon.datetimeMod.DateTimeOptions
import typings.luxon.datetimeMod.DiffOptions
import typings.luxon.datetimeMod.ToISOTimeOptions
import typings.luxon.durationMod.Duration
...
object intervalMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.luxon.datetimeMod.DateTime
    - typings.luxon.datetimeMod.DateObjectUnits
    - js.Date
  */
