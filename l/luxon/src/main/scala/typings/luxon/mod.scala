...
object mod {
  ...
  open class DateTime protected ()
    extends typings.luxon.srcLuxonMod.DateTime {
  ...
  open class Duration protected ()
    extends typings.luxon.srcLuxonMod.Duration {
    /* private */ def this(config: Any) = this()
  }
  /* static members */
  object Duration {
  ...
  open class FixedOffsetZone ()
    extends typings.luxon.srcLuxonMod.FixedOffsetZone
  /* static members */
  ...
  open class IANAZone protected ()
    extends typings.luxon.srcLuxonMod.IANAZone {
  ...
  open class Interval protected ()
    extends typings.luxon.srcLuxonMod.Interval {
    /* private */ def this(config: Any) = this()
  }
  /* static members */
  object Interval {
  ...
  open class InvalidZone ()
    extends typings.luxon.srcLuxonMod.InvalidZone
  
  @JSImport("luxon", "Settings")
  @js.native
  open class Settings ()
    extends typings.luxon.srcLuxonMod.Settings
  /* static members */
  object Settings {
  ...
  open class SystemZone ()
    extends typings.luxon.srcLuxonMod.SystemZone
  ...
  @js.native
  open class Zone ()
    extends typings.luxon.srcLuxonMod.Zone
}
