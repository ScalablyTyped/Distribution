...
object mod {
  ...
  open class DateTime protected ()
    extends typings.luxon.luxonMod.DateTime {
  ...
  open class Duration protected ()
    extends typings.luxon.luxonMod.Duration {
    /* private */ def this(config: Any) = this()
  }
  /* static members */
  object Duration {
  ...
  open class FixedOffsetZone ()
    extends typings.luxon.luxonMod.FixedOffsetZone
  /* static members */
  ...
  open class IANAZone protected ()
    extends typings.luxon.luxonMod.IANAZone {
  ...
  open class Interval protected ()
    extends typings.luxon.luxonMod.Interval {
    /* private */ def this(config: Any) = this()
  }
  /* static members */
  object Interval {
  ...
  open class InvalidZone ()
    extends typings.luxon.luxonMod.InvalidZone
  
  @JSImport("luxon", "Settings")
  @js.native
  open class Settings ()
    extends typings.luxon.luxonMod.Settings
  /* static members */
  object Settings {
  ...
  open class SystemZone ()
    extends typings.luxon.luxonMod.SystemZone
  ...
  @js.native
  abstract class Zone ()
    extends typings.luxon.luxonMod.Zone
}
