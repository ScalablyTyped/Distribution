...
name := "libp2p"
version := "0.40.0-5563f4"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "achingbrain__nat-port-mapper" % "1.0.7-8954ee",
  "org.scalablytyped" %%% "achingbrain__ssdp" % "4.0.1-1ab5ec",
  ...
  "org.scalablytyped" %%% "timeout-abort-controller" % "3.0.0-0ca377",
