...
name := "libp2p"
version := "0.39.2-4c3f33"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "achingbrain__nat-port-mapper" % "1.0.7-92cdfd",
  "org.scalablytyped" %%% "achingbrain__ssdp" % "4.0.1-33507d",
  ...
  "org.scalablytyped" %%% "libp2p__interface-stream-muxer" % "2.0.2-2ca3ce",
