...
name := "libp2p"
version := "0.39.2-b57da1"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "achingbrain__nat-port-mapper" % "1.0.7-ed61a6",
  "org.scalablytyped" %%% "achingbrain__ssdp" % "4.0.1-75b96b",
  ...
  "org.scalablytyped" %%% "libp2p__interface-stream-muxer" % "2.0.2-7fc9f9",
