...
trait Libp2pInit extends StObject {
  ...
  var contentRouters: js.UndefOr[js.Array[js.Function1[/* components */ Components, ContentRouting]]] = js.undefined
  
  var datastore: Datastore
  
  var dht: js.UndefOr[js.Function1[/* components */ Components, DualDHT]] = js.undefined
  ...
  var peerDiscovery: js.UndefOr[js.Array[js.Function1[/* components */ Components, PeerDiscovery]]] = js.undefined
  
  var peerId: PeerId
  
  var peerRouters: js.UndefOr[js.Array[js.Function1[/* components */ Components, PeerRouting]]] = js.undefined
  ...
  var pubsub: js.UndefOr[js.Function1[/* components */ Components, PubSub[PubSubEvents]]] = js.undefined
...
object Libp2pInit {
  ...
  extension [Self <: Libp2pInit](x: Self) {
    ...
    inline def setContentRouters(value: js.Array[js.Function1[/* components */ Components, ContentRouting]]): Self = StObject.set(x, "contentRouters", value.asInstanceOf[js.Any])
    
    inline def setContentRoutersUndefined: Self = StObject.set(x, "contentRouters", js.undefined)
    
    inline def setContentRoutersVarargs(value: (js.Function1[/* components */ Components, ContentRouting])*): Self = StObject.set(x, "contentRouters", js.Array(value*))
    
    inline def setDatastore(value: Datastore): Self = StObject.set(x, "datastore", value.asInstanceOf[js.Any])
    
    inline def setDht(value: /* components */ Components => DualDHT): Self = StObject.set(x, "dht", js.Any.fromFunction1(value))
    ...
    inline def setPeerDiscovery(value: js.Array[js.Function1[/* components */ Components, PeerDiscovery]]): Self = StObject.set(x, "peerDiscovery", value.asInstanceOf[js.Any])
    
    inline def setPeerDiscoveryUndefined: Self = StObject.set(x, "peerDiscovery", js.undefined)
    
    inline def setPeerDiscoveryVarargs(value: (js.Function1[/* components */ Components, PeerDiscovery])*): Self = StObject.set(x, "peerDiscovery", js.Array(value*))
    
    inline def setPeerId(value: PeerId): Self = StObject.set(x, "peerId", value.asInstanceOf[js.Any])
    
    inline def setPeerRouters(value: js.Array[js.Function1[/* components */ Components, PeerRouting]]): Self = StObject.set(x, "peerRouters", value.asInstanceOf[js.Any])
    
    inline def setPeerRoutersUndefined: Self = StObject.set(x, "peerRouters", js.undefined)
    
    inline def setPeerRoutersVarargs(value: (js.Function1[/* components */ Components, PeerRouting])*): Self = StObject.set(x, "peerRouters", js.Array(value*))
    ...
    inline def setPubsub(value: /* components */ Components => PubSub[PubSubEvents]): Self = StObject.set(x, "pubsub", js.Any.fromFunction1(value))
