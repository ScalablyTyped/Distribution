...
/* Inlined std.Partial<libp2p.libp2p/dist/src/circuit-relay/pb.HopMessage> */
trait PartialHopMessage extends StObject {
...
object PartialHopMessage {
  
  inline def apply(): PartialHopMessage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialHopMessage]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialHopMessage] (val x: Self) extends AnyVal {
