...
object UploadOption {
  ...
  extension [Self <: UploadOption](x: Self) {
    ...
    inline def setAllDone(value: /* obj */ js.Object => Unit): Self = StObject.set(x, "allDone", js.Any.fromFunction1(value))
    ...
    inline def setBefore(value: /* obj */ js.Object => Unit): Self = StObject.set(x, "before", js.Any.fromFunction1(value))
    ...
    inline def setChoose(value: /* obj */ js.Object => Unit): Self = StObject.set(x, "choose", js.Any.fromFunction1(value))
    ...
    inline def setDone(value: (/* res */ js.Object, /* index */ Double, /* upload */ js.Function0[Unit]) => Unit): Self = StObject.set(x, "done", js.Any.fromFunction3(value))
    ...
    inline def setError(value: (/* index */ Double, /* upload */ js.Function0[Unit]) => Unit): Self = StObject.set(x, "error", js.Any.fromFunction2(value))
