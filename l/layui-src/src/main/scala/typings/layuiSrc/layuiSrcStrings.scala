...
object layuiSrcStrings {
  ...
  @js.native
  sealed trait LAY_CHECKED extends StObject
  inline def LAY_CHECKED: LAY_CHECKED = "LAY_CHECKED".asInstanceOf[LAY_CHECKED]
  
  @js.native
  sealed trait LAY_TABLE_INDEX extends StObject
  inline def LAY_TABLE_INDEX: LAY_TABLE_INDEX = "LAY_TABLE_INDEX".asInstanceOf[LAY_TABLE_INDEX]
  ...
  inline def abolute: abolute = "abolute".asInstanceOf[abolute]
  ...
  @js.native
  sealed trait bar1 extends StObject
  inline def bar1: bar1 = "bar1".asInstanceOf[bar1]
  
  @js.native
  sealed trait bar2 extends StObject
  inline def bar2: bar2 = "bar2".asInstanceOf[bar2]
  ...
  inline def insider: insider = "insider".asInstanceOf[insider]
  ...
  @js.native
  sealed trait jquery extends StObject
  inline def jquery: jquery = "jquery".asInstanceOf[jquery]
  ...
  @js.native
  sealed trait lay extends StObject
  inline def lay: lay = "lay".asInstanceOf[lay]
  
  @js.native
  sealed trait laydate extends StObject
  inline def laydate: laydate = "laydate".asInstanceOf[laydate]
  
  @js.native
  sealed trait layedit extends StObject
  inline def layedit: layedit = "layedit".asInstanceOf[layedit]
  ...
  @js.native
  sealed trait laypage extends StObject
  inline def laypage: laypage = "laypage".asInstanceOf[laypage]
  
  @js.native
  sealed trait laytpl extends StObject
  inline def laytpl: laytpl = "laytpl".asInstanceOf[laytpl]
  
  @js.native
  sealed trait layuiDotall extends StObject
  inline def layuiDotall: layuiDotall = "layui.all".asInstanceOf[layuiDotall]
  ...
  inline def molv: molv = "molv".asInstanceOf[molv]
  ...
  inline def outsider: outsider = "outsider".asInstanceOf[outsider]
  ...
  inline def tips: tips = "tips".asInstanceOf[tips]
  ...
  inline def updown: updown = "updown".asInstanceOf[updown]
  ...
  @js.native
  sealed trait util extends StObject
  inline def util: util = "util".asInstanceOf[util]
