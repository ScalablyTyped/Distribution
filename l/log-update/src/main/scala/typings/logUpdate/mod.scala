...
object mod {
  ...
  /**
  		...
  		*/
  @scala.inline
  def apply(text: String*): Unit = ^.asInstanceOf[js.Dynamic].apply(text.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
  	...
  	*/
  @scala.inline
  def create(stream: WritableStream): LogUpdate = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(stream.asInstanceOf[js.Any]).asInstanceOf[LogUpdate]
  @scala.inline
  def create(stream: WritableStream, options: Options): LogUpdate = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(stream.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[LogUpdate]
  
  /**
  		Persist the logged output. Useful if you want to start a new log session below the current one.
  		*/
  @scala.inline
  def done(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("done")().asInstanceOf[Unit]
  ...
  /**
  	...
  	*/
  @scala.inline
  def stderr(text: String*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("stderr")(text.asInstanceOf[js.Any]).asInstanceOf[Unit]
