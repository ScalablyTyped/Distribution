...
trait GlobalTimers[TTimerId /* <: TimerId */] extends js.Object {
  ...
  /**
    ...
    * @param id   Timer ID or object.
    */
  def clearTimeout(id: TimerId): scala.Unit = js.native
  /**
    ...
    */
  def setImmediate(callback: js.Function0[scala.Unit]): TTimerId = js.native
  /**
    ...
    */
  def setInterval(callback: js.Function0[scala.Unit], timeout: scala.Double, args: js.Any*): TTimerId = js.native
  /**
    ...
    * @returns Time identifier for cancellation.
    */
  def setTimeout(callback: js.Function0[scala.Unit], timeout: scala.Double, args: js.Any*): TTimerId = js.native
}
