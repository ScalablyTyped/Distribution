...
object ^ extends js.Object {
  val timers: lolexLib.lolexMod.GlobalTimers[lolexLib.lolexMod.TimerId] = js.native
  ...
  def install[TClock /* <: lolexLib.Clock */](opts: lolexLib.lolexMod.LolexInstallOpts): lolexLib.InstalledClock[TClock] = js.native
  def withGlobal(global: js.Object): lolexLib.lolexMod.LolexWithContext = js.native
}
