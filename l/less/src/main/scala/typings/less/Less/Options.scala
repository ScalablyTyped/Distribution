...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(depends)) __obj.updateDynamic("depends")(depends.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(ieCompat)) __obj.updateDynamic("ieCompat")(ieCompat.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(strictImports)) __obj.updateDynamic("strictImports")(strictImports.get.asInstanceOf[js.Any])
    if (!js.isUndefined(strictUnits)) __obj.updateDynamic("strictUnits")(strictUnits.get.asInstanceOf[js.Any])
    if (!js.isUndefined(syncImport)) __obj.updateDynamic("syncImport")(syncImport.get.asInstanceOf[js.Any])
