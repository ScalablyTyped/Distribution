...
object global {
  ...
  object Less_ {
    ...
    @JSGlobal("Less.AbstractFileManager")
    @js.native
    open class AbstractFileManager ()
      extends StObject
         with typings.less.Less.AbstractFileManager {
  ...
  object less extends Shortcut {
    ...
    /* This means you don't have to write `^`, but can instead just say `less.foo` */
