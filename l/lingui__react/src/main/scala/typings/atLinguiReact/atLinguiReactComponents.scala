...
object atLinguiReactComponents extends atLinguiReactProps {
  ...
  typings.atLinguiReact.createFormatMod.FormatPropsWithoutI18n[typings.std.Date, typings.std.IntlNs.DateTimeFormatOptions]]]
  @scala.inline
  ...
  typings.atLinguiReact.createFormatMod.FormatPropsWithoutI18n[scala.Double, typings.std.IntlNs.NumberFormatOptions]]]
  @scala.inline
