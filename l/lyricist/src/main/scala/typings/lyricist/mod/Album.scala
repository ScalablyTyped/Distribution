...
object Album {
  ...
  extension [Self <: Album](x: Self) {
    ...
    inline def setCover_arts(value: js.Array[js.Any]): Self = StObject.set(x, "cover_arts", value.asInstanceOf[js.Any])
    
    inline def setCover_artsVarargs(value: js.Any*): Self = StObject.set(x, "cover_arts", js.Array(value :_*))
    ...
    inline def setCustom_header_image_url(value: js.Any): Self = StObject.set(x, "custom_header_image_url", value.asInstanceOf[js.Any])
    ...
    inline def setPerformance_groups(value: js.Array[js.Any]): Self = StObject.set(x, "performance_groups", value.asInstanceOf[js.Any])
    
    inline def setPerformance_groupsVarargs(value: js.Any*): Self = StObject.set(x, "performance_groups", js.Array(value :_*))
    
    inline def setPyongs_count(value: Double): Self = StObject.set(x, "pyongs_count", value.asInstanceOf[js.Any])
    
    inline def setRelease_date(value: js.Any): Self = StObject.set(x, "release_date", value.asInstanceOf[js.Any])
    
    inline def setRelease_dateUndefined: Self = StObject.set(x, "release_date", js.undefined)
    
    inline def setRelease_date_components(value: js.Any): Self = StObject.set(x, "release_date_components", value.asInstanceOf[js.Any])
    ...
    inline def setSong_performances(value: js.Array[js.Any]): Self = StObject.set(x, "song_performances", value.asInstanceOf[js.Any])
    
    inline def setSong_performancesVarargs(value: js.Any*): Self = StObject.set(x, "song_performances", js.Array(value :_*))
