...
import typings.lyricist.AnonExcludedpermissionsFeatures
...
trait User extends js.Object {
  var api_path: String
  var avatar: Avatar
  var current_user_metadata: AnonExcludedpermissionsFeatures
...
object User {
  ...
  def apply(
    api_path: String,
    avatar: Avatar,
    current_user_metadata: AnonExcludedpermissionsFeatures,
