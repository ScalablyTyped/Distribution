...
@js.native
object lockfileModMembers extends js.Object {
  def check(
  ...
  def checkSync(path: java.lang.String, opts: Options): scala.Boolean = js.native
  ...
  def lockSync(path: java.lang.String, opts: Options): scala.Unit = js.native
