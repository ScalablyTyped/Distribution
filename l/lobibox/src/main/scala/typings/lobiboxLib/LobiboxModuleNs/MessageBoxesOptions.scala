...
object MessageBoxesOptions {
  ...
  def apply(
    ...
    setHeight: /* height */ js.UndefOr[scala.Double] => MessageBoxesOptions = null,
    setPosition: (/* left */ js.UndefOr[scala.Double | java.lang.String], /* top */ js.UndefOr[scala.Double]) => MessageBoxesOptions = null,
    setSize: (/* width */ js.UndefOr[scala.Double], /* height */ js.UndefOr[scala.Double]) => MessageBoxesOptions = null,
    setTitle: /* title */ js.UndefOr[java.lang.String] => MessageBoxesOptions = null,
    setWidth: /* width */ js.UndefOr[scala.Double] => MessageBoxesOptions = null,
