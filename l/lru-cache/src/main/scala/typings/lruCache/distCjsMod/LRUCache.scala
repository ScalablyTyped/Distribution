...
import typings.lruCache.distCjsMod.LRUCache.Count
import typings.lruCache.distCjsMod.LRUCache.Disposer
import typings.lruCache.distCjsMod.LRUCache.Entry
import typings.lruCache.distCjsMod.LRUCache.Fetcher
import typings.lruCache.distCjsMod.LRUCache.GetOptions
import typings.lruCache.distCjsMod.LRUCache.HasOptions
import typings.lruCache.distCjsMod.LRUCache.Milliseconds
import typings.lruCache.distCjsMod.LRUCache.Options
import typings.lruCache.distCjsMod.LRUCache.PeekOptions
import typings.lruCache.distCjsMod.LRUCache.SetOptions
import typings.lruCache.distCjsMod.LRUCache.Size
import typings.lruCache.distCjsMod.LRUCache.SizeCalculator
...
@JSImport("lru-cache/dist/cjs", "LRUCache")
@js.native
...
object LRUCache {
  ...
  /**
    ...
    * @internal
    */
  inline def unsafeExposeInternals[K /* <: js.Object */, V /* <: js.Object */, FC /* <: Any */](c: LRUCache[K, V, FC]): typings.lruCache.anon.BackgroundFetch[K, V, FC] = ^.asInstanceOf[js.Dynamic].applyDynamic("unsafeExposeInternals")(c.asInstanceOf[js.Any]).asInstanceOf[typings.lruCache.anon.BackgroundFetch[K, V, FC]]
  ...
  */
  ...
  /**
    ...
    */
  /* Inlined parent std.Pick<lru-cache.lru-cache/dist/cjs.LRUCache.OptionsBase<K, V, FC>, 'allowStale' | 'updateAgeOnGet' | 'noDeleteOnStaleGet' | 'sizeCalculation' | 'ttl' | 'noDisposeOnSet' | 'noUpdateTTL' | 'noDeleteOnFetchRejection' | 'allowStaleOnFetchRejection' | 'ignoreFetchAbort' | 'allowStaleOnFetchAbort'> */
  ...
  /**
    ...
    */
  /* Inlined parent std.Pick<lru-cache.lru-cache/dist/cjs.LRUCache.OptionsBase<K, V, FC>, 'allowStale' | 'updateAgeOnGet' | 'noDeleteOnStaleGet'> */
  ...
  /**
    ...
    */
  /* Inlined parent std.Pick<lru-cache.lru-cache/dist/cjs.LRUCache.OptionsBase<K, V, FC>, 'updateAgeOnHas'> */
  ...
  /**
    ...
    */
  /* Rewritten from type alias, can be one of: 
    - typings.lruCache.distCjsMod.LRUCache.OptionsMaxLimit[K, V, FC]
    - typings.lruCache.distCjsMod.LRUCache.OptionsSizeLimit[K, V, FC]
    - typings.lruCache.distCjsMod.LRUCache.OptionsTTLLimit[K, V, FC]
  */
  trait Options[K, V, FC] extends StObject
  object Options {
    
    inline def OptionsMaxLimit[K, V, FC](max: Count): typings.lruCache.distCjsMod.LRUCache.OptionsMaxLimit[K, V, FC] = {
      val __obj = js.Dynamic.literal(max = max.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.lruCache.distCjsMod.LRUCache.OptionsMaxLimit[K, V, FC]]
    }
    
    inline def OptionsSizeLimit[K, V, FC](maxSize: Size): typings.lruCache.distCjsMod.LRUCache.OptionsSizeLimit[K, V, FC] = {
      val __obj = js.Dynamic.literal(maxSize = maxSize.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.lruCache.distCjsMod.LRUCache.OptionsSizeLimit[K, V, FC]]
    }
    
    inline def OptionsTTLLimit[K, V, FC](ttl: Milliseconds, ttlAutopurge: Boolean): typings.lruCache.distCjsMod.LRUCache.OptionsTTLLimit[K, V, FC] = {
      val __obj = js.Dynamic.literal(ttl = ttl.asInstanceOf[js.Any], ttlAutopurge = ttlAutopurge.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.lruCache.distCjsMod.LRUCache.OptionsTTLLimit[K, V, FC]]
    }
  }
  ...
  /**
    ...
    */
  /* Inlined parent std.Pick<lru-cache.lru-cache/dist/cjs.LRUCache.OptionsBase<K, V, FC>, 'allowStale'> */
  ...
  /**
    ...
    */
  /* Inlined parent std.Pick<lru-cache.lru-cache/dist/cjs.LRUCache.OptionsBase<K, V, FC>, 'sizeCalculation' | 'ttl' | 'noDisposeOnSet' | 'noUpdateTTL'> */
