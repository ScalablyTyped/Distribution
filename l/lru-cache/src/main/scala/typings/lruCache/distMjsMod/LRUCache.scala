...
open class LRUCache[K /* <: js.Object */, V /* <: js.Object */, FC] protected () extends StObject {
  ...
  def fetch(
    k: K,
    fetchOptions: /* import warning: importer.ImportType#apply Failed type conversion: unknown extends FC ? lru-cache.lru-cache/dist/mjs.LRUCache.FetchOptions<K, V, FC> : FC extends undefined | void ? lru-cache.lru-cache/dist/mjs.LRUCache.FetchOptionsNoContext<K, V, FC> : lru-cache.lru-cache/dist/mjs.LRUCache.FetchOptionsWithContext<K, V, FC> */ js.Any
  ...
  def fetch(
    k: /* import warning: importer.ImportType#apply Failed type conversion: unknown extends FC ? K : FC extends undefined | void ? K : never */ js.Any,
    fetchOptions: /* import warning: importer.ImportType#apply Failed type conversion: unknown extends FC ? lru-cache.lru-cache/dist/mjs.LRUCache.FetchOptions<K, V, FC> : FC extends undefined | void ? lru-cache.lru-cache/dist/mjs.LRUCache.FetchOptionsNoContext<K, V, FC> : never */ js.Any
  ): js.Promise[Unit | V] = js.native
