...
import typings.libp2pDelegatedPeerRouting.libp2pDelegatedPeerRoutingStrings.PROVIDER
...
trait ProviderEvent
  ...
  var `type`: typings.libp2pDelegatedPeerRouting.mod.EventTypes.PROVIDER
}
object ProviderEvent {
  
  inline def apply(providers: js.Array[PeerInfo], `type`: typings.libp2pDelegatedPeerRouting.mod.EventTypes.PROVIDER): ProviderEvent = {
  ...
  extension [Self <: ProviderEvent](x: Self) {
    ...
    inline def setType(value: typings.libp2pDelegatedPeerRouting.mod.EventTypes.PROVIDER): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
