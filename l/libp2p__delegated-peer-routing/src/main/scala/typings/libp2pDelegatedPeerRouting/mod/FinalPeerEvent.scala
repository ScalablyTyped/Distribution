...
import typings.libp2pDelegatedPeerRouting.libp2pDelegatedPeerRoutingStrings.FINAL_PEER
...
trait FinalPeerEvent
  ...
  var `type`: typings.libp2pDelegatedPeerRouting.mod.EventTypes.FINAL_PEER
}
object FinalPeerEvent {
  
  inline def apply(peer: PeerInfo, `type`: typings.libp2pDelegatedPeerRouting.mod.EventTypes.FINAL_PEER): FinalPeerEvent = {
  ...
  implicit open class MutableBuilder[Self <: FinalPeerEvent] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.libp2pDelegatedPeerRouting.mod.EventTypes.FINAL_PEER): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
