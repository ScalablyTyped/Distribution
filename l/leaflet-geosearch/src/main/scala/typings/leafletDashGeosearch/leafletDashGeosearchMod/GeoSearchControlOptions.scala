...
import typings.leafletDashGeosearch.Anon_Button
import typings.leafletDashGeosearch.Anon_Query
import typings.leafletDashGeosearch.leafletDashGeosearchStrings.bar
import typings.leafletDashGeosearch.leafletDashGeosearchStrings.button
...
object GeoSearchControlOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(animateZoom)) __obj.updateDynamic("animateZoom")(animateZoom)
    ...
    if (!js.isUndefined(keepResult)) __obj.updateDynamic("keepResult")(keepResult)
    ...
    if (notFoundMessage != null) __obj.updateDynamic("notFoundMessage")(notFoundMessage)
    if (popupFormat != null) __obj.updateDynamic("popupFormat")(js.Any.fromFunction1(popupFormat))
    if (position != null) __obj.updateDynamic("position")(position)
    if (!js.isUndefined(retainZoomLevel)) __obj.updateDynamic("retainZoomLevel")(retainZoomLevel)
    if (searchLabel != null) __obj.updateDynamic("searchLabel")(searchLabel)
