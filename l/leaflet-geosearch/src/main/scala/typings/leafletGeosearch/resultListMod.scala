...
object resultListMod {
  ...
  trait ResultList extends StObject {
    ...
    def render(results: js.Array[SearchResult[Any]], resultFormat: js.Function): Unit = js.native
    def render(results: Unit, resultFormat: js.Function): Unit = js.native
