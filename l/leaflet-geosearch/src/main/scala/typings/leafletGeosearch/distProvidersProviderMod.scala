...
object distProvidersProviderMod {
  
  /* note: abstract class */ @JSImport("leaflet-geosearch/dist/providers/provider", JSImport.Default)
  @js.native
  open class default[TRequestResult, TRawResult] ()
    extends StObject
  ...
  object RequestType extends StObject {
    ...
    sealed trait REVERSE
      extends StObject
         with RequestType
    /* 1 */ val REVERSE: typings.leafletGeosearch.distProvidersProviderMod.RequestType.REVERSE & Double = js.native
    
    @js.native
    sealed trait SEARCH
      extends StObject
         with RequestType
    /* 0 */ val SEARCH: typings.leafletGeosearch.distProvidersProviderMod.RequestType.SEARCH & Double = js.native
  }
