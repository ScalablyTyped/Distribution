...
import typings.leafletGeosearch.resultListMod.default
...
object searchControlMod {
  ...
  trait SearchControl extends StObject {
    ...
    var searchElement: typings.leafletGeosearch.searchElementMod.default = js.native
