...
import typings.libp2pKadDht.libp2pKadDhtStrings.FINAL_PEER
...
trait FinalPeerEvent
  ...
  var `type`: typings.libp2pKadDht.mod.EventTypes.FINAL_PEER
}
object FinalPeerEvent {
  
  inline def apply(from: PeerId, peer: PeerInfo, `type`: typings.libp2pKadDht.mod.EventTypes.FINAL_PEER): FinalPeerEvent = {
  ...
  implicit open class MutableBuilder[Self <: FinalPeerEvent] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.libp2pKadDht.mod.EventTypes.FINAL_PEER): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
