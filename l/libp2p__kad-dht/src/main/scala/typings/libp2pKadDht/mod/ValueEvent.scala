...
import typings.libp2pKadDht.libp2pKadDhtStrings.VALUE
...
trait ValueEvent
  ...
  var `type`: typings.libp2pKadDht.mod.EventTypes.VALUE
  
  var value: js.typedarray.Uint8Array
}
object ValueEvent {
  
  inline def apply(from: PeerId, `type`: typings.libp2pKadDht.mod.EventTypes.VALUE, value: js.typedarray.Uint8Array): ValueEvent = {
  ...
  implicit open class MutableBuilder[Self <: ValueEvent] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.libp2pKadDht.mod.EventTypes.VALUE): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
