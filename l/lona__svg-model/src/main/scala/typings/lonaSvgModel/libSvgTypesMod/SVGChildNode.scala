...
/* Rewritten from type alias, can be one of: 
  - typings.lonaSvgModel.libSvgTypesMod.SVGDefs
  - typings.lonaSvgModel.libSvgTypesMod.SVGMask
  - typings.lonaSvgModel.libSvgTypesMod.SVGGroup
  - typings.lonaSvgModel.libSvgTypesMod.SVGDrawableNode
  - typings.lonaSvgModel.libSvgTypesMod.SVGUnknown
*/
trait SVGChildNode
  extends StObject
     with SVGNode
