...
object lonaSvgModelStrings {
  ...
  @js.native
  sealed trait cubicCurve extends StObject
  inline def cubicCurve: cubicCurve = "cubicCurve".asInstanceOf[cubicCurve]
  ...
  @js.native
  sealed trait quadCurve extends StObject
  inline def quadCurve: quadCurve = "quadCurve".asInstanceOf[quadCurve]
