...
/* Rewritten from type alias, can be one of: 
  - typings.lonaSvgModel.svgTypesMod.SVGRoot
  - typings.lonaSvgModel.svgTypesMod.SVGChildNode
*/
...
object SVGNode {
  ...
  inline def SVGRoot(attributes: SVGRootAttributes, children: js.Array[SVGChildNode | SVGDefs]): typings.lonaSvgModel.svgTypesMod.SVGRoot = {
    val __obj = js.Dynamic.literal(attributes = attributes.asInstanceOf[js.Any], children = children.asInstanceOf[js.Any], name = "svg")
    __obj.updateDynamic("type")("element")
    __obj.asInstanceOf[typings.lonaSvgModel.svgTypesMod.SVGRoot]
  }
