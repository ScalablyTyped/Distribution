...
object ipPortToMultiaddrMod {
  
  @JSImport("@libp2p/utils/ip-port-to-multiaddr", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object Errors {
    
    @JSImport("@libp2p/utils/ip-port-to-multiaddr", "Errors")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@libp2p/utils/ip-port-to-multiaddr", "Errors.ERR_INVALID_IP")
    @js.native
    ...
    @JSImport("@libp2p/utils/ip-port-to-multiaddr", "Errors.ERR_INVALID_IP_PARAMETER")
    @js.native
    ...
    @JSImport("@libp2p/utils/ip-port-to-multiaddr", "Errors.ERR_INVALID_PORT_PARAMETER")
    @js.native
