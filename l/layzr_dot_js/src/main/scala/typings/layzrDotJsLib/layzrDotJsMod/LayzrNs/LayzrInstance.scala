...
trait LayzrInstance extends js.Object {
  ...
  /**
           ...
           * @param flag
           */
  def handlers(flag: scala.Boolean): LayzrInstance = js.native
  /**
  ...
  /**
           ...
           * @param handler Event handler
           */
  def on(name: LayzrEvents, handler: js.Function1[/* element */ stdLib.HTMLElement, scala.Unit]): LayzrInstance = js.native
  /**
           ...
           * @param handler Event handler
           */
  def once(name: LayzrEvents, handler: js.Function1[/* element */ stdLib.HTMLElement, scala.Unit]): LayzrInstance = js.native
  /**
