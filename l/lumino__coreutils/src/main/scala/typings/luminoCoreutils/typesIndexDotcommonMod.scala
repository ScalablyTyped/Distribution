...
object typesIndexDotcommonMod {
  ...
  @js.native
  open class MimeData ()
    extends typings.luminoCoreutils.typesMimeMod.MimeData
  ...
  open class PromiseDelegate[T] ()
    extends typings.luminoCoreutils.typesPromiseMod.PromiseDelegate[T]
  
  @JSImport("@lumino/coreutils/types/index.common", "Token")
  @js.native
  open class Token[T] protected ()
    extends typings.luminoCoreutils.typesTokenMod.Token[T] {
    /**
