...
object typesIndexDotnodeMod {
  
  object JSONExt {
    
    @JSImport("@lumino/coreutils/types/index.node", "JSONExt")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@lumino/coreutils/types/index.node", "JSONExt.emptyArray")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@lumino/coreutils/types/index.node", "JSONExt.emptyObject")
    @js.native
  ...
  @JSImport("@lumino/coreutils/types/index.node", "MimeData")
  @js.native
  open class MimeData ()
    extends typings.luminoCoreutils.typesIndexDotcommonMod.MimeData
  
  @JSImport("@lumino/coreutils/types/index.node", "PromiseDelegate")
  @js.native
  /**
  ...
  object Random {
    ...
    @JSImport("@lumino/coreutils/types/index.node", "Random")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport("@lumino/coreutils/types/index.node", "Token")
  @js.native
  ...
  object UUID {
    ...
    @JSImport("@lumino/coreutils/types/index.node", "UUID")
    @js.native
    val ^ : js.Any = js.native
