...
trait SequenceBaser[T] extends js.Object {
  ...
  def async(interval: scala.Double): AsyncSequence[T] = js.native
  def chunk(size: scala.Double): Sequence[T] = js.native
  def compact(): Sequence[T] = js.native
  def concat(var_args: js.Array[T]): Sequence[T] = js.native
  def consecutive(length: scala.Double): Sequence[T] = js.native
  def contains(value: T): scala.Boolean = js.native
  def countBy(keyFn: GetKeyCallback[T]): ObjectLikeSequence[T] = js.native
  def countBy(propertyName: java.lang.String): ObjectLikeSequence[T] = js.native
  def dropWhile(predicateFn: TestCallback[T, java.lang.String | scala.Double]): Sequence[T] = js.native
  def every(predicateFn: TestCallback[T, java.lang.String | scala.Double]): scala.Boolean = js.native
  def filter(predicateFn: TestCallback[T, java.lang.String | scala.Double]): Sequence[T] = js.native
  def find(predicateFn: TestCallback[T, java.lang.String | scala.Double]): T = js.native
  ...
  def initial(count: scala.Double): Sequence[T] = js.native
  def intersection(var_args: js.Array[T]): Sequence[T] = js.native
  def invoke(methodName: java.lang.String): Sequence[T] = js.native
  ...
  def none(): scala.Boolean = js.native
  def none(valueFn: TestCallback[T, java.lang.String | scala.Double]): scala.Boolean = js.native
  def pluck(propertyName: java.lang.String): Sequence[_] = js.native
  ...
  def reject(predicateFn: TestCallback[T, java.lang.String | scala.Double]): Sequence[T] = js.native
  def rest(): Sequence[T] = js.native
  def rest(count: scala.Double): Sequence[T] = js.native
  def shuffle(): Sequence[T] = js.native
  def size(): scala.Double = js.native
  def some(): scala.Boolean = js.native
  def some(predicateFn: TestCallback[T, java.lang.String | scala.Double]): scala.Boolean = js.native
  def sort(): Sequence[T] = js.native
  def sort(sortFn: CompareCallback): Sequence[T] = js.native
  def sort(sortFn: CompareCallback, descending: scala.Boolean): Sequence[T] = js.native
  def sortBy(sortFn: java.lang.String): Sequence[T] = js.native
  def sortBy(sortFn: java.lang.String, descending: scala.Boolean): Sequence[T] = js.native
  def sortBy(sortFn: NumberCallback[T]): Sequence[T] = js.native
  def sortBy(sortFn: NumberCallback[T], descending: scala.Boolean): Sequence[T] = js.native
  def sortedIndex(value: T): scala.Double = js.native
  def sum(): T = js.native
  def sum(valueFn: NumberCallback[T]): T = js.native
  def takeWhile(predicateFn: TestCallback[T, java.lang.String | scala.Double]): Sequence[T] = js.native
  def toArray(): js.Array[T] = js.native
  def toObject(): js.Any = js.native
  def union(var_args: js.Array[T]): Sequence[T] = js.native
  def uniq(): Sequence[T] = js.native
  def uniq(key: java.lang.String): Sequence[T] = js.native
