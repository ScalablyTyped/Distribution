...
package object LazyJS {
  ...
  type Flatten[T, Shallow /* <: scala.Boolean */] = (/* import warning: importer.ImportType#apply Failed type conversion: lazy.js.Anon_0<T>[T extends lazy.js.LazyJS.Sequence<any> ? 0 : 1] */ js.Any) | T
