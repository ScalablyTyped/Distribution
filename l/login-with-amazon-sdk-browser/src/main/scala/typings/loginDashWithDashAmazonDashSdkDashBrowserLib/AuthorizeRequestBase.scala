...
trait AuthorizeRequestBase[T /* <: AuthorizeRequest */] extends js.Object {
  ...
  /**
    ...
    */
  var error_description: js.UndefOr[java.lang.String] = js.native
  /**
    * A URI for a web page with more information on the error.
    */
  var error_uri: js.UndefOr[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  def onComplete(next: java.lang.String): scala.Unit = js.native
  def onComplete(next: NextCallback[T]): scala.Unit = js.native
}
