...
class LambdaLog ()
  ...
  def assert(test: js.Any, msg: java.lang.String): scala.Boolean | LogMessage = js.native
  def assert(test: js.Any, msg: java.lang.String, meta: js.Object): scala.Boolean | LogMessage = js.native
  def assert(test: js.Any, msg: java.lang.String, meta: js.Object, tags: js.Array[java.lang.String]): scala.Boolean | LogMessage = js.native
