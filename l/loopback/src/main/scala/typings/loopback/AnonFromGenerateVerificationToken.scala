...
trait AnonFromGenerateVerificationToken extends js.Object {
  var from: String
  var redirect: String
  var subject: String
  var template: String
...
object AnonFromGenerateVerificationToken {
  @scala.inline
  def apply(
    from: String,
    ...
    to: String,
    `type`: String
  ): AnonFromGenerateVerificationToken = {
    ...
    __obj.asInstanceOf[AnonFromGenerateVerificationToken]
  }
}
