...
import typings.loopback.Anon_DataSource
import typings.loopback.Anon_Enabled
...
trait LoopBackApplication
  ...
  /**
    ...
    */
  def middlewareFromConfig(factory: js.Function0[Unit], config: Anon_Enabled): js.Any = js.native
  def model(Model: String, config: Anon_DataSource): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def model(Model: js.Any, config: Anon_DataSource): js.Any = js.native
  /**
