...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def favicon(): RequestHandler = js.native
  /**
    ...
    */
  def rest(): RequestHandler = js.native
  /**
    * Rewrite the url to replace current user literal with the logged in user id
    */
  def rewriteUserLiteral(): RequestHandler = js.native
  /**
    ...
    */
  def static(root: String): RequestHandler = js.native
  def static(root: String, options: js.Any): RequestHandler = js.native
  /**
    ...
    * ```
    */
  def status(): RequestHandler = js.native
  /**
    ...
    */
  def token(): RequestHandler = js.native
  def token(options: Anon_Cookies): RequestHandler = js.native
  /**
    ...
    */
  def urlNotFound(): RequestHandler = js.native
}
