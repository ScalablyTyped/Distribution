...
import typings.loopback.Anon_AccessType
import typings.loopback.Anon_Acls
...
class ACL () extends PersistedModel {
  ...
  @JSName("settings")
  var settings_ACL: Anon_Acls = js.native
  /**
...
object ACL extends js.Object {
  /**
    ...
    */
  def checkAccessForContext(context: Anon_AccessType, callback: js.Function0[Unit]): Unit = js.native
  /**
