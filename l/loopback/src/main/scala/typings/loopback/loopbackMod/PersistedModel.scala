...
import typings.loopback.Anon_Conflicts
import typings.loopback.Anon_Created
import typings.loopback.Anon_Fields
import typings.loopback.Anon_FieldsInclude
import typings.loopback.Anon_FieldsIncludeOrder
import typings.loopback.Anon_Info
import typings.loopback.Anon_Throws
import typings.loopback.Anon_Validate
import typings.loopback.Anon_Where
...
class PersistedModel () extends Model {
  ...
  def replaceAttributes[T](data: js.Any, options: Anon_Validate): js.Promise[T] = js.native
  /**
    * Replace attributes for a model instance and persist it into the datasource.
    * Performs validation before replacing
    * @param {any} data Data to replace.
    ...
    * @param {any} instance Replaced instance
    */
  def replaceAttributes[T](data: js.Any, options: Anon_Validate, callback: CallbackWithResult[T]): Unit = js.native
  /**
  ...
  def save[T](options: Anon_Throws): js.Promise[T] = js.native
  /**
    * Save model instance. If the instance doesn't have an ID, then calls [create](#persistedmodelcreatedata-cb) instead.
    * Triggers: validate, save, update, or create.
    * @options {any} [options] See below.
    ...
    * @param {any} instance Model instance saved or created
    */
  def save[T](options: Anon_Throws, callback: CallbackWithResult[T]): Unit = js.native
  /**
...
object PersistedModel extends js.Object {
  ...
  /**
    ...
    */
  @JSName("checkpoint")
  def checkpoint_Unit(): Unit = js.native
  /**
  ...
  /**
    ...
    * @returns {any} changes
    */
  def createChangeStream(options: Anon_Where): js.Promise[_] = js.native
  /**
    * Create a change stream. See here for more info http://loopback.io/doc/en/lb2/Realtime-server-sent-events.html
    * @param {any} options Only changes to models matching this where filter will be included in the ChangeStream.
    * @param {() => void} callback
    */
  def createChangeStream(options: Anon_Where, callback: CallbackWithResult[_]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def destroyAll(): js.Promise[Anon_Info] = js.native
  def destroyAll(where: js.Any): js.Promise[Anon_Info] = js.native
  /**
    * Destroy all model instances that match the optional `where` specification
    * @param {any} [where] Optional where filter, like:
    * ```
  ...
  def find[T](filter: Anon_Fields): js.Promise[js.Array[T] | Null] = js.native
  /**
    * Find all model instances that match `filter` specification.
    * See [Querying models](docs.strongloop.com/display/LB/Querying+models)
    * @options {any} [filter] Optional Filter JSON object; see below.
    ...
    */
  def find[T](filter: Anon_Fields, callback: CallbackWithResult[js.Array[T]]): Unit = js.native
  /**
  ...
  def findById[T](id: js.Any, filter: Anon_FieldsInclude): js.Promise[T | Null] = js.native
  /**
    * Find object by ID with an optional filter for include/fields
    * @param {*} id Primary key value
    * @options {any} [filter] Optional Filter JSON object; see below.
    ...
    * @param {any} instance Model instance matching the specified ID or null if no instance matches
    */
  def findById[T](id: js.Any, filter: Anon_FieldsInclude, callback: CallbackWithResult[T]): Unit = js.native
  /**
  ...
  def findOne[T](filter: Anon_FieldsIncludeOrder): js.Promise[T | Null] = js.native
  /**
    * Find one model instance that matches `filter` specification.
    * Same as `find`, but limited to one result;
    * Returns object, not collection
    ...
    * @param {Array} model First model instance that matches the filter or null if none found
    */
  def findOne[T](filter: Anon_FieldsIncludeOrder, callback: CallbackWithResult[T]): Unit = js.native
  /**
    ...
    */
  def findOrCreate[T](data: js.Any): js.Promise[Anon_Created[T] | Null] = js.native
  /**
    * Finds one record matching the optional filter object. If not found, creates
    * the object using the data provided as second argument. In this sense it is
    * the same as `find`, but limited to one object. Returns an object, not
  ...
  def findOrCreate[T](data: js.Any, filter: Anon_Fields): js.Promise[Anon_Created[T] | Null] = js.native
  /**
    * Finds one record matching the optional filter object. If not found, creates
    * the object using the data provided as second argument. In this sense it is
    * the same as `find`, but limited to one object. Returns an object, not
    ...
    * @param {boolean} created True if the instance matching the `where` filter was created
    */
  def findOrCreate[T](data: js.Any, filter: Anon_Fields, callback: CallbackWithMultipleResults[T, Boolean]): Unit = js.native
  /**
  ...
  def replaceById[T](id: js.Any, data: js.Any, options: Anon_Validate): js.Promise[T] = js.native
  /**
    * Replace attributes for a model instance whose id is the first input
    * argument and persist it into the datasource.
    * Performs validation before replacing
    ...
    * @param {any} instance Replaced instance
    */
  def replaceById[T](id: js.Any, data: js.Any, options: Anon_Validate, callback: CallbackWithResult[T]): Unit = js.native
  /**
  ...
  def replaceOrCreate[T](data: js.Any, options: Anon_Validate): js.Promise[T] = js.native
  /**
    * Replace or insert a model instance; replace existing record if one is found,
    * such that parameter `data.id` matches `id` of model instance; otherwise,
    * insert a new record.
    ...
    * @param {any} model Replaced model instance.
    */
  def replaceOrCreate[T](data: js.Any, options: Anon_Validate, callback: CallbackWithResult[T]): Unit = js.native
  /**
    ...
    */
  def replicate(): js.Promise[Anon_Conflicts] | Unit = js.native
  def replicate(since: Double): js.Promise[Anon_Conflicts] | Unit = js.native
  def replicate(since: Double, targetModel: Model): js.Promise[Anon_Conflicts] | Unit = js.native
  def replicate(since: Double, targetModel: Model, options: js.Any): js.Promise[Anon_Conflicts] | Unit = js.native
  def replicate(since: Double, targetModel: Model, options: js.Any, optionsFilter: js.Any): js.Promise[Anon_Conflicts] | Unit = js.native
  def replicate(
    since: Double,
    targetModel: Model,
    options: js.Any,
  ...
  ): js.Promise[Anon_Conflicts] | Unit = js.native
  /**
