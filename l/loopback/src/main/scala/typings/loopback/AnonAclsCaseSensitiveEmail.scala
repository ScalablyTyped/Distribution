...
trait AnonAclsCaseSensitiveEmail extends js.Object {
...
object AnonAclsCaseSensitiveEmail {
  @scala.inline
  def apply(
    acls: js.Array[ACL],
    ...
    __obj.asInstanceOf[AnonAclsCaseSensitiveEmail]
  }
}
