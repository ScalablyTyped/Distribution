...
trait AnonAclsHashAlgorithm extends js.Object {
...
object AnonAclsHashAlgorithm {
  @scala.inline
  def apply(acls: js.Array[ACL], hashAlgorithm: String, http: AnonPath, ignoreErrors: Boolean): AnonAclsHashAlgorithm = {
    ...
    __obj.asInstanceOf[AnonAclsHashAlgorithm]
  }
}
