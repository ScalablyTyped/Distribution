...
class Registry () extends js.Object {
  /**
    ...
    */
  def configureModel(ModelCtor: Model, config: loopbackLib.Anon_DataSourceRelations): scala.Unit = js.native
  /**
...
object Registry extends js.Object {
  def addACL(acls: js.Array[_], acl: js.Any): scala.Unit = js.native
}
