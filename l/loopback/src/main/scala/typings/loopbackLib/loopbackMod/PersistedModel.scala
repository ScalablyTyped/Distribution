...
object PersistedModel extends js.Object {
  ...
  /**
    ...
    * @param  {() => void} callback Callback function
    */
  def bulkUpdate(updates: js.Array[_], options: js.Any, callback: loopbackLib.loopbackMod.CallbackWithoutResult): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param {Array} changes An Array of [Change](#change) objects
    */
  def changes(since: scala.Double, filter: js.Any, callback: loopbackLib.loopbackMod.CallbackWithResult[_]): scala.Unit = js.native
  /**
    * Create a checkpoint
    */
  ...
  /**
    ...
    * @param {number} count number of instances updated
    */
  def count(where: js.Any, callback: loopbackLib.loopbackMod.CallbackWithResult[scala.Double]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def create[T](data: js.Any, callback: loopbackLib.loopbackMod.CallbackWithResult[T | js.Array[T] | scala.Null]): scala.Unit = js.native
  def create[T](data: js.Array[_]): js.Promise[T | js.Array[T] | scala.Null] = js.native
  def create[T](
    data: js.Array[_],
    callback: loopbackLib.loopbackMod.CallbackWithResult[T | js.Array[T] | scala.Null]
  ...
  /**
    ...
    * @param {() => void} callback
    */
  def createChangeStream(options: loopbackLib.Anon_Where, callback: loopbackLib.loopbackMod.CallbackWithResult[_]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param  {() => void} callback
    */
  def createUpdates(deltas: js.Array[_], callback: loopbackLib.loopbackMod.CallbackWithoutResult): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def currentCheckpoint(callback: loopbackLib.loopbackMod.CallbackWithResult[scala.Double]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def destroyAll(where: js.Any, callback: loopbackLib.loopbackMod.CallbackWithMultipleResults[_, scala.Double]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param {Error} err Error object; see [Error object](docs.strongloop.com/display/LB/Error+object)
    */
  def destroyById(id: js.Any, callback: loopbackLib.loopbackMod.CallbackWithoutResult): scala.Unit = js.native
  /**
  ...
  def diff(
    ...
    callback: loopbackLib.loopbackMod.CallbackWithResult[_]
  ): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def exists(id: js.Any, callback: loopbackLib.loopbackMod.CallbackWithResult[scala.Boolean]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def find[T](filter: loopbackLib.Anon_Fields, callback: loopbackLib.loopbackMod.CallbackWithResult[js.Array[T]]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def findById[T](id: js.Any, callback: loopbackLib.loopbackMod.CallbackWithResult[T]): scala.Unit = js.native
  ...
  def findById[T](
    ...
    callback: loopbackLib.loopbackMod.CallbackWithResult[T]
  ): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def findOne[T](callback: loopbackLib.loopbackMod.CallbackWithResult[T]): scala.Unit = js.native
  ...
  /**
    ...
    */
  def findOrCreate[T](data: js.Any, callback: loopbackLib.loopbackMod.CallbackWithMultipleResults[T, scala.Boolean]): scala.Unit = js.native
  ...
  def findOrCreate[T](
    ...
    callback: loopbackLib.loopbackMod.CallbackWithMultipleResults[T, scala.Boolean]
  ): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getSourceId(callback: loopbackLib.loopbackMod.CallbackWithResult[java.lang.String]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param {Error} er
    */
  def rectifyChange(id: js.Any, callback: loopbackLib.loopbackMod.CallbackWithoutResult): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param {any} instance Replaced instance
    */
  def replaceById[T](id: js.Any, data: js.Any, callback: loopbackLib.loopbackMod.CallbackWithResult[T]): scala.Unit = js.native
  ...
  /**
    ...
    */
  def replaceOrCreate[T](data: js.Any, callback: loopbackLib.loopbackMod.CallbackWithResult[T]): scala.Unit = js.native
  ...
  def replicate(since: scala.Double, targetModel: loopbackLib.loopbackMod.Model): js.Promise[loopbackLib.Anon_Conflicts] | scala.Unit = js.native
  def replicate(since: scala.Double, targetModel: loopbackLib.loopbackMod.Model, options: js.Any): js.Promise[loopbackLib.Anon_Conflicts] | scala.Unit = js.native
  def replicate(
    since: scala.Double,
    targetModel: loopbackLib.loopbackMod.Model,
    options: js.Any,
  ...
  def replicate(
    ...
    callback: js.Function3[
      /* err */ stdLib.Error, 
      /* conflicts */ js.Array[loopbackLib.loopbackMod.Conflict], 
      /* param */ js.Any, 
      scala.Unit
    ]
  ): js.Promise[loopbackLib.Anon_Conflicts] | scala.Unit = js.native
  ...
  /**
    ...
    *
    */
  def updateAll(callback: loopbackLib.loopbackMod.CallbackWithMultipleResults[_, scala.Double]): scala.Unit = js.native
  /**
    * Update multiple instances that match the where clause.
    *
    * Example:
  ...
  def updateAll(
    whereOrData: js.Any,
    callback: loopbackLib.loopbackMod.CallbackWithMultipleResults[_, scala.Double]
  ): scala.Unit = js.native
  ...
  /**
    ...
    * @param {any} model Updated model instance
    */
  def upsert[T](data: js.Any, callback: loopbackLib.loopbackMod.CallbackWithResult[T]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param {any} model Updated model instance
    */
  def upsertWithWhere[T](data: js.Any, callback: loopbackLib.loopbackMod.CallbackWithResult[T]): scala.Unit = js.native
}
