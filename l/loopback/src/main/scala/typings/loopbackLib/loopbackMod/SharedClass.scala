...
class SharedClass protected () extends js.Object {
  ...
  /**
    ...
    */
  def defineMethod(name: java.lang.String, options: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def disableMethod(fn: java.lang.String, isStatic: scala.Boolean): scala.Unit = js.native
  /**
    * Disable a sharedMethod with the given static or prototype method name.
    * @param {string} methodName	The method name
    */
  def disableMethodByName(methodName: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def find(fn: js.Function0[scala.Unit | java.lang.String], isStatic: scala.Boolean): js.Any = js.native
  /**
    ...
    */
  def findMethodByName(methodName: java.lang.String): js.Any = js.native
  /**
    * Get a key for the given method.
    * @param {string} fn The function or method name
    * @param {boolean} isStatic Disable a static or prototype method
    */
  def getKeyFromMethodNameAndTarget(fn: java.lang.String, isStatic: scala.Boolean): scala.Unit = js.native
  /**
    * Get all shared methods belonging to this shared class.
    * @param {any} options
    * @return {any[]} An array of shared methods SharedMethod[]
    */
  def methods(options: loopbackLib.Anon_IncludeDisabled): js.Array[_] = js.native
  /**
    ...
    */
  def resolve(resolver: js.Function0[scala.Unit]): scala.Unit = js.native
}
