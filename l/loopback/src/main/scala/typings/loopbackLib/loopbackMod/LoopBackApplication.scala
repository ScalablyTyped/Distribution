...
trait LoopBackApplication
  ...
  def model(Model: java.lang.String, config: loopbackLib.Anon_DataSource): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def model(Model: js.Any, config: loopbackLib.Anon_DataSource): js.Any = js.native
  /**
