...
object Control {
  ...
  open class Draw () extends Control_ {
    ...
    def initialize(options: typings.leafletDraw.leafletMod.Control.DrawOptions): Unit = js.native
    
    def setDrawingOptions(): Unit = js.native
    def setDrawingOptions(options: typings.leafletDraw.leafletMod.Control.DrawOptions): Unit = js.native
  }
  ...
  trait DrawConstructorOptions extends StObject {
    ...
    /**
      ...
      * @default {}
      */
    var draw: js.UndefOr[typings.leafletDraw.leafletMod.Control.DrawOptions] = js.undefined
    ...
    /**
      ...
      * @default false
      */
    var edit: js.UndefOr[typings.leafletDraw.leafletMod.Control.EditOptions] = js.undefined
  ...
  object DrawConstructorOptions {
    ...
    extension [Self <: DrawConstructorOptions](x: Self) {
      ...
      inline def setEdit(value: typings.leafletDraw.leafletMod.Control.EditOptions): Self = StObject.set(x, "edit", value.asInstanceOf[js.Any])
  ...
  object DrawOptions {
    ...
    inline def apply(): typings.leafletDraw.leafletMod.Control.DrawOptions = {
      val __obj = js.Dynamic.literal()
  ...
  object EditOptions {
    ...
    inline def apply(featureGroup: FeatureGroup_[Any]): typings.leafletDraw.leafletMod.Control.EditOptions = {
