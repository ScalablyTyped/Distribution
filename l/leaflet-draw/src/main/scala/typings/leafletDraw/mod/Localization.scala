...
object Localization {
  ...
  object Draw {
    ...
    inline def apply(handlers: DrawHandlers, toolbar: typings.leafletDraw.mod.Localization.DrawToolbar): typings.leafletDraw.mod.Localization.Draw = {
    ...
    extension [Self <: typings.leafletDraw.mod.Localization.Draw](x: Self) {
      
      inline def setHandlers(value: DrawHandlers): Self = StObject.set(x, "handlers", value.asInstanceOf[js.Any])
      
      inline def setToolbar(value: typings.leafletDraw.mod.Localization.DrawToolbar): Self = StObject.set(x, "toolbar", value.asInstanceOf[js.Any])
    }
  }
  ...
  object DrawLocal {
    ...
    inline def apply(draw: typings.leafletDraw.mod.Localization.Draw, edit: typings.leafletDraw.mod.Localization.Edit): DrawLocal = {
    ...
    extension [Self <: DrawLocal](x: Self) {
      ...
      inline def setDraw(value: typings.leafletDraw.mod.Localization.Draw): Self = StObject.set(x, "draw", value.asInstanceOf[js.Any])
      
      inline def setEdit(value: typings.leafletDraw.mod.Localization.Edit): Self = StObject.set(x, "edit", value.asInstanceOf[js.Any])
    }
  }
  ...
  object DrawToolbar {
    ...
    inline def apply(actions: Action, buttons: Circle, finish: Action, undo: Action): typings.leafletDraw.mod.Localization.DrawToolbar = {
    ...
    extension [Self <: typings.leafletDraw.mod.Localization.DrawToolbar](x: Self) {
  ...
  object Edit {
    ...
    inline def apply(handlers: EditHandlers, toolbar: typings.leafletDraw.mod.Localization.EditToolbar): typings.leafletDraw.mod.Localization.Edit = {
      val __obj = js.Dynamic.literal(handlers = handlers.asInstanceOf[js.Any], toolbar = toolbar.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.leafletDraw.mod.Localization.Edit]
    }
    
    extension [Self <: typings.leafletDraw.mod.Localization.Edit](x: Self) {
      
      inline def setHandlers(value: EditHandlers): Self = StObject.set(x, "handlers", value.asInstanceOf[js.Any])
      
      inline def setToolbar(value: typings.leafletDraw.mod.Localization.EditToolbar): Self = StObject.set(x, "toolbar", value.asInstanceOf[js.Any])
    }
  }
  ...
  object EditToolbar {
    ...
    inline def apply(actions: Cancel, buttons: typings.leafletDraw.anon.Edit): typings.leafletDraw.mod.Localization.EditToolbar = {
    ...
    extension [Self <: typings.leafletDraw.mod.Localization.EditToolbar](x: Self) {
