...
object Expression {
  ...
  inline def BooleanLiteral(raw: String, value: Boolean): typings.luaparse.astMod.BooleanLiteral = {
    val __obj = js.Dynamic.literal(raw = raw.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("BooleanLiteral")
    __obj.asInstanceOf[typings.luaparse.astMod.BooleanLiteral]
  }
  
  inline def CallExpression(arguments: js.Array[Expression], base: Expression): typings.luaparse.astMod.CallExpression = {
  ...
  inline def FunctionDeclaration(body: js.Array[Statement], isLocal: Boolean, parameters: js.Array[Identifier | VarargLiteral]): typings.luaparse.astMod.FunctionDeclaration = {
  ...
  inline def Identifier(name: String): typings.luaparse.astMod.Identifier = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("Identifier")
    __obj.asInstanceOf[typings.luaparse.astMod.Identifier]
  }
  
  inline def IndexExpression(base: Expression, index: Expression): typings.luaparse.astMod.IndexExpression = {
  ...
  inline def LogicalExpression(left: Expression, operator: or | and, right: Expression): typings.luaparse.astMod.LogicalExpression = {
    val __obj = js.Dynamic.literal(left = left.asInstanceOf[js.Any], operator = operator.asInstanceOf[js.Any], right = right.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("LogicalExpression")
    __obj.asInstanceOf[typings.luaparse.astMod.LogicalExpression]
  }
  
  inline def MemberExpression(base: Expression, identifier: Identifier, indexer: Dot | Colon): typings.luaparse.astMod.MemberExpression = {
  ...
  inline def NilLiteral(raw: String, value: Null): typings.luaparse.astMod.NilLiteral = {
    val __obj = js.Dynamic.literal(raw = raw.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("NilLiteral")
    __obj.asInstanceOf[typings.luaparse.astMod.NilLiteral]
  }
  
  inline def NumericLiteral(raw: String, value: Double): typings.luaparse.astMod.NumericLiteral = {
    val __obj = js.Dynamic.literal(raw = raw.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("NumericLiteral")
    __obj.asInstanceOf[typings.luaparse.astMod.NumericLiteral]
  }
  
  inline def StringCallExpression(argument: Expression, base: Expression): typings.luaparse.astMod.StringCallExpression = {
  ...
  inline def StringLiteral(raw: String, value: String): typings.luaparse.astMod.StringLiteral = {
    val __obj = js.Dynamic.literal(raw = raw.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("StringLiteral")
    __obj.asInstanceOf[typings.luaparse.astMod.StringLiteral]
  }
  
  inline def TableCallExpression(arguments: Expression, base: Expression): typings.luaparse.astMod.TableCallExpression = {
    val __obj = js.Dynamic.literal(arguments = arguments.asInstanceOf[js.Any], base = base.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("TableCallExpression")
    __obj.asInstanceOf[typings.luaparse.astMod.TableCallExpression]
  }
  
  inline def TableConstructorExpression(fields: js.Array[TableKey | TableKeyString | TableValue]): typings.luaparse.astMod.TableConstructorExpression = {
  ...
  inline def UnaryExpression(argument: Expression, operator: not | `-_` | Tilde | Numbersign): typings.luaparse.astMod.UnaryExpression = {
  ...
  inline def VarargLiteral(raw: String, value: String): typings.luaparse.astMod.VarargLiteral = {
    val __obj = js.Dynamic.literal(raw = raw.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
