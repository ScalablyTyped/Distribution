...
object HastNode {
  ...
  inline def Comment(value: String): typings.lowlight.lowlight.AST.Comment = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("comment")
    __obj.asInstanceOf[typings.lowlight.lowlight.AST.Comment]
  }
  
  inline def Doctype(name: String): typings.lowlight.lowlight.AST.Doctype = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("doctype")
    __obj.asInstanceOf[typings.lowlight.lowlight.AST.Doctype]
  }
  
  inline def Element(children: js.Array[Node], properties: Properties, tagName: String): typings.lowlight.lowlight.AST.Element = {
  ...
  inline def Root(children: js.Array[Node]): typings.lowlight.lowlight.AST.Root = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("root")
    __obj.asInstanceOf[typings.lowlight.lowlight.AST.Root]
  }
  
  inline def Text(`type`: String, value: String): typings.lowlight.lowlight.AST.Text = {
    val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
