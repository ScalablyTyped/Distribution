...
import typings.libphonenumberJs.sourceAsYouTypeFormatterDotPatternParserMod.character
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceAsYouTypeFormatterDotPatternMatcherMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultOverflow
    - typings.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultFullMatch
    - typings.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultPartialMatch
    - typings.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultNoMatch
  */
  ...
  object _MatchResult {
    ...
    inline def MatchResultFullMatch(matchedChars: js.Array[character]): typings.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultFullMatch = {
      val __obj = js.Dynamic.literal(matchedChars = matchedChars.asInstanceOf[js.Any])
      __obj.updateDynamic("match")(true)
      __obj.asInstanceOf[typings.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultFullMatch]
    }
    
    inline def MatchResultOverflow(): typings.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultOverflow = {
      val __obj = js.Dynamic.literal(overflow = true)
      __obj.asInstanceOf[typings.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultOverflow]
    }
    
    inline def MatchResultPartialMatch(): typings.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultPartialMatch = {
      val __obj = js.Dynamic.literal(partialMatch = true)
      __obj.asInstanceOf[typings.libphonenumberJs.sourceAsYouTypeFormatterDotPatternMatcherMod.MatchResultPartialMatch]
    }
  }
}
