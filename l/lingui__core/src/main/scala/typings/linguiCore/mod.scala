...
object mod {
  ...
  @scala.inline
  def setupI18n(): typings.linguiCore.i18nMod.I18n_ = ^.asInstanceOf[js.Dynamic].applyDynamic("setupI18n")().asInstanceOf[typings.linguiCore.i18nMod.I18n_]
  @scala.inline
  def setupI18n(params: setupI18nProps): typings.linguiCore.i18nMod.I18n_ = ^.asInstanceOf[js.Dynamic].applyDynamic("setupI18n")(params.asInstanceOf[js.Any]).asInstanceOf[typings.linguiCore.i18nMod.I18n_]
}
