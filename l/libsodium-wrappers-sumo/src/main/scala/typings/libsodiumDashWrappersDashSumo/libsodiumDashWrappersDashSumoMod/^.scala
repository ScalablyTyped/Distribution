package typings.libsodiumDashWrappersDashSumo.libsodiumDashWrappersDashSumoMod
...
object ^ extends js.Object {
  ...
  def from_base64(input: String, variant: typings.libsodiumDashWrappers.libsodiumDashWrappersMod.base64_variants): Uint8Array = js.native
  ...
  def to_base64(input: String, variant: typings.libsodiumDashWrappers.libsodiumDashWrappersMod.base64_variants): String = js.native
  def to_base64(input: Uint8Array): String = js.native
  def to_base64(input: Uint8Array, variant: typings.libsodiumDashWrappers.libsodiumDashWrappersMod.base64_variants): String = js.native
