...
object cryptoCoreRistretto255FromHash extends js.Object {
  def apply(r: Uint8Array): Uint8Array = js.native
  def apply(r: Uint8Array, outputFormat: StringOutputFormat): String = js.native
  def apply(r: Uint8Array, outputFormat: Uint8ArrayOutputFormat): Uint8Array = js.native
}
