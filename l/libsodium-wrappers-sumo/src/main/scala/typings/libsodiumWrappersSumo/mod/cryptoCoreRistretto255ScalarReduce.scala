...
object cryptoCoreRistretto255ScalarReduce extends js.Object {
  def apply(secret: String): Uint8Array = js.native
  def apply(secret: String, outputFormat: StringOutputFormat): String = js.native
  def apply(secret: String, outputFormat: Uint8ArrayOutputFormat): Uint8Array = js.native
  def apply(secret: Uint8Array): Uint8Array = js.native
  def apply(secret: Uint8Array, outputFormat: StringOutputFormat): String = js.native
  def apply(secret: Uint8Array, outputFormat: Uint8ArrayOutputFormat): Uint8Array = js.native
}
