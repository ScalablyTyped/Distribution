...
object cryptoPwhashScryptsalsa208sha256 extends js.Object {
  def apply(keyLength: Double, password: String, salt: Uint8Array, opsLimit: Double, memLimit: Double): Uint8Array = js.native
  def apply(
    keyLength: Double,
    password: String,
    salt: Uint8Array,
  ...
  def apply(keyLength: Double, password: Uint8Array, salt: Uint8Array, opsLimit: Double, memLimit: Double): Uint8Array = js.native
  def apply(
    keyLength: Double,
    password: Uint8Array,
    salt: Uint8Array,
