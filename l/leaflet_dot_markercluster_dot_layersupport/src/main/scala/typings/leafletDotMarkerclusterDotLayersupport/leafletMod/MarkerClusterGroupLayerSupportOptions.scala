...
- Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify MarkerClusterGroupOptions * / any */ trait MarkerClusterGroupLayerSupportOptions extends js.Object {
  /**
