...
object loudDashRejectionMod extends js.Object {
  ...
  @JSName("default")
  var default_Original: loudDashRejectionLib.Anon_Default = js.native
  /**
  ...
  def apply(log: js.Function1[/* stack */ java.lang.String, scala.Unit]): scala.Unit = js.native
  /**
  	Make unhandled promise rejections fail loudly instead of the default [silent fail](https://gist.github.com/benjamingr/0237932cee84712951a2).
  	@param log - Custom logging function to print the rejected promise. Receives the error stack. Default: `console.error`.
  	@example
  ...
  def default(log: js.Function1[/* stack */ java.lang.String, scala.Unit]): scala.Unit = js.native
}
