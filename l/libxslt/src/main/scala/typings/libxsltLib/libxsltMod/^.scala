...
object ^ extends js.Object {
  ...
  def parse(source: java.lang.String): libxsltLib.libxsltMod.Stylesheet = js.native
  def parse(source: java.lang.String, callback: libxsltLib.internalDashTypesMod.ParseCallback): scala.Unit = js.native
  def parse(source: libxmljsLib.libxmljsMod.Document): libxsltLib.libxsltMod.Stylesheet = js.native
