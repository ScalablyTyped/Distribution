...
import typings.ltijs.libProviderServicesDeepLinkingMod.DeepLinkingService
import typings.ltijs.libProviderServicesGradeServiceMod.GradeService
import typings.ltijs.libProviderServicesNamesAndRolesMod.NamesAndRolesService
import typings.ltijs.libUtilsDatabaseMod.DatabaseOptions
import typings.ltijs.libUtilsPlatformMod.Platform
import typings.ltijs.libUtilsPlatformMod.PlatformConfig
...
object libProviderProviderMod {
  ...
  open class Provider protected () extends StObject {
    ...
    var Database: typings.ltijs.libUtilsDatabaseMod.Database = js.native
