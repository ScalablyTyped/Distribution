...
@js.native
object loadjsModMembers extends js.Object {
  def apply(
  ...
  def ready(bundleIds: java.lang.String, optionsOrCallback: loadjsLib.loadjsMod.loadjsNs.LoadedFn): loadjsLib.Anon_IsDefined = js.native
  def ready(bundleIds: java.lang.String, optionsOrCallback: loadjsLib.loadjsMod.loadjsNs.ReadyOptions): loadjsLib.Anon_IsDefined = js.native
  def ready(bundleIds: js.Array[java.lang.String], optionsOrCallback: loadjsLib.loadjsMod.loadjsNs.LoadedFn): loadjsLib.Anon_IsDefined = js.native
  def ready(
    bundleIds: js.Array[java.lang.String],
    optionsOrCallback: loadjsLib.loadjsMod.loadjsNs.ReadyOptions
  ): loadjsLib.Anon_IsDefined = js.native
