...
import typings.luminoWidgets.typesDocklayoutMod.DockLayout.IAddOptions
...
import typings.luminoWidgets.typesDocklayoutMod.DockLayout.IRenderer
import typings.luminoWidgets.typesDocklayoutMod.DockLayout.ITabAreaGeometry
...
object typesDocklayoutMod {
  ...
  object DockLayout {
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.luminoWidgets.typesDocklayoutMod.DockLayout.ITabAreaConfig
      - typings.luminoWidgets.typesDocklayoutMod.DockLayout.ISplitAreaConfig
    */
    trait AreaConfig extends StObject
    object AreaConfig {
      
      inline def ISplitAreaConfig(children: js.Array[AreaConfig], orientation: horizontal | vertical, sizes: js.Array[Double]): typings.luminoWidgets.typesDocklayoutMod.DockLayout.ISplitAreaConfig = {
        ...
        __obj.asInstanceOf[typings.luminoWidgets.typesDocklayoutMod.DockLayout.ISplitAreaConfig]
      }
      
      inline def ITabAreaConfig(currentIndex: Double, widgets: js.Array[Widget]): typings.luminoWidgets.typesDocklayoutMod.DockLayout.ITabAreaConfig = {
        ...
        __obj.asInstanceOf[typings.luminoWidgets.typesDocklayoutMod.DockLayout.ITabAreaConfig]
      }
    }
