...
import typings.luminoWidgets.typesTabbarMod.TabBar.ICurrentChangedArgs
import typings.luminoWidgets.typesTabbarMod.TabBar.IOptions
import typings.luminoWidgets.typesTabbarMod.TabBar.IRenderer
import typings.luminoWidgets.typesTabbarMod.TabBar.ITabActivateRequestedArgs
import typings.luminoWidgets.typesTabbarMod.TabBar.ITabCloseRequestedArgs
import typings.luminoWidgets.typesTabbarMod.TabBar.ITabDetachRequestedArgs
import typings.luminoWidgets.typesTabbarMod.TabBar.ITabMovedArgs
...
object typesTabbarMod {
  ...
  open class TabBar[T] () extends Widget {
    ...
    def addTab(value: typings.luminoWidgets.typesTitleMod.Title.IOptions[T]): Title[T] = js.native
    ...
    def insertTab(index: Double, value: typings.luminoWidgets.typesTitleMod.Title.IOptions[T]): Title[T] = js.native
