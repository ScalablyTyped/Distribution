...
import typings.luminoWidgets.accordionlayoutMod.AccordionLayout.IRenderer
...
object accordionlayoutMod {
  ...
  object AccordionLayout {
    ...
    trait IOptions
      extends StObject
         with typings.luminoWidgets.splitlayoutMod.SplitLayout.IOptions {
    ...
    object IOptions {
      ...
      inline def apply(renderer: typings.luminoWidgets.splitlayoutMod.SplitLayout.IRenderer): IOptions = {
