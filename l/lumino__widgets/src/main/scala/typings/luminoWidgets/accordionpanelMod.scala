...
import typings.luminoWidgets.accordionlayoutMod.AccordionLayout
import typings.luminoWidgets.accordionpanelMod.AccordionPanel.IOptions
import typings.luminoWidgets.accordionpanelMod.AccordionPanel.IRenderer
import typings.luminoWidgets.splitpanelMod.SplitPanel
  ...
  object AccordionPanel {
    ...
    open class Renderer ()
      extends typings.luminoWidgets.splitpanelMod.SplitPanel.Renderer
         with typings.luminoWidgets.accordionlayoutMod.AccordionLayout.IRenderer {
    ...
    trait IOptions extends StObject {
      ...
      var alignment: js.UndefOr[typings.luminoWidgets.splitlayoutMod.SplitLayout.Alignment] = js.undefined
      ...
      var orientation: js.UndefOr[typings.luminoWidgets.splitlayoutMod.SplitLayout.Orientation] = js.undefined
      
      var renderer: js.UndefOr[typings.luminoWidgets.accordionlayoutMod.AccordionLayout.IRenderer] = js.undefined
    ...
    object IOptions {
      ...
      extension [Self <: IOptions](x: Self) {
        ...
        inline def setAlignment(value: typings.luminoWidgets.splitlayoutMod.SplitLayout.Alignment): Self = StObject.set(x, "alignment", value.asInstanceOf[js.Any])
        ...
        inline def setOrientation(value: typings.luminoWidgets.splitlayoutMod.SplitLayout.Orientation): Self = StObject.set(x, "orientation", value.asInstanceOf[js.Any])
        
        inline def setOrientationUndefined: Self = StObject.set(x, "orientation", js.undefined)
        
        inline def setRenderer(value: typings.luminoWidgets.accordionlayoutMod.AccordionLayout.IRenderer): Self = StObject.set(x, "renderer", value.asInstanceOf[js.Any])
    ...
    /**
      ...
      */
    type IRenderer = typings.luminoWidgets.accordionlayoutMod.AccordionLayout.IRenderer
