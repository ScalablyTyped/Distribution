...
import typings.luminoWidgets.typesBoxlayoutMod.BoxLayout
import typings.luminoWidgets.typesBoxpanelMod.BoxPanel.Alignment
import typings.luminoWidgets.typesBoxpanelMod.BoxPanel.Direction
...
object typesBoxpanelMod {
  ...
  object BoxPanel {
    ...
    /**
      ...
      */
    type Alignment = typings.luminoWidgets.typesBoxlayoutMod.BoxLayout.Alignment
    
    /**
      * A type alias for a box panel direction.
      */
    type Direction = typings.luminoWidgets.typesBoxlayoutMod.BoxLayout.Direction
