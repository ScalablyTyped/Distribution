...
object libp2pGossipsubStrings {
  ...
  @js.native
  sealed trait `Linefeedmessage RPC LeftcurlybracketLinefeed  repeated SubOpts subscriptions Equalssign 1SemicolonLinefeed  repeated Message msgs Equalssign 2SemicolonLinefeed  optional ControlMessage control Equalssign 3SemicolonLinefeedLinefeed  message SubOpts LeftcurlybracketLinefeed    optional bool subscribe Equalssign 1Semicolon SlashSlash subscribe or unsubcribeLinefeed    optional string topicID Equalssign 2SemicolonLinefeed  RightcurlybracketLinefeedLinefeed  message Message LeftcurlybracketLinefeed  ` extends js.Object
