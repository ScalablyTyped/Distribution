...
trait Linq[T] extends js.Object {
  ...
  /**
    ...
    */
  def All(predicate: js.Function1[/* value */ T, scala.Boolean]): scala.Boolean = js.native
  /**
  ...
  def Any(predicate: js.Function1[/* value */ T, scala.Boolean]): scala.Boolean = js.native
  /**
  ...
  def Average(selector: js.Function1[/* value */ T, scala.Double]): scala.Double = js.native
  /**
  ...
  def Contains(value: T, comparer: linqsharpLib.linqsharpMod.LinqSharpNs.IEqualityComparer[T]): scala.Boolean = js.native
  /**
  ...
  def Count(selector: js.Function1[/* value */ T, scala.Boolean]): scala.Double = js.native
  /**
  ...
  def Distinct(comparer: linqsharpLib.linqsharpMod.LinqSharpNs.IEqualityComparer[T]): Linq[T] = js.native
  /**
    * Returns distinct elements from a sequence by using a specified IEqualityComparer<T>
    * to compare values.
    *
  ...
  def DistinctBy[U](
    selector: js.Function1[/* e */ T, U],
    comparer: linqsharpLib.linqsharpMod.LinqSharpNs.IEqualityComparer[T]
  ): Linq[T] = js.native
  /**
  ...
  def Except(except: js.Array[T], comparer: linqsharpLib.linqsharpMod.LinqSharpNs.IEqualityComparer[T]): Linq[T] = js.native
  /**
  ...
  def First(selector: js.Function1[/* e */ T, scala.Boolean]): T = js.native
  /**
  ...
  def FirstOrDefault(selector: js.Function1[/* e */ T, scala.Boolean]): T = js.native
  def FirstOrDefault(selector: js.Function1[/* e */ T, scala.Boolean], defaultValue: T): T = js.native
  /**
    ...
    */
  def ForEach(callback: js.Function2[/* e */ T, /* index */ scala.Double, _]): scala.Unit = js.native
  /**
  ...
  def GroupBy[TKey, TElement](
    ...
    comparer: linqsharpLib.linqsharpMod.LinqSharpNs.IEqualityComparer[TKey]
  ): Linq[_] = js.native
  /**
    ...
    * otherwise, –1.
    */
  def IndexOf(e: T): scala.Double = js.native
  def IndexOf(e: T, comparer: linqsharpLib.linqsharpMod.LinqSharpNs.IEqualityComparer[T]): scala.Double = js.native
  /**
  ...
  def Intersect(array: js.Array[T], comparer: linqsharpLib.linqsharpMod.LinqSharpNs.IEqualityComparer[T]): Linq[T] = js.native
  /**
  ...
  def Last(predicate: js.Function1[/* e */ T, scala.Boolean]): T = js.native
  /**
  ...
  def LastOrDefault(predicate: js.Function1[/* e */ T, scala.Boolean]): T = js.native
  def LastOrDefault(predicate: js.Function1[/* e */ T, scala.Boolean], defaultValue: T): T = js.native
  /**
  ...
  @JSName("Max")
  def Max_TResultTResult[TResult](): TResult = js.native
  /**
  ...
  @JSName("Min")
  def Min_TResultTResult[TResult](): TResult = js.native
  /**
  ...
  def OrderBy[TKey](
    keySelector: js.Function1[/* e */ T, TKey],
    comparer: js.Function2[/* a */ TKey, /* b */ TKey, scala.Double]
  ): Linq[T] = js.native
  /**
  ...
  /**
    ...
    */
  def Select[TResult](selector: js.Function2[/* e */ T, /* i */ js.UndefOr[scala.Double], TResult]): Linq[TResult] = js.native
  /**
  ...
  def SequenceEqual(second: js.Array[T], comparer: js.Function2[/* a */ T, /* b */ T, scala.Boolean]): scala.Boolean = js.native
  /**
  ...
  def Single(predicate: js.Function1[/* e */ T, scala.Boolean]): T = js.native
  /**
  ...
  def SingleOrDefault(predicate: js.Function1[/* e */ T, scala.Boolean]): T = js.native
  def SingleOrDefault(predicate: js.Function1[/* e */ T, scala.Boolean], defaultValue: T): T = js.native
  /**
    ...
    */
  def Skip(count: scala.Double): Linq[T] = js.native
  /**
    ...
    */
  def SkipWhile(predicate: js.Function1[/* e */ T, scala.Boolean]): Linq[T] = js.native
  /**
  ...
  def Sum(selector: js.Function1[/* value */ T, scala.Double]): scala.Double = js.native
  /**
    ...
    */
  def Take(count: scala.Double): Linq[T] = js.native
  /**
    ...
    */
  def TakeWhile(predicate: js.Function1[/* e */ T, scala.Boolean]): Linq[T] = js.native
  /**
  ...
  def Union(second: js.Array[T], comparer: linqsharpLib.linqsharpMod.LinqSharpNs.IEqualityComparer[T]): Linq[T] = js.native
  /**
    ...
    */
  def Where(selector: js.Function1[/* value */ T, scala.Boolean]): Linq[T] = js.native
  /**
