...
import typings.lezerCommon.parseMod.PartialParse
...
import typings.lezerLr.tokenMod.CachedToken
import typings.lezerLr.tokenMod.InputStream
import typings.lezerLr.tokenMod.Tokenizer
...
object parseMod {
  ...
  object ParserConfig {
    ...
    extension [Self <: ParserConfig](x: Self) {
      ...
      inline def setWrap(
        value: (/* inner */ PartialParse, /* input */ Input, /* fragments */ js.Array[typings.lezerCommon.parseMod.TreeFragment], /* ranges */ js.Array[typings.lezerCommon.anon.From]) => PartialParse
