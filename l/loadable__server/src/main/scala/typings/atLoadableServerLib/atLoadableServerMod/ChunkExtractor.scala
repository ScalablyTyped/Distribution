...
class ChunkExtractor protected () extends js.Object {
  ...
  /**
  	 ...
  	 */
  def getLinkElements(): js.Array[reactLib.reactMod.ReactElement] = js.native
  def getLinkElements(attr: AttrFn): js.Array[reactLib.reactMod.ReactElement] = js.native
  def getLinkElements(attr: js.Object): js.Array[reactLib.reactMod.ReactElement] = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def getScriptElements(): js.Array[reactLib.reactMod.ReactElement] = js.native
  def getScriptElements(attr: AttrFn): js.Array[reactLib.reactMod.ReactElement] = js.native
  def getScriptElements(attr: js.Object): js.Array[reactLib.reactMod.ReactElement] = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def getStyleElements(): js.Array[reactLib.reactMod.ReactElement] = js.native
  def getStyleElements(attr: AttrFn): js.Array[reactLib.reactMod.ReactElement] = js.native
  def getStyleElements(attr: js.Object): js.Array[reactLib.reactMod.ReactElement] = js.native
  /**
