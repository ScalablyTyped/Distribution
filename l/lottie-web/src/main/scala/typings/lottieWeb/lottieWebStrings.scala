...
object lottieWebStrings {
  ...
  @js.native
  sealed trait config_ready
    extends StObject
       with AnimationEventName
  inline def config_ready: config_ready = "config_ready".asInstanceOf[config_ready]
  
  @js.native
  sealed trait data_failed
    extends StObject
       with AnimationEventName
  inline def data_failed: data_failed = "data_failed".asInstanceOf[data_failed]
  
  @js.native
  sealed trait data_ready
    extends StObject
       with AnimationEventName
