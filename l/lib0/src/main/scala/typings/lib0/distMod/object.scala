...
object `object` {
  ...
  inline def forEach(obj: StringDictionary[Any], f: js.Function2[/* arg0 */ Any, /* arg1 */ String, Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("forEach")(obj.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[Unit]
