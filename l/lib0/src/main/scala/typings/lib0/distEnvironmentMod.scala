...
object distEnvironmentMod {
  ...
  @JSImport("lib0/dist/environment", JSImport.Namespace)
  @js.native
  ...
  @JSImport("lib0/dist/environment", "isBrowser")
  @js.native
  val isBrowser: Boolean = js.native
  
  @JSImport("lib0/dist/environment", "isMac")
  @js.native
  val isMac: Boolean = js.native
  
  @JSImport("lib0/dist/environment", "isNode")
  @js.native
