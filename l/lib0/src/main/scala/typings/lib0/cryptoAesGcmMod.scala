...
import typings.lib0.anon.Extractable
...
object cryptoAesGcmMod {
  
  @JSImport("lib0/crypto/aes-gcm", JSImport.Namespace)
  @js.native
  ...
  inline def deriveKey(secret: String, salt: String, param2: Extractable): js.Promise[CryptoKey] = (^.asInstanceOf[js.Dynamic].applyDynamic("deriveKey")(secret.asInstanceOf[js.Any], salt.asInstanceOf[js.Any], param2.asInstanceOf[js.Any])).asInstanceOf[js.Promise[CryptoKey]]
  ...
  inline def deriveKey(secret: String, salt: js.typedarray.Uint8Array, param2: Extractable): js.Promise[CryptoKey] = (^.asInstanceOf[js.Dynamic].applyDynamic("deriveKey")(secret.asInstanceOf[js.Any], salt.asInstanceOf[js.Any], param2.asInstanceOf[js.Any])).asInstanceOf[js.Promise[CryptoKey]]
  ...
  inline def deriveKey(secret: js.typedarray.Uint8Array, salt: String, param2: Extractable): js.Promise[CryptoKey] = (^.asInstanceOf[js.Dynamic].applyDynamic("deriveKey")(secret.asInstanceOf[js.Any], salt.asInstanceOf[js.Any], param2.asInstanceOf[js.Any])).asInstanceOf[js.Promise[CryptoKey]]
  ...
  inline def deriveKey(secret: js.typedarray.Uint8Array, salt: js.typedarray.Uint8Array, param2: Extractable): js.Promise[CryptoKey] = (^.asInstanceOf[js.Dynamic].applyDynamic("deriveKey")(secret.asInstanceOf[js.Any], salt.asInstanceOf[js.Any], param2.asInstanceOf[js.Any])).asInstanceOf[js.Promise[CryptoKey]]
