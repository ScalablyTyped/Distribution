...
object cryptoEcdsaMod {
  
  @JSImport("lib0/crypto/ecdsa", JSImport.Namespace)
  @js.native
  ...
  inline def generateKeyPair(param0: typings.lib0.anon.Usages): js.Promise[CryptoKeyPair] = ^.asInstanceOf[js.Dynamic].applyDynamic("generateKeyPair")(param0.asInstanceOf[js.Any]).asInstanceOf[js.Promise[CryptoKeyPair]]
  ...
  inline def importKey(jwk: Any, param1: typings.lib0.anon.Usages): js.Promise[CryptoKey] = (^.asInstanceOf[js.Dynamic].applyDynamic("importKey")(jwk.asInstanceOf[js.Any], param1.asInstanceOf[js.Any])).asInstanceOf[js.Promise[CryptoKey]]
