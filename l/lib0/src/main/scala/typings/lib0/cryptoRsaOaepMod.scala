...
import typings.lib0.anon.ExtractableUsages
...
object cryptoRsaOaepMod {
  
  @JSImport("lib0/crypto/rsa-oaep", JSImport.Namespace)
  @js.native
  ...
  inline def generateKeyPair(param0: ExtractableUsages): js.Promise[CryptoKeyPair] = ^.asInstanceOf[js.Dynamic].applyDynamic("generateKeyPair")(param0.asInstanceOf[js.Any]).asInstanceOf[js.Promise[CryptoKeyPair]]
  ...
  inline def importKey(jwk: Any, param1: ExtractableUsages): js.Promise[CryptoKey] = (^.asInstanceOf[js.Dynamic].applyDynamic("importKey")(jwk.asInstanceOf[js.Any], param1.asInstanceOf[js.Any])).asInstanceOf[js.Promise[CryptoKey]]
