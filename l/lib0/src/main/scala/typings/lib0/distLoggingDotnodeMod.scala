...
object distLoggingDotnodeMod {
  
  @JSImport("lib0/dist/logging.node", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("lib0/dist/logging.node", "BLUE")
  @js.native
  val BLUE: js.Symbol = js.native
  
  @JSImport("lib0/dist/logging.node", "BOLD")
  @js.native
  val BOLD: js.Symbol = js.native
  
  @JSImport("lib0/dist/logging.node", "GREEN")
  @js.native
  val GREEN: js.Symbol = js.native
  
  @JSImport("lib0/dist/logging.node", "GREY")
  @js.native
  val GREY: js.Symbol = js.native
  
  @JSImport("lib0/dist/logging.node", "ORANGE")
  @js.native
  val ORANGE: js.Symbol = js.native
  
  @JSImport("lib0/dist/logging.node", "PURPLE")
  @js.native
  val PURPLE: js.Symbol = js.native
  
  @JSImport("lib0/dist/logging.node", "RED")
  @js.native
  val RED: js.Symbol = js.native
  
  @JSImport("lib0/dist/logging.node", "UNBOLD")
  @js.native
  val UNBOLD: js.Symbol = js.native
  
  @JSImport("lib0/dist/logging.node", "UNCOLOR")
  @js.native
