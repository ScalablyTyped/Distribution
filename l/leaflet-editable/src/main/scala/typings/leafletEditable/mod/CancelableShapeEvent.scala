...
- typings.leafletEditable.mod.ShapeEvent because var conflicts: layer, popup, propagatedFrom, sourceTarget, target, `type`. Inlined shape */ trait CancelableShapeEvent
  extends StObject
