...
- typings.leafletEditable.leafletMod.VertexEvent because var conflicts: layer, popup, propagatedFrom, sourceTarget, target, `type`. Inlined vertex */ trait CancelableVertexEvent
  extends StObject
