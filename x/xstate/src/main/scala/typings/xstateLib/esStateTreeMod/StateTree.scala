...
class StateTree protected () extends js.Object {
  def this(stateNode: xstateLib.esStateNodeMod.StateNode[_, _, xstateLib.esTypesMod.OmniEventObject[xstateLib.esTypesMod.EventObject]]) = this()
  def this(stateNode: xstateLib.esStateNodeMod.StateNode[_, _, xstateLib.esTypesMod.OmniEventObject[xstateLib.esTypesMod.EventObject]], stateValue: xstateLib.esTypesMod.StateValue) = this()
  def this(stateNode: xstateLib.esStateNodeMod.StateNode[_, _, xstateLib.esTypesMod.OmniEventObject[xstateLib.esTypesMod.EventObject]], stateValue: js.UndefOr[xstateLib.esTypesMod.StateValue], options: StateTreeOptions) = this()
  def this(stateNode: xstateLib.esStateNodeMod.StateNode[_, _, xstateLib.esTypesMod.OmniEventObject[xstateLib.esTypesMod.EventObject]], stateValue: js.UndefOr[xstateLib.esTypesMod.StateValue], options: StateTreeOptions, parent: StateTree) = this()
  ...
  var stateNode: xstateLib.esStateNodeMod.StateNode[_, _, xstateLib.esTypesMod.OmniEventObject[xstateLib.esTypesMod.EventObject]] = js.native
  var stateValue: js.UndefOr[xstateLib.esTypesMod.StateValue] = js.native
  val value: xstateLib.esTypesMod.StateValue = js.native
  def addReentryNode(
    reentryNode: xstateLib.esStateNodeMod.StateNode[_, _, xstateLib.esTypesMod.OmniEventObject[xstateLib.esTypesMod.EventObject]]
