...
trait SendActionObject[TContext, TEvent /* <: EventObject */] extends SendAction[TContext, TEvent] {
  ...
  @JSName("to")
  var to_SendActionObject: js.UndefOr[java.lang.String | scala.Double | (xstateLib.esActorMod.Actor[_, EventObject])] = js.undefined
}
...
object SendActionObject {
  ...
  def apply[TContext, TEvent /* <: EventObject */](
    ...
    to: java.lang.String | scala.Double | (xstateLib.esActorMod.Actor[_, EventObject]) = null
