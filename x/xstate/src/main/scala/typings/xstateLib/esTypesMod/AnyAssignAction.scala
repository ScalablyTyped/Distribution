...
trait AnyAssignAction[TContext, TEvent /* <: EventObject */] extends ActionObject[TContext, TEvent] {
  ...
  @JSName("type")
  var type_AnyAssignAction: ActionTypes
}

object AnyAssignAction {
  @scala.inline
  def apply[TContext, TEvent /* <: EventObject */](assignment: js.Any, `type`: ActionTypes, exec: ActionFunction[TContext, TEvent] = null): AnyAssignAction[TContext, TEvent] = {
