...
trait SendAction[TContext, TEvent /* <: EventObject */] extends ActionObject[TContext, TEvent] {
  ...
  var to: js.UndefOr[
    java.lang.String | scala.Double | (xstateLib.libActorMod.Actor[_, EventObject]) | (Expr[
      TContext, 
      TEvent, 
      java.lang.String | scala.Double | (xstateLib.libActorMod.Actor[_, EventObject])
    ])
  ] = js.undefined
}
...
object SendAction {
  ...
  def apply[TContext, TEvent /* <: EventObject */](
    ...
    to: java.lang.String | scala.Double | (xstateLib.libActorMod.Actor[_, EventObject]) | (Expr[
      TContext, 
      TEvent, 
      java.lang.String | scala.Double | (xstateLib.libActorMod.Actor[_, EventObject])
    ]) = null
