...
trait StateTransition[TContext, TEvent /* <: EventObject */] extends js.Object {
  ...
  var configuration: js.Array[xstateLib.libStateNodeMod.StateNode[TContext, _, TEvent]]
...
object StateTransition {
  ...
  def apply[TContext, TEvent /* <: EventObject */](
    ...
    configuration: js.Array[xstateLib.libStateNodeMod.StateNode[TContext, _, TEvent]],
