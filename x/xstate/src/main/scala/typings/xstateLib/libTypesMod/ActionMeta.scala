...
object ActionMeta {
  @scala.inline
  def apply[TContext, TEvent /* <: EventObject */](action: ActionObject[TContext, TEvent], state: xstateLib.libStateMod.State[TContext, TEvent]): ActionMeta[TContext, TEvent] = {
