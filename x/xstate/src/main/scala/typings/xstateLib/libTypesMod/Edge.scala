...
trait Edge[TContext, TEvent /* <: EventObject */, TEventType /* <: /* import warning: ImportType.apply Failed type conversion: TEvent['type'] */ js.Any */] extends js.Object {
  ...
  var source: xstateLib.libStateNodeMod.StateNode[TContext, _, OmniEventObject[EventObject]]
  var target: xstateLib.libStateNodeMod.StateNode[TContext, _, OmniEventObject[EventObject]]
...
object Edge {
  ...
  def apply[TContext, TEvent /* <: EventObject */, TEventType /* <: /* import warning: ImportType.apply Failed type conversion: TEvent['type'] */ js.Any */](
    ...
    event: TEventType,
    source: xstateLib.libStateNodeMod.StateNode[TContext, _, OmniEventObject[EventObject]],
    target: xstateLib.libStateNodeMod.StateNode[TContext, _, OmniEventObject[EventObject]],
