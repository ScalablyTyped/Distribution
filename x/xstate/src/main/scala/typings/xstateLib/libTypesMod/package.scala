...
package object libTypesMod {
  ...
  */
  ...
  type Assigner[TContext, TEvent /* <: EventObject */] = js.Function2[/* extState */ TContext, /* event */ TEvent, stdLib.Partial[TContext]]
  type Condition[TContext, TEvent /* <: EventObject */] = java.lang.String | (ConditionPredicate[TContext, TEvent])
  ...
  ]) | (js.Array[(TransitionConfig[TContext, TEvent]) with xstateLib.Anon_Delay])
  ...
  type InvokeCreator[TFinalContext, TContext] = js.Function2[
    /* context */ TContext, 
    /* event */ EventObject, 
    js.Promise[TFinalContext] | (StateMachine[TFinalContext, js.Any, js.Any]) | InvokeCallback
  ]
  type InvokesConfig[TContext, TEvent /* <: EventObject */] = SingleOrArray[InvokeConfig[TContext, TEvent]]
  type Mapper[TContext, TEvent /* <: EventObject */] = js.Function2[/* extState */ TContext, /* event */ TEvent, js.Any]
  ...
  type PropertyMapper[TContext, TEvent /* <: EventObject */] = stdLib.Partial[
    org.scalablytyped.runtime.StringDictionary[(js.Function2[/* extState */ TContext, /* event */ TEvent, js.Any]) | js.Any]
  ]
