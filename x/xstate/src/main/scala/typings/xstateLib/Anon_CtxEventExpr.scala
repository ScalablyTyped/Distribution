...
trait Anon_CtxEventExpr[TContext, TEvent /* <: xstateLib.libTypesMod.EventObject */] extends js.Object {
  var label: js.UndefOr[java.lang.String] = js.undefined
  var `type`: xstateLib.libTypesMod.ActionTypes
  def expr(ctx: TContext, event: TEvent): js.Any
}

object Anon_CtxEventExpr {
  @scala.inline
  ...
  ): Anon_CtxEventExpr[TContext, TEvent] = {
    val __obj = js.Dynamic.literal(expr = js.Any.fromFunction2(expr))
    __obj.updateDynamic("type")(`type`)
    if (label != null) __obj.updateDynamic("label")(label)
    __obj.asInstanceOf[Anon_CtxEventExpr[TContext, TEvent]]
  }
}
