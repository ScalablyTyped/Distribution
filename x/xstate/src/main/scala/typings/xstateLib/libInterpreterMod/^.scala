...
object ^ extends js.Object {
  ...
  def spawn[TContext](entity: Spawnable[TContext], nameOrOptions: java.lang.String): xstateLib.libActorMod.Actor[TContext, xstateLib.libTypesMod.EventObject] = js.native
  def spawn[TContext](entity: Spawnable[TContext], nameOrOptions: SpawnOptions): xstateLib.libActorMod.Actor[TContext, xstateLib.libTypesMod.EventObject] = js.native
}
