...
import typings.xstate.typesMod.TransitionConfigTargetShortcut
...
object utilsMod extends js.Object {
  ...
  def toSCXMLEvent[TEvent /* <: EventObject */](event: Event[TEvent]): typings.xstate.typesMod.SCXML.Event[TEvent] = js.native
  def toSCXMLEvent[TEvent /* <: EventObject */](event: Event[TEvent], scxmlEvent: Partial[typings.xstate.typesMod.SCXML.Event[TEvent]]): typings.xstate.typesMod.SCXML.Event[TEvent] = js.native
  def toSCXMLEvent[TEvent /* <: EventObject */](event: typings.xstate.typesMod.SCXML.Event[TEvent]): typings.xstate.typesMod.SCXML.Event[TEvent] = js.native
  def toSCXMLEvent[TEvent /* <: EventObject */](
    event: typings.xstate.typesMod.SCXML.Event[TEvent],
    scxmlEvent: Partial[typings.xstate.typesMod.SCXML.Event[TEvent]]
  ): typings.xstate.typesMod.SCXML.Event[TEvent] = js.native
