...
import typings.xstate.typesMod.Subscription
...
object interpreterMod {
  ...
  open class Interpreter[TContext, TStateSchema /* <: StateSchema[Any] */, TEvent /* <: EventObject */, TTypestate /* <: Typestate[TContext] */, TResolvedTypesMeta] protected ()
    ...
    def nextState(event: typings.xstate.typesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    ...
    def send(event: typings.xstate.typesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    def send(event: typings.xstate.typesMod.SCXML.Event[TEvent], payload: EventData): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    ...
    def subscribe(observer: Partial[Observer[State[TContext, TEvent, Any, TTypestate, TResolvedTypesMeta]]]): Subscription = js.native
    /* CompleteClass */
