...
trait StateLike[TContext] extends StObject {
  ...
  var _event: typings.xstate.libTypesMod.SCXML.Event[EventObject]
...
object StateLike {
  ...
  extension [Self <: StateLike[?], TContext](x: Self & StateLike[TContext]) {
    ...
    inline def set_event(value: typings.xstate.libTypesMod.SCXML.Event[EventObject]): Self = StObject.set(x, "_event", value.asInstanceOf[js.Any])
  }
}
