...
/* Rewritten from type alias, can be one of: 
  - typings.xstate.libTypesMod.AtomicStateNodeConfig[TContext, TEvent]
  - typings.xstate.libTypesMod.StateNodeConfig[TContext, TStateSchema, TEvent]
*/
...
object SimpleOrStateNodeConfig {
  @scala.inline
  def AtomicStateNodeConfig[TContext, TStateSchema /* <: StateSchema[_] */, TEvent /* <: EventObject */](
  ...
  ): SimpleOrStateNodeConfig[TContext, TStateSchema, TEvent] = {
  ...
  @scala.inline
  def StateNodeConfig[TContext, TStateSchema /* <: StateSchema[_] */, TEvent /* <: EventObject */](
    activities: SingleOrArray[Activity[TContext, TEvent]] = null,
    after: DelayedTransitions[TContext, TEvent] = null,
    context: TContext | js.Function0[TContext] = null,
    data: (Mapper[TContext, TEvent]) | (PropertyMapper[TContext, TEvent]) = null,
