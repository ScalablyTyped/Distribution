...
trait AssignMeta[TContext, TEvent /* <: EventObject */] extends StObject {
  ...
  def action(arg: TContext, ev: TEvent, meta: ActionMeta[TContext, TEvent, BaseActionObject]): Unit
  @JSName("action")
  var action_Original: AssignAction[TContext, TEvent, TEvent]
...
object AssignMeta {
  ...
  inline def apply[TContext, TEvent /* <: EventObject */](
    ...
    action: AssignAction[TContext, TEvent, TEvent]
  ...
  implicit open class MutableBuilder[Self <: AssignMeta[?, ?], TContext, TEvent /* <: EventObject */] (val x: Self & (AssignMeta[TContext, TEvent])) extends AnyVal {
    ...
    inline def setAction(value: AssignAction[TContext, TEvent, TEvent]): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
