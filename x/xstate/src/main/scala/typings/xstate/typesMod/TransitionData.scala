...
object TransitionData {
  @scala.inline
  def apply[TContext, /* <: typings.xstate.typesMod.EventObject */ TEvent](actions: ActionMap[TContext, TEvent], activities: ActivityMap = null, value: StateValue = null): TransitionData[TContext, TEvent] = {
