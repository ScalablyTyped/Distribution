...
object RaiseActionObject {
  ...
  @scala.inline
  implicit class RaiseActionObjectOps[Self <: RaiseActionObject[_], /* <: typings.xstate.typesMod.EventObject */ TEvent] (val x: Self with RaiseActionObject[TEvent]) extends AnyVal {
    @scala.inline
