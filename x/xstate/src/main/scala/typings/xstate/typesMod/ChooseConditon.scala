...
object ChooseConditon {
  @scala.inline
  def apply[TContext, /* <: typings.xstate.typesMod.EventObject */ TEvent](actions: Actions[TContext, TEvent], cond: Condition[TContext, TEvent] = null): ChooseConditon[TContext, TEvent] = {
