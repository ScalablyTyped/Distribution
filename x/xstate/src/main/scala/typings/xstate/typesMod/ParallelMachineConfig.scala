...
object ParallelMachineConfig {
  ...
  @scala.inline
  implicit class ParallelMachineConfigOps[Self <: ParallelMachineConfig[_, _, _], TContext, TStateSchema /* <: StateSchema[_] */, TEvent /* <: EventObject */] (val x: Self with (ParallelMachineConfig[TContext, TStateSchema, TEvent])) extends AnyVal {
