...
object HistoryStateNodeConfig {
  @scala.inline
  def apply[TContext, /* <: typings.xstate.typesMod.EventObject */ TEvent](history: shallow | deep | `true`): HistoryStateNodeConfig[TContext, TEvent] = {
    val __obj = js.Dynamic.literal(history = history.asInstanceOf[js.Any])
    __obj.asInstanceOf[HistoryStateNodeConfig[TContext, TEvent]]
  }
  @scala.inline
  implicit class HistoryStateNodeConfigOps[Self <: HistoryStateNodeConfig[_, _], TContext, /* <: typings.xstate.typesMod.EventObject */ TEvent] (val x: Self with (HistoryStateNodeConfig[TContext, TEvent])) extends AnyVal {
    @scala.inline
