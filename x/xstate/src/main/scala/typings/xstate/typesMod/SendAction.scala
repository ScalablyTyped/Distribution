...
object SendAction {
  ...
  @scala.inline
  implicit class SendActionOps[Self <: SendAction[_, _, _], TContext, TEvent /* <: EventObject */, TSentEvent /* <: EventObject */] (val x: Self with (SendAction[TContext, TEvent, TSentEvent])) extends AnyVal {
