...
object Segment {
  @scala.inline
  def apply[TContext, /* <: typings.xstate.typesMod.EventObject */ TEvent](event: TEvent, state: State[TContext, TEvent, _, Context[TContext]]): Segment[TContext, TEvent] = {
  ...
  @scala.inline
  implicit class SegmentOps[Self <: Segment[_, _], TContext, /* <: typings.xstate.typesMod.EventObject */ TEvent] (val x: Self with (Segment[TContext, TEvent])) extends AnyVal {
    @scala.inline
