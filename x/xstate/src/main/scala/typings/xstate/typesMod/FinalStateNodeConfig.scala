...
object FinalStateNodeConfig {
  ...
  @scala.inline
  implicit class FinalStateNodeConfigOps[Self <: FinalStateNodeConfig[_, _], TContext, TEvent /* <: EventObject */] (val x: Self with (FinalStateNodeConfig[TContext, TEvent])) extends AnyVal {
