...
object ActivityDefinition {
  ...
  @scala.inline
  implicit class ActivityDefinitionOps[Self <: ActivityDefinition[_, _], TContext, TEvent /* <: EventObject */] (val x: Self with (ActivityDefinition[TContext, TEvent])) extends AnyVal {
