...
java.lang.String | (typings.xstate.typesMod.SingleOrArray[typings.xstate.typesMod.TransitionConfig[TContext, TEvent]])]) | (js.Array[
(typings.xstate.typesMod.TransitionConfig[TContext, TEvent]) & (typings.xstate.anon.Delay[TContext, TEvent])])
...
type EventData = (typings.std.Record[java.lang.String, js.Any]) & typings.xstate.anon.`2`
...
{[ K in std.Exclude<keyof A, 'type'> ]: A[K]}
  */ typings.xstate.xstateStrings.ExcludeType & org.scalablytyped.runtime.TopLevel[A]
...
{[ K in xstate.xstate/lib/types.KeysWithStates<TSchema['states']> ]:? / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias xstate.xstate/lib/types.ExtractStateValue<TSchema['states'][K]> * / object}
  */ typings.xstate.xstateStrings.ExtractStateValue & org.scalablytyped.runtime.TopLevel[js.Any])

type Guard[TContext, TEvent /* <: typings.xstate.typesMod.EventObject */] = (typings.xstate.typesMod.GuardPredicate[TContext, TEvent]) | ((typings.std.Record[java.lang.String, js.Any]) & typings.xstate.anon.TypeString)
...
type KeysWithStates[TStates /* <: js.UndefOr[
typings.std.Record[java.lang.String, typings.xstate.typesMod.StateSchema[js.Any]]] */] = /* import warning: importer.ImportType#apply Failed type conversion: {[ K in keyof TStates ]: -? TStates[K] extends {  states :object}? K : never}[keyof TStates] */ js.Any
...
{[ K in keyof TContext ]:? (context : TContext, event : TEvent, meta : xstate.xstate/lib/types.AssignMeta<TContext, TEvent>): TContext[K] | TContext[K]}
  */ typings.xstate.xstateStrings.PropertyAssigner & org.scalablytyped.runtime.TopLevel[js.Any]
...
{[ K in keyof TParams ]:? (context : TContext, event : TEvent): TParams[K] | TParams[K]}
  */ typings.xstate.xstateStrings.PropertyMapper & org.scalablytyped.runtime.TopLevel[js.Any]
...
type StandardMachineConfig[TContext, TStateSchema /* <: typings.xstate.typesMod.StateSchema[js.Any] */, TEvent /* <: typings.xstate.typesMod.EventObject */] = typings.xstate.typesMod.StateNodeConfig[TContext, TStateSchema, TEvent]

type StateFrom[TMachine /* <: typings.xstate.typesMod.StateMachine[js.Any, js.Any, js.Any, typings.xstate.anon.ContextAny] */] = typings.std.ReturnType[
...
type StateNodesConfig[TContext, TStateSchema /* <: typings.xstate.typesMod.StateSchema[js.Any] */, TEvent /* <: typings.xstate.typesMod.EventObject */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ K in keyof TStateSchema['states'] ]: xstate.xstate/lib/StateNode.StateNode<TContext, TStateSchema['states'][K], TEvent, {  value :any,   context :TContext}>}
  */ typings.xstate.xstateStrings.StateNodesConfig & org.scalablytyped.runtime.TopLevel[TStateSchema]
...
type StatesConfig[TContext, TStateSchema /* <: typings.xstate.typesMod.StateSchema[js.Any] */, TEvent /* <: typings.xstate.typesMod.EventObject */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ K in keyof TStateSchema['states'] ]: xstate.xstate/lib/types.StateNodeConfig<TContext, TStateSchema['states'][K], TEvent>}
  */ typings.xstate.xstateStrings.StatesConfig & org.scalablytyped.runtime.TopLevel[TStateSchema]

type StatesDefinition[TContext, TStateSchema /* <: typings.xstate.typesMod.StateSchema[js.Any] */, TEvent /* <: typings.xstate.typesMod.EventObject */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ K in keyof TStateSchema['states'] ]: xstate.xstate/lib/types.StateNodeDefinition<TContext, TStateSchema['states'][K], TEvent>}
  */ typings.xstate.xstateStrings.StatesDefinition & org.scalablytyped.runtime.TopLevel[TStateSchema]
...
{[ K in TEvent['type'] | xstate.xstate/lib/types.ActionTypes.NullEvent | '*' ]: std.Array<xstate.xstate/lib/types.TransitionDefinition<TContext, K extends TEvent['type']? std.Extract<TEvent, {  type :K}> : xstate.xstate/lib/types.EventObject>>}
  */ typings.xstate.xstateStrings.TransitionDefinitionMap & org.scalablytyped.runtime.TopLevel[TEvent]
...
((typings.xstate.typesMod.TransitionConfig[TContext, TEvent]) & typings.xstate.anon.Event[TEvent]) | ((typings.xstate.typesMod.TransitionConfig[TContext, TEvent]) & typings.xstate.anon.`0`) | ((typings.xstate.typesMod.TransitionConfig[TContext, TEvent]) & typings.xstate.anon.`1`)]
