...
object SCXML {
  ...
  object Event {
    ...
    @scala.inline
    def apply[TEvent /* <: EventObject */](DollarDollartype: scxml, data: TEvent, name: String, `type`: platform | internal | external): typings.xstate.typesMod.SCXML.Event[TEvent] = {
    ...
    @scala.inline
    implicit class EventMutableBuilder[Self <: typings.xstate.typesMod.SCXML.Event[_], TEvent /* <: EventObject */] (val x: Self with typings.xstate.typesMod.SCXML.Event[TEvent]) extends AnyVal {
