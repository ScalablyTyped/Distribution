...
object SendActionObject {
  ...
  @scala.inline
  implicit class SendActionObjectOps[Self <: SendActionObject[_, _, _], TContext, /* <: typings.xstate.typesMod.EventObject */ TEvent, /* <: typings.xstate.typesMod.EventObject */ TSentEvent] (val x: Self with (SendActionObject[TContext, TEvent, TSentEvent])) extends AnyVal {
    @scala.inline
