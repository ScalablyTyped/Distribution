...
object Initial {
  ...
  @scala.inline
  implicit class InitialOps[Self <: Initial[_, _], /* <: typings.xstate.typesMod.StateSchema[_] */ TStateSchema, /* <: typings.xstate.typesMod.EventObject */ TEvent] (val x: Self with (Initial[TStateSchema, TEvent])) extends AnyVal {
    @scala.inline
