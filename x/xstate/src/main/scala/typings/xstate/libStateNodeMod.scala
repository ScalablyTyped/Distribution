...
import typings.xstate.libTypesMod.MachineSchema
...
import typings.xstate.libTypesMod.StateTransition
...
object libStateNodeMod {
  ...
  open class StateNode[TContext, TStateSchema /* <: StateSchema[Any] */, TEvent /* <: EventObject */, TTypestate /* <: Typestate[TContext] */, TServiceMap /* <: ServiceMap */, TResolvedTypesMeta] protected () extends StObject {
    ...
    def getRelativeStateNodes(
      relativeStateId: StateNode[TContext, Any, TEvent, ContextValue[TContext], ServiceMap, TypegenDisabled]
    ): js.Array[
        StateNode[TContext, Any, TEvent, ContextValue[TContext], ServiceMap, TypegenDisabled]
      ] = js.native
    def getRelativeStateNodes(
      relativeStateId: StateNode[TContext, Any, TEvent, ContextValue[TContext], ServiceMap, TypegenDisabled],
      historyValue: Unit,
    ...
    ): js.UndefOr[StateTransition[TContext, TEvent]] = js.native
    ...
    def transition(state: Unit, event: typings.xstate.libTypesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    def transition(state: Unit, event: typings.xstate.libTypesMod.SCXML.Event[TEvent], context: TContext): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    def transition(
      state: Unit,
      event: typings.xstate.libTypesMod.SCXML.Event[TEvent],
      context: TContext,
    ...
    def transition(state: StateValue, event: typings.xstate.libTypesMod.SCXML.Event[TEvent]): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    def transition(state: StateValue, event: typings.xstate.libTypesMod.SCXML.Event[TEvent], context: TContext): State[TContext, TEvent, TStateSchema, TTypestate, TResolvedTypesMeta] = js.native
    def transition(
      state: StateValue,
      event: typings.xstate.libTypesMod.SCXML.Event[TEvent],
      context: TContext,
