...
import typings.xstate.esTypesMod.DelayedTransitionDefinition
...
import typings.xstate.esTypesMod.InvokeDefinition
...
import typings.xstate.esTypesMod.StateNodeDefinition
import typings.xstate.esTypesMod.StateNodesConfig
import typings.xstate.esTypesMod.StateSchema
import typings.xstate.esTypesMod.StateTypes
import typings.xstate.esTypesMod.StateValue
import typings.xstate.esTypesMod.TransitionDefinition
import typings.xstate.esTypesMod.TransitionsDefinition
...
@JSImport("xstate/es/StateNode", JSImport.Namespace)
@js.native
object esStateNodeMod extends js.Object {
  @js.native
