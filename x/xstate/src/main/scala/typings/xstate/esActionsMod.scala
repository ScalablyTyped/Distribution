...
import typings.xstate.esTypesMod.ActionFunction
...
import typings.xstate.esTypesMod.ErrorPlatformEvent
...
import typings.xstate.esTypesMod.PureAction
import typings.xstate.esTypesMod.RaiseEvent
import typings.xstate.esTypesMod.SendAction
import typings.xstate.esTypesMod.SendActionObject
...
object esActionsMod extends js.Object {
  ...
  def isActionObject[TContext, TEvent /* <: EventObject */](action: Action[TContext, TEvent]): /* is xstate.xstate/es/types.ActionObject<TContext, TEvent> */ Boolean = js.native
