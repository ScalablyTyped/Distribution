...
/* Rewritten from type alias, can be one of: 
  - typings.xstate.esTypesMod.AtomicStateNodeConfig[TContext, TEvent]
  - typings.xstate.esTypesMod.CompoundStateNodeConfig[TContext, TStateSchema, TEvent]
*/
trait SimpleOrCompoundStateNodeConfig[TContext, TStateSchema /* <: StateSchema */, TEvent /* <: EventObject */] extends js.Object

object SimpleOrCompoundStateNodeConfig {
  @scala.inline
  def AtomicStateNodeConfig[TContext, TStateSchema /* <: StateSchema */, TEvent /* <: EventObject */](
  ...
  ): SimpleOrCompoundStateNodeConfig[TContext, TStateSchema, TEvent] = {
    ...
    __obj.asInstanceOf[SimpleOrCompoundStateNodeConfig[TContext, TStateSchema, TEvent]]
  }
  @scala.inline
  def CompoundStateNodeConfig[TContext, TStateSchema /* <: StateSchema */, TEvent /* <: EventObject */](
    activities: SingleOrArray[Activity[TContext, TEvent]] = null,
    after: DelayedTransitions[TContext, TEvent] = null,
    context: TContext = null,
    data: (Mapper[TContext, TEvent]) | (PropertyMapper[TContext, TEvent]) = null,
