...
@JSImport("xstate/es/Actor", JSImport.Namespace)
@js.native
object esActorMod extends js.Object {
  @js.native
  ...
  def isActor(item: js.Any): /* is xstate.xstate/es/Actor.Actor<any, xstate.xstate/es/types.EventObject> */ Boolean = js.native
}
