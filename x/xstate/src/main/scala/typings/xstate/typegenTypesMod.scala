...
object typegenTypesMod {
  ...
  */
  ...
  type GenerateServiceEvent[TServiceName, TEventType, TServiceMap /* <: ServiceMap */] = `1`[TEventType] & (Prop[TServiceMap, TServiceName])
  
  type GenerateServiceEvents[TServiceMap /* <: ServiceMap */, TInvokeSrcNameMap] = Cast[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ K in keyof TInvokeSrcNameMap ]: xstate.xstate/lib/typegenTypes.GenerateServiceEvent<K, TInvokeSrcNameMap[K], TServiceMap>}[keyof TInvokeSrcNameMap] */ js.Any, 
    EventObject
  ]
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.xstate.typegenTypesMod.TypegenEnabled
    - typings.xstate.typegenTypesMod.TypegenDisabled
  */
  trait TypegenConstraint extends StObject
  object TypegenConstraint {
    
    inline def TypegenDisabled(): typings.xstate.typegenTypesMod.TypegenDisabled = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("@@xstate/typegen")(false)
      __obj.asInstanceOf[typings.xstate.typegenTypesMod.TypegenDisabled]
    }
    
    inline def TypegenEnabled(): typings.xstate.typegenTypesMod.TypegenEnabled = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("@@xstate/typegen")(true)
      __obj.asInstanceOf[typings.xstate.typegenTypesMod.TypegenEnabled]
    }
  }
