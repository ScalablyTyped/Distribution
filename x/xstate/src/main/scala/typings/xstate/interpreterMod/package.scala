...
package object interpreterMod {
  ...
  type StateListener[TContext, TEvent /* <: typings.xstate.typesMod.EventObject */, TTypestate /* <: typings.xstate.typesMod.Typestate[TContext] */] = js.Function2[
    /* state */ typings.xstate.stateMod.State[TContext, TEvent, js.Any, TTypestate], 
    /* event */ TEvent, 
    scala.Unit
  ]
}
