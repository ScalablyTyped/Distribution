...
import typings.xadesjs.buildTypesSrcXmlCommitmentTypeIndicationMod.CommitmentTypeIndication
import typings.xadesjs.buildTypesSrcXmlDataObjectFormatMod.DataObjectFormat
