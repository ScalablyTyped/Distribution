...
object buildTypesSrcXmlObjectIdentifierMod {
  ...
  open class ObjectIdentifier () extends XadesObject {
    ...
    var DocumentationReferences: typings.xadesjs.buildTypesSrcXmlObjectIdentifierMod.DocumentationReferences = js.native
    
    var Identifier: typings.xadesjs.buildTypesSrcXmlObjectIdentifierMod.Identifier = js.native
  }
