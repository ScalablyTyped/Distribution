package typings.xadesjs.buildTypesSrcMod.xml
...
object XmlXades {
  ...
  @JSImport("xadesjs/build/types/src", "xml.XmlXades")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("xadesjs/build/types/src", "xml.XmlXades.AttributeNames")
  @js.native
  ...
  @JSImport("xadesjs/build/types/src", "xml.XmlXades.DefaultPrefix")
  @js.native
  ...
  @JSImport("xadesjs/build/types/src", "xml.XmlXades.ElementNames")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("xadesjs/build/types/src", "xml.XmlXades.NamespaceURI")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("xadesjs/build/types/src", "xml.XmlXades.SignedPropertiesType")
  @js.native
