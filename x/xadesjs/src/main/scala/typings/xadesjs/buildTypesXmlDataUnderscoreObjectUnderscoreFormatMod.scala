...
@js.native
object buildTypesXmlDataUnderscoreObjectUnderscoreFormatMod extends js.Object {
  @js.native
  class DataObjectFormat () extends XmlObject {
    var Description: String = js.native
    var Encoding: String = js.native
    var MimeType: String = js.native
    var ObjectIdentifier: typings.xadesjs.buildTypesXmlObjectUnderscoreIdentifierMod.ObjectIdentifier = js.native
