...
object buildTypesXmlSignatureUnderscorePolicyUnderscoreIdentifierMod extends js.Object {
  ...
  class SignaturePolicyId () extends XmlObject {
    var SigPolicyHash: typings.xadesjs.buildTypesXmlSignatureUnderscorePolicyUnderscoreIdentifierMod.SigPolicyHash = js.native
    var SigPolicyId: typings.xadesjs.buildTypesXmlSignatureUnderscorePolicyUnderscoreIdentifierMod.SigPolicyId = js.native
    var SigPolicyQualifiers: typings.xadesjs.buildTypesXmlSignatureUnderscorePolicyUnderscoreIdentifierMod.SigPolicyQualifiers = js.native
    var Transforms: typings.xmldsigjs.xmldsigjsMod.Transforms = js.native
  }
  
  @js.native
  class SignaturePolicyIdentifier () extends XmlObject {
    var SignaturePolicyId: typings.xadesjs.buildTypesXmlSignatureUnderscorePolicyUnderscoreIdentifierMod.SignaturePolicyId = js.native
