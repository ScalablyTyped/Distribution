...
object buildTypesXmlObjectIdentifierMod {
  ...
  open class ObjectIdentifier () extends XadesObject {
    ...
    var DocumentationReferences: typings.xadesjs.buildTypesXmlObjectIdentifierMod.DocumentationReferences = js.native
    
    var Identifier: typings.xadesjs.buildTypesXmlObjectIdentifierMod.Identifier = js.native
  }
