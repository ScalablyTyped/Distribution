...
trait OptionsPolicyId extends js.Object {
  ...
  var transforms: js.UndefOr[js.Array[xmldsigjsLib.xmldsigjsMod.OptionsSignTransform]] = js.undefined
}
...
object OptionsPolicyId {
  ...
  def apply(
    ...
    transforms: js.Array[xmldsigjsLib.xmldsigjsMod.OptionsSignTransform] = null
  ): OptionsPolicyId = {
