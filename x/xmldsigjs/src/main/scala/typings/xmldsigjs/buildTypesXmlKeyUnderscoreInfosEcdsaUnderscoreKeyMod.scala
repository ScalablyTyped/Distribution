...
@js.native
object buildTypesXmlKeyUnderscoreInfosEcdsaUnderscoreKeyMod extends js.Object {
  @js.native
  class DomainParameters () extends XmlObject {
    var NamedCurve: typings.xmldsigjs.buildTypesXmlKeyUnderscoreInfosEcdsaUnderscoreKeyMod.NamedCurve = js.native
  }
  
  @js.native
  class EcdsaKeyValue () extends KeyInfoClause {
    var DomainParameters: typings.xmldsigjs.buildTypesXmlKeyUnderscoreInfosEcdsaUnderscoreKeyMod.DomainParameters = js.native
