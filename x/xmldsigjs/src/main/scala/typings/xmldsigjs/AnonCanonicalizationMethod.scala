...
trait AnonCanonicalizationMethod extends js.Object {
...
object AnonCanonicalizationMethod {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonCanonicalizationMethod]
  }
}
