...
import typings.xmldsigjs.buildTypesSignedUnderscoreXmlMod.OptionsSignTransform
import typings.xmldsigjs.buildTypesXmlKeyUnderscoreInfosEcdsaUnderscoreKeyMod._NamedCurveType
