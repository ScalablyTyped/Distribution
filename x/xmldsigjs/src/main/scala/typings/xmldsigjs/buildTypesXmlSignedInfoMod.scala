...
object buildTypesXmlSignedInfoMod {
  ...
  open class SignedInfo () extends XmlSignatureObject {
    ...
    /**
      ...
      */
    var CanonicalizationMethod: typings.xmldsigjs.buildTypesXmlCanonicalizationMethodMod.CanonicalizationMethod = js.native
    ...
    /**
      ...
      */
    var SignatureMethod: typings.xmldsigjs.buildTypesXmlSignatureMethodMod.SignatureMethod = js.native
  }
}
