...
object buildTypesXmlXmlNamesMod {
  ...
  object XmlSignature {
    ...
    inline def ElementNames_=(x: CanonicalizationMethod): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ElementNames")(x.asInstanceOf[js.Any])
