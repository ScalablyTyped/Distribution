...
class XmlCanonicalizer protected () extends js.Object {
  def this(withComments: scala.Boolean, excC14N: scala.Boolean) = this()
  def this(withComments: scala.Boolean, excC14N: scala.Boolean, propagatedNamespaces: xmlDashCoreLib.xmlDashCoreMod.NamespaceManager) = this()
  ...
  /* protected */ def IsTextNode(`type`: xmlDashCoreLib.xmlDashCoreMod.XmlNodeType): scala.Boolean = js.native
  /* protected */ def NormalizeString(input: java.lang.String, `type`: xmlDashCoreLib.xmlDashCoreMod.XmlNodeType): java.lang.String = js.native
  /* protected */ def NormalizeString(input: scala.Null, `type`: xmlDashCoreLib.xmlDashCoreMod.XmlNodeType): java.lang.String = js.native
