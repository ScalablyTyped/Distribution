...
- xmldsigjsLib.xmldsigjsMod.ISignatureAlgorithm because var conflicts: algorithm, namespaceURI. Inlined Sign, Verify, Verify */ @JSImport("xmldsigjs", "SignatureAlgorithm")
@js.native
