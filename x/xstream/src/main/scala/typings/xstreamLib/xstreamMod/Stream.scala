...
class Stream[T] () extends InternalListener[T] {
  ...
  var _d: scala.Boolean = js.native
  ...
  def _add(il: InternalListener[T]): scala.Unit = js.native
  /* CompleteClass */
  override def _c(): scala.Unit = js.native
  /* CompleteClass */
  override def _e(err: js.Any): scala.Unit = js.native
  def _hasNoSinks(x: InternalListener[_], trace: js.Array[_]): scala.Boolean = js.native
  /* protected */ def _map[U](project: js.Function1[/* t */ T, U]): Stream[U] | MemoryStream[U] = js.native
  /* CompleteClass */
  override def _n(v: T): scala.Unit = js.native
  def _pruneCycles(): scala.Unit = js.native
  def _remove(il: InternalListener[T]): scala.Unit = js.native
  def _stopNow(): scala.Unit = js.native
  def _x(): scala.Unit = js.native
  /**
    * Adds a Listener to the Stream.
    *
    * @param {Listener} listener
    */
  def addListener(listener: stdLib.Partial[Listener[T]]): scala.Unit = js.native
  /**
  ...
  def debug(labelOrSpy: java.lang.String): Stream[T] = js.native
  ...
  /**
    ...
    * @return {Stream}
    */
  def drop(amount: scala.Double): Stream[T] = js.native
  /**
  ...
  def filter(passes: js.Function1[/* t */ T, scala.Boolean]): Stream[T] = js.native
  @JSName("filter")
  def filter_ST[S /* <: T */](passes: js.Function1[/* t */ T, /* is S */ scala.Boolean]): Stream[S] = js.native
  /**
    ...
    * @return {Stream}
    */
  def flatten[R](`this`: Stream[Stream[R]]): Stream[R] = js.native
  /**
  ...
  /**
    ...
    */
  def imitate(target: Stream[T]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def removeListener(listener: stdLib.Partial[Listener[T]]): scala.Unit = js.native
  /**
  ...
  def setDebugListener(): scala.Unit = js.native
  /**
    ...
    * @param {Listener<T>} listener
    */
  def setDebugListener(listener: stdLib.Partial[Listener[T]]): scala.Unit = js.native
  /**
    ...
    */
  def shamefullySendComplete(): scala.Unit = js.native
  /**
    ...
    * this Stream.
    */
  def shamefullySendError(error: js.Any): scala.Unit = js.native
  /**
    ...
    * this Stream.
    */
  def shamefullySendNext(value: T): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def subscribe(listener: stdLib.Partial[Listener[T]]): Subscription = js.native
  /**
    ...
    * @return {Stream}
    */
  def take(amount: scala.Double): Stream[T] = js.native
}
