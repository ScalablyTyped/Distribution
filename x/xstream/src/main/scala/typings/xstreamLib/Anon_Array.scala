...
@js.native
trait Anon_Array
  extends org.scalablytyped.runtime.Instantiable0[xstreamLib.xstreamMod.Stream[js.Object]]
     with org.scalablytyped.runtime.Instantiable1[
      /* producer */ xstreamLib.xstreamMod.InternalProducer[/* import warning: RewrittenClass.unapply cls $anonfun was tparam T */ js.Any], 
      xstreamLib.xstreamMod.Stream[js.Object]
    ] {
  /**
  ...
  /**
    ...
    * @return {Stream}
    */
  def fromObservable[T](obs: Anon_Subscribe): xstreamLib.xstreamMod.Stream[T] = js.native
  /**
