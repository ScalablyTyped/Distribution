...
@js.native
trait objectfalseundefinedJsonO extends js.Object {
...
object objectfalseundefinedJsonO {
  ...
  @scala.inline
  implicit class objectfalseundefinedJsonOOps[Self <: objectfalseundefinedJsonO] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setObject(value: `false`): Self = this.set("object", value.asInstanceOf[js.Any])
