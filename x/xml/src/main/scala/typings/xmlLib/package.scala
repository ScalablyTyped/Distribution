...
package object xmlLib {
  ...
  type XmlDesc = Anon_Attr | Anon_Cdata | Anon_AttrCdata | XmlAtom | js.Array[XmlAtom] | (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify XmlDescArray */ js.Any)
