...
trait HTMLTextAreaElement extends HTMLElement {
  ...
  def setSelectionRange_backward(start: scala.Double, end: scala.Double, direction: xtermLib.xtermLibStrings.backward): scala.Unit = js.native
  /**
       * Sets the start and end positions of a selection in a text field.
       * @param start The offset into the text field for the start of the selection.
       * @param end The offset into the text field for the end of the selection.
       ...
       */
  @JSName("setSelectionRange")
  def setSelectionRange_forward(start: scala.Double, end: scala.Double, direction: xtermLib.xtermLibStrings.forward): scala.Unit = js.native
  /**
       * Sets the start and end positions of a selection in a text field.
       * @param start The offset into the text field for the start of the selection.
       * @param end The offset into the text field for the end of the selection.
       ...
       */
  @JSName("setSelectionRange")
  def setSelectionRange_none(start: scala.Double, end: scala.Double, direction: xtermLib.xtermLibStrings.none): scala.Unit = js.native
}
