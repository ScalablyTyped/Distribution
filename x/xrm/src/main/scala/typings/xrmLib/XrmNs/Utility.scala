...
trait Utility extends js.Object {
  /**
           ...
           */
  def alertDialog(message: java.lang.String, onCloseCallback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Closes a progress dialog box.
           */
  def closeProgressIndicator(): scala.Unit = js.native
  /**
  ...
  def confirmDialog(
    ...
    yesCloseCallback: js.Function0[scala.Unit],
    noCloseCallback: js.Function0[scala.Unit]
  ...
  /**
           ...
           */
  def getAllowedStatusTransitions(entityName: java.lang.String, stateCode: scala.Double): xrmLib.XrmNs.AsyncNs.PromiseLike[_] = js.native
  /**
           * Returns the entity metadata for the specified entity.
           * @param entityName The logical name of the entity.
           * @param attributes The attributes to get metadata for.
           */
  def getEntityMetadata(entityName: java.lang.String): xrmLib.XrmNs.AsyncNs.PromiseLike[xrmLib.XrmNs.MetadataNs.EntityMetadata] = js.native
  /**
           * Returns the entity metadata for the specified entity.
           * @param entityName The logical name of the entity.
           * @param attributes The attributes to get metadata for.
           */
  def getEntityMetadata(entityName: java.lang.String, attributes: js.Array[java.lang.String]): xrmLib.XrmNs.AsyncNs.PromiseLike[xrmLib.XrmNs.MetadataNs.EntityMetadata] = js.native
  /**
  ...
  /**
           ...
           */
  def getResourceString(webResourceName: java.lang.String, key: java.lang.String): java.lang.String = js.native
  /**
           ...
           */
  def invokeProcessAction(name: java.lang.String, parameters: xrmLib.XrmNs.CollectionNs.Dictionary[_]): xrmLib.XrmNs.AsyncNs.PromiseLike[_] = js.native
  /**
           ...
           */
  def isActivityType(entityType: java.lang.String): scala.Boolean = js.native
  /**
           * Opens a lookup control to select one or more items.
           * @param lookupOptions Defines the options for opening the lookup dialog
           */
  def lookupObjects(lookupOptions: LookupOptions): xrmLib.XrmNs.AsyncNs.PromiseLike[js.Array[LookupValue]] = js.native
  /**
           ...
           */
  def openEntityForm(name: java.lang.String): scala.Unit = js.native
  /**
           * Opens an entity form.
           * @deprecated Deprecated in v9. Use {@link Xrm.Navigation.openForm} instead.
           * @see {@link https://docs.microsoft.com/en-us/dynamics365/get-started/whats-new/customer-engagement/important-changes-coming#some-client-apis-are-deprecated External Link: Deprecated Client APIs}
           ...
           * @param windowOptions (Optional) Options for controlling the window.
           */
  def openEntityForm(name: java.lang.String, id: java.lang.String): scala.Unit = js.native
  /**
           * Opens an entity form.
           * @deprecated Deprecated in v9. Use {@link Xrm.Navigation.openForm} instead.
           * @see {@link https://docs.microsoft.com/en-us/dynamics365/get-started/whats-new/customer-engagement/important-changes-coming#some-client-apis-are-deprecated External Link: Deprecated Client APIs}
  ...
  def openEntityForm(
    ...
    id: java.lang.String,
    parameters: xrmLib.XrmNs.UtilityNs.FormOpenParameters
  ): scala.Unit = js.native
  /**
           * Opens an entity form.
           * @deprecated Deprecated in v9. Use {@link Xrm.Navigation.openForm} instead.
  ...
  def openEntityForm(
    ...
    id: java.lang.String,
    parameters: xrmLib.XrmNs.UtilityNs.FormOpenParameters,
    windowOptions: xrmLib.XrmNs.UtilityNs.WindowOptions
  ): scala.Unit = js.native
  /**
           * Opens quick create.
           ...
           */
  def openQuickCreate(entityLogicalName: java.lang.String): xrmLib.XrmNs.AsyncNs.PromiseLike[xrmLib.XrmNs.AsyncNs.OpenQuickCreateSuccessCallbackObject] = js.native
  /**
           * Opens quick create.
           * @deprecated Deprecated in v9. Use {@link Xrm.Navigation.openForm} instead with the option {useQuickCreateForm:true}.
           * @see {@link https://docs.microsoft.com/en-us/dynamics365/get-started/whats-new/customer-engagement/important-changes-coming#some-client-apis-are-deprecated External Link: Deprecated Client APIs}
           ...
           * @returns Returns an asynchronous promise.
           */
  def openQuickCreate(entityLogicalName: java.lang.String, createFromEntity: LookupValue): xrmLib.XrmNs.AsyncNs.PromiseLike[xrmLib.XrmNs.AsyncNs.OpenQuickCreateSuccessCallbackObject] = js.native
  /**
           * Opens quick create.
           * @deprecated Deprecated in v9. Use {@link Xrm.Navigation.openForm} instead with the option {useQuickCreateForm:true}.
           * @see {@link https://docs.microsoft.com/en-us/dynamics365/get-started/whats-new/customer-engagement/important-changes-coming#some-client-apis-are-deprecated External Link: Deprecated Client APIs}
  ...
  def openQuickCreate(
    ...
    parameters: xrmLib.XrmNs.UtilityNs.OpenParameters
  ): xrmLib.XrmNs.AsyncNs.PromiseLike[xrmLib.XrmNs.AsyncNs.OpenQuickCreateSuccessCallbackObject] = js.native
  /**
           ...
           * * formid
           */
  def openWebResource(webResourceName: java.lang.String): xrmLib.Window = js.native
  /**
           * Opens an HTML Web Resource in a new browser window.
           * @deprecated Deprecated in v9. Use {@link Xrm.Navigation.openWebResource} instead.
           * @see {@link https://docs.microsoft.com/en-us/dynamics365/get-started/whats-new/customer-engagement/important-changes-coming#some-client-apis-are-deprecated External Link: Deprecated Client APIs}
           ...
           * * formid
           */
  def openWebResource(webResourceName: java.lang.String, webResourceData: java.lang.String): xrmLib.Window = js.native
  /**
           * Opens an HTML Web Resource in a new browser window.
           * @deprecated Deprecated in v9. Use {@link Xrm.Navigation.openWebResource} instead.
           * @see {@link https://docs.microsoft.com/en-us/dynamics365/get-started/whats-new/customer-engagement/important-changes-coming#some-client-apis-are-deprecated External Link: Deprecated Client APIs}
           ...
           * * formid
           */
  def openWebResource(webResourceName: java.lang.String, webResourceData: java.lang.String, width: scala.Double): xrmLib.Window = js.native
  /**
           * Opens an HTML Web Resource in a new browser window.
           * @deprecated Deprecated in v9. Use {@link Xrm.Navigation.openWebResource} instead.
           * @see {@link https://docs.microsoft.com/en-us/dynamics365/get-started/whats-new/customer-engagement/important-changes-coming#some-client-apis-are-deprecated External Link: Deprecated Client APIs}
  ...
  def openWebResource(
    ...
    webResourceData: java.lang.String,
    width: scala.Double,
    height: scala.Double
  ): xrmLib.Window = js.native
  /**
           ...
           */
  def refreshParentGrid(lookupOptions: LookupValue): scala.Unit = js.native
  /**
           ...
           */
  def showProgressIndicator(message: java.lang.String): scala.Unit = js.native
}
