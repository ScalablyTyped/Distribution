...
trait XrmStatic extends js.Object {
  /**
    ...
    */
  var Device: xrmLib.XrmNs.Device
  /**
    ...
    */
  var Encoding: xrmLib.XrmNs.Encoding
  /**
    ...
    */
  var Mobile: xrmLib.XrmNs.Mobile
  /** Provides navigation-related methods.
    */
  var Navigation: xrmLib.XrmNs.Navigation
  /**
  ...
  /**
    ...
    */
  var Utility: xrmLib.XrmNs.Utility
  /**
    ...
    */
  var WebApi: xrmLib.XrmNs.WebApi
}
