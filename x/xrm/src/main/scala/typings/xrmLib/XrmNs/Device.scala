...
trait Device extends js.Object {
  /**
    ...
    */
  def captureAudio(): xrmLib.XrmNs.AsyncNs.PromiseLike[xrmLib.XrmNs.DeviceNs.CaptureFileResponse] = js.native
  /**
    * Invokes the device camera to capture an image.
    * @returns On success, returns Base64 encoded file
    */
  def captureImage(): xrmLib.XrmNs.AsyncNs.PromiseLike[xrmLib.XrmNs.DeviceNs.CaptureFileResponse] = js.native
  def captureImage(imageOptions: xrmLib.XrmNs.DeviceNs.CaptureImageOptions): xrmLib.XrmNs.AsyncNs.PromiseLike[xrmLib.XrmNs.DeviceNs.CaptureFileResponse] = js.native
  /**
    * Invokes the device camera to capture video.
    * @returns On success, returns Base64 encoded file
    */
  def captureVideo(): xrmLib.XrmNs.AsyncNs.PromiseLike[xrmLib.XrmNs.DeviceNs.CaptureFileResponse] = js.native
  /**
    ...
    */
  def getBarcodeValue(): xrmLib.XrmNs.AsyncNs.PromiseLike[java.lang.String] = js.native
  /**
    ...
    */
  def getCurrentPosition(): xrmLib.XrmNs.AsyncNs.PromiseLike[xrmLib.XrmNs.DeviceNs.GetCurrentPositionResponse] = js.native
  /**
