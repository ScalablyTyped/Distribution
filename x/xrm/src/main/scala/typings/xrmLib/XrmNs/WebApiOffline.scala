...
trait WebApiOffline extends js.Object {
  ...
  /**
    ...
    */
  def deleteRecord(entityLogicalName: java.lang.String, id: java.lang.String): xrmLib.XrmNs.AsyncNs.PromiseLike[java.lang.String] = js.native
  /**
    ...
    */
  def retrieveMultipleRecords(entityLogicalName: java.lang.String): xrmLib.XrmNs.AsyncNs.PromiseLike[RetrieveMultipleResult] = js.native
  def retrieveMultipleRecords(entityLogicalName: java.lang.String, options: java.lang.String): xrmLib.XrmNs.AsyncNs.PromiseLike[RetrieveMultipleResult] = js.native
  def retrieveMultipleRecords(entityLogicalName: java.lang.String, options: java.lang.String, maxPageSize: scala.Double): xrmLib.XrmNs.AsyncNs.PromiseLike[RetrieveMultipleResult] = js.native
  /**
    ...
    */
  def retrieveRecord(entityLogicalName: java.lang.String, id: java.lang.String): xrmLib.XrmNs.AsyncNs.PromiseLike[_] = js.native
  def retrieveRecord(entityLogicalName: java.lang.String, id: java.lang.String, options: java.lang.String): xrmLib.XrmNs.AsyncNs.PromiseLike[_] = js.native
  /**
    ...
    */
  def updateRecord(entityLogicalName: java.lang.String, id: java.lang.String, data: js.Any): xrmLib.XrmNs.AsyncNs.PromiseLike[_] = js.native
}
