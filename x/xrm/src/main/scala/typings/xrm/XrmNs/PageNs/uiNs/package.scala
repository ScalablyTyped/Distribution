...
package object uiNs {
  /**
    ...
    */
  type DisplayState = typings.xrm.XrmNs.DisplayState
  /**
    * Form Notification Levels for Xrm.Ui.setFormNotification().
    * @deprecated Use {@link Xrm.FormNotificationLevel} instead.
    */
  type FormNotificationLevel = typings.xrm.XrmNs.FormNotificationLevel
  /**
    ...
    */
  type Grid = typings.xrm.XrmNs.ControlsNs.Grid
  /**
    ...
    */
  type GridEntity = typings.xrm.XrmNs.ControlsNs.GridNs.GridEntity
  /**
    ...
    */
  type GridRow = typings.xrm.XrmNs.ControlsNs.GridNs.GridRow
  /**
    ...
    */
  type GridRowData = typings.xrm.XrmNs.ControlsNs.GridNs.GridRowData
  /**
  ...
  /**
    ...
    */
  type ViewSelector = typings.xrm.XrmNs.ControlsNs.ViewSelector
  /**
    ...
    * @deprecated Use {@link Xrm.Controls.ViewSelectorItem} instead.
    */
  type ViewSelectorItem = typings.xrm.XrmNs.ControlsNs.ViewSelectorItem
}
