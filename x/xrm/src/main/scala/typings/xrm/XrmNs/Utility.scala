...
import typings.xrm.XrmNs.AsyncNs.OpenQuickCreateSuccessCallbackObject
import typings.xrm.XrmNs.AsyncNs.PromiseLike
import typings.xrm.XrmNs.CollectionNs.Dictionary
import typings.xrm.XrmNs.MetadataNs.EntityMetadata
import typings.xrm.XrmNs.UtilityNs.FormOpenParameters
import typings.xrm.XrmNs.UtilityNs.OpenParameters
import typings.xrm.XrmNs.UtilityNs.WindowOptions
