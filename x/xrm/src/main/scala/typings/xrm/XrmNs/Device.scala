...
import typings.xrm.XrmNs.DeviceNs.CaptureFileResponse
import typings.xrm.XrmNs.DeviceNs.CaptureImageOptions
import typings.xrm.XrmNs.DeviceNs.GetCurrentPositionResponse
import typings.xrm.XrmNs.DeviceNs.PickFileOptions
