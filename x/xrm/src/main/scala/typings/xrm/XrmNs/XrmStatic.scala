...
trait XrmStatic extends js.Object {
  /**
    ...
    */
  var Device: typings.xrm.XrmNs.Device
  /**
    ...
    */
  var Encoding: typings.xrm.XrmNs.Encoding
  /**
    ...
    */
  var Mobile: typings.xrm.XrmNs.Mobile
  /** Provides navigation-related methods.
    */
  var Navigation: typings.xrm.XrmNs.Navigation
  /**
    ...
    */
  var Page: typings.xrm.XrmNs.Page
  /**
    ...
    */
  var Panel: typings.xrm.XrmNs.Panel
  /**
    ...
    */
  var Utility: typings.xrm.XrmNs.Utility
  /**
    ...
    */
  var WebApi: typings.xrm.XrmNs.WebApi
}
