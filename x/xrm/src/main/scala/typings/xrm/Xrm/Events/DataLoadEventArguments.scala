...
object DataLoadEventArguments {
  ...
  inline def apply(getDataLoadState: () => FormDataLoadState): DataLoadEventArguments = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DataLoadEventArguments] (val x: Self) extends AnyVal {
