...
object ^ extends js.Object {
  ...
  def parseString(xmlString: java.lang.String, opt: xmltojsonLib.xmltojsonMod.xmltojsonNs.Options): js.Object = js.native
  def parseXml(oXMLParent: stdLib.Document, opt: xmltojsonLib.xmltojsonMod.xmltojsonNs.Options): js.Object = js.native
