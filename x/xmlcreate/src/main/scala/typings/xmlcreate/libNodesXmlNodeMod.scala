...
import typings.xmlcreate.libNodesXmlNodeMod.XmlNode
import typings.xmlcreate.libOptionsMod.IStringOptions
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("xmlcreate/lib/nodes/XmlNode", JSImport.Namespace)
@js.native
object libNodesXmlNodeMod extends js.Object {
  @js.native
  trait XmlNode extends js.Object {
    ...
    def insertChild(node: XmlNode, index: Double): js.UndefOr[XmlNode] = js.native
    /**
    ...
    /**
      ...
      */
    def removeChild(node: XmlNode): Boolean = js.native
    /**
      ...
      */
    def removeChildAtIndex(index: Double): XmlNode = js.native
