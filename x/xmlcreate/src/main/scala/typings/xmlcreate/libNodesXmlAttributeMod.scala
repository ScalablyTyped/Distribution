...
import typings.xmlcreate.libNodesXmlAttributeMod.XmlAttribute
...
object libNodesXmlAttributeMod extends js.Object {
  ...
  trait XmlAttribute
    ...
    /**
      ...
      * @returns The newly created XML declaration.
      */
    def text(text: String): typings.xmlcreate.libNodesXmlAttributeTextMod.default = js.native
    def text(text: String, index: Double): typings.xmlcreate.libNodesXmlAttributeTextMod.default = js.native
  }
