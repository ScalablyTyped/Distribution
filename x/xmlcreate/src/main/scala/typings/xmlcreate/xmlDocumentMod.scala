...
object xmlDocumentMod extends js.Object {
  ...
  trait XmlDocument
    ...
    /**
      ...
      */
    def decl(): typings.xmlcreate.xmlDeclMod.default = js.native
    def decl(options: IDeclarationOptions): typings.xmlcreate.xmlDeclMod.default = js.native
    /**
      ...
      */
    def dtd(name: String): typings.xmlcreate.xmlDtdMod.default = js.native
    def dtd(name: String, sysId: String): typings.xmlcreate.xmlDtdMod.default = js.native
    def dtd(name: String, sysId: String, pubId: String): typings.xmlcreate.xmlDtdMod.default = js.native
    def dtd(name: String, sysId: String, pubId: String, index: Double): typings.xmlcreate.xmlDtdMod.default = js.native
    /**
    ...
    /**
      ...
      * @returns The root element of this document.
      */
    def root(): typings.xmlcreate.xmlElementMod.default = js.native
  }
