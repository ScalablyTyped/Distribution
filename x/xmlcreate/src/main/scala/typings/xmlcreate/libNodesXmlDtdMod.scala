...
import typings.xmlcreate.libNodesXmlDtdMod.XmlDtd
...
object libNodesXmlDtdMod extends js.Object {
  ...
  trait XmlDtd
    ...
    /**
      ...
      */
    def attlist(text: String): typings.xmlcreate.libNodesXmlDtdAttlistMod.default = js.native
    def attlist(text: String, index: Double): typings.xmlcreate.libNodesXmlDtdAttlistMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def element(text: String): typings.xmlcreate.libNodesXmlDtdElementMod.default = js.native
    def element(text: String, index: Double): typings.xmlcreate.libNodesXmlDtdElementMod.default = js.native
    /**
      ...
      */
    def entity(text: String): typings.xmlcreate.libNodesXmlDtdEntityMod.default = js.native
    def entity(text: String, index: Double): typings.xmlcreate.libNodesXmlDtdEntityMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def notation(text: String): typings.xmlcreate.libNodesXmlDtdNotationMod.default = js.native
    def notation(text: String, index: Double): typings.xmlcreate.libNodesXmlDtdNotationMod.default = js.native
    /**
      ...
      */
    def paramEntityRef(entity: String): typings.xmlcreate.libNodesXmlDtdParamEntityRefMod.default = js.native
    def paramEntityRef(entity: String, index: Double): typings.xmlcreate.libNodesXmlDtdParamEntityRefMod.default = js.native
    /**
