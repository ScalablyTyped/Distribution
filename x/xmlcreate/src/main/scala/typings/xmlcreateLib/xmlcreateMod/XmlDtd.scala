...
class XmlDtd protected ()
  extends xmlcreateLib.libNodesXmlDtdMod.default {
  /**
  ...
  def this(name: java.lang.String, sysId: java.lang.String) = this()
  def this(name: java.lang.String, sysId: java.lang.String, pubId: java.lang.String) = this()
}
