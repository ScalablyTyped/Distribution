...
@js.native
object xmlbuilderModMembers extends js.Object {
  def begin(): xmlbuilderLib.xmlbuilderMod.xmlbuilderNs.XMLElementOrXMLNode = js.native
  def create(nameOrObjSpec: ScalablyTyped.runtime.StringDictionary[js.Object]): xmlbuilderLib.xmlbuilderMod.xmlbuilderNs.XMLElementOrXMLNode = js.native
  def create(
    nameOrObjSpec: ScalablyTyped.runtime.StringDictionary[js.Object],
