...
/**
  ...
  */
inline def begin(): typings.xmlbuilder.mod.XMLDocumentCB = typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("begin")().asInstanceOf[typings.xmlbuilder.mod.XMLDocumentCB]
...
inline def begin(options: scala.Unit, onData: typings.xmlbuilder.mod.OnDataCallback): typings.xmlbuilder.mod.XMLDocumentCB = (typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("begin")(options.asInstanceOf[js.Any], onData.asInstanceOf[js.Any])).asInstanceOf[typings.xmlbuilder.mod.XMLDocumentCB]
inline def begin(
  options: scala.Unit,
...
inline def begin(options: scala.Unit, onData: typings.xmlbuilder.mod.OnEndCallback): typings.xmlbuilder.mod.XMLDocumentCB = (typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("begin")(options.asInstanceOf[js.Any], onData.asInstanceOf[js.Any])).asInstanceOf[typings.xmlbuilder.mod.XMLDocumentCB]
inline def begin(
  options: scala.Unit,
  onData: typings.xmlbuilder.mod.OnEndCallback,
  onEnd: typings.xmlbuilder.mod.OnEndCallback
): typings.xmlbuilder.mod.XMLDocumentCB = (typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("begin")(options.asInstanceOf[js.Any], onData.asInstanceOf[js.Any], onEnd.asInstanceOf[js.Any])).asInstanceOf[typings.xmlbuilder.mod.XMLDocumentCB]
inline def begin(options: typings.xmlbuilder.mod.BeginOptions): typings.xmlbuilder.mod.XMLDocumentCB = typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("begin")(options.asInstanceOf[js.Any]).asInstanceOf[typings.xmlbuilder.mod.XMLDocumentCB]
inline def begin(
...
inline def begin(options: typings.xmlbuilder.mod.OnDataCallback): typings.xmlbuilder.mod.XMLDocumentCB = typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("begin")(options.asInstanceOf[js.Any]).asInstanceOf[typings.xmlbuilder.mod.XMLDocumentCB]
inline def begin(
...
/**
  ...
  * @param options - create options
  */
inline def begin_XMLDocument(): typings.xmlbuilder.mod.XMLDocument = typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("begin")().asInstanceOf[typings.xmlbuilder.mod.XMLDocument]
inline def begin_XMLDocument(options: typings.xmlbuilder.mod.BeginOptions): typings.xmlbuilder.mod.XMLDocument = typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("begin")(options.asInstanceOf[js.Any]).asInstanceOf[typings.xmlbuilder.mod.XMLDocument]
...
/**
  ...
  * @param options - create options
  */
inline def create(nameOrObject: java.lang.String): typings.xmlbuilder.mod.XMLElement = typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("create")(nameOrObject.asInstanceOf[js.Any]).asInstanceOf[typings.xmlbuilder.mod.XMLElement]
inline def create(
...
inline def create(nameOrObject: org.scalablytyped.runtime.StringDictionary[js.Object]): typings.xmlbuilder.mod.XMLElement = typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("create")(nameOrObject.asInstanceOf[js.Any]).asInstanceOf[typings.xmlbuilder.mod.XMLElement]
inline def create(
...
/**
  ...
  */
inline def streamWriter(stream: typings.node.streamMod.Writable): typings.xmlbuilder.mod.XMLWriter = typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("streamWriter")(stream.asInstanceOf[js.Any]).asInstanceOf[typings.xmlbuilder.mod.XMLWriter]
...
/**
  ...
  * @param options - writer options
  */
inline def stringWriter(): typings.xmlbuilder.mod.XMLWriter = typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("stringWriter")().asInstanceOf[typings.xmlbuilder.mod.XMLWriter]
inline def stringWriter(options: typings.xmlbuilder.mod.WriterOptions): typings.xmlbuilder.mod.XMLWriter = typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("stringWriter")(options.asInstanceOf[js.Any]).asInstanceOf[typings.xmlbuilder.mod.XMLWriter]
