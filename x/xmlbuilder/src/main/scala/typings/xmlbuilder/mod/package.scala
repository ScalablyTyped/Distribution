...
package object mod {
  ...
  @scala.inline
  def begin(options: js.UndefOr[scala.Nothing], onData: typings.xmlbuilder.mod.OnDataCallback): typings.xmlbuilder.mod.XMLDocumentCB = (typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("begin")(options.asInstanceOf[js.Any], onData.asInstanceOf[js.Any])).asInstanceOf[typings.xmlbuilder.mod.XMLDocumentCB]
  @scala.inline
  def begin(
    options: js.UndefOr[scala.Nothing],
  ...
  @scala.inline
  def begin(options: js.UndefOr[scala.Nothing], onData: typings.xmlbuilder.mod.OnEndCallback): typings.xmlbuilder.mod.XMLDocumentCB = (typings.xmlbuilder.mod.^.asInstanceOf[js.Dynamic].applyDynamic("begin")(options.asInstanceOf[js.Any], onData.asInstanceOf[js.Any])).asInstanceOf[typings.xmlbuilder.mod.XMLDocumentCB]
  @scala.inline
  def begin(
    options: js.UndefOr[scala.Nothing],
