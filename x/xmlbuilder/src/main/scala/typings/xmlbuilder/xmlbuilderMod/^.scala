...
object ^ extends js.Object {
  /**
    ...
    */
  def begin(): XMLDocumentCB = js.native
  def begin(options: BeginOptions): XMLDocumentCB = js.native
  ...
  /**
    ...
    */
  @JSName("begin")
  def begin_XMLDocument(): XMLDocument = js.native
  @JSName("begin")
  def begin_XMLDocument(options: BeginOptions): XMLDocument = js.native
  /**
    ...
    * @param options - create options
    */
  def create(nameOrObject: String): XMLElement = js.native
  def create(nameOrObject: String, xmldecOrOptions: CreateOptions): XMLElement = js.native
  def create(nameOrObject: String, xmldecOrOptions: CreateOptions, doctypeOrOptions: CreateOptions): XMLElement = js.native
  def create(
    nameOrObject: String,
  ...
  def create(nameOrObject: StringDictionary[js.Object]): XMLElement = js.native
  def create(nameOrObject: StringDictionary[js.Object], xmldecOrOptions: CreateOptions): XMLElement = js.native
  def create(
  ...
  /**
    ...
    */
  def streamWriter(stream: Writable): XMLWriter = js.native
  def streamWriter(stream: Writable, options: WriterOptions): XMLWriter = js.native
  /**
