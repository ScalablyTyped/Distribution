...
import typings.xmlbuilder.Anon_NData
...
class XMLDocumentCB () extends js.Object {
  ...
  def ent(name: String, value: Anon_NData): XMLDocumentCB = js.native
  /**
  ...
  def entity(name: String, value: Anon_NData): XMLDocumentCB = js.native
  ...
  def not(name: String, value: Anon_PubID): XMLDocumentCB = js.native
  /**
    ...
    * @returns the document builder object
    */
  def notation(name: String, value: Anon_PubID): XMLDocumentCB = js.native
  /**
  ...
  def pEntity(name: String, value: Anon_PubID): XMLDocumentCB = js.native
  def pent(name: String, value: String): XMLDocumentCB = js.native
  def pent(name: String, value: Anon_PubID): XMLDocumentCB = js.native
