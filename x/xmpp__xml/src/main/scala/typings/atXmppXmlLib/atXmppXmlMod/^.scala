...
object ^ extends js.Object {
  ...
  def apply(name: java.lang.String): atXmppXmlLib.atXmppXmlMod.xmlNs.Element = js.native
  def apply(
    name: java.lang.String,
    attrs: java.lang.String | org.scalablytyped.runtime.StringDictionary[js.Any],
    children: atXmppXmlLib.atXmppXmlMod.xmlNs.ElementChild*
  ): atXmppXmlLib.atXmppXmlMod.xmlNs.Element = js.native
  def x(name: java.lang.String): atXmppXmlLib.atXmppXmlMod.xmlNs.Element = js.native
  def x(
    name: java.lang.String,
