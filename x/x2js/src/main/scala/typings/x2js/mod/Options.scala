...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableToStringFunc)) __obj.updateDynamic("enableToStringFunc")(enableToStringFunc.get.asInstanceOf[js.Any])
    if (!js.isUndefined(escapeMode)) __obj.updateDynamic("escapeMode")(escapeMode.get.asInstanceOf[js.Any])
    if (!js.isUndefined(ignoreRoot)) __obj.updateDynamic("ignoreRoot")(ignoreRoot.get.asInstanceOf[js.Any])
    if (!js.isUndefined(keepCData)) __obj.updateDynamic("keepCData")(keepCData.get.asInstanceOf[js.Any])
    if (!js.isUndefined(keepText)) __obj.updateDynamic("keepText")(keepText.get.asInstanceOf[js.Any])
    if (!js.isUndefined(selfClosingElements)) __obj.updateDynamic("selfClosingElements")(selfClosingElements.get.asInstanceOf[js.Any])
    if (!js.isUndefined(skipEmptyTextNodesForObj)) __obj.updateDynamic("skipEmptyTextNodesForObj")(skipEmptyTextNodesForObj.get.asInstanceOf[js.Any])
    if (!js.isUndefined(stripWhitespaces)) __obj.updateDynamic("stripWhitespaces")(stripWhitespaces.get.asInstanceOf[js.Any])
