...
package object mod {
  ...
  def tag(): js.Function2[
    ...
    /* repeated */ js.Any, 
    typings.std.RegExp
  ] = typings.xregexp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("tag")().asInstanceOf[js.Function2[
    /* literals */ typings.std.TemplateStringsArray, 
    /* repeated */ js.Any, 
    typings.std.RegExp
  ]]
  ...
  def tag(flags: java.lang.String): js.Function2[
    ...
    /* repeated */ js.Any, 
    typings.std.RegExp
  ] = typings.xregexp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("tag")(flags.asInstanceOf[js.Any]).asInstanceOf[js.Function2[
    /* literals */ typings.std.TemplateStringsArray, 
    /* repeated */ js.Any, 
    typings.std.RegExp
  ]]
