...
import typings.xregexp.mod.Feature
import typings.xregexp.mod.FeatureOptions
import typings.xregexp.mod.TokenFlag
import typings.xregexp.mod.TokenFlagLOWER
import typings.xregexp.mod.TokenFlagNUMBER
import typings.xregexp.mod.TokenFlagOTHER
import typings.xregexp.mod.TokenFlagUPPER
import typings.xregexp.mod.TokenScope
import typings.xregexp.mod.TokenScopeOption
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object xregexpStrings {
  
  @js.native
  sealed trait default
    extends StObject
       with TokenScope
       with TokenScopeOption
  ...
  sealed trait astral
    extends StObject
       with Feature
  inline def astral: astral = "astral".asInstanceOf[astral]
  
  @js.native
  sealed trait `astral namespacing`
    extends StObject
       with FeatureOptions
  inline def `astral namespacing`: `astral namespacing` = ("astral namespacing").asInstanceOf[`astral namespacing`]
  ...
  @js.native
  sealed trait namespacing
    extends StObject
       with Feature
  inline def namespacing: namespacing = "namespacing".asInstanceOf[namespacing]
  
  @js.native
  sealed trait `namespacing astral`
    extends StObject
       with FeatureOptions
  inline def `namespacing astral`: `namespacing astral` = ("namespacing astral").asInstanceOf[`namespacing astral`]
