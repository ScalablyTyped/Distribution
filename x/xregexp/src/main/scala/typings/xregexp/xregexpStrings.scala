...
object xregexpStrings {
  ...
  @js.native
  sealed trait all extends TokenScopeOption
  
  @js.native
  sealed trait astral extends Feature
  
  @js.native
  sealed trait `astral namespacing` extends FeatureOptions
  ...
  @js.native
  sealed trait namespacing extends Feature
  
  @js.native
  sealed trait `namespacing astral` extends FeatureOptions
