...
import typings.x509Js.anon.CountryName
...
object mod {
  ...
  object Certificate {
    ...
    implicit open class MutableBuilder[Self <: Certificate] (val x: Self) extends AnyVal {
      ...
      inline def setIssuer(value: CountryName): Self = StObject.set(x, "issuer", value.asInstanceOf[js.Any])
      ...
      inline def setOcspListVarargs(value: String*): Self = StObject.set(x, "ocspList", js.Array(value*))
