...
object global {
  ...
  object XDate {
    ...
    inline def UTC(
      ...
      seconds: Double,
      milliseconds: Double
    ): typings.xdate.mod.XDate = (^.asInstanceOf[js.Dynamic].applyDynamic("UTC")(year.asInstanceOf[js.Any], month.asInstanceOf[js.Any], date.asInstanceOf[js.Any], hours.asInstanceOf[js.Any], minutes.asInstanceOf[js.Any], seconds.asInstanceOf[js.Any], milliseconds.asInstanceOf[js.Any])).asInstanceOf[typings.xdate.mod.XDate]
    /* static member */
    ...
    /*
      ...
      */
    /* static member */
    inline def today(): typings.xdate.mod.XDate = ^.asInstanceOf[js.Dynamic].applyDynamic("today")().asInstanceOf[typings.xdate.mod.XDate]
  }
}
