...
version := "2.0-dt-20190212Z-040617"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "material-ui" % "0.21-dt-20190225Z-3a110e",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190226Z-1549d2",
  "org.scalablytyped" %%% "react" % "16.8-dt-20190322Z-acd0bd",
  "org.scalablytyped" %%% "react-addons-linked-state-mixin" % "0.14-dt-20190322Z-25e716",
