...
version := "2.0-dt-20190212Z-1c1218"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "material-ui" % "0.21-dt-20190225Z-8f2bb6",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190226Z-66c044",
  "org.scalablytyped" %%% "react" % "16.8-dt-20190226Z-9e9d73",
  "org.scalablytyped" %%% "react-addons-linked-state-mixin" % "0.14-dt-20180806Z-26d4a7",
