...
object esNoticeMod extends Shortcut {
  ...
  @js.native
  val default: ForwardRefExoticComponent[NoticePropstimesnumberund] = js.native
  ...
  object NoticeConfig {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: NoticeConfig] (val x: Self) extends AnyVal {
  ...
  type _To = ForwardRefExoticComponent[NoticePropstimesnumberund]
  
  /* This means you don't have to write `default`, but can instead just say `esNoticeMod.foo` */
  override def _to: ForwardRefExoticComponent[NoticePropstimesnumberund] = default
}
