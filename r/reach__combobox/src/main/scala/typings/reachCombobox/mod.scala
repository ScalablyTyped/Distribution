...
object mod {
  ...
  @js.native
  val Combobox: FC[ComboboxProps] = js.native
  
  @JSImport("@reach/combobox", "ComboboxInput")
  @js.native
  val ComboboxInput: FC[ComboboxInputProps] = js.native
  
  @JSImport("@reach/combobox", "ComboboxList")
  @js.native
  val ComboboxList: FC[ComboboxListProps] = js.native
  
  @JSImport("@reach/combobox", "ComboboxOption")
  @js.native
  val ComboboxOption: FC[ComboboxOptionProps] = js.native
  
  @JSImport("@reach/combobox", "ComboboxOptionText")
  @js.native
  val ComboboxOptionText: FC[js.Object] = js.native
  
  @JSImport("@reach/combobox", "ComboboxPopover")
  @js.native
  val ComboboxPopover: FC[ComboboxPopoverProps] = js.native
  ...
  object ComboboxProps {
    ...
    extension [Self <: ComboboxProps](x: Self) {
      ...
      inline def setOnSelect(value: /* value */ String => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
