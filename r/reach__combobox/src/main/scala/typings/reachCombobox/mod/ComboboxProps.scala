...
import typings.reachCombobox.reachComboboxStrings.`additions removals`
import typings.reachCombobox.reachComboboxStrings.`additions text`
import typings.reachCombobox.reachComboboxStrings.`inline`
import typings.reachCombobox.reachComboboxStrings.`removals additions`
import typings.reachCombobox.reachComboboxStrings.`removals text`
import typings.reachCombobox.reachComboboxStrings.`text additions`
import typings.reachCombobox.reachComboboxStrings.`text removals`
...
trait ComboboxProps extends js.Object {
  ...
  var onSelect: js.UndefOr[js.Function1[/* value */ String, Unit]] = js.native
...
object ComboboxProps {
  ...
  implicit class ComboboxPropsOps[Self <: ComboboxProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnSelect(value: /* value */ String => Unit): Self = this.set("onSelect", js.Any.fromFunction1(value))
