package typings
package reactDashMediaDashHook2Lib.esMod
...
trait UseMediaProps extends js.Object {
  ...
  var query: js.UndefOr[
    java.lang.String | reactDashMediaDashHook2Lib.esMediaMod.MediaQueryProperties | js.Array[reactDashMediaDashHook2Lib.esMediaMod.MediaQueryProperties]
  ] = js.undefined
...
object UseMediaProps {
  ...
  def apply(
    ...
    query: java.lang.String | reactDashMediaDashHook2Lib.esMediaMod.MediaQueryProperties | js.Array[reactDashMediaDashHook2Lib.esMediaMod.MediaQueryProperties] = null,
