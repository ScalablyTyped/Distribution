...
trait PlotParams extends js.Object {
  ...
  var config: js.UndefOr[stdLib.Partial[_]] = js.undefined
  var data: js.Array[_]
  /**
  ...
  var onAnimatingFrame: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  ...
  var onButtonClicked: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  var onClick: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  var onClickAnnotation: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  ...
  var onHover: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  /**
  ...
  var onLegendClick: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Boolean]] = js.undefined
  var onLegendDoubleClick: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Boolean]] = js.undefined
  /**
  ...
  var onRelayout: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  var onRestyle: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  var onSelected: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  var onSelecting: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  var onSliderChange: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  var onSliderEnd: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  var onSliderStart: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  ...
  var onUnhover: js.UndefOr[js.Function1[/* event */ stdLib.Readonly[_], scala.Unit]] = js.undefined
  /**
