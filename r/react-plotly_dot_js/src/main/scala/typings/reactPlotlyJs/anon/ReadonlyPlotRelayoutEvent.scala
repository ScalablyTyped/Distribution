...
import typings.plotlyJs.mod.Template
...
import typings.reactPlotlyJs.reactPlotlyJsStrings.any
import typings.reactPlotlyJs.reactPlotlyJsStrings.closest
import typings.reactPlotlyJs.reactPlotlyJsStrings.d
import typings.reactPlotlyJs.reactPlotlyJsStrings.event
import typings.reactPlotlyJs.reactPlotlyJsStrings.eventPlussignselect
import typings.reactPlotlyJs.reactPlotlyJsStrings.fraction
import typings.reactPlotlyJs.reactPlotlyJsStrings.group
import typings.reactPlotlyJs.reactPlotlyJsStrings.h
import typings.reactPlotlyJs.reactPlotlyJsStrings.lasso
import typings.reactPlotlyJs.reactPlotlyJsStrings.none
import typings.reactPlotlyJs.reactPlotlyJsStrings.orbit
import typings.reactPlotlyJs.reactPlotlyJsStrings.overlay
import typings.reactPlotlyJs.reactPlotlyJsStrings.pan
import typings.reactPlotlyJs.reactPlotlyJsStrings.percent
import typings.reactPlotlyJs.reactPlotlyJsStrings.relative
import typings.reactPlotlyJs.reactPlotlyJsStrings.select
import typings.reactPlotlyJs.reactPlotlyJsStrings.stack
import typings.reactPlotlyJs.reactPlotlyJsStrings.turntable
import typings.reactPlotlyJs.reactPlotlyJsStrings.v
import typings.reactPlotlyJs.reactPlotlyJsStrings.x
import typings.reactPlotlyJs.reactPlotlyJsStrings.y
...
trait ReadonlyPlotRelayoutEvent extends StObject {
  ...
  val boxmode: js.UndefOr[group | overlay] = js.undefined
  
  val calendar: js.UndefOr[Calendar] = js.undefined
  
  val clickmode: js.UndefOr[event | select | eventPlussignselect | none] = js.undefined
  
  val colorway: js.UndefOr[js.Array[String]] = js.undefined
  
  val datarevision: js.UndefOr[Double | String] = js.undefined
  
  val dragmode: js.UndefOr[zoom | pan | select | lasso | orbit | turntable | `false`] = js.undefined
  
  val editrevision: js.UndefOr[Double | String] = js.undefined
  ...
  val modebar: js.UndefOr[PartialModeBar] = js.undefined
  ...
  val selectionrevision: js.UndefOr[Double | String] = js.undefined
  ...
  val uirevision: js.UndefOr[Double | String] = js.undefined
  
  val updatemenus: js.UndefOr[js.Array[PartialUpdateMenu]] = js.undefined
...
object ReadonlyPlotRelayoutEvent {
  ...
  inline def apply(): ReadonlyPlotRelayoutEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReadonlyPlotRelayoutEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ReadonlyPlotRelayoutEvent] (val x: Self) extends AnyVal {
    ...
    inline def setBargroupgapUndefined: Self = StObject.set(x, "bargroupgap", js.undefined)
    
    inline def setBarmode(value: stack | group | overlay | relative): Self = StObject.set(x, "barmode", value.asInstanceOf[js.Any])
    
    inline def setBarmodeUndefined: Self = StObject.set(x, "barmode", js.undefined)
    ...
    inline def setHovermode(
      value: closest | typings.reactPlotlyJs.reactPlotlyJsStrings.x | y | (`x unified`) | (`y unified`) | `false`
    ...
    inline def setSubplotUndefined: Self = StObject.set(x, "subplot", js.undefined)
    
    inline def setTemplate(value: Template): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
    
    inline def setTemplateUndefined: Self = StObject.set(x, "template", js.undefined)
    
    inline def setTernary(value: js.Object): Self = StObject.set(x, "ternary", value.asInstanceOf[js.Any])
    
    inline def setTernaryUndefined: Self = StObject.set(x, "ternary", js.undefined)
    ...
    inline def setXaxisDotautorangeUndefined: Self = StObject.set(x, "xaxis.autorange", js.undefined)
    
    inline def setXaxisDotrange(value: js.Tuple2[Datum, Datum]): Self = StObject.set(x, "xaxis.range", value.asInstanceOf[js.Any])
    
    inline def setXaxisDotrangeUndefined: Self = StObject.set(x, "xaxis.range", js.undefined)
    
    inline def `setXaxisDotrange[0]`(value: Double): Self = StObject.set(x, "xaxis.range[0]", value.asInstanceOf[js.Any])
    
    inline def `setXaxisDotrange[0]Undefined`: Self = StObject.set(x, "xaxis.range[0]", js.undefined)
    
    inline def `setXaxisDotrange[1]`(value: Double): Self = StObject.set(x, "xaxis.range[1]", value.asInstanceOf[js.Any])
    
    inline def `setXaxisDotrange[1]Undefined`: Self = StObject.set(x, "xaxis.range[1]", js.undefined)
    
    inline def setXaxisDottitle(value: String): Self = StObject.set(x, "xaxis.title", value.asInstanceOf[js.Any])
    
    inline def setXaxisDottitleUndefined: Self = StObject.set(x, "xaxis.title", js.undefined)
    
    inline def setXaxisDottype(value: AxisType): Self = StObject.set(x, "xaxis.type", value.asInstanceOf[js.Any])
    
    inline def setXaxisDottypeUndefined: Self = StObject.set(x, "xaxis.type", js.undefined)
    ...
    inline def setYaxisDotautorangeUndefined: Self = StObject.set(x, "yaxis.autorange", js.undefined)
    
    inline def setYaxisDotrange(value: js.Tuple2[Datum, Datum]): Self = StObject.set(x, "yaxis.range", value.asInstanceOf[js.Any])
    
    inline def setYaxisDotrangeUndefined: Self = StObject.set(x, "yaxis.range", js.undefined)
    
    inline def `setYaxisDotrange[0]`(value: Double): Self = StObject.set(x, "yaxis.range[0]", value.asInstanceOf[js.Any])
    
    inline def `setYaxisDotrange[0]Undefined`: Self = StObject.set(x, "yaxis.range[0]", js.undefined)
    
    inline def `setYaxisDotrange[1]`(value: Double): Self = StObject.set(x, "yaxis.range[1]", value.asInstanceOf[js.Any])
    
    inline def `setYaxisDotrange[1]Undefined`: Self = StObject.set(x, "yaxis.range[1]", js.undefined)
    
    inline def setYaxisDottitle(value: String): Self = StObject.set(x, "yaxis.title", value.asInstanceOf[js.Any])
    
    inline def setYaxisDottitleUndefined: Self = StObject.set(x, "yaxis.title", js.undefined)
    
    inline def setYaxisDottype(value: AxisType): Self = StObject.set(x, "yaxis.type", value.asInstanceOf[js.Any])
    
    inline def setYaxisDottypeUndefined: Self = StObject.set(x, "yaxis.type", js.undefined)
