...
version := "2.2-dt-20190621Z-8714e0"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "d3-axis" % "1.0-dt-20190212Z-710e68",
  "org.scalablytyped" %%% "d3-brush" % "1.0-dt-20190212Z-cf76f2",
  ...
  "org.scalablytyped" %%% "plotly_dot_js" % "1.44-dt-20190612Z-97345a",
