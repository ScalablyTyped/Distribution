...
import typings.reactDashNativeDashSnapDashCarousel.Anon_Index
import typings.reactDashNativeDashSnapDashCarousel.Anon_InputRange
import typings.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.center
import typings.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.decay
import typings.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.end
import typings.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.spring
import typings.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.stack
import typings.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.start
import typings.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.timing
import typings.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.tinder
...
trait CarouselProps[T] extends Props[ScrollViewProps] {
  ...
  var layout: js.UndefOr[
    typings.reactDashNativeDashSnapDashCarousel.reactDashNativeDashSnapDashCarouselStrings.default | stack | tinder
  ] = js.native
  /**
  ...
  /**
    ...
    */
  def renderItem(item: Anon_Index[T]): ReactNode = js.native
  def renderItem(item: Anon_Index[T], parallaxProps: AdditionalParallaxProps): ReactNode = js.native
}
