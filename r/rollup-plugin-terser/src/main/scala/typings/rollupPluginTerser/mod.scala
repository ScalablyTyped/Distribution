...
import typings.terser.mod.MangleOptions
import typings.terser.mod.ParseOptions
...
object mod {
  ...
  inline def terser(): Plugin = ^.asInstanceOf[js.Dynamic].applyDynamic("terser")().asInstanceOf[Plugin]
  inline def terser(options: Options): Plugin = ^.asInstanceOf[js.Dynamic].applyDynamic("terser")(options.asInstanceOf[js.Any]).asInstanceOf[Plugin]
  
  /* Inlined parent std.Omit<terser.terser.MinifyOptions, 'sourceMap'> */
