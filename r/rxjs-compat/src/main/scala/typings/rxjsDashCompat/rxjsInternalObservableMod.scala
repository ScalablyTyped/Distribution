...
@js.native
object rxjsInternalObservableMod extends js.Object {
  @js.native
  trait Observable[T] extends js.Object {
    @JSName("_catch")
    var _catch_Original: Fn_Caught = js.native
    @JSName("_do")
    var _do_Original: Fn_Complete = js.native
    @JSName("_finally")
    var _finally_Original: Fn_Callback = js.native
    @JSName("_switch")
    var _switch_Original: Fn_This = js.native
    @JSName("auditTime")
    var auditTime_Original: Fn_Duration = js.native
    @JSName("audit")
    var audit_Original: Fn_DurationSelector = js.native
    @JSName("bufferCount")
    var bufferCount_Original: Fn_BufferSize = js.native
    @JSName("bufferTime")
    var bufferTime_Original: Fn_BufferCreationInterval = js.native
    @JSName("bufferToggle")
    var bufferToggle_Original: Fn_ClosingSelector = js.native
    @JSName("bufferWhen")
    var bufferWhen_Original: Fn_ClosingSelectorThis = js.native
    @JSName("buffer")
    var buffer_Original: Fn_ClosingNotifier = js.native
    @JSName("catch")
    var catch_Original: Fn_Caught = js.native
    @JSName("combineAll")
    var combineAll_Original: Fn_Project = js.native
    @JSName("combineLatest")
    var combineLatest_Original: Fn_Array = js.native
    @JSName("concatAll")
    var concatAll_Original: Fn_This = js.native
    @JSName("concatMapTo")
    var concatMapTo_Original: Fn_InnerObservable = js.native
    @JSName("concatMap")
    var concatMap_Original: Fn_Index = js.native
    @JSName("concat")
    var concat_Original: Fn_Observables = js.native
    @JSName("count")
    var count_Original: Fn_IndexPredicate = js.native
    @JSName("debounceTime")
    var debounceTime_Original: Fn_DueTime = js.native
    @JSName("debounce")
    var debounce_Original: Fn_DurationSelector = js.native
    @JSName("defaultIfEmpty")
    var defaultIfEmpty_Original: Fn_DefaultValue = js.native
    @JSName("delayWhen")
    var delayWhen_Original: Fn_DelayDurationSelector = js.native
    @JSName("delay")
    var delay_Original: Fn_Delay = js.native
    @JSName("dematerialize")
    var dematerialize_Original: Fn_ThisAny = js.native
    @JSName("distinctUntilChanged")
    var distinctUntilChanged_Original: Fn_Compare = js.native
    @JSName("distinctUntilKeyChanged")
    var distinctUntilKeyChanged_Original: Fn_CompareKey = js.native
    @JSName("distinct")
    var distinct_Original: Fn_Flushes = js.native
    @JSName("do")
    var do_Original: Fn_Complete = js.native
    @JSName("elementAt")
    var elementAt_Original: Fn_DefaultValueIndex = js.native
    @JSName("every")
    var every_Original: Fn_IndexPredicateSource = js.native
    @JSName("exhaustMap")
    var exhaustMap_Original: Fn_Index = js.native
    @JSName("exhaust")
    var exhaust_Original: Fn_This = js.native
    @JSName("expand")
    var expand_Original: Fn_Concurrent = js.native
    @JSName("filter")
    var filter_Original: Fn_IndexPredicateThis = js.native
    @JSName("finally")
    var finally_Original: Fn_Callback = js.native
    @JSName("findIndex")
    var findIndex_Original: Fn_IndexPredicateSource = js.native
    @JSName("find")
    var find_Original: Fn_IndexPredicateThis = js.native
    @JSName("first")
    var first_Original: Fn_DefaultValueIndexPredicate = js.native
    @JSName("flatMapTo")
    var flatMapTo_Original: Fn_ConcurrentInnerObservable = js.native
    @JSName("flatMap")
    var flatMap_Original: Fn_ConcurrentIndex = js.native
    @JSName("groupBy")
    var groupBy_Original: Fn_DurationSelectorElementSelector = js.native
    ...
    @JSName("isEmpty")
    var isEmpty_Original: Fn_ThisAny = js.native
    @JSName("last")
    var last_Original: Fn_DefaultValueIndexPredicate = js.native
    @JSName("letBind")
    var letBind_Original: Fn_Func = js.native
    @JSName("let")
    var let_Original: Fn_Func = js.native
    @JSName("mapTo")
    var mapTo_Original: Fn_ThisValue = js.native
    @JSName("map")
    var map_Original: Fn_IndexProject = js.native
    @JSName("materialize")
    var materialize_Original: Fn_ThisAny = js.native
    @JSName("max")
    var max_Original: Fn_Comparer = js.native
    @JSName("mergeAll")
    var mergeAll_Original: Fn_ConcurrentThis = js.native
    @JSName("mergeMapTo")
    var mergeMapTo_Original: Fn_ConcurrentInnerObservable = js.native
    @JSName("mergeMap")
    var mergeMap_Original: Fn_ConcurrentIndex = js.native
    @JSName("mergeScan")
    var mergeScan_Original: Fn_Acc = js.native
    @JSName("merge")
    var merge_Original: Fn_ConcurrentObservables = js.native
    @JSName("min")
    var min_Original: Fn_Comparer = js.native
    @JSName("multicast")
    var multicast_Original: Fn_Selector = js.native
    @JSName("observeOn")
    var observeOn_Original: Fn_DelayScheduler = js.native
    @JSName("onErrorResumeNext")
    var onErrorResumeNext_Original: Fn_ArrayObservables = js.native
    @JSName("pairwise")
    var pairwise_Original: Fn_ThisAny = js.native
    @JSName("partition")
    var partition_Original: Fn_IndexPredicateThisThisArg = js.native
    @JSName("pluck")
    var pluck_Original: Fn_Properties = js.native
    @JSName("publishBehavior")
    var publishBehavior_Original: Fn_ThisValueAny = js.native
    @JSName("publishLast")
    var publishLast_Original: Fn_ThisAny = js.native
    @JSName("publishReplay")
    var publishReplay_Original: Fn_BufferSizeScheduler = js.native
    @JSName("publish")
    var publish_Original: Fn_SelectorSource = js.native
    @JSName("race")
    var race_Original: Fn_ObservablesThis = js.native
    @JSName("reduce")
    var reduce_Original: Fn_AccAccumulator = js.native
    @JSName("repeatWhen")
    var repeatWhen_Original: Fn_Notifications = js.native
    @JSName("repeat")
    var repeat_Original: Fn_Count = js.native
    @JSName("retryWhen")
    var retryWhen_Original: Fn_Errors = js.native
    @JSName("retry")
    var retry_Original: Fn_Count = js.native
    @JSName("sampleTime")
    var sampleTime_Original: Fn_Period = js.native
    @JSName("sample")
    var sample_Original: Fn_Notifier = js.native
    @JSName("scan")
    var scan_Original: Fn_AccAccumulator = js.native
    @JSName("sequenceEqual")
    var sequenceEqual_Original: Fn_A = js.native
    @JSName("shareReplay")
    var shareReplay_Original: Fn_BufferSizeConfig = js.native
    @JSName("share")
    var share_Original: Fn_ThisAny = js.native
    @JSName("single")
    var single_Original: Fn_IndexPredicate = js.native
    @JSName("skipLast")
    var skipLast_Original: Fn_CountThis = js.native
    @JSName("skipUntil")
    var skipUntil_Original: Fn_Notifier = js.native
    @JSName("skipWhile")
    var skipWhile_Original: Fn_IndexPredicateThisValue = js.native
    @JSName("skip")
    var skip_Original: Fn_CountThis = js.native
    @JSName("startWith")
    var startWith_Original: Fn_ArrayScheduler = js.native
    @JSName("subscribeOn")
    var subscribeOn_Original: Fn_DelayScheduler = js.native
    @JSName("switchMapTo")
    var switchMapTo_Original: Fn_InnerIndex = js.native
    @JSName("switchMap")
    var switchMap_Original: Fn_Index = js.native
    @JSName("switch")
    var switch_Original: Fn_This = js.native
    @JSName("takeLast")
    var takeLast_Original: Fn_CountThis = js.native
    @JSName("takeUntil")
    var takeUntil_Original: Fn_Notifier = js.native
    @JSName("takeWhile")
    var takeWhile_Original: Fn_IndexPredicateThisValue = js.native
    @JSName("take")
    var take_Original: Fn_CountThis = js.native
    @JSName("throttleTime")
    var throttleTime_Original: Fn_ConfigDuration = js.native
    @JSName("throttle")
    var throttle_Original: Fn_Config = js.native
    @JSName("timeInterval")
    var timeInterval_Original: Fn_Scheduler = js.native
    @JSName("timeoutWith")
    var timeoutWith_Original: Fn_DueScheduler = js.native
    @JSName("timeout")
    var timeout_Original: Fn_Due = js.native
    @JSName("timestamp")
    var timestamp_Original: Fn_Scheduler = js.native
    @JSName("toArray")
    var toArray_Original: Fn_ThisAny = js.native
    @JSName("windowCount")
    var windowCount_Original: Fn_StartWindowEvery = js.native
    @JSName("windowTime")
    var windowTime_Original: Fn_MaxWindowSize = js.native
    @JSName("windowToggle")
    var windowToggle_Original: Fn_ClosingSelector = js.native
    @JSName("windowWhen")
    var windowWhen_Original: Fn_ClosingSelectorThis = js.native
    @JSName("window")
    var window_Original: Fn_ThisWindowBoundaries = js.native
    @JSName("withLatestFrom")
    var withLatestFrom_Original: Fn_ArrayObservablesProject = js.native
    @JSName("zipAll")
    var zipAll_Original: Fn_Project = js.native
    @JSName("zip")
    var zip_Original: Fn_ArrayObservablesProjectThis = js.native
    def _catch[T, R](
