...
object usingObservableMod {
  ...
  @js.native
  open class UsingObservable[T] () extends StObject
  /* static members */
  object UsingObservable {
    ...
    inline def create[T](
      resourceFactory: js.Function0[
          (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Unsubscribable */ Any) | Unit
        ],
      observableFactory: js.Function1[
          /* resource */ (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Unsubscribable */ Any) | Unit, 
          (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SubscribableOrPromise<T> */ Any) | Unit
        ]
    ): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(resourceFactory.asInstanceOf[js.Any], observableFactory.asInstanceOf[js.Any])).asInstanceOf[Any]
  }
}
