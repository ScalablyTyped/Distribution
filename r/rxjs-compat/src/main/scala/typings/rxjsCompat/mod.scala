...
import typings.rxjsCompat.anon.TypeofonErrorResumeNext
...
object mod {
  ...
  @JSImport("rxjs-compat", "AjaxError")
  @js.native
  ...
  @JSImport("rxjs-compat", "AjaxResponse")
  @js.native
  ...
  @JSImport("rxjs-compat", "AjaxTimeoutError")
  @js.native
  ...
  open class AsyncSubject[T] ()
    extends typings.rxjs.mod.AsyncSubject[T]
  
  @JSImport("rxjs-compat", "BehaviorSubject")
  @js.native
  open class BehaviorSubject[T] protected ()
    extends typings.rxjs.mod.BehaviorSubject[T] {
  ...
  object Notification {
    ...
    @JSImport("rxjs-compat", "Notification.completeNotification")
    @js.native
  ...
  open class ReplaySubject[T] ()
    extends typings.rxjs.mod.ReplaySubject[T] {
  ...
  object Scheduler {
    ...
    @JSImport("rxjs-compat", "Scheduler.animationFrame")
    @js.native
    ...
    @JSImport("rxjs-compat", "Scheduler.asap")
    @js.native
    ...
    @JSImport("rxjs-compat", "Scheduler.async")
    @js.native
    ...
    @JSImport("rxjs-compat", "Scheduler.queue")
    @js.native
  ...
  open class Subscriber[T] ()
    extends typings.rxjs.mod.Subscriber[T] {
  ...
  object Subscription {
    ...
    /** @nocollapse */
    @JSImport("rxjs-compat", "Subscription.EMPTY")
    @js.native
  ...
  object Symbol {
    ...
    @JSImport("rxjs-compat", "Symbol.iterator")
    @js.native
    ...
    @JSImport("rxjs-compat", "Symbol.observable")
    @js.native
    ...
    @JSImport("rxjs-compat", "Symbol.rxSubscriber")
    @js.native
  ...
  @JSImport("rxjs-compat", "TestScheduler")
  @js.native
  ...
  object TestScheduler {
    ...
    /**
      ...
      * @nocollapse
      */
    @JSImport("rxjs-compat", "TestScheduler.frameTimeFactor")
    @js.native
  ...
  open class VirtualTimeScheduler ()
    extends typings.rxjs.mod.VirtualTimeScheduler {
  ...
  object VirtualTimeScheduler {
    ...
    @JSImport("rxjs-compat", "VirtualTimeScheduler.frameTimeFactor")
    @js.native
    def frameTimeFactor: Double = js.native
    inline def frameTimeFactor_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("frameTimeFactor")(x.asInstanceOf[js.Any])
  }
  ...
  object operators {
    ...
    @JSImport("rxjs-compat", "operators.combineAll")
    @js.native
    ...
    @JSImport("rxjs-compat", "operators.exhaust")
    @js.native
    ...
    @JSImport("rxjs-compat", "operators.flatMap")
    @js.native
    ...
    @JSImport("rxjs-compat", "operators.onErrorResumeNext")
    @js.native
    val onErrorResumeNext: TypeofonErrorResumeNext = js.native
