...
trait Fn20 extends StObject {
  ...
  def apply[T, R](array: js.Array[ObservableInput[Any]]): Observable_[R] = js.native
  def apply[T, R](array: js.Array[ObservableInput[Any]], project: js.Function1[/* repeated */ Any, R]): Observable_[R] = js.native
  def apply[T, R](observables: (ObservableInput[Any] | (js.Function1[/* repeated */ Any, R]))*): Observable_[R] = js.native
