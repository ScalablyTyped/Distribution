...
object operatorGroupByMod extends js.Object {
  def groupBy[T, K](`this`: rxjsLib.rxjsMod.Observable[T], keySelector: js.Function1[/* value */ T, K]): rxjsLib.rxjsMod.Observable[
    /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify GroupedObservable<K, T> */ _
  ] = js.native
  def groupBy[T, K](
    ...
    durationSelector: js.Function1[
      /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify GroupedObservable<K, T> */ /* grouped */ js.Any, 
  ...
  def groupBy[T, K, R](
    ...
    /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify GroupedObservable<K, R> */ _
  ] = js.native
  def groupBy[T, K, R](
    `this`: rxjsLib.rxjsMod.Observable[T],
    keySelector: js.Function1[/* value */ T, K],
    elementSelector: js.Function1[/* value */ T, R],
    durationSelector: js.Function1[
      /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify GroupedObservable<K, R> */ /* grouped */ js.Any, 
      rxjsLib.rxjsMod.Observable[_]
    ]
  ): rxjsLib.rxjsMod.Observable[
    /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify GroupedObservable<K, R> */ _
