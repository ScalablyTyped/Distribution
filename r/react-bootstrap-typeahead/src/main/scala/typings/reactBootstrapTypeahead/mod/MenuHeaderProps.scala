...
object MenuHeaderProps {
  ...
  def apply(
    ...
    nonce: String = null,
    onAbort: SyntheticEvent[li, Event] => Unit = null,
    onAnimationEnd: AnimationEvent[li] => Unit = null,
    onAnimationIteration: AnimationEvent[li] => Unit = null,
    onAnimationStart: AnimationEvent[li] => Unit = null,
    onAuxClick: MouseEvent[li, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[li] => Unit = null,
    onBlur: FocusEvent[li] => Unit = null,
    onCanPlay: SyntheticEvent[li, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[li, Event] => Unit = null,
    onChange: FormEvent[li] => Unit = null,
    onClick: MouseEvent[li, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[li] => Unit = null,
    onCompositionStart: CompositionEvent[li] => Unit = null,
    onCompositionUpdate: CompositionEvent[li] => Unit = null,
    onContextMenu: MouseEvent[li, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[li] => Unit = null,
    onCut: ClipboardEvent[li] => Unit = null,
    onDoubleClick: MouseEvent[li, NativeMouseEvent] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[li, Event] => Unit = null,
    onEmptied: SyntheticEvent[li, Event] => Unit = null,
    onEncrypted: SyntheticEvent[li, Event] => Unit = null,
    onEnded: SyntheticEvent[li, Event] => Unit = null,
    onError: SyntheticEvent[li, Event] => Unit = null,
    onFocus: FocusEvent[li] => Unit = null,
    onInput: FormEvent[li] => Unit = null,
    onInvalid: FormEvent[li] => Unit = null,
    onKeyDown: KeyboardEvent[li] => Unit = null,
    onKeyPress: KeyboardEvent[li] => Unit = null,
    onKeyUp: KeyboardEvent[li] => Unit = null,
    onLoad: SyntheticEvent[li, Event] => Unit = null,
    onLoadStart: SyntheticEvent[li, Event] => Unit = null,
    onLoadedData: SyntheticEvent[li, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[li, Event] => Unit = null,
    onMouseDown: MouseEvent[li, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[li, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[li, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[li, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[li, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[li, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[li, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[li] => Unit = null,
    onPause: SyntheticEvent[li, Event] => Unit = null,
    onPlay: SyntheticEvent[li, Event] => Unit = null,
    onPlaying: SyntheticEvent[li, Event] => Unit = null,
    onPointerCancel: PointerEvent[li] => Unit = null,
    onPointerDown: PointerEvent[li] => Unit = null,
    onPointerEnter: PointerEvent[li] => Unit = null,
    onPointerLeave: PointerEvent[li] => Unit = null,
    onPointerMove: PointerEvent[li] => Unit = null,
    onPointerOut: PointerEvent[li] => Unit = null,
    onPointerOver: PointerEvent[li] => Unit = null,
    onPointerUp: PointerEvent[li] => Unit = null,
    onProgress: SyntheticEvent[li, Event] => Unit = null,
    onRateChange: SyntheticEvent[li, Event] => Unit = null,
    onReset: FormEvent[li] => Unit = null,
    onScroll: UIEvent[li, NativeUIEvent] => Unit = null,
    onSeeked: SyntheticEvent[li, Event] => Unit = null,
    onSeeking: SyntheticEvent[li, Event] => Unit = null,
    onSelect: SyntheticEvent[li, Event] => Unit = null,
    onStalled: SyntheticEvent[li, Event] => Unit = null,
    onSubmit: FormEvent[li] => Unit = null,
    onSuspend: SyntheticEvent[li, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[li, Event] => Unit = null,
    onTouchCancel: TouchEvent[li] => Unit = null,
    onTouchEnd: TouchEvent[li] => Unit = null,
    onTouchMove: TouchEvent[li] => Unit = null,
    onTouchStart: TouchEvent[li] => Unit = null,
    onTransitionEnd: TransitionEvent[li] => Unit = null,
    onVolumeChange: SyntheticEvent[li, Event] => Unit = null,
    onWaiting: SyntheticEvent[li, Event] => Unit = null,
    onWheel: WheelEvent[li] => Unit = null,
