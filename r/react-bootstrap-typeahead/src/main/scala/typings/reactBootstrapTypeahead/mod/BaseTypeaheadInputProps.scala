...
object BaseTypeaheadInputProps {
  ...
  def apply(
    ...
    name: String = null,
    onAbort: SyntheticEvent[input, Event] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[input, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[input, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[input, Event] => Unit = null,
    onEmptied: SyntheticEvent[input, Event] => Unit = null,
    onEncrypted: SyntheticEvent[input, Event] => Unit = null,
    onEnded: SyntheticEvent[input, Event] => Unit = null,
    onError: SyntheticEvent[input, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[input, Event] => Unit = null,
    onLoadStart: SyntheticEvent[input, Event] => Unit = null,
    onLoadedData: SyntheticEvent[input, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[input, Event] => Unit = null,
    ...
    onPause: SyntheticEvent[input, Event] => Unit = null,
    onPlay: SyntheticEvent[input, Event] => Unit = null,
    onPlaying: SyntheticEvent[input, Event] => Unit = null,
    ...
    onProgress: SyntheticEvent[input, Event] => Unit = null,
    onRateChange: SyntheticEvent[input, Event] => Unit = null,
    onReset: FormEvent[input] => Unit = null,
    onScroll: UIEvent[input, NativeUIEvent] => Unit = null,
    onSeeked: SyntheticEvent[input, Event] => Unit = null,
    onSeeking: SyntheticEvent[input, Event] => Unit = null,
    onSelect: SyntheticEvent[input, Event] => Unit = null,
    onStalled: SyntheticEvent[input, Event] => Unit = null,
    onSubmit: FormEvent[input] => Unit = null,
    onSuspend: SyntheticEvent[input, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[input, Event] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[input, Event] => Unit = null,
    onWaiting: SyntheticEvent[input, Event] => Unit = null,
