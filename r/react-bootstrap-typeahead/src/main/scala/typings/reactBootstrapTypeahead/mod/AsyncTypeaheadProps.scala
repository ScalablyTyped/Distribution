...
object AsyncTypeaheadProps {
  @scala.inline
  def apply[/* <: typings.reactBootstrapTypeahead.mod.TypeaheadModel */ T](isLoading: Boolean, onSearch: String => Unit, options: js.Array[T]): AsyncTypeaheadProps[T] = {
  ...
  @scala.inline
  implicit class AsyncTypeaheadPropsOps[Self <: AsyncTypeaheadProps[_], /* <: typings.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with AsyncTypeaheadProps[T]) extends AnyVal {
    @scala.inline
