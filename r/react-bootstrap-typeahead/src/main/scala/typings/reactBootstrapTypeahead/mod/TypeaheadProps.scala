...
object TypeaheadProps {
  @scala.inline
  def apply[/* <: typings.reactBootstrapTypeahead.mod.TypeaheadModel */ T](options: js.Array[T]): TypeaheadProps[T] = {
    val __obj = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    __obj.asInstanceOf[TypeaheadProps[T]]
  }
  @scala.inline
  implicit class TypeaheadPropsOps[Self <: TypeaheadProps[_], /* <: typings.reactBootstrapTypeahead.mod.TypeaheadModel */ T] (val x: Self with TypeaheadProps[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRenderMenu(value: (/* results */ js.Array[TypeaheadResult[T]], /* menuProps */ js.Any) => ReactNode): Self = this.set("renderMenu", js.Any.fromFunction2(value))
    @scala.inline
