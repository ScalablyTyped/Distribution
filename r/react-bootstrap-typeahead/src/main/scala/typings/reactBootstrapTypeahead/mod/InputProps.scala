...
import typings.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.dialog
...
import typings.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.grid
...
import typings.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.menu
...
import typings.reactBootstrapTypeahead.reactBootstrapTypeaheadStrings.tree
...
trait InputProps extends StObject {
  ...
  var onClick: js.UndefOr[MouseEventHandler[input]] = js.native
...
object InputProps {
  ...
  implicit class InputPropsMutableBuilder[Self <: InputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: MouseEvent[input, NativeMouseEvent] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setShouldSelectHint(value: (/* shouldSelect */ Boolean, /* e */ KeyboardEvent[HTMLInputElement]) => Boolean): Self = StObject.set(x, "shouldSelectHint", js.Any.fromFunction2(value))
    
    @scala.inline
    def setShouldSelectHintUndefined: Self = StObject.set(x, "shouldSelectHint", js.undefined)
