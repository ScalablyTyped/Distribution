...
object InputProps {
  ...
  implicit class InputPropsOps[Self <: InputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: MouseEvent[input, NativeMouseEvent] => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setShouldSelectHint(value: (/* shouldSelect */ Boolean, /* e */ KeyboardEvent[HTMLInputElement]) => Boolean): Self = this.set("shouldSelectHint", js.Any.fromFunction2(value))
