...
object TypeaheadMulitInputWithHocProps {
  ...
  @scala.inline
  implicit class TypeaheadMulitInputWithHocPropsOps[Self <: TypeaheadMulitInputWithHocProps[_], T /* <: TypeaheadModel */] (val x: Self with TypeaheadMulitInputWithHocProps[T]) extends AnyVal {
