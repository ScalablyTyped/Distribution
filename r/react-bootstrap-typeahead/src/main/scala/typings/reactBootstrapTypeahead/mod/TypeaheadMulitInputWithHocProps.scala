...
object TypeaheadMulitInputWithHocProps {
  ...
  @scala.inline
  implicit class TypeaheadMulitInputWithHocPropsMutableBuilder[Self <: TypeaheadMulitInputWithHocProps[?], T /* <: TypeaheadModel */] (val x: Self & TypeaheadMulitInputWithHocProps[T]) extends AnyVal {
