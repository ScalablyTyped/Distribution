...
object badgedButtonMod {
  ...
  trait BadgedButtonProps extends StObject {
    ...
    /**
      ...
      */
    var buttonChildren: js.UndefOr[ReactNode] = js.undefined
  ...
  object BadgedButtonProps {
    ...
    @scala.inline
    implicit class BadgedButtonPropsMutableBuilder[Self <: BadgedButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBadgeClassName(value: String): Self = StObject.set(x, "badgeClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBadgeClassNameUndefined: Self = StObject.set(x, "badgeClassName", js.undefined)
      
      @scala.inline
      def setBadgeId(value: String): Self = StObject.set(x, "badgeId", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBadgeIdUndefined: Self = StObject.set(x, "badgeId", js.undefined)
      
      @scala.inline
      def setBadgeRef(value: Ref[HTMLSpanElement]): Self = StObject.set(x, "badgeRef", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBadgeRefFunction1(value: /* instance */ HTMLSpanElement | Null => Unit): Self = StObject.set(x, "badgeRef", js.Any.fromFunction1(value))
      
      @scala.inline
      def setBadgeRefNull: Self = StObject.set(x, "badgeRef", null)
      
      @scala.inline
      def setBadgeRefUndefined: Self = StObject.set(x, "badgeRef", js.undefined)
      ...
      @scala.inline
      def setBadgeTheme(value: BadgeTheme): Self = StObject.set(x, "badgeTheme", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBadgeThemeUndefined: Self = StObject.set(x, "badgeTheme", js.undefined)
      
      @scala.inline
      def setButtonChildren(value: ReactNode): Self = StObject.set(x, "buttonChildren", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setButtonChildrenUndefined: Self = StObject.set(x, "buttonChildren", js.undefined)
