...
object ^ extends js.Object {
  ...
  @JSName("sync")
  def sync_Package(path: java.lang.String, options: readDashPkgLib.readDashPkgMod.ReadPkgNs.Options): normalizeDashPackageDashDataLib.normalizeDashPackageDashDataMod.normalizeNs.Package = js.native
}
