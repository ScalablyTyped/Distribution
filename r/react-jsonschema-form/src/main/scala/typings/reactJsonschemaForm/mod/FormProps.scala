...
trait FormProps[T] extends StObject {
  ...
  var tagName: js.UndefOr[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 179, starting with typings.reactJsonschemaForm.reactJsonschemaFormStrings.a, typings.reactJsonschemaForm.reactJsonschemaFormStrings.abbr, typings.reactJsonschemaForm.reactJsonschemaFormStrings.address */ Any
  ] = js.undefined
...
object FormProps {
  ...
  implicit open class MutableBuilder[Self <: FormProps[?], T] (val x: Self & FormProps[T]) extends AnyVal {
    ...
    inline def setTagName(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 179, starting with typings.reactJsonschemaForm.reactJsonschemaFormStrings.a, typings.reactJsonschemaForm.reactJsonschemaFormStrings.abbr, typings.reactJsonschemaForm.reactJsonschemaFormStrings.address */ Any
