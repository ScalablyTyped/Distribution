...
package object reactDashJsonschemaDashFormMod {
  ...
  type FormValidation = FieldValidation with ScalablyTyped.runtime.StringDictionary[FieldValidation]
  type ISubmitEvent[T] = IChangeEvent[T]
  type IdSchema = FieldId with ScalablyTyped.runtime.StringDictionary[FieldId]
