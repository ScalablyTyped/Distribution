...
object mod {
  ...
  object rword {
    ...
    /**
      ...
      */
    inline def generate(): String | js.Array[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("generate")().asInstanceOf[String | js.Array[String]]
    inline def generate(count: Double): String | js.Array[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("generate")(count.asInstanceOf[js.Any]).asInstanceOf[String | js.Array[String]]
    inline def generate(count: Double, opt: GenerateOptions): String | js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("generate")(count.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[String | js.Array[String]]
    inline def generate(count: Unit, opt: GenerateOptions): String | js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("generate")(count.asInstanceOf[js.Any], opt.asInstanceOf[js.Any])).asInstanceOf[String | js.Array[String]]
    ...
    /**
      ...
      */
    inline def load_big(list: big): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("load")(list.asInstanceOf[js.Any]).asInstanceOf[Unit]
    
    inline def load_small(list: small): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("load")(list.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  object GenerateOptions {
    ...
    extension [Self <: GenerateOptions](x: Self) {
      ...
      inline def setContains(value: RegExp | String): Self = StObject.set(x, "contains", value.asInstanceOf[js.Any])
