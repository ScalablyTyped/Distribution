...
trait SQLiteDatabase extends js.Object {
  def attach(nameToAttach: String, alias: String): js.Promise[Unit] = js.native
  ...
  @JSName("attach")
  def attach_Unit(nameToAttach: String, alias: String): Unit = js.native
  def close(): js.Promise[Unit] = js.native
  def close(success: js.Function0[Unit], error: js.Function1[/* err */ SQLError, Unit]): Unit = js.native
  def dettach(alias: String): js.Promise[Unit] = js.native
  ...
  @JSName("dettach")
  def dettach_Unit(alias: String): Unit = js.native
  def executeSql(statement: String): js.Promise[js.Array[ResultSet]] = js.native
  def executeSql(statement: String, params: js.Array[_]): js.Promise[js.Array[ResultSet]] = js.native
  ...
  @JSName("executeSql")
  def executeSql_Unit(statement: String): Unit = js.native
  @JSName("executeSql")
  def executeSql_Unit(statement: String, params: js.Array[_]): Unit = js.native
  def readTransaction(scope: js.Function1[/* tx */ Transaction, Unit]): js.Promise[TransactionCallback] = js.native
  ...
  def readTransaction_Unit(scope: js.Function1[/* tx */ Transaction, Unit]): Unit = js.native
  def transaction(scope: js.Function1[/* tx */ Transaction, Unit]): js.Promise[Transaction] = js.native
  ...
  @JSName("transaction")
  def transaction_Unit(scope: js.Function1[/* tx */ Transaction, Unit]): Unit = js.native
}
