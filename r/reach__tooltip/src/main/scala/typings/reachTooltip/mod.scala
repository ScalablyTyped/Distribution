...
import typings.reachTooltip.reachTooltipStrings.`additions removals`
import typings.reachTooltip.reachTooltipStrings.`additions text`
import typings.reachTooltip.reachTooltipStrings.`inline`
import typings.reachTooltip.reachTooltipStrings.`removals additions`
import typings.reachTooltip.reachTooltipStrings.`removals text`
import typings.reachTooltip.reachTooltipStrings.`text additions`
import typings.reachTooltip.reachTooltipStrings.`text removals`
import typings.reachTooltip.reachTooltipStrings.additions
import typings.reachTooltip.reachTooltipStrings.all
import typings.reachTooltip.reachTooltipStrings.ascending
import typings.reachTooltip.reachTooltipStrings.assertive
import typings.reachTooltip.reachTooltipStrings.both
import typings.reachTooltip.reachTooltipStrings.copy
import typings.reachTooltip.reachTooltipStrings.date
import typings.reachTooltip.reachTooltipStrings.decimal
import typings.reachTooltip.reachTooltipStrings.descending
import typings.reachTooltip.reachTooltipStrings.dialog
import typings.reachTooltip.reachTooltipStrings.email
import typings.reachTooltip.reachTooltipStrings.execute
import typings.reachTooltip.reachTooltipStrings.grammar
import typings.reachTooltip.reachTooltipStrings.grid
import typings.reachTooltip.reachTooltipStrings.horizontal
import typings.reachTooltip.reachTooltipStrings.inherit
import typings.reachTooltip.reachTooltipStrings.link
import typings.reachTooltip.reachTooltipStrings.list
import typings.reachTooltip.reachTooltipStrings.listbox
import typings.reachTooltip.reachTooltipStrings.location
import typings.reachTooltip.reachTooltipStrings.menu
import typings.reachTooltip.reachTooltipStrings.mixed
import typings.reachTooltip.reachTooltipStrings.move
import typings.reachTooltip.reachTooltipStrings.no
import typings.reachTooltip.reachTooltipStrings.none
import typings.reachTooltip.reachTooltipStrings.numeric
import typings.reachTooltip.reachTooltipStrings.off
import typings.reachTooltip.reachTooltipStrings.on
import typings.reachTooltip.reachTooltipStrings.other
import typings.reachTooltip.reachTooltipStrings.page
import typings.reachTooltip.reachTooltipStrings.polite
import typings.reachTooltip.reachTooltipStrings.popup
import typings.reachTooltip.reachTooltipStrings.removals
import typings.reachTooltip.reachTooltipStrings.search
import typings.reachTooltip.reachTooltipStrings.spelling
import typings.reachTooltip.reachTooltipStrings.step
import typings.reachTooltip.reachTooltipStrings.tel
import typings.reachTooltip.reachTooltipStrings.text
import typings.reachTooltip.reachTooltipStrings.time
import typings.reachTooltip.reachTooltipStrings.tree
import typings.reachTooltip.reachTooltipStrings.url
import typings.reachTooltip.reachTooltipStrings.vertical
import typings.reachTooltip.reachTooltipStrings.yes
...
object mod {
  ...
  @scala.inline
  def useTooltip(): js.Tuple3[TriggerParams, TooltipParams, Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("useTooltip")().asInstanceOf[js.Tuple3[TriggerParams, TooltipParams, Boolean]]
  @scala.inline
  def useTooltip(attrs: HTMLProps[js.Any]): js.Tuple3[TriggerParams, TooltipParams, Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("useTooltip")(attrs.asInstanceOf[js.Any]).asInstanceOf[js.Tuple3[TriggerParams, TooltipParams, Boolean]]
  ...
  object TriggerParams {
    ...
    implicit class TriggerParamsMutableBuilder[Self <: TriggerParams] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnBlur(value: SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnFocus(value: SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnKeyDown(value: SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnMouseDown(value: SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnMouseEnter(value: SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnMouseLeave(value: SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnMouseMove(value: SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction1(value))
