...
object mod {
  ...
  inline def useTooltip(): js.Tuple3[TriggerParams, TooltipParams, Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("useTooltip")().asInstanceOf[js.Tuple3[TriggerParams, TooltipParams, Boolean]]
  inline def useTooltip(attrs: HTMLProps[js.Any]): js.Tuple3[TriggerParams, TooltipParams, Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("useTooltip")(attrs.asInstanceOf[js.Any]).asInstanceOf[js.Tuple3[TriggerParams, TooltipParams, Boolean]]
  ...
  object BaseTooltipProps {
    ...
    inline def apply(): BaseTooltipProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[BaseTooltipProps]
    }
    
    extension [Self <: BaseTooltipProps](x: Self) {
      ...
      inline def setPosition(value: (/* position1 */ DOMRect, /* position2 */ DOMRect) => DOMRect): Self = StObject.set(x, "position", js.Any.fromFunction2(value))
  ...
  object TooltipParams {
    ...
    inline def apply(id: String, isVisible: Boolean, triggerRect: DOMRect): TooltipParams = {
  ...
  object TooltipPopupProps {
    ...
    inline def apply(BaseTooltipProps: BaseTooltipProps): TooltipPopupProps = {
      val __obj = js.Dynamic.literal()
  ...
  object TooltipProps {
    ...
    inline def apply(BaseTooltipProps: BaseTooltipProps): TooltipProps = {
      val __obj = js.Dynamic.literal()
      js.Dynamic.global.Object.assign(__obj, BaseTooltipProps)
  ...
  object TriggerParams {
    ...
    extension [Self <: TriggerParams](x: Self) {
