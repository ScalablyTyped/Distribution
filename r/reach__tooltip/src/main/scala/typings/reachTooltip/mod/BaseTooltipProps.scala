...
object BaseTooltipProps {
  ...
  @scala.inline
  implicit class BaseTooltipPropsOps[Self <: BaseTooltipProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPosition(value: (/* position1 */ DOMRect, /* position2 */ DOMRect) => DOMRect): Self = this.set("position", js.Any.fromFunction2(value))
