...
import typings.reactDaumPostcode.loadPostcodeMod.Address
import typings.reactDaumPostcode.loadPostcodeMod.PostcodeConstructor
import typings.reactDaumPostcode.loadPostcodeMod.Search
import typings.reactDaumPostcode.loadPostcodeMod.Size
import typings.reactDaumPostcode.loadPostcodeMod.Theme
import typings.std.HTMLDivElement
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object daumPostcodeEmbedMod {
  ...
  trait DaumPostcodeEmbedProps extends StObject {
    ...
    var onClose: js.UndefOr[js.Function1[/* state */ typings.reactDaumPostcode.loadPostcodeMod.State, Unit]] = js.undefined
  ...
  object DaumPostcodeEmbedProps {
    ...
    extension [Self <: DaumPostcodeEmbedProps](x: Self) {
      ...
      inline def setOnClose(value: /* state */ typings.reactDaumPostcode.loadPostcodeMod.State => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
