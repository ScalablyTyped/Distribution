...
object TabsProps {
  ...
  def apply(
    ...
    nonce: String = null,
    onAbort: SyntheticEvent[Tabs, Event_] => Unit = null,
    onBlur: FocusEvent[Tabs] => Unit = null,
    onCanPlay: SyntheticEvent[Tabs, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[Tabs, Event_] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[Tabs, Event_] => Unit = null,
    onEmptied: SyntheticEvent[Tabs, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[Tabs, Event_] => Unit = null,
    onEnded: SyntheticEvent[Tabs, Event_] => Unit = null,
    onError: SyntheticEvent[Tabs, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[Tabs, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[Tabs, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[Tabs, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[Tabs, Event_] => Unit = null,
    ...
    onPause: SyntheticEvent[Tabs, Event_] => Unit = null,
    onPlay: SyntheticEvent[Tabs, Event_] => Unit = null,
    ...
    onStalled: SyntheticEvent[Tabs, Event_] => Unit = null,
    onSubmit: FormEvent[Tabs] => Unit = null,
    onSuspend: SyntheticEvent[Tabs, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[Tabs, Event_] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[Tabs, Event_] => Unit = null,
    onWaiting: SyntheticEvent[Tabs, Event_] => Unit = null,
