...
object TableHeaderProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onBlur: FocusEvent[TableHeader] => Unit = null,
    onCanPlay: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[TableHeader, Event_] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onEmptied: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onEnded: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onError: SyntheticEvent[TableHeader, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[TableHeader, Event_] => Unit = null,
    ...
    onPause: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onPlay: SyntheticEvent[TableHeader, Event_] => Unit = null,
    ...
    onStalled: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onSubmit: FormEvent[TableHeader] => Unit = null,
    onSuspend: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[TableHeader, Event_] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[TableHeader, Event_] => Unit = null,
    onWaiting: SyntheticEvent[TableHeader, Event_] => Unit = null,
