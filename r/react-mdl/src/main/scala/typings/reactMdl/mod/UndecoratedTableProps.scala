...
object UndecoratedTableProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UndecoratedTableProps] (val x: Self) extends AnyVal {
    ...
    inline def setRowKeyColumn(value: String): Self = StObject.set(x, "rowKeyColumn", value.asInstanceOf[js.Any])
    
    inline def setRowKeyColumnUndefined: Self = StObject.set(x, "rowKeyColumn", js.undefined)
