...
object RadioGroupProps {
  ...
  def apply(
    ...
    onCompositionStart: CompositionEvent[RadioGroup] => Unit = null,
    onCompositionUpdate: CompositionEvent[RadioGroup] => Unit = null,
    onContextMenu: MouseEvent[RadioGroup, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[RadioGroup] => Unit = null,
    onCut: ClipboardEvent[RadioGroup] => Unit = null,
    onDoubleClick: MouseEvent[RadioGroup, NativeMouseEvent] => Unit = null,
    ...
    onMouseMove: MouseEvent[RadioGroup, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[RadioGroup, NativeMouseEvent] => Unit = null,
    ...
    onPointerLeave: PointerEvent[RadioGroup] => Unit = null,
    onPointerMove: PointerEvent[RadioGroup] => Unit = null,
    ...
    onScroll: UIEvent[RadioGroup] => Unit = null,
