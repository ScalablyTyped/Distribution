...
object TabBarProps {
  ...
  def apply(
    ...
    nonce: String = null,
    onAbort: ReactEventHandler[TabBar] = null,
    onBlur: FocusEventHandler[TabBar] = null,
    onCanPlay: ReactEventHandler[TabBar] = null,
    onCanPlayThrough: ReactEventHandler[TabBar] = null,
    onChange: /* tabId */ Double => _ = null,
    onClick: MouseEventHandler[TabBar] = null,
    onCompositionEnd: CompositionEventHandler[TabBar] = null,
    onCompositionStart: CompositionEventHandler[TabBar] = null,
    onCompositionUpdate: CompositionEventHandler[TabBar] = null,
    onContextMenu: MouseEventHandler[TabBar] = null,
    onCopy: ClipboardEventHandler[TabBar] = null,
    onCut: ClipboardEventHandler[TabBar] = null,
    onDoubleClick: MouseEventHandler[TabBar] = null,
    onDrag: DragEventHandler[TabBar] = null,
    onDragEnd: DragEventHandler[TabBar] = null,
    onDragEnter: DragEventHandler[TabBar] = null,
    onDragExit: DragEventHandler[TabBar] = null,
    onDragLeave: DragEventHandler[TabBar] = null,
    onDragOver: DragEventHandler[TabBar] = null,
    onDragStart: DragEventHandler[TabBar] = null,
    onDrop: DragEventHandler[TabBar] = null,
    onDurationChange: ReactEventHandler[TabBar] = null,
    onEmptied: ReactEventHandler[TabBar] = null,
    onEncrypted: ReactEventHandler[TabBar] = null,
    onEnded: ReactEventHandler[TabBar] = null,
    onError: ReactEventHandler[TabBar] = null,
    onFocus: FocusEventHandler[TabBar] = null,
    onInput: FormEventHandler[TabBar] = null,
    onKeyDown: KeyboardEventHandler[TabBar] = null,
    onKeyPress: KeyboardEventHandler[TabBar] = null,
    onKeyUp: KeyboardEventHandler[TabBar] = null,
    onLoad: ReactEventHandler[TabBar] = null,
    onLoadStart: ReactEventHandler[TabBar] = null,
    onLoadedData: ReactEventHandler[TabBar] = null,
    onLoadedMetadata: ReactEventHandler[TabBar] = null,
    onMouseDown: MouseEventHandler[TabBar] = null,
    onMouseEnter: MouseEventHandler[TabBar] = null,
    onMouseLeave: MouseEventHandler[TabBar] = null,
    onMouseMove: MouseEventHandler[TabBar] = null,
    onMouseOut: MouseEventHandler[TabBar] = null,
    onMouseOver: MouseEventHandler[TabBar] = null,
    onMouseUp: MouseEventHandler[TabBar] = null,
    onPaste: ClipboardEventHandler[TabBar] = null,
    onPause: ReactEventHandler[TabBar] = null,
    onPlay: ReactEventHandler[TabBar] = null,
    onPlaying: ReactEventHandler[TabBar] = null,
    onProgress: ReactEventHandler[TabBar] = null,
    onRateChange: ReactEventHandler[TabBar] = null,
    onScroll: UIEventHandler[TabBar] = null,
    onSeeked: ReactEventHandler[TabBar] = null,
    onSeeking: ReactEventHandler[TabBar] = null,
    onSelect: ReactEventHandler[TabBar] = null,
    onStalled: ReactEventHandler[TabBar] = null,
    onSubmit: FormEventHandler[TabBar] = null,
    onSuspend: ReactEventHandler[TabBar] = null,
    onTimeUpdate: ReactEventHandler[TabBar] = null,
    onTouchCancel: TouchEventHandler[TabBar] = null,
    onTouchEnd: TouchEventHandler[TabBar] = null,
    onTouchMove: TouchEventHandler[TabBar] = null,
    onTouchStart: TouchEventHandler[TabBar] = null,
    onVolumeChange: ReactEventHandler[TabBar] = null,
    onWaiting: ReactEventHandler[TabBar] = null,
    onWheel: WheelEventHandler[TabBar] = null,
