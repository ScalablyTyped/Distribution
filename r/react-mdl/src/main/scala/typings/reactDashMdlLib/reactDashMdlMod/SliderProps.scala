...
trait SliderProps
  extends MDLHTMLAttributes
     with reactLib.reactMod.DOMAttributes[Slider] {
  @JSName("max")
...
object SliderProps {
  ...
  def apply(
    max: scala.Double,
    min: scala.Double,
    DOMAttributes: reactLib.reactMod.DOMAttributes[Slider] = null,
    MDLHTMLAttributes: MDLHTMLAttributes = null,
    onChange: reactLib.reactMod.FormEventHandler[Slider] = null,
