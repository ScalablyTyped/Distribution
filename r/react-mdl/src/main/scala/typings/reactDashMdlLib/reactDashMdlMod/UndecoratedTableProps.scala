...
trait UndecoratedTableProps
  extends reactLib.reactMod.ClassAttributes[js.Any]
     ...
     with reactLib.reactMod.DOMAttributes[UndecoratedTable]
...
object UndecoratedTableProps {
  ...
  def apply(
    rows: js.Array[_],
    ClassAttributes: reactLib.reactMod.ClassAttributes[js.Any] = null,
    DOMAttributes: reactLib.reactMod.DOMAttributes[UndecoratedTable] = null,
