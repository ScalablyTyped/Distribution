...
trait RadioProps
  extends MDLHTMLAttributes
     with reactLib.reactMod.DOMAttributes[Radio]
...
object RadioProps {
  ...
  def apply(
    ...
    DOMAttributes: reactLib.reactMod.DOMAttributes[Radio] = null,
    ...
    onChange: reactLib.reactMod.FormEventHandler[Radio] = null
  ): RadioProps = {
