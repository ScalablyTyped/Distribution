...
trait RadioGroupProps
  extends MDLHTMLAttributes
     with reactLib.reactMod.DOMAttributes[RadioGroup] {
...
object RadioGroupProps {
  ...
  def apply(
    ...
    DOMAttributes: reactLib.reactMod.DOMAttributes[RadioGroup] = null,
    MDLHTMLAttributes: MDLHTMLAttributes = null,
    childContainer: java.lang.String = null,
    container: java.lang.String = null,
    label: java.lang.String = null,
    onChange: reactLib.reactMod.FormEventHandler[RadioGroup] = null
  ): RadioGroupProps = {
