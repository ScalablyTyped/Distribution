...
trait SwitchProps
  ...
  @JSName("onChange")
  var onChange_SwitchProps: js.UndefOr[reactLib.reactMod.ReactNs.FormEventHandler[Switch]] = js.undefined
}
...
object SwitchProps {
  ...
  def apply(
    ...
    onChange: reactLib.reactMod.ReactNs.FormEventHandler[Switch] = null
  ): SwitchProps = {
