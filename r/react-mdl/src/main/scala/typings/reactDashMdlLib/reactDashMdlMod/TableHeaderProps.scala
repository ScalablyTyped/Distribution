...
trait TableHeaderProps
  extends reactLib.reactMod.ClassAttributes[js.Any]
  ...
  var onClick: js.UndefOr[
    js.Function2[
      /* e */ reactLib.reactMod.MouseEvent[TableHeader, reactLib.NativeMouseEvent], 
...
object TableHeaderProps {
  ...
  def apply(
    ...
    cellFormatter: (/* value */ js.Any, /* row */ js.Any, /* index */ scala.Double) => reactLib.reactMod.ReactNode = null,
    ...
    onAbort: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onBlur: reactLib.reactMod.FocusEventHandler[TableHeader] = null,
    onCanPlay: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onCanPlayThrough: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onClick: (/* e */ reactLib.reactMod.MouseEvent[TableHeader, reactLib.NativeMouseEvent], /* name */ java.lang.String) => _ = null,
    onCompositionEnd: reactLib.reactMod.CompositionEventHandler[TableHeader] = null,
    onCompositionStart: reactLib.reactMod.CompositionEventHandler[TableHeader] = null,
    onCompositionUpdate: reactLib.reactMod.CompositionEventHandler[TableHeader] = null,
    onContextMenu: reactLib.reactMod.MouseEventHandler[TableHeader] = null,
    onCopy: reactLib.reactMod.ClipboardEventHandler[TableHeader] = null,
    onCut: reactLib.reactMod.ClipboardEventHandler[TableHeader] = null,
    onDoubleClick: reactLib.reactMod.MouseEventHandler[TableHeader] = null,
    onDrag: reactLib.reactMod.DragEventHandler[TableHeader] = null,
    onDragEnd: reactLib.reactMod.DragEventHandler[TableHeader] = null,
    onDragEnter: reactLib.reactMod.DragEventHandler[TableHeader] = null,
    onDragExit: reactLib.reactMod.DragEventHandler[TableHeader] = null,
    onDragLeave: reactLib.reactMod.DragEventHandler[TableHeader] = null,
    onDragOver: reactLib.reactMod.DragEventHandler[TableHeader] = null,
    onDragStart: reactLib.reactMod.DragEventHandler[TableHeader] = null,
    onDrop: reactLib.reactMod.DragEventHandler[TableHeader] = null,
    onDurationChange: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onEmptied: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onEncrypted: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onEnded: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onError: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onFocus: reactLib.reactMod.FocusEventHandler[TableHeader] = null,
    onInput: reactLib.reactMod.FormEventHandler[TableHeader] = null,
    onKeyDown: reactLib.reactMod.KeyboardEventHandler[TableHeader] = null,
    onKeyPress: reactLib.reactMod.KeyboardEventHandler[TableHeader] = null,
    onKeyUp: reactLib.reactMod.KeyboardEventHandler[TableHeader] = null,
    onLoad: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onLoadStart: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onLoadedData: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onLoadedMetadata: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onMouseDown: reactLib.reactMod.MouseEventHandler[TableHeader] = null,
    onMouseEnter: reactLib.reactMod.MouseEventHandler[TableHeader] = null,
    onMouseLeave: reactLib.reactMod.MouseEventHandler[TableHeader] = null,
    onMouseMove: reactLib.reactMod.MouseEventHandler[TableHeader] = null,
    onMouseOut: reactLib.reactMod.MouseEventHandler[TableHeader] = null,
    onMouseOver: reactLib.reactMod.MouseEventHandler[TableHeader] = null,
    onMouseUp: reactLib.reactMod.MouseEventHandler[TableHeader] = null,
    onPaste: reactLib.reactMod.ClipboardEventHandler[TableHeader] = null,
    onPause: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onPlay: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onPlaying: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onProgress: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onRateChange: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onScroll: reactLib.reactMod.UIEventHandler[TableHeader] = null,
    onSeeked: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onSeeking: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onSelect: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onStalled: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onSubmit: reactLib.reactMod.FormEventHandler[TableHeader] = null,
    onSuspend: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onTimeUpdate: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onTouchCancel: reactLib.reactMod.TouchEventHandler[TableHeader] = null,
    onTouchEnd: reactLib.reactMod.TouchEventHandler[TableHeader] = null,
    onTouchMove: reactLib.reactMod.TouchEventHandler[TableHeader] = null,
    onTouchStart: reactLib.reactMod.TouchEventHandler[TableHeader] = null,
    onVolumeChange: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onWaiting: reactLib.reactMod.ReactEventHandler[TableHeader] = null,
    onWheel: reactLib.reactMod.WheelEventHandler[TableHeader] = null,
