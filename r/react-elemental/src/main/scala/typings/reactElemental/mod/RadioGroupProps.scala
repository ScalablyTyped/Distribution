...
/* Inlined react.react.HTMLAttributes<std.HTMLDivElement> & { readonly options :std.Array<{ readonly value :string,  readonly label :string | react.react.ReactNode,  readonly disabled :boolean | undefined}> | undefined,  readonly value :string | undefined,  readonly accentColor :string | undefined,  readonly idleColor :string | undefined,  readonly radioRenderer :(option : react.react.ReactElement, idx : number, options : std.Array<react.react.ReactElement>): react.react.ReactElement | undefined,  readonly onChange :(value : string): void | undefined} */
@js.native
trait RadioGroupProps extends js.Object {
  ...
  // Form Events
  var onChange: js.UndefOr[FormEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* value */ String, Unit]]) = js.native
...
object RadioGroupProps {
  ...
  implicit class RadioGroupPropsOps[Self <: RadioGroupProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(
      value: js.UndefOr[FormEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* value */ String, Unit]])
    ...
    @scala.inline
    def setIdleColor(value: String): Self = this.set("idleColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIdleColor: Self = this.set("idleColor", js.undefined)
    ...
    ): Self = this.set("radioRenderer", js.Any.fromFunction3(value))
    
    @scala.inline
    def deleteRadioRenderer: Self = this.set("radioRenderer", js.undefined)
