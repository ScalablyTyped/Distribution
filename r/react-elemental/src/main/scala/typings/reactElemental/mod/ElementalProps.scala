...
import typings.reactElemental.AnonPrimaryDark
...
object ElementalProps {
  @scala.inline
  def apply(children: ReactNode = null, colorOpts: AnonPrimaryDark = null, fontOpts: AnonPrimary = null): ElementalProps = {
