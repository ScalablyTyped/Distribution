...
class Dialog_ protected ()
  ...
  def componentDidMount_MDialog_(): Unit = js.native
  
  @JSName("componentDidUpdate")
  def componentDidUpdate_MDialog_(e: js.Any): Unit = js.native
  
  @JSName("componentWillUnmount")
  def componentWillUnmount_MDialog_(): Unit = js.native
