...
@js.native
open class GridBase protected ()
  extends Component[Any, js.Object, Any] {
  def this(e: Any) = this()
  
  def addFilterRule(e: Any): Unit = js.native
  
  def addSort(e: Any): Any = js.native
  
  def allColumns(): Any = js.native
  
  def beginEdit(e: Any, args: Any*): Unit = js.native
  ...
  def componentDidUpdate_MGridBase(e: Any): Unit = js.native
  ...
  def findColumn(e: Any): Any = js.native
  
  def footerRows(): Any = js.native
  
  def getColumnCount(e: Any): Any = js.native
  
  def getColumnIndex(e: Any): Any = js.native
  
  def getColumnLayout(e: Any): Any = js.native
  
  def handleBodyScroll(e: Any): Unit = js.native
  
  def initColumnSort(): Unit = js.native
  
  def initColumns(): Any = js.native
  
  def initFilterRules(): Unit = js.native
  
  def initHeaderHeight(): Unit = js.native
  
  def isEditing(e: Any, args: Any*): Any = js.native
  
  def leftFrozenWidth(): Any = js.native
  
  def moveColumn(e: Any, t: Any, n: Any): Any = js.native
  
  def onColumnAdd(e: Any): Unit = js.native
  
  def onColumnGroupAdd(e: Any): Unit = js.native
  
  def onColumnGroupRemove(e: Any): Unit = js.native
  
  def onColumnRemove(e: Any): Unit = js.native
  
  def renderColumns(): Any = js.native
  
  def renderLoading(): Any = js.native
  
  def renderPagination(e: Any): Any = js.native
  
  def renderSplitHelper(): Any = js.native
  
  def renderToolbar(): Any = js.native
  
  def renderView(e: Any): Any = js.native
  
  def resizeColumn(e: Any, t: Any): Unit = js.native
  
  def rightFrozenWidth(): Any = js.native
  
  def scrollTo(e: Any): Unit = js.native
