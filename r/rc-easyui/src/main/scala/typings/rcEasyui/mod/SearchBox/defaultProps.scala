package typings.rcEasyui.mod.SearchBox

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("rc-easyui", "SearchBox.defaultProps")
@js.native
object defaultProps extends js.Object {
  val buttonAlign: String = js.native
  val buttonIconCls: String = js.native
  val categories: js.Array[js.Any] = js.native
  val disabled: Boolean = js.native
  val editable: Boolean = js.native
  val iconAlign: String = js.native
  val invalid: Boolean = js.native
  val menuAlign: String = js.native
  ...
  def onSearch(e: js.Any): Unit = js.native
