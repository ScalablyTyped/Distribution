...
@js.native
open class MaskedBox protected ()
  ...
  def deleteChar(e: Any): Unit = js.native
  
  def formatter(e: Any): Any = js.native
  
  def getInputOffset(e: Any): Any = js.native
  
  def handleKeyDown(e: Any): Unit = js.native
  
  def insertChar(e: Any): Unit = js.native
  
  def parser(e: Any): Any = js.native
  
  def renderInput(): Any = js.native
  
  def seekNext(e: Any): Any = js.native
  
  def seekPrev(e: Any): Any = js.native
}
object MaskedBox {
