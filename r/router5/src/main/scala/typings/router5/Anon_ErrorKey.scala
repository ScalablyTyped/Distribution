...
trait Anon_ErrorKey extends js.Object {
...
object Anon_ErrorKey {
  @scala.inline
  def apply(fromState: js.Any, isCancelled: js.Any, toState: js.Any, errorKey: js.Any = null): Anon_ErrorKey = {
    ...
    __obj.asInstanceOf[Anon_ErrorKey]
  }
}
