...
object PartialOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(allowNotFound)) __obj.updateDynamic("allowNotFound")(allowNotFound.asInstanceOf[js.Any])
    if (!js.isUndefined(autoCleanUp)) __obj.updateDynamic("autoCleanUp")(autoCleanUp.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(rewritePathOnMatch)) __obj.updateDynamic("rewritePathOnMatch")(rewritePathOnMatch.asInstanceOf[js.Any])
