...
trait MosaicWindowActions extends js.Object {
  /**
    ...
    */
  def connectDragSource(connectedElements: reactLib.reactMod.ReactElement): reactLib.reactMod.ReactElement | scala.Null
  /**
...
object MosaicWindowActions {
  @scala.inline
  def apply(
    connectDragSource: reactLib.reactMod.ReactElement => reactLib.reactMod.ReactElement | scala.Null,
