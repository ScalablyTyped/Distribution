...
object defaultToolbarControlsMod {
  
  @JSImport("react-mosaic-component/lib/buttons/defaultToolbarControls", "DEFAULT_CONTROLS_WITHOUT_CREATION")
  @js.native
  val DEFAULT_CONTROLS_WITHOUT_CREATION: js.Array[String | Double | ReactElement | ReactFragment | ReactPortal] = js.native
  
  @JSImport("react-mosaic-component/lib/buttons/defaultToolbarControls", "DEFAULT_CONTROLS_WITH_CREATION")
  @js.native
