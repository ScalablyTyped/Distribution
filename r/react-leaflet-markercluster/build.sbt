...
version := "2.0-dt-20181121Z-c8c444"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "leaflet_dot_markercluster" % "1.4-dt-20190326Z-9c5ed0",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190417Z-c843c9",
  "org.scalablytyped" %%% "react" % "16.8-dt-20190528Z-1fde1d",
  "org.scalablytyped" %%% "react-leaflet" % "2.2-dt-20190311Z-a80883",
