...
version := "2.0-dt-20181121Z-3af99d"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "leaflet_dot_markercluster" % "1.0-dt-20180216Z-b4189c",
  "org.scalablytyped" %%% "prop-types" % "15.5-dt-20181212Z-e51e1e",
  "org.scalablytyped" %%% "react" % "16.7-dt-20190116Z-73addc",
  "org.scalablytyped" %%% "react-leaflet" % "1.1-dt-20180721Z-b4e6ae",
