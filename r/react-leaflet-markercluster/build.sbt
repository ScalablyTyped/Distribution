...
version := "2.0-dt-20181121Z-8fb581"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "leaflet_dot_markercluster" % "1.4-dt-20190326Z-e104d1",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190417Z-f48590",
  "org.scalablytyped" %%% "react" % "16.9-dt-20190809Z-2d489e",
  "org.scalablytyped" %%% "react-leaflet" % "2.4-dt-20190813Z-5a62e0",
