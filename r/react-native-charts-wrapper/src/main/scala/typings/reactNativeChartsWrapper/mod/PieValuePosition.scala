...
/* Rewritten from type alias, can be one of: 
  - typings.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.INSIDE_SLICE
  - typings.reactNativeChartsWrapper.reactNativeChartsWrapperStrings.OUTSIDE_SLICE
*/
