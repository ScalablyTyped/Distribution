...
trait ChartBase extends ViewProps {
  var animation: js.UndefOr[AnonDurationX] = js.undefined
  ...
  var highlights: js.UndefOr[js.Array[AnonDataIndex]] = js.undefined
  var legend: js.UndefOr[ChartLegend] = js.undefined
  var logEnabled: js.UndefOr[Boolean] = js.undefined
  var marker: js.UndefOr[AnonDigits] = js.undefined
