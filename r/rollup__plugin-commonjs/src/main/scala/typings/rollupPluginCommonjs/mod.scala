...
import typings.rollupPluginCommonjs.rollupPluginCommonjsStrings.auto
import typings.rollupPluginCommonjs.rollupPluginCommonjsStrings.remove
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Boolean
    - typings.rollupPluginCommonjs.rollupPluginCommonjsStrings.auto
    - typings.rollupPluginCommonjs.rollupPluginCommonjsStrings.preferred
    - typings.rollupPluginCommonjs.rollupPluginCommonjsStrings.namespace
  */
  type RequireReturnsDefaultOption = _RequireReturnsDefaultOption | Boolean
  ...
  trait RollupCommonJSOptions extends StObject {
    ...
    /**
      * @default "auto"
      */
    var defaultIsModuleExports: js.UndefOr[
        DefaultIsModuleExportsOption | (js.Function1[/* id */ String, DefaultIsModuleExportsOption])
      ] = js.undefined
    ...
    var requireReturnsDefault: js.UndefOr[
        RequireReturnsDefaultOption | (js.Function1[/* id */ String, RequireReturnsDefaultOption])
      ] = js.undefined
    ...
    /**
      ...
      * @default "auto"
      */
    var strictRequires: js.UndefOr[Boolean | FilterPattern] = js.undefined
  ...
  object RollupCommonJSOptions {
    ...
    implicit open class MutableBuilder[Self <: RollupCommonJSOptions] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "defaultIsModuleExports", value.asInstanceOf[js.Any])
      
      inline def setDefaultIsModuleExportsFunction1(value: /* id */ String => DefaultIsModuleExportsOption): Self = StObject.set(x, "defaultIsModuleExports", js.Any.fromFunction1(value))
      ...
      inline def setRequireReturnsDefault(value: RequireReturnsDefaultOption | (js.Function1[/* id */ String, RequireReturnsDefaultOption])): Self = StObject.set(x, "requireReturnsDefault", value.asInstanceOf[js.Any])
      
      inline def setRequireReturnsDefaultFunction1(value: /* id */ String => RequireReturnsDefaultOption): Self = StObject.set(x, "requireReturnsDefault", js.Any.fromFunction1(value))
      ...
      inline def setStrictRequires(value: Boolean | FilterPattern): Self = StObject.set(x, "strictRequires", value.asInstanceOf[js.Any])
      
      inline def setStrictRequiresNull: Self = StObject.set(x, "strictRequires", null)
  ...
  trait _RequireReturnsDefaultOption extends StObject
}
