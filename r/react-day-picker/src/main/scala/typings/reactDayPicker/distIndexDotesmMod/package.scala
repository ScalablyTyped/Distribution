...
import typings.reactDayPicker.distIndexDotesmMod.^
...
/* Rewritten from type alias, can be one of: 
  ...
  - js.Date
  - js.Array[js.Date]
  - typings.reactDayPicker.distIndexDotesmMod.DateRange
  - typings.reactDayPicker.distIndexDotesmMod.DateBefore
  - typings.reactDayPicker.distIndexDotesmMod.DateAfter
  - typings.reactDayPicker.distIndexDotesmMod.DateInterval
  - typings.reactDayPicker.distIndexDotesmMod.DayOfWeek
*/
