...
object anon {
  ...
  trait PartialFormattersFormatCaption extends StObject {
    ...
    var formatCaption: js.UndefOr[typings.reactDayPicker.distIndexDotesmMod.DateFormatter] = js.undefined
    
    var formatDay: js.UndefOr[typings.reactDayPicker.distIndexDotesmMod.DateFormatter] = js.undefined
    
    var formatMonthCaption: js.UndefOr[typings.reactDayPicker.distIndexDotesmMod.DateFormatter] = js.undefined
    
    var formatWeekNumber: js.UndefOr[typings.reactDayPicker.distIndexDotesmMod.WeekNumberFormatter] = js.undefined
    
    var formatWeekdayName: js.UndefOr[typings.reactDayPicker.distIndexDotesmMod.DateFormatter] = js.undefined
    
    var formatYearCaption: js.UndefOr[typings.reactDayPicker.distIndexDotesmMod.DateFormatter] = js.undefined
  }
  ...
  trait PartialLabelsLabelDay extends StObject {
    ...
    var labelDay: js.UndefOr[typings.reactDayPicker.distIndexDotesmMod.DayLabel] = js.undefined
    
    var labelMonthDropdown: js.UndefOr[js.Function0[String]] = js.undefined
    
    var labelNext: js.UndefOr[typings.reactDayPicker.distIndexDotesmMod.NavButtonLabel] = js.undefined
    
    var labelPrevious: js.UndefOr[typings.reactDayPicker.distIndexDotesmMod.NavButtonLabel] = js.undefined
    
    var labelWeekNumber: js.UndefOr[typings.reactDayPicker.distIndexDotesmMod.WeekNumberLabel] = js.undefined
    
    var labelWeekday: js.UndefOr[typings.reactDayPicker.distIndexDotesmMod.WeekdayLabel] = js.undefined
