...
object anon {
  ...
  /* Inlined std.Partial<react-day-picker.react-day-picker/dist/index.esm.Formatters> */
  trait PartialFormattersFormatCaption extends StObject {
    
    var formatCaption: js.UndefOr[typings.reactDayPicker.indexEsmMod.DateFormatter] = js.undefined
    
    var formatDay: js.UndefOr[typings.reactDayPicker.indexEsmMod.DateFormatter] = js.undefined
    
    var formatMonthCaption: js.UndefOr[typings.reactDayPicker.indexEsmMod.DateFormatter] = js.undefined
    
    var formatWeekNumber: js.UndefOr[typings.reactDayPicker.indexEsmMod.WeekNumberFormatter] = js.undefined
    
    var formatWeekdayName: js.UndefOr[typings.reactDayPicker.indexEsmMod.DateFormatter] = js.undefined
    
    var formatYearCaption: js.UndefOr[typings.reactDayPicker.indexEsmMod.DateFormatter] = js.undefined
  }
  object PartialFormattersFormatCaption {
    
    inline def apply(): PartialFormattersFormatCaption = {
      val __obj = js.Dynamic.literal()
  ...
  /* Inlined std.Partial<react-day-picker.react-day-picker/dist/index.esm.Labels> */
  trait PartialLabelsLabelDay extends StObject {
    
    var labelDay: js.UndefOr[typings.reactDayPicker.indexEsmMod.DayLabel] = js.undefined
    
    var labelMonthDropdown: js.UndefOr[js.Function0[String]] = js.undefined
    
    var labelNext: js.UndefOr[typings.reactDayPicker.indexEsmMod.NavButtonLabel] = js.undefined
    
    var labelPrevious: js.UndefOr[typings.reactDayPicker.indexEsmMod.NavButtonLabel] = js.undefined
    
    var labelWeekNumber: js.UndefOr[typings.reactDayPicker.indexEsmMod.WeekNumberLabel] = js.undefined
    
    var labelWeekday: js.UndefOr[typings.reactDayPicker.indexEsmMod.WeekdayLabel] = js.undefined
    
    var labelYearDropdown: js.UndefOr[js.Function0[String]] = js.undefined
  }
  object PartialLabelsLabelDay {
    
    inline def apply(): PartialLabelsLabelDay = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: PartialLabelsLabelDay](x: Self) {
      ...
      inline def setLabelDay(
        value: (/* day */ js.Date, /* activeModifiers */ typings.reactDayPicker.indexEsmMod.ActiveModifiers, /* options */ js.UndefOr[Locale]) => String
      ): Self = StObject.set(x, "labelDay", js.Any.fromFunction3(value))
  ...
  /* Inlined std.Required<react-day-picker.react-day-picker/dist/index.esm.ClassNames> */
  ...
  /* Inlined react-day-picker.react-day-picker/dist/index.esm.StyledComponent & std.Pick<react-day-picker.react-day-picker/dist/index.esm.ButtonProps, 'disabled' | 'aria-pressed' | 'tabIndex'> & react-day-picker.react-day-picker/dist/index.esm.DayEventHandlers */
