...
object dayPickerContextMod {
  
  @JSImport("react-day-picker/dist/contexts/DayPicker/DayPickerContext", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-day-picker/dist/contexts/DayPicker/DayPickerContext", "DayPickerContext")
  @js.native
  ...
  object DayPickerContextValue {
    ...
    extension [Self <: DayPickerContextValue](x: Self) {
      ...
      inline def setOnSelect(
        value: (js.UndefOr[js.Array[js.Date] | js.Date | DateRange], /* selectedDay */ js.Date, /* activeModifiers */ ActiveModifiers, /* e */ MouseEvent[typings.std.Element, NativeMouseEvent]) => Unit
