...
object dateUtilsMod {
  ...
  object DateUtils {
    ...
    extension [Self <: DateUtils](x: Self) {
      
      inline def setAddDayToRange(value: (Date, RangeModifier) => RangeModifier): Self = StObject.set(x, "addDayToRange", js.Any.fromFunction2(value))
      
      inline def setAddMonths(value: (Date, Double) => Date): Self = StObject.set(x, "addMonths", js.Any.fromFunction2(value))
      
      inline def setClone_(value: Date => Date): Self = StObject.set(x, "clone", js.Any.fromFunction1(value))
      
      inline def setIsDate(value: Date => Boolean): Self = StObject.set(x, "isDate", js.Any.fromFunction1(value))
      
      inline def setIsDayAfter(value: (Date, Date) => Boolean): Self = StObject.set(x, "isDayAfter", js.Any.fromFunction2(value))
      
      inline def setIsDayBefore(value: (Date, Date) => Boolean): Self = StObject.set(x, "isDayBefore", js.Any.fromFunction2(value))
      
      inline def setIsDayBetween(value: (Date, Date, Date) => Boolean): Self = StObject.set(x, "isDayBetween", js.Any.fromFunction3(value))
      
      inline def setIsDayInRange(value: (Date, RangeModifier) => Boolean): Self = StObject.set(x, "isDayInRange", js.Any.fromFunction2(value))
      
      inline def setIsFutureDay(value: Date => Boolean): Self = StObject.set(x, "isFutureDay", js.Any.fromFunction1(value))
      
      inline def setIsPastDay(value: Date => Boolean): Self = StObject.set(x, "isPastDay", js.Any.fromFunction1(value))
      
      inline def setIsSameDay(value: (Date, Date) => Boolean): Self = StObject.set(x, "isSameDay", js.Any.fromFunction2(value))
      
      inline def setIsSameMonth(value: (Date, Date) => Boolean): Self = StObject.set(x, "isSameMonth", js.Any.fromFunction2(value))
    }
  }
}
