...
import typings.reactDayPicker.reactDayPickerStrings.environment
...
import typings.reactDayPicker.reactDayPickerStrings.user
...
object PickButtonPropsmultiplede {
  
  inline def apply(): PickButtonPropsmultiplede = {
