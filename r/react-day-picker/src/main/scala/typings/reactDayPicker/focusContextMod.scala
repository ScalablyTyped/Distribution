...
object focusContextMod {
  
  @JSImport("react-day-picker/dist/contexts/Focus/FocusContext", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-day-picker/dist/contexts/Focus/FocusContext", "FocusContext")
  @js.native
