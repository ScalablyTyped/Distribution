...
object typesFormattersMod {
  
  type DateFormatter = js.Function2[/* date */ js.Date, /* options */ js.UndefOr[`1`], ReactNode]
  ...
  object Formatters {
    ...
    inline def apply(
      formatCaption: (/* date */ js.Date, /* options */ js.UndefOr[`1`]) => ReactNode,
      formatDay: (/* date */ js.Date, /* options */ js.UndefOr[`1`]) => ReactNode,
      formatMonthCaption: (/* date */ js.Date, /* options */ js.UndefOr[`1`]) => ReactNode,
      formatWeekNumber: (/* weekNumber */ Double, /* options */ js.UndefOr[`1`]) => ReactNode,
      formatWeekdayName: (/* date */ js.Date, /* options */ js.UndefOr[`1`]) => ReactNode,
      formatYearCaption: (/* date */ js.Date, /* options */ js.UndefOr[`1`]) => ReactNode
    ): Formatters = {
  ...
  type WeekNumberFormatter = js.Function2[/* weekNumber */ Double, /* options */ js.UndefOr[`1`], ReactNode]
}
