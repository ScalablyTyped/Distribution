...
import typings.rcTrigger.AnonAdjustX
...
object AlignType {
  @scala.inline
  def apply(
    ignoreShake: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(ignoreShake)) __obj.updateDynamic("ignoreShake")(ignoreShake.asInstanceOf[js.Any])
