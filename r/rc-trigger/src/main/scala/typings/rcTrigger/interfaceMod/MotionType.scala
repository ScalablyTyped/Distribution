...
object MotionType {
  @scala.inline
  def apply(): MotionType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MotionType]
  }
  @scala.inline
  implicit class MotionTypeOps[Self <: MotionType] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMotionName(value: String | MotionNameObject): Self = this.set("motionName", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMotionName: Self = this.set("motionName", js.undefined)
    @scala.inline
    def setOnAppearActive(
      value: (/* element */ HTMLElement, /* event */ js.UndefOr[TransitionEvent[HTMLElement] | AnimationEvent[HTMLElement]]) => js.UndefOr[CSSProperties | `false` | Null | Unit]
