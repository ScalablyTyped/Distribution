...
import typings.reactNativeWindows.anon.ReadonlyNativeMethods
...
trait HostComponent[P]
  ...
  var defaultProps: js.UndefOr[Partial[typings.reactNativeWindows.reactNativeWindowsStrings.defaultProps]] = js.native
  
  var displayName: js.UndefOr[String] = js.native
  
  var getDerivedStateFromError: js.UndefOr[
    GetDerivedStateFromError[
      typings.reactNativeWindows.reactNativeWindowsStrings.getDerivedStateFromError, 
      ComponentState
    ]
  ] = js.native
  ...
  var getDerivedStateFromProps: js.UndefOr[
    GetDerivedStateFromProps[
      typings.reactNativeWindows.reactNativeWindowsStrings.getDerivedStateFromProps, 
      ComponentState
    ]
  ] = js.native
  
  var propTypes: js.UndefOr[
    WeakValidationMap[typings.reactNativeWindows.reactNativeWindowsStrings.propTypes]
  ] = js.native
}
