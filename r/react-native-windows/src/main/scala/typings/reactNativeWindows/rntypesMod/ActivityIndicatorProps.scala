...
import typings.reactNativeWindows.reactNativeWindowsStrings.large_
import typings.reactNativeWindows.reactNativeWindowsStrings.small_
...
object ActivityIndicatorProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ActivityIndicatorProps] (val x: Self) extends AnyVal {
