...
import typings.reactNativeWindows.reactNativeWindowsStrings.Dragging
import typings.reactNativeWindows.reactNativeWindowsStrings.Idle
import typings.reactNativeWindows.reactNativeWindowsStrings.Settling
import typings.reactNativeWindows.reactNativeWindowsStrings.`on-drag`
