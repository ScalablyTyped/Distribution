...
import typings.reactNativeWindows.reactNativeWindowsStrings.`locked-closed`
import typings.reactNativeWindows.reactNativeWindowsStrings.`locked-open`
...
import typings.reactNativeWindows.reactNativeWindowsStrings.unlocked
