...
- Dropped new (args : ...any): react-native-windows.react-native-windows/rntypes.NativeMethods */ @JSImport("react-native-windows/rntypes", "Image")
@js.native
open class Image ()
...
object Image {
  ...
  @JSImport("react-native-windows/rntypes", "Image")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-native-windows/rntypes", "Image.abortPrefetch")
  @js.native
  ...
  @JSImport("react-native-windows/rntypes", "Image.queryCache")
  @js.native
