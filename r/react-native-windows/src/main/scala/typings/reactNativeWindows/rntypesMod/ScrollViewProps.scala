...
import typings.reactNativeWindows.reactNativeWindowsStrings.fast
import typings.reactNativeWindows.reactNativeWindowsStrings.handled
import typings.reactNativeWindows.reactNativeWindowsStrings.interactive
