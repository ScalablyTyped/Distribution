...
import typings.reactNativeWindows.reactNativeWindowsStrings.URL
import typings.reactNativeWindows.reactNativeWindowsStrings.`unless-editing`
import typings.reactNativeWindows.reactNativeWindowsStrings.`while-editing`
import typings.reactNativeWindows.reactNativeWindowsStrings.addressCity
import typings.reactNativeWindows.reactNativeWindowsStrings.addressCityAndState
import typings.reactNativeWindows.reactNativeWindowsStrings.addressState
import typings.reactNativeWindows.reactNativeWindowsStrings.always
import typings.reactNativeWindows.reactNativeWindowsStrings.countryName
import typings.reactNativeWindows.reactNativeWindowsStrings.creditCardNumber
...
import typings.reactNativeWindows.reactNativeWindowsStrings.emailAddress
import typings.reactNativeWindows.reactNativeWindowsStrings.familyName
import typings.reactNativeWindows.reactNativeWindowsStrings.fullStreetAddress
import typings.reactNativeWindows.reactNativeWindowsStrings.givenName
import typings.reactNativeWindows.reactNativeWindowsStrings.jobTitle
import typings.reactNativeWindows.reactNativeWindowsStrings.light
import typings.reactNativeWindows.reactNativeWindowsStrings.location
import typings.reactNativeWindows.reactNativeWindowsStrings.middleName
import typings.reactNativeWindows.reactNativeWindowsStrings.name
import typings.reactNativeWindows.reactNativeWindowsStrings.namePrefix
import typings.reactNativeWindows.reactNativeWindowsStrings.nameSuffix
import typings.reactNativeWindows.reactNativeWindowsStrings.never
import typings.reactNativeWindows.reactNativeWindowsStrings.newPassword
import typings.reactNativeWindows.reactNativeWindowsStrings.nickname
import typings.reactNativeWindows.reactNativeWindowsStrings.none
import typings.reactNativeWindows.reactNativeWindowsStrings.oneTimeCode
import typings.reactNativeWindows.reactNativeWindowsStrings.organizationName
import typings.reactNativeWindows.reactNativeWindowsStrings.password
import typings.reactNativeWindows.reactNativeWindowsStrings.postalCode
import typings.reactNativeWindows.reactNativeWindowsStrings.streetAddressLine1
import typings.reactNativeWindows.reactNativeWindowsStrings.streetAddressLine2
import typings.reactNativeWindows.reactNativeWindowsStrings.sublocality
import typings.reactNativeWindows.reactNativeWindowsStrings.telephoneNumber
