...
- Dropped new (args : ...any): react-native-windows.react-native-windows/rntypes.TouchableMixin */ @JSImport("react-native-windows/rntypes", "TouchableNativeFeedback")
@js.native
...
object TouchableNativeFeedback {
  ...
  @JSImport("react-native-windows/rntypes", "TouchableNativeFeedback")
  @js.native
