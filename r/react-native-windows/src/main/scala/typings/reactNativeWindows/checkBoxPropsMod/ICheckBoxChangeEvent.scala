...
@js.native
trait ICheckBoxChangeEvent extends js.Object {
...
object ICheckBoxChangeEvent {
  ...
  @scala.inline
  implicit class ICheckBoxChangeEventOps[Self <: ICheckBoxChangeEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNativeEvent(value: Value): Self = this.set("nativeEvent", value.asInstanceOf[js.Any])
  }
}
