...
object reactourComponents extends reactourProps {
  @scala.inline
  def Arrow: ComponentType[typings.reactour.reactourMod.ArrowProps] = typings.reactour.reactourMod.^.asInstanceOf[js.Dynamic].selectDynamic("Arrow").asInstanceOf[typings.react.reactMod.ComponentType[typings.reactour.reactourMod.ArrowProps]]
  @scala.inline
  ...
  @scala.inline
  def Close: ComponentType[typings.reactour.reactourMod.CloseProps] = typings.reactour.reactourMod.^.asInstanceOf[js.Dynamic].selectDynamic("Close").asInstanceOf[typings.react.reactMod.ComponentType[typings.reactour.reactourMod.CloseProps]]
  @scala.inline
