...
object dbDatabaseMod {
  ...
  trait SchemaSpec[I /* <: IndexedModelClasses[
    ...
    var tables: /* import warning: importer.ImportType#apply Failed type conversion: {[ K in keyof I ]: redux-orm.redux-orm/db/Table.ModelTableOpts<I[K]>} */ js.Any
  }
  object SchemaSpec {
    ...
    inline def apply[I /* <: IndexedModelClasses[
      ...
      tables: /* import warning: importer.ImportType#apply Failed type conversion: {[ K in keyof I ]: redux-orm.redux-orm/db/Table.ModelTableOpts<I[K]>} */ js.Any
    ): SchemaSpec[I] = {
