...
class QuerySet[Fields, Additional, VirtualFields] protected () extends js.Object {
  def this(modelClass: ScalablyTyped.runtime.Instantiable1[/* props */ ModelProps, Model[js.Object, js.Object, js.Object]], clauses: QuerySetClauses, opts: QuerySetOpts) = this()
