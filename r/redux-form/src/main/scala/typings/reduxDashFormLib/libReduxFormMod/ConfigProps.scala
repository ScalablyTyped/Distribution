...
object ConfigProps {
  ...
  def apply[FormData, P, ErrorType](
    ...
    shouldAsyncValidate: js.Function1[/* params */ AsyncValidateCallback[FormData, ErrorType], scala.Boolean] = null,
    shouldError: js.Function1[/* params */ ValidateCallback[FormData, P, ErrorType], scala.Boolean] = null,
    shouldValidate: js.Function1[/* params */ ValidateCallback[FormData, P, ErrorType], scala.Boolean] = null,
    shouldWarn: js.Function1[/* params */ ValidateCallback[FormData, P, ErrorType], scala.Boolean] = null,
    ...
    if (onSubmitFail != null) __obj.updateDynamic("onSubmitFail")(onSubmitFail)
    if (onSubmitSuccess != null) __obj.updateDynamic("onSubmitSuccess")(onSubmitSuccess)
    ...
    if (shouldAsyncValidate != null) __obj.updateDynamic("shouldAsyncValidate")(shouldAsyncValidate)
    if (shouldError != null) __obj.updateDynamic("shouldError")(shouldError)
    if (shouldValidate != null) __obj.updateDynamic("shouldValidate")(shouldValidate)
    if (shouldWarn != null) __obj.updateDynamic("shouldWarn")(shouldWarn)
