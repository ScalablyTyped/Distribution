...
trait CommonFieldProps extends CommonFieldInputProps {
  @JSName("onBlur")
  var onBlur_Original: EventWithDataHandler[reactLib.reactMod.ReactNs.FocusEvent[_]] = js.native
  @JSName("onChange")
  var onChange_Original: EventWithDataHandler[reactLib.reactMod.ReactNs.ChangeEvent[_]] = js.native
