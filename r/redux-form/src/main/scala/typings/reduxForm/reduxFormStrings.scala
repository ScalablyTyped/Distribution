...
object reduxFormStrings {
  ...
  sealed trait FieldArray
    extends StObject
       with FieldType
  inline def FieldArray: FieldArray = "FieldArray".asInstanceOf[FieldArray]
  ...
  @js.native
  sealed trait getAll extends StObject
  inline def getAll: getAll = "getAll".asInstanceOf[getAll]
