...
class TournamentAPI protected () extends API {
  ...
  ): stdLib.Promise[js.Array[scala.Double]] = js.native
  /**
  ...
  /**
          ...
          */
  def getLobbyEventByCode(tournamentCode: java.lang.String): stdLib.Promise[riotDashGamesDashApiLib.RiotGamesAPINs.TournamentProviderNs.LobbyEventDto] = js.native
  /**
          ...
          */
  def getTournamentByCode(tournamentCode: java.lang.String): stdLib.Promise[riotDashGamesDashApiLib.RiotGamesAPINs.TournamentProviderNs.TournamentCodeDto] = js.native
  /**
          ...
          */
  def registerProvider(region: region_e, url: java.lang.String): stdLib.Promise[scala.Double] = js.native
  /**
          ...
          */
  def registerTournament(name: java.lang.String, providerId: scala.Double): stdLib.Promise[scala.Double] = js.native
}
