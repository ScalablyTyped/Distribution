...
import typings.riotDashGamesDashApi.RiotGamesAPINs.ChampionMasteryNs.ChampionMasteryDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.ChampionNs.ChampionDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.ChampionNs.ChampionListDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.CurrentGameNs.CurrentGameInfo
import typings.riotDashGamesDashApi.RiotGamesAPINs.FeaturedGamesNs.FeaturedGames
import typings.riotDashGamesDashApi.RiotGamesAPINs.GameNs.RecentGamesDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LeagueNs.LeagueDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.ItemDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.ItemListDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.LanguageStringsDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.MapDataDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.MasteryDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.MasteryListDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.RealmDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.RuneDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.RuneListDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.SummonerSpellDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.SummonerSpellListDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.LolStatusNs.Shard
import typings.riotDashGamesDashApi.RiotGamesAPINs.MatchListNs.MatchList
import typings.riotDashGamesDashApi.RiotGamesAPINs.MatchNs.MatchDetail
import typings.riotDashGamesDashApi.RiotGamesAPINs.StatsNs.PlayerStatsSummaryListDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.StatsNs.RankedStatsDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.SummonerNs.MasteryPagesDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.SummonerNs.RunePagesDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.SummonerNs.SummonerDto
import typings.riotDashGamesDashApi.RiotGamesAPINs.TeamNs.TeamDto
...
class ClassicAPI protected () extends API {
  ...
  /**
    ...
    */
  def staticDataChampionById(championsId: Double): js.Promise[typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.ChampionDto] = js.native
  /**
    * get Champions (static data)
    * @param     {RiotGamesAPI.LolStaticData.ChampionListDto}    callback    data callback
    */
  def staticDataChampions(): js.Promise[typings.riotDashGamesDashApi.RiotGamesAPINs.LolStaticDataNs.ChampionListDto] = js.native
  /**
