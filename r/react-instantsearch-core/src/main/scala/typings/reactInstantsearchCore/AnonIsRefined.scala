...
trait AnonIsRefined extends js.Object {
...
object AnonIsRefined {
  @scala.inline
  def apply(isRefined: Boolean, label: String, noRefinement: Boolean, value: String): AnonIsRefined = {
    ...
    __obj.asInstanceOf[AnonIsRefined]
  }
}
