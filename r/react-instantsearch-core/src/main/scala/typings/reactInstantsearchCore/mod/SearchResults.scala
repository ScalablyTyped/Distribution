...
object SearchResults {
  ...
  extension [Self <: SearchResults[?], TDoc](x: Self & SearchResults[TDoc]) {
    ...
    inline def setDisjunctiveFacets(value: js.Array[js.Any]): Self = StObject.set(x, "disjunctiveFacets", value.asInstanceOf[js.Any])
    
    inline def setDisjunctiveFacetsVarargs(value: js.Any*): Self = StObject.set(x, "disjunctiveFacets", js.Array(value :_*))
    
    inline def setExhaustiveNbHits(value: Boolean): Self = StObject.set(x, "exhaustiveNbHits", value.asInstanceOf[js.Any])
    
    inline def setFacets(value: js.Array[js.Any]): Self = StObject.set(x, "facets", value.asInstanceOf[js.Any])
    
    inline def setFacetsVarargs(value: js.Any*): Self = StObject.set(x, "facets", js.Array(value :_*))
    
    inline def setHierarchicalFacets(value: js.Array[js.Any]): Self = StObject.set(x, "hierarchicalFacets", value.asInstanceOf[js.Any])
    
    inline def setHierarchicalFacetsVarargs(value: js.Any*): Self = StObject.set(x, "hierarchicalFacets", js.Array(value :_*))
    ...
    inline def setHitsVarargs(value: Hit[TDoc]*): Self = StObject.set(x, "hits", js.Array(value :_*))
