...
package object mod {
  type AllSearchResults[TDoc] = org.scalablytyped.runtime.StringDictionary[typings.reactInstantsearchCore.mod.SearchResults[TDoc]] with typings.reactInstantsearchCore.mod.SearchResults[TDoc]
  ...
  type ConnectorProvided[TProvided] = typings.reactInstantsearchCore.AnonArgs with TProvided
  ...
  type Refinement = typings.reactInstantsearchCore.AnonAttribute with (typings.reactInstantsearchCore.AnonCurrentRefinement | typings.reactInstantsearchCore.AnonCurrentRefinementItems)
