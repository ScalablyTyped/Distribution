...
object HIGHLIGHT_TAGS {
  ...
  @JSImport("react-instantsearch-core", "HIGHLIGHT_TAGS")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-instantsearch-core", "HIGHLIGHT_TAGS.highlightPostTag")
  @js.native
  ...
  @JSImport("react-instantsearch-core", "HIGHLIGHT_TAGS.highlightPreTag")
  @js.native
