...
object InstantSearchProps {
  ...
  def apply(
    ...
    stalledSearchDelay: js.UndefOr[Double] = js.undefined
  ): InstantSearchProps = {
    ...
    if (!js.isUndefined(stalledSearchDelay)) __obj.updateDynamic("stalledSearchDelay")(stalledSearchDelay.get.asInstanceOf[js.Any])
