...
trait Anon_Adsense extends js.Object {
  ...
  val adsenseNs: Anon_AdUnit
  val drawingNs: Anon_DrawingManager
  var event: Anon_AddDomListener
  val geometryNs: Anon_Encoding
  val placesNs: Anon_AttrContainer
  val visualizationNs: Anon_HeatmapLayer
}
...
object Anon_Adsense {
  ...
  def apply(
    ...
    adsenseNs: Anon_AdUnit,
    drawingNs: Anon_DrawingManager,
    event: Anon_AddDomListener,
    geometryNs: Anon_Encoding,
    placesNs: Anon_AttrContainer,
    visualizationNs: Anon_HeatmapLayer
  ): Anon_Adsense = {
    ...
    __obj.asInstanceOf[Anon_Adsense]
  }
}
