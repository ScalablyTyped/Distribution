...
- typings.reactMdTransition.typesTypesMod.CSSTransitionElementProps because var conflicts: ref. Inlined className */ trait CSSTransitionHookReturnValue[E /* <: HTMLElement */]
  extends StObject
