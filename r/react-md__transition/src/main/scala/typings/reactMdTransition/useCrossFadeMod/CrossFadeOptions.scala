...
object CrossFadeOptions {
  @scala.inline
  def apply[/* <: typings.std.HTMLElement */ E](): CrossFadeOptions[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CrossFadeOptions[E]]
  }
  @scala.inline
  implicit class CrossFadeOptionsOps[Self <: CrossFadeOptions[_], /* <: typings.std.HTMLElement */ E] (val x: Self with CrossFadeOptions[E]) extends AnyVal {
    @scala.inline
