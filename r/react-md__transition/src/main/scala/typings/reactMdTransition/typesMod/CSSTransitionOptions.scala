...
object CSSTransitionOptions {
  @scala.inline
  def apply[/* <: typings.std.HTMLElement */ E](classNames: CSSTransitionClassNames | String, timeout: TransitionTimeout, transitionIn: Boolean): CSSTransitionOptions[E] = {
  ...
  @scala.inline
  implicit class CSSTransitionOptionsOps[Self <: CSSTransitionOptions[_], /* <: typings.std.HTMLElement */ E] (val x: Self with CSSTransitionOptions[E]) extends AnyVal {
    @scala.inline
