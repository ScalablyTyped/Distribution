...
@js.native
trait OverridableCSSTransitionProps extends js.Object {
...
object OverridableCSSTransitionProps {
  ...
  @scala.inline
  implicit class OverridableCSSTransitionPropsOps[Self <: OverridableCSSTransitionProps] (val x: Self) extends AnyVal {
