...
object CollapseOptions {
  @scala.inline
  def apply[/* <: typings.std.HTMLElement */ E](): CollapseOptions[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CollapseOptions[E]]
  }
  @scala.inline
  implicit class CollapseOptionsOps[Self <: CollapseOptions[_], /* <: typings.std.HTMLElement */ E] (val x: Self with CollapseOptions[E]) extends AnyVal {
    @scala.inline
