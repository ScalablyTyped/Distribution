...
object CSSTransitionProvidedProps {
  ...
  @scala.inline
  implicit class CSSTransitionProvidedPropsOps[Self <: CSSTransitionProvidedProps[_], E /* <: HTMLElement */] (val x: Self with CSSTransitionProvidedProps[E]) extends AnyVal {
