...
import typings.reactMdTransition.typesTypesMod.CSSTransitionElementProps
...
object typesUseCollapseTransitionMod {
  ...
  - typings.reactMdTransition.typesTypesMod.CSSTransitionElementProps because Already inherited
  - typings.reactMdTransition.typesUseCollapseTransitionMod.CollapseElementProps because var conflicts: className, ref. Inlined style, hidden */ trait CollapseTransitionHookReturnValue[E /* <: HTMLElement */]
    extends StObject
