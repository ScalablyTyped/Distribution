...
object anon {
  ...
  object PickCrossFadePropshiddenc {
    ...
    inline def apply(): PickCrossFadePropshiddenc = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PickCrossFadePropshiddenc]
    }
    
    extension [Self <: PickCrossFadePropshiddenc](x: Self) {
      ...
      inline def setOnEnter(value: (HTMLDivElement, /* isAppearing */ Boolean) => Unit): Self = StObject.set(x, "onEnter", js.Any.fromFunction2(value))
      
      inline def setOnEnterUndefined: Self = StObject.set(x, "onEnter", js.undefined)
      
      inline def setOnEntered(value: (HTMLDivElement, /* isAppearing */ Boolean) => Unit): Self = StObject.set(x, "onEntered", js.Any.fromFunction2(value))
      
      inline def setOnEnteredUndefined: Self = StObject.set(x, "onEntered", js.undefined)
      
      inline def setOnEntering(value: (HTMLDivElement, /* isAppearing */ Boolean) => Unit): Self = StObject.set(x, "onEntering", js.Any.fromFunction2(value))
      ...
      inline def setOnExit(value: HTMLDivElement => Unit): Self = StObject.set(x, "onExit", js.Any.fromFunction1(value))
      
      inline def setOnExitUndefined: Self = StObject.set(x, "onExit", js.undefined)
      
      inline def setOnExited(value: HTMLDivElement => Unit): Self = StObject.set(x, "onExited", js.Any.fromFunction1(value))
      
      inline def setOnExitedUndefined: Self = StObject.set(x, "onExited", js.undefined)
      
      inline def setOnExiting(value: HTMLDivElement => Unit): Self = StObject.set(x, "onExiting", js.Any.fromFunction1(value))
