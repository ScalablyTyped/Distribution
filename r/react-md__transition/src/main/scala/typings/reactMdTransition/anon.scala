...
object anon {
  ...
  trait PickCrossFadePropshiddenc extends StObject {
    ...
    var onEnter: js.UndefOr[EnterHandler[HTMLDivElement]] = js.native
    
    var onEntered: js.UndefOr[EnterHandler[HTMLDivElement]] = js.native
    
    var onEntering: js.UndefOr[EnterHandler[HTMLDivElement]] = js.native
    
    var onError: js.UndefOr[ReactEventHandler[HTMLDivElement]] = js.native
    
    var onErrorCapture: js.UndefOr[js.Any] = js.native
    
    var onExit: js.UndefOr[ExitHandler[HTMLDivElement]] = js.native
    
    var onExited: js.UndefOr[ExitHandler[HTMLDivElement]] = js.native
    
    var onExiting: js.UndefOr[ExitHandler[HTMLDivElement]] = js.native
