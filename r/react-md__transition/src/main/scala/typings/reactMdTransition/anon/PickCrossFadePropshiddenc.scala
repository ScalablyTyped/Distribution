package typings.reactMdTransition.anon
...
object PickCrossFadePropshiddenc {
  ...
  @scala.inline
  implicit class PickCrossFadePropshiddencOps[Self <: PickCrossFadePropshiddenc] (val x: Self) extends AnyVal {
    @scala.inline
