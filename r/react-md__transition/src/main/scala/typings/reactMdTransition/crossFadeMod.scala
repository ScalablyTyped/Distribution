...
object crossFadeMod {
  ...
  @JSImport("@react-md/transition/types/CrossFade", "CrossFade")
  @js.native
  ...
  @js.native
  trait CrossFadeProps extends StObject {
  ...
  object CrossFadeProps {
    ...
    @scala.inline
    implicit class CrossFadePropsMutableBuilder[Self <: CrossFadeProps] (val x: Self) extends AnyVal {
