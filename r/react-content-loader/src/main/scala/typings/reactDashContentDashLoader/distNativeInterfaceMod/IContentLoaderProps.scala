package typings.reactDashContentDashLoader.distNativeInterfaceMod
...
import typings.reactDashNativeDashSvg.reactDashNativeDashSvgMod.SvgProps
...
import typings.reactDashNativeDashSvg.reactDashNativeDashSvgStrings.default
...
object IContentLoaderProps {
  ...
  def apply(
    ...
    pointerEvents: `box-none` | typings.reactDashNativeDashSvg.reactDashNativeDashSvgStrings.none | `box-only` | typings.reactDashNativeDashSvg.reactDashNativeDashSvgStrings.auto = null,
    ...
    vectorEffect: typings.reactDashNativeDashSvg.reactDashNativeDashSvgStrings.none | `non-scaling-stroke` | nonScalingStroke | default | inherit | uri = null,
    viewBox: String = null,
