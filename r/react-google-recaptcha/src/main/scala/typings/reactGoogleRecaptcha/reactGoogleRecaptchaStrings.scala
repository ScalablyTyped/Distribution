...
import typings.reactGoogleRecaptcha.mod.Badge
import typings.reactGoogleRecaptcha.mod.Size
import typings.reactGoogleRecaptcha.mod.Theme
import typings.reactGoogleRecaptcha.mod.Type
