...
object PartialRRuleStrOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(forceset)) __obj.updateDynamic("forceset")(forceset.get.asInstanceOf[js.Any])
    if (tzid != null) __obj.updateDynamic("tzid")(tzid.asInstanceOf[js.Any])
    if (!js.isUndefined(unfold)) __obj.updateDynamic("unfold")(unfold.get.asInstanceOf[js.Any])
