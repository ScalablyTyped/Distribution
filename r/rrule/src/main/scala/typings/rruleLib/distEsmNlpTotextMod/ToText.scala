...
trait ToText extends js.Object {
  ...
  def list(arr: js.Array[rruleLib.distEsmTypesMod.ByWeekday]): java.lang.String = js.native
  def list(arr: js.Array[rruleLib.distEsmTypesMod.ByWeekday], callback: GetText): java.lang.String = js.native
  def list(arr: js.Array[rruleLib.distEsmTypesMod.ByWeekday], callback: GetText, finalDelim: java.lang.String): java.lang.String = js.native
  def list(
    arr: js.Array[rruleLib.distEsmTypesMod.ByWeekday],
    callback: GetText,
    finalDelim: java.lang.String,
    delim: java.lang.String
  ): java.lang.String = js.native
  def list(arr: rruleLib.distEsmTypesMod.ByWeekday): java.lang.String = js.native
  def list(arr: rruleLib.distEsmTypesMod.ByWeekday, callback: GetText): java.lang.String = js.native
  def list(arr: rruleLib.distEsmTypesMod.ByWeekday, callback: GetText, finalDelim: java.lang.String): java.lang.String = js.native
  def list(
    arr: rruleLib.distEsmTypesMod.ByWeekday,
    callback: GetText,
    finalDelim: java.lang.String,
    delim: java.lang.String
  ): java.lang.String = js.native
  ...
  def weekdaytext(wday: rruleLib.distEsmWeekdayMod.Weekday): java.lang.String = js.native
