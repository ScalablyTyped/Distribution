package typings
package rruleLib.distEsmSrcCacheMod
...
class Cache () extends js.Object {
  var after: js.Array[rruleLib.distEsmSrcIterresultMod.IterArgs] = js.native
  var all: js.Array[stdLib.Date] | stdLib.Partial[rruleLib.distEsmSrcIterresultMod.IterArgs] | rruleLib.rruleLibNumbers.`false` = js.native
  var before: js.Array[rruleLib.distEsmSrcIterresultMod.IterArgs] = js.native
  var between: js.Array[rruleLib.distEsmSrcIterresultMod.IterArgs] = js.native
  ...
  def _cacheGet(what: CacheKeys, args: stdLib.Partial[rruleLib.distEsmSrcIterresultMod.IterArgs]): stdLib.Date | js.Array[stdLib.Date] | rruleLib.rruleLibNumbers.`false` | scala.Null = js.native
  @JSName("_cacheGet")
  ...
  def _cacheGet_all(
    what: rruleLib.rruleLibStrings.all,
    args: stdLib.Partial[rruleLib.distEsmSrcIterresultMod.IterArgs]
  ): stdLib.Date | js.Array[stdLib.Date] | rruleLib.rruleLibNumbers.`false` | scala.Null = js.native
}
