...
trait NavLinkProps[S] extends LinkProps[S] {
  ...
  var isActive: js.UndefOr[js.Function2[/* match */ `match`[_] | Null, /* location */ Location[S], Boolean]] = js.undefined
...
object NavLinkProps {
  ...
  def apply[S](
    ...
    is: String = null,
    isActive: (/* match */ `match`[_] | Null, /* location */ Location[S]) => Boolean = null,
    itemID: String = null,
