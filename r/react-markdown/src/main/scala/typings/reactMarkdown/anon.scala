...
import typings.reactMarkdown.reactMarkdownBooleans.`true`
...
object anon {
  ...
  object Checked {
    ...
    inline def apply(index: Double, ordered: Boolean): Checked = {
      val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any], ordered = ordered.asInstanceOf[js.Any], checked = null)
  ...
  object Depth {
    ...
    inline def apply(depth: Double): Depth = {
      val __obj = js.Dynamic.literal(depth = depth.asInstanceOf[js.Any], ordered = true)
    ...
    extension [Self <: Depth](x: Self) {
      ...
      inline def setOrdered(value: `true`): Self = StObject.set(x, "ordered", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait IsHeader extends StObject {
    
    var isHeader: Boolean
    
    var style: js.UndefOr[Record[String, Any]] = js.undefined
  }
  object IsHeader {
    
    inline def apply(isHeader: Boolean): IsHeader = {
      val __obj = js.Dynamic.literal(isHeader = isHeader.asInstanceOf[js.Any])
      __obj.asInstanceOf[IsHeader]
    }
    
    extension [Self <: IsHeader](x: Self) {
  ...
  trait IsHeaderBoolean extends StObject {
    
    var isHeader: Boolean
  }
  object IsHeaderBoolean {
    
    inline def apply(isHeader: Boolean): IsHeaderBoolean = {
      val __obj = js.Dynamic.literal(isHeader = isHeader.asInstanceOf[js.Any])
      __obj.asInstanceOf[IsHeaderBoolean]
    }
    
    extension [Self <: IsHeaderBoolean](x: Self) {
  ...
  object Ordered {
    ...
    inline def apply(depth: Double): Ordered = {
      val __obj = js.Dynamic.literal(depth = depth.asInstanceOf[js.Any], ordered = false)
    ...
    extension [Self <: Ordered](x: Self) {
      ...
      inline def setOrdered(value: `false`): Self = StObject.set(x, "ordered", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait PartialOmitNormalComponen extends StObject {
  ...
  object PartialOmitNormalComponen {
    
    inline def apply(): PartialOmitNormalComponen = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PartialOmitNormalComponen]
    }
    
    extension [Self <: PartialOmitNormalComponen](x: Self) {
