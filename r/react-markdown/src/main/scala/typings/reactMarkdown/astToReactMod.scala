...
import typings.reactMarkdown.anon.Checked
import typings.reactMarkdown.anon.Depth
import typings.reactMarkdown.anon.Inline
import typings.reactMarkdown.anon.IsHeader
import typings.reactMarkdown.anon.IsHeaderBoolean
import typings.reactMarkdown.anon.Level
import typings.reactMarkdown.anon.Ordered
import typings.reactMarkdown.anon.PartialOmitNormalComponen
import typings.reactMarkdown.reactMarkdownBooleans.`false`
import typings.reactMarkdown.reactMarkdownStrings.code
import typings.reactMarkdown.reactMarkdownStrings.h1
import typings.reactMarkdown.reactMarkdownStrings.li
import typings.reactMarkdown.reactMarkdownStrings.ol
import typings.reactMarkdown.reactMarkdownStrings.raw
import typings.reactMarkdown.reactMarkdownStrings.table
import typings.reactMarkdown.reactMarkdownStrings.tr
import typings.reactMarkdown.reactMarkdownStrings.ul
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object astToReactMod {
  
  @JSImport("react-markdown/lib/ast-to-react", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def childrenToReact(context: Context, node: Element): js.Array[typings.react.mod.ReactNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("childrenToReact")(context.asInstanceOf[js.Any], node.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.react.mod.ReactNode]]
  inline def childrenToReact(context: Context, node: Root): js.Array[typings.react.mod.ReactNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("childrenToReact")(context.asInstanceOf[js.Any], node.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.react.mod.ReactNode]]
  
  type CodeComponent = ComponentType[CodeProps]
  
  type CodeProps = ComponentPropsWithoutRef[code] & ReactMarkdownProps & Inline
  
  type Comment = typings.hast.mod.Comment
  
  type ComponentPropsWithoutRef[T] = typings.react.mod.ComponentPropsWithoutRef[T]
  
  type ComponentType[T] = typings.react.mod.ComponentType[T]
  
  /* Inlined std.Partial<std.Omit<react-markdown.react-markdown/lib/complex-types.NormalComponents, keyof react-markdown.react-markdown/lib/ast-to-react.SpecialComponents> & react-markdown.react-markdown/lib/ast-to-react.SpecialComponents> */
  ...
  object Context {
    ...
    inline def apply(listDepth: Double, options: Options, schema: Schema): Context = {
      val __obj = js.Dynamic.literal(listDepth = listDepth.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], schema = schema.asInstanceOf[js.Any])
      __obj.asInstanceOf[Context]
    }
    
    extension [Self <: Context](x: Self) {
      
      inline def setListDepth(value: Double): Self = StObject.set(x, "listDepth", value.asInstanceOf[js.Any])
  ...
  type HeadingComponent = ComponentType[HeadingProps]
  
  type HeadingProps = ComponentPropsWithoutRef[h1] & ReactMarkdownProps & Level
  
  type Info = typings.propertyInformation.mod.Info
  
  type LiComponent = ComponentType[LiProps]
  
  type LiProps = ComponentPropsWithoutRef[li] & ReactMarkdownProps & Checked
  
  trait Options extends StObject {
    
    var components: js.UndefOr[PartialOmitNormalComponen] = js.undefined
    
    var includeElementIndex: js.UndefOr[Boolean] = js.undefined
    
    var linkTarget: js.UndefOr[HTMLAttributeAnchorTarget | TransformLinkTarget] = js.undefined
    
    var rawSourcePos: js.UndefOr[Boolean] = js.undefined
    
    var skipHtml: js.UndefOr[Boolean] = js.undefined
    
    var sourcePos: js.UndefOr[Boolean] = js.undefined
    
    var transformImageUri: js.UndefOr[TransformImage] = js.undefined
    
    var transformLinkUri: js.UndefOr[`false` | TransformLink | Null] = js.undefined
  }
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setComponents(value: PartialOmitNormalComponen): Self = StObject.set(x, "components", value.asInstanceOf[js.Any])
      
      inline def setComponentsUndefined: Self = StObject.set(x, "components", js.undefined)
      
      inline def setIncludeElementIndex(value: Boolean): Self = StObject.set(x, "includeElementIndex", value.asInstanceOf[js.Any])
      
      inline def setIncludeElementIndexUndefined: Self = StObject.set(x, "includeElementIndex", js.undefined)
      
      inline def setLinkTarget(value: HTMLAttributeAnchorTarget | TransformLinkTarget): Self = StObject.set(x, "linkTarget", value.asInstanceOf[js.Any])
      
      inline def setLinkTargetFunction3(
        value: (/* href */ String, /* children */ js.Array[ElementContent], /* title */ String | Null) => js.UndefOr[TransformLinkTargetType]
      ): Self = StObject.set(x, "linkTarget", js.Any.fromFunction3(value))
      ...
      inline def setTransformImageUri(value: (/* src */ String, /* alt */ String, /* title */ String | Null) => String): Self = StObject.set(x, "transformImageUri", js.Any.fromFunction3(value))
      
      inline def setTransformImageUriUndefined: Self = StObject.set(x, "transformImageUri", js.undefined)
      
      inline def setTransformLinkUri(value: `false` | TransformLink): Self = StObject.set(x, "transformLinkUri", value.asInstanceOf[js.Any])
      
      inline def setTransformLinkUriFunction3(
        value: (/* href */ String, /* children */ js.Array[ElementContent], /* title */ String | Null) => String
  ...
  type OrderedListComponent = ComponentType[OrderedListProps]
  
  type OrderedListProps = ComponentPropsWithoutRef[ol] & ReactMarkdownProps & Depth
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactMarkdown.reactMarkdownStrings.a
    - typings.reactMarkdown.reactMarkdownStrings.abbr
    - typings.reactMarkdown.reactMarkdownStrings.address
    - typings.reactMarkdown.reactMarkdownStrings.area
    - typings.reactMarkdown.reactMarkdownStrings.article
    - typings.reactMarkdown.reactMarkdownStrings.aside
    - typings.reactMarkdown.reactMarkdownStrings.audio
    - typings.reactMarkdown.reactMarkdownStrings.b
    - typings.reactMarkdown.reactMarkdownStrings.base
    - typings.reactMarkdown.reactMarkdownStrings.bdi
    - typings.reactMarkdown.reactMarkdownStrings.bdo
    - typings.reactMarkdown.reactMarkdownStrings.big
    - typings.reactMarkdown.reactMarkdownStrings.blockquote
    - typings.reactMarkdown.reactMarkdownStrings.body
    - typings.reactMarkdown.reactMarkdownStrings.br
    - typings.reactMarkdown.reactMarkdownStrings.button
    - typings.reactMarkdown.reactMarkdownStrings.canvas
    - typings.reactMarkdown.reactMarkdownStrings.caption
    - typings.reactMarkdown.reactMarkdownStrings.cite
    - typings.reactMarkdown.reactMarkdownStrings.code
    - typings.reactMarkdown.reactMarkdownStrings.col
    - typings.reactMarkdown.reactMarkdownStrings.colgroup
    - typings.reactMarkdown.reactMarkdownStrings.data
    - typings.reactMarkdown.reactMarkdownStrings.datalist
    - typings.reactMarkdown.reactMarkdownStrings.dd
    - typings.reactMarkdown.reactMarkdownStrings.del
    - typings.reactMarkdown.reactMarkdownStrings.details
    - typings.reactMarkdown.reactMarkdownStrings.dfn
    - typings.reactMarkdown.reactMarkdownStrings.dialog
    - typings.reactMarkdown.reactMarkdownStrings.div
    - typings.reactMarkdown.reactMarkdownStrings.dl
    - typings.reactMarkdown.reactMarkdownStrings.dt
    - typings.reactMarkdown.reactMarkdownStrings.em
    - typings.reactMarkdown.reactMarkdownStrings.embed
    - typings.reactMarkdown.reactMarkdownStrings.fieldset
    - typings.reactMarkdown.reactMarkdownStrings.figcaption
    - typings.reactMarkdown.reactMarkdownStrings.figure
    - typings.reactMarkdown.reactMarkdownStrings.footer
    - typings.reactMarkdown.reactMarkdownStrings.form
    - typings.reactMarkdown.reactMarkdownStrings.h1
    - typings.reactMarkdown.reactMarkdownStrings.h2
    - typings.reactMarkdown.reactMarkdownStrings.h3
    - typings.reactMarkdown.reactMarkdownStrings.h4
    - typings.reactMarkdown.reactMarkdownStrings.h5
    - typings.reactMarkdown.reactMarkdownStrings.h6
    - typings.reactMarkdown.reactMarkdownStrings.head
    - typings.reactMarkdown.reactMarkdownStrings.header
    - typings.reactMarkdown.reactMarkdownStrings.hgroup
    - typings.reactMarkdown.reactMarkdownStrings.hr
    - typings.reactMarkdown.reactMarkdownStrings.html
    - typings.reactMarkdown.reactMarkdownStrings.i
    - typings.reactMarkdown.reactMarkdownStrings.iframe
    - typings.reactMarkdown.reactMarkdownStrings.img
    - typings.reactMarkdown.reactMarkdownStrings.input
    - typings.reactMarkdown.reactMarkdownStrings.ins
    - typings.reactMarkdown.reactMarkdownStrings.kbd
    - typings.reactMarkdown.reactMarkdownStrings.keygen
    - typings.reactMarkdown.reactMarkdownStrings.label
    - typings.reactMarkdown.reactMarkdownStrings.legend
    - typings.reactMarkdown.reactMarkdownStrings.li
    - typings.reactMarkdown.reactMarkdownStrings.link
    - typings.reactMarkdown.reactMarkdownStrings.main
    - typings.reactMarkdown.reactMarkdownStrings.map
    - typings.reactMarkdown.reactMarkdownStrings.mark
    - typings.reactMarkdown.reactMarkdownStrings.menu
    - typings.reactMarkdown.reactMarkdownStrings.menuitem
    - typings.reactMarkdown.reactMarkdownStrings.meta
    - typings.reactMarkdown.reactMarkdownStrings.meter
    - typings.reactMarkdown.reactMarkdownStrings.nav
    - typings.reactMarkdown.reactMarkdownStrings.noindex
    - typings.reactMarkdown.reactMarkdownStrings.noscript
    - typings.reactMarkdown.reactMarkdownStrings.`object`
    - typings.reactMarkdown.reactMarkdownStrings.ol
    - typings.reactMarkdown.reactMarkdownStrings.optgroup
    - typings.reactMarkdown.reactMarkdownStrings.option
    - typings.reactMarkdown.reactMarkdownStrings.output
    - typings.reactMarkdown.reactMarkdownStrings.p
    - typings.reactMarkdown.reactMarkdownStrings.param
    - typings.reactMarkdown.reactMarkdownStrings.picture
    - typings.reactMarkdown.reactMarkdownStrings.pre
    - typings.reactMarkdown.reactMarkdownStrings.progress
    - typings.reactMarkdown.reactMarkdownStrings.q
    - typings.reactMarkdown.reactMarkdownStrings.rp
    - typings.reactMarkdown.reactMarkdownStrings.rt
    - typings.reactMarkdown.reactMarkdownStrings.ruby
    - typings.reactMarkdown.reactMarkdownStrings.s
    - typings.reactMarkdown.reactMarkdownStrings.samp
    - typings.reactMarkdown.reactMarkdownStrings.slot
    - typings.reactMarkdown.reactMarkdownStrings.script
    - typings.reactMarkdown.reactMarkdownStrings.section
    - typings.reactMarkdown.reactMarkdownStrings.select
    - typings.reactMarkdown.reactMarkdownStrings.small
    - typings.reactMarkdown.reactMarkdownStrings.source
    - typings.reactMarkdown.reactMarkdownStrings.span
    - typings.reactMarkdown.reactMarkdownStrings.strong
    - typings.reactMarkdown.reactMarkdownStrings.style
    - typings.reactMarkdown.reactMarkdownStrings.sub
    - typings.reactMarkdown.reactMarkdownStrings.summary
    - typings.reactMarkdown.reactMarkdownStrings.sup
    - typings.reactMarkdown.reactMarkdownStrings.table
    - typings.reactMarkdown.reactMarkdownStrings.template
    - typings.reactMarkdown.reactMarkdownStrings.tbody
    - typings.reactMarkdown.reactMarkdownStrings.td
    - typings.reactMarkdown.reactMarkdownStrings.textarea
    - typings.reactMarkdown.reactMarkdownStrings.tfoot
    - typings.reactMarkdown.reactMarkdownStrings.th
    - typings.reactMarkdown.reactMarkdownStrings.thead
    - typings.reactMarkdown.reactMarkdownStrings.time
    - typings.reactMarkdown.reactMarkdownStrings.title
    - typings.reactMarkdown.reactMarkdownStrings.tr
    - typings.reactMarkdown.reactMarkdownStrings.track
    - typings.reactMarkdown.reactMarkdownStrings.u
    - typings.reactMarkdown.reactMarkdownStrings.ul
    - typings.reactMarkdown.reactMarkdownStrings.`var`
    - typings.reactMarkdown.reactMarkdownStrings.video
    - typings.reactMarkdown.reactMarkdownStrings.wbr
    - typings.reactMarkdown.reactMarkdownStrings.webview
    - typings.reactMarkdown.reactMarkdownStrings.svg
    - typings.reactMarkdown.reactMarkdownStrings.animate
    - typings.reactMarkdown.reactMarkdownStrings.animateMotion
    - typings.reactMarkdown.reactMarkdownStrings.animateTransform
    - typings.reactMarkdown.reactMarkdownStrings.circle
    - typings.reactMarkdown.reactMarkdownStrings.clipPath
    - typings.reactMarkdown.reactMarkdownStrings.defs
    - typings.reactMarkdown.reactMarkdownStrings.desc
    - typings.reactMarkdown.reactMarkdownStrings.ellipse
    - typings.reactMarkdown.reactMarkdownStrings.feBlend
    - typings.reactMarkdown.reactMarkdownStrings.feColorMatrix
    - typings.reactMarkdown.reactMarkdownStrings.feComponentTransfer
    - typings.reactMarkdown.reactMarkdownStrings.feComposite
    - typings.reactMarkdown.reactMarkdownStrings.feConvolveMatrix
    - typings.reactMarkdown.reactMarkdownStrings.feDiffuseLighting
    - typings.reactMarkdown.reactMarkdownStrings.feDisplacementMap
    - typings.reactMarkdown.reactMarkdownStrings.feDistantLight
    - typings.reactMarkdown.reactMarkdownStrings.feDropShadow
    - typings.reactMarkdown.reactMarkdownStrings.feFlood
    - typings.reactMarkdown.reactMarkdownStrings.feFuncA
    - typings.reactMarkdown.reactMarkdownStrings.feFuncB
    - typings.reactMarkdown.reactMarkdownStrings.feFuncG
    - typings.reactMarkdown.reactMarkdownStrings.feFuncR
    - typings.reactMarkdown.reactMarkdownStrings.feGaussianBlur
    - typings.reactMarkdown.reactMarkdownStrings.feImage
    - typings.reactMarkdown.reactMarkdownStrings.feMerge
    - typings.reactMarkdown.reactMarkdownStrings.feMergeNode
    - typings.reactMarkdown.reactMarkdownStrings.feMorphology
    - typings.reactMarkdown.reactMarkdownStrings.feOffset
    - typings.reactMarkdown.reactMarkdownStrings.fePointLight
    - typings.reactMarkdown.reactMarkdownStrings.feSpecularLighting
    - typings.reactMarkdown.reactMarkdownStrings.feSpotLight
    - typings.reactMarkdown.reactMarkdownStrings.feTile
    - typings.reactMarkdown.reactMarkdownStrings.feTurbulence
    - typings.reactMarkdown.reactMarkdownStrings.filter
    - typings.reactMarkdown.reactMarkdownStrings.foreignObject
    - typings.reactMarkdown.reactMarkdownStrings.g
    - typings.reactMarkdown.reactMarkdownStrings.image
    - typings.reactMarkdown.reactMarkdownStrings.line
    - typings.reactMarkdown.reactMarkdownStrings.linearGradient
    - typings.reactMarkdown.reactMarkdownStrings.marker
    - typings.reactMarkdown.reactMarkdownStrings.mask
    - typings.reactMarkdown.reactMarkdownStrings.metadata
    - typings.reactMarkdown.reactMarkdownStrings.mpath
    - typings.reactMarkdown.reactMarkdownStrings.path
    - typings.reactMarkdown.reactMarkdownStrings.pattern
    - typings.reactMarkdown.reactMarkdownStrings.polygon
    - typings.reactMarkdown.reactMarkdownStrings.polyline
    - typings.reactMarkdown.reactMarkdownStrings.radialGradient
    - typings.reactMarkdown.reactMarkdownStrings.rect
    - typings.reactMarkdown.reactMarkdownStrings.stop
    - typings.reactMarkdown.reactMarkdownStrings.switch
    - typings.reactMarkdown.reactMarkdownStrings.symbol
    - typings.reactMarkdown.reactMarkdownStrings.text
    - typings.reactMarkdown.reactMarkdownStrings.textPath
    - typings.reactMarkdown.reactMarkdownStrings.tspan
    - typings.reactMarkdown.reactMarkdownStrings.use
    - typings.reactMarkdown.reactMarkdownStrings.view
  */
  trait ReactMarkdownNames extends StObject
  
  type ReactMarkdownProps = typings.reactMarkdown.complexTypesMod.ReactMarkdownProps
  ...
  trait SpecialComponents extends StObject {
    
    var code: CodeComponent | ReactMarkdownNames
    
    var h1: HeadingComponent | ReactMarkdownNames
    
    var h2: HeadingComponent | ReactMarkdownNames
    
    var h3: HeadingComponent | ReactMarkdownNames
    
    var h4: HeadingComponent | ReactMarkdownNames
    
    var h5: HeadingComponent | ReactMarkdownNames
    
    var h6: HeadingComponent | ReactMarkdownNames
    
    var li: LiComponent | ReactMarkdownNames
    
    var ol: OrderedListComponent | ReactMarkdownNames
    
    var td: TableCellComponent | ReactMarkdownNames
    
    var th: TableCellComponent | ReactMarkdownNames
    
    var tr: TableRowComponent | ReactMarkdownNames
    
    var ul: UnorderedListComponent | ReactMarkdownNames
  }
  object SpecialComponents {
    
    extension [Self <: SpecialComponents](x: Self) {
  ...
  type TableCellComponent = ComponentType[TableCellProps]
  
  type TableCellProps = ComponentPropsWithoutRef[table] & ReactMarkdownProps & IsHeader
  
  type TableRowComponent = ComponentType[TableRowProps]
  
  type TableRowProps = ComponentPropsWithoutRef[tr] & ReactMarkdownProps & IsHeaderBoolean
  
  type Text = typings.hast.mod.Text
  
  type TransformImage = js.Function3[/* src */ String, /* alt */ String, /* title */ String | Null, String]
  
  type TransformLink = js.Function3[
    /* href */ String, 
  ...
  type TransformLinkTarget = js.Function3[
    /* href */ String, 
    /* children */ js.Array[ElementContent], 
    /* title */ String | Null, 
    js.UndefOr[TransformLinkTargetType]
  ]
  
  type TransformLinkTargetType = HTMLAttributeAnchorTarget
  
  type UnorderedListComponent = ComponentType[UnorderedListProps]
  
  type UnorderedListProps = ComponentPropsWithoutRef[ul] & ReactMarkdownProps & Ordered
}
