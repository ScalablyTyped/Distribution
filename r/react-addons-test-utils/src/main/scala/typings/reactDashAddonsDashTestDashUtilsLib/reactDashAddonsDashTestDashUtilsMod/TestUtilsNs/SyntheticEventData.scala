package typings
package reactDashAddonsDashTestDashUtilsLib.reactDashAddonsDashTestDashUtilsMod.TestUtilsNs
...
object SyntheticEventData {
  ...
  def apply(
    ...
    touches: reactLib.TouchList = null,
