...
object ^ extends js.Object {
  ...
  def isCompositeComponentWithType[T /* <: reactLib.reactMod.Component[_, js.Object, _] */, C /* <: reactLib.reactMod.ComponentClass[_, reactLib.reactMod.ComponentState] */](instance: reactLib.reactMod.ReactInstance, `type`: reactLib.reactMod.ClassType[_, T, C]): T = js.native
  ...
  def renderIntoDocument[T /* <: reactLib.reactMod.Component[_, js.Object, _] */](element: reactLib.reactMod.CElement[_, T]): T = js.native
