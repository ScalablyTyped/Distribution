...
object distCommandsStrlenMod {
  
  @JSImport("@redis/json/dist/commands/STRLEN", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/json/dist/commands/STRLEN", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 1 */ Double = js.native
  
  @JSImport("@redis/json/dist/commands/STRLEN", "IS_READ_ONLY")
  @js.native
