...
object distCommandsObjlenMod {
  
  @JSImport("@redis/json/dist/commands/OBJLEN", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/json/dist/commands/OBJLEN", "FIRST_KEY_INDEX")
  @js.native
  ...
  inline def transformReply(): Double | Null | (js.Array[Double | Null]) = ^.asInstanceOf[js.Dynamic].applyDynamic("transformReply")().asInstanceOf[Double | Null | (js.Array[Double | Null])]
}
