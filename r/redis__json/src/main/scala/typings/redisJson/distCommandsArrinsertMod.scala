...
object distCommandsArrinsertMod {
  ...
  inline def transformArguments(key: String, path: String, index: Double, jsons: RedisJSON*): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("transformArguments")((scala.List(key.asInstanceOf[js.Any], path.asInstanceOf[js.Any], index.asInstanceOf[js.Any])).`++`(jsons.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[js.Array[String]]
