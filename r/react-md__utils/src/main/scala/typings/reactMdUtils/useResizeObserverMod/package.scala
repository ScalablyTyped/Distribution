...
package object useResizeObserverMod {
  ...
  type ObservedResizeEventHandler = js.Function1[
    /* event */ typings.reactMdUtils.useResizeObserverMod.ObservedResizeData, 
    scala.Unit
  ]
  type RefTarget[E /* <: typings.std.HTMLElement */] = typings.react.mod.MutableRefObject[E | scala.Null]
  type ResizeObserverTarget[E /* <: typings.std.HTMLElement */] = scala.Null | typings.std.HTMLElement | java.lang.String | typings.reactMdUtils.useResizeObserverMod.RefTarget[E] | typings.reactMdUtils.useResizeObserverMod.GetTarget[E]
}
