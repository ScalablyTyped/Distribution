...
object typesWiaAriaMovementTypesMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactMdUtils.typesWiaAriaMovementTypesMod.IncrementMovementKey
    - typings.reactMdUtils.typesWiaAriaMovementTypesMod.JumpMovementKey
  */
