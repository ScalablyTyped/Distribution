...
import typings.reactMdUtils.useResizeObserverMod.ObservedResizeData
import typings.reactMdUtils.useResizeObserverMod.ObservedResizeEventHandler
import typings.reactMdUtils.useResizeObserverMod.ResizeObserverTarget
