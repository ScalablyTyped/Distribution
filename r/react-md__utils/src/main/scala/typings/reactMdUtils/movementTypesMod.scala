...
object movementTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactMdUtils.reactMdUtilsStrings.increment
    - typings.reactMdUtils.reactMdUtilsStrings.decrement
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactMdUtils.movementTypesMod.IncrementMovementKey
    - typings.reactMdUtils.movementTypesMod.JumpMovementKey
  */
  trait MovementKey extends StObject
}
