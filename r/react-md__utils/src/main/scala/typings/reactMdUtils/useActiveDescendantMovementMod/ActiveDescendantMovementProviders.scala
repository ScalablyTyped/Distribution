...
object ActiveDescendantMovementProviders {
  @scala.inline
  def apply[/* <: typings.std.HTMLElement */ CE, /* <: typings.std.HTMLElement */ IE](
  ...
  @scala.inline
  implicit class ActiveDescendantMovementProvidersOps[Self <: ActiveDescendantMovementProviders[_, _], /* <: typings.std.HTMLElement */ CE, /* <: typings.std.HTMLElement */ IE] (val x: Self with (ActiveDescendantMovementProviders[CE, IE])) extends AnyVal {
    @scala.inline
