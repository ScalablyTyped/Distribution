...
object ActiveDescendantOptions {
  ...
  @scala.inline
  implicit class ActiveDescendantOptionsOps[Self <: ActiveDescendantOptions[_, _, _], D, CE /* <: HTMLElement */, IE /* <: HTMLElement */] (val x: Self with (ActiveDescendantOptions[D, CE, IE])) extends AnyVal {
