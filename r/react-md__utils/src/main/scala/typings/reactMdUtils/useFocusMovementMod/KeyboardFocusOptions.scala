...
object KeyboardFocusOptions {
  ...
  @scala.inline
  implicit class KeyboardFocusOptionsOps[Self <: KeyboardFocusOptions[_, _, _], D, CE /* <: HTMLElement */, IE /* <: HTMLElement */] (val x: Self with (KeyboardFocusOptions[D, CE, IE])) extends AnyVal {
