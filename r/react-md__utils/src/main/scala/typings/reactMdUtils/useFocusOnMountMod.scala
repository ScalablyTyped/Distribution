...
object useFocusOnMountMod extends js.Object {
  ...
  def default(refOrInstance: RefOrInstance, defaultFocus: Focus, preventScroll: Boolean): Unit = js.native
  def default(
    refOrInstance: RefOrInstance,
    defaultFocus: Focus,
  ...
  def default(refOrInstance: RefOrInstance, defaultFocus: Focus, preventScroll: Boolean, programatic: Boolean): Unit = js.native
  def default(
    refOrInstance: RefOrInstance,
    defaultFocus: Focus,
    preventScroll: Boolean,
