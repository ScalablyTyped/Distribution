...
object CloseOnOutsideClickOptions {
  ...
  @scala.inline
  implicit class CloseOnOutsideClickOptionsOps[Self <: CloseOnOutsideClickOptions[_], E /* <: HTMLElement */] (val x: Self with CloseOnOutsideClickOptions[E]) extends AnyVal {
