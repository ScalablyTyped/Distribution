...
object KeyboardMovementOptions {
  ...
  @scala.inline
  implicit class KeyboardMovementOptionsOps[Self <: KeyboardMovementOptions[_, _, _], D, /* <: typings.std.HTMLElement */ CE, /* <: typings.std.HTMLElement */ IE] (val x: Self with (KeyboardMovementOptions[D, CE, IE])) extends AnyVal {
    @scala.inline
