...
trait MiscUtil extends js.Object {
  /**
    ...
    */
  def contains(arr: js.Array[_], item: js.Any): Boolean
  /**
    ...
    */
  def defineProperty(el: js.Any, key: String, value: js.Any, options: js.Any): js.Any
  /**
    ...
    */
  def each(list: js.Any, fn: js.Function2[/* item */ js.Any, /* index */ Double, Unit]): Unit
  /**
  ...
  /**
    ...
    */
  def startsWith(str: String, value: String): Boolean
  /**
    * Convert a string containing dashes to camel case
    * @param str - input string
    * @returns my-string -> myString
    */
  def toCamel(str: String): String
}

object MiscUtil {
  @scala.inline
  def apply(
    contains: (js.Array[_], js.Any) => Boolean,
    defineProperty: (js.Any, String, js.Any, js.Any) => js.Any,
    each: (js.Any, js.Function2[/* item */ js.Any, /* index */ Double, Unit]) => Unit,
