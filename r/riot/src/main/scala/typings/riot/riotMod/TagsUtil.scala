...
trait TagsUtil extends js.Object {
  /**
    ...
    */
  def arrayishAdd(obj: js.Any, key: String, value: js.Any): Unit = js.native
  def arrayishAdd(obj: js.Any, key: String, value: js.Any, ensureArray: Boolean): Unit = js.native
  def arrayishAdd(obj: js.Any, key: String, value: js.Any, ensureArray: Boolean, index: Double): Unit = js.native
  /**
    ...
    * @param ensureArray - ensure that the property remains an array
    */
  def arrayishRemove(obj: js.Any, key: String, value: js.Any): Unit = js.native
  def arrayishRemove(obj: js.Any, key: String, value: js.Any, ensureArray: Boolean): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getTag(element: Element): js.Any = js.native
  /**
    ...
    */
  def getTagName(dom: Element, skipDataIs: Boolean): String = js.native
  /**
    ...
    */
  def inheritFrom(`this`: TagInstance, target: TagInstance, propsInSyncWithParent: js.Array[String]): Unit = js.native
  /**
    ...
    */
  def initChildTag(child: js.Any, opts: js.Any, innerHTML: String, parent: TagInstance): TagInstance = js.native
  /**
    * Makes a tag virtual and replaces a reference in the dom
    * @param tag - tag to make virtual
    * @param ref - dom reference location
    */
  def makeReplaceVirtual(tag: TagInstance, ref: Node): Unit = js.native
  /**
    ...
    */
  def makeVirtual(`this`: TagInstance, src: Node): Unit = js.native
  def makeVirtual(`this`: TagInstance, src: Node, target: TagInstance): Unit = js.native
  /**
    ...
    */
  def mountTo(root: Element, tagName: String): TagInstance = js.native
  def mountTo(root: Element, tagName: String, opts: TagOpts): TagInstance = js.native
  def mountTo(root: Element, tagName: String, opts: TagOpts, ctx: js.Any): TagInstance = js.native
  /**
    * Move the position of a custom tag in its parent tag
    * @param tagName - key where the tag was stored
    * @param newPos - index where the new tag will be stored
    */
  def moveChildTag(`this`: TagInstance, tagName: String, newPos: Double): Unit = js.native
  /**
    * Move virtual tag and all child nodes
    * @param src  - the node that will do the inserting
    * @param target - insert before this tag's first child
    */
  def moveVirtual(`this`: TagInstance, src: Node, target: TagInstance): Unit = js.native
  /**
    * Get selectors for tags
    * @param tags - tag names to select
    * @returns Selector
    */
  def selectTags(tags: js.Array[String]): String = js.native
  /**
    * Trigger the unmount method on all the expressions
    * @param expressions - DOM expressions
    */
  def unmountAll(expressions: js.Array[_]): Unit = js.native
}
