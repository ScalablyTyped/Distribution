...
trait CheckUtil extends js.Object {
  ...
  /**
    ...
    */
  def isBlank(value: js.Any): Boolean
  /**
    ...
    */
  def isBoolAttr(value: String): Boolean
  /**
  ...
  /**
    ...
    */
  def isReservedName(value: String): Boolean
  /**
  ...
  /**
    ...
    */
  def isWritable(obj: js.Any, key: String): Boolean
}
