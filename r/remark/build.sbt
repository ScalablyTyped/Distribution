...
name := "remark"
version := "13.0.0-8a021b"
scalaVersion := "3.0.1"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "mdast" % "3.0-dt-20190907Z-507f66",
  "org.scalablytyped" %%% "mdast-util-from-markdown" % "0.8.1-1df3a1",
  "org.scalablytyped" %%% "micromark" % "2.10.1-2305e1",
  "org.scalablytyped" %%% "node" % "14.14-dt-20201119Z-814aa8",
  "org.scalablytyped" %%% "remark-stringify" % "8.1.1-5e216a",
