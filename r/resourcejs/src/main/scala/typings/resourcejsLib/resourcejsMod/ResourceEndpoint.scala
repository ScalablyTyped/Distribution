...
trait ResourceEndpoint extends js.Object {
  ...
  def respond(req: Request, res: Response, next: expressLib.expressMod.NextFunction): scala.Unit = js.native
  def rest(): ResourceEndpoint = js.native
  def rest(options: RestOptions): ResourceEndpoint = js.native
  def setResponse(req: Request, res: Response, next: expressLib.expressMod.NextFunction): scala.Unit = js.native
