...
import typings.requestDashPromiseDashNative.Fn_Onfulfilled
import typings.requestDashPromiseDashNative.Fn_Onrejected
...
trait RequestPromise[T] extends Request {
  @JSName("catch")
  var catch_Original: Fn_Onrejected[T] = js.native
  @JSName("then")
  var then_Original: Fn_Onfulfilled[T] = js.native
