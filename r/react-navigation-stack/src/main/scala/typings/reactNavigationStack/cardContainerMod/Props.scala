...
trait Props extends js.Object {
  ...
  var scene: Scene[typings.reactNavigationStack.vendorTypesMod.Route[String]] = js.native
  /**
    * Object which specifies the animation type (timing or spring) and their options (such as duration for timing).
    */
  var transitionSpec: Close = js.native
  def getFocusedRoute(): typings.reactNavigationStack.vendorTypesMod.Route[String] = js.native
  def getPreviousScene(props: Route): js.UndefOr[Scene[typings.reactNavigationStack.vendorTypesMod.Route[String]]] = js.native
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetFocusedRoute(value: () => typings.reactNavigationStack.vendorTypesMod.Route[String]): Self = this.set("getFocusedRoute", js.Any.fromFunction0(value))
    @scala.inline
    def setGetPreviousScene(value: Route => js.UndefOr[Scene[typings.reactNavigationStack.vendorTypesMod.Route[String]]]): Self = this.set("getPreviousScene", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setScene(value: Scene[typings.reactNavigationStack.vendorTypesMod.Route[String]]): Self = this.set("scene", value.asInstanceOf[js.Any])
    @scala.inline
