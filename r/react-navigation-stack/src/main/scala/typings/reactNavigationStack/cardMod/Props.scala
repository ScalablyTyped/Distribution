...
trait Props extends js.Object {
  ...
  var onTransition: js.UndefOr[js.Function1[/* props */ Gesture, Unit]] = js.native
  
  def overlay(props: StyleWithAnimatedValue): ReactNode = js.native
...
object Props {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOverlay(value: StyleWithAnimatedValue => ReactNode): Self = this.set("overlay", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnTransition(value: /* props */ Gesture => Unit): Self = this.set("onTransition", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnTransition: Self = this.set("onTransition", js.undefined)
