...
object headerBackgroundMod {
  ...
  @JSImport("react-navigation-stack/lib/typescript/src/vendor/views/Header/HeaderBackground", JSImport.Default)
  @js.native
  def default(hasStyleRest: Props): Element = js.native
  ...
  trait Props extends StObject {
    ...
    var style: js.UndefOr[StyleProp[ViewStyle]] with js.UndefOr[WithAnimatedValue[StyleProp[ViewStyle]]] = js.native
  ...
  object Props {
    ...
    @scala.inline
    def apply(style: js.UndefOr[StyleProp[ViewStyle]] with js.UndefOr[WithAnimatedValue[StyleProp[ViewStyle]]]): Props = {
    ...
    implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStyle(value: js.UndefOr[StyleProp[ViewStyle]] with js.UndefOr[WithAnimatedValue[StyleProp[ViewStyle]]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
