...
@js.native
trait ViewPropsenabledbooleanla extends StObject {
  ...
  var ref: js.UndefOr[Ref[View]] = js.native
...
object ViewPropsenabledbooleanla {
  
  @scala.inline
  def apply(enabled: Boolean, layout: Width): ViewPropsenabledbooleanla = {
    val __obj = js.Dynamic.literal(enabled = enabled.asInstanceOf[js.Any], layout = layout.asInstanceOf[js.Any])
    __obj.asInstanceOf[ViewPropsenabledbooleanla]
  }
  
  @scala.inline
  implicit class ViewPropsenabledbooleanlaMutableBuilder[Self <: ViewPropsenabledbooleanla] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: Ref[View]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ View | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
