...
object ViewPropsenabledbooleanla {
  ...
  inline def apply(enabled: Boolean, layout: Width): ViewPropsenabledbooleanla = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ViewPropsenabledbooleanla] (val x: Self) extends AnyVal {
