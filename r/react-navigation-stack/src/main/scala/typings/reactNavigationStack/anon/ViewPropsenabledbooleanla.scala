...
@js.native
trait ViewPropsenabledbooleanla extends js.Object {
...
object ViewPropsenabledbooleanla {
  ...
  @scala.inline
  implicit class ViewPropsenabledbooleanlaOps[Self <: ViewPropsenabledbooleanla] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefFunction1(value: /* instance */ View | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: Ref[View]): Self = this.set("ref", value.asInstanceOf[js.Any])
