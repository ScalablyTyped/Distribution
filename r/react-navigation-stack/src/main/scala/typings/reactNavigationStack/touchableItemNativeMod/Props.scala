...
/* Inlined react-native.react-native.ViewProps & {  pressColor  :string,   disabled ? :boolean,   borderless ? :boolean,   delayPressIn ? :number, onPress ? (): void,   children  :react.react.ReactNode} */
