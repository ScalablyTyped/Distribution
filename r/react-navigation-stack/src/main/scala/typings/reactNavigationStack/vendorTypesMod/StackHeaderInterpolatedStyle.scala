...
trait StackHeaderInterpolatedStyle extends StObject {
  ...
  /**
    ...
    */
  var leftButtonStyle: js.UndefOr[Any] = js.undefined
  
  /**
    * Interpolated style for the label of the left button (back button label).
    */
  var leftLabelStyle: js.UndefOr[Any] = js.undefined
  
  /**
    * Interpolated style for the right button.
    */
  var rightButtonStyle: js.UndefOr[Any] = js.undefined
...
object StackHeaderInterpolatedStyle {
  ...
  extension [Self <: StackHeaderInterpolatedStyle](x: Self) {
    ...
    inline def setLeftButtonStyle(value: Any): Self = StObject.set(x, "leftButtonStyle", value.asInstanceOf[js.Any])
    
    inline def setLeftButtonStyleUndefined: Self = StObject.set(x, "leftButtonStyle", js.undefined)
    
    inline def setLeftLabelStyle(value: Any): Self = StObject.set(x, "leftLabelStyle", value.asInstanceOf[js.Any])
    
    inline def setLeftLabelStyleUndefined: Self = StObject.set(x, "leftLabelStyle", js.undefined)
    
    inline def setRightButtonStyle(value: Any): Self = StObject.set(x, "rightButtonStyle", value.asInstanceOf[js.Any])
