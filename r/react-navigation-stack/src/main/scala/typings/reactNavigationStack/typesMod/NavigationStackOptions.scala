...
import typings.reactNavigationStack.TextPropschildrenstring
import typings.reactNavigationStack.reactNavigationStackStrings.inverted
...
trait NavigationStackOptions extends js.Object {
  ...
  var headerBackImage: js.UndefOr[js.Function1[/* props */ AnonTintColor, ReactNode]] = js.undefined
...
object NavigationStackOptions {
  ...
  def apply(
    ...
    headerBackImage: /* props */ AnonTintColor => ReactNode = null,
