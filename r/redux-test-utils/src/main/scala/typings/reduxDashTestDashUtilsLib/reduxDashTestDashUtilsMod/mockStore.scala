...
- reduxDashTestDashUtilsLib.reduxDashTestDashUtilsMod.mockDispatch because var conflicts: dispatch_Original. Inlined dispatch, getActions, getAction, isActionTypeDispatched, isActionDispatched */ @js.native
trait mockStore[S]
