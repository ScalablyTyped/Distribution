...
object JSONTreeProps {
  ...
  def apply(
    ...
    valueRenderer: (/* displayValue */ java.lang.String | scala.Double, /* rawValue */ js.UndefOr[java.lang.String | scala.Double | scala.Boolean | scala.Null], /* repeated */ java.lang.String | scala.Double) => reactLib.reactMod.Global.JSXNs.Element = null
  ): JSONTreeProps = {
