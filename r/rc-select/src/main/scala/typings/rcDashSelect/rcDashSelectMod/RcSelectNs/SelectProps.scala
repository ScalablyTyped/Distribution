...
trait SelectProps extends js.Object {
  ...
  var onDeselect: js.UndefOr[
    js.Function2[
      /* value */ String, 
      /* option */ typings.rcDashSelect.rcDashSelectMod.RcSelectNs.Option, 
      Unit
    ]
  ] = js.undefined
  ...
  var onSelect: js.UndefOr[
    js.Function2[
      /* value */ String, 
      /* ontion */ typings.rcDashSelect.rcDashSelectMod.RcSelectNs.Option, 
      Unit
    ]
  ] = js.undefined
...
object SelectProps {
  ...
  def apply(
    ...
    onDeselect: (/* value */ String, /* option */ typings.rcDashSelect.rcDashSelectMod.RcSelectNs.Option) => Unit = null,
    onFocus: () => Unit = null,
    onInputKeyDown: /* e */ Event => Unit = null,
    onPopupScroll: () => Unit = null,
    onSearch: () => Unit = null,
    onSelect: (/* value */ String, /* ontion */ typings.rcDashSelect.rcDashSelectMod.RcSelectNs.Option) => Unit = null,
