...
import typings.rcSelect.selectMod.OnActiveValue
import typings.rcSelect.selectMod.OnInternalSelect
...
object selectContextMod extends Shortcut {
  ...
  object SelectContextProps {
    ...
    inline def apply(
      ...
      onActiveValue: (/* active */ typings.rcSelect.selectMod.RawValueType, /* index */ Double, /* info */ js.UndefOr[`0`]) => Unit,
      onSelect: (/* value */ typings.rcSelect.selectMod.RawValueType, /* info */ Selected) => Unit,
    ...
    extension [Self <: SelectContextProps](x: Self) {
      ...
      inline def setOnActiveValue(
        value: (/* active */ typings.rcSelect.selectMod.RawValueType, /* index */ Double, /* info */ js.UndefOr[`0`]) => Unit
      ): Self = StObject.set(x, "onActiveValue", js.Any.fromFunction3(value))
      
      inline def setOnSelect(value: (/* value */ typings.rcSelect.selectMod.RawValueType, /* info */ Selected) => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction2(value))
  ...
  /* This means you don't have to write `default`, but can instead just say `selectContextMod.foo` */
