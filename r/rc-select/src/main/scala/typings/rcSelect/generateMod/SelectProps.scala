...
object SelectProps {
  @scala.inline
  def apply[/* <: js.Array[js.Object] */ OptionsType, ValueType](): SelectProps[OptionsType, ValueType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SelectProps[OptionsType, ValueType]]
  }
  @scala.inline
  implicit class SelectPropsOps[Self <: SelectProps[_, _], /* <: js.Array[js.Object] */ OptionsType, ValueType] (val x: Self with (SelectProps[OptionsType, ValueType])) extends AnyVal {
    @scala.inline
