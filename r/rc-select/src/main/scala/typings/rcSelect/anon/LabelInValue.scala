...
object LabelInValue {
  @scala.inline
  def apply[/* <: typings.rcSelect.generatorMod.FlattenOptionsType[js.Array[js.Object]] */ FOT](labelInValue: Boolean, optionLabelProp: String, options: FOT, prevValue: DefaultValueType): LabelInValue[FOT] = {
  ...
  @scala.inline
  implicit class LabelInValueOps[Self <: LabelInValue[_], /* <: typings.rcSelect.generatorMod.FlattenOptionsType[js.Array[js.Object]] */ FOT] (val x: Self with LabelInValue[FOT]) extends AnyVal {
    @scala.inline
