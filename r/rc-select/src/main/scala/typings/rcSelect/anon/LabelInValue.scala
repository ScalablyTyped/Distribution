...
object LabelInValue {
  ...
  inline def apply[FOT /* <: FlattenOptionsType[js.Array[js.Object]] */](labelInValue: Boolean, optionLabelProp: String, options: FOT, prevValue: DefaultValueType): LabelInValue[FOT] = {
  ...
  extension [Self <: LabelInValue[?], FOT /* <: FlattenOptionsType[js.Array[js.Object]] */](x: Self & LabelInValue[FOT]) {
