...
object Mark {
  @scala.inline
  def apply[/* <: js.Array[js.Object] */ OptionsType](): Mark[OptionsType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Mark[OptionsType]]
  }
  @scala.inline
  implicit class MarkOps[Self <: Mark[_], /* <: js.Array[js.Object] */ OptionsType] (val x: Self with Mark[OptionsType]) extends AnyVal {
    @scala.inline
