...
object rcDashSelectLibComponents {
  ...
  @scala.inline
  def OptionProps: rcDashSelectLib.rcDashSelectMod.RcSelectNs.OptionProps.type = rcDashSelectLib.rcDashSelectMod.RcSelectNs.OptionProps
  type OptionProps = rcDashSelectLib.rcDashSelectMod.RcSelectNs.OptionProps
  @scala.inline
  def SelectProps: rcDashSelectLib.rcDashSelectMod.RcSelectNs.SelectProps.type = rcDashSelectLib.rcDashSelectMod.RcSelectNs.SelectProps
  type SelectProps = rcDashSelectLib.rcDashSelectMod.RcSelectNs.SelectProps
}
