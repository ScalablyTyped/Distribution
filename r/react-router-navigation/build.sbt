...
version := "1.0-dt-20190212Z-0f1bff"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-navigation" % "3.0-dt-20190507Z-f9f329",
  "org.scalablytyped" %%% "react-router" % "5.0-dt-20190702Z-99459e",
  "org.scalablytyped" %%% "react-router-navigation-core" % "1.0-dt-20181017Z-0e2bde",
