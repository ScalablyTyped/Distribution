...
version := "1.0-dt-20181018Z-ad1ecd"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "react-navigation" % "2.13-dt-20181130Z-882f39",
  "com.scalablytyped" %%% "react-router" % "4.4-dt-20181109Z-169b9f",
  "com.scalablytyped" %%% "react-router-navigation-core" % "1.0-dt-20181018Z-002ed7",
