...
version := "1.0-dt-20190212Z-f1d653"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-navigation" % "3.0-dt-20190507Z-2a192b",
  "org.scalablytyped" %%% "react-router" % "5.0-dt-20190520Z-dbea1f",
  "org.scalablytyped" %%% "react-router-navigation-core" % "1.0-dt-20181017Z-570b5e",
