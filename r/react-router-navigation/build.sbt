...
version := "1.0-dt-20190212Z-a1f00d"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-navigation" % "3.0-dt-20190215Z-f818db",
  "org.scalablytyped" %%% "react-router" % "4.4-dt-20190212Z-f52bb1",
  "org.scalablytyped" %%% "react-router-navigation-core" % "1.0-dt-20181017Z-f581d7",
