...
version := "1.0-dt-20190212Z-03ab76"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-navigation" % "3.0-dt-20190805Z-7504f8",
  "org.scalablytyped" %%% "react-router" % "5.0-dt-20190918Z-0deff5",
  "org.scalablytyped" %%% "react-router-navigation-core" % "1.0-dt-20181017Z-c298ec",
