...
version := "1.0-dt-20181018Z-e21c86"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "react-navigation" % "2.13-dt-20181120Z-85b95a",
  "com.scalablytyped" %%% "react-router" % "4.4-dt-20181109Z-ab18e0",
  "com.scalablytyped" %%% "react-router-navigation-core" % "1.0-dt-20181018Z-30dc33",
