...
version := "1.0-dt-20181017Z-ebcef6"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-navigation" % "3.0-dt-20181219Z-d87e7d",
  "org.scalablytyped" %%% "react-router" % "4.4-dt-20190103Z-3b9cc8",
  "org.scalablytyped" %%% "react-router-navigation-core" % "1.0-dt-20181017Z-d48cdb",
