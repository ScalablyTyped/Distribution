...
object reactDashRouterDashNavigationLibComponents {
  ...
  type CardSubViewProps = reactDashRouterDashNavigationLib.reactDashRouterDashNavigationMod.CardSubViewProps
  @scala.inline
  def NavigationComponentProps: reactDashRouterDashNavigationLib.reactDashRouterDashNavigationMod.NavigationComponentProps.type = reactDashRouterDashNavigationLib.reactDashRouterDashNavigationMod.NavigationComponentProps
  type NavigationComponentProps = reactDashRouterDashNavigationLib.reactDashRouterDashNavigationMod.NavigationComponentProps
  @scala.inline
  def TabBarComponentProps: reactDashRouterDashNavigationLib.reactDashRouterDashNavigationMod.TabBarComponentProps.type = reactDashRouterDashNavigationLib.reactDashRouterDashNavigationMod.TabBarComponentProps
  type TabBarComponentProps = reactDashRouterDashNavigationLib.reactDashRouterDashNavigationMod.TabBarComponentProps
}
