...
class BottomNavigation ()
  ...
  def renderScene(sceneProps: TabSubViewProps): reactLib.reactMod.ReactNs.ReactElement = js.native
...
object BottomNavigation extends js.Object {
  var defaultProps: reactDashRouterDashNavigationLib.Anon_Lazy = js.native
}
