...
object SpringConfigWithOrigamiTensionAndFriction {
  ...
  extension [Self <: SpringConfigWithOrigamiTensionAndFriction](x: Self) {
    ...
    inline def setFrictionVarargs(value: (Double | AnimatedNode[Double] | (js.Array[Double | AnimatedNode[Double]]))*): Self = StObject.set(x, "friction", js.Array(value :_*))
    ...
    inline def setTensionVarargs(value: (Double | AnimatedNode[Double] | (js.Array[Double | AnimatedNode[Double]]))*): Self = StObject.set(x, "tension", js.Array(value :_*))
