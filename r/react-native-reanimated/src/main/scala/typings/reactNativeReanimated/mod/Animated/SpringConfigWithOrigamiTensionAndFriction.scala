...
object SpringConfigWithOrigamiTensionAndFriction {
  ...
  @scala.inline
  implicit class SpringConfigWithOrigamiTensionAndFrictionMutableBuilder[Self <: SpringConfigWithOrigamiTensionAndFriction] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFriction(value: Adaptable[Double]): Self = StObject.set(x, "friction", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFrictionVarargs(value: (Double | AnimatedNode[Double] | (js.Array[Double | AnimatedNode[Double]]))*): Self = StObject.set(x, "friction", js.Array(value :_*))
    ...
    @scala.inline
    def setTension(value: Adaptable[Double]): Self = StObject.set(x, "tension", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTensionVarargs(value: (Double | AnimatedNode[Double] | (js.Array[Double | AnimatedNode[Double]]))*): Self = StObject.set(x, "tension", js.Array(value :_*))
