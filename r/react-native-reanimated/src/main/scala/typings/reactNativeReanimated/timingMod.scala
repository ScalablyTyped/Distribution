...
import typings.reactNativeReanimated.easingMod.EasingFactoryFn
...
object timingMod {
  ...
  object InnerTimingAnimation {
    ...
    inline def apply(
      ...
      onStart: (/* nextAnimation */ TimingAnimation, /* current */ AnimatableValue | Double, /* timestamp */ Timestamp, /* previousAnimation */ TimingAnimation) => Unit,
      progress: Double,
      startTime: Timestamp,
    ...
    extension [Self <: InnerTimingAnimation](x: Self) {
      ...
      inline def setOnStart(
        value: (/* nextAnimation */ TimingAnimation, /* current */ AnimatableValue | Double, /* timestamp */ Timestamp, /* previousAnimation */ TimingAnimation) => Unit
