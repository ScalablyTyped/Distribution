...
object libTypesReanimated2JsReanimatedMapperRegistryMod {
  ...
  trait MapperRegistry[T] extends StObject {
    ...
    var mappers: Map[
        Double, 
        typings.reactNativeReanimated.libTypesReanimated2JsReanimatedMapperMod.default[T]
      ] = js.native
    ...
    def startMapper(mapper: typings.reactNativeReanimated.libTypesReanimated2JsReanimatedMapperMod.default[T]): Double = js.native
