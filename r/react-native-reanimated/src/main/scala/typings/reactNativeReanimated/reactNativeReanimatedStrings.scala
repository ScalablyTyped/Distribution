...
object reactNativeReanimatedStrings {
  ...
  @scala.inline
  def AdaptTransforms: AdaptTransforms = "AdaptTransforms".asInstanceOf[AdaptTransforms]
  
  @js.native
  sealed trait AnimateProps extends StObject
  @scala.inline
  def AnimateProps: AnimateProps = "AnimateProps".asInstanceOf[AnimateProps]
  
  @js.native
  sealed trait AnimateStyle extends StObject
  @scala.inline
  def AnimateStyle: AnimateStyle = "AnimateStyle".asInstanceOf[AnimateStyle]
  
  @js.native
  sealed trait EventMapping extends StObject
  @scala.inline
  def EventMapping: EventMapping = "EventMapping".asInstanceOf[EventMapping]
  
  @js.native
  sealed trait EventMappingArray extends StObject
  @scala.inline
  def EventMappingArray: EventMappingArray = "EventMappingArray".asInstanceOf[EventMappingArray]
  ...
  @js.native
  sealed trait `slide-bottom` extends StObject
  @scala.inline
  def `slide-bottom`: `slide-bottom` = "slide-bottom".asInstanceOf[`slide-bottom`]
  
  @js.native
  sealed trait `slide-left` extends StObject
  @scala.inline
  def `slide-left`: `slide-left` = "slide-left".asInstanceOf[`slide-left`]
  
  @js.native
  sealed trait `slide-right` extends StObject
  @scala.inline
  def `slide-right`: `slide-right` = "slide-right".asInstanceOf[`slide-right`]
  
  @js.native
  sealed trait `slide-top` extends StObject
  @scala.inline
  def `slide-top`: `slide-top` = "slide-top".asInstanceOf[`slide-top`]
