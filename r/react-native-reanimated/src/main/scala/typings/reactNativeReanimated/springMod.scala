...
object springMod {
  ...
  object InnerSpringAnimation {
    ...
    inline def apply(
      ...
      onStart: (/* nextAnimation */ SpringAnimation, /* current */ AnimatableValue | Double, /* timestamp */ Timestamp, /* previousAnimation */ SpringAnimation) => Unit,
      toValue: Double,
      velocity: Double
    ...
    extension [Self <: InnerSpringAnimation](x: Self) {
      ...
      inline def setOnStart(
        value: (/* nextAnimation */ SpringAnimation, /* current */ AnimatableValue | Double, /* timestamp */ Timestamp, /* previousAnimation */ SpringAnimation) => Unit
