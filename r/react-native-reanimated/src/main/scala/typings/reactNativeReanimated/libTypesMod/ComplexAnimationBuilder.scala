...
@JSImport("react-native-reanimated/lib/types", "ComplexAnimationBuilder")
@js.native
open class ComplexAnimationBuilder ()
  extends typings.reactNativeReanimated.libTypesReanimated2Mod.ComplexAnimationBuilder
/* static members */
