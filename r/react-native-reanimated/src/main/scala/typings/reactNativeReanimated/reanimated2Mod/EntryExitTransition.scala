...
@JSImport("react-native-reanimated/lib/types/reanimated2", "EntryExitTransition")
@js.native
open class EntryExitTransition ()
  extends typings.reactNativeReanimated.layoutReanimationMod.EntryExitTransition
/* static members */
object EntryExitTransition {
  ...
  inline def entering(animation: typings.reactNativeReanimated.animationBuilderMod.BaseAnimationBuilder): typings.reactNativeReanimated.entryExitTransitionMod.EntryExitTransition = ^.asInstanceOf[js.Dynamic].applyDynamic("entering")(animation.asInstanceOf[js.Any]).asInstanceOf[typings.reactNativeReanimated.entryExitTransitionMod.EntryExitTransition]
  ...
  inline def exiting(animation: typings.reactNativeReanimated.animationBuilderMod.BaseAnimationBuilder): typings.reactNativeReanimated.entryExitTransitionMod.EntryExitTransition = ^.asInstanceOf[js.Dynamic].applyDynamic("exiting")(animation.asInstanceOf[js.Any]).asInstanceOf[typings.reactNativeReanimated.entryExitTransitionMod.EntryExitTransition]
