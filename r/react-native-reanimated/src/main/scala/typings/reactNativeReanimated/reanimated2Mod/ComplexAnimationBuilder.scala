...
@JSImport("react-native-reanimated/lib/types/reanimated2", "ComplexAnimationBuilder")
@js.native
open class ComplexAnimationBuilder ()
  extends typings.reactNativeReanimated.layoutReanimationMod.ComplexAnimationBuilder
/* static members */
