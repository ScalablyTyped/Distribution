...
object repeatMod {
  ...
  trait InnerRepeatAnimation extends StObject {
    ...
    var onStart: js.Function4[
        ...
        /* current */ AnimatableValue | Double, 
        /* timestamp */ Timestamp, 
  ...
  object InnerRepeatAnimation {
    ...
    inline def apply(
      ...
      onStart: (/* nextAnimation */ RepeatAnimation, /* current */ AnimatableValue | Double, /* timestamp */ Timestamp, /* previousAnimation */ RepeatAnimation) => Unit,
      reps: Double,
      startValue: Double,
      toValue: Double
    ...
    extension [Self <: InnerRepeatAnimation](x: Self) {
      ...
      inline def setOnStart(
        value: (/* nextAnimation */ RepeatAnimation, /* current */ AnimatableValue | Double, /* timestamp */ Timestamp, /* previousAnimation */ RepeatAnimation) => Unit
