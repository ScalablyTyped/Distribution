...
@JSImport("react-native-reanimated/lib/types/index.web", "KeyboardState")
@js.native
object KeyboardState extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[
    typings.reactNativeReanimated.libTypesReanimated2CommonTypesMod.KeyboardState & Double
  ] = js.native
