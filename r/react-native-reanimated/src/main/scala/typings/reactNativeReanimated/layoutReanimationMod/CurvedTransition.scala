...
@JSImport("react-native-reanimated/lib/types/reanimated2/layoutReanimation", "CurvedTransition")
@js.native
open class CurvedTransition ()
  extends typings.reactNativeReanimated.defaultTransitionsMod.CurvedTransition
/* static members */
