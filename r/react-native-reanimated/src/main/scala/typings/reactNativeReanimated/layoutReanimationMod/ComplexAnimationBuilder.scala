...
@JSImport("react-native-reanimated/lib/types/reanimated2/layoutReanimation", "ComplexAnimationBuilder")
@js.native
open class ComplexAnimationBuilder ()
  extends typings.reactNativeReanimated.animationBuilderMod.ComplexAnimationBuilder
/* static members */
