...
@JSImport("react-native-reanimated/lib/types/reanimated2/layoutReanimation", "BaseAnimationBuilder")
@js.native
open class BaseAnimationBuilder ()
  extends typings.reactNativeReanimated.animationBuilderMod.BaseAnimationBuilder
/* static members */
