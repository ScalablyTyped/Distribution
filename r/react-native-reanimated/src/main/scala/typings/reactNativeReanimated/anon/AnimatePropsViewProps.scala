...
/* Inlined react-native-reanimated.react-native-reanimated.Animated.AnimateProps<react-native.react-native.ViewProps> */
trait AnimatePropsViewProps extends StObject {
  ...
  var animatedProps: js.UndefOr[PartialAnimatePropsViewPr] = js.undefined
...
object AnimatePropsViewProps {
  
  inline def apply(): AnimatePropsViewProps = {
  ...
  implicit open class MutableBuilder[Self <: AnimatePropsViewProps] (val x: Self) extends AnyVal {
    ...
    inline def setAnimatedProps(value: PartialAnimatePropsViewPr): Self = StObject.set(x, "animatedProps", value.asInstanceOf[js.Any])
