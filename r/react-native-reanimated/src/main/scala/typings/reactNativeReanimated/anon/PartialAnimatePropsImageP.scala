...
/* Inlined std.Partial<react-native-reanimated.react-native-reanimated.Animated.AnimateProps<react-native.react-native.ImageProps>> */
trait PartialAnimatePropsImageP extends StObject {
  ...
  var animatedProps: js.UndefOr[Partial[AnimateProps[ImageProps]]] = js.undefined
...
object PartialAnimatePropsImageP {
  
  inline def apply(): PartialAnimatePropsImageP = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAnimatePropsImageP]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAnimatePropsImageP] (val x: Self) extends AnyVal {
    ...
    inline def setAnimatedProps(value: Partial[AnimateProps[ImageProps]]): Self = StObject.set(x, "animatedProps", value.asInstanceOf[js.Any])
