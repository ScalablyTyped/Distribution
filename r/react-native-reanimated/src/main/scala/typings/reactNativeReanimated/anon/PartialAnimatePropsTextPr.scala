...
/* Inlined std.Partial<react-native-reanimated.react-native-reanimated.Animated.AnimateProps<react-native.react-native.TextProps>> */
trait PartialAnimatePropsTextPr extends StObject {
  ...
  var animatedProps: js.UndefOr[Partial[AnimateProps[TextProps]]] = js.undefined
...
object PartialAnimatePropsTextPr {
  
  inline def apply(): PartialAnimatePropsTextPr = {
  ...
  implicit open class MutableBuilder[Self <: PartialAnimatePropsTextPr] (val x: Self) extends AnyVal {
    ...
    inline def setAnimatedProps(value: Partial[AnimateProps[TextProps]]): Self = StObject.set(x, "animatedProps", value.asInstanceOf[js.Any])
