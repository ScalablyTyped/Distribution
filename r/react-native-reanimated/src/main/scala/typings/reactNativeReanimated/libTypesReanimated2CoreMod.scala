...
object libTypesReanimated2CoreMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - js.Function0[typings.reactNativeReanimated.libTypesReanimated2CommonTypesMod.AnimationObject]
    - typings.reactNativeReanimated.libTypesReanimated2CommonTypesMod.AnimationObject
    - typings.reactNativeReanimated.libTypesReanimated2CommonTypesMod.AnimatableValue
    - typings.reactNativeReanimated.libTypesReanimated2HookCommonTypesMod.Descriptor
  */
  ...
  object _WorkletValue {
    ...
    inline def AnimationObject(
      ...
      __obj.asInstanceOf[typings.reactNativeReanimated.libTypesReanimated2CommonTypesMod.AnimationObject]
    }
    
    inline def Descriptor(name: String, tag: Double): typings.reactNativeReanimated.libTypesReanimated2HookCommonTypesMod.Descriptor = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], tag = tag.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.reactNativeReanimated.libTypesReanimated2HookCommonTypesMod.Descriptor]
    }
  }
}
