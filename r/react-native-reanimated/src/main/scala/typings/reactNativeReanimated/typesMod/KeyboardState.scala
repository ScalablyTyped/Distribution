...
@JSImport("react-native-reanimated/lib/types", "KeyboardState")
@js.native
object KeyboardState extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.reactNativeReanimated.reanimated2CommonTypesMod.KeyboardState & Double] = js.native
