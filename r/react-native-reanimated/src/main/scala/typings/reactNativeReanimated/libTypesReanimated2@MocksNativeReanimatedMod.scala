...
object `libTypesReanimated2@MocksNativeReanimatedMod` {
  ...
  object default {
    ...
    inline def makeMutable(init: Any): typings.reactNativeReanimated.`libTypesReanimated2@MocksMutableValueMod`.default = ^.asInstanceOf[js.Dynamic].applyDynamic("makeMutable")(init.asInstanceOf[js.Any]).asInstanceOf[typings.reactNativeReanimated.`libTypesReanimated2@MocksMutableValueMod`.default]
