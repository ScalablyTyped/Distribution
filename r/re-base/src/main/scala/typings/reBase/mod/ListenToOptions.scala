...
object ListenToOptions {
  ...
  inline def apply(context: js.Object, `then`: Any => Unit): ListenToOptions = {
  ...
  extension [Self <: ListenToOptions](x: Self) {
    ...
    inline def setOnFailure(value: /* error */ Any => Unit): Self = StObject.set(x, "onFailure", js.Any.fromFunction1(value))
    ...
    inline def setThen(value: Any => Unit): Self = StObject.set(x, "then", js.Any.fromFunction1(value))
  }
}
