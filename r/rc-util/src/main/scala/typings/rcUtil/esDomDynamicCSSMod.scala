...
object esDomDynamicCSSMod {
  ...
  inline def clearContainerCache(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("clearContainerCache")().asInstanceOf[Unit]
  ...
  */
  ...
  trait Options extends StObject {
    ...
    var attachTo: js.UndefOr[ContainerType] = js.undefined
  ...
  object Options {
    ...
    implicit open class MutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      inline def setAttachTo(value: ContainerType): Self = StObject.set(x, "attachTo", value.asInstanceOf[js.Any])
