...
object anon {
  ...
  @js.native
  trait DocumentFragmentMARKRootu extends StObject {
  ...
  @js.native
  trait ElementMARKRootundefined extends StObject {
    ...
    def getElementsByTagNameNS(namespaceURI: "http://www.w3.org/1999/xhtml", localName: String): HTMLCollectionOf[HTMLElement] = js.native
    /* standard dom */
    @JSName("getElementsByTagNameNS")
    @scala.annotation.targetName("getElementsByTagNameNS_httpwwww3org2000svg")
    def getElementsByTagNameNS(namespaceURI: "http://www.w3.org/2000/svg", localName: String): HTMLCollectionOf[SVGElement] = js.native
    /* standard dom */
