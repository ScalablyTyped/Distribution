package typings.rollupDashPluginDashSizeDashSnapshot.rollupDashPluginDashSizeDashSnapshotMod
...
object PluginSizeSnapshotOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(matchSnapshot)) __obj.updateDynamic("matchSnapshot")(matchSnapshot)
    if (!js.isUndefined(printInfo)) __obj.updateDynamic("printInfo")(printInfo)
    if (snapshotPath != null) __obj.updateDynamic("snapshotPath")(snapshotPath)
