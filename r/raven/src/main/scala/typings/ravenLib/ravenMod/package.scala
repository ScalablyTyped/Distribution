...
package object ravenMod {
  ...
  type DataCallback = js.Function1[/* data */ ScalablyTyped.runtime.StringDictionary[js.Any], js.Any]
  ...
  type ShouldSendCallback = js.Function1[/* data */ ScalablyTyped.runtime.StringDictionary[js.Any], scala.Boolean]
