...
object FeatureFlags {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(ENABLE_CONNECTION_RESOLVERS = ENABLE_CONNECTION_RESOLVERS, ENABLE_PARTIAL_RENDERING_DEFAULT = ENABLE_PARTIAL_RENDERING_DEFAULT, ENABLE_VARIABLE_CONNECTION_KEY = ENABLE_VARIABLE_CONNECTION_KEY, USE_RECORD_SOURCE_MAP_IMPL = USE_RECORD_SOURCE_MAP_IMPL)
