...
trait RecordProxy extends js.Object {
  ...
  def setLinkedRecords(records: js.Array[RecordProxy], name: String): RecordProxy = js.native
  def setLinkedRecords(records: js.Array[RecordProxy], name: String, args: Variables): RecordProxy = js.native
