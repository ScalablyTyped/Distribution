...
trait ReadOnlyRecordProxy extends js.Object {
  ...
  def getLinkedRecord(name: String): RecordProxy = js.native
  def getLinkedRecord(name: String, args: Variables): RecordProxy = js.native
  def getLinkedRecords(name: String): js.Array[RecordProxy] = js.native
  def getLinkedRecords(name: String, args: Variables): js.Array[RecordProxy] = js.native
