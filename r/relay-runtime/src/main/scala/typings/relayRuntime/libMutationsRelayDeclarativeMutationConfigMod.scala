...
object libMutationsRelayDeclarativeMutationConfigMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.relayRuntime.libMutationsRelayDeclarativeMutationConfigMod.RangeAddConfig
    - typings.relayRuntime.libMutationsRelayDeclarativeMutationConfigMod.RangeDeleteConfig
    - typings.relayRuntime.libMutationsRelayDeclarativeMutationConfigMod.NodeDeleteConfig
  */
  trait DeclarativeMutationConfig extends StObject
  object DeclarativeMutationConfig {
    
    inline def NodeDeleteConfig(deletedIDFieldName: String): typings.relayRuntime.libMutationsRelayDeclarativeMutationConfigMod.NodeDeleteConfig = {
      ...
      __obj.asInstanceOf[typings.relayRuntime.libMutationsRelayDeclarativeMutationConfigMod.NodeDeleteConfig]
    }
    
    inline def RangeAddConfig(edgeName: String): typings.relayRuntime.libMutationsRelayDeclarativeMutationConfigMod.RangeAddConfig = {
      val __obj = js.Dynamic.literal(edgeName = edgeName.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("RANGE_ADD")
      __obj.asInstanceOf[typings.relayRuntime.libMutationsRelayDeclarativeMutationConfigMod.RangeAddConfig]
    }
    
    inline def RangeDeleteConfig(deletedIDFieldName: String | js.Array[String], pathToConnection: js.Array[String]): typings.relayRuntime.libMutationsRelayDeclarativeMutationConfigMod.RangeDeleteConfig = {
      ...
      __obj.asInstanceOf[typings.relayRuntime.libMutationsRelayDeclarativeMutationConfigMod.RangeDeleteConfig]
    }
  }
