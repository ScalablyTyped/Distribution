...
object GraphQLSubscriptionConfig {
  ...
  @scala.inline
  implicit class GraphQLSubscriptionConfigOps[Self <: GraphQLSubscriptionConfig[_], /* <: typings.relayRuntime.relayRuntimeTypesMod.OperationType */ TSubscription] (val x: Self with GraphQLSubscriptionConfig[TSubscription]) extends AnyVal {
    @scala.inline
