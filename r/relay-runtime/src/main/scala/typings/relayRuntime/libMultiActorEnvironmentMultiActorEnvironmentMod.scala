...
import typings.relayRuntime.libMultiActorEnvironmentMultiActorEnvironmentTypesMod.ActorEnvironment
import typings.relayRuntime.libMultiActorEnvironmentMultiActorEnvironmentTypesMod.MultiActorStoreUpdater
...
object libMultiActorEnvironmentMultiActorEnvironmentMod {
  ...
  open class MultiActorEnvironment protected ()
    extends StObject
       with typings.relayRuntime.libMultiActorEnvironmentMultiActorEnvironmentTypesMod.MultiActorEnvironment {
