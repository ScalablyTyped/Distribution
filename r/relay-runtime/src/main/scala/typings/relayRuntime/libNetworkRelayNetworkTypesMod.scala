...
object libNetworkRelayNetworkTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithData
    - typings.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithExtensionsOnly
    - typings.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithoutData
  */
  trait GraphQLSingularResponse extends StObject
  object GraphQLSingularResponse {
    
    inline def GraphQLResponseWithData(data: PayloadData): typings.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithData = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithData]
    }
    
    inline def GraphQLResponseWithExtensionsOnly(data: Null, extensions: PayloadExtensions): typings.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithExtensionsOnly = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], extensions = extensions.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithExtensionsOnly]
    }
    
    inline def GraphQLResponseWithoutData(errors: js.Array[PayloadError]): typings.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithoutData = {
      val __obj = js.Dynamic.literal(errors = errors.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.relayRuntime.libNetworkRelayNetworkTypesMod.GraphQLResponseWithoutData]
    }
  }
