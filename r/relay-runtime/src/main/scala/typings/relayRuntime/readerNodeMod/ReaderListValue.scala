...
object ReaderListValue {
  ...
  inline def apply(items: js.Array[ReaderArgument | Null], kind: String, name: String): ReaderListValue = {
  ...
  extension [Self <: ReaderListValue](x: Self) {
    
    inline def setItems(value: js.Array[ReaderArgument | Null]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsVarargs(value: (ReaderArgument | Null)*): Self = StObject.set(x, "items", js.Array(value :_*))
