...
object ReaderArgument {
  ...
  @scala.inline
  def ReaderListValue(items: js.Array[ReaderArgument | Null], kind: String, name: String): typings.relayRuntime.readerNodeMod.ReaderListValue = {
  ...
  @scala.inline
  def ReaderLiteral(kind: String, name: String, value: js.Any): typings.relayRuntime.readerNodeMod.ReaderLiteral = {
  ...
  @scala.inline
  def ReaderObjectValue(fields: js.Array[ReaderArgument], kind: String, name: String): typings.relayRuntime.readerNodeMod.ReaderObjectValue = {
  ...
  @scala.inline
  def ReaderVariable(kind: String, name: String, variableName: String): typings.relayRuntime.readerNodeMod.ReaderVariable = {
