...
trait RecordProxy extends js.Object {
  ...
  def setLinkedRecords(records: js.Array[js.UndefOr[RecordProxy | scala.Null]], name: java.lang.String): RecordProxy = js.native
  def setLinkedRecords(records: js.Array[js.UndefOr[RecordProxy | scala.Null]], name: java.lang.String, args: Variables): RecordProxy = js.native
