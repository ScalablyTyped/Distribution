...
trait OptimisticUpdate extends js.Object {
  var fieldPayloads: js.UndefOr[js.Array[HandleFieldPayload] | scala.Null] = js.undefined
  var operation: js.UndefOr[OperationDescriptor] = js.undefined
  var response: js.UndefOr[js.Object | scala.Null] = js.undefined
  var selectorStoreUpdater: js.UndefOr[SelectorStoreUpdater[_] | scala.Null] = js.undefined
