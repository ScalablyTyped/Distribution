...
object CropperProps {
  ...
  implicit class CropperPropsOps[Self <: CropperProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnCropAreaChange(value: (/* croppedArea */ Area, /* croppedAreaPixels */ Area) => Unit): Self = this.set("onCropAreaChange", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteOnCropAreaChange: Self = this.set("onCropAreaChange", js.undefined)
    ...
    @scala.inline
    def setOnCropSizeChange(value: /* cropSize */ Size => Unit): Self = this.set("onCropSizeChange", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnCropSizeChange: Self = this.set("onCropSizeChange", js.undefined)
