...
object valueUtilMod {
  ...
  inline def addValue(rawValues: js.Array[RawValueType], value: RawValueType): js.Array[String | Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("addValue")(rawValues.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[js.Array[String | Double]]
  ...
  inline def findValueOption(values: js.Array[RawValueType], options: js.Array[FlattenDataNode]): js.Array[DataNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("findValueOption")(values.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[DataNode]]
  
  inline def flattenOptions(options: js.Array[DataNode]): js.Array[FlattenDataNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("flattenOptions")(options.asInstanceOf[js.Any]).asInstanceOf[js.Array[FlattenDataNode]]
  
  inline def getRawValueLabeled(
  ...
  inline def isValueDisabled(value: RawValueType, options: js.Array[FlattenDataNode]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isValueDisabled")(value.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def removeValue(rawValues: js.Array[RawValueType], value: RawValueType): js.Array[String | Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("removeValue")(rawValues.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[js.Array[String | Double]]
