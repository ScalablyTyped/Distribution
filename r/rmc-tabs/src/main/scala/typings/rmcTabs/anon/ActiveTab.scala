...
object ActiveTab {
  ...
  @scala.inline
  implicit class ActiveTabOps[Self <: ActiveTab[_, _], /* <: typings.rmcTabs.tabsBaseMod.StateType */ S, /* <: typings.rmcTabs.propsTypeMod.PropsType */ P] (val x: Self with (ActiveTab[S, P])) extends AnyVal {
    @scala.inline
