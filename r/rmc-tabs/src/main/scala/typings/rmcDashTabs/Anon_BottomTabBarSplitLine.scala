...
trait Anon_BottomTabBarSplitLine extends js.Object {
  var bottomTabBarSplitLine: ViewStyle
  var container: ViewStyle
  var topTabBarSplitLine: ViewStyle
}

object Anon_BottomTabBarSplitLine {
  @scala.inline
  def apply(bottomTabBarSplitLine: ViewStyle, container: ViewStyle, topTabBarSplitLine: ViewStyle): Anon_BottomTabBarSplitLine = {
    ...
    __obj.asInstanceOf[Anon_BottomTabBarSplitLine]
  }
}
