...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "lodash_dot_assign" % "4.2-dt-20190214Z-8941f9",
  "org.scalablytyped" %%% "node" % "11.11-dt-20190325Z-000e7b",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190226Z-1549d2",
  "org.scalablytyped" %%% "query-string" % "6.4.0-c81114",
  ...
  "org.scalablytyped" %%% "url-pattern" % "1.0.3-6e8dc4")
