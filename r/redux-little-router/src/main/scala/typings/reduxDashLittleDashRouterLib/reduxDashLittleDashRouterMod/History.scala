...
trait History extends js.Object {
  var action: reduxDashLittleDashRouterLib.HistoryAction = js.native
  var length: scala.Double = js.native
  var location: Location = js.native
  def block(callback: reduxDashLittleDashRouterLib.BlockCallback): reduxDashLittleDashRouterLib.Unsubscribe = js.native
  ...
  def listen(callback: reduxDashLittleDashRouterLib.ListenCallback): reduxDashLittleDashRouterLib.Unsubscribe = js.native
