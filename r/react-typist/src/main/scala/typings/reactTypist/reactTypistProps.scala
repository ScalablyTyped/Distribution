...
trait reactTypistProps {
  ...
  type DelayProps = typings.reactTypist.mod.Typist.DelayProps
  @scala.inline
  def ReactTypistProps: typings.reactTypist.mod.TypistProps.type = typings.reactTypist.mod.TypistProps
  type ReactTypistProps = typings.reactTypist.mod.TypistProps
  @scala.inline
  ...
  type TypistDelayProps = typings.reactTypist.mod.Typist.DelayProps
}
