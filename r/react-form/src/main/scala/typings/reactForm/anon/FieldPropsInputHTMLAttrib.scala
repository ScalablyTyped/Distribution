...
import typings.reactForm.reactFormStrings.`additions removals`
import typings.reactForm.reactFormStrings.`additions text`
import typings.reactForm.reactFormStrings.`inline`
import typings.reactForm.reactFormStrings.`removals additions`
import typings.reactForm.reactFormStrings.`removals text`
import typings.reactForm.reactFormStrings.`text additions`
import typings.reactForm.reactFormStrings.`text removals`
...
import typings.reactForm.reactFormStrings.done
import typings.reactForm.reactFormStrings.email
import typings.reactForm.reactFormStrings.enter
import typings.reactForm.reactFormStrings.execute
import typings.reactForm.reactFormStrings.go
...
import typings.reactForm.reactFormStrings.next
...
@js.native
trait FieldPropsInputHTMLAttrib extends js.Object {
...
object FieldPropsInputHTMLAttrib {
  ...
  @scala.inline
  def apply(group: FieldApi): FieldPropsInputHTMLAttrib = {
    val __obj = js.Dynamic.literal(group = group.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldPropsInputHTMLAttrib]
  }
  
  @scala.inline
  implicit class FieldPropsInputHTMLAttribOps[Self <: FieldPropsInputHTMLAttrib] (val x: Self) extends AnyVal {
