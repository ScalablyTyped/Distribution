...
object anon {
  ...
  object FormApi {
    ...
    implicit class FormApiMutableBuilder[Self <: FormApi] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFormApi(value: typings.reactForm.mod.FormApi): Self = StObject.set(x, "formApi", value.asInstanceOf[js.Any])
    }
  }
  ...
  object FormPropschildrenpropsFor {
    ...
    implicit class FormPropschildrenpropsForMutableBuilder[Self <: FormPropschildrenpropsFor] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetApi(value: /* formApi */ typings.reactForm.mod.FormApi => Unit): Self = StObject.set(x, "getApi", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnSubmitFailure(value: (/* errors */ FormErrors, /* formApi */ typings.reactForm.mod.FormApi) => Unit): Self = StObject.set(x, "onSubmitFailure", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setPreSubmit(value: (/* values */ FormValues, /* formApi */ typings.reactForm.mod.FormApi) => FormValues): Self = StObject.set(x, "preSubmit", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setRender(value: /* formApi */ typings.reactForm.mod.FormApi => RenderReturn): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
