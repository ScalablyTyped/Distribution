...
@js.native
class Form ()
  extends reactLib.reactMod.Component[FormProps with reactDashFormLib.Anon_ChildrenProps, js.Object, js.Any]
...
object Form extends js.Object {
  var childContextTypes: reactDashFormLib.Anon_FormApiValidator = js.native
