...
object modulesComponentsLinkMod {
  ...
  trait ReactScrollLinkProps extends StObject {
    ...
    var spyThrottle: js.UndefOr[Double] = js.undefined
  ...
  object ReactScrollLinkProps {
    ...
    implicit open class MutableBuilder[Self <: ReactScrollLinkProps] (val x: Self) extends AnyVal {
      ...
      inline def setSpyThrottle(value: Double): Self = StObject.set(x, "spyThrottle", value.asInstanceOf[js.Any])
      
      inline def setSpyThrottleUndefined: Self = StObject.set(x, "spyThrottle", js.undefined)
