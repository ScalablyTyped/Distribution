...
object linkMod {
  ...
  - typings.react.mod.HTMLProps because var conflicts: onClick. Inlined  */ trait LinkProps
    extends StObject
  ...
  trait ReactScrollLinkProps extends StObject {
    ...
    var duration: js.UndefOr[Double | String | (js.Function1[/* distance */ Double, Double])] = js.undefined
  ...
  object ReactScrollLinkProps {
    ...
    inline def apply(to: String): ReactScrollLinkProps = {
      val __obj = js.Dynamic.literal(to = to.asInstanceOf[js.Any])
    ...
    extension [Self <: ReactScrollLinkProps](x: Self) {
      ...
      inline def setDuration(value: Double | String | (js.Function1[/* distance */ Double, Double])): Self = StObject.set(x, "duration", value.asInstanceOf[js.Any])
      ...
      inline def setIgnoreCancelEventsUndefined: Self = StObject.set(x, "ignoreCancelEvents", js.undefined)
      
      inline def setIsDynamic(value: Boolean): Self = StObject.set(x, "isDynamic", value.asInstanceOf[js.Any])
      
      inline def setIsDynamicUndefined: Self = StObject.set(x, "isDynamic", js.undefined)
      ...
      inline def setSaveHashHistory(value: Boolean): Self = StObject.set(x, "saveHashHistory", value.asInstanceOf[js.Any])
      
      inline def setSaveHashHistoryUndefined: Self = StObject.set(x, "saveHashHistory", js.undefined)
      
      inline def setSmooth(value: Boolean | String): Self = StObject.set(x, "smooth", value.asInstanceOf[js.Any])
      
      inline def setSmoothUndefined: Self = StObject.set(x, "smooth", js.undefined)
      
      inline def setSpy(value: Boolean): Self = StObject.set(x, "spy", value.asInstanceOf[js.Any])
