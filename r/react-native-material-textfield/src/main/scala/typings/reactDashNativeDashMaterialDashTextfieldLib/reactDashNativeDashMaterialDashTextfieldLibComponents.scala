...
object reactDashNativeDashMaterialDashTextfieldLibComponents {
  @scala.inline
  def TextField: reactLib.reactMod.ComponentType[
    reactDashNativeDashMaterialDashTextfieldLib.reactDashNativeDashMaterialDashTextfieldMod.TextFieldProps
  ] = js.constructorOf[reactDashNativeDashMaterialDashTextfieldLib.reactDashNativeDashMaterialDashTextfieldMod.TextField].asInstanceOf[reactLib.reactMod.ComponentType[
  reactDashNativeDashMaterialDashTextfieldLib.reactDashNativeDashMaterialDashTextfieldMod.TextFieldProps]]
  @scala.inline
