...
object DrawerNavigationState {
  ...
  implicit class DrawerNavigationStateOps[Self <: DrawerNavigationState[_], ParamList /* <: ParamListBase */] (val x: Self with DrawerNavigationState[ParamList]) extends AnyVal {
    ...
    @scala.inline
    def setHistoryVarargs(value: (KeyType | `0`)*): Self = this.set("history", js.Array(value :_*))
    
    @scala.inline
    def setHistory(value: js.Array[KeyType | `0`]): Self = this.set("history", value.asInstanceOf[js.Any])
