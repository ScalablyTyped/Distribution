...
import typings.rdfjsTypes.anon.QueryBindings
import typings.rdfjsTypes.anon.QueryBoolean
import typings.rdfjsTypes.anon.QueryQuads
import typings.rdfjsTypes.anon.QueryVoid
import typings.rdfjsTypes.anon.`0`
import typings.rdfjsTypes.anon.`1`
import typings.rdfjsTypes.anon.`2`
import typings.rdfjsTypes.anon.`3`
import typings.rdfjsTypes.commonMod.Query
...
object queryableMod {
  ...
  type AlgebraSparqlQueryable[AlgebraType, SupportedResultType, QueryAlgebraContextType /* <: QueryAlgebraContext */] = Any & (Any | (`0`[AlgebraType, QueryAlgebraContextType])) & (Any | (`1`[AlgebraType, QueryAlgebraContextType])) & (Any | (`2`[AlgebraType, QueryAlgebraContextType])) & (Any | (`3`[AlgebraType, QueryAlgebraContextType]))
  ...
  type StringSparqlQueryable[SupportedResultType, QueryStringContextType /* <: QueryStringContext */] = Any & (Any | QueryBindings[QueryStringContextType]) & (Any | QueryBoolean[QueryStringContextType]) & (Any | QueryQuads[QueryStringContextType]) & (Any | QueryVoid[QueryStringContextType])
