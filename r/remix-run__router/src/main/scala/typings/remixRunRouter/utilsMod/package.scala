...
import typings.remixRunRouter.utilsMod.^
...
type ParamParseKey[Segment /* <: String */] = PathParam[Segment] | String

type Params[Key /* <: String */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
{readonly [ key in Key ]: string | undefined}
  */ typings.remixRunRouter.remixRunRouterStrings.Params & TopLevel[Any]
...
/**
  ...
  * "/:a/b/:c/ *" -> "a" | "c" | "*"
  */
type PathParam[Path /* <: String */] = (_PathParam[
(/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Rest */ Any) | Path]) | Asterisk
...
type _PathParam[Path /* <: String */] = Any
