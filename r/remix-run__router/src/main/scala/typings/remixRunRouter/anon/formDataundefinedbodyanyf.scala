...
/* Inlined {  formData :undefined,   body :any} & {  formMethod :@remix-run/router.@remix-run/router/dist/utils.HTMLFormMethod | undefined,   formEncType :@remix-run/router.@remix-run/router/dist/utils.FormEncType | undefined} */
trait formDataundefinedbodyanyf
  extends StObject
...
object formDataundefinedbodyanyf {
  
  inline def apply(body: Any, formData: Unit): formDataundefinedbodyanyf = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], formData = formData.asInstanceOf[js.Any])
    __obj.asInstanceOf[formDataundefinedbodyanyf]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: formDataundefinedbodyanyf] (val x: Self) extends AnyVal {
