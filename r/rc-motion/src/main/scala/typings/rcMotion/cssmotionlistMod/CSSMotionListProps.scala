...
object CSSMotionListProps {
  ...
  implicit class CSSMotionListPropsOps[Self <: CSSMotionListProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponent(value: String | ComponentType[js.Object] | `false`): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnVisibleChanged(value: (/* visible */ Boolean, /* info */ typings.rcMotion.anon.Key) => Unit): Self = this.set("onVisibleChanged", js.Any.fromFunction2(value))
