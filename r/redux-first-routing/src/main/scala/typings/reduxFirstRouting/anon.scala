...
object anon {
  ...
  object Hash {
    ...
    inline def apply[P /* <: typings.history.mod.Pathname */, S /* <: Search */, H /* <: typings.history.mod.Hash */](hash: H, pathname: P, search: S): Hash[P, S, H] = {
  ...
  object Pathname {
    ...
    inline def apply[P /* <: typings.history.mod.Pathname */, S /* <: Search */, H /* <: typings.history.mod.Hash */](hash: H, pathname: P, queries: Any, search: S): Pathname[P, S, H] = {
