...
object Pathname {
  ...
  @scala.inline
  implicit class PathnameOps[Self <: Pathname[_, _, _], /* <: typings.history.mod.Pathname */ P, /* <: typings.history.mod.Search */ S, /* <: typings.history.mod.Hash */ H] (val x: Self with (Pathname[P, S, H])) extends AnyVal {
    @scala.inline
