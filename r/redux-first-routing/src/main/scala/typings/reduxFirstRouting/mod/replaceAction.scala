...
object replaceAction {
  ...
  @scala.inline
  implicit class replaceActionOps[Self <: replaceAction[_], /* <: typings.history.mod.Path | typings.history.mod.LocationDescriptorObject[typings.history.mod.LocationState] */ T] (val x: Self with replaceAction[T]) extends AnyVal {
    @scala.inline
