...
trait AnonHashPathname[P /* <: Pathname */, S /* <: Search */, H /* <: Hash */] extends js.Object {
  var hash: H
  var pathname: P
  var search: S
}

object AnonHashPathname {
  @scala.inline
  def apply[P /* <: Pathname */, S /* <: Search */, H /* <: Hash */](hash: H, pathname: P, search: S): AnonHashPathname[P, S, H] = {
    ...
    __obj.asInstanceOf[AnonHashPathname[P, S, H]]
  }
}
