...
import typings.reactDashWindow.Anon_Align
import typings.reactDashWindow.Anon_ColumnIndexRowIndex
import typings.reactDashWindow.Anon_ScrollLeft
...
class VariableSizeGrid ()
  ...
  /**
    ...
    */
  def resetAfterIndices(params: Anon_ColumnIndexRowIndex): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def scrollTo(params: Anon_ScrollLeft): Unit = js.native
  /**
    ...
    */
  def scrollToItem(params: Anon_Align): Unit = js.native
}
