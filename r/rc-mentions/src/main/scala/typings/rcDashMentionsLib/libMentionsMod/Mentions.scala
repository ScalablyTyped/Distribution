...
trait Mentions
  ...
  def getOptions(): js.Array[rcDashMentionsLib.libOptionMod.OptionProps] = js.native
  def getOptions(measureText: java.lang.String): js.Array[rcDashMentionsLib.libOptionMod.OptionProps] = js.native
  ...
  def selectOption(option: rcDashMentionsLib.libOptionMod.OptionProps): scala.Unit = js.native
