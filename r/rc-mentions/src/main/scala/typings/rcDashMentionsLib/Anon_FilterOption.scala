...
object Anon_FilterOption {
  @scala.inline
  def apply(
    filterOption: (/* input */ java.lang.String, /* hasValue */ rcDashMentionsLib.esOptionMod.OptionProps) => scala.Boolean,
    notFoundContent: java.lang.String,
    prefix: java.lang.String,
    prefixCls: java.lang.String,
    rows: scala.Double,
    split: java.lang.String,
    validateSearch: (/* text */ java.lang.String, /* props */ rcDashMentionsLib.esMentionsMod.MentionsProps) => scala.Boolean
  ): Anon_FilterOption = {
