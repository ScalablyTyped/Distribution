...
import typings.rcDashMentions.esMod.default
...
object Es
  ...
  override val component: String | js.Object = js.constructorOf[typings.rcDashMentions.esMod.default].asInstanceOf[String | js.Object]
  def apply(
