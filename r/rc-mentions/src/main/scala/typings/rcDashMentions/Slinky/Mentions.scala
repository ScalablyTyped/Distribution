...
import typings.rcDashMentions.esMentionsMod.default
...
object Mentions
  ...
  override val component: String | js.Object = js.constructorOf[typings.rcDashMentions.esMentionsMod.default].asInstanceOf[String | js.Object]
  def apply(
