...
@js.native
trait Anon_CollectionCollections extends js.Object {
  val CollectionNs: Anon_Collection = js.native
  val ListNs: Anon_IsList = js.native
  val MapNs: Anon_IsMap = js.native
  val OrderedMapNs: Anon_IsOrderedMap = js.native
  val OrderedSetNs: Anon_FromKeysIsOrderedSet = js.native
  val RecordNs: Anon_Factory = js.native
  val SeqNs: Anon_CollectionIndexed = js.native
  val SetNs: Anon_FromKeys = js.native
  val StackNs: Anon_IsStack = js.native
