...
@js.native
trait PopoverChildrenRenderProps extends js.Object {
...
object PopoverChildrenRenderProps {
  ...
  @scala.inline
  implicit class PopoverChildrenRenderPropsOps[Self <: PopoverChildrenRenderProps] (val x: Self) extends AnyVal {
    @scala.inline
