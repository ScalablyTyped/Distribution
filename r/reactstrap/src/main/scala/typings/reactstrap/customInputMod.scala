...
import typings.reactstrap.reactstrapStrings.done
import typings.reactstrap.reactstrapStrings.email
import typings.reactstrap.reactstrapStrings.enter
import typings.reactstrap.reactstrapStrings.execute
import typings.reactstrap.reactstrapStrings.go
...
object customInputMod {
  ...
  type CustomInput = Component[CustomInputProps, js.Object, js.Any]
  ...
  object CustomInputProps {
    ...
    inline def apply(id: String | Double, `type`: CustomInputType): CustomInputProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[CustomInputProps]
    }
    
    extension [Self <: CustomInputProps](x: Self) {
      ...
      inline def setType(value: CustomInputType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
