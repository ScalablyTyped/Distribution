...
object typesLibAccordionMod {
  ...
  /* Inlined parent std.Omit<reactstrap.reactstrap/types/lib/Accordion.AccordionProps, 'open'> */
  trait UncontrolledAccordionProps extends StObject {
  ...
  object UncontrolledAccordionProps {
    ...
    inline def apply(): UncontrolledAccordionProps = {
