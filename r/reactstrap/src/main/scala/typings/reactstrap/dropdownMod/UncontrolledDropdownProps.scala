...
object UncontrolledDropdownProps {
  ...
  def apply(
    ...
    onToggle: (/* event */ KeyboardEvent[Element] | (MouseEvent[Element, NativeMouseEvent]), /* isOpen */ Boolean) => Unit = null,
    ...
    if (!js.isUndefined(inNavbar)) __obj.updateDynamic("inNavbar")(inNavbar.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(setActiveFromChild)) __obj.updateDynamic("setActiveFromChild")(setActiveFromChild.get.asInstanceOf[js.Any])
