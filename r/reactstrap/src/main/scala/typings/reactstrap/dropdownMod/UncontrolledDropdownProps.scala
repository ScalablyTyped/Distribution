...
object UncontrolledDropdownProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(inNavbar)) __obj.updateDynamic("inNavbar")(inNavbar.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(setActiveFromChild)) __obj.updateDynamic("setActiveFromChild")(setActiveFromChild.asInstanceOf[js.Any])
