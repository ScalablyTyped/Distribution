...
object InputProps {
  ...
  def apply(
    ...
    id: String = null,
    inlist: js.Any = null,
    innerRef: js.UndefOr[Null | Ref[HTMLInputElement]] = js.undefined,
    ...
    if (!js.isUndefined(addon)) __obj.updateDynamic("addon")(addon.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(plaintext)) __obj.updateDynamic("plaintext")(plaintext.get.asInstanceOf[js.Any])
