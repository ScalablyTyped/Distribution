...
object rowMod {
  ...
  @JSImport("reactstrap/types/lib/Row", JSImport.Default)
  @js.native
  open class default ()
  ...
  /* Inlined parent reactstrap.reactstrap/types/lib/Row.Omit<react.react.HTMLAttributes<std.HTMLElement>, 'form'> */
  trait RowProps
    extends StObject
    ...
    var xxl: js.UndefOr[Double | String] = js.undefined
  }
  object RowProps {
    ...
    extension [Self <: RowProps](x: Self) {
      ...
      inline def setLg(value: Double | String): Self = StObject.set(x, "lg", value.asInstanceOf[js.Any])
      
      inline def setLgUndefined: Self = StObject.set(x, "lg", js.undefined)
      
      inline def setMd(value: Double | String): Self = StObject.set(x, "md", value.asInstanceOf[js.Any])
      
      inline def setMdUndefined: Self = StObject.set(x, "md", js.undefined)
      
      inline def setNoGutters(value: Boolean): Self = StObject.set(x, "noGutters", value.asInstanceOf[js.Any])
      
      inline def setNoGuttersUndefined: Self = StObject.set(x, "noGutters", js.undefined)
      ...
      inline def setSm(value: Double | String): Self = StObject.set(x, "sm", value.asInstanceOf[js.Any])
      ...
      inline def setXl(value: Double | String): Self = StObject.set(x, "xl", value.asInstanceOf[js.Any])
      
      inline def setXlUndefined: Self = StObject.set(x, "xl", js.undefined)
      
      inline def setXs(value: Double | String): Self = StObject.set(x, "xs", value.asInstanceOf[js.Any])
      
      inline def setXsUndefined: Self = StObject.set(x, "xs", js.undefined)
      
      inline def setXxl(value: Double | String): Self = StObject.set(x, "xxl", value.asInstanceOf[js.Any])
