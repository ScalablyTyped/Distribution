...
object ModalProps {
  ...
  def apply(
    ...
    if (modalClassName != null) __obj.updateDynamic("modalClassName")(modalClassName.asInstanceOf[js.Any])
    if (modalTransition != null) __obj.updateDynamic("modalTransition")(modalTransition.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(returnFocusAfterClose)) __obj.updateDynamic("returnFocusAfterClose")(returnFocusAfterClose.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(unmountOnClose)) __obj.updateDynamic("unmountOnClose")(unmountOnClose.asInstanceOf[js.Any])
