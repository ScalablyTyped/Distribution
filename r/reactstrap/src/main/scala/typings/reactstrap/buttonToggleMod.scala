...
object buttonToggleMod {
  ...
  type ButtonToggle = Component[ButtonToggleProps, js.Object, js.Any]
  ...
  object ButtonToggleProps {
    ...
    @scala.inline
    implicit class ButtonTogglePropsMutableBuilder[Self <: ButtonToggleProps] (val x: Self) extends AnyVal {
