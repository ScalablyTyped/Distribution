...
object mod {
  ...
  object CalendarProps {
    ...
    implicit class CalendarPropsMutableBuilder[Self <: CalendarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDateFunction1(value: /* now */ Date => AnyDate): Self = StObject.set(x, "date", js.Any.fromFunction1(value))
    }
  }
  ...
  object CommonCalendarProps {
    ...
    implicit class CommonCalendarPropsMutableBuilder[Self <: CommonCalendarProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMaxDateFunction1(value: /* now */ Date => AnyDate): Self = StObject.set(x, "maxDate", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setMinDateFunction1(value: /* now */ Date => AnyDate): Self = StObject.set(x, "minDate", js.Any.fromFunction1(value))
  ...
  */
  ...
  object DateRangeIndex {
    ...
    @scala.inline
    def `Last 30 Days`: typings.reactDateRange.reactDateRangeStrings.`Last 30 Days` = ("Last 30 Days").asInstanceOf[typings.reactDateRange.reactDateRangeStrings.`Last 30 Days`]
    
    @scala.inline
    def `Last 7 Days`: typings.reactDateRange.reactDateRangeStrings.`Last 7 Days` = ("Last 7 Days").asInstanceOf[typings.reactDateRange.reactDateRangeStrings.`Last 7 Days`]
    
    @scala.inline
    def Today: typings.reactDateRange.reactDateRangeStrings.Today = "Today".asInstanceOf[typings.reactDateRange.reactDateRangeStrings.Today]
  ...
  object DateRangeObject {
    ...
    implicit class DateRangeObjectMutableBuilder[Self <: DateRangeObject] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEndDate(value: Date => Date): Self = StObject.set(x, "endDate", js.Any.fromFunction1(value))
      
      @scala.inline
      def setStartDate(value: Date => Date): Self = StObject.set(x, "startDate", js.Any.fromFunction1(value))
    }
  }
  ...
  object DateRangeProps {
    ...
    implicit class DateRangePropsMutableBuilder[Self <: DateRangeProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setShownDate(value: Date): Self = StObject.set(x, "shownDate", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object _OnChangeProps {
    ...
    @scala.inline
    def Range(): typings.reactDateRange.mod.Range = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.reactDateRange.mod.Range]
    }
    
    @scala.inline
    def Selection(selection: Range): typings.reactDateRange.anon.Selection = {
