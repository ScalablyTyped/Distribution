...
object typesLinearProgressMod {
  
  @JSImport("@react-md/progress/types/LinearProgress", "LinearProgress")
  @js.native
  val LinearProgress: ForwardRefExoticComponent[LinearProgressProps & RefAttributes[HTMLSpanElement]] = js.native
  
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLDivElement>, 'id'> */
  ...
  object LinearProgressProps {
    ...
    inline def apply(id: String): LinearProgressProps = {
