...
object mod {
  ...
  object default {
    ...
    object defaultProps {
      ...
      inline def focusOnUpDown_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("focusOnUpDown")(x.asInstanceOf[js.Any])
      ...
      inline def onKeyDown_=(x: js.Function0[Unit]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onKeyDown")(x.asInstanceOf[js.Any])
      
      @JSImport("rc-input-number", "default.defaultProps.onPressEnter")
      @js.native
      def onPressEnter: js.Function0[Unit] = js.native
      inline def onPressEnter_=(x: js.Function0[Unit]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onPressEnter")(x.asInstanceOf[js.Any])
      
      inline def parser(input: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("parser")(input.asInstanceOf[js.Any]).asInstanceOf[String]
      ...
      inline def useTouch_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("useTouch")(x.asInstanceOf[js.Any])
    }
  }
}
