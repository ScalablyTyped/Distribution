...
/* Rewritten from type alias, can be one of: 
  - typings.reactQuery.typesCoreTypesMod.MutationObserverIdleResult[TData, TError, TVariables, TContext]
  - typings.reactQuery.typesCoreTypesMod.MutationObserverLoadingResult[TData, TError, TVariables, TContext]
  - typings.reactQuery.typesCoreTypesMod.MutationObserverErrorResult[TData, TError, TVariables, TContext]
  - typings.reactQuery.typesCoreTypesMod.MutationObserverSuccessResult[TData, TError, TVariables, TContext]
*/
...
object MutationObserverResult {
  ...
  inline def MutationObserverErrorResult[TData, TError, TVariables, TContext](
    ...
    __obj.asInstanceOf[typings.reactQuery.typesCoreTypesMod.MutationObserverErrorResult[TData, TError, TVariables, TContext]]
  }
  ...
  inline def MutationObserverIdleResult[TData, TError, TVariables, TContext](
    ...
    __obj.asInstanceOf[typings.reactQuery.typesCoreTypesMod.MutationObserverIdleResult[TData, TError, TVariables, TContext]]
  }
  ...
  inline def MutationObserverLoadingResult[TData, TError, TVariables, TContext](
    ...
    __obj.asInstanceOf[typings.reactQuery.typesCoreTypesMod.MutationObserverLoadingResult[TData, TError, TVariables, TContext]]
  }
  ...
  inline def MutationObserverSuccessResult[TData, TError, TVariables, TContext](
    ...
    __obj.asInstanceOf[typings.reactQuery.typesCoreTypesMod.MutationObserverSuccessResult[TData, TError, TVariables, TContext]]
  }
}
