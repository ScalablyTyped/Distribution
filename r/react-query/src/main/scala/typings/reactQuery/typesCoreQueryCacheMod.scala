...
object typesCoreQueryCacheMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactQuery.typesCoreQueryCacheMod.NotifyEventQueryAdded
    - typings.reactQuery.typesCoreQueryCacheMod.NotifyEventQueryRemoved
    - typings.reactQuery.typesCoreQueryCacheMod.NotifyEventQueryUpdated
    - typings.reactQuery.typesCoreQueryCacheMod.NotifyEventObserverAdded
    - typings.reactQuery.typesCoreQueryCacheMod.NotifyEventObserverRemoved
    - typings.reactQuery.typesCoreQueryCacheMod.NotifyEventObserverResultsUpdated
  */
  trait QueryCacheNotifyEvent extends StObject
  object QueryCacheNotifyEvent {
    
    inline def NotifyEventObserverAdded(observer: QueryObserver[Any, Any, Any, Any, Any], query: Query[Any, Any, Any, Any]): typings.reactQuery.typesCoreQueryCacheMod.NotifyEventObserverAdded = {
      val __obj = js.Dynamic.literal(observer = observer.asInstanceOf[js.Any], query = query.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("observerAdded")
      __obj.asInstanceOf[typings.reactQuery.typesCoreQueryCacheMod.NotifyEventObserverAdded]
    }
    
    inline def NotifyEventObserverRemoved(observer: QueryObserver[Any, Any, Any, Any, Any], query: Query[Any, Any, Any, Any]): typings.reactQuery.typesCoreQueryCacheMod.NotifyEventObserverRemoved = {
      val __obj = js.Dynamic.literal(observer = observer.asInstanceOf[js.Any], query = query.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("observerRemoved")
      __obj.asInstanceOf[typings.reactQuery.typesCoreQueryCacheMod.NotifyEventObserverRemoved]
    }
    
    inline def NotifyEventObserverResultsUpdated(query: Query[Any, Any, Any, Any]): typings.reactQuery.typesCoreQueryCacheMod.NotifyEventObserverResultsUpdated = {
      val __obj = js.Dynamic.literal(query = query.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("observerResultsUpdated")
      __obj.asInstanceOf[typings.reactQuery.typesCoreQueryCacheMod.NotifyEventObserverResultsUpdated]
    }
    
    inline def NotifyEventQueryAdded(query: Query[Any, Any, Any, Any]): typings.reactQuery.typesCoreQueryCacheMod.NotifyEventQueryAdded = {
      val __obj = js.Dynamic.literal(query = query.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("queryAdded")
      __obj.asInstanceOf[typings.reactQuery.typesCoreQueryCacheMod.NotifyEventQueryAdded]
    }
    
    inline def NotifyEventQueryRemoved(query: Query[Any, Any, Any, Any]): typings.reactQuery.typesCoreQueryCacheMod.NotifyEventQueryRemoved = {
      val __obj = js.Dynamic.literal(query = query.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("queryRemoved")
      __obj.asInstanceOf[typings.reactQuery.typesCoreQueryCacheMod.NotifyEventQueryRemoved]
    }
    
    inline def NotifyEventQueryUpdated(action: Action[Any, Any], query: Query[Any, Any, Any, Any]): typings.reactQuery.typesCoreQueryCacheMod.NotifyEventQueryUpdated = {
      val __obj = js.Dynamic.literal(action = action.asInstanceOf[js.Any], query = query.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("queryUpdated")
      __obj.asInstanceOf[typings.reactQuery.typesCoreQueryCacheMod.NotifyEventQueryUpdated]
    }
  }
}
