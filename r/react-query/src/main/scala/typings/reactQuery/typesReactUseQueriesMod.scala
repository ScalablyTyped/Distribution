...
object typesReactUseQueriesMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type QueriesOptions[T /* <: js.Array[Any] */, Result /* <: js.Array[Any] */, Depth /* <: js.Array[Double] */] = js.Array[UseQueryOptions[Any, Any, Any, QueryKey]]
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type QueriesResults[T /* <: js.Array[Any] */, Result /* <: js.Array[Any] */, Depth /* <: js.Array[Double] */] = js.Array[UseQueryResult[Any, Any]]
}
