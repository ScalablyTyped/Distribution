...
import typings.reactQuery.AnonExact
import typings.reactQuery.AnonExactBoolean
...
trait QueryCache_ extends js.Object {
  ...
  def refetchQueries(queryKeyOrPredicateFn: String, hasExactThrowOnErrorForce: AnonExact): js.Promise[Unit] = js.native
  ...
  def refetchQueries(
    ...
    hasExactThrowOnErrorForce: AnonExact
  ): js.Promise[Unit] = js.native
  def refetchQueries(queryKeyOrPredicateFn: AnyQueryKey): js.Promise[Unit] = js.native
  def refetchQueries(queryKeyOrPredicateFn: AnyQueryKey, hasExactThrowOnErrorForce: AnonExact): js.Promise[Unit] = js.native
  def removeQueries(queryKeyOrPredicateFn: String): js.Promise[Unit] = js.native
  def removeQueries(queryKeyOrPredicateFn: String, hasExact: AnonExactBoolean): js.Promise[Unit] = js.native
  def removeQueries(queryKeyOrPredicateFn: js.Function1[/* query */ CachedQuery, Boolean]): js.Promise[Unit] = js.native
  def removeQueries(queryKeyOrPredicateFn: js.Function1[/* query */ CachedQuery, Boolean], hasExact: AnonExactBoolean): js.Promise[Unit] = js.native
  def removeQueries(queryKeyOrPredicateFn: AnyQueryKey): js.Promise[Unit] = js.native
  def removeQueries(queryKeyOrPredicateFn: AnyQueryKey, hasExact: AnonExactBoolean): js.Promise[Unit] = js.native
