...
import typings.reactQuery.reactQueryStrings.environment
...
import typings.reactQuery.reactQueryStrings.user
...
import typings.reactQuery.typesReactTypesMod.UseMutateAsyncFunction
...
object anon {
  ...
  trait Entry extends StObject {
    ...
    var entry: typings.reactQuery.typesDevtoolsExplorerMod.Entry
  }
  object Entry {
    
    inline def apply(entry: typings.reactQuery.typesDevtoolsExplorerMod.Entry): Entry = {
