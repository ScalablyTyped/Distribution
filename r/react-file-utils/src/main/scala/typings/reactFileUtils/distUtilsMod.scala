...
object distUtilsMod {
  ...
  inline def useHandleFileChangeWrapper(): js.Function1[/* param0 */ ChangeEvent[HTMLInputElement], Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("useHandleFileChangeWrapper")().asInstanceOf[js.Function1[/* param0 */ ChangeEvent[HTMLInputElement], Unit]]
  inline def useHandleFileChangeWrapper(resetOnChange: Boolean): js.Function1[/* param0 */ ChangeEvent[HTMLInputElement], Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("useHandleFileChangeWrapper")(resetOnChange.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* param0 */ ChangeEvent[HTMLInputElement], Unit]]
  inline def useHandleFileChangeWrapper(resetOnChange: Boolean, handler: js.Function1[/* files */ js.Array[File], Unit]): js.Function1[/* param0 */ ChangeEvent[HTMLInputElement], Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("useHandleFileChangeWrapper")(resetOnChange.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* param0 */ ChangeEvent[HTMLInputElement], Unit]]
