...
trait Props extends js.Object {
  ...
  var onRequestClose: js.UndefOr[
    js.Function1[
      /* event */ (reactLib.reactMod.MouseEvent[reactLib.Element, reactLib.NativeMouseEvent]) | reactLib.reactMod.KeyboardEvent[reactLib.Element], 
      scala.Unit
    ]
  ] = js.undefined
...
object Props {
  ...
  def apply(
    ...
    onRequestClose: /* event */ (reactLib.reactMod.MouseEvent[reactLib.Element, reactLib.NativeMouseEvent]) | reactLib.reactMod.KeyboardEvent[reactLib.Element] => scala.Unit = null,
