package typings.rmcDashInputDashNumber.esBaseMod

import typings.react.reactMod.Component
import typings.rmcDashInputDashNumber.rmcDashInputDashNumberStrings.down
import typings.rmcDashInputDashNumber.rmcDashInputDashNumberStrings.up
