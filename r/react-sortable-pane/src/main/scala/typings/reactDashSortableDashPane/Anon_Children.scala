...
object Anon_Children {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(children = children, className = className, direction = direction, disableEffect = disableEffect, isSortable = isSortable, margin = margin, onClick = js.Any.fromFunction0(onClick), onDragStart = js.Any.fromFunction0(onDragStart), onDragStop = js.Any.fromFunction0(onDragStop), onOrderChange = js.Any.fromFunction0(onOrderChange), onResize = js.Any.fromFunction0(onResize), onResizeStart = js.Any.fromFunction0(onResizeStart), onResizeStop = js.Any.fromFunction0(onResizeStop), onTouchStart = js.Any.fromFunction0(onTouchStart), springConfig = springConfig)
