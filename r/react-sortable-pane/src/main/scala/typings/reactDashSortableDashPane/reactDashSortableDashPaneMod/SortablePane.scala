...
import typings.reactDashSortableDashPane.Anon_Children
import typings.reactDashSortableDashPane.Anon_Next
import typings.reactDashSortableDashPane.Anon_PageX
import typings.resizeDashObserverDashPolyfill.resizeDashObserverDashPolyfillMod._Global_.ResizeObserver
...
class SortablePane protected ()
  ...
  /**
    ...
    *                                  pane halfway points
    */
  def getSurroundingHalfSizes(currentPane: Double, sizes: js.Array[Double], margin: Double): Anon_Next = js.native
  ...
  def handleMove(hasPageXPageY: Anon_PageX): Unit = js.native
