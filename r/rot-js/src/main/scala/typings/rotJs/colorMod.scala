...
object colorMod {
  ...
  inline def add(color1: Color, colors: Color*): Color = ^.asInstanceOf[js.Dynamic].applyDynamic("add")(List(color1.asInstanceOf[js.Any]).`++`(colors.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Color]
  
  inline def add_(color1: Color, colors: Color*): Color = ^.asInstanceOf[js.Dynamic].applyDynamic("add_")(List(color1.asInstanceOf[js.Any]).`++`(colors.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Color]
  ...
  inline def multiply(color1: Color, colors: Color*): Color = ^.asInstanceOf[js.Dynamic].applyDynamic("multiply")(List(color1.asInstanceOf[js.Any]).`++`(colors.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Color]
  
  inline def multiply_(color1: Color, colors: Color*): Color = ^.asInstanceOf[js.Dynamic].applyDynamic("multiply_")(List(color1.asInstanceOf[js.Any]).`++`(colors.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Color]
