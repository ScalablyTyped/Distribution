...
{[ K in keyof Params ]:? string}
  */ typings.reactRouter.reactRouterStrings.AnonLocation with js.Any */] extends js.Object {
...
object AnonLocation {
  ...
  {[ K in keyof Params ]:? string}
    */ typings.reactRouter.reactRouterStrings.AnonLocation with js.Any */](location: Location[LocationState], `match`: `match`[Params]): AnonLocation[Params] = {
