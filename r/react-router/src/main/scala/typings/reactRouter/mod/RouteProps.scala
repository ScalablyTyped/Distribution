...
object RouteProps {
  ...
  extension [Self <: RouteProps](x: Self) {
    ...
    inline def setChildrenFunction1(value: /* props */ RouteChildrenProps[js.Any, LocationState] => ReactNode): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    
    inline def setChildrenUndefined: Self = StObject.set(x, "children", js.undefined)
    
    inline def setComponent(value: ComponentType[js.Any | (RouteComponentProps[js.Any, StaticContext, LocationState])]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
    ...
    inline def setRender(value: /* props */ RouteComponentProps[js.Any, StaticContext, LocationState] => ReactNode): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
