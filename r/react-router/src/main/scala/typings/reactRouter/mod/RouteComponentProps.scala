...
{[ K in keyof Params ]:? string}
  */ typings.reactRouter.reactRouterStrings.RouteComponentProps with js.Any */, C /* <: StaticContext */, S] extends js.Object {
...
object RouteComponentProps {
  ...
  {[ K in keyof Params ]:? string}
    */ typings.reactRouter.reactRouterStrings.RouteComponentProps with js.Any */, C /* <: StaticContext */, S](history: History[S], location: Location[S], `match`: `match`[Params], staticContext: C = null): RouteComponentProps[Params, C, S] = {
