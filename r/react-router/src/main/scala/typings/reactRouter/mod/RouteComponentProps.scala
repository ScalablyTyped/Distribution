...
object RouteComponentProps {
  ...
  {[ K in keyof Params ]:? string}
    * / typings.reactRouter.reactRouterStrings.RouteComponentProps with org.scalablytyped.runtime.TopLevel[js.Any] */ Params, /* <: typings.reactRouter.mod.StaticContext */ C, S](history: History[S], location: Location[S], `match`: `match`[Params]): RouteComponentProps[Params, C, S] = {
  ...
  {[ K in keyof Params ]:? string}
    * / typings.reactRouter.reactRouterStrings.RouteComponentProps with org.scalablytyped.runtime.TopLevel[js.Any] */ Params, /* <: typings.reactRouter.mod.StaticContext */ C, S] (val x: Self with (RouteComponentProps[Params, C, S])) extends AnyVal {
    @scala.inline
