...
@scala.inline
def withRouter[P /* <: typings.reactRouter.mod.RouteComponentProps[js.Any, typings.reactRouter.mod.StaticContext, typings.history.mod.LocationState] */, C /* <: typings.react.mod.ComponentType[P] */](component: C & typings.react.mod.ComponentType[P]): (typings.react.mod.ComponentClass[
