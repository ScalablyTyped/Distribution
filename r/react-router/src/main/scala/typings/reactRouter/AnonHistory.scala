...
import typings.reactRouter.reactRouterStrings.Anon_History
...
{[ K in keyof Params ]:? string}
  */ Anon_History with js.Any */] extends js.Object {
...
object AnonHistory {
  ...
  {[ K in keyof Params ]:? string}
    */ Anon_History with js.Any */](history: History[LocationState], route: AnonLocation[Params]): AnonHistory[Params] = {
