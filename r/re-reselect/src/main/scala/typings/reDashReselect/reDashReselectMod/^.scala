...
import typings.reDashReselect.reDashReselectStrings.createStructuredCachedSelector
...
object ^ extends js.Object {
  ...
  def createStructuredCachedSelector_SPT_OutputParametricCachedSelector[S, P, T](
    selectors: /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ K in keyof T ]: re-reselect.re-reselect.ParametricSelector<S, P, T[K]>}
    */ createStructuredCachedSelector with T
