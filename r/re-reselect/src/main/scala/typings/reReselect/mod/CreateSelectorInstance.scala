...
trait CreateSelectorInstance extends js.Object {
  def apply[S, R, T](
    selectors: js.Array[typings.reselect.mod.Selector[S, R]],
    combiner: js.Function1[/* repeated */ R, T]
  ): typings.reselect.mod.OutputSelector[S, T, js.Function1[/* repeated */ R, T]] = js.native
  def apply[S, R1, T](selector: typings.reselect.mod.Selector[S, R1], combiner: js.Function1[/* res */ R1, T]): typings.reselect.mod.OutputSelector[S, T, js.Function1[/* res */ R1, T]] = js.native
  def apply[S, R1, R2, T](
