...
import typings.reactDashNativeDashFetchDashBlob.reactDashNativeDashFetchDashBlobStrings.directory
import typings.reactDashNativeDashFetchDashBlob.reactDashNativeDashFetchDashBlobStrings.file
