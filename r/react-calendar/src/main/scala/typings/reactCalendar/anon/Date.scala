...
object Date {
  ...
  inline def apply(date: js.Date, weekNumber: Double): Date = {
    val __obj = js.Dynamic.literal(date = date.asInstanceOf[js.Any], weekNumber = weekNumber.asInstanceOf[js.Any])
