...
object distCjsDecadeViewYearMod {
  
  object default {
    
    inline def apply(param0: YearProps): Element = ^.asInstanceOf[js.Dynamic].apply(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("react-calendar/dist/cjs/DecadeView/Year", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.activeStartDate")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.classes")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.date")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.formatYear")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.locale")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.maxDate")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.minDate")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.onClick")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.onMouseOver")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.style")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.tileClassName")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.tileContent")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Year", "default.propTypes.tileDisabled")
      @js.native
  ...
  type YearProps = Classes & (Omit[ComponentProps[TypeofTile], children | maxDateTransform | minDateTransform | view])
}
