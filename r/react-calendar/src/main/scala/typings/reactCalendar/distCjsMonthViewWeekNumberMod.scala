...
import typings.reactCalendar.reactCalendarStrings.`additions removals`
import typings.reactCalendar.reactCalendarStrings.`additions text`
import typings.reactCalendar.reactCalendarStrings.`inline`
import typings.reactCalendar.reactCalendarStrings.`removals additions`
import typings.reactCalendar.reactCalendarStrings.`removals text`
import typings.reactCalendar.reactCalendarStrings.`text additions`
import typings.reactCalendar.reactCalendarStrings.`text removals`
import typings.reactCalendar.reactCalendarStrings.additions
import typings.reactCalendar.reactCalendarStrings.all
import typings.reactCalendar.reactCalendarStrings.ascending
import typings.reactCalendar.reactCalendarStrings.assertive
import typings.reactCalendar.reactCalendarStrings.both
import typings.reactCalendar.reactCalendarStrings.button
import typings.reactCalendar.reactCalendarStrings.copy
import typings.reactCalendar.reactCalendarStrings.date
import typings.reactCalendar.reactCalendarStrings.decimal
import typings.reactCalendar.reactCalendarStrings.descending
import typings.reactCalendar.reactCalendarStrings.dialog
import typings.reactCalendar.reactCalendarStrings.email
import typings.reactCalendar.reactCalendarStrings.execute
import typings.reactCalendar.reactCalendarStrings.grammar
import typings.reactCalendar.reactCalendarStrings.grid
import typings.reactCalendar.reactCalendarStrings.horizontal
import typings.reactCalendar.reactCalendarStrings.inherit
import typings.reactCalendar.reactCalendarStrings.link
import typings.reactCalendar.reactCalendarStrings.list
import typings.reactCalendar.reactCalendarStrings.listbox
import typings.reactCalendar.reactCalendarStrings.location
import typings.reactCalendar.reactCalendarStrings.menu
import typings.reactCalendar.reactCalendarStrings.mixed
import typings.reactCalendar.reactCalendarStrings.move
import typings.reactCalendar.reactCalendarStrings.no
import typings.reactCalendar.reactCalendarStrings.none
import typings.reactCalendar.reactCalendarStrings.numeric
import typings.reactCalendar.reactCalendarStrings.off
import typings.reactCalendar.reactCalendarStrings.on
import typings.reactCalendar.reactCalendarStrings.other
import typings.reactCalendar.reactCalendarStrings.page
import typings.reactCalendar.reactCalendarStrings.polite
import typings.reactCalendar.reactCalendarStrings.popup
import typings.reactCalendar.reactCalendarStrings.removals
import typings.reactCalendar.reactCalendarStrings.reset
import typings.reactCalendar.reactCalendarStrings.search
import typings.reactCalendar.reactCalendarStrings.spelling
import typings.reactCalendar.reactCalendarStrings.step
import typings.reactCalendar.reactCalendarStrings.submit
import typings.reactCalendar.reactCalendarStrings.tel
import typings.reactCalendar.reactCalendarStrings.text
import typings.reactCalendar.reactCalendarStrings.time
import typings.reactCalendar.reactCalendarStrings.tree
import typings.reactCalendar.reactCalendarStrings.url
import typings.reactCalendar.reactCalendarStrings.vertical
import typings.reactCalendar.reactCalendarStrings.yes
...
object distCjsMonthViewWeekNumberMod {
  
  object default {
    
    inline def apply(props: WeekNumberProps[js.UndefOr[OnClickWeekNumberFunc]]): Element = ^.asInstanceOf[js.Dynamic].apply(props.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("react-calendar/dist/cjs/MonthView/WeekNumber", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-calendar/dist/cjs/MonthView/WeekNumber", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-calendar/dist/cjs/MonthView/WeekNumber", "default.propTypes.date")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/MonthView/WeekNumber", "default.propTypes.onClickWeekNumber")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/MonthView/WeekNumber", "default.propTypes.weekNumber")
      @js.native
      def weekNumber: Validator[NonNullable[ReactNodeLike]] = js.native
      inline def weekNumber_=(x: Validator[NonNullable[ReactNodeLike]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("weekNumber")(x.asInstanceOf[js.Any])
    }
  }
  
  /* Inlined std.Omit<react.react.ButtonHTMLAttributes<std.HTMLButtonElement>, 'onClick'> & {  onClickWeekNumber :react-calendar.react-calendar/dist/cjs/shared/types.OnClickWeekNumberFunc} */
  trait ButtonProps extends StObject {
    ...
    var onClickWeekNumber: OnClickWeekNumberFunc
  ...
  object ButtonProps {
    ...
    inline def apply(
      onClickWeekNumber: (/* weekNumber */ Double, /* date */ js.Date, /* event */ MouseEvent[HTMLButtonElement, NativeMouseEvent]) => Unit
    ): ButtonProps = {
      val __obj = js.Dynamic.literal(onClickWeekNumber = js.Any.fromFunction3(onClickWeekNumber))
  ...
  trait DivProps
    ...
    var onClickWeekNumber: Unit
  }
  object DivProps {
    
    inline def apply(onClickWeekNumber: Unit): DivProps = {
      val __obj = js.Dynamic.literal(onClickWeekNumber = onClickWeekNumber.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: DivProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnClickWeekNumber(value: Unit): Self = StObject.set(x, "onClickWeekNumber", value.asInstanceOf[js.Any])
    }
  }
  
  type WeekNumberProps[T] = (/* import warning: importer.ImportType#apply Failed type conversion: T extends react-calendar.react-calendar/dist/cjs/shared/types.OnClickWeekNumberFunc ? react-calendar.react-calendar/dist/cjs/MonthView/WeekNumber.ButtonProps : react-calendar.react-calendar/dist/cjs/MonthView/WeekNumber.DivProps */ js.Any) & Date
}
