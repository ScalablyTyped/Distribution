...
object distCjsDecadeViewYearsMod {
  
  object default {
    
    inline def apply(props: YearsProps): Element = ^.asInstanceOf[js.Dynamic].apply(props.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("react-calendar/dist/cjs/DecadeView/Years", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes.activeStartDate")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes.hover")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes.locale")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes.maxDate")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes.minDate")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes.onClick")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes.onMouseOver")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes.tileClassName")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes.tileContent")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes.value")
      @js.native
      def value: Requireable[NonNullable[js.UndefOr[js.Date | (js.Array[js.UndefOr[js.Date | Null]]) | Null]]] = js.native
      
      @JSImport("react-calendar/dist/cjs/DecadeView/Years", "default.propTypes.valueType")
      @js.native
  ...
  type YearsProps = ActiveStartDateDate & ComponentProps[TypeofTileGroup]
}
