...
object distCjsCenturyViewDecadesMod {
  
  object default {
    
    inline def apply(props: DecadesProps): Element = ^.asInstanceOf[js.Dynamic].apply(props.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("react-calendar/dist/cjs/CenturyView/Decades", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes.activeStartDate")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes.hover")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes.locale")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes.maxDate")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes.minDate")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes.onClick")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes.onMouseOver")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes.tileClassName")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes.tileContent")
      @js.native
      ...
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes.value")
      @js.native
      def value: Requireable[NonNullable[js.UndefOr[js.Date | (js.Array[js.UndefOr[js.Date | Null]]) | Null]]] = js.native
      
      @JSImport("react-calendar/dist/cjs/CenturyView/Decades", "default.propTypes.valueType")
      @js.native
  ...
  type DecadesProps = ActiveStartDateDate & ComponentProps[TypeofTileGroup]
}
