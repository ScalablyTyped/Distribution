...
import typings.atReduxDashSagaCore.effectsMod.ActionChannelEffect
import typings.atReduxDashSagaCore.effectsMod.AllEffect
import typings.atReduxDashSagaCore.effectsMod.CallEffect
import typings.atReduxDashSagaCore.effectsMod.CancelEffect
import typings.atReduxDashSagaCore.effectsMod.CancelledEffect
import typings.atReduxDashSagaCore.effectsMod.ChannelPutEffect
import typings.atReduxDashSagaCore.effectsMod.ChannelTakeEffect
import typings.atReduxDashSagaCore.effectsMod.CpsCallback
import typings.atReduxDashSagaCore.effectsMod.CpsEffect
import typings.atReduxDashSagaCore.effectsMod.CpsFunctionParameters
import typings.atReduxDashSagaCore.effectsMod.FlushEffect
import typings.atReduxDashSagaCore.effectsMod.ForkEffect
import typings.atReduxDashSagaCore.effectsMod.GetContextEffect
import typings.atReduxDashSagaCore.effectsMod.HelperWorkerParameters
import typings.atReduxDashSagaCore.effectsMod.JoinEffect
import typings.atReduxDashSagaCore.effectsMod.PutEffect
import typings.atReduxDashSagaCore.effectsMod.RaceEffect
import typings.atReduxDashSagaCore.effectsMod.SelectEffect
import typings.atReduxDashSagaCore.effectsMod.SetContextEffect
import typings.atReduxDashSagaCore.effectsMod.Tail
import typings.atReduxDashSagaCore.effectsMod.TakeEffect
...
import typings.reduxDashSaga.reduxDashSagaStrings.apply
import typings.reduxDashSaga.reduxDashSagaStrings.call
import typings.reduxDashSaga.reduxDashSagaStrings.spawn
...
object effectsMod extends js.Object {
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): any}
    */ typings.reduxDashSaga.reduxDashSagaStrings.call with js.Any */, Name /* <: String */](
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): void}
    */ typings.reduxDashSaga.reduxDashSagaStrings.cps with js.Any */, Name /* <: String */](
    ctxAndFnName: js.Tuple2[Ctx, Name],
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): any}
    */ typings.reduxDashSaga.reduxDashSagaStrings.fork with js.Any */, Name /* <: String */](
    ctxAndFnName: js.Tuple2[Ctx, Name],
    /* import warning: parser.TsParser#functionParam $anonfun Dropping repeated marker of param args because its type Parameters<Ctx[Name]> is not an array type */ args: Parameters[/* import warning: ImportType.apply Failed type conversion: Ctx[Name] */ js.Any]
  ): ForkEffect = js.native
  def fork[Ctx /* <: /* import warning: ImportType.apply c Unsupported type mapping: 
  ...
  {[ P in Name ]: (this : Ctx, args : ...any): any}
    */ typings.reduxDashSaga.reduxDashSagaStrings.spawn with js.Any */, Name /* <: String */](
    ctxAndFnName: Anon_Context[Ctx, Name],
    /* import warning: parser.TsParser#functionParam $anonfun Dropping repeated marker of param args because its type Parameters<Ctx[Name]> is not an array type */ args: Parameters[/* import warning: ImportType.apply Failed type conversion: Ctx[Name] */ js.Any]
  ): ForkEffect = js.native
  ...
  object effectTypes extends js.Object {
    var ACTION_CHANNEL: typings.reduxDashSaga.reduxDashSagaStrings.ACTION_CHANNEL = js.native
    var ALL: typings.reduxDashSaga.reduxDashSagaStrings.ALL = js.native
    var CALL: typings.reduxDashSaga.reduxDashSagaStrings.CALL = js.native
    var CANCEL: typings.reduxDashSaga.reduxDashSagaStrings.CANCEL = js.native
    var CANCELLED: typings.reduxDashSaga.reduxDashSagaStrings.CANCELLED = js.native
    var CPS: typings.reduxDashSaga.reduxDashSagaStrings.CPS = js.native
    var FLUSH: typings.reduxDashSaga.reduxDashSagaStrings.FLUSH = js.native
    var FORK: typings.reduxDashSaga.reduxDashSagaStrings.FORK = js.native
    var GET_CONTEXT: typings.reduxDashSaga.reduxDashSagaStrings.GET_CONTEXT = js.native
    var JOIN: typings.reduxDashSaga.reduxDashSagaStrings.JOIN = js.native
    var PUT: typings.reduxDashSaga.reduxDashSagaStrings.PUT = js.native
    var RACE: typings.reduxDashSaga.reduxDashSagaStrings.RACE = js.native
    var SELECT: typings.reduxDashSaga.reduxDashSagaStrings.SELECT = js.native
    var SET_CONTEXT: typings.reduxDashSaga.reduxDashSagaStrings.SET_CONTEXT = js.native
    var TAKE: typings.reduxDashSaga.reduxDashSagaStrings.TAKE = js.native
  }
