package typings.rollupDashPluginDashPostcss.rollupDashPluginDashPostcssMod

import typings.cssnano.cssnanoMod.CssNanoOptions
import typings.rollupDashPluginDashPostcss.Anon_Ctx
import typings.rollupDashPluginDashPostcss.Anon_InsertAt
import typings.rollupDashPluginDashPostcss.rollupDashPluginDashPostcssStrings.`inline`
...
object PostCssPluginOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(autoModules)) __obj.updateDynamic("autoModules")(autoModules)
