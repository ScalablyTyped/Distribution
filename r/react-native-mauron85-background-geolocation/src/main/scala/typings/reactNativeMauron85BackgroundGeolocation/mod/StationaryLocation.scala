...
object StationaryLocation {
  ...
  def apply(
    ...
    if (!js.isUndefined(isFromMockProvider)) __obj.updateDynamic("isFromMockProvider")(isFromMockProvider.get.asInstanceOf[js.Any])
    if (!js.isUndefined(mockLocationsEnabled)) __obj.updateDynamic("mockLocationsEnabled")(mockLocationsEnabled.get.asInstanceOf[js.Any])
