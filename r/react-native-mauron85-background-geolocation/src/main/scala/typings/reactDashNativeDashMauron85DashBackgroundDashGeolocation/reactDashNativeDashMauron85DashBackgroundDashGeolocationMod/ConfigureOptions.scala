...
trait ConfigureOptions extends js.Object {
  ...
  /**
    ...
    */
  var desiredAccuracy: js.UndefOr[Double] = js.undefined
  /**
  ...
  /**
    ...
    */
  var locationProvider: js.UndefOr[Double] = js.undefined
  /**
