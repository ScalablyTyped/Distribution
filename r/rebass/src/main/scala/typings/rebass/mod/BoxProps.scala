...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLProps<std.HTMLDivElement>, 'variant' | 'tx'> ]: react.react.HTMLProps<std.HTMLDivElement>[P]} */ trait BoxProps extends BoxKnownProps
