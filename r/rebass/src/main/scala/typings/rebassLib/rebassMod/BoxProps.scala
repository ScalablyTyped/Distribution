...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLProps<react.HTMLDivElement>, keyof rebass.rebass.BoxKnownProps> ]: react.react.HTMLProps<react.HTMLDivElement>[P]} */ trait BoxProps extends BoxKnownProps
