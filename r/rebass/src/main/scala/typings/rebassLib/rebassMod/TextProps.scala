...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLProps<std.HTMLDivElement>, keyof rebass.rebass.TextKnownProps> ]: react.react.HTMLProps<std.HTMLDivElement>[P]} */ trait TextProps extends TextKnownProps
