...
- Dropped {[ P in std.Exclude<keyof react.react.React.HTMLProps<std.HTMLDivElement>, keyof rebass.rebass.TextKnownProps> ]: react.react.React.HTMLProps<std.HTMLDivElement>[P]} */ trait TextProps extends TextKnownProps
