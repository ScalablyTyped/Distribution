...
- Dropped {[ P in std.Exclude<keyof react.react.React.HTMLProps<std.HTMLAnchorElement>, keyof rebass.rebass.LinkKnownProps> ]: react.react.React.HTMLProps<std.HTMLAnchorElement>[P]} */ trait LinkProps extends BoxKnownProps
