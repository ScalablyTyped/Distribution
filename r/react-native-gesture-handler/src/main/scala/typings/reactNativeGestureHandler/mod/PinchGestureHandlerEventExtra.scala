...
object PinchGestureHandlerEventExtra {
  ...
  inline def apply(focalX: Double, focalY: Double, scale: Double, velocity: Double): PinchGestureHandlerEventExtra = {
  ...
  extension [Self <: PinchGestureHandlerEventExtra](x: Self) {
