...
object LongPressGestureHandlerEventExtra {
  ...
  inline def apply(absoluteX: Double, absoluteY: Double, x: Double, y: Double): LongPressGestureHandlerEventExtra = {
  ...
  extension [Self <: LongPressGestureHandlerEventExtra](x: Self) {
