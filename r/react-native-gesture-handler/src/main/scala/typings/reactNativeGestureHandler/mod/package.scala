...
inline def GestureHandlerRootView: typings.react.mod.ComponentType[typings.reactNative.mod.ViewProps] = typings.reactNativeGestureHandler.mod.^.asInstanceOf[js.Dynamic].selectDynamic("GestureHandlerRootView").asInstanceOf[typings.react.mod.ComponentType[typings.reactNative.mod.ViewProps]]

inline def createNativeWrapper[P](
...
inline def gestureHandlerRootHOC[P](Component: typings.react.mod.ComponentType[P]): typings.react.mod.ComponentType[P] = typings.reactNativeGestureHandler.mod.^.asInstanceOf[js.Dynamic].applyDynamic("gestureHandlerRootHOC")(Component.asInstanceOf[js.Any]).asInstanceOf[typings.react.mod.ComponentType[P]]
inline def gestureHandlerRootHOC[P](
  Component: typings.react.mod.ComponentType[P],
