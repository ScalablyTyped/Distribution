...
object interactionManagerMod {
  ...
  /* private */ open class default ()
    ...
    /* CompleteClass */
    override def configureInteractions(handler: typings.reactNativeGestureHandler.gestureHandlerMod.default, config: Config): Unit = js.native
    ...
    override def shouldHandlerBeCancelledBy(
      _handler: typings.reactNativeGestureHandler.gestureHandlerMod.default,
      _otherHandler: typings.reactNativeGestureHandler.gestureHandlerMod.default
    ): Boolean = js.native
    
    /* CompleteClass */
    override def shouldRecognizeSimultaneously(
      handler: typings.reactNativeGestureHandler.gestureHandlerMod.default,
      otherHandler: typings.reactNativeGestureHandler.gestureHandlerMod.default
    ): Boolean = js.native
  ...
  trait InteractionManager extends StObject {
    ...
    def configureInteractions(handler: typings.reactNativeGestureHandler.gestureHandlerMod.default, config: Config): Unit
  ...
  object InteractionManager {
    ...
    inline def apply(
      configureInteractions: (typings.reactNativeGestureHandler.gestureHandlerMod.default, Config) => Unit,
      dropRelationsForHandlerWithTag: Double => Unit,
      reset: () => Unit,
      shouldHandlerBeCancelledBy: (typings.reactNativeGestureHandler.gestureHandlerMod.default, typings.reactNativeGestureHandler.gestureHandlerMod.default) => Boolean,
      shouldRecognizeSimultaneously: (typings.reactNativeGestureHandler.gestureHandlerMod.default, typings.reactNativeGestureHandler.gestureHandlerMod.default) => Boolean,
      shouldRequireHandlerToWaitForFailure: (typings.reactNativeGestureHandler.gestureHandlerMod.default, typings.reactNativeGestureHandler.gestureHandlerMod.default) => Boolean,
      shouldWaitForHandlerFailure: (typings.reactNativeGestureHandler.gestureHandlerMod.default, typings.reactNativeGestureHandler.gestureHandlerMod.default) => Boolean,
    ...
    extension [Self <: InteractionManager](x: Self) {
      ...
      inline def setConfigureInteractions(value: (typings.reactNativeGestureHandler.gestureHandlerMod.default, Config) => Unit): Self = StObject.set(x, "configureInteractions", js.Any.fromFunction2(value))
      ...
      inline def setShouldHandlerBeCancelledBy(
        value: (typings.reactNativeGestureHandler.gestureHandlerMod.default, typings.reactNativeGestureHandler.gestureHandlerMod.default) => Boolean
