...
object libTypescriptWebToolsGestureHandlerOrchestratorMod {
  ...
  trait GestureHandlerOrchestrator extends StObject {
    ...
    def cancelMouseAndPenGestures(
      currentHandler: typings.reactNativeGestureHandler.libTypescriptWebHandlersGestureHandlerMod.default
    ): Unit = js.native
    ...
    def recordHandlerIfNotPresent(handler: typings.reactNativeGestureHandler.libTypescriptWebHandlersGestureHandlerMod.default): Unit = js.native
    
    def removeHandlerFromOrchestrator(handler: typings.reactNativeGestureHandler.libTypescriptWebHandlersGestureHandlerMod.default): Unit = js.native
