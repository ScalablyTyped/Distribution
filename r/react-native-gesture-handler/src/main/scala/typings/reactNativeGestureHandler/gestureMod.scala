...
import typings.reactNativeGestureHandler.gestureHandlerCommonMod.CommonGestureConfig
...
object gestureMod {
  ...
  @JSImport("react-native-gesture-handler/lib/typescript/handlers/gestures/gesture", "BaseGesture")
  @js.native
  abstract class BaseGesture[EventPayloadT /* <: Record[String, Any] */] () extends Gesture {
  ...
  */
  ...
  @JSImport("react-native-gesture-handler/lib/typescript/handlers/gestures/gesture", "ContinousBaseGesture")
  @js.native
  abstract class ContinousBaseGesture[EventPayloadT /* <: Record[String, Any] */, EventChangePayloadT /* <: Record[String, Any] */] () extends BaseGesture[EventPayloadT] {
  ...
  @JSImport("react-native-gesture-handler/lib/typescript/handlers/gestures/gesture", "Gesture")
  @js.native
  abstract class Gesture () extends StObject {
