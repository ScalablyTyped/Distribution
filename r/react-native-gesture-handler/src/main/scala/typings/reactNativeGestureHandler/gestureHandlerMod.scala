...
import typings.reactNativeGestureHandler.interfacesMod.PointerType
...
object gestureHandlerMod {
  ...
  @JSImport("react-native-gesture-handler/lib/typescript/web/handlers/GestureHandler", JSImport.Default)
  @js.native
  ...
  trait GestureHandler extends StObject {
    ...
    /* protected */ var eventManagers: js.Array[typings.reactNativeGestureHandler.eventManagerMod.default] = js.native
    ...
    def getEventManagers(): js.Array[typings.reactNativeGestureHandler.eventManagerMod.default] = js.native
    ...
    def getTracker(): typings.reactNativeGestureHandler.pointerTrackerMod.default = js.native
    ...
    /* protected */ var tracker: typings.reactNativeGestureHandler.pointerTrackerMod.default = js.native
