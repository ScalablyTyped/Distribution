...
import typings.reactNativeGestureHandler.touchableHighlightMod.default
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object touchablesMod {
  ...
  open class TouchableNativeFeedback protected ()
    extends typings.reactNativeGestureHandler.touchableNativeFeedbackMod.default {
  ...
  open class TouchableOpacity ()
    extends typings.reactNativeGestureHandler.touchableOpacityMod.default
  /* static members */
