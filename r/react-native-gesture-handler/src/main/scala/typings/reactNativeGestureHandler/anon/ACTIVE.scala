...
trait ACTIVE extends StObject {
  ...
  val BEGAN: typings.reactNativeGestureHandler.reactNativeGestureHandlerNumbers.`2`
  
  val CANCELLED: `3`
  
  val END: `5`
  
  val FAILED: typings.reactNativeGestureHandler.reactNativeGestureHandlerNumbers.`1`
...
object ACTIVE {
  ...
  extension [Self <: ACTIVE](x: Self) {
    ...
    inline def setBEGAN(value: typings.reactNativeGestureHandler.reactNativeGestureHandlerNumbers.`2`): Self = StObject.set(x, "BEGAN", value.asInstanceOf[js.Any])
    ...
    inline def setFAILED(value: typings.reactNativeGestureHandler.reactNativeGestureHandlerNumbers.`1`): Self = StObject.set(x, "FAILED", value.asInstanceOf[js.Any])
