...
/* Inlined react-native-gesture-handler.react-native-gesture-handler/lib/typescript/web_hammer/GestureHandler.Config & {  minVelocityX :number | undefined,   minVelocityY :number | undefined} */
trait ConfigminVelocityXnumberu extends StObject {
...
object ConfigminVelocityXnumberu {
  
  inline def apply(): ConfigminVelocityXnumberu = {
