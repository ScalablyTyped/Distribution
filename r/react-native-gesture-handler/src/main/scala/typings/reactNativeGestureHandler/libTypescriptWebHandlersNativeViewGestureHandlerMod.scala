...
object libTypescriptWebHandlersNativeViewGestureHandlerMod {
  ...
  trait NativeViewGestureHandler
    ...
    def shouldBeCancelledByOther(_handler: typings.reactNativeGestureHandler.libTypescriptWebHandlersGestureHandlerMod.default): Boolean = js.native
    
    def shouldRecognizeSimultaneously(handler: typings.reactNativeGestureHandler.libTypescriptWebHandlersGestureHandlerMod.default): Boolean = js.native
