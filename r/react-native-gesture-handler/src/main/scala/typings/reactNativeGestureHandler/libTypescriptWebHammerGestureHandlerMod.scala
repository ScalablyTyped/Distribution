...
object libTypescriptWebHammerGestureHandlerMod {
  
  /* note: abstract class */ @JSImport("react-native-gesture-handler/lib/typescript/web_hammer/GestureHandler", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
       with GestureHandler
