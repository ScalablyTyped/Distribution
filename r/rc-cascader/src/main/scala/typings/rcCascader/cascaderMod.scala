...
object cascaderMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.rcCascader.cascaderMod.SingleCascaderProps[OptionType]
    - typings.rcCascader.cascaderMod.MultipleCascaderProps[OptionType]
  */
  trait CascaderProps[OptionType /* <: BaseOptionType */] extends StObject
  object CascaderProps {
    
    inline def MultipleCascaderProps[OptionType /* <: BaseOptionType */](): typings.rcCascader.cascaderMod.MultipleCascaderProps[OptionType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.rcCascader.cascaderMod.MultipleCascaderProps[OptionType]]
    }
    
    inline def SingleCascaderProps[OptionType /* <: BaseOptionType */](): typings.rcCascader.cascaderMod.SingleCascaderProps[OptionType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.rcCascader.cascaderMod.SingleCascaderProps[OptionType]]
    }
  }
