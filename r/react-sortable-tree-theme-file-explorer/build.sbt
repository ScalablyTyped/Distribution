...
version := "0.0-dt-20181210Z-74facb"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-sortable-tree" % "0.3-dt-20190212Z-a39e42",
  "org.scalablytyped" %%% "react-virtualized" % "9.18-dt-20190110Z-31e9b9",
