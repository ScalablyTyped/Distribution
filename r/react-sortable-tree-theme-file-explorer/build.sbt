...
version := "0.0-dt-20200515Z-b0e0b1"
scalaVersion := "2.13.3"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "csstype" % "3.0.2-b6fa26",
  "org.scalablytyped" %%% "dnd-core" % "11.1.3-08cd13",
  ...
  "org.scalablytyped" %%% "react-dnd" % "11.1.3-c57295",
  "org.scalablytyped" %%% "react-sortable-tree" % "0.3-dt-20200717Z-e7e09e",
  "org.scalablytyped" %%% "react-virtualized" % "9.21-dt-20200515Z-143ebb",
