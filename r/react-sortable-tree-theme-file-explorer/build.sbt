...
version := "0.0-dt-20181210Z-c9aab0"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-sortable-tree" % "0.3-dt-20190212Z-d4dc02",
  "org.scalablytyped" %%% "react-virtualized" % "9.18-dt-20190110Z-4b8cb8",
