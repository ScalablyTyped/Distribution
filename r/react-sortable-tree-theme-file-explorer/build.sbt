...
version := "0.0-dt-20181210Z-4fab9c"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-dnd" % "7.0.2-7c3f98",
  "org.scalablytyped" %%% "react-sortable-tree" % "0.3-dt-20190212Z-facde7",
  "org.scalablytyped" %%% "react-virtualized" % "9.18-dt-20190110Z-be47b1",
