...
version := "0.0-dt-20211202Z-e3ab89"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-sortable-tree" % "0.3-dt-20221230Z-c8305f",
  "org.scalablytyped" %%% "react-virtualized" % "9.21-dt-20221230Z-2f50fb",
