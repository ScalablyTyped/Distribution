...
class TestSchedulerCls ()
  extends rxDashLiteDashTestingLib.RxNs.TestScheduler {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def createColdObservable[T](records: rxDashLiteDashTestingLib.RxNs.Recorded*): rxDashCoreLib.RxNs.Observable[T] = js.native
  /* CompleteClass */
  override def createHotObservable[T](records: rxDashLiteDashTestingLib.RxNs.Recorded*): rxDashCoreLib.RxNs.Observable[T] = js.native
  /* CompleteClass */
  override def createObserver[T](): rxDashLiteDashTestingLib.RxNs.MockObserver[T] = js.native
  ...
  /* CompleteClass */
  override def startWithCreate[T](create: js.Function0[rxDashCoreLib.RxNs.Observable[T]]): rxDashLiteDashTestingLib.RxNs.MockObserver[T] = js.native
  /* CompleteClass */
  override def startWithDispose[T](create: js.Function0[rxDashCoreLib.RxNs.Observable[T]], disposedAt: scala.Double): rxDashLiteDashTestingLib.RxNs.MockObserver[T] = js.native
  /* CompleteClass */
  ...
  ): rxDashLiteDashTestingLib.RxNs.MockObserver[T] = js.native
  /* CompleteClass */
