...
class TestSchedulerCls ()
  extends typings.rxDashLiteDashTesting.RxNs.TestScheduler {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def createColdObservable[T](records: typings.rxDashLiteDashTesting.RxNs.Recorded*): Observable[T] = js.native
  /* CompleteClass */
  override def createHotObservable[T](records: typings.rxDashLiteDashTesting.RxNs.Recorded*): Observable[T] = js.native
  /* CompleteClass */
