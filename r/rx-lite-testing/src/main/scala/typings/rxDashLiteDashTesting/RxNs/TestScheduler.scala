...
import typings.rxDashCore.RxNs.Observable
import typings.rxDashLite.RxNs.internalsNs.ScheduledItem
import typings.rxDashLiteDashVirtualtime.RxNs.VirtualTimeScheduler
...
class TestSchedulerCls () extends TestScheduler {
  ...
  /* CompleteClass */
  override def createColdObservable[T](records: Recorded*): Observable[T] = js.native
  /* CompleteClass */
  override def createHotObservable[T](records: Recorded*): Observable[T] = js.native
  /* CompleteClass */
