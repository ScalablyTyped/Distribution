...
object mod {
  ...
  @js.native
  open class ^[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typings.react.mod.ComponentType[js.Object], typings.reactTimeago.reactTimeagoStrings.a, typings.reactTimeago.reactTimeagoStrings.abbr */ Any */] ()
  ...
  */
  ...
  type ReactTimeago[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typings.react.mod.ComponentType[js.Object], typings.reactTimeago.reactTimeagoStrings.a, typings.reactTimeago.reactTimeagoStrings.abbr */ Any */] = Component[ReactTimeagoProps[T] & ComponentProps[T], js.Object, Any]
  
  trait ReactTimeagoProps[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typings.react.mod.ComponentType[js.Object], typings.reactTimeago.reactTimeagoStrings.a, typings.reactTimeago.reactTimeagoStrings.abbr */ Any */] extends StObject {
  ...
  object ReactTimeagoProps {
    ...
    inline def apply[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typings.react.mod.ComponentType[js.Object], typings.reactTimeago.reactTimeagoStrings.a, typings.reactTimeago.reactTimeagoStrings.abbr */ Any */](date: String | Double | js.Date): ReactTimeagoProps[T] = {
      val __obj = js.Dynamic.literal(date = date.asInstanceOf[js.Any])
      __obj.asInstanceOf[ReactTimeagoProps[T]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ReactTimeagoProps[?], T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typings.react.mod.ComponentType[js.Object], typings.reactTimeago.reactTimeagoStrings.a, typings.reactTimeago.reactTimeagoStrings.abbr */ Any */] (val x: Self & ReactTimeagoProps[T]) extends AnyVal {
