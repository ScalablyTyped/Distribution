...
trait ReactTimeagoProps extends js.Object {
  val component: js.UndefOr[java.lang.String | reactLib.reactMod.ComponentType[_]] = js.undefined
...
object ReactTimeagoProps {
  ...
  def apply(
    ...
    component: java.lang.String | reactLib.reactMod.ComponentType[_] = null,
