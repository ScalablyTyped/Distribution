...
trait CSSPropertieslineCSSPrope extends StObject {
  ...
  /**
    ...
    */
  var bottom: js.UndefOr[typings.csstype.mod.Property.Bottom[String | Double]] = js.undefined
...
object CSSPropertieslineCSSPrope {
  ...
  extension [Self <: CSSPropertieslineCSSPrope](x: Self) {
    ...
    inline def setBottom(value: typings.csstype.mod.Property.Bottom[String | Double]): Self = StObject.set(x, "bottom", value.asInstanceOf[js.Any])
