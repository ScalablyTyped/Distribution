...
import typings.csstype.mod.MozContextPropertiesProperty
import typings.csstype.mod.MozFloatEdgeProperty
import typings.csstype.mod.MozImageRegionProperty
...
import typings.csstype.mod.MsContentZoomSnapProperty
import typings.csstype.mod.MsContentZoomSnapTypeProperty
import typings.csstype.mod.MsContentZoomingProperty
import typings.csstype.mod.MsFlowFromProperty
import typings.csstype.mod.MsFlowIntoProperty
import typings.csstype.mod.MsGridColumnsProperty
import typings.csstype.mod.MsGridRowsProperty
import typings.csstype.mod.MsHighContrastAdjustProperty
import typings.csstype.mod.MsHyphenateLimitCharsProperty
import typings.csstype.mod.MsHyphenateLimitLinesProperty
import typings.csstype.mod.MsHyphenateLimitZoneProperty
...
import typings.csstype.mod.MsScrollLimitXMaxProperty
import typings.csstype.mod.MsScrollLimitXMinProperty
import typings.csstype.mod.MsScrollLimitYMaxProperty
import typings.csstype.mod.MsScrollLimitYMinProperty
...
import typings.csstype.mod.MsScrollbar3dlightColorProperty
import typings.csstype.mod.MsScrollbarArrowColorProperty
import typings.csstype.mod.MsScrollbarBaseColorProperty
import typings.csstype.mod.MsScrollbarDarkshadowColorProperty
import typings.csstype.mod.MsScrollbarFaceColorProperty
import typings.csstype.mod.MsScrollbarHighlightColorProperty
import typings.csstype.mod.MsScrollbarShadowColorProperty
...
import typings.csstype.mod.MsWrapMarginProperty
...
import typings.csstype.mod.WebkitBorderBeforeColorProperty
import typings.csstype.mod.WebkitBorderBeforeProperty
import typings.csstype.mod.WebkitBorderBeforeStyleProperty
import typings.csstype.mod.WebkitBorderBeforeWidthProperty
import typings.csstype.mod.WebkitBoxReflectProperty
import typings.csstype.mod.WebkitLineClampProperty
import typings.csstype.mod.WebkitMaskAttachmentProperty
import typings.csstype.mod.WebkitMaskClipProperty
import typings.csstype.mod.WebkitMaskCompositeProperty
import typings.csstype.mod.WebkitMaskImageProperty
import typings.csstype.mod.WebkitMaskOriginProperty
import typings.csstype.mod.WebkitMaskPositionProperty
import typings.csstype.mod.WebkitMaskPositionXProperty
import typings.csstype.mod.WebkitMaskPositionYProperty
import typings.csstype.mod.WebkitMaskProperty
import typings.csstype.mod.WebkitMaskRepeatProperty
import typings.csstype.mod.WebkitMaskRepeatXProperty
import typings.csstype.mod.WebkitMaskRepeatYProperty
import typings.csstype.mod.WebkitMaskSizeProperty
import typings.csstype.mod.WebkitOverflowScrollingProperty
import typings.csstype.mod.WebkitTapHighlightColorProperty
import typings.csstype.mod.WebkitTextFillColorProperty
import typings.csstype.mod.WebkitTextStrokeColorProperty
import typings.csstype.mod.WebkitTextStrokeProperty
import typings.csstype.mod.WebkitTextStrokeWidthProperty
...
/* Inlined react.react.CSSProperties & {  line :react.react.CSSProperties | undefined,   ticks :react.react.CSSProperties | undefined,   text :react.react.CSSProperties | undefined,   title :react.react.CSSProperties | undefined} */
trait CSSPropertieslineCSSPrope extends StObject {
  ...
  /**
    ...
    * @deprecated
    */
  var MozBackgroundSize: js.UndefOr[BackgroundSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var MozBorderBottomColors: js.UndefOr[MozBorderBottomColorsProperty] = js.undefined
  ...
  /**
    ...
    */
  var MozBorderEndWidth: js.UndefOr[BorderInlineEndWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var MozBorderLeftColors: js.UndefOr[MozBorderLeftColorsProperty] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozBorderRadius: js.UndefOr[BorderRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozBorderRadiusBottomleft: js.UndefOr[BorderBottomLeftRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozBorderRadiusBottomright: js.UndefOr[BorderBottomRightRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozBorderRadiusTopleft: js.UndefOr[BorderTopLeftRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozBorderRadiusTopright: js.UndefOr[BorderTopRightRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var MozBorderRightColors: js.UndefOr[MozBorderRightColorsProperty] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var MozBorderTopColors: js.UndefOr[MozBorderTopColorsProperty] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `normal`
    */
  var MozColumnGap: js.UndefOr[ColumnGapProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var MozColumnRule: js.UndefOr[ColumnRuleProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `medium`
    */
  var MozColumnRuleWidth: js.UndefOr[ColumnRuleWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var MozColumnWidth: js.UndefOr[ColumnWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var MozColumns: js.UndefOr[ColumnsProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var MozOsxFontSmoothing: js.UndefOr[FontSmoothProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozOutlineRadius: js.UndefOr[MozOutlineRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozOutlineRadiusBottomleft: js.UndefOr[MozOutlineRadiusBottomleftProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozOutlineRadiusBottomright: js.UndefOr[MozOutlineRadiusBottomrightProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozOutlineRadiusTopleft: js.UndefOr[MozOutlineRadiusTopleftProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozOutlineRadiusTopright: js.UndefOr[MozOutlineRadiusToprightProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozOutlineWidth: js.UndefOr[OutlineWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var MozPaddingEnd: js.UndefOr[PaddingInlineEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var MozPaddingStart: js.UndefOr[PaddingInlineStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var MozPerspective: js.UndefOr[PerspectiveProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `50% 50%`
    */
  var MozPerspectiveOrigin: js.UndefOr[PerspectiveOriginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `8`
    */
  var MozTabSize: js.UndefOr[TabSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var MozTextBlink: js.UndefOr[MozTextBlinkProperty] = js.undefined
  ...
  /**
    ...
    */
  var MozTransformOrigin: js.UndefOr[TransformOriginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var OBackgroundSize: js.UndefOr[BackgroundSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `50% 50%`
    */
  var OObjectPosition: js.UndefOr[ObjectPositionProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `8`
    */
  var OTabSize: js.UndefOr[TabSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `50% 50% 0`
    */
  var OTransformOrigin: js.UndefOr[TransformOriginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto auto`
    */
  var WebkitBackgroundSize: js.UndefOr[BackgroundSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var WebkitBorderBefore: js.UndefOr[WebkitBorderBeforeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `medium`
    */
  var WebkitBorderBeforeWidth: js.UndefOr[WebkitBorderBeforeWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitBorderBottomLeftRadius: js.UndefOr[BorderBottomLeftRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitBorderBottomRightRadius: js.UndefOr[BorderBottomRightRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Syntax**: `<length-percentage>{1,4} [ / <length-percentage>{1,4} ]?`
    */
  var WebkitBorderRadius: js.UndefOr[BorderRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitBorderTopLeftRadius: js.UndefOr[BorderTopLeftRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitBorderTopRightRadius: js.UndefOr[BorderTopRightRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var WebkitBoxReflect: js.UndefOr[WebkitBoxReflectProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `normal`
    */
  var WebkitColumnGap: js.UndefOr[ColumnGapProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Syntax**: `<'column-rule-width'> || <'column-rule-style'> || <'column-rule-color'>`
    */
  var WebkitColumnRule: js.UndefOr[ColumnRuleProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `medium`
    */
  var WebkitColumnRuleWidth: js.UndefOr[ColumnRuleWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var WebkitColumnWidth: js.UndefOr[ColumnWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Syntax**: `<'column-width'> || <'column-count'>`
    */
  var WebkitColumns: js.UndefOr[ColumnsProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var WebkitFlex: js.UndefOr[FlexProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var WebkitFlexBasis: js.UndefOr[FlexBasisProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var WebkitFontSmoothing: js.UndefOr[FontSmoothProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitMarginEnd: js.UndefOr[MarginInlineEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitMarginStart: js.UndefOr[MarginInlineStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var WebkitMask: js.UndefOr[WebkitMaskProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0% 0%`
    */
  var WebkitMaskPosition: js.UndefOr[WebkitMaskPositionProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0%`
    */
  var WebkitMaskPositionX: js.UndefOr[WebkitMaskPositionXProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0%`
    */
  var WebkitMaskPositionY: js.UndefOr[WebkitMaskPositionYProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto auto`
    */
  var WebkitMaskSize: js.UndefOr[WebkitMaskSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitMaxInlineSize: js.UndefOr[MaxInlineSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitPaddingEnd: js.UndefOr[PaddingInlineEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitPaddingStart: js.UndefOr[PaddingInlineStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var WebkitPerspective: js.UndefOr[PerspectiveProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `50% 50%`
    */
  var WebkitPerspectiveOrigin: js.UndefOr[PerspectiveOriginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var WebkitPrintColorAdjust: js.UndefOr[ColorAdjustProperty] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `over`
    */
  var WebkitRubyPosition: js.UndefOr[RubyPositionProperty] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitShapeMargin: js.UndefOr[ShapeMarginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Syntax**: `<length> || <color>`
    */
  var WebkitTextStroke: js.UndefOr[WebkitTextStrokeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitTextStrokeWidth: js.UndefOr[WebkitTextStrokeWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var WebkitTextUnderlinePosition: js.UndefOr[TextUnderlinePositionProperty] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `50% 50% 0`
    */
  var WebkitTransformOrigin: js.UndefOr[TransformOriginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var backgroundPositionX: js.UndefOr[BackgroundPositionXProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var backgroundPositionY: js.UndefOr[BackgroundPositionYProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var blockSize: js.UndefOr[BlockSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderBlock: js.UndefOr[BorderBlockProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderBlockEnd: js.UndefOr[BorderBlockEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderBlockEndWidth: js.UndefOr[BorderBlockEndWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderBlockStart: js.UndefOr[BorderBlockStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderBlockStartWidth: js.UndefOr[BorderBlockStartWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderBlockWidth: js.UndefOr[BorderBlockWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderBottom: js.UndefOr[BorderBottomProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderBottomLeftRadius: js.UndefOr[BorderBottomLeftRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderBottomRightRadius: js.UndefOr[BorderBottomRightRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderBottomWidth: js.UndefOr[BorderBottomWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderEndEndRadius: js.UndefOr[BorderEndEndRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderEndStartRadius: js.UndefOr[BorderEndStartRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderImageOutset: js.UndefOr[BorderImageOutsetProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderImageWidth: js.UndefOr[BorderImageWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderInline: js.UndefOr[BorderInlineProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderInlineEnd: js.UndefOr[BorderInlineEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderInlineEndWidth: js.UndefOr[BorderInlineEndWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderInlineStart: js.UndefOr[BorderInlineStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderInlineStartWidth: js.UndefOr[BorderInlineStartWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderInlineWidth: js.UndefOr[BorderInlineWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderLeft: js.UndefOr[BorderLeftProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderLeftWidth: js.UndefOr[BorderLeftWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderRight: js.UndefOr[BorderRightProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderRightWidth: js.UndefOr[BorderRightWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderSpacing: js.UndefOr[BorderSpacingProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderStartEndRadius: js.UndefOr[BorderStartEndRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderStartStartRadius: js.UndefOr[BorderStartStartRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderTop: js.UndefOr[BorderTopProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderTopLeftRadius: js.UndefOr[BorderTopLeftRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderTopRightRadius: js.UndefOr[BorderTopRightRadiusProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderTopWidth: js.UndefOr[BorderTopWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var borderWidth: js.UndefOr[BorderWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var bottom: js.UndefOr[BottomProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var columnGap: js.UndefOr[ColumnGapProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var columnRule: js.UndefOr[ColumnRuleProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var columnRuleWidth: js.UndefOr[ColumnRuleWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var columnWidth: js.UndefOr[ColumnWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var columns: js.UndefOr[ColumnsProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var flex: js.UndefOr[FlexProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var flexBasis: js.UndefOr[FlexBasisProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var fontSize: js.UndefOr[FontSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var fontSmooth: js.UndefOr[FontSmoothProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var gridAutoColumns: js.UndefOr[GridAutoColumnsProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var gridAutoRows: js.UndefOr[GridAutoRowsProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var gridColumnGap: js.UndefOr[GridColumnGapProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var gridGap: js.UndefOr[GridGapProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var gridRowGap: js.UndefOr[GridRowGapProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var gridTemplateColumns: js.UndefOr[GridTemplateColumnsProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var gridTemplateRows: js.UndefOr[GridTemplateRowsProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var inlineSize: js.UndefOr[InlineSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var inset: js.UndefOr[InsetProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var insetBlock: js.UndefOr[InsetBlockProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var insetBlockEnd: js.UndefOr[InsetBlockEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var insetBlockStart: js.UndefOr[InsetBlockStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var insetInline: js.UndefOr[InsetInlineProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var insetInlineEnd: js.UndefOr[InsetInlineEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var insetInlineStart: js.UndefOr[InsetInlineStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var left: js.UndefOr[LeftProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var letterSpacing: js.UndefOr[LetterSpacingProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var lineHeight: js.UndefOr[LineHeightProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var lineHeightStep: js.UndefOr[LineHeightStepProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var margin: js.UndefOr[MarginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var marginBlock: js.UndefOr[MarginBlockProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var marginBlockEnd: js.UndefOr[MarginBlockEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var marginBlockStart: js.UndefOr[MarginBlockStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var marginBottom: js.UndefOr[MarginBottomProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var marginInline: js.UndefOr[MarginInlineProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var marginInlineEnd: js.UndefOr[MarginInlineEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var marginInlineStart: js.UndefOr[MarginInlineStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var marginLeft: js.UndefOr[MarginLeftProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var marginRight: js.UndefOr[MarginRightProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var marginTop: js.UndefOr[MarginTopProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var mask: js.UndefOr[MaskProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var maskBorderOutset: js.UndefOr[MaskBorderOutsetProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var maskBorderWidth: js.UndefOr[MaskBorderWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var maskPosition: js.UndefOr[MaskPositionProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var maskSize: js.UndefOr[MaskSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var maxBlockSize: js.UndefOr[MaxBlockSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var maxInlineSize: js.UndefOr[MaxInlineSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var minBlockSize: js.UndefOr[MinBlockSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var minHeight: js.UndefOr[MinHeightProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var minInlineSize: js.UndefOr[MinInlineSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var motion: js.UndefOr[OffsetProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var motionDistance: js.UndefOr[OffsetDistanceProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Syntax**: `none | [ <'flex-grow'> <'flex-shrink'>? || <'flex-basis'> ]`
    */
  var msFlex: js.UndefOr[FlexProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var msGridColumns: js.UndefOr[MsGridColumnsProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var msGridRows: js.UndefOr[MsGridRowsProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var msHyphenateLimitZone: js.UndefOr[MsHyphenateLimitZoneProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var msJustifySelf: js.UndefOr[JustifySelfProperty] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var msScrollLimitXMax: js.UndefOr[MsScrollLimitXMaxProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var msScrollLimitXMin: js.UndefOr[MsScrollLimitXMinProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var msScrollLimitYMax: js.UndefOr[MsScrollLimitYMaxProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var msScrollLimitYMin: js.UndefOr[MsScrollLimitYMinProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `50% 50% 0`
    */
  var msTransformOrigin: js.UndefOr[TransformOriginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var msWrapMargin: js.UndefOr[MsWrapMarginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var objectPosition: js.UndefOr[ObjectPositionProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @see https://developer.mozilla.org/docs/Web/CSS/offset
    */
  var offset: js.UndefOr[OffsetProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var offsetAnchor: js.UndefOr[OffsetAnchorProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var offsetBlock: js.UndefOr[InsetBlockProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var offsetBlockEnd: js.UndefOr[InsetBlockEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var offsetBlockStart: js.UndefOr[InsetBlockStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @see https://developer.mozilla.org/docs/Web/CSS/offset-distance
    */
  var offsetDistance: js.UndefOr[OffsetDistanceProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var offsetInline: js.UndefOr[InsetInlineProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var outlineOffset: js.UndefOr[OutlineOffsetProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var outlineWidth: js.UndefOr[OutlineWidthProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var paddingBlock: js.UndefOr[PaddingBlockProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var paddingBlockEnd: js.UndefOr[PaddingBlockEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var paddingBlockStart: js.UndefOr[PaddingBlockStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var paddingBottom: js.UndefOr[PaddingBottomProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var paddingInline: js.UndefOr[PaddingInlineProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var paddingInlineEnd: js.UndefOr[PaddingInlineEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var paddingInlineStart: js.UndefOr[PaddingInlineStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var paddingLeft: js.UndefOr[PaddingLeftProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var paddingRight: js.UndefOr[PaddingRightProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var paddingTop: js.UndefOr[PaddingTopProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var perspective: js.UndefOr[PerspectiveProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var perspectiveOrigin: js.UndefOr[PerspectiveOriginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var right: js.UndefOr[RightProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var rowGap: js.UndefOr[RowGapProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollMargin: js.UndefOr[ScrollMarginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollMarginBlock: js.UndefOr[ScrollMarginBlockProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollMarginBlockEnd: js.UndefOr[ScrollMarginBlockEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollMarginBlockStart: js.UndefOr[ScrollMarginBlockStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollMarginBottom: js.UndefOr[ScrollMarginBottomProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollMarginInline: js.UndefOr[ScrollMarginInlineProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollMarginInlineEnd: js.UndefOr[ScrollMarginInlineEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollMarginInlineStart: js.UndefOr[ScrollMarginInlineStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollMarginLeft: js.UndefOr[ScrollMarginLeftProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollMarginRight: js.UndefOr[ScrollMarginRightProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollMarginTop: js.UndefOr[ScrollMarginTopProperty[String | Double]] = js.undefined
  ...
  The scroll-padding properties define offsets for the optimal viewing region of the scrollport: the region used as the target region for placing things in view of the user. This allows the author to exclude regions of the scrollport that are obscured by other content (such as fixed-positioned toolbars or sidebars) or simply to put more breathing room between a targetted element and the edges of the scrollport.
    ...
    */
  var scrollPadding: js.UndefOr[ScrollPaddingProperty[String | Double]] = js.undefined
  ...
  The scroll-padding properties define offsets for the optimal viewing region of the scrollport: the region used as the target region for placing things in view of the user. This allows the author to exclude regions of the scrollport that are obscured by other content (such as fixed-positioned toolbars or sidebars) or simply to put more breathing room between a targetted element and the edges of the scrollport.
    ...
    */
  var scrollPaddingBlock: js.UndefOr[ScrollPaddingBlockProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollPaddingBlockEnd: js.UndefOr[ScrollPaddingBlockEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollPaddingBlockStart: js.UndefOr[ScrollPaddingBlockStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollPaddingBottom: js.UndefOr[ScrollPaddingBottomProperty[String | Double]] = js.undefined
  ...
  The scroll-padding properties define offsets for the optimal viewing region of the scrollport: the region used as the target region for placing things in view of the user. This allows the author to exclude regions of the scrollport that are obscured by other content (such as fixed-positioned toolbars or sidebars) or simply to put more breathing room between a targetted element and the edges of the scrollport.
    ...
    */
  var scrollPaddingInline: js.UndefOr[ScrollPaddingInlineProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollPaddingInlineEnd: js.UndefOr[ScrollPaddingInlineEndProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollPaddingInlineStart: js.UndefOr[ScrollPaddingInlineStartProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollPaddingLeft: js.UndefOr[ScrollPaddingLeftProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollPaddingRight: js.UndefOr[ScrollPaddingRightProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var scrollPaddingTop: js.UndefOr[ScrollPaddingTopProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var scrollSnapCoordinate: js.UndefOr[ScrollSnapCoordinateProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var scrollSnapDestination: js.UndefOr[ScrollSnapDestinationProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @see https://developer.mozilla.org/docs/Web/CSS/scroll-margin
    */
  var scrollSnapMargin: js.UndefOr[ScrollMarginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @see https://developer.mozilla.org/docs/Web/CSS/scroll-margin-bottom
    */
  var scrollSnapMarginBottom: js.UndefOr[ScrollMarginBottomProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @see https://developer.mozilla.org/docs/Web/CSS/scroll-margin-left
    */
  var scrollSnapMarginLeft: js.UndefOr[ScrollMarginLeftProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @see https://developer.mozilla.org/docs/Web/CSS/scroll-margin-right
    */
  var scrollSnapMarginRight: js.UndefOr[ScrollMarginRightProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    * @see https://developer.mozilla.org/docs/Web/CSS/scroll-margin-top
    */
  var scrollSnapMarginTop: js.UndefOr[ScrollMarginTopProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var tabSize: js.UndefOr[TabSizeProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var textIndent: js.UndefOr[TextIndentProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var transformOrigin: js.UndefOr[TransformOriginProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var translate: js.UndefOr[TranslateProperty[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var wordSpacing: js.UndefOr[WordSpacingProperty[String | Double]] = js.undefined
...
object CSSPropertieslineCSSPrope {
  
  inline def apply(): CSSPropertieslineCSSPrope = {
  ...
  extension [Self <: CSSPropertieslineCSSPrope](x: Self) {
    ...
    inline def setBackground(value: BackgroundProperty[String | Double]): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    ...
    inline def setBackgroundPosition(value: BackgroundPositionProperty[String | Double]): Self = StObject.set(x, "backgroundPosition", value.asInstanceOf[js.Any])
    
    inline def setBackgroundPositionUndefined: Self = StObject.set(x, "backgroundPosition", js.undefined)
    
    inline def setBackgroundPositionX(value: BackgroundPositionXProperty[String | Double]): Self = StObject.set(x, "backgroundPositionX", value.asInstanceOf[js.Any])
    
    inline def setBackgroundPositionXUndefined: Self = StObject.set(x, "backgroundPositionX", js.undefined)
    
    inline def setBackgroundPositionY(value: BackgroundPositionYProperty[String | Double]): Self = StObject.set(x, "backgroundPositionY", value.asInstanceOf[js.Any])
    ...
    inline def setBaselineShift(value: BaselineShiftProperty[String | Double]): Self = StObject.set(x, "baselineShift", value.asInstanceOf[js.Any])
    ...
    inline def setBlockSize(value: BlockSizeProperty[String | Double]): Self = StObject.set(x, "blockSize", value.asInstanceOf[js.Any])
    ...
    inline def setBorderBlock(value: BorderBlockProperty[String | Double]): Self = StObject.set(x, "borderBlock", value.asInstanceOf[js.Any])
    ...
    inline def setBorderBlockEnd(value: BorderBlockEndProperty[String | Double]): Self = StObject.set(x, "borderBlockEnd", value.asInstanceOf[js.Any])
    ...
    inline def setBorderBlockEndWidth(value: BorderBlockEndWidthProperty[String | Double]): Self = StObject.set(x, "borderBlockEndWidth", value.asInstanceOf[js.Any])
    
    inline def setBorderBlockEndWidthUndefined: Self = StObject.set(x, "borderBlockEndWidth", js.undefined)
    
    inline def setBorderBlockStart(value: BorderBlockStartProperty[String | Double]): Self = StObject.set(x, "borderBlockStart", value.asInstanceOf[js.Any])
    ...
    inline def setBorderBlockStartWidth(value: BorderBlockStartWidthProperty[String | Double]): Self = StObject.set(x, "borderBlockStartWidth", value.asInstanceOf[js.Any])
    ...
    inline def setBorderBlockWidth(value: BorderBlockWidthProperty[String | Double]): Self = StObject.set(x, "borderBlockWidth", value.asInstanceOf[js.Any])
    
    inline def setBorderBlockWidthUndefined: Self = StObject.set(x, "borderBlockWidth", js.undefined)
    
    inline def setBorderBottom(value: BorderBottomProperty[String | Double]): Self = StObject.set(x, "borderBottom", value.asInstanceOf[js.Any])
    ...
    inline def setBorderBottomLeftRadius(value: BorderBottomLeftRadiusProperty[String | Double]): Self = StObject.set(x, "borderBottomLeftRadius", value.asInstanceOf[js.Any])
    
    inline def setBorderBottomLeftRadiusUndefined: Self = StObject.set(x, "borderBottomLeftRadius", js.undefined)
    
    inline def setBorderBottomRightRadius(value: BorderBottomRightRadiusProperty[String | Double]): Self = StObject.set(x, "borderBottomRightRadius", value.asInstanceOf[js.Any])
    ...
    inline def setBorderBottomWidth(value: BorderBottomWidthProperty[String | Double]): Self = StObject.set(x, "borderBottomWidth", value.asInstanceOf[js.Any])
    ...
    inline def setBorderEndEndRadius(value: BorderEndEndRadiusProperty[String | Double]): Self = StObject.set(x, "borderEndEndRadius", value.asInstanceOf[js.Any])
    
    inline def setBorderEndEndRadiusUndefined: Self = StObject.set(x, "borderEndEndRadius", js.undefined)
    
    inline def setBorderEndStartRadius(value: BorderEndStartRadiusProperty[String | Double]): Self = StObject.set(x, "borderEndStartRadius", value.asInstanceOf[js.Any])
    ...
    inline def setBorderImageOutset(value: BorderImageOutsetProperty[String | Double]): Self = StObject.set(x, "borderImageOutset", value.asInstanceOf[js.Any])
    ...
    inline def setBorderImageWidth(value: BorderImageWidthProperty[String | Double]): Self = StObject.set(x, "borderImageWidth", value.asInstanceOf[js.Any])
    
    inline def setBorderImageWidthUndefined: Self = StObject.set(x, "borderImageWidth", js.undefined)
    
    inline def setBorderInline(value: BorderInlineProperty[String | Double]): Self = StObject.set(x, "borderInline", value.asInstanceOf[js.Any])
    ...
    inline def setBorderInlineEnd(value: BorderInlineEndProperty[String | Double]): Self = StObject.set(x, "borderInlineEnd", value.asInstanceOf[js.Any])
    ...
    inline def setBorderInlineEndWidth(value: BorderInlineEndWidthProperty[String | Double]): Self = StObject.set(x, "borderInlineEndWidth", value.asInstanceOf[js.Any])
    
    inline def setBorderInlineEndWidthUndefined: Self = StObject.set(x, "borderInlineEndWidth", js.undefined)
    
    inline def setBorderInlineStart(value: BorderInlineStartProperty[String | Double]): Self = StObject.set(x, "borderInlineStart", value.asInstanceOf[js.Any])
    ...
    inline def setBorderInlineStartWidth(value: BorderInlineStartWidthProperty[String | Double]): Self = StObject.set(x, "borderInlineStartWidth", value.asInstanceOf[js.Any])
    ...
    inline def setBorderInlineWidth(value: BorderInlineWidthProperty[String | Double]): Self = StObject.set(x, "borderInlineWidth", value.asInstanceOf[js.Any])
    
    inline def setBorderInlineWidthUndefined: Self = StObject.set(x, "borderInlineWidth", js.undefined)
    
    inline def setBorderLeft(value: BorderLeftProperty[String | Double]): Self = StObject.set(x, "borderLeft", value.asInstanceOf[js.Any])
    ...
    inline def setBorderLeftWidth(value: BorderLeftWidthProperty[String | Double]): Self = StObject.set(x, "borderLeftWidth", value.asInstanceOf[js.Any])
    ...
    inline def setBorderRight(value: BorderRightProperty[String | Double]): Self = StObject.set(x, "borderRight", value.asInstanceOf[js.Any])
    ...
    inline def setBorderRightWidth(value: BorderRightWidthProperty[String | Double]): Self = StObject.set(x, "borderRightWidth", value.asInstanceOf[js.Any])
    
    inline def setBorderRightWidthUndefined: Self = StObject.set(x, "borderRightWidth", js.undefined)
    
    inline def setBorderSpacing(value: BorderSpacingProperty[String | Double]): Self = StObject.set(x, "borderSpacing", value.asInstanceOf[js.Any])
    
    inline def setBorderSpacingUndefined: Self = StObject.set(x, "borderSpacing", js.undefined)
    
    inline def setBorderStartEndRadius(value: BorderStartEndRadiusProperty[String | Double]): Self = StObject.set(x, "borderStartEndRadius", value.asInstanceOf[js.Any])
    
    inline def setBorderStartEndRadiusUndefined: Self = StObject.set(x, "borderStartEndRadius", js.undefined)
    
    inline def setBorderStartStartRadius(value: BorderStartStartRadiusProperty[String | Double]): Self = StObject.set(x, "borderStartStartRadius", value.asInstanceOf[js.Any])
    ...
    inline def setBorderTop(value: BorderTopProperty[String | Double]): Self = StObject.set(x, "borderTop", value.asInstanceOf[js.Any])
    ...
    inline def setBorderTopLeftRadius(value: BorderTopLeftRadiusProperty[String | Double]): Self = StObject.set(x, "borderTopLeftRadius", value.asInstanceOf[js.Any])
    
    inline def setBorderTopLeftRadiusUndefined: Self = StObject.set(x, "borderTopLeftRadius", js.undefined)
    
    inline def setBorderTopRightRadius(value: BorderTopRightRadiusProperty[String | Double]): Self = StObject.set(x, "borderTopRightRadius", value.asInstanceOf[js.Any])
    ...
    inline def setBorderTopWidth(value: BorderTopWidthProperty[String | Double]): Self = StObject.set(x, "borderTopWidth", value.asInstanceOf[js.Any])
    
    inline def setBorderTopWidthUndefined: Self = StObject.set(x, "borderTopWidth", js.undefined)
    
    inline def setBorderUndefined: Self = StObject.set(x, "border", js.undefined)
    
    inline def setBorderWidth(value: BorderWidthProperty[String | Double]): Self = StObject.set(x, "borderWidth", value.asInstanceOf[js.Any])
    
    inline def setBorderWidthUndefined: Self = StObject.set(x, "borderWidth", js.undefined)
    
    inline def setBottom(value: BottomProperty[String | Double]): Self = StObject.set(x, "bottom", value.asInstanceOf[js.Any])
    ...
    inline def setColumnGap(value: ColumnGapProperty[String | Double]): Self = StObject.set(x, "columnGap", value.asInstanceOf[js.Any])
    
    inline def setColumnGapUndefined: Self = StObject.set(x, "columnGap", js.undefined)
    
    inline def setColumnRule(value: ColumnRuleProperty[String | Double]): Self = StObject.set(x, "columnRule", value.asInstanceOf[js.Any])
    ...
    inline def setColumnRuleWidth(value: ColumnRuleWidthProperty[String | Double]): Self = StObject.set(x, "columnRuleWidth", value.asInstanceOf[js.Any])
    ...
    inline def setColumnWidth(value: ColumnWidthProperty[String | Double]): Self = StObject.set(x, "columnWidth", value.asInstanceOf[js.Any])
    
    inline def setColumnWidthUndefined: Self = StObject.set(x, "columnWidth", js.undefined)
    
    inline def setColumns(value: ColumnsProperty[String | Double]): Self = StObject.set(x, "columns", value.asInstanceOf[js.Any])
    ...
    inline def setFlex(value: FlexProperty[String | Double]): Self = StObject.set(x, "flex", value.asInstanceOf[js.Any])
    
    inline def setFlexBasis(value: FlexBasisProperty[String | Double]): Self = StObject.set(x, "flexBasis", value.asInstanceOf[js.Any])
    ...
    inline def setFontSize(value: FontSizeProperty[String | Double]): Self = StObject.set(x, "fontSize", value.asInstanceOf[js.Any])
    ...
    inline def setFontSmooth(value: FontSmoothProperty[String | Double]): Self = StObject.set(x, "fontSmooth", value.asInstanceOf[js.Any])
    ...
    inline def setGridAutoColumns(value: GridAutoColumnsProperty[String | Double]): Self = StObject.set(x, "gridAutoColumns", value.asInstanceOf[js.Any])
    ...
    inline def setGridAutoRows(value: GridAutoRowsProperty[String | Double]): Self = StObject.set(x, "gridAutoRows", value.asInstanceOf[js.Any])
    ...
    inline def setGridColumnGap(value: GridColumnGapProperty[String | Double]): Self = StObject.set(x, "gridColumnGap", value.asInstanceOf[js.Any])
    ...
    inline def setGridGap(value: GridGapProperty[String | Double]): Self = StObject.set(x, "gridGap", value.asInstanceOf[js.Any])
    ...
    inline def setGridRowGap(value: GridRowGapProperty[String | Double]): Self = StObject.set(x, "gridRowGap", value.asInstanceOf[js.Any])
    ...
    inline def setGridTemplateColumns(value: GridTemplateColumnsProperty[String | Double]): Self = StObject.set(x, "gridTemplateColumns", value.asInstanceOf[js.Any])
    
    inline def setGridTemplateColumnsUndefined: Self = StObject.set(x, "gridTemplateColumns", js.undefined)
    
    inline def setGridTemplateRows(value: GridTemplateRowsProperty[String | Double]): Self = StObject.set(x, "gridTemplateRows", value.asInstanceOf[js.Any])
    ...
    inline def setHeight(value: HeightProperty[String | Double]): Self = StObject.set(x, "height", value.asInstanceOf[js.Any])
    ...
    inline def setInlineSize(value: InlineSizeProperty[String | Double]): Self = StObject.set(x, "inlineSize", value.asInstanceOf[js.Any])
    
    inline def setInlineSizeUndefined: Self = StObject.set(x, "inlineSize", js.undefined)
    
    inline def setInset(value: InsetProperty[String | Double]): Self = StObject.set(x, "inset", value.asInstanceOf[js.Any])
    
    inline def setInsetBlock(value: InsetBlockProperty[String | Double]): Self = StObject.set(x, "insetBlock", value.asInstanceOf[js.Any])
    
    inline def setInsetBlockEnd(value: InsetBlockEndProperty[String | Double]): Self = StObject.set(x, "insetBlockEnd", value.asInstanceOf[js.Any])
    
    inline def setInsetBlockEndUndefined: Self = StObject.set(x, "insetBlockEnd", js.undefined)
    
    inline def setInsetBlockStart(value: InsetBlockStartProperty[String | Double]): Self = StObject.set(x, "insetBlockStart", value.asInstanceOf[js.Any])
    ...
    inline def setInsetInline(value: InsetInlineProperty[String | Double]): Self = StObject.set(x, "insetInline", value.asInstanceOf[js.Any])
    
    inline def setInsetInlineEnd(value: InsetInlineEndProperty[String | Double]): Self = StObject.set(x, "insetInlineEnd", value.asInstanceOf[js.Any])
    
    inline def setInsetInlineEndUndefined: Self = StObject.set(x, "insetInlineEnd", js.undefined)
    
    inline def setInsetInlineStart(value: InsetInlineStartProperty[String | Double]): Self = StObject.set(x, "insetInlineStart", value.asInstanceOf[js.Any])
    ...
    inline def setLeft(value: LeftProperty[String | Double]): Self = StObject.set(x, "left", value.asInstanceOf[js.Any])
    
    inline def setLeftUndefined: Self = StObject.set(x, "left", js.undefined)
    
    inline def setLetterSpacing(value: LetterSpacingProperty[String | Double]): Self = StObject.set(x, "letterSpacing", value.asInstanceOf[js.Any])
    ...
    inline def setLineHeight(value: LineHeightProperty[String | Double]): Self = StObject.set(x, "lineHeight", value.asInstanceOf[js.Any])
    
    inline def setLineHeightStep(value: LineHeightStepProperty[String | Double]): Self = StObject.set(x, "lineHeightStep", value.asInstanceOf[js.Any])
    ...
    inline def setMargin(value: MarginProperty[String | Double]): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
    
    inline def setMarginBlock(value: MarginBlockProperty[String | Double]): Self = StObject.set(x, "marginBlock", value.asInstanceOf[js.Any])
    
    inline def setMarginBlockEnd(value: MarginBlockEndProperty[String | Double]): Self = StObject.set(x, "marginBlockEnd", value.asInstanceOf[js.Any])
    
    inline def setMarginBlockEndUndefined: Self = StObject.set(x, "marginBlockEnd", js.undefined)
    
    inline def setMarginBlockStart(value: MarginBlockStartProperty[String | Double]): Self = StObject.set(x, "marginBlockStart", value.asInstanceOf[js.Any])
    ...
    inline def setMarginBottom(value: MarginBottomProperty[String | Double]): Self = StObject.set(x, "marginBottom", value.asInstanceOf[js.Any])
    
    inline def setMarginBottomUndefined: Self = StObject.set(x, "marginBottom", js.undefined)
    
    inline def setMarginInline(value: MarginInlineProperty[String | Double]): Self = StObject.set(x, "marginInline", value.asInstanceOf[js.Any])
    
    inline def setMarginInlineEnd(value: MarginInlineEndProperty[String | Double]): Self = StObject.set(x, "marginInlineEnd", value.asInstanceOf[js.Any])
    
    inline def setMarginInlineEndUndefined: Self = StObject.set(x, "marginInlineEnd", js.undefined)
    
    inline def setMarginInlineStart(value: MarginInlineStartProperty[String | Double]): Self = StObject.set(x, "marginInlineStart", value.asInstanceOf[js.Any])
    ...
    inline def setMarginLeft(value: MarginLeftProperty[String | Double]): Self = StObject.set(x, "marginLeft", value.asInstanceOf[js.Any])
    
    inline def setMarginLeftUndefined: Self = StObject.set(x, "marginLeft", js.undefined)
    
    inline def setMarginRight(value: MarginRightProperty[String | Double]): Self = StObject.set(x, "marginRight", value.asInstanceOf[js.Any])
    
    inline def setMarginRightUndefined: Self = StObject.set(x, "marginRight", js.undefined)
    
    inline def setMarginTop(value: MarginTopProperty[String | Double]): Self = StObject.set(x, "marginTop", value.asInstanceOf[js.Any])
    ...
    inline def setMask(value: MaskProperty[String | Double]): Self = StObject.set(x, "mask", value.asInstanceOf[js.Any])
    ...
    inline def setMaskBorderOutset(value: MaskBorderOutsetProperty[String | Double]): Self = StObject.set(x, "maskBorderOutset", value.asInstanceOf[js.Any])
    ...
    inline def setMaskBorderWidth(value: MaskBorderWidthProperty[String | Double]): Self = StObject.set(x, "maskBorderWidth", value.asInstanceOf[js.Any])
    ...
    inline def setMaskPosition(value: MaskPositionProperty[String | Double]): Self = StObject.set(x, "maskPosition", value.asInstanceOf[js.Any])
    ...
    inline def setMaskSize(value: MaskSizeProperty[String | Double]): Self = StObject.set(x, "maskSize", value.asInstanceOf[js.Any])
    ...
    inline def setMaxBlockSize(value: MaxBlockSizeProperty[String | Double]): Self = StObject.set(x, "maxBlockSize", value.asInstanceOf[js.Any])
    
    inline def setMaxBlockSizeUndefined: Self = StObject.set(x, "maxBlockSize", js.undefined)
    
    inline def setMaxHeight(value: MaxHeightProperty[String | Double]): Self = StObject.set(x, "maxHeight", value.asInstanceOf[js.Any])
    
    inline def setMaxHeightUndefined: Self = StObject.set(x, "maxHeight", js.undefined)
    
    inline def setMaxInlineSize(value: MaxInlineSizeProperty[String | Double]): Self = StObject.set(x, "maxInlineSize", value.asInstanceOf[js.Any])
    ...
    inline def setMinBlockSize(value: MinBlockSizeProperty[String | Double]): Self = StObject.set(x, "minBlockSize", value.asInstanceOf[js.Any])
    
    inline def setMinBlockSizeUndefined: Self = StObject.set(x, "minBlockSize", js.undefined)
    
    inline def setMinHeight(value: MinHeightProperty[String | Double]): Self = StObject.set(x, "minHeight", value.asInstanceOf[js.Any])
    
    inline def setMinHeightUndefined: Self = StObject.set(x, "minHeight", js.undefined)
    
    inline def setMinInlineSize(value: MinInlineSizeProperty[String | Double]): Self = StObject.set(x, "minInlineSize", value.asInstanceOf[js.Any])
    ...
    inline def setMotion(value: OffsetProperty[String | Double]): Self = StObject.set(x, "motion", value.asInstanceOf[js.Any])
    
    inline def setMotionDistance(value: OffsetDistanceProperty[String | Double]): Self = StObject.set(x, "motionDistance", value.asInstanceOf[js.Any])
    ...
    inline def setMozAnimation(value: AnimationProperty): Self = StObject.set(x, "MozAnimation", value.asInstanceOf[js.Any])
    
    inline def setMozAnimationDelay(value: GlobalsString): Self = StObject.set(x, "MozAnimationDelay", value.asInstanceOf[js.Any])
    
    inline def setMozAnimationDelayUndefined: Self = StObject.set(x, "MozAnimationDelay", js.undefined)
    
    inline def setMozAnimationDirection(value: AnimationDirectionProperty): Self = StObject.set(x, "MozAnimationDirection", value.asInstanceOf[js.Any])
    
    inline def setMozAnimationDirectionUndefined: Self = StObject.set(x, "MozAnimationDirection", js.undefined)
    
    inline def setMozAnimationDuration(value: GlobalsString): Self = StObject.set(x, "MozAnimationDuration", value.asInstanceOf[js.Any])
    
    inline def setMozAnimationDurationUndefined: Self = StObject.set(x, "MozAnimationDuration", js.undefined)
    
    inline def setMozAnimationFillMode(value: AnimationFillModeProperty): Self = StObject.set(x, "MozAnimationFillMode", value.asInstanceOf[js.Any])
    
    inline def setMozAnimationFillModeUndefined: Self = StObject.set(x, "MozAnimationFillMode", js.undefined)
    
    inline def setMozAnimationIterationCount(value: AnimationIterationCountProperty): Self = StObject.set(x, "MozAnimationIterationCount", value.asInstanceOf[js.Any])
    
    inline def setMozAnimationIterationCountUndefined: Self = StObject.set(x, "MozAnimationIterationCount", js.undefined)
    
    inline def setMozAnimationName(value: AnimationNameProperty): Self = StObject.set(x, "MozAnimationName", value.asInstanceOf[js.Any])
    
    inline def setMozAnimationNameUndefined: Self = StObject.set(x, "MozAnimationName", js.undefined)
    
    inline def setMozAnimationPlayState(value: AnimationPlayStateProperty): Self = StObject.set(x, "MozAnimationPlayState", value.asInstanceOf[js.Any])
    
    inline def setMozAnimationPlayStateUndefined: Self = StObject.set(x, "MozAnimationPlayState", js.undefined)
    
    inline def setMozAnimationTimingFunction(value: AnimationTimingFunctionProperty): Self = StObject.set(x, "MozAnimationTimingFunction", value.asInstanceOf[js.Any])
    ...
    inline def setMozAppearance(value: MozAppearanceProperty): Self = StObject.set(x, "MozAppearance", value.asInstanceOf[js.Any])
    
    inline def setMozAppearanceUndefined: Self = StObject.set(x, "MozAppearance", js.undefined)
    
    inline def setMozBackfaceVisibility(value: BackfaceVisibilityProperty): Self = StObject.set(x, "MozBackfaceVisibility", value.asInstanceOf[js.Any])
    ...
    inline def setMozBackgroundSize(value: BackgroundSizeProperty[String | Double]): Self = StObject.set(x, "MozBackgroundSize", value.asInstanceOf[js.Any])
    ...
    inline def setMozBorderBottomColors(value: MozBorderBottomColorsProperty): Self = StObject.set(x, "MozBorderBottomColors", value.asInstanceOf[js.Any])
    
    inline def setMozBorderBottomColorsUndefined: Self = StObject.set(x, "MozBorderBottomColors", js.undefined)
    
    inline def setMozBorderEndColor(value: BorderInlineEndColorProperty): Self = StObject.set(x, "MozBorderEndColor", value.asInstanceOf[js.Any])
    
    inline def setMozBorderEndColorUndefined: Self = StObject.set(x, "MozBorderEndColor", js.undefined)
    
    inline def setMozBorderEndStyle(value: BorderInlineEndStyleProperty): Self = StObject.set(x, "MozBorderEndStyle", value.asInstanceOf[js.Any])
    
    inline def setMozBorderEndStyleUndefined: Self = StObject.set(x, "MozBorderEndStyle", js.undefined)
    
    inline def setMozBorderEndWidth(value: BorderInlineEndWidthProperty[String | Double]): Self = StObject.set(x, "MozBorderEndWidth", value.asInstanceOf[js.Any])
    
    inline def setMozBorderEndWidthUndefined: Self = StObject.set(x, "MozBorderEndWidth", js.undefined)
    
    inline def setMozBorderImage(value: BorderImageProperty): Self = StObject.set(x, "MozBorderImage", value.asInstanceOf[js.Any])
    
    inline def setMozBorderImageUndefined: Self = StObject.set(x, "MozBorderImage", js.undefined)
    
    inline def setMozBorderLeftColors(value: MozBorderLeftColorsProperty): Self = StObject.set(x, "MozBorderLeftColors", value.asInstanceOf[js.Any])
    
    inline def setMozBorderLeftColorsUndefined: Self = StObject.set(x, "MozBorderLeftColors", js.undefined)
    
    inline def setMozBorderRadius(value: BorderRadiusProperty[String | Double]): Self = StObject.set(x, "MozBorderRadius", value.asInstanceOf[js.Any])
    
    inline def setMozBorderRadiusBottomleft(value: BorderBottomLeftRadiusProperty[String | Double]): Self = StObject.set(x, "MozBorderRadiusBottomleft", value.asInstanceOf[js.Any])
    
    inline def setMozBorderRadiusBottomleftUndefined: Self = StObject.set(x, "MozBorderRadiusBottomleft", js.undefined)
    
    inline def setMozBorderRadiusBottomright(value: BorderBottomRightRadiusProperty[String | Double]): Self = StObject.set(x, "MozBorderRadiusBottomright", value.asInstanceOf[js.Any])
    
    inline def setMozBorderRadiusBottomrightUndefined: Self = StObject.set(x, "MozBorderRadiusBottomright", js.undefined)
    
    inline def setMozBorderRadiusTopleft(value: BorderTopLeftRadiusProperty[String | Double]): Self = StObject.set(x, "MozBorderRadiusTopleft", value.asInstanceOf[js.Any])
    
    inline def setMozBorderRadiusTopleftUndefined: Self = StObject.set(x, "MozBorderRadiusTopleft", js.undefined)
    
    inline def setMozBorderRadiusTopright(value: BorderTopRightRadiusProperty[String | Double]): Self = StObject.set(x, "MozBorderRadiusTopright", value.asInstanceOf[js.Any])
    ...
    inline def setMozBorderRightColors(value: MozBorderRightColorsProperty): Self = StObject.set(x, "MozBorderRightColors", value.asInstanceOf[js.Any])
    
    inline def setMozBorderRightColorsUndefined: Self = StObject.set(x, "MozBorderRightColors", js.undefined)
    
    inline def setMozBorderStartColor(value: BorderInlineStartColorProperty): Self = StObject.set(x, "MozBorderStartColor", value.asInstanceOf[js.Any])
    
    inline def setMozBorderStartColorUndefined: Self = StObject.set(x, "MozBorderStartColor", js.undefined)
    
    inline def setMozBorderStartStyle(value: BorderInlineStartStyleProperty): Self = StObject.set(x, "MozBorderStartStyle", value.asInstanceOf[js.Any])
    
    inline def setMozBorderStartStyleUndefined: Self = StObject.set(x, "MozBorderStartStyle", js.undefined)
    
    inline def setMozBorderTopColors(value: MozBorderTopColorsProperty): Self = StObject.set(x, "MozBorderTopColors", value.asInstanceOf[js.Any])
    ...
    inline def setMozBoxSizing(value: BoxSizingProperty): Self = StObject.set(x, "MozBoxSizing", value.asInstanceOf[js.Any])
    
    inline def setMozBoxSizingUndefined: Self = StObject.set(x, "MozBoxSizing", js.undefined)
    
    inline def setMozColumnCount(value: ColumnCountProperty): Self = StObject.set(x, "MozColumnCount", value.asInstanceOf[js.Any])
    
    inline def setMozColumnCountUndefined: Self = StObject.set(x, "MozColumnCount", js.undefined)
    
    inline def setMozColumnFill(value: ColumnFillProperty): Self = StObject.set(x, "MozColumnFill", value.asInstanceOf[js.Any])
    
    inline def setMozColumnFillUndefined: Self = StObject.set(x, "MozColumnFill", js.undefined)
    
    inline def setMozColumnGap(value: ColumnGapProperty[String | Double]): Self = StObject.set(x, "MozColumnGap", value.asInstanceOf[js.Any])
    
    inline def setMozColumnGapUndefined: Self = StObject.set(x, "MozColumnGap", js.undefined)
    
    inline def setMozColumnRule(value: ColumnRuleProperty[String | Double]): Self = StObject.set(x, "MozColumnRule", value.asInstanceOf[js.Any])
    
    inline def setMozColumnRuleColor(value: ColumnRuleColorProperty): Self = StObject.set(x, "MozColumnRuleColor", value.asInstanceOf[js.Any])
    
    inline def setMozColumnRuleColorUndefined: Self = StObject.set(x, "MozColumnRuleColor", js.undefined)
    
    inline def setMozColumnRuleStyle(value: ColumnRuleStyleProperty): Self = StObject.set(x, "MozColumnRuleStyle", value.asInstanceOf[js.Any])
    ...
    inline def setMozColumnRuleWidth(value: ColumnRuleWidthProperty[String | Double]): Self = StObject.set(x, "MozColumnRuleWidth", value.asInstanceOf[js.Any])
    
    inline def setMozColumnRuleWidthUndefined: Self = StObject.set(x, "MozColumnRuleWidth", js.undefined)
    
    inline def setMozColumnWidth(value: ColumnWidthProperty[String | Double]): Self = StObject.set(x, "MozColumnWidth", value.asInstanceOf[js.Any])
    
    inline def setMozColumnWidthUndefined: Self = StObject.set(x, "MozColumnWidth", js.undefined)
    
    inline def setMozColumns(value: ColumnsProperty[String | Double]): Self = StObject.set(x, "MozColumns", value.asInstanceOf[js.Any])
    
    inline def setMozColumnsUndefined: Self = StObject.set(x, "MozColumns", js.undefined)
    
    inline def setMozContextProperties(value: MozContextPropertiesProperty): Self = StObject.set(x, "MozContextProperties", value.asInstanceOf[js.Any])
    ...
    inline def setMozFontFeatureSettings(value: FontFeatureSettingsProperty): Self = StObject.set(x, "MozFontFeatureSettings", value.asInstanceOf[js.Any])
    
    inline def setMozFontFeatureSettingsUndefined: Self = StObject.set(x, "MozFontFeatureSettings", js.undefined)
    
    inline def setMozFontLanguageOverride(value: FontLanguageOverrideProperty): Self = StObject.set(x, "MozFontLanguageOverride", value.asInstanceOf[js.Any])
    ...
    inline def setMozHyphens(value: HyphensProperty): Self = StObject.set(x, "MozHyphens", value.asInstanceOf[js.Any])
    
    inline def setMozHyphensUndefined: Self = StObject.set(x, "MozHyphens", js.undefined)
    
    inline def setMozImageRegion(value: MozImageRegionProperty): Self = StObject.set(x, "MozImageRegion", value.asInstanceOf[js.Any])
    
    inline def setMozImageRegionUndefined: Self = StObject.set(x, "MozImageRegion", js.undefined)
    
    inline def setMozMarginEnd(value: MarginInlineEndProperty[String | Double]): Self = StObject.set(x, "MozMarginEnd", value.asInstanceOf[js.Any])
    
    inline def setMozMarginEndUndefined: Self = StObject.set(x, "MozMarginEnd", js.undefined)
    
    inline def setMozMarginStart(value: MarginInlineStartProperty[String | Double]): Self = StObject.set(x, "MozMarginStart", value.asInstanceOf[js.Any])
    ...
    inline def setMozOrient(value: MozOrientProperty): Self = StObject.set(x, "MozOrient", value.asInstanceOf[js.Any])
    
    inline def setMozOrientUndefined: Self = StObject.set(x, "MozOrient", js.undefined)
    
    inline def setMozOsxFontSmoothing(value: FontSmoothProperty[String | Double]): Self = StObject.set(x, "MozOsxFontSmoothing", value.asInstanceOf[js.Any])
    
    inline def setMozOsxFontSmoothingUndefined: Self = StObject.set(x, "MozOsxFontSmoothing", js.undefined)
    
    inline def setMozOutline(value: OutlineProperty[String | Double]): Self = StObject.set(x, "MozOutline", value.asInstanceOf[js.Any])
    ...
    inline def setMozOutlineRadius(value: MozOutlineRadiusProperty[String | Double]): Self = StObject.set(x, "MozOutlineRadius", value.asInstanceOf[js.Any])
    
    inline def setMozOutlineRadiusBottomleft(value: MozOutlineRadiusBottomleftProperty[String | Double]): Self = StObject.set(x, "MozOutlineRadiusBottomleft", value.asInstanceOf[js.Any])
    
    inline def setMozOutlineRadiusBottomleftUndefined: Self = StObject.set(x, "MozOutlineRadiusBottomleft", js.undefined)
    
    inline def setMozOutlineRadiusBottomright(value: MozOutlineRadiusBottomrightProperty[String | Double]): Self = StObject.set(x, "MozOutlineRadiusBottomright", value.asInstanceOf[js.Any])
    
    inline def setMozOutlineRadiusBottomrightUndefined: Self = StObject.set(x, "MozOutlineRadiusBottomright", js.undefined)
    
    inline def setMozOutlineRadiusTopleft(value: MozOutlineRadiusTopleftProperty[String | Double]): Self = StObject.set(x, "MozOutlineRadiusTopleft", value.asInstanceOf[js.Any])
    
    inline def setMozOutlineRadiusTopleftUndefined: Self = StObject.set(x, "MozOutlineRadiusTopleft", js.undefined)
    
    inline def setMozOutlineRadiusTopright(value: MozOutlineRadiusToprightProperty[String | Double]): Self = StObject.set(x, "MozOutlineRadiusTopright", value.asInstanceOf[js.Any])
    ...
    inline def setMozOutlineWidth(value: OutlineWidthProperty[String | Double]): Self = StObject.set(x, "MozOutlineWidth", value.asInstanceOf[js.Any])
    
    inline def setMozOutlineWidthUndefined: Self = StObject.set(x, "MozOutlineWidth", js.undefined)
    
    inline def setMozPaddingEnd(value: PaddingInlineEndProperty[String | Double]): Self = StObject.set(x, "MozPaddingEnd", value.asInstanceOf[js.Any])
    
    inline def setMozPaddingEndUndefined: Self = StObject.set(x, "MozPaddingEnd", js.undefined)
    
    inline def setMozPaddingStart(value: PaddingInlineStartProperty[String | Double]): Self = StObject.set(x, "MozPaddingStart", value.asInstanceOf[js.Any])
    
    inline def setMozPaddingStartUndefined: Self = StObject.set(x, "MozPaddingStart", js.undefined)
    
    inline def setMozPerspective(value: PerspectiveProperty[String | Double]): Self = StObject.set(x, "MozPerspective", value.asInstanceOf[js.Any])
    
    inline def setMozPerspectiveOrigin(value: PerspectiveOriginProperty[String | Double]): Self = StObject.set(x, "MozPerspectiveOrigin", value.asInstanceOf[js.Any])
    ...
    inline def setMozStackSizing(value: MozStackSizingProperty): Self = StObject.set(x, "MozStackSizing", value.asInstanceOf[js.Any])
    
    inline def setMozStackSizingUndefined: Self = StObject.set(x, "MozStackSizing", js.undefined)
    
    inline def setMozTabSize(value: TabSizeProperty[String | Double]): Self = StObject.set(x, "MozTabSize", value.asInstanceOf[js.Any])
    ...
    inline def setMozTextBlink(value: MozTextBlinkProperty): Self = StObject.set(x, "MozTextBlink", value.asInstanceOf[js.Any])
    ...
    inline def setMozTextSizeAdjust(value: TextSizeAdjustProperty): Self = StObject.set(x, "MozTextSizeAdjust", value.asInstanceOf[js.Any])
    
    inline def setMozTextSizeAdjustUndefined: Self = StObject.set(x, "MozTextSizeAdjust", js.undefined)
    
    inline def setMozTransformOrigin(value: TransformOriginProperty[String | Double]): Self = StObject.set(x, "MozTransformOrigin", value.asInstanceOf[js.Any])
    
    inline def setMozTransformOriginUndefined: Self = StObject.set(x, "MozTransformOrigin", js.undefined)
    
    inline def setMozTransformStyle(value: TransformStyleProperty): Self = StObject.set(x, "MozTransformStyle", value.asInstanceOf[js.Any])
    
    inline def setMozTransformStyleUndefined: Self = StObject.set(x, "MozTransformStyle", js.undefined)
    
    inline def setMozTransition(value: TransitionProperty): Self = StObject.set(x, "MozTransition", value.asInstanceOf[js.Any])
    
    inline def setMozTransitionDelay(value: GlobalsString): Self = StObject.set(x, "MozTransitionDelay", value.asInstanceOf[js.Any])
    
    inline def setMozTransitionDelayUndefined: Self = StObject.set(x, "MozTransitionDelay", js.undefined)
    
    inline def setMozTransitionDuration(value: GlobalsString): Self = StObject.set(x, "MozTransitionDuration", value.asInstanceOf[js.Any])
    
    inline def setMozTransitionDurationUndefined: Self = StObject.set(x, "MozTransitionDuration", js.undefined)
    
    inline def setMozTransitionProperty(value: TransitionPropertyProperty): Self = StObject.set(x, "MozTransitionProperty", value.asInstanceOf[js.Any])
    
    inline def setMozTransitionPropertyUndefined: Self = StObject.set(x, "MozTransitionProperty", js.undefined)
    
    inline def setMozTransitionTimingFunction(value: TransitionTimingFunctionProperty): Self = StObject.set(x, "MozTransitionTimingFunction", value.asInstanceOf[js.Any])
    ...
    inline def setMozUserFocus(value: MozUserFocusProperty): Self = StObject.set(x, "MozUserFocus", value.asInstanceOf[js.Any])
    ...
    inline def setMozUserModify(value: MozUserModifyProperty): Self = StObject.set(x, "MozUserModify", value.asInstanceOf[js.Any])
    
    inline def setMozUserModifyUndefined: Self = StObject.set(x, "MozUserModify", js.undefined)
    
    inline def setMozUserSelect(value: UserSelectProperty): Self = StObject.set(x, "MozUserSelect", value.asInstanceOf[js.Any])
    
    inline def setMozUserSelectUndefined: Self = StObject.set(x, "MozUserSelect", js.undefined)
    
    inline def setMozWindowDragging(value: MozWindowDraggingProperty): Self = StObject.set(x, "MozWindowDragging", value.asInstanceOf[js.Any])
    
    inline def setMozWindowDraggingUndefined: Self = StObject.set(x, "MozWindowDragging", js.undefined)
    
    inline def setMozWindowShadow(value: MozWindowShadowProperty): Self = StObject.set(x, "MozWindowShadow", value.asInstanceOf[js.Any])
    
    inline def setMozWindowShadowUndefined: Self = StObject.set(x, "MozWindowShadow", js.undefined)
    
    inline def setMsAccelerator(value: MsAcceleratorProperty): Self = StObject.set(x, "msAccelerator", value.asInstanceOf[js.Any])
    
    inline def setMsAcceleratorUndefined: Self = StObject.set(x, "msAccelerator", js.undefined)
    
    inline def setMsAlignSelf(value: AlignSelfProperty): Self = StObject.set(x, "msAlignSelf", value.asInstanceOf[js.Any])
    
    inline def setMsAlignSelfUndefined: Self = StObject.set(x, "msAlignSelf", js.undefined)
    
    inline def setMsBlockProgression(value: MsBlockProgressionProperty): Self = StObject.set(x, "msBlockProgression", value.asInstanceOf[js.Any])
    
    inline def setMsBlockProgressionUndefined: Self = StObject.set(x, "msBlockProgression", js.undefined)
    
    inline def setMsContentZoomChaining(value: MsContentZoomChainingProperty): Self = StObject.set(x, "msContentZoomChaining", value.asInstanceOf[js.Any])
    
    inline def setMsContentZoomChainingUndefined: Self = StObject.set(x, "msContentZoomChaining", js.undefined)
    
    inline def setMsContentZoomLimit(value: GlobalsString): Self = StObject.set(x, "msContentZoomLimit", value.asInstanceOf[js.Any])
    
    inline def setMsContentZoomLimitMax(value: GlobalsString): Self = StObject.set(x, "msContentZoomLimitMax", value.asInstanceOf[js.Any])
    
    inline def setMsContentZoomLimitMaxUndefined: Self = StObject.set(x, "msContentZoomLimitMax", js.undefined)
    
    inline def setMsContentZoomLimitMin(value: GlobalsString): Self = StObject.set(x, "msContentZoomLimitMin", value.asInstanceOf[js.Any])
    ...
    inline def setMsContentZoomSnap(value: MsContentZoomSnapProperty): Self = StObject.set(x, "msContentZoomSnap", value.asInstanceOf[js.Any])
    
    inline def setMsContentZoomSnapPoints(value: GlobalsString): Self = StObject.set(x, "msContentZoomSnapPoints", value.asInstanceOf[js.Any])
    
    inline def setMsContentZoomSnapPointsUndefined: Self = StObject.set(x, "msContentZoomSnapPoints", js.undefined)
    
    inline def setMsContentZoomSnapType(value: MsContentZoomSnapTypeProperty): Self = StObject.set(x, "msContentZoomSnapType", value.asInstanceOf[js.Any])
    ...
    inline def setMsContentZooming(value: MsContentZoomingProperty): Self = StObject.set(x, "msContentZooming", value.asInstanceOf[js.Any])
    
    inline def setMsContentZoomingUndefined: Self = StObject.set(x, "msContentZooming", js.undefined)
    
    inline def setMsFilter(value: GlobalsString): Self = StObject.set(x, "msFilter", value.asInstanceOf[js.Any])
    
    inline def setMsFilterUndefined: Self = StObject.set(x, "msFilter", js.undefined)
    
    inline def setMsFlex(value: FlexProperty[String | Double]): Self = StObject.set(x, "msFlex", value.asInstanceOf[js.Any])
    
    inline def setMsFlexDirection(value: FlexDirectionProperty): Self = StObject.set(x, "msFlexDirection", value.asInstanceOf[js.Any])
    
    inline def setMsFlexDirectionUndefined: Self = StObject.set(x, "msFlexDirection", js.undefined)
    
    inline def setMsFlexPositive(value: GlobalsNumber): Self = StObject.set(x, "msFlexPositive", value.asInstanceOf[js.Any])
    ...
    inline def setMsFlowFrom(value: MsFlowFromProperty): Self = StObject.set(x, "msFlowFrom", value.asInstanceOf[js.Any])
    
    inline def setMsFlowFromUndefined: Self = StObject.set(x, "msFlowFrom", js.undefined)
    
    inline def setMsFlowInto(value: MsFlowIntoProperty): Self = StObject.set(x, "msFlowInto", value.asInstanceOf[js.Any])
    
    inline def setMsFlowIntoUndefined: Self = StObject.set(x, "msFlowInto", js.undefined)
    
    inline def setMsGridColumns(value: MsGridColumnsProperty[String | Double]): Self = StObject.set(x, "msGridColumns", value.asInstanceOf[js.Any])
    
    inline def setMsGridColumnsUndefined: Self = StObject.set(x, "msGridColumns", js.undefined)
    
    inline def setMsGridRows(value: MsGridRowsProperty[String | Double]): Self = StObject.set(x, "msGridRows", value.asInstanceOf[js.Any])
    
    inline def setMsGridRowsUndefined: Self = StObject.set(x, "msGridRows", js.undefined)
    
    inline def setMsHighContrastAdjust(value: MsHighContrastAdjustProperty): Self = StObject.set(x, "msHighContrastAdjust", value.asInstanceOf[js.Any])
    
    inline def setMsHighContrastAdjustUndefined: Self = StObject.set(x, "msHighContrastAdjust", js.undefined)
    
    inline def setMsHyphenateLimitChars(value: MsHyphenateLimitCharsProperty): Self = StObject.set(x, "msHyphenateLimitChars", value.asInstanceOf[js.Any])
    
    inline def setMsHyphenateLimitCharsUndefined: Self = StObject.set(x, "msHyphenateLimitChars", js.undefined)
    
    inline def setMsHyphenateLimitLines(value: MsHyphenateLimitLinesProperty): Self = StObject.set(x, "msHyphenateLimitLines", value.asInstanceOf[js.Any])
    
    inline def setMsHyphenateLimitLinesUndefined: Self = StObject.set(x, "msHyphenateLimitLines", js.undefined)
    
    inline def setMsHyphenateLimitZone(value: MsHyphenateLimitZoneProperty[String | Double]): Self = StObject.set(x, "msHyphenateLimitZone", value.asInstanceOf[js.Any])
    
    inline def setMsHyphenateLimitZoneUndefined: Self = StObject.set(x, "msHyphenateLimitZone", js.undefined)
    
    inline def setMsHyphens(value: HyphensProperty): Self = StObject.set(x, "msHyphens", value.asInstanceOf[js.Any])
    
    inline def setMsHyphensUndefined: Self = StObject.set(x, "msHyphens", js.undefined)
    
    inline def setMsImeAlign(value: MsImeAlignProperty): Self = StObject.set(x, "msImeAlign", value.asInstanceOf[js.Any])
    ...
    inline def setMsJustifySelf(value: JustifySelfProperty): Self = StObject.set(x, "msJustifySelf", value.asInstanceOf[js.Any])
    
    inline def setMsJustifySelfUndefined: Self = StObject.set(x, "msJustifySelf", js.undefined)
    
    inline def setMsLineBreak(value: LineBreakProperty): Self = StObject.set(x, "msLineBreak", value.asInstanceOf[js.Any])
    
    inline def setMsLineBreakUndefined: Self = StObject.set(x, "msLineBreak", js.undefined)
    
    inline def setMsOrder(value: GlobalsNumber): Self = StObject.set(x, "msOrder", value.asInstanceOf[js.Any])
    
    inline def setMsOrderUndefined: Self = StObject.set(x, "msOrder", js.undefined)
    
    inline def setMsOverflowStyle(value: MsOverflowStyleProperty): Self = StObject.set(x, "msOverflowStyle", value.asInstanceOf[js.Any])
    
    inline def setMsOverflowStyleUndefined: Self = StObject.set(x, "msOverflowStyle", js.undefined)
    
    inline def setMsOverflowX(value: OverflowXProperty): Self = StObject.set(x, "msOverflowX", value.asInstanceOf[js.Any])
    
    inline def setMsOverflowXUndefined: Self = StObject.set(x, "msOverflowX", js.undefined)
    
    inline def setMsOverflowY(value: OverflowYProperty): Self = StObject.set(x, "msOverflowY", value.asInstanceOf[js.Any])
    
    inline def setMsOverflowYUndefined: Self = StObject.set(x, "msOverflowY", js.undefined)
    
    inline def setMsScrollChaining(value: MsScrollChainingProperty): Self = StObject.set(x, "msScrollChaining", value.asInstanceOf[js.Any])
    
    inline def setMsScrollChainingUndefined: Self = StObject.set(x, "msScrollChaining", js.undefined)
    
    inline def setMsScrollLimit(value: GlobalsString): Self = StObject.set(x, "msScrollLimit", value.asInstanceOf[js.Any])
    
    inline def setMsScrollLimitUndefined: Self = StObject.set(x, "msScrollLimit", js.undefined)
    
    inline def setMsScrollLimitXMax(value: MsScrollLimitXMaxProperty[String | Double]): Self = StObject.set(x, "msScrollLimitXMax", value.asInstanceOf[js.Any])
    
    inline def setMsScrollLimitXMaxUndefined: Self = StObject.set(x, "msScrollLimitXMax", js.undefined)
    
    inline def setMsScrollLimitXMin(value: MsScrollLimitXMinProperty[String | Double]): Self = StObject.set(x, "msScrollLimitXMin", value.asInstanceOf[js.Any])
    
    inline def setMsScrollLimitXMinUndefined: Self = StObject.set(x, "msScrollLimitXMin", js.undefined)
    
    inline def setMsScrollLimitYMax(value: MsScrollLimitYMaxProperty[String | Double]): Self = StObject.set(x, "msScrollLimitYMax", value.asInstanceOf[js.Any])
    
    inline def setMsScrollLimitYMaxUndefined: Self = StObject.set(x, "msScrollLimitYMax", js.undefined)
    
    inline def setMsScrollLimitYMin(value: MsScrollLimitYMinProperty[String | Double]): Self = StObject.set(x, "msScrollLimitYMin", value.asInstanceOf[js.Any])
    
    inline def setMsScrollLimitYMinUndefined: Self = StObject.set(x, "msScrollLimitYMin", js.undefined)
    
    inline def setMsScrollRails(value: MsScrollRailsProperty): Self = StObject.set(x, "msScrollRails", value.asInstanceOf[js.Any])
    
    inline def setMsScrollRailsUndefined: Self = StObject.set(x, "msScrollRails", js.undefined)
    
    inline def setMsScrollSnapPointsX(value: GlobalsString): Self = StObject.set(x, "msScrollSnapPointsX", value.asInstanceOf[js.Any])
    
    inline def setMsScrollSnapPointsXUndefined: Self = StObject.set(x, "msScrollSnapPointsX", js.undefined)
    
    inline def setMsScrollSnapPointsY(value: GlobalsString): Self = StObject.set(x, "msScrollSnapPointsY", value.asInstanceOf[js.Any])
    
    inline def setMsScrollSnapPointsYUndefined: Self = StObject.set(x, "msScrollSnapPointsY", js.undefined)
    
    inline def setMsScrollSnapType(value: MsScrollSnapTypeProperty): Self = StObject.set(x, "msScrollSnapType", value.asInstanceOf[js.Any])
    
    inline def setMsScrollSnapTypeUndefined: Self = StObject.set(x, "msScrollSnapType", js.undefined)
    
    inline def setMsScrollSnapX(value: GlobalsString): Self = StObject.set(x, "msScrollSnapX", value.asInstanceOf[js.Any])
    
    inline def setMsScrollSnapXUndefined: Self = StObject.set(x, "msScrollSnapX", js.undefined)
    
    inline def setMsScrollSnapY(value: GlobalsString): Self = StObject.set(x, "msScrollSnapY", value.asInstanceOf[js.Any])
    
    inline def setMsScrollSnapYUndefined: Self = StObject.set(x, "msScrollSnapY", js.undefined)
    
    inline def setMsScrollTranslation(value: MsScrollTranslationProperty): Self = StObject.set(x, "msScrollTranslation", value.asInstanceOf[js.Any])
    
    inline def setMsScrollTranslationUndefined: Self = StObject.set(x, "msScrollTranslation", js.undefined)
    
    inline def setMsScrollbar3dlightColor(value: MsScrollbar3dlightColorProperty): Self = StObject.set(x, "msScrollbar3dlightColor", value.asInstanceOf[js.Any])
    
    inline def setMsScrollbar3dlightColorUndefined: Self = StObject.set(x, "msScrollbar3dlightColor", js.undefined)
    
    inline def setMsScrollbarArrowColor(value: MsScrollbarArrowColorProperty): Self = StObject.set(x, "msScrollbarArrowColor", value.asInstanceOf[js.Any])
    
    inline def setMsScrollbarArrowColorUndefined: Self = StObject.set(x, "msScrollbarArrowColor", js.undefined)
    
    inline def setMsScrollbarBaseColor(value: MsScrollbarBaseColorProperty): Self = StObject.set(x, "msScrollbarBaseColor", value.asInstanceOf[js.Any])
    
    inline def setMsScrollbarBaseColorUndefined: Self = StObject.set(x, "msScrollbarBaseColor", js.undefined)
    
    inline def setMsScrollbarDarkshadowColor(value: MsScrollbarDarkshadowColorProperty): Self = StObject.set(x, "msScrollbarDarkshadowColor", value.asInstanceOf[js.Any])
    
    inline def setMsScrollbarDarkshadowColorUndefined: Self = StObject.set(x, "msScrollbarDarkshadowColor", js.undefined)
    
    inline def setMsScrollbarFaceColor(value: MsScrollbarFaceColorProperty): Self = StObject.set(x, "msScrollbarFaceColor", value.asInstanceOf[js.Any])
    
    inline def setMsScrollbarFaceColorUndefined: Self = StObject.set(x, "msScrollbarFaceColor", js.undefined)
    
    inline def setMsScrollbarHighlightColor(value: MsScrollbarHighlightColorProperty): Self = StObject.set(x, "msScrollbarHighlightColor", value.asInstanceOf[js.Any])
    
    inline def setMsScrollbarHighlightColorUndefined: Self = StObject.set(x, "msScrollbarHighlightColor", js.undefined)
    
    inline def setMsScrollbarShadowColor(value: MsScrollbarShadowColorProperty): Self = StObject.set(x, "msScrollbarShadowColor", value.asInstanceOf[js.Any])
    ...
    inline def setMsTextAutospace(value: MsTextAutospaceProperty): Self = StObject.set(x, "msTextAutospace", value.asInstanceOf[js.Any])
    
    inline def setMsTextAutospaceUndefined: Self = StObject.set(x, "msTextAutospace", js.undefined)
    
    inline def setMsTextCombineHorizontal(value: TextCombineUprightProperty): Self = StObject.set(x, "msTextCombineHorizontal", value.asInstanceOf[js.Any])
    
    inline def setMsTextCombineHorizontalUndefined: Self = StObject.set(x, "msTextCombineHorizontal", js.undefined)
    
    inline def setMsTextOverflow(value: TextOverflowProperty): Self = StObject.set(x, "msTextOverflow", value.asInstanceOf[js.Any])
    
    inline def setMsTextOverflowUndefined: Self = StObject.set(x, "msTextOverflow", js.undefined)
    
    inline def setMsTouchAction(value: TouchActionProperty): Self = StObject.set(x, "msTouchAction", value.asInstanceOf[js.Any])
    
    inline def setMsTouchActionUndefined: Self = StObject.set(x, "msTouchAction", js.undefined)
    
    inline def setMsTouchSelect(value: MsTouchSelectProperty): Self = StObject.set(x, "msTouchSelect", value.asInstanceOf[js.Any])
    
    inline def setMsTouchSelectUndefined: Self = StObject.set(x, "msTouchSelect", js.undefined)
    
    inline def setMsTransform(value: TransformProperty): Self = StObject.set(x, "msTransform", value.asInstanceOf[js.Any])
    
    inline def setMsTransformOrigin(value: TransformOriginProperty[String | Double]): Self = StObject.set(x, "msTransformOrigin", value.asInstanceOf[js.Any])
    ...
    inline def setMsTransition(value: TransitionProperty): Self = StObject.set(x, "msTransition", value.asInstanceOf[js.Any])
    
    inline def setMsTransitionDelay(value: GlobalsString): Self = StObject.set(x, "msTransitionDelay", value.asInstanceOf[js.Any])
    
    inline def setMsTransitionDelayUndefined: Self = StObject.set(x, "msTransitionDelay", js.undefined)
    
    inline def setMsTransitionDuration(value: GlobalsString): Self = StObject.set(x, "msTransitionDuration", value.asInstanceOf[js.Any])
    
    inline def setMsTransitionDurationUndefined: Self = StObject.set(x, "msTransitionDuration", js.undefined)
    
    inline def setMsTransitionProperty(value: TransitionPropertyProperty): Self = StObject.set(x, "msTransitionProperty", value.asInstanceOf[js.Any])
    
    inline def setMsTransitionPropertyUndefined: Self = StObject.set(x, "msTransitionProperty", js.undefined)
    
    inline def setMsTransitionTimingFunction(value: TransitionTimingFunctionProperty): Self = StObject.set(x, "msTransitionTimingFunction", value.asInstanceOf[js.Any])
    ...
    inline def setMsUserSelect(value: MsUserSelectProperty): Self = StObject.set(x, "msUserSelect", value.asInstanceOf[js.Any])
    
    inline def setMsUserSelectUndefined: Self = StObject.set(x, "msUserSelect", js.undefined)
    
    inline def setMsWordBreak(value: WordBreakProperty): Self = StObject.set(x, "msWordBreak", value.asInstanceOf[js.Any])
    
    inline def setMsWordBreakUndefined: Self = StObject.set(x, "msWordBreak", js.undefined)
    
    inline def setMsWrapFlow(value: MsWrapFlowProperty): Self = StObject.set(x, "msWrapFlow", value.asInstanceOf[js.Any])
    
    inline def setMsWrapFlowUndefined: Self = StObject.set(x, "msWrapFlow", js.undefined)
    
    inline def setMsWrapMargin(value: MsWrapMarginProperty[String | Double]): Self = StObject.set(x, "msWrapMargin", value.asInstanceOf[js.Any])
    
    inline def setMsWrapMarginUndefined: Self = StObject.set(x, "msWrapMargin", js.undefined)
    
    inline def setMsWrapThrough(value: MsWrapThroughProperty): Self = StObject.set(x, "msWrapThrough", value.asInstanceOf[js.Any])
    
    inline def setMsWrapThroughUndefined: Self = StObject.set(x, "msWrapThrough", js.undefined)
    
    inline def setMsWritingMode(value: WritingModeProperty): Self = StObject.set(x, "msWritingMode", value.asInstanceOf[js.Any])
    ...
    inline def setOBackgroundSize(value: BackgroundSizeProperty[String | Double]): Self = StObject.set(x, "OBackgroundSize", value.asInstanceOf[js.Any])
    ...
    inline def setOObjectFit(value: ObjectFitProperty): Self = StObject.set(x, "OObjectFit", value.asInstanceOf[js.Any])
    
    inline def setOObjectFitUndefined: Self = StObject.set(x, "OObjectFit", js.undefined)
    
    inline def setOObjectPosition(value: ObjectPositionProperty[String | Double]): Self = StObject.set(x, "OObjectPosition", value.asInstanceOf[js.Any])
    
    inline def setOObjectPositionUndefined: Self = StObject.set(x, "OObjectPosition", js.undefined)
    
    inline def setOTabSize(value: TabSizeProperty[String | Double]): Self = StObject.set(x, "OTabSize", value.asInstanceOf[js.Any])
    
    inline def setOTabSizeUndefined: Self = StObject.set(x, "OTabSize", js.undefined)
    
    inline def setOTextOverflow(value: TextOverflowProperty): Self = StObject.set(x, "OTextOverflow", value.asInstanceOf[js.Any])
    ...
    inline def setOTransformOrigin(value: TransformOriginProperty[String | Double]): Self = StObject.set(x, "OTransformOrigin", value.asInstanceOf[js.Any])
    ...
    inline def setObjectPosition(value: ObjectPositionProperty[String | Double]): Self = StObject.set(x, "objectPosition", value.asInstanceOf[js.Any])
    
    inline def setObjectPositionUndefined: Self = StObject.set(x, "objectPosition", js.undefined)
    
    inline def setOffset(value: OffsetProperty[String | Double]): Self = StObject.set(x, "offset", value.asInstanceOf[js.Any])
    
    inline def setOffsetAnchor(value: OffsetAnchorProperty[String | Double]): Self = StObject.set(x, "offsetAnchor", value.asInstanceOf[js.Any])
    
    inline def setOffsetAnchorUndefined: Self = StObject.set(x, "offsetAnchor", js.undefined)
    
    inline def setOffsetBlock(value: InsetBlockProperty[String | Double]): Self = StObject.set(x, "offsetBlock", value.asInstanceOf[js.Any])
    
    inline def setOffsetBlockEnd(value: InsetBlockEndProperty[String | Double]): Self = StObject.set(x, "offsetBlockEnd", value.asInstanceOf[js.Any])
    
    inline def setOffsetBlockEndUndefined: Self = StObject.set(x, "offsetBlockEnd", js.undefined)
    
    inline def setOffsetBlockStart(value: InsetBlockStartProperty[String | Double]): Self = StObject.set(x, "offsetBlockStart", value.asInstanceOf[js.Any])
    ...
    inline def setOffsetDistance(value: OffsetDistanceProperty[String | Double]): Self = StObject.set(x, "offsetDistance", value.asInstanceOf[js.Any])
    
    inline def setOffsetDistanceUndefined: Self = StObject.set(x, "offsetDistance", js.undefined)
    
    inline def setOffsetInline(value: InsetInlineProperty[String | Double]): Self = StObject.set(x, "offsetInline", value.asInstanceOf[js.Any])
    
    inline def setOffsetInlineEnd(value: InsetInlineEndProperty[String | Double]): Self = StObject.set(x, "offsetInlineEnd", value.asInstanceOf[js.Any])
    
    inline def setOffsetInlineEndUndefined: Self = StObject.set(x, "offsetInlineEnd", js.undefined)
    
    inline def setOffsetInlineStart(value: InsetInlineStartProperty[String | Double]): Self = StObject.set(x, "offsetInlineStart", value.asInstanceOf[js.Any])
    ...
    inline def setOutline(value: OutlineProperty[String | Double]): Self = StObject.set(x, "outline", value.asInstanceOf[js.Any])
    ...
    inline def setOutlineOffset(value: OutlineOffsetProperty[String | Double]): Self = StObject.set(x, "outlineOffset", value.asInstanceOf[js.Any])
    ...
    inline def setOutlineWidth(value: OutlineWidthProperty[String | Double]): Self = StObject.set(x, "outlineWidth", value.asInstanceOf[js.Any])
    ...
    inline def setPadding(value: PaddingProperty[String | Double]): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
    
    inline def setPaddingBlock(value: PaddingBlockProperty[String | Double]): Self = StObject.set(x, "paddingBlock", value.asInstanceOf[js.Any])
    
    inline def setPaddingBlockEnd(value: PaddingBlockEndProperty[String | Double]): Self = StObject.set(x, "paddingBlockEnd", value.asInstanceOf[js.Any])
    
    inline def setPaddingBlockEndUndefined: Self = StObject.set(x, "paddingBlockEnd", js.undefined)
    
    inline def setPaddingBlockStart(value: PaddingBlockStartProperty[String | Double]): Self = StObject.set(x, "paddingBlockStart", value.asInstanceOf[js.Any])
    ...
    inline def setPaddingBottom(value: PaddingBottomProperty[String | Double]): Self = StObject.set(x, "paddingBottom", value.asInstanceOf[js.Any])
    
    inline def setPaddingBottomUndefined: Self = StObject.set(x, "paddingBottom", js.undefined)
    
    inline def setPaddingInline(value: PaddingInlineProperty[String | Double]): Self = StObject.set(x, "paddingInline", value.asInstanceOf[js.Any])
    
    inline def setPaddingInlineEnd(value: PaddingInlineEndProperty[String | Double]): Self = StObject.set(x, "paddingInlineEnd", value.asInstanceOf[js.Any])
    
    inline def setPaddingInlineEndUndefined: Self = StObject.set(x, "paddingInlineEnd", js.undefined)
    
    inline def setPaddingInlineStart(value: PaddingInlineStartProperty[String | Double]): Self = StObject.set(x, "paddingInlineStart", value.asInstanceOf[js.Any])
    ...
    inline def setPaddingLeft(value: PaddingLeftProperty[String | Double]): Self = StObject.set(x, "paddingLeft", value.asInstanceOf[js.Any])
    
    inline def setPaddingLeftUndefined: Self = StObject.set(x, "paddingLeft", js.undefined)
    
    inline def setPaddingRight(value: PaddingRightProperty[String | Double]): Self = StObject.set(x, "paddingRight", value.asInstanceOf[js.Any])
    
    inline def setPaddingRightUndefined: Self = StObject.set(x, "paddingRight", js.undefined)
    
    inline def setPaddingTop(value: PaddingTopProperty[String | Double]): Self = StObject.set(x, "paddingTop", value.asInstanceOf[js.Any])
    ...
    inline def setPerspective(value: PerspectiveProperty[String | Double]): Self = StObject.set(x, "perspective", value.asInstanceOf[js.Any])
    
    inline def setPerspectiveOrigin(value: PerspectiveOriginProperty[String | Double]): Self = StObject.set(x, "perspectiveOrigin", value.asInstanceOf[js.Any])
    ...
    inline def setRight(value: RightProperty[String | Double]): Self = StObject.set(x, "right", value.asInstanceOf[js.Any])
    ...
    inline def setRowGap(value: RowGapProperty[String | Double]): Self = StObject.set(x, "rowGap", value.asInstanceOf[js.Any])
    ...
    inline def setScrollMargin(value: ScrollMarginProperty[String | Double]): Self = StObject.set(x, "scrollMargin", value.asInstanceOf[js.Any])
    
    inline def setScrollMarginBlock(value: ScrollMarginBlockProperty[String | Double]): Self = StObject.set(x, "scrollMarginBlock", value.asInstanceOf[js.Any])
    
    inline def setScrollMarginBlockEnd(value: ScrollMarginBlockEndProperty[String | Double]): Self = StObject.set(x, "scrollMarginBlockEnd", value.asInstanceOf[js.Any])
    
    inline def setScrollMarginBlockEndUndefined: Self = StObject.set(x, "scrollMarginBlockEnd", js.undefined)
    
    inline def setScrollMarginBlockStart(value: ScrollMarginBlockStartProperty[String | Double]): Self = StObject.set(x, "scrollMarginBlockStart", value.asInstanceOf[js.Any])
    ...
    inline def setScrollMarginBottom(value: ScrollMarginBottomProperty[String | Double]): Self = StObject.set(x, "scrollMarginBottom", value.asInstanceOf[js.Any])
    
    inline def setScrollMarginBottomUndefined: Self = StObject.set(x, "scrollMarginBottom", js.undefined)
    
    inline def setScrollMarginInline(value: ScrollMarginInlineProperty[String | Double]): Self = StObject.set(x, "scrollMarginInline", value.asInstanceOf[js.Any])
    
    inline def setScrollMarginInlineEnd(value: ScrollMarginInlineEndProperty[String | Double]): Self = StObject.set(x, "scrollMarginInlineEnd", value.asInstanceOf[js.Any])
    
    inline def setScrollMarginInlineEndUndefined: Self = StObject.set(x, "scrollMarginInlineEnd", js.undefined)
    
    inline def setScrollMarginInlineStart(value: ScrollMarginInlineStartProperty[String | Double]): Self = StObject.set(x, "scrollMarginInlineStart", value.asInstanceOf[js.Any])
    ...
    inline def setScrollMarginLeft(value: ScrollMarginLeftProperty[String | Double]): Self = StObject.set(x, "scrollMarginLeft", value.asInstanceOf[js.Any])
    
    inline def setScrollMarginLeftUndefined: Self = StObject.set(x, "scrollMarginLeft", js.undefined)
    
    inline def setScrollMarginRight(value: ScrollMarginRightProperty[String | Double]): Self = StObject.set(x, "scrollMarginRight", value.asInstanceOf[js.Any])
    
    inline def setScrollMarginRightUndefined: Self = StObject.set(x, "scrollMarginRight", js.undefined)
    
    inline def setScrollMarginTop(value: ScrollMarginTopProperty[String | Double]): Self = StObject.set(x, "scrollMarginTop", value.asInstanceOf[js.Any])
    ...
    inline def setScrollPadding(value: ScrollPaddingProperty[String | Double]): Self = StObject.set(x, "scrollPadding", value.asInstanceOf[js.Any])
    
    inline def setScrollPaddingBlock(value: ScrollPaddingBlockProperty[String | Double]): Self = StObject.set(x, "scrollPaddingBlock", value.asInstanceOf[js.Any])
    
    inline def setScrollPaddingBlockEnd(value: ScrollPaddingBlockEndProperty[String | Double]): Self = StObject.set(x, "scrollPaddingBlockEnd", value.asInstanceOf[js.Any])
    
    inline def setScrollPaddingBlockEndUndefined: Self = StObject.set(x, "scrollPaddingBlockEnd", js.undefined)
    
    inline def setScrollPaddingBlockStart(value: ScrollPaddingBlockStartProperty[String | Double]): Self = StObject.set(x, "scrollPaddingBlockStart", value.asInstanceOf[js.Any])
    ...
    inline def setScrollPaddingBottom(value: ScrollPaddingBottomProperty[String | Double]): Self = StObject.set(x, "scrollPaddingBottom", value.asInstanceOf[js.Any])
    
    inline def setScrollPaddingBottomUndefined: Self = StObject.set(x, "scrollPaddingBottom", js.undefined)
    
    inline def setScrollPaddingInline(value: ScrollPaddingInlineProperty[String | Double]): Self = StObject.set(x, "scrollPaddingInline", value.asInstanceOf[js.Any])
    
    inline def setScrollPaddingInlineEnd(value: ScrollPaddingInlineEndProperty[String | Double]): Self = StObject.set(x, "scrollPaddingInlineEnd", value.asInstanceOf[js.Any])
    
    inline def setScrollPaddingInlineEndUndefined: Self = StObject.set(x, "scrollPaddingInlineEnd", js.undefined)
    
    inline def setScrollPaddingInlineStart(value: ScrollPaddingInlineStartProperty[String | Double]): Self = StObject.set(x, "scrollPaddingInlineStart", value.asInstanceOf[js.Any])
    ...
    inline def setScrollPaddingLeft(value: ScrollPaddingLeftProperty[String | Double]): Self = StObject.set(x, "scrollPaddingLeft", value.asInstanceOf[js.Any])
    
    inline def setScrollPaddingLeftUndefined: Self = StObject.set(x, "scrollPaddingLeft", js.undefined)
    
    inline def setScrollPaddingRight(value: ScrollPaddingRightProperty[String | Double]): Self = StObject.set(x, "scrollPaddingRight", value.asInstanceOf[js.Any])
    
    inline def setScrollPaddingRightUndefined: Self = StObject.set(x, "scrollPaddingRight", js.undefined)
    
    inline def setScrollPaddingTop(value: ScrollPaddingTopProperty[String | Double]): Self = StObject.set(x, "scrollPaddingTop", value.asInstanceOf[js.Any])
    ...
    inline def setScrollSnapCoordinate(value: ScrollSnapCoordinateProperty[String | Double]): Self = StObject.set(x, "scrollSnapCoordinate", value.asInstanceOf[js.Any])
    
    inline def setScrollSnapCoordinateUndefined: Self = StObject.set(x, "scrollSnapCoordinate", js.undefined)
    
    inline def setScrollSnapDestination(value: ScrollSnapDestinationProperty[String | Double]): Self = StObject.set(x, "scrollSnapDestination", value.asInstanceOf[js.Any])
    
    inline def setScrollSnapDestinationUndefined: Self = StObject.set(x, "scrollSnapDestination", js.undefined)
    
    inline def setScrollSnapMargin(value: ScrollMarginProperty[String | Double]): Self = StObject.set(x, "scrollSnapMargin", value.asInstanceOf[js.Any])
    
    inline def setScrollSnapMarginBottom(value: ScrollMarginBottomProperty[String | Double]): Self = StObject.set(x, "scrollSnapMarginBottom", value.asInstanceOf[js.Any])
    
    inline def setScrollSnapMarginBottomUndefined: Self = StObject.set(x, "scrollSnapMarginBottom", js.undefined)
    
    inline def setScrollSnapMarginLeft(value: ScrollMarginLeftProperty[String | Double]): Self = StObject.set(x, "scrollSnapMarginLeft", value.asInstanceOf[js.Any])
    
    inline def setScrollSnapMarginLeftUndefined: Self = StObject.set(x, "scrollSnapMarginLeft", js.undefined)
    
    inline def setScrollSnapMarginRight(value: ScrollMarginRightProperty[String | Double]): Self = StObject.set(x, "scrollSnapMarginRight", value.asInstanceOf[js.Any])
    
    inline def setScrollSnapMarginRightUndefined: Self = StObject.set(x, "scrollSnapMarginRight", js.undefined)
    
    inline def setScrollSnapMarginTop(value: ScrollMarginTopProperty[String | Double]): Self = StObject.set(x, "scrollSnapMarginTop", value.asInstanceOf[js.Any])
    ...
    inline def setShapeMargin(value: ShapeMarginProperty[String | Double]): Self = StObject.set(x, "shapeMargin", value.asInstanceOf[js.Any])
    ...
    inline def setStrokeDasharray(value: StrokeDasharrayProperty[String | Double]): Self = StObject.set(x, "strokeDasharray", value.asInstanceOf[js.Any])
    
    inline def setStrokeDasharrayUndefined: Self = StObject.set(x, "strokeDasharray", js.undefined)
    
    inline def setStrokeDashoffset(value: StrokeDashoffsetProperty[String | Double]): Self = StObject.set(x, "strokeDashoffset", value.asInstanceOf[js.Any])
    ...
    inline def setStrokeWidth(value: StrokeWidthProperty[String | Double]): Self = StObject.set(x, "strokeWidth", value.asInstanceOf[js.Any])
    
    inline def setStrokeWidthUndefined: Self = StObject.set(x, "strokeWidth", js.undefined)
    
    inline def setTabSize(value: TabSizeProperty[String | Double]): Self = StObject.set(x, "tabSize", value.asInstanceOf[js.Any])
    ...
    inline def setTextDecoration(value: TextDecorationProperty[String | Double]): Self = StObject.set(x, "textDecoration", value.asInstanceOf[js.Any])
    ...
    inline def setTextDecorationThickness(value: TextDecorationThicknessProperty[String | Double]): Self = StObject.set(x, "textDecorationThickness", value.asInstanceOf[js.Any])
    
    inline def setTextDecorationThicknessUndefined: Self = StObject.set(x, "textDecorationThickness", js.undefined)
    
    inline def setTextDecorationUndefined: Self = StObject.set(x, "textDecoration", js.undefined)
    
    inline def setTextDecorationWidth(value: TextDecorationThicknessProperty[String | Double]): Self = StObject.set(x, "textDecorationWidth", value.asInstanceOf[js.Any])
    ...
    inline def setTextIndent(value: TextIndentProperty[String | Double]): Self = StObject.set(x, "textIndent", value.asInstanceOf[js.Any])
    ...
    inline def setTextUnderlineOffset(value: TextUnderlineOffsetProperty[String | Double]): Self = StObject.set(x, "textUnderlineOffset", value.asInstanceOf[js.Any])
    ...
    inline def setTop(value: TopProperty[String | Double]): Self = StObject.set(x, "top", value.asInstanceOf[js.Any])
    ...
    inline def setTransformOrigin(value: TransformOriginProperty[String | Double]): Self = StObject.set(x, "transformOrigin", value.asInstanceOf[js.Any])
    ...
    inline def setTranslate(value: TranslateProperty[String | Double]): Self = StObject.set(x, "translate", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitAlignContent(value: AlignContentProperty): Self = StObject.set(x, "WebkitAlignContent", value.asInstanceOf[js.Any])
    
    inline def setWebkitAlignContentUndefined: Self = StObject.set(x, "WebkitAlignContent", js.undefined)
    
    inline def setWebkitAlignItems(value: AlignItemsProperty): Self = StObject.set(x, "WebkitAlignItems", value.asInstanceOf[js.Any])
    
    inline def setWebkitAlignItemsUndefined: Self = StObject.set(x, "WebkitAlignItems", js.undefined)
    
    inline def setWebkitAlignSelf(value: AlignSelfProperty): Self = StObject.set(x, "WebkitAlignSelf", value.asInstanceOf[js.Any])
    
    inline def setWebkitAlignSelfUndefined: Self = StObject.set(x, "WebkitAlignSelf", js.undefined)
    
    inline def setWebkitAnimation(value: AnimationProperty): Self = StObject.set(x, "WebkitAnimation", value.asInstanceOf[js.Any])
    
    inline def setWebkitAnimationDelay(value: GlobalsString): Self = StObject.set(x, "WebkitAnimationDelay", value.asInstanceOf[js.Any])
    
    inline def setWebkitAnimationDelayUndefined: Self = StObject.set(x, "WebkitAnimationDelay", js.undefined)
    
    inline def setWebkitAnimationDirection(value: AnimationDirectionProperty): Self = StObject.set(x, "WebkitAnimationDirection", value.asInstanceOf[js.Any])
    
    inline def setWebkitAnimationDirectionUndefined: Self = StObject.set(x, "WebkitAnimationDirection", js.undefined)
    
    inline def setWebkitAnimationDuration(value: GlobalsString): Self = StObject.set(x, "WebkitAnimationDuration", value.asInstanceOf[js.Any])
    
    inline def setWebkitAnimationDurationUndefined: Self = StObject.set(x, "WebkitAnimationDuration", js.undefined)
    
    inline def setWebkitAnimationFillMode(value: AnimationFillModeProperty): Self = StObject.set(x, "WebkitAnimationFillMode", value.asInstanceOf[js.Any])
    
    inline def setWebkitAnimationFillModeUndefined: Self = StObject.set(x, "WebkitAnimationFillMode", js.undefined)
    
    inline def setWebkitAnimationIterationCount(value: AnimationIterationCountProperty): Self = StObject.set(x, "WebkitAnimationIterationCount", value.asInstanceOf[js.Any])
    
    inline def setWebkitAnimationIterationCountUndefined: Self = StObject.set(x, "WebkitAnimationIterationCount", js.undefined)
    
    inline def setWebkitAnimationName(value: AnimationNameProperty): Self = StObject.set(x, "WebkitAnimationName", value.asInstanceOf[js.Any])
    
    inline def setWebkitAnimationNameUndefined: Self = StObject.set(x, "WebkitAnimationName", js.undefined)
    
    inline def setWebkitAnimationPlayState(value: AnimationPlayStateProperty): Self = StObject.set(x, "WebkitAnimationPlayState", value.asInstanceOf[js.Any])
    
    inline def setWebkitAnimationPlayStateUndefined: Self = StObject.set(x, "WebkitAnimationPlayState", js.undefined)
    
    inline def setWebkitAnimationTimingFunction(value: AnimationTimingFunctionProperty): Self = StObject.set(x, "WebkitAnimationTimingFunction", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitAppearance(value: WebkitAppearanceProperty): Self = StObject.set(x, "WebkitAppearance", value.asInstanceOf[js.Any])
    
    inline def setWebkitAppearanceUndefined: Self = StObject.set(x, "WebkitAppearance", js.undefined)
    
    inline def setWebkitBackdropFilter(value: BackdropFilterProperty): Self = StObject.set(x, "WebkitBackdropFilter", value.asInstanceOf[js.Any])
    
    inline def setWebkitBackdropFilterUndefined: Self = StObject.set(x, "WebkitBackdropFilter", js.undefined)
    
    inline def setWebkitBackfaceVisibility(value: BackfaceVisibilityProperty): Self = StObject.set(x, "WebkitBackfaceVisibility", value.asInstanceOf[js.Any])
    
    inline def setWebkitBackfaceVisibilityUndefined: Self = StObject.set(x, "WebkitBackfaceVisibility", js.undefined)
    
    inline def setWebkitBackgroundClip(value: BackgroundClipProperty): Self = StObject.set(x, "WebkitBackgroundClip", value.asInstanceOf[js.Any])
    
    inline def setWebkitBackgroundClipUndefined: Self = StObject.set(x, "WebkitBackgroundClip", js.undefined)
    
    inline def setWebkitBackgroundOrigin(value: BackgroundOriginProperty): Self = StObject.set(x, "WebkitBackgroundOrigin", value.asInstanceOf[js.Any])
    
    inline def setWebkitBackgroundOriginUndefined: Self = StObject.set(x, "WebkitBackgroundOrigin", js.undefined)
    
    inline def setWebkitBackgroundSize(value: BackgroundSizeProperty[String | Double]): Self = StObject.set(x, "WebkitBackgroundSize", value.asInstanceOf[js.Any])
    
    inline def setWebkitBackgroundSizeUndefined: Self = StObject.set(x, "WebkitBackgroundSize", js.undefined)
    
    inline def setWebkitBorderBefore(value: WebkitBorderBeforeProperty[String | Double]): Self = StObject.set(x, "WebkitBorderBefore", value.asInstanceOf[js.Any])
    
    inline def setWebkitBorderBeforeColor(value: WebkitBorderBeforeColorProperty): Self = StObject.set(x, "WebkitBorderBeforeColor", value.asInstanceOf[js.Any])
    
    inline def setWebkitBorderBeforeColorUndefined: Self = StObject.set(x, "WebkitBorderBeforeColor", js.undefined)
    
    inline def setWebkitBorderBeforeStyle(value: WebkitBorderBeforeStyleProperty): Self = StObject.set(x, "WebkitBorderBeforeStyle", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitBorderBeforeWidth(value: WebkitBorderBeforeWidthProperty[String | Double]): Self = StObject.set(x, "WebkitBorderBeforeWidth", value.asInstanceOf[js.Any])
    
    inline def setWebkitBorderBeforeWidthUndefined: Self = StObject.set(x, "WebkitBorderBeforeWidth", js.undefined)
    
    inline def setWebkitBorderBottomLeftRadius(value: BorderBottomLeftRadiusProperty[String | Double]): Self = StObject.set(x, "WebkitBorderBottomLeftRadius", value.asInstanceOf[js.Any])
    
    inline def setWebkitBorderBottomLeftRadiusUndefined: Self = StObject.set(x, "WebkitBorderBottomLeftRadius", js.undefined)
    
    inline def setWebkitBorderBottomRightRadius(value: BorderBottomRightRadiusProperty[String | Double]): Self = StObject.set(x, "WebkitBorderBottomRightRadius", value.asInstanceOf[js.Any])
    
    inline def setWebkitBorderBottomRightRadiusUndefined: Self = StObject.set(x, "WebkitBorderBottomRightRadius", js.undefined)
    
    inline def setWebkitBorderImage(value: BorderImageProperty): Self = StObject.set(x, "WebkitBorderImage", value.asInstanceOf[js.Any])
    
    inline def setWebkitBorderImageSlice(value: BorderImageSliceProperty): Self = StObject.set(x, "WebkitBorderImageSlice", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitBorderRadius(value: BorderRadiusProperty[String | Double]): Self = StObject.set(x, "WebkitBorderRadius", value.asInstanceOf[js.Any])
    
    inline def setWebkitBorderRadiusUndefined: Self = StObject.set(x, "WebkitBorderRadius", js.undefined)
    
    inline def setWebkitBorderTopLeftRadius(value: BorderTopLeftRadiusProperty[String | Double]): Self = StObject.set(x, "WebkitBorderTopLeftRadius", value.asInstanceOf[js.Any])
    
    inline def setWebkitBorderTopLeftRadiusUndefined: Self = StObject.set(x, "WebkitBorderTopLeftRadius", js.undefined)
    
    inline def setWebkitBorderTopRightRadius(value: BorderTopRightRadiusProperty[String | Double]): Self = StObject.set(x, "WebkitBorderTopRightRadius", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitBoxDecorationBreak(value: BoxDecorationBreakProperty): Self = StObject.set(x, "WebkitBoxDecorationBreak", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitBoxReflect(value: WebkitBoxReflectProperty[String | Double]): Self = StObject.set(x, "WebkitBoxReflect", value.asInstanceOf[js.Any])
    
    inline def setWebkitBoxReflectUndefined: Self = StObject.set(x, "WebkitBoxReflect", js.undefined)
    
    inline def setWebkitBoxShadow(value: BoxShadowProperty): Self = StObject.set(x, "WebkitBoxShadow", value.asInstanceOf[js.Any])
    
    inline def setWebkitBoxShadowUndefined: Self = StObject.set(x, "WebkitBoxShadow", js.undefined)
    
    inline def setWebkitBoxSizing(value: BoxSizingProperty): Self = StObject.set(x, "WebkitBoxSizing", value.asInstanceOf[js.Any])
    
    inline def setWebkitBoxSizingUndefined: Self = StObject.set(x, "WebkitBoxSizing", js.undefined)
    
    inline def setWebkitClipPath(value: ClipPathProperty): Self = StObject.set(x, "WebkitClipPath", value.asInstanceOf[js.Any])
    
    inline def setWebkitClipPathUndefined: Self = StObject.set(x, "WebkitClipPath", js.undefined)
    
    inline def setWebkitColumnCount(value: ColumnCountProperty): Self = StObject.set(x, "WebkitColumnCount", value.asInstanceOf[js.Any])
    
    inline def setWebkitColumnCountUndefined: Self = StObject.set(x, "WebkitColumnCount", js.undefined)
    
    inline def setWebkitColumnFill(value: ColumnFillProperty): Self = StObject.set(x, "WebkitColumnFill", value.asInstanceOf[js.Any])
    
    inline def setWebkitColumnFillUndefined: Self = StObject.set(x, "WebkitColumnFill", js.undefined)
    
    inline def setWebkitColumnGap(value: ColumnGapProperty[String | Double]): Self = StObject.set(x, "WebkitColumnGap", value.asInstanceOf[js.Any])
    
    inline def setWebkitColumnGapUndefined: Self = StObject.set(x, "WebkitColumnGap", js.undefined)
    
    inline def setWebkitColumnRule(value: ColumnRuleProperty[String | Double]): Self = StObject.set(x, "WebkitColumnRule", value.asInstanceOf[js.Any])
    
    inline def setWebkitColumnRuleColor(value: ColumnRuleColorProperty): Self = StObject.set(x, "WebkitColumnRuleColor", value.asInstanceOf[js.Any])
    
    inline def setWebkitColumnRuleColorUndefined: Self = StObject.set(x, "WebkitColumnRuleColor", js.undefined)
    
    inline def setWebkitColumnRuleStyle(value: ColumnRuleStyleProperty): Self = StObject.set(x, "WebkitColumnRuleStyle", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitColumnRuleWidth(value: ColumnRuleWidthProperty[String | Double]): Self = StObject.set(x, "WebkitColumnRuleWidth", value.asInstanceOf[js.Any])
    
    inline def setWebkitColumnRuleWidthUndefined: Self = StObject.set(x, "WebkitColumnRuleWidth", js.undefined)
    
    inline def setWebkitColumnSpan(value: ColumnSpanProperty): Self = StObject.set(x, "WebkitColumnSpan", value.asInstanceOf[js.Any])
    
    inline def setWebkitColumnSpanUndefined: Self = StObject.set(x, "WebkitColumnSpan", js.undefined)
    
    inline def setWebkitColumnWidth(value: ColumnWidthProperty[String | Double]): Self = StObject.set(x, "WebkitColumnWidth", value.asInstanceOf[js.Any])
    
    inline def setWebkitColumnWidthUndefined: Self = StObject.set(x, "WebkitColumnWidth", js.undefined)
    
    inline def setWebkitColumns(value: ColumnsProperty[String | Double]): Self = StObject.set(x, "WebkitColumns", value.asInstanceOf[js.Any])
    
    inline def setWebkitColumnsUndefined: Self = StObject.set(x, "WebkitColumns", js.undefined)
    
    inline def setWebkitFilter(value: FilterProperty): Self = StObject.set(x, "WebkitFilter", value.asInstanceOf[js.Any])
    
    inline def setWebkitFilterUndefined: Self = StObject.set(x, "WebkitFilter", js.undefined)
    
    inline def setWebkitFlex(value: FlexProperty[String | Double]): Self = StObject.set(x, "WebkitFlex", value.asInstanceOf[js.Any])
    
    inline def setWebkitFlexBasis(value: FlexBasisProperty[String | Double]): Self = StObject.set(x, "WebkitFlexBasis", value.asInstanceOf[js.Any])
    
    inline def setWebkitFlexBasisUndefined: Self = StObject.set(x, "WebkitFlexBasis", js.undefined)
    
    inline def setWebkitFlexDirection(value: FlexDirectionProperty): Self = StObject.set(x, "WebkitFlexDirection", value.asInstanceOf[js.Any])
    
    inline def setWebkitFlexDirectionUndefined: Self = StObject.set(x, "WebkitFlexDirection", js.undefined)
    
    inline def setWebkitFlexFlow(value: FlexFlowProperty): Self = StObject.set(x, "WebkitFlexFlow", value.asInstanceOf[js.Any])
    
    inline def setWebkitFlexFlowUndefined: Self = StObject.set(x, "WebkitFlexFlow", js.undefined)
    
    inline def setWebkitFlexGrow(value: GlobalsNumber): Self = StObject.set(x, "WebkitFlexGrow", value.asInstanceOf[js.Any])
    
    inline def setWebkitFlexGrowUndefined: Self = StObject.set(x, "WebkitFlexGrow", js.undefined)
    
    inline def setWebkitFlexShrink(value: GlobalsNumber): Self = StObject.set(x, "WebkitFlexShrink", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitFlexWrap(value: FlexWrapProperty): Self = StObject.set(x, "WebkitFlexWrap", value.asInstanceOf[js.Any])
    
    inline def setWebkitFlexWrapUndefined: Self = StObject.set(x, "WebkitFlexWrap", js.undefined)
    
    inline def setWebkitFontFeatureSettings(value: FontFeatureSettingsProperty): Self = StObject.set(x, "WebkitFontFeatureSettings", value.asInstanceOf[js.Any])
    
    inline def setWebkitFontFeatureSettingsUndefined: Self = StObject.set(x, "WebkitFontFeatureSettings", js.undefined)
    
    inline def setWebkitFontKerning(value: FontKerningProperty): Self = StObject.set(x, "WebkitFontKerning", value.asInstanceOf[js.Any])
    
    inline def setWebkitFontKerningUndefined: Self = StObject.set(x, "WebkitFontKerning", js.undefined)
    
    inline def setWebkitFontSmoothing(value: FontSmoothProperty[String | Double]): Self = StObject.set(x, "WebkitFontSmoothing", value.asInstanceOf[js.Any])
    
    inline def setWebkitFontSmoothingUndefined: Self = StObject.set(x, "WebkitFontSmoothing", js.undefined)
    
    inline def setWebkitFontVariantLigatures(value: FontVariantLigaturesProperty): Self = StObject.set(x, "WebkitFontVariantLigatures", value.asInstanceOf[js.Any])
    
    inline def setWebkitFontVariantLigaturesUndefined: Self = StObject.set(x, "WebkitFontVariantLigatures", js.undefined)
    
    inline def setWebkitHyphens(value: HyphensProperty): Self = StObject.set(x, "WebkitHyphens", value.asInstanceOf[js.Any])
    
    inline def setWebkitHyphensUndefined: Self = StObject.set(x, "WebkitHyphens", js.undefined)
    
    inline def setWebkitJustifyContent(value: JustifyContentProperty): Self = StObject.set(x, "WebkitJustifyContent", value.asInstanceOf[js.Any])
    
    inline def setWebkitJustifyContentUndefined: Self = StObject.set(x, "WebkitJustifyContent", js.undefined)
    
    inline def setWebkitLineBreak(value: LineBreakProperty): Self = StObject.set(x, "WebkitLineBreak", value.asInstanceOf[js.Any])
    
    inline def setWebkitLineBreakUndefined: Self = StObject.set(x, "WebkitLineBreak", js.undefined)
    
    inline def setWebkitLineClamp(value: WebkitLineClampProperty): Self = StObject.set(x, "WebkitLineClamp", value.asInstanceOf[js.Any])
    
    inline def setWebkitLineClampUndefined: Self = StObject.set(x, "WebkitLineClamp", js.undefined)
    
    inline def setWebkitMarginEnd(value: MarginInlineEndProperty[String | Double]): Self = StObject.set(x, "WebkitMarginEnd", value.asInstanceOf[js.Any])
    
    inline def setWebkitMarginEndUndefined: Self = StObject.set(x, "WebkitMarginEnd", js.undefined)
    
    inline def setWebkitMarginStart(value: MarginInlineStartProperty[String | Double]): Self = StObject.set(x, "WebkitMarginStart", value.asInstanceOf[js.Any])
    
    inline def setWebkitMarginStartUndefined: Self = StObject.set(x, "WebkitMarginStart", js.undefined)
    
    inline def setWebkitMask(value: WebkitMaskProperty[String | Double]): Self = StObject.set(x, "WebkitMask", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskAttachment(value: WebkitMaskAttachmentProperty): Self = StObject.set(x, "WebkitMaskAttachment", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskAttachmentUndefined: Self = StObject.set(x, "WebkitMaskAttachment", js.undefined)
    
    inline def setWebkitMaskClip(value: WebkitMaskClipProperty): Self = StObject.set(x, "WebkitMaskClip", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskClipUndefined: Self = StObject.set(x, "WebkitMaskClip", js.undefined)
    
    inline def setWebkitMaskComposite(value: WebkitMaskCompositeProperty): Self = StObject.set(x, "WebkitMaskComposite", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskCompositeUndefined: Self = StObject.set(x, "WebkitMaskComposite", js.undefined)
    
    inline def setWebkitMaskImage(value: WebkitMaskImageProperty): Self = StObject.set(x, "WebkitMaskImage", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskImageUndefined: Self = StObject.set(x, "WebkitMaskImage", js.undefined)
    
    inline def setWebkitMaskOrigin(value: WebkitMaskOriginProperty): Self = StObject.set(x, "WebkitMaskOrigin", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskOriginUndefined: Self = StObject.set(x, "WebkitMaskOrigin", js.undefined)
    
    inline def setWebkitMaskPosition(value: WebkitMaskPositionProperty[String | Double]): Self = StObject.set(x, "WebkitMaskPosition", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskPositionUndefined: Self = StObject.set(x, "WebkitMaskPosition", js.undefined)
    
    inline def setWebkitMaskPositionX(value: WebkitMaskPositionXProperty[String | Double]): Self = StObject.set(x, "WebkitMaskPositionX", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskPositionXUndefined: Self = StObject.set(x, "WebkitMaskPositionX", js.undefined)
    
    inline def setWebkitMaskPositionY(value: WebkitMaskPositionYProperty[String | Double]): Self = StObject.set(x, "WebkitMaskPositionY", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskPositionYUndefined: Self = StObject.set(x, "WebkitMaskPositionY", js.undefined)
    
    inline def setWebkitMaskRepeat(value: WebkitMaskRepeatProperty): Self = StObject.set(x, "WebkitMaskRepeat", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskRepeatUndefined: Self = StObject.set(x, "WebkitMaskRepeat", js.undefined)
    
    inline def setWebkitMaskRepeatX(value: WebkitMaskRepeatXProperty): Self = StObject.set(x, "WebkitMaskRepeatX", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskRepeatXUndefined: Self = StObject.set(x, "WebkitMaskRepeatX", js.undefined)
    
    inline def setWebkitMaskRepeatY(value: WebkitMaskRepeatYProperty): Self = StObject.set(x, "WebkitMaskRepeatY", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaskRepeatYUndefined: Self = StObject.set(x, "WebkitMaskRepeatY", js.undefined)
    
    inline def setWebkitMaskSize(value: WebkitMaskSizeProperty[String | Double]): Self = StObject.set(x, "WebkitMaskSize", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitMaxInlineSize(value: MaxInlineSizeProperty[String | Double]): Self = StObject.set(x, "WebkitMaxInlineSize", value.asInstanceOf[js.Any])
    
    inline def setWebkitMaxInlineSizeUndefined: Self = StObject.set(x, "WebkitMaxInlineSize", js.undefined)
    
    inline def setWebkitOrder(value: GlobalsNumber): Self = StObject.set(x, "WebkitOrder", value.asInstanceOf[js.Any])
    
    inline def setWebkitOrderUndefined: Self = StObject.set(x, "WebkitOrder", js.undefined)
    
    inline def setWebkitOverflowScrolling(value: WebkitOverflowScrollingProperty): Self = StObject.set(x, "WebkitOverflowScrolling", value.asInstanceOf[js.Any])
    
    inline def setWebkitOverflowScrollingUndefined: Self = StObject.set(x, "WebkitOverflowScrolling", js.undefined)
    
    inline def setWebkitPaddingEnd(value: PaddingInlineEndProperty[String | Double]): Self = StObject.set(x, "WebkitPaddingEnd", value.asInstanceOf[js.Any])
    
    inline def setWebkitPaddingEndUndefined: Self = StObject.set(x, "WebkitPaddingEnd", js.undefined)
    
    inline def setWebkitPaddingStart(value: PaddingInlineStartProperty[String | Double]): Self = StObject.set(x, "WebkitPaddingStart", value.asInstanceOf[js.Any])
    
    inline def setWebkitPaddingStartUndefined: Self = StObject.set(x, "WebkitPaddingStart", js.undefined)
    
    inline def setWebkitPerspective(value: PerspectiveProperty[String | Double]): Self = StObject.set(x, "WebkitPerspective", value.asInstanceOf[js.Any])
    
    inline def setWebkitPerspectiveOrigin(value: PerspectiveOriginProperty[String | Double]): Self = StObject.set(x, "WebkitPerspectiveOrigin", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitPrintColorAdjust(value: ColorAdjustProperty): Self = StObject.set(x, "WebkitPrintColorAdjust", value.asInstanceOf[js.Any])
    
    inline def setWebkitPrintColorAdjustUndefined: Self = StObject.set(x, "WebkitPrintColorAdjust", js.undefined)
    
    inline def setWebkitRubyPosition(value: RubyPositionProperty): Self = StObject.set(x, "WebkitRubyPosition", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitScrollSnapType(value: ScrollSnapTypeProperty): Self = StObject.set(x, "WebkitScrollSnapType", value.asInstanceOf[js.Any])
    
    inline def setWebkitScrollSnapTypeUndefined: Self = StObject.set(x, "WebkitScrollSnapType", js.undefined)
    
    inline def setWebkitShapeMargin(value: ShapeMarginProperty[String | Double]): Self = StObject.set(x, "WebkitShapeMargin", value.asInstanceOf[js.Any])
    
    inline def setWebkitShapeMarginUndefined: Self = StObject.set(x, "WebkitShapeMargin", js.undefined)
    
    inline def setWebkitTapHighlightColor(value: WebkitTapHighlightColorProperty): Self = StObject.set(x, "WebkitTapHighlightColor", value.asInstanceOf[js.Any])
    
    inline def setWebkitTapHighlightColorUndefined: Self = StObject.set(x, "WebkitTapHighlightColor", js.undefined)
    
    inline def setWebkitTextCombine(value: TextCombineUprightProperty): Self = StObject.set(x, "WebkitTextCombine", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextCombineUndefined: Self = StObject.set(x, "WebkitTextCombine", js.undefined)
    
    inline def setWebkitTextDecorationColor(value: TextDecorationColorProperty): Self = StObject.set(x, "WebkitTextDecorationColor", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextDecorationColorUndefined: Self = StObject.set(x, "WebkitTextDecorationColor", js.undefined)
    
    inline def setWebkitTextDecorationLine(value: TextDecorationLineProperty): Self = StObject.set(x, "WebkitTextDecorationLine", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextDecorationLineUndefined: Self = StObject.set(x, "WebkitTextDecorationLine", js.undefined)
    
    inline def setWebkitTextDecorationSkip(value: TextDecorationSkipProperty): Self = StObject.set(x, "WebkitTextDecorationSkip", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextDecorationSkipUndefined: Self = StObject.set(x, "WebkitTextDecorationSkip", js.undefined)
    
    inline def setWebkitTextDecorationStyle(value: TextDecorationStyleProperty): Self = StObject.set(x, "WebkitTextDecorationStyle", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextDecorationStyleUndefined: Self = StObject.set(x, "WebkitTextDecorationStyle", js.undefined)
    
    inline def setWebkitTextEmphasis(value: TextEmphasisProperty): Self = StObject.set(x, "WebkitTextEmphasis", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextEmphasisColor(value: TextEmphasisColorProperty): Self = StObject.set(x, "WebkitTextEmphasisColor", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextEmphasisColorUndefined: Self = StObject.set(x, "WebkitTextEmphasisColor", js.undefined)
    
    inline def setWebkitTextEmphasisPosition(value: GlobalsString): Self = StObject.set(x, "WebkitTextEmphasisPosition", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextEmphasisPositionUndefined: Self = StObject.set(x, "WebkitTextEmphasisPosition", js.undefined)
    
    inline def setWebkitTextEmphasisStyle(value: TextEmphasisStyleProperty): Self = StObject.set(x, "WebkitTextEmphasisStyle", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitTextFillColor(value: WebkitTextFillColorProperty): Self = StObject.set(x, "WebkitTextFillColor", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextFillColorUndefined: Self = StObject.set(x, "WebkitTextFillColor", js.undefined)
    
    inline def setWebkitTextOrientation(value: TextOrientationProperty): Self = StObject.set(x, "WebkitTextOrientation", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextOrientationUndefined: Self = StObject.set(x, "WebkitTextOrientation", js.undefined)
    
    inline def setWebkitTextSizeAdjust(value: TextSizeAdjustProperty): Self = StObject.set(x, "WebkitTextSizeAdjust", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextSizeAdjustUndefined: Self = StObject.set(x, "WebkitTextSizeAdjust", js.undefined)
    
    inline def setWebkitTextStroke(value: WebkitTextStrokeProperty[String | Double]): Self = StObject.set(x, "WebkitTextStroke", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextStrokeColor(value: WebkitTextStrokeColorProperty): Self = StObject.set(x, "WebkitTextStrokeColor", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitTextStrokeWidth(value: WebkitTextStrokeWidthProperty[String | Double]): Self = StObject.set(x, "WebkitTextStrokeWidth", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextStrokeWidthUndefined: Self = StObject.set(x, "WebkitTextStrokeWidth", js.undefined)
    
    inline def setWebkitTextUnderlinePosition(value: TextUnderlinePositionProperty): Self = StObject.set(x, "WebkitTextUnderlinePosition", value.asInstanceOf[js.Any])
    
    inline def setWebkitTextUnderlinePositionUndefined: Self = StObject.set(x, "WebkitTextUnderlinePosition", js.undefined)
    
    inline def setWebkitTouchCallout(value: WebkitTouchCalloutProperty): Self = StObject.set(x, "WebkitTouchCallout", value.asInstanceOf[js.Any])
    
    inline def setWebkitTouchCalloutUndefined: Self = StObject.set(x, "WebkitTouchCallout", js.undefined)
    
    inline def setWebkitTransform(value: TransformProperty): Self = StObject.set(x, "WebkitTransform", value.asInstanceOf[js.Any])
    
    inline def setWebkitTransformOrigin(value: TransformOriginProperty[String | Double]): Self = StObject.set(x, "WebkitTransformOrigin", value.asInstanceOf[js.Any])
    
    inline def setWebkitTransformOriginUndefined: Self = StObject.set(x, "WebkitTransformOrigin", js.undefined)
    
    inline def setWebkitTransformStyle(value: TransformStyleProperty): Self = StObject.set(x, "WebkitTransformStyle", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitTransition(value: TransitionProperty): Self = StObject.set(x, "WebkitTransition", value.asInstanceOf[js.Any])
    
    inline def setWebkitTransitionDelay(value: GlobalsString): Self = StObject.set(x, "WebkitTransitionDelay", value.asInstanceOf[js.Any])
    
    inline def setWebkitTransitionDelayUndefined: Self = StObject.set(x, "WebkitTransitionDelay", js.undefined)
    
    inline def setWebkitTransitionDuration(value: GlobalsString): Self = StObject.set(x, "WebkitTransitionDuration", value.asInstanceOf[js.Any])
    
    inline def setWebkitTransitionDurationUndefined: Self = StObject.set(x, "WebkitTransitionDuration", js.undefined)
    
    inline def setWebkitTransitionProperty(value: TransitionPropertyProperty): Self = StObject.set(x, "WebkitTransitionProperty", value.asInstanceOf[js.Any])
    
    inline def setWebkitTransitionPropertyUndefined: Self = StObject.set(x, "WebkitTransitionProperty", js.undefined)
    
    inline def setWebkitTransitionTimingFunction(value: TransitionTimingFunctionProperty): Self = StObject.set(x, "WebkitTransitionTimingFunction", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitUserModify(value: WebkitUserModifyProperty): Self = StObject.set(x, "WebkitUserModify", value.asInstanceOf[js.Any])
    
    inline def setWebkitUserModifyUndefined: Self = StObject.set(x, "WebkitUserModify", js.undefined)
    
    inline def setWebkitUserSelect(value: UserSelectProperty): Self = StObject.set(x, "WebkitUserSelect", value.asInstanceOf[js.Any])
    
    inline def setWebkitUserSelectUndefined: Self = StObject.set(x, "WebkitUserSelect", js.undefined)
    
    inline def setWebkitWritingMode(value: WritingModeProperty): Self = StObject.set(x, "WebkitWritingMode", value.asInstanceOf[js.Any])
    ...
    inline def setWordSpacing(value: WordSpacingProperty[String | Double]): Self = StObject.set(x, "wordSpacing", value.asInstanceOf[js.Any])
