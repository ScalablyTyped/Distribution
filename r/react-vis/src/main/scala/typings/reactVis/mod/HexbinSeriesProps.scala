...
object HexbinSeriesProps {
  ...
  def apply(
    ...
    sizeHexagonsWithCount: js.UndefOr[Boolean] = js.undefined,
    sizeRange: js.Array[
      /* import warning: importer.ImportType#apply Failed type conversion: T['size'] */ js.Any
    ] = null,
    sizeType: Scale = null,
    ...
    if (!js.isUndefined(sizeHexagonsWithCount)) __obj.updateDynamic("sizeHexagonsWithCount")(sizeHexagonsWithCount.get.asInstanceOf[js.Any])
