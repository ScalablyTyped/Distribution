...
@js.native
trait FlexibleXYPlotProps extends js.Object {
...
object FlexibleXYPlotProps {
  @scala.inline
  def apply(): FlexibleXYPlotProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FlexibleXYPlotProps]
  }
  @scala.inline
  implicit class FlexibleXYPlotPropsOps[Self <: FlexibleXYPlotProps] (val x: Self) extends AnyVal {
    @scala.inline
