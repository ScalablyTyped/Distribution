...
object RectSeriesProps {
  ...
  def apply(
    ...
    data: js.Array[RectSeriesPoint | js.Array[_]] = null,
    fill: String | Double = null,
    getColor: RectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getColor0: RectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getOpacity: RectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getOpacity0: RectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getSize: RectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getSize0: RectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getX: RectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getX0: RectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getY: RectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getY0: RectSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    height: js.UndefOr[Double] = js.undefined,
    linePosAttr: String = null,
    lineSizeAttr: String = null,
    onNearestX: (RectSeriesPoint, /* data */ RVNearestXData[RectSeriesPoint]) => Unit = null,
    onNearestXY: (RectSeriesPoint, /* data */ RVNearestXData[RectSeriesPoint]) => Unit = null,
    ...
    onValueClick: (RectSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
    onValueMouseOut: (RectSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
    onValueMouseOver: (RectSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
    onValueRightClick: (RectSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
    ...
    valuePosAttr: String = null,
    valueSizeAttr: String = null,
    ...
    if (linePosAttr != null) __obj.updateDynamic("linePosAttr")(linePosAttr.asInstanceOf[js.Any])
    if (lineSizeAttr != null) __obj.updateDynamic("lineSizeAttr")(lineSizeAttr.asInstanceOf[js.Any])
    ...
    if (valuePosAttr != null) __obj.updateDynamic("valuePosAttr")(valuePosAttr.asInstanceOf[js.Any])
    if (valueSizeAttr != null) __obj.updateDynamic("valueSizeAttr")(valueSizeAttr.asInstanceOf[js.Any])
