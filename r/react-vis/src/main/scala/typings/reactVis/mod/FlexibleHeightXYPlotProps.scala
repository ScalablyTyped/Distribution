...
@js.native
trait FlexibleHeightXYPlotProps extends js.Object {
...
object FlexibleHeightXYPlotProps {
  ...
  @scala.inline
  def apply(): FlexibleHeightXYPlotProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FlexibleHeightXYPlotProps]
  }
  
  @scala.inline
  implicit class FlexibleHeightXYPlotPropsOps[Self <: FlexibleHeightXYPlotProps] (val x: Self) extends AnyVal {
