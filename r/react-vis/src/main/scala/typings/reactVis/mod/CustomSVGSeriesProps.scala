...
trait CustomSVGSeriesProps extends AbstractSeriesProps[CustomSVGSeriesPoint] {
  var customComponent: js.UndefOr[String | (js.Function1[/* row */ js.Any, _])] = js.undefined
   // default: 'circle'
...
object CustomSVGSeriesProps {
  ...
  def apply(
    ...
    customComponent: String | (js.Function1[/* row */ js.Any, _]) = null,
    data: js.Array[CustomSVGSeriesPoint | js.Array[_]] = null,
    fill: String | Double = null,
    getColor: CustomSVGSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getColor0: CustomSVGSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getOpacity: CustomSVGSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getOpacity0: CustomSVGSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getSize: CustomSVGSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getSize0: CustomSVGSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getX: CustomSVGSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getX0: CustomSVGSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getY: CustomSVGSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getY0: CustomSVGSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    height: js.UndefOr[Double] = js.undefined,
    marginLeft: js.UndefOr[Double] = js.undefined,
    marginTop: js.UndefOr[Double] = js.undefined,
    onNearestX: (CustomSVGSeriesPoint, /* data */ RVNearestXData[CustomSVGSeriesPoint]) => Unit = null,
    onNearestXY: (CustomSVGSeriesPoint, /* data */ RVNearestXData[CustomSVGSeriesPoint]) => Unit = null,
    ...
    onValueClick: (CustomSVGSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
    onValueMouseOut: (CustomSVGSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
    onValueMouseOver: (CustomSVGSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
    onValueRightClick: (CustomSVGSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
