...
trait LineMarkSeriesProps extends AbstractSeriesProps[LineMarkSeriesPoint] {
  var curve: js.UndefOr[String | (js.Function1[/* x */ js.Any, _])] = js.undefined
   // default: null
...
object LineMarkSeriesProps {
  ...
  def apply(
    ...
    curve: String | (js.Function1[/* x */ js.Any, _]) = null,
    ...
    getNull: LineMarkSeriesPoint => js.Any = null,
    ...
    lineStyle: CSSProperties = null,
    markStyle: CSSProperties = null,
    ...
    if (getNull != null) __obj.updateDynamic("getNull")(js.Any.fromFunction1(getNull))
    ...
    if (markStyle != null) __obj.updateDynamic("markStyle")(markStyle.asInstanceOf[js.Any])
