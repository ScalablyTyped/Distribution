...
object CircularGridLinesProps {
  ...
  inline def apply(): CircularGridLinesProps = {
  ...
  extension [Self <: CircularGridLinesProps](x: Self) {
    ...
    inline def setRRange(value: js.Array[Double]): Self = StObject.set(x, "rRange", value.asInstanceOf[js.Any])
    ...
    inline def setTickValues(value: js.Array[Double]): Self = StObject.set(x, "tickValues", value.asInstanceOf[js.Any])
