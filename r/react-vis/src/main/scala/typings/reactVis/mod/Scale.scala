...
/* Rewritten from type alias, can be one of: 
  - typings.reactVis.reactVisStrings.linear
  - typings.reactVis.reactVisStrings.ordinal
  - typings.reactVis.reactVisStrings.category
  - typings.reactVis.reactVisStrings.literal
  - typings.reactVis.reactVisStrings.log
  - typings.reactVis.reactVisStrings.time
  - typings.reactVis.reactVisStrings.`time-utc`
*/
