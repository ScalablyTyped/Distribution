...
object ArcSeriesProps {
  @scala.inline
  def apply(
    _angleValue: /* import warning: importer.ImportType#apply Failed type conversion: react-vis.react-vis.ArcSeriesPoint['_angle'] */ js.Any = null,
    ...
    _radiusValue: /* import warning: importer.ImportType#apply Failed type conversion: react-vis.react-vis.ArcSeriesPoint['_radius'] */ js.Any = null,
    ...
    angleBaseValue: js.UndefOr[Double] = js.undefined,
    angleDistance: js.UndefOr[Double] = js.undefined,
    angleDomain: js.Array[Double] = null,
    angleRange: js.Array[Double] = null,
    angleType: Scale = null,
    animation: String | AnimationParam | Boolean = null,
    arcClassName: String = null,
    center: X = null,
    ...
    data: js.Array[ArcSeriesPoint | js.Array[_]] = null,
    fill: String | Double = null,
    getAngle: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getAngle0: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getColor: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getColor0: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getOpacity: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getOpacity0: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getRadius: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getRadius0: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getSize: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getSize0: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getX: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getX0: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getY: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    getY0: ArcSeriesPoint => /* import warning: importer.ImportType#apply Failed type conversion: T[K] */ js.Any = null,
    height: js.UndefOr[Double] = js.undefined,
    onNearestX: (ArcSeriesPoint, /* data */ RVNearestXData[ArcSeriesPoint]) => Unit = null,
    onNearestXY: (ArcSeriesPoint, /* data */ RVNearestXData[ArcSeriesPoint]) => Unit = null,
    ...
    onValueClick: (ArcSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
    onValueMouseOut: (ArcSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
    onValueMouseOver: (ArcSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
    onValueRightClick: (ArcSeriesPoint, /* event */ MouseEvent[HTMLElement, NativeMouseEvent]) => Unit = null,
    ...
    radiusBaseValue: js.UndefOr[Double] = js.undefined,
    radiusDistance: js.UndefOr[Double] = js.undefined,
    radiusDomain: js.Array[Double] = null,
    radiusRange: js.Array[Double] = null,
    radiusType: Scale = null,
    ...
    if (_angleValue != null) __obj.updateDynamic("_angleValue")(_angleValue.asInstanceOf[js.Any])
    ...
    if (_radiusValue != null) __obj.updateDynamic("_radiusValue")(_radiusValue.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(angleBaseValue)) __obj.updateDynamic("angleBaseValue")(angleBaseValue.get.asInstanceOf[js.Any])
    if (!js.isUndefined(angleDistance)) __obj.updateDynamic("angleDistance")(angleDistance.get.asInstanceOf[js.Any])
    if (angleDomain != null) __obj.updateDynamic("angleDomain")(angleDomain.asInstanceOf[js.Any])
    if (angleRange != null) __obj.updateDynamic("angleRange")(angleRange.asInstanceOf[js.Any])
    if (angleType != null) __obj.updateDynamic("angleType")(angleType.asInstanceOf[js.Any])
    if (animation != null) __obj.updateDynamic("animation")(animation.asInstanceOf[js.Any])
    if (arcClassName != null) __obj.updateDynamic("arcClassName")(arcClassName.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(radiusBaseValue)) __obj.updateDynamic("radiusBaseValue")(radiusBaseValue.get.asInstanceOf[js.Any])
    if (!js.isUndefined(radiusDistance)) __obj.updateDynamic("radiusDistance")(radiusDistance.get.asInstanceOf[js.Any])
    if (radiusDomain != null) __obj.updateDynamic("radiusDomain")(radiusDomain.asInstanceOf[js.Any])
    if (radiusRange != null) __obj.updateDynamic("radiusRange")(radiusRange.asInstanceOf[js.Any])
    if (radiusType != null) __obj.updateDynamic("radiusType")(radiusType.asInstanceOf[js.Any])
