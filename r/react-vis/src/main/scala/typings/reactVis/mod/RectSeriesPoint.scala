...
object RectSeriesPoint {
  ...
  implicit class RectSeriesPointOps[Self <: RectSeriesPoint] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setX0(value: String | Double | Date): Self = this.set("x0", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setY(value: String | Double | Date): Self = this.set("y", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setY0(value: String | Double | Date): Self = this.set("y0", value.asInstanceOf[js.Any])
