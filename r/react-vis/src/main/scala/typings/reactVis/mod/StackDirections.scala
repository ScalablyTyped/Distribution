...
/* Rewritten from type alias, can be one of: 
  - typings.reactVis.reactVisStrings.x
  - typings.reactVis.reactVisStrings.y
  - typings.reactVis.reactVisStrings.radius
  - typings.reactVis.reactVisStrings.angle
  - typings.reactVis.reactVisStrings.color
  - typings.reactVis.reactVisStrings.fill
  - typings.reactVis.reactVisStrings.stroke
