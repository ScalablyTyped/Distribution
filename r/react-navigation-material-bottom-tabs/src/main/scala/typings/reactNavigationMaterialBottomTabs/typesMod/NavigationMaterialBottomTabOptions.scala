...
import typings.reactNavigationMaterialBottomTabs.AnonDefaultHandler
import typings.reactNavigationMaterialBottomTabs.AnonFocused
...
trait NavigationMaterialBottomTabOptions extends js.Object {
  ...
  var tabBarIcon: js.UndefOr[ReactNode | (js.Function1[/* props */ AnonFocused, ReactNode])] = js.undefined
...
object NavigationMaterialBottomTabOptions {
  ...
  def apply(
    ...
    tabBarIcon: ReactNode | (js.Function1[/* props */ AnonFocused, ReactNode]) = null,
