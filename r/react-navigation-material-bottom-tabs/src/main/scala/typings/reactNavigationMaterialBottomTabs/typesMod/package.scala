...
package object typesMod {
  ...
  ]) with typings.reactNavigationMaterialBottomTabs.AnonActiveColorDark
  ...
  ]) with (typings.reactNavigationMaterialBottomTabs.AnonNavigationOptions[Params, ScreenProps])
