...
import typings.reactNavigationMaterialBottomTabs.AnonColor
import typings.reactNavigationMaterialBottomTabs.AnonRouteAnonKey
...
trait MaterialBottomTabView
  ...
  def _renderIcon(hasRouteFocusedColor: AnonColor): ReactNode = js.native
}
