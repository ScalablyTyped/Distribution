...
import typings.reactDashNavigationDashMaterialDashBottomDashTabs.Anon_DefaultHandler
import typings.reactDashNavigationDashMaterialDashBottomDashTabs.Anon_Focused
...
trait NavigationMaterialBottomTabOptions extends js.Object {
  ...
  var tabBarIcon: js.UndefOr[ReactNode | (js.Function1[/* props */ Anon_Focused, ReactNode])] = js.undefined
  var tabBarLabel: js.UndefOr[ReactNode] = js.undefined
  var tabBarOnPress: js.UndefOr[js.Function1[/* props */ Anon_DefaultHandler, Unit]] = js.undefined
...
object NavigationMaterialBottomTabOptions {
  ...
  def apply(
    ...
    tabBarIcon: ReactNode | (js.Function1[/* props */ Anon_Focused, ReactNode]) = null,
    tabBarLabel: ReactNode = null,
    tabBarOnPress: /* props */ Anon_DefaultHandler => Unit = null,
