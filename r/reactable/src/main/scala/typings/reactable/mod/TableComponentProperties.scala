...
object TableComponentProperties {
  ...
  def apply[T](
    ...
    pageButtonLimit: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(hideFilterInput)) __obj.updateDynamic("hideFilterInput")(hideFilterInput.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(pageButtonLimit)) __obj.updateDynamic("pageButtonLimit")(pageButtonLimit.get.asInstanceOf[js.Any])
