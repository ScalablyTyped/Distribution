...
object IProps {
  ...
  implicit class IPropsOps[Self <: IProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderThumb(value: IsDragged => ReactNode): Self = this.set("renderThumb", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRenderMark(value: /* params */ Index => ReactNode): Self = this.set("renderMark", js.Any.fromFunction1(value))
