...
object Props {
  ...
  def apply[HolderProps /* <: js.Object */](
    ...
    if (boundaryElement != null) __obj.updateDynamic("boundaryElement")(boundaryElement.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(hideOnBoundaryHit)) __obj.updateDynamic("hideOnBoundaryHit")(hideOnBoundaryHit.asInstanceOf[js.Any])
    if (holderCmp != null) __obj.updateDynamic("holderCmp")(holderCmp.asInstanceOf[js.Any])
    ...
    if (wrapperCmp != null) __obj.updateDynamic("wrapperCmp")(wrapperCmp.asInstanceOf[js.Any])
