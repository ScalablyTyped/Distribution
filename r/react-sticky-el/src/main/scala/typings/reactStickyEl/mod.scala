  ...
  object Sticky {
    ...
    trait Props[HolderProps /* <: js.Object */]
      ...
      var holderCmp: js.UndefOr[
            /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 119, starting with typings.reactStickyEl.reactStickyElStrings.a, typings.reactStickyEl.reactStickyElStrings.abbr, typings.reactStickyEl.reactStickyElStrings.address */ Any
          ] = js.undefined
    ...
    object Props {
      ...
      implicit open class MutableBuilder[Self <: Props[?], HolderProps /* <: js.Object */] (val x: Self & Props[HolderProps]) extends AnyVal {
        ...
        inline def setHolderCmp(
          value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 119, starting with typings.reactStickyEl.reactStickyElStrings.a, typings.reactStickyEl.reactStickyElStrings.abbr, typings.reactStickyEl.reactStickyElStrings.address */ Any
