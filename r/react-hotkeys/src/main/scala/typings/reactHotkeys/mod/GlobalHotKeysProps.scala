...
object GlobalHotKeysProps {
  ...
  def apply(
    ...
    keyMap: KeyMap = null,
    lang: String = null,
    onAbort: SyntheticEvent[HotKeys, Event] => Unit = null,
    onAnimationEnd: AnimationEvent[HotKeys] => Unit = null,
    onAnimationIteration: AnimationEvent[HotKeys] => Unit = null,
    onAnimationStart: AnimationEvent[HotKeys] => Unit = null,
    onAuxClick: MouseEvent[HotKeys, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[HotKeys] => Unit = null,
    onBlur: FocusEvent[HotKeys] => Unit = null,
    onCanPlay: SyntheticEvent[HotKeys, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HotKeys, Event] => Unit = null,
    onChange: FormEvent[HotKeys] => Unit = null,
    onClick: MouseEvent[HotKeys, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[HotKeys] => Unit = null,
    onCompositionStart: CompositionEvent[HotKeys] => Unit = null,
    onCompositionUpdate: CompositionEvent[HotKeys] => Unit = null,
    onContextMenu: MouseEvent[HotKeys, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[HotKeys] => Unit = null,
    onCut: ClipboardEvent[HotKeys] => Unit = null,
    onDoubleClick: MouseEvent[HotKeys, NativeMouseEvent] => Unit = null,
    onDrag: DragEvent[HotKeys] => Unit = null,
    onDragEnd: DragEvent[HotKeys] => Unit = null,
    onDragEnter: DragEvent[HotKeys] => Unit = null,
    onDragExit: DragEvent[HotKeys] => Unit = null,
    onDragLeave: DragEvent[HotKeys] => Unit = null,
    onDragOver: DragEvent[HotKeys] => Unit = null,
    onDragStart: DragEvent[HotKeys] => Unit = null,
    onDrop: DragEvent[HotKeys] => Unit = null,
    onDurationChange: SyntheticEvent[HotKeys, Event] => Unit = null,
    onEmptied: SyntheticEvent[HotKeys, Event] => Unit = null,
    onEncrypted: SyntheticEvent[HotKeys, Event] => Unit = null,
    onEnded: SyntheticEvent[HotKeys, Event] => Unit = null,
    onError: SyntheticEvent[HotKeys, Event] => Unit = null,
    onFocus: FocusEvent[HotKeys] => Unit = null,
    onInput: FormEvent[HotKeys] => Unit = null,
    onInvalid: FormEvent[HotKeys] => Unit = null,
    onKeyDown: typings.react.mod.KeyboardEvent[HotKeys] => Unit = null,
    onKeyPress: typings.react.mod.KeyboardEvent[HotKeys] => Unit = null,
    onKeyUp: typings.react.mod.KeyboardEvent[HotKeys] => Unit = null,
    onLoad: SyntheticEvent[HotKeys, Event] => Unit = null,
    onLoadStart: SyntheticEvent[HotKeys, Event] => Unit = null,
    onLoadedData: SyntheticEvent[HotKeys, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HotKeys, Event] => Unit = null,
    onMouseDown: MouseEvent[HotKeys, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[HotKeys, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[HotKeys, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[HotKeys, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[HotKeys, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[HotKeys, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[HotKeys, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[HotKeys] => Unit = null,
    onPause: SyntheticEvent[HotKeys, Event] => Unit = null,
    onPlay: SyntheticEvent[HotKeys, Event] => Unit = null,
    onPlaying: SyntheticEvent[HotKeys, Event] => Unit = null,
    onPointerCancel: PointerEvent[HotKeys] => Unit = null,
    onPointerDown: PointerEvent[HotKeys] => Unit = null,
    onPointerEnter: PointerEvent[HotKeys] => Unit = null,
    onPointerLeave: PointerEvent[HotKeys] => Unit = null,
    onPointerMove: PointerEvent[HotKeys] => Unit = null,
    onPointerOut: PointerEvent[HotKeys] => Unit = null,
    onPointerOver: PointerEvent[HotKeys] => Unit = null,
    onPointerUp: PointerEvent[HotKeys] => Unit = null,
    onProgress: SyntheticEvent[HotKeys, Event] => Unit = null,
    onRateChange: SyntheticEvent[HotKeys, Event] => Unit = null,
    onReset: FormEvent[HotKeys] => Unit = null,
    onScroll: UIEvent[HotKeys, NativeUIEvent] => Unit = null,
    onSeeked: SyntheticEvent[HotKeys, Event] => Unit = null,
    onSeeking: SyntheticEvent[HotKeys, Event] => Unit = null,
    onSelect: SyntheticEvent[HotKeys, Event] => Unit = null,
    onStalled: SyntheticEvent[HotKeys, Event] => Unit = null,
    onSubmit: FormEvent[HotKeys] => Unit = null,
    onSuspend: SyntheticEvent[HotKeys, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[HotKeys, Event] => Unit = null,
    onTouchCancel: TouchEvent[HotKeys] => Unit = null,
    onTouchEnd: TouchEvent[HotKeys] => Unit = null,
    onTouchMove: TouchEvent[HotKeys] => Unit = null,
    onTouchStart: TouchEvent[HotKeys] => Unit = null,
    onTransitionEnd: TransitionEvent[HotKeys] => Unit = null,
    ...
    if (!js.isUndefined(allowChanges)) __obj.updateDynamic("allowChanges")(allowChanges.get.asInstanceOf[js.Any])
