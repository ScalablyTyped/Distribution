...
object ReactNativePhoneInputProps {
  ...
  def apply[TextComponentType /* <: ComponentType[js.Object] */](
    ...
    if (!js.isUndefined(allowZeroAfterCountryCode)) __obj.updateDynamic("allowZeroAfterCountryCode")(allowZeroAfterCountryCode)
    ...
    if (countriesList != null) __obj.updateDynamic("countriesList")(countriesList)
    ...
    if (pickerBackgroundColor != null) __obj.updateDynamic("pickerBackgroundColor")(pickerBackgroundColor)
    if (pickerButtonColor != null) __obj.updateDynamic("pickerButtonColor")(pickerButtonColor)
