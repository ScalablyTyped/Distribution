...
trait State extends js.Object {
  var displayedChildren: js.Array[reactLib.reactMod.ReactElement[_]]
  var finishedLeaving: org.scalablytyped.runtime.StringDictionary[scala.Boolean]
  var hasInitialized: scala.Boolean
  var indexedChildren: org.scalablytyped.runtime.StringDictionary[reactLib.reactMod.ReactElement[_]]
...
object State {
  @scala.inline
  def apply(
    displayedChildren: js.Array[reactLib.reactMod.ReactElement[_]],
    finishedLeaving: org.scalablytyped.runtime.StringDictionary[scala.Boolean],
    hasInitialized: scala.Boolean,
    indexedChildren: org.scalablytyped.runtime.StringDictionary[reactLib.reactMod.ReactElement[_]],
