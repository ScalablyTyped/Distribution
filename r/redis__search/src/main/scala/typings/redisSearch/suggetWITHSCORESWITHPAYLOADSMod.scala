...
object suggetWITHSCORESWITHPAYLOADSMod {
  ...
  - typings.redisSearch.suggetWITHPAYLOADSMod.SuggestionWithPayload because var conflicts: suggestion. Inlined payload */ trait SuggestionWithScoresAndPayloads
    extends StObject
