...
trait Observable[T] extends js.Object {
  ...
  def replay(selector: scala.Boolean): ConnectableObservable[T] = js.native
  def replay(selector: scala.Boolean, bufferSize: scala.Double): ConnectableObservable[T] = js.native
  def replay(selector: scala.Boolean, bufferSize: scala.Double, window: scala.Double): ConnectableObservable[T] = js.native
  def replay(
    selector: scala.Boolean,
    bufferSize: scala.Double,
    window: scala.Double,
    scheduler: rxDashCoreLib.RxNs.IScheduler
  ...
  def shareReplay(bufferSize: scala.Double): Observable[T] = js.native
  def shareReplay(bufferSize: scala.Double, window: scala.Double): Observable[T] = js.native
  def shareReplay(bufferSize: scala.Double, window: scala.Double, scheduler: rxDashCoreLib.RxNs.IScheduler): Observable[T] = js.native
  /**
