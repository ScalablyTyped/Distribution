...
trait IElement extends IService {
  var id: js.UndefOr[scala.Double | java.lang.String] = js.native
  ...
  def getRequestedUrl(): java.lang.String = js.native
  def getRestangularUrl(): java.lang.String = js.native
  @JSName("get")
  ...
  def withHttpConfig(httpConfig: angularLib.angularMod.angularNs.IRequestShortcutConfig): IElement = js.native
}
