...
trait ICollection
  ...
  @JSName("plain")
  def plain_TArray[T](): js.Array[T] = js.native
  ...
  def withHttpConfig(httpConfig: angularLib.angularMod.angularNs.IRequestShortcutConfig): ICollection = js.native
}
