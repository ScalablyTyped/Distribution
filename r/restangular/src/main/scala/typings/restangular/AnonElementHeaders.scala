...
trait AnonElementHeaders extends js.Object {
  var element: js.Any
  var headers: js.Any
...
object AnonElementHeaders {
  @scala.inline
  def apply(element: js.Any, headers: js.Any, httpConfig: IRequestShortcutConfig, params: js.Any): AnonElementHeaders = {
    ...
    __obj.asInstanceOf[AnonElementHeaders]
  }
}
