...
class Pane[P /* <: PaneProps */, S /* <: PaneState */] ()
  ...
  def getPane(): js.UndefOr[stdLib.HTMLElement | scala.Null] = js.native
  def getPane(name: java.lang.String): js.UndefOr[stdLib.HTMLElement | scala.Null] = js.native
  def getParentPane(): js.UndefOr[stdLib.HTMLElement | scala.Null] = js.native
