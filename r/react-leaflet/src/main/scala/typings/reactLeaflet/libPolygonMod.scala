...
object libPolygonMod {
  
  @JSImport("react-leaflet/lib/Polygon", "Polygon")
  @js.native
  ...
  - typings.reactLeafletCore.libPathMod.PathProps because var conflicts: attribution, bubblingMouseEvents, interactive, pane. Inlined pathOptions */ trait PolygonProps
    extends StObject
