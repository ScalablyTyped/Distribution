...
object anon {
  ...
  trait Typeoftypes extends StObject {
    ...
    def isPlaceholderType(
      placeholderType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typings.reactRefresh.reactRefreshStrings.ClassAccessorProperty, typings.reactRefresh.reactRefreshStrings.AnyTypeAnnotation, typings.reactRefresh.reactRefreshStrings.ArgumentPlaceholder */ Any,
      targetType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typings.reactRefresh.reactRefreshStrings.ClassAccessorProperty, typings.reactRefresh.reactRefreshStrings.AnyTypeAnnotation, typings.reactRefresh.reactRefreshStrings.ArgumentPlaceholder */ Any
    ): Boolean = js.native
    ...
    def isType[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typings.reactRefresh.reactRefreshStrings.ClassAccessorProperty, typings.reactRefresh.reactRefreshStrings.AnyTypeAnnotation, typings.reactRefresh.reactRefreshStrings.ArgumentPlaceholder */ Any */](nodetype: String, targetType: T): /* is T */ Boolean = js.native
