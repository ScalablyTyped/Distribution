...
object BaseTransitionProps {
  ...
  @scala.inline
  implicit class BaseTransitionPropsOps[Self <: BaseTransitionProps[_], RefElement /* <: js.UndefOr[HTMLElement] */] (val x: Self with BaseTransitionProps[RefElement]) extends AnyVal {
