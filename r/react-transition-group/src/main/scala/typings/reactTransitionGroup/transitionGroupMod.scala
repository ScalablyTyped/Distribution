...
object transitionGroupMod {
  ...
  trait IntrinsicTransitionGroupProps[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typings.reactTransitionGroup.reactTransitionGroupStrings.a, typings.reactTransitionGroup.reactTransitionGroupStrings.abbr, typings.reactTransitionGroup.reactTransitionGroupStrings.address */ Any */]
    extends StObject
       with TransitionActions {
  ...
  object IntrinsicTransitionGroupProps {
    ...
    inline def apply[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typings.reactTransitionGroup.reactTransitionGroupStrings.a, typings.reactTransitionGroup.reactTransitionGroupStrings.abbr, typings.reactTransitionGroup.reactTransitionGroupStrings.address */ Any */](): IntrinsicTransitionGroupProps[T] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[IntrinsicTransitionGroupProps[T]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: IntrinsicTransitionGroupProps[?], T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typings.reactTransitionGroup.reactTransitionGroupStrings.a, typings.reactTransitionGroup.reactTransitionGroupStrings.abbr, typings.reactTransitionGroup.reactTransitionGroupStrings.address */ Any */] (val x: Self & IntrinsicTransitionGroupProps[T]) extends AnyVal {
