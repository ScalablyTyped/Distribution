...
object mod {
  ...
  object ReactCropperProps {
    ...
    inline def apply(): ReactCropperProps = {
    ...
    implicit open class MutableBuilder[Self <: ReactCropperProps] (val x: Self) extends AnyVal {
      ...
      inline def setRef(value: LegacyRef[ReactCropper]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      inline def setRefFunction1(value: /* instance */ ReactCropper | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
