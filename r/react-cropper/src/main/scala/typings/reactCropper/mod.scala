package typings.reactCropper

import typings.cropperjs.Cropper
import typings.cropperjs.Cropper.CropEndEvent
...
import typings.reactCropper.reactCropperStrings.`removals additions`
...
object mod {
  ...
  object ReactCropperProps {
    ...
    @scala.inline
    def apply(): ReactCropperProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ReactCropperProps]
    }
    
    @scala.inline
    implicit class ReactCropperPropsMutableBuilder[Self <: ReactCropperProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRef(value: LegacyRef[ReactCropper]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRefFunction1(value: /* instance */ ReactCropper | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
