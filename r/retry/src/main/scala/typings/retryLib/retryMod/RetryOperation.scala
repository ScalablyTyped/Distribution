...
trait RetryOperation extends js.Object {
  /**
    ...
    */
  def attempt(fn: js.Function1[/* currentAttempt */ scala.Double, scala.Unit]): scala.Unit = js.native
  def attempt(fn: js.Function1[/* currentAttempt */ scala.Double, scala.Unit], timeoutOps: AttemptTimeoutOptions): scala.Unit = js.native
  /**
