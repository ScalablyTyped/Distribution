...
trait ReactImageGalleryItem extends js.Object {
  ...
  var renderItem: js.UndefOr[js.Function1[/* item */ js.UndefOr[this.type], ReactNode]] = js.native
  var renderThumbInner: js.UndefOr[js.Function1[/* item */ js.UndefOr[this.type], ReactNode]] = js.native
...
object ReactImageGalleryItem {
  ...
  implicit class ReactImageGalleryItemOps[Self <: ReactImageGalleryItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderItem(value: /* item */ js.UndefOr[ReactImageGalleryItem] => ReactNode): Self = this.set("renderItem", js.Any.fromFunction1(value))
    @scala.inline
    def deleteRenderItem: Self = this.set("renderItem", js.undefined)
    @scala.inline
    def setRenderThumbInner(value: /* item */ js.UndefOr[ReactImageGalleryItem] => ReactNode): Self = this.set("renderThumbInner", js.Any.fromFunction1(value))
    @scala.inline
