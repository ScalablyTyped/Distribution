...
object ContextCtx {
  ...
  @scala.inline
  implicit class ContextCtxOps[Self <: ContextCtx[_, _], Ctx, /* <: js.ThisFunction1[/ * this * / Ctx, / * repeated * / js.Any, scala.Unit] */ Fn] (val x: Self with (ContextCtx[Ctx, Fn])) extends AnyVal {
    @scala.inline
