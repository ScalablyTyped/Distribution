...
import typings.reactDashRelay.libRelayDashExperimentalEntryPointTypesMod.PreloadFetchPolicy
import typings.reactDashRelay.libRelayDashExperimentalQueryResourceMod.RenderPolicy
import typings.reactDashRelay.libRelayDashExperimentalUseLoadMoreFunctionMod.Direction
...
object reactDashRelayStrings {
  ...
  sealed trait `network-only`
    extends FetchPolicy
       with typings.reactDashRelay.libRelayDashExperimentalQueryResourceMod.FetchPolicy
  ...
  sealed trait `store-only`
    extends typings.reactDashRelay.libRelayDashExperimentalQueryResourceMod.FetchPolicy
