...
object ReturnType {
  ...
  def apply[TQuery /* <: OperationType */, TKey, TFragmentData](
    ...
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], hasNext = hasNext, hasPrevious = hasPrevious, loadNext = js.Any.fromFunction2(loadNext), loadPrevious = js.Any.fromFunction2(loadPrevious), refetch = refetch)
