...
/* import warning: importer.ImportType#apply Failed type conversion: TEntryPointComponent extends react-relay.react-relay/relay-hooks/EntryPointTypes.EntryPointComponent<any, infer TNestedEntryPoints, any, any> ? TNestedEntryPoints : never */ js.Any, 
...
type EntryPointComponent[TPreloadedQueries /* <: Record[String, OperationType] */, TNestedEntryPoints /* <: Record[String, js.UndefOr[EntryPoint[Any, Any]]] */, TRuntimeProps /* <: js.Object */, TExtraProps /* <: js.Object | Null */] = ComponentType[
