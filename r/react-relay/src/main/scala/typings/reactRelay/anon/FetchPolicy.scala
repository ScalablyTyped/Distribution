...
trait FetchPolicy extends Action {
  ...
  var fetchPolicy: js.UndefOr[typings.reactRelay.queryResourceMod.FetchPolicy] = js.native
...
object FetchPolicy {
  ...
  implicit class FetchPolicyOps[Self <: FetchPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFetchPolicy(value: typings.reactRelay.queryResourceMod.FetchPolicy): Self = this.set("fetchPolicy", value.asInstanceOf[js.Any])
    @scala.inline
