...
import typings.roads.roadMod.IncomingHeaders
import typings.roads.roadMod.NextCallback
...
object basicRouterMod {
  ...
  open class BasicRouter () extends StObject {
    ...
    /* protected */ def _middleware(
      ...
      next: NextCallback
    ): js.Promise[typings.roads.responseMod.default | String] = js.native
  ...
  object BasicRouterURL {
    ...
    extension [Self <: BasicRouterURL](x: Self) {
  ...
  trait RouteDetails extends StObject {
    ...
    def route(path: BasicRouterURL, body: String, headers: IncomingHeaders, next: NextCallback): js.Promise[typings.roads.responseMod.default]
    @JSName("route")
