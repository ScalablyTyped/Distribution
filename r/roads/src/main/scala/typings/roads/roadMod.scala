...
object roadMod {
  ...
  type Middleware[MiddlewareContext /* <: Context */] = js.ThisFunction5[
    ...
    /* next */ NextCallback, 
    (js.Promise[typings.roads.responseMod.default | String]) | typings.roads.responseMod.default | String
  ]
  
  type NextCallback = js.Function0[js.Promise[typings.roads.responseMod.default | String]]
  ...
  trait Road extends StObject {
    ...
    def request(method: String, url: String, body: String, headers: IncomingHeaders): js.Promise[typings.roads.responseMod.default] = js.native
    def request(method: String, url: String, body: Unit, headers: IncomingHeaders): js.Promise[typings.roads.responseMod.default] = js.native
