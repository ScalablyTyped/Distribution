...
object requestMod {
  ...
  trait Request extends StObject {
    ...
    def request(method: String, path: String, body: String, headers: IncomingHeaders): js.Promise[typings.roads.responseMod.default] = js.native
    def request(method: String, path: String, body: Unit, headers: IncomingHeaders): js.Promise[typings.roads.responseMod.default] = js.native
