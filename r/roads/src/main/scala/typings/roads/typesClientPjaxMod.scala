...
object typesClientPjaxMod {
  ...
  open class default protected ()
    ...
    /**
      ...
      */
    def this(road: typings.roads.typesCoreRoadMod.default, containerElement: HTMLElement, window: Window) = this()
    ...
    /* protected */ /* CompleteClass */
    var _road: typings.roads.typesCoreRoadMod.default = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def render(response_object: typings.roads.typesCoreResponseMod.default): Unit = js.native
  }
  ...
  trait RoadsPjax extends StObject {
    ...
    /* protected */ var _road: typings.roads.typesCoreRoadMod.default
    ...
    /**
      ...
      * @param {Response} response_object
      */
    def render(response_object: typings.roads.typesCoreResponseMod.default): Unit
  }
  object RoadsPjax {
    ...
    inline def apply(
      ...
      _road: typings.roads.typesCoreRoadMod.default,
      ...
      render: typings.roads.typesCoreResponseMod.default => Unit
    ): RoadsPjax = {
    ...
    implicit open class MutableBuilder[Self <: RoadsPjax] (val x: Self) extends AnyVal {
      ...
      inline def setRender(value: typings.roads.typesCoreResponseMod.default => Unit): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
      ...
      inline def set_road(value: typings.roads.typesCoreRoadMod.default): Self = StObject.set(x, "_road", value.asInstanceOf[js.Any])
