...
class Road () extends js.Object {
  /**
    ...
    */
  def request(method: java.lang.String, url: java.lang.String): js.Any = js.native
  def request(method: java.lang.String, url: java.lang.String, body: js.Any): js.Any = js.native
  def request(method: java.lang.String, url: java.lang.String, body: js.Any, headers: stdLib.Headers): js.Any = js.native
  /**
