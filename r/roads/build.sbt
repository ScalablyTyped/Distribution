...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "babelify" % "v7.3.0-dt-20200225Z-a0f558",
  "org.scalablytyped" %%% "babylon" % "6.16-dt-20200226Z-aad46b",
  "org.scalablytyped" %%% "browserify" % "12.0-dt-20200226Z-624996",
  "org.scalablytyped" %%% "cookie" % "0.3-dt-20200226Z-4db12d",
