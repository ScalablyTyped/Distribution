...
object mod {
  ...
  inline def Any(hexType: String, hexBytes: String*): String = (^.asInstanceOf[js.Dynamic].applyDynamic("Any")(hexType.asInstanceOf[js.Any], hexBytes.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def Any(hexType: Double, hexBytes: String*): String = (^.asInstanceOf[js.Dynamic].applyDynamic("Any")(hexType.asInstanceOf[js.Any], hexBytes.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def pack(asn1: ArrInput): Uint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("pack")(asn1.asInstanceOf[js.Any]).asInstanceOf[Uint8Array]
  inline def pack(asn1: ArrInput, opts: Json): Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("pack")(asn1.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Uint8Array]
  ...
  inline def pack(asn1: ElementInput): Uint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("pack")(asn1.asInstanceOf[js.Any]).asInstanceOf[Uint8Array]
  inline def pack(asn1: ElementInput, opts: Json): Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("pack")(asn1.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Uint8Array]
  ...
  inline def parseVerbose(buf: Uint8Array): ElementBuffer = ^.asInstanceOf[js.Dynamic].applyDynamic("parseVerbose")(buf.asInstanceOf[js.Any]).asInstanceOf[ElementBuffer]
  inline def parseVerbose(buf: Uint8Array, opts: Json): ElementBuffer = (^.asInstanceOf[js.Dynamic].applyDynamic("parseVerbose")(buf.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[ElementBuffer]
  inline def parseVerbose(buf: Uint8Array, opts: `0`): ElementHex = (^.asInstanceOf[js.Dynamic].applyDynamic("parseVerbose")(buf.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[ElementHex]
  ...
  object Element {
    ...
    inline def apply[V /* <: String | Uint8Array */](length: Double, lengthSize: Double, `type`: Double): Element[V] = {
    ...
    extension [Self <: Element[?], V /* <: String | Uint8Array */](x: Self & Element[V]) {
      
      inline def setChildren(value: js.Array[Element[V]]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      inline def setChildrenUndefined: Self = StObject.set(x, "children", js.undefined)
      
      inline def setChildrenVarargs(value: Element[V]*): Self = StObject.set(x, "children", js.Array(value :_*))
  ...
  object ElementInput {
    ...
    extension [Self <: ElementInput](x: Self) {
      ...
      inline def setChildrenVarargs(value: ElementInput*): Self = StObject.set(x, "children", js.Array(value :_*))
      
      inline def setType(value: Double): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
      
      inline def setValue(value: String | Uint8Array): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
