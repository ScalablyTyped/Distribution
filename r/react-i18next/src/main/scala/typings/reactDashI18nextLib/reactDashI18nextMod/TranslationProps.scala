...
object TranslationProps {
  @scala.inline
  def apply(
    children: (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify i18next.TFunction */ js.Any, reactDashI18nextLib.Anon_I18nLng) => reactLib.reactMod.ReactNode,
