...
object ^ extends js.Object {
  val I18nextProvider: reactLib.reactMod.ReactNs.FunctionComponent[reactDashI18nextLib.reactDashI18nextMod.I18nextProviderProps] = js.native
  ...
  def useTranslation(): reactDashI18nextLib.reactDashI18nextMod.UseTranslationResponse = js.native
  def useTranslation(ns: reactDashI18nextLib.reactDashI18nextMod.Namespace): reactDashI18nextLib.reactDashI18nextMod.UseTranslationResponse = js.native
  def useTranslation(
  ...
  ): reactDashI18nextLib.reactDashI18nextMod.UseTranslationResponse = js.native
