...
import typings.reactI18next.AnonLng
...
trait TranslationProps extends js.Object {
  ...
  def children(t: TFunction, options: AnonLng, ready: Boolean): ReactNode
}

object TranslationProps {
  @scala.inline
  def apply(children: (TFunction, AnonLng, Boolean) => ReactNode, i18n: i18n = null, ns: Namespace = null): TranslationProps = {
