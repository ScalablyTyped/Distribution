...
@js.native
trait WithTranslationProps extends js.Object {
...
object WithTranslationProps {
  ...
  @scala.inline
  def apply(): WithTranslationProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WithTranslationProps]
  }
  
  @scala.inline
  implicit class WithTranslationPropsOps[Self <: WithTranslationProps] (val x: Self) extends AnyVal {
