...
trait TransProps[E /* <: Element */] extends js.Object {
  ...
  var parent: js.UndefOr[String | ComponentType[_] | Null] = js.undefined
...
object TransProps {
  ...
  def apply[/* <: typings.std.Element */ E](
    ...
    nonce: String = null,
    ns: Namespace = null,
    onAbort: SyntheticEvent[E, Event] => Unit = null,
    onAnimationEnd: AnimationEvent[E] => Unit = null,
    onAnimationIteration: AnimationEvent[E] => Unit = null,
    onAnimationStart: AnimationEvent[E] => Unit = null,
    onAuxClick: MouseEvent[E, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[E] => Unit = null,
    onBlur: FocusEvent[E] => Unit = null,
    onCanPlay: SyntheticEvent[E, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[E, Event] => Unit = null,
    onChange: FormEvent[E] => Unit = null,
    onClick: MouseEvent[E, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[E] => Unit = null,
    onCompositionStart: CompositionEvent[E] => Unit = null,
    onCompositionUpdate: CompositionEvent[E] => Unit = null,
    onContextMenu: MouseEvent[E, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[E] => Unit = null,
    onCut: ClipboardEvent[E] => Unit = null,
    onDoubleClick: MouseEvent[E, NativeMouseEvent] => Unit = null,
    onDrag: DragEvent[E] => Unit = null,
    onDragEnd: DragEvent[E] => Unit = null,
    onDragEnter: DragEvent[E] => Unit = null,
    onDragExit: DragEvent[E] => Unit = null,
    onDragLeave: DragEvent[E] => Unit = null,
    onDragOver: DragEvent[E] => Unit = null,
    onDragStart: DragEvent[E] => Unit = null,
    onDrop: DragEvent[E] => Unit = null,
    onDurationChange: SyntheticEvent[E, Event] => Unit = null,
    onEmptied: SyntheticEvent[E, Event] => Unit = null,
    onEncrypted: SyntheticEvent[E, Event] => Unit = null,
    onEnded: SyntheticEvent[E, Event] => Unit = null,
    onError: SyntheticEvent[E, Event] => Unit = null,
    onFocus: FocusEvent[E] => Unit = null,
    onInput: FormEvent[E] => Unit = null,
    onInvalid: FormEvent[E] => Unit = null,
    onKeyDown: KeyboardEvent[E] => Unit = null,
    onKeyPress: KeyboardEvent[E] => Unit = null,
    onKeyUp: KeyboardEvent[E] => Unit = null,
    onLoad: SyntheticEvent[E, Event] => Unit = null,
    onLoadStart: SyntheticEvent[E, Event] => Unit = null,
    onLoadedData: SyntheticEvent[E, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[E, Event] => Unit = null,
    onMouseDown: MouseEvent[E, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[E, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[E, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[E, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[E, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[E, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[E, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[E] => Unit = null,
    onPause: SyntheticEvent[E, Event] => Unit = null,
    onPlay: SyntheticEvent[E, Event] => Unit = null,
    onPlaying: SyntheticEvent[E, Event] => Unit = null,
    onPointerCancel: PointerEvent[E] => Unit = null,
    onPointerDown: PointerEvent[E] => Unit = null,
    onPointerEnter: PointerEvent[E] => Unit = null,
    onPointerLeave: PointerEvent[E] => Unit = null,
    onPointerMove: PointerEvent[E] => Unit = null,
    onPointerOut: PointerEvent[E] => Unit = null,
    onPointerOver: PointerEvent[E] => Unit = null,
    onPointerUp: PointerEvent[E] => Unit = null,
    onProgress: SyntheticEvent[E, Event] => Unit = null,
    onRateChange: SyntheticEvent[E, Event] => Unit = null,
    onReset: FormEvent[E] => Unit = null,
    onScroll: UIEvent[E, NativeUIEvent] => Unit = null,
    onSeeked: SyntheticEvent[E, Event] => Unit = null,
    onSeeking: SyntheticEvent[E, Event] => Unit = null,
    onSelect: SyntheticEvent[E, Event] => Unit = null,
    onStalled: SyntheticEvent[E, Event] => Unit = null,
    onSubmit: FormEvent[E] => Unit = null,
    onSuspend: SyntheticEvent[E, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[E, Event] => Unit = null,
    onTouchCancel: TouchEvent[E] => Unit = null,
    onTouchEnd: TouchEvent[E] => Unit = null,
    onTouchMove: TouchEvent[E] => Unit = null,
    onTouchStart: TouchEvent[E] => Unit = null,
    onTransitionEnd: TransitionEvent[E] => Unit = null,
    onVolumeChange: SyntheticEvent[E, Event] => Unit = null,
    onWaiting: SyntheticEvent[E, Event] => Unit = null,
    onWheel: WheelEvent[E] => Unit = null,
    open: js.UndefOr[Boolean] = js.undefined,
    optimum: js.UndefOr[Double] = js.undefined,
    parent: js.UndefOr[Null | String | ComponentType[_]] = js.undefined,
    pattern: String = null,
    ...
    ref: js.UndefOr[Null | LegacyRef[E]] = js.undefined,
    rel: String = null,
