...
object distTypeMod {
  ...
  @JSImport("react-loader-spinner/dist/type", "DEFAULT_COLOR")
  @js.native
  val DEFAULT_COLOR: /* "#4fa94d" */ String = js.native
  
  object DEFAULT_WAI_ARIA_ATTRIBUTE {
    
    @JSImport("react-loader-spinner/dist/type", "DEFAULT_WAI_ARIA_ATTRIBUTE")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-loader-spinner/dist/type", "DEFAULT_WAI_ARIA_ATTRIBUTE.aria-busy")
    @js.native
    ...
    @JSImport("react-loader-spinner/dist/type", "DEFAULT_WAI_ARIA_ATTRIBUTE.role")
    @js.native
