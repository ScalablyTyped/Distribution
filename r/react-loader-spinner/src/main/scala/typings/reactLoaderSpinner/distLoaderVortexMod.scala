...
object distLoaderVortexMod {
  
  @JSImport("react-loader-spinner/dist/loader/Vortex", JSImport.Namespace)
  @js.native
  ...
  trait VortexProps extends StObject {
    ...
    var colors: js.UndefOr[js.Tuple6[String, String, String, String, String, String]] = js.undefined
  ...
  object VortexProps {
    ...
    extension [Self <: VortexProps](x: Self) {
      ...
      inline def setColors(value: js.Tuple6[String, String, String, String, String, String]): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
