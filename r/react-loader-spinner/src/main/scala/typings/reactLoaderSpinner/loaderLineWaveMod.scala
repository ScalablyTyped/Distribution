...
object loaderLineWaveMod extends Shortcut {
  
  @JSImport("react-loader-spinner/dist/loader/LineWave", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `loaderLineWaveMod.foo` */
