...
object distLoaderOvalMod extends Shortcut {
  
  @JSImport("react-loader-spinner/dist/loader/Oval", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distLoaderOvalMod.foo` */
