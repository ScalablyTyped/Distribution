...
object rotatingSquareMod extends Shortcut {
  
  @JSImport("react-loader-spinner/dist/esm/loader/RotatingSquare", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `rotatingSquareMod.foo` */
