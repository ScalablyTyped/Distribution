...
object circlesWithBarMod extends Shortcut {
  
  @JSImport("react-loader-spinner/dist/esm/loader/CirclesWithBar", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `circlesWithBarMod.foo` */
