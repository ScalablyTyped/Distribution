...
object distLoaderGridMod extends Shortcut {
  
  @JSImport("react-loader-spinner/dist/loader/Grid", JSImport.Default)
  @js.native
  val default: FunctionComponent[GridProps] = js.native
  
  @JSImport("react-loader-spinner/dist/loader/Grid", "Grid")
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distLoaderGridMod.foo` */
