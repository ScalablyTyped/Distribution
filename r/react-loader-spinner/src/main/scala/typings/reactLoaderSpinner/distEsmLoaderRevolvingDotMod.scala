...
object distEsmLoaderRevolvingDotMod extends Shortcut {
  
  @JSImport("react-loader-spinner/dist/esm/loader/RevolvingDot", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distEsmLoaderRevolvingDotMod.foo` */
