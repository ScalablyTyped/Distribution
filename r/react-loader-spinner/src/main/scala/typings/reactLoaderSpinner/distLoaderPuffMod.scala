...
object distLoaderPuffMod extends Shortcut {
  
  @JSImport("react-loader-spinner/dist/loader/Puff", JSImport.Default)
  @js.native
  val default: FunctionComponent[PuffProps] = js.native
  
  @JSImport("react-loader-spinner/dist/loader/Puff", "Puff")
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distLoaderPuffMod.foo` */
