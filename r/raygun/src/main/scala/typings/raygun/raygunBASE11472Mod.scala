...
object raygunBASE11472Mod {
  
  object default {
    
    @JSImport("raygun/build/raygun_BASE_11472", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("raygun/build/raygun_BASE_11472", "default.Client")
    @js.native
    open class Client ()
      extends StObject
         with Raygun
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("raygun/build/raygun_BASE_11472", "Client")
  @js.native
  open class Client ()
    extends StObject
       with Raygun
