...
object raygunLOCAL11472Mod {
  
  object default {
    
    @JSImport("raygun/build/raygun_LOCAL_11472", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("raygun/build/raygun_LOCAL_11472", "default.Client")
    @js.native
  ...
  @JSImport("raygun/build/raygun_LOCAL_11472", "Client")
  @js.native
