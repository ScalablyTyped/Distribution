...
inline def callVariadicCallback[T](callback: typings.raygun.typesMod.Callback[T]): scala.Unit = typings.raygun.typesMod.^.asInstanceOf[js.Dynamic].applyDynamic("callVariadicCallback")(callback.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
inline def callVariadicCallback[T](callback: typings.raygun.typesMod.Callback[T], error: scala.Null, result: T): scala.Unit = (typings.raygun.typesMod.^.asInstanceOf[js.Dynamic].applyDynamic("callVariadicCallback")(callback.asInstanceOf[js.Any], error.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
inline def callVariadicCallback[T](callback: typings.raygun.typesMod.Callback[T], error: typings.std.Error): scala.Unit = (typings.raygun.typesMod.^.asInstanceOf[js.Dynamic].applyDynamic("callVariadicCallback")(callback.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
