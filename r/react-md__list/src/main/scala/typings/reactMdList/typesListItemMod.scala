...
object typesListItemMod {
  ...
  - typings.reactMdStates.typesUseInteractionStatesMod.InteractionStatesOptions because var conflicts: className, disabled. Inlined disableProgrammaticRipple, rippleClassNames, disableRipple, disableSpacebarClick, rippleClassName, rippleContainerClassName, handlers, rippleTimeout, enablePressedAndRipple, disableEnterClick, disablePressedFallback */ trait ListItemProps
    extends StObject
