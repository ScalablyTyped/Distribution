...
object mod {
  ...
  object default {
    ...
    @JSImport("@redis/time-series", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@redis/time-series", "default.ADD")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.ALTER")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.CREATERULE")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.CREATE")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.DECRBY")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.DELETERULE")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.DEL")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.GET")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.INCRBY")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.INFO")
    @js.native
    def INFO_ : TypeofINFO = js.native
    
    @JSImport("@redis/time-series", "default.INFO_DEBUG")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.MADD")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.MGET")
    @js.native
    def MGET_ : TypeofMGET = js.native
    
    @JSImport("@redis/time-series", "default.MGET_WITHLABELS")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.MRANGE")
    @js.native
    def MRANGE_ : TypeofMRANGE = js.native
    
    @JSImport("@redis/time-series", "default.MRANGE_WITHLABELS")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.MREVRANGE")
    @js.native
    def MREVRANGE_ : TypeofMREVRANGE = js.native
    
    @JSImport("@redis/time-series", "default.MREVRANGE_WITHLABELS")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.QUERYINDEX")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.RANGE")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.REVRANGE")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.infoDebug")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.mGetWithLabels")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.mRangeWithLabels")
    @js.native
    ...
    @JSImport("@redis/time-series", "default.mRevRangeWithLabels")
    @js.native
  ...
  @JSImport("@redis/time-series", "TimeSeriesAggregationType")
  @js.native
  ...
  @JSImport("@redis/time-series", "TimeSeriesEncoding")
  @js.native
