...
object distCommandsTopKCountMod {
  
  @JSImport("@redis/bloom/dist/commands/top-k/COUNT", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/bloom/dist/commands/top-k/COUNT", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 1 */ Double = js.native
  
  @JSImport("@redis/bloom/dist/commands/top-k/COUNT", "IS_READ_ONLY")
  @js.native
