...
object distCommandsTDigestByrankMod {
  
  @JSImport("@redis/bloom/dist/commands/t-digest/BYRANK", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/bloom/dist/commands/t-digest/BYRANK", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 1 */ Double = js.native
  
  @JSImport("@redis/bloom/dist/commands/t-digest/BYRANK", "IS_READ_ONLY")
  @js.native
