...
object distCommandsTDigestRevrankMod {
  
  @JSImport("@redis/bloom/dist/commands/t-digest/REVRANK", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/bloom/dist/commands/t-digest/REVRANK", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 1 */ Double = js.native
  
  @JSImport("@redis/bloom/dist/commands/t-digest/REVRANK", "IS_READ_ONLY")
  @js.native
