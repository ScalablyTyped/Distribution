...
trait TypeofimportedADDNX extends StObject {
...
object TypeofimportedADDNX {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedADDNX]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedADDNX] (val x: Self) extends AnyVal {
