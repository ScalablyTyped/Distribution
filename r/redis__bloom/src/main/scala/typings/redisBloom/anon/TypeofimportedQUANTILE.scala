...
trait TypeofimportedQUANTILE extends StObject {
...
object TypeofimportedQUANTILE {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedQUANTILE]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedQUANTILE] (val x: Self) extends AnyVal {
