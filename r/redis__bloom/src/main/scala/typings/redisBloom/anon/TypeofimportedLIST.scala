...
object TypeofimportedLIST {
  ...
  inline def apply(
    ...
    transformReply: () => js.Array[String | Null]
  ): TypeofimportedLIST = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedLIST] (val x: Self) extends AnyVal {
    ...
    inline def setTransformReply(value: () => js.Array[String | Null]): Self = StObject.set(x, "transformReply", js.Any.fromFunction0(value))
  }
}
