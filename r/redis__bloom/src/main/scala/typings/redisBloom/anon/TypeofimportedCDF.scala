...
trait TypeofimportedCDF extends StObject {
...
object TypeofimportedCDF {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedCDF]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedCDF] (val x: Self) extends AnyVal {
