...
trait TypeofimportedTRIMMEDME extends StObject {
  
  val FIRST_KEY_INDEX: /* 1 */ Double
  
  val IS_READ_ONLY: /* true */ Boolean
  
  def transformArguments(key: RedisCommandArgument, lowCutPercentile: Double, highCutPercentile: Double): RedisCommandArguments
  
  def transformReply(reply: String): Double
}
object TypeofimportedTRIMMEDME {
  ...
  ): TypeofimportedTRIMMEDME = {
    val __obj = js.Dynamic.literal(FIRST_KEY_INDEX = FIRST_KEY_INDEX.asInstanceOf[js.Any], IS_READ_ONLY = IS_READ_ONLY.asInstanceOf[js.Any], transformArguments = js.Any.fromFunction3(transformArguments), transformReply = js.Any.fromFunction1(transformReply))
