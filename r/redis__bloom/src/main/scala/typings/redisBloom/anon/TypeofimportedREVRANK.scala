...
trait TypeofimportedREVRANK extends StObject {
...
object TypeofimportedREVRANK {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedREVRANK]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedREVRANK] (val x: Self) extends AnyVal {
