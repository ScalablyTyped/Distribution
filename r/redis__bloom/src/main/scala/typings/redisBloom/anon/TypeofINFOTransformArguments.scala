...
import typings.redisBloom.topKInfoMod.InfoRawReply
import typings.redisBloom.topKInfoMod.InfoReply
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TypeofINFOTransformArguments extends StObject {
...
object TypeofINFOTransformArguments {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofINFOTransformArguments]
  }
  
  extension [Self <: TypeofINFOTransformArguments](x: Self) {
