...
trait TypeofimportedMIN extends StObject {
...
object TypeofimportedMIN {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedMIN]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedMIN] (val x: Self) extends AnyVal {
