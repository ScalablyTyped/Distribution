...
trait TypeofimportedRANK extends StObject {
...
object TypeofimportedRANK {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedRANK]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedRANK] (val x: Self) extends AnyVal {
