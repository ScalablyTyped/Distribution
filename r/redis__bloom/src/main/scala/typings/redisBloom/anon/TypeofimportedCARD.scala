...
trait TypeofimportedCARD extends StObject {
...
object TypeofimportedCARD {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedCARD]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedCARD] (val x: Self) extends AnyVal {
