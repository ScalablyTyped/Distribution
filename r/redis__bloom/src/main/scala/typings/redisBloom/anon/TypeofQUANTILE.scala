...
trait TypeofQUANTILE extends StObject {
  
  val FIRST_KEY_INDEX: /* 1 */ Double
  
  val IS_READ_ONLY: /* true */ Boolean
  
  def transformArguments(key: RedisCommandArgument, quantiles: js.Array[Double]): RedisCommandArguments
  
  def transformReply(reply: js.Array[String]): js.Array[Double]
}
object TypeofQUANTILE {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofQUANTILE]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofQUANTILE] (val x: Self) extends AnyVal {
