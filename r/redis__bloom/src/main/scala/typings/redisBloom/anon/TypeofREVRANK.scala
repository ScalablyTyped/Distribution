...
trait TypeofREVRANK extends StObject {
...
object TypeofREVRANK {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofREVRANK]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofREVRANK] (val x: Self) extends AnyVal {
