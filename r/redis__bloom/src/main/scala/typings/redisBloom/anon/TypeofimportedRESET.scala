...
trait TypeofimportedRESET extends StObject {
...
object TypeofimportedRESET {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedRESET]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedRESET] (val x: Self) extends AnyVal {
