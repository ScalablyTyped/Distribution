...
trait TypeofimportedBYRANK extends StObject {
...
object TypeofimportedBYRANK {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedBYRANK]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedBYRANK] (val x: Self) extends AnyVal {
