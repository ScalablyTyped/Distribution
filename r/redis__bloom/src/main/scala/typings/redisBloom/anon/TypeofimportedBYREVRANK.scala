...
trait TypeofimportedBYREVRANK extends StObject {
...
object TypeofimportedBYREVRANK {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedBYREVRANK]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedBYREVRANK] (val x: Self) extends AnyVal {
