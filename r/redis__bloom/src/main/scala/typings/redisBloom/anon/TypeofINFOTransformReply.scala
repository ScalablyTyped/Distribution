...
trait TypeofINFOTransformReply extends StObject {
...
object TypeofINFOTransformReply {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofINFOTransformReply]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofINFOTransformReply] (val x: Self) extends AnyVal {
