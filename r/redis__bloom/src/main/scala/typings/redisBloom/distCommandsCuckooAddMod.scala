...
object distCommandsCuckooAddMod {
  
  @JSImport("@redis/bloom/dist/commands/cuckoo/ADD", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/bloom/dist/commands/cuckoo/ADD", "FIRST_KEY_INDEX")
  @js.native
