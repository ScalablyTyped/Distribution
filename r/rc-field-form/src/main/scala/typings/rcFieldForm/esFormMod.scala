...
object esFormMod extends Shortcut {
  ...
  @js.native
  val default: ForwardRefRenderFunction[FormInstance[Any], FormProps[Any]] = js.native
  
  /* Inlined std.Omit<react.react.FormHTMLAttributes<std.HTMLFormElement>, 'onSubmit' | 'children'> */
  ...
  object BaseFormProps {
    ...
    inline def apply(): BaseFormProps = {
  ...
  object FormProps {
    ...
    extension [Self <: FormProps[?], Values](x: Self & FormProps[Values]) {
      ...
      inline def setChildrenFunction2(
        value: (/* values */ Store, /* form */ FormInstance[Any]) => typings.react.mod.global.JSX.Element | ReactNode
  ...
  type RenderProps = js.Function2[
    ...
    typings.react.mod.global.JSX.Element | ReactNode
  ]
  
  type _To = ForwardRefRenderFunction[FormInstance[Any], FormProps[Any]]
  
  /* This means you don't have to write `default`, but can instead just say `esFormMod.foo` */
  override def _to: ForwardRefRenderFunction[FormInstance[Any], FormProps[Any]] = default
}
