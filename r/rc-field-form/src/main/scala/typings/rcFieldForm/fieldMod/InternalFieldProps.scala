...
object InternalFieldProps {
  ...
  implicit class InternalFieldPropsOps[Self <: InternalFieldProps[_], Values] (val x: Self with InternalFieldProps[Values]) extends AnyVal {
    ...
    @scala.inline
    def setChildrenFunction3(value: (/* control */ ChildProps, /* meta */ Meta, /* form */ FormInstance[Values]) => ReactNode): Self = this.set("children", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def deleteFieldContext: Self = this.set("fieldContext", js.undefined)
