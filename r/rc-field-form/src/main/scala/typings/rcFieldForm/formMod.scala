...
object formMod extends Shortcut {
  ...
  trait FormProps[Values]
    ...
    @JSName("children")
    var children_FormProps: js.UndefOr[RenderProps | ReactNode] = js.undefined
    
    var component: js.UndefOr[`false` | String | FC[js.Any] | (ComponentClass[js.Any, ComponentState])] = js.undefined
  ...
  object FormProps {
    ...
    @scala.inline
    implicit class FormPropsMutableBuilder[Self <: FormProps[?], Values] (val x: Self & FormProps[Values]) extends AnyVal {
      
      @scala.inline
      def setChildren(value: RenderProps | ReactNode): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setChildrenFunction2(value: (/* values */ Store, /* form */ FormInstance[js.Any]) => Element | ReactNode): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
      
      @scala.inline
      def setChildrenUndefined: Self = StObject.set(x, "children", js.undefined)
      
      @scala.inline
      def setComponent(value: `false` | String | FC[js.Any] | (ComponentClass[js.Any, ComponentState])): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
  ...
  type RenderProps = js.Function2[/* values */ Store, /* form */ FormInstance[js.Any], Element | ReactNode]
