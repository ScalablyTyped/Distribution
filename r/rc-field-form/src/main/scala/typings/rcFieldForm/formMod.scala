...
object formMod extends Shortcut {
  ...
  object FormProps {
    ...
    extension [Self <: FormProps[?], Values](x: Self & FormProps[Values]) {
      ...
      inline def setChildrenFunction2(value: (/* values */ Store, /* form */ FormInstance[js.Any]) => Element | ReactNode): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
      
      inline def setChildrenUndefined: Self = StObject.set(x, "children", js.undefined)
      
      inline def setComponent(value: `false` | String | FC[js.Any] | (ComponentClass[js.Any, ComponentState])): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      inline def setFieldsVarargs(value: FieldData*): Self = StObject.set(x, "fields", js.Array(value :_*))
