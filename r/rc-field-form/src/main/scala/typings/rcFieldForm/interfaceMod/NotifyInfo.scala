...
object NotifyInfo {
  ...
  @scala.inline
  def DependenciesUpdateInfo(relatedFields: js.Array[InternalNamePath]): typings.rcFieldForm.interfaceMod.DependenciesUpdateInfo = {
  ...
  @scala.inline
  def ResetInfo(): typings.rcFieldForm.interfaceMod.ResetInfo = {
  ...
  @scala.inline
  def SetFieldInfo(data: FieldData): typings.rcFieldForm.interfaceMod.SetFieldInfo = {
  ...
  @scala.inline
  def ValidateFinishInfo(): typings.rcFieldForm.interfaceMod.ValidateFinishInfo = {
    val __obj = js.Dynamic.literal()
  ...
  @scala.inline
  def ValueUpdateInfo(source: internal | external): typings.rcFieldForm.interfaceMod.ValueUpdateInfo = {
