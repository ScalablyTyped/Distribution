...
object mod {
  ...
  inline def addAll[Q /* <: BaseQuad */, D /* <: DatasetCore[Q, Q] */](dataset: D, iterable: Iterable[Q]): D = (^.asInstanceOf[js.Dynamic].applyDynamic("addAll")(dataset.asInstanceOf[js.Any], iterable.asInstanceOf[js.Any])).asInstanceOf[D]
  ...
  inline def fromStream[D /* <: DatasetCore[BaseQuad, BaseQuad] */](dataset: D, stream: EventEmitter): js.Promise[D] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromStream")(dataset.asInstanceOf[js.Any], stream.asInstanceOf[js.Any])).asInstanceOf[js.Promise[D]]
  ...
  inline def toStream[Q /* <: BaseQuad */](dataset: DatasetCore[Q, Q]): Stream[Q] = ^.asInstanceOf[js.Dynamic].applyDynamic("toStream")(dataset.asInstanceOf[js.Any]).asInstanceOf[Stream[Q]]
}
