...
object mod {
  ...
  object default {
    ...
    @scala.inline
    def defaultProps_=(x: Audio): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
    
    @JSImport("react-webcam", "default.stopMediaStream")
    @js.native
    def stopMediaStream: js.Any = js.native
    @scala.inline
    def stopMediaStream_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("stopMediaStream")(x.asInstanceOf[js.Any])
  }
  ...
  object ScreenshotDimensions {
    ...
    @scala.inline
    implicit class ScreenshotDimensionsMutableBuilder[Self <: ScreenshotDimensions] (val x: Self) extends AnyVal {
  ...
  object WebcamProps {
    ...
    @scala.inline
    implicit class WebcamPropsMutableBuilder[Self <: WebcamProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAudioConstraints(value: Boolean | MediaTrackConstraints): Self = StObject.set(x, "audioConstraints", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMinScreenshotHeight(value: Double): Self = StObject.set(x, "minScreenshotHeight", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMinScreenshotHeightUndefined: Self = StObject.set(x, "minScreenshotHeight", js.undefined)
      
      @scala.inline
      def setMinScreenshotWidth(value: Double): Self = StObject.set(x, "minScreenshotWidth", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMinScreenshotWidthUndefined: Self = StObject.set(x, "minScreenshotWidth", js.undefined)
      ...
      @scala.inline
      def setOnUserMedia(value: MediaStream => Unit): Self = StObject.set(x, "onUserMedia", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnUserMediaError(value: String => Unit): Self = StObject.set(x, "onUserMediaError", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setScreenshotFormat(value: imageSlashwebp | imageSlashpng | imageSlashjpeg): Self = StObject.set(x, "screenshotFormat", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVideoConstraints(value: Boolean | MediaTrackConstraints): Self = StObject.set(x, "videoConstraints", value.asInstanceOf[js.Any])
  ...
  object WebcamState {
    ...
    @scala.inline
    implicit class WebcamStateMutableBuilder[Self <: WebcamState] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setHasUserMedia(value: Boolean): Self = StObject.set(x, "hasUserMedia", value.asInstanceOf[js.Any])
