...
object reactDashFnsComponents extends reactDashFnsProps {
  ...
  def DeviceMotion: ComponentType[
    SharedRenderProps[typings.reactDashFns.distDeviceMotionDeviceMotionMod.DeviceMotionProps]
  ] = js.constructorOf[typings.reactDashFns.reactDashFnsMod.DeviceMotion].asInstanceOf[typings.react.reactMod.ComponentType[
  typings.reactDashFns.distTypesMod.SharedRenderProps[typings.reactDashFns.distDeviceMotionDeviceMotionMod.DeviceMotionProps]]]
  @scala.inline
  ...
  typings.reactDashFns.distTypesMod.SharedRenderProps[
    typings.reactDashFns.distDeviceOrientationDeviceOrientationMod.DeviceOrientationProps
  ]]]
  @scala.inline
  def GeoPosition: ComponentType[
    SharedRenderProps[typings.reactDashFns.distGeoPositionGeoPositionMod.GeoPositionProps]
  ] = js.constructorOf[typings.reactDashFns.reactDashFnsMod.GeoPosition].asInstanceOf[typings.react.reactMod.ComponentType[
  typings.reactDashFns.distTypesMod.SharedRenderProps[typings.reactDashFns.distGeoPositionGeoPositionMod.GeoPositionProps]]]
  @scala.inline
  ...
  typings.reactDashFns.distTypesMod.SharedRenderProps[typings.reactDashFns.distNetworkNetworkMod.NetworkProps]]]
  @scala.inline
