...
object reduxDashDoghouseModMembers extends js.Object {
  def bindActionCreatorsDeep[A /* <: reduxLib.reduxMod.ActionCreator[_] */, S](actionFactories: A, dispatch: reduxLib.reduxMod.Dispatch[S]): A = js.native
  ...
  @JSName("bindActionCreatorsDeep")
  def bindActionCreatorsDeep_MActionFactoriesMapSM[M /* <: ActionFactoriesMap */, S](actionFactories: M, dispatch: reduxLib.reduxMod.Dispatch[S]): M = js.native
  def bindScopedActionFactories[A /* <: reduxLib.reduxMod.ActionCreator[_] */, S](actionFactories: A, dispatch: reduxLib.reduxMod.Dispatch[S]): A = js.native
  def bindScopedActionFactories[A /* <: reduxLib.reduxMod.ActionCreator[_] */, S](
    actionFactories: A,
  ...
  @JSName("bindScopedActionFactories")
  def bindScopedActionFactories_MActionFactoriesMapSM[M /* <: ActionFactoriesMap */, S](actionFactories: M, dispatch: reduxLib.reduxMod.Dispatch[S]): M = js.native
  @JSName("bindScopedActionFactories")
  def bindScopedActionFactories_MActionFactoriesMapSM[M /* <: ActionFactoriesMap */, S](
    actionFactories: M,
    dispatch: reduxLib.reduxMod.Dispatch[S],
    bindFn: js.Function2[
      /* actionCreators */ reduxLib.reduxMod.ActionCreatorsMapObject[_], 
