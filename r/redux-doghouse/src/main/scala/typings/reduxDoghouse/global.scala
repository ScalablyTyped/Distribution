...
object global {
  ...
  object ReduxDoghouse {
    ...
    @js.native
    class ScopedActionFactory[A /* <: ActionCreator[js.Any] | ActionCreatorsMapObject[js.Any] */] protected ()
    ...
    inline def bindScopedActionFactories_A_UnionActionCreatorAnyActionCreatorsMapObjectAnyF_ScopedActionFactoryAS_F[A /* <: ActionCreator[js.Any] | ActionCreatorsMapObject[js.Any] */, F /* <: typings.reduxDoghouse.mod.ScopedActionFactory[A] */, S](actionFactories: F, dispatch: Dispatch[S], bindFn: FnCall): F = (^.asInstanceOf[js.Dynamic].applyDynamic("bindScopedActionFactories")(actionFactories.asInstanceOf[js.Any], dispatch.asInstanceOf[js.Any], bindFn.asInstanceOf[js.Any])).asInstanceOf[F]
