...
object ^ extends js.Object {
  def createMessageListener(config: MessageListenerConfig): scala.Unit = js.native
  ...
  def createStateSyncMiddleware(config: Config): reduxLib.reduxMod.Middleware[js.Object, _, reduxLib.reduxMod.Dispatch[reduxLib.reduxMod.AnyAction]] = js.native
  def generateUuidForAction(action: reduxLib.reduxMod.AnyAction): StampedAction = js.native
  ...
  def isActionAllowed(config: Config): js.Function1[/* type */ java.lang.String, scala.Boolean] = js.native
