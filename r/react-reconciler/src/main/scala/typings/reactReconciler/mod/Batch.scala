...
object Batch {
  ...
  def apply(_defer: Boolean, _expirationTime: ExpirationTime, _onComplete: () => js.Any, _next: Batch = null): Batch = {
    val __obj = js.Dynamic.literal(_defer = _defer.asInstanceOf[js.Any], _expirationTime = _expirationTime.asInstanceOf[js.Any], _onComplete = js.Any.fromFunction0(_onComplete), _next = _next.asInstanceOf[js.Any])
