...
object reactDashReconcilerLibNumbers {
  @js.native
  sealed trait `0`
    extends reactDashReconcilerLib.reactDashReconcilerMod.BundleType
       with reactDashReconcilerLib.reactDashReconcilerMod.WorkTag
  ...
  @js.native
  sealed trait `10`
    extends reactDashReconcilerLib.reactDashReconcilerMod.WorkTag
