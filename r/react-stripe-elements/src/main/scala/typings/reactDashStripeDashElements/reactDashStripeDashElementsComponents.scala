...
object reactDashStripeDashElementsComponents extends reactDashStripeDashElementsProps {
  ...
  typings.reactDashStripeDashElements.reactDashStripeDashElementsMod.ReactStripeElementsNs.ElementProps]]
  @scala.inline
  def Elements: ComponentType[ElementsCreateOptions] = js.constructorOf[typings.reactDashStripeDashElements.reactDashStripeDashElementsMod.Elements].asInstanceOf[typings.react.reactMod.ComponentType[typings.stripeDashV3.stripeNs.elementsNs.ElementsCreateOptions]]
  @scala.inline
  ...
  def StripeProvider: ComponentType[
    typings.reactDashStripeDashElements.reactDashStripeDashElementsMod.ReactStripeElementsNs.StripeProviderProps
