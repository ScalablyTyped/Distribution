...
object Marking {
  ...
  inline def CustomMarking(customStyles: MarkedDateCustomStyles): typings.reactNativeCalendars.mod.CustomMarking = {
  ...
  inline def DotMarking(): typings.reactNativeCalendars.mod.DotMarking = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[typings.reactNativeCalendars.mod.DotMarking]
  }
  
  inline def MultiDotMarking(dots: js.Array[CalendarDot]): typings.reactNativeCalendars.mod.MultiDotMarking = {
  ...
  inline def MultiPeriodMarking(periods: js.Array[Color]): typings.reactNativeCalendars.mod.MultiPeriodMarking = {
  ...
  inline def PeriodMarking(): typings.reactNativeCalendars.mod.PeriodMarking = {
    val __obj = js.Dynamic.literal()
