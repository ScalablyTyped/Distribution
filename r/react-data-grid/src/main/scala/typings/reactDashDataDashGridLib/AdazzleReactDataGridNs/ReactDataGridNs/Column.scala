...
trait Column[T] extends js.Object {
  ...
  var editor: js.UndefOr[
    reactLib.reactMod.ReactElement | (reactLib.reactMod.ComponentClass[
  ...
  var events: js.UndefOr[
    org.scalablytyped.runtime.StringDictionary[reactDashDataDashGridLib.AdazzleReactDataGridNs.ColumnEventCallback]
  ] = js.undefined
  /**
...
object Column {
  ...
  def apply[T](
    ...
    editor: reactLib.reactMod.ReactElement | (reactLib.reactMod.ComponentClass[
      reactDashDataDashGridLib.AdazzleReactDataGridNs.EditorBaseProps, 
      reactLib.reactMod.ComponentState
