package typings
package reactDashDataDashGridLib.AdazzleReactDataGridPluginsNs.MenuNs
...
@js.native
object MenuNsMembers extends js.Object {
  val monitor: reactDashDataDashGridLib.Anon_GetPosition = js.native
