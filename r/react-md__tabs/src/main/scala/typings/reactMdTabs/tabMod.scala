...
object tabMod {
  ...
  trait TabProps extends StObject {
    ...
    /**
      ...
      */
    var panelId: js.UndefOr[String] = js.undefined
  ...
  object TabProps {
    ...
    inline def apply(active: Boolean, id: String): TabProps = {
    ...
    extension [Self <: TabProps](x: Self) {
      ...
      inline def setPanelIdUndefined: Self = StObject.set(x, "panelId", js.undefined)
