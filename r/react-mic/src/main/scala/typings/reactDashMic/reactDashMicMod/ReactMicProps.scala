package typings.reactDashMic.reactDashMicMod

import typings.reactDashMic.reactDashMicStrings.frequencyBars
import typings.reactDashMic.reactDashMicStrings.sinewave
