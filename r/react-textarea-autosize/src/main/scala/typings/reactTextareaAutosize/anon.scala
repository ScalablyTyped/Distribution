...
import typings.reactTextareaAutosize.mod.Style
import typings.reactTextareaAutosize.mod.TextareaHeightChangeMeta
...
object anon {
  ...
  object PickTextareaPropscolortra {
    ...
    inline def apply(): PickTextareaPropscolortra = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PickTextareaPropscolortra]
    }
    
    extension [Self <: PickTextareaPropscolortra](x: Self) {
