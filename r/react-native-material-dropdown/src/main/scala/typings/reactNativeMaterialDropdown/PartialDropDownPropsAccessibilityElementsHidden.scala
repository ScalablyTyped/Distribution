...
object PartialDropDownPropsAccessibilityElementsHidden {
  ...
  def apply(
    ...
    label: String = null,
    labelExtractor: (PartialDropDownPropsAccessibilityElementsHidden, /* index */ Double) => String = null,
    ...
    onBlur: () => Unit = null,
    onChangeText: (/* value */ String, /* index */ Double, /* data */ js.Array[PartialDropDownPropsAccessibilityElementsHidden]) => Unit = null,
    onFocus: () => Unit = null,
    ...
    propsExtractor: (PartialDropDownPropsAccessibilityElementsHidden, /* index */ Double) => PartialDropDownPropsAccessibilityComponentType = null,
    ...
    valueExtractor: (PartialDropDownPropsAccessibilityElementsHidden, /* index */ Double) => String = null
