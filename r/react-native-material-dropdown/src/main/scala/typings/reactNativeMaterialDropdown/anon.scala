...
object anon {
  ...
  object PartialDropDownProps {
    ...
    extension [Self <: PartialDropDownProps](x: Self) {
      ...
      inline def setOnChangeText(value: (/* value */ String, /* index */ Double, /* data */ js.Array[PartialDropDownProps]) => Unit): Self = StObject.set(x, "onChangeText", js.Any.fromFunction3(value))
