...
object anon {
  ...
  trait DetailedHTMLPropsHTMLAttr extends StObject {
    ...
    var onBlur: js.UndefOr[FocusEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ FocusEvent[HTMLTextAreaElement], Unit]])
    ...
    var onClick: js.UndefOr[MouseEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLTextAreaElement, NativeMouseEvent], Unit]])
    ...
    // Focus Events
    var onFocus: js.UndefOr[FocusEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ FocusEvent[HTMLTextAreaElement], Unit]])
    ...
    // also a Media Event
    // Keyboard Events
    var onKeyDown: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLTextAreaElement], Unit]])
    
    var onKeyPress: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] = js.undefined
    
    var onKeyUp: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLTextAreaElement], Unit]])
  ...
  object DetailedHTMLPropsHTMLAttr {
    ...
    def apply(
      ...
      onBlur: js.UndefOr[FocusEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ FocusEvent[HTMLTextAreaElement], Unit]]),
      onClick: js.UndefOr[MouseEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLTextAreaElement, NativeMouseEvent], Unit]]),
      onFocus: js.UndefOr[FocusEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ FocusEvent[HTMLTextAreaElement], Unit]]),
      onKeyDown: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLTextAreaElement], Unit]]),
      onKeyUp: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLTextAreaElement], Unit]]),
    ...
    implicit class DetailedHTMLPropsHTMLAttrMutableBuilder[Self <: DetailedHTMLPropsHTMLAttr] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnBlur(
        value: js.UndefOr[FocusEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ FocusEvent[HTMLTextAreaElement], Unit]])
      ...
      @scala.inline
      def setOnClick(
        value: js.UndefOr[MouseEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLTextAreaElement, NativeMouseEvent], Unit]])
      ...
      @scala.inline
      def setOnKeyDown(
        value: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] & (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLTextAreaElement], Unit]])
