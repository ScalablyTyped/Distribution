...
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.`additions removals`
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.`additions text`
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.`inline`
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.`removals additions`
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.`removals text`
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.`text additions`
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.`text removals`
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.additions
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.all
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.ascending
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.assertive
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.both
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.copy
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.date
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.decimal
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.descending
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.dialog
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.email
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.execute
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.grammar
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.grid
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.horizontal
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.inherit
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.link
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.list
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.listbox
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.location
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.menu
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.mixed
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.move
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.no
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.none
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.numeric
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.off
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.on
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.other
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.page
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.polite
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.popup
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.removals
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.search
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.spelling
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.step
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.tel
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.text
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.time
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.tree
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.url
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.vertical
import typings.reactSimpleCodeEditor.reactSimpleCodeEditorStrings.yes
...
object anon {
  ...
  /* Inlined react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLDivElement>, std.HTMLDivElement> & {  value :string, onValueChange (value : string): void, highlight (value : string): string | react.react.ReactNode,   tabSize :number | undefined,   insertSpaces :boolean | undefined,   ignoreTabKey :boolean | undefined,   padding :number | string | undefined,   style :react.react.CSSProperties | undefined,   textareaId :string | undefined,   autoFocus :boolean | undefined,   disabled :boolean | undefined,   form :string | undefined,   maxLength :number | undefined,   minLength :number | undefined,   name :string | undefined,   placeholder :string | undefined,   readOnly :boolean | undefined,   required :boolean | undefined,   onClick :(e : react.react.MouseEvent<std.HTMLTextAreaElement, react.react.NativeMouseEvent>): void | undefined,   onFocus :(e : react.react.FocusEvent<std.HTMLTextAreaElement>): void | undefined,   onBlur :(e : react.react.FocusEvent<std.HTMLTextAreaElement>): void | undefined,   onKeyUp :(e : react.react.KeyboardEvent<std.HTMLTextAreaElement>): void | undefined,   onKeyDown :(e : react.react.KeyboardEvent<std.HTMLTextAreaElement>): void | undefined} */
  @js.native
  trait DetailedHTMLPropsHTMLAttr extends StObject {
    ...
    def highlight(value: String): String | ReactNode = js.native
    ...
    var onBlur: js.UndefOr[FocusEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ FocusEvent[HTMLTextAreaElement], Unit]]) = js.native
    ...
    var onClick: js.UndefOr[MouseEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLTextAreaElement, NativeMouseEvent], Unit]]) = js.native
    ...
    // Focus Events
    var onFocus: js.UndefOr[FocusEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ FocusEvent[HTMLTextAreaElement], Unit]]) = js.native
    ...
    // also a Media Event
    // Keyboard Events
    var onKeyDown: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLTextAreaElement], Unit]]) = js.native
    
    var onKeyPress: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] = js.native
    
    var onKeyUp: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLTextAreaElement], Unit]]) = js.native
  ...
  object DetailedHTMLPropsHTMLAttr {
    ...
    def apply(
      ...
      onBlur: js.UndefOr[FocusEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ FocusEvent[HTMLTextAreaElement], Unit]]),
      onClick: js.UndefOr[MouseEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLTextAreaElement, NativeMouseEvent], Unit]]),
      onFocus: js.UndefOr[FocusEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ FocusEvent[HTMLTextAreaElement], Unit]]),
      onKeyDown: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLTextAreaElement], Unit]]),
      onKeyUp: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLTextAreaElement], Unit]]),
      onValueChange: String => Unit,
      value: String
    ): DetailedHTMLPropsHTMLAttr = {
    ...
    implicit class DetailedHTMLPropsHTMLAttrMutableBuilder[Self <: DetailedHTMLPropsHTMLAttr] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHighlight(value: String => String | ReactNode): Self = StObject.set(x, "highlight", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setIgnoreTabKey(value: Boolean): Self = StObject.set(x, "ignoreTabKey", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIgnoreTabKeyUndefined: Self = StObject.set(x, "ignoreTabKey", js.undefined)
      ...
      @scala.inline
      def setOnBlur(
        value: js.UndefOr[FocusEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ FocusEvent[HTMLTextAreaElement], Unit]])
      ...
      @scala.inline
      def setOnClick(
        value: js.UndefOr[MouseEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLTextAreaElement, NativeMouseEvent], Unit]])
      ...
      @scala.inline
      def setOnKeyDown(
        value: js.UndefOr[KeyboardEventHandler[HTMLDivElement]] with (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLTextAreaElement], Unit]])
      ...
      @scala.inline
      def setOnValueChange(value: String => Unit): Self = StObject.set(x, "onValueChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setTextareaId(value: String): Self = StObject.set(x, "textareaId", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTextareaIdUndefined: Self = StObject.set(x, "textareaId", js.undefined)
  ...
  object History {
    ...
    implicit class HistoryMutableBuilder[Self <: History] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHistory(value: Offset): Self = StObject.set(x, "history", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Offset {
    ...
    implicit class OffsetMutableBuilder[Self <: Offset] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStack(value: js.Array[SelectionEnd]): Self = StObject.set(x, "stack", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStackVarargs(value: SelectionEnd*): Self = StObject.set(x, "stack", js.Array(value :_*))
    }
  }
