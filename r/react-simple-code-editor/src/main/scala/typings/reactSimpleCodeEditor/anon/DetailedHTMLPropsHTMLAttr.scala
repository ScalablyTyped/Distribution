...
object DetailedHTMLPropsHTMLAttr {
  ...
  implicit class DetailedHTMLPropsHTMLAttrOps[Self <: DetailedHTMLPropsHTMLAttr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHighlight(value: String => String | ReactNode): Self = this.set("highlight", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnValueChange(value: String => Unit): Self = this.set("onValueChange", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setIgnoreTabKey(value: Boolean): Self = this.set("ignoreTabKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIgnoreTabKey: Self = this.set("ignoreTabKey", js.undefined)
    ...
    @scala.inline
    def setTextareaId(value: String): Self = this.set("textareaId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTextareaId: Self = this.set("textareaId", js.undefined)
