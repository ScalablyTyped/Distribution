...
trait DetailedHTMLPropsHTMLAttr extends js.Object {
  ...
  var onBlur: js.UndefOr[
    FocusEventHandler[HTMLDivElement] | (js.Function1[/* e */ FocusEvent[HTMLTextAreaElement], Unit])
  ] = js.native
  ...
  var onClick: js.UndefOr[
    (js.Function1[/* e */ MouseEvent[HTMLTextAreaElement, NativeMouseEvent], Unit]) | MouseEventHandler[HTMLDivElement]
  ] = js.native
  // Composition Events
  ...
  var onKeyDown: js.UndefOr[
    (js.Function1[/* e */ KeyboardEvent[HTMLTextAreaElement], Unit]) | KeyboardEventHandler[HTMLDivElement]
  ] = js.native
