...
object Anon_AutoFocus {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(highlight = js.Any.fromFunction1(highlight), onValueChange = js.Any.fromFunction1(onValueChange), value = value)
    ...
    if (textareaId != null) __obj.updateDynamic("textareaId")(textareaId)
