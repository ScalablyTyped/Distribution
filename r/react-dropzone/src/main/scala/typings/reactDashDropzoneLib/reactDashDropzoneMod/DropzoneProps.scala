...
- Dropped {[ P in react-dropzone.react-dropzone.PickedAttributes ]: react.react.InputHTMLAttributes<std.HTMLDivElement>[P]} */ trait DropzoneProps extends js.Object {
