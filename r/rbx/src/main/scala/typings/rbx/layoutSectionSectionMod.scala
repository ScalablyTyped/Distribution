...
object layoutSectionSectionMod {
  
  object SECTION_DEFAULTS {
    
    @JSImport("rbx/layout/section/section", "SECTION_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/layout/section/section", "SECTION_DEFAULTS.sizes")
    @js.native
  ...
  object SectionModifierProps {
    ...
    inline def apply(): SectionModifierProps = {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/layout/section/section.SectionModifierProps */
  ...
  trait SectionVariables extends StObject {
    
    var sizes: medium | large
  }
  object SectionVariables {
    
    inline def apply(sizes: medium | large): SectionVariables = {
  ...
  trait SectionVariablesDefaults extends StObject {
    
    var sizes: medium | large
  }
  object SectionVariablesDefaults {
    
    inline def apply(sizes: medium | large): SectionVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any])
  ...
  trait SectionVariablesOverrides extends StObject
}
