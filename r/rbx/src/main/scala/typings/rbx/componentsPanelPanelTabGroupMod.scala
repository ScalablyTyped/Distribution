...
object componentsPanelPanelTabGroupMod {
  ...
  object PanelTabGroupProps {
    ...
    inline def apply(): PanelTabGroupProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PanelTabGroupProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PanelTabGroupProps] (val x: Self) extends AnyVal {
