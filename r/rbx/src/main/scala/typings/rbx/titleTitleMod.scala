...
object titleTitleMod {
  ...
  object TITLE_DEFAULTS {
    ...
    inline def sizes_=(x: js.Tuple6[`1`, `2`, `3`, `4`, `5`, `6`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sizes")(x.asInstanceOf[js.Any])
  }
  ...
  object TitleModifierProps {
    ...
    inline def apply(): TitleModifierProps = {
  ...
  object TitleVariables {
    ...
    inline def apply(sizes: `1` | `2` | `3` | `4` | `5` | `6`): TitleVariables = {
  ...
  object TitleVariablesDefaults {
    ...
    inline def apply(sizes: `1` | `2` | `3` | `4` | `5` | `6`): TitleVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any])
