...
object componentsMediaMod {
  ...
  object Media {
    ...
    @JSImport("rbx/components/media", "Media")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/media", "Media.Item")
    @js.native
    ...
    @JSImport("rbx/components/media", "Media.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/media", "Media.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/media", "Media.$$typeof")
    @js.native
