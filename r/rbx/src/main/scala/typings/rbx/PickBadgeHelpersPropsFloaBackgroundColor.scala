...
trait PickBadgeHelpersPropsFloaBackgroundColor extends js.Object {
  ...
  var responsive: js.UndefOr[
    typings.rbx.rbxStrings.PickBadgeHelpersPropsFloaBackgroundColor with TopLevel[js.Any]
  ] = js.undefined
...
object PickBadgeHelpersPropsFloaBackgroundColor {
  ...
  def apply(
    ...
    responsive: typings.rbx.rbxStrings.PickBadgeHelpersPropsFloaBackgroundColor with TopLevel[js.Any] = null,
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typings.rbx.rbxStrings.PickBadgeHelpersPropsFloaBackgroundColor with TopLevel[js.Any] = null,
