...
object elementsFormControlMod {
  
  object CONTROL_DEFAULTS {
    
    @JSImport("rbx/elements/form/control", "CONTROL_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/form/control", "CONTROL_DEFAULTS.sizes")
    @js.native
  ...
  object ControlModifierProps {
    ...
    inline def apply(): ControlModifierProps = {
    ...
    implicit open class MutableBuilder[Self <: ControlModifierProps] (val x: Self) extends AnyVal {
      ...
      inline def setIconLeft(value: Boolean): Self = StObject.set(x, "iconLeft", value.asInstanceOf[js.Any])
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/form/control.ControlModifierProps */
  ...
  trait ControlVariables extends StObject {
    
    var sizes: small | medium | large
  }
  object ControlVariables {
    
    inline def apply(sizes: small | medium | large): ControlVariables = {
  ...
  trait ControlVariablesDefaults extends StObject {
    
    var sizes: small | medium | large
  }
  object ControlVariablesDefaults {
    
    inline def apply(sizes: small | medium | large): ControlVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any])
  ...
  trait ControlVariablesOverrides extends StObject
}
