...
object elementsFormFileMod {
  
  object FILE_DEFAULTS {
    
    @JSImport("rbx/elements/form/file", "FILE_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/form/file", "FILE_DEFAULTS.alignments")
    @js.native
    ...
    @JSImport("rbx/elements/form/file", "FILE_DEFAULTS.sizes")
    @js.native
  ...
  object File {
    ...
    @JSImport("rbx/elements/form/file", "File")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/form/file", "File.CTA")
    @js.native
    def CTA: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]] = js.native
    inline def CTA_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CTA")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/form/file", "File.Icon")
    @js.native
    def Icon: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]] = js.native
    inline def Icon_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Icon")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/form/file", "File.Input")
    @js.native
    def Input: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]] = js.native
    inline def Input_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Input")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/form/file", "File.Label")
    @js.native
    def Label: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]] = js.native
    inline def Label_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Label")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/form/file", "File.Name")
    @js.native
    def Name: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]] = js.native
    inline def Name_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Name")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/form/file", "File.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & FileModifierProps & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
    ...
    @JSImport("rbx/elements/form/file", "File.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/form/file", "File.$$typeof")
    @js.native
  ...
  trait FileModifierProps extends StObject {
  ...
  object FileModifierProps {
    ...
    inline def apply(): FileModifierProps = {
    ...
    implicit open class MutableBuilder[Self <: FileModifierProps] (val x: Self) extends AnyVal {
      ...
      inline def setHasName(value: Boolean): Self = StObject.set(x, "hasName", value.asInstanceOf[js.Any])
      
      inline def setHasNameUndefined: Self = StObject.set(x, "hasName", js.undefined)
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/form/file.FileModifierProps */
  trait FileProps extends StObject {
  ...
  trait FileVariables extends StObject {
  ...
  object FileVariables {
    ...
    inline def apply(alignments: centered | right, sizes: small | medium | large): FileVariables = {
  ...
  trait FileVariablesDefaults extends StObject {
  ...
  object FileVariablesDefaults {
    ...
    inline def apply(alignments: centered | right, sizes: small | medium | large): FileVariablesDefaults = {
      val __obj = js.Dynamic.literal(alignments = alignments.asInstanceOf[js.Any], sizes = sizes.asInstanceOf[js.Any])
  ...
  trait FileVariablesOverrides extends StObject
}
