...
object componentsNavbarNavbarSegmentMod {
  
  object NAVBAR_SEGMENT_DEFAULTS {
    
    @JSImport("rbx/components/navbar/navbar-segment", "NAVBAR_SEGMENT_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/navbar/navbar-segment", "NAVBAR_SEGMENT_DEFAULTS.alignments")
    @js.native
    def alignments: js.Tuple2[start, end] = js.native
    inline def alignments_=(x: js.Tuple2[start, end]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alignments")(x.asInstanceOf[js.Any])
  }
  ...
  object NavbarSegmentModifierProps {
    ...
    inline def apply(align: start | end): NavbarSegmentModifierProps = {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/navbar/navbar-segment.NavbarSegmentModifierProps */
  trait NavbarSegmentProps extends StObject {
  ...
  object NavbarSegmentProps {
    
    inline def apply(align: start | end): NavbarSegmentProps = {
      val __obj = js.Dynamic.literal(align = align.asInstanceOf[js.Any])
  ...
  trait NavbarSegmentVariables extends StObject {
    
    var alignments: start | end
  }
  object NavbarSegmentVariables {
    
    inline def apply(alignments: start | end): NavbarSegmentVariables = {
  ...
  trait NavbarSegmentVariablesDefaults extends StObject {
    
    var alignments: start | end
  }
  object NavbarSegmentVariablesDefaults {
    
    inline def apply(alignments: start | end): NavbarSegmentVariablesDefaults = {
      val __obj = js.Dynamic.literal(alignments = alignments.asInstanceOf[js.Any])
  ...
  trait NavbarSegmentVariablesOverrides extends StObject
}
