...
import typings.rbx.componentsBreadcrumbBreadcrumbItemMod.BreadcrumbItemProps
import typings.rbx.componentsBreadcrumbBreadcrumbMod.BreadcrumbModifierProps
...
object componentsBreadcrumbMod {
  ...
  object Breadcrumb {
    ...
    @JSImport("rbx/components/breadcrumb", "Breadcrumb")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/breadcrumb", "Breadcrumb.Item")
    @js.native
    ...
    @JSImport("rbx/components/breadcrumb", "Breadcrumb.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/breadcrumb", "Breadcrumb.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/breadcrumb", "Breadcrumb.$$typeof")
    @js.native
