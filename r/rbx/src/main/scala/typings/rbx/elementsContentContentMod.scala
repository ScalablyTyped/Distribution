...
object elementsContentContentMod {
  
  object CONTENT_DEFAULTS {
    
    @JSImport("rbx/elements/content/content", "CONTENT_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/content/content", "CONTENT_DEFAULTS.sizes")
    @js.native
  ...
  object Content {
    ...
    @JSImport("rbx/elements/content/content", "Content.OrderedList")
    @js.native
    ...
    @JSImport("rbx/elements/content/content", "Content.defaultProps")
    @js.native
    ...
    @JSImport("rbx/elements/content/content", "Content.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/content/content", "Content.$$typeof")
    @js.native
  ...
  trait ContentModifierProps extends StObject {
    
    var size: js.UndefOr[small | medium | large] = js.undefined
  }
  object ContentModifierProps {
    
    inline def apply(): ContentModifierProps = {
  ...
  trait ContentVariables extends StObject {
    
    var sizes: small | medium | large
  }
  object ContentVariables {
    
    inline def apply(sizes: small | medium | large): ContentVariables = {
  ...
  trait ContentVariablesDefaults extends StObject {
    
    var sizes: small | medium | large
  }
  object ContentVariablesDefaults {
    
    inline def apply(sizes: small | medium | large): ContentVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any])
  ...
  trait ContentVariablesOverrides extends StObject
}
