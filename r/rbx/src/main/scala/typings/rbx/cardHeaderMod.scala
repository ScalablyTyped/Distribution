...
object cardHeaderMod {
  ...
  object CardHeader {
    ...
    inline def Title_=(x: ForwardRefAsExoticComponent[CardHeaderTitleProps, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Title")(x.asInstanceOf[js.Any])
