...
import typings.rbx.cardHeaderTitleMod.CardHeaderTitleProps
...
object cardHeaderMod {
  ...
  object CardHeader {
    ...
    @js.native
    def Title: ForwardRefAsExoticComponent[CardHeaderTitleProps, ElementType[js.Any]] = js.native
    @scala.inline
    def Title_=(x: ForwardRefAsExoticComponent[CardHeaderTitleProps, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Title")(x.asInstanceOf[js.Any])
