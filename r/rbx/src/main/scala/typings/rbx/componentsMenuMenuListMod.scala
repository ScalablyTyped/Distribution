...
object componentsMenuMenuListMod {
  ...
  object MenuList {
    ...
    @JSImport("rbx/components/menu/menu-list", "MenuList.Item")
    @js.native
    def Item: ForwardRefAsExoticComponent[MenuListItemProps, ElementType[Any]] = js.native
    inline def Item_=(x: ForwardRefAsExoticComponent[MenuListItemProps, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/menu/menu-list", "MenuList.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/menu/menu-list", "MenuList.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/menu/menu-list", "MenuList.$$typeof")
    @js.native
