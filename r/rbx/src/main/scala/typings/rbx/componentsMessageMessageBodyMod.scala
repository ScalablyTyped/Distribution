...
object componentsMessageMessageBodyMod {
  ...
  object MessageBodyProps {
    ...
    inline def apply(): MessageBodyProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MessageBodyProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: MessageBodyProps] (val x: Self) extends AnyVal {
