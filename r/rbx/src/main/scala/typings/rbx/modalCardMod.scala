...
object modalCardMod {
  ...
  object ModalCard {
    ...
    @JSImport("rbx/components/modal/modal-card", "ModalCard")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/modal/modal-card", "ModalCard.Body")
    @js.native
    ...
    @JSImport("rbx/components/modal/modal-card", "ModalCard.Foot")
    @js.native
    ...
    @JSImport("rbx/components/modal/modal-card", "ModalCard.Head")
    @js.native
    ...
    @JSImport("rbx/components/modal/modal-card", "ModalCard.Title")
    @js.native
    def Title: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]] = js.native
    inline def Title_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Title")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/modal/modal-card", "ModalCard.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
    ...
    @JSImport("rbx/components/modal/modal-card", "ModalCard.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/modal/modal-card", "ModalCard.$$typeof")
    @js.native
  ...
  trait ModalCardProps extends StObject {
  ...
  object ModalCardProps {
    
    inline def apply(): ModalCardProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ModalCardProps]
    }
    
    extension [Self <: ModalCardProps](x: Self) {
      ...
      inline def setTextSize(value: `1` | `2` | `3` | `4` | `5` | typings.rbx.rbxNumbers.`6` | `7`): Self = StObject.set(x, "textSize", value.asInstanceOf[js.Any])
