...
object modalCardMod {
  ...
  object ModalCard {
    ...
    @scala.inline
    def Foot_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Foot")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def Head_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Head")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/modal/modal-card", "ModalCard.Title")
    @js.native
    def Title: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]] = js.native
    @scala.inline
    def Title_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Title")(x.asInstanceOf[js.Any])
  ...
  object ModalCardProps {
    ...
    @scala.inline
    def apply(): ModalCardProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ModalCardProps]
    }
    
    @scala.inline
    implicit class ModalCardPropsMutableBuilder[Self <: ModalCardProps] (val x: Self) extends AnyVal {
