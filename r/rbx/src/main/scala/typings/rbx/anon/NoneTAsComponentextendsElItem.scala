...
import typings.rbx.contentOrderedListMod.ContentOrderedListModifierProps
...
@js.native
trait NoneTAsComponentextendsElItem extends js.Object {
  
  def apply[TAsComponent /* <: ElementType[_] */](
    props: `6`[TAsComponent] with HelpersPropsOverrides with PickBadgeHelpersPropsFloaBackgroundColor with ContentOrderedListModifierProps with (Pick[
  ...
  var defaultProps: AsElementType with (Partial[
    HelpersPropsOverrides with PickBadgeHelpersPropsFloaBackgroundColor with ContentOrderedListModifierProps with (Pick[_, String | Double | js.Symbol])
  ]) = js.native
