...
@js.native
trait NoneTAsComponentextendsEl extends js.Object {
  @JSName("$$typeof")
  var DollarDollartypeof: js.Symbol = js.native
  var Item: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ElementType[_]] = js.native
  ...
  def apply[TAsComponent /* <: ElementType[_] */](
    props: `7`[TAsComponent] with HelpersPropsOverrides with PickBadgeHelpersPropsFloaBackgroundColor with (Pick[
