...
trait PickBadgeHelpersPropsFloa extends StObject {
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typings.rbx.rbxStrings.PickBadgeHelpersPropsFloa & TopLevel[js.Any]
  ] = js.undefined
...
object PickBadgeHelpersPropsFloa {
  ...
  inline def apply(): PickBadgeHelpersPropsFloa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickBadgeHelpersPropsFloa]
  }
  
  extension [Self <: PickBadgeHelpersPropsFloa](x: Self) {
