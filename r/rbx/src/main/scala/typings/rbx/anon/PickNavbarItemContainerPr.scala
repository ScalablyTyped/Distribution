...
trait PickNavbarItemContainerPr extends js.Object {
  ...
  var responsive: js.UndefOr[typings.rbx.rbxStrings.PickNavbarItemContainerPr with TopLevel[js.Any]] = js.native
...
object PickNavbarItemContainerPr {
  ...
  implicit class PickNavbarItemContainerPrOps[Self <: PickNavbarItemContainerPr] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponsive(value: typings.rbx.rbxStrings.PickNavbarItemContainerPr with TopLevel[js.Any]): Self = this.set("responsive", value.asInstanceOf[js.Any])
