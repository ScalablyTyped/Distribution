...
object AsTDefaultComponent {
  ...
  @scala.inline
  implicit class AsTDefaultComponentOps[Self <: AsTDefaultComponent[_], /* <: typings.react.mod.ReactType[_] */ TDefaultComponent] (val x: Self with AsTDefaultComponent[TDefaultComponent]) extends AnyVal {
    @scala.inline
