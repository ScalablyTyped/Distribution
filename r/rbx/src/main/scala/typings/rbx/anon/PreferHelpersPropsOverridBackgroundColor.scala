...
trait PreferHelpersPropsOverridBackgroundColor extends StObject {
...
object PreferHelpersPropsOverridBackgroundColor {
  ...
  inline def apply(): PreferHelpersPropsOverridBackgroundColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PreferHelpersPropsOverridBackgroundColor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PreferHelpersPropsOverridBackgroundColor] (val x: Self) extends AnyVal {
