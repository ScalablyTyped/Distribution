...
object `6` {
  @scala.inline
  def apply[/* <: typings.react.mod.ElementType[_] */ TAsComponent](): `6`[TAsComponent] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`6`[TAsComponent]]
  }
  @scala.inline
  implicit class `6Ops`[Self <: `6`[_], /* <: typings.react.mod.ElementType[_] */ TAsComponent] (val x: Self with `6`[TAsComponent]) extends AnyVal {
    @scala.inline
