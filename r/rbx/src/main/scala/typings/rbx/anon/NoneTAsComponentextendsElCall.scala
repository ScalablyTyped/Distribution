...
trait NoneTAsComponentextendsElCall extends StObject {
  ...
  var Icon: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ElementType[Any]] = js.native
  
  var Title: ForwardRefAsExoticComponent[CardHeaderTitleProps, ElementType[Any]] = js.native
