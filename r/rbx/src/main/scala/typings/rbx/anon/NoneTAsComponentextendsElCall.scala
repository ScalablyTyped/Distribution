...
@js.native
trait NoneTAsComponentextendsElCall extends StObject {
  ...
  var Icon: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ElementType[js.Any]] = js.native
  
  var Title: ForwardRefAsExoticComponent[CardHeaderTitleProps, ElementType[js.Any]] = js.native
