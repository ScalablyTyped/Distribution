...
object PreferHelpersPropsOverrid {
  ...
  inline def apply(): PreferHelpersPropsOverrid = {
  ...
  extension [Self <: PreferHelpersPropsOverrid](x: Self) {
    ...
    inline def setTooltipResponsive(value: Kinmobiletabletdesktopwid): Self = StObject.set(x, "tooltipResponsive", value.asInstanceOf[js.Any])
