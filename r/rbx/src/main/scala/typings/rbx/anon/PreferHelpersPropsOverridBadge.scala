...
object PreferHelpersPropsOverridBadge {
  ...
  implicit class PreferHelpersPropsOverridBadgeMutableBuilder[Self <: PreferHelpersPropsOverridBadge] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResponsive(value: typings.rbx.rbxStrings.PreferHelpersPropsOverridBadge & TopLevel[js.Any]): Self = StObject.set(x, "responsive", value.asInstanceOf[js.Any])
