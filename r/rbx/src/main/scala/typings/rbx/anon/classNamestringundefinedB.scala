...
@js.native
trait classNamestringundefinedB extends StObject {
...
object classNamestringundefinedB {
  ...
  @scala.inline
  implicit class classNamestringundefinedBMutableBuilder[Self <: classNamestringundefinedB] (val x: Self) extends AnyVal {
