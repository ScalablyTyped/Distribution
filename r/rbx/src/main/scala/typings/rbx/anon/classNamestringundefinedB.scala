...
object classNamestringundefinedB {
  @scala.inline
  def apply(): classNamestringundefinedB = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[classNamestringundefinedB]
  }
  @scala.inline
  implicit class classNamestringundefinedBOps[Self <: classNamestringundefinedB] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    ): Self = this.set("textSize", value.asInstanceOf[js.Any])
    @scala.inline
