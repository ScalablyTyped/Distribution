...
import typings.rbx.panelTabMod.PanelTabModifierProps
...
@js.native
trait NoneTAsComponentextendsElDisplayName extends js.Object {
  @JSName("$$typeof")
  var DollarDollartypeof: js.Symbol = js.native
  var Group: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ElementType[_]] = js.native
  var defaultProps: AsElementType with (Partial[
    HelpersPropsOverrides with PickBadgeHelpersPropsFloaBackgroundColor with PanelTabModifierProps with (Pick[_, String | Double | js.Symbol])
  ]) = js.native
  var displayName: String with js.UndefOr[String] = js.native
  def apply[TAsComponent /* <: ElementType[_] */](
    props: `6`[TAsComponent] with HelpersPropsOverrides with PickBadgeHelpersPropsFloaBackgroundColor with PanelTabModifierProps with (Pick[
