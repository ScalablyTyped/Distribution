...
trait PickNavbarItemContainerPrActive extends StObject {
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typings.rbx.rbxStrings.PickNavbarItemContainerPrActive with TopLevel[js.Any]
  ] = js.native
...
object PickNavbarItemContainerPrActive {
  ...
  @scala.inline
  def apply(): PickNavbarItemContainerPrActive = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickNavbarItemContainerPrActive]
  }
  
  @scala.inline
  implicit class PickNavbarItemContainerPrActiveMutableBuilder[Self <: PickNavbarItemContainerPrActive] (val x: Self) extends AnyVal {
