...
@js.native
trait PickNavbarItemContainerPrActive extends js.Object {
...
object PickNavbarItemContainerPrActive {
  ...
  @scala.inline
  implicit class PickNavbarItemContainerPrActiveOps[Self <: PickNavbarItemContainerPrActive] (val x: Self) extends AnyVal {
