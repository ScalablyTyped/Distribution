...
trait PickNavbarItemContainerPrActive extends StObject {
...
object PickNavbarItemContainerPrActive {
  
  inline def apply(): PickNavbarItemContainerPrActive = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickNavbarItemContainerPrActive]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickNavbarItemContainerPrActive] (val x: Self) extends AnyVal {
    ...
    inline def setResponsive(value: BinmobilefullhdtouchLimit): Self = StObject.set(x, "responsive", value.asInstanceOf[js.Any])
