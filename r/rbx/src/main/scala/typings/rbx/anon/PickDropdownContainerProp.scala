...
trait PickDropdownContainerProp extends StObject {
...
object PickDropdownContainerProp {
  ...
  @scala.inline
  implicit class PickDropdownContainerPropMutableBuilder[Self <: PickDropdownContainerProp] (val x: Self) extends AnyVal {
