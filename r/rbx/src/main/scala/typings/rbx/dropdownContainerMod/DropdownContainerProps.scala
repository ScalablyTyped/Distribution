...
/* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/dropdown/dropdown-container.DropdownContainerModifierProps */
@js.native
trait DropdownContainerProps extends js.Object {
...
object DropdownContainerProps {
  @scala.inline
  def apply(): DropdownContainerProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DropdownContainerProps]
  }
  @scala.inline
  implicit class DropdownContainerPropsOps[Self <: DropdownContainerProps] (val x: Self) extends AnyVal {
    @scala.inline
