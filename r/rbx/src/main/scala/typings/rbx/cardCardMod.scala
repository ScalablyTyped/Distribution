...
object cardCardMod {
  ...
  object Card {
    ...
    @JSImport("rbx/components/card/card", "Card")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/card/card", "Card.Content")
    @js.native
    ...
    @JSImport("rbx/components/card/card", "Card.Footer")
    @js.native
    ...
    @JSImport("rbx/components/card/card", "Card.Header")
    @js.native
    ...
    @JSImport("rbx/components/card/card", "Card.Image")
    @js.native
    ...
    @JSImport("rbx/components/card/card", "Card.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/card/card", "Card.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/card/card", "Card.$$typeof")
    @js.native
