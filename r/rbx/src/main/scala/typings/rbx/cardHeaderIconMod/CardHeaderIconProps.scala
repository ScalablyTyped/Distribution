package typings.rbx.cardHeaderIconMod
...
@js.native
trait CardHeaderIconProps extends js.Object {
...
object CardHeaderIconProps {
  
  @scala.inline
  def apply(): CardHeaderIconProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CardHeaderIconProps]
  }
  
  @scala.inline
  implicit class CardHeaderIconPropsOps[Self <: CardHeaderIconProps] (val x: Self) extends AnyVal {
