...
object navbarSegmentMod {
  ...
  object NAVBAR_SEGMENT_DEFAULTS {
    ...
    @scala.inline
    def alignments_=(x: js.Tuple2[start, end]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alignments")(x.asInstanceOf[js.Any])
  }
  ...
  object NavbarSegmentModifierProps {
    ...
    @scala.inline
    implicit class NavbarSegmentModifierPropsMutableBuilder[Self <: NavbarSegmentModifierProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAlign(value: start | end): Self = StObject.set(x, "align", value.asInstanceOf[js.Any])
    }
  }
  ...
  object NavbarSegmentProps {
    ...
    @scala.inline
    implicit class NavbarSegmentPropsMutableBuilder[Self <: NavbarSegmentProps] (val x: Self) extends AnyVal {
  ...
  object NavbarSegmentVariables {
    ...
    @scala.inline
    implicit class NavbarSegmentVariablesMutableBuilder[Self <: NavbarSegmentVariables] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAlignments(value: start | end): Self = StObject.set(x, "alignments", value.asInstanceOf[js.Any])
    }
  }
  ...
  object NavbarSegmentVariablesDefaults {
    ...
    @scala.inline
    implicit class NavbarSegmentVariablesDefaultsMutableBuilder[Self <: NavbarSegmentVariablesDefaults] (val x: Self) extends AnyVal {
