...
object componentsNavbarNavbarDropdownMod {
  ...
  object NavbarDropdownModifierProps {
    ...
    inline def apply(): NavbarDropdownModifierProps = {
  ...
  object NavbarDropdownVariables {
    ...
    inline def apply(): NavbarDropdownVariables = {
  ...
  object NavbarDropdownVariablesDefaults {
    ...
    inline def apply(): NavbarDropdownVariablesDefaults = {
      val __obj = js.Dynamic.literal(alignments = "right")
