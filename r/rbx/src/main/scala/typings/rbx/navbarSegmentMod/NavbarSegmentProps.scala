...
@js.native
trait NavbarSegmentProps extends js.Object {
...
object NavbarSegmentProps {
  ...
  @scala.inline
  def apply(align: start | end): NavbarSegmentProps = {
    val __obj = js.Dynamic.literal(align = align.asInstanceOf[js.Any])
    __obj.asInstanceOf[NavbarSegmentProps]
  }
  
  @scala.inline
  implicit class NavbarSegmentPropsOps[Self <: NavbarSegmentProps] (val x: Self) extends AnyVal {
