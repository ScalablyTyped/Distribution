...
object tabTabMod {
  ...
  object Tab {
    ...
    @JSImport("rbx/components/tab/tab", "Tab.Group")
    @js.native
    ...
    @JSImport("rbx/components/tab/tab", "Tab.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/tab/tab", "Tab.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/tab/tab", "Tab.$$typeof")
    @js.native
  ...
  @js.native
  trait TabModifierProps extends StObject {
  ...
  object TabModifierProps {
    ...
    @scala.inline
    implicit class TabModifierPropsMutableBuilder[Self <: TabModifierProps] (val x: Self) extends AnyVal {
