package typings.rbx.cardFooterItemMod
...
@js.native
trait CardFooterItemProps extends js.Object {
...
object CardFooterItemProps {
  ...
  @scala.inline
  implicit class CardFooterItemPropsOps[Self <: CardFooterItemProps] (val x: Self) extends AnyVal {
