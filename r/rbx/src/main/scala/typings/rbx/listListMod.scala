...
object listListMod {
  ...
  object List {
    ...
    @JSImport("rbx/components/list/list", "List.Item")
    @js.native
    ...
    @JSImport("rbx/components/list/list", "List.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/list/list", "List.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/list/list", "List.$$typeof")
    @js.native
