...
object cardHeaderTitleMod {
  
  object CARD_HEADER_TITLE_DEFAULTS {
    
    @JSImport("rbx/components/card/card-header-title", "CARD_HEADER_TITLE_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/card/card-header-title", "CARD_HEADER_TITLE_DEFAULTS.alignments")
    @js.native
    def alignments: js.Array[centered] = js.native
    @scala.inline
    def alignments_=(x: js.Array[centered]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alignments")(x.asInstanceOf[js.Any])
  }
  ...
  object CardHeaderTitleModifierProps {
    ...
    @scala.inline
    implicit class CardHeaderTitleModifierPropsMutableBuilder[Self <: CardHeaderTitleModifierProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAlign(value: centered): Self = StObject.set(x, "align", value.asInstanceOf[js.Any])
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/card/card-header-title.CardHeaderTitleModifierProps */
  trait CardHeaderTitleProps extends StObject {
  ...
  object CardHeaderTitleProps {
    
    @scala.inline
    def apply(): CardHeaderTitleProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CardHeaderTitleProps]
    }
    
    @scala.inline
    implicit class CardHeaderTitlePropsMutableBuilder[Self <: CardHeaderTitleProps] (val x: Self) extends AnyVal {
  ...
  trait CardHeaderTitleVariables extends StObject {
    
    var alignments: centered
  }
  object CardHeaderTitleVariables {
    
    @scala.inline
    def apply(): CardHeaderTitleVariables = {
      val __obj = js.Dynamic.literal(alignments = "centered")
      __obj.asInstanceOf[CardHeaderTitleVariables]
    }
    
    @scala.inline
    implicit class CardHeaderTitleVariablesMutableBuilder[Self <: CardHeaderTitleVariables] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAlignments(value: centered): Self = StObject.set(x, "alignments", value.asInstanceOf[js.Any])
    }
  }
  
  trait CardHeaderTitleVariablesDefaults extends StObject {
  ...
  object CardHeaderTitleVariablesDefaults {
    ...
    @scala.inline
    def apply(): CardHeaderTitleVariablesDefaults = {
      val __obj = js.Dynamic.literal(alignments = "centered")
      __obj.asInstanceOf[CardHeaderTitleVariablesDefaults]
    }
    
    @scala.inline
    implicit class CardHeaderTitleVariablesDefaultsMutableBuilder[Self <: CardHeaderTitleVariablesDefaults] (val x: Self) extends AnyVal {
  ...
  trait CardHeaderTitleVariablesOverrides extends StObject
}
