...
object cardHeaderTitleMod {
  ...
  object CARD_HEADER_TITLE_DEFAULTS {
    ...
    inline def alignments_=(x: js.Array[centered]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alignments")(x.asInstanceOf[js.Any])
  }
  ...
  object CardHeaderTitleModifierProps {
    ...
    inline def apply(): CardHeaderTitleModifierProps = {
  ...
  object CardHeaderTitleProps {
    ...
    inline def apply(): CardHeaderTitleProps = {
      val __obj = js.Dynamic.literal()
  ...
  object CardHeaderTitleVariables {
    ...
    inline def apply(): CardHeaderTitleVariables = {
  ...
  object CardHeaderTitleVariablesDefaults {
    ...
    inline def apply(): CardHeaderTitleVariablesDefaults = {
      val __obj = js.Dynamic.literal(alignments = "centered")
