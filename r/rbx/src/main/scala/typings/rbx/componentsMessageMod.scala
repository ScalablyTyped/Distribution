...
import typings.rbx.componentsMessageMessageMod.MessageModifierProps
...
object componentsMessageMod {
  ...
  object Message {
    ...
    @JSImport("rbx/components/message", "Message")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/message", "Message.Body")
    @js.native
    ...
    @JSImport("rbx/components/message", "Message.Header")
    @js.native
    ...
    @JSImport("rbx/components/message", "Message.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/message", "Message.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/message", "Message.$$typeof")
    @js.native
