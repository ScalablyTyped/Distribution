...
object modalCardBodyMod {
  
  @JSImport("rbx/components/modal/modal-card-body", "ModalCardBody")
  @js.native
  val ModalCardBody: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ElementType[js.Any]] = js.native
  ...
  object ModalCardBodyProps {
    ...
    @scala.inline
    def apply(): ModalCardBodyProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ModalCardBodyProps]
    }
    
    @scala.inline
    implicit class ModalCardBodyPropsMutableBuilder[Self <: ModalCardBodyProps] (val x: Self) extends AnyVal {
