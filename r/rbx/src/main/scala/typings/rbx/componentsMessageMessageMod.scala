...
object componentsMessageMessageMod {
  
  object MESSAGE_DEFAULTS {
    
    @JSImport("rbx/components/message/message", "MESSAGE_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/message/message", "MESSAGE_DEFAULTS.sizes")
    @js.native
  ...
  object Message {
    ...
    inline def apply[TAsComponent /* <: ElementType[Any] */](
      props: `6`[TAsComponent] & HelpersPropsOverrides & PickBadgeHelpersPropsFloa & MessageModifierProps & (Pick[
    ...
    @JSImport("rbx/components/message/message", "Message.Body")
    @js.native
    ...
    @JSImport("rbx/components/message/message", "Message.Header")
    @js.native
    def Header: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]] = js.native
    inline def Header_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Header")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/message/message", "Message.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & MessageModifierProps & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
    ...
    @JSImport("rbx/components/message/message", "Message.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/message/message", "Message.$$typeof")
    @js.native
  ...
  trait MessageModifierProps extends StObject {
  ...
  object MessageModifierProps {
    ...
    inline def apply(): MessageModifierProps = {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/message/message.MessageModifierProps */
  ...
  trait MessageVariables extends StObject {
    
    var sizes: small | medium | large
  }
  object MessageVariables {
    
    inline def apply(sizes: small | medium | large): MessageVariables = {
  ...
  trait MessageVariablesDefaults extends StObject {
    
    var sizes: small | medium | large
  }
  object MessageVariablesDefaults {
    
    inline def apply(sizes: small | medium | large): MessageVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any])
  ...
  trait MessageVariablesOverrides extends StObject
}
