...
object componentsDropdownDropdownMod {
  ...
  object Dropdown {
    ...
    @JSImport("rbx/components/dropdown/dropdown", "Dropdown.Container")
    @js.native
    ...
    @JSImport("rbx/components/dropdown/dropdown", "Dropdown.Content")
    @js.native
    ...
    @JSImport("rbx/components/dropdown/dropdown", "Dropdown.Context")
    @js.native
    ...
    @JSImport("rbx/components/dropdown/dropdown", "Dropdown.Divider")
    @js.native
    ...
    @JSImport("rbx/components/dropdown/dropdown", "Dropdown.Item")
    @js.native
    ...
    @JSImport("rbx/components/dropdown/dropdown", "Dropdown.Menu")
    @js.native
    ...
    @JSImport("rbx/components/dropdown/dropdown", "Dropdown.Trigger")
    @js.native
    ...
    @JSImport("rbx/components/dropdown/dropdown", "Dropdown.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/dropdown/dropdown", "Dropdown.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/dropdown/dropdown", "Dropdown.$$typeof")
    @js.native
