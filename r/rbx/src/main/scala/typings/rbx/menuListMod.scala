...
object menuListMod {
  ...
  object MenuList {
    ...
    @js.native
    def Item: ForwardRefAsExoticComponent[MenuListItemProps, ElementType[js.Any]] = js.native
    inline def Item_=(x: ForwardRefAsExoticComponent[MenuListItemProps, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
