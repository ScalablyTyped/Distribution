...
object modalCloseMod {
  ...
  object ModalCloseModifierProps {
    ...
    @scala.inline
    implicit class ModalCloseModifierPropsMutableBuilder[Self <: ModalCloseModifierProps] (val x: Self) extends AnyVal {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/modal/modal-close.ModalCloseModifierProps */
  trait ModalCloseProps extends StObject {
  ...
  object ModalCloseProps {
    
    @scala.inline
    def apply(): ModalCloseProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ModalCloseProps]
    }
    
    @scala.inline
    implicit class ModalClosePropsMutableBuilder[Self <: ModalCloseProps] (val x: Self) extends AnyVal {
