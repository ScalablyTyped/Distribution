...
object fileLabelMod {
  ...
  object FileLabelProps {
    
    @scala.inline
    def apply(): FileLabelProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FileLabelProps]
    }
    
    @scala.inline
    implicit class FileLabelPropsMutableBuilder[Self <: FileLabelProps] (val x: Self) extends AnyVal {
