...
object textareaMod {
  ...
  object TextareaModifierProps {
    ...
    @scala.inline
    implicit class TextareaModifierPropsMutableBuilder[Self <: TextareaModifierProps] (val x: Self) extends AnyVal {
  ...
  object TextareaVariables {
    ...
    @scala.inline
    implicit class TextareaVariablesMutableBuilder[Self <: TextareaVariables] (val x: Self) extends AnyVal {
  ...
  object TextareaVariablesDefaults {
    ...
    @scala.inline
    implicit class TextareaVariablesDefaultsMutableBuilder[Self <: TextareaVariablesDefaults] (val x: Self) extends AnyVal {
