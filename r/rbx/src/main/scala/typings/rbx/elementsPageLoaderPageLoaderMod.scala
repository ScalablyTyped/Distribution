...
object elementsPageLoaderPageLoaderMod {
  ...
  object PAGE_LOADER_DEFAULTS {
    ...
    inline def directions_=(x: js.Tuple2[`right-to-left`, `left-to-right`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("directions")(x.asInstanceOf[js.Any])
  }
  ...
  object PageLoaderModifierProps {
    ...
    inline def apply(): PageLoaderModifierProps = {
    ...
    extension [Self <: PageLoaderModifierProps](x: Self) {
      ...
      inline def setDirection(value: `right-to-left` | `left-to-right`): Self = StObject.set(x, "direction", value.asInstanceOf[js.Any])
  ...
  object PageLoaderProps {
    ...
    inline def apply(): PageLoaderProps = {
      val __obj = js.Dynamic.literal()
