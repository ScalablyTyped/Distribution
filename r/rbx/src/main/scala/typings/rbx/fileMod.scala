...
object fileMod {
  ...
  object File {
    ...
    @scala.inline
    def CTA_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CTA")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def Input_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Input")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def Name_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Name")(x.asInstanceOf[js.Any])
  ...
  object FileModifierProps {
    ...
    @scala.inline
    implicit class FileModifierPropsMutableBuilder[Self <: FileModifierProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setBoxed(value: Boolean): Self = StObject.set(x, "boxed", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBoxedUndefined: Self = StObject.set(x, "boxed", js.undefined)
      ...
      @scala.inline
      def setHasName(value: Boolean): Self = StObject.set(x, "hasName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHasNameUndefined: Self = StObject.set(x, "hasName", js.undefined)
  ...
  object FileProps {
    ...
    @scala.inline
    implicit class FilePropsMutableBuilder[Self <: FileProps] (val x: Self) extends AnyVal {
  ...
  object FileVariables {
    ...
    @scala.inline
    implicit class FileVariablesMutableBuilder[Self <: FileVariables] (val x: Self) extends AnyVal {
  ...
  object FileVariablesDefaults {
    ...
    @scala.inline
    implicit class FileVariablesDefaultsMutableBuilder[Self <: FileVariablesDefaults] (val x: Self) extends AnyVal {
