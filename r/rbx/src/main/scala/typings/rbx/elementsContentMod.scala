...
import typings.rbx.elementsContentContentMod.ContentModifierProps
...
object elementsContentMod {
  ...
  object Content {
    ...
    @JSImport("rbx/elements/content", "Content")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/content", "Content.OrderedList")
    @js.native
    ...
    @JSImport("rbx/elements/content", "Content.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & ContentModifierProps & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
    ...
    @JSImport("rbx/elements/content", "Content.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/content", "Content.$$typeof")
    @js.native
