...
object tagTagMod {
  ...
  object TAG_DEFAULTS {
    ...
    inline def sizes_=(x: js.Tuple3[normal, medium, large]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sizes")(x.asInstanceOf[js.Any])
  }
  ...
  object TagModifierProps {
    ...
    inline def apply(): TagModifierProps = {
    ...
    extension [Self <: TagModifierProps](x: Self) {
      ...
      inline def setSize(value: normal | medium | large): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
  ...
  object TagVariables {
    ...
    inline def apply(sizes: normal | medium | large): TagVariables = {
  ...
  object TagVariablesDefaults {
    ...
    inline def apply(sizes: normal | medium | large): TagVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any])
