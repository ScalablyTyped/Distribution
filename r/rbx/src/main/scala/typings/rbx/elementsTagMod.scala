...
import typings.rbx.elementsTagTagGroupMod.TagGroupProps
import typings.rbx.elementsTagTagMod.TagModifierProps
...
object elementsTagMod {
  ...
  object Tag {
    ...
    @JSImport("rbx/elements/tag", "Tag")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/tag", "Tag.Group")
    @js.native
    def Group: ForwardRefAsExoticComponent[TagGroupProps, ElementType[Any]] = js.native
    inline def Group_=(x: ForwardRefAsExoticComponent[TagGroupProps, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Group")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/tag", "Tag.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & TagModifierProps & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
    ...
    @JSImport("rbx/elements/tag", "Tag.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/tag", "Tag.$$typeof")
    @js.native
