...
object componentsMod {
  ...
  object Breadcrumb {
    ...
    @js.native
    def Item: ForwardRefAsExoticComponent[BreadcrumbItemProps, ElementType[Any]] = js.native
    inline def Item_=(x: ForwardRefAsExoticComponent[BreadcrumbItemProps, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components", "Breadcrumb.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & BreadcrumbModifierProps & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
  ...
  object Card {
    ...
    @js.native
    def Image: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]] = js.native
    inline def Image_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Image")(x.asInstanceOf[js.Any])
  ...
  object Level {
    ...
    @js.native
    def Item: ForwardRefAsExoticComponent[LevelItemProps, ElementType[Any]] = js.native
    inline def Item_=(x: ForwardRefAsExoticComponent[LevelItemProps, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components", "Level.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & LevelModifierProps & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
    inline def defaultProps_=(
      x: AsElementType & (Partial[
          HelpersPropsOverrides & PickBadgeHelpersPropsFloa & LevelModifierProps & (Pick[Any, String | Double | js.Symbol])
  ...
  object Panel {
    ...
    @js.native
    def Block: ForwardRefAsExoticComponent[PanelBlockProps, ElementType[Any]] = js.native
    inline def Block_=(x: ForwardRefAsExoticComponent[PanelBlockProps, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Block")(x.asInstanceOf[js.Any])
  ...
  object Tab {
    ...
    @js.native
    def Group: ForwardRefAsExoticComponent[TabGroupProps, ElementType[Any]] = js.native
    inline def Group_=(x: ForwardRefAsExoticComponent[TabGroupProps, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Group")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components", "Tab.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & TabModifierProps & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
    inline def defaultProps_=(
      x: AsElementType & (Partial[
          HelpersPropsOverrides & PickBadgeHelpersPropsFloa & TabModifierProps & (Pick[Any, String | Double | js.Symbol])
