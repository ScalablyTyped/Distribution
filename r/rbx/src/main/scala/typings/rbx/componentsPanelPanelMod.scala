...
object componentsPanelPanelMod {
  ...
  object Panel {
    ...
    @JSImport("rbx/components/panel/panel", "Panel")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/panel/panel", "Panel.Block")
    @js.native
    ...
    @JSImport("rbx/components/panel/panel", "Panel.Heading")
    @js.native
    ...
    @JSImport("rbx/components/panel/panel", "Panel.Icon")
    @js.native
    ...
    @JSImport("rbx/components/panel/panel", "Panel.Tab")
    @js.native
    ...
    @JSImport("rbx/components/panel/panel", "Panel.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/panel/panel", "Panel.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/panel/panel", "Panel.$$typeof")
    @js.native
