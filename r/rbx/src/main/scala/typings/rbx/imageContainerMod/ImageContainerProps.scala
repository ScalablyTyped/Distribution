...
/* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/image/image-container.ImageContainerModifierProps */
@js.native
trait ImageContainerProps extends js.Object {
...
object ImageContainerProps {
  
  @scala.inline
  def apply(): ImageContainerProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ImageContainerProps]
  }
  
  @scala.inline
  implicit class ImageContainerPropsOps[Self <: ImageContainerProps] (val x: Self) extends AnyVal {
