...
object selectMod {
  ...
  object SELECT_CONTAINER_DEFAULTS {
    ...
    inline def states_=(x: js.Tuple3[focused, hovered, loading]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("states")(x.asInstanceOf[js.Any])
  }
  ...
  object SelectContainerModifierProps {
    ...
    inline def apply(): SelectContainerModifierProps = {
    ...
    extension [Self <: SelectContainerModifierProps](x: Self) {
      ...
      inline def setState(value: focused | hovered | loading): Self = StObject.set(x, "state", value.asInstanceOf[js.Any])
  ...
  object SelectContainerProps {
    ...
    inline def apply(): SelectContainerProps = {
      val __obj = js.Dynamic.literal()
  ...
  object SelectContainerVariables {
    ...
    inline def apply(sizes: small | medium | large, states: focused | hovered | loading): SelectContainerVariables = {
    ...
    extension [Self <: SelectContainerVariables](x: Self) {
      ...
      inline def setStates(value: focused | hovered | loading): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    }
  }
  ...
  object SelectContainerVariablesDefaults {
    ...
    inline def apply(sizes: small | medium | large, states: focused | hovered | loading): SelectContainerVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any], states = states.asInstanceOf[js.Any])
