...
import typings.rbx.elementsImageImageContainerMod.ImageContainerProps
...
object elementsImageImageMod {
  ...
  object Image {
    ...
    @JSImport("rbx/elements/image/image", "Image.Container")
    @js.native
    def Container: ForwardRefAsExoticComponent[ImageContainerProps, ElementType[Any]] = js.native
    inline def Container_=(x: ForwardRefAsExoticComponent[ImageContainerProps, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Container")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/image/image", "Image.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & ImageModifierProps & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
    ...
    @JSImport("rbx/elements/image/image", "Image.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/image/image", "Image.$$typeof")
    @js.native
  ...
  trait ImageModifierProps extends StObject {
    
    var rounded: js.UndefOr[Boolean] = js.undefined
  }
  object ImageModifierProps {
    
    inline def apply(): ImageModifierProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ImageModifierProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ImageModifierProps] (val x: Self) extends AnyVal {
