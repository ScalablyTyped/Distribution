...
trait PickNavbarItemContainerPr extends js.Object {
  ...
  var responsive: js.UndefOr[typings.rbx.rbxStrings.PickNavbarItemContainerPr with TopLevel[js.Any]] = js.undefined
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typings.rbx.rbxStrings.PickNavbarItemContainerPr with TopLevel[js.Any]
  ] = js.undefined
...
object PickNavbarItemContainerPr {
  ...
  def apply(
    ...
    responsive: typings.rbx.rbxStrings.PickNavbarItemContainerPr with TopLevel[js.Any] = null,
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typings.rbx.rbxStrings.PickNavbarItemContainerPr with TopLevel[js.Any] = null,
