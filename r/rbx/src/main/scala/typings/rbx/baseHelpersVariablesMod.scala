...
object baseHelpersVariablesMod {
  ...
  object DEFAULTS {
    ...
    inline def badgeSizes_=(x: js.Tuple3[small, medium, large]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("badgeSizes")(x.asInstanceOf[js.Any])
    ...
    inline def breakpointsLimited_=(x: js.Tuple3[mobile, fullhd, touch]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("breakpointsLimited")(x.asInstanceOf[js.Any])
    
    inline def breakpoints_=(x: js.Tuple6[mobile, tablet, desktop, widescreen, fullhd, touch]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("breakpoints")(x.asInstanceOf[js.Any])
    ...
    inline def colors_=(x: js.Tuple10[primary, success, info, warning, danger, light, dark, white, black, link]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("colors")(x.asInstanceOf[js.Any])
    ...
    inline def displays_=(x: js.Tuple5[block, flex, `inline`, `inline-block`, `inline-flex`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displays")(x.asInstanceOf[js.Any])
    ...
    inline def floatPulledAlignments_=(x: js.Tuple2[left, right]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("floatPulledAlignments")(x.asInstanceOf[js.Any])
    ...
    inline def textAlignments_=(x: js.Tuple4[centered, justified, left, right]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("textAlignments")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/base/helpers/variables", "DEFAULTS.textSizes")
    @js.native
    def textSizes: js.Tuple7[`1`, `2`, `3`, `4`, `5`, `6`, `7`] = js.native
    inline def textSizes_=(x: js.Tuple7[`1`, `2`, `3`, `4`, `5`, `6`, `7`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("textSizes")(x.asInstanceOf[js.Any])
    ...
    inline def textTransforms_=(x: js.Tuple3[capitalized, lowercase, uppercase]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("textTransforms")(x.asInstanceOf[js.Any])
    ...
    inline def textWeights_=(x: js.Tuple5[light, medium, normal, semibold, bold]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("textWeights")(x.asInstanceOf[js.Any])
    ...
    inline def tooltipPositions_=(x: js.Tuple4[top, right, bottom, left]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("tooltipPositions")(x.asInstanceOf[js.Any])
  }
  ...
  object Variables {
    ...
    implicit open class MutableBuilder[Self <: Variables] (val x: Self) extends AnyVal {
      ...
      inline def setBreakpoints(value: mobile | tablet | desktop | widescreen | fullhd | touch): Self = StObject.set(x, "breakpoints", value.asInstanceOf[js.Any])
      
      inline def setBreakpointsLimited(value: mobile | fullhd | touch): Self = StObject.set(x, "breakpointsLimited", value.asInstanceOf[js.Any])
      
      inline def setColors(value: primary | success | info | warning | danger | light | dark | white | black | link): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
      
      inline def setDisplays(value: block | flex | `inline` | `inline-block` | `inline-flex`): Self = StObject.set(x, "displays", value.asInstanceOf[js.Any])
      
      inline def setFloatPulledAlignments(value: left | right): Self = StObject.set(x, "floatPulledAlignments", value.asInstanceOf[js.Any])
      
      inline def setShades(
      ...
      inline def setTextAlignments(value: centered | justified | left | right): Self = StObject.set(x, "textAlignments", value.asInstanceOf[js.Any])
      
      inline def setTextSizes(value: `1` | `2` | `3` | `4` | `5` | `6` | `7`): Self = StObject.set(x, "textSizes", value.asInstanceOf[js.Any])
      
      inline def setTextTransforms(value: capitalized | lowercase | uppercase): Self = StObject.set(x, "textTransforms", value.asInstanceOf[js.Any])
      
      inline def setTextWeights(value: light | medium | normal | semibold | bold): Self = StObject.set(x, "textWeights", value.asInstanceOf[js.Any])
      
      inline def setTooltipPositions(value: top | right | bottom | left): Self = StObject.set(x, "tooltipPositions", value.asInstanceOf[js.Any])
    }
  }
  ...
  object VariablesDefinitions {
    ...
    implicit open class MutableBuilder[Self <: VariablesDefinitions] (val x: Self) extends AnyVal {
      ...
      inline def setBreakpoints(value: ReadonlyArraystringnumber): Self = StObject.set(x, "breakpoints", value.asInstanceOf[js.Any])
      
      inline def setBreakpointsLimited(value: ReadonlyArraystringnumber): Self = StObject.set(x, "breakpointsLimited", value.asInstanceOf[js.Any])
      
      inline def setColors(value: ReadonlyArraystringnumber): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
      
      inline def setDisplays(value: ReadonlyArraystringnumber): Self = StObject.set(x, "displays", value.asInstanceOf[js.Any])
      
      inline def setFloatPulledAlignments(value: ReadonlyArraystringnumber): Self = StObject.set(x, "floatPulledAlignments", value.asInstanceOf[js.Any])
      
      inline def setShades(value: ReadonlyArraystringnumber): Self = StObject.set(x, "shades", value.asInstanceOf[js.Any])
      
      inline def setTextAlignments(value: ReadonlyArraystringnumber): Self = StObject.set(x, "textAlignments", value.asInstanceOf[js.Any])
      
      inline def setTextSizes(value: ReadonlyArraystringnumber): Self = StObject.set(x, "textSizes", value.asInstanceOf[js.Any])
      
      inline def setTextTransforms(value: ReadonlyArraystringnumber): Self = StObject.set(x, "textTransforms", value.asInstanceOf[js.Any])
      
      inline def setTextWeights(value: ReadonlyArraystringnumber): Self = StObject.set(x, "textWeights", value.asInstanceOf[js.Any])
      
      inline def setTooltipPositions(value: ReadonlyArraystringnumber): Self = StObject.set(x, "tooltipPositions", value.asInstanceOf[js.Any])
    }
  }
