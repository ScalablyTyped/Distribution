...
import typings.rbx.rbxStrings.`type`
...
object contentOrderedListMod {
  ...
  object CONTENT_ORDERED_LIST_DEFAULTS {
    
    @JSImport("rbx/elements/content/content-ordered-list", "CONTENT_ORDERED_LIST_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/content/content-ordered-list", "CONTENT_ORDERED_LIST_DEFAULTS.types")
    @js.native
    def types: js.Tuple4[`lower-alpha`, `lower-roman`, `upper-alpha`, `upper-roman`] = js.native
    @scala.inline
    def types_=(x: js.Tuple4[`lower-alpha`, `lower-roman`, `upper-alpha`, `upper-roman`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("types")(x.asInstanceOf[js.Any])
  }
  ...
  object ContentOrderedList {
    ...
    @JSImport("rbx/elements/content/content-ordered-list", "ContentOrderedList.Item")
    @js.native
    def Item: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]] = js.native
    @scala.inline
    def Item_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
    ...
    @JSImport("rbx/elements/content/content-ordered-list", "ContentOrderedList.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/content/content-ordered-list", "ContentOrderedList.$$typeof")
    @js.native
  ...
  object ContentOrderedListModifierProps {
    ...
    @scala.inline
    implicit class ContentOrderedListModifierPropsMutableBuilder[Self <: ContentOrderedListModifierProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setType(value: `lower-alpha` | `lower-roman` | `upper-alpha` | `upper-roman`): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  object ContentOrderedListProps {
    ...
    @scala.inline
    implicit class ContentOrderedListPropsMutableBuilder[Self <: ContentOrderedListProps] (val x: Self) extends AnyVal {
  ...
  object ContentOrderedListVariables {
    ...
    @scala.inline
    implicit class ContentOrderedListVariablesMutableBuilder[Self <: ContentOrderedListVariables] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setTypes(value: `lower-alpha` | `lower-roman` | `upper-alpha` | `upper-roman`): Self = StObject.set(x, "types", value.asInstanceOf[js.Any])
    }
  }
  ...
  object ContentOrderedListVariablesDefaults {
    ...
    @scala.inline
    implicit class ContentOrderedListVariablesDefaultsMutableBuilder[Self <: ContentOrderedListVariablesDefaults] (val x: Self) extends AnyVal {
