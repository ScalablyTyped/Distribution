...
/* Inlined std.Pick<rbx.rbx/components/dropdown/dropdown-container.DropdownContainerProps, 'active' | 'hidden' | 'up' | 'overlay' | 'italic' | 'relative' | 'tooltip' | 'className' | 'badge' | 'badgeColor' | 'badgeOutlined' | 'badgeRounded' | 'badgeSize' | 'clearfix' | 'pull' | 'marginless' | 'paddingless' | 'radiusless' | 'shadowless' | 'unselectable' | 'clipped' | 'responsive' | 'textAlign' | 'textSize' | 'tooltipActive' | 'tooltipColor' | 'tooltipMultiline' | 'tooltipPosition' | 'tooltipResponsive' | 'backgroundColor' | 'textColor' | 'textTransform' | 'textWeight' | 'invisible' | 'srOnly' | 'align' | 'hoverable' | 'managed'> */
trait PickDropdownContainerProp extends js.Object {
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typings.rbx.rbxStrings.PickDropdownContainerProp with TopLevel[js.Any]
  ] = js.undefined
  var unselectable: js.UndefOr[Boolean] = js.undefined
  var up: js.UndefOr[Boolean] = js.undefined
}

object PickDropdownContainerProp {
  @scala.inline
  def apply(
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typings.rbx.rbxStrings.PickDropdownContainerProp with TopLevel[js.Any] = null,
    unselectable: js.UndefOr[Boolean] = js.undefined,
    up: js.UndefOr[Boolean] = js.undefined
  ): PickDropdownContainerProp = {
