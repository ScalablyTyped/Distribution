...
object labelMod {
  ...
  object LabelModifierProps {
    ...
    inline def apply(): LabelModifierProps = {
  ...
  object LabelVariables {
    ...
    inline def apply(sizes: small | medium | large): LabelVariables = {
  ...
  object LabelVariablesDefaults {
    ...
    inline def apply(sizes: small | medium | large): LabelVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any])
