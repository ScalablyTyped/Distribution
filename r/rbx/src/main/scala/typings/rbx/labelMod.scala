...
object labelMod {
  ...
  object LABEL_DEFAULTS {
    
    @JSImport("rbx/elements/form/label", "LABEL_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/form/label", "LABEL_DEFAULTS.sizes")
    @js.native
  ...
  object LabelModifierProps {
    ...
    @scala.inline
    implicit class LabelModifierPropsMutableBuilder[Self <: LabelModifierProps] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait LabelVariables extends StObject {
  ...
  object LabelVariables {
    ...
    @scala.inline
    implicit class LabelVariablesMutableBuilder[Self <: LabelVariables] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait LabelVariablesDefaults extends StObject {
  ...
  object LabelVariablesDefaults {
    ...
    @scala.inline
    implicit class LabelVariablesDefaultsMutableBuilder[Self <: LabelVariablesDefaults] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait LabelVariablesOverrides extends StObject
}
