...
object componentsNavbarNavbarDividerMod {
  
  @JSImport("rbx/components/navbar/navbar-divider", "NavbarDivider")
  @js.native
  val NavbarDivider: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ElementType[Any]] = js.native
  ...
  object NavbarDividerProps {
    ...
    inline def apply(): NavbarDividerProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[NavbarDividerProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: NavbarDividerProps] (val x: Self) extends AnyVal {
