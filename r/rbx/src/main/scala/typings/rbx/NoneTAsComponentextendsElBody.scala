...
trait NoneTAsComponentextendsElBody extends js.Object {
  var Body: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ElementType[_]] = js.native
  @JSName("$$typeof")
  var DollarDollartypeof: js.Symbol = js.native
  var Foot: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ElementType[_]] = js.native
  var Head: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ElementType[_]] = js.native
  var Title: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBadge, ElementType[_]] = js.native
