...
object elementsButtonButtonGroupMod {
  
  object BUTTON_GROUP_DEFAULTS {
    
    @JSImport("rbx/elements/button/button-group", "BUTTON_GROUP_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/button/button-group", "BUTTON_GROUP_DEFAULTS.alignments")
    @js.native
    ...
    @JSImport("rbx/elements/button/button-group", "BUTTON_GROUP_DEFAULTS.sizes")
    @js.native
  ...
  object ButtonGroupModifierProps {
    ...
    inline def apply(): ButtonGroupModifierProps = {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/button/button-group.ButtonGroupModifierProps */
  ...
  trait ButtonGroupVariables extends StObject {
  ...
  object ButtonGroupVariables {
    ...
    inline def apply(alignments: centered | right, sizes: small | medium | large): ButtonGroupVariables = {
  ...
  trait ButtonGroupVariablesDefaults extends StObject {
  ...
  object ButtonGroupVariablesDefaults {
    ...
    inline def apply(alignments: centered | right, sizes: small | medium | large): ButtonGroupVariablesDefaults = {
      val __obj = js.Dynamic.literal(alignments = alignments.asInstanceOf[js.Any], sizes = sizes.asInstanceOf[js.Any])
  ...
  trait ButtonGroupVariablesOverrides extends StObject
}
