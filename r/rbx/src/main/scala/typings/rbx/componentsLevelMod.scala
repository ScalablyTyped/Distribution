...
import typings.rbx.componentsLevelLevelItemMod.LevelItemProps
import typings.rbx.componentsLevelLevelMod.LevelModifierProps
...
object componentsLevelMod {
  ...
  object Level {
    ...
    @JSImport("rbx/components/level", "Level")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/level", "Level.Item")
    @js.native
    ...
    @JSImport("rbx/components/level", "Level.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/level", "Level.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/level", "Level.$$typeof")
    @js.native
