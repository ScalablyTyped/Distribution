...
trait PreferHelpersPropsOverridBackgroundColor extends js.Object {
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typings.rbx.rbxStrings.PreferHelpersPropsOverridBackgroundColor with TopLevel[js.Any]
  ] = js.undefined
  var unselectable: js.UndefOr[Boolean] = js.undefined
}

object PreferHelpersPropsOverridBackgroundColor {
  @scala.inline
  def apply(
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typings.rbx.rbxStrings.PreferHelpersPropsOverridBackgroundColor with TopLevel[js.Any] = null,
    unselectable: js.UndefOr[Boolean] = js.undefined
  ): PreferHelpersPropsOverridBackgroundColor = {
    ...
    __obj.asInstanceOf[PreferHelpersPropsOverridBackgroundColor]
  }
}
