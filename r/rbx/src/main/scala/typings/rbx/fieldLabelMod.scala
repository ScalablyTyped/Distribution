...
object fieldLabelMod {
  ...
  object FieldLabelModifierProps {
    ...
    inline def apply(): FieldLabelModifierProps = {
  ...
  object FieldLabelVariables {
    ...
    inline def apply(sizes: small | normal | medium | large): FieldLabelVariables = {
  ...
  object FieldLabelVariablesDefaults {
    ...
    inline def apply(sizes: small | normal | medium | large): FieldLabelVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any])
