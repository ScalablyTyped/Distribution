...
object fieldLabelMod {
  ...
  object FIELD_LABEL_DEFAULTS {
    
    @JSImport("rbx/elements/form/field-label", "FIELD_LABEL_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/form/field-label", "FIELD_LABEL_DEFAULTS.sizes")
    @js.native
  ...
  object FieldLabelModifierProps {
    ...
    @scala.inline
    implicit class FieldLabelModifierPropsMutableBuilder[Self <: FieldLabelModifierProps] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait FieldLabelVariables extends StObject {
  ...
  object FieldLabelVariables {
    ...
    @scala.inline
    implicit class FieldLabelVariablesMutableBuilder[Self <: FieldLabelVariables] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait FieldLabelVariablesDefaults extends StObject {
  ...
  object FieldLabelVariablesDefaults {
    ...
    @scala.inline
    implicit class FieldLabelVariablesDefaultsMutableBuilder[Self <: FieldLabelVariablesDefaults] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait FieldLabelVariablesOverrides extends StObject
}
