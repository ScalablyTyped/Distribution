...
object elementsContentContentOrderedListMod {
  ...
  object CONTENT_ORDERED_LIST_DEFAULTS {
    ...
    inline def types_=(x: js.Tuple4[`lower-alpha`, `lower-roman`, `upper-alpha`, `upper-roman`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("types")(x.asInstanceOf[js.Any])
  }
  ...
  object ContentOrderedList {
    ...
    @js.native
    def Item: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]] = js.native
    inline def Item_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/content/content-ordered-list", "ContentOrderedList.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & ContentOrderedListModifierProps & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
  ...
  object ContentOrderedListModifierProps {
    ...
    inline def apply(): ContentOrderedListModifierProps = {
  ...
  object ContentOrderedListProps {
    ...
    inline def apply(): ContentOrderedListProps = {
      val __obj = js.Dynamic.literal()
  ...
  object ContentOrderedListVariables {
    ...
    inline def apply(types: `lower-alpha` | `lower-roman` | `upper-alpha` | `upper-roman`): ContentOrderedListVariables = {
  ...
  object ContentOrderedListVariablesDefaults {
    ...
    inline def apply(types: `lower-alpha` | `lower-roman` | `upper-alpha` | `upper-roman`): ContentOrderedListVariablesDefaults = {
      val __obj = js.Dynamic.literal(types = types.asInstanceOf[js.Any])
