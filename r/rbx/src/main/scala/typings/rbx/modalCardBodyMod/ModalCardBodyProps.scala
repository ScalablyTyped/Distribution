package typings.rbx.modalCardBodyMod
...
@js.native
trait ModalCardBodyProps extends js.Object {
...
object ModalCardBodyProps {
  ...
  @scala.inline
  implicit class ModalCardBodyPropsOps[Self <: ModalCardBodyProps] (val x: Self) extends AnyVal {
