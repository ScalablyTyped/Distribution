...
object componentsPaginationPaginationStepMod {
  
  object PAGINATION_STEP_DEFAULTS {
    
    @JSImport("rbx/components/pagination/pagination-step", "PAGINATION_STEP_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/pagination/pagination-step", "PAGINATION_STEP_DEFAULTS.alignments")
    @js.native
    def alignments: js.Tuple2[next, previous] = js.native
    inline def alignments_=(x: js.Tuple2[next, previous]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alignments")(x.asInstanceOf[js.Any])
  }
  ...
  object PaginationStepModifierProps {
    ...
    inline def apply(align: next | previous): PaginationStepModifierProps = {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/pagination/pagination-step.PaginationStepModifierProps */
  trait PaginationStepProps extends StObject {
  ...
  object PaginationStepProps {
    
    inline def apply(align: next | previous): PaginationStepProps = {
      val __obj = js.Dynamic.literal(align = align.asInstanceOf[js.Any])
  ...
  trait PaginationStepVariables extends StObject {
    
    var alignments: next | previous
  }
  object PaginationStepVariables {
    
    inline def apply(alignments: next | previous): PaginationStepVariables = {
  ...
  trait PaginationStepVariablesDefaults extends StObject {
    
    var alignments: next | previous
  }
  object PaginationStepVariablesDefaults {
    
    inline def apply(alignments: next | previous): PaginationStepVariablesDefaults = {
      val __obj = js.Dynamic.literal(alignments = alignments.asInstanceOf[js.Any])
  ...
  trait PaginationStepVariablesOverrides extends StObject
}
