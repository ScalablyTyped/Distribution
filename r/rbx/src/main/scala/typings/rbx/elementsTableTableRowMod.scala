...
object elementsTableTableRowMod {
  ...
  object TableRowHelperProps {
    ...
    inline def apply(): TableRowHelperProps = {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/table/table-row.TableRowHelperProps */
