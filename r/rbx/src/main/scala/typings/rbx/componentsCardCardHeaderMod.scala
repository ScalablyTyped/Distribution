...
import typings.rbx.componentsCardCardHeaderTitleMod.CardHeaderTitleProps
...
object componentsCardCardHeaderMod {
  ...
  object CardHeader {
    ...
    @JSImport("rbx/components/card/card-header", "CardHeader")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/card/card-header", "CardHeader.Icon")
    @js.native
    ...
    @JSImport("rbx/components/card/card-header", "CardHeader.Title")
    @js.native
    def Title: ForwardRefAsExoticComponent[CardHeaderTitleProps, ElementType[Any]] = js.native
    inline def Title_=(x: ForwardRefAsExoticComponent[CardHeaderTitleProps, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Title")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/card/card-header", "CardHeader.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/card/card-header", "CardHeader.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/card/card-header", "CardHeader.$$typeof")
    @js.native
