...
object deleteMod {
  ...
  object DeleteModifierProps {
    ...
    @scala.inline
    implicit class DeleteModifierPropsMutableBuilder[Self <: DeleteModifierProps] (val x: Self) extends AnyVal {
  ...
  object DeleteVariables {
    ...
    @scala.inline
    implicit class DeleteVariablesMutableBuilder[Self <: DeleteVariables] (val x: Self) extends AnyVal {
  ...
  object DeleteVariablesDefaults {
    ...
    @scala.inline
    implicit class DeleteVariablesDefaultsMutableBuilder[Self <: DeleteVariablesDefaults] (val x: Self) extends AnyVal {
