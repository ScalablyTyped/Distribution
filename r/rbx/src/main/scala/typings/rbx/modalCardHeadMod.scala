...
object modalCardHeadMod {
  ...
  object ModalCardHeadProps {
    
    @scala.inline
    def apply(): ModalCardHeadProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ModalCardHeadProps]
    }
    
    @scala.inline
    implicit class ModalCardHeadPropsMutableBuilder[Self <: ModalCardHeadProps] (val x: Self) extends AnyVal {
