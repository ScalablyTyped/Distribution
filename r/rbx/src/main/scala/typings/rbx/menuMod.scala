...
object menuMod {
  ...
  object Menu {
    ...
    @JSImport("rbx/components/menu", "Menu")
    @js.native
    ...
    @JSImport("rbx/components/menu", "Menu.Label")
    @js.native
    ...
    @JSImport("rbx/components/menu", "Menu.List")
    @js.native
    ...
    @JSImport("rbx/components/menu", "Menu.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/menu", "Menu.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/menu", "Menu.$$typeof")
    @js.native
