...
object inputMod {
  ...
  object INPUT_DEFAULTS {
    ...
    inline def types_=(x: js.Tuple9[text, email, tel, password, number, search, color, date, time]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("types")(x.asInstanceOf[js.Any])
  }
  ...
  object InputModifierProps {
    ...
    inline def apply(): InputModifierProps = {
    ...
    extension [Self <: InputModifierProps](x: Self) {
      ...
      inline def setType(value: text | email | tel | password | number | search | color | date | time): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  object InputVariables {
    ...
    extension [Self <: InputVariables](x: Self) {
      ...
      inline def setTypes(value: text | email | tel | password | number | search | color | date | time): Self = StObject.set(x, "types", value.asInstanceOf[js.Any])
    }
  }
