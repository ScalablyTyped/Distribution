...
object imageImageMod {
  ...
  object Image {
    ...
    @scala.inline
    def Container_=(x: ForwardRefAsExoticComponent[ImageContainerProps, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Container")(x.asInstanceOf[js.Any])
  ...
  object ImageModifierProps {
    ...
    @scala.inline
    implicit class ImageModifierPropsMutableBuilder[Self <: ImageModifierProps] (val x: Self) extends AnyVal {
