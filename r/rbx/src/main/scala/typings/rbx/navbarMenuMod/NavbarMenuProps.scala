package typings.rbx.navbarMenuMod
...
@js.native
trait NavbarMenuProps extends js.Object {
...
object NavbarMenuProps {
  ...
  @scala.inline
  implicit class NavbarMenuPropsOps[Self <: NavbarMenuProps] (val x: Self) extends AnyVal {
    @scala.inline
