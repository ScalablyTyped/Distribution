...
trait PreferHelpersPropsOverridBadge extends js.Object {
  ...
  var responsive: js.UndefOr[typings.rbx.rbxStrings.PreferHelpersPropsOverridBadge with TopLevel[js.Any]] = js.undefined
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typings.rbx.rbxStrings.PreferHelpersPropsOverridBadge with TopLevel[js.Any]
  ] = js.undefined
...
object PreferHelpersPropsOverridBadge {
  ...
  def apply(
    ...
    responsive: typings.rbx.rbxStrings.PreferHelpersPropsOverridBadge with TopLevel[js.Any] = null,
  ...
  {[ K in 'mobile' | 'tablet' | 'desktop' | 'widescreen' | 'fullhd' | 'touch' ]:? 'top' | 'right' | 'bottom' | 'left'}
    */ typings.rbx.rbxStrings.PreferHelpersPropsOverridBadge with TopLevel[js.Any] = null,
