...
import typings.rbx.elementsButtonButtonMod.ButtonModifierProps
...
object elementsButtonMod {
  ...
  object Button {
    ...
    @JSImport("rbx/elements/button", "Button")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/button", "Button.Group")
    @js.native
    ...
    @JSImport("rbx/elements/button", "Button.defaultProps")
    @js.native
    ...
    @JSImport("rbx/elements/button", "Button.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/button", "Button.$$typeof")
    @js.native
