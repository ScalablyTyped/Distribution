...
import typings.rbx.elementsButtonButtonGroupMod.ButtonGroupProps
...
object elementsButtonButtonMod {
  
  object BUTTON_DEFAULTS {
    
    @JSImport("rbx/elements/button/button", "BUTTON_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/button/button", "BUTTON_DEFAULTS.sizes")
    @js.native
    def sizes: js.Tuple4[small, normal, medium, large] = js.native
    inline def sizes_=(x: js.Tuple4[small, normal, medium, large]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sizes")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/button/button", "BUTTON_DEFAULTS.states")
    @js.native
    def states: js.Tuple4[hovered, focused, active, loading] = js.native
    inline def states_=(x: js.Tuple4[hovered, focused, active, loading]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("states")(x.asInstanceOf[js.Any])
  }
  ...
  object Button {
    ...
    @JSImport("rbx/elements/button/button", "Button.Group")
    @js.native
    def Group: ForwardRefAsExoticComponent[ButtonGroupProps, ElementType[Any]] = js.native
    inline def Group_=(x: ForwardRefAsExoticComponent[ButtonGroupProps, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Group")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/button/button", "Button.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & ButtonModifierProps & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
    ...
    @JSImport("rbx/elements/button/button", "Button.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/button/button", "Button.$$typeof")
    @js.native
  ...
  trait ButtonModifierProps extends StObject {
  ...
  object ButtonModifierProps {
    ...
    inline def apply(): ButtonModifierProps = {
    ...
    extension [Self <: ButtonModifierProps](x: Self) {
      ...
      inline def setState(value: hovered | focused | active | loading): Self = StObject.set(x, "state", value.asInstanceOf[js.Any])
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/button/button.ButtonModifierProps */
  ...
  trait ButtonVariables extends StObject {
  ...
  object ButtonVariables {
    ...
    inline def apply(sizes: small | normal | medium | large, states: hovered | focused | active | loading): ButtonVariables = {
    ...
    extension [Self <: ButtonVariables](x: Self) {
      ...
      inline def setStates(value: hovered | focused | active | loading): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
    }
  }
  
  trait ButtonVariablesDefaults extends StObject {
  ...
  object ButtonVariablesDefaults {
    ...
    inline def apply(sizes: small | normal | medium | large, states: hovered | focused | active | loading): ButtonVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any], states = states.asInstanceOf[js.Any])
  ...
  trait ButtonVariablesOverrides extends StObject
}
