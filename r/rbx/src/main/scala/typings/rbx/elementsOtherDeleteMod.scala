...
object elementsOtherDeleteMod {
  
  object DELETE_DEFAULTS {
    
    @JSImport("rbx/elements/other/delete", "DELETE_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/other/delete", "DELETE_DEFAULTS.sizes")
    @js.native
  ...
  object DeleteModifierProps {
    ...
    inline def apply(): DeleteModifierProps = {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/elements/other/delete.DeleteModifierProps */
  trait DeleteProps extends StObject {
  ...
  trait DeleteVariables extends StObject {
    
    var sizes: small | medium | large
  }
  object DeleteVariables {
    
    inline def apply(sizes: small | medium | large): DeleteVariables = {
  ...
  trait DeleteVariablesDefaults extends StObject {
    
    var sizes: small | medium | large
  }
  object DeleteVariablesDefaults {
    
    inline def apply(sizes: small | medium | large): DeleteVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any])
  ...
  trait DeleteVariablesOverrides extends StObject
}
