...
object navbarBurgerMod {
  ...
  object NavbarBurgerModifierProps {
    ...
    @scala.inline
    implicit class NavbarBurgerModifierPropsMutableBuilder[Self <: NavbarBurgerModifierProps] (val x: Self) extends AnyVal {
  ...
  object NavbarBurgerProps {
    ...
    @scala.inline
    implicit class NavbarBurgerPropsMutableBuilder[Self <: NavbarBurgerProps] (val x: Self) extends AnyVal {
