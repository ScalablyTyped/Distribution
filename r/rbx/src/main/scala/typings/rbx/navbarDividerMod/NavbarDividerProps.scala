package typings.rbx.navbarDividerMod
...
object NavbarDividerProps {
  @scala.inline
  def apply(): NavbarDividerProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NavbarDividerProps]
  }
  @scala.inline
  implicit class NavbarDividerPropsOps[Self <: NavbarDividerProps] (val x: Self) extends AnyVal {
    @scala.inline
