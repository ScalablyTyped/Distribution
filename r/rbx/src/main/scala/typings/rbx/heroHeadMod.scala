...
object heroHeadMod {
  ...
  @js.native
  val HeroHead: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ElementType[js.Any]] = js.native
  ...
  object HeroHeadProps {
    ...
    @scala.inline
    implicit class HeroHeadPropsMutableBuilder[Self <: HeroHeadProps] (val x: Self) extends AnyVal {
