...
object tableMod {
  ...
  object Table {
    ...
    @JSImport("rbx/elements/table", "Table")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/elements/table", "Table.Body")
    @js.native
    ...
    @JSImport("rbx/elements/table", "Table.Cell")
    @js.native
    ...
    @JSImport("rbx/elements/table", "Table.Foot")
    @js.native
    ...
    @JSImport("rbx/elements/table", "Table.Head")
    @js.native
    ...
    @JSImport("rbx/elements/table", "Table.Heading")
    @js.native
    ...
    @JSImport("rbx/elements/table", "Table.Row")
    @js.native
    ...
    @JSImport("rbx/elements/table", "Table.defaultProps")
    @js.native
    ...
    @JSImport("rbx/elements/table", "Table.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/elements/table", "Table.$$typeof")
    @js.native
