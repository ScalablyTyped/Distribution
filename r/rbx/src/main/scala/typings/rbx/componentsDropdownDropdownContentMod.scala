...
object componentsDropdownDropdownContentMod {
  ...
  object DropdownContentProps {
    ...
    inline def apply(): DropdownContentProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DropdownContentProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: DropdownContentProps] (val x: Self) extends AnyVal {
