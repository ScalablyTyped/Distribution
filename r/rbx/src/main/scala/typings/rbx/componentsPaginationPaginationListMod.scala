...
object componentsPaginationPaginationListMod {
  ...
  object PaginationListProps {
    ...
    inline def apply(): PaginationListProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PaginationListProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PaginationListProps] (val x: Self) extends AnyVal {
