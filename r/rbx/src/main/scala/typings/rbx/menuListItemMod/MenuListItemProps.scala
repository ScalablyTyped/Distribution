...
/* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/menu/menu-list-item.MenuListItemModifierProps */
@js.native
trait MenuListItemProps extends js.Object {
...
object MenuListItemProps {
  @scala.inline
  def apply(): MenuListItemProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MenuListItemProps]
  }
  @scala.inline
  implicit class MenuListItemPropsOps[Self <: MenuListItemProps] (val x: Self) extends AnyVal {
    @scala.inline
