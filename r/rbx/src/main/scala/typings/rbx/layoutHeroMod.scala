...
object layoutHeroMod {
  ...
  object Hero {
    ...
    @JSImport("rbx/layout/hero", "Hero")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/layout/hero", "Hero.Body")
    @js.native
    ...
    @JSImport("rbx/layout/hero", "Hero.Foot")
    @js.native
    ...
    @JSImport("rbx/layout/hero", "Hero.Head")
    @js.native
    ...
    @JSImport("rbx/layout/hero", "Hero.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & HeroModifierProps & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
    ...
    @JSImport("rbx/layout/hero", "Hero.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/layout/hero", "Hero.$$typeof")
    @js.native
