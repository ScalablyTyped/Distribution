...
object componentsLevelLevelItemMod {
  
  object LEVEL_ITEM_DEFAULTS {
    
    @JSImport("rbx/components/level/level-item", "LEVEL_ITEM_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/level/level-item", "LEVEL_ITEM_DEFAULTS.alignments")
    @js.native
  ...
  object LevelItemModifierProps {
    ...
    inline def apply(): LevelItemModifierProps = {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/level/level-item.LevelItemModifierProps */
  trait LevelItemProps extends StObject {
  ...
  object LevelItemProps {
    
    inline def apply(): LevelItemProps = {
      val __obj = js.Dynamic.literal()
  ...
  trait LevelItemVariables extends StObject {
    
    var alignments: left | right
  }
  object LevelItemVariables {
    
    inline def apply(alignments: left | right): LevelItemVariables = {
  ...
  trait LevelItemVariablesDefaults extends StObject {
    
    var alignments: left | right
  }
  object LevelItemVariablesDefaults {
    
    inline def apply(alignments: left | right): LevelItemVariablesDefaults = {
      val __obj = js.Dynamic.literal(alignments = alignments.asInstanceOf[js.Any])
  ...
  trait LevelItemVariablesOverrides extends StObject
}
