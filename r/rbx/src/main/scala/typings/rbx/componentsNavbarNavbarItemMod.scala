...
object componentsNavbarNavbarItemMod {
  ...
  object NavbarItem {
    ...
    @js.native
    open class Container protected () extends NavbarItemContainer {
      def this(props: NavbarItemContainerProps) = this()
    }
    @JSImport("rbx/components/navbar/navbar-item", "NavbarItem.Container")
    @js.native
    def Container: TypeofNavbarItemContainer = js.native
    inline def Container_=(x: TypeofNavbarItemContainer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Container")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/navbar/navbar-item", "NavbarItem.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[PickNavbarItemContainerPrActive & (Pick[Any, String | Double | js.Symbol])]) = js.native
    inline def defaultProps_=(
      x: AsElementType & (Partial[PickNavbarItemContainerPrActive & (Pick[Any, String | Double | js.Symbol])])
