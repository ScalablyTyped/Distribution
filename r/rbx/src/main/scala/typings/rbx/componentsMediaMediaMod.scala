...
import typings.rbx.componentsMediaMediaItemMod.MediaItemProps
...
object componentsMediaMediaMod {
  ...
  object Media {
    ...
    @JSImport("rbx/components/media/media", "Media")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/media/media", "Media.Item")
    @js.native
    def Item: ForwardRefAsExoticComponent[MediaItemProps, ElementType[Any]] = js.native
    inline def Item_=(x: ForwardRefAsExoticComponent[MediaItemProps, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/media/media", "Media.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/media/media", "Media.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/media/media", "Media.$$typeof")
    @js.native
