package typings.rbx.genericMod
...
@js.native
trait GenericProps extends js.Object {
...
object GenericProps {
  ...
  @scala.inline
  def apply(): GenericProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GenericProps]
  }
  
  @scala.inline
  implicit class GenericPropsOps[Self <: GenericProps] (val x: Self) extends AnyVal {
