...
object componentsModalModalBackgroundMod {
  ...
  object ModalBackgroundModifierProps {
    ...
    inline def apply(): ModalBackgroundModifierProps = {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/modal/modal-background.ModalBackgroundModifierProps */
  trait ModalBackgroundProps extends StObject {
  ...
  object ModalBackgroundProps {
    
    inline def apply(): ModalBackgroundProps = {
      val __obj = js.Dynamic.literal()
