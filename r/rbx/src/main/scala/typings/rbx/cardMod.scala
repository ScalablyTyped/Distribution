...
object cardMod {
  ...
  object Card {
    ...
    @JSImport("rbx/components/card", "Card")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/card", "Card.Content")
    @js.native
    def Content: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]] = js.native
    inline def Content_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Content")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/card", "Card.Footer")
    @js.native
    def Footer: NoneTAsComponentextendsEl = js.native
    inline def Footer_=(x: NoneTAsComponentextendsEl): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Footer")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/card", "Card.Header")
    @js.native
    def Header: NoneTAsComponentextendsElCall = js.native
    inline def Header_=(x: NoneTAsComponentextendsElCall): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Header")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/card", "Card.Image")
    @js.native
    def Image: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]] = js.native
    inline def Image_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Image")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/card", "Card.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/card", "Card.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/card", "Card.$$typeof")
    @js.native
