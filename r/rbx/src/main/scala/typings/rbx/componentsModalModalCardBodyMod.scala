...
object componentsModalModalCardBodyMod {
  
  @JSImport("rbx/components/modal/modal-card-body", "ModalCardBody")
  @js.native
  val ModalCardBody: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ElementType[Any]] = js.native
  
  /* Inlined rbx.rbx/base/helpers.HelpersProps */
  trait ModalCardBodyProps extends StObject {
  ...
  object ModalCardBodyProps {
    
    inline def apply(): ModalCardBodyProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ModalCardBodyProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ModalCardBodyProps] (val x: Self) extends AnyVal {
