...
object listMod {
  ...
  object List {
    ...
    @JSImport("rbx/components/list", "List")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/list", "List.Item")
    @js.native
    def Item: ForwardRefAsExoticComponent[ListItemProps, ElementType[Any]] = js.native
    inline def Item_=(x: ForwardRefAsExoticComponent[ListItemProps, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/list", "List.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/list", "List.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/list", "List.$$typeof")
    @js.native
