...
object listMod {
  ...
  object List {
    ...
    @js.native
    def Item: ForwardRefAsExoticComponent[ListItemProps, ElementType[js.Any]] = js.native
    inline def Item_=(x: ForwardRefAsExoticComponent[ListItemProps, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Item")(x.asInstanceOf[js.Any])
