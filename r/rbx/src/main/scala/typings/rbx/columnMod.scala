...
import typings.rbx.rbxInts.`10`
import typings.rbx.rbxInts.`11`
import typings.rbx.rbxInts.`12`
...
object columnMod {
  ...
  object COLUMN_DEFAULTS {
    ...
    @js.native
    def sizes: js.Array[Any] = js.native
    inline def sizes_=(x: js.Array[Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sizes")(x.asInstanceOf[js.Any])
  }
  ...
  object Column {
    ...
    @js.native
    def Group: ForwardRefAsExoticComponent[ColumnGroupPropsBackgroundColor, ElementType[Any]] = js.native
    inline def Group_=(x: ForwardRefAsExoticComponent[ColumnGroupPropsBackgroundColor, ElementType[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Group")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/grid/columns/column", "Column.defaultProps")
    @js.native
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & Fullhd & ColumnBreakpointOptions & (Pick[Any, String | Double | js.Symbol])
      ]) = js.native
  ...
  object ColumnBreakpointOptions {
    ...
    inline def apply(): ColumnBreakpointOptions = {
  ...
  object ColumnModifierProps {
    ...
    inline def apply(): ColumnModifierProps = {
      val __obj = js.Dynamic.literal()
