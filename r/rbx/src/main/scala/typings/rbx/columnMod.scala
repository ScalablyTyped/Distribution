...
object columnMod {
  ...
  object COLUMN_DEFAULTS {
    
    @JSImport("rbx/grid/columns/column", "COLUMN_DEFAULTS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/grid/columns/column", "COLUMN_DEFAULTS.sizes")
    @js.native
    def sizes: js.Array[js.Any] = js.native
    @scala.inline
    def sizes_=(x: js.Array[js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sizes")(x.asInstanceOf[js.Any])
  }
  ...
  object Column {
    ...
    @JSImport("rbx/grid/columns/column", "Column.Group")
    @js.native
    def Group: ForwardRefAsExoticComponent[ColumnGroupPropsBackgroundColor, ElementType[js.Any]] = js.native
    @scala.inline
    def Group_=(x: ForwardRefAsExoticComponent[ColumnGroupPropsBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Group")(x.asInstanceOf[js.Any])
    ...
    @JSImport("rbx/grid/columns/column", "Column.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/grid/columns/column", "Column.$$typeof")
    @js.native
  ...
  object ColumnBreakpointOptions {
    ...
    @scala.inline
    implicit class ColumnBreakpointOptionsMutableBuilder[Self <: ColumnBreakpointOptions] (val x: Self) extends AnyVal {
  ...
  object ColumnModifierProps {
    ...
    @scala.inline
    implicit class ColumnModifierPropsMutableBuilder[Self <: ColumnModifierProps] (val x: Self) extends AnyVal {
  ...
  object ColumnVariables {
    ...
    @scala.inline
    implicit class ColumnVariablesMutableBuilder[Self <: ColumnVariables] (val x: Self) extends AnyVal {
  ...
  object ColumnVariablesDefaults {
    ...
    @scala.inline
    implicit class ColumnVariablesDefaultsMutableBuilder[Self <: ColumnVariablesDefaults] (val x: Self) extends AnyVal {
