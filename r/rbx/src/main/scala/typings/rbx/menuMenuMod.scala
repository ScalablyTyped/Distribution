...
object menuMenuMod {
  ...
  object Menu {
    ...
    @JSImport("rbx/components/menu/menu", "Menu")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rbx/components/menu/menu", "Menu.Label")
    @js.native
    ...
    @JSImport("rbx/components/menu/menu", "Menu.List")
    @js.native
    def List: NoneTAsComponentextendsElDefaultProps = js.native
    inline def List_=(x: NoneTAsComponentextendsElDefaultProps): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("List")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/menu/menu", "Menu.defaultProps")
    @js.native
    ...
    @JSImport("rbx/components/menu/menu", "Menu.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/menu/menu", "Menu.$$typeof")
    @js.native
