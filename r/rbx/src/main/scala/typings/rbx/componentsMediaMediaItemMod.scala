...
object componentsMediaMediaItemMod {
  ...
  object MEDIA_ITEM_DEFAULTS {
    ...
    inline def alignments_=(x: js.Tuple3[content, left, right]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alignments")(x.asInstanceOf[js.Any])
  }
  ...
  object MediaItemModifierProps {
    ...
    inline def apply(): MediaItemModifierProps = {
  ...
  object MediaItemVariables {
    ...
    inline def apply(alignments: content | left | right): MediaItemVariables = {
  ...
  object MediaItemVariablesDefaults {
    ...
    inline def apply(alignments: content | left | right): MediaItemVariablesDefaults = {
      val __obj = js.Dynamic.literal(alignments = alignments.asInstanceOf[js.Any])
