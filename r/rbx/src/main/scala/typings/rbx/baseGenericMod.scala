...
object baseGenericMod {
  ...
  object GenericProps {
    ...
    inline def apply(): GenericProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[GenericProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: GenericProps] (val x: Self) extends AnyVal {
