...
object menuLabelMod {
  ...
  object MenuLabelProps {
    
    @scala.inline
    def apply(): MenuLabelProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MenuLabelProps]
    }
    
    @scala.inline
    implicit class MenuLabelPropsMutableBuilder[Self <: MenuLabelProps] (val x: Self) extends AnyVal {
