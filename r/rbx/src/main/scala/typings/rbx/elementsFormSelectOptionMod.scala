...
object elementsFormSelectOptionMod {
  
  @JSImport("rbx/elements/form/select-option", "SelectOption")
  @js.native
  val SelectOption: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ElementType[Any]] = js.native
  
  /* Inlined rbx.rbx/base/helpers.HelpersProps */
  trait SelectOptionProps extends StObject {
  ...
  object SelectOptionProps {
    ...
    inline def apply(): SelectOptionProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SelectOptionProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: SelectOptionProps] (val x: Self) extends AnyVal {
