...
object modalCardFootMod {
  
  @JSImport("rbx/components/modal/modal-card-foot", "ModalCardFoot")
  @js.native
  val ModalCardFoot: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ElementType[js.Any]] = js.native
  
  /* Inlined rbx.rbx/base/helpers.HelpersProps */
  trait ModalCardFootProps extends StObject {
  ...
  object ModalCardFootProps {
    ...
    @scala.inline
    def apply(): ModalCardFootProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ModalCardFootProps]
    }
    
    @scala.inline
    implicit class ModalCardFootPropsMutableBuilder[Self <: ModalCardFootProps] (val x: Self) extends AnyVal {
