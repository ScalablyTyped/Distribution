...
object cardFooterItemMod {
  ...
  object CardFooterItemProps {
    
    @scala.inline
    def apply(): CardFooterItemProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CardFooterItemProps]
    }
    
    @scala.inline
    implicit class CardFooterItemPropsMutableBuilder[Self <: CardFooterItemProps] (val x: Self) extends AnyVal {
