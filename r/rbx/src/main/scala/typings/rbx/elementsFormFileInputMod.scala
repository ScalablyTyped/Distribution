...
object elementsFormFileInputMod {
  
  @JSImport("rbx/elements/form/file-input", "FileInput")
  @js.native
  val FileInput: ForwardRefAsExoticComponent[PreferHelpersPropsOverrid, ElementType[Any]] = js.native
