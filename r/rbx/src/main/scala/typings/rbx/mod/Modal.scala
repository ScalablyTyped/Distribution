...
object Modal {
  ...
  @JSImport("rbx", "Modal.defaultProps")
  @js.native
  ...
  @JSImport("rbx", "Modal.displayName")
  @js.native
  ...
  object propTypes {
    ...
    @JSImport("rbx", "Modal.propTypes")
    @js.native
    val ^ : Active = js.native
  }
  
  @JSImport("rbx", "Modal.$$typeof")
  @js.native
