...
object layoutHeroHeroMod {
  ...
  object HERO_DEFAULTS {
    ...
    inline def sizes_=(x: js.Tuple5[small, medium, large, fullheight, `fullheight-with-navbar`]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sizes")(x.asInstanceOf[js.Any])
  }
  ...
  object HeroModifierProps {
    ...
    inline def apply(): HeroModifierProps = {
    ...
    implicit open class MutableBuilder[Self <: HeroModifierProps] (val x: Self) extends AnyVal {
      ...
      inline def setSize(value: small | medium | large | fullheight | `fullheight-with-navbar`): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
  ...
  object HeroVariables {
    ...
    inline def apply(sizes: small | medium | large | fullheight | `fullheight-with-navbar`): HeroVariables = {
  ...
  object HeroVariablesDefaults {
    ...
    inline def apply(sizes: small | medium | large | fullheight | `fullheight-with-navbar`): HeroVariablesDefaults = {
      val __obj = js.Dynamic.literal(sizes = sizes.asInstanceOf[js.Any])
