...
object panelTabMod {
  ...
  object PanelTab {
    ...
    def apply[TAsComponent /* <: ElementType[js.Any] */](
      props: `6`[TAsComponent] & HelpersPropsOverrides & PickBadgeHelpersPropsFloa & PanelTabModifierProps & (Pick[
    ...
    def defaultProps: AsElementType & (Partial[
        HelpersPropsOverrides & PickBadgeHelpersPropsFloa & PanelTabModifierProps & (Pick[js.Any, String | Double | js.Symbol])
      ]) = js.native
    @scala.inline
    def defaultProps_=(
