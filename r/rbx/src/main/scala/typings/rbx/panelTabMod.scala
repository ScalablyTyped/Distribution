...
object panelTabMod {
  ...
  object PanelTab {
    ...
    @JSImport("rbx/components/panel/panel-tab", "PanelTab")
    @js.native
    def apply[TAsComponent /* <: ElementType[_] */](
      props: `6`[TAsComponent] with HelpersPropsOverrides with PickBadgeHelpersPropsFloa with PanelTabModifierProps with (Pick[
    ...
    @JSImport("rbx/components/panel/panel-tab", "PanelTab.Group")
    @js.native
    def Group: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]] = js.native
    @scala.inline
    def Group_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Group")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/panel/panel-tab", "PanelTab.defaultProps")
    @js.native
    def defaultProps: AsElementType with (Partial[
        HelpersPropsOverrides with PickBadgeHelpersPropsFloa with PanelTabModifierProps with (Pick[_, String | Double | js.Symbol])
      ]) = js.native
    @scala.inline
    def defaultProps_=(
    ...
    @JSImport("rbx/components/panel/panel-tab", "PanelTab.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    @scala.inline
    def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("rbx/components/panel/panel-tab", "PanelTab.$$typeof")
    @js.native
  ...
  @js.native
  trait PanelTabModifierProps extends StObject {
  ...
  object PanelTabModifierProps {
    ...
    @scala.inline
    implicit class PanelTabModifierPropsMutableBuilder[Self <: PanelTabModifierProps] (val x: Self) extends AnyVal {
  ...
  /* Inlined rbx.rbx/base/helpers.HelpersProps & rbx.rbx/components/panel/panel-tab.PanelTabModifierProps */
  @js.native
  ...
  object PanelTabProps {
    ...
    @scala.inline
    def apply(): PanelTabProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PanelTabProps]
    }
    
    @scala.inline
    implicit class PanelTabPropsMutableBuilder[Self <: PanelTabProps] (val x: Self) extends AnyVal {
