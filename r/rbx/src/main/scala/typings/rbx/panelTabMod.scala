...
object panelTabMod {
  ...
  object PanelTab {
    ...
    inline def Group_=(x: ForwardRefAsExoticComponent[PreferHelpersPropsOverridBackgroundColor, ElementType[js.Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Group")(x.asInstanceOf[js.Any])
  ...
  object PanelTabModifierProps {
    ...
    inline def apply(): PanelTabModifierProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PanelTabModifierProps]
    }
    
    extension [Self <: PanelTabModifierProps](x: Self) {
