...
import typings.reactNative.codegenTypesMod.DirectEventHandler
...
object nativeSafeAreaProviderMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `nativeSafeAreaProviderMod.foo` */
