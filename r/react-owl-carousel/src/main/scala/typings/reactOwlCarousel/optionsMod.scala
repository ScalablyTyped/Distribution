...
object optionsMod {
  ...
  */
  ...
  object OnEvent {
    ...
    inline def changeDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.changeDotowlDotcarousel = "change.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.changeDotowlDotcarousel]
    
    inline def changedDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.changedDotowlDotcarousel = "changed.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.changedDotowlDotcarousel]
    
    inline def dragDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.dragDotowlDotcarousel = "drag.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.dragDotowlDotcarousel]
    
    inline def draggedDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.draggedDotowlDotcarousel = "dragged.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.draggedDotowlDotcarousel]
    
    inline def initializeDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.initializeDotowlDotcarousel = "initialize.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.initializeDotowlDotcarousel]
    
    inline def initializedDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.initializedDotowlDotcarousel = "initialized.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.initializedDotowlDotcarousel]
    
    inline def loadDotowlDotlazy: typings.reactOwlCarousel.reactOwlCarouselStrings.loadDotowlDotlazy = "load.owl.lazy".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.loadDotowlDotlazy]
    
    inline def loadedDotowlDotlazy: typings.reactOwlCarousel.reactOwlCarouselStrings.loadedDotowlDotlazy = "loaded.owl.lazy".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.loadedDotowlDotlazy]
    
    inline def playDotowlDotvideo: typings.reactOwlCarousel.reactOwlCarouselStrings.playDotowlDotvideo = "play.owl.video".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.playDotowlDotvideo]
    
    inline def refreshDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.refreshDotowlDotcarousel = "refresh.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.refreshDotowlDotcarousel]
    
    inline def refreshedDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.refreshedDotowlDotcarousel = "refreshed.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.refreshedDotowlDotcarousel]
    
    inline def resizeDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.resizeDotowlDotcarousel = "resize.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.resizeDotowlDotcarousel]
    
    inline def resizedDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.resizedDotowlDotcarousel = "resized.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.resizedDotowlDotcarousel]
    
    inline def stopDotowlDotvideo: typings.reactOwlCarousel.reactOwlCarouselStrings.stopDotowlDotvideo = "stop.owl.video".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.stopDotowlDotvideo]
    
    inline def translateDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.translateDotowlDotcarousel = "translate.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.translateDotowlDotcarousel]
    
    inline def translatedDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.translatedDotowlDotcarousel = "translated.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.translatedDotowlDotcarousel]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactOwlCarousel.reactOwlCarouselStrings.refreshDotowlDotcarousel
    - typings.reactOwlCarousel.reactOwlCarouselStrings.nextDotowlDotcarousel
    - typings.reactOwlCarousel.reactOwlCarouselStrings.prevDotowlDotcarousel
    - typings.reactOwlCarousel.reactOwlCarouselStrings.toDotowlDotcarousel
    - typings.reactOwlCarousel.reactOwlCarouselStrings.destroyDotowlDotcarousel
    - typings.reactOwlCarousel.reactOwlCarouselStrings.replaceDotowlDotcarousel
    - typings.reactOwlCarousel.reactOwlCarouselStrings.addDotowlDotcarousel
    - typings.reactOwlCarousel.reactOwlCarouselStrings.removeDotowlDotcarousel
    - typings.reactOwlCarousel.reactOwlCarouselStrings.playDotowlDotautoplay
    - typings.reactOwlCarousel.reactOwlCarouselStrings.stopDotowlDotautoplay
  */
  trait TriggerEvent extends StObject
  object TriggerEvent {
    
    inline def addDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.addDotowlDotcarousel = "add.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.addDotowlDotcarousel]
    
    inline def destroyDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.destroyDotowlDotcarousel = "destroy.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.destroyDotowlDotcarousel]
    
    inline def nextDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.nextDotowlDotcarousel = "next.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.nextDotowlDotcarousel]
    
    inline def playDotowlDotautoplay: typings.reactOwlCarousel.reactOwlCarouselStrings.playDotowlDotautoplay = "play.owl.autoplay".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.playDotowlDotautoplay]
    
    inline def prevDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.prevDotowlDotcarousel = "prev.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.prevDotowlDotcarousel]
    
    inline def refreshDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.refreshDotowlDotcarousel = "refresh.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.refreshDotowlDotcarousel]
    
    inline def removeDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.removeDotowlDotcarousel = "remove.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.removeDotowlDotcarousel]
    
    inline def replaceDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.replaceDotowlDotcarousel = "replace.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.replaceDotowlDotcarousel]
    
    inline def stopDotowlDotautoplay: typings.reactOwlCarousel.reactOwlCarouselStrings.stopDotowlDotautoplay = "stop.owl.autoplay".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.stopDotowlDotautoplay]
    
    inline def toDotowlDotcarousel: typings.reactOwlCarousel.reactOwlCarouselStrings.toDotowlDotcarousel = "to.owl.carousel".asInstanceOf[typings.reactOwlCarousel.reactOwlCarouselStrings.toDotowlDotcarousel]
  }
}
