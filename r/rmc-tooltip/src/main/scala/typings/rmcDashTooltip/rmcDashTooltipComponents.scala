...
object rmcDashTooltipComponents extends rmcDashTooltipProps {
  ...
  @scala.inline
  def Tooltip: ComponentType[TooltipProps] = js.constructorOf[typings.rmcDashTooltip.libTooltipMod.default].asInstanceOf[typings.react.reactMod.ComponentType[TooltipProps]]
}
