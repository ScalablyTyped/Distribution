...
import typings.rmcTooltip.anon.Offset
...
object placementsMod {
  ...
  object default {
    ...
    @JSImport("rmc-tooltip/es/placements", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rmc-tooltip/es/placements", "default.bottom")
    @js.native
  ...
  object placements {
    ...
    @JSImport("rmc-tooltip/es/placements", "placements")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rmc-tooltip/es/placements", "placements.bottom")
    @js.native
    def bottom: Offset = js.native
