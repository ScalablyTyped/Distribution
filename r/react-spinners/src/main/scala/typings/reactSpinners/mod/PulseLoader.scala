package typings.reactSpinners.mod
...
@JSImport("react-spinners", "PulseLoader")
@js.native
...
@JSImport("react-spinners", "PulseLoader")
@js.native
object PulseLoader extends TopLevel[ComponentClass[LoaderSizeMarginProps, ComponentState]]
