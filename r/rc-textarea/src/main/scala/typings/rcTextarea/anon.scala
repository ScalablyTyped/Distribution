...
import typings.rcTextarea.esInterfaceMod.ResizableTextAreaRef
import typings.rcTextarea.esInterfaceMod.TextAreaRef
import typings.rcTextarea.rcTextareaStrings.`additions removals`
import typings.rcTextarea.rcTextareaStrings.`additions text`
import typings.rcTextarea.rcTextareaStrings.`inline`
import typings.rcTextarea.rcTextareaStrings.`removals additions`
import typings.rcTextarea.rcTextareaStrings.`removals text`
import typings.rcTextarea.rcTextareaStrings.`text additions`
import typings.rcTextarea.rcTextareaStrings.`text removals`
import typings.rcTextarea.rcTextareaStrings.additions
import typings.rcTextarea.rcTextareaStrings.all
import typings.rcTextarea.rcTextareaStrings.ascending
import typings.rcTextarea.rcTextareaStrings.assertive
import typings.rcTextarea.rcTextareaStrings.both
import typings.rcTextarea.rcTextareaStrings.copy
import typings.rcTextarea.rcTextareaStrings.date
import typings.rcTextarea.rcTextareaStrings.decimal
import typings.rcTextarea.rcTextareaStrings.descending
import typings.rcTextarea.rcTextareaStrings.dialog
import typings.rcTextarea.rcTextareaStrings.email
import typings.rcTextarea.rcTextareaStrings.execute
import typings.rcTextarea.rcTextareaStrings.grammar
import typings.rcTextarea.rcTextareaStrings.grid
import typings.rcTextarea.rcTextareaStrings.horizontal
import typings.rcTextarea.rcTextareaStrings.inherit
import typings.rcTextarea.rcTextareaStrings.link
import typings.rcTextarea.rcTextareaStrings.list
import typings.rcTextarea.rcTextareaStrings.listbox
import typings.rcTextarea.rcTextareaStrings.location
import typings.rcTextarea.rcTextareaStrings.menu
import typings.rcTextarea.rcTextareaStrings.mixed
import typings.rcTextarea.rcTextareaStrings.move
import typings.rcTextarea.rcTextareaStrings.no
import typings.rcTextarea.rcTextareaStrings.none
import typings.rcTextarea.rcTextareaStrings.numeric
import typings.rcTextarea.rcTextareaStrings.off
import typings.rcTextarea.rcTextareaStrings.on
import typings.rcTextarea.rcTextareaStrings.other
import typings.rcTextarea.rcTextareaStrings.page
import typings.rcTextarea.rcTextareaStrings.polite
import typings.rcTextarea.rcTextareaStrings.popup
import typings.rcTextarea.rcTextareaStrings.removals
import typings.rcTextarea.rcTextareaStrings.search
import typings.rcTextarea.rcTextareaStrings.spelling
import typings.rcTextarea.rcTextareaStrings.step
import typings.rcTextarea.rcTextareaStrings.tel
import typings.rcTextarea.rcTextareaStrings.text
import typings.rcTextarea.rcTextareaStrings.time
import typings.rcTextarea.rcTextareaStrings.tree
import typings.rcTextarea.rcTextareaStrings.url
import typings.rcTextarea.rcTextareaStrings.vertical
import typings.rcTextarea.rcTextareaStrings.yes
...
object anon {
  ...
  trait AffixWrapper extends StObject {
    ...
    var countWrapper: js.UndefOr[String] = js.undefined
  }
  object AffixWrapper {
    ...
    implicit open class MutableBuilder[Self <: AffixWrapper] (val x: Self) extends AnyVal {
      ...
      inline def setCountWrapper(value: String): Self = StObject.set(x, "countWrapper", value.asInstanceOf[js.Any])
      
      inline def setCountWrapperUndefined: Self = StObject.set(x, "countWrapper", js.undefined)
    }
  }
  ...
  /* Inlined std.Omit<rc-textarea.rc-textarea/es/interface.HTMLTextareaProps, 'onResize'> & {  prefixCls :string | undefined,   className :string | undefined,   style :react.react.CSSProperties | undefined,   autoSize :boolean | rc-textarea.rc-textarea/es/interface.AutoSizeType | undefined,   onPressEnter :react.react.KeyboardEventHandler<std.HTMLTextAreaElement> | undefined,   onResize :(size : {  width :number,   height :number}): void | undefined,   showCount :boolean | rc-input.rc-input/es/interface.ShowCountProps | undefined,   classes :{  countWrapper :string | undefined,   affixWrapper :string | undefined} | undefined,   classNames :{  textarea :string | undefined,   count :string | undefined} | undefined,   styles :{  textarea :react.react.CSSProperties | undefined,   count :react.react.CSSProperties | undefined} | undefined} & std.Pick<rc-input.rc-input/es/interface.BaseInputProps, 'allowClear' | 'suffix'> & react.react.RefAttributes<rc-textarea.rc-textarea/es/interface.ResizableTextAreaRef> */
  trait OmitHTMLTextareaPropsonRe extends StObject {
    ...
    /**
      ...
      */
    var ref: js.UndefOr[Ref[ResizableTextAreaRef]] = js.undefined
  ...
  object OmitHTMLTextareaPropsonRe {
    
    inline def apply(): OmitHTMLTextareaPropsonRe = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OmitHTMLTextareaPropsonRe]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: OmitHTMLTextareaPropsonRe] (val x: Self) extends AnyVal {
      ...
      inline def setRef(value: Ref[ResizableTextAreaRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      inline def setRefFunction1(value: /* instance */ ResizableTextAreaRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
  ...
  trait OmitHTMLTextareaPropsonReAbout extends StObject {
  ...
  object OmitHTMLTextareaPropsonReAbout {
    
    inline def apply(): OmitHTMLTextareaPropsonReAbout = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OmitHTMLTextareaPropsonReAbout]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: OmitHTMLTextareaPropsonReAbout] (val x: Self) extends AnyVal {
  ...
  trait Textarea extends StObject {
    ...
    var textarea: js.UndefOr[CSSProperties] = js.undefined
  }
  object Textarea {
    ...
    implicit open class MutableBuilder[Self <: Textarea] (val x: Self) extends AnyVal {
      ...
      inline def setTextarea(value: CSSProperties): Self = StObject.set(x, "textarea", value.asInstanceOf[js.Any])
