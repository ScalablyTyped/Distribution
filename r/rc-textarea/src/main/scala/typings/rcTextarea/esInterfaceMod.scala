...
object esInterfaceMod {
  ...
  trait TextAreaRef extends StObject {
    ...
    var resizableTextArea: ResizableTextAreaRef
  }
  object TextAreaRef {
    
    inline def apply(blur: () => Unit, focus: () => Unit, resizableTextArea: ResizableTextAreaRef): TextAreaRef = {
    ...
    implicit open class MutableBuilder[Self <: TextAreaRef] (val x: Self) extends AnyVal {
      ...
      inline def setResizableTextArea(value: ResizableTextAreaRef): Self = StObject.set(x, "resizableTextArea", value.asInstanceOf[js.Any])
    }
  }
}
