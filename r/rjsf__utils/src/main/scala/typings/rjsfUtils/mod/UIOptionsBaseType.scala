...
/** This type represents all the known supported options in the `ui:options` property, kept separate in order to
  ...
  */
/* Inlined std.Partial<std.Omit<@rjsf/utils.@rjsf/utils.TemplatesType<T, S, F>, 'ButtonTemplates'>> & @rjsf/utils.@rjsf/utils.GlobalUISchemaOptions & {  classNames :string | undefined,   style :react.react.StyleHTMLAttributes<any> | undefined,   title :string | undefined,   description :string | undefined,   placeholder :string | undefined,   help :string | undefined,   autofocus :boolean | undefined,   autocomplete :std.HTMLInputElement['autocomplete'] | undefined,   disabled :boolean | undefined,   emptyValue :any | undefined,   enumDisabled :std.Array<string | number | boolean> | undefined,   hideError :boolean | undefined,   readonly :boolean | undefined,   order :std.Array<string> | undefined,   filePreview :boolean | undefined,   inline :boolean | undefined,   inputType :string | undefined,   rows :number | undefined,   submitButtonOptions :@rjsf/utils.@rjsf/utils.UISchemaSubmitButtonOptions | undefined,   widget :@rjsf/utils.@rjsf/utils.Widget<T, S, F> | string | undefined} */
trait UIOptionsBaseType[T, S /* <: StrictRJSFSchema */, F /* <: FormContextType */] extends StObject {
...
object UIOptionsBaseType {
  ...
  inline def apply[T, S /* <: StrictRJSFSchema */, F /* <: FormContextType */](): UIOptionsBaseType[T, S, F] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UIOptionsBaseType[T, S, F]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UIOptionsBaseType[?, ?, ?], T, S /* <: StrictRJSFSchema */, F /* <: FormContextType */] (val x: Self & (UIOptionsBaseType[T, S, F])) extends AnyVal {
