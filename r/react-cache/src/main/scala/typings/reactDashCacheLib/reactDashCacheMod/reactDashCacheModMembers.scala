...
object reactDashCacheModMembers extends js.Object {
  def unstable_createResource[Input, Value](fetch: js.Function1[/* input */ Input, stdLib.PromiseLike[Value]]): Resource[Input, Value] = js.native
  def unstable_createResource[Input, Value](
    fetch: js.Function1[/* input */ Input, stdLib.PromiseLike[Value]],
