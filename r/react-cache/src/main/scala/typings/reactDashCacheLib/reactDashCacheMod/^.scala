...
object ^ extends js.Object {
  def unstable_createResource[Input, Value](fetch: js.Function1[/* input */ Input, js.Thenable[Value]]): reactDashCacheLib.reactDashCacheMod.Resource[Input, Value] = js.native
  ...
  ): reactDashCacheLib.reactDashCacheMod.Resource[Input, Value] = js.native
}
