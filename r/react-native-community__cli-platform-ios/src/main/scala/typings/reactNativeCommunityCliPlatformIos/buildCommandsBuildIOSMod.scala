...
object buildCommandsBuildIOSMod {
  
  object default {
    
    @JSImport("@react-native-community/cli-platform-ios/build/commands/buildIOS", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@react-native-community/cli-platform-ios/build/commands/buildIOS", "default.description")
    @js.native
    def description: String = js.native
    inline def description_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("description")(x.asInstanceOf[js.Any])
    
    @JSImport("@react-native-community/cli-platform-ios/build/commands/buildIOS", "default.examples")
    @js.native
    ...
    @JSImport("@react-native-community/cli-platform-ios/build/commands/buildIOS", "default.func")
    @js.native
    def func: js.Function3[
        /* _ */ js.Array[String], 
        /* ctx */ Config, 
        /* args */ FlagsT, 
        js.Promise[String | Unit]
      ] = js.native
    inline def func(_underscore: js.Array[String], ctx: Config, args: FlagsT): js.Promise[String | Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("func")(_underscore.asInstanceOf[js.Any], ctx.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[js.Promise[String | Unit]]
    inline def func_=(
      x: js.Function3[
          /* _ */ js.Array[String], 
          /* ctx */ Config, 
    ...
    @JSImport("@react-native-community/cli-platform-ios/build/commands/buildIOS", "default.name")
    @js.native
    def name: String = js.native
    inline def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
    
    @JSImport("@react-native-community/cli-platform-ios/build/commands/buildIOS", "default.options")
    @js.native
  ...
  @JSImport("@react-native-community/cli-platform-ios/build/commands/buildIOS", "iosBuildOptions")
  @js.native
  val iosBuildOptions: js.Array[Default | Description | Name | Parse] = js.native
  ...
  object FlagsT {
    ...
    inline def apply(mode: String, packager: Boolean, port: Double, verbose: Boolean): FlagsT = {
