...
object xgroupDELCONSUMERMod {
  
  @JSImport("@redis/client/dist/lib/commands/XGROUP_DELCONSUMER", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/XGROUP_DELCONSUMER", "FIRST_KEY_INDEX")
  @js.native
