...
object roleMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.redisClient.roleMod.RoleMasterReply
    - typings.redisClient.roleMod.RoleReplicaReply
    - typings.redisClient.roleMod.RoleSentinelReply
  */
  trait RoleReply extends StObject
  object RoleReply {
    
    inline def RoleMasterReply(replicas: js.Array[Ip], replicationOffest: Double): typings.redisClient.roleMod.RoleMasterReply = {
      val __obj = js.Dynamic.literal(replicas = replicas.asInstanceOf[js.Any], replicationOffest = replicationOffest.asInstanceOf[js.Any], role = "master")
      __obj.asInstanceOf[typings.redisClient.roleMod.RoleMasterReply]
    }
    
    inline def RoleReplicaReply(dataReceived: Double, master: Port, state: RoleReplicaState): typings.redisClient.roleMod.RoleReplicaReply = {
      val __obj = js.Dynamic.literal(dataReceived = dataReceived.asInstanceOf[js.Any], master = master.asInstanceOf[js.Any], role = "slave", state = state.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.redisClient.roleMod.RoleReplicaReply]
    }
    
    inline def RoleSentinelReply(masterNames: js.Array[String]): typings.redisClient.roleMod.RoleSentinelReply = {
      val __obj = js.Dynamic.literal(masterNames = masterNames.asInstanceOf[js.Any], role = "sentinel")
      __obj.asInstanceOf[typings.redisClient.roleMod.RoleSentinelReply]
    }
  }
