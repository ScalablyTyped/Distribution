...
object sdiffMod {
  ...
  @JSImport("@redis/client/dist/lib/commands/SDIFF", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/SDIFF", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 1 */ Double = js.native
  
  @JSImport("@redis/client/dist/lib/commands/SDIFF", "IS_READ_ONLY")
  @js.native
