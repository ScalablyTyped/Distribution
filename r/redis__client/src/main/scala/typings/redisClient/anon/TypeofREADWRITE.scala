...
trait TypeofREADWRITE extends StObject {
  
  def transformArguments(): js.Array[String]
  
  def transformReply(): String
}
object TypeofREADWRITE {
  
  inline def apply(transformArguments: () => js.Array[String], transformReply: () => String): TypeofREADWRITE = {
    ...
    __obj.asInstanceOf[TypeofREADWRITE]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofREADWRITE] (val x: Self) extends AnyVal {
