...
trait TypeofPEXPIRETIME extends StObject {
...
object TypeofPEXPIRETIME {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofPEXPIRETIME]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofPEXPIRETIME] (val x: Self) extends AnyVal {
