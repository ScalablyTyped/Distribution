...
trait TypeofZPOPMINCOUNT extends StObject {
...
object TypeofZPOPMINCOUNT {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofZPOPMINCOUNT]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofZPOPMINCOUNT] (val x: Self) extends AnyVal {
