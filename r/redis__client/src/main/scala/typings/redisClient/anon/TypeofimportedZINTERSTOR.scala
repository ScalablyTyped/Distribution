...
import typings.redisClient.distLibCommandsZinterstoreMod.ZInterStoreOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@js.native
trait TypeofimportedZINTERSTOR extends StObject {
  ...
  def transformArguments(destination: RedisCommandArgument, keys: RedisCommandArgument, options: ZInterStoreOptions): RedisCommandArguments = js.native
