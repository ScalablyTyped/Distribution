...
trait TypeofimportedGET extends StObject {
...
object TypeofimportedGET {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedGET]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedGET] (val x: Self) extends AnyVal {
