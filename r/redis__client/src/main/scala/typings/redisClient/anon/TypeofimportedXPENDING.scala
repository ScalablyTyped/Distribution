...
import typings.redisClient.xpendingMod.XPendingRawReply
import typings.redisClient.xpendingMod.XPendingReply
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TypeofimportedXPENDING extends StObject {
...
object TypeofimportedXPENDING {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedXPENDING]
  }
  
  extension [Self <: TypeofimportedXPENDING](x: Self) {
