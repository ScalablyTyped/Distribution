...
trait TypeofimportedHRANDFIELDFIRSTKEYINDEX extends StObject {
...
object TypeofimportedHRANDFIELDFIRSTKEYINDEX {
  ...
  inline def apply(
  ...
  ): TypeofimportedHRANDFIELDFIRSTKEYINDEX = {
    ...
    __obj.asInstanceOf[TypeofimportedHRANDFIELDFIRSTKEYINDEX]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedHRANDFIELDFIRSTKEYINDEX] (val x: Self) extends AnyVal {
