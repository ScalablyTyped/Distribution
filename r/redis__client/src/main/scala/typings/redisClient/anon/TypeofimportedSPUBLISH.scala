...
trait TypeofimportedSPUBLISH extends StObject {
...
object TypeofimportedSPUBLISH {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedSPUBLISH]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedSPUBLISH] (val x: Self) extends AnyVal {
