...
trait TypeofimportedLCSLEN extends StObject {
...
object TypeofimportedLCSLEN {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedLCSLEN]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedLCSLEN] (val x: Self) extends AnyVal {
