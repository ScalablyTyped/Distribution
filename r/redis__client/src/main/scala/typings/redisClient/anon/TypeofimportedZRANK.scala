...
trait TypeofimportedZRANK extends StObject {
...
object TypeofimportedZRANK {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedZRANK]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedZRANK] (val x: Self) extends AnyVal {
