...
trait TypeofimportedLCSIDXWI extends StObject {
...
object TypeofimportedLCSIDXWI {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedLCSIDXWI]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedLCSIDXWI] (val x: Self) extends AnyVal {
