...
trait TypeofimportedLREM extends StObject {
...
object TypeofimportedLREM {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedLREM]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedLREM] (val x: Self) extends AnyVal {
