...
import typings.redisClient.distLibCommandsLcsIDXMod.RawReply
import typings.redisClient.distLibCommandsLcsIDXMod.Reply
...
trait TypeofLCSIDX extends StObject {
