...
trait TypeofimportedZRANDMEMBEFIRSTKEYINDEX extends StObject {
...
object TypeofimportedZRANDMEMBEFIRSTKEYINDEX {
  ...
  inline def apply(
  ...
  ): TypeofimportedZRANDMEMBEFIRSTKEYINDEX = {
    ...
    __obj.asInstanceOf[TypeofimportedZRANDMEMBEFIRSTKEYINDEX]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedZRANDMEMBEFIRSTKEYINDEX] (val x: Self) extends AnyVal {
