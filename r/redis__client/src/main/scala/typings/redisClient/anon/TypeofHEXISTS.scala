...
trait TypeofHEXISTS extends StObject {
...
object TypeofHEXISTS {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofHEXISTS]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofHEXISTS] (val x: Self) extends AnyVal {
