...
trait TypeofimportedINCRBYFLOA extends StObject {
...
object TypeofimportedINCRBYFLOA {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedINCRBYFLOA]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedINCRBYFLOA] (val x: Self) extends AnyVal {
