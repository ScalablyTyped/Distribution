...
trait TypeofimportedHSTRLEN extends StObject {
...
object TypeofimportedHSTRLEN {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedHSTRLEN]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedHSTRLEN] (val x: Self) extends AnyVal {
