...
trait TypeofRENAMENX extends StObject {
...
object TypeofRENAMENX {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofRENAMENX]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofRENAMENX] (val x: Self) extends AnyVal {
