...
import typings.redisClient.distLibCommandsXinfoSTREAMMod.XInfoStreamReply
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TypeofimportedXINFOSTRE extends StObject {
...
object TypeofimportedXINFOSTRE {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedXINFOSTRE]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedXINFOSTRE] (val x: Self) extends AnyVal {
