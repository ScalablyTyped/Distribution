...
trait TypeofimportedPTTL extends StObject {
...
object TypeofimportedPTTL {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedPTTL]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedPTTL] (val x: Self) extends AnyVal {
