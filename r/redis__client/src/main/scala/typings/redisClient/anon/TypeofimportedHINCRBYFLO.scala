...
trait TypeofimportedHINCRBYFLO extends StObject {
...
object TypeofimportedHINCRBYFLO {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedHINCRBYFLO]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedHINCRBYFLO] (val x: Self) extends AnyVal {
