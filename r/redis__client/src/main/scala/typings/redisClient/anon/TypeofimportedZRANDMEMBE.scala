...
trait TypeofimportedZRANDMEMBE extends StObject {
...
object TypeofimportedZRANDMEMBE {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedZRANDMEMBE]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedZRANDMEMBE] (val x: Self) extends AnyVal {
