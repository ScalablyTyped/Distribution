...
trait TypeofCONFIGREWRITE extends StObject {
  
  def transformArguments(): js.Array[String]
  
  def transformReply(): String
}
object TypeofCONFIGREWRITE {
  
  inline def apply(transformArguments: () => js.Array[String], transformReply: () => String): TypeofCONFIGREWRITE = {
    ...
    __obj.asInstanceOf[TypeofCONFIGREWRITE]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofCONFIGREWRITE] (val x: Self) extends AnyVal {
