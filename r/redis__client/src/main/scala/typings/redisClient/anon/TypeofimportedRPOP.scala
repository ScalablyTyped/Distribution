...
trait TypeofimportedRPOP extends StObject {
...
object TypeofimportedRPOP {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedRPOP]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedRPOP] (val x: Self) extends AnyVal {
