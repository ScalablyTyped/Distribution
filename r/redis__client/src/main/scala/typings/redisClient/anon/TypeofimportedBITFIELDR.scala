...
import typings.redisClient.distLibCommandsBitfieldROMod.BitFieldRoOperations
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TypeofimportedBITFIELDR extends StObject {
...
object TypeofimportedBITFIELDR {
  
  inline def apply(
    FIRST_KEY_INDEX: /* 1 */ Double,
    IS_READ_ONLY: /* true */ Boolean,
    transformArguments: (String, BitFieldRoOperations) => js.Array[String],
    transformReply: () => js.Array[Double | Null]
  ): TypeofimportedBITFIELDR = {
  ...
  extension [Self <: TypeofimportedBITFIELDR](x: Self) {
    ...
    inline def setTransformReply(value: () => js.Array[Double | Null]): Self = StObject.set(x, "transformReply", js.Any.fromFunction0(value))
  }
}
