...
trait TypeofimportedSTRLEN extends StObject {
...
object TypeofimportedSTRLEN {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedSTRLEN]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedSTRLEN] (val x: Self) extends AnyVal {
