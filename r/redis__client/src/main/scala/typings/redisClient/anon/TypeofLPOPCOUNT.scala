...
trait TypeofLPOPCOUNT extends StObject {
...
object TypeofLPOPCOUNT {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofLPOPCOUNT]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofLPOPCOUNT] (val x: Self) extends AnyVal {
