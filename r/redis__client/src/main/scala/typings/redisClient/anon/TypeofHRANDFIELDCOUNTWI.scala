...
trait TypeofHRANDFIELDCOUNTWI extends StObject {
...
object TypeofHRANDFIELDCOUNTWI {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofHRANDFIELDCOUNTWI]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofHRANDFIELDCOUNTWI] (val x: Self) extends AnyVal {
