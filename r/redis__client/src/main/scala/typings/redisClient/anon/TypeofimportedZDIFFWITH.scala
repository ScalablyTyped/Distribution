...
trait TypeofimportedZDIFFWITH extends StObject {
  ...
  def transformArguments(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<typeof transformZDiffArguments> is not an array type */ args: Parameters[
      /* import warning: importer.ImportType#apply Failed type conversion: typeof transformZDiffArguments */ js.Any
    ]
  ): RedisCommandArguments
  
  def transformReply(reply: js.Array[RedisCommandArgument]): js.Array[ZMember]
}
object TypeofimportedZDIFFWITH {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedZDIFFWITH]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedZDIFFWITH] (val x: Self) extends AnyVal {
