...
trait TypeofimportedTTL extends StObject {
...
object TypeofimportedTTL {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedTTL]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedTTL] (val x: Self) extends AnyVal {
