...
trait TypeofSPUBLISH extends StObject {
...
object TypeofSPUBLISH {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofSPUBLISH]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofSPUBLISH] (val x: Self) extends AnyVal {
