...
trait TypeofOBJECTREFCOUNT extends StObject {
...
object TypeofOBJECTREFCOUNT {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofOBJECTREFCOUNT]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofOBJECTREFCOUNT] (val x: Self) extends AnyVal {
