...
trait TypeofimportedHVALS extends StObject {
...
object TypeofimportedHVALS {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedHVALS]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedHVALS] (val x: Self) extends AnyVal {
