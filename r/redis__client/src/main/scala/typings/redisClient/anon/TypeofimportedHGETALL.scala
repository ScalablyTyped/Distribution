...
trait TypeofimportedHGETALL extends StObject {
...
object TypeofimportedHGETALL {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedHGETALL]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedHGETALL] (val x: Self) extends AnyVal {
