...
import typings.redisClient.distLibCommandsXinfoCONSUMERSMod.XInfoConsumersReply
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TypeofimportedXINFOCONS extends StObject {
...
object TypeofimportedXINFOCONS {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedXINFOCONS]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedXINFOCONS] (val x: Self) extends AnyVal {
