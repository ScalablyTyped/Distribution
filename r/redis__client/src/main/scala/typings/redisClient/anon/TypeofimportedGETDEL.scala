...
trait TypeofimportedGETDEL extends StObject {
...
object TypeofimportedGETDEL {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedGETDEL]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedGETDEL] (val x: Self) extends AnyVal {
