...
object TypeofLATENCYDOCTOR {
  ...
  inline def apply(transformArguments: () => js.Array[String], transformReply: () => String): TypeofLATENCYDOCTOR = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofLATENCYDOCTOR] (val x: Self) extends AnyVal {
