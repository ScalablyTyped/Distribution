...
trait TypeofimportedLRANGE extends StObject {
...
object TypeofimportedLRANGE {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofimportedLRANGE]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofimportedLRANGE] (val x: Self) extends AnyVal {
