...
trait TypeofHRANDFIELDCOUNT extends StObject {
...
object TypeofHRANDFIELDCOUNT {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofHRANDFIELDCOUNT]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofHRANDFIELDCOUNT] (val x: Self) extends AnyVal {
