...
object TypeofREADONLY {
  ...
  inline def apply(transformArguments: () => js.Array[String], transformReply: () => String): TypeofREADONLY = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofREADONLY] (val x: Self) extends AnyVal {
