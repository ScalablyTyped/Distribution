...
object distLibCommandsScardMod {
  
  @JSImport("@redis/client/dist/lib/commands/SCARD", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/SCARD", "FIRST_KEY_INDEX")
  @js.native
