...
object distLibCommandsGetdelMod {
  
  @JSImport("@redis/client/dist/lib/commands/GETDEL", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/GETDEL", "FIRST_KEY_INDEX")
  @js.native
