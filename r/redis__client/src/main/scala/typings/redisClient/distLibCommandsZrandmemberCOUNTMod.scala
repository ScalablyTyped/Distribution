...
object distLibCommandsZrandmemberCOUNTMod {
  
  @JSImport("@redis/client/dist/lib/commands/ZRANDMEMBER_COUNT", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/ZRANDMEMBER_COUNT", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 1 */ Double = js.native
  
  @JSImport("@redis/client/dist/lib/commands/ZRANDMEMBER_COUNT", "IS_READ_ONLY")
  @js.native
