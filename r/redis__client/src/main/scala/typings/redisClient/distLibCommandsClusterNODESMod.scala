...
object distLibCommandsClusterNODESMod {
  ...
  object RedisClusterNodeLinkStates extends StObject {
    ...
    /* "connected" */ val CONNECTED: typings.redisClient.distLibCommandsClusterNODESMod.RedisClusterNodeLinkStates.CONNECTED & String = js.native
    
    @js.native
    sealed trait DISCONNECTED
      extends StObject
         with RedisClusterNodeLinkStates
    /* "disconnected" */ val DISCONNECTED: typings.redisClient.distLibCommandsClusterNODESMod.RedisClusterNodeLinkStates.DISCONNECTED & String = js.native
  }
