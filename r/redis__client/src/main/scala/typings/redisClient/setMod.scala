...
object setMod {
  ...
  type MaximumOneOf[T, K /* <: /* keyof T */ String */] = typings.redisClient.redisClientStrings.MaximumOneOf & TopLevel[T] & (Partial[Record[Exclude[/* keyof T */ String, K], scala.Nothing]])
