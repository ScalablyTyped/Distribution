...
object distLibCommandsIncrMod {
  
  @JSImport("@redis/client/dist/lib/commands/INCR", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/INCR", "FIRST_KEY_INDEX")
  @js.native
