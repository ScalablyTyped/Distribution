...
object typeMod {
  ...
  @JSImport("@redis/client/dist/lib/commands/TYPE", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/TYPE", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 1 */ Double = js.native
  
  @JSImport("@redis/client/dist/lib/commands/TYPE", "IS_READ_ONLY")
  @js.native
