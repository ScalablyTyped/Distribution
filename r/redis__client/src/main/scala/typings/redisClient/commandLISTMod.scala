...
object commandLISTMod {
  ...
  object FilterBy extends StObject {
    ...
    sealed trait ACLCAT
      extends StObject
         with FilterBy
    /* "ACLCAT" */ val ACLCAT: typings.redisClient.commandLISTMod.FilterBy.ACLCAT & String = js.native
    
    @js.native
    sealed trait MODULE
      extends StObject
         with FilterBy
    /* "MODULE" */ val MODULE: typings.redisClient.commandLISTMod.FilterBy.MODULE & String = js.native
    
    @js.native
    sealed trait PATTERN
      extends StObject
         with FilterBy
    /* "PATTERN" */ val PATTERN: typings.redisClient.commandLISTMod.FilterBy.PATTERN & String = js.native
  }
