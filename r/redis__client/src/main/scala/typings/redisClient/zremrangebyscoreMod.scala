...
object zremrangebyscoreMod {
  
  @JSImport("@redis/client/dist/lib/commands/ZREMRANGEBYSCORE", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/ZREMRANGEBYSCORE", "FIRST_KEY_INDEX")
  @js.native
