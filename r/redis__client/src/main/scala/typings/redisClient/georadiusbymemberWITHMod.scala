...
object georadiusbymemberWITHMod {
  
  @JSImport("@redis/client/dist/lib/commands/GEORADIUSBYMEMBER_WITH", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/GEORADIUSBYMEMBER_WITH", "FIRST_KEY_INDEX")
  @js.native
  val FIRST_KEY_INDEX: /* 1 */ Double = js.native
  
  @JSImport("@redis/client/dist/lib/commands/GEORADIUSBYMEMBER_WITH", "IS_READ_ONLY")
  @js.native
