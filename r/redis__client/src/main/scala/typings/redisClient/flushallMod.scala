...
object flushallMod {
  ...
  object RedisFlushModes extends StObject {
    ...
    /* "ASYNC" */ val ASYNC: typings.redisClient.flushallMod.RedisFlushModes.ASYNC & String = js.native
    
    @js.native
    sealed trait SYNC
      extends StObject
         with RedisFlushModes
    /* "SYNC" */ val SYNC: typings.redisClient.flushallMod.RedisFlushModes.SYNC & String = js.native
  }
