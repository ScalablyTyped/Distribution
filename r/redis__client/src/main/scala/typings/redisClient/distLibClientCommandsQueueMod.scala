...
object distLibClientCommandsQueueMod {
  ...
  object PubSubSubscribeCommands extends StObject {
    ...
    /* "PSUBSCRIBE" */ val PSUBSCRIBE: typings.redisClient.distLibClientCommandsQueueMod.PubSubSubscribeCommands.PSUBSCRIBE & String = js.native
    
    @js.native
    sealed trait SUBSCRIBE
      extends StObject
         with PubSubSubscribeCommands
    /* "SUBSCRIBE" */ val SUBSCRIBE: typings.redisClient.distLibClientCommandsQueueMod.PubSubSubscribeCommands.SUBSCRIBE & String = js.native
  }
  ...
  object PubSubUnsubscribeCommands extends StObject {
    ...
    /* "PUNSUBSCRIBE" */ val PUNSUBSCRIBE: typings.redisClient.distLibClientCommandsQueueMod.PubSubUnsubscribeCommands.PUNSUBSCRIBE & String = js.native
    
    @js.native
    sealed trait UNSUBSCRIBE
      extends StObject
         with PubSubUnsubscribeCommands
    /* "UNSUBSCRIBE" */ val UNSUBSCRIBE: typings.redisClient.distLibClientCommandsQueueMod.PubSubUnsubscribeCommands.UNSUBSCRIBE & String = js.native
  }
  ...
  trait RedisCommandsQueue extends StObject {
    ...
    def subscribe_true[T /* <: Boolean */](
      ...
      listener: PubSubListener[
          T, 
          /* import warning: importer.ImportType#apply Failed type conversion: T extends true ? node.buffer.<global>.Buffer : string */ js.Any
        ]
