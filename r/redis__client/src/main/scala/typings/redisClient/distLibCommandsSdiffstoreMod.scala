...
object distLibCommandsSdiffstoreMod {
  
  @JSImport("@redis/client/dist/lib/commands/SDIFFSTORE", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/SDIFFSTORE", "FIRST_KEY_INDEX")
  @js.native
