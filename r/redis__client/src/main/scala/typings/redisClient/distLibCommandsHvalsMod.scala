...
object distLibCommandsHvalsMod {
  
  @JSImport("@redis/client/dist/lib/commands/HVALS", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/HVALS", "FIRST_KEY_INDEX")
  @js.native
