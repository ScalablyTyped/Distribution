...
object clusterFAILOVERMod {
  ...
  object FailoverModes extends StObject {
    ...
    sealed trait FORCE
      extends StObject
         with FailoverModes
    /* "FORCE" */ val FORCE: typings.redisClient.clusterFAILOVERMod.FailoverModes.FORCE & String = js.native
    
    @js.native
    sealed trait TAKEOVER
      extends StObject
         with FailoverModes
    /* "TAKEOVER" */ val TAKEOVER: typings.redisClient.clusterFAILOVERMod.FailoverModes.TAKEOVER & String = js.native
  }
