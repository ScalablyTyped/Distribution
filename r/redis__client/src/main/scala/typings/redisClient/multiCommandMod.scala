...
import typings.redisClient.libMultiCommandMod.RedisMultiQueuedCommand
...
object multiCommandMod {
  ...
  type WithFunctions[M /* <: RedisModules */, F /* <: RedisFunctions */, S /* <: RedisScripts */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof F as @redis/client.@redis/client/dist/lib/commands.ExcludeMappedString<P> ]: {[ FF in keyof F[P] as @redis/client.@redis/client/dist/lib/commands.ExcludeMappedString<FF> ]: @redis/client.@redis/client/dist/lib/client/multi-command.CommandSignature<F[P][FF], M, F, S>}}
    */ typings.redisClient.redisClientStrings.WithFunctions & TopLevel[F]
  
  type WithModules[M /* <: RedisModules */, F /* <: RedisFunctions */, S /* <: RedisScripts */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof M as @redis/client.@redis/client/dist/lib/commands.ExcludeMappedString<P> ]: {[ C in keyof M[P] as @redis/client.@redis/client/dist/lib/commands.ExcludeMappedString<C> ]: @redis/client.@redis/client/dist/lib/client/multi-command.CommandSignature<M[P][C], M, F, S>}}
    */ typings.redisClient.redisClientStrings.WithModules & TopLevel[M]
  
  type WithScripts[M /* <: RedisModules */, F /* <: RedisFunctions */, S /* <: RedisScripts */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof S as @redis/client.@redis/client/dist/lib/commands.ExcludeMappedString<P> ]: @redis/client.@redis/client/dist/lib/client/multi-command.CommandSignature<S[P], M, F, S>}
    */ typings.redisClient.redisClientStrings.WithScripts & TopLevel[S]
}
