...
object distLibCommandsDecrMod {
  
  @JSImport("@redis/client/dist/lib/commands/DECR", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/DECR", "FIRST_KEY_INDEX")
  @js.native
