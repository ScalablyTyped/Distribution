...
object distLibCommandsHlenMod {
  
  @JSImport("@redis/client/dist/lib/commands/HLEN", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@redis/client/dist/lib/commands/HLEN", "FIRST_KEY_INDEX")
  @js.native
