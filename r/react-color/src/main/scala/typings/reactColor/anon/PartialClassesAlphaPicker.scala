...
object PartialClassesAlphaPicker {
  ...
  @scala.inline
  implicit class PartialClassesAlphaPickerOps[Self <: PartialClassesAlphaPicker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefault(value: PartialAlphaPickerStylesP): Self = this.set("default", value.asInstanceOf[js.Any])
