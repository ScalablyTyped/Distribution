...
object MaterialPickerProps {
  ...
  @scala.inline
  implicit class MaterialPickerPropsOps[Self <: MaterialPickerProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStyles(value: PartialClassesMaterialPic): Self = this.set("styles", value.asInstanceOf[js.Any])
    @scala.inline
