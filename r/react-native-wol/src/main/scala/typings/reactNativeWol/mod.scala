...
object mod {
  ...
  object default {
    ...
    @scala.inline
    def send(ipAddress: String, macAddress: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("send")(ipAddress.asInstanceOf[js.Any], macAddress.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def send(
      ipAddress: String,
      macAddress: String,
