...
object FileDropItem {
  ...
  inline def apply(getFile: () => js.Promise[File], getText: () => js.Promise[String], name: String, `type`: String): FileDropItem = {
    ...
    __obj.asInstanceOf[FileDropItem]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FileDropItem] (val x: Self) extends AnyVal {
