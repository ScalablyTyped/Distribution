...
object previewMod extends Shortcut {
  ...
  object PreviewProps {
    ...
    extension [Self <: PreviewProps](x: Self) {
      ...
      inline def setAfterClose(value: () => js.Any): Self = StObject.set(x, "afterClose", js.Any.fromFunction0(value))
      ...
      inline def setOnClose(value: /* e */ SyntheticEvent[HTMLDivElement | HTMLLIElement, Event] => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
      ...
      inline def setWrapStyle(value: js.Object): Self = StObject.set(x, "wrapStyle", value.asInstanceOf[js.Any])
