...
object mod {
  ...
  @js.native
  trait AnnotationProps extends SVGProps[SVGGElement] {
  ...
  object GeographiesChildrenArgument {
    ...
    implicit class GeographiesChildrenArgumentMutableBuilder[Self <: GeographiesChildrenArgument] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGeographies(value: js.Array[_]): Self = StObject.set(x, "geographies", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGeographiesVarargs(value: js.Any*): Self = StObject.set(x, "geographies", js.Array(value :_*))
      
      @scala.inline
      def setPath(value: GeoPath_[_, GeoPermissibleObjects]): Self = StObject.set(x, "path", value.asInstanceOf[js.Any])
  ...
  object GeographiesProps {
    ...
    implicit class GeographiesPropsMutableBuilder[Self <: GeographiesProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGeography(value: String | (Record[String, _]) | js.Array[String]): Self = StObject.set(x, "geography", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setParseGeographies(value: /* features */ js.Array[Feature[_, _]] => js.Array[Feature[_, _]]): Self = StObject.set(x, "parseGeographies", js.Any.fromFunction1(value))
  ...
  trait GeographyProps extends StObject {
    ...
    var onBlur: js.UndefOr[js.Function1[/* event */ FocusEvent[SVGPathElement], Unit]] = js.native
    ...
    var onFocus: js.UndefOr[js.Function1[/* event */ FocusEvent[SVGPathElement], Unit]] = js.native
  ...
  @js.native
  trait GraticuleProps extends SVGProps[SVGPathElement] {
  ...
  @js.native
  trait SphereProps extends SVGProps[SVGPathElement] {
