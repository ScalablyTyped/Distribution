...
object GeographyProps {
  ...
  @scala.inline
  implicit class GeographyPropsOps[Self <: GeographyProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setGeography(value: js.Any): Self = this.set("geography", value.asInstanceOf[js.Any])
    @scala.inline
