...
object LineProps {
  ...
  implicit class LinePropsOps[Self <: LineProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCoordinatesVarargs(value: Point*): Self = this.set("coordinates", js.Array(value :_*))
    @scala.inline
    def setCoordinates(value: js.Array[Point]): Self = this.set("coordinates", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFrom(value: Point): Self = this.set("from", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTo(value: Point): Self = this.set("to", value.asInstanceOf[js.Any])
    @scala.inline
