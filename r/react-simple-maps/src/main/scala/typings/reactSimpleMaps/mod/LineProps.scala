...
object LineProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onEmptied: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onEncrypted: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onEnded: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onError: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onLoadStart: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onLoadedData: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    ...
    onPause: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onPlay: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onPlaying: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    ...
    onProgress: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onRateChange: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onReset: FormEvent[SVGPathElement] => Unit = null,
    onScroll: UIEvent[SVGPathElement, NativeUIEvent] => Unit = null,
    onSeeked: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onSeeking: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onSelect: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onStalled: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onSubmit: FormEvent[SVGPathElement] => Unit = null,
    onSuspend: SyntheticEvent[SVGPathElement, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[SVGPathElement, Event] => Unit = null,
