package typings.reactDashDndDashMultiDashBackend

import typings.reactDashDndDashMultiDashBackend.reactDashDndDashMultiDashBackendMod.Backends
...
@js.native
object libHTML5toTouchMod extends js.Object {
  /**
