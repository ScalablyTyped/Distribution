...
object rangePickerMod {
  ...
  */
  ...
  object RangePickerProps {
    ...
    inline def RangePickerBaseProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale, picker: Exclude[PickerMode, date | time]): typings.rcPicker.rangePickerMod.RangePickerBaseProps[DateType] = {
      val __obj = js.Dynamic.literal(generateConfig = generateConfig.asInstanceOf[js.Any], locale = locale.asInstanceOf[js.Any], picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.rcPicker.rangePickerMod.RangePickerBaseProps[DateType]]
    }
    
    inline def RangePickerDateProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale): typings.rcPicker.rangePickerMod.RangePickerDateProps[DateType] = {
      val __obj = js.Dynamic.literal(generateConfig = generateConfig.asInstanceOf[js.Any], locale = locale.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.rcPicker.rangePickerMod.RangePickerDateProps[DateType]]
    }
    
    inline def RangePickerTimeProps[DateType](generateConfig: GenerateConfig[DateType], locale: Locale): typings.rcPicker.rangePickerMod.RangePickerTimeProps[DateType] = {
  ...
  object RangeShowTimeObject {
    ...
    extension [Self <: RangeShowTimeObject[?], DateType](x: Self & RangeShowTimeObject[DateType]) {
      ...
      inline def setDefaultValueVarargs(value: DateType*): Self = StObject.set(x, "defaultValue", js.Array(value :_*))
