...
object quarterHeaderMod {
  ...
  @scala.inline
  def default[DateType](props: QuarterHeaderProps[DateType]): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  object QuarterHeaderProps {
    ...
    @scala.inline
    implicit class QuarterHeaderPropsMutableBuilder[Self <: QuarterHeaderProps[?], DateType] (val x: Self & QuarterHeaderProps[DateType]) extends AnyVal {
