...
object rcPickerStrings {
  ...
  inline def disabledTime: disabledTime = "disabledTime".asInstanceOf[disabledTime]
  ...
  inline def hideHeader: hideHeader = "hideHeader".asInstanceOf[hideHeader]
  ...
  @js.native
  sealed trait onPickerValueChange extends StObject
  inline def onPickerValueChange: onPickerValueChange = "onPickerValueChange".asInstanceOf[onPickerValueChange]
  ...
  @js.native
  sealed trait pickerValue extends StObject
  inline def pickerValue: pickerValue = "pickerValue".asInstanceOf[pickerValue]
