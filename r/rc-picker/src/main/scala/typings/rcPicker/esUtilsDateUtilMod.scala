...
object esUtilsDateUtilMod {
  ...
  inline def getQuarter[DateType](generateConfig: typings.rcPicker.esGenerateMod.GenerateConfig[DateType], date: DateType): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getQuarter")(generateConfig.asInstanceOf[js.Any], date.asInstanceOf[js.Any])).asInstanceOf[Double]
