...
object Disabled {
  ...
  def apply[DateType](
    ...
    val __obj = js.Dynamic.literal(disabled = disabled.asInstanceOf[js.Any], generateConfig = generateConfig.asInstanceOf[js.Any], locale = locale.asInstanceOf[js.Any], picker = picker.asInstanceOf[js.Any], selectedValue = selectedValue.asInstanceOf[js.Any])
