...
object anon {
  ...
  object IconBasePropsattrundefine {
    ...
    extension [Self <: IconBasePropsattrundefine](x: Self) {
      ...
      inline def setOnBlur(value: FocusEvent[SVGElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      inline def setOnError(value: SyntheticEvent[SVGElement, Event] => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction1(value))
      
      inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
      
      inline def setOnFocus(value: FocusEvent[SVGElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
      ...
      inline def setOnLoad(value: SyntheticEvent[SVGElement, Event] => Unit): Self = StObject.set(x, "onLoad", js.Any.fromFunction1(value))
