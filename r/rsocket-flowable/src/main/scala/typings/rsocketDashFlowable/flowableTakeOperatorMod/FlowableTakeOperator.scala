package typings.rsocketDashFlowable.flowableTakeOperatorMod
...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ISubscriber<T> * / any */ trait FlowableTakeOperator[T] extends js.Object {
  def onComplete(): Unit
