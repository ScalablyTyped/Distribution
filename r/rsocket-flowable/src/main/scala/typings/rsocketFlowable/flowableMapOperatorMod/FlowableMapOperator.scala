...
- Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ISubscriber<T> * / any */ trait FlowableMapOperator[T, R] extends js.Object {
  def onComplete(): Unit
