...
import typings.rmcDashFeedback.libPropTypesMod.ITouchState
import typings.rmcDashFeedback.libTouchFeedbackMod.TouchFeedback
...
@js.native
object libTouchFeedbackMod extends js.Object {
  @js.native
  trait TouchFeedback
