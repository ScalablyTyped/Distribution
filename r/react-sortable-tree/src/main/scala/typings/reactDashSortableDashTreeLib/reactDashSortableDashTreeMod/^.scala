...
object ^ extends js.Object {
  ...
  def changeNodeAtPath(data: FullTree with TreePath with reactDashSortableDashTreeLib.Anon_DataGetNodeKey): js.Array[TreeItem] = js.native
  ...
  def find(data: FullTree with reactDashSortableDashTreeLib.Anon_DataExpandAllMatchPaths): reactDashSortableDashTreeLib.Anon_Matches with FullTree = js.native
  ...
  def getFlatDataFromTree(data: FullTree with reactDashSortableDashTreeLib.Anon_DataGetNodeKeyIgnoreCollapsed): js.Array[FlatDataItem] = js.native
  def getNodeAtPath(data: FullTree with TreePath with reactDashSortableDashTreeLib.Anon_DataGetNodeKeyIgnoreCollapsed): (TreeNode with TreeIndex) | scala.Null = js.native
  ...
  def getVisibleNodeInfoAtIndex(data: FullTree with reactDashSortableDashTreeLib.Anon_Data): TreeNode with TreePath with (reactDashSortableDashTreeLib.Anon_LowerSiblingsCounts | scala.Null) = js.native
  def insertNode(data: FullTree with reactDashSortableDashTreeLib.Anon_DataDepth): FullTree with TreeIndex with TreePath with reactDashSortableDashTreeLib.Anon_ParentNode = js.native
  ...
  def removeNode(data: FullTree with TreePath with reactDashSortableDashTreeLib.Anon_DataGetNodeKeyIgnoreCollapsed): (FullTree with TreeNode with TreeIndex) | scala.Null = js.native
  def removeNodeAtPath(data: FullTree with TreePath with reactDashSortableDashTreeLib.Anon_DataGetNodeKeyIgnoreCollapsed): js.Array[TreeItem] = js.native
