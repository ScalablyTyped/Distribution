...
object ReactSortableTreeProps {
  @scala.inline
  def apply(
    onChange: js.Function1[js.Array[TreeItem], scala.Unit],
    treeData: js.Array[TreeItem],
    canDrag: (js.Function1[/* data */ ExtendedNodeData, scala.Boolean]) | scala.Boolean = null,
    canDrop: js.Function1[/* data */ OnDragPreviousAndNextLocation with NodeData, scala.Boolean] = null,
    canNodeHaveChildren: js.Function1[/* node */ TreeItem, scala.Boolean] = null,
    className: java.lang.String = null,
    dndType: java.lang.String = null,
    generateNodeProps: js.Function1[/* data */ ExtendedNodeData, org.scalablytyped.runtime.StringDictionary[_]] = null,
    getNodeKey: js.Function1[/* data */ TreeNode with TreeIndex, java.lang.String | scala.Double] = null,
    ...
    onDragStateChanged: js.Function1[/* data */ OnDragStateChangedData, scala.Unit] = null,
    onMoveNode: js.Function1[/* data */ NodeData with FullTree with OnMovePreviousAndNextLocation, scala.Unit] = null,
    onVisibilityToggle: js.Function1[/* data */ OnVisibilityToggleData, scala.Unit] = null,
    ...
    searchFinishCallback: js.Function1[/* matches */ js.Array[NodeData], scala.Unit] = null,
    searchFocusOffset: scala.Int | scala.Double = null,
    searchMethod: js.Function1[/* data */ SearchData, scala.Boolean] = null,
    ...
    val __obj = js.Dynamic.literal(onChange = onChange, treeData = treeData)
    ...
    if (canNodeHaveChildren != null) __obj.updateDynamic("canNodeHaveChildren")(canNodeHaveChildren)
    if (className != null) __obj.updateDynamic("className")(className)
    if (dndType != null) __obj.updateDynamic("dndType")(dndType)
    if (generateNodeProps != null) __obj.updateDynamic("generateNodeProps")(generateNodeProps)
    ...
    if (onDragStateChanged != null) __obj.updateDynamic("onDragStateChanged")(onDragStateChanged)
    if (onMoveNode != null) __obj.updateDynamic("onMoveNode")(onMoveNode)
    ...
    if (searchFinishCallback != null) __obj.updateDynamic("searchFinishCallback")(searchFinishCallback)
    if (searchFocusOffset != null) __obj.updateDynamic("searchFocusOffset")(searchFocusOffset.asInstanceOf[js.Any])
    if (searchMethod != null) __obj.updateDynamic("searchMethod")(searchMethod)
