...
@scala.inline
def addNodeUnderParent(data: typings.reactSortableTree.anon.FullTreenewNodeTreeItempa): typings.reactSortableTree.mod.FullTree & typings.reactSortableTree.mod.TreeIndex = typings.reactSortableTree.mod.^.asInstanceOf[js.Dynamic].applyDynamic("addNodeUnderParent")(data.asInstanceOf[js.Any]).asInstanceOf[typings.reactSortableTree.mod.FullTree & typings.reactSortableTree.mod.TreeIndex]
...
@scala.inline
def getNodeAtPath(data: typings.reactSortableTree.anon.FullTreeTreePathgetNodeKe): (typings.reactSortableTree.mod.TreeNode & typings.reactSortableTree.mod.TreeIndex) | scala.Null = typings.reactSortableTree.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getNodeAtPath")(data.asInstanceOf[js.Any]).asInstanceOf[(typings.reactSortableTree.mod.TreeNode & typings.reactSortableTree.mod.TreeIndex) | scala.Null]
...
@scala.inline
def removeNode(data: typings.reactSortableTree.anon.FullTreeTreePathgetNodeKe): (typings.reactSortableTree.mod.FullTree & typings.reactSortableTree.mod.TreeNode & typings.reactSortableTree.mod.TreeIndex) | scala.Null = typings.reactSortableTree.mod.^.asInstanceOf[js.Dynamic].applyDynamic("removeNode")(data.asInstanceOf[js.Any]).asInstanceOf[(typings.reactSortableTree.mod.FullTree & typings.reactSortableTree.mod.TreeNode & typings.reactSortableTree.mod.TreeIndex) | scala.Null]
