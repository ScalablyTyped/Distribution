...
object anon {
  ...
  /* Inlined std.Omit<@react-md/link.@react-md/link.SkipToMainContentProps, 'mainId'> */
  trait OmitSkipToMainContentProp extends StObject {
  ...
  object OmitSkipToMainContentProp {
    
    inline def apply(): OmitSkipToMainContentProp = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OmitSkipToMainContentProp]
    }
    
    extension [Self <: OmitSkipToMainContentProp](x: Self) {
  ...
  /* Inlined @react-md/utils.@react-md/utils.PropsWithRef<std.Omit<@react-md/app-bar.@react-md/app-bar.AppBarTitleProps, 'children'>, std.HTMLHeadingElement> */
  trait PropsWithRefOmitAppBarTit extends StObject {
    ...
    /**
      ...
      */
    var ref: js.UndefOr[Ref[HTMLHeadingElement]] = js.undefined
  ...
  object PropsWithRefOmitAppBarTit {
    
    inline def apply(): PropsWithRefOmitAppBarTit = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PropsWithRefOmitAppBarTit]
    }
    
    extension [Self <: PropsWithRefOmitAppBarTit](x: Self) {
      ...
      inline def setRef(value: Ref[HTMLHeadingElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
  ...
  /* Inlined std.Readonly<@react-md/menu.@react-md/menu.MenuConfiguration> */
  trait ReadonlyMenuConfiguration extends StObject {
    
    val horizontal: js.UndefOr[Boolean] = js.undefined
    
    val renderAsSheet: js.UndefOr[RenderMenuAsSheet] = js.undefined
    
    val sheetFooter: js.UndefOr[ReactNode] = js.undefined
    
    val sheetHeader: js.UndefOr[ReactNode] = js.undefined
    
    val sheetPosition: js.UndefOr[SheetPosition] = js.undefined
    
    val sheetVerticalSize: js.UndefOr[SheetVerticalSize] = js.undefined
  }
  object ReadonlyMenuConfiguration {
    
    inline def apply(): ReadonlyMenuConfiguration = {
      val __obj = js.Dynamic.literal()
