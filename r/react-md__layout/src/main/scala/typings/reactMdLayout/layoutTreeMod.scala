...
import typings.reactMdLayout.reactMdLayoutStrings.`additions removals`
import typings.reactMdLayout.reactMdLayoutStrings.`additions text`
import typings.reactMdLayout.reactMdLayoutStrings.`inline`
import typings.reactMdLayout.reactMdLayoutStrings.`removals additions`
import typings.reactMdLayout.reactMdLayoutStrings.`removals text`
import typings.reactMdLayout.reactMdLayoutStrings.`text additions`
import typings.reactMdLayout.reactMdLayoutStrings.`text removals`
import typings.reactMdLayout.reactMdLayoutStrings.additions
import typings.reactMdLayout.reactMdLayoutStrings.all
import typings.reactMdLayout.reactMdLayoutStrings.ascending
import typings.reactMdLayout.reactMdLayoutStrings.assertive
import typings.reactMdLayout.reactMdLayoutStrings.both
import typings.reactMdLayout.reactMdLayoutStrings.copy
import typings.reactMdLayout.reactMdLayoutStrings.date
import typings.reactMdLayout.reactMdLayoutStrings.decimal
import typings.reactMdLayout.reactMdLayoutStrings.descending
import typings.reactMdLayout.reactMdLayoutStrings.dialog
import typings.reactMdLayout.reactMdLayoutStrings.email
import typings.reactMdLayout.reactMdLayoutStrings.execute
import typings.reactMdLayout.reactMdLayoutStrings.grammar
import typings.reactMdLayout.reactMdLayoutStrings.grid
import typings.reactMdLayout.reactMdLayoutStrings.horizontal
import typings.reactMdLayout.reactMdLayoutStrings.inherit
import typings.reactMdLayout.reactMdLayoutStrings.link
import typings.reactMdLayout.reactMdLayoutStrings.list
import typings.reactMdLayout.reactMdLayoutStrings.listbox
import typings.reactMdLayout.reactMdLayoutStrings.location
import typings.reactMdLayout.reactMdLayoutStrings.menu
import typings.reactMdLayout.reactMdLayoutStrings.mixed
import typings.reactMdLayout.reactMdLayoutStrings.move
import typings.reactMdLayout.reactMdLayoutStrings.no
import typings.reactMdLayout.reactMdLayoutStrings.none
import typings.reactMdLayout.reactMdLayoutStrings.numeric
import typings.reactMdLayout.reactMdLayoutStrings.off
import typings.reactMdLayout.reactMdLayoutStrings.on
import typings.reactMdLayout.reactMdLayoutStrings.other
import typings.reactMdLayout.reactMdLayoutStrings.page
import typings.reactMdLayout.reactMdLayoutStrings.polite
import typings.reactMdLayout.reactMdLayoutStrings.popup
import typings.reactMdLayout.reactMdLayoutStrings.removals
import typings.reactMdLayout.reactMdLayoutStrings.search
import typings.reactMdLayout.reactMdLayoutStrings.spelling
import typings.reactMdLayout.reactMdLayoutStrings.step
import typings.reactMdLayout.reactMdLayoutStrings.tel
import typings.reactMdLayout.reactMdLayoutStrings.text
import typings.reactMdLayout.reactMdLayoutStrings.time
import typings.reactMdLayout.reactMdLayoutStrings.tree
import typings.reactMdLayout.reactMdLayoutStrings.url
import typings.reactMdLayout.reactMdLayoutStrings.vertical
import typings.reactMdLayout.reactMdLayoutStrings.yes
...
import typings.reactMdTree.typesMod.ConfigurableTreeItemProps
import typings.reactMdTree.typesMod.ExpandedIds
import typings.reactMdTree.typesMod.GetItemProps
...
object layoutTreeMod {
  
  @JSImport("@react-md/layout/types/LayoutTree", "LayoutTree")
  @js.native
  val LayoutTree: ForwardRefExoticComponent[LayoutTreeProps[LayoutNavigationItem] & RefAttributes[HTMLUListElement]] = js.native
  
  /* Inlined std.Omit<@react-md/tree.@react-md/tree.TreeProps<T>, 'id' | 'data' | 'aria-label' | 'aria-labelledby'> */
  trait BaseLayoutTreeProps[T /* <: BaseTreeItem */] extends StObject {
  ...
  object BaseLayoutTreeProps {
    ...
    def apply[T /* <: BaseTreeItem */](
      ...
      val __obj = js.Dynamic.literal(expandedIds = expandedIds.asInstanceOf[js.Any], onItemExpansion = js.Any.fromFunction2(onItemExpansion), onItemSelect = js.Any.fromFunction1(onItemSelect), onMultiItemExpansion = js.Any.fromFunction1(onMultiItemExpansion), onMultiItemSelect = js.Any.fromFunction1(onMultiItemSelect), selectedIds = selectedIds.asInstanceOf[js.Any])
      __obj.asInstanceOf[BaseLayoutTreeProps[T]]
    }
    
    @scala.inline
    implicit class BaseLayoutTreePropsMutableBuilder[Self <: BaseLayoutTreeProps[?], T /* <: BaseTreeItem */] (val x: Self & BaseLayoutTreeProps[T]) extends AnyVal {
  ...
  trait LayoutTreeProps[T /* <: BaseTreeItem */]
    extends StObject
       with BaseLayoutTreeProps[T] {
    ...
    /**
      ...
      */
    var disableTemporaryAutoclose: js.UndefOr[Boolean] = js.undefined
  ...
  object LayoutTreeProps {
    ...
    def apply[T /* <: BaseTreeItem */](
      ...
      val __obj = js.Dynamic.literal(expandedIds = expandedIds.asInstanceOf[js.Any], navItems = navItems.asInstanceOf[js.Any], onItemExpansion = js.Any.fromFunction2(onItemExpansion), onItemSelect = js.Any.fromFunction1(onItemSelect), onMultiItemExpansion = js.Any.fromFunction1(onMultiItemExpansion), onMultiItemSelect = js.Any.fromFunction1(onMultiItemSelect), selectedIds = selectedIds.asInstanceOf[js.Any])
      __obj.asInstanceOf[LayoutTreeProps[T]]
    }
    
    @scala.inline
    implicit class LayoutTreePropsMutableBuilder[Self <: LayoutTreeProps[?], T /* <: BaseTreeItem */] (val x: Self & LayoutTreeProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setDisableTemporaryAutoclose(value: Boolean): Self = StObject.set(x, "disableTemporaryAutoclose", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisableTemporaryAutocloseUndefined: Self = StObject.set(x, "disableTemporaryAutoclose", js.undefined)
      ...
      @scala.inline
      def setNavClassName(value: String): Self = StObject.set(x, "navClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNavClassNameUndefined: Self = StObject.set(x, "navClassName", js.undefined)
      
      @scala.inline
      def setNavItems(value: TreeData[T]): Self = StObject.set(x, "navItems", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNavStyle(value: CSSProperties): Self = StObject.set(x, "navStyle", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNavStyleUndefined: Self = StObject.set(x, "navStyle", js.undefined)
    }
  }
}
