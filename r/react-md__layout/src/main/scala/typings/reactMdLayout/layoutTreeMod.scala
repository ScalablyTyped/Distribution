...
object layoutTreeMod {
  ...
  object BaseLayoutTreeProps {
    ...
    extension [Self <: BaseLayoutTreeProps[?], T /* <: BaseTreeItem */](x: Self & BaseLayoutTreeProps[T]) {
  ...
  object LayoutTreeProps {
    ...
    extension [Self <: LayoutTreeProps[?], T /* <: BaseTreeItem */](x: Self & LayoutTreeProps[T]) {
      ...
      inline def setDisableTemporaryAutoclose(value: Boolean): Self = StObject.set(x, "disableTemporaryAutoclose", value.asInstanceOf[js.Any])
      
      inline def setDisableTemporaryAutocloseUndefined: Self = StObject.set(x, "disableTemporaryAutoclose", js.undefined)
      ...
      inline def setNavItems(value: TreeData[T]): Self = StObject.set(x, "navItems", value.asInstanceOf[js.Any])
