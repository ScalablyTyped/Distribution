...
object configurationMod {
  ...
  object Configuration {
    ...
    @JSImport("@react-md/layout/types/Configuration", "Configuration")
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("@react-md/layout/types/Configuration", "Configuration.propTypes")
      @js.native
      val ^ : js.Any = js.native
  ...
  trait ConfigurationProps
    ...
    /**
      ...
      */
    var disableTooltipHoverMode: js.UndefOr[Boolean] = js.undefined
    ...
    /**
      ...
      */
    var tooltipDefaultDelay: js.UndefOr[Double] = js.undefined
    
    /**
      * The delay before the tooltip should become visible.
      */
    var tooltipDelayTimeout: js.UndefOr[Double] = js.undefined
  }
