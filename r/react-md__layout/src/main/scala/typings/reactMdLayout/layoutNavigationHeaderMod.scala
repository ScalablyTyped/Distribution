...
object layoutNavigationHeaderMod {
  ...
  object LayoutNavigationHeaderProps {
    ...
    inline def apply(): LayoutNavigationHeaderProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LayoutNavigationHeaderProps]
    }
    
    extension [Self <: LayoutNavigationHeaderProps](x: Self) {
      ...
      inline def setDisableBorderBottom(value: Boolean): Self = StObject.set(x, "disableBorderBottom", value.asInstanceOf[js.Any])
      
      inline def setDisableBorderBottomUndefined: Self = StObject.set(x, "disableBorderBottom", js.undefined)
      ...
      inline def setTitleProps(value: PropsWithRef[AppBarProps, HTMLDivElement]): Self = StObject.set(x, "titleProps", value.asInstanceOf[js.Any])
