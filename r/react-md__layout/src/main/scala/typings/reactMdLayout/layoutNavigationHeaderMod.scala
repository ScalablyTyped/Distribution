...
object layoutNavigationHeaderMod {
  
  @JSImport("@react-md/layout/types/LayoutNavigationHeader", "LayoutNavigationHeader")
  @js.native
  val LayoutNavigationHeader: ForwardRefExoticComponent[LayoutNavigationHeaderProps & RefAttributes[HTMLDivElement]] = js.native
  
  /* Inlined parent std.Omit<@react-md/app-bar.@react-md/app-bar.AppBarProps, 'title'> */
  trait LayoutNavigationHeaderProps extends StObject {
    ...
    /**
      ...
      */
    var disableBorderBottom: js.UndefOr[Boolean] = js.undefined
    ...
    /**
      ...
      * was provided.
      */
    var titleProps: js.UndefOr[PropsWithRef[AppBarProps, HTMLDivElement]] = js.undefined
  ...
  object LayoutNavigationHeaderProps {
    
    @scala.inline
    def apply(): LayoutNavigationHeaderProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LayoutNavigationHeaderProps]
    }
    
    @scala.inline
    implicit class LayoutNavigationHeaderPropsMutableBuilder[Self <: LayoutNavigationHeaderProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisableBorderBottom(value: Boolean): Self = StObject.set(x, "disableBorderBottom", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisableBorderBottomUndefined: Self = StObject.set(x, "disableBorderBottom", js.undefined)
      ...
      @scala.inline
      def setTitleProps(value: PropsWithRef[AppBarProps, HTMLDivElement]): Self = StObject.set(x, "titleProps", value.asInstanceOf[js.Any])
