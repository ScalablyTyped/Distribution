...
object layoutAppBarMod {
  
  @JSImport("@react-md/layout/types/LayoutAppBar", "LayoutAppBar")
  @js.native
  ...
  trait BaseLayoutAppBarProps extends StObject {
  ...
  object BaseLayoutAppBarProps {
    
    @scala.inline
    def apply(): BaseLayoutAppBarProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[BaseLayoutAppBarProps]
    }
    
    @scala.inline
    implicit class BaseLayoutAppBarPropsMutableBuilder[Self <: BaseLayoutAppBarProps] (val x: Self) extends AnyVal {
  ...
  trait LayoutAppBarProps
    extends StObject
       with BaseLayoutAppBarProps
       with LayoutWithNavToggle
       with LayoutWithTitle
  object LayoutAppBarProps {
    
    @scala.inline
    def apply(): LayoutAppBarProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LayoutAppBarProps]
    }
  }
}
