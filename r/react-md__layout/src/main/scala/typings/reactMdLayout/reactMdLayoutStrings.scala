...
object reactMdLayoutStrings {
  ...
  @js.native
  sealed trait disableScrollLock extends StObject
  inline def disableScrollLock: disableScrollLock = "disableScrollLock".asInstanceOf[disableScrollLock]
  
  @js.native
  sealed trait disableTabFocusWrap extends StObject
  inline def disableTabFocusWrap: disableTabFocusWrap = "disableTabFocusWrap".asInstanceOf[disableTabFocusWrap]
  ...
  sealed trait `full-height`
    extends StObject
       with SupportedWideLayout
  inline def `full-height`: `full-height` = "full-height".asInstanceOf[`full-height`]
  ...
  sealed trait temporary
    extends StObject
       with SupportedPhoneLayout
       with SupportedTabletLayout
       with SupportedWideLayout
  ...
  sealed trait `temporary-mini`
    extends StObject
       ...
       with SupportedTabletLayout
       with SupportedWideLayout
  inline def `temporary-mini`: `temporary-mini` = "temporary-mini".asInstanceOf[`temporary-mini`]
  ...
  @js.native
  sealed trait toggleable
    extends StObject
       with SupportedTabletLayout
       with SupportedWideLayout
  inline def toggleable: toggleable = "toggleable".asInstanceOf[toggleable]
  
  @js.native
  sealed trait `toggleable-mini`
    extends StObject
       with SupportedTabletLayout
       with SupportedWideLayout
  inline def `toggleable-mini`: `toggleable-mini` = "toggleable-mini".asInstanceOf[`toggleable-mini`]
