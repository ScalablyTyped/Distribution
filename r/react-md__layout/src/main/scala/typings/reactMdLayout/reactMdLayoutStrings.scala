...
object reactMdLayoutStrings {
  ...
  @scala.inline
  def disableScrollLock: disableScrollLock = "disableScrollLock".asInstanceOf[disableScrollLock]
  
  @js.native
  sealed trait disableTabFocusWrap extends StObject
  @scala.inline
  def disableTabFocusWrap: disableTabFocusWrap = "disableTabFocusWrap".asInstanceOf[disableTabFocusWrap]
  ...
  sealed trait `full-height`
    extends StObject
       with SupportedWideLayout
  @scala.inline
  def `full-height`: `full-height` = "full-height".asInstanceOf[`full-height`]
  ...
  sealed trait `temporary-mini`
    extends StObject
       ...
       with SupportedWideLayout
  @scala.inline
  def `temporary-mini`: `temporary-mini` = "temporary-mini".asInstanceOf[`temporary-mini`]
  ...
  sealed trait `toggleable-mini`
    extends StObject
       ...
       with SupportedWideLayout
  @scala.inline
  def `toggleable-mini`: `toggleable-mini` = "toggleable-mini".asInstanceOf[`toggleable-mini`]
