...
trait Connect extends js.Object {
  ...
  def apply[no_state, TDispatchProps, TOwnProps](
    ...
    mapDispatchToProps: reactDashReduxLib.MapDispatchToPropsParam[TDispatchProps, TOwnProps]
  ...
  def apply[TStateProps, no_dispatch, TOwnProps, State](mapStateToProps: reactDashReduxLib.MapStateToPropsParam[TStateProps, TOwnProps, State]): InferableComponentEnhancerWithProps[TStateProps with DispatchProp[reduxLib.reduxMod.AnyAction], TOwnProps] = js.native
  def apply[TStateProps, no_dispatch, TOwnProps, State](
    mapStateToProps: reactDashReduxLib.MapStateToPropsParam[TStateProps, TOwnProps, State],
    mapDispatchToProps: scala.Null,
    mergeProps: js.UndefOr[scala.Nothing],
