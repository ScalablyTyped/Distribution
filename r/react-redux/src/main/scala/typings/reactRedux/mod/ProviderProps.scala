...
object ProviderProps {
  @scala.inline
  def apply[/* <: typings.redux.mod.Action[_] */ A](store: Store[_, A]): ProviderProps[A] = {
    val __obj = js.Dynamic.literal(store = store.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProviderProps[A]]
  }
  @scala.inline
  implicit class ProviderPropsOps[Self <: ProviderProps[_], /* <: typings.redux.mod.Action[_] */ A] (val x: Self with ProviderProps[A]) extends AnyVal {
    @scala.inline
