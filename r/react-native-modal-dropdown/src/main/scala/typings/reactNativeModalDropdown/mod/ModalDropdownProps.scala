...
object ModalDropdownProps {
  ...
  def apply[T](
    ...
    renderRow: (/* option */ T, /* index */ String, /* isSelected */ Boolean) => ReactNode = null,
    renderSeparator: (/* sectionID */ String, /* index */ String, /* adjacentRowHighlighted */ Boolean) => ReactNode = null,
