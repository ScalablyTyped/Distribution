...
import typings.reactToolbox.componentsRadioRadioButtonMod.RadioButtonProps
import typings.reactToolbox.componentsRadioRadioGroupMod.RadioGroupProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object componentsRadioMod {
  
  @JSImport("react-toolbox/components/radio", JSImport.Default)
  @js.native
  open class default protected ()
    extends typings.reactToolbox.componentsRadioRadioButtonMod.RadioButton {
  ...
  open class RadioGroup protected ()
    extends typings.reactToolbox.componentsRadioRadioGroupMod.RadioGroup {
