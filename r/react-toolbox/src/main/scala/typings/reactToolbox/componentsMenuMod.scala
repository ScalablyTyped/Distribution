...
import typings.reactToolbox.componentsMenuIconMenuMod.IconMenuProps
import typings.reactToolbox.componentsMenuMenuDividerMod.MenuDividerProps
import typings.reactToolbox.componentsMenuMenuItemMod.MenuItemProps
import typings.reactToolbox.componentsMenuMenuMod.MenuProps
...
object componentsMenuMod {
  ...
  open class IconMenu protected ()
    extends typings.reactToolbox.componentsMenuIconMenuMod.IconMenu {
  ...
  open class Menu protected ()
    extends typings.reactToolbox.componentsMenuMenuMod.Menu {
  ...
  open class MenuDivider protected ()
    extends typings.reactToolbox.componentsMenuMenuDividerMod.MenuDivider {
  ...
  open class MenuItem protected ()
    extends typings.reactToolbox.componentsMenuMenuItemMod.MenuItem {
