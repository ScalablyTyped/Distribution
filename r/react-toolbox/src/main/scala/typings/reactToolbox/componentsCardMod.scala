...
import typings.reactToolbox.componentsCardCardActionsMod.CardActionsProps
import typings.reactToolbox.componentsCardCardMediaMod.CardMediaProps
import typings.reactToolbox.componentsCardCardMod.CardProps
import typings.reactToolbox.componentsCardCardTextMod.CardTextProps
import typings.reactToolbox.componentsCardCardTitleMod.CardTitleProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object componentsCardMod {
  
  @JSImport("react-toolbox/components/card", JSImport.Default)
  @js.native
  open class default protected ()
    extends typings.reactToolbox.componentsCardCardMod.Card {
  ...
  open class CardActions protected ()
    extends typings.reactToolbox.componentsCardCardActionsMod.CardActions {
  ...
  open class CardMedia protected ()
    extends typings.reactToolbox.componentsCardCardMediaMod.CardMedia {
  ...
  open class CardText protected ()
    extends typings.reactToolbox.componentsCardCardTextMod.CardText {
  ...
  open class CardTitle protected ()
    extends typings.reactToolbox.componentsCardCardTitleMod.CardTitle {
