...
import typings.reactToolbox.componentsTableTableCellMod.TableCellProps
import typings.reactToolbox.componentsTableTableHeadMod.TableHeadProps
import typings.reactToolbox.componentsTableTableMod.TableProps
import typings.reactToolbox.componentsTableTableRowMod.TableRowProps
...
object componentsTableMod {
  ...
  open class default protected ()
    extends typings.reactToolbox.componentsTableTableMod.Table {
  ...
  open class TableCell protected ()
    extends typings.reactToolbox.componentsTableTableCellMod.TableCell {
  ...
  open class TableHead protected ()
    extends typings.reactToolbox.componentsTableTableHeadMod.TableHead {
  ...
  open class TableRow protected ()
    extends typings.reactToolbox.componentsTableTableRowMod.TableRow {
