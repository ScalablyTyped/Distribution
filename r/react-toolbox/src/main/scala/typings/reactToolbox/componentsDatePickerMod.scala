...
import typings.reactToolbox.componentsDatePickerDatePickerMod.DatePickerProps
...
object componentsDatePickerMod {
  ...
  open class default protected ()
    extends typings.reactToolbox.componentsDatePickerDatePickerMod.DatePicker {
