...
import typings.reactToolbox.componentsFontIconFontIconMod.FontIconProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object componentsFontIconMod {
  
  @JSImport("react-toolbox/components/font_icon", JSImport.Default)
  @js.native
  open class default protected ()
    extends typings.reactToolbox.componentsFontIconFontIconMod.FontIcon {
