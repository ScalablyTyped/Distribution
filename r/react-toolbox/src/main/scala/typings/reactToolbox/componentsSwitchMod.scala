...
import typings.reactToolbox.componentsSwitchSwitchMod.SwitchProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object componentsSwitchMod {
  
  @JSImport("react-toolbox/components/switch", JSImport.Default)
  @js.native
  open class default protected ()
    extends typings.reactToolbox.componentsSwitchSwitchMod.Switch {
