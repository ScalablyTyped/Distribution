...
trait ExpandRowProps[T] extends js.Object {
  ...
  def onExpandAll(isExpandAll: Boolean, results: js.Array[Double], e: SyntheticEvent[Element, Event_]): Unit
  def renderer(row: T, rowIndex: Double): typings.react.mod._Global_.JSX.Element
}
...
object ExpandRowProps {
  ...
  def apply[T](
    ...
    onExpandAll: (Boolean, js.Array[Double], SyntheticEvent[Element, Event_]) => Unit,
    renderer: (T, Double) => typings.react.mod._Global_.JSX.Element,
    expandByColumnOnly: js.UndefOr[Boolean] = js.undefined,
    expanded: js.Array[Double] = null,
    onExpand: (/* row */ T, /* isExpand */ Boolean, /* rowIndex */ Double, /* e */ SyntheticEvent[Element, Event_]) => Unit = null,
    ...
    if (!js.isUndefined(expandByColumnOnly)) __obj.updateDynamic("expandByColumnOnly")(expandByColumnOnly.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showExpandColumn)) __obj.updateDynamic("showExpandColumn")(showExpandColumn.asInstanceOf[js.Any])
