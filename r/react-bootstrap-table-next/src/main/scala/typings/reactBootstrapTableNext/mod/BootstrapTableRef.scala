...
object BootstrapTableRef {
  @scala.inline
  def apply[/* <: js.Object */ T](table: Props[T]): BootstrapTableRef[T] = {
    val __obj = js.Dynamic.literal(table = table.asInstanceOf[js.Any])
    __obj.asInstanceOf[BootstrapTableRef[T]]
  }
  @scala.inline
  implicit class BootstrapTableRefOps[Self <: BootstrapTableRef[_], /* <: js.Object */ T] (val x: Self with BootstrapTableRef[T]) extends AnyVal {
    @scala.inline
