...
inline def CHECKBOX_STATUS_CHECKED: /* "checked" */ java.lang.String = typings.reactBootstrapTableNext.mod.^.asInstanceOf[js.Dynamic].selectDynamic("CHECKBOX_STATUS_CHECKED").asInstanceOf[/* "checked" */ java.lang.String]

inline def CHECKBOX_STATUS_INDETERMINATE: /* "indeterminate" */ java.lang.String = typings.reactBootstrapTableNext.mod.^.asInstanceOf[js.Dynamic].selectDynamic("CHECKBOX_STATUS_INDETERMINATE").asInstanceOf[/* "indeterminate" */ java.lang.String]

inline def CHECKBOX_STATUS_UNCHECKED: /* "unchecked" */ java.lang.String = typings.reactBootstrapTableNext.mod.^.asInstanceOf[js.Dynamic].selectDynamic("CHECKBOX_STATUS_UNCHECKED").asInstanceOf[/* "unchecked" */ java.lang.String]

inline def FILTERS_POSITION_BOTTOM: /* "bottom" */ java.lang.String = typings.reactBootstrapTableNext.mod.^.asInstanceOf[js.Dynamic].selectDynamic("FILTERS_POSITION_BOTTOM").asInstanceOf[/* "bottom" */ java.lang.String]

inline def FILTERS_POSITION_INLINE: /* "inline" */ java.lang.String = typings.reactBootstrapTableNext.mod.^.asInstanceOf[js.Dynamic].selectDynamic("FILTERS_POSITION_INLINE").asInstanceOf[/* "inline" */ java.lang.String]

inline def FILTERS_POSITION_TOP: /* "top" */ java.lang.String = typings.reactBootstrapTableNext.mod.^.asInstanceOf[js.Dynamic].selectDynamic("FILTERS_POSITION_TOP").asInstanceOf[/* "top" */ java.lang.String]

inline def ROW_SELECT_DISABLED: /* "ROW_SELECT_DISABLED" */ java.lang.String = typings.reactBootstrapTableNext.mod.^.asInstanceOf[js.Dynamic].selectDynamic("ROW_SELECT_DISABLED").asInstanceOf[/* "ROW_SELECT_DISABLED" */ java.lang.String]

inline def ROW_SELECT_MULTIPLE: /* "checkbox" */ java.lang.String = typings.reactBootstrapTableNext.mod.^.asInstanceOf[js.Dynamic].selectDynamic("ROW_SELECT_MULTIPLE").asInstanceOf[/* "checkbox" */ java.lang.String]

inline def ROW_SELECT_SINGLE: /* "radio" */ java.lang.String = typings.reactBootstrapTableNext.mod.^.asInstanceOf[js.Dynamic].selectDynamic("ROW_SELECT_SINGLE").asInstanceOf[/* "radio" */ java.lang.String]
