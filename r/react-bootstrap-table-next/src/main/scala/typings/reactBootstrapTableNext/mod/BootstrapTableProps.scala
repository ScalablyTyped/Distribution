...
object BootstrapTableProps {
  ...
  implicit class BootstrapTablePropsOps[Self <: BootstrapTableProps[_, _], T /* <: js.Object */, K] (val x: Self with (BootstrapTableProps[T, K])) extends AnyVal {
    ...
    @scala.inline
    def setNoDataIndicationFunction0(value: () => Element | String): Self = this.set("noDataIndication", js.Any.fromFunction0(value))
    
    @scala.inline
    def setNoDataIndication(value: (js.Function0[Element | String]) | Element | String): Self = this.set("noDataIndication", value.asInstanceOf[js.Any])
