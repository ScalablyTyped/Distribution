...
object SortColumn {
  ...
  @scala.inline
  def apply[T /* <: js.Object */](sortColumn: ColumnDescription[T, js.Any], sortOrder: SortOrder): SortColumn[T] = {
  ...
  @scala.inline
  implicit class SortColumnMutableBuilder[Self <: SortColumn[?], T /* <: js.Object */] (val x: Self & SortColumn[T]) extends AnyVal {
    
    @scala.inline
    def setSortColumn(value: ColumnDescription[T, js.Any]): Self = StObject.set(x, "sortColumn", value.asInstanceOf[js.Any])
