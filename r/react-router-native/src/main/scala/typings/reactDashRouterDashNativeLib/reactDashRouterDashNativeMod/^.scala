...
object ^ extends js.Object {
  ...
  {[ K in keyof Params ]:? string}
    */ reactDashRouterDashNativeLib.reactDashRouterDashNativeLibStrings.matchPath with js.Any */](pathname: java.lang.String, props: java.lang.String): reactDashRouterLib.reactDashRouterMod.`match`[Params] | scala.Null = js.native
  def matchPath[Params /* <: /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ K in keyof Params ]:? string}
    */ reactDashRouterDashNativeLib.reactDashRouterDashNativeLibStrings.matchPath with js.Any */](
  ...
  def matchPath[Params /* <: /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ K in keyof Params ]:? string}
    */ reactDashRouterDashNativeLib.reactDashRouterDashNativeLibStrings.matchPath with js.Any */](pathname: java.lang.String, props: reactDashRouterLib.reactDashRouterMod.RouteProps): reactDashRouterLib.reactDashRouterMod.`match`[Params] | scala.Null = js.native
  def matchPath[Params /* <: /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ K in keyof Params ]:? string}
    */ reactDashRouterDashNativeLib.reactDashRouterDashNativeLibStrings.matchPath with js.Any */](
    pathname: java.lang.String,
