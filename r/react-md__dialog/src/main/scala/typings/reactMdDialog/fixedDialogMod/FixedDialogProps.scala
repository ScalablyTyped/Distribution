package typings.reactMdDialog.fixedDialogMod
...
/* Inlined parent std.Omit<@react-md/dialog.@react-md/dialog/types/Dialog.DialogProps, 'type'> */
/* Inlined parent std.Pick<@react-md/transition.@react-md/transition.OptionalFixedPositionOptions, 'anchor'> */
@js.native
trait FixedDialogProps extends js.Object {
...
object FixedDialogProps {
  @scala.inline
  def apply(id: String, onRequestClose: () => Unit, visible: Boolean): FixedDialogProps = {
    ...
    __obj.asInstanceOf[FixedDialogProps]
  }
  @scala.inline
  implicit class FixedDialogPropsOps[Self <: FixedDialogProps] (val x: Self) extends AnyVal {
    @scala.inline
