...
object reactMdDialogStrings {
  ...
  @scala.inline
  def `stacked-end`: `stacked-end` = "stacked-end".asInstanceOf[`stacked-end`]
  
  @scala.inline
  def `stacked-start`: `stacked-start` = "stacked-start".asInstanceOf[`stacked-start`]
  ...
  @js.native
  sealed trait `full-page` extends js.Object
  ...
  @js.native
  sealed trait `stacked-end` extends js.Object
  
  @js.native
  sealed trait `stacked-start` extends js.Object
