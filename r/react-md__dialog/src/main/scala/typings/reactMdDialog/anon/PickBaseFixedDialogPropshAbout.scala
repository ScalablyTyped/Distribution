...
@js.native
trait PickBaseFixedDialogPropshAbout extends js.Object {
...
object PickBaseFixedDialogPropshAbout {
  ...
  @scala.inline
  implicit class PickBaseFixedDialogPropshAboutOps[Self <: PickBaseFixedDialogPropshAbout] (val x: Self) extends AnyVal {
