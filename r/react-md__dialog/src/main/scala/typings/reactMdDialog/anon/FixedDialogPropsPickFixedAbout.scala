...
object FixedDialogPropsPickFixedAbout {
  ...
  def apply(
    ...
    onRequestClose: () => Unit,
    visible: Boolean
  ): FixedDialogPropsPickFixedAbout = {
    ...
    __obj.asInstanceOf[FixedDialogPropsPickFixedAbout]
  }
  @scala.inline
  implicit class FixedDialogPropsPickFixedAboutOps[Self <: FixedDialogPropsPickFixedAbout] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def `setAria-labelledby`(value: js.UndefOr[String] with String): Self = this.set("aria-labelledby", value.asInstanceOf[js.Any])
    @scala.inline
