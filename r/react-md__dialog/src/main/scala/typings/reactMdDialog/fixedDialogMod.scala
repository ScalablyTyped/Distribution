...
import typings.reactMdDialog.reactMdDialogStrings.`removals additions`
import typings.reactMdDialog.reactMdDialogStrings.`removals text`
import typings.reactMdDialog.reactMdDialogStrings.`text additions`
import typings.reactMdDialog.reactMdDialogStrings.`text removals`
...
object fixedDialogMod {
  ...
  trait BaseFixedDialogProps extends StObject {
    ...
    /**
      ...
      */
    var options: js.UndefOr[OptionalFixedPositionOptions] = js.native
  ...
  object BaseFixedDialogProps {
    ...
    @scala.inline
    def apply(id: String, onRequestClose: () => Unit, visible: Boolean): BaseFixedDialogProps = {
    ...
    @scala.inline
    implicit class BaseFixedDialogPropsMutableBuilder[Self <: BaseFixedDialogProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOptions(value: OptionalFixedPositionOptions): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
  ...
  type FixedDialogProps = LabelRequiredForA11y[BaseFixedDialogProps]
}
