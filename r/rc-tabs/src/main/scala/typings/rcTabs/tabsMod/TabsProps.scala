...
object TabsProps {
  ...
  implicit class TabsPropsOps[Self <: TabsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMoreIcon(value: ReactNode): Self = this.set("moreIcon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRenderTabBar(value: (/* props */ js.Any, /* DefaultTabBar */ ComponentType[js.Object]) => ReactElement): Self = this.set("renderTabBar", js.Any.fromFunction2(value))
