...
object TabsProps {
  ...
  def apply(
    ...
    animated: Boolean | AnimatedConfig = null,
    ...
    moreIcon: ReactNode = null,
    moreTransitionName: String = null,
    ...
    onTabClick: (/* activeKey */ String, /* e */ KeyboardEvent[Element] | (MouseEvent[Element, NativeMouseEvent])) => Unit = null,
    onTabScroll: /* info */ Direction => Unit = null,
    ...
    renderTabBar: (/* props */ js.Any, /* DefaultTabBar */ ComponentType[js.Object]) => ReactElement = null,
    ...
    if (onTabScroll != null) __obj.updateDynamic("onTabScroll")(js.Any.fromFunction1(onTabScroll))
