...
trait WeakValidationMapTabsProp extends js.Object {
  ...
  var tabBarExtraContent: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.native
...
object WeakValidationMapTabsProp {
  ...
  implicit class WeakValidationMapTabsPropOps[Self <: WeakValidationMapTabsProp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTabBarExtraContent(value: Validator[js.UndefOr[Null | ReactNode]]): Self = this.set("tabBarExtraContent", value.asInstanceOf[js.Any])
    @scala.inline
