...
import typings.rcTabs.rcTabsStrings.`additions removals`
import typings.rcTabs.rcTabsStrings.`additions text`
import typings.rcTabs.rcTabsStrings.`inline`
import typings.rcTabs.rcTabsStrings.`removals additions`
import typings.rcTabs.rcTabsStrings.`removals text`
import typings.rcTabs.rcTabsStrings.`text additions`
import typings.rcTabs.rcTabsStrings.`text removals`
...
trait WeakValidationMapTabsProp extends js.Object {
  ...
  var moreIcon: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.native
...
object WeakValidationMapTabsProp {
  ...
  implicit class WeakValidationMapTabsPropOps[Self <: WeakValidationMapTabsProp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMoreIcon(value: Validator[js.UndefOr[Null | ReactNode]]): Self = this.set("moreIcon", value.asInstanceOf[js.Any])
