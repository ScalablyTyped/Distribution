...
import typings.rcTabs.rcTabsStrings.`additions text`
import typings.rcTabs.rcTabsStrings.`inline`
import typings.rcTabs.rcTabsStrings.additions
import typings.rcTabs.rcTabsStrings.all
import typings.rcTabs.rcTabsStrings.ascending
import typings.rcTabs.rcTabsStrings.assertive
import typings.rcTabs.rcTabsStrings.both
import typings.rcTabs.rcTabsStrings.copy
import typings.rcTabs.rcTabsStrings.date
import typings.rcTabs.rcTabsStrings.decimal
import typings.rcTabs.rcTabsStrings.descending
import typings.rcTabs.rcTabsStrings.dialog
import typings.rcTabs.rcTabsStrings.email
import typings.rcTabs.rcTabsStrings.execute
import typings.rcTabs.rcTabsStrings.grammar
import typings.rcTabs.rcTabsStrings.grid
import typings.rcTabs.rcTabsStrings.horizontal
import typings.rcTabs.rcTabsStrings.inherit
import typings.rcTabs.rcTabsStrings.link
import typings.rcTabs.rcTabsStrings.list
import typings.rcTabs.rcTabsStrings.listbox
import typings.rcTabs.rcTabsStrings.location
import typings.rcTabs.rcTabsStrings.ltr
import typings.rcTabs.rcTabsStrings.menu
import typings.rcTabs.rcTabsStrings.mixed
import typings.rcTabs.rcTabsStrings.move
import typings.rcTabs.rcTabsStrings.no
import typings.rcTabs.rcTabsStrings.none
import typings.rcTabs.rcTabsStrings.numeric
import typings.rcTabs.rcTabsStrings.off
import typings.rcTabs.rcTabsStrings.on
import typings.rcTabs.rcTabsStrings.other
import typings.rcTabs.rcTabsStrings.page
import typings.rcTabs.rcTabsStrings.polite
import typings.rcTabs.rcTabsStrings.popup
import typings.rcTabs.rcTabsStrings.removals
import typings.rcTabs.rcTabsStrings.rtl
import typings.rcTabs.rcTabsStrings.search
import typings.rcTabs.rcTabsStrings.spelling
import typings.rcTabs.rcTabsStrings.step
import typings.rcTabs.rcTabsStrings.tel
import typings.rcTabs.rcTabsStrings.text
import typings.rcTabs.rcTabsStrings.time
import typings.rcTabs.rcTabsStrings.tree
import typings.rcTabs.rcTabsStrings.url
import typings.rcTabs.rcTabsStrings.vertical
import typings.rcTabs.rcTabsStrings.yes
...
/* Inlined react.react.WeakValidationMap<rc-tabs.rc-tabs/lib/Tabs.TabsProps & react.react.RefAttributes<std.HTMLDivElement>> */
trait WeakValidationMapTabsProp extends js.Object {
  ...
  var animated: js.UndefOr[Validator[js.UndefOr[AnimatedConfig | Boolean | Null]]] = js.undefined
  ...
  var defaultActiveKey: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  ...
  var destroyInactiveTabPane: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
  ...
  var editable: js.UndefOr[Validator[js.UndefOr[EditableConfig | Null]]] = js.undefined
  ...
  var locale: js.UndefOr[Validator[js.UndefOr[Null | TabsLocale]]] = js.undefined
  var moreIcon: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.undefined
  var moreTransitionName: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  ...
  var onChange: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* activeKey */ String, Unit]) | Null]]] = js.undefined
  ...
  var onTabClick: js.UndefOr[
    Validator[
      js.UndefOr[
        (js.Function2[
          /* activeKey */ String, 
          KeyboardEvent[Element] | (MouseEvent[Element, NativeMouseEvent]), 
          Unit
        ]) | Null
      ]
    ]
  ] = js.undefined
  var onTabScroll: js.UndefOr[Validator[js.UndefOr[Null | OnTabScroll]]] = js.undefined
  ...
  var renderTabBar: js.UndefOr[Validator[js.UndefOr[Null | RenderTabBar]]] = js.undefined
  ...
  var tabBarExtraContent: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.undefined
  var tabBarGutter: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  var tabBarStyle: js.UndefOr[Validator[js.UndefOr[CSSProperties | Null]]] = js.undefined
  var tabIndex: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  var tabPosition: js.UndefOr[Validator[js.UndefOr[Null | TabPosition]]] = js.undefined
...
object WeakValidationMapTabsProp {
  ...
  def apply(
    ...
    animated: Validator[js.UndefOr[AnimatedConfig | Boolean | Null]] = null,
    ...
    defaultActiveKey: Validator[js.UndefOr[Null | String]] = null,
    ...
    destroyInactiveTabPane: Validator[js.UndefOr[Boolean | Null]] = null,
    ...
    editable: Validator[js.UndefOr[EditableConfig | Null]] = null,
    ...
    locale: Validator[js.UndefOr[Null | TabsLocale]] = null,
    moreIcon: Validator[js.UndefOr[Null | ReactNode]] = null,
    moreTransitionName: Validator[js.UndefOr[Null | String]] = null,
    ...
    onChange: Validator[js.UndefOr[(js.Function1[/* activeKey */ String, Unit]) | Null]] = null,
    ...
    onTabScroll: Validator[js.UndefOr[Null | OnTabScroll]] = null,
    ...
    renderTabBar: Validator[js.UndefOr[Null | RenderTabBar]] = null,
    ...
    tabBarExtraContent: Validator[js.UndefOr[Null | ReactNode]] = null,
    tabBarGutter: Validator[js.UndefOr[Double | Null]] = null,
    tabBarStyle: Validator[js.UndefOr[CSSProperties | Null]] = null,
    tabIndex: Validator[js.UndefOr[Double | Null]] = null,
    tabPosition: Validator[js.UndefOr[Null | TabPosition]] = null,
    ...
    if (destroyInactiveTabPane != null) __obj.updateDynamic("destroyInactiveTabPane")(destroyInactiveTabPane.asInstanceOf[js.Any])
    ...
    if (moreIcon != null) __obj.updateDynamic("moreIcon")(moreIcon.asInstanceOf[js.Any])
    if (moreTransitionName != null) __obj.updateDynamic("moreTransitionName")(moreTransitionName.asInstanceOf[js.Any])
    ...
    if (onTabScroll != null) __obj.updateDynamic("onTabScroll")(onTabScroll.asInstanceOf[js.Any])
