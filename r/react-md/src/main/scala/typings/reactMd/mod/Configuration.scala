...
object Configuration {
  ...
  @JSImport("react-md", "Configuration")
  @js.native
  val ^ : js.Any = js.native
  
  object propTypes {
    
    @JSImport("react-md", "Configuration.propTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-md", "Configuration.propTypes.children")
    @js.native
    def children: js.Any = js.native
    inline def children_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("children")(x.asInstanceOf[js.Any])
    
    @JSImport("react-md", "Configuration.propTypes.defaultDir")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.defaultSize")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.desktopLargeMinWidth")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.desktopMinWidth")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.disableProgrammaticRipple")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.disableRipple")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.disableTooltipHoverMode")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.formTheme")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.icons")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.onAppResize")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.phoneMaxWidth")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.rippleClassNames")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.rippleTimeout")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.tabletMaxWidth")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.tabletMinWidth")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.tooltipDefaultDelay")
    @js.native
    ...
    @JSImport("react-md", "Configuration.propTypes.tooltipDelayTimeout")
    @js.native
