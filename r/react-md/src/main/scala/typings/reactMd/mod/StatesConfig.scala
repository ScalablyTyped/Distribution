...
object StatesConfig {
  ...
  @JSImport("react-md", "StatesConfig")
  @js.native
  val ^ : js.Any = js.native
  
  object propTypes {
    
    @JSImport("react-md", "StatesConfig.propTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-md", "StatesConfig.propTypes.children")
    @js.native
    def children: js.Any = js.native
    inline def children_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("children")(x.asInstanceOf[js.Any])
    
    @JSImport("react-md", "StatesConfig.propTypes.disableProgrammaticRipple")
    @js.native
    ...
    @JSImport("react-md", "StatesConfig.propTypes.disableRipple")
    @js.native
    ...
    @JSImport("react-md", "StatesConfig.propTypes.rippleClassNames")
    @js.native
    ...
    @JSImport("react-md", "StatesConfig.propTypes.rippleTimeout")
    @js.native
