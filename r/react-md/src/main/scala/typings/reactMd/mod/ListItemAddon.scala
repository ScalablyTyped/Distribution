...
object ListItemAddon {
  ...
  @JSImport("react-md", "ListItemAddon")
  @js.native
  val ^ : js.Any = js.native
  
  object propTypes {
    
    @JSImport("react-md", "ListItemAddon.propTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-md", "ListItemAddon.propTypes.addon")
    @js.native
    def addon: js.Any = js.native
    
    @JSImport("react-md", "ListItemAddon.propTypes.addonAfter")
    @js.native
    ...
    @JSImport("react-md", "ListItemAddon.propTypes.forceAddonWrap")
    @js.native
    ...
    @JSImport("react-md", "ListItemAddon.propTypes.position")
    @js.native
    ...
    @JSImport("react-md", "ListItemAddon.propTypes.type")
    @js.native
