...
object HighlightedResult {
  ...
  @JSImport("react-md", "HighlightedResult")
  @js.native
  val ^ : js.Any = js.native
  
  object propTypes {
    
    @JSImport("react-md", "HighlightedResult.propTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-md", "HighlightedResult.propTypes.children")
    @js.native
    def children: js.Any = js.native
    @scala.inline
    def children_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("children")(x.asInstanceOf[js.Any])
    
    @JSImport("react-md", "HighlightedResult.propTypes.className")
    @js.native
    ...
    @JSImport("react-md", "HighlightedResult.propTypes.enabled")
    @js.native
