...
object Collapse {
  ...
  @JSImport("react-md", "Collapse")
  @js.native
  val ^ : js.Any = js.native
  
  object propTypes {
    
    @JSImport("react-md", "Collapse.propTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-md", "Collapse.propTypes.children")
    @js.native
    def children: js.Any = js.native
    inline def children_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("children")(x.asInstanceOf[js.Any])
    
    @JSImport("react-md", "Collapse.propTypes.className")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.collapsed")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.minHeight")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.minPaddingBottom")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.minPaddingTop")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.onEnter")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.onEntered")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.onEntering")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.onExit")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.onExited")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.onExiting")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.style")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.temporary")
    @js.native
    ...
    @JSImport("react-md", "Collapse.propTypes.timeout")
    @js.native
