...
object IconProvider {
  ...
  @JSImport("react-md", "IconProvider")
  @js.native
  val ^ : js.Any = js.native
  
  object propTypes {
    
    @JSImport("react-md", "IconProvider.propTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-md", "IconProvider.propTypes.back")
    @js.native
    def back: js.Any = js.native
    @scala.inline
    def back_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("back")(x.asInstanceOf[js.Any])
    
    @JSImport("react-md", "IconProvider.propTypes.checkbox")
    @js.native
    ...
    @JSImport("react-md", "IconProvider.propTypes.dropdown")
    @js.native
    ...
    @JSImport("react-md", "IconProvider.propTypes.expander")
    @js.native
    ...
    @JSImport("react-md", "IconProvider.propTypes.forward")
    @js.native
    ...
    @JSImport("react-md", "IconProvider.propTypes.password")
    @js.native
    ...
    @JSImport("react-md", "IconProvider.propTypes.sort")
    @js.native
