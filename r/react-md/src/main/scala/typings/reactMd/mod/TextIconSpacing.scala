...
object TextIconSpacing {
  ...
  @JSImport("react-md", "TextIconSpacing")
  @js.native
  val ^ : js.Any = js.native
  
  object propTypes {
    
    @JSImport("react-md", "TextIconSpacing.propTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-md", "TextIconSpacing.propTypes.aboveClassName")
    @js.native
    ...
    @JSImport("react-md", "TextIconSpacing.propTypes.afterClassName")
    @js.native
    ...
    @JSImport("react-md", "TextIconSpacing.propTypes.beforeClassName")
    @js.native
    ...
    @JSImport("react-md", "TextIconSpacing.propTypes.belowClassName")
    @js.native
    ...
    @JSImport("react-md", "TextIconSpacing.propTypes.forceIconWrap")
    @js.native
    ...
    @JSImport("react-md", "TextIconSpacing.propTypes.icon")
    @js.native
    def icon: js.Any = js.native
    
    @JSImport("react-md", "TextIconSpacing.propTypes.iconAfter")
    @js.native
    ...
    @JSImport("react-md", "TextIconSpacing.propTypes.stacked")
    @js.native
