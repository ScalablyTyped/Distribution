package typings
package reactDashMdLib.libFontIconsFontIconMod
...
trait FontIconProps
  ...
  var forceFontSize: js.UndefOr[scala.Boolean] = js.undefined
  var forceSize: js.UndefOr[scala.Boolean | scala.Double] = js.undefined
...
object FontIconProps {
  ...
  def apply(
    ...
    forceFontSize: js.UndefOr[scala.Boolean] = js.undefined,
    forceSize: scala.Boolean | scala.Double = null,
    ...
    if (!js.isUndefined(forceFontSize)) __obj.updateDynamic("forceFontSize")(forceFontSize)
    if (forceSize != null) __obj.updateDynamic("forceSize")(forceSize.asInstanceOf[js.Any])
