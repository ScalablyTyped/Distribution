...
object TimePickerProps {
  ...
  def apply(
    ...
    defaultTimeMode: reactDashMdLib.reactDashMdLibStrings.hour | reactDashMdLib.reactDashMdLibStrings.minute = null,
    ...
    formatOptions: reactDashMdLib.libPickersMod.IntlTimeFormat = null,
    fullWidth: js.UndefOr[scala.Boolean] = js.undefined,
    helpOnFocus: js.UndefOr[scala.Boolean] = js.undefined,
    helpText: reactLib.reactMod.ReactNode = null,
    hoverMode: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    onChange: (/* formattedTime */ java.lang.String, /* date */ stdLib.Date, /* event */ stdLib.Event) => scala.Unit = null,
    ...
    if (defaultTimeMode != null) __obj.updateDynamic("defaultTimeMode")(defaultTimeMode.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(hoverMode)) __obj.updateDynamic("hoverMode")(hoverMode)
