...
object SelectFieldColumnProps {
  ...
  def apply(
    ...
    onChange: (/* value */ scala.Double | java.lang.String, /* selectedIndex */ scala.Double, /* event */ reactLib.reactMod.MouseEvent[stdLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ reactDashMdLib.libSelectFieldsSelectFieldMod.FieldDataProps) => scala.Unit = null,
