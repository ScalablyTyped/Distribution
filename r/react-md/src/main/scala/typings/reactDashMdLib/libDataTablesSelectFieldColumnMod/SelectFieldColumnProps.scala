package typings
package reactDashMdLib.libDataTablesSelectFieldColumnMod
...
object SelectFieldColumnProps {
  ...
  def apply(
    ...
    onChange: (/* value */ scala.Double | java.lang.String, /* selectedIndex */ scala.Double, /* event */ reactLib.reactMod.ReactNs.MouseEvent[stdLib.HTMLElement, reactLib.NativeMouseEvent], /* data */ reactDashMdLib.libSelectFieldsSelectFieldMod.FieldDataProps) => scala.Unit = null,
    ...
    __obj.asInstanceOf[SelectFieldColumnProps]
  }
}
