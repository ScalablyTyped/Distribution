...
@js.native
object reactDashMdMod extends js.Object {
  val Autocomplete: reactDashMdLib.libAutocompletesAutocompleteMod.AutocompleteComponent = js.native
  val Avatar: reactLib.reactMod.ReactNs.ComponentClass[
    reactDashMdLib.libAvatarsAvatarMod.AvatarProps, 
    reactLib.reactMod.ReactNs.ComponentState
  ] = js.native
  val Badge: reactLib.reactMod.ReactNs.ComponentClass[
    reactDashMdLib.libBadgesBadgeMod.BadgeProps, 
    reactLib.reactMod.ReactNs.ComponentState
  ] = js.native
  ...
  val Chip: reactLib.reactMod.ReactNs.ComponentClass[reactDashMdLib.libChipsChipMod.ChipProps, reactLib.reactMod.ReactNs.ComponentState] = js.native
  ...
  val Toolbar: reactLib.reactMod.ReactNs.ComponentClass[
