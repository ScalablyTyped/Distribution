...
object Config {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(ErrorOverlay = ErrorOverlay.asInstanceOf[js.Any], allowSFC = allowSFC, disableHotRenderer = disableHotRenderer, disableHotRendererWhenInjected = disableHotRendererWhenInjected, errorReporter = errorReporter.asInstanceOf[js.Any], ignoreComponents = ignoreComponents, ignoreSFC = ignoreSFC, logLevel = logLevel, onComponentCreate = js.Any.fromFunction2(onComponentCreate), onComponentRegister = js.Any.fromFunction3(onComponentRegister), pureRender = pureRender, pureSFC = pureSFC, reloadHooks = reloadHooks, showReactDomPatchNotification = showReactDomPatchNotification, trackTailUpdates = trackTailUpdates)
