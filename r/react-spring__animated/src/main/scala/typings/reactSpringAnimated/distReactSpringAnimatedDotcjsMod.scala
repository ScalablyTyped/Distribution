...
object distReactSpringAnimatedDotcjsMod {
  ...
  open class Animated[T] ()
    extends typings.reactSpringAnimated.distDeclarationsSrcMod.Animated[T]
  ...
  open class AnimatedArray[T /* <: js.Array[Value] */] protected ()
    extends typings.reactSpringAnimated.distDeclarationsSrcMod.AnimatedArray[T] {
  ...
  open class AnimatedObject protected ()
    extends typings.reactSpringAnimated.distDeclarationsSrcMod.AnimatedObject {
  ...
  open class AnimatedString protected ()
    extends typings.reactSpringAnimated.distDeclarationsSrcMod.AnimatedString {
  ...
  open class AnimatedValue[T] protected ()
    extends typings.reactSpringAnimated.distDeclarationsSrcMod.AnimatedValue[T] {
