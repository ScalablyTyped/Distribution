...
object createHostMod {
  ...
  trait HostConfig extends StObject {
    ...
    def createAnimatedStyle(style: Lookup[Any]): typings.reactSpringAnimated.animatedMod.Animated[Any]
  ...
  object HostConfig {
    ...
    inline def apply(
      ...
      createAnimatedStyle: Lookup[Any] => typings.reactSpringAnimated.animatedMod.Animated[Any],
    ...
    extension [Self <: HostConfig](x: Self) {
      ...
      inline def setCreateAnimatedStyle(value: Lookup[Any] => typings.reactSpringAnimated.animatedMod.Animated[Any]): Self = StObject.set(x, "createAnimatedStyle", js.Any.fromFunction1(value))
