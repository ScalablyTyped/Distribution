...
object mod {
  ...
  object AnimatedArray {
    ...
    /* static member */
    @JSImport("@react-spring/animated", "AnimatedArray.create")
    @js.native
  ...
  object AnimatedString {
    ...
    /* static member */
    @JSImport("@react-spring/animated", "AnimatedString.create")
    @js.native
  ...
  object AnimatedValue {
    ...
    /* static member */
    @JSImport("@react-spring/animated", "AnimatedValue.create")
    @js.native
    def create[T](from: T): AnimatedValue[T] = js.native
    @JSImport("@react-spring/animated", "AnimatedValue.create")
    @js.native
  ...
  @js.native
  def createHost(components: js.Array[AnimatableComponent]): AnimatedWithAnimated = js.native
  @JSImport("@react-spring/animated", "createHost")
  @js.native
  def createHost(
  ...
  @JSImport("@react-spring/animated", "createHost")
  @js.native
  def createHost(components: StringDictionary[AnimatableComponent]): AnimatedWithAnimated = js.native
  @JSImport("@react-spring/animated", "createHost")
  @js.native
  def createHost(
  ...
  @js.native
  def isAnimated[T](value: js.Any): /* is @react-spring/animated.@react-spring/animated.Animated<T> */ Boolean = js.native
