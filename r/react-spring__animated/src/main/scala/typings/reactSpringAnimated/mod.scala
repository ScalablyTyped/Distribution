...
object mod {
  ...
  @JSImport("@react-spring/animated/dist/declarations/src", "Animated")
  @js.native
  abstract class Animated[T] ()
    extends typings.reactSpringAnimated.animatedMod.Animated[T]
  
  @JSImport("@react-spring/animated/dist/declarations/src", "AnimatedArray")
  @js.native
  open class AnimatedArray[T /* <: js.Array[Value] */] protected ()
    extends typings.reactSpringAnimated.animatedArrayMod.AnimatedArray[T] {
  ...
  open class AnimatedObject protected ()
    extends typings.reactSpringAnimated.animatedObjectMod.AnimatedObject {
  ...
  open class AnimatedString protected ()
    extends typings.reactSpringAnimated.animatedStringMod.AnimatedString {
  ...
  open class AnimatedValue[T] protected ()
    extends typings.reactSpringAnimated.animatedValueMod.AnimatedValue[T] {
