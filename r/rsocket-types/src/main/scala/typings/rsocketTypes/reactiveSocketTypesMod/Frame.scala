...
object Frame {
  ...
  @scala.inline
  def CancelFrame(flags: Double, streamId: Double): typings.rsocketTypes.reactiveSocketTypesMod.CancelFrame = {
  ...
  @scala.inline
  def ErrorFrame(code: Double, flags: Double, message: String, streamId: Double): typings.rsocketTypes.reactiveSocketTypesMod.ErrorFrame = {
  ...
  @scala.inline
  def KeepAliveFrame(flags: Double, lastReceivedPosition: Double): typings.rsocketTypes.reactiveSocketTypesMod.KeepAliveFrame = {
  ...
  @scala.inline
  def LeaseFrame(flags: Double, requestCount: Double, ttl: Double): typings.rsocketTypes.reactiveSocketTypesMod.LeaseFrame = {
  ...
  @scala.inline
  def PayloadFrame(flags: Double, streamId: Double): typings.rsocketTypes.reactiveSocketTypesMod.PayloadFrame = {
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any], streamId = streamId.asInstanceOf[js.Any])
  ...
  @scala.inline
  def RequestChannelFrame(flags: Double, requestN: Double, streamId: Double): typings.rsocketTypes.reactiveSocketTypesMod.RequestChannelFrame = {
  ...
  @scala.inline
  def RequestFnfFrame(flags: Double, streamId: Double): typings.rsocketTypes.reactiveSocketTypesMod.RequestFnfFrame = {
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any], streamId = streamId.asInstanceOf[js.Any])
  ...
  @scala.inline
  def RequestNFrame(flags: Double, requestN: Double, streamId: Double): typings.rsocketTypes.reactiveSocketTypesMod.RequestNFrame = {
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any], requestN = requestN.asInstanceOf[js.Any], streamId = streamId.asInstanceOf[js.Any])
  ...
  @scala.inline
  def RequestResponseFrame(flags: Double, streamId: Double): typings.rsocketTypes.reactiveSocketTypesMod.RequestResponseFrame = {
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any], streamId = streamId.asInstanceOf[js.Any])
  ...
  @scala.inline
  def RequestStreamFrame(data: Encodable, flags: Double, metadata: Encodable, requestN: Double, streamId: Double): typings.rsocketTypes.reactiveSocketTypesMod.RequestStreamFrame = {
  ...
  @scala.inline
  def ResumeOkFrame(clientPosition: Double, flags: Double): typings.rsocketTypes.reactiveSocketTypesMod.ResumeOkFrame = {
  ...
  @scala.inline
  def UnsupportedFrame(flags: Double, `type`: `0x3f` | `0x0c` | `0x00`): typings.rsocketTypes.reactiveSocketTypesMod.UnsupportedFrame = {
