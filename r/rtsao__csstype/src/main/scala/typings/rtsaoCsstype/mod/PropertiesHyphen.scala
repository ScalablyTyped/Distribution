...
object PropertiesHyphen {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PropertiesHyphen[?], TLength] (val x: Self & PropertiesHyphen[TLength]) extends AnyVal {
