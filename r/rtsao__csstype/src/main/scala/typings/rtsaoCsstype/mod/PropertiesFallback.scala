...
object PropertiesFallback {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PropertiesFallback[?], TLength] (val x: Self & PropertiesFallback[TLength]) extends AnyVal {
