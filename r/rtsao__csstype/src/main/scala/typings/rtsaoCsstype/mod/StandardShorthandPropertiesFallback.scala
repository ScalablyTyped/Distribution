...
object StandardShorthandPropertiesFallback {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StandardShorthandPropertiesFallback[?], TLength] (val x: Self & StandardShorthandPropertiesFallback[TLength]) extends AnyVal {
