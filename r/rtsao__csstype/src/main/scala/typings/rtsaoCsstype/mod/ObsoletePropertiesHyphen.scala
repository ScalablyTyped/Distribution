...
object ObsoletePropertiesHyphen {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ObsoletePropertiesHyphen[?], TLength] (val x: Self & ObsoletePropertiesHyphen[TLength]) extends AnyVal {
    ...
    inline def `set-moz-opacity`(value: GlobalsNumber): Self = StObject.set(x, "-moz-opacity", value.asInstanceOf[js.Any])
    ...
    inline def `set-moz-resize`(value: ResizeProperty): Self = StObject.set(x, "-moz-resize", value.asInstanceOf[js.Any])
    
    inline def `set-moz-resizeUndefined`: Self = StObject.set(x, "-moz-resize", js.undefined)
