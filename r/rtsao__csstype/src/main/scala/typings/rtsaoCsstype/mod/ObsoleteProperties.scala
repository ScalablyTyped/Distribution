...
object ObsoleteProperties {
  ...
  implicit open class MutableBuilder[Self <: ObsoleteProperties[?], TLength] (val x: Self & ObsoleteProperties[TLength]) extends AnyVal {
    ...
    inline def setMozOpacity(value: GlobalsNumber): Self = StObject.set(x, "MozOpacity", value.asInstanceOf[js.Any])
    ...
    inline def setMozResize(value: ResizeProperty): Self = StObject.set(x, "MozResize", value.asInstanceOf[js.Any])
    
    inline def setMozResizeUndefined: Self = StObject.set(x, "MozResize", js.undefined)
