...
object GatewayRegistry {
  ...
  implicit class GatewayRegistryOps[Self <: GatewayRegistry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_children(value: StringDictionary[js.UndefOr[StringDictionary[ReactNode]]]): Self = this.set("_children", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set_containers(value: StringDictionary[js.UndefOr[(Component[js.Object, js.Object, _]) | Null]]): Self = this.set("_containers", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setAddChild(value: (String, String, ReactNode) => Unit): Self = this.set("addChild", js.Any.fromFunction3(value))
    
    @scala.inline
    def setAddContainer(value: (String, Component[js.Object, js.Object, _]) => Unit): Self = this.set("addContainer", js.Any.fromFunction2(value))
    
    @scala.inline
    def setClearChild(value: (String, String) => Unit): Self = this.set("clearChild", js.Any.fromFunction2(value))
    
    @scala.inline
    def setRegister(value: (String, ReactNode) => String): Self = this.set("register", js.Any.fromFunction2(value))
