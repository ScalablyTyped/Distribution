...
object jsExtrasMod {
  ...
  object default {
    ...
    @JSImport("refractor/lang/js-extras", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("refractor/lang/js-extras", "default.aliases")
    @js.native
    val aliases: js.Array[Any] = js.native
    
    @JSImport("refractor/lang/js-extras", "default.displayName")
    @js.native
