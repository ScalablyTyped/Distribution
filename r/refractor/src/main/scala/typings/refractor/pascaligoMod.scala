...
object pascaligoMod {
  ...
  object default {
    ...
    @JSImport("refractor/lang/pascaligo", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("refractor/lang/pascaligo", "default.aliases")
    @js.native
    val aliases: js.Array[Any] = js.native
    
    @JSImport("refractor/lang/pascaligo", "default.displayName")
    @js.native
