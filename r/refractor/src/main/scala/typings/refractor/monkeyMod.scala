...
object monkeyMod extends Shortcut {
  
  @JSImport("refractor/lang/monkey", JSImport.Namespace)
  @js.native
  val ^ : RefractorSyntax = js.native
  
  type _To = RefractorSyntax
  
  /* This means you don't have to write `^`, but can instead just say `monkeyMod.foo` */
