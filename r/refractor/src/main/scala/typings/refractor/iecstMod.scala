...
object iecstMod extends Shortcut {
  
  @JSImport("refractor/lang/iecst", JSImport.Namespace)
  @js.native
  val ^ : RefractorSyntax = js.native
  
  type _To = RefractorSyntax
  
  /* This means you don't have to write `^`, but can instead just say `iecstMod.foo` */
