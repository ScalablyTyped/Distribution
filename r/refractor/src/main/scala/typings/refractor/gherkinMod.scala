...
object gherkinMod extends Shortcut {
  
  @JSImport("refractor/lang/gherkin", JSImport.Namespace)
  @js.native
  val ^ : RefractorSyntax = js.native
  
  type _To = RefractorSyntax
  
  /* This means you don't have to write `^`, but can instead just say `gherkinMod.foo` */
