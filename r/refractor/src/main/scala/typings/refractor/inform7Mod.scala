...
object inform7Mod extends Shortcut {
  
  @JSImport("refractor/lang/inform7", JSImport.Namespace)
  @js.native
  val ^ : RefractorSyntax = js.native
  
  type _To = RefractorSyntax
  
  /* This means you don't have to write `^`, but can instead just say `inform7Mod.foo` */
