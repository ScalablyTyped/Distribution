...
object goModuleMod {
  ...
  object default {
    ...
    @JSImport("refractor/lang/go-module", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("refractor/lang/go-module", "default.aliases")
    @js.native
    val aliases: js.Array[String] = js.native
    
    @JSImport("refractor/lang/go-module", "default.displayName")
    @js.native
