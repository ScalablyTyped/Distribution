...
object dataweaveMod {
  ...
  object default {
    ...
    @JSImport("refractor/lang/dataweave", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("refractor/lang/dataweave", "default.aliases")
    @js.native
    val aliases: js.Array[Any] = js.native
    
    @JSImport("refractor/lang/dataweave", "default.displayName")
    @js.native
