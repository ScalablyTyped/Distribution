...
object handlebarsMod {
  ...
  object default {
    ...
    @JSImport("refractor/lang/handlebars", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("refractor/lang/handlebars", "default.aliases")
    @js.native
    val aliases: js.Array[String] = js.native
    
    @JSImport("refractor/lang/handlebars", "default.displayName")
    @js.native
