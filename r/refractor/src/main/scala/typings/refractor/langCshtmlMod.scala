...
object langCshtmlMod {
  
  object default {
    
    inline def apply(Prism: Any): Unit = ^.asInstanceOf[js.Dynamic].apply(Prism.asInstanceOf[js.Any]).asInstanceOf[Unit]
    
    @JSImport("refractor/lang/cshtml", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("refractor/lang/cshtml", "default.aliases")
    @js.native
    val aliases: js.Array[String] = js.native
    
    @JSImport("refractor/lang/cshtml", "default.displayName")
    @js.native
