...
object propertiesMod {
  ...
  object default {
    ...
    @JSImport("refractor/lang/properties", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("refractor/lang/properties", "default.aliases")
    @js.native
    val aliases: js.Array[Any] = js.native
    
    @JSImport("refractor/lang/properties", "default.displayName")
    @js.native
