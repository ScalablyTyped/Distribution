...
object purebasicMod {
  ...
  object default {
    ...
    @JSImport("refractor/lang/purebasic", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("refractor/lang/purebasic", "default.aliases")
    @js.native
    val aliases: js.Array[String] = js.native
    
    @JSImport("refractor/lang/purebasic", "default.displayName")
    @js.native
