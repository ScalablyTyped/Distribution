...
object maxscriptMod {
  ...
  object default {
    ...
    @JSImport("refractor/lang/maxscript", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("refractor/lang/maxscript", "default.aliases")
    @js.native
    val aliases: js.Array[Any] = js.native
    
    @JSImport("refractor/lang/maxscript", "default.displayName")
    @js.native
