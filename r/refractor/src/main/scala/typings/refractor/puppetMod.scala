...
object puppetMod extends Shortcut {
  
  @JSImport("refractor/lang/puppet", JSImport.Namespace)
  @js.native
  val ^ : RefractorSyntax = js.native
  
  type _To = RefractorSyntax
  
  /* This means you don't have to write `^`, but can instead just say `puppetMod.foo` */
