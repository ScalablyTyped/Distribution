...
trait DraggableProps extends js.Object {
  ...
  def children(arg: State with reactDashDragtasticLib.Anon_Events): reactLib.reactMod.ReactNode
}

object DraggableProps {
  @scala.inline
  def apply(
    children: State with reactDashDragtasticLib.Anon_Events => reactLib.reactMod.ReactNode,
    data: js.Any = null,
