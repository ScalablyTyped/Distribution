...
object withNativeAdMod {
  ...
  trait NativeAdWrapperProps
    ...
    var adsManager: js.UndefOr[typings.reactNativeAdManager.nativeAdsManagerMod.^] = js.undefined
  ...
  object NativeAdWrapperProps {
    ...
    extension [Self <: NativeAdWrapperProps](x: Self) {
      ...
      inline def setAdsManager(value: typings.reactNativeAdManager.nativeAdsManagerMod.^): Self = StObject.set(x, "adsManager", value.asInstanceOf[js.Any])
