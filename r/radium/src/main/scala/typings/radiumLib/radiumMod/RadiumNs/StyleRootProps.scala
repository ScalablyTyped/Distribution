...
trait StyleRootProps
  extends reactLib.reactMod.HTMLProps[StyleRoot] {
  var radiumConfig: js.UndefOr[RadiumConfig] = js.undefined
}

object StyleRootProps {
  @scala.inline
  def apply(HTMLProps: reactLib.reactMod.HTMLProps[StyleRoot] = null, radiumConfig: RadiumConfig = null): StyleRootProps = {
