...
- Dropped {[ P in keyof recharts.recharts.PresentationAttributes<number, number> ]:? recharts.recharts.PresentationAttributes<number, number>[P]} */ trait CartesianGridProps extends js.Object {
  ...
  var horizontal: js.UndefOr[
    js.Object | reactLib.reactMod.ReactElement | (ContentRenderer[LineProps with CartesianGridProps]) | scala.Boolean
  ] = js.undefined
...
object CartesianGridProps {
  ...
  def apply(
    ...
    horizontal: js.Object | reactLib.reactMod.ReactElement | (ContentRenderer[LineProps with CartesianGridProps]) | scala.Boolean = null,
    ...
    vertical: js.Object | reactLib.reactMod.ReactElement | (ContentRenderer[LineProps with CartesianGridProps]) | scala.Boolean = null,
