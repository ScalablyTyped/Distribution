...
- Dropped {[ P in keyof recharts.recharts.PresentationAttributes<number, number> ]:? recharts.recharts.PresentationAttributes<number, number>[P]} */ trait PieProps
  ...
  var label: js.UndefOr[
    rechartsLib.Anon_OffsetRadius | reactLib.reactMod.ReactElement | ContentRenderer[PieLabelRenderProps] | scala.Boolean
  ] = js.undefined
  var labelLine: js.UndefOr[
    js.Object | (ContentRenderer[LineProps with js.Any]) | reactLib.reactMod.ReactElement | scala.Boolean
  ] = js.undefined
