...
- Dropped {[ P in keyof recharts.recharts.PresentationAttributes<number, number> ]:? recharts.recharts.PresentationAttributes<number, number>[P]} */ trait LineProps
  ...
  var activeDot: js.UndefOr[
    js.Object | reactLib.reactMod.ReactNs.ReactElement | ContentRenderer[_] | scala.Boolean
  ] = js.undefined
  ...
  var dataKey: DataKey
  var dot: js.UndefOr[
    js.Object | reactLib.reactMod.ReactNs.ReactElement | ContentRenderer[DotProps] | scala.Boolean
  ] = js.undefined
