...
object PieLabelRenderProps {
  ...
  def apply(
    ...
    label: rechartsLib.Anon_OffsetRadius | reactLib.reactMod.ReactElement | ContentRenderer[PieLabelRenderProps] | scala.Boolean = null,
    labelLine: js.Object | (ContentRenderer[LineProps with js.Any]) | reactLib.reactMod.ReactElement | scala.Boolean = null,
