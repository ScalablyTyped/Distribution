...
object TooltipProps {
  ...
  def apply(
    ...
    content: reactLib.reactMod.ReactNs.ReactElement[_] | reactLib.reactMod.ReactNs.StatelessComponent[_] | ContentRenderer[TooltipProps] = null,
    coordinate: Coordinate = null,
    cursor: scala.Boolean | js.Object | reactLib.reactMod.ReactNs.ReactElement[_] | reactLib.reactMod.ReactNs.StatelessComponent[_] = null,
