...
@js.native
trait EventAttributesPartialPreAlignmentBaseline extends StObject {
...
object EventAttributesPartialPreAlignmentBaseline {
  ...
  @scala.inline
  def apply(x1: Double, x2: Double, y1: Double, y2: Double): EventAttributesPartialPreAlignmentBaseline = {
    val __obj = js.Dynamic.literal(x1 = x1.asInstanceOf[js.Any], x2 = x2.asInstanceOf[js.Any], y1 = y1.asInstanceOf[js.Any], y2 = y2.asInstanceOf[js.Any])
    __obj.asInstanceOf[EventAttributesPartialPreAlignmentBaseline]
  }
  
  @scala.inline
  implicit class EventAttributesPartialPreAlignmentBaselineMutableBuilder[Self <: EventAttributesPartialPreAlignmentBaseline] (val x: Self) extends AnyVal {
