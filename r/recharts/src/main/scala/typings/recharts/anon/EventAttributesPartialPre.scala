...
/* Inlined recharts.recharts.EventAttributes & std.Partial<recharts.recharts.PresentationAttributes<number | string, number | string>> & {  cx :number,   cy :number} */
@js.native
trait EventAttributesPartialPre extends StObject {
...
object EventAttributesPartialPre {
  
  @scala.inline
  def apply(cx: Double, cy: Double): EventAttributesPartialPre = {
    val __obj = js.Dynamic.literal(cx = cx.asInstanceOf[js.Any], cy = cy.asInstanceOf[js.Any])
    __obj.asInstanceOf[EventAttributesPartialPre]
  }
  
  @scala.inline
  implicit class EventAttributesPartialPreMutableBuilder[Self <: EventAttributesPartialPre] (val x: Self) extends AnyVal {
