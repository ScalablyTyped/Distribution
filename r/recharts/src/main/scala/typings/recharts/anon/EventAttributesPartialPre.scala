...
object EventAttributesPartialPre {
  ...
  inline def apply(cx: Double, cy: Double): EventAttributesPartialPre = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EventAttributesPartialPre] (val x: Self) extends AnyVal {
