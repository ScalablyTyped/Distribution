...
object ScatterProps {
  ...
  extension [Self <: ScatterProps](x: Self) {
    ...
    inline def setActiveShape(value: js.Object | RechartsFunction | ReactElement): Self = StObject.set(x, "activeShape", value.asInstanceOf[js.Any])
    ...
    inline def setLine(value: Boolean | js.Object | RechartsFunction | ReactElement): Self = StObject.set(x, "line", value.asInstanceOf[js.Any])
