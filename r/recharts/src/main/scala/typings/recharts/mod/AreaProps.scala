...
object AreaProps {
  ...
  extension [Self <: AreaProps](x: Self) {
    ...
    inline def setDot(value: Boolean | js.Object | ReactElement | ContentRenderer[DotPropspayloadany]): Self = StObject.set(x, "dot", value.asInstanceOf[js.Any])
    
    inline def setDotFunction1(value: DotPropspayloadany => ReactNode): Self = StObject.set(x, "dot", js.Any.fromFunction1(value))
