...
object SymbolsProps {
  ...
  @scala.inline
  implicit class SymbolsPropsOps[Self <: SymbolsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSizeType(value: area | diameter): Self = this.set("sizeType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setType(value: circle | cross | diamond | square | star | triangle | wye): Self = this.set("type", value.asInstanceOf[js.Any])
