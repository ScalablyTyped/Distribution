...
trait SymbolsProps extends StObject {
  ...
  var sizeType: js.UndefOr[area | diameter] = js.native
  ...
  var `type`: js.UndefOr[circle | cross | diamond | square | star | triangle | wye] = js.native
...
object SymbolsProps {
  ...
  @scala.inline
  def apply(): SymbolsProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SymbolsProps]
  }
  
  @scala.inline
  implicit class SymbolsPropsMutableBuilder[Self <: SymbolsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSizeType(value: area | diameter): Self = StObject.set(x, "sizeType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setType(value: circle | cross | diamond | square | star | triangle | wye): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
