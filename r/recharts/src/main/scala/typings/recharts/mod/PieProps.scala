...
object PieProps {
  ...
  inline def apply(dataKey: DataKey): PieProps = {
  ...
  extension [Self <: PieProps](x: Self) {
    ...
    inline def setLabel(value: OffsetRadius | ReactElement | ContentRenderer[PieLabelRenderProps] | Boolean): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    inline def setMidAngle(value: Double): Self = StObject.set(x, "midAngle", value.asInstanceOf[js.Any])
    
    inline def setMidAngleUndefined: Self = StObject.set(x, "midAngle", js.undefined)
    ...
    inline def setPaddingAngle(value: Double): Self = StObject.set(x, "paddingAngle", value.asInstanceOf[js.Any])
    
    inline def setPaddingAngleUndefined: Self = StObject.set(x, "paddingAngle", js.undefined)
    ...
    inline def setSectors(value: js.Array[js.Object]): Self = StObject.set(x, "sectors", value.asInstanceOf[js.Any])
