...
object PieProps {
  ...
  implicit class PiePropsMutableBuilder[Self <: PieProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelFunction1(value: PieLabelRenderProps => ReactNode): Self = StObject.set(x, "label", js.Any.fromFunction1(value))
    
    @scala.inline
    def setLabelLine(value: js.Object | (ContentRenderer[LineProps & js.Any]) | ReactElement | Boolean): Self = StObject.set(x, "labelLine", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelLineFunction1(value: LineProps & js.Any => ReactNode): Self = StObject.set(x, "labelLine", js.Any.fromFunction1(value))
