...
- typings.recharts.mod.EventAttributes because var conflicts: onClick, onMouseDown, onMouseEnter, onMouseLeave, onMouseMove, onMouseUp. Inlined onMouseOver, onMouseOut, onTouchEnd, onTouchMove, onTouchStart, onTouchCancel */ trait ComposedChartProps
  extends StObject
...
object ComposedChartProps {
  ...
  @scala.inline
  def apply(): ComposedChartProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ComposedChartProps]
  }
  
  @scala.inline
  implicit class ComposedChartPropsMutableBuilder[Self <: ComposedChartProps] (val x: Self) extends AnyVal {
