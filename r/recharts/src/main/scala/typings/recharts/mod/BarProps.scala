...
object BarProps {
  ...
  implicit class BarPropsOps[Self <: BarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabel(value: Boolean | Label | LabelProps | SFC[LabelProps] | ReactElement | ContentRenderer[_]): Self = this.set("label", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setShapeFunction1(value: RectangleProps => ReactNode): Self = this.set("shape", js.Any.fromFunction1(value))
    
    @scala.inline
    def setShape(value: ReactElement | ContentRenderer[RectangleProps]): Self = this.set("shape", value.asInstanceOf[js.Any])
