...
trait BarProps extends StObject {
  ...
  var data: js.UndefOr[js.Array[BarData]] = js.native
  ...
  var shape: js.UndefOr[ReactElement | ContentRenderer[RectangleProps]] = js.native
...
object BarProps {
  ...
  @scala.inline
  def apply(dataKey: DataKey): BarProps = {
  ...
  implicit class BarPropsMutableBuilder[Self <: BarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabel(value: Boolean | Label | LabelProps | SFC[LabelProps] | ReactElement | ContentRenderer[_]): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setShape(value: ReactElement | ContentRenderer[RectangleProps]): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShapeFunction1(value: RectangleProps => ReactNode): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
