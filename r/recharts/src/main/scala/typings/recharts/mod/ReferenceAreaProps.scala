...
trait ReferenceAreaProps extends StObject {
  ...
  var shape: js.UndefOr[(ContentRenderer[ReferenceAreaProps & RectangleProps]) | ReactElement] = js.undefined
...
object ReferenceAreaProps {
  ...
  inline def apply(): ReferenceAreaProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReferenceAreaProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ReferenceAreaProps] (val x: Self) extends AnyVal {
    ...
    inline def setShape(value: (ContentRenderer[ReferenceAreaProps & RectangleProps]) | ReactElement): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    inline def setShapeFunction1(value: ReferenceAreaProps & RectangleProps => ReactNode): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
