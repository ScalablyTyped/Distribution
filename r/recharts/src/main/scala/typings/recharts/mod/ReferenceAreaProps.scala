...
object ReferenceAreaProps {
  ...
  @scala.inline
  def apply(): ReferenceAreaProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReferenceAreaProps]
  }
  
  @scala.inline
  implicit class ReferenceAreaPropsMutableBuilder[Self <: ReferenceAreaProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShape(value: (ContentRenderer[ReferenceAreaProps & RectangleProps]) | ReactElement): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShapeFunction1(value: ReferenceAreaProps & RectangleProps => ReactNode): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
