...
@js.native
trait ReferenceAreaProps extends js.Object {
  ...
  var shape: js.UndefOr[(ContentRenderer[ReferenceAreaProps with RectangleProps]) | ReactElement] = js.native
...
object ReferenceAreaProps {
  ...
  @scala.inline
  implicit class ReferenceAreaPropsOps[Self <: ReferenceAreaProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShapeFunction1(value: ReferenceAreaProps with RectangleProps => ReactNode): Self = this.set("shape", js.Any.fromFunction1(value))
    
    @scala.inline
    def setShape(value: (ContentRenderer[ReferenceAreaProps with RectangleProps]) | ReactElement): Self = this.set("shape", value.asInstanceOf[js.Any])
