...
trait RadarProps extends StObject {
  ...
  var label: js.UndefOr[js.Object | ReactElement | ContentRenderer[_] | Boolean] = js.native
  ...
  var points: js.UndefOr[js.Array[RadarPoint]] = js.native
  
  var r: js.UndefOr[Double] = js.native
  
  var shape: js.UndefOr[ReactElement | ContentRenderer[RadarProps]] = js.native
...
object RadarProps {
  ...
  @scala.inline
  def apply(dataKey: DataKey): RadarProps = {
    val __obj = js.Dynamic.literal(dataKey = dataKey.asInstanceOf[js.Any])
    __obj.asInstanceOf[RadarProps]
  }
  
  @scala.inline
  implicit class RadarPropsMutableBuilder[Self <: RadarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDot(value: js.Object | ReactElement | ContentRenderer[DotProps] | Boolean): Self = StObject.set(x, "dot", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDotFunction1(value: DotProps => ReactNode): Self = StObject.set(x, "dot", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setLabel(value: js.Object | ReactElement | ContentRenderer[_] | Boolean): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPoints(value: js.Array[RadarPoint]): Self = StObject.set(x, "points", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPointsUndefined: Self = StObject.set(x, "points", js.undefined)
    
    @scala.inline
    def setPointsVarargs(value: RadarPoint*): Self = StObject.set(x, "points", js.Array(value :_*))
    ...
    @scala.inline
    def setShape(value: ReactElement | ContentRenderer[RadarProps]): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShapeFunction1(value: RadarProps => ReactNode): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
