...
object RadarProps {
  ...
  implicit class RadarPropsMutableBuilder[Self <: RadarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActiveDot(value: js.Object | ReactElement | ContentRenderer[js.Any] | Boolean): Self = StObject.set(x, "activeDot", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabel(value: js.Object | ReactElement | ContentRenderer[js.Any] | Boolean): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
