...
object RadarProps {
  ...
  implicit open class MutableBuilder[Self <: RadarProps] (val x: Self) extends AnyVal {
    ...
    inline def setDot(value: js.Object | ReactElement | ContentRenderer[DotProps] | Boolean): Self = StObject.set(x, "dot", value.asInstanceOf[js.Any])
    
    inline def setDotFunction1(value: DotProps => ReactNode): Self = StObject.set(x, "dot", js.Any.fromFunction1(value))
    ...
    inline def setShape(value: ReactElement | ContentRenderer[RadarProps]): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    inline def setShapeFunction1(value: RadarProps => ReactNode): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
