...
object RadarProps {
  ...
  @scala.inline
  implicit class RadarPropsOps[Self <: RadarProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDotFunction1(value: DotProps => ReactNode): Self = this.set("dot", js.Any.fromFunction1(value))
    @scala.inline
    def setDot(value: js.Object | ReactElement | ContentRenderer[DotProps] | Boolean): Self = this.set("dot", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLabel(value: js.Object | ReactElement | ContentRenderer[_] | Boolean): Self = this.set("label", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPointsVarargs(value: RadarPoint*): Self = this.set("points", js.Array(value :_*))
    @scala.inline
    def setPoints(value: js.Array[RadarPoint]): Self = this.set("points", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setShapeFunction1(value: RadarProps => ReactNode): Self = this.set("shape", js.Any.fromFunction1(value))
    @scala.inline
    def setShape(value: ReactElement | ContentRenderer[RadarProps]): Self = this.set("shape", value.asInstanceOf[js.Any])
    @scala.inline
