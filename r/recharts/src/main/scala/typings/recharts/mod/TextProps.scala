...
object TextProps {
  ...
  implicit class TextPropsOps[Self <: TextProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCapHeight(value: String): Self = this.set("capHeight", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setScaleToFit(value: Boolean): Self = this.set("scaleToFit", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteScaleToFit: Self = this.set("scaleToFit", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setTextAnchor(value: start | middle | end | inherit): Self = this.set("textAnchor", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setVerticalAnchor(value: start | middle | end): Self = this.set("verticalAnchor", value.asInstanceOf[js.Any])
    @scala.inline
