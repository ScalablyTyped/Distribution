...
trait TextProps extends StObject {
  ...
  var capHeight: js.UndefOr[String] = js.native
  ...
  var scaleToFit: js.UndefOr[Boolean] = js.native
  ...
  var textAnchor: js.UndefOr[start | middle | end | inherit] = js.native
  ...
  var verticalAnchor: js.UndefOr[start | middle | end] = js.native
...
object TextProps {
  ...
  implicit class TextPropsMutableBuilder[Self <: TextProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCapHeight(value: String): Self = StObject.set(x, "capHeight", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setScaleToFit(value: Boolean): Self = StObject.set(x, "scaleToFit", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setScaleToFitUndefined: Self = StObject.set(x, "scaleToFit", js.undefined)
    ...
    @scala.inline
    def setTextAnchor(value: start | middle | end | inherit): Self = StObject.set(x, "textAnchor", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVerticalAnchor(value: start | middle | end): Self = StObject.set(x, "verticalAnchor", value.asInstanceOf[js.Any])
