...
object ReferenceLineProps {
  ...
  @scala.inline
  implicit class ReferenceLinePropsMutableBuilder[Self <: ReferenceLineProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClassName(value: Double | String): Self = StObject.set(x, "className", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIfOverflow(value: IfOverflowType): Self = StObject.set(x, "ifOverflow", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIfOverflowUndefined: Self = StObject.set(x, "ifOverflow", js.undefined)
    ...
    @scala.inline
    def setIsFront(value: Boolean): Self = StObject.set(x, "isFront", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIsFrontUndefined: Self = StObject.set(x, "isFront", js.undefined)
    ...
    @scala.inline
    def setPosition(value: ReferenceLinePosition): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSegment(value: js.Tuple2[SegmentItem, SegmentItem]): Self = StObject.set(x, "segment", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSegmentUndefined: Self = StObject.set(x, "segment", js.undefined)
    
    @scala.inline
    def setShape(value: ContentRenderer[EventAttributesPartialPreAlignmentBaseline] | ReactElement): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShapeFunction1(value: EventAttributesPartialPreAlignmentBaseline => ReactNode): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
