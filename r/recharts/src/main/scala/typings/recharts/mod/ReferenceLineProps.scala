...
import typings.recharts.anon.EventAttributesPartialPreAlignmentBaseline
...
object ReferenceLineProps {
  @scala.inline
  def apply(): ReferenceLineProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReferenceLineProps]
  }
  @scala.inline
  implicit class ReferenceLinePropsOps[Self <: ReferenceLineProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setClassName(value: Double | String): Self = this.set("className", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setIfOverflow(value: IfOverflowType): Self = this.set("ifOverflow", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIfOverflow: Self = this.set("ifOverflow", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setIsFront(value: Boolean): Self = this.set("isFront", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIsFront: Self = this.set("isFront", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setLabel(value: String | Double | ContentRenderer[_] | ReactElement): Self = this.set("label", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPosition(value: ReferenceLinePosition): Self = this.set("position", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSegment(value: js.Tuple2[SegmentItem, SegmentItem]): Self = this.set("segment", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSegment: Self = this.set("segment", js.undefined)
    @scala.inline
    def setShapeFunction1(value: EventAttributesPartialPreAlignmentBaseline => ReactNode): Self = this.set("shape", js.Any.fromFunction1(value))
    @scala.inline
    def setShape(value: ContentRenderer[EventAttributesPartialPreAlignmentBaseline] | ReactElement): Self = this.set("shape", value.asInstanceOf[js.Any])
    @scala.inline
