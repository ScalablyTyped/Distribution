...
object ReferenceLineProps {
  ...
  implicit open class MutableBuilder[Self <: ReferenceLineProps] (val x: Self) extends AnyVal {
    ...
    inline def setShape(value: ContentRenderer[EventAttributesPartialPreAlignmentBaseline] | ReactElement): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    inline def setShapeFunction1(value: EventAttributesPartialPreAlignmentBaseline => ReactNode): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
