...
- typings.recharts.mod.EventAttributes because var conflicts: onClick, onMouseDown, onMouseEnter, onMouseLeave, onMouseMove, onMouseUp. Inlined onMouseOver, onMouseOut, onTouchEnd, onTouchMove, onTouchStart, onTouchCancel */ trait BarChartProps
  extends StObject
...
object BarChartProps {
  ...
  inline def apply(): BarChartProps = {
