...
object RadialBarProps {
  ...
  @scala.inline
  implicit class RadialBarPropsMutableBuilder[Self <: RadialBarProps] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setActiveShape(value: js.Object | ContentRenderer[js.Any] | ReactElement): Self = StObject.set(x, "activeShape", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setActiveShapeFunction1(value: js.Any => ReactNode): Self = StObject.set(x, "activeShape", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setBackground(value: Boolean | ReactElement | ContentRenderer[js.Any] | js.Object): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBackgroundFunction1(value: js.Any => ReactNode): Self = StObject.set(x, "background", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setData(value: js.Array[RadialBarData]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDataVarargs(value: RadialBarData*): Self = StObject.set(x, "data", js.Array(value :_*))
    ...
    @scala.inline
    def setLabel(value: Boolean | ReactElement | ContentRenderer[js.Any] | js.Object): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinPointSize(value: Double): Self = StObject.set(x, "minPointSize", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRadiusAxisId(value: String | Double): Self = StObject.set(x, "radiusAxisId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRadiusAxisIdUndefined: Self = StObject.set(x, "radiusAxisId", js.undefined)
    
    @scala.inline
    def setShape(value: ContentRenderer[js.Any] | ReactElement): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShapeFunction1(value: js.Any => ReactNode): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
