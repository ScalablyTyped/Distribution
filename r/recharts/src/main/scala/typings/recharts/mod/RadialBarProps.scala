...
object RadialBarProps {
  ...
  implicit class RadialBarPropsOps[Self <: RadialBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActiveShapeFunction1(value: _ => ReactNode): Self = this.set("activeShape", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setBackgroundFunction1(value: _ => ReactNode): Self = this.set("background", js.Any.fromFunction1(value))
    @scala.inline
    def setBackground(value: Boolean | ReactElement | ContentRenderer[_] | js.Object): Self = this.set("background", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDataVarargs(value: RadialBarData*): Self = this.set("data", js.Array(value :_*))
    @scala.inline
    def setData(value: js.Array[RadialBarData]): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLabel(value: Boolean | ReactElement | ContentRenderer[_] | js.Object): Self = this.set("label", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMinPointSize(value: Double): Self = this.set("minPointSize", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRadiusAxisId(value: String | Double): Self = this.set("radiusAxisId", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRadiusAxisId: Self = this.set("radiusAxisId", js.undefined)
    @scala.inline
    def setShapeFunction1(value: _ => ReactNode): Self = this.set("shape", js.Any.fromFunction1(value))
    @scala.inline
    def setShape(value: ContentRenderer[_] | ReactElement): Self = this.set("shape", value.asInstanceOf[js.Any])
    @scala.inline
