...
object RadialBarProps {
  ...
  implicit class RadialBarPropsMutableBuilder[Self <: RadialBarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActiveShapeFunction1(value: _ => ReactNode): Self = StObject.set(x, "activeShape", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setBackground(value: Boolean | ReactElement | ContentRenderer[_] | js.Object): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBackgroundFunction1(value: _ => ReactNode): Self = StObject.set(x, "background", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setLabel(value: Boolean | ReactElement | ContentRenderer[_] | js.Object): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setShape(value: ContentRenderer[_] | ReactElement): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
