...
object RadialBarProps {
  ...
  inline def apply(dataKey: DataKey): RadialBarProps = {
  ...
  implicit open class MutableBuilder[Self <: RadialBarProps] (val x: Self) extends AnyVal {
    ...
    inline def setAngleAxisId(value: String | Double): Self = StObject.set(x, "angleAxisId", value.asInstanceOf[js.Any])
    
    inline def setAngleAxisIdUndefined: Self = StObject.set(x, "angleAxisId", js.undefined)
    ...
    inline def setData(value: js.Array[RadialBarData]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
