...
import typings.recharts.anon.Links
...
trait SankeyProps extends StObject {
  ...
  var link: js.UndefOr[js.Object | ContentRenderer[Any] | ReactElement] = js.undefined
  ...
  var node: js.UndefOr[js.Object | ContentRenderer[Any] | ReactElement] = js.undefined
...
object SankeyProps {
  ...
  extension [Self <: SankeyProps](x: Self) {
    ...
    inline def setLink(value: js.Object | ContentRenderer[Any] | ReactElement): Self = StObject.set(x, "link", value.asInstanceOf[js.Any])
    ...
    inline def setLinkFunction1(value: Any => ReactNode): Self = StObject.set(x, "link", js.Any.fromFunction1(value))
    ...
    inline def setNode(value: js.Object | ContentRenderer[Any] | ReactElement): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
    
    inline def setNodeFunction1(value: Any => ReactNode): Self = StObject.set(x, "node", js.Any.fromFunction1(value))
