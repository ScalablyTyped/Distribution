...
@js.native
trait ReferenceDotProps extends js.Object {
...
object ReferenceDotProps {
  ...
  @scala.inline
  implicit class ReferenceDotPropsOps[Self <: ReferenceDotProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelFunction1(value: /* repeated */ js.Any => Unit): Self = this.set("label", js.Any.fromFunction1(value))
    
    @scala.inline
    def setLabel(value: String | Double | ReactElement | RechartsFunction): Self = this.set("label", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setShapeFunction1(value: EventAttributesPartialPre => ReactNode): Self = this.set("shape", js.Any.fromFunction1(value))
    
    @scala.inline
    def setShape(value: ContentRenderer[EventAttributesPartialPre] | ReactElement): Self = this.set("shape", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setXAxis(value: ReferenceDotAxisConfiguration): Self = this.set("xAxis", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setYAxis(value: ReferenceDotAxisConfiguration): Self = this.set("yAxis", value.asInstanceOf[js.Any])
