...
object ReferenceDotProps {
  ...
  inline def apply(): ReferenceDotProps = {
  ...
  extension [Self <: ReferenceDotProps](x: Self) {
    ...
    inline def setLabel(value: String | Double | ReactElement | RechartsFunction): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    inline def setShape(value: ContentRenderer[EventAttributesPartialPre] | ReactElement): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    inline def setShapeFunction1(value: EventAttributesPartialPre => ReactNode): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
    ...
    inline def setXAxis(value: ReferenceDotAxisConfiguration): Self = StObject.set(x, "xAxis", value.asInstanceOf[js.Any])
    ...
    inline def setYAxis(value: ReferenceDotAxisConfiguration): Self = StObject.set(x, "yAxis", value.asInstanceOf[js.Any])
