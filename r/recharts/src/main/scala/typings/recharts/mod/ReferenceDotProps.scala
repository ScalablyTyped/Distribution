...
@js.native
trait ReferenceDotProps extends StObject {
  ...
  var label: js.UndefOr[String | Double | ReactElement | RechartsFunction] = js.native
  ...
  var shape: js.UndefOr[ContentRenderer[EventAttributesPartialPre] | ReactElement] = js.native
  ...
  var xAxis: js.UndefOr[ReferenceDotAxisConfiguration] = js.native
  
  var xAxisId: js.UndefOr[String | Double] = js.native
  
  var y: js.UndefOr[Double | String] = js.native
  
  var yAxis: js.UndefOr[ReferenceDotAxisConfiguration] = js.native
...
object ReferenceDotProps {
  ...
  @scala.inline
  def apply(): ReferenceDotProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReferenceDotProps]
  }
  
  @scala.inline
  implicit class ReferenceDotPropsMutableBuilder[Self <: ReferenceDotProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabel(value: String | Double | ReactElement | RechartsFunction): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelFunction1(value: /* repeated */ js.Any => Unit): Self = StObject.set(x, "label", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setShape(value: ContentRenderer[EventAttributesPartialPre] | ReactElement): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShapeFunction1(value: EventAttributesPartialPre => ReactNode): Self = StObject.set(x, "shape", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setXAxis(value: ReferenceDotAxisConfiguration): Self = StObject.set(x, "xAxis", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setYAxis(value: ReferenceDotAxisConfiguration): Self = StObject.set(x, "yAxis", value.asInstanceOf[js.Any])
