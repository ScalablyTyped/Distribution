...
@js.native
trait CurveProps extends js.Object {
...
object CurveProps {
  ...
  @scala.inline
  implicit class CurvePropsOps[Self <: CurveProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setPathRefFunction1(value: /* instance */ _ | Null => Unit): Self = this.set("pathRef", js.Any.fromFunction1(value))
    @scala.inline
    def setPathRef(value: Ref[_]): Self = this.set("pathRef", value.asInstanceOf[js.Any])
    @scala.inline
    def deletePathRef: Self = this.set("pathRef", js.undefined)
    @scala.inline
    def setPathRefNull: Self = this.set("pathRef", null)
    @scala.inline
