...
object CurveProps {
  ...
  implicit class CurvePropsMutableBuilder[Self <: CurveProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPathRef(value: Ref[js.Any]): Self = StObject.set(x, "pathRef", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPathRefFunction1(value: /* instance */ js.Any | Null => Unit): Self = StObject.set(x, "pathRef", js.Any.fromFunction1(value))
