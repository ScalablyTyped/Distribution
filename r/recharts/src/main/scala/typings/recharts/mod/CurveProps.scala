...
@js.native
trait CurveProps extends StObject {
  ...
  var pathRef: js.UndefOr[Ref[_]] = js.native
...
object CurveProps {
  ...
  @scala.inline
  def apply(): CurveProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CurveProps]
  }
  
  @scala.inline
  implicit class CurvePropsMutableBuilder[Self <: CurveProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBaseLine(value: Double | js.Array[_]): Self = StObject.set(x, "baseLine", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPathRef(value: Ref[_]): Self = StObject.set(x, "pathRef", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPathRefFunction1(value: /* instance */ _ | Null => Unit): Self = StObject.set(x, "pathRef", js.Any.fromFunction1(value))
    
    @scala.inline
    def setPathRefNull: Self = StObject.set(x, "pathRef", null)
    
    @scala.inline
    def setPathRefUndefined: Self = StObject.set(x, "pathRef", js.undefined)
