...
object CartesianGridProps {
  ...
  inline def apply(): CartesianGridProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CartesianGridProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CartesianGridProps] (val x: Self) extends AnyVal {
    ...
    inline def setHorizontalFill(value: js.Array[String]): Self = StObject.set(x, "horizontalFill", value.asInstanceOf[js.Any])
    ...
    inline def setHorizontalPoints(value: js.Array[Double]): Self = StObject.set(x, "horizontalPoints", value.asInstanceOf[js.Any])
    ...
    inline def setVerticalFill(value: js.Array[String]): Self = StObject.set(x, "verticalFill", value.asInstanceOf[js.Any])
    ...
    inline def setVerticalPoints(value: js.Array[Double]): Self = StObject.set(x, "verticalPoints", value.asInstanceOf[js.Any])
