...
object CartesianGridProps {
  ...
  @scala.inline
  implicit class CartesianGridPropsMutableBuilder[Self <: CartesianGridProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHorizontalCoordinatesGeneratorUndefined: Self = StObject.set(x, "horizontalCoordinatesGenerator", js.undefined)
    
    @scala.inline
    def setHorizontalFill(value: js.Array[String]): Self = StObject.set(x, "horizontalFill", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHorizontalFillUndefined: Self = StObject.set(x, "horizontalFill", js.undefined)
    ...
    @scala.inline
    def setHorizontalPointsUndefined: Self = StObject.set(x, "horizontalPoints", js.undefined)
    
    @scala.inline
    def setHorizontalPointsVarargs(value: Double*): Self = StObject.set(x, "horizontalPoints", js.Array(value :_*))
    ...
    @scala.inline
    def setVerticalCoordinatesGeneratorUndefined: Self = StObject.set(x, "verticalCoordinatesGenerator", js.undefined)
    
    @scala.inline
    def setVerticalFill(value: js.Array[String]): Self = StObject.set(x, "verticalFill", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVerticalPointsUndefined: Self = StObject.set(x, "verticalPoints", js.undefined)
    
    @scala.inline
    def setVerticalPointsVarargs(value: Double*): Self = StObject.set(x, "verticalPoints", js.Array(value :_*))
    ...
    @scala.inline
    def setXAxis(value: XAxisProps): Self = StObject.set(x, "xAxis", value.asInstanceOf[js.Any])
