...
object DateTimePickerProps {
  ...
  def apply(
    ...
    onChange: (/* dates */ js.Array[typings.flatpickr.distTypesGlobalsMod._Global_.Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[js.Any]) => Unit = null,
    onClose: (/* dates */ js.Array[typings.flatpickr.distTypesGlobalsMod._Global_.Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[js.Any]) => Unit = null,
    onDayCreate: (/* dates */ js.Array[typings.flatpickr.distTypesGlobalsMod._Global_.Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[js.Any]) => Unit = null,
    onMonthChange: (/* dates */ js.Array[typings.flatpickr.distTypesGlobalsMod._Global_.Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[js.Any]) => Unit = null,
    onOpen: (/* dates */ js.Array[typings.flatpickr.distTypesGlobalsMod._Global_.Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[js.Any]) => Unit = null,
    onReady: (/* dates */ js.Array[typings.flatpickr.distTypesGlobalsMod._Global_.Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[js.Any]) => Unit = null,
    onValueUpdate: (/* dates */ js.Array[typings.flatpickr.distTypesGlobalsMod._Global_.Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[js.Any]) => Unit = null,
    onYearChange: (/* dates */ js.Array[typings.flatpickr.distTypesGlobalsMod._Global_.Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[js.Any]) => Unit = null,
