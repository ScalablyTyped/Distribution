package typings.reactFlatpickr.anon
...
object OmitDateTimePickerPropsop {
  ...
  implicit class OmitDateTimePickerPropsopOps[Self <: OmitDateTimePickerPropsop] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(
      value: (/* dates */ js.Array[typings.flatpickr.globalsMod.global.Date], /* currentDateString */ String, /* self */ Instance, /* data */ js.UndefOr[js.Any]) => Unit
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[OmitDateTimePickerPropsop, /* ev */ ProgressEvent[EventTarget], _]): Self = this.set("onprogress", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setValueVarargs(value: (String | Date | Double)*): Self = this.set("value", js.Array(value :_*))
    
    @scala.inline
    def setValue(value: String | Date | Double | (js.Array[String | Date | Double])): Self = this.set("value", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteValue: Self = this.set("value", js.undefined)
    
    @scala.inline
    def setValueAsDate(value: Date): Self = this.set("valueAsDate", value.asInstanceOf[js.Any])
