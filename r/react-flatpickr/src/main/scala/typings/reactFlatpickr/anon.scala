  ...
  object OmitDateTimePickerPropsop {
    ...
    extension [Self <: OmitDateTimePickerPropsop](x: Self) {
      ...
      inline def setAddEventListener(
        value: (fullscreenchange, /* listener */ js.ThisFunction1[OmitDateTimePickerPropsop, /* ev */ Event, Any]) => Unit
      ...
      inline def setOnprogress(value: js.ThisFunction1[OmitDateTimePickerPropsop, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
