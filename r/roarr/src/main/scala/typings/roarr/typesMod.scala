...
object typesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.roarr.typesMod.NestedAsyncLocalContext
    - typings.roarr.typesMod.TopLevelAsyncLocalContext
  */
  ...
  object AsyncLocalContext {
    ...
    inline def NestedAsyncLocalContext(
      ...
      __obj.asInstanceOf[typings.roarr.typesMod.NestedAsyncLocalContext]
    }
    ...
    inline def TopLevelAsyncLocalContext(
      ...
      __obj.asInstanceOf[typings.roarr.typesMod.TopLevelAsyncLocalContext]
    }
  }
  ...
  */
  ...
  - typings.roarr.typesMod.AsyncLocalContext because Already inherited */ trait NestedAsyncLocalContext
    extends StObject
