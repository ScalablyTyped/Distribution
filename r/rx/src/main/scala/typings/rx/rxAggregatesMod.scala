...
object rxAggregatesMod {
  ...
  @JSImport("rx.aggregates", "Notification")
  @js.native
  ...
  @JSImport("rx.aggregates", "Observer")
  @js.native
  ...
  object ReactiveTest {
    ...
    @JSImport("rx.aggregates", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx.aggregates", "ReactiveTest.disposed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.aggregates", "ReactiveTest.onCompleted")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.aggregates", "ReactiveTest.onError")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.aggregates", "ReactiveTest.onNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.aggregates", "ReactiveTest.subscribe")
    @js.native
    ...
    @JSImport("rx.aggregates", "ReactiveTest.subscribed")
    @js.native
  ...
  object config {
    ...
    @JSImport("rx.aggregates", "config.Promise")
    @js.native
  ...
  object helpers {
    ...
    @JSImport("rx.aggregates", "helpers.asArray")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.identity")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.isPromise")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.noop")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx.aggregates", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx.aggregates", "helpers.notSupported")
    @js.native
  ...
  object internals {
    ...
    @JSImport("rx.aggregates", "internals.bindCallback")
    @js.native
