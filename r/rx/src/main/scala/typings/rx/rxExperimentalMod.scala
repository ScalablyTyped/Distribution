...
object rxExperimentalMod {
  ...
  @JSImport("rx.experimental", "AnonymousObserver")
  @js.native
  ...
  @JSImport("rx.experimental", "Observable")
  @js.native
  ...
  object ReactiveTest {
    ...
    @JSImport("rx.experimental", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx.experimental", "ReactiveTest.disposed")
    @js.native
  ...
  @JSImport("rx.experimental", "Subject")
  @js.native
  ...
  object helpers {
    ...
    @JSImport("rx.experimental", "helpers")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rx.experimental", "helpers.asArray")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.identity")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.isPromise")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.noop")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx.experimental", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx.experimental", "helpers.notSupported")
    @js.native
  ...
  object internals {
    ...
    @JSImport("rx.experimental", "internals.addProperties")
    @js.native
    ...
    @JSImport("rx.experimental", "internals.addRef")
    @js.native
    ...
    @JSImport("rx.experimental", "internals.bindCallback")
    @js.native
    ...
    @JSImport("rx.experimental", "internals.inherits")
    @js.native
    ...
    @JSImport("rx.experimental", "internals.isEqual")
    @js.native
