...
object SchedulerStatic {
  ...
  extension [Self <: SchedulerStatic](x: Self) {
    
    inline def setAsync(value: IScheduler): Self = StObject.set(x, "async", value.asInstanceOf[js.Any])
    
    inline def setCurrentThread(value: ICurrentThreadScheduler): Self = StObject.set(x, "currentThread", value.asInstanceOf[js.Any])
    
    inline def setDefault(value: IScheduler): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
    
    inline def setImmediate(value: IScheduler): Self = StObject.set(x, "immediate", value.asInstanceOf[js.Any])
    
    inline def setIsScheduler(value: js.Any => Boolean): Self = StObject.set(x, "isScheduler", js.Any.fromFunction1(value))
    
    inline def setNormalize(value: Double => Double): Self = StObject.set(x, "normalize", js.Any.fromFunction1(value))
