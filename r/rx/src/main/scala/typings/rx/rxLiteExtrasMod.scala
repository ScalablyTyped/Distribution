...
object rxLiteExtrasMod {
  
  @JSImport("rx.lite.extras", JSImport.Namespace)
  @js.native
  ...
  object ReactiveTest {
    ...
    @JSImport("rx.lite.extras", "ReactiveTest")
    @js.native
    val ^ : js.Any = js.native
    
    /** Default virtual time used for creation of observable sequences in unit tests. */
    @JSImport("rx.lite.extras", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx.lite.extras", "ReactiveTest.disposed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.lite.extras", "ReactiveTest.onCompleted")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.lite.extras", "ReactiveTest.onError")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.lite.extras", "ReactiveTest.onNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.lite.extras", "ReactiveTest.subscribe")
    @js.native
    ...
    @JSImport("rx.lite.extras", "ReactiveTest.subscribed")
    @js.native
  ...
  @JSImport("rx.lite.extras", "Recorded")
  @js.native
  ...
  @JSImport("rx.lite.extras", "ReplaySubject")
  @js.native
  ...
  @JSImport("rx.lite.extras", "Scheduler")
  @js.native
  ...
  @JSImport("rx.lite.extras", "SingleAssignmentDisposable")
  @js.native
  ...
  @JSImport("rx.lite.extras", "Subject")
  @js.native
  ...
  @JSImport("rx.lite.extras", "Subscription")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("rx.lite.extras", "TestScheduler")
  @js.native
  ...
  object config {
    ...
    @JSImport("rx.lite.extras", "config.Promise")
    @js.native
  ...
  object helpers {
    ...
    @JSImport("rx.lite.extras", "helpers.asArray")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.identity")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.isPromise")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.noop")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx.lite.extras", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx.lite.extras", "helpers.notSupported")
    @js.native
  ...
  object internals {
    ...
    @JSImport("rx.lite.extras", "internals.addRef")
    @js.native
    ...
    @JSImport("rx.lite.extras", "internals.bindCallback")
    @js.native
    ...
    @JSImport("rx.lite.extras", "internals.inherits")
    @js.native
    ...
    @JSImport("rx.lite.extras", "internals.isEqual")
    @js.native
