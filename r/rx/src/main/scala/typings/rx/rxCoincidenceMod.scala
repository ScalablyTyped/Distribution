...
object rxCoincidenceMod {
  
  @JSImport("rx.coincidence", JSImport.Namespace)
  @js.native
  ...
  @JSImport("rx.coincidence", "Observer")
  @js.native
  ...
  object ReactiveTest {
    ...
    @JSImport("rx.coincidence", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx.coincidence", "ReactiveTest.disposed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.coincidence", "ReactiveTest.onCompleted")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.coincidence", "ReactiveTest.onError")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.coincidence", "ReactiveTest.onNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.coincidence", "ReactiveTest.subscribe")
    @js.native
    ...
    @JSImport("rx.coincidence", "ReactiveTest.subscribed")
    @js.native
  ...
  @JSImport("rx.coincidence", "ReplaySubject")
  @js.native
  ...
  @JSImport("rx.coincidence", "Scheduler")
  @js.native
  ...
  @JSImport("rx.coincidence", "SingleAssignmentDisposable")
  @js.native
  ...
  @JSImport("rx.coincidence", "Subject")
  @js.native
  ...
  object config {
    ...
    @JSImport("rx.coincidence", "config.Promise")
    @js.native
  ...
  object helpers {
    ...
    @JSImport("rx.coincidence", "helpers")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rx.coincidence", "helpers.asArray")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.identity")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.isPromise")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.noop")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx.coincidence", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx.coincidence", "helpers.notSupported")
    @js.native
  ...
  object internals {
    ...
    @JSImport("rx.coincidence", "internals.PriorityQueue")
    @js.native
    ...
    @JSImport("rx.coincidence", "internals.addProperties")
    @js.native
    ...
    @JSImport("rx.coincidence", "internals.addRef")
    @js.native
    ...
    @JSImport("rx.coincidence", "internals.bindCallback")
    @js.native
    ...
    @JSImport("rx.coincidence", "internals.inherits")
    @js.native
