...
object rxCoreBindingMod {
  
  @JSImport("rx.core.binding", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("rx.core.binding", "AnonymousObserver")
  @js.native
  ...
  @JSImport("rx.core.binding", "AnonymousSubject")
  @js.native
  ...
  @JSImport("rx.core.binding", "Disposable")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("rx.core.binding", "HistoricalScheduler")
  @js.native
  ...
  @JSImport("rx.core.binding", "Notification")
  @js.native
  ...
  @JSImport("rx.core.binding", "Observable")
  @js.native
  ...
  @JSImport("rx.core.binding", "Observer")
  @js.native
  ...
  object ReactiveTest {
    ...
    @JSImport("rx.core.binding", "ReactiveTest")
    @js.native
    val ^ : js.Any = js.native
    
    /** Default virtual time used for creation of observable sequences in unit tests. */
    @JSImport("rx.core.binding", "ReactiveTest.created")
    @js.native
    ...
    @JSImport("rx.core.binding", "ReactiveTest.disposed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.core.binding", "ReactiveTest.onCompleted")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.core.binding", "ReactiveTest.onError")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.core.binding", "ReactiveTest.onNext")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("rx.core.binding", "ReactiveTest.subscribe")
    @js.native
    ...
    @JSImport("rx.core.binding", "ReactiveTest.subscribed")
    @js.native
  ...
  @JSImport("rx.core.binding", "Recorded")
  @js.native
  ...
  @JSImport("rx.core.binding", "RefCountDisposable")
  @js.native
  ...
  @JSImport("rx.core.binding", "Scheduler")
  @js.native
  ...
  @JSImport("rx.core.binding", "SerialDisposable")
  @js.native
  ...
  @JSImport("rx.core.binding", "SingleAssignmentDisposable")
  @js.native
  ...
  @JSImport("rx.core.binding", "Subscription")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("rx.core.binding", "TestScheduler")
  @js.native
  ...
  object config {
    ...
    @JSImport("rx.core.binding", "config.Promise")
    @js.native
  ...
  object helpers {
    ...
    @JSImport("rx.core.binding", "helpers")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rx.core.binding", "helpers.asArray")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.defaultComparer")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.defaultError")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.defaultKeySerializer")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.defaultNow")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.defaultSubComparer")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.identity")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.isFunction")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.isPromise")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.noop")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.not")
    @js.native
    def not: js.Function1[/* value */ js.Any, Boolean] = js.native
    
    @JSImport("rx.core.binding", "helpers.notDefined")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.notImplemented")
    @js.native
    ...
    @JSImport("rx.core.binding", "helpers.notSupported")
    @js.native
  ...
  object internals {
    ...
    @JSImport("rx.core.binding", "internals")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("rx.core.binding", "internals.AbstractObserver")
    @js.native
    ...
    @JSImport("rx.core.binding", "internals.PriorityQueue")
    @js.native
    ...
    @JSImport("rx.core.binding", "internals.SchedulePeriodicRecursive")
    @js.native
    ...
    @JSImport("rx.core.binding", "internals.addProperties")
    @js.native
    ...
    @JSImport("rx.core.binding", "internals.addRef")
    @js.native
    ...
    @JSImport("rx.core.binding", "internals.bindCallback")
    @js.native
    ...
    @JSImport("rx.core.binding", "internals.inherits")
    @js.native
    ...
    @JSImport("rx.core.binding", "internals.isEqual")
    @js.native
