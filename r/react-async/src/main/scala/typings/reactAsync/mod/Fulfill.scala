...
object Fulfill {
  ...
  @scala.inline
  def apply[T](meta: Dictmeta, payload: T): Fulfill[T] = {
  ...
  @scala.inline
  implicit class FulfillMutableBuilder[Self <: Fulfill[?], T] (val x: Self & Fulfill[T]) extends AnyVal {
    
    @scala.inline
    def setPayload(value: T): Self = StObject.set(x, "payload", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setType(value: fulfill): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
