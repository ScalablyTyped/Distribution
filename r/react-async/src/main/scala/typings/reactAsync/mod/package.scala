...
package object mod {
  ...
  @scala.inline
  def default: typings.reactAsync.mod.GenericAsync = typings.reactAsync.mod.^.asInstanceOf[js.Dynamic].selectDynamic("default").asInstanceOf[typings.reactAsync.mod.GenericAsync]
  ...
  def dispatchMiddleware[T](
    ...
    /* repeated */ js.Any, 
    scala.Unit
  ] = typings.reactAsync.mod.^.asInstanceOf[js.Dynamic].applyDynamic("dispatchMiddleware")(dispatch.asInstanceOf[js.Any]).asInstanceOf[js.Function2[
    /* action */ typings.reactAsync.mod.AsyncAction[T], 
    /* repeated */ js.Any, 
    scala.Unit
  ]]
