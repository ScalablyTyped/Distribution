...
object GlobalScope_ {
  ...
  inline def apply(__REACT_ASYNC__ : js.Any, fetch: FnCall): GlobalScope_ = {
  ...
  extension [Self <: GlobalScope_](x: Self) {
    ...
    inline def set__REACT_ASYNC__(value: js.Any): Self = StObject.set(x, "__REACT_ASYNC__", value.asInstanceOf[js.Any])
  }
}
