...
trait Anon_Fulfilled extends js.Object {
  def Fulfilled[T](props: Anon_Children[T]): Element
  ...
  def Rejected[T](props: Anon_Children[T]): Element
  def Resolved[T](props: Anon_Children[T]): Element
  def Settled[T](props: Anon_Children[T]): Element
}

object Anon_Fulfilled {
  @scala.inline
  def apply(
    Fulfilled: Anon_Children[js.Any] => Element,
    ...
    Rejected: Anon_Children[js.Any] => Element,
    Resolved: Anon_Children[js.Any] => Element,
    Settled: Anon_Children[js.Any] => Element
  ): Anon_Fulfilled = {
