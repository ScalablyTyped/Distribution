...
trait Typeofts extends js.Object {
  ...
  val servicesVersion: rollupDashTypescriptLib.rollupDashTypescriptLibStrings.`0DOT8` = js.native
  ...
  def isIterationStatement_false(
    node: typescriptLib.typescriptMod.Node,
    lookInLabeledStatements: rollupDashTypescriptLib.rollupDashTypescriptLibNumbers.`false`
