...
import typings.virtualKeyboard.mod.CustomLayout
...
object ReactKeyboardOptions {
  ...
  def apply(
    ...
    repeatRate: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(acceptValid)) __obj.updateDynamic("acceptValid")(acceptValid.get.asInstanceOf[js.Any])
    if (accepted != null) __obj.updateDynamic("accepted")(js.Any.fromFunction3(accepted))
    if (!js.isUndefined(alwaysOpen)) __obj.updateDynamic("alwaysOpen")(alwaysOpen.get.asInstanceOf[js.Any])
    if (!js.isUndefined(appendLocally)) __obj.updateDynamic("appendLocally")(appendLocally.get.asInstanceOf[js.Any])
    if (appendTo != null) __obj.updateDynamic("appendTo")(appendTo.asInstanceOf[js.Any])
    if (!js.isUndefined(autoAccept)) __obj.updateDynamic("autoAccept")(autoAccept.get.asInstanceOf[js.Any])
    if (!js.isUndefined(autoAcceptOnEsc)) __obj.updateDynamic("autoAcceptOnEsc")(autoAcceptOnEsc.get.asInstanceOf[js.Any])
    if (!js.isUndefined(autoAcceptOnValid)) __obj.updateDynamic("autoAcceptOnValid")(autoAcceptOnValid.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(cancelClose)) __obj.updateDynamic("cancelClose")(cancelClose.get.asInstanceOf[js.Any])
    if (canceled != null) __obj.updateDynamic("canceled")(js.Any.fromFunction3(canceled))
    if (!js.isUndefined(caretToEnd)) __obj.updateDynamic("caretToEnd")(caretToEnd.get.asInstanceOf[js.Any])
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction3(change))
    if (`class` != null) __obj.updateDynamic("class")(`class`.asInstanceOf[js.Any])
    if (!js.isUndefined(closeByClickEvent)) __obj.updateDynamic("closeByClickEvent")(closeByClickEvent.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enterNavigation)) __obj.updateDynamic("enterNavigation")(enterNavigation.get.asInstanceOf[js.Any])
    if (hidden != null) __obj.updateDynamic("hidden")(js.Any.fromFunction3(hidden))
    if (!js.isUndefined(ignoreEsc)) __obj.updateDynamic("ignoreEsc")(ignoreEsc.get.asInstanceOf[js.Any])
    if (!js.isUndefined(initialFocus)) __obj.updateDynamic("initialFocus")(initialFocus.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(lockInput)) __obj.updateDynamic("lockInput")(lockInput.get.asInstanceOf[js.Any])
    if (!js.isUndefined(maxInsert)) __obj.updateDynamic("maxInsert")(maxInsert.get.asInstanceOf[js.Any])
    if (maxLength != null) __obj.updateDynamic("maxLength")(maxLength.asInstanceOf[js.Any])
    if (!js.isUndefined(noFocus)) __obj.updateDynamic("noFocus")(noFocus.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(repeatRate)) __obj.updateDynamic("repeatRate")(repeatRate.get.asInstanceOf[js.Any])
    if (!js.isUndefined(reposition)) __obj.updateDynamic("reposition")(reposition.get.asInstanceOf[js.Any])
    if (!js.isUndefined(resetDefault)) __obj.updateDynamic("resetDefault")(resetDefault.get.asInstanceOf[js.Any])
    if (restrictInclude != null) __obj.updateDynamic("restrictInclude")(restrictInclude.asInstanceOf[js.Any])
    if (!js.isUndefined(restrictInput)) __obj.updateDynamic("restrictInput")(restrictInput.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(stayOpen)) __obj.updateDynamic("stayOpen")(stayOpen.get.asInstanceOf[js.Any])
    if (!js.isUndefined(stickyShift)) __obj.updateDynamic("stickyShift")(stickyShift.get.asInstanceOf[js.Any])
    if (!js.isUndefined(stopAtEnd)) __obj.updateDynamic("stopAtEnd")(stopAtEnd.get.asInstanceOf[js.Any])
    if (switchInput != null) __obj.updateDynamic("switchInput")(js.Any.fromFunction3(switchInput))
    if (!js.isUndefined(tabNavigation)) __obj.updateDynamic("tabNavigation")(tabNavigation.get.asInstanceOf[js.Any])
    if (!js.isUndefined(updateOnChange)) __obj.updateDynamic("updateOnChange")(updateOnChange.get.asInstanceOf[js.Any])
    if (!js.isUndefined(useCombos)) __obj.updateDynamic("useCombos")(useCombos.get.asInstanceOf[js.Any])
    if (!js.isUndefined(usePreview)) __obj.updateDynamic("usePreview")(usePreview.get.asInstanceOf[js.Any])
    if (!js.isUndefined(useWheel)) __obj.updateDynamic("useWheel")(useWheel.get.asInstanceOf[js.Any])
    if (!js.isUndefined(userClosed)) __obj.updateDynamic("userClosed")(userClosed.get.asInstanceOf[js.Any])
