...
object ReactKeyboardOptions {
  ...
  def apply(
    ...
    beforeClose: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
    beforeInsert: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
    beforeVisible: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
    buildKey: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
    cancelClose: js.UndefOr[Boolean] = js.undefined,
    canceled: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
    caretToEnd: js.UndefOr[Boolean] = js.undefined,
    change: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
    `class`: String = null,
    ...
    hidden: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
    ignoreEsc: js.UndefOr[Boolean] = js.undefined,
    initialFocus: js.UndefOr[Boolean] = js.undefined,
    initialized: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
    ...
    restricted: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
    ...
    switchInput: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
    ...
    validate: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
    visible: (/* event */ js.UndefOr[Event_ | String], /* keyboard */ js.UndefOr[Element], /* el */ js.UndefOr[Element]) => Unit = null,
