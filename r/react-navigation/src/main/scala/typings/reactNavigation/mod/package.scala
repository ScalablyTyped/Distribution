...
inline def withNavigation[P /* <: NavigationInjectedProps[NavigationParams] */](Component: ComponentType[P]): ComponentType[
Omit[
  P, 
  /* keyof react-navigation.react-navigation.NavigationInjectedProps<react-navigation.react-navigation.NavigationParams> */ "navigation"
]] = ^.asInstanceOf[js.Dynamic].applyDynamic("withNavigation")(Component.asInstanceOf[js.Any]).asInstanceOf[ComponentType[
Omit[
  P, 
  /* keyof react-navigation.react-navigation.NavigationInjectedProps<react-navigation.react-navigation.NavigationParams> */ "navigation"
]]]
inline def withNavigation[P /* <: NavigationInjectedProps[NavigationParams] */, T /* <: ComponentClass[P, ComponentState] */](Component: T & (ComponentClass[P, ComponentState])): ComponentType[
(Omit[
  P, 
  /* keyof react-navigation.react-navigation.NavigationInjectedProps<react-navigation.react-navigation.NavigationParams> */ "navigation"
]) & (OnRef[T, P])] = ^.asInstanceOf[js.Dynamic].applyDynamic("withNavigation")(Component.asInstanceOf[js.Any]).asInstanceOf[ComponentType[
(Omit[
  P, 
  /* keyof react-navigation.react-navigation.NavigationInjectedProps<react-navigation.react-navigation.NavigationParams> */ "navigation"
]) & (OnRef[T, P])]]
...
type NavigationAction = NavigationInitAction | NavigationStackAction | NavigationTabAction | NavigationDrawerAction | NavigationSwitchAction | Key
...
type NavigationDrawerAction = NavigationDrawerOpenedAction | NavigationDrawerClosedAction | NavigationOpenDrawerAction | NavigationCloseDrawerAction | NavigationToggleDrawerAction
...
type NavigatorType = "react-navigation/STACK" | "react-navigation/TABS" | "react-navigation/DRAWER"
