...
object GetScreen {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetScreen[?, ?], Options, NavigationScreenPropType] (val x: Self & (GetScreen[Options, NavigationScreenPropType])) extends AnyVal {
