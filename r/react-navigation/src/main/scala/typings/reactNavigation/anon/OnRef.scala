...
object OnRef {
  ...
  @scala.inline
  implicit class OnRefOps[Self <: OnRef[_, _], T /* <: ComponentClass[P, ComponentState] */, P /* <: NavigationInjectedProps[NavigationParams] */] (val x: Self with (OnRef[T, P])) extends AnyVal {
