...
object OnRef {
  @scala.inline
  def apply[/* <: typings.react.mod.ComponentClass[P, typings.react.mod.ComponentState] */ T, /* <: typings.reactNavigation.mod.NavigationInjectedProps[typings.reactNavigation.mod.NavigationParams] */ P](onRef: js.UndefOr[Null | Ref[InstanceType[T]]] = js.undefined): OnRef[T, P] = {
