...
import typings.reactDashNavigation.reactDashNavigationMod.SafeAreaViewProps
...
object SafeAreaView
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNavigation.reactDashNavigationMod.SafeAreaView] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNavigation.reactDashNavigationMod.SafeAreaView].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNavigation.reactDashNavigationMod.SafeAreaView] = {
