...
import typings.reactDashNavigation.reactDashNavigationMod.NavigationEventPayload
import typings.reactDashNavigation.reactDashNavigationMod.NavigationEventsProps
...
object NavigationEvents
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNavigation.reactDashNavigationMod.NavigationEvents] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNavigation.reactDashNavigationMod.NavigationEvents].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNavigation.reactDashNavigationMod.NavigationEvents] = {
  ...
  type Props = NavigationEventsProps
}
