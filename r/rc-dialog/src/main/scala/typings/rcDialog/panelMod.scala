...
object panelMod extends Shortcut {
  ...
  /* Inlined parent std.Omit<rc-dialog.rc-dialog/es/Dialog.IDialogChildProps, 'getOpenCount'> */
  trait PanelProps extends StObject {
    ...
    var scrollLocker: js.UndefOr[typings.rcUtil.scrollLockerMod.default] = js.undefined
  ...
  object PanelProps {
    ...
    extension [Self <: PanelProps](x: Self) {
      ...
      inline def setScrollLocker(value: typings.rcUtil.scrollLockerMod.default): Self = StObject.set(x, "scrollLocker", value.asInstanceOf[js.Any])
