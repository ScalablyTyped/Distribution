...
object MKRangeSliderProperties {
  ...
  def apply(
    ...
    onChange: /* curValue */ Max => Unit = null,
    onConfirm: /* curValue */ Max => Unit = null,
    ...
    testID: String = null,
    thumbPadding: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(thumbPadding)) __obj.updateDynamic("thumbPadding")(thumbPadding.get.asInstanceOf[js.Any])
