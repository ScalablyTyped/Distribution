...
import typings.reactNativeMaterialKit.AnonMax
...
trait MKRangeSliderProperties extends BaseSlider {
  ...
  var onChange: js.UndefOr[js.Function1[/* curValue */ AnonMax, Unit]] = js.undefined
  var onConfirm: js.UndefOr[js.Function1[/* curValue */ AnonMax, Unit]] = js.undefined
...
object MKRangeSliderProperties {
  ...
  def apply(
    ...
    onChange: /* curValue */ AnonMax => Unit = null,
    onConfirm: /* curValue */ AnonMax => Unit = null,
    ...
    upperTrackColor: String = null,
    value: Int | Double = null
  ): MKRangeSliderProperties = {
