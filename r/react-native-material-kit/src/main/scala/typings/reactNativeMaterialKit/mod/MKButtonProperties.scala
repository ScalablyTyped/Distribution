...
object MKButtonProperties {
  ...
  @scala.inline
  implicit class MKButtonPropertiesOps[Self <: MKButtonProperties] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFab(value: Boolean): Self = this.set("fab", value.asInstanceOf[js.Any])
    @scala.inline
