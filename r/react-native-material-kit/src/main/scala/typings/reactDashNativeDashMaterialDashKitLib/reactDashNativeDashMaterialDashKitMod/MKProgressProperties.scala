...
trait MKProgressProperties
  ...
  var bufferAniDuration: js.UndefOr[scala.Double] = js.undefined
  var bufferColor: js.UndefOr[java.lang.String] = js.undefined
  var progress: js.UndefOr[scala.Double] = js.undefined
  var progressAniDuration: js.UndefOr[scala.Double] = js.undefined
...
object MKProgressProperties {
  ...
  def apply(
    ...
    bufferAniDuration: scala.Int | scala.Double = null,
    ...
    progressAniDuration: scala.Int | scala.Double = null,
    ...
    if (bufferAniDuration != null) __obj.updateDynamic("bufferAniDuration")(bufferAniDuration.asInstanceOf[js.Any])
    ...
    if (progressAniDuration != null) __obj.updateDynamic("progressAniDuration")(progressAniDuration.asInstanceOf[js.Any])
