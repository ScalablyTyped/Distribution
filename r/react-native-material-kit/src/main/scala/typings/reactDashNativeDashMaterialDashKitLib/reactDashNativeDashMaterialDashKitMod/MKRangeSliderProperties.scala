...
object MKRangeSliderProperties {
  ...
  def apply(
    ...
    onChange: /* curValue */ reactDashNativeDashMaterialDashKitLib.Anon_Max => scala.Unit = null,
    onConfirm: /* curValue */ reactDashNativeDashMaterialDashKitLib.Anon_Max => scala.Unit = null,
