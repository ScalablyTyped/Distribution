...
- typings.reactDashNativeDashMaterialDashKit.reactDashNativeDashMaterialDashKitMod.FloatingLabelProperties because var conflicts: allowFontScaling. Inlined floatingLabelEnabled, floatingLabelAniDuration, floatingLabelBottomMargin, floatingLabelFont */ trait MKTextFieldProperties extends TextInputProps {
...
object MKTextFieldProperties {
  ...
  def apply(
    ...
    onTextChange: /* val */ String => Unit = null,
    ...
    underlineEnabled: js.UndefOr[Boolean] = js.undefined,
    underlineSize: Int | Double = null,
    value: String = null
