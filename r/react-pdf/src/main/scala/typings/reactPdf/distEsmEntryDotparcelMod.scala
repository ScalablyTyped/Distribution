...
object distEsmEntryDotparcelMod {
  ...
  object pdfjs {
    ...
    @JSImport("react-pdf/dist/esm/entry.parcel", "pdfjs.AbortException")
    @js.native
    ...
    @JSImport("react-pdf/dist/esm/entry.parcel", "pdfjs.FeatureTest")
    @js.native
    ...
    object PDFWorker {
      ...
      @JSImport("react-pdf/dist/esm/entry.parcel", "pdfjs.PDFWorker.__#21@#workerPorts")
      @js.native
    ...
    @JSImport("react-pdf/dist/esm/entry.parcel", "pdfjs.PromiseCapability")
    @js.native
