...
object mod {
  ...
  object pdfjs {
    ...
    @JSImport("react-pdf", "pdfjs.AbortException")
    @js.native
    ...
    @JSImport("react-pdf", "pdfjs.FeatureTest")
    @js.native
    ...
    object PDFWorker {
      ...
      @JSImport("react-pdf", "pdfjs.PDFWorker.__#21@#workerPorts")
      @js.native
    ...
    @JSImport("react-pdf", "pdfjs.PromiseCapability")
    @js.native
