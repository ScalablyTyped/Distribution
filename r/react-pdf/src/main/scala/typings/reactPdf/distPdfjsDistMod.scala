...
object distPdfjsDistMod {
  ...
  object default {
    ...
    @JSImport("react-pdf/dist/pdfjs-dist", "default.AbortException")
    @js.native
    open class AbortException protected ()
      extends typings.pdfjsDist.mod.AbortException {
    ...
    @JSImport("react-pdf/dist/pdfjs-dist", "default.FeatureTest")
    @js.native
    open class FeatureTest ()
      extends typings.pdfjsDist.mod.FeatureTest
    ...
    object PDFWorker {
      ...
      @JSImport("react-pdf/dist/pdfjs-dist", "default.PDFWorker.__#21@#workerPorts")
      @js.native
    ...
    @JSImport("react-pdf/dist/pdfjs-dist", "default.PromiseCapability")
    @js.native
    open class PromiseCapability ()
      extends typings.pdfjsDist.mod.PromiseCapability
