...
object distEsmEntryDotparcel2Mod {
  ...
  object pdfjs {
    ...
    @JSImport("react-pdf/dist/esm/entry.parcel2", "pdfjs.AbortException")
    @js.native
    ...
    @JSImport("react-pdf/dist/esm/entry.parcel2", "pdfjs.FeatureTest")
    @js.native
    ...
    object PDFWorker {
      ...
      @JSImport("react-pdf/dist/esm/entry.parcel2", "pdfjs.PDFWorker.__#21@#workerPorts")
      @js.native
    ...
    @JSImport("react-pdf/dist/esm/entry.parcel2", "pdfjs.PromiseCapability")
    @js.native
