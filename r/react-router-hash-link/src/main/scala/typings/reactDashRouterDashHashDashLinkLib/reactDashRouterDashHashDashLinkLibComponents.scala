package typings
package reactDashRouterDashHashDashLinkLib
...
object reactDashRouterDashHashDashLinkLibComponents {
  ...
  type HashLinkProps = reactDashRouterDashHashDashLinkLib.reactDashRouterDashHashDashLinkMod.HashLinkProps
  @scala.inline
  def NavHashLinkProps: reactDashRouterDashHashDashLinkLib.reactDashRouterDashHashDashLinkMod.NavHashLinkProps.type = reactDashRouterDashHashDashLinkLib.reactDashRouterDashHashDashLinkMod.NavHashLinkProps
  type NavHashLinkProps = reactDashRouterDashHashDashLinkLib.reactDashRouterDashHashDashLinkMod.NavHashLinkProps
}
