...
object mod {
  ...
  inline def renderRoutes(routes: js.Array[RouteConfig], extraProps: js.Any): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("renderRoutes")(routes.asInstanceOf[js.Any], extraProps.asInstanceOf[js.Any])).asInstanceOf[Element]
  inline def renderRoutes(routes: js.Array[RouteConfig], extraProps: js.Any, switchProps: SwitchProps): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("renderRoutes")(routes.asInstanceOf[js.Any], extraProps.asInstanceOf[js.Any], switchProps.asInstanceOf[js.Any])).asInstanceOf[Element]
  inline def renderRoutes(routes: js.Array[RouteConfig], extraProps: Unit, switchProps: SwitchProps): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("renderRoutes")(routes.asInstanceOf[js.Any], extraProps.asInstanceOf[js.Any], switchProps.asInstanceOf[js.Any])).asInstanceOf[Element]
  inline def renderRoutes(routes: Unit, extraProps: js.Any): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("renderRoutes")(routes.asInstanceOf[js.Any], extraProps.asInstanceOf[js.Any])).asInstanceOf[Element]
  inline def renderRoutes(routes: Unit, extraProps: js.Any, switchProps: SwitchProps): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("renderRoutes")(routes.asInstanceOf[js.Any], extraProps.asInstanceOf[js.Any], switchProps.asInstanceOf[js.Any])).asInstanceOf[Element]
  inline def renderRoutes(routes: Unit, extraProps: Unit, switchProps: SwitchProps): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("renderRoutes")(routes.asInstanceOf[js.Any], extraProps.asInstanceOf[js.Any], switchProps.asInstanceOf[js.Any])).asInstanceOf[Element]
  ...
  object MatchedRoute {
    ...
    {[ K in keyof Params ]:? string}
      */ typings.reactRouterConfig.reactRouterConfigStrings.MatchedRoute & TopLevel[js.Any] */](x: Self & MatchedRoute[Params]) {
  ...
  object RouteConfig {
    ...
    extension [Self <: RouteConfig](x: Self) {
      ...
      inline def setComponent(value: ComponentType[js.Object | RouteConfigComponentProps[js.Any]]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      ...
      inline def setRender(value: /* props */ RouteConfigComponentProps[js.Any] => ReactNode): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
  ...
  object RouteConfigComponentProps {
    ...
    {[ K in keyof Params ]:? string}
      */ typings.reactRouterConfig.reactRouterConfigStrings.RouteConfigComponentProps & TopLevel[js.Any] */](x: Self & RouteConfigComponentProps[Params]) {
