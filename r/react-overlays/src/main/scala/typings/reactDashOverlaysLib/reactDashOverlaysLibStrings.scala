...
object reactDashOverlaysLibStrings {
  @js.native
  sealed trait bottom
    extends reactDashOverlaysLib.libOverlayMod.Placements
  ...
  @js.native
  sealed trait down
    extends reactDashOverlaysLib.libDropdownMod.Directions
  
  @js.native
  sealed trait left
    extends reactDashOverlaysLib.libDropdownMod.Directions
       with reactDashOverlaysLib.libOverlayMod.Placements
