...
object OverlayProps {
  @scala.inline
  def apply(
    children: OverlayRenderProps => reactLib.reactMod.ReactNs.ReactElement[_],
    ...
    onHide: (/* props */ reactDashOverlaysLib.libPortalMod.PortalNs.PortalProps, /* repeated */ js.Any) => _ = null,
