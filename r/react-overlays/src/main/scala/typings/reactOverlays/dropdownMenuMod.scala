...
object dropdownMenuMod {
  ...
  @JSImport("react-overlays/cjs/DropdownMenu", "useDropdownMenu")
  @js.native
  ...
  object UseDropdownMenuOptions {
    ...
    implicit class UseDropdownMenuOptionsMutableBuilder[Self <: UseDropdownMenuOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOffsetFunction1(value: /* details */ Placement => OffsetValue): Self = StObject.set(x, "offset", js.Any.fromFunction1(value))
