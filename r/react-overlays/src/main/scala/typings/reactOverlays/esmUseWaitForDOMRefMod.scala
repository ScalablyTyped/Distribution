...
object esmUseWaitForDOMRefMod {
  ...
  inline def resolveContainerRef[T /* <: HTMLElement */](ref: T): HTMLBodyElement | T | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("resolveContainerRef")(ref.asInstanceOf[js.Any]).asInstanceOf[HTMLBodyElement | T | Null]
  inline def resolveContainerRef[T /* <: HTMLElement */](ref: js.Function0[T | RefObject[T] | Null]): HTMLBodyElement | T | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("resolveContainerRef")(ref.asInstanceOf[js.Any]).asInstanceOf[HTMLBodyElement | T | Null]
  inline def resolveContainerRef[T /* <: HTMLElement */](ref: RefObject[T]): HTMLBodyElement | T | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("resolveContainerRef")(ref.asInstanceOf[js.Any]).asInstanceOf[HTMLBodyElement | T | Null]
