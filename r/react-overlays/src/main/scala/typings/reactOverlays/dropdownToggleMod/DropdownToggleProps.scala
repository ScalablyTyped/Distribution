...
trait DropdownToggleProps extends js.Object {
  ...
  def children(args: UseDropdownToggleHelpersp): ReactNode = js.native
}
object DropdownToggleProps {
  ...
  implicit class DropdownTogglePropsOps[Self <: DropdownToggleProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: UseDropdownToggleHelpersp => ReactNode): Self = this.set("children", js.Any.fromFunction1(value))
  }
}
