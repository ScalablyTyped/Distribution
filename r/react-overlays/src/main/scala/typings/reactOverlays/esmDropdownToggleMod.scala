...
object esmDropdownToggleMod {
  ...
  object DropdownToggleProps {
    ...
    inline def apply(children: UseDropdownToggleHelperspProps => ReactNode): DropdownToggleProps = {
    ...
    extension [Self <: DropdownToggleProps](x: Self) {
      ...
      inline def setChildren(value: UseDropdownToggleHelperspProps => ReactNode): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    }
  }
