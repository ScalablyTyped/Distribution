...
object esmManageAriaHiddenMod {
  ...
  @JSImport("react-overlays/esm/manageAriaHidden", "ariaHidden")
  @js.native
  ...
  @JSImport("react-overlays/esm/manageAriaHidden", "hideSiblings")
  @js.native
  def hideSiblings(container: Element, hasDialogBackdrop: SiblingExclusions): Unit = js.native
  
  @JSImport("react-overlays/esm/manageAriaHidden", "showSiblings")
  @js.native
