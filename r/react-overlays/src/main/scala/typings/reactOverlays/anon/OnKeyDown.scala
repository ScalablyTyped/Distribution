...
trait OnKeyDown extends js.Object {
  def onKeyDown(event: SyntheticEvent[_, Event]): Unit = js.native
}
...
object OnKeyDown {
  ...
  implicit class OnKeyDownOps[Self <: OnKeyDown] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnKeyDown(value: SyntheticEvent[_, Event] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
  }
