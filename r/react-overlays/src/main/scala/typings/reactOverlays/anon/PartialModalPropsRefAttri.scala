...
import typings.reactOverlays.cjsModalMod.ModalTransitionComponent
import typings.reactOverlays.cjsModalMod.RenderModalBackdropProps
import typings.reactOverlays.cjsModalMod.RenderModalDialogProps
...
object PartialModalPropsRefAttri {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialModalPropsRefAttri] (val x: Self) extends AnyVal {
