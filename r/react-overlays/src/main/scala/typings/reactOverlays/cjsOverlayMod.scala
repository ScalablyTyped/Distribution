...
object cjsOverlayMod extends Shortcut {
  
  /**
    * Built on top of `Popper.js`, the overlay component is
    * great for custom tooltip overlays.
    */
  @JSImport("react-overlays/cjs/Overlay", JSImport.Default)
  @js.native
  ...
  trait OverlayProps
    ...
    def children(value: ArrowProps): ReactNode
  ...
  /* This means you don't have to write `default`, but can instead just say `cjsOverlayMod.foo` */
