...
trait ModalProps
  ...
  var manager: js.UndefOr[typings.reactOverlays.esmModalManagerMod.default] = js.native
...
object ModalProps {
  ...
  implicit class ModalPropsOps[Self <: ModalProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setManager(value: typings.reactOverlays.esmModalManagerMod.default): Self = this.set("manager", value.asInstanceOf[js.Any])
