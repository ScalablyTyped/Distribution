...
object reactOverlaysStrings {
  ...
  sealed trait down
    extends StObject
       with DropDirection
       with typings.reactOverlays.dropdownContextMod.DropDirection
  ...
  @js.native
  sealed trait lostpointercapture
    extends StObject
       with MouseEvents
       with typings.reactOverlays.esmUseRootCloseMod.MouseEvents
  ...
  @js.native
  sealed trait securitypolicyviolation
    extends StObject
       with MouseEvents
       with typings.reactOverlays.esmUseRootCloseMod.MouseEvents
