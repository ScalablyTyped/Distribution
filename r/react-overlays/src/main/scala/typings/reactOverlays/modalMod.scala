...
object modalMod {
  ...
  object default {
    ...
    @JSImport("react-overlays/cjs/Modal", "default.defaultProps")
    @js.native
    ...
    @JSImport("react-overlays/cjs/Modal", "default.displayName")
    @js.native
    def displayName: js.UndefOr[String] = js.native
    inline def displayName_=(x: js.UndefOr[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("react-overlays/cjs/Modal", "default.propTypes")
    @js.native
    ...
    @JSImport("react-overlays/cjs/Modal", "default.$$typeof")
    @js.native
