...
import typings.reactDashOverlays.reactDashOverlaysStrings.static
...
trait ModalProps
  ...
  /**
    ...
    */
  var manager: js.UndefOr[typings.reactDashOverlays.libModalManagerMod.^] = js.undefined
  /**
...
object ModalProps {
  ...
  def apply(
    ...
    manager: typings.reactDashOverlays.libModalManagerMod.^ = null,
