...
object reactMdTableStrings {
  ...
  @js.native
  sealed trait colSpan extends StObject
  ...
  sealed trait defaultChecked
    extends StObject
       with WantedCheckboxProps
  inline def defaultChecked: defaultChecked = "defaultChecked".asInstanceOf[defaultChecked]
  ...
  sealed trait disableIconOverlay
    extends StObject
       with WantedCheckboxProps
  inline def disableIconOverlay: disableIconOverlay = "disableIconOverlay".asInstanceOf[disableIconOverlay]
  ...
  @js.native
  sealed trait `header-cell` extends StObject
  inline def `header-cell`: `header-cell` = "header-cell".asInstanceOf[`header-cell`]
  ...
  sealed trait iconClassName
    extends StObject
       with WantedCheckboxProps
  inline def iconClassName: iconClassName = "iconClassName".asInstanceOf[iconClassName]
  
  @js.native
  sealed trait iconStyle
    extends StObject
       with WantedCheckboxProps
  inline def iconStyle: iconStyle = "iconStyle".asInstanceOf[iconStyle]
  ...
  sealed trait toggleClassName
    extends StObject
       with WantedCheckboxProps
  inline def toggleClassName: toggleClassName = "toggleClassName".asInstanceOf[toggleClassName]
  
  @js.native
  sealed trait toggleStyle
    extends StObject
       with WantedCheckboxProps
  inline def toggleStyle: toggleStyle = "toggleStyle".asInstanceOf[toggleStyle]
