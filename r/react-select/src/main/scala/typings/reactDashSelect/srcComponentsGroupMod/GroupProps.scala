...
/* Inlined react-select.react-select/src/types.CommonProps<OptionType> & react-select.react-select/src/components/Group.ComponentProps */
@js.native
trait GroupProps[OptionType /* <: OptionTypeBase */] extends js.Object {
