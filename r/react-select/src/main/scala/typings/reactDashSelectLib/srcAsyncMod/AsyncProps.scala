...
trait AsyncProps[OptionType] extends js.Object {
  ...
  /* The default set of options to show before the user starts searching. When
    ...
    Default: false. */
  var defaultOptions: js.UndefOr[reactDashSelectLib.srcTypesMod.OptionsType[OptionType] | scala.Boolean] = js.undefined
...
object AsyncProps {
  ...
  def apply[OptionType](
    loadOptions: (java.lang.String, js.Function1[/* options */ reactDashSelectLib.srcTypesMod.OptionsType[OptionType], scala.Unit]) => js.Promise[_] | scala.Unit,
    cacheOptions: js.Any = null,
    defaultOptions: reactDashSelectLib.srcTypesMod.OptionsType[OptionType] | scala.Boolean = null
