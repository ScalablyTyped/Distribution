...
trait Select[OptionType]
  ...
  var commonProps: js.Any = js.native
   // TODO
  var components: reactDashSelectLib.srcComponentsMod.SelectComponents[OptionType] = js.native
  // Refs
  // ------------------------------
  var controlRef: ElRef = js.native
  var focusedOptionRef: ElRef = js.native
  var formatGroupLabel: reactDashSelectLib.srcBuiltinsMod.formatGroupLabel[OptionType] = js.native
  var getOptionLabel: reactDashSelectLib.srcBuiltinsMod.getOptionLabel[OptionType] = js.native
  var getOptionValue: reactDashSelectLib.srcBuiltinsMod.getOptionValue[OptionType] = js.native
  ...
  // Menu Options
  // ==============================
  def buildMenuOptions(props: Props[OptionType], selectValue: reactDashSelectLib.srcTypesMod.OptionsType[OptionType]): MenuOptions[OptionType] = js.native
  // Lifecycle
  // ------------------------------
  def cacheComponents(components: reactDashSelectLib.srcComponentsMod.SelectComponents[OptionType]): scala.Unit = js.native
  ...
  def focusOption(direction: reactDashSelectLib.srcTypesMod.FocusDirection): scala.Unit = js.native
  @JSName("focusValue")
  ...
  def getNextFocusedOption(options: reactDashSelectLib.srcTypesMod.OptionsType[OptionType]): OptionType = js.native
  def getNextFocusedValue(nextSelectValue: reactDashSelectLib.srcTypesMod.OptionsType[OptionType]): OptionType = js.native
  ...
  def isOptionDisabled(option: OptionType, selectValue: reactDashSelectLib.srcTypesMod.OptionsType[OptionType]): scala.Boolean = js.native
  def isOptionSelected(option: OptionType, selectValue: reactDashSelectLib.srcTypesMod.OptionsType[OptionType]): scala.Boolean = js.native
  ...
  def onInputChange(newValue: java.lang.String, actionMeta: reactDashSelectLib.srcTypesMod.InputActionMeta): scala.Unit = js.native
  ...
  def renderPlaceholderOrValue(): reactDashSelectLib.srcComponentsMod.PlaceholderOrValue[OptionType] | scala.Null = js.native
