...
/* Inlined react-select.react-select/src/components/Menu.MenuProps<OptionType> & react-select.react-select/src/components/Menu.MenuState */
@js.native
trait MenuPropsOptionTypeMenuState[OptionType /* <: OptionTypeBase */] extends js.Object {
