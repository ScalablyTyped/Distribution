...
object distDeclarationsSrcComponentsSingleValueMod {
  ...
  inline def css[Option, IsMulti /* <: Boolean */, Group /* <: GroupBase[Option] */](param0: SingleValueProps[Option, IsMulti, Group], unstyled: Boolean): CSSObjectWithLabel = (^.asInstanceOf[js.Dynamic].applyDynamic("css")(param0.asInstanceOf[js.Any], unstyled.asInstanceOf[js.Any])).asInstanceOf[CSSObjectWithLabel]
