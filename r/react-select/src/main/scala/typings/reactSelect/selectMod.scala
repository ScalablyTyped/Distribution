...
import typings.reactSelect.accessibilityMod.AriaLiveMessages
...
import typings.reactSelect.typesMod.PropsValue
...
object selectMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactSelect.selectMod.CategorizedGroup[Option, Group]
    - typings.reactSelect.selectMod.CategorizedOption[Option]
  */
  trait CategorizedGroupOrOption[Option, Group /* <: GroupBase[Option] */] extends StObject
  object CategorizedGroupOrOption {
    
    inline def CategorizedGroup[Option, Group /* <: GroupBase[Option] */](data: Group, index: Double, options: js.Array[CategorizedOption[Option]]): typings.reactSelect.selectMod.CategorizedGroup[Option, Group] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("group")
      __obj.asInstanceOf[typings.reactSelect.selectMod.CategorizedGroup[Option, Group]]
    }
    ...
    inline def CategorizedOption[Option](
      ...
      __obj.asInstanceOf[typings.reactSelect.selectMod.CategorizedOption[Option]]
    }
  }
  ...
  */
  ...
  trait State[Option, IsMulti /* <: Boolean */, Group /* <: GroupBase[Option] */] extends StObject {
    ...
    var ariaSelection: (typings.reactSelect.accessibilityMod.AriaSelection[Option, IsMulti]) | Null
  ...
  object State {
    ...
    extension [Self <: State[?, ?, ?], Option, IsMulti /* <: Boolean */, Group /* <: GroupBase[Option] */](x: Self & (State[Option, IsMulti, Group])) {
      ...
      inline def setAriaSelection(value: typings.reactSelect.accessibilityMod.AriaSelection[Option, IsMulti]): Self = StObject.set(x, "ariaSelection", value.asInstanceOf[js.Any])
