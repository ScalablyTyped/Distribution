...
object ValueProps {
  @scala.inline
  def apply[/* <: typings.reactSelect.typesMod.OptionTypeBase */ OptionType](data: OptionType, innerProps: js.Any): ValueProps[OptionType] = {
  ...
  @scala.inline
  implicit class ValuePropsOps[Self <: ValueProps[_], /* <: typings.reactSelect.typesMod.OptionTypeBase */ OptionType] (val x: Self with ValueProps[OptionType]) extends AnyVal {
    @scala.inline
