...
/* Inlined react-select.react-select/src/types.CommonProps<OptionType> & react-select.react-select/src/components/SingleValue.ValueProps<OptionType> & react-select.react-select/src/components/SingleValue.State */
@js.native
trait SingleValueProps[OptionType /* <: OptionTypeBase */] extends js.Object {
