...
object distDeclarationsSrcComponentsInputMod {
  ...
  inline def inputCSS[Option, IsMulti /* <: Boolean */, Group /* <: GroupBase[Option] */](param0: InputProps[Option, IsMulti, Group], unstyled: Boolean): CSSObjectWithLabel = (^.asInstanceOf[js.Dynamic].applyDynamic("inputCSS")(param0.asInstanceOf[js.Any], unstyled.asInstanceOf[js.Any])).asInstanceOf[CSSObjectWithLabel]
