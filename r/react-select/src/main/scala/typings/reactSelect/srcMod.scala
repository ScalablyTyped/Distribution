...
object srcMod {
  ...
  @JSImport("react-select/dist/declarations/src", "NonceProvider")
  @js.native
  open class NonceProvider protected ()
    extends typings.reactSelect.nonceProviderMod.default {
  ...
  object components {
    ...
    @JSImport("react-select/dist/declarations/src", "components.MenuPortal")
    @js.native
  ...
  type SelectInstance[Option, IsMulti /* <: Boolean */, Group /* <: GroupBase[Option] */] = typings.reactSelect.selectMod.default[Option, IsMulti, Group]
}
