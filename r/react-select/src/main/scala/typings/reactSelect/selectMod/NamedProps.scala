...
@js.native
trait NamedProps[OptionType /* <: OptionTypeBase */] extends js.Object {
...
object NamedProps {
  ...
  @scala.inline
  implicit class NamedPropsOps[Self <: NamedProps[_], OptionType /* <: OptionTypeBase */] (val x: Self with NamedProps[OptionType]) extends AnyVal {
