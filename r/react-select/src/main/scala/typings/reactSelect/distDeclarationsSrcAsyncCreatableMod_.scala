...
object distDeclarationsSrcAsyncCreatableMod_ extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distDeclarationsSrcAsyncCreatableMod_.foo` */
