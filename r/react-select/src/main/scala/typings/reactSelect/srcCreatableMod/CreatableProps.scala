...
object CreatableProps {
  @scala.inline
  def apply[/* <: typings.reactSelect.typesMod.OptionTypeBase */ OptionType](): CreatableProps[OptionType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreatableProps[OptionType]]
  }
  @scala.inline
  implicit class CreatablePropsOps[Self <: CreatableProps[_], /* <: typings.reactSelect.typesMod.OptionTypeBase */ OptionType] (val x: Self with CreatableProps[OptionType]) extends AnyVal {
    @scala.inline
