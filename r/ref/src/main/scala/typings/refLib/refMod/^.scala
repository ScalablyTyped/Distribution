...
object ^ extends js.Object {
  ...
  var types: refLib.Anon_Bool = js.native
  ...
  def alloc(`type`: refLib.refMod.Type): nodeLib.Buffer = js.native
  def alloc(`type`: refLib.refMod.Type, value: js.Any): nodeLib.Buffer = js.native
  ...
  def coerceType(`type`: java.lang.String): refLib.refMod.Type = js.native
  def coerceType(`type`: refLib.refMod.Type): refLib.refMod.Type = js.native
  def deref(buffer: nodeLib.Buffer): js.Any = js.native
  def derefType(`type`: java.lang.String): refLib.refMod.Type = js.native
  def derefType(`type`: refLib.refMod.Type): refLib.refMod.Type = js.native
  ...
  def get(buffer: nodeLib.Buffer, offset: scala.Double, `type`: refLib.refMod.Type): js.Any = js.native
  def getType(buffer: nodeLib.Buffer): refLib.refMod.Type = js.native
  ...
  def refType(`type`: java.lang.String): refLib.refMod.Type = js.native
  def refType(`type`: refLib.refMod.Type): refLib.refMod.Type = js.native
  ...
  def set(buffer: nodeLib.Buffer, offset: scala.Double, value: js.Any, `type`: refLib.refMod.Type): scala.Unit = js.native
