...
trait IAnimateProps extends js.Object {
  ...
  def children(state: reactDashMoveLib.reactDashMoveMod.HashMap): reactLib.reactMod.ReactElement
}

object IAnimateProps {
  @scala.inline
  def apply(
    children: reactDashMoveLib.reactDashMoveMod.HashMap => reactLib.reactMod.ReactElement,
    start: js.Any,
    enter: js.Any = null,
