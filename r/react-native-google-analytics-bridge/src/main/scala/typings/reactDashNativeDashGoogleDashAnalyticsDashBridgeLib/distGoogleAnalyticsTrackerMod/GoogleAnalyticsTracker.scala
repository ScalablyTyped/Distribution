...
trait GoogleAnalyticsTracker extends js.Object {
  var customDimensionsFieldsIndexMap: reactDashNativeDashGoogleDashAnalyticsDashBridgeLib.distModelsCustomMod.CustomDimensionsFieldIndexMap = js.native
  ...
  /**
    ...
    */
  def allowIDFA(): scala.Unit = js.native
  def allowIDFA(enabled: scala.Boolean): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def setAnonymizeIp(enabled: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def setAppName(appName: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def setClient(clientId: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def setCurrency(currencyCode: java.lang.String): scala.Unit = js.native
  /**
    * Sets tracker sampling rate.
    * @example tracker.setSamplingRate(50);
    * @param {number} sampleRatio (Required) Percentage 0 - 100
    */
  def setSamplingRate(sampleRatio: scala.Double): scala.Unit = js.native
  /**
    ...
    */
  def setTrackUncaughtExceptions(enabled: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def setUser(userId: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def trackEvent(category: java.lang.String, action: java.lang.String): scala.Unit = js.native
  def trackEvent(
    category: java.lang.String,
    action: java.lang.String,
    eventMetadata: reactDashNativeDashGoogleDashAnalyticsDashBridgeLib.distModelsAnalyticsMod.EventMetadata
  ): scala.Unit = js.native
  def trackEvent(
    category: java.lang.String,
    action: java.lang.String,
    eventMetadata: reactDashNativeDashGoogleDashAnalyticsDashBridgeLib.distModelsAnalyticsMod.EventMetadata,
    payload: reactDashNativeDashGoogleDashAnalyticsDashBridgeLib.distModelsAnalyticsMod.HitPayload
  ): scala.Unit = js.native
  /**
    * Track an exception
    * @example
    ...
    * @param  {HitPayload} payload (Optional) An object containing the hit payload
    */
  def trackException(error: java.lang.String): scala.Unit = js.native
  def trackException(error: java.lang.String, fatal: scala.Boolean): scala.Unit = js.native
  def trackException(
  ...
  /**
    ...
    * @param  {HitPayload} payload (Optional) An object containing the hit payload
    */
  def trackScreenView(screenName: java.lang.String): scala.Unit = js.native
  def trackScreenView(
  ...
  def trackTiming(
    ...
    timingMetadata: reactDashNativeDashGoogleDashAnalyticsDashBridgeLib.distModelsAnalyticsMod.TimingMetadata
  ): scala.Unit = js.native
  def trackTiming(
    category: java.lang.String,
    interval: scala.Double,
