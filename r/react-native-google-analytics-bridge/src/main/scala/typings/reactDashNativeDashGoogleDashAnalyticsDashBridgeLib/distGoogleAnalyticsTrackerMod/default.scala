package typings
package reactDashNativeDashGoogleDashAnalyticsDashBridgeLib.distGoogleAnalyticsTrackerMod
...
class default protected () extends GoogleAnalyticsTracker {
  /**
    ...
    */
  def this(trackerId: java.lang.String) = this()
  def this(trackerId: java.lang.String, customDimensionsFieldsIndexMap: reactDashNativeDashGoogleDashAnalyticsDashBridgeLib.distModelsCustomMod.CustomDimensionsFieldIndexMap) = this()
}
