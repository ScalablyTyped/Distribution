...
import typings.reactNativeGoogleAnalyticsBridge.distModelsCustomMod.CustomDimensionsByField
import typings.reactNativeGoogleAnalyticsBridge.distModelsCustomMod.CustomDimensionsByIndex
import typings.reactNativeGoogleAnalyticsBridge.distModelsCustomMod.CustomMetrics
import typings.reactNativeGoogleAnalyticsBridge.distModelsProductMod.Product
import typings.reactNativeGoogleAnalyticsBridge.distModelsProductMod.ProductAction
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distModelsAnalyticsMod {
  ...
  object SessionState extends StObject {
    ...
    sealed trait End
      extends StObject
         with SessionState
    /* "end" */ val End: typings.reactNativeGoogleAnalyticsBridge.distModelsAnalyticsMod.SessionState.End & String = js.native
    
    @js.native
    sealed trait Start
      extends StObject
         with SessionState
    /* "start" */ val Start: typings.reactNativeGoogleAnalyticsBridge.distModelsAnalyticsMod.SessionState.Start & String = js.native
  }
