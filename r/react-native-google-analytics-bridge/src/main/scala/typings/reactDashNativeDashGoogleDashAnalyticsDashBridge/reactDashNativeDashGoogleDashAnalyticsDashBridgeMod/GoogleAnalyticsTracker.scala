...
import typings.reactDashNativeDashGoogleDashAnalyticsDashBridge.distGoogleAnalyticsTrackerMod.default
...
@js.native
class GoogleAnalyticsTracker protected () extends default {
  /**
