package typings.reactDashNativeDashGoogleDashAnalyticsDashBridge.reactDashNativeDashGoogleDashAnalyticsDashBridgeMod

import typings.reactDashNativeDashGoogleDashAnalyticsDashBridge.distGoogleTagManagerMod.default
...
@js.native
class GoogleTagManager () extends default
