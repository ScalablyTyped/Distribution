...
trait Anon_HTTPOrNetworkError extends js.Object {
  ...
  var HTTPOrNetworkError_Original: requestretryLib.requestretryMod.RetryStrategy = js.native
  @JSName("HttpError")
  var HttpError_Original: requestretryLib.requestretryMod.RetryStrategy = js.native
  @JSName("NetworkError")
  var NetworkError_Original: requestretryLib.requestretryMod.RetryStrategy = js.native
