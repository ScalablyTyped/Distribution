...
class TabStack protected ()
  extends reactLib.reactMod.PureComponent[TabStackProps, reactDashRouterDashNavigationDashCoreLib.Anon_KeyLoadedTabs, js.Any] {
...
object TabStack extends js.Object {
  var defaultProps: reactDashRouterDashNavigationDashCoreLib.Anon_False = js.native
}
