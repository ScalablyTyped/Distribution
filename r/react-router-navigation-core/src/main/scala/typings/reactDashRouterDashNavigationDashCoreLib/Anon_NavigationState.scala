...
trait Anon_NavigationState extends js.Object {
  var loadedTabs: js.Array[java.lang.String]
  var navigationState: reactDashRouterDashNavigationDashCoreLib.reactDashRouterDashNavigationDashCoreMod.NavigationState[Anon_Title]
