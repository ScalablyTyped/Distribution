...
object mod {
  ...
  @JSImport("remark-rehype", JSImport.Namespace)
  @js.native
  ...
  /**
    ...
    */
  @JSImport("remark-rehype", JSImport.Default)
  @js.native
  val default: Plugin[
    (js.Tuple2[
  ...
  type Options = typings.remarkRehype.libMod.Options
  
  type Processor = typings.remarkRehype.libMod.Processor
}
