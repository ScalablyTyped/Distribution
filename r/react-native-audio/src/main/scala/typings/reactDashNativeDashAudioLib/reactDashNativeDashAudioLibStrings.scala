...
object reactDashNativeDashAudioLibStrings {
  @js.native
  ...
  @js.native
  sealed trait MAC3
    extends reactDashNativeDashAudioLib.reactDashNativeDashAudioMod.AudioEncodingIOSType
  ...
  @js.native
  sealed trait aac
    extends reactDashNativeDashAudioLib.reactDashNativeDashAudioMod.AudioEncodingType
  
  @js.native
  sealed trait aac_eld
    extends reactDashNativeDashAudioLib.reactDashNativeDashAudioMod.AudioEncodingAndroidType
