...
import typings.reactTimePicker.anon.MinTime
...
object distCjsTimeInputSecondInputMod {
  
  object default {
    
    inline def apply(param0: SecondInputProps): Element = ^.asInstanceOf[js.Dynamic].apply(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.ariaLabel")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.className")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.disabled")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.hour")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.inputRef")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.maxTime")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.minTime")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.minute")
      @js.native
      def minute: Requireable[String] = js.native
      inline def minute_=(x: Requireable[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("minute")(x.asInstanceOf[js.Any])
      
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.onChange")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.onKeyDown")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.onKeyUp")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.placeholder")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.required")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.showLeadingZeros")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/SecondInput", "default.propTypes.value")
      @js.native
  ...
  type SecondInputProps = MinTime & (Omit[ComponentProps[TypeofInput], max | min | name])
}
