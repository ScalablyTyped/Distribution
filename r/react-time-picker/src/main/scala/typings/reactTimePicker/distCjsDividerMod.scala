...
object distCjsDividerMod {
  ...
  object default {
    ...
    @JSImport("react-time-picker/dist/cjs/Divider", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-time-picker/dist/cjs/Divider", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-time-picker/dist/cjs/Divider", "default.propTypes.children")
      @js.native
