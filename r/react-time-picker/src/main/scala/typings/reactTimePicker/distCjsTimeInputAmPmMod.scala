...
import typings.reactTimePicker.anon.ChangeEventHTMLSelectElem
import typings.reactTimePicker.anon.Current
import typings.reactTimePicker.anon.KeyboardEventHTMLSelectEl
...
object distCjsTimeInputAmPmMod {
  
  object default {
    
    inline def apply(param0: AmPmProps): Element = ^.asInstanceOf[js.Dynamic].apply(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.ariaLabel")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.autoFocus")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.className")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.disabled")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.inputRef")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.locale")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.maxTime")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.minTime")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.onChange")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.onKeyDown")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.required")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/AmPm", "default.propTypes.value")
      @js.native
  ...
  trait AmPmProps extends StObject {
  ...
  object AmPmProps {
    ...
    inline def apply(className: String): AmPmProps = {
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any])
      __obj.asInstanceOf[AmPmProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: AmPmProps] (val x: Self) extends AnyVal {
