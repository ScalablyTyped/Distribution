...
import typings.reactTimePicker.anon.Hour
...
object distCjsTimeInputMinuteInputMod {
  
  object default {
    
    inline def apply(param0: MinuteInputProps): Element = ^.asInstanceOf[js.Dynamic].apply(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.ariaLabel")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.className")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.disabled")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.hour")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.inputRef")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.maxTime")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.minTime")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.onChange")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.onKeyDown")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.onKeyUp")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.placeholder")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.required")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.showLeadingZeros")
      @js.native
      ...
      @JSImport("react-time-picker/dist/cjs/TimeInput/MinuteInput", "default.propTypes.value")
      @js.native
  ...
  type MinuteInputProps = Hour & (Omit[ComponentProps[TypeofInput], max | min | name])
}
