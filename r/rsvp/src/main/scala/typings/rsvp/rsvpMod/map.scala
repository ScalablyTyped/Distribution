...
object map extends js.Object {
  def apply[T, U](entries: js.Array[Arg[T]], mapFn: js.Function1[/* item */ T, U]): typings.rsvp.rsvpMod.RSVPNs.Promise[js.Array[U] with Anon_1] = js.native
  def apply[T, U](entries: js.Array[Arg[T]], mapFn: js.Function1[/* item */ T, U], label: String): typings.rsvp.rsvpMod.RSVPNs.Promise[js.Array[U] with Anon_1] = js.native
  def apply[T1, T2, U](entries: js.Tuple2[Arg[T1], Arg[T2]], mapFn: js.Function1[/* item */ T1 | T2, U]): typings.rsvp.rsvpMod.RSVPNs.Promise[js.Array[U] with Anon_2] = js.native
  def apply[T1, T2, U](entries: js.Tuple2[Arg[T1], Arg[T2]], mapFn: js.Function1[/* item */ T1 | T2, U], label: String): typings.rsvp.rsvpMod.RSVPNs.Promise[js.Array[U] with Anon_2] = js.native
  def apply[T1, T2, T3, U](entries: js.Tuple3[Arg[T1], Arg[T2], Arg[T3]], mapFn: js.Function1[/* item */ T1 | T2 | T3, U]): typings.rsvp.rsvpMod.RSVPNs.Promise[js.Array[U] with Anon_3] = js.native
