...
object ^ extends js.Object {
  val EventTarget: rsvpLib.Anon_Callback = js.native
  val Promise: rsvpLib.Anon_All = js.native
  val all: rsvpLib.Anon_Values = js.native
  val allSettled: rsvpLib.Anon_Entries = js.native
  val asap: rsvpLib.Anon_Arg = js.native
  ...
  val defer: rsvpLib.Anon_LabelDeferred = js.native
  val denodeify: rsvpLib.Anon_Arg1 = js.native
  val filter: rsvpLib.Anon_EntriesFilterFn = js.native
  val hash: rsvpLib.Anon_Label = js.native
  val hashSettled: rsvpLib.Anon_LabelObject = js.native
  val map: rsvpLib.Anon_EntriesItem = js.native
