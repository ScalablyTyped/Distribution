...
trait AnonBytesBytesDelta extends js.Object {
  /**
...
object AnonBytesBytesDelta {
  @scala.inline
  def apply(bytes: Double, bytesDelta: Double, bytesLeft: Double, speed: Double, timeLeft: Double): AnonBytesBytesDelta = {
    ...
    __obj.asInstanceOf[AnonBytesBytesDelta]
  }
}
