...
object anon {
  ...
  trait TypeofReact extends StObject {
    ...
    def createElement[P /* <: HTMLAttributes[T] */, T /* <: HTMLElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 116, starting with typings.reactHint.reactHintStrings.a, typings.reactHint.reactHintStrings.abbr, typings.reactHint.reactHintStrings.address */ Any,
    ...
    def createElement_PT_ReactSVGElement[P /* <: SVGAttributes[T] */, T /* <: SVGElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55, starting with typings.reactHint.reactHintStrings.animate, typings.reactHint.reactHintStrings.circle, typings.reactHint.reactHintStrings.clipPath */ Any,
      props: ClassAttributes[T] & P,
      children: ReactNode*
