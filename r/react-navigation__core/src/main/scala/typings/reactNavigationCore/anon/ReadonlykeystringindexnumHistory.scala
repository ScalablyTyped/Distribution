...
@js.native
trait ReadonlykeystringindexnumHistory extends js.Object {
...
object ReadonlykeystringindexnumHistory {
  ...
  @scala.inline
  implicit class ReadonlykeystringindexnumHistoryOps[Self <: ReadonlykeystringindexnumHistory] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRoutesVarargs(value: (Key with Params with `0`)*): Self = this.set("routes", js.Array(value :_*))
    
    @scala.inline
    def setRoutes(value: js.Array[Key with Params with `0`]): Self = this.set("routes", value.asInstanceOf[js.Any])
