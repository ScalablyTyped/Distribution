...
object `6` {
  ...
  @scala.inline
  implicit class `6MutableBuilder`[Self <: `6`[?, ?], EventMap /* <: EventMapBase */, EventName /* <: Extract[/* keyof EventMap */ String, String] */] (val x: Self & (`6`[EventMap, EventName])) extends AnyVal {
