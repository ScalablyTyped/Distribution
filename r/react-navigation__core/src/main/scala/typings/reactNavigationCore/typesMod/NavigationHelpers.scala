...
import typings.reactNavigationCore.anon.MergeName
import typings.reactNavigationCore.anon.MergeParams
...
import typings.reactNavigationCore.anon.`7`
...
trait NavigationHelpers[ParamList /* <: ParamListBase */, EventMap /* <: EventMapBase */] extends StObject {
  ...
  def emit[EventName /* <: Keyof[EventMap] */](
    options: (TargetType[EventName, EventMap]) & (js.Object | `3`) & ((`7`[EventMap, EventName]) | (`6`[EventMap, EventName]))
  ): EventArg[
    EventName, 
  ...
  /**
    ...
    */
  def navigate[RouteName /* <: /* keyof ParamList */ String */](options: (MergeParams[ParamList, RouteName]) | (MergeName[RouteName, ParamList])): Unit = js.native
