...
import typings.reactNavigationCore.anon.KeyMergeParams
import typings.reactNavigationCore.anon.NameParams
...
/* Inlined @react-navigation/core.@react-navigation/core/lib/typescript/src/types.NavigationContainerRef<ParamList> & {  current :@react-navigation/core.@react-navigation/core/lib/typescript/src/types.NavigationContainerRef<ParamList> | null} */
@js.native
trait NavigationContainerRefWithCurrent[ParamList /* <: js.Object */] extends StObject {
  ...
  var current: NavigationContainerRef[ParamList] | Null = js.native
  ...
  /**
    ...
    */
  def navigate[RouteName /* <: /* keyof ParamList */ String */](options: (KeyMergeParams[ParamList, RouteName]) | (NameParams[RouteName, ParamList])): Unit = js.native
