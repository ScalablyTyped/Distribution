...
trait Anon_A extends js.Object {
  ...
  def apply[A, R](f1: js.Function1[/* b */ A, R], f2: reduxLib.reduxMod.Func0[A]): reduxLib.reduxMod.Func0[R] = js.native
  def apply[A, B, R](f1: js.Function1[/* b */ B, R], f2: js.Function1[/* a */ A, B], f3: reduxLib.reduxMod.Func0[A]): reduxLib.reduxMod.Func0[R] = js.native
  def apply[A, T1, R](f1: js.Function1[/* b */ A, R], f2: reduxLib.reduxMod.Func1[T1, A]): reduxLib.reduxMod.Func1[T1, R] = js.native
  def apply[A, B, C, R](
  ...
  def apply[A, B, T1, R](f1: js.Function1[/* b */ B, R], f2: js.Function1[/* a */ A, B], f3: reduxLib.reduxMod.Func1[T1, A]): reduxLib.reduxMod.Func1[T1, R] = js.native
  def apply[A, T1, T2, R](f1: js.Function1[/* b */ A, R], f2: reduxLib.reduxMod.Func2[T1, T2, A]): reduxLib.reduxMod.Func2[T1, T2, R] = js.native
  ...
  def apply[A, B, T1, T2, R](
    f1: js.Function1[/* b */ B, R],
    f2: js.Function1[/* a */ A, B],
    f3: reduxLib.reduxMod.Func2[T1, T2, A]
  ): reduxLib.reduxMod.Func2[T1, T2, R] = js.native
  def apply[A, T1, T2, T3, R](f1: js.Function1[/* b */ A, R], f2: reduxLib.reduxMod.Func3[T1, T2, T3, A]): reduxLib.reduxMod.Func3[T1, T2, T3, R] = js.native
