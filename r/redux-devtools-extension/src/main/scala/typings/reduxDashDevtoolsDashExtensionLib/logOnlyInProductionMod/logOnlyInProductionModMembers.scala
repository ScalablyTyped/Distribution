...
object logOnlyInProductionModMembers extends js.Object {
  def composeWithDevTools(options: reduxDashDevtoolsDashExtensionLib.reduxDashDevtoolsDashExtensionMod.EnhancerOptions): reduxDashDevtoolsDashExtensionLib.Anon_Funcs = js.native
