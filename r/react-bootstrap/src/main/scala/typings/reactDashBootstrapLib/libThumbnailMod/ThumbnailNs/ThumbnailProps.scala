package typings
package reactDashBootstrapLib.libThumbnailMod.ThumbnailNs
...
object ThumbnailProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libThumbnailMod.Thumbnail] = null,
