package typings
package reactDashBootstrapLib.libTooltipMod.TooltipNs
...
trait TooltipProps
  extends reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libTooltipMod.Tooltip] {
  // Optional
...
object TooltipProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libTooltipMod.Tooltip] = null,
