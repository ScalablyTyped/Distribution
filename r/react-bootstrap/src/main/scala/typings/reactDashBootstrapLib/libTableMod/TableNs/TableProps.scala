package typings
package reactDashBootstrapLib.libTableMod.TableNs
...
trait TableProps
  extends reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libTableMod.Table] {
...
object TableProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libTableMod.Table] = null,
