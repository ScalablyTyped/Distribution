package typings
package reactDashBootstrapLib.libLabelMod.LabelNs
...
trait LabelProps
  extends reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libLabelMod.Label] {
...
object LabelProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libLabelMod.Label] = null,
