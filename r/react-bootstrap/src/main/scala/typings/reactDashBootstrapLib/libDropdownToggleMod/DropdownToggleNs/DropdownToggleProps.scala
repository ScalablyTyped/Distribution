package typings
package reactDashBootstrapLib.libDropdownToggleMod.DropdownToggleNs
...
trait DropdownToggleProps
  extends reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libDropdownToggleMod.DropdownToggle] {
...
object DropdownToggleProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libDropdownToggleMod.DropdownToggle] = null,
