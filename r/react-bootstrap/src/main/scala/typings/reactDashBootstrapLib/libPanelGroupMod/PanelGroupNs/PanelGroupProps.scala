package typings
package reactDashBootstrapLib.libPanelGroupMod.PanelGroupNs
...
object PanelGroupProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libPanelGroupMod.PanelGroup] = null,
