package typings
package reactDashBootstrapLib.libDropdownMenuMod
...
trait DropdownMenuProps
  extends reactLib.reactMod.HTMLProps[DropdownMenu] {
...
object DropdownMenuProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.HTMLProps[DropdownMenu] = null,
