package typings
package reactDashBootstrapLib.libModalHeaderMod.ModalHeaderNs
...
trait ModalHeaderProps
  extends reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libModalHeaderMod.ModalHeader] {
