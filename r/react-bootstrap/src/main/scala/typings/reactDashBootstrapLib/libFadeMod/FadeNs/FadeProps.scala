package typings
package reactDashBootstrapLib.libFadeMod.FadeNs
...
trait FadeProps
  extends reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libFadeMod.Fade]
...
object FadeProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libFadeMod.Fade] = null,
