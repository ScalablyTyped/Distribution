package typings
package reactDashBootstrapLib.libAccordionMod.AccordionNs
...
trait AccordionProps
  extends reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libAccordionMod.Accordion] {
...
object AccordionProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libAccordionMod.Accordion] = null,
