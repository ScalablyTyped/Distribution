package typings
package reactDashBootstrapLib.libPanelMod.PanelNs
...
trait PanelProps
  extends reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libPanelMod.Panel]
...
object PanelProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libPanelMod.Panel] = null,
