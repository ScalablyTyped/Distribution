package typings
package reactDashBootstrapLib.libTabPaneMod
...
trait TabPaneProps
  extends reactLib.reactMod.HTMLProps[TabPane]
     with reactDashBootstrapLib.reactDashBootstrapMod.TransitionCallbacks {
  var animation: js.UndefOr[
    scala.Boolean | (reactLib.reactMod.ComponentClass[_, reactLib.reactMod.ComponentState])
  ] = js.undefined
...
object TabPaneProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.HTMLProps[TabPane] = null,
    TransitionCallbacks: reactDashBootstrapLib.reactDashBootstrapMod.TransitionCallbacks = null,
    animation: scala.Boolean | (reactLib.reactMod.ComponentClass[_, reactLib.reactMod.ComponentState]) = null,
