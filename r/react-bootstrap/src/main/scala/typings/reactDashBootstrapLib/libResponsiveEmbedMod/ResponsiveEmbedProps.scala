package typings
package reactDashBootstrapLib.libResponsiveEmbedMod
...
trait ResponsiveEmbedProps
  extends reactLib.reactMod.HTMLProps[ResponsiveEmbed] {
...
object ResponsiveEmbedProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.HTMLProps[ResponsiveEmbed] = null,
