package typings
package reactDashBootstrapLib.libControlLabelMod
...
trait ControlLabelProps
  extends reactLib.reactMod.HTMLProps[ControlLabel] {
...
object ControlLabelProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.HTMLProps[ControlLabel] = null,
