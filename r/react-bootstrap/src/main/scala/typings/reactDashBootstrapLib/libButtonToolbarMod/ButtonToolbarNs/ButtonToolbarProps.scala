package typings
package reactDashBootstrapLib.libButtonToolbarMod.ButtonToolbarNs
...
trait ButtonToolbarProps
  extends reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libButtonToolbarMod.ButtonToolbar] {
...
object ButtonToolbarProps {
  @scala.inline
  def apply(
    HTMLProps: reactLib.reactMod.ReactNs.HTMLProps[reactDashBootstrapLib.libButtonToolbarMod.ButtonToolbar] = null,
