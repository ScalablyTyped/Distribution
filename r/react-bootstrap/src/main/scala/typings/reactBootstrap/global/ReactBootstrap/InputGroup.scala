...
@JSGlobal("ReactBootstrap.InputGroup")
@js.native
class InputGroup ()
  extends typings.reactBootstrap.mod.InputGroup
object InputGroup {
  ...
  @JSGlobal("ReactBootstrap.InputGroup.Addon")
  @js.native
  class Addon ()
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSGlobal("ReactBootstrap.InputGroup.Button")
  @js.native
  class Button ()
