...
object anon {
  ...
  object ActiveIndex {
    ...
    implicit class ActiveIndexMutableBuilder[Self <: ActiveIndex] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnSlideEnd(value: js.Function): Self = StObject.set(x, "onSlideEnd", value.asInstanceOf[js.Any])
  ...
  object BsClass {
    ...
    @scala.inline
    implicit class BsClassMutableBuilder[Self <: BsClass] (val x: Self) extends AnyVal {
  ...
  object Source {
    ...
    implicit class SourceMutableBuilder[Self <: Source] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSource(value: select | click | rootClose | keydown): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
    }
  }
}
