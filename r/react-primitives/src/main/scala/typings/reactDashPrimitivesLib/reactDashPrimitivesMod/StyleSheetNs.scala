...
object StyleSheetNs extends js.Object {
  ...
  def create[T /* <: reactDashNativeLib.reactDashNativeMod.StyleSheetNs.NamedStyles[T] */](styles: T): reactDashPrimitivesLib.reactDashPrimitivesLibStrings.create with T = js.native
