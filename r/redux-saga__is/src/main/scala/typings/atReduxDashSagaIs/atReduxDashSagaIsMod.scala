...
object atReduxDashSagaIsMod extends js.Object {
  val array: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify GuardPredicate<Array<any>> */ js.Any = js.native
  val buffer: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify GuardPredicate<Buffer<any>> */ js.Any = js.native
  val channel: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify GuardPredicate<Channel<any>> */ js.Any = js.native
  val effect: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify GuardPredicate<Effect> */ js.Any = js.native
  val func: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify GuardPredicate<Function> */ js.Any = js.native
  val iterable: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify GuardPredicate<Iterable<any>> */ js.Any = js.native
  val iterator: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify GuardPredicate<Iterator<any>> */ js.Any = js.native
