...
object atReduxDashSagaIsMod extends js.Object {
  ...
  val observable: atReduxDashSagaTypesLib.atReduxDashSagaTypesMod.GuardPredicate[atReduxDashSagaIsLib.Anon_Subscribe, js.Any] = js.native
  val pattern: atReduxDashSagaTypesLib.atReduxDashSagaTypesMod.GuardPredicate[
    atReduxDashSagaTypesLib.atReduxDashSagaTypesMod.Pattern[js.Any] | atReduxDashSagaTypesLib.atReduxDashSagaTypesMod.ActionPattern[reduxLib.reduxMod.Action[js.Any]], 
    js.Any
  ] = js.native
  ...
  val undef: atReduxDashSagaTypesLib.atReduxDashSagaTypesMod.GuardPredicate[js.UndefOr[scala.Nothing], js.Any] = js.native
}
