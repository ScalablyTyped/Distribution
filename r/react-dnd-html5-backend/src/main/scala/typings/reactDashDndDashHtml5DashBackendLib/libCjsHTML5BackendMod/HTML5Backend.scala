package typings
package reactDashDndDashHtml5DashBackendLib.libCjsHTML5BackendMod
...
trait HTML5Backend
  ...
  val window: js.UndefOr[reactDashDndDashHtml5DashBackendLib.libCjsHTML5BackendMod.Global.Window] = js.native
  def connectDragPreview(sourceId: java.lang.String, node: stdLib.Element, options: js.Any): js.Function0[scala.Unit] = js.native
  def connectDragSource(sourceId: java.lang.String, node: stdLib.Element, options: js.Any): js.Function0[scala.Unit] = js.native
  def connectDropTarget(targetId: java.lang.String, node: stdLib.HTMLElement): js.Function0[scala.Unit] = js.native
}
