...
object FormCell {
  ...
  @js.native
  def defaultProps: typings.reactWeui.anon.Radio = js.native
  inline def defaultProps_=(x: typings.reactWeui.anon.Radio): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
