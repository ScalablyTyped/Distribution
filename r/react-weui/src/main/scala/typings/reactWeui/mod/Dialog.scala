...
object Dialog {
  ...
  @JSImport("react-weui", "Dialog.defaultProps")
  @js.native
  def defaultProps: AutoDectect = js.native
  inline def defaultProps_=(x: AutoDectect): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
  ...
  object propTypes {
    ...
    object autoDectect {
      ...
      @JSImport("react-weui", "Dialog.propTypes.autoDectect")
      @js.native
      val ^ : js.Any = js.native
    ...
    object buttons {
      ...
      @JSImport("react-weui", "Dialog.propTypes.buttons")
      @js.native
      val ^ : js.Any = js.native
    ...
    object show {
      ...
      @JSImport("react-weui", "Dialog.propTypes.show")
      @js.native
      val ^ : js.Any = js.native
    ...
    object title {
      ...
      @JSImport("react-weui", "Dialog.propTypes.title")
      @js.native
      val ^ : js.Any = js.native
    ...
    object `type` {
      ...
      @JSImport("react-weui", "Dialog.propTypes.type")
      @js.native
      val ^ : js.Any = js.native
