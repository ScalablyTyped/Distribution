...
@js.native
object ButtonAreaNs extends js.Object {
  @JSName("propTypes")
  @js.native
  object propTypesNs extends js.Object {
    def direction(p0: js.Any, p1: js.Any, p2: js.Any, p3: js.Any, p4: js.Any, p5: js.Any): js.Any = js.native
    @JSName("direction")
    @js.native
    object directionNs extends js.Object {
