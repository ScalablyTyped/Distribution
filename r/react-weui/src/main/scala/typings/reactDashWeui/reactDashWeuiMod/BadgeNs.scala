...
object BadgeNs extends js.Object {
  ...
  object propTypesNs extends js.Object {
    def dot(p0: js.Any, p1: js.Any, p2: js.Any, p3: js.Any, p4: js.Any, p5: js.Any): js.Any = js.native
    def preset(p0: js.Any, p1: js.Any, p2: js.Any, p3: js.Any, p4: js.Any, p5: js.Any): js.Any = js.native
    @JSName("dot")
    @js.native
    ...
    @JSName("preset")
    @js.native
    object presetNs extends js.Object {
      def isRequired(p0: js.Any, p1: js.Any, p2: js.Any, p3: js.Any, p4: js.Any, p5: js.Any): js.Any = js.native
    }
