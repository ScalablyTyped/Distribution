...
import typings.reactSketchapp.libComponentsSvgMod.default
...
object libComponentsMod {
  ...
  open class Artboard protected ()
    extends typings.reactSketchapp.libComponentsArtboardMod.Artboard {
  ...
  open class Document protected ()
    extends typings.reactSketchapp.libComponentsDocumentMod.Document {
  ...
  open class Image protected ()
    extends typings.reactSketchapp.libComponentsImageMod.Image {
  ...
  open class Page protected ()
    extends typings.reactSketchapp.libComponentsPageMod.Page {
  ...
  open class RedBox protected ()
    extends typings.reactSketchapp.libComponentsRedBoxMod.RedBox {
  ...
  open class Text protected ()
    extends typings.reactSketchapp.libComponentsTextMod.Text {
  ...
  open class View protected ()
    extends typings.reactSketchapp.libComponentsViewMod.View {
