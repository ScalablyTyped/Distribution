...
import typings.reactSketchapp.libJsonUtilsMakeSvgLayerGraphicsTypesMod.Point
import typings.reactSketchapp.libJsonUtilsMakeSvgLayerGraphicsTypesMod.Size
