...
trait ViewStyle extends StObject {
...
object ViewStyle {
  ...
  extension [Self <: ViewStyle](x: Self) {
    ...
    inline def setBorderBottomStyle(value: BorderStyle): Self = StObject.set(x, "borderBottomStyle", value.asInstanceOf[js.Any])
    ...
    inline def setBorderLeftStyle(value: BorderStyle): Self = StObject.set(x, "borderLeftStyle", value.asInstanceOf[js.Any])
    ...
    inline def setBorderRightStyle(value: BorderStyle): Self = StObject.set(x, "borderRightStyle", value.asInstanceOf[js.Any])
    ...
    inline def setBorderTopStyle(value: BorderStyle): Self = StObject.set(x, "borderTopStyle", value.asInstanceOf[js.Any])
    ...
    inline def setOverflowX(value: Overflow): Self = StObject.set(x, "overflowX", value.asInstanceOf[js.Any])
    
    inline def setOverflowXUndefined: Self = StObject.set(x, "overflowX", js.undefined)
    
    inline def setOverflowY(value: Overflow): Self = StObject.set(x, "overflowY", value.asInstanceOf[js.Any])
    ...
    inline def setShadowInnerUndefined: Self = StObject.set(x, "shadowInner", js.undefined)
    ...
    inline def setShadowSpreadUndefined: Self = StObject.set(x, "shadowSpread", js.undefined)
