...
import typings.reactSketchapp.libModuleComponentsSvgMod.default
...
object libModuleComponentsMod {
  ...
  open class Artboard protected ()
    extends typings.reactSketchapp.libModuleComponentsArtboardMod.Artboard {
  ...
  open class Document protected ()
    extends typings.reactSketchapp.libModuleComponentsDocumentMod.Document {
  ...
  open class Image protected ()
    extends typings.reactSketchapp.libModuleComponentsImageMod.Image {
  ...
  open class Page protected ()
    extends typings.reactSketchapp.libModuleComponentsPageMod.Page {
  ...
  open class RedBox protected ()
    extends typings.reactSketchapp.libModuleComponentsRedBoxMod.RedBox {
  ...
  open class Text protected ()
    extends typings.reactSketchapp.libModuleComponentsTextMod.Text {
  ...
  open class View protected ()
    extends typings.reactSketchapp.libModuleComponentsViewMod.View {
