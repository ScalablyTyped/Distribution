...
object libModuleComponentsShadowsPropTypesMod {
  
  object ShadowsPropTypes {
    
    @JSImport("react-sketchapp/lib/module/components/ShadowsPropTypes", "ShadowsPropTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-sketchapp/lib/module/components/ShadowsPropTypes", "ShadowsPropTypes.shadowColor")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/module/components/ShadowsPropTypes", "ShadowsPropTypes.shadowInner")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/module/components/ShadowsPropTypes", "ShadowsPropTypes.shadowOffset")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/module/components/ShadowsPropTypes", "ShadowsPropTypes.shadowOpacity")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/module/components/ShadowsPropTypes", "ShadowsPropTypes.shadowRadius")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/module/components/ShadowsPropTypes", "ShadowsPropTypes.shadowSpread")
    @js.native
