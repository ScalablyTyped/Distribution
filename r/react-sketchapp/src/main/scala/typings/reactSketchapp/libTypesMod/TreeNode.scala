...
import typings.reactSketchapp.anon.TextNodesArray
...
trait TreeNode[Props] extends StObject {
  ...
  var props: Props & TextNodesArray
...
object TreeNode {
  ...
  inline def apply[Props](layout: LayoutInfo, props: Props & TextNodesArray, style: ViewStyle, `type`: String): TreeNode[Props] = {
  ...
  extension [Self <: TreeNode[?], Props](x: Self & TreeNode[Props]) {
    ...
    inline def setProps(value: Props & TextNodesArray): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
