...
object libModuleComponentsRedBoxMod {
  
  object ErrorBoxPropTypes {
    
    @JSImport("react-sketchapp/lib/module/components/RedBox", "ErrorBoxPropTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-sketchapp/lib/module/components/RedBox", "ErrorBoxPropTypes.error")
    @js.native
  ...
  @JSImport("react-sketchapp/lib/module/components/RedBox", "RedBox")
  @js.native
  ...
  object RedBox {
    ...
    @JSImport("react-sketchapp/lib/module/components/RedBox", "RedBox.defaultProps")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/module/components/RedBox", "RedBox.propTypes")
    @js.native
