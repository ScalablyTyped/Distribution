...
import typings.reactSketchapp.circleMod.Props
...
open class Circle protected ()
  extends typings.reactSketchapp.circleMod.Circle {
...
object Circle {
  ...
  @JSImport("react-sketchapp/lib/components/Svg", "Circle.defaultProps")
  @js.native
  ...
  @JSImport("react-sketchapp/lib/components/Svg", "Circle.propTypes")
  @js.native
