...
object lineMod {
  ...
  @JSImport("react-sketchapp/lib/components/Svg/Line", "Line")
  @js.native
  ...
  object Line {
    ...
    @JSImport("react-sketchapp/lib/components/Svg/Line", "Line.defaultProps")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/components/Svg/Line", "Line.propTypes")
    @js.native
