...
object libModuleComponentsSvgCircleMod {
  
  @JSImport("react-sketchapp/lib/module/components/Svg/Circle", "Circle")
  @js.native
  ...
  object Circle {
    ...
    @JSImport("react-sketchapp/lib/module/components/Svg/Circle", "Circle.defaultProps")
    @js.native
    ...
    @JSImport("react-sketchapp/lib/module/components/Svg/Circle", "Circle.propTypes")
    @js.native
