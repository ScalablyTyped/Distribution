...
import typings.reactSketchapp.libModuleComponentsSvgRadialGradientMod.Props
...
open class RadialGradient protected ()
  extends typings.reactSketchapp.libModuleComponentsSvgRadialGradientMod.RadialGradient {
