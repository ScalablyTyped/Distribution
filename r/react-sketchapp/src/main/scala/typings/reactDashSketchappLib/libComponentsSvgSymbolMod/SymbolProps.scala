...
trait SymbolProps extends js.Object {
  var children: js.Array[reactLib.reactMod.ReactNode] | reactLib.reactMod.ReactNode
...
object SymbolProps {
  @scala.inline
  def apply(
    children: js.Array[reactLib.reactMod.ReactNode] | reactLib.reactMod.ReactNode,
    id: java.lang.String,
