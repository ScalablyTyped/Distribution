...
trait EllipseProps
  ...
  var rx: reactDashSketchappLib.libComponentsSvgPropsMod.NumberProp
  var ry: reactDashSketchappLib.libComponentsSvgPropsMod.NumberProp
}
...
object EllipseProps {
  ...
  def apply(
    ...
    rx: reactDashSketchappLib.libComponentsSvgPropsMod.NumberProp,
    ry: reactDashSketchappLib.libComponentsSvgPropsMod.NumberProp,
