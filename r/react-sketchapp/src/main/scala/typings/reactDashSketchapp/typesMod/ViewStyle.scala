...
trait ViewStyle extends js.Object {
  ...
  var shadowOffset: js.UndefOr[Anon_HeightWidth] = js.undefined
...
object ViewStyle {
  ...
  def apply(
    ...
    shadowOffset: Anon_HeightWidth = null,
    ...
    if (!js.isUndefined(shadowInner)) __obj.updateDynamic("shadowInner")(shadowInner.asInstanceOf[js.Any])
