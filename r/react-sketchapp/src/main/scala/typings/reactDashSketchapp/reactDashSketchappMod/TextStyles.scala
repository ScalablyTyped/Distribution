...
import typings.reactDashSketchapp.Anon_ClearExistingStyles
...
object TextStyles extends js.Object {
  ...
  /**
    ...
    */
  def create(options: Anon_ClearExistingStyles, styles: StringDictionary[TextStyle]): js.Any = js.native
  /**
