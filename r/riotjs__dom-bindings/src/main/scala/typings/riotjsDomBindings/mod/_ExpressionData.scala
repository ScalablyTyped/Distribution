...
object _ExpressionData {
  ...
  @scala.inline
  def AttributeExpressionData(evaluate: js.Any => js.Any, name: String, `type`: ExpressionType): typings.riotjsDomBindings.mod.AttributeExpressionData = {
  ...
  @scala.inline
  def EventExpressionData(evaluate: js.Any => js.Any, name: String, `type`: ExpressionType): typings.riotjsDomBindings.mod.EventExpressionData = {
    val __obj = js.Dynamic.literal(evaluate = js.Any.fromFunction1(evaluate), name = name.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
  ...
  @scala.inline
  def TextExpressionData(childNodeIndex: Double, evaluate: js.Any => js.Any, `type`: ExpressionType): typings.riotjsDomBindings.mod.TextExpressionData = {
