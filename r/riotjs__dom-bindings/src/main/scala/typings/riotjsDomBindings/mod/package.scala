...
inline def bindingTypes: typings.riotjsDomBindings.mod.BindingType = typings.riotjsDomBindings.mod.^.asInstanceOf[js.Dynamic].selectDynamic("bindingTypes").asInstanceOf[typings.riotjsDomBindings.mod.BindingType]
...
inline def expressionTypes: typings.riotjsDomBindings.mod.ExpressionType = typings.riotjsDomBindings.mod.^.asInstanceOf[js.Dynamic].selectDynamic("expressionTypes").asInstanceOf[typings.riotjsDomBindings.mod.ExpressionType]
