...
trait NavigationLeafRouteNavigationParamsisDrawerOpenany extends js.Object {
  /**
...
object NavigationLeafRouteNavigationParamsisDrawerOpenany {
  @scala.inline
  def apply(
    index: Double,
    ...
    path: String = null
  ): NavigationLeafRouteNavigationParamsisDrawerOpenany = {
    ...
    __obj.asInstanceOf[NavigationLeafRouteNavigationParamsisDrawerOpenany]
  }
}
