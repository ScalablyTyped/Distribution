package typings.reactDashNavigationDashDrawer.libTypescriptSrcViewsDrawerMod
...
import typings.reactDashNavigationDashDrawer.Anon_Progress
...
object Props {
  ...
  def apply(
    ...
    onOpen: () => Unit,
    open: Boolean,
    renderDrawerContent: /* props */ Anon_Progress => ReactNode,
    renderSceneContent: /* props */ Anon_Progress => ReactNode,
