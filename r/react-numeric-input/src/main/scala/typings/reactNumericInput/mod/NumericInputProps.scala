...
import typings.reactNumericInput.reactNumericInputStrings.`additions removals`
import typings.reactNumericInput.reactNumericInputStrings.`additions text`
import typings.reactNumericInput.reactNumericInputStrings.`inline`
import typings.reactNumericInput.reactNumericInputStrings.`removals additions`
import typings.reactNumericInput.reactNumericInputStrings.`removals text`
import typings.reactNumericInput.reactNumericInputStrings.`text additions`
import typings.reactNumericInput.reactNumericInputStrings.`text removals`
import typings.reactNumericInput.reactNumericInputStrings.additions
import typings.reactNumericInput.reactNumericInputStrings.all
import typings.reactNumericInput.reactNumericInputStrings.ascending
import typings.reactNumericInput.reactNumericInputStrings.assertive
import typings.reactNumericInput.reactNumericInputStrings.auto
import typings.reactNumericInput.reactNumericInputStrings.both
import typings.reactNumericInput.reactNumericInputStrings.copy
import typings.reactNumericInput.reactNumericInputStrings.date
import typings.reactNumericInput.reactNumericInputStrings.decimal
import typings.reactNumericInput.reactNumericInputStrings.descending
import typings.reactNumericInput.reactNumericInputStrings.dialog
import typings.reactNumericInput.reactNumericInputStrings.done
import typings.reactNumericInput.reactNumericInputStrings.email
import typings.reactNumericInput.reactNumericInputStrings.enter
import typings.reactNumericInput.reactNumericInputStrings.execute
import typings.reactNumericInput.reactNumericInputStrings.go
import typings.reactNumericInput.reactNumericInputStrings.grammar
import typings.reactNumericInput.reactNumericInputStrings.grid
import typings.reactNumericInput.reactNumericInputStrings.horizontal
import typings.reactNumericInput.reactNumericInputStrings.inherit
import typings.reactNumericInput.reactNumericInputStrings.link
import typings.reactNumericInput.reactNumericInputStrings.list
import typings.reactNumericInput.reactNumericInputStrings.listbox
import typings.reactNumericInput.reactNumericInputStrings.location
import typings.reactNumericInput.reactNumericInputStrings.menu
import typings.reactNumericInput.reactNumericInputStrings.mixed
import typings.reactNumericInput.reactNumericInputStrings.move
import typings.reactNumericInput.reactNumericInputStrings.next
import typings.reactNumericInput.reactNumericInputStrings.no
import typings.reactNumericInput.reactNumericInputStrings.none
import typings.reactNumericInput.reactNumericInputStrings.numeric
import typings.reactNumericInput.reactNumericInputStrings.off
import typings.reactNumericInput.reactNumericInputStrings.on
import typings.reactNumericInput.reactNumericInputStrings.other
import typings.reactNumericInput.reactNumericInputStrings.page
import typings.reactNumericInput.reactNumericInputStrings.polite
import typings.reactNumericInput.reactNumericInputStrings.popup
import typings.reactNumericInput.reactNumericInputStrings.previous
import typings.reactNumericInput.reactNumericInputStrings.removals
import typings.reactNumericInput.reactNumericInputStrings.search
import typings.reactNumericInput.reactNumericInputStrings.send
import typings.reactNumericInput.reactNumericInputStrings.spelling
import typings.reactNumericInput.reactNumericInputStrings.step
import typings.reactNumericInput.reactNumericInputStrings.tel
import typings.reactNumericInput.reactNumericInputStrings.text
import typings.reactNumericInput.reactNumericInputStrings.time
import typings.reactNumericInput.reactNumericInputStrings.tree
import typings.reactNumericInput.reactNumericInputStrings.url
import typings.reactNumericInput.reactNumericInputStrings.vertical
import typings.reactNumericInput.reactNumericInputStrings.yes
...
/* Inlined parent react-numeric-input.react-numeric-input.Omit<react.react.InputHTMLAttributes<std.HTMLInputElement>, 'min' | 'max' | 'step' | 'onChange' | 'defaultValue' | 'onInvalid' | 'style'> */
@js.native
trait NumericInputProps extends js.Object {
  ...
  var format: js.UndefOr[js.Function1[/* value */ Double | Null, String]] = js.native
  ...
  var max: js.UndefOr[BoundsFunctionProp] = js.native
  
  var maxLength: js.UndefOr[Double] = js.native
  
  var min: js.UndefOr[BoundsFunctionProp] = js.native
  
  var minLength: js.UndefOr[Double] = js.native
  
  var mobile: js.UndefOr[Boolean | auto | (js.Function1[/* component */ NumericInput, Boolean])] = js.native
  ...
  var onBlur: js.UndefOr[FocusEventHandler[HTMLDivElement | HTMLInputElement]] = js.native
  ...
  var onFocus: js.UndefOr[FocusEventHandler[HTMLDivElement | HTMLInputElement]] = js.native
  ...
  var onKeyDown: js.UndefOr[KeyboardEventHandler[HTMLDivElement | HTMLInputElement]] = js.native
  ...
  var onValid: js.UndefOr[js.Function2[/* value */ Double | Null, /* stringValue */ String, Unit]] = js.native
  ...
  var parse: js.UndefOr[js.Function1[/* stringValue */ String, Double | Null]] = js.native
  
  var pattern: js.UndefOr[String] = js.native
  
  var placeholder: js.UndefOr[String] = js.native
  
  var precision: js.UndefOr[Double | (js.Function1[/* component */ NumericInput, js.UndefOr[Double | Null]])] = js.native
  ...
  var style: js.UndefOr[StringDictionary[CSSProperties] | Boolean] = js.native
...
object NumericInputProps {
  ...
  @scala.inline
  def apply(): NumericInputProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NumericInputProps]
  }
  
  @scala.inline
  implicit class NumericInputPropsOps[Self <: NumericInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormat(value: /* value */ Double | Null => String): Self = this.set("format", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setMaxFunction1(value: /* component */ NumericInput => js.UndefOr[Double]): Self = this.set("max", js.Any.fromFunction1(value))
    
    @scala.inline
    def setMax(value: BoundsFunctionProp): Self = this.set("max", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMinFunction1(value: /* component */ NumericInput => js.UndefOr[Double]): Self = this.set("min", js.Any.fromFunction1(value))
    
    @scala.inline
    def setMin(value: BoundsFunctionProp): Self = this.set("min", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMobileFunction1(value: /* component */ NumericInput => Boolean): Self = this.set("mobile", js.Any.fromFunction1(value))
    
    @scala.inline
    def setMobile(value: Boolean | auto | (js.Function1[/* component */ NumericInput, Boolean])): Self = this.set("mobile", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNoValidate(value: Boolean | String): Self = this.set("noValidate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnBlur(value: FocusEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = this.set("onBlur", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnChange(value: (/* value */ Double | Null, /* stringValue */ String, /* input */ HTMLInputElement) => Unit): Self = this.set("onChange", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setOnFocus(value: FocusEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = this.set("onFocus", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnInvalid(value: (/* error */ String, /* value */ Double | Null, /* stringValue */ String) => Unit): Self = this.set("onInvalid", js.Any.fromFunction3(value))
    
    @scala.inline
    def deleteOnInvalid: Self = this.set("onInvalid", js.undefined)
    
    @scala.inline
    def setOnKeyDown(value: KeyboardEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnValid(value: (/* value */ Double | Null, /* stringValue */ String) => Unit): Self = this.set("onValid", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setParse(value: /* stringValue */ String => Double | Null): Self = this.set("parse", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setPrecisionFunction1(value: /* component */ NumericInput => js.UndefOr[Double | Null]): Self = this.set("precision", js.Any.fromFunction1(value))
    
    @scala.inline
    def setPrecision(value: Double | (js.Function1[/* component */ NumericInput, js.UndefOr[Double | Null]])): Self = this.set("precision", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStepFunction2(value: (/* component */ NumericInput, /* direction */ String) => js.UndefOr[Double]): Self = this.set("step", js.Any.fromFunction2(value))
    
    @scala.inline
    def setStep(
      value: Double | (js.Function2[/* component */ NumericInput, /* direction */ String, js.UndefOr[Double]])
    ): Self = this.set("step", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStyle(value: StringDictionary[CSSProperties] | Boolean): Self = this.set("style", value.asInstanceOf[js.Any])
