...
object mod {
  ...
  object NumericInputProps {
    ...
    implicit class NumericInputPropsMutableBuilder[Self <: NumericInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMaxFunction1(value: /* component */ NumericInput => js.UndefOr[Double]): Self = StObject.set(x, "max", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setMinFunction1(value: /* component */ NumericInput => js.UndefOr[Double]): Self = StObject.set(x, "min", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setMobile(value: Boolean | auto | (js.Function1[/* component */ NumericInput, Boolean])): Self = StObject.set(x, "mobile", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMobileFunction1(value: /* component */ NumericInput => Boolean): Self = StObject.set(x, "mobile", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnBlur(value: FocusEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnFocus(value: FocusEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnKeyDown(value: KeyboardEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setPrecision(value: Double | (js.Function1[/* component */ NumericInput, js.UndefOr[Double | Null]])): Self = StObject.set(x, "precision", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPrecisionFunction1(value: /* component */ NumericInput => js.UndefOr[Double | Null]): Self = StObject.set(x, "precision", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setStepFunction2(value: (/* component */ NumericInput, /* direction */ String) => js.UndefOr[Double]): Self = StObject.set(x, "step", js.Any.fromFunction2(value))
