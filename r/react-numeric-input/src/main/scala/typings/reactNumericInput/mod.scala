...
object mod {
  ...
  object NumericInputProps {
    ...
    extension [Self <: NumericInputProps](x: Self) {
      ...
      inline def setOnBlur(value: FocusEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      inline def setOnFocus(value: FocusEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
