...
import typings.reactNumericInput.reactNumericInputStrings._empty
...
import typings.reactNumericInput.reactNumericInputStrings.`use-credentials`
...
import typings.reactNumericInput.reactNumericInputStrings.anonymous
...
import typings.reactNumericInput.reactNumericInputStrings.environment
...
import typings.reactNumericInput.reactNumericInputStrings.user
...
object mod {
  ...
  type NumericInput = Component[NumericInputProps, NumericInputState, Any]
  ...
  object NumericInputProps {
    ...
    implicit open class MutableBuilder[Self <: NumericInputProps] (val x: Self) extends AnyVal {
      ...
      inline def setMaxFunction1(value: /* component */ NumericInput => js.UndefOr[Double]): Self = StObject.set(x, "max", js.Any.fromFunction1(value))
      ...
      inline def setMinFunction1(value: /* component */ NumericInput => js.UndefOr[Double]): Self = StObject.set(x, "min", js.Any.fromFunction1(value))
      ...
      inline def setMobile(value: Boolean | auto | (js.Function1[/* component */ NumericInput, Boolean])): Self = StObject.set(x, "mobile", value.asInstanceOf[js.Any])
      
      inline def setMobileFunction1(value: /* component */ NumericInput => Boolean): Self = StObject.set(x, "mobile", js.Any.fromFunction1(value))
      ...
      inline def setOnBlur(value: FocusEvent[HTMLDivElement | HTMLInputElement, Element] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      inline def setOnChange(value: (/* value */ Double | Null, /* stringValue */ String, /* input */ HTMLInputElement) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction3(value))
      ...
      inline def setOnFocus(value: FocusEvent[HTMLDivElement | HTMLInputElement, Element] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
      ...
      inline def setOnInvalid(value: (/* error */ String, /* value */ Double | Null, /* stringValue */ String) => Unit): Self = StObject.set(x, "onInvalid", js.Any.fromFunction3(value))
      
      inline def setOnInvalidUndefined: Self = StObject.set(x, "onInvalid", js.undefined)
      
      inline def setOnKeyDown(value: KeyboardEvent[HTMLDivElement | HTMLInputElement] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      ...
      inline def setOnValid(value: (/* value */ Double | Null, /* stringValue */ String) => Unit): Self = StObject.set(x, "onValid", js.Any.fromFunction2(value))
      ...
      inline def setPrecision(value: Double | (js.Function1[/* component */ NumericInput, js.UndefOr[Double | Null]])): Self = StObject.set(x, "precision", value.asInstanceOf[js.Any])
      
      inline def setPrecisionFunction1(value: /* component */ NumericInput => js.UndefOr[Double | Null]): Self = StObject.set(x, "precision", js.Any.fromFunction1(value))
      ...
      inline def setStepFunction2(value: (/* component */ NumericInput, /* direction */ String) => js.UndefOr[Double]): Self = StObject.set(x, "step", js.Any.fromFunction2(value))
