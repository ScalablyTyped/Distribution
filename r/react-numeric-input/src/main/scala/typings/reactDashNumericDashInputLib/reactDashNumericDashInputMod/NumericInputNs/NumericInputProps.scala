...
- Dropped {[ P in std.Exclude<keyof react.react.React.InputHTMLAttributes<std.HTMLInputElement>, 'min' | 'max' | 'step' | 'onChange' | 'defaultValue' | 'onInvalid' | 'style'> ]: react.react.React.InputHTMLAttributes<std.HTMLInputElement>[P]} */ trait NumericInputProps extends js.Object {
  ...
  var onBlur: js.UndefOr[
    reactLib.reactMod.ReactNs.FocusEventHandler[stdLib.HTMLDivElement | stdLib.HTMLInputElement]
  ] = js.undefined
  ...
  var onInput: js.UndefOr[reactLib.reactMod.ReactNs.FormEventHandler[stdLib.HTMLInputElement]] = js.undefined
  ...
  var onKeyDown: js.UndefOr[
    reactLib.reactMod.ReactNs.KeyboardEventHandler[stdLib.HTMLDivElement | stdLib.HTMLInputElement]
  ] = js.undefined
  var onSelect: js.UndefOr[reactLib.reactMod.ReactNs.ReactEventHandler[stdLib.HTMLInputElement]] = js.undefined
...
object NumericInputProps {
  ...
  def apply(
    ...
    onBlur: reactLib.reactMod.ReactNs.FocusEventHandler[stdLib.HTMLDivElement | stdLib.HTMLInputElement] = null,
    onChange: (/* value */ scala.Double | scala.Null, /* stringValue */ java.lang.String, /* input */ stdLib.HTMLInputElement) => scala.Unit = null,
    onFocus: reactLib.reactMod.ReactNs.FocusEventHandler[stdLib.HTMLDivElement | stdLib.HTMLInputElement] = null,
    onInput: reactLib.reactMod.ReactNs.FormEventHandler[stdLib.HTMLInputElement] = null,
    onInvalid: (/* error */ java.lang.String, /* value */ scala.Double | scala.Null, /* stringValue */ java.lang.String) => scala.Unit = null,
    onKeyDown: reactLib.reactMod.ReactNs.KeyboardEventHandler[stdLib.HTMLDivElement | stdLib.HTMLInputElement] = null,
    onSelect: reactLib.reactMod.ReactNs.ReactEventHandler[stdLib.HTMLInputElement] = null,
