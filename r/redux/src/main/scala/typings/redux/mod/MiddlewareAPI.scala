...
object MiddlewareAPI {
  ...
  @scala.inline
  implicit class MiddlewareAPIOps[Self <: MiddlewareAPI[_, _], /* <: typings.redux.mod.Dispatch[typings.redux.mod.AnyAction] */ D, S] (val x: Self with (MiddlewareAPI[D, S])) extends AnyVal {
    @scala.inline
