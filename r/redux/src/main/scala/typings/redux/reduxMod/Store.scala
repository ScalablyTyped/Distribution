...
trait Store[S, A /* <: Action[_] */] extends js.Object {
  ...
  /**
    ...
    */
  def replaceReducer(nextReducer: Reducer[S, A]): /* import warning: importer.ImportType#apply Failed type conversion: void[/ * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Symbol.observable * / any] */ js.Any = js.native
  /**
