...
object Dispatch {
  ...
  @scala.inline
  implicit class DispatchOps[Self <: Dispatch[_], Ext1] (val x: Self with Dispatch[Ext1]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDispatch(value: Ext1): Self = this.set("dispatch", value.asInstanceOf[js.Any])
  }
