...
object sheetMod {
  ...
  object AllowedDialogProps {
    ...
    @scala.inline
    implicit class AllowedDialogPropsMutableBuilder[Self <: AllowedDialogProps] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait BaseSheetProps extends AllowedDialogProps {
  ...
  object BaseSheetProps {
    ...
    @scala.inline
    def apply(id: String, onRequestClose: () => Unit, visible: Boolean): BaseSheetProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], onRequestClose = js.Any.fromFunction0(onRequestClose), visible = visible.asInstanceOf[js.Any])
      __obj.asInstanceOf[BaseSheetProps]
    }
    
    @scala.inline
    implicit class BaseSheetPropsMutableBuilder[Self <: BaseSheetProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setHorizontalSize(value: SheetHorizontalSize): Self = StObject.set(x, "horizontalSize", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHorizontalSizeUndefined: Self = StObject.set(x, "horizontalSize", js.undefined)
      
      @scala.inline
      def setPosition(value: SheetPosition): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPositionUndefined: Self = StObject.set(x, "position", js.undefined)
      
      @scala.inline
      def setRole(value: dialog | menu | none): Self = StObject.set(x, "role", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRoleUndefined: Self = StObject.set(x, "role", js.undefined)
      
      @scala.inline
      def setVerticalSize(value: SheetVerticalSize): Self = StObject.set(x, "verticalSize", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object SheetHorizontalSize {
    ...
    @scala.inline
    def media: typings.reactMdSheet.reactMdSheetStrings.media = "media".asInstanceOf[typings.reactMdSheet.reactMdSheetStrings.media]
    
    @scala.inline
    def none: typings.reactMdSheet.reactMdSheetStrings.none = "none".asInstanceOf[typings.reactMdSheet.reactMdSheetStrings.none]
    
    @scala.inline
    def static: typings.reactMdSheet.reactMdSheetStrings.static = "static".asInstanceOf[typings.reactMdSheet.reactMdSheetStrings.static]
