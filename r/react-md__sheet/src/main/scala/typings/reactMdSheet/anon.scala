...
object anon {
  ...
  object PickBaseSheetPropshiddenv {
    ...
    inline def apply(`aria-label`: String, id: String, onRequestClose: () => Unit, visible: Boolean): PickBaseSheetPropshiddenv = {
    ...
    extension [Self <: PickBaseSheetPropshiddenv](x: Self) {
  ...
  object PickBaseSheetPropshiddenvAbout {
    ...
    inline def apply(`aria-labelledby`: String, id: String, onRequestClose: () => Unit, visible: Boolean): PickBaseSheetPropshiddenvAbout = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], onRequestClose = js.Any.fromFunction0(onRequestClose), visible = visible.asInstanceOf[js.Any])
      __obj.updateDynamic("aria-labelledby")(`aria-labelledby`.asInstanceOf[js.Any])
      __obj.asInstanceOf[PickBaseSheetPropshiddenvAbout]
    }
    
    extension [Self <: PickBaseSheetPropshiddenvAbout](x: Self) {
