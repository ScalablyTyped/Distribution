...
trait DOMEventTarget extends StObject {
  ...
  def addEventListener(`type`: String, listener: js.Function1[/* e */ js.Any, js.Any], useCapture: Boolean): Unit
  
  def removeEventListener(`type`: String, listener: js.Function1[/* e */ js.Any, js.Any], useCapture: Boolean): Unit
}
