...
trait ObservableStatic extends js.Object {
  ...
  @JSName("fromNodeCallback")
  def fromNodeCallback_T1T2TR[T1, T2, TR](func: js.Function3[/* arg1 */ T1, /* arg2 */ T2, /* callback */ js.Function, _]): js.Function2[/* arg1 */ T1, /* arg2 */ T2, Observable[TR]] = js.native
  @JSName("fromNodeCallback")
  def fromNodeCallback_T1T2TR[T1, T2, TR](func: js.Function3[/* arg1 */ T1, /* arg2 */ T2, /* callback */ js.Function, _], context: js.Any): js.Function2[/* arg1 */ T1, /* arg2 */ T2, Observable[TR]] = js.native
  @JSName("fromNodeCallback")
