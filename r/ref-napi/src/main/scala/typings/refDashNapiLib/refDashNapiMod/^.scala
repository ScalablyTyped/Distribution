...
object ^ extends js.Object {
  ...
  def alloc(`type`: refDashNapiLib.refDashNapiMod.Type): nodeLib.Buffer = js.native
  def alloc(`type`: refDashNapiLib.refDashNapiMod.Type, value: js.Any): nodeLib.Buffer = js.native
  ...
  def coerceType(`type`: java.lang.String): refDashNapiLib.refDashNapiMod.Type = js.native
  def coerceType(`type`: refDashNapiLib.refDashNapiMod.Type): refDashNapiLib.refDashNapiMod.Type = js.native
  def deref(buffer: nodeLib.Buffer): js.Any = js.native
  def derefType(`type`: java.lang.String): refDashNapiLib.refDashNapiMod.Type = js.native
  def derefType(`type`: refDashNapiLib.refDashNapiMod.Type): refDashNapiLib.refDashNapiMod.Type = js.native
  ...
  def get(buffer: nodeLib.Buffer, offset: scala.Double, `type`: refDashNapiLib.refDashNapiMod.Type): js.Any = js.native
  def getType(buffer: nodeLib.Buffer): refDashNapiLib.refDashNapiMod.Type = js.native
  ...
  def refType(`type`: java.lang.String): refDashNapiLib.refDashNapiMod.Type = js.native
  def refType(`type`: refDashNapiLib.refDashNapiMod.Type): refDashNapiLib.refDashNapiMod.Type = js.native
  ...
  def set(
    ...
    offset: scala.Double,
    value: js.Any,
    `type`: refDashNapiLib.refDashNapiMod.Type
