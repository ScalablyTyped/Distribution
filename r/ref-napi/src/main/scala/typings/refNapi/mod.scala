...
object mod {
  ...
  inline def alloc_CString(`type`: CString): (Value[Any | UnderlyingType[CString]]) | UnderlyingType[CString] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[CString]]) | UnderlyingType[CString]]
  inline def alloc_CString(`type`: CString, value: UnderlyingType[CString]): (Value[Any | UnderlyingType[CString]]) | UnderlyingType[CString] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[CString]]) | UnderlyingType[CString]]
  ...
  inline def alloc_byte(`type`: byte): (Value[Any | UnderlyingType[byte]]) | UnderlyingType[byte] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[byte]]) | UnderlyingType[byte]]
  inline def alloc_byte(`type`: byte, value: UnderlyingType[byte]): (Value[Any | UnderlyingType[byte]]) | UnderlyingType[byte] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[byte]]) | UnderlyingType[byte]]
  
  inline def alloc_char(`type`: char): (Value[Any | UnderlyingType[char]]) | UnderlyingType[char] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[char]]) | UnderlyingType[char]]
  inline def alloc_char(`type`: char, value: UnderlyingType[char]): (Value[Any | UnderlyingType[char]]) | UnderlyingType[char] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[char]]) | UnderlyingType[char]]
  
  inline def alloc_double(`type`: double): (Value[Any | UnderlyingType[double]]) | UnderlyingType[double] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[double]]) | UnderlyingType[double]]
  inline def alloc_double(`type`: double, value: UnderlyingType[double]): (Value[Any | UnderlyingType[double]]) | UnderlyingType[double] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[double]]) | UnderlyingType[double]]
  
  inline def alloc_float(`type`: float): (Value[Any | UnderlyingType[float]]) | UnderlyingType[float] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[float]]) | UnderlyingType[float]]
  inline def alloc_float(`type`: float, value: UnderlyingType[float]): (Value[Any | UnderlyingType[float]]) | UnderlyingType[float] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[float]]) | UnderlyingType[float]]
  
  inline def alloc_int(`type`: int): (Value[Any | UnderlyingType[int]]) | UnderlyingType[int] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[int]]) | UnderlyingType[int]]
  inline def alloc_int(`type`: int, value: UnderlyingType[int]): (Value[Any | UnderlyingType[int]]) | UnderlyingType[int] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[int]]) | UnderlyingType[int]]
  
  inline def alloc_int16(`type`: int16): (Value[Any | UnderlyingType[int16]]) | UnderlyingType[int16] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[int16]]) | UnderlyingType[int16]]
  inline def alloc_int16(`type`: int16, value: UnderlyingType[int16]): (Value[Any | UnderlyingType[int16]]) | UnderlyingType[int16] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[int16]]) | UnderlyingType[int16]]
  
  inline def alloc_int32(`type`: int32): (Value[Any | UnderlyingType[int32]]) | UnderlyingType[int32] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[int32]]) | UnderlyingType[int32]]
  inline def alloc_int32(`type`: int32, value: UnderlyingType[int32]): (Value[Any | UnderlyingType[int32]]) | UnderlyingType[int32] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[int32]]) | UnderlyingType[int32]]
  
  inline def alloc_int64(`type`: int64): (Value[Any | UnderlyingType[int64]]) | UnderlyingType[int64] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[int64]]) | UnderlyingType[int64]]
  inline def alloc_int64(`type`: int64, value: UnderlyingType[int64]): (Value[Any | UnderlyingType[int64]]) | UnderlyingType[int64] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[int64]]) | UnderlyingType[int64]]
  
  inline def alloc_int8(`type`: int8): (Value[Any | UnderlyingType[int8]]) | UnderlyingType[int8] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[int8]]) | UnderlyingType[int8]]
  inline def alloc_int8(`type`: int8, value: UnderlyingType[int8]): (Value[Any | UnderlyingType[int8]]) | UnderlyingType[int8] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[int8]]) | UnderlyingType[int8]]
  
  inline def alloc_long(`type`: long): (Value[Any | UnderlyingType[long]]) | UnderlyingType[long] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[long]]) | UnderlyingType[long]]
  inline def alloc_long(`type`: long, value: UnderlyingType[long]): (Value[Any | UnderlyingType[long]]) | UnderlyingType[long] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[long]]) | UnderlyingType[long]]
  
  inline def alloc_longlong(`type`: longlong): (Value[Any | UnderlyingType[longlong]]) | UnderlyingType[longlong] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[longlong]]) | UnderlyingType[longlong]]
  inline def alloc_longlong(`type`: longlong, value: UnderlyingType[longlong]): (Value[Any | UnderlyingType[longlong]]) | UnderlyingType[longlong] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[longlong]]) | UnderlyingType[longlong]]
  
  inline def alloc_short(`type`: short): (Value[Any | UnderlyingType[short]]) | UnderlyingType[short] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[short]]) | UnderlyingType[short]]
  inline def alloc_short(`type`: short, value: UnderlyingType[short]): (Value[Any | UnderlyingType[short]]) | UnderlyingType[short] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[short]]) | UnderlyingType[short]]
  
  inline def alloc_sizet(`type`: size_t): (Value[Any | UnderlyingType[size_t]]) | UnderlyingType[size_t] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[size_t]]) | UnderlyingType[size_t]]
  inline def alloc_sizet(`type`: size_t, value: UnderlyingType[size_t]): (Value[Any | UnderlyingType[size_t]]) | UnderlyingType[size_t] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[size_t]]) | UnderlyingType[size_t]]
  
  inline def alloc_uchar(`type`: uchar): (Value[Any | UnderlyingType[uchar]]) | UnderlyingType[uchar] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[uchar]]) | UnderlyingType[uchar]]
  inline def alloc_uchar(`type`: uchar, value: UnderlyingType[uchar]): (Value[Any | UnderlyingType[uchar]]) | UnderlyingType[uchar] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[uchar]]) | UnderlyingType[uchar]]
  
  inline def alloc_uint(`type`: uint): (Value[Any | UnderlyingType[uint]]) | UnderlyingType[uint] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[uint]]) | UnderlyingType[uint]]
  inline def alloc_uint(`type`: uint, value: UnderlyingType[uint]): (Value[Any | UnderlyingType[uint]]) | UnderlyingType[uint] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[uint]]) | UnderlyingType[uint]]
  
  inline def alloc_uint16(`type`: uint16): (Value[Any | UnderlyingType[uint16]]) | UnderlyingType[uint16] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[uint16]]) | UnderlyingType[uint16]]
  inline def alloc_uint16(`type`: uint16, value: UnderlyingType[uint16]): (Value[Any | UnderlyingType[uint16]]) | UnderlyingType[uint16] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[uint16]]) | UnderlyingType[uint16]]
  
  inline def alloc_uint32(`type`: uint32): (Value[Any | UnderlyingType[uint32]]) | UnderlyingType[uint32] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[uint32]]) | UnderlyingType[uint32]]
  inline def alloc_uint32(`type`: uint32, value: UnderlyingType[uint32]): (Value[Any | UnderlyingType[uint32]]) | UnderlyingType[uint32] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[uint32]]) | UnderlyingType[uint32]]
  
  inline def alloc_uint64(`type`: uint64): (Value[Any | UnderlyingType[uint64]]) | UnderlyingType[uint64] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[uint64]]) | UnderlyingType[uint64]]
  inline def alloc_uint64(`type`: uint64, value: UnderlyingType[uint64]): (Value[Any | UnderlyingType[uint64]]) | UnderlyingType[uint64] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[uint64]]) | UnderlyingType[uint64]]
  
  inline def alloc_uint8(`type`: uint8): (Value[Any | UnderlyingType[uint8]]) | UnderlyingType[uint8] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[uint8]]) | UnderlyingType[uint8]]
  inline def alloc_uint8(`type`: uint8, value: UnderlyingType[uint8]): (Value[Any | UnderlyingType[uint8]]) | UnderlyingType[uint8] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[uint8]]) | UnderlyingType[uint8]]
  
  inline def alloc_ulong(`type`: ulong): (Value[Any | UnderlyingType[ulong]]) | UnderlyingType[ulong] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[ulong]]) | UnderlyingType[ulong]]
  inline def alloc_ulong(`type`: ulong, value: UnderlyingType[ulong]): (Value[Any | UnderlyingType[ulong]]) | UnderlyingType[ulong] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[ulong]]) | UnderlyingType[ulong]]
  
  inline def alloc_ulonglong(`type`: ulonglong): (Value[Any | UnderlyingType[ulonglong]]) | UnderlyingType[ulonglong] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[ulonglong]]) | UnderlyingType[ulonglong]]
  inline def alloc_ulonglong(`type`: ulonglong, value: UnderlyingType[ulonglong]): (Value[Any | UnderlyingType[ulonglong]]) | UnderlyingType[ulonglong] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[ulonglong]]) | UnderlyingType[ulonglong]]
  
  inline def alloc_ushort(`type`: ushort): (Value[Any | UnderlyingType[ushort]]) | UnderlyingType[ushort] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[ushort]]) | UnderlyingType[ushort]]
  inline def alloc_ushort(`type`: ushort, value: UnderlyingType[ushort]): (Value[Any | UnderlyingType[ushort]]) | UnderlyingType[ushort] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[ushort]]) | UnderlyingType[ushort]]
  
  inline def alloc_void(`type`: void): (Value[Any | UnderlyingType[void]]) | UnderlyingType[void] = ^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any]).asInstanceOf[(Value[Any | UnderlyingType[void]]) | UnderlyingType[void]]
  inline def alloc_void(`type`: void, value: UnderlyingType[void]): (Value[Any | UnderlyingType[void]]) | UnderlyingType[void] = (^.asInstanceOf[js.Dynamic].applyDynamic("alloc")(`type`.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[(Value[Any | UnderlyingType[void]]) | UnderlyingType[void]]
  ...
  */
  ...
  type UnderlyingType[T /* <: TypeLike */] = (// Treat this as a `Pointer` to the underlying type.
  Any) | (// `void*` is a `Pointer` to some unknown value.
  Pointer[Any | Double]) | Buffer | String | Null | (/* import warning: importer.ImportType#apply Failed type conversion: ref-napi.ref-napi.UnderlyingTypeRegistry[T] */ js.Any)
