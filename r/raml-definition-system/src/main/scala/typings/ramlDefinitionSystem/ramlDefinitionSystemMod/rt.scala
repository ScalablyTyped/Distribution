...
object rt {
  ...
  inline def toNominal(
    t: IParsedType,
    bt: js.Function1[/* name */ String, typings.ramlTypesystem.nominalTypesMod.ITypeDefinition]
  ): typings.ramlTypesystem.nominalTypesMod.ITypeDefinition = (^.asInstanceOf[js.Dynamic].applyDynamic("toNominal")(t.asInstanceOf[js.Any], bt.asInstanceOf[js.Any])).asInstanceOf[typings.ramlTypesystem.nominalTypesMod.ITypeDefinition]
