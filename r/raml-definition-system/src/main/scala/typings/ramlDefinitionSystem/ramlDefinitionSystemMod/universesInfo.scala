...
object universesInfo {
  ...
  @JSImport("raml-definition-system", "universesInfo")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("raml-definition-system", "universesInfo.Universe08")
  @js.native
  ...
  @JSImport("raml-definition-system", "universesInfo.Universe10")
  @js.native
