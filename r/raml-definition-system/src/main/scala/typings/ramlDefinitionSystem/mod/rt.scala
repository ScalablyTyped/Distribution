...
object rt {
  ...
  @JSImport("raml-definition-system", "rt")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("raml-definition-system", "rt.DEFINED_IN_TYPES_EXTRA")
  @js.native
  ...
  @JSImport("raml-definition-system", "rt.NodeKind")
  @js.native
  ...
  @JSImport("raml-definition-system", "rt.SOURCE_EXTRA")
  @js.native
  ...
  @JSImport("raml-definition-system", "rt.TOP_LEVEL_EXTRA")
  @js.native
  ...
  @JSImport("raml-definition-system", "rt.TypeConstructor")
  @js.native
  open class TypeConstructor protected ()
    extends typings.ramlTypesystem.mod.TypeConstructor {
    def this(target: IParsedType) = this()
  }
  
  @JSImport("raml-definition-system", "rt.USER_DEFINED_EXTRA")
  @js.native
  ...
  inline def dump(ts: IParsedType): ITypeCollection | typings.ramlTypesystem.mod.IType = ^.asInstanceOf[js.Dynamic].applyDynamic("dump")(ts.asInstanceOf[js.Any]).asInstanceOf[ITypeCollection | typings.ramlTypesystem.mod.IType]
  inline def dump(ts: IParsedTypeCollection): ITypeCollection | typings.ramlTypesystem.mod.IType = ^.asInstanceOf[js.Dynamic].applyDynamic("dump")(ts.asInstanceOf[js.Any]).asInstanceOf[ITypeCollection | typings.ramlTypesystem.mod.IType]
  ...
  inline def loadType(data: typings.ramlTypesystem.mod.IType): IParsedType = ^.asInstanceOf[js.Dynamic].applyDynamic("loadType")(data.asInstanceOf[js.Any]).asInstanceOf[IParsedType]
  ...
  @JSImport("raml-definition-system", "rt.messageRegistry")
  @js.native
  ...
  object nominalInterfaces {
    ...
    @JSImport("raml-definition-system", "rt.nominalInterfaces.ValueRequirement")
    @js.native
    open class ValueRequirement protected ()
      extends typings.ramlTypesystem.mod.nominalInterfaces.ValueRequirement {
      /**
        *
  ...
  object nominalTypes {
    ...
    @JSImport("raml-definition-system", "rt.nominalTypes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("raml-definition-system", "rt.nominalTypes.AbstractType")
    @js.native
    open class AbstractType protected ()
      extends typings.ramlTypesystem.mod.nominalTypes.AbstractType {
    ...
    @JSImport("raml-definition-system", "rt.nominalTypes.Adaptable")
    @js.native
    open class Adaptable ()
      extends typings.ramlTypesystem.mod.nominalTypes.Adaptable
    /* static members */
    object Adaptable {
      ...
      @JSImport("raml-definition-system", "rt.nominalTypes.Adaptable.CLASS_IDENTIFIER_Adaptable")
      @js.native
    ...
    @JSImport("raml-definition-system", "rt.nominalTypes.Annotation")
    @js.native
    open class Annotation protected ()
      extends typings.ramlTypesystem.mod.nominalTypes.Annotation {
      def this(`type`: IAnnotationType, parameters: StringDictionary[Any]) = this()
    }
    
    @JSImport("raml-definition-system", "rt.nominalTypes.Array")
    @js.native
    open class Array protected ()
      extends typings.ramlTypesystem.mod.nominalTypes.Array {
      def this(_name: String) = this()
      def this(_name: String, _universe: IUniverse) = this()
      def this(_name: String, _universe: Unit, _path: String) = this()
      def this(_name: String, _universe: IUniverse, _path: String) = this()
    ...
    @JSImport("raml-definition-system", "rt.nominalTypes.Described")
    @js.native
    open class Described protected ()
      extends typings.ramlTypesystem.mod.nominalTypes.Described {
      def this(_name: String) = this()
    ...
    object Described {
      ...
      @JSImport("raml-definition-system", "rt.nominalTypes.Described.CLASS_IDENTIFIER_Described")
      @js.native
    ...
    @JSImport("raml-definition-system", "rt.nominalTypes.Empty")
    @js.native
    open class Empty ()
      extends typings.ramlTypesystem.mod.nominalTypes.Empty
    
    @JSImport("raml-definition-system", "rt.nominalTypes.ExternalType")
    @js.native
    open class ExternalType protected ()
      extends typings.ramlTypesystem.mod.nominalTypes.ExternalType {
      def this(_name: String) = this()
      def this(_name: String, _universe: IUniverse) = this()
      def this(_name: String, _universe: Unit, _path: String) = this()
      def this(_name: String, _universe: IUniverse, _path: String) = this()
    ...
    @JSImport("raml-definition-system", "rt.nominalTypes.Property")
    @js.native
    open class Property protected ()
      extends typings.ramlTypesystem.mod.nominalTypes.Property {
      def this(_name: String) = this()
      def this(_name: String, _description: String) = this()
    }
    /* static members */
    object Property {
      ...
      @JSImport("raml-definition-system", "rt.nominalTypes.Property.CLASS_IDENTIFIER_Property")
      @js.native
    ...
    @JSImport("raml-definition-system", "rt.nominalTypes.StructuredType")
    @js.native
    open class StructuredType protected ()
      extends typings.ramlTypesystem.mod.nominalTypes.StructuredType {
      def this(_name: String) = this()
      def this(_name: String, _universe: IUniverse) = this()
      def this(_name: String, _universe: Unit, _path: String) = this()
      def this(_name: String, _universe: IUniverse, _path: String) = this()
    ...
    @JSImport("raml-definition-system", "rt.nominalTypes.Union")
    @js.native
    open class Union protected ()
      extends typings.ramlTypesystem.mod.nominalTypes.Union {
      def this(_name: String) = this()
      def this(_name: String, _universe: IUniverse) = this()
      def this(_name: String, _universe: Unit, _path: String) = this()
      def this(_name: String, _universe: IUniverse, _path: String) = this()
    ...
    @JSImport("raml-definition-system", "rt.nominalTypes.ValueType")
    @js.native
    open class ValueType protected ()
      extends typings.ramlTypesystem.mod.nominalTypes.ValueType {
  ...
  inline def parse(data: typings.ramlTypesystem.mod.IType): IParsedType | IParsedTypeCollection = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(data.asInstanceOf[js.Any]).asInstanceOf[IParsedType | IParsedTypeCollection]
  ...
  inline def parseType(data: typings.ramlTypesystem.mod.IType, collection: IParsedTypeCollection): IParsedType = (^.asInstanceOf[js.Dynamic].applyDynamic("parseType")(data.asInstanceOf[js.Any], collection.asInstanceOf[js.Any])).asInstanceOf[IParsedType]
  ...
  inline def toNominal(
    t: IParsedType,
    bt: js.Function1[/* name */ String, typings.ramlTypesystem.distSrcNominalTypesMod.ITypeDefinition]
  ): typings.ramlTypesystem.distSrcNominalTypesMod.ITypeDefinition = (^.asInstanceOf[js.Dynamic].applyDynamic("toNominal")(t.asInstanceOf[js.Any], bt.asInstanceOf[js.Any])).asInstanceOf[typings.ramlTypesystem.distSrcNominalTypesMod.ITypeDefinition]
  ...
  object tsInterfaces {
    ...
    @JSImport("raml-definition-system", "rt.tsInterfaces")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("raml-definition-system", "rt.tsInterfaces.DEFINED_IN_TYPES_EXTRA")
    @js.native
    val DEFINED_IN_TYPES_EXTRA: /* "definedInTypes" */ String = js.native
    
    @JSImport("raml-definition-system", "rt.tsInterfaces.GLOBAL_EXTRA")
    @js.native
    val GLOBAL_EXTRA: /* "GLOBAL" */ String = js.native
    
    @JSImport("raml-definition-system", "rt.tsInterfaces.HAS_FACETS")
    @js.native
    val HAS_FACETS: /* "HAS_FACETS" */ String = js.native
    
    @JSImport("raml-definition-system", "rt.tsInterfaces.HAS_ITEMS")
    @js.native
    val HAS_ITEMS: /* "HAS_ITEMS" */ String = js.native
    
    @JSImport("raml-definition-system", "rt.tsInterfaces.MetaInformationKind")
    @js.native
    ...
    @JSImport("raml-definition-system", "rt.tsInterfaces.PARSE_ERROR")
    @js.native
    val PARSE_ERROR: /* "parseError" */ String = js.native
    
    @JSImport("raml-definition-system", "rt.tsInterfaces.REPEAT")
    @js.native
    val REPEAT: /* "repeat" */ String = js.native
    
    @JSImport("raml-definition-system", "rt.tsInterfaces.SCHEMA_AND_TYPE_EXTRA")
    @js.native
    val SCHEMA_AND_TYPE_EXTRA: /* "SCHEMA" */ String = js.native
    
    @JSImport("raml-definition-system", "rt.tsInterfaces.SOURCE_EXTRA")
    @js.native
    val SOURCE_EXTRA: /* "SOURCE" */ String = js.native
    
    @JSImport("raml-definition-system", "rt.tsInterfaces.TOP_LEVEL_EXTRA")
    @js.native
    val TOP_LEVEL_EXTRA: /* "topLevel" */ String = js.native
    
    @JSImport("raml-definition-system", "rt.tsInterfaces.USER_DEFINED_EXTRA")
    @js.native
  ...
  object typeExpressions {
    ...
    @JSImport("raml-definition-system", "rt.typeExpressions")
    @js.native
    val ^ : js.Any = js.native
