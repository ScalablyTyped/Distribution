...
object reactDashBreadcrumbsLibComponents {
  ...
  @scala.inline
  def BreadcrumbsProps: reactDashBreadcrumbsLib.reactDashBreadcrumbsMod.BreadcrumbsProps.type = reactDashBreadcrumbsLib.reactDashBreadcrumbsMod.BreadcrumbsProps
  type BreadcrumbsProps = reactDashBreadcrumbsLib.reactDashBreadcrumbsMod.BreadcrumbsProps
}
