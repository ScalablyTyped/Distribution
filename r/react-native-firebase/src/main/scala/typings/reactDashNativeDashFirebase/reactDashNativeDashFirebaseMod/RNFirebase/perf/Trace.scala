...
import typings.reactDashNativeDashFirebase.reactDashNativeDashFirebaseBooleans.`false`
import typings.reactDashNativeDashFirebase.reactDashNativeDashFirebaseBooleans.`true`
