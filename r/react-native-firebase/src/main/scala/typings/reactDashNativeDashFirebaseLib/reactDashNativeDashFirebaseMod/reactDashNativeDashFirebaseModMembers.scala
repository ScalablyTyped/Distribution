...
@js.native
object reactDashNativeDashFirebaseModMembers extends js.Object {
  val analytics: AnalyticsModule = js.native
  val auth: AuthModule = js.native
  val config: ConfigModule = js.native
