...
@js.native
trait TypeofClassFieldPath
  extends org.scalablytyped.runtime.Instantiable1[
      /* segments (repeated) */ java.lang.String, 
      reactDashNativeDashFirebaseLib.reactDashNativeDashFirebaseMod.RNFirebaseNs.firestoreNs.FieldPath
    ] {
