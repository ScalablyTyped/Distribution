...
object ^ extends js.Object {
  ...
  def useAlert(context: reactLib.reactMod.Context[js.UndefOr[AlertManager]]): AlertManager = js.native
  def withAlert[P /* <: reactDashAlertLib.Anon_Alert */](): js.Function1[
    /* c */ reactLib.reactMod.ComponentType[P], 
  ...
  def withAlert[P /* <: reactDashAlertLib.Anon_Alert */](context: reactLib.reactMod.Context[js.UndefOr[AlertManager]]): js.Function1[
    /* c */ reactLib.reactMod.ComponentType[P], 
    reactLib.reactMod.ComponentType[
      stdLib.Pick[
        P, 
