...
object distSrcPackageMod {
  
  @JSImport("@remix-run/web-blob/dist/src/package", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@remix-run/web-blob/dist/src/package", "TextDecoder")
  @js.native
  ...
  @JSImport("@remix-run/web-blob/dist/src/package", "TextEncoder")
  @js.native
