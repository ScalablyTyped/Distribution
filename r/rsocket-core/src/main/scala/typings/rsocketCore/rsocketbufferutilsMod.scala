...
object rsocketbufferutilsMod {
  ...
  */
  ...
  object Encoding {
    ...
    inline def ascii: typings.rsocketCore.rsocketCoreStrings.ascii = "ascii".asInstanceOf[typings.rsocketCore.rsocketCoreStrings.ascii]
    
    inline def base64: typings.rsocketCore.rsocketCoreStrings.base64 = "base64".asInstanceOf[typings.rsocketCore.rsocketCoreStrings.base64]
    
    inline def hex: typings.rsocketCore.rsocketCoreStrings.hex = "hex".asInstanceOf[typings.rsocketCore.rsocketCoreStrings.hex]
    
    inline def utf8: typings.rsocketCore.rsocketCoreStrings.utf8 = "utf8".asInstanceOf[typings.rsocketCore.rsocketCoreStrings.utf8]
  }
}
