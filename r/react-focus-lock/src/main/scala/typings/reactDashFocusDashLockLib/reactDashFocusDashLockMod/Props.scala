...
trait Props extends js.Object {
  ...
  /**
    ...
    */
  var noFocusGuards: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object Props {
  ...
  def apply(
    ...
    noFocusGuards: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    if (!js.isUndefined(noFocusGuards)) __obj.updateDynamic("noFocusGuards")(noFocusGuards)
