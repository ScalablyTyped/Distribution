...
object reactDashFocusDashLockLibComponents {
  ...
  @scala.inline
  def FreeFocusProps: reactDashFocusDashLockLib.reactDashFocusDashLockMod.FreeFocusProps.type = reactDashFocusDashLockLib.reactDashFocusDashLockMod.FreeFocusProps
  type FreeFocusProps = reactDashFocusDashLockLib.reactDashFocusDashLockMod.FreeFocusProps
  @scala.inline
  ...
  @scala.inline
  def Props: reactDashFocusDashLockLib.reactDashFocusDashLockMod.Props.type = reactDashFocusDashLockLib.reactDashFocusDashLockMod.Props
  type Props = reactDashFocusDashLockLib.reactDashFocusDashLockMod.Props
}
