...
import typings.reactDashFocusDashLock.Anon_Children
...
trait ReactFocusLockProps[ChildrenType, LockProps] extends js.Object {
  ...
  /**
    ...
    */
  var as: js.UndefOr[String | (ElementType[LockProps with Anon_Children[ChildrenType]])] = js.undefined
  /**
...
object ReactFocusLockProps {
  ...
  def apply[ChildrenType, LockProps](
    ...
    as: String | (ElementType[LockProps with Anon_Children[ChildrenType]]) = null,
