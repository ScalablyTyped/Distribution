...
object TourProps {
  ...
  def apply(
    ...
    onAbort: SyntheticEvent[js.Any, Event_] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[js.Any, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[js.Any, Event_] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[js.Any, Event_] => Unit = null,
    onEmptied: SyntheticEvent[js.Any, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[js.Any, Event_] => Unit = null,
    onEnded: SyntheticEvent[js.Any, Event_] => Unit = null,
    onError: SyntheticEvent[js.Any, Event_] => Unit = null,
    ...
    onLoad: SyntheticEvent[js.Any, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[js.Any, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[js.Any, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[js.Any, Event_] => Unit = null,
    ...
    onPause: SyntheticEvent[js.Any, Event_] => Unit = null,
    onPlay: SyntheticEvent[js.Any, Event_] => Unit = null,
    onPlaying: SyntheticEvent[js.Any, Event_] => Unit = null,
    ...
    onStalled: SyntheticEvent[js.Any, Event_] => Unit = null,
    onSubmit: FormEvent[js.Any] => Unit = null,
    onSuspend: SyntheticEvent[js.Any, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[js.Any, Event_] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[js.Any, Event_] => Unit = null,
    onWaiting: SyntheticEvent[js.Any, Event_] => Unit = null,
