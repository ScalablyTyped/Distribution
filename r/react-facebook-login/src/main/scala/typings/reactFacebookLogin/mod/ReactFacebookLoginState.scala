...
object ReactFacebookLoginState {
  ...
  def apply(isProcessing: js.UndefOr[Boolean] = js.undefined, isSdkLoaded: js.UndefOr[Boolean] = js.undefined): ReactFacebookLoginState = {
    ...
    if (!js.isUndefined(isProcessing)) __obj.updateDynamic("isProcessing")(isProcessing.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isSdkLoaded)) __obj.updateDynamic("isSdkLoaded")(isSdkLoaded.get.asInstanceOf[js.Any])
