...
import typings.reactImgpro.AnonBlue
import typings.reactImgpro.AnonDegree
import typings.reactImgpro.AnonHeight
import typings.reactImgpro.AnonHorizontal
