...
import typings.reactDashSlider.Anon_Index
import typings.reactDashSlider.Anon_IndexValue
...
trait ReactSliderProps extends js.Object {
  ...
  /**
    ...
    */
  var ariaValuetext: js.UndefOr[String | (js.Function1[/* value */ Anon_Index, String])] = js.undefined
  /**
  ...
  /**
    ...
    */
  var renderThumb: js.UndefOr[js.Function2[/* props */ js.Object, /* state */ Anon_Index, Element]] = js.undefined
  /**
    * Provide a custom render function for the track node.
    * The render function will be passed two arguments. The first is
    * an object that should be added to your handle node.
    */
  var renderTrack: js.UndefOr[js.Function2[/* props */ js.Object, /* state */ Anon_IndexValue, Element]] = js.undefined
  /**
...
object ReactSliderProps {
  ...
  def apply(
    ...
    renderThumb: (/* props */ js.Object, /* state */ Anon_Index) => Element = null,
    renderTrack: (/* props */ js.Object, /* state */ Anon_IndexValue) => Element = null,
    ...
    if (thumbActiveClassName != null) __obj.updateDynamic("thumbActiveClassName")(thumbActiveClassName)
    ...
    if (!js.isUndefined(withTracks)) __obj.updateDynamic("withTracks")(withTracks)
