...
/* Rewritten from type alias, can be one of: 
  - typings.reactNativeModals.reactNativeModalsStrings.`flex-start`
  - typings.reactNativeModals.reactNativeModalsStrings.`flex-end`
  - typings.reactNativeModals.reactNativeModalsStrings.center
*/
