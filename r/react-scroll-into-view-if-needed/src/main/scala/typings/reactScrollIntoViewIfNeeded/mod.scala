...
object mod {
  ...
  trait ReactScrollIntoViewIfNeededProps
    ...
    var elementType: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typings.reactScrollIntoViewIfNeeded.reactScrollIntoViewIfNeededStrings.a, typings.reactScrollIntoViewIfNeeded.reactScrollIntoViewIfNeededStrings.abbr, typings.reactScrollIntoViewIfNeeded.reactScrollIntoViewIfNeededStrings.address */ Any
      ] = js.undefined
  ...
  object ReactScrollIntoViewIfNeededProps {
    ...
    implicit open class MutableBuilder[Self <: ReactScrollIntoViewIfNeededProps] (val x: Self) extends AnyVal {
      ...
      inline def setElementType(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typings.reactScrollIntoViewIfNeeded.reactScrollIntoViewIfNeededStrings.a, typings.reactScrollIntoViewIfNeeded.reactScrollIntoViewIfNeededStrings.abbr, typings.reactScrollIntoViewIfNeeded.reactScrollIntoViewIfNeededStrings.address */ Any
