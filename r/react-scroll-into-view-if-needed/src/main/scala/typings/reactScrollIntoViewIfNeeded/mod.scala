...
object mod {
  ...
  object ReactScrollIntoViewIfNeededProps {
    ...
    extension [Self <: ReactScrollIntoViewIfNeededProps](x: Self) {
      ...
      inline def setElementType(value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 176 */ Any): Self = StObject.set(x, "elementType", value.asInstanceOf[js.Any])
