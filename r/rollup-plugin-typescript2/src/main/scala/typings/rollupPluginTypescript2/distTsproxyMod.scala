...
object distTsproxyMod {
  
  @JSImport("rollup-plugin-typescript2/dist/tsproxy", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def setTypescriptModule(`override`: TypeoftsTypes): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setTypescriptModule")(`override`.asInstanceOf[js.Any]).asInstanceOf[Unit]
