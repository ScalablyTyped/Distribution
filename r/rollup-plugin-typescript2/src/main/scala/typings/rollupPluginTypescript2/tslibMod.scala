...
object tslibMod {
  ...
  @JSImport("rollup-plugin-typescript2/dist/tslib", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("rollup-plugin-typescript2/dist/tslib", "TSLIB")
  @js.native
  val TSLIB: /* "tslib" */ String = js.native
  
  @JSImport("rollup-plugin-typescript2/dist/tslib", "TSLIB_VIRTUAL")
  @js.native
  val TSLIB_VIRTUAL: /* "\\u0000tslib.js" */ String = js.native
