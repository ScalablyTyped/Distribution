...
object distContextMod {
  ...
  object VerbosityLevel extends StObject {
    ...
    sealed trait Debug
      extends StObject
         with VerbosityLevel
    /* 3 */ val Debug: typings.rollupPluginTypescript2.distContextMod.VerbosityLevel.Debug & Double = js.native
    
    @js.native
    sealed trait Error
      extends StObject
         with VerbosityLevel
    /* 0 */ val Error: typings.rollupPluginTypescript2.distContextMod.VerbosityLevel.Error & Double = js.native
    
    @js.native
    sealed trait Info
      extends StObject
         with VerbosityLevel
    /* 2 */ val Info: typings.rollupPluginTypescript2.distContextMod.VerbosityLevel.Info & Double = js.native
    
    @js.native
    sealed trait Warning
      extends StObject
         with VerbosityLevel
    /* 1 */ val Warning: typings.rollupPluginTypescript2.distContextMod.VerbosityLevel.Warning & Double = js.native
  }
}
