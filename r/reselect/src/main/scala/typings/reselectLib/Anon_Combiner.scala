...
@js.native
trait Anon_Combiner extends js.Object {
  def apply[S, R1, T](selector: reselectLib.reselectMod.Selector[S, R1], combiner: js.Function1[/* res */ R1, T]): reselectLib.reselectMod.OutputSelector[S, T, js.Function1[/* res */ R1, T]] = js.native
  def apply[S, R1, T](
