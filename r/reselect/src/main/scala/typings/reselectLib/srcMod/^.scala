package typings
package reselectLib.srcMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("reselect/src", JSImport.Namespace)
@js.native
object ^ extends js.Object {
  ...
  def createSelectorCreator(memoize: js.Function1[/* func */ js.Function, js.Function]): reselectLib.Anon_CombinerRes = js.native
  def createSelectorCreator[O1](memoize: js.Function2[/* func */ js.Function, /* option1 */ O1, js.Function], option1: O1): reselectLib.Anon_CombinerRes = js.native
  def createSelectorCreator[O1, O2](
    memoize: js.Function3[/* func */ js.Function, /* option1 */ O1, /* option2 */ O2, js.Function],
    option1: O1,
    option2: O2
  ): reselectLib.Anon_CombinerRes = js.native
  ...
  {[ K in keyof T ]: reselect.reselect/src.Selector<S, T[K]>}
  ...
  {[ K in keyof T ]: reselect.reselect/src.Selector<S, T[K]>}
    */ reselectLib.reselectLibStrings.createStructuredSelector with T,
    selectorCreator: reselectLib.Anon_CombinerRes
  ): Selector[S, T] = js.native
  @JSName("createStructuredSelector")
  def createStructuredSelector_SPTParametricSelector[S, P, T](
    selectors: /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ K in keyof T ]: reselect.reselect/src.ParametricSelector<S, P, T[K]>}
    */ reselectLib.reselectLibStrings.createStructuredSelector with T
