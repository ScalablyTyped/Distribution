...
import typings.reactNativeDraggableFlatlist.libTypescriptTypesMod.RenderItem
import typings.reactNativeDraggableFlatlist.libTypescriptTypesMod.RenderItemParams
...
object libTypescriptContextPropsContextMod {
  
  @JSImport("react-native-draggable-flatlist/lib/typescript/context/propsContext", JSImport.Namespace)
  @js.native
  ...
  /* Inlined react-native-draggable-flatlist.react-native-draggable-flatlist/lib/typescript/types.DraggableFlatListProps<T> & {  children :react.react.ReactNode} */
  ...
  object Props {
    ...
    extension [Self <: Props[?], T](x: Self & Props[T]) {
      ...
      inline def setOnAnimValInit(value: /* animVals */ ReturnType[js.Function0[ActiveIndexAnim]] => Unit): Self = StObject.set(x, "onAnimValInit", js.Any.fromFunction1(value))
