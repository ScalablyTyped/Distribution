...
object libTypescriptTypesMod {
  ...
  object RenderItemParams {
    ...
    inline def apply[T](drag: () => Unit, getIndex: () => js.UndefOr[Double], isActive: Boolean, item: T): RenderItemParams[T] = {
      val __obj = js.Dynamic.literal(drag = js.Any.fromFunction0(drag), getIndex = js.Any.fromFunction0(getIndex), isActive = isActive.asInstanceOf[js.Any], item = item.asInstanceOf[js.Any])
    ...
    extension [Self <: RenderItemParams[?], T](x: Self & RenderItemParams[T]) {
      ...
      inline def setGetIndex(value: () => js.UndefOr[Double]): Self = StObject.set(x, "getIndex", js.Any.fromFunction0(value))
