...
import typings.reactNativeDraggableFlatlist.componentsCellDecoratorsMod.OpacityProps
import typings.reactNativeDraggableFlatlist.componentsCellDecoratorsMod.ScaleProps
import typings.reactNativeDraggableFlatlist.componentsCellDecoratorsMod.ShadowProps
