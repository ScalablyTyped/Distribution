...
import typings.reactNativeDraggableFlatlist.anon.Ref
...
object typesMod {
  ...
  type AnimatedFlatListType = js.Function1[/* props */ AnimateProps[FlatListProps[Any] & Ref[Any]], ReactElement]
  ...
  type RenderItem[T] = js.Function1[/* params */ RenderItemParams[T], ReactNode]
  ...
  object RenderItemParams {
    ...
    inline def apply[T](drag: () => Unit, isActive: Boolean, item: T): RenderItemParams[T] = {
      val __obj = js.Dynamic.literal(drag = js.Any.fromFunction0(drag), isActive = isActive.asInstanceOf[js.Any], item = item.asInstanceOf[js.Any])
