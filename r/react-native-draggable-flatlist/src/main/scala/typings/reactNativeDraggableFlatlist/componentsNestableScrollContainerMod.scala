...
object componentsNestableScrollContainerMod {
  
  @JSImport("react-native-draggable-flatlist/lib/typescript/components/NestableScrollContainer", JSImport.Namespace)
  @js.native
