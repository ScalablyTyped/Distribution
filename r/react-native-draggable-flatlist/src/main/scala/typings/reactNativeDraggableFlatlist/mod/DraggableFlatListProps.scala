...
object DraggableFlatListProps {
  ...
  def apply[Item](
    ...
    indicatorStyle: typings.reactNative.reactNativeStrings.default | black | white = null,
    ...
    scrollPercent: js.UndefOr[Double] = js.undefined,
    ...
    val __obj = js.Dynamic.literal(renderItem = js.Any.fromFunction1(renderItem), data = data.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(scrollPercent)) __obj.updateDynamic("scrollPercent")(scrollPercent.get.asInstanceOf[js.Any])
