...
trait ComponentProps extends js.Object {
  ...
  var FilterComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var LoadingComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var NextComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var NoDataComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var PaginationComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var PivotComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var PivotValueComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var PreviousComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var ResizerComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var TableComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var TbodyComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var TdComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var TfootComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var ThComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var TheadComponent: reactLib.reactMod.ReactNs.ReactType[_]
  var TrComponent: reactLib.reactMod.ReactNs.ReactType[_]
