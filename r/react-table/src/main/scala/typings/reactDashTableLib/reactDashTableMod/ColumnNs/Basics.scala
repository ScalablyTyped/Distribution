...
/** Basic column props */
trait Basics[D] extends js.Object {
  /** Used to render aggregated cells. Defaults to a comma separated list of values. */
  var Aggregated: reactDashTableLib.reactDashTableMod.TableCellRenderer[D]
  /** Used to render the expander in both Pivot and Expander cells */
  var Expander: reactDashTableLib.reactDashTableMod.TableCellRenderer[D]
  /** Used to render a pivoted cell  */
  var Pivot: reactDashTableLib.reactDashTableMod.PivotRenderer[D]
  /**  Used to render the value inside of a Pivot cell */
  var PivotValue: reactDashTableLib.reactDashTableMod.TableCellRenderer[D]
  /** Default: false */
...
object Basics {
  @scala.inline
  def apply[D](
    Aggregated: reactDashTableLib.reactDashTableMod.TableCellRenderer[D],
    Expander: reactDashTableLib.reactDashTableMod.TableCellRenderer[D],
    Pivot: reactDashTableLib.reactDashTableMod.PivotRenderer[D],
    PivotValue: reactDashTableLib.reactDashTableMod.TableCellRenderer[D],
