...
- Dropped {[ P in keyof react-table.react-table.Column.HeaderProps ]:? react-table.react-table.Column.HeaderProps[P]} */ @JSName("Column")
trait Column_[D] extends js.Object {
  /**
...
object Column_ {
  ...
  def apply[D](
    ...
    aggregate: (/* values */ js.Any, /* rows */ js.Any) => js.Any = null,
