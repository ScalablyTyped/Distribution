...
trait SelectTableAdditionalProps extends js.Object {
  var SelectAllInputComponent: js.UndefOr[ComponentType[SelectAllInputComponentProps]] = js.undefined
  var SelectInputComponent: js.UndefOr[ComponentType[SelectInputComponentProps]] = js.undefined
  var isSelected: js.UndefOr[js.Function1[/* key */ String, Boolean]] = js.undefined
  /**
    * Default: _id
    */
  ...
  var selectWidth: js.UndefOr[Double] = js.undefined
  var toggleAll: js.UndefOr[js.Function0[_]] = js.undefined
  var toggleSelection: js.UndefOr[
    js.Function3[/* key */ String, /* shiftKeyPressed */ Boolean, /* row */ js.Any, _]
  ] = js.undefined
}
...
object SelectTableAdditionalProps {
  @scala.inline
  def apply(
    SelectAllInputComponent: ComponentType[SelectAllInputComponentProps] = null,
    SelectInputComponent: ComponentType[SelectInputComponentProps] = null,
    isSelected: /* key */ String => Boolean = null,
    keyField: String = null,
    selectAll: js.UndefOr[Boolean] = js.undefined,
    selectType: SelectType = null,
    selectWidth: Int | Double = null,
    toggleAll: () => _ = null,
    toggleSelection: (/* key */ String, /* shiftKeyPressed */ Boolean, /* row */ js.Any) => _ = null
