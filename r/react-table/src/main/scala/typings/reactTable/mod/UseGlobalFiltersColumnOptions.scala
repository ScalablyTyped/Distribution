...
object UseGlobalFiltersColumnOptions {
  ...
  @scala.inline
  implicit class UseGlobalFiltersColumnOptionsOps[Self <: UseGlobalFiltersColumnOptions[_], D /* <: js.Object */] (val x: Self with UseGlobalFiltersColumnOptions[D]) extends AnyVal {
