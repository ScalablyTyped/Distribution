...
package object mod {
  ...
  @scala.inline
  def defaultColumn: typings.std.Partial[typings.reactTable.mod.Column[js.Object]] with (typings.std.Record[java.lang.String, _]) = typings.reactTable.mod.^.asInstanceOf[js.Dynamic].selectDynamic("defaultColumn").asInstanceOf[typings.std.Partial[typings.reactTable.mod.Column[js.Object]] with (typings.std.Record[java.lang.String, _])]
  ...
  @scala.inline
  def useAsyncDebounce[F /* <: js.Function1[/* repeated */ js.Any, _] */](defaultFn: F): F = typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("useAsyncDebounce")(defaultFn.asInstanceOf[js.Any]).asInstanceOf[F]
  @scala.inline
  def useAsyncDebounce[F /* <: js.Function1[/* repeated */ js.Any, _] */](defaultFn: F, defaultWait: scala.Double): F = (typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("useAsyncDebounce")(defaultFn.asInstanceOf[js.Any], defaultWait.asInstanceOf[js.Any])).asInstanceOf[F]
