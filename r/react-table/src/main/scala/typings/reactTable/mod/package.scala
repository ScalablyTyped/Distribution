...
inline def actions: typings.std.Record[java.lang.String, java.lang.String] = typings.reactTable.mod.^.asInstanceOf[js.Dynamic].selectDynamic("actions").asInstanceOf[typings.std.Record[java.lang.String, java.lang.String]]
...
inline def defaultOrderByFn[D /* <: js.Object */](
...
inline def ensurePluginOrder[D /* <: js.Object */](
...
inline def loopHooks(hooks: typings.reactTable.mod.Hooks[js.Object], args: js.Any*): scala.Unit = (typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("loopHooks")(hooks.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]

inline def makePropGetter(hooks: typings.reactTable.mod.Hooks[js.Object], meta: js.Any*): js.Any = (typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("makePropGetter")(hooks.asInstanceOf[js.Any], meta.asInstanceOf[js.Any])).asInstanceOf[js.Any]

inline def makeRenderer(
...
inline def reduceHooks[T /* <: js.Object */](hooks: typings.reactTable.mod.Hooks[js.Object], initial: T, args: js.Any*): T = (typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("reduceHooks")(hooks.asInstanceOf[js.Any], initial.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[T]

inline def safeUseLayoutEffect(effect: typings.react.mod.EffectCallback): scala.Unit = typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("safeUseLayoutEffect")(effect.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
inline def safeUseLayoutEffect(effect: typings.react.mod.EffectCallback, deps: typings.react.mod.DependencyList): scala.Unit = (typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("safeUseLayoutEffect")(effect.asInstanceOf[js.Any], deps.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]

inline def useAsyncDebounce[F /* <: js.Function1[/* repeated */ js.Any, js.Any] */](defaultFn: F): F = typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("useAsyncDebounce")(defaultFn.asInstanceOf[js.Any]).asInstanceOf[F]
inline def useAsyncDebounce[F /* <: js.Function1[/* repeated */ js.Any, js.Any] */](defaultFn: F, defaultWait: scala.Double): F = (typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("useAsyncDebounce")(defaultFn.asInstanceOf[js.Any], defaultWait.asInstanceOf[js.Any])).asInstanceOf[F]

inline def useGetLatest[T](obj: T): js.Function0[T] = typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("useGetLatest")(obj.asInstanceOf[js.Any]).asInstanceOf[js.Function0[T]]

inline def useMountedLayoutEffect(effect: typings.react.mod.EffectCallback): scala.Unit = typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("useMountedLayoutEffect")(effect.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
inline def useMountedLayoutEffect(effect: typings.react.mod.EffectCallback, deps: typings.react.mod.DependencyList): scala.Unit = (typings.reactTable.mod.^.asInstanceOf[js.Dynamic].applyDynamic("useMountedLayoutEffect")(effect.asInstanceOf[js.Any], deps.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
