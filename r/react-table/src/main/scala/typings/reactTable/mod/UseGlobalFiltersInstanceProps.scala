...
object UseGlobalFiltersInstanceProps {
  ...
  @scala.inline
  implicit class UseGlobalFiltersInstancePropsOps[Self <: UseGlobalFiltersInstanceProps[_], /* <: js.Object */ D] (val x: Self with UseGlobalFiltersInstanceProps[D]) extends AnyVal {
    @scala.inline
