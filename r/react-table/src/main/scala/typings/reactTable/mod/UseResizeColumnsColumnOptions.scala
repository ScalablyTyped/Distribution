...
object UseResizeColumnsColumnOptions {
  ...
  @scala.inline
  implicit class UseResizeColumnsColumnOptionsOps[Self <: UseResizeColumnsColumnOptions[_], D /* <: js.Object */] (val x: Self with UseResizeColumnsColumnOptions[D]) extends AnyVal {
