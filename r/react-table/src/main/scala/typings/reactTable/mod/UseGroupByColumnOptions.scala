...
object UseGroupByColumnOptions {
  @scala.inline
  def apply[/* <: js.Object */ D](): UseGroupByColumnOptions[D] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UseGroupByColumnOptions[D]]
  }
  @scala.inline
  implicit class UseGroupByColumnOptionsOps[Self <: UseGroupByColumnOptions[_], /* <: js.Object */ D] (val x: Self with UseGroupByColumnOptions[D]) extends AnyVal {
    @scala.inline
