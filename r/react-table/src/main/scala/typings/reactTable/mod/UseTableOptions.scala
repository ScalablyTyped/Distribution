...
object UseTableOptions {
  @scala.inline
  def apply[/* <: js.Object */ D](columns: js.Array[Column[D]], data: js.Array[D]): UseTableOptions[D] = {
  ...
  @scala.inline
  implicit class UseTableOptionsOps[Self <: UseTableOptions[_], /* <: js.Object */ D] (val x: Self with UseTableOptions[D]) extends AnyVal {
    @scala.inline
