...
object Cell {
  ...
  inline def apply[D /* <: js.Object */](cell: typings.reactTable.mod.Cell[D, js.Any]): Cell[D] = {
  ...
  extension [Self <: Cell[?], D /* <: js.Object */](x: Self & Cell[D]) {
    ...
    inline def setCell(value: typings.reactTable.mod.Cell[D, js.Any]): Self = StObject.set(x, "cell", value.asInstanceOf[js.Any])
  }
}
