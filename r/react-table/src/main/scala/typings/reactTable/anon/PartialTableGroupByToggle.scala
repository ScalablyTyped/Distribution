...
/* Inlined std.Partial<react-table.react-table.TableGroupByToggleProps> */
trait PartialTableGroupByToggle extends StObject {
...
object PartialTableGroupByToggle {
  
  inline def apply(): PartialTableGroupByToggle = {
