...
@js.native
trait PartialTableToggleHideAll extends js.Object {
...
object PartialTableToggleHideAll {
  @scala.inline
  def apply(): PartialTableToggleHideAll = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTableToggleHideAll]
  }
  @scala.inline
  implicit class PartialTableToggleHideAllOps[Self <: PartialTableToggleHideAll] (val x: Self) extends AnyVal {
    @scala.inline
