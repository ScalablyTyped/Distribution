...
trait readDir extends js.Object {
  def apply(path: java.lang.String): js.Promise[js.Array[java.lang.String]] = js.native
  def apply(path: java.lang.String, callback: Callback): scala.Unit = js.native
  def apply(path: java.lang.String, ignores: Ignores): js.Promise[js.Array[java.lang.String]] = js.native
