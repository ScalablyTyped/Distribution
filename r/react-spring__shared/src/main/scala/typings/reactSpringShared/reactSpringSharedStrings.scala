...
import typings.reactSpringShared.esmColorsMod.ColorName
import typings.reactSpringShared.typesMod.ExtrapolateType
...
object reactSpringSharedStrings {
  ...
  @js.native
  sealed trait Animatable extends StObject
  inline def Animatable: Animatable = "Animatable".asInstanceOf[Animatable]
  ...
  sealed trait aliceblue
    extends StObject
       with ColorName
       with typings.reactSpringShared.colorsMod.ColorName
  ...
  @js.native
  sealed trait burntsienna
    extends StObject
       with ColorName
       with typings.reactSpringShared.colorsMod.ColorName
  inline def burntsienna: burntsienna = "burntsienna".asInstanceOf[burntsienna]
  ...
  sealed trait clamp
    extends StObject
       ...
       with typings.reactSpringShared.esmTypesMod.ExtrapolateType
