...
import typings.reactSpringShared.fluidsMod.FluidObserver
import typings.reactSpringShared.fluidsMod.GetFluidObservers_
import typings.reactSpringShared.fluidsMod.GetFluidValue_
import typings.reactSpringShared.frameLoopMod.OpaqueAnimation
import typings.reactSpringShared.globalsMod.AnimatedGlobals
import typings.reactSpringShared.helpersMod.EachFn
import typings.reactSpringShared.helpersMod.Eachable
import typings.reactSpringShared.helpersMod.IsType
...
object mod {
  ...
  /**
    ...
    */
  @JSImport("@react-spring/shared/dist/declarations/src", "FluidValue")
  @js.native
  abstract class FluidValue[T, E /* <: FluidEvent[T] */] ()
    extends typings.reactSpringShared.fluidsMod.FluidValue[T, E] {
  ...
  object Globals {
    ...
    @js.native
    def to: js.Function2[
        /* source */ OneOrMore[typings.reactSpringShared.fluidsMod.FluidValue[Any, Any]], 
        /* args */ InterpolatorArgs[Any, Any], 
        typings.reactSpringShared.fluidsMod.FluidValue[Any, Any]
      ] = js.native
    inline def to_=(
      x: js.Function2[
          /* source */ OneOrMore[typings.reactSpringShared.fluidsMod.FluidValue[Any, Any]], 
  ...
  inline def addFluidObserver[T, E /* <: FluidEvent[Any] */](target: typings.reactSpringShared.fluidsMod.FluidValue[T, E], observer: FluidObserver[E]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("addFluidObserver")(target.asInstanceOf[js.Any], observer.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  inline def callFluidObservers[E /* <: FluidEvent[Any] */](target: typings.reactSpringShared.fluidsMod.FluidValue[Any, E], event: E): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("callFluidObservers")(target.asInstanceOf[js.Any], event.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def removeFluidObserver[E /* <: FluidEvent[Any] */](target: typings.reactSpringShared.fluidsMod.FluidValue[Any, E], observer: FluidObserver[E]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("removeFluidObserver")(target.asInstanceOf[js.Any], observer.asInstanceOf[js.Any])).asInstanceOf[Unit]
