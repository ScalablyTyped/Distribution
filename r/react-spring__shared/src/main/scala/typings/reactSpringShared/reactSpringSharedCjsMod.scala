...
object reactSpringSharedCjsMod {
  ...
  /**
    ...
    */
  @JSImport("@react-spring/shared/dist/react-spring-shared.cjs", "FluidValue")
  @js.native
  abstract class FluidValue[T, E /* <: FluidEvent[T] */] ()
    extends typings.reactSpringShared.mod.FluidValue[T, E] {
