...
object fluidsMod {
  ...
  /**
    ...
    */
  @JSImport("@react-spring/shared/dist/declarations/src/fluids", "FluidValue")
  @js.native
  abstract class FluidValue[T, E /* <: FluidEvent[T] */] () extends StObject {
  ...
  type FluidProps[T] = Any | (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof T ]: T[P] | @react-spring/shared.@react-spring/shared/dist/declarations/src/fluids.FluidValue<std.Exclude<T[P], void>, any>}
    */ typings.reactSpringShared.reactSpringSharedStrings.FluidProps & TopLevel[Any])
  ...
  type StaticProps[T /* <: js.Object */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof T ]: T[P] extends @react-spring/shared.@react-spring/shared/dist/declarations/src/fluids.FluidValue<infer U, any>? any : T[P]}
    */ typings.reactSpringShared.reactSpringSharedStrings.StaticProps & TopLevel[Any]
}
