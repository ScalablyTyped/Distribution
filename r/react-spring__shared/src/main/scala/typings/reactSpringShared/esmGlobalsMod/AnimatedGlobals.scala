...
import typings.reactSpringShared.anon.FnCallSourceArgs
...
trait AnimatedGlobals extends js.Object {
  ...
  var to: js.UndefOr[FnCallSourceArgs] = js.native
...
object AnimatedGlobals {
  ...
  implicit class AnimatedGlobalsOps[Self <: AnimatedGlobals] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTo(value: FnCallSourceArgs): Self = this.set("to", value.asInstanceOf[js.Any])
