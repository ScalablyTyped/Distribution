...
object GraphData {
  @scala.inline
  def apply[/* <: typings.reactD3Graph.mod.GraphNode */ N, /* <: typings.reactD3Graph.mod.GraphLink */ L](links: js.Array[L], nodes: js.Array[N], focusedNodeId: String = null): GraphData[N, L] = {
