...
object GraphLevelLinkConfiguration {
  ...
  @scala.inline
  implicit class GraphLevelLinkConfigurationOps[Self <: GraphLevelLinkConfiguration[_], L /* <: GraphLink */] (val x: Self with GraphLevelLinkConfiguration[L]) extends AnyVal {
