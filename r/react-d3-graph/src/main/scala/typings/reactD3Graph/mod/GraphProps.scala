...
object GraphProps {
  @scala.inline
  def apply[/* <: typings.reactD3Graph.mod.GraphNode */ N, /* <: typings.reactD3Graph.mod.GraphLink */ L](id: String): GraphProps[N, L] = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[GraphProps[N, L]]
  }
  @scala.inline
  implicit class GraphPropsOps[Self <: GraphProps[_, _], /* <: typings.reactD3Graph.mod.GraphNode */ N, /* <: typings.reactD3Graph.mod.GraphLink */ L] (val x: Self with (GraphProps[N, L])) extends AnyVal {
    @scala.inline
