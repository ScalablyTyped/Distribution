...
object GraphLevelNodeConfiguration {
  ...
  @scala.inline
  implicit class GraphLevelNodeConfigurationOps[Self <: GraphLevelNodeConfiguration[_], /* <: typings.reactD3Graph.mod.GraphNode */ N] (val x: Self with GraphLevelNodeConfiguration[N]) extends AnyVal {
    @scala.inline
