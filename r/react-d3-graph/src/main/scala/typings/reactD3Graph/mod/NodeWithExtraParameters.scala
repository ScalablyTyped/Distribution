...
object NodeWithExtraParameters {
  ...
  @scala.inline
  implicit class NodeWithExtraParametersOps[Self <: NodeWithExtraParameters] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setViewGenerator(value: NodeWithExtraParameters => _): Self = this.set("viewGenerator", js.Any.fromFunction1(value))
