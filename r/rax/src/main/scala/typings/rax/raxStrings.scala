...
object raxStrings {
  ...
  inline def `aria-component`: `aria-component` = "aria-component".asInstanceOf[`aria-component`]
  ...
  inline def `contact-button`: `contact-button` = "contact-button".asInstanceOf[`contact-button`]
  ...
  inline def `cover-view`: `cover-view` = "cover-view".asInstanceOf[`cover-view`]
  ...
  inline def `functional-page-navigator`: `functional-page-navigator` = "functional-page-navigator".asInstanceOf[`functional-page-navigator`]
  ...
  inline def `movable-area`: `movable-area` = "movable-area".asInstanceOf[`movable-area`]
  
  @js.native
  sealed trait `movable-view` extends StObject
  inline def `movable-view`: `movable-view` = "movable-view".asInstanceOf[`movable-view`]
  ...
  inline def `navigation-bar`: `navigation-bar` = "navigation-bar".asInstanceOf[`navigation-bar`]
  ...
  inline def `open-data`: `open-data` = "open-data".asInstanceOf[`open-data`]
  ...
  inline def `page-meta`: `page-meta` = "page-meta".asInstanceOf[`page-meta`]
  ...
  inline def `scroll-view`: `scroll-view` = "scroll-view".asInstanceOf[`scroll-view`]
  ...
  inline def `swiper-item`: `swiper-item` = "swiper-item".asInstanceOf[`swiper-item`]
  ...
  inline def `web-view`: `web-view` = "web-view".asInstanceOf[`web-view`]
