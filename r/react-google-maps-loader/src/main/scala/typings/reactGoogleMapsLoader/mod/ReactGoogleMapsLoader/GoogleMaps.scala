...
import typings.reactGoogleMapsLoader.Typeofgeometry
import typings.reactGoogleMapsLoader.Typeofplaces
import typings.reactGoogleMapsLoader.Typeofvisualization
