...
import typings.raphael.mod.RaphaelBuiltinEasingFormula
import typings.raphael.mod.RaphaelDashArrayType
import typings.raphael.mod.RaphaelFontOrigin
import typings.raphael.mod.RaphaelLineCapType
import typings.raphael.mod.RaphaelLineJoinType
import typings.raphael.mod.RaphaelShapeType
import typings.raphael.mod.RaphaelTechnology
...
object raphaelStrings {
  ...
  @scala.inline
  def RaphaelBaseElement: RaphaelBaseElement = "RaphaelBaseElement".asInstanceOf[RaphaelBaseElement]
  
  @scala.inline
  def RaphaelPaperPluginRegistry: RaphaelPaperPluginRegistry = "RaphaelPaperPluginRegistry".asInstanceOf[RaphaelPaperPluginRegistry]
  ...
  @scala.inline
  def `clip-rect`: `clip-rect` = "clip-rect".asInstanceOf[`clip-rect`]
  ...
  @js.native
  sealed trait RaphaelBaseElement extends js.Object
  
  @js.native
  sealed trait RaphaelPaperPluginRegistry extends js.Object
  ...
  @js.native
  sealed trait `arrow-end` extends js.Object
  ...
  @js.native
  sealed trait `clip-rect` extends js.Object
  ...
  @js.native
  sealed trait `font-family` extends js.Object
  
  @js.native
  sealed trait `font-size` extends js.Object
  
  @js.native
  sealed trait `font-weight` extends js.Object
  ...
  @js.native
  sealed trait ry extends js.Object
  ...
  @js.native
  sealed trait `stroke-dasharray` extends js.Object
  
  @js.native
  sealed trait `stroke-linecap` extends js.Object
  
  @js.native
  sealed trait `stroke-linejoin` extends js.Object
  
  @js.native
  sealed trait `stroke-miterlimit` extends js.Object
  
  @js.native
  sealed trait `stroke-opacity` extends js.Object
  
  @js.native
  sealed trait `stroke-width` extends js.Object
  ...
  @js.native
  sealed trait `text-anchor` extends js.Object
