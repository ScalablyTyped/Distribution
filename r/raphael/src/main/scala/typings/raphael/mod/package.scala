...
type RaphaelCustomEasingFormula = java.lang.String
...
type RaphaelElementPluginMethod[TTechnology /* <: typings.raphael.mod.RaphaelTechnology */, TArgs /* <: js.Array[js.Any] */, TRetVal] = /**
...
type RaphaelPaperPluginMethod[TTechnology /* <: typings.raphael.mod.RaphaelTechnology */, TArgs /* <: js.Array[js.Any] */, TRetVal] = /**
...
{[ P in keyof T ]: T[P] extends (args : any): any? raphael.raphael.RaphaelPaperPluginMethod<TTechnology, std.Parameters<T[P]>, std.ReturnType<T[P]>> : / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias raphael.raphael.RaphaelPaperPluginRegistry<TTechnology, T[P]> * / object}
  */ typings.raphael.raphaelStrings.RaphaelPaperPluginRegistry & org.scalablytyped.runtime.TopLevel[js.Any]
...
scala.Double, 
scala.Double, 
scala.Double]) | (js.Array[typings.raphael.raphaelStrings.Z | typings.raphael.raphaelStrings.z_])

type RaphaelPotentialFailure[T /* <: js.Object */] = T & typings.raphael.anon.Error

type RaphaelSetPluginMethod[TTechnology /* <: typings.raphael.mod.RaphaelTechnology */, TArgs /* <: js.Array[js.Any] */, TRetVal] = /**
...
scala.Double, 
scala.Double, 
scala.Double]) | (js.Tuple4[typings.raphael.raphaelStrings.r_, scala.Double, scala.Double, scala.Double]) | (js.Tuple2[typings.raphael.raphaelStrings.r_, scala.Double]) | (js.Tuple7[
