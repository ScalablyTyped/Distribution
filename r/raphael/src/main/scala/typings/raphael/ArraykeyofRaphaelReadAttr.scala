...
import typings.raphael.raphaelNumbers.`0`
import typings.raphael.raphaelNumbers.`1`
import typings.raphael.raphaelNumbers.`2`
import typings.raphael.raphaelNumbers.`3`
import typings.raphael.raphaelNumbers.`4`
import typings.raphael.raphaelNumbers.`5`
import typings.raphael.raphaelNumbers.`6`
import typings.raphael.raphaelNumbers.`7`
...
trait ArraykeyofRaphaelReadAttr extends /* n */ NumberDictionary[transform] {
  ...
  /**
    ...
    */
  @JSName("findIndex")
  def findIndex_transform(predicate: js.Function3[transform, /* index */ Double, /* obj */ js.Array[transform], _]): Double = js.native
  @JSName("findIndex")
  def findIndex_transform(
    predicate: js.Function3[transform, /* index */ Double, /* obj */ js.Array[transform], _],
    thisArg: js.Any
  ): Double = js.native
  @JSName("find")
  def find_transform(predicate: js.Function3[transform, /* index */ Double, /* obj */ js.Array[transform], _]): js.UndefOr[transform] = js.native
  @JSName("find")
  def find_transform(
    predicate: js.Function3[transform, /* index */ Double, /* obj */ js.Array[transform], _],
    thisArg: js.Any
