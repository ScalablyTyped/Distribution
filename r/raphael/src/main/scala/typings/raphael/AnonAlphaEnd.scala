...
trait AnonAlphaEnd extends js.Object {
  var alpha: Double
  var end: AnonX
  var m: AnonX
  var n: AnonX
...
object AnonAlphaEnd {
  @scala.inline
  def apply(alpha: Double, end: AnonX, m: AnonX, n: AnonX, start: AnonX, x: Double, y: Double): AnonAlphaEnd = {
    ...
    __obj.asInstanceOf[AnonAlphaEnd]
  }
}
