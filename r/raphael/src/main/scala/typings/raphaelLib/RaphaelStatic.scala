...
trait RaphaelStatic extends js.Object {
  ...
  def color(clr: java.lang.String): Anon_B = js.native
  ...
  def getRGB(colour: java.lang.String): Anon_BError = js.native
  ...
  def hsb2rgb(h: scala.Double, s: scala.Double, v: scala.Double): Anon_BG = js.native
  def hsl(h: scala.Double, s: scala.Double, l: scala.Double): java.lang.String = js.native
  def hsl2rgb(h: scala.Double, s: scala.Double, l: scala.Double): Anon_BG = js.native
  ...
  def pathIntersection(path1: java.lang.String, path2: java.lang.String): js.Array[Anon_Bez1] = js.native
  ...
  def rgb2hsb(r: scala.Double, g: scala.Double, b: scala.Double): Anon_BH = js.native
