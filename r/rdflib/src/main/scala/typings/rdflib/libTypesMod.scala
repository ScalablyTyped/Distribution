...
import typings.rdflib.libNodeInternalMod.default
...
object libTypesMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - scala.Unit
    - scala.Null
    - typings.rdflib.libCollectionMod.default[C]
  */
  type FromValueReturns[C /* <: default */] = js.UndefOr[_FromValueReturns[C] | Null]
  
  /* Rewritten from type alias, can be one of: 
    - typings.rdflib.libDefaultGraphMod.default
  ...
  */
  ...
  trait IRDFlibDataFactory
    extends StObject
       with DataFactory[
          typings.rdflib.libNamedNodeMod.default | typings.rdflib.libBlankNodeMod.default | typings.rdflib.libLiteralMod.default | (typings.rdflib.libCollectionMod.default[
            default | typings.rdflib.libBlankNodeMod.default | typings.rdflib.libCollectionMod.Collection[Any] | typings.rdflib.libLiteralMod.default | typings.rdflib.libVariableMod.default
          ]) | (typings.rdflib.libStatementMod.default[SubjectType, PredicateType, ObjectType, GraphType]), 
          Indexable
        ] {
    
    def fetcher(store: typings.rdflib.libStoreMod.default, options: Any): typings.rdflib.libFetcherMod.default = js.native
    
    def graph(): typings.rdflib.libStoreMod.default = js.native
    def graph(features: Any): typings.rdflib.libStoreMod.default = js.native
    def graph(features: Any, opts: Any): typings.rdflib.libStoreMod.default = js.native
    def graph(features: Unit, opts: Any): typings.rdflib.libStoreMod.default = js.native
    
    def lit(`val`: String): typings.rdflib.libLiteralMod.default = js.native
    def lit(`val`: String, lang: String): typings.rdflib.libLiteralMod.default = js.native
    def lit(`val`: String, lang: String, dt: typings.rdflib.libTfTypesMod.NamedNode): typings.rdflib.libLiteralMod.default = js.native
    def lit(`val`: String, lang: Unit, dt: typings.rdflib.libTfTypesMod.NamedNode): typings.rdflib.libLiteralMod.default = js.native
    
    def st(subject: QuadSubject, predicate: QuadPredicate, `object`: QuadObject): typings.rdflib.libStatementMod.default[SubjectType, PredicateType, ObjectType, GraphType] = js.native
    def st(subject: QuadSubject, predicate: QuadPredicate, `object`: QuadObject, graph: QuadGraph): typings.rdflib.libStatementMod.default[SubjectType, PredicateType, ObjectType, GraphType] = js.native
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.rdflib.libNamedNodeMod.default
    - typings.rdflib.libLiteralMod.default
    - typings.rdflib.libCollectionMod.default[
  typings.rdflib.libNodeInternalMod.default | typings.rdflib.libBlankNodeMod.default | typings.rdflib.libCollectionMod.Collection[scala.Any] | typings.rdflib.libLiteralMod.default | typings.rdflib.libVariableMod.default]
    - typings.rdflib.libBlankNodeMod.default
    - typings.rdflib.libVariableMod.default
    - typings.rdflib.libEmptyMod.default
  */
  type ObjectType = _ObjectType | (typings.rdflib.libCollectionMod.default[
    default | typings.rdflib.libBlankNodeMod.default | typings.rdflib.libCollectionMod.Collection[Any] | typings.rdflib.libLiteralMod.default | typings.rdflib.libVariableMod.default
  ])
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.rdflib.libTfTypesMod.Term
    - typings.rdflib.libNodeInternalMod.default
    - js.Date
    - java.lang.String
    - scala.Double
    - scala.Boolean
  ...
  */
  type ValueType = js.UndefOr[
    _ValueType | (typings.rdflib.libCollectionMod.default[
      default | typings.rdflib.libBlankNodeMod.default | typings.rdflib.libCollectionMod.Collection[Any] | typings.rdflib.libLiteralMod.default | typings.rdflib.libVariableMod.default
