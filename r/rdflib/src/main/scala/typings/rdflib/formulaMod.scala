...
object formulaMod {
  ...
  trait Formula
    ...
    def add(subject: QuadSubject, predicate: Unit, `object`: String): (typings.rdflib.statementMod.default[SubjectType, PredicateType, ObjectType, GraphType]) | Null | this.type | Double = js.native
    def add(subject: QuadSubject, predicate: Unit, `object`: String, graph: QuadGraph): (typings.rdflib.statementMod.default[SubjectType, PredicateType, ObjectType, GraphType]) | Null | this.type | Double = js.native
    def add(subject: QuadSubject, predicate: Unit, `object`: Unit, graph: QuadGraph): (typings.rdflib.statementMod.default[SubjectType, PredicateType, ObjectType, GraphType]) | Null | this.type | Double = js.native
    def add(subject: QuadSubject, predicate: Unit, `object`: Term): (typings.rdflib.statementMod.default[SubjectType, PredicateType, ObjectType, GraphType]) | Null | this.type | Double = js.native
    def add(subject: QuadSubject, predicate: Unit, `object`: Term, graph: QuadGraph): (typings.rdflib.statementMod.default[SubjectType, PredicateType, ObjectType, GraphType]) | Null | this.type | Double = js.native
    ...
    def add(subject: QuadSubject, predicate: QuadPredicate, `object`: Unit, graph: QuadGraph): (typings.rdflib.statementMod.default[SubjectType, PredicateType, ObjectType, GraphType]) | Null | this.type | Double = js.native
    ...
    def add(subject: Quad[QuadSubject, QuadPredicate, QuadObject, QuadGraph], predicate: Unit, `object`: Term): (typings.rdflib.statementMod.default[SubjectType, PredicateType, ObjectType, GraphType]) | Null | this.type | Double = js.native
    def add(
      subject: Quad[QuadSubject, QuadPredicate, QuadObject, QuadGraph],
      predicate: Unit,
      `object`: Term,
    ...
    def sym(uri: String, name: Any): typings.rdflib.namedNodeMod.default = js.native
