...
object libStoreMod {
  ...
  trait IndexedFormula
    ...
    var _existentialVariables: js.UndefOr[js.Array[typings.rdflib.libBlankNodeMod.default]] = js.native
    
    var _universalVariables: js.UndefOr[js.Array[typings.rdflib.libNamedNodeMod.default]] = js.native
    ...
    def add(
      subj: QuadSubject | (Quad[QuadSubject, QuadPredicate, QuadObject, QuadGraph]) | (js.Array[
          (Quad[QuadSubject, QuadPredicate, QuadObject, QuadGraph]) | (typings.rdflib.libStatementMod.default[SubjectType, PredicateType, ObjectType, GraphType])
        ]) | (typings.rdflib.libStatementMod.default[SubjectType, PredicateType, ObjectType, GraphType]),
    ...
    /**
      ...
      */
    def allAliases(x: typings.rdflib.libNamedNodeMod.default): js.Array[typings.rdflib.libNamedNodeMod.default] = js.native
    ...
    /**
      ...
      */
    def canon(): typings.rdflib.libNodeMod.default = js.native
    def canon(term: Term): typings.rdflib.libNodeMod.default = js.native
    ...
    /**
      ...
      */
    def declareExistential(x: typings.rdflib.libBlankNodeMod.default): typings.rdflib.libBlankNodeMod.default = js.native
    ...
    def query(
      myQuery: Query,
      callback: js.Function1[/* bindings */ Bindings, Unit],
      fetcher: typings.rdflib.libFetcherMod.default
    ): Unit = js.native
    def query(
      myQuery: Query,
      callback: js.Function1[/* bindings */ Bindings, Unit],
    ...
    /**
      ...
      */
    def sameThings(x: typings.rdflib.libNamedNodeMod.default, y: typings.rdflib.libNamedNodeMod.default): Boolean = js.native
    ...
    /**
      ...
      */
    var updater: js.UndefOr[typings.rdflib.libUpdateManagerMod.default] = js.native
