...
object libFetcherMod {
  ...
  trait Fetcher
    ...
    /** Create an empty resource if it really does not exist
      ...
      */
    def createIfNotExists(doc: typings.rdflib.libNamedNodeMod.default): js.Promise[ExtendedResponse] = js.native
    def createIfNotExists(doc: typings.rdflib.libNamedNodeMod.default, contentType: Unit, data: String): js.Promise[ExtendedResponse] = js.native
    @JSName("createIfNotExists")
    def createIfNotExists_textturtle(doc: typings.rdflib.libNamedNodeMod.default, contentType: textSlashturtle): js.Promise[ExtendedResponse] = js.native
    @JSName("createIfNotExists")
    def createIfNotExists_textturtle(doc: typings.rdflib.libNamedNodeMod.default, contentType: textSlashturtle, data: String): js.Promise[ExtendedResponse] = js.native
    ...
    var store: typings.rdflib.libStoreMod.default = js.native
