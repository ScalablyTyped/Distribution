...
object tfTypesMod {
  ...
  - typings.rdflib.factoryTypesMod._TFIDFactoryTypes because Already inherited
  - typings.rdflib.factoryTypesMod._Comparable because Already inherited
  - typings.rdflib.tfTypesMod.QuadObject because Already inherited */ trait Literal
    extends StObject
       with Term {
  ...
  */
  ...
  object QuadGraph {
    ...
    inline def DefaultGraph(equals_ : Term => Boolean): typings.rdflib.tfTypesMod.DefaultGraph = {
      val __obj = js.Dynamic.literal(termType = "DefaultGraph", value = "")
      __obj.updateDynamic("equals")(js.Any.fromFunction1(equals_))
      __obj.asInstanceOf[typings.rdflib.tfTypesMod.DefaultGraph]
    }
