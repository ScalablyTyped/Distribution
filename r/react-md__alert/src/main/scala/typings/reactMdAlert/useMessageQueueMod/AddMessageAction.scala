...
object AddMessageAction {
  @scala.inline
  def apply[/* <: typings.reactMdAlert.messageQueueContextMod.Message */ M](duplicates: DuplicateBehavior, message: M, `type`: /* "ADD_MESSAGE" */ String): AddMessageAction[M] = {
  ...
  @scala.inline
  implicit class AddMessageActionOps[Self <: AddMessageAction[_], /* <: typings.reactMdAlert.messageQueueContextMod.Message */ M] (val x: Self with AddMessageAction[M]) extends AnyVal {
    @scala.inline
