...
object SnackbarQueueProps {
  @scala.inline
  def apply[/* <: typings.reactMdAlert.messageQueueContextMod.ToastMessage */ M](id: String, queue: js.Array[M]): SnackbarQueueProps[M] = {
  ...
  @scala.inline
  implicit class SnackbarQueuePropsOps[Self <: SnackbarQueueProps[_], /* <: typings.reactMdAlert.messageQueueContextMod.ToastMessage */ M] (val x: Self with SnackbarQueueProps[M]) extends AnyVal {
    @scala.inline
