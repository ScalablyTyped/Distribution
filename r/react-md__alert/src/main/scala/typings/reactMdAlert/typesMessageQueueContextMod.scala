...
import typings.reactMdAlert.reactMdAlertStrings.`additions removals`
import typings.reactMdAlert.reactMdAlertStrings.`additions text`
import typings.reactMdAlert.reactMdAlertStrings.`inline`
import typings.reactMdAlert.reactMdAlertStrings.`removals additions`
import typings.reactMdAlert.reactMdAlertStrings.`removals text`
import typings.reactMdAlert.reactMdAlertStrings.`text additions`
import typings.reactMdAlert.reactMdAlertStrings.`text removals`
import typings.reactMdAlert.reactMdAlertStrings.additions
import typings.reactMdAlert.reactMdAlertStrings.all
import typings.reactMdAlert.reactMdAlertStrings.ascending
import typings.reactMdAlert.reactMdAlertStrings.assertive
import typings.reactMdAlert.reactMdAlertStrings.both
import typings.reactMdAlert.reactMdAlertStrings.copy
import typings.reactMdAlert.reactMdAlertStrings.date
import typings.reactMdAlert.reactMdAlertStrings.decimal
import typings.reactMdAlert.reactMdAlertStrings.descending
import typings.reactMdAlert.reactMdAlertStrings.dialog
import typings.reactMdAlert.reactMdAlertStrings.email
import typings.reactMdAlert.reactMdAlertStrings.execute
import typings.reactMdAlert.reactMdAlertStrings.grammar
import typings.reactMdAlert.reactMdAlertStrings.grid
import typings.reactMdAlert.reactMdAlertStrings.horizontal
import typings.reactMdAlert.reactMdAlertStrings.inherit
import typings.reactMdAlert.reactMdAlertStrings.link
import typings.reactMdAlert.reactMdAlertStrings.list
import typings.reactMdAlert.reactMdAlertStrings.listbox
import typings.reactMdAlert.reactMdAlertStrings.location
import typings.reactMdAlert.reactMdAlertStrings.menu
import typings.reactMdAlert.reactMdAlertStrings.mixed
import typings.reactMdAlert.reactMdAlertStrings.move
import typings.reactMdAlert.reactMdAlertStrings.no
import typings.reactMdAlert.reactMdAlertStrings.none
import typings.reactMdAlert.reactMdAlertStrings.numeric
import typings.reactMdAlert.reactMdAlertStrings.off
import typings.reactMdAlert.reactMdAlertStrings.on
import typings.reactMdAlert.reactMdAlertStrings.other
import typings.reactMdAlert.reactMdAlertStrings.page
import typings.reactMdAlert.reactMdAlertStrings.polite
import typings.reactMdAlert.reactMdAlertStrings.popup
import typings.reactMdAlert.reactMdAlertStrings.removals
import typings.reactMdAlert.reactMdAlertStrings.search
import typings.reactMdAlert.reactMdAlertStrings.spelling
import typings.reactMdAlert.reactMdAlertStrings.step
import typings.reactMdAlert.reactMdAlertStrings.tel
import typings.reactMdAlert.reactMdAlertStrings.text
import typings.reactMdAlert.reactMdAlertStrings.time
import typings.reactMdAlert.reactMdAlertStrings.tree
...
object typesMessageQueueContextMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactMdAlert.reactMdAlertStrings.restart
    - typings.reactMdAlert.reactMdAlertStrings.prevent
    - typings.reactMdAlert.reactMdAlertStrings.allow
  */
  trait DuplicateBehavior extends StObject
  object DuplicateBehavior {
    
    inline def allow: typings.reactMdAlert.reactMdAlertStrings.allow = "allow".asInstanceOf[typings.reactMdAlert.reactMdAlertStrings.allow]
    
    inline def prevent: typings.reactMdAlert.reactMdAlertStrings.prevent = "prevent".asInstanceOf[typings.reactMdAlert.reactMdAlertStrings.prevent]
    
    inline def restart: typings.reactMdAlert.reactMdAlertStrings.restart = "restart".asInstanceOf[typings.reactMdAlert.reactMdAlertStrings.restart]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactMdAlert.reactMdAlertStrings.normal
    - typings.reactMdAlert.reactMdAlertStrings.next
    - typings.reactMdAlert.reactMdAlertStrings.immediate
    - typings.reactMdAlert.reactMdAlertStrings.replace
  */
  trait MessagePriority extends StObject
  object MessagePriority {
    
    inline def immediate: typings.reactMdAlert.reactMdAlertStrings.immediate = "immediate".asInstanceOf[typings.reactMdAlert.reactMdAlertStrings.immediate]
    
    inline def next: typings.reactMdAlert.reactMdAlertStrings.next = "next".asInstanceOf[typings.reactMdAlert.reactMdAlertStrings.next]
    
    inline def normal: typings.reactMdAlert.reactMdAlertStrings.normal = "normal".asInstanceOf[typings.reactMdAlert.reactMdAlertStrings.normal]
    
    inline def replace: typings.reactMdAlert.reactMdAlertStrings.replace = "replace".asInstanceOf[typings.reactMdAlert.reactMdAlertStrings.replace]
  }
  ...
  object MessageQueueActions {
    ...
    extension [Self <: MessageQueueActions[?], M /* <: Message */](x: Self & MessageQueueActions[M]) {
      ...
      inline def setPopMessage(value: () => Unit): Self = StObject.set(x, "popMessage", js.Any.fromFunction0(value))
      
      inline def setResetQueue(value: () => js.Array[M]): Self = StObject.set(x, "resetQueue", js.Any.fromFunction0(value))
      
      inline def setRestartTimer(value: () => Unit): Self = StObject.set(x, "restartTimer", js.Any.fromFunction0(value))
  ...
  object ToastMessage {
    ...
    extension [Self <: ToastMessage](x: Self) {
      ...
      inline def setAction(value: ButtonProps | ReactNode): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
