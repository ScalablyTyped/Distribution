...
trait ToastMessage extends js.Object {
  ...
  /**
    ...
    */
  var action: js.UndefOr[ButtonProps | ReactNode] = js.native
  ...
  /**
    ...
    * clicked.
    */
  var disableActionHide: js.UndefOr[Boolean] = js.native
  /**
...
object ToastMessage {
  ...
  implicit class ToastMessageOps[Self <: ToastMessage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAction(value: ButtonProps | ReactNode): Self = this.set("action", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDisableActionHide(value: Boolean): Self = this.set("disableActionHide", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableActionHide: Self = this.set("disableActionHide", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setTwoLines(value: Boolean): Self = this.set("twoLines", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTwoLines: Self = this.set("twoLines", js.undefined)
    @scala.inline
