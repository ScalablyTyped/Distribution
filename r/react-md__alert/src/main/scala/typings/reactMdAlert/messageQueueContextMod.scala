...
object messageQueueContextMod {
  ...
  */
  ...
  object MessageQueueActions {
    ...
    @scala.inline
    implicit class MessageQueueActionsMutableBuilder[Self <: MessageQueueActions[?], M /* <: Message */] (val x: Self & MessageQueueActions[M]) extends AnyVal {
  ...
  object ToastMessage {
    ...
    implicit class ToastMessageMutableBuilder[Self <: ToastMessage] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAction(value: ButtonProps | ReactNode): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
