...
object buildResizeDetectorMod {
  ...
  trait ComponentsProps[ElementT /* <: HTMLElement */]
    ...
    var nodeType: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 176, starting with typings.reactResizeDetector.reactResizeDetectorStrings.a, typings.reactResizeDetector.reactResizeDetectorStrings.abbr, typings.reactResizeDetector.reactResizeDetectorStrings.address */ Any
      ] = js.undefined
  ...
  object ComponentsProps {
    ...
    implicit open class MutableBuilder[Self <: ComponentsProps[?], ElementT /* <: HTMLElement */] (val x: Self & ComponentsProps[ElementT]) extends AnyVal {
      ...
      inline def setNodeType(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 176, starting with typings.reactResizeDetector.reactResizeDetectorStrings.a, typings.reactResizeDetector.reactResizeDetectorStrings.abbr, typings.reactResizeDetector.reactResizeDetectorStrings.address */ Any
      ): Self = StObject.set(x, "nodeType", value.asInstanceOf[js.Any])
