...
import typings.reactTracking.anon.PropsWithChildren
...
object mod {
  ...
  */
  ...
  object TrackingHook {
    ...
    inline def apply[P](Track: TrackingComponent[P], getTrackingData: () => js.Object, trackEvent: Partial[P] => Unit): TrackingHook[P] = {
      val __obj = js.Dynamic.literal(Track = Track.asInstanceOf[js.Any], getTrackingData = js.Any.fromFunction0(getTrackingData), trackEvent = js.Any.fromFunction1(trackEvent))
