package typings.relayDashCompiler.libReportersGraphQLConsoleReporterMod
...
@JSImport("relay-compiler/lib/reporters/GraphQLConsoleReporter", JSImport.Namespace)
@js.native
