...
@JSImport("relay-compiler/lib/transforms/RelayRelayDirectiveTransform", JSImport.Namespace)
@js.native
object libTransformsRelayRelayDirectiveTransformMod extends js.Object {
  /**
