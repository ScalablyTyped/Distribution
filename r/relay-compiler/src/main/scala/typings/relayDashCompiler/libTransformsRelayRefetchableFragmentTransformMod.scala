...
@JSImport("relay-compiler/lib/transforms/RelayRefetchableFragmentTransform", JSImport.Namespace)
@js.native
object libTransformsRelayRefetchableFragmentTransformMod extends js.Object {
  /**
