...
trait Fragment
  ...
  var kind: typings.relayCompiler.relayCompilerStrings.Fragment = js.native
...
object Fragment {
  ...
  implicit class FragmentOps[Self <: Fragment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typings.relayCompiler.relayCompilerStrings.Fragment): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
