...
/* Rewritten from type alias, can be one of: 
  - typings.relayCompiler.graphQLIRMod.SourceLocation
  - typings.relayCompiler.graphQLIRMod.GeneratedLocation
  - typings.relayCompiler.graphQLIRMod.DerivedLocation
  - typings.relayCompiler.graphQLIRMod.UnknownLocation
*/
