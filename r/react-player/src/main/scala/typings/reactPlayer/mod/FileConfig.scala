...
object FileConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(forceAudio)) __obj.updateDynamic("forceAudio")(forceAudio.get.asInstanceOf[js.Any])
    if (!js.isUndefined(forceDASH)) __obj.updateDynamic("forceDASH")(forceDASH.get.asInstanceOf[js.Any])
    if (!js.isUndefined(forceHLS)) __obj.updateDynamic("forceHLS")(forceHLS.get.asInstanceOf[js.Any])
    if (!js.isUndefined(forceVideo)) __obj.updateDynamic("forceVideo")(forceVideo.get.asInstanceOf[js.Any])
