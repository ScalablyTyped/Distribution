...
import typings.ret.typesTypesMod.types.CHAR
import typings.ret.typesTypesMod.types.GROUP
import typings.ret.typesTypesMod.types.POSITION
import typings.ret.typesTypesMod.types.RANGE
import typings.ret.typesTypesMod.types.REFERENCE
import typings.ret.typesTypesMod.types.REPETITION
import typings.ret.typesTypesMod.types.ROOT
import typings.ret.typesTypesMod.types.SET
...
object tokensMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.ret.tokensMod.Group
    - typings.ret.tokensMod.Position
    - typings.ret.tokensMod.Set
    - typings.ret.tokensMod.Range
    - typings.ret.tokensMod.Repetition
    - typings.ret.tokensMod.Reference
    - typings.ret.tokensMod.Char
  */
  trait Token
    extends StObject
       with Tokens
  object Token {
    ...
    inline def Char(`type`: CHAR, value: Double): typings.ret.tokensMod.Char = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.ret.tokensMod.Char]
    }
    
    inline def Group(remember: Boolean, `type`: GROUP): typings.ret.tokensMod.Group = {
      val __obj = js.Dynamic.literal(remember = remember.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.ret.tokensMod.Group]
    }
    
    inline def Position(`type`: POSITION, value: $ | ^ | b_ | B): typings.ret.tokensMod.Position = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.ret.tokensMod.Position]
    }
    
    inline def Range(from: Double, to: Double, `type`: RANGE): typings.ret.tokensMod.Range = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], to = to.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.ret.tokensMod.Range]
    }
    
    inline def Reference(`type`: REFERENCE, value: Double): typings.ret.tokensMod.Reference = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.ret.tokensMod.Reference]
    }
    
    inline def Repetition(max: Double, min: Double, `type`: REPETITION, value: Token): typings.ret.tokensMod.Repetition = {
      val __obj = js.Dynamic.literal(max = max.asInstanceOf[js.Any], min = min.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.ret.tokensMod.Repetition]
    }
    
    inline def Set(not: Boolean, set: SetTokens, `type`: SET): typings.ret.tokensMod.Set = {
      val __obj = js.Dynamic.literal(not = not.asInstanceOf[js.Any], set = set.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.ret.tokensMod.Set]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.ret.tokensMod.Root
    - typings.ret.tokensMod.Token
  */
  ...
  object Tokens {
    ...
    inline def Root(`type`: ROOT): typings.ret.tokensMod.Root = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.ret.tokensMod.Root]
    }
