...
object distEsmUsePreviewMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.reactDndPreview.distEsmUsePreviewMod.usePreviewStateFull[T, El]
  */
  ...
  object usePreviewState {
    ...
    inline def usePreviewStateFull[T, El /* <: Element */](
      ...
      __obj.asInstanceOf[typings.reactDndPreview.distEsmUsePreviewMod.usePreviewStateFull[T, El]]
    }
  }
