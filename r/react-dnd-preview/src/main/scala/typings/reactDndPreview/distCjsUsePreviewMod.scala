...
object distCjsUsePreviewMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.reactDndPreview.distCjsUsePreviewMod.usePreviewStateFull[T, El]
  */
  ...
  object usePreviewState {
    ...
    inline def usePreviewStateFull[T, El /* <: Element */](
      ...
      __obj.asInstanceOf[typings.reactDndPreview.distCjsUsePreviewMod.usePreviewStateFull[T, El]]
    }
  }
