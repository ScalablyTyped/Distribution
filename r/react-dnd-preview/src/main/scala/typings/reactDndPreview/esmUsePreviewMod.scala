...
object esmUsePreviewMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.reactDndPreview.esmUsePreviewMod.usePreviewStateFull[T, El]
  */
  ...
  object usePreviewState {
    ...
    inline def usePreviewStateFull[T, El /* <: Element */](
      ...
      __obj.asInstanceOf[typings.reactDndPreview.esmUsePreviewMod.usePreviewStateFull[T, El]]
    }
  }
