...
object ParseOptions {
  ...
  def apply(
    ...
    resolveUndefinedEntity: js.Function1[/* ref */ java.lang.String, java.lang.String] = null
  ): ParseOptions = {
    ...
    if (resolveUndefinedEntity != null) __obj.updateDynamic("resolveUndefinedEntity")(resolveUndefinedEntity)
