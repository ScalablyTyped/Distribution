package typings
package rmcDashCalendarLib.libCalendarMod
...
@js.native
trait Calendar
  extends reactLib.reactMod.PureComponent[rmcDashCalendarLib.libCalendarPropsMod.PropsType, StateType, js.Any] {
  @JSName("componentWillReceiveProps")
  def componentWillReceiveProps_MCalendar(nextProps: rmcDashCalendarLib.libCalendarPropsMod.PropsType): scala.Unit = js.native
