...
trait Anon_Evt extends js.Object {
  ...
  def onTouchMove(evt: reactLib.reactMod.TouchEvent[stdLib.HTMLDivElement]): scala.Unit
  def onTouchStart(evt: reactLib.reactMod.TouchEvent[stdLib.HTMLDivElement]): scala.Unit
}
...
object Anon_Evt {
  ...
  def apply(
    ...
    onTouchMove: reactLib.reactMod.TouchEvent[stdLib.HTMLDivElement] => scala.Unit,
    onTouchStart: reactLib.reactMod.TouchEvent[stdLib.HTMLDivElement] => scala.Unit
  ): Anon_Evt = {
