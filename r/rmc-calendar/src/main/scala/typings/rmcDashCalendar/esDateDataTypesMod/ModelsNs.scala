package typings.rmcDashCalendar.esDateDataTypesMod

import typings.react.reactMod.ReactNode
import typings.rmcDashCalendar.esDateDataTypesMod.ModelsNs.CellData
import typings.rmcDashCalendar.esDateDataTypesMod.ModelsNs.SelectType
...
object ModelsNs extends js.Object {
  ...
  object SelectType extends js.Object {
    ...
    /* 2 */ val All: typings.rmcDashCalendar.esDateDataTypesMod.ModelsNs.SelectType.All with Double = js.native
    /* 6 */ val End: typings.rmcDashCalendar.esDateDataTypesMod.ModelsNs.SelectType.End with Double = js.native
    /* 5 */ val Middle: typings.rmcDashCalendar.esDateDataTypesMod.ModelsNs.SelectType.Middle with Double = js.native
    /* 0 */ val None: typings.rmcDashCalendar.esDateDataTypesMod.ModelsNs.SelectType.None with Double = js.native
    /* 3 */ val Only: typings.rmcDashCalendar.esDateDataTypesMod.ModelsNs.SelectType.Only with Double = js.native
    /* 1 */ val Single: typings.rmcDashCalendar.esDateDataTypesMod.ModelsNs.SelectType.Single with Double = js.native
    /* 4 */ val Start: typings.rmcDashCalendar.esDateDataTypesMod.ModelsNs.SelectType.Start with Double = js.native
    @JSBracketAccess
