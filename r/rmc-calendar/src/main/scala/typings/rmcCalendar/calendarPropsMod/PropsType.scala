...
trait PropsType extends js.Object {
  ...
  /** 替换标题栏 */
  var renderHeader: js.UndefOr[js.Function1[/* prop */ typings.rmcCalendar.headerMod.PropsType, ReactNode]] = js.undefined
...
object PropsType {
  ...
  def apply(
    ...
    renderHeader: /* prop */ typings.rmcCalendar.headerMod.PropsType => ReactNode = null,
