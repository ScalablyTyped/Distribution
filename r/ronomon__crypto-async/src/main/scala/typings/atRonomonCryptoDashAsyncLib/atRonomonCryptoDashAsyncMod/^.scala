...
object ^ extends js.Object {
  def cipher(
    ...
    cb: js.Function2[/* error */ js.UndefOr[stdLib.Error], /* ciphertext */ nodeLib.Buffer, scala.Unit]
  ...
  def cipher(
    ...
    cb: js.Function2[/* error */ js.UndefOr[stdLib.Error], /* targetSize */ scala.Double, scala.Unit]
  ): scala.Unit = js.native
  def hash(
    algorithm: java.lang.String,
    source: nodeLib.Buffer,
    cb: js.Function2[/* error */ js.UndefOr[stdLib.Error], /* hash */ nodeLib.Buffer, scala.Unit]
  ): scala.Unit = js.native
  def hash(
    algorithm: java.lang.String,
    source: nodeLib.Buffer,
  ...
  def hmac(
    ...
    key: nodeLib.Buffer,
    source: nodeLib.Buffer,
    cb: js.Function2[/* error */ js.UndefOr[stdLib.Error], /* hmac */ nodeLib.Buffer, scala.Unit]
  ): scala.Unit = js.native
}
