...
object LanguageStringsDto {
  ...
  @scala.inline
  implicit class LanguageStringsDtoOps[Self <: LanguageStringsDto] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDataVarargs(value: StringDictionary[String]*): Self = this.set("data", js.Array(value :_*))
    
    @scala.inline
    def setData(value: js.Array[StringDictionary[String]]): Self = this.set("data", value.asInstanceOf[js.Any])
