...
object chipMod {
  ...
  object ChipProps {
    ...
    implicit class ChipPropsMutableBuilder[Self <: ChipProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLeftIcon(value: ReactNode): Self = StObject.set(x, "leftIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRightIcon(value: ReactNode): Self = StObject.set(x, "rightIcon", value.asInstanceOf[js.Any])
