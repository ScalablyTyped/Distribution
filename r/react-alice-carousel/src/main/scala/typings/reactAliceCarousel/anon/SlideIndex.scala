...
object SlideIndex {
  ...
  inline def apply(slideIndex: Double, slidesLength: Double): SlideIndex = {
  ...
  extension [Self <: SlideIndex](x: Self) {
    
    inline def setSlideIndex(value: Double): Self = StObject.set(x, "slideIndex", value.asInstanceOf[js.Any])
    
    inline def setSlidesLength(value: Double): Self = StObject.set(x, "slidesLength", value.asInstanceOf[js.Any])
  }
}
