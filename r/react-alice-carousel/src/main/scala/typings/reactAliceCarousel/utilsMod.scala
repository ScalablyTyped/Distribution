...
object utilsMod {
  ...
  inline def debounce(func: js.Function1[/* repeated */ js.Any, Unit]): js.Function1[/* repeated */ js.Any, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("debounce")(func.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* repeated */ js.Any, Unit]]
  inline def debounce(func: js.Function1[/* repeated */ js.Any, Unit], ms: Double): js.Function1[/* repeated */ js.Any, Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("debounce")(func.asInstanceOf[js.Any], ms.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* repeated */ js.Any, Unit]]
  
  inline def debug(args: js.Any*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("debug")(args.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def getActiveIndex(index: Double, dotsLength: Double, infinite: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getActiveIndex")(index.asInstanceOf[js.Any], dotsLength.asInstanceOf[js.Any], infinite.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getActiveSlideIndex(isNextSlideDisabled: js.Any, state: State): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getActiveSlideIndex")(isNextSlideDisabled.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getDotsNavigationLength(itemsCount: Double, itemsInSlide: Double, autoWidth: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getDotsNavigationLength")(itemsCount.asInstanceOf[js.Any], itemsInSlide.asInstanceOf[js.Any], autoWidth.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def getDotsNavigationLength(itemsCount: Double, itemsInSlide: Unit, autoWidth: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getDotsNavigationLength")(itemsCount.asInstanceOf[js.Any], itemsInSlide.asInstanceOf[js.Any], autoWidth.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def getDotsNavigationLength(itemsCount: Unit, itemsInSlide: Double, autoWidth: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getDotsNavigationLength")(itemsCount.asInstanceOf[js.Any], itemsInSlide.asInstanceOf[js.Any], autoWidth.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def getDotsNavigationLength(itemsCount: Unit, itemsInSlide: Unit, autoWidth: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getDotsNavigationLength")(itemsCount.asInstanceOf[js.Any], itemsInSlide.asInstanceOf[js.Any], autoWidth.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getFadeoutAnimationPosition(nextIndex: js.Any, state: State): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getFadeoutAnimationPosition")(nextIndex.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getSlideIndexForNonMultipleItems(activeIndex: js.Any, itemsInSlide: js.Any, slidesLength: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getSlideIndexForNonMultipleItems")(activeIndex.asInstanceOf[js.Any], itemsInSlide.asInstanceOf[js.Any], slidesLength.asInstanceOf[js.Any])).asInstanceOf[Double]
  
  inline def getSlideInfo(): SlideIndex = ^.asInstanceOf[js.Dynamic].applyDynamic("getSlideInfo")().asInstanceOf[SlideIndex]
  inline def getSlideInfo(activeIndex: Double): SlideIndex = ^.asInstanceOf[js.Dynamic].applyDynamic("getSlideInfo")(activeIndex.asInstanceOf[js.Any]).asInstanceOf[SlideIndex]
  inline def getSlideInfo(activeIndex: Double, slidesLength: Double): SlideIndex = (^.asInstanceOf[js.Dynamic].applyDynamic("getSlideInfo")(activeIndex.asInstanceOf[js.Any], slidesLength.asInstanceOf[js.Any])).asInstanceOf[SlideIndex]
  inline def getSlideInfo(activeIndex: Unit, slidesLength: Double): SlideIndex = (^.asInstanceOf[js.Dynamic].applyDynamic("getSlideInfo")(activeIndex.asInstanceOf[js.Any], slidesLength.asInstanceOf[js.Any])).asInstanceOf[SlideIndex]
  
  inline def getSlideItemInfo(state: State): IsPrevSlideDisabled = ^.asInstanceOf[js.Dynamic].applyDynamic("getSlideItemInfo")(state.asInstanceOf[js.Any]).asInstanceOf[IsPrevSlideDisabled]
  ...
  inline def getStartIndex(index: Double, childrenLength: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getStartIndex")(index.asInstanceOf[js.Any], childrenLength.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def getStartIndex(index: Unit, childrenLength: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getStartIndex")(index.asInstanceOf[js.Any], childrenLength.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getSwipeShiftValue(cursor: Double, transformationSet: js.Array[TransformationSetItem]): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getSwipeShiftValue")(cursor.asInstanceOf[js.Any], transformationSet.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def getSwipeShiftValue(cursor: Unit, transformationSet: js.Array[TransformationSetItem]): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getSwipeShiftValue")(cursor.asInstanceOf[js.Any], transformationSet.asInstanceOf[js.Any])).asInstanceOf[Double]
  
  inline def getSwipeTouchendIndex(position: js.Any, state: State): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getSwipeTouchendIndex")(position.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getSwipeTransformationCursor(transformationSet: js.Array[TransformationSetItem]): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("getSwipeTransformationCursor")(transformationSet.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def getSwipeTransformationCursor(transformationSet: js.Array[TransformationSetItem], position: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getSwipeTransformationCursor")(transformationSet.asInstanceOf[js.Any], position.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def getSwipeTransformationCursor(transformationSet: js.Array[TransformationSetItem], position: Double, deltaX: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getSwipeTransformationCursor")(transformationSet.asInstanceOf[js.Any], position.asInstanceOf[js.Any], deltaX.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def getSwipeTransformationCursor(transformationSet: js.Array[TransformationSetItem], position: Unit, deltaX: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getSwipeTransformationCursor")(transformationSet.asInstanceOf[js.Any], position.asInstanceOf[js.Any], deltaX.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getTransformationItemIndex(transformationSet: js.Array[TransformationSetItem]): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("getTransformationItemIndex")(transformationSet.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def getTransformationItemIndex(transformationSet: js.Array[TransformationSetItem], position: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getTransformationItemIndex")(transformationSet.asInstanceOf[js.Any], position.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getTransformationSetItem(): TransformationSetItem = ^.asInstanceOf[js.Dynamic].applyDynamic("getTransformationSetItem")().asInstanceOf[TransformationSetItem]
  inline def getTransformationSetItem(cursor: Double): TransformationSetItem = ^.asInstanceOf[js.Dynamic].applyDynamic("getTransformationSetItem")(cursor.asInstanceOf[js.Any]).asInstanceOf[TransformationSetItem]
  inline def getTransformationSetItem(cursor: Double, transformationSet: js.Array[TransformationSetItem]): TransformationSetItem = (^.asInstanceOf[js.Dynamic].applyDynamic("getTransformationSetItem")(cursor.asInstanceOf[js.Any], transformationSet.asInstanceOf[js.Any])).asInstanceOf[TransformationSetItem]
  inline def getTransformationSetItem(cursor: Unit, transformationSet: js.Array[TransformationSetItem]): TransformationSetItem = (^.asInstanceOf[js.Dynamic].applyDynamic("getTransformationSetItem")(cursor.asInstanceOf[js.Any], transformationSet.asInstanceOf[js.Any])).asInstanceOf[TransformationSetItem]
  ...
  inline def shouldCancelSlideAnimation(activeIndex: js.Any, itemsCount: js.Any, itemsInSlide: js.Any): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("shouldCancelSlideAnimation")(activeIndex.asInstanceOf[js.Any], itemsCount.asInstanceOf[js.Any], itemsInSlide.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def shouldDisableDots(props: Props, state: State): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("shouldDisableDots")(props.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def shouldRecalculateSlideIndex(activeIndex: js.Any, itemsCount: js.Any): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("shouldRecalculateSlideIndex")(activeIndex.asInstanceOf[js.Any], itemsCount.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def shouldRecalculateSwipePosition(currentPosition: js.Any, minPosition: js.Any, maxPosition: js.Any): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("shouldRecalculateSwipePosition")(currentPosition.asInstanceOf[js.Any], minPosition.asInstanceOf[js.Any], maxPosition.asInstanceOf[js.Any])).asInstanceOf[Boolean]
}
