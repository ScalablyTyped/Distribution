...
object Dictx {
  ...
  inline def apply(disabled: js.Any, dragging: js.Any, index: js.Any, value: js.Any): Dictx = {
  ...
  extension [Self <: Dictx](x: Self) {
    ...
    inline def setDragging(value: js.Any): Self = StObject.set(x, "dragging", value.asInstanceOf[js.Any])
