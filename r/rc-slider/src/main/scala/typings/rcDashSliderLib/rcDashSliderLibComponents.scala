...
object rcDashSliderLibComponents {
  ...
  @scala.inline
  def RangeProps: rcDashSliderLib.rcDashSliderMod.RangeProps.type = rcDashSliderLib.rcDashSliderMod.RangeProps
  type RangeProps = rcDashSliderLib.rcDashSliderMod.RangeProps
  @scala.inline
  def SliderProps: rcDashSliderLib.rcDashSliderMod.SliderProps.type = rcDashSliderLib.rcDashSliderMod.SliderProps
  type SliderProps = rcDashSliderLib.rcDashSliderMod.SliderProps
}
