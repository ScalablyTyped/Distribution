...
object interfaceMod {
  ...
  object UploadProps {
    ...
    implicit class UploadPropsMutableBuilder[Self <: UploadProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnError(value: (/* error */ Error, /* ret */ js.Object, /* file */ RcFile) => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction3(value))
      ...
      @scala.inline
      def setOnMouseEnter(value: /* e */ MouseEvent[HTMLDivElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
      
      @scala.inline
      def setOnMouseLeave(value: /* e */ MouseEvent[HTMLDivElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction1(value))
  ...
  */
  ...
  object UploadRequestMethod {
    ...
    @scala.inline
    def PATCH: typings.rcUpload.rcUploadStrings.PATCH = "PATCH".asInstanceOf[typings.rcUpload.rcUploadStrings.PATCH]
    
    @scala.inline
    def POST: typings.rcUpload.rcUploadStrings.POST = "POST".asInstanceOf[typings.rcUpload.rcUploadStrings.POST]
    
    @scala.inline
    def PUT: typings.rcUpload.rcUploadStrings.PUT = "PUT".asInstanceOf[typings.rcUpload.rcUploadStrings.PUT]
