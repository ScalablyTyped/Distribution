...
trait UploadProps extends js.Object {
  ...
  var action: js.UndefOr[String | (js.Function1[/* file */ RcFile, String])] = js.native
  ...
  var component: js.UndefOr[JSXElementConstructor[_]] = js.native
  ...
  var customRequest: js.UndefOr[js.Function0[Unit]] = js.native
  
  var dangerouslySetInnerHTML: js.UndefOr[Html] = js.native
  
  var data: js.UndefOr[js.Object | (js.Function1[/* file */ RcFile | String | Blob, js.Object])] = js.native
  ...
  var onError: js.UndefOr[js.Function3[/* error */ Error, /* ret */ js.Object, /* file */ RcFile, Unit]] = js.native
  ...
  var onMouseEnter: js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLDivElement, NativeMouseEvent], Unit]] = js.native
  
  var onMouseLeave: js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLDivElement, NativeMouseEvent], Unit]] = js.native
...
object UploadProps {
  ...
  implicit class UploadPropsOps[Self <: UploadProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActionFunction1(value: /* file */ RcFile => String): Self = this.set("action", js.Any.fromFunction1(value))
    
    @scala.inline
    def setAction(value: String | (js.Function1[/* file */ RcFile, String])): Self = this.set("action", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setBeforeUpload(value: (/* file */ RcFile, /* FileList */ js.Array[RcFile]) => Boolean | js.Promise[RcFile]): Self = this.set("beforeUpload", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setComponentFunction1(value: _ => ReactElement | Null): Self = this.set("component", js.Any.fromFunction1(value))
    
    @scala.inline
    def setComponent(value: JSXElementConstructor[_]): Self = this.set("component", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCustomRequest(value: () => Unit): Self = this.set("customRequest", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setDataFunction1(value: /* file */ RcFile | String | Blob => js.Object): Self = this.set("data", js.Any.fromFunction1(value))
    
    @scala.inline
    def setData(value: js.Object | (js.Function1[/* file */ RcFile | String | Blob, js.Object])): Self = this.set("data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnError(value: (/* error */ Error, /* ret */ js.Object, /* file */ RcFile) => Unit): Self = this.set("onError", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setOnMouseEnter(value: /* e */ MouseEvent[HTMLDivElement, NativeMouseEvent] => Unit): Self = this.set("onMouseEnter", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteOnMouseEnter: Self = this.set("onMouseEnter", js.undefined)
    
    @scala.inline
    def setOnMouseLeave(value: /* e */ MouseEvent[HTMLDivElement, NativeMouseEvent] => Unit): Self = this.set("onMouseLeave", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnProgress(value: (/* event */ UploadProgressEvent, /* file */ RcFile) => Unit): Self = this.set("onProgress", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnStart(value: /* file */ RcFile => Unit): Self = this.set("onStart", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnSuccess(value: (/* response */ js.Object, /* file */ RcFile, /* xhr */ js.Object) => Unit): Self = this.set("onSuccess", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setTransformFile(value: /* file */ RcFile => String | Blob | RcFile | (js.Thenable[String | Blob | RcFile])): Self = this.set("transformFile", js.Any.fromFunction1(value))
