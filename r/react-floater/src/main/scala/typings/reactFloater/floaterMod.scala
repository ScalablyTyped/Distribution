...
import typings.reactFloater.typesMod.RenderProps
...
object floaterMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `floaterMod.foo` */
