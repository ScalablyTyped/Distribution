...
/* Inlined react.react.CSSProperties & {  length :number,   spread :number} */
trait CSSPropertieslengthnumber extends StObject {
  ...
  /**
    ...
    */
  var motion: js.UndefOr[typings.csstype.mod.Property.Offset[String | Double]] = js.undefined
  ...
  /**
    ...
    * @see https://developer.mozilla.org/docs/Web/CSS/offset
    */
  var offset: js.UndefOr[typings.csstype.mod.Property.Offset[String | Double]] = js.undefined
  ...
  /**
    ...
    */
  var zIndex: js.UndefOr[typings.csstype.mod.Property.ZIndex] = js.undefined
...
object CSSPropertieslengthnumber {
  
  inline def apply(length: Double, spread: Double): CSSPropertieslengthnumber = {
    val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any], spread = spread.asInstanceOf[js.Any])
    __obj.asInstanceOf[CSSPropertieslengthnumber]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSPropertieslengthnumber] (val x: Self) extends AnyVal {
    ...
    inline def setMotion(value: typings.csstype.mod.Property.Offset[String | Double]): Self = StObject.set(x, "motion", value.asInstanceOf[js.Any])
    ...
    inline def setOffset(value: typings.csstype.mod.Property.Offset[String | Double]): Self = StObject.set(x, "offset", value.asInstanceOf[js.Any])
    ...
    inline def setZIndex(value: typings.csstype.mod.Property.ZIndex): Self = StObject.set(x, "zIndex", value.asInstanceOf[js.Any])
