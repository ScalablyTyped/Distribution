...
import typings.popperjsCore.libModifiersEventListenersMod.Options
...
import typings.reactFloater.reactFloaterStrings.eventListeners
...
trait PartialEventListenersModi extends StObject {
