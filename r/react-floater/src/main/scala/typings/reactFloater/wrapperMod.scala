...
import typings.reactFloater.typesMod.HandlerFunction
import typings.reactFloater.typesMod.Statuses
...
object wrapperMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `wrapperMod.foo` */
