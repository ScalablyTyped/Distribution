...
trait Options[T] extends js.Object {
  var actionTransformer: js.UndefOr[js.Function1[/* action */ reduxLib.reduxMod.Action[_], _]] = js.undefined
...
object Options {
  @scala.inline
  def apply[T](
    actionTransformer: /* action */ reduxLib.reduxMod.Action[_] => _ = null,
