...
trait MeasureProps extends js.Object {
  ...
  var innerRef: js.UndefOr[js.Function1[/* ref */ reactLib.Element | scala.Null, scala.Unit]] = js.undefined
...
object MeasureProps {
  ...
  def apply(
    ...
    innerRef: js.Function1[/* ref */ reactLib.Element | scala.Null, scala.Unit] = null,
    margin: js.UndefOr[scala.Boolean] = js.undefined,
    offset: js.UndefOr[scala.Boolean] = js.undefined,
    onResize: js.Function1[/* contentRect */ ContentRect, scala.Unit] = null,
