...
object mod {
  ...
  inline def blankNode_Fmod_=(x: js.Function0[BlankNode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("blankNode")(x.asInstanceOf[js.Any])
  
  inline def dataset[InQuad /* <: BaseQuad */](): typings.rdfjsDataset.datasetCoreMod.^[InQuad] = ^.asInstanceOf[js.Dynamic].applyDynamic("dataset")().asInstanceOf[typings.rdfjsDataset.datasetCoreMod.^[InQuad]]
  inline def dataset[InQuad /* <: BaseQuad */](quads: js.Array[InQuad]): typings.rdfjsDataset.datasetCoreMod.^[InQuad] = ^.asInstanceOf[js.Dynamic].applyDynamic("dataset")(quads.asInstanceOf[js.Any]).asInstanceOf[typings.rdfjsDataset.datasetCoreMod.^[InQuad]]
  ...
  inline def defaultGraphInstance_=(x: DefaultGraph): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultGraphInstance")(x.asInstanceOf[js.Any])
  
  @JSImport("@rdfjs/dataset", "defaultGraph")
  @js.native
  def defaultGraph_Fmod: js.Function0[DefaultGraph] = js.native
  
  inline def defaultGraph_Fmod_=(x: js.Function0[DefaultGraph]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultGraph")(x.asInstanceOf[js.Any])
  ...
  inline def literal_=(x: js.Function1[/* value */ String, Literal]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("literal")(x.asInstanceOf[js.Any])
  ...
  inline def namedNode_=(x: js.Function1[/* value */ String, NamedNode[String]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("namedNode")(x.asInstanceOf[js.Any])
  ...
  inline def quad(subject: QuadSubject, predicate: QuadPredicate, `object`: QuadObject): Quad = (^.asInstanceOf[js.Dynamic].applyDynamic("quad")(subject.asInstanceOf[js.Any], predicate.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any])).asInstanceOf[Quad]
  inline def quad_=(
    x: js.Function3[
      /* subject */ QuadSubject, 
      /* predicate */ QuadPredicate, 
  ...
  inline def variable_=(x: js.Function1[/* value */ String, Variable]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("variable")(x.asInstanceOf[js.Any])
}
