...
package object mod {
  ...
  @scala.inline
  def selectLocationState[TState](state: TState): typings.reduxFirstRouter.mod.LocationState[js.Object, _] = typings.reduxFirstRouter.mod.^.asInstanceOf[js.Dynamic].applyDynamic("selectLocationState")(state.asInstanceOf[js.Any]).asInstanceOf[typings.reduxFirstRouter.mod.LocationState[js.Object, _]]
