...
trait RequestPromise extends Request {
  ...
  @JSName("catch")
  var catch_Original: Fn_ErrorFilter1 = js.native
  @JSName("finally")
  var finally_Original: js.Function1[/* handler */ js.Function0[Resolvable[_]], Bluebird[_]] = js.native
  @JSName("then")
  var then_Original: Fn_Error = js.native
  def cancel(): Unit = js.native
  def `catch`[U](): Bluebird[U | _] = js.native
  def `catch`[U](onReject: js.Function1[/* error */ js.Any, Resolvable[U]]): Bluebird[U | _] = js.native
  def `catch`[U, E1](
    // tslint:disable-next-line:unified-signatures
  filter1: CatchFilter[E1],
    onReject: js.Function1[/* error */ E1, Resolvable[U]]
  ): Bluebird[U | _] = js.native
  def `catch`[U, E1](filter1: Constructor[E1], onReject: js.Function1[/* error */ E1, Resolvable[U]]): Bluebird[U | _] = js.native
  def `catch`[U, E1, E2](
    filter1: CatchFilter[E1],
  ...
  def `finally`(handler: js.Function0[Resolvable[_]]): Bluebird[_] = js.native
  def promise(): typings.bluebird.bluebirdMod.^[_] = js.native
  def `then`[U](): Bluebird[U] = js.native
  def `then`[U](onFulfill: js.Function1[/* value */ js.Any, Resolvable[U]]): Bluebird[U] = js.native
  def `then`[U](
  ...
  @JSName("then")
  def then_TResult1TResult2[TResult1, TResult2](onfulfilled: js.Function1[/* value */ js.Any, Resolvable[TResult1]]): Bluebird[TResult1 | TResult2] = js.native
  @JSName("then")
  def then_TResult1TResult2[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ js.Any, Resolvable[TResult1]],
