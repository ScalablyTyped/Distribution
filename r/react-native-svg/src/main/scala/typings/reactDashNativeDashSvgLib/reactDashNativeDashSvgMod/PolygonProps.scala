...
trait PolygonProps extends CommonPathProps {
  var opacity: js.UndefOr[reactDashNativeDashSvgLib.NumberProp] = js.undefined
  var points: java.lang.String | js.Array[reactDashNativeDashSvgLib.NumberProp]
}

object PolygonProps {
  @scala.inline
  def apply(
    points: java.lang.String | js.Array[reactDashNativeDashSvgLib.NumberProp],
