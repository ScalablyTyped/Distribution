...
object UriProps {
  ...
  def apply(
    ...
    uri: String = null,
    vectorEffect: typings.reactDashNativeDashSvg.reactDashNativeDashSvgStrings.none | `non-scaling-stroke` | nonScalingStroke | typings.reactDashNativeDashSvg.reactDashNativeDashSvgStrings.default | inherit | uri = null,
    viewBox: String = null,
