...
object libTypescriptFabricImageNativeComponentMod extends Shortcut {
  
  @JSImport("react-native-svg/lib/typescript/fabric/ImageNativeComponent", JSImport.Default)
  @js.native
  ...
  object NativeProps {
    ...
    extension [Self <: NativeProps](x: Self) {
      ...
      inline def setSrcVarargs(value: ImageURISource*): Self = StObject.set(x, "src", js.Array(value*))
  ...
  /* This means you don't have to write `default`, but can instead just say `libTypescriptFabricImageNativeComponentMod.foo` */
