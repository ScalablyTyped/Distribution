...
object textPathNativeComponentMod extends Shortcut {
  ...
  object SvgTextCommonProps {
    ...
    extension [Self <: SvgTextCommonProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `textPathNativeComponentMod.foo` */
