...
object tspannativecomponentMod extends Shortcut {
  
  @JSImport("react-native-svg/lib/typescript/fabric/TSpanNativeComponent", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `tspannativecomponentMod.foo` */
