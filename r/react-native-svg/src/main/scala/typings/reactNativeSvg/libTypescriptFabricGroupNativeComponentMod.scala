...
object libTypescriptFabricGroupNativeComponentMod extends Shortcut {
  
  @JSImport("react-native-svg/lib/typescript/fabric/GroupNativeComponent", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libTypescriptFabricGroupNativeComponentMod.foo` */
