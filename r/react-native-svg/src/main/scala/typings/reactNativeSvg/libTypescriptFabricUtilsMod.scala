...
import typings.reactNativeSvg.reactNativeSvgStrings.`no-hide-descendants`
import typings.reactNativeSvg.reactNativeSvgStrings.assertive
import typings.reactNativeSvg.reactNativeSvgStrings.auto
import typings.reactNativeSvg.reactNativeSvgStrings.no
import typings.reactNativeSvg.reactNativeSvgStrings.none
import typings.reactNativeSvg.reactNativeSvgStrings.polite
import typings.reactNativeSvg.reactNativeSvgStrings.yes
