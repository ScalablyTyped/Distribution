...
@JSImport("react-native-svg/lib/typescript/ReactNativeSVG", "SvgWithCss")
@js.native
open class SvgWithCss protected ()
  extends typings.reactNativeSvg.libTypescriptCssMod.SvgWithCss {
