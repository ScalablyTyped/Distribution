...
object libTypescriptReactNativeSVGDotwebMod {
  ...
  @JSImport("react-native-svg/lib/typescript/ReactNativeSVG.web", "Circle")
  @js.native
  ...
  @js.native
  open class WebShape[P /* <: BaseProps */, C] protected ()
    extends Component[P, C, Any]
    ...
    var touchableHandleResponderMove: js.UndefOr[js.Function1[/* e */ GestureResponderEvent, Unit]] = js.native
    
    var touchableHandleResponderRelease: js.UndefOr[js.Function1[/* e */ GestureResponderEvent, Unit]] = js.native
    
    var touchableHandleResponderTerminate: js.UndefOr[js.Function1[/* e */ GestureResponderEvent, Unit]] = js.native
    
    var touchableHandleResponderTerminationRequest: js.UndefOr[js.Function1[/* e */ GestureResponderEvent, Boolean]] = js.native
    
    var touchableHandleStartShouldSetResponder: js.UndefOr[js.Function1[/* e */ GestureResponderEvent, Boolean]] = js.native
  }
  ...
  type BlurEvent = js.Object
  
  type EdgeInsetsProp = js.Object
  
  type FocusEvent = js.Object
  
  type LayoutEvent = js.Object
  
  type PressEvent = js.Object
}
