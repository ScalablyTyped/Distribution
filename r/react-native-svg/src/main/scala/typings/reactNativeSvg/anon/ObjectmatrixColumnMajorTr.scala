...
trait ObjectmatrixColumnMajorTr extends StObject {
  ...
  var matrix: js.UndefOr[ColumnMajorTransformMatrix] = js.undefined
...
object ObjectmatrixColumnMajorTr {
  
  inline def apply(
    constructor: js.Function,
    hasOwnProperty: PropertyKey => Boolean,
    propertyIsEnumerable: PropertyKey => Boolean
  ): ObjectmatrixColumnMajorTr = {
    val __obj = js.Dynamic.literal(constructor = constructor.asInstanceOf[js.Any], hasOwnProperty = js.Any.fromFunction1(hasOwnProperty), propertyIsEnumerable = js.Any.fromFunction1(propertyIsEnumerable))
    __obj.asInstanceOf[ObjectmatrixColumnMajorTr]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ObjectmatrixColumnMajorTr] (val x: Self) extends AnyVal {
    ...
    inline def setMatrix(value: ColumnMajorTransformMatrix): Self = StObject.set(x, "matrix", value.asInstanceOf[js.Any])
