...
/* Inlined std.Object & {  matrix :react-native-svg.react-native-svg/lib/typescript/lib/extract/types.ColumnMajorTransformMatrix | undefined,   style :[] | {} | undefined} & react-native-svg.react-native-svg/lib/typescript/lib/extract/types.TransformProps */
trait ObjectmatrixColumnMajorTrConstructor extends StObject {
...
object ObjectmatrixColumnMajorTrConstructor {
  
  inline def apply(
    constructor: js.Function,
    hasOwnProperty: PropertyKey => Boolean,
    propertyIsEnumerable: PropertyKey => Boolean
  ): ObjectmatrixColumnMajorTrConstructor = {
