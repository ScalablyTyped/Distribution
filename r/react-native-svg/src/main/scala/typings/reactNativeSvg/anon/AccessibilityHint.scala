...
trait AccessibilityHint extends StObject {
  ...
  var forwardedRef: js.UndefOr[
    (js.Function1[/* instance */ SVGElement | Null, Unit]) | (MutableRefObject[SVGElement | Null])
  ] = js.undefined
  ...
  var hitSlop: js.UndefOr[js.Object] = js.undefined
  
  var nativeID: js.UndefOr[String] = js.undefined
  
  var onBlur: js.UndefOr[js.Function1[/* e */ js.Object, Unit]] = js.undefined
  
  var onClick: js.UndefOr[js.Function1[/* event */ js.Object, js.Object]] = js.undefined
  
  var onFocus: js.UndefOr[js.Function1[/* e */ js.Object, Unit]] = js.undefined
  
  var onLayout: js.UndefOr[js.Function1[/* event */ js.Object, js.Object]] = js.undefined
  
  var onLongPress: js.UndefOr[js.Function1[/* event */ js.Object, js.Object]] = js.undefined
  
  var onPress: js.UndefOr[js.Function1[/* event */ js.Object, js.Object]] = js.undefined
  
  var onPressIn: js.UndefOr[js.Function1[/* event */ js.Object, js.Object]] = js.undefined
  
  var onPressOut: js.UndefOr[js.Function1[/* event */ js.Object, js.Object]] = js.undefined
  ...
  var pressRetentionOffset: js.UndefOr[js.Object] = js.undefined
  ...
  var translate: js.UndefOr[NumberArray & String] = js.undefined
...
object AccessibilityHint {
  ...
  inline def apply(style: js.Iterable[js.Object]): AccessibilityHint = {
  ...
  extension [Self <: AccessibilityHint](x: Self) {
    ...
    inline def setForwardedRef(
      value: (js.Function1[/* instance */ SVGElement | Null, Unit]) | (MutableRefObject[SVGElement | Null])
    ...
    inline def setGradientTransformVarargs(
    ...
    ): Self = StObject.set(x, "gradientTransform", js.Array(value*))
    
    inline def setHitSlop(value: js.Object): Self = StObject.set(x, "hitSlop", value.asInstanceOf[js.Any])
    ...
    inline def setOnBlur(value: /* e */ js.Object => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    
    inline def setOnBlurUndefined: Self = StObject.set(x, "onBlur", js.undefined)
    
    inline def setOnClick(value: /* event */ js.Object => js.Object): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
    
    inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
    
    inline def setOnFocus(value: /* e */ js.Object => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
    
    inline def setOnFocusUndefined: Self = StObject.set(x, "onFocus", js.undefined)
    
    inline def setOnLayout(value: /* event */ js.Object => js.Object): Self = StObject.set(x, "onLayout", js.Any.fromFunction1(value))
    
    inline def setOnLayoutUndefined: Self = StObject.set(x, "onLayout", js.undefined)
    
    inline def setOnLongPress(value: /* event */ js.Object => js.Object): Self = StObject.set(x, "onLongPress", js.Any.fromFunction1(value))
    
    inline def setOnLongPressUndefined: Self = StObject.set(x, "onLongPress", js.undefined)
    
    inline def setOnPress(value: /* event */ js.Object => js.Object): Self = StObject.set(x, "onPress", js.Any.fromFunction1(value))
    
    inline def setOnPressIn(value: /* event */ js.Object => js.Object): Self = StObject.set(x, "onPressIn", js.Any.fromFunction1(value))
    
    inline def setOnPressInUndefined: Self = StObject.set(x, "onPressIn", js.undefined)
    
    inline def setOnPressOut(value: /* event */ js.Object => js.Object): Self = StObject.set(x, "onPressOut", js.Any.fromFunction1(value))
    ...
    inline def setPatternTransformVarargs(
      value: (PerpectiveTransform | RotateTransform | RotateXTransform | RotateYTransform | RotateZTransform | ScaleTransform | ScaleXTransform | ScaleYTransform | TranslateXTransform | TranslateYTransform | SkewXTransform | SkewYTransform | MatrixTransform)*
    ): Self = StObject.set(x, "patternTransform", js.Array(value*))
    
    inline def setPressRetentionOffset(value: js.Object): Self = StObject.set(x, "pressRetentionOffset", value.asInstanceOf[js.Any])
    ...
    inline def setTranslate(value: NumberArray & String): Self = StObject.set(x, "translate", value.asInstanceOf[js.Any])
