...
/* Inlined std.Object & {  matrix :[number, number, number, number, number, number] | undefined} & react-native-svg.react-native-svg/lib/typescript/lib/extract/types.TransformProps */
trait Objectmatrixnumbernumbern extends StObject {
...
object Objectmatrixnumbernumbern {
  
  inline def apply(
    constructor: js.Function,
    hasOwnProperty: PropertyKey => Boolean,
    propertyIsEnumerable: PropertyKey => Boolean
  ): Objectmatrixnumbernumbern = {
    val __obj = js.Dynamic.literal(constructor = constructor.asInstanceOf[js.Any], hasOwnProperty = js.Any.fromFunction1(hasOwnProperty), propertyIsEnumerable = js.Any.fromFunction1(propertyIsEnumerable))
    __obj.asInstanceOf[Objectmatrixnumbernumbern]
  }
  
  extension [Self <: Objectmatrixnumbernumbern](x: Self) {
