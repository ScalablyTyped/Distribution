...
object libTypescriptFabricForeignObjectNativeComponentMod extends Shortcut {
  
  @JSImport("react-native-svg/lib/typescript/fabric/ForeignObjectNativeComponent", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libTypescriptFabricForeignObjectNativeComponentMod.foo` */
