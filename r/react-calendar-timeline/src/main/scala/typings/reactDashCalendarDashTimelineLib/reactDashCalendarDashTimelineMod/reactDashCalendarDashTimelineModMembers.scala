...
@js.native
object reactDashCalendarDashTimelineModMembers extends js.Object {
  var default: reactLib.reactMod.ReactNs.ClassicComponentClass[ReactCalendarTimelineProps] = js.native
