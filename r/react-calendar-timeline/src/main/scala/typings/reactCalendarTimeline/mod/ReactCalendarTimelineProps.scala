...
object ReactCalendarTimelineProps {
  @scala.inline
  def apply[/* <: typings.reactCalendarTimeline.mod.TimelineItemBase[_] */ CustomItem, /* <: typings.reactCalendarTimeline.mod.TimelineGroupBase */ CustomGroup](groups: js.Array[CustomGroup], items: js.Array[CustomItem]): ReactCalendarTimelineProps[CustomItem, CustomGroup] = {
  ...
  @scala.inline
  implicit class ReactCalendarTimelinePropsOps[Self <: ReactCalendarTimelineProps[_, _], /* <: typings.reactCalendarTimeline.mod.TimelineItemBase[_] */ CustomItem, /* <: typings.reactCalendarTimeline.mod.TimelineGroupBase */ CustomGroup] (val x: Self with (ReactCalendarTimelineProps[CustomItem, CustomGroup])) extends AnyVal {
    @scala.inline
