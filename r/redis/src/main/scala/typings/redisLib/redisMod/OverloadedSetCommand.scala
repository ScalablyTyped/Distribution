...
trait OverloadedSetCommand[T, U, R] extends js.Object {
  ...
  def apply(key: java.lang.String, arg1: org.scalablytyped.runtime.StringDictionary[T]): R = js.native
  def apply(key: java.lang.String, arg1: org.scalablytyped.runtime.StringDictionary[T], cb: Callback[U]): R = js.native
