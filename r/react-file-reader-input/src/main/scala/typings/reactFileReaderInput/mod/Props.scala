...
import typings.reactFileReaderInput.reactFileReaderInputStrings.`removals additions`
...
import typings.reactFileReaderInput.reactFileReaderInputStrings.copy
import typings.reactFileReaderInput.reactFileReaderInputStrings.date
import typings.reactFileReaderInput.reactFileReaderInputStrings.decimal
import typings.reactFileReaderInput.reactFileReaderInputStrings.descending
import typings.reactFileReaderInput.reactFileReaderInputStrings.dialog
import typings.reactFileReaderInput.reactFileReaderInputStrings.done
import typings.reactFileReaderInput.reactFileReaderInputStrings.email
import typings.reactFileReaderInput.reactFileReaderInputStrings.enter
import typings.reactFileReaderInput.reactFileReaderInputStrings.execute
import typings.reactFileReaderInput.reactFileReaderInputStrings.go
import typings.reactFileReaderInput.reactFileReaderInputStrings.grammar
import typings.reactFileReaderInput.reactFileReaderInputStrings.grid
import typings.reactFileReaderInput.reactFileReaderInputStrings.horizontal
import typings.reactFileReaderInput.reactFileReaderInputStrings.inherit
import typings.reactFileReaderInput.reactFileReaderInputStrings.link
import typings.reactFileReaderInput.reactFileReaderInputStrings.list
import typings.reactFileReaderInput.reactFileReaderInputStrings.listbox
import typings.reactFileReaderInput.reactFileReaderInputStrings.location
import typings.reactFileReaderInput.reactFileReaderInputStrings.menu
import typings.reactFileReaderInput.reactFileReaderInputStrings.mixed
import typings.reactFileReaderInput.reactFileReaderInputStrings.move
import typings.reactFileReaderInput.reactFileReaderInputStrings.next
import typings.reactFileReaderInput.reactFileReaderInputStrings.no
import typings.reactFileReaderInput.reactFileReaderInputStrings.none
import typings.reactFileReaderInput.reactFileReaderInputStrings.numeric
import typings.reactFileReaderInput.reactFileReaderInputStrings.off
import typings.reactFileReaderInput.reactFileReaderInputStrings.on
import typings.reactFileReaderInput.reactFileReaderInputStrings.other
import typings.reactFileReaderInput.reactFileReaderInputStrings.page
import typings.reactFileReaderInput.reactFileReaderInputStrings.polite
import typings.reactFileReaderInput.reactFileReaderInputStrings.popup
import typings.reactFileReaderInput.reactFileReaderInputStrings.previous
import typings.reactFileReaderInput.reactFileReaderInputStrings.removals
import typings.reactFileReaderInput.reactFileReaderInputStrings.search
import typings.reactFileReaderInput.reactFileReaderInputStrings.send
import typings.reactFileReaderInput.reactFileReaderInputStrings.spelling
import typings.reactFileReaderInput.reactFileReaderInputStrings.step
import typings.reactFileReaderInput.reactFileReaderInputStrings.tel
import typings.reactFileReaderInput.reactFileReaderInputStrings.text
import typings.reactFileReaderInput.reactFileReaderInputStrings.time
import typings.reactFileReaderInput.reactFileReaderInputStrings.tree
import typings.reactFileReaderInput.reactFileReaderInputStrings.url
import typings.reactFileReaderInput.reactFileReaderInputStrings.vertical
import typings.reactFileReaderInput.reactFileReaderInputStrings.yes
...
trait Props extends js.Object {
  ...
  /**
    ...
    */
  def onChange(event: ChangeEvent[HTMLInputElement], results: js.Array[Result]): Unit = js.native
...
object Props {
  ...
  @scala.inline
  def apply(onChange: (ChangeEvent[HTMLInputElement], js.Array[Result]) => Unit): Props = {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: (ChangeEvent[HTMLInputElement], js.Array[Result]) => Unit): Self = this.set("onChange", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setAs(value: Format): Self = this.set("as", value.asInstanceOf[js.Any])
