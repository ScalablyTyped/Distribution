...
import typings.reactFileReaderInput.reactFileReaderInputStrings.environment
...
import typings.reactFileReaderInput.reactFileReaderInputStrings.user
...
object mod {
  ...
  type FileInput = Component[Props, js.Object, Any]
  ...
  */
  ...
  object Format {
    ...
    inline def binary: typings.reactFileReaderInput.reactFileReaderInputStrings.binary = "binary".asInstanceOf[typings.reactFileReaderInput.reactFileReaderInputStrings.binary]
    
    inline def buffer: typings.reactFileReaderInput.reactFileReaderInputStrings.buffer = "buffer".asInstanceOf[typings.reactFileReaderInput.reactFileReaderInputStrings.buffer]
    
    inline def text: typings.reactFileReaderInput.reactFileReaderInputStrings.text = "text".asInstanceOf[typings.reactFileReaderInput.reactFileReaderInputStrings.text]
    
    inline def url: typings.reactFileReaderInput.reactFileReaderInputStrings.url = "url".asInstanceOf[typings.reactFileReaderInput.reactFileReaderInputStrings.url]
  }
  ...
  object Props {
    ...
    inline def apply(onChange: (ChangeEvent[HTMLInputElement], js.Array[Result]) => Unit): Props = {
    ...
    implicit open class MutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
      ...
      inline def setOnChange(value: (ChangeEvent[HTMLInputElement], js.Array[Result]) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
  ...
  type Result = js.Tuple2[ProgressEvent[EventTarget], File]
}
