  ...
  */
  ...
  object Props {
    ...
    implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAs(value: Format): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: (ChangeEvent[HTMLInputElement], js.Array[Result]) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
