...
trait Props extends js.Object {
  ...
  /**
    ...
    */
  def onChange(event: reactLib.reactMod.SyntheticEvent[_, reactLib.Event], results: js.Array[Result]): scala.Unit
}

object Props {
  @scala.inline
  def apply(
    onChange: (reactLib.reactMod.SyntheticEvent[_, reactLib.Event], js.Array[Result]) => scala.Unit,
    as: Format = null
  ): Props = {
