...
object Props {
  ...
  def apply(
    ...
    if (!js.isUndefined(alwaysShowMask)) __obj.updateDynamic("alwaysShowMask")(alwaysShowMask.asInstanceOf[js.Any])
    ...
    if (formatChars != null) __obj.updateDynamic("formatChars")(formatChars.asInstanceOf[js.Any])
