...
/* Inlined std.Omit<@react-md/list.@react-md/list.ListProps, 'role'> */
trait OmitListPropsrole extends StObject {
...
object OmitListPropsrole {
  
  inline def apply(): OmitListPropsrole = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitListPropsrole]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitListPropsrole] (val x: Self) extends AnyVal {
