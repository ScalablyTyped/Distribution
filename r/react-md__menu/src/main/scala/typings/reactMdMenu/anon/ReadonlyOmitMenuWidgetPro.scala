...
trait ReadonlyOmitMenuWidgetPro extends StObject {
  ...
  val `aria-orientation`: js.UndefOr[typings.reactMdMenu.reactMdMenuStrings.horizontal | vertical] = js.undefined
...
object ReadonlyOmitMenuWidgetPro {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ReadonlyOmitMenuWidgetPro] (val x: Self) extends AnyVal {
