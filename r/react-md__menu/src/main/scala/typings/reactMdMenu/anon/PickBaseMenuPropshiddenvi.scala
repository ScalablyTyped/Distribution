...
object PickBaseMenuPropshiddenvi {
  ...
  @scala.inline
  def apply(`aria-label`: String, controlId: String, id: String, onRequestClose: () => Unit, visible: Boolean): PickBaseMenuPropshiddenvi = {
    ...
    __obj.asInstanceOf[PickBaseMenuPropshiddenvi]
  }
  
  @scala.inline
  implicit class PickBaseMenuPropshiddenviOps[Self <: PickBaseMenuPropshiddenvi] (val x: Self) extends AnyVal {
