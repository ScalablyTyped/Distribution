...
object anon {
  ...
  trait MenuItemSeparatorPropsrol
    extends StObject
       with _ValidMenuItem {
    ...
    // <command>, <menuitem>
    // WAI-ARIA
    var role: js.UndefOr[String] & separator
  ...
  object MenuItemSeparatorPropsrol {
    ...
    inline def apply(role: js.UndefOr[String] & separator): MenuItemSeparatorPropsrol = {
      val __obj = js.Dynamic.literal(role = role.asInstanceOf[js.Any])
      __obj.asInstanceOf[MenuItemSeparatorPropsrol]
    }
    
    extension [Self <: MenuItemSeparatorPropsrol](x: Self) {
      ...
      inline def setRole(value: js.UndefOr[String] & separator): Self = StObject.set(x, "role", value.asInstanceOf[js.Any])
  ...
  trait PickBaseMenuPropshiddenvi extends StObject {
    ...
    var role: js.UndefOr[menu] = js.undefined
  ...
  object PickBaseMenuPropshiddenvi {
    ...
    inline def apply(`aria-label`: String, controlId: String, id: String, onRequestClose: () => Unit, visible: Boolean): PickBaseMenuPropshiddenvi = {
    ...
    extension [Self <: PickBaseMenuPropshiddenvi](x: Self) {
  ...
  object PickBaseMenuPropshiddenviAbout {
    ...
    extension [Self <: PickBaseMenuPropshiddenviAbout](x: Self) {
