...
- typings.reactMdMenu.typesMod.MenuTransitionProps because var conflicts: className. Inlined onExit, onExited, exit, onEnter, onExiting, onEntered, appear, enter, onEntering, timeout, temporary, classNames
- typings.reactMdMenu.typesMod.BaseDropdownMenuProps because var conflicts: className. Inlined  */ trait DropdownMenuButtonProps
  extends StObject
