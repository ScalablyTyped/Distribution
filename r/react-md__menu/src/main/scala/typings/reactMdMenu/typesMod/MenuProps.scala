...
- typings.react.mod.HTMLAttributes because var conflicts: className, id. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results
- typings.reactMdMenu.typesMod.MenuWidgetProps because var conflicts: className. Inlined id, disableElevation */ trait MenuProps
  extends StObject
