...
object dropdownMenuItemMod {
  ...
  object DropdownMenuItemProps {
    ...
    @scala.inline
    implicit class DropdownMenuItemPropsMutableBuilder[Self <: DropdownMenuItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisableEscapeCascade(value: Boolean): Self = StObject.set(x, "disableEscapeCascade", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisableEscapeCascadeUndefined: Self = StObject.set(x, "disableEscapeCascade", js.undefined)
