...
object dropdownMenuItemMod {
  
  @JSImport("@react-md/menu/types/DropdownMenuItem", "DropdownMenuItem")
  @js.native
  ...
  trait DropdownMenuItemProps extends StObject {
    ...
    /**
      ...
      * be closed.
      */
    var disableEscapeCascade: js.UndefOr[Boolean] = js.undefined
    ...
    var role: js.UndefOr[menuitem | button] = js.undefined
  ...
  object DropdownMenuItemProps {
    ...
    inline def apply(id: String, items: js.Array[ValidMenuItem]): DropdownMenuItemProps = {
    ...
    extension [Self <: DropdownMenuItemProps](x: Self) {
      ...
      inline def setDisableEscapeCascade(value: Boolean): Self = StObject.set(x, "disableEscapeCascade", value.asInstanceOf[js.Any])
      
      inline def setDisableEscapeCascadeUndefined: Self = StObject.set(x, "disableEscapeCascade", js.undefined)
