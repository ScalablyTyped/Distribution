...
trait MenuProps
  ...
  /**
    ...
    */
  @JSName("id")
  var id_MenuProps: String = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("role")
  var role_MenuProps: js.UndefOr[menu] = js.native
  /**
...
object MenuProps {
  @scala.inline
  def apply(controlId: String, id: String, onRequestClose: () => Unit, visible: Boolean): MenuProps = {
