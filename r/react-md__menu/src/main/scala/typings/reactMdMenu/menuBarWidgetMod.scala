...
object menuBarWidgetMod {
  
  @JSImport("@react-md/menu/types/MenuBarWidget", JSImport.Namespace)
  @js.native
  ...
  /* Inlined std.Omit<@react-md/list.@react-md/list.ListProps, 'role' | 'horizontal'> */
  trait BaseMenuBarWidgetProps extends StObject {
  ...
  object BaseMenuBarWidgetProps {
    
    inline def apply(): BaseMenuBarWidgetProps = {
  ...
  type MenuBarWidgetProps = LabelRequiredForA11y[BaseMenuBarWidgetProps]
}
