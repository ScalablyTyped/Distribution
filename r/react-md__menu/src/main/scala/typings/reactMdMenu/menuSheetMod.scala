...
import typings.reactMdSheet.sheetMod.BaseSheetProps
...
object menuSheetMod {
  ...
  - typings.reactMdUtils.useKeyboardFocusMod.KeyboardFocusCallbacks because var conflicts: onFocus, onKeyDown. Inlined onJumpToFirst, onSearch, onIncrement, onDecrement, onJumpToLast
  - typings.reactMdUtils.useKeyboardFocusMod.KeyboardFocusHookOptions because var conflicts: onFocus, onKeyDown. Inlined onFocusChange, getDefaultFocusIndex */ trait MenuSheetProps
    extends StObject
       with BaseSheetProps
