...
object menuButtonMod {
  ...
  trait MenuButtonProps extends AppBarActionClassNameProps {
    ...
    var `aria-haspopup`: js.UndefOr[
        Boolean | dialog | grid | listbox | menu | typings.reactMdButton.reactMdButtonStrings.menu | tree | `true` | typings.reactMdMenu.reactMdMenuBooleans.`true`
      ] = js.native
  ...
  object MenuButtonProps {
    ...
    implicit class MenuButtonPropsMutableBuilder[Self <: MenuButtonProps] (val x: Self) extends AnyVal {
      ...
      def `setAria-haspopup`(
        value: Boolean | dialog | grid | listbox | menu | typings.reactMdButton.reactMdButtonStrings.menu | tree | `true` | typings.reactMdMenu.reactMdMenuBooleans.`true`
