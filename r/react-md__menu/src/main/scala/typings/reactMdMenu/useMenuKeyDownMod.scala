...
object useMenuKeyDownMod {
  ...
  object MenuKeyDownOptions {
    ...
    inline def apply(defaultFocus: String, horizontal: Boolean, onRequestClose: () => Unit, portalled: Boolean): MenuKeyDownOptions = {
    ...
    extension [Self <: MenuKeyDownOptions](x: Self) {
      
      inline def setDefaultFocus(value: String): Self = StObject.set(x, "defaultFocus", value.asInstanceOf[js.Any])
      
      inline def setHorizontal(value: Boolean): Self = StObject.set(x, "horizontal", value.asInstanceOf[js.Any])
      
      inline def setMenu(value: HTMLDivElement): Self = StObject.set(x, "menu", value.asInstanceOf[js.Any])
