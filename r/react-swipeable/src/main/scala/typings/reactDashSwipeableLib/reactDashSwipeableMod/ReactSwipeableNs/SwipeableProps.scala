package typings
package reactDashSwipeableLib.reactDashSwipeableMod.ReactSwipeableNs
...
trait SwipeableProps[T /* <: stdLib.Element */]
  extends reactLib.reactMod.ReactNs.ClassAttributes[reactDashSwipeableLib.reactDashSwipeableMod.ReactSwipeable[T]]
     with reactLib.reactMod.ReactNs.HTMLAttributes[T] {
  var delta: js.UndefOr[scala.Double] = js.undefined
  var disabled: js.UndefOr[scala.Boolean] = js.undefined
  var flickThreshold: js.UndefOr[scala.Double] = js.undefined
  var innerRef: js.UndefOr[reactLib.reactMod.ReactNs.Ref[T]] = js.undefined
...
object SwipeableProps {
  ...
  def apply[T /* <: stdLib.Element */](
    ClassAttributes: reactLib.reactMod.ReactNs.ClassAttributes[reactDashSwipeableLib.reactDashSwipeableMod.ReactSwipeable[T]] = null,
    ...
    innerRef: reactLib.reactMod.ReactNs.Ref[T] = null,
