...
/* Rewritten from type alias, can be one of: 
  - typings.reactBeautifulDnd.reactBeautifulDndStrings.none
  - typings.reactBeautifulDnd.reactBeautifulDndStrings.open
  - typings.reactBeautifulDnd.reactBeautifulDndStrings.close
*/
