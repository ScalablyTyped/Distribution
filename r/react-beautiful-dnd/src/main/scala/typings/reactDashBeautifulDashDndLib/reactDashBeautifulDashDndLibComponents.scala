...
object reactDashBeautifulDashDndLibComponents {
  ...
  @scala.inline
  def DraggableProps: reactDashBeautifulDashDndLib.reactDashBeautifulDashDndMod.DraggableProps.type = reactDashBeautifulDashDndLib.reactDashBeautifulDashDndMod.DraggableProps
  type DraggableProps = reactDashBeautifulDashDndLib.reactDashBeautifulDashDndMod.DraggableProps
  @scala.inline
  ...
  @scala.inline
  def DroppableProps: reactDashBeautifulDashDndLib.reactDashBeautifulDashDndMod.DroppableProps.type = reactDashBeautifulDashDndLib.reactDashBeautifulDashDndMod.DroppableProps
  type DroppableProps = reactDashBeautifulDashDndLib.reactDashBeautifulDashDndMod.DroppableProps
}
