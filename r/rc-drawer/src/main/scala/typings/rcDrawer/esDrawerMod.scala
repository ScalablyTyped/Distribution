...
import typings.rcComponentPortal.esPortalMod.ContainerType
import typings.rcComponentPortal.esPortalMod.GetContainer
import typings.rcDrawer.esDrawerPopupMod.PushConfig
...
object esDrawerMod extends Shortcut {
  ...
  trait DrawerProps extends StObject {
    ...
    var motion: js.UndefOr[
        CSSMotionProps | (js.Function1[/* placement */ typings.rcDrawer.esDrawerPopupMod.Placement, CSSMotionProps])
      ] = js.undefined
    ...
    var placement: js.UndefOr[typings.rcDrawer.esDrawerPopupMod.Placement] = js.undefined
  ...
  object DrawerProps {
    ...
    implicit open class MutableBuilder[Self <: DrawerProps] (val x: Self) extends AnyVal {
      ...
      inline def setMotion(
        value: CSSMotionProps | (js.Function1[/* placement */ typings.rcDrawer.esDrawerPopupMod.Placement, CSSMotionProps])
      ): Self = StObject.set(x, "motion", value.asInstanceOf[js.Any])
      
      inline def setMotionFunction1(value: /* placement */ typings.rcDrawer.esDrawerPopupMod.Placement => CSSMotionProps): Self = StObject.set(x, "motion", js.Any.fromFunction1(value))
      ...
      inline def setPlacement(value: typings.rcDrawer.esDrawerPopupMod.Placement): Self = StObject.set(x, "placement", value.asInstanceOf[js.Any])
