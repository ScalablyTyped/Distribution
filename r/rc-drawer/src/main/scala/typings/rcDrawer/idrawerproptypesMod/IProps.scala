...
object IProps {
  ...
  implicit class IPropsOps[Self <: IProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClose(value: /* e */ (MouseEvent[Element, NativeMouseEvent]) | KeyboardEvent[Element] => Unit): Self = this.set("onClose", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnHandleClick(value: /* e */ (MouseEvent[Element, NativeMouseEvent]) | KeyboardEvent[Element] => Unit): Self = this.set("onHandleClick", js.Any.fromFunction1(value))
