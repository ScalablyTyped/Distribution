...
import typings.rcDrawer.rcDrawerStrings.`additions removals`
import typings.rcDrawer.rcDrawerStrings.`additions text`
import typings.rcDrawer.rcDrawerStrings.`inline`
import typings.rcDrawer.rcDrawerStrings.`removals additions`
import typings.rcDrawer.rcDrawerStrings.`removals text`
import typings.rcDrawer.rcDrawerStrings.`text additions`
import typings.rcDrawer.rcDrawerStrings.`text removals`
  ...
  */
  ...
  object IProps {
    ...
    implicit class IPropsMutableBuilder[Self <: IProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClose(value: /* e */ (MouseEvent[Element, NativeMouseEvent]) | KeyboardEvent[Element] => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnHandleClick(value: /* e */ (MouseEvent[Element, NativeMouseEvent]) | KeyboardEvent[Element] => Unit): Self = StObject.set(x, "onHandleClick", js.Any.fromFunction1(value))
