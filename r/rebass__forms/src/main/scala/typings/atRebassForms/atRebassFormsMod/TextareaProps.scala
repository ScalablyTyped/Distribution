package typings.atRebassForms.atRebassFormsMod
...
import typings.rebass.rebassMod.SxStyleProp
...
- Dropped {[ P in std.Exclude<keyof react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>, 'variant' | 'tx'> ]: react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>[P]} */ trait TextareaProps extends BoxKnownProps
