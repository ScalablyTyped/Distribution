...
- Dropped {[ P in std.Exclude<keyof react.react.LabelHTMLAttributes<std.HTMLLabelElement>, keyof @rebass/forms.@rebass/forms.LabelKnownProps> ]: react.react.LabelHTMLAttributes<std.HTMLLabelElement>[P]} */ trait LabelProps
