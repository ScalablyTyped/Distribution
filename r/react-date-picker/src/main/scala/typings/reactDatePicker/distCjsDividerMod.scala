...
object distCjsDividerMod {
  ...
  object default {
    ...
    @JSImport("react-date-picker/dist/cjs/Divider", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-date-picker/dist/cjs/Divider", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-date-picker/dist/cjs/Divider", "default.propTypes.children")
      @js.native
