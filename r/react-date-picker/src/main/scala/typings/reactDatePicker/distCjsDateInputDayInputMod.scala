...
import typings.reactDatePicker.anon.MaxDate
...
object distCjsDateInputDayInputMod {
  
  object default {
    
    inline def apply(param0: DayInputProps): Element = ^.asInstanceOf[js.Dynamic].apply(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.ariaLabel")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.className")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.disabled")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.inputRef")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.maxDate")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.minDate")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.month")
      @js.native
      def month: Requireable[String] = js.native
      inline def month_=(x: Requireable[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("month")(x.asInstanceOf[js.Any])
      
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.onChange")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.onKeyDown")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.onKeyUp")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.placeholder")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.required")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.showLeadingZeros")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.value")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/DayInput", "default.propTypes.year")
      @js.native
  ...
  type DayInputProps = MaxDate & (Omit[ComponentProps[TypeofInput], max | min | name])
}
