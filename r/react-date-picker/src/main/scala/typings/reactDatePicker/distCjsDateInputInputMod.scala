...
import typings.reactDatePicker.anon.ChangeEventHTMLInputEleme
import typings.reactDatePicker.anon.Current
import typings.reactDatePicker.anon.KeyboardEventHTMLInputEle
...
object distCjsDateInputInputMod {
  
  object default {
    
    inline def apply(param0: InputProps): Element = ^.asInstanceOf[js.Dynamic].apply(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("react-date-picker/dist/cjs/DateInput/Input", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.ariaLabel")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.autoFocus")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.className")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.disabled")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.inputRef")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.max")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.min")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.name")
      @js.native
      def name: Requireable[String] = js.native
      
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.nameForClass")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.onChange")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.onKeyDown")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.onKeyUp")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.placeholder")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.required")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.showLeadingZeros")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.step")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/Input", "default.propTypes.value")
      @js.native
