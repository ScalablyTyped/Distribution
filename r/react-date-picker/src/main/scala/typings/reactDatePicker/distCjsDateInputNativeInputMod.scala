...
object distCjsDateInputNativeInputMod {
  ...
  object default {
    ...
    @JSImport("react-date-picker/dist/cjs/DateInput/NativeInput", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-date-picker/dist/cjs/DateInput/NativeInput", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-date-picker/dist/cjs/DateInput/NativeInput", "default.propTypes.ariaLabel")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/NativeInput", "default.propTypes.disabled")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/NativeInput", "default.propTypes.maxDate")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/NativeInput", "default.propTypes.minDate")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/NativeInput", "default.propTypes.name")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/NativeInput", "default.propTypes.onChange")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/NativeInput", "default.propTypes.required")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/NativeInput", "default.propTypes.value")
      @js.native
      def value: Requireable[js.Date] = js.native
      
      @JSImport("react-date-picker/dist/cjs/DateInput/NativeInput", "default.propTypes.valueType")
      @js.native
  ...
  trait NativeInputProps extends StObject {
    ...
    var valueType: century | decade | year | month | day
  }
  object NativeInputProps {
    
    inline def apply(valueType: century | decade | year | month | day): NativeInputProps = {
