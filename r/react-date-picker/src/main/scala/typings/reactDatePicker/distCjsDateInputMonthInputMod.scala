...
import typings.reactDatePicker.anon.MinDate
...
object distCjsDateInputMonthInputMod {
  
  object default {
    
    inline def apply(param0: MonthInputProps): Element = ^.asInstanceOf[js.Dynamic].apply(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.ariaLabel")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.className")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.disabled")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.inputRef")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.maxDate")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.minDate")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.onChange")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.onKeyDown")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.onKeyUp")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.placeholder")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.required")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.showLeadingZeros")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.value")
      @js.native
      ...
      @JSImport("react-date-picker/dist/cjs/DateInput/MonthInput", "default.propTypes.year")
      @js.native
  ...
  type MonthInputProps = MinDate & (Omit[ComponentProps[TypeofInput], max | min | name])
}
