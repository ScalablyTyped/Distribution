...
import typings.reduxRouter.libActionCreatorsMod.ReduxRouterAction
...
object mod {
  ...
  object ReduxRouter {
    ...
    open class AbortedDeferredError ()
      extends typings.reduxRouter.libReduxRouterMod.default.AbortedDeferredError
    ...
    @JSImport("redux-router", "ReduxRouter.defer")
    @js.native
