...
object actionCreatorsMod {
  ...
  inline def initRoutes(routes: js.Any): ReduxRouterAction = ^.asInstanceOf[js.Dynamic].applyDynamic("initRoutes")(routes.asInstanceOf[js.Any]).asInstanceOf[ReduxRouterAction]
  ...
  inline def replaceRoutes(routes: js.Any): ReduxRouterAction = ^.asInstanceOf[js.Dynamic].applyDynamic("replaceRoutes")(routes.asInstanceOf[js.Any]).asInstanceOf[ReduxRouterAction]
  ...
  inline def routerDidChange(state: js.Any): ReduxRouterAction = ^.asInstanceOf[js.Dynamic].applyDynamic("routerDidChange")(state.asInstanceOf[js.Any]).asInstanceOf[ReduxRouterAction]
  ...
  object ReduxRouterAction {
    ...
    inline def apply(payload: js.Any, `type`: String): ReduxRouterAction = {
