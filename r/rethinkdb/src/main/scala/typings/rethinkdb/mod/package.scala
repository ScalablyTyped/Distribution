...
@scala.inline
def expr(stuff: js.Any): typings.rethinkdb.mod.Expression[js.Any] = typings.rethinkdb.mod.^.asInstanceOf[js.Dynamic].applyDynamic("expr")(stuff.asInstanceOf[js.Any]).asInstanceOf[typings.rethinkdb.mod.Expression[js.Any]]

@scala.inline
def js_(jsString: java.lang.String): typings.rethinkdb.mod.Operation[js.Any] = typings.rethinkdb.mod.^.asInstanceOf[js.Dynamic].applyDynamic("js")(jsString.asInstanceOf[js.Any]).asInstanceOf[typings.rethinkdb.mod.Operation[js.Any]]
@scala.inline
def js_(jsString: java.lang.String, opts: typings.rethinkdb.anon.Timeout): typings.rethinkdb.mod.Operation[js.Any] = (typings.rethinkdb.mod.^.asInstanceOf[js.Dynamic].applyDynamic("js")(jsString.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.rethinkdb.mod.Operation[js.Any]]
