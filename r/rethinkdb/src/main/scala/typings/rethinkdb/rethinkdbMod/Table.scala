...
import typings.rethinkdb.Anon_Function
...
trait Table
  ...
  def indexWait(): Operation[js.Array[Anon_Function]] = js.native
  def indexWait(name: String): Operation[js.Array[Anon_Function]] = js.native
