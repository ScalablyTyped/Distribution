...
trait Connection extends js.Object {
  ...
  def close(opts: NoReplyWait, cb: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  def on(event: java.lang.String, cb: js.Function): scala.Unit = js.native
  def reconnect(): js.Promise[Connection] = js.native
  def reconnect(cb: js.Function2[/* err */ stdLib.Error, /* conn */ this.type, scala.Unit]): scala.Unit = js.native
  def reconnect(opts: NoReplyWait): js.Promise[Connection] = js.native
  def reconnect(opts: NoReplyWait, cb: js.Function2[/* err */ stdLib.Error, /* conn */ this.type, scala.Unit]): scala.Unit = js.native
  def server(): js.Promise[ServerResult] = js.native
  def server(cb: js.Function2[/* err */ stdLib.Error, /* conn */ ServerResult, scala.Unit]): scala.Unit = js.native
