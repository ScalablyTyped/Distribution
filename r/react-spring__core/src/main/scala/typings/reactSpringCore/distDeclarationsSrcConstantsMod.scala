...
object distDeclarationsSrcConstantsMod {
  
  object config extends Shortcut {
    
    @JSImport("@react-spring/core/dist/declarations/src/constants", "config.default")
    @js.native
    val default: Friction = js.native
    
    @JSImport("@react-spring/core/dist/declarations/src/constants", "config.gentle")
    @js.native
    val gentle: Tension = js.native
    
    @JSImport("@react-spring/core/dist/declarations/src/constants", "config.molasses")
    @js.native
    val molasses: `2` = js.native
    
    @JSImport("@react-spring/core/dist/declarations/src/constants", "config.slow")
    @js.native
    val slow: `1` = js.native
    
    @JSImport("@react-spring/core/dist/declarations/src/constants", "config.stiff")
    @js.native
    val stiff: `0` = js.native
    
    @JSImport("@react-spring/core/dist/declarations/src/constants", "config.wobbly")
    @js.native
  ...
  @JSImport("@react-spring/core/dist/declarations/src/constants", "easings")
  @js.native
