...
trait UseResizeOptions extends StObject {
  ...
  var container: js.UndefOr[MutableRefObject[js.UndefOr[HTMLElement | Null]]] = js.undefined
...
object UseResizeOptions {
  
  inline def apply(): UseResizeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UseResizeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UseResizeOptions] (val x: Self) extends AnyVal {
    ...
    inline def setContainer(value: MutableRefObject[js.UndefOr[HTMLElement | Null]]): Self = StObject.set(x, "container", value.asInstanceOf[js.Any])
