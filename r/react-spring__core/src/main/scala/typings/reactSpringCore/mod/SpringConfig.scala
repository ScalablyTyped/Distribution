...
/* Inlined @react-spring/core.@react-spring/core.Partial<@react-spring/core.@react-spring/core.AnimationConfig> */
trait SpringConfig extends StObject {
  ...
  var constructor: js.UndefOr[js.Function0[scala.Any]] = js.undefined
...
object SpringConfig {
  ...
  implicit open class MutableBuilder[Self <: SpringConfig] (val x: Self) extends AnyVal {
    ...
    inline def setConstructor(value: () => scala.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction0(value))
