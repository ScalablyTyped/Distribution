...
object distReactSpringCoreDotcjsMod {
  ...
  open class BailSignal ()
    extends typings.reactSpringCore.distDeclarationsSrcMod.BailSignal
  
  @JSImport("@react-spring/core/dist/react-spring-core.cjs", "Controller")
  @js.native
  open class Controller[State /* <: Lookup[Any] */] ()
    extends typings.reactSpringCore.distDeclarationsSrcMod.Controller[State] {
  ...
  open class FrameValue[T] ()
    extends typings.reactSpringCore.distDeclarationsSrcMod.FrameValue[T]
  
  @JSImport("@react-spring/core/dist/react-spring-core.cjs", "Interpolation")
  @js.native
  open class Interpolation[Input, Output] protected ()
    extends typings.reactSpringCore.distDeclarationsSrcMod.Interpolation[Input, Output] {
  ...
  open class SpringValue[T] ()
    extends typings.reactSpringCore.distDeclarationsSrcMod.SpringValue[T] {
