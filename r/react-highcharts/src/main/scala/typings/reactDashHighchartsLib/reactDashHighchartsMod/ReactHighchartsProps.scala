...
trait ReactHighchartsProps extends js.Object {
  /**
    ...
    */
  var callback: js.UndefOr[js.Function1[/* chart */ highchartsLib.highchartsMod.ChartObject, scala.Unit]] = js.undefined
  /**
    * Highcharts configuration options.
    */
  var config: highchartsLib.highchartsMod.Options
  /**
...
object ReactHighchartsProps {
  @scala.inline
  def apply(
    config: highchartsLib.highchartsMod.Options,
    callback: /* chart */ highchartsLib.highchartsMod.ChartObject => scala.Unit = null,
