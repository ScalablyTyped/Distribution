...
import typings.reactNativePickerPicker.pickerIOSMod.PickerIOSProps
...
object mod {
  ...
  open class Picker[T] protected ()
    extends typings.reactNativePickerPicker.pickerMod.Picker[T] {
  ...
  open class PickerIOS protected ()
    extends typings.reactNativePickerPicker.pickerIOSMod.PickerIOS {
  ...
  object PickerIOS {
    ...
    @js.native
    open class Item ()
      extends typings.reactNativePickerPicker.pickerIOSMod.PickerIOS.Item
  }
}
