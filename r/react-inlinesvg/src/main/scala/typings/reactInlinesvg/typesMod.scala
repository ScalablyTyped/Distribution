...
object typesMod {
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setOnError(value: /* error */ Error | FetchError => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction1(value))
  ...
  object StorageItem {
    ...
    inline def apply(content: String, queue: js.Array[Callback], status: String): StorageItem = {
    ...
    extension [Self <: StorageItem](x: Self) {
      ...
      inline def setQueue(value: js.Array[Callback]): Self = StObject.set(x, "queue", value.asInstanceOf[js.Any])
      
      inline def setQueueVarargs(value: Callback*): Self = StObject.set(x, "queue", js.Array(value :_*))
