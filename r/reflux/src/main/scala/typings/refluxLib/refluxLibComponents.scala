...
object refluxLibComponents {
  ...
  @scala.inline
  def PureComponent[TOfStore /* <: org.scalablytyped.runtime.Instantiable0[refluxLib.refluxMod.Store] */, P, S, SS]: reactLib.reactMod.ComponentType[P] = js.constructorOf[refluxLib.refluxMod.PureComponent[TOfStore, P, S, SS]].asInstanceOf[reactLib.reactMod.ComponentType[P]]
}
