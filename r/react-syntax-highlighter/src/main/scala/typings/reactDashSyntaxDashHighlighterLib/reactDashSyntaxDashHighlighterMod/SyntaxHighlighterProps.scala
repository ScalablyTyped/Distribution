package typings
package reactDashSyntaxDashHighlighterLib.reactDashSyntaxDashHighlighterMod
...
trait SyntaxHighlighterProps
  ...
  var lineProps: js.UndefOr[
    reactDashSyntaxDashHighlighterLib.lineTagPropsFunction | reactLib.reactMod.DOMAttributes[stdLib.HTMLElement]
  ] = js.undefined
...
object SyntaxHighlighterProps {
  ...
  def apply(
    ...
    lineProps: reactDashSyntaxDashHighlighterLib.lineTagPropsFunction | reactLib.reactMod.DOMAttributes[stdLib.HTMLElement] = null,
