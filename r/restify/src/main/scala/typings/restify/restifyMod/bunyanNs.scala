...
import typings.bunyan.bunyanMod.Serializers
import typings.bunyan.bunyanMod.Stream
import typings.restify.Anon_Clientreq
import typings.restify.restifyMod.bunyanNs.RequestCaptureOptions
...
object bunyanNs extends js.Object {
  ...
  val serializers: Serializers with Anon_Clientreq = js.native
  /** create a bunyan logger */
  def createLogger(name: String): typings.bunyan.bunyanMod.^ = js.native
}
