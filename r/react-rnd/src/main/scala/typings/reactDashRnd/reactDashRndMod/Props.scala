...
import typings.reactDashRnd.reactDashRndStrings.x
import typings.reactDashRnd.reactDashRndStrings.y
...
trait Props
  ...
  var default: js.UndefOr[Anon_X with Size] = js.undefined
...
object Props {
  ...
  def apply(
    ...
    onDrag: (/* e */ DraggableEvent, /* data */ typings.reactDashDraggable.reactDashDraggableMod.DraggableData) => Unit | `false` = null,
    onDragStart: (/* e */ DraggableEvent, /* data */ typings.reactDashDraggable.reactDashDraggableMod.DraggableData) => Unit | `false` = null,
    ...
    if (dragGrid != null) __obj.updateDynamic("dragGrid")(dragGrid)
    ...
    if (!js.isUndefined(enableUserSelectHack)) __obj.updateDynamic("enableUserSelectHack")(enableUserSelectHack)
    ...
    if (resizeGrid != null) __obj.updateDynamic("resizeGrid")(resizeGrid)
    if (resizeHandleClasses != null) __obj.updateDynamic("resizeHandleClasses")(resizeHandleClasses)
    if (resizeHandleComponent != null) __obj.updateDynamic("resizeHandleComponent")(resizeHandleComponent)
    if (resizeHandleStyles != null) __obj.updateDynamic("resizeHandleStyles")(resizeHandleStyles)
    if (resizeHandleWrapperClass != null) __obj.updateDynamic("resizeHandleWrapperClass")(resizeHandleWrapperClass)
    if (resizeHandleWrapperStyle != null) __obj.updateDynamic("resizeHandleWrapperStyle")(resizeHandleWrapperStyle)
