...
object DefaultProps {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(maxHeight = maxHeight, maxWidth = maxWidth, onDrag = js.Any.fromFunction2(onDrag), onDragStart = js.Any.fromFunction2(onDragStart), onDragStop = js.Any.fromFunction2(onDragStop), onResize = js.Any.fromFunction5(onResize), onResizeStart = js.Any.fromFunction3(onResizeStart), onResizeStop = js.Any.fromFunction5(onResizeStop), scale = scale)
