...
object DefaultProps {
  ...
  def apply(
    ...
    onResizeStart: (/* e */ (typings.react.reactMod.MouseEvent[HTMLDivElement, NativeMouseEvent]) | typings.react.reactMod.TouchEvent[HTMLDivElement], /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ResizeDirection */ /* dir */ js.Any, /* elementRef */ HTMLDivElement) => Unit,
