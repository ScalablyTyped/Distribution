...
object AUTHENTICATION_TYPE extends StObject {
  ...
  /* "AuthenticationWithBiometrics" */ val BIOMETRICS: typings.reactNativeKeychain.mod.AUTHENTICATION_TYPE.BIOMETRICS & String = js.native
  
  @js.native
  sealed trait DEVICE_PASSCODE_OR_BIOMETRICS
    extends StObject
       with AUTHENTICATION_TYPE
  /* "AuthenticationWithBiometricsDevicePasscode" */ val DEVICE_PASSCODE_OR_BIOMETRICS: typings.reactNativeKeychain.mod.AUTHENTICATION_TYPE.DEVICE_PASSCODE_OR_BIOMETRICS & String = js.native
}
