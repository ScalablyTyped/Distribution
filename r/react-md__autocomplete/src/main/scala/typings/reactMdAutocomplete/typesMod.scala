...
object typesMod {
  ...
  object AutoCompleteProps {
    ...
    implicit class AutoCompletePropsMutableBuilder[Self <: AutoCompleteProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAfterResultsChildren(value: ReactNode): Self = StObject.set(x, "afterResultsChildren", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setBeforeResultsChildren(value: ReactNode): Self = StObject.set(x, "beforeResultsChildren", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setFilterOptions(value: typings.reactMdAutocomplete.anon.FilterFunctionOptions): Self = StObject.set(x, "filterOptions", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setGetResultLabel(value: (/* data */ AutoCompleteData, /* labelKey */ String, /* query */ String) => ReactNode): Self = StObject.set(x, "getResultLabel", js.Any.fromFunction3(value))
