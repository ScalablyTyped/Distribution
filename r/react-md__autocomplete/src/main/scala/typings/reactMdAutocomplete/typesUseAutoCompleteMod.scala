...
import typings.reactMdAutocomplete.typesTypesMod.AutoCompleteHandler
import typings.reactMdAutocomplete.typesTypesMod.AutoCompleteListboxPositionOptions
import typings.reactMdAutocomplete.typesTypesMod.AutoCompleteResult
  ...
  object RequiredAutoCompleteProps {
    ...
    extension [Self <: RequiredAutoCompleteProps](x: Self) {
      ...
      inline def setFilterFunction3(
        value: (/* query */ String, /* data */ js.Array[AutoCompleteData], /* options */ typings.reactMdAutocomplete.typesTypesMod.FilterFunctionOptions[js.Object]) => js.Array[AutoCompleteData]
