...
import typings.reactMdForm.typesSelectUtilsMod.ListboxOptionProps
...
object typesTypesMod {
  ...
  trait AutoCompleteProps extends StObject {
    ...
    /**
      ...
      */
    var filterOptions: js.UndefOr[typings.reactMdAutocomplete.anon.FilterFunctionOptions] = js.undefined
  ...
  object AutoCompleteProps {
    ...
    extension [Self <: AutoCompleteProps](x: Self) {
      ...
      inline def setAfterResultsChildren(value: ReactNode): Self = StObject.set(x, "afterResultsChildren", value.asInstanceOf[js.Any])
      ...
      inline def setBeforeResultsChildren(value: ReactNode): Self = StObject.set(x, "beforeResultsChildren", value.asInstanceOf[js.Any])
      ...
      inline def setFilterOptions(value: typings.reactMdAutocomplete.anon.FilterFunctionOptions): Self = StObject.set(x, "filterOptions", value.asInstanceOf[js.Any])
      ...
      inline def setGetResultLabel(value: (/* data */ AutoCompleteData, /* labelKey */ String, /* query */ String) => ReactNode): Self = StObject.set(x, "getResultLabel", js.Any.fromFunction3(value))
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.reactMdAutocomplete.reactMdAutocompleteStrings.`inline`
    - typings.reactMdAutocomplete.reactMdAutocompleteStrings.list
    - typings.reactMdAutocomplete.reactMdAutocompleteStrings.both
  */
  trait AutoCompletion extends StObject
  object AutoCompletion {
    
    inline def both: typings.reactMdAutocomplete.reactMdAutocompleteStrings.both = "both".asInstanceOf[typings.reactMdAutocomplete.reactMdAutocompleteStrings.both]
    
    inline def `inline`: typings.reactMdAutocomplete.reactMdAutocompleteStrings.`inline` = "inline".asInstanceOf[typings.reactMdAutocomplete.reactMdAutocompleteStrings.`inline`]
    
    inline def list: typings.reactMdAutocomplete.reactMdAutocompleteStrings.list = "list".asInstanceOf[typings.reactMdAutocomplete.reactMdAutocompleteStrings.list]
    
    inline def none: typings.reactMdAutocomplete.reactMdAutocompleteStrings.none = "none".asInstanceOf[typings.reactMdAutocomplete.reactMdAutocompleteStrings.none]
  }
  ...
  */
  ...
  object PreconfiguredFilterFunction {
    ...
    inline def `case-insensitive`: typings.reactMdAutocomplete.reactMdAutocompleteStrings.`case-insensitive` = "case-insensitive".asInstanceOf[typings.reactMdAutocomplete.reactMdAutocompleteStrings.`case-insensitive`]
    
    inline def fuzzy: typings.reactMdAutocomplete.reactMdAutocompleteStrings.fuzzy = "fuzzy".asInstanceOf[typings.reactMdAutocomplete.reactMdAutocompleteStrings.fuzzy]
