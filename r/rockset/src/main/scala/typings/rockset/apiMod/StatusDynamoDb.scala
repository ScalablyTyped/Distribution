...
import typings.rockset.apiMod.StatusDynamoDb.StateEnum
...
object StatusDynamoDb {
  ...
  object StateEnum extends StObject {
    ...
    sealed trait INITIALIZING
      extends StObject
         with StateEnum
    /* 0 */ val INITIALIZING: typings.rockset.apiMod.StatusDynamoDb.StateEnum.INITIALIZING & Double = js.native
    
    @js.native
    sealed trait PROCESSINGSTREAM
      extends StObject
         with StateEnum
    /* 2 */ val PROCESSINGSTREAM: typings.rockset.apiMod.StatusDynamoDb.StateEnum.PROCESSINGSTREAM & Double = js.native
    
    @js.native
    sealed trait SCANNINGTABLE
      extends StObject
         with StateEnum
    /* 1 */ val SCANNINGTABLE: typings.rockset.apiMod.StatusDynamoDb.StateEnum.SCANNINGTABLE & Double = js.native
  }
