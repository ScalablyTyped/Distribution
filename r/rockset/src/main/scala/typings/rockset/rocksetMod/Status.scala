...
object Status {
  ...
  def apply(
    ...
    if (last_error_at != null) __obj.updateDynamic("last_error_at")(last_error_at)
    if (last_error_item != null) __obj.updateDynamic("last_error_item")(last_error_item)
    if (last_error_reason != null) __obj.updateDynamic("last_error_reason")(last_error_reason)
    if (last_processed_at != null) __obj.updateDynamic("last_processed_at")(last_processed_at)
    if (last_processed_item != null) __obj.updateDynamic("last_processed_item")(last_processed_item)
