...
object CreateIntegrationResponse {
  ...
  @scala.inline
  implicit class CreateIntegrationResponseOps[Self <: CreateIntegrationResponse] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setData(value: Integration): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
