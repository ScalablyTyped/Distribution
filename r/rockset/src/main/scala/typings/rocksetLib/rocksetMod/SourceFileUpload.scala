...
trait SourceFileUpload extends js.Object {
  ...
  var file_size: scala.Double
  // time of file upload
  var file_upload_time: java.lang.String
}

object SourceFileUpload {
  @scala.inline
  def apply(file_name: java.lang.String, file_size: scala.Double, file_upload_time: java.lang.String): SourceFileUpload = {
