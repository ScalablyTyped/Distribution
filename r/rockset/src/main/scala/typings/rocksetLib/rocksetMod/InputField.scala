...
trait InputField extends js.Object {
  ...
  var if_missing: js.UndefOr[rocksetLib.rocksetLibStrings.SKIP | rocksetLib.rocksetLibStrings.PASS] = js.undefined
  // If true, then drop fieldName from the document
  var is_drop: js.UndefOr[scala.Boolean] = js.undefined
  // Sql parameter name
...
object InputField {
  ...
  def apply(
    ...
    if_missing: rocksetLib.rocksetLibStrings.SKIP | rocksetLib.rocksetLibStrings.PASS = null,
    is_drop: js.UndefOr[scala.Boolean] = js.undefined,
