...
import typings.rxLite.AnonGetDisposable
...
object internals extends js.Object {
  ...
  class PriorityQueue[TTime] protected ()
    extends typings.rx.mod.internals.PriorityQueue[TTime] {
    def this(capacity: Double) = this()
  }
  
  @js.native
  class ScheduledItem[TTime] protected ()
    extends typings.rx.mod.internals.ScheduledItem[TTime] {
    def this(
  ...
  def addRef[T](xs: typings.rxLite.Rx.Observable[T], r: AnonGetDisposable): typings.rxLite.Rx.Observable[T] = js.native
