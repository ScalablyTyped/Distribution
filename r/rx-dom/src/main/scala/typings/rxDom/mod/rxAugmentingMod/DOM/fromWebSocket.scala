...
object fromWebSocket extends js.Object {
  ...
  // Web Sockets
  def apply(url: String, protocol: String): Subject[MessageEvent[_]] = js.native
  def apply(
    url: String,
    protocol: String,
    openObserver: js.UndefOr[scala.Nothing],
    closingObserver: Observer[CloseEvent]
  ): Subject[MessageEvent[_]] = js.native
  def apply(url: String, protocol: String, openObserver: Observer[Event]): Subject[MessageEvent[_]] = js.native
  def apply(
    url: String,
    protocol: String,
