...
import typings.reactNativeMaps.anon.PartialNativeProps
...
object libMapCircleMod {
  
  /* was `typeof MapCircle` */
  @JSImport("react-native-maps/lib/MapCircle", JSImport.Default)
  @js.native
  open class default protected () extends MapCircle {
    def this(props: MapCircleProps) = this()
  }
  
  @JSImport("react-native-maps/lib/MapCircle", "MapCircle")
  @js.native
  open class MapCircle protected ()
    extends Component[MapCircleProps, js.Object, Any] {
    def this(props: MapCircleProps) = this()
    
    /* private */ var circle: Any = js.native
    
    @JSName("context")
    var context_MapCircle: ContextType[Context[Provider]] = js.native
    ...
    def setNativeProps(props: PartialNativeProps): Unit = js.native
  }
  ...
  /* Inlined react-native-maps.react-native-maps/lib/MapCircle.MapCircleProps & {  ref :react.react.RefObject<react-native.react-native.View>} */
  ...
  object NativeProps {
    ...
    inline def apply(center: LatLng, radius: Double, ref: RefObject[View]): NativeProps = {
      val __obj = js.Dynamic.literal(center = center.asInstanceOf[js.Any], radius = radius.asInstanceOf[js.Any], ref = ref.asInstanceOf[js.Any])
