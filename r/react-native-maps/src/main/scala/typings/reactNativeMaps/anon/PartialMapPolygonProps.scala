...
import typings.reactNativeMaps.libMapPolygonMod.PolygonPressEvent
...
object PartialMapPolygonProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMapPolygonProps] (val x: Self) extends AnyVal {
