...
import typings.reactNativeMaps.libMapPolylineMod.PolylinePressEvent
...
object PartialNativePropsAccessibilityHint {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialNativePropsAccessibilityHint] (val x: Self) extends AnyVal {
    ...
    inline def setOnPress(value: /* event */ PolylinePressEvent => Unit): Self = StObject.set(x, "onPress", js.Any.fromFunction1(value))
