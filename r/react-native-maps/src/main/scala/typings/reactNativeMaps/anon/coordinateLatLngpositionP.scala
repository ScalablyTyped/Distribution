...
object coordinateLatLngpositionP {
  ...
  inline def apply(coordinate: LatLng, id: String, position: typings.reactNativeMaps.libSharedTypesMod.Point): coordinateLatLngpositionP = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: coordinateLatLngpositionP] (val x: Self) extends AnyVal {
