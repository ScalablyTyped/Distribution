...
import typings.reactNativeMaps.libMapHeatmapMod.WeightedLatLng
import typings.reactNativeMaps.libSharedTypesInternalMod.Modify
...
object PartialNativePropsAccessibilityActions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialNativePropsAccessibilityActions] (val x: Self) extends AnyVal {
