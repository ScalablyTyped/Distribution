...
import typings.reactNativeMaps.anon.PartialMapPolygonProps
...
object libMapPolygonMod {
  
  /* was `typeof MapPolygon` */
  @JSImport("react-native-maps/lib/MapPolygon", JSImport.Default)
  @js.native
  open class default protected () extends MapPolygon {
    def this(props: MapPolygonProps) = this()
  }
  
  @JSImport("react-native-maps/lib/MapPolygon", "MapPolygon")
  @js.native
  open class MapPolygon protected ()
    extends Component[MapPolygonProps, js.Object, Any] {
    def this(props: MapPolygonProps) = this()
    
    @JSName("context")
    var context_MapPolygon: ContextType[Context[Provider]] = js.native
    ...
    /* private */ var polygon: Any = js.native
    
    def setNativeProps(props: PartialMapPolygonProps): Unit = js.native
  }
  ...
  object MapPolygonProps {
    ...
    inline def apply(coordinates: js.Array[LatLng]): MapPolygonProps = {
    ...
    extension [Self <: MapPolygonProps](x: Self) {
      ...
      inline def setOnPress(value: /* event */ PolygonPressEvent => Unit): Self = StObject.set(x, "onPress", js.Any.fromFunction1(value))
  ...
  /* Inlined react-native-maps.react-native-maps/lib/MapPolygon.MapPolygonProps & {  ref :react.react.RefObject<react-native.react-native.View>} */
  ...
  object NativeProps {
    ...
    inline def apply(coordinates: js.Array[LatLng], ref: RefObject[View]): NativeProps = {
  ...
  type PolygonPressEvent = NativeSyntheticEvent[Id]
  
  /* was `typeof MapPolygon` */
  type _default = MapPolygon
}
