...
trait Anon_EstimatedRowSize extends js.Object {
  ...
  var noRowsRenderer: js.Function0[scala.Null]
  var onRowsRendered: js.Function0[scala.Null]
  var onScroll: js.Function0[scala.Null]
