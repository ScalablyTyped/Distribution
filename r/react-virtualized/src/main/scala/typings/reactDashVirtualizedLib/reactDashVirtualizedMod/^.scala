...
object ^ extends js.Object {
  val IS_SCROLLING_TIMEOUT: reactDashVirtualizedLib.reactDashVirtualizedLibNumbers.`150` = js.native
  ...
  def defaultTableHeaderRenderer(): js.Array[reactLib.reactMod.ReactElement] = js.native
}
