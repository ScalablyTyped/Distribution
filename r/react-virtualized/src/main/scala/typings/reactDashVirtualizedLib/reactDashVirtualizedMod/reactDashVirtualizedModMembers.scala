...
@js.native
object reactDashVirtualizedModMembers extends js.Object {
  ...
  val createMasonryCellPositioner: js.Function1[
    /* params */ reactDashVirtualizedLib.distEsMasonryMod.createCellPositionerParams, 
    reactDashVirtualizedLib.distEsMasonryMod.Positioner
  ] = js.native
  ...
  val defaultTableHeaderRenderer: js.Function0[
    js.Array[
