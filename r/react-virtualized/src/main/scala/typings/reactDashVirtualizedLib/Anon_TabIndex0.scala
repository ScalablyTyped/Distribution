...
trait Anon_TabIndex0 extends js.Object {
  ...
  var getScrollbarSize: js.Function0[scala.Double]
  var noContentRenderer: js.Function0[reactLib.reactMod.ReactNs.ReactNode]
  var onScroll: js.Function0[scala.Unit]
  var onScrollbarPresenceChange: js.Function0[scala.Unit]
  var onSectionRendered: js.Function0[scala.Unit]
