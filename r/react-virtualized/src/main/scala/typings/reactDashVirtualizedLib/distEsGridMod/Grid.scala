...
class Grid ()
  ...
  def getOffsetForCell(params: reactDashVirtualizedLib.Anon_Alignment): ScrollOffset = js.native
  /**
  ...
  def invalidateCellSizeAfterRender(params: reactDashVirtualizedLib.Anon_ColumnIndex): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def scrollToCell(params: reactDashVirtualizedLib.Anon_ColumnIndex): scala.Unit = js.native
  /**
