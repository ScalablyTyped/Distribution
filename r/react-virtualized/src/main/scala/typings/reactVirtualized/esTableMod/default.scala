...
@JSImport("react-virtualized/dist/es/Table", JSImport.Default)
@js.native
...
object default {
  ...
  @JSImport("react-virtualized/dist/es/Table", "default.defaultProps")
  @js.native
  ...
  @JSImport("react-virtualized/dist/es/Table", "default.propTypes")
  @js.native
