...
trait AnonArialabelAutoHeightChildren extends js.Object {
  ...
  /**
    ...
    */
  var sort: js.UndefOr[js.Function1[/* info */ AnonSortBy, Unit]] = js.undefined
...
object AnonArialabelAutoHeightChildren {
  @scala.inline
  def apply(
    headerHeight: Double,
    rowCount: Double,
  ...
  ): AnonArialabelAutoHeightChildren = {
    ...
    __obj.asInstanceOf[AnonArialabelAutoHeightChildren]
  }
}
