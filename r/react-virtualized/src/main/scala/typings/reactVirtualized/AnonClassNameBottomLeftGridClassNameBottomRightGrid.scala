...
trait AnonClassNameBottomLeftGridClassNameBottomRightGrid extends js.Object {
...
object AnonClassNameBottomLeftGridClassNameBottomRightGrid {
  @scala.inline
  def apply(
  ...
  ): AnonClassNameBottomLeftGridClassNameBottomRightGrid = {
    ...
    __obj.asInstanceOf[AnonClassNameBottomLeftGridClassNameBottomRightGrid]
  }
}
