...
trait AnonArialabelCellDataGetter extends js.Object {
...
object AnonArialabelCellDataGetter {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonArialabelCellDataGetter]
  }
}
