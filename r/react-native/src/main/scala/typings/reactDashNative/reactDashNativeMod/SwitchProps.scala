...
import typings.reactDashNative.Anon_False
...
trait SwitchProps extends SwitchPropsIOS {
  ...
  /**
    ...
    */
  var trackColor: js.UndefOr[Anon_False] = js.undefined
  /**
...
object SwitchProps {
  ...
  def apply(
    ...
    ios_backgroundColor: String = null,
    ...
    if (ios_backgroundColor != null) __obj.updateDynamic("ios_backgroundColor")(ios_backgroundColor.asInstanceOf[js.Any])
    ...
    if (onTintColor != null) __obj.updateDynamic("onTintColor")(onTintColor.asInstanceOf[js.Any])
