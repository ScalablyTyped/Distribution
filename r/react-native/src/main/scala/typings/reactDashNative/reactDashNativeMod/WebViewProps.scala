...
trait WebViewProps
  ...
  /**
    ...
    */
  var mediaPlaybackRequiresUserAction: js.UndefOr[Boolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onError: js.UndefOr[js.Function1[/* event */ NavState, Unit]] = js.undefined
  /**
    * Invoked when load finish
    */
  var onLoad: js.UndefOr[js.Function1[/* event */ NavState, Unit]] = js.undefined
  /**
    * Invoked when load either succeeds or fails
    */
  var onLoadEnd: js.UndefOr[js.Function1[/* event */ NavState, Unit]] = js.undefined
  /**
    * Invoked on load start
    */
  var onLoadStart: js.UndefOr[js.Function1[/* event */ NavState, Unit]] = js.undefined
  /**
    * Invoked when window.postMessage is called from WebView.
    */
  var onMessage: js.UndefOr[js.Function1[/* event */ NativeSyntheticEvent[WebViewMessageEventData], Unit]] = js.undefined
  /**
    * Function that is invoked when the `WebView` loading starts or ends.
    */
  var onNavigationStateChange: js.UndefOr[js.Function1[/* event */ NavState, Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var renderError: js.UndefOr[js.Function0[ReactElement]] = js.undefined
  /**
    * Function that returns a loading indicator.
    */
  var renderLoading: js.UndefOr[js.Function0[ReactElement]] = js.undefined
  /**
    * sets whether the webpage scales to fit the view and the user can change the scale
    */
  var scalesPageToFit: js.UndefOr[Boolean] = js.undefined
  var source: js.UndefOr[WebViewUriSource | WebViewHtmlSource | Double] = js.undefined
  /**
...
object WebViewProps {
  ...
  def apply(
    ...
    mediaPlaybackRequiresUserAction: js.UndefOr[Boolean] = js.undefined,
    ...
    onError: /* event */ NavState => Unit = null,
    onLayout: /* event */ LayoutChangeEvent => Unit = null,
    onLoad: /* event */ NavState => Unit = null,
    onLoadEnd: /* event */ NavState => Unit = null,
    onLoadStart: /* event */ NavState => Unit = null,
    onMagicTap: () => Unit = null,
    onMessage: /* event */ NativeSyntheticEvent[WebViewMessageEventData] => Unit = null,
    ...
    onNavigationStateChange: /* event */ NavState => Unit = null,
    ...
    source: WebViewUriSource | WebViewHtmlSource | Double = null,
