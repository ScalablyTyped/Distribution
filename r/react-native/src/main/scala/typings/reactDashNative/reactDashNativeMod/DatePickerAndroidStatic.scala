...
trait DatePickerAndroidStatic extends js.Object {
  /**
    ...
    */
  var dateSetAction: typings.reactDashNative.reactDashNativeStrings.dateSetAction = js.native
  /**
    * The dialog has been dismissed.
    */
  var dismissedAction: typings.reactDashNative.reactDashNativeStrings.dismissedAction = js.native
  /**
