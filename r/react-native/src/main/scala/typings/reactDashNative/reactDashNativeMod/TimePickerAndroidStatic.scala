...
trait TimePickerAndroidStatic extends js.Object {
  /**
    ...
    */
  var dismissedAction: typings.reactDashNative.reactDashNativeStrings.dismissedAction
  /**
    * A time has been selected.
    */
  var timeSetAction: typings.reactDashNative.reactDashNativeStrings.timeSetAction
  /**
