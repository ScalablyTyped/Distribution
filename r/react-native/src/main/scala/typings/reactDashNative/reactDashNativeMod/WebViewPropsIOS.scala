...
trait WebViewPropsIOS extends js.Object {
  /**
    ...
    * attribute."
    */
  var allowsInlineMediaPlayback: js.UndefOr[Boolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var decelerationRate: js.UndefOr[normal | fast | Double] = js.undefined
  /**
    ...
    * request.
    */
  var onShouldStartLoadWithRequest: js.UndefOr[js.Function1[/* event */ WebViewIOSLoadRequestEvent, Boolean]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var useWebKit: js.UndefOr[Boolean] = js.undefined
}

object WebViewPropsIOS {
  @scala.inline
  def apply(
    allowsInlineMediaPlayback: js.UndefOr[Boolean] = js.undefined,
    bounces: js.UndefOr[Boolean] = js.undefined,
    dataDetectorTypes: DataDetectorTypes | js.Array[DataDetectorTypes] = null,
    decelerationRate: normal | fast | Double = null,
    onShouldStartLoadWithRequest: /* event */ WebViewIOSLoadRequestEvent => Boolean = null,
    scrollEnabled: js.UndefOr[Boolean] = js.undefined,
    useWebKit: js.UndefOr[Boolean] = js.undefined
  ): WebViewPropsIOS = {
