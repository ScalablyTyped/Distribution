...
import typings.reactDashNative.reactDashNativeMod.TabBarIOSProps
...
import typings.reactDashNative.reactDashNativeStrings.fill
...
object TabBarIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.TabBarIOS] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.TabBarIOS].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.TabBarIOS] = {
