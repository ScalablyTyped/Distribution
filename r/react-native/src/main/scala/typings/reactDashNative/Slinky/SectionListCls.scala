...
object SectionListCls
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.SectionListCls] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.SectionListCls].asInstanceOf[String | js.Object]
  def apply[ItemT](
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.SectionListCls] = {
