...
import typings.reactDashNative.reactDashNativeMod.ImageBackgroundProps
...
object ImageBackground
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.ImageBackground] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.ImageBackground].asInstanceOf[String | js.Object]
  def apply(
    ...
    imageRef: /* image */ typings.reactDashNative.reactDashNativeMod.Image => Unit = null,
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.ImageBackground] = {
