...
import typings.reactDashNative.reactDashNativeMod.DrawerLayoutAndroidProps
import typings.reactDashNative.reactDashNativeMod.DrawerSlideEvent
...
import typings.reactDashNative.reactDashNativeStrings.`locked-closed`
import typings.reactDashNative.reactDashNativeStrings.`locked-open`
...
import typings.reactDashNative.reactDashNativeStrings.unlocked
...
object DrawerLayoutAndroid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.DrawerLayoutAndroid] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.DrawerLayoutAndroid].asInstanceOf[String | js.Object]
  def apply(
    renderNavigationView: () => typings.react.reactMod.Global.JSXNs.Element,
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.DrawerLayoutAndroid] = {
  ...
  type Props = DrawerLayoutAndroidProps
}
