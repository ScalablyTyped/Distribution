...
import typings.reactDashNative.reactDashNativeMod.ListViewDataSource
...
object ListView
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.ListView] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.ListView].asInstanceOf[String | js.Object]
  def apply(
    ...
    enableEmptySections: js.UndefOr[Boolean] = js.undefined,
    ...
    onChangeVisibleRows: (/* visibleRows */ js.Array[StringDictionary[StringDictionary[Boolean]]], /* changedRows */ js.Array[StringDictionary[StringDictionary[Boolean]]]) => Unit = null,
    ...
    refreshControl: typings.react.reactMod.ReactElement = null,
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.ListView] = {
    val __obj = js.Dynamic.literal(dataSource = dataSource, renderRow = js.Any.fromFunction3(renderRow))
    ...
    if (!js.isUndefined(enableEmptySections)) __obj.updateDynamic("enableEmptySections")(enableEmptySections)
    ...
    if (onChangeVisibleRows != null) __obj.updateDynamic("onChangeVisibleRows")(js.Any.fromFunction2(onChangeVisibleRows))
    if (onContentSizeChange != null) __obj.updateDynamic("onContentSizeChange")(js.Any.fromFunction2(onContentSizeChange))
    if (onEndReached != null) __obj.updateDynamic("onEndReached")(js.Any.fromFunction0(onEndReached))
