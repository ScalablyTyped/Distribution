...
import typings.reactDashNative.reactDashNativeMod.ProgressViewIOSProps
...
import typings.reactDashNative.reactDashNativeStrings.bar
...
object ProgressViewIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.ProgressViewIOS] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.ProgressViewIOS].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.ProgressViewIOS] = {
