...
import typings.reactDashNative.reactDashNativeMod.ListRenderItemInfo
...
object FlatList
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.FlatList[js.Any]] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.FlatList[js.Any]].asInstanceOf[String | js.Object]
  def apply[ItemT](
    ...
    data: js.Any = null,
    data_FlatListProps: js.Array[ItemT] = null,
    ...
    getItemLayout_FlatListProps: (/* data */ js.Array[ItemT] | Null, /* index */ Double) => Anon_Index = null,
    ...
    viewabilityConfig_FlatListProps: js.Any = null,
    windowSize: Int | Double = null,
    zoomScale: Int | Double = null
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.FlatList[js.Any]] = {
    ...
    if (data_FlatListProps != null) __obj.updateDynamic("data")(data_FlatListProps)
    ...
    if (getItemLayout_FlatListProps != null) __obj.updateDynamic("getItemLayout")(js.Any.fromFunction2(getItemLayout_FlatListProps))
    ...
    if (viewabilityConfig_FlatListProps != null) __obj.updateDynamic("viewabilityConfig")(viewabilityConfig_FlatListProps)
  ...
  typings.reactDashNative.reactDashNativeMod.FlatList[js.Any]]]
  }
