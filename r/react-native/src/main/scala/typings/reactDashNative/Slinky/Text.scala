...
object Text
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.Text] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.Text].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.Text] = {
