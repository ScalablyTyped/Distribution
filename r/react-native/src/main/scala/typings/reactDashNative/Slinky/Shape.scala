...
object Shape
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.Shape] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.Shape].asInstanceOf[String | js.Object]
  def apply(
    ...
    x: Int | Double = null,
    y: Int | Double = null
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.Shape] = {
