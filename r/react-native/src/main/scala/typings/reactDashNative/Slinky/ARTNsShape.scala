...
/* The following DOM/SVG props were specified: title, stroke, fill, d */
object ARTNsShape
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.ARTNs.Shape] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.ARTNs.Shape].asInstanceOf[String | js.Object]
  def apply(
    ...
    x: Int | Double = null,
    y: Int | Double = null
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.ARTNs.Shape] = {
