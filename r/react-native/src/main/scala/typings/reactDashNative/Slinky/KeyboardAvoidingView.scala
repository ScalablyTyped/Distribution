...
import typings.reactDashNative.reactDashNativeMod.KeyboardAvoidingViewProps
...
import typings.reactDashNative.reactDashNativeStrings.height
import typings.reactDashNative.reactDashNativeStrings.no
import typings.reactDashNative.reactDashNativeStrings.none
import typings.reactDashNative.reactDashNativeStrings.padding
import typings.reactDashNative.reactDashNativeStrings.polite
import typings.reactDashNative.reactDashNativeStrings.position
...
object KeyboardAvoidingView
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.KeyboardAvoidingView] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.KeyboardAvoidingView].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.KeyboardAvoidingView] = {
