...
import typings.reactDashNative.reactDashNativeMod.PickerProps
...
/* The following DOM/SVG props were specified: pointerEvents, mode */
object Picker
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.Picker] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.Picker].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.Picker] = {
