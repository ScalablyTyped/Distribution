...
import typings.reactDashNative.Anon_Section
...
import typings.reactDashNative.reactDashNativeMod.SectionListProps
import typings.reactDashNative.reactDashNativeMod.SectionListRenderItemInfo
...
object SectionList
  ...
  override val component: String | js.Object = typings.reactDashNative.reactDashNativeMod.^.SectionList.asInstanceOf[String | js.Object]
  def apply[ItemT](
    ...
    SectionSeparatorComponent: ReactComponentClass[_] | slinky.core.facade.ReactElement = null,
    ...
    getItemLayout_SectionListProps: (/* data */ js.Array[SectionListData[ItemT]] | Null, /* index */ Double) => Anon_Index = null,
    ...
    renderSectionFooter: /* info */ Anon_Section[ItemT] => slinky.core.facade.ReactElement | Null = null,
    renderSectionHeader: /* info */ Anon_Section[ItemT] => slinky.core.facade.ReactElement | Null = null,
    ...
    if (ItemSeparatorComponent != null) __obj.updateDynamic("ItemSeparatorComponent")(ItemSeparatorComponent)
    ...
    if (getItemLayout_SectionListProps != null) __obj.updateDynamic("getItemLayout")(js.Any.fromFunction2(getItemLayout_SectionListProps))
