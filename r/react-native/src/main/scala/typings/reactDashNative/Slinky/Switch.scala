...
import typings.reactDashNative.reactDashNativeMod.SwitchProps
...
object Switch
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.Switch] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.Switch].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.Switch] = {
