...
import typings.reactDashNative.reactDashNativeMod.DatePickerIOSProps
...
object DatePickerIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.DatePickerIOS] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.DatePickerIOS].asInstanceOf[String | js.Object]
  def apply(
    date: Date,
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.DatePickerIOS] = {
