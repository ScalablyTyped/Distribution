...
import typings.reactDashNative.reactDashNativeMod.TouchableNativeFeedbackProps
...
object TouchableNativeFeedback
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.TouchableNativeFeedback] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.TouchableNativeFeedback].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.TouchableNativeFeedback] = {
