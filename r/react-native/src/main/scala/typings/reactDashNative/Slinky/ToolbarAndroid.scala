...
import typings.reactDashNative.reactDashNativeMod.ToolbarAndroidAction
import typings.reactDashNative.reactDashNativeMod.ToolbarAndroidProps
...
/* The following DOM/SVG props were specified: pointerEvents, title */
object ToolbarAndroid
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.ToolbarAndroid] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.ToolbarAndroid].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.ToolbarAndroid] = {
