...
import typings.reactDashNative.reactDashNativeMod.CheckBoxProps
...
/* The following DOM/SVG props were specified: pointerEvents, disabled */
object CheckBox
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.CheckBox] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.CheckBox].asInstanceOf[String | js.Object]
  def apply(
    ...
    onValueChange: /* value */ Boolean => Unit = null,
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.CheckBox] = {
