...
import typings.reactDashNative.reactDashNativeMod.NativeSegmentedControlIOSChangeEvent
import typings.reactDashNative.reactDashNativeMod.NativeSyntheticEvent
import typings.reactDashNative.reactDashNativeMod.SegmentedControlIOSProps
...
object SegmentedControlIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.SegmentedControlIOS] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.SegmentedControlIOS].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.SegmentedControlIOS] = {
