...
object ARTText
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.ARTText] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.ARTText].asInstanceOf[String | js.Object]
  def apply(
    ...
    x: Int | Double = null,
    y: Int | Double = null
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.ARTText] = {
