...
import typings.reactDashNative.reactDashNativeMod.RefreshControlProps
...
/* The following DOM/SVG props were specified: pointerEvents, title, size */
object RefreshControl
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.RefreshControl] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.RefreshControl].asInstanceOf[String | js.Object]
  def apply(
    refreshing: Boolean,
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.RefreshControl] = {
