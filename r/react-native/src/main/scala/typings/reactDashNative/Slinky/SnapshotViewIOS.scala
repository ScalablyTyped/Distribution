...
import typings.reactDashNative.reactDashNativeMod.SnapshotViewIOSProps
...
object SnapshotViewIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.SnapshotViewIOS] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.SnapshotViewIOS].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.SnapshotViewIOS] = {
