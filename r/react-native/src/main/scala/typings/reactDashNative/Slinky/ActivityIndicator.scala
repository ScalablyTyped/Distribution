...
import typings.reactDashNative.reactDashNativeMod.ActivityIndicatorProps
...
object ActivityIndicator
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.reactDashNative.reactDashNativeMod.ActivityIndicator] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNative.reactDashNativeMod.ActivityIndicator].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.reactDashNative.reactDashNativeMod.ActivityIndicator] = {
