...
object ^ extends js.Object {
  ...
  def fetch(input: reactDashNativeLib.RequestInfo): js.Promise[reactDashNativeLib.Response] = js.native
  def fetch(input: reactDashNativeLib.RequestInfo, init: reactDashNativeLib.RequestInit): js.Promise[reactDashNativeLib.Response] = js.native
  def fetchBundle(
