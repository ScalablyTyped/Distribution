...
trait LinkingStatic extends EventEmitter {
  ...
  /**
       ...
       */
  def canOpenURL(url: java.lang.String): stdLib.Promise[scala.Boolean] = js.native
  /**
       ...
       */
  def getInitialURL(): stdLib.Promise[java.lang.String] = js.native
  /**
       ...
       * NOTE: For web URLs, the protocol ("http://", "https://") must be set accordingly!
       */
  def openURL(url: java.lang.String): stdLib.Promise[_] = js.native
  /**
