...
trait ARTRenderableMixin extends ARTNodeMixin {
  ...
  var strokeCap: js.UndefOr[
    reactDashNativeLib.reactDashNativeLibStrings.butt | reactDashNativeLib.reactDashNativeLibStrings.square | reactDashNativeLib.reactDashNativeLibStrings.round
  ] = js.undefined
  var strokeDash: js.UndefOr[js.Array[scala.Double]] = js.undefined
  var strokeJoin: js.UndefOr[
    reactDashNativeLib.reactDashNativeLibStrings.bevel | reactDashNativeLib.reactDashNativeLibStrings.miter | reactDashNativeLib.reactDashNativeLibStrings.round
  ] = js.undefined
