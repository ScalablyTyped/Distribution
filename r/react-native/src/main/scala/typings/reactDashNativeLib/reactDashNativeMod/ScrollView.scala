...
- Dropped TsTypeConstructor() */ @JSImport("react-native", "ScrollView")
@js.native
class ScrollView () extends js.Object {
  ...
  /**
       ...
       * The animated prop defaults to true
       */
  def scrollToEnd(options: reactDashNativeLib.Anon_AnimatedBoolean_1275572940): scala.Unit = js.native
}
