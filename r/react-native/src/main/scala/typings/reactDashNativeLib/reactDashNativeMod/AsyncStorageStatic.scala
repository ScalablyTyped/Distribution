...
trait AsyncStorageStatic extends js.Object {
  ...
  /**
       ...
       * Use removeItem or multiRemove to clear only your own keys instead.
       */
  def clear(callback: js.Function1[/* error */ js.UndefOr[stdLib.Error], scala.Unit]): stdLib.Promise[scala.Unit] = js.native
  /**
  ...
  /**
       ...
       */
  def getItem(key: java.lang.String): stdLib.Promise[java.lang.String | scala.Null] = js.native
  /**
       * Fetches key and passes the result to callback, along with an Error if there is any.
       */
  def getItem(
  ...
  /**
       ...
       */
  def mergeItem(key: java.lang.String, value: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  /**
       * Merges existing value with input value, assuming they are stringified json. Returns a Promise object.
       * Not supported by all native implementation
       */
  ...
  /**
       ...
       */
  def multiGet(keys: js.Array[java.lang.String]): stdLib.Promise[js.Array[js.Tuple2[java.lang.String, java.lang.String]]] = js.native
  /**
       * multiGet invokes callback with an array of key-value pair arrays that matches the input format of multiSet
       */
  def multiGet(
  ...
  ): stdLib.Promise[js.Array[js.Tuple2[java.lang.String, java.lang.String]]] = js.native
  /**
       ...
       */
  def multiMerge(keyValuePairs: js.Array[js.Array[java.lang.String]]): stdLib.Promise[scala.Unit] = js.native
  /**
       * Merges existing values with input values, assuming they are stringified json.
       * Returns a Promise object.
       *
