...
trait TextStyleIOS extends ViewStyle {
  ...
  var textDecorationStyle: js.UndefOr[
    reactDashNativeLib.reactDashNativeLibStrings.solid | reactDashNativeLib.reactDashNativeLibStrings.double | reactDashNativeLib.reactDashNativeLibStrings.dotted | reactDashNativeLib.reactDashNativeLibStrings.dashed
  ] = js.undefined
  var textTransform: js.UndefOr[
    reactDashNativeLib.reactDashNativeLibStrings.none | reactDashNativeLib.reactDashNativeLibStrings.capitalize | reactDashNativeLib.reactDashNativeLibStrings.uppercase | reactDashNativeLib.reactDashNativeLibStrings.lowercase
  ] = js.undefined
  var writingDirection: js.UndefOr[
    reactDashNativeLib.reactDashNativeLibStrings.auto | reactDashNativeLib.reactDashNativeLibStrings.ltr | reactDashNativeLib.reactDashNativeLibStrings.rtl
  ] = js.undefined
}
