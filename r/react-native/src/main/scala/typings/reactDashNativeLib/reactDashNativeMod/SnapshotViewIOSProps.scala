...
trait SnapshotViewIOSProps extends ViewProps {
  ...
  var testIdentifier: java.lang.String
...
object SnapshotViewIOSProps {
  ...
  def apply(
    ...
    testIdentifier: java.lang.String,
    ...
    val __obj = js.Dynamic.literal(onSnapshotReady = js.Any.fromFunction0(onSnapshotReady), testIdentifier = testIdentifier)
