...
trait UIManagerStatic extends js.Object {
  ...
  def takeSnapshot(view: reactLib.reactMod.ReactElement[_]): js.Promise[java.lang.String] = js.native
  def takeSnapshot(view: reactLib.reactMod.ReactElement[_], options: reactDashNativeLib.Anon_Format): js.Promise[java.lang.String] = js.native
