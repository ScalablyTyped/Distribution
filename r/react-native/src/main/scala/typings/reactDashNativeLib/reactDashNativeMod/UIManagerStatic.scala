...
trait UIManagerStatic extends js.Object {
  ...
  def takeSnapshot(view: reactLib.reactMod.ReactElement): js.Promise[java.lang.String] = js.native
  def takeSnapshot(view: reactLib.reactMod.ReactElement, options: reactDashNativeLib.Anon_Format): js.Promise[java.lang.String] = js.native
