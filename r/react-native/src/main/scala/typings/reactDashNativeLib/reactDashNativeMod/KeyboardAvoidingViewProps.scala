...
object KeyboardAvoidingViewProps {
  ...
  def apply(
    ...
    behavior: reactDashNativeLib.reactDashNativeLibStrings.height | reactDashNativeLib.reactDashNativeLibStrings.position | reactDashNativeLib.reactDashNativeLibStrings.padding = null,
    ...
    keyboardVerticalOffset: scala.Int | scala.Double = null,
