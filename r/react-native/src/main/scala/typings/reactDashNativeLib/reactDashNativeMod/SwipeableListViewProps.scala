...
trait SwipeableListViewProps extends js.Object {
  ...
  def renderQuickActions(rowData: js.Any, sectionID: java.lang.String, rowID: java.lang.String): reactLib.reactMod.ReactNs.ReactElement[_] = js.native
  // Callback method to render the view that will be unveiled on swipe
  def renderQuickActions(rowData: js.Any, sectionID: java.lang.String, rowID: scala.Double): reactLib.reactMod.ReactNs.ReactElement[_] = js.native
  // Callback method to render the view that will be unveiled on swipe
  def renderQuickActions(rowData: js.Any, sectionID: scala.Double, rowID: java.lang.String): reactLib.reactMod.ReactNs.ReactElement[_] = js.native
  // Callback method to render the view that will be unveiled on swipe
  def renderQuickActions(rowData: js.Any, sectionID: scala.Double, rowID: scala.Double): reactLib.reactMod.ReactNs.ReactElement[_] = js.native
