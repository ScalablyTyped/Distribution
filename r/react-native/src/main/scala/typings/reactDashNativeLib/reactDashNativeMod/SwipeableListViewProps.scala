...
trait SwipeableListViewProps extends js.Object {
  ...
  def renderQuickActions(rowData: js.Any, sectionID: java.lang.String, rowID: java.lang.String): reactLib.reactMod.ReactElement[_] = js.native
  def renderQuickActions(rowData: js.Any, sectionID: java.lang.String, rowID: scala.Double): reactLib.reactMod.ReactElement[_] = js.native
  def renderQuickActions(rowData: js.Any, sectionID: scala.Double, rowID: java.lang.String): reactLib.reactMod.ReactElement[_] = js.native
  def renderQuickActions(rowData: js.Any, sectionID: scala.Double, rowID: scala.Double): reactLib.reactMod.ReactElement[_] = js.native
