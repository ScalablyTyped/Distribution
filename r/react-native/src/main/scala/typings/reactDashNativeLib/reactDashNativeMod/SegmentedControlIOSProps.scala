...
object SegmentedControlIOSProps {
  ...
  def apply(
    ...
    momentary: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    onChange: js.Function1[/* event */ NativeSyntheticEvent[NativeSegmentedControlIOSChangeEvent], scala.Unit] = null,
    ...
    onValueChange: js.Function1[/* value */ java.lang.String, scala.Unit] = null,
