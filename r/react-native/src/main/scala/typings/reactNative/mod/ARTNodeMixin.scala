...
object ARTNodeMixin {
  ...
  @scala.inline
  implicit class ARTNodeMixinMutableBuilder[Self <: ARTNodeMixin] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOriginY(value: Double): Self = StObject.set(x, "originY", value.asInstanceOf[js.Any])
