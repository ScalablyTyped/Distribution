...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.reactNative.reactNativeStrings.native
*/
...
object PlatformOSType {
  ...
  @scala.inline
  def native: typings.reactNative.reactNativeStrings.native = "native".asInstanceOf[typings.reactNative.reactNativeStrings.native]
