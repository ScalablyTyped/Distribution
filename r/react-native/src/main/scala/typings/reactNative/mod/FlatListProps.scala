...
object FlatListProps {
  ...
  def apply[ItemT](
    ...
    ListFooterComponentStyle: js.UndefOr[Null | ViewStyle] = js.undefined,
    ListHeaderComponent: js.UndefOr[Null | ComponentType[_] | ReactElement] = js.undefined,
    ListHeaderComponentStyle: js.UndefOr[Null | ViewStyle] = js.undefined,
    ...
    columnWrapperStyle: js.UndefOr[Null | StyleProp[ViewStyle]] = js.undefined,
    ...
    data: js.UndefOr[Null | js.Array[ItemT]] = js.undefined,
    ...
    renderItem: js.UndefOr[Null | (/* info */ ListRenderItemInfo[ItemT] => ReactElement | Null)] = js.undefined,
    ...
    if (!js.isUndefined(ListFooterComponentStyle)) __obj.updateDynamic("ListFooterComponentStyle")(ListFooterComponentStyle.asInstanceOf[js.Any])
    if (!js.isUndefined(ListHeaderComponent)) __obj.updateDynamic("ListHeaderComponent")(ListHeaderComponent.asInstanceOf[js.Any])
    if (!js.isUndefined(ListHeaderComponentStyle)) __obj.updateDynamic("ListHeaderComponentStyle")(ListHeaderComponentStyle.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(columnWrapperStyle)) __obj.updateDynamic("columnWrapperStyle")(columnWrapperStyle.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(renderItem)) __obj.updateDynamic("renderItem")(if (renderItem != null) js.Any.fromFunction1(renderItem.asInstanceOf[/* info */ ListRenderItemInfo[ItemT] => ReactElement | Null]) else null)
