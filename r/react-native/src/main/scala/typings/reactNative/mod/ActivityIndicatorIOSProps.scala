...
import typings.reactNative.AnonNativeEvent
...
trait ActivityIndicatorIOSProps extends ViewProps {
  ...
  /**
    ...
    */
  @JSName("onLayout")
  var onLayout_ActivityIndicatorIOSProps: js.UndefOr[js.Function1[/* event */ AnonNativeEvent, Unit]] = js.undefined
  /**
...
object ActivityIndicatorIOSProps {
  ...
  def apply(
    ...
    onLayout: /* event */ AnonNativeEvent => Unit = null,
