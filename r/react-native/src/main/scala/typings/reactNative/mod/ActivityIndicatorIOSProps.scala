...
import typings.reactNative.anon.NativeEvent
...
trait ActivityIndicatorIOSProps extends ViewProps {
  ...
  /**
    ...
    */
  @JSName("onLayout")
  var onLayout_ActivityIndicatorIOSProps: js.UndefOr[js.Function1[/* event */ NativeEvent, Unit]] = js.undefined
  /**
...
object ActivityIndicatorIOSProps {
  ...
  def apply(
    ...
    onLayout: /* event */ NativeEvent => Unit = null,
