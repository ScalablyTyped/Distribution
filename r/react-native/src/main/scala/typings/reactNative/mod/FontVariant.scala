...
/* Rewritten from type alias, can be one of: 
  - typings.reactNative.reactNativeStrings.`small-caps`
  - typings.reactNative.reactNativeStrings.`oldstyle-nums`
  - typings.reactNative.reactNativeStrings.`lining-nums`
  - typings.reactNative.reactNativeStrings.`tabular-nums`
  - typings.reactNative.reactNativeStrings.`proportional-nums`
*/
