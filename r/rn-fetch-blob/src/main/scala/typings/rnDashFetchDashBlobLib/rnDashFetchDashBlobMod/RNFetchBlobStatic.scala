...
trait RNFetchBlobStatic extends js.Object {
  ...
  var base64: rnDashFetchDashBlobLib.Anon_Decode = js.native
  var fs: FS = js.native
  ...
  def fetch(method: rnDashFetchDashBlobLib.Methods, url: java.lang.String): StatefulPromise[FetchBlobResponse] = js.native
  def fetch(
    method: rnDashFetchDashBlobLib.Methods,
