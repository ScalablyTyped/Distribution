...
object reactComponents extends reactProps {
  ...
  @scala.inline
  def unstable_Profiler: ComponentType[ProfilerProps] = typings.react.reactMod.^.unstable_Profiler.asInstanceOf[typings.react.reactMod.ComponentType[typings.react.reactMod.ProfilerProps]]
}
