...
object global {
  ...
  object JSX {
    ...
    trait IntrinsicElements extends StObject {
      ...
      var center: DetailedHTMLProps[HTMLAttributes[HTMLElement], HTMLElement]
      ...
      var line: SVGLineElementAttributes[SVGLineElement]
      ...
      var search: DetailedHTMLProps[HTMLAttributes[HTMLElement], HTMLElement]
      ...
      var text: SVGTextElementAttributes[SVGTextElement]
    ...
    object IntrinsicElements {
      ...
      implicit open class MutableBuilder[Self <: IntrinsicElements] (val x: Self) extends AnyVal {
        ...
        inline def setCenter(value: DetailedHTMLProps[HTMLAttributes[HTMLElement], HTMLElement]): Self = StObject.set(x, "center", value.asInstanceOf[js.Any])
        ...
        inline def setLine(value: SVGLineElementAttributes[SVGLineElement]): Self = StObject.set(x, "line", value.asInstanceOf[js.Any])
        ...
        inline def setSearch(value: DetailedHTMLProps[HTMLAttributes[HTMLElement], HTMLElement]): Self = StObject.set(x, "search", value.asInstanceOf[js.Any])
        ...
        inline def setText(value: SVGTextElementAttributes[SVGTextElement]): Self = StObject.set(x, "text", value.asInstanceOf[js.Any])
