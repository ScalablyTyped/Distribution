...
/** NOTE: Conditional type definitions are impossible to translate to Scala.
  ...
  */
@js.native
trait ElementRef[C /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typings.react.mod.ForwardRefExoticComponent[scala.Any], typings.react.anon.Instantiable, js.Function2[
/ * props * / scala.Any, 
