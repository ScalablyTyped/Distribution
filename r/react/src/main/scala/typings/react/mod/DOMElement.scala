...
object DOMElement {
  @scala.inline
  def apply[/* <: typings.react.mod.HTMLAttributes[T] | typings.react.mod.SVGAttributes[T] */ P, /* <: typings.std.Element */ T](props: js.Any, `type`: js.Any, key: Key = null, ref: LegacyRef[T] = null): DOMElement[P, T] = {
