...
package object mod {
  ...
  // Event Handler Types
  // ----------------------------------------------------------------------
  type EventHandler[E /* <: typings.react.mod.SyntheticEvent[_, typings.std.Event_] */] = js.Function1[/* event */ E, scala.Unit]
  ...
  // tslint:disable-next-line:no-empty-interface
  type FormEvent[T] = typings.react.mod.SyntheticEvent[T, typings.std.Event_]
  ...
  type ReactEventHandler[T] = typings.react.mod.EventHandler[typings.react.mod.SyntheticEvent[T, typings.std.Event_]]
