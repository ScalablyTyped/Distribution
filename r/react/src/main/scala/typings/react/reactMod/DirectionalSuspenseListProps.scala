...
trait DirectionalSuspenseListProps
  extends typings.react.experimentalMod.reactMod.SuspenseListCommonProps {
  /**
  ...
  /**
    ...
    */
  var tail: js.UndefOr[typings.react.experimentalMod.reactMod.SuspenseListTailMode] = js.undefined
}
