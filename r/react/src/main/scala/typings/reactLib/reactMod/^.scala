...
object ^ extends js.Object {
  ...
  val Fragment: ExoticComponent[reactLib.Anon_Children] = js.native
  val StrictMode: ExoticComponent[reactLib.Anon_Children] = js.native
  /**
  ...
  def cloneElement[P /* <: DOMAttributes[T] */, T /* <: reactLib.Element */](element: DOMElement[P, T]): DOMElement[P, T] = js.native
  def cloneElement[P /* <: DOMAttributes[T] */, T /* <: reactLib.Element */](element: DOMElement[P, T], props: DOMAttributes[T] with P, children: ReactNode*): DOMElement[P, T] = js.native
  // DOM Elements
  // ReactHTMLElement
  def cloneElement[P /* <: HTMLAttributes[T] */, T /* <: reactLib.HTMLElement */](element: DetailedReactHTMLElement[P, T]): DetailedReactHTMLElement[P, T] = js.native
  def cloneElement[P /* <: HTMLAttributes[T] */, T /* <: reactLib.HTMLElement */](element: DetailedReactHTMLElement[P, T], props: P, children: ReactNode*): DetailedReactHTMLElement[P, T] = js.native
  // SVGElement
  def cloneElement[P /* <: SVGAttributes[T] */, T /* <: reactLib.SVGElement */](element: ReactSVGElement): ReactSVGElement = js.native
  def cloneElement[P /* <: SVGAttributes[T] */, T /* <: reactLib.SVGElement */](element: ReactSVGElement, props: P, children: ReactNode*): ReactSVGElement = js.native
  // ReactHTMLElement, less specific
  @JSName("cloneElement")
  def cloneElement_PHTMLAttributesTHTMLElementReactHTMLElement[P /* <: HTMLAttributes[T] */, T /* <: reactLib.HTMLElement */](element: ReactHTMLElement[T]): ReactHTMLElement[T] = js.native
  @JSName("cloneElement")
  ...
  def createElement_PDOMAttributesTElementDOMElement[P /* <: DOMAttributes[T] */, T /* <: reactLib.Element */](`type`: java.lang.String): DOMElement[P, T] = js.native
  // Custom components
  @JSName("createElement")
  def createElement_PObjectFunctionComponentElement[P /* <: js.Object */](`type`: FunctionComponent[P]): FunctionComponentElement[P] = js.native
  @JSName("createElement")
  def createElement_PObjectFunctionComponentElement[P /* <: js.Object */](`type`: FunctionComponent[P], props: Attributes with (P | scala.Null), children: ReactNode*): FunctionComponentElement[P] = js.native
  @JSName("createElement")
  def createElement_PObjectTComponentCComponentClass[P /* <: js.Object */, T /* <: Component[P, ComponentState, _] */, C /* <: ComponentClass[P, ComponentState] */](`type`: ClassType[P, T, C]): CElement[P, T] = js.native
  @JSName("createElement")
  def createElement_PObjectTComponentCComponentClass[P /* <: js.Object */, T /* <: Component[P, ComponentState, _] */, C /* <: ComponentClass[P, ComponentState] */](`type`: ClassType[P, T, C], props: ClassAttributes[T] with (P | scala.Null), children: ReactNode*): CElement[P, T] = js.native
  @JSName("createElement")
  def createElement_PSVGAttributesTSVGElementReactSVGElement[P /* <: SVGAttributes[T] */, T /* <: reactLib.SVGElement */](`type`: /* import warning: LimitUnionLength.enterTypeRef Was union type with length 55 */ js.Any): ReactSVGElement = js.native
  @JSName("createElement")
  def createElement_PSVGAttributesTSVGElementReactSVGElement[P /* <: SVGAttributes[T] */, T /* <: reactLib.SVGElement */](
  ...
  @JSName("createElement")
  def createElement_input(`type`: reactLib.reactLibStrings.input): DetailedReactHTMLElement[InputHTMLAttributes[reactLib.HTMLInputElement], reactLib.HTMLInputElement] = js.native
  @JSName("createElement")
  def createElement_input(
    `type`: reactLib.reactLibStrings.input,
    props: InputHTMLAttributes[reactLib.HTMLInputElement] with (ClassAttributes[reactLib.HTMLInputElement] | scala.Null),
    children: ReactNode*
  ...
  def createFactory[P /* <: DOMAttributes[T] */, T /* <: reactLib.Element */](`type`: java.lang.String): DOMFactory[P, T] = js.native
  @JSName("createFactory")
  def createFactory_PTComponentCComponentClass[P, T /* <: Component[P, ComponentState, _] */, C /* <: ComponentClass[P, ComponentState] */](`type`: ClassType[P, T, C]): CFactory[P, T] = js.native
  //
  // Top Level API
  // ----------------------------------------------------------------------
  // DOM Elements
  ...
  /**
    ...
    */
  def useEffect(effect: EffectCallback): scala.Unit = js.native
  def useEffect(effect: EffectCallback, deps: DependencyList): scala.Unit = js.native
  ...
  /**
    ...
    */
  def useLayoutEffect(effect: EffectCallback): scala.Unit = js.native
  def useLayoutEffect(effect: EffectCallback, deps: DependencyList): scala.Unit = js.native
  ...
  @JSName("useRef")
  def useRef_TRefObject[T](): RefObject[T] = js.native
  ...
  // TODO (TypeScript 3.0): <T extends unknown>
  @JSName("useRef")
  def useRef_TRefObject[T](initialValue: T): RefObject[T] = js.native
