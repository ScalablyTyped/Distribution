...
object InfiniteScrollProps {
  ...
  def apply(
    ...
    AllHTMLAttributes: AllHTMLAttributes[typings.reactInfiniteScroller.mod.InfiniteScroll.InfiniteScroll] = null,
    ClassAttributes: ClassAttributes[typings.reactInfiniteScroller.mod.InfiniteScroll.InfiniteScroll] = null,
    element: String = null,
