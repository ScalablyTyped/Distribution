...
import typings.ramlTypesystem.typesystemInterfacesMod.ElementSourceInfo
import typings.ramlTypesystem.typesystemInterfacesMod.HasSource
...
import typings.ramlTypesystem.typesystemInterfacesMod.IParsedTypeCollection
...
@js.native
abstract class AbstractType protected ()
  extends StObject
     with IParsedType
     with HasSource {
  ...
  def validateDirect(
    ...
    autoClose: Boolean,
    nullAllowed: Boolean,
    path: typings.ramlTypesystem.typesystemInterfacesMod.IValidationPath
  ): Status = js.native
  def validateDirect(
    i: Any,
    autoClose: Boolean,
