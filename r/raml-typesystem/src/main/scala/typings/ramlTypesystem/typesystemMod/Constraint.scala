...
import typings.ramlTypesystem.typesystemInterfacesMod.IConstraint
...
import typings.ramlTypesystem.typesystemInterfacesMod.MetaInformationKind
...
abstract class Constraint ()
  ...
  def check(i: Any, parentPath: typings.ramlTypesystem.typesystemInterfacesMod.IValidationPath): Status = js.native
