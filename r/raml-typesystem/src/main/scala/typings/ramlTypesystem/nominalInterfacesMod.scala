...
import typings.ramlTypesystem.typesystemInterfacesMod.IHasExtra
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object nominalInterfacesMod {
  ...
  trait IExpandableExample extends StObject {
    ...
    def annotations(): StringDictionary[typings.ramlTypesystem.typesystemInterfacesMod.IAnnotation]
    ...
    def scalarsAnnotations(): StringDictionary[StringDictionary[typings.ramlTypesystem.typesystemInterfacesMod.IAnnotation]]
  ...
  object IExpandableExample {
    ...
    inline def apply(
      annotations: () => StringDictionary[typings.ramlTypesystem.typesystemInterfacesMod.IAnnotation],
      asJSON: () => Any,
      asString: () => String,
      description: () => String,
      displayName: () => String,
      ...
      name: () => String,
      original: () => Any,
      scalarsAnnotations: () => StringDictionary[StringDictionary[typings.ramlTypesystem.typesystemInterfacesMod.IAnnotation]],
      strict: () => Boolean
    ): IExpandableExample = {
    ...
    extension [Self <: IExpandableExample](x: Self) {
      ...
      inline def setAnnotations(value: () => StringDictionary[typings.ramlTypesystem.typesystemInterfacesMod.IAnnotation]): Self = StObject.set(x, "annotations", js.Any.fromFunction0(value))
      ...
      inline def setScalarsAnnotations(
        value: () => StringDictionary[StringDictionary[typings.ramlTypesystem.typesystemInterfacesMod.IAnnotation]]
