...
import typings.ramlTypesystem.metainfoMod.Annotation
import typings.ramlTypesystem.metainfoMod.CustomFacet
...
object parseMod {
  ...
  object NodeKind extends StObject {
    ...
    sealed trait ARRAY
      extends StObject
         with NodeKind
    /* 1 */ val ARRAY: typings.ramlTypesystem.parseMod.NodeKind.ARRAY & Double = js.native
    
    @js.native
    sealed trait MAP
      extends StObject
         with NodeKind
    /* 2 */ val MAP: typings.ramlTypesystem.parseMod.NodeKind.MAP & Double = js.native
    
    @js.native
    sealed trait SCALAR
      extends StObject
         with NodeKind
    /* 0 */ val SCALAR: typings.ramlTypesystem.parseMod.NodeKind.SCALAR & Double = js.native
  }
