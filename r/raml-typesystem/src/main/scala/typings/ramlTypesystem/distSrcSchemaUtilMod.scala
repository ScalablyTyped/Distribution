...
object distSrcSchemaUtilMod {
  ...
  inline def messageToValidationError(message: String): typings.ramlTypesystem.distSrcTypesystemMod.ValidationError = ^.asInstanceOf[js.Dynamic].applyDynamic("messageToValidationError")(message.asInstanceOf[js.Any]).asInstanceOf[typings.ramlTypesystem.distSrcTypesystemMod.ValidationError]
  inline def messageToValidationError(message: String, isExample: Boolean): typings.ramlTypesystem.distSrcTypesystemMod.ValidationError = (^.asInstanceOf[js.Dynamic].applyDynamic("messageToValidationError")(message.asInstanceOf[js.Any], isExample.asInstanceOf[js.Any])).asInstanceOf[typings.ramlTypesystem.distSrcTypesystemMod.ValidationError]
