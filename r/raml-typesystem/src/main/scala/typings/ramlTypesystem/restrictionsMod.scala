...
import typings.ramlTypesystem.typesystemMod.Constraint
...
object restrictionsMod {
  ...
  @JSImport("raml-typesystem/dist/src/restrictions", "FacetRestriction")
  @js.native
  abstract class FacetRestriction[T] () extends Constraint {
  ...
  @js.native
  abstract class MatchesProperty protected () extends Constraint {
    ...
    def patchPath(p: typings.ramlTypesystem.typesystemMod.IValidationPath, name: String): IValidationPath = js.native
    ...
    def validateProp(i: Any, n: String, t: AbstractType, q: typings.ramlTypesystem.typesystemMod.IValidationPath): Status = js.native
  }
  /* static members */
  ...
  @JSImport("raml-typesystem/dist/src/restrictions", "MinMaxRestriction")
  @js.native
  abstract class MinMaxRestriction protected () extends FacetRestriction[Number] {
    def this(
      _facetName: String,
      _value: Double,
      _max: Boolean,
  ...
  type IValidationPath = typings.ramlTypesystem.typesystemMod.IValidationPath
}
