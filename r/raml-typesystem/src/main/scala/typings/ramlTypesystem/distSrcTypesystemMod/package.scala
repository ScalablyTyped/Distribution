...
import typings.ramlTypesystem.distSrcTypesystemMod.^
...
inline def patchPath(p: typings.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath): typings.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath = ^.asInstanceOf[js.Dynamic].applyDynamic("patchPath")(p.asInstanceOf[js.Any]).asInstanceOf[typings.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath]

inline def setValidationPath(_s: IStatus, _c: typings.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setValidationPath")(_s.asInstanceOf[js.Any], _c.asInstanceOf[js.Any])).asInstanceOf[Unit]
