...
open class Status protected ()
  ...
  /* CompleteClass */
  override def getInternalPath(): typings.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath = js.native
  ...
  /* CompleteClass */
  override def getValidationPath(): typings.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath = js.native
  ...
  /* protected */ var internalPath: typings.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath = js.native
  ...
  def setInternalPath(ip: typings.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath): Unit = js.native
  ...
  /* CompleteClass */
  override def setValidationPath(p: typings.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath): Unit = js.native
  ...
  /* protected */ var vp: typings.ramlTypesystem.distSrcTypesystemInterfacesMod.IValidationPath = js.native
}
/* static members */
object Status {
