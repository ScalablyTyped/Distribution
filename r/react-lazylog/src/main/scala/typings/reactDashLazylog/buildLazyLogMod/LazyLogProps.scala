...
object LazyLogProps {
  ...
  def apply(
    ...
    if (highlightLineClassName != null) __obj.updateDynamic("highlightLineClassName")(highlightLineClassName)
    if (lineClassName != null) __obj.updateDynamic("lineClassName")(lineClassName)
    if (loadingComponent != null) __obj.updateDynamic("loadingComponent")(loadingComponent)
