...
import typings.railsUjs.railsUjsStrings.compositionend
import typings.railsUjs.railsUjsStrings.compositionstart
import typings.railsUjs.railsUjsStrings.compositionupdate
...
import typings.railsUjs.railsUjsStrings.formdata
...
import typings.railsUjs.railsUjsStrings.slotchange
...
import typings.railsUjs.railsUjsStrings.webkitanimationend
import typings.railsUjs.railsUjsStrings.webkitanimationiteration
...
object utilsEventMod {
  
  @JSImport("@rails/ujs/utils/event", JSImport.Namespace)
  @js.native
  ...
  inline def delegate_progress(
    ...
    selector: String,
    eventType: progress,
    handler: js.ThisFunction1[/* this */ HTMLElement, /* ev */ ProgressEvent[EventTarget], Any]
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("delegate")(element.asInstanceOf[js.Any], selector.asInstanceOf[js.Any], eventType.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def delegate_progress(
    element: EventTarget,
    selector: SelectorObject,
