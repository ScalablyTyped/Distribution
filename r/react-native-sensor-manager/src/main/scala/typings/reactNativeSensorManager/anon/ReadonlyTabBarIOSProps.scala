...
import typings.reactNativeSensorManager.reactNativeSensorManagerStrings.center
import typings.reactNativeSensorManager.reactNativeSensorManagerStrings.fill
