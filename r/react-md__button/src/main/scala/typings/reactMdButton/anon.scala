...
object anon {
  ...
  @js.native
  trait PickButtonHTMLAttributesH extends StObject {
  ...
  object PickButtonHTMLAttributesH {
    ...
    @scala.inline
    implicit class PickButtonHTMLAttributesHMutableBuilder[Self <: PickButtonHTMLAttributesH] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRef(value: Ref[HTMLButtonElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
