package typings.reactMdButton.unstyledButtonMod
...
@js.native
trait UnstyledButtonProps extends js.Object {
...
object UnstyledButtonProps {
  ...
  @scala.inline
  implicit class UnstyledButtonPropsOps[Self <: UnstyledButtonProps] (val x: Self) extends AnyVal {
