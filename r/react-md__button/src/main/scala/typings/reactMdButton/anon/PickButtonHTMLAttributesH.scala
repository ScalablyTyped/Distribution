package typings.reactMdButton.anon
...
trait PickButtonHTMLAttributesH extends js.Object {
  ...
  var ref: js.UndefOr[Ref[HTMLButtonElement]] = js.native
...
object PickButtonHTMLAttributesH {
  @scala.inline
  def apply(): PickButtonHTMLAttributesH = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickButtonHTMLAttributesH]
  }
  @scala.inline
  implicit class PickButtonHTMLAttributesHOps[Self <: PickButtonHTMLAttributesH] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRef(value: Ref[HTMLButtonElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
    @scala.inline
