...
/* Inlined parent @react-md/button.@react-md/button/types/buttonThemeClassNames.ButtonThemeProps */
/* Inlined parent react.react.ButtonHTMLAttributes<std.HTMLButtonElement> */
