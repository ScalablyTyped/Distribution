...
object MaterialCommunityIcons
  ...
  override val component: String | js.Object = js.constructorOf[typings.reactDashNativeDashVectorDashIcons.materialCommunityIconsMod.default].asInstanceOf[String | js.Object]
  def apply(
