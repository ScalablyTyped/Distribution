...
import typings.reactDashNativeDashVectorDashIcons.entypoMod.defaultNs.TabBarItemIOS
...
object defaultNsTabBarItemIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItemIOS] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNativeDashVectorDashIcons.entypoMod.defaultNs.TabBarItemIOS].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
