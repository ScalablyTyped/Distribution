...
object EvilIcons
  ...
  override val component: String | js.Object = js.constructorOf[typings.reactDashNativeDashVectorDashIcons.evilIconsMod.default].asInstanceOf[String | js.Object]
  def apply(
