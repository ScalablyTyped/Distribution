...
object FontAwesome
  ...
  override val component: String | js.Object = js.constructorOf[typings.reactDashNativeDashVectorDashIcons.fontAwesomeMod.default].asInstanceOf[String | js.Object]
  def apply(
