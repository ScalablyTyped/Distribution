...
object SimpleLineIcons
  ...
  override val component: String | js.Object = js.constructorOf[typings.reactDashNativeDashVectorDashIcons.simpleLineIconsMod.default].asInstanceOf[String | js.Object]
  def apply(
