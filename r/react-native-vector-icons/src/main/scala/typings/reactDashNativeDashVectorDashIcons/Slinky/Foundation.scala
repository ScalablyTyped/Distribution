...
object Foundation
  ...
  override val component: String | js.Object = js.constructorOf[typings.reactDashNativeDashVectorDashIcons.foundationMod.default].asInstanceOf[String | js.Object]
  def apply(
