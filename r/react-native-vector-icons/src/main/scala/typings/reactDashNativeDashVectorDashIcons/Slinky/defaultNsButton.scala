...
import typings.reactDashNativeDashVectorDashIcons.entypoMod.defaultNs.Button
...
object defaultNsButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, Button] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNativeDashVectorDashIcons.entypoMod.defaultNs.Button].asInstanceOf[String | js.Object]
  def apply(
