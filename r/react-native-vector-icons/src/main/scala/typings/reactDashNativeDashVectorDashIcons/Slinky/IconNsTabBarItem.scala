...
import typings.reactDashNativeDashVectorDashIcons.iconMod.IconNs.TabBarItem
...
object IconNsTabBarItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItem] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNativeDashVectorDashIcons.iconMod.IconNs.TabBarItem].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
