...
import typings.reactDashNativeDashVectorDashIcons.entypoMod.defaultNs.TabBarItem
...
object defaultNsTabBarItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItem] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNativeDashVectorDashIcons.entypoMod.defaultNs.TabBarItem].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
