...
import typings.reactDashNativeDashVectorDashIcons.iconMod.IconNs.TabBarItemIOS
...
object IconNsTabBarItemIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItemIOS] {
  override val component: String | js.Object = js.constructorOf[typings.reactDashNativeDashVectorDashIcons.iconMod.IconNs.TabBarItemIOS].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
