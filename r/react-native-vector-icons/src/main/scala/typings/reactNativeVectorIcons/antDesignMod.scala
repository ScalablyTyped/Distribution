...
object antDesignMod {
  ...
  object default {
    ...
    @JSImport("react-native-vector-icons/AntDesign", "default.TabBarItemIOS")
    @js.native
    ...
    @JSImport("react-native-vector-icons/AntDesign", "default.ToolbarAndroid")
    @js.native
    ...
    @JSImport("react-native-vector-icons/AntDesign", "default.getImageSource")
    @js.native
    ...
    @JSImport("react-native-vector-icons/AntDesign", "default.getImageSourceSync")
    @js.native
    ...
    @JSImport("react-native-vector-icons/AntDesign", "default.getRawGlyphMap")
    @js.native
    def getRawGlyphMap(): StringDictionary[Double] = js.native
    
    @JSImport("react-native-vector-icons/AntDesign", "default.hasIcon")
    @js.native
    def hasIcon(name: String): Boolean = js.native
    
    @JSImport("react-native-vector-icons/AntDesign", "default.loadFont")
    @js.native
