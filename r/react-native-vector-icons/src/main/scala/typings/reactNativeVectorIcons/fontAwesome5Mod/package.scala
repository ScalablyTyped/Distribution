...
package object fontAwesome5Mod {
  type AllowOnlyOne[T, Keys /* <: java.lang.String */] = (typings.reactNativeVectorIcons.fontAwesome5Mod.Omit[T, Keys]) with (/* import warning: importer.ImportType#apply Failed type conversion: {[ K in Keys ]: -? std.Partial<std.Pick<T, K>> & std.Partial<std.Record<std.Exclude<Keys, K>, undefined>>}[Keys] */ js.Any)
  ...
  type FontAwesome5IconProps = typings.reactNativeVectorIcons.fontAwesome5Mod.AllowOnlyOne[
    typings.reactNativeVectorIcons.KinFontAwesome5IconVarian, 
