...
object fontAwesome5ProMod {
  ...
  object default {
    ...
    inline def Button_=(x: Instantiable0[Button]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Button")(x.asInstanceOf[js.Any])
    ...
    inline def ToolbarAndroid_=(x: Instantiable0[ToolbarAndroid]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ToolbarAndroid")(x.asInstanceOf[js.Any])
