...
import typings.reactNativeVectorIcons.fontAwesome5Mod.FontAwesome5IconButton
...
object fontAwesome5ProMod {
  ...
  /* Inlined react-native-vector-icons.react-native-vector-icons/FontAwesome5.FontAwesome5IconProps */
  trait FontAwesome5ProIconProps extends StObject {
  ...
  object FontAwesome5ProIconProps {
    
    inline def apply(name: String): FontAwesome5ProIconProps = {
