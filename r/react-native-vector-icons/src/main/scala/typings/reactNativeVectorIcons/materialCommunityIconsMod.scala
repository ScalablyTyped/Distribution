...
object materialCommunityIconsMod {
  ...
  object default {
    ...
    @JSImport("react-native-vector-icons/MaterialCommunityIcons", "default.getImageSource")
    @js.native
    ...
    @JSImport("react-native-vector-icons/MaterialCommunityIcons", "default.getImageSourceSync")
    @js.native
    ...
    @JSImport("react-native-vector-icons/MaterialCommunityIcons", "default.getRawGlyphMap")
    @js.native
    def getRawGlyphMap(): StringDictionary[Double] = js.native
    
    @JSImport("react-native-vector-icons/MaterialCommunityIcons", "default.hasIcon")
    @js.native
    def hasIcon(name: String): Boolean = js.native
    
    @JSImport("react-native-vector-icons/MaterialCommunityIcons", "default.loadFont")
    @js.native
