...
object materialIconsMod {
  ...
  object default {
    ...
    @JSImport("react-native-vector-icons/MaterialIcons", "default.getImageSource")
    @js.native
    ...
    @JSImport("react-native-vector-icons/MaterialIcons", "default.getImageSourceSync")
    @js.native
    ...
    @JSImport("react-native-vector-icons/MaterialIcons", "default.getRawGlyphMap")
    @js.native
    def getRawGlyphMap(): StringDictionary[Double] = js.native
    
    @JSImport("react-native-vector-icons/MaterialIcons", "default.hasIcon")
    @js.native
    def hasIcon(name: String): Boolean = js.native
    
    @JSImport("react-native-vector-icons/MaterialIcons", "default.loadFont")
    @js.native
