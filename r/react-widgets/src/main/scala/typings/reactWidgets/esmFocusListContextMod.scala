...
import typings.reactWidgets.esmAccessorsMod.TextAccessorFn
...
object esmFocusListContextMod {
  
  @JSImport("react-widgets/esm/FocusListContext", JSImport.Namespace)
  @js.native
  ...
  object FocusListContext {
    ...
    @JSImport("react-widgets/esm/FocusListContext", "FocusListContext")
    @js.native
