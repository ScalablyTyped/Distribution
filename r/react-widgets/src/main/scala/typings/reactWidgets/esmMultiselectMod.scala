...
import typings.reactWidgets.esmMultiselectTagListMod.MultiselectTagListProps
import typings.reactWidgets.esmMultiselectTagListMod.RenderTagProp
import typings.reactWidgets.esmMultiselectTagListMod.TagComponentProp
import typings.reactWidgets.esmPopupMod.PopupProps
import typings.reactWidgets.esmSharedMod.AllowCreate
import typings.reactWidgets.esmSharedMod.SearchHandler
  ...
  object MultiselectProps {
    ...
    extension [Self <: MultiselectProps[?], TDataItem](x: Self & MultiselectProps[TDataItem]) {
      ...
      inline def setOnChange(
        value: (/* dataItem */ js.Array[TDataItem], /* metadata */ OriginalEventSearchTerm[TDataItem]) => Unit
