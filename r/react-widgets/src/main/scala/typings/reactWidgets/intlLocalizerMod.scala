...
import typings.reactWidgets.localizationMod.DateTimePart
...
object intlLocalizerMod {
  ...
  trait IntlNumberLocalizer
    extends StObject
       with typings.reactWidgets.localizationMod.NumberLocalizer[NumberFormatOptions] {
