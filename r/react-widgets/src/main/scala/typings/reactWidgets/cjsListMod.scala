...
import typings.reactWidgets.cjsListOptionMod.ListOptionProps
...
object cjsListMod {
  ...
  @JSImport("react-widgets/cjs/List", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-widgets/cjs/List", JSImport.Default)
  @js.native
  val default: typings.reactWidgets.cjsListMod.List = js.native
  ...
  object ListProps {
    ...
    inline def apply[TDataItem](
      ...
      onChange: (/* dataItem */ TDataItem | js.Array[TDataItem], /* metadata */ Action[TDataItem]) => Unit
    ): ListProps[TDataItem] = {
    ...
    extension [Self <: ListProps[?], TDataItem](x: Self & ListProps[TDataItem]) {
      ...
      inline def setOnChange(value: (/* dataItem */ TDataItem | js.Array[TDataItem], /* metadata */ Action[TDataItem]) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
