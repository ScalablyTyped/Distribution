...
import typings.reactWidgets.anon.PartialCalendarPropsunkno
import typings.reactWidgets.anon.PartialDatePickerInputPro
...
object cjsDatePickerMod extends Shortcut {
  ...
  /**
    ...
    * @extends Calendar
    */
  @JSImport("react-widgets/cjs/DatePicker", JSImport.Default)
  @js.native
  ...
  /* Inlined parent std.Omit<react-widgets.react-widgets/cjs/shared.WidgetHTMLProps<std.HTMLDivElement>, 'onChange' | 'defaultValue'> */
  /* Inlined parent std.Omit<react-widgets.react-widgets/cjs/Widget.WidgetProps, 'onChange' | 'onSelect' | 'defaultValue'> */
  ...
  /* This means you don't have to write `default`, but can instead just say `cjsDatePickerMod.foo` */
