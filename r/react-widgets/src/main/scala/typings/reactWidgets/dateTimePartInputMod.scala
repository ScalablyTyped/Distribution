...
object dateTimePartInputMod extends Shortcut {
  
  @JSImport("react-widgets/cjs/DateTimePartInput", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `dateTimePartInputMod.foo` */
