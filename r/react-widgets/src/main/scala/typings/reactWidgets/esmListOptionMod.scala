...
object esmListOptionMod {
  ...
  object default {
    ...
    @JSImport("react-widgets/esm/ListOption", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-widgets/esm/ListOption", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-widgets/esm/ListOption", "default.propTypes.activeId")
      @js.native
      ...
      @JSImport("react-widgets/esm/ListOption", "default.propTypes.component")
      @js.native
      def component: Requireable[Any] = js.native
      inline def component_=(x: Requireable[Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("component")(x.asInstanceOf[js.Any])
      
      @JSImport("react-widgets/esm/ListOption", "default.propTypes.dataItem")
      @js.native
      def dataItem: Requireable[Any] = js.native
      inline def dataItem_=(x: Requireable[Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("dataItem")(x.asInstanceOf[js.Any])
      
      @JSImport("react-widgets/esm/ListOption", "default.propTypes.onSelect")
      @js.native
      ...
      @JSImport("react-widgets/esm/ListOption", "default.propTypes.selected")
      @js.native
      def selected: Validator[Boolean] = js.native
      inline def selected_=(x: Validator[Boolean]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("selected")(x.asInstanceOf[js.Any])
    }
  }
  
  /* Inlined parent std.Omit<react.react.HTMLProps<std.HTMLDivElement>, 'onSelect'> */
  trait ListOptionProps[TDataItem] extends StObject {
    ...
    def onSelect(dataItem: TDataItem, event: MouseEvent[typings.std.Element, NativeMouseEvent]): Unit
  ...
  object ListOptionProps {
    
    inline def apply[TDataItem](
      dataItem: TDataItem,
      onSelect: (TDataItem, MouseEvent[typings.std.Element, NativeMouseEvent]) => Unit,
      selected: Boolean
    ): ListOptionProps[TDataItem] = {
      val __obj = js.Dynamic.literal(dataItem = dataItem.asInstanceOf[js.Any], onSelect = js.Any.fromFunction2(onSelect), selected = selected.asInstanceOf[js.Any])
    ...
    extension [Self <: ListOptionProps[?], TDataItem](x: Self & ListOptionProps[TDataItem]) {
      ...
      inline def setOnSelect(value: (TDataItem, MouseEvent[typings.std.Element, NativeMouseEvent]) => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction2(value))
