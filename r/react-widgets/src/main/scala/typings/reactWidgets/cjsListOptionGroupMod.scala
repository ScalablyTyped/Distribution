...
object cjsListOptionGroupMod {
  
  object default {
    
    inline def apply(param0: Props): Element = ^.asInstanceOf[js.Dynamic].apply(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
    
    @JSImport("react-widgets/cjs/ListOptionGroup", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object propTypes {
      
      @JSImport("react-widgets/cjs/ListOptionGroup", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-widgets/cjs/ListOptionGroup", "default.propTypes.className")
      @js.native
      ...
      @JSImport("react-widgets/cjs/ListOptionGroup", "default.propTypes.component")
      @js.native
      def component: Requireable[String] = js.native
      inline def component_=(x: Requireable[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("component")(x.asInstanceOf[js.Any])
    }
  }
