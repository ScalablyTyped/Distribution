...
object numberPickerMod {
  
  @JSImport("react-widgets/cjs/NumberPicker", JSImport.Namespace)
  @js.native
  ...
  /* Inlined parent std.Omit<react-widgets.react-widgets/cjs/Widget.WidgetProps, 'onChange'> */
