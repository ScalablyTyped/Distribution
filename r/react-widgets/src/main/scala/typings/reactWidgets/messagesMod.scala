...
object messagesMod {
  ...
  @JSImport("react-widgets/cjs/messages", JSImport.Namespace)
  @js.native
  ...
  /* Inlined {[ P in keyof react-widgets.react-widgets/cjs/messages.Messages ]: react-widgets.react-widgets/cjs/messages.Messages[P] extends std.Function? react-widgets.react-widgets/cjs/messages.Messages[P] : (): string} */
  ...
  /* Inlined std.Partial<react-widgets.react-widgets/cjs/messages.Messages> */
