...
import typings.reactWidgets.anon.PickPropsariaactivedescen
...
object esmDateTimePartInputMod extends Shortcut {
  
  @JSImport("react-widgets/esm/DateTimePartInput", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[PickPropsariaactivedescen] = js.native
  
  /* Inlined parent std.Omit<react.react.HTMLProps<std.HTMLInputElement>, 'value' | 'onChange'> */
  ...
  object Props {
    ...
    inline def apply(max: Double, min: Double, onChange: ChangeEvent[HTMLInputElement] => Unit): Props = {
      val __obj = js.Dynamic.literal(max = max.asInstanceOf[js.Any], min = min.asInstanceOf[js.Any], onChange = js.Any.fromFunction1(onChange))
  ...
  type _To = ForwardRefExoticComponent[PickPropsariaactivedescen]
  
  /* This means you don't have to write `default`, but can instead just say `esmDateTimePartInputMod.foo` */
  override def _to: ForwardRefExoticComponent[PickPropsariaactivedescen] = default
}
