...
import typings.reactWidgets.cjsSlideTransitionGroupMod.default
...
object cjsCalendarMod {
  ...
  - typings.reactWidgets.cjsSharedMod.WidgetProps because var conflicts: className, id, tabIndex. Inlined autoFocus, messages */ trait CalendarProps[TLocalizer]
    extends StObject
