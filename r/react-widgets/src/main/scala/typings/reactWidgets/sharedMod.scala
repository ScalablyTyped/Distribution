...
import typings.reactWidgets.filterMod.Filter
import typings.reactWidgets.listMod.GroupBy
import typings.reactWidgets.listMod.ListProps
import typings.reactWidgets.listMod.OptionComponentProp
import typings.reactWidgets.listMod.RenderGroupProp
import typings.reactWidgets.listMod.RenderItemProp
...
import typings.reactWidgets.typesMod.SearchMetadata
...
object sharedMod {
  ...
  object BaseListboxInputProps {
    ...
    extension [Self <: BaseListboxInputProps[?, ?], TDataItem, TValue](x: Self & (BaseListboxInputProps[TDataItem, TValue])) {
      ...
      inline def setOnChange(value: (TDataItem, /* metadata */ Source) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
