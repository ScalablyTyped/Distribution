...
import typings.reactWidgets.cjsSharedMod.ChangeHandler
import typings.reactWidgets.cjsSharedMod.Filterable
import typings.reactWidgets.cjsSharedMod.SelectHandler
import typings.reactWidgets.cjsSharedMod.WidgetHTMLProps
...
object cjsComboboxMod extends Shortcut {
  ...
  - typings.reactWidgets.cjsSharedMod.WidgetProps because var conflicts: className, id, tabIndex. Inlined autoFocus, messages */ trait ComboboxProps[TDataItem]
    extends StObject
  ...
  /* This means you don't have to write `default`, but can instead just say `cjsComboboxMod.foo` */
