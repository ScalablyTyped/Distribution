...
object cjsTimeInputMod {
  ...
  object default {
    ...
    @JSImport("react-widgets/cjs/TimeInput", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object defaultProps {
      
      @JSImport("react-widgets/cjs/TimeInput", "default.defaultProps")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-widgets/cjs/TimeInput", "default.defaultProps.emptyCharacter")
      @js.native
      ...
      @JSImport("react-widgets/cjs/TimeInput", "default.defaultProps.hoursAddon")
      @js.native
      ...
      @JSImport("react-widgets/cjs/TimeInput", "default.defaultProps.padValues")
      @js.native
      ...
      @JSImport("react-widgets/cjs/TimeInput", "default.defaultProps.precision")
      @js.native
    ...
    object propTypes {
      ...
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      ...
      /**
        ...
        * @default new Date()
        **/
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.datePart")
      @js.native
      ...
      /**
        ...
        */
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.disabled")
      @js.native
      ...
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.emptyCharacter")
      @js.native
      ...
      /**
        ...
        * @default ':'
        */
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.hoursAddon")
      @js.native
      ...
      /**
        ...
        * @default '.'
        */
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.millisecondsAddon")
      @js.native
      ...
      /**
        ...
        * @default ':'
        */
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.minutesAddon")
      @js.native
      ...
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.noClearButton")
      @js.native
      ...
      /**
        ...
        */
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.onChange")
      @js.native
      ...
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.padValues")
      @js.native
      ...
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.precision")
      @js.native
      ...
      /**
        ...
        */
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.readOnly")
      @js.native
      ...
      /**
        ...
        * @default ':'
        */
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.secondsAddon")
      @js.native
      ...
      /**
        ...
        **/
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.use12HourClock")
      @js.native
      ...
      /**
        ...
        */
      @JSImport("react-widgets/cjs/TimeInput", "default.propTypes.value")
      @js.native
  ...
  /* Inlined parent std.Omit<react-widgets.react-widgets/cjs/Widget.WidgetProps, 'value' | 'onChange'> */
  trait TimeInputProps extends StObject {
    ...
    var datePart: js.UndefOr[js.Date] = js.undefined
    ...
    var emptyCharacter: js.UndefOr[String] = js.undefined
    
    var focused: js.UndefOr[Boolean] = js.undefined
    
    var hidden: js.UndefOr[Boolean] = js.undefined
    
    var hoursAddon: js.UndefOr[ReactNode] = js.undefined
    ...
    var millisecondsAddon: js.UndefOr[ReactNode] = js.undefined
    
    var minutesAddon: js.UndefOr[ReactNode] = js.undefined
    ...
    var onChange: js.UndefOr[js.Function2[/* date */ js.Date | Null, /* ctx */ js.UndefOr[Any], Unit]] = js.undefined
    ...
    var padValues: js.UndefOr[Boolean] = js.undefined
    
    var placeholder: js.UndefOr[String] = js.undefined
    
    var precision: minutes | seconds | milliseconds
    ...
    var secondsAddon: js.UndefOr[ReactNode] = js.undefined
    ...
    var use12HourClock: js.UndefOr[Boolean] = js.undefined
  ...
  object TimeInputProps {
    ...
    inline def apply(precision: minutes | seconds | milliseconds): TimeInputProps = {
    ...
    extension [Self <: TimeInputProps](x: Self) {
      ...
      inline def setDatePart(value: js.Date): Self = StObject.set(x, "datePart", value.asInstanceOf[js.Any])
      
      inline def setDatePartUndefined: Self = StObject.set(x, "datePart", js.undefined)
      ...
      inline def setEmptyCharacter(value: String): Self = StObject.set(x, "emptyCharacter", value.asInstanceOf[js.Any])
      
      inline def setEmptyCharacterUndefined: Self = StObject.set(x, "emptyCharacter", js.undefined)
      ...
      inline def setHoursAddon(value: ReactNode): Self = StObject.set(x, "hoursAddon", value.asInstanceOf[js.Any])
      
      inline def setHoursAddonUndefined: Self = StObject.set(x, "hoursAddon", js.undefined)
      ...
      inline def setMillisecondsAddon(value: ReactNode): Self = StObject.set(x, "millisecondsAddon", value.asInstanceOf[js.Any])
      
      inline def setMillisecondsAddonUndefined: Self = StObject.set(x, "millisecondsAddon", js.undefined)
      
      inline def setMinutesAddon(value: ReactNode): Self = StObject.set(x, "minutesAddon", value.asInstanceOf[js.Any])
      
      inline def setMinutesAddonUndefined: Self = StObject.set(x, "minutesAddon", js.undefined)
      ...
      inline def setOnChange(value: (/* date */ js.Date | Null, /* ctx */ js.UndefOr[Any]) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      ...
      inline def setPadValues(value: Boolean): Self = StObject.set(x, "padValues", value.asInstanceOf[js.Any])
      
      inline def setPadValuesUndefined: Self = StObject.set(x, "padValues", js.undefined)
      
      inline def setPlaceholder(value: String): Self = StObject.set(x, "placeholder", value.asInstanceOf[js.Any])
      
      inline def setPlaceholderUndefined: Self = StObject.set(x, "placeholder", js.undefined)
      
      inline def setPrecision(value: minutes | seconds | milliseconds): Self = StObject.set(x, "precision", value.asInstanceOf[js.Any])
      ...
      inline def setSecondsAddon(value: ReactNode): Self = StObject.set(x, "secondsAddon", value.asInstanceOf[js.Any])
      
      inline def setSecondsAddonUndefined: Self = StObject.set(x, "secondsAddon", js.undefined)
      ...
      inline def setUse12HourClock(value: Boolean): Self = StObject.set(x, "use12HourClock", value.asInstanceOf[js.Any])
      
      inline def setUse12HourClockUndefined: Self = StObject.set(x, "use12HourClock", js.undefined)
