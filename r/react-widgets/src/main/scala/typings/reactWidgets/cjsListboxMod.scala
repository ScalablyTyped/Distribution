...
object cjsListboxMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactWidgets.cjsListboxMod.SingleListboxProps[TDataItem]
    - typings.reactWidgets.cjsListboxMod.MultipleListboxProps[TDataItem]
  */
  trait ListboxProps[TDataItem] extends StObject
  object ListboxProps {
    
    inline def MultipleListboxProps[TDataItem](data: js.Array[TDataItem]): typings.reactWidgets.cjsListboxMod.MultipleListboxProps[TDataItem] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], multiple = true)
      __obj.asInstanceOf[typings.reactWidgets.cjsListboxMod.MultipleListboxProps[TDataItem]]
    }
    
    inline def SingleListboxProps[TDataItem](data: js.Array[TDataItem]): typings.reactWidgets.cjsListboxMod.SingleListboxProps[TDataItem] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.reactWidgets.cjsListboxMod.SingleListboxProps[TDataItem]]
    }
  }
  ...
  /* This means you don't have to write `default`, but can instead just say `cjsListboxMod.foo` */
