...
import typings.reactWidgets.cjsLocalizationMod.DateTimePart
...
object cjsIntlLocalizerMod {
  
  /**
    * A `react-widgets` Localizer using native `Intl` APIs.
    *
    */
  @JSImport("react-widgets/cjs/IntlLocalizer", "DateLocalizer")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("react-widgets/cjs/IntlLocalizer", "NumberLocalizer")
  @js.native
  ...
  /**
    ...
    *
    */
  /* Inlined parent react-widgets.react-widgets/cjs/Localization.DateLocalizer<std.Intl.DateTimeFormatOptions> */
  @js.native
  ...
  trait IntlNumberLocalizer
    extends StObject
       with typings.reactWidgets.cjsLocalizationMod.NumberLocalizer[NumberFormatOptions] {
