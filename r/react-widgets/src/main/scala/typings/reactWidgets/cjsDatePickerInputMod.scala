...
object cjsDatePickerInputMod extends Shortcut {
  
  @JSImport("react-widgets/cjs/DatePickerInput", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[DatePickerInputProps[Any] & RefAttributes[HTMLInputElement]] = js.native
  
  /* Inlined parent std.Omit<react-widgets.react-widgets/cjs/Input.InputProps, 'value' | 'onChange'> */
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `cjsDatePickerInputMod.foo` */
