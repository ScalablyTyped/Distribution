...
object cjsSlideTransitionGroupMod {
  
  @JSImport("react-widgets/cjs/SlideTransitionGroup", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    object defaultProps {
      ...
      @JSImport("react-widgets/cjs/SlideTransitionGroup", "default.defaultProps")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-widgets/cjs/SlideTransitionGroup", "default.defaultProps.direction")
      @js.native
    ...
    object propTypes {
      ...
      @JSImport("react-widgets/cjs/SlideTransitionGroup", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-widgets/cjs/SlideTransitionGroup", "default.propTypes.direction")
      @js.native
      ...
      @JSImport("react-widgets/cjs/SlideTransitionGroup", "default.propTypes.onTransitionEnd")
      @js.native
