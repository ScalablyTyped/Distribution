...
import typings.reactWidgets.esmSlideTransitionGroupMod.default
...
object esmCalendarMod {
  ...
  - typings.reactWidgets.esmSharedMod.WidgetProps because var conflicts: className, id, tabIndex. Inlined autoFocus, messages */ trait CalendarProps[TLocalizer]
    extends StObject
