...
import typings.reactWidgets.esmDatePickerMod.DatePickerHandle
import typings.reactWidgets.esmDatePickerMod.DatePickerProps
import typings.reactWidgets.esmLocalizationMod.FormatterOverrides
import typings.reactWidgets.esmLocalizationMod.Localizer
import typings.reactWidgets.esmLocalizationMod.ProviderProps
import typings.reactWidgets.esmNumberPickerMod.NumberPickerProps
import typings.reactWidgets.esmSlideDownTransitionMod.default
import typings.reactWidgets.esmSlideTransitionGroupMod.SlideTransitionGroupProps
import typings.reactWidgets.esmTimeInputMod.TimeInputProps
...
object esmMod {
  ...
  object Calendar {
    ...
    open class Transition protected ()
      extends typings.reactWidgets.esmCalendarMod.default.Transition {
  ...
  @js.native
  val Combobox: typings.reactWidgets.esmComboboxMod.Combobox = js.native
  ...
  @js.native
  val DropdownList: typings.reactWidgets.esmDropdownListMod.DropdownList = js.native
  
  @JSImport("react-widgets/esm", "Listbox")
  @js.native
  val Listbox: typings.reactWidgets.esmListboxMod.Listbox = js.native
  ...
  @js.native
  val Multiselect: typings.reactWidgets.esmMultiselectMod.Multiselect = js.native
  ...
  open class SlideTransitionGroup protected ()
    extends typings.reactWidgets.esmSlideTransitionGroupMod.default {
    def this(args: SlideTransitionGroupProps) = this()
  }
