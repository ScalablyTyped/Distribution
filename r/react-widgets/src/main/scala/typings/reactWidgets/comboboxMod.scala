...
import typings.reactWidgets.anon.Source
import typings.reactWidgets.anon.`0`
import typings.reactWidgets.messagesMod.UserProvidedMessages
import typings.reactWidgets.popupMod.PopupProps
import typings.reactWidgets.sharedMod.BaseListboxInputProps
import typings.reactWidgets.sharedMod.ChangeHandler
import typings.reactWidgets.sharedMod.Filterable
import typings.reactWidgets.sharedMod.SelectHandler
...
object comboboxMod extends Shortcut {
  ...
  /**
    ...
    * @public
    */
  @JSImport("react-widgets/cjs/Combobox", JSImport.Default)
  @js.native
  ...
  - typings.reactWidgets.sharedMod.PopupWidgetProps because var conflicts: className, onKeyDown, onKeyPress. Inlined open, defaultOpen, onToggle, containerClassName, dropUp, popupProps, popupTransition, popupComponent
  - typings.reactWidgets.sharedMod.WidgetProps because var conflicts: className, id, tabIndex. Inlined autoFocus, messages */ trait ComboboxProps[TDataItem]
    extends StObject
  ...
  object ComboboxProps {
    ...
    extension [Self <: ComboboxProps[?], TDataItem](x: Self & ComboboxProps[TDataItem]) {
      ...
      inline def setOnChange(value: (TDataItem | String, /* metadata */ Source) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
  ...
  /* This means you don't have to write `default`, but can instead just say `comboboxMod.foo` */
