...
object cjsAddToListOptionMod {
  ...
  object default {
    ...
    object propTypes {
      ...
      @JSImport("react-widgets/cjs/AddToListOption", "default.propTypes")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("react-widgets/cjs/AddToListOption", "default.propTypes.activeId")
      @js.native
      ...
      @JSImport("react-widgets/cjs/AddToListOption", "default.propTypes.focused")
      @js.native
      ...
      @JSImport("react-widgets/cjs/AddToListOption", "default.propTypes.onSelect")
      @js.native
      ...
      @JSImport("react-widgets/cjs/AddToListOption", "default.propTypes.searchTerm")
      @js.native
