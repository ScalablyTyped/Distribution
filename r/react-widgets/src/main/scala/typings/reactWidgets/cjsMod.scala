...
import typings.reactWidgets.cjsCalendarMod.CalendarProps
import typings.reactWidgets.cjsCalendarMod.Direction
import typings.reactWidgets.cjsCalendarMod.View
import typings.reactWidgets.cjsDatePickerMod.DatePickerHandle
import typings.reactWidgets.cjsDatePickerMod.DatePickerProps
import typings.reactWidgets.cjsLocalizationMod.FormatterOverrides
import typings.reactWidgets.cjsLocalizationMod.Localizer
import typings.reactWidgets.cjsLocalizationMod.ProviderProps
import typings.reactWidgets.cjsNumberPickerMod.NumberPickerProps
import typings.reactWidgets.cjsSlideDownTransitionMod.default
import typings.reactWidgets.cjsSlideTransitionGroupMod.SlideTransitionGroupProps
import typings.reactWidgets.cjsTimeInputMod.TimeInputProps
...
object cjsMod {
  ...
  object Calendar {
    ...
    open class Transition protected ()
      extends typings.reactWidgets.cjsCalendarMod.default.Transition {
  ...
  @js.native
  val Combobox: typings.reactWidgets.cjsComboboxMod.Combobox = js.native
  ...
  @js.native
  val DropdownList: typings.reactWidgets.cjsDropdownListMod.DropdownList = js.native
  
  @JSImport("react-widgets/cjs", "Listbox")
  @js.native
  val Listbox: typings.reactWidgets.cjsListboxMod.Listbox = js.native
  ...
  @js.native
  val Multiselect: typings.reactWidgets.cjsMultiselectMod.Multiselect = js.native
  ...
  open class SlideTransitionGroup protected ()
    extends typings.reactWidgets.cjsSlideTransitionGroupMod.default {
    def this(args: SlideTransitionGroupProps) = this()
  }
