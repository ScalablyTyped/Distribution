...
import typings.reactWidgets.cjsDropdownListInputMod.RenderValueProp
import typings.reactWidgets.cjsPopupMod.PopupProps
import typings.reactWidgets.cjsSharedMod.BaseListboxInputProps
import typings.reactWidgets.cjsSharedMod.Filterable
import typings.reactWidgets.cjsSharedMod.Searchable
import typings.reactWidgets.cjsSharedMod.WidgetProps
...
object cjsDropdownListMod extends Shortcut {
  
  /**
    * A `<select>` replacement for single value lists.
    * @public
    */
  @JSImport("react-widgets/cjs/DropdownList", JSImport.Default)
  @js.native
  ...
  - typings.reactWidgets.cjsSharedMod.PopupWidgetProps because var conflicts: className, onKeyDown, onKeyPress. Inlined open, defaultOpen, onToggle, containerClassName, dropUp, popupProps, popupTransition, popupComponent
  - typings.reactWidgets.cjsSharedMod.WidgetHTMLProps because var conflicts: className, id, tabIndex. Inlined suppressContentEditableWarning, suppressHydrationWarning, accessKey, contextMenu, dir, hidden, lang, style, title, role, onFocus, onFocusCapture, onBlur, onBlurCapture, onKeyDown, onKeyDownCapture, onKeyPress, onKeyPressCapture, onKeyUp, onKeyUpCapture, onAuxClick, onAuxClickCapture, onClick, onClickCapture, onContextMenu, onContextMenuCapture, onDoubleClick, onDoubleClickCapture, onDrag, onDragCapture, onDragEnd, onDragEndCapture, onDragEnter, onDragEnterCapture, onDragExit, onDragExitCapture, onDragLeave, onDragLeaveCapture, onDragOver, onDragOverCapture, onDragStart, onDragStartCapture, onDrop, onDropCapture, onMouseDown, onMouseDownCapture, onMouseEnter, onMouseLeave, onMouseMove, onMouseMoveCapture, onMouseOut, onMouseOutCapture, onMouseOver, onMouseOverCapture, onMouseUp, onMouseUpCapture, onTouchCancel, onTouchCancelCapture, onTouchEnd, onTouchEndCapture, onTouchMove, onTouchMoveCapture, onTouchStart, onTouchStartCapture, onPointerDown, onPointerDownCapture, onPointerMove, onPointerMoveCapture, onPointerUp, onPointerUpCapture, onPointerCancel, onPointerCancelCapture, onPointerEnter, onPointerEnterCapture, onPointerLeave, onPointerLeaveCapture, onPointerOver, onPointerOverCapture, onPointerOut, onPointerOutCapture, onGotPointerCapture, onGotPointerCaptureCapture, onLostPointerCapture, onLostPointerCaptureCapture, onScroll, onScrollCapture, onWheel, onWheelCapture, onAnimationStart, onAnimationStartCapture, onAnimationEnd, onAnimationEndCapture, onAnimationIteration, onAnimationIterationCapture, onTransitionEnd, onTransitionEndCapture */ trait DropdownProps[TDataItem]
    extends StObject
       with WidgetProps
       with Searchable
  ...
  /* This means you don't have to write `default`, but can instead just say `cjsDropdownListMod.foo` */
