...
object propTypesMod {
  ...
  @JSImport("react-widgets/cjs/PropTypes", "accessor")
  @js.native
  ...
  object disabled {
    ...
    @JSImport("react-widgets/cjs/PropTypes", "disabled")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("react-widgets/cjs/PropTypes", "disabled.acceptsArray")
    @js.native
  ...
  @JSImport("react-widgets/cjs/PropTypes", "elementType")
  @js.native
  val elementType: Requireable[ReactComponentLike] = js.native
  
  @JSImport("react-widgets/cjs/PropTypes", "message")
  @js.native
