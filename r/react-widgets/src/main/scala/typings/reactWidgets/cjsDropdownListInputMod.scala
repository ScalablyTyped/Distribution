...
import typings.reactWidgets.cjsAccessorsMod.DataKeyAccessorFn
...
object cjsDropdownListInputMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `cjsDropdownListInputMod.foo` */
