...
import typings.reactWidgets.dropdownListInputMod.RenderValueProp
...
import typings.reactWidgets.sharedMod.Searchable
import typings.reactWidgets.sharedMod.WidgetProps
...
object dropdownListMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `dropdownListMod.foo` */
