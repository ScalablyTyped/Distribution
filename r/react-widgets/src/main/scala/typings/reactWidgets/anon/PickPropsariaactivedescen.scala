...
object PickPropsariaactivedescen {
  ...
  inline def apply(max: Double, min: Double, onChange: ChangeEvent[HTMLInputElement] => Unit): PickPropsariaactivedescen = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickPropsariaactivedescen] (val x: Self) extends AnyVal {
