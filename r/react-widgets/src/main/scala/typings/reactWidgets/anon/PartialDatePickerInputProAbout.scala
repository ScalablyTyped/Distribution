...
/* Inlined std.Partial<react-widgets.react-widgets/esm/DatePickerInput.DatePickerInputProps<unknown>> */
trait PartialDatePickerInputProAbout extends StObject {
  ...
  var displayFormat: js.UndefOr[Any] = js.undefined
  
  var download: js.UndefOr[Any] = js.undefined
  
  var draggable: js.UndefOr[Booleanish] = js.undefined
  
  var editFormat: js.UndefOr[Any] = js.undefined
  ...
  var formatter: js.UndefOr[RequiredDateMethods] = js.undefined
  ...
  var onChange: js.UndefOr[js.Function2[/* date */ js.Date | Null, /* rawValue */ String, Unit]] = js.undefined
  ...
  var parse: js.UndefOr[js.Function1[/* str */ String, js.Date | Null]] = js.undefined
...
object PartialDatePickerInputProAbout {
  
  inline def apply(): PartialDatePickerInputProAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDatePickerInputProAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialDatePickerInputProAbout] (val x: Self) extends AnyVal {
    ...
    inline def setDisplayFormat(value: Any): Self = StObject.set(x, "displayFormat", value.asInstanceOf[js.Any])
    ...
    inline def setEditFormat(value: Any): Self = StObject.set(x, "editFormat", value.asInstanceOf[js.Any])
    
    inline def setEditFormatUndefined: Self = StObject.set(x, "editFormat", js.undefined)
    ...
    inline def setFormatter(value: RequiredDateMethods): Self = StObject.set(x, "formatter", value.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: (/* date */ js.Date | Null, /* rawValue */ String) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
    ...
    inline def setParse(value: /* str */ String => js.Date | Null): Self = StObject.set(x, "parse", js.Any.fromFunction1(value))
