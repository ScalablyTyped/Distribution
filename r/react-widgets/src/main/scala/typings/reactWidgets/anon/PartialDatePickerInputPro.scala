...
/* Inlined std.Partial<react-widgets.react-widgets/cjs/DatePickerInput.DatePickerInputProps<unknown>> */
trait PartialDatePickerInputPro extends StObject {
...
object PartialDatePickerInputPro {
  
  inline def apply(): PartialDatePickerInputPro = {
