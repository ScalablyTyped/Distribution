...
trait OriginalEventSearchTerm[TDataItem] extends StObject {
...
object OriginalEventSearchTerm {
  
  inline def apply[TDataItem](action: insert | remove, dataItem: TDataItem, lastValue: Value): OriginalEventSearchTerm[TDataItem] = {
