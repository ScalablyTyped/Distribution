...
trait PickHTMLPropsHTMLInputEle extends StObject {
  ...
  /**
    ...
    */
  var ref: js.UndefOr[typings.react.mod.Ref[HTMLInputElement]] = js.undefined
...
object PickHTMLPropsHTMLInputEle {
  
  inline def apply(): PickHTMLPropsHTMLInputEle = {
  ...
  implicit open class MutableBuilder[Self <: PickHTMLPropsHTMLInputEle] (val x: Self) extends AnyVal {
    ...
    inline def setRef(value: typings.react.mod.Ref[HTMLInputElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
