...
/* Inlined std.Partial<react-widgets.react-widgets/esm/TimeInput.TimeInputProps> */
trait PartialTimeInputProps extends StObject {
  ...
  var precision: js.UndefOr[minutes | seconds | milliseconds] = js.undefined
...
object PartialTimeInputProps {
  
  inline def apply(): PartialTimeInputProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTimeInputProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialTimeInputProps] (val x: Self) extends AnyVal {
