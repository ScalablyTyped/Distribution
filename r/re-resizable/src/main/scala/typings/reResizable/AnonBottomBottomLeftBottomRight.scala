...
trait AnonBottomBottomLeftBottomRight extends js.Object {
...
object AnonBottomBottomLeftBottomRight {
  @scala.inline
  def apply(
  ...
  ): AnonBottomBottomLeftBottomRight = {
    ...
    __obj.asInstanceOf[AnonBottomBottomLeftBottomRight]
  }
}
