...
trait Anon_BottomBottomLeftBottomRight extends js.Object {
...
object Anon_BottomBottomLeftBottomRight {
  @scala.inline
  def apply(
  ...
  ): Anon_BottomBottomLeftBottomRight = {
    ...
    __obj.asInstanceOf[Anon_BottomBottomLeftBottomRight]
  }
}
