...
object ResizableProps {
  ...
  def apply(
    ...
    onResizeStart: (/* e */ (MouseEvent[HTMLDivElement, NativeMouseEvent]) | typings.react.reactMod.TouchEvent[HTMLDivElement], /* dir */ ResizableDirection, /* elementRef */ HTMLDivElement, /* delta */ NumberSize) => Unit = null,
    ...
    onTouchCancel: typings.react.reactMod.TouchEvent[HTMLDivElement] => Unit = null,
    onTouchEnd: typings.react.reactMod.TouchEvent[HTMLDivElement] => Unit = null,
    onTouchMove: typings.react.reactMod.TouchEvent[HTMLDivElement] => Unit = null,
    onTouchStart: typings.react.reactMod.TouchEvent[HTMLDivElement] => Unit = null,
