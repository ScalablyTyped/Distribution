...
object IGesture {
  ...
  def apply(
    ...
    onTouchCancel: reactLib.reactMod.ReactNs.TouchEventHandler[reactLib.HTMLElement] = null,
    onTouchEnd: reactLib.reactMod.ReactNs.TouchEventHandler[reactLib.HTMLElement] = null,
    onTouchMove: reactLib.reactMod.ReactNs.TouchEventHandler[reactLib.HTMLElement] = null,
    onTouchStart: reactLib.reactMod.ReactNs.TouchEventHandler[reactLib.HTMLElement] = null
  ): IGesture = {
