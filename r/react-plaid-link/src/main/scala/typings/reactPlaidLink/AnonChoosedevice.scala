...
trait AnonChoosedevice extends js.Object {
  var institution: AnonInstitutionidName
...
object AnonChoosedevice {
  @scala.inline
  def apply(
    institution: AnonInstitutionidName,
    ...
    __obj.asInstanceOf[AnonChoosedevice]
  }
}
