...
/* Rewritten from type alias, can be one of: 
  - typings.reactPlaidLink.indexUmdMinMod.PlaidLinkOptionsWithPublicKey
  - typings.reactPlaidLink.indexUmdMinMod.PlaidLinkOptionsWithLinkToken
*/
trait PlaidLinkOptions extends StObject
object PlaidLinkOptions {
  
  inline def PlaidLinkOptionsWithLinkToken(onSuccess: (/* public_token */ String, /* metadata */ PlaidLinkOnSuccessMetadata) => Unit): typings.reactPlaidLink.indexUmdMinMod.PlaidLinkOptionsWithLinkToken = {
    val __obj = js.Dynamic.literal(onSuccess = js.Any.fromFunction2(onSuccess), token = null)
    __obj.asInstanceOf[typings.reactPlaidLink.indexUmdMinMod.PlaidLinkOptionsWithLinkToken]
  }
  ...
  inline def PlaidLinkOptionsWithPublicKey(
    ...
    __obj.asInstanceOf[typings.reactPlaidLink.indexUmdMinMod.PlaidLinkOptionsWithPublicKey]
  }
}
