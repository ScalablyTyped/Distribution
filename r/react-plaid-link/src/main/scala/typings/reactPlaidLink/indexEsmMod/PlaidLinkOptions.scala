...
/* Rewritten from type alias, can be one of: 
  - typings.reactPlaidLink.indexEsmMod.PlaidLinkOptionsWithPublicKey
  - typings.reactPlaidLink.indexEsmMod.PlaidLinkOptionsWithLinkToken
*/
trait PlaidLinkOptions extends StObject
object PlaidLinkOptions {
  
  inline def PlaidLinkOptionsWithLinkToken(onSuccess: (/* public_token */ String, /* metadata */ PlaidLinkOnSuccessMetadata) => Unit): typings.reactPlaidLink.indexEsmMod.PlaidLinkOptionsWithLinkToken = {
    val __obj = js.Dynamic.literal(onSuccess = js.Any.fromFunction2(onSuccess), token = null)
    __obj.asInstanceOf[typings.reactPlaidLink.indexEsmMod.PlaidLinkOptionsWithLinkToken]
  }
  ...
  inline def PlaidLinkOptionsWithPublicKey(
    ...
    __obj.asInstanceOf[typings.reactPlaidLink.indexEsmMod.PlaidLinkOptionsWithPublicKey]
  }
}
