...
object ReadWriteSelectorFamilyOptions {
  ...
  @scala.inline
  implicit class ReadWriteSelectorFamilyOptionsOps[Self <: ReadWriteSelectorFamilyOptions[_, _], T, /* <: typings.recoil.mod.SerializableParam */ P] (val x: Self with (ReadWriteSelectorFamilyOptions[T, P])) extends AnyVal {
    @scala.inline
