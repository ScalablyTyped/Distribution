...
object RecoilLoadable {
  ...
  /**
    ...
    */
  inline def all[Inputs /* <: js.Array[Any | Loadable[Any]] */](inputs: Inputs): Loadable[UnwrapLoadables[Inputs]] = ^.asInstanceOf[js.Dynamic].applyDynamic("all")(inputs.asInstanceOf[js.Any]).asInstanceOf[Loadable[UnwrapLoadables[Inputs]]]
