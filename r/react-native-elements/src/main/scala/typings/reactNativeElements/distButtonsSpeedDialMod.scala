...
import typings.reactNativeElements.anon.ForwardRefExoticComponentCall
import typings.reactNativeElements.anon.FunctionComponentPickisOp
...
object distButtonsSpeedDialMod extends Shortcut {
  
  @JSImport("react-native-elements/dist/buttons/SpeedDial", JSImport.Default)
  @js.native
  val default: FunctionComponentPickisOp | ForwardRefExoticComponentCall = js.native
  
  @JSImport("react-native-elements/dist/buttons/SpeedDial", "SpeedDial")
  @js.native
  val SpeedDial: RneFunctionComponent[SpeedDialProps] = js.native
  
  /* Inlined std.Omit<react-native-elements.react-native-elements/dist/buttons/FAB.FABProps, 'size'> */
  ...
  type _To = FunctionComponentPickisOp | ForwardRefExoticComponentCall
  
  /* This means you don't have to write `default`, but can instead just say `distButtonsSpeedDialMod.foo` */
  override def _to: FunctionComponentPickisOp | ForwardRefExoticComponentCall = default
}
