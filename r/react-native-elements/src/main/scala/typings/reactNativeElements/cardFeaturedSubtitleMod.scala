...
object cardFeaturedSubtitleMod extends Shortcut {
  
  @JSImport("react-native-elements/dist/card/CardFeaturedSubtitle", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `cardFeaturedSubtitleMod.foo` */
