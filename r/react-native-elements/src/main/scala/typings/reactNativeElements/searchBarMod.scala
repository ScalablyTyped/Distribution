...
import typings.reactNativeElements.searchBarAndroidMod.SearchBarAndroidProps
import typings.reactNativeElements.searchBarDefaultMod.SearchBarDefaultProps
import typings.reactNativeElements.searchBarIosMod.SearchBarIosProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object searchBarMod extends Shortcut {
  ...
  open class SearchBar protected ()
    ...
    var searchbar: typings.reactNativeElements.searchBarIosMod.default = js.native
  }
  object SearchBar {
  ...
  /* This means you don't have to write `default`, but can instead just say `searchBarMod.foo` */
