...
object ListItem {
  ...
  @scala.inline
  def ButtonGroup_=(x: ComponentType[ButtonGroupProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ButtonGroup")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-elements", "ListItem.CheckBox")
  @js.native
  def CheckBox: ComponentType[CheckBoxProps] = js.native
  @scala.inline
  def CheckBox_=(x: ComponentType[CheckBoxProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CheckBox")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-elements", "ListItem.Chevron")
  @js.native
  def Chevron: ComponentType[PartialIconProps] = js.native
  @scala.inline
  def Chevron_=(x: ComponentType[PartialIconProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Chevron")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-elements", "ListItem.Content")
  @js.native
  def Content: ComponentType[ViewPropertiesrightboolea] = js.native
  @scala.inline
  def Content_=(x: ComponentType[ViewPropertiesrightboolea]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Content")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-elements", "ListItem.Input")
  @js.native
  def Input: ComponentType[InputProps] = js.native
  @scala.inline
  def Input_=(x: ComponentType[InputProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Input")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-elements", "ListItem.Subtitle")
  @js.native
  def Subtitle: ComponentType[TextPropsrightbooleanunde] = js.native
  @scala.inline
  def Subtitle_=(x: ComponentType[TextPropsrightbooleanunde]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Subtitle")(x.asInstanceOf[js.Any])
  
  @JSImport("react-native-elements", "ListItem.Title")
  @js.native
  def Title: ComponentType[TextPropsrightbooleanunde] = js.native
  @scala.inline
  def Title_=(x: ComponentType[TextPropsrightbooleanunde]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Title")(x.asInstanceOf[js.Any])
}
