...
object distButtonsChipMod extends Shortcut {
  
  @JSImport("react-native-elements/dist/buttons/Chip", JSImport.Default)
  @js.native
  val default: FunctionComponent[PickChipPropsstyleonLayou] | ForwardRefExoticComponent[ChipProps] = js.native
  
  @JSImport("react-native-elements/dist/buttons/Chip", "Chip")
  @js.native
  val Chip: RneFunctionComponent[ChipProps] = js.native
  
  /* Inlined std.Omit<react-native-elements.react-native-elements/dist/buttons/Button.ButtonProps, 'loading' | 'loadingStyle' | 'loadingProps'> & {  type :'solid' | 'outline' | undefined} */
  ...
  type _To = FunctionComponent[PickChipPropsstyleonLayou] | ForwardRefExoticComponent[ChipProps]
  
  /* This means you don't have to write `default`, but can instead just say `distButtonsChipMod.foo` */
  override def _to: FunctionComponent[PickChipPropsstyleonLayou] | ForwardRefExoticComponent[ChipProps] = default
}
