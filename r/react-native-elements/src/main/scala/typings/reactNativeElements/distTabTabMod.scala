...
import typings.reactNativeElements.anon.ForwardRefExoticComponentDisplayName
import typings.reactNativeElements.anon.FunctionComponentPickView
...
object distTabTabMod extends Shortcut {
  ...
  @js.native
  val Tab: typings.reactNativeElements.distTabTabMod.Tab = js.native
  ...
  trait TabItemProps extends StObject {
    ...
    var variant: js.UndefOr[primary | typings.reactNativeElements.reactNativeElementsStrings.default] = js.undefined
  }
  object TabItemProps {
    ...
    implicit open class MutableBuilder[Self <: TabItemProps] (val x: Self) extends AnyVal {
      ...
      inline def setVariant(value: primary | typings.reactNativeElements.reactNativeElementsStrings.default): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
