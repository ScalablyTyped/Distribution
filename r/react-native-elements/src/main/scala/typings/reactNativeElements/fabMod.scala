...
object fabMod extends Shortcut {
  ...
  @JSImport("react-native-elements/dist/buttons/FAB", JSImport.Default)
  @js.native
  val default: FunctionComponent[PicktitlestringReactEleme] | ForwardRefExoticComponent[titlestringReactElementun] = js.native
  
  @JSImport("react-native-elements/dist/buttons/FAB", "FAB")
  @js.native
  val FAB: RneFunctionComponent[FABProps] = js.native
  
  /* Inlined react-native-elements.react-native-elements/dist/buttons/Button.ButtonProps & {  color :string | undefined,   size :'large' | 'small' | undefined,   placement :'left' | 'right' | undefined,   visible :boolean | undefined,   upperCase :boolean | undefined} */
  ...
  type _To = FunctionComponent[PicktitlestringReactEleme] | ForwardRefExoticComponent[titlestringReactElementun]
  
  /* This means you don't have to write `default`, but can instead just say `fabMod.foo` */
  override def _to: FunctionComponent[PicktitlestringReactEleme] | ForwardRefExoticComponent[titlestringReactElementun] = default
}
