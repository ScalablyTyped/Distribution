...
object listItemSwipeableMod extends Shortcut {
  
  @JSImport("react-native-elements/dist/list/ListItemSwipeable", JSImport.Default)
  @js.native
  val default: RneFunctionComponent[ListItemSwipeableProps] = js.native
  
  /* Inlined react-native-elements.react-native-elements/dist/list/ListItemBase.ListItemProps & {  leftContent :react.react.ReactNode | undefined,   rightContent :react.react.ReactNode | undefined,   leftStyle :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   rightStyle :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   leftWidth :number | undefined,   rightWidth :number | undefined} */
  trait ListItemSwipeableProps extends StObject {
  ...
  object ListItemSwipeableProps {
    
    inline def apply(): ListItemSwipeableProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ListItemSwipeableProps]
    }
    
    extension [Self <: ListItemSwipeableProps](x: Self) {
  ...
  type _To = RneFunctionComponent[ListItemSwipeableProps]
  
  /* This means you don't have to write `default`, but can instead just say `listItemSwipeableMod.foo` */
  override def _to: RneFunctionComponent[ListItemSwipeableProps] = default
}
