...
trait RecursivePartialPartialAvActiveOpacity extends StObject {
...
object RecursivePartialPartialAvActiveOpacity {
  
  inline def apply(): RecursivePartialPartialAvActiveOpacity = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialAvActiveOpacity]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialAvActiveOpacity] (val x: Self) extends AnyVal {
