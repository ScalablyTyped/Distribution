...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/buttons/FAB.FABProps>> */
trait RecursivePartialPartialFAAccessibilityActions extends StObject {
...
object RecursivePartialPartialFAAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialFAAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialFAAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialFAAccessibilityActions] (val x: Self) extends AnyVal {
