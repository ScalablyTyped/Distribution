...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/linearProgress/LinearProgress.LinearProgressProps> */
trait ThemeLinearProgressProps extends StObject {
...
object ThemeLinearProgressProps {
  
  inline def apply(): ThemeLinearProgressProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeLinearProgressProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeLinearProgressProps] (val x: Self) extends AnyVal {
