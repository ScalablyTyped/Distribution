...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native.react-native.ViewProps>> */
trait RecursivePartialPartialViAccessibilityActions extends StObject {
...
object RecursivePartialPartialViAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialViAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialViAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialViAccessibilityActions] (val x: Self) extends AnyVal {
