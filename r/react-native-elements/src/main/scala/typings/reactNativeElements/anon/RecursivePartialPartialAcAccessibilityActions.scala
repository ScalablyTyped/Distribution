...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/avatar/Accessory.AccessoryProps>> */
trait RecursivePartialPartialAcAccessibilityActions extends StObject {
  ...
  var ImageComponent: js.UndefOr[RecursivePartial[js.UndefOr[ComponentType[Any]]]] = js.undefined
  ...
  var childrenContainerStyle: js.UndefOr[RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]] = js.undefined
...
object RecursivePartialPartialAcAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialAcAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialAcAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialAcAccessibilityActions] (val x: Self) extends AnyVal {
    ...
    inline def setChildrenContainerStyle(value: RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]): Self = StObject.set(x, "childrenContainerStyle", value.asInstanceOf[js.Any])
    ...
    inline def setIconProps(value: RecursivePartial[js.UndefOr[IconProps]]): Self = StObject.set(x, "iconProps", value.asInstanceOf[js.Any])
    
    inline def setIconPropsUndefined: Self = StObject.set(x, "iconProps", js.undefined)
    
    inline def setIconStyle(value: RecursivePartial[js.UndefOr[TextStyle]]): Self = StObject.set(x, "iconStyle", value.asInstanceOf[js.Any])
    
    inline def setIconStyleUndefined: Self = StObject.set(x, "iconStyle", js.undefined)
    
    inline def setImageComponent(value: RecursivePartial[js.UndefOr[ComponentType[Any]]]): Self = StObject.set(x, "ImageComponent", value.asInstanceOf[js.Any])
    ...
    inline def setName(value: RecursivePartial[js.UndefOr[String]]): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    ...
    inline def setReverseColor(value: RecursivePartial[js.UndefOr[String]]): Self = StObject.set(x, "reverseColor", value.asInstanceOf[js.Any])
    ...
    inline def setSolid(value: RecursivePartial[js.UndefOr[Boolean]]): Self = StObject.set(x, "solid", value.asInstanceOf[js.Any])
