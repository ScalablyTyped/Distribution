...
object PartialListItemPropsAccessibilityActions {
  ...
  inline def apply(): PartialListItemPropsAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialListItemPropsAccessibilityActions]
  }
  
  extension [Self <: PartialListItemPropsAccessibilityActions](x: Self) {
    ...
    inline def setLeftAvatar(value: PartialAvatarPropsActiveOpacity | ReactElement): Self = StObject.set(x, "leftAvatar", value.asInstanceOf[js.Any])
    ...
    inline def setRightAvatar(value: PartialAvatarPropsActiveOpacity | ReactElement): Self = StObject.set(x, "rightAvatar", value.asInstanceOf[js.Any])
