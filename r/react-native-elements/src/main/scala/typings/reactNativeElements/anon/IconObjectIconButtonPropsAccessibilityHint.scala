...
trait IconObjectIconButtonPropsAccessibilityHint extends StObject {
...
object IconObjectIconButtonPropsAccessibilityHint {
  ...
  inline def apply(
  ...
  ): IconObjectIconButtonPropsAccessibilityHint = {
    ...
    __obj.asInstanceOf[IconObjectIconButtonPropsAccessibilityHint]
  }
  
  extension [Self <: IconObjectIconButtonPropsAccessibilityHint](x: Self) {
