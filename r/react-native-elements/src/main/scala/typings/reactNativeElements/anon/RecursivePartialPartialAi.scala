...
object RecursivePartialPartialAi {
  ...
  inline def apply(): RecursivePartialPartialAi = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialAi]
  }
  
  extension [Self <: RecursivePartialPartialAi](x: Self) {
    ...
    inline def setOnFinishRating(value: RecursivePartial[js.UndefOr[js.Function1[/* value */ Double, Unit]]]): Self = StObject.set(x, "onFinishRating", value.asInstanceOf[js.Any])
    ...
    inline def setStarStyle(value: RecursivePartial[js.UndefOr[ImageStyle]]): Self = StObject.set(x, "starStyle", value.asInstanceOf[js.Any])
