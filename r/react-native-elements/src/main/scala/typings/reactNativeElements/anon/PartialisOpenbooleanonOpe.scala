...
object PartialisOpenbooleanonOpe {
  
  inline def apply(): PartialisOpenbooleanonOpe = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialisOpenbooleanonOpe]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialisOpenbooleanonOpe] (val x: Self) extends AnyVal {
