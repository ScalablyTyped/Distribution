...
trait WeakValidationMapisOpenbo extends StObject {
  ...
  var nextFocusDown: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  
  var nextFocusForward: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  
  var nextFocusLeft: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  
  var nextFocusRight: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  
  var nextFocusUp: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  ...
  var theme: js.UndefOr[Validator[js.UndefOr[Null | ThemeSpeedDialProps]]] = js.undefined
...
object WeakValidationMapisOpenbo {
  
  inline def apply(): WeakValidationMapisOpenbo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapisOpenbo]
  }
  
  extension [Self <: WeakValidationMapisOpenbo](x: Self) {
    ...
    inline def setNextFocusDown(value: Validator[js.UndefOr[Double | Null]]): Self = StObject.set(x, "nextFocusDown", value.asInstanceOf[js.Any])
    
    inline def setNextFocusDownUndefined: Self = StObject.set(x, "nextFocusDown", js.undefined)
    
    inline def setNextFocusForward(value: Validator[js.UndefOr[Double | Null]]): Self = StObject.set(x, "nextFocusForward", value.asInstanceOf[js.Any])
    
    inline def setNextFocusForwardUndefined: Self = StObject.set(x, "nextFocusForward", js.undefined)
    
    inline def setNextFocusLeft(value: Validator[js.UndefOr[Double | Null]]): Self = StObject.set(x, "nextFocusLeft", value.asInstanceOf[js.Any])
    
    inline def setNextFocusLeftUndefined: Self = StObject.set(x, "nextFocusLeft", js.undefined)
    
    inline def setNextFocusRight(value: Validator[js.UndefOr[Double | Null]]): Self = StObject.set(x, "nextFocusRight", value.asInstanceOf[js.Any])
    
    inline def setNextFocusRightUndefined: Self = StObject.set(x, "nextFocusRight", js.undefined)
    
    inline def setNextFocusUp(value: Validator[js.UndefOr[Double | Null]]): Self = StObject.set(x, "nextFocusUp", value.asInstanceOf[js.Any])
    ...
    inline def setTheme(value: Validator[js.UndefOr[Null | ThemeSpeedDialProps]]): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
