...
/* Inlined react-native-elements.react-native-elements/dist/config/ThemeProvider.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/tile/Tile.TileProps>> */
trait RecursivePartialPartialTiAccessibilityActions extends StObject {
    ...
    RecursivePartial[
      js.UndefOr[
        TypeofComponent & (Instantiable1[
          ...
          Component[
            typings.reactNativeElements.reactNativeElementsStrings.ImageComponent, 
            js.Object, 
            js.Object
          ]
        ])
  ...
  var caption: js.UndefOr[RecursivePartial[js.UndefOr[ReactNode]]] = js.undefined
  ...
  var icon: js.UndefOr[RecursivePartial[js.UndefOr[IconObject & IconProps]]] = js.undefined
  ...
  var imageProps: js.UndefOr[RecursivePartial[js.UndefOr[PartialImagePropsAccessibilityActions]]] = js.undefined
  
  var imageSrc: js.UndefOr[RecursivePartial[js.UndefOr[ImageSourcePropType | String | Double]]] = js.undefined
  ...
  var titleNumberOfLines: js.UndefOr[RecursivePartial[js.UndefOr[Double]]] = js.undefined
...
object RecursivePartialPartialTiAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialTiAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialTiAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialTiAccessibilityActions] (val x: Self) extends AnyVal {
    ...
    inline def setCaption(value: RecursivePartial[js.UndefOr[ReactNode]]): Self = StObject.set(x, "caption", value.asInstanceOf[js.Any])
    
    inline def setCaptionStyle(value: RecursivePartial[js.UndefOr[StyleProp[TextStyle]]]): Self = StObject.set(x, "captionStyle", value.asInstanceOf[js.Any])
    ...
    inline def setFeatured(value: RecursivePartial[js.UndefOr[Boolean]]): Self = StObject.set(x, "featured", value.asInstanceOf[js.Any])
    ...
    inline def setIcon(value: RecursivePartial[js.UndefOr[IconObject & IconProps]]): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
    ...
    inline def setImageContainerStyle(value: RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]): Self = StObject.set(x, "imageContainerStyle", value.asInstanceOf[js.Any])
    
    inline def setImageContainerStyleUndefined: Self = StObject.set(x, "imageContainerStyle", js.undefined)
    
    inline def setImageProps(value: RecursivePartial[js.UndefOr[PartialImagePropsAccessibilityActions]]): Self = StObject.set(x, "imageProps", value.asInstanceOf[js.Any])
    
    inline def setImagePropsUndefined: Self = StObject.set(x, "imageProps", js.undefined)
    
    inline def setImageSrc(value: RecursivePartial[js.UndefOr[ImageSourcePropType | String | Double]]): Self = StObject.set(x, "imageSrc", value.asInstanceOf[js.Any])
    ...
    inline def setTitleNumberOfLines(value: RecursivePartial[js.UndefOr[Double]]): Self = StObject.set(x, "titleNumberOfLines", value.asInstanceOf[js.Any])
