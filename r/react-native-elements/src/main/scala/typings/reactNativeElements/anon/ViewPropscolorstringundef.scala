...
trait ViewPropscolorstringundef extends StObject {
  ...
  var theme: js.UndefOr[ThemeDividerProps] = js.undefined
...
object ViewPropscolorstringundef {
  
  inline def apply(): ViewPropscolorstringundef = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ViewPropscolorstringundef]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ViewPropscolorstringundef] (val x: Self) extends AnyVal {
    ...
    inline def setTheme(value: ThemeDividerProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
