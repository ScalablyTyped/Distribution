...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/buttons/FAB.FABProps> */
trait ThemeFABProps extends StObject {
...
object ThemeFABProps {
  
  inline def apply(): ThemeFABProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeFABProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeFABProps] (val x: Self) extends AnyVal {
