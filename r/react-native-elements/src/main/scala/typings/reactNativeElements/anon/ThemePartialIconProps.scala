...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<std.Partial<react-native-elements.react-native-elements.IconProps>> */
trait ThemePartialIconProps extends StObject {
...
object ThemePartialIconProps {
  
  inline def apply(): ThemePartialIconProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemePartialIconProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemePartialIconProps] (val x: Self) extends AnyVal {
