...
/* Inlined {  containerStyle :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   disabledStyle :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   topDivider :boolean | undefined,   bottomDivider :boolean | undefined,   pad :number | undefined,   Component :typeof React.Component | undefined,   ViewComponent :typeof React.Component | undefined,   linearGradientProps :any | undefined,   children :any | undefined,   isExpanded :boolean | undefined,   icon :react-native-elements.react-native-elements/dist/icons/Icon.IconNode | undefined,   expandIcon :react-native-elements.react-native-elements/dist/icons/Icon.IconNode | undefined,   content :react.react.ReactNode | undefined,   noRotation :boolean | undefined,   noIcon :boolean | undefined,   animation :boolean | {  type :'spring' | 'timing' | undefined,   duration :number | undefined} | undefined} & react-native.react-native.TouchableHighlightProps & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/list/ListItemAccordion.ListItemAccordionProps>> */
trait containerStyleStylePropViAccessibilityActions extends StObject {
