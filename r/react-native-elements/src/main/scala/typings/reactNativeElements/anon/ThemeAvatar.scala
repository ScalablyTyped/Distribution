...
trait ThemeAvatar extends StObject {
...
object ThemeAvatar {
  ...
  inline def apply(): ThemeAvatar = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeAvatar]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeAvatar] (val x: Self) extends AnyVal {
