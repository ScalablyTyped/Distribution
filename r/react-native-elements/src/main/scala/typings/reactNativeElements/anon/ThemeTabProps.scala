...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/tab/Tab.TabProps> */
trait ThemeTabProps extends StObject {
...
object ThemeTabProps {
  
  inline def apply(): ThemeTabProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeTabProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeTabProps] (val x: Self) extends AnyVal {
