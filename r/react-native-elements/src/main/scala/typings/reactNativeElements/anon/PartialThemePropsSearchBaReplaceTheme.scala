...
trait PartialThemePropsSearchBaReplaceTheme extends StObject {
  ...
  var theme: js.UndefOr[typings.reactNativeElements.themeMod.Theme[SearchBarDefaultProps]] = js.undefined
...
object PartialThemePropsSearchBaReplaceTheme {
  ...
  extension [Self <: PartialThemePropsSearchBaReplaceTheme](x: Self) {
    ...
    inline def setTheme(value: typings.reactNativeElements.themeMod.Theme[SearchBarDefaultProps]): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
