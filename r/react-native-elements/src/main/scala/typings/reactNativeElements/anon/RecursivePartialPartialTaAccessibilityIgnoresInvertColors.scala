...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/tab/Tab.TabItemProps>> */
trait RecursivePartialPartialTaAccessibilityIgnoresInvertColors extends StObject {
  ...
  var active: js.UndefOr[RecursivePartial[js.UndefOr[Boolean]]] = js.undefined
...
object RecursivePartialPartialTaAccessibilityIgnoresInvertColors {
  
  inline def apply(): RecursivePartialPartialTaAccessibilityIgnoresInvertColors = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialTaAccessibilityIgnoresInvertColors]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialTaAccessibilityIgnoresInvertColors] (val x: Self) extends AnyVal {
    ...
    inline def setActive(value: RecursivePartial[js.UndefOr[Boolean]]): Self = StObject.set(x, "active", value.asInstanceOf[js.Any])
