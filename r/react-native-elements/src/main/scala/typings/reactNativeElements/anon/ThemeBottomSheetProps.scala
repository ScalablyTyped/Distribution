...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/bottomSheet/BottomSheet.BottomSheetProps> */
trait ThemeBottomSheetProps extends StObject {
...
object ThemeBottomSheetProps {
  
  inline def apply(): ThemeBottomSheetProps = {
