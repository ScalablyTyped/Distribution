...
/* Inlined react-native-elements.react-native-elements/dist/social/SocialIcon.SocialIconProps & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/social/SocialIcon.SocialIconProps>> */
trait SocialIconPropsPartialThe extends StObject {
  ...
  var theme: js.UndefOr[ThemeSocialIconProps] = js.undefined
...
object SocialIconPropsPartialThe {
  
  inline def apply(): SocialIconPropsPartialThe = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SocialIconPropsPartialThe]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SocialIconPropsPartialThe] (val x: Self) extends AnyVal {
    ...
    inline def setTheme(value: ThemeSocialIconProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
