...
/* Inlined react-native-elements.react-native-elements/dist/buttons/Button.ButtonProps & {  color :string | undefined,   onButtonPress :(): void | undefined} */
trait ButtonPropscolorstringund extends StObject {
...
object ButtonPropscolorstringund {
  
  inline def apply(): ButtonPropscolorstringund = {
