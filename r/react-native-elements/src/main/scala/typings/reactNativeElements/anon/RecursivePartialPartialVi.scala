...
/* Inlined react-native-elements.react-native-elements/dist/config/ThemeProvider.RecursivePartial<std.Partial<react-native.react-native.ViewProps>> */
trait RecursivePartialPartialVi extends StObject {
...
object RecursivePartialPartialVi {
  ...
  inline def apply(): RecursivePartialPartialVi = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialVi]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialVi] (val x: Self) extends AnyVal {
