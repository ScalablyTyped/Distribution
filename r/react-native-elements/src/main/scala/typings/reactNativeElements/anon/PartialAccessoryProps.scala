...
/* Inlined std.Partial<react-native-elements.react-native-elements/dist/avatar/Accessory.AccessoryProps> */
trait PartialAccessoryProps extends StObject {
...
object PartialAccessoryProps {
  
  inline def apply(): PartialAccessoryProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAccessoryProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialAccessoryProps] (val x: Self) extends AnyVal {
