...
/* Inlined react-native-elements.react-native-elements/dist/config/ThemeProvider.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/linearProgress.LinearProgressProps>> */
trait RecursivePartialPartialLiAccessibilityActions extends StObject {
  ...
  var color: js.UndefOr[RecursivePartial[js.UndefOr[primary | secondary | String]]] = js.undefined
  ...
  var trackColor: js.UndefOr[RecursivePartial[js.UndefOr[String]]] = js.undefined
  ...
  var variant: js.UndefOr[RecursivePartial[js.UndefOr[determinate | indeterminate]]] = js.undefined
}
object RecursivePartialPartialLiAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialLiAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialLiAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialLiAccessibilityActions] (val x: Self) extends AnyVal {
    ...
    inline def setColor(value: RecursivePartial[js.UndefOr[primary | secondary | String]]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    inline def setTrackColor(value: RecursivePartial[js.UndefOr[String]]): Self = StObject.set(x, "trackColor", value.asInstanceOf[js.Any])
    ...
    inline def setVariant(value: RecursivePartial[js.UndefOr[determinate | indeterminate]]): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
