...
/* Inlined std.Pick<react-native-vector-icons.react-native-vector-icons/Icon.IconButtonProps & {  type :string | undefined,   Component :{  contextType :react.react.Context<any> | undefined} & new <P = {}, S = {}, SS = any>(props : std.Readonly</ * import warning: RewrittenClass.unapply cls was tparam P * / any>): react.react.Component<P, S, SS> | undefined,   reverse :boolean | undefined,   raised :boolean | undefined,   containerStyle :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   iconProps :react-native-vector-icons.react-native-vector-icons/Icon.IconProps | undefined,   reverseColor :string | undefined,   disabled :boolean | undefined,   disabledStyle :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   solid :boolean | undefined,   brand :boolean | undefined} & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/icons/Icon.IconProps>>, 'style' | 'onLayout' | 'borderRadius' | 'testID' | 'accessible' | 'accessibilityActions' | 'accessibilityLabel' | 'accessibilityRole' | 'accessibilityState' | 'accessibilityHint' | 'accessibilityValue' | 'onAccessibilityAction' | 'accessibilityLiveRegion' | 'importantForAccessibility' | 'accessibilityElementsHidden' | 'accessibilityViewIsModal' | 'onAccessibilityEscape' | 'onAccessibilityTap' | 'onMagicTap' | 'accessibilityIgnoresInvertColors' | 'raised' | 'disabled' | 'color' | 'iconStyle' | 'backgroundColor' | 'size' | 'name' | 'allowFontScaling' | 'ellipsizeMode' | 'lineBreakMode' | 'numberOfLines' | 'onTextLayout' | 'onPress' | 'onLongPress' | 'nativeID' | 'maxFontSizeMultiplier' | 'adjustsFontSizeToFit' | 'minimumFontScale' | 'suppressHighlighting' | 'selectable' | 'selectionColor' | 'textBreakStrategy' | 'dataDetectorType' | 'activeOpacity' | 'onHideUnderlay' | 'onShowUnderlay' | 'underlayColor' | 'delayLongPress' | 'delayPressIn' | 'delayPressOut' | 'hitSlop' | 'onBlur' | 'onFocus' | 'onPressIn' | 'onPressOut' | 'pressRetentionOffset' | 'hasTVPreferredFocus' | 'tvParallaxProperties' | 'touchSoundDisabled' | 'background' | 'useForeground' | 'type' | 'Component' | 'reverse' | 'containerStyle' | 'iconProps' | 'reverseColor' | 'disabledStyle' | 'solid' | 'brand'> */
trait PickIconButtonPropstypest extends StObject {
...
object PickIconButtonPropstypest {
  
  inline def apply(name: String): PickIconButtonPropstypest = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickIconButtonPropstypest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickIconButtonPropstypest] (val x: Self) extends AnyVal {
