...
/* Inlined std.Partial<react-native-elements.react-native-elements/dist/buttons/SpeedDial.SpeedDialActionProps> */
trait PartialSpeedDialActionPro extends StObject {
...
object PartialSpeedDialActionPro {
  
  inline def apply(): PartialSpeedDialActionPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSpeedDialActionPro]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialSpeedDialActionPro] (val x: Self) extends AnyVal {
