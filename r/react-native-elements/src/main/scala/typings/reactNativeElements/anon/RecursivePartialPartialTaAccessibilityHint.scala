...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/tab/Tab.TabProps>> */
trait RecursivePartialPartialTaAccessibilityHint extends StObject {
  ...
  var disableIndicator: js.UndefOr[RecursivePartial[js.UndefOr[Boolean]]] = js.undefined
  ...
  var indicatorStyle: js.UndefOr[RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]] = js.undefined
  ...
  var onChange: js.UndefOr[RecursivePartial[js.UndefOr[js.Function1[/* value */ Double, Unit]]]] = js.undefined
  ...
  var variant: js.UndefOr[RecursivePartial[js.UndefOr[primary | default]]] = js.undefined
}
object RecursivePartialPartialTaAccessibilityHint {
  
  inline def apply(): RecursivePartialPartialTaAccessibilityHint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialTaAccessibilityHint]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialTaAccessibilityHint] (val x: Self) extends AnyVal {
    ...
    inline def setDisableIndicator(value: RecursivePartial[js.UndefOr[Boolean]]): Self = StObject.set(x, "disableIndicator", value.asInstanceOf[js.Any])
    ...
    inline def setIndicatorStyle(value: RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]): Self = StObject.set(x, "indicatorStyle", value.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: RecursivePartial[js.UndefOr[js.Function1[/* value */ Double, Unit]]]): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
    ...
    inline def setVariant(value: RecursivePartial[js.UndefOr[primary | default]]): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
