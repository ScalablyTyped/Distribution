...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/buttons/SpeedDial.SpeedDialActionProps>> */
trait RecursivePartialPartialSpAccessibilityHint extends StObject {
...
object RecursivePartialPartialSpAccessibilityHint {
  
  inline def apply(): RecursivePartialPartialSpAccessibilityHint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialSpAccessibilityHint]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialSpAccessibilityHint] (val x: Self) extends AnyVal {
