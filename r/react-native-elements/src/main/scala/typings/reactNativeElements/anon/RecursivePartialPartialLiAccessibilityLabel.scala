...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/list/ListItemAccordion.ListItemAccordionProps>> */
trait RecursivePartialPartialLiAccessibilityLabel extends StObject {
  ...
  var content: js.UndefOr[RecursivePartial[js.UndefOr[ReactNode]]] = js.undefined
...
object RecursivePartialPartialLiAccessibilityLabel {
  
  inline def apply(): RecursivePartialPartialLiAccessibilityLabel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialLiAccessibilityLabel]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialLiAccessibilityLabel] (val x: Self) extends AnyVal {
    ...
    inline def setContent(value: RecursivePartial[js.UndefOr[ReactNode]]): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
