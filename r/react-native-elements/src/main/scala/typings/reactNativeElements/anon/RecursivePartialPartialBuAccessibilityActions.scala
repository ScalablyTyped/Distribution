...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/buttons/Button.ButtonProps>> */
trait RecursivePartialPartialBuAccessibilityActions extends StObject {
...
object RecursivePartialPartialBuAccessibilityActions {
  ...
  inline def apply(): RecursivePartialPartialBuAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialBuAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialBuAccessibilityActions] (val x: Self) extends AnyVal {
