...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/text/Text.TextProps> */
trait ThemeTextPropsAccessibilityActions extends StObject {
...
object ThemeTextPropsAccessibilityActions {
  
  inline def apply(): ThemeTextPropsAccessibilityActions = {
