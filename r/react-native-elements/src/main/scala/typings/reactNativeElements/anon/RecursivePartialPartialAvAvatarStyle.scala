...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/avatar/Avatar.AvatarProps>> */
trait RecursivePartialPartialAvAvatarStyle extends StObject {
...
object RecursivePartialPartialAvAvatarStyle {
  
  inline def apply(): RecursivePartialPartialAvAvatarStyle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialAvAvatarStyle]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialAvAvatarStyle] (val x: Self) extends AnyVal {
