...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements.DividerProps> */
trait ThemeDividerProps extends StObject {
...
object ThemeDividerProps {
  
  inline def apply(): ThemeDividerProps = {
