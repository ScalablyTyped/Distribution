...
trait ImagePropsComponentcontex extends StObject {
  ...
  var theme: js.UndefOr[ThemeImageProps] = js.undefined
...
object ImagePropsComponentcontex {
  
  inline def apply(): ImagePropsComponentcontex = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ImagePropsComponentcontex]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ImagePropsComponentcontex] (val x: Self) extends AnyVal {
    ...
    inline def setTheme(value: ThemeImageProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
