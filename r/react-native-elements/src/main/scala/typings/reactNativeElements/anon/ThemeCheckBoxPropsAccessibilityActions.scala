...
trait ThemeCheckBoxPropsAccessibilityActions extends StObject {
  ...
  var titleProps: js.UndefOr[typings.reactNative.mod.TextProps] = js.undefined
...
object ThemeCheckBoxPropsAccessibilityActions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeCheckBoxPropsAccessibilityActions] (val x: Self) extends AnyVal {
    ...
    inline def setTitleProps(value: typings.reactNative.mod.TextProps): Self = StObject.set(x, "titleProps", value.asInstanceOf[js.Any])
