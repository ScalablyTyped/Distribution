...
trait valuenumberundefinedvaria extends StObject {
  ...
  var theme: js.UndefOr[ThemeLinearProgressProps] = js.undefined
...
object valuenumberundefinedvaria {
  
  inline def apply(): valuenumberundefinedvaria = {
  ...
  extension [Self <: valuenumberundefinedvaria](x: Self) {
    ...
    inline def setTheme(value: ThemeLinearProgressProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
