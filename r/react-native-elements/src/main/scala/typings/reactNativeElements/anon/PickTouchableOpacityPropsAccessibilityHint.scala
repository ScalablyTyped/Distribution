...
trait PickTouchableOpacityPropsAccessibilityHint extends StObject {
  ...
  var icon: js.UndefOr[IconObjectIconButtonPropsAccessibilityElementsHidden] = js.undefined
...
object PickTouchableOpacityPropsAccessibilityHint {
  
  inline def apply(): PickTouchableOpacityPropsAccessibilityHint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickTouchableOpacityPropsAccessibilityHint]
  }
  
  extension [Self <: PickTouchableOpacityPropsAccessibilityHint](x: Self) {
    ...
    inline def setIcon(value: IconObjectIconButtonPropsAccessibilityElementsHidden): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
