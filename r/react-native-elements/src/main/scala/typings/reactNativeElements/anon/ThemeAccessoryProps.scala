...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/avatar/Accessory.AccessoryProps> */
trait ThemeAccessoryProps extends StObject {
...
object ThemeAccessoryProps {
  
  inline def apply(): ThemeAccessoryProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeAccessoryProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeAccessoryProps] (val x: Self) extends AnyVal {
