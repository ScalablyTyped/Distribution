...
/* Inlined react-native-elements.react-native-elements/dist/slider/Slider.SliderProps & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/slider/Slider.SliderProps>> */
trait SliderPropsPartialThemePr extends StObject {
  ...
  var theme: js.UndefOr[ThemeSliderProps] = js.undefined
...
object SliderPropsPartialThemePr {
  
  inline def apply(): SliderPropsPartialThemePr = {
  ...
  extension [Self <: SliderPropsPartialThemePr](x: Self) {
    ...
    inline def setTheme(value: ThemeSliderProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
