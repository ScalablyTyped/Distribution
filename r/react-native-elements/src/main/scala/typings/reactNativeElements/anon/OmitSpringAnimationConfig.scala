...
trait OmitSpringAnimationConfig extends StObject {
  ...
  var velocity: js.UndefOr[Double | typings.reactNative.anon.X] = js.undefined
}
object OmitSpringAnimationConfig {
  ...
  extension [Self <: OmitSpringAnimationConfig](x: Self) {
    ...
    inline def setVelocity(value: Double | typings.reactNative.anon.X): Self = StObject.set(x, "velocity", value.asInstanceOf[js.Any])
