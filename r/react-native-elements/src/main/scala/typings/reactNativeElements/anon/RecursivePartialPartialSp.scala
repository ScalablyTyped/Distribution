...
/* Inlined react-native-elements.react-native-elements/dist/config/ThemeProvider.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/buttons/SpeedDial.SpeedDialProps>> */
trait RecursivePartialPartialSp extends StObject {
...
object RecursivePartialPartialSp {
  
  inline def apply(): RecursivePartialPartialSp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialSp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialSp] (val x: Self) extends AnyVal {
