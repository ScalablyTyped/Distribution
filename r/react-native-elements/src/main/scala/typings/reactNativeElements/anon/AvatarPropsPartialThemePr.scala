...
trait AvatarPropsPartialThemePr extends StObject {
  ...
  var theme: js.UndefOr[ThemeAvatarProps] = js.undefined
...
object AvatarPropsPartialThemePr {
  
  inline def apply(): AvatarPropsPartialThemePr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AvatarPropsPartialThemePr]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AvatarPropsPartialThemePr] (val x: Self) extends AnyVal {
    ...
    inline def setTheme(value: ThemeAvatarProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
