...
/* Inlined std.Partial<react-native-elements.react-native-elements/dist/dialog/Dialog.DialogProps> */
trait PartialDialogProps extends StObject {
  ...
  var theme: js.UndefOr[ThemeAvatar] = js.undefined
...
object PartialDialogProps {
  ...
  implicit open class MutableBuilder[Self <: PartialDialogProps] (val x: Self) extends AnyVal {
    ...
    inline def setTheme(value: ThemeAvatar): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
