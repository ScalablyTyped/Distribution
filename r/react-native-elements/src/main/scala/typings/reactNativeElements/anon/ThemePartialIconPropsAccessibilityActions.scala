...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<std.Partial<react-native-elements.react-native-elements/dist/icons/Icon.IconProps>> */
trait ThemePartialIconPropsAccessibilityActions extends StObject {
...
object ThemePartialIconPropsAccessibilityActions {
  
  inline def apply(): ThemePartialIconPropsAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemePartialIconPropsAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemePartialIconPropsAccessibilityActions] (val x: Self) extends AnyVal {
