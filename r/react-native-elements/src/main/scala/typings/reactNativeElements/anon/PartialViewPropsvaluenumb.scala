...
/* Inlined std.Partial<react-native.react-native.ViewProps & {  value :number | undefined,   onChange :(value : number): void | undefined,   disableIndicator :boolean | undefined,   indicatorStyle :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   variant :'primary' | 'default' | undefined} & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/tab/Tab.TabProps>>> */
trait PartialViewPropsvaluenumb extends StObject {
  ...
  var theme: js.UndefOr[ThemeTabProps] = js.undefined
...
object PartialViewPropsvaluenumb {
  
  inline def apply(): PartialViewPropsvaluenumb = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialViewPropsvaluenumb]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialViewPropsvaluenumb] (val x: Self) extends AnyVal {
    ...
    inline def setTheme(value: ThemeTabProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
