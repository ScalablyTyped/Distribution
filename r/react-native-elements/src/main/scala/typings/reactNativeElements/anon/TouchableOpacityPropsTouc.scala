...
trait TouchableOpacityPropsTouc extends StObject {
  ...
  var icon: js.UndefOr[IconObjectIconButtonPropsAccessibilityActions] = js.undefined
...
object TouchableOpacityPropsTouc {
  
  inline def apply(): TouchableOpacityPropsTouc = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TouchableOpacityPropsTouc]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TouchableOpacityPropsTouc] (val x: Self) extends AnyVal {
    ...
    inline def setIcon(value: IconObjectIconButtonPropsAccessibilityActions): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
