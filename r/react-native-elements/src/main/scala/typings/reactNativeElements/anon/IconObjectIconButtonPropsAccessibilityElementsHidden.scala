...
trait IconObjectIconButtonPropsAccessibilityElementsHidden extends StObject {
...
object IconObjectIconButtonPropsAccessibilityElementsHidden {
  ...
  inline def apply(
  ...
  ): IconObjectIconButtonPropsAccessibilityElementsHidden = {
    ...
    __obj.asInstanceOf[IconObjectIconButtonPropsAccessibilityElementsHidden]
  }
  
  extension [Self <: IconObjectIconButtonPropsAccessibilityElementsHidden](x: Self) {
