...
trait titlestringReactElementun extends StObject {
  ...
  var theme: js.UndefOr[ThemeFABProps] = js.undefined
...
object titlestringReactElementun {
  
  inline def apply(disabled: js.UndefOr[Boolean] & (js.UndefOr[Boolean | Null])): titlestringReactElementun = {
  ...
  extension [Self <: titlestringReactElementun](x: Self) {
    ...
    inline def setTheme(value: ThemeFABProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
