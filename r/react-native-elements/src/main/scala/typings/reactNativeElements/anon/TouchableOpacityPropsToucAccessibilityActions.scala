...
trait TouchableOpacityPropsToucAccessibilityActions extends StObject {
  ...
  var icon: js.UndefOr[IconObjectIconButtonPropsAccessibilityHint] = js.undefined
  ...
  var theme: js.UndefOr[ThemeTileProps] = js.undefined
...
object TouchableOpacityPropsToucAccessibilityActions {
  
  inline def apply(): TouchableOpacityPropsToucAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TouchableOpacityPropsToucAccessibilityActions]
  }
  
  extension [Self <: TouchableOpacityPropsToucAccessibilityActions](x: Self) {
    ...
    inline def setIcon(value: IconObjectIconButtonPropsAccessibilityHint): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
    ...
    inline def setTheme(value: ThemeTileProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
