...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/avatar/Avatar.AvatarProps> */
trait ThemeAvatarProps extends StObject {
...
object ThemeAvatarProps {
  
  inline def apply(): ThemeAvatarProps = {
