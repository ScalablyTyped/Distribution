...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/header/Header.HeaderProps>> */
trait RecursivePartialPartialHeAccessibilityActions extends StObject {
...
object RecursivePartialPartialHeAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialHeAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialHeAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialHeAccessibilityActions] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundImage(value: RecursivePartial[js.UndefOr[ImageSourcePropType]]): Self = StObject.set(x, "backgroundImage", value.asInstanceOf[js.Any])
    
    inline def setBackgroundImageStyle(value: RecursivePartial[js.UndefOr[ImageStyle]]): Self = StObject.set(x, "backgroundImageStyle", value.asInstanceOf[js.Any])
    
    inline def setBackgroundImageStyleUndefined: Self = StObject.set(x, "backgroundImageStyle", js.undefined)
    
    inline def setBackgroundImageUndefined: Self = StObject.set(x, "backgroundImage", js.undefined)
    
    inline def setBarStyle(value: RecursivePartial[js.UndefOr[StatusBarStyle]]): Self = StObject.set(x, "barStyle", value.asInstanceOf[js.Any])
    
    inline def setBarStyleUndefined: Self = StObject.set(x, "barStyle", js.undefined)
    
    inline def setCenterComponent(value: RecursivePartial[js.UndefOr[HeaderSubComponent]]): Self = StObject.set(x, "centerComponent", value.asInstanceOf[js.Any])
    
    inline def setCenterComponentUndefined: Self = StObject.set(x, "centerComponent", js.undefined)
    
    inline def setCenterContainerStyle(value: RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]): Self = StObject.set(x, "centerContainerStyle", value.asInstanceOf[js.Any])
    ...
    inline def setLeftComponent(value: RecursivePartial[js.UndefOr[HeaderSubComponent]]): Self = StObject.set(x, "leftComponent", value.asInstanceOf[js.Any])
    
    inline def setLeftComponentUndefined: Self = StObject.set(x, "leftComponent", js.undefined)
    
    inline def setLeftContainerStyle(value: RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]): Self = StObject.set(x, "leftContainerStyle", value.asInstanceOf[js.Any])
    ...
    inline def setPlacement(value: RecursivePartial[js.UndefOr[left | center | right]]): Self = StObject.set(x, "placement", value.asInstanceOf[js.Any])
    ...
    inline def setRightComponent(value: RecursivePartial[js.UndefOr[HeaderSubComponent]]): Self = StObject.set(x, "rightComponent", value.asInstanceOf[js.Any])
    
    inline def setRightComponentUndefined: Self = StObject.set(x, "rightComponent", js.undefined)
    
    inline def setRightContainerStyle(value: RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]): Self = StObject.set(x, "rightContainerStyle", value.asInstanceOf[js.Any])
