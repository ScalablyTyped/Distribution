...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/buttons/ButtonGroup.ButtonGroupProps> */
trait ThemeButtonGroupProps extends StObject {
...
object ThemeButtonGroupProps {
  
  inline def apply(): ThemeButtonGroupProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeButtonGroupProps]
  }
  
  extension [Self <: ThemeButtonGroupProps](x: Self) {
