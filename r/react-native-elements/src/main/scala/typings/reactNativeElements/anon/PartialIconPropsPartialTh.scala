...
/* Inlined std.Partial<react-native-elements.react-native-elements.IconProps> & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<std.Partial<react-native-elements.react-native-elements.IconProps>>> */
trait PartialIconPropsPartialTh extends StObject {
  ...
  var theme: js.UndefOr[ThemePartialIconProps] = js.undefined
...
object PartialIconPropsPartialTh {
  
  inline def apply(): PartialIconPropsPartialTh = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIconPropsPartialTh]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialIconPropsPartialTh] (val x: Self) extends AnyVal {
    ...
    inline def setTheme(value: ThemePartialIconProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
