...
trait ThemeAccessoryPropsAccessibilityActions extends StObject {
...
object ThemeAccessoryPropsAccessibilityActions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeAccessoryPropsAccessibilityActions] (val x: Self) extends AnyVal {
