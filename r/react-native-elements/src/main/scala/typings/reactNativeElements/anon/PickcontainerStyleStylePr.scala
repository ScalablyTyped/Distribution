...
object PickcontainerStyleStylePr {
  
  inline def apply(): PickcontainerStyleStylePr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickcontainerStyleStylePr]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickcontainerStyleStylePr] (val x: Self) extends AnyVal {
