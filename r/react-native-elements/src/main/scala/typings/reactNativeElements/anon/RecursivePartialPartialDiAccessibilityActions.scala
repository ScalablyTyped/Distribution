...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/divider/Divider.DividerProps>> */
trait RecursivePartialPartialDiAccessibilityActions extends StObject {
...
object RecursivePartialPartialDiAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialDiAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialDiAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialDiAccessibilityActions] (val x: Self) extends AnyVal {
