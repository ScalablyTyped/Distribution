...
/* Inlined react-native-elements.react-native-elements/dist/config/ThemeProvider.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/buttons/FAB.FABProps>> */
trait RecursivePartialPartialFA extends StObject {
...
object RecursivePartialPartialFA {
  
  inline def apply(): RecursivePartialPartialFA = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialFA]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialFA] (val x: Self) extends AnyVal {
