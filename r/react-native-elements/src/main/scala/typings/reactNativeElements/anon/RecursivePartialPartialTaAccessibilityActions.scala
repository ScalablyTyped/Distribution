...
/* Inlined react-native-elements.react-native-elements/dist/config/ThemeProvider.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/tab/Tab.TabProps>> */
trait RecursivePartialPartialTaAccessibilityActions extends StObject {
...
object RecursivePartialPartialTaAccessibilityActions {
  
  inline def apply(): RecursivePartialPartialTaAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialTaAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialTaAccessibilityActions] (val x: Self) extends AnyVal {
