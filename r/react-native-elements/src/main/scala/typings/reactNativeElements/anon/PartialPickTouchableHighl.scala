...
object PartialPickTouchableHighl {
  
  inline def apply(): PartialPickTouchableHighl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPickTouchableHighl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialPickTouchableHighl] (val x: Self) extends AnyVal {
