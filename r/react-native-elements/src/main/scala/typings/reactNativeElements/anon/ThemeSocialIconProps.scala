...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/social/SocialIcon.SocialIconProps> */
trait ThemeSocialIconProps extends StObject {
...
object ThemeSocialIconProps {
  
  inline def apply(): ThemeSocialIconProps = {
