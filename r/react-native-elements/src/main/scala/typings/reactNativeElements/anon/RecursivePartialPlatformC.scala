...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<react-native-elements.react-native-elements/dist/config/colors.PlatformColors> */
trait RecursivePartialPlatformC extends StObject {
  
  var error: js.UndefOr[RecursivePartial[String]] = js.undefined
  
  var grey: js.UndefOr[RecursivePartial[String]] = js.undefined
...
object RecursivePartialPlatformC {
  
  inline def apply(): RecursivePartialPlatformC = {
  ...
  extension [Self <: RecursivePartialPlatformC](x: Self) {
    ...
    inline def setGrey(value: RecursivePartial[String]): Self = StObject.set(x, "grey", value.asInstanceOf[js.Any])
