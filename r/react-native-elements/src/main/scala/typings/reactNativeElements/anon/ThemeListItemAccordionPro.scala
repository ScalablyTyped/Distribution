...
import typings.reactNativeElements.distAvatarAccessoryMod.AccessoryProps
import typings.reactNativeElements.distAvatarAvatarMod.AvatarProps
import typings.reactNativeElements.distBadgeBadgeMod.BadgeProps
import typings.reactNativeElements.distBottomSheetBottomSheetMod.BottomSheetProps
import typings.reactNativeElements.distButtonsButtonGroupMod.ButtonGroupProps
import typings.reactNativeElements.distButtonsButtonMod.ButtonProps
import typings.reactNativeElements.distButtonsFabMod.FABProps
import typings.reactNativeElements.distButtonsSpeedDialMod.SpeedDialActionProps
import typings.reactNativeElements.distButtonsSpeedDialMod.SpeedDialProps
import typings.reactNativeElements.distCardCardMod.CardProps
import typings.reactNativeElements.distCheckboxCheckBoxMod.CheckBoxProps
...
import typings.reactNativeElements.distDividerDividerMod.DividerProps
...
import typings.reactNativeElements.distLinearProgressLinearProgressMod.LinearProgressProps
import typings.reactNativeElements.distListListItemAccordionMod.ListItemAccordionProps
import typings.reactNativeElements.distListListItemBaseMod.ListItemProps
import typings.reactNativeElements.distOverlayOverlayMod.OverlayProps
import typings.reactNativeElements.distPricingPricingCardMod.PricingCardProps
import typings.reactNativeElements.distSearchbarSearchBarMod.SearchBarProps
import typings.reactNativeElements.distSliderSliderMod.SliderProps
import typings.reactNativeElements.distSocialSocialIconMod.SocialIconProps
import typings.reactNativeElements.distSwitchSwitchMod.SwitchProps
import typings.reactNativeElements.distTabTabMod.TabItemProps
import typings.reactNativeElements.distTabTabMod.TabProps
import typings.reactNativeElements.distTabTabViewMod.TabViewProps
import typings.reactNativeElements.distTextTextMod.TextProps
import typings.reactNativeElements.distTileTileMod.TileProps
import typings.reactNativeElements.distTooltipTooltipMod.TooltipProps
...
import typings.reactNativeRatings.distSwipeRatingMod.SwipeRatingProps
...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/list/ListItemAccordion.ListItemAccordionProps> */
trait ThemeListItemAccordionPro extends StObject {
...
object ThemeListItemAccordionPro {
  
  inline def apply(): ThemeListItemAccordionPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeListItemAccordionPro]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeListItemAccordionPro] (val x: Self) extends AnyVal {
