...
/* Inlined std.Pick<react-native-elements.react-native-elements.ButtonProps, 'style' | 'onLayout' | 'testID' | 'accessible' | 'accessibilityActions' | 'accessibilityLabel' | 'accessibilityRole' | 'accessibilityState' | 'accessibilityHint' | 'accessibilityValue' | 'onAccessibilityAction' | 'accessibilityLiveRegion' | 'importantForAccessibility' | 'accessibilityElementsHidden' | 'accessibilityViewIsModal' | 'onAccessibilityEscape' | 'onAccessibilityTap' | 'onMagicTap' | 'accessibilityIgnoresInvertColors' | 'raised' | 'disabled' | 'onPress' | 'onLongPress' | 'activeOpacity' | 'delayLongPress' | 'delayPressIn' | 'delayPressOut' | 'hitSlop' | 'onBlur' | 'onFocus' | 'onPressIn' | 'onPressOut' | 'pressRetentionOffset' | 'hasTVPreferredFocus' | 'tvParallaxProperties' | 'touchSoundDisabled' | 'background' | 'useForeground' | 'type' | 'containerStyle' | 'disabledStyle' | 'title' | 'icon' | 'titleStyle' | 'loading' | 'titleProps' | 'buttonStyle' | 'loadingStyle' | 'loadingProps' | 'iconContainerStyle' | 'iconRight' | 'linearGradientProps' | 'TouchableComponent' | 'ViewComponent' | 'disabledTitleStyle' | 'iconPosition'> */
trait PickButtonPropsstyleonLay extends StObject {
...
object PickButtonPropsstyleonLay {
  
  inline def apply(): PickButtonPropsstyleonLay = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickButtonPropsstyleonLay]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickButtonPropsstyleonLay] (val x: Self) extends AnyVal {
