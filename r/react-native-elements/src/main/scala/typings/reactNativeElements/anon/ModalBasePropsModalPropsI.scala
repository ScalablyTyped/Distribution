...
trait ModalBasePropsModalPropsI extends StObject {
  ...
  var theme: js.UndefOr[ThemeOverlayProps] = js.undefined
...
object ModalBasePropsModalPropsI {
  
  inline def apply(isVisible: Boolean): ModalBasePropsModalPropsI = {
  ...
  implicit open class MutableBuilder[Self <: ModalBasePropsModalPropsI] (val x: Self) extends AnyVal {
    ...
    inline def setTheme(value: ThemeOverlayProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
