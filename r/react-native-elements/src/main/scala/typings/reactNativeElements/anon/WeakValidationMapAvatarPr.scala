...
/* Inlined react.react.WeakValidationMap<react-native-elements.react-native-elements/dist/avatar/Avatar.AvatarProps & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/avatar/Avatar.AvatarProps>>> */
trait WeakValidationMapAvatarPr extends StObject {
  ...
  var theme: js.UndefOr[Validator[js.UndefOr[Null | ThemeAvatarPropsActiveOpacity]]] = js.undefined
...
object WeakValidationMapAvatarPr {
  
  inline def apply(): WeakValidationMapAvatarPr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapAvatarPr]
  }
  
  extension [Self <: WeakValidationMapAvatarPr](x: Self) {
    ...
    inline def setTheme(value: Validator[js.UndefOr[Null | ThemeAvatarPropsActiveOpacity]]): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
