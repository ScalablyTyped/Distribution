...
import typings.reactNativeElements.reactNativeElementsStrings.`birthdate-month`
import typings.reactNativeElements.reactNativeElementsStrings.`birthdate-year`
...
import typings.reactNativeElements.reactNativeElementsStrings.`cc-exp-day`
...
import typings.reactNativeElements.reactNativeElementsStrings.`name-family`
import typings.reactNativeElements.reactNativeElementsStrings.`name-given`
import typings.reactNativeElements.reactNativeElementsStrings.`name-middle-initial`
import typings.reactNativeElements.reactNativeElementsStrings.`name-middle`
import typings.reactNativeElements.reactNativeElementsStrings.`name-prefix`
import typings.reactNativeElements.reactNativeElementsStrings.`name-suffix`
import typings.reactNativeElements.reactNativeElementsStrings.`no-hide-descendants`
import typings.reactNativeElements.reactNativeElementsStrings.`password-new`
import typings.reactNativeElements.reactNativeElementsStrings.`postal-address-country`
import typings.reactNativeElements.reactNativeElementsStrings.`postal-address-extended-postal-code`
import typings.reactNativeElements.reactNativeElementsStrings.`postal-address-extended`
import typings.reactNativeElements.reactNativeElementsStrings.`postal-address-locality`
import typings.reactNativeElements.reactNativeElementsStrings.`postal-address-region`
import typings.reactNativeElements.reactNativeElementsStrings.`postal-address`
import typings.reactNativeElements.reactNativeElementsStrings.`postal-code`
import typings.reactNativeElements.reactNativeElementsStrings.`sms-otp`
import typings.reactNativeElements.reactNativeElementsStrings.`street-address`
import typings.reactNativeElements.reactNativeElementsStrings.`tel-country-code`
import typings.reactNativeElements.reactNativeElementsStrings.`tel-device`
import typings.reactNativeElements.reactNativeElementsStrings.`tel-national`
import typings.reactNativeElements.reactNativeElementsStrings.`unless-editing`
import typings.reactNativeElements.reactNativeElementsStrings.`username-new`
...
import typings.reactNativeElements.reactNativeElementsStrings.gender
