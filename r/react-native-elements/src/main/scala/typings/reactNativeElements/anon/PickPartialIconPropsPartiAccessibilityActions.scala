...
object PickPartialIconPropsPartiAccessibilityActions {
  
  inline def apply(): PickPartialIconPropsPartiAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickPartialIconPropsPartiAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickPartialIconPropsPartiAccessibilityActions] (val x: Self) extends AnyVal {
