...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/tooltip/Tooltip.TooltipProps>> */
trait RecursivePartialPartialToBackgroundColor extends StObject {
...
object RecursivePartialPartialToBackgroundColor {
  
  inline def apply(): RecursivePartialPartialToBackgroundColor = {
  ...
  implicit open class MutableBuilder[Self <: RecursivePartialPartialToBackgroundColor] (val x: Self) extends AnyVal {
    ...
    inline def setPopover(value: RecursivePartial[js.UndefOr[ReactElement]]): Self = StObject.set(x, "popover", value.asInstanceOf[js.Any])
