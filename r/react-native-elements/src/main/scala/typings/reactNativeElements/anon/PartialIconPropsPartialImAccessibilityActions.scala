...
trait PartialIconPropsPartialImAccessibilityActions extends StObject {
...
object PartialIconPropsPartialImAccessibilityActions {
  
  inline def apply(): PartialIconPropsPartialImAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIconPropsPartialImAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialIconPropsPartialImAccessibilityActions] (val x: Self) extends AnyVal {
    ...
    inline def setTheme(value: ThemeAccessoryPropsAccessibilityActions): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
