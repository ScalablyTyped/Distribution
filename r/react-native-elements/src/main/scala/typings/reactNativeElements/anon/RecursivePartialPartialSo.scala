...
object RecursivePartialPartialSo {
  ...
  @scala.inline
  implicit class RecursivePartialPartialSoMutableBuilder[Self <: RecursivePartialPartialSo] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setButton(value: RecursivePartial[js.UndefOr[Boolean]]): Self = StObject.set(x, "button", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFontStyle(value: RecursivePartial[js.UndefOr[StyleProp[TextStyle]]]): Self = StObject.set(x, "fontStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFontStyleUndefined: Self = StObject.set(x, "fontStyle", js.undefined)
    
    @scala.inline
    def setFontWeight(value: RecursivePartial[js.UndefOr[String]]): Self = StObject.set(x, "fontWeight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFontWeightUndefined: Self = StObject.set(x, "fontWeight", js.undefined)
    
    @scala.inline
    def setIconColor(value: RecursivePartial[js.UndefOr[String]]): Self = StObject.set(x, "iconColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIconColorUndefined: Self = StObject.set(x, "iconColor", js.undefined)
    
    @scala.inline
    def setIconSize(value: RecursivePartial[js.UndefOr[Double]]): Self = StObject.set(x, "iconSize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIconSizeUndefined: Self = StObject.set(x, "iconSize", js.undefined)
    
    @scala.inline
    def setIconStyle(value: RecursivePartial[js.UndefOr[StyleProp[ViewStyle]]]): Self = StObject.set(x, "iconStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setIconStyleUndefined: Self = StObject.set(x, "iconStyle", js.undefined)
    
    @scala.inline
    def setLight(value: RecursivePartial[js.UndefOr[Boolean]]): Self = StObject.set(x, "light", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setType(value: RecursivePartial[js.UndefOr[SocialMediaType]]): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
