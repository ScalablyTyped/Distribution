...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/buttons/SpeedDial.SpeedDialProps> */
trait ThemeSpeedDialProps extends StObject {
