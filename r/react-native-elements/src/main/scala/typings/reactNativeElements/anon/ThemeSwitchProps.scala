...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/switch/switch.SwitchProps> */
trait ThemeSwitchProps extends StObject {
...
object ThemeSwitchProps {
  
  inline def apply(): ThemeSwitchProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeSwitchProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeSwitchProps] (val x: Self) extends AnyVal {
