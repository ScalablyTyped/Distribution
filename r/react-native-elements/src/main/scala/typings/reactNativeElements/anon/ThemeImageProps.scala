...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements.ImageProps> */
trait ThemeImageProps extends StObject {
...
object ThemeImageProps {
  
  inline def apply(): ThemeImageProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeImageProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeImageProps] (val x: Self) extends AnyVal {
