...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/icons/Icon.IconProps> */
trait ThemeIconProps extends StObject {
...
object ThemeIconProps {
  
  inline def apply(name: String): ThemeIconProps = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[ThemeIconProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeIconProps] (val x: Self) extends AnyVal {
