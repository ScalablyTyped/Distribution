...
trait IconButtonPropstypestring extends StObject {
  ...
  var theme: js.UndefOr[ThemeIconProps] = js.undefined
...
object IconButtonPropstypestring {
  
  inline def apply(disabled: (js.UndefOr[Boolean | Null]) & js.UndefOr[Boolean], name: String): IconButtonPropstypestring = {
  ...
  extension [Self <: IconButtonPropstypestring](x: Self) {
    ...
    inline def setTheme(value: ThemeIconProps): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
