...
/* Inlined react-native.react-native.ViewProps & {  value :number | undefined,   onChange :(value : number): void | undefined,   disableIndicator :boolean | undefined,   indicatorStyle :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   variant :'primary' | 'default' | undefined} & std.Partial<react-native-elements.react-native-elements/dist/config.ThemeProps<react-native-elements.react-native-elements/dist/tab/Tab.TabProps>> */
trait ViewPropsvaluenumberundef extends StObject {
...
object ViewPropsvaluenumberundef {
  
  inline def apply(): ViewPropsvaluenumberundef = {
