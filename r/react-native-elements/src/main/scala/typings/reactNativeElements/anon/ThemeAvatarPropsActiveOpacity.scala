...
trait ThemeAvatarPropsActiveOpacity extends StObject {
...
object ThemeAvatarPropsActiveOpacity {
  
  inline def apply(): ThemeAvatarPropsActiveOpacity = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ThemeAvatarPropsActiveOpacity]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ThemeAvatarPropsActiveOpacity] (val x: Self) extends AnyVal {
