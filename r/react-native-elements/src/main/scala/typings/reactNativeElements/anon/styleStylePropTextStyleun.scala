...
trait styleStylePropTextStyleun extends StObject {
  ...
  var theme: js.UndefOr[ThemestyleStylePropTextSt] = js.undefined
  
  var updateTheme: js.UndefOr[js.Function1[/* updates */ RecursivePartialFullThemeAirbnbRating, Unit]] = js.undefined
}
object styleStylePropTextStyleun {
  
  inline def apply(): styleStylePropTextStyleun = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[styleStylePropTextStyleun]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: styleStylePropTextStyleun] (val x: Self) extends AnyVal {
    ...
    inline def setTheme(value: ThemestyleStylePropTextSt): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
