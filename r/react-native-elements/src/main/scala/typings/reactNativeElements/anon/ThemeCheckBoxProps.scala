...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.Theme<react-native-elements.react-native-elements/dist/checkbox/CheckBox.CheckBoxProps> */
trait ThemeCheckBoxProps extends StObject {
...
object ThemeCheckBoxProps {
  
  inline def apply(): ThemeCheckBoxProps = {
