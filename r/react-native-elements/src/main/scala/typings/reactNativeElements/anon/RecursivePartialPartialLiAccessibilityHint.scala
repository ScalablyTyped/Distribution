...
/* Inlined react-native-elements.react-native-elements/dist/config/theme.RecursivePartial<std.Partial<react-native-elements.react-native-elements/dist/list/ListItemBase.ListItemProps>> */
trait RecursivePartialPartialLiAccessibilityHint extends StObject {
...
object RecursivePartialPartialLiAccessibilityHint {
  
  inline def apply(): RecursivePartialPartialLiAccessibilityHint = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RecursivePartialPartialLiAccessibilityHint]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecursivePartialPartialLiAccessibilityHint] (val x: Self) extends AnyVal {
