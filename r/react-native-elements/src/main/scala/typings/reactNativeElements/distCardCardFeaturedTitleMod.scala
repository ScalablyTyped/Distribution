...
object distCardCardFeaturedTitleMod extends Shortcut {
  
  @JSImport("react-native-elements/dist/card/CardFeaturedTitle", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distCardCardFeaturedTitleMod.foo` */
