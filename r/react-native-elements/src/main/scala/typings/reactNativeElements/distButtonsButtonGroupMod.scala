...
import typings.reactNativeElements.anon.Color
...
object distButtonsButtonGroupMod extends Shortcut {
  
  @JSImport("react-native-elements/dist/buttons/ButtonGroup", JSImport.Default)
  @js.native
  ...
  @js.native
  val ButtonGroup: RneFunctionComponent[ButtonGroupProps] = js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distButtonsButtonGroupMod.foo` */
