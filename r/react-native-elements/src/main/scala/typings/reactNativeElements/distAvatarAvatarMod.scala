...
import typings.reactNativeElements.anon.AvatarPropsPartialThemePr
import typings.reactNativeElements.anon.ForwardRefExoticComponent
import typings.reactNativeElements.anon.FunctionComponentPickAvat
