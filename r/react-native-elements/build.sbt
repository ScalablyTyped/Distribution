...
version := "3.4.2-10593c"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "color" % "3.0-dt-20220819Z-60b3a7",
  ...
  "org.scalablytyped" %%% "react-native-ratings" % "8.1.0-2c3d57",
  "org.scalablytyped" %%% "react-native-vector-icons" % "6.4-dt-20220830Z-2888bc",
