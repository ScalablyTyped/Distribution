...
trait ReactCropProps extends js.Object {
  ...
  var onImageError: js.UndefOr[js.Function1[/* event */ SyntheticEvent[HTMLImageElement, Event_], Unit]] = js.undefined
...
object ReactCropProps {
  ...
  def apply(
    ...
    onImageError: /* event */ SyntheticEvent[HTMLImageElement, Event_] => Unit = null,
