...
object TreeContextProps {
  ...
  implicit class TreeContextPropsOps[Self <: TreeContextProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnNodeCheck(value: (MouseEvent[HTMLSpanElement, NativeMouseEvent], EventDataNode, Boolean) => Unit): Self = this.set("onNodeCheck", js.Any.fromFunction3(value))
    
    @scala.inline
    def setOnNodeClick(value: (/* e */ MouseEvent[HTMLSpanElement, NativeMouseEvent], /* node */ EventDataNode) => Unit): Self = this.set("onNodeClick", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnNodeContextMenu(value: (/* e */ MouseEvent[HTMLSpanElement, NativeMouseEvent], /* node */ EventDataNode) => Unit): Self = this.set("onNodeContextMenu", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnNodeDoubleClick(value: (/* e */ MouseEvent[HTMLSpanElement, NativeMouseEvent], /* node */ EventDataNode) => Unit): Self = this.set("onNodeDoubleClick", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnNodeExpand(value: (/* e */ MouseEvent[HTMLSpanElement, NativeMouseEvent], /* node */ EventDataNode) => Unit): Self = this.set("onNodeExpand", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnNodeLoad(value: EventDataNode => Unit): Self = this.set("onNodeLoad", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnNodeMouseEnter(value: (/* e */ MouseEvent[HTMLSpanElement, NativeMouseEvent], /* node */ EventDataNode) => Unit): Self = this.set("onNodeMouseEnter", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnNodeMouseLeave(value: (/* e */ MouseEvent[HTMLSpanElement, NativeMouseEvent], /* node */ EventDataNode) => Unit): Self = this.set("onNodeMouseLeave", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOnNodeSelect(value: (/* e */ MouseEvent[HTMLSpanElement, NativeMouseEvent], /* node */ EventDataNode) => Unit): Self = this.set("onNodeSelect", js.Any.fromFunction2(value))
