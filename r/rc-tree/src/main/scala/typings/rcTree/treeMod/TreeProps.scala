...
object TreeProps {
  ...
  implicit class TreePropsOps[Self <: TreeProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: (/* e */ MouseEvent[HTMLSpanElement, NativeMouseEvent], /* node */ EventDataNode) => Unit): Self = this.set("onClick", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setOnDoubleClick(value: (/* e */ MouseEvent[HTMLSpanElement, NativeMouseEvent], /* node */ EventDataNode) => Unit): Self = this.set("onDoubleClick", js.Any.fromFunction2(value))
