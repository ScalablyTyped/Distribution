...
trait DragOverNodeKey extends StObject {
  ...
  var dropContainerKey: typings.rcTree.interfaceMod.Key
  
  var dropLevelOffset: Double
  
  var dropPosition: `-1` | `0` | `1`
  
  var dropTargetKey: typings.rcTree.interfaceMod.Key
...
object DragOverNodeKey {
  ...
  inline def apply(
    ...
    dropAllowed: Boolean,
    dropContainerKey: typings.rcTree.interfaceMod.Key,
    dropLevelOffset: Double,
    dropPosition: `-1` | `0` | `1`,
    dropTargetKey: typings.rcTree.interfaceMod.Key,
