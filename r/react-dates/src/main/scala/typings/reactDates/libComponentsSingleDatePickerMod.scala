...
object libComponentsSingleDatePickerMod extends Shortcut {
  
  @JSImport("react-dates/lib/components/SingleDatePicker", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsSingleDatePickerMod.foo` */
