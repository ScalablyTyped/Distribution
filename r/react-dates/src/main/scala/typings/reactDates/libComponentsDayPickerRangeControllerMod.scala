...
object libComponentsDayPickerRangeControllerMod extends Shortcut {
  
  @JSImport("react-dates/lib/components/DayPickerRangeController", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsDayPickerRangeControllerMod.foo` */
