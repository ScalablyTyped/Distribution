...
object PickCalendarMonthGridShap {
  ...
  extension [Self <: PickCalendarMonthGridShap](x: Self) {
    ...
    inline def setOnDayClick(value: js.Any): Self = StObject.set(x, "onDayClick", value.asInstanceOf[js.Any])
    
    inline def setOnDayClickUndefined: Self = StObject.set(x, "onDayClick", js.undefined)
    
    inline def setOnDayMouseEnter(value: js.Any): Self = StObject.set(x, "onDayMouseEnter", value.asInstanceOf[js.Any])
    
    inline def setOnDayMouseEnterUndefined: Self = StObject.set(x, "onDayMouseEnter", js.undefined)
    
    inline def setOnDayMouseLeave(value: js.Any): Self = StObject.set(x, "onDayMouseLeave", value.asInstanceOf[js.Any])
