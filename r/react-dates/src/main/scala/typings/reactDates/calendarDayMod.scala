...
object calendarDayMod extends Shortcut {
  
  @JSImport("react-dates/esm/components/CalendarDay", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `calendarDayMod.foo` */
