...
object libComponentsDateRangePickerInputMod extends Shortcut {
  
  @JSImport("react-dates/lib/components/DateRangePickerInput", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsDateRangePickerInputMod.foo` */
