...
object esmComponentsCalendarMonthMod extends Shortcut {
  
  @JSImport("react-dates/esm/components/CalendarMonth", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `esmComponentsCalendarMonthMod.foo` */
