...
object dayPickerSingleDateControllerMod extends Shortcut {
  
  @JSImport("react-dates/esm/components/DayPickerSingleDateController", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `dayPickerSingleDateControllerMod.foo` */
