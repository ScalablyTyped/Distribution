...
trait HTMLAttributesidclassNamestyleonChangeePullHookCha extends js.Object {
...
object HTMLAttributesidclassNamestyleonChangeePullHookCha {
  @scala.inline
  def apply(
  ...
  ): HTMLAttributesidclassNamestyleonChangeePullHookCha = {
    ...
    __obj.asInstanceOf[HTMLAttributesidclassNamestyleonChangeePullHookCha]
  }
}
