...
trait HTMLAttributesidclassNamestylemodifierstringdisabl extends js.Object {
...
object HTMLAttributesidclassNamestylemodifierstringdisabl {
  @scala.inline
  def apply(
  ...
  ): HTMLAttributesidclassNamestylemodifierstringdisabl = {
    ...
    __obj.asInstanceOf[HTMLAttributesidclassNamestylemodifierstringdisabl]
  }
}
