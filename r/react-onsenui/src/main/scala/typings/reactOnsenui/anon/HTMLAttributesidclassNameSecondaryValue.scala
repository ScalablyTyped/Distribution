...
/* Inlined react-onsenui.react-onsenui.HTMLAttributes<'id' | 'className' | 'style'> & {  modifier :string | undefined,   value :number | undefined,   secondaryValue :boolean | undefined,   indeterminate :boolean | undefined} */
@js.native
...
object HTMLAttributesidclassNameSecondaryValue {
  ...
  implicit class HTMLAttributesidclassNameSecondaryValueOps[Self <: HTMLAttributesidclassNameSecondaryValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSecondaryValue(value: Boolean): Self = this.set("secondaryValue", value.asInstanceOf[js.Any])
    @scala.inline
