...
object GetTarget {
  ...
  @scala.inline
  implicit class GetTargetMutableBuilder[Self <: GetTarget] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetTarget(value: () => ReactInstance): Self = StObject.set(x, "getTarget", js.Any.fromFunction0(value))
