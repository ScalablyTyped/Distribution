...
object DataSource {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DataSource[?], T] (val x: Self & DataSource[T]) extends AnyVal {
    ...
    inline def setRenderFooter(value: () => js.UndefOr[Element]): Self = StObject.set(x, "renderFooter", js.Any.fromFunction0(value))
    
    inline def setRenderFooterUndefined: Self = StObject.set(x, "renderFooter", js.undefined)
    
    inline def setRenderHeader(value: () => js.UndefOr[Element]): Self = StObject.set(x, "renderHeader", js.Any.fromFunction0(value))
