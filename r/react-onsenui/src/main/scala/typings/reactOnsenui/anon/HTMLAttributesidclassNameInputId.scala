...
/* Inlined react-onsenui.react-onsenui.HTMLAttributes<'id' | 'className' | 'style'> & {  modifier :string | undefined,   disabled :boolean | undefined,   onChange :(e : std.Event): void | undefined,   value :string | undefined,   checked :boolean | undefined,   inputId :string | undefined,   name :string | undefined} */
@js.native
