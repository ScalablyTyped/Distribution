...
@js.native
trait HTMLAttributesidclassNameAutoFocus_ extends js.Object {
...
object HTMLAttributesidclassNameAutoFocus_ {
  
  @scala.inline
  def apply(): HTMLAttributesidclassNameAutoFocus_ = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLAttributesidclassNameAutoFocus_]
  }
  
  @scala.inline
  implicit class HTMLAttributesidclassNameAutoFocus_Ops[Self <: HTMLAttributesidclassNameAutoFocus_] (val x: Self) extends AnyVal {
