...
import typings.reactOnsenui.anon.ContentStyle
...
class Page protected ()
  extends Component[ContentStyle, js.Any] {
  def this(props: HTMLAttributesidclassName & ContentStyle) = this()
  /**
    * @deprecated
    * @see https://reactjs.org/docs/legacy-context.html
    */
  def this(props: HTMLAttributesidclassName & ContentStyle, context: js.Any) = this()
}
