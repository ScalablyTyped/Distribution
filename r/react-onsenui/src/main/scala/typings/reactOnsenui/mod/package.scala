...
package object mod {
  ...
  type InputHTMLAttributes[K /* <: /* keyof react.react.InputHTMLAttributes<{}> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 204 */ js.Any */] = typings.std.Partial[typings.std.Pick[typings.react.mod.InputHTMLAttributes[js.Object], K]]
