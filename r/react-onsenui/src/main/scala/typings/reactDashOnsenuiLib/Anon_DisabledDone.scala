...
object Anon_DisabledDone {
  ...
  def apply(
    ...
    onChange: /* e */ reactDashOnsenuiLib.reactDashOnsenuiMod.PullHookChangeEvent => scala.Unit = null,
    onLoad: /* done */ js.Function0[scala.Unit] => scala.Unit = null,
    onPull: () => scala.Unit = null,
