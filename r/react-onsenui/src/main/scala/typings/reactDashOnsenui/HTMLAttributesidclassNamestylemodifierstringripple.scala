...
/* Inlined react-onsenui.react-onsenui.HTMLAttributes<'id' | 'className' | 'style'> & {  modifier ? :string,   ripple ? :boolean,   position ? :string,   disabled ? :boolean,   onClick ? :(e ? : react.react.MouseEvent<std.HTMLElement, react.NativeMouseEvent>): void,   name ? :string} */
