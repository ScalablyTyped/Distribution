...
trait HTMLAttributesidclassNamestyleonCancelvoidisOpenbo extends js.Object {
...
object HTMLAttributesidclassNamestyleonCancelvoidisOpenbo {
  @scala.inline
  def apply(
  ...
  ): HTMLAttributesidclassNamestyleonCancelvoidisOpenbo = {
    ...
    __obj.asInstanceOf[HTMLAttributesidclassNamestyleonCancelvoidisOpenbo]
  }
}
