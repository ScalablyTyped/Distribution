...
/* Inlined react-onsenui.react-onsenui.HTMLAttributes<'id' | 'className' | 'style'> & {  modifier ? :string,   onClick ? :(e ? : react.react.MouseEvent<std.HTMLElement, react.NativeMouseEvent>): void} */
