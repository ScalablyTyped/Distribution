...
@js.native
trait EditorDidMount extends js.Object {
...
object EditorDidMount {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(defaultValue = defaultValue.asInstanceOf[js.Any], editorDidMount = js.Any.fromFunction0(editorDidMount), editorWillMount = js.Any.fromFunction0(editorWillMount), height = height.asInstanceOf[js.Any], language = language.asInstanceOf[js.Any], onChange = js.Any.fromFunction0(onChange), original = original.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
    __obj.asInstanceOf[EditorDidMount]
  }
  
  @scala.inline
  implicit class EditorDidMountOps[Self <: EditorDidMount] (val x: Self) extends AnyVal {
