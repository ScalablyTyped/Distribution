...
import typings.roslib.roslibMod.Message
import typings.roslib.roslibMod.Quaternion
import typings.roslib.roslibMod.ServiceRequest
import typings.roslib.roslibMod.Transform
...
@js.native
object roslibMod extends js.Object {
  @js.native
  ...
  class Ros protected () extends js.Object {
    /**
    		 ...
    		 */
    def this(options: Anon_GroovyCompatibility) = this()
    /**
  ...
  class Service protected () extends js.Object {
    /**
    		 ...
    		 */
    def this(data: Anon_NameRos) = this()
    // getter
  ...
  class TFClient protected () extends js.Object {
    /**
      ...
      */
    def this(options: Anon_AngularThres) = this()
    /**
