...
object anon {
  ...
  object PartialStyles {
    ...
    @scala.inline
    implicit class PartialStylesMutableBuilder[Self <: PartialStyles] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setBmBurgerBars(value: PartialCSSStyleDeclaratio): Self = StObject.set(x, "bmBurgerBars", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBmBurgerBarsUndefined: Self = StObject.set(x, "bmBurgerBars", js.undefined)
      
      @scala.inline
      def setBmBurgerButton(value: PartialCSSStyleDeclaratio): Self = StObject.set(x, "bmBurgerButton", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBmBurgerButtonUndefined: Self = StObject.set(x, "bmBurgerButton", js.undefined)
