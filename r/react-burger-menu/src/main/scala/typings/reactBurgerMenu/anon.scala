...
object anon {
  ...
  object PartialStyles {
    ...
    inline def apply(): PartialStyles = {
      val __obj = js.Dynamic.literal()
    ...
    implicit open class MutableBuilder[Self <: PartialStyles] (val x: Self) extends AnyVal {
      ...
      inline def setBmBurgerBarsUndefined: Self = StObject.set(x, "bmBurgerBars", js.undefined)
      ...
      inline def setBmBurgerButtonUndefined: Self = StObject.set(x, "bmBurgerButton", js.undefined)
