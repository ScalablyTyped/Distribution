...
import typings.reactNativeCommunityPicker.typingsPickerIOSMod.PickerIOSProps
import typings.reactNativeCommunityPicker.typingsPickerMod.PickerItemProps
import typings.reactNativeCommunityPicker.typingsPickerMod.PickerProps
...
object mod {
  ...
  open class Picker protected ()
    extends typings.reactNativeCommunityPicker.typingsPickerMod.Picker {
  ...
  open class PickerIOS protected ()
    extends typings.reactNativeCommunityPicker.typingsPickerIOSMod.PickerIOS {
  ...
  object PickerIOS {
    ...
    @js.native
    open class Item ()
      extends typings.reactNativeCommunityPicker.typingsPickerIOSMod.PickerIOS.Item
  }
}
