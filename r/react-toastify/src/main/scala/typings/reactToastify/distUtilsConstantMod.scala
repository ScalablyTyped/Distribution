...
object distUtilsConstantMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactToastify.reactToastifyStrings.TOP_LEFT
    - typings.reactToastify.reactToastifyStrings.TOP_RIGHT
    - typings.reactToastify.reactToastifyStrings.TOP_CENTER
    - typings.reactToastify.reactToastifyStrings.BOTTOM_LEFT
    - typings.reactToastify.reactToastifyStrings.BOTTOM_RIGHT
    - typings.reactToastify.reactToastifyStrings.BOTTOM_CENTER
  */
