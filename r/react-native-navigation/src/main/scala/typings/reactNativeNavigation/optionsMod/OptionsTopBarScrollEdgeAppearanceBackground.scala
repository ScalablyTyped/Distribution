...
@js.native
trait OptionsTopBarScrollEdgeAppearanceBackground extends js.Object {
...
object OptionsTopBarScrollEdgeAppearanceBackground {
  ...
  @scala.inline
  implicit class OptionsTopBarScrollEdgeAppearanceBackgroundOps[Self <: OptionsTopBarScrollEdgeAppearanceBackground] (val x: Self) extends AnyVal {
