...
object OverlayOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(handleKeyboardEvents)) __obj.updateDynamic("handleKeyboardEvents")(handleKeyboardEvents.get.asInstanceOf[js.Any])
    if (!js.isUndefined(interceptTouchOutside)) __obj.updateDynamic("interceptTouchOutside")(interceptTouchOutside.get.asInstanceOf[js.Any])
