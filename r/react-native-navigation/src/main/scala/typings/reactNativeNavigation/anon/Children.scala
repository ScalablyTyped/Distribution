...
object Children {
  ...
  extension [Self <: Children](x: Self) {
    ...
    inline def setOnPeekIn(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "onPeekIn", value.asInstanceOf[js.Any])
    
    inline def setOnPeekOut(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "onPeekOut", value.asInstanceOf[js.Any])
    
    inline def setOnPress(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "onPress", value.asInstanceOf[js.Any])
    
    inline def setOnPressIn(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "onPressIn", value.asInstanceOf[js.Any])
    
    inline def setTouchableComponent(value: Requireable[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "touchableComponent", value.asInstanceOf[js.Any])
  }
}
