...
object libDistSrcInterfacesLayoutMod {
  ...
  object LayoutBottomTabs {
    ...
    implicit open class MutableBuilder[Self <: LayoutBottomTabs] (val x: Self) extends AnyVal {
      ...
      inline def setChildrenVarargs(value: LayoutTabsChildren*): Self = StObject.set(x, "children", js.Array(value*))
  ...
  trait LayoutRoot extends StObject {
    ...
    var modals: js.UndefOr[Any] = js.undefined
    
    var overlays: js.UndefOr[Any] = js.undefined
  ...
  object LayoutRoot {
    ...
    implicit open class MutableBuilder[Self <: LayoutRoot] (val x: Self) extends AnyVal {
      ...
      inline def setOverlays(value: Any): Self = StObject.set(x, "overlays", value.asInstanceOf[js.Any])
  ...
  trait LayoutSideMenu extends StObject {
    ...
    /**
      ...
      */
    var left: js.UndefOr[Layout[js.Object]] = js.undefined
    ...
    /**
      ...
      */
    var right: js.UndefOr[Layout[js.Object]] = js.undefined
  }
  object LayoutSideMenu {
    ...
    implicit open class MutableBuilder[Self <: LayoutSideMenu] (val x: Self) extends AnyVal {
      ...
      inline def setLeft(value: Layout[js.Object]): Self = StObject.set(x, "left", value.asInstanceOf[js.Any])
      ...
      inline def setRight(value: Layout[js.Object]): Self = StObject.set(x, "right", value.asInstanceOf[js.Any])
  ...
  object LayoutStack {
    ...
    implicit open class MutableBuilder[Self <: LayoutStack] (val x: Self) extends AnyVal {
      ...
      inline def setChildrenVarargs(value: LayoutStackChildren*): Self = StObject.set(x, "children", js.Array(value*))
