...
@js.native
trait ParserOptionspluginsArray extends js.Object {
...
object ParserOptionspluginsArray {
  ...
  @scala.inline
  implicit class ParserOptionspluginsArrayOps[Self <: ParserOptionspluginsArray] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPlugins(value: js.UndefOr[js.Array[ParserPlugin]] with js.Array[ParserPlugin]): Self = this.set("plugins", value.asInstanceOf[js.Any])
