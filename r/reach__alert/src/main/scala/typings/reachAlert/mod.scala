...
import typings.reachAlert.reachAlertStrings.`additions removals`
import typings.reachAlert.reachAlertStrings.`additions text`
import typings.reachAlert.reachAlertStrings.`inline`
import typings.reachAlert.reachAlertStrings.`removals additions`
import typings.reachAlert.reachAlertStrings.`removals text`
import typings.reachAlert.reachAlertStrings.`text additions`
import typings.reachAlert.reachAlertStrings.`text removals`
...
object mod extends Shortcut {
  ...
  /* Inlined {  type :'assertive' | 'polite' | undefined} & react.react.HTMLProps<std.HTMLDivElement> */
  @js.native
  trait AlertProps extends StObject {
    ...
    var `type`: (js.UndefOr[assertive | polite]) with js.UndefOr[String] = js.native
  ...
  object AlertProps {
    ...
    @scala.inline
    def apply(`type`: (js.UndefOr[assertive | polite]) with js.UndefOr[String]): AlertProps = {
    ...
    implicit class AlertPropsMutableBuilder[Self <: AlertProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setType(value: (js.UndefOr[assertive | polite]) with js.UndefOr[String]): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
