package typings.reactDashMovable.libListMod

import typings.react.reactMod.Component
import typings.react.reactMod.KeyboardEvent
import typings.react.reactMod.RefObject
import typings.react.reactMod.WheelEvent
import typings.reactDashMovable.Anon_InitialX
import typings.reactDashMovable.Anon_ScrollingSpeed
...
trait List[Value]
  ...
  @JSName("state")
  var state_List: Anon_InitialX = js.native
  ...
  def componentDidUpdate_MList(_prevProps: js.Any, prevState: Anon_ScrollingSpeed): Unit = js.native
