...
object IProps {
  ...
  implicit class IPropsOps[Self <: IProps[_], Value] (val x: Self with IProps[Value]) extends AnyVal {
    ...
    @scala.inline
    def setRenderItem(value: RenderItemParams[Value] => ReactNode): Self = this.set("renderItem", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRenderList(value: RenderListParams => ReactNode): Self = this.set("renderList", js.Any.fromFunction1(value))
