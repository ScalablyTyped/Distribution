...
trait TooltipArg extends js.Object {
  var arrowRef: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ReactPopper.RefHandler */ js.Any = js.native
  var placement: Placement = js.native
  var tooltipRef: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ReactPopper.RefHandler */ js.Any = js.native
