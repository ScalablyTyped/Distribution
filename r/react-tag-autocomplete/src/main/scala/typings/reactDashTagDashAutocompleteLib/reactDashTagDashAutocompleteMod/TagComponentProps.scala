...
trait TagComponentProps extends js.Object {
  ...
  var tag: Tag
  def onDelete(event: reactLib.reactMod.ReactNs.MouseEvent[stdLib.HTMLButtonElement, reactLib.NativeMouseEvent]): scala.Unit
}
...
object TagComponentProps {
  ...
  def apply(
    ...
    onDelete: reactLib.reactMod.ReactNs.MouseEvent[stdLib.HTMLButtonElement, reactLib.NativeMouseEvent] => scala.Unit,
    tag: Tag
  ): TagComponentProps = {
