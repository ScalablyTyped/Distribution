...
import typings.rcSegmented.rcSegmentedStrings.`removals additions`
...
import typings.rcSegmented.rcSegmentedStrings.copy
import typings.rcSegmented.rcSegmentedStrings.date
import typings.rcSegmented.rcSegmentedStrings.decimal
import typings.rcSegmented.rcSegmentedStrings.descending
import typings.rcSegmented.rcSegmentedStrings.dialog
import typings.rcSegmented.rcSegmentedStrings.email
import typings.rcSegmented.rcSegmentedStrings.environment
import typings.rcSegmented.rcSegmentedStrings.execute
import typings.rcSegmented.rcSegmentedStrings.grammar
import typings.rcSegmented.rcSegmentedStrings.grid
import typings.rcSegmented.rcSegmentedStrings.horizontal
import typings.rcSegmented.rcSegmentedStrings.inherit
import typings.rcSegmented.rcSegmentedStrings.link
import typings.rcSegmented.rcSegmentedStrings.list
import typings.rcSegmented.rcSegmentedStrings.listbox
import typings.rcSegmented.rcSegmentedStrings.location
import typings.rcSegmented.rcSegmentedStrings.ltr
import typings.rcSegmented.rcSegmentedStrings.menu
import typings.rcSegmented.rcSegmentedStrings.mixed
import typings.rcSegmented.rcSegmentedStrings.move
import typings.rcSegmented.rcSegmentedStrings.no
import typings.rcSegmented.rcSegmentedStrings.none
import typings.rcSegmented.rcSegmentedStrings.numeric
import typings.rcSegmented.rcSegmentedStrings.off
import typings.rcSegmented.rcSegmentedStrings.on
import typings.rcSegmented.rcSegmentedStrings.other
import typings.rcSegmented.rcSegmentedStrings.page
import typings.rcSegmented.rcSegmentedStrings.polite
import typings.rcSegmented.rcSegmentedStrings.popup
import typings.rcSegmented.rcSegmentedStrings.removals
import typings.rcSegmented.rcSegmentedStrings.rtl
import typings.rcSegmented.rcSegmentedStrings.search
import typings.rcSegmented.rcSegmentedStrings.spelling
import typings.rcSegmented.rcSegmentedStrings.step
import typings.rcSegmented.rcSegmentedStrings.tel
import typings.rcSegmented.rcSegmentedStrings.text
import typings.rcSegmented.rcSegmentedStrings.time
import typings.rcSegmented.rcSegmentedStrings.tree
import typings.rcSegmented.rcSegmentedStrings.url
import typings.rcSegmented.rcSegmentedStrings.user
import typings.rcSegmented.rcSegmentedStrings.vertical
import typings.rcSegmented.rcSegmentedStrings.yes
...
object mod extends Shortcut {
  ...
  object SegmentedLabeledOption {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SegmentedLabeledOption] (val x: Self) extends AnyVal {
