...
object FirebaseAppConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(automaticDataCollectionEnabled)) __obj.updateDynamic("automaticDataCollectionEnabled")(automaticDataCollectionEnabled.get.asInstanceOf[js.Any])
    if (!js.isUndefined(automaticResourceManagement)) __obj.updateDynamic("automaticResourceManagement")(automaticResourceManagement.get.asInstanceOf[js.Any])
