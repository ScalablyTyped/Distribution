...
object buildBundleMod {
  
  @JSImport("@react-native-community/cli-plugin-metro/build/commands/bundle/buildBundle", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default(args: CommandLineArgs, ctx: Config): js.Promise[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(args.asInstanceOf[js.Any], ctx.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Any]]
  inline def default(args: CommandLineArgs, ctx: Config, output: Any): js.Promise[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(args.asInstanceOf[js.Any], ctx.asInstanceOf[js.Any], output.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Any]]
