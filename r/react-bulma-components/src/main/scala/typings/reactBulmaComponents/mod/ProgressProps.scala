...
/* Inlined parent react-bulma-components.react-bulma-components.ProgressModifierProps */
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'progress'>, 'color' | 'max' | 'value' | 'unselectable'>> */
