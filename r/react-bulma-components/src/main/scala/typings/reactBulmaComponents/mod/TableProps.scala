...
/* Inlined parent react-bulma-components.react-bulma-components.TableModifierProps */
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'table'>, 'unselectable'>> */
