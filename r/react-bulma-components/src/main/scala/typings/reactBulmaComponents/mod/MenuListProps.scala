...
/* Inlined parent react-bulma-components.react-bulma-components.MenuListModifierProps */
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'ul'>, 'unselectable'>> */
