...
/* Inlined react-bulma-components.react-bulma-components.ModifierProps & react-bulma-components.react-bulma-components.ImageProps */
trait CardImageProps extends js.Object {
...
object CardImageProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[CardImageProps]
  }
}
