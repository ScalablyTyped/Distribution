...
/* Inlined parent react-bulma-components.react-bulma-components.TextareaModifierProps */
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'textarea'>, 'color' | 'unselectable'>> */
