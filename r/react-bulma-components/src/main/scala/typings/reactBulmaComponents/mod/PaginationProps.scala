...
/* Inlined parent react-bulma-components.react-bulma-components.PaginationModifierProps */
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'nav'>, 'onChange' | 'unselectable'>> */
