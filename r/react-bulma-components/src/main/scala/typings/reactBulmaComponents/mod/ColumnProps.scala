...
/* Inlined parent react-bulma-components.react-bulma-components.ColumnModifierProps */
/* Inlined parent react-bulma-components.react-bulma-components.ColumnSizeModifierProps */
