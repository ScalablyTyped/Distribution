...
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'footer'>, 'unselectable'>> */
trait ModalCardFootProps extends js.Object {
...
object ModalCardFootProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ModalCardFootProps]
  }
}
