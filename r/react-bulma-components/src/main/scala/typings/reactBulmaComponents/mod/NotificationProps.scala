...
/* Inlined parent react-bulma-components.react-bulma-components.Omit<react-bulma-components.react-bulma-components.ElementProps, 'color'> */
/* Inlined parent react-bulma-components.react-bulma-components.NotificationModifierProps */
