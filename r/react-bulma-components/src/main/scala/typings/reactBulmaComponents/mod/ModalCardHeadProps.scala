...
/* Inlined parent react-bulma-components.react-bulma-components.ModalCardHeadModifierProps */
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'header'>, 'unselectable'>> */
