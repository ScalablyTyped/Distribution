...
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'div'>, 'unselectable'>> */
trait NavbarDividerProps extends js.Object {
...
object NavbarDividerProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[NavbarDividerProps]
  }
}
