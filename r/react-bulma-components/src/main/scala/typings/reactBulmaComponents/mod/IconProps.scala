...
/* Inlined parent react-bulma-components.react-bulma-components.IconModifierProps */
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'span'>, 'color' | 'unselectable'>> */
