...
/* Inlined parent react-bulma-components.react-bulma-components.InputFileModifierProps */
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'input'>, 'color' | 'size' | 'unselectable'>> */
trait InputFileProps extends js.Object {
