...
/* Inlined parent react-bulma-components.react-bulma-components.DropdownModifierProps */
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'div'>, 'color' | 'onChange' | 'unselectable'>> */
