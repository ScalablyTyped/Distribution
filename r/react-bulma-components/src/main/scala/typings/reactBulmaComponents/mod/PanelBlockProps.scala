...
/* Inlined react-bulma-components.react-bulma-components.ElementProps & react-bulma-components.react-bulma-components.PanelBlockModifierProps */
trait PanelBlockProps extends js.Object {
