...
/* Inlined parent react-bulma-components.react-bulma-components.ImageModifierProps */
/* Inlined parent std.Partial<react-bulma-components.react-bulma-components.Omit<react.react.ComponentPropsWithoutRef<'figure'>, 'unselectable'>> */
