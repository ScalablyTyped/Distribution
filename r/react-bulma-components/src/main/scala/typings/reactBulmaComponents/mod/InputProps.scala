...
import typings.reactBulmaComponents.reactBulmaComponentsStrings.`datetime-local`
...
import typings.reactBulmaComponents.reactBulmaComponentsStrings.color
import typings.reactBulmaComponents.reactBulmaComponentsStrings.date
import typings.reactBulmaComponents.reactBulmaComponentsStrings.email
...
import typings.reactBulmaComponents.reactBulmaComponentsStrings.number
import typings.reactBulmaComponents.reactBulmaComponentsStrings.password
import typings.reactBulmaComponents.reactBulmaComponentsStrings.right
import typings.reactBulmaComponents.reactBulmaComponentsStrings.search
...
import typings.reactBulmaComponents.reactBulmaComponentsStrings.tel
import typings.reactBulmaComponents.reactBulmaComponentsStrings.text
import typings.reactBulmaComponents.reactBulmaComponentsStrings.time
...
/* Inlined parent react-bulma-components.react-bulma-components.InputModifierProps */
...
trait InputProps extends js.Object {
  ...
  var `type`: js.UndefOr[
    text | email | tel | password | number | search | color | date | time | `datetime-local`
  ] = js.undefined
...
object InputProps {
  ...
  def apply(
    ...
    `type`: text | email | tel | password | number | search | color | date | time | `datetime-local` = null,
