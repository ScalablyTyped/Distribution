...
@js.native
object reactDashLifecycleDashComponentModMembers extends js.Object {
  ...
  def applyLifecycle[P, S](component: reactLib.reactMod.ReactNs.ComponentClass[P, S]): reactLib.reactMod.ReactNs.ComponentClass[
    P with (LifecycleDispatchProps[P, S]) with (LifecycleDispatchProps[P with (LifecycleDispatchProps[P, S]), reactLib.reactMod.ReactNs.ComponentState]), 
