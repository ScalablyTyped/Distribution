...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "reach__polymorphic" % "0.18.0-530903",
  "org.scalablytyped" %%% "reach__popover" % "0.18.0-46c87d",
  "org.scalablytyped" %%% "reach__rect" % "0.18.0-78b449",
