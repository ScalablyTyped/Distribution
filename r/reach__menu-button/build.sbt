...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "reach__polymorphic" % "0.18.0-4f2c18",
  "org.scalablytyped" %%% "reach__popover" % "0.18.0-7b66a7",
  "org.scalablytyped" %%% "reach__rect" % "0.18.0-da89ee",
