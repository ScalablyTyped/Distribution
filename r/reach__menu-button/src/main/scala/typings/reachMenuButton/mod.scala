...
import typings.reachMenuButton.anon.As
import typings.reachMenuButton.anon.Children
...
object mod {
  ...
  @js.native
  val MenuButton: FC[MenuButtonProps] = js.native
  ...
  @js.native
  val MenuList: FC[MenuListProps] = js.native
  ...
  trait MenuButtonProps
    ...
    @JSName("onClick")
    var onClick_MenuButtonProps: js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]] = js.undefined
    
    @JSName("onKeyDown")
    var onKeyDown_MenuButtonProps: js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLElement], Unit]] = js.undefined
  }
  ...
  trait MenuItemProps
    ...
    @JSName("onClick")
    var onClick_MenuItemProps: js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]] = js.undefined
    
    @JSName("onKeyDown")
    var onKeyDown_MenuItemProps: js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLElement], Unit]] = js.undefined
    
    @JSName("onMouseMove")
    var onMouseMove_MenuItemProps: js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]] = js.undefined
    
    @JSName("onSelect")
    var onSelect_MenuItemProps: js.UndefOr[js.Function0[Unit]] = js.undefined
  ...
  type MenuLinkProps[T /* <: SupportedMenuLinkComponent */] = ResolvedMenuLinkProps[T] & As[T]
  
  type MenuListProps = (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement]) & Children
