...
import typings.reachMenuButton.reachMenuButtonStrings.`additions removals`
...
import typings.reachMenuButton.reachMenuButtonStrings.`removals additions`
import typings.reachMenuButton.reachMenuButtonStrings.`removals text`
import typings.reachMenuButton.reachMenuButtonStrings.`text additions`
import typings.reachMenuButton.reachMenuButtonStrings.`text removals`
...
trait MenuButtonProps extends js.Object {
  ...
  var onClick: (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]]) with js.UndefOr[MouseEventHandler[HTMLButtonElement]] = js.native
  ...
  var onInvalid: js.UndefOr[FormEventHandler[HTMLButtonElement]] = js.native
   ...
   // also a Media Event
  // Keyboard Events
  var onKeyDown: (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLElement], Unit]]) with js.UndefOr[KeyboardEventHandler[HTMLButtonElement]] = js.native
...
object MenuButtonProps {
  ...
  @scala.inline
  def apply(
    onClick: (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]]) with js.UndefOr[MouseEventHandler[HTMLButtonElement]],
    onKeyDown: (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLElement], Unit]]) with js.UndefOr[KeyboardEventHandler[HTMLButtonElement]]
  ): MenuButtonProps = {
  ...
  @scala.inline
  implicit class MenuButtonPropsOps[Self <: MenuButtonProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(
      value: (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]]) with js.UndefOr[MouseEventHandler[HTMLButtonElement]]
    ): Self = this.set("onClick", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnKeyDown(
      value: (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLElement], Unit]]) with js.UndefOr[KeyboardEventHandler[HTMLButtonElement]]
    ...
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLButtonElement | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: LegacyRef[HTMLButtonElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
