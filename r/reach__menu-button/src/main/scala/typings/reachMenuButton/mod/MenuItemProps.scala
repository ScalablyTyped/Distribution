...
trait MenuItemProps extends js.Object {
  ...
  var onClick: js.UndefOr[
    (js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]) | MouseEventHandler[HTMLDivElement]
  ] = js.native
  // Composition Events
  ...
  var onKeyDown: js.UndefOr[
    (js.Function1[/* e */ KeyboardEvent[HTMLElement], Unit]) | KeyboardEventHandler[HTMLDivElement]
  ] = js.native
