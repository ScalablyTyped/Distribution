...
trait MenuItemProps extends js.Object {
  ...
  var onClick: (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]]) with js.UndefOr[MouseEventHandler[HTMLDivElement]] = js.native
  ...
  var onInvalid: js.UndefOr[FormEventHandler[HTMLDivElement]] = js.native
   ...
   // also a Media Event
  // Keyboard Events
  var onKeyDown: (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLElement], Unit]]) with js.UndefOr[KeyboardEventHandler[HTMLDivElement]] = js.native
  ...
  var onMouseMove: (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]]) with js.UndefOr[MouseEventHandler[HTMLDivElement]] = js.native
...
object MenuItemProps {
  ...
  @scala.inline
  def apply(
    onClick: (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]]) with js.UndefOr[MouseEventHandler[HTMLDivElement]],
    onKeyDown: (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLElement], Unit]]) with js.UndefOr[KeyboardEventHandler[HTMLDivElement]],
    onMouseMove: (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]]) with js.UndefOr[MouseEventHandler[HTMLDivElement]],
  ...
  implicit class MenuItemPropsOps[Self <: MenuItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(
      value: (js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]]) with js.UndefOr[MouseEventHandler[HTMLDivElement]]
    ): Self = this.set("onClick", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnKeyDown(
      value: (js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLElement], Unit]]) with js.UndefOr[KeyboardEventHandler[HTMLDivElement]]
