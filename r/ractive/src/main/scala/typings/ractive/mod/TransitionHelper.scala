...
trait TransitionHelper extends js.Object {
  ...
  /**
  	 ...
  	 */
  def animateStyle(map: ValueMap, opts: TransitionOpts with js.Object): js.Promise[Unit] = js.native
  def animateStyle(map: ValueMap, opts: TransitionOpts with js.Object, complete: js.Function0[Unit]): js.Promise[Unit] = js.native
  /**
  	 ...
  	 * @returns a Promise that resolves when the animation is complete
  	 */
  def animateStyle(prop: String, value: js.Any, opts: TransitionOpts with js.Object): js.Promise[Unit] = js.native
  def animateStyle(prop: String, value: js.Any, opts: TransitionOpts with js.Object, complete: js.Function0[Unit]): js.Promise[Unit] = js.native
  /**
