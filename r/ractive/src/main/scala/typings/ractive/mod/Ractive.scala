...
class Ractive[T /* <: Ractive[T] */] () extends js.Object {
  ...
  def transition(transition: String, node: HTMLElement, opts: TransitionOpts with js.Object): js.Promise[Unit] = js.native
  def transition(transition: String, opts: TransitionOpts with js.Object): js.Promise[Unit] = js.native
  ...
  def transition(transition: Transition, node: HTMLElement, opts: TransitionOpts with js.Object): js.Promise[Unit] = js.native
  def transition(transition: Transition, opts: TransitionOpts with js.Object): js.Promise[Unit] = js.native
  /**
