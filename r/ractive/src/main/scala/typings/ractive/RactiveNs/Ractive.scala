...
trait Ractive extends js.Object {
  // Properties
  // Since 0.7.1
  var container: typings.ractive.RactiveNs.Ractive = js.native
   // TODO: Ractive?
  var nodes: js.Object = js.native
  // Since 0.7.1
  var parent: typings.ractive.RactiveNs.Ractive = js.native
  var partials: js.Object = js.native
   // TODO: Ractive?
  // Since 0.7.1
  var root: typings.ractive.RactiveNs.Ractive = js.native
   // TODO: Ractive?
  ...
  // live default false
  def findAllComponents(name: String): js.Array[typings.ractive.RactiveNs.Ractive] = js.native
  def findAllComponents(name: String, options: Anon_Live): js.Array[typings.ractive.RactiveNs.Ractive] = js.native
  // TODO: maybe exist, in that case it is undocumented
  // findAllComponents(): Ractive[]
  def findComponent(): typings.ractive.RactiveNs.Ractive = js.native
  def findComponent(name: String): typings.ractive.RactiveNs.Ractive = js.native
  // Since 0.7.1
  def findContainer(name: String): typings.ractive.RactiveNs.Ractive = js.native
   // TODO: Ractive?
  // Since 0.7.1
  def findParent(name: String): typings.ractive.RactiveNs.Ractive = js.native
   // TODO: Ractive?
  ...
  def off(): typings.ractive.RactiveNs.Ractive = js.native
  def off(eventName: String): typings.ractive.RactiveNs.Ractive = js.native
  def off(
    eventName: String,
    handler: js.Function2[/* event */ js.UndefOr[Event | js.Any], /* repeated */ js.Any, _]
  ): typings.ractive.RactiveNs.Ractive = js.native
  def on(
    eventName: String,
    handler: js.Function2[/* event */ js.UndefOr[Event | js.Any], /* repeated */ js.Any, _]
  ): Observe = js.native
