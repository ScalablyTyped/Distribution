package typings
package rmcDashPullDashToDashRefreshLib.esPullToRefreshMod
...
@js.native
trait PullToRefresh
  extends reactLib.reactMod.Component[rmcDashPullDashToDashRefreshLib.esPropsTypeMod.PropsType, js.Any, js.Any] {
