...
object typesAdventureTimeMod {
  
  @JSImport("react-json-pretty/types/adventure_time", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-json-pretty/types/adventure_time", "boolean")
  @js.native
  ...
  @JSImport("react-json-pretty/types/adventure_time", "error")
  @js.native
  ...
  @JSImport("react-json-pretty/types/adventure_time", "value")
  @js.native
