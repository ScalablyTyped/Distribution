...
object jsonprettyAcaiMod {
  
  @JSImport("react-json-pretty/types/JSONPretty.acai", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-json-pretty/types/JSONPretty.acai", "boolean")
  @js.native
