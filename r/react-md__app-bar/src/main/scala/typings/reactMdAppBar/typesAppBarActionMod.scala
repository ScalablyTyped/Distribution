...
object typesAppBarActionMod {
  ...
  - typings.reactMdAppBar.typesUseActionClassNameMod.AppBarActionClassNameProps because var conflicts: className. Inlined first, last */ trait AppBarActionProps
    extends StObject
       with ButtonProps
