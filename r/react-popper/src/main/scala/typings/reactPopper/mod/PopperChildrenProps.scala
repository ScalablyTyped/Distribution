...
object PopperChildrenProps {
  ...
  implicit class PopperChildrenPropsOps[Self <: PopperChildrenProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForceUpdate(value: () => PartialState): Self = this.set("forceUpdate", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setUpdate(value: () => js.Promise[Null | PartialState]): Self = this.set("update", js.Any.fromFunction0(value))
