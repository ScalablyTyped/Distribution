...
import typings.reactAuthKit.actionsMod.ActionType.RefreshToken
import typings.reactAuthKit.actionsMod.ActionType.SignIn
import typings.reactAuthKit.actionsMod.ActionType.SignOut
...
object actionsMod {
  ...
  object ActionType extends StObject {
    ...
    sealed trait RefreshToken
      extends StObject
         with ActionType
    /* 2 */ val RefreshToken: typings.reactAuthKit.actionsMod.ActionType.RefreshToken & Double = js.native
    
    @js.native
    sealed trait SignIn
      extends StObject
         with ActionType
    /* 0 */ val SignIn: typings.reactAuthKit.actionsMod.ActionType.SignIn & Double = js.native
    
    @js.native
    sealed trait SignOut
      extends StObject
         with ActionType
    /* 1 */ val SignOut: typings.reactAuthKit.actionsMod.ActionType.SignOut & Double = js.native
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.reactAuthKit.actionsMod.SignInAction
    - typings.reactAuthKit.actionsMod.SignOutAction
    - typings.reactAuthKit.actionsMod.RefreshTokenAction
  */
  trait AuthActions extends StObject
  object AuthActions {
    
    inline def RefreshTokenAction(payload: RefreshTokenActionPayload, `type`: RefreshToken): typings.reactAuthKit.actionsMod.RefreshTokenAction = {
      val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.reactAuthKit.actionsMod.RefreshTokenAction]
    }
    
    inline def SignInAction(payload: SignInActionPayload, `type`: SignIn): typings.reactAuthKit.actionsMod.SignInAction = {
      val __obj = js.Dynamic.literal(payload = payload.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.reactAuthKit.actionsMod.SignInAction]
    }
    
    inline def SignOutAction(`type`: SignOut): typings.reactAuthKit.actionsMod.SignOutAction = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.reactAuthKit.actionsMod.SignOutAction]
    }
  }
