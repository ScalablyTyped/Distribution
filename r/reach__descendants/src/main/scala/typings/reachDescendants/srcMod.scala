...
object srcMod {
  ...
  @JSImport("@reach/descendants/dist/declarations/src", JSImport.Namespace)
  @js.native
  ...
  trait DescendantContextValue[DescendantType /* <: Descendant[HTMLElement] */] extends StObject {
    ...
    def registerDescendant(descendant: DescendantType): Unit
    
    @JSName("unregisterDescendant")
    def unregisterDescendant_element(
      element: /* import warning: importer.ImportType#apply Failed type conversion: DescendantType['element'] */ js.Any
    ): Unit
  }
  object DescendantContextValue {
    
    inline def apply[DescendantType /* <: Descendant[HTMLElement] */](
      descendants: js.Array[DescendantType],
      registerDescendant: DescendantType => Unit,
      unregisterDescendant: /* import warning: importer.ImportType#apply Failed type conversion: DescendantType['element'] */ js.Any => Unit
    ): DescendantContextValue[DescendantType] = {
      val __obj = js.Dynamic.literal(descendants = descendants.asInstanceOf[js.Any], registerDescendant = js.Any.fromFunction1(registerDescendant), unregisterDescendant = js.Any.fromFunction1(unregisterDescendant))
    ...
    extension [Self <: DescendantContextValue[?], DescendantType /* <: Descendant[HTMLElement] */](x: Self & DescendantContextValue[DescendantType]) {
      ...
      inline def setRegisterDescendant(value: DescendantType => Unit): Self = StObject.set(x, "registerDescendant", js.Any.fromFunction1(value))
      
      inline def setUnregisterDescendant(
        value: /* import warning: importer.ImportType#apply Failed type conversion: DescendantType['element'] */ js.Any => Unit
      ): Self = StObject.set(x, "unregisterDescendant", js.Any.fromFunction1(value))
    }
  }
  
  type SomeElement[T] = HTMLElement | T
}
