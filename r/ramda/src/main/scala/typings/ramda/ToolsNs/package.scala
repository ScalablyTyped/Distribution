...
package object ToolsNs {
  ...
  type Drop[N /* <: Double */, T /* <: js.Array[_] */, I /* <: js.Array[_] */] = /* import warning: ImportType.apply Failed type conversion: ramda.Anon_01<T>[ramda.Tools.Length<I> extends N ? 1 : 0] */ js.Any
  type Head[T /* <: js.Array[_] */] = /* import warning: ImportType.apply Failed type conversion: T[0] */ js.Any
  type Iterator[Index /* <: Double */, From /* <: js.Array[_] */, I /* <: js.Array[_] */] = /* import warning: ImportType.apply Failed type conversion: ramda.Anon_01From<From>[ramda.Tools.Pos<I> extends Index ? 1 : 0] */ js.Any
  type Last[T /* <: js.Array[_] */] = /* import warning: ImportType.apply Failed type conversion: ramda.Anon_0<T>[ramda.Tools.HasTail<T> extends true ? 0 : 1] */ js.Any
