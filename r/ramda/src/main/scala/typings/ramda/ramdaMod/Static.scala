...
import typings.ramda.Anon_A
import typings.ramda.Anon_AOr
import typings.ramda.Anon_AT
import typings.ramda.Anon_Obj
import typings.ramda.CurryNs.Curry
import typings.ramda.Fn_B
import typings.ramda.Fn_List
import typings.ramda.Fn_ListArray
import typings.ramda.Fn_ListArrayReadonlyArray
import typings.ramda.Fn_ListArrayReadonlyArrayString
import typings.ramda.Fn_Name
import typings.ramda.Fn_Obj
import typings.ramda.Fn_Xs
import typings.ramda.Fn_XsArray
import typings.ramda.Fn_XsArrayReadonlyArray
import typings.ramda.Fn_XsArrayReadonlyArrayString
import typings.ramda.ToolsNs.ValueOfRecord
...
trait Static extends js.Object {
  ...
  def addIndex[T](fn: js.Function2[/* f */ js.Function1[/* item */ T, Unit], /* list */ js.Array[T], js.Array[T]]): Curry[
    js.Function2[
      /* a */ js.Function3[/* item */ T, /* idx */ Double, /* list */ js.UndefOr[js.Array[T]], Unit], 
      /* b */ js.Array[T], 
      js.Array[T]
    ]
  ] = js.native
  ...
  def addIndex[T, U](
    ...
    js.Function3[
      /* a */ js.Function4[/* acc */ U, /* item */ T, /* idx */ Double, /* list */ js.UndefOr[js.Array[T]], U], 
      /* b */ U, 
      /* c */ js.Array[T], 
      U
    ]
  ...
  /**
    ...
    */
  @JSName("addIndex")
  def addIndex_TU[T, U](fn: js.Function2[/* f */ js.Function1[/* item */ T, U], /* list */ js.Array[T], js.Array[U]]): Curry[
    js.Function2[
      /* a */ js.Function3[/* item */ T, /* idx */ Double, /* list */ js.UndefOr[js.Array[T]], U], 
      /* b */ js.Array[T], 
      js.Array[U]
    ]
  ] = js.native
  ...
  {[ Key in keyof Obj ]: std.ReturnType<Obj[Key]>}
    */ typings.ramda.ramdaStrings.Static with Obj
  ] = js.native
  ...
  def assocPath[T, U](path: Path): Curry[js.Function2[/* a */ T, /* b */ U, U]] = js.native
  ...
  /**
    ...
    */
  def curry[F /* <: js.Function1[/* args */ js.Any, _] */](f: F): Curry[F] = js.native
  /**
  ...
  def eqBy[T, U](fn: js.Function1[/* a */ T, U]): Curry[js.Function2[/* a */ T, /* b */ T, Boolean]] = js.native
  ...
  /**
    * Returns a new list containing only those items that match a given predicate function. The predicate function is passed one argument: (value).
    */
  def filter[T](fn: js.Function1[/* value */ T, Boolean]): FilterOnceApplied[T] = js.native
  /**
    * Returns a new list containing only those items that match a given predicate function. The predicate function is passed one argument: (value).
    */
  def filter[T](fn: js.Function1[/* value */ T, Boolean], list: js.Array[T]): js.Array[T] = js.native
  /**
    * Returns a new list containing only those items that match a given predicate function. The predicate function is passed one argument: (value).
    */
  def filter[T](fn: js.Function1[/* value */ T, Boolean], obj: Dictionary[T]): Dictionary[T] = js.native
  /**
    * Returns a new list containing only those items that match a given predicate function. The predicate function is passed one argument: (value).
    */
  @JSName("filter")
  def filter_TKind_array_Function1[T, Kind /* <: array */](fn: js.Function1[/* value */ T, Boolean]): js.Function1[/* list */ js.Array[T], js.Array[T]] = js.native
  /**
    * Returns a new list containing only those items that match a given predicate function. The predicate function is passed one argument: (value).
    */
  @JSName("filter")
  def filter_TKind_object_Function1[T, Kind /* <: `object` */](fn: js.Function1[/* value */ T, Boolean]): js.Function1[/* list */ Dictionary[T], Dictionary[T]] = js.native
  ...
  @JSName("head")
  def head_T_Any_T[T /* <: js.Any */](list: js.Array[T]): T = js.native
  ...
  /**
    ...
    */
  def isArrayLike(`val`: js.Any): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def isNaN(x: js.Any): Boolean = js.native
  /**
  ...
  @JSName("last")
  def last_T_Any_T[T /* <: js.Any */](list: js.Array[T]): T = js.native
  /**
  ...
  def `match`(regexp: RegExp): js.Function1[/* str */ String, js.Array[_]] = js.native
  /**
    * Tests a regular expression agains a String
    */
  def `match`(regexp: RegExp, str: String): js.Array[_] = js.native
  ...
  def maxBy[T](keyFn: js.Function1[/* a */ T, Ord]): Curry[js.Function2[/* a */ T, /* b */ T, T]] = js.native
  ...
  /**
    ...
    */
  @JSName("mergeAll")
  def mergeAll_T_T[T](list: js.Array[T]): T = js.native
  ...
  def minBy[T](keyFn: js.Function1[/* a */ T, Ord]): Curry[js.Function2[/* a */ T, /* b */ T, T]] = js.native
  ...
  def pathEq(path: Path): Curry[js.Function2[/* a */ _, /* b */ _, Boolean]] = js.native
  ...
  def pathOr[T](defaultValue: T): Curry[js.Function2[/* a */ Path, /* b */ _, T]] = js.native
  ...
  def pathSatisfies[T, U](pred: js.Function1[/* val */ T, Boolean]): Curry[js.Function2[/* a */ Path, /* b */ U, Boolean]] = js.native
  ...
  /**
    ...
    */
  def pluck[K /* <: String */, T](p: K, list: js.Array[T]): js.Array[/* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any] = js.native
  ...
  def prop[P /* <: String */, T](p: P, obj: T): /* import warning: ImportType.apply Failed type conversion: T[P] */ js.Any = js.native
  ...
  def propSatisfies[T, U](pred: js.Function1[/* val */ T, Boolean]): Curry[js.Function2[/* a */ String, /* b */ U, Boolean]] = js.native
  ...
  def reduceBy[T, TResult](valueFn: js.Function2[/* acc */ TResult, /* elem */ T, TResult]): Curry[
    js.Function3[
      /* a */ TResult, 
      /* b */ js.Function1[/* elem */ T, String], 
      /* c */ js.Array[T], 
      StringDictionary[TResult]
    ]
  ] = js.native
  def reduceBy[T, TResult](valueFn: js.Function2[/* acc */ TResult, /* elem */ T, TResult], acc: TResult): Curry[
    js.Function2[
      /* a */ js.Function1[/* elem */ T, String], 
      /* b */ js.Array[T], 
      StringDictionary[TResult]
    ]
  ] = js.native
  ...
  def reduceWhile[T, TResult](predicate: js.Function2[/* acc */ TResult, /* elem */ T, Boolean]): Curry[
    js.Function3[
  ...
  ): Curry[js.Function2[/* a */ TResult, /* b */ js.Array[T], TResult]] = js.native
  def reduceWhile[T, TResult](
    predicate: js.Function2[/* acc */ TResult, /* elem */ T, Boolean],
    fn: js.Function2[/* acc */ TResult, /* elem */ T, TResult],
    acc: TResult
  ...
  /**
    ...
    * function returns falsy.
    */
  def reject[T](fn: js.Function1[/* value */ T, Boolean]): FilterOnceApplied[T] = js.native
  /**
    * Similar to `filter`, except that it keeps only values for which the given predicate
    * function returns falsy.
    */
  def reject[T](fn: js.Function1[/* value */ T, Boolean], list: js.Array[T]): js.Array[T] = js.native
  /**
    * Similar to `filter`, except that it keeps only values for which the given predicate
    * function returns falsy.
    */
  def reject[T](fn: js.Function1[/* value */ T, Boolean], obj: Dictionary[T]): Dictionary[T] = js.native
  /**
    * Similar to `filter`, except that it keeps only values for which the given predicate
    * function returns falsy.
    */
  @JSName("reject")
  def reject_TKind_array_Function1[T, Kind /* <: array */](fn: js.Function1[/* value */ T, Boolean]): js.Function1[/* list */ js.Array[T], js.Array[T]] = js.native
  /**
    * Similar to `filter`, except that it keeps only values for which the given predicate
    * function returns falsy.
    */
  @JSName("reject")
  def reject_TKind_object_Function1[T, Kind /* <: `object` */](fn: js.Function1[/* value */ T, Boolean]): js.Function1[/* list */ Dictionary[T], Dictionary[T]] = js.native
  ...
  def splitAt(index: Double): Fn_ListArrayReadonlyArray = js.native
  ...
  def splitEvery(a: Double): Fn_ListArrayReadonlyArrayString = js.native
  ...
  def symmetricDifferenceWith[T](pred: js.Function2[/* a */ T, /* b */ T, Boolean]): Curry[js.Function2[/* a */ js.Array[T], /* b */ js.Array[T], js.Array[T]]] = js.native
  /**
    * Finds the set (i.e. no duplicates) of all elements contained in the first or second list, but not both.
  ...
  def take(n: Double): Fn_XsArrayReadonlyArray = js.native
  ...
  def takeLast(n: Double): Fn_XsArrayReadonlyArrayString = js.native
  ...
  /**
    ...
    */
  def thunkify[F /* <: js.Function1[/* repeated */ js.Any, _] */](fn: F): Curry[js.Function1[/* args */ Parameters[F], js.Function0[ReturnType[F]]]] = js.native
  ...
  def unionWith[T](pred: js.Function2[/* a */ T, /* b */ T, Boolean]): Curry[js.Function2[/* a */ js.Array[T], /* b */ js.Array[T], js.Array[T]]] = js.native
  /**
  ...
  /**
    ...
    */
  def values[T /* <: js.Object */, K /* <: String */](obj: T): js.Array[/* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any] = js.native
  /**
