...
trait Static extends js.Object {
  ...
  def countBy[T](fn: js.Function1[/* a */ T, java.lang.String | scala.Double]): js.Function1[/* list */ js.Array[T], ScalablyTyped.runtime.StringDictionary[scala.Double]] = js.native
  /**
           ...
           */
  def countBy[T](fn: js.Function1[/* a */ T, java.lang.String | scala.Double], list: js.Array[T]): ScalablyTyped.runtime.StringDictionary[scala.Double] = js.native
  ...
  /**
           ...
           */
  def fromPairs[V](pairs: js.Array[KeyValuePair[java.lang.String, V]]): ScalablyTyped.runtime.StringDictionary[V] = js.native
  @JSName("fromPairs")
  def fromPairs_VNumberDictionary[V](pairs: js.Array[KeyValuePair[scala.Double, V]]): ScalablyTyped.runtime.NumberDictionary[V] = js.native
  def groupBy[T](fn: js.Function1[/* a */ T, java.lang.String]): js.Function1[/* list */ js.Array[T], ScalablyTyped.runtime.StringDictionary[js.Array[T]]] = js.native
  /**
           * Splits a list into sublists stored in an object, based on the result of
           * calling a String-returning function
           * on each element, and grouping the results according to values returned.
           */
  def groupBy[T](fn: js.Function1[/* a */ T, java.lang.String], list: js.Array[T]): ScalablyTyped.runtime.StringDictionary[js.Array[T]] = js.native
  /**
  ...
  def indexBy[T](fn: js.Function1[/* a */ T, java.lang.String]): js.Function1[/* list */ js.Array[T], ScalablyTyped.runtime.StringDictionary[T]] = js.native
  /**
           * Given a function that generates a key, turns a list of objects into an object indexing the objects
           * by the given key.
           */
  def indexBy[T](fn: js.Function1[/* a */ T, java.lang.String], list: js.Array[T]): ScalablyTyped.runtime.StringDictionary[T] = js.native
  ...
  /**
           ...
           */
  def invert[T](obj: T): ScalablyTyped.runtime.StringDictionary[js.Array[java.lang.String]] = js.native
  /**
           * Returns a new object with the keys of the given object as values, and the values of the given object as keys.
           */
  def invertObj(obj: ScalablyTyped.runtime.NumberDictionary[java.lang.String]): ScalablyTyped.runtime.StringDictionary[java.lang.String] = js.native
  /**
           * Returns a new object with the keys of the given object as values, and the values of the given object as keys.
           */
  def invertObj(obj: ScalablyTyped.runtime.StringDictionary[java.lang.String]): ScalablyTyped.runtime.StringDictionary[java.lang.String] = js.native
  /**
  ...
  def map[T, U](
    fn: js.Function1[
      /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Right(TsTypeKeyOf(TsTypeIntersect(List(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()), TsTypeKeyOf(TsTypeRef(TsQIdent(List(TsIdentSimple(U))),List()))))))) *//* x */ js.Any, 
      /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(U))),List()),Right(TsTypeKeyOf(TsTypeIntersect(List(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()), TsTypeKeyOf(TsTypeRef(TsQIdent(List(TsIdentSimple(U))),List()))))))) */js.Any
    ],
    list: T
  ): U = js.native
  /**
  ...
  def mapObjIndexed[T, TResult](fn: js.Function3[/* value */ T, /* key */ java.lang.String, /* obj */ js.UndefOr[js.Any], TResult]): js.Function1[/* obj */ js.Any, ScalablyTyped.runtime.StringDictionary[TResult]] = js.native
  /**
  ...
  def mapObjIndexed[T, TResult](
    fn: js.Function3[
      /* value */ T, 
      /* key */ java.lang.String, 
      /* obj */ js.UndefOr[ScalablyTyped.runtime.StringDictionary[T]], 
      TResult
    ],
    obj: ScalablyTyped.runtime.StringDictionary[T]
  ): ScalablyTyped.runtime.StringDictionary[TResult] = js.native
  def mapObjIndexed[T, TResult](
  ...
  /**
           ...
           */
  def prop[P /* <: java.lang.String */, T](p: P, obj: T): /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(P))) */js.Any = js.native
  ...
  def reduceBy[T, TResult](valueFn: js.Function2[/* acc */ TResult, /* elem */ T, TResult]): CurriedFunction3[
    ...
    js.Array[T], 
    ScalablyTyped.runtime.StringDictionary[TResult]
  ] = js.native
  ...
  ): js.Function1[/* list */ js.Array[T], ScalablyTyped.runtime.StringDictionary[TResult]] = js.native
  /**
  ...
  /**
           ...
           */
  def toPairs[S](obj: ScalablyTyped.runtime.NumberDictionary[S]): js.Array[js.Tuple2[java.lang.String, S]] = js.native
  /**
           * Converts an object into an array of key, value arrays.
           * Only the object's own properties are used.
           * Note that the order of the output array is not guaranteed to be
           * consistent across different JS platforms.
           */
  def toPairs[S](obj: ScalablyTyped.runtime.StringDictionary[S]): js.Array[js.Tuple2[java.lang.String, S]] = js.native
  /**
           * Converts an object into an array of key, value arrays.
           ...
           * consistent across different JS platforms.
           */
  def toPairsIn[S](obj: ScalablyTyped.runtime.NumberDictionary[S]): js.Array[js.Tuple2[java.lang.String, S]] = js.native
  /**
           * Converts an object into an array of key, value arrays.
           * The object's own properties and prototype properties are used.
           * Note that the order of the output array is not guaranteed to be
           * consistent across different JS platforms.
           */
  def toPairsIn[S](obj: ScalablyTyped.runtime.StringDictionary[S]): js.Array[js.Tuple2[java.lang.String, S]] = js.native
  /**
  ...
  /**
           ...
           */
  def values[T /* <: js.Object */, K /* <: java.lang.String */](obj: T): js.Array[
  ...
  def zipObj(keys: js.Array[java.lang.String]): js.Function1[/* values */ js.Array[_], ScalablyTyped.runtime.StringDictionary[_]] = js.native
  /**
           * Creates a new object out of a list of keys and a list of values.
           */
  // TODO: Dictionary<T> as a return value is to specific, any seems to loose
  def zipObj[T](keys: js.Array[java.lang.String], values: js.Array[T]): ScalablyTyped.runtime.StringDictionary[T] = js.native
