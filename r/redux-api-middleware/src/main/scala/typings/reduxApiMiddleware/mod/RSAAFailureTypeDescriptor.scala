...
object RSAAFailureTypeDescriptor {
  ...
  @scala.inline
  implicit class RSAAFailureTypeDescriptorOps[Self <: RSAAFailureTypeDescriptor[_, _, _], State, Payload, Meta] (val x: Self with (RSAAFailureTypeDescriptor[State, Payload, Meta])) extends AnyVal {
