...
import typings.recurlyRecurlyJs.libPricingMod.PricingInstance
import typings.recurlyRecurlyJs.libPricingMod.Tax
import typings.recurlyRecurlyJs.libPricingPromiseMod.PricingPromise
import typings.recurlyRecurlyJs.libPricingSubscriptionMod.SubscriptionPricingState
import typings.std.HTMLElement
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libPricingCheckoutMod {
  
  /* Rewritten from type alias, can be one of: 
    - typings.recurlyRecurlyJs.libPricingCheckoutMod.ItemAdjustment
    - typings.recurlyRecurlyJs.libPricingCheckoutMod.NonItemAdjustment
  */
  trait Adjustment extends StObject
  object Adjustment {
    
    inline def ItemAdjustment(itemCode: String, quantity: Double): typings.recurlyRecurlyJs.libPricingCheckoutMod.ItemAdjustment = {
      val __obj = js.Dynamic.literal(itemCode = itemCode.asInstanceOf[js.Any], quantity = quantity.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.recurlyRecurlyJs.libPricingCheckoutMod.ItemAdjustment]
    }
    
    inline def NonItemAdjustment(amount: Double, quantity: Double, taxCode: String, taxExempt: Boolean): typings.recurlyRecurlyJs.libPricingCheckoutMod.NonItemAdjustment = {
      ...
      __obj.asInstanceOf[typings.recurlyRecurlyJs.libPricingCheckoutMod.NonItemAdjustment]
    }
  }
  ...
  object CheckoutPrice {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CheckoutPrice] (val x: Self) extends AnyVal {
  ...
  object CheckoutPricingMethods {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CheckoutPricingMethods] (val x: Self) extends AnyVal {
  ...
  object CheckoutPricingState {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CheckoutPricingState] (val x: Self) extends AnyVal {
  ...
  object CheckoutPricingStateTax {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CheckoutPricingStateTax] (val x: Self) extends AnyVal {
  ...
  object ItemAdjustment {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ItemAdjustment] (val x: Self) extends AnyVal {
  ...
  object NonItemAdjustment {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: NonItemAdjustment] (val x: Self) extends AnyVal {
