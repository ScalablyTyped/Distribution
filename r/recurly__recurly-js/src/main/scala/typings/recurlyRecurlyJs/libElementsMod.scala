  ...
  */
  ...
  trait ElementsInstance
    ...
    /**
      ...
      */
    def CardElement(): typings.recurlyRecurlyJs.libElementsMod.CardElement = js.native
    def CardElement(cardElementOptions: CardElementOptions): typings.recurlyRecurlyJs.libElementsMod.CardElement = js.native
