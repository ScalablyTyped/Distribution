...
/* Inlined @recurly/recurly-js.elements.CommonElementStyle & {  invalid ? :@recurly/recurly-js.elements.CommonElementStyle,   placeholder ? :{  color ? :string,   fontWeight ? :string,   content ? :{  number ? :string,   expiry ? :string,   cvv ? :string}}} */
trait CommonElementStyleinvalid extends js.Object {
  ...
  var placeholder: js.UndefOr[AnonColor] = js.undefined
