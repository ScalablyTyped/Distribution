...
import typings.rcInput.commonUtilsMod.InputFocusOptions
...
object interfaceMod {
  ...
  trait BaseInputProps
    ...
    var handleReset: js.UndefOr[MouseEventHandler[Element]] = js.undefined
  ...
  object BaseInputProps {
    ...
    inline def apply(inputElement: ReactElement): BaseInputProps = {
    ...
    extension [Self <: BaseInputProps](x: Self) {
      ...
      inline def setHandleReset(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "handleReset", js.Any.fromFunction1(value))
  ...
  object CommonInputProps {
    ...
    inline def apply(): CommonInputProps = {
  ...
  trait ShowCountProps extends StObject {
    ...
    def formatter(args: Count): ReactNode
  }
  object ShowCountProps {
    
    inline def apply(formatter: Count => ReactNode): ShowCountProps = {
