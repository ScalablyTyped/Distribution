...
object commandsMod {
  ...
  @JSImport("@redis/graph/dist/commands", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object default {
    
    @JSImport("@redis/graph/dist/commands", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@redis/graph/dist/commands", "default.CONFIG_GET")
    @js.native
    ...
    @JSImport("@redis/graph/dist/commands", "default.CONFIG_SET")
    @js.native
    ...
    @JSImport("@redis/graph/dist/commands", "default.DELETE")
    @js.native
    ...
    @JSImport("@redis/graph/dist/commands", "default.EXPLAIN")
    @js.native
    ...
    @JSImport("@redis/graph/dist/commands", "default.LIST")
    @js.native
    ...
    @JSImport("@redis/graph/dist/commands", "default.PROFILE")
    @js.native
    ...
    @JSImport("@redis/graph/dist/commands", "default.configGet")
    @js.native
    ...
    @JSImport("@redis/graph/dist/commands", "default.configSet")
    @js.native
  ...
  inline def pushQueryArguments(args: RedisCommandArguments, graph: RedisCommandArgument, query: RedisCommandArgument): RedisCommandArguments = (^.asInstanceOf[js.Dynamic].applyDynamic("pushQueryArguments")(args.asInstanceOf[js.Any], graph.asInstanceOf[js.Any], query.asInstanceOf[js.Any])).asInstanceOf[RedisCommandArguments]
