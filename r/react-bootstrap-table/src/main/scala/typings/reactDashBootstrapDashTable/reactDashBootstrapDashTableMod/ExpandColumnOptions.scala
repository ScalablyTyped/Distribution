...
object ExpandColumnOptions {
  ...
  def apply(
    ...
    expandColumnComponent: /* props */ ExpandColumnComponentProps => String | ReactElement = null,
    expandColumnVisible: js.UndefOr[Boolean] = js.undefined,
    expandedColumnHeaderComponent: /* props */ ExpandedColumnHeaderProps => String | ReactElement = null
  ): ExpandColumnOptions = {
