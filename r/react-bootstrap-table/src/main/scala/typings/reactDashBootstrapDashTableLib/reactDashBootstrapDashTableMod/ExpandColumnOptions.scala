...
object ExpandColumnOptions {
  ...
  def apply(
    ...
    expandColumnComponent: /* props */ ExpandColumnComponentProps => java.lang.String | reactLib.reactMod.ReactElement = null,
    expandColumnVisible: js.UndefOr[scala.Boolean] = js.undefined,
    expandedColumnHeaderComponent: /* props */ ExpandedColumnHeaderProps => java.lang.String | reactLib.reactMod.ReactElement = null
  ): ExpandColumnOptions = {
