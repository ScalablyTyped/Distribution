...
trait ColumnDescription[TRow /* <: js.Object */] extends js.Object {
  ...
  /**
  	 ...
  	 */
  var text: java.lang.String | scala.Double | scala.Boolean | reactLib.reactMod.ReactElement
  /**
  ...
  /**
  	 ...
  	 */
  def format(cell: js.Any, row: TRow, formatExtraData: js.Any, rowIndex: scala.Double): java.lang.String | reactLib.reactMod.ReactElement
  /**
...
object ColumnDescription {
  ...
  def apply[TRow /* <: js.Object */](
    ...
    format: (js.Any, TRow, js.Any, scala.Double) => java.lang.String | reactLib.reactMod.ReactElement,
    ...
    text: java.lang.String | scala.Double | scala.Boolean | reactLib.reactMod.ReactElement,
