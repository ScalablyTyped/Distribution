...
import typings.reactBootstrapTable.mod.ButtonProps
import typings.reactBootstrapTable.mod.ShowSelectedButtonProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait reactBootstrapTableProps {
  @scala.inline
  ...
  type InsertModalFooterProps = typings.reactBootstrapTable.mod.InsertModalFooterProps
  @scala.inline
  def InsertModalHeaderProps: typings.reactBootstrapTable.mod.InsertModalHeaderProps.type = typings.reactBootstrapTable.mod.InsertModalHeaderProps
  type InsertModalHeaderProps = typings.reactBootstrapTable.mod.InsertModalHeaderProps
  @scala.inline
  ...
  type SizePerPageDropDownProps = typings.reactBootstrapTable.mod.SizePerPageDropDownProps
  @scala.inline
  def TableHeaderColumnProps: typings.reactBootstrapTable.mod.TableHeaderColumnProps.type = typings.reactBootstrapTable.mod.TableHeaderColumnProps
  type TableHeaderColumnProps = typings.reactBootstrapTable.mod.TableHeaderColumnProps
}
