...
object ExpandColumnOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(expandColumnBeforeSelectColumn)) __obj.updateDynamic("expandColumnBeforeSelectColumn")(expandColumnBeforeSelectColumn.get.asInstanceOf[js.Any])
    if (expandColumnComponent != null) __obj.updateDynamic("expandColumnComponent")(js.Any.fromFunction1(expandColumnComponent))
    if (!js.isUndefined(expandColumnVisible)) __obj.updateDynamic("expandColumnVisible")(expandColumnVisible.get.asInstanceOf[js.Any])
