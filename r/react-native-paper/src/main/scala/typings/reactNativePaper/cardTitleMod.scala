...
import typings.reactNativePaper.anon.CallHasTitleTitleStyleTitleNumberOfLinesSubtitleSubtitleStyleSubtitleNumberOfLinesLeftLeftStyleRightRightStyleStyleDisplayNameString
...
object cardTitleMod extends Shortcut {
  ...
  val default: ComponentType[PickViewPropsRefAttributeAccessibilityLabelledBy] & (NonReactStatics[
    ComponentType[ViewPropsRefAttributesVieAccessibilityLanguage] & CallHasTitleTitleStyleTitleNumberOfLinesSubtitleSubtitleStyleSubtitleNumberOfLinesLeftLeftStyleRightRightStyleStyleDisplayNameString, 
    js.Object
  ]) = js.native
