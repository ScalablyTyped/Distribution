...
object touchableRippleMod extends Shortcut {
  
  @JSImport("react-native-paper/lib/typescript/components/TouchableRipple/TouchableRipple", JSImport.Default)
  @js.native
  val default: ComponentType[PickTouchableWithoutFeedb] & (NonReactStatics[ComponentType[TouchableWithoutFeedbackP] & Supported, js.Object]) = js.native
  
  type Props = ComponentPropsWithRef[Instantiable0[TouchableWithoutFeedback]] & Background
  
  type _To = ComponentType[PickTouchableWithoutFeedb] & (NonReactStatics[ComponentType[TouchableWithoutFeedbackP] & Supported, js.Object])
  
  /* This means you don't have to write `default`, but can instead just say `touchableRippleMod.foo` */
  override def _to: ComponentType[PickTouchableWithoutFeedb] & (NonReactStatics[ComponentType[TouchableWithoutFeedbackP] & Supported, js.Object]) = default
}
