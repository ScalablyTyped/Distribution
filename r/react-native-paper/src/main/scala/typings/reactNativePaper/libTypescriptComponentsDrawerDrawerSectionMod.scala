...
object libTypescriptComponentsDrawerDrawerSectionMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[PickViewPropsRefAttributeAccessibilityState] & (NonReactStatics[ComponentType[ViewPropsRefAttributesVieAccessibilityRole] & `17`, js.Object]) = js.native
  
  type Props = ComponentPropsWithRef[TypeofView] & Title
  
  type _To = ComponentType[PickViewPropsRefAttributeAccessibilityState] & (NonReactStatics[ComponentType[ViewPropsRefAttributesVieAccessibilityRole] & `17`, js.Object])
  
  /* This means you don't have to write `default`, but can instead just say `libTypescriptComponentsDrawerDrawerSectionMod.foo` */
  override def _to: ComponentType[PickViewPropsRefAttributeAccessibilityState] & (NonReactStatics[ComponentType[ViewPropsRefAttributesVieAccessibilityRole] & `17`, js.Object]) = default
}
