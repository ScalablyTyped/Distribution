...
import typings.reactNativePaper.anon.CallHasLabelAccessibilityLabelPageNumberOfPagesOnPageChangeStyleThemeShowFastPaginationControlsNumberOfItemsPerPageListNumberOfItemsPerPageOnItemsPerPageChangeSelectPageDropdownLabelSelectPageDropdownAccessibilityLabelRestDisplayNameString
...
object dataTablePaginationMod extends Shortcut {
  ...
  val default: ComponentType[PickViewPropsRefAttributeAccessibilityLiveRegion] & (NonReactStatics[
    ComponentType[ViewPropsRefAttributesVieAccessibilityRole] & CallHasLabelAccessibilityLabelPageNumberOfPagesOnPageChangeStyleThemeShowFastPaginationControlsNumberOfItemsPerPageListNumberOfItemsPerPageOnItemsPerPageChangeSelectPageDropdownLabelSelectPageDropdownAccessibilityLabelRestDisplayNameString, 
    js.Object
  ]) = js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `dataTablePaginationMod.foo` */
