...
import typings.reactNativePaper.anon.CallHasIndexTotalStyleThemeRestDisplayNameString
...
object cardCoverMod extends Shortcut {
  ...
  val default: ComponentType[PickImagePropsRefAttributAccessibilityActions] & (NonReactStatics[
    ComponentType[ImagePropsRefAttributesIm] & CallHasIndexTotalStyleThemeRestDisplayNameString, 
    js.Object
  ]) = js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `cardCoverMod.foo` */
