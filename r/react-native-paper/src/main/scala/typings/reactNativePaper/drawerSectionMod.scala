...
object drawerSectionMod extends Shortcut {
  ...
  val default: ComponentType[PickViewPropsRefAttributeAccessibilityState] & (NonReactStatics[
    ComponentType[ViewPropsRefAttributesVieAccessibilityValue] & CallHasChildrenTitleThemeStyleRest, 
    js.Object
  ]) = js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `drawerSectionMod.foo` */
