...
trait ViewPropsRefAttributesVieAccessible extends StObject {
...
object ViewPropsRefAttributesVieAccessible {
  
  inline def apply(theme: typings.reactNativePaper.typescriptTypesMod.global.ReactNativePaper.Theme): ViewPropsRefAttributesVieAccessible = {
    val __obj = js.Dynamic.literal(theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[ViewPropsRefAttributesVieAccessible]
  }
  
  extension [Self <: ViewPropsRefAttributesVieAccessible](x: Self) {
