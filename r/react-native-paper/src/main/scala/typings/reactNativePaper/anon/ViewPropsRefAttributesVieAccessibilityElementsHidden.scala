...
/* Inlined react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View> & {  source :react-native-paper.react-native-paper/lib/typescript/components/Avatar/AvatarImage.AvatarImageSource,   size :number | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   onError :(error : react-native.react-native.NativeSyntheticEvent<react-native.react-native.ImageErrorEventData>): void | undefined,   onLayout :(event : react-native.react-native.LayoutChangeEvent): void | undefined,   onLoad :(event : react-native.react-native.NativeSyntheticEvent<react-native.react-native.ImageLoadEventData>): void | undefined,   onLoadEnd :(): void | undefined,   onLoadStart :(): void | undefined,   onProgress :(event : react-native.react-native.NativeSyntheticEvent<react-native.react-native.ImageProgressEventDataIOS>): void | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} */
trait ViewPropsRefAttributesVieAccessibilityElementsHidden extends StObject {
...
object ViewPropsRefAttributesVieAccessibilityElementsHidden {
  
  inline def apply(
    source: AvatarImageSource,
    theme: typings.reactNativePaper.libTypescriptTypesMod.global.ReactNativePaper.Theme
  ): ViewPropsRefAttributesVieAccessibilityElementsHidden = {
    val __obj = js.Dynamic.literal(source = source.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[ViewPropsRefAttributesVieAccessibilityElementsHidden]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ViewPropsRefAttributesVieAccessibilityElementsHidden] (val x: Self) extends AnyVal {
