...
object ColorDisabled {
  ...
  inline def apply(theme: typings.reactNativePaper.libTypescriptTypesMod.global.ReactNativePaper.Theme): ColorDisabled = {
    val __obj = js.Dynamic.literal(theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[ColorDisabled]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorDisabled] (val x: Self) extends AnyVal {
