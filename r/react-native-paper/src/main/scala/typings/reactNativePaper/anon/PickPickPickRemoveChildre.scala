...
object PickPickPickRemoveChildre {
  
  inline def apply(): PickPickPickRemoveChildre = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickPickPickRemoveChildre]
  }
  
  extension [Self <: PickPickPickRemoveChildre](x: Self) {
