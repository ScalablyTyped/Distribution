...
object PickRemoveChildrenComponeAccessibilityHint {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickRemoveChildrenComponeAccessibilityHint] (val x: Self) extends AnyVal {
