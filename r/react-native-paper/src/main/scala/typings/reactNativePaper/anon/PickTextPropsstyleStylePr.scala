...
/* Inlined std.Pick<react-native.react-native.TextProps & {  style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} & react.react.RefAttributes<{}>, keyof react-native.react-native.TextProps | keyof react.react.RefAttributes<{}>> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
...
object PickTextPropsstyleStylePr {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickTextPropsstyleStylePr] (val x: Self) extends AnyVal {
