...
object PickRemoveChildrenComponeAccessibilityIgnoresInvertColors {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickRemoveChildrenComponeAccessibilityIgnoresInvertColors] (val x: Self) extends AnyVal {
