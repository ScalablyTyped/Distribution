...
trait PickchildrenReactNodestyl extends StObject {
...
object PickchildrenReactNodestyl {
  
  inline def apply(): PickchildrenReactNodestyl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickchildrenReactNodestyl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickchildrenReactNodestyl] (val x: Self) extends AnyVal {
