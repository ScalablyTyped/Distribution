...
object PickthemeDeepPartialThemeAction {
  
  inline def apply(onDismiss: () => Unit, visible: Boolean): PickthemeDeepPartialThemeAction = {
    val __obj = js.Dynamic.literal(onDismiss = js.Any.fromFunction0(onDismiss), visible = visible.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickthemeDeepPartialThemeAction]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickthemeDeepPartialThemeAction] (val x: Self) extends AnyVal {
