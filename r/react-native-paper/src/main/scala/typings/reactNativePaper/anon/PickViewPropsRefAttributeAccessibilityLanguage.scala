...
object PickViewPropsRefAttributeAccessibilityLanguage {
  
  inline def apply(): PickViewPropsRefAttributeAccessibilityLanguage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickViewPropsRefAttributeAccessibilityLanguage]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickViewPropsRefAttributeAccessibilityLanguage] (val x: Self) extends AnyVal {
