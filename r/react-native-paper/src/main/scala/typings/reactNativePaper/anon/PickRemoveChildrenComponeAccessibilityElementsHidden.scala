...
object PickRemoveChildrenComponeAccessibilityElementsHidden {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickRemoveChildrenComponeAccessibilityElementsHidden] (val x: Self) extends AnyVal {
