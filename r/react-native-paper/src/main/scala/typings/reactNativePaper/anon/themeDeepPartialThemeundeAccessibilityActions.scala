...
/* Inlined {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined,   children :react.react.ReactNode | undefined} & std.Pick<std.Partial<react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View>> & {  dark :boolean | undefined,   children :react.react.ReactNode,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined}, keyof react-native.react-native.ViewProps | 'dark' | keyof react.react.RefAttributes<react-native.react-native.View>> & {  dark :boolean | undefined,   statusBarHeight :number | undefined,   children :react.react.ReactNode,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined} */
trait themeDeepPartialThemeundeAccessibilityActions extends StObject {
  ...
  ]) & typings.reactNativePaper.typescriptTypesMod.global.ReactNativePaper.Theme
...
object themeDeepPartialThemeundeAccessibilityActions {
  
  inline def apply(
    theme: (js.UndefOr[
      DeepPartial[typings.reactNativePaper.typescriptTypesMod.global.ReactNativePaper.Theme]
    ]) & typings.reactNativePaper.typescriptTypesMod.global.ReactNativePaper.Theme
  ): themeDeepPartialThemeundeAccessibilityActions = {
    val __obj = js.Dynamic.literal(theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[themeDeepPartialThemeundeAccessibilityActions]
  }
  
  extension [Self <: themeDeepPartialThemeundeAccessibilityActions](x: Self) {
