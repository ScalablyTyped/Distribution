...
import typings.reactNativePaper.reactNativePaperStrings.disk
import typings.reactNativePaper.reactNativePaperStrings.diskSlashmemory
import typings.reactNativePaper.reactNativePaperStrings.memory
