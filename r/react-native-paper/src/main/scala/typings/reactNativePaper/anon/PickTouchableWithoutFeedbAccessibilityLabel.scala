...
trait PickTouchableWithoutFeedbAccessibilityLabel extends StObject {
...
object PickTouchableWithoutFeedbAccessibilityLabel {
  
  inline def apply(): PickTouchableWithoutFeedbAccessibilityLabel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickTouchableWithoutFeedbAccessibilityLabel]
  }
  
  extension [Self <: PickTouchableWithoutFeedbAccessibilityLabel](x: Self) {
