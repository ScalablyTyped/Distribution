...
trait PickthemeDeepPartialThemeAccessibilityRole extends StObject {
...
object PickthemeDeepPartialThemeAccessibilityRole {
  ...
  inline def apply(): PickthemeDeepPartialThemeAccessibilityRole = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickthemeDeepPartialThemeAccessibilityRole]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickthemeDeepPartialThemeAccessibilityRole] (val x: Self) extends AnyVal {
