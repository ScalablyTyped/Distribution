...
trait IOS extends StObject {
  ...
  var Android: ComponentType[PickRemoveChildrenComponeBorderless] & (NonReactStatics[
    (ComponentType[
      (RemoveChildren[
...
object IOS {
  ...
  inline def apply(
    Android: ComponentType[PickRemoveChildrenComponeBorderless] & (NonReactStatics[
      (ComponentType[
        (RemoveChildren[
          ComponentType[PickTouchableWithoutFeedbAccessibilityActions] & (NonReactStatics[ComponentType[TouchableWithoutFeedbackP] & Call, js.Object])
        ]) & UncheckedColor
