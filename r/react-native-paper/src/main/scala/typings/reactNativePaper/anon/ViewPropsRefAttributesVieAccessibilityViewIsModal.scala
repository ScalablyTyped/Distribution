...
trait ViewPropsRefAttributesVieAccessibilityViewIsModal extends StObject {
...
object ViewPropsRefAttributesVieAccessibilityViewIsModal {
  
  inline def apply(theme: typings.reactNativePaper.typescriptTypesMod.global.ReactNativePaper.Theme): ViewPropsRefAttributesVieAccessibilityViewIsModal = {
    val __obj = js.Dynamic.literal(theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[ViewPropsRefAttributesVieAccessibilityViewIsModal]
  }
  
  extension [Self <: ViewPropsRefAttributesVieAccessibilityViewIsModal](x: Self) {
