...
object PickPickRemoveChildrenCom {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[PickPickRemoveChildrenCom]
  }
  
  extension [Self <: PickPickRemoveChildrenCom](x: Self) {
