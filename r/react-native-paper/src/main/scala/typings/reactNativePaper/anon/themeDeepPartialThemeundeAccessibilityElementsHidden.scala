...
/* Inlined {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined,   children :react.react.ReactNode | undefined} & std.Pick<react-native.react-native.Animated.AnimatedProps<react-native.react-native.TextProps & react.react.RefAttributes<react-native.react-native.Text>> & {  style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme}, keyof react-native.react-native.TextProps | keyof react.react.RefAttributes<react-native.react-native.Text>> */
trait themeDeepPartialThemeundeAccessibilityElementsHidden extends StObject {
...
object themeDeepPartialThemeundeAccessibilityElementsHidden {
  
  inline def apply(
    children: js.UndefOr[ReactNode] & (js.UndefOr[
      WithAnimatedValue[js.UndefOr[ReactNode]] | ReactNode | TAugmentRef[js.UndefOr[ReactNode]]
    ])
  ): themeDeepPartialThemeundeAccessibilityElementsHidden = {
    val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
    __obj.asInstanceOf[themeDeepPartialThemeundeAccessibilityElementsHidden]
  }
  
  extension [Self <: themeDeepPartialThemeundeAccessibilityElementsHidden](x: Self) {
    ...
    inline def setRef(
      value: WithAnimatedValue[js.UndefOr[typings.react.mod.Ref[Text]]] | typings.react.mod.Ref[Text] | TAugmentRef[js.UndefOr[typings.react.mod.Ref[Text]]]
    ): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: Any | LegacyRef[Any] | Null | Text => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
    ...
    inline def setStyle(
      value: WithAnimatedValue[js.UndefOr[StyleProp[TextStyle]]] | StyleProp[TextStyle] | TAugmentRef[js.UndefOr[StyleProp[TextStyle]]]
