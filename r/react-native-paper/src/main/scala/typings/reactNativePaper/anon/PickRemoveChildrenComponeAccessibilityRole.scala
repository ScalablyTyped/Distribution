...
object PickRemoveChildrenComponeAccessibilityRole {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickRemoveChildrenComponeAccessibilityRole] (val x: Self) extends AnyVal {
