...
trait AccessibilityLabelColor extends StObject {
...
object AccessibilityLabelColor {
  
  inline def apply(icon: IconSource, theme: typings.reactNativePaper.typescriptTypesMod.global.ReactNativePaper.Theme): AccessibilityLabelColor = {
    val __obj = js.Dynamic.literal(icon = icon.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[AccessibilityLabelColor]
  }
  
  extension [Self <: AccessibilityLabelColor](x: Self) {
