...
/* Inlined std.Pick<{  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined,   children :react.react.ReactNode | undefined,   alpha :number,   family :'light' | 'regular' | 'medium' | 'thin',   style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} & std.Pick<react-native.react-native.TextProps & {  style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} & react.react.RefAttributes<{}>, keyof react-native.react-native.TextProps | keyof react.react.RefAttributes<{}>>, keyof react-native.react-native.TextProps | keyof react.react.RefAttributes<{}> | 'alpha' | 'family'> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickthemeDeepPartialThemeAndroidhyphenationFrequency extends StObject {
...
object PickthemeDeepPartialThemeAndroidhyphenationFrequency {
  ...
  inline def apply(alpha: Double, family: light | regular | medium | thin): PickthemeDeepPartialThemeAndroidhyphenationFrequency = {
