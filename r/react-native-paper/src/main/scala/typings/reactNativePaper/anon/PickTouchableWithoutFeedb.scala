...
trait PickTouchableWithoutFeedb extends StObject {
...
object PickTouchableWithoutFeedb {
  
  inline def apply(): PickTouchableWithoutFeedb = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickTouchableWithoutFeedb]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickTouchableWithoutFeedb] (val x: Self) extends AnyVal {
