...
trait LabelTextColor extends StObject {
...
object LabelTextColor {
  ...
  inline def apply(icon: IconSource, onPress: () => Unit): LabelTextColor = {
    val __obj = js.Dynamic.literal(icon = icon.asInstanceOf[js.Any], onPress = js.Any.fromFunction0(onPress))
    __obj.asInstanceOf[LabelTextColor]
  }
  
  extension [Self <: LabelTextColor](x: Self) {
