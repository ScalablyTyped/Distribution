...
trait PickthemeDeepPartialThemeAccessibilityLabelledBy extends StObject {
...
object PickthemeDeepPartialThemeAccessibilityLabelledBy {
  
  inline def apply(): PickthemeDeepPartialThemeAccessibilityLabelledBy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickthemeDeepPartialThemeAccessibilityLabelledBy]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickthemeDeepPartialThemeAccessibilityLabelledBy] (val x: Self) extends AnyVal {
