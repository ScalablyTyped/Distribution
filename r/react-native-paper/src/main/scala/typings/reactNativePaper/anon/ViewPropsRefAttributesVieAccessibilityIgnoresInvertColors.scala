...
/* Inlined react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View> & {  children :react.react.ReactNode,   style :false | react-native.react-native.RegisteredStyle<react-native.react-native.ViewStyle> | react-native.react-native.Animated.Value | react-native.react-native.Animated.AnimatedInterpolation<number | string> | react-native.react-native.Animated.WithAnimatedObject<react-native.react-native.ViewStyle> | react-native.react-native.Animated.WithAnimatedArray<react-native.react-native.ViewStyle | react-native.react-native.Falsy | react-native.react-native.RegisteredStyle<react-native.react-native.ViewStyle> | react-native.react-native.RecursiveArray<react-native.react-native.ViewStyle | react-native.react-native.Falsy | react-native.react-native.RegisteredStyle<react-native.react-native.ViewStyle>> | std.Array<react-native.react-native.ViewStyle | react-native.react-native.Falsy | react-native.react-native.RegisteredStyle<react-native.react-native.ViewStyle>>> | null | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} */
trait ViewPropsRefAttributesVieAccessibilityIgnoresInvertColors extends StObject {
