...
trait SwitchPropsRefAttributesS extends StObject {
  ...
  var ref: js.UndefOr[typings.react.mod.Ref[Switch]] = js.undefined
...
object SwitchPropsRefAttributesS {
  ...
  extension [Self <: SwitchPropsRefAttributesS](x: Self) {
    ...
    inline def setRef(value: typings.react.mod.Ref[Switch]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: /* instance */ Switch | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
