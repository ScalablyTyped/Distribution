...
object PickPickthemeDeepPartialT {
  
  inline def apply(): PickPickthemeDeepPartialT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickPickthemeDeepPartialT]
  }
  
  extension [Self <: PickPickthemeDeepPartialT](x: Self) {
