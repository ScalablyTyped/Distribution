...
/* Inlined std.Pick<{  page :number,   numberOfPages :number, onPageChange (page : number): void,   showFastPaginationControls :boolean | undefined,   numberOfItemsPerPage :number | undefined,   numberOfItemsPerPageList :std.Array<number> | undefined,   onItemsPerPageChange :(numberOfItemsPerPage : number): void | undefined,   label :react.react.ReactNode | undefined,   accessibilityLabel :string | undefined,   selectPageDropdownLabel :react.react.ReactNode | undefined,   selectPageDropdownAccessibilityLabel :string | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} & react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View>, 'label' | keyof react-native.react-native.ViewProps | keyof react.react.RefAttributes<react-native.react-native.View> | 'selectPageDropdownLabel' | 'selectPageDropdownAccessibilityLabel' | keyof {  page :number,   numberOfPages :number, onPageChange (page : number): void,   showFastPaginationControls :boolean | undefined} | keyof {  numberOfItemsPerPage :number | undefined,   numberOfItemsPerPageList :std.Array<number> | undefined,   onItemsPerPageChange :(numberOfItemsPerPage : number): void | undefined}> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickpagenumbernumberOfPag extends StObject {
  ...
  var onPageChange: js.Function1[/* page */ Double, Unit]
...
object PickpagenumbernumberOfPag {
  
  inline def apply(numberOfPages: Double, onPageChange: /* page */ Double => Unit, page: Double): PickpagenumbernumberOfPag = {
