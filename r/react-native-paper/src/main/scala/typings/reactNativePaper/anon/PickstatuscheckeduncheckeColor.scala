...
/* Inlined std.Pick<{  status :'checked' | 'unchecked' | 'indeterminate',   disabled :boolean | undefined,   label :string,   onPress :(): void | undefined,   uncheckedColor :string | undefined,   color :string | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   labelStyle :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme,   testID :string | undefined,   position :'leading' | 'trailing' | undefined,   mode :'ios' | 'android' | undefined}, 'label' | 'style' | 'color' | 'onPress' | 'testID' | 'position' | 'mode' | 'labelStyle' | 'disabled' | 'status' | 'uncheckedColor'> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickstatuscheckeduncheckeColor extends StObject {
...
object PickstatuscheckeduncheckeColor {
  
  inline def apply(label: String, status: checked | unchecked | indeterminate): PickstatuscheckeduncheckeColor = {
    val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickstatuscheckeduncheckeColor]
  }
  
  extension [Self <: PickstatuscheckeduncheckeColor](x: Self) {
