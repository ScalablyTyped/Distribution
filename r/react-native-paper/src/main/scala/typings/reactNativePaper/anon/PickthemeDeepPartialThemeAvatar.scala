...
trait PickthemeDeepPartialThemeAvatar extends StObject {
...
object PickthemeDeepPartialThemeAvatar {
  
  inline def apply(): PickthemeDeepPartialThemeAvatar = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickthemeDeepPartialThemeAvatar]
  }
  
  extension [Self <: PickthemeDeepPartialThemeAvatar](x: Self) {
