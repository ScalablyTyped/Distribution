...
/* Inlined std.Pick<react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View> & react-native-paper.react-native-paper/lib/typescript/components/DataTable/DataTablePagination.PaginationControlsProps & react-native-paper.react-native-paper/lib/typescript/components/DataTable/DataTablePagination.PaginationDropdownProps & {  label :react.react.ReactNode | undefined,   accessibilityLabel :string | undefined,   selectPageDropdownLabel :react.react.ReactNode | undefined,   selectPageDropdownAccessibilityLabel :string | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme}, 'label' | keyof react-native.react-native.ViewProps | keyof react.react.RefAttributes<react-native.react-native.View> | 'selectPageDropdownLabel' | 'selectPageDropdownAccessibilityLabel' | keyof react-native-paper.react-native-paper/lib/typescript/components/DataTable/DataTablePagination.PaginationControlsProps | keyof react-native-paper.react-native-paper/lib/typescript/components/DataTable/DataTablePagination.PaginationDropdownProps> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickViewPropsRefAttributeAccessibilityLiveRegion extends StObject {
...
object PickViewPropsRefAttributeAccessibilityLiveRegion {
  
  inline def apply(numberOfPages: Double, onPageChange: /* page */ Double => Unit, page: Double): PickViewPropsRefAttributeAccessibilityLiveRegion = {
    ...
    __obj.asInstanceOf[PickViewPropsRefAttributeAccessibilityLiveRegion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickViewPropsRefAttributeAccessibilityLiveRegion] (val x: Self) extends AnyVal {
