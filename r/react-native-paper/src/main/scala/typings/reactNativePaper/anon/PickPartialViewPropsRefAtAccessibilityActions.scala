...
trait PickPartialViewPropsRefAtAccessibilityActions extends StObject {
  ...
  var theme: js.UndefOr[DeepPartialThemeDark] & typings.reactNativePaper.typescriptTypesMod.global.ReactNativePaper.Theme
...
object PickPartialViewPropsRefAtAccessibilityActions {
  
  inline def apply(
    theme: js.UndefOr[DeepPartialThemeDark] & typings.reactNativePaper.typescriptTypesMod.global.ReactNativePaper.Theme
  ): PickPartialViewPropsRefAtAccessibilityActions = {
    val __obj = js.Dynamic.literal(theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPartialViewPropsRefAtAccessibilityActions]
  }
  
  extension [Self <: PickPartialViewPropsRefAtAccessibilityActions](x: Self) {
    ...
    inline def setTheme(
      value: js.UndefOr[DeepPartialThemeDark] & typings.reactNativePaper.typescriptTypesMod.global.ReactNativePaper.Theme
