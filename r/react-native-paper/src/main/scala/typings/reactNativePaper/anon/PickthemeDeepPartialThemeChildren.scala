...
object PickthemeDeepPartialThemeChildren {
  
  inline def apply(onDismiss: () => Unit, visible: Boolean): PickthemeDeepPartialThemeChildren = {
    val __obj = js.Dynamic.literal(onDismiss = js.Any.fromFunction0(onDismiss), visible = visible.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickthemeDeepPartialThemeChildren]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickthemeDeepPartialThemeChildren] (val x: Self) extends AnyVal {
