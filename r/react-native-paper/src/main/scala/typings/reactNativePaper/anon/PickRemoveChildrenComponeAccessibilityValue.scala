...
object PickRemoveChildrenComponeAccessibilityValue {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickRemoveChildrenComponeAccessibilityValue] (val x: Self) extends AnyVal {
