...
/* Inlined react-native.react-native.TextProps & {  style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} & react.react.RefAttributes<{}> */
...
object TextPropsstyleStylePropTe {
  ...
  inline def apply(theme: typings.reactNativePaper.libTypescriptTypesMod.global.ReactNativePaper.Theme): TextPropsstyleStylePropTe = {
