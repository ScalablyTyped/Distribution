...
/* Inlined std.Pick<{  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined,   children :react.react.ReactNode | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme,   style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined} & std.Pick<react-native.react-native.TextProps & {  style :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme} & react.react.RefAttributes<{}>, keyof react-native.react-native.TextProps | keyof react.react.RefAttributes<{}>>, keyof react-native.react-native.TextProps | keyof react.react.RefAttributes<{}>> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickthemeDeepPartialThemeAllowFontScaling extends StObject {
  ...
  var ref: js.UndefOr[typings.react.mod.Ref[js.Object]] = js.undefined
...
object PickthemeDeepPartialThemeAllowFontScaling {
  ...
  inline def apply(): PickthemeDeepPartialThemeAllowFontScaling = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickthemeDeepPartialThemeAllowFontScaling]
  }
  
  extension [Self <: PickthemeDeepPartialThemeAllowFontScaling](x: Self) {
    ...
    inline def setRef(value: typings.react.mod.Ref[js.Object]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: /* instance */ js.Object | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
