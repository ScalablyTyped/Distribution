...
trait PickPartialViewPropsRefAtAccessibilityElementsHidden extends StObject {
...
object PickPartialViewPropsRefAtAccessibilityElementsHidden {
  
  inline def apply(
    theme: (js.UndefOr[
      DeepPartial[typings.reactNativePaper.typescriptTypesMod.global.ReactNativePaper.Theme]
    ]) & typings.reactNativePaper.typescriptTypesMod.global.ReactNativePaper.Theme
  ): PickPartialViewPropsRefAtAccessibilityElementsHidden = {
    val __obj = js.Dynamic.literal(theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPartialViewPropsRefAtAccessibilityElementsHidden]
  }
  
  extension [Self <: PickPartialViewPropsRefAtAccessibilityElementsHidden](x: Self) {
