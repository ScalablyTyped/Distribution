...
/* Inlined std.Pick<react-native.react-native.ViewProps & react.react.RefAttributes<react-native.react-native.View> & {  label :string,   size :number | undefined,   color :string | undefined,   style :react-native.react-native.StyleProp<react-native.react-native.ViewStyle> | undefined,   labelStyle :react-native.react-native.StyleProp<react-native.react-native.TextStyle> | undefined,   theme :react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme}, 'label' | 'color' | 'size' | keyof react-native.react-native.ViewProps | keyof react.react.RefAttributes<react-native.react-native.View> | 'labelStyle'> & {  theme :@callstack/react-theme-provider.@callstack/react-theme-provider.$DeepPartial<react-native-paper.react-native-paper/lib/typescript/types.<global>.ReactNativePaper.Theme> | undefined} */
trait PickViewPropsRefAttributeAccessibilityHint extends StObject {
...
object PickViewPropsRefAttributeAccessibilityHint {
  
  inline def apply(label: String): PickViewPropsRefAttributeAccessibilityHint = {
    val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickViewPropsRefAttributeAccessibilityHint]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickViewPropsRefAttributeAccessibilityHint] (val x: Self) extends AnyVal {
