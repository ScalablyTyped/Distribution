...
object PickRemoveChildrenComponeBorderless {
  
  inline def apply(): PickRemoveChildrenComponeBorderless = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickRemoveChildrenComponeBorderless]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickRemoveChildrenComponeBorderless] (val x: Self) extends AnyVal {
