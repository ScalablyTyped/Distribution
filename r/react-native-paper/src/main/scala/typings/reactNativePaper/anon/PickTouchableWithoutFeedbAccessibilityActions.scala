...
trait PickTouchableWithoutFeedbAccessibilityActions extends StObject {
...
object PickTouchableWithoutFeedbAccessibilityActions {
  
  inline def apply(): PickTouchableWithoutFeedbAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickTouchableWithoutFeedbAccessibilityActions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickTouchableWithoutFeedbAccessibilityActions] (val x: Self) extends AnyVal {
