...
import typings.reactNativePaper.anon.OnPressOnValueChange
...
object radioButtonUtilsMod {
  
  @JSImport("react-native-paper/lib/typescript/components/RadioButton/utils", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def handlePress(hasOnPressValueOnValueChange: OnPressOnValueChange): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("handlePress")(hasOnPressValueOnValueChange.asInstanceOf[js.Any]).asInstanceOf[Unit]
