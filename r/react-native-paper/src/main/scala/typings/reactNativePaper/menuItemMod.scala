...
import typings.reactNativePaper.anon.CallHasIconTitleDisabledOnPressStyleContentStyleTestIDTitleStyleAccessibilityLabelThemeDisplayNameString
import typings.reactNativePaper.anon.IconPropscolorstring
import typings.reactNativePaper.anon.PickPropsstyletitleonPres
...
object menuItemMod extends Shortcut {
  ...
  @js.native
  val default: ComponentType[PickPropsstyletitleonPres] & (NonReactStatics[
    ComponentType[Props] & CallHasIconTitleDisabledOnPressStyleContentStyleTestIDTitleStyleAccessibilityLabelThemeDisplayNameString, 
    js.Object
  ]) = js.native
  ...
  type _To = ComponentType[PickPropsstyletitleonPres] & (NonReactStatics[
    ComponentType[Props] & CallHasIconTitleDisabledOnPressStyleContentStyleTestIDTitleStyleAccessibilityLabelThemeDisplayNameString, 
    js.Object
  ])
  
  /* This means you don't have to write `default`, but can instead just say `menuItemMod.foo` */
  override def _to: ComponentType[PickPropsstyletitleonPres] & (NonReactStatics[
    ComponentType[Props] & CallHasIconTitleDisabledOnPressStyleContentStyleTestIDTitleStyleAccessibilityLabelThemeDisplayNameString, 
    js.Object
  ]) = default
}
