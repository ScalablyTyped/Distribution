...
import typings.reactNativePaper.anon.CallHasChildrenThemeStyleRestDisplayNameString
...
object dialogTitleMod extends Shortcut {
  ...
  val default: ComponentType[PickchildrenReactNodestylAccessibilityActions] & (NonReactStatics[
    ComponentType[childrenReactNodestyleSty] & CallHasChildrenThemeStyleRestDisplayNameString, 
    js.Object
  ]) = js.native
  ...
  type Props = (ComponentPropsWithRef[js.Function1[/* props */ typings.reactNativePaper.titleMod.Props, Element]]) & StyleTheme
