...
import typings.reactNativePaper.adornmentTypesMod.AdornmentConfig
import typings.reactNativePaper.adornmentTypesMod.AdornmentStyleAdjustmentForNativeInput
...
object textInputAdornmentMod {
  ...
  inline def getAdornmentConfig(hasLeftRight: Right): js.Array[AdornmentConfig] = ^.asInstanceOf[js.Dynamic].applyDynamic("getAdornmentConfig")(hasLeftRight.asInstanceOf[js.Any]).asInstanceOf[js.Array[AdornmentConfig]]
  ...
  object TextInputAdornmentProps {
    ...
    extension [Self <: TextInputAdornmentProps](x: Self) {
      ...
      inline def setOnAffixChange(value: `0`): Self = StObject.set(x, "onAffixChange", value.asInstanceOf[js.Any])
