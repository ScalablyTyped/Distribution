...
import typings.reactNativePaper.anon.PickRemoveChildrenComponeAccessibilityValue
...
object libTypescriptComponentsFabMod extends Shortcut {
  
  @JSImport("react-native-paper/lib/typescript/components/FAB", JSImport.Default)
  @js.native
  val default: ComponentType[PickRemoveChildrenComponeAccessibilityValue] & (NonReactStatics[
    (ComponentType[
      (RemoveChildren[
  ...
  type _To = ComponentType[PickRemoveChildrenComponeAccessibilityValue] & (NonReactStatics[
    (ComponentType[
      (RemoveChildren[
        ComponentType[PickViewPropsRefAttributeAccessibilityIgnoresInvertColors] & (NonReactStatics[
          ComponentType[ViewPropsRefAttributesVieAccessibilityIgnoresInvertColors] & (js.Function1[/* hasStyleThemeRest */ Props, Element]), 
  ...
  /* This means you don't have to write `default`, but can instead just say `libTypescriptComponentsFabMod.foo` */
  override def _to: ComponentType[PickRemoveChildrenComponeAccessibilityValue] & (NonReactStatics[
    (ComponentType[
      (RemoveChildren[
        ComponentType[PickViewPropsRefAttributeAccessibilityIgnoresInvertColors] & (NonReactStatics[
          ComponentType[ViewPropsRefAttributesVieAccessibilityIgnoresInvertColors] & (js.Function1[/* hasStyleThemeRest */ Props, Element]), 
