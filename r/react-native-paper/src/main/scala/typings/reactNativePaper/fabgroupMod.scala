...
import typings.reactNativePaper.anon.LabelTextColor
...
object fabgroupMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `fabgroupMod.foo` */
