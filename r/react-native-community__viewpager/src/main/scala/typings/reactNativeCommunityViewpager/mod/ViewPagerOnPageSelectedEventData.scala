...
@js.native
trait ViewPagerOnPageSelectedEventData extends js.Object {
...
object ViewPagerOnPageSelectedEventData {
  ...
  @scala.inline
  implicit class ViewPagerOnPageSelectedEventDataOps[Self <: ViewPagerOnPageSelectedEventData] (val x: Self) extends AnyVal {
