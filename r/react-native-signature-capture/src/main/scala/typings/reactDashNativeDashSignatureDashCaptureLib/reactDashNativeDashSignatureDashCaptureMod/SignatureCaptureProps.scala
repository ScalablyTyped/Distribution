...
trait SignatureCaptureProps
  ...
  /**
    ...
    */
  var onDragEvent: js.UndefOr[js.Function1[/* event */ js.Any, scala.Unit]] = js.undefined
  /**
    ...
    */
  var onSaveEvent: js.UndefOr[js.Function1[/* params */ SaveEventParams, scala.Unit]] = js.undefined
  /**
    ...
    * @default false
    */
  var saveImageFileInExtStorage: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    * @default false
    */
  var showNativeButtons: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * If this props is made to true, it will display the "x_ _ _ _ _ _ _ _ _ _ _" placeholder indicating where to sign.
    *
    * @default false
    */
  var showTitleLabel: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * Change the screen orientation based on boolean value
    * "portrait" or "landscape"
    */
  var viewMode: js.UndefOr[
    reactDashNativeDashSignatureDashCaptureLib.reactDashNativeDashSignatureDashCaptureLibStrings.portrait | reactDashNativeDashSignatureDashCaptureLib.reactDashNativeDashSignatureDashCaptureLibStrings.landscape
  ] = js.undefined
}
...
object SignatureCaptureProps {
  ...
  def apply(
    ...
    onDragEvent: /* event */ js.Any => scala.Unit = null,
    ...
    onSaveEvent: /* params */ SaveEventParams => scala.Unit = null,
    ...
    saveImageFileInExtStorage: js.UndefOr[scala.Boolean] = js.undefined,
    shouldRasterizeIOS: js.UndefOr[scala.Boolean] = js.undefined,
    showBorder: js.UndefOr[scala.Boolean] = js.undefined,
    showNativeButtons: js.UndefOr[scala.Boolean] = js.undefined,
    showTitleLabel: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    viewMode: reactDashNativeDashSignatureDashCaptureLib.reactDashNativeDashSignatureDashCaptureLibStrings.portrait | reactDashNativeDashSignatureDashCaptureLib.reactDashNativeDashSignatureDashCaptureLibStrings.landscape = null
