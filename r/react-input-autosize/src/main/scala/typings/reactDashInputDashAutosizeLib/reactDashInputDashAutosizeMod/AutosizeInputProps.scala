...
object AutosizeInputProps {
  @scala.inline
  def apply(
    ClassAttributes: reactLib.reactMod.ReactNs.ClassAttributes[reactLib.HTMLInputElement] = null,
    ...
    onAutosize: js.Function1[/* inputWidth */ java.lang.String | scala.Double, scala.Unit] = null,
