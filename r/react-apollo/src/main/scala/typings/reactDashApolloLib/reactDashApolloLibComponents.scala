...
object reactDashApolloLibComponents {
  ...
  @scala.inline
  def SubscriptionsProps: reactDashApolloLib.subscriptionsMod.SubscriptionProps.type = reactDashApolloLib.subscriptionsMod.SubscriptionProps
  type SubscriptionsProps[TData, TVariables] = reactDashApolloLib.subscriptionsMod.SubscriptionProps[TData, TVariables]
}
