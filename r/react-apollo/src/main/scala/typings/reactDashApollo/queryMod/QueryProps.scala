...
import typings.reactDashApollo.typesMod.Context
import typings.reactDashApollo.typesMod.QueryOpts
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait QueryProps[TData, TVariables] extends QueryOpts[TVariables] {
  ...
  def children(result: QueryResult[TData, TVariables]): ReactNode
}
...
object QueryProps {
  ...
  def apply[TData, TVariables](
    ...
    query: DocumentNode,
    client: typings.apolloDashClient.apolloDashClientMod.default[_] = null,
