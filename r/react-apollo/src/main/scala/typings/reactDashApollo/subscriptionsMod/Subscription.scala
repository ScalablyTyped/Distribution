...
trait Subscription[TData, TVariables]
  extends Component[SubscriptionProps[TData, TVariables], SubscriptionState[TData], js.Any] {
  ...
  def componentDidMount_MSubscription(): Unit = js.native
  @JSName("componentWillReceiveProps")
  def componentWillReceiveProps_MSubscription(nextProps: SubscriptionProps[TData, TVariables], nextContext: SubscriptionContext): Unit = js.native
  @JSName("componentWillUnmount")
  def componentWillUnmount_MSubscription(): Unit = js.native
}
