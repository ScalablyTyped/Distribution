...
trait Anon_0Children[Name /* <: formatDate | formatTime */] extends js.Object {
  var value: /* import warning: importer.ImportType#apply Failed type conversion: std.Parameters<react-intl.react-intl/dist/types.IntlShape[Name]>[0] */ js.Any
...
object Anon_0Children {
  ...
  def apply[Name /* <: formatDate | formatTime */](
    ...
    value: /* import warning: importer.ImportType#apply Failed type conversion: std.Parameters<react-intl.react-intl/dist/types.IntlShape[Name]>[0] */ js.Any
  ): Anon_0Children[Name] = {
