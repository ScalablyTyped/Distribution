...
trait Anon_0ChildrenFormatOptsValValueArray extends js.Object {
  var value: /* import warning: ImportType.apply Failed type conversion: std.Parameters<(value : std.Parameters<std.Intl.NumberFormat['format']>[0], opts ? : react-intl.react-intl.FormatNumberOptions): string>[0] */ js.Any
...
object Anon_0ChildrenFormatOptsValValueArray {
  ...
  def apply(
    ...
    value: /* import warning: ImportType.apply Failed type conversion: std.Parameters<(value : std.Parameters<std.Intl.NumberFormat['format']>[0], opts ? : react-intl.react-intl.FormatNumberOptions): string>[0] */ js.Any
