package typings.reactDashIntl.ReactIntlNs.FormattedTimeNs
...
trait Props extends DateTimeFormatProps {
  var children: js.UndefOr[js.Function1[/* formattedTime */ String, ReactNode]] = js.undefined
...
object Props {
  ...
  def apply(
    value: DateSource,
    children: /* formattedTime */ String => ReactNode = null,
    day: String = null,
    era: String = null,
    format: String = null,
