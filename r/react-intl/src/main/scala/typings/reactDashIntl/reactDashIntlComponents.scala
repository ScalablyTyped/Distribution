...
object reactDashIntlComponents extends reactDashIntlProps {
  ...
  @scala.inline
  def FormattedMessage[V /* <: Record[String, _] */]: ComponentType[FormattedMessageProps[V]] = js.constructorOf[typings.reactDashIntl.libMod.FormattedMessage[V]].asInstanceOf[typings.react.reactMod.ComponentType[FormattedMessageProps[V]]]
  @scala.inline
  ...
  @scala.inline
  def Message[V /* <: Record[String, _] */]: ComponentType[MessageProps[V]] = js.constructorOf[typings.reactDashIntl.libComponentsMessageMod.default[V]].asInstanceOf[typings.react.reactMod.ComponentType[MessageProps[V]]]
  @scala.inline
