...
object IntlListFormatOptionsvalu {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IntlListFormatOptionsvalu] (val x: Self) extends AnyVal {
    ...
    inline def setValueVarargs(value: ReactNode*): Self = StObject.set(x, "value", js.Array(value*))
  }
}
