...
/* Inlined @formatjs/intl.@formatjs/intl.FormatDateOptions & {  value :std.Parameters<std.Intl.DateTimeFormat['format']>[0] | string, children (val : std.Array<std.Intl.DateTimeFormatPart>): react.react.ReactElement | null} */
trait FormatDateOptionsvaluePar extends StObject {
...
object FormatDateOptionsvaluePar {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FormatDateOptionsvaluePar] (val x: Self) extends AnyVal {
