...
/* Inlined std.Intl.DateTimeFormatOptions & @formatjs/intl.@formatjs/intl.CustomFormatConfig<string> & {  value :string | number | std.Date | undefined} */
...
object DateTimeFormatOptionsCust {
  ...
  inline def apply(formatMatcher: (js.UndefOr[basic | (`best fit`)]) & (js.UndefOr[(`best fit`) | basic])): DateTimeFormatOptionsCust = {
