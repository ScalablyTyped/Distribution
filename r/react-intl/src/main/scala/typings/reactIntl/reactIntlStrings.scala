...
object reactIntlStrings {
  ...
  inline def formatDisplayName: formatDisplayName = "formatDisplayName".asInstanceOf[formatDisplayName]
  
  @js.native
  sealed trait formatList extends StObject
  inline def formatList: formatList = "formatList".asInstanceOf[formatList]
  
  @js.native
  sealed trait formatNumber extends StObject
  inline def formatNumber: formatNumber = "formatNumber".asInstanceOf[formatNumber]
