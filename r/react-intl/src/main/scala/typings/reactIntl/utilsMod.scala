...
object utilsMod {
  ...
  /* Inlined std.Pick<react-intl.react-intl/lib/src/types.IntlConfig, 'formats' | 'messages' | 'timeZone' | 'textComponent' | 'defaultLocale' | 'defaultFormats' | 'onError'> */
  ...
  @JSImport("react-intl/lib/src/utils", "assignUniqueKeysToParts")
  @js.native
  ...
  @JSImport("react-intl/lib/src/utils", "invariantIntlContext")
  @js.native
