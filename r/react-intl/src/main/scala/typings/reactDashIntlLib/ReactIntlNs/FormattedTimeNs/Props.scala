...
trait Props
  ...
  var children: js.UndefOr[js.Function1[/* formattedTime */ java.lang.String, reactLib.reactMod.ReactNode]] = js.undefined
...
object Props {
  ...
  def apply(
    ...
    children: /* formattedTime */ java.lang.String => reactLib.reactMod.ReactNode = null,
