...
import typings.reactNativeHoneywellScanner.anon.Data
...
object mod {
  ...
  object default {
    ...
    inline def on(eventName: String, handler: js.Function1[/* event */ Data | String | Null, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("on")(eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[Unit]
