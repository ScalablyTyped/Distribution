package typings.rnMaterialUiTextfield
...
import typings.rnMaterialUiTextfield.rnMaterialUiTextfieldStrings.dashed
import typings.rnMaterialUiTextfield.rnMaterialUiTextfieldStrings.dotted
import typings.rnMaterialUiTextfield.rnMaterialUiTextfieldStrings.none
import typings.rnMaterialUiTextfield.rnMaterialUiTextfieldStrings.solid
...
object mod {
  ...
  trait TextFieldProps
    ...
    var inputRef: js.UndefOr[RefObject[Any]] = js.undefined
  ...
  object TextFieldProps {
    ...
    extension [Self <: TextFieldProps](x: Self) {
      ...
      inline def setInputRef(value: RefObject[Any]): Self = StObject.set(x, "inputRef", value.asInstanceOf[js.Any])
      ...
      inline def setOnBlur(value: /* event */ NativeSyntheticEvent[TextInputChangeEventData] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
