...
trait TypeofReactTestUtils extends js.Object {
  ...
  def isElementOfType[T /* <: stdLib.HTMLElement */](element: reactLib.reactMod.ReactElement[_], `type`: java.lang.String): /* is react.react.ReactHTMLElement<T> */ scala.Boolean = js.native
  def isElementOfType[P](element: reactLib.reactMod.ReactElement[_], `type`: reactLib.reactMod.SFC[P]): /* is react.react.SFCElement<P> */ scala.Boolean = js.native
