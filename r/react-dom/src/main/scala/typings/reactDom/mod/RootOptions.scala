...
object RootOptions {
  ...
  implicit class RootOptionsOps[Self <: RootOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHydrationOptions(value: typings.reactDom.experimentalMod.reactDomAugmentingMod.HydrationOptions): Self = this.set("hydrationOptions", value.asInstanceOf[js.Any])
    @scala.inline
