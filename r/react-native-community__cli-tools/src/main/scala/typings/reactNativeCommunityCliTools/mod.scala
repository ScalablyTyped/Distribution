...
import typings.reactNativeCommunityCliTools.loaderMod.Loader
import typings.reactNativeCommunityCliTools.loaderMod.OraNoop
...
object mod {
  ...
  open class CLIError protected ()
    extends typings.reactNativeCommunityCliTools.errorsMod.CLIError {
