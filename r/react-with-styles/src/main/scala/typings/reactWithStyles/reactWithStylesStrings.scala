...
object reactWithStylesStrings {
  ...
  @scala.inline
  def distribute: distribute = "distribute".asInstanceOf[distribute]
  ...
  @scala.inline
  def `inter-cluster`: `inter-cluster` = "inter-cluster".asInstanceOf[`inter-cluster`]
  
  @js.native
  sealed trait `inter-ideograph` extends StObject
  @scala.inline
  def `inter-ideograph`: `inter-ideograph` = "inter-ideograph".asInstanceOf[`inter-ideograph`]
  ...
  @scala.inline
  def kashida: kashida = "kashida".asInstanceOf[kashida]
