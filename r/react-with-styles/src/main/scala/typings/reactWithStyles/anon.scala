...
object anon {
  ...
  object CSSPropertiespseudoSelect {
    ...
    @scala.inline
    def apply(Object: js.Object): CSSPropertiespseudoSelect = {
  ...
  object Css {
    ...
    @scala.inline
    implicit class CssMutableBuilder[Self <: Css[?], TStyles /* <: Styles */] (val x: Self & Css[TStyles]) extends AnyVal {
  ...
  object StylesFn {
    ...
    @scala.inline
    implicit class StylesFnMutableBuilder[Self <: StylesFn[?], TStyles /* <: Styles */] (val x: Self & StylesFn[TStyles]) extends AnyVal {
