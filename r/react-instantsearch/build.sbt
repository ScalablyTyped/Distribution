...
version := "6.10-dt-20220105Z-0abeab"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "algoliasearch-helper" % "3.11.1-2af3ab",
  ...
  "org.scalablytyped" %%% "react-instantsearch-core" % "6.26-dt-20220720Z-1bdd94",
  "org.scalablytyped" %%% "react-instantsearch-dom" % "6.12-dt-20220426Z-a891cd",
  "org.scalablytyped" %%% "react-instantsearch-native" % "6.3-dt-20211202Z-997a6a",
