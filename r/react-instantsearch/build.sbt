...
version := "6.10-dt-20220105Z-d4d4d8"
scalaVersion := "3.1.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-instantsearch-core" % "6.26-dt-20220720Z-4a6b32",
  "org.scalablytyped" %%% "react-instantsearch-dom" % "6.12-dt-20220426Z-67d7bd",
  "org.scalablytyped" %%% "react-instantsearch-native" % "6.3-dt-20211202Z-fef9c7",
