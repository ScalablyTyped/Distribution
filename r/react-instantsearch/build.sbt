...
version := "6.10-dt-20220105Z-9302db"
scalaVersion := "3.1.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-instantsearch-dom" % "6.12-dt-20220426Z-1a2490",
  "org.scalablytyped" %%% "react-instantsearch-native" % "6.3-dt-20211202Z-4cea87",
