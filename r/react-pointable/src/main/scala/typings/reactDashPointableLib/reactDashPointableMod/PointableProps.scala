...
object PointableProps {
  @scala.inline
  def apply(
    HTMLAttributes: reactLib.reactMod.HTMLAttributes[stdLib.Element] = null,
    SVGAttributes: reactLib.reactMod.SVGAttributes[stdLib.Element] = null,
