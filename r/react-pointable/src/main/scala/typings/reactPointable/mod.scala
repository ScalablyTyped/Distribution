...
object mod {
  ...
  object default {
    ...
    @scala.inline
    def defaultProps_=(x: TagName): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
  }
  ...
  object PointableProps {
    ...
    @scala.inline
    implicit class PointablePropsMutableBuilder[Self <: PointableProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setElementRef(value: /* el */ HTMLElement | SVGElement => Unit): Self = StObject.set(x, "elementRef", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setTagName(value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 173 */ js.Any): Self = StObject.set(x, "tagName", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTouchAction(value: TouchAction): Self = StObject.set(x, "touchAction", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object TouchAction {
    ...
    @scala.inline
    def auto: typings.reactPointable.reactPointableStrings.auto = "auto".asInstanceOf[typings.reactPointable.reactPointableStrings.auto]
    
    @scala.inline
    def manipulation: typings.reactPointable.reactPointableStrings.manipulation = "manipulation".asInstanceOf[typings.reactPointable.reactPointableStrings.manipulation]
    
    @scala.inline
    def none: typings.reactPointable.reactPointableStrings.none = "none".asInstanceOf[typings.reactPointable.reactPointableStrings.none]
    
    @scala.inline
    def `pan-x`: typings.reactPointable.reactPointableStrings.`pan-x` = "pan-x".asInstanceOf[typings.reactPointable.reactPointableStrings.`pan-x`]
    
    @scala.inline
    def `pan-y`: typings.reactPointable.reactPointableStrings.`pan-y` = "pan-y".asInstanceOf[typings.reactPointable.reactPointableStrings.`pan-y`]
  }
}
