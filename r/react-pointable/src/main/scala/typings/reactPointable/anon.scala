...
object anon {
  ...
  object TagName {
    ...
    implicit class TagNameMutableBuilder[Self <: TagName] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTagName(value: div): Self = StObject.set(x, "tagName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTouchAction(value: auto): Self = StObject.set(x, "touchAction", value.asInstanceOf[js.Any])
    }
  }
}
