...
object RTCPeerConnectionState {
  ...
  @scala.inline
  def connecting: typings.reactNativeWebrtc.reactNativeWebrtcStrings.connecting = "connecting".asInstanceOf[typings.reactNativeWebrtc.reactNativeWebrtcStrings.connecting]
