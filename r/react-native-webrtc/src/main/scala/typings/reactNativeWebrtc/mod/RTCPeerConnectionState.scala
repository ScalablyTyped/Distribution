...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.reactNativeWebrtc.reactNativeWebrtcStrings.connecting
...
object RTCPeerConnectionState {
  ...
  inline def connecting: typings.reactNativeWebrtc.reactNativeWebrtcStrings.connecting = "connecting".asInstanceOf[typings.reactNativeWebrtc.reactNativeWebrtcStrings.connecting]
