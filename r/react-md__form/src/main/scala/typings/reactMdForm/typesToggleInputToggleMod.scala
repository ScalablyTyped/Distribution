...
object typesToggleInputToggleMod {
  
  @JSImport("@react-md/form/types/toggle/InputToggle", "InputToggle")
  @js.native
  ...
  trait InputToggleProps extends StObject {
  ...
  object InputToggleProps {
    ...
    inline def apply(id: String): InputToggleProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[InputToggleProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: InputToggleProps] (val x: Self) extends AnyVal {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactMdForm.anon.typeradioInputToggleProps
    - typings.reactMdForm.anon.typecheckboxindeterminate
  */
  trait Props extends StObject
  object Props {
    
    inline def typecheckboxindeterminate(id: String): typings.reactMdForm.anon.typecheckboxindeterminate = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("checkbox")
      __obj.asInstanceOf[typings.reactMdForm.anon.typecheckboxindeterminate]
    }
    
    inline def typeradioInputToggleProps(id: String): typings.reactMdForm.anon.typeradioInputToggleProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("radio")
      __obj.asInstanceOf[typings.reactMdForm.anon.typeradioInputToggleProps]
    }
  }
}
