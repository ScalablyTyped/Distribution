...
object passwordMod {
  ...
  object ConfigurableVisibilityIcon {
    ...
    extension [Self <: ConfigurableVisibilityIcon](x: Self) {
      ...
      inline def setVisible(value: ReactNode): Self = StObject.set(x, "visible", value.asInstanceOf[js.Any])
  ...
  object PasswordProps {
    ...
    extension [Self <: PasswordProps](x: Self) {
      ...
      inline def setGetVisibilityIcon(value: /* type */ text | password => ReactNode): Self = StObject.set(x, "getVisibilityIcon", js.Any.fromFunction1(value))
      ...
      inline def setOnVisibilityClick(value: MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onVisibilityClick", js.Any.fromFunction1(value))
      ...
      inline def setVisibilityIcon(value: ReactNode | ConfigurableVisibilityIcon): Self = StObject.set(x, "visibilityIcon", value.asInstanceOf[js.Any])
