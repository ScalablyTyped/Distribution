...
import typings.reactMdForm.reactMdFormStrings.password
...
object passwordMod {
  ...
  object ConfigurableVisibilityIcon {
    ...
    @scala.inline
    implicit class ConfigurableVisibilityIconMutableBuilder[Self <: ConfigurableVisibilityIcon] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setInvisible(value: ReactNode): Self = StObject.set(x, "invisible", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInvisibleUndefined: Self = StObject.set(x, "invisible", js.undefined)
      
      @scala.inline
      def setVisible(value: ReactNode): Self = StObject.set(x, "visible", value.asInstanceOf[js.Any])
  ...
  type GetVisibilityIcon = js.Function1[/* type */ text | password, ReactNode]
  
  /* Inlined parent std.Omit<@react-md/form.@react-md/form/types/text-field/TextField.TextFieldProps, 'type' | 'rightChildren'> */
  @js.native
  trait PasswordProps extends StObject {
    ...
    /**
      ...
      */
    var disableVisibility: js.UndefOr[Boolean] = js.native
    ...
    /**
      ...
      */
    var getVisibilityIcon: js.UndefOr[GetVisibilityIcon] = js.native
    ...
    /**
      ...
      * implement your own `Password` component using the native `TextField`.
      */
    var onVisibilityClick: js.UndefOr[MouseEventHandler[HTMLButtonElement]] = js.native
    ...
    /**
      ...
      */
    var visibilityClassName: js.UndefOr[String] = js.native
    ...
    /**
      ...
      */
    var visibilityIcon: js.UndefOr[ReactNode | ConfigurableVisibilityIcon] = js.native
    ...
    /**
      ...
      */
    var visibilityLabel: js.UndefOr[String] = js.native
    
    /**
      * An optional style to apply to the visibility toggle button.
      */
    var visibilityStyle: js.UndefOr[CSSProperties] = js.native
  ...
  object PasswordProps {
    ...
    @scala.inline
    def apply(id: String): PasswordProps = {
    ...
    implicit class PasswordPropsMutableBuilder[Self <: PasswordProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisableVisibility(value: Boolean): Self = StObject.set(x, "disableVisibility", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisableVisibilityUndefined: Self = StObject.set(x, "disableVisibility", js.undefined)
      ...
      @scala.inline
      def setGetVisibilityIcon(value: /* type */ text | password => ReactNode): Self = StObject.set(x, "getVisibilityIcon", js.Any.fromFunction1(value))
      
      @scala.inline
      def setGetVisibilityIconUndefined: Self = StObject.set(x, "getVisibilityIcon", js.undefined)
      ...
      @scala.inline
      def setOnVisibilityClick(value: MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onVisibilityClick", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnVisibilityClickUndefined: Self = StObject.set(x, "onVisibilityClick", js.undefined)
      ...
      @scala.inline
      def setVisibilityClassName(value: String): Self = StObject.set(x, "visibilityClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVisibilityClassNameUndefined: Self = StObject.set(x, "visibilityClassName", js.undefined)
      
      @scala.inline
      def setVisibilityIcon(value: ReactNode | ConfigurableVisibilityIcon): Self = StObject.set(x, "visibilityIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVisibilityIconUndefined: Self = StObject.set(x, "visibilityIcon", js.undefined)
      
      @scala.inline
      def setVisibilityLabel(value: String): Self = StObject.set(x, "visibilityLabel", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVisibilityLabelUndefined: Self = StObject.set(x, "visibilityLabel", js.undefined)
      
      @scala.inline
      def setVisibilityStyle(value: CSSProperties): Self = StObject.set(x, "visibilityStyle", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setVisibilityStyleUndefined: Self = StObject.set(x, "visibilityStyle", js.undefined)
