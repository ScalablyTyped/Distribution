...
object typesSliderConstantsMod {
  
  @JSImport("@react-md/form/types/slider/constants", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@react-md/form/types/slider/constants", "DEFAULT_SLIDER_ANIMATION_TIME")
  @js.native
  ...
  @JSImport("@react-md/form/types/slider/constants", "THUMB_1_VAR")
  @js.native
  val THUMB_1_VAR: /* "--offset1" */ String = js.native
  
  @JSImport("@react-md/form/types/slider/constants", "THUMB_2_VAR")
  @js.native
