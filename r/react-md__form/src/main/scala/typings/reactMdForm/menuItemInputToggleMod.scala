...
object menuItemInputToggleMod {
  ...
  - typings.reactMdForm.menuItemInputToggleMod.AllowedListItemProps because var conflicts: children. Inlined threeLines, height, textChildren, textClassName, secondaryTextClassName, secondaryText, disabledOpacity, primaryText, forceAddonWrap */ trait BaseMenuItemInputToggleProps
    extends StObject
