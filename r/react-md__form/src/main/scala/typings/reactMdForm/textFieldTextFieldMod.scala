...
object textFieldTextFieldMod {
  ...
  */
  ...
  object TextFieldAttributes {
    ...
    @scala.inline
    implicit class TextFieldAttributesMutableBuilder[Self <: TextFieldAttributes] (val x: Self) extends AnyVal {
  ...
  object TextFieldProps {
    ...
    implicit class TextFieldPropsMutableBuilder[Self <: TextFieldProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setType(value: SupportedInputTypes): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
