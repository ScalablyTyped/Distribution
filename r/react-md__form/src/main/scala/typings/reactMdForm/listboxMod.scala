...
object listboxMod {
  ...
  object ListboxChangeEventData {
    ...
    extension [Self <: ListboxChangeEventData](x: Self) {
      ...
      inline def setOptionsVarargs(value: ListboxOption*): Self = StObject.set(x, "options", js.Array(value :_*))
  ...
  trait ListboxOptions
    ...
    /**
      ...
      */
    var getOptionLabel: js.UndefOr[js.Function2[/* option */ ListboxOption, /* labelKey */ String, ReactNode]] = js.undefined
    ...
    /**
      ...
      * do `option[valueKey]`.
      */
    var getOptionValue: js.UndefOr[js.Function2[/* item */ js.Any, /* valueKey */ js.UndefOr[String], String]] = js.undefined
  ...
  object ListboxOptions {
    ...
    extension [Self <: ListboxOptions](x: Self) {
      ...
      inline def setGetOptionLabel(value: (/* option */ ListboxOption, /* labelKey */ String) => ReactNode): Self = StObject.set(x, "getOptionLabel", js.Any.fromFunction2(value))
      
      inline def setGetOptionLabelUndefined: Self = StObject.set(x, "getOptionLabel", js.undefined)
      
      inline def setGetOptionValue(value: (/* item */ js.Any, /* valueKey */ js.UndefOr[String]) => String): Self = StObject.set(x, "getOptionValue", js.Any.fromFunction2(value))
