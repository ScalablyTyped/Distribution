...
object typesTextFieldPasswordWithMessageMod {
  
  @JSImport("@react-md/form/types/text-field/PasswordWithMessage", "PasswordWithMessage")
  @js.native
  val PasswordWithMessage: ForwardRefExoticComponent[PasswordPropsmessageProps] = js.native
  
  /* Inlined @react-md/form.@react-md/form/types/FormMessageContainer.FieldMessageContainerExtension<@react-md/form.@react-md/form/types/text-field/Password.PasswordProps> */
  trait PasswordWithMessageProps extends StObject {
  ...
  object PasswordWithMessageProps {
    
    inline def apply(id: String): PasswordWithMessageProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[PasswordWithMessageProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PasswordWithMessageProps] (val x: Self) extends AnyVal {
