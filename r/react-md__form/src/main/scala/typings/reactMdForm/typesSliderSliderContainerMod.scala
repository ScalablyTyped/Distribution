...
object typesSliderSliderContainerMod {
  
  @JSImport("@react-md/form/types/slider/SliderContainer", "SliderContainer")
  @js.native
  ...
  /* Inlined parent @react-md/form.@react-md/form/types/slider/types.SliderLabelProps */
  /* Inlined parent @react-md/form.@react-md/form/types/slider/types.SliderAddons */
  /* Inlined parent std.Pick<@react-md/form.@react-md/form/types/slider/types.SliderPresentation, 'vertical'> */
  trait SliderContainerProps extends StObject {
  ...
  object SliderContainerProps {
    
    inline def apply(labelId: String): SliderContainerProps = {
