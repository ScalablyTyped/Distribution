...
@js.native
trait OmitHTMLAttributesHTMLDiv extends js.Object {
...
object OmitHTMLAttributesHTMLDiv {
  ...
  @scala.inline
  def apply(): OmitHTMLAttributesHTMLDiv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitHTMLAttributesHTMLDiv]
  }
  
  @scala.inline
  implicit class OmitHTMLAttributesHTMLDivOps[Self <: OmitHTMLAttributesHTMLDiv] (val x: Self) extends AnyVal {
