...
/* Inlined {  type :'checkbox',   indeterminate :boolean | undefined} & @react-md/form.@react-md/form/types/toggle/InputToggle.InputToggleProps */
trait typecheckboxindeterminate
  extends StObject
     with Props {
...
object typecheckboxindeterminate {
  
  inline def apply(id: String): typecheckboxindeterminate = {
