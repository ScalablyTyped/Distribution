...
import typings.reactMdForm.typesTextFieldUseNumberFieldMod.FixNumberOnBlur
...
/* Inlined @react-md/form.@react-md/form/types/text-field/useNumberField.NumberFieldHookOptions & {  defaultValue :number | (): number,   disableMessage :false} */
trait NumberFieldHookOptionsdefCounter extends StObject {
...
object NumberFieldHookOptionsdefCounter {
  
  inline def apply(id: String): NumberFieldHookOptionsdefCounter = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[NumberFieldHookOptionsdefCounter]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NumberFieldHookOptionsdefCounter] (val x: Self) extends AnyVal {
