...
/* Inlined {  type :'checkbox'} & @react-md/form.@react-md/form/types/toggle/Checkbox.IndeterminateCheckboxProps & @react-md/form.@react-md/form/types/menu/MenuItemInputToggle.BaseMenuItemInputToggleProps */
trait typecheckboxIndeterminate_
  extends StObject
...
object typecheckboxIndeterminate_ {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[typecheckboxIndeterminate_]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: typecheckboxIndeterminate_] (val x: Self) extends AnyVal {
