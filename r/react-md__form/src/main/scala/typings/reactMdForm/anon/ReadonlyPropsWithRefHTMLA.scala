...
trait ReadonlyPropsWithRefHTMLA extends StObject {
  ...
  val onResize: js.UndefOr[ReactEventHandler[HTMLLIElement]] = js.undefined
...
object ReadonlyPropsWithRefHTMLA {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ReadonlyPropsWithRefHTMLA] (val x: Self) extends AnyVal {
