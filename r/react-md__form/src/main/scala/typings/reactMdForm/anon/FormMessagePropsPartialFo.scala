...
/* Inlined @react-md/form.@react-md/form/types/text-field/FormMessage.FormMessageProps & std.Partial<@react-md/form.@react-md/form/types/text-field/FormMessage.FormMessageCounterProps> & react.react.RefAttributes<std.HTMLDivElement> */
@js.native
trait FormMessagePropsPartialFo extends js.Object {
...
object FormMessagePropsPartialFo {
  @scala.inline
  def apply(id: String): FormMessagePropsPartialFo = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[FormMessagePropsPartialFo]
  }
  @scala.inline
  implicit class FormMessagePropsPartialFoOps[Self <: FormMessagePropsPartialFo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDisableWrap(value: Boolean): Self = this.set("disableWrap", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableWrap: Self = this.set("disableWrap", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setMessageClassName(value: String): Self = this.set("messageClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMessageClassName: Self = this.set("messageClassName", js.undefined)
    @scala.inline
    def setMessageStyle(value: CSSProperties): Self = this.set("messageStyle", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRole(value: alert): Self = this.set("role", value.asInstanceOf[js.Any])
    @scala.inline
