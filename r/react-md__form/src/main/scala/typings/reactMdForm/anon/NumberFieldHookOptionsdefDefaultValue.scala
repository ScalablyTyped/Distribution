...
/* Inlined @react-md/form.@react-md/form/types/text-field/useNumberField.NumberFieldHookOptions & {  defaultValue :number | (): number,   disableMessage :boolean | undefined} */
trait NumberFieldHookOptionsdefDefaultValue extends StObject {
...
object NumberFieldHookOptionsdefDefaultValue {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NumberFieldHookOptionsdefDefaultValue] (val x: Self) extends AnyVal {
