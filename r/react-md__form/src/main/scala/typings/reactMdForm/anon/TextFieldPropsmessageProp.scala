...
trait TextFieldPropsmessageProp extends StObject {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[SupportedInputTypes] = js.undefined
...
object TextFieldPropsmessageProp {
  
  inline def apply(id: String): TextFieldPropsmessageProp = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.asInstanceOf[TextFieldPropsmessageProp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TextFieldPropsmessageProp] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: SupportedInputTypes): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
