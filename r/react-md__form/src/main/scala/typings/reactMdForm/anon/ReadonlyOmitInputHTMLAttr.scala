...
trait ReadonlyOmitInputHTMLAttr extends StObject {
  ...
  val `aria-autocomplete`: js.UndefOr[none | `inline` | typings.reactMdForm.reactMdFormStrings.list | both] = js.undefined
  ...
  val `aria-current`: js.UndefOr[
    Boolean | page | typings.reactMdForm.reactMdFormStrings.step | location | date | time
  ] = js.undefined
...
object ReadonlyOmitInputHTMLAttr {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ReadonlyOmitInputHTMLAttr] (val x: Self) extends AnyVal {
