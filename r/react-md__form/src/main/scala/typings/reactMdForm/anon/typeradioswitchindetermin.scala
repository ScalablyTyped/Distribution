...
/* Inlined {  type :'radio' | 'switch',   indeterminate :never | undefined} & @react-md/form.@react-md/form/types/menu/MenuItemInputToggle.BaseMenuItemInputToggleProps */
trait typeradioswitchindetermin
  extends StObject
     with StrictMenuItemInputToggleProps {
  ...
  var indeterminate: js.UndefOr[scala.Nothing] = js.undefined
...
object typeradioswitchindetermin {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[typeradioswitchindetermin]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: typeradioswitchindetermin] (val x: Self) extends AnyVal {
