package typings.reactMdForm.switchMod
...
object SwitchProps {
  ...
  implicit class SwitchPropsOps[Self <: SwitchProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBallClassName(value: String): Self = this.set("ballClassName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBallClassName: Self = this.set("ballClassName", js.undefined)
    
    @scala.inline
    def setBallStyle(value: CSSProperties): Self = this.set("ballStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBallStyle: Self = this.set("ballStyle", js.undefined)
