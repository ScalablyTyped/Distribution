...
object PasswordProps {
  ...
  implicit class PasswordPropsOps[Self <: PasswordProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisableVisibility(value: Boolean): Self = this.set("disableVisibility", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableVisibility: Self = this.set("disableVisibility", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setGetVisibilityIcon(value: /* type */ text | password => ReactNode): Self = this.set("getVisibilityIcon", js.Any.fromFunction1(value))
    @scala.inline
    def deleteGetVisibilityIcon: Self = this.set("getVisibilityIcon", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setOnVisibilityClick(value: MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = this.set("onVisibilityClick", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnVisibilityClick: Self = this.set("onVisibilityClick", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setVisibilityClassName(value: String): Self = this.set("visibilityClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteVisibilityClassName: Self = this.set("visibilityClassName", js.undefined)
    @scala.inline
    def setVisibilityIcon(value: ReactNode | ConfigurableVisibilityIcon): Self = this.set("visibilityIcon", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteVisibilityIcon: Self = this.set("visibilityIcon", js.undefined)
    @scala.inline
    def setVisibilityLabel(value: String): Self = this.set("visibilityLabel", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteVisibilityLabel: Self = this.set("visibilityLabel", js.undefined)
    @scala.inline
    def setVisibilityStyle(value: CSSProperties): Self = this.set("visibilityStyle", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteVisibilityStyle: Self = this.set("visibilityStyle", js.undefined)
    @scala.inline
