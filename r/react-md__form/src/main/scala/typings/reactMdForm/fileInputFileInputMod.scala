...
import typings.reactMdForm.reactMdFormStrings.environment
...
object fileInputFileInputMod {
  ...
  object FileInputProps {
    ...
    extension [Self <: FileInputProps](x: Self) {
      ...
      inline def setDisableIconSpacing(value: Boolean): Self = StObject.set(x, "disableIconSpacing", value.asInstanceOf[js.Any])
      
      inline def setDisableIconSpacingUndefined: Self = StObject.set(x, "disableIconSpacing", js.undefined)
