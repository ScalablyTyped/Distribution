...
object typesMenuMenuItemCheckboxMod {
  ...
  - typings.reactMdForm.typesToggleCheckboxMod.IndeterminateCheckboxProps because var conflicts: `aria-controls`. Inlined indeterminate */ trait MenuItemCheckboxProps
    extends StObject
