package typings.reactMdForm.fileInputFileInputMod
...
object FileInputProps {
  ...
  implicit class FileInputPropsOps[Self <: FileInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisableIconSpacing(value: Boolean): Self = this.set("disableIconSpacing", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableIconSpacing: Self = this.set("disableIconSpacing", js.undefined)
    @scala.inline
    def setDisableRepeatableFiles(value: Boolean): Self = this.set("disableRepeatableFiles", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisableRepeatableFiles: Self = this.set("disableRepeatableFiles", js.undefined)
    @scala.inline
