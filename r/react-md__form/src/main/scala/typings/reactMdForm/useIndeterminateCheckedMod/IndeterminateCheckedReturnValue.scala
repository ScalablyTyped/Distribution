...
object IndeterminateCheckedReturnValue {
  ...
  @scala.inline
  implicit class IndeterminateCheckedReturnValueOps[Self <: IndeterminateCheckedReturnValue[_], /* <: java.lang.String */ T] (val x: Self with IndeterminateCheckedReturnValue[T]) extends AnyVal {
    @scala.inline
