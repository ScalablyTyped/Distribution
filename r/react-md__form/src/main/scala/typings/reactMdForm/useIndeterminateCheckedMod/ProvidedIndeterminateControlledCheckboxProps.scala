...
object ProvidedIndeterminateControlledCheckboxProps {
  ...
  @scala.inline
  implicit class ProvidedIndeterminateControlledCheckboxPropsOps[Self <: ProvidedIndeterminateControlledCheckboxProps[_], T /* <: String */] (val x: Self with ProvidedIndeterminateControlledCheckboxProps[T]) extends AnyVal {
