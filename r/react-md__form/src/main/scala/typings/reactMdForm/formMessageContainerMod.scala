...
import typings.reactMdForm.reactMdFormStrings.alert
...
object formMessageContainerMod {
  
  @JSImport("@react-md/form/types/FormMessageContainer", "FormMessageContainer")
  @js.native
  ...
  type FieldMessageContainerExtension[P] = P & typings.reactMdForm.anon.MessageContainerProps
  
  trait FormMessageContainerProps
    extends StObject
  ...
  object FormMessageContainerProps {
    
    inline def apply(): FormMessageContainerProps = {
  ...
  /* Inlined @react-md/utils.@react-md/utils.PropsWithRef<@react-md/form.@react-md/form/types/FormMessage.FormMessageProps, std.HTMLDivElement> */
  trait MessageProps extends StObject {
    ...
    /**
      ...
      * `"alert"`.
      */
    var disableWrap: js.UndefOr[Boolean] = js.undefined
    ...
    /**
      ...
      */
    var role: js.UndefOr[alert] = js.undefined
  ...
  object MessageProps {
    ...
    inline def apply(id: String): MessageProps = {
    ...
    extension [Self <: MessageProps](x: Self) {
      ...
      inline def setDisableWrap(value: Boolean): Self = StObject.set(x, "disableWrap", value.asInstanceOf[js.Any])
      
      inline def setDisableWrapUndefined: Self = StObject.set(x, "disableWrap", js.undefined)
      ...
      inline def setRole(value: alert): Self = StObject.set(x, "role", value.asInstanceOf[js.Any])
