...
import typings.reactMdForm.typesSelectListboxMod.ListboxChangeEventData
import typings.reactMdForm.typesSelectListboxMod.ListboxOptions
...
object typesSelectSelectMod {
  ...
  object SelectProps {
    ...
    extension [Self <: SelectProps](x: Self) {
      ...
      inline def setGetDisplayLabel(value: (/* option */ ListboxOption, /* labelKey */ String, /* includeLeft */ Boolean) => ReactNode): Self = StObject.set(x, "getDisplayLabel", js.Any.fromFunction3(value))
