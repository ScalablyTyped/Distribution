...
/* Rewritten from type alias, can be one of: 
  - typings.reactMdForm.reactMdFormStrings.onBlur
  - typings.reactMdForm.reactMdFormStrings.onKeyDown
  - typings.reactMdForm.reactMdFormStrings.onMouseDown
  - typings.reactMdForm.reactMdFormStrings.onTouchStart
*/
trait SliderEventHandlerNames extends StObject
object SliderEventHandlerNames {
  
  inline def onBlur: typings.reactMdForm.reactMdFormStrings.onBlur = "onBlur".asInstanceOf[typings.reactMdForm.reactMdFormStrings.onBlur]
