...
import typings.reactMdForm.formMessageContainerMod.MessageContainerProps
...
object textFieldWithMessageMod {
  
  @JSImport("@react-md/form/types/text-field/TextFieldWithMessage", "TextFieldWithMessage")
  @js.native
  val TextFieldWithMessage: ForwardRefExoticComponent[TextFieldPropsmessageProp] = js.native
  
  /* Inlined @react-md/form.@react-md/form/types/FormMessageContainer.FieldMessageContainerExtension<@react-md/form.@react-md/form/types/text-field/TextField.TextFieldProps> */
  trait TextFieldWithMessageProps extends StObject {
  ...
  object TextFieldWithMessageProps {
    
    inline def apply(id: String): TextFieldWithMessageProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[TextFieldWithMessageProps]
    }
    
    extension [Self <: TextFieldWithMessageProps](x: Self) {
