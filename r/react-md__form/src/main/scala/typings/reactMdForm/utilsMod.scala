...
object utilsMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactMdForm.utilsMod.ProcessingFileUploadStats
    - typings.reactMdForm.utilsMod.CompletedFileUploadStats
  */
  trait FileUploadStats extends StObject
  object FileUploadStats {
    
    inline def CompletedFileUploadStats(file: File, key: String, progress: Double): typings.reactMdForm.utilsMod.CompletedFileUploadStats = {
      val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any], progress = progress.asInstanceOf[js.Any], status = "complete", result = null)
      __obj.asInstanceOf[typings.reactMdForm.utilsMod.CompletedFileUploadStats]
    }
    
    inline def ProcessingFileUploadStats(file: File, key: String, progress: Double, status: pending | uploading): typings.reactMdForm.utilsMod.ProcessingFileUploadStats = {
      ...
      __obj.asInstanceOf[typings.reactMdForm.utilsMod.ProcessingFileUploadStats]
    }
  }
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactMdForm.utilsMod.FileAccessError
    - typings.reactMdForm.utilsMod.TooManyFilesError
    - typings.reactMdForm.utilsMod.FileSizeError
    - typings.reactMdForm.utilsMod.FileExtensionError
    - E
  */
