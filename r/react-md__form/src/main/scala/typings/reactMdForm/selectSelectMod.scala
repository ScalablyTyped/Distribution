...
object selectSelectMod {
  ...
  object SelectProps {
    ...
    implicit class SelectPropsMutableBuilder[Self <: SelectProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetDisplayLabel(value: (/* option */ ListboxOption, /* labelKey */ String, /* includeLeft */ Boolean) => ReactNode): Self = StObject.set(x, "getDisplayLabel", js.Any.fromFunction3(value))
