...
import typings.reactMdForm.anon.ReadonlyOmitInputHTMLAttr
...
import typings.reactMdForm.reactMdFormStrings.menuitem
...
object typesMenuMenuItemFileInputMod {
  ...
  object MenuItemAllowedFileInputProps {
    ...
    inline def apply(id: String, onChange: ChangeEvent[HTMLInputElement] => Unit): MenuItemAllowedFileInputProps = {
  ...
  object MenuItemFileInputProps {
    ...
    inline def apply(id: String, onChange: ChangeEvent[HTMLInputElement] => Unit): MenuItemFileInputProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], onChange = js.Any.fromFunction1(onChange))
