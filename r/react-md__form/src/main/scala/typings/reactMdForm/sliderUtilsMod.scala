...
import typings.reactMdForm.typesMod.SliderControls
...
object sliderUtilsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactMdForm.sliderUtilsMod.SimpleSliderControls
    - typings.reactMdForm.sliderUtilsMod.ComplexSliderControls
  */
  ...
  object CombinedSliderControls {
    ...
    inline def ComplexSliderControls(
      ...
      __obj.asInstanceOf[typings.reactMdForm.sliderUtilsMod.ComplexSliderControls]
    }
    ...
    inline def SimpleSliderControls(
      ...
      __obj.asInstanceOf[typings.reactMdForm.sliderUtilsMod.SimpleSliderControls]
    }
  }
