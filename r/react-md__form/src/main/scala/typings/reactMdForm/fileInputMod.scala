...
object fileInputMod {
  ...
  open class FileAccessError ()
    extends typings.reactMdForm.utilsMod.FileAccessError {
  ...
  open class FileExtensionError protected ()
    extends typings.reactMdForm.utilsMod.FileExtensionError {
    /**
      *
  ...
  open class FileSizeError protected ()
    extends typings.reactMdForm.utilsMod.FileSizeError {
    /**
      *
  ...
  open class GenericFileError protected ()
    extends typings.reactMdForm.utilsMod.GenericFileError {
    /**
      *
  ...
  open class TooManyFilesError protected ()
    extends typings.reactMdForm.utilsMod.TooManyFilesError {
    /**
      *
