...
trait Rules[P /* <: js.Object */] extends js.Object {
  ...
  {[ key in keyof P ]: react-native-joi.react-native-joi.SchemaLike}
    */ typings.reactDashNativeDashJoi.reactDashNativeDashJoiStrings.Rules with js.Any)
  ] = js.undefined
...
object Rules {
  ...
  {[ key in keyof P ]: react-native-joi.react-native-joi.SchemaLike}
    */ typings.reactDashNativeDashJoi.reactDashNativeDashJoiStrings.Rules with js.Any) = null,
