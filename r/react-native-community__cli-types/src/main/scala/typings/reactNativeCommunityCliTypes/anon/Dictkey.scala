...
object Dictkey {
  ...
  implicit class DictkeyOps[Self <: Dictkey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAndroid(value: AndroidDependencyConfig): Self = this.set("android", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIos(value: IOSDependencyConfig): Self = this.set("ios", value.asInstanceOf[js.Any])
