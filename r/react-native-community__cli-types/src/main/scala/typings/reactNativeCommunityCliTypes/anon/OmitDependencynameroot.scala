...
object OmitDependencynameroot {
  ...
  inline def apply(assets: js.Array[String], hooks: Postlink, params: js.Array[InquirerPrompt], platforms: Dictkey): OmitDependencynameroot = {
  ...
  extension [Self <: OmitDependencynameroot](x: Self) {
