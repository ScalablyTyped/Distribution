...
import typings.reactMentions.applyChangeToValueMod.Options
import typings.reactMentions.getMentionsMod.Mention
import typings.reactMentions.iterateMentionsMarkupMod.MarkupIterateeFunction
...
object utilsMod {
  ...
  object PLACEHOLDERS extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typings.reactMentions.placeholdersMod.PLACEHOLDERS & String] = js.native
    
    /* "__display__" */ val display: typings.reactMentions.placeholdersMod.PLACEHOLDERS.display & String = js.native
    
    /* "__id__" */ val id: typings.reactMentions.placeholdersMod.PLACEHOLDERS.id & String = js.native
  }
  ...
  inline def isNumber[T](`val`: T): `false` | `true` = ^.asInstanceOf[js.Dynamic].applyDynamic("isNumber")(`val`.asInstanceOf[js.Any]).asInstanceOf[`false` | `true`]
