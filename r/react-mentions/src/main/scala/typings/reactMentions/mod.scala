...
object mod {
  ...
  trait MentionsInputProps extends StObject {
    ...
    /**
      ...
      */
    var allowSpaceInQuery: js.UndefOr[Boolean] = js.native
    
    var allowSuggestionsAboveCursor: js.UndefOr[Boolean] = js.native
    ...
    var onChange: js.UndefOr[OnChangeHandlerFunc] = js.native
    ...
    var onSelect: js.UndefOr[js.Function1[/* event */ UIEvent[Element, NativeUIEvent], Unit]] = js.native
    ...
    var suggestionsPortalHost: js.UndefOr[Element] = js.native
