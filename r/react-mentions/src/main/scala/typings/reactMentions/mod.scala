...
import typings.reactMentions.anon.Target
import typings.reactMentions.reactMentionsStrings.`additions removals`
import typings.reactMentions.reactMentionsStrings.`additions text`
import typings.reactMentions.reactMentionsStrings.`inline`
import typings.reactMentions.reactMentionsStrings.`removals additions`
import typings.reactMentions.reactMentionsStrings.`removals text`
import typings.reactMentions.reactMentionsStrings.`text additions`
import typings.reactMentions.reactMentionsStrings.`text removals`
import typings.reactMentions.reactMentionsStrings.additions
import typings.reactMentions.reactMentionsStrings.all
import typings.reactMentions.reactMentionsStrings.ascending
import typings.reactMentions.reactMentionsStrings.assertive
import typings.reactMentions.reactMentionsStrings.both
import typings.reactMentions.reactMentionsStrings.copy
import typings.reactMentions.reactMentionsStrings.date
import typings.reactMentions.reactMentionsStrings.decimal
import typings.reactMentions.reactMentionsStrings.descending
import typings.reactMentions.reactMentionsStrings.dialog
import typings.reactMentions.reactMentionsStrings.email
import typings.reactMentions.reactMentionsStrings.execute
import typings.reactMentions.reactMentionsStrings.grammar
import typings.reactMentions.reactMentionsStrings.grid
import typings.reactMentions.reactMentionsStrings.horizontal
import typings.reactMentions.reactMentionsStrings.inherit
import typings.reactMentions.reactMentionsStrings.link
import typings.reactMentions.reactMentionsStrings.list
import typings.reactMentions.reactMentionsStrings.listbox
import typings.reactMentions.reactMentionsStrings.location
import typings.reactMentions.reactMentionsStrings.menu
import typings.reactMentions.reactMentionsStrings.mixed
import typings.reactMentions.reactMentionsStrings.move
import typings.reactMentions.reactMentionsStrings.no
import typings.reactMentions.reactMentionsStrings.none
import typings.reactMentions.reactMentionsStrings.numeric
import typings.reactMentions.reactMentionsStrings.off
import typings.reactMentions.reactMentionsStrings.on
import typings.reactMentions.reactMentionsStrings.other
import typings.reactMentions.reactMentionsStrings.page
import typings.reactMentions.reactMentionsStrings.polite
import typings.reactMentions.reactMentionsStrings.popup
import typings.reactMentions.reactMentionsStrings.removals
import typings.reactMentions.reactMentionsStrings.search
import typings.reactMentions.reactMentionsStrings.spelling
import typings.reactMentions.reactMentionsStrings.step
import typings.reactMentions.reactMentionsStrings.tel
import typings.reactMentions.reactMentionsStrings.text
import typings.reactMentions.reactMentionsStrings.time
import typings.reactMentions.reactMentionsStrings.tree
import typings.reactMentions.reactMentionsStrings.url
import typings.reactMentions.reactMentionsStrings.vertical
import typings.reactMentions.reactMentionsStrings.yes
...
object mod {
  ...
  @js.native
  val Mention: FC[MentionProps] = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("react-mentions", "MentionsInput")
  @js.native
  open class MentionsInput protected () extends Component[MentionsInputProps, ComponentState, Any] {
    def this(props: MentionsInputProps) = this()
    def this(props: MentionsInputProps, context: Any) = this()
  }
  @JSImport("react-mentions", "MentionsInput")
  @js.native
  val MentionsInput: MentionsInputClass = js.native
  
  type DataFunc = js.Function2[
    /* query */ String, 
    /* callback */ js.Function1[/* data */ js.Array[SuggestionDataItem], Unit], 
    (js.Promise[js.Array[SuggestionDataItem] | Unit]) | Unit | js.Array[SuggestionDataItem]
  ]
  ...
  object MentionProps {
    ...
    inline def apply(data: js.Array[SuggestionDataItem] | DataFunc, trigger: String | js.RegExp): MentionProps = {
    ...
    implicit open class MutableBuilder[Self <: MentionProps] (val x: Self) extends AnyVal {
      ...
      inline def setAppendSpaceOnAddUndefined: Self = StObject.set(x, "appendSpaceOnAdd", js.undefined)
      
      inline def setClassName(value: String): Self = StObject.set(x, "className", value.asInstanceOf[js.Any])
      
      inline def setClassNameUndefined: Self = StObject.set(x, "className", js.undefined)
      
      inline def setData(value: js.Array[SuggestionDataItem] | DataFunc): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
      
      inline def setDataFunction2(
        value: (/* query */ String, /* callback */ js.Function1[/* data */ js.Array[SuggestionDataItem], Unit]) => (js.Promise[js.Array[SuggestionDataItem] | Unit]) | Unit | js.Array[SuggestionDataItem]
      ): Self = StObject.set(x, "data", js.Any.fromFunction2(value))
      
      inline def setDataVarargs(value: SuggestionDataItem*): Self = StObject.set(x, "data", js.Array(value*))
      ...
      inline def setOnAdd(value: (/* id */ String | Double, /* display */ String) => Unit): Self = StObject.set(x, "onAdd", js.Any.fromFunction2(value))
      ...
      inline def setTrigger(value: String | js.RegExp): Self = StObject.set(x, "trigger", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait MentionsInputComponent
    extends Component[MentionsInputProps, js.Object, Any] {
  ...
  /* Inlined parent std.Omit<react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>, 'onChange' | 'onBlur' | 'onKeyDown' | 'onSelect'> */
  trait MentionsInputProps extends StObject {
    
    /**
      * This label would be exposed to screen readers when suggestion popup appears
      * @default ''
      */
    var a11ySuggestionsListLabel: js.UndefOr[String] = js.undefined
    ...
    var classNames: js.UndefOr[Any] = js.undefined
    ...
    var forceSuggestionsAboveCursor: js.UndefOr[Boolean] = js.undefined
    ...
    var inputRef: js.UndefOr[Ref[HTMLInputElement | HTMLTextAreaElement]] = js.undefined
  ...
  object MentionsInputProps {
    ...
    inline def apply(children: ReactElement | js.Array[ReactElement]): MentionsInputProps = {
    ...
    implicit open class MutableBuilder[Self <: MentionsInputProps] (val x: Self) extends AnyVal {
      ...
      inline def setA11ySuggestionsListLabelUndefined: Self = StObject.set(x, "a11ySuggestionsListLabel", js.undefined)
      ...
      inline def setAllowSpaceInQuery(value: Boolean): Self = StObject.set(x, "allowSpaceInQuery", value.asInstanceOf[js.Any])
      
      inline def setAllowSpaceInQueryUndefined: Self = StObject.set(x, "allowSpaceInQuery", js.undefined)
      
      inline def setAllowSuggestionsAboveCursor(value: Boolean): Self = StObject.set(x, "allowSuggestionsAboveCursor", value.asInstanceOf[js.Any])
      
      inline def setAllowSuggestionsAboveCursorUndefined: Self = StObject.set(x, "allowSuggestionsAboveCursor", js.undefined)
      ...
      inline def setClassNames(value: Any): Self = StObject.set(x, "classNames", value.asInstanceOf[js.Any])
      ...
      inline def setForceSuggestionsAboveCursor(value: Boolean): Self = StObject.set(x, "forceSuggestionsAboveCursor", value.asInstanceOf[js.Any])
      
      inline def setForceSuggestionsAboveCursorUndefined: Self = StObject.set(x, "forceSuggestionsAboveCursor", js.undefined)
      ...
      inline def setOnBlur(
        value: (/* event */ FocusEvent[HTMLInputElement | HTMLTextAreaElement, Element], /* clickedSuggestion */ Boolean) => Unit
      ...
      inline def setOnChange(
        value: (/* event */ Target, /* newValue */ String, /* newPlainTextValue */ String, /* mentions */ js.Array[MentionItem]) => Unit
      ...
      inline def setOnKeyDown(value: /* event */ KeyboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      ...
      inline def setOnSelect(value: /* event */ UIEvent[Element, NativeUIEvent] => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
      ...
      inline def setSuggestionsPortalHost(value: Element): Self = StObject.set(x, "suggestionsPortalHost", value.asInstanceOf[js.Any])
      
      inline def setSuggestionsPortalHostUndefined: Self = StObject.set(x, "suggestionsPortalHost", js.undefined)
  ...
  trait SuggestionDataItem extends StObject {
  ...
  object SuggestionDataItem {
    ...
    inline def apply(id: String | Double): SuggestionDataItem = {
