...
object mod {
  ...
  @js.native
  val Mention: SFC[MentionProps] = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("react-mentions", "MentionsInput")
  @js.native
  class MentionsInput protected ()
    extends Component[MentionsInputProps, ComponentState, js.Any] {
    def this(props: MentionsInputProps) = this()
    def this(props: MentionsInputProps, context: js.Any) = this()
  }
  @JSImport("react-mentions", "MentionsInput")
  @js.native
  ...
  object MentionItem {
    ...
    @scala.inline
    implicit class MentionItemMutableBuilder[Self <: MentionItem] (val x: Self) extends AnyVal {
  ...
  object MentionProps {
    ...
    implicit class MentionPropsMutableBuilder[Self <: MentionProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAppendSpaceOnAdd(value: Boolean): Self = StObject.set(x, "appendSpaceOnAdd", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAppendSpaceOnAddUndefined: Self = StObject.set(x, "appendSpaceOnAdd", js.undefined)
      ...
      @scala.inline
      def setData(value: js.Array[SuggestionDataItem] | DataFunc): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDataVarargs(value: SuggestionDataItem*): Self = StObject.set(x, "data", js.Array(value :_*))
      
      @scala.inline
      def setDisplayTransform(value: (/* id */ String, /* display */ String) => String): Self = StObject.set(x, "displayTransform", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setOnAdd(value: (/* id */ String | Double, /* display */ String) => Unit): Self = StObject.set(x, "onAdd", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setTrigger(value: String | RegExp): Self = StObject.set(x, "trigger", value.asInstanceOf[js.Any])
    }
  }
  ...
  /* Inlined parent react-mentions.react-mentions.Omit<react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>, 'onChange' | 'onBlur' | 'onKeyDown' | 'onSelect'> */
  ...
  object MentionsInputProps {
    ...
    @scala.inline
    def apply(children: ReactElement | js.Array[ReactElement]): MentionsInputProps = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
      __obj.asInstanceOf[MentionsInputProps]
    }
    
    @scala.inline
    implicit class MentionsInputPropsMutableBuilder[Self <: MentionsInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAllowSpaceInQuery(value: Boolean): Self = StObject.set(x, "allowSpaceInQuery", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAllowSpaceInQueryUndefined: Self = StObject.set(x, "allowSpaceInQuery", js.undefined)
      
      @scala.inline
      def setAllowSuggestionsAboveCursor(value: Boolean): Self = StObject.set(x, "allowSuggestionsAboveCursor", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAllowSuggestionsAboveCursorUndefined: Self = StObject.set(x, "allowSuggestionsAboveCursor", js.undefined)
      ...
      @scala.inline
      def setOnBlur(
        value: (/* event */ FocusEvent[HTMLInputElement | HTMLTextAreaElement], /* clickedSuggestion */ Boolean) => Unit
      ...
      @scala.inline
      def setOnKeyDown(value: /* event */ KeyboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnSelect(value: /* event */ UIEvent[Element, NativeUIEvent] => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setSuggestionsPortalHost(value: Element): Self = StObject.set(x, "suggestionsPortalHost", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSuggestionsPortalHostUndefined: Self = StObject.set(x, "suggestionsPortalHost", js.undefined)
  ...
  object SuggestionDataItem {
    ...
    @scala.inline
    implicit class SuggestionDataItemMutableBuilder[Self <: SuggestionDataItem] (val x: Self) extends AnyVal {
