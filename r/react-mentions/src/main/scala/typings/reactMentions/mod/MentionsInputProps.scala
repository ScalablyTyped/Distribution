...
object MentionsInputProps {
  ...
  implicit class MentionsInputPropsOps[Self <: MentionsInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInputRef(value: RefObject[HTMLInputElement | HTMLTextAreaElement]): Self = this.set("inputRef", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnKeyDown(value: /* event */ KeyboardEvent[HTMLInputElement | HTMLTextAreaElement] => Unit): Self = this.set("onKeyDown", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnSelect(value: /* event */ UIEvent[Element, NativeUIEvent] => Unit): Self = this.set("onSelect", js.Any.fromFunction1(value))
    @scala.inline
