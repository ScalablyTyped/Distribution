...
trait FlipMoveProps extends js.Object {
  ...
  var onFinish: js.UndefOr[
    js.Function2[
      /* childElement */ reactLib.reactMod.ReactElement, 
  ...
  var onFinishAll: js.UndefOr[
    js.Function2[
      /* childElements */ js.Array[reactLib.reactMod.ReactElement], 
...
object FlipMoveProps {
  ...
  def apply(
    ...
    onFinish: (/* childElement */ reactLib.reactMod.ReactElement, /* domNode */ stdLib.HTMLElement) => scala.Unit = null,
    onFinishAll: (/* childElements */ js.Array[reactLib.reactMod.ReactElement], /* domNodes */ js.Array[stdLib.HTMLElement]) => scala.Unit = null,
    onStart: (/* childElement */ reactLib.reactMod.ReactElement, /* domNode */ stdLib.HTMLElement) => scala.Unit = null,
    onStartAll: (/* childElements */ js.Array[reactLib.reactMod.ReactElement], /* domNodes */ js.Array[stdLib.HTMLElement]) => scala.Unit = null,
