...
object RequestHeaders {
  ...
  def apply(
    ...
    `forwarded-for`: java.lang.String = null,
    ...
    `x-client-ip`: java.lang.String = null,
    `x-cluster-client-ip`: java.lang.String = null,
    `x-forwarded`: java.lang.String = null,
    `x-forwarded-for`: java.lang.String = null,
    `x-real-ip`: java.lang.String = null
  ): RequestHeaders = {
