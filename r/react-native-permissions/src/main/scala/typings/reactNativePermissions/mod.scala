...
object mod {
  ...
  object default {
    ...
    @scala.inline
    def check(permission: Permission): js.Promise[unavailable | blocked | denied | granted | limited] = ^.asInstanceOf[js.Dynamic].applyDynamic("check")(permission.asInstanceOf[js.Any]).asInstanceOf[js.Promise[unavailable | blocked | denied | granted | limited]]
    ...
    @scala.inline
    def request(permission: Permission): js.Promise[unavailable | blocked | denied | granted | limited] = ^.asInstanceOf[js.Dynamic].applyDynamic("request")(permission.asInstanceOf[js.Any]).asInstanceOf[js.Promise[unavailable | blocked | denied | granted | limited]]
    @scala.inline
    def request(permission: Permission, rationale: Rationale): js.Promise[unavailable | blocked | denied | granted | limited] = (^.asInstanceOf[js.Dynamic].applyDynamic("request")(permission.asInstanceOf[js.Any], rationale.asInstanceOf[js.Any])).asInstanceOf[js.Promise[unavailable | blocked | denied | granted | limited]]
    
    @scala.inline
    def requestLocationAccuracy(options: LocationAccuracyOptions): js.Promise[LocationAccuracy] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestLocationAccuracy")(options.asInstanceOf[js.Any]).asInstanceOf[js.Promise[LocationAccuracy]]
