...
object permissionsIosMod {
  ...
  object PERMISSIONS {
    ...
    @JSImport("react-native-permissions/dist/typescript/permissions.ios", "PERMISSIONS.ANDROID")
    @js.native
    val ANDROID: ReadonlyreadonlyACCEPTHAN = js.native
    
    @JSImport("react-native-permissions/dist/typescript/permissions.ios", "PERMISSIONS.IOS")
    @js.native
    val IOS: ReadonlyreadonlyAPPTRACKI = js.native
    
    @JSImport("react-native-permissions/dist/typescript/permissions.ios", "PERMISSIONS.WINDOWS")
    @js.native
    val WINDOWS: ReadonlyreadonlyACCESSORY = js.native
  }
  
  /* Inlined std.Readonly<{ readonly APP_TRACKING_TRANSPARENCY :'ios.permission.APP_TRACKING_TRANSPARENCY',  readonly BLUETOOTH_PERIPHERAL :'ios.permission.BLUETOOTH_PERIPHERAL',  readonly CALENDARS :'ios.permission.CALENDARS',  readonly CAMERA :'ios.permission.CAMERA',  readonly CONTACTS :'ios.permission.CONTACTS',  readonly FACE_ID :'ios.permission.FACE_ID',  readonly LOCATION_ALWAYS :'ios.permission.LOCATION_ALWAYS',  readonly LOCATION_WHEN_IN_USE :'ios.permission.LOCATION_WHEN_IN_USE',  readonly MEDIA_LIBRARY :'ios.permission.MEDIA_LIBRARY',  readonly MICROPHONE :'ios.permission.MICROPHONE',  readonly MOTION :'ios.permission.MOTION',  readonly PHOTO_LIBRARY :'ios.permission.PHOTO_LIBRARY',  readonly PHOTO_LIBRARY_ADD_ONLY :'ios.permission.PHOTO_LIBRARY_ADD_ONLY',  readonly REMINDERS :'ios.permission.REMINDERS',  readonly SIRI :'ios.permission.SIRI',  readonly SPEECH_RECOGNITION :'ios.permission.SPEECH_RECOGNITION',  readonly STOREKIT :'ios.permission.STOREKIT'}> */
  trait IOSPermissionMap extends StObject {
    
    val APP_TRACKING_TRANSPARENCY: iosDotpermissionDotAPP_TRACKING_TRANSPARENCY
    
    val BLUETOOTH_PERIPHERAL: iosDotpermissionDotBLUETOOTH_PERIPHERAL
    
    val CALENDARS: iosDotpermissionDotCALENDARS
    
    val CAMERA: iosDotpermissionDotCAMERA
    
    val CONTACTS: iosDotpermissionDotCONTACTS
    
    val FACE_ID: iosDotpermissionDotFACE_ID
    
    val LOCATION_ALWAYS: iosDotpermissionDotLOCATION_ALWAYS
    
    val LOCATION_WHEN_IN_USE: iosDotpermissionDotLOCATION_WHEN_IN_USE
    
    val MEDIA_LIBRARY: iosDotpermissionDotMEDIA_LIBRARY
    
    val MICROPHONE: iosDotpermissionDotMICROPHONE
    
    val MOTION: iosDotpermissionDotMOTION
    
    val PHOTO_LIBRARY: iosDotpermissionDotPHOTO_LIBRARY
    
    val PHOTO_LIBRARY_ADD_ONLY: iosDotpermissionDotPHOTO_LIBRARY_ADD_ONLY
    
    val REMINDERS: iosDotpermissionDotREMINDERS
    
    val SIRI: iosDotpermissionDotSIRI
    
    val SPEECH_RECOGNITION: iosDotpermissionDotSPEECH_RECOGNITION
    
    val STOREKIT: iosDotpermissionDotSTOREKIT
  }
