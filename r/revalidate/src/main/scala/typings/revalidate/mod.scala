...
object mod {
  ...
  inline def composeValidators(firstValidator: Any, validators: Validator*): ComposedCurryableValidator = ^.asInstanceOf[js.Dynamic].applyDynamic("composeValidators")(List(firstValidator.asInstanceOf[js.Any]).`++`(validators.asInstanceOf[Seq[js.Any]])*).asInstanceOf[ComposedCurryableValidator]
  inline def composeValidators(firstValidator: Validator, validators: Validator*): ComposedCurryableValidator = ^.asInstanceOf[js.Dynamic].applyDynamic("composeValidators")(List(firstValidator.asInstanceOf[js.Any]).`++`(validators.asInstanceOf[Seq[js.Any]])*).asInstanceOf[ComposedCurryableValidator]
