...
object reactDashIntlDashReduxComponents extends reactDashIntlDashReduxProps {
  ...
  @scala.inline
  def Provider: ComponentType[ProviderProps[Action[_]]] = js.constructorOf[typings.reactDashIntlDashRedux.reactDashIntlDashReduxMod.Provider[typings.redux.reduxMod.Action[_]]].asInstanceOf[typings.react.reactMod.ComponentType[ProviderProps[typings.redux.reduxMod.Action[_]]]]
}
