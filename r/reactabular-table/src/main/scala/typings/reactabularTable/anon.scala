...
object anon {
  ...
  object Cell {
    ...
    extension [Self <: Cell](x: Self) {
      ...
      inline def setCellFunction1(value: /* props */ js.Any => ReactInstance): Self = StObject.set(x, "cell", js.Any.fromFunction1(value))
      
      inline def setCellFunction2(value: (/* props */ js.Any, /* column */ typings.reactabularTable.mod.Column) => Element): Self = StObject.set(x, "cell", js.Any.fromFunction2(value))
      
      inline def setCellUndefined: Self = StObject.set(x, "cell", js.undefined)
      
      inline def setRow(value: String | (js.Function1[/* props */ js.Any, Element | ReactInstance])): Self = StObject.set(x, "row", value.asInstanceOf[js.Any])
      
      inline def setRowFunction1(value: /* props */ js.Any => Element | ReactInstance): Self = StObject.set(x, "row", js.Any.fromFunction1(value))
      
      inline def setRowUndefined: Self = StObject.set(x, "row", js.undefined)
      
      inline def setWrapper(value: String | (js.Function1[/* props */ js.Any, Element | ReactInstance])): Self = StObject.set(x, "wrapper", value.asInstanceOf[js.Any])
      
      inline def setWrapperFunction1(value: /* props */ js.Any => Element | ReactInstance): Self = StObject.set(x, "wrapper", js.Any.fromFunction1(value))
  ...
  object Draggable {
    ...
    extension [Self <: Draggable](x: Self) {
      ...
      inline def setFormattersVarargs(value: ColumnFormatter*): Self = StObject.set(x, "formatters", js.Array(value :_*))
      ...
      inline def setTransformsVarargs(value: ColumnTransform*): Self = StObject.set(x, "transforms", js.Array(value :_*))
    }
  }
  ...
  object Formatters {
    ...
    extension [Self <: Formatters](x: Self) {
      ...
      inline def setFormattersVarargs(value: CellFormatter*): Self = StObject.set(x, "formatters", js.Array(value :_*))
      
      inline def setTransforms(value: js.Array[CellTransform]): Self = StObject.set(x, "transforms", value.asInstanceOf[js.Any])
      
      inline def setTransformsUndefined: Self = StObject.set(x, "transforms", js.undefined)
      
      inline def setTransformsVarargs(value: CellTransform*): Self = StObject.set(x, "transforms", js.Array(value :_*))
    }
  }
  ...
  object Row {
    ...
    extension [Self <: Row](x: Self) {
      ...
      inline def setCell(value: String | (js.Function1[/* props */ js.Any, Element | ReactInstance])): Self = StObject.set(x, "cell", value.asInstanceOf[js.Any])
      
      inline def setCellFunction1(value: /* props */ js.Any => Element | ReactInstance): Self = StObject.set(x, "cell", js.Any.fromFunction1(value))
      ...
      inline def setRowFunction1(value: /* props */ js.Any => ReactInstance): Self = StObject.set(x, "row", js.Any.fromFunction1(value))
      
      inline def setRowFunction2(value: (/* props */ js.Any, /* rowData */ js.Any) => Element): Self = StObject.set(x, "row", js.Any.fromFunction2(value))
  ...
  object RowData {
    ...
    inline def apply(column: typings.reactabularTable.mod.Column, columnIndex: Double, rowData: js.Any): RowData = {
