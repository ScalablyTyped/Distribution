...
trait PartialCSSStyleDeclaratio extends js.Object {
  ...
  var setProperty: js.UndefOr[js.Function2[/* property */ String, /* value */ String, Unit]] = js.undefined
...
object PartialCSSStyleDeclaratio {
  ...
  def apply(
    ...
    if (parentRule != null) __obj.updateDynamic("parentRule")(parentRule.asInstanceOf[js.Any])
