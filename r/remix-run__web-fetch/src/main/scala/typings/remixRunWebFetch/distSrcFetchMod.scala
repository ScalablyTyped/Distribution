...
object distSrcFetchMod {
  ...
  @JSImport("@remix-run/web-fetch/dist/src/fetch", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@remix-run/web-fetch/dist/src/fetch", "FormData")
  @js.native
  open class FormData ()
    extends StObject
  ...
  @JSImport("@remix-run/web-fetch/dist/src/fetch", "Headers")
  @js.native
  /**
    * Headers class
    *
  ...
  @JSImport("@remix-run/web-fetch/dist/src/fetch", "Request")
  @js.native
  ...
  @JSImport("@remix-run/web-fetch/dist/src/fetch", "Response")
  @js.native
  /**
