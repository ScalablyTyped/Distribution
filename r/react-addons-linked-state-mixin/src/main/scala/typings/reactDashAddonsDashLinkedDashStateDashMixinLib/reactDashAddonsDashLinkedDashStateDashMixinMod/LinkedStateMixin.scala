...
trait LinkedStateMixin
  extends reactLib.reactMod.Mixin[js.Any, js.Any] {
...
object LinkedStateMixin {
  ...
  def apply(
    ...
    UNSAFE_componentWillReceiveProps: (js.Any, /* nextContext */ js.Any) => scala.Unit = null,
    UNSAFE_componentWillUpdate: (js.Any, js.Any, /* nextContext */ js.Any) => scala.Unit = null,
    childContextTypes: reactLib.reactMod.ValidationMap[_] = null,
    ...
    componentDidUpdate: (js.Any, js.Any, /* snapshot */ js.UndefOr[js.Any]) => scala.Unit = null,
    componentWillMount: () => scala.Unit = null,
    componentWillReceiveProps: (js.Any, /* nextContext */ js.Any) => scala.Unit = null,
    componentWillUnmount: () => scala.Unit = null,
    componentWillUpdate: (js.Any, js.Any, /* nextContext */ js.Any) => scala.Unit = null,
    contextTypes: reactLib.reactMod.ValidationMap[_] = null,
    displayName: java.lang.String = null,
    getDefaultProps: () => js.Any = null,
    getInitialState: () => js.Any = null,
    getSnapshotBeforeUpdate: (js.Any, js.Any) => js.Any | scala.Null = null,
    mixins: js.Array[reactLib.reactMod.Mixin[js.Any, js.Any]] = null,
    propTypes: reactLib.reactMod.ValidationMap[_] = null,
    shouldComponentUpdate: (js.Any, js.Any, /* nextContext */ js.Any) => scala.Boolean = null,
