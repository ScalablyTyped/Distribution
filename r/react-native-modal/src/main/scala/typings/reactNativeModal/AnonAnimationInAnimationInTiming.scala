...
trait AnonAnimationInAnimationInTiming extends js.Object {
...
object AnonAnimationInAnimationInTiming {
  @scala.inline
  def apply(
    animationIn: String,
  ...
  ): AnonAnimationInAnimationInTiming = {
    ...
    __obj.asInstanceOf[AnonAnimationInAnimationInTiming]
  }
}
