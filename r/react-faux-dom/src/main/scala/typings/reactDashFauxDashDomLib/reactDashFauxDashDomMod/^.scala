...
object ^ extends js.Object {
  ...
  def createElement(nodeName: java.lang.String): reactDashFauxDashDomLib.reactDashFauxDashDomMod.Element = js.native
  def createElementNS(namespace: java.lang.String, nodeName: java.lang.String): reactDashFauxDashDomLib.reactDashFauxDashDomMod.Element = js.native
  def withFauxDOM[P](
