...
import typings.resourceDashLoader.Anon_CrossOrigin
...
import typings.resourceDashLoader.resourceDashLoaderMod.Resource.OnCompleteSignal
import typings.resourceDashLoader.resourceDashLoaderMod.Resource.OnProgressSignal
import typings.resourceDashLoader.resourceDashLoaderMod.Resource.OnStartSignal
import typings.resourceDashLoader.resourceDashLoaderMod.Resource.TYPE
...
class Resource_ protected () extends js.Object {
  ...
  def this(name: String, url: String, options: Anon_CrossOrigin) = this()
  def this(name: String, url: js.Array[String], options: Anon_CrossOrigin) = this()
  /**
