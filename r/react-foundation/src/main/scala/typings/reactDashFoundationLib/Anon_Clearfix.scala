...
trait Anon_Clearfix extends js.Object {
  ...
  var `show-for-landscape`: js.UndefOr[scala.Boolean] = js.undefined
  ...
  var `show-for-portrait`: js.UndefOr[scala.Boolean] = js.undefined
  var `show-for-small-only`: scala.Boolean
  var `show-for-sr`: js.UndefOr[scala.Boolean] = js.undefined
  var `show-on-focus`: js.UndefOr[scala.Boolean] = js.undefined
}
