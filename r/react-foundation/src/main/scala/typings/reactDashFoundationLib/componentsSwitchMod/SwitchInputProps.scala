...
/* RemoveMultipleInheritance: Dropped parents List(reactDashFoundationLib.utilsMod.GeneralPropTypes because Would inherit conflicting mutable fields List(className))*/
trait SwitchInputProps
