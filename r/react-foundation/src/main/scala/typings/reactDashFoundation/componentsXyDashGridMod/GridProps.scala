...
import typings.reactDashFoundation.enumsMod.GutterTypes
...
- typings.react.reactMod.HTMLAttributes because var conflicts: className. Inlined about, accessKey, autoCapitalize, autoCorrect, autoSave, color, contentEditable, contextMenu, datatype, defaultChecked, defaultValue, dir, draggable, hidden, id, inlist, inputMode, is, itemID, itemProp, itemRef, itemScope, itemType, lang, placeholder, prefix, property, radioGroup, resource, results, role, security, slot, spellCheck, style, suppressContentEditableWarning, suppressHydrationWarning, tabIndex, title, translate, typeof, unselectable, vocab */ trait GridProps
  ...
  var collapseOnLarge: js.UndefOr[GutterTypes] = js.undefined
  var collapseOnMedium: js.UndefOr[GutterTypes] = js.undefined
  var collapseOnSmall: js.UndefOr[GutterTypes] = js.undefined
  ...
  var gridFrame: js.UndefOr[ExtendedBreakpoints] = js.undefined
  var gutters: js.UndefOr[GutterTypes] = js.undefined
...
object GridProps {
  ...
  def apply(
    ...
    collapseOnLarge: GutterTypes = null,
    collapseOnMedium: GutterTypes = null,
    collapseOnSmall: GutterTypes = null,
    color: String = null,
    ...
    gridFrame: ExtendedBreakpoints = null,
    gutters: GutterTypes = null,
    ...
    if (collapseOnLarge != null) __obj.updateDynamic("collapseOnLarge")(collapseOnLarge.asInstanceOf[js.Any])
    if (collapseOnMedium != null) __obj.updateDynamic("collapseOnMedium")(collapseOnMedium.asInstanceOf[js.Any])
    if (collapseOnSmall != null) __obj.updateDynamic("collapseOnSmall")(collapseOnSmall.asInstanceOf[js.Any])
    ...
    if (gridFrame != null) __obj.updateDynamic("gridFrame")(gridFrame.asInstanceOf[js.Any])
