...
object ColumnProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(centerOnLarge)) __obj.updateDynamic("centerOnLarge")(centerOnLarge.asInstanceOf[js.Any])
    if (!js.isUndefined(centerOnMedium)) __obj.updateDynamic("centerOnMedium")(centerOnMedium.asInstanceOf[js.Any])
    if (!js.isUndefined(centerOnSmall)) __obj.updateDynamic("centerOnSmall")(centerOnSmall.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(expandOnLarge)) __obj.updateDynamic("expandOnLarge")(expandOnLarge.asInstanceOf[js.Any])
    if (!js.isUndefined(expandOnMedium)) __obj.updateDynamic("expandOnMedium")(expandOnMedium.asInstanceOf[js.Any])
    if (!js.isUndefined(expandOnSmall)) __obj.updateDynamic("expandOnSmall")(expandOnSmall.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isShrunk)) __obj.updateDynamic("isShrunk")(isShrunk.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(uncenterOnLarge)) __obj.updateDynamic("uncenterOnLarge")(uncenterOnLarge.asInstanceOf[js.Any])
    if (!js.isUndefined(uncenterOnMedium)) __obj.updateDynamic("uncenterOnMedium")(uncenterOnMedium.asInstanceOf[js.Any])
    if (!js.isUndefined(uncenterOnSmall)) __obj.updateDynamic("uncenterOnSmall")(uncenterOnSmall.asInstanceOf[js.Any])
