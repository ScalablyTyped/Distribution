...
object buttonMod {
  ...
  object ButtonProps {
    ...
    implicit class ButtonPropsMutableBuilder[Self <: ButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setColor(value: ButtonColors | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
  ...
  object ButtonPropsCommon {
    ...
    @scala.inline
    implicit class ButtonPropsCommonMutableBuilder[Self <: ButtonPropsCommon] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setIsArrowOnly(value: Boolean): Self = StObject.set(x, "isArrowOnly", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsArrowOnlyUndefined: Self = StObject.set(x, "isArrowOnly", js.undefined)
      ...
      @scala.inline
      def setIsHollow(value: Boolean): Self = StObject.set(x, "isHollow", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsHollowUndefined: Self = StObject.set(x, "isHollow", js.undefined)
      
      @scala.inline
      def setSize(value: ButtonSizes): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
  ...
  - typings.react.mod.AnchorHTMLAttributes because var conflicts: className. Inlined target, media, rel, ping, referrerPolicy, href, download, `type`, hrefLang */ @js.native
  trait LinkProps
    extends ButtonPropsCommon
       with AriaAttributes
