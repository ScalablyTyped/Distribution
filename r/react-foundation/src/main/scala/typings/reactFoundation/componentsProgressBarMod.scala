...
import typings.reactFoundation.utilsMod.GeneralPropTypes
...
object componentsProgressBarMod {
  ...
  @js.native
  val Progress: FunctionComponent[PaginationProps] = js.native
  ...
  - typings.react.mod.ProgressHTMLAttributes because var conflicts: className. Inlined max, value */ trait NativeProgressProps
    extends StObject
       ...
       with AriaAttributes
       with DOMAttributes[HTMLProgressElement] {
    ...
    var value: js.UndefOr[js.Array[String] | Double | String] = js.undefined
    
    var vocab: js.UndefOr[String] = js.undefined
  }
  object NativeProgressProps {
    
    inline def apply(): NativeProgressProps = {
    ...
    extension [Self <: NativeProgressProps](x: Self) {
      ...
      inline def setColor(value: ProgressColors | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      inline def setValue(value: js.Array[String] | Double | String): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
  ...
  object PaginationProps {
    ...
    extension [Self <: PaginationProps](x: Self) {
      ...
      inline def setMeter(value: ProgressMeterWithTextProps): Self = StObject.set(x, "meter", value.asInstanceOf[js.Any])
  ...
  object ProgressMeterProps {
    ...
    inline def apply(): ProgressMeterProps = {
      val __obj = js.Dynamic.literal()
  ...
  - typings.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, nonce, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait ProgressMeterTextProps
    ...
    @JSName("children")
    var children_ProgressMeterTextProps: js.UndefOr[String] = js.undefined
  ...
  object ProgressMeterTextProps {
    ...
    inline def apply(): ProgressMeterTextProps = {
      val __obj = js.Dynamic.literal()
  ...
  object ProgressMeterWithTextProps {
    ...
    inline def apply(text: String): ProgressMeterWithTextProps = {
