package typings.reactFoundation.switchMod
...
import typings.reactFoundation.enumsMod.SwitchSizes
...
object SwitchProps {
  ...
  implicit class SwitchPropsOps[Self <: SwitchProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActive(value: SwitchActiveProps): Self = this.set("active", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInactive(value: SwitchInactiveProps): Self = this.set("inactive", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInput(value: SwitchInputProps): Self = this.set("input", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPaddle(value: SwitchPaddleProps): Self = this.set("paddle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePaddle: Self = this.set("paddle", js.undefined)
    ...
    @scala.inline
    def setSize(value: SwitchSizes): Self = this.set("size", value.asInstanceOf[js.Any])
