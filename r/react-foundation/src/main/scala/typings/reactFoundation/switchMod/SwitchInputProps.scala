...
object SwitchInputProps {
  ...
  @scala.inline
  implicit class SwitchInputPropsOps[Self <: SwitchInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: SwitchInputTypes): Self = this.set("type", value.asInstanceOf[js.Any])
