package typings.reactFoundation.mediaObjectMod
...
trait MediaObjectProps
  ...
  var stackForSmall: js.UndefOr[Boolean] = js.native
...
object MediaObjectProps {
  ...
  @scala.inline
  def apply(): MediaObjectProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MediaObjectProps]
  }
  
  @scala.inline
  implicit class MediaObjectPropsOps[Self <: MediaObjectProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStackForSmall(value: Boolean): Self = this.set("stackForSmall", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteStackForSmall: Self = this.set("stackForSmall", js.undefined)
