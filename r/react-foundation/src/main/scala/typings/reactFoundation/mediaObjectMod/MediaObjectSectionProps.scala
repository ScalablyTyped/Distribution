...
object MediaObjectSectionProps {
  ...
  def apply(
    ...
    alignment: HorizontalAlignments = null,
    ...
    is: String = null,
    isBottom: js.UndefOr[Boolean] = js.undefined,
    ...
    isMain: js.UndefOr[Boolean] = js.undefined,
    isMiddle: js.UndefOr[Boolean] = js.undefined,
    itemID: String = null,
    ...
    if (!js.isUndefined(isBottom)) __obj.updateDynamic("isBottom")(isBottom.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isMain)) __obj.updateDynamic("isMain")(isMain.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isMiddle)) __obj.updateDynamic("isMiddle")(isMiddle.get.asInstanceOf[js.Any])
