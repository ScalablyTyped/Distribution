...
object MediaObjectSectionProps {
  ...
  @scala.inline
  implicit class MediaObjectSectionPropsOps[Self <: MediaObjectSectionProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAlignment(value: HorizontalAlignments): Self = this.set("alignment", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setIsBottom(value: Boolean): Self = this.set("isBottom", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIsBottom: Self = this.set("isBottom", js.undefined)
    @scala.inline
    def setIsMain(value: Boolean): Self = this.set("isMain", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIsMain: Self = this.set("isMain", js.undefined)
    @scala.inline
    def setIsMiddle(value: Boolean): Self = this.set("isMiddle", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIsMiddle: Self = this.set("isMiddle", js.undefined)
    @scala.inline
