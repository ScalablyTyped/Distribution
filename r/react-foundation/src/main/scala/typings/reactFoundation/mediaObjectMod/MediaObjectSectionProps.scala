...
object MediaObjectSectionProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(isBottom)) __obj.updateDynamic("isBottom")(isBottom.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isMain)) __obj.updateDynamic("isMain")(isMain.asInstanceOf[js.Any])
    if (!js.isUndefined(isMiddle)) __obj.updateDynamic("isMiddle")(isMiddle.asInstanceOf[js.Any])
