package typings.reactFoundation.paginationMod
...
object PaginationItemProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(isCurrent)) __obj.updateDynamic("isCurrent")(isCurrent.get.asInstanceOf[js.Any])
