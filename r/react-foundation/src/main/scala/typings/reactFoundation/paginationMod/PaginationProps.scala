...
trait PaginationProps
  ...
  var isCentered: js.UndefOr[Boolean] = js.native
...
object PaginationProps {
  ...
  implicit class PaginationPropsOps[Self <: PaginationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsCentered(value: Boolean): Self = this.set("isCentered", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIsCentered: Self = this.set("isCentered", js.undefined)
    @scala.inline
