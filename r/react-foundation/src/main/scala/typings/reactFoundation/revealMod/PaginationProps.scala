...
trait PaginationProps
  ...
  var isTiny: js.UndefOr[Boolean] = js.native
...
object PaginationProps {
  ...
  implicit class PaginationPropsOps[Self <: PaginationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsTiny(value: Boolean): Self = this.set("isTiny", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIsTiny: Self = this.set("isTiny", js.undefined)
