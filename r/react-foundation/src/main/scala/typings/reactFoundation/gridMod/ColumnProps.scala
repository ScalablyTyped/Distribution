...
object ColumnProps {
  ...
  def apply(
    ...
    orderOnLarge: js.UndefOr[Double] = js.undefined,
    orderOnMedium: js.UndefOr[Double] = js.undefined,
    orderOnSmall: js.UndefOr[Double] = js.undefined,
    placeholder: String = null,
    prefix: String = null,
    property: String = null,
    pullOnLarge: js.UndefOr[Double] = js.undefined,
    pullOnMedium: js.UndefOr[Double] = js.undefined,
    pullOnSmall: js.UndefOr[Double] = js.undefined,
    pushOnLarge: js.UndefOr[Double] = js.undefined,
    pushOnMedium: js.UndefOr[Double] = js.undefined,
    pushOnSmall: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(centerOnLarge)) __obj.updateDynamic("centerOnLarge")(centerOnLarge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(centerOnMedium)) __obj.updateDynamic("centerOnMedium")(centerOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(centerOnSmall)) __obj.updateDynamic("centerOnSmall")(centerOnSmall.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(expandOnLarge)) __obj.updateDynamic("expandOnLarge")(expandOnLarge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(expandOnMedium)) __obj.updateDynamic("expandOnMedium")(expandOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(expandOnSmall)) __obj.updateDynamic("expandOnSmall")(expandOnSmall.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isShrunk)) __obj.updateDynamic("isShrunk")(isShrunk.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(orderOnLarge)) __obj.updateDynamic("orderOnLarge")(orderOnLarge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(orderOnMedium)) __obj.updateDynamic("orderOnMedium")(orderOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(orderOnSmall)) __obj.updateDynamic("orderOnSmall")(orderOnSmall.get.asInstanceOf[js.Any])
    if (placeholder != null) __obj.updateDynamic("placeholder")(placeholder.asInstanceOf[js.Any])
    if (prefix != null) __obj.updateDynamic("prefix")(prefix.asInstanceOf[js.Any])
    if (property != null) __obj.updateDynamic("property")(property.asInstanceOf[js.Any])
    if (!js.isUndefined(pullOnLarge)) __obj.updateDynamic("pullOnLarge")(pullOnLarge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(pullOnMedium)) __obj.updateDynamic("pullOnMedium")(pullOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(pullOnSmall)) __obj.updateDynamic("pullOnSmall")(pullOnSmall.get.asInstanceOf[js.Any])
    if (!js.isUndefined(pushOnLarge)) __obj.updateDynamic("pushOnLarge")(pushOnLarge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(pushOnMedium)) __obj.updateDynamic("pushOnMedium")(pushOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(pushOnSmall)) __obj.updateDynamic("pushOnSmall")(pushOnSmall.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(uncenterOnLarge)) __obj.updateDynamic("uncenterOnLarge")(uncenterOnLarge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(uncenterOnMedium)) __obj.updateDynamic("uncenterOnMedium")(uncenterOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(uncenterOnSmall)) __obj.updateDynamic("uncenterOnSmall")(uncenterOnSmall.get.asInstanceOf[js.Any])
