...
object componentsFlexVideoMod {
  ...
  - typings.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, nonce, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait FlexVideoProps
    ...
    var isVimeo: js.UndefOr[Boolean] = js.undefined
    
    var isWidescreen: js.UndefOr[Boolean] = js.undefined
  ...
  object FlexVideoProps {
    
    inline def apply(): FlexVideoProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FlexVideoProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: FlexVideoProps] (val x: Self) extends AnyVal {
      ...
      inline def setIsVimeo(value: Boolean): Self = StObject.set(x, "isVimeo", value.asInstanceOf[js.Any])
      
      inline def setIsVimeoUndefined: Self = StObject.set(x, "isVimeo", js.undefined)
      
      inline def setIsWidescreen(value: Boolean): Self = StObject.set(x, "isWidescreen", value.asInstanceOf[js.Any])
      
      inline def setIsWidescreenUndefined: Self = StObject.set(x, "isWidescreen", js.undefined)
