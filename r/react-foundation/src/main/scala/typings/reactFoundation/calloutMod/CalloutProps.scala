package typings.reactFoundation.calloutMod
...
import typings.reactFoundation.enumsMod.CalloutColors
import typings.reactFoundation.enumsMod.CalloutSizes
...
trait CalloutProps
  ...
  var color: js.UndefOr[CalloutColors | String] = js.native
  ...
  var size: js.UndefOr[CalloutSizes] = js.native
...
object CalloutProps {
  ...
  implicit class CalloutPropsOps[Self <: CalloutProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: CalloutColors | String): Self = this.set("color", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSize(value: CalloutSizes): Self = this.set("size", value.asInstanceOf[js.Any])
    @scala.inline
