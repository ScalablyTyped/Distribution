...
trait MenuProps
  ...
  var alignment: js.UndefOr[MenuAlignments] = js.native
  ...
  var horizontalOnMedium: js.UndefOr[Boolean] = js.native
  var iconsOnTop: js.UndefOr[Boolean] = js.native
  ...
  var isSimple: js.UndefOr[Boolean] = js.native
...
object MenuProps {
  ...
  implicit class MenuPropsOps[Self <: MenuProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlignment(value: MenuAlignments): Self = this.set("alignment", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setHorizontalOnMedium(value: Boolean): Self = this.set("horizontalOnMedium", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteHorizontalOnMedium: Self = this.set("horizontalOnMedium", js.undefined)
    @scala.inline
    def setIconsOnTop(value: Boolean): Self = this.set("iconsOnTop", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIconsOnTop: Self = this.set("iconsOnTop", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def deleteIsSimple: Self = this.set("isSimple", js.undefined)
    @scala.inline
