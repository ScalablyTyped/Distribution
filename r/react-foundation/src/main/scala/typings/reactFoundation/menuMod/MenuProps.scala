...
object MenuProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(horizontalOnMedium)) __obj.updateDynamic("horizontalOnMedium")(horizontalOnMedium.get.asInstanceOf[js.Any])
    if (!js.isUndefined(iconsOnTop)) __obj.updateDynamic("iconsOnTop")(iconsOnTop.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isSimple)) __obj.updateDynamic("isSimple")(isSimple.get.asInstanceOf[js.Any])
