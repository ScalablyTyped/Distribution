...
object ResponsiveNavigationProps {
  ...
  @scala.inline
  implicit class ResponsiveNavigationPropsOps[Self <: ResponsiveNavigationProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMenuIcon(value: MenuIconProps): Self = this.set("menuIcon", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTitleBar(value: TitleBarProps): Self = this.set("titleBar", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTitleBar: Self = this.set("titleBar", js.undefined)
    @scala.inline
    def setTitleBarTitle(value: TitleBarTitleProps): Self = this.set("titleBarTitle", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTitleBarTitle: Self = this.set("titleBarTitle", js.undefined)
    @scala.inline
    def setTopBar(value: TopBarProps): Self = this.set("topBar", value.asInstanceOf[js.Any])
    @scala.inline
