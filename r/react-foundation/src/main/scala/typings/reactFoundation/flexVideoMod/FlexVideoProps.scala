...
object FlexVideoProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(isVimeo)) __obj.updateDynamic("isVimeo")(isVimeo.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isWidescreen)) __obj.updateDynamic("isWidescreen")(isWidescreen.get.asInstanceOf[js.Any])
