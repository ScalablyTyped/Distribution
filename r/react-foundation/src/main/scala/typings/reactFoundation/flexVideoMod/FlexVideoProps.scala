...
object FlexVideoProps {
  ...
  @scala.inline
  implicit class FlexVideoPropsOps[Self <: FlexVideoProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setIsVimeo(value: Boolean): Self = this.set("isVimeo", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIsVimeo: Self = this.set("isVimeo", js.undefined)
    @scala.inline
    def setIsWidescreen(value: Boolean): Self = this.set("isWidescreen", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIsWidescreen: Self = this.set("isWidescreen", js.undefined)
    @scala.inline
