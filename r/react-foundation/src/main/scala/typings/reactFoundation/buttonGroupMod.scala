...
object buttonGroupMod {
  ...
  object ButtonGroupProps {
    ...
    extension [Self <: ButtonGroupProps](x: Self) {
      ...
      inline def setColor(value: ButtonGroupColors | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      inline def setSize(value: ButtonGroupSizes): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
      ...
      inline def setStackFor(value: Breakpoints): Self = StObject.set(x, "stackFor", value.asInstanceOf[js.Any])
      
      inline def setStackForUndefined: Self = StObject.set(x, "stackFor", js.undefined)
