...
import typings.reactFoundation.enumsMod.ButtonGroupColors
import typings.reactFoundation.enumsMod.ButtonGroupSizes
...
object buttonGroupMod {
  ...
  - typings.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait ButtonGroupProps
    ...
    var color: js.UndefOr[ButtonGroupColors | String] = js.undefined
    ...
    var size: js.UndefOr[ButtonGroupSizes] = js.undefined
    
    var slot: js.UndefOr[String] = js.undefined
    
    var spellCheck: js.UndefOr[Booleanish] = js.undefined
    
    var stackFor: js.UndefOr[Breakpoints] = js.undefined
  ...
  object ButtonGroupProps {
    ...
    implicit class ButtonGroupPropsMutableBuilder[Self <: ButtonGroupProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setColor(value: ButtonGroupColors | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setIsStacked(value: Boolean): Self = StObject.set(x, "isStacked", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSize(value: ButtonGroupSizes): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStackFor(value: Breakpoints): Self = StObject.set(x, "stackFor", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setStackForUndefined: Self = StObject.set(x, "stackFor", js.undefined)
