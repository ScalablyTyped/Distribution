...
object mod extends js.Object {
  ...
  object Breakpoints extends js.Object {
    ...
    var LARGE: typings.reactFoundation.enumsMod.Breakpoints = js.native
    
    var MEDIUM: typings.reactFoundation.enumsMod.Breakpoints = js.native
    
    var SMALL: typings.reactFoundation.enumsMod.Breakpoints = js.native
    
    var XLARGE: typings.reactFoundation.enumsMod.Breakpoints = js.native
    
    var XXLARGE: typings.reactFoundation.enumsMod.Breakpoints = js.native
  }
  ...
  object ExtendedBreakpoints extends js.Object {
    ...
    var ALL: typings.reactFoundation.enumsMod.ExtendedBreakpoints = js.native
    
    var LARGE: typings.reactFoundation.enumsMod.ExtendedBreakpoints = js.native
    
    var MEDIUM: typings.reactFoundation.enumsMod.ExtendedBreakpoints = js.native
    
    var SMALL: typings.reactFoundation.enumsMod.ExtendedBreakpoints = js.native
    
    var XLARGE: typings.reactFoundation.enumsMod.ExtendedBreakpoints = js.native
    
    var XXLARGE: typings.reactFoundation.enumsMod.ExtendedBreakpoints = js.native
  }
  
  @js.native
  object FloatTypes extends js.Object {
    
    var CENTER: typings.reactFoundation.enumsMod.FloatTypes = js.native
    
    var LEFT: typings.reactFoundation.enumsMod.FloatTypes = js.native
    
    var RIGHT: typings.reactFoundation.enumsMod.FloatTypes = js.native
  }
  
  @js.native
  object GutterTypes extends js.Object {
    
    var MARGIN: typings.reactFoundation.enumsMod.GutterTypes = js.native
    
    var PADDING: typings.reactFoundation.enumsMod.GutterTypes = js.native
  }
  ...
  object SpaceControls extends js.Object {
    ...
    var AUTO: typings.reactFoundation.enumsMod.SpaceControls = js.native
    
    var GROW: typings.reactFoundation.enumsMod.SpaceControls = js.native
    
    var SHRINK: typings.reactFoundation.enumsMod.SpaceControls = js.native
  }
