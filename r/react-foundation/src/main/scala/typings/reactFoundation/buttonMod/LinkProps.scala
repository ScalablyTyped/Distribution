...
- typings.react.mod.AnchorHTMLAttributes because var conflicts: className. Inlined download, href, hrefLang, media, ping, referrerPolicy, rel, target, `type` */ trait LinkProps
...
object LinkProps {
  ...
  def apply(
    ...
    color: ButtonColors | String = null,
