...
- typings.react.mod.AnchorHTMLAttributes because var conflicts: className. Inlined download, href, hrefLang, media, ping, referrerPolicy, rel, target, `type` */ @js.native
trait LinkProps
  ...
  var color: js.UndefOr[ButtonColors | String] = js.native
...
object LinkProps {
  ...
  implicit class LinkPropsOps[Self <: LinkProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColor(value: ButtonColors | String): Self = this.set("color", value.asInstanceOf[js.Any])
    @scala.inline
