...
object componentsResponsiveMod {
  ...
  - typings.react.mod.ButtonHTMLAttributes because var conflicts: className. Inlined formAction, formEncType, form, value, name, disabled, formMethod, formTarget, `type`, formNoValidate */ trait MenuIconProps
    extends StObject
