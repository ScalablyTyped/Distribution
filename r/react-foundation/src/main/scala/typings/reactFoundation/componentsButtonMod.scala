...
object componentsButtonMod {
  ...
  object ButtonProps {
    ...
    extension [Self <: ButtonProps](x: Self) {
      ...
      inline def setColor(value: ButtonColors | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
  ...
  object ButtonPropsCommon {
    ...
    inline def apply(): ButtonPropsCommon = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: ButtonPropsCommon](x: Self) {
      ...
      inline def setIsArrowOnlyUndefined: Self = StObject.set(x, "isArrowOnly", js.undefined)
      ...
      inline def setIsHollow(value: Boolean): Self = StObject.set(x, "isHollow", value.asInstanceOf[js.Any])
      
      inline def setIsHollowUndefined: Self = StObject.set(x, "isHollow", js.undefined)
      
      inline def setSize(value: ButtonSizes): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
  ...
  - typings.react.mod.AnchorHTMLAttributes because var conflicts: className. Inlined target, media, rel, ping, referrerPolicy, href, download, `type`, hrefLang */ trait LinkProps
    extends StObject
       with ButtonPropsCommon
       with AriaAttributes
