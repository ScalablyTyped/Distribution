...
object componentsButtonMod {
  ...
  - typings.react.mod.AnchorHTMLAttributes because var conflicts: className. Inlined target, media, ping, referrerPolicy, href, download, `type`, hrefLang */ trait LinkProps
    extends StObject
       with ButtonPropsCommon
       with AriaAttributes
