...
object componentsRevealMod {
  
  @JSImport("react-foundation/components/reveal", "Reveal")
  @js.native
  val Reveal: FunctionComponent[PaginationProps] = js.native
  ...
  object PaginationProps {
    ...
    implicit open class MutableBuilder[Self <: PaginationProps] (val x: Self) extends AnyVal {
      ...
      inline def setIsTiny(value: Boolean): Self = StObject.set(x, "isTiny", value.asInstanceOf[js.Any])
      
      inline def setIsTinyUndefined: Self = StObject.set(x, "isTiny", js.undefined)
