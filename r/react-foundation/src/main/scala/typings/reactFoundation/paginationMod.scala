...
object paginationMod {
  ...
  object PaginationItemProps {
    ...
    implicit class PaginationItemPropsMutableBuilder[Self <: PaginationItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIsCurrentUndefined: Self = StObject.set(x, "isCurrent", js.undefined)
  ...
  object PaginationProps {
    ...
    implicit class PaginationPropsMutableBuilder[Self <: PaginationProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIsCentered(value: Boolean): Self = StObject.set(x, "isCentered", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setIsCenteredUndefined: Self = StObject.set(x, "isCentered", js.undefined)
