...
object paginationMod {
  ...
  object PaginationItemProps {
    ...
    extension [Self <: PaginationItemProps](x: Self) {
      ...
      inline def setIsCurrentUndefined: Self = StObject.set(x, "isCurrent", js.undefined)
  ...
  object PaginationProps {
    ...
    extension [Self <: PaginationProps](x: Self) {
      ...
      inline def setIsCentered(value: Boolean): Self = StObject.set(x, "isCentered", value.asInstanceOf[js.Any])
      
      inline def setIsCenteredUndefined: Self = StObject.set(x, "isCentered", js.undefined)
