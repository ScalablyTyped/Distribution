...
object Clearfix {
  ...
  def apply(
    ...
    if (!js.isUndefined(`show-for-landscape`)) __obj.updateDynamic("show-for-landscape")(`show-for-landscape`.get.asInstanceOf[js.Any])
    if (!js.isUndefined(`show-for-portrait`)) __obj.updateDynamic("show-for-portrait")(`show-for-portrait`.get.asInstanceOf[js.Any])
    if (!js.isUndefined(`show-for-sr`)) __obj.updateDynamic("show-for-sr")(`show-for-sr`.get.asInstanceOf[js.Any])
    if (!js.isUndefined(`show-on-focus`)) __obj.updateDynamic("show-on-focus")(`show-on-focus`.get.asInstanceOf[js.Any])
