...
object Config {
  ...
  def apply(
    ...
    oAuthCallback: js.Function1[/* hash */ java.lang.String, scala.Unit] = null,
    oAuthCallbackName: java.lang.String = null,
    redirectUrl: java.lang.String = null,
    scope: java.lang.String = null,
    token: java.lang.String = null,
    windowStrategy: js.Function1[/* url */ java.lang.String, DismissWindow] = null
  ): Config = {
    val __obj = js.Dynamic.literal()
    if (authorizationUrl != null) __obj.updateDynamic("authorizationUrl")(authorizationUrl)
    if (clientId != null) __obj.updateDynamic("clientId")(clientId)
    if (oAuthCallback != null) __obj.updateDynamic("oAuthCallback")(oAuthCallback)
    ...
    if (windowStrategy != null) __obj.updateDynamic("windowStrategy")(windowStrategy)
