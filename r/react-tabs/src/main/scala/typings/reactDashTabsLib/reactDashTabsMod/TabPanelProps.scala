...
- Dropped {[ P in std.Exclude<keyof react.react.HTMLProps<react.HTMLDivElement>, 'className'> ]: react.react.HTMLProps<react.HTMLDivElement>[P]} */ trait TabPanelProps extends js.Object {
