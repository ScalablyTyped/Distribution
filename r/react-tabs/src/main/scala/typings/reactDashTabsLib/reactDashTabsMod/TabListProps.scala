...
- Dropped {[ P in std.Exclude<keyof react.react.React.HTMLProps<std.HTMLUListElement>, 'className'> ]: react.react.React.HTMLProps<std.HTMLUListElement>[P]} */ trait TabListProps extends js.Object {
