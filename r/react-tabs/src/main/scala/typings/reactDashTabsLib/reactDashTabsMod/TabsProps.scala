...
- Dropped {[ P in std.Exclude<keyof react.react.React.HTMLProps<std.HTMLDivElement>, 'className' | 'onSelect'> ]: react.react.React.HTMLProps<std.HTMLDivElement>[P]} */ trait TabsProps extends js.Object {
  ...
  var domRef: js.UndefOr[js.Function1[/* node */ js.UndefOr[stdLib.HTMLElement], scala.Unit]] = js.undefined
...
object TabsProps {
  ...
  def apply(
    ...
    domRef: /* node */ js.UndefOr[stdLib.HTMLElement] => scala.Unit = null,
    forceRenderTabPanel: js.UndefOr[scala.Boolean] = js.undefined,
    onSelect: (/* index */ scala.Double, /* last */ scala.Double, /* event */ stdLib.Event) => scala.Boolean | scala.Unit = null,
