...
- Dropped {[ P in std.Exclude<keyof react.react.React.HTMLProps<std.HTMLLIElement>, 'className' | 'tabIndex'> ]: react.react.React.HTMLProps<std.HTMLLIElement>[P]} */ trait TabProps extends js.Object {
