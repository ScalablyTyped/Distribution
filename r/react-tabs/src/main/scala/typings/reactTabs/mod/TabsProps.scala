...
object TabsProps {
  ...
  implicit class TabsPropsOps[Self <: TabsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultFocus(value: Boolean): Self = this.set("defaultFocus", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDisabledTabClassName(value: String): Self = this.set("disabledTabClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDisabledTabClassName: Self = this.set("disabledTabClassName", js.undefined)
    @scala.inline
    def setDomRef(value: /* node */ js.UndefOr[HTMLElement] => Unit): Self = this.set("domRef", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setForceRenderTabPanel(value: Boolean): Self = this.set("forceRenderTabPanel", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteForceRenderTabPanel: Self = this.set("forceRenderTabPanel", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setOnSelect(value: (/* index */ Double, /* last */ Double, /* event */ Event) => Boolean | Unit): Self = this.set("onSelect", js.Any.fromFunction3(value))
    @scala.inline
    ...
    @scala.inline
    def setSelectedTabClassName(value: String): Self = this.set("selectedTabClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSelectedTabClassName: Self = this.set("selectedTabClassName", js.undefined)
    @scala.inline
    def setSelectedTabPanelClassName(value: String): Self = this.set("selectedTabPanelClassName", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSelectedTabPanelClassName: Self = this.set("selectedTabPanelClassName", js.undefined)
    @scala.inline
