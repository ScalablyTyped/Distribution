...
/* Inlined parent react-tabs.react-tabs.Omit<react.react.HTMLProps<std.HTMLDivElement>, 'className' | 'onSelect'> */
...
object TabsProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(defaultFocus)) __obj.updateDynamic("defaultFocus")(defaultFocus.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(forceRenderTabPanel)) __obj.updateDynamic("forceRenderTabPanel")(forceRenderTabPanel.get.asInstanceOf[js.Any])
