...
import typings.reactTabs.reactTabsStrings._empty
...
import typings.reactTabs.reactTabsStrings.`use-credentials`
import typings.reactTabs.reactTabsStrings.additions
import typings.reactTabs.reactTabsStrings.all
import typings.reactTabs.reactTabsStrings.anonymous
...
import typings.reactTabs.reactTabsStrings.environment
...
import typings.reactTabs.reactTabsStrings.ltr
...
import typings.reactTabs.reactTabsStrings.rtl
...
import typings.reactTabs.reactTabsStrings.user
...
object mod {
  ...
  trait ReactTabsFunctionComponent[P]
    ...
    var tabsRole: typings.reactTabs.reactTabsStrings.Tabs | typings.reactTabs.reactTabsStrings.TabList | typings.reactTabs.reactTabsStrings.Tab | typings.reactTabs.reactTabsStrings.TabPanel = js.native
  }
  ...
  trait TabsProps extends StObject {
    ...
    var disableLeftRightKeys: js.UndefOr[Boolean] = js.undefined
  ...
  object TabsProps {
    ...
    implicit open class MutableBuilder[Self <: TabsProps] (val x: Self) extends AnyVal {
      ...
      inline def setDisableLeftRightKeys(value: Boolean): Self = StObject.set(x, "disableLeftRightKeys", value.asInstanceOf[js.Any])
      
      inline def setDisableLeftRightKeysUndefined: Self = StObject.set(x, "disableLeftRightKeys", js.undefined)
      ...
      inline def setDomRef(value: /* node */ js.UndefOr[HTMLElement] => Unit): Self = StObject.set(x, "domRef", js.Any.fromFunction1(value))
