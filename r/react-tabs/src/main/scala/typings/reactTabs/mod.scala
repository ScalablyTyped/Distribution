...
object mod {
  ...
  @js.native
  class TabList protected ()
    extends Component[TabListProps, js.Object, js.Any] {
    def this(props: TabListProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: TabListProps, context: js.Any) = this()
  }
  
  @JSImport("react-tabs", "TabPanel")
  @js.native
  class TabPanel protected ()
    extends Component[TabPanelProps, js.Object, js.Any] {
  ...
  object TabListProps {
    ...
    @scala.inline
    implicit class TabListPropsMutableBuilder[Self <: TabListProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setClassName(value: String | js.Array[String] | StringDictionary[Boolean]): Self = StObject.set(x, "className", value.asInstanceOf[js.Any])
  ...
  object TabPanelProps {
    ...
    implicit class TabPanelPropsMutableBuilder[Self <: TabPanelProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSelectedClassNameUndefined: Self = StObject.set(x, "selectedClassName", js.undefined)
  ...
  /* Inlined parent react-tabs.react-tabs.Omit<react.react.HTMLProps<std.HTMLDivElement>, 'className' | 'onSelect' | 'ref'> */
  @js.native
  trait TabsProps extends StObject {
    ...
    var defaultFocus: js.UndefOr[Boolean] = js.native
    ...
    var disabledTabClassName: js.UndefOr[String] = js.native
    
    var domRef: js.UndefOr[js.Function1[/* node */ js.UndefOr[HTMLElement], Unit]] = js.native
    ...
    var forceRenderTabPanel: js.UndefOr[Boolean] = js.native
    ...
    var selectedTabClassName: js.UndefOr[String] = js.native
    
    var selectedTabPanelClassName: js.UndefOr[String] = js.native
  ...
  object TabsProps {
    ...
    implicit class TabsPropsMutableBuilder[Self <: TabsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultFocus(value: Boolean): Self = StObject.set(x, "defaultFocus", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDisabledTabClassName(value: String): Self = StObject.set(x, "disabledTabClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisabledTabClassNameUndefined: Self = StObject.set(x, "disabledTabClassName", js.undefined)
      
      @scala.inline
      def setDisabledUndefined: Self = StObject.set(x, "disabled", js.undefined)
      
      @scala.inline
      def setDomRef(value: /* node */ js.UndefOr[HTMLElement] => Unit): Self = StObject.set(x, "domRef", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setForceRenderTabPanel(value: Boolean): Self = StObject.set(x, "forceRenderTabPanel", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setForceRenderTabPanelUndefined: Self = StObject.set(x, "forceRenderTabPanel", js.undefined)
      ...
      @scala.inline
      def setOnSelect(value: (/* index */ Double, /* last */ Double, /* event */ Event) => Boolean | Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction3(value))
      ...
      @scala.inline
      def setSelectedTabClassName(value: String): Self = StObject.set(x, "selectedTabClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSelectedTabClassNameUndefined: Self = StObject.set(x, "selectedTabClassName", js.undefined)
      
      @scala.inline
      def setSelectedTabPanelClassName(value: String): Self = StObject.set(x, "selectedTabPanelClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSelectedTabPanelClassNameUndefined: Self = StObject.set(x, "selectedTabPanelClassName", js.undefined)
