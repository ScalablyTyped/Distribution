...
object ecmaVersionsMod {
  ...
  */
  ...
  object EcmaVersion {
    ...
    inline def `2015`: typings.regexpp.regexppNumbers.`2015` = 2015.asInstanceOf[typings.regexpp.regexppNumbers.`2015`]
    
    inline def `2016`: typings.regexpp.regexppNumbers.`2016` = 2016.asInstanceOf[typings.regexpp.regexppNumbers.`2016`]
    
    inline def `2017`: typings.regexpp.regexppNumbers.`2017` = 2017.asInstanceOf[typings.regexpp.regexppNumbers.`2017`]
    
    inline def `2018`: typings.regexpp.regexppNumbers.`2018` = 2018.asInstanceOf[typings.regexpp.regexppNumbers.`2018`]
