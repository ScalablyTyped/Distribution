...
object reactErrorBoundaryUmdMod {
  
  @JSImport("react-error-boundary/dist/react-error-boundary.umd", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-error-boundary/dist/react-error-boundary.umd", "ErrorBoundary")
  @js.native
