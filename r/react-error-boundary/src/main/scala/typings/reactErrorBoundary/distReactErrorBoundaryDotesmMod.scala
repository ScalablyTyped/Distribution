...
object distReactErrorBoundaryDotesmMod {
  
  @JSImport("react-error-boundary/dist/react-error-boundary.esm", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("react-error-boundary/dist/react-error-boundary.esm", "ErrorBoundary")
  @js.native
