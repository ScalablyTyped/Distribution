...
trait NavigationBarProps extends js.Object {
  var leftButton: js.UndefOr[NavigationBarButton | reactLib.reactMod.ReactElement | scala.Null] = js.undefined
  var rightButton: js.UndefOr[NavigationBarButton | reactLib.reactMod.ReactElement | scala.Null] = js.undefined
  ...
  var title: js.UndefOr[NavigationBarTitle | reactLib.reactMod.ReactElement | scala.Null] = js.undefined
}

object NavigationBarProps {
  @scala.inline
  def apply(
    leftButton: NavigationBarButton | reactLib.reactMod.ReactElement = null,
    rightButton: NavigationBarButton | reactLib.reactMod.ReactElement = null,
    statusBar: StatusBar = null,
    style: reactDashNativeLib.reactDashNativeMod.ViewStyle = null,
    tintColor: java.lang.String = null,
    title: NavigationBarTitle | reactLib.reactMod.ReactElement = null
  ): NavigationBarProps = {
