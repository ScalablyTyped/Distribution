...
import typings.reactThreeFiber.anon.FnCall
import typings.reactThreeFiber.anon.FnCallXY
import typings.reactThreeFiber.anon.FnCallXYZ
import typings.reactThreeFiber.anon.TypeofBufferGeometry
...
import typings.reactThreeFiber.anon.Vertices
...
import typings.three.mod.BoxBufferGeometry
...
import typings.three.mod.DodecahedronBufferGeometry
...
import typings.three.mod.IcosahedronBufferGeometry
import typings.three.mod.IcosahedronGeometry
import typings.three.mod.ImmediateRenderObject
...
import typings.three.mod.LatheBufferGeometry
...
import typings.three.mod.OctahedronBufferGeometry
import typings.three.mod.OctahedronGeometry
import typings.three.mod.OrthographicCamera
import typings.three.mod.ParametricBufferGeometry
import typings.three.mod.ParametricGeometry
import typings.three.mod.PerspectiveCamera
import typings.three.mod.PlaneBufferGeometry
...
import typings.three.mod.PolyhedronBufferGeometry
...
import typings.three.mod.RingBufferGeometry
...
import typings.three.mod.ShapeBufferGeometry
...
import typings.three.mod.SphereBufferGeometry
...
import typings.three.mod.TetrahedronBufferGeometry
import typings.three.mod.TetrahedronGeometry
import typings.three.mod.TextBufferGeometry
import typings.three.mod.TextGeometry
import typings.three.mod.Texture
import typings.three.mod.TorusBufferGeometry
import typings.three.mod.TorusGeometry
import typings.three.mod.TorusKnotBufferGeometry
import typings.three.mod.TorusKnotGeometry
import typings.three.mod.TubeBufferGeometry
...
object threeTypesMod {
  ...
  type Color = typings.three.mod.Color | Double | String
  
  type ColorProps = Node[typings.three.mod.Color, TypeofColor]
  ...
  type EdgesGeometryProps = BufferGeometryNode[
    EdgesGeometry, 
    Instantiable1[/* geometry */ typings.three.bufferGeometryMod.BufferGeometry, EdgesGeometry]
  ]
  
  type Euler = typings.three.mod.Euler | Parameters[FnCall]
  ...
  type FogProps = Node[Fog, Instantiable1[/* color */ typings.three.colorMod.Color, Fog]]
  ...
  type LatheBufferGeometryProps = BufferGeometryNode[
    LatheBufferGeometry, 
    Instantiable1[/* points */ js.Array[typings.three.vector2Mod.Vector2], LatheBufferGeometry]
  ]
  
  type LatheGeometryProps = GeometryNode[
    LatheGeometry, 
    Instantiable1[/* points */ js.Array[typings.three.vector2Mod.Vector2], LatheGeometry]
  ]
  
  type Layers = typings.three.mod.Layers | (Parameters[js.Function1[/* channel */ Double, Unit]])
  
  type LightNode[T /* <: Light */, P] = Overwrite[Object3DNode[T, P], typings.reactThreeFiber.anon.Color]
  ...
  type MaterialNode[T /* <: typings.three.mod.Material */, P] = Overwrite[Node[T, P], typings.reactThreeFiber.anon.Color]
  ...
  type SkeletonProps = Object3DNode[
    Skeleton, 
    Instantiable1[/* bones */ js.Array[typings.three.boneMod.Bone], Skeleton]
  ]
  ...
  type SpotLightHelperProps = Object3DNode[
    SpotLightHelper, 
    Instantiable1[/* light */ typings.three.lightMod.Light, SpotLightHelper]
  ]
  ...
  type TubeBufferGeometryProps = BufferGeometryNode[
    TubeBufferGeometry, 
    Instantiable1[/* path */ Curve[typings.three.vector3Mod.Vector3], TubeBufferGeometry]
  ]
  
  type TubeGeometryProps = GeometryNode[
    TubeGeometry, 
    Instantiable1[/* path */ Curve[typings.three.vector3Mod.Vector3], TubeGeometry]
  ]
  
  type Vector2 = typings.three.mod.Vector2 | Parameters[FnCallXY]
  
  type Vector2Props = Node[typings.three.mod.Vector2, Instantiable0[typings.three.mod.Vector2]]
  
  type Vector3 = typings.three.mod.Vector3 | Parameters[FnCallXYZ]
  ...
  type WireframeGeometryProps = BufferGeometryNode[
    WireframeGeometry, 
    Instantiable1[/* geometry */ typings.three.geometryMod.Geometry, WireframeGeometry]
  ]
