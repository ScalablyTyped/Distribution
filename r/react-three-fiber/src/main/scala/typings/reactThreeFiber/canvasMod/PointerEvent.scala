...
object PointerEvent {
  ...
  implicit class PointerEventOps[Self <: PointerEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNativeEvent(value: NativePointerEvent): Self = this.set("nativeEvent", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSourceEvent(value: typings.react.mod.PointerEvent[Element]): Self = this.set("sourceEvent", value.asInstanceOf[js.Any])
