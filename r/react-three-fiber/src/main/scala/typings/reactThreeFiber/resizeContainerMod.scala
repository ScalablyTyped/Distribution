...
object resizeContainerMod {
  ...
  trait Renderer extends StObject {
    ...
    var render: js.Function2[/* scene */ Object3D, /* camera */ Camera, Unit]
    
    var setSize: js.Function2[/* width */ Double, /* height */ Double, Unit]
  }
  object Renderer {
    ...
    extension [Self <: Renderer](x: Self) {
      ...
      inline def setRender(value: (/* scene */ Object3D, /* camera */ Camera) => Unit): Self = StObject.set(x, "render", js.Any.fromFunction2(value))
      
      inline def setSetSize(value: (/* width */ Double, /* height */ Double) => Unit): Self = StObject.set(x, "setSize", js.Any.fromFunction2(value))
    }
  }
  
  trait ResizeContainerProps
    extends StObject
       with ContainerProps {
    
    var effects: js.UndefOr[
        js.Function2[/* renderer */ js.Any, /* parent */ HTMLDivElement, js.Function0[js.Any]]
      ] = js.undefined
    
    var preRender: js.UndefOr[ReactNode] = js.undefined
    
    def renderer(): js.UndefOr[Renderer | Null]
  }
  object ResizeContainerProps {
    
    inline def apply(renderer: () => js.UndefOr[Renderer | Null]): ResizeContainerProps = {
      val __obj = js.Dynamic.literal(renderer = js.Any.fromFunction0(renderer))
      __obj.asInstanceOf[ResizeContainerProps]
    }
    
    extension [Self <: ResizeContainerProps](x: Self) {
      
      inline def setEffects(value: (/* renderer */ js.Any, /* parent */ HTMLDivElement) => js.Function0[js.Any]): Self = StObject.set(x, "effects", js.Any.fromFunction2(value))
      
      inline def setEffectsUndefined: Self = StObject.set(x, "effects", js.undefined)
      
      inline def setPreRender(value: ReactNode): Self = StObject.set(x, "preRender", value.asInstanceOf[js.Any])
      
      inline def setPreRenderUndefined: Self = StObject.set(x, "preRender", js.undefined)
      
      inline def setRenderer(value: () => js.UndefOr[Renderer | Null]): Self = StObject.set(x, "renderer", js.Any.fromFunction0(value))
    }
  }
}
