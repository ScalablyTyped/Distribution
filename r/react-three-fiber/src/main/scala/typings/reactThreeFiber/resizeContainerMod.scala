...
object resizeContainerMod {
  ...
  object Renderer {
    ...
    implicit class RendererMutableBuilder[Self <: Renderer] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRender(value: (/* scene */ Object3D, /* camera */ Camera) => Unit): Self = StObject.set(x, "render", js.Any.fromFunction2(value))
  ...
  object ResizeContainerProps {
    ...
    implicit class ResizeContainerPropsMutableBuilder[Self <: ResizeContainerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEffects(value: (/* renderer */ js.Any, /* parent */ HTMLDivElement) => js.Function0[js.Any]): Self = StObject.set(x, "effects", js.Any.fromFunction2(value))
