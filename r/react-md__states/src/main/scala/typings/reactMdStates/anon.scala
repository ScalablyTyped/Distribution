...
object anon {
  ...
  object CSSPropertiesleftnumberto {
    ...
    implicit class CSSPropertiesleftnumbertoMutableBuilder[Self <: CSSPropertiesleftnumberto] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHeight(value: (js.UndefOr[HeightProperty[String | Double]]) & Double): Self = StObject.set(x, "height", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLeft(value: (js.UndefOr[LeftProperty[String | Double]]) & Double): Self = StObject.set(x, "left", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTop(value: (js.UndefOr[TopProperty[String | Double]]) & Double): Self = StObject.set(x, "top", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setWidth(value: (js.UndefOr[WidthProperty[String | Double]]) & Double): Self = StObject.set(x, "width", value.asInstanceOf[js.Any])
