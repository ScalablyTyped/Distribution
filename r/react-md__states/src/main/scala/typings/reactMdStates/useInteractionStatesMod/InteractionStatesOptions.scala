...
object InteractionStatesOptions {
  @scala.inline
  def apply[/* <: typings.std.HTMLElement */ E](): InteractionStatesOptions[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InteractionStatesOptions[E]]
  }
  @scala.inline
  implicit class InteractionStatesOptionsOps[Self <: InteractionStatesOptions[_], /* <: typings.std.HTMLElement */ E] (val x: Self with InteractionStatesOptions[E]) extends AnyVal {
    @scala.inline
