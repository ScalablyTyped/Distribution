...
object typesRipplesReducerMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.reactMdStates.typesRipplesReducerMod.CreateAction[E]
    - typings.reactMdStates.typesRipplesReducerMod.ReleaseAction[E]
    - typings.reactMdStates.typesRipplesReducerMod.CancelAction
    - typings.reactMdStates.typesRipplesReducerMod.EnteredAction
    - typings.reactMdStates.typesRipplesReducerMod.RemoveAction
  */
  trait RippleStateAction[E /* <: HTMLElement */] extends StObject
  object RippleStateAction {
    
    inline def CancelAction(ease: Boolean, `type`: /* "CANCEL" */ String): typings.reactMdStates.typesRipplesReducerMod.CancelAction = {
      val __obj = js.Dynamic.literal(ease = ease.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.reactMdStates.typesRipplesReducerMod.CancelAction]
    }
    
    inline def CreateAction[E /* <: HTMLElement */](disableSpacebarClick: Boolean, event: RippleEvent[E], `type`: /* "CREATE" */ String): typings.reactMdStates.typesRipplesReducerMod.CreateAction[E] = {
      val __obj = js.Dynamic.literal(disableSpacebarClick = disableSpacebarClick.asInstanceOf[js.Any], event = event.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.reactMdStates.typesRipplesReducerMod.CreateAction[E]]
    }
    
    inline def EnteredAction(ripple: RippleState, `type`: /* "ENTERED" */ String): typings.reactMdStates.typesRipplesReducerMod.EnteredAction = {
      val __obj = js.Dynamic.literal(ripple = ripple.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.reactMdStates.typesRipplesReducerMod.EnteredAction]
    }
    
    inline def ReleaseAction[E /* <: HTMLElement */](event: RippleEvent[E], `type`: /* "RELEASE" */ String): typings.reactMdStates.typesRipplesReducerMod.ReleaseAction[E] = {
      val __obj = js.Dynamic.literal(event = event.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.reactMdStates.typesRipplesReducerMod.ReleaseAction[E]]
    }
    
    inline def RemoveAction(ripple: RippleState, `type`: /* "REMOVE" */ String): typings.reactMdStates.typesRipplesReducerMod.RemoveAction = {
      val __obj = js.Dynamic.literal(ripple = ripple.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.reactMdStates.typesRipplesReducerMod.RemoveAction]
    }
  }
}
