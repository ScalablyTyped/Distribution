...
object anon {
  ...
  object Comparator {
    ...
    inline def apply(comparator: typings.reactBootstrapTable2Filter.mod.Comparator, date: js.Date): Comparator = {
  ...
  object ComparatorNumber {
    ...
    inline def apply(comparator: typings.reactBootstrapTable2Filter.mod.Comparator, number: Double): ComparatorNumber = {
  ...
  object Number {
    ...
    inline def apply(comparator: typings.reactBootstrapTable2Filter.mod.Comparator, number: Double | _empty): Number = {
      val __obj = js.Dynamic.literal(comparator = comparator.asInstanceOf[js.Any], number = number.asInstanceOf[js.Any])
  ...
  object PartialNumberFilterPropsa {
    ...
    extension [Self <: PartialNumberFilterPropsa](x: Self) {
      ...
      inline def setGetFilter(value: /* filter */ js.Function1[/* value */ Number, Unit | js.Array[Any]] => Unit): Self = StObject.set(x, "getFilter", js.Any.fromFunction1(value))
