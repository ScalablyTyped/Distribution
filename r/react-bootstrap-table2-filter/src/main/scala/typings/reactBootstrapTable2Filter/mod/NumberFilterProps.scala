...
object NumberFilterProps {
  ...
  @scala.inline
  implicit class NumberFilterPropsOps[Self <: NumberFilterProps[_], T /* <: js.Object */] (val x: Self with NumberFilterProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setDefaultValue(value: js.UndefOr[js.Any] with js.UndefOr[typings.reactBootstrapTable2Filter.anon.Comparator]): Self = this.set("defaultValue", value.asInstanceOf[js.Any])
