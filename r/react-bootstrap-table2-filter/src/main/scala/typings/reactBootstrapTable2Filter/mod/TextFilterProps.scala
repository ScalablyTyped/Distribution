...
object TextFilterProps {
  @scala.inline
  def apply[/* <: js.Object */ T](): TextFilterProps[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TextFilterProps[T]]
  }
  @scala.inline
  implicit class TextFilterPropsOps[Self <: TextFilterProps[_], /* <: js.Object */ T] (val x: Self with TextFilterProps[T]) extends AnyVal {
    @scala.inline
