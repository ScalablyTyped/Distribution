...
object mod {
  ...
  object Comparator extends StObject {
    ...
    /* "=" */ val EQ: typings.reactBootstrapTable2Filter.mod.Comparator.EQ with String = js.native
    
    @js.native
    sealed trait GE extends Comparator
    /* ">=" */ val GE: typings.reactBootstrapTable2Filter.mod.Comparator.GE with String = js.native
    
    @js.native
    sealed trait GT extends Comparator
    /* ">" */ val GT: typings.reactBootstrapTable2Filter.mod.Comparator.GT with String = js.native
    
    @js.native
    sealed trait LE extends Comparator
    /* "<=" */ val LE: typings.reactBootstrapTable2Filter.mod.Comparator.LE with String = js.native
    
    @js.native
    sealed trait LIKE extends Comparator
    /* "LIKE" */ val LIKE: typings.reactBootstrapTable2Filter.mod.Comparator.LIKE with String = js.native
    
    @js.native
    sealed trait LT extends Comparator
    /* "<" */ val LT: typings.reactBootstrapTable2Filter.mod.Comparator.LT with String = js.native
    
    @js.native
    sealed trait NE extends Comparator
    /* "!=" */ val NE: typings.reactBootstrapTable2Filter.mod.Comparator.NE with String = js.native
  }
  ...
  object FILTER_TYPES extends StObject {
    ...
    /* "DATE" */ val DATE: typings.reactBootstrapTable2Filter.mod.FILTER_TYPES.DATE with String = js.native
    
    @js.native
    sealed trait MULTISELECT extends FILTER_TYPES
    /* "MULTISELECT" */ val MULTISELECT: typings.reactBootstrapTable2Filter.mod.FILTER_TYPES.MULTISELECT with String = js.native
    
    @js.native
    sealed trait NUMBER extends FILTER_TYPES
    /* "NUMBER" */ val NUMBER: typings.reactBootstrapTable2Filter.mod.FILTER_TYPES.NUMBER with String = js.native
    
    @js.native
    sealed trait SELECT extends FILTER_TYPES
    /* "SELECT" */ val SELECT: typings.reactBootstrapTable2Filter.mod.FILTER_TYPES.SELECT with String = js.native
    
    @js.native
    sealed trait TEXT extends FILTER_TYPES
    /* "TEXT" */ val TEXT: typings.reactBootstrapTable2Filter.mod.FILTER_TYPES.TEXT with String = js.native
  }
  ...
  trait NumberFilterProps[T /* <: js.Object */] extends StObject {
    ...
    var defaultValue: js.UndefOr[js.Any] with js.UndefOr[typings.reactBootstrapTable2Filter.anon.Comparator] = js.native
  ...
  object NumberFilterProps {
    ...
    def apply[T /* <: js.Object */](
      defaultValue: js.UndefOr[js.Any] with js.UndefOr[typings.reactBootstrapTable2Filter.anon.Comparator]
    ): NumberFilterProps[T] = {
    ...
    implicit class NumberFilterPropsMutableBuilder[Self <: NumberFilterProps[_], T /* <: js.Object */] (val x: Self with NumberFilterProps[T]) extends AnyVal {
      ...
      @scala.inline
      def setDefaultValue(value: js.UndefOr[js.Any] with js.UndefOr[typings.reactBootstrapTable2Filter.anon.Comparator]): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
