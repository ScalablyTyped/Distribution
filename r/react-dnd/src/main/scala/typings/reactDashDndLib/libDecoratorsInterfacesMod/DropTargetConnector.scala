...
trait DropTargetConnector extends js.Object {
  /**
    ...
    */
  def dropTarget(): reactDashDndLib.libInterfacesConnectorsMod.ConnectDropTarget
}

object DropTargetConnector {
  @scala.inline
  def apply(dropTarget: () => reactDashDndLib.libInterfacesConnectorsMod.ConnectDropTarget): DropTargetConnector = {
