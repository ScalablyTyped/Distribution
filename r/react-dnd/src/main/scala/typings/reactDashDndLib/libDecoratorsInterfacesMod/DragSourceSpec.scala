...
object DragSourceSpec {
  ...
  def apply[Props, DragObject](
    beginDrag: (Props, reactDashDndLib.libInterfacesMonitorsMod.DragSourceMonitor, js.Any) => DragObject,
    canDrag: (/* props */ Props, /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DragSourceMonitor) => scala.Boolean = null,
    endDrag: (/* props */ Props, /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DragSourceMonitor, /* component */ js.Any) => scala.Unit = null,
    isDragging: (/* props */ Props, /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DragSourceMonitor) => scala.Boolean = null
