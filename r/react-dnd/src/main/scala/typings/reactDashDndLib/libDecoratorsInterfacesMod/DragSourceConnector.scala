...
trait DragSourceConnector extends js.Object {
  /**
    ...
    */
  def dragPreview(): reactDashDndLib.libInterfacesConnectorsMod.ConnectDragPreview
  /**
    ...
    * the render function.
    */
  def dragSource(): reactDashDndLib.libInterfacesConnectorsMod.ConnectDragSource
}

object DragSourceConnector {
  @scala.inline
  def apply(
    dragPreview: () => reactDashDndLib.libInterfacesConnectorsMod.ConnectDragPreview,
    dragSource: () => reactDashDndLib.libInterfacesConnectorsMod.ConnectDragSource
  ): DragSourceConnector = {
