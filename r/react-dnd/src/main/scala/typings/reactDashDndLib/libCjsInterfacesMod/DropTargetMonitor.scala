...
@js.native
trait DropTargetMonitor extends js.Object {
  /**
  ...
  /**
    ...
    */
  def getClientOffset(): dndDashCoreLib.libCjsInterfacesMod.XYCoord | scala.Null = js.native
  /**
    ...
    */
  def getDifferenceFromInitialOffset(): dndDashCoreLib.libCjsInterfacesMod.XYCoord | scala.Null = js.native
  /**
  ...
  /**
    ...
    * is being dragged.
    */
  def getInitialClientOffset(): dndDashCoreLib.libCjsInterfacesMod.XYCoord | scala.Null = js.native
  /**
    ...
    */
  def getInitialSourceClientOffset(): dndDashCoreLib.libCjsInterfacesMod.XYCoord | scala.Null = js.native
  /**
  ...
  /**
    ...
    */
  def getItemType(): dndDashCoreLib.libCjsInterfacesMod.Identifier | scala.Null = js.native
  /**
    ...
    */
  def getSourceClientOffset(): dndDashCoreLib.libCjsInterfacesMod.XYCoord | scala.Null = js.native
  /**
