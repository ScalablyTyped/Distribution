...
trait DropTargetSpec[Props] extends js.Object {
  /**
    ...
    */
  var canDrop: js.UndefOr[js.Function2[/* props */ Props, /* monitor */ DropTargetMonitor, scala.Boolean]] = js.undefined
  /**
    * Optional.
  ...
  var hover: js.UndefOr[
    js.Function3[/* props */ Props, /* monitor */ DropTargetMonitor, /* component */ js.Any, scala.Unit]
  ] = js.undefined
}
...
object DropTargetSpec {
  @scala.inline
  def apply[Props](
    canDrop: js.Function2[/* props */ Props, /* monitor */ DropTargetMonitor, scala.Boolean] = null,
    drop: js.Function3[/* props */ Props, /* monitor */ DropTargetMonitor, /* component */ js.Any, _] = null,
    hover: js.Function3[/* props */ Props, /* monitor */ DropTargetMonitor, /* component */ js.Any, scala.Unit] = null
