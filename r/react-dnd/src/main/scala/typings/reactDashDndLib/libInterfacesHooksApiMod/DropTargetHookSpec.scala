...
trait DropTargetHookSpec[DragObject, DropResult, CollectedProps] extends js.Object {
  /**
    ...
    */
  var accept: dndDashCoreLib.libInterfacesMod.TargetType
  /**
...
object DropTargetHookSpec {
  ...
  def apply[DragObject, DropResult, CollectedProps](
    accept: dndDashCoreLib.libInterfacesMod.TargetType,
    canDrop: (/* item */ DragObject, /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DropTargetMonitor) => scala.Boolean = null,
    collect: /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DropTargetMonitor => CollectedProps = null,
    drop: (/* item */ DragObject, /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DropTargetMonitor) => js.UndefOr[DropResult] = null,
    hover: (/* item */ DragObject, /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DropTargetMonitor) => scala.Unit = null,
    options: js.Any = null
