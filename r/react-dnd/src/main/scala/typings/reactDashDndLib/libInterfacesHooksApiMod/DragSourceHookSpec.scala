...
trait DragSourceHookSpec[DragObject /* <: DragObjectWithType */, DropResult, CollectedProps] extends js.Object {
  ...
  var begin: js.UndefOr[
    js.Function1[
      ...
      js.UndefOr[DragObject | scala.Unit]
    ]
  ] = js.undefined
  /**
    * Optional.
  ...
  /**
    ...
    */
  var options: js.UndefOr[reactDashDndLib.libInterfacesOptionsMod.DragSourceOptions] = js.undefined
  /**
    * DragPreview options
    */
  var previewOptions: js.UndefOr[reactDashDndLib.libInterfacesOptionsMod.DragPreviewOptions] = js.undefined
}
...
object DragSourceHookSpec {
  ...
  def apply[DragObject /* <: DragObjectWithType */, DropResult, CollectedProps](
    item: DragObject,
    begin: /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DragSourceMonitor => js.UndefOr[DragObject | scala.Unit] = null,
    canDrag: scala.Boolean | (js.Function1[
      /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DragSourceMonitor, 
      scala.Boolean
    ]) = null,
    collect: /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DragSourceMonitor => CollectedProps = null,
    end: (/* dropResult */ js.UndefOr[DropResult], /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DragSourceMonitor) => scala.Unit = null,
    isDragging: /* monitor */ reactDashDndLib.libInterfacesMonitorsMod.DragSourceMonitor => scala.Boolean = null,
    options: reactDashDndLib.libInterfacesOptionsMod.DragSourceOptions = null,
    previewOptions: reactDashDndLib.libInterfacesOptionsMod.DragPreviewOptions = null
