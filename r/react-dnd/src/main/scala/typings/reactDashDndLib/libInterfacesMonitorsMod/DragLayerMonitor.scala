...
object DragLayerMonitor {
  @scala.inline
  def apply(
    getClientOffset: () => dndDashCoreLib.libInterfacesMod.XYCoord | scala.Null,
    getDifferenceFromInitialOffset: () => dndDashCoreLib.libInterfacesMod.XYCoord | scala.Null,
    getInitialClientOffset: () => dndDashCoreLib.libInterfacesMod.XYCoord | scala.Null,
    getInitialSourceClientOffset: () => dndDashCoreLib.libInterfacesMod.XYCoord | scala.Null,
    getItem: () => js.Any,
    getItemType: () => dndDashCoreLib.libInterfacesMod.Identifier | scala.Null,
    getSourceClientOffset: () => dndDashCoreLib.libInterfacesMod.XYCoord | scala.Null,
