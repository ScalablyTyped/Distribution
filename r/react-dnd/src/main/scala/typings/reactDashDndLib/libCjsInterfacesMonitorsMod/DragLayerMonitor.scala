...
trait DragLayerMonitor extends js.Object {
  /**
    ...
    */
  def getClientOffset(): dndDashCoreLib.libCjsInterfacesMod.XYCoord | scala.Null
  /**
    ...
    */
  def getDifferenceFromInitialOffset(): dndDashCoreLib.libCjsInterfacesMod.XYCoord | scala.Null
  /**
    * Returns the { x, y } client offset of the pointer at the time when the current drag operation has started.
    * Returns null if no item is being dragged.
    */
  def getInitialClientOffset(): dndDashCoreLib.libCjsInterfacesMod.XYCoord | scala.Null
  /**
    * Returns the { x, y } client offset of the drag source component's root DOM node at the time when the current
    * drag operation has started. Returns null if no item is being dragged.
    */
  def getInitialSourceClientOffset(): dndDashCoreLib.libCjsInterfacesMod.XYCoord | scala.Null
  /**
  ...
  /**
    ...
    * Returns null if no item is being dragged.
    */
  def getItemType(): dndDashCoreLib.libCjsInterfacesMod.Identifier | scala.Null
  /**
    ...
    * Returns null if no item is being dragged.
    */
  def getSourceClientOffset(): dndDashCoreLib.libCjsInterfacesMod.XYCoord | scala.Null
  /**
