...
object decorateHandlerMod {
  ...
  inline def decorateHandler[Props, CollectedProps, ItemIdType](
  ...
  object DecorateHandlerArgs {
    ...
    inline def apply[Props, ItemIdType](
    ...
    extension [Self <: DecorateHandlerArgs[?, ?], Props, ItemIdType](x: Self & (DecorateHandlerArgs[Props, ItemIdType])) {
      
      inline def setCollect(value: js.Any): Self = StObject.set(x, "collect", value.asInstanceOf[js.Any])
      
      inline def setContainerDisplayName(value: String): Self = StObject.set(x, "containerDisplayName", value.asInstanceOf[js.Any])
      
      inline def setCreateConnector(value: js.Any): Self = StObject.set(x, "createConnector", value.asInstanceOf[js.Any])
      
      inline def setCreateHandler(value: (HandlerReceiver, RefObject[js.Any]) => Handler[Props]): Self = StObject.set(x, "createHandler", js.Any.fromFunction2(value))
      
      inline def setCreateMonitor(value: DragDropManager => HandlerReceiver): Self = StObject.set(x, "createMonitor", js.Any.fromFunction1(value))
      
      inline def setDecoratedComponent(value: js.Any): Self = StObject.set(x, "DecoratedComponent", value.asInstanceOf[js.Any])
      
      inline def setGetType(value: Props => ItemIdType): Self = StObject.set(x, "getType", js.Any.fromFunction1(value))
      
      inline def setOptions(value: js.Any): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      
      inline def setRegisterHandler(value: js.Any): Self = StObject.set(x, "registerHandler", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Handler {
    ...
    inline def apply[Props](receiveProps: Props => Unit, ref: RefObject[js.Any]): Handler[Props] = {
    ...
    extension [Self <: Handler[?], Props](x: Self & Handler[Props]) {
      
      inline def setReceiveProps(value: Props => Unit): Self = StObject.set(x, "receiveProps", js.Any.fromFunction1(value))
