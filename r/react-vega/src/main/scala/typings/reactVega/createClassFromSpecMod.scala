...
import typings.reactVega.typesMod.PlainObject
...
object createClassFromSpecMod {
  ...
  object FixedVegaChartProps {
    ...
    extension [Self <: FixedVegaChartProps](x: Self) {
      ...
      inline def setOnNewView(value: /* view */ typings.reactVega.typesMod.View => Unit): Self = StObject.set(x, "onNewView", js.Any.fromFunction1(value))
