...
object ModalFilterPickerProps {
  @scala.inline
  def apply[/* <: typings.reactNativeModalFilterPicker.mod.ModalFilterPickerOption */ T](onCancel: () => Unit, onSelect: String => Unit, options: js.Array[T]): ModalFilterPickerProps[T] = {
  ...
  @scala.inline
  implicit class ModalFilterPickerPropsOps[Self <: ModalFilterPickerProps[_], /* <: typings.reactNativeModalFilterPicker.mod.ModalFilterPickerOption */ T] (val x: Self with ModalFilterPickerProps[T]) extends AnyVal {
    @scala.inline
