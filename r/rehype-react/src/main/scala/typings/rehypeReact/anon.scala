...
object anon {
  ...
  trait PartialTagNameinkeyofIntr extends StObject {
    ...
    var a: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typings.rehypeReact.rehypeReactStrings.a, typings.rehypeReact.rehypeReactStrings.abbr, typings.rehypeReact.rehypeReactStrings.address */ Any
      ] = js.undefined
  ...
  object PartialTagNameinkeyofIntr {
    ...
    implicit open class MutableBuilder[Self <: PartialTagNameinkeyofIntr] (val x: Self) extends AnyVal {
      ...
      inline def setA(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 178, starting with typings.rehypeReact.rehypeReactStrings.a, typings.rehypeReact.rehypeReactStrings.abbr, typings.rehypeReact.rehypeReactStrings.address */ Any
