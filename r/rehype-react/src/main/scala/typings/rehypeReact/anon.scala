...
object anon {
  ...
  trait PartialTagNameinkeyofIntr extends StObject {
    ...
    var a: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typings.rehypeReact.rehypeReactStrings.a, typings.rehypeReact.rehypeReactStrings.abbr, typings.rehypeReact.rehypeReactStrings.address */ Any
      ] = js.undefined
