...
trait CalendarProps[TEvent /* <: js.Object */, TResource /* <: js.Object */]
  extends reactLib.reactMod.Props[Calendar[TEvent, TResource]] {
  ...
  var onNavigate: js.UndefOr[
    js.Function3[/* newDate */ stdLib.Date, /* view */ View, /* action */ NavigateAction, scala.Unit]
  ] = js.undefined
...
object CalendarProps {
  ...
  def apply[TEvent /* <: js.Object */, TResource /* <: js.Object */](
    ...
    onNavigate: (/* newDate */ stdLib.Date, /* view */ View, /* action */ NavigateAction) => scala.Unit = null,
    ...
    ref: reactLib.reactMod.LegacyRef[Calendar[TEvent, TResource]] = null,
