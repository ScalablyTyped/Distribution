...
trait CSSPropertiesxOffsetnumbe extends StObject {
...
object CSSPropertiesxOffsetnumbe {
  
  inline def apply(xOffset: Double): CSSPropertiesxOffsetnumbe = {
    val __obj = js.Dynamic.literal(xOffset = xOffset.asInstanceOf[js.Any])
    __obj.asInstanceOf[CSSPropertiesxOffsetnumbe]
  }
  
  extension [Self <: CSSPropertiesxOffsetnumbe](x: Self) {
