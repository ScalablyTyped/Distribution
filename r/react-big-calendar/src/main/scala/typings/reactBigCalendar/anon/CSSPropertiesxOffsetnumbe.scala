...
trait CSSPropertiesxOffsetnumbe extends js.Object {
  ...
  /**
    ...
    */
  var direction: js.UndefOr[typings.csstype.mod.Property.Direction] = js.native
  /**
...
object CSSPropertiesxOffsetnumbe {
  ...
  @scala.inline
  implicit class CSSPropertiesxOffsetnumbeOps[Self <: CSSPropertiesxOffsetnumbe] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDirection(value: typings.csstype.mod.Property.Direction): Self = this.set("direction", value.asInstanceOf[js.Any])
    @scala.inline
