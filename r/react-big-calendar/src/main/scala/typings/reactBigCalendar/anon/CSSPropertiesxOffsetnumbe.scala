...
object CSSPropertiesxOffsetnumbe {
  ...
  @scala.inline
  def apply(xOffset: Double): CSSPropertiesxOffsetnumbe = {
    val __obj = js.Dynamic.literal(xOffset = xOffset.asInstanceOf[js.Any])
    __obj.asInstanceOf[CSSPropertiesxOffsetnumbe]
  }
  
  @scala.inline
  implicit class CSSPropertiesxOffsetnumbeMutableBuilder[Self <: CSSPropertiesxOffsetnumbe] (val x: Self) extends AnyVal {
