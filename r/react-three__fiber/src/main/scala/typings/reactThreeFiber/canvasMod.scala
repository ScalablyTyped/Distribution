...
import typings.reactThreeFiber.coreMod.GLProps
import typings.reactThreeFiber.eventsMod.EventManager
import typings.reactThreeFiber.reactThreeFiberStrings.`box-none`
import typings.reactThreeFiber.reactThreeFiberStrings.`box-only`
import typings.reactThreeFiber.reactThreeFiberStrings.`no-hide-descendants`
...
import typings.reactThreeFiber.reactThreeFiberStrings.auto
