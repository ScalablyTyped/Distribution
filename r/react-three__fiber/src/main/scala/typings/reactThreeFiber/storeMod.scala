...
import typings.reactThreeFiber.eventsMod.PointerCaptureTarget
...
import typings.zustand.zustandVanillaMod.GetState
import typings.zustand.zustandVanillaMod.SetState
...
object storeMod {
  ...
  */
  ...
  trait RootState extends StObject {
    ...
    var camera: typings.reactThreeFiber.utilsMod.Camera & Manual = js.native
