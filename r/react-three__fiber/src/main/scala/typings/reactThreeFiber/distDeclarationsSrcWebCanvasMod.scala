...
import typings.reactThreeFiber.distDeclarationsSrcCoreMod.GLProps
...
import typings.reactThreeFiber.reactThreeFiberStrings.`additions removals`
import typings.reactThreeFiber.reactThreeFiberStrings.`additions text`
import typings.reactThreeFiber.reactThreeFiberStrings.`inline`
import typings.reactThreeFiber.reactThreeFiberStrings.`removals additions`
import typings.reactThreeFiber.reactThreeFiberStrings.`removals text`
import typings.reactThreeFiber.reactThreeFiberStrings.`text additions`
import typings.reactThreeFiber.reactThreeFiberStrings.`text removals`
import typings.reactThreeFiber.reactThreeFiberStrings.additions
import typings.reactThreeFiber.reactThreeFiberStrings.all
import typings.reactThreeFiber.reactThreeFiberStrings.always
import typings.reactThreeFiber.reactThreeFiberStrings.ascending
import typings.reactThreeFiber.reactThreeFiberStrings.assertive
import typings.reactThreeFiber.reactThreeFiberStrings.both
import typings.reactThreeFiber.reactThreeFiberStrings.client
import typings.reactThreeFiber.reactThreeFiberStrings.copy
import typings.reactThreeFiber.reactThreeFiberStrings.date
import typings.reactThreeFiber.reactThreeFiberStrings.decimal
import typings.reactThreeFiber.reactThreeFiberStrings.demand
import typings.reactThreeFiber.reactThreeFiberStrings.descending
import typings.reactThreeFiber.reactThreeFiberStrings.dialog
import typings.reactThreeFiber.reactThreeFiberStrings.email
import typings.reactThreeFiber.reactThreeFiberStrings.execute
import typings.reactThreeFiber.reactThreeFiberStrings.grammar
import typings.reactThreeFiber.reactThreeFiberStrings.grid
import typings.reactThreeFiber.reactThreeFiberStrings.horizontal
import typings.reactThreeFiber.reactThreeFiberStrings.inherit
import typings.reactThreeFiber.reactThreeFiberStrings.layer
import typings.reactThreeFiber.reactThreeFiberStrings.link
import typings.reactThreeFiber.reactThreeFiberStrings.list
import typings.reactThreeFiber.reactThreeFiberStrings.listbox
import typings.reactThreeFiber.reactThreeFiberStrings.location
import typings.reactThreeFiber.reactThreeFiberStrings.menu
import typings.reactThreeFiber.reactThreeFiberStrings.mixed
import typings.reactThreeFiber.reactThreeFiberStrings.move
import typings.reactThreeFiber.reactThreeFiberStrings.never
import typings.reactThreeFiber.reactThreeFiberStrings.no
import typings.reactThreeFiber.reactThreeFiberStrings.none
import typings.reactThreeFiber.reactThreeFiberStrings.numeric
import typings.reactThreeFiber.reactThreeFiberStrings.off
import typings.reactThreeFiber.reactThreeFiberStrings.offset
import typings.reactThreeFiber.reactThreeFiberStrings.on
import typings.reactThreeFiber.reactThreeFiberStrings.other
import typings.reactThreeFiber.reactThreeFiberStrings.page
import typings.reactThreeFiber.reactThreeFiberStrings.polite
import typings.reactThreeFiber.reactThreeFiberStrings.popup
import typings.reactThreeFiber.reactThreeFiberStrings.removals
import typings.reactThreeFiber.reactThreeFiberStrings.screen
import typings.reactThreeFiber.reactThreeFiberStrings.search
import typings.reactThreeFiber.reactThreeFiberStrings.spelling
import typings.reactThreeFiber.reactThreeFiberStrings.step
import typings.reactThreeFiber.reactThreeFiberStrings.tel
import typings.reactThreeFiber.reactThreeFiberStrings.text
import typings.reactThreeFiber.reactThreeFiberStrings.time
import typings.reactThreeFiber.reactThreeFiberStrings.tree
import typings.reactThreeFiber.reactThreeFiberStrings.url
import typings.reactThreeFiber.reactThreeFiberStrings.vertical
import typings.reactThreeFiber.reactThreeFiberStrings.yes
import typings.reactUseMeasure.mod.Options
...
object distDeclarationsSrcWebCanvasMod {
  
  @JSImport("@react-three/fiber/dist/declarations/src/web/Canvas", "Canvas")
  @js.native
  val Canvas: ForwardRefExoticComponent[Props & RefAttributes[HTMLCanvasElement]] = js.native
  
  /* Inlined parent std.Omit<@react-three/fiber.@react-three/fiber/dist/declarations/src/core.RenderProps<std.HTMLCanvasElement>, 'size'> */
  ...
  trait Props extends StObject {
    ...
    var eventPrefix: js.UndefOr[offset | client | page | layer | screen] = js.undefined
    
    var eventSource: js.UndefOr[HTMLElement | MutableRefObject[HTMLElement]] = js.undefined
    ...
    var resize: js.UndefOr[Options] = js.undefined
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setEventPrefix(value: offset | client | page | layer | screen): Self = StObject.set(x, "eventPrefix", value.asInstanceOf[js.Any])
      
      inline def setEventPrefixUndefined: Self = StObject.set(x, "eventPrefix", js.undefined)
      
      inline def setEventSource(value: HTMLElement | MutableRefObject[HTMLElement]): Self = StObject.set(x, "eventSource", value.asInstanceOf[js.Any])
      ...
      inline def setOnMouseDown(value: typings.react.mod.MouseEvent[HTMLDivElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction1(value))
      ...
      inline def setOnMouseUp(value: typings.react.mod.MouseEvent[HTMLDivElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseUp", js.Any.fromFunction1(value))
      ...
      inline def setResize(value: Options): Self = StObject.set(x, "resize", value.asInstanceOf[js.Any])
