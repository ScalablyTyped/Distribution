...
import typings.reactThreeFiber.loopMod.GlobalEffectType
...
object reactThreeFiberStrings {
  ...
  @js.native
  sealed trait ExtendedColors extends StObject
  inline def ExtendedColors: ExtendedColors = "ExtendedColors".asInstanceOf[ExtendedColors]
