...
import typings.reactThreeFiber.anon.Dispose
import typings.reactThreeFiber.anon.FnCallXYZOrder
import typings.reactThreeFiber.anon.TypeofBoxGeometry
import typings.reactThreeFiber.anon.TypeofCircleGeometry
import typings.reactThreeFiber.anon.TypeofColor
import typings.reactThreeFiber.anon.TypeofConeGeometry
import typings.reactThreeFiber.anon.TypeofCylinderGeometry
import typings.reactThreeFiber.anon.TypeofDodecahedronGeometr
import typings.reactThreeFiber.anon.TypeofEuler
import typings.reactThreeFiber.anon.TypeofExtrudeGeometry
import typings.reactThreeFiber.anon.TypeofIcosahedronGeometry
import typings.reactThreeFiber.anon.TypeofLatheGeometry
import typings.reactThreeFiber.anon.TypeofObject3D
import typings.reactThreeFiber.anon.TypeofOctahedronGeometry
import typings.reactThreeFiber.anon.TypeofPlaneGeometry
import typings.reactThreeFiber.anon.TypeofPolyhedronGeometry
import typings.reactThreeFiber.anon.TypeofQuaternion
import typings.reactThreeFiber.anon.TypeofRingGeometry
import typings.reactThreeFiber.anon.TypeofShapeGeometry
import typings.reactThreeFiber.anon.TypeofSphereGeometry
import typings.reactThreeFiber.anon.TypeofTetrahedronGeometry
import typings.reactThreeFiber.anon.TypeofTexture
import typings.reactThreeFiber.anon.TypeofTorusGeometry
import typings.reactThreeFiber.anon.TypeofTorusKnotGeometry
import typings.reactThreeFiber.anon.TypeofTubeGeometry
import typings.reactThreeFiber.distDeclarationsSrcCoreEventsMod.EventHandlers
...
import typings.three.mod.AudioListener
...
import typings.three.mod.CircleGeometry
...
import typings.three.mod.DodecahedronGeometry
...
import typings.three.mod.IcosahedronGeometry
...
import typings.three.mod.LatheGeometry
...
import typings.three.mod.PolyhedronGeometry
...
import typings.three.mod.ShapeGeometry
...
import typings.three.mod.TetrahedronGeometry
import typings.three.mod.Texture
import typings.three.mod.TorusGeometry
import typings.three.mod.TorusKnotGeometry
import typings.three.mod.TubeGeometry
...
object distDeclarationsSrcThreeTypesMod {
  ...
  type CameraProps = Object3DNode[typings.three.mod.Camera, Instantiable0[typings.three.mod.Camera]]
  ...
  type Color = ConstructorParameters[TypeofColor] | typings.three.mod.Color | Double | String
  
  type ColorArray = TypeofColor | (Parameters[
    js.Function1[/* color */ ColorRepresentation, typings.three.srcMathColorMod.Color]
  ])
  
  type ColorProps = Node[typings.three.mod.Color, ColorArray]
  ...
  type DirectionalLightProps = LightNode[
    ...
    Instantiable0[typings.three.mod.DirectionalLight]
  ]
  ...
  type EdgesGeometryProps = BufferGeometryNode[
    EdgesGeometry[typings.three.srcCoreBufferGeometryMod.BufferGeometry], 
    Instantiable0[EdgesGeometry[typings.three.srcCoreBufferGeometryMod.BufferGeometry]]
  ]
  
  type Euler = typings.three.mod.Euler | Parameters[FnCallXYZOrder]
  ...
  type HemisphereLightProps = LightNode[
    ...
    Instantiable0[typings.three.mod.HemisphereLight]
  ]
  ...
  type Layers = typings.three.mod.Layers | (/* import warning: importer.ImportType#apply Failed type conversion: std.Parameters<(channel : number): void>[0] */ js.Any)
  ...
  type MaterialNode[T /* <: typings.three.mod.Material */, P] = Node[T, P]
  
  type MaterialProps = MaterialNode[typings.three.mod.Material, js.Array[MaterialParameters]]
  
  type Matrix3Props = Node[Matrix3, Instantiable0[Matrix3]]
  
  type Matrix4 = typings.three.mod.Matrix4 | (Parameters[
    js.Function16[
      /* n11 */ Double, 
      /* n12 */ Double, 
      /* n13 */ Double, 
      ...
      /* n43 */ Double, 
      /* n44 */ Double, 
      typings.three.srcMathMatrix4Mod.Matrix4
    ]
  ]) | (js.Function16[
    /* n11 */ Double, 
    /* n12 */ Double, 
  ...
  type Matrix4Props = Node[typings.three.mod.Matrix4, Instantiable0[typings.three.mod.Matrix4]]
  ...
  type Object3DProps = Object3DNode[typings.three.mod.Object3D[Event], TypeofObject3D]
  ...
  type PointLightProps = LightNode[typings.three.mod.PointLight, Instantiable0[typings.three.mod.PointLight]]
  ...
  type PositionalAudioProps = Object3DNode[
    PositionalAudio, 
    Instantiable1[
      /* listener */ typings.three.srcAudioAudioListenerMod.AudioListener, 
      PositionalAudio
    ]
  ]
  ...
  type Quaternion = typings.three.mod.Quaternion | (Parameters[
    js.Function4[
      /* x */ Double, 
      /* y */ Double, 
      /* z */ Double, 
      /* w */ Double, 
      typings.three.srcMathQuaternionMod.Quaternion
    ]
  ])
  
  type QuaternionProps = Node[typings.three.mod.Quaternion, TypeofQuaternion]
  ...
  type SkeletonProps = Object3DNode[
    Skeleton, 
    Instantiable1[/* bones */ js.Array[typings.three.srcObjectsBoneMod.Bone], Skeleton]
  ]
  ...
  type SpotLightHelperProps = Object3DNode[
    SpotLightHelper, 
    Instantiable1[/* light */ typings.three.srcLightsLightMod.Light, SpotLightHelper]
  ]
  ...
  type Vector2 = VectorLike[typings.three.mod.Vector2]
  
  type Vector2Props = Node[typings.three.mod.Vector2, Instantiable0[typings.three.mod.Vector2]]
  
  type Vector3 = VectorLike[typings.three.mod.Vector3]
  
  type Vector3Props = Node[typings.three.mod.Vector3, Instantiable0[typings.three.mod.Vector3]]
  
  type Vector4 = VectorLike[typings.three.mod.Vector4]
  
  type Vector4Props = Node[typings.three.mod.Vector4, Instantiable0[typings.three.mod.Vector4]]
  ...
  type WireframeGeometryProps = BufferGeometryNode[
    WireframeGeometry[typings.three.srcCoreBufferGeometryMod.BufferGeometry], 
    Instantiable0[WireframeGeometry[typings.three.srcCoreBufferGeometryMod.BufferGeometry]]
  ]
