...
import typings.reactNativeTabView.reactNativeTabViewStrings.`box-none`
import typings.reactNativeTabView.reactNativeTabViewStrings.`box-only`
import typings.reactNativeTabView.reactNativeTabViewStrings.`no-hide-descendants`
import typings.reactNativeTabView.reactNativeTabViewStrings.assertive
import typings.reactNativeTabView.reactNativeTabViewStrings.auto
import typings.reactNativeTabView.reactNativeTabViewStrings.button
import typings.reactNativeTabView.reactNativeTabViewStrings.no
import typings.reactNativeTabView.reactNativeTabViewStrings.none
import typings.reactNativeTabView.reactNativeTabViewStrings.polite
import typings.reactNativeTabView.reactNativeTabViewStrings.radiobutton_checked
import typings.reactNativeTabView.reactNativeTabViewStrings.radiobutton_unchecked
import typings.reactNativeTabView.reactNativeTabViewStrings.yes
