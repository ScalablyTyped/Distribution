...
import typings.reactDashNativeDashTabDashView.libTypescriptSrcTypesMod.Event
...
trait Anon_ActiveColor[T /* <: Route */] extends js.Object {
  ...
  var renderIcon: js.UndefOr[js.Function1[/* scene */ Scene[T] with Anon_Color, ReactNode]] = js.undefined
  var renderLabel: js.UndefOr[js.Function1[/* scene */ Scene[T] with Anon_Color, ReactNode]] = js.undefined
