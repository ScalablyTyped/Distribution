...
import typings.rcSwitch.rcSwitchStrings.`additions removals`
import typings.rcSwitch.rcSwitchStrings.`additions text`
import typings.rcSwitch.rcSwitchStrings.`inline`
import typings.rcSwitch.rcSwitchStrings.`removals additions`
import typings.rcSwitch.rcSwitchStrings.`removals text`
import typings.rcSwitch.rcSwitchStrings.`text additions`
import typings.rcSwitch.rcSwitchStrings.`text removals`
import typings.rcSwitch.rcSwitchStrings.additions
import typings.rcSwitch.rcSwitchStrings.all
import typings.rcSwitch.rcSwitchStrings.ascending
import typings.rcSwitch.rcSwitchStrings.assertive
import typings.rcSwitch.rcSwitchStrings.both
import typings.rcSwitch.rcSwitchStrings.copy
import typings.rcSwitch.rcSwitchStrings.date
import typings.rcSwitch.rcSwitchStrings.decimal
import typings.rcSwitch.rcSwitchStrings.descending
import typings.rcSwitch.rcSwitchStrings.dialog
import typings.rcSwitch.rcSwitchStrings.email
import typings.rcSwitch.rcSwitchStrings.execute
import typings.rcSwitch.rcSwitchStrings.grammar
import typings.rcSwitch.rcSwitchStrings.grid
import typings.rcSwitch.rcSwitchStrings.horizontal
import typings.rcSwitch.rcSwitchStrings.inherit
import typings.rcSwitch.rcSwitchStrings.link
import typings.rcSwitch.rcSwitchStrings.list
import typings.rcSwitch.rcSwitchStrings.listbox
import typings.rcSwitch.rcSwitchStrings.location
import typings.rcSwitch.rcSwitchStrings.menu
import typings.rcSwitch.rcSwitchStrings.mixed
import typings.rcSwitch.rcSwitchStrings.move
import typings.rcSwitch.rcSwitchStrings.no
import typings.rcSwitch.rcSwitchStrings.none
import typings.rcSwitch.rcSwitchStrings.numeric
import typings.rcSwitch.rcSwitchStrings.off
import typings.rcSwitch.rcSwitchStrings.on
import typings.rcSwitch.rcSwitchStrings.other
import typings.rcSwitch.rcSwitchStrings.page
import typings.rcSwitch.rcSwitchStrings.polite
import typings.rcSwitch.rcSwitchStrings.popup
import typings.rcSwitch.rcSwitchStrings.removals
import typings.rcSwitch.rcSwitchStrings.search
import typings.rcSwitch.rcSwitchStrings.spelling
import typings.rcSwitch.rcSwitchStrings.step
import typings.rcSwitch.rcSwitchStrings.tel
import typings.rcSwitch.rcSwitchStrings.text
import typings.rcSwitch.rcSwitchStrings.time
import typings.rcSwitch.rcSwitchStrings.tree
import typings.rcSwitch.rcSwitchStrings.url
import typings.rcSwitch.rcSwitchStrings.vertical
import typings.rcSwitch.rcSwitchStrings.yes
...
object mod extends Shortcut {
  ...
  @js.native
  val default: ForwardRefExoticComponent[SwitchProps with RefAttributes[HTMLButtonElement]] = js.native
  
  type SwitchChangeEventHandler = js.Function2[
    /* checked */ Boolean, 
    /* event */ (MouseEvent[HTMLButtonElement, NativeMouseEvent]) | KeyboardEvent[HTMLButtonElement], 
    Unit
  ]
  ...
  object SwitchProps {
    ...
    implicit class SwitchPropsMutableBuilder[Self <: SwitchProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(
        value: (/* checked */ Boolean, /* event */ (MouseEvent[HTMLButtonElement, NativeMouseEvent]) | KeyboardEvent[HTMLButtonElement]) => Unit
  ...
  type _To = ForwardRefExoticComponent[SwitchProps with RefAttributes[HTMLButtonElement]]
  
  /* This means you don't have to write `default`, but can instead just say `mod.foo` */
  override def _to: ForwardRefExoticComponent[SwitchProps with RefAttributes[HTMLButtonElement]] = default
}
