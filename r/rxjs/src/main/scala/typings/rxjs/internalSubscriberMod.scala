...
@js.native
object internalSubscriberMod extends js.Object {
  @js.native
  ...
  - typings.rxjs.internalTypesMod.Observer because var conflicts: closed. Inlined next, error, complete */ @js.native
  /**
