...
object bindCallbackMod {
  ...
  @scala.inline
  def bindCallback_AR_Function1[A, R](callbackFunc: js.Function1[A | (js.Function1[/* result */ R, js.Any]), js.Any]): js.Function1[/* repeated */ A, Observable[R]] = ^.asInstanceOf[js.Dynamic].applyDynamic("bindCallback")(callbackFunc.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* repeated */ A, Observable[R]]]
  @scala.inline
