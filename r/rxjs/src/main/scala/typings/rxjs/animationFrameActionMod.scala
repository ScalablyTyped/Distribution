...
object animationFrameActionMod {
  ...
  class AnimationFrameAction[T] protected () extends AsyncAction[T] {
    ...
    /* protected */ def recycleAsyncId(scheduler: AnimationFrameScheduler, id: Unit, delay: Double): js.Any = js.native
    ...
    /* protected */ def requestAsyncId(scheduler: AnimationFrameScheduler, id: Unit, delay: Double): js.Any = js.native
