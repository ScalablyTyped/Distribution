...
object rxjsMod {
  ...
  @scala.inline
  def endWith[T](scheduler: SchedulerLike): MonoTypeOperatorFunction[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("endWith")(scheduler.asInstanceOf[js.Any]).asInstanceOf[MonoTypeOperatorFunction[T]]
  @scala.inline
  def endWith[T, Z](array: (SchedulerLike | Z)*): OperatorFunction[T, T | Z] = ^.asInstanceOf[js.Dynamic].applyDynamic("endWith")(array.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[T, T | Z]]
  @scala.inline
  def endWith[T, A](v1: A): OperatorFunction[T, T | A] = ^.asInstanceOf[js.Dynamic].applyDynamic("endWith")(v1.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[T, T | A]]
  @scala.inline
  def endWith[T, A](v1: A, scheduler: SchedulerLike): OperatorFunction[T, T | A] = (^.asInstanceOf[js.Dynamic].applyDynamic("endWith")(v1.asInstanceOf[js.Any], scheduler.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, T | A]]
  @scala.inline
  def endWith[T, A, B](v1: A, v2: B): OperatorFunction[T, T | A | B] = (^.asInstanceOf[js.Dynamic].applyDynamic("endWith")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, T | A | B]]
  @scala.inline
  def endWith[T, A, B](v1: A, v2: B, scheduler: SchedulerLike): OperatorFunction[T, T | A | B] = (^.asInstanceOf[js.Dynamic].applyDynamic("endWith")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any], scheduler.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, T | A | B]]
  @scala.inline
  def endWith[T, A, B, C](v1: A, v2: B, v3: C): OperatorFunction[T, T | A | B | C] = (^.asInstanceOf[js.Dynamic].applyDynamic("endWith")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any], v3.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, T | A | B | C]]
  @scala.inline
  def endWith[T, A, B, C](v1: A, v2: B, v3: C, scheduler: SchedulerLike): OperatorFunction[T, T | A | B | C] = (^.asInstanceOf[js.Dynamic].applyDynamic("endWith")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any], v3.asInstanceOf[js.Any], scheduler.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, T | A | B | C]]
  @scala.inline
  def endWith[T, A, B, C, D](v1: A, v2: B, v3: C, v4: D): OperatorFunction[T, T | A | B | C | D] = (^.asInstanceOf[js.Dynamic].applyDynamic("endWith")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any], v3.asInstanceOf[js.Any], v4.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, T | A | B | C | D]]
  @scala.inline
  ...
  @scala.inline
  def endWith[T, A, B, C, D, E](v1: A, v2: B, v3: C, v4: D, v5: E): OperatorFunction[T, T | A | B | C | D | E] = (^.asInstanceOf[js.Dynamic].applyDynamic("endWith")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any], v3.asInstanceOf[js.Any], v4.asInstanceOf[js.Any], v5.asInstanceOf[js.Any])).asInstanceOf[OperatorFunction[T, T | A | B | C | D | E]]
  @scala.inline
