...
object pluckMod {
  ...
  inline def pluck[T, R](properties: String*): OperatorFunction[T, R] = ^.asInstanceOf[js.Dynamic].applyDynamic("pluck")(properties.asInstanceOf[js.Any]).asInstanceOf[OperatorFunction[T, R]]
