...
object WebSocketSubjectConfig {
  ...
  implicit class WebSocketSubjectConfigOps[Self <: WebSocketSubjectConfig[_], T] (val x: Self with WebSocketSubjectConfig[T]) extends AnyVal {
    ...
    @scala.inline
    def setDeserializer(value: /* e */ MessageEvent[_] => T): Self = this.set("deserializer", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setResultSelector(value: /* e */ MessageEvent[_] => T): Self = this.set("resultSelector", js.Any.fromFunction1(value))
