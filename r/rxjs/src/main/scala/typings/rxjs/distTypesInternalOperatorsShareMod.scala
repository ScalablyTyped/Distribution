...
object distTypesInternalOperatorsShareMod {
  ...
  trait ShareConfig[T] extends StObject {
    ...
    /**
      ...
      */
    var resetOnComplete: js.UndefOr[Boolean | js.Function0[ObservableInput[Any]]] = js.undefined
    ...
    /**
      ...
      * control over how and when the reset should happen. This allows behaviors like conditional or delayed resets.
      */
    var resetOnError: js.UndefOr[Boolean | (js.Function1[/* error */ Any, ObservableInput[Any]])] = js.undefined
    ...
    /**
      ...
      * control over how and when the reset should happen. This allows behaviors like conditional or delayed resets.
      */
    var resetOnRefCountZero: js.UndefOr[Boolean | js.Function0[ObservableInput[Any]]] = js.undefined
  }
  object ShareConfig {
    ...
    implicit open class MutableBuilder[Self <: ShareConfig[?], T] (val x: Self & ShareConfig[T]) extends AnyVal {
      ...
      inline def setResetOnComplete(value: Boolean | js.Function0[ObservableInput[Any]]): Self = StObject.set(x, "resetOnComplete", value.asInstanceOf[js.Any])
      
      inline def setResetOnCompleteFunction0(value: () => ObservableInput[Any]): Self = StObject.set(x, "resetOnComplete", js.Any.fromFunction0(value))
      
      inline def setResetOnCompleteUndefined: Self = StObject.set(x, "resetOnComplete", js.undefined)
      
      inline def setResetOnError(value: Boolean | (js.Function1[/* error */ Any, ObservableInput[Any]])): Self = StObject.set(x, "resetOnError", value.asInstanceOf[js.Any])
      
      inline def setResetOnErrorFunction1(value: /* error */ Any => ObservableInput[Any]): Self = StObject.set(x, "resetOnError", js.Any.fromFunction1(value))
      
      inline def setResetOnErrorUndefined: Self = StObject.set(x, "resetOnError", js.undefined)
      
      inline def setResetOnRefCountZero(value: Boolean | js.Function0[ObservableInput[Any]]): Self = StObject.set(x, "resetOnRefCountZero", value.asInstanceOf[js.Any])
      
      inline def setResetOnRefCountZeroFunction0(value: () => ObservableInput[Any]): Self = StObject.set(x, "resetOnRefCountZero", js.Any.fromFunction0(value))
