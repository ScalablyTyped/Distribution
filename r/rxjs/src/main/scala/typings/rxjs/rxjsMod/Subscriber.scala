...
/**
  ...
  */
class Subscriber[T] ()
  extends typings.rxjs.internalSubscriberMod.Subscriber[T] {
...
object Subscriber extends js.Object {
  /**
    ...
    * @nocollapse
    */
  def create[T](): typings.rxjs.internalSubscriberMod.Subscriber[T] = js.native
  def create[T](next: js.Function1[/* x */ js.UndefOr[T], Unit]): typings.rxjs.internalSubscriberMod.Subscriber[T] = js.native
  def create[T](
