...
object zip extends js.Object {
  def apply[O /* <: ObservableInput[_] */](array: js.Array[O]): typings.rxjs.internalObservableMod.Observable[js.Array[ObservedValueOf[O]]] = js.native
  def apply[R](array: js.Array[ObservableInput[_]], resultSelector: js.Function1[/* repeated */ js.Any, R]): typings.rxjs.internalObservableMod.Observable[R] = js.native
  def apply[O /* <: ObservableInput[_] */](observables: O*): typings.rxjs.internalObservableMod.Observable[js.Array[ObservedValueOf[O]]] = js.native
