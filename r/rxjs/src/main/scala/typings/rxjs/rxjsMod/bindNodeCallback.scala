...
object bindNodeCallback extends js.Object {
  def apply(callbackFunc: js.Function): js.Function1[/* repeated */ js.Any, typings.rxjs.internalObservableMod.Observable[js.Array[_]]] = js.native
  def apply(callbackFunc: js.Function1[/* callback */ js.Function1[/* err */ js.Any, _], _]): js.Function0[typings.rxjs.internalObservableMod.Observable[Unit]] = js.native
  def apply(
  ...
  def apply(callbackFunc: js.Function, scheduler: SchedulerLike): js.Function1[/* repeated */ js.Any, typings.rxjs.internalObservableMod.Observable[js.Array[_]]] = js.native
  def apply[A1](callbackFunc: js.Function2[/* arg1 */ A1, /* callback */ js.Function1[/* err */ js.Any, _], _]): js.Function1[/* arg1 */ A1, typings.rxjs.internalObservableMod.Observable[Unit]] = js.native
  def apply[A1](
