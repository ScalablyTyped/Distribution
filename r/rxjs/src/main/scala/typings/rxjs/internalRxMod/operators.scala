...
object operators extends js.Object {
  ...
  def dematerialize[T](): OperatorFunction[typings.rxjs.internalNotificationMod.Notification[T], T] = js.native
  ...
  def groupBy[T, K, R](
    ...
    subjectSelector: js.Function0[typings.rxjs.internalSubjectMod.Subject[R]]
  ): OperatorFunction[T, GroupedObservable[K, R]] = js.native
  @JSName("groupBy")
  ...
  def materialize[T](): OperatorFunction[T, typings.rxjs.internalNotificationMod.Notification[T]] = js.native
  ...
  def multicast[T](
    subjectFactory: js.ThisFunction0[
      ...
      typings.rxjs.internalSubjectMod.Subject[T]
    ]
  ): UnaryFunction[
    typings.rxjs.internalObservableMod.Observable[T], 
    typings.rxjs.internalObservableConnectableObservableMod.ConnectableObservable[T]
  ] = js.native
  def multicast[T](subject: typings.rxjs.internalSubjectMod.Subject[T]): UnaryFunction[
    typings.rxjs.internalObservableMod.Observable[T], 
    typings.rxjs.internalObservableConnectableObservableMod.ConnectableObservable[T]
  ] = js.native
  ...
  def multicast[T, O /* <: ObservableInput[_] */](
    subject: typings.rxjs.internalSubjectMod.Subject[T],
    selector: js.Function1[/* shared */ typings.rxjs.internalObservableMod.Observable[T], O]
  ): UnaryFunction[
    typings.rxjs.internalObservableMod.Observable[T], 
    typings.rxjs.internalObservableConnectableObservableMod.ConnectableObservable[ObservedValueOf[O]]
  ] = js.native
  ...
  def timeInterval[T](): OperatorFunction[T, typings.rxjs.internalOperatorsTimeIntervalMod.TimeInterval[T]] = js.native
  def timeInterval[T](scheduler: SchedulerLike): OperatorFunction[T, typings.rxjs.internalOperatorsTimeIntervalMod.TimeInterval[T]] = js.native
  ...
  def timestamp[T](): OperatorFunction[T, typings.rxjs.internalOperatorsTimestampMod.Timestamp[T]] = js.native
  def timestamp[T](scheduler: SchedulerLike): OperatorFunction[T, typings.rxjs.internalOperatorsTimestampMod.Timestamp[T]] = js.native
