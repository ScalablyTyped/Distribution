...
object zipAllMod {
  ...
  @scala.inline
  def zipAll[T](): OperatorFunction[ObservableInput[T], js.Array[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("zipAll")().asInstanceOf[OperatorFunction[ObservableInput[T], js.Array[T]]]
  @scala.inline
