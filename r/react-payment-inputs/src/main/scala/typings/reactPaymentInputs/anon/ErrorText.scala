...
object ErrorText {
  ...
  inline def apply(errorText: `0`, fieldWrapper: Base, input: CardNumber, inputWrapper: Errored): ErrorText = {
  ...
  extension [Self <: ErrorText](x: Self) {
    ...
    inline def setInput(value: CardNumber): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
