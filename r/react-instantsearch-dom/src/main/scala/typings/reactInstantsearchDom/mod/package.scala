...
import typings.reactInstantsearchCore.mod.DynamicWidgetsProvided
...
import typings.reactInstantsearchCore.mod.InsightsClient
...
import typings.reactInstantsearchDom.mod.^
...
inline def createClassNames(baseName: String): js.Function1[/* repeated */ String, String | js.Array[String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("createClassNames")(baseName.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* repeated */ String, String | js.Array[String]]]
...
inline def createInfiniteHitsSessionStorageCache(args: Any*): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("createInfiniteHitsSessionStorageCache")(args.asInstanceOf[Seq[js.Any]]*).asInstanceOf[Any]

inline def createVoiceSearchHelper(params: VoiceSearchHelperParams): VoiceSearchHelper = ^.asInstanceOf[js.Dynamic].applyDynamic("createVoiceSearchHelper")(params.asInstanceOf[js.Any]).asInstanceOf[VoiceSearchHelper]

inline def getInsightsAnonymousUserToken(): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getInsightsAnonymousUserToken")().asInstanceOf[js.UndefOr[String]]
