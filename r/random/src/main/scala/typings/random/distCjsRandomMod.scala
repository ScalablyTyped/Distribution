...
object distCjsRandomMod {
  ...
  open class Random () extends StObject {
    ...
    var _rng: typings.random.distCjsRngMod.default = js.native
    ...
    /**
      ...
      */
    def rng: typings.random.distCjsRngMod.default = js.native
    ...
    /**
      ...
      */
    def use(
      /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type [RNG] is not an array type */ args: js.Array[typings.random.distCjsRngMod.default]
    ): Unit = js.native
  }
