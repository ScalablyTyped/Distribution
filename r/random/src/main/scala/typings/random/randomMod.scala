...
object randomMod {
  ...
  @JSImport("random/dist/cjs/random", "RNG")
  @js.native
  abstract class RNG ()
  ...
  open class Random () extends StObject {
    ...
    var _rng: typings.random.rngMod.default = js.native
    ...
    /**
      ...
      */
    def rng: typings.random.rngMod.default = js.native
    ...
    /**
      ...
      */
    def use(
      /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type [RNG] is not an array type */ args: js.Array[typings.random.rngMod.default]
    ): Unit = js.native
  }
