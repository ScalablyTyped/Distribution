...
trait Options extends js.Object {
  ...
  var lstat: js.UndefOr[
    (js.Function2[
      ...
      scala.Unit
    ]) with rimrafLib.Anon_PromisifyPath
  ] = js.undefined
  ...
  var readdir: js.UndefOr[rimrafLib.Anon_PathOptions] = js.undefined
  var readdirSync: js.UndefOr[rimrafLib.Anon_PathOptionsBuffer] = js.undefined
  var rmdir: js.UndefOr[
    (js.Function2[
      /* path */ nodeLib.fsMod.PathLike, 
      /* callback */ js.Function1[/* err */ nodeLib.NodeJSNs.ErrnoException, scala.Unit], 
      scala.Unit
    ]) with rimrafLib.Anon_Promisify
  ] = js.undefined
