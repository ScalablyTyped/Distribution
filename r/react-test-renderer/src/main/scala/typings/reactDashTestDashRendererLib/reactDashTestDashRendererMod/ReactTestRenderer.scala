...
trait ReactTestRenderer extends js.Object {
  ...
  def unmount(nextElement: reactLib.reactMod.ReactNs.ReactElement): scala.Unit = js.native
  def update(nextElement: reactLib.reactMod.ReactNs.ReactElement): scala.Unit = js.native
}
