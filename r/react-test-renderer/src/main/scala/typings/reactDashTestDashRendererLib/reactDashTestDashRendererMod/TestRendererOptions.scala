...
trait TestRendererOptions extends js.Object {
  def createNodeMock(element: reactLib.reactMod.ReactElement[_]): js.Any
}

object TestRendererOptions {
  @scala.inline
  def apply(createNodeMock: reactLib.reactMod.ReactElement[_] => js.Any): TestRendererOptions = {
