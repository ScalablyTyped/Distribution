...
object AriaModalProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(escapeExits)) __obj.updateDynamic("escapeExits")(escapeExits.get.asInstanceOf[js.Any])
    if (!js.isUndefined(focusDialog)) __obj.updateDynamic("focusDialog")(focusDialog.get.asInstanceOf[js.Any])
    if (focusTrapOptions != null) __obj.updateDynamic("focusTrapOptions")(focusTrapOptions.asInstanceOf[js.Any])
    if (!js.isUndefined(focusTrapPaused)) __obj.updateDynamic("focusTrapPaused")(focusTrapPaused.get.asInstanceOf[js.Any])
    if (getApplicationNode != null) __obj.updateDynamic("getApplicationNode")(js.Any.fromFunction0(getApplicationNode))
    if (!js.isUndefined(includeDefaultStyles)) __obj.updateDynamic("includeDefaultStyles")(includeDefaultStyles.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(scrollDisabled)) __obj.updateDynamic("scrollDisabled")(scrollDisabled.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(underlayClickExits)) __obj.updateDynamic("underlayClickExits")(underlayClickExits.get.asInstanceOf[js.Any])
    if (underlayColor != null) __obj.updateDynamic("underlayColor")(underlayColor.asInstanceOf[js.Any])
    if (underlayStyle != null) __obj.updateDynamic("underlayStyle")(underlayStyle.asInstanceOf[js.Any])
    if (!js.isUndefined(verticallyCenter)) __obj.updateDynamic("verticallyCenter")(verticallyCenter.get.asInstanceOf[js.Any])
