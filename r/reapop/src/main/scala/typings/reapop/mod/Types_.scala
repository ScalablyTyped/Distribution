...
trait Types_ extends js.Object {
  var ADD_NOTIFICATION: typings.reapop.mod.ADD_NOTIFICATION
  var REMOVE_NOTIFICATION: typings.reapop.mod.REMOVE_NOTIFICATION
  var REMOVE_NOTIFICATIONS: typings.reapop.mod.REMOVE_NOTIFICATIONS
  var UPDATE_NOTIFICATION: typings.reapop.mod.UPDATE_NOTIFICATION
}
