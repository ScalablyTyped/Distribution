package typings.reapop.reapopNotificationsContextMod
...
@js.native
trait NotificationsContext extends js.Object {
...
object NotificationsContext {
  ...
  @scala.inline
  implicit class NotificationsContextOps[Self <: NotificationsContext] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNotify(value: NewNotification => Unit): Self = this.set("notify", js.Any.fromFunction1(value))
  }
}
