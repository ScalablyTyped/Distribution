...
object mod {
  ...
  /* Inlined {  initialFocusRef :react.react.RefObject<std.HTMLElement> | undefined} & @reach/dialog.@reach/dialog.DialogProps */
  @js.native
  trait DialogOverlayProps extends StObject {
    ...
    var initialFocusRef: js.UndefOr[RefObject[HTMLElement]] = js.native
  ...
  object DialogOverlayProps {
    ...
    @scala.inline
    def apply(): DialogOverlayProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DialogOverlayProps]
    }
    
    @scala.inline
    implicit class DialogOverlayPropsMutableBuilder[Self <: DialogOverlayProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setInitialFocusRef(value: RefObject[HTMLElement]): Self = StObject.set(x, "initialFocusRef", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setInitialFocusRefUndefined: Self = StObject.set(x, "initialFocusRef", js.undefined)
