package typings.reactImage.imgMod
...
object ImgProps {
  ...
  implicit class ImgPropsOps[Self <: ImgProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContainer(value: /* children */ ReactNode => Element): Self = this.set("container", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setLoader(value: Element): Self = this.set("loader", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLoaderContainer(value: /* children */ ReactNode => Element): Self = this.set("loaderContainer", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setUnloader(value: Element): Self = this.set("unloader", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUnloaderContainer(value: /* children */ ReactNode => Element): Self = this.set("unloaderContainer", js.Any.fromFunction1(value))
