...
object imgMod {
  ...
  trait ImgProps extends StObject {
    ...
    var loaderContainer: js.UndefOr[js.Function1[/* children */ ReactNode, Element]] = js.undefined
    ...
    var unloaderContainer: js.UndefOr[js.Function1[/* children */ ReactNode, Element]] = js.undefined
  ...
  object ImgProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ImgProps] (val x: Self) extends AnyVal {
      ...
      inline def setContainer(value: /* children */ ReactNode => Element): Self = StObject.set(x, "container", js.Any.fromFunction1(value))
      ...
      inline def setLoader(value: Element): Self = StObject.set(x, "loader", value.asInstanceOf[js.Any])
      
      inline def setLoaderContainer(value: /* children */ ReactNode => Element): Self = StObject.set(x, "loaderContainer", js.Any.fromFunction1(value))
      ...
      inline def setOnBlur(value: FocusEvent[HTMLImageElement, typings.std.Element] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      inline def setOnFocus(value: FocusEvent[HTMLImageElement, typings.std.Element] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
      ...
      inline def setRefFunction1(value: /* instance */ HTMLImageElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
      ...
      inline def setUnloader(value: Element): Self = StObject.set(x, "unloader", value.asInstanceOf[js.Any])
      
      inline def setUnloaderContainer(value: /* children */ ReactNode => Element): Self = StObject.set(x, "unloaderContainer", js.Any.fromFunction1(value))
