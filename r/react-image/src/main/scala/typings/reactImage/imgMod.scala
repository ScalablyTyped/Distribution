...
import typings.reactImage.reactImageStrings._empty
import typings.reactImage.reactImageStrings.`additions removals`
import typings.reactImage.reactImageStrings.`additions text`
import typings.reactImage.reactImageStrings.`inline`
import typings.reactImage.reactImageStrings.`lazy`
import typings.reactImage.reactImageStrings.`removals additions`
import typings.reactImage.reactImageStrings.`removals text`
import typings.reactImage.reactImageStrings.`text additions`
import typings.reactImage.reactImageStrings.`text removals`
import typings.reactImage.reactImageStrings.`use-credentials`
import typings.reactImage.reactImageStrings.additions
import typings.reactImage.reactImageStrings.all
import typings.reactImage.reactImageStrings.anonymous
import typings.reactImage.reactImageStrings.ascending
import typings.reactImage.reactImageStrings.assertive
import typings.reactImage.reactImageStrings.async
import typings.reactImage.reactImageStrings.auto
import typings.reactImage.reactImageStrings.both
import typings.reactImage.reactImageStrings.copy
import typings.reactImage.reactImageStrings.date
import typings.reactImage.reactImageStrings.decimal
import typings.reactImage.reactImageStrings.descending
import typings.reactImage.reactImageStrings.dialog
import typings.reactImage.reactImageStrings.eager
import typings.reactImage.reactImageStrings.email
import typings.reactImage.reactImageStrings.execute
import typings.reactImage.reactImageStrings.grammar
import typings.reactImage.reactImageStrings.grid
import typings.reactImage.reactImageStrings.horizontal
import typings.reactImage.reactImageStrings.inherit
import typings.reactImage.reactImageStrings.link
import typings.reactImage.reactImageStrings.list
import typings.reactImage.reactImageStrings.listbox
import typings.reactImage.reactImageStrings.location
import typings.reactImage.reactImageStrings.menu
import typings.reactImage.reactImageStrings.mixed
import typings.reactImage.reactImageStrings.move
import typings.reactImage.reactImageStrings.no
import typings.reactImage.reactImageStrings.none
import typings.reactImage.reactImageStrings.numeric
import typings.reactImage.reactImageStrings.off
import typings.reactImage.reactImageStrings.on
import typings.reactImage.reactImageStrings.other
import typings.reactImage.reactImageStrings.page
import typings.reactImage.reactImageStrings.polite
import typings.reactImage.reactImageStrings.popup
import typings.reactImage.reactImageStrings.removals
import typings.reactImage.reactImageStrings.search
import typings.reactImage.reactImageStrings.spelling
import typings.reactImage.reactImageStrings.step
import typings.reactImage.reactImageStrings.sync
import typings.reactImage.reactImageStrings.tel
import typings.reactImage.reactImageStrings.text
import typings.reactImage.reactImageStrings.time
import typings.reactImage.reactImageStrings.tree
import typings.reactImage.reactImageStrings.url
import typings.reactImage.reactImageStrings.vertical
import typings.reactImage.reactImageStrings.yes
...
object imgMod {
  ...
  @JSImport("react-image/Img", JSImport.Default)
  @js.native
  def default(
    hasDecodeSrcLoaderUnloaderContainerLoaderContainerUnloaderContainerImgPromiseCrossoriginUseSuspenseImgProps: ImgProps
  ...
  trait ImgProps extends StObject {
    ...
    var container: js.UndefOr[js.Function1[/* children */ ReactNode, Element]] = js.native
    ...
    var loader: js.UndefOr[Element | Null] = js.native
    
    var loaderContainer: js.UndefOr[js.Function1[/* children */ ReactNode, Element]] = js.native
    ...
    var unloader: js.UndefOr[Element | Null] = js.native
    
    var unloaderContainer: js.UndefOr[js.Function1[/* children */ ReactNode, Element]] = js.native
  ...
  object ImgProps {
    ...
    implicit class ImgPropsMutableBuilder[Self <: ImgProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContainer(value: /* children */ ReactNode => Element): Self = StObject.set(x, "container", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setLoader(value: Element): Self = StObject.set(x, "loader", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLoaderContainer(value: /* children */ ReactNode => Element): Self = StObject.set(x, "loaderContainer", js.Any.fromFunction1(value))
      
      @scala.inline
      def setLoaderContainerUndefined: Self = StObject.set(x, "loaderContainer", js.undefined)
      ...
      @scala.inline
      def setRef(value: LegacyRef[HTMLImageElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRefFunction1(value: /* instance */ HTMLImageElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setUnloader(value: Element): Self = StObject.set(x, "unloader", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUnloaderContainer(value: /* children */ ReactNode => Element): Self = StObject.set(x, "unloaderContainer", js.Any.fromFunction1(value))
      
      @scala.inline
      def setUnloaderContainerUndefined: Self = StObject.set(x, "unloaderContainer", js.undefined)
      
      @scala.inline
      def setUnloaderNull: Self = StObject.set(x, "unloader", null)
      
      @scala.inline
      def setUnloaderUndefined: Self = StObject.set(x, "unloader", js.undefined)
