...
object ModuleInfo {
  ...
  extension [Self <: ModuleInfo](x: Self) {
    ...
    inline def setDynamicImportersVarargs(value: String*): Self = StObject.set(x, "dynamicImporters", js.Array(value :_*))
    ...
    inline def setDynamicallyImportedIdsVarargs(value: String*): Self = StObject.set(x, "dynamicallyImportedIds", js.Array(value :_*))
    ...
    inline def setImportedIdsVarargs(value: String*): Self = StObject.set(x, "importedIds", js.Array(value :_*))
    
    inline def setImporters(value: js.Array[String]): Self = StObject.set(x, "importers", value.asInstanceOf[js.Any])
    
    inline def setImportersVarargs(value: String*): Self = StObject.set(x, "importers", js.Array(value :_*))
