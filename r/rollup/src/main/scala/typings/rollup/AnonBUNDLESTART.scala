...
trait AnonBUNDLESTART extends RollupWatcherEvent {
  var code: BUNDLE_START
  var input: InputOption
  var output: js.Array[String]
}

object AnonBUNDLESTART {
  @scala.inline
  def apply(code: BUNDLE_START, input: InputOption, output: js.Array[String]): AnonBUNDLESTART = {
    ...
    __obj.asInstanceOf[AnonBUNDLESTART]
  }
}
