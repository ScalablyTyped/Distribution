...
version := "0.3-dt-20211202Z-66e14a"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-auth" % "5.0-dt-20211202Z-cd8e0a",
  "org.scalablytyped" %%% "sc-broker" % "8.0-dt-20211202Z-aa0a6f",
  "org.scalablytyped" %%% "sc-broker-cluster" % "9.0-dt-20211202Z-73a486",
  "org.scalablytyped" %%% "sc-channel" % "2.0-dt-20211202Z-982202",
  "org.scalablytyped" %%% "sc-errors" % "1.4-dt-20211202Z-7a6ac9",
  "org.scalablytyped" %%% "socketcluster" % "14.0-dt-20211202Z-036838",
