...
version := "0.3-dt-20211202Z-a1fc40"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-auth" % "5.0-dt-20211202Z-ff1e6c",
  "org.scalablytyped" %%% "sc-broker" % "8.0-dt-20211202Z-bd27bd",
  "org.scalablytyped" %%% "sc-broker-cluster" % "9.0-dt-20211202Z-b587c2",
  "org.scalablytyped" %%% "sc-channel" % "2.0-dt-20211202Z-05f9ab",
  "org.scalablytyped" %%% "sc-errors" % "1.4-dt-20211202Z-f264e4",
  "org.scalablytyped" %%% "socketcluster" % "14.0-dt-20211202Z-7280e8",
