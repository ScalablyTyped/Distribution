...
version := "0.3-dt-20211202Z-214ecc"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-auth" % "5.0-dt-20211202Z-9f0d7f",
  "org.scalablytyped" %%% "sc-broker" % "8.0-dt-20211202Z-f3f535",
  "org.scalablytyped" %%% "sc-broker-cluster" % "9.0-dt-20211202Z-4898f4",
  "org.scalablytyped" %%% "sc-channel" % "2.0-dt-20211202Z-fcf6b5",
  "org.scalablytyped" %%% "sc-errors" % "1.4-dt-20211202Z-b05182",
  "org.scalablytyped" %%% "socketcluster" % "14.0-dt-20211202Z-402c44",
