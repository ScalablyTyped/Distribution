...
class Session () extends js.Object {
  ...
  def downloadAllServerChanges(): js.Promise[scala.Unit] = js.native
  def downloadAllServerChanges(timeoutMs: scala.Double): js.Promise[scala.Unit] = js.native
  ...
  def uploadAllLocalChanges(): js.Promise[scala.Unit] = js.native
  def uploadAllLocalChanges(timeoutMs: scala.Double): js.Promise[scala.Unit] = js.native
}
