package typings.rcSteps.stepsMod
...
object StepsProps {
  ...
  implicit class StepsPropsOps[Self <: StepsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSize(value: typings.rcSteps.rcStepsStrings.default | small): Self = this.set("size", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setType(value: typings.rcSteps.rcStepsStrings.default | navigation): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
