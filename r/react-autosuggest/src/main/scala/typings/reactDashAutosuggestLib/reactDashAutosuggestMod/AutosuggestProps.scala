...
trait AutosuggestProps[TSuggestion] extends js.Object {
  /**
    ...
    */
  var alwaysRenderSuggestions: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * Set it to false if you don't want Autosuggest to keep the input focused when suggestions are clicked/tapped.
    */
  var focusInputOnSuggestionClick: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var multiSection: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object AutosuggestProps {
  ...
  def apply[TSuggestion](
    ...
    alwaysRenderSuggestions: js.UndefOr[scala.Boolean] = js.undefined,
    focusInputOnSuggestionClick: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    multiSection: js.UndefOr[scala.Boolean] = js.undefined,
