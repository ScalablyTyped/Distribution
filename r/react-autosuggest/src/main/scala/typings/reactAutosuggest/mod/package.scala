...
/* reason */ typings.reactAutosuggest.mod.ShouldRenderReasons, 
scala.Boolean]
...
type Theme = (typings.std.Record[java.lang.String, java.lang.String | typings.react.mod.CSSProperties]) | typings.reactAutosuggest.anon.PartialRecordThemeKeystri
