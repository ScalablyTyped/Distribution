...
object mod {
  ...
  inline def keyIn(query: Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("keyIn")(query.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def keyIn(query: Any, options: BasicOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("keyIn")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def keyInPause(query: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("keyInPause")(query.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def keyInPause(query: Any, options: BasicOptions): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("keyInPause")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def keyInSelect(items: js.Array[String], query: Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("keyInSelect")(items.asInstanceOf[js.Any], query.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def keyInSelect(items: js.Array[String], query: Any, options: BasicOptions): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("keyInSelect")(items.asInstanceOf[js.Any], query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def keyInYN(query: Any): Boolean | String = ^.asInstanceOf[js.Dynamic].applyDynamic("keyInYN")(query.asInstanceOf[js.Any]).asInstanceOf[Boolean | String]
  inline def keyInYN(query: Any, options: BasicOptions): Boolean | String = (^.asInstanceOf[js.Dynamic].applyDynamic("keyInYN")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean | String]
  ...
  inline def keyInYNStrict(query: Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("keyInYNStrict")(query.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  inline def keyInYNStrict(query: Any, options: BasicOptions): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("keyInYNStrict")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def question(query: Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("question")(query.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def question(query: Any, options: BasicOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("question")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def questionEMail(query: Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("questionEMail")(query.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def questionEMail(query: Any, options: BasicOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("questionEMail")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def questionFloat(query: Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("questionFloat")(query.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def questionFloat(query: Any, options: BasicOptions): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("questionFloat")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def questionInt(query: Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("questionInt")(query.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def questionInt(query: Any, options: BasicOptions): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("questionInt")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def questionNewPassword(query: Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("questionNewPassword")(query.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def questionNewPassword(query: Any, options: BasicOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("questionNewPassword")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def questionPath(query: Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("questionPath")(query.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def questionPath(query: Any, options: BasicOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("questionPath")(query.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def setPrompt(value: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setPrompt")(value.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  trait BasicOptions extends StObject {
    ...
    var confirmMessage: js.UndefOr[Any] = js.undefined
    ...
    var exists: js.UndefOr[Any] = js.undefined
    ...
    var unmatchMessage: js.UndefOr[Any] = js.undefined
  ...
  object BasicOptions {
    ...
    extension [Self <: BasicOptions](x: Self) {
      ...
      inline def setConfirmMessage(value: Any): Self = StObject.set(x, "confirmMessage", value.asInstanceOf[js.Any])
      ...
      inline def setFalseValueVarargs(value: OptionType*): Self = StObject.set(x, "falseValue", js.Array(value*))
      ...
      inline def setLimitVarargs(value: OptionType*): Self = StObject.set(x, "limit", js.Array(value*))
      ...
      inline def setTrueValueVarargs(value: OptionType*): Self = StObject.set(x, "trueValue", js.Array(value*))
      
      inline def setUnmatchMessage(value: Any): Self = StObject.set(x, "unmatchMessage", value.asInstanceOf[js.Any])
  ...
  type OptionType = String | Double | js.RegExp | (js.Function1[/* input */ String, Boolean])
}
