...
import typings.reactCsv.commonPropTypesMod.LabelKeyObject
import typings.reactCsv.commonPropTypesMod.SyncClickHandler
import typings.reactCsv.reactCsvStrings.`additions removals`
import typings.reactCsv.reactCsvStrings.`additions text`
import typings.reactCsv.reactCsvStrings.`inline`
import typings.reactCsv.reactCsvStrings.`removals additions`
import typings.reactCsv.reactCsvStrings.`removals text`
import typings.reactCsv.reactCsvStrings.`text additions`
import typings.reactCsv.reactCsvStrings.`text removals`
...
object LinkProps {
  ...
  @scala.inline
  def apply(data: String | Data): LinkProps = {
