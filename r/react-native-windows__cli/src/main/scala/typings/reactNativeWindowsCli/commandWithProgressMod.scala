...
object commandWithProgressMod {
  ...
  inline def newError(text: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("newError")(text.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def newInfo(text: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("newInfo")(text.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def newSpinner(text: String): Ora = ^.asInstanceOf[js.Dynamic].applyDynamic("newSpinner")(text.asInstanceOf[js.Any]).asInstanceOf[Ora]
  
  inline def newSuccess(text: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("newSuccess")(text.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def newWarn(text: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("newWarn")(text.asInstanceOf[js.Any]).asInstanceOf[Unit]
