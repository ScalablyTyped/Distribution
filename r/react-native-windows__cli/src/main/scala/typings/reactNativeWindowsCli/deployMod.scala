...
object deployMod {
  ...
  inline def deployToDevice(options: RunWindowsOptions_, verbose: Boolean): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("deployToDevice")(options.asInstanceOf[js.Any], verbose.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  
  inline def getBuildConfiguration(options: RunWindowsOptions_): BuildConfig = ^.asInstanceOf[js.Dynamic].applyDynamic("getBuildConfiguration")(options.asInstanceOf[js.Any]).asInstanceOf[BuildConfig]
  
  inline def startServerInNewWindow(options: RunWindowsOptions_, verbose: Boolean): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("startServerInNewWindow")(options.asInstanceOf[js.Any], verbose.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
}
