...
object mod {
  ...
  object default {
    ...
    object defaultProps {
      ...
      @scala.inline
      def overflowedIndicator_=(x: Element): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("overflowedIndicator")(x.asInstanceOf[js.Any])
    ...
    /* static member */
    @scala.inline
    def getDerivedStateFromProps(nextProps: MenuProps, prevState: MenuState): PartialMenuState = (^.asInstanceOf[js.Dynamic].applyDynamic("getDerivedStateFromProps")(nextProps.asInstanceOf[js.Any], prevState.asInstanceOf[js.Any])).asInstanceOf[PartialMenuState]
  }
