...
object interfaceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.rcMenu.interfaceMod.SubMenuType
    - typings.rcMenu.interfaceMod.MenuItemType
    - typings.rcMenu.interfaceMod.MenuItemGroupType
    - typings.rcMenu.interfaceMod.MenuDividerType
    - scala.Null
  */
  ...
  */
  ...
  object _ItemType {
    ...
    inline def MenuDividerType(): typings.rcMenu.interfaceMod.MenuDividerType = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("divider")
      __obj.asInstanceOf[typings.rcMenu.interfaceMod.MenuDividerType]
    }
    
    inline def MenuItemGroupType(): typings.rcMenu.interfaceMod.MenuItemGroupType = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("group")
      __obj.asInstanceOf[typings.rcMenu.interfaceMod.MenuItemGroupType]
    }
    
    inline def MenuItemType(key: Key): typings.rcMenu.interfaceMod.MenuItemType = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.rcMenu.interfaceMod.MenuItemType]
    }
    
    inline def SubMenuType(children: js.Array[ItemType], key: String): typings.rcMenu.interfaceMod.SubMenuType = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.rcMenu.interfaceMod.SubMenuType]
    }
  }
}
