...
trait PartialSubPopupMenuProps extends js.Object {
  ...
  var builtinPlacements: js.UndefOr[typings.rcMenu.interfaceMod.BuiltinPlacements] = js.undefined
...
object PartialSubPopupMenuProps {
  ...
  def apply(
    ...
    builtinPlacements: typings.rcMenu.interfaceMod.BuiltinPlacements = null,
    ...
    onDestroy: /* key */ typings.react.mod.Key => Unit = null,
    onOpenChange: /* keys */ js.Array[typings.react.mod.Key] | Open => Unit = null,
