...
object PartialkeyinMenuModeother {
  ...
  extension [Self <: PartialkeyinMenuModeother](x: Self) {
    ...
    inline def `setVertical-left`(value: CSSMotionProps): Self = StObject.set(x, "vertical-left", value.asInstanceOf[js.Any])
    
    inline def `setVertical-leftUndefined`: Self = StObject.set(x, "vertical-left", js.undefined)
    
    inline def `setVertical-right`(value: CSSMotionProps): Self = StObject.set(x, "vertical-right", value.asInstanceOf[js.Any])
    
    inline def `setVertical-rightUndefined`: Self = StObject.set(x, "vertical-right", js.undefined)
