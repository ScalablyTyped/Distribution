...
object ReactElementisRootMenuboo {
  ...
  inline def apply(isRootMenu: Boolean, props: js.Any, subMenuInstance: ReactInstance, `type`: js.Any): ReactElementisRootMenuboo = {
  ...
  extension [Self <: ReactElementisRootMenuboo](x: Self) {
    
    inline def setIsRootMenu(value: Boolean): Self = StObject.set(x, "isRootMenu", value.asInstanceOf[js.Any])
    ...
    inline def setSubMenuInstance(value: ReactInstance): Self = StObject.set(x, "subMenuInstance", value.asInstanceOf[js.Any])
