...
object menuItemMod {
  ...
  object MenuItem {
    ...
    @scala.inline
    def defaultProps_=(x: ManualRef): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
    
    @JSImport("rc-menu/es/MenuItem", "MenuItem.isMenuItem")
    @js.native
    def isMenuItem: Boolean = js.native
    @scala.inline
    def isMenuItem_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("isMenuItem")(x.asInstanceOf[js.Any])
  }
