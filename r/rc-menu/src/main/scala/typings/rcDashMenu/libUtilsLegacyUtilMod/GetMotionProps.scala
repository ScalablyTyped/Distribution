package typings.rcDashMenu.libUtilsLegacyUtilMod

import typings.rcDashMenu.libInterfaceMod.AnimationType
import typings.rcDashMenu.libInterfaceMod.MotionType
import typings.rcDashMenu.libInterfaceMod.TransitionNameType
