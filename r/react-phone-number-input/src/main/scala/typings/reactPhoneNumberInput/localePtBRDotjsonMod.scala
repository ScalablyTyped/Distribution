...
object localePtBRDotjsonMod extends Shortcut {
  
  @JSImport("react-phone-number-input/locale/pt-BR.json", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localePtBRDotjsonMod.foo` */
