...
object localeViDotjsonMod extends Shortcut {
  
  @JSImport("react-phone-number-input/locale/vi.json", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localeViDotjsonMod.foo` */
