...
object localeNlDotjsonMod extends Shortcut {
  
  @JSImport("react-phone-number-input/locale/nl.json", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localeNlDotjsonMod.foo` */
