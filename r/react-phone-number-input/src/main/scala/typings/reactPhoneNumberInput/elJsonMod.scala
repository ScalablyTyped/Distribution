...
object elJsonMod extends Shortcut {
  
  @JSImport("react-phone-number-input/locale/el.json", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `elJsonMod.foo` */
