...
object plJsonMod extends Shortcut {
  
  @JSImport("react-phone-number-input/locale/pl.json", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `plJsonMod.foo` */
