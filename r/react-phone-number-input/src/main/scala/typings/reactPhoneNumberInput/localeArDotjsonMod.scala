...
object localeArDotjsonMod extends Shortcut {
  
  @JSImport("react-phone-number-input/locale/ar.json", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localeArDotjsonMod.foo` */
