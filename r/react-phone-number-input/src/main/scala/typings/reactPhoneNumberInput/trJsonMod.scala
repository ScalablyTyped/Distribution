...
object trJsonMod extends Shortcut {
  
  @JSImport("react-phone-number-input/locale/tr.json", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `trJsonMod.foo` */
