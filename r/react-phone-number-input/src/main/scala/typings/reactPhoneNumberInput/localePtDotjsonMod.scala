...
object localePtDotjsonMod extends Shortcut {
  
  @JSImport("react-phone-number-input/locale/pt.json", JSImport.Default)
  @js.native
  val default: Locale = js.native
  
  /* Inlined {[ key in react-phone-number-input.react-phone-number-input.LabelKey ]: string} */
  ...
  /* This means you don't have to write `default`, but can instead just say `localePtDotjsonMod.foo` */
