...
object localeJaDotjsonMod extends Shortcut {
  
  @JSImport("react-phone-number-input/locale/ja.json", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localeJaDotjsonMod.foo` */
