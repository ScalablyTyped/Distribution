...
object HelmetTags {
  ...
  implicit class HelmetTagsOps[Self <: HelmetTags] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOpenedVisorTagsVarargs(value: js.Any*): Self = this.set("openedVisorTags", js.Array(value :_*))
    
    @scala.inline
    def setOpenedVisorTags(value: js.Array[_]): Self = this.set("openedVisorTags", value.asInstanceOf[js.Any])
