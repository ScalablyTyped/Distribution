...
object revealJsStrings {
  ...
  @js.native
  sealed trait cSlasht extends StObject
  ...
  @js.native
  sealed trait concave extends StObject
  inline def concave: concave = "concave".asInstanceOf[concave]
  ...
  @js.native
  sealed trait faded extends StObject
  inline def faded: faded = "faded".asInstanceOf[faded]
  ...
  @js.native
  sealed trait hDotv extends StObject
  inline def hDotv: hDotv = "h.v".asInstanceOf[hDotv]
  
  @js.native
  sealed trait hSlashv extends StObject
  inline def hSlashv: hSlashv = "h/v".asInstanceOf[hSlashv]
  ...
  @js.native
  sealed trait `letter-spacing` extends StObject
  ...
  @js.native
  sealed trait `outline-offset` extends StObject
  ...
  @js.native
  sealed trait speaker extends StObject
