...
import typings.atReachAlertDashDialog.Anon_Children
import typings.atReachAlertDashDialog.Anon_ChildrenReactNode
...
package object atReachAlertDashDialogMod {
