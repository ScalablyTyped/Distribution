...
object TreeProps {
  ...
  def apply(
    ...
    if (childrenClassName != null) __obj.updateDynamic("childrenClassName")(childrenClassName.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(defaultCollapsed)) __obj.updateDynamic("defaultCollapsed")(defaultCollapsed.asInstanceOf[js.Any])
    ...
    if (nodeLabel != null) __obj.updateDynamic("nodeLabel")(nodeLabel.asInstanceOf[js.Any])
    ...
    if (treeViewClassName != null) __obj.updateDynamic("treeViewClassName")(treeViewClassName.asInstanceOf[js.Any])
