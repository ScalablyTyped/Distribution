...
trait VirtualTimeScheduler[TAbsolute, TRelative] extends IScheduler {
  ...
  def scheduleAbsoluteWithState[TState](
    state: TState,
    dueTime: TAbsolute,
    action: js.Function2[/* scheduler */ typings.rxDashCore.RxNs.IScheduler, /* state */ TState, IDisposable]
  ): IDisposable
...
object VirtualTimeScheduler {
  ...
  def apply[TAbsolute, TRelative](
    ...
    scheduleAbsoluteWithState: (js.Any, TAbsolute, js.Function2[/* scheduler */ typings.rxDashCore.RxNs.IScheduler, js.Any, IDisposable]) => IDisposable,
    ...
    scheduleRelativeWithState: (js.Any, TRelative, js.Function2[/* scheduler */ typings.rxDashCore.RxNs.IScheduler, js.Any, IDisposable]) => IDisposable,
