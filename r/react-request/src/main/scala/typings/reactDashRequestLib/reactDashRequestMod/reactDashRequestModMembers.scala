...
object reactDashRequestModMembers extends js.Object {
  ...
  def fetchDedupe(input: js.Any): stdLib.Promise[ProxyRequest] = js.native
  def fetchDedupe(input: js.Any, init: js.Any): stdLib.Promise[ProxyRequest] = js.native
  def fetchDedupe(input: js.Any, init: js.Any, dedupeOptions: js.Any): stdLib.Promise[ProxyRequest] = js.native
