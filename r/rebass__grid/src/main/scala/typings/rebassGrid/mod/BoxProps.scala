...
/* Inlined parent styled-system.styled-system.WidthProps<styled-system.styled-system.RequiredTheme, csstype.csstype.WidthProperty<styled-system.styled-system.TLengthStyledSystem>> */
...
/* Inlined parent styled-system.styled-system.FlexProps<styled-system.styled-system.RequiredTheme, csstype.csstype.FlexProperty<styled-system.styled-system.TLengthStyledSystem>> */
...
object BoxProps {
  ...
  def apply(
    ...
    p: js.UndefOr[Null | (ResponsiveValue[ThemeValue[space, RequiredTheme, _], RequiredTheme])] = js.undefined,
    padding: js.UndefOr[Null | (ResponsiveValue[ThemeValue[space, RequiredTheme, _], RequiredTheme])] = js.undefined,
    paddingBottom: js.UndefOr[Null | (ResponsiveValue[ThemeValue[space, RequiredTheme, _], RequiredTheme])] = js.undefined,
    paddingLeft: js.UndefOr[Null | (ResponsiveValue[ThemeValue[space, RequiredTheme, _], RequiredTheme])] = js.undefined,
    paddingRight: js.UndefOr[Null | (ResponsiveValue[ThemeValue[space, RequiredTheme, _], RequiredTheme])] = js.undefined,
    paddingTop: js.UndefOr[Null | (ResponsiveValue[ThemeValue[space, RequiredTheme, _], RequiredTheme])] = js.undefined,
    paddingX: js.UndefOr[Null | (ResponsiveValue[ThemeValue[space, RequiredTheme, _], RequiredTheme])] = js.undefined
  ): BoxProps = {
