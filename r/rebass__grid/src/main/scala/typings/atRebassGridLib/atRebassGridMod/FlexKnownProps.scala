...
trait FlexKnownProps
  extends BoxKnownProps
     with styledDashSystemLib.styledDashSystemMod.FlexWrapProps
     with styledDashSystemLib.styledDashSystemMod.FlexDirectionProps
     with styledDashSystemLib.styledDashSystemMod.AlignItemsProps
     with styledDashSystemLib.styledDashSystemMod.JustifyContentProps
...
object FlexKnownProps {
  ...
  def apply(
    ...
    as: reactLib.reactMod.ReactNs.ElementType[_] = null,
    ...
    flexDirection: styledDashSystemLib.styledDashSystemMod.ResponsiveValue[csstypeLib.csstypeMod.FlexDirectionProperty] = null,
    flexWrap: styledDashSystemLib.styledDashSystemMod.ResponsiveValue[csstypeLib.csstypeMod.FlexWrapProperty] = null,
