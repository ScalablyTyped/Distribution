...
- Dropped {[ P in std.Exclude<keyof react.react.React.HTMLProps<std.HTMLDivElement>, keyof @rebass/grid.@rebass/grid.FlexKnownProps> ]: react.react.React.HTMLProps<std.HTMLDivElement>[P]} */ trait FlexProps extends FlexKnownProps
