...
import typings.reachTabs.reachTabsStrings.`additions removals`
import typings.reachTabs.reachTabsStrings.`additions text`
import typings.reachTabs.reachTabsStrings.`inline`
import typings.reachTabs.reachTabsStrings.`removals additions`
import typings.reachTabs.reachTabsStrings.`removals text`
import typings.reachTabs.reachTabsStrings.`text additions`
import typings.reachTabs.reachTabsStrings.`text removals`
...
object TabsProps {
  ...
  implicit class TabsPropsOps[Self <: TabsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnChange(value: /* index */ Double => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
