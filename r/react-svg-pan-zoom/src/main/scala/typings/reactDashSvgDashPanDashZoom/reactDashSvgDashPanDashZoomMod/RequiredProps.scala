...
object RequiredProps {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(height = height, onChangeTool = js.Any.fromFunction1(onChangeTool), onChangeValue = js.Any.fromFunction1(onChangeValue), tool = tool, width = width)
