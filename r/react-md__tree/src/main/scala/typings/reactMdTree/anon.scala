...
object anon {
  ...
  object ChildItems {
    ...
    inline def apply(): ChildItems = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ChildItems]
    }
    
    extension [Self <: ChildItems](x: Self) {
      
      inline def setChildItems(
        value: js.Array[
              /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias @react-md/tree.@react-md/tree/types/useNestedTreeList.NestedTreeItem<T> */ js.Object
            ]
      ...
      inline def setChildItemsVarargs(
  ...
  object NestedTreeItemUnknownTree {
    ...
    extension [Self <: NestedTreeItemUnknownTree](x: Self) {
      ...
      inline def setChildItemsVarargs(value: NestedTreeItem[UnknownTreeItem]*): Self = StObject.set(x, "childItems", js.Array(value :_*))
