...
object TreeProps {
  @scala.inline
  def apply[/* <: typings.reactMdTree.typesMod.BaseTreeItem */ T](
    data: TreeData[T],
  ...
  @scala.inline
  implicit class TreePropsOps[Self <: TreeProps[_], /* <: typings.reactMdTree.typesMod.BaseTreeItem */ T] (val x: Self with TreeProps[T]) extends AnyVal {
    @scala.inline
