...
object treeGroupMod {
  ...
  /* Inlined parent std.Omit<@react-md/transition.@react-md/transition.CollapseProps<@react-md/list.@react-md/list.ListElement>, 'children'> */
  ...
  object TreeGroupProps {
    ...
    extension [Self <: TreeGroupProps](x: Self) {
      ...
      inline def setNodeRef(value: Ref[ListElement]): Self = StObject.set(x, "nodeRef", value.asInstanceOf[js.Any])
      
      inline def setNodeRefFunction1(value: /* instance */ ListElement | Null => Unit): Self = StObject.set(x, "nodeRef", js.Any.fromFunction1(value))
