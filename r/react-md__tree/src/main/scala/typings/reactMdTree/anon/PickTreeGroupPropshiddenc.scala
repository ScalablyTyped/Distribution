...
object PickTreeGroupPropshiddenc {
  @scala.inline
  def apply(collapsed: Boolean): PickTreeGroupPropshiddenc = {
    val __obj = js.Dynamic.literal(collapsed = collapsed.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickTreeGroupPropshiddenc]
  }
  @scala.inline
  implicit class PickTreeGroupPropshiddencOps[Self <: PickTreeGroupPropshiddenc] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: FormEvent[ListElement] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setRefFunction1(value: /* instance */ ListElement | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    @scala.inline
    def setRef(value: Ref[ListElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
    @scala.inline
