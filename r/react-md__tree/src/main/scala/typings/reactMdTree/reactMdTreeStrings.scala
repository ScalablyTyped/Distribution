...
object reactMdTreeStrings {
  ...
  sealed trait itemIndex
    extends StObject
       with TreeItemKeys
  inline def itemIndex: itemIndex = "itemIndex".asInstanceOf[itemIndex]
  ...
  sealed trait listSize
    extends StObject
       with TreeItemKeys
  inline def listSize: listSize = "listSize".asInstanceOf[listSize]
  ...
  sealed trait renderChildItems
    extends StObject
       with TreeItemKeys
  inline def renderChildItems: renderChildItems = "renderChildItems".asInstanceOf[renderChildItems]
