...
import typings.commonmarkReactRenderer.mod.CodeBlockProps
import typings.commonmarkReactRenderer.mod.CodeProps
import typings.commonmarkReactRenderer.mod.CommonProps
import typings.commonmarkReactRenderer.mod.HeadingProps
import typings.commonmarkReactRenderer.mod.HtmlInlineBlockProps
import typings.commonmarkReactRenderer.mod.ImageProps
import typings.commonmarkReactRenderer.mod.LinkProps
import typings.commonmarkReactRenderer.mod.ListProps
import typings.commonmarkReactRenderer.mod.SoftBreakProps
...
object anon {
  ...
  /* Inlined std.Partial<react-markings.react-markings.Renderers> */
