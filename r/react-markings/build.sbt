...
name := "react-markings"
version := "1.3-dt-20211202Z-39cc85"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "commonmark" % "0.27-dt-20211202Z-1d724d",
  "org.scalablytyped" %%% "commonmark-react-renderer" % "4.3-dt-20211202Z-531a5d",
