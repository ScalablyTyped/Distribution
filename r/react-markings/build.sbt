...
name := "react-markings"
version := "1.3-dt-20211202Z-593a20"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "commonmark" % "0.27-dt-20211202Z-ef5c15",
  "org.scalablytyped" %%% "commonmark-react-renderer" % "4.3-dt-20211202Z-4076ff",
