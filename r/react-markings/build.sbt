...
name := "react-markings"
version := "1.3-dt-20211202Z-f08b10"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "commonmark" % "0.27-dt-20230325Z-d237f8",
  "org.scalablytyped" %%% "commonmark-react-renderer" % "4.3-dt-20211202Z-336cc8",
