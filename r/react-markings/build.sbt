...
name := "react-markings"
version := "1.3-dt-20211202Z-ce49ea"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "commonmark" % "0.27-dt-20211202Z-45e6b7",
  "org.scalablytyped" %%% "commonmark-react-renderer" % "4.3-dt-20211202Z-2b89c8",
