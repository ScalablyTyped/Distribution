...
object commonMod {
  ...
  inline def useTransitionDuration(percentList: js.Array[Double]): js.Array[js.Array[MutableRefObject[Unit]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("useTransitionDuration")(percentList.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Array[MutableRefObject[Unit]]]]
}
