...
import typings.reactTether.reactTetherStrings.string
...
object anon {
  ...
  trait ElementComponent extends StObject {
    ...
    var elementComponent: (Unit & ReactElement) | Null
    
    var targetComponent: (Unit & ReactElement) | Null
  }
  object ElementComponent {
    ...
    implicit open class MutableBuilder[Self <: ElementComponent] (val x: Self) extends AnyVal {
      ...
      inline def setTargetComponent(value: Unit & ReactElement): Self = StObject.set(x, "targetComponent", value.asInstanceOf[js.Any])
