...
trait Anon_DisableGlob extends js.Object {
  ...
  var glob: js.UndefOr[
    globLib.globMod.IOptions | rmfrLib.rmfrLibNumbers.`false` | rmfrLib.rmfrLibNumbers.`true`
  ] = js.undefined
}
...
object Anon_DisableGlob {
  ...
  def apply(
    ...
    glob: globLib.globMod.IOptions | rmfrLib.rmfrLibNumbers.`false` | rmfrLib.rmfrLibNumbers.`true` = null
  ): Anon_DisableGlob = {
