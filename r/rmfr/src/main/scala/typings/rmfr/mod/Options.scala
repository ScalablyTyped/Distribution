...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDisableGlob(value: js.UndefOr[Boolean] with js.UndefOr[scala.Nothing]): Self = this.set("disableGlob", value.asInstanceOf[js.Any])
    @scala.inline
    def setGlob(value: (js.UndefOr[IOptions | `false`]) with (js.UndefOr[IOptions | `false` | `true`])): Self = this.set("glob", value.asInstanceOf[js.Any])
    @scala.inline
