...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fbemitter" % "2.0.0-dt-20180315Z-c9f1aa",
  "org.scalablytyped" %%% "flux" % "3.1-dt-20180803Z-de3ba3",
  ...
  "org.scalablytyped" %%% "react-textarea-autosize" % "4.3.0-dt-20180806Z-1f3111",
