...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fbemitter" % "2.0.0-dt-20180315Z-c90332",
  "org.scalablytyped" %%% "flux" % "3.1-dt-20180803Z-55a3eb",
  ...
  "org.scalablytyped" %%% "react-textarea-autosize" % "4.3.0-dt-20180806Z-58d3cb",
