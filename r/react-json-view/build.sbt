...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fbemitter" % "2.0.0-dt-20180315Z-704d3a",
  "org.scalablytyped" %%% "flux" % "3.1-dt-20180803Z-59e763",
  ...
  "org.scalablytyped" %%% "react-textarea-autosize" % "4.3.0-dt-20180806Z-182efa",
