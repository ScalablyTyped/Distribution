...
object anon {
  ...
  object Data {
    ...
    inline def apply[T](data: js.Array[T], headers: typings.restfulJs.mod.Headers, status: Double, statusText: String): Data[T] = {
  ...
  object Headers {
    ...
    inline def apply[T](data: T, headers: typings.restfulJs.mod.Headers, status: Double, statusText: String): Headers[T] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], headers = headers.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], statusText = statusText.asInstanceOf[js.Any])
