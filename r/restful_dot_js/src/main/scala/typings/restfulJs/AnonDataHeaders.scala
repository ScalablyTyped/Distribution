...
trait AnonDataHeaders[T] extends js.Object {
  var data: js.Array[T]
  var headers: Headers
  var status: Double
...
object AnonDataHeaders {
  @scala.inline
  def apply[T](data: js.Array[T], headers: Headers, status: Double, statusText: String): AnonDataHeaders[T] = {
    ...
    __obj.asInstanceOf[AnonDataHeaders[T]]
  }
}
