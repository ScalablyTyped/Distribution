...
object libTypescriptUtilsMod {
  
  @JSImport("react-native-screens/lib/typescript/utils", JSImport.Namespace)
  @js.native
  ...
  @JSImport("react-native-screens/lib/typescript/utils", "isSearchBarAvailableForCurrentPlatform")
  @js.native
