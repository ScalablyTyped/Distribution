...
/* Inlined react.react.PropsWithChildren<react-native.react-native.ViewProps & {  type :react-native-screens.react-native-screens/lib/typescript/types.HeaderSubviewTypes | undefined}> */
trait PropsWithChildrenViewProp extends StObject {
  ...
  var `type`: js.UndefOr[HeaderSubviewTypes] = js.undefined
}
object PropsWithChildrenViewProp {
  
  inline def apply(): PropsWithChildrenViewProp = {
  ...
  extension [Self <: PropsWithChildrenViewProp](x: Self) {
    ...
    inline def setType(value: HeaderSubviewTypes): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
