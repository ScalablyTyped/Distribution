...
object createNativeStackNavigatorMod {
  ...
  - typings.reactNativeScreens.createNativeStackNavigatorMod.BackButtonProps because var conflicts: headerBackTitleStyle, headerTintColor. Inlined headerBackImage, headerPressColorAndroid, backButtonTitle, truncatedBackButtonTitle, backTitleVisible, layoutPreset */ trait NativeStackNavigationOptions
    extends StObject
       with StackNavigatorOptions
       with typings.reactNativeScreens.typesMod.NativeStackNavigationOptions {
