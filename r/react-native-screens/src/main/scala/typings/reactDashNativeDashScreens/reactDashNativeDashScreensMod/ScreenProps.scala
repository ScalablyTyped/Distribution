package typings.reactDashNativeDashScreens.reactDashNativeDashScreensMod
...
import typings.reactDashNativeDashScreens.reactDashNativeDashScreensNumbers.`0`
import typings.reactDashNativeDashScreens.reactDashNativeDashScreensNumbers.`1`
