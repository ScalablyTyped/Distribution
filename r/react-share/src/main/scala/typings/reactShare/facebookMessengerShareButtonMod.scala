...
object facebookMessengerShareButtonMod extends Shortcut {
  
  @JSImport("react-share/lib/FacebookMessengerShareButton", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[PickPropsOptionsclassNameAbout] = js.native
  ...
  type _To = ForwardRefExoticComponent[PickPropsOptionsclassNameAbout]
  
  /* This means you don't have to write `default`, but can instead just say `facebookMessengerShareButtonMod.foo` */
  override def _to: ForwardRefExoticComponent[PickPropsOptionsclassNameAbout] = default
}
