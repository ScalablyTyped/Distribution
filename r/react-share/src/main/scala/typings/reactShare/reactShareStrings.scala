...
object reactShareStrings {
  ...
  @js.native
  sealed trait forwardedRef extends StObject
  inline def forwardedRef: forwardedRef = "forwardedRef".asInstanceOf[forwardedRef]
  ...
  @js.native
  sealed trait networkLink extends StObject
  inline def networkLink: networkLink = "networkLink".asInstanceOf[networkLink]
  
  @js.native
  sealed trait networkName extends StObject
  inline def networkName: networkName = "networkName".asInstanceOf[networkName]
  ...
  @js.native
  sealed trait opts extends StObject
  inline def opts: opts = "opts".asInstanceOf[opts]
