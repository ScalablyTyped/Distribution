...
object PickPropstitlestringundefAriaatomic {
  
  inline def apply(url: String): PickPropstitlestringundefAriaatomic = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropstitlestringundefAriaatomic]
  }
  
  extension [Self <: PickPropstitlestringundefAriaatomic](x: Self) {
    ...
    inline def setHashtagsVarargs(value: String*): Self = StObject.set(x, "hashtags", js.Array(value*))
