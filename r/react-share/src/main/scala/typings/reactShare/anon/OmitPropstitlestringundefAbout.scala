...
/* Inlined std.Omit<react-share.react-share/lib/ShareButton.Props<{  title :string | undefined,   description :string | undefined}>, 'forwardedRef' | 'networkName' | 'networkLink' | 'opts'> & {  title :string | undefined,   description :string | undefined} & react.react.RefAttributes<std.HTMLButtonElement> */
trait OmitPropstitlestringundefAbout extends StObject {
...
object OmitPropstitlestringundefAbout {
  
  inline def apply(url: String): OmitPropstitlestringundefAbout = {
