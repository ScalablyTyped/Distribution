...
trait PickPropstitlestringundefAbout extends StObject {
...
object PickPropstitlestringundefAbout {
  
  inline def apply(url: String): PickPropstitlestringundefAbout = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropstitlestringundefAbout]
  }
  
  extension [Self <: PickPropstitlestringundefAbout](x: Self) {
