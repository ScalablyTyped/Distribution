...
trait PickPropstitlestringundefAriaactivedescendant extends StObject {
...
object PickPropstitlestringundefAriaactivedescendant {
  
  inline def apply(url: String): PickPropstitlestringundefAriaactivedescendant = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropstitlestringundefAriaactivedescendant]
  }
  
  extension [Self <: PickPropstitlestringundefAriaactivedescendant](x: Self) {
