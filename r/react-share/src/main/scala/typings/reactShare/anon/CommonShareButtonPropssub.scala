...
/* Inlined react-share.react-share.CommonShareButtonProps & {  subject ? :string,   body ? :string,   separator ? :string,   openWindow ? :boolean} */
trait CommonShareButtonPropssub extends js.Object {
  /**
