...
/* Inlined std.Omit<react-share.react-share/lib/ShareButton.Props<react-share.react-share/lib/EmailShareButton.Options>, 'forwardedRef' | 'networkName' | 'networkLink' | 'opts'> & react-share.react-share/lib/EmailShareButton.Options & react.react.RefAttributes<std.HTMLButtonElement> */
trait OmitPropsOptionsforwarded extends StObject {
...
object OmitPropsOptionsforwarded {
  
  inline def apply(url: String): OmitPropsOptionsforwarded = {
