...
object PickSVGPropsSVGSVGElement {
  
  inline def apply(): PickSVGPropsSVGSVGElement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickSVGPropsSVGSVGElement]
  }
  
  extension [Self <: PickSVGPropsSVGSVGElement](x: Self) {
