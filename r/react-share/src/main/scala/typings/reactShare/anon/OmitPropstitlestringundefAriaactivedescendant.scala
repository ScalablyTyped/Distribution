...
import typings.reactShare.libShareButtonMod.WindowPosition
...
object OmitPropstitlestringundefAriaactivedescendant {
  
  inline def apply(url: String): OmitPropstitlestringundefAriaactivedescendant = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[OmitPropstitlestringundefAriaactivedescendant]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPropstitlestringundefAriaactivedescendant] (val x: Self) extends AnyVal {
