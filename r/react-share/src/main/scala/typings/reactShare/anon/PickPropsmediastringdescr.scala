...
object PickPropsmediastringdescr {
  
  inline def apply(media: String, url: String): PickPropsmediastringdescr = {
    val __obj = js.Dynamic.literal(media = media.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropsmediastringdescr]
  }
  
  extension [Self <: PickPropsmediastringdescr](x: Self) {
