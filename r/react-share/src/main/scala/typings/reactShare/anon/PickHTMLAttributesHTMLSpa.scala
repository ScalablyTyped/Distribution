...
object PickHTMLAttributesHTMLSpa {
  
  inline def apply(url: String): PickHTMLAttributesHTMLSpa = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickHTMLAttributesHTMLSpa]
  }
  
  extension [Self <: PickHTMLAttributesHTMLSpa](x: Self) {
