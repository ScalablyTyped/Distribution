...
object PickPropsOptionsclassNameAriaactivedescendant {
  
  inline def apply(url: String): PickPropsOptionsclassNameAriaactivedescendant = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropsOptionsclassNameAriaactivedescendant]
  }
  
  extension [Self <: PickPropsOptionsclassNameAriaactivedescendant](x: Self) {
