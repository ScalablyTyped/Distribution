...
object PickPropsOptionsclassNameAbout {
  
  inline def apply(appId: String, url: String): PickPropsOptionsclassNameAbout = {
    val __obj = js.Dynamic.literal(appId = appId.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropsOptionsclassNameAbout]
  }
  
  extension [Self <: PickPropsOptionsclassNameAbout](x: Self) {
