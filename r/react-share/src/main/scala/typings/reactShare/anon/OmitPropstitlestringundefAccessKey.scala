...
trait OmitPropstitlestringundefAccessKey extends StObject {
...
object OmitPropstitlestringundefAccessKey {
  
  inline def apply(url: String): OmitPropstitlestringundefAccessKey = {
