...
trait PickPropstitlestringundef extends StObject {
...
object PickPropstitlestringundef {
  
  inline def apply(url: String): PickPropstitlestringundef = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropstitlestringundef]
  }
  
  extension [Self <: PickPropstitlestringundef](x: Self) {
