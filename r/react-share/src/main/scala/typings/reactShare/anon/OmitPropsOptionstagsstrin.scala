...
/* Inlined std.Omit<react-share.react-share/lib/ShareButton.Props<react-share.react-share/lib/TumblrShareButton.Options & {  tags :string}>, 'forwardedRef' | 'networkName' | 'networkLink' | 'opts'> & react-share.react-share/lib/TumblrShareButton.Options & {  tags :std.Array<string> | undefined} & react.react.RefAttributes<std.HTMLButtonElement> */
trait OmitPropsOptionstagsstrin extends StObject {
...
object OmitPropsOptionstagsstrin {
  
  inline def apply(url: String): OmitPropsOptionstagsstrin = {
