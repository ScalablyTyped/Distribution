...
object PickPropsOptionstagsstrin {
  
  inline def apply(url: String): PickPropsOptionstagsstrin = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropsOptionstagsstrin]
  }
  
  extension [Self <: PickPropsOptionstagsstrin](x: Self) {
