...
trait PickPropstitlestringundefAccessKey extends StObject {
...
object PickPropstitlestringundefAccessKey {
  
  inline def apply(url: String): PickPropstitlestringundefAccessKey = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropstitlestringundefAccessKey]
  }
  
  extension [Self <: PickPropstitlestringundefAccessKey](x: Self) {
