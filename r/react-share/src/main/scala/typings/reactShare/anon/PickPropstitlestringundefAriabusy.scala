...
trait PickPropstitlestringundefAriabusy extends StObject {
...
object PickPropstitlestringundefAriabusy {
  
  inline def apply(url: String): PickPropstitlestringundefAriabusy = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropstitlestringundefAriabusy]
  }
  
  extension [Self <: PickPropstitlestringundefAriabusy](x: Self) {
