...
trait PickPropstitlestringundefAriaautocomplete extends StObject {
...
object PickPropstitlestringundefAriaautocomplete {
  
  inline def apply(url: String): PickPropstitlestringundefAriaautocomplete = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropstitlestringundefAriaautocomplete]
  }
  
  extension [Self <: PickPropstitlestringundefAriaautocomplete](x: Self) {
