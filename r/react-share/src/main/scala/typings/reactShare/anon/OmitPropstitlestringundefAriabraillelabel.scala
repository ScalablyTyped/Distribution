...
trait OmitPropstitlestringundefAriabraillelabel extends StObject {
...
object OmitPropstitlestringundefAriabraillelabel {
  
  inline def apply(url: String): OmitPropstitlestringundefAriabraillelabel = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[OmitPropstitlestringundefAriabraillelabel]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPropstitlestringundefAriabraillelabel] (val x: Self) extends AnyVal {
