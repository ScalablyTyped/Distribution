...
/* Inlined std.Omit<react-share.react-share/lib/ShareButton.Props<{  title :string | undefined}>, 'forwardedRef' | 'networkName' | 'networkLink' | 'opts'> & {  title :string | undefined} & react.react.RefAttributes<std.HTMLButtonElement> */
trait OmitPropstitlestringundef extends StObject {
...
object OmitPropstitlestringundef {
  
  inline def apply(url: String): OmitPropstitlestringundef = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[OmitPropstitlestringundef]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPropstitlestringundef] (val x: Self) extends AnyVal {
