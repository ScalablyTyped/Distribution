...
object PickPropsOptionsclassName {
  
  inline def apply(url: String): PickPropsOptionsclassName = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickPropsOptionsclassName]
  }
  
  extension [Self <: PickPropsOptionsclassName](x: Self) {
