...
object OmitPropsOptionsforwardedAbout {
  ...
  inline def apply(appId: String, url: String): OmitPropsOptionsforwardedAbout = {
    val __obj = js.Dynamic.literal(appId = appId.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[OmitPropsOptionsforwardedAbout]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPropsOptionsforwardedAbout] (val x: Self) extends AnyVal {
