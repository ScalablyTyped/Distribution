...
import typings.reactShare.reactShareStrings._empty
import typings.reactShare.reactShareStrings.`additions removals`
import typings.reactShare.reactShareStrings.`additions text`
import typings.reactShare.reactShareStrings.`after-edge`
import typings.reactShare.reactShareStrings.`before-edge`
import typings.reactShare.reactShareStrings.`inline`
import typings.reactShare.reactShareStrings.`removals additions`
import typings.reactShare.reactShareStrings.`removals text`
import typings.reactShare.reactShareStrings.`text additions`
import typings.reactShare.reactShareStrings.`text removals`
import typings.reactShare.reactShareStrings.`text-after-edge`
import typings.reactShare.reactShareStrings.`text-before-edge`
import typings.reactShare.reactShareStrings.`use-credentials`
import typings.reactShare.reactShareStrings.additions
import typings.reactShare.reactShareStrings.all
import typings.reactShare.reactShareStrings.alphabetic
import typings.reactShare.reactShareStrings.anonymous
import typings.reactShare.reactShareStrings.ascending
import typings.reactShare.reactShareStrings.assertive
import typings.reactShare.reactShareStrings.auto
import typings.reactShare.reactShareStrings.baseline
import typings.reactShare.reactShareStrings.bevel
import typings.reactShare.reactShareStrings.both
import typings.reactShare.reactShareStrings.butt
import typings.reactShare.reactShareStrings.central
import typings.reactShare.reactShareStrings.copy
import typings.reactShare.reactShareStrings.date
import typings.reactShare.reactShareStrings.descending
import typings.reactShare.reactShareStrings.dialog
import typings.reactShare.reactShareStrings.evenodd
import typings.reactShare.reactShareStrings.execute
import typings.reactShare.reactShareStrings.grammar
import typings.reactShare.reactShareStrings.grid
import typings.reactShare.reactShareStrings.hanging
import typings.reactShare.reactShareStrings.horizontal
import typings.reactShare.reactShareStrings.ideographic
import typings.reactShare.reactShareStrings.inherit
import typings.reactShare.reactShareStrings.initial
import typings.reactShare.reactShareStrings.isolated
import typings.reactShare.reactShareStrings.linearRGB
import typings.reactShare.reactShareStrings.link
import typings.reactShare.reactShareStrings.list
import typings.reactShare.reactShareStrings.listbox
import typings.reactShare.reactShareStrings.location
import typings.reactShare.reactShareStrings.mathematical
import typings.reactShare.reactShareStrings.medial
import typings.reactShare.reactShareStrings.menu
import typings.reactShare.reactShareStrings.middle
import typings.reactShare.reactShareStrings.miter
import typings.reactShare.reactShareStrings.mixed
import typings.reactShare.reactShareStrings.move
import typings.reactShare.reactShareStrings.no
import typings.reactShare.reactShareStrings.none
import typings.reactShare.reactShareStrings.nonzero
import typings.reactShare.reactShareStrings.off
import typings.reactShare.reactShareStrings.other
import typings.reactShare.reactShareStrings.page
import typings.reactShare.reactShareStrings.polite
import typings.reactShare.reactShareStrings.popup
import typings.reactShare.reactShareStrings.removals
import typings.reactShare.reactShareStrings.replace
import typings.reactShare.reactShareStrings.round
import typings.reactShare.reactShareStrings.sRGB
import typings.reactShare.reactShareStrings.spelling
import typings.reactShare.reactShareStrings.square
import typings.reactShare.reactShareStrings.step
import typings.reactShare.reactShareStrings.sum
import typings.reactShare.reactShareStrings.terminal
import typings.reactShare.reactShareStrings.text
import typings.reactShare.reactShareStrings.time
import typings.reactShare.reactShareStrings.tree
import typings.reactShare.reactShareStrings.vertical
...
object createIconMod {
  
  @JSImport("react-share/lib/hocs/createIcon", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default(iconConfig: IconConfig): FC[Props] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(iconConfig.asInstanceOf[js.Any]).asInstanceOf[FC[Props]]
  
  trait IconConfig extends StObject {
  ...
  object IconConfig {
    ...
    inline def apply(color: String, networkName: String, path: String): IconConfig = {
      val __obj = js.Dynamic.literal(color = color.asInstanceOf[js.Any], networkName = networkName.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
  ...
  /* Inlined std.Omit<react.react.SVGProps<std.SVGSVGElement>, 'width' | 'height'> & {  bgStyle :react.react.CSSProperties | undefined,   borderRadius :number | undefined,   iconFillColor :string | undefined,   round :boolean | undefined,   size :number | string | undefined} */
  trait Props extends StObject {
    ...
    var bgStyle: js.UndefOr[CSSProperties] = js.undefined
    ...
    var iconFillColor: js.UndefOr[String] = js.undefined
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setBgStyle(value: CSSProperties): Self = StObject.set(x, "bgStyle", value.asInstanceOf[js.Any])
      
      inline def setBgStyleUndefined: Self = StObject.set(x, "bgStyle", js.undefined)
      ...
      inline def setIconFillColor(value: String): Self = StObject.set(x, "iconFillColor", value.asInstanceOf[js.Any])
      
      inline def setIconFillColorUndefined: Self = StObject.set(x, "iconFillColor", js.undefined)
      ...
      inline def setOnBlur(value: FocusEvent[SVGSVGElement, Element] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      inline def setOnFocus(value: FocusEvent[SVGSVGElement, Element] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
