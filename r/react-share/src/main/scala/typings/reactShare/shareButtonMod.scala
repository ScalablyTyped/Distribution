...
import typings.reactShare.anon.DisabledStyle
...
object shareButtonMod {
  ...
  object CustomProps {
    ...
    inline def apply[LinkOptions](
      ...
      val __obj = js.Dynamic.literal(networkLink = js.Any.fromFunction2(networkLink), networkName = networkName.asInstanceOf[js.Any], opts = opts.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    ...
    extension [Self <: CustomProps[?], LinkOptions](x: Self & CustomProps[LinkOptions]) {
      ...
      inline def setForwardedRefFunction1(value: /* instance */ HTMLButtonElement | Null => Unit): Self = StObject.set(x, "forwardedRef", js.Any.fromFunction1(value))
  ...
  trait ShareButton[LinkOptions]
    ...
    def handleClick(event: MouseEvent[HTMLButtonElement, NativeMouseEvent]): js.Promise[Unit] = js.native
    
    def openShareDialog(link: String): Unit = js.native
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.reactShare.reactShareStrings.windowCenter
    - typings.reactShare.reactShareStrings.screenCenter
  */
  trait WindowPosition extends StObject
  object WindowPosition {
    
    inline def screenCenter: typings.reactShare.reactShareStrings.screenCenter = "screenCenter".asInstanceOf[typings.reactShare.reactShareStrings.screenCenter]
    
    inline def windowCenter: typings.reactShare.reactShareStrings.windowCenter = "windowCenter".asInstanceOf[typings.reactShare.reactShareStrings.windowCenter]
  }
}
