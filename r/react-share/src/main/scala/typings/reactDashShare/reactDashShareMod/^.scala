...
import typings.reactDashShare.Anon_Body
...
object ^ extends js.Object {
  ...
  val EmailShareButton: StatelessComponent[CommonShareButtonProps with Anon_Body] = js.native
  ...
  val TelegramShareButton: StatelessComponent[CommonShareButtonProps with Anon_Title] = js.native
  val TumblrIcon: StatelessComponent[IconComponentProps] = js.native
  val TumblrShareButton: StatelessComponent[CommonShareButtonProps with Anon_Caption] = js.native
  ...
  val TwitterShareButton: StatelessComponent[CommonShareButtonProps with Anon_Hashtags] = js.native
