...
object mod {
  ...
  inline def load(name: String, doNotParse: Boolean): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(name.asInstanceOf[js.Any], doNotParse.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  
  inline def loadAll(): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadAll")().asInstanceOf[StringDictionary[js.Any]]
  inline def loadAll(doNotParse: Boolean): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("loadAll")(doNotParse.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  
  inline def plugToRequest(req: Request_[ParamsDictionary, js.Any, js.Any, Query], res: Response_[js.Any]): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("plugToRequest")(req.asInstanceOf[js.Any], res.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
  ...
  inline def select(): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("select")().asInstanceOf[StringDictionary[js.Any]]
  inline def select(regex: RegExp): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("select")(regex.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
