...
trait Typeoffs extends StObject {
  ...
  var Dir: Instantiable0[typings.gracefulFs.mod.Dir] = js.native
  
  var Dirent: Instantiable0[typings.gracefulFs.mod.Dirent] = js.native
  
  var ReadStream: Instantiable0[typings.gracefulFs.mod.ReadStream] = js.native
  
  var Stats: Instantiable0[typings.gracefulFs.mod.Stats] = js.native
  
  var StatsFs: Instantiable0[typings.gracefulFs.mod.StatsFs] = js.native
  
  var WriteStream: Instantiable0[typings.gracefulFs.mod.WriteStream] = js.native
