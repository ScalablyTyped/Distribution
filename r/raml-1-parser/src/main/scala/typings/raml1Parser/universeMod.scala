...
import typings.raml1Parser.anon.AbstractSecurityScheme
import typings.raml1Parser.anon.Annotable
...
object universeMod {
  ...
  @JSImport("raml-1-parser/dist/parser/tools/universe", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("raml-1-parser/dist/parser/tools/universe", "Universe08")
  @js.native
  ...
  @JSImport("raml-1-parser/dist/parser/tools/universe", "Universe10")
  @js.native
