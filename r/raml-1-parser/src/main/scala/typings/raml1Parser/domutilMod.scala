...
object domutilMod {
  ...
  inline def buildHamlStyleTag(tag: String, classes: js.Array[String], id: typings.raml1Parser.optMod.^[String]): String = (^.asInstanceOf[js.Dynamic].applyDynamic("buildHamlStyleTag")(tag.asInstanceOf[js.Any], classes.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def buildHamlStyleTag(tag: String, classes: Unit, id: typings.raml1Parser.optMod.^[String]): String = (^.asInstanceOf[js.Dynamic].applyDynamic("buildHamlStyleTag")(tag.asInstanceOf[js.Any], classes.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[String]
