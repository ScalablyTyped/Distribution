...
import typings.raml1Parser.distParserLowLevelASTMod.TextChangeCommand
import typings.yamlAstParser.distSrcYamlASTMod.Kind
...
object distParserJsyamlJsyaml2lowLevelMod {
  ...
  open class HTTPResolverImpl ()
    ...
    /**
      ...
      **/
    /* CompleteClass */
    override def getResource(url: String): typings.raml1Parser.distParserJsyamlResolversApiMod.Response = js.native
    ...
    /**
      ...
      **/
    /* CompleteClass */
    override def getResourceAsync(url: String): js.Promise[typings.raml1Parser.distParserJsyamlResolversApiMod.Response] = js.native
  ...
  object InsertionPointType extends StObject {
    ...
    /* 2 */ val END: typings.raml1Parser.distParserJsyamlJsyaml2lowLevelMod.InsertionPointType.END & Double = js.native
    
    @js.native
    sealed trait NONE
      extends StObject
         with InsertionPointType
    /* 0 */ val NONE: typings.raml1Parser.distParserJsyamlJsyaml2lowLevelMod.InsertionPointType.NONE & Double = js.native
    
    @js.native
    sealed trait POINT
      extends StObject
         with InsertionPointType
    /* 3 */ val POINT: typings.raml1Parser.distParserJsyamlJsyaml2lowLevelMod.InsertionPointType.POINT & Double = js.native
    
    @js.native
    sealed trait START
      extends StObject
         with InsertionPointType
    /* 1 */ val START: typings.raml1Parser.distParserJsyamlJsyaml2lowLevelMod.InsertionPointType.START & Double = js.native
  }
  ...
  object Kind {
    ...
    @js.native
    def SCALAR: typings.yamlAstParser.distSrcYamlASTMod.Kind = js.native
    inline def SCALAR_=(x: typings.yamlAstParser.distSrcYamlASTMod.Kind): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SCALAR")(x.asInstanceOf[js.Any])
  }
  ...
  type Response = typings.raml1Parser.distParserJsyamlResolversApiMod.Response
}
