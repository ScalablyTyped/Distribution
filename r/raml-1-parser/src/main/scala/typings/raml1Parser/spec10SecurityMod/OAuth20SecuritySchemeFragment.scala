...
- typings.raml1Parser.spec10SecurityMod.OAuth20SecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait OAuth20SecuritySchemeFragment
  extends StObject
