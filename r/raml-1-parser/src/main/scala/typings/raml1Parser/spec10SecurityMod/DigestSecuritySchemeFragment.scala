...
- typings.raml1Parser.spec10SecurityMod.DigestSecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait DigestSecuritySchemeFragment
  extends StObject
