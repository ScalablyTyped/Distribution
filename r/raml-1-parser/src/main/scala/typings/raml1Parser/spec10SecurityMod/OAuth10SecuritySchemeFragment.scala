...
- typings.raml1Parser.spec10SecurityMod.OAuth10SecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait OAuth10SecuritySchemeFragment
  extends StObject
