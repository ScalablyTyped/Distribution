...
- typings.raml1Parser.spec10SecurityMod.SecuritySchemeBase10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, settings, sourceMap. Inlined name, description, describedBy, `type`
- typings.raml1Parser.spec10SecurityMod.CustomSecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait CustomSecuritySchemeFragment
  extends StObject
