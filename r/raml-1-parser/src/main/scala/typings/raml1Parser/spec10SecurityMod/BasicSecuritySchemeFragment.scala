...
- typings.raml1Parser.spec10SecurityMod.BasicSecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait BasicSecuritySchemeFragment
  extends StObject
