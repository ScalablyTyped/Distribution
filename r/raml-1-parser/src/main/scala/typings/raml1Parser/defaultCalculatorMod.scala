...
object defaultCalculatorMod {
  ...
  object InsertionKind extends StObject {
    ...
    sealed trait BY_DEFAULT
      extends StObject
         with InsertionKind
    /* 1 */ val BY_DEFAULT: typings.raml1Parser.defaultCalculatorMod.InsertionKind.BY_DEFAULT & Double = js.native
    
    @js.native
    sealed trait CALCULATED
      extends StObject
         with InsertionKind
    /* 0 */ val CALCULATED: typings.raml1Parser.defaultCalculatorMod.InsertionKind.CALCULATED & Double = js.native
  }
