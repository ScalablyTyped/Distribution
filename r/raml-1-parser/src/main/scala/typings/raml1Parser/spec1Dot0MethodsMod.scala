...
import typings.raml1Parser.spec10DatamodelMod.ObjectTypeDeclaration
...
object spec1Dot0MethodsMod {
  ...
  - typings.raml1Parser.spec1Dot0CommonMod.FragmentDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations. Inlined uses */ trait TraitFragment
    extends StObject
       with Trait10 {
