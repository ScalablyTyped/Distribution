...
- typings.raml1Parser.datamodelMod.TypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined `type`, examples, simplifiedExamples, name, default, description, allowedTargets, xml, required, displayName, facets, fixedFacets, anyOf */ trait DateTypeFragment
  extends StObject
...
object DateTypeFragment {
  
  inline def apply(displayName: String, name: String, `type`: js.Array[TypeReference10]): DateTypeFragment = {
