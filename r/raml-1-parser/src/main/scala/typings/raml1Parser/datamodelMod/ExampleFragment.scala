...
- typings.raml1Parser.spec10CommonMod.FragmentDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined uses */ trait ExampleFragment
  extends StObject
     with ExampleSpec10 {
