...
- typings.raml1Parser.datamodelMod.ArrayTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined uniqueItems, minItems, maxItems, items */ trait ArrayTypeFragment
  extends StObject
