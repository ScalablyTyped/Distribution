...
- typings.raml1Parser.datamodelMod.ObjectTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined discriminator, discriminatorValue, properties, minProperties, maxProperties, additionalProperties */ trait ObjectTypeFragment
  extends StObject
