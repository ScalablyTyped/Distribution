...
- typings.raml1Parser.datamodelMod.NumberTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined `enum`, minimum, maximum, format, multipleOf */ trait NumberTypeFragment
  extends StObject
...
object NumberTypeFragment {
  ...
  extension [Self <: NumberTypeFragment](x: Self) {
