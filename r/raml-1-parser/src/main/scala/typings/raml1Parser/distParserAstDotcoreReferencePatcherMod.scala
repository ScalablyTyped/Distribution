...
import typings.raml1Parser.distParserJsyamlJsyaml2lowLevelMod.ASTNode
...
object distParserAstDotcoreReferencePatcherMod {
  ...
  object ParametersEscapingStatus extends StObject {
    ...
    /* 2 */ val ERROR: typings.raml1Parser.distParserAstDotcoreReferencePatcherMod.ParametersEscapingStatus.ERROR & Double = js.native
    
    @js.native
    sealed trait NOT_REQUIRED
      extends StObject
         with ParametersEscapingStatus
    /* 1 */ val NOT_REQUIRED: typings.raml1Parser.distParserAstDotcoreReferencePatcherMod.ParametersEscapingStatus.NOT_REQUIRED & Double = js.native
    
    @js.native
    sealed trait OK
      extends StObject
         with ParametersEscapingStatus
    /* 0 */ val OK: typings.raml1Parser.distParserAstDotcoreReferencePatcherMod.ParametersEscapingStatus.OK & Double = js.native
  }
  ...
  object PatchMode extends StObject {
    ...
    sealed trait DEFAULT
      extends StObject
         with PatchMode
    /* 0 */ val DEFAULT: typings.raml1Parser.distParserAstDotcoreReferencePatcherMod.PatchMode.DEFAULT & Double = js.native
    
    @js.native
    sealed trait PATH
      extends StObject
         with PatchMode
    /* 1 */ val PATH: typings.raml1Parser.distParserAstDotcoreReferencePatcherMod.PatchMode.PATH & Double = js.native
  }
