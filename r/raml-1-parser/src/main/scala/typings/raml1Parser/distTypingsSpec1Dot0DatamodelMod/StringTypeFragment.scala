...
- typings.raml1Parser.distTypingsSpec1Dot0DatamodelMod.StringTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations. Inlined `enum`, pattern, minLength, maxLength */ trait StringTypeFragment
  extends StObject
