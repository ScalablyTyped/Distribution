...
- typings.raml1Parser.distTypingsSpec1Dot0DatamodelMod.ArrayTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations. Inlined uniqueItems, minItems, maxItems, items */ trait ArrayTypeFragment
  extends StObject
...
object ArrayTypeFragment {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ArrayTypeFragment] (val x: Self) extends AnyVal {
