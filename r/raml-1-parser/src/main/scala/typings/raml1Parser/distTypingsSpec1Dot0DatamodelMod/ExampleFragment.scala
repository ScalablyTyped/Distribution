...
- typings.raml1Parser.distTypingsSpec1Dot0CommonMod.FragmentDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations. Inlined uses */ trait ExampleFragment
  extends StObject
     with ExampleSpec10 {
