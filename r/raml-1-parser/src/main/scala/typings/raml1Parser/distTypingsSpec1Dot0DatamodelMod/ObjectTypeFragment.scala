...
- typings.raml1Parser.distTypingsSpec1Dot0DatamodelMod.ObjectTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations. Inlined discriminator, discriminatorValue, properties, minProperties, maxProperties, additionalProperties */ trait ObjectTypeFragment
  extends StObject
