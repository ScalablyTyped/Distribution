...
import typings.raml1Parser.distTypingsNewFormatSpec1Dot0DatamodelMod.ObjectTypeDeclaration
...
object distTypingsNewFormatSpec1Dot0MethodsMod {
  ...
  - typings.raml1Parser.distTypingsNewFormatSpec1Dot0CommonMod.FragmentDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined uses */ trait TraitFragment
    extends StObject
       with Trait10 {
