...
import typings.ramlDefinitionSystem.ramlDefinitionSystemMod.Property
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object searchImplementationMod {
  ...
  object LocationKind extends StObject {
    ...
    sealed trait ANNOTATION_COMPLETION
      extends StObject
         with LocationKind
    /* 5 */ val ANNOTATION_COMPLETION: typings.raml1Parser.searchImplementationMod.LocationKind.ANNOTATION_COMPLETION & Double = js.native
    
    @js.native
    sealed trait DIRECTIVE_COMPLETION
      extends StObject
         with LocationKind
    /* 3 */ val DIRECTIVE_COMPLETION: typings.raml1Parser.searchImplementationMod.LocationKind.DIRECTIVE_COMPLETION & Double = js.native
    
    @js.native
    sealed trait INCOMMENT
      extends StObject
         with LocationKind
    /* 7 */ val INCOMMENT: typings.raml1Parser.searchImplementationMod.LocationKind.INCOMMENT & Double = js.native
    
    @js.native
    sealed trait KEY_COMPLETION
      extends StObject
         with LocationKind
    /* 1 */ val KEY_COMPLETION: typings.raml1Parser.searchImplementationMod.LocationKind.KEY_COMPLETION & Double = js.native
    
    @js.native
    sealed trait PATH_COMPLETION
      extends StObject
         with LocationKind
    /* 2 */ val PATH_COMPLETION: typings.raml1Parser.searchImplementationMod.LocationKind.PATH_COMPLETION & Double = js.native
    
    @js.native
    sealed trait SEQUENCE_KEY_COPLETION
      extends StObject
         with LocationKind
    /* 6 */ val SEQUENCE_KEY_COPLETION: typings.raml1Parser.searchImplementationMod.LocationKind.SEQUENCE_KEY_COPLETION & Double = js.native
    
    @js.native
    sealed trait VALUE_COMPLETION
      extends StObject
         with LocationKind
    /* 0 */ val VALUE_COMPLETION: typings.raml1Parser.searchImplementationMod.LocationKind.VALUE_COMPLETION & Double = js.native
    
    @js.native
    sealed trait VERSION_COMPLETION
      extends StObject
         with LocationKind
    /* 4 */ val VERSION_COMPLETION: typings.raml1Parser.searchImplementationMod.LocationKind.VERSION_COMPLETION & Double = js.native
  }
  ...
  inline def findAllSubTypes(p: IProperty, n: IHighLevelNode): js.Array[typings.raml1Parser.highLevelASTMod.ITypeDefinition] = (^.asInstanceOf[js.Dynamic].applyDynamic("findAllSubTypes")(p.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.raml1Parser.highLevelASTMod.ITypeDefinition]]
  ...
  inline def nodesDeclaringType(range: typings.raml1Parser.highLevelASTMod.ITypeDefinition, n: IHighLevelNode): js.Array[IHighLevelNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("nodesDeclaringType")(range.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[js.Array[IHighLevelNode]]
  ...
  inline def schemasWithName(
    ...
    backup: StringDictionary[typings.raml1Parser.highLevelASTMod.ITypeDefinition]
  ): typings.raml1Parser.highLevelASTMod.ITypeDefinition = (^.asInstanceOf[js.Dynamic].applyDynamic("schemasWithName")(tname.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any], backup.asInstanceOf[js.Any])).asInstanceOf[typings.raml1Parser.highLevelASTMod.ITypeDefinition]
  
  inline def subTypesWithLocals(range: typings.raml1Parser.highLevelASTMod.ITypeDefinition, parentNode: IHighLevelNode): js.Array[ITypeDefinition] = (^.asInstanceOf[js.Dynamic].applyDynamic("subTypesWithLocals")(range.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any])).asInstanceOf[js.Array[ITypeDefinition]]
  
  inline def subTypesWithName(
    tname: String,
    parentNode: IHighLevelNode,
    backup: StringDictionary[typings.raml1Parser.highLevelASTMod.ITypeDefinition]
  ): typings.raml1Parser.highLevelASTMod.ITypeDefinition = (^.asInstanceOf[js.Dynamic].applyDynamic("subTypesWithName")(tname.asInstanceOf[js.Any], parentNode.asInstanceOf[js.Any], backup.asInstanceOf[js.Any])).asInstanceOf[typings.raml1Parser.highLevelASTMod.ITypeDefinition]
  ...
  type ITypeDefinition = typings.raml1Parser.highLevelASTMod.ITypeDefinition
}
