...
object utils {
  ...
  open class PointOfViewValidationAcceptorImpl protected ()
    extends typings.raml1Parser.utilsMod.PointOfViewValidationAcceptorImpl {
    def this(
      errors: js.Array[ValidationIssue],
      primaryUnitRoot: typings.raml1Parser.highLevelASTMod.IParseResult
    ) = this()
  }
  ...
  open class UnitLink protected ()
    extends typings.raml1Parser.utilsMod.UnitLink {
    def this(
      node: typings.raml1Parser.highLevelASTMod.IParseResult,
      targetUnitRoot: typings.raml1Parser.highLevelASTMod.IParseResult
    ) = this()
  }
  ...
  inline def genStructuredValue(
    ...
    pr: typings.raml1Parser.highLevelASTMod.IProperty
  ...
  inline def getFragmentDefenitionName(node: typings.raml1Parser.highLevelASTMod.IHighLevelNode): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getFragmentDefenitionName")(node.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  @js.native
  def updateType: js.Function1[/* node */ typings.raml1Parser.highLevelASTMod.IHighLevelNode, Unit] = js.native
  inline def updateType_=(x: js.Function1[/* node */ typings.raml1Parser.highLevelASTMod.IHighLevelNode, Unit]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("updateType")(x.asInstanceOf[js.Any])
}
