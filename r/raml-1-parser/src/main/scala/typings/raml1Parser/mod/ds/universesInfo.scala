...
object universesInfo {
  
  @JSImport("raml-1-parser", "ds.universesInfo")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("raml-1-parser", "ds.universesInfo.Universe08")
  @js.native
  ...
  @JSImport("raml-1-parser", "ds.universesInfo.Universe10")
  @js.native
