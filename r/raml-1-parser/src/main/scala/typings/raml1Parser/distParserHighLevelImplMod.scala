...
import typings.raml1Parser.distParserHighLevelASTMod.IEditableHighLevelNode
...
import typings.raml1Parser.distParserHighLevelASTMod.IValueTypeDefinition
import typings.raml1Parser.distParserHighLevelASTMod.RamlParserError
...
import typings.raml1Parser.distUtilContentproviderMod.ContentProvider
import typings.ramlDefinitionSystem.mod.SourceProvider
...
object distParserHighLevelImplMod {
  ...
  object OverlayMergeMode extends StObject {
    ...
    /* 1 */ val AGGREGATE: typings.raml1Parser.distParserHighLevelImplMod.OverlayMergeMode.AGGREGATE & Double = js.native
    
    @js.native
    sealed trait MERGE
      extends StObject
         with OverlayMergeMode
    /* 0 */ val MERGE: typings.raml1Parser.distParserHighLevelImplMod.OverlayMergeMode.MERGE & Double = js.native
  }
  ...
  inline def auxiliaryTypeForExample(node: IHighLevelNode): typings.ramlTypesystem.distSrcNominalInterfacesMod.ITypeDefinition = ^.asInstanceOf[js.Dynamic].applyDynamic("auxiliaryTypeForExample")(node.asInstanceOf[js.Any]).asInstanceOf[typings.ramlTypesystem.distSrcNominalInterfacesMod.ITypeDefinition]
