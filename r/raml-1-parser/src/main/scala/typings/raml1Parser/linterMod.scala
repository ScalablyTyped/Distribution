...
import typings.raml1Parser.highLevelImplMod.BasicASTNode
...
object linterMod {
  ...
  inline def typeOfContainingTemplate(h: IParseResult): typings.ramlDefinitionSystem.ramlDefinitionSystemMod.ITypeDefinition = ^.asInstanceOf[js.Dynamic].applyDynamic("typeOfContainingTemplate")(h.asInstanceOf[js.Any]).asInstanceOf[typings.ramlDefinitionSystem.ramlDefinitionSystemMod.ITypeDefinition]
