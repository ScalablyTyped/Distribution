...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "DateTimeOnlyTypeDeclarationImpl")
@js.native
open class DateTimeOnlyTypeDeclarationImpl protected () extends TypeDeclarationImpl {
...
/* static members */
object DateTimeOnlyTypeDeclarationImpl {
