...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "StatusCodeStringImpl")
@js.native
open class StatusCodeStringImpl protected () extends StringTypeImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object StatusCodeStringImpl {
