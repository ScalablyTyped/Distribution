...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "MarkdownStringImpl")
@js.native
open class MarkdownStringImpl protected () extends StringTypeImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object MarkdownStringImpl {
