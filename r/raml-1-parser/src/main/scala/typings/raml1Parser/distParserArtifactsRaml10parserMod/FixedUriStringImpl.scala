...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "FixedUriStringImpl")
@js.native
open class FixedUriStringImpl protected () extends StringTypeImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object FixedUriStringImpl {
