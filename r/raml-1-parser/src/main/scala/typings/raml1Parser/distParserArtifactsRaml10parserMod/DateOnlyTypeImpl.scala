...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "DateOnlyTypeImpl")
@js.native
open class DateOnlyTypeImpl protected () extends ValueTypeImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object DateOnlyTypeImpl {
