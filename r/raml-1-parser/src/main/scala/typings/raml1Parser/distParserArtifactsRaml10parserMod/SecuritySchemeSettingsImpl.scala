...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "SecuritySchemeSettingsImpl")
@js.native
open class SecuritySchemeSettingsImpl protected () extends AnnotableImpl {
...
/* static members */
object SecuritySchemeSettingsImpl {
