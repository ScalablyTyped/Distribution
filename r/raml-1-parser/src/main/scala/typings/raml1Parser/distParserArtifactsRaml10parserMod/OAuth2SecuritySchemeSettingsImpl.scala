...
import typings.raml1Parser.distParserArtifactsRaml10parserapiMod.OAuth2SecuritySchemeSettings
import typings.raml1Parser.distParserHighLevelASTMod.IHighLevelNode
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "OAuth2SecuritySchemeSettingsImpl")
@js.native
open class OAuth2SecuritySchemeSettingsImpl protected ()
  extends SecuritySchemeSettingsImpl
     with OAuth2SecuritySchemeSettings {
  ...
  /**
    ...
    **/
  def setAuthorizationGrants(param: String): this.type = js.native
  
  /**
    * @hidden
    * Set scopes value
    **/
  def setScopes(param: String): this.type = js.native
...
/* static members */
object OAuth2SecuritySchemeSettingsImpl {
