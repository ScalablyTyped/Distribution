...
- typings.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.OAuth20SecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait OAuth20SecuritySchemeFragment
  extends StObject
...
object OAuth20SecuritySchemeFragment {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OAuth20SecuritySchemeFragment] (val x: Self) extends AnyVal {
