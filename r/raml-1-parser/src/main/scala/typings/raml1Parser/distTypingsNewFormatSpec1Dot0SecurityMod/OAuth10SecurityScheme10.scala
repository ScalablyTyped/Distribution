...
trait OAuth10SecurityScheme10
  ...
  /**
    ...
    */
  @JSName("settings")
  var settings_OAuth10SecurityScheme10: js.UndefOr[OAuth10SecuritySettings10] = js.undefined
}
object OAuth10SecurityScheme10 {
  
  inline def apply(name: String, `type`: String): OAuth10SecurityScheme10 = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OAuth10SecurityScheme10] (val x: Self) extends AnyVal {
