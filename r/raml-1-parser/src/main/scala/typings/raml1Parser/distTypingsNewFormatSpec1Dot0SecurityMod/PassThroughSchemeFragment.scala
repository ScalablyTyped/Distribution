...
- typings.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.PassThroughSecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait PassThroughSchemeFragment
  extends StObject
