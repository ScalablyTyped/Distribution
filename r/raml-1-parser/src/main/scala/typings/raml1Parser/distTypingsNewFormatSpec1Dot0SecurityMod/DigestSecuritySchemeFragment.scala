...
- typings.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.DigestSecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait DigestSecuritySchemeFragment
  extends StObject
...
object DigestSecuritySchemeFragment {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DigestSecuritySchemeFragment] (val x: Self) extends AnyVal {
