...
- typings.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.OAuth10SecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait OAuth10SecuritySchemeFragment
  extends StObject
  ...
  /**
    ...
    */
  var settings: js.UndefOr[OAuth10SecuritySettings10] = js.undefined
...
object OAuth10SecuritySchemeFragment {
  ...
  inline def apply(name: String, `type`: String): OAuth10SecuritySchemeFragment = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OAuth10SecuritySchemeFragment] (val x: Self) extends AnyVal {
