...
- typings.raml1Parser.distTypingsNewFormatSpec1Dot0SecurityMod.BasicSecurityScheme10 because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined settings */ trait BasicSecuritySchemeFragment
  extends StObject
...
object BasicSecuritySchemeFragment {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BasicSecuritySchemeFragment] (val x: Self) extends AnyVal {
