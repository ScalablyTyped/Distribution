...
- typings.raml1Parser.spec10DatamodelMod.TypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations. Inlined `type`, example, examples, structuredExample, name, default, description, allowedTargets, xml, required, displayName, facets, fixedFacets */ trait DateTypeFragment
  extends StObject
