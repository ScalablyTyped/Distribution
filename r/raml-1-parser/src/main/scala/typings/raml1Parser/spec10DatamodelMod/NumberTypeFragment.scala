...
- typings.raml1Parser.spec10DatamodelMod.NumberTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations. Inlined `enum`, minimum, maximum, format, multipleOf */ trait NumberTypeFragment
  extends StObject
