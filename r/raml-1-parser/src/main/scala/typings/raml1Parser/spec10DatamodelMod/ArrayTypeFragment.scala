...
- typings.raml1Parser.spec10DatamodelMod.ArrayTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations. Inlined uniqueItems, minItems, maxItems, items */ trait ArrayTypeFragment
  extends StObject
