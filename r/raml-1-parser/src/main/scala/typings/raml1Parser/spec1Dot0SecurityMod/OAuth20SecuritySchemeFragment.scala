...
trait OAuth20SecuritySchemeFragment
  extends StObject
     with FragmentDeclaration
     with OAuth20SecurityScheme10
     with SecuritySchemeFragment
object OAuth20SecuritySchemeFragment {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OAuth20SecuritySchemeFragment]
  }
}
