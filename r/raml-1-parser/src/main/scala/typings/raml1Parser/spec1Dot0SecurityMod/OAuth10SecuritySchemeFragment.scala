...
trait OAuth10SecuritySchemeFragment
  extends StObject
     with FragmentDeclaration
     with OAuth10SecurityScheme10
     with SecuritySchemeFragment
object OAuth10SecuritySchemeFragment {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OAuth10SecuritySchemeFragment]
  }
}
