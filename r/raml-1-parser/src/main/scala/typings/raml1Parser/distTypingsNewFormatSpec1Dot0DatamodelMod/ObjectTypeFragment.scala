...
- typings.raml1Parser.distTypingsNewFormatSpec1Dot0DatamodelMod.ObjectTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined discriminator, discriminatorValue, properties, minProperties, maxProperties, additionalProperties */ trait ObjectTypeFragment
  extends StObject
