...
- typings.raml1Parser.distTypingsNewFormatSpec1Dot0DatamodelMod.StringTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined `enum`, pattern, minLength, maxLength */ trait StringTypeFragment
  extends StObject
