...
- typings.raml1Parser.distTypingsNewFormatSpec1Dot0DatamodelMod.ArrayTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined uniqueItems, minItems, maxItems, items */ trait ArrayTypeFragment
  extends StObject
