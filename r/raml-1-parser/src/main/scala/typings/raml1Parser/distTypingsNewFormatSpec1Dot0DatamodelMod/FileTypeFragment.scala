...
- typings.raml1Parser.distTypingsNewFormatSpec1Dot0DatamodelMod.FileTypeDeclaration because var conflicts: __METADATA__, annotations, scalarsAnnotations, sourceMap. Inlined fileTypes, minLength, maxLength */ trait FileTypeFragment
  extends StObject
