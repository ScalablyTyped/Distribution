...
object typeExpanderMod {
  ...
  open class AbstractTypeEntry protected ()
    ...
    def declaredExampleFacets(): js.Array[typings.ramlTypesystem.typesystemInterfacesMod.ITypeFacet] = js.native
  ...
  open class PropertyEntry protected ()
    ...
    def annotations(): js.Array[typings.ramlTypesystem.typesystemInterfacesMod.IAnnotation] = js.native
    ...
    def original(): typings.ramlTypesystem.typesystemInterfacesMod.IPropertyInfo = js.native
