...
import typings.raml1Parser.spec10DatamodelMod.TypeDeclaration
import typings.raml1Parser.spec10DatamodelMod.TypeReference10
import typings.raml1Parser.spec1Dot0MethodsMod.Trait10
import typings.raml1Parser.spec1Dot0ResourcesMod.Resource10
import typings.raml1Parser.spec1Dot0ResourcesMod.ResourceType10
import typings.raml1Parser.spec1Dot0SecurityMod.SecuritySchemeBase10
import typings.raml1Parser.spec1Dot0SecurityMod.SecuritySchemeRef10
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object spec1Dot0ApiMod {
  
  trait Api10 extends StObject {
    ...
    /**
      ...
      */
    var baseUriParameters: js.UndefOr[StringDictionary[TypeReference10]] = js.undefined
    ...
    /**
      ...
      */
    var mediaType: js.UndefOr[String | js.Array[String]] = js.undefined
  ...
  object Api10 {
    ...
    inline def apply(title: String): Api10 = {
    ...
    extension [Self <: Api10](x: Self) {
      ...
      inline def setBaseUriParameters(value: StringDictionary[TypeReference10]): Self = StObject.set(x, "baseUriParameters", value.asInstanceOf[js.Any])
      ...
      inline def setMediaType(value: String | js.Array[String]): Self = StObject.set(x, "mediaType", value.asInstanceOf[js.Any])
  ...
  trait DocumentationItem extends StObject {
  ...
  object Extension {
    ...
    inline def apply(`extends`: String, title: String): Extension = {
      val __obj = js.Dynamic.literal(title = title.asInstanceOf[js.Any])
  ...
  trait LibraryBase10 extends StObject {
    
    /**
      * Declarations of annotation types for use by annotations
      */
    var annotationTypes: js.UndefOr[js.Array[StringDictionary[TypeDeclaration]]] = js.undefined
    
    /**
      * Declarations of resource types for use within this API
      */
    var resourceTypes: js.UndefOr[js.Array[StringDictionary[ResourceType10]]] = js.undefined
    ...
    /**
      ...
      */
    var schemas: js.UndefOr[js.Array[StringDictionary[TypeDeclaration]]] = js.undefined
    
    /**
      * Declarations of security schemes for use within this API.
      */
    var securitySchemes: js.UndefOr[js.Array[StringDictionary[SecuritySchemeBase10]]] = js.undefined
    
    /**
      * Declarations of traits for use within this API
      */
    var traits: js.UndefOr[js.Array[StringDictionary[Trait10]]] = js.undefined
    
    /**
      * Declarations of (data) types for use within this API
      */
    var types: js.UndefOr[js.Array[StringDictionary[TypeDeclaration]]] = js.undefined
  }
  object LibraryBase10 {
    ...
    extension [Self <: LibraryBase10](x: Self) {
      ...
      inline def setAnnotationTypesVarargs(value: StringDictionary[TypeDeclaration]*): Self = StObject.set(x, "annotationTypes", js.Array(value*))
      
      inline def setResourceTypes(value: js.Array[StringDictionary[ResourceType10]]): Self = StObject.set(x, "resourceTypes", value.asInstanceOf[js.Any])
      
      inline def setResourceTypesUndefined: Self = StObject.set(x, "resourceTypes", js.undefined)
      
      inline def setResourceTypesVarargs(value: StringDictionary[ResourceType10]*): Self = StObject.set(x, "resourceTypes", js.Array(value*))
      
      inline def setSchemas(value: js.Array[StringDictionary[TypeDeclaration]]): Self = StObject.set(x, "schemas", value.asInstanceOf[js.Any])
      
      inline def setSchemasUndefined: Self = StObject.set(x, "schemas", js.undefined)
      
      inline def setSchemasVarargs(value: StringDictionary[TypeDeclaration]*): Self = StObject.set(x, "schemas", js.Array(value*))
      
      inline def setSecuritySchemes(value: js.Array[StringDictionary[SecuritySchemeBase10]]): Self = StObject.set(x, "securitySchemes", value.asInstanceOf[js.Any])
      
      inline def setSecuritySchemesUndefined: Self = StObject.set(x, "securitySchemes", js.undefined)
      
      inline def setSecuritySchemesVarargs(value: StringDictionary[SecuritySchemeBase10]*): Self = StObject.set(x, "securitySchemes", js.Array(value*))
      
      inline def setTraits(value: js.Array[StringDictionary[Trait10]]): Self = StObject.set(x, "traits", value.asInstanceOf[js.Any])
      
      inline def setTraitsUndefined: Self = StObject.set(x, "traits", js.undefined)
      
      inline def setTraitsVarargs(value: StringDictionary[Trait10]*): Self = StObject.set(x, "traits", js.Array(value*))
      
      inline def setTypes(value: js.Array[StringDictionary[TypeDeclaration]]): Self = StObject.set(x, "types", value.asInstanceOf[js.Any])
      
      inline def setTypesUndefined: Self = StObject.set(x, "types", js.undefined)
      
      inline def setTypesVarargs(value: StringDictionary[TypeDeclaration]*): Self = StObject.set(x, "types", js.Array(value*))
    }
  }
  ...
  object Overlay {
    ...
    inline def apply(`extends`: String, title: String): Overlay = {
      val __obj = js.Dynamic.literal(title = title.asInstanceOf[js.Any])
      __obj.updateDynamic("extends")(`extends`.asInstanceOf[js.Any])
