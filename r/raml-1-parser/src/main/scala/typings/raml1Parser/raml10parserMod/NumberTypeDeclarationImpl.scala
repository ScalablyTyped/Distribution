...
import typings.raml1Parser.raml10parserapiMod.NumberTypeDeclaration
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "NumberTypeDeclarationImpl")
@js.native
open class NumberTypeDeclarationImpl protected ()
  extends TypeDeclarationImpl
     with NumberTypeDeclaration {
  ...
  /**
    ...
    * Set enum value
    **/
  def setEnum(param: Double): this.type = js.native
  
  /**
    * @hidden
    * Set format value
    **/
  def setFormat(param: String): this.type = js.native
  
  /**
    * @hidden
    * Set maximum value
    **/
  def setMaximum(param: Double): this.type = js.native
  
  /**
    * @hidden
    * Set minimum value
    **/
  def setMinimum(param: Double): this.type = js.native
  
  /**
    * @hidden
    * Set multipleOf value
    **/
  def setMultipleOf(param: Double): this.type = js.native
...
/* static members */
object NumberTypeDeclarationImpl {
