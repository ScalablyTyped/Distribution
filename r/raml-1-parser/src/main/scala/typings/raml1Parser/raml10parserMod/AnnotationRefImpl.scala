...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "AnnotationRefImpl")
@js.native
open class AnnotationRefImpl protected ()
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def annotation(): TypeDeclaration = js.native
