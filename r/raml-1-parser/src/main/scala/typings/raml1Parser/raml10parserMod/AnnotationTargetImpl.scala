...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "AnnotationTargetImpl")
@js.native
open class AnnotationTargetImpl protected () extends ValueTypeImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object AnnotationTargetImpl {
