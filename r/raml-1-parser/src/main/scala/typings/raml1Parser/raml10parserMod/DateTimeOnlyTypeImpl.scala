...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "DateTimeOnlyTypeImpl")
@js.native
open class DateTimeOnlyTypeImpl protected () extends ValueTypeImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object DateTimeOnlyTypeImpl {
