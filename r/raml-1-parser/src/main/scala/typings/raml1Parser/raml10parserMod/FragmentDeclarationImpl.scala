...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "FragmentDeclarationImpl")
@js.native
open class FragmentDeclarationImpl protected ()
...
/* static members */
object FragmentDeclarationImpl {
