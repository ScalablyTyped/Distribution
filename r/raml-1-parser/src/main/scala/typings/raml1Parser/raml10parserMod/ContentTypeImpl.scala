...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "ContentTypeImpl")
@js.native
open class ContentTypeImpl protected () extends StringTypeImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object ContentTypeImpl {
