...
@JSImport("raml-1-parser/dist/parser/artifacts/raml10parser", "DateOnlyTypeDeclarationImpl")
@js.native
open class DateOnlyTypeDeclarationImpl protected () extends TypeDeclarationImpl {
...
/* static members */
object DateOnlyTypeDeclarationImpl {
