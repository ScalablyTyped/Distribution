...
@JSImport("raml-1-parser/dist/parser/definition-system/ramlServices", "EnumType")
@js.native
open class EnumType ()
...
object EnumType {
  ...
  @JSImport("raml-1-parser/dist/parser/definition-system/ramlServices", "EnumType.CLASS_IDENTIFIER")
  @js.native
