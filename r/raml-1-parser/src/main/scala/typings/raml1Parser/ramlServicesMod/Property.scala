...
- Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify typeSystem.IProperty * / any */ @JSImport("raml-1-parser/dist/parser/definition-system/ramlServices", "Property")
@js.native
open class Property ()
...
object Property {
  ...
  @JSImport("raml-1-parser/dist/parser/definition-system/ramlServices", "Property")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("raml-1-parser/dist/parser/definition-system/ramlServices", "Property.CLASS_IDENTIFIER_Property_def")
  @js.native
