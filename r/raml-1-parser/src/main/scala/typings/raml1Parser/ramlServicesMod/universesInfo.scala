...
object universesInfo {
  ...
  @JSImport("raml-1-parser/dist/parser/definition-system/ramlServices", "universesInfo")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("raml-1-parser/dist/parser/definition-system/ramlServices", "universesInfo.Universe08")
  @js.native
  ...
  @JSImport("raml-1-parser/dist/parser/definition-system/ramlServices", "universesInfo.Universe10")
  @js.native
