...
@JSImport("raml-1-parser/dist/parser/artifacts/raml08parser", "XMLExampleImpl")
@js.native
open class XMLExampleImpl protected () extends ExampleStringImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object XMLExampleImpl {
