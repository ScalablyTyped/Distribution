...
@JSImport("raml-1-parser/dist/parser/artifacts/raml08parser", "JSONExampleImpl")
@js.native
open class JSONExampleImpl protected () extends ExampleStringImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object JSONExampleImpl {
