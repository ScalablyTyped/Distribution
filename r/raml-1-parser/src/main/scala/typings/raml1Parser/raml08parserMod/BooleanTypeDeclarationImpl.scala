...
@JSImport("raml-1-parser/dist/parser/artifacts/raml08parser", "BooleanTypeDeclarationImpl")
@js.native
open class BooleanTypeDeclarationImpl protected () extends ParameterImpl {
...
/* static members */
object BooleanTypeDeclarationImpl {
