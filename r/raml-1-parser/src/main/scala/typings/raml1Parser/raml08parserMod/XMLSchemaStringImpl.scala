...
@JSImport("raml-1-parser/dist/parser/artifacts/raml08parser", "XMLSchemaStringImpl")
@js.native
open class XMLSchemaStringImpl protected () extends SchemaStringImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object XMLSchemaStringImpl {
