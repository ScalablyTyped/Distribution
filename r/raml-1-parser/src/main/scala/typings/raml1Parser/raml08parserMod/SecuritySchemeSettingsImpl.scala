...
@JSImport("raml-1-parser/dist/parser/artifacts/raml08parser", "SecuritySchemeSettingsImpl")
@js.native
open class SecuritySchemeSettingsImpl protected () extends BasicNodeImpl {
  /**
    * @hidden
    **/
