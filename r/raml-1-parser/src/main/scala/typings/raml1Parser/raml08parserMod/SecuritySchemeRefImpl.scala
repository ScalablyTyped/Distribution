...
@JSImport("raml-1-parser/dist/parser/artifacts/raml08parser", "SecuritySchemeRefImpl")
@js.native
open class SecuritySchemeRefImpl protected ()
  extends ReferenceImpl
     with SecuritySchemeRef {
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def securityScheme(): AbstractSecurityScheme = js.native
  
  /**
    * Returns the name of security scheme, this reference refers to.
    **/
  /* CompleteClass */
  override def securitySchemeName(): String = js.native
