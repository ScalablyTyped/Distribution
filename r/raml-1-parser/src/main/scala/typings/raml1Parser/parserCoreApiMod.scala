...
object parserCoreApiMod {
  
  type AbstractWrapperNode = typings.raml1Parser.highLevelASTMod.AbstractWrapperNode
  
  trait AttributeNode
    extends StObject
       with typings.raml1Parser.highLevelASTMod.AbstractWrapperNode {
  ...
  type BasicNode = typings.raml1Parser.highLevelASTMod.BasicNode
  ...
  type ValueMetadata = typings.raml1Parser.highLevelASTMod.ValueMetadata
}
