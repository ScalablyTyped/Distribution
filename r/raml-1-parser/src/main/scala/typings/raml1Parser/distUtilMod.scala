...
object distUtilMod {
  ...
  inline def find[T](xs: js.Array[T], f: js.Function1[/* T */ Any, Boolean]): typings.raml1Parser.distOptMod.^[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("find")(xs.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[typings.raml1Parser.distOptMod.^[T]]
