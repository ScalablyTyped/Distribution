...
import typings.raml1Parser.distParserArtifactsRaml10parserMod.ArrayTypeDeclarationImpl
import typings.raml1Parser.distParserArtifactsRaml10parserMod.TypeDeclarationImpl
...
object distParserToolsSchemaModelGenMod {
  ...
  open class SchemaToModelGenerator ()
    extends StObject
       with typings.raml1Parser.distParserToolsSchemaModelGenApiMod.SchemaToModelGenerator {
