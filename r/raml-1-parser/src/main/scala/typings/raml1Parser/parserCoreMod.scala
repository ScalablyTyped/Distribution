...
object parserCoreMod {
  ...
  open class AttributeNodeImpl protected ()
    ...
    /* CompleteClass */
    override def meta(): typings.raml1Parser.parserCoreApiMod.ValueMetadata = js.native
    ...
    /* CompleteClass */
    override def parent(): typings.raml1Parser.parserCoreApiMod.BasicNode = js.native
    ...
    def toJSON(serializeOptions: typings.raml1Parser.jsonSerializerMod.SerializeOptions): Any = js.native
  ...
  open class BasicNodeImpl protected ()
    extends StObject
       with typings.raml1Parser.highLevelASTMod.BasicNode {
    /**
      * @hidden
      **/
  ...
  open class NodeMetadataImpl ()
    extends ValueMetadataImpl
       with typings.raml1Parser.highLevelASTMod.NodeMetadata {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def primitiveValuesMeta(): StringDictionary[typings.raml1Parser.highLevelASTMod.ValueMetadata] = js.native
  ...
  open class ValueMetadataImpl ()
    extends StObject
       with typings.raml1Parser.highLevelASTMod.ValueMetadata {
    def this(_insertedAsDefault: Boolean) = this()
    def this(_insertedAsDefault: Boolean, _calculated: Boolean) = this()
    def this(_insertedAsDefault: Unit, _calculated: Boolean) = this()
    def this(_insertedAsDefault: Boolean, _calculated: Boolean, _optional: Boolean) = this()
  ...
  type NodeMetadata = typings.raml1Parser.highLevelASTMod.NodeMetadata
  
  type RamlParserError = typings.raml1Parser.highLevelASTMod.RamlParserError
  
  type SerializeOptions = typings.raml1Parser.highLevelASTMod.SerializeOptions
  
  type ValueMetaData_ = typings.raml1Parser.highLevelASTMod.ValueMetadata
