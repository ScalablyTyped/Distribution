...
@JSImport("raml-1-parser/dist/parser/artifacts/raml08parser", "FullUriTemplateStringImpl")
@js.native
open class FullUriTemplateStringImpl protected () extends UriTemplateImpl {
  def this(attr: IAttribute) = this()
}
/* static members */
object FullUriTemplateStringImpl {
