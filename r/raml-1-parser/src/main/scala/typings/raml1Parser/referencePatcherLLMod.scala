...
import typings.raml1Parser.expanderLLMod.DefaultTransformer
...
import typings.raml1Parser.referencePatcherMod.PatchMode
import typings.raml1Parser.referencePatcherMod.PatchedReference
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object referencePatcherLLMod {
  ...
  object TransitionKind extends StObject {
    ...
    sealed trait ACTION
      extends StObject
         with TransitionKind
    /* 2 */ val ACTION: typings.raml1Parser.referencePatcherLLMod.TransitionKind.ACTION & Double = js.native
    
    @js.native
    sealed trait BASIC
      extends StObject
         with TransitionKind
    /* 0 */ val BASIC: typings.raml1Parser.referencePatcherLLMod.TransitionKind.BASIC & Double = js.native
    
    @js.native
    sealed trait MIXED
      extends StObject
         with TransitionKind
    /* 3 */ val MIXED: typings.raml1Parser.referencePatcherLLMod.TransitionKind.MIXED & Double = js.native
    
    @js.native
    sealed trait ONE_OF
      extends StObject
         with TransitionKind
    /* 1 */ val ONE_OF: typings.raml1Parser.referencePatcherLLMod.TransitionKind.ONE_OF & Double = js.native
  }
