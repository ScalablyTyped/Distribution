...
object distParserLowLevelASTMod {
  ...
  object CommandKind extends StObject {
    ...
    sealed trait ADD_CHILD
      extends StObject
         with CommandKind
    /* 0 */ val ADD_CHILD: typings.raml1Parser.distParserLowLevelASTMod.CommandKind.ADD_CHILD & Double = js.native
    
    @js.native
    sealed trait CHANGE_KEY
      extends StObject
         with CommandKind
    /* 3 */ val CHANGE_KEY: typings.raml1Parser.distParserLowLevelASTMod.CommandKind.CHANGE_KEY & Double = js.native
    
    @js.native
    sealed trait CHANGE_VALUE
      extends StObject
         with CommandKind
    /* 4 */ val CHANGE_VALUE: typings.raml1Parser.distParserLowLevelASTMod.CommandKind.CHANGE_VALUE & Double = js.native
    
    @js.native
    sealed trait INIT_RAML_FILE
      extends StObject
         with CommandKind
    /* 5 */ val INIT_RAML_FILE: typings.raml1Parser.distParserLowLevelASTMod.CommandKind.INIT_RAML_FILE & Double = js.native
    
    @js.native
    sealed trait MOVE_CHILD
      extends StObject
         with CommandKind
    /* 2 */ val MOVE_CHILD: typings.raml1Parser.distParserLowLevelASTMod.CommandKind.MOVE_CHILD & Double = js.native
    
    @js.native
    sealed trait REMOVE_CHILD
      extends StObject
         with CommandKind
    /* 1 */ val REMOVE_CHILD: typings.raml1Parser.distParserLowLevelASTMod.CommandKind.REMOVE_CHILD & Double = js.native
  }
  ...
  object InsertionPointType extends StObject {
    ...
    /* 2 */ val END: typings.raml1Parser.distParserLowLevelASTMod.InsertionPointType.END & Double = js.native
    
    @js.native
    sealed trait NONE
      extends StObject
         with InsertionPointType
    /* 0 */ val NONE: typings.raml1Parser.distParserLowLevelASTMod.InsertionPointType.NONE & Double = js.native
    
    @js.native
    sealed trait POINT
      extends StObject
         with InsertionPointType
    /* 3 */ val POINT: typings.raml1Parser.distParserLowLevelASTMod.InsertionPointType.POINT & Double = js.native
    
    @js.native
    sealed trait START
      extends StObject
         with InsertionPointType
    /* 1 */ val START: typings.raml1Parser.distParserLowLevelASTMod.InsertionPointType.START & Double = js.native
  }
