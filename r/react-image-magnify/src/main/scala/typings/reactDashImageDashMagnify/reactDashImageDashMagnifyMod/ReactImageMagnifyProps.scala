...
import typings.reactDashImageDashMagnify.Anon_Height
...
trait ReactImageMagnifyProps extends js.Object {
  ...
  /**
    ...
    */
  var enlargedImageContainerDimensions: js.UndefOr[Anon_Height] = js.undefined
  /**
...
object ReactImageMagnifyProps {
  ...
  def apply(
    ...
    enlargedImageContainerDimensions: Anon_Height = null,
    ...
    val __obj = js.Dynamic.literal(largeImage = largeImage, smallImage = smallImage)
    if (className != null) __obj.updateDynamic("className")(className)
    if (enlargedImageClassName != null) __obj.updateDynamic("enlargedImageClassName")(enlargedImageClassName)
    if (enlargedImageContainerClassName != null) __obj.updateDynamic("enlargedImageContainerClassName")(enlargedImageContainerClassName)
    if (enlargedImageContainerDimensions != null) __obj.updateDynamic("enlargedImageContainerDimensions")(enlargedImageContainerDimensions)
    if (enlargedImageContainerStyle != null) __obj.updateDynamic("enlargedImageContainerStyle")(enlargedImageContainerStyle)
    if (enlargedImagePortalId != null) __obj.updateDynamic("enlargedImagePortalId")(enlargedImagePortalId)
    if (enlargedImagePosition != null) __obj.updateDynamic("enlargedImagePosition")(enlargedImagePosition)
    if (enlargedImageStyle != null) __obj.updateDynamic("enlargedImageStyle")(enlargedImageStyle)
    ...
    if (hintTextMouse != null) __obj.updateDynamic("hintTextMouse")(hintTextMouse)
    if (hintTextTouch != null) __obj.updateDynamic("hintTextTouch")(hintTextTouch)
    ...
    if (imageClassName != null) __obj.updateDynamic("imageClassName")(imageClassName)
    if (imageStyle != null) __obj.updateDynamic("imageStyle")(imageStyle)
    if (!js.isUndefined(isActivatedOnTouch)) __obj.updateDynamic("isActivatedOnTouch")(isActivatedOnTouch)
    if (!js.isUndefined(isEnlargedImagePortalEnabledForTouch)) __obj.updateDynamic("isEnlargedImagePortalEnabledForTouch")(isEnlargedImagePortalEnabledForTouch)
    if (!js.isUndefined(isHintEnabled)) __obj.updateDynamic("isHintEnabled")(isHintEnabled)
    if (lensComponent != null) __obj.updateDynamic("lensComponent")(js.Any.fromFunction0(lensComponent))
    if (lensStyle != null) __obj.updateDynamic("lensStyle")(lensStyle)
    ...
    if (!js.isUndefined(shouldHideHintAfterFirstActivation)) __obj.updateDynamic("shouldHideHintAfterFirstActivation")(shouldHideHintAfterFirstActivation)
    if (!js.isUndefined(shouldUsePositiveSpaceLens)) __obj.updateDynamic("shouldUsePositiveSpaceLens")(shouldUsePositiveSpaceLens)
