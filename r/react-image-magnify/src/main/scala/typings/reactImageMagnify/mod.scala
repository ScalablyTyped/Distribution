...
object mod {
  ...
  inline def default(props: ReactImageMagnifyPropsRea): ReactElement = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[ReactElement]
