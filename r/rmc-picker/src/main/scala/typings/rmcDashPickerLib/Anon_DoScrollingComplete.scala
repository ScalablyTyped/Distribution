...
@js.native
trait Anon_DoScrollingComplete extends js.Object {
  var context: js.Any = js.native
  var doScrollingComplete: js.Function3[/* top */ js.Any, /* itemHeight */ js.Any, /* fireValueChange */ js.Any, scala.Unit] = js.native
  ...
  var select: js.Function3[/* value */ js.Any, /* itemHeight */ js.Any, /* scrollTo */ js.Any, scala.Unit] = js.native
