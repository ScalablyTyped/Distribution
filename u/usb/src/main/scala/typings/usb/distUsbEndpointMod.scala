...
import typings.usb.distUsbBindingsMod.Transfer
...
object distUsbEndpointMod {
  
  /* note: abstract class */ @JSImport("usb/dist/usb/endpoint", "Endpoint")
  @js.native
  open class Endpoint protected () extends EventEmitter {
