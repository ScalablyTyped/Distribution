...
import typings.usb.usbMod.BosDescriptor
import typings.usb.usbMod.Capability
import typings.usb.usbMod.CapabilityDescriptor
import typings.usb.usbMod.ConfigDescriptor
import typings.usb.usbMod.Device
import typings.usb.usbMod.DeviceDescriptor
import typings.usb.usbMod.Endpoint
import typings.usb.usbMod.EndpointDescriptor
import typings.usb.usbMod.InEndpoint
import typings.usb.usbMod.Interface
import typings.usb.usbMod.InterfaceDescriptor
import typings.usb.usbMod.LibUSBException
import typings.usb.usbMod.OutEndpoint
