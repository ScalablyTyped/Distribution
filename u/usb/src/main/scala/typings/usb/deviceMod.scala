...
import typings.usb.capabilityMod.Capability
import typings.usb.descriptorsMod.BosDescriptor
import typings.usb.descriptorsMod.ConfigDescriptor
import typings.usb.interfaceMod.Interface
