...
@js.native
object urllibModMembers extends js.Object {
  ...
  def curl(url: java.lang.String): stdLib.Promise[_] = js.native
  def curl(url: java.lang.String, callback: Callback): scala.Unit = js.native
  def curl(url: java.lang.String, options: RequestOptions): stdLib.Promise[_] = js.native
  def curl(url: java.lang.String, options: RequestOptions, callback: Callback): scala.Unit = js.native
  def curl(url: nodeLib.urlMod.URL): stdLib.Promise[_] = js.native
  def curl(url: nodeLib.urlMod.URL, callback: Callback): scala.Unit = js.native
  def curl(url: nodeLib.urlMod.URL, options: RequestOptions): stdLib.Promise[_] = js.native
  def curl(url: nodeLib.urlMod.URL, options: RequestOptions, callback: Callback): scala.Unit = js.native
  def request(url: java.lang.String): stdLib.Promise[_] = js.native
  def request(url: java.lang.String, callback: Callback): scala.Unit = js.native
  def request(url: java.lang.String, options: RequestOptions): stdLib.Promise[_] = js.native
  def request(url: java.lang.String, options: RequestOptions, callback: Callback): scala.Unit = js.native
  def request(url: nodeLib.urlMod.URL): stdLib.Promise[_] = js.native
  def request(url: nodeLib.urlMod.URL, callback: Callback): scala.Unit = js.native
  def request(url: nodeLib.urlMod.URL, options: RequestOptions): stdLib.Promise[_] = js.native
