...
import typings.urllib.urllibStrings.buffer
import typings.urllib.urllibStrings.html
import typings.urllib.urllibStrings.json
import typings.urllib.urllibStrings.stream
import typings.urllib.urllibStrings.text
