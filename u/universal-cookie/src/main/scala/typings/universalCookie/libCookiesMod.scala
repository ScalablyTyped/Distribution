...
import typings.universalCookie.libTypesMod.CookieChangeListener
import typings.universalCookie.libTypesMod.CookieGetOptions
import typings.universalCookie.libTypesMod.CookieParseOptions
import typings.universalCookie.libTypesMod.CookieSetOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libCookiesMod {
  
  @JSImport("universal-cookie/lib/Cookies", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
       with Cookies {
