...
object utilsMod {
  ...
  inline def canAcceptRef(component: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("canAcceptRef")(component.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  inline def uncontrolledPropTypes(controlledValues: js.Any, displayName: String): js.Object = (^.asInstanceOf[js.Dynamic].applyDynamic("uncontrolledPropTypes")(controlledValues.asInstanceOf[js.Any], displayName.asInstanceOf[js.Any])).asInstanceOf[js.Object]
}
