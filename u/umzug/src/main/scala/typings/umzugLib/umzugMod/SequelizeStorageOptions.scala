...
trait SequelizeStorageOptions extends Storage {
  ...
  /**
    ...
    */
  var columnType: sequelizeLib.sequelizeMod.DataTypeAbstract
  /**
    * The to be used Sequelize model.
    * Must have column name matching `columnName` option
    * Optional of `sequelize` is passed.
    */
  var model: js.UndefOr[sequelizeLib.sequelizeMod.Model[_, _, _]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var sequelize: js.UndefOr[sequelizeLib.sequelizeMod.Sequelize] = js.undefined
  /**
...
object SequelizeStorageOptions {
  ...
  def apply(
    ...
    columnType: sequelizeLib.sequelizeMod.DataTypeAbstract,
    ...
    model: sequelizeLib.sequelizeMod.Model[_, _, _] = null,
    modelName: java.lang.String = null,
    sequelize: sequelizeLib.sequelizeMod.Sequelize = null,
