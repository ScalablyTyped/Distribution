...
trait PullStream
  ...
  def pull(eof: java.lang.String, includeEof: scala.Boolean): stdLib.Promise[nodeLib.Buffer] = js.native
  def pull(eof: scala.Double, includeEof: scala.Boolean): stdLib.Promise[nodeLib.Buffer] = js.native
