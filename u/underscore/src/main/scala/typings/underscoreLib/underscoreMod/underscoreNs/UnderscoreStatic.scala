...
trait UnderscoreStatic extends js.Object {
  ...
  /**
          ...
          **/
  def isArguments(`object`: js.Any): /* is IArguments */scala.Boolean = js.native
  /**
  ...
  /**
          ...
          **/
  @JSName("isArray")
  def isArray_T[T](`object`: js.Any): /* is Array */scala.Boolean = js.native
  /**
  ...
  /**
          ...
          **/
  def isElement(`object`: js.Any): /* is Element */scala.Boolean = js.native
  /**
  ...
  /**
          ...
          **/
  def isFunction(`object`: js.Any): /* is Function */scala.Boolean = js.native
  /**
