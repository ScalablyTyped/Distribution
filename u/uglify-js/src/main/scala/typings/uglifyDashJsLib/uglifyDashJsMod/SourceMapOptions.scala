...
trait SourceMapOptions extends js.Object {
  ...
  var url: js.UndefOr[java.lang.String | uglifyDashJsLib.uglifyDashJsLibStrings.`inline`] = js.undefined
}
...
object SourceMapOptions {
  ...
  def apply(
    ...
    url: java.lang.String | uglifyDashJsLib.uglifyDashJsLibStrings.`inline` = null
  ): SourceMapOptions = {
