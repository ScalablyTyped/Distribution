...
import typings.atUifabricUtilities.atUifabricUtilitiesStrings.`ms-Fabric--isFocusVisible`
import typings.atUifabricUtilities.atUifabricUtilitiesStrings.change
...
object atUifabricUtilitiesMod extends js.Object {
  @js.native
  class Async ()
    extends typings.atUifabricUtilities.libAsyncMod.Async {
  ...
  class AutoScroll protected ()
    extends typings.atUifabricUtilities.libAutoScrollMod.AutoScroll {
  ...
  class DelayedRender protected ()
    extends typings.atUifabricUtilities.libDelayedRenderMod.DelayedRender {
  ...
  @js.native
  class Rectangle ()
    extends typings.atUifabricUtilities.libRectangleMod.Rectangle {
  ...
  @js.native
  class Selection ()
    extends typings.atUifabricUtilities.libSelectionMod.Selection {
