...
trait Anon_DefaultRender[T] extends js.Object {
  var defaultRender: js.UndefOr[reactLib.reactMod.ComponentType[T]] = js.undefined
}

object Anon_DefaultRender {
  @scala.inline
  def apply[T](defaultRender: reactLib.reactMod.ComponentType[T] = null): Anon_DefaultRender[T] = {
