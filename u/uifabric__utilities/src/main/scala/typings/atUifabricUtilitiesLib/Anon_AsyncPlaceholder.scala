...
trait Anon_AsyncPlaceholder extends js.Object {
  var asyncPlaceholder: js.UndefOr[reactLib.reactMod.ReactType[_]] = js.undefined
}

object Anon_AsyncPlaceholder {
  @scala.inline
  def apply(asyncPlaceholder: reactLib.reactMod.ReactType[_] = null): Anon_AsyncPlaceholder = {
