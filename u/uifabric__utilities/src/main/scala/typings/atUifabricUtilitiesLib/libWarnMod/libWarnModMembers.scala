...
@js.native
object libWarnModMembers extends js.Object {
  ...
  def warnDeprecations[P](componentName: java.lang.String, props: P, deprecationMap: ISettingsMap[P]): scala.Unit = js.native
  def warnMutuallyExclusive[P](componentName: java.lang.String, props: P, exclusiveMap: ISettingsMap[P]): scala.Unit = js.native
}
