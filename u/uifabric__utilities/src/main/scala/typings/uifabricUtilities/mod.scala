...
import typings.uifabricUtilities.uifabricUtilitiesStrings.change
...
object mod extends js.Object {
  ...
  def allowOverscrollOnElement(element: HTMLElement, events: typings.uifabricUtilities.eventGroupMod.EventGroup): Unit = js.native
  def allowScrollOnElement(element: Null, events: typings.uifabricUtilities.eventGroupMod.EventGroup): Unit = js.native
