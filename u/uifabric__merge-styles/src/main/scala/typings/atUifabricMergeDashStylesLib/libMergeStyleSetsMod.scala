...
@js.native
object libMergeStyleSetsMod extends js.Object {
  ...
  @JSName("mergeStyleSets")
  def mergeStyleSets_false[TStyleSet /* <: atUifabricMergeDashStylesLib.libIStyleSetMod.IStyleSet[TStyleSet] */](styleSet: atUifabricMergeDashStylesLib.atUifabricMergeDashStylesLibNumbers.`false`): atUifabricMergeDashStylesLib.libIStyleSetMod.IProcessedStyleSet[TStyleSet] = js.native
  @JSName("mergeStyleSets")
