...
object libConcatStyleSetsMod extends js.Object {
  ...
  @JSName("concatStyleSets")
  def concatStyleSets_false[TStyleSet /* <: atUifabricMergeDashStylesLib.libIStyleSetMod.IStyleSet[TStyleSet] */](styleSet: atUifabricMergeDashStylesLib.atUifabricMergeDashStylesLibNumbers.`false`): atUifabricMergeDashStylesLib.libIStyleSetMod.IConcatenatedStyleSet[TStyleSet] = js.native
  @JSName("concatStyleSets")
