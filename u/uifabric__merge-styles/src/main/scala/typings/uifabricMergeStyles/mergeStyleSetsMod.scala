...
object mergeStyleSetsMod {
  
  @JSImport("@uifabric/merge-styles/lib/mergeStyleSets", "mergeCssSets")
  @js.native
  ...
  @JSImport("@uifabric/merge-styles/lib/mergeStyleSets", "mergeStyleSets")
  @js.native
