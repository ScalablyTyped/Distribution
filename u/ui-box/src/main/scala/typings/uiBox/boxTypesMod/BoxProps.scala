...
/* Inlined ui-box.ui-box/dist/types/box-types.InheritedProps<T> & ui-box.ui-box/dist/types/enhancers.EnhancerProps & {  is ? :T,   innerRef ? :(ref : ui-box.ui-box/dist/types/box-types.RefType<T>): void | react.react.RefObject<ui-box.ui-box/dist/types/box-types.RefType<T>>} */
trait BoxProps[T /* <: Is[_] */] extends js.Object {
  ...
  var opacity: js.UndefOr[OpacityProperty | Double | `false`] = js.undefined
  ...
  var textDecoration: js.UndefOr[(TextDecorationProperty[String | `0`]) | Double | `false`] = js.undefined
...
object BoxProps {
  ...
  def apply[T /* <: Is[_] */](
    ...
    innerRef: (js.Function1[/* ref */ RefType[T], Unit]) | RefObject[RefType[T]] = null,
    is: T = null,
    ...
    opacity: OpacityProperty | Double | `false` = null,
    ...
    textDecoration: (TextDecorationProperty[String | `0`]) | Double | `false` = null,
