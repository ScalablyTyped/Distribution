package typings.uiBox.domNodesMod
...
trait DomNodes extends js.Object {
  var a: HTMLAnchorElement
  var abbr: HTMLElement
  var address: HTMLElement
  var animate: SVGElement
  var animateMotion: SVGElement
  var animateTransform: SVGElement
  ...
  var meter: HTMLElement
  var mpath: SVGElement
  var nav: HTMLElement
  var noindex: HTMLElement
