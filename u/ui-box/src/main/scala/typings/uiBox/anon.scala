...
import typings.uiBox.distSrcTypesEnhancersMod.SelectorMap
...
object anon {
  ...
  trait AllowUnsafeHref[E /* <: ElementType[Any] */] extends StObject {
  ...
  object AllowUnsafeHref {
    ...
    inline def apply[E /* <: ElementType[Any] */](): AllowUnsafeHref[E] = {
  ...
  /* Inlined ui-box.ui-box/dist/src/types/enhancers.BoxCssProps<ui-box.ui-box/dist/src/types/enhancers.CssProps> */
  trait BoxCssPropsCssProps extends StObject {
  ...
  object BoxCssPropsCssProps {
    
    inline def apply(): BoxCssPropsCssProps = {
      val __obj = js.Dynamic.literal()
  ...
  trait BoxOwnPropsElementTypeany extends StObject {
    ...
    var is: js.UndefOr[ElementType[Any]] = js.undefined
  ...
  object BoxOwnPropsElementTypeany {
    ...
    implicit open class MutableBuilder[Self <: BoxOwnPropsElementTypeany] (val x: Self) extends AnyVal {
      ...
      inline def setIs(value: ElementType[Any]): Self = StObject.set(x, "is", value.asInstanceOf[js.Any])
