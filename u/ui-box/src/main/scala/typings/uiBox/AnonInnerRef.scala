...
trait AnonInnerRef[T /* <: Is[_] */] extends js.Object {
  /**
...
object AnonInnerRef {
  @scala.inline
  def apply[T /* <: Is[_] */](innerRef: (js.Function1[/* ref */ RefType[T], Unit]) | RefObject[RefType[T]] = null, is: T = null): AnonInnerRef[T] = {
    val __obj = js.Dynamic.literal()
    if (innerRef != null) __obj.updateDynamic("innerRef")(innerRef.asInstanceOf[js.Any])
    if (is != null) __obj.updateDynamic("is")(is.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonInnerRef[T]]
  }
}
