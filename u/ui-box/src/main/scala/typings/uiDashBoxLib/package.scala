...
package object uiDashBoxLib {
  type CSSProps = /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify CSS.StandardProperties */ js.Any
  type CacheEntry = js.Array[js.Tuple2[/** key */ java.lang.String, /** value */ java.lang.String]]
  /** A prop defining which */
  type UIBoxIsProp = java.lang.String | (/* import warning: QualifyReferences.resolveTypeRef Couldn't qualify ReactNode */ js.Any)
