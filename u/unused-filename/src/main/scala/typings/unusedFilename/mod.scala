...
object mod {
  ...
  /**
  	...
  	*/
  // TODO: Remove this for the next major release
  inline def default(filePath: String): js.Promise[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(filePath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[String]]
  ...
  /**
  	...
  	@returns Either the original `filename` or the `filename` appended with a number.
  	*/
  inline def sync(filePath: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("sync")(filePath.asInstanceOf[js.Any]).asInstanceOf[String]
}
