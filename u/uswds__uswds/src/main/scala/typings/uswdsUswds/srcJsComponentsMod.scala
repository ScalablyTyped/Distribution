...
object srcJsComponentsMod {
  
  @JSImport("@uswds/uswds/src/js/components", "accordion")
  @js.native
  val accordion: Accordion = js.native
  
  @JSImport("@uswds/uswds/src/js/components", "banner")
  @js.native
  val banner: Banner = js.native
  
  @JSImport("@uswds/uswds/src/js/components", "characterCount")
  @js.native
  val characterCount: CharacterCount = js.native
  
  @JSImport("@uswds/uswds/src/js/components", "comboBox")
  @js.native
  val comboBox: ComboBox = js.native
  
  @JSImport("@uswds/uswds/src/js/components", "datePicker")
  @js.native
  ...
  @JSImport("@uswds/uswds/src/js/components", "footer")
  @js.native
  ...
  @JSImport("@uswds/uswds/src/js/components", "navigation")
  @js.native
  val navigation: Navigation = js.native
  
  @JSImport("@uswds/uswds/src/js/components", "password")
  @js.native
  val password: Password = js.native
  
  @JSImport("@uswds/uswds/src/js/components", "search")
  @js.native
  val search: Search = js.native
  
  @JSImport("@uswds/uswds/src/js/components", "skipnav")
  @js.native
  val skipnav: Skipnav = js.native
  
  @JSImport("@uswds/uswds/src/js/components", "table")
  @js.native
  val table: Table = js.native
  
  @JSImport("@uswds/uswds/src/js/components", "timePicker")
  @js.native
  val timePicker: TimePicker = js.native
  
  @JSImport("@uswds/uswds/src/js/components", "tooltip")
  @js.native
  val tooltip: Tooltip = js.native
  
  @JSImport("@uswds/uswds/src/js/components", "validator")
  @js.native
