...
trait UploadFileOption extends js.Object {
  ...
  var fileType: js.UndefOr[
    uniDashAppLib.uniDashAppLibStrings.image | uniDashAppLib.uniDashAppLibStrings.video | uniDashAppLib.uniDashAppLibStrings.audio
  ] = js.undefined
  /**
  ...
  /**
    * 成功返回的回调函数
    */
  var success: js.UndefOr[js.Function1[/* result */ UploadFileSuccessCallbackResult, scala.Unit]] = js.undefined
  /**
    * 开发者服务器 url
    */
...
object UploadFileOption {
  ...
  def apply(
    ...
    fileType: uniDashAppLib.uniDashAppLibStrings.image | uniDashAppLib.uniDashAppLibStrings.video | uniDashAppLib.uniDashAppLibStrings.audio = null,
    files: js.Array[UploadFileOptionFiles] = null,
    formData: js.Any = null,
    header: js.Any = null,
    name: java.lang.String = null,
    success: /* result */ UploadFileSuccessCallbackResult => scala.Unit = null,
