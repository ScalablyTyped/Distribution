...
trait GetBluetoothAdapterStateOptions extends js.Object {
  ...
  /**
    * 成功则返回本机蓝牙适配器状态
    */
  var success: js.UndefOr[js.Function1[/* result */ GetBluetoothAdapterStateSuccess, scala.Unit]] = js.undefined
}
...
object GetBluetoothAdapterStateOptions {
  ...
  def apply(
    ...
    success: /* result */ GetBluetoothAdapterStateSuccess => scala.Unit = null
