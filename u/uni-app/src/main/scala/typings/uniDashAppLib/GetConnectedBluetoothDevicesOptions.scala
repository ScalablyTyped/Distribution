...
trait GetConnectedBluetoothDevicesOptions extends js.Object {
  ...
  /**
    * 成功则返回本机蓝牙适配器状态
    */
  var success: js.UndefOr[js.Function1[/* result */ GetConnectedBluetoothDevicesSuccess, scala.Unit]] = js.undefined
}
...
object GetConnectedBluetoothDevicesOptions {
  ...
  def apply(
    ...
    success: /* result */ GetConnectedBluetoothDevicesSuccess => scala.Unit = null
