...
trait CheckIsSupportSoterAuthenticationOptions extends js.Object {
  ...
  /**
    * 接口调用成功的回调函数
    */
  var success: js.UndefOr[js.Function1[/* result */ CheckIsSupportSoterAuthenticationRes, scala.Unit]] = js.undefined
}
...
object CheckIsSupportSoterAuthenticationOptions {
  ...
  def apply(
    ...
    success: /* result */ CheckIsSupportSoterAuthenticationRes => scala.Unit = null
