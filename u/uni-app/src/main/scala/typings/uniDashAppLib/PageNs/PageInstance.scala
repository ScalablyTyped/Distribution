...
trait PageInstance[D /* <: uniDashAppLib.AnyObject */, T /* <: uniDashAppLib.AnyObject */] extends PageInstanceBaseProps[D] {
  ...
  /**
    ...
    */
  var onLoad: js.UndefOr[js.Function1[/* query */ js.UndefOr[uniDashAppLib.AnyObject], scala.Unit]] = js.undefined
  /**
    * 监听原生标题栏按钮点击事件
    * @param options tab 点击参数
    */
  var onNavigationBarButtonTap: js.UndefOr[js.Function1[/* options */ NavigationBarButtonTapOption, scala.Unit]] = js.undefined
  /**
    * 监听原生标题栏搜索输入框输入内容变化事件
    */
  var onNavigationBarSearchInputChanged: js.UndefOr[js.Function1[/* event */ NavigationBarSearchInputEvent, scala.Unit]] = js.undefined
  /**
    * 监听原生标题栏搜索输入框点击事件
    */
  var onNavigationBarSearchInputClicked: js.UndefOr[js.Function0[scala.Unit]] = js.undefined
  /**
    * 监听原生标题栏搜索输入框搜索事件，用户点击软键盘上的“搜索”按钮时触发。
    */
  var onNavigationBarSearchInputConfirmed: js.UndefOr[js.Function1[/* event */ NavigationBarSearchInputEvent, scala.Unit]] = js.undefined
  /**
    * 页面滚动触发事件的处理函数
    *
    * 监听用户滑动页面事件。
    ...
    */
  var onPageScroll: js.UndefOr[js.Function1[/* options */ PageScrollOption, scala.Unit]] = js.undefined
  /**
    * 监听用户下拉动作
  ...
  /**
    ...
    * @param options 页面滚动参数
    */
  var onResize: js.UndefOr[js.Function1[/* options */ PageScrollOption, scala.Unit]] = js.undefined
  /**
    * 用户点击右上角转发
    *
  ...
  /**
    ...
    * @param options tab 点击参数
    */
  var onTabItemTap: js.UndefOr[js.Function1[/* options */ TabItemTapOption, scala.Unit]] = js.undefined
  /**
    * 生命周期回调 监听页面卸载
    *
...
object PageInstance {
  ...
  def apply[D /* <: uniDashAppLib.AnyObject */, T /* <: uniDashAppLib.AnyObject */](
    ...
    onNavigationBarButtonTap: /* options */ NavigationBarButtonTapOption => scala.Unit = null,
    onNavigationBarSearchInputChanged: /* event */ NavigationBarSearchInputEvent => scala.Unit = null,
    onNavigationBarSearchInputClicked: () => scala.Unit = null,
    onNavigationBarSearchInputConfirmed: /* event */ NavigationBarSearchInputEvent => scala.Unit = null,
    onPageScroll: /* options */ PageScrollOption => scala.Unit = null,
    onPullDownRefresh: () => scala.Unit = null,
    onReachBottom: () => scala.Unit = null,
    onReady: () => scala.Unit = null,
    onResize: /* options */ PageScrollOption => scala.Unit = null,
    onShareAppMessage: /* options */ ShareAppMessageOption => CustomShareContent = null,
    onShow: () => scala.Unit = null,
    onTabItemTap: /* options */ TabItemTapOption => scala.Unit = null,
