...
trait AppInstance[T /* <: uniDashAppLib.AnyObject */] extends js.Object {
  ...
  /**
    ...
    */
  var onPageNotFound: js.UndefOr[js.Function1[/* options */ PageNotFoundOption, scala.Unit]] = js.undefined
  /**
    * 生命周期回调 监听应用显示
    *
    * 应用启动，或从后台进入前台显示时触发
...
object AppInstance {
  ...
  def apply[T /* <: uniDashAppLib.AnyObject */](
    ...
    onPageNotFound: /* options */ PageNotFoundOption => scala.Unit = null,
