...
trait GetBluetoothDevicesOptions extends js.Object {
  ...
  /**
    * 成功则返回本机蓝牙适配器状态
    */
  var success: js.UndefOr[js.Function1[/* result */ GetBluetoothDevicesSuccess, scala.Unit]] = js.undefined
}
...
object GetBluetoothDevicesOptions {
  ...
  def apply(
    ...
    success: /* result */ GetBluetoothDevicesSuccess => scala.Unit = null
