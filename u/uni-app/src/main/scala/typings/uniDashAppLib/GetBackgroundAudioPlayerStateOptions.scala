...
trait GetBackgroundAudioPlayerStateOptions extends js.Object {
  ...
  /**
    * 接口调用成功的回调函数
    */
  var success: js.UndefOr[js.Function1[/* result */ GetBackgroundAudioPlayerStateSuccessData, scala.Unit]] = js.undefined
}
...
object GetBackgroundAudioPlayerStateOptions {
  ...
  def apply(
    ...
    success: /* result */ GetBackgroundAudioPlayerStateSuccessData => scala.Unit = null
