...
trait RecorderManagerStartOptions extends js.Object {
  ...
  /**
    * 编码码率，有效值见下表格
    */
  var encodeBitRate: js.UndefOr[scala.Double] = js.undefined
  /**
    * 音频格式，有效值 aac/mp3
    */
  ...
  /**
    ...
    */
  var frameSize: js.UndefOr[scala.Double] = js.undefined
  /**
    * 录音通道数，有效值 1/2
    */
...
object RecorderManagerStartOptions {
  ...
  def apply(
    ...
    encodeBitRate: scala.Int | scala.Double = null,
    format: java.lang.String = null,
    frameSize: scala.Int | scala.Double = null,
