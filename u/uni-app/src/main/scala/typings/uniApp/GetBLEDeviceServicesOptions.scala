...
object GetBLEDeviceServicesOptions {
  ...
  @scala.inline
  def apply(): GetBLEDeviceServicesOptions = {
  ...
  implicit class GetBLEDeviceServicesOptionsMutableBuilder[Self <: GetBLEDeviceServicesOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetBLEDeviceServicesSuccess => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
