...
object GetBLEDeviceServicesOptions {
  ...
  inline def apply(): GetBLEDeviceServicesOptions = {
  ...
  extension [Self <: GetBLEDeviceServicesOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetBLEDeviceServicesSuccess => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
