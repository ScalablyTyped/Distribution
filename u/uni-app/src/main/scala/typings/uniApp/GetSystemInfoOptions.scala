...
trait GetSystemInfoOptions extends StObject {
  ...
  /**
    * 接口调用成功的回调函数
    */
  var success: js.UndefOr[js.Function1[/* result */ GetSystemInfoResult, Unit]] = js.native
}
object GetSystemInfoOptions {
  ...
  implicit class GetSystemInfoOptionsMutableBuilder[Self <: GetSystemInfoOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetSystemInfoResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
