...
trait StartBeaconDiscoveryOptions extends StObject {
  ...
  /**
    * iBeacon设备广播的 uuids
    */
  var uuids: js.UndefOr[js.Array[_]] = js.native
}
object StartBeaconDiscoveryOptions {
  
  @scala.inline
  def apply(): StartBeaconDiscoveryOptions = {
  ...
  implicit class StartBeaconDiscoveryOptionsMutableBuilder[Self <: StartBeaconDiscoveryOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUuids(value: js.Array[_]): Self = StObject.set(x, "uuids", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUuidsUndefined: Self = StObject.set(x, "uuids", js.undefined)
    
    @scala.inline
    def setUuidsVarargs(value: js.Any*): Self = StObject.set(x, "uuids", js.Array(value :_*))
  }
}
