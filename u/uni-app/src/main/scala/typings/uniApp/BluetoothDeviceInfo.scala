...
object BluetoothDeviceInfo {
  ...
  implicit class BluetoothDeviceInfoMutableBuilder[Self <: BluetoothDeviceInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdvertisData(value: js.Array[js.Any]): Self = StObject.set(x, "advertisData", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setServiceData(value: js.Array[js.Any]): Self = StObject.set(x, "serviceData", value.asInstanceOf[js.Any])
