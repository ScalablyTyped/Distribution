...
object PageInstanceBaseProps {
  @scala.inline
  def apply[/* <: typings.uniApp.AnyObject */ D](): PageInstanceBaseProps[D] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PageInstanceBaseProps[D]]
  }
  @scala.inline
  implicit class PageInstanceBasePropsOps[Self <: PageInstanceBaseProps[_], /* <: typings.uniApp.AnyObject */ D] (val x: Self with PageInstanceBaseProps[D]) extends AnyVal {
    @scala.inline
