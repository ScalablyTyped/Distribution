...
object PageInstance {
  @scala.inline
  def apply[/* <: typings.uniApp.AnyObject */ D, /* <: typings.uniApp.AnyObject */ T](): PageInstance[D, T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PageInstance[D, T]]
  }
  @scala.inline
  implicit class PageInstanceOps[Self <: PageInstance[_, _], /* <: typings.uniApp.AnyObject */ D, /* <: typings.uniApp.AnyObject */ T] (val x: Self with (PageInstance[D, T])) extends AnyVal {
    @scala.inline
