...
object ChooseAddressOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ChooseAddressOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ ChooseAddressRes => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
