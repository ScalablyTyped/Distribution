...
@js.native
trait SetKeepScreenOnOptions extends StObject {
  ...
  /**
    * 是否保持屏幕常亮
    */
  var keepScreenOn: js.UndefOr[Boolean] = js.native
...
object SetKeepScreenOnOptions {
  ...
  @scala.inline
  def apply(): SetKeepScreenOnOptions = {
  ...
  implicit class SetKeepScreenOnOptionsMutableBuilder[Self <: SetKeepScreenOnOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeepScreenOnUndefined: Self = StObject.set(x, "keepScreenOn", js.undefined)
