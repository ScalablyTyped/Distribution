...
object CameraContextStopRecordOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CameraContextStopRecordOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ CameraContextStopRecordResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
