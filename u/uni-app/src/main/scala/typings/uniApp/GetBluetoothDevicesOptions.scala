...
object GetBluetoothDevicesOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetBluetoothDevicesOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ GetBluetoothDevicesSuccess => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
