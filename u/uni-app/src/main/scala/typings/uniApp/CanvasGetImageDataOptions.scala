...
object CanvasGetImageDataOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CanvasGetImageDataOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ CanvasGetImageDataRes => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
