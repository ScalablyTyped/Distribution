package typings
package atUirouterAngularjsLib.libStateProviderMod
...
class StateProvider protected () extends js.Object {
  ...
  /**
    ...
    */
  def state(name: java.lang.String, definition: atUirouterAngularjsLib.libInterfaceMod.Ng1StateDeclaration): StateProvider = js.native
}
