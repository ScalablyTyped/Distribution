package typings
package atUirouterAngularjsLib.libTemplateFactoryMod
...
class TemplateFactory ()
  extends atUirouterAngularjsLib.libInterfaceMod.TemplateFactoryProvider {
  /** @hidden */ @JSName("$get")
  var $get: js.Array[
    java.lang.String | (js.Function3[/* $http */ _, /* $templateCache */ _, /* $injector */ _, this.type])
  ] = js.native
  /** @hidden */ @JSName("$http")
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def useHttpService(useUnsafeHttpService: scala.Boolean): js.Any = js.native
}
