...
object angularjsModMembers extends js.Object {
  ...
  @JSName("eq")
  val eq_FangularjsModMembers: js.Function1[/* comp */ js.Any, atUirouterCoreLib.libCommonCommonMod.Predicate[js.Any]] = js.native
  @JSName("equals")
  ...
  val getLocals: js.Function1[
    /* ctx */ atUirouterCoreLib.coreMod.ResolveContext, 
    atUirouterCoreLib.libCommonCommonMod.TypedMap[js.Any]
  ] = js.native
