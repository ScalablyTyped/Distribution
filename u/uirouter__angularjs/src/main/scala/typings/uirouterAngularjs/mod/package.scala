...
import typings.uirouterAngularjs.mod.^
import typings.uirouterAngularjs.uirouterAngularjsStrings.uiDotrouter
...
inline def getLocals(ctx: typings.uirouterCore.mod.ResolveContext): TypedMap[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("getLocals")(ctx.asInstanceOf[js.Any]).asInstanceOf[TypedMap[Any]]
...
inline def ng1ViewsBuilder(state: typings.uirouterCore.mod.StateObject): StringDictionary[Ng1ViewDeclaration] = ^.asInstanceOf[js.Dynamic].applyDynamic("ng1ViewsBuilder")(state.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Ng1ViewDeclaration]]
