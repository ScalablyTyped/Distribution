...
object ^ extends js.Object {
  ...
  def decodeImages(buffer: nodeLib.Buffer, ifds: js.Array[utifLib.utifMod.IFD]): scala.Unit = js.native
  def decodeImages(buffer: stdLib.ArrayBuffer, ifds: js.Array[utifLib.utifMod.IFD]): scala.Unit = js.native
