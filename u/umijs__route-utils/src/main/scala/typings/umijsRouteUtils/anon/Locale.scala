...
trait Locale extends js.Object {
  var children: js.Array[Icon] = js.native
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenVarargs(value: Icon*): Self = this.set("children", js.Array(value :_*))
    @scala.inline
    def setChildren(value: js.Array[Icon]): Self = this.set("children", value.asInstanceOf[js.Any])
    @scala.inline
