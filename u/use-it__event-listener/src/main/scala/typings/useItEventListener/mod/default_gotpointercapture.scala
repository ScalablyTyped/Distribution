...
object default_gotpointercapture extends js.Object {
  ...
  def apply(eventName: gotpointercapture, handler: PointerEvent, element: Document): Unit = js.native
  def apply(eventName: gotpointercapture, handler: PointerEvent, element: Document, options: Options): Unit = js.native
  def apply(
    eventName: gotpointercapture,
    handler: PointerEvent,
    // allow null to support usage with `useRef<HTMLElement | null>(null)`
