...
object ^ extends js.Object {
  /**
    ...
    */
  def default(initialState: scala.Boolean): DarkMode = js.native
  def default(initialState: scala.Boolean, darkModeConfig: stdLib.Partial[DarkModeConfig]): DarkMode = js.native
}
