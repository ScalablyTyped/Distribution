...
object URISchemeHandler {
  ...
  @scala.inline
  implicit class URISchemeHandlerOps[Self <: URISchemeHandler[_, _, _], Components /* <: URIComponents */, Options /* <: URIOptions */, ParentComponents /* <: URIComponents */] (val x: Self with (URISchemeHandler[Components, Options, ParentComponents])) extends AnyVal {
