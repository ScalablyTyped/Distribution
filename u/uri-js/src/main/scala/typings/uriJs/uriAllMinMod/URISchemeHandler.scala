...
object URISchemeHandler {
  @scala.inline
  def apply[/* <: typings.uriJs.uriAllMinMod.URIComponents */ Components, /* <: typings.uriJs.uriAllMinMod.URIOptions */ Options, /* <: typings.uriJs.uriAllMinMod.URIComponents */ ParentComponents](
  ...
  @scala.inline
  implicit class URISchemeHandlerOps[Self <: URISchemeHandler[_, _, _], /* <: typings.uriJs.uriAllMinMod.URIComponents */ Components, /* <: typings.uriJs.uriAllMinMod.URIOptions */ Options, /* <: typings.uriJs.uriAllMinMod.URIComponents */ ParentComponents] (val x: Self with (URISchemeHandler[Components, Options, ParentComponents])) extends AnyVal {
    @scala.inline
