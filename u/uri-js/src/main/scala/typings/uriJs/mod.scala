...
object mod {
  ...
  @JSImport("uri-js", "escapeComponent")
  @js.native
  ...
  @JSImport("uri-js", "removeDotSegments")
  @js.native
  def removeDotSegments(input: String): String = js.native
  
  @JSImport("uri-js", "resolve")
  @js.native
  ...
  @JSImport("uri-js", "unescapeComponent")
  @js.native
