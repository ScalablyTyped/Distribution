...
trait NotSupportedError
  ...
  var code: UND_ERR_NOT_SUPPORTED
  
  @JSName("name")
  var name_NotSupportedError: typings.undici.undiciStrings.NotSupportedError
}
object NotSupportedError {
  ...
  implicit open class MutableBuilder[Self <: NotSupportedError] (val x: Self) extends AnyVal {
    ...
    inline def setName(value: typings.undici.undiciStrings.NotSupportedError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
  }
}
