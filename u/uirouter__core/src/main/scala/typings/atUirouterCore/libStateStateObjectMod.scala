...
@js.native
object libStateStateObjectMod extends js.Object {
  @js.native
  /** @deprecated use State.create() */
  class StateObject () extends _StateOrName {
    def this(config: StateDeclaration) = this()
    /** @hidden */
    var __stateObjectCache: Anon_NameGlob = js.native
    ...
    var redirectTo: String | (js.Function1[/* $transition$ */ Transition, TargetState]) | Anon_Key = js.native
    ...
    /**
      ...
      */
    var views: StringDictionary[_ViewDeclaration] = js.native
    /**
    ...
    def parameter(id: String, opts: Anon_InheritBoolean): Param = js.native
    /**
    ...
    def parameters(opts: Anon_Inherit): js.Array[Param] = js.native
    /**
