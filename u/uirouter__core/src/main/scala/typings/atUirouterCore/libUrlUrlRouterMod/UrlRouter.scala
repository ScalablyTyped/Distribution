package typings.atUirouterCore.libUrlUrlRouterMod

import typings.atUirouterCore.Anon_Absolute
import typings.atUirouterCore.Anon_Priority
import typings.atUirouterCore.Anon_Replace
...
class UrlRouter protected () extends js.Object {
  ...
  def href(urlMatcher: UrlMatcher, params: js.Any, options: Anon_Absolute): String = js.native
  ...
  def push(urlMatcher: UrlMatcher, params: RawParams, options: Anon_Replace): Unit = js.native
