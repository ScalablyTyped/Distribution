...
import typings.atUirouterCore.libStateInterfaceMod.HrefOptions
...
@js.native
object libStateStateServiceMod extends js.Object {
  @js.native
  class StateService protected () extends js.Object {
    ...
    def is(stateOrName: StateOrName, params: RawParams, options: Anon_Relative): Boolean = js.native
    /**
      * Lazy loads a state
      *
