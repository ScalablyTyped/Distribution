package typings.atUirouterCore.libResolveResolvableMod
...
- typings.atUirouterCore.libStateInterfaceMod.ResolveTypes because Already inherited */ @JSImport("@uirouter/core/lib/resolve/resolvable", "Resolvable")
@js.native
