...
@js.native
object libResolveResolveContextMod extends js.Object {
  @js.native
  class ResolveContext protected () extends js.Object {
    ...
    /**
      ...
      */
    def resolvePath(): js.Promise[js.Array[Anon_Token]] = js.native
    def resolvePath(when: PolicyWhen): js.Promise[js.Array[Anon_Token]] = js.native
    def resolvePath(when: PolicyWhen, trans: Transition): js.Promise[js.Array[Anon_Token]] = js.native
    /**
