...
import typings.atUirouterCore.Anon_DefaultValue
import typings.atUirouterCore.Anon_From
...
class Param protected () extends js.Object {
  ...
  var _defaultValueCache: Anon_DefaultValue = js.native
  ...
  var replace: js.Array[Anon_From] = js.native
