...
object libPathMod extends js.Object {
  ...
  @js.native
  class PathUtils ()
    extends typings.atUirouterCore.libPathPathUtilsMod.PathUtils
  ...
  object PathUtils extends js.Object {
    ...
    def buildPath(targetState: TargetState): js.Array[typings.atUirouterCore.libPathPathNodeMod.PathNode] = js.native
    /** Given a fromPath: PathNode[] and a TargetState, builds a toPath: PathNode[] */
    def buildToPath(fromPath: js.Array[typings.atUirouterCore.libPathPathNodeMod.PathNode], targetState: TargetState): js.Array[typings.atUirouterCore.libPathPathNodeMod.PathNode] = js.native
    /**
    ...
    def makeTargetState(registry: StateRegistry, path: js.Array[typings.atUirouterCore.libPathPathNodeMod.PathNode]): TargetState = js.native
    /**
    ...
    def nonDynamicParams(node: typings.atUirouterCore.libPathPathNodeMod.PathNode): js.Array[Param] = js.native
