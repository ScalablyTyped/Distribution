...
class UrlService protected ()
  ...
  override var deferIntercept: (js.Function1[/* defer */ js.UndefOr[scala.Boolean], scala.Unit]) | (/* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibraryScoped(uirouter,Some(core)), TsIdentModule(Some(uirouter),List(core, lib, url, urlService)), TsIdentSimple(UrlService))),List()),Left(TsIdentSimple(deferIntercept))) */js.Any) = js.native
  /** @hidden */ var interceptDeferred: scala.Boolean = js.native
  /** See: [[UrlService.listen]] */ /* CompleteClass */
  override var listen: (js.Function1[/* enabled */ js.UndefOr[scala.Boolean], js.Function]) | (/* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibraryScoped(uirouter,Some(core)), TsIdentModule(Some(uirouter),List(core, lib, url, urlService)), TsIdentSimple(UrlService))),List()),Left(TsIdentSimple(listen))) */js.Any) = js.native
  ...
  override var sync: (js.Function1[/* evt */ js.UndefOr[js.Any], scala.Unit]) | (/* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibraryScoped(uirouter,Some(core)), TsIdentModule(Some(uirouter),List(core, lib, url, urlService)), TsIdentSimple(UrlService))),List()),Left(TsIdentSimple(sync))) */js.Any) = js.native
  /**
