package typings
package atUirouterCoreLib.libTransitionTransitionMod
...
class Transition protected ()
  ...
  /** @hidden */
  var _aborted: scala.Boolean = js.native
  ...
  var _registeredHooks_Transition: atUirouterCoreLib.libTransitionInterfaceMod.RegisteredHooks = js.native
  /** @hidden */
  ...
  /**
    ...
    */
  @JSName("$from")
  def $from(): atUirouterCoreLib.libStateStateObjectMod.StateObject = js.native
  /**
    * @internalapi
    *
    ...
    */
  @JSName("$to")
  def $to(): atUirouterCoreLib.libStateStateObjectMod.StateObject = js.native
  /** @hidden */
  def _ignoredReason(): js.UndefOr[
    atUirouterCoreLib.atUirouterCoreLibStrings.SameAsCurrent | atUirouterCoreLib.atUirouterCoreLibStrings.SameAsPending
  ] = js.native
  /**
  ...
  def addResolvable(resolvable: atUirouterCoreLib.libResolveInterfaceMod.ResolvableLiteral): scala.Unit = js.native
  def addResolvable(
    resolvable: atUirouterCoreLib.libResolveInterfaceMod.ResolvableLiteral,
    state: atUirouterCoreLib.libStateInterfaceMod.StateOrName
  ...
  /**
    ...
    */
  def addResolvable(resolvable: atUirouterCoreLib.libResolveResolvableMod.Resolvable): scala.Unit = js.native
  def addResolvable(
  ...
  /**
    ...
    * @returns true if the Transition is dynamic
    */
  def dynamic(): scala.Boolean = js.native
  /**
    * Gets the states being entered.
    *
    * @returns an array of states that will be entered during this transition.
    */
  def entering(): js.Array[atUirouterCoreLib.libStateInterfaceMod.StateDeclaration] = js.native
  /**
    ...
    */
  def error(): atUirouterCoreLib.libTransitionRejectFactoryMod.Rejection = js.native
  /**
    * Gets the states being exited.
    *
    * @returns an array of states that will be exited during this transition.
    */
  def exiting(): js.Array[atUirouterCoreLib.libStateInterfaceMod.StateDeclaration] = js.native
  /**
    ...
    */
  def from(): atUirouterCoreLib.libStateInterfaceMod.StateDeclaration = js.native
  /**
  ...
  def getResolveTokens(pathname: java.lang.String): js.Array[_] = js.native
  /**
    ...
    * @returns true if the Transition is ignored.
    */
  def ignored(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @deprecated
    */
  def is(compare: Transition): scala.Boolean = js.native
  ...
  @JSName("params")
  def params_TT[T](): T = js.native
  @JSName("params")
  def params_TT[T](pathname: java.lang.String): T = js.native
  /**
    ...
    */
  def redirect(targetState: atUirouterCoreLib.libStateTargetStateMod.TargetState): Transition = js.native
  /**
  ...
  /**
    ...
    */
  def retained(): js.Array[atUirouterCoreLib.libStateInterfaceMod.StateDeclaration] = js.native
  /**
    * Runs the transition
    *
  ...
  /**
    ...
    */
  def targetState(): atUirouterCoreLib.libStateTargetStateMod.TargetState = js.native
  /**
    ...
    */
  def to(): atUirouterCoreLib.libStateInterfaceMod.StateDeclaration = js.native
  def treeChanges(): atUirouterCoreLib.libTransitionInterfaceMod.TreeChanges = js.native
  /**
    ...
    *   (`'to'`, `'from'`, `'entering'`, `'exiting'`, `'retained'`)
    */
  def treeChanges(pathname: java.lang.String): js.Array[atUirouterCoreLib.libPathPathNodeMod.PathNode] = js.native
  /**
  ...
  /**
    ...
    */
  def views(): js.Array[atUirouterCoreLib.libViewInterfaceMod.ViewConfig] = js.native
  def views(pathname: java.lang.String): js.Array[atUirouterCoreLib.libViewInterfaceMod.ViewConfig] = js.native
