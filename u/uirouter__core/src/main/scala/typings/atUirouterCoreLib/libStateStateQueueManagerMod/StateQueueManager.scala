...
class StateQueueManager protected ()
  ...
  var states: ScalablyTyped.runtime.StringDictionary[atUirouterCoreLib.libStateStateObjectMod.StateObject] = js.native
  def attachRoute(state: atUirouterCoreLib.libStateStateObjectMod.StateObject): scala.Unit = js.native
  def flush(): ScalablyTyped.runtime.StringDictionary[atUirouterCoreLib.libStateStateObjectMod.StateObject] = js.native
