...
trait LocationServices
  ...
  /** See: [[UrlService.onChange]] */ var onChange: (/* import warning: ImportType.apply Failed type conversion: @uirouter/core.@uirouter/core/lib/url.UrlService['onChange'] */ js.Any) | (js.Function1[/* callback */ stdLib.EventListener, js.Function]) = js.native
