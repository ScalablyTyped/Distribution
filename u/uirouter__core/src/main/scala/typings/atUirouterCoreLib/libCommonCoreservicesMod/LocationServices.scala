...
trait LocationServices
  ...
  /** See: [[UrlService.search]] */ var search: js.Function0[ScalablyTyped.runtime.StringDictionary[_]] | (/* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibraryScoped(uirouter,Some(core)), TsIdentModule(Some(uirouter),List(core, lib, url)), TsIdentSimple(UrlService))),List()),Left(TsIdentSimple(search))) */js.Any) = js.native
