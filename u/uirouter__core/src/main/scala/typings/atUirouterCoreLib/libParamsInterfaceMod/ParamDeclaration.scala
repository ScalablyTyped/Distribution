...
trait ParamDeclaration extends js.Object {
  ...
  /**
    ...
    */
  var squash: js.UndefOr[scala.Boolean | java.lang.String] = js.undefined
  /**
    ...
    *
    */
  var `type`: js.UndefOr[java.lang.String | atUirouterCoreLib.libParamsParamTypeMod.ParamType] = js.undefined
  /**
