package typings
package atUirouterCoreLib.libStateStateServiceMod
...
class StateService protected () extends js.Object {
  ...
  /**
    ...
    */
  def defaultErrorHandler(): js.Function1[/* error */ js.Any, scala.Unit] = js.native
  def defaultErrorHandler(handler: js.Function1[/* error */ js.Any, scala.Unit]): js.Function1[/* error */ js.Any, scala.Unit] = js.native
  /** @internalapi */
  ...
  /**
    ...
    */
  def go(to: atUirouterCoreLib.libStateInterfaceMod.StateOrName): atUirouterCoreLib.libStateInterfaceMod.TransitionPromise = js.native
  def go(
    to: atUirouterCoreLib.libStateInterfaceMod.StateOrName,
    params: atUirouterCoreLib.libParamsInterfaceMod.RawParams
  ): atUirouterCoreLib.libStateInterfaceMod.TransitionPromise = js.native
  def go(
    to: atUirouterCoreLib.libStateInterfaceMod.StateOrName,
    params: atUirouterCoreLib.libParamsInterfaceMod.RawParams,
    options: atUirouterCoreLib.libTransitionInterfaceMod.TransitionOptions
  ): atUirouterCoreLib.libStateInterfaceMod.TransitionPromise = js.native
  /**
  ...
  def href(
    stateOrName: atUirouterCoreLib.libStateInterfaceMod.StateOrName,
    params: atUirouterCoreLib.libParamsInterfaceMod.RawParams,
    options: atUirouterCoreLib.libStateInterfaceMod.HrefOptions
  ): java.lang.String = js.native
  /**
    ...
    */
  def includes(stateOrName: atUirouterCoreLib.libStateInterfaceMod.StateOrName): scala.Boolean = js.native
  def includes(
    stateOrName: atUirouterCoreLib.libStateInterfaceMod.StateOrName,
    params: atUirouterCoreLib.libParamsInterfaceMod.RawParams
  ...
  /**
    ...
    */
  def is(stateOrName: atUirouterCoreLib.libStateInterfaceMod.StateOrName): scala.Boolean = js.native
  def is(
    stateOrName: atUirouterCoreLib.libStateInterfaceMod.StateOrName,
    params: atUirouterCoreLib.libParamsInterfaceMod.RawParams
  ): scala.Boolean = js.native
  def is(
    stateOrName: atUirouterCoreLib.libStateInterfaceMod.StateOrName,
    params: atUirouterCoreLib.libParamsInterfaceMod.RawParams,
    options: atUirouterCoreLib.Anon_Relative
  ): scala.Boolean = js.native
  /**
    * Lazy loads a state
    *
  ...
  /**
    ...
    */
  def target(identifier: atUirouterCoreLib.libStateInterfaceMod.StateOrName): atUirouterCoreLib.libStateTargetStateMod.TargetState = js.native
  def target(
    identifier: atUirouterCoreLib.libStateInterfaceMod.StateOrName,
    params: atUirouterCoreLib.libParamsInterfaceMod.RawParams
  ...
  /**
    ...
    */
  def transitionTo(to: atUirouterCoreLib.libStateInterfaceMod.StateOrName): atUirouterCoreLib.libStateInterfaceMod.TransitionPromise = js.native
  def transitionTo(
    to: atUirouterCoreLib.libStateInterfaceMod.StateOrName,
    toParams: atUirouterCoreLib.libParamsInterfaceMod.RawParams
  ): atUirouterCoreLib.libStateInterfaceMod.TransitionPromise = js.native
  def transitionTo(
    to: atUirouterCoreLib.libStateInterfaceMod.StateOrName,
    toParams: atUirouterCoreLib.libParamsInterfaceMod.RawParams,
