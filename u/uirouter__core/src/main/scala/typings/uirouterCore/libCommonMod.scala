...
object libCommonMod {
  ...
  open class Glob protected ()
    extends typings.uirouterCore.libCommonGlobMod.Glob {
  ...
  @js.native
  open class Queue[T] ()
    extends typings.uirouterCore.libCommonQueueMod.Queue[T] {
  ...
  /** @internal */
  open class Trace_ ()
    extends typings.uirouterCore.libCommonTraceMod.Trace_
  ...
  @JSImport("@uirouter/core/lib/common", "trace")
  @js.native
  val trace: typings.uirouterCore.libCommonTraceMod.Trace_ = js.native
