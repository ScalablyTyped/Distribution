...
object libPathMod {
  ...
  open class PathNode protected ()
    extends typings.uirouterCore.libPathPathNodeMod.PathNode {
  ...
  open class PathUtils ()
    extends typings.uirouterCore.libPathPathUtilsMod.PathUtils
  /* static members */
  object PathUtils {
    ...
    inline def buildPath(targetState: TargetState): js.Array[typings.uirouterCore.libPathPathNodeMod.PathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("buildPath")(targetState.asInstanceOf[js.Any]).asInstanceOf[js.Array[typings.uirouterCore.libPathPathNodeMod.PathNode]]
    
    /** Given a fromPath: PathNode[] and a TargetState, builds a toPath: PathNode[] */
    inline def buildToPath(fromPath: js.Array[typings.uirouterCore.libPathPathNodeMod.PathNode], targetState: TargetState): js.Array[typings.uirouterCore.libPathPathNodeMod.PathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("buildToPath")(fromPath.asInstanceOf[js.Any], targetState.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.uirouterCore.libPathPathNodeMod.PathNode]]
    ...
    inline def makeTargetState(registry: StateRegistry, path: js.Array[typings.uirouterCore.libPathPathNodeMod.PathNode]): TargetState = (^.asInstanceOf[js.Dynamic].applyDynamic("makeTargetState")(registry.asInstanceOf[js.Any], path.asInstanceOf[js.Any])).asInstanceOf[TargetState]
    ...
    inline def nonDynamicParams(node: typings.uirouterCore.libPathPathNodeMod.PathNode): js.Array[Param] = ^.asInstanceOf[js.Dynamic].applyDynamic("nonDynamicParams")(node.asInstanceOf[js.Any]).asInstanceOf[js.Array[Param]]
