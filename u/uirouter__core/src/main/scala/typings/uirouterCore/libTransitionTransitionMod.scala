...
import typings.uirouterCore.anon.To
import typings.uirouterCore.anon.TypeofTransition
import typings.uirouterCore.libInterfaceMod.UIInjector
...
import typings.uirouterCore.libTransitionRejectFactoryMod.Rejection
...
object libTransitionTransitionMod {
