...
object libParamsMod {
  ...
  object DefType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.uirouterCore.libParamsParamMod.DefType & Double] = js.native
  ...
  open class Param protected ()
    extends typings.uirouterCore.libParamsParamMod.Param {
    def this(
      id: String,
  ...
  open class ParamType protected ()
    extends typings.uirouterCore.libParamsParamTypeMod.ParamType {
    /**
  ...
  open class ParamTypes ()
    extends typings.uirouterCore.libParamsParamTypesMod.ParamTypes
  /* static members */
  object ParamTypes {
  ...
  open class StateParams ()
    extends typings.uirouterCore.libParamsStateParamsMod.StateParams {
