...
import typings.uirouterCore.libUrlInterfaceMod.UrlSyncApi
import typings.uirouterCore.libUrlUrlConfigMod.UrlConfig
import typings.uirouterCore.libUrlUrlRulesMod.UrlRules
