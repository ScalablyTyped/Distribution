...
import typings.uirouterCore.libResolveResolveContextMod.ResolveContext
...
object libResolveResolvableMod {
  ...
  - typings.uirouterCore.libStateInterfaceMod.ResolveTypes because Already inherited */ @JSImport("@uirouter/core/lib/resolve/resolvable", "Resolvable")
  @js.native
