...
import typings.uirouterCore.libUrlInterfaceMod.MatchResult
import typings.uirouterCore.libUrlInterfaceMod.UrlParts
import typings.uirouterCore.libUrlInterfaceMod.UrlRule
...
import typings.uirouterCore.libUrlUrlRuleMod.UrlRuleFactory
