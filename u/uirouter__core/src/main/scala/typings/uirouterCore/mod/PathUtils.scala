...
object PathUtils {
  ...
  /**
    ...
    */
  @JSImport("@uirouter/core", "PathUtils.applyViewConfigs")
  @js.native
  ...
  @JSImport("@uirouter/core", "PathUtils.buildPath")
  @js.native
  ...
  @JSImport("@uirouter/core", "PathUtils.buildToPath")
  @js.native
  def buildToPath(
  ...
  /**
    ...
    */
  @JSImport("@uirouter/core", "PathUtils.equals")
  @js.native
  def equals(
  ...
  /**
    ...
    */
  @JSImport("@uirouter/core", "PathUtils.inheritParams")
  @js.native
  def inheritParams(
    fromPath: js.Array[typings.uirouterCore.pathNodeMod.PathNode],
  ...
  @JSImport("@uirouter/core", "PathUtils.makeTargetState")
  @js.native
  def makeTargetState(
  ...
  /**
    ...
    */
  @JSImport("@uirouter/core", "PathUtils.matching")
  @js.native
  def matching(
    pathA: js.Array[typings.uirouterCore.pathNodeMod.PathNode],
    pathB: js.Array[typings.uirouterCore.pathNodeMod.PathNode]
  ...
  @JSImport("@uirouter/core", "PathUtils.nonDynamicParams")
  @js.native
  ...
  @JSImport("@uirouter/core", "PathUtils.paramValues")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@uirouter/core", "PathUtils.subPath")
  @js.native
  def subPath(
    path: js.Array[typings.uirouterCore.pathNodeMod.PathNode],
  ...
  /**
    ...
    */
  @JSImport("@uirouter/core", "PathUtils.treeChanges")
  @js.native
  def treeChanges(
    fromPath: js.Array[typings.uirouterCore.pathNodeMod.PathNode],
    toPath: js.Array[typings.uirouterCore.pathNodeMod.PathNode],
