...
package object mod {
  ...
  @scala.inline
  def _inArray(array: js.Array[_]): js.Function1[/* obj */ js.Any, scala.Boolean] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("_inArray")(array.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* obj */ js.Any, scala.Boolean]]
  @scala.inline
  def _inArray(array: js.Array[_], obj: js.Any): scala.Boolean = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("_inArray")(array.asInstanceOf[js.Any], obj.asInstanceOf[js.Any])).asInstanceOf[scala.Boolean]
  ...
  @scala.inline
  def all(fn1: typings.uirouterCore.commonCommonMod.Predicate[_]): js.Function1[/* arr */ js.Array[_], scala.Boolean] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("all")(fn1.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* arr */ js.Array[_], scala.Boolean]]
  ...
  ): typings.uirouterCore.commonCommonMod.Predicate[_] = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("and")(fn1.asInstanceOf[js.Any], fn2.asInstanceOf[js.Any])).asInstanceOf[typings.uirouterCore.commonCommonMod.Predicate[_]]
  
  @scala.inline
  def any(fn1: typings.uirouterCore.commonCommonMod.Predicate[_]): js.Function1[/* arr */ js.Array[_], scala.Boolean] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("any")(fn1.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* arr */ js.Array[_], scala.Boolean]]
  ...
  @scala.inline
  def applyPairs(memo: typings.uirouterCore.commonCommonMod.TypedMap[_], keyValTuple: js.Array[_]): typings.uirouterCore.commonCommonMod.TypedMap[_] = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("applyPairs")(memo.asInstanceOf[js.Any], keyValTuple.asInstanceOf[js.Any])).asInstanceOf[typings.uirouterCore.commonCommonMod.TypedMap[_]]
  
  @scala.inline
  def arrayTuples(args: js.Any*): js.Array[_] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("arrayTuples")(args.asInstanceOf[js.Any]).asInstanceOf[js.Array[_]]
  ...
  @scala.inline
  def compose(): js.Function0[_] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("compose")().asInstanceOf[js.Function0[_]]
  ...
  @scala.inline
  def eq_(comp: js.Any): typings.uirouterCore.commonCommonMod.Predicate[_] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("eq")(comp.asInstanceOf[js.Any]).asInstanceOf[typings.uirouterCore.commonCommonMod.Predicate[_]]
  ...
  def extend: js.Function2[
    ...
    js.Any
  ] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].selectDynamic("extend").asInstanceOf[js.Function2[
    /* toObj */ typings.uirouterCore.commonCommonMod.Obj, 
    /* repeated */ typings.uirouterCore.commonCommonMod.Obj, 
    js.Any
  ]]
  ...
  @scala.inline
  def flatten(arr: js.Array[_]): js.Any = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("flatten")(arr.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  
  @scala.inline
  def flattenR(memo: js.Array[_], elem: js.Any): js.Array[_] = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("flattenR")(memo.asInstanceOf[js.Any], elem.asInstanceOf[js.Any])).asInstanceOf[js.Array[_]]
  ...
  @scala.inline
  def inArray(array: js.Array[_]): js.Function1[/* obj */ js.Any, scala.Boolean] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("inArray")(array.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* obj */ js.Any, scala.Boolean]]
  @scala.inline
  def inArray(array: js.Array[_], obj: js.Any): scala.Boolean = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("inArray")(array.asInstanceOf[js.Any], obj.asInstanceOf[js.Any])).asInstanceOf[scala.Boolean]
  ...
  @scala.inline
  def invoke(fnName: java.lang.String, args: js.Array[_]): js.Function = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("invoke")(fnName.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[js.Function]
  ...
  @scala.inline
  def joinNeighborsR(acc: js.Array[_], x: js.Any): js.Array[_] = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("joinNeighborsR")(acc.asInstanceOf[js.Any], x.asInstanceOf[js.Any])).asInstanceOf[js.Array[_]]
  ...
  @scala.inline
  def keyValsToObjectR(accum: js.Any, hasKeyVal: js.Tuple2[_, _]): js.Any = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("keyValsToObjectR")(accum.asInstanceOf[js.Any], hasKeyVal.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  ] = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("locationPluginFactory")(name.asInstanceOf[js.Any], isHtml5.asInstanceOf[js.Any], serviceClass.asInstanceOf[js.Any], configurationClass.asInstanceOf[js.Any])).asInstanceOf[js.Function1[
    /* uiRouter */ typings.uirouterCore.routerMod.UIRouter, 
    typings.uirouterCore.anon.Configuration
  ]]
  ...
  def makeEvent(
    ...
    _
  ] = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("makeEvent")(registry.asInstanceOf[js.Any], transitionService.asInstanceOf[js.Any], eventType.asInstanceOf[js.Any])).asInstanceOf[js.Function3[
    /* matchObject */ js.Any, 
    /* callback */ js.Any, 
    /* options */ js.UndefOr[js.Object], 
    _
  ...
  ] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].selectDynamic("mapObj").asInstanceOf[js.Function3[
    /* collection */ org.scalablytyped.runtime.StringDictionary[js.Any], 
    /* callback */ typings.uirouterCore.commonCommonMod.Mapper[js.Any, js.Any], 
    /* target */ js.UndefOr[
      /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof collection */ js.Any
  ...
  @scala.inline
  def not(fn: typings.uirouterCore.commonCommonMod.Predicate[_]): typings.uirouterCore.commonCommonMod.Predicate[_] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("not")(fn.asInstanceOf[js.Any]).asInstanceOf[typings.uirouterCore.commonCommonMod.Predicate[_]]
  ...
  def or(
    fn1: typings.uirouterCore.commonCommonMod.Predicate[_],
    fn2: typings.uirouterCore.commonCommonMod.Predicate[_]
  ): typings.uirouterCore.commonCommonMod.Predicate[_] = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("or")(fn1.asInstanceOf[js.Any], fn2.asInstanceOf[js.Any])).asInstanceOf[typings.uirouterCore.commonCommonMod.Predicate[_]]
  ...
  @scala.inline
  def pairs(obj: typings.uirouterCore.commonCommonMod.Obj): js.Array[js.Array[_]] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("pairs")(obj.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Array[_]]]
  ...
  @scala.inline
  def pipe(funcs: js.Function*): js.Function1[/* obj */ js.Any, _] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("pipe")(funcs.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* obj */ js.Any, _]]
  ...
  @scala.inline
  def prop(name: java.lang.String): js.Function1[/* obj */ js.Any, _] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("prop")(name.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* obj */ js.Any, _]]
  
  @scala.inline
  def propEq: js.Function = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].selectDynamic("propEq").asInstanceOf[js.Function]
  
  @scala.inline
  def pushR(arr: js.Array[_], obj: js.Any): js.Array[_] = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("pushR")(arr.asInstanceOf[js.Any], obj.asInstanceOf[js.Any])).asInstanceOf[js.Array[_]]
  ...
  @scala.inline
  def silenceUncaughtInPromise(promise: js.Promise[_]): js.Promise[_] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("silenceUncaughtInPromise")(promise.asInstanceOf[js.Any]).asInstanceOf[js.Promise[_]]
  
  @scala.inline
  def silentRejection(error: js.Any): js.Promise[_] = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("silentRejection")(error.asInstanceOf[js.Any]).asInstanceOf[js.Promise[_]]
  ...
  @scala.inline
  def unnest(arr: js.Array[_]): js.Any = typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("unnest")(arr.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  
  @scala.inline
  def unnestR(memo: js.Array[_], elem: js.Array[_]): js.Array[_] = (typings.uirouterCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("unnestR")(memo.asInstanceOf[js.Any], elem.asInstanceOf[js.Any])).asInstanceOf[js.Array[_]]
