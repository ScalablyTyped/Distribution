...
import typings.uirouterCore.libParamsInterfaceMod.ParamDeclaration
...
object libStateInterfaceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typings.uirouterCore.libStateTargetStateMod.TargetState
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.uirouterCore.libResolveResolvableMod.Resolvable
    - typings.uirouterCore.libResolveInterfaceMod.ResolvableLiteral
    - typings.uirouterCore.libResolveInterfaceMod.ProviderLike
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typings.uirouterCore.libStateInterfaceMod.StateDeclaration
    - typings.uirouterCore.libStateStateObjectMod.StateObject
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.uirouterCore.libStateInterfaceMod.StateDeclaration
    - typings.uirouterCore.anon.InstantiableStateDeclaration
  */
