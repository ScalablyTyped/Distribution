package typings
package atUifabricStylingLib.libInterfacesIFontStylesMod
...
trait IFontStyles extends js.Object {
  var large: atUifabricMergeDashStylesLib.libIStyleMod.IRawStyle
  var medium: atUifabricMergeDashStylesLib.libIStyleMod.IRawStyle
  var mediumPlus: atUifabricMergeDashStylesLib.libIStyleMod.IRawStyle
  var mega: atUifabricMergeDashStylesLib.libIStyleMod.IRawStyle
  var small: atUifabricMergeDashStylesLib.libIStyleMod.IRawStyle
  var smallPlus: atUifabricMergeDashStylesLib.libIStyleMod.IRawStyle
