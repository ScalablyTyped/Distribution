...
object PartialIEffects {
  ...
  def apply(
    ...
    roundedCorner4: String = null,
    roundedCorner6: String = null
  ): PartialIEffects = {
    ...
    if (roundedCorner4 != null) __obj.updateDynamic("roundedCorner4")(roundedCorner4.asInstanceOf[js.Any])
    if (roundedCorner6 != null) __obj.updateDynamic("roundedCorner6")(roundedCorner6.asInstanceOf[js.Any])
