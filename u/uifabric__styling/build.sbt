...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "microsoft__load-themed-styles" % "1.8.51-cc56d4",
  ...
  "org.scalablytyped" %%% "uifabric__merge-styles" % "6.15.0-795f63",
  "org.scalablytyped" %%% "uifabric__set-version" % "1.1.3-bc9c0a",
  "org.scalablytyped" %%% "uifabric__utilities" % "6.27.1-7d3ddb")
