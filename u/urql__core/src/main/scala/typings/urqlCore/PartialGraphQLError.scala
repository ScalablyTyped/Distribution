...
object PartialGraphQLError {
  @scala.inline
  def apply(
    constructor: (/* message */ String, /* nodes */ js.UndefOr[js.Array[ASTNode]], /* source */ js.UndefOr[Maybe[Source]], /* positions */ js.UndefOr[Maybe[js.Array[Double]]], /* path */ js.UndefOr[Maybe[js.Array[String | Double]]], /* originalError */ js.UndefOr[Maybe[Error]], /* extensions */ js.UndefOr[Maybe[StringDictionary[_]]]) => js.Any = null,
    extensions: StringDictionary[js.Any] = null,
    locations: js.Array[SourceLocation] = null,
    message: String = null,
    name: String = null,
    nodes: js.Array[ASTNode] = null,
    originalError: Maybe[Error] = null,
