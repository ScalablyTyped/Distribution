...
object Anon_CallbackErr {
  @scala.inline
  def apply(
    remove: (java.lang.String, js.Function2[/* err */ stdLib.Error, /* res */ uploadcareLib.uploadcareMod.File, scala.Unit]) => scala.Unit,
    store: (java.lang.String, js.Function2[/* err */ stdLib.Error, /* res */ uploadcareLib.uploadcareMod.File, scala.Unit]) => scala.Unit
  ): Anon_CallbackErr = {
