...
object Result {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(`og:description` = `og:description`, `og:determiner` = `og:determiner`, `og:image` = `og:image`, `og:image:height` = `og:image:height`, `og:image:secure_url` = `og:image:secure_url`, `og:image:type` = `og:image:type`, `og:image:width` = `og:image:width`, `og:locale` = `og:locale`, `og:locale:alternate` = `og:locale:alternate`, `og:site_name` = `og:site_name`, `og:title` = `og:title`, `og:type` = `og:type`, `og:url` = `og:url`)
