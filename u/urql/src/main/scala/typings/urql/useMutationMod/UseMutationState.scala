...
object UseMutationState {
  @scala.inline
  def apply[T](fetching: Boolean, stale: Boolean): UseMutationState[T] = {
  ...
  @scala.inline
  implicit class UseMutationStateOps[Self <: UseMutationState[_], T] (val x: Self with UseMutationState[T]) extends AnyVal {
    @scala.inline
