...
trait UrlAssembler extends js.Object {
  ...
  def param(params: org.scalablytyped.runtime.StringDictionary[js.Any]): UrlAssembler = js.native
  def param(params: org.scalablytyped.runtime.StringDictionary[js.Any], strict: scala.Boolean): UrlAssembler = js.native
  ...
  def query(params: org.scalablytyped.runtime.StringDictionary[js.Any]): UrlAssembler = js.native
