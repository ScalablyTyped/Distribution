...
object finderMod {
  ...
  type GitIgnore = typings.unifiedEngine.ignoreMod.Ignore
  
  type Ignore = typings.unifiedEngine.ignoreMod.Ignore
  ...
  trait SearchResults extends StObject {
    ...
    var stats: js.UndefOr[typings.node.nodeFsMod.Stats] = js.undefined
  }
  object SearchResults {
    ...
    extension [Self <: SearchResults](x: Self) {
      ...
      inline def setStats(value: typings.node.nodeFsMod.Stats): Self = StObject.set(x, "stats", value.asInstanceOf[js.Any])
