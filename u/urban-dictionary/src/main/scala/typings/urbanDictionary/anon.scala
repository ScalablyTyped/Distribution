...
object anon {
  ...
  object Entries {
    ...
    inline def apply(entries: js.Array[WordDefinition], sounds: js.Array[String], tags: js.Array[String]): Entries = {
    ...
    extension [Self <: Entries](x: Self) {
      ...
      inline def setEntries(value: js.Array[WordDefinition]): Self = StObject.set(x, "entries", value.asInstanceOf[js.Any])
      
      inline def setEntriesVarargs(value: WordDefinition*): Self = StObject.set(x, "entries", js.Array(value :_*))
      
      inline def setSounds(value: js.Array[String]): Self = StObject.set(x, "sounds", value.asInstanceOf[js.Any])
      
      inline def setSoundsVarargs(value: String*): Self = StObject.set(x, "sounds", js.Array(value :_*))
