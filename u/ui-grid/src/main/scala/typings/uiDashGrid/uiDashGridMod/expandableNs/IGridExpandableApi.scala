package typings.uiDashGrid.uiDashGridMod.expandableNs

import typings.uiDashGrid.Anon_HandlerRowExpandedStateChanged
...
trait IGridExpandableApi[TEntity] extends js.Object {
  // Events
  var on: Anon_HandlerRowExpandedStateChanged[TEntity]
  // Methods
  /**
...
object IGridExpandableApi {
  ...
  def apply[TEntity](
    ...
    expandAllRows: () => Unit,
    on: Anon_HandlerRowExpandedStateChanged[TEntity],
    toggleAllRows: () => Unit,
