...
trait ICellNavApi[TEntity] extends js.Object {
  ...
  /**
    ...
    */
  def scrollToFocus(rowEntity: TEntity, colDef: typings.uiDashGrid.uiDashGridMod.cellNavNs.IColumnDef): IPromise[_]
}
...
object ICellNavApi {
  ...
  def apply[TEntity](
    ...
    scrollToFocus: (TEntity, typings.uiDashGrid.uiDashGridMod.cellNavNs.IColumnDef) => IPromise[_]
  ): ICellNavApi[TEntity] = {
