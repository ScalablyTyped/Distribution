...
trait IGridSelectionApi[TEntity] extends js.Object {
  ...
  def clearSelectedRows(event: angularLib.angularMod.IAngularEvent): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getSelectedGridRows(): js.Array[uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity]] = js.native
  /**
  ...
  def selectAllRows(event: angularLib.angularMod.IAngularEvent): scala.Unit = js.native
  /**
    * Selects all visible rows.  Does nothing if multiselect = false
    * @param {ng.IAngularEvent} event object if raised from event
    */
  def selectAllVisibleRows(): scala.Unit = js.native
  def selectAllVisibleRows(event: angularLib.angularMod.IAngularEvent): scala.Unit = js.native
  /**
    * Select row by data
  ...
  def selectRow(rowEntity: TEntity, event: angularLib.angularMod.IAngularEvent): scala.Unit = js.native
  /**
  ...
  def selectRowByVisibleIndex(index: scala.Double, event: angularLib.angularMod.IAngularEvent): scala.Unit = js.native
  /**
  ...
  def toggleRowSelection(rowEntity: TEntity, event: angularLib.angularMod.IAngularEvent): scala.Unit = js.native
  /**
  ...
  def unSelectRow(rowEntity: TEntity, event: angularLib.angularMod.IAngularEvent): scala.Unit = js.native
}
