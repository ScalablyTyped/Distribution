...
trait IGridTreeBaseApi[TEntity] extends js.Object {
  ...
  /**
    ...
    */
  def collapseRow(row: uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity]): scala.Unit
  /**
    ...
    */
  def collapseRowChildren(row: uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity]): scala.Unit
  /**
  ...
  /**
    ...
    */
  def expandRow(row: uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity]): scala.Unit
  /**
    ...
    */
  def getRowChildren(row: uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity]): js.Array[uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity]]
  /**
  ...
  /**
    ...
    */
  def toggleRowTreeState(row: uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity]): scala.Unit
}
...
object IGridTreeBaseApi {
  ...
  def apply[TEntity](
    ...
    collapseRow: uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity] => scala.Unit,
    collapseRowChildren: uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity] => scala.Unit,
    expandAllRows: () => scala.Unit,
    expandRow: uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity] => scala.Unit,
    getRowChildren: uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity] => js.Array[uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity]],
    getTreeState: () => ITreeState,
    on: uiDashGridLib.Anon_HandlerRowCollapsed[TEntity],
    setTreeState: ITreeState => scala.Unit,
    toggleRowTreeState: uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity] => scala.Unit
