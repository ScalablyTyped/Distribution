...
trait IGridOptions[TEntity] extends js.Object {
  /**
    ...
    */
  var exporterAllDataFn: js.UndefOr[js.Function0[angularLib.angularMod.IPromise[js.Array[TEntity]]]] = js.undefined
  /**
    * @deprecated
    ...
    * @returns {ng.IPromise<Array<TEntity>>} A promise to load all data from server
    */
  var exporterAllDataPromise: js.UndefOr[js.Function0[angularLib.angularMod.IPromise[js.Array[TEntity]]]] = js.undefined
  /**
...
object IGridOptions {
  ...
  def apply[TEntity](
    ...
    exporterFieldCallback: (/* grid */ uiDashGridLib.uiDashGridMod.IGridInstanceOf[TEntity], /* row */ uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity], /* col */ uiDashGridLib.uiDashGridMod.IGridColumnOf[TEntity], /* value */ js.Any) => _ = null,
