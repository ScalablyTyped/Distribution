...
object IColumnDef {
  ...
  def apply[TEntity](
    ...
    customTreeAggregationFn: (/* aggregation */ IGridTreeBaseAggregationObject, /* fieldValue */ js.Any, /* numValue */ scala.Double, /* row */ uiDashGridLib.uiDashGridMod.IGridRowOf[TEntity]) => scala.Unit = null,
