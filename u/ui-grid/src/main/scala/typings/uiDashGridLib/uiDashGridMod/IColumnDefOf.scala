...
trait IColumnDefOf[TEntity]
  extends uiDashGridLib.uiDashGridMod.cellNavNs.IColumnDef
     with uiDashGridLib.uiDashGridMod.editNs.IColumnDef[TEntity]
     with uiDashGridLib.uiDashGridMod.exporterNs.IColumnDef
     with uiDashGridLib.uiDashGridMod.groupingNs.IColumnDef
     with uiDashGridLib.uiDashGridMod.moveColumnsNs.IColumnDef
     with uiDashGridLib.uiDashGridMod.pinningNs.IColumnDef
     with uiDashGridLib.uiDashGridMod.resizeColumnsNs.IColumnDef
     with uiDashGridLib.uiDashGridMod.treeBaseNs.IColumnDef[TEntity] {
  /**
    * defaults to false
...
object IColumnDefOf {
  ...
  def apply[TEntity](
    ...
    customTreeAggregationFinalizerFn: /* aggregation */ uiDashGridLib.uiDashGridMod.treeBaseNs.IGridTreeBaseAggregationObject => scala.Unit = null,
    customTreeAggregationFn: (/* aggregation */ uiDashGridLib.uiDashGridMod.treeBaseNs.IGridTreeBaseAggregationObject, /* fieldValue */ js.Any, /* numValue */ scala.Double, /* row */ IGridRowOf[TEntity]) => scala.Unit = null,
    defaultSort: ISortInfo = null,
    displayName: java.lang.String = null,
    editDropdownFilter: java.lang.String = null,
    editDropdownIdLabel: java.lang.String = null,
    editDropdownOptionsArray: js.Array[uiDashGridLib.uiDashGridMod.editNs.IEditDropdown] = null,
