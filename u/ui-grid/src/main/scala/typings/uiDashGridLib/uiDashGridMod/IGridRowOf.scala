...
trait IGridRowOf[TEntity]
  extends uiDashGridLib.uiDashGridMod.cellNavNs.IGridRow
     with uiDashGridLib.uiDashGridMod.editNs.IGridRow
     with uiDashGridLib.uiDashGridMod.exporterNs.IGridRow
     with uiDashGridLib.uiDashGridMod.selectionNs.IGridRow
     with uiDashGridLib.uiDashGridMod.expandableNs.IGridRow {
  ...
  var exporterEnableExporting_IGridRowOf: scala.Boolean = js.native
  ...
  /**
    ...
    */
  def clearRowInvisible(reason: java.lang.String, fromRowsProcessor: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def clearRowInvisible(row: IGridRowOf[TEntity]): scala.Unit = js.native
  /**
    ...
    * grid refreshes.
    */
  def evaluateRowVisibility(fromRowProcessor: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def getEntityQualifiedColField(col: IGridColumnOf[TEntity]): java.lang.String = js.native
  /**
    ...
    */
  def getQualifiedColField(col: IGridColumnOf[TEntity]): java.lang.String = js.native
  /**
    ...
    */
  def setRowInvisible(row: IGridRowOf[TEntity]): scala.Unit = js.native
  /**
    * Sets an override on the row that forces it to always be invisible.
    * Emits the rowsVisibleChanged event if it changed the row visibility
    * @param reason the reason (usually the module) for the row to be invisible. E.g. grouping, user, filter
    * @param fromRowsProcessor whether we were called from a rowsProcessor, passed through to evaluateRowVisibility
    */
  def setThisRowInvisible(reason: java.lang.String, fromRowsProcessor: scala.Boolean): scala.Unit = js.native
}
