...
trait IGridRowEditApi[TEntity] extends js.Object {
  ...
  /**
               ...
               */
  def flushDirtyRows(): angularLib.angularMod.angularNs.IPromise[js.Array[_]] = js.native
  // Methods
  /**
               * Triggers a save event for all currently dirty rows.
               * Could be used where user presses a save button or navigates away from the page
               ...
               *          promises.  i.e. it will be resolved when all the individual save promises have been resolved.
               */
  def flushDirtyRows(grid: uiDashGridLib.uiDashGridMod.uiGridNs.IGridInstanceOf[TEntity]): angularLib.angularMod.angularNs.IPromise[js.Array[_]] = js.native
  /**
               ...
               */
  def getDirtyRows(): js.Array[uiDashGridLib.uiDashGridMod.uiGridNs.IGridRowOf[TEntity]] = js.native
  /**
               * Returns all currently dirty rows
               * @param {IGridInstance} grid The target grid
               * @returns {Array<IGridRow>} An array of gridRows that are currently dirty
               */
  def getDirtyRows(grid: uiDashGridLib.uiDashGridMod.uiGridNs.IGridInstanceOf[TEntity]): js.Array[uiDashGridLib.uiDashGridMod.uiGridNs.IGridRowOf[TEntity]] = js.native
  /**
               * Returns all currently errored rows
               * @param {IGridInstance} grid The target grid
               * @returns {Array<IGridRow>} An array of gridRows that are currently in error
               */
  def getErrorRows(): js.Array[uiDashGridLib.uiDashGridMod.uiGridNs.IGridRowOf[TEntity]] = js.native
  /**
               * Returns all currently errored rows
               * @param {IGridInstance} grid The target grid
               * @returns {Array<IGridRow>} An array of gridRows that are currently in error
               */
  def getErrorRows(grid: uiDashGridLib.uiDashGridMod.uiGridNs.IGridInstanceOf[TEntity]): js.Array[uiDashGridLib.uiDashGridMod.uiGridNs.IGridRowOf[TEntity]] = js.native
  /**
  ...
  /**
               ...
               */
  def setSavePromise(rowEntity: js.Object, savePromise: angularLib.angularMod.angularNs.IPromise[_]): scala.Unit = js.native
}
