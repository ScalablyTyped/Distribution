...
trait IMenuItem extends js.Object {
  ...
  var action: js.UndefOr[js.Function1[/* $event */ angularLib.angularMod.IAngularEvent, scala.Unit]] = js.undefined
...
object IMenuItem {
  @scala.inline
  def apply(
    action: /* $event */ angularLib.angularMod.IAngularEvent => scala.Unit = null,
