...
trait IColumnDef[TEntity] extends js.Object {
  /**
    ...
    */
  var customTreeAggregationFinalizerFn: js.UndefOr[js.Function1[/* aggregation */ IGridTreeBaseAggregationObject, scala.Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var treeAggregationLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
    ...
    * @default undefined
    */
  var treeAggregationType: js.UndefOr[java.lang.String] = js.undefined
  /**
...
object IColumnDef {
  @scala.inline
  def apply[TEntity](
    customTreeAggregationFinalizerFn: /* aggregation */ IGridTreeBaseAggregationObject => scala.Unit = null,
    customTreeAggregationFn: (/* aggregation */ IGridTreeBaseAggregationObject, /* fieldValue */ js.Any, /* numValue */ scala.Double, /* row */ uiDashGridLib.uiDashGridMod.uiGridNs.IGridRowOf[TEntity]) => scala.Unit = null,
