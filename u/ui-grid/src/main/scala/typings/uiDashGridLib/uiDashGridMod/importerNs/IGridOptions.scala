...
trait IGridOptions[TEntity] extends js.Object {
  ...
  var importerDataAddCallback: js.UndefOr[
    js.Function2[
      /* grid */ uiDashGridLib.uiDashGridMod.IGridInstanceOf[TEntity], 
...
object IGridOptions {
  ...
  def apply[TEntity](
    ...
    importerDataAddCallback: (/* grid */ uiDashGridLib.uiDashGridMod.IGridInstanceOf[TEntity], /* newObjects */ js.Array[TEntity]) => scala.Unit = null,
    importerErrorCallback: (/* grid */ uiDashGridLib.uiDashGridMod.IGridInstanceOf[TEntity], /* errorKey */ java.lang.String, /* consoleMessage */ java.lang.String, /* context */ js.Any) => scala.Unit = null,
    importerHeaderFilter: /* displayName */ java.lang.String => java.lang.String = null,
    importerNewObject: js.Function = null,
    importerObjectCallback: (/* grid */ uiDashGridLib.uiDashGridMod.IGridInstanceOf[TEntity], /* newObject */ TEntity) => TEntity = null,
    importerProcessHeaders: (/* grid */ uiDashGridLib.uiDashGridMod.IGridInstanceOf[TEntity], /* headerArray */ js.Array[java.lang.String]) => js.Array[java.lang.String] = null,
