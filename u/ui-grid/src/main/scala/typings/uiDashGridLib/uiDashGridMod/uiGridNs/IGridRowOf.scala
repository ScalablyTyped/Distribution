...
trait IGridRowOf[TEntity]
  extends uiDashGridLib.uiDashGridMod.uiGridNs.cellNavNs.IGridRow
     with uiDashGridLib.uiDashGridMod.uiGridNs.editNs.IGridRow
     with uiDashGridLib.uiDashGridMod.uiGridNs.exporterNs.IGridRow
     with uiDashGridLib.uiDashGridMod.uiGridNs.selectionNs.IGridRow
     with uiDashGridLib.uiDashGridMod.uiGridNs.expandableNs.IGridRow {
