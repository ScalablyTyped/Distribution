...
trait IGridInstanceOf[TEntity] extends js.Object {
  /**
    ...
    */
  var appScope: js.UndefOr[angularLib.angularMod.IScope] = js.native
  /**
  ...
  /**
    ...
    */
  def buildColumns(options: IBuildColumnsOptions): angularLib.angularMod.IPromise[_] = js.native
  /**
  ...
  /**
    ...
    */
  def clearAllFilters(refreshRows: scala.Boolean, clearConditions: scala.Boolean, clearFlags: scala.Boolean): angularLib.angularMod.IPromise[_] = js.native
  /**
  ...
  /**
    ...
    */
  def handleWindowResize($event: angularLib.angularMod.IAngularEvent): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def modifyRows(newRawData: js.Array[TEntity]): angularLib.angularMod.IPromise[_] = js.native
  /**
  ...
  /**
    ...
    *          has been refreshed
    */
  def refreshCanvas(): angularLib.angularMod.IPromise[_] = js.native
  def refreshCanvas(buildStyles: scala.Boolean): angularLib.angularMod.IPromise[_] = js.native
  /**
    ...
    */
  def refreshRows(): angularLib.angularMod.IPromise[_] = js.native
  /**
  ...
  /**
    ...
    */
  def registerStyleComputation(styleComputation: js.Function1[/* $scope */ angularLib.angularMod.IScope, java.lang.String]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def scrollTo(): angularLib.angularMod.IPromise[_] = js.native
  def scrollTo(rowEntity: TEntity): angularLib.angularMod.IPromise[_] = js.native
  def scrollTo(rowEntity: TEntity, colDef: IColumnDefOf[TEntity]): angularLib.angularMod.IPromise[_] = js.native
  /**
    ...
    */
  def scrollToIfNecessary(gridRow: IGridRowOf[TEntity], gridCol: IGridColumnOf[TEntity]): angularLib.angularMod.IPromise[_] = js.native
  /**
    ...
    */
  def sortColumn(column: IGridColumnOf[TEntity]): angularLib.angularMod.IPromise[IGridColumnOf[TEntity]] = js.native
  def sortColumn(column: IGridColumnOf[TEntity], direction: java.lang.String): angularLib.angularMod.IPromise[IGridColumnOf[TEntity]] = js.native
  def sortColumn(column: IGridColumnOf[TEntity], direction: java.lang.String, add: scala.Boolean): angularLib.angularMod.IPromise[IGridColumnOf[TEntity]] = js.native
  /**
