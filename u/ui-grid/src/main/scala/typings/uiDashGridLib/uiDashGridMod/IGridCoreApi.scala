...
trait IGridCoreApi[TEntity] extends js.Object {
  // Events
  var on: uiDashGridLib.Anon_CallBack[TEntity] = js.native
  // Methods
  /**
  ...
  /**
    ...
    */
  def clearAllFilters(): angularLib.angularMod.IPromise[js.Array[IGridRowOf[TEntity]]] = js.native
  def clearAllFilters(refreshRows: scala.Boolean): angularLib.angularMod.IPromise[js.Array[IGridRowOf[TEntity]]] = js.native
  def clearAllFilters(refreshRows: scala.Boolean, clearConditions: scala.Boolean): angularLib.angularMod.IPromise[js.Array[IGridRowOf[TEntity]]] = js.native
  def clearAllFilters(refreshRows: scala.Boolean, clearConditions: scala.Boolean, clearFlags: scala.Boolean): angularLib.angularMod.IPromise[js.Array[IGridRowOf[TEntity]]] = js.native
  /**
  ...
  /**
    ...
    */
  def refresh(): angularLib.angularMod.IPromise[_] = js.native
  def refresh(rowsAltered: scala.Boolean): angularLib.angularMod.IPromise[_] = js.native
  /**
    * Refresh the rendered rows on screen?  Note: not functional at present
    * @returns {ng.IPromise<any>} promise that is resolved when render completes?
    */
  def refreshRows(): angularLib.angularMod.IPromise[scala.Boolean] = js.native
  /**
