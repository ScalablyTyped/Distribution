package typings
package uiDashGridLib.uiDashGridMod.infiniteScrollNs
...
trait IGridInfiniteScrollApi[TEntity] extends js.Object {
  ...
  /**
    ...
    *          scroll positioning
    */
  def dataLoaded(scrollUp: scala.Boolean, scrollDown: scala.Boolean): angularLib.angularMod.IPromise[_] = js.native
  /**
  ...
  /**
    ...
    * @returns {ng.IPromise<any>} A promise that is resolved when scrolling finishes
    */
  def dataRemovedBottom(scrollUp: scala.Boolean, scrollDown: scala.Boolean): angularLib.angularMod.IPromise[_] = js.native
  /**
    * Adjusts the scroll position after you've removed data at the bottom.
    * You should have called saveScrollPercentage before you remove the data,
    * and if you're doing this in response to a needMoreData you should wait
  ...
  /**
    ...
    * @returns {ng.IPromise<any>} A promise that is resolved when scrolling finishes
    */
  def dataRemovedTop(scrollUp: scala.Boolean, scrollDown: scala.Boolean): angularLib.angularMod.IPromise[_] = js.native
  /**
    ...
    * @returns {ng.IPromise<any>} A promise that is resolved when scrolling finishes
    */
  def resetScroll(scrollUp: scala.Boolean, scrollDown: scala.Boolean): angularLib.angularMod.IPromise[_] = js.native
  /**
