...
object IFilterOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(disableCancelFilterButton)) __obj.updateDynamic("disableCancelFilterButton")(disableCancelFilterButton.get.asInstanceOf[js.Any])
    if (flags != null) __obj.updateDynamic("flags")(flags.asInstanceOf[js.Any])
    if (!js.isUndefined(noTerm)) __obj.updateDynamic("noTerm")(noTerm.get.asInstanceOf[js.Any])
