...
import typings.uiGrid.AnonDOWNLEFT
...
trait IUiGridCellNavConstants extends js.Object {
  ...
  var direction: AnonDOWNLEFT
}

object IUiGridCellNavConstants {
  @scala.inline
  def apply(CELL_NAV_EVENT: String, EVENT_TYPE: AnonCLEAR, FEATURE_NAME: String, direction: AnonDOWNLEFT): IUiGridCellNavConstants = {
