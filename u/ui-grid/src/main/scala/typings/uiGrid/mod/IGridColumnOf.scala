...
object IGridColumnOf {
  ...
  extension [Self <: IGridColumnOf[?], TEntity](x: Self & IGridColumnOf[TEntity]) {
    ...
    inline def setGetAggregationValue(value: () => String): Self = StObject.set(x, "getAggregationValue", js.Any.fromFunction0(value))
    ...
    inline def setGridColumn(value: (IColumnDefOf[TEntity], Double, IGridInstanceOf[TEntity]) => Unit): Self = StObject.set(x, "GridColumn", js.Any.fromFunction3(value))
    
    inline def setHideColumn(value: () => Unit): Self = StObject.set(x, "hideColumn", js.Any.fromFunction0(value))
    
    inline def setIsPinnedLeft(value: () => Boolean): Self = StObject.set(x, "isPinnedLeft", js.Any.fromFunction0(value))
    
    inline def setIsPinnedRight(value: () => Boolean): Self = StObject.set(x, "isPinnedRight", js.Any.fromFunction0(value))
    ...
    inline def setUpdateColumnDef(value: (IColumnDefOf[TEntity], Boolean) => Unit): Self = StObject.set(x, "updateColumnDef", js.Any.fromFunction2(value))
