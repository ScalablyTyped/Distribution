...
trait AnonHandlerSaveRow[TEntity] extends js.Object {
  /**
...
object AnonHandlerSaveRow {
  @scala.inline
  def apply[TEntity](saveRow: (IScope, saveRowHandler[TEntity]) => Unit): AnonHandlerSaveRow[TEntity] = {
    val __obj = js.Dynamic.literal(saveRow = js.Any.fromFunction2(saveRow))
  
    __obj.asInstanceOf[AnonHandlerSaveRow[TEntity]]
  }
}
