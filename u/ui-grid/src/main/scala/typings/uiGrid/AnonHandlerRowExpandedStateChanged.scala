...
trait AnonHandlerRowExpandedStateChanged[TEntity] extends js.Object {
  /**
...
object AnonHandlerRowExpandedStateChanged {
  @scala.inline
  def apply[TEntity](rowExpandedStateChanged: (IScope, rowExpandedStateChangedHandler[TEntity]) => Unit): AnonHandlerRowExpandedStateChanged[TEntity] = {
    val __obj = js.Dynamic.literal(rowExpandedStateChanged = js.Any.fromFunction2(rowExpandedStateChanged))
  
    __obj.asInstanceOf[AnonHandlerRowExpandedStateChanged[TEntity]]
  }
}
