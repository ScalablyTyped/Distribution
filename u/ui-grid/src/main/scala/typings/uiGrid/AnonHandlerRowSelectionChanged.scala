...
trait AnonHandlerRowSelectionChanged[TEntity] extends js.Object {
  /**
...
object AnonHandlerRowSelectionChanged {
  @scala.inline
  def apply[TEntity](
  ...
  ): AnonHandlerRowSelectionChanged[TEntity] = {
    ...
    __obj.asInstanceOf[AnonHandlerRowSelectionChanged[TEntity]]
  }
}
