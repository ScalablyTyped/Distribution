...
trait AnonDOWNLEFT extends js.Object {
  var DOWN: Double
  var LEFT: Double
  var PG_DOWN: Double
  var PG_UP: Double
...
object AnonDOWNLEFT {
  @scala.inline
  def apply(DOWN: Double, LEFT: Double, PG_DOWN: Double, PG_UP: Double, RIGHT: Double, UP: Double): AnonDOWNLEFT = {
    ...
    __obj.asInstanceOf[AnonDOWNLEFT]
  }
}
