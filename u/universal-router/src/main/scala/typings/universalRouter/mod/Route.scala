...
object Route {
  @scala.inline
  def apply[R, /* <: typings.universalRouter.mod.RouterContext */ C](): Route[R, C] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Route[R, C]]
  }
  @scala.inline
  implicit class RouteOps[Self <: Route[_, _], R, /* <: typings.universalRouter.mod.RouterContext */ C] (val x: Self with (Route[R, C])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAction(value: (/* context */ RouteContext[R, C], /* params */ RouteParams) => RouteResult[R]): Self = this.set("action", js.Any.fromFunction2(value))
    @scala.inline
