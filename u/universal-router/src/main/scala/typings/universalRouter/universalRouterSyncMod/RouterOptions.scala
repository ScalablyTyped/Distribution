...
object RouterOptions {
  ...
  def apply[R, /* <: typings.universalRouter.universalRouterSyncMod.RouterContext */ C](
    ...
    errorHandler: (/* error */ RouteError, /* context */ ResolveContext) => RouteResultSync[R] = null,
    prefixes: String = null,
    resolveRoute: (/* context */ RouteContext[R, C], /* params */ RouteParams) => RouteResultSync[R] = null,
