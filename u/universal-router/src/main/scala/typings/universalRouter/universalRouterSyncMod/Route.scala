...
object Route {
  @scala.inline
  def apply[R, /* <: typings.universalRouter.universalRouterSyncMod.RouterContext */ C](): Route[R, C] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Route[R, C]]
  }
  @scala.inline
  implicit class RouteOps[Self <: Route[_, _], R, /* <: typings.universalRouter.universalRouterSyncMod.RouterContext */ C] (val x: Self with (Route[R, C])) extends AnyVal {
    @scala.inline
