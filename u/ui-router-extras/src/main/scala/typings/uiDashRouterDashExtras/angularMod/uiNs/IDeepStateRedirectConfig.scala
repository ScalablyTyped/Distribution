...
import typings.uiDashRouterDashExtras.Anon_Redirect
...
trait IDeepStateRedirectConfig extends js.Object {
  ...
  /*
    ...
    */
  var fn: js.UndefOr[js.Function1[/* $dsr$ */ Anon_Redirect, Boolean | IRedirectParams]] = js.undefined
  /*
...
object IDeepStateRedirectConfig {
  ...
  def apply(
    ...
    fn: /* $dsr$ */ Anon_Redirect => Boolean | IRedirectParams = null,
