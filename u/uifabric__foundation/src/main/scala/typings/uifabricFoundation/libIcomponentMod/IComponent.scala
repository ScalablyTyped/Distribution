...
object IComponent {
  ...
  @scala.inline
  implicit class IComponentOps[Self <: IComponent[_, _, _, _, _], TComponentProps, TTokens, /* <: typings.uifabricMergeStyles.istylesetMod.IStyleSet[TStyleSet] */ TStyleSet, TViewProps, TStatics] (val x: Self with (IComponent[TComponentProps, TTokens, TStyleSet, TViewProps, TStatics])) extends AnyVal {
    @scala.inline
