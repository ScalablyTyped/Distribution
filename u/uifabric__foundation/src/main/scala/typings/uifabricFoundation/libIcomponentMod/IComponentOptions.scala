...
object IComponentOptions {
  ...
  @scala.inline
  implicit class IComponentOptionsOps[Self <: IComponentOptions[_, _, _, _, _], TComponentProps, TTokens, TStyleSet /* <: IStyleSet[TStyleSet] */, TViewProps, TStatics] (val x: Self with (IComponentOptions[TComponentProps, TTokens, TStyleSet, TViewProps, TStatics])) extends AnyVal {
