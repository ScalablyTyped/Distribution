...
object IControlledStateOptions {
  @scala.inline
  def apply[TProps, /* <: / * keyof TProps * / java.lang.String */ TProp, /* <: / * keyof TProps * / java.lang.String */ TDefaultProp](): IControlledStateOptions[TProps, TProp, TDefaultProp] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IControlledStateOptions[TProps, TProp, TDefaultProp]]
  }
  @scala.inline
  implicit class IControlledStateOptionsOps[Self <: IControlledStateOptions[_, _, _], TProps, /* <: / * keyof TProps * / java.lang.String */ TProp, /* <: / * keyof TProps * / java.lang.String */ TDefaultProp] (val x: Self with (IControlledStateOptions[TProps, TProp, TDefaultProp])) extends AnyVal {
    @scala.inline
