...
trait IEntityResource extends js.Object {
  /**
    ...
    *
    */
  def getAll(`type`: java.lang.String, postFilter: java.lang.String, postFilterParams: java.lang.String): angularLib.angularMod.IPromise[IResourcePromise] = js.native
  /**
    * @ngdoc method
    ...
    *
    */
  def getAncestors(id: scala.Double, `type`: java.lang.String): angularLib.angularMod.IPromise[IResourcePromise] = js.native
  /**
    * @ngdoc method
    ...
    *
    */
  def getById(id: scala.Double, `type`: java.lang.String): angularLib.angularMod.IPromise[IResourcePromise] = js.native
  /**
    * @ngdoc method
    ...
    *
    */
  def getByIds(ids: js.Array[scala.Double], `type`: java.lang.String): angularLib.angularMod.IPromise[IResourcePromise] = js.native
  def getByQuery(query: java.lang.String, nodeContextId: java.lang.String, `type`: java.lang.String): angularLib.angularMod.IPromise[IResourcePromise] = js.native
  def getByQuery(query: java.lang.String, nodeContextId: scala.Double, `type`: java.lang.String): angularLib.angularMod.IPromise[IResourcePromise] = js.native
  /**
    * @ngdoc method
    * @name umbraco.resources.entityResource#getAncestors
    * @methodOf umbraco.resources.entityResource
    ...
    *
    */
  def getChildren(id: scala.Double, `type`: java.lang.String): angularLib.angularMod.IPromise[IResourcePromise] = js.native
  /**
    * @ngdoc method
    ...
    *
    */
  def getPath(id: scala.Double, `type`: java.lang.String): angularLib.angularMod.IPromise[IResourcePromise] = js.native
  /**
    * @ngdoc method
    ...
    *
    */
  def search(query: java.lang.String, `type`: java.lang.String, searchFrom: js.Any, canceler: js.Any): angularLib.angularMod.IPromise[IResourcePromise] = js.native
  /**
    * @ngdoc method
    ...
    *
    */
  def searchAll(query: java.lang.String, canceler: js.Any): angularLib.angularMod.IPromise[IResourcePromise] = js.native
}
