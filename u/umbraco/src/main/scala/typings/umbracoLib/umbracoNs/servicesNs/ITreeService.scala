...
trait ITreeService extends js.Object {
  ...
  def clearCache(args: ICacheArgs): scala.Unit = js.native
  /**
    * @ngdoc method
    ...
    */
  def getChildNode(treeNode: js.Object, id: scala.Double): js.Any = js.native
  /**
    * @ngdoc method
  ...
  /**
    ...
    */
  def getDescendantNode(treeNode: js.Object, id: scala.Double, treeAlias: java.lang.String): js.Any = js.native
  /**
    * @ngdoc method
  ...
  /**
    ...
    */
  def getPath(node: js.Object): java.lang.String = js.native
  /**
    * @ngdoc method
    ...
    */
  def getTree(args: ITreeArgs): angularLib.angularMod.IPromise[_] = js.native
  /**
    * @ngdoc method
    ...
    */
  def getTreeAlias(treeNode: js.Object): java.lang.String = js.native
  /**
    * @ngdoc method
    ...
    */
  def getTreePackageFolder(treeAlias: java.lang.String): IPackageFolder = js.native
  /**
    * @ngdoc method
  ...
  /**
    ...
    */
  def loadNodeChildren(args: INodeArgs): angularLib.angularMod.IPromise[_] = js.native
  /**
    * @ngdoc method
    ...
    */
  def reloadNode(node: js.Object): scala.Unit = js.native
  /**
    * @ngdoc method
    ...
    */
  def removeChildNodes(treeNode: js.Object): scala.Unit = js.native
  /**
    * @ngdoc method
    ...
    */
  def removeNode(treeNode: js.Object): scala.Unit = js.native
}
