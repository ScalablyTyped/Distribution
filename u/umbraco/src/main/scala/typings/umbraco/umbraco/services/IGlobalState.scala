...
object IGlobalState {
  ...
  extension [Self <: IGlobalState](x: Self) {
    ...
    inline def setNavMode(value: js.Any): Self = StObject.set(x, "navMode", value.asInstanceOf[js.Any])
    ...
    inline def setStickyNavigation(value: js.Any): Self = StObject.set(x, "stickyNavigation", value.asInstanceOf[js.Any])
