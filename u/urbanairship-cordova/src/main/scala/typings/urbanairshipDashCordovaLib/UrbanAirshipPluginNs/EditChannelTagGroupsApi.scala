...
trait EditChannelTagGroupsApi extends js.Object {
  /**
    ...
    */
  def addTags(tagGroup: java.lang.String, tags: js.Array[java.lang.String]): EditChannelTagGroupsApi = js.native
  /**
  ...
  /**
    ...
    * @returns The chainable API instance.
    */
  def removeTags(tagGroup: java.lang.String, tags: js.Array[java.lang.String]): EditChannelTagGroupsApi = js.native
}
