...
import typings.unsplashJs.AnonCollectionsOrientation
...
trait Search extends js.Object {
  ...
  def photos(keyword: String, page: Double, perPage: Double, filters: AnonCollectionsOrientation): js.Promise[Response] = js.native
