...
object distHelpersQueryMod {
  ...
  inline def getFeedParams(param0: PaginationParams): Record[String, Double | OrderBy] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFeedParams")(param0.asInstanceOf[js.Any]).asInstanceOf[Record[String, Double | OrderBy]]
