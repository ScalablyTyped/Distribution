...
object topicsTypesMod {
  
  trait Basic
    extends StObject
       with Entity {
    
    var cover_photo: typings.unsplashJs.photosTypesMod.Basic | Null
    ...
    var owners: NonEmptyArray[typings.unsplashJs.usersTypesMod.Basic]
  ...
  object Basic {
    ...
    inline def apply(
      ...
      id: String,
      links: Html,
      owners: NonEmptyArray[typings.unsplashJs.usersTypesMod.Basic],
      published_at: String,
      slug: String,
      starts_at: String,
      status: open | closed,
    ...
    extension [Self <: Basic](x: Self) {
      ...
      inline def setCover_photo(value: typings.unsplashJs.photosTypesMod.Basic): Self = StObject.set(x, "cover_photo", value.asInstanceOf[js.Any])
      ...
      inline def setOwners(value: NonEmptyArray[typings.unsplashJs.usersTypesMod.Basic]): Self = StObject.set(x, "owners", value.asInstanceOf[js.Any])
  ...
  trait Full
    ...
    var top_contributors: js.Array[typings.unsplashJs.usersTypesMod.Basic]
  }
  object Full {
    ...
    inline def apply(
      ...
      status: open | closed,
      title: String,
      top_contributors: js.Array[typings.unsplashJs.usersTypesMod.Basic],
      total_photos: Double,
      updated_at: String
    ): Full = {
    ...
    extension [Self <: Full](x: Self) {
      ...
      inline def setTop_contributors(value: js.Array[typings.unsplashJs.usersTypesMod.Basic]): Self = StObject.set(x, "top_contributors", value.asInstanceOf[js.Any])
      
      inline def setTop_contributorsVarargs(value: typings.unsplashJs.usersTypesMod.Basic*): Self = StObject.set(x, "top_contributors", js.Array(value*))
    }
  }
}
