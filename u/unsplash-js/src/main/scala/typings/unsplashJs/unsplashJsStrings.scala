...
import typings.unsplashJs.mod.Orientation
...
object unsplashJsStrings {
  ...
  @js.native
  sealed trait black_and_white extends StObject
  @scala.inline
  def black_and_white: black_and_white = "black_and_white".asInstanceOf[black_and_white]
  ...
  @js.native
  sealed trait relevant extends StObject
  @scala.inline
