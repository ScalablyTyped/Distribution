...
object Photos {
  ...
  inline def apply(collections: GetRelated, photos: Get, search: GetPhotos, topics: List, users: GetCollections): Photos = {
  ...
  extension [Self <: Photos](x: Self) {
    ...
    inline def setTopics(value: List): Self = StObject.set(x, "topics", value.asInstanceOf[js.Any])
