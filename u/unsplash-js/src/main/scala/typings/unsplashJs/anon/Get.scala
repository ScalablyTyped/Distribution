...
trait Get extends StObject {
  ...
  def get(a: PhotoIdString): js.Promise[ApiResponse[typings.unsplashJs.topicsTypesMod.Full]] = js.native
  def get(a: PhotoIdString, additionalFetchOptions: AdditionalFetchOptions): js.Promise[ApiResponse[typings.unsplashJs.topicsTypesMod.Full]] = js.native
