...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/config.GenericOptions & @use-gesture/core.@use-gesture/core/dist/declarations/src/types/config.DragConfig */
trait UserDragConfig extends StObject {
...
object UserDragConfig {
  
  inline def apply(): UserDragConfig = {
