...
object distDeclarationsSrcConfigDragConfigResolverMod {
  ...
  object dragConfigResolver {
    ...
    inline def device(_v: Any, _k: String, param3: DragConfig): mouse | touch | pointer = (^.asInstanceOf[js.Dynamic].applyDynamic("device")(_v.asInstanceOf[js.Any], _k.asInstanceOf[js.Any], param3.asInstanceOf[js.Any])).asInstanceOf[mouse | touch | pointer]
    ...
    inline def preventScrollAxis(value: x | y | xy, _k: String, param3: DragConfig): js.UndefOr[x | y | xy] = (^.asInstanceOf[js.Dynamic].applyDynamic("preventScrollAxis")(value.asInstanceOf[js.Any], _k.asInstanceOf[js.Any], param3.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[x | y | xy]]
    ...
    inline def swipe(param1: Distance): Duration = ^.asInstanceOf[js.Dynamic].applyDynamic("swipe")(param1.asInstanceOf[js.Any]).asInstanceOf[Duration]
    
    inline def threshold(value: Double, _k: String, param3: Axis): js.Tuple2[Double, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("threshold")(value.asInstanceOf[js.Any], _k.asInstanceOf[js.Any], param3.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[Double, Double]]
    inline def threshold(value: Vector2, _k: String, param3: Axis): js.Tuple2[Double, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("threshold")(value.asInstanceOf[js.Any], _k.asInstanceOf[js.Any], param3.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[Double, Double]]
