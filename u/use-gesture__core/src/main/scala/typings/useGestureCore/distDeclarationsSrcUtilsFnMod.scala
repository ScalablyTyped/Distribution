...
object distDeclarationsSrcUtilsFnMod {
  ...
  inline def call[T](v: T, args: Any*): T = ^.asInstanceOf[js.Dynamic].applyDynamic("call")(scala.List(v.asInstanceOf[js.Any]).`++`(args.asInstanceOf[Seq[js.Any]])*).asInstanceOf[T]
  inline def call[T](v: js.Function1[/* repeated */ Any, T], args: Any*): T = ^.asInstanceOf[js.Dynamic].applyDynamic("call")(scala.List(v.asInstanceOf[js.Any]).`++`(args.asInstanceOf[Seq[js.Any]])*).asInstanceOf[T]
