...
import typings.useGestureCore.internalConfigMod.InternalGenericOptions
import typings.useGestureCore.stateMod.IngKey
import typings.useGestureCore.stateMod.SharedGestureState
...
object engineMod {
  ...
  @JSImport("@use-gesture/core/dist/declarations/src/engines/Engine", "Engine")
  @js.native
  abstract class Engine[Key /* <: GestureKey */] protected () extends StObject {
