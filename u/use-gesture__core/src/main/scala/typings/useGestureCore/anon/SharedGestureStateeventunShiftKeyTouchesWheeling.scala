...
import typings.useGestureCore.useGestureCoreStrings.onLoadedMetadata
...
trait SharedGestureStateeventunShiftKeyTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onLoadedMetadata]] = js.undefined
...
object SharedGestureStateeventunShiftKeyTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunShiftKeyTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onLoadedMetadata]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
