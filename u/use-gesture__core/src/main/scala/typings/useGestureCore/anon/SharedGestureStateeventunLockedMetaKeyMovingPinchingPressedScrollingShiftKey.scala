...
import typings.useGestureCore.useGestureCoreStrings.onReset
...
trait SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrollingShiftKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onReset]] = js.undefined
...
object SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrollingShiftKey {
  ...
  extension [Self <: SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrollingShiftKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onReset]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
