...
import typings.useGestureCore.useGestureCoreStrings.onBlurCapture
...
trait SharedGestureStateeventunScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onBlurCapture]] = js.undefined
...
object SharedGestureStateeventunScrolling {
  ...
  extension [Self <: SharedGestureStateeventunScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onBlurCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
