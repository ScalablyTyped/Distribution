...
import typings.useGestureCore.useGestureCoreStrings.onWaitingCapture
...
trait SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onWaitingCapture]] = js.undefined
...
object SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKey {
  ...
  extension [Self <: SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onWaitingCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
