...
import typings.useGestureCore.useGestureCoreStrings.onChange
...
trait SharedGestureStateeventunDraggingEventHoveringLocked extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onChange]] = js.undefined
...
object SharedGestureStateeventunDraggingEventHoveringLocked {
  ...
  extension [Self <: SharedGestureStateeventunDraggingEventHoveringLocked](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onChange]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
