...
import typings.useGestureCore.useGestureCoreStrings.onInvalid
...
trait SharedGestureStateeventunMetaKeyMovingPinchingPressedScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onInvalid]] = js.undefined
...
object SharedGestureStateeventunMetaKeyMovingPinchingPressedScrolling {
  ...
  extension [Self <: SharedGestureStateeventunMetaKeyMovingPinchingPressedScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onInvalid]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
