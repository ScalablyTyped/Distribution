...
import typings.useGestureCore.useGestureCoreStrings.onDragCapture
...
trait SharedGestureStateeventunLockedMetaKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDragCapture]] = js.undefined
...
object SharedGestureStateeventunLockedMetaKey {
  ...
  extension [Self <: SharedGestureStateeventunLockedMetaKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDragCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
