...
import typings.useGestureCore.useGestureCoreStrings.onAnimationEndCapture
...
trait SharedGestureStateeventun extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onAnimationEndCapture]] = js.undefined
...
object SharedGestureStateeventun {
  ...
  extension [Self <: SharedGestureStateeventun](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onAnimationEndCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
