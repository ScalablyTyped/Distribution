...
import typings.useGestureCore.useGestureCoreStrings.onEncrypted
...
trait SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onEncrypted]] = js.undefined
...
object SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onEncrypted]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
