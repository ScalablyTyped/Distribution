...
import typings.useGestureCore.useGestureCoreStrings.onMouseUp
...
trait SharedGestureStateeventunDraggingEventHoveringLockedMetaKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseUp]] = js.undefined
...
object SharedGestureStateeventunDraggingEventHoveringLockedMetaKey {
  ...
  extension [Self <: SharedGestureStateeventunDraggingEventHoveringLockedMetaKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseUp]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
