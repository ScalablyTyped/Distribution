...
import typings.useGestureCore.useGestureCoreStrings.onDoubleClick
...
trait SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHoveringLocked extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDoubleClick]] = js.undefined
...
object SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHoveringLocked {
  ...
  extension [Self <: SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHoveringLocked](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDoubleClick]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
