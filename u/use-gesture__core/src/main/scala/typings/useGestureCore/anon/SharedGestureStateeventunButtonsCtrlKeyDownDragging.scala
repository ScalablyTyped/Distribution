...
import typings.useGestureCore.useGestureCoreStrings.onTransitionEnd
...
trait SharedGestureStateeventunButtonsCtrlKeyDownDragging extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onTransitionEnd]] = js.undefined
...
object SharedGestureStateeventunButtonsCtrlKeyDownDragging {
  ...
  extension [Self <: SharedGestureStateeventunButtonsCtrlKeyDownDragging](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onTransitionEnd]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
