...
import typings.useGestureCore.useGestureCoreStrings.onAbort
...
trait SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onAbort]] = js.undefined
...
object SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onAbort]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
