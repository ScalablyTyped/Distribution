...
import typings.useGestureCore.useGestureCoreStrings.onTimeUpdateCapture
...
trait SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinching extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onTimeUpdateCapture]] = js.undefined
...
object SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinching {
  ...
  extension [Self <: SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinching](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onTimeUpdateCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
