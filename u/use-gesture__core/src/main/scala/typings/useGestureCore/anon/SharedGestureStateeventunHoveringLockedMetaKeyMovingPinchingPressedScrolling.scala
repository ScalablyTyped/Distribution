...
import typings.useGestureCore.useGestureCoreStrings.onWaiting
...
trait SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onWaiting]] = js.undefined
...
object SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrolling {
  ...
  extension [Self <: SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onWaiting]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
