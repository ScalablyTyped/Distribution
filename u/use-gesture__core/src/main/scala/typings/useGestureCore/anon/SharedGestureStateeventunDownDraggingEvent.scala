...
import typings.useGestureCore.useGestureCoreStrings.onCanPlayThroughCapture
...
trait SharedGestureStateeventunDownDraggingEvent extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCanPlayThroughCapture]] = js.undefined
...
object SharedGestureStateeventunDownDraggingEvent {
  ...
  extension [Self <: SharedGestureStateeventunDownDraggingEvent](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCanPlayThroughCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
