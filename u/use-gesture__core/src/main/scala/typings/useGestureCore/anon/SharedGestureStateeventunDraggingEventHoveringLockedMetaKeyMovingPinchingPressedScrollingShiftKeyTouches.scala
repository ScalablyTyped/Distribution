...
import typings.useGestureCore.useGestureCoreStrings.onEmptiedCapture
...
trait SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onEmptiedCapture]] = js.undefined
...
object SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches {
  ...
  extension [Self <: SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onEmptiedCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
