...
import typings.useGestureCore.useGestureCoreStrings.onBeforeInput
...
trait SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onBeforeInput]] = js.undefined
...
object SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKey {
  ...
  extension [Self <: SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onBeforeInput]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
