...
import typings.useGestureCore.useGestureCoreStrings.onCompositionStartCapture
...
trait SharedGestureStateeventunEvent extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCompositionStartCapture]] = js.undefined
...
object SharedGestureStateeventunEvent {
  ...
  extension [Self <: SharedGestureStateeventunEvent](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCompositionStartCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
