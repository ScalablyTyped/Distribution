...
import typings.useGestureCore.useGestureCoreStrings.onCompositionUpdate
...
trait SharedGestureStateeventunPinchingPressed extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCompositionUpdate]] = js.undefined
...
object SharedGestureStateeventunPinchingPressed {
  ...
  extension [Self <: SharedGestureStateeventunPinchingPressed](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCompositionUpdate]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
