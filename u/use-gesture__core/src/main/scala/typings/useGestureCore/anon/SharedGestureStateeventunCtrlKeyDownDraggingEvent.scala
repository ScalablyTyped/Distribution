...
import typings.useGestureCore.useGestureCoreStrings.onMouseOver
...
trait SharedGestureStateeventunCtrlKeyDownDraggingEvent extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseOver]] = js.undefined
...
object SharedGestureStateeventunCtrlKeyDownDraggingEvent {
  ...
  extension [Self <: SharedGestureStateeventunCtrlKeyDownDraggingEvent](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseOver]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
