...
import typings.useGestureCore.useGestureCoreStrings.onPointerMove
...
trait SharedGestureStateeventunCtrlKeyDown extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerMove]] = js.undefined
...
object SharedGestureStateeventunCtrlKeyDown {
  ...
  extension [Self <: SharedGestureStateeventunCtrlKeyDown](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerMove]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
