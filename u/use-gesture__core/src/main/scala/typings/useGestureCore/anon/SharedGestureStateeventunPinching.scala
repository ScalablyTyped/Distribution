...
import typings.useGestureCore.useGestureCoreStrings.onDragOver
...
trait SharedGestureStateeventunPinching extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDragOver]] = js.undefined
...
object SharedGestureStateeventunPinching {
  ...
  extension [Self <: SharedGestureStateeventunPinching](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDragOver]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
