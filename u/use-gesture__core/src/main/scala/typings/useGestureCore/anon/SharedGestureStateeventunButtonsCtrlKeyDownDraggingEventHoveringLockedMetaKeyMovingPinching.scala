...
object SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinching {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinching] (val x: Self) extends AnyVal {
