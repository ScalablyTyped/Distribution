...
import typings.useGestureCore.useGestureCoreStrings.onLoadedDataCapture
...
trait SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onLoadedDataCapture]] = js.undefined
...
object SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling {
  ...
  extension [Self <: SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onLoadedDataCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
