...
import typings.useGestureCore.useGestureCoreStrings.onCut
...
trait SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCut]] = js.undefined
...
object SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling {
  ...
  extension [Self <: SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCut]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
