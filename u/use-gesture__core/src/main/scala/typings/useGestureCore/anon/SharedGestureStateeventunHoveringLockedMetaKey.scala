...
import typings.useGestureCore.useGestureCoreStrings.onMouseUpCapture
...
trait SharedGestureStateeventunHoveringLockedMetaKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseUpCapture]] = js.undefined
...
object SharedGestureStateeventunHoveringLockedMetaKey {
  ...
  extension [Self <: SharedGestureStateeventunHoveringLockedMetaKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseUpCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
