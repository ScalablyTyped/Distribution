...
import typings.useGestureCore.useGestureCoreStrings.onPointerOut
...
trait SharedGestureStateeventunTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerOut]] = js.undefined
...
object SharedGestureStateeventunTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerOut]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
