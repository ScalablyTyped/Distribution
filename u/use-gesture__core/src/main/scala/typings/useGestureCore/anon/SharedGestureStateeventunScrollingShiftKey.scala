...
import typings.useGestureCore.useGestureCoreStrings.onSelect
...
trait SharedGestureStateeventunScrollingShiftKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onSelect]] = js.undefined
...
object SharedGestureStateeventunScrollingShiftKey {
  ...
  extension [Self <: SharedGestureStateeventunScrollingShiftKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onSelect]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
