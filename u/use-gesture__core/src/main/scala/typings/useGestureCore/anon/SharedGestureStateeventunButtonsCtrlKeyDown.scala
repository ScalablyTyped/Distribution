...
import typings.useGestureCore.useGestureCoreStrings.onPointerUpCapture
...
trait SharedGestureStateeventunButtonsCtrlKeyDown extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerUpCapture]] = js.undefined
...
object SharedGestureStateeventunButtonsCtrlKeyDown {
  ...
  extension [Self <: SharedGestureStateeventunButtonsCtrlKeyDown](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerUpCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
