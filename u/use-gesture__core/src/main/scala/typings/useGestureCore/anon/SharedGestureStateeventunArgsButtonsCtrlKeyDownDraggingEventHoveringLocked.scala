...
import typings.useGestureCore.useGestureCoreStrings.onSubmit
...
trait SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLocked extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onSubmit]] = js.undefined
...
object SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLocked {
  ...
  extension [Self <: SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLocked](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onSubmit]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
