...
import typings.useGestureCore.useGestureCoreStrings.onBeforeInputCapture
...
trait SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressed extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onBeforeInputCapture]] = js.undefined
...
object SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressed {
  ...
  extension [Self <: SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressed](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onBeforeInputCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
