...
import typings.useGestureCore.useGestureCoreStrings.onAuxClick
...
trait SharedGestureStateeventunArgsButtonsCtrlKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onAuxClick]] = js.undefined
...
object SharedGestureStateeventunArgsButtonsCtrlKey {
  ...
  extension [Self <: SharedGestureStateeventunArgsButtonsCtrlKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onAuxClick]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
