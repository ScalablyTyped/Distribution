...
object SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey] (val x: Self) extends AnyVal {
