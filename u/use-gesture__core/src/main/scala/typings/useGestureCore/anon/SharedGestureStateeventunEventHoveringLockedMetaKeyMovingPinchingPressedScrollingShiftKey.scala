...
import typings.useGestureCore.useGestureCoreStrings.onPlayCapture
...
trait SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPlayCapture]] = js.undefined
...
object SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey {
  ...
  extension [Self <: SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPlayCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
