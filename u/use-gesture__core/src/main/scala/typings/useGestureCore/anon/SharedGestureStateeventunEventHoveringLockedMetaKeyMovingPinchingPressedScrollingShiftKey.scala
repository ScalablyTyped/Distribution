...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onPlayCapture'> : any | undefined,   args :any} */
trait SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onPlayCapture'> : any | undefined */ js.Any
...
object SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onPlayCapture'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey] (val x: Self) extends AnyVal {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onPlayCapture'> : any | undefined */ js.Any
