...
import typings.useGestureCore.useGestureCoreStrings.onStalled
...
trait SharedGestureStateeventunShiftKeyTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onStalled]] = js.undefined
...
object SharedGestureStateeventunShiftKeyTouches {
  ...
  extension [Self <: SharedGestureStateeventunShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onStalled]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
