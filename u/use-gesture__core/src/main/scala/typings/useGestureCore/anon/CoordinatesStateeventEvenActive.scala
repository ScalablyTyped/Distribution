...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.CoordinatesState & {  event :@use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.EventTypes['scroll']} */
trait CoordinatesStateeventEvenActive extends StObject {
...
object CoordinatesStateeventEvenActive {
  ...
  inline def apply(
    ...
    velocity: Vector2,
    xy: Vector2
  ): CoordinatesStateeventEvenActive = {
    ...
    __obj.asInstanceOf[CoordinatesStateeventEvenActive]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CoordinatesStateeventEvenActive] (val x: Self) extends AnyVal {
