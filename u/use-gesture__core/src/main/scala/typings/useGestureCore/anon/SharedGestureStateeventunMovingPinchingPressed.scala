...
import typings.useGestureCore.useGestureCoreStrings.onContextMenuCapture
...
trait SharedGestureStateeventunMovingPinchingPressed extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onContextMenuCapture]] = js.undefined
...
object SharedGestureStateeventunMovingPinchingPressed {
  ...
  extension [Self <: SharedGestureStateeventunMovingPinchingPressed](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onContextMenuCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
