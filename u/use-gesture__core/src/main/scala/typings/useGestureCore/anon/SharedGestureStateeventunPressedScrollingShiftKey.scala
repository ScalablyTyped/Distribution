...
import typings.useGestureCore.useGestureCoreStrings.onGotPointerCaptureCapture
...
trait SharedGestureStateeventunPressedScrollingShiftKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onGotPointerCaptureCapture]] = js.undefined
...
object SharedGestureStateeventunPressedScrollingShiftKey {
  ...
  extension [Self <: SharedGestureStateeventunPressedScrollingShiftKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onGotPointerCaptureCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
