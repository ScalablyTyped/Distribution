...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onGotPointerCaptureCapture'> : any | undefined,   args :any} */
trait SharedGestureStateeventunPressedScrollingShiftKey extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onGotPointerCaptureCapture'> : any | undefined */ js.Any
...
object SharedGestureStateeventunPressedScrollingShiftKey {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onGotPointerCaptureCapture'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunPressedScrollingShiftKey = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunPressedScrollingShiftKey]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunPressedScrollingShiftKey] (val x: Self) extends AnyVal {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onGotPointerCaptureCapture'> : any | undefined */ js.Any
