...
import typings.useGestureCore.useGestureCoreStrings.onLoadedData
...
trait SharedGestureStateeventunDragging extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onLoadedData]] = js.undefined
...
object SharedGestureStateeventunDragging {
  ...
  extension [Self <: SharedGestureStateeventunDragging](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onLoadedData]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
