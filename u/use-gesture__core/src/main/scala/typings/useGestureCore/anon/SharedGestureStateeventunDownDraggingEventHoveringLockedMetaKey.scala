...
import typings.useGestureCore.useGestureCoreStrings.onPointerEnter
...
trait SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerEnter]] = js.undefined
...
object SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKey {
  ...
  extension [Self <: SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerEnter]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
