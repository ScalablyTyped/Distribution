...
import typings.useGestureCore.useGestureCoreStrings.onAuxClickCapture
...
trait SharedGestureStateeventunCtrlKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onAuxClickCapture]] = js.undefined
...
object SharedGestureStateeventunCtrlKey {
  ...
  extension [Self <: SharedGestureStateeventunCtrlKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onAuxClickCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
