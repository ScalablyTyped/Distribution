...
import typings.useGestureCore.useGestureCoreStrings.onDurationChange
...
trait SharedGestureStateeventunEventHoveringLocked extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDurationChange]] = js.undefined
...
object SharedGestureStateeventunEventHoveringLocked {
  ...
  extension [Self <: SharedGestureStateeventunEventHoveringLocked](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDurationChange]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
