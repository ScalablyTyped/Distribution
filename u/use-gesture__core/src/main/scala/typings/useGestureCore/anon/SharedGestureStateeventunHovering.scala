...
import typings.useGestureCore.useGestureCoreStrings.onClick
...
trait SharedGestureStateeventunHovering extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onClick]] = js.undefined
...
object SharedGestureStateeventunHovering {
  ...
  extension [Self <: SharedGestureStateeventunHovering](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onClick]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
