...
import typings.useGestureCore.useGestureCoreStrings.onTouchStart
...
trait SharedGestureStateeventunLocked extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onTouchStart]] = js.undefined
...
object SharedGestureStateeventunLocked {
  ...
  extension [Self <: SharedGestureStateeventunLocked](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onTouchStart]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
