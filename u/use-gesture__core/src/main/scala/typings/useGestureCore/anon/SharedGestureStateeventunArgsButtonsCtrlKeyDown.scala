...
import typings.useGestureCore.useGestureCoreStrings.onPointerOutCapture
...
trait SharedGestureStateeventunArgsButtonsCtrlKeyDown extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerOutCapture]] = js.undefined
...
object SharedGestureStateeventunArgsButtonsCtrlKeyDown {
  ...
  extension [Self <: SharedGestureStateeventunArgsButtonsCtrlKeyDown](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerOutCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
