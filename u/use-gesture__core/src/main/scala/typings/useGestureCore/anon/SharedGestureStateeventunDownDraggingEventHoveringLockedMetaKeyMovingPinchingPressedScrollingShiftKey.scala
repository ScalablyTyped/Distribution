...
import typings.useGestureCore.useGestureCoreStrings.onInvalidCapture
...
trait SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onInvalidCapture]] = js.undefined
...
object SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey {
  ...
  extension [Self <: SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onInvalidCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
