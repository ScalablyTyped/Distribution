...
import typings.useGestureCore.useGestureCoreStrings.onMouseEnter
...
trait SharedGestureStateeventunDown extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseEnter]] = js.undefined
...
object SharedGestureStateeventunDown {
  ...
  extension [Self <: SharedGestureStateeventunDown](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseEnter]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
