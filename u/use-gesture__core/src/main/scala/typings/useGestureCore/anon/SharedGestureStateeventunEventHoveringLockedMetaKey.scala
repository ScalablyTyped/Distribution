...
import typings.useGestureCore.useGestureCoreStrings.onSeeking
...
trait SharedGestureStateeventunEventHoveringLockedMetaKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onSeeking]] = js.undefined
...
object SharedGestureStateeventunEventHoveringLockedMetaKey {
  ...
  extension [Self <: SharedGestureStateeventunEventHoveringLockedMetaKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onSeeking]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
