...
import typings.useGestureCore.useGestureCoreStrings.onCompositionStart
...
trait SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMoving extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCompositionStart]] = js.undefined
...
object SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMoving {
  ...
  extension [Self <: SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMoving](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCompositionStart]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
