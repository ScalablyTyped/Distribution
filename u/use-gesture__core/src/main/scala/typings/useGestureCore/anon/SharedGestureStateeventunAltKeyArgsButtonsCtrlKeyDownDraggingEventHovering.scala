...
import typings.useGestureCore.useGestureCoreStrings.onMouseDown
...
trait SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHovering extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseDown]] = js.undefined
...
object SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHovering {
  ...
  extension [Self <: SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHovering](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseDown]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
