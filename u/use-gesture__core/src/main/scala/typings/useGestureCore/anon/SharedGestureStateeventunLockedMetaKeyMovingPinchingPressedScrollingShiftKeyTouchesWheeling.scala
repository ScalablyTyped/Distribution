...
import typings.useGestureCore.useGestureCoreStrings.onTouchEnd
...
trait SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onTouchEnd]] = js.undefined
...
object SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onTouchEnd]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
