...
object SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling] (val x: Self) extends AnyVal {
