...
import typings.useGestureCore.useGestureCoreStrings.onInput
...
trait SharedGestureStateeventunEventHoveringLockedMetaKeyMoving extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onInput]] = js.undefined
...
object SharedGestureStateeventunEventHoveringLockedMetaKeyMoving {
  ...
  extension [Self <: SharedGestureStateeventunEventHoveringLockedMetaKeyMoving](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onInput]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
