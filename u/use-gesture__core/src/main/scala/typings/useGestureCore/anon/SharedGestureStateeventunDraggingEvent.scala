...
import typings.useGestureCore.useGestureCoreStrings.onSeeked
...
trait SharedGestureStateeventunDraggingEvent extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onSeeked]] = js.undefined
...
object SharedGestureStateeventunDraggingEvent {
  ...
  extension [Self <: SharedGestureStateeventunDraggingEvent](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onSeeked]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
