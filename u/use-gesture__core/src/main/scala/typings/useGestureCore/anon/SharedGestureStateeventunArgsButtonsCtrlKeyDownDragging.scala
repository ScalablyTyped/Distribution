...
import typings.useGestureCore.useGestureCoreStrings.onMouseDownCapture
...
trait SharedGestureStateeventunArgsButtonsCtrlKeyDownDragging extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseDownCapture]] = js.undefined
...
object SharedGestureStateeventunArgsButtonsCtrlKeyDownDragging {
  ...
  extension [Self <: SharedGestureStateeventunArgsButtonsCtrlKeyDownDragging](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseDownCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
