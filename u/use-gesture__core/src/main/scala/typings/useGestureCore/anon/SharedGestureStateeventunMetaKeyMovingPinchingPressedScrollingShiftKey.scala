...
import typings.useGestureCore.useGestureCoreStrings.onLostPointerCaptureCapture
...
trait SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onLostPointerCaptureCapture]] = js.undefined
...
object SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKey {
  ...
  extension [Self <: SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onLostPointerCaptureCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
