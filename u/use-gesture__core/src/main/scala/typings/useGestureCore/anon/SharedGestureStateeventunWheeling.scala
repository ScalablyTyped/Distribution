...
import typings.useGestureCore.useGestureCoreStrings.onEndedCapture
...
trait SharedGestureStateeventunWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onEndedCapture]] = js.undefined
...
object SharedGestureStateeventunWheeling {
  ...
  extension [Self <: SharedGestureStateeventunWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onEndedCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
