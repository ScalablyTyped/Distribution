...
import typings.useGestureCore.useGestureCoreStrings.onTimeUpdate
...
trait SharedGestureStateeventunHoveringLocked extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onTimeUpdate]] = js.undefined
...
object SharedGestureStateeventunHoveringLocked {
  ...
  extension [Self <: SharedGestureStateeventunHoveringLocked](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onTimeUpdate]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
