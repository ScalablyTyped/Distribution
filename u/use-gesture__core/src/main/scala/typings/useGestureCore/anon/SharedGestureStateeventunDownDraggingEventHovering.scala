...
import typings.useGestureCore.useGestureCoreStrings.onAbortCapture
...
trait SharedGestureStateeventunDownDraggingEventHovering extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onAbortCapture]] = js.undefined
...
object SharedGestureStateeventunDownDraggingEventHovering {
  ...
  extension [Self <: SharedGestureStateeventunDownDraggingEventHovering](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onAbortCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
