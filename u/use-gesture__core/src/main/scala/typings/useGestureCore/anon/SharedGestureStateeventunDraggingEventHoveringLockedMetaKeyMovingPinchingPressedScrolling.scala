...
import typings.useGestureCore.useGestureCoreStrings.onDragLeave
...
trait SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDragLeave]] = js.undefined
...
object SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling {
  ...
  extension [Self <: SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDragLeave]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
