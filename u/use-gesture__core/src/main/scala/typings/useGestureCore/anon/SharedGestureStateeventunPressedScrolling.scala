...
import typings.useGestureCore.useGestureCoreStrings.onMouseMove
...
trait SharedGestureStateeventunPressedScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseMove]] = js.undefined
...
object SharedGestureStateeventunPressedScrolling {
  ...
  extension [Self <: SharedGestureStateeventunPressedScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseMove]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
