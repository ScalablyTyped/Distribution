...
import typings.useGestureCore.useGestureCoreStrings.onDrop
...
trait SharedGestureStateeventunMetaKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDrop]] = js.undefined
...
object SharedGestureStateeventunMetaKey {
  ...
  extension [Self <: SharedGestureStateeventunMetaKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDrop]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
