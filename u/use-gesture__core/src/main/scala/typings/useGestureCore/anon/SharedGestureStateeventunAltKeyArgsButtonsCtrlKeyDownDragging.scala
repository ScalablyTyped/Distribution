...
import typings.useGestureCore.useGestureCoreStrings.onTouchCancel
...
trait SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDragging extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onTouchCancel]] = js.undefined
...
object SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDragging {
  ...
  extension [Self <: SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDragging](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onTouchCancel]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
