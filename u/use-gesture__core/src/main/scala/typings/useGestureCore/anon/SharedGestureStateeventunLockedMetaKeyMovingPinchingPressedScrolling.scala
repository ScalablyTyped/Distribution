...
import typings.useGestureCore.useGestureCoreStrings.onResetCapture
...
trait SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onResetCapture]] = js.undefined
...
object SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrolling {
  ...
  extension [Self <: SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onResetCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
