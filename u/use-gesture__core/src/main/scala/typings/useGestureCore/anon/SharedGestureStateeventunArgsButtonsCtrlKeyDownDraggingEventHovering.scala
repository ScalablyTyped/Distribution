...
import typings.useGestureCore.useGestureCoreStrings.onLoadStartCapture
...
trait SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHovering extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onLoadStartCapture]] = js.undefined
...
object SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHovering {
  ...
  extension [Self <: SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHovering](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onLoadStartCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
