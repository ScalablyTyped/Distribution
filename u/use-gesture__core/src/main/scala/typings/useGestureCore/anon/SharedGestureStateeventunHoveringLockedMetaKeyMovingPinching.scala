...
import typings.useGestureCore.useGestureCoreStrings.onDragEndCapture
...
trait SharedGestureStateeventunHoveringLockedMetaKeyMovingPinching extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDragEndCapture]] = js.undefined
...
object SharedGestureStateeventunHoveringLockedMetaKeyMovingPinching {
  ...
  extension [Self <: SharedGestureStateeventunHoveringLockedMetaKeyMovingPinching](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDragEndCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
