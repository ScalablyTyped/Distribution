...
import typings.useGestureCore.useGestureCoreStrings.onPointerLeaveCapture
...
trait SharedGestureStateeventunAltKeyArgsButtonsCtrlKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerLeaveCapture]] = js.undefined
...
object SharedGestureStateeventunAltKeyArgsButtonsCtrlKey {
  ...
  extension [Self <: SharedGestureStateeventunAltKeyArgsButtonsCtrlKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerLeaveCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
