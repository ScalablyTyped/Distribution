...
import typings.useGestureCore.useGestureCoreStrings.onBlur
...
trait SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onBlur]] = js.undefined
...
object SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onBlur]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
