...
import typings.useGestureCore.useGestureCoreStrings.onInputCapture
...
trait SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onInputCapture]] = js.undefined
...
object SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling {
  ...
  extension [Self <: SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onInputCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
