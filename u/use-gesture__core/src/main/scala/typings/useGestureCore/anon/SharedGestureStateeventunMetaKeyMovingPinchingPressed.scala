...
import typings.useGestureCore.useGestureCoreStrings.onCanPlay
...
trait SharedGestureStateeventunMetaKeyMovingPinchingPressed extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCanPlay]] = js.undefined
...
object SharedGestureStateeventunMetaKeyMovingPinchingPressed {
  ...
  extension [Self <: SharedGestureStateeventunMetaKeyMovingPinchingPressed](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCanPlay]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
