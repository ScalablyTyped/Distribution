...
import typings.useGestureCore.useGestureCoreStrings.onCompositionEnd
...
trait SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinching extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCompositionEnd]] = js.undefined
...
object SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinching {
  ...
  extension [Self <: SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinching](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCompositionEnd]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
