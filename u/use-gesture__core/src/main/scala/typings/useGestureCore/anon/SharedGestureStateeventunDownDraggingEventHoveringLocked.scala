...
import typings.useGestureCore.useGestureCoreStrings.onMouseOutCapture
...
trait SharedGestureStateeventunDownDraggingEventHoveringLocked extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseOutCapture]] = js.undefined
...
object SharedGestureStateeventunDownDraggingEventHoveringLocked {
  ...
  extension [Self <: SharedGestureStateeventunDownDraggingEventHoveringLocked](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseOutCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
