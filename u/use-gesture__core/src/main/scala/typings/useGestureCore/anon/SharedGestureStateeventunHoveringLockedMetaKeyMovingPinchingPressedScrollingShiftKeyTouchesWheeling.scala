...
object SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling] (val x: Self) extends AnyVal {
