...
import typings.useGestureCore.useGestureCoreStrings.onPointerMoveCapture
...
trait SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerMoveCapture]] = js.undefined
...
object SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerMoveCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
