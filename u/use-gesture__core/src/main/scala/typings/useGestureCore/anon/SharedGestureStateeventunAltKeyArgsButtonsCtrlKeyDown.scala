...
import typings.useGestureCore.useGestureCoreStrings.onMouseLeave
...
trait SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDown extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseLeave]] = js.undefined
...
object SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDown {
  ...
  extension [Self <: SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDown](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseLeave]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
