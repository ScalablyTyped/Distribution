...
import typings.useGestureCore.useGestureCoreStrings.onTouchStartCapture
...
trait SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEvent extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onTouchStartCapture]] = js.undefined
...
object SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEvent {
  ...
  extension [Self <: SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEvent](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onTouchStartCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
