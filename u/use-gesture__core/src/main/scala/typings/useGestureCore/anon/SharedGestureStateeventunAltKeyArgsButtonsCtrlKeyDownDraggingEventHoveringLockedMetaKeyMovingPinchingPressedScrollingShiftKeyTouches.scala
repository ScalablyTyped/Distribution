...
import typings.useGestureCore.useGestureCoreStrings.onDragEnterCapture
...
trait SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDragEnterCapture]] = js.undefined
...
object SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches {
  ...
  extension [Self <: SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDragEnterCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
