...
import typings.useGestureCore.useGestureCoreStrings.onTransitionEndCapture
...
trait SharedGestureStateeventunAltKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onTransitionEndCapture]] = js.undefined
...
object SharedGestureStateeventunAltKey {
  ...
  extension [Self <: SharedGestureStateeventunAltKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onTransitionEndCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
