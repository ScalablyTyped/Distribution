...
import typings.useGestureCore.useGestureCoreStrings.onTouchMove
...
trait SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHovering extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onTouchMove]] = js.undefined
...
object SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHovering {
  ...
  extension [Self <: SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHovering](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onTouchMove]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
