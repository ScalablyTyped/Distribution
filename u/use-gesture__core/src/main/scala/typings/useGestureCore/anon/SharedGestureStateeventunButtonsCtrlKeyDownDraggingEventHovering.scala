...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onTouchMove'> : any | undefined,   args :any} */
trait SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHovering extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onTouchMove'> : any | undefined */ js.Any
...
object SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHovering {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onTouchMove'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHovering = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHovering]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHovering] (val x: Self) extends AnyVal {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onTouchMove'> : any | undefined */ js.Any
