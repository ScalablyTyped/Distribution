...
import typings.useGestureCore.useGestureCoreStrings.onEnded
...
trait SharedGestureStateeventunMetaKeyMoving extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onEnded]] = js.undefined
...
object SharedGestureStateeventunMetaKeyMoving {
  ...
  extension [Self <: SharedGestureStateeventunMetaKeyMoving](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onEnded]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
