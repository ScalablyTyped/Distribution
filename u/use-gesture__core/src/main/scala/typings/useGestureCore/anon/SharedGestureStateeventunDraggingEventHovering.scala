...
import typings.useGestureCore.useGestureCoreStrings.onPauseCapture
...
trait SharedGestureStateeventunDraggingEventHovering extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPauseCapture]] = js.undefined
...
object SharedGestureStateeventunDraggingEventHovering {
  ...
  extension [Self <: SharedGestureStateeventunDraggingEventHovering](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPauseCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
