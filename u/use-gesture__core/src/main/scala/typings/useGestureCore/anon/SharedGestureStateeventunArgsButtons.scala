...
import typings.useGestureCore.useGestureCoreStrings.onPasteCapture
...
trait SharedGestureStateeventunArgsButtons extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPasteCapture]] = js.undefined
...
object SharedGestureStateeventunArgsButtons {
  ...
  extension [Self <: SharedGestureStateeventunArgsButtons](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPasteCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
