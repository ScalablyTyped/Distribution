...
import typings.useGestureCore.useGestureCoreStrings.onCanPlayCapture
...
trait SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLocked extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCanPlayCapture]] = js.undefined
...
object SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLocked {
  ...
  extension [Self <: SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLocked](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCanPlayCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
