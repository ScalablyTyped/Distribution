...
import typings.useGestureCore.useGestureCoreStrings.onCompositionEndCapture
...
trait SharedGestureStateeventunButtonsCtrlKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCompositionEndCapture]] = js.undefined
...
object SharedGestureStateeventunButtonsCtrlKey {
  ...
  extension [Self <: SharedGestureStateeventunButtonsCtrlKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCompositionEndCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
