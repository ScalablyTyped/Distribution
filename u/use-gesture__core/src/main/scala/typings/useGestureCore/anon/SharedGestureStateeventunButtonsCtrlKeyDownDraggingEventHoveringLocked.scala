...
import typings.useGestureCore.useGestureCoreStrings.onAnimationStartCapture
...
trait SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLocked extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onAnimationStartCapture]] = js.undefined
...
object SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLocked {
  ...
  extension [Self <: SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLocked](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onAnimationStartCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
