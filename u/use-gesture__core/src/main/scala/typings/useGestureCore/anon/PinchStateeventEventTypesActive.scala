...
trait PinchStateeventEventTypesActive extends StObject {
...
object PinchStateeventEventTypesActive {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PinchStateeventEventTypesActive] (val x: Self) extends AnyVal {
