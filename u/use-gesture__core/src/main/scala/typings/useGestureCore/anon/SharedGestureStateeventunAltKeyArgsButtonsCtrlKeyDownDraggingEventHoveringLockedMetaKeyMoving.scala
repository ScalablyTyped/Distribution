...
import typings.useGestureCore.useGestureCoreStrings.onPointerUp
...
trait SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMoving extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerUp]] = js.undefined
...
object SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMoving {
  ...
  extension [Self <: SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMoving](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerUp]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
