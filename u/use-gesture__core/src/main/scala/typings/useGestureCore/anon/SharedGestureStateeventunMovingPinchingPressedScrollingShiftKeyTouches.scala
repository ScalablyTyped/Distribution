...
import typings.useGestureCore.useGestureCoreStrings.onErrorCapture
...
trait SharedGestureStateeventunMovingPinchingPressedScrollingShiftKeyTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onErrorCapture]] = js.undefined
...
object SharedGestureStateeventunMovingPinchingPressedScrollingShiftKeyTouches {
  ...
  extension [Self <: SharedGestureStateeventunMovingPinchingPressedScrollingShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onErrorCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
