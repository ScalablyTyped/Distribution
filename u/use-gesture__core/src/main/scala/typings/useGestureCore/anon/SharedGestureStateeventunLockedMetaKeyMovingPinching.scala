...
import typings.useGestureCore.useGestureCoreStrings.onAnimationEnd
...
trait SharedGestureStateeventunLockedMetaKeyMovingPinching extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onAnimationEnd]] = js.undefined
...
object SharedGestureStateeventunLockedMetaKeyMovingPinching {
  ...
  extension [Self <: SharedGestureStateeventunLockedMetaKeyMovingPinching](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onAnimationEnd]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
