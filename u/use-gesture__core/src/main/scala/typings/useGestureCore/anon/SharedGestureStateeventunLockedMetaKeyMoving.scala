...
import typings.useGestureCore.useGestureCoreStrings.onKeyUpCapture
...
trait SharedGestureStateeventunLockedMetaKeyMoving extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onKeyUpCapture]] = js.undefined
...
object SharedGestureStateeventunLockedMetaKeyMoving {
  ...
  extension [Self <: SharedGestureStateeventunLockedMetaKeyMoving](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onKeyUpCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
