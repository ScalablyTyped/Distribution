...
import typings.useGestureCore.useGestureCoreStrings.onProgressCapture
...
trait SharedGestureStateeventunPinchingPressedScrollingShiftKeyTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onProgressCapture]] = js.undefined
...
object SharedGestureStateeventunPinchingPressedScrollingShiftKeyTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunPinchingPressedScrollingShiftKeyTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onProgressCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
