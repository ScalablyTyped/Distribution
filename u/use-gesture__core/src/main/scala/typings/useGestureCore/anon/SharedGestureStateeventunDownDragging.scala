...
import typings.useGestureCore.useGestureCoreStrings.onPaste
...
trait SharedGestureStateeventunDownDragging extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPaste]] = js.undefined
...
object SharedGestureStateeventunDownDragging {
  ...
  extension [Self <: SharedGestureStateeventunDownDragging](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPaste]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
