...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.PinchState & {  event :@use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.EventTypes['pinch']} */
trait PinchStateeventEventTypes extends StObject {
...
object PinchStateeventEventTypes {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[PinchStateeventEventTypes]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PinchStateeventEventTypes] (val x: Self) extends AnyVal {
