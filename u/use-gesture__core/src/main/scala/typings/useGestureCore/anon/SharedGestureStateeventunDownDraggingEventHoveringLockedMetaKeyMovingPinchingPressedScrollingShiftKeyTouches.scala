...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onDragExitCapture'> : any | undefined,   args :any} */
trait SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onDragExitCapture'> : any | undefined */ js.Any
...
object SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onDragExitCapture'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches] (val x: Self) extends AnyVal {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onDragExitCapture'> : any | undefined */ js.Any
