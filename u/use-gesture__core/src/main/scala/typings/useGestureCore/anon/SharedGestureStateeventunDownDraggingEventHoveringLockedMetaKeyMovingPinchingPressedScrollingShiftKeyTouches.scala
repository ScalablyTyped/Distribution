...
import typings.useGestureCore.useGestureCoreStrings.onDragExitCapture
...
trait SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDragExitCapture]] = js.undefined
...
object SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches {
  ...
  extension [Self <: SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDragExitCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
