...
import typings.useGestureCore.useGestureCoreStrings.onContextMenu
...
trait SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMoving extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onContextMenu]] = js.undefined
...
object SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMoving {
  ...
  extension [Self <: SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMoving](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onContextMenu]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
