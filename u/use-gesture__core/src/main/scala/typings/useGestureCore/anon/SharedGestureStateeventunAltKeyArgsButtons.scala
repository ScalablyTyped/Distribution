...
import typings.useGestureCore.useGestureCoreStrings.onPointerOverCapture
...
trait SharedGestureStateeventunAltKeyArgsButtons extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerOverCapture]] = js.undefined
...
object SharedGestureStateeventunAltKeyArgsButtons {
  ...
  extension [Self <: SharedGestureStateeventunAltKeyArgsButtons](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerOverCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
