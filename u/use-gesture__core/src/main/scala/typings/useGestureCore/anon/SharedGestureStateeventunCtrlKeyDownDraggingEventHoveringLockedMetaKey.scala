...
import typings.useGestureCore.useGestureCoreStrings.onDragEnter
...
trait SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDragEnter]] = js.undefined
...
object SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKey {
  ...
  extension [Self <: SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDragEnter]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
