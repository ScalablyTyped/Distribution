...
import typings.useGestureCore.useGestureCoreStrings.onStalledCapture
...
trait SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onStalledCapture]] = js.undefined
...
object SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onStalledCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
