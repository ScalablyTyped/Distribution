...
import typings.useGestureCore.useGestureCoreStrings.onVolumeChangeCapture
...
trait SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressedScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onVolumeChangeCapture]] = js.undefined
...
object SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressedScrolling {
  ...
  extension [Self <: SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressedScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onVolumeChangeCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
