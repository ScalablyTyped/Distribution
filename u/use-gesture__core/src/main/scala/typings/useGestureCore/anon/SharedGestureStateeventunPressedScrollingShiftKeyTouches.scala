...
import typings.useGestureCore.useGestureCoreStrings.onFocusCapture
...
trait SharedGestureStateeventunPressedScrollingShiftKeyTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onFocusCapture]] = js.undefined
...
object SharedGestureStateeventunPressedScrollingShiftKeyTouches {
  ...
  extension [Self <: SharedGestureStateeventunPressedScrollingShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onFocusCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
