...
import typings.useGestureCore.useGestureCoreStrings.onCopyCapture
...
trait SharedGestureStateeventunArgs extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCopyCapture]] = js.undefined
...
object SharedGestureStateeventunArgs {
  ...
  extension [Self <: SharedGestureStateeventunArgs](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCopyCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
