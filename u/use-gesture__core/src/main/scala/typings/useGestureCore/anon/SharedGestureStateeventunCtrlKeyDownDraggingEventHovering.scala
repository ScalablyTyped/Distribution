...
import typings.useGestureCore.useGestureCoreStrings.onPointerLeave
...
trait SharedGestureStateeventunCtrlKeyDownDraggingEventHovering extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerLeave]] = js.undefined
...
object SharedGestureStateeventunCtrlKeyDownDraggingEventHovering {
  ...
  extension [Self <: SharedGestureStateeventunCtrlKeyDownDraggingEventHovering](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerLeave]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
