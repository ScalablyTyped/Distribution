...
import typings.useGestureCore.useGestureCoreStrings.onSuspendCapture
...
trait SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinching extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onSuspendCapture]] = js.undefined
...
object SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinching {
  ...
  extension [Self <: SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinching](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onSuspendCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
