...
import typings.useGestureCore.useGestureCoreStrings.onPointerOver
...
trait SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressed extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerOver]] = js.undefined
...
object SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressed {
  ...
  extension [Self <: SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressed](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerOver]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
