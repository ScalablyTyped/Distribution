...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onPointerOver'> : any | undefined,   args :any} */
trait SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressed extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onPointerOver'> : any | undefined */ js.Any
...
object SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressed {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onPointerOver'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressed = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressed]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunEventHoveringLockedMetaKeyMovingPinchingPressed] (val x: Self) extends AnyVal {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onPointerOver'> : any | undefined */ js.Any
