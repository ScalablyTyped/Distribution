...
import typings.useGestureCore.useGestureCoreStrings.onVolumeChange
...
trait SharedGestureStateeventunMetaKeyMovingPinching extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onVolumeChange]] = js.undefined
...
object SharedGestureStateeventunMetaKeyMovingPinching {
  ...
  extension [Self <: SharedGestureStateeventunMetaKeyMovingPinching](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onVolumeChange]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
