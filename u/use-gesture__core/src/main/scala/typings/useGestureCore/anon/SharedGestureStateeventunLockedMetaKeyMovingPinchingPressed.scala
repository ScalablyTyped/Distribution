...
import typings.useGestureCore.useGestureCoreStrings.onClickCapture
...
trait SharedGestureStateeventunLockedMetaKeyMovingPinchingPressed extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onClickCapture]] = js.undefined
...
object SharedGestureStateeventunLockedMetaKeyMovingPinchingPressed {
  ...
  extension [Self <: SharedGestureStateeventunLockedMetaKeyMovingPinchingPressed](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onClickCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
