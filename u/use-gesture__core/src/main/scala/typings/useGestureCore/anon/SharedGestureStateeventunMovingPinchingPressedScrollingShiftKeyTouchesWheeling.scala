...
import typings.useGestureCore.useGestureCoreStrings.onKeyUp
...
trait SharedGestureStateeventunMovingPinchingPressedScrollingShiftKeyTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onKeyUp]] = js.undefined
...
object SharedGestureStateeventunMovingPinchingPressedScrollingShiftKeyTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunMovingPinchingPressedScrollingShiftKeyTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onKeyUp]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
