...
import typings.useGestureCore.useGestureCoreStrings.onError
...
trait SharedGestureStateeventunEventHovering extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onError]] = js.undefined
...
object SharedGestureStateeventunEventHovering {
  ...
  extension [Self <: SharedGestureStateeventunEventHovering](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onError]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
