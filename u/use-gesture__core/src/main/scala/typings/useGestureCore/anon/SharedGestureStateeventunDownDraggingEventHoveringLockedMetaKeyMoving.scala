...
import typings.useGestureCore.useGestureCoreStrings.onGotPointerCapture
...
trait SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMoving extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onGotPointerCapture]] = js.undefined
...
object SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMoving {
  ...
  extension [Self <: SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMoving](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onGotPointerCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
