...
import typings.useGestureCore.useGestureCoreStrings.onDoubleClickCapture
...
trait SharedGestureStateeventunHoveringLockedMetaKeyMoving extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDoubleClickCapture]] = js.undefined
...
object SharedGestureStateeventunHoveringLockedMetaKeyMoving {
  ...
  extension [Self <: SharedGestureStateeventunHoveringLockedMetaKeyMoving](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDoubleClickCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
