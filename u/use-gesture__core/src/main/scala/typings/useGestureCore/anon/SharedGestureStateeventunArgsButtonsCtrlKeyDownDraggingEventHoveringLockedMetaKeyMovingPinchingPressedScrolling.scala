...
object SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrolling] (val x: Self) extends AnyVal {
