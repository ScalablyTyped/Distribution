...
import typings.useGestureCore.useGestureCoreStrings.onPlay
...
trait SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKeyTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPlay]] = js.undefined
...
object SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKeyTouches {
  ...
  extension [Self <: SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPlay]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
