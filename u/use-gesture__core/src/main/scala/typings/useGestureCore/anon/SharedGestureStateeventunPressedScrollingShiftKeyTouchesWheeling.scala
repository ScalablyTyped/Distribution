...
import typings.useGestureCore.useGestureCoreStrings.onLoad
...
trait SharedGestureStateeventunPressedScrollingShiftKeyTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onLoad]] = js.undefined
...
object SharedGestureStateeventunPressedScrollingShiftKeyTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunPressedScrollingShiftKeyTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onLoad]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
