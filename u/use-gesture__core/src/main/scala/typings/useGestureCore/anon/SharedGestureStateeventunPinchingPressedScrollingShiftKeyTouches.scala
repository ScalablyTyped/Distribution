...
import typings.useGestureCore.useGestureCoreStrings.onSuspend
...
trait SharedGestureStateeventunPinchingPressedScrollingShiftKeyTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onSuspend]] = js.undefined
...
object SharedGestureStateeventunPinchingPressedScrollingShiftKeyTouches {
  ...
  extension [Self <: SharedGestureStateeventunPinchingPressedScrollingShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onSuspend]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
