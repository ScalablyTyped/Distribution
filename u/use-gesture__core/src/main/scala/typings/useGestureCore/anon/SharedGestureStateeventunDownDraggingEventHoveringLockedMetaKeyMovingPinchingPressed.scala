...
import typings.useGestureCore.useGestureCoreStrings.onTouchMoveCapture
...
trait SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressed extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onTouchMoveCapture]] = js.undefined
...
object SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressed {
  ...
  extension [Self <: SharedGestureStateeventunDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressed](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onTouchMoveCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
