...
import typings.useGestureCore.useGestureCoreStrings.onDropCapture
...
trait SharedGestureStateeventunMovingPinchingPressedScrollingShiftKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onDropCapture]] = js.undefined
...
object SharedGestureStateeventunMovingPinchingPressedScrollingShiftKey {
  ...
  extension [Self <: SharedGestureStateeventunMovingPinchingPressedScrollingShiftKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onDropCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
