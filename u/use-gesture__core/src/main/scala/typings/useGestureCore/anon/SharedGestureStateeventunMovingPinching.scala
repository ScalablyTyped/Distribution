...
import typings.useGestureCore.useGestureCoreStrings.onPointerCancel
...
trait SharedGestureStateeventunMovingPinching extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPointerCancel]] = js.undefined
...
object SharedGestureStateeventunMovingPinching {
  ...
  extension [Self <: SharedGestureStateeventunMovingPinching](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPointerCancel]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
