...
import typings.useGestureCore.useGestureCoreStrings.onPlaying
...
trait SharedGestureStateeventunAltKeyArgs extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onPlaying]] = js.undefined
...
object SharedGestureStateeventunAltKeyArgs {
  ...
  extension [Self <: SharedGestureStateeventunAltKeyArgs](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onPlaying]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
