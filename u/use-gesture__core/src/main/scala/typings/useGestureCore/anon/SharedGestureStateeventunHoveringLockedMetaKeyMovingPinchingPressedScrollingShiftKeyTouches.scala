...
object SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches] (val x: Self) extends AnyVal {
