...
import typings.useGestureCore.useGestureCoreStrings.onSelectCapture
...
trait SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onSelectCapture]] = js.undefined
...
object SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches {
  ...
  extension [Self <: SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onSelectCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
