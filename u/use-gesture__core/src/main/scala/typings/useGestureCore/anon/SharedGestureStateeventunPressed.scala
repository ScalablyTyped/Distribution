...
import typings.useGestureCore.useGestureCoreStrings.onLoadCapture
...
trait SharedGestureStateeventunPressed extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onLoadCapture]] = js.undefined
...
object SharedGestureStateeventunPressed {
  ...
  extension [Self <: SharedGestureStateeventunPressed](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onLoadCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
