...
import typings.useGestureCore.useGestureCoreStrings.onWheelCapture
...
trait SharedGestureStateeventunPinchingPressedScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onWheelCapture]] = js.undefined
...
object SharedGestureStateeventunPinchingPressedScrolling {
  ...
  extension [Self <: SharedGestureStateeventunPinchingPressedScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onWheelCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
