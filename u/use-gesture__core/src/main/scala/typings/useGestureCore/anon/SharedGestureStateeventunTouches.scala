...
import typings.useGestureCore.useGestureCoreStrings.onSeekingCapture
...
trait SharedGestureStateeventunTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onSeekingCapture]] = js.undefined
...
object SharedGestureStateeventunTouches {
  ...
  extension [Self <: SharedGestureStateeventunTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onSeekingCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
