...
import typings.useGestureCore.useGestureCoreStrings.onChangeCapture
...
trait SharedGestureStateeventunScrollingShiftKeyTouchesWheeling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onChangeCapture]] = js.undefined
...
object SharedGestureStateeventunScrollingShiftKeyTouchesWheeling {
  ...
  extension [Self <: SharedGestureStateeventunScrollingShiftKeyTouchesWheeling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onChangeCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
