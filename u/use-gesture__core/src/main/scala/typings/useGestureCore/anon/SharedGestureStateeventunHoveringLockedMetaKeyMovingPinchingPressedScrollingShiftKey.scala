...
import typings.useGestureCore.useGestureCoreStrings.onFocus
...
trait SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onFocus]] = js.undefined
...
object SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey {
  ...
  extension [Self <: SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onFocus]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
