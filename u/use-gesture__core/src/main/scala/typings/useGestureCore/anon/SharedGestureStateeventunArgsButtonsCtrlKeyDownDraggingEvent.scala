...
import typings.useGestureCore.useGestureCoreStrings.onAnimationStart
...
trait SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEvent extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onAnimationStart]] = js.undefined
...
object SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEvent {
  ...
  extension [Self <: SharedGestureStateeventunArgsButtonsCtrlKeyDownDraggingEvent](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onAnimationStart]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
