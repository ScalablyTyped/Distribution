...
import typings.useGestureCore.useGestureCoreStrings.onMouseOverCapture
...
trait SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseOverCapture]] = js.undefined
...
object SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey {
  ...
  extension [Self <: SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressedScrollingShiftKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseOverCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
