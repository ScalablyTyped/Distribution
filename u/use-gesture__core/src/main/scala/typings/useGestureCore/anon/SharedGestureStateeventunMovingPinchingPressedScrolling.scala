...
import typings.useGestureCore.useGestureCoreStrings.onMouseOut
...
trait SharedGestureStateeventunMovingPinchingPressedScrolling extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseOut]] = js.undefined
...
object SharedGestureStateeventunMovingPinchingPressedScrolling {
  ...
  extension [Self <: SharedGestureStateeventunMovingPinchingPressedScrolling](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseOut]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
