...
import typings.useGestureCore.useGestureCoreStrings.onAnimationIterationCapture
...
trait SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressed extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onAnimationIterationCapture]] = js.undefined
...
object SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressed {
  ...
  extension [Self <: SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMovingPinchingPressed](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onAnimationIterationCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
