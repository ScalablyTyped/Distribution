...
import typings.useGestureCore.useGestureCoreStrings.onSubmitCapture
...
trait SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressed extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onSubmitCapture]] = js.undefined
...
object SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressed {
  ...
  extension [Self <: SharedGestureStateeventunButtonsCtrlKeyDownDraggingEventHoveringLockedMetaKeyMovingPinchingPressed](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onSubmitCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
