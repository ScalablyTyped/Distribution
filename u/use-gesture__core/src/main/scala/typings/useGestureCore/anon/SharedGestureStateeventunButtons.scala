...
import typings.useGestureCore.useGestureCoreStrings.onLostPointerCapture
...
trait SharedGestureStateeventunButtons extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onLostPointerCapture]] = js.undefined
...
object SharedGestureStateeventunButtons {
  ...
  extension [Self <: SharedGestureStateeventunButtons](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onLostPointerCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
