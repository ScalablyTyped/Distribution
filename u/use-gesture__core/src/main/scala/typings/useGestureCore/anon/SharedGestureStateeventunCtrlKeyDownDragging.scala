...
import typings.useGestureCore.useGestureCoreStrings.onCopy
...
trait SharedGestureStateeventunCtrlKeyDownDragging extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCopy]] = js.undefined
...
object SharedGestureStateeventunCtrlKeyDownDragging {
  ...
  extension [Self <: SharedGestureStateeventunCtrlKeyDownDragging](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCopy]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
