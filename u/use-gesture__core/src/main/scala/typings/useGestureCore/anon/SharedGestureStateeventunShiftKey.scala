...
import typings.useGestureCore.useGestureCoreStrings.onAnimationIteration
...
trait SharedGestureStateeventunShiftKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onAnimationIteration]] = js.undefined
...
object SharedGestureStateeventunShiftKey {
  ...
  extension [Self <: SharedGestureStateeventunShiftKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onAnimationIteration]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
