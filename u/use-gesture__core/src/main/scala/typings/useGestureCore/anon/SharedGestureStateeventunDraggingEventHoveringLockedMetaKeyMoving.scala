...
import typings.useGestureCore.useGestureCoreStrings.onCutCapture
...
trait SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMoving extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCutCapture]] = js.undefined
...
object SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMoving {
  ...
  extension [Self <: SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMoving](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCutCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
