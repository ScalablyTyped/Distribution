...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onCutCapture'> : any | undefined,   args :any} */
trait SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMoving extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onCutCapture'> : any | undefined */ js.Any
...
object SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMoving {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onCutCapture'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMoving = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMoving]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SharedGestureStateeventunDraggingEventHoveringLockedMetaKeyMoving] (val x: Self) extends AnyVal {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onCutCapture'> : any | undefined */ js.Any
