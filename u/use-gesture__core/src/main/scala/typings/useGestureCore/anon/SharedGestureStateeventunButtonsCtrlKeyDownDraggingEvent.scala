...
import typings.useGestureCore.useGestureCoreStrings.onProgress
...
trait SharedGestureStateeventunButtonsCtrlKeyDownDraggingEvent extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onProgress]] = js.undefined
...
object SharedGestureStateeventunButtonsCtrlKeyDownDraggingEvent {
  ...
  extension [Self <: SharedGestureStateeventunButtonsCtrlKeyDownDraggingEvent](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onProgress]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
