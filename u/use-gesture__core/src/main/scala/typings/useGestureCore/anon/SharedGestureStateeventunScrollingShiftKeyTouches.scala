...
import typings.useGestureCore.useGestureCoreStrings.onCompositionUpdateCapture
...
trait SharedGestureStateeventunScrollingShiftKeyTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCompositionUpdateCapture]] = js.undefined
...
object SharedGestureStateeventunScrollingShiftKeyTouches {
  ...
  extension [Self <: SharedGestureStateeventunScrollingShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCompositionUpdateCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
