...
import typings.useGestureCore.useGestureCoreStrings.onCanPlayThrough
...
trait SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onCanPlayThrough]] = js.undefined
...
object SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches {
  ...
  extension [Self <: SharedGestureStateeventunLockedMetaKeyMovingPinchingPressedScrollingShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onCanPlayThrough]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
