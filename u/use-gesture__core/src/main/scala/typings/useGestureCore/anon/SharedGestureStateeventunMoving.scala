...
import typings.useGestureCore.useGestureCoreStrings.onMouseMoveCapture
...
trait SharedGestureStateeventunMoving extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onMouseMoveCapture]] = js.undefined
...
object SharedGestureStateeventunMoving {
  ...
  extension [Self <: SharedGestureStateeventunMoving](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onMouseMoveCapture]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
