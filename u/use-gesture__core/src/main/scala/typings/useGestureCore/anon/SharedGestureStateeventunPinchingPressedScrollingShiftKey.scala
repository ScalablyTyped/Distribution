...
import typings.useGestureCore.useGestureCoreStrings.onKeyDown
...
trait SharedGestureStateeventunPinchingPressedScrollingShiftKey extends StObject {
  ...
  var event: js.UndefOr[Any | GetEventType[onKeyDown]] = js.undefined
...
object SharedGestureStateeventunPinchingPressedScrollingShiftKey {
  ...
  extension [Self <: SharedGestureStateeventunPinchingPressedScrollingShiftKey](x: Self) {
    ...
    inline def setEvent(value: Any | GetEventType[onKeyDown]): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
