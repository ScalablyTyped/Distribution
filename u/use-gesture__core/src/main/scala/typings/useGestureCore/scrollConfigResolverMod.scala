...
object scrollConfigResolverMod {
  
  object scrollConfigResolver {
    
    @JSImport("@use-gesture/core/dist/declarations/src/config/scrollConfigResolver", "scrollConfigResolver")
    @js.native
