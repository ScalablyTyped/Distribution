...
object distDeclarationsSrcConfigWheelConfigResolverMod {
  
  object wheelConfigResolver {
    
    @JSImport("@use-gesture/core/dist/declarations/src/config/wheelConfigResolver", "wheelConfigResolver")
    @js.native
