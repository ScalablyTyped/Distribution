...
/**
  ...
  */
@js.native
trait LightBox_ extends js.Object {
  /**
  ...
  def apply(element: JQuery_[HTMLElement]): LightBoxElement = js.native
  def apply(element: JQuery_[HTMLElement], options: LightBoxOptions): LightBoxElement = js.native
  /**
