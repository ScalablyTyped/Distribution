...
object urijsStrings {
  ...
  inline def idn: idn = "idn".asInstanceOf[idn]
  
  @js.native
  sealed trait inet4 extends StObject
  inline def inet4: inet4 = "inet4".asInstanceOf[inet4]
  
  @js.native
  sealed trait inet6 extends StObject
  inline def inet6: inet6 = "inet6".asInstanceOf[inet6]
  ...
  inline def punycode: punycode = "punycode".asInstanceOf[punycode]
