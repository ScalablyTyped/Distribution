...
object specialCharsMod {
  
  @JSImport("jest-util/build/specialChars", "ARROW")
  @js.native
  val ARROW: /* " \\u203A " */ String = js.native
  
  @JSImport("jest-util/build/specialChars", "CLEAR")
  @js.native
  val CLEAR: String = js.native
  
  object ICONS {
    
    @JSImport("jest-util/build/specialChars", "ICONS")
    @js.native
