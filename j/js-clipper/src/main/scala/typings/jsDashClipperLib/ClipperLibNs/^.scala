...
object ^ extends js.Object {
  ...
  def Clean(polygon: stdLib.ArrayLike[stdLib.ArrayLike[IntPoint] | IntPoint], delta: scala.Double): stdLib.ArrayLike[stdLib.ArrayLike[IntPoint] | IntPoint] = js.native
  def Clear(a: stdLib.ArrayLike[_]): scala.Unit = js.native
  def Clone(polygon: stdLib.ArrayLike[stdLib.ArrayLike[IntPoint] | IntPoint]): stdLib.ArrayLike[stdLib.ArrayLike[IntPoint] | IntPoint] = js.native
  def Error(message: java.lang.String): scala.Unit = js.native
  def Lighten(polygon: stdLib.ArrayLike[stdLib.ArrayLike[IntPoint] | IntPoint], tolerance: scala.Double): stdLib.ArrayLike[stdLib.ArrayLike[IntPoint] | IntPoint] = js.native
