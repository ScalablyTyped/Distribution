...
object Protects extends js.Object {
  ...
  /* 3 */ val ipBoth: typings.jsDashClipper.ClipperLibNs.Protects.ipBoth with Double = js.native
  /* 1 */ val ipLeft: typings.jsDashClipper.ClipperLibNs.Protects.ipLeft with Double = js.native
  /* 0 */ val ipNone: typings.jsDashClipper.ClipperLibNs.Protects.ipNone with Double = js.native
  /* 2 */ val ipRight: typings.jsDashClipper.ClipperLibNs.Protects.ipRight with Double = js.native
  @JSBracketAccess
