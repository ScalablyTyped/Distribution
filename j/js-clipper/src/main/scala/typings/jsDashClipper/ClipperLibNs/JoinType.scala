...
object JoinType extends js.Object {
  ...
  /* 2 */ val jtMiter: typings.jsDashClipper.ClipperLibNs.JoinType.jtMiter with Double = js.native
  /* 1 */ val jtRound: typings.jsDashClipper.ClipperLibNs.JoinType.jtRound with Double = js.native
  /* 0 */ val jtSquare: typings.jsDashClipper.ClipperLibNs.JoinType.jtSquare with Double = js.native
  @JSBracketAccess
