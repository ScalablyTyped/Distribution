...
object justDashDebounceDashItMod extends js.Object {
  ...
  def apply[T /* <: js.Function */](fn: T, wait: scala.Double): js.Function1[/* args */ justDashDebounceDashItLib.ArgumentTypes[T], scala.Unit] = js.native
  def apply[T /* <: js.Function */](
    fn: T,
    wait: scala.Double,
    callFirst: justDashDebounceDashItLib.justDashDebounceDashItLibNumbers.`false`
  ): js.Function1[/* args */ justDashDebounceDashItLib.ArgumentTypes[T], scala.Unit] = js.native
  def apply[T /* <: js.Function */](
    fn: T,
    wait: scala.Double,
