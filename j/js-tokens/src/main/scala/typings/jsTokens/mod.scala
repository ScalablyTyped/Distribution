...
import typings.jsTokens.anon.Jsx
import typings.jsTokens.anon.`10`
...
object mod {
  ...
  inline def default(input: String, options: Jsx): js.Iterable[Token | JSXToken] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(input.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Iterable[Token | JSXToken]]
  inline def default(input: String, options: `10`): js.Iterable[Token] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(input.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Iterable[Token]]
  ...
  */
  ...
  object JSXToken {
    ...
    inline def `9`(value: String): typings.jsTokens.anon.`9` = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("JSXInvalid")
      __obj.asInstanceOf[typings.jsTokens.anon.`9`]
    }
  ...
  */
  ...
  object Token {
    ...
    inline def Type(closed: Boolean, value: String): typings.jsTokens.anon.Type = {
      val __obj = js.Dynamic.literal(closed = closed.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
