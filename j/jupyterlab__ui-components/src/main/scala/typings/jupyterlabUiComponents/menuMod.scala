...
import typings.luminoWidgets.menuMod.Menu.IItem
...
object menuMod {
  ...
  trait IRankedMenu
    ...
    /**
      ...
      */
    def addItem(options: typings.jupyterlabUiComponents.menuMod.IRankedMenu.IItemOptions): IItem = js.native
  ...
  object IRankedMenu {
    ...
    object IItemOptions {
      ...
      inline def apply(): typings.jupyterlabUiComponents.menuMod.IRankedMenu.IItemOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typings.jupyterlabUiComponents.menuMod.IRankedMenu.IItemOptions]
      }
      
      extension [Self <: typings.jupyterlabUiComponents.menuMod.IRankedMenu.IItemOptions](x: Self) {
    ...
    trait IOptions
      extends StObject
         with typings.luminoWidgets.menuMod.Menu.IOptions {
  ...
  open class RankedMenu protected ()
    ...
    /**
      ...
      */
    def insertItem(index: Double, options: typings.jupyterlabUiComponents.menuMod.IRankedMenu.IItemOptions): IDisposableMenuItem = js.native
