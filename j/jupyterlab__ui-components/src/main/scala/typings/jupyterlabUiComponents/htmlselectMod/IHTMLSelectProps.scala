...
object IHTMLSelectProps {
  ...
  def apply(
    ...
    defaultStyle: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(defaultStyle)) __obj.updateDynamic("defaultStyle")(defaultStyle.get.asInstanceOf[js.Any])
