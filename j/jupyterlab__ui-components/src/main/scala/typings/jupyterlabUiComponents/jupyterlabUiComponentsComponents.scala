...
object jupyterlabUiComponentsComponents extends jupyterlabUiComponentsProps {
  @scala.inline
  ...
  (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ICollapseProps */ js.Any) with typings.jupyterlabUiComponents.blueprintMod.CommonProps[js.Any]]]
  @scala.inline
  def HTMLSelect: ComponentType[HTMLSelectProps] = js.constructorOf[typings.jupyterlabUiComponents.mod.HTMLSelect].asInstanceOf[typings.react.mod.ComponentType[HTMLSelectProps]]
  @scala.inline
  def InputGroup: ComponentType[IInputGroupProps with CommonProps[js.Any]] = typings.jupyterlabUiComponents.mod.asInstanceOf[js.Dynamic].selectDynamic("InputGroup").asInstanceOf[typings.react.mod.ComponentType[
  typings.jupyterlabUiComponents.blueprintMod.IInputGroupProps with typings.jupyterlabUiComponents.blueprintMod.CommonProps[js.Any]]]
  @scala.inline
  def Select: ComponentType[
    (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ISelectProps<any> */ js.Any) with CommonProps[js.Any]
  ] = typings.jupyterlabUiComponents.mod.asInstanceOf[js.Dynamic].selectDynamic("Select").asInstanceOf[typings.react.mod.ComponentType[
  (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ISelectProps<any> */ js.Any) with typings.jupyterlabUiComponents.blueprintMod.CommonProps[js.Any]]]
}
