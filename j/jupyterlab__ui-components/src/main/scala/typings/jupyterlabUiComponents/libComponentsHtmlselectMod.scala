...
import typings.jupyterlabUiComponents.libComponentsInterfaceMod.IElementRefProps
import typings.jupyterlabUiComponents.libIconLabiconMod.LabIcon.IProps
import typings.jupyterlabUiComponents.libIconMod.LabIcon
...
object libComponentsHtmlselectMod {
