...
import typings.jupyterlabUiComponents.libIconLabiconMod.LabIcon.ILabIcon
import typings.jupyterlabUiComponents.libIconLabiconMod.LabIcon.IProps
import typings.jupyterlabUiComponents.libIconLabiconMod.LabIcon.IReact
import typings.jupyterlabUiComponents.libIconLabiconMod.LabIcon.IReactProps
import typings.jupyterlabUiComponents.libIconLabiconMod.LabIcon.IRendererOptions
...
object libIconLabiconMod {
  ...
  object LabIcon {
    ...
    trait IProps
      extends StObject
         with typings.jupyterlabUiComponents.libStyleIconMod.LabIconStyle.IProps {
