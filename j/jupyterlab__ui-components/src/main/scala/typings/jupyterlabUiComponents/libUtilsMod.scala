...
object libUtilsMod {
  ...
  inline def getReactAttrs(elem: Element, param1: Ignore): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("getReactAttrs")(elem.asInstanceOf[js.Any], param1.asInstanceOf[js.Any])).asInstanceOf[Any]
}
