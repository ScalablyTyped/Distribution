...
object testResultMod {
  ...
  object AssertionResult {
    ...
    extension [Self <: AssertionResult](x: Self) {
      ...
      inline def setFailureDetails(value: js.Array[js.Any]): Self = StObject.set(x, "failureDetails", value.asInstanceOf[js.Any])
      
      inline def setFailureDetailsVarargs(value: js.Any*): Self = StObject.set(x, "failureDetails", js.Array(value :_*))
  ...
  */
  ...
  object Status {
    ...
    inline def pending: typings.jestTypes.jestTypesStrings.pending = "pending".asInstanceOf[typings.jestTypes.jestTypesStrings.pending]
    
    inline def skipped: typings.jestTypes.jestTypesStrings.skipped = "skipped".asInstanceOf[typings.jestTypes.jestTypesStrings.skipped]
