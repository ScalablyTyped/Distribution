...
/* argName */ StringDictionary[Any] {
  ...
  var ignoreProjects: js.UndefOr[js.Array[String]] = js.undefined
  ...
  var testEnvironmentOptions: js.UndefOr[String] = js.undefined
...
object Argv {
  ...
  inline def apply($0: String, _underscore: js.Array[String | Double]): Argv = {
  ...
  extension [Self <: Argv](x: Self) {
    ...
    inline def setCollectCoverageFrom(value: String): Self = StObject.set(x, "collectCoverageFrom", value.asInstanceOf[js.Any])
    ...
    inline def setCoverageThreshold(value: String): Self = StObject.set(x, "coverageThreshold", value.asInstanceOf[js.Any])
    ...
    inline def setGlobals(value: String): Self = StObject.set(x, "globals", value.asInstanceOf[js.Any])
    
    inline def setGlobalsUndefined: Self = StObject.set(x, "globals", js.undefined)
    
    inline def setHaste(value: String): Self = StObject.set(x, "haste", value.asInstanceOf[js.Any])
    
    inline def setHasteUndefined: Self = StObject.set(x, "haste", js.undefined)
    
    inline def setIgnoreProjects(value: js.Array[String]): Self = StObject.set(x, "ignoreProjects", value.asInstanceOf[js.Any])
    
    inline def setIgnoreProjectsUndefined: Self = StObject.set(x, "ignoreProjects", js.undefined)
    
    inline def setIgnoreProjectsVarargs(value: String*): Self = StObject.set(x, "ignoreProjects", js.Array(value*))
    ...
    inline def setModuleNameMapper(value: String): Self = StObject.set(x, "moduleNameMapper", value.asInstanceOf[js.Any])
    ...
    inline def setSelectProjectsVarargs(value: String*): Self = StObject.set(x, "selectProjects", js.Array(value*))
    ...
    inline def setTestEnvironmentOptions(value: String): Self = StObject.set(x, "testEnvironmentOptions", value.asInstanceOf[js.Any])
    ...
    inline def setTestFailureExitCode(value: String): Self = StObject.set(x, "testFailureExitCode", value.asInstanceOf[js.Any])
    
    inline def setTestFailureExitCodeNull: Self = StObject.set(x, "testFailureExitCode", null)
    ...
    inline def setUnmockedModulePathPatternsNull: Self = StObject.set(x, "unmockedModulePathPatterns", null)
