...
/* Inlined @jest/types.@jest/types.InitialOptions & std.Required<std.Pick<@jest/types.@jest/types.InitialOptions, 'rootDir'>> */
...
object InitialOptionsWithRootDir {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InitialOptionsWithRootDir] (val x: Self) extends AnyVal {
