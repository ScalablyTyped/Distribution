...
object ProjectConfig {
  ...
  implicit class ProjectConfigOps[Self <: ProjectConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTestRegexVarargs(value: (String | RegExp)*): Self = this.set("testRegex", js.Array(value :_*))
    
    @scala.inline
    def setTestRegex(value: js.Array[String | RegExp]): Self = this.set("testRegex", value.asInstanceOf[js.Any])
