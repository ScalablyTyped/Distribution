...
trait Env extends js.Object {
  ...
  def afterAll(afterAllFunction: typings.jasmine.jasmine.ImplementationCallback): Unit = js.native
  def afterAll(afterAllFunction: typings.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = js.native
  def afterEach(afterEachFunction: typings.jasmine.jasmine.ImplementationCallback): Unit = js.native
  def afterEach(afterEachFunction: typings.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = js.native
  def allowRespy(allow: Boolean): Unit = js.native
  def beforeAll(beforeAllFunction: typings.jasmine.jasmine.ImplementationCallback): Unit = js.native
  def beforeAll(beforeAllFunction: typings.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = js.native
  // ddescribe(description: string, specDefinitions: () => void): Suite; Not a part of jasmine. Angular team adds these
  def beforeEach(beforeEachFunction: typings.jasmine.jasmine.ImplementationCallback): Unit = js.native
  def beforeEach(beforeEachFunction: typings.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = js.native
