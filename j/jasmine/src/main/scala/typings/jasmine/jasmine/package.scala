...
{[ K in keyof T ]: jasmine.jasmine.ExpectedRecursive<T[K]>}
  */ typings.jasmine.jasmineStrings.Expected & org.scalablytyped.runtime.TopLevel[T]) | T
...
{[ K in keyof T ]: / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias jasmine.jasmine.ExpectedRecursive<T[K]> * / object | jasmine.jasmine.Any}
  */ typings.jasmine.jasmineStrings.ExpectedRecursive & org.scalablytyped.runtime.TopLevel[js.Any])
...
{[ K in keyof any ]: any[K] | jasmine.jasmine.AsymmetricMatcher<any>}
  */ typings.jasmine.jasmineStrings.MatchableArgs & org.scalablytyped.runtime.TopLevel[js.Any]
...
{[ K in keyof T ]: T[K] extends jasmine.jasmine.Func? jasmine.jasmine.Func : T[K]}
  */ typings.jasmine.jasmineStrings.NonTypedSpyObj & org.scalablytyped.runtime.TopLevel[js.Any]]
...
type SpyObj[T] = T & typings.jasmine.jasmineStrings.SpyObj & org.scalablytyped.runtime.TopLevel[js.Any]
...
{[ P in keyof T ]:? T[P] extends jasmine.jasmine.Func? std.ReturnType<T[P]> : any}
  */ typings.jasmine.jasmineStrings.SpyObjMethodNames & org.scalablytyped.runtime.TopLevel[js.Any]) | org.scalablytyped.runtime.StringDictionary[js.Any]
...
{[ P in keyof T ]:? T[P]}
  */ typings.jasmine.jasmineStrings.SpyObjPropertyNames & org.scalablytyped.runtime.TopLevel[T]) | org.scalablytyped.runtime.StringDictionary[js.Any]
