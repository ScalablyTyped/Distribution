...
object JScrollPaneSettings {
  ...
  def apply(
    ...
    arrowButtonSpeed: js.UndefOr[Double] = js.undefined,
    arrowRepeatFreq: js.UndefOr[Double] = js.undefined,
    arrowScrollOnHover: js.UndefOr[Boolean] = js.undefined,
    autoReinitialise: js.UndefOr[Boolean] = js.undefined,
    autoReinitialiseDelay: js.UndefOr[Double] = js.undefined,
    clickOnTrack: js.UndefOr[Boolean] = js.undefined,
    contentWidth: js.UndefOr[Double] = js.undefined,
    ...
    horizontalDragMaxWidth: js.UndefOr[Double] = js.undefined,
    horizontalDragMinWidth: js.UndefOr[Double] = js.undefined,
    horizontalGutter: js.UndefOr[Double] = js.undefined,
    ...
    trackClickRepeatFreq: js.UndefOr[Double] = js.undefined,
    trackClickSpeed: js.UndefOr[Double] = js.undefined,
    verticalArrowPositions: String = null,
    verticalDragMaxHeight: js.UndefOr[Double] = js.undefined,
    verticalDragMinHeight: js.UndefOr[Double] = js.undefined,
    verticalGutter: js.UndefOr[Double] = js.undefined
  ): JScrollPaneSettings = {
    ...
    if (!js.isUndefined(arrowButtonSpeed)) __obj.updateDynamic("arrowButtonSpeed")(arrowButtonSpeed.get.asInstanceOf[js.Any])
    if (!js.isUndefined(arrowRepeatFreq)) __obj.updateDynamic("arrowRepeatFreq")(arrowRepeatFreq.get.asInstanceOf[js.Any])
    if (!js.isUndefined(arrowScrollOnHover)) __obj.updateDynamic("arrowScrollOnHover")(arrowScrollOnHover.get.asInstanceOf[js.Any])
    if (!js.isUndefined(autoReinitialise)) __obj.updateDynamic("autoReinitialise")(autoReinitialise.get.asInstanceOf[js.Any])
    if (!js.isUndefined(autoReinitialiseDelay)) __obj.updateDynamic("autoReinitialiseDelay")(autoReinitialiseDelay.get.asInstanceOf[js.Any])
    if (!js.isUndefined(clickOnTrack)) __obj.updateDynamic("clickOnTrack")(clickOnTrack.get.asInstanceOf[js.Any])
    if (!js.isUndefined(contentWidth)) __obj.updateDynamic("contentWidth")(contentWidth.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableKeyboardNavigation)) __obj.updateDynamic("enableKeyboardNavigation")(enableKeyboardNavigation.get.asInstanceOf[js.Any])
    if (!js.isUndefined(hideFocus)) __obj.updateDynamic("hideFocus")(hideFocus.get.asInstanceOf[js.Any])
    if (!js.isUndefined(hijackInternalLinks)) __obj.updateDynamic("hijackInternalLinks")(hijackInternalLinks.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(horizontalDragMaxWidth)) __obj.updateDynamic("horizontalDragMaxWidth")(horizontalDragMaxWidth.get.asInstanceOf[js.Any])
    if (!js.isUndefined(horizontalDragMinWidth)) __obj.updateDynamic("horizontalDragMinWidth")(horizontalDragMinWidth.get.asInstanceOf[js.Any])
    if (!js.isUndefined(horizontalGutter)) __obj.updateDynamic("horizontalGutter")(horizontalGutter.get.asInstanceOf[js.Any])
    if (!js.isUndefined(maintainPosition)) __obj.updateDynamic("maintainPosition")(maintainPosition.get.asInstanceOf[js.Any])
    if (!js.isUndefined(mouseWheelSpeed)) __obj.updateDynamic("mouseWheelSpeed")(mouseWheelSpeed.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showArrows)) __obj.updateDynamic("showArrows")(showArrows.get.asInstanceOf[js.Any])
    if (!js.isUndefined(stickToBottom)) __obj.updateDynamic("stickToBottom")(stickToBottom.get.asInstanceOf[js.Any])
    if (!js.isUndefined(stickToRight)) __obj.updateDynamic("stickToRight")(stickToRight.get.asInstanceOf[js.Any])
    if (!js.isUndefined(trackClickRepeatFreq)) __obj.updateDynamic("trackClickRepeatFreq")(trackClickRepeatFreq.get.asInstanceOf[js.Any])
    if (!js.isUndefined(trackClickSpeed)) __obj.updateDynamic("trackClickSpeed")(trackClickSpeed.get.asInstanceOf[js.Any])
    if (verticalArrowPositions != null) __obj.updateDynamic("verticalArrowPositions")(verticalArrowPositions.asInstanceOf[js.Any])
    if (!js.isUndefined(verticalDragMaxHeight)) __obj.updateDynamic("verticalDragMaxHeight")(verticalDragMaxHeight.get.asInstanceOf[js.Any])
    if (!js.isUndefined(verticalDragMinHeight)) __obj.updateDynamic("verticalDragMinHeight")(verticalDragMinHeight.get.asInstanceOf[js.Any])
    if (!js.isUndefined(verticalGutter)) __obj.updateDynamic("verticalGutter")(verticalGutter.get.asInstanceOf[js.Any])
