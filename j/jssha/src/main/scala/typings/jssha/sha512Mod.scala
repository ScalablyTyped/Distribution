...
object sha512Mod {
  ...
  @JSImport("jssha/dist/sha512", JSImport.Default)
  @js.native
  ...
  */
  ...
  object GenericInputType {
    ...
    inline def FormatValueString(value: String): typings.jssha.anon.FormatValueString = {
  ...
  */
  ...
  trait jsSHA
    extends StObject
       with jsSHABase[js.Array[Int64], VariantType] {
    
    def finalizeFunc(remainder: js.Array[Double], remainderBinLen: Double, processedBinLen: Double, H: js.Array[Int64]): js.Array[Double] = js.native
