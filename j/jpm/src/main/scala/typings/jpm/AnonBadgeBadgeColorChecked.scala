...
trait AnonBadgeBadgeColorChecked extends js.Object {
...
object AnonBadgeBadgeColorChecked {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonBadgeBadgeColorChecked]
  }
}
