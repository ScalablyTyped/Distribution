...
object sdkContextMenuMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.jpm.sdkContextMenuMod.Item
    - typings.jpm.sdkContextMenuMod.Menu
    - typings.jpm.sdkContextMenuMod.Separator
  */
  trait ItemMenuSeparator extends StObject
  object ItemMenuSeparator {
    
    inline def Item(context: ItemContext, data: Any, destroy: () => Unit, image: String | URL, label: String): typings.jpm.sdkContextMenuMod.Item = {
      ...
      __obj.asInstanceOf[typings.jpm.sdkContextMenuMod.Item]
    }
    ...
    inline def Menu(
      ...
      __obj.asInstanceOf[typings.jpm.sdkContextMenuMod.Menu]
    }
    
    inline def Separator(destroy: () => Unit, parentMenu: Menu): typings.jpm.sdkContextMenuMod.Separator = {
      val __obj = js.Dynamic.literal(destroy = js.Any.fromFunction0(destroy), parentMenu = parentMenu.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.jpm.sdkContextMenuMod.Separator]
    }
  }
}
