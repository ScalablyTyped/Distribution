...
object jpmStrings {
  ...
  inline def OverQuota: OverQuota = "OverQuota".asInstanceOf[OverQuota]
  ...
  inline def downgrade: downgrade = "downgrade".asInstanceOf[downgrade]
  ...
  sealed trait existing
    extends StObject
       with attachmentMode
  inline def existing: existing = "existing".asInstanceOf[existing]
