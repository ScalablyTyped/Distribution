...
trait AnonAnonymousContent[ResponseType] extends js.Object {
...
object AnonAnonymousContent {
  ...
  def apply[ResponseType](
  ...
  ): AnonAnonymousContent[ResponseType] = {
    ...
    __obj.asInstanceOf[AnonAnonymousContent[ResponseType]]
  }
}
