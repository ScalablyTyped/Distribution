...
trait Anon_ContentScript extends js.Object {
  ...
  var context: js.UndefOr[js.Array[jpmLib.sdkContextDashMenuMod.Context]] = js.native
  var image: js.UndefOr[java.lang.String] = js.native
  var items: js.Array[jpmLib.sdkContextDashMenuMod.ItemMenuSeparator] = js.native
