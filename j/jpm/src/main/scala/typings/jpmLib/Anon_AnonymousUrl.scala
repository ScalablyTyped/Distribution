...
trait Anon_AnonymousUrl[ResponseType] extends js.Object {
  ...
  var onComplete: js.UndefOr[js.Function1[/* response */ jpmLib.requestMod.STResponse[ResponseType], _]] = js.undefined
