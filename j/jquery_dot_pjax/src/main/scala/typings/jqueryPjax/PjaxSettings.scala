...
object PjaxSettings {
  ...
  def apply(
    ...
    maxCacheLength: js.UndefOr[Double] = js.undefined,
    method: String = null,
    ...
    if (!js.isUndefined(maxCacheLength)) __obj.updateDynamic("maxCacheLength")(maxCacheLength.get.asInstanceOf[js.Any])
