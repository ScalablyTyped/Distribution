...
import typings.joi.anon.Array
import typings.joi.joiBooleans.`false`
import typings.joi.joiStrings.key
...
object ErrorFormattingOptions {
  ...
  extension [Self <: ErrorFormattingOptions](x: Self) {
    ...
    inline def setLanguage(value: /* keyof joi.joi.LanguageMessages */ String): Self = StObject.set(x, "language", value.asInstanceOf[js.Any])
