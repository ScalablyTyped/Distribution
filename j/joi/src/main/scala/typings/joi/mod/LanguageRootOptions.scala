...
/* Inlined {  root :string | undefined,   key :string | undefined,   messages :{  wrapArrays :boolean | undefined} | undefined, [key: string] : joi.joi.LanguageOptions} & std.Partial<std.Record<joi.joi.Types, joi.joi.LanguageOptions>> */
@js.native
