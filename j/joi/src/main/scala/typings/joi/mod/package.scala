...
type ExtensionBoundSchema = typings.joi.mod.Schema & typings.joi.mod.SchemaInternals
...
{[ key in keyof TSchema ]:? joi.joi.SchemaLike | std.Array<joi.joi.SchemaLike>}
  */ typings.joi.joiStrings.SchemaMap & org.scalablytyped.runtime.TopLevel[js.Any]
