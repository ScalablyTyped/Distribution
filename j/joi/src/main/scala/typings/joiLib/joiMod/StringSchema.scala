...
trait StringSchema extends AnySchema {
  ...
  @JSName("normalize")
  def normalize_NFC(form: joiLib.joiLibStrings.NFC): this.type = js.native
  @JSName("normalize")
  def normalize_NFD(form: joiLib.joiLibStrings.NFD): this.type = js.native
  @JSName("normalize")
  def normalize_NFKC(form: joiLib.joiLibStrings.NFKC): this.type = js.native
  @JSName("normalize")
  def normalize_NFKD(form: joiLib.joiLibStrings.NFKD): this.type = js.native
  /**
