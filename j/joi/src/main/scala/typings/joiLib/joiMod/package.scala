...
package object joiMod {
  ...
  type LanguageRootOptions = joiLib.Anon_Root with (stdLib.Partial[stdLib.Record[Types, LanguageOptions]]) with ScalablyTyped.runtime.StringDictionary[LanguageOptions]
