...
trait Root extends js.Object {
  ...
  def defaults(fn: DefaultsFunction): /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt $anonfun#applyOrElse Simplified recursive type alias joi.joi.Root */ js.Object = js.native
