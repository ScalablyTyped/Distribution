...
trait ObjectSchema extends AnySchema {
  ...
  def forbiddenKeys(children: java.lang.String*): this.type = js.native
  /**
    ...
    */
  def forbiddenKeys(children: js.Array[java.lang.String]): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def pattern(pattern: stdLib.RegExp, schema: SchemaLike): this.type = js.native
  /**
  ...
  def `type`(constructor: js.Function, name: java.lang.String): this.type = js.native
  /**
