...
import typings.jupyterlabRendermime.libMimemodelMod.MimeModel
import typings.jupyterlabRendermime.libMimemodelMod.MimeModel.IOptions
import typings.jupyterlabRendermime.libTokensMod.IRenderMimeRegistry.ICloneOptions
...
object libTokensMod {
  ...
  trait IRenderMimeRegistry extends StObject {
    ...
    def preferredMimeType(bundle: ReadonlyPartialJSONObject, safe: ensure | prefer | any): js.UndefOr[String] = js.native
