...
import typings.atJupyterlabRendermime.libTokensMod.IRenderMimeRegistry.ICloneOptions
...
@JSName("IRenderMimeRegistry")
@js.native
trait IRenderMimeRegistry_ extends js.Object {
  /**
    * The LaTeX typesetter for the rendermime.
    */
  val latexTypesetter: typings.atJupyterlabRendermimeDashInterfaces.atJupyterlabRendermimeDashInterfacesMod.IRenderMime.ILatexTypesetter | Null = js.native
  /**
