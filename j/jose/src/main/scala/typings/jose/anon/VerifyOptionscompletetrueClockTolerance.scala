...
@js.native
trait VerifyOptionscompletetrueClockTolerance extends js.Object {
...
object VerifyOptionscompletetrueClockTolerance {
  ...
  @scala.inline
  implicit class VerifyOptionscompletetrueClockToleranceOps[Self <: VerifyOptionscompletetrueClockTolerance] (val x: Self) extends AnyVal {
