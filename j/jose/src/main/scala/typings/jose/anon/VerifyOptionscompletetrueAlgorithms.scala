...
@js.native
trait VerifyOptionscompletetrueAlgorithms extends js.Object {
...
object VerifyOptionscompletetrueAlgorithms {
  ...
  @scala.inline
  implicit class VerifyOptionscompletetrueAlgorithmsOps[Self <: VerifyOptionscompletetrueAlgorithms] (val x: Self) extends AnyVal {
