...
object JWKECKey {
  ...
  inline def apply(crv: ECCurve, x: String, y: String): JWKECKey = {
  ...
  extension [Self <: JWKECKey](x: Self) {
    
    inline def setCrv(value: ECCurve): Self = StObject.set(x, "crv", value.asInstanceOf[js.Any])
