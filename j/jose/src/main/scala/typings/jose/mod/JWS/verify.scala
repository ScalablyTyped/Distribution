...
object verify extends js.Object {
  def apply(jws: String, key: ConsumeKeyInput | EmbeddedVerifyKeys): completeVerification[String | js.Object, Key] = js.native
  def apply(jws: String, key: ConsumeKeyInput | EmbeddedVerifyKeys, options: VerifyOptions[`true`, `false`]): completeVerification[Buffer, Key] = js.native
  ...
  def apply(jws: FlattenedJWS, key: ConsumeKeyInput | EmbeddedVerifyKeys): completeVerification[String | js.Object, Key] = js.native
  def apply(
    jws: FlattenedJWS,
    key: ConsumeKeyInput | EmbeddedVerifyKeys,
    options: VerifyOptions[`true`, `false`]
  ): completeVerification[Buffer, Key] = js.native
  ...
  def apply(jws: GeneralJWS, key: ConsumeKeyInput | EmbeddedVerifyKeys): completeVerification[String | js.Object, Key] = js.native
  def apply(
    jws: GeneralJWS,
    key: ConsumeKeyInput | EmbeddedVerifyKeys,
    options: VerifyOptions[`true`, `false`]
