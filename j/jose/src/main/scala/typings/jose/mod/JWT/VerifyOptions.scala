...
object VerifyOptions {
  ...
  def apply[komplet](
    ...
    if (!js.isUndefined(ignoreExp)) __obj.updateDynamic("ignoreExp")(ignoreExp.get.asInstanceOf[js.Any])
    if (!js.isUndefined(ignoreIat)) __obj.updateDynamic("ignoreIat")(ignoreIat.get.asInstanceOf[js.Any])
    if (!js.isUndefined(ignoreNbf)) __obj.updateDynamic("ignoreNbf")(ignoreNbf.get.asInstanceOf[js.Any])
