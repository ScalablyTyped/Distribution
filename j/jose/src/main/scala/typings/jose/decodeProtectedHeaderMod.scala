...
object decodeProtectedHeaderMod {
  ...
  - typings.jose.typesMod.JoseHeaderParameters because Already inherited
  - typings.jose.typesMod.JWEHeaderParameters because var conflicts: alg, crit, cty, jku, jwk, kid, typ, x5c, x5t, x5u. Inlined enc, zip */ trait ProtectedHeaderParameters
    extends StObject
