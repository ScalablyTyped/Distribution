...
import typings.jsonSchemaMergeAllof.AnonIgnoreAdditionalProperties
...
object ^ extends js.Object {
  ...
  def apply(
    ...
    options: (Options_[JSONSchema4] with AnonIgnoreAdditionalProperties) | Options_[JSONSchema4]
  ): JSONSchema4 = js.native
  def apply(rootSchema: JSONSchema6): JSONSchema6 = js.native
  def apply(
    rootSchema: JSONSchema6,
    options: (Options_[JSONSchema6] with AnonIgnoreAdditionalProperties) | Options_[JSONSchema6]
  ): JSONSchema6 = js.native
  def apply(rootSchema: JSONSchema7): JSONSchema7 = js.native
  def apply(
    rootSchema: JSONSchema7,
    options: (Options_[JSONSchema7] with AnonIgnoreAdditionalProperties) | Options_[JSONSchema7]
