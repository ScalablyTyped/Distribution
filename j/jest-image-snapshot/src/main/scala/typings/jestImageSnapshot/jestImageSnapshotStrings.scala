...
object jestImageSnapshotStrings {
  ...
  @scala.inline
  def bezkrovny: bezkrovny = "bezkrovny".asInstanceOf[bezkrovny]
  ...
  @scala.inline
  def pixelmatch: pixelmatch = "pixelmatch".asInstanceOf[pixelmatch]
  ...
  @scala.inline
  def weber: weber = "weber".asInstanceOf[weber]
}
