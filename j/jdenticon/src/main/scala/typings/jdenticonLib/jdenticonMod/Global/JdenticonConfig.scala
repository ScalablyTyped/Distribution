...
trait JdenticonConfig extends js.Object {
  ...
  /**
    ...
    */
  var hues: js.UndefOr[js.Array[scala.Double]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var replaceMode: js.UndefOr[
    jdenticonLib.jdenticonLibStrings.never | jdenticonLib.jdenticonLibStrings.once | jdenticonLib.jdenticonLibStrings.observe
  ] = js.undefined
  /**
    ...
    */
  var saturation: js.UndefOr[jdenticonLib.Anon_ColorGrayscale | scala.Double] = js.undefined
}
...
object JdenticonConfig {
  ...
  def apply(
    ...
    hues: js.Array[scala.Double] = null,
    lightness: jdenticonLib.Anon_Color = null,
    padding: scala.Int | scala.Double = null,
    replaceMode: jdenticonLib.jdenticonLibStrings.never | jdenticonLib.jdenticonLibStrings.once | jdenticonLib.jdenticonLibStrings.observe = null,
    saturation: jdenticonLib.Anon_ColorGrayscale | scala.Double = null
  ): JdenticonConfig = {
