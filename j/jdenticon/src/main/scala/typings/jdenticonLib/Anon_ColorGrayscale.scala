...
trait Anon_ColorGrayscale extends js.Object {
  ...
  /**
    ...
    * number in the range [0.0, 1.0].
    */
  var grayscale: js.UndefOr[scala.Double] = js.undefined
}

object Anon_ColorGrayscale {
  @scala.inline
  def apply(color: scala.Int | scala.Double = null, grayscale: scala.Int | scala.Double = null): Anon_ColorGrayscale = {
