...
trait JQueryDeparam extends js.Object {
  ...
  def fragment(url: java.lang.String): js.Any = js.native
  def fragment(url: java.lang.String, coerce: scala.Boolean): js.Any = js.native
  /**
  ...
  def querystring(url: java.lang.String): js.Any = js.native
  def querystring(url: java.lang.String, coerce: scala.Boolean): js.Any = js.native
}
