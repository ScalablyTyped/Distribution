...
import typings.jqueryDotBbq.jqueryDotBbqMod.Global.JQueryBbqNs.JQueryDeparam
...
trait JQueryStatic extends js.Object {
  var bbq: typings.jqueryDotBbq.jqueryDotBbqMod.Global.JQueryBbqNs.JQuery = js.native
  @JSName("deparam")
