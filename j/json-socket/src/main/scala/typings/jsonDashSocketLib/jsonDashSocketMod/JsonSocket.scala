...
trait JsonSocket
  ...
  /**
    ...
    * @param callback
    */
  def sendEndError(err: stdLib.Error, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  def sendEndMessage(message: js.Any, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
    * Convenience method for sending an error as a message.
    * @param err an Error object that should be formatted as a message
    * @param callback will be called after the message has been sent
    */
  def sendError(err: stdLib.Error, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  /**
    * Sends a JSON message over the socket.
    * @param message the message to send
    * @param callback will be called after the message has been sent
    */
  def sendMessage(message: js.Any, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
}
