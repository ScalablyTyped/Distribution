...
trait Typeofutils extends js.Object {
  val SNAPSHOT_GUIDE_LINK: /* "https://goo.gl/fbAQLP" */ String
  val SNAPSHOT_VERSION: /* "1" */ String
  ...
  def getSnapshotData(snapshotPath: String, update: SnapshotUpdateState): Data
