...
trait AnonActualExpectedMessage extends js.Object {
...
object AnonActualExpectedMessage {
  @scala.inline
  def apply(
    message: () => String,
    pass: Boolean,
    ...
    __obj.asInstanceOf[AnonActualExpectedMessage]
  }
}
