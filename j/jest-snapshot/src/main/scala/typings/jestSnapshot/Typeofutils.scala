...
import typings.jestSnapshot.jestSnapshotStrings.`1`
import typings.jestSnapshot.jestSnapshotStrings.httpsColonSlashSlashgooDotglSlashfbAQLP
...
object Typeofutils {
  ...
  def apply(
    ...
    getSnapshotData: (String, SnapshotUpdateState) => AnonData,
