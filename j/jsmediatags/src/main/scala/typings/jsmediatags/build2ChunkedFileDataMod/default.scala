package typings.jsmediatags.build2ChunkedFileDataMod

import typings.jsmediatags.Anon_EndIx
...
class default () extends ChunkedFileData {
  ...
  /* CompleteClass */
  override def _getChunkRange(offsetStart: Double, offsetEnd: Double): Anon_EndIx = js.native
  /* CompleteClass */
