...
object mod {
  ...
  inline def stringify(`object`: js.Array[Node], replacer: js.Function1[/* node */ Cheerio, js.Any]): String = (^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(`object`.asInstanceOf[js.Any], replacer.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def stringify(`object`: js.Array[Node], replacer: js.Function1[/* node */ Cheerio, js.Any], indent: Double): String = (^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(`object`.asInstanceOf[js.Any], replacer.asInstanceOf[js.Any], indent.asInstanceOf[js.Any])).asInstanceOf[String]
