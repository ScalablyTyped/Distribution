...
trait JQueryGenericPromise[T] extends js.Object {
  /**
       ...
       */
  def `then`(doneFilter: js.Function2[/* value */ js.UndefOr[T], /* repeated */js.Any, scala.Unit]): JQueryPromise[scala.Unit] = js.native
  /**
       * Add handlers to be called when the Deferred object is resolved, rejected, or still in progress.
       * 
       * @param doneFilter A function that is called when the Deferred is resolved.
       ...
       */
  def `then`(
    doneFilter: js.Function2[/* value */ js.UndefOr[T], /* repeated */js.Any, scala.Unit],
    failFilter: js.Function1[/* repeated */js.Any, _]
  ): JQueryPromise[scala.Unit] = js.native
  /**
       * Add handlers to be called when the Deferred object is resolved, rejected, or still in progress.
       * 
       * @param doneFilter A function that is called when the Deferred is resolved.
