...
trait JQueryAnimationOptions extends StObject {
  ...
  var always: js.UndefOr[
    js.Function2[/* animation */ JQueryPromise[js.Any], /* jumpedToEnd */ Boolean, js.Any]
  ] = js.undefined
  ...
  var progress: js.UndefOr[
    js.Function3[
      /* animation */ JQueryPromise[js.Any], 
      /* progress */ Double, 
      /* remainingMs */ Double, 
      js.Any
    ]
  ...
  /**
    ...
    */
  var start: js.UndefOr[js.Function1[/* animation */ JQueryPromise[js.Any], js.Any]] = js.undefined
  
  /**
    * A function to be called for each animated property of each animated element. This function provides an opportunity to modify the Tween object to change the value of the property before it is set.
    */
  var step: js.UndefOr[js.Function2[/* now */ Double, /* tween */ js.Any, js.Any]] = js.undefined
}
