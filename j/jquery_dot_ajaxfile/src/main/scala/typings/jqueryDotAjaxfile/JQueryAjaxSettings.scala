...
object JQueryAjaxSettings {
  ...
  def apply(
    ...
    complete: (/* jqXHR */ JQueryXHR, /* textStatus */ String) => _ = null,
    ...
    error: (/* jqXHR */ JQueryXHR, /* textStatus */ String, /* errorThrown */ String) => _ = null,
    ...
    success: (/* data */ js.Any, /* textStatus */ String, /* jqXHR */ JQueryXHR) => _ = null,
