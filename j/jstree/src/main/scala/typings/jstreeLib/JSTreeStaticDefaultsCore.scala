...
trait JSTreeStaticDefaultsCore extends js.Object {
  ...
  /**
    ...
    */
  var dblclick_toggle: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * if left as `true` all parents of all selected nodes will be opened once the tree loads (so that all selected nodes are visible to the user)
    * @name $.jstree.defaults.core.expand_selected_onload
    */
  var expand_selected_onload: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * Force node text to plain text (and escape HTML). Defaults to `false`
    * @name $.jstree.defaults.core.force_text
    */
  var force_text: js.UndefOr[scala.Boolean] = js.undefined
  /**
