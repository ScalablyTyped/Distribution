...
trait CreateElement extends js.Object {
  /**
    ...
    */
  def apply[P](component: reactLib.reactMod.ReactNs.ComponentClass[P, reactLib.reactMod.ReactNs.ComponentState]): reactLib.reactMod.ReactNs.ReactElement = js.native
  /**
