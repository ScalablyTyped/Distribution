...
class ContentsManager ()
  extends atJupyterlabServicesLib.libContentsMod.ContentsNs.IManager {
  def this(options: atJupyterlabServicesLib.libContentsMod.ContentsManagerNs.IOptions) = this()
  ...
  /**
    ...
    */
  @JSName("fileChanged")
  val fileChanged_ContentsManager: atPhosphorSignalingLib.atPhosphorSignalingMod.ISignal[this.type, atJupyterlabServicesLib.libContentsMod.ContentsNs.IChangedArgs] = js.native
  /**
