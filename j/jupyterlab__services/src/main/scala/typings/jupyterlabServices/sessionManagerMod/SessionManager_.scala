...
import typings.jupyterlabServices.sessionSessionMod.Session.IManager
...
class SessionManager_ () extends IManager {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def startNew(options: typings.jupyterlabServices.sessionSessionMod.Session.IOptions): js.Promise[ISession] = js.native
  /**
