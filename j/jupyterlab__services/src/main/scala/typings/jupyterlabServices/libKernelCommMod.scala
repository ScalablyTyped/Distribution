...
import typings.jupyterlabServices.libKernelKernelMod.IComm
...
import typings.jupyterlabServices.libKernelMessagesMod.ICommCloseMsg
import typings.jupyterlabServices.libKernelMessagesMod.ICommMsgMsg
