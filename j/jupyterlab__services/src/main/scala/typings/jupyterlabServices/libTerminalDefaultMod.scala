...
import typings.jupyterlabServices.libTerminalTerminalMod.IMessage
import typings.jupyterlabServices.libTerminalTerminalMod.ITerminalConnection
import typings.jupyterlabServices.libTerminalTerminalMod.ITerminalConnection.IOptions
