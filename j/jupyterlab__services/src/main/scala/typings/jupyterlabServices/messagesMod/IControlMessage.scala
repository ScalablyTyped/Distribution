...
object IControlMessage {
  ...
  @scala.inline
  implicit class IControlMessageOps[Self <: IControlMessage[_], T /* <: ControlMessageType */] (val x: Self with IControlMessage[T]) extends AnyVal {
    ...
    @scala.inline
    def setChannel(value: control): Self = this.set("channel", value.asInstanceOf[js.Any])
  }
}
