...
object Status {
  ...
  @scala.inline
  def terminating: typings.jupyterlabServices.jupyterlabServicesStrings.terminating = "terminating".asInstanceOf[typings.jupyterlabServices.jupyterlabServicesStrings.terminating]
