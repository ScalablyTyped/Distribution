...
import typings.jupyterlabServices.messagesMod.KernelMessage.IHistoryRequestRange
import typings.jupyterlabServices.messagesMod.KernelMessage.IHistoryRequestSearch
import typings.jupyterlabServices.messagesMod.KernelMessage.IHistoryRequestTail
import typings.jupyterlabServices.messagesMod.KernelMessage.IIOPubMessage
import typings.jupyterlabServices.messagesMod.KernelMessage.IInfoReply
...
trait IKernelConnection extends IDisposable {
  ...
  /**
    ...
    * received and validated.
    */
  def requestInspect(content: Anon0): js.Promise[IInspectReplyMsg] = js.native
  /**
