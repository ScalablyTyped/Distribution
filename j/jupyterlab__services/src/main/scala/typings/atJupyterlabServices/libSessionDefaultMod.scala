...
object libSessionDefaultMod extends js.Object {
  ...
  class DefaultSession protected () extends ISession {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val model: typings.atJupyterlabServices.libSessionSessionMod.Session.IModel = js.native
    /**
    ...
    /**
      ...
      */
    def update(model: typings.atJupyterlabServices.libSessionSessionMod.Session.IModel): Unit = js.native
  }
  ...
  object DefaultSession extends js.Object {
    /**
      ...
      */
    def connectTo(model: typings.atJupyterlabServices.libSessionSessionMod.Session.IModel): ISession = js.native
    def connectTo(model: typings.atJupyterlabServices.libSessionSessionMod.Session.IModel, settings: ISettings): ISession = js.native
    /**
      * Find a session by id.
      */
    def findById(id: String): js.Promise[typings.atJupyterlabServices.libSessionSessionMod.Session.IModel] = js.native
    def findById(id: String, settings: ISettings): js.Promise[typings.atJupyterlabServices.libSessionSessionMod.Session.IModel] = js.native
    /**
      * Find a session by path.
      */
    def findByPath(path: String): js.Promise[typings.atJupyterlabServices.libSessionSessionMod.Session.IModel] = js.native
    def findByPath(path: String, settings: ISettings): js.Promise[typings.atJupyterlabServices.libSessionSessionMod.Session.IModel] = js.native
    /**
      * List the running sessions.
      */
    def listRunning(): js.Promise[js.Array[typings.atJupyterlabServices.libSessionSessionMod.Session.IModel]] = js.native
    def listRunning(settings: ISettings): js.Promise[js.Array[typings.atJupyterlabServices.libSessionSessionMod.Session.IModel]] = js.native
    /**
