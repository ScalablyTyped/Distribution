package typings.atJupyterlabServices.libTerminalManagerMod

import typings.atJupyterlabServices.libTerminalManagerMod.TerminalManager.IOptions
import typings.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.IManager
...
class TerminalManager_ () extends IManager {
  ...
  def connectTo(
    name: String,
    options: typings.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.IOptions
