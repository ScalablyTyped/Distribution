...
/**
  ...
  */
class TerminalManager () extends IManager {
  ...
  val connectionFailure_TerminalManager: ISignal[this.type, Error] = js.native
  /**
  ...
  val runningChanged_TerminalManager: ISignal[this.type, js.Array[IModel]] = js.native
  def connectTo(
    name: String,
    options: typings.atJupyterlabServices.libTerminalTerminalMod.TerminalSessionNs.IOptions
