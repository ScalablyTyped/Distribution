...
object libTerminalMod extends js.Object {
  ...
  class TerminalManager ()
    extends typings.atJupyterlabServices.libTerminalManagerMod.TerminalManager {
  ...
  object TerminalSession extends js.Object {
    ...
    def startNew(options: typings.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.IOptions): js.Promise[ISession] = js.native
  }
