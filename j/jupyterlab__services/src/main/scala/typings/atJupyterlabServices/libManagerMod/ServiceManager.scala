...
import typings.atJupyterlabServices.libManagerMod.ServiceManagerNs.IOptions
...
class ServiceManager () extends IManager {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val builder: typings.atJupyterlabServices.libBuilderMod.BuilderNs.IManager = js.native
  /**
    * The builder for the manager.
    */
  @JSName("builder")
  ...
  val connectionFailure_ServiceManager: ISignal[this.type, Error] = js.native
  /**
    * The contents manager for the manager.
    */
  /* CompleteClass */
  override val contents: typings.atJupyterlabServices.libContentsMod.ContentsNs.IManager = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val nbconvert: typings.atJupyterlabServices.libNbconvertMod.NbConvertNs.IManager = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val sessions: typings.atJupyterlabServices.libSessionSessionMod.SessionNs.IManager = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val settings: typings.atJupyterlabServices.libSettingMod.SettingNs.IManager = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("specsChanged")
  val specsChanged_ServiceManager: ISignal[this.type, ISpecModels] = js.native
  /**
    * The terminals manager for the manager.
    */
  /* CompleteClass */
  override val terminals: typings.atJupyterlabServices.libTerminalTerminalMod.TerminalSessionNs.IManager = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val workspaces: typings.atJupyterlabServices.libWorkspaceMod.WorkspaceNs.IManager = js.native
  /**
