...
object ServerConnection extends js.Object {
  ...
  class NetworkError protected ()
    extends typings.atJupyterlabServices.libServerconnectionMod.ServerConnection.NetworkError {
    /**
  ...
  class ResponseError protected ()
    extends typings.atJupyterlabServices.libServerconnectionMod.ServerConnection.ResponseError {
    /**
