...
object ServerConnectionNs extends js.Object {
  ...
  class NetworkError protected ()
    extends typings.atJupyterlabServices.libServerconnectionMod.ServerConnectionNs.NetworkError {
    /**
  ...
  class ResponseError protected ()
    extends typings.atJupyterlabServices.libServerconnectionMod.ServerConnectionNs.ResponseError {
    /**
