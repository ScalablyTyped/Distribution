...
/**
  ...
  */
class SessionManager () extends IManager {
  ...
  val connectionFailure_SessionManager: ISignal[this.type, Error] = js.native
  /**
  ...
  val serverSettings_SessionManager: ISettings = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def startNew(options: typings.atJupyterlabServices.libSessionSessionMod.SessionNs.IOptions): js.Promise[ISession] = js.native
  /**
