package typings.atJupyterlabDocumentsearch.libSearchoverlayMod.createSearchOverlay

import typings.atJupyterlabDocumentsearch.libInterfacesMod.IDisplayState
import typings.atJupyterlabDocumentsearch.libSearchinstanceMod.SearchInstance
