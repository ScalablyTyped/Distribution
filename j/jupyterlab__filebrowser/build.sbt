...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__docmanager" % "1.2.1-edd4bb",
  ...
  "org.scalablytyped" %%% "jupyterlab__ui-components" % "1.2.1-749265",
  ...
  "org.scalablytyped" %%% "typestyle" % "2.0.4-932afb")
