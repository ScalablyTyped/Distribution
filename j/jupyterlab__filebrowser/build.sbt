...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__docmanager" % "1.1.3-28a2c6",
  ...
  "org.scalablytyped" %%% "jupyterlab__ui-components" % "1.1.2-4837fa",
  ...
  "org.scalablytyped" %%% "typestyle" % "2.0.4-93529a")
