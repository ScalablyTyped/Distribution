...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__docmanager" % "1.2.1-90f273",
  ...
  "org.scalablytyped" %%% "jupyterlab__ui-components" % "1.2.1-ca00d1",
  ...
  "org.scalablytyped" %%% "typestyle" % "2.0.4-94faef")
