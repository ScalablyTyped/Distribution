package typings.atJupyterlabFilebrowser.libModelMod.FilterFileBrowserModelNs
...
/**
  ...
  */
trait IOptions
  extends typings.atJupyterlabFilebrowser.libModelMod.FileBrowserModelNs.IOptions {
  /**
