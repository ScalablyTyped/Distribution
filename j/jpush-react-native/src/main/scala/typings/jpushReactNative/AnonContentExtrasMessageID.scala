...
trait AnonContentExtrasMessageID extends js.Object {
  /**
...
object AnonContentExtrasMessageID {
  @scala.inline
  def apply(content: String, extras: Extra, messageID: String): AnonContentExtrasMessageID = {
    ...
    __obj.asInstanceOf[AnonContentExtrasMessageID]
  }
}
