...
object TagtagEnableboolean {
  ...
  @scala.inline
  implicit class TagtagEnablebooleanOps[Self <: TagtagEnableboolean] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTagEnable(value: Boolean): Self = this.set("tagEnable", value.asInstanceOf[js.Any])
  }
}
