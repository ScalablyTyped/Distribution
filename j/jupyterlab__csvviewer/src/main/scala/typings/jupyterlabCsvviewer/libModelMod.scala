...
import typings.jupyterlabCsvviewer.libModelMod.DSVModel.IOptions
...
object libModelMod {
  ...
  open class DSVModel protected ()
    ...
    /**
      ...
      */
    /* private */ var _columnOffsets: Any = js.native
    
    /**
      * The row that _columnOffsets[0] represents.
      */
    /* private */ var _columnOffsetsStartingRow: Any = js.native
    ...
    /**
      ...
      * parsed again.
      */
    /* private */ var _computeRowOffsets: Any = js.native
    
    /* private */ var _delayedParse: Any = js.native
    
    /* private */ var _delimiter: Any = js.native
    
    /* private */ var _doneParsing: Any = js.native
    ...
    /**
      ...
      */
    /* private */ var _getField: Any = js.native
    ...
    /**
      ...
      * entire data.
      */
    /* private */ var _initialRows: Any = js.native
    ...
    /**
      ...
      */
    /* private */ var _maxCacheGet: Any = js.native
    
    /* private */ var _parser: Any = js.native
    
    /* private */ var _quote: Any = js.native
    
    /* private */ var _quoteEscaped: Any = js.native
    ...
    /**
      ...
      */
    /* private */ var _resetParser: Any = js.native
    
    /* private */ var _rowCount: Any = js.native
    
    /* private */ var _rowDelimiter: Any = js.native
    
    /**
      * The index for the start of each row.
      */
    /* private */ var _rowOffsets: Any = js.native
    
    /* private */ var _startedParsing: Any = js.native
    ...
    /**
      ...
      */
    def doneParsing: Boolean = js.native
    ...
    /**
      ...
      */
    def getOffsetIndex(row: Double, column: Double): Double = js.native
    
    /**
      * The header strings.
      */
    def header: js.Array[String] = js.native
    def header_=(value: js.Array[String]): Unit = js.native
    
    /**
      * The initial chunk of rows to parse.
      */
    def initialRows: Double = js.native
    def initialRows_=(value: Double): Unit = js.native
    ...
    /**
      ...
      */
    def parseAsync(): Unit = js.native
    
    /**
      * The string representation of the data.
      */
    def rawData: String = js.native
    def rawData_=(value: String): Unit = js.native
    ...
    /**
      ...
      */
    def rowDelimiter: String = js.native
  }
  object DSVModel {
