...
object widgetMod {
  ...
  object CollapsibleSection {
    ...
    object IProperties {
      ...
      implicit class IPropertiesMutableBuilder[Self <: IProperties] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setHeaderElements(value: ReactNode): Self = StObject.set(x, "headerElements", value.asInstanceOf[js.Any])
  ...
  object ListView {
    ...
    object IProperties {
      ...
      @scala.inline
      implicit class IPropertiesMutableBuilder[Self <: typings.jupyterlabExtensionmanager.widgetMod.ListView.IProperties] (val x: Self) extends AnyVal {
  ...
  object SearchBar {
    ...
    object IProperties {
      ...
      @scala.inline
      def apply(disabled: Boolean, placeholder: String, settings: ISettings): typings.jupyterlabExtensionmanager.widgetMod.SearchBar.IProperties = {
      ...
      @scala.inline
      implicit class IPropertiesMutableBuilder[Self <: typings.jupyterlabExtensionmanager.widgetMod.SearchBar.IProperties] (val x: Self) extends AnyVal {
    ...
    object IState {
      ...
      @scala.inline
      def apply(value: String): typings.jupyterlabExtensionmanager.widgetMod.SearchBar.IState = {
        val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.jupyterlabExtensionmanager.widgetMod.SearchBar.IState]
      }
      
      @scala.inline
      implicit class IStateMutableBuilder[Self <: typings.jupyterlabExtensionmanager.widgetMod.SearchBar.IState] (val x: Self) extends AnyVal {
  ...
  object ListEntry {
    ...
    object IProperties {
      ...
      @scala.inline
      implicit class IPropertiesMutableBuilder[Self <: typings.jupyterlabExtensionmanager.widgetMod.ListEntry.IProperties] (val x: Self) extends AnyVal {
