...
import typings.jsonRpcEngine.distCreateAsyncMiddlewareMod.AsyncJsonrpcMiddleware
import typings.jsonRpcEngine.distCreateScaffoldMiddlewareMod.ScaffoldMiddlewareHandler
...
object distMod {
  ...
  open class JsonRpcEngine ()
    extends typings.jsonRpcEngine.distJsonRpcEngineMod.JsonRpcEngine
  /* static members */
