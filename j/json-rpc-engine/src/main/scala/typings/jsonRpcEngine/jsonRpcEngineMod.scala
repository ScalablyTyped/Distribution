...
object jsonRpcEngineMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.jsonRpcEngine.jsonRpcEngineMod.JsonRpcSuccess[T]
    - typings.jsonRpcEngine.jsonRpcEngineMod.JsonRpcFailure
  */
  trait JsonRpcResponse[T] extends StObject
  object JsonRpcResponse {
    
    inline def JsonRpcFailure(error: JsonRpcError, id: JsonRpcId, jsonrpc: JsonRpcVersion): typings.jsonRpcEngine.jsonRpcEngineMod.JsonRpcFailure = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], jsonrpc = jsonrpc.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.jsonRpcEngine.jsonRpcEngineMod.JsonRpcFailure]
    }
    
    inline def JsonRpcSuccess[T](id: JsonRpcId, jsonrpc: JsonRpcVersion): typings.jsonRpcEngine.jsonRpcEngineMod.JsonRpcSuccess[T] = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], jsonrpc = jsonrpc.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.jsonRpcEngine.jsonRpcEngineMod.JsonRpcSuccess[T]]
    }
  }
