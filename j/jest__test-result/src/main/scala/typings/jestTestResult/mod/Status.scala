...
object Status {
  ...
  inline def pending: typings.jestTestResult.jestTestResultStrings.pending = "pending".asInstanceOf[typings.jestTestResult.jestTestResultStrings.pending]
  
  inline def skipped: typings.jestTestResult.jestTestResultStrings.skipped = "skipped".asInstanceOf[typings.jestTestResult.jestTestResultStrings.skipped]
  
  inline def todo: typings.jestTestResult.jestTestResultStrings.todo = "todo".asInstanceOf[typings.jestTestResult.jestTestResultStrings.todo]
}
