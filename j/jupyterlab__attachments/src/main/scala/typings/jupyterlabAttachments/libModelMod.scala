...
import typings.jupyterlabAttachments.libModelMod.IAttachmentsModel.ChangedArgs
import typings.jupyterlabAttachments.libModelMod.IAttachmentsModel.IContentFactory
...
import typings.jupyterlabRendermime.libAttachmentmodelMod.IAttachmentModel
...
object libModelMod {
  ...
  object AttachmentsModel {
    ...
    open class ContentFactory ()
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def createAttachmentModel(options: typings.jupyterlabRendermime.libAttachmentmodelMod.IAttachmentModel.IOptions): IAttachmentModel = js.native
    }
  ...
  object AttachmentsResolver {
    ...
    object IOptions {
      ...
      inline def apply(model: IAttachmentsModel): typings.jupyterlabAttachments.libModelMod.AttachmentsResolver.IOptions = {
  ...
  object IAttachmentsModel {
    ...
    trait IContentFactory extends StObject {
      ...
      /**
        * Create an attachment model.
        */
      def createAttachmentModel(options: typings.jupyterlabRendermime.libAttachmentmodelMod.IAttachmentModel.IOptions): IAttachmentModel
    }
    object IContentFactory {
      
      inline def apply(
        createAttachmentModel: typings.jupyterlabRendermime.libAttachmentmodelMod.IAttachmentModel.IOptions => IAttachmentModel
      ): IContentFactory = {
