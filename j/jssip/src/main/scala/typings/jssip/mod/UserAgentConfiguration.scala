...
object UserAgentConfiguration {
  ...
  inline def apply(sockets: Socket | js.Array[Socket], uri: String): UserAgentConfiguration = {
  ...
  extension [Self <: UserAgentConfiguration](x: Self) {
    ...
    inline def setSockets(value: Socket | js.Array[Socket]): Self = StObject.set(x, "sockets", value.asInstanceOf[js.Any])
    
    inline def setSocketsVarargs(value: Socket*): Self = StObject.set(x, "sockets", js.Array(value :_*))
    
    inline def setUri(value: String): Self = StObject.set(x, "uri", value.asInstanceOf[js.Any])
    
    inline def setUse_reloaded_route(value: Boolean): Self = StObject.set(x, "use_reloaded_route", value.asInstanceOf[js.Any])
    
    inline def setUse_reloaded_routeUndefined: Self = StObject.set(x, "use_reloaded_route", js.undefined)
