...
import typings.jsreportDashChromeDashPdf.Anon_DeviceScaleFactor
import typings.jsreportDashChromeDashPdf.jsreportDashChromeDashPdfStrings.chrome
import typings.jsreportDashChromeDashPdf.jsreportDashChromeDashPdfStrings.firefox
...
trait LaunchOptions extends js.Object {
  ...
  var defaultViewport: Partial[Anon_DeviceScaleFactor]
...
object LaunchOptions {
  ...
  def apply(
    ...
    defaultViewport: Partial[Anon_DeviceScaleFactor],
    devtools: Boolean,
    dumpio: Boolean,
