...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-mock" % "29.3.1-a8eb32",
  "org.scalablytyped" %%% "jest-resolve" % "29.3.1-ab06a9",
  "org.scalablytyped" %%% "jest-snapshot" % "29.3.1-242e9b",
  "org.scalablytyped" %%% "jest__console" % "29.3.1-5fb157",
  "org.scalablytyped" %%% "jest__environment" % "29.3.1-bcef55",
  "org.scalablytyped" %%% "jest__expect" % "29.3.1-807304",
  "org.scalablytyped" %%% "jest__expect-utils" % "29.3.1-7d3f28",
  "org.scalablytyped" %%% "jest__fake-timers" % "29.3.1-e24c07",
  "org.scalablytyped" %%% "jest__schemas" % "29.0.0-db208b",
  "org.scalablytyped" %%% "jest__source-map" % "29.2.0-e3544e",
  "org.scalablytyped" %%% "jest__test-result" % "29.3.1-238f76",
  "org.scalablytyped" %%% "jest__transform" % "29.3.1-743d2e",
