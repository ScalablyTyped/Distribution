...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-mock" % "29.2.1-e1c938",
  "org.scalablytyped" %%% "jest-resolve" % "29.2.1-61b435",
  "org.scalablytyped" %%% "jest-snapshot" % "29.2.1-b9dc5c",
  "org.scalablytyped" %%% "jest__console" % "29.2.1-dfd50b",
  "org.scalablytyped" %%% "jest__environment" % "29.2.1-a76133",
  "org.scalablytyped" %%% "jest__expect" % "29.2.1-ca3e6e",
  "org.scalablytyped" %%% "jest__expect-utils" % "29.2.1-a19937",
  "org.scalablytyped" %%% "jest__fake-timers" % "29.2.1-3ef53f",
  ...
  "org.scalablytyped" %%% "jest__transform" % "29.2.1-e4a4cd",
