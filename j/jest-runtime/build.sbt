...
name := "jest-runtime"
version := "29.2.2-78a313"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "callsites" % "4.0.0-f99612",
  "org.scalablytyped" %%% "collect-v8-coverage" % "1.0.1-e4a47f",
  ...
  "org.scalablytyped" %%% "jest-resolve" % "29.2.2-cc8c14",
  "org.scalablytyped" %%% "jest-snapshot" % "29.2.2-504ef0",
  "org.scalablytyped" %%% "jest__console" % "29.2.1-5786cb",
  "org.scalablytyped" %%% "jest__environment" % "29.2.2-c4509a",
  "org.scalablytyped" %%% "jest__expect" % "29.2.2-e8f3e6",
  "org.scalablytyped" %%% "jest__expect-utils" % "29.2.2-7822b7",
  "org.scalablytyped" %%% "jest__fake-timers" % "29.2.2-231484",
  "org.scalablytyped" %%% "jest__schemas" % "29.0.0-db208b",
  "org.scalablytyped" %%% "jest__source-map" % "29.2.0-e3544e",
  "org.scalablytyped" %%% "jest__test-result" % "29.2.1-cd99fb",
  "org.scalablytyped" %%% "jest__transform" % "29.2.2-870a14",
