...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-resolve" % "29.3.0-156b4e",
  "org.scalablytyped" %%% "jest-snapshot" % "29.3.0-d16e39",
  "org.scalablytyped" %%% "jest__console" % "29.2.1-0db0e9",
  "org.scalablytyped" %%% "jest__environment" % "29.3.0-a1cd7d",
  "org.scalablytyped" %%% "jest__expect" % "29.3.0-09a1d0",
  ...
  "org.scalablytyped" %%% "jest__test-result" % "29.2.1-91b605",
  "org.scalablytyped" %%% "jest__transform" % "29.3.0-397ad3",
