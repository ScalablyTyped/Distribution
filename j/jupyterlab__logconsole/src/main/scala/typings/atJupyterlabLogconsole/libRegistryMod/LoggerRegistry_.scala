package typings.atJupyterlabLogconsole.libRegistryMod

import typings.atJupyterlabLogconsole.libRegistryMod.LoggerRegistry.IOptions
...
import typings.atJupyterlabLogconsole.libTokensMod.ILoggerRegistryChange
