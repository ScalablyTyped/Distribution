...
object anon {
  ...
  object Day {
    ...
    extension [Self <: Day](x: Self) {
      ...
      inline def setPrefixAgoUndefined: Self = StObject.set(x, "prefixAgo", js.undefined)
      ...
      inline def setSuffixAgoUndefined: Self = StObject.set(x, "suffixAgo", js.undefined)
      
      inline def setSuffixFromNow(value: String): Self = StObject.set(x, "suffixFromNow", value.asInstanceOf[js.Any])
      
      inline def setSuffixFromNowUndefined: Self = StObject.set(x, "suffixFromNow", js.undefined)
