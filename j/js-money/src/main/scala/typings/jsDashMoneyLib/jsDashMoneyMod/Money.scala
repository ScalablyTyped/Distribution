...
trait Money extends js.Object {
  ...
  def divide(divisor: scala.Double, rounder: jsDashMoneyLib.RoundFunction): Money = js.native
  ...
  def multiply(multiplier: scala.Double, rounder: jsDashMoneyLib.RoundFunction): Money = js.native
