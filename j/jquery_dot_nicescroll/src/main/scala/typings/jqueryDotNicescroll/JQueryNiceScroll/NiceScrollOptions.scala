package typings.jqueryDotNicescroll.JQueryNiceScroll

import typings.jqueryDotNicescroll.Anon_Bottom
import typings.jqueryDotNicescroll.Anon_Left
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.auto
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.bottom
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.cursor
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.hidden
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.inherit
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.initial
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.leave
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.left
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.overlay
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.right
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.scroll
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.top
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.unset
import typings.jqueryDotNicescroll.jqueryDotNicescrollStrings.visible
...
trait NiceScrollOptions extends js.Object {
  ...
  var railhoffset: js.UndefOr[Boolean | Anon_Left] = js.undefined
  var railoffset: js.UndefOr[Boolean | Anon_Left] = js.undefined
  var railpadding: js.UndefOr[Anon_Bottom] = js.undefined
...
object NiceScrollOptions {
  ...
  def apply(
    ...
    railhoffset: Boolean | Anon_Left = null,
    railoffset: Boolean | Anon_Left = null,
    railpadding: Anon_Bottom = null,
    ...
    if (!js.isUndefined(bouncescroll)) __obj.updateDynamic("bouncescroll")(bouncescroll)
    if (!js.isUndefined(boxzoom)) __obj.updateDynamic("boxzoom")(boxzoom)
    if (cursorborder != null) __obj.updateDynamic("cursorborder")(cursorborder)
    if (cursorborderradius != null) __obj.updateDynamic("cursorborderradius")(cursorborderradius)
    if (cursorcolor != null) __obj.updateDynamic("cursorcolor")(cursorcolor)
    if (!js.isUndefined(cursordragontouch)) __obj.updateDynamic("cursordragontouch")(cursordragontouch)
    ...
    if (cursorwidth != null) __obj.updateDynamic("cursorwidth")(cursorwidth)
    if (!js.isUndefined(dblclickzoom)) __obj.updateDynamic("dblclickzoom")(dblclickzoom)
    ...
    if (!js.isUndefined(disableoutline)) __obj.updateDynamic("disableoutline")(disableoutline)
    if (!js.isUndefined(emulatetouch)) __obj.updateDynamic("emulatetouch")(emulatetouch)
    if (!js.isUndefined(enablekeyboard)) __obj.updateDynamic("enablekeyboard")(enablekeyboard)
    if (!js.isUndefined(enablemouselockapi)) __obj.updateDynamic("enablemouselockapi")(enablemouselockapi)
    if (!js.isUndefined(enablemousewheel)) __obj.updateDynamic("enablemousewheel")(enablemousewheel)
    if (!js.isUndefined(enableobserver)) __obj.updateDynamic("enableobserver")(enableobserver)
    if (!js.isUndefined(enablescrollonselection)) __obj.updateDynamic("enablescrollonselection")(enablescrollonselection)
    if (!js.isUndefined(enabletranslate3d)) __obj.updateDynamic("enabletranslate3d")(enabletranslate3d)
    if (!js.isUndefined(gesturezoom)) __obj.updateDynamic("gesturezoom")(gesturezoom)
    if (!js.isUndefined(grabcursorenabled)) __obj.updateDynamic("grabcursorenabled")(grabcursorenabled)
    if (hidecursordelay != null) __obj.updateDynamic("hidecursordelay")(hidecursordelay.asInstanceOf[js.Any])
    if (!js.isUndefined(horizrailenabled)) __obj.updateDynamic("horizrailenabled")(horizrailenabled)
    if (!js.isUndefined(hwacceleration)) __obj.updateDynamic("hwacceleration")(hwacceleration)
    if (!js.isUndefined(iframeautoresize)) __obj.updateDynamic("iframeautoresize")(iframeautoresize)
    if (mousescrollstep != null) __obj.updateDynamic("mousescrollstep")(mousescrollstep.asInstanceOf[js.Any])
    if (!js.isUndefined(nativeparentscrolling)) __obj.updateDynamic("nativeparentscrolling")(nativeparentscrolling)
    ...
    if (!js.isUndefined(preservenativescrolling)) __obj.updateDynamic("preservenativescrolling")(preservenativescrolling)
    if (!js.isUndefined(preventmultitouchscrolling)) __obj.updateDynamic("preventmultitouchscrolling")(preventmultitouchscrolling)
    ...
    if (railpadding != null) __obj.updateDynamic("railpadding")(railpadding)
    ...
    if (scrollCLass != null) __obj.updateDynamic("scrollCLass")(scrollCLass)
    if (scrollbarid != null) __obj.updateDynamic("scrollbarid")(scrollbarid)
    if (scrollspeed != null) __obj.updateDynamic("scrollspeed")(scrollspeed.asInstanceOf[js.Any])
    if (!js.isUndefined(sensitiverail)) __obj.updateDynamic("sensitiverail")(sensitiverail)
    if (!js.isUndefined(smoothscroll)) __obj.updateDynamic("smoothscroll")(smoothscroll)
    if (!js.isUndefined(spacebarenabled)) __obj.updateDynamic("spacebarenabled")(spacebarenabled)
    if (!js.isUndefined(touchbehavior)) __obj.updateDynamic("touchbehavior")(touchbehavior)
