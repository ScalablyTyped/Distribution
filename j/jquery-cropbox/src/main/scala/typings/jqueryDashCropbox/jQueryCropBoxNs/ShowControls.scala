...
object ShowControls extends js.Object {
  ...
  /* 1 */ val always: typings.jqueryDashCropbox.jQueryCropBoxNs.ShowControls.always with Double = js.native
  /* 3 */ val auto: typings.jqueryDashCropbox.jQueryCropBoxNs.ShowControls.auto with Double = js.native
  /* 2 */ val hover: typings.jqueryDashCropbox.jQueryCropBoxNs.ShowControls.hover with Double = js.native
  /* 0 */ val never: typings.jqueryDashCropbox.jQueryCropBoxNs.ShowControls.never with Double = js.native
  @JSBracketAccess
