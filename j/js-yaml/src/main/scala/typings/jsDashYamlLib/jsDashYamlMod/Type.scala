...
class Type protected () extends js.Object {
  ...
  var predicate: java.lang.String | scala.Null = js.native
  var represent: (js.Function1[/* data */ js.Object, _]) | (ScalablyTyped.runtime.StringDictionary[js.Function1[/* data */ js.Object, _]]) | scala.Null = js.native
  var styleAliases: ScalablyTyped.runtime.StringDictionary[js.Any] = js.native
