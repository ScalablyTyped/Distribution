...
import typings.atJupyterlabApplication.libLayoutrestorerMod.LayoutRestorer.IOptions
...
class LayoutRestorer_ protected () extends ILayoutRestorer {
  ...
  override def restore(
    ...
    options: typings.atJupyterlabCoreutils.libInterfacesMod.IRestorable.IOptions[IObservableDisposable]
  ...
  override def restore[T /* <: Widget */](
    ...
    options: typings.atJupyterlabCoreutils.libInterfacesMod.IRestorer.IOptions[T]
