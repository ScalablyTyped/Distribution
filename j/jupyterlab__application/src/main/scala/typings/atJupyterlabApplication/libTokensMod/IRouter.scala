...
import typings.atJupyterlabApplication.libTokensMod.IRouterNs.INavOptions
import typings.atJupyterlabApplication.libTokensMod.IRouterNs.IRegisterOptions
