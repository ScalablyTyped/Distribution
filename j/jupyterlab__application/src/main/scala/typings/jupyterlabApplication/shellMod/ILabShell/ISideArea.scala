...
object ISideArea {
  ...
  def apply(collapsed: Boolean, currentWidget: Widget = null, widgets: js.Array[Widget] = null): ISideArea = {
    val __obj = js.Dynamic.literal(collapsed = collapsed.asInstanceOf[js.Any], currentWidget = currentWidget.asInstanceOf[js.Any], widgets = widgets.asInstanceOf[js.Any])
