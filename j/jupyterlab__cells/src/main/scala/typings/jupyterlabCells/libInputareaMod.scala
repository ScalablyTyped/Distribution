...
import typings.jupyterlabCells.libInputareaMod.InputArea.IContentFactory
import typings.jupyterlabCells.libInputareaMod.InputArea.IOptions
...
object libInputareaMod {
  
  @JSImport("@jupyterlab/cells/lib/inputarea", "InputArea")
  @js.native
  open class InputArea protected () extends Widget {
    /**
    ...
    /* private */ var _prompt: Any = js.native
    ...
    /**
      ...
      */
    def renderedInput: Widget = js.native
  ...
  object InputArea {
    ...
    object ContentFactory {
      ...
      object IOptions {
        ...
        inline def apply(): typings.jupyterlabCells.libInputareaMod.InputArea.ContentFactory.IOptions = {
  ...
  @js.native
  open class InputPrompt () extends IInputPrompt {
