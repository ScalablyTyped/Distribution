...
import typings.jupyterlabCells.libWidgetMod.Cell
...
object libCelldragutilsMod {
  ...
  object CellDragUtils {
    ...
    /**
      ...
      */
    inline def createCellDragImage(activeCell: Cell[ICellModel], selectedCells: js.Array[ICell]): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("createCellDragImage")(activeCell.asInstanceOf[js.Any], selectedCells.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
    ...
    /**
      ...
      */
    inline def detectTargetArea(cell: Cell[ICellModel], target: HTMLElement): ICellTargetArea = (^.asInstanceOf[js.Dynamic].applyDynamic("detectTargetArea")(cell.asInstanceOf[js.Any], target.asInstanceOf[js.Any])).asInstanceOf[ICellTargetArea]
