...
trait TopologicalSort extends StObject {
  ...
  /* private */ var postOrder: js.Any
}
object TopologicalSort {
  
  inline def apply(dfs: (DiGraph, Double) => Unit, marked: js.Any, order: () => js.Array[Double], postOrder: js.Any): TopologicalSort = {
  ...
  extension [Self <: TopologicalSort](x: Self) {
    ...
    inline def setPostOrder(value: js.Any): Self = StObject.set(x, "postOrder", value.asInstanceOf[js.Any])
  }
}
