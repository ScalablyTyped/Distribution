...
import typings.jasmineDashExpect.distToBeArrayOfBooleansMod.ToBeArrayOfBooleans
...
import typings.jasmineDashExpect.distToBeOddNumberMod.ToBeOddNumber
...
import typings.jasmineDashExpect.distToBeValidDateMod.ToBeValidDate
...
import typings.jasmineDashExpect.distToHaveArrayOfBooleansMod.ToHaveArrayOfBooleans
...
import typings.jasmineDashExpect.distToHaveIso8601Mod.ToHaveIso8601
...
@js.native
object distMatchersByNameMod extends js.Object {
  val toBeAfter: ToBeAfter = js.native
  val toBeArray: ToBeArray = js.native
  val toBeArrayOfBooleans: ToBeArrayOfBooleans = js.native
  val toBeArrayOfNumbers: ToBeArrayOfNumbers = js.native
  val toBeArrayOfObjects: ToBeArrayOfObjects = js.native
  val toBeArrayOfSize: ToBeArrayOfSize = js.native
  val toBeArrayOfStrings: ToBeArrayOfStrings = js.native
  val toBeBefore: ToBeBefore = js.native
  val toBeBoolean: ToBeBoolean = js.native
  val toBeDate: ToBeDate = js.native
  val toBeEmptyArray: ToBeEmptyArray = js.native
  val toBeEmptyObject: ToBeEmptyObject = js.native
  val toBeEmptyString: ToBeEmptyString = js.native
  val toBeEvenNumber: ToBeEvenNumber = js.native
  val toBeFalse: ToBeFalse = js.native
  val toBeFunction: ToBeFunction = js.native
  val toBeGreaterThanOrEqualTo: ToBeGreaterThanOrEqualTo = js.native
  val toBeHtmlString: ToBeHtmlString = js.native
  val toBeIso8601: ToBeIso8601 = js.native
  val toBeJsonString: ToBeJsonString = js.native
  val toBeLessThanOrEqualTo: ToBeLessThanOrEqualTo = js.native
  val toBeLongerThan: ToBeLongerThan = js.native
  val toBeNear: ToBeNear = js.native
  val toBeNonEmptyArray: ToBeNonEmptyArray = js.native
  val toBeNonEmptyObject: ToBeNonEmptyObject = js.native
  val toBeNonEmptyString: ToBeNonEmptyString = js.native
  val toBeNumber: ToBeNumber = js.native
  val toBeObject: ToBeObject = js.native
  val toBeOddNumber: ToBeOddNumber = js.native
  val toBeRegExp: ToBeRegExp = js.native
  val toBeSameLengthAs: ToBeSameLengthAs = js.native
  val toBeShorterThan: ToBeShorterThan = js.native
  val toBeString: ToBeString = js.native
  val toBeTrue: ToBeTrue = js.native
  ...
  val toEndWith: ToEndWith = js.native
  val toHaveArray: ToHaveArray = js.native
  val toHaveArrayOfBooleans: ToHaveArrayOfBooleans = js.native
  val toHaveArrayOfNumbers: ToHaveArrayOfNumbers = js.native
  val toHaveArrayOfObjects: ToHaveArrayOfObjects = js.native
  val toHaveArrayOfSize: ToHaveArrayOfSize = js.native
  val toHaveArrayOfStrings: ToHaveArrayOfStrings = js.native
  val toHaveBoolean: ToHaveBoolean = js.native
  val toHaveCalculable: ToHaveCalculable = js.native
  val toHaveDate: ToHaveDate = js.native
  val toHaveDateAfter: ToHaveDateAfter = js.native
  val toHaveDateBefore: ToHaveDateBefore = js.native
  val toHaveEmptyArray: ToHaveEmptyArray = js.native
  val toHaveEmptyObject: ToHaveEmptyObject = js.native
  val toHaveEmptyString: ToHaveEmptyString = js.native
  val toHaveEvenNumber: ToHaveEvenNumber = js.native
  val toHaveFalse: ToHaveFalse = js.native
  val toHaveHtmlString: ToHaveHtmlString = js.native
  val toHaveIso8601: ToHaveIso8601 = js.native
  val toHaveJsonString: ToHaveJsonString = js.native
  val toHaveMember: ToHaveMember = js.native
  val toHaveMethod: ToHaveMethod = js.native
  val toHaveNonEmptyArray: ToHaveNonEmptyArray = js.native
  val toHaveNonEmptyObject: ToHaveNonEmptyObject = js.native
  val toHaveNonEmptyString: ToHaveNonEmptyString = js.native
  val toHaveNumber: ToHaveNumber = js.native
  val toHaveNumberWithinRange: ToHaveNumberWithinRange = js.native
  val toHaveObject: ToHaveObject = js.native
  val toHaveOddNumber: ToHaveOddNumber = js.native
  val toHaveString: ToHaveString = js.native
  ...
  val toHaveTrue: ToHaveTrue = js.native
  val toHaveUndefined: ToHaveUndefined = js.native
  val toHaveWhitespaceString: ToHaveWhitespaceString = js.native
  val toHaveWholeNumber: ToHaveWholeNumber = js.native
  val toStartWith: ToStartWith = js.native
  val toThrowAnyError: ToThrowAnyError = js.native
  val toThrowErrorOfType: ToThrowErrorOfType = js.native
