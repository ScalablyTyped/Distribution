  ...
  object global {
    ...
    object jasmine {
      ...
      object Matchers {
        ...
        inline def apply[T](toHaveString: (/* key */ String, /* expectationFailOutput */ js.UndefOr[js.Any]) => Boolean): Matchers[T] = {
        ...
        extension [Self <: Matchers[?], T](x: Self & Matchers[T]) {
          ...
          inline def setToHaveString(value: (/* key */ String, /* expectationFailOutput */ js.UndefOr[js.Any]) => Boolean): Self = StObject.set(x, "toHaveString", js.Any.fromFunction2(value))
        }
      }
    }
  }
