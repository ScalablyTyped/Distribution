  ...
  object global {
    ...
    object jasmine {
      ...
      object Matchers {
        ...
        inline def apply[T](toThrowAnyError: /* expectationFailOutput */ js.UndefOr[js.Any] => Boolean): Matchers[T] = {
        ...
        extension [Self <: Matchers[?], T](x: Self & Matchers[T]) {
          ...
          inline def setToThrowAnyError(value: /* expectationFailOutput */ js.UndefOr[js.Any] => Boolean): Self = StObject.set(x, "toThrowAnyError", js.Any.fromFunction1(value))
        }
      }
    }
  }
