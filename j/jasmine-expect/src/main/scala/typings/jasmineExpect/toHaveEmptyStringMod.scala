  ...
  object global {
    ...
    object jasmine {
      ...
      object Matchers {
        ...
        @scala.inline
        def apply[T](toHaveEmptyString: (/* key */ String, /* expectationFailOutput */ js.UndefOr[js.Any]) => Boolean): Matchers[T] = {
        ...
        implicit class MatchersMutableBuilder[Self <: Matchers[?], T] (val x: Self & Matchers[T]) extends AnyVal {
          ...
          @scala.inline
          def setToHaveEmptyString(value: (/* key */ String, /* expectationFailOutput */ js.UndefOr[js.Any]) => Boolean): Self = StObject.set(x, "toHaveEmptyString", js.Any.fromFunction2(value))
        }
      }
    }
  }
