  ...
  object global {
    ...
    object jasmine {
      ...
      object Matchers {
        ...
        inline def apply[T](toBeArrayOfSize: (/* size */ Double, /* expectationFailOutput */ js.UndefOr[js.Any]) => Boolean): Matchers[T] = {
        ...
        extension [Self <: Matchers[?], T](x: Self & Matchers[T]) {
          ...
          inline def setToBeArrayOfSize(value: (/* size */ Double, /* expectationFailOutput */ js.UndefOr[js.Any]) => Boolean): Self = StObject.set(x, "toBeArrayOfSize", js.Any.fromFunction2(value))
        }
      }
    }
  }
