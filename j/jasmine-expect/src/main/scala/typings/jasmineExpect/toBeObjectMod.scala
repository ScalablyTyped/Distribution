  ...
  object global {
    ...
    object jasmine {
      ...
      object Matchers {
        ...
        @scala.inline
        def apply[T](toBeObject: /* expectationFailOutput */ js.UndefOr[js.Any] => Boolean): Matchers[T] = {
        ...
        implicit class MatchersMutableBuilder[Self <: Matchers[?], T] (val x: Self & Matchers[T]) extends AnyVal {
          ...
          @scala.inline
          def setToBeObject(value: /* expectationFailOutput */ js.UndefOr[js.Any] => Boolean): Self = StObject.set(x, "toBeObject", js.Any.fromFunction1(value))
        }
      }
    }
  }
