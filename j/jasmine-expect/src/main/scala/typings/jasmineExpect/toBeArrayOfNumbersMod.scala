  ...
  object global {
    ...
    object jasmine {
      ...
      object Matchers {
        ...
        inline def apply[T](toBeArrayOfNumbers: /* expectationFailOutput */ js.UndefOr[js.Any] => Boolean): Matchers[T] = {
        ...
        extension [Self <: Matchers[?], T](x: Self & Matchers[T]) {
          ...
          inline def setToBeArrayOfNumbers(value: /* expectationFailOutput */ js.UndefOr[js.Any] => Boolean): Self = StObject.set(x, "toBeArrayOfNumbers", js.Any.fromFunction1(value))
        }
      }
    }
  }
