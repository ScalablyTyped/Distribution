  ...
  object global {
    ...
    object jasmine {
      ...
      object Matchers {
        ...
        inline def apply[T](toEndWith: (/* subString */ String, /* expectationFailOutput */ js.UndefOr[js.Any]) => Boolean): Matchers[T] = {
        ...
        extension [Self <: Matchers[?], T](x: Self & Matchers[T]) {
          ...
          inline def setToEndWith(value: (/* subString */ String, /* expectationFailOutput */ js.UndefOr[js.Any]) => Boolean): Self = StObject.set(x, "toEndWith", js.Any.fromFunction2(value))
        }
      }
    }
  }
