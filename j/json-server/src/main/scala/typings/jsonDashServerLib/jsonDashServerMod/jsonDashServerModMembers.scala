...
@js.native
object jsonDashServerModMembers extends js.Object {
  ...
  def rewriter(rules: ScalablyTyped.runtime.StringDictionary[java.lang.String]): expressLib.expressMod.eNs.Router = js.native
