...
package object QtyNs {
  type ComparisonResult = jsDashQuantitiesLib.jsDashQuantitiesLibNumbers.`-1` | jsDashQuantitiesLib.jsDashQuantitiesLibNumbers.`0` | jsDashQuantitiesLib.jsDashQuantitiesLibNumbers.`1`
