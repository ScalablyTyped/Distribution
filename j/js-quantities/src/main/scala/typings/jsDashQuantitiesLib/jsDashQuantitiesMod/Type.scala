...
@js.native
trait Type
  extends org.scalablytyped.runtime.Instantiable1[/* value */ Source, Qty]
     with org.scalablytyped.runtime.Instantiable2[/* value */ scala.Double, /* unit */ java.lang.String, Qty] {
  val Error: js.Any = js.native
  @JSName("formatter")
  var formatter_Original: Formatter = js.native
  def apply(value: Source): Qty = js.native
  def apply(value: scala.Double, unit: java.lang.String): Qty = js.native
  ...
  def parse(value: java.lang.String): Qty = js.native
