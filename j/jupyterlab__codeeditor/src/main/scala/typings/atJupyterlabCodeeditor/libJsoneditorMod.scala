...
import typings.atJupyterlabCodeeditor.libJsoneditorMod.JSONEditor.IOptions
  ...
  object JSONEditor extends js.Object {
    ...
    trait IOptions extends js.Object {
      ...
      /**
        * The editor factory used by the editor.
        */
      def editorFactory(options: typings.atJupyterlabCodeeditor.libEditorMod.CodeEditor.IOptions): IEditor = js.native
    }
