package typings.jupyterlabCodeeditor.libEditorMod
...
import typings.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.cursorBlinkRate
...
import typings.jupyterlabCodeeditor.jupyterlabCodeeditorStrings.showTrailingSpace
...
object CodeEditor {
  ...
  open class Model ()
    extends StObject
       with IModel {
    def this(options: typings.jupyterlabCodeeditor.libEditorMod.CodeEditor.Model.IOptions) = this()
  ...
  object Model {
    ...
    object IOptions {
      ...
      inline def apply(): typings.jupyterlabCodeeditor.libEditorMod.CodeEditor.Model.IOptions = {
  ...
  */
  ...
  object IModel {
    ...
    extension [Self <: IModel](x: Self) {
      ...
      inline def setSwitchSharedModel(value: (ISharedText, Boolean) => Unit): Self = StObject.set(x, "switchSharedModel", js.Any.fromFunction2(value))
