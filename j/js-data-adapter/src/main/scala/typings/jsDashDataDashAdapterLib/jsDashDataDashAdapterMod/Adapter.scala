...
class Adapter () extends js.Object {
  ...
  def loadBelongsTo(mapper: jsDashDataLib.jsDashDataMod.Mapper, `def`: IDict, records: js.Array[IDict], __opts: IDict): stdLib.Promise[_] = js.native
  def loadBelongsTo(mapper: jsDashDataLib.jsDashDataMod.Mapper, `def`: IDict, records: IDict, __opts: IDict): stdLib.Promise[_] = js.native
  def loadHasMany(mapper: jsDashDataLib.jsDashDataMod.Mapper, `def`: IDict, records: js.Array[IDict], __opts: IDict): stdLib.Promise[_] = js.native
  def loadHasMany(mapper: jsDashDataLib.jsDashDataMod.Mapper, `def`: IDict, records: IDict, __opts: IDict): stdLib.Promise[_] = js.native
  def loadHasManyForeignKeys(mapper: jsDashDataLib.jsDashDataMod.Mapper, `def`: IDict, records: js.Array[IDict], __opts: IDict): stdLib.Promise[_] = js.native
  def loadHasManyForeignKeys(mapper: jsDashDataLib.jsDashDataMod.Mapper, `def`: IDict, records: IDict, __opts: IDict): stdLib.Promise[_] = js.native
  def loadHasManyLocalKeys(mapper: jsDashDataLib.jsDashDataMod.Mapper, `def`: IDict, records: js.Array[IDict], __opts: IDict): stdLib.Promise[_] = js.native
  def loadHasManyLocalKeys(mapper: jsDashDataLib.jsDashDataMod.Mapper, `def`: IDict, records: IDict, __opts: IDict): stdLib.Promise[_] = js.native
  def loadHasOne(mapper: jsDashDataLib.jsDashDataMod.Mapper, `def`: IDict, records: js.Array[IDict], __opts: IDict): stdLib.Promise[_] = js.native
  def loadHasOne(mapper: jsDashDataLib.jsDashDataMod.Mapper, `def`: IDict, records: IDict, __opts: IDict): stdLib.Promise[_] = js.native
...
object Adapter extends js.Object {
  ...
  def extend(instanceProps: jsDashDataDashAdapterLib.jsDashDataDashAdapterMod.IDict): ScalablyTyped.runtime.Instantiable1[
    /* opts */ js.UndefOr[/* opts */ jsDashDataDashAdapterLib.jsDashDataDashAdapterMod.IAdapterOpts], 
    jsDashDataDashAdapterLib.jsDashDataDashAdapterMod.Adapter
  ] = js.native
  def extend(
