...
import typings.atJupyterlabNotebook.Anon_Anchor
...
class Notebook protected () extends StaticNotebook {
  ...
  /**
    ...
    * selection.
    */
  def getContiguousSelection(): Anon_Anchor = js.native
  /**
...
object Notebook extends js.Object {
  ...
  object ContentFactory extends js.Object {
    /**
      ...
      */
    type IOptions = typings.atJupyterlabNotebook.libWidgetMod.StaticNotebook.ContentFactory.IOptions
  }
  
  /**
    * The content factory for the notebook widget.
    */
  type IContentFactory = typings.atJupyterlabNotebook.libWidgetMod.StaticNotebook.IContentFactory
  /**
    * An options object for initializing a notebook widget.
    */
  type IOptions = typings.atJupyterlabNotebook.libWidgetMod.StaticNotebook.IOptions
}
