...
object celllistMod {
  ...
  @js.native
  class CellList protected ()
    extends StObject
       with IObservableUndoableList[ICellModel] {
    /**
      * Construct the cell list.
      */
    def this(modelDB: IModelDB, factory: IContentFactory) = this()
    
    /* private */ var _cellMap: js.Any = js.native
    
    /* private */ var _cellOrder: js.Any = js.native
    ...
    /* private */ var _onOrderChanged: js.Any = js.native
