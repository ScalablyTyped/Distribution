...
trait IOptions extends js.Object {
  ...
  /**
    ...
    */
  var contentFactory: js.UndefOr[typings.jupyterlabNotebook.modelMod.NotebookModel.IContentFactory] = js.undefined
}
...
object IOptions {
  ...
  def apply(
    ...
    contentFactory: typings.jupyterlabNotebook.modelMod.NotebookModel.IContentFactory = null
  ): IOptions = {
