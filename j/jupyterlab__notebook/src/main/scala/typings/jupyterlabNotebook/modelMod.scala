...
object modelMod {
  ...
  class NotebookModel () extends DocumentModel {
    ...
    /* private */ var _deletedCells: js.Any = js.native
    
    /**
      * Make sure we have the required metadata fields.
      */
    /* private */ var _ensureMetadata: js.Any = js.native
    
    /* private */ var _nbformat: js.Any = js.native
    
    /* private */ var _nbformatMinor: js.Any = js.native
  ...
  object NotebookModel {
    ...
    object ContentFactory {
      ...
      object IOptions {
        ...
        inline def apply(): typings.jupyterlabNotebook.modelMod.NotebookModel.ContentFactory.IOptions = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typings.jupyterlabNotebook.modelMod.NotebookModel.ContentFactory.IOptions]
        }
        
        extension [Self <: typings.jupyterlabNotebook.modelMod.NotebookModel.ContentFactory.IOptions](x: Self) {
    ...
    object IContentFactory {
      ...
      extension [Self <: IContentFactory](x: Self) {
        ...
        inline def setClone_(value: IModelDB => IContentFactory): Self = StObject.set(x, "clone", js.Any.fromFunction1(value))
        
        inline def setCodeCellContentFactory(value: typings.jupyterlabCells.modelMod.CodeCellModel.IContentFactory): Self = StObject.set(x, "codeCellContentFactory", value.asInstanceOf[js.Any])
        
        inline def setCreateCell(value: (CellType, typings.jupyterlabCells.modelMod.CellModel.IOptions) => ICellModel): Self = StObject.set(x, "createCell", js.Any.fromFunction2(value))
        ...
        inline def setCreateMarkdownCell(value: typings.jupyterlabCells.modelMod.CellModel.IOptions => IMarkdownCellModel): Self = StObject.set(x, "createMarkdownCell", js.Any.fromFunction1(value))
  ...
  object INotebookModel {
    ...
    inline def apply(
      ...
      readOnly: Boolean,
      stateChanged: ISignal[INotebookModel, IChangedArgs[js.Any, js.Any, String]],
    ...
    extension [Self <: INotebookModel](x: Self) {
      
      inline def setCells(value: IObservableUndoableList[ICellModel]): Self = StObject.set(x, "cells", value.asInstanceOf[js.Any])
      
      inline def setContentFactory(value: IContentFactory): Self = StObject.set(x, "contentFactory", value.asInstanceOf[js.Any])
      
      inline def setDeletedCells(value: js.Array[String]): Self = StObject.set(x, "deletedCells", value.asInstanceOf[js.Any])
      
      inline def setDeletedCellsVarargs(value: String*): Self = StObject.set(x, "deletedCells", js.Array(value :_*))
      ...
      inline def setNbformatMinor(value: Double): Self = StObject.set(x, "nbformatMinor", value.asInstanceOf[js.Any])
    }
  }
}
