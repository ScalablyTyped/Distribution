...
import typings.jqueryDashToastmessageDashPlugin.JQueryToastmessage.ToastOptions
import typings.jqueryDashToastmessageDashPlugin.JQueryToastmessage.ToastmessageStatic
