...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-message-util" % "24.9.0-83b458",
  "org.scalablytyped" %%% "jest-mock" % "24.9.0-ea1bae",
  "org.scalablytyped" %%% "jest-resolve" % "24.9.0-f323bb",
  "org.scalablytyped" %%% "jest-runtime" % "24.9.0-b746b8",
  "org.scalablytyped" %%% "jest__console" % "24.9.0-7fb5d5",
  "org.scalablytyped" %%% "jest__environment" % "24.9.0-11fc6e",
  "org.scalablytyped" %%% "jest__fake-timers" % "24.9.0-76df0a",
