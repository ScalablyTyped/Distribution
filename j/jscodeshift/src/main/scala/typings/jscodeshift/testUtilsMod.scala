...
object testUtilsMod {
  ...
  inline def defineTest(dirName: String, transformName: String, options: Options): js.Function0[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("defineTest")(dirName.asInstanceOf[js.Any], transformName.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Function0[js.Any]]
