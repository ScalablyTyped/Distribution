package typings.jscodeshift.srcCollectionMod
...
import typings.jscodeshift.srcCollectionsVariableDeclaratorMod.TransformMethods
...
trait Collection[N]
  extends TraversalMethods
     ...
     with typings.jscodeshift.srcCollectionsJSXElementMod.GlobalMethods
     with typings.jscodeshift.srcCollectionsJSXElementMod.TraversalMethods
     with /**
