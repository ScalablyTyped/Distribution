...
version := "1.2.1-841e3e"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "csstype" % "2.6.6-fd5644",
  "org.scalablytyped" %%% "jupyterlab__application" % "1.2.1-f83e7a",
  ...
  "org.scalablytyped" %%% "jupyterlab__docregistry" % "1.2.1-8c5a41",
  "org.scalablytyped" %%% "jupyterlab__markdownviewer" % "1.2.1-424ebc",
  ...
  "org.scalablytyped" %%% "phosphor__application" % "1.7.3-68b183",
