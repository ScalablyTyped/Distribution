...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__application" % "3.5.0-80f8b3",
  "org.scalablytyped" %%% "jupyterlab__apputils" % "3.5.0-cf31bc",
  "org.scalablytyped" %%% "jupyterlab__codeeditor" % "3.5.0-2ed73a",
  "org.scalablytyped" %%% "jupyterlab__coreutils" % "5.5.0-c1cac4",
  "org.scalablytyped" %%% "jupyterlab__docprovider" % "3.5.0-c0ca11",
  "org.scalablytyped" %%% "jupyterlab__docregistry" % "3.5.0-b20574",
  "org.scalablytyped" %%% "jupyterlab__markdownviewer" % "3.5.0-0ad918",
