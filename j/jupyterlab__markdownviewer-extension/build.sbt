...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__application" % "2.1.0-3f20b4",
  "org.scalablytyped" %%% "jupyterlab__apputils" % "2.1.0-6debfe",
  "org.scalablytyped" %%% "jupyterlab__codeeditor" % "2.1.0-00ca71",
  "org.scalablytyped" %%% "jupyterlab__coreutils" % "4.1.0-c87d6c",
  "org.scalablytyped" %%% "jupyterlab__docregistry" % "2.1.0-be5472",
  "org.scalablytyped" %%% "jupyterlab__markdownviewer" % "2.1.0-188213",
  "org.scalablytyped" %%% "jupyterlab__nbformat" % "2.1.0-6c39cd",
  "org.scalablytyped" %%% "jupyterlab__observables" % "3.1.0-74e8c6",
  "org.scalablytyped" %%% "jupyterlab__rendermime" % "2.1.0-b360c4",
  "org.scalablytyped" %%% "jupyterlab__rendermime-interfaces" % "2.1.0-107b62",
