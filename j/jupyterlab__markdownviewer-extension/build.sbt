...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__application" % "2.1.2-c38cd0",
  ...
  "org.scalablytyped" %%% "jupyterlab__docregistry" % "2.1.2-582a44",
  "org.scalablytyped" %%% "jupyterlab__markdownviewer" % "2.1.2-757445",
  ...
  "org.scalablytyped" %%% "lumino__application" % "1.9.2-fc1495",
