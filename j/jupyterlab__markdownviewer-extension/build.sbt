...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__application" % "3.5.0-22520c",
  "org.scalablytyped" %%% "jupyterlab__apputils" % "3.5.0-ea5687",
  "org.scalablytyped" %%% "jupyterlab__codeeditor" % "3.5.0-9516fd",
  "org.scalablytyped" %%% "jupyterlab__coreutils" % "5.5.0-c1cac4",
  "org.scalablytyped" %%% "jupyterlab__docprovider" % "3.5.0-272c3c",
  "org.scalablytyped" %%% "jupyterlab__docregistry" % "3.5.0-5d34d9",
  "org.scalablytyped" %%% "jupyterlab__markdownviewer" % "3.5.0-92ea4e",
  "org.scalablytyped" %%% "jupyterlab__nbformat" % "3.5.0-81f773",
  "org.scalablytyped" %%% "jupyterlab__observables" % "4.5.0-1ab86b",
  "org.scalablytyped" %%% "jupyterlab__rendermime" % "3.5.0-ba759a",
  ...
  "org.scalablytyped" %%% "jupyterlab__ui-components" % "3.5.0-60a9d9",
  ...
  "org.scalablytyped" %%% "y-websocket" % "1.4.5-1b3855",
