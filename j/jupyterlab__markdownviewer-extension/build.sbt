...
version := "1.0.5-dae731"
scalaVersion := "2.12.9"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "csstype" % "2.6.6-c240ab",
  "org.scalablytyped" %%% "jupyterlab__application" % "1.0.5-fd3769",
  ...
  "org.scalablytyped" %%% "jupyterlab__markdownviewer" % "1.0.5-93e473",
  ...
  "org.scalablytyped" %%% "phosphor__application" % "1.7.0-9881a4",
