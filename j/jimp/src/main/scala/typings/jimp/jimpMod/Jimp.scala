...
import typings.jimp.Anon_B
import typings.jimp.Anon_CropOnlyFrames
import typings.jimp.Anon_Image
...
Instantiable1[
  ...
  def blit(src: Jimp, x: Double, y: Double, cb: ImageCallback[_]): this.type = js.native
  ...
  def composite(src: Jimp, x: Double, y: Double, options: BlendMode, cb: ImageCallback[_]): this.type = js.native
  ...
  def create(data: Buffer): js.Promise[Jimp] = js.native
  def create(image: Jimp): js.Promise[Jimp] = js.native
  def create(path: String): js.Promise[Jimp] = js.native
  def create(w: Double, h: Double): js.Promise[Jimp] = js.native
  def create(w: Double, h: Double, background: String): js.Promise[Jimp] = js.native
  def create(w: Double, h: Double, background: Double): js.Promise[Jimp] = js.native
  ...
  def diff(img1: Jimp, img2: Jimp): Anon_Image = js.native
  def diff(img1: Jimp, img2: Jimp, threshold: Double): Anon_Image = js.native
  def displace(map: Jimp, offset: Double): this.type = js.native
  def displace(map: Jimp, offset: Double, cb: ImageCallback[_]): this.type = js.native
  ...
  def hash(base: js.UndefOr[scala.Nothing], cb: GenericCallback[String, _, this.type]): this.type = js.native
  def hash(base: Double): this.type = js.native
  def hash(base: Double, cb: GenericCallback[String, _, this.type]): this.type = js.native
  def hash(base: Null, cb: GenericCallback[String, _, this.type]): this.type = js.native
  def hash(cb: GenericCallback[String, _, this.type]): this.type = js.native
  ...
  def mask(src: Jimp, x: Double, y: Double, cb: ImageCallback[_]): this.type = js.native
  ...
  def read(data: Buffer): js.Promise[Jimp] = js.native
  def read(image: Jimp): js.Promise[Jimp] = js.native
  def read(path: String): js.Promise[Jimp] = js.native
  def read(w: Double, h: Double): js.Promise[Jimp] = js.native
  def read(w: Double, h: Double, background: String): js.Promise[Jimp] = js.native
  def read(w: Double, h: Double, background: Double): js.Promise[Jimp] = js.native
  ...
  def rgbaToInt(r: Double, g: Double, b: Double, a: Double, cb: GenericCallback[Double, _, Jimp]): Double = js.native
  // Shape methods
  ...
  def writeAsync(path: String): js.Promise[Jimp] = js.native
}
