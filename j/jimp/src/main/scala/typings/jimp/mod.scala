...
import typings.jimp.anon.Decoders
...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : JimpConstructors & IntersectedPluginConsts & Decoders = js.native
  ...
  override def _to: JimpConstructors & IntersectedPluginConsts & Decoders = ^
}
