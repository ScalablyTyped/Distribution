...
- Dropped {[ P in keyof json-schema-ref-parser.json-schema-ref-parser.ResolverOptions ]:? json-schema-ref-parser.json-schema-ref-parser.ResolverOptions[P]} */ trait HTTPResolverOptions extends js.Object {
  /**
