...
class $Refs () extends js.Object {
  ...
  /**
    ...
    * @param $ref The JSON Reference path, optionally with a JSON Pointer in the hash
    */
  def get($ref: java.lang.String): jsonDashSchemaLib.jsonDashSchemaMod.JSONSchema4Type | jsonDashSchemaLib.jsonDashSchemaMod.JSONSchema6Type = js.native
  /**
  ...
  def set(
    ...
    value: jsonDashSchemaLib.jsonDashSchemaMod.JSONSchema4Type | jsonDashSchemaLib.jsonDashSchemaMod.JSONSchema6Type
  ...
  /**
    ...
    */
  def values(types: java.lang.String*): org.scalablytyped.runtime.StringDictionary[JSONSchema] = js.native
}
