...
object ^ extends js.Object {
  ...
  def mkdirP(name: java.lang.String, f: js.Function2[/* er */ stdLib.Error, /* made */ js.Any, scala.Unit]): scala.Unit = js.native
  def mkdirP(name: java.lang.String, mode: java.lang.String): scala.Unit = js.native
  def mkdirP(
    name: java.lang.String,
    mode: java.lang.String,
    f: js.Function2[/* er */ stdLib.Error, /* made */ js.Any, scala.Unit]
  ): scala.Unit = js.native
