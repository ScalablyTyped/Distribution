...
object ^ extends js.Object {
  var logger: jakeLib.jakeNs.Logger = js.native
  ...
  def cpR(path: java.lang.String, destination: java.lang.String, opts: jakeLib.jakeNs.UtilOptions): scala.Unit = js.native
  def cpR(
    path: java.lang.String,
    destination: java.lang.String,
    opts: jakeLib.jakeNs.UtilOptions,
    callback: js.Function0[scala.Unit]
  ): scala.Unit = js.native
  def createExec(cmds: java.lang.String): jakeLib.jakeNs.Exec = js.native
  def createExec(cmds: java.lang.String, callback: js.Function0[scala.Unit]): jakeLib.jakeNs.Exec = js.native
  def createExec(cmds: java.lang.String, callback: js.Function0[scala.Unit], opts: jakeLib.jakeNs.ExecOptions): jakeLib.jakeNs.Exec = js.native
  def createExec(cmds: java.lang.String, opts: jakeLib.jakeNs.ExecOptions): jakeLib.jakeNs.Exec = js.native
  def createExec(cmds: java.lang.String, opts: jakeLib.jakeNs.ExecOptions, callback: js.Function0[scala.Unit]): jakeLib.jakeNs.Exec = js.native
  def createExec(cmds: js.Array[java.lang.String]): jakeLib.jakeNs.Exec = js.native
  def createExec(cmds: js.Array[java.lang.String], callback: js.Function0[scala.Unit]): jakeLib.jakeNs.Exec = js.native
  def createExec(
    cmds: js.Array[java.lang.String],
    callback: js.Function0[scala.Unit],
    opts: jakeLib.jakeNs.ExecOptions
  ): jakeLib.jakeNs.Exec = js.native
  def createExec(cmds: js.Array[java.lang.String], opts: jakeLib.jakeNs.ExecOptions): jakeLib.jakeNs.Exec = js.native
  def createExec(
    cmds: js.Array[java.lang.String],
    opts: jakeLib.jakeNs.ExecOptions,
    callback: js.Function0[scala.Unit]
  ...
  def readdirR(name: java.lang.String, opts: jakeLib.jakeNs.UtilOptions): js.Array[java.lang.String] = js.native
  ...
  def rmRf(name: java.lang.String, opts: jakeLib.jakeNs.UtilOptions): scala.Unit = js.native
