...
object ^ extends js.Object {
  ...
  def decode(jpegData: stdLib.Iterable[scala.Double], useTypedArray: jpegDashJsLib.jpegDashJsLibNumbers.`false`): RawImageData[nodeLib.Buffer] = js.native
  def decode(jpegData: stdLib.Iterable[scala.Double], useTypedArray: jpegDashJsLib.jpegDashJsLibNumbers.`true`): RawImageData[stdLib.Uint8Array] = js.native
