...
@JSGlobal("vscode.TabInputNotebook")
@js.native
open class TabInputNotebook protected ()
  extends typings.vscode.mod.TabInputNotebook {
  /**
    ...
    */
  def this(uri: typings.vscode.mod.Uri, notebookType: String) = this()
}
