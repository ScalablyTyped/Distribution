...
object Uri {
  ...
  /**
    ...
    */
  inline def joinPath(base: typings.vscode.mod.Uri, pathSegments: String*): typings.vscode.mod.Uri = ^.asInstanceOf[js.Dynamic].applyDynamic("joinPath")(List(base.asInstanceOf[js.Any]).`++`(pathSegments.asInstanceOf[Seq[js.Any]])*).asInstanceOf[typings.vscode.mod.Uri]
