...
@JSGlobal("vscode.QuickInputButtons")
@js.native
/**
		 * @hidden
		 */
/* private */ open class QuickInputButtons ()
  extends typings.vscode.mod.QuickInputButtons
/* static members */
object QuickInputButtons {
  ...
  /**
  		 ...
  		 */
  @JSGlobal("vscode.QuickInputButtons.Back")
  @js.native
