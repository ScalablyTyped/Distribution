...
import typings.vscode.mod.MessageItem
...
object window {
  ...
  inline def showErrorMessage[T /* <: String */](message: String, items: T*): Thenable[js.UndefOr[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("showErrorMessage")(List(message.asInstanceOf[js.Any]).`++`(items.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showErrorMessage[T /* <: String */](message: String, options: MessageOptions, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showErrorMessage")((List(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).`++`(items.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Thenable[js.UndefOr[T]]]
  
  inline def showErrorMessage_T_MessageItem[T /* <: MessageItem */](message: String, items: T*): Thenable[js.UndefOr[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("showErrorMessage")(List(message.asInstanceOf[js.Any]).`++`(items.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showErrorMessage_T_MessageItem[T /* <: MessageItem */](message: String, options: MessageOptions, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showErrorMessage")((List(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).`++`(items.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Thenable[js.UndefOr[T]]]
  
  inline def showInformationMessage[T /* <: String */](message: String, items: T*): Thenable[js.UndefOr[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("showInformationMessage")(List(message.asInstanceOf[js.Any]).`++`(items.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showInformationMessage[T /* <: String */](message: String, options: MessageOptions, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showInformationMessage")((List(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).`++`(items.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Thenable[js.UndefOr[T]]]
  
  inline def showInformationMessage_T_MessageItem[T /* <: MessageItem */](message: String, items: T*): Thenable[js.UndefOr[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("showInformationMessage")(List(message.asInstanceOf[js.Any]).`++`(items.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showInformationMessage_T_MessageItem[T /* <: MessageItem */](message: String, options: MessageOptions, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showInformationMessage")((List(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).`++`(items.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Thenable[js.UndefOr[T]]]
  ...
  inline def showQuickPick_T_QuickPickItem[T /* <: QuickPickItem */](items: js.Array[T]): Thenable[js.UndefOr[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("showQuickPick")(items.asInstanceOf[js.Any]).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showQuickPick_T_QuickPickItem[T /* <: QuickPickItem */](items: js.Array[T], options: Unit, token: CancellationToken): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showQuickPick")(items.asInstanceOf[js.Any], options.asInstanceOf[js.Any], token.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showQuickPick_T_QuickPickItem[T /* <: QuickPickItem */](items: js.Array[T], options: QuickPickOptionscanPickMa): Thenable[js.UndefOr[js.Array[T]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showQuickPick")(items.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[js.Array[T]]]]
  ...
  inline def showQuickPick_T_QuickPickItem[T /* <: QuickPickItem */](items: js.Array[T], options: QuickPickOptions): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showQuickPick")(items.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[T]]]
  ...
  inline def showQuickPick_T_QuickPickItem[T /* <: QuickPickItem */](items: Thenable[js.Array[T]]): Thenable[js.UndefOr[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("showQuickPick")(items.asInstanceOf[js.Any]).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showQuickPick_T_QuickPickItem[T /* <: QuickPickItem */](items: Thenable[js.Array[T]], options: Unit, token: CancellationToken): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showQuickPick")(items.asInstanceOf[js.Any], options.asInstanceOf[js.Any], token.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showQuickPick_T_QuickPickItem[T /* <: QuickPickItem */](items: Thenable[js.Array[T]], options: QuickPickOptionscanPickMa): Thenable[js.UndefOr[js.Array[T]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showQuickPick")(items.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[js.Array[T]]]]
  ...
  inline def showQuickPick_T_QuickPickItem[T /* <: QuickPickItem */](items: Thenable[js.Array[T]], options: QuickPickOptions): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showQuickPick")(items.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[T]]]
  ...
  inline def showWarningMessage[T /* <: String */](message: String, items: T*): Thenable[js.UndefOr[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("showWarningMessage")(List(message.asInstanceOf[js.Any]).`++`(items.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showWarningMessage[T /* <: String */](message: String, options: MessageOptions, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showWarningMessage")((List(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).`++`(items.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Thenable[js.UndefOr[T]]]
  
  inline def showWarningMessage_T_MessageItem[T /* <: MessageItem */](message: String, items: T*): Thenable[js.UndefOr[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("showWarningMessage")(List(message.asInstanceOf[js.Any]).`++`(items.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showWarningMessage_T_MessageItem[T /* <: MessageItem */](message: String, options: MessageOptions, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showWarningMessage")((List(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).`++`(items.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Thenable[js.UndefOr[T]]]
