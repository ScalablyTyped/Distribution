...
object jsplumbLibStrings {
  @js.native
  sealed trait Arrow
    extends jsplumbLib.jsplumbMod.OverlayId
  
  @js.native
  sealed trait Assign
    extends jsplumbLib.jsplumbMod.AnchorId
  ...
  @js.native
  sealed trait Bezier
    extends jsplumbLib.jsplumbMod._ConnectorId
  
  @js.native
  sealed trait Blank
    extends jsplumbLib.jsplumbMod._EndpointId
