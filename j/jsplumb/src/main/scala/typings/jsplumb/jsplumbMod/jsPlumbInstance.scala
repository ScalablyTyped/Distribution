...
import typings.jsplumb.Anon_Conn
...
class jsPlumbInstance () extends js.Object {
  ...
  def select(): Anon_Conn = js.native
  def select(params: js.Object): Anon_Conn = js.native
  def select(params: js.Object, scope: String): Anon_Conn = js.native
  def select(params: js.Object, scope: String, source: String): Anon_Conn = js.native
  def select(params: js.Object, scope: String, source: String, target: String): Anon_Conn = js.native
  def select(
    params: js.Object,
    scope: String,
    source: String,
