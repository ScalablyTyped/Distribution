...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.jsplumb.jsplumbStrings.AutoDefault
  ...
  - typings.jsplumb.jsplumbStrings.Continuous
  - typings.jsplumb.jsplumbStrings.ContinuousBottom
  - typings.jsplumb.jsplumbStrings.ContinuousLeft
  ...
  - typings.jsplumb.jsplumbStrings.Perimeter
...
object AnchorId {
  ...
  @scala.inline
  def AutoDefault: typings.jsplumb.jsplumbStrings.AutoDefault = this.cast("AutoDefault")
  @scala.inline
  ...
  @scala.inline
  def Perimeter: typings.jsplumb.jsplumbStrings.Perimeter = this.cast("Perimeter")
  @scala.inline
