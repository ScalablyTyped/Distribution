...
object mod extends js.Object {
  ...
  def diffLinesUnified(aLines: js.Array[String], bLines: js.Array[String], options: typings.jestDiff.typesMod.DiffOptions): String = js.native
  ...
  def diffLinesUnified2(
    ...
    aLinesCompare: js.Array[String],
    bLinesCompare: js.Array[String],
    options: typings.jestDiff.typesMod.DiffOptions
  ): String = js.native
  ...
  def diffStringsUnified(a: String, b: String, options: typings.jestDiff.typesMod.DiffOptions): String = js.native
  type DiffOptions = typings.jestDiff.typesMod.DiffOptions
  type DiffOptionsColor = typings.jestDiff.typesMod.DiffOptionsColor
}
