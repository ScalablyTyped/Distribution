...
object ^ extends js.Object {
  var options: jwtDashExpressLib.jwtDashExpressMod.JWTExpressOptions = js.native
  ...
  def create(secret: java.lang.String, payload: js.Any): jwtDashExpressLib.jwtDashExpressMod.JWT = js.native
  def create(secret: js.Function1[/* payload */ js.Any, java.lang.String], payload: js.Any): jwtDashExpressLib.jwtDashExpressMod.JWT = js.native
  def init(secret: java.lang.String): expressLib.expressMod.eNs.RequestHandler = js.native
  def init(secret: java.lang.String, options: jwtDashExpressLib.jwtDashExpressMod.JWTExpressOptions): expressLib.expressMod.eNs.RequestHandler = js.native
  ...
  def init(
    ...
    options: jwtDashExpressLib.jwtDashExpressMod.JWTExpressOptions
