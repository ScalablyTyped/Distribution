...
object JSONPathOptionsAutoStart {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(autostart = autostart, path = path.asInstanceOf[js.Any])
    ...
    if (parentProperty != null) __obj.updateDynamic("parentProperty")(parentProperty)
    if (!js.isUndefined(preventEval)) __obj.updateDynamic("preventEval")(preventEval)
