...
trait AnonErrMsgLocalIds extends js.Object {
  var errMsg: String
  	// weixin album camera
...
object AnonErrMsgLocalIds {
  @scala.inline
  def apply(errMsg: String, localIds: js.Array[String], sourceType: String): AnonErrMsgLocalIds = {
    ...
    __obj.asInstanceOf[AnonErrMsgLocalIds]
  }
}
