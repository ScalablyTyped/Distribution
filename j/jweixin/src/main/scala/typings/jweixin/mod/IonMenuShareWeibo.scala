...
object IonMenuShareWeibo {
  ...
  inline def apply(cancel: () => Unit, desc: String, imgUrl: String, link: String, success: () => Unit, title: String): IonMenuShareWeibo = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IonMenuShareWeibo] (val x: Self) extends AnyVal {
