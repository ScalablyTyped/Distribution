...
object IuploadImage {
  ...
  inline def apply(isShowProgressTips: Double, localId: String, success: ServerId => Unit): IuploadImage = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IuploadImage] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: ServerId => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
  }
}
