...
object IonMenuShareQZone {
  ...
  inline def apply(cancel: () => Unit, desc: String, imgUrl: String, link: String, success: () => Unit, title: String): IonMenuShareQZone = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IonMenuShareQZone] (val x: Self) extends AnyVal {
