...
name := "jupyterlab__logconsole-extension"
version := "2.1.2-3aa51f"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__logconsole" % "2.1.1-b781e5",
  "org.scalablytyped" %%% "jupyterlab__nbformat" % "2.1.0-286e04",
  "org.scalablytyped" %%% "jupyterlab__observables" % "3.1.0-f11e6c",
  "org.scalablytyped" %%% "jupyterlab__outputarea" % "2.1.1-3e56cb",
