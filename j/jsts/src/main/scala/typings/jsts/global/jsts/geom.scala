...
object geom {
  ...
  object Envelope {
    ...
    /**
      ...
      */
    @JSGlobal("jsts.geom.Envelope.intersects")
    @js.native
    def intersects(
    ...
    /**
      ...
      */
    @JSGlobal("jsts.geom.Envelope.intersectsEnvelope")
    @js.native
  ...
  object IntersectionMatrix {
    ...
    @JSGlobal("jsts.geom.IntersectionMatrix.isTrue")
    @js.native
    def isTrue(actualDimensionValue: Double): Boolean = js.native
    
    @JSGlobal("jsts.geom.IntersectionMatrix.matches")
    @js.native
  ...
  object LineSegment {
    ...
    /**
      ...
      */
    @JSGlobal("jsts.geom.LineSegment.midPoint")
    @js.native
  ...
  object util {
    ...
    object AffineTransformation {
      ...
      @JSGlobal("jsts.geom.util.AffineTransformation.reflectionInstance")
      @js.native
      ...
      @JSGlobal("jsts.geom.util.AffineTransformation.rotationInstance")
      @js.native
      ...
      @JSGlobal("jsts.geom.util.AffineTransformation.scaleInstance")
      @js.native
      ...
      @JSGlobal("jsts.geom.util.AffineTransformation.shearInstance")
      @js.native
      def shearInstance(xShear: Double, yShear: Double): typings.jsts.jsts.geom.util.AffineTransformation = js.native
      
      @JSGlobal("jsts.geom.util.AffineTransformation.translationInstance")
      @js.native
