...
object dateMod {
  ...
  object SfDate {
    ...
    inline def toDateLiteral(date: Date): SfDate = ^.asInstanceOf[js.Dynamic].applyDynamic("toDateLiteral")(date.asInstanceOf[js.Any]).asInstanceOf[SfDate]
    ...
    inline def toDateTimeLiteral(date: Date): SfDate = ^.asInstanceOf[js.Dynamic].applyDynamic("toDateTimeLiteral")(date.asInstanceOf[js.Any]).asInstanceOf[SfDate]
  }
}
