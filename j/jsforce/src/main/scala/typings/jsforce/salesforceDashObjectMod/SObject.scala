...
import typings.jsforce.Anon_CallbackClearApprovalLayoutInfo
import typings.jsforce.Anon_CallbackClearCompactLayoutInfo
import typings.jsforce.Anon_CallbackClearDescribeSObjectResult
import typings.jsforce.Anon_CallbackClearLayoutName
import typings.jsforce.Anon_ExtIdField
...
import typings.jsforce.quickDashActionMod.QuickActionInfo
...
class SObject[T] () extends js.Object {
  ...
  def quickAction(actionName: String): typings.jsforce.quickDashActionMod.QuickAction = js.native
