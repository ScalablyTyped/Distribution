...
class Job protected ()
  ...
  def abort(callback: js.Function2[/* err */ nodeLib.Error, /* jobInfo */ JobInfo, scala.Unit]): js.Promise[_] = js.native
  def batch(batchId: java.lang.String): jsforceLib.batchMod.Batch = js.native
  def check(): js.Promise[JobInfo] = js.native
  def check(callback: js.Function2[/* err */ nodeLib.Error, /* jobInfo */ JobInfo, scala.Unit]): js.Promise[JobInfo] = js.native
  def close(): js.Promise[JobInfo] = js.native
  def close(callback: js.Function2[/* err */ nodeLib.Error, /* jobInfo */ JobInfo, scala.Unit]): js.Promise[JobInfo] = js.native
  def createBatch(): jsforceLib.batchMod.Batch = js.native
  def info(): js.Promise[JobInfo] = js.native
  def info(callback: js.Function2[/* err */ nodeLib.Error, /* jobInfo */ JobInfo, scala.Unit]): js.Promise[JobInfo] = js.native
  ...
  def open(callback: js.Function2[/* err */ nodeLib.Error, /* jobInfo */ JobInfo, scala.Unit]): js.Promise[JobInfo] = js.native
}
