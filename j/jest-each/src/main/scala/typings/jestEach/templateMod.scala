...
object templateMod {
  ...
  @scala.inline
  def default(title: String, headings: Headings, row: Row): EachTests = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(title.asInstanceOf[js.Any], headings.asInstanceOf[js.Any], row.asInstanceOf[js.Any])).asInstanceOf[EachTests]
  
  @scala.inline
  def getPath[Obj /* <: Template */](obj: Obj, path: js.Array[String]): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("getPath")(obj.asInstanceOf[js.Any], path.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
