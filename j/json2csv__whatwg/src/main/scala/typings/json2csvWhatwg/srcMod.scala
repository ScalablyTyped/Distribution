...
import typings.json2csvWhatwg.srcAsyncParserMod.default
...
object srcMod {
  ...
  @JSImport("@json2csv/whatwg/src", "AsyncParser")
  @js.native
  open class AsyncParser[I, O] () extends default[I, O] {
  ...
  @JSImport("@json2csv/whatwg/src", "TransformStream")
  @js.native
  open class TransformStream[I, O] ()
    extends typings.json2csvWhatwg.srcTransformStreamMod.default[I, O] {
    def this(opts: Options) = this()
    def this(opts: Unit, asyncOpts: AsyncOptions) = this()
    def this(opts: Options, asyncOpts: AsyncOptions) = this()
    def this(opts: Unit, asyncOpts: Unit, writableStrategy: QueuingStrategy[I]) = this()
