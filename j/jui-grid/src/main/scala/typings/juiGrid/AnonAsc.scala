...
object AnonAsc {
  ...
  def apply(
    ...
    if (!js.isUndefined(editEvent)) __obj.updateDynamic("editEvent")(editEvent.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(expandEvent)) __obj.updateDynamic("expandEvent")(expandEvent.asInstanceOf[js.Any])
    if (fields != null) __obj.updateDynamic("fields")(fields.asInstanceOf[js.Any])
    if (!js.isUndefined(moveRow)) __obj.updateDynamic("moveRow")(moveRow.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(sortEvent)) __obj.updateDynamic("sortEvent")(sortEvent.asInstanceOf[js.Any])
