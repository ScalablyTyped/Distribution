package typings
package atJupyterlabDocregistryLib.libContextMod
...
@js.native
class Context[T /* <: atJupyterlabDocregistryLib.libRegistryMod.DocumentRegistryNs.IModel */] protected ()
  extends atJupyterlabDocregistryLib.libRegistryMod.DocumentRegistryNs.IContext[T] {
  /**
    * Construct a new document context.
    */
  def this(options: atJupyterlabDocregistryLib.libContextMod.ContextNs.IOptions[T]) = this()
  ...
  /**
    ...
    */
  val factoryName: java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("session")
  val session_Context: atJupyterlabApputilsLib.atJupyterlabApputilsMod.ClientSession = js.native
  /**
  ...
  /**
    ...
    */
  def initialize(isNew: scala.Boolean): js.Promise[scala.Unit] = js.native
}
