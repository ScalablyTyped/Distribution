...
import typings.atJupyterlabServices.libContentsMod.Contents.ICheckpointModel
...
trait IContext[T /* <: IModel */] extends IDisposable {
  /**
    ...
    */
  val contentsModel: typings.atJupyterlabServices.libContentsMod.Contents.IModel | Null = js.native
  /**
  ...
  /**
    ...
    */
  var fileChanged: ISignal[this.type, typings.atJupyterlabServices.libContentsMod.Contents.IModel] = js.native
  /**
