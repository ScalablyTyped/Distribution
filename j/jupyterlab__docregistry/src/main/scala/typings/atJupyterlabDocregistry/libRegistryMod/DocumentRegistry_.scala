...
import typings.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.IChangedArgs
import typings.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.IFileType
import typings.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.IOptions
import typings.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.ModelFactory
import typings.atJupyterlabDocregistry.libRegistryMod.DocumentRegistry.WidgetExtension
