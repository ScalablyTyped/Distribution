package typings.atJupyterlabDocregistry.libContextMod

import typings.atJupyterlabApputils.atJupyterlabApputilsMod.ClientSession
...
class Context[T /* <: IModel */] protected () extends IContext[T] {
  ...
  /**
    ...
    */
  @JSName("session")
  val session_Context: ClientSession = js.native
  /**
