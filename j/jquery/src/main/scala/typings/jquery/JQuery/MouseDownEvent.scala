...
object MouseDownEvent {
  ...
  @scala.inline
  implicit class MouseDownEventOps[Self <: MouseDownEvent[_, _, _, _], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self with (MouseDownEvent[TDelegateTarget, TData, TCurrentTarget, TTarget])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: mousedown): Self = this.set("type", value.asInstanceOf[js.Any])
  }
