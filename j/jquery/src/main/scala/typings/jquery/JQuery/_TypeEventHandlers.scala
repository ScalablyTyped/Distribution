...
object _TypeEventHandlers {
  ...
  @scala.inline
  implicit class _TypeEventHandlersOps[Self <: _TypeEventHandlers[_, _, _, _], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self with (_TypeEventHandlers[TDelegateTarget, TData, TCurrentTarget, TTarget])) extends AnyVal {
    @scala.inline
    ...
    ): Self = this.set("change", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    ): Self = this.set("dragexit", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    ): Self = this.set("scroll", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    ): Self = this.set("submit", value.asInstanceOf[js.Any])
    @scala.inline
