...
object DragLeaveEvent {
  ...
  @scala.inline
  implicit class DragLeaveEventOps[Self <: DragLeaveEvent[_, _, _, _], TDelegateTarget, TData, TCurrentTarget, TTarget] (val x: Self with (DragLeaveEvent[TDelegateTarget, TData, TCurrentTarget, TTarget])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: dragleave): Self = this.set("type", value.asInstanceOf[js.Any])
  }
