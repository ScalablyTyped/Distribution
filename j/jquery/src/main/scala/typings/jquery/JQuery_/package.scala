...
package object JQuery_ {
  /**
    ...
    */
  type AnimationHook[TElement] = js.Function1[/* fx */ typings.jquery.JQuery_.Tween[TElement], scala.Unit]
  // #endregion
  // region CSS hooks
  // #region CSS hooks
  // Workaround for TypeScript 2.3 which does not have support for weak types handling.
  type CSSHook[TElement] = typings.std.Partial[typings.jquery.JQuery_._CSSHook[TElement]] with (typings.std.Pick[
    typings.jquery.JQuery_._CSSHook[TElement], 
  ...
  org.scalablytyped.runtime.StringDictionary[typings.jquery.JQuery_.CSSHook[typings.std.HTMLElement]]
  // #endregion
  // region Callbacks
  // #region Callbacks
  ...
  */
  type Duration = typings.jquery.JQuery_._Duration | scala.Double
  // #endregion
  // region Easing
  // #region Easing
  type EasingMethod = js.Function1[/* percent */ scala.Double, scala.Double]
  type Easings = org.scalablytyped.runtime.StringDictionary[typings.jquery.JQuery_.EasingMethod]
  type EventHandler[TCurrentTarget, TData] = typings.jquery.JQuery_.EventHandlerBase[
    TCurrentTarget, 
    typings.jquery.JQuery_.TriggeredEvent[TCurrentTarget, TData, js.Any, js.Any]
  ]
  ...
  */
  ...
  /**
    ...
    */
  type Promise[TR, TJ, TN] = typings.jquery.JQuery_.PromiseBase[TR, TJ, TN, TR, TJ, TN, TR, TJ, TN, TR, TJ, TN]
  /**
    * This object provides a subset of the methods of the Deferred object (then, done, fail, always, pipe, progress, state and promise) to prevent users from changing the state of the Deferred.
    * @see \`{@link https://api.jquery.com/Types/#Promise }\`
    */
  type Promise2[TR, TJ, TN, UR, UJ, UN] = typings.jquery.JQuery_.PromiseBase[
    TR, 
    TJ, 
    TN, 
    UR, 
  ...
  /**
    ...
    * @see \`{@link https://api.jquery.com/Types/#Promise }\`
    */
  type Promise3[TR, TJ, TN, UR, UJ, UN, VR, VJ, VN] = typings.jquery.JQuery_.PromiseBase[TR, TJ, TN, UR, UJ, UN, VR, VJ, VN, scala.Nothing, scala.Nothing, scala.Nothing]
  /**
  ...
  // Workaround for TypeScript 2.3 which does not have support for weak types handling.
  /* Rewritten from type alias, can be one of: 
    - typings.jquery.AnonGet[TElement]
    - typings.jquery.AnonSet[TElement]
    - org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  */
  type PropHook[TElement] = typings.jquery.JQuery_._PropHook[TElement] | org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  /**
    * @see \`{@link https://gist.github.com/gnarf/54829d408993526fe475#tween-hooks }\`
    * @since 1.8
    */
  ...
  */
  ...
  type SpecialEventHooks = org.scalablytyped.runtime.StringDictionary[typings.jquery.JQuery_.SpecialEventHook[typings.std.EventTarget, js.Any]]
  // #endregion
  // region Speed
  // #region Speed
  // Workaround for TypeScript 2.3 which does not have support for weak types handling.
  /* Rewritten from type alias, can be one of: 
    - typings.jquery.AnonDuration
    - typings.jquery.AnonEasing
    - typings.jquery.AnonComplete[TElement]
    - org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  */
  type SpeedSettings[TElement] = typings.jquery.JQuery_._SpeedSettings[TElement] | org.scalablytyped.runtime.StringDictionary[scala.Nothing]
  // #endregion
  // region Deferred
  // #region Deferred
  /**
