...
trait Anon_Default[TTarget, TData] extends js.Object {
  /**
           ...
           */
  def _default(event: jqueryLib.JQueryNs.Event[TTarget, TData], data: TData): scala.Unit | jqueryLib.jqueryLibNumbers.`false`
}
