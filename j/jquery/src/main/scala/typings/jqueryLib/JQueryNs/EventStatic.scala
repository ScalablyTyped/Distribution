...
org.scalablytyped.runtime.Instantiable1[/* event */ java.lang.String, Event with js.Object]
     with org.scalablytyped.runtime.Instantiable2[/* event */ java.lang.String, /* properties */ js.Object, Event with js.Object] {
  /**
    * The jQuery.Event constructor is exposed and can be used when calling trigger. The new operator is optional.
    *
    * Check \`{@link https://api.jquery.com/trigger/ trigger}\`'s documentation to see how to combine it with your own event object.
  ...
  ```
    */
  def apply[T /* <: js.Object */](event: java.lang.String): Event with T = js.native
  def apply[T /* <: js.Object */](event: java.lang.String, properties: T): Event with T = js.native
}
