...
trait Deferred[TR, TJ, TN] extends js.Object {
  ...
  ```
           */
  def always(
    alwaysCallback: TypeOrArray[jqueryLib.JQueryNs.DeferredNs.Callback[TR | TJ]],
    alwaysCallbacks: (TypeOrArray[jqueryLib.JQueryNs.DeferredNs.Callback[TR | TJ]])*
  ): this.type = js.native
  // #endregion
  /**
  ...
  ```
           */
  def done(
    doneCallback: TypeOrArray[jqueryLib.JQueryNs.DeferredNs.Callback[TR]],
    doneCallbacks: TypeOrArray[jqueryLib.JQueryNs.DeferredNs.Callback[TR]]*
  ): this.type = js.native
  /**
           * Add handlers to be called when the Deferred object is rejected.
  ...
  ```
           */
  def fail(
    failCallback: TypeOrArray[jqueryLib.JQueryNs.DeferredNs.Callback[TJ]],
    failCallbacks: TypeOrArray[jqueryLib.JQueryNs.DeferredNs.Callback[TJ]]*
  ): this.type = js.native
  /**
  ...
  /**
           ...
           */
  def progress(
    progressCallback: TypeOrArray[jqueryLib.JQueryNs.DeferredNs.Callback[TN]],
    progressCallbacks: TypeOrArray[jqueryLib.JQueryNs.DeferredNs.Callback[TN]]*
  ): this.type = js.native
  /**
