...
trait ClickEvent[TDelegateTarget, TData, TCurrentTarget, TTarget] extends MouseEventBase[TDelegateTarget, TData, TCurrentTarget, TTarget] {
  ...
  var relatedTarget_ClickEvent: js.UndefOr[scala.Null] = js.undefined
  @JSName("type")
  var type_ClickEvent: jqueryLib.jqueryLibStrings.click
}
...
object ClickEvent {
  ...
  def apply[TDelegateTarget, TData, TCurrentTarget, TTarget](
    ...
    `type`: jqueryLib.jqueryLibStrings.click,
    view: stdLib.Window,
    which: scala.Double,
