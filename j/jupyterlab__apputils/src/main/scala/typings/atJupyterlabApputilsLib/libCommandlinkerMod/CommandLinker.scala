package typings
package atJupyterlabApputilsLib.libCommandlinkerMod
...
class CommandLinker protected ()
  ...
  /**
    ...
    */
  def this(options: atJupyterlabApputilsLib.libCommandlinkerMod.CommandLinkerNs.IOptions) = this()
  ...
  /**
    ...
    */
  def connectNode(node: stdLib.HTMLElement, command: java.lang.String): stdLib.HTMLElement = js.native
  def connectNode(
    node: stdLib.HTMLElement,
    command: java.lang.String,
    args: atPhosphorCoreutilsLib.libJsonMod.JSONObject
  ...
  /**
    ...
    */
  def disconnectNode(node: stdLib.HTMLElement): stdLib.HTMLElement = js.native
  /**
  ...
  /**
    ...
    * ```
    */
  def populateVNodeDataset(command: java.lang.String): atPhosphorVirtualdomLib.atPhosphorVirtualdomMod.ElementDataset = js.native
  def populateVNodeDataset(command: java.lang.String, args: atPhosphorCoreutilsLib.libJsonMod.JSONObject): atPhosphorVirtualdomLib.atPhosphorVirtualdomMod.ElementDataset = js.native
}
