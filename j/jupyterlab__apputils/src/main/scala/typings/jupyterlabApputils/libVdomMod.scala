...
object libVdomMod {
  ...
  /* note: abstract class */ @JSImport("@jupyterlab/apputils/lib/vdom", "ReactWidget")
  @js.native
  /**
    ...
    */
  open class ReactWidget () extends Widget {
  ...
  /* note: abstract class */ @JSImport("@jupyterlab/apputils/lib/vdom", "VDomRenderer")
  @js.native
  open class VDomRenderer[T /* <: IModel | Null */] protected () extends ReactWidget {
    /**
