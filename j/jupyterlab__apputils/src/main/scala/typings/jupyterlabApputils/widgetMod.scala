...
object widgetMod {
  ...
  object ToolbarButtonComponent {
    ...
    inline def apply(props: typings.jupyterlabApputils.widgetMod.ToolbarButtonComponent.IProps): Element = ^.asInstanceOf[js.Dynamic].apply(props.asInstanceOf[js.Any]).asInstanceOf[Element]
    ...
    object IProps {
      ...
      inline def apply(): typings.jupyterlabApputils.widgetMod.ToolbarButtonComponent.IProps = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typings.jupyterlabApputils.widgetMod.ToolbarButtonComponent.IProps]
      }
      
      extension [Self <: typings.jupyterlabApputils.widgetMod.ToolbarButtonComponent.IProps](x: Self) {
