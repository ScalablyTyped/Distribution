...
import typings.jupyterlabApputils.tokensMod.ISanitizer.IOptions
...
object tokensMod {
  ...
  object ToolbarRegistry {
    ...
    object IOptions {
      ...
      inline def apply(defaultFactory: (String, Widget, IWidget) => Widget): typings.jupyterlabApputils.tokensMod.ToolbarRegistry.IOptions = {
        val __obj = js.Dynamic.literal(defaultFactory = js.Any.fromFunction3(defaultFactory))
        __obj.asInstanceOf[typings.jupyterlabApputils.tokensMod.ToolbarRegistry.IOptions]
      }
      
      extension [Self <: typings.jupyterlabApputils.tokensMod.ToolbarRegistry.IOptions](x: Self) {
    ...
    /**
      ...
      */
    type IWidget = typings.jupyterlabSettingregistry.tokensMod.ISettingRegistry.IToolbarItem
  }
}
