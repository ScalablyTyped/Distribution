...
object libToolbarMod {
  ...
  open class CommandToolbarButton protected ()
    extends typings.jupyterlabApputils.libToolbarWidgetMod.CommandToolbarButton {
    /**
  ...
  open class ReactiveToolbar ()
    extends typings.jupyterlabApputils.libToolbarWidgetMod.ReactiveToolbar
  ...
  open class Toolbar[T /* <: Widget */] ()
    extends typings.jupyterlabApputils.libToolbarWidgetMod.Toolbar[T] {
  ...
  open class ToolbarButton ()
    extends typings.jupyterlabApputils.libToolbarWidgetMod.ToolbarButton {
  ...
  open class ToolbarWidgetRegistry protected ()
    extends typings.jupyterlabApputils.libToolbarRegistryMod.ToolbarWidgetRegistry {
