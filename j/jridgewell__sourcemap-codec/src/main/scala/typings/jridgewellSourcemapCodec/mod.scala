...
import typings.jridgewellSourcemapCodec.anon.ReadonlySourceMapMappings
...
object mod {
  ...
  inline def encode(decoded: ReadonlySourceMapMappings): String = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(decoded.asInstanceOf[js.Any]).asInstanceOf[String]
