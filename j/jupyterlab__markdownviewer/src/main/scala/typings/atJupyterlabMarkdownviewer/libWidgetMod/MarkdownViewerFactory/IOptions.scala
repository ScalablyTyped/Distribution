...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify DocumentRegistry.IWidgetFactoryOptions * / any */ trait IOptions extends js.Object {
  /**
