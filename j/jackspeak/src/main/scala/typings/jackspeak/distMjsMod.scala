...
import typings.jackspeak.anon.Hint
import typings.jackspeak.anon.Multiple
import typings.jackspeak.anon.Pre
import typings.jackspeak.anon.Short
...
object distMjsMod {
  ...
  @JSImport("jackspeak/dist/mjs", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("jackspeak/dist/mjs", "Jack")
  @js.native
  open class Jack_[C /* <: ConfigSet */] () extends StObject {
    ...
    /**
      ...
      */
    def toJSON(): StringDictionary[Multiple] = js.native
    ...
    /**
      ...
      */
    def validate(o: Any): /* asserts o is TsTypeRef(NoComments,TsQIdent(IArray(TsIdentLibrarySimple(jackspeak), TsIdentModule(None,List(jackspeak, dist, mjs)), TsIdentSimple(OptionsResults))),IArray(TsTypeRef(NoComments,TsQIdent(IArray(TsIdentSimple(C))),IArray())))*/ Boolean = js.native
  }
  
  inline def isConfigOption[T /* <: ConfigType */, M /* <: Boolean */](o: Any, `type`: T, multi: M): /* is jackspeak.jackspeak/dist/mjs.ConfigOptionBase<T, M> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isConfigOption")(o.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], multi.asInstanceOf[js.Any])).asInstanceOf[/* is jackspeak.jackspeak/dist/mjs.ConfigOptionBase<T, M> */ Boolean]
  
  inline def isConfigType(t: String): /* is jackspeak.jackspeak/dist/mjs.ConfigType */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isConfigType")(t.asInstanceOf[js.Any]).asInstanceOf[/* is jackspeak.jackspeak/dist/mjs.ConfigType */ Boolean]
  ...
  type ConfigOptionBase[T /* <: ConfigType */, M /* <: Boolean */] = (Hint[T, M]) & MultiType[M]
  
  type ConfigOptionMeta[T /* <: ConfigType */, M /* <: Boolean */] = (Short[T, M]) & (/* import warning: importer.ImportType#apply Failed type conversion: T extends 'boolean' ? {} : {  hint :string | undefined} */ js.Any)
  ...
  /** NOTE: Mapped type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    {[ longOption in keyof S ]: jackspeak.jackspeak/dist/mjs.ConfigOptionBase<T, M>}
    }}}
    */
  @js.native
  ...
  */
  ...
  /** NOTE: Mapped type definitions are impossible to translate to Scala.
    ...
    * You'll have to cast your way around this structure, unfortunately. 
    * TS definition: {{{
    {[ k in keyof T ]:? T[k] extends jackspeak.jackspeak/dist/mjs.ConfigOptionBase<'string', false>? string : T[k] extends jackspeak.jackspeak/dist/mjs.ConfigOptionBase<'string', true>? std.Array<string> : T[k] extends jackspeak.jackspeak/dist/mjs.ConfigOptionBase<'number', false>? number : T[k] extends jackspeak.jackspeak/dist/mjs.ConfigOptionBase<'number', true>? std.Array<number> : T[k] extends jackspeak.jackspeak/dist/mjs.ConfigOptionBase<'boolean', false>? boolean : T[k] extends jackspeak.jackspeak/dist/mjs.ConfigOptionBase<'boolean', true>? std.Array<boolean> : never}
    }}}
    */
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.jackspeak.distMjsMod.Heading
    - typings.jackspeak.distMjsMod.Description
  */
  trait TextRow
    extends StObject
       with UsageField
  object TextRow {
    ...
    inline def Description(text: String): typings.jackspeak.distMjsMod.Description = {
      val __obj = js.Dynamic.literal(text = text.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("description")
      __obj.asInstanceOf[typings.jackspeak.distMjsMod.Description]
    }
    
    inline def Heading(level: Double, text: String): typings.jackspeak.distMjsMod.Heading = {
      val __obj = js.Dynamic.literal(level = level.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("heading")
      __obj.asInstanceOf[typings.jackspeak.distMjsMod.Heading]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.jackspeak.distMjsMod.TextRow
    - typings.jackspeak.anon.Type
  */
  ...
  object UsageField {
    ...
    inline def Type(name: String, value: ConfigOptionBase[ConfigType, Boolean]): typings.jackspeak.anon.Type = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("config")
      __obj.asInstanceOf[typings.jackspeak.anon.Type]
    }
  }
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    [T, M] extends ['number', true] ? std.Array<number> : [T, M] extends ['string', true] ? std.Array<string> : [T, M] extends ['boolean', true] ? std.Array<boolean> : [T, M] extends ['number', false] ? number : [T, M] extends ['string', false] ? string : [T, M] extends ['boolean', false] ? boolean : [T, M] extends ['string', boolean] ? string | std.Array<string> : [T, M] extends ['boolean', boolean] ? boolean | std.Array<boolean> : [T, M] extends ['number', boolean] ? number | std.Array<number> : [T, M] extends [jackspeak.jackspeak/dist/mjs.ConfigType, false] ? string | number | boolean : [T, M] extends [jackspeak.jackspeak/dist/mjs.ConfigType, true] ? std.Array<string> | std.Array<number> | std.Array<boolean> : string | number | boolean | std.Array<string> | std.Array<number> | std.Array<boolean>
    }}}
    */
