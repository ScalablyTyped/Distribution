...
trait jsPDF extends js.Object {
  ...
  def setDrawColor(ch1: String, ch2: Double): jsPDF = js.native
  def setDrawColor(ch1: String, ch2: Double, ch3: Double): jsPDF = js.native
  def setDrawColor(ch1: String, ch2: Double, ch3: Double, ch4: Double): jsPDF = js.native
  def setDrawColor(ch1: Double): jsPDF = js.native
  def setDrawColor(ch1: Double, ch2: Double): jsPDF = js.native
  ...
  def setFillColor(ch1: String, ch2: Double): jsPDF = js.native
  def setFillColor(ch1: String, ch2: Double, ch3: Double): jsPDF = js.native
  def setFillColor(ch1: String, ch2: Double, ch3: Double, ch4: Double): jsPDF = js.native
  def setFillColor(ch1: Double): jsPDF = js.native
  def setFillColor(ch1: Double, ch2: Double): jsPDF = js.native
  ...
  def setTextColor(r: Double): jsPDF = js.native
  def setTextColor(r: Double, g: Double): jsPDF = js.native
  def setTextColor(r: Double, g: Double, b: Double): jsPDF = js.native
