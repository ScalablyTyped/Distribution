    ...
    */
    ...
    trait IItem extends StObject {
      ...
      /**
        ...
        */
      var activeStateChanged: js.UndefOr[ISignal[js.Any, Unit]] = js.undefined
    ...
    object IItem {
      ...
      extension [Self <: IItem](x: Self) {
        ...
        inline def setActiveStateChanged(value: ISignal[js.Any, Unit]): Self = StObject.set(x, "activeStateChanged", value.asInstanceOf[js.Any])
