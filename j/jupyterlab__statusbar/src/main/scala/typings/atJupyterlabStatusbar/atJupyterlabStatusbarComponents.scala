...
object atJupyterlabStatusbarComponents extends atJupyterlabStatusbarProps {
  ...
  def TextItem: ComponentType[
    typings.atJupyterlabStatusbar.libComponentsTextMod.TextItemNs.IProps with HTMLAttributes[HTMLSpanElement]
  ] = typings.atJupyterlabStatusbar.libComponentsMod.^.asInstanceOf[js.Dynamic].selectDynamic("TextItem").asInstanceOf[typings.react.reactMod.ComponentType[
  typings.atJupyterlabStatusbar.libComponentsTextMod.TextItemNs.IProps with typings.react.reactMod.HTMLAttributes[typings.std.HTMLSpanElement]]]
}
