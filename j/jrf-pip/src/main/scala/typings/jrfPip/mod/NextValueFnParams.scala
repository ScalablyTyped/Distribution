...
@js.native
trait NextValueFnParams[T] extends js.Object {
...
object NextValueFnParams {
  ...
  @scala.inline
  implicit class NextValueFnParamsOps[Self <: NextValueFnParams[_], T] (val x: Self with NextValueFnParams[T]) extends AnyVal {
