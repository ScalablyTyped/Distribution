...
object JsonRpcClientOptions {
  ...
  def apply(
    ...
    getSockect: js.Function1[/* onmessageCb */ js.Function0[scala.Unit], stdLib.WebSocket] = null,
    ...
    onclose: js.Function1[/* ev */ stdLib.CloseEvent, scala.Unit] = null,
    onerror: js.Function1[/* ev */ stdLib.Event, scala.Unit] = null,
    onmessage: js.Function1[/* ev */ stdLib.MessageEvent, scala.Unit] = null,
    onopen: js.Function1[/* ev */ stdLib.Event, scala.Unit] = null,
    ...
    if (getSockect != null) __obj.updateDynamic("getSockect")(getSockect)
