...
trait JsonRpcClient extends js.Object {
  /**
      ...
      */
  def batch(
    callback: js.Function1[/* batch */ this.type, scala.Unit],
    allDoneCb: js.Function1[/* result */ js.Any, scala.Unit],
    errorCb: js.Function1[/* error */ js.Any, scala.Unit]
  ...
  ): jqueryLib.JQueryDeferred[jqueryLib.JQueryXHR] = js.native
  /**
      * @fn call
      * @memberof JsonRpcClient
      *
  ...
  /**
      ...
      * @return {object} Returns the deferred object that $.ajax returns or {null} for websockets
      */
  def notify(method: java.lang.String, params: js.Array[_]): jqueryLib.JQueryDeferred[jqueryLib.JQueryXHR] = js.native
  /**
      * Notify sends a command to the server that won't need a response.  In http, there is probably
      * an empty response - that will be dropped, but in ws there should be no response at all.
      *
      ...
      * @return {object} Returns the deferred object that $.ajax returns or {null} for websockets
      */
  def notify(method: java.lang.String, params: js.Object): jqueryLib.JQueryDeferred[jqueryLib.JQueryXHR] = js.native
}
