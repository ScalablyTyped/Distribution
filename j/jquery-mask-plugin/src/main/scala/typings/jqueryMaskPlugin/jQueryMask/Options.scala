...
object Options {
  ...
  def apply(
    ...
    watchInterval: js.UndefOr[Double] = js.undefined
  ): Options = {
    val __obj = js.Dynamic.literal()
    if (byPassKeys != null) __obj.updateDynamic("byPassKeys")(byPassKeys.asInstanceOf[js.Any])
    if (!js.isUndefined(clearIfNotMatch)) __obj.updateDynamic("clearIfNotMatch")(clearIfNotMatch.get.asInstanceOf[js.Any])
    if (!js.isUndefined(dataMask)) __obj.updateDynamic("dataMask")(dataMask.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(watchDataMask)) __obj.updateDynamic("watchDataMask")(watchDataMask.get.asInstanceOf[js.Any])
    if (!js.isUndefined(watchInputs)) __obj.updateDynamic("watchInputs")(watchInputs.get.asInstanceOf[js.Any])
    if (!js.isUndefined(watchInterval)) __obj.updateDynamic("watchInterval")(watchInterval.get.asInstanceOf[js.Any])
