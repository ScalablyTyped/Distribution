  ...
  object IOutputAreaModel {
    ...
    object IContentFactory {
      ...
      implicit class IContentFactoryMutableBuilder[Self <: IContentFactory] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setCreateOutputModel(value: typings.jupyterlabRendermime.outputmodelMod.IOutputModel.IOptions => IOutputModel): Self = StObject.set(x, "createOutputModel", js.Any.fromFunction1(value))
      }
    }
