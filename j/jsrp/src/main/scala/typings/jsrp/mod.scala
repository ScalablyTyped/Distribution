...
object mod {
  ...
  class client () extends StObject {
    ...
    /**
      ...
      */
    def createVerifier(callback: js.Function2[/* error */ js.Any, /* result */ Verifier, js.Any]): Unit = js.native
    ...
    /**
      ...
      */
    def init(options: ClientOptions, callback: js.Function0[js.Any]): Unit = js.native
  ...
  class server () extends StObject {
    ...
    /**
      ...
      */
    def init(options: ServerOptions, callback: js.Function0[js.Any]): Unit = js.native
