package typings.jestConfig.normalizeMod

import org.scalablytyped.runtime.StringDictionary
import typings.jestConfig.jestConfigStrings.`json-summary`
import typings.jestConfig.jestConfigStrings.`text-lcov`
import typings.jestConfig.jestConfigStrings.`text-summary`
import typings.jestConfig.jestConfigStrings.clover
import typings.jestConfig.jestConfigStrings.cobertura
import typings.jestConfig.jestConfigStrings.fake
import typings.jestConfig.jestConfigStrings.html
import typings.jestConfig.jestConfigStrings.json_
import typings.jestConfig.jestConfigStrings.lcovonly
import typings.jestConfig.jestConfigStrings.none
import typings.jestConfig.jestConfigStrings.real
import typings.jestConfig.jestConfigStrings.teamcity
import typings.jestConfig.jestConfigStrings.text
import typings.jestTypes.AnonConfig
import typings.jestTypes.configMod.ConfigGlobals
import typings.jestTypes.configMod.CoverageThreshold
