...
object NodeData {
  ...
  def apply(
    ...
    if (!js.isUndefined(folder)) __obj.updateDynamic("folder")(folder.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(unselectableIgnore)) __obj.updateDynamic("unselectableIgnore")(unselectableIgnore.asInstanceOf[js.Any])
    if (!js.isUndefined(unselectableStatus)) __obj.updateDynamic("unselectableStatus")(unselectableStatus.asInstanceOf[js.Any])
