...
import typings.jqueryDotFancytree.FancytreeNs.ExtensionsNs.DragAndDrop5
import typings.jqueryDotFancytree.FancytreeNs.ExtensionsNs.Filter
import typings.jqueryDotFancytree.FancytreeNs.ExtensionsNs.Table
...
import typings.jqueryui.JQueryUINs.EffectOptions
