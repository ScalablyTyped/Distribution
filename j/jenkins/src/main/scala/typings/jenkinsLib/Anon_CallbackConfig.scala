...
trait Anon_CallbackConfig extends js.Object {
  ...
  def create(name: java.lang.String, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  def disconnect(name: java.lang.String, callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  def disconnect(
    name: java.lang.String,
    message: java.lang.String,
    callback: js.Function1[/* err */ stdLib.Error, scala.Unit]
  ...
  def exists(
    name: java.lang.String,
    callback: js.Function2[/* err */ stdLib.Error, /* data */ scala.Boolean, scala.Unit]
  ): scala.Unit = js.native
  def get(
    name: java.lang.String,
    callback: js.Function2[/* err */ stdLib.Error, /* data */ js.Any, scala.Unit]
  ...
  def list(full: scala.Boolean, callback: js.Function2[/* err */ stdLib.Error, /* data */ js.Any, scala.Unit]): scala.Unit = js.native
}
