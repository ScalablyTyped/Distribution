...
import typings.jupyterlabCoreutils.interfacesMod.IPoll._Phase
import typings.jupyterlabCoreutils.nbformatMod.nbformat.CellType
import typings.jupyterlabCoreutils.nbformatMod.nbformat.OutputType
import typings.jupyterlabCoreutils.nbformatMod.nbformat.StreamType
import typings.jupyterlabCoreutils.pollMod.Poll.Standby
import typings.jupyterlabCoreutils.tokensMod.ISettingRegistry.IPlugin.Phase
import typings.jupyterlabCoreutils.tokensMod.ISettingRegistry.Primitive
...
object jupyterlabCoreutilsStrings {
  ...
  @js.native
  sealed trait SettingRegistry extends js.Object
  ...
  @scala.inline
  def SettingRegistry: SettingRegistry = "SettingRegistry".asInstanceOf[SettingRegistry]
  @scala.inline
