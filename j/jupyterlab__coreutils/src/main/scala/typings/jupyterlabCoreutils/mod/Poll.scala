...
import typings.jupyterlabCoreutils.jupyterlabCoreutilsNumbers.`0`
import typings.jupyterlabCoreutils.jupyterlabCoreutilsNumbers.`2147483647`
import typings.jupyterlabCoreutils.pollMod.Poll.IOptions
...
class Poll[T, U, V /* <: String */] protected ()
  extends typings.jupyterlabCoreutils.pollMod.Poll[T, U, V] {
  /**
