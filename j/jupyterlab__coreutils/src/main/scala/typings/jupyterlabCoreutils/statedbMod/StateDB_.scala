package typings.jupyterlabCoreutils.statedbMod

import typings.jupyterlabCoreutils.AnonIdsValues
import typings.jupyterlabCoreutils.statedbMod.StateDB.Change
...
class StateDB_[T /* <: ReadonlyJSONValue */] () extends IStateDB[T] {
  ...
  /**
    ...
    */
  def list(namespace: String): js.Promise[AnonIdsValues[T]] = js.native
}
