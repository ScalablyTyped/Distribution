...
import typings.jupyterlabCoreutils.AnonCompositeUser
import typings.jupyterlabCoreutils.settingregistryMod.ISchemaValidator.IError
import typings.jupyterlabCoreutils.settingregistryMod.Settings.IOptions
...
class Settings_ protected () extends ISettings {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def get(key: String): AnonCompositeUser = js.native
  /**
