...
trait ISchema extends IProperty {
  /**
    ...
    */
  var `jupyter.lab.setting-deprecated`: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    * out and reject.
    */
  var `jupyter.lab.transform`: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * The root schema is always an object.
    */
  @JSName("type")
  var type_ISchema: atJupyterlabCoreutilsLib.atJupyterlabCoreutilsLibStrings.`object`
}

object ISchema {
  @scala.inline
  def apply(
    `type`: atJupyterlabCoreutilsLib.atJupyterlabCoreutilsLibStrings.`object`,
    default: js.Any = null,
    description: java.lang.String = null,
    `jupyter.lab.setting-deprecated`: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    `jupyter.lab.transform`: js.UndefOr[scala.Boolean] = js.undefined,
