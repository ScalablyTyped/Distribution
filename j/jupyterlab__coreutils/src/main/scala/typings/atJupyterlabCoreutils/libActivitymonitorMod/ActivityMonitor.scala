package typings.atJupyterlabCoreutils.libActivitymonitorMod

import typings.atJupyterlabCoreutils.libActivitymonitorMod.ActivityMonitorNs.IArguments
import typings.atJupyterlabCoreutils.libActivitymonitorMod.ActivityMonitorNs.IOptions
