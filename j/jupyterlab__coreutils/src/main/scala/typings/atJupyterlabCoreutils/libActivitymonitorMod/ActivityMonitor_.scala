...
import typings.atJupyterlabCoreutils.libActivitymonitorMod.ActivityMonitor.IArguments
import typings.atJupyterlabCoreutils.libActivitymonitorMod.ActivityMonitor.IOptions
