...
import typings.atJupyterlabCoreutils.libInterfacesMod.IRestorableNs.IOptions
import typings.atPhosphorDisposable.atPhosphorDisposableMod.IObservableDisposable
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait IRestorer[T /* <: IRestorable[U, _] */, U /* <: IObservableDisposable */, V] extends js.Object {
  /**
...
object IRestorer {
  @scala.inline
  def apply[T /* <: IRestorable[U, _] */, U /* <: IObservableDisposable */, V](restore: (T, IOptions[U]) => js.Promise[V], restored: js.Promise[V]): IRestorer[T, U, V] = {
