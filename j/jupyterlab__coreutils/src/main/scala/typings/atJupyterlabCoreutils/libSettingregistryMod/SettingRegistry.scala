...
import typings.atJupyterlabCoreutils.libSettingregistryMod.SettingRegistryNs.IOptions
...
import typings.atJupyterlabCoreutils.libTokensMod.ISettingRegistryNs.ISettings
...
class SettingRegistry protected () extends ISettingRegistry {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def get(plugin: String, key: String): js.Promise[Anon_Composite] = js.native
  /**
