...
object array extends js.Object {
  def apply(className: java.lang.String, value: js.Array[_]): js.Object = js.native
  def BigDecimal(`val`: js.Array[java.lang.String]): js.Object = js.native
  def Boolean(value: js.Array[scala.Boolean]): js.Object = js.native
  def Byte(value: js.Array[scala.Double]): js.Object = js.native
  ...
  def Currency(value: js.Array[typings.jsDashToDashJava.jsDashToDashJavaMod.Currency | Null | java.lang.String]): js.Object = js.native
  ...
  def Float(value: js.Array[scala.Double]): js.Object = js.native
  def HashMap(value: js.Array[js.Object]): js.Object = js.native
  def Integer(value: js.Array[scala.Double]): js.Object = js.native
  def Iterator(value: js.Array[js.Object]): js.Object = js.native
  def List[T](value: js.Array[T]): js.Object = js.native
  def Locale(locale: js.Array[java.lang.String], handle: java.lang.String): js.Object = js.native
  def Long(value: js.Array[scala.Double]): js.Object = js.native
  def Map(value: js.Array[js.Object]): js.Object = js.native
  def Set(value: js.Array[js.Object]): js.Object = js.native
  def Short(value: js.Array[scala.Double]): js.Object = js.native
  def String(value: js.Array[java.lang.String]): js.Object = js.native
  def boolean(value: js.Array[scala.Boolean]): js.Object = js.native
  def byte(value: js.Array[scala.Double]): js.Object = js.native
  def char(value: js.Array[java.lang.String]): js.Object = js.native
  def chars(value: js.Array[java.lang.String]): js.Object = js.native
  def double(value: js.Array[scala.Double]): js.Object = js.native
  def float(value: js.Array[scala.Double]): js.Object = js.native
  def int(value: js.Array[scala.Double]): js.Object = js.native
  def long(value: js.Array[scala.Double]): js.Object = js.native
  def short(value: js.Array[scala.Double]): js.Object = js.native
}
