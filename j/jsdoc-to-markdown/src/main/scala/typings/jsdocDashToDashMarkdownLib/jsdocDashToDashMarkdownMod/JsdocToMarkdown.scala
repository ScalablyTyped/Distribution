...
class JsdocToMarkdown () extends js.Object {
  ...
  def render(options: JsdocOptions): js.Promise[java.lang.String] = js.native
  /**
    * Returns markdown documentation from jsdoc-annoted source code.
    */
  def render(options: RenderOptions): js.Promise[java.lang.String] = js.native
  def renderSync(options: JsdocOptions): java.lang.String = js.native
  /**
    * Sync version of render.
    */
  def renderSync(options: RenderOptions): java.lang.String = js.native
}
