...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-changed-files" % "24.9.0-9b4f6a",
  ...
  "org.scalablytyped" %%% "prompts" % "2.0-dt-20191106Z-5a0386",
