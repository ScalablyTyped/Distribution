...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-changed-files" % "24.9.0-91f86a",
  ...
  "org.scalablytyped" %%% "prompts" % "2.0-dt-20191106Z-d45236",
