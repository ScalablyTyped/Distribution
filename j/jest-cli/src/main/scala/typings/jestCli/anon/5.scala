...
trait `5` extends js.Object {
  val description: `Generate a basic configuration file` = js.native
...
object `5` {
  ...
  implicit class `5Ops`[Self <: `5`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDescription(value: `Generate a basic configuration file`): Self = this.set("description", value.asInstanceOf[js.Any])
    @scala.inline
