...
trait AnonAliasDefaultDescriptionType extends js.Object {
  val alias: f
...
object AnonAliasDefaultDescriptionType {
  @scala.inline
  def apply(
    alias: f,
    description: `Run tests that failed in the previous executionDot`,
    `type`: boolean,
    default: js.UndefOr[scala.Nothing] = js.undefined
  ): AnonAliasDefaultDescriptionType = {
    ...
    __obj.asInstanceOf[AnonAliasDefaultDescriptionType]
  }
}
