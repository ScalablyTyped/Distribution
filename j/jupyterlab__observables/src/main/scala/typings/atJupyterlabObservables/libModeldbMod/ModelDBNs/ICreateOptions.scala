package typings.atJupyterlabObservables.libModeldbMod.ModelDBNs

import typings.atJupyterlabObservables.libModeldbMod.ModelDB
...
object ICreateOptions {
  @scala.inline
  def apply(baseDB: ModelDB = null, basePath: String = null): ICreateOptions = {
