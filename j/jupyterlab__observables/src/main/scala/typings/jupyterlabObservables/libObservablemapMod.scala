...
import typings.jupyterlabObservables.libObservablemapMod.ObservableMap.IOptions
...
object libObservablemapMod {
  ...
  object IObservableMap {
    ...
    */
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: IObservableMap[?], T] (val x: Self & IObservableMap[T]) extends AnyVal {
