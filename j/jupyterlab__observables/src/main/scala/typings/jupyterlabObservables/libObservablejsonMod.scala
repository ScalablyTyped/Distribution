...
import typings.jupyterlabObservables.libObservablemapMod.ObservableMap
...
object libObservablejsonMod {
  ...
  object IObservableJSON {
    ...
    inline def apply(
      changed: ISignal[
          IObservableJSON, 
          typings.jupyterlabObservables.libObservablemapMod.IObservableMap.IChangedArgs[js.UndefOr[ReadonlyPartialJSONValue]]
        ],
      clear: () => Unit,
