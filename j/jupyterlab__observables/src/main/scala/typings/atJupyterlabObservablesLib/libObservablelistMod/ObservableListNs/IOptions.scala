package typings
package atJupyterlabObservablesLib.libObservablelistMod.ObservableListNs
...
trait IOptions[T] extends js.Object {
  ...
  /**
    ...
    */
  var values: js.UndefOr[atPhosphorAlgorithmLib.libIterMod.IterableOrArrayLike[T]] = js.undefined
}
...
object IOptions {
  ...
  def apply[T](
    ...
    values: atPhosphorAlgorithmLib.libIterMod.IterableOrArrayLike[T] = null
  ): IOptions[T] = {
