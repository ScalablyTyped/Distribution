...
import typings.jestJasmine2.jestJasmine2Strings.finished
...
trait Suite extends js.Object {
  ...
  var children: js.Array[Suite | typings.jestJasmine2.specMod.default] = js.native
  ...
  def addChild(child: typings.jestJasmine2.specMod.default): Unit = js.native
  ...
  def onException(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<Spec['onException']> is not an array type */ args: Parameters[
      js.Function1[
        /* error */ typings.jestJasmine2.expectationFailedMod.default | AssertionErrorWithStack, 
        Unit
      ]
    ]
  ): Unit = js.native
