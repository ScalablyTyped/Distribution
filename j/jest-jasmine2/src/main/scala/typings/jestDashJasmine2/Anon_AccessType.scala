...
import typings.jestDashJasmine2.buildJasmineSuiteMod.default
...
trait Anon_AccessType extends js.Object {
  ...
  def it(
    description: String,
    fn: js.Function1[/* done */ js.Function1[/* error */ js.UndefOr[js.Any], Unit], Unit]
  ): typings.jestDashJasmine2.buildJasmineSpecMod.default = js.native
  def it(
    description: String,
    fn: js.Function1[/* done */ js.Function1[/* error */ js.UndefOr[js.Any], Unit], Unit],
    timeout: Double
  ...
  def specFilter(spec: typings.jestDashJasmine2.buildJasmineSpecMod.default): Boolean = js.native
  ...
  def todo(): typings.jestDashJasmine2.buildJasmineSpecMod.default = js.native
