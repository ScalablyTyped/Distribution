...
trait Anon_AddMatchers extends js.Object {
  ...
  var Env: ReturnType[
    js.Function1[
      /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt $anonfun#applyOrElse Simplified recursive type alias jest-jasmine2.jest-jasmine2/build/types.Jasmine */ /* j$ */ js.Object, 
      Anon_Options
    ]
  ] = js.native
