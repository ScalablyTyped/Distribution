...
object searchproviderMod {
  ...
  class CSVSearchProvider ()
    extends StObject
       with ISearchProvider[CSVDocumentWidget] {
  ...
  object CSVSearchProvider {
    ...
    /**
      ...
      */
    inline def canSearchOn(domain: Widget): /* is @jupyterlab/csvviewer-extension.@jupyterlab/csvviewer-extension/lib/searchprovider.CSVDocumentWidget */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("canSearchOn")(domain.asInstanceOf[js.Any]).asInstanceOf[/* is @jupyterlab/csvviewer-extension.@jupyterlab/csvviewer-extension/lib/searchprovider.CSVDocumentWidget */ Boolean]
  }
