...
object IModelFactory {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(codeCellContentFactory = codeCellContentFactory, createCodeCell = js.Any.fromFunction1(createCodeCell), createRawCell = js.Any.fromFunction1(createRawCell))
