...
import typings.atJupyterlabConsole.libPanelMod.ConsolePanelNs.IContentFactory
import typings.atJupyterlabConsole.libPanelMod.ConsolePanelNs.IOptions
...
@js.native
class ConsolePanel protected () extends Panel {
  /**
