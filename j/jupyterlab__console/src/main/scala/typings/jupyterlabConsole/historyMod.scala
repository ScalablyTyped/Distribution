...
object historyMod {
  ...
  class ConsoleHistory protected ()
    ...
    /* private */ var _filtered: js.Any = js.native
    
    /**
      * Handle the current kernel changing.
      */
    /* private */ var _handleKernel: js.Any = js.native
    
    /* private */ var _hasSession: js.Any = js.native
    ...
    /* private */ var _setByHistory: js.Any = js.native
