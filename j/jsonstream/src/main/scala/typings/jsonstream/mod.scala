...
object mod {
  ...
  inline def parse(pattern: js.Any): ReadWriteStream = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(pattern.asInstanceOf[js.Any]).asInstanceOf[ReadWriteStream]
  inline def parse(patterns: js.Array[js.Any]): ReadWriteStream = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(patterns.asInstanceOf[js.Any]).asInstanceOf[ReadWriteStream]
