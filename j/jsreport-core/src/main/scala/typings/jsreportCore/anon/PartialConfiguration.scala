...
object PartialConfiguration {
  ...
  def apply(
    ...
    scripts: AllowedModules = null,
    tasks: PartialallowedModulesArra = null,
    tempDirectory: String = null
  ): PartialConfiguration = {
    val __obj = js.Dynamic.literal()
    if (!js.isUndefined(autoTempCleanup)) __obj.updateDynamic("autoTempCleanup")(autoTempCleanup.get.asInstanceOf[js.Any])
    if (dataDirectory != null) __obj.updateDynamic("dataDirectory")(dataDirectory.asInstanceOf[js.Any])
    if (!js.isUndefined(extensionsLocationCache)) __obj.updateDynamic("extensionsLocationCache")(extensionsLocationCache.get.asInstanceOf[js.Any])
    if (!js.isUndefined(loadConfig)) __obj.updateDynamic("loadConfig")(loadConfig.get.asInstanceOf[js.Any])
