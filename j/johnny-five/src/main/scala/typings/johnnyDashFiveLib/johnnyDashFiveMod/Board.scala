...
class Board () extends js.Object {
  ...
  def analogRead(pin: java.lang.String, cb: js.Function1[/* item */ scala.Double, scala.Unit]): scala.Unit = js.native
  def analogRead(pin: scala.Double, cb: js.Function1[/* item */ scala.Double, scala.Unit]): scala.Unit = js.native
  def analogWrite(pin: java.lang.String, value: scala.Double): scala.Unit = js.native
  def analogWrite(pin: scala.Double, value: scala.Double): scala.Unit = js.native
  def digitalRead(pin: java.lang.String, cb: js.Function1[/* item */ scala.Double, scala.Unit]): scala.Unit = js.native
  def digitalRead(pin: scala.Double, cb: js.Function1[/* item */ scala.Double, scala.Unit]): scala.Unit = js.native
  def digitalWrite(pin: java.lang.String, value: scala.Double): scala.Unit = js.native
  ...
  def pinMode(pin: java.lang.String, mode: scala.Double): scala.Unit = js.native
  ...
  def servoWrite(pin: java.lang.String, angle: scala.Double): scala.Unit = js.native
