...
trait OrientationOption extends StObject {
...
object OrientationOption {
  
  inline def apply(): OrientationOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OrientationOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OrientationOption] (val x: Self) extends AnyVal {
