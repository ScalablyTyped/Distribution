...
trait OnoConstructor
  ...
  def extend[P /* <: js.Object */](error: Error, props: P): Error with P with (OnoError[Error with P]) = js.native
  ...
  @JSName("extend")
  def extend_E_ErrorLike[E /* <: ErrorLike */](error: Error, originalError: E): Error with E with (OnoError[Error with E]) = js.native
  @JSName("extend")
