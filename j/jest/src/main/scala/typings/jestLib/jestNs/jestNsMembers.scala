...
object jestNsMembers extends js.Object {
  ...
  /**
       ...
       * });
       */
  def spyOn[T /* <: js.Object */, M /* <: java.lang.String */](`object`: T, method: M): SpyInstance[
  ...
  /**
       ...
       */
  @JSName("spyOn")
  def spyOn_get[T /* <: js.Object */, M /* <: java.lang.String */](`object`: T, method: M, accessType: jestLib.jestLibStrings.get): SpyInstance[
    /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(M))) */js.Any
  ] = js.native
  /**
       * Creates a mock function similar to jest.fn but also tracks calls to `object[methodName]`
       ...
       */
  @JSName("spyOn")
  def spyOn_set[T /* <: js.Object */, M /* <: java.lang.String */](`object`: T, method: M, accessType: jestLib.jestLibStrings.set): SpyInstance[
    /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(M))) */js.Any
  ] = js.native
  /**
