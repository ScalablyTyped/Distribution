...
object ^ extends js.Object {
  ...
  def doMock(moduleName: java.lang.String, factory: js.Any, options: jestLib.jestNs.MockOptions): jestLib.Anon_AccessType = js.native
  /**
    * Indicates that the module system should never return a mocked version
  ...
  def mock(moduleName: java.lang.String, factory: js.Any, options: jestLib.jestNs.MockOptions): jestLib.Anon_AccessType = js.native
  /**
  ...
  def spyOn[T /* <: js.Object */, M /* <: java.lang.String */](`object`: T, method: M): jestLib.jestNs.SpyInstance[
    ...
    jestLib.ArgsType[/* import warning: ImportType.apply Failed type conversion: T[M] */ js.Any]
  ] = js.native
  /**
