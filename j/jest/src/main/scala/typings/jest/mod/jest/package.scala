...
@scala.inline
def doMock(moduleName: java.lang.String, factory: js.Function0[js.Any]): typings.jest.anon.Typeofjest = (typings.jest.mod.jest.^.asInstanceOf[js.Dynamic].applyDynamic("doMock")(moduleName.asInstanceOf[js.Any], factory.asInstanceOf[js.Any])).asInstanceOf[typings.jest.anon.Typeofjest]
@scala.inline
def doMock(
...
/**
  ...
  */
@scala.inline
def fn(): typings.jest.mod.jest.Mock_[js.Any, js.Any] = typings.jest.mod.jest.^.asInstanceOf[js.Dynamic].applyDynamic("fn")().asInstanceOf[typings.jest.mod.jest.Mock_[js.Any, js.Any]]
@scala.inline
def fn[T, Y /* <: js.Array[js.Any] */](implementation: js.Function1[/* args */ Y, T]): typings.jest.mod.jest.Mock_[T, Y] = typings.jest.mod.jest.^.asInstanceOf[js.Dynamic].applyDynamic("fn")(implementation.asInstanceOf[js.Any]).asInstanceOf[typings.jest.mod.jest.Mock_[T, Y]]

/**
  * Creates a mock function. Optionally takes a mock implementation.
  */
@scala.inline
def fn_TY_ArrayAny[T, Y /* <: js.Array[js.Any] */](): typings.jest.mod.jest.Mock_[T, Y] = typings.jest.mod.jest.^.asInstanceOf[js.Dynamic].applyDynamic("fn")().asInstanceOf[typings.jest.mod.jest.Mock_[T, Y]]
...
@scala.inline
def mock(moduleName: java.lang.String, factory: js.Function0[js.Any]): typings.jest.anon.Typeofjest = (typings.jest.mod.jest.^.asInstanceOf[js.Dynamic].applyDynamic("mock")(moduleName.asInstanceOf[js.Any], factory.asInstanceOf[js.Any])).asInstanceOf[typings.jest.anon.Typeofjest]
@scala.inline
def mock(
  moduleName: java.lang.String,
  factory: js.Function0[js.Any],
