...
trait Typeofjest extends js.Object {
  /**
    ...
    */
  def addMatchers(matchers: CustomMatcherFactories): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def deepUnmock(moduleName: String): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  /**
    * Disables automatic mocking in the module loader.
    */
  ...
  /**
    ...
    */
  def doMock(moduleName: String): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  def doMock(moduleName: String, factory: js.Function0[_]): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  def doMock(moduleName: String, factory: js.Function0[_], options: MockOptions): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  /**
    * Indicates that the module system should never return a mocked version
    * of the specified module from require() (e.g. that it should always return the real module).
    */
  def dontMock(moduleName: String): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  /**
    * Enables automatic mocking in the module loader.
    */
  ...
  /**
    ...
    */
  def isolateModules(fn: js.Function0[Unit]): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  /**
    * Mocks a module with an auto-mocked version when it is being required.
    */
  def mock(moduleName: String): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  def mock(moduleName: String, factory: js.Function0[_]): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  def mock(moduleName: String, factory: js.Function0[_], options: MockOptions): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def retryTimes(numRetries: Double): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def runTimersToTime(msToRun: Double): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  /**
    * Explicitly supplies the mock object that the module system should return
    * for the specified module.
    */
  def setMock[T](moduleName: String, moduleExports: T): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  /**
    * Set the default timeout interval for tests and before/after hooks in milliseconds.
    * Note: The default timeout interval is 5 seconds if this method is not called.
    */
  def setTimeout(timeout: Double): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  ...
  /**
    ...
    */
  def unmock(moduleName: String): /* import warning: ImportType.apply Failed type conversion: typeof jest */ js.Any = js.native
  /**
