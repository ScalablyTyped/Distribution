...
/**
  ...
  */
/* itemName */ org.scalablytyped.runtime.StringDictionary[T] {
   // named item
  ...
  /**
    ...
    */
  def apply(name: java.lang.String): T = js.native
  def apply(name: java.lang.String, item: TO): T = js.native
  def apply(name: java.lang.String, item: TO, parentTmpl: Template): T = js.native
}
