...
trait ViewModelOptions extends js.Object {
  ...
  var id: js.UndefOr[java.lang.String | (js.Function2[/* a */ js.Any, /* b */ js.Any, scala.Boolean])] = js.undefined
}
...
object ViewModelOptions {
  ...
  def apply(
    ...
    id: java.lang.String | (js.Function2[/* a */ js.Any, /* b */ js.Any, scala.Boolean]) = null
  ): ViewModelOptions = {
