...
import typings.jqueryDotRateit.jqueryDotRateitStrings.ispreset
import typings.jqueryDotRateit.jqueryDotRateitStrings.max
import typings.jqueryDotRateit.jqueryDotRateitStrings.min
import typings.jqueryDotRateit.jqueryDotRateitStrings.readonly
import typings.jqueryDotRateit.jqueryDotRateitStrings.reset
import typings.jqueryDotRateit.jqueryDotRateitStrings.value
