...
object jQRangeSliderScale {
  ...
  inline def apply(next: js.Any => js.Any): jQRangeSliderScale = {
  ...
  extension [Self <: jQRangeSliderScale](x: Self) {
    ...
    inline def setLabel(value: (/* value */ js.Any, /* nextValue */ js.Any) => String): Self = StObject.set(x, "label", js.Any.fromFunction2(value))
    
    inline def setLabelUndefined: Self = StObject.set(x, "label", js.undefined)
    
    inline def setNext(value: js.Any => js.Any): Self = StObject.set(x, "next", js.Any.fromFunction1(value))
    
    inline def setStop(value: /* value */ js.Any => Boolean): Self = StObject.set(x, "stop", js.Any.fromFunction1(value))
