...
object ECCurveFp {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ECCurveFp] (val x: Self) extends AnyVal {
    ...
    inline def setDecodePointHex(value: () => ECPointFp | Null): Self = StObject.set(x, "decodePointHex", js.Any.fromFunction0(value))
    
    inline def setEquals_(value: () => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction0(value))
    
    inline def setFromBigInteger(value: () => ECFieldElementFp): Self = StObject.set(x, "fromBigInteger", js.Any.fromFunction0(value))
    
    inline def setGetA(value: () => ECFieldElementFp): Self = StObject.set(x, "getA", js.Any.fromFunction0(value))
    
    inline def setGetB(value: () => ECFieldElementFp): Self = StObject.set(x, "getB", js.Any.fromFunction0(value))
    
    inline def setGetInfinity(value: () => ECPointFp): Self = StObject.set(x, "getInfinity", js.Any.fromFunction0(value))
    
    inline def setGetQ(value: () => BigInteger): Self = StObject.set(x, "getQ", js.Any.fromFunction0(value))
