...
open class RSAKey ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def sign(s: String, hashAlg: String): String = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def signPSS(s: String, hashAlg: String, sLen: Double): String = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def signWithMessageHash(sHashHex: String, hashAlg: String): String = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def signWithMessageHashPSS(hHash: String, hashAlg: String, sLen: Double): String = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def verifyPSS(sMsg: String, hSig: String, hashAlg: String, sLen: Double): Boolean = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def verifyWithMessageHash(sHashHex: String, hSig: String): Boolean = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def verifyWithMessageHashPSS(hHash: String, hSig: String, hashAlg: String, sLen: Double): Boolean = js.native
}
object RSAKey {
