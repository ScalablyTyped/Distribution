...
import typings.jsrsasign.jsrsasign.HashOfKeyAndUnusedIV
import typings.jsrsasign.jsrsasign.HashOfKeyInformation
...
open class KEYUTIL ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def _getKeyFromPublicPKCS8Hex(h: String): typings.jsrsasign.jsrsasign.RSAKey | ECDSA | DSA = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getKeyFromPlainPrivatePKCS8PEM(pkcs8PEM: String): typings.jsrsasign.jsrsasign.RSAKey | ECDSA = js.native
...
object KEYUTIL {
  ...
  /* static member */
  inline def getJWK(
    keyinfo: typings.jsrsasign.jsrsasign.RSAKey | ECDSA | DSA | String,
  ...
  /**
    ...
    */
  /* static member */
  inline def getKeyFromEncryptedPKCS8PEM(pkcs8PEM: String, passcode: String): typings.jsrsasign.jsrsasign.RSAKey | ECDSA = (^.asInstanceOf[js.Dynamic].applyDynamic("getKeyFromEncryptedPKCS8PEM")(pkcs8PEM.asInstanceOf[js.Any], passcode.asInstanceOf[js.Any])).asInstanceOf[typings.jsrsasign.jsrsasign.RSAKey | ECDSA]
  ...
  /**
    ...
    */
  /* static member */
  inline def getKeyFromPlainPrivatePKCS8Hex(prvKeyHex: String): typings.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = ^.asInstanceOf[js.Dynamic].applyDynamic("getKeyFromPlainPrivatePKCS8Hex")(prvKeyHex.asInstanceOf[js.Any]).asInstanceOf[typings.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA]
  ...
  /**
    ...
    */
  /* static member */
  inline def getKeyFromPlainPrivatePKCS8PEM(pkcs8PEM: String): typings.jsrsasign.jsrsasign.RSAKey | ECDSA = ^.asInstanceOf[js.Dynamic].applyDynamic("getKeyFromPlainPrivatePKCS8PEM")(pkcs8PEM.asInstanceOf[js.Any]).asInstanceOf[typings.jsrsasign.jsrsasign.RSAKey | ECDSA]
  ...
  /**
    ...
    */
  /* static member */
  inline def getKeyID(obj: typings.jsrsasign.jsrsasign.RSAKey): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getKeyID")(obj.asInstanceOf[js.Any]).asInstanceOf[String]
