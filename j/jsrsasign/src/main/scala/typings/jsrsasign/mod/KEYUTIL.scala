...
object KEYUTIL extends js.Object {
  ...
  def getKey(param: AnonE): typings.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
  def getKey(param: AnonE, passcode: String): typings.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
  def getKey(param: AnonE, passcode: String, hextype: String): typings.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
  def getKey(param: AnonE, passcode: Null, hextype: String): typings.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
