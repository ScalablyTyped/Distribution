...
object langNs extends js.Object {
  ...
  object StringNs extends js.Object {
    /**
      ...
      */
    def isBase64(s: String): Boolean = js.native
    /**
      ...
      */
    def isBase64URL(s: String): Boolean = js.native
    /**
      ...
      */
    def isHex(s: String): Boolean = js.native
    /**
      ...
      */
    def isInteger(s: String): Boolean = js.native
    /**
      ...
      */
    def isIntegerArray(s: String): Boolean = js.native
  }
