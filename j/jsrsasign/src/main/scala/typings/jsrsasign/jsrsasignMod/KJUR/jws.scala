...
object jws extends js.Object {
  ...
  object JWS extends js.Object {
    ...
    /**
      ...
      * }
      */
    def parse(sJWS: String): Anon_HeaderObj = js.native
    /**
    ...
    def verify(sJWS: String, key: String, acceptAlgs: Anon_B64): Boolean = js.native
    def verify(sJWS: String, key: String, acceptAlgs: Anon_Hex): Boolean = js.native
    def verify(sJWS: String, key: String, acceptAlgs: Anon_Utf8): Boolean = js.native
    /**
    ...
    def verifyJWT(sJWT: String, key: String, acceptField: Anon_AlgAud): Boolean = js.native
