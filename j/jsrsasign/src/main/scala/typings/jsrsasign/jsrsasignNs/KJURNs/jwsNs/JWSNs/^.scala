...
import typings.jsrsasign.Anon_AlgString_1329162176
...
object ^ extends js.Object {
  ...
  /**
    ...
    * sJWS = KJUR.jws.JWS.sign(null, '{alg:"HS256",cty:"JWT"}', '{age:21}', "aaa");
    */
  def sign(alg: String, spHead: Anon_AlgString_1329162176, spPayload: String): String = js.native
  def sign(alg: String, spHead: Anon_AlgString_1329162176, spPayload: String, pass: String): String = js.native
  def sign(alg: String, spHead: Anon_AlgString_1329162176, spPayload: js.Object): String = js.native
  def sign(alg: String, spHead: Anon_AlgString_1329162176, spPayload: js.Object, pass: String): String = js.native
  def sign(alg: Null, spHead: Anon_AlgString_1329162176, spPayload: String): String = js.native
  def sign(alg: Null, spHead: Anon_AlgString_1329162176, spPayload: String, pass: String): String = js.native
  def sign(alg: Null, spHead: Anon_AlgString_1329162176, spPayload: js.Object): String = js.native
  def sign(alg: Null, spHead: Anon_AlgString_1329162176, spPayload: js.Object, pass: String): String = js.native
  /**
