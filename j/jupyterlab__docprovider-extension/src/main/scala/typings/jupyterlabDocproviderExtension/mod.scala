...
import typings.jupyterlabDocproviderExtension.jupyterlabDocproviderExtensionStrings.desktop
import typings.jupyterlabDocproviderExtension.jupyterlabDocproviderExtensionStrings.mobile
...
object mod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@jupyterlab/docprovider-extension", JSImport.Default)
  @js.native
