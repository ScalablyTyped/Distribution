...
trait Options extends js.Object {
  /**
    ...
    * @default false
    */
  var accent: js.UndefOr[scala.Boolean | FromToPair] = js.undefined
  /**
    ...
    */
  var backdrop: js.UndefOr[scala.Boolean | CssObject] = js.undefined
  /**
    * If set to `true`, as soon as the Typeahead input is focused, the `backdrop` option will be displayed regardless.
    */
  var backdropOnFocus: js.UndefOr[jqueryDashTypeaheadLib.jqueryDashTypeaheadLibNumbers.`true`] = js.undefined
  /** Blur Typeahead when Tab key is pressed, if false Tab will go though search results */
  var blurOnTab: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var cancelButton: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var correlativeTemplate: js.UndefOr[scala.Boolean | js.Array[_]] = js.undefined
  ...
  /**
    ...
    */
  var display: js.UndefOr[js.Array[java.lang.String]] = js.undefined
  /**
    ...
    */
  var dropdownFilter: js.UndefOr[
    scala.Boolean | jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.string | js.Array[DropdownFilterItem]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var dynamicFilter: js.UndefOr[
    jqueryDashTypeaheadLib.jqueryDashTypeaheadLibNumbers.`false` | js.Array[DynamicFilterItem]
  ] = js.undefined
  /**
    ...
    */
  var emptyTemplate: js.UndefOr[
    java.lang.String | (js.Function1[
      /* query */ js.UndefOr[java.lang.String], 
      java.lang.String | jqueryDashTypeaheadLib.JQuery
    ])
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var generateOnLoad: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    * @default false
    */
  var group: js.UndefOr[scala.Boolean | java.lang.String | GroupSetting] = js.undefined
  /**
  ...
  var groupOrder: js.UndefOr[
    jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.asc | jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.desc | js.Array[java.lang.String] | (js.Function5[
      /* node */ js.UndefOr[jqueryDashTypeaheadLib.JQuery], 
      /* query */ js.UndefOr[java.lang.String], 
      /* result */ js.UndefOr[js.Any], 
      /* resultCount */ js.UndefOr[scala.Double], 
      /* resultCountPerGroup */ js.UndefOr[scala.Double], 
      js.Array[_]
    ])
  ] = js.undefined
  /** Set a custom template for the groups */
  var groupTemplate: js.UndefOr[scala.Null] = js.undefined
  /**
    ...
    * @default true
    */
  var highlight: js.UndefOr[jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.any | scala.Boolean] = js.undefined
  /**
    ...
    * @default false
    */
  var hint: js.UndefOr[scala.Boolean | CssObject] = js.undefined
  /**
  ...
  var loadingAnimation: js.UndefOr[jqueryDashTypeaheadLib.jqueryDashTypeaheadLibNumbers.`true`] = js.undefined
  /** If set to function, every element will be filtered using this custom rule AFTER the regular Typeahead filters have been applied. */
  ...
  /**
    ...
    * @default 8
    */
  var maxItem: js.UndefOr[jqueryDashTypeaheadLib.jqueryDashTypeaheadLibNumbers.`false` | scala.Double] = js.undefined
  /** Set a maximum results per group if `group: true` configuration is enabled */
  var maxItemPerGroup: js.UndefOr[scala.Double] = js.undefined
  /**
  ...
  /**
    ...
    */
  var mustSelectItem: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  var order: js.UndefOr[
    jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.asc | jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.desc
  ] = js.undefined
  /**
    ...
    */
  var resultContainer: js.UndefOr[
    jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.string | jqueryDashTypeaheadLib.jqueryDashTypeaheadLibNumbers.`false` | jqueryDashTypeaheadLib.JQuery
  ] = js.undefined
  /**
    ...
    */
  var searchOnFocus: js.UndefOr[scala.Boolean] = js.undefined
...
object Options {
  @scala.inline
  def apply(
    accent: scala.Boolean | FromToPair = null,
    backdrop: scala.Boolean | CssObject = null,
    backdropOnFocus: jqueryDashTypeaheadLib.jqueryDashTypeaheadLibNumbers.`true` = null,
    blurOnTab: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    cancelButton: js.UndefOr[scala.Boolean] = js.undefined,
    compression: js.UndefOr[scala.Boolean] = js.undefined,
    correlativeTemplate: scala.Boolean | js.Array[_] = null,
    debug: js.UndefOr[scala.Boolean] = js.undefined,
    delay: scala.Int | scala.Double = null,
    display: js.Array[java.lang.String] = null,
    dropdownFilter: scala.Boolean | jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.string | js.Array[DropdownFilterItem] = null,
    dynamic: js.UndefOr[scala.Boolean] = js.undefined,
    dynamicFilter: jqueryDashTypeaheadLib.jqueryDashTypeaheadLibNumbers.`false` | js.Array[DynamicFilterItem] = null,
    emptyTemplate: java.lang.String | (js.Function1[
      /* query */ js.UndefOr[java.lang.String], 
      java.lang.String | jqueryDashTypeaheadLib.JQuery
    ]) = null,
    ...
    generateOnLoad: js.UndefOr[scala.Boolean] = js.undefined,
    group: scala.Boolean | java.lang.String | GroupSetting = null,
    groupOrder: jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.asc | jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.desc | js.Array[java.lang.String] | (js.Function5[
      /* node */ js.UndefOr[jqueryDashTypeaheadLib.JQuery], 
      /* query */ js.UndefOr[java.lang.String], 
      /* result */ js.UndefOr[js.Any], 
      /* resultCount */ js.UndefOr[scala.Double], 
    ...
    groupTemplate: scala.Null = null,
    highlight: jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.any | scala.Boolean = null,
    hint: scala.Boolean | CssObject = null,
    href: java.lang.String | (js.Function1[/* item */ js.UndefOr[js.Any], java.lang.String]) = null,
    input: java.lang.String = null,
    loadingAnimation: jqueryDashTypeaheadLib.jqueryDashTypeaheadLibNumbers.`true` = null,
    matcher: (/* item */ js.UndefOr[js.Any], /* displayKey */ js.UndefOr[java.lang.String]) => scala.Boolean = null,
    maxItem: jqueryDashTypeaheadLib.jqueryDashTypeaheadLibNumbers.`false` | scala.Double = null,
    maxItemPerGroup: scala.Int | scala.Double = null,
    ...
    mustSelectItem: js.UndefOr[scala.Boolean] = js.undefined,
    offset: js.UndefOr[scala.Boolean] = js.undefined,
    order: jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.asc | jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.desc = null,
    resultContainer: jqueryDashTypeaheadLib.jqueryDashTypeaheadLibStrings.string | jqueryDashTypeaheadLib.jqueryDashTypeaheadLibNumbers.`false` | jqueryDashTypeaheadLib.JQuery = null,
    searchOnFocus: js.UndefOr[scala.Boolean] = js.undefined,
