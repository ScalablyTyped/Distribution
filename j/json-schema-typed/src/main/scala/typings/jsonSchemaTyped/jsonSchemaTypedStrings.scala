...
import typings.jsonSchemaTyped.mod.JSONSchemaContentEncodingName
...
object jsonSchemaTypedStrings {
  ...
  @js.native
  sealed trait additionalProperties extends js.Object
  
  @js.native
  sealed trait allOf extends js.Object
  ...
  @js.native
  sealed trait contentEncoding extends js.Object
  
  @js.native
  sealed trait contentMediaType extends js.Object
  ...
  @js.native
  sealed trait dependencies extends js.Object
  
  @js.native
  sealed trait description extends js.Object
  
  @js.native
  sealed trait `else` extends js.Object
  ...
  @js.native
  sealed trait examples extends js.Object
  
  @js.native
  sealed trait exclusiveMaximum extends js.Object
  
  @js.native
  sealed trait exclusiveMinimum extends js.Object
  
  @js.native
  sealed trait format extends js.Object
  
  @js.native
  sealed trait `full-date` extends js.Object
  
  @js.native
  sealed trait `full-time` extends js.Object
  
  @js.native
  sealed trait hostname extends js.Object
  
  @js.native
  sealed trait `idn-email` extends js.Object
  
  @js.native
  sealed trait `idn-hostname` extends js.Object
  
  @js.native
  sealed trait `ietf-token` extends JSONSchemaContentEncodingName
  
  @js.native
  sealed trait `if` extends js.Object
  ...
  @js.native
  sealed trait iri extends js.Object
  
  @js.native
  sealed trait `iri-reference` extends js.Object
  
  @js.native
  sealed trait items extends js.Object
  
  @js.native
  sealed trait `json-pointer` extends js.Object
  
  @js.native
  sealed trait `json-pointer-uri-fragment` extends js.Object
  
  @js.native
  sealed trait maxItems extends js.Object
  
  @js.native
  sealed trait maxLength extends js.Object
  
  @js.native
  sealed trait maxProperties extends js.Object
  
  @js.native
  sealed trait maximum extends js.Object
  
  @js.native
  sealed trait minItems extends js.Object
  
  @js.native
  sealed trait minLength extends js.Object
  
  @js.native
  sealed trait minProperties extends js.Object
  
  @js.native
  sealed trait minimum extends js.Object
  
  @js.native
  sealed trait multipleOf extends js.Object
  ...
  @js.native
  sealed trait oneOf extends js.Object
  
  @js.native
  sealed trait pattern extends js.Object
  
  @js.native
  sealed trait patternProperties extends js.Object
  
  @js.native
  sealed trait properties extends js.Object
  
  @js.native
  sealed trait propertyNames extends js.Object
  ...
  @js.native
  sealed trait `relative-json-pointer` extends js.Object
  ...
  @js.native
  sealed trait `then` extends js.Object
  ...
  @js.native
  sealed trait uniqueItems extends js.Object
  
  @js.native
  sealed trait uri extends js.Object
  
  @js.native
  sealed trait `uri-reference` extends js.Object
  
  @js.native
  sealed trait `uri-template` extends js.Object
