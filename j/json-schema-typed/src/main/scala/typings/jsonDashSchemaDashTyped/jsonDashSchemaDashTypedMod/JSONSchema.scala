...
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`date-time`
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`full-date`
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`full-time`
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`idn-email`
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`idn-hostname`
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`iri-reference`
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`json-pointer-uri-fragment`
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`json-pointer`
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`relative-json-pointer`
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`uri-reference`
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.`uri-template`
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.date
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.email
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.hostname
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.ipv4
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.ipv6
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.iri
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.regex
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.time
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.uri
import typings.jsonDashSchemaDashTyped.jsonDashSchemaDashTypedStrings.uuid
...
trait JSONSchema extends js.Object {
  ...
  /**
    ...
    */
  var dependencies: js.UndefOr[(StringDictionary[JSONSchema | js.Array[String]]) | js.Array[String]] = js.undefined
  /**
...
object JSONSchema {
  ...
  def apply(
    ...
    dependencies: (StringDictionary[JSONSchema | js.Array[String]]) | js.Array[String] = null,
