...
trait JSONSchema extends js.Object {
  ...
  /**
    ...
    */
  var additionalItems: js.UndefOr[JSONSchema] = js.undefined
  /**
  ...
  var dependencies: js.UndefOr[
    (org.scalablytyped.runtime.StringDictionary[JSONSchema | js.Array[java.lang.String]]) | js.Array[java.lang.String]
  ] = js.undefined
  /**
  ...
  var format: js.UndefOr[
    JSONSchemaFormat | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.date | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.`date-time` | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.email | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.`full-date` | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.`full-time` | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.hostname | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.`idn-email` | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.`idn-hostname` | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.ipv4 | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.ipv6 | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.iri | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.`iri-reference` | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.`json-pointer` | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.`json-pointer-uri-fragment` | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.regex | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.`relative-json-pointer` | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.time | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.uri | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.`uri-reference` | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.`uri-template` | jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedLibStrings.uuid
  ] = js.undefined
  /**
    * This keyword's value MUST be a valid JSON Schema.
    *
...
object JSONSchema {
  ...
  def apply(
    ...
    dependencies: (org.scalablytyped.runtime.StringDictionary[JSONSchema | js.Array[java.lang.String]]) | js.Array[java.lang.String] = null,
    ...
    if (additionalItems != null) __obj.updateDynamic("additionalItems")(additionalItems)
    ...
    if (const != null) __obj.updateDynamic("const")(const)
