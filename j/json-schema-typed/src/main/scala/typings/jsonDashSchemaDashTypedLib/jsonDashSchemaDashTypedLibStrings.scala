...
object jsonDashSchemaDashTypedLibStrings {
  @js.native
  sealed trait `7bit`
    extends jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedMod.JSONSchemaContentEncodingName
  ...
  @js.native
  sealed trait array
    extends jsonDashSchemaDashTypedLib.jsonDashSchemaDashTypedMod.JSONSchemaTypeName
