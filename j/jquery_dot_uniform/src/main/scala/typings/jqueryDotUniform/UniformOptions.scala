...
object UniformOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(inputAddTypeAsClass)) __obj.updateDynamic("inputAddTypeAsClass")(inputAddTypeAsClass.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(selectAutoWidth)) __obj.updateDynamic("selectAutoWidth")(selectAutoWidth.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useID)) __obj.updateDynamic("useID")(useID.asInstanceOf[js.Any])
