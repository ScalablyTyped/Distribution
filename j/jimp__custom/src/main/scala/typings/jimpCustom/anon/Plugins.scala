...
object Plugins {
  ...
  typings.jimpCore.utilsMod.FunctionRet[typings.jimpCore.pluginsMod.JimpPlugin[typings.jimpCore.etcMod.Image]]] */ PluginFuncArr](): Plugins[TypesFuncArr, PluginFuncArr] = {
  ...
  typings.jimpCore.utilsMod.FunctionRet[typings.jimpCore.pluginsMod.JimpType[typings.jimpCore.etcMod.Image]]] */ TypesFuncArr, /* <: js.UndefOr[
  typings.jimpCore.utilsMod.FunctionRet[typings.jimpCore.pluginsMod.JimpPlugin[typings.jimpCore.etcMod.Image]]] */ PluginFuncArr] (val x: Self with (Plugins[TypesFuncArr, PluginFuncArr])) extends AnyVal {
    @scala.inline
