...
object _IOutput {
  ...
  @scala.inline
  def IDisplayData(data: IMimeBundle, metadata: OutputMetadata): typings.jupyterlabNbformat.mod.IDisplayData = {
  ...
  @scala.inline
  def IError(ename: String, evalue: String, traceback: js.Array[String]): typings.jupyterlabNbformat.mod.IError = {
  ...
  @scala.inline
  def IExecuteResult(data: IMimeBundle, metadata: OutputMetadata): typings.jupyterlabNbformat.mod.IExecuteResult = {
  ...
  @scala.inline
  def IStream(name: StreamType, text: MultilineString): typings.jupyterlabNbformat.mod.IStream = {
