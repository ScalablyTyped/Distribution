...
trait ConditionalExpression
  ...
  @JSName("type")
  var type_ConditionalExpression: typings.jsep.jsepStrings.ConditionalExpression
}
object ConditionalExpression {
  ...
  extension [Self <: ConditionalExpression](x: Self) {
    ...
    inline def setType(value: typings.jsep.jsepStrings.ConditionalExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
