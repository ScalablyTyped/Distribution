...
object JimpType {
  @scala.inline
  def apply[/* <: typings.jimpCore.etcMod.Image */ T](mime: js.UndefOr[StringDictionary[js.Array[String]]] with StringDictionary[js.Array[String]]): JimpType[T] = {
    val __obj = js.Dynamic.literal(mime = mime.asInstanceOf[js.Any])
    __obj.asInstanceOf[JimpType[T]]
  }
  @scala.inline
  implicit class JimpTypeOps[Self <: JimpType[_], /* <: typings.jimpCore.etcMod.Image */ T] (val x: Self with JimpType[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMime(value: js.UndefOr[StringDictionary[js.Array[String]]] with StringDictionary[js.Array[String]]): Self = this.set("mime", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    StringDictionary[EncoderFn[T]]): Self = this.set("encoders", value.asInstanceOf[js.Any])
    @scala.inline
