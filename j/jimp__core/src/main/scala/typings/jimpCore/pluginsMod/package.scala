...
package object pluginsMod {
  ...
  type JimpType[T /* <: typings.jimpCore.etcMod.Image */] = typings.jimpCore.pluginsMod.WellFormedPlugin[T] with (typings.std.Required[
    typings.std.Pick[
      typings.jimpCore.pluginsMod.WellFormedPlugin[T], 
      typings.jimpCore.jimpCoreStrings.mime
    ]
  ])
}
