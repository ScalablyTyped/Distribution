...
object mod {
  ...
  inline def apply(schema: js.Object, cb: TraverseCallback): Unit = (^.asInstanceOf[js.Dynamic].apply(schema.asInstanceOf[js.Any], cb.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def apply(schema: js.Object, opts: TraverseOptions): Unit = (^.asInstanceOf[js.Dynamic].apply(schema.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def apply(schema: js.Object, opts: TraverseOptions, cb: TraverseCallback): Unit = (^.asInstanceOf[js.Dynamic].apply(schema.asInstanceOf[js.Any], opts.asInstanceOf[js.Any], cb.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  object arrayKeywords {
    ...
    inline def allOf_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("allOf")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "arrayKeywords.anyOf")
    @js.native
    def anyOf: `true` = js.native
    inline def anyOf_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("anyOf")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "arrayKeywords.items")
    @js.native
    def items: `true` = js.native
    inline def items_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("items")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "arrayKeywords.oneOf")
    @js.native
    def oneOf: `true` = js.native
    inline def oneOf_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("oneOf")(x.asInstanceOf[js.Any])
  }
  ...
  object keywords {
    ...
    inline def additionalItems_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("additionalItems")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "keywords.additionalProperties")
    @js.native
    def additionalProperties: `true` = js.native
    inline def additionalProperties_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("additionalProperties")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "keywords.contains")
    @js.native
    def contains: `true` = js.native
    inline def contains_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("contains")(x.asInstanceOf[js.Any])
    ...
    inline def not_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("not")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "keywords.propertyNames")
    @js.native
    def propertyNames: `true` = js.native
    inline def propertyNames_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("propertyNames")(x.asInstanceOf[js.Any])
  ...
  object propsKeywords {
    ...
    inline def definitions_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("definitions")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "propsKeywords.dependencies")
    @js.native
    def dependencies: `true` = js.native
    inline def dependencies_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("dependencies")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "propsKeywords.patternProperties")
    @js.native
    def patternProperties: `true` = js.native
    inline def patternProperties_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("patternProperties")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "propsKeywords.properties")
    @js.native
    def properties: `true` = js.native
    inline def properties_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("properties")(x.asInstanceOf[js.Any])
  }
  ...
  object skipKeywords {
    ...
    inline def const_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("const")(x.asInstanceOf[js.Any])
    
    inline def default_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("default")(x.asInstanceOf[js.Any])
    ...
    inline def exclusiveMaximum_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("exclusiveMaximum")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.exclusiveMinimum")
    @js.native
    def exclusiveMinimum: `true` = js.native
    inline def exclusiveMinimum_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("exclusiveMinimum")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.format")
    @js.native
    def format: `true` = js.native
    inline def format_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("format")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.maxItems")
    @js.native
    def maxItems: `true` = js.native
    inline def maxItems_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("maxItems")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.maxLength")
    @js.native
    def maxLength: `true` = js.native
    inline def maxLength_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("maxLength")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.maxProperties")
    @js.native
    def maxProperties: `true` = js.native
    inline def maxProperties_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("maxProperties")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.maximum")
    @js.native
    def maximum: `true` = js.native
    inline def maximum_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("maximum")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.minItems")
    @js.native
    def minItems: `true` = js.native
    inline def minItems_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("minItems")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.minLength")
    @js.native
    def minLength: `true` = js.native
    inline def minLength_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("minLength")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.minProperties")
    @js.native
    def minProperties: `true` = js.native
    inline def minProperties_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("minProperties")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.minimum")
    @js.native
    def minimum: `true` = js.native
    inline def minimum_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("minimum")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.multipleOf")
    @js.native
    def multipleOf: `true` = js.native
    inline def multipleOf_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("multipleOf")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.pattern")
    @js.native
    def pattern: `true` = js.native
    inline def pattern_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("pattern")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.required")
    @js.native
    def required: `true` = js.native
    inline def required_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("required")(x.asInstanceOf[js.Any])
    
    @JSImport("json-schema-traverse", "skipKeywords.uniqueItems")
    @js.native
    def uniqueItems: `true` = js.native
    inline def uniqueItems_=(x: `true`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("uniqueItems")(x.asInstanceOf[js.Any])
  }
  ...
  object TraverseOptions {
    ...
    inline def apply(): TraverseOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TraverseOptions]
    }
    
    extension [Self <: TraverseOptions](x: Self) {
      ...
      inline def setCb(value: TraverseCallback): Self = StObject.set(x, "cb", value.asInstanceOf[js.Any])
