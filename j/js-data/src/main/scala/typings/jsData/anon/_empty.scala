...
object _empty {
  ...
  implicit class _emptyOps[Self <: _empty] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEqualssignEqualssign(value: (js.Any, js.Any) => Boolean): Self = this.set("==", js.Any.fromFunction2(value))
    
    @scala.inline
    def setEqualssignEqualssignEqualssign(value: (js.Any, js.Any) => Boolean): Self = this.set("===", js.Any.fromFunction2(value))
    
    @scala.inline
    def setExclamationmarkEqualssign(value: (js.Any, js.Any) => Boolean): Self = this.set("!=", js.Any.fromFunction2(value))
    
    @scala.inline
    def setExclamationmarkEqualssignEqualssign(value: (js.Any, js.Any) => Boolean): Self = this.set("!==", js.Any.fromFunction2(value))
    
    @scala.inline
    def setGreaterthansign(value: (js.Any, js.Any) => Boolean): Self = this.set(">", js.Any.fromFunction2(value))
    
    @scala.inline
    def setGreaterthansignEqualssign(value: (js.Any, js.Any) => Boolean): Self = this.set(">=", js.Any.fromFunction2(value))
    
    @scala.inline
    def setLessthansign(value: (js.Any, js.Any) => Boolean): Self = this.set("<", js.Any.fromFunction2(value))
    
    @scala.inline
    def setLessthansignEqualssign(value: (js.Any, js.Any) => Boolean): Self = this.set("<=", js.Any.fromFunction2(value))
    
    @scala.inline
    def setContains(value: (js.Any, js.Any) => Boolean): Self = this.set("contains", js.Any.fromFunction2(value))
    
    @scala.inline
    def setIn(value: (js.Any, js.Any) => Boolean): Self = this.set("in", js.Any.fromFunction2(value))
    
    @scala.inline
    def setIsectEmpty(value: (js.Any, js.Any) => Boolean): Self = this.set("isectEmpty", js.Any.fromFunction2(value))
    
    @scala.inline
    def setIsectNotEmpty(value: (js.Any, js.Any) => Double): Self = this.set("isectNotEmpty", js.Any.fromFunction2(value))
    
    @scala.inline
    def setNotContains(value: (js.Any, js.Any) => Boolean): Self = this.set("notContains", js.Any.fromFunction2(value))
    
    @scala.inline
    def setNotIn(value: (js.Any, js.Any) => Boolean): Self = this.set("notIn", js.Any.fromFunction2(value))
  }
}
