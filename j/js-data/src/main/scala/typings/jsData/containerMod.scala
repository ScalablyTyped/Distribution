...
import typings.jsData.componentMod.default
...
object containerMod extends js.Object {
  ...
  class Container () extends default {
    ...
    def defineMapper(name: js.Any, opts: MapperOpts): typings.jsData.mapperMod.default = js.native
    def defineMapper(name: MapperOpts): typings.jsData.mapperMod.default = js.native
    def defineMapper(name: MapperOpts, opts: MapperOpts): typings.jsData.mapperMod.default = js.native
    def defineResource(name: js.Any, opts: js.Any): typings.jsData.mapperMod.default = js.native
    /**
    ...
    /**
      ...
      * @since 3.0.0
      */
    def getMapper(name: String): typings.jsData.mapperMod.default = js.native
    /**
      * Return the mapper registered under the specified name.
      ...
      * @since 3.0.0
      */
    def getMapperByName(name: js.Any): typings.jsData.mapperMod.default = js.native
    /**
      ...
      * @since 3.0.0
      */
    def getSchema(name: js.Any): typings.jsData.schemaMod.default = js.native
    /**
