...
object DataStoreOpts {
  ...
  def apply(
    ...
    if (!js.isUndefined(linkRelations)) __obj.updateDynamic("linkRelations")(linkRelations.get.asInstanceOf[js.Any])
    if (mapperClass != null) __obj.updateDynamic("mapperClass")(mapperClass.asInstanceOf[js.Any])
    if (scopes != null) __obj.updateDynamic("scopes")(scopes.asInstanceOf[js.Any])
    if (!js.isUndefined(unlinkOnDestroy)) __obj.updateDynamic("unlinkOnDestroy")(unlinkOnDestroy.get.asInstanceOf[js.Any])
