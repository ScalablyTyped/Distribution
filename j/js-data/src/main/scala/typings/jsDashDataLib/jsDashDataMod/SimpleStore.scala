...
class SimpleStore () extends Container {
  ...
  def create(mapperName: java.lang.String, record: js.Any): stdLib.Promise[_] = js.native
  def create(mapperName: java.lang.String, record: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  ...
  def createMany(mapperName: java.lang.String, records: js.Any): stdLib.Promise[js.Array[_] | _] = js.native
  def createMany(mapperName: java.lang.String, records: js.Any, opts: js.Any): stdLib.Promise[js.Array[_] | _] = js.native
  def destroy(mapperName: java.lang.String, id: js.Any): stdLib.Promise[_] = js.native
  def destroy(mapperName: java.lang.String, id: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  def destroyAll(mapperName: java.lang.String): stdLib.Promise[_] = js.native
  def destroyAll(mapperName: java.lang.String, query: js.Any): stdLib.Promise[_] = js.native
  def destroyAll(mapperName: java.lang.String, query: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  ...
  def find(mapperName: java.lang.String, id: js.Any): stdLib.Promise[_] = js.native
  def find(mapperName: java.lang.String, id: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  def findAll(mapperName: java.lang.String): stdLib.Promise[_] = js.native
  def findAll(mapperName: java.lang.String, query: js.Any): stdLib.Promise[_] = js.native
  def findAll(mapperName: java.lang.String, query: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  ...
  def update(mapperName: java.lang.String, id: js.Any, record: js.Any): stdLib.Promise[_] = js.native
  def update(mapperName: java.lang.String, id: js.Any, record: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  def updateAll(mapperName: java.lang.String, props: js.Any): stdLib.Promise[js.Array[_] | _] = js.native
  def updateAll(mapperName: java.lang.String, props: js.Any, query: js.Any): stdLib.Promise[js.Array[_] | _] = js.native
  def updateAll(mapperName: java.lang.String, props: js.Any, query: js.Any, opts: js.Any): stdLib.Promise[js.Array[_] | _] = js.native
  def updateMany(mapperName: java.lang.String, records: js.Any): stdLib.Promise[js.Array[_] | _] = js.native
  def updateMany(mapperName: java.lang.String, records: js.Any, opts: js.Any): stdLib.Promise[js.Array[_] | _] = js.native
}
