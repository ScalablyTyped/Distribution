...
class Mapper () extends Component {
  ...
  def count(query: js.Any): stdLib.Promise[_] = js.native
  def count(query: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  def create(props: js.Any): stdLib.Promise[_] = js.native
  def create(props: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  def createInstance(props: js.Any): js.Any = js.native
  def createInstance(props: js.Any, opts: js.Any): js.Any = js.native
  def createMany(records: js.Array[_]): stdLib.Promise[_] = js.native
  def createMany(records: js.Array[_], opts: js.Any): stdLib.Promise[_] = js.native
  ...
  def crud(method: js.Any, args: js.Any*): stdLib.Promise[_] = js.native
  def destroy(id: java.lang.String): stdLib.Promise[_] = js.native
  def destroy(id: java.lang.String, opts: js.Any): stdLib.Promise[_] = js.native
  def destroy(id: scala.Double): stdLib.Promise[_] = js.native
  def destroy(id: scala.Double, opts: js.Any): stdLib.Promise[_] = js.native
  def destroyAll(query: js.Any): stdLib.Promise[_] = js.native
  def destroyAll(query: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  def find(id: java.lang.String): stdLib.Promise[_] = js.native
  def find(id: java.lang.String, opts: js.Any): stdLib.Promise[_] = js.native
  def find(id: scala.Double): stdLib.Promise[_] = js.native
  def find(id: scala.Double, opts: js.Any): stdLib.Promise[_] = js.native
  def findAll(query: js.Any): stdLib.Promise[_] = js.native
  def findAll(query: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  ...
  def sum(field: java.lang.String, query: js.Any): stdLib.Promise[_] = js.native
  def sum(field: java.lang.String, query: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  def toJSON(record: js.Any): js.Object = js.native
  def toJSON(record: js.Any, opts: js.Any): js.Object = js.native
  def update(id: java.lang.String, props: js.Any): stdLib.Promise[_] = js.native
  def update(id: java.lang.String, props: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  def update(id: scala.Double, props: js.Any): stdLib.Promise[_] = js.native
  def update(id: scala.Double, props: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  def updateAll(props: js.Any, query: js.Any): stdLib.Promise[_] = js.native
  def updateAll(props: js.Any, query: js.Any, opts: js.Any): stdLib.Promise[_] = js.native
  def updateMany(records: js.Array[_]): stdLib.Promise[_] = js.native
  def updateMany(records: js.Array[_], opts: js.Any): stdLib.Promise[_] = js.native
