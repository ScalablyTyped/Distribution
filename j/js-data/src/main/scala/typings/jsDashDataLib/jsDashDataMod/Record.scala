...
class Record () extends Component {
  ...
  def create(): stdLib.Promise[Record] = js.native
  def create(opts: js.Any): stdLib.Promise[Record] = js.native
  def destroy(): stdLib.Promise[_] = js.native
  def destroy(opts: js.Any): stdLib.Promise[_] = js.native
  ...
  def loadRelations(relations: js.Any): stdLib.Promise[this.type] = js.native
  def loadRelations(relations: js.Any, opts: js.Any): stdLib.Promise[this.type] = js.native
  ...
  def save(opts: js.Any): stdLib.Promise[this.type] = js.native
