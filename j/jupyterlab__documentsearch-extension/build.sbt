...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__attachments" % "2.0.0-d49f7d",
  "org.scalablytyped" %%% "jupyterlab__cells" % "2.0.0-a5a5f2",
  "org.scalablytyped" %%% "jupyterlab__codeeditor" % "2.0.0-76ca5f",
  "org.scalablytyped" %%% "jupyterlab__codemirror" % "2.0.0-9bbc73",
  "org.scalablytyped" %%% "jupyterlab__coreutils" % "4.0.0-9a76f5",
  "org.scalablytyped" %%% "jupyterlab__docregistry" % "2.0.0-013482",
  "org.scalablytyped" %%% "jupyterlab__documentsearch" % "2.0.0-b4df90",
  "org.scalablytyped" %%% "jupyterlab__fileeditor" % "2.0.0-01cc0b",
  "org.scalablytyped" %%% "jupyterlab__nbformat" % "2.0.0-6946d1",
  "org.scalablytyped" %%% "jupyterlab__notebook" % "2.0.0-2d7d94",
