...
@js.native
object libMainmenuMod extends js.Object {
  @js.native
  class MainMenu protected ()
    ...
    /* InferMemberOverrides */
    override def addMenu(menu: Menu, options: IAddOptions): Unit = js.native
    /**
      ...
      */
    /* InferMemberOverrides */
    override def addMenu(menu: typings.atPhosphorWidgets.libMenuMod.Menu): Unit = js.native
    /**
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def insertMenu(index: Double, menu: typings.atPhosphorWidgets.libMenuMod.Menu): Unit = js.native
    /**
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def removeMenu(menu: typings.atPhosphorWidgets.libMenuMod.Menu): Unit = js.native
    /**
