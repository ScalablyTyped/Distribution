...
object GridsterCoords {
  ...
  inline def apply(col: Double, row: Double, size_x: Double, size_y: Double): GridsterCoords = {
  ...
  extension [Self <: GridsterCoords](x: Self) {
    ...
    inline def setSize_x(value: Double): Self = StObject.set(x, "size_x", value.asInstanceOf[js.Any])
    
    inline def setSize_y(value: Double): Self = StObject.set(x, "size_y", value.asInstanceOf[js.Any])
  }
}
