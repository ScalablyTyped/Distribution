...
trait JssExpand extends js.Object {
  var animation: jssLib.Anon_Delay | js.Any
  var background: jssLib.Anon_0 | js.Any
  var border: jssLib.Anon_Color | js.Any
  var boxShadow: jssLib.Anon_Blur | js.Any
  var flex: jssLib.Anon_Basis | js.Any
  var font: jssLib.Anon_Family | js.Any
  var listStyle: jssLib.Anon_Image | js.Any
  var margin: jssLib.Anon_Bottom | js.Any
  var outline: jssLib.Anon_Color | js.Any
  var padding: jssLib.Anon_Bottom | js.Any
  var textShadow: jssLib.Anon_BlurColor | js.Any
