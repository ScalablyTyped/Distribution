...
package object mod {
  ...
  type Styles[Name /* <: java.lang.String | scala.Double | js.Symbol */] = typings.std.Record[
    Name, 
    typings.jss.mod.JssStyle | java.lang.String | (typings.jss.mod.Func[js.UndefOr[typings.jss.mod.JssStyle | java.lang.String | scala.Null]]) | (typings.indefiniteObservable.typesMod.Observable[js.UndefOr[typings.jss.mod.JssStyle | java.lang.String | scala.Null]])
  ]
}
