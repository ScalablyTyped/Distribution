...
import typings.atJupyterlabRunning.atJupyterlabRunningMod.RunningSessions.IOptions
...
class RunningSessions_ protected () extends ReactWidget {
  ...
  val terminalOpenRequested: ISignal[
    this.type, 
    typings.atJupyterlabServices.libTerminalTerminalMod.TerminalSession.IModel
  ] = js.native
}
