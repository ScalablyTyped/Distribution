...
object jsonpathModMembers extends js.Object {
  @JSName("apply")
  def apply(obj: js.Any, pathExpression: java.lang.String, fn: js.Function1[/* x */ js.Any, _]): js.Array[jsonpathLib.Anon_Value] = js.native
  def nodes(obj: js.Any, pathExpression: java.lang.String): js.Array[jsonpathLib.Anon_Value] = js.native
  def nodes(obj: js.Any, pathExpression: java.lang.String, count: scala.Double): js.Array[jsonpathLib.Anon_Value] = js.native
