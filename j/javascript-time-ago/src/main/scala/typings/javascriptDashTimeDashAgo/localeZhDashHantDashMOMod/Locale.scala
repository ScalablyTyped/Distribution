package typings.javascriptDashTimeDashAgo.localeZhDashHantDashMOMod

import typings.javascriptDashTimeDashAgo.javascriptDashTimeDashAgoStrings.`zh-Hant-MO`
