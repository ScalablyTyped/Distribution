package typings.javascriptDashTimeDashAgo.localeZhDashHantDashHKMod

import typings.javascriptDashTimeDashAgo.javascriptDashTimeDashAgoStrings.`zh-Hant-HK`
