package typings.javascriptDashTimeDashAgo.localeZhDashHansDashMOMod

import typings.javascriptDashTimeDashAgo.javascriptDashTimeDashAgoStrings.`zh-Hans-MO`
