package typings.javascriptTimeAgo.nlMod

import typings.javascriptTimeAgo.javascriptTimeAgoStrings.few
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.nl
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: nl): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
