package typings.javascriptTimeAgo.kkMod

import typings.javascriptTimeAgo.javascriptTimeAgoStrings.few
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.kk
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: kk): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
