package typings.javascriptTimeAgo.orMod
...
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.or
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: or): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
