package typings.javascriptTimeAgo.psMod
...
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.ps
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: ps): Self = this.set("locale", value.asInstanceOf[js.Any])
