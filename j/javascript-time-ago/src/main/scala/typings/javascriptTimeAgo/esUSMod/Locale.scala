package typings.javascriptTimeAgo.esUSMod

import typings.javascriptTimeAgo.javascriptTimeAgoStrings.`es-US`
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: `es-US`): Self = this.set("locale", value.asInstanceOf[js.Any])
