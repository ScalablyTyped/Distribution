package typings.javascriptTimeAgo.tkMod
...
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.tk
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: tk): Self = this.set("locale", value.asInstanceOf[js.Any])
