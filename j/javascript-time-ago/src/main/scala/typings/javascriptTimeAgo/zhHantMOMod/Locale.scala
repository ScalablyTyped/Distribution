package typings.javascriptTimeAgo.zhHantMOMod

import typings.javascriptTimeAgo.javascriptTimeAgoStrings.`zh-Hant-MO`
...
trait Locale extends js.Object {
  ...
  var locale: `zh-Hant-MO` = js.native
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: `zh-Hant-MO`): Self = this.set("locale", value.asInstanceOf[js.Any])
