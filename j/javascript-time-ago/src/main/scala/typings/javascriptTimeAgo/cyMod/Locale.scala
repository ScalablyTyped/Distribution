package typings.javascriptTimeAgo.cyMod

import typings.javascriptTimeAgo.javascriptTimeAgoStrings.cy
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: cy): Self = this.set("locale", value.asInstanceOf[js.Any])
