package typings.javascriptTimeAgo.quMod
...
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.qu
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: qu): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
