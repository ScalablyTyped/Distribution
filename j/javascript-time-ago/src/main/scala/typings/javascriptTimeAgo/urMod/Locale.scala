package typings.javascriptTimeAgo.urMod
...
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.ur
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: ur): Self = this.set("locale", value.asInstanceOf[js.Any])
