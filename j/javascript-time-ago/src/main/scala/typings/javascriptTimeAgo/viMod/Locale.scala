package typings.javascriptTimeAgo.viMod
...
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.vi
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: vi): Self = this.set("locale", value.asInstanceOf[js.Any])
