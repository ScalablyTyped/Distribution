package typings.javascriptTimeAgo.tiMod
...
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.ti
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: ti): Self = this.set("locale", value.asInstanceOf[js.Any])
