...
object enMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/en", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(locale = "en", long = long.asInstanceOf[js.Any], narrow = narrow.asInstanceOf[js.Any], quantify = js.Any.fromFunction1(quantify), short = short.asInstanceOf[js.Any], tiny = tiny.asInstanceOf[js.Any])
    ...
    extension [Self <: Locale](x: Self) {
      ...
      inline def setLocale(value: en): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `enMod.foo` */
