package typings.javascriptTimeAgo.ccpMod

import typings.javascriptTimeAgo.javascriptTimeAgoStrings.ccp
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: ccp): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
