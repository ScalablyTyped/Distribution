package typings.javascriptTimeAgo.zhHantMod

import typings.javascriptTimeAgo.javascriptTimeAgoStrings.`zh-Hant`
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: `zh-Hant`): Self = this.set("locale", value.asInstanceOf[js.Any])
