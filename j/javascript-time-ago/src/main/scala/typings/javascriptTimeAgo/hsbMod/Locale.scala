...
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.hsb
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: hsb): Self = this.set("locale", value.asInstanceOf[js.Any])
