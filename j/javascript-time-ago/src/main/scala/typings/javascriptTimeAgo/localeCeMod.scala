...
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.ce
...
object localeCeMod extends Shortcut {
  ...
  object Locale {
    ...
    inline def apply(long: Duration, narrow: Duration, quantify: Double => one | two | few | other, short: Duration): Locale = {
      val __obj = js.Dynamic.literal(locale = "ce", long = long.asInstanceOf[js.Any], narrow = narrow.asInstanceOf[js.Any], quantify = js.Any.fromFunction1(quantify), short = short.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: Locale] (val x: Self) extends AnyVal {
      ...
      inline def setLocale(value: ce): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `localeCeMod.foo` */
