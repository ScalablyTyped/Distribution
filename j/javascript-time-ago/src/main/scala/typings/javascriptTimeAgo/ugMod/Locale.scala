package typings.javascriptTimeAgo.ugMod
...
import typings.javascriptTimeAgo.javascriptTimeAgoStrings.ug
...
object Locale {
  ...
  implicit class LocaleOps[Self <: Locale] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocale(value: ug): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
