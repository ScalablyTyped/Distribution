...
object ClientSideLoggingClientInfoObject {
  ...
  def apply(
    ...
    if (!js.isUndefined(screen_size)) __obj.updateDynamic("screen_size")(screen_size.get.asInstanceOf[js.Any])
    if (!js.isUndefined(user_agent)) __obj.updateDynamic("user_agent")(user_agent.get.asInstanceOf[js.Any])
    if (!js.isUndefined(window_size)) __obj.updateDynamic("window_size")(window_size.get.asInstanceOf[js.Any])
