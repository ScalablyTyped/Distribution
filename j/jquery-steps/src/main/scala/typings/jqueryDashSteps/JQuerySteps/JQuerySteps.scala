...
trait JQuerySteps extends js.Object {
  /**
    ...
    */
  def add(step: Step): typings.jqueryDashSteps.JQuerySteps.JQuerySteps
  /**
  ...
  /**
    ...
    */
  def insert(index: Double, step: Step): typings.jqueryDashSteps.JQuerySteps.JQuerySteps
  /**
...
object JQuerySteps {
  @scala.inline
  def apply(
    add: Step => typings.jqueryDashSteps.JQuerySteps.JQuerySteps,
    destroy: () => Unit,
    finish: () => Unit,
    getCurrentIndex: () => Double,
    getCurrentStep: () => Step,
    getStep: Double => Step,
    insert: (Double, Step) => typings.jqueryDashSteps.JQuerySteps.JQuerySteps,
    next: () => Boolean,
    previous: () => Boolean,
