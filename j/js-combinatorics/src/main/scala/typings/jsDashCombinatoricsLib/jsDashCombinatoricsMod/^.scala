...
object ^ extends js.Object {
  ...
  def baseN[T](a: js.Array[T], n: scala.Double): IPredictableGenerator[js.Array[T]] = js.native
  /**
  ...
  def bigCombination[T](a: js.Array[T], n: scala.Double): IGenerator[js.Array[T]] = js.native
  ...
  def combination[T](a: js.Array[T], n: scala.Double): IGenerator[js.Array[T]] = js.native
  /**
  ...
  def permutation[T](a: js.Array[T], n: scala.Double): IGenerator[js.Array[T]] = js.native
  /**
