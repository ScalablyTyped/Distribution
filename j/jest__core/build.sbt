...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-changed-files" % "25.2.6-09563e",
  ...
  "org.scalablytyped" %%% "jest-runner" % "25.2.7-6bc7f6",
  "org.scalablytyped" %%% "jest-runtime" % "25.2.7-8469a4",
  "org.scalablytyped" %%% "jest-watcher" % "25.2.7-aaa553",
  ...
  "org.scalablytyped" %%% "jest__reporters" % "25.2.6-a007aa",
