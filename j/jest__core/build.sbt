...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-changed-files" % "24.9.0-67df51",
  ...
  "org.scalablytyped" %%% "jest-runner" % "24.9.0-64488b",
  ...
  "org.scalablytyped" %%% "jest__reporters" % "24.9.0-f03e60",
