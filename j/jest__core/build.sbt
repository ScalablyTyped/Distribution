...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-changed-files" % "25.1.0-0c875b",
  ...
  "org.scalablytyped" %%% "jest-runner" % "25.1.0-e0dae3",
  ...
  "org.scalablytyped" %%% "jest__reporters" % "25.1.0-ad2c9b",
