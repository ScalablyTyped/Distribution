...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-changed-files" % "25.3.0-ed1dac",
  ...
  "org.scalablytyped" %%% "jest-runner" % "25.3.0-bbdf8d",
  "org.scalablytyped" %%% "jest-runtime" % "25.3.0-39377f",
  "org.scalablytyped" %%% "jest-watcher" % "25.3.0-7b0a35",
  ...
  "org.scalablytyped" %%% "jest__reporters" % "25.3.0-16cb70",
