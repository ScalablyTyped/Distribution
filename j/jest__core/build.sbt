...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "emittery" % "0.7.2-25ca1e",
  ...
  "org.scalablytyped" %%% "jest-changed-files" % "26.6.2-1cb1ea",
  ...
  "org.scalablytyped" %%% "jest-runner" % "26.6.3-fb2994",
  "org.scalablytyped" %%% "jest-runtime" % "26.6.3-2648ab",
  "org.scalablytyped" %%% "jest-watcher" % "26.6.2-39780e",
  "org.scalablytyped" %%% "jest__console" % "24.9.0-3b85dc",
  "org.scalablytyped" %%% "jest__environment" % "26.6.2-bde1db",
  "org.scalablytyped" %%% "jest__reporters" % "26.6.2-a25aac",
