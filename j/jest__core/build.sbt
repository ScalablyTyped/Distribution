...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-changed-files" % "25.1.0-f5d003",
  ...
  "org.scalablytyped" %%% "jest-runner" % "25.1.0-ec2835",
  ...
  "org.scalablytyped" %%% "jest__reporters" % "25.1.0-7cdc9a",
