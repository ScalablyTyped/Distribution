...
@js.native
trait EleOmitContentTabletableO extends js.Object {
...
object EleOmitContentTabletableO {
  ...
  @scala.inline
  implicit class EleOmitContentTabletableOOps[Self <: EleOmitContentTabletableO] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeightsFunction1(value: /* row */ Double => Double | typings.pdfmake.pdfmakeStrings.auto): Self = this.set("heights", js.Any.fromFunction1(value))
