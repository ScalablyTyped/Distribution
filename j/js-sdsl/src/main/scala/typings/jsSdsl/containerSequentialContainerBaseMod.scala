...
object containerSequentialContainerBaseMod {
  
  @JSImport("js-sdsl/dist/esm/container/SequentialContainer/Base", JSImport.Default)
  @js.native
  abstract class default[T] () extends SequentialContainer[T]
