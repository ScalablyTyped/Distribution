...
object baseTreeNodeMod {
  
  @JSImport("js-sdsl/dist/esm/container/TreeContainer/Base/TreeNode", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    /* static member */
    @JSImport("js-sdsl/dist/esm/container/TreeContainer/Base/TreeNode", "default.BLACK")
    @js.native
    val BLACK: /* false */ Boolean = js.native
    
    /* static member */
    @JSImport("js-sdsl/dist/esm/container/TreeContainer/Base/TreeNode", "default.RED")
    @js.native
