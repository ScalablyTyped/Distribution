...
object esmMod {
  ...
  object ContainerIterator {
    ...
    @JSImport("js-sdsl/dist/esm", "ContainerIterator.NORMAL")
    @js.native
    val NORMAL: /* false */ Boolean = js.native
    
    @JSImport("js-sdsl/dist/esm", "ContainerIterator.REVERSE")
    @js.native
  ...
  object HashContainer {
    ...
    /* static member */
    @JSImport("js-sdsl/dist/esm", "HashContainer.maxBucketNum")
    @js.native
    val maxBucketNum: Double = js.native
    
    /* static member */
    @JSImport("js-sdsl/dist/esm", "HashContainer.minTreeifySize")
    @js.native
    val minTreeifySize: /* 64 */ Double = js.native
    
    /* static member */
    @JSImport("js-sdsl/dist/esm", "HashContainer.sigma")
    @js.native
    val sigma: /* 0.75 */ Double = js.native
    
    /* static member */
    @JSImport("js-sdsl/dist/esm", "HashContainer.treeifyThreshold")
    @js.native
    val treeifyThreshold: /* 8 */ Double = js.native
    
    /* static member */
    @JSImport("js-sdsl/dist/esm", "HashContainer.untreeifyThreshold")
    @js.native
