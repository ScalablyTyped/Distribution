...
object distCjsContainerTreeContainerOrderedSetMod {
  ...
  open class OrderedSetIterator[K] ()
    extends typings.jsSdsl.distCjsContainerTreeContainerBaseTreeIteratorMod.default[K, Unit]
  
  @js.native
  trait OrderedSet[K]
    extends typings.jsSdsl.distCjsContainerTreeContainerBaseMod.default[K, Unit] {
