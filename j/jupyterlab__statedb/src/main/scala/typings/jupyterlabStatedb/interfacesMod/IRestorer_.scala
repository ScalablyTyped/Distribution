...
object IRestorer_ {
  ...
  @scala.inline
  implicit class IRestorer_Ops[Self <: IRestorer_[_, _, _], /* <: typings.jupyterlabStatedb.interfacesMod.IRestorable[U, _] */ T, /* <: typings.luminoDisposable.mod.IObservableDisposable */ U, V] (val x: Self with (IRestorer_[T, U, V])) extends AnyVal {
    @scala.inline
