...
import typings.jupyterlabStatedb.libInterfacesMod.IRestorable.IOptions
...
object libInterfacesMod {
  ...
  object IRestorable {
    ...
    trait IOptions[T /* <: IObservableDisposable */]
      extends StObject
         with typings.jupyterlabStatedb.libInterfacesMod.IRestorer.IOptions[T] {
  ...
  object IRestorer {
    ...
    inline def apply[T /* <: IRestorable[U, Any] */, U /* <: IObservableDisposable */, V](
      restore: (T, typings.jupyterlabStatedb.libInterfacesMod.IRestorable.IOptions[U]) => js.Promise[V],
    ...
    object IOptions {
      ...
      inline def apply[T /* <: IObservableDisposable */](command: String, name: T => String): typings.jupyterlabStatedb.libInterfacesMod.IRestorer.IOptions[T] = {
