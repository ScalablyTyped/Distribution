...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__attachments" % "1.2.0-6cc3c0",
  "org.scalablytyped" %%% "jupyterlab__cells" % "1.2.1-613fd3",
  "org.scalablytyped" %%% "jupyterlab__codeeditor" % "1.2.0-6eaed4",
  "org.scalablytyped" %%% "jupyterlab__console" % "1.2.1-2efbd9",
  ...
  "org.scalablytyped" %%% "jupyterlab__filebrowser" % "1.2.0-1c2076",
  "org.scalablytyped" %%% "jupyterlab__fileeditor" % "1.2.0-e9fc5e",
