...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__attachments" % "3.5.0-f4b53f",
  "org.scalablytyped" %%% "jupyterlab__cells" % "3.5.0-93b1d8",
  "org.scalablytyped" %%% "jupyterlab__codeeditor" % "3.5.0-10c5e4",
  "org.scalablytyped" %%% "jupyterlab__console" % "3.5.0-b5117f",
  ...
  "org.scalablytyped" %%% "jupyterlab__filebrowser" % "3.5.0-f4aa10",
  "org.scalablytyped" %%% "jupyterlab__fileeditor" % "3.5.0-97d299",
