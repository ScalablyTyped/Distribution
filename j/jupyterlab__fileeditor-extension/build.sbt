...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jupyterlab__attachments" % "1.2.1-732ecf",
  "org.scalablytyped" %%% "jupyterlab__cells" % "1.2.2-0132c4",
  "org.scalablytyped" %%% "jupyterlab__codeeditor" % "1.2.0-da30c5",
  "org.scalablytyped" %%% "jupyterlab__console" % "1.2.2-ec6ddf",
  ...
  "org.scalablytyped" %%% "jupyterlab__filebrowser" % "1.2.1-9670a6",
  "org.scalablytyped" %%% "jupyterlab__fileeditor" % "1.2.1-d98130",
