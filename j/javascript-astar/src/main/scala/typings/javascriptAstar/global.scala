...
object global {
  ...
  object astar {
    ...
    inline def search(graph: typings.javascriptAstar.Graph, start: X, end: X): js.Array[typings.javascriptAstar.GridNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("search")(graph.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[js.Array[typings.javascriptAstar.GridNode]]
