...
trait JQuery extends js.Object {
  ...
  /**
       ...
       * @returns {} 
       */
  def addJSONData(data: js.Array[_]): scala.Unit = js.native
  /**
       ...
       * @returns {} 
       */
  def editRow(rowid: js.Any): scala.Unit = js.native
  /**
       * Edits the row specified by rowid.
       * keys is a boolean value, indicating if to use the Enter key to accept the value ane Esc to cancel the edit, or not.
       * @param rowid the id of the row to edit
       ...
       * @returns {} 
       */
  def editRow(rowid: js.Any, keys: scala.Boolean): scala.Unit = js.native
  /**
       ...
       * @returns {} 
       */
  def getGridParam(name: java.lang.String): js.Any = js.native
  /**
       ...
       * @returns {} 
       */
  def restoreRow(rowId: js.Any): scala.Unit = js.native
  /**
       * This method restores the data to original values before the editing of the row
       * @param rowId the row to restore
       * @param afterRestoreFunc if defined this function is called in after the row is restored.
       * @returns {} 
       */
  def restoreRow(rowId: js.Any, afterRestoreFunc: js.Function1[/* response */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
       ...
       * @returns {} 
       */
  def saveRow(rowid: java.lang.String): scala.Unit = js.native
  /**
       * Saves the edited row.
       * @param rowid the id of the row to save
       * @param successfunc 
       ...
       * @returns {} 
       */
  def saveRow(rowid: java.lang.String, successfunc: js.Function1[/* response */ js.Any, scala.Boolean]): scala.Unit = js.native
  /**
       * Saves the edited row.
       * @param rowid the id of the row to save
       * @param successfunc 
  ...
  def saveRow(
    ...
    successfunc: js.Function1[/* response */ js.Any, scala.Boolean],
  ...
  /**
       ...
       * @returns {} 
       */
  def saveRow(rowid: java.lang.String, successfunc: scala.Boolean): scala.Unit = js.native
  /**
       * Saves the edited row.
       * @param rowid the id of the row to save
       * @param successfunc 
       ...
       * @returns {} 
       */
  def saveRow(rowid: java.lang.String, successfunc: scala.Boolean, url: java.lang.String): scala.Unit = js.native
  /**
       * Saves the edited row.
       * @param rowid the id of the row to save
       * @param successfunc 
       ...
       * @returns {} 
       */
  def saveRow(rowid: java.lang.String, successfunc: scala.Boolean, url: java.lang.String, extraparam: js.Any): scala.Unit = js.native
  /**
       ...
       * @returns {} 
       */
  def setGridParam(obj: js.Any): scala.Unit = js.native
}
