...
object EventParams {
  ...
  extension [Self <: EventParams](x: Self) {
    ...
    inline def setAdCompanions(value: AdCompanionsParam): Self = StObject.set(x, "adCompanions", value.asInstanceOf[js.Any])
    
    inline def setAdComplete(value: AdProgressParam): Self = StObject.set(x, "adComplete", value.asInstanceOf[js.Any])
    
    inline def setAdError(value: AdErrorParam): Self = StObject.set(x, "adError", value.asInstanceOf[js.Any])
    
    inline def setAdImpression(value: AdImpressionParam): Self = StObject.set(x, "adImpression", value.asInstanceOf[js.Any])
    
    inline def setAdPause(value: AdPlayParam): Self = StObject.set(x, "adPause", value.asInstanceOf[js.Any])
    
    inline def setAdPlay(value: AdPlayParam): Self = StObject.set(x, "adPlay", value.asInstanceOf[js.Any])
    
    inline def setAdRequest(value: AdRequestParam): Self = StObject.set(x, "adRequest", value.asInstanceOf[js.Any])
    
    inline def setAdSchedule(value: AdScheduleParam): Self = StObject.set(x, "adSchedule", value.asInstanceOf[js.Any])
    
    inline def setAdSkipped(value: AdProgressParam): Self = StObject.set(x, "adSkipped", value.asInstanceOf[js.Any])
    
    inline def setAdStarted(value: AdStartedParam): Self = StObject.set(x, "adStarted", value.asInstanceOf[js.Any])
    
    inline def setAdTime(value: AdTimeParam): Self = StObject.set(x, "adTime", value.asInstanceOf[js.Any])
    
    inline def setAudioTrackChanged(value: AudioTrackChangedParam): Self = StObject.set(x, "audioTrackChanged", value.asInstanceOf[js.Any])
    
    inline def setAudioTracks(value: AudioTracksParam): Self = StObject.set(x, "audioTracks", value.asInstanceOf[js.Any])
    
    inline def setBuffer(value: BufferParam): Self = StObject.set(x, "buffer", value.asInstanceOf[js.Any])
    
    inline def setBufferChange(value: BufferChangeParam): Self = StObject.set(x, "bufferChange", value.asInstanceOf[js.Any])
    
    inline def setCaptionsChanged(value: CaptionsChangedParam): Self = StObject.set(x, "captionsChanged", value.asInstanceOf[js.Any])
    
    inline def setCaptionsList(value: CaptionsListParam): Self = StObject.set(x, "captionsList", value.asInstanceOf[js.Any])
    
    inline def setCast(value: CastParam): Self = StObject.set(x, "cast", value.asInstanceOf[js.Any])
    
    inline def setControls(value: ControlsParam): Self = StObject.set(x, "controls", value.asInstanceOf[js.Any])
    
    inline def setError(value: ErrorParam): Self = StObject.set(x, "error", value.asInstanceOf[js.Any])
    
    inline def setFirstFrame(value: FirstFrameParam): Self = StObject.set(x, "firstFrame", value.asInstanceOf[js.Any])
    
    inline def setFullscreen(value: FullscreenParam): Self = StObject.set(x, "fullscreen", value.asInstanceOf[js.Any])
    
    inline def setIdle(value: IdleParam): Self = StObject.set(x, "idle", value.asInstanceOf[js.Any])
    
    inline def setLevels(value: LevelsParam): Self = StObject.set(x, "levels", value.asInstanceOf[js.Any])
    
    inline def setLevelsChanged(value: LevelsChangedParam): Self = StObject.set(x, "levelsChanged", value.asInstanceOf[js.Any])
    ...
    inline def setPlay(value: PlayParam): Self = StObject.set(x, "play", value.asInstanceOf[js.Any])
    
    inline def setPlaybackRateChanged(value: PlaybackRateChangedParam): Self = StObject.set(x, "playbackRateChanged", value.asInstanceOf[js.Any])
    
    inline def setPlaylist(value: PlaylistParam): Self = StObject.set(x, "playlist", value.asInstanceOf[js.Any])
    
    inline def setPlaylistItem(value: PlaylistItemParam): Self = StObject.set(x, "playlistItem", value.asInstanceOf[js.Any])
    
    inline def setReady(value: ReadyParam): Self = StObject.set(x, "ready", value.asInstanceOf[js.Any])
    
    inline def setResize(value: ResizeParam): Self = StObject.set(x, "resize", value.asInstanceOf[js.Any])
    
    inline def setSeek(value: SeekParam): Self = StObject.set(x, "seek", value.asInstanceOf[js.Any])
    
    inline def setSetupError(value: ErrorParam): Self = StObject.set(x, "setupError", value.asInstanceOf[js.Any])
    
    inline def setTime(value: TimeParam): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
