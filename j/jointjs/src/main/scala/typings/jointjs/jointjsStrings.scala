...
object jointjsStrings {
  ...
  @js.native
  sealed trait doubleMesh extends js.Object
  ...
  @scala.inline
  def doubleMesh: doubleMesh = "doubleMesh".asInstanceOf[doubleMesh]
  @scala.inline
  ...
  @scala.inline
  def `network-simplex`: `network-simplex` = "network-simplex".asInstanceOf[`network-simplex`]
  @scala.inline
  ...
  @scala.inline
  def `tight-tree`: `tight-tree` = "tight-tree".asInstanceOf[`tight-tree`]
  @scala.inline
