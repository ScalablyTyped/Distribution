...
package object g {
  ...
  */
  ...
  @scala.inline
  def random(min: js.UndefOr[scala.Nothing], max: scala.Double): scala.Double = (typings.jointjs.mod.g.^.asInstanceOf[js.Dynamic].applyDynamic("random")(min.asInstanceOf[js.Any], max.asInstanceOf[js.Any])).asInstanceOf[scala.Double]
  @scala.inline
