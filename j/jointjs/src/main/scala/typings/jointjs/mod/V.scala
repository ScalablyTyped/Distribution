...
object V extends js.Object {
  ...
  def apply(svg: String, attrs: js.UndefOr[scala.Nothing], children: SVGElement): Vectorizer = js.native
  ...
  def apply(svg: Vectorizer, attrs: js.UndefOr[scala.Nothing], children: js.Array[SVGElement | Vectorizer]): Vectorizer = js.native
  def apply(svg: Vectorizer, attrs: js.UndefOr[scala.Nothing], children: Vectorizer): Vectorizer = js.native
  def apply(svg: Vectorizer, attrs: js.UndefOr[scala.Nothing], children: SVGElement): Vectorizer = js.native
  ...
  def apply(svg: SVGElement, attrs: js.UndefOr[scala.Nothing], children: js.Array[SVGElement | Vectorizer]): Vectorizer = js.native
  def apply(svg: SVGElement, attrs: js.UndefOr[scala.Nothing], children: Vectorizer): Vectorizer = js.native
  def apply(svg: SVGElement, attrs: js.UndefOr[scala.Nothing], children: SVGElement): Vectorizer = js.native
