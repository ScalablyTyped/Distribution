...
object bezier {
  ...
  inline def curveThroughPoints(points: js.Array[PlainPoint | Point]): js.Array[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("curveThroughPoints")(points.asInstanceOf[js.Any]).asInstanceOf[js.Array[String]]
  
  inline def getCurveControlPoints(points: js.Array[PlainPoint | Point]): js.Tuple2[js.Array[Point], js.Array[Point]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getCurveControlPoints")(points.asInstanceOf[js.Any]).asInstanceOf[js.Tuple2[js.Array[Point], js.Array[Point]]]
  ...
  object IBezierCurve {
    ...
    inline def apply(p0: Point, p1: Point, p2: Point, p3: Point): IBezierCurve = {
    ...
    extension [Self <: IBezierCurve](x: Self) {
      
      inline def setP0(value: Point): Self = StObject.set(x, "p0", value.asInstanceOf[js.Any])
      ...
      inline def setP3(value: Point): Self = StObject.set(x, "p3", value.asInstanceOf[js.Any])
    }
  }
}
