...
object GenericRouterJSON {
  @scala.inline
  def apply[/* <: typings.jointjs.mod.routers.RouterType */ K](name: K): GenericRouterJSON[K] = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[GenericRouterJSON[K]]
  }
  @scala.inline
  implicit class GenericRouterJSONOps[Self <: GenericRouterJSON[_], /* <: typings.jointjs.mod.routers.RouterType */ K] (val x: Self with GenericRouterJSON[K]) extends AnyVal {
    @scala.inline
