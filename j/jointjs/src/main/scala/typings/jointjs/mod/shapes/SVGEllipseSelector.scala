...
object SVGEllipseSelector {
  ...
  inline def apply(): SVGEllipseSelector = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SVGEllipseSelector]
  }
  
  extension [Self <: SVGEllipseSelector](x: Self) {
    
    inline def setEllipse(value: SVGEllipseAttributes): Self = StObject.set(x, "ellipse", value.asInstanceOf[js.Any])
