...
object BundleValueType extends StObject {
  ...
  /* "BYTES" */ val BYTES: typings.tizenCommonWeb.tizenMod.BundleValueType.BYTES with String = js.native
  
  @js.native
  sealed trait BYTES_ARRAY extends BundleValueType
  /* "BYTES_ARRAY" */ val BYTES_ARRAY: typings.tizenCommonWeb.tizenMod.BundleValueType.BYTES_ARRAY with String = js.native
  
  @js.native
  sealed trait STRING extends BundleValueType
  /* "STRING" */ val STRING: typings.tizenCommonWeb.tizenMod.BundleValueType.STRING with String = js.native
  
  @js.native
  sealed trait STRING_ARRAY extends BundleValueType
  /* "STRING_ARRAY" */ val STRING_ARRAY: typings.tizenCommonWeb.tizenMod.BundleValueType.STRING_ARRAY with String = js.native
}
