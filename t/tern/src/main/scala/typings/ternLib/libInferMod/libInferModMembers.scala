...
@js.native
object libInferModMembers extends js.Object {
  val ANull: ANull = js.native
  ...
  def expressionType(expr: ternLib.Anon_Node): AVal | Type = js.native
  ...
  def withContext(context: Context, f: js.Function0[scala.Unit]): scala.Unit = js.native
}
