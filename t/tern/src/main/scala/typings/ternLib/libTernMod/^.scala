...
object ^ extends js.Object {
  ...
  def defineQueryType[T /* <: /* import warning: ImportType.apply Failed type conversion: tern.tern/lib/tern.Query['type'] */ js.Any */](name: T, desc: Desc[T]): scala.Unit = js.native
  def registerPlugin(
