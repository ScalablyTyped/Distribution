...
package object libTernMod {
  ...
  type Query = /* import warning: ImportType.apply Failed type conversion: tern.Anon_QueryResult | tern.Anon_QueryResultFilesQuery | tern.Anon_QueryResultRenameQuery | tern.Anon_QueryResultRefsQuery | tern.Anon_QueryResultPropertiesQuery | tern.Anon_QueryResultDefinitionQuery | tern.Anon_QueryResultTypeQuery | tern.Anon_QueryResultCompletionsQuery['query'] */ js.Any
