...
trait AnonEndFile extends js.Object {
...
object AnonEndFile {
  @scala.inline
  def apply(end: Double | Position, file: String, start: Double | Position, text: String): AnonEndFile = {
    ...
    __obj.asInstanceOf[AnonEndFile]
  }
}
