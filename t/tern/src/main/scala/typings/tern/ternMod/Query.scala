...
object Query {
  ...
  inline def CompletionsQuery(end: Double | Position, file: String): typings.tern.ternMod.CompletionsQuery = {
  ...
  inline def DefinitionQuery(end: Double | Position, file: String): typings.tern.ternMod.DefinitionQuery = {
    val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], file = file.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("definition")
    __obj.asInstanceOf[typings.tern.ternMod.DefinitionQuery]
  }
  
  inline def DocumentationQuery(end: Double | Position, file: String): typings.tern.ternMod.DocumentationQuery = {
    val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], file = file.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("documentation")
    __obj.asInstanceOf[typings.tern.ternMod.DocumentationQuery]
  }
  
  inline def FilesQuery(): typings.tern.ternMod.FilesQuery = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("files")
    __obj.asInstanceOf[typings.tern.ternMod.FilesQuery]
  }
  
  inline def PropertiesQuery(): typings.tern.ternMod.PropertiesQuery = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("properties")
    __obj.asInstanceOf[typings.tern.ternMod.PropertiesQuery]
  }
  
  inline def RefsQuery(end: Double | Position, file: String): typings.tern.ternMod.RefsQuery = {
    val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], file = file.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("refs")
    __obj.asInstanceOf[typings.tern.ternMod.RefsQuery]
  }
  
  inline def RenameQuery(end: Double | Position, file: String, newName: String): typings.tern.ternMod.RenameQuery = {
  ...
  inline def TypeQuery(end: Double | Position, file: String): typings.tern.ternMod.TypeQuery = {
    val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], file = file.asInstanceOf[js.Any])
