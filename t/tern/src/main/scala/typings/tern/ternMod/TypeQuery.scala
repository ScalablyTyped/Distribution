...
object TypeQuery {
  ...
  inline def apply(end: Double | Position, file: String): TypeQuery = {
  ...
  extension [Self <: TypeQuery](x: Self) {
    ...
    inline def setPreferFunction(value: Boolean): Self = StObject.set(x, "preferFunction", value.asInstanceOf[js.Any])
    
    inline def setPreferFunctionUndefined: Self = StObject.set(x, "preferFunction", js.undefined)
