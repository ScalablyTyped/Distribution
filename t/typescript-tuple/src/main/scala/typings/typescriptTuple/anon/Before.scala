...
object Before {
  ...
  inline def apply[Tuple /* <: js.Array[js.Any] */, Holder /* <: js.Array[js.Any] */](
  ...
  extension [Self <: Before[?, ?], Tuple /* <: js.Array[js.Any] */, Holder /* <: js.Array[js.Any] */](x: Self & (Before[Tuple, Holder])) {
    ...
    inline def setEnd(value: Reverse[Holder, js.Array[js.Any]]): Self = StObject.set(x, "end", value.asInstanceOf[js.Any])
