...
object InfiniteNonEmpty {
  ...
  @scala.inline
  implicit class InfiniteNonEmptyOps[Self <: InfiniteNonEmpty[_, _, _, _], NotFound, /* <: js.Array[_] */ Tuple, Type, /* <: js.Array[_] */ Count] (val x: Self with (InfiniteNonEmpty[NotFound, Tuple, Type, Count])) extends AnyVal {
    @scala.inline
