...
object EmptyLongest {
  ...
  @scala.inline
  implicit class EmptyLongestOps[Self <: EmptyLongest[_, _], Longest, TupleSet /* <: js.Array[js.Array[_]] */] (val x: Self with (EmptyLongest[Longest, TupleSet])) extends AnyVal {
