...
@js.native
trait NonEmpty[NotFound, Tuple /* <: js.Array[_] */, Type, Count /* <: js.Array[_] */] extends StObject {
...
object NonEmpty {
  ...
  @scala.inline
  implicit class NonEmptyMutableBuilder[Self <: NonEmpty[_, _, _, _], NotFound, Tuple /* <: js.Array[_] */, Type, Count /* <: js.Array[_] */] (val x: Self with (NonEmpty[NotFound, Tuple, Type, Count])) extends AnyVal {
