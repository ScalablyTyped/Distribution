...
trait Anon1Equal[Left /* <: js.Array[_] */, Right /* <: js.Array[_] */] extends js.Object {
  var fitBoth: equal
...
object Anon1Equal {
  @scala.inline
  def apply[Left /* <: js.Array[_] */, Right /* <: js.Array[_] */](fitBoth: equal, fitLeft: shorterLeft, fitRight: shorterRight, unfit: js.Any): Anon1Equal[Left, Right] = {
    ...
    __obj.asInstanceOf[Anon1Equal[Left, Right]]
  }
}
