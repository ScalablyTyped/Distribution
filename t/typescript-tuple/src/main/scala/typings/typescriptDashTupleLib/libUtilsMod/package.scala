...
package object libUtilsMod {
  type Concat[Left /* <: js.Array[_] */, Right /* <: js.Array[_] */] = (Prepend[Right, js.Any]) | Right
  ...
  type IsFinite[Tuple /* <: js.Array[_] */, Finite, Infinite] = Infinite | Finite
  ...
  type LongestTuple[TupleSet /* <: js.Array[js.Array[_]] */, Longest] = (/* import warning: ImportType.apply Failed type conversion: typescript-tuple.typescript-tuple/lib/utils.SortTwoTuple<Longest, any, [Longest, any]>[1] */ js.Any) | Longest
  ...
  type ShortestTuple[TupleSet /* <: js.Array[js.Array[_]] */, Shortest] = (/* import warning: ImportType.apply Failed type conversion: typescript-tuple.typescript-tuple/lib/utils.SortTwoTuple<Shortest, any, [Shortest, any]>[0] */ js.Any) | Shortest
