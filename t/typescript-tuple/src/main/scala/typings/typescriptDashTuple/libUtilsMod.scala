...
object libUtilsMod extends js.Object {
  ...
  type _AllIndexesEqual[Type, Tuple /* <: js.Array[_] */, Holder /* <: js.Array[_] */, Count /* <: js.Array[_] */] = /* import warning: importer.ImportType#apply Failed type conversion: typescript-tuple.Anon_1EmptyInfiniteNonEmpty<Holder, Tuple>[Tuple extends [] ? 'empty' : typescript-tuple.typescript-tuple/lib/utils.IsFinite<Tuple, 'nonEmpty', 'infinite'>] */ js.Any
  type _AllIndexesSubset[Type, Tuple /* <: js.Array[_] */, Holder /* <: js.Array[_] */, Count /* <: js.Array[_] */] = /* import warning: importer.ImportType#apply Failed type conversion: typescript-tuple.Anon_1EmptyInfiniteNonEmpty<Holder, Tuple>[Tuple extends [] ? 'empty' : typescript-tuple.typescript-tuple/lib/utils.IsFinite<Tuple, 'nonEmpty', 'infinite'>] */ js.Any
  type _AllIndexesSuperset[Type, Tuple /* <: js.Array[_] */, Holder /* <: js.Array[_] */, Count /* <: js.Array[_] */] = /* import warning: importer.ImportType#apply Failed type conversion: typescript-tuple.Anon_1EmptyInfiniteNonEmpty<Holder, Tuple>[Tuple extends [] ? 'empty' : typescript-tuple.typescript-tuple/lib/utils.IsFinite<Tuple, 'nonEmpty', 'infinite'>] */ js.Any
