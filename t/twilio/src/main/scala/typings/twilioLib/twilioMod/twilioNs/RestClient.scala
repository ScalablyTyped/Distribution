...
trait RestClient extends Client {
  ...
  def getCall(callSid: java.lang.String): qLib.qMod.QNs.Promise[_] = js.native
  def getCall(callSid: java.lang.String, callback: RequestCallback): qLib.qMod.QNs.Promise[_] = js.native
  def getMessage(messageSid: java.lang.String): qLib.qMod.QNs.Promise[_] = js.native
  def getMessage(messageSid: java.lang.String, callback: RequestCallback): qLib.qMod.QNs.Promise[_] = js.native
  def getSms(messageSid: java.lang.String): qLib.qMod.QNs.Promise[_] = js.native
  def getSms(messageSid: java.lang.String, callback: RequestCallback): qLib.qMod.QNs.Promise[_] = js.native
  ...
  def listCalls(args: js.Any): qLib.qMod.QNs.Promise[_] = js.native
  def listCalls(args: js.Any, callback: RequestCallback): qLib.qMod.QNs.Promise[_] = js.native
  def listCalls(callback: RequestCallback): qLib.qMod.QNs.Promise[_] = js.native
  def listMessages(args: js.Any): qLib.qMod.QNs.Promise[_] = js.native
  def listMessages(args: js.Any, callback: RequestCallback): qLib.qMod.QNs.Promise[_] = js.native
  def listMessages(callback: RequestCallback): qLib.qMod.QNs.Promise[_] = js.native
  def listSms(args: js.Any): qLib.qMod.QNs.Promise[_] = js.native
  def listSms(args: js.Any, callback: RequestCallback): qLib.qMod.QNs.Promise[_] = js.native
  ...
  def sendMessage(args: js.Any): qLib.qMod.QNs.Promise[_] = js.native
  def sendMessage(args: js.Any, callback: RequestCallback): qLib.qMod.QNs.Promise[_] = js.native
  def sendMessage(callback: RequestCallback): qLib.qMod.QNs.Promise[_] = js.native
  def sendMms(args: js.Any): qLib.qMod.QNs.Promise[_] = js.native
  def sendMms(args: js.Any, callback: RequestCallback): qLib.qMod.QNs.Promise[_] = js.native
