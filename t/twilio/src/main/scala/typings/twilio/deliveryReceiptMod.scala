...
object deliveryReceiptMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/message/deliveryReceipt", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/message/deliveryReceipt", "DeliveryReceiptContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/conversations/v1/conversation/message/deliveryReceipt", "DeliveryReceiptInstance")
  @js.native
  ...
  /**
    ...
    * @param messageSid - The SID of the message the delivery receipt belongs to
    */
  inline def DeliveryReceiptList(version: typings.twilio.conversationsV1Mod.^, conversationSid: String, messageSid: String): DeliveryReceiptListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DeliveryReceiptList")(version.asInstanceOf[js.Any], conversationSid.asInstanceOf[js.Any], messageSid.asInstanceOf[js.Any])).asInstanceOf[DeliveryReceiptListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/message/deliveryReceipt", "DeliveryReceiptPage")
  @js.native
