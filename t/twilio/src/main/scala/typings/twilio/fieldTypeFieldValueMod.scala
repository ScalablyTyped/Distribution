...
object fieldTypeFieldValueMod {
  ...
  open class FieldValueContext protected () extends StObject {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.understandMod.^, assistantSid: String, fieldTypeSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param fieldTypeSid - The unique ID of the Field Type associated with this Field Value.
    */
  inline def FieldValueList(version: typings.twilio.understandMod.^, assistantSid: String, fieldTypeSid: String): FieldValueListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("FieldValueList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any], fieldTypeSid.asInstanceOf[js.Any])).asInstanceOf[FieldValueListInstance]
