...
object conversationsV1CredentialMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/credential", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/credential", "CredentialContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/conversations/v1/credential", "CredentialInstance")
  @js.native
  open class CredentialInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - A 34 character string that uniquely identifies this resource.
      */
    def this(version: typings.twilio.conversationsV1Mod.^, payload: CredentialPayload, sid: String) = this()
    ...
    var `type`: CredentialPushType = js.native
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def CredentialList(version: typings.twilio.conversationsV1Mod.^): CredentialListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("CredentialList")(version.asInstanceOf[js.Any]).asInstanceOf[CredentialListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/credential", "CredentialPage")
  @js.native
  ...
  trait CredentialInstanceUpdateOptions extends StObject {
    ...
    var `type`: js.UndefOr[CredentialPushType] = js.undefined
  }
  object CredentialInstanceUpdateOptions {
    ...
    extension [Self <: CredentialInstanceUpdateOptions](x: Self) {
      ...
      inline def setType(value: CredentialPushType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  trait CredentialListInstanceCreateOptions extends StObject {
    ...
    var `type`: CredentialPushType
  }
  object CredentialListInstanceCreateOptions {
    
    inline def apply(`type`: CredentialPushType): CredentialListInstanceCreateOptions = {
      val __obj = js.Dynamic.literal()
  ...
  */
  trait CredentialPushType extends StObject
  object CredentialPushType {
