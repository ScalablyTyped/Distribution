...
object libBasePageMod {
  ...
  @js.native
  open class ^[TVersion /* <: typings.twilio.libBaseVersionMod.^ */, TPayload /* <: TwilioResponsePayload */, TResource, TInstance] protected ()
    extends StObject
    ...
    def this(
      version: TVersion,
      response: typings.twilio.libHttpResponseMod.^[String | js.Object],
      solution: Solution
    ) = this()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def processResponse(response: typings.twilio.libHttpResponseMod.^[String | js.Object]): TPayload = js.native
  }
  @JSImport("twilio/lib/base/Page", JSImport.Namespace)
  @js.native
  ...
  /**
    * Base page object to maintain request state.
    */
  trait Page[TVersion /* <: typings.twilio.libBaseVersionMod.^ */, TPayload /* <: TwilioResponsePayload */, TResource, TInstance] extends StObject {
    ...
    /**
      ...
      * @return json parsed response
      */
    def processResponse(response: typings.twilio.libHttpResponseMod.^[String | js.Object]): TPayload
  }
  object Page {
    
    inline def apply[TVersion /* <: typings.twilio.libBaseVersionMod.^ */, TPayload /* <: TwilioResponsePayload */, TResource, TInstance](
      ...
      processResponse: typings.twilio.libHttpResponseMod.^[String | js.Object] => TPayload
    ...
    extension [Self <: Page[?, ?, ?, ?], TVersion /* <: typings.twilio.libBaseVersionMod.^ */, TPayload /* <: TwilioResponsePayload */, TResource, TInstance](x: Self & (Page[TVersion, TPayload, TResource, TInstance])) {
      ...
      inline def setProcessResponse(value: typings.twilio.libHttpResponseMod.^[String | js.Object] => TPayload): Self = StObject.set(x, "processResponse", js.Any.fromFunction1(value))
    }
  }
