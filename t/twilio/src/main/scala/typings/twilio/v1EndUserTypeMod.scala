...
object v1EndUserTypeMod {
  
  @JSImport("twilio/lib/rest/trusthub/v1/endUserType", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/trusthub/v1/endUserType", "EndUserTypeContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/trusthub/v1/endUserType", "EndUserTypeInstance")
  @js.native
  open class EndUserTypeInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The unique string that identifies the End-User Type resource
      */
    def this(version: typings.twilio.trusthubV1Mod.^, payload: EndUserTypePayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def EndUserTypeList(version: typings.twilio.trusthubV1Mod.^): EndUserTypeListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("EndUserTypeList")(version.asInstanceOf[js.Any]).asInstanceOf[EndUserTypeListInstance]
  
  @JSImport("twilio/lib/rest/trusthub/v1/endUserType", "EndUserTypePage")
  @js.native
