...
object executionStepExecutionStepContextMod {
  
  @JSImport("twilio/lib/rest/studio/v2/flow/execution/executionStep/executionStepContext", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/studio/v2/flow/execution/executionStep/executionStepContext", "ExecutionStepContextContext")
  @js.native
  open class ExecutionStepContextContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.studioV2Mod.^, flowSid: String, executionSid: String, stepSid: String) = this()
  ...
  @JSImport("twilio/lib/rest/studio/v2/flow/execution/executionStep/executionStepContext", "ExecutionStepContextInstance")
  @js.native
  ...
  /**
    ...
    * @param stepSid - Step SID
    */
  inline def ExecutionStepContextList(version: typings.twilio.studioV2Mod.^, flowSid: String, executionSid: String, stepSid: String): ExecutionStepContextListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ExecutionStepContextList")(version.asInstanceOf[js.Any], flowSid.asInstanceOf[js.Any], executionSid.asInstanceOf[js.Any], stepSid.asInstanceOf[js.Any])).asInstanceOf[ExecutionStepContextListInstance]
  
  @JSImport("twilio/lib/rest/studio/v2/flow/execution/executionStep/executionStepContext", "ExecutionStepContextPage")
  @js.native
