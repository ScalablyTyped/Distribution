...
object simUsageMod {
  ...
  open class UsageContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.wirelessMod.^, simSid: String) = this()
  ...
  open class UsageInstance protected () extends SerializableClass {
    /**
      ...
      * @param simSid - The sim_sid
      */
    def this(version: typings.twilio.wirelessMod.^, payload: UsagePayload, simSid: String) = this()
  ...
  /**
    ...
    * @param simSid - The sim_sid
    */
  inline def UsageList(version: typings.twilio.wirelessMod.^, simSid: String): UsageListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UsageList")(version.asInstanceOf[js.Any], simSid.asInstanceOf[js.Any])).asInstanceOf[UsageListInstance]
  
  @JSImport("twilio/lib/rest/preview/wireless/sim/usage", "UsagePage")
  @js.native
  open class UsagePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.wirelessMod.^, UsagePayload, UsageResource, UsageInstance] {
    /**
