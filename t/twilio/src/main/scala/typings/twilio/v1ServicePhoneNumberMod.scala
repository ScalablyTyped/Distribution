...
object v1ServicePhoneNumberMod {
  
  @JSImport("twilio/lib/rest/proxy/v1/service/phoneNumber", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/proxy/v1/service/phoneNumber", "PhoneNumberContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/proxy/v1/service/phoneNumber", "PhoneNumberInstance")
  @js.native
  open class PhoneNumberInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The unique string that identifies the resource
      */
    def this(version: typings.twilio.proxyV1Mod.^, payload: PhoneNumberPayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The SID of the PhoneNumber resource's parent Service resource
    */
  inline def PhoneNumberList(version: typings.twilio.proxyV1Mod.^, serviceSid: String): PhoneNumberListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("PhoneNumberList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[PhoneNumberListInstance]
  
  @JSImport("twilio/lib/rest/proxy/v1/service/phoneNumber", "PhoneNumberPage")
  @js.native
  ...
  trait PhoneNumberListInstance extends StObject {
    ...
    /**
      ...
      * @param callback - Callback to handle processed record
      */
    def create(): js.Promise[PhoneNumberInstance] = js.native
    def create(callback: js.Function2[/* error */ js.Error | Null, /* item */ PhoneNumberInstance, Any]): js.Promise[PhoneNumberInstance] = js.native
    def create(
      opts: Unit,
  ...
  object PhoneNumberListInstanceCreateOptions {
    ...
    inline def apply(): PhoneNumberListInstanceCreateOptions = {
      val __obj = js.Dynamic.literal()
  ...
  object PhoneNumberPayload {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], capabilities = capabilities.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], first_page_uri = first_page_uri.asInstanceOf[js.Any], friendly_name = friendly_name.asInstanceOf[js.Any], in_use = in_use.asInstanceOf[js.Any], is_reserved = is_reserved.asInstanceOf[js.Any], iso_country = iso_country.asInstanceOf[js.Any], next_page_uri = next_page_uri.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], page_size = page_size.asInstanceOf[js.Any], phone_number = phone_number.asInstanceOf[js.Any], previous_page_uri = previous_page_uri.asInstanceOf[js.Any], service_sid = service_sid.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
  ...
  object PhoneNumberResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], capabilities = capabilities.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], friendly_name = friendly_name.asInstanceOf[js.Any], in_use = in_use.asInstanceOf[js.Any], is_reserved = is_reserved.asInstanceOf[js.Any], iso_country = iso_country.asInstanceOf[js.Any], phone_number = phone_number.asInstanceOf[js.Any], service_sid = service_sid.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    ...
    extension [Self <: PhoneNumberResource](x: Self) {
      ...
      inline def setIn_use(value: Double): Self = StObject.set(x, "in_use", value.asInstanceOf[js.Any])
