...
import typings.twilio.userBindingMod.UserBindingContext
import typings.twilio.userBindingMod.UserBindingListInstance
import typings.twilio.userUserChannelMod.UserChannelContext
import typings.twilio.userUserChannelMod.UserChannelListInstance
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object serviceUserMod {
  
  @JSImport("twilio/lib/rest/chat/v2/service/user", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v2/service/user", "UserContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/chat/v2/service/user", "UserInstance")
  @js.native
  open class UserInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the User resource to fetch
      */
    def this(version: typings.twilio.v2Mod.^, payload: UserPayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The SID of the Service that the resource is associated with
    */
  inline def UserList(version: typings.twilio.v2Mod.^, serviceSid: String): UserListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UserList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[UserListInstance]
  
  @JSImport("twilio/lib/rest/chat/v2/service/user", "UserPage")
  @js.native
  open class UserPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2Mod.^, UserPayload, UserResource, UserInstance] {
    /**
