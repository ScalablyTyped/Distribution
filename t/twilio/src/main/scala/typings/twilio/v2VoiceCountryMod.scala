...
object v2VoiceCountryMod {
  
  @JSImport("twilio/lib/rest/pricing/v2/voice/country", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/pricing/v2/voice/country", "CountryContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/pricing/v2/voice/country", "CountryInstance")
  @js.native
  open class CountryInstance protected () extends SerializableClass {
    ...
    var inboundCallPrices: js.Array[String] = js.native
    
    var isoCountry: String = js.native
    
    var outboundPrefixPrices: js.Array[String] = js.native
  ...
  @JSImport("twilio/lib/rest/pricing/v2/voice/country", "CountryPage")
  @js.native
  ...
  trait CountryResource extends StObject {
    ...
    var inbound_call_prices: js.UndefOr[js.Array[String]] = js.undefined
    
    var iso_country: String
    
    var outbound_prefix_prices: js.UndefOr[js.Array[String]] = js.undefined
  ...
  object CountryResource {
    ...
    extension [Self <: CountryResource](x: Self) {
      ...
      inline def setInbound_call_prices(value: js.Array[String]): Self = StObject.set(x, "inbound_call_prices", value.asInstanceOf[js.Any])
      
      inline def setInbound_call_pricesUndefined: Self = StObject.set(x, "inbound_call_prices", js.undefined)
      
      inline def setInbound_call_pricesVarargs(value: String*): Self = StObject.set(x, "inbound_call_prices", js.Array(value*))
      
      inline def setIso_country(value: String): Self = StObject.set(x, "iso_country", value.asInstanceOf[js.Any])
      
      inline def setOutbound_prefix_prices(value: js.Array[String]): Self = StObject.set(x, "outbound_prefix_prices", value.asInstanceOf[js.Any])
      
      inline def setOutbound_prefix_pricesUndefined: Self = StObject.set(x, "outbound_prefix_prices", js.undefined)
      
      inline def setOutbound_prefix_pricesVarargs(value: String*): Self = StObject.set(x, "outbound_prefix_prices", js.Array(value*))
