...
object serviceParticipantConversationMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/service/participantConversation", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/service/participantConversation", "ParticipantConversationInstance")
  @js.native
  ...
  /**
    ...
    * @param chatServiceSid - The unique ID of the Conversation Service this conversation belongs to.
    */
  inline def ParticipantConversationList(version: typings.twilio.conversationsV1Mod.^, chatServiceSid: String): ParticipantConversationListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ParticipantConversationList")(version.asInstanceOf[js.Any], chatServiceSid.asInstanceOf[js.Any])).asInstanceOf[ParticipantConversationListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/service/participantConversation", "ParticipantConversationPage")
  @js.native
  ...
  object ParticipantConversationSolution {
    
    inline def apply(): ParticipantConversationSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ParticipantConversationSolution]
    }
    
    extension [Self <: ParticipantConversationSolution](x: Self) {
