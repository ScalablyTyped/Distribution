...
import typings.twilio.executionExecutionContextMod.ExecutionContextContext
import typings.twilio.executionExecutionContextMod.ExecutionContextListInstance
import typings.twilio.executionExecutionStepMod.ExecutionStepContext
import typings.twilio.executionExecutionStepMod.ExecutionStepListInstance
...
object flowExecutionMod {
  
  @JSImport("twilio/lib/rest/studio/v2/flow/execution", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/studio/v2/flow/execution", "ExecutionContext")
  @js.native
  open class ExecutionContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.studioV2Mod.^, flowSid: String, sid: String) = this()
  ...
  @JSImport("twilio/lib/rest/studio/v2/flow/execution", "ExecutionInstance")
  @js.native
  open class ExecutionInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the Execution resource to fetch
      */
    def this(version: typings.twilio.studioV2Mod.^, payload: ExecutionPayload, flowSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param flowSid - The SID of the Flow
    */
  inline def ExecutionList(version: typings.twilio.studioV2Mod.^, flowSid: String): ExecutionListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ExecutionList")(version.asInstanceOf[js.Any], flowSid.asInstanceOf[js.Any])).asInstanceOf[ExecutionListInstance]
  
  @JSImport("twilio/lib/rest/studio/v2/flow/execution", "ExecutionPage")
  @js.native
  open class ExecutionPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.studioV2Mod.^, ExecutionPayload, ExecutionResource, ExecutionInstance] {
    /**
