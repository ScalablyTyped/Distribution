...
import typings.twilio.assignedAddOnMod.AssignedAddOnContext
import typings.twilio.assignedAddOnMod.AssignedAddOnListInstance
import typings.twilio.incomingPhoneNumberLocalMod.LocalListInstance
import typings.twilio.incomingPhoneNumberMobileMod.MobileListInstance
import typings.twilio.incomingPhoneNumberTollFreeMod.TollFreeListInstance
...
object incomingPhoneNumberMod {
  
  @JSImport("twilio/lib/rest/api/v2010/account/incomingPhoneNumber", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/incomingPhoneNumber", "IncomingPhoneNumberContext")
  @js.native
  open class IncomingPhoneNumberContext protected () extends StObject {
    /**
    ...
    /**
      ...
      */
    def assignedAddOns(sid: String): AssignedAddOnContext = js.native
    @JSName("assignedAddOns")
    var assignedAddOns_Original: AssignedAddOnListInstance = js.native
    ...
    /**
      ...
      */
    def fetch(): js.Promise[IncomingPhoneNumberInstance] = js.native
    def fetch(callback: js.Function2[/* error */ js.Error | Null, /* items */ IncomingPhoneNumberInstance, Any]): js.Promise[IncomingPhoneNumberInstance] = js.native
    ...
    def remove(callback: js.Function2[/* error */ js.Error | Null, /* items */ IncomingPhoneNumberInstance, Any]): js.Promise[Boolean] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle processed record
      */
    def update(): js.Promise[IncomingPhoneNumberInstance] = js.native
    def update(callback: js.Function2[/* error */ js.Error | Null, /* items */ IncomingPhoneNumberInstance, Any]): js.Promise[IncomingPhoneNumberInstance] = js.native
    def update(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ IncomingPhoneNumberInstance, Any]
    ): js.Promise[IncomingPhoneNumberInstance] = js.native
    def update(opts: IncomingPhoneNumberInstanceUpdateOptions): js.Promise[IncomingPhoneNumberInstance] = js.native
    def update(
      opts: IncomingPhoneNumberInstanceUpdateOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ IncomingPhoneNumberInstance, Any]
    ): js.Promise[IncomingPhoneNumberInstance] = js.native
  }
  
  @JSImport("twilio/lib/rest/api/v2010/account/incomingPhoneNumber", "IncomingPhoneNumberInstance")
  @js.native
  open class IncomingPhoneNumberInstance protected () extends SerializableClass {
    /**
      * Initialize the IncomingPhoneNumberContext
      *
      * @param version - Version of the resource
    ...
    /* private */ var _proxy: IncomingPhoneNumberContext = js.native
    
    var accountSid: String = js.native
    
    var addressRequirements: IncomingPhoneNumberAddressRequirement = js.native
    ...
    /**
      ...
      */
    def assignedAddOns(): AssignedAddOnListInstance = js.native
    ...
    var emergencyAddressStatus: IncomingPhoneNumberEmergencyAddressStatus = js.native
    
    var emergencyStatus: IncomingPhoneNumberEmergencyStatus = js.native
    ...
    /**
      ...
      */
    def fetch(): js.Promise[IncomingPhoneNumberInstance] = js.native
    def fetch(callback: js.Function2[/* error */ js.Error | Null, /* items */ this.type, Any]): js.Promise[IncomingPhoneNumberInstance] = js.native
    ...
    /**
      ...
      */
    def update(): js.Promise[IncomingPhoneNumberInstance] = js.native
    def update(callback: js.Function2[/* error */ js.Error | Null, /* items */ this.type, Any]): js.Promise[IncomingPhoneNumberInstance] = js.native
    def update(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ this.type, Any]): js.Promise[IncomingPhoneNumberInstance] = js.native
    def update(opts: IncomingPhoneNumberInstanceUpdateOptions): js.Promise[IncomingPhoneNumberInstance] = js.native
    def update(
      opts: IncomingPhoneNumberInstanceUpdateOptions,
    ...
    var voiceReceiveMode: IncomingPhoneNumberVoiceReceiveMode = js.native
  ...
  /**
    ...
    * @param accountSid - The SID of the Account that created the resource
    */
  inline def IncomingPhoneNumberList(version: typings.twilio.v2010Mod.^, accountSid: String): IncomingPhoneNumberListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("IncomingPhoneNumberList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any])).asInstanceOf[IncomingPhoneNumberListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/incomingPhoneNumber", "IncomingPhoneNumberPage")
  @js.native
  open class IncomingPhoneNumberPage protected ()
    ...
    /**
      ...
      */
    def getInstance(payload: IncomingPhoneNumberPayload): IncomingPhoneNumberInstance = js.native
  ...
  */
  trait IncomingPhoneNumberAddressRequirement extends StObject
  object IncomingPhoneNumberAddressRequirement {
  ...
  */
  trait IncomingPhoneNumberEmergencyAddressStatus extends StObject
  object IncomingPhoneNumberEmergencyAddressStatus {
  ...
  */
  trait IncomingPhoneNumberEmergencyStatus extends StObject
  object IncomingPhoneNumberEmergencyStatus {
  ...
  /**
    ...
    */
  trait IncomingPhoneNumberInstanceUpdateOptions extends StObject {
    ...
    var emergencyStatus: js.UndefOr[IncomingPhoneNumberEmergencyStatus] = js.undefined
    ...
    var voiceReceiveMode: js.UndefOr[IncomingPhoneNumberVoiceReceiveMode] = js.undefined
    
    var voiceUrl: js.UndefOr[String] = js.undefined
  }
  object IncomingPhoneNumberInstanceUpdateOptions {
    
    inline def apply(): IncomingPhoneNumberInstanceUpdateOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[IncomingPhoneNumberInstanceUpdateOptions]
    }
    
    extension [Self <: IncomingPhoneNumberInstanceUpdateOptions](x: Self) {
      ...
      inline def setEmergencyStatus(value: IncomingPhoneNumberEmergencyStatus): Self = StObject.set(x, "emergencyStatus", value.asInstanceOf[js.Any])
      ...
      inline def setVoiceReceiveMode(value: IncomingPhoneNumberVoiceReceiveMode): Self = StObject.set(x, "voiceReceiveMode", value.asInstanceOf[js.Any])
  ...
  @js.native
  trait IncomingPhoneNumberListInstance extends StObject {
    
    /**
      * @param sid - sid of instance
      */
    def apply(sid: String): IncomingPhoneNumberContext = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle processed record
      */
    def create(): js.Promise[IncomingPhoneNumberInstance] = js.native
    def create(callback: js.Function2[/* error */ js.Error | Null, /* item */ IncomingPhoneNumberInstance, Any]): js.Promise[IncomingPhoneNumberInstance] = js.native
    def create(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* item */ IncomingPhoneNumberInstance, Any]
    ): js.Promise[IncomingPhoneNumberInstance] = js.native
    def create(opts: IncomingPhoneNumberListInstanceCreateOptions): js.Promise[IncomingPhoneNumberInstance] = js.native
    def create(
      opts: IncomingPhoneNumberListInstanceCreateOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* item */ IncomingPhoneNumberInstance, Any]
    ): js.Promise[IncomingPhoneNumberInstance] = js.native
    ...
    def each(opts: IncomingPhoneNumberListInstanceEachOptions): Unit = js.native
    def each(
      opts: IncomingPhoneNumberListInstanceEachOptions,
      callback: js.Function2[
          /* item */ IncomingPhoneNumberInstance, 
          /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit], 
          Unit
    ...
    /**
      ...
      * @param sid - The unique string that identifies the resource
      */
    def get(sid: String): IncomingPhoneNumberContext = js.native
    ...
    /**
      ...
      */
    def getPage(): js.Promise[IncomingPhoneNumberPage] = js.native
    def getPage(callback: js.Function2[/* error */ js.Error | Null, /* items */ IncomingPhoneNumberPage, Any]): js.Promise[IncomingPhoneNumberPage] = js.native
    def getPage(targetUrl: String): js.Promise[IncomingPhoneNumberPage] = js.native
    def getPage(
      targetUrl: String,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ IncomingPhoneNumberPage, Any]
    ): js.Promise[IncomingPhoneNumberPage] = js.native
    def getPage(
      targetUrl: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ IncomingPhoneNumberPage, Any]
    ): js.Promise[IncomingPhoneNumberPage] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def list(): js.Promise[js.Array[IncomingPhoneNumberInstance]] = js.native
    def list(
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[IncomingPhoneNumberInstance], Any]
    ): js.Promise[js.Array[IncomingPhoneNumberInstance]] = js.native
    def list(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[IncomingPhoneNumberInstance], Any]
    ): js.Promise[js.Array[IncomingPhoneNumberInstance]] = js.native
    def list(opts: IncomingPhoneNumberListInstanceOptions): js.Promise[js.Array[IncomingPhoneNumberInstance]] = js.native
    def list(
      opts: IncomingPhoneNumberListInstanceOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[IncomingPhoneNumberInstance], Any]
    ): js.Promise[js.Array[IncomingPhoneNumberInstance]] = js.native
    
    var local: js.UndefOr[LocalListInstance] = js.native
    
    var mobile: js.UndefOr[MobileListInstance] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def page(): js.Promise[IncomingPhoneNumberPage] = js.native
    def page(callback: js.Function2[/* error */ js.Error | Null, /* items */ IncomingPhoneNumberPage, Any]): js.Promise[IncomingPhoneNumberPage] = js.native
    def page(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ IncomingPhoneNumberPage, Any]
    ): js.Promise[IncomingPhoneNumberPage] = js.native
    def page(opts: IncomingPhoneNumberListInstancePageOptions): js.Promise[IncomingPhoneNumberPage] = js.native
    def page(
      opts: IncomingPhoneNumberListInstancePageOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ IncomingPhoneNumberPage, Any]
    ): js.Promise[IncomingPhoneNumberPage] = js.native
    ...
    var tollFree: js.UndefOr[TollFreeListInstance] = js.native
  }
  ...
  /**
    ...
    * @property voiceUrl - The URL we should call when the phone number receives a call
    */
  trait IncomingPhoneNumberListInstanceCreateOptions extends StObject {
  ...
  object IncomingPhoneNumberListInstanceCreateOptions {
    
    inline def apply(): IncomingPhoneNumberListInstanceCreateOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[IncomingPhoneNumberListInstanceCreateOptions]
    }
    
    extension [Self <: IncomingPhoneNumberListInstanceCreateOptions](x: Self) {
  ...
  /**
    ...
    */
  trait IncomingPhoneNumberListInstanceEachOptions extends StObject {
  ...
  object IncomingPhoneNumberListInstanceEachOptions {
    
    inline def apply(): IncomingPhoneNumberListInstanceEachOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[IncomingPhoneNumberListInstanceEachOptions]
    }
    
    extension [Self <: IncomingPhoneNumberListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ IncomingPhoneNumberInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit
  ...
  /**
    ...
    * @property phoneNumber - The phone numbers of the IncomingPhoneNumber resources to read
    */
  trait IncomingPhoneNumberListInstanceOptions extends StObject {
  ...
  object IncomingPhoneNumberListInstanceOptions {
    
    inline def apply(): IncomingPhoneNumberListInstanceOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[IncomingPhoneNumberListInstanceOptions]
    }
    
    extension [Self <: IncomingPhoneNumberListInstanceOptions](x: Self) {
  ...
  /**
    ...
    * @property phoneNumber - The phone numbers of the IncomingPhoneNumber resources to read
    */
  trait IncomingPhoneNumberListInstancePageOptions extends StObject {
  ...
  object IncomingPhoneNumberListInstancePageOptions {
    
    inline def apply(): IncomingPhoneNumberListInstancePageOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[IncomingPhoneNumberListInstancePageOptions]
    }
    
    extension [Self <: IncomingPhoneNumberListInstancePageOptions](x: Self) {
  ...
  - typings.twilio.pageMod.TwilioResponsePayload because var conflicts: uri. Inlined first_page_uri, next_page_uri, page, page_size, previous_page_uri, meta */ trait IncomingPhoneNumberPayload
    extends StObject
       with IncomingPhoneNumberResource {
  ...
  object IncomingPhoneNumberPayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[IncomingPhoneNumberPayload]
    }
    
    extension [Self <: IncomingPhoneNumberPayload](x: Self) {
  ...
  trait IncomingPhoneNumberResource extends StObject {
    
    var account_sid: String
    
    var address_requirements: IncomingPhoneNumberAddressRequirement
    ...
    var emergency_address_status: IncomingPhoneNumberEmergencyAddressStatus
    
    var emergency_status: IncomingPhoneNumberEmergencyStatus
    ...
    var voice_receive_mode: IncomingPhoneNumberVoiceReceiveMode
    
    var voice_url: String
  }
  object IncomingPhoneNumberResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[IncomingPhoneNumberResource]
    }
    
    extension [Self <: IncomingPhoneNumberResource](x: Self) {
      
      inline def setAccount_sid(value: String): Self = StObject.set(x, "account_sid", value.asInstanceOf[js.Any])
      
      inline def setAddress_requirements(value: IncomingPhoneNumberAddressRequirement): Self = StObject.set(x, "address_requirements", value.asInstanceOf[js.Any])
      ...
      inline def setEmergency_address_status(value: IncomingPhoneNumberEmergencyAddressStatus): Self = StObject.set(x, "emergency_address_status", value.asInstanceOf[js.Any])
      
      inline def setEmergency_status(value: IncomingPhoneNumberEmergencyStatus): Self = StObject.set(x, "emergency_status", value.asInstanceOf[js.Any])
      ...
      inline def setVoice_receive_mode(value: IncomingPhoneNumberVoiceReceiveMode): Self = StObject.set(x, "voice_receive_mode", value.asInstanceOf[js.Any])
      
      inline def setVoice_url(value: String): Self = StObject.set(x, "voice_url", value.asInstanceOf[js.Any])
    }
  }
  
  trait IncomingPhoneNumberSolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
  }
  object IncomingPhoneNumberSolution {
    
    inline def apply(): IncomingPhoneNumberSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[IncomingPhoneNumberSolution]
    }
    
    extension [Self <: IncomingPhoneNumberSolution](x: Self) {
  ...
  */
  trait IncomingPhoneNumberVoiceReceiveMode extends StObject
  object IncomingPhoneNumberVoiceReceiveMode {
