...
object libRestPreviewTrustedCommsCurrentCallMod {
  ...
  open class CurrentCallInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.libRestPreviewTrustedCommsMod.^, payload: CurrentCallPayload) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def CurrentCallList(version: typings.twilio.libRestPreviewTrustedCommsMod.^): CurrentCallListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("CurrentCallList")(version.asInstanceOf[js.Any]).asInstanceOf[CurrentCallListInstance]
  ...
  open class CurrentCallPage protected ()
    extends typings.twilio.libBasePageMod.^[
          typings.twilio.libRestPreviewTrustedCommsMod.^, 
          CurrentCallPayload, 
          CurrentCallResource, 
          CurrentCallInstance
        ] {
