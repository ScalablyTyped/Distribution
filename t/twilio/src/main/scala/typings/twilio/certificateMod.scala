...
object certificateMod {
  ...
  /**
    ...
    * @param fleetSid - The unique identifier of the Fleet.
    */
  inline def CertificateList(version: typings.twilio.deployedDevicesMod.^, fleetSid: String): CertificateListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("CertificateList")(version.asInstanceOf[js.Any], fleetSid.asInstanceOf[js.Any])).asInstanceOf[CertificateListInstance]
