...
object serviceBindingMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/service/binding", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/service/binding", "BindingContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/conversations/v1/service/binding", "BindingInstance")
  @js.native
  ...
  /**
    ...
    * @param chatServiceSid - The SID of the Conversation Service that the resource is associated with.
    */
  inline def BindingList(version: typings.twilio.conversationsV1Mod.^, chatServiceSid: String): BindingListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("BindingList")(version.asInstanceOf[js.Any], chatServiceSid.asInstanceOf[js.Any])).asInstanceOf[BindingListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/service/binding", "BindingPage")
  @js.native
  open class BindingPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.conversationsV1Mod.^, BindingPayload, BindingResource, BindingInstance] {
    /**
  ...
  */
  ...
  object BindingResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], binding_type = binding_type.asInstanceOf[js.Any], chat_service_sid = chat_service_sid.asInstanceOf[js.Any], credential_sid = credential_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], endpoint = endpoint.asInstanceOf[js.Any], identity = identity.asInstanceOf[js.Any], message_types = message_types.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
