...
import typings.twilio.allTimeMod.AllTimeListInstance
import typings.twilio.anon.Key
import typings.twilio.dailyMod.DailyListInstance
import typings.twilio.interfacesMod.SerializableClass
import typings.twilio.lastMonthMod.LastMonthListInstance
import typings.twilio.monthlyMod.MonthlyListInstance
import typings.twilio.thisMonthMod.ThisMonthListInstance
import typings.twilio.todayMod.TodayListInstance
import typings.twilio.yearlyMod.YearlyListInstance
import typings.twilio.yesterdayMod.YesterdayListInstance
...
object recordMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record", "RecordInstance")
  @js.native
  open class RecordInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.v2010Mod.^, payload: RecordPayload, accountSid: String) = this()
    ...
    var category: RecordCategory = js.native
  ...
  /**
    ...
    * @param accountSid - A 34 character string that uniquely identifies this resource.
    */
  inline def RecordList(version: typings.twilio.v2010Mod.^, accountSid: String): RecordListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("RecordList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any])).asInstanceOf[RecordListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record", "RecordPage")
  @js.native
  open class RecordPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2010Mod.^, RecordPayload, RecordResource, RecordInstance] {
    /**
    ...
    /**
      ...
      */
    def getInstance(payload: RecordPayload): RecordInstance = js.native
  ...
  */
  trait RecordCategory extends StObject
  object RecordCategory {
  ...
  @js.native
  trait RecordListInstance extends StObject {
    
    var allTime: js.UndefOr[AllTimeListInstance] = js.native
    
    var daily: js.UndefOr[DailyListInstance] = js.native
    ...
    def each(opts: RecordListInstanceEachOptions): Unit = js.native
    def each(
      opts: RecordListInstanceEachOptions,
      callback: js.Function2[
          /* item */ RecordInstance, 
          /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit], 
          Unit
    ...
    /**
      ...
      */
    def getPage(): js.Promise[RecordPage] = js.native
    def getPage(callback: js.Function2[/* error */ js.Error | Null, /* items */ RecordPage, Any]): js.Promise[RecordPage] = js.native
    def getPage(targetUrl: String): js.Promise[RecordPage] = js.native
    def getPage(
      targetUrl: String,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ RecordPage, Any]
    ): js.Promise[RecordPage] = js.native
    def getPage(targetUrl: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ RecordPage, Any]): js.Promise[RecordPage] = js.native
    
    var lastMonth: js.UndefOr[LastMonthListInstance] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def list(): js.Promise[js.Array[RecordInstance]] = js.native
    def list(callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[RecordInstance], Any]): js.Promise[js.Array[RecordInstance]] = js.native
    def list(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[RecordInstance], Any]
    ): js.Promise[js.Array[RecordInstance]] = js.native
    def list(opts: RecordListInstanceOptions): js.Promise[js.Array[RecordInstance]] = js.native
    def list(
      opts: RecordListInstanceOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[RecordInstance], Any]
    ): js.Promise[js.Array[RecordInstance]] = js.native
    
    var monthly: js.UndefOr[MonthlyListInstance] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def page(): js.Promise[RecordPage] = js.native
    def page(callback: js.Function2[/* error */ js.Error | Null, /* items */ RecordPage, Any]): js.Promise[RecordPage] = js.native
    def page(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ RecordPage, Any]): js.Promise[RecordPage] = js.native
    def page(opts: RecordListInstancePageOptions): js.Promise[RecordPage] = js.native
    def page(
      opts: RecordListInstancePageOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ RecordPage, Any]
    ): js.Promise[RecordPage] = js.native
    
    var thisMonth: js.UndefOr[ThisMonthListInstance] = js.native
    ...
    var today: js.UndefOr[TodayListInstance] = js.native
    
    var yearly: js.UndefOr[YearlyListInstance] = js.native
    
    var yesterday: js.UndefOr[YesterdayListInstance] = js.native
  }
  ...
  /**
    ...
    */
  trait RecordListInstanceEachOptions extends StObject {
    ...
    var category: js.UndefOr[RecordCategory] = js.undefined
  ...
  object RecordListInstanceEachOptions {
    
    inline def apply(): RecordListInstanceEachOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[RecordListInstanceEachOptions]
    }
    
    extension [Self <: RecordListInstanceEachOptions](x: Self) {
      
      inline def setCallback(
        value: (/* item */ RecordInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2(value))
      
      inline def setCallbackUndefined: Self = StObject.set(x, "callback", js.undefined)
      
      inline def setCategory(value: RecordCategory): Self = StObject.set(x, "category", value.asInstanceOf[js.Any])
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait RecordListInstanceOptions extends StObject {
  ...
  object RecordListInstanceOptions {
    
    inline def apply(): RecordListInstanceOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[RecordListInstanceOptions]
    }
    
    extension [Self <: RecordListInstanceOptions](x: Self) {
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait RecordListInstancePageOptions extends StObject {
  ...
  object RecordListInstancePageOptions {
    
    inline def apply(): RecordListInstancePageOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[RecordListInstancePageOptions]
    }
    
    extension [Self <: RecordListInstancePageOptions](x: Self) {
  ...
  - typings.twilio.pageMod.TwilioResponsePayload because var conflicts: uri. Inlined first_page_uri, next_page_uri, page, page_size, previous_page_uri, meta */ trait RecordPayload
    extends StObject
       with RecordResource {
  ...
  object RecordPayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[RecordPayload]
    }
    
    extension [Self <: RecordPayload](x: Self) {
  ...
  trait RecordResource extends StObject {
  ...
  object RecordResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[RecordResource]
    }
    
    extension [Self <: RecordResource](x: Self) {
  ...
  trait RecordSolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
  }
  object RecordSolution {
    
    inline def apply(): RecordSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[RecordSolution]
    }
    
    extension [Self <: RecordSolution](x: Self) {
