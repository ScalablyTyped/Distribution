...
object machineToMachineMod {
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/machineToMachine", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/machineToMachine", "MachineToMachineInstance")
  @js.native
  open class MachineToMachineInstance protected () extends SerializableClass {
    /**
  ...
  /**
    ...
    * @param countryCode - The ISO-3166-1 country code of the country.
    */
  inline def MachineToMachineList(version: typings.twilio.v2010Mod.^, accountSid: String, countryCode: String): MachineToMachineListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("MachineToMachineList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any], countryCode.asInstanceOf[js.Any])).asInstanceOf[MachineToMachineListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/machineToMachine", "MachineToMachinePage")
  @js.native
  open class MachineToMachinePage protected ()
    ...
    /**
      ...
      */
    def getInstance(payload: MachineToMachinePayload): MachineToMachineInstance = js.native
  ...
  @js.native
  trait MachineToMachineListInstance extends StObject {
    ...
    def each(opts: MachineToMachineListInstanceEachOptions): Unit = js.native
    def each(
      opts: MachineToMachineListInstanceEachOptions,
      callback: js.Function2[
          /* item */ MachineToMachineInstance, 
          /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit], 
          Unit
    ...
    /**
      ...
      */
    def getPage(): js.Promise[MachineToMachinePage] = js.native
    def getPage(callback: js.Function2[/* error */ js.Error | Null, /* items */ MachineToMachinePage, Any]): js.Promise[MachineToMachinePage] = js.native
    def getPage(targetUrl: String): js.Promise[MachineToMachinePage] = js.native
    def getPage(
      targetUrl: String,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ MachineToMachinePage, Any]
    ): js.Promise[MachineToMachinePage] = js.native
    def getPage(
      targetUrl: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ MachineToMachinePage, Any]
    ): js.Promise[MachineToMachinePage] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def list(): js.Promise[js.Array[MachineToMachineInstance]] = js.native
    def list(
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[MachineToMachineInstance], Any]
    ): js.Promise[js.Array[MachineToMachineInstance]] = js.native
    def list(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[MachineToMachineInstance], Any]
    ): js.Promise[js.Array[MachineToMachineInstance]] = js.native
    def list(opts: MachineToMachineListInstanceOptions): js.Promise[js.Array[MachineToMachineInstance]] = js.native
    def list(
      opts: MachineToMachineListInstanceOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[MachineToMachineInstance], Any]
    ): js.Promise[js.Array[MachineToMachineInstance]] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def page(): js.Promise[MachineToMachinePage] = js.native
    def page(callback: js.Function2[/* error */ js.Error | Null, /* items */ MachineToMachinePage, Any]): js.Promise[MachineToMachinePage] = js.native
    def page(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ MachineToMachinePage, Any]
    ): js.Promise[MachineToMachinePage] = js.native
    def page(opts: MachineToMachineListInstancePageOptions): js.Promise[MachineToMachinePage] = js.native
    def page(
      opts: MachineToMachineListInstancePageOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ MachineToMachinePage, Any]
    ): js.Promise[MachineToMachinePage] = js.native
  ...
  /**
    ...
    */
  trait MachineToMachineListInstanceEachOptions extends StObject {
  ...
  object MachineToMachineListInstanceEachOptions {
    
    inline def apply(): MachineToMachineListInstanceEachOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MachineToMachineListInstanceEachOptions]
    }
    
    extension [Self <: MachineToMachineListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ MachineToMachineInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit
  ...
  /**
    ...
    * @property voiceEnabled - Whether the phone numbers can receive calls.
    */
  trait MachineToMachineListInstanceOptions extends StObject {
  ...
  object MachineToMachineListInstanceOptions {
    
    inline def apply(): MachineToMachineListInstanceOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MachineToMachineListInstanceOptions]
    }
    
    extension [Self <: MachineToMachineListInstanceOptions](x: Self) {
  ...
  /**
    ...
    * @property voiceEnabled - Whether the phone numbers can receive calls.
    */
  trait MachineToMachineListInstancePageOptions extends StObject {
  ...
  object MachineToMachineListInstancePageOptions {
    
    inline def apply(): MachineToMachineListInstancePageOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MachineToMachineListInstancePageOptions]
    }
    
    extension [Self <: MachineToMachineListInstancePageOptions](x: Self) {
  ...
  trait MachineToMachinePayload
    extends StObject
       with MachineToMachineResource
       with TwilioResponsePayload
  object MachineToMachinePayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[MachineToMachinePayload]
    }
  }
  
  trait MachineToMachineResource extends StObject {
  ...
  object MachineToMachineResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[MachineToMachineResource]
    }
    
    extension [Self <: MachineToMachineResource](x: Self) {
  ...
  trait MachineToMachineSolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
    
    var countryCode: js.UndefOr[String] = js.undefined
  }
  object MachineToMachineSolution {
    
    inline def apply(): MachineToMachineSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MachineToMachineSolution]
    }
    
    extension [Self <: MachineToMachineSolution](x: Self) {
