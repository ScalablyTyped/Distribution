...
import typings.twilio.installedAddOnExtensionMod.InstalledAddOnExtensionContext
import typings.twilio.installedAddOnExtensionMod.InstalledAddOnExtensionListInstance
...
object installedAddOnMod {
  ...
  open class InstalledAddOnInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the InstalledAddOn resource to fetch
      */
    def this(version: typings.twilio.marketplaceMod.^, payload: InstalledAddOnPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def InstalledAddOnList(version: typings.twilio.marketplaceMod.^): InstalledAddOnListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("InstalledAddOnList")(version.asInstanceOf[js.Any]).asInstanceOf[InstalledAddOnListInstance]
