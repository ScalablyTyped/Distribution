...
object documentDocumentPermissionMod {
  
  @JSImport("twilio/lib/rest/sync/v1/service/document/documentPermission", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/sync/v1/service/document/documentPermission", "DocumentPermissionContext")
  @js.native
  open class DocumentPermissionContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.syncV1Mod.^, serviceSid: String, documentSid: String, identity: String) = this()
  ...
  @JSImport("twilio/lib/rest/sync/v1/service/document/documentPermission", "DocumentPermissionInstance")
  @js.native
  ...
  /**
    ...
    * @param documentSid - The Sync Document SID
    */
  inline def DocumentPermissionList(version: typings.twilio.syncV1Mod.^, serviceSid: String, documentSid: String): DocumentPermissionListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DocumentPermissionList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], documentSid.asInstanceOf[js.Any])).asInstanceOf[DocumentPermissionListInstance]
  
  @JSImport("twilio/lib/rest/sync/v1/service/document/documentPermission", "DocumentPermissionPage")
  @js.native
