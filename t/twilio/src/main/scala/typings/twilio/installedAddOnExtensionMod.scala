...
object installedAddOnExtensionMod {
  ...
  open class InstalledAddOnExtensionContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.marketplaceMod.^, installedAddOnSid: String, sid: String) = this()
