...
object commandMod {
  ...
  open class CommandInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.wirelessMod.^, payload: CommandPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def CommandList(version: typings.twilio.wirelessMod.^): CommandListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("CommandList")(version.asInstanceOf[js.Any]).asInstanceOf[CommandListInstance]
  
  @JSImport("twilio/lib/rest/preview/wireless/command", "CommandPage")
  @js.native
  open class CommandPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.wirelessMod.^, CommandPayload, CommandResource, CommandInstance] {
    /**
