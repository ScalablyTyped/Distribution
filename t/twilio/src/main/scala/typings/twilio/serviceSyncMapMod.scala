...
import typings.twilio.syncMapSyncMapItemMod.SyncMapItemContext
import typings.twilio.syncMapSyncMapItemMod.SyncMapItemListInstance
import typings.twilio.syncMapSyncMapPermissionMod.SyncMapPermissionContext
import typings.twilio.syncMapSyncMapPermissionMod.SyncMapPermissionListInstance
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object serviceSyncMapMod {
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap", "SyncMapContext")
  @js.native
  open class SyncMapContext protected () extends StObject {
    ...
    /**
      ...
      * @param callback - Callback to handle processed record
      */
    def update(): js.Promise[SyncMapInstance] = js.native
    def update(callback: js.Function2[/* error */ js.Error | Null, /* items */ SyncMapInstance, Any]): js.Promise[SyncMapInstance] = js.native
    def update(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ SyncMapInstance, Any]): js.Promise[SyncMapInstance] = js.native
    def update(opts: SyncMapInstanceUpdateOptions): js.Promise[SyncMapInstance] = js.native
    def update(
      opts: SyncMapInstanceUpdateOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ SyncMapInstance, Any]
    ): js.Promise[SyncMapInstance] = js.native
  }
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap", "SyncMapInstance")
  @js.native
  open class SyncMapInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the Sync Map resource to fetch
      */
    def this(version: typings.twilio.syncV1Mod.^, payload: SyncMapPayload, serviceSid: String, sid: String) = this()
    ...
    /**
      ...
      */
    def update(): js.Promise[SyncMapInstance] = js.native
    def update(callback: js.Function2[/* error */ js.Error | Null, /* items */ this.type, Any]): js.Promise[SyncMapInstance] = js.native
    def update(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ this.type, Any]): js.Promise[SyncMapInstance] = js.native
    def update(opts: SyncMapInstanceUpdateOptions): js.Promise[SyncMapInstance] = js.native
    def update(
      opts: SyncMapInstanceUpdateOptions,
  ...
  /**
    ...
    * @param serviceSid - The SID of the Sync Service that the resource is associated with
    */
  inline def SyncMapList(version: typings.twilio.syncV1Mod.^, serviceSid: String): SyncMapListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SyncMapList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[SyncMapListInstance]
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap", "SyncMapPage")
  @js.native
  open class SyncMapPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.syncV1Mod.^, SyncMapPayload, SyncMapResource, SyncMapInstance] {
    /**
  ...
  /**
    ...
    */
  trait SyncMapInstanceUpdateOptions extends StObject {
    
    var collectionTtl: js.UndefOr[Double] = js.undefined
    
    var ttl: js.UndefOr[Double] = js.undefined
  }
  object SyncMapInstanceUpdateOptions {
    
    inline def apply(): SyncMapInstanceUpdateOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SyncMapInstanceUpdateOptions]
    }
    
    extension [Self <: SyncMapInstanceUpdateOptions](x: Self) {
