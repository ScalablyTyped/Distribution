...
object v2ServiceUserUserChannelMod {
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/user/userChannel", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/user/userChannel", "UserChannelContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/user/userChannel", "UserChannelInstance")
  @js.native
  ...
  /**
    ...
    * @param userSid - The user_sid
    */
  inline def UserChannelList(version: typings.twilio.ipMessagingV2Mod.^, serviceSid: String, userSid: String): UserChannelListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UserChannelList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], userSid.asInstanceOf[js.Any])).asInstanceOf[UserChannelListInstance]
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/user/userChannel", "UserChannelPage")
  @js.native
