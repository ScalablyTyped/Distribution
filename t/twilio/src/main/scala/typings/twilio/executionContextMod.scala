...
object executionContextMod {
  ...
  @JSImport("twilio/lib/rest/studio/v1/flow/execution/executionContext", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/studio/v1/flow/execution/executionContext", "ExecutionContextContext")
  @js.native
  open class ExecutionContextContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.studioV1Mod.^, flowSid: String, executionSid: String) = this()
  ...
  @JSImport("twilio/lib/rest/studio/v1/flow/execution/executionContext", "ExecutionContextInstance")
  @js.native
  ...
  /**
    ...
    * @param executionSid - The SID of the Execution
    */
  inline def ExecutionContextList(version: typings.twilio.studioV1Mod.^, flowSid: String, executionSid: String): ExecutionContextListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ExecutionContextList")(version.asInstanceOf[js.Any], flowSid.asInstanceOf[js.Any], executionSid.asInstanceOf[js.Any])).asInstanceOf[ExecutionContextListInstance]
  
  @JSImport("twilio/lib/rest/studio/v1/flow/execution/executionContext", "ExecutionContextPage")
  @js.native
