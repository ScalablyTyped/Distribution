...
object supportingDocumentMod {
  
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/supportingDocument", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/supportingDocument", "SupportingDocumentContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/supportingDocument", "SupportingDocumentInstance")
  @js.native
  open class SupportingDocumentInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The unique string that identifies the resource
      */
    def this(version: typings.twilio.numbersV2Mod.^, payload: SupportingDocumentPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def SupportingDocumentList(version: typings.twilio.numbersV2Mod.^): SupportingDocumentListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("SupportingDocumentList")(version.asInstanceOf[js.Any]).asInstanceOf[SupportingDocumentListInstance]
  
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/supportingDocument", "SupportingDocumentPage")
  @js.native
  ...
  object SupportingDocumentResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], attributes = attributes.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], failure_reason = failure_reason.asInstanceOf[js.Any], friendly_name = friendly_name.asInstanceOf[js.Any], mime_type = mime_type.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
