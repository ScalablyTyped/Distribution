...
import typings.twilio.documentDocumentPermissionMod.DocumentPermissionContext
import typings.twilio.documentDocumentPermissionMod.DocumentPermissionListInstance
...
object serviceDocumentMod {
  
  @JSImport("twilio/lib/rest/sync/v1/service/document", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/sync/v1/service/document", "DocumentContext")
  @js.native
  open class DocumentContext protected () extends StObject {
    ...
    /**
      ...
      * @param callback - Callback to handle processed record
      */
    def update(): js.Promise[DocumentInstance] = js.native
    def update(callback: js.Function2[/* error */ js.Error | Null, /* items */ DocumentInstance, Any]): js.Promise[DocumentInstance] = js.native
    def update(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ DocumentInstance, Any]): js.Promise[DocumentInstance] = js.native
  ...
  @JSImport("twilio/lib/rest/sync/v1/service/document", "DocumentInstance")
  @js.native
  open class DocumentInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the Document resource to fetch
      */
    def this(version: typings.twilio.syncV1Mod.^, payload: DocumentPayload, serviceSid: String, sid: String) = this()
    ...
    /**
      ...
      */
    def update(): js.Promise[DocumentInstance] = js.native
    def update(callback: js.Function2[/* error */ js.Error | Null, /* items */ this.type, Any]): js.Promise[DocumentInstance] = js.native
    def update(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ this.type, Any]): js.Promise[DocumentInstance] = js.native
    def update(opts: DocumentInstanceUpdateOptions): js.Promise[DocumentInstance] = js.native
    def update(
      opts: DocumentInstanceUpdateOptions,
  ...
  /**
    ...
    * @param serviceSid - The SID of the Sync Service that the resource is associated with
    */
  inline def DocumentList(version: typings.twilio.syncV1Mod.^, serviceSid: String): DocumentListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DocumentList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[DocumentListInstance]
  
  @JSImport("twilio/lib/rest/sync/v1/service/document", "DocumentPage")
  @js.native
  open class DocumentPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.syncV1Mod.^, DocumentPayload, DocumentResource, DocumentInstance] {
    /**
  ...
  object DocumentInstanceUpdateOptions {
    ...
    inline def apply(): DocumentInstanceUpdateOptions = {
