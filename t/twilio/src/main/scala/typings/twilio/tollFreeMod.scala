...
object tollFreeMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/tollFree", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/tollFree", "TollFreeInstance")
  @js.native
  ...
  /**
    ...
    * @param countryCode - The ISO-3166-1 country code of the country.
    */
  inline def TollFreeList(version: typings.twilio.v2010Mod.^, accountSid: String, countryCode: String): TollFreeListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("TollFreeList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any], countryCode.asInstanceOf[js.Any])).asInstanceOf[TollFreeListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/tollFree", "TollFreePage")
  @js.native
