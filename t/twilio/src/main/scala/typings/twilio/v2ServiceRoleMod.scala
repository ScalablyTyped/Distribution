...
object v2ServiceRoleMod {
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/role", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/role", "RoleContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/role", "RoleInstance")
  @js.native
  open class RoleInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.ipMessagingV2Mod.^, payload: RolePayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The service_sid
    */
  inline def RoleList(version: typings.twilio.ipMessagingV2Mod.^, serviceSid: String): RoleListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("RoleList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[RoleListInstance]
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/role", "RolePage")
  @js.native
  open class RolePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.ipMessagingV2Mod.^, RolePayload, RoleResource, RoleInstance] {
    /**
