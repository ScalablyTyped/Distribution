...
object libRestPreviewTrustedCommsBrandedChannelChannelMod {
  ...
  /**
    ...
    * @param brandedChannelSid - Branded Channel Sid.
    */
  inline def ChannelList(version: typings.twilio.libRestPreviewTrustedCommsMod.^, brandedChannelSid: String): ChannelListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ChannelList")(version.asInstanceOf[js.Any], brandedChannelSid.asInstanceOf[js.Any])).asInstanceOf[ChannelListInstance]
