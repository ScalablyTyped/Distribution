...
object siprecMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/call/siprec", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/call/siprec", "SiprecContext")
  @js.native
  open class SiprecContext protected () extends StObject {
    /**
    ...
    /**
      ...
      */
    def update(opts: SiprecInstanceUpdateOptions): js.Promise[SiprecInstance] = js.native
    def update(
      opts: SiprecInstanceUpdateOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ SiprecInstance, Any]
    ): js.Promise[SiprecInstance] = js.native
  }
  
  @JSImport("twilio/lib/rest/api/v2010/account/call/siprec", "SiprecInstance")
  @js.native
  open class SiprecInstance protected () extends SerializableClass {
    /**
      * Initialize the SiprecContext
      *
      * @param version - Version of the resource
    ...
    /* private */ var _proxy: SiprecContext = js.native
    ...
    var status: SiprecStatus = js.native
  ...
  /**
    ...
    * @param callSid - The SID of the Call the resource is associated with
    */
  inline def SiprecList(version: typings.twilio.v2010Mod.^, accountSid: String, callSid: String): SiprecListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SiprecList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any], callSid.asInstanceOf[js.Any])).asInstanceOf[SiprecListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/call/siprec", "SiprecPage")
  @js.native
  open class SiprecPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2010Mod.^, SiprecPayload, SiprecResource, SiprecInstance] {
    /**
    ...
    /**
      ...
      */
    def getInstance(payload: SiprecPayload): SiprecInstance = js.native
  ...
  /**
    ...
    */
  trait SiprecInstanceUpdateOptions extends StObject {
    
    var status: SiprecUpdateStatus
  }
  object SiprecInstanceUpdateOptions {
    
    inline def apply(status: SiprecUpdateStatus): SiprecInstanceUpdateOptions = {
      val __obj = js.Dynamic.literal(status = status.asInstanceOf[js.Any])
      __obj.asInstanceOf[SiprecInstanceUpdateOptions]
    }
    
    extension [Self <: SiprecInstanceUpdateOptions](x: Self) {
      
      inline def setStatus(value: SiprecUpdateStatus): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
    }
  }
  
  @js.native
  trait SiprecListInstance extends StObject {
    
    /**
      * @param sid - sid of instance
      */
    def apply(sid: String): SiprecContext = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle processed record
      */
    def create(): js.Promise[SiprecInstance] = js.native
    def create(callback: js.Function2[/* error */ js.Error | Null, /* item */ SiprecInstance, Any]): js.Promise[SiprecInstance] = js.native
    def create(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* item */ SiprecInstance, Any]): js.Promise[SiprecInstance] = js.native
    def create(opts: SiprecListInstanceCreateOptions): js.Promise[SiprecInstance] = js.native
    def create(
      opts: SiprecListInstanceCreateOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* item */ SiprecInstance, Any]
    ): js.Promise[SiprecInstance] = js.native
    ...
    /**
      ...
      * @param sid - The SID of the Siprec resource, or the `name`
      */
    def get(sid: String): SiprecContext = js.native
  ...
  /**
    ...
    */
  trait SiprecListInstanceCreateOptions extends StObject {
  ...
  object SiprecListInstanceCreateOptions {
    
    inline def apply(): SiprecListInstanceCreateOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SiprecListInstanceCreateOptions]
    }
    
    extension [Self <: SiprecListInstanceCreateOptions](x: Self) {
  ...
  - typings.twilio.pageMod.TwilioResponsePayload because var conflicts: uri. Inlined first_page_uri, next_page_uri, page, page_size, previous_page_uri, meta */ trait SiprecPayload
    extends StObject
       with SiprecResource {
  ...
  object SiprecPayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[SiprecPayload]
    }
    
    extension [Self <: SiprecPayload](x: Self) {
  ...
  trait SiprecResource extends StObject {
    ...
    var status: SiprecStatus
    
    var uri: String
  }
  object SiprecResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[SiprecResource]
    }
    
    extension [Self <: SiprecResource](x: Self) {
      ...
      inline def setStatus(value: SiprecStatus): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
      
      inline def setUri(value: String): Self = StObject.set(x, "uri", value.asInstanceOf[js.Any])
    }
  }
  
  trait SiprecSolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
    
    var callSid: js.UndefOr[String] = js.undefined
  }
  object SiprecSolution {
    
    inline def apply(): SiprecSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SiprecSolution]
    }
    
    extension [Self <: SiprecSolution](x: Self) {
  ...
  */
  trait SiprecStatus extends StObject
  object SiprecStatus {
  ...
  */
  trait SiprecTrack extends StObject
  object SiprecTrack {
