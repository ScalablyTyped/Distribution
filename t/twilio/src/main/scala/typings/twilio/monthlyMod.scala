...
object monthlyMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/monthly", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/monthly", "MonthlyInstance")
  @js.native
  open class MonthlyInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.v2010Mod.^, payload: MonthlyPayload, accountSid: String) = this()
    ...
    var category: MonthlyCategory = js.native
  ...
  /**
    ...
    * @param accountSid - A 34 character string that uniquely identifies this resource.
    */
  inline def MonthlyList(version: typings.twilio.v2010Mod.^, accountSid: String): MonthlyListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("MonthlyList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any])).asInstanceOf[MonthlyListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/monthly", "MonthlyPage")
  @js.native
  open class MonthlyPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2010Mod.^, MonthlyPayload, MonthlyResource, MonthlyInstance] {
    /**
    ...
    /**
      ...
      */
    def getInstance(payload: MonthlyPayload): MonthlyInstance = js.native
  ...
  */
  trait MonthlyCategory extends StObject
  object MonthlyCategory {
  ...
  @js.native
  trait MonthlyListInstance extends StObject {
    ...
    def each(opts: MonthlyListInstanceEachOptions): Unit = js.native
    def each(
      opts: MonthlyListInstanceEachOptions,
      callback: js.Function2[
          /* item */ MonthlyInstance, 
          /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit], 
          Unit
    ...
    /**
      ...
      */
    def getPage(): js.Promise[MonthlyPage] = js.native
    def getPage(callback: js.Function2[/* error */ js.Error | Null, /* items */ MonthlyPage, Any]): js.Promise[MonthlyPage] = js.native
    def getPage(targetUrl: String): js.Promise[MonthlyPage] = js.native
    def getPage(
      targetUrl: String,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ MonthlyPage, Any]
    ): js.Promise[MonthlyPage] = js.native
    def getPage(targetUrl: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ MonthlyPage, Any]): js.Promise[MonthlyPage] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def list(): js.Promise[js.Array[MonthlyInstance]] = js.native
    def list(callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[MonthlyInstance], Any]): js.Promise[js.Array[MonthlyInstance]] = js.native
    def list(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[MonthlyInstance], Any]
    ): js.Promise[js.Array[MonthlyInstance]] = js.native
    def list(opts: MonthlyListInstanceOptions): js.Promise[js.Array[MonthlyInstance]] = js.native
    def list(
      opts: MonthlyListInstanceOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[MonthlyInstance], Any]
    ): js.Promise[js.Array[MonthlyInstance]] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def page(): js.Promise[MonthlyPage] = js.native
    def page(callback: js.Function2[/* error */ js.Error | Null, /* items */ MonthlyPage, Any]): js.Promise[MonthlyPage] = js.native
    def page(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ MonthlyPage, Any]): js.Promise[MonthlyPage] = js.native
    def page(opts: MonthlyListInstancePageOptions): js.Promise[MonthlyPage] = js.native
    def page(
      opts: MonthlyListInstancePageOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ MonthlyPage, Any]
    ): js.Promise[MonthlyPage] = js.native
  ...
  /**
    ...
    */
  trait MonthlyListInstanceEachOptions extends StObject {
    ...
    var category: js.UndefOr[MonthlyCategory] = js.undefined
  ...
  object MonthlyListInstanceEachOptions {
    
    inline def apply(): MonthlyListInstanceEachOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MonthlyListInstanceEachOptions]
    }
    
    extension [Self <: MonthlyListInstanceEachOptions](x: Self) {
      
      inline def setCallback(
        value: (/* item */ MonthlyInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2(value))
      
      inline def setCallbackUndefined: Self = StObject.set(x, "callback", js.undefined)
      
      inline def setCategory(value: MonthlyCategory): Self = StObject.set(x, "category", value.asInstanceOf[js.Any])
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait MonthlyListInstanceOptions extends StObject {
  ...
  object MonthlyListInstanceOptions {
    
    inline def apply(): MonthlyListInstanceOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MonthlyListInstanceOptions]
    }
    
    extension [Self <: MonthlyListInstanceOptions](x: Self) {
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait MonthlyListInstancePageOptions extends StObject {
  ...
  object MonthlyListInstancePageOptions {
    
    inline def apply(): MonthlyListInstancePageOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MonthlyListInstancePageOptions]
    }
    
    extension [Self <: MonthlyListInstancePageOptions](x: Self) {
  ...
  - typings.twilio.pageMod.TwilioResponsePayload because var conflicts: uri. Inlined first_page_uri, next_page_uri, page, page_size, previous_page_uri, meta */ trait MonthlyPayload
    extends StObject
       with MonthlyResource {
  ...
  object MonthlyPayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[MonthlyPayload]
    }
    
    extension [Self <: MonthlyPayload](x: Self) {
  ...
  trait MonthlyResource extends StObject {
  ...
  object MonthlyResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[MonthlyResource]
    }
    
    extension [Self <: MonthlyResource](x: Self) {
  ...
  trait MonthlySolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
  }
  object MonthlySolution {
    
    inline def apply(): MonthlySolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MonthlySolution]
    }
    
    extension [Self <: MonthlySolution](x: Self) {
