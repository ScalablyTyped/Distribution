...
import typings.twilio.serviceDocumentMod.DocumentContext
import typings.twilio.serviceDocumentMod.DocumentListInstance
import typings.twilio.serviceSyncListMod.SyncListContext
import typings.twilio.serviceSyncListMod.SyncListListInstance
import typings.twilio.serviceSyncMapMod.SyncMapContext
import typings.twilio.serviceSyncMapMod.SyncMapListInstance
import typings.twilio.syncStreamMod.SyncStreamContext
import typings.twilio.syncStreamMod.SyncStreamListInstance
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object syncV1ServiceMod {
  
  @JSImport("twilio/lib/rest/sync/v1/service", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/sync/v1/service", "ServiceContext")
  @js.native
  open class ServiceContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.syncV1Mod.^, sid: String) = this()
    ...
    /**
      * @param sid - sid of instance
      */
    def syncStreams(sid: String): SyncStreamContext = js.native
    @JSName("syncStreams")
    var syncStreams_Original: SyncStreamListInstance = js.native
  ...
  @JSImport("twilio/lib/rest/sync/v1/service", "ServiceInstance")
  @js.native
  open class ServiceInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the Service resource to fetch
      */
    def this(version: typings.twilio.syncV1Mod.^, payload: ServicePayload, sid: String) = this()
    ...
    var reachabilityDebouncingEnabled: Boolean = js.native
    
    var reachabilityDebouncingWindow: Double = js.native
    ...
    /**
      ...
      */
    def syncStreams(): SyncStreamListInstance = js.native
    ...
    var webhooksFromRestEnabled: Boolean = js.native
  }
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def ServiceList(version: typings.twilio.syncV1Mod.^): ServiceListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("ServiceList")(version.asInstanceOf[js.Any]).asInstanceOf[ServiceListInstance]
  
  @JSImport("twilio/lib/rest/sync/v1/service", "ServicePage")
  @js.native
  open class ServicePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.syncV1Mod.^, ServicePayload, ServiceResource, ServiceInstance] {
    /**
  ...
  trait ServiceInstanceUpdateOptions extends StObject {
    ...
    var reachabilityDebouncingEnabled: js.UndefOr[Boolean] = js.undefined
    
    var reachabilityDebouncingWindow: js.UndefOr[Double] = js.undefined
    
    var reachabilityWebhooksEnabled: js.UndefOr[Boolean] = js.undefined
    
    var webhookUrl: js.UndefOr[String] = js.undefined
    
    var webhooksFromRestEnabled: js.UndefOr[Boolean] = js.undefined
  }
  object ServiceInstanceUpdateOptions {
    ...
    extension [Self <: ServiceInstanceUpdateOptions](x: Self) {
      ...
      inline def setReachabilityDebouncingEnabled(value: Boolean): Self = StObject.set(x, "reachabilityDebouncingEnabled", value.asInstanceOf[js.Any])
      
      inline def setReachabilityDebouncingEnabledUndefined: Self = StObject.set(x, "reachabilityDebouncingEnabled", js.undefined)
      
      inline def setReachabilityDebouncingWindow(value: Double): Self = StObject.set(x, "reachabilityDebouncingWindow", value.asInstanceOf[js.Any])
      
      inline def setReachabilityDebouncingWindowUndefined: Self = StObject.set(x, "reachabilityDebouncingWindow", js.undefined)
      ...
      inline def setWebhooksFromRestEnabled(value: Boolean): Self = StObject.set(x, "webhooksFromRestEnabled", value.asInstanceOf[js.Any])
      
      inline def setWebhooksFromRestEnabledUndefined: Self = StObject.set(x, "webhooksFromRestEnabled", js.undefined)
    }
  }
  ...
  object ServicePayload {
    ...
    inline def apply(
      ...
      reachability_debouncing_window: Double,
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], acl_enabled = acl_enabled.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], first_page_uri = first_page_uri.asInstanceOf[js.Any], friendly_name = friendly_name.asInstanceOf[js.Any], links = links.asInstanceOf[js.Any], next_page_uri = next_page_uri.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], page_size = page_size.asInstanceOf[js.Any], previous_page_uri = previous_page_uri.asInstanceOf[js.Any], reachability_debouncing_enabled = reachability_debouncing_enabled.asInstanceOf[js.Any], reachability_debouncing_window = reachability_debouncing_window.asInstanceOf[js.Any], reachability_webhooks_enabled = reachability_webhooks_enabled.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], unique_name = unique_name.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], webhook_url = webhook_url.asInstanceOf[js.Any], webhooks_from_rest_enabled = webhooks_from_rest_enabled.asInstanceOf[js.Any])
  ...
  trait ServiceResource extends StObject {
    ...
    var reachability_debouncing_enabled: Boolean
    
    var reachability_debouncing_window: Double
    ...
    var webhooks_from_rest_enabled: Boolean
  }
  object ServiceResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], acl_enabled = acl_enabled.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], friendly_name = friendly_name.asInstanceOf[js.Any], links = links.asInstanceOf[js.Any], reachability_debouncing_enabled = reachability_debouncing_enabled.asInstanceOf[js.Any], reachability_debouncing_window = reachability_debouncing_window.asInstanceOf[js.Any], reachability_webhooks_enabled = reachability_webhooks_enabled.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], unique_name = unique_name.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], webhook_url = webhook_url.asInstanceOf[js.Any], webhooks_from_rest_enabled = webhooks_from_rest_enabled.asInstanceOf[js.Any])
    ...
    extension [Self <: ServiceResource](x: Self) {
      ...
      inline def setReachability_debouncing_enabled(value: Boolean): Self = StObject.set(x, "reachability_debouncing_enabled", value.asInstanceOf[js.Any])
      
      inline def setReachability_debouncing_window(value: Double): Self = StObject.set(x, "reachability_debouncing_window", value.asInstanceOf[js.Any])
      ...
      inline def setWebhooks_from_rest_enabled(value: Boolean): Self = StObject.set(x, "webhooks_from_rest_enabled", value.asInstanceOf[js.Any])
    }
  }
