...
import typings.twilio.addOnResultMod.AddOnResultContext
import typings.twilio.addOnResultMod.AddOnResultListInstance
import typings.twilio.anon.Key
import typings.twilio.interfacesMod.SerializableClass
import typings.twilio.transcriptionMod.TranscriptionContext
import typings.twilio.transcriptionMod.TranscriptionListInstance
...
object accountRecordingMod {
  
  @JSImport("twilio/lib/rest/api/v2010/account/recording", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/recording", "RecordingContext")
  @js.native
  open class RecordingContext protected () extends StObject {
    ...
    /**
      ...
      */
    def addOnResults(sid: String): AddOnResultContext = js.native
    @JSName("addOnResults")
    var addOnResults_Original: AddOnResultListInstance = js.native
    ...
    def fetch(opts: RecordingInstanceFetchOptions): js.Promise[RecordingInstance] = js.native
    def fetch(
      opts: RecordingInstanceFetchOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ RecordingInstance, Any]
    ): js.Promise[RecordingInstance] = js.native
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/recording", "RecordingInstance")
  @js.native
  open class RecordingInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The unique string that identifies the resource
      */
    def this(version: typings.twilio.v2010Mod.^, payload: RecordingPayload, accountSid: String, sid: String) = this()
    ...
    /**
      ...
      */
    def addOnResults(): AddOnResultListInstance = js.native
    ...
    def fetch(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ this.type, Any]): js.Promise[RecordingInstance] = js.native
    def fetch(opts: RecordingInstanceFetchOptions): js.Promise[RecordingInstance] = js.native
    def fetch(
      opts: RecordingInstanceFetchOptions,
  ...
  /**
    ...
    * @param accountSid - The SID of the Account that created the resource
    */
  inline def RecordingList(version: typings.twilio.v2010Mod.^, accountSid: String): RecordingListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("RecordingList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any])).asInstanceOf[RecordingListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/recording", "RecordingPage")
  @js.native
  ...
  /**
    ...
    */
  trait RecordingInstanceFetchOptions extends StObject {
    
    var includeSoftDeleted: js.UndefOr[Boolean] = js.undefined
  }
  object RecordingInstanceFetchOptions {
    
    inline def apply(): RecordingInstanceFetchOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[RecordingInstanceFetchOptions]
    }
    
    extension [Self <: RecordingInstanceFetchOptions](x: Self) {
      
      inline def setIncludeSoftDeleted(value: Boolean): Self = StObject.set(x, "includeSoftDeleted", value.asInstanceOf[js.Any])
      
      inline def setIncludeSoftDeletedUndefined: Self = StObject.set(x, "includeSoftDeleted", js.undefined)
    }
  }
  ...
  object RecordingResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], api_version = api_version.asInstanceOf[js.Any], call_sid = call_sid.asInstanceOf[js.Any], channels = channels.asInstanceOf[js.Any], conference_sid = conference_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], duration = duration.asInstanceOf[js.Any], encryption_details = encryption_details.asInstanceOf[js.Any], error_code = error_code.asInstanceOf[js.Any], media_url = media_url.asInstanceOf[js.Any], price = price.asInstanceOf[js.Any], price_unit = price_unit.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any], start_time = start_time.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], subresource_uris = subresource_uris.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any])
