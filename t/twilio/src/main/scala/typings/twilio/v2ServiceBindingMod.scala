...
object v2ServiceBindingMod {
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/binding", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/binding", "BindingContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/binding", "BindingInstance")
  @js.native
  open class BindingInstance protected () extends SerializableClass {
    ...
    var bindingType: BindingBindingType = js.native
  ...
  /**
    ...
    * @param serviceSid - The service_sid
    */
  inline def BindingList(version: typings.twilio.ipMessagingV2Mod.^, serviceSid: String): BindingListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("BindingList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[BindingListInstance]
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/binding", "BindingPage")
  @js.native
  open class BindingPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.ipMessagingV2Mod.^, BindingPayload, BindingResource, BindingInstance] {
    /**
  ...
  */
  ...
  trait BindingListInstanceEachOptions extends StObject {
    ...
    var bindingType: js.UndefOr[BindingBindingType | js.Array[BindingBindingType]] = js.undefined
  ...
  object BindingListInstanceEachOptions {
    ...
    extension [Self <: BindingListInstanceEachOptions](x: Self) {
      ...
      inline def setBindingType(value: BindingBindingType | js.Array[BindingBindingType]): Self = StObject.set(x, "bindingType", value.asInstanceOf[js.Any])
      
      inline def setBindingTypeUndefined: Self = StObject.set(x, "bindingType", js.undefined)
      
      inline def setBindingTypeVarargs(value: BindingBindingType*): Self = StObject.set(x, "bindingType", js.Array(value*))
  ...
  object BindingPayload {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], binding_type = binding_type.asInstanceOf[js.Any], credential_sid = credential_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], endpoint = endpoint.asInstanceOf[js.Any], first_page_uri = first_page_uri.asInstanceOf[js.Any], identity = identity.asInstanceOf[js.Any], links = links.asInstanceOf[js.Any], message_types = message_types.asInstanceOf[js.Any], next_page_uri = next_page_uri.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], page_size = page_size.asInstanceOf[js.Any], previous_page_uri = previous_page_uri.asInstanceOf[js.Any], service_sid = service_sid.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
  ...
  trait BindingResource extends StObject {
    ...
    var binding_type: BindingBindingType
  ...
  object BindingResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], binding_type = binding_type.asInstanceOf[js.Any], credential_sid = credential_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], endpoint = endpoint.asInstanceOf[js.Any], identity = identity.asInstanceOf[js.Any], links = links.asInstanceOf[js.Any], message_types = message_types.asInstanceOf[js.Any], service_sid = service_sid.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    ...
    extension [Self <: BindingResource](x: Self) {
      ...
      inline def setBinding_type(value: BindingBindingType): Self = StObject.set(x, "binding_type", value.asInstanceOf[js.Any])
