...
object taskSampleMod {
  ...
  /**
    ...
    * @param taskSid - The unique ID of the Task associated with this Sample.
    */
  inline def SampleList(version: typings.twilio.understandMod.^, assistantSid: String, taskSid: String): SampleListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SampleList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any], taskSid.asInstanceOf[js.Any])).asInstanceOf[SampleListInstance]
  
  @JSImport("twilio/lib/rest/preview/understand/assistant/task/sample", "SamplePage")
  @js.native
  open class SamplePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.understandMod.^, SamplePayload, SampleResource, SampleInstance] {
    /**
