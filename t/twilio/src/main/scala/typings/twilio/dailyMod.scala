...
object dailyMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/daily", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/daily", "DailyInstance")
  @js.native
  open class DailyInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.v2010Mod.^, payload: DailyPayload, accountSid: String) = this()
    ...
    var category: DailyCategory = js.native
  ...
  /**
    ...
    * @param accountSid - A 34 character string that uniquely identifies this resource.
    */
  inline def DailyList(version: typings.twilio.v2010Mod.^, accountSid: String): DailyListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DailyList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any])).asInstanceOf[DailyListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/daily", "DailyPage")
  @js.native
  open class DailyPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2010Mod.^, DailyPayload, DailyResource, DailyInstance] {
    /**
    ...
    /**
      ...
      */
    def getInstance(payload: DailyPayload): DailyInstance = js.native
  ...
  */
  trait DailyCategory extends StObject
  object DailyCategory {
  ...
  @js.native
  trait DailyListInstance extends StObject {
    ...
    def each(opts: DailyListInstanceEachOptions): Unit = js.native
    def each(
      opts: DailyListInstanceEachOptions,
      callback: js.Function2[
          /* item */ DailyInstance, 
          /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit], 
          Unit
    ...
    /**
      ...
      */
    def getPage(): js.Promise[DailyPage] = js.native
    def getPage(callback: js.Function2[/* error */ js.Error | Null, /* items */ DailyPage, Any]): js.Promise[DailyPage] = js.native
    def getPage(targetUrl: String): js.Promise[DailyPage] = js.native
    def getPage(targetUrl: String, callback: js.Function2[/* error */ js.Error | Null, /* items */ DailyPage, Any]): js.Promise[DailyPage] = js.native
    def getPage(targetUrl: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ DailyPage, Any]): js.Promise[DailyPage] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def list(): js.Promise[js.Array[DailyInstance]] = js.native
    def list(callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[DailyInstance], Any]): js.Promise[js.Array[DailyInstance]] = js.native
    def list(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[DailyInstance], Any]
    ): js.Promise[js.Array[DailyInstance]] = js.native
    def list(opts: DailyListInstanceOptions): js.Promise[js.Array[DailyInstance]] = js.native
    def list(
      opts: DailyListInstanceOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[DailyInstance], Any]
    ): js.Promise[js.Array[DailyInstance]] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def page(): js.Promise[DailyPage] = js.native
    def page(callback: js.Function2[/* error */ js.Error | Null, /* items */ DailyPage, Any]): js.Promise[DailyPage] = js.native
    def page(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ DailyPage, Any]): js.Promise[DailyPage] = js.native
    def page(opts: DailyListInstancePageOptions): js.Promise[DailyPage] = js.native
    def page(
      opts: DailyListInstancePageOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ DailyPage, Any]
    ): js.Promise[DailyPage] = js.native
  ...
  /**
    ...
    */
  trait DailyListInstanceEachOptions extends StObject {
    ...
    var category: js.UndefOr[DailyCategory] = js.undefined
  ...
  object DailyListInstanceEachOptions {
    
    inline def apply(): DailyListInstanceEachOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DailyListInstanceEachOptions]
    }
    
    extension [Self <: DailyListInstanceEachOptions](x: Self) {
      
      inline def setCallback(
        value: (/* item */ DailyInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2(value))
      
      inline def setCallbackUndefined: Self = StObject.set(x, "callback", js.undefined)
      
      inline def setCategory(value: DailyCategory): Self = StObject.set(x, "category", value.asInstanceOf[js.Any])
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait DailyListInstanceOptions extends StObject {
  ...
  object DailyListInstanceOptions {
    
    inline def apply(): DailyListInstanceOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DailyListInstanceOptions]
    }
    
    extension [Self <: DailyListInstanceOptions](x: Self) {
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait DailyListInstancePageOptions extends StObject {
  ...
  object DailyListInstancePageOptions {
    
    inline def apply(): DailyListInstancePageOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DailyListInstancePageOptions]
    }
    
    extension [Self <: DailyListInstancePageOptions](x: Self) {
  ...
  - typings.twilio.pageMod.TwilioResponsePayload because var conflicts: uri. Inlined first_page_uri, next_page_uri, page, page_size, previous_page_uri, meta */ trait DailyPayload
    extends StObject
       with DailyResource {
  ...
  object DailyPayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[DailyPayload]
    }
    
    extension [Self <: DailyPayload](x: Self) {
  ...
  trait DailyResource extends StObject {
  ...
  object DailyResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[DailyResource]
    }
    
    extension [Self <: DailyResource](x: Self) {
  ...
  trait DailySolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
  }
  object DailySolution {
    
    inline def apply(): DailySolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DailySolution]
    }
    
    extension [Self <: DailySolution](x: Self) {
