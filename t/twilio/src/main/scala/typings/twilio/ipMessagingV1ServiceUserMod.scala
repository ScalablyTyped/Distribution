...
import typings.twilio.serviceUserUserChannelMod.UserChannelListInstance
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ipMessagingV1ServiceUserMod {
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/user", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/user", "UserContext")
  @js.native
  open class UserContext protected () extends StObject {
    ...
    var userChannels: UserChannelListInstance = js.native
  }
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/user", "UserInstance")
  @js.native
  open class UserInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.ipMessagingV1Mod.^, payload: UserPayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The service_sid
    */
  inline def UserList(version: typings.twilio.ipMessagingV1Mod.^, serviceSid: String): UserListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UserList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[UserListInstance]
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/user", "UserPage")
  @js.native
  open class UserPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.ipMessagingV1Mod.^, UserPayload, UserResource, UserInstance] {
    /**
