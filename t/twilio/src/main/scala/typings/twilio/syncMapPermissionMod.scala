...
object syncMapPermissionMod {
  ...
  open class SyncMapPermissionContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.syncMod.^, serviceSid: String, mapSid: String, identity: String) = this()
  ...
  /**
    ...
    * @param mapSid - Sync Map SID.
    */
  inline def SyncMapPermissionList(version: typings.twilio.syncMod.^, serviceSid: String, mapSid: String): SyncMapPermissionListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SyncMapPermissionList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], mapSid.asInstanceOf[js.Any])).asInstanceOf[SyncMapPermissionListInstance]
