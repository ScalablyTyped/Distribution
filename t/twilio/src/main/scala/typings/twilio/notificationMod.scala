...
object notificationMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/call/notification", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/call/notification", "NotificationContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/call/notification", "NotificationInstance")
  @js.native
  ...
  /**
    ...
    * @param callSid - The SID of the Call the resource is associated with
    */
  inline def NotificationList(version: typings.twilio.v2010Mod.^, accountSid: String, callSid: String): NotificationListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("NotificationList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any], callSid.asInstanceOf[js.Any])).asInstanceOf[NotificationListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/call/notification", "NotificationPage")
  @js.native
