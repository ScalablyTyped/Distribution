...
import typings.twilio.conversationMessageMod.MessageContext
import typings.twilio.conversationMessageMod.MessageListInstance
import typings.twilio.conversationParticipantMod.ParticipantContext
import typings.twilio.conversationParticipantMod.ParticipantListInstance
import typings.twilio.conversationWebhookMod.WebhookContext
import typings.twilio.conversationWebhookMod.WebhookListInstance
...
object conversationMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation", "ConversationContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/conversations/v1/conversation", "ConversationInstance")
  @js.native
  open class ConversationInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - A 34 character string that uniquely identifies this resource.
      */
    def this(version: typings.twilio.conversationsV1Mod.^, payload: ConversationPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def ConversationList(version: typings.twilio.conversationsV1Mod.^): ConversationListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("ConversationList")(version.asInstanceOf[js.Any]).asInstanceOf[ConversationListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation", "ConversationPage")
  @js.native
