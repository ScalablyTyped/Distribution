...
import typings.twilio.serviceChannelWebhookMod.WebhookContext
import typings.twilio.serviceChannelWebhookMod.WebhookListInstance
import typings.twilio.v2ServiceChannelInviteMod.InviteContext
import typings.twilio.v2ServiceChannelInviteMod.InviteListInstance
import typings.twilio.v2ServiceChannelMemberMod.MemberContext
import typings.twilio.v2ServiceChannelMemberMod.MemberListInstance
import typings.twilio.v2ServiceChannelMessageMod.MessageContext
import typings.twilio.v2ServiceChannelMessageMod.MessageListInstance
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object v2ServiceChannelMod {
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel", "ChannelContext")
  @js.native
  open class ChannelContext protected () extends StObject {
    ...
    def remove(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ ChannelInstance, Any]): js.Promise[Boolean] = js.native
    def remove(opts: ChannelInstanceRemoveOptions): js.Promise[Boolean] = js.native
    def remove(
      opts: ChannelInstanceRemoveOptions,
  ...
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel", "ChannelInstance")
  @js.native
  ...
  /**
    ...
    * @param serviceSid - The service_sid
    */
  inline def ChannelList(version: typings.twilio.ipMessagingV2Mod.^, serviceSid: String): ChannelListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ChannelList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[ChannelListInstance]
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel", "ChannelPage")
  @js.native
  open class ChannelPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.ipMessagingV2Mod.^, ChannelPayload, ChannelResource, ChannelInstance] {
    /**
  ...
  */
  ...
  /**
    ...
    */
  trait ChannelInstanceRemoveOptions extends StObject {
    
    var xTwilioWebhookEnabled: js.UndefOr[ChannelWebhookEnabledType] = js.undefined
  }
  object ChannelInstanceRemoveOptions {
    
    inline def apply(): ChannelInstanceRemoveOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ChannelInstanceRemoveOptions]
    }
    
    extension [Self <: ChannelInstanceRemoveOptions](x: Self) {
