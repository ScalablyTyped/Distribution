...
object serviceRoleMod {
  
  @JSImport("twilio/lib/rest/chat/v2/service/role", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v2/service/role", "RoleContext")
  @js.native
  open class RoleContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.v2Mod.^, serviceSid: String, sid: String) = this()
  ...
  @JSImport("twilio/lib/rest/chat/v2/service/role", "RoleInstance")
  @js.native
  open class RoleInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the Role resource to fetch
      */
    def this(version: typings.twilio.v2Mod.^, payload: RolePayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The SID of the Service that the resource is associated with
    */
  inline def RoleList(version: typings.twilio.v2Mod.^, serviceSid: String): RoleListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("RoleList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[RoleListInstance]
  
  @JSImport("twilio/lib/rest/chat/v2/service/role", "RolePage")
  @js.native
  open class RolePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2Mod.^, RolePayload, RoleResource, RoleInstance] {
    /**
  ...
  object RoleResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], friendly_name = friendly_name.asInstanceOf[js.Any], permissions = permissions.asInstanceOf[js.Any], service_sid = service_sid.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.twilio.twilioStrings.channel
    - typings.twilio.twilioStrings.deployment
  */
  trait RoleRoleType extends StObject
  object RoleRoleType {
    
    inline def channel: typings.twilio.twilioStrings.channel = "channel".asInstanceOf[typings.twilio.twilioStrings.channel]
    
    inline def deployment: typings.twilio.twilioStrings.deployment = "deployment".asInstanceOf[typings.twilio.twilioStrings.deployment]
  }
  ...
  object RoleSolution {
    ...
    inline def apply(): RoleSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[RoleSolution]
    }
    
    extension [Self <: RoleSolution](x: Self) {
