...
object dialogueMod {
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/dialogue", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/dialogue", "DialogueContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/dialogue", "DialogueInstance")
  @js.native
  ...
  /**
    ...
    * @param assistantSid - The SID of the Assistant that is the parent of the resource
    */
  inline def DialogueList(version: typings.twilio.autopilotV1Mod.^, assistantSid: String): DialogueListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DialogueList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[DialogueListInstance]
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/dialogue", "DialoguePage")
  @js.native
  open class DialoguePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.autopilotV1Mod.^, DialoguePayload, DialogueResource, DialogueInstance] {
    /**
