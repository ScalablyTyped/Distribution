...
object incomingPhoneNumberMobileMod {
  
  @JSImport("twilio/lib/rest/api/v2010/account/incomingPhoneNumber/mobile", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/incomingPhoneNumber/mobile", "MobileInstance")
  @js.native
  open class MobileInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.v2010Mod.^, payload: MobilePayload, accountSid: String) = this()
    
    var accountSid: String = js.native
    
    var addressRequirements: MobileAddressRequirement = js.native
    ...
    var emergencyAddressStatus: MobileEmergencyAddressStatus = js.native
    
    var emergencyStatus: MobileEmergencyStatus = js.native
    ...
    var voiceReceiveMode: MobileVoiceReceiveMode = js.native
  ...
  /**
    ...
    * @param accountSid - The SID of the Account that created the resource
    */
  inline def MobileList(version: typings.twilio.v2010Mod.^, accountSid: String): MobileListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("MobileList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any])).asInstanceOf[MobileListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/incomingPhoneNumber/mobile", "MobilePage")
  @js.native
  ...
  */
  trait MobileAddressRequirement extends StObject
  object MobileAddressRequirement {
  ...
  */
  trait MobileEmergencyAddressStatus extends StObject
  object MobileEmergencyAddressStatus {
  ...
  */
  trait MobileEmergencyStatus extends StObject
  object MobileEmergencyStatus {
  ...
  trait MobileListInstance extends StObject {
    ...
    /**
      ...
      */
    def create(opts: MobileListInstanceCreateOptions): js.Promise[MobileInstance] = js.native
    def create(
      opts: MobileListInstanceCreateOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* item */ MobileInstance, Any]
    ): js.Promise[MobileInstance] = js.native
  ...
  /**
    ...
    */
  trait MobileListInstanceCreateOptions extends StObject {
    ...
    var emergencyStatus: js.UndefOr[MobileEmergencyStatus] = js.undefined
    ...
    var voiceReceiveMode: js.UndefOr[MobileVoiceReceiveMode] = js.undefined
    
    var voiceUrl: js.UndefOr[String] = js.undefined
  }
  object MobileListInstanceCreateOptions {
    
    inline def apply(phoneNumber: String): MobileListInstanceCreateOptions = {
      val __obj = js.Dynamic.literal(phoneNumber = phoneNumber.asInstanceOf[js.Any])
      __obj.asInstanceOf[MobileListInstanceCreateOptions]
    }
    
    extension [Self <: MobileListInstanceCreateOptions](x: Self) {
      ...
      inline def setEmergencyStatus(value: MobileEmergencyStatus): Self = StObject.set(x, "emergencyStatus", value.asInstanceOf[js.Any])
      ...
      inline def setVoiceReceiveMode(value: MobileVoiceReceiveMode): Self = StObject.set(x, "voiceReceiveMode", value.asInstanceOf[js.Any])
  ...
  - typings.twilio.pageMod.TwilioResponsePayload because var conflicts: uri. Inlined first_page_uri, next_page_uri, page, page_size, previous_page_uri, meta */ trait MobilePayload
    extends StObject
       with MobileResource {
  ...
  object MobilePayload {
    ...
    extension [Self <: MobilePayload](x: Self) {
  ...
  trait MobileResource extends StObject {
    ...
    var address_requirements: MobileAddressRequirement
    ...
    var emergency_address_status: MobileEmergencyAddressStatus
    
    var emergency_status: MobileEmergencyStatus
    ...
    var voice_receive_mode: MobileVoiceReceiveMode
  ...
  object MobileResource {
    ...
    extension [Self <: MobileResource](x: Self) {
      ...
      inline def setAddress_requirements(value: MobileAddressRequirement): Self = StObject.set(x, "address_requirements", value.asInstanceOf[js.Any])
      ...
      inline def setEmergency_address_status(value: MobileEmergencyAddressStatus): Self = StObject.set(x, "emergency_address_status", value.asInstanceOf[js.Any])
      
      inline def setEmergency_status(value: MobileEmergencyStatus): Self = StObject.set(x, "emergency_status", value.asInstanceOf[js.Any])
      ...
      inline def setVoice_receive_mode(value: MobileVoiceReceiveMode): Self = StObject.set(x, "voice_receive_mode", value.asInstanceOf[js.Any])
  ...
  */
  trait MobileVoiceReceiveMode extends StObject
  object MobileVoiceReceiveMode {
