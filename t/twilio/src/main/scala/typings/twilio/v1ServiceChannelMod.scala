...
import typings.twilio.serviceChannelInviteMod.InviteContext
import typings.twilio.serviceChannelInviteMod.InviteListInstance
import typings.twilio.v1ServiceChannelMemberMod.MemberContext
import typings.twilio.v1ServiceChannelMemberMod.MemberListInstance
import typings.twilio.v1ServiceChannelMessageMod.MessageContext
import typings.twilio.v1ServiceChannelMessageMod.MessageListInstance
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object v1ServiceChannelMod {
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/channel", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/channel", "ChannelContext")
  @js.native
  open class ChannelContext protected () extends StObject {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.ipMessagingV1Mod.^, serviceSid: String, sid: String) = this()
  ...
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/channel", "ChannelInstance")
  @js.native
  ...
  /**
    ...
    * @param serviceSid - The service_sid
    */
  inline def ChannelList(version: typings.twilio.ipMessagingV1Mod.^, serviceSid: String): ChannelListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ChannelList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[ChannelListInstance]
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/channel", "ChannelPage")
  @js.native
  open class ChannelPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.ipMessagingV1Mod.^, ChannelPayload, ChannelResource, ChannelInstance] {
    /**
