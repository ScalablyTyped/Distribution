...
object ipMessagingV1CredentialMod {
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/credential", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/credential", "CredentialContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/ipMessaging/v1/credential", "CredentialInstance")
  @js.native
  open class CredentialInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.ipMessagingV1Mod.^, payload: CredentialPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def CredentialList(version: typings.twilio.ipMessagingV1Mod.^): CredentialListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("CredentialList")(version.asInstanceOf[js.Any]).asInstanceOf[CredentialListInstance]
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/credential", "CredentialPage")
  @js.native
