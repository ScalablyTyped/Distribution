...
import typings.twilio.executionStepContextMod.ExecutionStepContextContext
import typings.twilio.executionStepContextMod.ExecutionStepContextListInstance
...
object executionStepMod {
  
  @JSImport("twilio/lib/rest/studio/v1/flow/execution/executionStep", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/studio/v1/flow/execution/executionStep", "ExecutionStepContext")
  @js.native
  open class ExecutionStepContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.studioV1Mod.^, flowSid: String, executionSid: String, sid: String) = this()
  ...
  @JSImport("twilio/lib/rest/studio/v1/flow/execution/executionStep", "ExecutionStepInstance")
  @js.native
  ...
  /**
    ...
    * @param executionSid - The SID of the Execution
    */
  inline def ExecutionStepList(version: typings.twilio.studioV1Mod.^, flowSid: String, executionSid: String): ExecutionStepListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ExecutionStepList")(version.asInstanceOf[js.Any], flowSid.asInstanceOf[js.Any], executionSid.asInstanceOf[js.Any])).asInstanceOf[ExecutionStepListInstance]
  
  @JSImport("twilio/lib/rest/studio/v1/flow/execution/executionStep", "ExecutionStepPage")
  @js.native
