...
import typings.twilio.fieldMod.FieldContext
import typings.twilio.fieldMod.FieldListInstance
import typings.twilio.interfacesMod.SerializableClass
import typings.twilio.pageMod.TwilioResponsePayload
import typings.twilio.sampleMod.SampleContext
import typings.twilio.sampleMod.SampleListInstance
import typings.twilio.taskActionsMod.TaskActionsContext
import typings.twilio.taskActionsMod.TaskActionsListInstance
import typings.twilio.taskStatisticsMod.TaskStatisticsContext
import typings.twilio.taskStatisticsMod.TaskStatisticsListInstance
...
object taskMod {
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task", "TaskContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task", "TaskInstance")
  @js.native
  open class TaskInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The unique string that identifies the resource to fetch
      */
    def this(version: typings.twilio.autopilotV1Mod.^, payload: TaskPayload, assistantSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param assistantSid - The SID of the Assistant that is the parent of the resource
    */
  inline def TaskList(version: typings.twilio.autopilotV1Mod.^, assistantSid: String): TaskListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("TaskList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[TaskListInstance]
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task", "TaskPage")
  @js.native
  open class TaskPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.autopilotV1Mod.^, TaskPayload, TaskResource, TaskInstance] {
    /**
