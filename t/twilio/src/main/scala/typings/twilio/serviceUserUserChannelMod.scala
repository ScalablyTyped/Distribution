...
object serviceUserUserChannelMod {
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/user/userChannel", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/user/userChannel", "UserChannelInstance")
  @js.native
  ...
  /**
    ...
    * @param userSid - The sid
    */
  inline def UserChannelList(version: typings.twilio.ipMessagingV1Mod.^, serviceSid: String, userSid: String): UserChannelListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UserChannelList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], userSid.asInstanceOf[js.Any])).asInstanceOf[UserChannelListInstance]
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/user/userChannel", "UserChannelPage")
  @js.native
  open class UserChannelPage protected ()
    extends typings.twilio.pageMod.^[
          typings.twilio.ipMessagingV1Mod.^, 
          UserChannelPayload, 
          UserChannelResource, 
          UserChannelInstance
        ] {
  ...
  */
  ...
  object UserChannelPayload {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], channel_sid = channel_sid.asInstanceOf[js.Any], first_page_uri = first_page_uri.asInstanceOf[js.Any], last_consumed_message_index = last_consumed_message_index.asInstanceOf[js.Any], links = links.asInstanceOf[js.Any], member_sid = member_sid.asInstanceOf[js.Any], next_page_uri = next_page_uri.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], page_size = page_size.asInstanceOf[js.Any], previous_page_uri = previous_page_uri.asInstanceOf[js.Any], service_sid = service_sid.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], unread_messages_count = unread_messages_count.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any])
  ...
  object UserChannelResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], channel_sid = channel_sid.asInstanceOf[js.Any], last_consumed_message_index = last_consumed_message_index.asInstanceOf[js.Any], links = links.asInstanceOf[js.Any], member_sid = member_sid.asInstanceOf[js.Any], service_sid = service_sid.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], unread_messages_count = unread_messages_count.asInstanceOf[js.Any])
