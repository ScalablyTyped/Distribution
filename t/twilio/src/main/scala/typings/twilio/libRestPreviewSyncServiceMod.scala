...
object libRestPreviewSyncServiceMod {
  ...
  open class ServiceContext protected () extends StObject {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.libRestPreviewSyncMod.^, sid: String) = this()
  ...
  open class ServiceInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.libRestPreviewSyncMod.^, payload: ServicePayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def ServiceList(version: typings.twilio.libRestPreviewSyncMod.^): ServiceListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("ServiceList")(version.asInstanceOf[js.Any]).asInstanceOf[ServiceListInstance]
