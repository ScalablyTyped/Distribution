...
object allTimeMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/allTime", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/allTime", "AllTimeInstance")
  @js.native
  open class AllTimeInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.v2010Mod.^, payload: AllTimePayload, accountSid: String) = this()
    ...
    var category: AllTimeCategory = js.native
  ...
  /**
    ...
    * @param accountSid - A 34 character string that uniquely identifies this resource.
    */
  inline def AllTimeList(version: typings.twilio.v2010Mod.^, accountSid: String): AllTimeListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("AllTimeList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any])).asInstanceOf[AllTimeListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/allTime", "AllTimePage")
  @js.native
  open class AllTimePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2010Mod.^, AllTimePayload, AllTimeResource, AllTimeInstance] {
    /**
    ...
    /**
      ...
      */
    def getInstance(payload: AllTimePayload): AllTimeInstance = js.native
  ...
  */
  trait AllTimeCategory extends StObject
  object AllTimeCategory {
  ...
  @js.native
  trait AllTimeListInstance extends StObject {
    ...
    def each(opts: AllTimeListInstanceEachOptions): Unit = js.native
    def each(
      opts: AllTimeListInstanceEachOptions,
      callback: js.Function2[
          /* item */ AllTimeInstance, 
          /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit], 
          Unit
    ...
    /**
      ...
      */
    def getPage(): js.Promise[AllTimePage] = js.native
    def getPage(callback: js.Function2[/* error */ js.Error | Null, /* items */ AllTimePage, Any]): js.Promise[AllTimePage] = js.native
    def getPage(targetUrl: String): js.Promise[AllTimePage] = js.native
    def getPage(
      targetUrl: String,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ AllTimePage, Any]
    ): js.Promise[AllTimePage] = js.native
    def getPage(targetUrl: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ AllTimePage, Any]): js.Promise[AllTimePage] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def list(): js.Promise[js.Array[AllTimeInstance]] = js.native
    def list(callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[AllTimeInstance], Any]): js.Promise[js.Array[AllTimeInstance]] = js.native
    def list(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[AllTimeInstance], Any]
    ): js.Promise[js.Array[AllTimeInstance]] = js.native
    def list(opts: AllTimeListInstanceOptions): js.Promise[js.Array[AllTimeInstance]] = js.native
    def list(
      opts: AllTimeListInstanceOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[AllTimeInstance], Any]
    ): js.Promise[js.Array[AllTimeInstance]] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def page(): js.Promise[AllTimePage] = js.native
    def page(callback: js.Function2[/* error */ js.Error | Null, /* items */ AllTimePage, Any]): js.Promise[AllTimePage] = js.native
    def page(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ AllTimePage, Any]): js.Promise[AllTimePage] = js.native
    def page(opts: AllTimeListInstancePageOptions): js.Promise[AllTimePage] = js.native
    def page(
      opts: AllTimeListInstancePageOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ AllTimePage, Any]
    ): js.Promise[AllTimePage] = js.native
  ...
  /**
    ...
    */
  trait AllTimeListInstanceEachOptions extends StObject {
    ...
    var category: js.UndefOr[AllTimeCategory] = js.undefined
  ...
  object AllTimeListInstanceEachOptions {
    
    inline def apply(): AllTimeListInstanceEachOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AllTimeListInstanceEachOptions]
    }
    
    extension [Self <: AllTimeListInstanceEachOptions](x: Self) {
      
      inline def setCallback(
        value: (/* item */ AllTimeInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2(value))
      
      inline def setCallbackUndefined: Self = StObject.set(x, "callback", js.undefined)
      
      inline def setCategory(value: AllTimeCategory): Self = StObject.set(x, "category", value.asInstanceOf[js.Any])
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait AllTimeListInstanceOptions extends StObject {
  ...
  object AllTimeListInstanceOptions {
    
    inline def apply(): AllTimeListInstanceOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AllTimeListInstanceOptions]
    }
    
    extension [Self <: AllTimeListInstanceOptions](x: Self) {
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait AllTimeListInstancePageOptions extends StObject {
  ...
  object AllTimeListInstancePageOptions {
    
    inline def apply(): AllTimeListInstancePageOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AllTimeListInstancePageOptions]
    }
    
    extension [Self <: AllTimeListInstancePageOptions](x: Self) {
  ...
  - typings.twilio.pageMod.TwilioResponsePayload because var conflicts: uri. Inlined first_page_uri, next_page_uri, page, page_size, previous_page_uri, meta */ trait AllTimePayload
    extends StObject
       with AllTimeResource {
  ...
  object AllTimePayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[AllTimePayload]
    }
    
    extension [Self <: AllTimePayload](x: Self) {
  ...
  trait AllTimeResource extends StObject {
  ...
  object AllTimeResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[AllTimeResource]
    }
    
    extension [Self <: AllTimeResource](x: Self) {
  ...
  trait AllTimeSolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
  }
  object AllTimeSolution {
    
    inline def apply(): AllTimeSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AllTimeSolution]
    }
    
    extension [Self <: AllTimeSolution](x: Self) {
