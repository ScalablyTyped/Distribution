...
object assistantModelBuildMod {
  ...
  /**
    ...
    * @param assistantSid - The unique ID of the parent Assistant.
    */
  inline def ModelBuildList(version: typings.twilio.understandMod.^, assistantSid: String): ModelBuildListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ModelBuildList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[ModelBuildListInstance]
