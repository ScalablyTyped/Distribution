...
import typings.twilio.libRestPreviewTrustedCommsBrandedChannelChannelMod.ChannelListInstance
...
object libRestPreviewTrustedCommsBrandedChannelMod {
  ...
  open class BrandedChannelContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.libRestPreviewTrustedCommsMod.^, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def BrandedChannelList(version: typings.twilio.libRestPreviewTrustedCommsMod.^): BrandedChannelListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("BrandedChannelList")(version.asInstanceOf[js.Any]).asInstanceOf[BrandedChannelListInstance]
