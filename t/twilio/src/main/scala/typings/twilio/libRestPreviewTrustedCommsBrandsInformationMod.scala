...
object libRestPreviewTrustedCommsBrandsInformationMod {
  ...
  open class BrandsInformationInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.libRestPreviewTrustedCommsMod.^, payload: BrandsInformationPayload) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def BrandsInformationList(version: typings.twilio.libRestPreviewTrustedCommsMod.^): BrandsInformationListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("BrandsInformationList")(version.asInstanceOf[js.Any]).asInstanceOf[BrandsInformationListInstance]
