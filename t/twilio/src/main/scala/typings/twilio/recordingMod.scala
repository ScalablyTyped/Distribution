...
object recordingMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/call/recording", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/call/recording", "RecordingContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/call/recording", "RecordingInstance")
  @js.native
  ...
  /**
    ...
    * @param callSid - The SID of the Call the resource is associated with
    */
  inline def RecordingList(version: typings.twilio.v2010Mod.^, accountSid: String, callSid: String): RecordingListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("RecordingList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any], callSid.asInstanceOf[js.Any])).asInstanceOf[RecordingListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/call/recording", "RecordingPage")
  @js.native
  ...
  trait RecordingListInstance extends StObject {
    ...
    /**
      ...
      * @param callback - Callback to handle processed record
      */
    def create(): js.Promise[RecordingInstance] = js.native
    def create(callback: js.Function2[/* error */ js.Error | Null, /* item */ RecordingInstance, Any]): js.Promise[RecordingInstance] = js.native
    def create(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* item */ RecordingInstance, Any]): js.Promise[RecordingInstance] = js.native
    def create(opts: RecordingListInstanceCreateOptions): js.Promise[RecordingInstance] = js.native
    def create(
      opts: RecordingListInstanceCreateOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* item */ RecordingInstance, Any]
    ): js.Promise[RecordingInstance] = js.native
  ...
  /**
    ...
    */
  trait RecordingListInstanceCreateOptions extends StObject {
  ...
  object RecordingListInstanceCreateOptions {
    
    inline def apply(): RecordingListInstanceCreateOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[RecordingListInstanceCreateOptions]
    }
    
    extension [Self <: RecordingListInstanceCreateOptions](x: Self) {
