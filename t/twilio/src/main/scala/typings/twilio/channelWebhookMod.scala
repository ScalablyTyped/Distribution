...
import typings.twilio.anon.Filters
...
object channelWebhookMod {
  
  @JSImport("twilio/lib/rest/chat/v2/service/channel/webhook", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v2/service/channel/webhook", "WebhookContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/chat/v2/service/channel/webhook", "WebhookInstance")
  @js.native
  ...
  /**
    ...
    * @param channelSid - The SID of the Channel the Channel Webhook resource belongs to
    */
  inline def WebhookList(version: typings.twilio.v2Mod.^, serviceSid: String, channelSid: String): WebhookListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("WebhookList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], channelSid.asInstanceOf[js.Any])).asInstanceOf[WebhookListInstance]
  
  @JSImport("twilio/lib/rest/chat/v2/service/channel/webhook", "WebhookPage")
  @js.native
  open class WebhookPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2Mod.^, WebhookPayload, WebhookResource, WebhookInstance] {
    /**
  ...
  trait WebhookInstanceUpdateOptions extends StObject {
    ...
    var configuration: js.UndefOr[Filters] = js.undefined
  }
  object WebhookInstanceUpdateOptions {
    ...
    extension [Self <: WebhookInstanceUpdateOptions](x: Self) {
      ...
      inline def setConfiguration(value: Filters): Self = StObject.set(x, "configuration", value.asInstanceOf[js.Any])
