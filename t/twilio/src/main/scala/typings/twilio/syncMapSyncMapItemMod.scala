...
object syncMapSyncMapItemMod {
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap/syncMapItem", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap/syncMapItem", "SyncMapItemContext")
  @js.native
  open class SyncMapItemContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.syncV1Mod.^, serviceSid: String, mapSid: String, key: String) = this()
    ...
    /**
      ...
      * @param callback - Callback to handle processed record
      */
    def update(): js.Promise[SyncMapItemInstance] = js.native
    def update(callback: js.Function2[/* error */ js.Error | Null, /* items */ SyncMapItemInstance, Any]): js.Promise[SyncMapItemInstance] = js.native
    def update(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ SyncMapItemInstance, Any]
  ...
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap/syncMapItem", "SyncMapItemInstance")
  @js.native
  open class SyncMapItemInstance protected () extends SerializableClass {
    ...
    /**
      ...
      */
    def update(): js.Promise[SyncMapItemInstance] = js.native
    def update(callback: js.Function2[/* error */ js.Error | Null, /* items */ this.type, Any]): js.Promise[SyncMapItemInstance] = js.native
    def update(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ this.type, Any]): js.Promise[SyncMapItemInstance] = js.native
    def update(opts: SyncMapItemInstanceUpdateOptions): js.Promise[SyncMapItemInstance] = js.native
    def update(
      opts: SyncMapItemInstanceUpdateOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ this.type, Any]
  ...
  /**
    ...
    * @param mapSid - The SID of the Sync Map that contains the Map Item
    */
  inline def SyncMapItemList(version: typings.twilio.syncV1Mod.^, serviceSid: String, mapSid: String): SyncMapItemListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SyncMapItemList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], mapSid.asInstanceOf[js.Any])).asInstanceOf[SyncMapItemListInstance]
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap/syncMapItem", "SyncMapItemPage")
  @js.native
  ...
  object SyncMapItemInstanceUpdateOptions {
    ...
    inline def apply(): SyncMapItemInstanceUpdateOptions = {
      val __obj = js.Dynamic.literal()
