...
object cpsMod {
  ...
  open class CpsInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.trustedCommsMod.^, payload: CpsPayload) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def CpsList(version: typings.twilio.trustedCommsMod.^): CpsListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("CpsList")(version.asInstanceOf[js.Any]).asInstanceOf[CpsListInstance]
  
  @JSImport("twilio/lib/rest/preview/trusted_comms/cps", "CpsPage")
  @js.native
  open class CpsPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.trustedCommsMod.^, CpsPayload, CpsResource, CpsInstance] {
    /**
