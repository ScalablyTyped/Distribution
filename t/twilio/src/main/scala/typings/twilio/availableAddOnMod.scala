...
import typings.twilio.availableAddOnExtensionMod.AvailableAddOnExtensionContext
import typings.twilio.availableAddOnExtensionMod.AvailableAddOnExtensionListInstance
...
object availableAddOnMod {
  ...
  open class AvailableAddOnContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.marketplaceMod.^, sid: String) = this()
  ...
  open class AvailableAddOnInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the AvailableAddOn resource to fetch
      */
    def this(version: typings.twilio.marketplaceMod.^, payload: AvailableAddOnPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def AvailableAddOnList(version: typings.twilio.marketplaceMod.^): AvailableAddOnListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("AvailableAddOnList")(version.asInstanceOf[js.Any]).asInstanceOf[AvailableAddOnListInstance]
  ...
  open class AvailableAddOnPage protected ()
    ...
    /**
      ...
      */
    def this(
      version: typings.twilio.marketplaceMod.^,
  ...
  object AvailableAddOnListInstanceEachOptions {
    ...
    extension [Self <: AvailableAddOnListInstanceEachOptions](x: Self) {
  ...
  object AvailableAddOnListInstanceOptions {
    ...
    extension [Self <: AvailableAddOnListInstanceOptions](x: Self) {
  ...
  object AvailableAddOnListInstancePageOptions {
    ...
    extension [Self <: AvailableAddOnListInstancePageOptions](x: Self) {
  ...
  object AvailableAddOnResource {
    ...
    extension [Self <: AvailableAddOnResource](x: Self) {
