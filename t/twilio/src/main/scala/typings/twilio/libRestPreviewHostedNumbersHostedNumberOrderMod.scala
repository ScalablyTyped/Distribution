...
object libRestPreviewHostedNumbersHostedNumberOrderMod {
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def HostedNumberOrderList(version: typings.twilio.libRestPreviewHostedNumbersMod.^): HostedNumberOrderListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("HostedNumberOrderList")(version.asInstanceOf[js.Any]).asInstanceOf[HostedNumberOrderListInstance]
