...
import typings.twilio.channelInviteMod.InviteContext
import typings.twilio.channelInviteMod.InviteListInstance
import typings.twilio.channelWebhookMod.WebhookContext
import typings.twilio.channelWebhookMod.WebhookListInstance
import typings.twilio.interfacesMod.SerializableClass
import typings.twilio.pageMod.TwilioResponsePayload
import typings.twilio.serviceChannelMemberMod.MemberContext
import typings.twilio.serviceChannelMemberMod.MemberListInstance
import typings.twilio.serviceChannelMessageMod.MessageContext
import typings.twilio.serviceChannelMessageMod.MessageListInstance
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object serviceChannelMod {
  
  @JSImport("twilio/lib/rest/chat/v2/service/channel", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v2/service/channel", "ChannelContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/chat/v2/service/channel", "ChannelInstance")
  @js.native
  open class ChannelInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the resource
      */
    def this(version: typings.twilio.v2Mod.^, payload: ChannelPayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The SID of the Service that the resource is associated with
    */
  inline def ChannelList(version: typings.twilio.v2Mod.^, serviceSid: String): ChannelListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ChannelList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[ChannelListInstance]
  
  @JSImport("twilio/lib/rest/chat/v2/service/channel", "ChannelPage")
  @js.native
  open class ChannelPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2Mod.^, ChannelPayload, ChannelResource, ChannelInstance] {
    /**
