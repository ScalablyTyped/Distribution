...
object fleetDeviceMod {
  ...
  /**
    ...
    * @param fleetSid - The unique identifier of the Fleet.
    */
  inline def DeviceList(version: typings.twilio.deployedDevicesMod.^, fleetSid: String): DeviceListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DeviceList")(version.asInstanceOf[js.Any], fleetSid.asInstanceOf[js.Any])).asInstanceOf[DeviceListInstance]
  
  @JSImport("twilio/lib/rest/preview/deployed_devices/fleet/device", "DevicePage")
  @js.native
  open class DevicePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.deployedDevicesMod.^, DevicePayload, DeviceResource, DeviceInstance] {
    /**
