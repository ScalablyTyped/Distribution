...
object userBindingMod {
  
  @JSImport("twilio/lib/rest/chat/v2/service/user/userBinding", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v2/service/user/userBinding", "UserBindingContext")
  @js.native
  open class UserBindingContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.v2Mod.^, serviceSid: String, userSid: String, sid: String) = this()
  ...
  @JSImport("twilio/lib/rest/chat/v2/service/user/userBinding", "UserBindingInstance")
  @js.native
  ...
  /**
    ...
    * @param userSid - The SID of the User with the binding
    */
  inline def UserBindingList(version: typings.twilio.v2Mod.^, serviceSid: String, userSid: String): UserBindingListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UserBindingList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], userSid.asInstanceOf[js.Any])).asInstanceOf[UserBindingListInstance]
  
  @JSImport("twilio/lib/rest/chat/v2/service/user/userBinding", "UserBindingPage")
  @js.native
  open class UserBindingPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2Mod.^, UserBindingPayload, UserBindingResource, UserBindingInstance] {
    /**
