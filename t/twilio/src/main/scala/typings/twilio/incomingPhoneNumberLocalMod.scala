...
object incomingPhoneNumberLocalMod {
  
  @JSImport("twilio/lib/rest/api/v2010/account/incomingPhoneNumber/local", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/incomingPhoneNumber/local", "LocalInstance")
  @js.native
  open class LocalInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.v2010Mod.^, payload: LocalPayload, accountSid: String) = this()
    
    var accountSid: String = js.native
    
    var addressRequirements: LocalAddressRequirement = js.native
    ...
    var emergencyAddressStatus: LocalEmergencyAddressStatus = js.native
    
    var emergencyStatus: LocalEmergencyStatus = js.native
    ...
    var voiceReceiveMode: LocalVoiceReceiveMode = js.native
  ...
  /**
    ...
    * @param accountSid - The SID of the Account that created the resource
    */
  inline def LocalList(version: typings.twilio.v2010Mod.^, accountSid: String): LocalListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("LocalList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any])).asInstanceOf[LocalListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/incomingPhoneNumber/local", "LocalPage")
  @js.native
  open class LocalPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2010Mod.^, LocalPayload, LocalResource, LocalInstance] {
    /**
    ...
    /**
      ...
      */
    def getInstance(payload: LocalPayload): LocalInstance = js.native
  ...
  */
  trait LocalAddressRequirement extends StObject
  object LocalAddressRequirement {
  ...
  */
  trait LocalEmergencyAddressStatus extends StObject
  object LocalEmergencyAddressStatus {
  ...
  */
  trait LocalEmergencyStatus extends StObject
  object LocalEmergencyStatus {
  ...
  @js.native
  trait LocalListInstance extends StObject {
    ...
    /**
      ...
      */
    def create(opts: LocalListInstanceCreateOptions): js.Promise[LocalInstance] = js.native
    def create(
      opts: LocalListInstanceCreateOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* item */ LocalInstance, Any]
    ): js.Promise[LocalInstance] = js.native
    ...
    def each(opts: LocalListInstanceEachOptions): Unit = js.native
    def each(
      opts: LocalListInstanceEachOptions,
      callback: js.Function2[
          /* item */ LocalInstance, 
          /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit], 
          Unit
    ...
    /**
      ...
      */
    def getPage(): js.Promise[LocalPage] = js.native
    def getPage(callback: js.Function2[/* error */ js.Error | Null, /* items */ LocalPage, Any]): js.Promise[LocalPage] = js.native
    def getPage(targetUrl: String): js.Promise[LocalPage] = js.native
    def getPage(targetUrl: String, callback: js.Function2[/* error */ js.Error | Null, /* items */ LocalPage, Any]): js.Promise[LocalPage] = js.native
    def getPage(targetUrl: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ LocalPage, Any]): js.Promise[LocalPage] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def list(): js.Promise[js.Array[LocalInstance]] = js.native
    def list(callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[LocalInstance], Any]): js.Promise[js.Array[LocalInstance]] = js.native
    def list(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[LocalInstance], Any]
    ): js.Promise[js.Array[LocalInstance]] = js.native
    def list(opts: LocalListInstanceOptions): js.Promise[js.Array[LocalInstance]] = js.native
    def list(
      opts: LocalListInstanceOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[LocalInstance], Any]
    ): js.Promise[js.Array[LocalInstance]] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def page(): js.Promise[LocalPage] = js.native
    def page(callback: js.Function2[/* error */ js.Error | Null, /* items */ LocalPage, Any]): js.Promise[LocalPage] = js.native
    def page(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ LocalPage, Any]): js.Promise[LocalPage] = js.native
    def page(opts: LocalListInstancePageOptions): js.Promise[LocalPage] = js.native
    def page(
      opts: LocalListInstancePageOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ LocalPage, Any]
    ): js.Promise[LocalPage] = js.native
  ...
  /**
    ...
    */
  trait LocalListInstanceCreateOptions extends StObject {
    ...
    var emergencyStatus: js.UndefOr[LocalEmergencyStatus] = js.undefined
    ...
    var voiceReceiveMode: js.UndefOr[LocalVoiceReceiveMode] = js.undefined
    
    var voiceUrl: js.UndefOr[String] = js.undefined
  }
  object LocalListInstanceCreateOptions {
    
    inline def apply(phoneNumber: String): LocalListInstanceCreateOptions = {
      val __obj = js.Dynamic.literal(phoneNumber = phoneNumber.asInstanceOf[js.Any])
      __obj.asInstanceOf[LocalListInstanceCreateOptions]
    }
    
    extension [Self <: LocalListInstanceCreateOptions](x: Self) {
      ...
      inline def setEmergencyStatus(value: LocalEmergencyStatus): Self = StObject.set(x, "emergencyStatus", value.asInstanceOf[js.Any])
      ...
      inline def setVoiceReceiveMode(value: LocalVoiceReceiveMode): Self = StObject.set(x, "voiceReceiveMode", value.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  trait LocalListInstanceEachOptions extends StObject {
  ...
  object LocalListInstanceEachOptions {
    
    inline def apply(): LocalListInstanceEachOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LocalListInstanceEachOptions]
    }
    
    extension [Self <: LocalListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ LocalInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit
  ...
  /**
    ...
    * @property phoneNumber - The phone numbers of the resources to read
    */
  trait LocalListInstanceOptions extends StObject {
  ...
  object LocalListInstanceOptions {
    
    inline def apply(): LocalListInstanceOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LocalListInstanceOptions]
    }
    
    extension [Self <: LocalListInstanceOptions](x: Self) {
  ...
  /**
    ...
    * @property phoneNumber - The phone numbers of the resources to read
    */
  trait LocalListInstancePageOptions extends StObject {
  ...
  object LocalListInstancePageOptions {
    
    inline def apply(): LocalListInstancePageOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LocalListInstancePageOptions]
    }
    
    extension [Self <: LocalListInstancePageOptions](x: Self) {
  ...
  - typings.twilio.pageMod.TwilioResponsePayload because var conflicts: uri. Inlined first_page_uri, next_page_uri, page, page_size, previous_page_uri, meta */ trait LocalPayload
    extends StObject
       with LocalResource {
  ...
  object LocalPayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[LocalPayload]
    }
    
    extension [Self <: LocalPayload](x: Self) {
  ...
  trait LocalResource extends StObject {
    
    var account_sid: String
    
    var address_requirements: LocalAddressRequirement
    ...
    var emergency_address_status: LocalEmergencyAddressStatus
    
    var emergency_status: LocalEmergencyStatus
    ...
    var voice_receive_mode: LocalVoiceReceiveMode
  ...
  object LocalResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[LocalResource]
    }
    
    extension [Self <: LocalResource](x: Self) {
      
      inline def setAccount_sid(value: String): Self = StObject.set(x, "account_sid", value.asInstanceOf[js.Any])
      
      inline def setAddress_requirements(value: LocalAddressRequirement): Self = StObject.set(x, "address_requirements", value.asInstanceOf[js.Any])
      ...
      inline def setEmergency_address_status(value: LocalEmergencyAddressStatus): Self = StObject.set(x, "emergency_address_status", value.asInstanceOf[js.Any])
      
      inline def setEmergency_status(value: LocalEmergencyStatus): Self = StObject.set(x, "emergency_status", value.asInstanceOf[js.Any])
      ...
      inline def setVoice_receive_mode(value: LocalVoiceReceiveMode): Self = StObject.set(x, "voice_receive_mode", value.asInstanceOf[js.Any])
      
      inline def setVoice_url(value: String): Self = StObject.set(x, "voice_url", value.asInstanceOf[js.Any])
    }
  }
  
  trait LocalSolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
  }
  object LocalSolution {
    
    inline def apply(): LocalSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LocalSolution]
    }
    
    extension [Self <: LocalSolution](x: Self) {
  ...
  */
  trait LocalVoiceReceiveMode extends StObject
  object LocalVoiceReceiveMode {
