...
object serviceConfigurationWebhookMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/service/configuration/webhook", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/service/configuration/webhook", "WebhookContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/conversations/v1/service/configuration/webhook", "WebhookInstance")
  @js.native
  open class WebhookInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.conversationsV1Mod.^, payload: WebhookPayload, chatServiceSid: String) = this()
  ...
  /**
    ...
    * @param chatServiceSid - The unique string that identifies the resource
    */
  inline def WebhookList(version: typings.twilio.conversationsV1Mod.^, chatServiceSid: String): WebhookListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("WebhookList")(version.asInstanceOf[js.Any], chatServiceSid.asInstanceOf[js.Any])).asInstanceOf[WebhookListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/service/configuration/webhook", "WebhookPage")
  @js.native
  ...
  */
  ...
  object WebhookPayload {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], chat_service_sid = chat_service_sid.asInstanceOf[js.Any], filters = filters.asInstanceOf[js.Any], first_page_uri = first_page_uri.asInstanceOf[js.Any], method = method.asInstanceOf[js.Any], next_page_uri = next_page_uri.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], page_size = page_size.asInstanceOf[js.Any], post_webhook_url = post_webhook_url.asInstanceOf[js.Any], pre_webhook_url = pre_webhook_url.asInstanceOf[js.Any], previous_page_uri = previous_page_uri.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
  ...
  object WebhookResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], chat_service_sid = chat_service_sid.asInstanceOf[js.Any], filters = filters.asInstanceOf[js.Any], method = method.asInstanceOf[js.Any], post_webhook_url = post_webhook_url.asInstanceOf[js.Any], pre_webhook_url = pre_webhook_url.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
