...
import typings.twilio.bindingMod.BindingContext
import typings.twilio.bindingMod.BindingListInstance
import typings.twilio.interfacesMod.SerializableClass
import typings.twilio.pageMod.TwilioResponsePayload
import typings.twilio.serviceChannelMod.ChannelContext
import typings.twilio.serviceChannelMod.ChannelListInstance
import typings.twilio.serviceRoleMod.RoleContext
import typings.twilio.serviceRoleMod.RoleListInstance
import typings.twilio.serviceUserMod.UserContext
import typings.twilio.serviceUserMod.UserListInstance
...
object v2ServiceMod {
  ...
  @JSImport("twilio/lib/rest/chat/v2/service", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v2/service", "ServiceContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/chat/v2/service", "ServiceInstance")
  @js.native
  open class ServiceInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the Service resource to fetch
      */
    def this(version: typings.twilio.v2Mod.^, payload: ServicePayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def ServiceList(version: typings.twilio.v2Mod.^): ServiceListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("ServiceList")(version.asInstanceOf[js.Any]).asInstanceOf[ServiceListInstance]
  
  @JSImport("twilio/lib/rest/chat/v2/service", "ServicePage")
  @js.native
  open class ServicePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2Mod.^, ServicePayload, ServiceResource, ServiceInstance] {
    /**
