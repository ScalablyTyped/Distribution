...
object syncListSyncListPermissionMod {
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncList/syncListPermission", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncList/syncListPermission", "SyncListPermissionContext")
  @js.native
  open class SyncListPermissionContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.syncV1Mod.^, serviceSid: String, listSid: String, identity: String) = this()
  ...
  @JSImport("twilio/lib/rest/sync/v1/service/syncList/syncListPermission", "SyncListPermissionInstance")
  @js.native
  ...
  /**
    ...
    * @param listSid - The SID of the Sync List to which the Permission applies
    */
  inline def SyncListPermissionList(version: typings.twilio.syncV1Mod.^, serviceSid: String, listSid: String): SyncListPermissionListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SyncListPermissionList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], listSid.asInstanceOf[js.Any])).asInstanceOf[SyncListPermissionListInstance]
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncList/syncListPermission", "SyncListPermissionPage")
  @js.native
