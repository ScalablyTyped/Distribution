...
import typings.twilio.userChannelMod.UserChannelListInstance
...
object userMod {
  ...
  @JSImport("twilio/lib/rest/chat/v1/service/user", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v1/service/user", "UserContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/chat/v1/service/user", "UserInstance")
  @js.native
  open class UserInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The unique string that identifies the resource
      */
    def this(version: typings.twilio.chatV1Mod.^, payload: UserPayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The SID of the Service that the resource is associated with
    */
  inline def UserList(version: typings.twilio.chatV1Mod.^, serviceSid: String): UserListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UserList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[UserListInstance]
  
  @JSImport("twilio/lib/rest/chat/v1/service/user", "UserPage")
  @js.native
  open class UserPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.chatV1Mod.^, UserPayload, UserResource, UserInstance] {
    /**
