...
trait ActionsUrl extends StObject {
...
object ActionsUrl {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(accountSid = accountSid.asInstanceOf[js.Any], actionsUrl = actionsUrl.asInstanceOf[js.Any], assistantSid = assistantSid.asInstanceOf[js.Any], dateCreated = dateCreated.asInstanceOf[js.Any], dateUpdated = dateUpdated.asInstanceOf[js.Any], friendlyName = friendlyName.asInstanceOf[js.Any], links = links.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], uniqueName = uniqueName.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[ActionsUrl]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ActionsUrl] (val x: Self) extends AnyVal {
