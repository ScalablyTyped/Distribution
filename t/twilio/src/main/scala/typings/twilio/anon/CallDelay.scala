...
trait CallDelay extends StObject {
...
object CallDelay {
  ...
  implicit open class MutableBuilder[Self <: CallDelay] (val x: Self) extends AnyVal {
    ...
    inline def setVerificationType(value: DependentHostedNumberOrderVerificationType): Self = StObject.set(x, "verificationType", value.asInstanceOf[js.Any])
  }
}
