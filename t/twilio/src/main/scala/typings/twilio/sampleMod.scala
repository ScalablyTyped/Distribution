...
object sampleMod {
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task/sample", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task/sample", "SampleContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task/sample", "SampleInstance")
  @js.native
  ...
  /**
    ...
    * @param taskSid - The SID of the Task associated with the resource
    */
  inline def SampleList(version: typings.twilio.autopilotV1Mod.^, assistantSid: String, taskSid: String): SampleListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SampleList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any], taskSid.asInstanceOf[js.Any])).asInstanceOf[SampleListInstance]
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task/sample", "SamplePage")
  @js.native
  open class SamplePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.autopilotV1Mod.^, SamplePayload, SampleResource, SampleInstance] {
    /**
