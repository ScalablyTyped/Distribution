...
object roleMod {
  ...
  @JSImport("twilio/lib/rest/chat/v1/service/role", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v1/service/role", "RoleContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/chat/v1/service/role", "RoleInstance")
  @js.native
  open class RoleInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The unique string that identifies the resource
      */
    def this(version: typings.twilio.chatV1Mod.^, payload: RolePayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The SID of the Service that the resource is associated with
    */
  inline def RoleList(version: typings.twilio.chatV1Mod.^, serviceSid: String): RoleListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("RoleList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[RoleListInstance]
  
  @JSImport("twilio/lib/rest/chat/v1/service/role", "RolePage")
  @js.native
  open class RolePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.chatV1Mod.^, RolePayload, RoleResource, RoleInstance] {
    /**
