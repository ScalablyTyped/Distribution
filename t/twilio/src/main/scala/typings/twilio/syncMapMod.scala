...
import typings.twilio.syncMapItemMod.SyncMapItemContext
import typings.twilio.syncMapItemMod.SyncMapItemListInstance
import typings.twilio.syncMapPermissionMod.SyncMapPermissionContext
import typings.twilio.syncMapPermissionMod.SyncMapPermissionListInstance
...
object syncMapMod {
  ...
  open class SyncMapInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.syncMod.^, payload: SyncMapPayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The service_sid
    */
  inline def SyncMapList(version: typings.twilio.syncMod.^, serviceSid: String): SyncMapListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SyncMapList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[SyncMapListInstance]
  
  @JSImport("twilio/lib/rest/preview/sync/service/syncMap", "SyncMapPage")
  @js.native
  open class SyncMapPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.syncMod.^, SyncMapPayload, SyncMapResource, SyncMapInstance] {
    /**
