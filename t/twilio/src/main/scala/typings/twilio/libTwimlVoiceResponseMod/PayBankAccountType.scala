...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.twilio.twilioStrings.`commercial-savings`
*/
trait PayBankAccountType extends StObject
object PayBankAccountType {
  ...
  inline def `commercial-savings`: typings.twilio.twilioStrings.`commercial-savings` = "commercial-savings".asInstanceOf[typings.twilio.twilioStrings.`commercial-savings`]
