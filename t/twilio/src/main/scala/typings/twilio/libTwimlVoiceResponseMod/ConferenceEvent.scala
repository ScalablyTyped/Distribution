...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.twilio.twilioStrings.modify
  - typings.twilio.twilioStrings.speaker
  - typings.twilio.twilioStrings.announcement
*/
trait ConferenceEvent extends StObject
object ConferenceEvent {
  
  inline def announcement: typings.twilio.twilioStrings.announcement = "announcement".asInstanceOf[typings.twilio.twilioStrings.announcement]
  ...
  inline def modify: typings.twilio.twilioStrings.modify = "modify".asInstanceOf[typings.twilio.twilioStrings.modify]
