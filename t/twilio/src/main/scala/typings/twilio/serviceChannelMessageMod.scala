...
object serviceChannelMessageMod {
  
  @JSImport("twilio/lib/rest/chat/v2/service/channel/message", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v2/service/channel/message", "MessageContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/chat/v2/service/channel/message", "MessageInstance")
  @js.native
  ...
  /**
    ...
    * @param channelSid - The SID of the Channel the Message resource belongs to
    */
  inline def MessageList(version: typings.twilio.v2Mod.^, serviceSid: String, channelSid: String): MessageListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("MessageList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], channelSid.asInstanceOf[js.Any])).asInstanceOf[MessageListInstance]
  
  @JSImport("twilio/lib/rest/chat/v2/service/channel/message", "MessagePage")
  @js.native
  open class MessagePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2Mod.^, MessagePayload, MessageResource, MessageInstance] {
    /**
