...
import typings.twilio.assistantDialogueMod.DialogueContext
import typings.twilio.assistantDialogueMod.DialogueListInstance
import typings.twilio.assistantFallbackActionsMod.AssistantFallbackActionsContext
import typings.twilio.assistantFallbackActionsMod.AssistantFallbackActionsListInstance
import typings.twilio.assistantFieldTypeMod.FieldTypeContext
import typings.twilio.assistantFieldTypeMod.FieldTypeListInstance
import typings.twilio.assistantInitiationActionsMod.AssistantInitiationActionsContext
import typings.twilio.assistantInitiationActionsMod.AssistantInitiationActionsListInstance
import typings.twilio.assistantModelBuildMod.ModelBuildContext
import typings.twilio.assistantModelBuildMod.ModelBuildListInstance
import typings.twilio.assistantQueryMod.QueryContext
import typings.twilio.assistantQueryMod.QueryListInstance
import typings.twilio.assistantStyleSheetMod.StyleSheetContext
import typings.twilio.assistantStyleSheetMod.StyleSheetListInstance
import typings.twilio.assistantTaskMod.TaskContext
import typings.twilio.assistantTaskMod.TaskListInstance
...
object understandAssistantMod {
  ...
  open class AssistantContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.understandMod.^, sid: String) = this()
  ...
  open class AssistantInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - A 34 character string that uniquely identifies this resource.
      */
    def this(version: typings.twilio.understandMod.^, payload: AssistantPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def AssistantList(version: typings.twilio.understandMod.^): AssistantListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("AssistantList")(version.asInstanceOf[js.Any]).asInstanceOf[AssistantListInstance]
  
  @JSImport("twilio/lib/rest/preview/understand/assistant", "AssistantPage")
  @js.native
  open class AssistantPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.understandMod.^, AssistantPayload, AssistantResource, AssistantInstance] {
    /**
