...
object deploymentMod {
  ...
  /**
    ...
    * @param fleetSid - The unique identifier of the Fleet.
    */
  inline def DeploymentList(version: typings.twilio.deployedDevicesMod.^, fleetSid: String): DeploymentListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DeploymentList")(version.asInstanceOf[js.Any], fleetSid.asInstanceOf[js.Any])).asInstanceOf[DeploymentListInstance]
  ...
  open class DeploymentPage protected ()
    extends typings.twilio.pageMod.^[
          typings.twilio.deployedDevicesMod.^, 
          DeploymentPayload, 
          DeploymentResource, 
          DeploymentInstance
        ] {
