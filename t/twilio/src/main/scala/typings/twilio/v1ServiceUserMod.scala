...
import typings.twilio.userConversationMod.UserConversationContext
import typings.twilio.userConversationMod.UserConversationListInstance
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object v1ServiceUserMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/service/user", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/service/user", "UserContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/conversations/v1/service/user", "UserInstance")
  @js.native
  ...
  /**
    ...
    * @param chatServiceSid - The SID of the Conversation Service that the resource is associated with
    */
  inline def UserList(version: typings.twilio.conversationsV1Mod.^, chatServiceSid: String): UserListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UserList")(version.asInstanceOf[js.Any], chatServiceSid.asInstanceOf[js.Any])).asInstanceOf[UserListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/service/user", "UserPage")
  @js.native
