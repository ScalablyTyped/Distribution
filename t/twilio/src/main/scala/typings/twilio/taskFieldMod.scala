...
object taskFieldMod {
  ...
  open class FieldContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.understandMod.^, assistantSid: String, taskSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param taskSid - The unique ID of the Task associated with this Field.
    */
  inline def FieldList(version: typings.twilio.understandMod.^, assistantSid: String, taskSid: String): FieldListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("FieldList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any], taskSid.asInstanceOf[js.Any])).asInstanceOf[FieldListInstance]
  
  @JSImport("twilio/lib/rest/preview/understand/assistant/task/field", "FieldPage")
  @js.native
  open class FieldPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.understandMod.^, FieldPayload, FieldResource, FieldInstance] {
    /**
