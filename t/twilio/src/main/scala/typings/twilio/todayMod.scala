...
object todayMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/today", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/today", "TodayInstance")
  @js.native
  open class TodayInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.v2010Mod.^, payload: TodayPayload, accountSid: String) = this()
    ...
    var category: TodayCategory = js.native
  ...
  /**
    ...
    * @param accountSid - A 34 character string that uniquely identifies this resource.
    */
  inline def TodayList(version: typings.twilio.v2010Mod.^, accountSid: String): TodayListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("TodayList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any])).asInstanceOf[TodayListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/today", "TodayPage")
  @js.native
  open class TodayPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2010Mod.^, TodayPayload, TodayResource, TodayInstance] {
    /**
    ...
    /**
      ...
      */
    def getInstance(payload: TodayPayload): TodayInstance = js.native
  ...
  */
  trait TodayCategory extends StObject
  object TodayCategory {
  ...
  @js.native
  trait TodayListInstance extends StObject {
    ...
    def each(opts: TodayListInstanceEachOptions): Unit = js.native
    def each(
      opts: TodayListInstanceEachOptions,
      callback: js.Function2[
          /* item */ TodayInstance, 
          /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit], 
          Unit
    ...
    /**
      ...
      */
    def getPage(): js.Promise[TodayPage] = js.native
    def getPage(callback: js.Function2[/* error */ js.Error | Null, /* items */ TodayPage, Any]): js.Promise[TodayPage] = js.native
    def getPage(targetUrl: String): js.Promise[TodayPage] = js.native
    def getPage(targetUrl: String, callback: js.Function2[/* error */ js.Error | Null, /* items */ TodayPage, Any]): js.Promise[TodayPage] = js.native
    def getPage(targetUrl: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ TodayPage, Any]): js.Promise[TodayPage] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def list(): js.Promise[js.Array[TodayInstance]] = js.native
    def list(callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[TodayInstance], Any]): js.Promise[js.Array[TodayInstance]] = js.native
    def list(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[TodayInstance], Any]
    ): js.Promise[js.Array[TodayInstance]] = js.native
    def list(opts: TodayListInstanceOptions): js.Promise[js.Array[TodayInstance]] = js.native
    def list(
      opts: TodayListInstanceOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[TodayInstance], Any]
    ): js.Promise[js.Array[TodayInstance]] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def page(): js.Promise[TodayPage] = js.native
    def page(callback: js.Function2[/* error */ js.Error | Null, /* items */ TodayPage, Any]): js.Promise[TodayPage] = js.native
    def page(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ TodayPage, Any]): js.Promise[TodayPage] = js.native
    def page(opts: TodayListInstancePageOptions): js.Promise[TodayPage] = js.native
    def page(
      opts: TodayListInstancePageOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ TodayPage, Any]
    ): js.Promise[TodayPage] = js.native
  ...
  /**
    ...
    */
  trait TodayListInstanceEachOptions extends StObject {
    ...
    var category: js.UndefOr[TodayCategory] = js.undefined
  ...
  object TodayListInstanceEachOptions {
    
    inline def apply(): TodayListInstanceEachOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TodayListInstanceEachOptions]
    }
    
    extension [Self <: TodayListInstanceEachOptions](x: Self) {
      
      inline def setCallback(
        value: (/* item */ TodayInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2(value))
      
      inline def setCallbackUndefined: Self = StObject.set(x, "callback", js.undefined)
      
      inline def setCategory(value: TodayCategory): Self = StObject.set(x, "category", value.asInstanceOf[js.Any])
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait TodayListInstanceOptions extends StObject {
  ...
  object TodayListInstanceOptions {
    
    inline def apply(): TodayListInstanceOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TodayListInstanceOptions]
    }
    
    extension [Self <: TodayListInstanceOptions](x: Self) {
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait TodayListInstancePageOptions extends StObject {
  ...
  object TodayListInstancePageOptions {
    
    inline def apply(): TodayListInstancePageOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TodayListInstancePageOptions]
    }
    
    extension [Self <: TodayListInstancePageOptions](x: Self) {
  ...
  - typings.twilio.pageMod.TwilioResponsePayload because var conflicts: uri. Inlined first_page_uri, next_page_uri, page, page_size, previous_page_uri, meta */ trait TodayPayload
    extends StObject
       with TodayResource {
  ...
  object TodayPayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[TodayPayload]
    }
    
    extension [Self <: TodayPayload](x: Self) {
  ...
  trait TodayResource extends StObject {
  ...
  object TodayResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[TodayResource]
    }
    
    extension [Self <: TodayResource](x: Self) {
  ...
  trait TodaySolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
  }
  object TodaySolution {
    
    inline def apply(): TodaySolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TodaySolution]
    }
    
    extension [Self <: TodaySolution](x: Self) {
