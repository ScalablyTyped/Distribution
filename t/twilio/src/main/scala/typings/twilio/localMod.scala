...
object localMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/local", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/local", "LocalInstance")
  @js.native
  open class LocalInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.v2010Mod.^, payload: LocalPayload, accountSid: String, countryCode: String) = this()
  ...
  /**
    ...
    * @param countryCode - The ISO-3166-1 country code of the country.
    */
  inline def LocalList(version: typings.twilio.v2010Mod.^, accountSid: String, countryCode: String): LocalListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("LocalList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any], countryCode.asInstanceOf[js.Any])).asInstanceOf[LocalListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/local", "LocalPage")
  @js.native
