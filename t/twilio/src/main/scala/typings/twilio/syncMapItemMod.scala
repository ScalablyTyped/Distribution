...
object syncMapItemMod {
  ...
  open class SyncMapItemContext protected () extends StObject {
    /**
      ...
      * @param key - The key
      */
    def this(version: typings.twilio.syncMod.^, serviceSid: String, mapSid: String, key: String) = this()
  ...
  /**
    ...
    * @param mapSid - The map_sid
    */
  inline def SyncMapItemList(version: typings.twilio.syncMod.^, serviceSid: String, mapSid: String): SyncMapItemListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SyncMapItemList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], mapSid.asInstanceOf[js.Any])).asInstanceOf[SyncMapItemListInstance]
  
  @JSImport("twilio/lib/rest/preview/sync/service/syncMap/syncMapItem", "SyncMapItemPage")
  @js.native
  open class SyncMapItemPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.syncMod.^, SyncMapItemPayload, SyncMapItemResource, SyncMapItemInstance] {
    /**
