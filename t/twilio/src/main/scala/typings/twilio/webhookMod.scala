...
object webhookMod {
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/webhook", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/webhook", "WebhookContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/webhook", "WebhookInstance")
  @js.native
  ...
  /**
    ...
    * @param assistantSid - The SID of the Assistant that is the parent of the resource
    */
  inline def WebhookList(version: typings.twilio.autopilotV1Mod.^, assistantSid: String): WebhookListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("WebhookList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[WebhookListInstance]
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/webhook", "WebhookPage")
  @js.native
  open class WebhookPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.autopilotV1Mod.^, WebhookPayload, WebhookResource, WebhookInstance] {
    /**
  ...
  object WebhookListInstanceCreateOptions {
    ...
    inline def apply(events: String, uniqueName: String, webhookUrl: String): WebhookListInstanceCreateOptions = {
      val __obj = js.Dynamic.literal(events = events.asInstanceOf[js.Any], uniqueName = uniqueName.asInstanceOf[js.Any], webhookUrl = webhookUrl.asInstanceOf[js.Any])
  ...
  object WebhookPayload {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], assistant_sid = assistant_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], events = events.asInstanceOf[js.Any], first_page_uri = first_page_uri.asInstanceOf[js.Any], next_page_uri = next_page_uri.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], page_size = page_size.asInstanceOf[js.Any], previous_page_uri = previous_page_uri.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], unique_name = unique_name.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], webhook_method = webhook_method.asInstanceOf[js.Any], webhook_url = webhook_url.asInstanceOf[js.Any])
  ...
  object WebhookResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], assistant_sid = assistant_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], events = events.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], unique_name = unique_name.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], webhook_method = webhook_method.asInstanceOf[js.Any], webhook_url = webhook_url.asInstanceOf[js.Any])
