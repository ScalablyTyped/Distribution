...
object v2CredentialMod {
  
  @JSImport("twilio/lib/rest/chat/v2/credential", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v2/credential", "CredentialContext")
  @js.native
  open class CredentialContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.v2Mod.^, sid: String) = this()
  ...
  @JSImport("twilio/lib/rest/chat/v2/credential", "CredentialInstance")
  @js.native
  open class CredentialInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the Credential resource to fetch
      */
    def this(version: typings.twilio.v2Mod.^, payload: CredentialPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def CredentialList(version: typings.twilio.v2Mod.^): CredentialListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("CredentialList")(version.asInstanceOf[js.Any]).asInstanceOf[CredentialListInstance]
  
  @JSImport("twilio/lib/rest/chat/v2/credential", "CredentialPage")
  @js.native
  open class CredentialPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2Mod.^, CredentialPayload, CredentialResource, CredentialInstance] {
    /**
