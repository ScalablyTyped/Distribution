...
object supportingDocumentTypeMod {
  
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/supportingDocumentType", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/supportingDocumentType", "SupportingDocumentTypeContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/supportingDocumentType", "SupportingDocumentTypeInstance")
  @js.native
  open class SupportingDocumentTypeInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The unique string that identifies the Supporting Document Type resource
      */
    def this(version: typings.twilio.numbersV2Mod.^, payload: SupportingDocumentTypePayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def SupportingDocumentTypeList(version: typings.twilio.numbersV2Mod.^): SupportingDocumentTypeListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("SupportingDocumentTypeList")(version.asInstanceOf[js.Any]).asInstanceOf[SupportingDocumentTypeListInstance]
  
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/supportingDocumentType", "SupportingDocumentTypePage")
  @js.native
