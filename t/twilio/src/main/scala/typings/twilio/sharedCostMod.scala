...
object sharedCostMod {
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/sharedCost", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/sharedCost", "SharedCostInstance")
  @js.native
  open class SharedCostInstance protected () extends SerializableClass {
    /**
  ...
  /**
    ...
    * @param countryCode - The ISO-3166-1 country code of the country.
    */
  inline def SharedCostList(version: typings.twilio.v2010Mod.^, accountSid: String, countryCode: String): SharedCostListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SharedCostList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any], countryCode.asInstanceOf[js.Any])).asInstanceOf[SharedCostListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/sharedCost", "SharedCostPage")
  @js.native
  open class SharedCostPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2010Mod.^, SharedCostPayload, SharedCostResource, SharedCostInstance] {
    /**
    ...
    /**
      ...
      */
    def getInstance(payload: SharedCostPayload): SharedCostInstance = js.native
  ...
  @js.native
  trait SharedCostListInstance extends StObject {
    ...
    def each(opts: SharedCostListInstanceEachOptions): Unit = js.native
    def each(
      opts: SharedCostListInstanceEachOptions,
      callback: js.Function2[
          /* item */ SharedCostInstance, 
          /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit], 
          Unit
    ...
    /**
      ...
      */
    def getPage(): js.Promise[SharedCostPage] = js.native
    def getPage(callback: js.Function2[/* error */ js.Error | Null, /* items */ SharedCostPage, Any]): js.Promise[SharedCostPage] = js.native
    def getPage(targetUrl: String): js.Promise[SharedCostPage] = js.native
    def getPage(
      targetUrl: String,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ SharedCostPage, Any]
    ): js.Promise[SharedCostPage] = js.native
    def getPage(
      targetUrl: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ SharedCostPage, Any]
    ): js.Promise[SharedCostPage] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def list(): js.Promise[js.Array[SharedCostInstance]] = js.native
    def list(callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[SharedCostInstance], Any]): js.Promise[js.Array[SharedCostInstance]] = js.native
    def list(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[SharedCostInstance], Any]
    ): js.Promise[js.Array[SharedCostInstance]] = js.native
    def list(opts: SharedCostListInstanceOptions): js.Promise[js.Array[SharedCostInstance]] = js.native
    def list(
      opts: SharedCostListInstanceOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[SharedCostInstance], Any]
    ): js.Promise[js.Array[SharedCostInstance]] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def page(): js.Promise[SharedCostPage] = js.native
    def page(callback: js.Function2[/* error */ js.Error | Null, /* items */ SharedCostPage, Any]): js.Promise[SharedCostPage] = js.native
    def page(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ SharedCostPage, Any]): js.Promise[SharedCostPage] = js.native
    def page(opts: SharedCostListInstancePageOptions): js.Promise[SharedCostPage] = js.native
    def page(
      opts: SharedCostListInstancePageOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ SharedCostPage, Any]
    ): js.Promise[SharedCostPage] = js.native
  ...
  /**
    ...
    */
  trait SharedCostListInstanceEachOptions extends StObject {
  ...
  object SharedCostListInstanceEachOptions {
    
    inline def apply(): SharedCostListInstanceEachOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SharedCostListInstanceEachOptions]
    }
    
    extension [Self <: SharedCostListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ SharedCostInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit
  ...
  /**
    ...
    * @property voiceEnabled - Whether the phone numbers can receive calls.
    */
  trait SharedCostListInstanceOptions extends StObject {
  ...
  object SharedCostListInstanceOptions {
    
    inline def apply(): SharedCostListInstanceOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SharedCostListInstanceOptions]
    }
    
    extension [Self <: SharedCostListInstanceOptions](x: Self) {
  ...
  /**
    ...
    * @property voiceEnabled - Whether the phone numbers can receive calls.
    */
  trait SharedCostListInstancePageOptions extends StObject {
  ...
  object SharedCostListInstancePageOptions {
    
    inline def apply(): SharedCostListInstancePageOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SharedCostListInstancePageOptions]
    }
    
    extension [Self <: SharedCostListInstancePageOptions](x: Self) {
  ...
  trait SharedCostPayload
    extends StObject
       with SharedCostResource
       with TwilioResponsePayload
  object SharedCostPayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[SharedCostPayload]
    }
  }
  
  trait SharedCostResource extends StObject {
  ...
  object SharedCostResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[SharedCostResource]
    }
    
    extension [Self <: SharedCostResource](x: Self) {
  ...
  trait SharedCostSolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
    
    var countryCode: js.UndefOr[String] = js.undefined
  }
  object SharedCostSolution {
    
    inline def apply(): SharedCostSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SharedCostSolution]
    }
    
    extension [Self <: SharedCostSolution](x: Self) {
