...
object endUserMod {
  ...
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/endUser", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/endUser", "EndUserContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/endUser", "EndUserInstance")
  @js.native
  open class EndUserInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The unique string that identifies the resource
      */
    def this(version: typings.twilio.numbersV2Mod.^, payload: EndUserPayload, sid: String) = this()
    ...
    var `type`: EndUserType = js.native
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def EndUserList(version: typings.twilio.numbersV2Mod.^): EndUserListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("EndUserList")(version.asInstanceOf[js.Any]).asInstanceOf[EndUserListInstance]
  
  @JSImport("twilio/lib/rest/numbers/v2/regulatoryCompliance/endUser", "EndUserPage")
  @js.native
  open class EndUserPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.numbersV2Mod.^, EndUserPayload, EndUserResource, EndUserInstance] {
    /**
  ...
  trait EndUserListInstanceCreateOptions extends StObject {
    ...
    var `type`: EndUserType
  }
  object EndUserListInstanceCreateOptions {
    
    inline def apply(friendlyName: String, `type`: EndUserType): EndUserListInstanceCreateOptions = {
    ...
    extension [Self <: EndUserListInstanceCreateOptions](x: Self) {
      ...
      inline def setType(value: EndUserType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
  ...
  */
  trait EndUserType extends StObject
  object EndUserType {
