...
object v2ServiceChannelInviteMod {
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel/invite", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel/invite", "InviteContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel/invite", "InviteInstance")
  @js.native
  ...
  /**
    ...
    * @param channelSid - The channel_sid
    */
  inline def InviteList(version: typings.twilio.ipMessagingV2Mod.^, serviceSid: String, channelSid: String): InviteListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("InviteList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], channelSid.asInstanceOf[js.Any])).asInstanceOf[InviteListInstance]
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel/invite", "InvitePage")
  @js.native
  open class InvitePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.ipMessagingV2Mod.^, InvitePayload, InviteResource, InviteInstance] {
    /**
