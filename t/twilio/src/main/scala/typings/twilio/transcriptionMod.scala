...
object transcriptionMod {
  
  @JSImport("twilio/lib/rest/api/v2010/account/recording/transcription", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/recording/transcription", "TranscriptionContext")
  @js.native
  open class TranscriptionContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.v2010Mod.^, accountSid: String, recordingSid: String, sid: String) = this()
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/recording/transcription", "TranscriptionInstance")
  @js.native
  ...
  /**
    ...
    * @param recordingSid - The SID that identifies the transcription's recording
    */
  inline def TranscriptionList(version: typings.twilio.v2010Mod.^, accountSid: String, recordingSid: String): TranscriptionListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("TranscriptionList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any], recordingSid.asInstanceOf[js.Any])).asInstanceOf[TranscriptionListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/recording/transcription", "TranscriptionPage")
  @js.native
  ...
  trait TranscriptionSolution extends StObject {
    ...
    var recordingSid: js.UndefOr[String] = js.undefined
  }
  object TranscriptionSolution {
    ...
    extension [Self <: TranscriptionSolution](x: Self) {
      ...
      inline def setRecordingSid(value: String): Self = StObject.set(x, "recordingSid", value.asInstanceOf[js.Any])
      
      inline def setRecordingSidUndefined: Self = StObject.set(x, "recordingSid", js.undefined)
    }
  }
