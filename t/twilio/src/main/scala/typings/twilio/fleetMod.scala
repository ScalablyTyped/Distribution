...
import typings.twilio.certificateMod.CertificateContext
import typings.twilio.certificateMod.CertificateListInstance
import typings.twilio.deploymentMod.DeploymentContext
import typings.twilio.deploymentMod.DeploymentListInstance
import typings.twilio.fleetDeviceMod.DeviceContext
import typings.twilio.fleetDeviceMod.DeviceListInstance
import typings.twilio.fleetKeyMod.KeyContext
import typings.twilio.fleetKeyMod.KeyListInstance
...
object fleetMod {
  ...
  open class FleetContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.deployedDevicesMod.^, sid: String) = this()
  ...
  open class FleetInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - A string that uniquely identifies the Fleet.
      */
    def this(version: typings.twilio.deployedDevicesMod.^, payload: FleetPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def FleetList(version: typings.twilio.deployedDevicesMod.^): FleetListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("FleetList")(version.asInstanceOf[js.Any]).asInstanceOf[FleetListInstance]
  
  @JSImport("twilio/lib/rest/preview/deployed_devices/fleet", "FleetPage")
  @js.native
  open class FleetPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.deployedDevicesMod.^, FleetPayload, FleetResource, FleetInstance] {
    /**
