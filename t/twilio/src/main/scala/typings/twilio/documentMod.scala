...
import typings.twilio.documentPermissionMod.DocumentPermissionContext
import typings.twilio.documentPermissionMod.DocumentPermissionListInstance
...
object documentMod {
  ...
  open class DocumentContext protected () extends StObject {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.syncMod.^, serviceSid: String, sid: String) = this()
  ...
  open class DocumentInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.syncMod.^, payload: DocumentPayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The service_sid
    */
  inline def DocumentList(version: typings.twilio.syncMod.^, serviceSid: String): DocumentListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DocumentList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[DocumentListInstance]
  
  @JSImport("twilio/lib/rest/preview/sync/service/document", "DocumentPage")
  @js.native
  open class DocumentPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.syncMod.^, DocumentPayload, DocumentResource, DocumentInstance] {
    /**
