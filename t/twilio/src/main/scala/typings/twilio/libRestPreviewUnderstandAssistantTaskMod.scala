...
object libRestPreviewUnderstandAssistantTaskMod {
  ...
  /**
    ...
    * @param assistantSid - The unique ID of the Assistant.
    */
  inline def TaskList(version: typings.twilio.libRestPreviewUnderstandMod.^, assistantSid: String): TaskListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("TaskList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[TaskListInstance]
  
  @JSImport("twilio/lib/rest/preview/understand/assistant/task", "TaskPage")
  @js.native
  open class TaskPage protected ()
    extends typings.twilio.libBasePageMod.^[typings.twilio.libRestPreviewUnderstandMod.^, TaskPayload, TaskResource, TaskInstance] {
    /**
