...
object simUsageRecordMod {
  
  @JSImport("twilio/lib/rest/wireless/v1/sim/usageRecord", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/wireless/v1/sim/usageRecord", "UsageRecordInstance")
  @js.native
  open class UsageRecordInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.wirelessV1Mod.^, payload: UsageRecordPayload, simSid: String) = this()
  ...
  /**
    ...
    * @param simSid - The SID of the Sim resource that this Usage Record is for
    */
  inline def UsageRecordList(version: typings.twilio.wirelessV1Mod.^, simSid: String): UsageRecordListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UsageRecordList")(version.asInstanceOf[js.Any], simSid.asInstanceOf[js.Any])).asInstanceOf[UsageRecordListInstance]
  
  @JSImport("twilio/lib/rest/wireless/v1/sim/usageRecord", "UsageRecordPage")
  @js.native
  ...
  */
  ...
  object UsageRecordResource {
    ...
    inline def apply(account_sid: String, commands: js.Object, data: js.Object, period: js.Object, sim_sid: String): UsageRecordResource = {
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], commands = commands.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], period = period.asInstanceOf[js.Any], sim_sid = sim_sid.asInstanceOf[js.Any])
  ...
  object UsageRecordSolution {
    
    inline def apply(): UsageRecordSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[UsageRecordSolution]
    }
    
    extension [Self <: UsageRecordSolution](x: Self) {
