...
import typings.twilio.v2VoiceCountryMod.CountryListInstance
import typings.twilio.voiceNumberMod.NumberListInstance
...
object v2VoiceMod {
  ...
  @JSImport("twilio/lib/rest/pricing/v2/voice", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/pricing/v2/voice", "VoiceInstance")
  @js.native
  open class VoiceInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.pricingV2Mod.^, payload: VoicePayload) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def VoiceList(version: typings.twilio.pricingV2Mod.^): VoiceListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("VoiceList")(version.asInstanceOf[js.Any]).asInstanceOf[VoiceListInstance]
  
  @JSImport("twilio/lib/rest/pricing/v2/voice", "VoicePage")
  @js.native
  open class VoicePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.pricingV2Mod.^, VoicePayload, VoiceResource, VoiceInstance] {
    /**
