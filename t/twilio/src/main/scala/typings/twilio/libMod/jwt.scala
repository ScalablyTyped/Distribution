...
import typings.twilio.libJwtClientCapabilityMod.default
...
object jwt {
  ...
  @JSImport("twilio/lib", "jwt.AccessToken")
  @js.native
  ...
  object AccessToken {
    ...
    /* static member */
    @JSImport("twilio/lib", "jwt.AccessToken.ALGORITHMS")
    @js.native
    ...
    open class ChatGrant ()
      extends typings.twilio.libJwtAccessTokenMod.ChatGrant {
      def this(options: ChatGrantOptions) = this()
    }
    
    /* static member */
    @JSImport("twilio/lib", "jwt.AccessToken.DEFAULT_ALGORITHM")
    @js.native
    ...
    open class Grant[TOptions, TPayload, TKey] protected ()
      extends typings.twilio.libJwtAccessTokenMod.Grant[TOptions, TPayload, TKey] {
    ...
    open class PlaybackGrant ()
      extends typings.twilio.libJwtAccessTokenMod.PlaybackGrant {
    ...
    open class SyncGrant ()
      extends typings.twilio.libJwtAccessTokenMod.SyncGrant {
    ...
    open class TaskRouterGrant ()
      extends typings.twilio.libJwtAccessTokenMod.TaskRouterGrant {
    ...
    open class VideoGrant ()
      extends typings.twilio.libJwtAccessTokenMod.VideoGrant {
    ...
    open class VoiceGrant ()
      extends typings.twilio.libJwtAccessTokenMod.VoiceGrant {
      def this(options: VoiceGrantOptions) = this()
    }
  }
  
  /* was `typeof IClientCapability` */
  @JSImport("twilio/lib", "jwt.ClientCapability")
  @js.native
  open class ClientCapability protected () extends default {
  ...
  object taskrouter {
    ...
    @JSImport("twilio/lib", "jwt.taskrouter.TaskRouterCapability")
    @js.native
    open class TaskRouterCapability protected ()
      extends typings.twilio.libJwtTaskrouterTaskRouterCapabilityMod.default {
      /**
        * @param options - ...
    ...
    object util {
      ...
      @JSImport("twilio/lib", "jwt.taskrouter.util")
      @js.native
      val ^ : js.Any = js.native
