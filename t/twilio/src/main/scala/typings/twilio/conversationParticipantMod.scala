...
object conversationParticipantMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/participant", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/participant", "ParticipantContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/conversations/v1/conversation/participant", "ParticipantInstance")
  @js.native
  ...
  /**
    ...
    * @param conversationSid - The unique ID of the Conversation for this participant.
    */
  inline def ParticipantList(version: typings.twilio.conversationsV1Mod.^, conversationSid: String): ParticipantListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ParticipantList")(version.asInstanceOf[js.Any], conversationSid.asInstanceOf[js.Any])).asInstanceOf[ParticipantListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/participant", "ParticipantPage")
  @js.native
