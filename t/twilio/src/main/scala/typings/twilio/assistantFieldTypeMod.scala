...
import typings.twilio.fieldTypeFieldValueMod.FieldValueContext
import typings.twilio.fieldTypeFieldValueMod.FieldValueListInstance
...
object assistantFieldTypeMod {
  ...
  /**
    ...
    * @param assistantSid - The unique ID of the Assistant.
    */
  inline def FieldTypeList(version: typings.twilio.understandMod.^, assistantSid: String): FieldTypeListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("FieldTypeList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[FieldTypeListInstance]
  
  @JSImport("twilio/lib/rest/preview/understand/assistant/fieldType", "FieldTypePage")
  @js.native
  open class FieldTypePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.understandMod.^, FieldTypePayload, FieldTypeResource, FieldTypeInstance] {
    /**
