...
object styleSheetMod {
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/styleSheet", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/styleSheet", "StyleSheetContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/styleSheet", "StyleSheetInstance")
  @js.native
  open class StyleSheetInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.autopilotV1Mod.^, payload: StyleSheetPayload, assistantSid: String) = this()
  ...
  /**
    ...
    * @param assistantSid - The SID of the Assistant that is the parent of the resource
    */
  inline def StyleSheetList(version: typings.twilio.autopilotV1Mod.^, assistantSid: String): StyleSheetListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("StyleSheetList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[StyleSheetListInstance]
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/styleSheet", "StyleSheetPage")
  @js.native
