...
import typings.twilio.deliveryReceiptMod.DeliveryReceiptContext
import typings.twilio.deliveryReceiptMod.DeliveryReceiptListInstance
...
object conversationMessageMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/message", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/message", "MessageContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/conversations/v1/conversation/message", "MessageInstance")
  @js.native
  ...
  /**
    ...
    * @param conversationSid - The unique ID of the Conversation for this message.
    */
  inline def MessageList(version: typings.twilio.conversationsV1Mod.^, conversationSid: String): MessageListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("MessageList")(version.asInstanceOf[js.Any], conversationSid.asInstanceOf[js.Any])).asInstanceOf[MessageListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/message", "MessagePage")
  @js.native
