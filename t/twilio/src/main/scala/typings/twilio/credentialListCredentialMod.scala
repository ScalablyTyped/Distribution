...
object credentialListCredentialMod {
  
  @JSImport("twilio/lib/rest/api/v2010/account/sip/credentialList/credential", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/sip/credentialList/credential", "CredentialContext")
  @js.native
  open class CredentialContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.v2010Mod.^, accountSid: String, credentialListSid: String, sid: String) = this()
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/sip/credentialList/credential", "CredentialInstance")
  @js.native
  open class CredentialInstance protected () extends SerializableClass {
    ...
    var credentialListSid: String = js.native
  ...
  /**
    ...
    * @param credentialListSid - The unique id that identifies the credential list that includes this credential
    */
  inline def CredentialList(version: typings.twilio.v2010Mod.^, accountSid: String, credentialListSid: String): CredentialListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("CredentialList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any], credentialListSid.asInstanceOf[js.Any])).asInstanceOf[CredentialListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/sip/credentialList/credential", "CredentialPage")
  @js.native
  open class CredentialPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2010Mod.^, CredentialPayload, CredentialResource, CredentialInstance] {
    /**
  ...
  object CredentialListInstanceCreateOptions {
    ...
    inline def apply(password: String, username: String): CredentialListInstanceCreateOptions = {
  ...
  - typings.twilio.pageMod.TwilioResponsePayload because var conflicts: uri. Inlined first_page_uri, next_page_uri, page, page_size, previous_page_uri, meta */ trait CredentialPayload
    extends StObject
  ...
  object CredentialPayload {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], credential_list_sid = credential_list_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], first_page_uri = first_page_uri.asInstanceOf[js.Any], next_page_uri = next_page_uri.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], page_size = page_size.asInstanceOf[js.Any], previous_page_uri = previous_page_uri.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any], username = username.asInstanceOf[js.Any])
      __obj.asInstanceOf[CredentialPayload]
    }
    
    extension [Self <: CredentialPayload](x: Self) {
  ...
  object CredentialResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], credential_list_sid = credential_list_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any], username = username.asInstanceOf[js.Any])
    ...
    extension [Self <: CredentialResource](x: Self) {
      ...
      inline def setCredential_list_sid(value: String): Self = StObject.set(x, "credential_list_sid", value.asInstanceOf[js.Any])
  ...
  trait CredentialSolution extends StObject {
    ...
    var credentialListSid: js.UndefOr[String] = js.undefined
  }
  object CredentialSolution {
    
    inline def apply(): CredentialSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CredentialSolution]
    }
    
    extension [Self <: CredentialSolution](x: Self) {
      ...
      inline def setCredentialListSidUndefined: Self = StObject.set(x, "credentialListSid", js.undefined)
    }
  }
}
