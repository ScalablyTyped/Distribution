...
object taskStatisticsMod {
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task/taskStatistics", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task/taskStatistics", "TaskStatisticsContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task/taskStatistics", "TaskStatisticsInstance")
  @js.native
  ...
  /**
    ...
    * @param taskSid - The SID of the Task for which the statistics were collected
    */
  inline def TaskStatisticsList(version: typings.twilio.autopilotV1Mod.^, assistantSid: String, taskSid: String): TaskStatisticsListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("TaskStatisticsList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any], taskSid.asInstanceOf[js.Any])).asInstanceOf[TaskStatisticsListInstance]
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/task/taskStatistics", "TaskStatisticsPage")
  @js.native
