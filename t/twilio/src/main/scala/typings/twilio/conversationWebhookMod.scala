...
import typings.twilio.anon.FlowSid
import typings.twilio.anon.ReplayAfter
...
object conversationWebhookMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/webhook", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/webhook", "WebhookContext")
  @js.native
  open class WebhookContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.conversationsV1Mod.^, conversationSid: String, sid: String) = this()
  ...
  @JSImport("twilio/lib/rest/conversations/v1/conversation/webhook", "WebhookInstance")
  @js.native
  ...
  /**
    ...
    * @param conversationSid - The unique ID of the Conversation for this webhook.
    */
  inline def WebhookList(version: typings.twilio.conversationsV1Mod.^, conversationSid: String): WebhookListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("WebhookList")(version.asInstanceOf[js.Any], conversationSid.asInstanceOf[js.Any])).asInstanceOf[WebhookListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/conversation/webhook", "WebhookPage")
  @js.native
  ...
  trait WebhookInstanceUpdateOptions extends StObject {
    ...
    var configuration: js.UndefOr[FlowSid] = js.undefined
  }
  object WebhookInstanceUpdateOptions {
    ...
    extension [Self <: WebhookInstanceUpdateOptions](x: Self) {
      ...
      inline def setConfiguration(value: FlowSid): Self = StObject.set(x, "configuration", value.asInstanceOf[js.Any])
  ...
  trait WebhookListInstanceCreateOptions extends StObject {
    ...
    var configuration: js.UndefOr[ReplayAfter] = js.undefined
  ...
  object WebhookListInstanceCreateOptions {
    ...
    extension [Self <: WebhookListInstanceCreateOptions](x: Self) {
      ...
      inline def setConfiguration(value: ReplayAfter): Self = StObject.set(x, "configuration", value.asInstanceOf[js.Any])
