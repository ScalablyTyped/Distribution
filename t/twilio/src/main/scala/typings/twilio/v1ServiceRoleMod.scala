...
object v1ServiceRoleMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/service/role", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/service/role", "RoleContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/conversations/v1/service/role", "RoleInstance")
  @js.native
  ...
  /**
    ...
    * @param chatServiceSid - The SID of the Conversation Service that the resource is associated with
    */
  inline def RoleList(version: typings.twilio.conversationsV1Mod.^, chatServiceSid: String): RoleListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("RoleList")(version.asInstanceOf[js.Any], chatServiceSid.asInstanceOf[js.Any])).asInstanceOf[RoleListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/service/role", "RolePage")
  @js.native
