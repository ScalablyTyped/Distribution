...
import typings.twilio.dependentHostedNumberOrderMod.DependentHostedNumberOrderListInstance
...
object authorizationDocumentMod {
  ...
  open class AuthorizationDocumentInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - AuthorizationDocument sid.
      */
    def this(version: typings.twilio.hostedNumbersMod.^, payload: AuthorizationDocumentPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def AuthorizationDocumentList(version: typings.twilio.hostedNumbersMod.^): AuthorizationDocumentListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("AuthorizationDocumentList")(version.asInstanceOf[js.Any]).asInstanceOf[AuthorizationDocumentListInstance]
