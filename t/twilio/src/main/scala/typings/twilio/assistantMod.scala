...
import typings.twilio.defaultsMod.DefaultsContext
import typings.twilio.defaultsMod.DefaultsListInstance
import typings.twilio.dialogueMod.DialogueContext
import typings.twilio.dialogueMod.DialogueListInstance
import typings.twilio.fieldTypeMod.FieldTypeContext
import typings.twilio.fieldTypeMod.FieldTypeListInstance
import typings.twilio.interfacesMod.SerializableClass
import typings.twilio.modelBuildMod.ModelBuildContext
import typings.twilio.modelBuildMod.ModelBuildListInstance
import typings.twilio.pageMod.TwilioResponsePayload
import typings.twilio.queryMod.QueryContext
import typings.twilio.queryMod.QueryListInstance
import typings.twilio.styleSheetMod.StyleSheetContext
import typings.twilio.styleSheetMod.StyleSheetListInstance
import typings.twilio.taskMod.TaskContext
import typings.twilio.taskMod.TaskListInstance
import typings.twilio.webhookMod.WebhookContext
import typings.twilio.webhookMod.WebhookListInstance
...
object assistantMod {
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant", "AssistantContext")
  @js.native
  open class AssistantContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.autopilotV1Mod.^, sid: String) = this()
    
    /**
      * @param sid - sid of instance
      */
    def defaults(sid: String): DefaultsContext = js.native
    @JSName("defaults")
    var defaults_Original: DefaultsListInstance = js.native
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant", "AssistantInstance")
  @js.native
  open class AssistantInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The unique string that identifies the resource
      */
    def this(version: typings.twilio.autopilotV1Mod.^, payload: AssistantPayload, sid: String) = this()
    ...
    /**
      * Access the defaults
      */
    def defaults(): DefaultsListInstance = js.native
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def AssistantList(version: typings.twilio.autopilotV1Mod.^): AssistantListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("AssistantList")(version.asInstanceOf[js.Any]).asInstanceOf[AssistantListInstance]
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant", "AssistantPage")
  @js.native
  ...
  trait AssistantInstanceUpdateOptions extends StObject {
    ...
    var developmentStage: js.UndefOr[String] = js.undefined
  ...
  object AssistantInstanceUpdateOptions {
    ...
    extension [Self <: AssistantInstanceUpdateOptions](x: Self) {
      ...
      inline def setDevelopmentStage(value: String): Self = StObject.set(x, "developmentStage", value.asInstanceOf[js.Any])
  ...
  object AssistantResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], callback_events = callback_events.asInstanceOf[js.Any], callback_url = callback_url.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], development_stage = development_stage.asInstanceOf[js.Any], friendly_name = friendly_name.asInstanceOf[js.Any], latest_model_build_sid = latest_model_build_sid.asInstanceOf[js.Any], links = links.asInstanceOf[js.Any], log_queries = log_queries.asInstanceOf[js.Any], needs_model_build = needs_model_build.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], unique_name = unique_name.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
