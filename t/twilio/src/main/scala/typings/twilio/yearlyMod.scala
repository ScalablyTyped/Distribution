...
object yearlyMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/yearly", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/yearly", "YearlyInstance")
  @js.native
  open class YearlyInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typings.twilio.v2010Mod.^, payload: YearlyPayload, accountSid: String) = this()
    ...
    var category: YearlyCategory = js.native
  ...
  /**
    ...
    * @param accountSid - A 34 character string that uniquely identifies this resource.
    */
  inline def YearlyList(version: typings.twilio.v2010Mod.^, accountSid: String): YearlyListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("YearlyList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any])).asInstanceOf[YearlyListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/usage/record/yearly", "YearlyPage")
  @js.native
  open class YearlyPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2010Mod.^, YearlyPayload, YearlyResource, YearlyInstance] {
    /**
    ...
    /**
      ...
      */
    def getInstance(payload: YearlyPayload): YearlyInstance = js.native
  ...
  */
  trait YearlyCategory extends StObject
  object YearlyCategory {
  ...
  @js.native
  trait YearlyListInstance extends StObject {
    ...
    def each(opts: YearlyListInstanceEachOptions): Unit = js.native
    def each(
      opts: YearlyListInstanceEachOptions,
      callback: js.Function2[
          /* item */ YearlyInstance, 
          /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit], 
          Unit
    ...
    /**
      ...
      */
    def getPage(): js.Promise[YearlyPage] = js.native
    def getPage(callback: js.Function2[/* error */ js.Error | Null, /* items */ YearlyPage, Any]): js.Promise[YearlyPage] = js.native
    def getPage(targetUrl: String): js.Promise[YearlyPage] = js.native
    def getPage(
      targetUrl: String,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ YearlyPage, Any]
    ): js.Promise[YearlyPage] = js.native
    def getPage(targetUrl: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ YearlyPage, Any]): js.Promise[YearlyPage] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def list(): js.Promise[js.Array[YearlyInstance]] = js.native
    def list(callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[YearlyInstance], Any]): js.Promise[js.Array[YearlyInstance]] = js.native
    def list(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[YearlyInstance], Any]
    ): js.Promise[js.Array[YearlyInstance]] = js.native
    def list(opts: YearlyListInstanceOptions): js.Promise[js.Array[YearlyInstance]] = js.native
    def list(
      opts: YearlyListInstanceOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[YearlyInstance], Any]
    ): js.Promise[js.Array[YearlyInstance]] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def page(): js.Promise[YearlyPage] = js.native
    def page(callback: js.Function2[/* error */ js.Error | Null, /* items */ YearlyPage, Any]): js.Promise[YearlyPage] = js.native
    def page(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ YearlyPage, Any]): js.Promise[YearlyPage] = js.native
    def page(opts: YearlyListInstancePageOptions): js.Promise[YearlyPage] = js.native
    def page(
      opts: YearlyListInstancePageOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ YearlyPage, Any]
    ): js.Promise[YearlyPage] = js.native
  ...
  /**
    ...
    */
  trait YearlyListInstanceEachOptions extends StObject {
    ...
    var category: js.UndefOr[YearlyCategory] = js.undefined
  ...
  object YearlyListInstanceEachOptions {
    
    inline def apply(): YearlyListInstanceEachOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[YearlyListInstanceEachOptions]
    }
    
    extension [Self <: YearlyListInstanceEachOptions](x: Self) {
      
      inline def setCallback(
        value: (/* item */ YearlyInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2(value))
      
      inline def setCallbackUndefined: Self = StObject.set(x, "callback", js.undefined)
      
      inline def setCategory(value: YearlyCategory): Self = StObject.set(x, "category", value.asInstanceOf[js.Any])
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait YearlyListInstanceOptions extends StObject {
  ...
  object YearlyListInstanceOptions {
    
    inline def apply(): YearlyListInstanceOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[YearlyListInstanceOptions]
    }
    
    extension [Self <: YearlyListInstanceOptions](x: Self) {
  ...
  /**
    ...
    * @property startDate - Only include usage that has occurred on or after this date
    */
  trait YearlyListInstancePageOptions extends StObject {
  ...
  object YearlyListInstancePageOptions {
    
    inline def apply(): YearlyListInstancePageOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[YearlyListInstancePageOptions]
    }
    
    extension [Self <: YearlyListInstancePageOptions](x: Self) {
  ...
  - typings.twilio.pageMod.TwilioResponsePayload because var conflicts: uri. Inlined first_page_uri, next_page_uri, page, page_size, previous_page_uri, meta */ trait YearlyPayload
    extends StObject
       with YearlyResource {
  ...
  object YearlyPayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[YearlyPayload]
    }
    
    extension [Self <: YearlyPayload](x: Self) {
  ...
  trait YearlyResource extends StObject {
  ...
  object YearlyResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[YearlyResource]
    }
    
    extension [Self <: YearlyResource](x: Self) {
  ...
  trait YearlySolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
  }
  object YearlySolution {
    
    inline def apply(): YearlySolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[YearlySolution]
    }
    
    extension [Self <: YearlySolution](x: Self) {
