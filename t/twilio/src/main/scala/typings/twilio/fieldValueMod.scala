...
object fieldValueMod {
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/fieldType/fieldValue", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/fieldType/fieldValue", "FieldValueContext")
  @js.native
  open class FieldValueContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.autopilotV1Mod.^, assistantSid: String, fieldTypeSid: String, sid: String) = this()
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/fieldType/fieldValue", "FieldValueInstance")
  @js.native
  ...
  /**
    ...
    * @param fieldTypeSid - The SID of the Field Type associated with the Field Value
    */
  inline def FieldValueList(version: typings.twilio.autopilotV1Mod.^, assistantSid: String, fieldTypeSid: String): FieldValueListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("FieldValueList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any], fieldTypeSid.asInstanceOf[js.Any])).asInstanceOf[FieldValueListInstance]
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/fieldType/fieldValue", "FieldValuePage")
  @js.native
