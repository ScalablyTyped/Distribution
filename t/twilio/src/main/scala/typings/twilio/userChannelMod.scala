...
object userChannelMod {
  
  @JSImport("twilio/lib/rest/chat/v1/service/user/userChannel", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v1/service/user/userChannel", "UserChannelInstance")
  @js.native
  ...
  /**
    ...
    * @param userSid - The unique string that identifies the resource
    */
  inline def UserChannelList(version: typings.twilio.chatV1Mod.^, serviceSid: String, userSid: String): UserChannelListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UserChannelList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], userSid.asInstanceOf[js.Any])).asInstanceOf[UserChannelListInstance]
  
  @JSImport("twilio/lib/rest/chat/v1/service/user/userChannel", "UserChannelPage")
  @js.native
  open class UserChannelPage protected ()
    extends typings.twilio.pageMod.^[
          typings.twilio.chatV1Mod.^, 
          UserChannelPayload, 
          UserChannelResource, 
          UserChannelInstance
        ] {
