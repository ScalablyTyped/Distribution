...
object PromptFor {
  ...
  inline def `payment-processing`: typings.twilio.twilioStrings.`payment-processing` = "payment-processing".asInstanceOf[typings.twilio.twilioStrings.`payment-processing`]
