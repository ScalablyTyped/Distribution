...
object syncMapSyncMapPermissionMod {
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap/syncMapPermission", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap/syncMapPermission", "SyncMapPermissionContext")
  @js.native
  open class SyncMapPermissionContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.syncV1Mod.^, serviceSid: String, mapSid: String, identity: String) = this()
  ...
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap/syncMapPermission", "SyncMapPermissionInstance")
  @js.native
  ...
  /**
    ...
    * @param mapSid - Sync Map SID
    */
  inline def SyncMapPermissionList(version: typings.twilio.syncV1Mod.^, serviceSid: String, mapSid: String): SyncMapPermissionListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SyncMapPermissionList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], mapSid.asInstanceOf[js.Any])).asInstanceOf[SyncMapPermissionListInstance]
  
  @JSImport("twilio/lib/rest/sync/v1/service/syncMap/syncMapPermission", "SyncMapPermissionPage")
  @js.native
