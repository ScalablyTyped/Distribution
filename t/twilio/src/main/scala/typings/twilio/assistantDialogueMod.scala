...
object assistantDialogueMod {
  ...
  /**
    ...
    * @param assistantSid - The unique ID of the parent Assistant.
    */
  inline def DialogueList(version: typings.twilio.understandMod.^, assistantSid: String): DialogueListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DialogueList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[DialogueListInstance]
  
  @JSImport("twilio/lib/rest/preview/understand/assistant/dialogue", "DialoguePage")
  @js.native
  open class DialoguePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.understandMod.^, DialoguePayload, DialogueResource, DialogueInstance] {
    /**
