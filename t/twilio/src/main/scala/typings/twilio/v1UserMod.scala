...
import typings.twilio.userUserConversationMod.UserConversationContext
import typings.twilio.userUserConversationMod.UserConversationListInstance
...
object v1UserMod {
  ...
  @JSImport("twilio/lib/rest/conversations/v1/user", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/user", "UserContext")
  @js.native
  open class UserContext protected () extends StObject {
    ...
    def remove(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ UserInstance, Any]): js.Promise[Boolean] = js.native
    def remove(opts: UserInstanceRemoveOptions): js.Promise[Boolean] = js.native
    def remove(
      opts: UserInstanceRemoveOptions,
    ...
    /**
      ...
      */
    def userConversations(sid: String): UserConversationContext = js.native
    @JSName("userConversations")
    var userConversations_Original: UserConversationListInstance = js.native
  }
  
  @JSImport("twilio/lib/rest/conversations/v1/user", "UserInstance")
  @js.native
  open class UserInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the User resource to fetch
      */
    def this(version: typings.twilio.conversationsV1Mod.^, payload: UserPayload, sid: String) = this()
    ...
    /**
      ...
      */
    def userConversations(): UserConversationListInstance = js.native
  }
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def UserList(version: typings.twilio.conversationsV1Mod.^): UserListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("UserList")(version.asInstanceOf[js.Any]).asInstanceOf[UserListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/user", "UserPage")
  @js.native
  open class UserPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.conversationsV1Mod.^, UserPayload, UserResource, UserInstance] {
    /**
  ...
  /**
    ...
    */
  trait UserInstanceRemoveOptions extends StObject {
    
    var xTwilioWebhookEnabled: js.UndefOr[UserWebhookEnabledType] = js.undefined
  }
  object UserInstanceRemoveOptions {
    
    inline def apply(): UserInstanceRemoveOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[UserInstanceRemoveOptions]
    }
    
    extension [Self <: UserInstanceRemoveOptions](x: Self) {
  ...
  object UserPayload {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], attributes = attributes.asInstanceOf[js.Any], chat_service_sid = chat_service_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], first_page_uri = first_page_uri.asInstanceOf[js.Any], friendly_name = friendly_name.asInstanceOf[js.Any], identity = identity.asInstanceOf[js.Any], is_notifiable = is_notifiable.asInstanceOf[js.Any], is_online = is_online.asInstanceOf[js.Any], links = links.asInstanceOf[js.Any], next_page_uri = next_page_uri.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], page_size = page_size.asInstanceOf[js.Any], previous_page_uri = previous_page_uri.asInstanceOf[js.Any], role_sid = role_sid.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], uri = uri.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
  ...
  object UserResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], attributes = attributes.asInstanceOf[js.Any], chat_service_sid = chat_service_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], friendly_name = friendly_name.asInstanceOf[js.Any], identity = identity.asInstanceOf[js.Any], is_notifiable = is_notifiable.asInstanceOf[js.Any], is_online = is_online.asInstanceOf[js.Any], links = links.asInstanceOf[js.Any], role_sid = role_sid.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
