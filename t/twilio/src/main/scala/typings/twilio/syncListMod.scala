...
import typings.twilio.syncListItemMod.SyncListItemContext
import typings.twilio.syncListItemMod.SyncListItemListInstance
import typings.twilio.syncListPermissionMod.SyncListPermissionContext
import typings.twilio.syncListPermissionMod.SyncListPermissionListInstance
...
object syncListMod {
  ...
  open class SyncListInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typings.twilio.syncMod.^, payload: SyncListPayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The service_sid
    */
  inline def SyncListList(version: typings.twilio.syncMod.^, serviceSid: String): SyncListListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SyncListList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[SyncListListInstance]
  
  @JSImport("twilio/lib/rest/preview/sync/service/syncList", "SyncListPage")
  @js.native
  open class SyncListPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.syncMod.^, SyncListPayload, SyncListResource, SyncListInstance] {
    /**
