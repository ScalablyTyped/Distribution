...
object v1ServiceChannelMessageMod {
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/channel/message", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/channel/message", "MessageContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/channel/message", "MessageInstance")
  @js.native
  ...
  /**
    ...
    * @param channelSid - The channel_sid
    */
  inline def MessageList(version: typings.twilio.ipMessagingV1Mod.^, serviceSid: String, channelSid: String): MessageListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("MessageList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], channelSid.asInstanceOf[js.Any])).asInstanceOf[MessageListInstance]
  
  @JSImport("twilio/lib/rest/ipMessaging/v1/service/channel/message", "MessagePage")
  @js.native
  open class MessagePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.ipMessagingV1Mod.^, MessagePayload, MessageResource, MessageInstance] {
    /**
