...
object v2CountryMod {
  ...
  @JSImport("twilio/lib/rest/pricing/v2/country", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/pricing/v2/country", "CountryContext")
  @js.native
  open class CountryContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.pricingV2Mod.^, isoCountry: String) = this()
  ...
  @JSImport("twilio/lib/rest/pricing/v2/country", "CountryInstance")
  @js.native
  open class CountryInstance protected () extends SerializableClass {
    /**
      ...
      * @param isoCountry - The ISO country code of the pricing information to fetch
      */
    def this(version: typings.twilio.pricingV2Mod.^, payload: CountryPayload, isoCountry: String) = this()
    ...
    var originatingCallPrices: js.Array[String] = js.native
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def CountryList(version: typings.twilio.pricingV2Mod.^): CountryListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("CountryList")(version.asInstanceOf[js.Any]).asInstanceOf[CountryListInstance]
  
  @JSImport("twilio/lib/rest/pricing/v2/country", "CountryPage")
  @js.native
  open class CountryPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.pricingV2Mod.^, CountryPayload, CountryResource, CountryInstance] {
    /**
  ...
  trait CountryResource extends StObject {
    ...
    var originating_call_prices: js.UndefOr[js.Array[String]] = js.undefined
    
    var price_unit: js.UndefOr[String] = js.undefined
    
    var terminating_prefix_prices: js.UndefOr[js.Array[String]] = js.undefined
  ...
  object CountryResource {
    ...
    extension [Self <: CountryResource](x: Self) {
      ...
      inline def setOriginating_call_prices(value: js.Array[String]): Self = StObject.set(x, "originating_call_prices", value.asInstanceOf[js.Any])
      
      inline def setOriginating_call_pricesUndefined: Self = StObject.set(x, "originating_call_prices", js.undefined)
      
      inline def setOriginating_call_pricesVarargs(value: String*): Self = StObject.set(x, "originating_call_prices", js.Array(value*))
      ...
      inline def setTerminating_prefix_pricesUndefined: Self = StObject.set(x, "terminating_prefix_prices", js.undefined)
