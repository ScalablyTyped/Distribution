...
object requestClientMod {
  ...
  open class ^ ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def request[TData](opts: RequestOptions[TData, js.Object]): js.Promise[typings.twilio.responseMod.^[TData]] = js.native
  }
  ...
  trait RequestClient extends StObject {
    ...
    /**
      ...
      * @param opts The options https.Agent takes in
      */
    def request[TData](opts: RequestOptions[TData, js.Object]): js.Promise[typings.twilio.responseMod.^[TData]]
  }
  object RequestClient {
    
    inline def apply(request: RequestOptions[Any, js.Object] => js.Promise[typings.twilio.responseMod.^[Any]]): RequestClient = {
    ...
    extension [Self <: RequestClient](x: Self) {
      ...
      inline def setRequest(value: RequestOptions[Any, js.Object] => js.Promise[typings.twilio.responseMod.^[Any]]): Self = StObject.set(x, "request", js.Any.fromFunction1(value))
    }
  }
