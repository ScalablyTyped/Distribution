...
object libRestPreviewUnderstandAssistantStyleSheetMod {
  ...
  /**
    ...
    * @param assistantSid - The unique ID of the Assistant
    */
  inline def StyleSheetList(version: typings.twilio.libRestPreviewUnderstandMod.^, assistantSid: String): StyleSheetListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("StyleSheetList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[StyleSheetListInstance]
