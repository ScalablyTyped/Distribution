...
import typings.twilio.fieldValueMod.FieldValueContext
import typings.twilio.fieldValueMod.FieldValueListInstance
...
object fieldTypeMod {
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/fieldType", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/fieldType", "FieldTypeContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/fieldType", "FieldTypeInstance")
  @js.native
  ...
  /**
    ...
    * @param assistantSid - The SID of the Assistant that is the parent of the resource
    */
  inline def FieldTypeList(version: typings.twilio.autopilotV1Mod.^, assistantSid: String): FieldTypeListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("FieldTypeList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[FieldTypeListInstance]
  
  @JSImport("twilio/lib/rest/autopilot/v1/assistant/fieldType", "FieldTypePage")
  @js.native
