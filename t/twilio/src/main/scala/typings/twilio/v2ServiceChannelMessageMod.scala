...
object v2ServiceChannelMessageMod {
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel/message", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel/message", "MessageContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel/message", "MessageInstance")
  @js.native
  open class MessageInstance protected () extends SerializableClass {
    ...
    var lastUpdatedBy: String = js.native
  ...
  /**
    ...
    * @param channelSid - The channel_sid
    */
  inline def MessageList(version: typings.twilio.ipMessagingV2Mod.^, serviceSid: String, channelSid: String): MessageListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("MessageList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], channelSid.asInstanceOf[js.Any])).asInstanceOf[MessageListInstance]
  
  @JSImport("twilio/lib/rest/ipMessaging/v2/service/channel/message", "MessagePage")
  @js.native
  open class MessagePage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.ipMessagingV2Mod.^, MessagePayload, MessageResource, MessageInstance] {
    /**
  ...
  */
  ...
  object MessageResource {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(account_sid = account_sid.asInstanceOf[js.Any], attributes = attributes.asInstanceOf[js.Any], body = body.asInstanceOf[js.Any], channel_sid = channel_sid.asInstanceOf[js.Any], date_created = date_created.asInstanceOf[js.Any], date_updated = date_updated.asInstanceOf[js.Any], from = from.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any], last_updated_by = last_updated_by.asInstanceOf[js.Any], media = media.asInstanceOf[js.Any], service_sid = service_sid.asInstanceOf[js.Any], sid = sid.asInstanceOf[js.Any], to = to.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], was_edited = was_edited.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
