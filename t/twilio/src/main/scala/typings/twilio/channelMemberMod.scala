...
object channelMemberMod {
  
  @JSImport("twilio/lib/rest/chat/v1/service/channel/member", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v1/service/channel/member", "MemberContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/chat/v1/service/channel/member", "MemberInstance")
  @js.native
  ...
  /**
    ...
    * @param channelSid - The unique ID of the Channel for the member
    */
  inline def MemberList(version: typings.twilio.chatV1Mod.^, serviceSid: String, channelSid: String): MemberListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("MemberList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any], channelSid.asInstanceOf[js.Any])).asInstanceOf[MemberListInstance]
  
  @JSImport("twilio/lib/rest/chat/v1/service/channel/member", "MemberPage")
  @js.native
  open class MemberPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.chatV1Mod.^, MemberPayload, MemberResource, MemberInstance] {
    /**
