...
object WorkspaceWorkerReservationInstance {
  ...
  inline def apply(get: RestMethod, post: RestMethod, update: RestMethod): WorkspaceWorkerReservationInstance = {
  ...
  extension [Self <: WorkspaceWorkerReservationInstance](x: Self) {
