...
inline def apply(accountSid: String, authToken: String, opts: ClientOpts): typings.twilio.libMod.Twilio = (^.asInstanceOf[js.Dynamic].apply(accountSid.asInstanceOf[js.Any], authToken.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.twilio.libMod.Twilio]
inline def apply(accountSid: String, authToken: Unit, opts: ClientOpts): typings.twilio.libMod.Twilio = (^.asInstanceOf[js.Dynamic].apply(accountSid.asInstanceOf[js.Any], authToken.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.twilio.libMod.Twilio]
...
inline def apply(accountSid: Unit, authToken: String, opts: ClientOpts): typings.twilio.libMod.Twilio = (^.asInstanceOf[js.Dynamic].apply(accountSid.asInstanceOf[js.Any], authToken.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.twilio.libMod.Twilio]
inline def apply(accountSid: Unit, authToken: Unit, opts: ClientOpts): typings.twilio.libMod.Twilio = (^.asInstanceOf[js.Dynamic].apply(accountSid.asInstanceOf[js.Any], authToken.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.twilio.libMod.Twilio]
