...
object userConversationMod {
  
  @JSImport("twilio/lib/rest/conversations/v1/service/user/userConversation", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/conversations/v1/service/user/userConversation", "UserConversationContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/conversations/v1/service/user/userConversation", "UserConversationInstance")
  @js.native
  ...
  /**
    ...
    * @param userSid - The unique ID for the User.
    */
  inline def UserConversationList(version: typings.twilio.conversationsV1Mod.^, chatServiceSid: String, userSid: String): UserConversationListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UserConversationList")(version.asInstanceOf[js.Any], chatServiceSid.asInstanceOf[js.Any], userSid.asInstanceOf[js.Any])).asInstanceOf[UserConversationListInstance]
  
  @JSImport("twilio/lib/rest/conversations/v1/service/user/userConversation", "UserConversationPage")
  @js.native
