...
object nationalMod {
  ...
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/national", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/national", "NationalInstance")
  @js.native
  open class NationalInstance protected () extends SerializableClass {
    /**
  ...
  /**
    ...
    * @param countryCode - The ISO-3166-1 country code of the country.
    */
  inline def NationalList(version: typings.twilio.v2010Mod.^, accountSid: String, countryCode: String): NationalListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("NationalList")(version.asInstanceOf[js.Any], accountSid.asInstanceOf[js.Any], countryCode.asInstanceOf[js.Any])).asInstanceOf[NationalListInstance]
  
  @JSImport("twilio/lib/rest/api/v2010/account/availablePhoneNumber/national", "NationalPage")
  @js.native
  open class NationalPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2010Mod.^, NationalPayload, NationalResource, NationalInstance] {
    /**
    ...
    /**
      ...
      */
    def getInstance(payload: NationalPayload): NationalInstance = js.native
  ...
  @js.native
  trait NationalListInstance extends StObject {
    ...
    def each(opts: NationalListInstanceEachOptions): Unit = js.native
    def each(
      opts: NationalListInstanceEachOptions,
      callback: js.Function2[
          /* item */ NationalInstance, 
          /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit], 
          Unit
    ...
    /**
      ...
      */
    def getPage(): js.Promise[NationalPage] = js.native
    def getPage(callback: js.Function2[/* error */ js.Error | Null, /* items */ NationalPage, Any]): js.Promise[NationalPage] = js.native
    def getPage(targetUrl: String): js.Promise[NationalPage] = js.native
    def getPage(
      targetUrl: String,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ NationalPage, Any]
    ): js.Promise[NationalPage] = js.native
    def getPage(
      targetUrl: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ NationalPage, Any]
    ): js.Promise[NationalPage] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def list(): js.Promise[js.Array[NationalInstance]] = js.native
    def list(callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[NationalInstance], Any]): js.Promise[js.Array[NationalInstance]] = js.native
    def list(
      opts: Unit,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[NationalInstance], Any]
    ): js.Promise[js.Array[NationalInstance]] = js.native
    def list(opts: NationalListInstanceOptions): js.Promise[js.Array[NationalInstance]] = js.native
    def list(
      opts: NationalListInstanceOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ js.Array[NationalInstance], Any]
    ): js.Promise[js.Array[NationalInstance]] = js.native
    ...
    /**
      ...
      * @param callback - Callback to handle list of records
      */
    def page(): js.Promise[NationalPage] = js.native
    def page(callback: js.Function2[/* error */ js.Error | Null, /* items */ NationalPage, Any]): js.Promise[NationalPage] = js.native
    def page(opts: Unit, callback: js.Function2[/* error */ js.Error | Null, /* items */ NationalPage, Any]): js.Promise[NationalPage] = js.native
    def page(opts: NationalListInstancePageOptions): js.Promise[NationalPage] = js.native
    def page(
      opts: NationalListInstancePageOptions,
      callback: js.Function2[/* error */ js.Error | Null, /* items */ NationalPage, Any]
    ): js.Promise[NationalPage] = js.native
  ...
  /**
    ...
    */
  trait NationalListInstanceEachOptions extends StObject {
  ...
  object NationalListInstanceEachOptions {
    
    inline def apply(): NationalListInstanceEachOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[NationalListInstanceEachOptions]
    }
    
    extension [Self <: NationalListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ NationalInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Unit
  ...
  /**
    ...
    * @property voiceEnabled - Whether the phone numbers can receive calls.
    */
  trait NationalListInstanceOptions extends StObject {
  ...
  object NationalListInstanceOptions {
    
    inline def apply(): NationalListInstanceOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[NationalListInstanceOptions]
    }
    
    extension [Self <: NationalListInstanceOptions](x: Self) {
  ...
  /**
    ...
    * @property voiceEnabled - Whether the phone numbers can receive calls.
    */
  trait NationalListInstancePageOptions extends StObject {
  ...
  object NationalListInstancePageOptions {
    
    inline def apply(): NationalListInstancePageOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[NationalListInstancePageOptions]
    }
    
    extension [Self <: NationalListInstancePageOptions](x: Self) {
  ...
  trait NationalPayload
    extends StObject
       with NationalResource
       with TwilioResponsePayload
  object NationalPayload {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[NationalPayload]
    }
  }
  
  trait NationalResource extends StObject {
  ...
  object NationalResource {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[NationalResource]
    }
    
    extension [Self <: NationalResource](x: Self) {
  ...
  trait NationalSolution extends StObject {
    
    var accountSid: js.UndefOr[String] = js.undefined
    
    var countryCode: js.UndefOr[String] = js.undefined
  }
  object NationalSolution {
    
    inline def apply(): NationalSolution = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[NationalSolution]
    }
    
    extension [Self <: NationalSolution](x: Self) {
