...
object phoneNumberCountryMod {
  
  @JSImport("twilio/lib/rest/pricing/v1/phoneNumber/country", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/pricing/v1/phoneNumber/country", "CountryContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/pricing/v1/phoneNumber/country", "CountryInstance")
  @js.native
  open class CountryInstance protected () extends SerializableClass {
    ...
    var phoneNumberPrices: js.Array[String] = js.native
  ...
  @JSImport("twilio/lib/rest/pricing/v1/phoneNumber/country", "CountryPage")
  @js.native
  ...
  trait CountryResource extends StObject {
    ...
    var phone_number_prices: js.UndefOr[js.Array[String]] = js.undefined
  ...
  object CountryResource {
    ...
    extension [Self <: CountryResource](x: Self) {
      ...
      inline def setPhone_number_prices(value: js.Array[String]): Self = StObject.set(x, "phone_number_prices", value.asInstanceOf[js.Any])
      
      inline def setPhone_number_pricesUndefined: Self = StObject.set(x, "phone_number_prices", js.undefined)
      
      inline def setPhone_number_pricesVarargs(value: String*): Self = StObject.set(x, "phone_number_prices", js.Array(value*))
