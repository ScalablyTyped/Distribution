...
object reservationMod {
  
  @JSImport("twilio/lib/rest/taskrouter/v1/workspace/task/reservation", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/taskrouter/v1/workspace/task/reservation", "ReservationContext")
  @js.native
  open class ReservationContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typings.twilio.taskrouterV1Mod.^, workspaceSid: String, taskSid: String, sid: String) = this()
  ...
  @JSImport("twilio/lib/rest/taskrouter/v1/workspace/task/reservation", "ReservationInstance")
  @js.native
  ...
  /**
    ...
    * @param taskSid - The SID of the reserved Task resource
    */
  inline def ReservationList(version: typings.twilio.taskrouterV1Mod.^, workspaceSid: String, taskSid: String): ReservationListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ReservationList")(version.asInstanceOf[js.Any], workspaceSid.asInstanceOf[js.Any], taskSid.asInstanceOf[js.Any])).asInstanceOf[ReservationListInstance]
  
  @JSImport("twilio/lib/rest/taskrouter/v1/workspace/task/reservation", "ReservationPage")
  @js.native
  ...
  */
  ...
  trait ReservationInstanceUpdateOptions extends StObject {
    ...
    var supervisor: js.UndefOr[String] = js.undefined
    
    var supervisorMode: js.UndefOr[ReservationSupervisorMode] = js.undefined
  ...
  object ReservationInstanceUpdateOptions {
    ...
    extension [Self <: ReservationInstanceUpdateOptions](x: Self) {
      ...
      inline def setSupervisor(value: String): Self = StObject.set(x, "supervisor", value.asInstanceOf[js.Any])
      
      inline def setSupervisorMode(value: ReservationSupervisorMode): Self = StObject.set(x, "supervisorMode", value.asInstanceOf[js.Any])
      
      inline def setSupervisorModeUndefined: Self = StObject.set(x, "supervisorMode", js.undefined)
      
      inline def setSupervisorUndefined: Self = StObject.set(x, "supervisor", js.undefined)
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.twilio.twilioStrings.monitor
    - typings.twilio.twilioStrings.whisper
    - typings.twilio.twilioStrings.barge
  */
  trait ReservationSupervisorMode extends StObject
  object ReservationSupervisorMode {
    
    inline def barge: typings.twilio.twilioStrings.barge = "barge".asInstanceOf[typings.twilio.twilioStrings.barge]
    
    inline def monitor: typings.twilio.twilioStrings.monitor = "monitor".asInstanceOf[typings.twilio.twilioStrings.monitor]
    
    inline def whisper: typings.twilio.twilioStrings.whisper = "whisper".asInstanceOf[typings.twilio.twilioStrings.whisper]
  }
}
