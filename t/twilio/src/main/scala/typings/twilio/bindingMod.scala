...
object bindingMod {
  ...
  @JSImport("twilio/lib/rest/chat/v2/service/binding", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("twilio/lib/rest/chat/v2/service/binding", "BindingContext")
  @js.native
  ...
  @JSImport("twilio/lib/rest/chat/v2/service/binding", "BindingInstance")
  @js.native
  open class BindingInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The SID of the resource to fetch
      */
    def this(version: typings.twilio.v2Mod.^, payload: BindingPayload, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The SID of the Service that the Binding resource is associated with
    */
  inline def BindingList(version: typings.twilio.v2Mod.^, serviceSid: String): BindingListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("BindingList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[BindingListInstance]
  
  @JSImport("twilio/lib/rest/chat/v2/service/binding", "BindingPage")
  @js.native
  open class BindingPage protected ()
    extends typings.twilio.pageMod.^[typings.twilio.v2Mod.^, BindingPayload, BindingResource, BindingInstance] {
    /**
