...
trait TypeChecker extends js.Object {
  ...
  def getConstantValue(node: EnumMember): js.UndefOr[java.lang.String | scala.Double] = js.native
  ...
  def isOptionalParameter(node: ParameterDeclaration): scala.Boolean = js.native
  def isUndefinedSymbol(symbol: Symbol): scala.Boolean = js.native
  def isUnknownSymbol(symbol: Symbol): scala.Boolean = js.native
  def isValidPropertyAccess(node: ImportTypeNode, propertyName: java.lang.String): scala.Boolean = js.native
