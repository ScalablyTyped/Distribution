...
@js.native
object typescriptModMembers extends js.Object {
  ...
  /**
       ...
       */
  def hasJSDocParameterTags(
    node: typescriptLib.typescriptMod.tsNs.FunctionLikeDeclaration | typescriptLib.typescriptMod.tsNs.SignatureDeclaration
  ): scala.Boolean = js.native
  def idText(identifier: typescriptLib.typescriptMod.tsNs.Identifier): java.lang.String = js.native
  def isAccessor(node: typescriptLib.typescriptMod.tsNs.Node): /* is AccessorDeclaration */scala.Boolean = js.native
  ...
  def isBundle(node: typescriptLib.typescriptMod.tsNs.Node): /* is Bundle */scala.Boolean = js.native
  ...
  def isClassElement(node: typescriptLib.typescriptMod.tsNs.Node): /* is ClassElement */scala.Boolean = js.native
  def isClassExpression(node: typescriptLib.typescriptMod.tsNs.Node): /* is ClassExpression */scala.Boolean = js.native
  def isClassLike(node: typescriptLib.typescriptMod.tsNs.Node): /* is ClassLikeDeclaration */scala.Boolean = js.native
  ...
  def isEmptyBindingPattern(node: typescriptLib.typescriptMod.tsNs.BindingName): /* is BindingPattern */scala.Boolean = js.native
  ...
  def isFunctionLike(node: typescriptLib.typescriptMod.tsNs.Node): /* is SignatureDeclaration */scala.Boolean = js.native
  ...
  def isGetAccessor(node: typescriptLib.typescriptMod.tsNs.Node): /* is GetAccessorDeclaration */scala.Boolean = js.native
  ...
  def isHeritageClause(node: typescriptLib.typescriptMod.tsNs.Node): /* is HeritageClause */scala.Boolean = js.native
  ...
  ): /* is IterationStatement */scala.Boolean = js.native
  def isJSDoc(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDoc */scala.Boolean = js.native
  def isJSDocAllType(node: typescriptLib.typescriptMod.tsNs.JSDocAllType): /* is JSDocAllType */scala.Boolean = js.native
  def isJSDocAugmentsTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocAugmentsTag */scala.Boolean = js.native
  def isJSDocCallbackTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocCallbackTag */scala.Boolean = js.native
  def isJSDocClassTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocClassTag */scala.Boolean = js.native
  /** True if node is of a kind that may contain comment text. */
  def isJSDocCommentContainingNode(node: typescriptLib.typescriptMod.tsNs.Node): scala.Boolean = js.native
  def isJSDocEnumTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocEnumTag */scala.Boolean = js.native
  def isJSDocFunctionType(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocFunctionType */scala.Boolean = js.native
  def isJSDocNonNullableType(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocNonNullableType */scala.Boolean = js.native
  def isJSDocNullableType(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocNullableType */scala.Boolean = js.native
  def isJSDocOptionalType(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocOptionalType */scala.Boolean = js.native
  def isJSDocParameterTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocParameterTag */scala.Boolean = js.native
  def isJSDocPropertyLikeTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocPropertyLikeTag */scala.Boolean = js.native
  def isJSDocPropertyTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocPropertyTag */scala.Boolean = js.native
  def isJSDocReturnTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocReturnTag */scala.Boolean = js.native
  def isJSDocSignature(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocSignature */scala.Boolean = js.native
  def isJSDocTemplateTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocTemplateTag */scala.Boolean = js.native
  def isJSDocThisTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocThisTag */scala.Boolean = js.native
  def isJSDocTypeExpression(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocTypeExpression */scala.Boolean = js.native
  def isJSDocTypeLiteral(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocTypeLiteral */scala.Boolean = js.native
  def isJSDocTypeTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocTypeTag */scala.Boolean = js.native
  def isJSDocTypedefTag(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocTypedefTag */scala.Boolean = js.native
  def isJSDocUnknownType(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocUnknownType */scala.Boolean = js.native
  def isJSDocVariadicType(node: typescriptLib.typescriptMod.tsNs.Node): /* is JSDocVariadicType */scala.Boolean = js.native
  ...
  def isMissingDeclaration(node: typescriptLib.typescriptMod.tsNs.Node): /* is MissingDeclaration */scala.Boolean = js.native
  def isModifier(node: typescriptLib.typescriptMod.tsNs.Node): /* is Modifier */scala.Boolean = js.native
  ...
  def isObjectLiteralElement(node: typescriptLib.typescriptMod.tsNs.Node): /* is ObjectLiteralElement */scala.Boolean = js.native
  def isObjectLiteralElementLike(node: typescriptLib.typescriptMod.tsNs.Node): /* is ObjectLiteralElementLike */scala.Boolean = js.native
  ...
  def isParameter(node: typescriptLib.typescriptMod.tsNs.Node): /* is ParameterDeclaration */scala.Boolean = js.native
  def isParameterPropertyDeclaration(node: typescriptLib.typescriptMod.tsNs.Node): /* is ParameterPropertyDeclaration */scala.Boolean = js.native
  ...
  def isPropertyName(node: typescriptLib.typescriptMod.tsNs.Node): /* is PropertyName */scala.Boolean = js.native
  ...
  def isSemicolonClassElement(node: typescriptLib.typescriptMod.tsNs.Node): /* is SemicolonClassElement */scala.Boolean = js.native
  def isSetAccessor(node: typescriptLib.typescriptMod.tsNs.Node): /* is SetAccessorDeclaration */scala.Boolean = js.native
  ...
  def isStringLiteralLike(node: typescriptLib.typescriptMod.tsNs.Node): /* is StringLiteralLike */scala.Boolean = js.native
  ...
  def isTemplateHead(node: typescriptLib.typescriptMod.tsNs.Node): /* is TemplateHead */scala.Boolean = js.native
  def isTemplateLiteral(node: typescriptLib.typescriptMod.tsNs.Node): /* is TemplateLiteral */scala.Boolean = js.native
  def isTemplateLiteralToken(node: typescriptLib.typescriptMod.tsNs.Node): /* is TemplateLiteralToken */scala.Boolean = js.native
  def isTemplateMiddle(node: typescriptLib.typescriptMod.tsNs.Node): /* is TemplateMiddle */scala.Boolean = js.native
  def isTemplateMiddleOrTemplateTail(node: typescriptLib.typescriptMod.tsNs.Node): scala.Boolean = js.native
  def isTemplateSpan(node: typescriptLib.typescriptMod.tsNs.Node): /* is TemplateSpan */scala.Boolean = js.native
  def isTemplateTail(node: typescriptLib.typescriptMod.tsNs.Node): /* is TemplateTail */scala.Boolean = js.native
  def isThisTypeNode(node: typescriptLib.typescriptMod.tsNs.Node): /* is ThisTypeNode */scala.Boolean = js.native
  ...
  def isTypeElement(node: typescriptLib.typescriptMod.tsNs.Node): /* is TypeElement */scala.Boolean = js.native
  ...
  /**
       ...
       * of a TypeNode.
       */
  def isTypeNode(node: typescriptLib.typescriptMod.tsNs.Node): /* is TypeNode */scala.Boolean = js.native
  ...
  def isUnparsedSource(node: typescriptLib.typescriptMod.tsNs.Node): /* is UnparsedSource */scala.Boolean = js.native
  ...
  def isYieldExpression(node: typescriptLib.typescriptMod.tsNs.Node): /* is YieldExpression */scala.Boolean = js.native
  /**
  ...
  def visitEachChild[T /* <: typescriptLib.typescriptMod.tsNs.Node */](
    ...
    nodesVisitor: js.Function5[
      /* nodes */ js.UndefOr[
        typescriptLib.typescriptMod.tsNs.NodeArray[typescriptLib.typescriptMod.tsNs.Node]
      ], 
      /* visitor */ typescriptLib.typescriptMod.tsNs.Visitor, 
      /* test */ js.UndefOr[js.Function1[/* node */ typescriptLib.typescriptMod.tsNs.Node, scala.Boolean]], 
