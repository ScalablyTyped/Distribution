...
object EmitHint extends js.Object {
  ...
  /* 0 */ val SourceFile: typescriptLib.typescriptMod.tsNs.EmitHint.SourceFile with scala.Double = js.native
  /* 4 */ val Unspecified: typescriptLib.typescriptMod.tsNs.EmitHint.Unspecified with scala.Double = js.native
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[typescriptLib.typescriptMod.tsNs.EmitHint with scala.Double] = js.native
}
