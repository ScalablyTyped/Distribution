...
trait Type extends FlowType {
  ...
  def isClass(): /* is typescript.typescript.InterfaceType */ scala.Boolean
  def isClassOrInterface(): /* is typescript.typescript.InterfaceType */ scala.Boolean
  def isIntersection(): /* is typescript.typescript.IntersectionType */ scala.Boolean
  def isLiteral(): /* is typescript.typescript.LiteralType */ scala.Boolean
  def isNumberLiteral(): /* is typescript.typescript.NumberLiteralType */ scala.Boolean
  def isStringLiteral(): /* is typescript.typescript.StringLiteralType */ scala.Boolean
  def isTypeParameter(): /* is typescript.typescript.TypeParameter */ scala.Boolean
  def isUnion(): /* is typescript.typescript.UnionType */ scala.Boolean
  def isUnionOrIntersection(): /* is typescript.typescript.UnionOrIntersectionType */ scala.Boolean
}
