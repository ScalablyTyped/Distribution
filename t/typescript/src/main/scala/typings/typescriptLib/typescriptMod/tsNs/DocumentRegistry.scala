...
trait DocumentRegistry extends js.Object {
  ...
  /**
    ...
    */
  def releaseDocument(fileName: java.lang.String, compilationSettings: CompilerOptions): scala.Unit = js.native
  def releaseDocumentWithKey(path: Path, key: DocumentRegistryBucketKey): scala.Unit = js.native
