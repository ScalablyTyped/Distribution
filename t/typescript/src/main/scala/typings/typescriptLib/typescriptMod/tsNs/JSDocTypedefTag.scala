...
/* RemoveMultipleInheritance: Dropped parents List(typescriptLib.typescriptMod.tsNs.JSDocTag because Would inherit conflicting mutable fields List(pos, end, parent, flags, decorators, modifiers, kind))*/
@js.native
