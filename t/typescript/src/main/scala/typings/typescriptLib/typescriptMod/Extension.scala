...
object Extension extends js.Object {
  /* ".d.ts" */ val Dts: typescriptLib.typescriptMod.tsNs.Extension.Dts with java.lang.String = js.native
  /* ".js" */ val Js: typescriptLib.typescriptMod.tsNs.Extension.Js with java.lang.String = js.native
