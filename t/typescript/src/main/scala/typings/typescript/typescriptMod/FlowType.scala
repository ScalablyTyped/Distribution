...
object FlowType {
  ...
  def Type(
    ...
    getConstraint: () => js.UndefOr[typings.typescript.typescriptMod.Type],
    getConstructSignatures: () => js.Array[Signature],
    getDefault: () => js.UndefOr[typings.typescript.typescriptMod.Type],
    getFlags: () => TypeFlags,
    getNonNullableType: () => typings.typescript.typescriptMod.Type,
    getNumberIndexType: () => js.UndefOr[typings.typescript.typescriptMod.Type],
    getProperties: () => js.Array[Symbol],
    getProperty: String => js.UndefOr[Symbol],
    getStringIndexType: () => js.UndefOr[typings.typescript.typescriptMod.Type],
    ...
    aliasTypeArguments: js.Array[typings.typescript.typescriptMod.Type] = null,
