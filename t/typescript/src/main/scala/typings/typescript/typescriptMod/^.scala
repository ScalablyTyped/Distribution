...
object ^ extends js.Object {
  ...
  def createPropertySignature(modifiers: js.UndefOr[js.Array[Modifier]], name: PropertyName | String): PropertySignature = js.native
  ...
  def createUnionOrIntersectionTypeNode(kind: typings.typescript.typescriptMod.SyntaxKind.IntersectionType, types: js.Array[TypeNode]): UnionOrIntersectionTypeNode = js.native
  def createUnionOrIntersectionTypeNode(kind: typings.typescript.typescriptMod.SyntaxKind.UnionType, types: js.Array[TypeNode]): UnionOrIntersectionTypeNode = js.native
