...
object Classifier {
  @scala.inline
  def apply(
    getClassificationsForLine: (String, EndOfLineState, Boolean) => ClassificationResult,
    getEncodedLexicalClassifications: (String, EndOfLineState, Boolean) => Classifications
  ): Classifier = {
