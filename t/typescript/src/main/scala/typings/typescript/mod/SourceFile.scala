...
trait SourceFile
  ...
  var endOfFileToken: Token[typings.typescript.mod.SyntaxKind.EndOfFileToken] = js.native
  ...
  @JSName("kind")
  var kind_SourceFile: typings.typescript.mod.SyntaxKind.SourceFile = js.native
