...
package object mod {
  ...
  type AbstractKeyword = typings.typescript.mod.ModifierToken[typings.typescript.mod.SyntaxKind.AbstractKeyword]
  
  type AccessibilityModifier = typings.typescript.mod.PublicKeyword | typings.typescript.mod.PrivateKeyword | typings.typescript.mod.ProtectedKeyword
  ...
  */
  type ArrayBindingOrAssignmentElement = typings.typescript.mod._ArrayBindingOrAssignmentElement | typings.typescript.mod.AssignmentExpression[typings.typescript.mod.EqualsToken]
  
  type AssertsKeyword = typings.typescript.mod.KeywordToken[typings.typescript.mod.SyntaxKind.AssertsKeyword]
  
  type AssertsToken = typings.typescript.mod.AssertsKeyword
  ...
  */
  ...
  type AsteriskToken = typings.typescript.mod.PunctuationToken[typings.typescript.mod.SyntaxKind.AsteriskToken]
  
  type AsyncKeyword = typings.typescript.mod.ModifierToken[typings.typescript.mod.SyntaxKind.AsyncKeyword]
  
  type AwaitKeyword = typings.typescript.mod.KeywordToken[typings.typescript.mod.SyntaxKind.AwaitKeyword]
  
  type AwaitKeywordToken = typings.typescript.mod.AwaitKeyword
  ...
  */
  ...
  type ClassMemberModifier = typings.typescript.mod.AccessibilityModifier | typings.typescript.mod.ReadonlyKeyword | typings.typescript.mod.StaticKeyword
  
  type CodeActionCommand = typings.typescript.mod.InstallPackageAction
  
  type ColonToken = typings.typescript.mod.PunctuationToken[typings.typescript.mod.SyntaxKind.ColonToken]
  ...
  type ConstKeyword = typings.typescript.mod.ModifierToken[typings.typescript.mod.SyntaxKind.ConstKeyword]
  ...
  type DeclareKeyword = typings.typescript.mod.ModifierToken[typings.typescript.mod.SyntaxKind.DeclareKeyword]
  
  type DefaultKeyword = typings.typescript.mod.ModifierToken[typings.typescript.mod.SyntaxKind.DefaultKeyword]
  ...
  type DotDotDotToken = typings.typescript.mod.PunctuationToken[typings.typescript.mod.SyntaxKind.DotDotDotToken]
  
  type DotToken = typings.typescript.mod.PunctuationToken[typings.typescript.mod.SyntaxKind.DotToken]
  ...
  type EqualsGreaterThanToken = typings.typescript.mod.PunctuationToken[typings.typescript.mod.SyntaxKind.EqualsGreaterThanToken]
  
  type EqualsToken = typings.typescript.mod.PunctuationToken[typings.typescript.mod.SyntaxKind.EqualsToken]
  ...
  type ExclamationToken = typings.typescript.mod.PunctuationToken[typings.typescript.mod.SyntaxKind.ExclamationToken]
  
  type ExponentiationOperator = typings.typescript.mod.SyntaxKind.AsteriskAsteriskToken
  
  type ExportKeyword = typings.typescript.mod.ModifierToken[typings.typescript.mod.SyntaxKind.ExportKeyword]
  ...
  */
  ...
  type KeywordToken[TKind /* <: typings.typescript.mod.KeywordSyntaxKind */] = typings.typescript.mod.Token[TKind]
  ...
  /**
    ...
    */
  type Map[T] = typings.typescript.mod.ESMap[java.lang.String, T]
  ...
  type MinusToken = typings.typescript.mod.PunctuationToken[typings.typescript.mod.SyntaxKind.MinusToken]
  
  type Modifier = typings.typescript.mod.AbstractKeyword | typings.typescript.mod.AsyncKeyword | typings.typescript.mod.ConstKeyword | typings.typescript.mod.DeclareKeyword | typings.typescript.mod.DefaultKeyword | typings.typescript.mod.ExportKeyword | typings.typescript.mod.PrivateKeyword | typings.typescript.mod.ProtectedKeyword | typings.typescript.mod.PublicKeyword | typings.typescript.mod.ReadonlyKeyword | typings.typescript.mod.StaticKeyword
  
  type ModifierToken[TKind /* <: typings.typescript.mod.ModifierSyntaxKind */] = typings.typescript.mod.KeywordToken[TKind]
  ...
  type ParameterPropertyModifier = typings.typescript.mod.AccessibilityModifier | typings.typescript.mod.ReadonlyKeyword
  
  type Path = java.lang.String with typings.typescript.anon.PathBrand
  
  type PlusToken = typings.typescript.mod.PunctuationToken[typings.typescript.mod.SyntaxKind.PlusToken]
  
  type PrivateKeyword = typings.typescript.mod.ModifierToken[typings.typescript.mod.SyntaxKind.PrivateKeyword]
  
  type ProtectedKeyword = typings.typescript.mod.ModifierToken[typings.typescript.mod.SyntaxKind.ProtectedKeyword]
  
  type PublicKeyword = typings.typescript.mod.ModifierToken[typings.typescript.mod.SyntaxKind.PublicKeyword]
  
  type PunctuationToken[TKind /* <: typings.typescript.mod.PunctuationSyntaxKind */] = typings.typescript.mod.Token[TKind]
  
  type QuestionDotToken = typings.typescript.mod.PunctuationToken[typings.typescript.mod.SyntaxKind.QuestionDotToken]
  
  type QuestionToken = typings.typescript.mod.PunctuationToken[typings.typescript.mod.SyntaxKind.QuestionToken]
  
  type ReadonlyKeyword = typings.typescript.mod.ModifierToken[typings.typescript.mod.SyntaxKind.ReadonlyKeyword]
  ...
  /**
    ...
    */
  type ReadonlyMap[T] = typings.typescript.mod.ReadonlyESMap[java.lang.String, T]
  
  type ReadonlyToken = typings.typescript.mod.ReadonlyKeyword
  
  type ReadonlyUnderscoreEscapedMap[T] = typings.typescript.mod.ReadonlyESMap[typings.typescript.mod.String, T]
  ...
  type StaticKeyword = typings.typescript.mod.ModifierToken[typings.typescript.mod.SyntaxKind.StaticKeyword]
