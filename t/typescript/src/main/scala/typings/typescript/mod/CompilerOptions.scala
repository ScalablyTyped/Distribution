...
object CompilerOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(disableSolutionSearching)) __obj.updateDynamic("disableSolutionSearching")(disableSolutionSearching.get.asInstanceOf[js.Any])
    ...
    if (tsBuildInfoFile != null) __obj.updateDynamic("tsBuildInfoFile")(tsBuildInfoFile.asInstanceOf[js.Any])
