...
trait CompilerOptions
  ...
  var declarationDir: js.UndefOr[java.lang.String] = js.native
  ...
  var importsNotUsedAsValues: js.UndefOr[ImportsNotUsedAsValues] = js.native
  ...
  var lib: js.UndefOr[js.Array[java.lang.String]] = js.native
  var locale: js.UndefOr[java.lang.String] = js.native
  var mapRoot: js.UndefOr[java.lang.String] = js.native
  ...
  var out: js.UndefOr[java.lang.String] = js.native
  var outDir: js.UndefOr[java.lang.String] = js.native
  var outFile: js.UndefOr[java.lang.String] = js.native
  var paths: js.UndefOr[MapLike[js.Array[java.lang.String]]] = js.native
  var preserveConstEnums: js.UndefOr[Boolean] = js.native
  var preserveSymlinks: js.UndefOr[Boolean] = js.native
  var project: js.UndefOr[java.lang.String] = js.native
  var reactNamespace: js.UndefOr[java.lang.String] = js.native
  ...
  var rootDirs: js.UndefOr[js.Array[java.lang.String]] = js.native
  var skipDefaultLibCheck: js.UndefOr[Boolean] = js.native
  var skipLibCheck: js.UndefOr[Boolean] = js.native
  var sourceMap: js.UndefOr[Boolean] = js.native
  var sourceRoot: js.UndefOr[java.lang.String] = js.native
  ...
  var tsBuildInfoFile: js.UndefOr[java.lang.String] = js.native
  /** Paths used to compute primary types search locations */
  var typeRoots: js.UndefOr[js.Array[java.lang.String]] = js.native
  var types: js.UndefOr[js.Array[java.lang.String]] = js.native
...
object CompilerOptions {
  ...
  implicit class CompilerOptionsOps[Self <: CompilerOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBaseUrl(value: java.lang.String): Self = this.set("baseUrl", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDeclarationDir(value: java.lang.String): Self = this.set("declarationDir", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDisableSolutionSearching(value: Boolean): Self = this.set("disableSolutionSearching", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setJsxFactory(value: java.lang.String): Self = this.set("jsxFactory", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMapRoot(value: java.lang.String): Self = this.set("mapRoot", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOut(value: java.lang.String): Self = this.set("out", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOut: Self = this.set("out", js.undefined)
    @scala.inline
    def setOutDir(value: java.lang.String): Self = this.set("outDir", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOutDir: Self = this.set("outDir", js.undefined)
    @scala.inline
    def setOutFile(value: java.lang.String): Self = this.set("outFile", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOutFile: Self = this.set("outFile", js.undefined)
    @scala.inline
    def setPaths(value: MapLike[js.Array[java.lang.String]]): Self = this.set("paths", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setProject(value: java.lang.String): Self = this.set("project", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteProject: Self = this.set("project", js.undefined)
    @scala.inline
    def setReactNamespace(value: java.lang.String): Self = this.set("reactNamespace", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRootDir(value: java.lang.String): Self = this.set("rootDir", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSourceRoot(value: java.lang.String): Self = this.set("sourceRoot", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTsBuildInfoFile(value: java.lang.String): Self = this.set("tsBuildInfoFile", value.asInstanceOf[js.Any])
    @scala.inline
