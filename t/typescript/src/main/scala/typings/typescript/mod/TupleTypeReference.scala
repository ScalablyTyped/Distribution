...
trait TupleTypeReference extends TypeReference {
  @JSName("target")
  var target_TupleTypeReference: TupleType = js.native
}
...
object TupleTypeReference {
  ...
  @scala.inline
  implicit class TupleTypeReferenceOps[Self <: TupleTypeReference] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setTarget(value: TupleType): Self = this.set("target", value.asInstanceOf[js.Any])
  }
