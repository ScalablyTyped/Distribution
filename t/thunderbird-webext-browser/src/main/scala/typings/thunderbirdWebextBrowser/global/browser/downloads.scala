...
import typings.thunderbirdWebextBrowser.browser.downloads.DownloadItem
import typings.thunderbirdWebextBrowser.browser.downloads.DownloadOptions
import typings.thunderbirdWebextBrowser.browser.downloads.DownloadQuery
import typings.thunderbirdWebextBrowser.browser.downloads.GetFileIconOptions
import typings.thunderbirdWebextBrowser.browser.downloads.OnChangedDownloadDelta
