...
import typings.thunderbirdWebextBrowser.messenger.contacts.ContactProperties
import typings.thunderbirdWebextBrowser.messenger.contacts.PropertyChange
import typings.thunderbirdWebextBrowser.messenger.contacts.QueryInfo
