...
import typings.thunderbirdWebextBrowser.browser.composeAction.ColorArray
import typings.thunderbirdWebextBrowser.browser.composeAction.GetBadgeBackgroundColorDetails
import typings.thunderbirdWebextBrowser.browser.composeAction.GetBadgeTextDetails
import typings.thunderbirdWebextBrowser.browser.composeAction.GetLabelDetails
import typings.thunderbirdWebextBrowser.browser.composeAction.GetPopupDetails
import typings.thunderbirdWebextBrowser.browser.composeAction.GetTitleDetails
import typings.thunderbirdWebextBrowser.browser.composeAction.IsEnabledDetails
import typings.thunderbirdWebextBrowser.browser.composeAction.OnClickData
import typings.thunderbirdWebextBrowser.browser.composeAction.SetBadgeBackgroundColorDetails
import typings.thunderbirdWebextBrowser.browser.composeAction.SetBadgeTextDetails
import typings.thunderbirdWebextBrowser.browser.composeAction.SetIconDetails
import typings.thunderbirdWebextBrowser.browser.composeAction.SetLabelDetails
import typings.thunderbirdWebextBrowser.browser.composeAction.SetPopupDetails
import typings.thunderbirdWebextBrowser.browser.composeAction.SetTitleDetails
...
object composeAction {
  ...
  @JSGlobal("browser.composeAction")
  @js.native
  ...
  @JSGlobal("browser.composeAction.onClicked")
  @js.native
