...
import typings.thunderbirdWebextBrowser.messenger.windows.CreateCreateData
import typings.thunderbirdWebextBrowser.messenger.windows.GetInfo
import typings.thunderbirdWebextBrowser.messenger.windows.UpdateUpdateInfo
import typings.thunderbirdWebextBrowser.messenger.windows.Window
...
object windows {
  ...
  @JSGlobal("messenger.windows")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("messenger.windows.WINDOW_ID_CURRENT")
  @js.native
  val WINDOW_ID_CURRENT: Double = js.native
  
  @JSGlobal("messenger.windows.WINDOW_ID_NONE")
  @js.native
