...
import typings.thunderbirdWebextBrowser.browser.messages.MessagePart
import typings.thunderbirdWebextBrowser.browser.messages.MessageProperties
import typings.thunderbirdWebextBrowser.browser.messages.MessageTag
import typings.thunderbirdWebextBrowser.browser.messages.QueryQueryInfo
import typings.thunderbirdWebextBrowser.browser.messages.UpdateTagUpdateProperties
