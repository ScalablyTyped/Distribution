...
import typings.thunderbirdWebextBrowser.messenger.action.ColorArray
import typings.thunderbirdWebextBrowser.messenger.action.GetBadgeBackgroundColorDetails
import typings.thunderbirdWebextBrowser.messenger.action.GetBadgeTextDetails
import typings.thunderbirdWebextBrowser.messenger.action.GetLabelDetails
import typings.thunderbirdWebextBrowser.messenger.action.GetPopupDetails
import typings.thunderbirdWebextBrowser.messenger.action.GetTitleDetails
import typings.thunderbirdWebextBrowser.messenger.action.IsEnabledDetails
import typings.thunderbirdWebextBrowser.messenger.action.OnClickData
import typings.thunderbirdWebextBrowser.messenger.action.SetBadgeBackgroundColorDetails
import typings.thunderbirdWebextBrowser.messenger.action.SetBadgeTextDetails
import typings.thunderbirdWebextBrowser.messenger.action.SetIconDetails
import typings.thunderbirdWebextBrowser.messenger.action.SetLabelDetails
import typings.thunderbirdWebextBrowser.messenger.action.SetPopupDetails
import typings.thunderbirdWebextBrowser.messenger.action.SetTitleDetails
...
object action {
  ...
  @JSGlobal("messenger.action.onClicked")
  @js.native
