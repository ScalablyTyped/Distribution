...
import typings.thunderbirdWebextBrowser.browser.messageDisplay.OpenOpenProperties
...
object messageDisplay {
  ...
  @JSGlobal("browser.messageDisplay")
  @js.native
  ...
  @JSGlobal("browser.messageDisplay.onMessageDisplayed")
  @js.native
  val onMessageDisplayed: WebExtEvent[js.Function2[/* tab */ Tab, /* message */ MessageHeader, Unit]] = js.native
  
  @JSGlobal("browser.messageDisplay.onMessagesDisplayed")
  @js.native
