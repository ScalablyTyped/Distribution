...
import typings.thunderbirdWebextBrowser.browser.manifest.UndefinedChromeResources
...
object Version {
  ...
  inline def apply(chrome_resources: UndefinedChromeResources, version: String): Version = {
