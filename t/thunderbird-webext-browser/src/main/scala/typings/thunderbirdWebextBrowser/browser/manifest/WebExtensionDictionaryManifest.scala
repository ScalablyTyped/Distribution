...
trait WebExtensionDictionaryManifest extends StObject {
  ...
  var developer: js.UndefOr[WebExtensionDictionaryManifestDeveloper] = js.undefined
...
object WebExtensionDictionaryManifest {
  ...
  implicit open class MutableBuilder[Self <: WebExtensionDictionaryManifest] (val x: Self) extends AnyVal {
    ...
    inline def setDeveloper(value: WebExtensionDictionaryManifestDeveloper): Self = StObject.set(x, "developer", value.asInstanceOf[js.Any])
    
    inline def setDeveloperUndefined: Self = StObject.set(x, "developer", js.undefined)
    
    inline def setDictionaries(value: WebExtensionDictionaryManifestDictionaries): Self = StObject.set(x, "dictionaries", value.asInstanceOf[js.Any])
