...
import typings.thunderbirdWebextBrowser.browser.webRequest.HttpHeaders
import typings.thunderbirdWebextBrowser.browser.webRequest.RequestFilter
import typings.thunderbirdWebextBrowser.browser.webRequest.ResourceType
import typings.thunderbirdWebextBrowser.browser.webRequest.UrlClassification
import typings.thunderbirdWebextBrowser.browser.webRequest._HttpHeaders
