...
import typings.thunderbirdWebextBrowser.anon.Matches
import typings.thunderbirdWebextBrowser.anon.PagePersistent
import typings.thunderbirdWebextBrowser.anon.Scripts
import typings.thunderbirdWebextBrowser.anon.ServiceworkerExtensionURL
import typings.thunderbirdWebextBrowser.browser.experiments.ExperimentAPI
...
trait WebExtensionManifest extends StObject {
  ...
  var background: js.UndefOr[PagePersistent | Scripts | ServiceworkerExtensionURL] = js.undefined
...
object WebExtensionManifest {
  ...
  implicit open class MutableBuilder[Self <: WebExtensionManifest] (val x: Self) extends AnyVal {
    ...
    inline def setBackground(value: PagePersistent | Scripts | ServiceworkerExtensionURL): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
