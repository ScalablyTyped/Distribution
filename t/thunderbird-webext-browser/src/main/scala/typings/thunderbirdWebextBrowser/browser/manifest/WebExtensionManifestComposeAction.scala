...
trait WebExtensionManifestComposeAction extends StObject {
  ...
  /**
    ...
    */
  var default_area: js.UndefOr[WebExtensionManifestComposeActionDefaultArea] = js.undefined
...
object WebExtensionManifestComposeAction {
  
  inline def apply(): WebExtensionManifestComposeAction = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WebExtensionManifestComposeAction]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WebExtensionManifestComposeAction] (val x: Self) extends AnyVal {
    ...
    inline def setDefault_area(value: WebExtensionManifestComposeActionDefaultArea): Self = StObject.set(x, "default_area", value.asInstanceOf[js.Any])
