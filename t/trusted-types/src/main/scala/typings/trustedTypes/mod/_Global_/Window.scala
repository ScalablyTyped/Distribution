...
trait Window extends js.Object {
  var TrustedHTML: typings.trustedTypes.mod._Global_.TrustedHTML
  var TrustedScript: typings.trustedTypes.mod._Global_.TrustedScript
  var TrustedScriptURL: typings.trustedTypes.mod._Global_.TrustedScriptURL
  var TrustedTypePolicy: typings.trustedTypes.mod._Global_.TrustedTypePolicy
  var TrustedTypePolicyFactory: typings.trustedTypes.mod._Global_.TrustedTypePolicyFactory
  /** @deprecated Prefer the lowercase version. */
  var TrustedTypes: js.UndefOr[TrustedTypePolicyFactory] = js.undefined
  var TrustedURL: typings.trustedTypes.mod._Global_.TrustedURL
