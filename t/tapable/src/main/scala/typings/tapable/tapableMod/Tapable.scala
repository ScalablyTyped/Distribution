...
import typings.tapable.tapableMod.TapableNs.CallbackFunction
import typings.tapable.tapableMod.TapableNs.Handler
import typings.tapable.tapableMod.TapableNs.Plugin
