...
object mod {
  ...
  inline def cleanup(callback: js.Function2[/* err */ js.Any, /* result */ Stats, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("cleanup")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def mkdir(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("mkdir")().asInstanceOf[Unit]
  inline def mkdir(affixes: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("mkdir")(affixes.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def mkdir(affixes: String, callback: js.Function2[/* err */ js.Any, /* dirPath */ String, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdir")(affixes.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def mkdir(affixes: Unit, callback: js.Function2[/* err */ js.Any, /* dirPath */ String, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdir")(affixes.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def mkdir(affixes: AffixOptions): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("mkdir")(affixes.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def mkdir(affixes: AffixOptions, callback: js.Function2[/* err */ js.Any, /* dirPath */ String, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("mkdir")(affixes.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def open(affixes: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("open")(affixes.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def open(affixes: String, callback: js.Function2[/* err */ js.Any, /* result */ OpenFile, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("open")(affixes.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def open(affixes: Unit, callback: js.Function2[/* err */ js.Any, /* result */ OpenFile, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("open")(affixes.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def open(affixes: AffixOptions): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("open")(affixes.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def open(affixes: AffixOptions, callback: js.Function2[/* err */ js.Any, /* result */ OpenFile, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("open")(affixes.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def track(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("track")().asInstanceOf[js.Any]
  inline def track(value: Boolean): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("track")(value.asInstanceOf[js.Any]).asInstanceOf[js.Any]
