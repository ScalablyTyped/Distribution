...
object srcQueryTransformerQueryTransformerMod {
  
  @JSImport("typeorm-aurora-data-api-driver/dist/types/src/query-transformer/query-transformer", "QueryTransformer")
  @js.native
  abstract class QueryTransformer () extends StObject {
