...
object distTypesSrcTypeormAuroraDataApiDriverMod {
  ...
  open class MysqlQueryTransformer ()
    extends typings.typeormAuroraDataApiDriver.distTypesSrcQueryTransformerMod.MysqlQueryTransformer {
  ...
  open class PostgresQueryTransformer ()
    extends typings.typeormAuroraDataApiDriver.distTypesSrcQueryTransformerMod.PostgresQueryTransformer {
    def this(transformOptions: Any) = this()
  }
