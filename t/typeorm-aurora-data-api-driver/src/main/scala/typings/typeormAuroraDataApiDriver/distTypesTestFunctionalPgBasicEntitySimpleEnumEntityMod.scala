...
object distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod {
  ...
  object HeterogeneousEnum extends StObject {
    ...
    /* 0 */ val NO: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.HeterogeneousEnum.NO & (Double | String) = js.native
    
    @js.native
    sealed trait YES
      extends StObject
         with HeterogeneousEnum
    /* "YES" */ val YES: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.HeterogeneousEnum.YES & (Double | String) = js.native
  }
  ...
  object NumericEnum extends StObject {
    ...
    sealed trait ADMIN
      extends StObject
         with NumericEnum
    /* 0 */ val ADMIN: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.NumericEnum.ADMIN & Double = js.native
    
    @js.native
    sealed trait EDITOR
      extends StObject
         with NumericEnum
    /* 1 */ val EDITOR: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.NumericEnum.EDITOR & Double = js.native
    
    @js.native
    sealed trait GHOST
      extends StObject
         with NumericEnum
    /* 3 */ val GHOST: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.NumericEnum.GHOST & Double = js.native
    
    @js.native
    sealed trait MODERATOR
      extends StObject
         with NumericEnum
    /* 2 */ val MODERATOR: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.NumericEnum.MODERATOR & Double = js.native
  }
  ...
  object StringEnum extends StObject {
    ...
    sealed trait ADMIN
      extends StObject
         with StringEnum
    /* "a" */ val ADMIN: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.StringEnum.ADMIN & String = js.native
    
    @js.native
    sealed trait EDITOR
      extends StObject
         with StringEnum
    /* "e" */ val EDITOR: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.StringEnum.EDITOR & String = js.native
    
    @js.native
    sealed trait GHOST
      extends StObject
         with StringEnum
    /* "g" */ val GHOST: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.StringEnum.GHOST & String = js.native
    
    @js.native
    sealed trait MODERATOR
      extends StObject
         with StringEnum
    /* "m" */ val MODERATOR: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.StringEnum.MODERATOR & String = js.native
  }
  ...
  object StringNumericEnum extends StObject {
    ...
    /* "4" */ val FOUR: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.StringNumericEnum.FOUR & String = js.native
    
    @js.native
    sealed trait ONE
      extends StObject
         with StringNumericEnum
    /* "1" */ val ONE: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.StringNumericEnum.ONE & String = js.native
    
    @js.native
    sealed trait THREE
      extends StObject
         with StringNumericEnum
    /* "3" */ val THREE: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.StringNumericEnum.THREE & String = js.native
    
    @js.native
    sealed trait TWO
      extends StObject
         with StringNumericEnum
    /* "2" */ val TWO: typings.typeormAuroraDataApiDriver.distTypesTestFunctionalPgBasicEntitySimpleEnumEntityMod.StringNumericEnum.TWO & String = js.native
  }
