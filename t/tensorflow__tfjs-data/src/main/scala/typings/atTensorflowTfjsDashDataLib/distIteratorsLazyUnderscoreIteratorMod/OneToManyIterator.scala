...
abstract class OneToManyIterator[T] () extends LazyIterator[T] {
  ...
  var outputQueue: atTensorflowTfjsDashDataLib.distUtilRingUnderscoreBufferMod.RingBuffer[T] = js.native
  /**
    ...
    */
  /* protected */ def pump(): js.Promise[scala.Boolean] = js.native
