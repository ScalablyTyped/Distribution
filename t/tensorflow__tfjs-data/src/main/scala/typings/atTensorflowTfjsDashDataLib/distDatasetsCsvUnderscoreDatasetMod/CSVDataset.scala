package typings
package atTensorflowTfjsDashDataLib.distDatasetsCsvUnderscoreDatasetMod
...
class CSVDataset protected ()
  extends atTensorflowTfjsDashDataLib.distDatasetMod.Dataset[atTensorflowTfjsDashCoreLib.distTensorUnderscoreTypesMod.TensorContainer] {
  /**
    * Create a `CSVDataset`.
    *
  ...
  var base: atTensorflowTfjsDashDataLib.distDatasetsTextUnderscoreLineUnderscoreDatasetMod.TextLineDataset = js.native
  ...
  def columnNames(): js.Promise[js.Array[java.lang.String]] = js.native
  def makeDataElement(line: java.lang.String): atTensorflowTfjsDashCoreLib.distTensorUnderscoreTypesMod.TensorContainer = js.native
}
