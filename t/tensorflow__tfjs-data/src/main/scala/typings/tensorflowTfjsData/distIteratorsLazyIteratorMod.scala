...
import typings.tensorflowTfjsData.distTypesMod.Container
import typings.tensorflowTfjsData.distUtilDeepMapMod.DeepMapResult
...
object distIteratorsLazyIteratorMod {
  ...
  object ZipMismatchMode extends StObject {
    ...
    /* 0 */ val FAIL: typings.tensorflowTfjsData.distIteratorsLazyIteratorMod.ZipMismatchMode.FAIL & Double = js.native
    
    @js.native
    sealed trait LONGEST
      extends StObject
         with ZipMismatchMode
    /* 2 */ val LONGEST: typings.tensorflowTfjsData.distIteratorsLazyIteratorMod.ZipMismatchMode.LONGEST & Double = js.native
    
    @js.native
    sealed trait SHORTEST
      extends StObject
         with ZipMismatchMode
    /* 1 */ val SHORTEST: typings.tensorflowTfjsData.distIteratorsLazyIteratorMod.ZipMismatchMode.SHORTEST & Double = js.native
  }
