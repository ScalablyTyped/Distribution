...
class Workbook () extends js.Object {
  ...
  def activateSheetAsync(sheetNameOrIndex: java.lang.String): stdLib.Promise[Sheet] = js.native
  /** Activates the sheet, either by name or index, and returns a promise of the sheet that was activated. */
  def activateSheetAsync(sheetNameOrIndex: scala.Double): stdLib.Promise[Sheet] = js.native
  /**
           ...
           */
  def changeParameterValueAsync(name: java.lang.String, value: js.Any): stdLib.Promise[Parameter] = js.native
  ...
  def getCustomViewsAsync(): stdLib.Promise[js.Array[CustomView]] = js.native
  ...
  def getParametersAsync(): stdLib.Promise[js.Array[Parameter]] = js.native
  ...
  def rememberCustomViewAsync(customViewName: java.lang.String): stdLib.Promise[CustomView] = js.native
  /** Removes the named custom view. */
  def removeCustomViewAsync(customViewName: java.lang.String): stdLib.Promise[CustomView] = js.native
  ...
  def showCustomViewAsync(customViewName: java.lang.String): stdLib.Promise[CustomView] = js.native
}
