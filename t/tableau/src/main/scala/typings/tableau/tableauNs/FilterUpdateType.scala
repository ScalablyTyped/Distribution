...
object FilterUpdateType extends js.Object {
  ...
  /* "add" */ val ADD: typings.tableau.tableauNs.FilterUpdateType.ADD with String = js.native
  /* "all" */ val ALL: typings.tableau.tableauNs.FilterUpdateType.ALL with String = js.native
  /* "remove" */ val REMOVE: typings.tableau.tableauNs.FilterUpdateType.REMOVE with String = js.native
  /* "replace" */ val REPLACE: typings.tableau.tableauNs.FilterUpdateType.REPLACE with String = js.native
  @JSBracketAccess
