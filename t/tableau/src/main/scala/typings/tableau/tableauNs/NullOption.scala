...
object NullOption extends js.Object {
  ...
  /* "allValues" */ val ALL_VALUES: typings.tableau.tableauNs.NullOption.ALL_VALUES with String = js.native
  /* "nonNullValues" */ val NON_NULL_VALUES: typings.tableau.tableauNs.NullOption.NON_NULL_VALUES with String = js.native
  /* "nullValues" */ val NULL_VALUES: typings.tableau.tableauNs.NullOption.NULL_VALUES with String = js.native
  @JSBracketAccess
