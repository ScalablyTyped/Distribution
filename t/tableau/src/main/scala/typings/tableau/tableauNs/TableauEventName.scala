...
object TableauEventName extends js.Object {
  ...
  /* "customviewload" */ val CUSTOM_VIEW_LOAD: typings.tableau.tableauNs.TableauEventName.CUSTOM_VIEW_LOAD with String = js.native
  /* "customviewremove" */ val CUSTOM_VIEW_REMOVE: typings.tableau.tableauNs.TableauEventName.CUSTOM_VIEW_REMOVE with String = js.native
  /* "customviewsave" */ val CUSTOM_VIEW_SAVE: typings.tableau.tableauNs.TableauEventName.CUSTOM_VIEW_SAVE with String = js.native
  /* "customviewsetdefault" */ val CUSTOM_VIEW_SET_DEFAULT: typings.tableau.tableauNs.TableauEventName.CUSTOM_VIEW_SET_DEFAULT with String = js.native
  /* "filterchange" */ val FILTER_CHANGE: typings.tableau.tableauNs.TableauEventName.FILTER_CHANGE with String = js.native
  /* "marksselection" */ val MARKS_SELECTION: typings.tableau.tableauNs.TableauEventName.MARKS_SELECTION with String = js.native
  /* "parametervaluechange" */ val PARAMETER_VALUE_CHANGE: typings.tableau.tableauNs.TableauEventName.PARAMETER_VALUE_CHANGE with String = js.native
  /* "storypointswitch" */ val STORY_POINT_SWITCH: typings.tableau.tableauNs.TableauEventName.STORY_POINT_SWITCH with String = js.native
  /* "tabswitch" */ val TAB_SWITCH: typings.tableau.tableauNs.TableauEventName.TAB_SWITCH with String = js.native
  /* "toolbarstatechange" */ val TOOLBAR_STATE_CHANGE: typings.tableau.tableauNs.TableauEventName.TOOLBAR_STATE_CHANGE with String = js.native
  /* "vizresize" */ val VIZ_RESIZE: typings.tableau.tableauNs.TableauEventName.VIZ_RESIZE with String = js.native
  @JSBracketAccess
