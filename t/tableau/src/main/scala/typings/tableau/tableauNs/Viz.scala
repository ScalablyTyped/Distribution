...
import typings.tableau.tableauNs.TableauEventName.CUSTOM_VIEW_LOAD
import typings.tableau.tableauNs.TableauEventName.CUSTOM_VIEW_REMOVE
import typings.tableau.tableauNs.TableauEventName.CUSTOM_VIEW_SAVE
import typings.tableau.tableauNs.TableauEventName.CUSTOM_VIEW_SET_DEFAULT
import typings.tableau.tableauNs.TableauEventName.FILTER_CHANGE
import typings.tableau.tableauNs.TableauEventName.MARKS_SELECTION
import typings.tableau.tableauNs.TableauEventName.PARAMETER_VALUE_CHANGE
import typings.tableau.tableauNs.TableauEventName.STORY_POINT_SWITCH
import typings.tableau.tableauNs.TableauEventName.TAB_SWITCH
import typings.tableau.tableauNs.TableauEventName.TOOLBAR_STATE_CHANGE
import typings.tableau.tableauNs.TableauEventName.VIZ_RESIZE
