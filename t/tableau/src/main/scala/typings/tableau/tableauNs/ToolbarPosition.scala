...
object ToolbarPosition extends js.Object {
  ...
  /* "bottom" */ val BOTTOM: typings.tableau.tableauNs.ToolbarPosition.BOTTOM with String = js.native
  /* "top" */ val TOP: typings.tableau.tableauNs.ToolbarPosition.TOP with String = js.native
  @JSBracketAccess
