...
object DataSource {
  ...
  inline def apply(getFields: () => js.Array[Field], getIsPrimary: () => Boolean, getName: () => String): DataSource = {
  ...
  extension [Self <: DataSource](x: Self) {
    ...
    inline def setGetFields(value: () => js.Array[Field]): Self = StObject.set(x, "getFields", js.Any.fromFunction0(value))
    
    inline def setGetIsPrimary(value: () => Boolean): Self = StObject.set(x, "getIsPrimary", js.Any.fromFunction0(value))
