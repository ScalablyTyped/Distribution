...
trait Twit extends js.Object {
  def get(path: java.lang.String): js.Promise[twitLib.twitMod.TwitNs.PromiseResponse] = js.native
  /**
       * @see https://github.com/ttezel/twit#tgetpath-params-callback
       */
  def get(path: java.lang.String, callback: twitLib.twitMod.TwitNs.Callback): scala.Unit = js.native
  def get(path: java.lang.String, params: twitLib.twitMod.TwitNs.Params): js.Promise[twitLib.twitMod.TwitNs.PromiseResponse] = js.native
  def get(
  ...
  def post(path: java.lang.String): js.Promise[twitLib.twitMod.TwitNs.PromiseResponse] = js.native
  /**
  ...
  def post(path: java.lang.String, params: twitLib.twitMod.TwitNs.Params): js.Promise[twitLib.twitMod.TwitNs.PromiseResponse] = js.native
  def post(
    path: java.lang.String,
    params: twitLib.twitMod.TwitNs.Params,
    callback: twitLib.twitMod.TwitNs.Callback
