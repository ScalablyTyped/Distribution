...
object queriesMod {
  ...
  @JSImport("@testing-library/dom/types/queries", JSImport.Namespace)
  @js.native
  ...
  type AllByBoundAttribute[T /* <: HTMLElement */] = js.Function3[
  ...
  type AllByRole[T /* <: HTMLElement */] = js.Function3[
    /* container */ HTMLElement, 
    /* role */ ByRoleMatcher, 
  ...
  type AllByText[T /* <: HTMLElement */] = js.Function3[
    /* container */ HTMLElement, 
    /* id */ Matcher, 
  ...
  trait ByRoleOptions
    ...
    /**
      ...
      */
    var current: js.UndefOr[Boolean | String] = js.undefined
    
    /**
      * Only considers elements with the specified accessible description.
      */
    var description: js.UndefOr[
        js.RegExp | String | (js.Function2[/* accessibleDescription */ String, /* element */ Element, Boolean])
      ] = js.undefined
    ...
    /**
      ...
      */
    var name: js.UndefOr[
        js.RegExp | String | (js.Function2[/* accessibleName */ String, /* element */ Element, Boolean])
      ] = js.undefined
  ...
  object ByRoleOptions {
    ...
    extension [Self <: ByRoleOptions](x: Self) {
      ...
      inline def setCurrent(value: Boolean | String): Self = StObject.set(x, "current", value.asInstanceOf[js.Any])
      
      inline def setCurrentUndefined: Self = StObject.set(x, "current", js.undefined)
      
      inline def setDescription(
        value: js.RegExp | String | (js.Function2[/* accessibleDescription */ String, /* element */ Element, Boolean])
      ): Self = StObject.set(x, "description", value.asInstanceOf[js.Any])
      
      inline def setDescriptionFunction2(value: (/* accessibleDescription */ String, /* element */ Element) => Boolean): Self = StObject.set(x, "description", js.Any.fromFunction2(value))
      ...
      inline def setName(
        value: js.RegExp | String | (js.Function2[/* accessibleName */ String, /* element */ Element, Boolean])
  ...
  type FindAllByBoundAttribute[T /* <: HTMLElement */] = js.Function4[
    /* container */ HTMLElement, 
    /* id */ Matcher, 
    /* options */ js.UndefOr[MatcherOptions], 
    /* waitForElementOptions */ js.UndefOr[waitForOptions], 
    js.Promise[js.Array[T]]
  ]
  
  type FindAllByRole_[T /* <: HTMLElement */] = js.Function4[
    /* container */ HTMLElement, 
    /* role */ ByRoleMatcher, 
    /* options */ js.UndefOr[ByRoleOptions], 
    /* waitForElementOptions */ js.UndefOr[waitForOptions], 
  ...
  type FindAllByText_[T /* <: HTMLElement */] = js.Function4[
    /* container */ HTMLElement, 
    /* id */ Matcher, 
    /* options */ js.UndefOr[SelectorMatcherOptions], 
    /* waitForElementOptions */ js.UndefOr[waitForOptions], 
  ...
  type FindByBoundAttribute[T /* <: HTMLElement */] = js.Function4[
    /* container */ HTMLElement, 
    /* id */ Matcher, 
    /* options */ js.UndefOr[MatcherOptions], 
    /* waitForElementOptions */ js.UndefOr[waitForOptions], 
  ...
  type FindByRole_[T /* <: HTMLElement */] = js.Function4[
    /* container */ HTMLElement, 
    /* role */ ByRoleMatcher, 
    /* options */ js.UndefOr[ByRoleOptions], 
    /* waitForElementOptions */ js.UndefOr[waitForOptions], 
  ...
  type FindByText_[T /* <: HTMLElement */] = js.Function4[
    /* container */ HTMLElement, 
    /* id */ Matcher, 
    /* options */ js.UndefOr[SelectorMatcherOptions], 
    /* waitForElementOptions */ js.UndefOr[waitForOptions], 
  ...
  type GetByBoundAttribute[T /* <: HTMLElement */] = js.Function3[
    /* container */ HTMLElement, 
    /* id */ Matcher, 
    /* options */ js.UndefOr[MatcherOptions], 
    T
  ...
  type GetByRole_[T /* <: HTMLElement */] = js.Function3[
    /* container */ HTMLElement, 
    /* role */ ByRoleMatcher, 
    /* options */ js.UndefOr[ByRoleOptions], 
    T
  ...
  type GetByText_[T /* <: HTMLElement */] = js.Function3[
    /* container */ HTMLElement, 
    /* id */ Matcher, 
    /* options */ js.UndefOr[SelectorMatcherOptions], 
    T
  ...
  type QueryByBoundAttribute[T /* <: HTMLElement */] = js.Function3[
    /* container */ HTMLElement, 
    /* id */ Matcher, 
    /* options */ js.UndefOr[MatcherOptions], 
    T | Null
  ...
  type QueryByRole_[T /* <: HTMLElement */] = js.Function3[
    /* container */ HTMLElement, 
    /* role */ ByRoleMatcher, 
    /* options */ js.UndefOr[ByRoleOptions], 
    T | Null
  ...
  type QueryByText_[T /* <: HTMLElement */] = js.Function3[
    /* container */ HTMLElement, 
    /* id */ Matcher, 
    /* options */ js.UndefOr[SelectorMatcherOptions], 
    T | Null
