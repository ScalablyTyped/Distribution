...
import typings.prettyFormat.mod.PrettyFormatOptions
...
object typesPrettyDomMod {
  ...
  object prettyFormat {
    ...
    object DEFAULT_OPTIONS {
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.callToJSON")
      @js.native
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.compareKeys")
      @js.native
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.escapeRegex")
      @js.native
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.escapeString")
      @js.native
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.highlight")
      @js.native
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.indent")
      @js.native
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.maxDepth")
      @js.native
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.maxWidth")
      @js.native
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.min")
      @js.native
      def min: `false` = js.native
      inline def min_=(x: `false`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("min")(x.asInstanceOf[js.Any])
      
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.plugins")
      @js.native
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.printBasicPrototype")
      @js.native
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.printFunctionName")
      @js.native
      ...
      @JSImport("@testing-library/dom/types/pretty-dom", "prettyFormat.DEFAULT_OPTIONS.theme")
      @js.native
  ...
  trait PrettyDOMOptions
    extends StObject
       with PrettyFormatOptions {
    
    /**
      * Given a `Node` return `false` if you wish to ignore that node in the output.
      * By default, ignores `<style />`, `<script />` and comment nodes.
      */
    var filterNode: js.UndefOr[js.Function1[/* node */ Node, Boolean]] = js.undefined
  }
  object PrettyDOMOptions {
    
    inline def apply(): PrettyDOMOptions = {
    ...
    extension [Self <: PrettyDOMOptions](x: Self) {
      ...
      inline def setFilterNodeUndefined: Self = StObject.set(x, "filterNode", js.undefined)
    }
  }
}
