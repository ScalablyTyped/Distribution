...
object default extends js.Object {
  val ActionContext: Instantiable1[/* e */ js.Any, typings.tokenizr.tokenizrMod.ActionContext] = js.native
  val ParsingError: Instantiable5[
    ...
    /* column */ Double, 
    /* input */ String, 
    typings.tokenizr.tokenizrMod.ParsingError
  ] = js.native
  val Token: Instantiable6[
    ...
    typings.tokenizr.tokenizrMod.Token[js.Object]
  ] = js.native
}
