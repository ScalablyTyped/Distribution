...
import typings.themeUiCore.distDeclarationsSrcTypesMod.SxProp
...
object distDeclarationsSrcMod {
  ...
  object jsx {
    ...
    inline def apply[P /* <: HTMLAttributes[T] */, T /* <: HTMLElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 118, starting with typings.themeUiCore.themeUiCoreStrings.a, typings.themeUiCore.themeUiCoreStrings.abbr, typings.themeUiCore.themeUiCoreStrings.address */ Any,
    ...
    object JSX {
      ...
      trait IntrinsicElements extends StObject {
        ...
        var center: (DetailedHTMLProps[HTMLAttributes[HTMLElement], HTMLElement]) & SxProp
        ...
        var line: SVGLineElementAttributes[SVGLineElement] & SxProp
        ...
        var search: (DetailedHTMLProps[HTMLAttributes[HTMLElement], HTMLElement]) & SxProp
        ...
        var text: SVGTextElementAttributes[SVGTextElement] & SxProp
      ...
      object IntrinsicElements {
        ...
        inline def apply(
          ...
          center: (DetailedHTMLProps[HTMLAttributes[HTMLElement], HTMLElement]) & SxProp,
          ...
          line: SVGLineElementAttributes[SVGLineElement] & SxProp,
          ...
          search: (DetailedHTMLProps[HTMLAttributes[HTMLElement], HTMLElement]) & SxProp,
          ...
          text: SVGTextElementAttributes[SVGTextElement] & SxProp,
        ...
        implicit open class MutableBuilder[Self <: IntrinsicElements] (val x: Self) extends AnyVal {
          ...
          inline def setCenter(value: (DetailedHTMLProps[HTMLAttributes[HTMLElement], HTMLElement]) & SxProp): Self = StObject.set(x, "center", value.asInstanceOf[js.Any])
          ...
          inline def setLine(value: SVGLineElementAttributes[SVGLineElement] & SxProp): Self = StObject.set(x, "line", value.asInstanceOf[js.Any])
          ...
          inline def setSearch(value: (DetailedHTMLProps[HTMLAttributes[HTMLElement], HTMLElement]) & SxProp): Self = StObject.set(x, "search", value.asInstanceOf[js.Any])
          ...
          inline def setText(value: SVGTextElementAttributes[SVGTextElement] & SxProp): Self = StObject.set(x, "text", value.asInstanceOf[js.Any])
