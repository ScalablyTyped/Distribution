...
import typings.themeUiCore.typesMod.SxProp
...
object jsxNamespaceMod {
  ...
  object ThemeUIJSX {
    ...
    /* Inlined {[ K in keyof @theme-ui/core.@theme-ui/core/dist/declarations/src/jsx-namespace.ReactJSXIntrinsicElements ]: @theme-ui/core.@theme-ui/core/dist/declarations/src/jsx-namespace.ReactJSXIntrinsicElements[K] & @theme-ui/core.@theme-ui/core/dist/declarations/src/types.SxProp} */
    ...
    object IntrinsicElements {
      ...
      inline def apply(
      ...
      ): typings.themeUiCore.jsxNamespaceMod.ThemeUIJSX.IntrinsicElements = {
        ...
        __obj.asInstanceOf[typings.themeUiCore.jsxNamespaceMod.ThemeUIJSX.IntrinsicElements]
      }
      
      extension [Self <: typings.themeUiCore.jsxNamespaceMod.ThemeUIJSX.IntrinsicElements](x: Self) {
  ...
  type WithConditionalSxProp[P] = P | (P & SxProp)
}
