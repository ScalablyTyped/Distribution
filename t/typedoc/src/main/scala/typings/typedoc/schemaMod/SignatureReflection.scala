...
trait SignatureReflection
  ...
  var parameters: ToSerialized[js.UndefOr[js.Array[typings.typedoc.parameterMod.ParameterReflection]]]
  
  var `type`: ToSerialized[js.UndefOr[typings.typedoc.modelsTypesMod.SomeType]]
  
  var typeParameter: js.UndefOr[
    ModelToObject[js.UndefOr[js.Array[typings.typedoc.typeParameterMod.TypeParameterReflection]]]
  ] = js.undefined
}
object SignatureReflection {
  ...
  extension [Self <: SignatureReflection](x: Self) {
    ...
    inline def setParameters(value: ToSerialized[js.UndefOr[js.Array[typings.typedoc.parameterMod.ParameterReflection]]]): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setParametersUndefined: Self = StObject.set(x, "parameters", js.undefined)
    
    inline def setParametersVarargs(value: (typings.typedoc.parameterMod.ParameterReflection | _ModelToObject[Any])*): Self = StObject.set(x, "parameters", js.Array(value*))
    ...
    inline def setTypeParameter(
      value: ModelToObject[js.UndefOr[js.Array[typings.typedoc.typeParameterMod.TypeParameterReflection]]]
    ...
    inline def setTypeParameterVarargs(value: (typings.typedoc.typeParameterMod.TypeParameterReflection | _ModelToObject[Any])*): Self = StObject.set(x, "typeParameter", js.Array(value*))
