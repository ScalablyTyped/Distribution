...
trait ReferenceType extends StObject {
  ...
  var typeArguments: ToSerialized[js.UndefOr[js.Array[typings.typedoc.modelsTypesMod.SomeType]]]
}
object ReferenceType {
  ...
  extension [Self <: ReferenceType](x: Self) {
    ...
    inline def setExternalUrlVarargs(value: _ModelToObject[Any]*): Self = StObject.set(x, "externalUrl", js.Array(value*))
    ...
    inline def setTypeArguments(value: ToSerialized[js.UndefOr[js.Array[typings.typedoc.modelsTypesMod.SomeType]]]): Self = StObject.set(x, "typeArguments", value.asInstanceOf[js.Any])
    
    inline def setTypeArgumentsUndefined: Self = StObject.set(x, "typeArguments", js.undefined)
    
    inline def setTypeArgumentsVarargs(value: (typings.typedoc.modelsTypesMod.SomeType | _ModelToObject[Any])*): Self = StObject.set(x, "typeArguments", js.Array(value*))
    ...
    inline def set_packageVarargs(value: _ModelToObject[Any]*): Self = StObject.set(x, "package", js.Array(value*))
  }
}
