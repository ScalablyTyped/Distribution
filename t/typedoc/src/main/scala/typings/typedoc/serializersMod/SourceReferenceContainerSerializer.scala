...
@JSImport("typedoc/dist/lib/serialization/serializers", "SourceReferenceContainerSerializer")
@js.native
class SourceReferenceContainerSerializer protected ()
  extends typings.typedoc.serializersSourcesMod.SourceReferenceContainerSerializer {
...
object SourceReferenceContainerSerializer {
  ...
  @JSImport("typedoc/dist/lib/serialization/serializers", "SourceReferenceContainerSerializer.PRIORITY")
  @js.native
