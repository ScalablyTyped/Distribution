...
trait TypeDocOptionMap extends StObject {
  ...
  var navigationLinks: ManuallyValidatedOption[Record[String, String]]
  ...
  var sidebarLinks: ManuallyValidatedOption[Record[String, String]]
  
  var skipErrorChecking: Boolean
  
  var sort: js.Array[SortStrategy]
  
  var sourceLinkTemplate: String
...
object TypeDocOptionMap {
  ...
  extension [Self <: TypeDocOptionMap](x: Self) {
    ...
    inline def setNavigationLinks(value: ManuallyValidatedOption[Record[String, String]]): Self = StObject.set(x, "navigationLinks", value.asInstanceOf[js.Any])
    ...
    inline def setSidebarLinks(value: ManuallyValidatedOption[Record[String, String]]): Self = StObject.set(x, "sidebarLinks", value.asInstanceOf[js.Any])
    ...
    inline def setSourceLinkTemplate(value: String): Self = StObject.set(x, "sourceLinkTemplate", value.asInstanceOf[js.Any])
