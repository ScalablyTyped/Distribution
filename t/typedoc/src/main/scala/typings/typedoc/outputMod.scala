...
object outputMod {
  ...
  open class DefaultThemeRenderContext protected ()
    extends typings.typedoc.defaultThemeRenderContextMod.DefaultThemeRenderContext {
    def this(theme: typings.typedoc.defaultThemeMod.DefaultTheme, options: Options) = this()
  }
  
  @JSImport("typedoc/dist/lib/output", "IndexEvent")
  @js.native
  open class IndexEvent protected ()
    extends typings.typedoc.eventsMod.IndexEvent {
  ...
  open class MarkdownEvent protected ()
    extends typings.typedoc.eventsMod.MarkdownEvent {
  ...
  open class PageEvent[Model] protected ()
    extends typings.typedoc.eventsMod.PageEvent[Model] {
    /**
  ...
  open class RendererEvent protected ()
    extends typings.typedoc.eventsMod.RendererEvent {
  ...
  @JSImport("typedoc/dist/lib/output", "Theme")
  @js.native
  abstract class Theme protected ()
    extends typings.typedoc.themeMod.Theme {
    /**
  ...
  open class UrlMapping[Model] protected ()
    extends typings.typedoc.urlMappingMod.UrlMapping[Model] {
