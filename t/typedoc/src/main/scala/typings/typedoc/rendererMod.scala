...
import typings.typedoc.libUtilsMod.EventHooks
...
object rendererMod {
  ...
  open class Renderer protected () extends ChildableComponent[Application, RendererComponent] {
    ...
    /**
      ...
      * @param theme
      */
    def defineTheme(name: String, theme: Instantiable1[/* renderer */ Renderer, typings.typedoc.themeMod.Theme]): Unit = js.native
    ...
    /**
      ...
      */
    var theme: js.UndefOr[typings.typedoc.themeMod.Theme] = js.native
