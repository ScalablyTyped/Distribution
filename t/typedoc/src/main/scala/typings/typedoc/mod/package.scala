...
package object mod {
  ...
  def BindOption(name: typings.typedoc.libUtilsMod.NeverIfInternal[java.lang.String]): js.Function2[
    ...
    scala.Unit
  ] = typings.typedoc.mod.^.asInstanceOf[js.Dynamic].applyDynamic("BindOption")(name.asInstanceOf[js.Any]).asInstanceOf[js.Function2[
    /* target */ typings.typedoc.anon.Application | typings.typedoc.anon.Options, 
    /* key */ typings.std.PropertyKey, 
    scala.Unit
  ]]
  ...
  def BindOption_categorizeByGroup(name: typings.typedoc.typedocStrings.categorizeByGroup): js.Function2[
    /* target */ (typings.typedoc.anon.Application | typings.typedoc.anon.Options) with typings.typedoc.typedocStrings.BindOption with org.scalablytyped.runtime.TopLevel[js.Any], 
    /* key */ typings.std.PropertyKey, 
    scala.Unit
  ] = typings.typedoc.mod.^.asInstanceOf[js.Dynamic].applyDynamic("BindOption")(name.asInstanceOf[js.Any]).asInstanceOf[js.Function2[
    /* target */ (typings.typedoc.anon.Application | typings.typedoc.anon.Options) with typings.typedoc.typedocStrings.BindOption with org.scalablytyped.runtime.TopLevel[js.Any], 
