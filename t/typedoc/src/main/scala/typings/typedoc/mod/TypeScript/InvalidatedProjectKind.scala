...
@JSImport("typedoc", "TypeScript.InvalidatedProjectKind")
@js.native
object InvalidatedProjectKind extends js.Object {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.typescript.mod.InvalidatedProjectKind with Double] = js.native
