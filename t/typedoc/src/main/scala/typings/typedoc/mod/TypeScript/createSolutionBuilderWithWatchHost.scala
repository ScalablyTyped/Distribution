...
object createSolutionBuilderWithWatchHost extends js.Object {
  ...
  def apply[T /* <: BuilderProgram */](system: js.UndefOr[scala.Nothing], createProgram: CreateProgram_[T]): SolutionBuilderWithWatchHost[T] = js.native
  def apply[T /* <: BuilderProgram */](
    system: js.UndefOr[scala.Nothing],
  ...
  def apply[T /* <: BuilderProgram */](system: System, createProgram: js.UndefOr[scala.Nothing], reportDiagnostic: DiagnosticReporter): SolutionBuilderWithWatchHost[T] = js.native
  def apply[T /* <: BuilderProgram */](
    system: System,
    createProgram: js.UndefOr[scala.Nothing],
    reportDiagnostic: DiagnosticReporter,
