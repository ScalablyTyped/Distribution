...
@JSImport("typedoc", "TypeScript.TypeFlags")
@js.native
object TypeFlags extends js.Object {
  ...
  /* 63176704 */ val Instantiable: typings.typescript.mod.TypeFlags.Instantiable with Double = js.native
  /* 58982400 */ val InstantiableNonPrimitive: typings.typescript.mod.TypeFlags.InstantiableNonPrimitive with Double = js.native
  /* 4194304 */ val InstantiablePrimitive: typings.typescript.mod.TypeFlags.InstantiablePrimitive with Double = js.native
  ...
  /* 133970943 */ val Narrowable: typings.typescript.mod.TypeFlags.Narrowable with Double = js.native
  ...
  /* 67637251 */ val NotUnionOrUnit: typings.typescript.mod.TypeFlags.NotUnionOrUnit with Double = js.native
  ...
  /* 132 */ val StringLike: typings.typescript.mod.TypeFlags.StringLike with Double = js.native
  ...
  /* 66846720 */ val StructuredOrInstantiable: typings.typescript.mod.TypeFlags.StructuredOrInstantiable with Double = js.native
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.typescript.mod.TypeFlags with Double] = js.native
}
