...
object distLibUtilsOptionsReadersArgumentsMod {
  ...
  open class ArgumentsReader protected ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def read(container: typings.typedoc.distLibUtilsOptionsOptionsMod.Options, logger: Logger): Unit = js.native
  }
}
