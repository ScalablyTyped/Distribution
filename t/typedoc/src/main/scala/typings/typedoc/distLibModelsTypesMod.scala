...
object distLibModelsTypesMod {
  ...
  open class IntrinsicType protected ()
    ...
    def toObject(): typings.typedoc.distLibSerializationSchemaMod.IntrinsicType = js.native
  ...
  open class LiteralType ()
    ...
    def toObject(): typings.typedoc.distLibSerializationSchemaMod.LiteralType = js.native
  ...
  open class Type () extends StObject {
    ...
    def toObject(serializer: Serializer): typings.typedoc.distLibSerializationSchemaMod.SomeType = js.native
  ...
  */
  ...
  open class UnknownType protected ()
    ...
    def toObject(): typings.typedoc.distLibSerializationSchemaMod.UnknownType = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.typedoc.distLibModelsTypesMod.LiteralType
    - typings.typedoc.distLibModelsTypesMod.NamedTupleMember
    - typings.typedoc.distLibModelsTypesMod.UnionType
    - typings.typedoc.distLibModelsTypesMod.ReferenceType
    - typings.typedoc.distLibModelsTypesMod.IndexedAccessType
    - typings.typedoc.distLibModelsTypesMod.IntersectionType
    - typings.typedoc.distLibModelsTypesMod.ArrayType
    - typings.typedoc.distLibModelsTypesMod.TemplateLiteralType
    - typings.typedoc.distLibModelsTypesMod.PredicateType
    - typings.typedoc.distLibModelsTypesMod.TypeOperatorType
    - typings.typedoc.distLibModelsTypesMod.InferredType
    - typings.typedoc.distLibModelsTypesMod.TupleType
    - typings.typedoc.distLibModelsTypesMod.RestType
    - typings.typedoc.distLibModelsTypesMod.QueryType
    - typings.typedoc.distLibModelsTypesMod.IntrinsicType
    - typings.typedoc.distLibModelsTypesMod.ReflectionType
    - typings.typedoc.distLibModelsTypesMod.UnknownType
    - typings.typedoc.distLibModelsTypesMod.MappedType
    - typings.typedoc.distLibModelsTypesMod.OptionalType
    - typings.typedoc.distLibModelsTypesMod.ConditionalType
  */
