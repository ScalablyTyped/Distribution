...
object PartialProjectReflection {
  ...
  inline def apply(): PartialProjectReflection = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialProjectReflection]
  }
  
  extension [Self <: PartialProjectReflection](x: Self) {
    ...
    inline def setGroups(value: ModelToObject[js.UndefOr[js.Array[ReflectionGroup]]] | js.Array[ReflectionGroup]): Self = StObject.set(x, "groups", value.asInstanceOf[js.Any])
    
    inline def setGroupsUndefined: Self = StObject.set(x, "groups", js.undefined)
    
    inline def setGroupsVarargs(value: (ReflectionGroup | _ModelToObject[js.Any])*): Self = StObject.set(x, "groups", js.Array(value :_*))
