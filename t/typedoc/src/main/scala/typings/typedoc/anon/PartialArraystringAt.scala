...
trait PartialArraystringAt extends StObject {
  ...
  var toLocaleString_FPartialArraystringAt: js.UndefOr[js.Function0[String]] = js.undefined
  
  @JSName("toString")
  var toString_FPartialArraystringAt: js.UndefOr[js.Function0[String]] = js.undefined
...
object PartialArraystringAt {
  
  inline def apply(): PartialArraystringAt = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialArraystringAt]
  }
  
  extension [Self <: PartialArraystringAt](x: Self) {
    ...
    inline def setCopyWithin(value: (/* target */ Double, /* start */ Double) => PartialArraystringAt): Self = StObject.set(x, "copyWithin", js.Any.fromFunction2(value))
    ...
    inline def setFill(value: /* value */ String => PartialArraystringAt): Self = StObject.set(x, "fill", js.Any.fromFunction1(value))
    ...
    inline def setSort(value: () => PartialArraystringAt): Self = StObject.set(x, "sort", js.Any.fromFunction0(value))
