...
/* Inlined typedoc.typedoc/dist/lib/utils/options/declaration.MixedDeclarationOption & {validate (value : unknown): void} */
@js.native
trait MixedDeclarationOptionval
  extends StObject
