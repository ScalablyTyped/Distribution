...
trait JsxHtmlGlobalProps
  extends StObject
     with /* data */ StringDictionary[String] {
  
  var accessKey: js.UndefOr[String] = js.undefined
  
  var autocapitalize: js.UndefOr[String] = js.undefined
  
  var children: js.UndefOr[JsxChildren] = js.undefined
  ...
  var itemScope: js.UndefOr[String] = js.undefined
...
object JsxHtmlGlobalProps {
  
  inline def apply(): JsxHtmlGlobalProps = {
  ...
  extension [Self <: JsxHtmlGlobalProps](x: Self) {
    ...
    inline def setChildren(value: JsxChildren): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
    ...
    inline def setItemScope(value: String): Self = StObject.set(x, "itemScope", value.asInstanceOf[js.Any])
