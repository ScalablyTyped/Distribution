...
object distLibUtilsComponentMod {
  
  @JSImport("typedoc/dist/lib/utils/component", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("typedoc/dist/lib/utils/component", "AbstractComponent")
  @js.native
  ...
  /* note: abstract class */ @JSImport("typedoc/dist/lib/utils/component", "ChildableComponent")
  @js.native
  open class ChildableComponent[O /* <: ComponentHost */, C /* <: Component */] protected () extends AbstractComponent[O] {
    /**
      * Create new Component instance.
      */
    def this(owner: O) = this()
