...
import typings.typedoc.optionsDeclarationMod.ParameterType.Path
...
trait StringDeclarationOption
  ...
  /**
    ...
    */
  @JSName("type")
  var type_StringDeclarationOption: js.UndefOr[typings.typedoc.optionsDeclarationMod.ParameterType.String | Path] = js.undefined
...
object StringDeclarationOption {
  ...
  extension [Self <: StringDeclarationOption](x: Self) {
    ...
    inline def setType(value: typings.typedoc.optionsDeclarationMod.ParameterType.String | Path): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
