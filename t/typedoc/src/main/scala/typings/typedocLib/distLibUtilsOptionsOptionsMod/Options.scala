...
class Options ()
  ...
  def getDeclaration(name: java.lang.String): typedocLib.distLibUtilsOptionsDeclarationMod.OptionDeclaration = js.native
  ...
  def setValue(name: java.lang.String, value: js.Any, errorCallback: js.Function): scala.Unit = js.native
  ...
  def setValues(obj: js.Object, prefix: java.lang.String, errorCallback: js.Function): scala.Unit = js.native
}
