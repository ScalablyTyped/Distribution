...
class Context protected () extends js.Object {
  ...
  var inheritParent: typescriptLib.typescriptMod.tsNs.Node = js.native
  var inherited: js.Array[java.lang.String] = js.native
  var inheritedChildren: js.Array[scala.Double] = js.native
  var isDeclaration: scala.Boolean = js.native
  var isExternal: scala.Boolean = js.native
  var isInherit: scala.Boolean = js.native
  ...
  var typeArguments: js.Array[typedocLib.distLibModelsMod.Type] = js.native
  var typeParameters: typescriptLib.typescriptMod.tsNs.MapLike[typedocLib.distLibModelsMod.Type] = js.native
  ...
  def getSymbolID(symbol: typescriptLib.typescriptMod.tsNs.Symbol): scala.Double = js.native
  def getTypeAtLocation(node: typescriptLib.typescriptMod.tsNs.Node): typescriptLib.typescriptMod.tsNs.Type = js.native
  ...
  def withScope(scope: typedocLib.distLibModelsMod.Reflection, callback: js.Function): scala.Unit = js.native
  def withScope(
