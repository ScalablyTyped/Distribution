...
abstract class ContextAwareRendererComponent () extends RendererComponent {
  ...
  var project: typedocLib.distLibModelsReflectionsMod.ProjectReflection = js.native
  var reflection: typedocLib.distLibModelsReflectionsMod.DeclarationReflection = js.native
