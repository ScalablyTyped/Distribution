...
class Comment () extends js.Object {
  ...
  var returns: js.UndefOr[java.lang.String] = js.native
  var shortText: java.lang.String = js.native
  var tags: js.UndefOr[js.Array[typedocLib.distLibModelsCommentsTagMod.CommentTag]] = js.native
  var text: java.lang.String = js.native
  def copyFrom(comment: Comment): scala.Unit = js.native
  def getTag(tagName: java.lang.String): js.UndefOr[typedocLib.distLibModelsCommentsTagMod.CommentTag] = js.native
  def getTag(tagName: java.lang.String, paramName: java.lang.String): js.UndefOr[typedocLib.distLibModelsCommentsTagMod.CommentTag] = js.native
