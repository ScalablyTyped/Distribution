...
@js.native
abstract class ConverterNodeComponent[T /* <: typescriptLib.typescriptMod.Node */] () extends ConverterComponent {
  var supports: js.Array[typescriptLib.typescriptMod.SyntaxKind] = js.native
