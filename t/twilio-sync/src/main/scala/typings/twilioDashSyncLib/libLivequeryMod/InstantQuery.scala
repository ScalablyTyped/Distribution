...
class InstantQuery protected ()
  ...
  /**
    ...
    * @public
    */
  def search(queryExpression: java.lang.String): js.Promise[scala.Unit] = js.native
  /**
  ...
  /**
    ...
    * @public
    */
  def updateIndexName(indexName: java.lang.String): scala.Unit = js.native
}
