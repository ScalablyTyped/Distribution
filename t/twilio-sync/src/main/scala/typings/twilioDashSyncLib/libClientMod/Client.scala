...
class Client protected ()
  ...
  /**
    ...
    *   });
    */
  def document(): js.Promise[twilioDashSyncLib.libSyncdocumentMod.SyncDocument] = js.native
  def document(arg: java.lang.String): js.Promise[twilioDashSyncLib.libSyncdocumentMod.SyncDocument] = js.native
  def document(arg: OpenDocumentOptions): js.Promise[twilioDashSyncLib.libSyncdocumentMod.SyncDocument] = js.native
  /**
    ...
    *    });
    */
  def instantQuery(indexName: java.lang.String): js.Promise[twilioDashSyncLib.libLivequeryMod.InstantQuery] = js.native
  /**
    ...
    *   });
    */
  def list(): js.Promise[twilioDashSyncLib.libSynclistMod.SyncList] = js.native
  def list(arg: java.lang.String): js.Promise[twilioDashSyncLib.libSynclistMod.SyncList] = js.native
  def list(arg: OpenListOptions): js.Promise[twilioDashSyncLib.libSynclistMod.SyncList] = js.native
  /**
    ...
    *     });
    */
  def liveQuery(indexName: java.lang.String, queryExpression: java.lang.String): js.Promise[twilioDashSyncLib.libLivequeryMod.LiveQuery] = js.native
  /**
    ...
    *   });
    */
  def map(): js.Promise[twilioDashSyncLib.libSyncmapMod.SyncMap] = js.native
  def map(arg: java.lang.String): js.Promise[twilioDashSyncLib.libSyncmapMod.SyncMap] = js.native
  def map(arg: OpenMapOptions): js.Promise[twilioDashSyncLib.libSyncmapMod.SyncMap] = js.native
  /**
  ...
  /**
    ...
    *   });
    */
  def stream(): js.Promise[twilioDashSyncLib.libStreamsSyncstreamMod.SyncStream] = js.native
  def stream(arg: java.lang.String): js.Promise[twilioDashSyncLib.libStreamsSyncstreamMod.SyncStream] = js.native
  def stream(arg: OpenStreamOptions): js.Promise[twilioDashSyncLib.libStreamsSyncstreamMod.SyncStream] = js.native
  /**
