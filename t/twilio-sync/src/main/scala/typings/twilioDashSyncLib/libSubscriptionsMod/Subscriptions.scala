...
class Subscriptions protected () extends js.Object {
  ...
  /**
    ...
    * @return undefined
    */
  def acceptMessage(message: js.Any, isStrictlyOrdered: scala.Boolean): scala.Unit = js.native
  /**
    ...
    * @return undefined
    */
  def add(sid: java.lang.String, entity: twilioDashSyncLib.libEntityMod.SyncEntity): scala.Unit = js.native
  ...
  /**
    ...
    * @return undefined
    */
  def remove(sid: java.lang.String): scala.Unit = js.native
  /**
