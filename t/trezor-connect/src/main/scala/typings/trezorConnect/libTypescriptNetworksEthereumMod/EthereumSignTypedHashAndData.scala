...
object EthereumSignTypedHashAndData {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EthereumSignTypedHashAndData[?], T /* <: EthereumSignTypedDataTypes */] (val x: Self & EthereumSignTypedHashAndData[T]) extends AnyVal {
