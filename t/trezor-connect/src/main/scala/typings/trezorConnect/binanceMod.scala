...
import typings.trezorConnect.protobufMod.BinanceCancelMsg
import typings.trezorConnect.protobufMod.BinanceInputOutput
import typings.trezorConnect.protobufMod.BinanceOrderMsg
...
import typings.trezorConnect.protobufMod.BinanceTransferMsg
