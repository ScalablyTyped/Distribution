...
/* Inlined trezor-connect.trezor-connect/lib/typescript/trezor/protobuf.CommonTxInputType & {  address_n :std.Array<number>,   script_type :trezor-connect.trezor-connect/lib/typescript/trezor/protobuf.InternalInputScriptType | undefined} */
trait CommonTxInputTypeaddressn
  extends StObject
     with TxInputType {
  ...
  var script_type: js.UndefOr[InternalInputScriptType] = js.undefined
...
object CommonTxInputTypeaddressn {
  
  inline def apply(address_n: js.Array[Double], amount: UintType, prev_hash: String, prev_index: Double): CommonTxInputTypeaddressn = {
    ...
    __obj.asInstanceOf[CommonTxInputTypeaddressn]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommonTxInputTypeaddressn] (val x: Self) extends AnyVal {
    ...
    inline def setScript_type(value: InternalInputScriptType): Self = StObject.set(x, "script_type", value.asInstanceOf[js.Any])
