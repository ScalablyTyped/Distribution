...
object TezosContractType extends StObject {
  ...
  /* 0 */ val Implicit: typings.trezorConnect.libTypescriptTrezorProtobufMod.TezosContractType.Implicit & Double = js.native
  
  @js.native
  sealed trait Originated
    extends StObject
       with TezosContractType
  /* 1 */ val Originated: typings.trezorConnect.libTypescriptTrezorProtobufMod.TezosContractType.Originated & Double = js.native
}
