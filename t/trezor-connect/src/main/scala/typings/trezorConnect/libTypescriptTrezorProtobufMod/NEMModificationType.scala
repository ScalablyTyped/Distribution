...
object NEMModificationType extends StObject {
  ...
  /* 1 */ val CosignatoryModification_Add: typings.trezorConnect.libTypescriptTrezorProtobufMod.NEMModificationType.CosignatoryModification_Add & Double = js.native
  
  @js.native
  sealed trait CosignatoryModification_Delete
    extends StObject
       with NEMModificationType
  /* 2 */ val CosignatoryModification_Delete: typings.trezorConnect.libTypescriptTrezorProtobufMod.NEMModificationType.CosignatoryModification_Delete & Double = js.native
}
