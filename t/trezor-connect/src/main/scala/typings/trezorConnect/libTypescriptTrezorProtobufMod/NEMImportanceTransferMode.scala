...
object NEMImportanceTransferMode extends StObject {
  ...
  /* 1 */ val ImportanceTransfer_Activate: typings.trezorConnect.libTypescriptTrezorProtobufMod.NEMImportanceTransferMode.ImportanceTransfer_Activate & Double = js.native
  
  @js.native
  sealed trait ImportanceTransfer_Deactivate
    extends StObject
       with NEMImportanceTransferMode
  /* 2 */ val ImportanceTransfer_Deactivate: typings.trezorConnect.libTypescriptTrezorProtobufMod.NEMImportanceTransferMode.ImportanceTransfer_Deactivate & Double = js.native
}
