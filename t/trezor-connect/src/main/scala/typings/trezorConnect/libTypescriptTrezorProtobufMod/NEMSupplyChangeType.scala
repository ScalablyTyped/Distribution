...
object NEMSupplyChangeType extends StObject {
  ...
  /* 2 */ val SupplyChange_Decrease: typings.trezorConnect.libTypescriptTrezorProtobufMod.NEMSupplyChangeType.SupplyChange_Decrease & Double = js.native
  
  @js.native
  sealed trait SupplyChange_Increase
    extends StObject
       with NEMSupplyChangeType
  /* 1 */ val SupplyChange_Increase: typings.trezorConnect.libTypescriptTrezorProtobufMod.NEMSupplyChangeType.SupplyChange_Increase & Double = js.native
}
