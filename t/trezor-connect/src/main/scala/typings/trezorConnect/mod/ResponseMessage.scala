...
object ResponseMessage {
  ...
  @scala.inline
  def Error(payload: typings.trezorConnect.anon.Error): typings.trezorConnect.mod.Error = {
  ...
  @scala.inline
  def Success[T](id: Double, payload: T): typings.trezorConnect.mod.Success[T] = {
