...
import typings.trezorConnect.protobufMod.EosActionUnlinkAuth
import typings.trezorConnect.protobufMod.EosAuthorizationKey
import typings.trezorConnect.protobufMod.EosAuthorizationWait
