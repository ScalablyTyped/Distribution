...
trait CardanoCollateralInput extends StObject {
...
object CardanoCollateralInput {
  
  inline def apply(prev_hash: String, prev_index: Double): CardanoCollateralInput = {
    val __obj = js.Dynamic.literal(prev_hash = prev_hash.asInstanceOf[js.Any], prev_index = prev_index.asInstanceOf[js.Any])
    __obj.asInstanceOf[CardanoCollateralInput]
  }
  
  extension [Self <: CardanoCollateralInput](x: Self) {
