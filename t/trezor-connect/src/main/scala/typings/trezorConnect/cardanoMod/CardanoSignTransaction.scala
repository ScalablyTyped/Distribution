...
trait CardanoSignTransaction extends StObject {
  ...
  var signingMode: typings.trezorConnect.protobufMod.CardanoTxSigningMode
...
object CardanoSignTransaction {
  ...
  inline def apply(
    ...
    signingMode: typings.trezorConnect.protobufMod.CardanoTxSigningMode
  ...
  extension [Self <: CardanoSignTransaction](x: Self) {
    ...
    inline def setSigningMode(value: typings.trezorConnect.protobufMod.CardanoTxSigningMode): Self = StObject.set(x, "signingMode", value.asInstanceOf[js.Any])
