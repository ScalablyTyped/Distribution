...
trait CardanoAddressParameters extends StObject {
  ...
  var addressType: typings.trezorConnect.protobufMod.CardanoAddressType
...
object CardanoAddressParameters {
  ...
  inline def apply(addressType: typings.trezorConnect.protobufMod.CardanoAddressType): CardanoAddressParameters = {
  ...
  extension [Self <: CardanoAddressParameters](x: Self) {
    ...
    inline def setAddressType(value: typings.trezorConnect.protobufMod.CardanoAddressType): Self = StObject.set(x, "addressType", value.asInstanceOf[js.Any])
