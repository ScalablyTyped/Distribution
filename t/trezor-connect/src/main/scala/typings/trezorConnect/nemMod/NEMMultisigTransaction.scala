...
import typings.trezorConnect.trezorConnectNumbers.`0x0102`
import typings.trezorConnect.trezorConnectNumbers.`0x1002`
import typings.trezorConnect.trezorConnectNumbers.`0x1004`
