...
/* Rewritten from type alias, can be one of: 
  - typings.trezorConnect.nemMod.NEMRegularTransaction
  - typings.trezorConnect.nemMod.NEMMultisigTransaction
*/
...
object NEMTransaction {
  ...
  inline def NEMMultisigTransaction(
    ...
    __obj.asInstanceOf[typings.trezorConnect.nemMod.NEMMultisigTransaction]
  }
