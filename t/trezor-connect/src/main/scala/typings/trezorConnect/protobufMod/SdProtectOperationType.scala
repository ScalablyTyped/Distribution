...
object SdProtectOperationType extends StObject {
  ...
  /* 0 */ val DISABLE: typings.trezorConnect.protobufMod.SdProtectOperationType.DISABLE & Double = js.native
  
  @js.native
  sealed trait ENABLE
    extends StObject
       with SdProtectOperationType
  /* 1 */ val ENABLE: typings.trezorConnect.protobufMod.SdProtectOperationType.ENABLE & Double = js.native
  
  @js.native
  sealed trait REFRESH
    extends StObject
       with SdProtectOperationType
  /* 2 */ val REFRESH: typings.trezorConnect.protobufMod.SdProtectOperationType.REFRESH & Double = js.native
}
