...
object NEMMosaicLevy extends StObject {
  ...
  sealed trait MosaicLevy_Absolute
    extends StObject
       with NEMMosaicLevy
  /* 1 */ val MosaicLevy_Absolute: typings.trezorConnect.protobufMod.NEMMosaicLevy.MosaicLevy_Absolute & Double = js.native
  
  @js.native
  sealed trait MosaicLevy_Percentile
    extends StObject
       with NEMMosaicLevy
  /* 2 */ val MosaicLevy_Percentile: typings.trezorConnect.protobufMod.NEMMosaicLevy.MosaicLevy_Percentile & Double = js.native
}
