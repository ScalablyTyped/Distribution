...
object RecoveryDeviceType extends StObject {
  ...
  /* 1 */ val RecoveryDeviceType_Matrix: typings.trezorConnect.protobufMod.RecoveryDeviceType.RecoveryDeviceType_Matrix & Double = js.native
  
  @js.native
  sealed trait RecoveryDeviceType_ScrambledWords
    extends StObject
       with RecoveryDeviceType
  /* 0 */ val RecoveryDeviceType_ScrambledWords: typings.trezorConnect.protobufMod.RecoveryDeviceType.RecoveryDeviceType_ScrambledWords & Double = js.native
}
