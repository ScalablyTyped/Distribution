...
object deviceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.trezorConnect.deviceMod.KnownDevice
    - typings.trezorConnect.deviceMod.UnknownDevice
    - typings.trezorConnect.deviceMod.UnreadableDevice
  */
  ...
  object Device {
    ...
    inline def KnownDevice(
      ...
      __obj.asInstanceOf[typings.trezorConnect.deviceMod.KnownDevice]
    }
    ...
    inline def UnknownDevice(
      ...
      __obj.asInstanceOf[typings.trezorConnect.deviceMod.UnknownDevice]
    }
    ...
    inline def UnreadableDevice(
      ...
      __obj.asInstanceOf[typings.trezorConnect.deviceMod.UnreadableDevice]
    }
  }
