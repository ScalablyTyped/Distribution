...
trait CardanoGetNativeScriptHash extends StObject {
  ...
  var displayFormat: typings.trezorConnect.libTypescriptTrezorProtobufMod.CardanoNativeScriptHashDisplayFormat
...
object CardanoGetNativeScriptHash {
  ...
  inline def apply(
    displayFormat: typings.trezorConnect.libTypescriptTrezorProtobufMod.CardanoNativeScriptHashDisplayFormat,
  ...
  extension [Self <: CardanoGetNativeScriptHash](x: Self) {
    ...
    inline def setDisplayFormat(value: typings.trezorConnect.libTypescriptTrezorProtobufMod.CardanoNativeScriptHashDisplayFormat): Self = StObject.set(x, "displayFormat", value.asInstanceOf[js.Any])
