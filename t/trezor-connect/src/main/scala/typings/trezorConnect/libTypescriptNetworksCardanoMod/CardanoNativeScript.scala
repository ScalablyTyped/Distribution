...
trait CardanoNativeScript extends StObject {
  ...
  var `type`: typings.trezorConnect.libTypescriptTrezorProtobufMod.CardanoNativeScriptType
}
object CardanoNativeScript {
  
  inline def apply(`type`: typings.trezorConnect.libTypescriptTrezorProtobufMod.CardanoNativeScriptType): CardanoNativeScript = {
  ...
  extension [Self <: CardanoNativeScript](x: Self) {
    ...
    inline def setType(value: typings.trezorConnect.libTypescriptTrezorProtobufMod.CardanoNativeScriptType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
