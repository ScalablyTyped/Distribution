...
trait CardanoCertificate extends StObject {
  ...
  var `type`: typings.trezorConnect.libTypescriptTrezorProtobufMod.CardanoCertificateType
}
object CardanoCertificate {
  
  inline def apply(`type`: typings.trezorConnect.libTypescriptTrezorProtobufMod.CardanoCertificateType): CardanoCertificate = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CardanoCertificate] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.trezorConnect.libTypescriptTrezorProtobufMod.CardanoCertificateType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
