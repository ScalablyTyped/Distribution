...
- typings.trezorConnect.ethereumMod.EthereumSignTypedHash because var conflicts: path. Inlined domain_separator_hash, message_hash */ trait EthereumSignTypedHashAndData[T /* <: EthereumSignTypedDataTypes */]
  extends StObject
