...
trait WebViewEvents extends WidgetEvents {
  /**
    ...
    */
  var canGoBackChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[WebView, scala.Boolean], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the [*canGoForward*](#canGoForward) property has changed.
    * @param value The new value of [*canGoForward*](#canGoForward).
    */
  var canGoForwardChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[WebView, scala.Boolean], scala.Unit]
  ] = js.undefined
  /**
    ...
    */
  var download: js.UndefOr[js.Function1[/* event */ WebViewDownloadEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the [*html*](#html) property has changed.
    * @param value The new value of [*html*](#html).
    */
  var htmlChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[WebView, java.lang.String], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the url has been loaded.
    */
  var load: js.UndefOr[js.Function1[/* event */ EventObject[WebView], scala.Unit]] = js.undefined
  /**
    * Fired when a web message has been sent via `window.parent.postMessage(message, targetOrigin)` from
    * inside the `WebView`.
    */
  var message: js.UndefOr[js.Function1[/* event */ WebViewMessageEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the WebView is about to navigate to a new URL.
    */
  var navigate: js.UndefOr[js.Function1[/* event */ WebViewNavigateEvent, scala.Unit]] = js.undefined
  /**
...
object WebViewEvents {
  ...
  def apply(
    ...
    canGoBackChanged: /* event */ PropertyChangedEvent[WebView, scala.Boolean] => scala.Unit = null,
    canGoForwardChanged: /* event */ PropertyChangedEvent[WebView, scala.Boolean] => scala.Unit = null,
    ...
    download: /* event */ WebViewDownloadEvent => scala.Unit = null,
    ...
    htmlChanged: /* event */ PropertyChangedEvent[WebView, java.lang.String] => scala.Unit = null,
    ...
    load: /* event */ EventObject[WebView] => scala.Unit = null,
    longpress: /* event */ WidgetLongpressEvent => scala.Unit = null,
    message: /* event */ WebViewMessageEvent => scala.Unit = null,
    navigate: /* event */ WebViewNavigateEvent => scala.Unit = null,
    ...
    urlChanged: /* event */ PropertyChangedEvent[WebView, java.lang.String] => scala.Unit = null,
    ...
    if (canGoBackChanged != null) __obj.updateDynamic("canGoBackChanged")(js.Any.fromFunction1(canGoBackChanged))
    if (canGoForwardChanged != null) __obj.updateDynamic("canGoForwardChanged")(js.Any.fromFunction1(canGoForwardChanged))
    ...
    if (htmlChanged != null) __obj.updateDynamic("htmlChanged")(js.Any.fromFunction1(htmlChanged))
