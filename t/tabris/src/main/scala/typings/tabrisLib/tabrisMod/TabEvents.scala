...
trait TabEvents extends CompositeEvents {
  /**
    ...
    */
  var appear: js.UndefOr[js.Function1[/* event */ EventObject[Tab], scala.Unit]] = js.undefined
  /**
    * Fired when the [*badge*](#badge) property has changed.
    * @param value The new value of [*badge*](#badge).
    */
  var badgeChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[Tab, java.lang.String], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the tab is no longer visible, i.e. it no longer is the selection of its TabFolder.
    */
  var disappear: js.UndefOr[js.Function1[/* event */ EventObject[Tab], scala.Unit]] = js.undefined
  /**
...
object TabEvents {
  ...
  def apply(
    ...
    disappear: /* event */ EventObject[Tab] => scala.Unit = null,
    ...
    titleChanged: /* event */ PropertyChangedEvent[Tab, java.lang.String] => scala.Unit = null,
    ...
    if (badgeChanged != null) __obj.updateDynamic("badgeChanged")(js.Any.fromFunction1(badgeChanged))
    ...
    if (selectedImageChanged != null) __obj.updateDynamic("selectedImageChanged")(js.Any.fromFunction1(selectedImageChanged))
