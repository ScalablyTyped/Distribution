...
trait CheckBoxEvents extends WidgetEvents {
  ...
  var checkedChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[CheckBox, scala.Boolean], scala.Unit]
  ] = js.undefined
  /**
  ...
  var checkedTintColorChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[CheckBox, tabrisLib.Color], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the check box is checked or unchecked by the user.
    */
  var select: js.UndefOr[js.Function1[/* event */ CheckBoxSelectEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the [*text*](#text) property has changed.
    * @param value The new value of [*text*](#text).
    */
  var textChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[CheckBox, java.lang.String], scala.Unit]
  ] = js.undefined
  /**
...
object CheckBoxEvents {
  ...
  def apply(
    ...
    checkedChanged: /* event */ PropertyChangedEvent[CheckBox, scala.Boolean] => scala.Unit = null,
    checkedTintColorChanged: /* event */ PropertyChangedEvent[CheckBox, tabrisLib.Color] => scala.Unit = null,
    ...
    select: /* event */ CheckBoxSelectEvent => scala.Unit = null,
    ...
    textChanged: /* event */ PropertyChangedEvent[CheckBox, java.lang.String] => scala.Unit = null,
    textColorChanged: /* event */ PropertyChangedEvent[CheckBox, tabrisLib.Color] => scala.Unit = null,
    tintColorChanged: /* event */ PropertyChangedEvent[CheckBox, tabrisLib.Color] => scala.Unit = null,
