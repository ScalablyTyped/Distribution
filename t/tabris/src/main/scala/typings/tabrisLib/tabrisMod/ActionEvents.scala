...
trait ActionEvents extends WidgetEvents {
  /**
    * Fired when the [*image*](#image) property has changed.
    * @param value The new value of [*image*](#image).
    */
  var imageChanged: js.UndefOr[js.Function1[/* event */ PropertyChangedEvent[Action, Image], scala.Unit]] = js.undefined
  /**
    ...
    */
  var placementPriorityChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[Action, java.lang.String], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the action is invoked.
    */
  var select: js.UndefOr[js.Function1[/* event */ EventObject[Action], scala.Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var win_symbolChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[Action, java.lang.String], scala.Unit]
  ] = js.undefined
}
...
object ActionEvents {
  ...
  def apply(
    ...
    imageChanged: /* event */ PropertyChangedEvent[Action, Image] => scala.Unit = null,
    ...
    placementPriorityChanged: /* event */ PropertyChangedEvent[Action, java.lang.String] => scala.Unit = null,
    ...
    select: /* event */ EventObject[Action] => scala.Unit = null,
    ...
    titleChanged: /* event */ PropertyChangedEvent[Action, java.lang.String] => scala.Unit = null,
    ...
    win_symbolChanged: /* event */ PropertyChangedEvent[Action, java.lang.String] => scala.Unit = null,
    ...
    if (placementPriorityChanged != null) __obj.updateDynamic("placementPriorityChanged")(js.Any.fromFunction1(placementPriorityChanged))
    ...
    if (win_symbolChanged != null) __obj.updateDynamic("win_symbolChanged")(js.Any.fromFunction1(win_symbolChanged))
    if (win_themeChanged != null) __obj.updateDynamic("win_themeChanged")(js.Any.fromFunction1(win_themeChanged))
    __obj.asInstanceOf[ActionEvents]
  }
}
