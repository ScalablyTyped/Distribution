...
trait NavigationBarEvents extends WidgetEvents {
  /**
    * Fired when the [*background*](#background) property has changed.
    * @param value The new value of [*background*](#background).
    */
  @JSName("backgroundChanged")
  var backgroundChanged_NavigationBarEvents: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[NavigationBar, tabrisLib.Color], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the [*displayMode*](#displayMode) property has changed.
    * @param value The new value of [*displayMode*](#displayMode).
    */
  var displayModeChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[NavigationBar, java.lang.String], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the [*theme*](#theme) property has changed.
    * @param value The new value of [*theme*](#theme).
    */
  var themeChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[NavigationBar, java.lang.String], scala.Unit]
  ] = js.undefined
}

object NavigationBarEvents {
  @scala.inline
  def apply(
    backgroundChanged: /* event */ PropertyChangedEvent[NavigationBar, tabrisLib.Color] => scala.Unit = null,
    ...
    displayModeChanged: /* event */ PropertyChangedEvent[NavigationBar, java.lang.String] => scala.Unit = null,
    ...
    themeChanged: /* event */ PropertyChangedEvent[NavigationBar, java.lang.String] => scala.Unit = null,
    ...
    if (displayModeChanged != null) __obj.updateDynamic("displayModeChanged")(js.Any.fromFunction1(displayModeChanged))
    ...
    if (themeChanged != null) __obj.updateDynamic("themeChanged")(js.Any.fromFunction1(themeChanged))
    ...
    __obj.asInstanceOf[NavigationBarEvents]
  }
}
