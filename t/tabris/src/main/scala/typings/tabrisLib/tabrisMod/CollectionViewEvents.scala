...
trait CollectionViewEvents extends WidgetEvents {
  /**
    ...
    */
  var cellHeightChanged: js.UndefOr[
    js.Function1[
  ...
  /**
    ...
    */
  var cellTypeChanged: js.UndefOr[
    js.Function1[
      /* event */ PropertyChangedEvent[
        CollectionView, 
  ...
  /**
    ...
    */
  var columnCountChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[CollectionView, scala.Double], scala.Unit]
  ] = js.undefined
  /**
    ...
    */
  var firstVisibleIndexChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[CollectionView, scala.Double], scala.Unit]
  ] = js.undefined
  /**
    ...
    */
  var itemCountChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[CollectionView, scala.Double], scala.Unit]
  ] = js.undefined
  /**
    ...
    */
  var lastVisibleIndexChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[CollectionView, scala.Double], scala.Unit]
  ] = js.undefined
  /**
    ...
    */
  var refresh: js.UndefOr[js.Function1[/* event */ EventObject[CollectionView], scala.Unit]] = js.undefined
  /**
    ...
    */
  var refreshEnabledChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[CollectionView, scala.Boolean], scala.Unit]
  ] = js.undefined
  /**
    ...
    */
  var refreshIndicatorChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[CollectionView, scala.Boolean], scala.Unit]
  ] = js.undefined
  /**
    ...
    */
  var refreshMessageChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[CollectionView, java.lang.String], scala.Unit]
  ] = js.undefined
  /**
    * Fired while the collection view is scrolling.
    */
  var scroll: js.UndefOr[js.Function1[/* event */ CollectionViewScrollEvent, scala.Unit]] = js.undefined
  /**
    * Fired when a cell is selected.
    */
  var select: js.UndefOr[js.Function1[/* event */ CollectionViewSelectEvent, scala.Unit]] = js.undefined
}
...
object CollectionViewEvents {
  ...
  def apply(
    ...
    cellHeightChanged: /* event */ PropertyChangedEvent[
      CollectionView, 
      scala.Double | tabrisLib.tabrisLibStrings.auto | (js.Function2[
        /* index */ scala.Double, 
        /* cellType */ java.lang.String, 
    ...
    cellTypeChanged: /* event */ PropertyChangedEvent[
      CollectionView, 
      java.lang.String | (js.Function1[/* index */ scala.Double, java.lang.String]) | scala.Null
    ] => scala.Unit = null,
    ...
    columnCountChanged: /* event */ PropertyChangedEvent[CollectionView, scala.Double] => scala.Unit = null,
    ...
    firstVisibleIndexChanged: /* event */ PropertyChangedEvent[CollectionView, scala.Double] => scala.Unit = null,
    ...
    itemCountChanged: /* event */ PropertyChangedEvent[CollectionView, scala.Double] => scala.Unit = null,
    lastVisibleIndexChanged: /* event */ PropertyChangedEvent[CollectionView, scala.Double] => scala.Unit = null,
    ...
    refresh: /* event */ EventObject[CollectionView] => scala.Unit = null,
    refreshEnabledChanged: /* event */ PropertyChangedEvent[CollectionView, scala.Boolean] => scala.Unit = null,
    refreshIndicatorChanged: /* event */ PropertyChangedEvent[CollectionView, scala.Boolean] => scala.Unit = null,
    refreshMessageChanged: /* event */ PropertyChangedEvent[CollectionView, java.lang.String] => scala.Unit = null,
    ...
    scroll: /* event */ CollectionViewScrollEvent => scala.Unit = null,
    select: /* event */ CollectionViewSelectEvent => scala.Unit = null,
    ...
    if (cellHeightChanged != null) __obj.updateDynamic("cellHeightChanged")(js.Any.fromFunction1(cellHeightChanged))
    if (cellTypeChanged != null) __obj.updateDynamic("cellTypeChanged")(js.Any.fromFunction1(cellTypeChanged))
    ...
    if (columnCountChanged != null) __obj.updateDynamic("columnCountChanged")(js.Any.fromFunction1(columnCountChanged))
    ...
    if (firstVisibleIndexChanged != null) __obj.updateDynamic("firstVisibleIndexChanged")(js.Any.fromFunction1(firstVisibleIndexChanged))
    ...
    if (itemCountChanged != null) __obj.updateDynamic("itemCountChanged")(js.Any.fromFunction1(itemCountChanged))
    if (lastVisibleIndexChanged != null) __obj.updateDynamic("lastVisibleIndexChanged")(js.Any.fromFunction1(lastVisibleIndexChanged))
    ...
    if (refreshEnabledChanged != null) __obj.updateDynamic("refreshEnabledChanged")(js.Any.fromFunction1(refreshEnabledChanged))
    if (refreshIndicatorChanged != null) __obj.updateDynamic("refreshIndicatorChanged")(js.Any.fromFunction1(refreshIndicatorChanged))
    if (refreshMessageChanged != null) __obj.updateDynamic("refreshMessageChanged")(js.Any.fromFunction1(refreshMessageChanged))
