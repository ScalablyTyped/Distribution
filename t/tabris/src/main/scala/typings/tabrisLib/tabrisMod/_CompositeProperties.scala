...
// Composite
trait _CompositeProperties extends _WidgetProperties {
  /**
    * Additional space to add inside the widget's bounds. If set to a number, this padding will be applied
    * on all four sides.
    */
  var padding: BoxDimensions | scala.Double
}

object _CompositeProperties {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[_CompositeProperties]
  }
}
