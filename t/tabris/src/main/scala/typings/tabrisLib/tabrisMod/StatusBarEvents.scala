...
trait StatusBarEvents extends WidgetEvents {
  ...
  var backgroundChanged_StatusBarEvents: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[StatusBar, tabrisLib.Color], scala.Unit]
  ] = js.undefined
  /**
  ...
  var displayModeChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[StatusBar, java.lang.String], scala.Unit]
  ] = js.undefined
  /**
    * Fired when status bar is tapped.
    */
  @JSName("tap")
  var tap_StatusBarEvents: js.UndefOr[js.Function1[/* event */ StatusBarTapEvent, scala.Unit]] = js.undefined
  /**
...
object StatusBarEvents {
  @scala.inline
  def apply(
    backgroundChanged: /* event */ PropertyChangedEvent[StatusBar, tabrisLib.Color] => scala.Unit = null,
    ...
    displayModeChanged: /* event */ PropertyChangedEvent[StatusBar, java.lang.String] => scala.Unit = null,
    ...
    tap: /* event */ StatusBarTapEvent => scala.Unit = null,
    themeChanged: /* event */ PropertyChangedEvent[StatusBar, java.lang.String] => scala.Unit = null,
