...
trait PickerEvents extends WidgetEvents {
  ...
  var borderColorChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[Picker, tabrisLib.Color], scala.Unit]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var itemCountChanged: js.UndefOr[js.Function1[/* event */ PropertyChangedEvent[Picker, scala.Double], scala.Unit]] = js.undefined
  /**
    * Fired when the [*itemText*](#itemText) property has changed.
    * @param value The new value of [*itemText*](#itemText).
    */
  var itemTextChanged: js.UndefOr[
    js.Function1[
      /* event */ PropertyChangedEvent[Picker, js.Function1[/* index */ scala.Double, java.lang.String]], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var select: js.UndefOr[js.Function1[/* event */ PickerSelectEvent, scala.Unit]] = js.undefined
  /**
    ...
    */
  var selectionIndexChanged: js.UndefOr[js.Function1[/* event */ PropertyChangedEvent[Picker, scala.Double], scala.Unit]] = js.undefined
  /**
...
object PickerEvents {
  ...
  def apply(
    ...
    borderColorChanged: /* event */ PropertyChangedEvent[Picker, tabrisLib.Color] => scala.Unit = null,
    ...
    fillColorChanged: /* event */ PropertyChangedEvent[Picker, tabrisLib.Color] => scala.Unit = null,
    ...
    itemCountChanged: /* event */ PropertyChangedEvent[Picker, scala.Double] => scala.Unit = null,
    itemTextChanged: /* event */ PropertyChangedEvent[Picker, js.Function1[/* index */ scala.Double, java.lang.String]] => scala.Unit = null,
    ...
    select: /* event */ PickerSelectEvent => scala.Unit = null,
    selectionIndexChanged: /* event */ PropertyChangedEvent[Picker, scala.Double] => scala.Unit = null,
    ...
    textColorChanged: /* event */ PropertyChangedEvent[Picker, tabrisLib.Color] => scala.Unit = null,
    ...
    if (itemTextChanged != null) __obj.updateDynamic("itemTextChanged")(js.Any.fromFunction1(itemTextChanged))
    ...
    if (selectionIndexChanged != null) __obj.updateDynamic("selectionIndexChanged")(js.Any.fromFunction1(selectionIndexChanged))
