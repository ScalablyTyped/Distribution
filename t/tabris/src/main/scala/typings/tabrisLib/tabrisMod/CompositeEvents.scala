...
trait CompositeEvents extends WidgetEvents {
  /**
    ...
    */
  var addChild: js.UndefOr[js.Function1[/* event */ CompositeAddChildEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the [*padding*](#padding) property has changed.
    * @param value The new value of [*padding*](#padding).
    */
  var paddingChanged: js.UndefOr[
    js.Function1[
      /* event */ PropertyChangedEvent[Composite, BoxDimensions | scala.Double], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var removeChild: js.UndefOr[js.Function1[/* event */ CompositeRemoveChildEvent, scala.Unit]] = js.undefined
}
