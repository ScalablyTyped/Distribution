...
trait SearchActionEvents extends ActionEvents {
  /**
    ...
    */
  var accept: js.UndefOr[js.Function1[/* event */ SearchActionAcceptEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the user inputs text.
    */
  var input: js.UndefOr[js.Function1[/* event */ SearchActionInputEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the [*message*](#message) property has changed.
    * @param value The new value of [*message*](#message).
    */
  var messageChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[SearchAction, java.lang.String], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the [*proposals*](#proposals) property has changed.
    * @param value The new value of [*proposals*](#proposals).
    */
  var proposalsChanged: js.UndefOr[
    js.Function1[
      /* event */ PropertyChangedEvent[SearchAction, js.Array[java.lang.String]], 
      scala.Unit
    ]
  ] = js.undefined
  /**
...
object SearchActionEvents {
  @scala.inline
  def apply(
    accept: /* event */ SearchActionAcceptEvent => scala.Unit = null,
    ...
    input: /* event */ SearchActionInputEvent => scala.Unit = null,
    ...
    messageChanged: /* event */ PropertyChangedEvent[SearchAction, java.lang.String] => scala.Unit = null,
    ...
    proposalsChanged: /* event */ PropertyChangedEvent[SearchAction, js.Array[java.lang.String]] => scala.Unit = null,
    ...
    textChanged: /* event */ PropertyChangedEvent[SearchAction, java.lang.String] => scala.Unit = null,
    ...
    if (proposalsChanged != null) __obj.updateDynamic("proposalsChanged")(js.Any.fromFunction1(proposalsChanged))
