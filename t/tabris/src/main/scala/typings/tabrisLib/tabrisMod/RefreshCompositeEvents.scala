...
trait RefreshCompositeEvents extends CompositeEvents {
  /**
    ...
    */
  var refresh: js.UndefOr[js.Function1[/* event */ EventObject[RefreshComposite], scala.Unit]] = js.undefined
  /**
  ...
  var refreshEnabledChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[RefreshComposite, scala.Boolean], scala.Unit]
  ] = js.undefined
  /**
  ...
  var refreshMessageChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[RefreshComposite, java.lang.String], scala.Unit]
  ] = js.undefined
}
...
object RefreshCompositeEvents {
  ...
  def apply(
    ...
    refresh: /* event */ EventObject[RefreshComposite] => scala.Unit = null,
    refreshEnabledChanged: /* event */ PropertyChangedEvent[RefreshComposite, scala.Boolean] => scala.Unit = null,
    refreshIndicatorChanged: /* event */ PropertyChangedEvent[RefreshComposite, scala.Boolean] => scala.Unit = null,
    refreshMessageChanged: /* event */ PropertyChangedEvent[RefreshComposite, java.lang.String] => scala.Unit = null,
