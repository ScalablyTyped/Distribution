...
trait SliderEvents extends WidgetEvents {
  /**
    * Fired when the [*maximum*](#maximum) property has changed.
    * @param value The new value of [*maximum*](#maximum).
    */
  var maximumChanged: js.UndefOr[js.Function1[/* event */ PropertyChangedEvent[Slider, scala.Double], scala.Unit]] = js.undefined
  /**
    * Fired when the [*minimum*](#minimum) property has changed.
    * @param value The new value of [*minimum*](#minimum).
    */
  var minimumChanged: js.UndefOr[js.Function1[/* event */ PropertyChangedEvent[Slider, scala.Double], scala.Unit]] = js.undefined
  /**
    * Fired when the selection property is changed by the user.
    */
  var select: js.UndefOr[js.Function1[/* event */ SliderSelectEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the [*selection*](#selection) property has changed.
    * @param value The new value of [*selection*](#selection).
    */
  var selectionChanged: js.UndefOr[js.Function1[/* event */ PropertyChangedEvent[Slider, scala.Double], scala.Unit]] = js.undefined
  /**
    * Fired when the [*tintColor*](#tintColor) property has changed.
    * @param value The new value of [*tintColor*](#tintColor).
    */
  var tintColorChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[Slider, tabrisLib.Color], scala.Unit]
  ] = js.undefined
}
...
object SliderEvents {
  ...
  def apply(
    ...
    maximumChanged: /* event */ PropertyChangedEvent[Slider, scala.Double] => scala.Unit = null,
    minimumChanged: /* event */ PropertyChangedEvent[Slider, scala.Double] => scala.Unit = null,
    ...
    select: /* event */ SliderSelectEvent => scala.Unit = null,
    selectionChanged: /* event */ PropertyChangedEvent[Slider, scala.Double] => scala.Unit = null,
    ...
    tintColorChanged: /* event */ PropertyChangedEvent[Slider, tabrisLib.Color] => scala.Unit = null,
    ...
    if (maximumChanged != null) __obj.updateDynamic("maximumChanged")(js.Any.fromFunction1(maximumChanged))
    if (minimumChanged != null) __obj.updateDynamic("minimumChanged")(js.Any.fromFunction1(minimumChanged))
