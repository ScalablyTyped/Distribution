...
trait ButtonEvents extends WidgetEvents {
  ...
  var alignmentChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[Button, java.lang.String], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the [*image*](#image) property has changed.
    * @param value The new value of [*image*](#image).
    */
  var imageChanged: js.UndefOr[js.Function1[/* event */ PropertyChangedEvent[Button, Image], scala.Unit]] = js.undefined
  /**
    * Fired when the button is pressed.
    */
  var select: js.UndefOr[js.Function1[/* event */ EventObject[Button], scala.Unit]] = js.undefined
  /**
  ...
  var textColorChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[Button, tabrisLib.Color], scala.Unit]
  ] = js.undefined
}
...
object ButtonEvents {
  @scala.inline
  def apply(
    alignmentChanged: /* event */ PropertyChangedEvent[Button, java.lang.String] => scala.Unit = null,
    ...
    imageChanged: /* event */ PropertyChangedEvent[Button, Image] => scala.Unit = null,
    ...
    select: /* event */ EventObject[Button] => scala.Unit = null,
    ...
    textChanged: /* event */ PropertyChangedEvent[Button, java.lang.String] => scala.Unit = null,
    textColorChanged: /* event */ PropertyChangedEvent[Button, tabrisLib.Color] => scala.Unit = null,
