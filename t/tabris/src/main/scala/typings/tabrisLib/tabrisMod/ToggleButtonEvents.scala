...
trait ToggleButtonEvents extends WidgetEvents {
  /**
    * Fired when the [*alignment*](#alignment) property has changed.
    * @param value The new value of [*alignment*](#alignment).
    */
  var alignmentChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[ToggleButton, java.lang.String], scala.Unit]
  ] = js.undefined
  /**
  ...
  var checkedChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[ToggleButton, scala.Boolean], scala.Unit]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var select: js.UndefOr[js.Function1[/* event */ ToggleButtonSelectEvent, scala.Unit]] = js.undefined
  /**
  ...
  var textColorChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[ToggleButton, tabrisLib.Color], scala.Unit]
  ] = js.undefined
}

object ToggleButtonEvents {
  @scala.inline
  def apply(
    ...
    checkedChanged: /* event */ PropertyChangedEvent[ToggleButton, scala.Boolean] => scala.Unit = null,
    ...
    select: /* event */ ToggleButtonSelectEvent => scala.Unit = null,
    ...
    textChanged: /* event */ PropertyChangedEvent[ToggleButton, java.lang.String] => scala.Unit = null,
    textColorChanged: /* event */ PropertyChangedEvent[ToggleButton, tabrisLib.Color] => scala.Unit = null,
    ...
    __obj.asInstanceOf[ToggleButtonEvents]
  }
}
