...
trait SwitchEvents extends WidgetEvents {
  ...
  /**
    ...
    */
  var trackOffColorChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[Switch, tabrisLib.Color], scala.Unit]
  ] = js.undefined
  /**
    ...
    */
  var trackOnColorChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[Switch, tabrisLib.Color], scala.Unit]
  ] = js.undefined
}
...
object SwitchEvents {
  ...
  def apply(
    ...
    checkedChanged: /* event */ PropertyChangedEvent[Switch, scala.Boolean] => scala.Unit = null,
    ...
    select: /* event */ SwitchSelectEvent => scala.Unit = null,
    ...
    thumbOffColorChanged: /* event */ PropertyChangedEvent[Switch, tabrisLib.Color] => scala.Unit = null,
    thumbOnColorChanged: /* event */ PropertyChangedEvent[Switch, tabrisLib.Color] => scala.Unit = null,
    ...
    trackOffColorChanged: /* event */ PropertyChangedEvent[Switch, tabrisLib.Color] => scala.Unit = null,
    trackOnColorChanged: /* event */ PropertyChangedEvent[Switch, tabrisLib.Color] => scala.Unit = null,
    ...
    if (thumbOffColorChanged != null) __obj.updateDynamic("thumbOffColorChanged")(js.Any.fromFunction1(thumbOffColorChanged))
    if (thumbOnColorChanged != null) __obj.updateDynamic("thumbOnColorChanged")(js.Any.fromFunction1(thumbOnColorChanged))
    ...
    if (trackOffColorChanged != null) __obj.updateDynamic("trackOffColorChanged")(js.Any.fromFunction1(trackOffColorChanged))
    if (trackOnColorChanged != null) __obj.updateDynamic("trackOnColorChanged")(js.Any.fromFunction1(trackOnColorChanged))
    ...
    __obj.asInstanceOf[SwitchEvents]
  }
}
