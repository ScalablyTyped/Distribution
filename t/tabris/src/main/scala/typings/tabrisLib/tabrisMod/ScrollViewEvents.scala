...
trait ScrollViewEvents extends CompositeEvents {
  /**
    ...
    */
  var offsetXChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[ScrollView, scala.Double], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the [*offsetY*](#offsetY) property has changed.
    * @param value The new value of [*offsetY*](#offsetY).
    */
  var offsetYChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[ScrollView, scala.Double], scala.Unit]
  ] = js.undefined
  /**
    * Fired while scrolling horizontally.
    */
  var scrollX: js.UndefOr[js.Function1[/* event */ ScrollViewScrollEvent, scala.Unit]] = js.undefined
  /**
    * Fired while scrolling vertically.
    */
  var scrollY: js.UndefOr[js.Function1[/* event */ ScrollViewScrollEvent, scala.Unit]] = js.undefined
}
...
object ScrollViewEvents {
  ...
  def apply(
    ...
    offsetXChanged: /* event */ PropertyChangedEvent[ScrollView, scala.Double] => scala.Unit = null,
    offsetYChanged: /* event */ PropertyChangedEvent[ScrollView, scala.Double] => scala.Unit = null,
    ...
    scrollX: /* event */ ScrollViewScrollEvent => scala.Unit = null,
    scrollY: /* event */ ScrollViewScrollEvent => scala.Unit = null,
    ...
    if (offsetXChanged != null) __obj.updateDynamic("offsetXChanged")(js.Any.fromFunction1(offsetXChanged))
    if (offsetYChanged != null) __obj.updateDynamic("offsetYChanged")(js.Any.fromFunction1(offsetYChanged))
    ...
    if (scrollX != null) __obj.updateDynamic("scrollX")(js.Any.fromFunction1(scrollX))
    if (scrollY != null) __obj.updateDynamic("scrollY")(js.Any.fromFunction1(scrollY))
