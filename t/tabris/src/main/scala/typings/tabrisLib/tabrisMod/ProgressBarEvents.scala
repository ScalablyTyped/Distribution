...
trait ProgressBarEvents extends WidgetEvents {
  /**
    ...
    */
  var maximumChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[ProgressBar, scala.Double], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the [*minimum*](#minimum) property has changed.
    * @param value The new value of [*minimum*](#minimum).
    */
  var minimumChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[ProgressBar, scala.Double], scala.Unit]
  ] = js.undefined
  /**
  ...
  var stateChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[ProgressBar, java.lang.String], scala.Unit]
  ] = js.undefined
  /**
  ...
  var tintColorChanged: js.UndefOr[
    js.Function1[/* event */ PropertyChangedEvent[ProgressBar, tabrisLib.Color], scala.Unit]
  ] = js.undefined
}
...
object ProgressBarEvents {
  ...
  def apply(
    ...
    maximumChanged: /* event */ PropertyChangedEvent[ProgressBar, scala.Double] => scala.Unit = null,
    minimumChanged: /* event */ PropertyChangedEvent[ProgressBar, scala.Double] => scala.Unit = null,
    ...
    selectionChanged: /* event */ PropertyChangedEvent[ProgressBar, scala.Double] => scala.Unit = null,
    stateChanged: /* event */ PropertyChangedEvent[ProgressBar, java.lang.String] => scala.Unit = null,
    ...
    tintColorChanged: /* event */ PropertyChangedEvent[ProgressBar, tabrisLib.Color] => scala.Unit = null,
