...
trait CompositeEvents extends WidgetEvents {
  /**
    * Fired when a child is added to this widget.
    */
  var onAddChild: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.CompositeAddChildEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the [*padding*](#padding) property has changed.
    * @param value The new value of [*padding*](#padding).
    */
  var onPaddingChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Composite, tabrisLib.tabrisMod.BoxDimensions | scala.Double], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onRemoveChild: js.UndefOr[
    js.Function1[/* event */ tabrisLib.tabrisMod.CompositeRemoveChildEvent, scala.Unit]
  ] = js.undefined
}

object CompositeEvents {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[CompositeEvents]
  }
}
