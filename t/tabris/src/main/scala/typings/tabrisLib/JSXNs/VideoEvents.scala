...
trait VideoEvents extends WidgetEvents {
  /**
    ...
    */
  var onAutoPlayChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, scala.Boolean], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onControlsVisibleChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, scala.Boolean], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onDurationChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, scala.Double], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onPositionChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, scala.Double], 
      scala.Unit
    ]
  ...
  var onStateChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
...
object VideoEvents {
  @scala.inline
  def apply(
    onAutoPlayChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, scala.Boolean] => scala.Unit = null,
    ...
    onControlsVisibleChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, scala.Boolean] => scala.Unit = null,
    ...
    onDurationChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, scala.Double] => scala.Unit = null,
    ...
    onPositionChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, scala.Double] => scala.Unit = null,
    ...
    onSpeedChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, scala.Double] => scala.Unit = null,
    onStateChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, java.lang.String] => scala.Unit = null,
    ...
    onUrlChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Video, java.lang.String] => scala.Unit = null,
    ...
    if (onAutoPlayChanged != null) __obj.updateDynamic("onAutoPlayChanged")(js.Any.fromFunction1(onAutoPlayChanged))
    ...
    if (onControlsVisibleChanged != null) __obj.updateDynamic("onControlsVisibleChanged")(js.Any.fromFunction1(onControlsVisibleChanged))
    ...
    if (onDurationChanged != null) __obj.updateDynamic("onDurationChanged")(js.Any.fromFunction1(onDurationChanged))
    ...
    if (onPositionChanged != null) __obj.updateDynamic("onPositionChanged")(js.Any.fromFunction1(onPositionChanged))
    if (onResize != null) __obj.updateDynamic("onResize")(js.Any.fromFunction1(onResize))
    if (onRightChanged != null) __obj.updateDynamic("onRightChanged")(js.Any.fromFunction1(onRightChanged))
    if (onSpeedChanged != null) __obj.updateDynamic("onSpeedChanged")(js.Any.fromFunction1(onSpeedChanged))
