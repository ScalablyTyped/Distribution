...
trait PageEvents extends CompositeEvents {
  ...
  var onAppear: js.UndefOr[
    js.Function1[/* event */ tabrisLib.tabrisMod.EventObject[tabrisLib.tabrisMod.Page], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the [*autoDispose*](#autoDispose) property has changed.
    * @param value The new value of [*autoDispose*](#autoDispose).
    */
  var onAutoDisposeChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Page, scala.Boolean], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  var onImageChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Page, tabrisLib.tabrisMod.Image], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  var onTitleChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Page, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
}
...
object PageEvents {
  ...
  def apply(
    ...
    onAppear: /* event */ tabrisLib.tabrisMod.EventObject[tabrisLib.tabrisMod.Page] => scala.Unit = null,
    onAutoDisposeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Page, scala.Boolean] => scala.Unit = null,
    ...
    onDisappear: /* event */ tabrisLib.tabrisMod.EventObject[tabrisLib.tabrisMod.Page] => scala.Unit = null,
    ...
    onImageChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Page, tabrisLib.tabrisMod.Image] => scala.Unit = null,
    ...
    onTitleChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Page, java.lang.String] => scala.Unit = null,
    ...
    if (onAutoDisposeChanged != null) __obj.updateDynamic("onAutoDisposeChanged")(js.Any.fromFunction1(onAutoDisposeChanged))
