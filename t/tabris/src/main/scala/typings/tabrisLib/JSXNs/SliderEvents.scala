...
trait SliderEvents extends WidgetEvents {
  ...
  var onMaximumChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Slider, scala.Double], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onSelect: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.SliderSelectEvent, scala.Unit]] = js.undefined
  /**
  ...
  var onTintColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Slider, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
}
...
object SliderEvents {
  ...
  def apply(
    ...
    onMaximumChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Slider, scala.Double] => scala.Unit = null,
    onMinimumChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Slider, scala.Double] => scala.Unit = null,
    ...
    onSelect: /* event */ tabrisLib.tabrisMod.SliderSelectEvent => scala.Unit = null,
    onSelectionChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Slider, scala.Double] => scala.Unit = null,
    ...
    onTintColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Slider, tabrisLib.Color] => scala.Unit = null,
