...
trait DrawerEvents extends CompositeEvents {
  ...
  var onClose: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.EventObject[tabrisLib.tabrisMod.Drawer], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  var onEnabledChanged_DrawerEvents: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Drawer, scala.Boolean], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onWin_displayModeChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Drawer, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onWin_targetViewChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Drawer, tabrisLib.tabrisMod.Widget], 
      scala.Unit
    ]
  ] = js.undefined
}
...
object DrawerEvents {
  ...
  def apply(
    ...
    onClose: /* event */ tabrisLib.tabrisMod.EventObject[tabrisLib.tabrisMod.Drawer] => scala.Unit = null,
    ...
    onEnabledChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Drawer, scala.Boolean] => scala.Unit = null,
    ...
    onOpen: /* event */ tabrisLib.tabrisMod.EventObject[tabrisLib.tabrisMod.Drawer] => scala.Unit = null,
    ...
    onWin_displayModeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Drawer, java.lang.String] => scala.Unit = null,
    onWin_targetViewChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Drawer, tabrisLib.tabrisMod.Widget] => scala.Unit = null,
    ...
    if (onWin_displayModeChanged != null) __obj.updateDynamic("onWin_displayModeChanged")(js.Any.fromFunction1(onWin_displayModeChanged))
    if (onWin_targetViewChanged != null) __obj.updateDynamic("onWin_targetViewChanged")(js.Any.fromFunction1(onWin_targetViewChanged))
