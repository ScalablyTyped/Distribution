...
trait NavigationBarEvents extends WidgetEvents {
  ...
  var onBackgroundChanged_NavigationBarEvents: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationBar, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  var onDisplayModeChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationBar, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
...
object NavigationBarEvents {
  @scala.inline
  def apply(
    onBackgroundChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationBar, tabrisLib.Color] => scala.Unit = null,
    ...
    onDisplayModeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationBar, java.lang.String] => scala.Unit = null,
    ...
    onThemeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationBar, java.lang.String] => scala.Unit = null,
