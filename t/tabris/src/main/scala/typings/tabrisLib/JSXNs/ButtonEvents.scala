...
trait ButtonEvents extends WidgetEvents {
  ...
  var onImageChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Button, tabrisLib.Image], 
      scala.Unit
    ]
  ] = js.undefined
  /**
...
object ButtonEvents {
  ...
  def apply(
    ...
    onImageChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Button, tabrisLib.Image] => scala.Unit = null,
