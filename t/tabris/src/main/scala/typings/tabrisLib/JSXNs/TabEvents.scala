...
trait TabEvents extends CompositeEvents {
  /**
    * Fired when the tab will become visible, i.e. the selection of its TabFolder.
    */
  var onAppear: js.UndefOr[
    js.Function1[/* event */ tabrisLib.tabrisMod.EventObject[tabrisLib.tabrisMod.Tab], scala.Unit]
  ] = js.undefined
  /**
    * Fired when the [*badge*](#badge) property has changed.
    * @param value The new value of [*badge*](#badge).
    */
  var onBadgeChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Tab, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  var onImageChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Tab, tabrisLib.tabrisMod.Image], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onSelectedImageChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Tab, tabrisLib.tabrisMod.Image], 
      scala.Unit
    ]
...
object TabEvents {
  ...
  def apply(
    ...
    onAppear: /* event */ tabrisLib.tabrisMod.EventObject[tabrisLib.tabrisMod.Tab] => scala.Unit = null,
    ...
    onBadgeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Tab, java.lang.String] => scala.Unit = null,
    ...
    onDisappear: /* event */ tabrisLib.tabrisMod.EventObject[tabrisLib.tabrisMod.Tab] => scala.Unit = null,
    ...
    onImageChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Tab, tabrisLib.tabrisMod.Image] => scala.Unit = null,
    ...
    onSelectedImageChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Tab, tabrisLib.tabrisMod.Image] => scala.Unit = null,
    ...
    onTitleChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Tab, java.lang.String] => scala.Unit = null,
    ...
    if (onBadgeChanged != null) __obj.updateDynamic("onBadgeChanged")(js.Any.fromFunction1(onBadgeChanged))
    ...
    if (onSelectedImageChanged != null) __obj.updateDynamic("onSelectedImageChanged")(js.Any.fromFunction1(onSelectedImageChanged))
