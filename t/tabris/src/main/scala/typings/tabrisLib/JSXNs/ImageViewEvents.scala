...
trait ImageViewEvents extends WidgetEvents {
  ...
  var onImageChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, tabrisLib.tabrisMod.Image], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onLoad: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.ImageViewLoadEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the [*maxZoomLevel*](#maxZoomLevel) property has changed.
    * @param value The new value of [*maxZoomLevel*](#maxZoomLevel).
    */
  var onMaxZoomLevelChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, scala.Double], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onMinZoomLevelChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, scala.Double], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onScaleModeChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  var onTintColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    * property.
    */
  var onZoom: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.ImageViewZoomEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the [*zoomEnabled*](#zoomEnabled) property has changed.
    * @param value The new value of [*zoomEnabled*](#zoomEnabled).
    */
  var onZoomEnabledChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, scala.Boolean], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onZoomLevelChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, scala.Double], 
      scala.Unit
    ]
...
object ImageViewEvents {
  ...
  def apply(
    ...
    onImageChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, tabrisLib.tabrisMod.Image] => scala.Unit = null,
    ...
    onLoad: /* event */ tabrisLib.tabrisMod.ImageViewLoadEvent => scala.Unit = null,
    onLongpress: /* event */ tabrisLib.tabrisMod.WidgetLongpressEvent => scala.Unit = null,
    onMaxZoomLevelChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, scala.Double] => scala.Unit = null,
    onMinZoomLevelChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, scala.Double] => scala.Unit = null,
    ...
    onScaleModeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, java.lang.String] => scala.Unit = null,
    ...
    onTintColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, tabrisLib.Color] => scala.Unit = null,
    ...
    onZoom: /* event */ tabrisLib.tabrisMod.ImageViewZoomEvent => scala.Unit = null,
    onZoomEnabledChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, scala.Boolean] => scala.Unit = null,
    onZoomLevelChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ImageView, scala.Double] => scala.Unit = null
  ): ImageViewEvents = {
    ...
    if (onMaxZoomLevelChanged != null) __obj.updateDynamic("onMaxZoomLevelChanged")(js.Any.fromFunction1(onMaxZoomLevelChanged))
    if (onMinZoomLevelChanged != null) __obj.updateDynamic("onMinZoomLevelChanged")(js.Any.fromFunction1(onMinZoomLevelChanged))
    ...
    if (onScaleModeChanged != null) __obj.updateDynamic("onScaleModeChanged")(js.Any.fromFunction1(onScaleModeChanged))
    ...
    if (onZoomEnabledChanged != null) __obj.updateDynamic("onZoomEnabledChanged")(js.Any.fromFunction1(onZoomEnabledChanged))
    if (onZoomLevelChanged != null) __obj.updateDynamic("onZoomLevelChanged")(js.Any.fromFunction1(onZoomLevelChanged))
