...
trait ToggleButtonEvents extends WidgetEvents {
  ...
  var onImageChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ToggleButton, tabrisLib.Image], 
      scala.Unit
    ]
  ] = js.undefined
  /**
...
object ToggleButtonEvents {
  ...
  def apply(
    ...
    onImageChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ToggleButton, tabrisLib.Image] => scala.Unit = null,
