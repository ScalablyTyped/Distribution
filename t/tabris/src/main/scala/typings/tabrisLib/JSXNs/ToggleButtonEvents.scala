...
trait ToggleButtonEvents extends WidgetEvents {
  ...
  var onAlignmentChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ToggleButton, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  var onCheckedChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ToggleButton, scala.Boolean], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  var onImageChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ToggleButton, tabrisLib.tabrisMod.Image], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  var onSelect: js.UndefOr[
    js.Function1[/* event */ tabrisLib.tabrisMod.ToggleButtonSelectEvent, scala.Unit]
  ] = js.undefined
  /**
  ...
  var onTextColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ToggleButton, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
}
...
object ToggleButtonEvents {
  @scala.inline
  def apply(
    onAlignmentChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ToggleButton, java.lang.String] => scala.Unit = null,
    ...
    onCheckedChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ToggleButton, scala.Boolean] => scala.Unit = null,
    ...
    onImageChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ToggleButton, tabrisLib.tabrisMod.Image] => scala.Unit = null,
    ...
    onSelect: /* event */ tabrisLib.tabrisMod.ToggleButtonSelectEvent => scala.Unit = null,
    ...
    onTextChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ToggleButton, java.lang.String] => scala.Unit = null,
    onTextColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ToggleButton, tabrisLib.Color] => scala.Unit = null,
