...
trait ActivityIndicatorEvents extends WidgetEvents {
  /**
  ...
  var onTintColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ActivityIndicator, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
}

object ActivityIndicatorEvents {
  @scala.inline
  def apply(
    ...
    onTintColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ActivityIndicator, tabrisLib.Color] => scala.Unit = null,
    ...
    __obj.asInstanceOf[ActivityIndicatorEvents]
  }
}
