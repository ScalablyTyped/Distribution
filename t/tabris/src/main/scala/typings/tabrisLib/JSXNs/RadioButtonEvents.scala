...
trait RadioButtonEvents extends WidgetEvents {
  /**
    ...
    */
  var onCheckedChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.RadioButton, scala.Boolean], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onCheckedTintColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.RadioButton, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onSelect: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.RadioButtonSelectEvent, scala.Unit]] = js.undefined
  /**
  ...
  var onTextChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.RadioButton, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
...
object RadioButtonEvents {
  ...
  def apply(
    ...
    onCheckedChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.RadioButton, scala.Boolean] => scala.Unit = null,
    onCheckedTintColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.RadioButton, tabrisLib.Color] => scala.Unit = null,
    ...
    onSelect: /* event */ tabrisLib.tabrisMod.RadioButtonSelectEvent => scala.Unit = null,
    ...
    onTextChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.RadioButton, java.lang.String] => scala.Unit = null,
    onTextColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.RadioButton, tabrisLib.Color] => scala.Unit = null,
    onTintColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.RadioButton, tabrisLib.Color] => scala.Unit = null,
    ...
    if (onCheckedChanged != null) __obj.updateDynamic("onCheckedChanged")(js.Any.fromFunction1(onCheckedChanged))
    if (onCheckedTintColorChanged != null) __obj.updateDynamic("onCheckedTintColorChanged")(js.Any.fromFunction1(onCheckedTintColorChanged))
