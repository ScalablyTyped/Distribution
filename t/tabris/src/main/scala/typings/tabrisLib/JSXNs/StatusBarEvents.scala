...
trait StatusBarEvents extends WidgetEvents {
  /**
    * Fired when the [*background*](#background) property has changed.
    * @param value The new value of [*background*](#background).
    */
  @JSName("onBackgroundChanged")
  var onBackgroundChanged_StatusBarEvents: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.StatusBar, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onDisplayModeChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.StatusBar, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  @JSName("onTap")
  var onTap_StatusBarEvents: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.StatusBarTapEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the [*theme*](#theme) property has changed.
    * @param value The new value of [*theme*](#theme).
    */
  var onThemeChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.StatusBar, java.lang.String], 
      scala.Unit
    ]
...
object StatusBarEvents {
  @scala.inline
  def apply(
    onBackgroundChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.StatusBar, tabrisLib.Color] => scala.Unit = null,
    ...
    onDisplayModeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.StatusBar, java.lang.String] => scala.Unit = null,
    ...
    onTap: /* event */ tabrisLib.tabrisMod.StatusBarTapEvent => scala.Unit = null,
    onThemeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.StatusBar, java.lang.String] => scala.Unit = null,
    ...
    if (onDisplayModeChanged != null) __obj.updateDynamic("onDisplayModeChanged")(js.Any.fromFunction1(onDisplayModeChanged))
    ...
    if (onThemeChanged != null) __obj.updateDynamic("onThemeChanged")(js.Any.fromFunction1(onThemeChanged))
    ...
    __obj.asInstanceOf[StatusBarEvents]
  }
}
