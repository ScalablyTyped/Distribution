...
trait ProgressBarEvents extends WidgetEvents {
  /**
    * Fired when the [*maximum*](#maximum) property has changed.
    * @param value The new value of [*maximum*](#maximum).
    */
  var onMaximumChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ProgressBar, scala.Double], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onMinimumChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ProgressBar, scala.Double], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onStateChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ProgressBar, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onTintColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ProgressBar, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
}
...
object ProgressBarEvents {
  ...
  def apply(
    ...
    onMaximumChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ProgressBar, scala.Double] => scala.Unit = null,
    onMinimumChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ProgressBar, scala.Double] => scala.Unit = null,
    ...
    onSelectionChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ProgressBar, scala.Double] => scala.Unit = null,
    onStateChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ProgressBar, java.lang.String] => scala.Unit = null,
    ...
    onTintColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ProgressBar, tabrisLib.Color] => scala.Unit = null,
    ...
    if (onMaximumChanged != null) __obj.updateDynamic("onMaximumChanged")(js.Any.fromFunction1(onMaximumChanged))
    if (onMinimumChanged != null) __obj.updateDynamic("onMinimumChanged")(js.Any.fromFunction1(onMinimumChanged))
    ...
    if (onTintColorChanged != null) __obj.updateDynamic("onTintColorChanged")(js.Any.fromFunction1(onTintColorChanged))
