...
trait TextViewEvents extends WidgetEvents {
  ...
  var onAlignmentChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TextView, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onLineSpacingChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TextView, scala.Double], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onMaxLinesChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TextView, scala.Double | scala.Null], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onSelectableChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TextView, scala.Boolean], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onTapLink: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.TextViewTapLinkEvent, scala.Unit]] = js.undefined
  /**
  ...
  var onTextColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TextView, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
}
...
object TextViewEvents {
  @scala.inline
  def apply(
    onAlignmentChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TextView, java.lang.String] => scala.Unit = null,
    ...
    onLineSpacingChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TextView, scala.Double] => scala.Unit = null,
    onLongpress: /* event */ tabrisLib.tabrisMod.WidgetLongpressEvent => scala.Unit = null,
    onMaxLinesChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TextView, scala.Double | scala.Null] => scala.Unit = null,
    ...
    onSelectableChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TextView, scala.Boolean] => scala.Unit = null,
    ...
    onTapLink: /* event */ tabrisLib.tabrisMod.TextViewTapLinkEvent => scala.Unit = null,
    onTextChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TextView, java.lang.String] => scala.Unit = null,
    onTextColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TextView, tabrisLib.Color] => scala.Unit = null,
    ...
    if (onLineSpacingChanged != null) __obj.updateDynamic("onLineSpacingChanged")(js.Any.fromFunction1(onLineSpacingChanged))
    if (onLongpress != null) __obj.updateDynamic("onLongpress")(js.Any.fromFunction1(onLongpress))
    if (onMaxLinesChanged != null) __obj.updateDynamic("onMaxLinesChanged")(js.Any.fromFunction1(onMaxLinesChanged))
    ...
    if (onSelectableChanged != null) __obj.updateDynamic("onSelectableChanged")(js.Any.fromFunction1(onSelectableChanged))
    ...
    if (onTapLink != null) __obj.updateDynamic("onTapLink")(js.Any.fromFunction1(onTapLink))
