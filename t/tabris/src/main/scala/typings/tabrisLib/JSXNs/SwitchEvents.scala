...
trait SwitchEvents extends WidgetEvents {
  ...
  var onCheckedChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Switch, scala.Boolean], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onSelect: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.SwitchSelectEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the [*thumbOffColor*](#thumbOffColor) property has changed.
    * @param value The new value of [*thumbOffColor*](#thumbOffColor).
    */
  var onThumbOffColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Switch, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onThumbOnColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Switch, tabrisLib.Color], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onTrackOffColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Switch, tabrisLib.Color], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onTrackOnColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Switch, tabrisLib.Color], 
      scala.Unit
    ]
...
object SwitchEvents {
  ...
  def apply(
    ...
    onCheckedChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Switch, scala.Boolean] => scala.Unit = null,
    ...
    onSelect: /* event */ tabrisLib.tabrisMod.SwitchSelectEvent => scala.Unit = null,
    ...
    onThumbOffColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Switch, tabrisLib.Color] => scala.Unit = null,
    onThumbOnColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Switch, tabrisLib.Color] => scala.Unit = null,
    ...
    onTrackOffColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Switch, tabrisLib.Color] => scala.Unit = null,
    onTrackOnColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Switch, tabrisLib.Color] => scala.Unit = null,
    ...
    if (onThumbOffColorChanged != null) __obj.updateDynamic("onThumbOffColorChanged")(js.Any.fromFunction1(onThumbOffColorChanged))
    if (onThumbOnColorChanged != null) __obj.updateDynamic("onThumbOnColorChanged")(js.Any.fromFunction1(onThumbOnColorChanged))
    ...
    if (onTrackOffColorChanged != null) __obj.updateDynamic("onTrackOffColorChanged")(js.Any.fromFunction1(onTrackOffColorChanged))
    if (onTrackOnColorChanged != null) __obj.updateDynamic("onTrackOnColorChanged")(js.Any.fromFunction1(onTrackOnColorChanged))
