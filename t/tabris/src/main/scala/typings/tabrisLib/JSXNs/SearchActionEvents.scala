...
trait SearchActionEvents extends ActionEvents {
  /**
    * Fired when a text input has been submitted by pressing the keyboard's search key.
    */
  var onAccept: js.UndefOr[
    js.Function1[/* event */ tabrisLib.tabrisMod.SearchActionAcceptEvent, scala.Unit]
  ] = js.undefined
  /**
    * Fired when the user inputs text.
    */
  var onInput: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.SearchActionInputEvent, scala.Unit]] = js.undefined
  /**
  ...
  var onMessageChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.SearchAction, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onProposalsChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.SearchAction, js.Array[java.lang.String]], 
      scala.Unit
    ]
  ] = js.undefined
  /**
...
object SearchActionEvents {
  @scala.inline
  def apply(
    onAccept: /* event */ tabrisLib.tabrisMod.SearchActionAcceptEvent => scala.Unit = null,
    ...
    onImageChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Action, tabrisLib.tabrisMod.Image] => scala.Unit = null,
    onInput: /* event */ tabrisLib.tabrisMod.SearchActionInputEvent => scala.Unit = null,
    ...
    onMessageChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.SearchAction, java.lang.String] => scala.Unit = null,
    ...
    onPlacementPriorityChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Action, java.lang.String] => scala.Unit = null,
    onProposalsChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.SearchAction, js.Array[java.lang.String]] => scala.Unit = null,
    ...
    onSelect: /* event */ tabrisLib.tabrisMod.EventObject[tabrisLib.tabrisMod.Action] => scala.Unit = null,
    ...
    onTextChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.SearchAction, java.lang.String] => scala.Unit = null,
    onTitleChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Action, java.lang.String] => scala.Unit = null,
    ...
    onWin_symbolChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Action, java.lang.String] => scala.Unit = null,
    ...
    if (onPlacementPriorityChanged != null) __obj.updateDynamic("onPlacementPriorityChanged")(js.Any.fromFunction1(onPlacementPriorityChanged))
    if (onProposalsChanged != null) __obj.updateDynamic("onProposalsChanged")(js.Any.fromFunction1(onProposalsChanged))
    ...
    if (onWin_symbolChanged != null) __obj.updateDynamic("onWin_symbolChanged")(js.Any.fromFunction1(onWin_symbolChanged))
    if (onWin_themeChanged != null) __obj.updateDynamic("onWin_themeChanged")(js.Any.fromFunction1(onWin_themeChanged))
    __obj.asInstanceOf[SearchActionEvents]
  }
}
