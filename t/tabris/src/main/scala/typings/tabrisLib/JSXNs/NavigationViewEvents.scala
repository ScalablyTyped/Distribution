...
trait NavigationViewEvents extends CompositeEvents {
  /**
    ...
    */
  var onActionColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onActionTextColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.Color], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onBottomToolbarHeightChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, scala.Double], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onDrawerActionVisibleChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, scala.Boolean], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onNavigationActionChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.tabrisMod.Action], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onPageAnimationChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onTitleTextColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.Color], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onToolbarColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.Color], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onToolbarVisibleChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, scala.Boolean], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onTopToolbarHeightChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, scala.Double], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onWin_drawerActionBackgroundChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.Color], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onWin_drawerActionThemeChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, java.lang.String], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onWin_toolbarOverflowThemeChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, java.lang.String], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onWin_toolbarThemeChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, java.lang.String], 
      scala.Unit
    ]
...
object NavigationViewEvents {
  @scala.inline
  def apply(
    onActionColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.Color] => scala.Unit = null,
    onActionTextColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.Color] => scala.Unit = null,
    ...
    onBottomToolbarHeightChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, scala.Double] => scala.Unit = null,
    ...
    onDrawerActionVisibleChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, scala.Boolean] => scala.Unit = null,
    ...
    onNavigationActionChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.tabrisMod.Action] => scala.Unit = null,
    ...
    onPageAnimationChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, java.lang.String] => scala.Unit = null,
    ...
    onTitleTextColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.Color] => scala.Unit = null,
    onToolbarColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.Color] => scala.Unit = null,
    onToolbarVisibleChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, scala.Boolean] => scala.Unit = null,
    onTopChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.Widget, tabrisLib.margin] => scala.Unit = null,
    onTopToolbarHeightChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, scala.Double] => scala.Unit = null,
    ...
    onWin_drawerActionBackgroundChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, tabrisLib.Color] => scala.Unit = null,
    onWin_drawerActionThemeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, java.lang.String] => scala.Unit = null,
    ...
    onWin_toolbarOverflowThemeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, java.lang.String] => scala.Unit = null,
    onWin_toolbarThemeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.NavigationView, java.lang.String] => scala.Unit = null
  ): NavigationViewEvents = {
    val __obj = js.Dynamic.literal()
    if (onActionColorChanged != null) __obj.updateDynamic("onActionColorChanged")(js.Any.fromFunction1(onActionColorChanged))
    if (onActionTextColorChanged != null) __obj.updateDynamic("onActionTextColorChanged")(js.Any.fromFunction1(onActionTextColorChanged))
    ...
    if (onBottomToolbarHeightChanged != null) __obj.updateDynamic("onBottomToolbarHeightChanged")(js.Any.fromFunction1(onBottomToolbarHeightChanged))
    ...
    if (onDrawerActionVisibleChanged != null) __obj.updateDynamic("onDrawerActionVisibleChanged")(js.Any.fromFunction1(onDrawerActionVisibleChanged))
    ...
    if (onNavigationActionChanged != null) __obj.updateDynamic("onNavigationActionChanged")(js.Any.fromFunction1(onNavigationActionChanged))
    ...
    if (onPageAnimationChanged != null) __obj.updateDynamic("onPageAnimationChanged")(js.Any.fromFunction1(onPageAnimationChanged))
    ...
    if (onTitleTextColorChanged != null) __obj.updateDynamic("onTitleTextColorChanged")(js.Any.fromFunction1(onTitleTextColorChanged))
    if (onToolbarColorChanged != null) __obj.updateDynamic("onToolbarColorChanged")(js.Any.fromFunction1(onToolbarColorChanged))
    if (onToolbarVisibleChanged != null) __obj.updateDynamic("onToolbarVisibleChanged")(js.Any.fromFunction1(onToolbarVisibleChanged))
    if (onTopChanged != null) __obj.updateDynamic("onTopChanged")(js.Any.fromFunction1(onTopChanged))
    if (onTopToolbarHeightChanged != null) __obj.updateDynamic("onTopToolbarHeightChanged")(js.Any.fromFunction1(onTopToolbarHeightChanged))
    ...
    if (onWin_drawerActionBackgroundChanged != null) __obj.updateDynamic("onWin_drawerActionBackgroundChanged")(js.Any.fromFunction1(onWin_drawerActionBackgroundChanged))
    if (onWin_drawerActionThemeChanged != null) __obj.updateDynamic("onWin_drawerActionThemeChanged")(js.Any.fromFunction1(onWin_drawerActionThemeChanged))
    if (onWin_themeChanged != null) __obj.updateDynamic("onWin_themeChanged")(js.Any.fromFunction1(onWin_themeChanged))
    if (onWin_toolbarOverflowThemeChanged != null) __obj.updateDynamic("onWin_toolbarOverflowThemeChanged")(js.Any.fromFunction1(onWin_toolbarOverflowThemeChanged))
    if (onWin_toolbarThemeChanged != null) __obj.updateDynamic("onWin_toolbarThemeChanged")(js.Any.fromFunction1(onWin_toolbarThemeChanged))
