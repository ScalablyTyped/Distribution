...
trait ScrollViewEvents extends CompositeEvents {
  /**
    * Fired when the [*offsetX*](#offsetX) property has changed.
    * @param value The new value of [*offsetX*](#offsetX).
    */
  var onOffsetXChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ScrollView, scala.Double], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onOffsetYChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ScrollView, scala.Double], 
      scala.Unit
    ]
  ...
  /**
    ...
    */
  var onScrollX: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.ScrollViewScrollEvent, scala.Unit]] = js.undefined
  /**
    * Fired while scrolling vertically.
    */
  var onScrollY: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.ScrollViewScrollEvent, scala.Unit]] = js.undefined
}

object ScrollViewEvents {
  @scala.inline
  def apply(
    ...
    onOffsetXChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ScrollView, scala.Double] => scala.Unit = null,
    onOffsetYChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.ScrollView, scala.Double] => scala.Unit = null,
    ...
    onScrollX: /* event */ tabrisLib.tabrisMod.ScrollViewScrollEvent => scala.Unit = null,
    onScrollY: /* event */ tabrisLib.tabrisMod.ScrollViewScrollEvent => scala.Unit = null,
    ...
    if (onOffsetXChanged != null) __obj.updateDynamic("onOffsetXChanged")(js.Any.fromFunction1(onOffsetXChanged))
    if (onOffsetYChanged != null) __obj.updateDynamic("onOffsetYChanged")(js.Any.fromFunction1(onOffsetYChanged))
    ...
    if (onScrollX != null) __obj.updateDynamic("onScrollX")(js.Any.fromFunction1(onScrollX))
    if (onScrollY != null) __obj.updateDynamic("onScrollY")(js.Any.fromFunction1(onScrollY))
    ...
    __obj.asInstanceOf[ScrollViewEvents]
  }
}
