...
trait TabFolderEvents extends CompositeEvents {
  /**
    ...
    */
  var onPagingChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TabFolder, scala.Boolean], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onScroll: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.TabFolderScrollEvent, scala.Unit]] = js.undefined
  /**
    * Fired when the user taps on a tab. The event also fires when the same tab is tapped multiple times.
    */
  var onSelect: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.TabFolderSelectEvent, scala.Unit]] = js.undefined
  /**
  ...
  var onSelectionChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TabFolder, tabrisLib.tabrisMod.Tab], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  var onTextColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TabFolder, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onWin_tabBarThemeChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TabFolder, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
}
...
object TabFolderEvents {
  ...
  def apply(
    ...
    onPagingChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TabFolder, scala.Boolean] => scala.Unit = null,
    ...
    onScroll: /* event */ tabrisLib.tabrisMod.TabFolderScrollEvent => scala.Unit = null,
    onSelect: /* event */ tabrisLib.tabrisMod.TabFolderSelectEvent => scala.Unit = null,
    onSelectionChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TabFolder, tabrisLib.tabrisMod.Tab] => scala.Unit = null,
    ...
    onTextColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TabFolder, tabrisLib.Color] => scala.Unit = null,
    ...
    onWin_tabBarThemeChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.TabFolder, java.lang.String] => scala.Unit = null,
    ...
    if (onPagingChanged != null) __obj.updateDynamic("onPagingChanged")(js.Any.fromFunction1(onPagingChanged))
    ...
    if (onWin_tabBarThemeChanged != null) __obj.updateDynamic("onWin_tabBarThemeChanged")(js.Any.fromFunction1(onWin_tabBarThemeChanged))
