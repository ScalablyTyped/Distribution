...
trait CheckBoxEvents extends WidgetEvents {
  /**
  ...
  var onCheckedChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.CheckBox, scala.Boolean], 
      scala.Unit
    ]
  ] = js.undefined
  /**
  ...
  var onCheckedTintColorChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.CheckBox, tabrisLib.Color], 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onSelect: js.UndefOr[js.Function1[/* event */ tabrisLib.tabrisMod.CheckBoxSelectEvent, scala.Unit]] = js.undefined
  /**
  ...
  var onTextChanged: js.UndefOr[
    js.Function1[
      /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.CheckBox, java.lang.String], 
      scala.Unit
    ]
  ] = js.undefined
  /**
...
object CheckBoxEvents {
  ...
  def apply(
    ...
    onCheckedChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.CheckBox, scala.Boolean] => scala.Unit = null,
    onCheckedTintColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.CheckBox, tabrisLib.Color] => scala.Unit = null,
    ...
    onSelect: /* event */ tabrisLib.tabrisMod.CheckBoxSelectEvent => scala.Unit = null,
    ...
    onTextChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.CheckBox, java.lang.String] => scala.Unit = null,
    onTextColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.CheckBox, tabrisLib.Color] => scala.Unit = null,
    onTintColorChanged: /* event */ tabrisLib.tabrisMod.PropertyChangedEvent[tabrisLib.tabrisMod.CheckBox, tabrisLib.Color] => scala.Unit = null,
    ...
    __obj.asInstanceOf[CheckBoxEvents]
  }
}
