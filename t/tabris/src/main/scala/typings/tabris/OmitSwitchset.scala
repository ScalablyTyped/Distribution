...
import typings.tabris.mod.Switch
...
/* Inlined tabris.tabris.Omit<tabris.tabris.Switch, 'set'> */
@js.native
trait OmitSwitchset extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], Switch] = js.native
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Switch, Omit[Switch, set]]], js.Any] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[Switch] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Switch] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Switch] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[Switch, Omit[Switch, set | typings.tabris.tabrisStrings.jsxAttributes]]) with AnonChildrenString = js.native
  ...
  var onBackgroundChanged: ChangeListeners[Switch, background] = js.native
  var onBaselineChanged: ChangeListeners[Switch, baseline] = js.native
  var onBottomChanged: ChangeListeners[Switch, bottom] = js.native
  var onBoundsChanged: ChangeListeners[Switch, bounds] = js.native
  var onCenterXChanged: ChangeListeners[Switch, centerX] = js.native
  var onCenterYChanged: ChangeListeners[Switch, centerY] = js.native
  var onCheckedChanged: ChangeListeners[Switch, checked] = js.native
  var onClassChanged: ChangeListeners[Switch, `class`] = js.native
  var onClassListChanged: ChangeListeners[Switch, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[Switch, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[Switch]] = js.native
  var onElevationChanged: ChangeListeners[Switch, elevation] = js.native
  var onEnabledChanged: ChangeListeners[Switch, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[Switch, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[Switch, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[Switch, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[Switch, id] = js.native
  var onLayoutDataChanged: ChangeListeners[Switch, layoutData] = js.native
  var onLeftChanged: ChangeListeners[Switch, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[Switch]] = js.native
  var onOpacityChanged: ChangeListeners[Switch, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[Switch]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[Switch]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[Switch]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[Switch]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[Switch]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[Switch]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[Switch]] = js.native
  var onResize: Listeners[WidgetResizeEvent[Switch]] = js.native
  var onRightChanged: ChangeListeners[Switch, right] = js.native
  var onSelect: Listeners[SwitchSelectEvent[Switch]] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[Switch]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Switch]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[Switch]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[Switch]] = js.native
  var onTap: Listeners[WidgetTapEvent[Switch]] = js.native
  var onThumbOffColorChanged: ChangeListeners[Switch, thumbOffColor] = js.native
  var onThumbOnColorChanged: ChangeListeners[Switch, thumbOnColor] = js.native
  var onTopChanged: ChangeListeners[Switch, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[Switch]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[Switch]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[Switch]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[Switch]] = js.native
  var onTrackOffColorChanged: ChangeListeners[Switch, trackOffColor] = js.native
  var onTrackOnColorChanged: ChangeListeners[Switch, trackOnColor] = js.native
  var onTransformChanged: ChangeListeners[Switch, transform] = js.native
  var onVisibleChanged: ChangeListeners[Switch, visible] = js.native
  var onWidthChanged: ChangeListeners[Switch, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Switch]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Switch] = js.native
  ...
  def appendTo(parent: Composite[Widget]): Switch = js.native
  def detach(): Switch = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): Switch = js.native
  def insertBefore(widget: Widget): Switch = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Switch = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): Switch = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Switch = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): Switch = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Switch = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): Switch = js.native
  def triggerAsync(`type`: String): js.Promise[Switch] = js.native
}
