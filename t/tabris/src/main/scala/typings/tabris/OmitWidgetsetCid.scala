...
@js.native
trait OmitWidgetsetCid extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], Widget] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[Widget] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Widget] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Widget] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: JSXAttributes[Widget, Omit[Widget, set | typings.tabris.tabrisStrings.jsxAttributes]] = js.native
  ...
  var onBackgroundChanged: ChangeListeners[Widget, background] = js.native
  var onBaselineChanged: ChangeListeners[Widget, baseline] = js.native
  var onBottomChanged: ChangeListeners[Widget, bottom] = js.native
  var onBoundsChanged: ChangeListeners[Widget, bounds] = js.native
  var onCenterXChanged: ChangeListeners[Widget, centerX] = js.native
  var onCenterYChanged: ChangeListeners[Widget, centerY] = js.native
  var onClassChanged: ChangeListeners[Widget, `class`] = js.native
  var onClassListChanged: ChangeListeners[Widget, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[Widget, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[Widget]] = js.native
  var onElevationChanged: ChangeListeners[Widget, elevation] = js.native
  var onEnabledChanged: ChangeListeners[Widget, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[Widget, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[Widget, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[Widget, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[Widget, id] = js.native
  var onLayoutDataChanged: ChangeListeners[Widget, layoutData] = js.native
  var onLeftChanged: ChangeListeners[Widget, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[Widget]] = js.native
  var onOpacityChanged: ChangeListeners[Widget, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[Widget]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[Widget]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[Widget]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[Widget]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[Widget]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[Widget]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[Widget]] = js.native
  var onResize: Listeners[WidgetResizeEvent[Widget]] = js.native
  var onRightChanged: ChangeListeners[Widget, right] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[Widget]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Widget]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[Widget]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[Widget]] = js.native
  var onTap: Listeners[WidgetTapEvent[Widget]] = js.native
  var onTopChanged: ChangeListeners[Widget, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[Widget]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[Widget]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[Widget]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[Widget]] = js.native
  var onTransformChanged: ChangeListeners[Widget, transform] = js.native
  var onVisibleChanged: ChangeListeners[Widget, visible] = js.native
  var onWidthChanged: ChangeListeners[Widget, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Widget]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Widget] = js.native
  ...
  def appendTo(parent: Composite[Widget]): Widget = js.native
  def detach(): Widget = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): Widget = js.native
  def insertBefore(widget: Widget): Widget = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Widget = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): Widget = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Widget = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): Widget = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Widget = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): Widget = js.native
  def triggerAsync(`type`: String): js.Promise[Widget] = js.native
}
