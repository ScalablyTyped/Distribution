...
import typings.tabris.mod.StackLayout
...
trait OmitStackset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[Stack, Omit[Stack, set | typings.tabris.tabrisStrings.jsxAttributes]]) with Anon2 = js.native
