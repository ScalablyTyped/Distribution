...
import typings.tabris.mod.ProgressBar
...
trait OmitProgressBarset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[ProgressBar, Omit[ProgressBar, set | typings.tabris.tabrisStrings.jsxAttributes]]) with js.Object = js.native
