...
import typings.tabris.mod.ScrollView
...
/* Inlined tabris.tabris.Omit<tabris.tabris.ScrollView, 'set'> */
@js.native
trait OmitScrollViewset extends js.Object {
  @JSName("$children")
  ...
  var _apply_Original: js.Function1[
    /* properties */ StringDictionary[Properties[Widget, OmitWidgetsetBounds]], 
    ScrollView
  ] = js.native
  ...
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, ScrollView] = js.native
  @JSName("apply")
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[ScrollView, Omit[ScrollView, set]]], js.Any] = js.native
  ...
  var jsxAttributes: (JSXAttributes[ScrollView, Omit[ScrollView, set | typings.tabris.tabrisStrings.jsxAttributes]]) with Anon2 = js.native
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[ScrollView]] = js.native
  ...
  var onOffsetXChanged: ChangeListeners[ScrollView, offsetX] = js.native
  var onOffsetYChanged: ChangeListeners[ScrollView, offsetY] = js.native
  ...
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[ScrollView]] = js.native
  ...
  var onScrollX: Listeners[ScrollViewScrollEvent[ScrollView]] = js.native
  var onScrollXStateChanged: ChangeListeners[ScrollView, scrollXState] = js.native
  var onScrollY: Listeners[ScrollViewScrollEvent[ScrollView]] = js.native
  var onScrollYStateChanged: ChangeListeners[ScrollView, scrollYState] = js.native
  var onScrollbarVisibleChanged: ChangeListeners[ScrollView, scrollbarVisible] = js.native
  ...
  @JSName("scrollToX")
  var scrollToX_Original: js.Function2[/* offset */ Double, /* options */ js.UndefOr[AnonAnimate], ScrollView] = js.native
  @JSName("scrollToY")
  var scrollToY_Original: js.Function2[/* offset */ Double, /* options */ js.UndefOr[AnonAnimate], ScrollView] = js.native
  var scrollXState: drag | rest | scroll = js.native
  var scrollYState: drag | rest | scroll = js.native
  ...
  def _apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetBounds]]): ScrollView = js.native
  ...
  def append(widgets: Widget*): ScrollView = js.native
  def appendTo(parent: Composite[Widget]): ScrollView = js.native
  @JSName("apply")
  def apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetBounds]]): ScrollView = js.native
  ...
  def scrollToX(offset: Double): ScrollView = js.native
  def scrollToX(offset: Double, options: AnonAnimate): ScrollView = js.native
  def scrollToY(offset: Double): ScrollView = js.native
  def scrollToY(offset: Double, options: AnonAnimate): ScrollView = js.native
