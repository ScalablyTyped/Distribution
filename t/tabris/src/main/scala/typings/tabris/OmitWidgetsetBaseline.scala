...
import typings.tabris.mod.RefreshComposite
...
@js.native
trait OmitWidgetsetBaseline extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], RefreshComposite] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[RefreshComposite] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, RefreshComposite] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, RefreshComposite] = js.native
  @JSName("isDisposed")
  ...
  var onBackgroundChanged: ChangeListeners[RefreshComposite, background] = js.native
  var onBaselineChanged: ChangeListeners[RefreshComposite, baseline] = js.native
  var onBottomChanged: ChangeListeners[RefreshComposite, bottom] = js.native
  var onBoundsChanged: ChangeListeners[RefreshComposite, bounds] = js.native
  var onCenterXChanged: ChangeListeners[RefreshComposite, centerX] = js.native
  var onCenterYChanged: ChangeListeners[RefreshComposite, centerY] = js.native
  var onClassChanged: ChangeListeners[RefreshComposite, `class`] = js.native
  var onClassListChanged: ChangeListeners[RefreshComposite, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[RefreshComposite, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[RefreshComposite]] = js.native
  var onElevationChanged: ChangeListeners[RefreshComposite, elevation] = js.native
  var onEnabledChanged: ChangeListeners[RefreshComposite, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[RefreshComposite, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[RefreshComposite, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[RefreshComposite, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[RefreshComposite, id] = js.native
  var onLayoutDataChanged: ChangeListeners[RefreshComposite, layoutData] = js.native
  var onLeftChanged: ChangeListeners[RefreshComposite, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[RefreshComposite]] = js.native
  var onOpacityChanged: ChangeListeners[RefreshComposite, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[RefreshComposite]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[RefreshComposite]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[RefreshComposite]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[RefreshComposite]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[RefreshComposite]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[RefreshComposite]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[RefreshComposite]] = js.native
  var onResize: Listeners[WidgetResizeEvent[RefreshComposite]] = js.native
  var onRightChanged: ChangeListeners[RefreshComposite, right] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[RefreshComposite]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[RefreshComposite]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[RefreshComposite]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[RefreshComposite]] = js.native
  var onTap: Listeners[WidgetTapEvent[RefreshComposite]] = js.native
  var onTopChanged: ChangeListeners[RefreshComposite, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[RefreshComposite]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[RefreshComposite]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[RefreshComposite]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[RefreshComposite]] = js.native
  var onTransformChanged: ChangeListeners[RefreshComposite, transform] = js.native
  var onVisibleChanged: ChangeListeners[RefreshComposite, visible] = js.native
  var onWidthChanged: ChangeListeners[RefreshComposite, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[RefreshComposite]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, RefreshComposite] = js.native
  ...
  def appendTo(parent: Composite[Widget]): RefreshComposite = js.native
  def detach(): RefreshComposite = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): RefreshComposite = js.native
  def insertBefore(widget: Widget): RefreshComposite = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): RefreshComposite = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): RefreshComposite = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): RefreshComposite = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): RefreshComposite = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): RefreshComposite = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): RefreshComposite = js.native
  def triggerAsync(`type`: String): js.Promise[RefreshComposite] = js.native
}
