...
object OmitPopovercontentView {
  ...
  def apply(
    ...
    cid: String,
    close: () => Popover,
    constructor: /* properties */ js.UndefOr[Properties[Omit[Popover, contentView], OmitOmitPopovercontentVie]] => js.Any,
    height: Dimension,
  ...
  @scala.inline
  implicit class OmitPopovercontentViewMutableBuilder[Self <: OmitPopovercontentView] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConstructor(
      value: /* properties */ js.UndefOr[Properties[Omit[Popover, contentView], OmitOmitPopovercontentVie]] => js.Any
    ...
    @scala.inline
    def setSet(value: /* properties */ Properties[Popover, Omit[Popover, set]] => Popover): Self = StObject.set(x, "set", js.Any.fromFunction1(value))
