...
trait OmitTextInputsetAbsoluteBounds extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): typings.tabris.global.tabris.widgets.TextInput
  @JSName("appendTo")
  ...
  def detach(): typings.tabris.global.tabris.widgets.TextInput
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.TextInput]
  ...
  def insertAfter(widget: Widget[Any]): typings.tabris.global.tabris.widgets.TextInput
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.TextInput]
  
  def insertBefore(widget: Widget[Any]): typings.tabris.global.tabris.widgets.TextInput
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.TextInput]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.TextInput
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.TextInput
  def on(
    `type`: String,
  ...
  var onAccept: Listeners[TextInputAcceptEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onAlignmentChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, alignment]
  
  var onAutoCapitalizeChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, autoCapitalize]
  
  var onAutoCorrectChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, autoCorrect]
  
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, baseline]
  
  var onBeforeTextChange: Listeners[TextInputBeforeTextChangeEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onBlur: Listeners[EventObject[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onBorderColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, borderColor]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, cornerRadius]
  
  var onCursorColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, cursorColor]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onEditableChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, editable]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, enabled]
  
  var onEnterKeyTypeChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, enterKeyType]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, excludeFromLayout]
  
  var onFloatMessageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, floatMessage]
  
  var onFocus: Listeners[EventObject[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onFocusedChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, focused]
  
  var onFontChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, font]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, id]
  
  var onInput: Listeners[TextInputInputEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onKeepFocusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, keepFocus]
  
  var onKeyboardAppearanceModeChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, keyboardAppearanceMode]
  
  var onKeyboardChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, keyboard]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onMaxCharsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, maxChars]
  
  var onMessageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, message]
  
  var onMessageColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, messageColor]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onRevealPasswordChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, revealPassword]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, right]
  
  var onSelect: Listeners[TextInputSelectEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onSelectionChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, selection]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onTextChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, text]
  
  var onTextColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, textColor]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.TextInput
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.TextInput
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.TextInput]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.TextInput]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.TextInput]
...
object OmitTextInputsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.TextInput,
    ...
    cornerRadius: Double,
    data: Any,
    detach: () => typings.tabris.global.tabris.widgets.TextInput,
    dispose: () => Unit,
    editable: Boolean,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.TextInput,
    insertBefore: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.TextInput,
    isDisposed: () => Boolean,
    ...
    maxChars: Double,
    message: String,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TextInput,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TextInput,
    onAccept: Listeners[TextInputAcceptEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onAlignmentChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, alignment],
    onAutoCapitalizeChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, autoCapitalize],
    onAutoCorrectChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, autoCorrect],
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, baseline],
    onBeforeTextChange: Listeners[TextInputBeforeTextChangeEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onBlur: Listeners[EventObject[typings.tabris.global.tabris.widgets.TextInput]],
    onBorderColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, borderColor],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, cornerRadius],
    onCursorColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, cursorColor],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.TextInput]],
    onEditableChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, editable],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, enabled],
    onEnterKeyTypeChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, enterKeyType],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, excludeFromLayout],
    onFloatMessageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, floatMessage],
    onFocus: Listeners[EventObject[typings.tabris.global.tabris.widgets.TextInput]],
    onFocusedChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, focused],
    onFontChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, font],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, id],
    onInput: Listeners[TextInputInputEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onKeepFocusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, keepFocus],
    onKeyboardAppearanceModeChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, keyboardAppearanceMode],
    onKeyboardChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, keyboard],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onMaxCharsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, maxChars],
    onMessageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, message],
    onMessageColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, messageColor],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onRevealPasswordChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, revealPassword],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, right],
    onSelect: Listeners[TextInputSelectEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onSelectionChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, selection],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onTextChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, text],
    onTextColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, textColor],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TextInput,
    opacity: Double,
    parent: () => Composite[Widget[Any]],
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.widgets.TextInput,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.TextInput],
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitTextInputsetAbsoluteBounds] (val x: Self) extends AnyVal {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.TextInput): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.TextInput): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.TextInput): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.TextInput): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TextInput
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TextInput
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAccept(value: Listeners[TextInputAcceptEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onAccept", value.asInstanceOf[js.Any])
    
    inline def setOnAlignmentChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, alignment]): Self = StObject.set(x, "onAlignmentChanged", value.asInstanceOf[js.Any])
    
    inline def setOnAutoCapitalizeChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, autoCapitalize]): Self = StObject.set(x, "onAutoCapitalizeChanged", value.asInstanceOf[js.Any])
    
    inline def setOnAutoCorrectChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, autoCorrect]): Self = StObject.set(x, "onAutoCorrectChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBeforeTextChange(value: Listeners[TextInputBeforeTextChangeEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onBeforeTextChange", value.asInstanceOf[js.Any])
    
    inline def setOnBlur(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onBlur", value.asInstanceOf[js.Any])
    
    inline def setOnBorderColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, borderColor]): Self = StObject.set(x, "onBorderColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCursorColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, cursorColor]): Self = StObject.set(x, "onCursorColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnEditableChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, editable]): Self = StObject.set(x, "onEditableChanged", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnterKeyTypeChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, enterKeyType]): Self = StObject.set(x, "onEnterKeyTypeChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnFloatMessageChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, floatMessage]): Self = StObject.set(x, "onFloatMessageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnFocus(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onFocus", value.asInstanceOf[js.Any])
    
    inline def setOnFocusedChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, focused]): Self = StObject.set(x, "onFocusedChanged", value.asInstanceOf[js.Any])
    
    inline def setOnFontChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, font]): Self = StObject.set(x, "onFontChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnInput(value: Listeners[TextInputInputEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onInput", value.asInstanceOf[js.Any])
    
    inline def setOnKeepFocusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, keepFocus]): Self = StObject.set(x, "onKeepFocusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnKeyboardAppearanceModeChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, keyboardAppearanceMode]): Self = StObject.set(x, "onKeyboardAppearanceModeChanged", value.asInstanceOf[js.Any])
    
    inline def setOnKeyboardChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, keyboard]): Self = StObject.set(x, "onKeyboardChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnMaxCharsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, maxChars]): Self = StObject.set(x, "onMaxCharsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnMessageChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, message]): Self = StObject.set(x, "onMessageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnMessageColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, messageColor]): Self = StObject.set(x, "onMessageColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRevealPasswordChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, revealPassword]): Self = StObject.set(x, "onRevealPasswordChanged", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[TextInputSelectEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnSelectionChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, selection]): Self = StObject.set(x, "onSelectionChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTextChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, text]): Self = StObject.set(x, "onTextChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTextColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, textColor]): Self = StObject.set(x, "onTextColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TextInput]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TextInput, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.TextInput): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.TextInput]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
