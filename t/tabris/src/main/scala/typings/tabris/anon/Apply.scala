...
trait Apply[T /* <: Composite[Widget[Any]] */, U /* <: Widget[Any] */] extends StObject {
...
object Apply {
  ...
  inline def apply[T /* <: Composite[Widget[Any]] */, U /* <: Widget[Any] */](): Apply[T, U] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Apply[T, U]]
  }
  
  extension [Self <: Apply[?, ?], T /* <: Composite[Widget[Any]] */, U /* <: Widget[Any] */](x: Self & (Apply[T, U])) {
