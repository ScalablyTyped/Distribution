...
import typings.tabris.global.tabris.Popover
...
object OmitOmitPopovercontentVieCid {
  ...
  inline def apply(
    ...
    cid: String,
    close: () => Popover,
    constructor: /* properties */ js.UndefOr[Properties[OmitPopovercontentViewCid, Omit[OmitPopovercontentViewCid, set]]] => js.Any,
    height: Dimension,
  ...
  extension [Self <: OmitOmitPopovercontentVieCid](x: Self) {
    ...
    inline def setConstructor(
      value: /* properties */ js.UndefOr[Properties[OmitPopovercontentViewCid, Omit[OmitPopovercontentViewCid, set]]] => js.Any
