...
import typings.tabris.mod.widgets.Canvas
...
trait OmitCanvasset extends StObject {
  ...
  def _apply[Target](options: Mode[Target]): Canvas
  def _apply[Target](options: Mode[Target], rules: js.Function1[/* widget */ Canvas, StringDictionary[js.Object]]): Canvas
  def _apply[Target](options: Mode[Target], rules: StringDictionary[js.Object]): Canvas
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ Mode[Canvas], 
    /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Canvas, StringDictionary[js.Object]]) | Null, 
    Canvas
  ]
  ...
  def append(widgets: Widget*): Canvas
  
  def appendTo(parent: Composite[Widget]): Canvas
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], Canvas]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, Canvas]
  
  @JSName("apply")
  def apply[Target](options: Mode[Target]): Canvas
  @JSName("apply")
  def apply[Target](options: Mode[Target], rules: js.Function1[/* widget */ Canvas, StringDictionary[js.Object]]): Canvas
  @JSName("apply")
  def apply[Target](options: Mode[Target], rules: StringDictionary[js.Object]): Canvas
  @JSName("apply")
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Canvas, Omit[Canvas, set]]], js.Any]
  ...
  def insertAfter(widget: Widget): Canvas
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Canvas]
  
  def insertBefore(widget: Widget): Canvas
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Canvas]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: (JSXAttributes[Canvas, Omit[Canvas, set | typings.tabris.tabrisStrings.jsxAttributes]]) & `3`
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): Canvas
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): Canvas
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  @JSName("toBlob")
  def toBlob_imagejpeg(callback: js.Function1[/* blob */ Blob, Unit], mimeType: imageSlashjpeg): Unit
  @JSName("toBlob")
  def toBlob_imagejpeg(callback: js.Function1[/* blob */ Blob, Unit], mimeType: imageSlashjpeg, quality: Double): Unit
  @JSName("toBlob")
  def toBlob_imagepng(callback: js.Function1[/* blob */ Blob, Unit], mimeType: imageSlashpng): Unit
  @JSName("toBlob")
  def toBlob_imagepng(callback: js.Function1[/* blob */ Blob, Unit], mimeType: imageSlashpng, quality: Double): Unit
  @JSName("toBlob")
  def toBlob_imagewebp(callback: js.Function1[/* blob */ Blob, Unit], mimeType: imageSlashwebp): Unit
  @JSName("toBlob")
  def toBlob_imagewebp(callback: js.Function1[/* blob */ Blob, Unit], mimeType: imageSlashwebp, quality: Double): Unit
...
object OmitCanvasset {
  ...
  def apply(
    ...
    _apply: (/* options */ Mode[Canvas], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Canvas, StringDictionary[js.Object]]) | Null) => Canvas,
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Widget => Canvas,
    appendTo: /* parent */ Composite[Widget] => Canvas,
    apply: (/* options */ Mode[Canvas], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Canvas, StringDictionary[js.Object]]) | Null) => Canvas,
    ...
    constructor: /* properties */ js.UndefOr[Properties[Canvas, Omit[Canvas, set]]] => js.Any,
    cornerRadius: Double,
    ...
    id: String,
    insertAfter: /* widget */ Widget => Canvas,
    insertBefore: /* widget */ Widget => Canvas,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[Canvas, Omit[Canvas, set | jsxAttributes]]) & `3`,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Canvas,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Canvas,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Canvas,
    opacity: Double,
    parent: () => Composite[Widget],
    right: ConstraintValue,
    siblings: /* selector */ js.UndefOr[Selector[Widget, Widget]] => WidgetCollection[Widget],
    toBlob: (/* callback */ js.Function1[/* blob */ Blob, Unit], /* mimeType */ js.UndefOr[imageSlashpng | imageSlashjpeg | imageSlashwebp], /* quality */ js.UndefOr[Double]) => Unit,
    top: ConstraintValue,
  ...
  implicit class OmitCanvassetMutableBuilder[Self <: OmitCanvasset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppend(value: /* repeated */ Widget => Canvas): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    @scala.inline
    def setAppendTo(value: /* parent */ Composite[Widget] => Canvas): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    @scala.inline
    def setApply(
      value: (/* options */ Mode[Canvas], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Canvas, StringDictionary[js.Object]]) | Null) => Canvas
    ...
    @scala.inline
    def setConstructor(value: /* properties */ js.UndefOr[Properties[Canvas, Omit[Canvas, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setDetach(value: () => Canvas): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setGetContext(value: (/* contextType */ String, /* width */ Double, /* height */ Double) => CanvasContext): Self = StObject.set(x, "getContext", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setInsertAfter(value: /* widget */ Widget => Canvas): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    @scala.inline
    def setInsertBefore(value: /* widget */ Widget => Canvas): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    @scala.inline
    def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    @scala.inline
    def setJsxAttributes(value: (JSXAttributes[Canvas, Omit[Canvas, set | jsxAttributes]]) & `3`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Canvas
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    @scala.inline
    def setOnAddChild(value: Listeners[CompositeAddChildEvent[Canvas]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBackgroundChanged(value: ChangeListeners[Canvas, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBaselineChanged(value: ChangeListeners[Canvas, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBottomChanged(value: ChangeListeners[Canvas, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBoundsChanged(value: ChangeListeners[Canvas, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterXChanged(value: ChangeListeners[Canvas, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterYChanged(value: ChangeListeners[Canvas, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassChanged(value: ChangeListeners[Canvas, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassListChanged(value: ChangeListeners[Canvas, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCornerRadiusChanged(value: ChangeListeners[Canvas, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDataChanged(value: ChangeListeners[Canvas, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDispose(value: Listeners[EventObject[Canvas]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnElevationChanged(value: ChangeListeners[Canvas, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnEnabledChanged(value: ChangeListeners[Canvas, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnExcludeFromLayoutChanged(value: ChangeListeners[Canvas, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHeightChanged(value: ChangeListeners[Canvas, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHighlightOnTouchChanged(value: ChangeListeners[Canvas, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnIdChanged(value: ChangeListeners[Canvas, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLayoutDataChanged(value: ChangeListeners[Canvas, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLeftChanged(value: ChangeListeners[Canvas, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLongPress(value: Listeners[WidgetLongPressEvent[Canvas]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnOpacityChanged(value: ChangeListeners[Canvas, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPan(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanDown(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanHorizontal(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanLeft(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanRight(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanUp(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanVertical(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[Canvas]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnResize(value: Listeners[WidgetResizeEvent[Canvas]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRightChanged(value: ChangeListeners[Canvas, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[Canvas]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[Canvas]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[Canvas]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[Canvas]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTap(value: Listeners[WidgetTapEvent[Canvas]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTopChanged(value: ChangeListeners[Canvas, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchCancel(value: Listeners[WidgetTouchEvent[Canvas]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchEnd(value: Listeners[WidgetTouchEvent[Canvas]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchMove(value: Listeners[WidgetTouchEvent[Canvas]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchStart(value: Listeners[WidgetTouchEvent[Canvas]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTransformChanged(value: ChangeListeners[Canvas, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnVisibleChanged(value: ChangeListeners[Canvas, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnWidthChanged(value: ChangeListeners[Canvas, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setToBlob(
      value: (/* callback */ js.Function1[/* blob */ Blob, Unit], /* mimeType */ js.UndefOr[imageSlashpng | imageSlashjpeg | imageSlashwebp], /* quality */ js.UndefOr[Double]) => Unit
    ): Self = StObject.set(x, "toBlob", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setTrigger(value: /* type */ String => Canvas): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTriggerAsync(value: /* type */ String => js.Promise[Canvas]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
