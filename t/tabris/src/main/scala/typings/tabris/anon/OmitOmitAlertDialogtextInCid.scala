...
import typings.tabris.global.tabris.AlertDialog
...
trait OmitOmitAlertDialogtextInCid extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[AlertDialog, Omit[AlertDialog, set | typings.tabris.tabrisStrings.jsxAttributes]]) & TextInputs
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): AlertDialog
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): AlertDialog
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitOmitAlertDialogtextInCid {
  ...
  inline def apply(
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => AlertDialog,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => AlertDialog,
    open: () => AlertDialog,
    title: String,
  ...
  extension [Self <: OmitOmitAlertDialogtextInCid](x: Self) {
    ...
    inline def setClose(value: () => AlertDialog): Self = StObject.set(x, "close", js.Any.fromFunction0(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => AlertDialog
    ...
    inline def setOpen(value: () => AlertDialog): Self = StObject.set(x, "open", js.Any.fromFunction0(value))
