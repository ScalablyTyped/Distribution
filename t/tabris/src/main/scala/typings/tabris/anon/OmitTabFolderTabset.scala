...
object OmitTabFolderTabset {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitTabFolderTabset[?], TabType /* <: Tab */] (val x: Self & OmitTabFolderTabset[TabType]) extends AnyVal {
    ...
    inline def setDetach(value: () => TabFolder[TabType]): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
