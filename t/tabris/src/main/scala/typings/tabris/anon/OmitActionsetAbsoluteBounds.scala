...
import typings.tabris.mod.widgets.Action
...
trait OmitActionsetAbsoluteBounds extends StObject {
  ...
  def appendTo(parent: NavigationView[Page, typings.tabris.mod.Action]): typings.tabris.global.tabris.widgets.Action
  @JSName("appendTo")
  var appendTo_Original: js.Function1[
    /* parent */ NavigationView[Page, typings.tabris.mod.Action], 
    typings.tabris.global.tabris.widgets.Action
  ]
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Action, Omit[Action, set]]], js.Any]
  ...
  def detach(): typings.tabris.global.tabris.widgets.Action
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.Action]
  ...
  def insertAfter(widget: Action): typings.tabris.global.tabris.widgets.Action
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Action, typings.tabris.global.tabris.widgets.Action]
  
  def insertBefore(widget: Action): typings.tabris.global.tabris.widgets.Action
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Action, typings.tabris.global.tabris.widgets.Action]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.Action
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.Action
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Action]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, id]
  
  var onImageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, image]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onPlacementChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, placement]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, right]
  
  var onSelect: Listeners[EventObject[typings.tabris.global.tabris.widgets.Action]]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onTitleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, title]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.Action
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def parent(): NavigationView[Page, typings.tabris.mod.Action]
  @JSName("parent")
  var parent_Original: js.Function0[NavigationView[Page, typings.tabris.mod.Action]]
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.Action
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.Action]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.Action]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.Action]
...
object OmitActionsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ NavigationView[Page, typings.tabris.mod.Action] => typings.tabris.global.tabris.widgets.Action,
    ...
    constructor: /* properties */ js.UndefOr[Properties[Action, Omit[Action, set]]] => js.Any,
    cornerRadius: Double,
    data: StringDictionary[js.Any],
    detach: () => typings.tabris.global.tabris.widgets.Action,
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Action => typings.tabris.global.tabris.widgets.Action,
    insertBefore: /* widget */ Action => typings.tabris.global.tabris.widgets.Action,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[
      typings.tabris.global.tabris.widgets.Action, 
      Omit[typings.tabris.global.tabris.widgets.Action, set | jsxAttributes]
    ]) & `1`,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Action,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Action,
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Action]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, id],
    onImageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, image],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Action]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]],
    onPlacementChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, placement],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Action]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, right],
    onSelect: Listeners[EventObject[typings.tabris.global.tabris.widgets.Action]],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Action]],
    onTitleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, title],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Action, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Action,
    opacity: Double,
    parent: () => NavigationView[Page, typings.tabris.mod.Action],
  ...
  extension [Self <: OmitActionsetAbsoluteBounds](x: Self) {
    ...
    inline def setAppendTo(
      value: /* parent */ NavigationView[Page, typings.tabris.mod.Action] => typings.tabris.global.tabris.widgets.Action
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[Action, Omit[Action, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.Action): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Action => typings.tabris.global.tabris.widgets.Action): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Action => typings.tabris.global.tabris.widgets.Action): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Action
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Action
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnImageChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, image]): Self = StObject.set(x, "onImageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnPlacementChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, placement]): Self = StObject.set(x, "onPlacementChanged", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTitleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, title]): Self = StObject.set(x, "onTitleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Action]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Action, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setParent(value: () => NavigationView[Page, typings.tabris.mod.Action]): Self = StObject.set(x, "parent", js.Any.fromFunction0(value))
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.Action): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Action]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
