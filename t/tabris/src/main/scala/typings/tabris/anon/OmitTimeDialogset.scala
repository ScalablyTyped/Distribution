...
trait OmitTimeDialogset extends StObject {
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[TimeDialog, Omit[TimeDialog, set]]], Any]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): TimeDialog
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): TimeDialog
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
...
object OmitTimeDialogset {
  ...
  inline def apply(
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => TimeDialog,
    open: () => TimeDialog,
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitTimeDialogset] (val x: Self) extends AnyVal {
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[TimeDialog, Omit[TimeDialog, set]]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => TimeDialog
