...
trait OmitTimeDialogset extends StObject {
  ...
  def close(): TimeDialog
  @JSName("close")
  var close_Original: js.Function0[TimeDialog]
  
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[TimeDialog, Omit[TimeDialog, set]]], js.Any]
  ...
  var jsxAttributes: JSXAttributes[TimeDialog, Omit[TimeDialog, set | typings.tabris.tabrisStrings.jsxAttributes]]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): TimeDialog
  def on(
    `type`: String,
  ...
  var onClose: Listeners[TimeDialogCloseEvent[TimeDialog]]
  
  var onDateChanged: ChangeListeners[TimeDialog, date]
  
  var onSelect: Listeners[TimeDialogSelectEvent[TimeDialog]]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): TimeDialog
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def open(): TimeDialog
  @JSName("open")
  var open_Original: js.Function0[TimeDialog]
  
  def trigger(`type`: String): TimeDialog
  
  def triggerAsync(`type`: String): js.Promise[TimeDialog]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[TimeDialog]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, TimeDialog]
}
object OmitTimeDialogset {
  ...
  extension [Self <: OmitTimeDialogset](x: Self) {
    ...
    inline def setClose(value: () => TimeDialog): Self = StObject.set(x, "close", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[TimeDialog, Omit[TimeDialog, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setJsxAttributes(value: JSXAttributes[TimeDialog, Omit[TimeDialog, set | jsxAttributes]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => TimeDialog
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnClose(value: Listeners[TimeDialogCloseEvent[TimeDialog]]): Self = StObject.set(x, "onClose", value.asInstanceOf[js.Any])
    
    inline def setOnDateChanged(value: ChangeListeners[TimeDialog, date]): Self = StObject.set(x, "onDateChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[TimeDialogSelectEvent[TimeDialog]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnce(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => TimeDialog
    ): Self = StObject.set(x, "once", js.Any.fromFunction3(value))
    
    inline def setOpen(value: () => TimeDialog): Self = StObject.set(x, "open", js.Any.fromFunction0(value))
    
    inline def setTrigger(value: /* type */ String => TimeDialog): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[TimeDialog]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
