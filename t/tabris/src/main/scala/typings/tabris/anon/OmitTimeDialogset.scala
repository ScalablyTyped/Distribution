...
object OmitTimeDialogset {
  ...
  @scala.inline
  implicit class OmitTimeDialogsetMutableBuilder[Self <: OmitTimeDialogset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClose(value: () => TimeDialog): Self = StObject.set(x, "close", js.Any.fromFunction0(value))
    
    @scala.inline
    def setConstructor(value: /* properties */ js.UndefOr[Properties[TimeDialog, Omit[TimeDialog, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setJsxAttributes(value: JSXAttributes[TimeDialog, Omit[TimeDialog, set | jsxAttributes]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnClose(value: Listeners[TimeDialogCloseEvent[TimeDialog]]): Self = StObject.set(x, "onClose", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDateChanged(value: ChangeListeners[TimeDialog, date]): Self = StObject.set(x, "onDateChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSelect(value: Listeners[TimeDialogSelectEvent[TimeDialog]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOpen(value: () => TimeDialog): Self = StObject.set(x, "open", js.Any.fromFunction0(value))
    
    @scala.inline
    def setTrigger(value: /* type */ String => TimeDialog): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTriggerAsync(value: /* type */ String => js.Promise[TimeDialog]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
