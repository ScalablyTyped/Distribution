...
trait `24`[Target] extends StObject {
...
object `24` {
  ...
  inline def apply[Target](): `24`[Target] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`24`[Target]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `24`[?], Target] (val x: Self & `24`[Target]) extends AnyVal {
