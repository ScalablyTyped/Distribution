...
trait OmitTabsetAbsoluteBounds extends StObject {
  ...
  def _apply[Target](options: `27`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.Tab]): typings.tabris.global.tabris.widgets.Tab
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `27`[typings.tabris.global.tabris.widgets.Tab], 
  ...
  @JSName("apply")
  def apply[Target](options: `27`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.Tab]): typings.tabris.global.tabris.widgets.Tab
  @JSName("apply")
  ...
  var jsxAttributes: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.Tab, Widget[Any]]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Tab
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Tab
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
...
object OmitTabsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `27`[typings.tabris.global.tabris.widgets.Tab], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Tab]) => typings.tabris.global.tabris.widgets.Tab,
    _checkDisposed: () => Unit,
    ...
    apply: (/* options */ `27`[typings.tabris.global.tabris.widgets.Tab], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Tab]) => typings.tabris.global.tabris.widgets.Tab,
    badge: Double,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Tab,
  ...
  extension [Self <: OmitTabsetAbsoluteBounds](x: Self) {
    ...
    inline def setApply(
      value: (/* options */ `27`[typings.tabris.global.tabris.widgets.Tab], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Tab]) => typings.tabris.global.tabris.widgets.Tab
    ...
    inline def setJsxAttributes(value: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.Tab, Widget[Any]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Tab
