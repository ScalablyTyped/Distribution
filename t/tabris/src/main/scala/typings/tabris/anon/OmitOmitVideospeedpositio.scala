...
trait OmitOmitVideospeedpositio extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[Video, Omit[Video, set | typings.tabris.tabrisStrings.jsxAttributes]]) & js.Object & Children
...
object OmitOmitVideospeedpositio {
  ...
  inline def apply(
    ...
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[Video, Omit[Video, set | jsxAttributes]]) & js.Object & Children,
  ...
  extension [Self <: OmitOmitVideospeedpositio](x: Self) {
    ...
    inline def setJsxAttributes(value: (JSXAttributes[Video, Omit[Video, set | jsxAttributes]]) & js.Object & Children): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
