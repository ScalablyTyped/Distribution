...
object OmitOmitVideospeedpositio {
  ...
  extension [Self <: OmitOmitVideospeedpositio](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => Video): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => Video): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => Video): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => Video): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[Video, Omit[Video, set | jsxAttributes]]) & js.Object): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
