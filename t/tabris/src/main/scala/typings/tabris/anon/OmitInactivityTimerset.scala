...
trait OmitInactivityTimerset extends StObject {
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): InactivityTimer
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): InactivityTimer
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
...
object OmitInactivityTimerset {
  ...
  inline def apply(
    ...
    cancel: () => Unit,
    cid: String,
    constructor: /* properties */ js.UndefOr[Properties[InactivityTimer, Omit[InactivityTimer, set]]] => Any,
    delay: Double,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => InactivityTimer,
    onDelayChanged: ChangeListeners[InactivityTimer, delay],
    onTimeout: Listeners[EventObject[InactivityTimer]],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => InactivityTimer,
    start: () => Unit,
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitInactivityTimerset] (val x: Self) extends AnyVal {
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[InactivityTimer, Omit[InactivityTimer, set]]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => InactivityTimer
