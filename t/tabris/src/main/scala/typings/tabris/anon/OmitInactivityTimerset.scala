...
object OmitInactivityTimerset {
  ...
  @scala.inline
  implicit class OmitInactivityTimersetMutableBuilder[Self <: OmitInactivityTimerset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJsxAttributes(value: JSXAttributes[InactivityTimer, Omit[InactivityTimer, set | jsxAttributes]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnDelayChanged(value: ChangeListeners[InactivityTimer, delay]): Self = StObject.set(x, "onDelayChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTimeout(value: Listeners[EventObject[InactivityTimer]]): Self = StObject.set(x, "onTimeout", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTrigger(value: /* type */ String => InactivityTimer): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTriggerAsync(value: /* type */ String => js.Promise[InactivityTimer]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
