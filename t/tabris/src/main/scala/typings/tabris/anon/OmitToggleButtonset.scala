...
object OmitToggleButtonset {
  ...
  extension [Self <: OmitToggleButtonset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => ToggleButton): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => ToggleButton): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => ToggleButton): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => ToggleButton): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[ToggleButton, Omit[ToggleButton, set | jsxAttributes]]) & `1`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
