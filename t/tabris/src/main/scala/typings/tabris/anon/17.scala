...
trait `17`[Target] extends StObject {
...
object `17` {
  ...
  @scala.inline
  def apply[Target](): `17`[Target] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`17`[Target]]
  }
  
  @scala.inline
  implicit class `17MutableBuilder`[Self <: `17`[?], Target] (val x: Self & `17`[Target]) extends AnyVal {
