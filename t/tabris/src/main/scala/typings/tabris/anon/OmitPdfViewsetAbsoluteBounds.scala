...
trait OmitPdfViewsetAbsoluteBounds extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): typings.tabris.global.tabris.widgets.PdfView
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], typings.tabris.global.tabris.widgets.PdfView]
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[PdfView, Omit[PdfView, set]]], Any]
  ...
  def detach(): typings.tabris.global.tabris.widgets.PdfView
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.PdfView]
  ...
  def insertAfter(widget: Widget[Any]): typings.tabris.global.tabris.widgets.PdfView
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.PdfView]
  
  def insertBefore(widget: Widget[Any]): typings.tabris.global.tabris.widgets.PdfView
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.PdfView]
  ...
  var jsxAttributes: (JSXAttributes[
    typings.tabris.global.tabris.widgets.PdfView, 
    Omit[
      typings.tabris.global.tabris.widgets.PdfView, 
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.PdfView
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.PdfView
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, id]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, left]
  
  var onLoad: Listeners[PdfViewLoadEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, opacity]
  
  var onPageBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, pageBackground]
  
  var onPageElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, pageElevation]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, right]
  
  var onSpacingChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, spacing]
  
  var onSrcChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, src]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, width]
  
  var onZoomEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, zoomEnabled]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.PdfView
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.PdfView
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.PdfView]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.PdfView]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.PdfView]
...
object OmitPdfViewsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.PdfView,
    ...
    constructor: /* properties */ js.UndefOr[Properties[PdfView, Omit[PdfView, set]]] => Any,
    cornerRadius: Double,
    data: Any,
    detach: () => typings.tabris.global.tabris.widgets.PdfView,
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.PdfView,
    insertBefore: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.PdfView,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[
      typings.tabris.global.tabris.widgets.PdfView, 
      Omit[typings.tabris.global.tabris.widgets.PdfView, set | jsxAttributes]
    ]) & `4`,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.PdfView,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.PdfView,
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.PdfView]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, id],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, left],
    onLoad: Listeners[PdfViewLoadEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, opacity],
    onPageBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, pageBackground],
    onPageElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, pageElevation],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, right],
    onSpacingChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, spacing],
    onSrcChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, src],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, width],
    onZoomEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, zoomEnabled],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.PdfView,
    opacity: Double,
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.widgets.PdfView,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.PdfView],
    visible: Boolean,
    width: Dimension | auto,
    zoomEnabled: Boolean
  ): OmitPdfViewsetAbsoluteBounds = {
    ...
    __obj.asInstanceOf[OmitPdfViewsetAbsoluteBounds]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPdfViewsetAbsoluteBounds] (val x: Self) extends AnyVal {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.PdfView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[PdfView, Omit[PdfView, set]]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.PdfView): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.PdfView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.PdfView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.PdfView
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.PdfView
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLoad(value: Listeners[PdfViewLoadEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onLoad", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPageBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, pageBackground]): Self = StObject.set(x, "onPageBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPageElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, pageElevation]): Self = StObject.set(x, "onPageElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSpacingChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, spacing]): Self = StObject.set(x, "onSpacingChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSrcChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, src]): Self = StObject.set(x, "onSrcChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.PdfView]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    
    inline def setOnZoomEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.PdfView, zoomEnabled]): Self = StObject.set(x, "onZoomEnabledChanged", value.asInstanceOf[js.Any])
    ...
    inline def setPageBackground(value: ColorValue): Self = StObject.set(x, "pageBackground", value.asInstanceOf[js.Any])
    
    inline def setPageBackgroundNull: Self = StObject.set(x, "pageBackground", null)
    
    inline def setPageElevation(value: Double): Self = StObject.set(x, "pageElevation", value.asInstanceOf[js.Any])
    ...
    inline def setSpacing(value: Dimension): Self = StObject.set(x, "spacing", value.asInstanceOf[js.Any])
    
    inline def setSrc(value: String | Blob): Self = StObject.set(x, "src", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.PdfView): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.PdfView]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
