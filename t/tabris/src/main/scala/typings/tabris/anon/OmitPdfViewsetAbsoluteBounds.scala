...
trait OmitPdfViewsetAbsoluteBounds extends StObject {
  ...
  def appendTo(parent: Composite[Widget]): typings.tabris.global.tabris.widgets.PdfView
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], typings.tabris.global.tabris.widgets.PdfView]
  ...
  def insertAfter(widget: Widget): typings.tabris.global.tabris.widgets.PdfView
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.PdfView]
  
  def insertBefore(widget: Widget): typings.tabris.global.tabris.widgets.PdfView
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.PdfView]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.PdfView
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.PdfView
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitPdfViewsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.PdfView,
    ...
    id: String,
    insertAfter: /* widget */ Widget => typings.tabris.global.tabris.widgets.PdfView,
    insertBefore: /* widget */ Widget => typings.tabris.global.tabris.widgets.PdfView,
    isDisposed: () => Boolean,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.PdfView,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.PdfView,
    opacity: Double,
  ...
  extension [Self <: OmitPdfViewsetAbsoluteBounds](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.PdfView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[PdfView, Omit[PdfView, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.PdfView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.PdfView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.PdfView
