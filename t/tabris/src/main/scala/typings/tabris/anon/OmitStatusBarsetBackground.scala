...
trait OmitStatusBarsetBackground extends StObject {
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[StatusBar_, Omit[StatusBar_, set]]], js.Any]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.StatusBar_
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.StatusBar_
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitStatusBarsetBackground {
  ...
  inline def apply(
    ...
    cid: String,
    constructor: /* properties */ js.UndefOr[Properties[StatusBar_, Omit[StatusBar_, set]]] => js.Any,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.StatusBar_,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.StatusBar_,
  ...
  extension [Self <: OmitStatusBarsetBackground](x: Self) {
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[StatusBar_, Omit[StatusBar_, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.StatusBar_
