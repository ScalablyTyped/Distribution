...
object OmitPickerset {
  ...
  extension [Self <: OmitPickerset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => Picker): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => Picker): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => Picker): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => Picker): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setJsxAttributes(value: (JSXAttributes[Picker, Omit[Picker, set | jsxAttributes]]) & PartialPickPickeritemText): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
