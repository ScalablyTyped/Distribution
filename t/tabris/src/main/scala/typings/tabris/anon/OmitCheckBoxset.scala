...
trait OmitCheckBoxset extends StObject {
  ...
  def appendTo(parent: Composite[Widget]): CheckBox
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], CheckBox]
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[CheckBox, Omit[CheckBox, set]]], js.Any]
  ...
  def detach(): CheckBox
  @JSName("detach")
  var detach_Original: js.Function0[CheckBox]
  ...
  def insertAfter(widget: Widget): CheckBox
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, CheckBox]
  
  def insertBefore(widget: Widget): CheckBox
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, CheckBox]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: (JSXAttributes[CheckBox, Omit[CheckBox, set | typings.tabris.tabrisStrings.jsxAttributes]]) & `1`
  
  var layoutData: LayoutDataValue
  
  var left: ConstraintValue
  
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): CheckBox
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): CheckBox
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[CheckBox, background]
  
  var onBaselineChanged: ChangeListeners[CheckBox, baseline]
  
  var onBottomChanged: ChangeListeners[CheckBox, bottom]
  
  var onBoundsChanged: ChangeListeners[CheckBox, bounds]
  
  var onCenterXChanged: ChangeListeners[CheckBox, centerX]
  
  var onCenterYChanged: ChangeListeners[CheckBox, centerY]
  
  var onCheckedChanged: ChangeListeners[CheckBox, checked]
  
  var onCheckedTintColorChanged: ChangeListeners[CheckBox, checkedTintColor]
  
  var onClassChanged: ChangeListeners[CheckBox, `class`]
  
  var onClassListChanged: ChangeListeners[CheckBox, classList]
  
  var onCornerRadiusChanged: ChangeListeners[CheckBox, cornerRadius]
  
  var onDataChanged: ChangeListeners[CheckBox, data]
  
  var onDispose: Listeners[EventObject[CheckBox]]
  
  var onElevationChanged: ChangeListeners[CheckBox, elevation]
  
  var onEnabledChanged: ChangeListeners[CheckBox, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[CheckBox, excludeFromLayout]
  
  var onFontChanged: ChangeListeners[CheckBox, font]
  
  var onHeightChanged: ChangeListeners[CheckBox, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[CheckBox, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[CheckBox, id]
  
  var onLayoutDataChanged: ChangeListeners[CheckBox, layoutData]
  
  var onLeftChanged: ChangeListeners[CheckBox, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[CheckBox]]
  
  var onOpacityChanged: ChangeListeners[CheckBox, opacity]
  
  var onPan: Listeners[WidgetPanEvent[CheckBox]]
  
  var onPanDown: Listeners[WidgetPanEvent[CheckBox]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[CheckBox]]
  
  var onPanLeft: Listeners[WidgetPanEvent[CheckBox]]
  
  var onPanRight: Listeners[WidgetPanEvent[CheckBox]]
  
  var onPanUp: Listeners[WidgetPanEvent[CheckBox]]
  
  var onPanVertical: Listeners[WidgetPanEvent[CheckBox]]
  
  var onResize: Listeners[WidgetResizeEvent[CheckBox]]
  
  var onRightChanged: ChangeListeners[CheckBox, right]
  
  var onSelect: Listeners[CheckBoxSelectEvent[CheckBox]]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[CheckBox]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[CheckBox]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[CheckBox]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[CheckBox]]
  
  var onTap: Listeners[WidgetTapEvent[CheckBox]]
  
  var onTextChanged: ChangeListeners[CheckBox, text]
  
  var onTextColorChanged: ChangeListeners[CheckBox, textColor]
  
  var onTintColorChanged: ChangeListeners[CheckBox, tintColor]
  
  var onTopChanged: ChangeListeners[CheckBox, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[CheckBox]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[CheckBox]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[CheckBox]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[CheckBox]]
  
  var onTransformChanged: ChangeListeners[CheckBox, transform]
  
  var onVisibleChanged: ChangeListeners[CheckBox, visible]
  
  var onWidthChanged: ChangeListeners[CheckBox, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): CheckBox
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def trigger(`type`: String): CheckBox
  
  def triggerAsync(`type`: String): js.Promise[CheckBox]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[CheckBox]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, CheckBox]
  
  var visible: Boolean
  
  var width: Dimension | auto
}
object OmitCheckBoxset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget] => CheckBox,
    ...
    constructor: /* properties */ js.UndefOr[Properties[CheckBox, Omit[CheckBox, set]]] => js.Any,
    cornerRadius: Double,
    ...
    id: String,
    insertAfter: /* widget */ Widget => CheckBox,
    insertBefore: /* widget */ Widget => CheckBox,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[CheckBox, Omit[CheckBox, set | jsxAttributes]]) & `1`,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => CheckBox,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => CheckBox,
    onBackgroundChanged: ChangeListeners[CheckBox, background],
    onBaselineChanged: ChangeListeners[CheckBox, baseline],
    onBottomChanged: ChangeListeners[CheckBox, bottom],
    onBoundsChanged: ChangeListeners[CheckBox, bounds],
    onCenterXChanged: ChangeListeners[CheckBox, centerX],
    onCenterYChanged: ChangeListeners[CheckBox, centerY],
    onCheckedChanged: ChangeListeners[CheckBox, checked],
    onCheckedTintColorChanged: ChangeListeners[CheckBox, checkedTintColor],
    onClassChanged: ChangeListeners[CheckBox, `class`],
    onClassListChanged: ChangeListeners[CheckBox, classList],
    onCornerRadiusChanged: ChangeListeners[CheckBox, cornerRadius],
    onDataChanged: ChangeListeners[CheckBox, data],
    onDispose: Listeners[EventObject[CheckBox]],
    onElevationChanged: ChangeListeners[CheckBox, elevation],
    onEnabledChanged: ChangeListeners[CheckBox, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[CheckBox, excludeFromLayout],
    onFontChanged: ChangeListeners[CheckBox, font],
    onHeightChanged: ChangeListeners[CheckBox, height],
    onHighlightOnTouchChanged: ChangeListeners[CheckBox, highlightOnTouch],
    onIdChanged: ChangeListeners[CheckBox, id],
    onLayoutDataChanged: ChangeListeners[CheckBox, layoutData],
    onLeftChanged: ChangeListeners[CheckBox, left],
    onLongPress: Listeners[WidgetLongPressEvent[CheckBox]],
    onOpacityChanged: ChangeListeners[CheckBox, opacity],
    onPan: Listeners[WidgetPanEvent[CheckBox]],
    onPanDown: Listeners[WidgetPanEvent[CheckBox]],
    onPanHorizontal: Listeners[WidgetPanEvent[CheckBox]],
    onPanLeft: Listeners[WidgetPanEvent[CheckBox]],
    onPanRight: Listeners[WidgetPanEvent[CheckBox]],
    onPanUp: Listeners[WidgetPanEvent[CheckBox]],
    onPanVertical: Listeners[WidgetPanEvent[CheckBox]],
    onResize: Listeners[WidgetResizeEvent[CheckBox]],
    onRightChanged: ChangeListeners[CheckBox, right],
    onSelect: Listeners[CheckBoxSelectEvent[CheckBox]],
    onSwipeDown: Listeners[WidgetSwipeEvent[CheckBox]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[CheckBox]],
    onSwipeRight: Listeners[WidgetSwipeEvent[CheckBox]],
    onSwipeUp: Listeners[WidgetSwipeEvent[CheckBox]],
    onTap: Listeners[WidgetTapEvent[CheckBox]],
    onTextChanged: ChangeListeners[CheckBox, text],
    onTextColorChanged: ChangeListeners[CheckBox, textColor],
    onTintColorChanged: ChangeListeners[CheckBox, tintColor],
    onTopChanged: ChangeListeners[CheckBox, top],
    onTouchCancel: Listeners[WidgetTouchEvent[CheckBox]],
    onTouchEnd: Listeners[WidgetTouchEvent[CheckBox]],
    onTouchMove: Listeners[WidgetTouchEvent[CheckBox]],
    onTouchStart: Listeners[WidgetTouchEvent[CheckBox]],
    onTransformChanged: ChangeListeners[CheckBox, transform],
    onVisibleChanged: ChangeListeners[CheckBox, visible],
    onWidthChanged: ChangeListeners[CheckBox, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => CheckBox,
    opacity: Double,
    ...
    trigger: /* type */ String => CheckBox,
    triggerAsync: /* type */ String => js.Promise[CheckBox],
    visible: Boolean,
  ...
  extension [Self <: OmitCheckBoxset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => CheckBox): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[CheckBox, Omit[CheckBox, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => CheckBox): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => CheckBox): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => CheckBox): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[CheckBox, Omit[CheckBox, set | jsxAttributes]]) & `1`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => CheckBox
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => CheckBox
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[CheckBox, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[CheckBox, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[CheckBox, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[CheckBox, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[CheckBox, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[CheckBox, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCheckedChanged(value: ChangeListeners[CheckBox, checked]): Self = StObject.set(x, "onCheckedChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCheckedTintColorChanged(value: ChangeListeners[CheckBox, checkedTintColor]): Self = StObject.set(x, "onCheckedTintColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[CheckBox, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[CheckBox, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[CheckBox, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[CheckBox, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[CheckBox]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[CheckBox, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[CheckBox, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[CheckBox, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnFontChanged(value: ChangeListeners[CheckBox, font]): Self = StObject.set(x, "onFontChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[CheckBox, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[CheckBox, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[CheckBox, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[CheckBox, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[CheckBox, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[CheckBox]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[CheckBox, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[CheckBox]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[CheckBox]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[CheckBox]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[CheckBox]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[CheckBox]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[CheckBox]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[CheckBox]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[CheckBox]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[CheckBox, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[CheckBoxSelectEvent[CheckBox]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[CheckBox]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[CheckBox]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[CheckBox]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[CheckBox]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[CheckBox]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTextChanged(value: ChangeListeners[CheckBox, text]): Self = StObject.set(x, "onTextChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTextColorChanged(value: ChangeListeners[CheckBox, textColor]): Self = StObject.set(x, "onTextColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTintColorChanged(value: ChangeListeners[CheckBox, tintColor]): Self = StObject.set(x, "onTintColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[CheckBox, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[CheckBox]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[CheckBox]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[CheckBox]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[CheckBox]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[CheckBox, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[CheckBox, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[CheckBox, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => CheckBox): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[CheckBox]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
