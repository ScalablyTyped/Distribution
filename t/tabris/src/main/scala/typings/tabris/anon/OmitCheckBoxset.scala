...
trait OmitCheckBoxset extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): CheckBox
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], CheckBox]
  ...
  def insertAfter(widget: Widget[Any]): CheckBox
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], CheckBox]
  
  def insertBefore(widget: Widget[Any]): CheckBox
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], CheckBox]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: (JSXAttributes[CheckBox, Omit[CheckBox, set | typings.tabris.tabrisStrings.jsxAttributes]]) & Children
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): CheckBox
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): CheckBox
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
...
object OmitCheckBoxset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => CheckBox,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => CheckBox,
    insertBefore: /* widget */ Widget[Any] => CheckBox,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[CheckBox, Omit[CheckBox, set | jsxAttributes]]) & Children,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => CheckBox,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => CheckBox,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => CheckBox,
    opacity: Double,
  ...
  extension [Self <: OmitCheckBoxset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => CheckBox): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => CheckBox): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => CheckBox): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[CheckBox, Omit[CheckBox, set | jsxAttributes]]) & Children): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => CheckBox
