...
trait OmitCompositeWidgetsetAbsoluteBounds[ChildType /* <: Widget */] extends StObject {
  ...
  def _apply[Target](options: `21`[Target]): typings.tabris.global.tabris.widgets.Composite[ChildType]
  def _apply[Target](
    options: `21`[Target],
    rules: js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.Composite[ChildType], 
      StringDictionary[js.Object]
    ]
  ): typings.tabris.global.tabris.widgets.Composite[ChildType]
  def _apply[Target](options: `21`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.widgets.Composite[ChildType]
  @JSName("_apply")
  ...
  def append(widgets: Widget*): typings.tabris.global.tabris.widgets.Composite[ChildType]
  
  def appendTo(parent: typings.tabris.mod.Composite[Widget]): typings.tabris.global.tabris.widgets.Composite[ChildType]
  @JSName("appendTo")
  ...
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, typings.tabris.global.tabris.widgets.Composite[ChildType]]
  
  @JSName("apply")
  def apply[Target](options: `21`[Target]): typings.tabris.global.tabris.widgets.Composite[ChildType]
  @JSName("apply")
  def apply[Target](
    options: `21`[Target],
    rules: js.Function1[
  ...
  @JSName("apply")
  def apply[Target](options: `21`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.widgets.Composite[ChildType]
  @JSName("apply")
  ...
  def insertAfter(widget: Widget): typings.tabris.global.tabris.widgets.Composite[ChildType]
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.Composite[ChildType]]
  
  def insertBefore(widget: Widget): typings.tabris.global.tabris.widgets.Composite[ChildType]
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.Composite[ChildType]]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.Composite[ChildType]
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.Composite[ChildType]
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitCompositeWidgetsetAbsoluteBounds {
  ...
  inline def apply[ChildType /* <: Widget */](
    ...
    _apply: (/* options */ `21`[typings.tabris.global.tabris.widgets.Composite[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.Composite[ChildType], 
      StringDictionary[js.Object]
    ]) | Null) => typings.tabris.global.tabris.widgets.Composite[ChildType],
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Widget => typings.tabris.global.tabris.widgets.Composite[ChildType],
    appendTo: /* parent */ typings.tabris.mod.Composite[Widget] => typings.tabris.global.tabris.widgets.Composite[ChildType],
    apply: (/* options */ `21`[typings.tabris.global.tabris.widgets.Composite[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.Composite[ChildType], 
      StringDictionary[js.Object]
    ]) | Null) => typings.tabris.global.tabris.widgets.Composite[ChildType],
    ...
    id: String,
    insertAfter: /* widget */ Widget => typings.tabris.global.tabris.widgets.Composite[ChildType],
    insertBefore: /* widget */ Widget => typings.tabris.global.tabris.widgets.Composite[ChildType],
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[
      typings.tabris.global.tabris.widgets.Composite[ChildType], 
      Omit[typings.tabris.global.tabris.widgets.Composite[ChildType], set | jsxAttributes]
    ]) & `3`,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Composite[ChildType],
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Composite[ChildType],
    opacity: Double,
    parent: () => typings.tabris.mod.Composite[Widget],
    ...
    __obj.asInstanceOf[OmitCompositeWidgetsetAbsoluteBounds[ChildType]]
  }
  
  extension [Self <: OmitCompositeWidgetsetAbsoluteBounds[?], ChildType /* <: Widget */](x: Self & OmitCompositeWidgetsetAbsoluteBounds[ChildType]) {
    ...
    inline def setAppend(value: /* repeated */ Widget => typings.tabris.global.tabris.widgets.Composite[ChildType]): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(
      value: /* parent */ typings.tabris.mod.Composite[Widget] => typings.tabris.global.tabris.widgets.Composite[ChildType]
    ): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `21`[typings.tabris.global.tabris.widgets.Composite[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[
          /* widget */ typings.tabris.global.tabris.widgets.Composite[ChildType], 
          StringDictionary[js.Object]
        ]) | Null) => typings.tabris.global.tabris.widgets.Composite[ChildType]
    ...
    inline def setInsertAfter(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.Composite[ChildType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.Composite[ChildType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Composite[ChildType]
