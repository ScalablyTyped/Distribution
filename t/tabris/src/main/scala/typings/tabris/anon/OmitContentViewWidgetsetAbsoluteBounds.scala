...
/* Inlined tabris.tabris.Omit<tabris.tabris.ContentView<tabris.tabris.Widget>, 'set'> */
trait OmitContentViewWidgetsetAbsoluteBounds[ChildType /* <: Widget */] extends StObject {
  ...
  def _apply[Target](options: `30`[Target]): typings.tabris.global.tabris.ContentView_[ChildType]
  def _apply[Target](
    options: `30`[Target],
    rules: js.Function1[
      /* widget */ typings.tabris.global.tabris.ContentView_[ChildType], 
      StringDictionary[js.Object]
    ]
  ): typings.tabris.global.tabris.ContentView_[ChildType]
  def _apply[Target](options: `30`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.ContentView_[ChildType]
  @JSName("_apply")
  ...
  def append(widgets: Widget*): typings.tabris.global.tabris.ContentView_[ChildType]
  
  def appendTo(parent: Composite[Widget]): typings.tabris.global.tabris.ContentView_[ChildType]
  @JSName("appendTo")
  ...
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, typings.tabris.global.tabris.ContentView_[ChildType]]
  
  @JSName("apply")
  def apply[Target](options: `30`[Target]): typings.tabris.global.tabris.ContentView_[ChildType]
  @JSName("apply")
  def apply[Target](
    options: `30`[Target],
    rules: js.Function1[
  ...
  @JSName("apply")
  def apply[Target](options: `30`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.ContentView_[ChildType]
  @JSName("apply")
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[Properties[ContentView_[Widget], Omit[ContentView_[Widget], set]]], 
    js.Any
  ]
  ...
  def detach(): typings.tabris.global.tabris.ContentView_[ChildType]
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.ContentView_[ChildType]]
  ...
  def insertAfter(widget: Widget): typings.tabris.global.tabris.ContentView_[ChildType]
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.ContentView_[ChildType]]
  
  def insertBefore(widget: Widget): typings.tabris.global.tabris.ContentView_[ChildType]
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.ContentView_[ChildType]]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.ContentView_[ChildType]
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.ContentView_[ChildType]
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], id]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.ContentView_[ChildType]
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.ContentView_[ChildType]
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.ContentView_[ChildType]]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[
    /* type */ String, 
    js.Promise[typings.tabris.global.tabris.ContentView_[ChildType]]
  ]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.ContentView_[ChildType]]
  
  var visible: Boolean
  
  var width: Dimension | auto
}
object OmitContentViewWidgetsetAbsoluteBounds {
  
  inline def apply[ChildType /* <: Widget */](
    ...
    _apply: (/* options */ `30`[typings.tabris.global.tabris.ContentView_[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[
      /* widget */ typings.tabris.global.tabris.ContentView_[ChildType], 
      StringDictionary[js.Object]
    ]) | Null) => typings.tabris.global.tabris.ContentView_[ChildType],
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Widget => typings.tabris.global.tabris.ContentView_[ChildType],
    appendTo: /* parent */ Composite[Widget] => typings.tabris.global.tabris.ContentView_[ChildType],
    apply: (/* options */ `30`[typings.tabris.global.tabris.ContentView_[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[
      /* widget */ typings.tabris.global.tabris.ContentView_[ChildType], 
      StringDictionary[js.Object]
    ]) | Null) => typings.tabris.global.tabris.ContentView_[ChildType],
    ...
    constructor: /* properties */ js.UndefOr[Properties[ContentView_[Widget], Omit[ContentView_[Widget], set]]] => js.Any,
    cornerRadius: Double,
    data: StringDictionary[js.Any],
    detach: () => typings.tabris.global.tabris.ContentView_[ChildType],
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget => typings.tabris.global.tabris.ContentView_[ChildType],
    insertBefore: /* widget */ Widget => typings.tabris.global.tabris.ContentView_[ChildType],
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[
      typings.tabris.global.tabris.ContentView_[ChildType], 
      Omit[typings.tabris.global.tabris.ContentView_[ChildType], set | jsxAttributes]
    ]) & `3`,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.ContentView_[ChildType],
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.ContentView_[ChildType],
    onAddChild: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], id],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onRemoveChild: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], right],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.ContentView_[ChildType],
    opacity: Double,
    parent: () => Composite[Widget],
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.ContentView_[ChildType],
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.ContentView_[ChildType]],
    visible: Boolean,
    width: Dimension | auto
  ): OmitContentViewWidgetsetAbsoluteBounds[ChildType] = {
    ...
    __obj.asInstanceOf[OmitContentViewWidgetsetAbsoluteBounds[ChildType]]
  }
  
  extension [Self <: OmitContentViewWidgetsetAbsoluteBounds[?], ChildType /* <: Widget */](x: Self & OmitContentViewWidgetsetAbsoluteBounds[ChildType]) {
    ...
    inline def setAppend(value: /* repeated */ Widget => typings.tabris.global.tabris.ContentView_[ChildType]): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ Composite[Widget] => typings.tabris.global.tabris.ContentView_[ChildType]): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `30`[typings.tabris.global.tabris.ContentView_[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[
          /* widget */ typings.tabris.global.tabris.ContentView_[ChildType], 
          StringDictionary[js.Object]
        ]) | Null) => typings.tabris.global.tabris.ContentView_[ChildType]
    ...
    inline def setConstructor(
      value: /* properties */ js.UndefOr[Properties[ContentView_[Widget], Omit[ContentView_[Widget], set]]] => js.Any
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.ContentView_[ChildType]): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => typings.tabris.global.tabris.ContentView_[ChildType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => typings.tabris.global.tabris.ContentView_[ChildType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.ContentView_[ChildType]
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.ContentView_[ChildType]
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAddChild(value: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.ContentView_[ChildType], width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.ContentView_[ChildType]): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.ContentView_[ChildType]]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
