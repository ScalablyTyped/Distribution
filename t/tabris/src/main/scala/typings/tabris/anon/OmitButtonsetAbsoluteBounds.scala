...
trait OmitButtonsetAbsoluteBounds extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): typings.tabris.global.tabris.widgets.Button
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], typings.tabris.global.tabris.widgets.Button]
  ...
  def detach(): typings.tabris.global.tabris.widgets.Button
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.Button]
  ...
  def insertAfter(widget: Widget[Any]): typings.tabris.global.tabris.widgets.Button
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.Button]
  
  def insertBefore(widget: Widget[Any]): typings.tabris.global.tabris.widgets.Button
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.Button]
  ...
  var jsxAttributes: (JSXAttributes[
    typings.tabris.global.tabris.widgets.Button, 
    Omit[
      typings.tabris.global.tabris.widgets.Button, 
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.Button
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Button
  def on(
    `type`: String,
  ...
  var onAlignmentChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, alignment]
  
  var onAutoCapitalizeChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, autoCapitalize]
  
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Button]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, excludeFromLayout]
  
  var onFontChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, font]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, id]
  
  var onImageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, image]
  
  var onImageTintColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, imageTintColor]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, right]
  
  var onSelect: Listeners[EventObject[typings.tabris.global.tabris.widgets.Button]]
  
  var onStrokeColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, strokeColor]
  
  var onStrokeWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, strokeWidth]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onTextChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, text]
  
  var onTextColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, textColor]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Button
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.Button
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.Button]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.Button]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.Button]
...
object OmitButtonsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.Button,
    ...
    cornerRadius: Double,
    data: Any,
    detach: () => typings.tabris.global.tabris.widgets.Button,
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Button,
    insertBefore: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Button,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[
      typings.tabris.global.tabris.widgets.Button, 
      Omit[typings.tabris.global.tabris.widgets.Button, set | jsxAttributes]
    ]) & `1`,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Button,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Button,
    onAlignmentChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, alignment],
    onAutoCapitalizeChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, autoCapitalize],
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Button]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, excludeFromLayout],
    onFontChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, font],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, id],
    onImageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, image],
    onImageTintColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, imageTintColor],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Button]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Button]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, right],
    onSelect: Listeners[EventObject[typings.tabris.global.tabris.widgets.Button]],
    onStrokeColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, strokeColor],
    onStrokeWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, strokeWidth],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Button]],
    onTextChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, text],
    onTextColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, textColor],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Button, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Button,
    opacity: Double,
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.widgets.Button,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Button],
    visible: Boolean,
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitButtonsetAbsoluteBounds] (val x: Self) extends AnyVal {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.Button): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.Button): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Button): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Button): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Button
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Button
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAlignmentChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, alignment]): Self = StObject.set(x, "onAlignmentChanged", value.asInstanceOf[js.Any])
    
    inline def setOnAutoCapitalizeChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, autoCapitalize]): Self = StObject.set(x, "onAutoCapitalizeChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnFontChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, font]): Self = StObject.set(x, "onFontChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnImageChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, image]): Self = StObject.set(x, "onImageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnImageTintColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, imageTintColor]): Self = StObject.set(x, "onImageTintColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnStrokeColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, strokeColor]): Self = StObject.set(x, "onStrokeColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnStrokeWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, strokeWidth]): Self = StObject.set(x, "onStrokeWidthChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTextChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, text]): Self = StObject.set(x, "onTextChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTextColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, textColor]): Self = StObject.set(x, "onTextColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Button]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Button, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.Button): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Button]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
