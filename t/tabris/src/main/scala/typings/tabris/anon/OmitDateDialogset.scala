...
object OmitDateDialogset {
  ...
  @scala.inline
  implicit class OmitDateDialogsetMutableBuilder[Self <: OmitDateDialogset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClose(value: () => DateDialog): Self = StObject.set(x, "close", js.Any.fromFunction0(value))
    
    @scala.inline
    def setConstructor(value: /* properties */ js.UndefOr[Properties[DateDialog, Omit[DateDialog, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setJsxAttributes(value: JSXAttributes[DateDialog, Omit[DateDialog, set | jsxAttributes]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnClose(value: Listeners[DateDialogCloseEvent[DateDialog]]): Self = StObject.set(x, "onClose", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDateChanged(value: ChangeListeners[DateDialog, date]): Self = StObject.set(x, "onDateChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnMaxDateChanged(value: ChangeListeners[DateDialog, maxDate]): Self = StObject.set(x, "onMaxDateChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnMinDateChanged(value: ChangeListeners[DateDialog, minDate]): Self = StObject.set(x, "onMinDateChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSelect(value: Listeners[DateDialogSelectEvent[DateDialog]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOpen(value: () => DateDialog): Self = StObject.set(x, "open", js.Any.fromFunction0(value))
    
    @scala.inline
    def setTrigger(value: /* type */ String => DateDialog): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTriggerAsync(value: /* type */ String => js.Promise[DateDialog]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
