...
import typings.tabris.mod.DateDialog
import typings.tabris.mod.DateDialogCloseEvent
import typings.tabris.mod.DateDialogSelectEvent
...
/* Inlined tabris.tabris.Omit<tabris.tabris.DateDialog, 'set'> */
trait OmitDateDialogset extends StObject {
  ...
  def close(): DateDialog
  @JSName("close")
  var close_Original: js.Function0[DateDialog]
  
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[DateDialog, Omit[DateDialog, set]]], js.Any]
  ...
  var jsxAttributes: JSXAttributes[DateDialog, Omit[DateDialog, set | typings.tabris.tabrisStrings.jsxAttributes]]
  
  var maxDate: Date
  
  var minDate: Date
  
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): DateDialog
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): DateDialog
  def on(
    `type`: String,
  ...
  var onClose: Listeners[DateDialogCloseEvent[DateDialog]]
  
  var onDateChanged: ChangeListeners[DateDialog, date]
  
  var onMaxDateChanged: ChangeListeners[DateDialog, maxDate]
  
  var onMinDateChanged: ChangeListeners[DateDialog, minDate]
  
  var onSelect: Listeners[DateDialogSelectEvent[DateDialog]]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): DateDialog
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def open(): DateDialog
  @JSName("open")
  var open_Original: js.Function0[DateDialog]
  
  def trigger(`type`: String): DateDialog
  
  def triggerAsync(`type`: String): js.Promise[DateDialog]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[DateDialog]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, DateDialog]
}
object OmitDateDialogset {
  ...
  extension [Self <: OmitDateDialogset](x: Self) {
    ...
    inline def setClose(value: () => DateDialog): Self = StObject.set(x, "close", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[DateDialog, Omit[DateDialog, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setJsxAttributes(value: JSXAttributes[DateDialog, Omit[DateDialog, set | jsxAttributes]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => DateDialog
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => DateDialog
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnClose(value: Listeners[DateDialogCloseEvent[DateDialog]]): Self = StObject.set(x, "onClose", value.asInstanceOf[js.Any])
    
    inline def setOnDateChanged(value: ChangeListeners[DateDialog, date]): Self = StObject.set(x, "onDateChanged", value.asInstanceOf[js.Any])
    
    inline def setOnMaxDateChanged(value: ChangeListeners[DateDialog, maxDate]): Self = StObject.set(x, "onMaxDateChanged", value.asInstanceOf[js.Any])
    
    inline def setOnMinDateChanged(value: ChangeListeners[DateDialog, minDate]): Self = StObject.set(x, "onMinDateChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[DateDialogSelectEvent[DateDialog]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnce(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => DateDialog
    ): Self = StObject.set(x, "once", js.Any.fromFunction3(value))
    
    inline def setOpen(value: () => DateDialog): Self = StObject.set(x, "open", js.Any.fromFunction0(value))
    
    inline def setTrigger(value: /* type */ String => DateDialog): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[DateDialog]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
