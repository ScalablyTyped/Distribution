...
trait OmitDateDialogset extends StObject {
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[DateDialog, Omit[DateDialog, set]]], Any]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): DateDialog
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): DateDialog
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
...
object OmitDateDialogset {
  ...
  inline def apply(
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => DateDialog,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => DateDialog,
    open: () => DateDialog,
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitDateDialogset] (val x: Self) extends AnyVal {
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[DateDialog, Omit[DateDialog, set]]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => DateDialog
