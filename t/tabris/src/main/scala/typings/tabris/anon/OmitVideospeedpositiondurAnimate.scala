...
trait OmitVideospeedpositiondurAnimate extends StObject {
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[
      Properties[Omit[Video, speed | position | duration | state], OmitOmitVideospeedpositioAnimate]
    ], 
    Any
  ]
...
object OmitVideospeedpositiondurAnimate {
  ...
  ): OmitVideospeedpositiondurAnimate = {
