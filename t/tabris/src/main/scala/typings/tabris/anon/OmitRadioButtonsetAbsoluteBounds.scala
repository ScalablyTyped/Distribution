...
trait OmitRadioButtonsetAbsoluteBounds extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): typings.tabris.global.tabris.widgets.RadioButton
  @JSName("appendTo")
  ...
  def detach(): typings.tabris.global.tabris.widgets.RadioButton
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.RadioButton]
  ...
  def insertAfter(widget: Widget[Any]): typings.tabris.global.tabris.widgets.RadioButton
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.RadioButton]
  
  def insertBefore(widget: Widget[Any]): typings.tabris.global.tabris.widgets.RadioButton
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.RadioButton]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.RadioButton
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.RadioButton
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, centerY]
  
  var onCheckedChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, checked]
  
  var onCheckedTintColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, checkedTintColor]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, excludeFromLayout]
  
  var onFontChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, font]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, id]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, right]
  
  var onSelect: Listeners[RadioButtonSelectEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onTextChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, text]
  
  var onTextColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, textColor]
  
  var onTintColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, tintColor]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.RadioButton
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.RadioButton
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.RadioButton]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.RadioButton]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.RadioButton]
...
object OmitRadioButtonsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.RadioButton,
    ...
    cornerRadius: Double,
    data: Any,
    detach: () => typings.tabris.global.tabris.widgets.RadioButton,
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.RadioButton,
    insertBefore: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.RadioButton,
    isDisposed: () => Boolean,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.RadioButton,
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, centerY],
    onCheckedChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, checked],
    onCheckedTintColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, checkedTintColor],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.RadioButton]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, excludeFromLayout],
    onFontChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, font],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, id],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, right],
    onSelect: Listeners[RadioButtonSelectEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onTextChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, text],
    onTextColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, textColor],
    onTintColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, tintColor],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.RadioButton,
    opacity: Double,
    parent: () => Composite[Widget[Any]],
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.widgets.RadioButton,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.RadioButton],
    visible: Boolean,
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitRadioButtonsetAbsoluteBounds] (val x: Self) extends AnyVal {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.RadioButton): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.RadioButton): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.RadioButton): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.RadioButton): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.RadioButton
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.RadioButton
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCheckedChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, checked]): Self = StObject.set(x, "onCheckedChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCheckedTintColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, checkedTintColor]): Self = StObject.set(x, "onCheckedTintColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnFontChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, font]): Self = StObject.set(x, "onFontChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[RadioButtonSelectEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTextChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, text]): Self = StObject.set(x, "onTextChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTextColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, textColor]): Self = StObject.set(x, "onTextColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTintColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, tintColor]): Self = StObject.set(x, "onTintColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.RadioButton]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.RadioButton, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.RadioButton): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.RadioButton]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
