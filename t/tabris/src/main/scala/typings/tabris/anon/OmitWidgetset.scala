...
trait OmitWidgetset extends StObject {
  ...
  def appendTo(parent: Composite[Widget]): Widget
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], Widget]
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Widget, Omit[Widget, set]]], js.Any]
  ...
  def detach(): Widget
  @JSName("detach")
  var detach_Original: js.Function0[Widget]
  ...
  def insertAfter(widget: Widget): Widget
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Widget]
  
  def insertBefore(widget: Widget): Widget
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Widget]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: JSXAttributes[Widget, Omit[Widget, set | typings.tabris.tabrisStrings.jsxAttributes]]
  
  var layoutData: LayoutDataValue
  
  var left: ConstraintValue
  
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Widget
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): Widget
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[Widget, background]
  
  var onBaselineChanged: ChangeListeners[Widget, baseline]
  
  var onBottomChanged: ChangeListeners[Widget, bottom]
  
  var onBoundsChanged: ChangeListeners[Widget, bounds]
  
  var onCenterXChanged: ChangeListeners[Widget, centerX]
  
  var onCenterYChanged: ChangeListeners[Widget, centerY]
  
  var onClassChanged: ChangeListeners[Widget, `class`]
  
  var onClassListChanged: ChangeListeners[Widget, classList]
  
  var onCornerRadiusChanged: ChangeListeners[Widget, cornerRadius]
  
  var onDataChanged: ChangeListeners[Widget, data]
  
  var onDispose: Listeners[EventObject[Widget]]
  
  var onElevationChanged: ChangeListeners[Widget, elevation]
  
  var onEnabledChanged: ChangeListeners[Widget, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[Widget, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[Widget, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[Widget, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[Widget, id]
  
  var onLayoutDataChanged: ChangeListeners[Widget, layoutData]
  
  var onLeftChanged: ChangeListeners[Widget, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[Widget]]
  
  var onOpacityChanged: ChangeListeners[Widget, opacity]
  
  var onPan: Listeners[WidgetPanEvent[Widget]]
  
  var onPanDown: Listeners[WidgetPanEvent[Widget]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[Widget]]
  
  var onPanLeft: Listeners[WidgetPanEvent[Widget]]
  
  var onPanRight: Listeners[WidgetPanEvent[Widget]]
  
  var onPanUp: Listeners[WidgetPanEvent[Widget]]
  
  var onPanVertical: Listeners[WidgetPanEvent[Widget]]
  
  var onResize: Listeners[WidgetResizeEvent[Widget]]
  
  var onRightChanged: ChangeListeners[Widget, right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[Widget]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Widget]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[Widget]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[Widget]]
  
  var onTap: Listeners[WidgetTapEvent[Widget]]
  
  var onTopChanged: ChangeListeners[Widget, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[Widget]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[Widget]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[Widget]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[Widget]]
  
  var onTransformChanged: ChangeListeners[Widget, transform]
  
  var onVisibleChanged: ChangeListeners[Widget, visible]
  
  var onWidthChanged: ChangeListeners[Widget, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): Widget
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def trigger(`type`: String): Widget
  
  def triggerAsync(`type`: String): js.Promise[Widget]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Widget]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Widget]
  
  var visible: Boolean
  
  var width: Dimension | auto
}
object OmitWidgetset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget] => Widget,
    ...
    constructor: /* properties */ js.UndefOr[Properties[Widget, Omit[Widget, set]]] => js.Any,
    cornerRadius: Double,
    ...
    id: String,
    insertAfter: /* widget */ Widget => Widget,
    insertBefore: /* widget */ Widget => Widget,
    isDisposed: () => Boolean,
    jsxAttributes: JSXAttributes[Widget, Omit[Widget, set | jsxAttributes]],
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Widget,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Widget,
    onBackgroundChanged: ChangeListeners[Widget, background],
    onBaselineChanged: ChangeListeners[Widget, baseline],
    onBottomChanged: ChangeListeners[Widget, bottom],
    onBoundsChanged: ChangeListeners[Widget, bounds],
    onCenterXChanged: ChangeListeners[Widget, centerX],
    onCenterYChanged: ChangeListeners[Widget, centerY],
    onClassChanged: ChangeListeners[Widget, `class`],
    onClassListChanged: ChangeListeners[Widget, classList],
    onCornerRadiusChanged: ChangeListeners[Widget, cornerRadius],
    onDataChanged: ChangeListeners[Widget, data],
    onDispose: Listeners[EventObject[Widget]],
    onElevationChanged: ChangeListeners[Widget, elevation],
    onEnabledChanged: ChangeListeners[Widget, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[Widget, excludeFromLayout],
    onHeightChanged: ChangeListeners[Widget, height],
    onHighlightOnTouchChanged: ChangeListeners[Widget, highlightOnTouch],
    onIdChanged: ChangeListeners[Widget, id],
    onLayoutDataChanged: ChangeListeners[Widget, layoutData],
    onLeftChanged: ChangeListeners[Widget, left],
    onLongPress: Listeners[WidgetLongPressEvent[Widget]],
    onOpacityChanged: ChangeListeners[Widget, opacity],
    onPan: Listeners[WidgetPanEvent[Widget]],
    onPanDown: Listeners[WidgetPanEvent[Widget]],
    onPanHorizontal: Listeners[WidgetPanEvent[Widget]],
    onPanLeft: Listeners[WidgetPanEvent[Widget]],
    onPanRight: Listeners[WidgetPanEvent[Widget]],
    onPanUp: Listeners[WidgetPanEvent[Widget]],
    onPanVertical: Listeners[WidgetPanEvent[Widget]],
    onResize: Listeners[WidgetResizeEvent[Widget]],
    onRightChanged: ChangeListeners[Widget, right],
    onSwipeDown: Listeners[WidgetSwipeEvent[Widget]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[Widget]],
    onSwipeRight: Listeners[WidgetSwipeEvent[Widget]],
    onSwipeUp: Listeners[WidgetSwipeEvent[Widget]],
    onTap: Listeners[WidgetTapEvent[Widget]],
    onTopChanged: ChangeListeners[Widget, top],
    onTouchCancel: Listeners[WidgetTouchEvent[Widget]],
    onTouchEnd: Listeners[WidgetTouchEvent[Widget]],
    onTouchMove: Listeners[WidgetTouchEvent[Widget]],
    onTouchStart: Listeners[WidgetTouchEvent[Widget]],
    onTransformChanged: ChangeListeners[Widget, transform],
    onVisibleChanged: ChangeListeners[Widget, visible],
    onWidthChanged: ChangeListeners[Widget, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Widget,
    opacity: Double,
    ...
    trigger: /* type */ String => Widget,
    triggerAsync: /* type */ String => js.Promise[Widget],
    visible: Boolean,
    ...
    __obj.asInstanceOf[OmitWidgetset]
  }
  
  extension [Self <: OmitWidgetset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => Widget): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[Widget, Omit[Widget, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => Widget): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => Widget): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => Widget): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: JSXAttributes[Widget, Omit[Widget, set | jsxAttributes]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Widget
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Widget
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[Widget, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[Widget, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[Widget, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[Widget, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[Widget, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[Widget, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[Widget, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[Widget, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[Widget, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[Widget, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[Widget]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[Widget, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[Widget, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[Widget, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[Widget, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[Widget, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[Widget, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[Widget, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[Widget, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[Widget]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[Widget, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[Widget]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[Widget]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[Widget]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[Widget]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[Widget]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[Widget]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[Widget]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[Widget]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[Widget, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[Widget]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[Widget]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[Widget]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[Widget]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[Widget]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[Widget, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[Widget]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[Widget]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[Widget]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[Widget]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[Widget, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[Widget, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[Widget, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => Widget): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[Widget]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
