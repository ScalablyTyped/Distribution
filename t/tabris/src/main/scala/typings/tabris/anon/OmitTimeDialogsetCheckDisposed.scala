...
trait OmitTimeDialogsetCheckDisposed extends StObject {
  ...
  def close(): typings.tabris.global.tabris.TimeDialog
  @JSName("close")
  var close_Original: js.Function0[typings.tabris.global.tabris.TimeDialog]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.TimeDialog
  def on(
    `type`: String,
  ...
  var onClose: Listeners[TimeDialogCloseEvent[typings.tabris.global.tabris.TimeDialog]]
  
  var onDateChanged: ChangeListeners[typings.tabris.global.tabris.TimeDialog, date]
  
  var onSelect: Listeners[TimeDialogSelectEvent[typings.tabris.global.tabris.TimeDialog]]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.TimeDialog
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def open(): typings.tabris.global.tabris.TimeDialog
  @JSName("open")
  var open_Original: js.Function0[typings.tabris.global.tabris.TimeDialog]
  
  def trigger(`type`: String): typings.tabris.global.tabris.TimeDialog
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.TimeDialog]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.TimeDialog]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.TimeDialog]
}
object OmitTimeDialogsetCheckDisposed {
  ...
  inline def apply(
    ...
    cid: String,
    close: () => typings.tabris.global.tabris.TimeDialog,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.TimeDialog,
    onClose: Listeners[TimeDialogCloseEvent[typings.tabris.global.tabris.TimeDialog]],
    onDateChanged: ChangeListeners[typings.tabris.global.tabris.TimeDialog, date],
    onSelect: Listeners[TimeDialogSelectEvent[typings.tabris.global.tabris.TimeDialog]],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.TimeDialog,
    open: () => typings.tabris.global.tabris.TimeDialog,
    trigger: /* type */ String => typings.tabris.global.tabris.TimeDialog,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.TimeDialog]
  ): OmitTimeDialogsetCheckDisposed = {
    ...
    __obj.asInstanceOf[OmitTimeDialogsetCheckDisposed]
  }
  
  extension [Self <: OmitTimeDialogsetCheckDisposed](x: Self) {
    ...
    inline def setClose(value: () => typings.tabris.global.tabris.TimeDialog): Self = StObject.set(x, "close", js.Any.fromFunction0(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.TimeDialog
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.TimeDialog
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnClose(value: Listeners[TimeDialogCloseEvent[typings.tabris.global.tabris.TimeDialog]]): Self = StObject.set(x, "onClose", value.asInstanceOf[js.Any])
    
    inline def setOnDateChanged(value: ChangeListeners[typings.tabris.global.tabris.TimeDialog, date]): Self = StObject.set(x, "onDateChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[TimeDialogSelectEvent[typings.tabris.global.tabris.TimeDialog]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnce(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.TimeDialog
    ): Self = StObject.set(x, "once", js.Any.fromFunction3(value))
    
    inline def setOpen(value: () => typings.tabris.global.tabris.TimeDialog): Self = StObject.set(x, "open", js.Any.fromFunction0(value))
    
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.TimeDialog): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.TimeDialog]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
