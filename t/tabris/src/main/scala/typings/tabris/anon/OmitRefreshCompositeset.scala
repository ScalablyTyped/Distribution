...
trait OmitRefreshCompositeset extends StObject {
  ...
  def _apply[Target](options: `8`[Target]): RefreshComposite
  def _apply[Target](
    options: `8`[Target],
    rules: js.Function1[/* widget */ RefreshComposite, StringDictionary[js.Object]]
  ): RefreshComposite
  def _apply[Target](options: `8`[Target], rules: StringDictionary[js.Object]): RefreshComposite
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `8`[RefreshComposite], 
    /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ RefreshComposite, StringDictionary[js.Object]]) | Null, 
    RefreshComposite
  ]
  ...
  def append(widgets: Widget*): RefreshComposite
  
  def appendTo(parent: Composite[Widget]): RefreshComposite
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], RefreshComposite]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, RefreshComposite]
  
  @JSName("apply")
  def apply[Target](options: `8`[Target]): RefreshComposite
  @JSName("apply")
  def apply[Target](
    options: `8`[Target],
    rules: js.Function1[/* widget */ RefreshComposite, StringDictionary[js.Object]]
  ...
  @JSName("apply")
  def apply[Target](options: `8`[Target], rules: StringDictionary[js.Object]): RefreshComposite
  @JSName("apply")
  ...
  def insertAfter(widget: Widget): RefreshComposite
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, RefreshComposite]
  
  def insertBefore(widget: Widget): RefreshComposite
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, RefreshComposite]
  ...
  var jsxAttributes: (JSXAttributes[
    RefreshComposite, 
    Omit[RefreshComposite, set | typings.tabris.tabrisStrings.jsxAttributes]
  ]) & `3`
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): RefreshComposite
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): RefreshComposite
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitRefreshCompositeset {
  ...
  def apply(
    ...
    _apply: (/* options */ `8`[RefreshComposite], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ RefreshComposite, StringDictionary[js.Object]]) | Null) => RefreshComposite,
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Widget => RefreshComposite,
    appendTo: /* parent */ Composite[Widget] => RefreshComposite,
    apply: (/* options */ `8`[RefreshComposite], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ RefreshComposite, StringDictionary[js.Object]]) | Null) => RefreshComposite,
    ...
    id: String,
    insertAfter: /* widget */ Widget => RefreshComposite,
    insertBefore: /* widget */ Widget => RefreshComposite,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[RefreshComposite, Omit[RefreshComposite, set | jsxAttributes]]) & `3`,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => RefreshComposite,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => RefreshComposite,
    opacity: Double,
  ...
  @scala.inline
  implicit class OmitRefreshCompositesetMutableBuilder[Self <: OmitRefreshCompositeset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppend(value: /* repeated */ Widget => RefreshComposite): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    @scala.inline
    def setAppendTo(value: /* parent */ Composite[Widget] => RefreshComposite): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    @scala.inline
    def setApply(
      value: (/* options */ `8`[RefreshComposite], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ RefreshComposite, StringDictionary[js.Object]]) | Null) => RefreshComposite
    ...
    @scala.inline
    def setDetach(value: () => RefreshComposite): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setInsertAfter(value: /* widget */ Widget => RefreshComposite): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    @scala.inline
    def setInsertBefore(value: /* widget */ Widget => RefreshComposite): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    @scala.inline
    def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    @scala.inline
    def setJsxAttributes(value: (JSXAttributes[RefreshComposite, Omit[RefreshComposite, set | jsxAttributes]]) & `3`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => RefreshComposite
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    @scala.inline
    def setOnAddChild(value: Listeners[CompositeAddChildEvent[RefreshComposite]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBackgroundChanged(value: ChangeListeners[RefreshComposite, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBaselineChanged(value: ChangeListeners[RefreshComposite, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBottomChanged(value: ChangeListeners[RefreshComposite, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBoundsChanged(value: ChangeListeners[RefreshComposite, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterXChanged(value: ChangeListeners[RefreshComposite, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterYChanged(value: ChangeListeners[RefreshComposite, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassChanged(value: ChangeListeners[RefreshComposite, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassListChanged(value: ChangeListeners[RefreshComposite, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCornerRadiusChanged(value: ChangeListeners[RefreshComposite, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDataChanged(value: ChangeListeners[RefreshComposite, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDispose(value: Listeners[EventObject[RefreshComposite]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnElevationChanged(value: ChangeListeners[RefreshComposite, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnEnabledChanged(value: ChangeListeners[RefreshComposite, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnExcludeFromLayoutChanged(value: ChangeListeners[RefreshComposite, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHeightChanged(value: ChangeListeners[RefreshComposite, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHighlightOnTouchChanged(value: ChangeListeners[RefreshComposite, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnIdChanged(value: ChangeListeners[RefreshComposite, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLayoutDataChanged(value: ChangeListeners[RefreshComposite, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLeftChanged(value: ChangeListeners[RefreshComposite, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLongPress(value: Listeners[WidgetLongPressEvent[RefreshComposite]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnOpacityChanged(value: ChangeListeners[RefreshComposite, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPan(value: Listeners[WidgetPanEvent[RefreshComposite]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanDown(value: Listeners[WidgetPanEvent[RefreshComposite]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanHorizontal(value: Listeners[WidgetPanEvent[RefreshComposite]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanLeft(value: Listeners[WidgetPanEvent[RefreshComposite]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanRight(value: Listeners[WidgetPanEvent[RefreshComposite]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanUp(value: Listeners[WidgetPanEvent[RefreshComposite]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanVertical(value: Listeners[WidgetPanEvent[RefreshComposite]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRefresh(value: Listeners[EventObject[RefreshComposite]]): Self = StObject.set(x, "onRefresh", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRefreshEnabledChanged(value: ChangeListeners[RefreshComposite, refreshEnabled]): Self = StObject.set(x, "onRefreshEnabledChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRefreshIndicatorChanged(value: ChangeListeners[RefreshComposite, refreshIndicator]): Self = StObject.set(x, "onRefreshIndicatorChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRefreshMessageChanged(value: ChangeListeners[RefreshComposite, refreshMessage]): Self = StObject.set(x, "onRefreshMessageChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[RefreshComposite]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnResize(value: Listeners[WidgetResizeEvent[RefreshComposite]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRightChanged(value: ChangeListeners[RefreshComposite, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[RefreshComposite]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[RefreshComposite]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[RefreshComposite]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[RefreshComposite]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTap(value: Listeners[WidgetTapEvent[RefreshComposite]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTopChanged(value: ChangeListeners[RefreshComposite, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchCancel(value: Listeners[WidgetTouchEvent[RefreshComposite]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchEnd(value: Listeners[WidgetTouchEvent[RefreshComposite]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchMove(value: Listeners[WidgetTouchEvent[RefreshComposite]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchStart(value: Listeners[WidgetTouchEvent[RefreshComposite]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTransformChanged(value: ChangeListeners[RefreshComposite, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnVisibleChanged(value: ChangeListeners[RefreshComposite, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnWidthChanged(value: ChangeListeners[RefreshComposite, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRefreshEnabled(value: Boolean): Self = StObject.set(x, "refreshEnabled", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefreshIndicator(value: Boolean): Self = StObject.set(x, "refreshIndicator", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefreshMessage(value: String): Self = StObject.set(x, "refreshMessage", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTrigger(value: /* type */ String => RefreshComposite): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTriggerAsync(value: /* type */ String => js.Promise[RefreshComposite]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
