...
trait OmitRefreshCompositeset extends StObject {
  ...
  def _apply[Target](options: `12`[Target], rules: RuleSet[RefreshComposite]): RefreshComposite
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `12`[RefreshComposite], 
  ...
  @JSName("apply")
  def apply[Target](options: `12`[Target], rules: RuleSet[RefreshComposite]): RefreshComposite
  @JSName("apply")
...
object OmitRefreshCompositeset {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `12`[RefreshComposite], /* rules */ RuleSet[RefreshComposite]) => RefreshComposite,
    _checkDisposed: () => Unit,
    ...
    apply: (/* options */ `12`[RefreshComposite], /* rules */ RuleSet[RefreshComposite]) => RefreshComposite,
  ...
  extension [Self <: OmitRefreshCompositeset](x: Self) {
    ...
    inline def setApply(
      value: (/* options */ `12`[RefreshComposite], /* rules */ RuleSet[RefreshComposite]) => RefreshComposite
