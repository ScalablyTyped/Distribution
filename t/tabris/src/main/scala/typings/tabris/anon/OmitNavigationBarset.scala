...
trait OmitNavigationBarset extends StObject {
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): NavigationBar_
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): NavigationBar_
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitNavigationBarset {
  ...
  def apply(
    ...
    cid: String,
    constructor: /* properties */ js.UndefOr[Properties[NavigationBar_, Omit[NavigationBar_, set]]] => js.Any,
    displayMode: default | float | hide,
    height: Double,
    jsxAttributes: (JSXAttributes[NavigationBar_, Omit[NavigationBar_, set | jsxAttributes]]) & `2`,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => NavigationBar_,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => NavigationBar_,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => NavigationBar_,
  ...
  @scala.inline
  implicit class OmitNavigationBarsetMutableBuilder[Self <: OmitNavigationBarset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBackground(value: ColorValue): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setConstructor(
      value: /* properties */ js.UndefOr[Properties[NavigationBar_, Omit[NavigationBar_, set]]] => js.Any
    ...
    @scala.inline
    def setDisplayMode(value: default | float | hide): Self = StObject.set(x, "displayMode", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJsxAttributes(value: (JSXAttributes[NavigationBar_, Omit[NavigationBar_, set | jsxAttributes]]) & `2`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => NavigationBar_
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    @scala.inline
    def setOnBackgroundChanged(value: ChangeListeners[NavigationBar_, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDisplayModeChanged(value: ChangeListeners[NavigationBar_, displayMode]): Self = StObject.set(x, "onDisplayModeChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnThemeChanged(value: ChangeListeners[NavigationBar_, theme]): Self = StObject.set(x, "onThemeChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTheme(value: dark | default | light): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTrigger(value: /* type */ String => NavigationBar_): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTriggerAsync(value: /* type */ String => js.Promise[NavigationBar_]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
