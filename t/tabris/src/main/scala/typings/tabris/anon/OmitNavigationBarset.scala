...
object OmitNavigationBarset {
  ...
  extension [Self <: OmitNavigationBarset](x: Self) {
    ...
    inline def setJsxAttributes(value: (JSXAttributes[NavigationBar_, Omit[NavigationBar_, set | jsxAttributes]]) & `2`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
