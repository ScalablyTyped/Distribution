...
trait OmitRowsetAbsoluteBounds extends StObject {
  ...
  def _apply[Target](options: `25`[Target]): typings.tabris.global.tabris.widgets.Row
  def _apply[Target](
    options: `25`[Target],
    rules: js.Function1[/* widget */ typings.tabris.global.tabris.widgets.Row, StringDictionary[js.Object]]
  ): typings.tabris.global.tabris.widgets.Row
  def _apply[Target](options: `25`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.widgets.Row
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `25`[typings.tabris.global.tabris.widgets.Row], 
    /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ typings.tabris.global.tabris.widgets.Row, StringDictionary[js.Object]]) | Null, 
    typings.tabris.global.tabris.widgets.Row
  ]
  ...
  def append(widgets: Widget*): typings.tabris.global.tabris.widgets.Row
  
  def appendTo(parent: Composite[Widget]): typings.tabris.global.tabris.widgets.Row
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], typings.tabris.global.tabris.widgets.Row]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, typings.tabris.global.tabris.widgets.Row]
  
  @JSName("apply")
  def apply[Target](options: `25`[Target]): typings.tabris.global.tabris.widgets.Row
  @JSName("apply")
  def apply[Target](
    options: `25`[Target],
    rules: js.Function1[/* widget */ typings.tabris.global.tabris.widgets.Row, StringDictionary[js.Object]]
  ...
  @JSName("apply")
  def apply[Target](options: `25`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.widgets.Row
  @JSName("apply")
  ...
  def detach(): typings.tabris.global.tabris.widgets.Row
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.Row]
  ...
  def insertAfter(widget: Widget): typings.tabris.global.tabris.widgets.Row
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.Row]
  
  def insertBefore(widget: Widget): typings.tabris.global.tabris.widgets.Row
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.Row]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.Row
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.Row
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Row]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, id]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.Row
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.Row
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.Row]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.Row]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.Row]
...
object OmitRowsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `25`[typings.tabris.global.tabris.widgets.Row], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ typings.tabris.global.tabris.widgets.Row, StringDictionary[js.Object]]) | Null) => typings.tabris.global.tabris.widgets.Row,
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Widget => typings.tabris.global.tabris.widgets.Row,
    appendTo: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.Row,
    apply: (/* options */ `25`[typings.tabris.global.tabris.widgets.Row], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ typings.tabris.global.tabris.widgets.Row, StringDictionary[js.Object]]) | Null) => typings.tabris.global.tabris.widgets.Row,
    ...
    detach: () => typings.tabris.global.tabris.widgets.Row,
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget => typings.tabris.global.tabris.widgets.Row,
    insertBefore: /* widget */ Widget => typings.tabris.global.tabris.widgets.Row,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[
      typings.tabris.global.tabris.widgets.Row, 
      Omit[typings.tabris.global.tabris.widgets.Row, set | jsxAttributes]
    ]) & `3`,
    layout: RowLayout,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Row,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Row,
    onAddChild: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.Row]],
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Row]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, id],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Row]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]],
    onRemoveChild: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Row]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Row]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, right],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Row]],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Row, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Row,
    opacity: Double,
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.widgets.Row,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Row],
    visible: Boolean,
  ...
  extension [Self <: OmitRowsetAbsoluteBounds](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget => typings.tabris.global.tabris.widgets.Row): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.Row): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `25`[typings.tabris.global.tabris.widgets.Row], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ typings.tabris.global.tabris.widgets.Row, StringDictionary[js.Object]]) | Null) => typings.tabris.global.tabris.widgets.Row
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.Row): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.Row): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.Row): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Row
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Row
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAddChild(value: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Row]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Row, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.Row): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Row]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
