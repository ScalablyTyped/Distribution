...
trait OmitRowsetAbsoluteBounds extends StObject {
  ...
  def _apply[Target](options: `27`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.Row]): typings.tabris.global.tabris.widgets.Row
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `27`[typings.tabris.global.tabris.widgets.Row], 
  ...
  def append(widgets: Widget[Any]*): typings.tabris.global.tabris.widgets.Row
  
  def appendTo(parent: Composite[Widget[Any]]): typings.tabris.global.tabris.widgets.Row
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], typings.tabris.global.tabris.widgets.Row]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget[Any], typings.tabris.global.tabris.widgets.Row]
  
  @JSName("apply")
  def apply[Target](options: `27`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.Row]): typings.tabris.global.tabris.widgets.Row
  @JSName("apply")
  ...
  def insertAfter(widget: Widget[Any]): typings.tabris.global.tabris.widgets.Row
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.Row]
  
  def insertBefore(widget: Widget[Any]): typings.tabris.global.tabris.widgets.Row
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.Row]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.Row, Widget[Any]]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Row
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Row
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
...
object OmitRowsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `27`[typings.tabris.global.tabris.widgets.Row], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Row]) => typings.tabris.global.tabris.widgets.Row,
    _checkDisposed: () => Unit,
    ...
    apply: (/* options */ `27`[typings.tabris.global.tabris.widgets.Row], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Row]) => typings.tabris.global.tabris.widgets.Row,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Row,
    insertBefore: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Row,
    isDisposed: () => Boolean,
    jsxAttributes: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.Row, Widget[Any]],
    layout: RowLayout,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Row,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Row,
    opacity: Double,
  ...
  extension [Self <: OmitRowsetAbsoluteBounds](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget[Any] => typings.tabris.global.tabris.widgets.Row): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    ...
    inline def setApply(
      value: (/* options */ `27`[typings.tabris.global.tabris.widgets.Row], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Row]) => typings.tabris.global.tabris.widgets.Row
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Row): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Row): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.Row, Widget[Any]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Row
