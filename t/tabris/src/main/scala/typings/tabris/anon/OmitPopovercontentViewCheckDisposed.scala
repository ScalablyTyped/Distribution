...
object OmitPopovercontentViewCheckDisposed {
  ...
  inline def apply(
    ...
    constructor: /* properties */ js.UndefOr[Properties[Omit[Popover, contentView], OmitOmitPopovercontentVieCheckDisposed]] => js.Any,
    height: Dimension,
  ...
  extension [Self <: OmitPopovercontentViewCheckDisposed](x: Self) {
    ...
    inline def setConstructor(
      value: /* properties */ js.UndefOr[Properties[Omit[Popover, contentView], OmitOmitPopovercontentVieCheckDisposed]] => js.Any
