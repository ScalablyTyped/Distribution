...
trait OmitPopovercontentViewCheckDisposed extends StObject {
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[Properties[Omit[Popover, contentView], OmitOmitPopovercontentVieCheckDisposed]], 
    Any
  ]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.Popover
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.Popover
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  var set_Original: js.Function1[
    /* properties */ Properties[
      typings.tabris.global.tabris.Popover, 
      Omit[typings.tabris.global.tabris.Popover, set]
    ], 
    typings.tabris.global.tabris.Popover
  ]
  @JSName("set")
  def set_set[T /* <: NativeObject */](properties: Properties[T, Omit[T, set]]): typings.tabris.global.tabris.Popover
...
object OmitPopovercontentViewCheckDisposed {
  ...
  inline def apply(
    ...
    constructor: /* properties */ js.UndefOr[Properties[Omit[Popover, contentView], OmitOmitPopovercontentVieCheckDisposed]] => Any,
    height: Dimension,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.Popover,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.Popover,
    ...
    width: Dimension
  ): OmitPopovercontentViewCheckDisposed = {
    ...
    __obj.asInstanceOf[OmitPopovercontentViewCheckDisposed]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPopovercontentViewCheckDisposed] (val x: Self) extends AnyVal {
    ...
    inline def setConstructor(
      value: /* properties */ js.UndefOr[Properties[Omit[Popover, contentView], OmitOmitPopovercontentVieCheckDisposed]] => Any
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.Popover
