...
object OmitPdfViewset {
  ...
  extension [Self <: OmitPdfViewset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => PdfView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => PdfView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => PdfView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[PdfView, Omit[PdfView, set | jsxAttributes]]) & `2`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
