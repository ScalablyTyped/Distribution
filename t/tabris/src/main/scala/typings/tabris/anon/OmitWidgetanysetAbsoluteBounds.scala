...
trait OmitWidgetanysetAbsoluteBounds[TData /* <: js.Object */] extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): typings.tabris.global.tabris.Widget[TData]
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], typings.tabris.global.tabris.Widget[TData]]
  ...
  def detach(): typings.tabris.global.tabris.Widget[TData]
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.Widget[TData]]
  ...
  def insertAfter(widget: Widget[Any]): typings.tabris.global.tabris.Widget[TData]
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.Widget[TData]]
  
  def insertBefore(widget: Widget[Any]): typings.tabris.global.tabris.Widget[TData]
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.Widget[TData]]
  ...
  var jsxAttributes: JSXAttributes[
    typings.tabris.global.tabris.Widget[TData], 
    Omit[
      typings.tabris.global.tabris.Widget[TData], 
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.Widget[TData]
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.Widget[TData]
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.Widget[TData]]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], id]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.Widget[TData]
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.Widget[TData]
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.Widget[TData]]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.Widget[TData]]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.Widget[TData]]
...
object OmitWidgetanysetAbsoluteBounds {
  ...
  inline def apply[TData /* <: js.Object */](
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.Widget[TData],
    ...
    cornerRadius: Double,
    data: Any,
    detach: () => typings.tabris.global.tabris.Widget[TData],
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typings.tabris.global.tabris.Widget[TData],
    insertBefore: /* widget */ Widget[Any] => typings.tabris.global.tabris.Widget[TData],
    isDisposed: () => Boolean,
    jsxAttributes: JSXAttributes[
      typings.tabris.global.tabris.Widget[TData], 
      Omit[typings.tabris.global.tabris.Widget[TData], set | jsxAttributes]
    ],
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.Widget[TData],
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.Widget[TData],
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.Widget[TData]]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], id],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.Widget[TData]]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.Widget[TData]]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], right],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.Widget[TData]]],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.Widget[TData], width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.Widget[TData],
    opacity: Double,
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.Widget[TData],
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.Widget[TData]],
    visible: Boolean,
  ...
  extension [Self <: OmitWidgetanysetAbsoluteBounds[?], TData /* <: js.Object */](x: Self & OmitWidgetanysetAbsoluteBounds[TData]) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.Widget[TData]): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.Widget[TData]): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.Widget[TData]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.Widget[TData]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.Widget[TData]
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.Widget[TData]
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.Widget[TData]]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.Widget[TData], width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.Widget[TData]): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.Widget[TData]]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
