...
trait OmitRefreshCompositesetAbsoluteBounds extends StObject {
  ...
  def _apply[Target](options: `23`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.RefreshComposite]): typings.tabris.global.tabris.widgets.RefreshComposite
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `23`[typings.tabris.global.tabris.widgets.RefreshComposite], 
    /* rules */ RuleSet[typings.tabris.global.tabris.widgets.RefreshComposite], 
  ...
  def append(widgets: Widget[Any]*): typings.tabris.global.tabris.widgets.RefreshComposite
  
  def appendTo(parent: Composite[Widget[Any]]): typings.tabris.global.tabris.widgets.RefreshComposite
  @JSName("appendTo")
  ...
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget[Any], typings.tabris.global.tabris.widgets.RefreshComposite]
  
  @JSName("apply")
  def apply[Target](options: `23`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.RefreshComposite]): typings.tabris.global.tabris.widgets.RefreshComposite
  @JSName("apply")
  ...
  def insertAfter(widget: Widget[Any]): typings.tabris.global.tabris.widgets.RefreshComposite
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.RefreshComposite]
  
  def insertBefore(widget: Widget[Any]): typings.tabris.global.tabris.widgets.RefreshComposite
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.RefreshComposite]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.RefreshComposite, Widget[Any]]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.RefreshComposite
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.RefreshComposite
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
...
object OmitRefreshCompositesetAbsoluteBounds {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `23`[typings.tabris.global.tabris.widgets.RefreshComposite], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.RefreshComposite]) => typings.tabris.global.tabris.widgets.RefreshComposite,
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Widget[Any] => typings.tabris.global.tabris.widgets.RefreshComposite,
    appendTo: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.RefreshComposite,
    apply: (/* options */ `23`[typings.tabris.global.tabris.widgets.RefreshComposite], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.RefreshComposite]) => typings.tabris.global.tabris.widgets.RefreshComposite,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.RefreshComposite,
    insertBefore: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.RefreshComposite,
    isDisposed: () => Boolean,
    jsxAttributes: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.RefreshComposite, Widget[Any]],
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.RefreshComposite,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.RefreshComposite,
    opacity: Double,
    parent: () => Composite[Widget[Any]],
  ...
  extension [Self <: OmitRefreshCompositesetAbsoluteBounds](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget[Any] => typings.tabris.global.tabris.widgets.RefreshComposite): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(
      value: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.RefreshComposite
    ): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `23`[typings.tabris.global.tabris.widgets.RefreshComposite], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.RefreshComposite]) => typings.tabris.global.tabris.widgets.RefreshComposite
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.RefreshComposite): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.RefreshComposite): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.RefreshComposite, Widget[Any]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.RefreshComposite
