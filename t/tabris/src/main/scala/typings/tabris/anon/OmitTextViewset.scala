...
trait OmitTextViewset extends StObject {
  ...
  def appendTo(parent: Composite[Widget]): TextView
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], TextView]
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[TextView, Omit[TextView, set]]], js.Any]
  ...
  def detach(): TextView
  @JSName("detach")
  var detach_Original: js.Function0[TextView]
  ...
  def insertAfter(widget: Widget): TextView
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, TextView]
  
  def insertBefore(widget: Widget): TextView
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, TextView]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: (JSXAttributes[TextView, Omit[TextView, set | typings.tabris.tabrisStrings.jsxAttributes]]) & `15`
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): TextView
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): TextView
  def on(
    `type`: String,
  ...
  var onAlignmentChanged: ChangeListeners[TextView, alignment]
  
  var onBackgroundChanged: ChangeListeners[TextView, background]
  
  var onBaselineChanged: ChangeListeners[TextView, baseline]
  
  var onBottomChanged: ChangeListeners[TextView, bottom]
  
  var onBoundsChanged: ChangeListeners[TextView, bounds]
  
  var onCenterXChanged: ChangeListeners[TextView, centerX]
  
  var onCenterYChanged: ChangeListeners[TextView, centerY]
  
  var onClassChanged: ChangeListeners[TextView, `class`]
  
  var onClassListChanged: ChangeListeners[TextView, classList]
  
  var onCornerRadiusChanged: ChangeListeners[TextView, cornerRadius]
  
  var onDataChanged: ChangeListeners[TextView, data]
  
  var onDispose: Listeners[EventObject[TextView]]
  
  var onElevationChanged: ChangeListeners[TextView, elevation]
  
  var onEnabledChanged: ChangeListeners[TextView, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[TextView, excludeFromLayout]
  
  var onFontChanged: ChangeListeners[TextView, font]
  
  var onHeightChanged: ChangeListeners[TextView, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[TextView, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[TextView, id]
  
  var onLayoutDataChanged: ChangeListeners[TextView, layoutData]
  
  var onLeftChanged: ChangeListeners[TextView, left]
  
  var onLineSpacingChanged: ChangeListeners[TextView, lineSpacing]
  
  var onLongPress: Listeners[WidgetLongPressEvent[TextView]]
  
  var onMarkupEnabledChanged: ChangeListeners[TextView, markupEnabled]
  
  var onMaxLinesChanged: ChangeListeners[TextView, maxLines]
  
  var onOpacityChanged: ChangeListeners[TextView, opacity]
  
  var onPan: Listeners[WidgetPanEvent[TextView]]
  
  var onPanDown: Listeners[WidgetPanEvent[TextView]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[TextView]]
  
  var onPanLeft: Listeners[WidgetPanEvent[TextView]]
  
  var onPanRight: Listeners[WidgetPanEvent[TextView]]
  
  var onPanUp: Listeners[WidgetPanEvent[TextView]]
  
  var onPanVertical: Listeners[WidgetPanEvent[TextView]]
  
  var onResize: Listeners[WidgetResizeEvent[TextView]]
  
  var onRightChanged: ChangeListeners[TextView, right]
  
  var onSelectableChanged: ChangeListeners[TextView, selectable]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[TextView]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[TextView]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[TextView]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[TextView]]
  
  var onTap: Listeners[WidgetTapEvent[TextView]]
  
  var onTapLink: Listeners[TextViewTapLinkEvent[TextView]]
  
  var onTextChanged: ChangeListeners[TextView, text]
  
  var onTextColorChanged: ChangeListeners[TextView, textColor]
  
  var onTopChanged: ChangeListeners[TextView, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[TextView]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[TextView]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[TextView]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[TextView]]
  
  var onTransformChanged: ChangeListeners[TextView, transform]
  
  var onVisibleChanged: ChangeListeners[TextView, visible]
  
  var onWidthChanged: ChangeListeners[TextView, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): TextView
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def trigger(`type`: String): TextView
  
  def triggerAsync(`type`: String): js.Promise[TextView]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[TextView]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, TextView]
  
  var visible: Boolean
  
  var width: Dimension | auto
}
object OmitTextViewset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget] => TextView,
    ...
    constructor: /* properties */ js.UndefOr[Properties[TextView, Omit[TextView, set]]] => js.Any,
    cornerRadius: Double,
    ...
    id: String,
    insertAfter: /* widget */ Widget => TextView,
    insertBefore: /* widget */ Widget => TextView,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[TextView, Omit[TextView, set | jsxAttributes]]) & `15`,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    lineSpacing: Double,
    markupEnabled: Boolean,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => TextView,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => TextView,
    onAlignmentChanged: ChangeListeners[TextView, alignment],
    onBackgroundChanged: ChangeListeners[TextView, background],
    onBaselineChanged: ChangeListeners[TextView, baseline],
    onBottomChanged: ChangeListeners[TextView, bottom],
    onBoundsChanged: ChangeListeners[TextView, bounds],
    onCenterXChanged: ChangeListeners[TextView, centerX],
    onCenterYChanged: ChangeListeners[TextView, centerY],
    onClassChanged: ChangeListeners[TextView, `class`],
    onClassListChanged: ChangeListeners[TextView, classList],
    onCornerRadiusChanged: ChangeListeners[TextView, cornerRadius],
    onDataChanged: ChangeListeners[TextView, data],
    onDispose: Listeners[EventObject[TextView]],
    onElevationChanged: ChangeListeners[TextView, elevation],
    onEnabledChanged: ChangeListeners[TextView, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[TextView, excludeFromLayout],
    onFontChanged: ChangeListeners[TextView, font],
    onHeightChanged: ChangeListeners[TextView, height],
    onHighlightOnTouchChanged: ChangeListeners[TextView, highlightOnTouch],
    onIdChanged: ChangeListeners[TextView, id],
    onLayoutDataChanged: ChangeListeners[TextView, layoutData],
    onLeftChanged: ChangeListeners[TextView, left],
    onLineSpacingChanged: ChangeListeners[TextView, lineSpacing],
    onLongPress: Listeners[WidgetLongPressEvent[TextView]],
    onMarkupEnabledChanged: ChangeListeners[TextView, markupEnabled],
    onMaxLinesChanged: ChangeListeners[TextView, maxLines],
    onOpacityChanged: ChangeListeners[TextView, opacity],
    onPan: Listeners[WidgetPanEvent[TextView]],
    onPanDown: Listeners[WidgetPanEvent[TextView]],
    onPanHorizontal: Listeners[WidgetPanEvent[TextView]],
    onPanLeft: Listeners[WidgetPanEvent[TextView]],
    onPanRight: Listeners[WidgetPanEvent[TextView]],
    onPanUp: Listeners[WidgetPanEvent[TextView]],
    onPanVertical: Listeners[WidgetPanEvent[TextView]],
    onResize: Listeners[WidgetResizeEvent[TextView]],
    onRightChanged: ChangeListeners[TextView, right],
    onSelectableChanged: ChangeListeners[TextView, selectable],
    onSwipeDown: Listeners[WidgetSwipeEvent[TextView]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[TextView]],
    onSwipeRight: Listeners[WidgetSwipeEvent[TextView]],
    onSwipeUp: Listeners[WidgetSwipeEvent[TextView]],
    onTap: Listeners[WidgetTapEvent[TextView]],
    onTapLink: Listeners[TextViewTapLinkEvent[TextView]],
    onTextChanged: ChangeListeners[TextView, text],
    onTextColorChanged: ChangeListeners[TextView, textColor],
    onTopChanged: ChangeListeners[TextView, top],
    onTouchCancel: Listeners[WidgetTouchEvent[TextView]],
    onTouchEnd: Listeners[WidgetTouchEvent[TextView]],
    onTouchMove: Listeners[WidgetTouchEvent[TextView]],
    onTouchStart: Listeners[WidgetTouchEvent[TextView]],
    onTransformChanged: ChangeListeners[TextView, transform],
    onVisibleChanged: ChangeListeners[TextView, visible],
    onWidthChanged: ChangeListeners[TextView, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => TextView,
    opacity: Double,
    ...
    trigger: /* type */ String => TextView,
    triggerAsync: /* type */ String => js.Promise[TextView],
    visible: Boolean,
    ...
    __obj.asInstanceOf[OmitTextViewset]
  }
  
  extension [Self <: OmitTextViewset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => TextView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[TextView, Omit[TextView, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => TextView): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => TextView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => TextView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[TextView, Omit[TextView, set | jsxAttributes]]) & `15`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => TextView
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => TextView
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAlignmentChanged(value: ChangeListeners[TextView, alignment]): Self = StObject.set(x, "onAlignmentChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[TextView, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[TextView, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[TextView, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[TextView, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[TextView, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[TextView, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[TextView, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[TextView, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[TextView, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[TextView, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[TextView]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[TextView, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[TextView, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[TextView, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnFontChanged(value: ChangeListeners[TextView, font]): Self = StObject.set(x, "onFontChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[TextView, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[TextView, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[TextView, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[TextView, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[TextView, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLineSpacingChanged(value: ChangeListeners[TextView, lineSpacing]): Self = StObject.set(x, "onLineSpacingChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[TextView]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnMarkupEnabledChanged(value: ChangeListeners[TextView, markupEnabled]): Self = StObject.set(x, "onMarkupEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnMaxLinesChanged(value: ChangeListeners[TextView, maxLines]): Self = StObject.set(x, "onMaxLinesChanged", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[TextView, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[TextView]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[TextView]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[TextView]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[TextView]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[TextView]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[TextView]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[TextView]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[TextView]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[TextView, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelectableChanged(value: ChangeListeners[TextView, selectable]): Self = StObject.set(x, "onSelectableChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[TextView]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[TextView]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[TextView]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[TextView]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[TextView]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTapLink(value: Listeners[TextViewTapLinkEvent[TextView]]): Self = StObject.set(x, "onTapLink", value.asInstanceOf[js.Any])
    
    inline def setOnTextChanged(value: ChangeListeners[TextView, text]): Self = StObject.set(x, "onTextChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTextColorChanged(value: ChangeListeners[TextView, textColor]): Self = StObject.set(x, "onTextColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[TextView, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[TextView]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[TextView]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[TextView]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[TextView]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[TextView, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[TextView, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[TextView, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => TextView): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[TextView]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
