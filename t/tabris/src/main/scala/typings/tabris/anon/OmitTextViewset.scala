...
trait OmitTextViewset extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): TextView
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], TextView]
  ...
  def insertAfter(widget: Widget[Any]): TextView
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], TextView]
  
  def insertBefore(widget: Widget[Any]): TextView
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], TextView]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): TextView
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): TextView
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
...
object OmitTextViewset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => TextView,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => TextView,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => TextView,
    opacity: Double,
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitTextViewset] (val x: Self) extends AnyVal {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => TextView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => TextView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => TextView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => TextView
