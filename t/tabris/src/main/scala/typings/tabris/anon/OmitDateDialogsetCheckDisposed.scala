...
trait OmitDateDialogsetCheckDisposed extends StObject {
  ...
  def close(): typings.tabris.global.tabris.DateDialog
  @JSName("close")
  var close_Original: js.Function0[typings.tabris.global.tabris.DateDialog]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.DateDialog
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.DateDialog
  def on(
    `type`: String,
  ...
  var onClose: Listeners[DateDialogCloseEvent[typings.tabris.global.tabris.DateDialog]]
  
  var onDateChanged: ChangeListeners[typings.tabris.global.tabris.DateDialog, date]
  
  var onMaxDateChanged: ChangeListeners[typings.tabris.global.tabris.DateDialog, maxDate]
  
  var onMinDateChanged: ChangeListeners[typings.tabris.global.tabris.DateDialog, minDate]
  
  var onSelect: Listeners[DateDialogSelectEvent[typings.tabris.global.tabris.DateDialog]]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.DateDialog
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def open(): typings.tabris.global.tabris.DateDialog
  @JSName("open")
  var open_Original: js.Function0[typings.tabris.global.tabris.DateDialog]
  
  def trigger(`type`: String): typings.tabris.global.tabris.DateDialog
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.DateDialog]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.DateDialog]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.DateDialog]
}
object OmitDateDialogsetCheckDisposed {
  ...
  inline def apply(
    ...
    cid: String,
    close: () => typings.tabris.global.tabris.DateDialog,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.DateDialog,
    onClose: Listeners[DateDialogCloseEvent[typings.tabris.global.tabris.DateDialog]],
    onDateChanged: ChangeListeners[typings.tabris.global.tabris.DateDialog, date],
    onMaxDateChanged: ChangeListeners[typings.tabris.global.tabris.DateDialog, maxDate],
    onMinDateChanged: ChangeListeners[typings.tabris.global.tabris.DateDialog, minDate],
    onSelect: Listeners[DateDialogSelectEvent[typings.tabris.global.tabris.DateDialog]],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.DateDialog,
    open: () => typings.tabris.global.tabris.DateDialog,
    trigger: /* type */ String => typings.tabris.global.tabris.DateDialog,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.DateDialog]
  ): OmitDateDialogsetCheckDisposed = {
  ...
  extension [Self <: OmitDateDialogsetCheckDisposed](x: Self) {
    ...
    inline def setClose(value: () => typings.tabris.global.tabris.DateDialog): Self = StObject.set(x, "close", js.Any.fromFunction0(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.DateDialog
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.DateDialog
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnClose(value: Listeners[DateDialogCloseEvent[typings.tabris.global.tabris.DateDialog]]): Self = StObject.set(x, "onClose", value.asInstanceOf[js.Any])
    
    inline def setOnDateChanged(value: ChangeListeners[typings.tabris.global.tabris.DateDialog, date]): Self = StObject.set(x, "onDateChanged", value.asInstanceOf[js.Any])
    
    inline def setOnMaxDateChanged(value: ChangeListeners[typings.tabris.global.tabris.DateDialog, maxDate]): Self = StObject.set(x, "onMaxDateChanged", value.asInstanceOf[js.Any])
    
    inline def setOnMinDateChanged(value: ChangeListeners[typings.tabris.global.tabris.DateDialog, minDate]): Self = StObject.set(x, "onMinDateChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[DateDialogSelectEvent[typings.tabris.global.tabris.DateDialog]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnce(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.DateDialog
    ): Self = StObject.set(x, "once", js.Any.fromFunction3(value))
    
    inline def setOpen(value: () => typings.tabris.global.tabris.DateDialog): Self = StObject.set(x, "open", js.Any.fromFunction0(value))
    
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.DateDialog): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.DateDialog]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
