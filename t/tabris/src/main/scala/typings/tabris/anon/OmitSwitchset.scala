...
object OmitSwitchset {
  ...
  extension [Self <: OmitSwitchset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => Switch): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[Switch, Omit[Switch, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => Switch): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => Switch): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => Switch): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[Switch, Omit[Switch, set | jsxAttributes]]) & `1`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
