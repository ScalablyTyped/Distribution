...
object OmitVideospeedpositiondurAbsoluteBounds {
  ...
  @scala.inline
  implicit class OmitVideospeedpositiondurAbsoluteBoundsMutableBuilder[Self <: OmitVideospeedpositiondurAbsoluteBounds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSet(value: /* properties */ Properties[Video, Omit[Video, set]] => Video): Self = StObject.set(x, "set", js.Any.fromFunction1(value))
