...
trait OmitAlertDialogtextInputsButtons extends StObject {
...
object OmitAlertDialogtextInputsButtons {
  ...
  def apply(
  ...
  ): OmitAlertDialogtextInputsButtons = {
    ...
    __obj.asInstanceOf[OmitAlertDialogtextInputsButtons]
  }
  
  @scala.inline
  implicit class OmitAlertDialogtextInputsButtonsMutableBuilder[Self <: OmitAlertDialogtextInputsButtons] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSet(value: /* properties */ Properties[AlertDialog, Omit[AlertDialog, set]] => AlertDialog): Self = StObject.set(x, "set", js.Any.fromFunction1(value))
