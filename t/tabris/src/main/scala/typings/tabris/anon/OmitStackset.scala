...
trait OmitStackset extends StObject {
  ...
  def _apply[Target](options: `11`[Target]): Stack
  def _apply[Target](options: `11`[Target], rules: js.Function1[/* widget */ Stack, StringDictionary[js.Object]]): Stack
  def _apply[Target](options: `11`[Target], rules: StringDictionary[js.Object]): Stack
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `11`[Stack], 
    /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Stack, StringDictionary[js.Object]]) | Null, 
    Stack
  ]
  ...
  def append(widgets: Widget*): Stack
  
  def appendTo(parent: Composite[Widget]): Stack
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], Stack]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, Stack]
  
  @JSName("apply")
  def apply[Target](options: `11`[Target]): Stack
  @JSName("apply")
  def apply[Target](options: `11`[Target], rules: js.Function1[/* widget */ Stack, StringDictionary[js.Object]]): Stack
  @JSName("apply")
  def apply[Target](options: `11`[Target], rules: StringDictionary[js.Object]): Stack
  @JSName("apply")
  ...
  def detach(): Stack
  @JSName("detach")
  var detach_Original: js.Function0[Stack]
  ...
  def insertAfter(widget: Widget): Stack
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Stack]
  
  def insertBefore(widget: Widget): Stack
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Stack]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: (JSXAttributes[Stack, Omit[Stack, set | typings.tabris.tabrisStrings.jsxAttributes]]) & `3`
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Stack
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): Stack
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[Stack]]
  
  var onBackgroundChanged: ChangeListeners[Stack, background]
  
  var onBaselineChanged: ChangeListeners[Stack, baseline]
  
  var onBottomChanged: ChangeListeners[Stack, bottom]
  
  var onBoundsChanged: ChangeListeners[Stack, bounds]
  
  var onCenterXChanged: ChangeListeners[Stack, centerX]
  
  var onCenterYChanged: ChangeListeners[Stack, centerY]
  
  var onClassChanged: ChangeListeners[Stack, `class`]
  
  var onClassListChanged: ChangeListeners[Stack, classList]
  
  var onCornerRadiusChanged: ChangeListeners[Stack, cornerRadius]
  
  var onDataChanged: ChangeListeners[Stack, data]
  
  var onDispose: Listeners[EventObject[Stack]]
  
  var onElevationChanged: ChangeListeners[Stack, elevation]
  
  var onEnabledChanged: ChangeListeners[Stack, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[Stack, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[Stack, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[Stack, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[Stack, id]
  
  var onLayoutDataChanged: ChangeListeners[Stack, layoutData]
  
  var onLeftChanged: ChangeListeners[Stack, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[Stack]]
  
  var onOpacityChanged: ChangeListeners[Stack, opacity]
  
  var onPan: Listeners[WidgetPanEvent[Stack]]
  
  var onPanDown: Listeners[WidgetPanEvent[Stack]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[Stack]]
  
  var onPanLeft: Listeners[WidgetPanEvent[Stack]]
  
  var onPanRight: Listeners[WidgetPanEvent[Stack]]
  
  var onPanUp: Listeners[WidgetPanEvent[Stack]]
  
  var onPanVertical: Listeners[WidgetPanEvent[Stack]]
  
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[Stack]]
  
  var onResize: Listeners[WidgetResizeEvent[Stack]]
  
  var onRightChanged: ChangeListeners[Stack, right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[Stack]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Stack]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[Stack]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[Stack]]
  
  var onTap: Listeners[WidgetTapEvent[Stack]]
  
  var onTopChanged: ChangeListeners[Stack, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[Stack]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[Stack]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[Stack]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[Stack]]
  
  var onTransformChanged: ChangeListeners[Stack, transform]
  
  var onVisibleChanged: ChangeListeners[Stack, visible]
  
  var onWidthChanged: ChangeListeners[Stack, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): Stack
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def trigger(`type`: String): Stack
  
  def triggerAsync(`type`: String): js.Promise[Stack]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Stack]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Stack]
...
object OmitStackset {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `11`[Stack], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Stack, StringDictionary[js.Object]]) | Null) => Stack,
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Widget => Stack,
    appendTo: /* parent */ Composite[Widget] => Stack,
    apply: (/* options */ `11`[Stack], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Stack, StringDictionary[js.Object]]) | Null) => Stack,
    ...
    id: String,
    insertAfter: /* widget */ Widget => Stack,
    insertBefore: /* widget */ Widget => Stack,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[Stack, Omit[Stack, set | jsxAttributes]]) & `3`,
    layout: StackLayout,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Stack,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Stack,
    onAddChild: Listeners[CompositeAddChildEvent[Stack]],
    onBackgroundChanged: ChangeListeners[Stack, background],
    onBaselineChanged: ChangeListeners[Stack, baseline],
    onBottomChanged: ChangeListeners[Stack, bottom],
    onBoundsChanged: ChangeListeners[Stack, bounds],
    onCenterXChanged: ChangeListeners[Stack, centerX],
    onCenterYChanged: ChangeListeners[Stack, centerY],
    onClassChanged: ChangeListeners[Stack, `class`],
    onClassListChanged: ChangeListeners[Stack, classList],
    onCornerRadiusChanged: ChangeListeners[Stack, cornerRadius],
    onDataChanged: ChangeListeners[Stack, data],
    onDispose: Listeners[EventObject[Stack]],
    onElevationChanged: ChangeListeners[Stack, elevation],
    onEnabledChanged: ChangeListeners[Stack, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[Stack, excludeFromLayout],
    onHeightChanged: ChangeListeners[Stack, height],
    onHighlightOnTouchChanged: ChangeListeners[Stack, highlightOnTouch],
    onIdChanged: ChangeListeners[Stack, id],
    onLayoutDataChanged: ChangeListeners[Stack, layoutData],
    onLeftChanged: ChangeListeners[Stack, left],
    onLongPress: Listeners[WidgetLongPressEvent[Stack]],
    onOpacityChanged: ChangeListeners[Stack, opacity],
    onPan: Listeners[WidgetPanEvent[Stack]],
    onPanDown: Listeners[WidgetPanEvent[Stack]],
    onPanHorizontal: Listeners[WidgetPanEvent[Stack]],
    onPanLeft: Listeners[WidgetPanEvent[Stack]],
    onPanRight: Listeners[WidgetPanEvent[Stack]],
    onPanUp: Listeners[WidgetPanEvent[Stack]],
    onPanVertical: Listeners[WidgetPanEvent[Stack]],
    onRemoveChild: Listeners[CompositeRemoveChildEvent[Stack]],
    onResize: Listeners[WidgetResizeEvent[Stack]],
    onRightChanged: ChangeListeners[Stack, right],
    onSwipeDown: Listeners[WidgetSwipeEvent[Stack]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[Stack]],
    onSwipeRight: Listeners[WidgetSwipeEvent[Stack]],
    onSwipeUp: Listeners[WidgetSwipeEvent[Stack]],
    onTap: Listeners[WidgetTapEvent[Stack]],
    onTopChanged: ChangeListeners[Stack, top],
    onTouchCancel: Listeners[WidgetTouchEvent[Stack]],
    onTouchEnd: Listeners[WidgetTouchEvent[Stack]],
    onTouchMove: Listeners[WidgetTouchEvent[Stack]],
    onTouchStart: Listeners[WidgetTouchEvent[Stack]],
    onTransformChanged: ChangeListeners[Stack, transform],
    onVisibleChanged: ChangeListeners[Stack, visible],
    onWidthChanged: ChangeListeners[Stack, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Stack,
    opacity: Double,
    ...
    trigger: /* type */ String => Stack,
    triggerAsync: /* type */ String => js.Promise[Stack],
    visible: Boolean,
    ...
    __obj.asInstanceOf[OmitStackset]
  }
  
  extension [Self <: OmitStackset](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget => Stack): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ Composite[Widget] => Stack): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `11`[Stack], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Stack, StringDictionary[js.Object]]) | Null) => Stack
    ...
    inline def setDetach(value: () => Stack): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => Stack): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => Stack): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[Stack, Omit[Stack, set | jsxAttributes]]) & `3`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Stack
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Stack
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAddChild(value: Listeners[CompositeAddChildEvent[Stack]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[Stack, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[Stack, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[Stack, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[Stack, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[Stack, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[Stack, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[Stack, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[Stack, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[Stack, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[Stack, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[Stack]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[Stack, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[Stack, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[Stack, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[Stack, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[Stack, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[Stack, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[Stack, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[Stack, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[Stack]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[Stack, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[Stack]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[Stack]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[Stack]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[Stack]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[Stack]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[Stack]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[Stack]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[Stack]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[Stack]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[Stack, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[Stack]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[Stack]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[Stack]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[Stack]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[Stack]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[Stack, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[Stack]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[Stack]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[Stack]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[Stack]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[Stack, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[Stack, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[Stack, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => Stack): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[Stack]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
