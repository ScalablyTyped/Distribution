...
trait OmitStackset extends StObject {
  ...
  def _apply[Target](options: `17`[Target], rules: RuleSet[Stack]): Stack
  @JSName("_apply")
  var _apply_Original: js.Function2[/* options */ `17`[Stack], /* rules */ RuleSet[Stack], Stack]
  ...
  def append(widgets: Widget[Any]*): Stack
  
  def appendTo(parent: Composite[Widget[Any]]): Stack
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], Stack]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget[Any], Stack]
  
  @JSName("apply")
  def apply[Target](options: `17`[Target], rules: RuleSet[Stack]): Stack
  @JSName("apply")
  var apply_Original: js.Function2[/* options */ `17`[Stack], /* rules */ RuleSet[Stack], Stack]
  ...
  def insertAfter(widget: Widget[Any]): Stack
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], Stack]
  
  def insertBefore(widget: Widget[Any]): Stack
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], Stack]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: JSXCompositeAttributes[Stack, Widget[Any]]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Stack
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Stack
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
...
object OmitStackset {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `17`[Stack], /* rules */ RuleSet[Stack]) => Stack,
    _checkDisposed: () => Unit,
    ...
    apply: (/* options */ `17`[Stack], /* rules */ RuleSet[Stack]) => Stack,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => Stack,
    insertBefore: /* widget */ Widget[Any] => Stack,
    isDisposed: () => Boolean,
    jsxAttributes: JSXCompositeAttributes[Stack, Widget[Any]],
    layout: StackLayout,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Stack,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Stack,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Stack,
    opacity: Double,
  ...
  extension [Self <: OmitStackset](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget[Any] => Stack): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => Stack): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(value: (/* options */ `17`[Stack], /* rules */ RuleSet[Stack]) => Stack): Self = StObject.set(x, "apply", js.Any.fromFunction2(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => Stack): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => Stack): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: JSXCompositeAttributes[Stack, Widget[Any]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Stack
    ...
    inline def set_apply(value: (/* options */ `17`[Stack], /* rules */ RuleSet[Stack]) => Stack): Self = StObject.set(x, "_apply", js.Any.fromFunction2(value))
