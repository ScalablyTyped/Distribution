...
trait OmitContentViewWidgetset[ChildType /* <: Widget */] extends StObject {
  ...
  def _apply[Target](options: `17`[Target]): ContentView_[ChildType]
  def _apply[Target](
    options: `17`[Target],
    rules: js.Function1[/* widget */ ContentView_[ChildType], StringDictionary[js.Object]]
  ): ContentView_[ChildType]
  def _apply[Target](options: `17`[Target], rules: StringDictionary[js.Object]): ContentView_[ChildType]
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `17`[ContentView_[ChildType]], 
    /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ ContentView_[ChildType], StringDictionary[js.Object]]) | Null, 
    ContentView_[ChildType]
  ]
  ...
  def append(widgets: Widget*): ContentView_[ChildType]
  
  def appendTo(parent: Composite[Widget]): ContentView_[ChildType]
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], ContentView_[ChildType]]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, ContentView_[ChildType]]
  
  @JSName("apply")
  def apply[Target](options: `17`[Target]): ContentView_[ChildType]
  @JSName("apply")
  def apply[Target](
    options: `17`[Target],
    rules: js.Function1[/* widget */ ContentView_[ChildType], StringDictionary[js.Object]]
  ...
  @JSName("apply")
  def apply[Target](options: `17`[Target], rules: StringDictionary[js.Object]): ContentView_[ChildType]
  @JSName("apply")
  ...
  def insertAfter(widget: Widget): ContentView_[ChildType]
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, ContentView_[ChildType]]
  
  def insertBefore(widget: Widget): ContentView_[ChildType]
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, ContentView_[ChildType]]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): ContentView_[ChildType]
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): ContentView_[ChildType]
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitContentViewWidgetset {
  ...
  def apply[ChildType /* <: Widget */](
    ...
    _apply: (/* options */ `17`[ContentView_[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ ContentView_[ChildType], StringDictionary[js.Object]]) | Null) => ContentView_[ChildType],
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Widget => ContentView_[ChildType],
    appendTo: /* parent */ Composite[Widget] => ContentView_[ChildType],
    apply: (/* options */ `17`[ContentView_[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ ContentView_[ChildType], StringDictionary[js.Object]]) | Null) => ContentView_[ChildType],
    ...
    id: String,
    insertAfter: /* widget */ Widget => ContentView_[ChildType],
    insertBefore: /* widget */ Widget => ContentView_[ChildType],
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[ContentView_[ChildType], Omit[ContentView_[ChildType], set | jsxAttributes]]) & `3`,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => ContentView_[ChildType],
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => ContentView_[ChildType],
    opacity: Double,
  ...
  ): OmitContentViewWidgetset[ChildType] = {
    ...
    __obj.asInstanceOf[OmitContentViewWidgetset[ChildType]]
  }
  
  @scala.inline
  implicit class OmitContentViewWidgetsetMutableBuilder[Self <: OmitContentViewWidgetset[?], ChildType /* <: Widget */] (val x: Self & OmitContentViewWidgetset[ChildType]) extends AnyVal {
    ...
    @scala.inline
    def setAppend(value: /* repeated */ Widget => ContentView_[ChildType]): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    @scala.inline
    def setAppendTo(value: /* parent */ Composite[Widget] => ContentView_[ChildType]): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    @scala.inline
    def setApply(
      value: (/* options */ `17`[ContentView_[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ ContentView_[ChildType], StringDictionary[js.Object]]) | Null) => ContentView_[ChildType]
    ...
    @scala.inline
    def setDetach(value: () => ContentView_[ChildType]): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setInsertAfter(value: /* widget */ Widget => ContentView_[ChildType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    @scala.inline
    def setInsertBefore(value: /* widget */ Widget => ContentView_[ChildType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    def setJsxAttributes(
      value: (JSXAttributes[ContentView_[ChildType], Omit[ContentView_[ChildType], set | jsxAttributes]]) & `3`
    ...
    @scala.inline
    def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => ContentView_[ChildType]
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    @scala.inline
    def setOnAddChild(value: Listeners[CompositeAddChildEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBackgroundChanged(value: ChangeListeners[ContentView_[ChildType], background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBaselineChanged(value: ChangeListeners[ContentView_[ChildType], baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBottomChanged(value: ChangeListeners[ContentView_[ChildType], bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBoundsChanged(value: ChangeListeners[ContentView_[ChildType], bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterXChanged(value: ChangeListeners[ContentView_[ChildType], centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterYChanged(value: ChangeListeners[ContentView_[ChildType], centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassChanged(value: ChangeListeners[ContentView_[ChildType], `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassListChanged(value: ChangeListeners[ContentView_[ChildType], classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCornerRadiusChanged(value: ChangeListeners[ContentView_[ChildType], cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDataChanged(value: ChangeListeners[ContentView_[ChildType], data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDispose(value: Listeners[EventObject[ContentView_[ChildType]]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnElevationChanged(value: ChangeListeners[ContentView_[ChildType], elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnEnabledChanged(value: ChangeListeners[ContentView_[ChildType], enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnExcludeFromLayoutChanged(value: ChangeListeners[ContentView_[ChildType], excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHeightChanged(value: ChangeListeners[ContentView_[ChildType], height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHighlightOnTouchChanged(value: ChangeListeners[ContentView_[ChildType], highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnIdChanged(value: ChangeListeners[ContentView_[ChildType], id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLayoutDataChanged(value: ChangeListeners[ContentView_[ChildType], layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLeftChanged(value: ChangeListeners[ContentView_[ChildType], left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLongPress(value: Listeners[WidgetLongPressEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnOpacityChanged(value: ChangeListeners[ContentView_[ChildType], opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPan(value: Listeners[WidgetPanEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanDown(value: Listeners[WidgetPanEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanHorizontal(value: Listeners[WidgetPanEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanLeft(value: Listeners[WidgetPanEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanRight(value: Listeners[WidgetPanEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanUp(value: Listeners[WidgetPanEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanVertical(value: Listeners[WidgetPanEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnResize(value: Listeners[WidgetResizeEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRightChanged(value: ChangeListeners[ContentView_[ChildType], right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTap(value: Listeners[WidgetTapEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTopChanged(value: ChangeListeners[ContentView_[ChildType], top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchCancel(value: Listeners[WidgetTouchEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchEnd(value: Listeners[WidgetTouchEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchMove(value: Listeners[WidgetTouchEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchStart(value: Listeners[WidgetTouchEvent[ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTransformChanged(value: ChangeListeners[ContentView_[ChildType], transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnVisibleChanged(value: ChangeListeners[ContentView_[ChildType], visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnWidthChanged(value: ChangeListeners[ContentView_[ChildType], width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTrigger(value: /* type */ String => ContentView_[ChildType]): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTriggerAsync(value: /* type */ String => js.Promise[ContentView_[ChildType]]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
