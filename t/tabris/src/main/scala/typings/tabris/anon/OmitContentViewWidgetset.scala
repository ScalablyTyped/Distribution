...
object OmitContentViewWidgetset {
  ...
  extension [Self <: OmitContentViewWidgetset[?], ChildType /* <: Widget */](x: Self & OmitContentViewWidgetset[ChildType]) {
    ...
    inline def setAppend(value: /* repeated */ Widget => ContentView_[ChildType]): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ Composite[Widget] => ContentView_[ChildType]): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => ContentView_[ChildType]): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => ContentView_[ChildType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => ContentView_[ChildType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
