...
object OmitTabset {
  ...
  extension [Self <: OmitTabset](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget => Tab): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    ...
    inline def setJsxAttributes(value: (JSXAttributes[Tab, Omit[Tab, set | jsxAttributes]]) & `3`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
