...
trait OmitNavigationViewPageAct[PageType /* <: Page */, ActionType /* <: Action */] extends StObject {
  ...
  def _apply[Target](options: `5`[Target]): NavigationView[PageType, ActionType]
  def _apply[Target](
    options: `5`[Target],
    rules: js.Function1[/* widget */ NavigationView[PageType, ActionType], StringDictionary[js.Object]]
  ): NavigationView[PageType, ActionType]
  def _apply[Target](options: `5`[Target], rules: StringDictionary[js.Object]): NavigationView[PageType, ActionType]
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `5`[NavigationView[PageType, ActionType]], 
    /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ NavigationView[PageType, ActionType], StringDictionary[js.Object]]) | Null, 
    NavigationView[PageType, ActionType]
  ]
  ...
  def append(widgets: (Page | Action)*): NavigationView[PageType, ActionType]
  
  def appendTo(parent: Composite[Widget]): NavigationView[PageType, ActionType]
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], NavigationView[PageType, ActionType]]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Page | Action, NavigationView[PageType, ActionType]]
  
  @JSName("apply")
  def apply[Target](options: `5`[Target]): NavigationView[PageType, ActionType]
  @JSName("apply")
  def apply[Target](
    options: `5`[Target],
    rules: js.Function1[/* widget */ NavigationView[PageType, ActionType], StringDictionary[js.Object]]
  ...
  @JSName("apply")
  def apply[Target](options: `5`[Target], rules: StringDictionary[js.Object]): NavigationView[PageType, ActionType]
  @JSName("apply")
  ...
  def detach(): NavigationView[PageType, ActionType]
  @JSName("detach")
  var detach_Original: js.Function0[NavigationView[PageType, ActionType]]
  ...
  def insertAfter(widget: Widget): NavigationView[PageType, ActionType]
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, NavigationView[PageType, ActionType]]
  
  def insertBefore(widget: Widget): NavigationView[PageType, ActionType]
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, NavigationView[PageType, ActionType]]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): NavigationView[PageType, ActionType]
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): NavigationView[PageType, ActionType]
  def on(
    `type`: String,
  ...
  var onActionColorChanged: ChangeListeners[NavigationView[PageType, ActionType], actionColor]
  
  var onActionTextColorChanged: ChangeListeners[NavigationView[PageType, ActionType], actionTextColor]
  
  var onAddChild: Listeners[CompositeAddChildEvent[NavigationView[PageType, ActionType]]]
  
  var onBackgroundChanged: ChangeListeners[NavigationView[PageType, ActionType], background]
  
  var onBaselineChanged: ChangeListeners[NavigationView[PageType, ActionType], baseline]
  
  var onBottomChanged: ChangeListeners[NavigationView[PageType, ActionType], bottom]
  
  var onBoundsChanged: ChangeListeners[NavigationView[PageType, ActionType], bounds]
  
  var onCenterXChanged: ChangeListeners[NavigationView[PageType, ActionType], centerX]
  
  var onCenterYChanged: ChangeListeners[NavigationView[PageType, ActionType], centerY]
  
  var onClassChanged: ChangeListeners[NavigationView[PageType, ActionType], `class`]
  
  var onClassListChanged: ChangeListeners[NavigationView[PageType, ActionType], classList]
  
  var onCornerRadiusChanged: ChangeListeners[NavigationView[PageType, ActionType], cornerRadius]
  
  var onDataChanged: ChangeListeners[NavigationView[PageType, ActionType], data]
  
  var onDispose: Listeners[EventObject[NavigationView[PageType, ActionType]]]
  
  var onDrawerActionVisibleChanged: ChangeListeners[NavigationView[PageType, ActionType], drawerActionVisible]
  
  var onElevationChanged: ChangeListeners[NavigationView[PageType, ActionType], elevation]
  
  var onEnabledChanged: ChangeListeners[NavigationView[PageType, ActionType], enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[NavigationView[PageType, ActionType], excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[NavigationView[PageType, ActionType], height]
  
  var onHighlightOnTouchChanged: ChangeListeners[NavigationView[PageType, ActionType], highlightOnTouch]
  
  var onIdChanged: ChangeListeners[NavigationView[PageType, ActionType], id]
  
  var onLayoutDataChanged: ChangeListeners[NavigationView[PageType, ActionType], layoutData]
  
  var onLeftChanged: ChangeListeners[NavigationView[PageType, ActionType], left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[NavigationView[PageType, ActionType]]]
  
  var onOpacityChanged: ChangeListeners[NavigationView[PageType, ActionType], opacity]
  
  var onPageAnimationChanged: ChangeListeners[NavigationView[PageType, ActionType], pageAnimation]
  
  var onPan: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]
  
  var onPanDown: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]
  
  var onPanLeft: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]
  
  var onPanRight: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]
  
  var onPanUp: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]
  
  var onPanVertical: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]
  
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[NavigationView[PageType, ActionType]]]
  
  var onResize: Listeners[WidgetResizeEvent[NavigationView[PageType, ActionType]]]
  
  var onRightChanged: ChangeListeners[NavigationView[PageType, ActionType], right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]
  
  var onTap: Listeners[WidgetTapEvent[NavigationView[PageType, ActionType]]]
  
  var onTitleTextColorChanged: ChangeListeners[NavigationView[PageType, ActionType], titleTextColor]
  
  var onToolbarColorChanged: ChangeListeners[NavigationView[PageType, ActionType], toolbarColor]
  
  var onToolbarHeightChanged: ChangeListeners[NavigationView[PageType, ActionType], toolbarHeight]
  
  var onToolbarVisibleChanged: ChangeListeners[NavigationView[PageType, ActionType], toolbarVisible]
  
  var onTopChanged: ChangeListeners[NavigationView[PageType, ActionType], top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]
  
  var onTransformChanged: ChangeListeners[NavigationView[PageType, ActionType], transform]
  
  var onVisibleChanged: ChangeListeners[NavigationView[PageType, ActionType], visible]
  
  var onWidthChanged: ChangeListeners[NavigationView[PageType, ActionType], width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): NavigationView[PageType, ActionType]
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def trigger(`type`: String): NavigationView[PageType, ActionType]
  
  def triggerAsync(`type`: String): js.Promise[NavigationView[PageType, ActionType]]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[NavigationView[PageType, ActionType]]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, NavigationView[PageType, ActionType]]
  
  var visible: Boolean
  
  var width: Dimension | auto
}
object OmitNavigationViewPageAct {
  
  @scala.inline
  def apply[PageType /* <: Page */, ActionType /* <: Action */](
    ...
    _apply: (/* options */ `5`[NavigationView[PageType, ActionType]], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ NavigationView[PageType, ActionType], StringDictionary[js.Object]]) | Null) => NavigationView[PageType, ActionType],
    _checkDisposed: () => Unit,
    ...
    appendTo: /* parent */ Composite[Widget] => NavigationView[PageType, ActionType],
    apply: (/* options */ `5`[NavigationView[PageType, ActionType]], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ NavigationView[PageType, ActionType], StringDictionary[js.Object]]) | Null) => NavigationView[PageType, ActionType],
    ...
    detach: () => NavigationView[PageType, ActionType],
    dispose: () => Unit,
    ...
    id: String,
    insertAfter: /* widget */ Widget => NavigationView[PageType, ActionType],
    insertBefore: /* widget */ Widget => NavigationView[PageType, ActionType],
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[
      NavigationView[PageType, ActionType], 
      Omit[NavigationView[PageType, ActionType], set | jsxAttributes]
    ]) & `6`,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => NavigationView[PageType, ActionType],
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => NavigationView[PageType, ActionType],
    onActionColorChanged: ChangeListeners[NavigationView[PageType, ActionType], actionColor],
    onActionTextColorChanged: ChangeListeners[NavigationView[PageType, ActionType], actionTextColor],
    onAddChild: Listeners[CompositeAddChildEvent[NavigationView[PageType, ActionType]]],
    onBackgroundChanged: ChangeListeners[NavigationView[PageType, ActionType], background],
    onBaselineChanged: ChangeListeners[NavigationView[PageType, ActionType], baseline],
    onBottomChanged: ChangeListeners[NavigationView[PageType, ActionType], bottom],
    onBoundsChanged: ChangeListeners[NavigationView[PageType, ActionType], bounds],
    onCenterXChanged: ChangeListeners[NavigationView[PageType, ActionType], centerX],
    onCenterYChanged: ChangeListeners[NavigationView[PageType, ActionType], centerY],
    onClassChanged: ChangeListeners[NavigationView[PageType, ActionType], `class`],
    onClassListChanged: ChangeListeners[NavigationView[PageType, ActionType], classList],
    onCornerRadiusChanged: ChangeListeners[NavigationView[PageType, ActionType], cornerRadius],
    onDataChanged: ChangeListeners[NavigationView[PageType, ActionType], data],
    onDispose: Listeners[EventObject[NavigationView[PageType, ActionType]]],
    onDrawerActionVisibleChanged: ChangeListeners[NavigationView[PageType, ActionType], drawerActionVisible],
    onElevationChanged: ChangeListeners[NavigationView[PageType, ActionType], elevation],
    onEnabledChanged: ChangeListeners[NavigationView[PageType, ActionType], enabled],
    onExcludeFromLayoutChanged: ChangeListeners[NavigationView[PageType, ActionType], excludeFromLayout],
    onHeightChanged: ChangeListeners[NavigationView[PageType, ActionType], height],
    onHighlightOnTouchChanged: ChangeListeners[NavigationView[PageType, ActionType], highlightOnTouch],
    onIdChanged: ChangeListeners[NavigationView[PageType, ActionType], id],
    onLayoutDataChanged: ChangeListeners[NavigationView[PageType, ActionType], layoutData],
    onLeftChanged: ChangeListeners[NavigationView[PageType, ActionType], left],
    onLongPress: Listeners[WidgetLongPressEvent[NavigationView[PageType, ActionType]]],
    onOpacityChanged: ChangeListeners[NavigationView[PageType, ActionType], opacity],
    onPageAnimationChanged: ChangeListeners[NavigationView[PageType, ActionType], pageAnimation],
    onPan: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]],
    onPanDown: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]],
    onPanHorizontal: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]],
    onPanLeft: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]],
    onPanRight: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]],
    onPanUp: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]],
    onPanVertical: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]],
    onRemoveChild: Listeners[CompositeRemoveChildEvent[NavigationView[PageType, ActionType]]],
    onResize: Listeners[WidgetResizeEvent[NavigationView[PageType, ActionType]]],
    onRightChanged: ChangeListeners[NavigationView[PageType, ActionType], right],
    onSwipeDown: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]],
    onSwipeRight: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]],
    onSwipeUp: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]],
    onTap: Listeners[WidgetTapEvent[NavigationView[PageType, ActionType]]],
    onTitleTextColorChanged: ChangeListeners[NavigationView[PageType, ActionType], titleTextColor],
    onToolbarColorChanged: ChangeListeners[NavigationView[PageType, ActionType], toolbarColor],
    onToolbarHeightChanged: ChangeListeners[NavigationView[PageType, ActionType], toolbarHeight],
    onToolbarVisibleChanged: ChangeListeners[NavigationView[PageType, ActionType], toolbarVisible],
    onTopChanged: ChangeListeners[NavigationView[PageType, ActionType], top],
    onTouchCancel: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]],
    onTouchEnd: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]],
    onTouchMove: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]],
    onTouchStart: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]],
    onTransformChanged: ChangeListeners[NavigationView[PageType, ActionType], transform],
    onVisibleChanged: ChangeListeners[NavigationView[PageType, ActionType], visible],
    onWidthChanged: ChangeListeners[NavigationView[PageType, ActionType], width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => NavigationView[PageType, ActionType],
    opacity: Double,
    ...
    trigger: /* type */ String => NavigationView[PageType, ActionType],
    triggerAsync: /* type */ String => js.Promise[NavigationView[PageType, ActionType]],
    visible: Boolean,
  ...
  @scala.inline
  implicit class OmitNavigationViewPageActMutableBuilder[Self <: OmitNavigationViewPageAct[?, ?], PageType /* <: Page */, ActionType /* <: Action */] (val x: Self & (OmitNavigationViewPageAct[PageType, ActionType])) extends AnyVal {
    ...
    @scala.inline
    def setActionColor(value: ColorValue): Self = StObject.set(x, "actionColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setActionColorNull: Self = StObject.set(x, "actionColor", null)
    
    @scala.inline
    def setActionTextColor(value: ColorValue): Self = StObject.set(x, "actionTextColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setActionTextColorNull: Self = StObject.set(x, "actionTextColor", null)
    ...
    @scala.inline
    def setAppend(value: /* repeated */ Page | Action => NavigationView[PageType, ActionType]): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    @scala.inline
    def setAppendTo(value: /* parent */ Composite[Widget] => NavigationView[PageType, ActionType]): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    @scala.inline
    def setApply(
      value: (/* options */ `5`[NavigationView[PageType, ActionType]], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ NavigationView[PageType, ActionType], StringDictionary[js.Object]]) | Null) => NavigationView[PageType, ActionType]
    ...
    @scala.inline
    def setDetach(value: () => NavigationView[PageType, ActionType]): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    
    @scala.inline
    def setDispose(value: () => Unit): Self = StObject.set(x, "dispose", js.Any.fromFunction0(value))
    
    @scala.inline
    def setDrawerActionVisible(value: Boolean): Self = StObject.set(x, "drawerActionVisible", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInsertAfter(value: /* widget */ Widget => NavigationView[PageType, ActionType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    @scala.inline
    def setInsertBefore(value: /* widget */ Widget => NavigationView[PageType, ActionType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    @scala.inline
    def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    @scala.inline
    def setJsxAttributes(
      value: (JSXAttributes[
          NavigationView[PageType, ActionType], 
          Omit[NavigationView[PageType, ActionType], set | jsxAttributes]
        ]) & `6`
    ...
    @scala.inline
    def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => NavigationView[PageType, ActionType]
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    @scala.inline
    def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => NavigationView[PageType, ActionType]
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    @scala.inline
    def setOnActionColorChanged(value: ChangeListeners[NavigationView[PageType, ActionType], actionColor]): Self = StObject.set(x, "onActionColorChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnActionTextColorChanged(value: ChangeListeners[NavigationView[PageType, ActionType], actionTextColor]): Self = StObject.set(x, "onActionTextColorChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnAddChild(value: Listeners[CompositeAddChildEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBackgroundChanged(value: ChangeListeners[NavigationView[PageType, ActionType], background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBaselineChanged(value: ChangeListeners[NavigationView[PageType, ActionType], baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBottomChanged(value: ChangeListeners[NavigationView[PageType, ActionType], bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBoundsChanged(value: ChangeListeners[NavigationView[PageType, ActionType], bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterXChanged(value: ChangeListeners[NavigationView[PageType, ActionType], centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterYChanged(value: ChangeListeners[NavigationView[PageType, ActionType], centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassChanged(value: ChangeListeners[NavigationView[PageType, ActionType], `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassListChanged(value: ChangeListeners[NavigationView[PageType, ActionType], classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCornerRadiusChanged(value: ChangeListeners[NavigationView[PageType, ActionType], cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDataChanged(value: ChangeListeners[NavigationView[PageType, ActionType], data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDispose(value: Listeners[EventObject[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDrawerActionVisibleChanged(value: ChangeListeners[NavigationView[PageType, ActionType], drawerActionVisible]): Self = StObject.set(x, "onDrawerActionVisibleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnElevationChanged(value: ChangeListeners[NavigationView[PageType, ActionType], elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnEnabledChanged(value: ChangeListeners[NavigationView[PageType, ActionType], enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnExcludeFromLayoutChanged(value: ChangeListeners[NavigationView[PageType, ActionType], excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHeightChanged(value: ChangeListeners[NavigationView[PageType, ActionType], height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHighlightOnTouchChanged(value: ChangeListeners[NavigationView[PageType, ActionType], highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnIdChanged(value: ChangeListeners[NavigationView[PageType, ActionType], id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLayoutDataChanged(value: ChangeListeners[NavigationView[PageType, ActionType], layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLeftChanged(value: ChangeListeners[NavigationView[PageType, ActionType], left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLongPress(value: Listeners[WidgetLongPressEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnOpacityChanged(value: ChangeListeners[NavigationView[PageType, ActionType], opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPageAnimationChanged(value: ChangeListeners[NavigationView[PageType, ActionType], pageAnimation]): Self = StObject.set(x, "onPageAnimationChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPan(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanDown(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanHorizontal(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanLeft(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanRight(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanUp(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanVertical(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnResize(value: Listeners[WidgetResizeEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRightChanged(value: ChangeListeners[NavigationView[PageType, ActionType], right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTap(value: Listeners[WidgetTapEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTitleTextColorChanged(value: ChangeListeners[NavigationView[PageType, ActionType], titleTextColor]): Self = StObject.set(x, "onTitleTextColorChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnToolbarColorChanged(value: ChangeListeners[NavigationView[PageType, ActionType], toolbarColor]): Self = StObject.set(x, "onToolbarColorChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnToolbarHeightChanged(value: ChangeListeners[NavigationView[PageType, ActionType], toolbarHeight]): Self = StObject.set(x, "onToolbarHeightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnToolbarVisibleChanged(value: ChangeListeners[NavigationView[PageType, ActionType], toolbarVisible]): Self = StObject.set(x, "onToolbarVisibleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTopChanged(value: ChangeListeners[NavigationView[PageType, ActionType], top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchCancel(value: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchEnd(value: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchMove(value: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchStart(value: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTransformChanged(value: ChangeListeners[NavigationView[PageType, ActionType], transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnVisibleChanged(value: ChangeListeners[NavigationView[PageType, ActionType], visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnWidthChanged(value: ChangeListeners[NavigationView[PageType, ActionType], width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPageAnimation(value: default | none): Self = StObject.set(x, "pageAnimation", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPages(value: /* selector */ js.UndefOr[Selector[Widget, Widget]] => WidgetCollection[Page]): Self = StObject.set(x, "pages", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setTitleTextColorNull: Self = StObject.set(x, "titleTextColor", null)
    
    @scala.inline
    def setToolbarColor(value: ColorValue): Self = StObject.set(x, "toolbarColor", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setToolbarColorNull: Self = StObject.set(x, "toolbarColor", null)
    
    @scala.inline
    def setToolbarHeight(value: Double): Self = StObject.set(x, "toolbarHeight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setToolbarVisible(value: Boolean): Self = StObject.set(x, "toolbarVisible", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTrigger(value: /* type */ String => NavigationView[PageType, ActionType]): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTriggerAsync(value: /* type */ String => js.Promise[NavigationView[PageType, ActionType]]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
