...
object OmitNavigationViewPageAct {
  ...
  extension [Self <: OmitNavigationViewPageAct[?, ?], PageType /* <: Page */, ActionType /* <: Action */](x: Self & (OmitNavigationViewPageAct[PageType, ActionType])) {
    ...
    inline def setAppend(value: /* repeated */ Page | Action => NavigationView[PageType, ActionType]): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ Composite[Widget] => NavigationView[PageType, ActionType]): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => NavigationView[PageType, ActionType]): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => NavigationView[PageType, ActionType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => NavigationView[PageType, ActionType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOnActionColorChanged(value: ChangeListeners[NavigationView[PageType, ActionType], actionColor]): Self = StObject.set(x, "onActionColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnActionTextColorChanged(value: ChangeListeners[NavigationView[PageType, ActionType], actionTextColor]): Self = StObject.set(x, "onActionTextColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnAddChild(value: Listeners[CompositeAddChildEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[NavigationView[PageType, ActionType], background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[NavigationView[PageType, ActionType], baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[NavigationView[PageType, ActionType], bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[NavigationView[PageType, ActionType], bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[NavigationView[PageType, ActionType], centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[NavigationView[PageType, ActionType], centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[NavigationView[PageType, ActionType], `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[NavigationView[PageType, ActionType], classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[NavigationView[PageType, ActionType], cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[NavigationView[PageType, ActionType], data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnDrawerActionVisibleChanged(value: ChangeListeners[NavigationView[PageType, ActionType], drawerActionVisible]): Self = StObject.set(x, "onDrawerActionVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[NavigationView[PageType, ActionType], elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[NavigationView[PageType, ActionType], enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[NavigationView[PageType, ActionType], excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[NavigationView[PageType, ActionType], height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[NavigationView[PageType, ActionType], highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[NavigationView[PageType, ActionType], id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[NavigationView[PageType, ActionType], layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[NavigationView[PageType, ActionType], left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[NavigationView[PageType, ActionType], opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPageAnimationChanged(value: ChangeListeners[NavigationView[PageType, ActionType], pageAnimation]): Self = StObject.set(x, "onPageAnimationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[NavigationView[PageType, ActionType], right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTitleTextColorChanged(value: ChangeListeners[NavigationView[PageType, ActionType], titleTextColor]): Self = StObject.set(x, "onTitleTextColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnToolbarColorChanged(value: ChangeListeners[NavigationView[PageType, ActionType], toolbarColor]): Self = StObject.set(x, "onToolbarColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnToolbarHeightChanged(value: ChangeListeners[NavigationView[PageType, ActionType], toolbarHeight]): Self = StObject.set(x, "onToolbarHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnToolbarVisibleChanged(value: ChangeListeners[NavigationView[PageType, ActionType], toolbarVisible]): Self = StObject.set(x, "onToolbarVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[NavigationView[PageType, ActionType], top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[NavigationView[PageType, ActionType]]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[NavigationView[PageType, ActionType], transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[NavigationView[PageType, ActionType], visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[NavigationView[PageType, ActionType], width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => NavigationView[PageType, ActionType]): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[NavigationView[PageType, ActionType]]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
