...
object OmitPageset {
  ...
  extension [Self <: OmitPageset](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget => Page): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    ...
    inline def setJsxAttributes(value: (JSXAttributes[Page, Omit[Page, set | jsxAttributes]]) & `3`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
