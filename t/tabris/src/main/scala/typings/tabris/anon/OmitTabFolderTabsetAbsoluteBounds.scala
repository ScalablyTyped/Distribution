...
import typings.tabris.mod.TabFolderScrollEvent
import typings.tabris.mod.TabFolderSelectEvent
...
import typings.tabris.mod.widgets.TabFolder
...
trait OmitTabFolderTabsetAbsoluteBounds[TabType /* <: Tab */] extends StObject {
  ...
  def _apply[Target](options: `29`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.TabFolder[TabType]]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `29`[typings.tabris.global.tabris.widgets.TabFolder[TabType]], 
    /* rules */ RuleSet[typings.tabris.global.tabris.widgets.TabFolder[TabType]], 
    typings.tabris.global.tabris.widgets.TabFolder[TabType]
  ]
  ...
  def append(widgets: Tab*): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  
  def appendTo(parent: Composite[Widget[Any]]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("appendTo")
  ...
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Tab, typings.tabris.global.tabris.widgets.TabFolder[TabType]]
  
  @JSName("apply")
  def apply[Target](options: `29`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.TabFolder[TabType]]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("apply")
  ...
  def detach(): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.TabFolder[TabType]]
  ...
  def insertAfter(widget: Widget[Any]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.TabFolder[TabType]]
  
  def insertBefore(widget: Widget[Any]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.TabFolder[TabType]]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.TabFolder[TabType], Tab]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], id]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], opacity]
  
  var onPagingChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], paging]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onRemoveChild: Listeners[
    CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]
  ]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], right]
  
  var onScroll: Listeners[TabFolderScrollEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onSelect: Listeners[TabFolderSelectEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onSelectedTabIndicatorTintColorChanged: ChangeListeners[
    typings.tabris.global.tabris.widgets.TabFolder[TabType], 
    selectedTabIndicatorTintColor
  ]
  
  var onSelectedTabTintColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], selectedTabTintColor]
  
  var onSelectionChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], selection]
  
  var onSelectionIndexChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], selectionIndex]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onTabBarBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], tabBarBackground]
  
  var onTabBarElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], tabBarElevation]
  
  var onTabTintColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], tabTintColor]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.TabFolder[TabType]]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[
    /* type */ String, 
    js.Promise[typings.tabris.global.tabris.widgets.TabFolder[TabType]]
  ]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.TabFolder[TabType]]
  
  var visible: Boolean
  
  var width: Dimension | auto
}
object OmitTabFolderTabsetAbsoluteBounds {
  ...
  inline def apply[TabType /* <: Tab */](
    ...
    _apply: (/* options */ `29`[typings.tabris.global.tabris.widgets.TabFolder[TabType]], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.TabFolder[TabType]]) => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Tab => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    appendTo: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    apply: (/* options */ `29`[typings.tabris.global.tabris.widgets.TabFolder[TabType]], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.TabFolder[TabType]]) => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    ...
    cornerRadius: Double,
    data: Any,
    detach: () => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    insertBefore: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    isDisposed: () => Boolean,
    jsxAttributes: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.TabFolder[TabType], Tab],
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    onAddChild: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], id],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], opacity],
    onPagingChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], paging],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onRemoveChild: Listeners[
      CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]
    ],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], right],
    onScroll: Listeners[TabFolderScrollEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onSelect: Listeners[TabFolderSelectEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onSelectedTabIndicatorTintColorChanged: ChangeListeners[
      typings.tabris.global.tabris.widgets.TabFolder[TabType], 
      selectedTabIndicatorTintColor
    ],
    onSelectedTabTintColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], selectedTabTintColor],
    onSelectionChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], selection],
    onSelectionIndexChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], selectionIndex],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onTabBarBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], tabBarBackground],
    onTabBarElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], tabBarElevation],
    onTabTintColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], tabTintColor],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    opacity: Double,
    paging: Boolean,
    parent: () => Composite[Widget[Any]],
  ...
  implicit open class MutableBuilder[Self <: OmitTabFolderTabsetAbsoluteBounds[?], TabType /* <: Tab */] (val x: Self & OmitTabFolderTabsetAbsoluteBounds[TabType]) extends AnyVal {
    ...
    inline def setAppend(value: /* repeated */ Tab => typings.tabris.global.tabris.widgets.TabFolder[TabType]): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(
      value: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.TabFolder[TabType]
    ): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `29`[typings.tabris.global.tabris.widgets.TabFolder[TabType]], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.TabFolder[TabType]]) => typings.tabris.global.tabris.widgets.TabFolder[TabType]
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.TabFolder[TabType]): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.TabFolder[TabType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.TabFolder[TabType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.TabFolder[TabType], Tab]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TabFolder[TabType]
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TabFolder[TabType]
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAddChild(value: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPagingChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], paging]): Self = StObject.set(x, "onPagingChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    ...
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnScroll(value: Listeners[TabFolderScrollEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onScroll", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[TabFolderSelectEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnSelectedTabIndicatorTintColorChanged(
      value: ChangeListeners[
          typings.tabris.global.tabris.widgets.TabFolder[TabType], 
          selectedTabIndicatorTintColor
        ]
    ): Self = StObject.set(x, "onSelectedTabIndicatorTintColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelectedTabTintColorChanged(
      value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], selectedTabTintColor]
    ): Self = StObject.set(x, "onSelectedTabTintColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelectionChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], selection]): Self = StObject.set(x, "onSelectionChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelectionIndexChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], selectionIndex]): Self = StObject.set(x, "onSelectionIndexChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTabBarBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], tabBarBackground]): Self = StObject.set(x, "onTabBarBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTabBarElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], tabBarElevation]): Self = StObject.set(x, "onTabBarElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTabTintColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], tabTintColor]): Self = StObject.set(x, "onTabTintColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.TabFolder[TabType]]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.TabFolder[TabType], width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.TabFolder[TabType]): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.TabFolder[TabType]]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
