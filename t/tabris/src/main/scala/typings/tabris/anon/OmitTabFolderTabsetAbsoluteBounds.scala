...
trait OmitTabFolderTabsetAbsoluteBounds[TabType /* <: Tab */] extends StObject {
  ...
  def _apply[Target](options: `29`[Target]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  def _apply[Target](
    options: `29`[Target],
    rules: js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.TabFolder[TabType], 
      StringDictionary[js.Object]
    ]
  ): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  def _apply[Target](options: `29`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("_apply")
  ...
  def appendTo(parent: Composite[Widget]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("appendTo")
  ...
  @JSName("apply")
  def apply[Target](options: `29`[Target]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("apply")
  def apply[Target](
    options: `29`[Target],
    rules: js.Function1[
  ...
  @JSName("apply")
  def apply[Target](options: `29`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("apply")
  ...
  def insertAfter(widget: Widget): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.TabFolder[TabType]]
  
  def insertBefore(widget: Widget): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.TabFolder[TabType]]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.TabFolder[TabType]
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitTabFolderTabsetAbsoluteBounds {
  ...
  inline def apply[TabType /* <: Tab */](
    ...
    _apply: (/* options */ `29`[typings.tabris.global.tabris.widgets.TabFolder[TabType]], /* rules */ StringDictionary[js.Object] | (js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.TabFolder[TabType], 
      StringDictionary[js.Object]
    ]) | Null) => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    _checkDisposed: () => Unit,
    ...
    appendTo: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    apply: (/* options */ `29`[typings.tabris.global.tabris.widgets.TabFolder[TabType]], /* rules */ StringDictionary[js.Object] | (js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.TabFolder[TabType], 
      StringDictionary[js.Object]
    ]) | Null) => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    ...
    id: String,
    insertAfter: /* widget */ Widget => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    insertBefore: /* widget */ Widget => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[
      typings.tabris.global.tabris.widgets.TabFolder[TabType], 
      Omit[typings.tabris.global.tabris.widgets.TabFolder[TabType], set | jsxAttributes]
    ]) & `14`,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TabFolder[TabType],
    opacity: Double,
    paging: Boolean,
    parent: () => Composite[Widget],
  ...
  extension [Self <: OmitTabFolderTabsetAbsoluteBounds[?], TabType /* <: Tab */](x: Self & OmitTabFolderTabsetAbsoluteBounds[TabType]) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.TabFolder[TabType]): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `29`[typings.tabris.global.tabris.widgets.TabFolder[TabType]], /* rules */ StringDictionary[js.Object] | (js.Function1[
          /* widget */ typings.tabris.global.tabris.widgets.TabFolder[TabType], 
          StringDictionary[js.Object]
        ]) | Null) => typings.tabris.global.tabris.widgets.TabFolder[TabType]
    ...
    inline def setInsertAfter(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.TabFolder[TabType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.TabFolder[TabType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.TabFolder[TabType]
