...
import typings.tabris.mod.widgets.Stack
...
trait OmitStacksetAbsoluteBounds extends StObject {
  ...
  def _apply[Target](options: `27`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.Stack]): typings.tabris.global.tabris.widgets.Stack
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `27`[typings.tabris.global.tabris.widgets.Stack], 
    /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Stack], 
    typings.tabris.global.tabris.widgets.Stack
  ]
  ...
  def append(widgets: Widget[Any]*): typings.tabris.global.tabris.widgets.Stack
  
  def appendTo(parent: Composite[Widget[Any]]): typings.tabris.global.tabris.widgets.Stack
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], typings.tabris.global.tabris.widgets.Stack]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget[Any], typings.tabris.global.tabris.widgets.Stack]
  
  @JSName("apply")
  def apply[Target](options: `27`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.Stack]): typings.tabris.global.tabris.widgets.Stack
  @JSName("apply")
  ...
  def detach(): typings.tabris.global.tabris.widgets.Stack
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.Stack]
  ...
  def insertAfter(widget: Widget[Any]): typings.tabris.global.tabris.widgets.Stack
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.Stack]
  
  def insertBefore(widget: Widget[Any]): typings.tabris.global.tabris.widgets.Stack
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.Stack]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.Stack, Widget[Any]]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.Stack
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Stack
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Stack]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, id]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Stack
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.Stack
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.Stack]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.Stack]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.Stack]
...
object OmitStacksetAbsoluteBounds {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `27`[typings.tabris.global.tabris.widgets.Stack], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Stack]) => typings.tabris.global.tabris.widgets.Stack,
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Widget[Any] => typings.tabris.global.tabris.widgets.Stack,
    appendTo: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.Stack,
    apply: (/* options */ `27`[typings.tabris.global.tabris.widgets.Stack], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Stack]) => typings.tabris.global.tabris.widgets.Stack,
    ...
    cornerRadius: Double,
    data: Any,
    detach: () => typings.tabris.global.tabris.widgets.Stack,
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Stack,
    insertBefore: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Stack,
    isDisposed: () => Boolean,
    jsxAttributes: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.Stack, Widget[Any]],
    layout: StackLayout,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Stack,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Stack,
    onAddChild: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.Stack]],
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Stack]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, id],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Stack]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]],
    onRemoveChild: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Stack]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Stack]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, right],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Stack]],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Stack,
    opacity: Double,
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.widgets.Stack,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Stack],
    visible: Boolean,
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitStacksetAbsoluteBounds] (val x: Self) extends AnyVal {
    ...
    inline def setAppend(value: /* repeated */ Widget[Any] => typings.tabris.global.tabris.widgets.Stack): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.Stack): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `27`[typings.tabris.global.tabris.widgets.Stack], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Stack]) => typings.tabris.global.tabris.widgets.Stack
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.Stack): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Stack): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Stack): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.Stack, Widget[Any]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Stack
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Stack
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAddChild(value: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Stack]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Stack, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.Stack): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Stack]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
