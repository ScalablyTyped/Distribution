...
trait OmitStacksetAbsoluteBounds extends StObject {
  ...
  def _apply[Target](options: `27`[Target]): typings.tabris.global.tabris.widgets.Stack
  def _apply[Target](
    options: `27`[Target],
    rules: js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.Stack, 
      StringDictionary[js.Object]
    ]
  ): typings.tabris.global.tabris.widgets.Stack
  def _apply[Target](options: `27`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.widgets.Stack
  @JSName("_apply")
  ...
  def append(widgets: Widget*): typings.tabris.global.tabris.widgets.Stack
  
  def appendTo(parent: Composite[Widget]): typings.tabris.global.tabris.widgets.Stack
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], typings.tabris.global.tabris.widgets.Stack]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, typings.tabris.global.tabris.widgets.Stack]
  
  @JSName("apply")
  def apply[Target](options: `27`[Target]): typings.tabris.global.tabris.widgets.Stack
  @JSName("apply")
  def apply[Target](
    options: `27`[Target],
    rules: js.Function1[
  ...
  @JSName("apply")
  def apply[Target](options: `27`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.widgets.Stack
  @JSName("apply")
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Stack, Omit[Stack, set]]], js.Any]
  ...
  def insertAfter(widget: Widget): typings.tabris.global.tabris.widgets.Stack
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.Stack]
  
  def insertBefore(widget: Widget): typings.tabris.global.tabris.widgets.Stack
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.Stack]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.Stack
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.Stack
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitStacksetAbsoluteBounds {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `27`[typings.tabris.global.tabris.widgets.Stack], /* rules */ StringDictionary[js.Object] | (js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.Stack, 
      StringDictionary[js.Object]
    ]) | Null) => typings.tabris.global.tabris.widgets.Stack,
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Widget => typings.tabris.global.tabris.widgets.Stack,
    appendTo: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.Stack,
    apply: (/* options */ `27`[typings.tabris.global.tabris.widgets.Stack], /* rules */ StringDictionary[js.Object] | (js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.Stack, 
      StringDictionary[js.Object]
    ]) | Null) => typings.tabris.global.tabris.widgets.Stack,
    ...
    constructor: /* properties */ js.UndefOr[Properties[Stack, Omit[Stack, set]]] => js.Any,
    cornerRadius: Double,
    ...
    id: String,
    insertAfter: /* widget */ Widget => typings.tabris.global.tabris.widgets.Stack,
    insertBefore: /* widget */ Widget => typings.tabris.global.tabris.widgets.Stack,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[
      typings.tabris.global.tabris.widgets.Stack, 
      Omit[typings.tabris.global.tabris.widgets.Stack, set | jsxAttributes]
    ]) & `3`,
    layout: StackLayout,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Stack,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Stack,
    opacity: Double,
  ...
  extension [Self <: OmitStacksetAbsoluteBounds](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget => typings.tabris.global.tabris.widgets.Stack): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.Stack): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `27`[typings.tabris.global.tabris.widgets.Stack], /* rules */ StringDictionary[js.Object] | (js.Function1[
          /* widget */ typings.tabris.global.tabris.widgets.Stack, 
          StringDictionary[js.Object]
        ]) | Null) => typings.tabris.global.tabris.widgets.Stack
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[Stack, Omit[Stack, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.Stack): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.Stack): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Stack
