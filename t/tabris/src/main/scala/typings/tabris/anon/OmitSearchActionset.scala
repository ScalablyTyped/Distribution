...
object OmitSearchActionset {
  ...
  extension [Self <: OmitSearchActionset](x: Self) {
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[SearchAction, Omit[SearchAction, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => SearchAction): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ typings.tabris.mod.widgets.Action => SearchAction): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ typings.tabris.mod.widgets.Action => SearchAction): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[SearchAction, Omit[SearchAction, set | jsxAttributes]]) & `1`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setProposalsVarargs(value: String*): Self = StObject.set(x, "proposals", js.Array(value :_*))
