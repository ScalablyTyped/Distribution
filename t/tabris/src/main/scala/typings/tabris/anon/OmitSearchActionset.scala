...
trait OmitSearchActionset extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): SearchAction
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], SearchAction]
  ...
  def insertAfter(widget: Widget[Any]): SearchAction
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], SearchAction]
  
  def insertBefore(widget: Widget[Any]): SearchAction
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], SearchAction]
...
object OmitSearchActionset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => SearchAction,
  ...
  extension [Self <: OmitSearchActionset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => SearchAction): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => SearchAction): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => SearchAction): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
