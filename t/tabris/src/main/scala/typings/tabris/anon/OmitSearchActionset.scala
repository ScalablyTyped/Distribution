...
import typings.tabris.mod.widgets.SearchAction
...
trait OmitSearchActionset extends StObject {
  ...
  def insertAfter(widget: typings.tabris.mod.widgets.Action): SearchAction
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ typings.tabris.mod.widgets.Action, SearchAction]
  
  def insertBefore(widget: typings.tabris.mod.widgets.Action): SearchAction
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ typings.tabris.mod.widgets.Action, SearchAction]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: (JSXAttributes[SearchAction, Omit[SearchAction, set | typings.tabris.tabrisStrings.jsxAttributes]]) & `1`
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): SearchAction
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): SearchAction
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  var siblings_Original: js.Function1[
    /* selector */ js.UndefOr[Selector[Widget, typings.tabris.mod.widgets.Action | Page]], 
...
object OmitSearchActionset {
  ...
  def apply(
    ...
    constructor: /* properties */ js.UndefOr[Properties[SearchAction, Omit[SearchAction, set]]] => js.Any,
    cornerRadius: Double,
    ...
    id: String,
    insertAfter: /* widget */ typings.tabris.mod.widgets.Action => SearchAction,
    insertBefore: /* widget */ typings.tabris.mod.widgets.Action => SearchAction,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[SearchAction, Omit[SearchAction, set | jsxAttributes]]) & `1`,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => SearchAction,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => SearchAction,
    opacity: Double,
    open: () => Unit,
    ...
    siblings: /* selector */ js.UndefOr[Selector[Widget, typings.tabris.mod.widgets.Action | Page]] => WidgetCollection[typings.tabris.mod.widgets.Action | Page],
    text: String,
    title: String,
    top: ConstraintValue,
  ...
  implicit class OmitSearchActionsetMutableBuilder[Self <: OmitSearchActionset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppendTo(value: /* parent */ NavigationView[Page, Action] => SearchAction): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setConstructor(value: /* properties */ js.UndefOr[Properties[SearchAction, Omit[SearchAction, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setDetach(value: () => SearchAction): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setInsertAfter(value: /* widget */ typings.tabris.mod.widgets.Action => SearchAction): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    @scala.inline
    def setInsertBefore(value: /* widget */ typings.tabris.mod.widgets.Action => SearchAction): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    @scala.inline
    def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    @scala.inline
    def setJsxAttributes(value: (JSXAttributes[SearchAction, Omit[SearchAction, set | jsxAttributes]]) & `1`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => SearchAction
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    @scala.inline
    def setOnAccept(value: Listeners[SearchActionAcceptEvent[SearchAction]]): Self = StObject.set(x, "onAccept", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBackgroundChanged(value: ChangeListeners[SearchAction, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBaselineChanged(value: ChangeListeners[SearchAction, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBottomChanged(value: ChangeListeners[SearchAction, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBoundsChanged(value: ChangeListeners[SearchAction, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterXChanged(value: ChangeListeners[SearchAction, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterYChanged(value: ChangeListeners[SearchAction, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassChanged(value: ChangeListeners[SearchAction, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassListChanged(value: ChangeListeners[SearchAction, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCornerRadiusChanged(value: ChangeListeners[SearchAction, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDataChanged(value: ChangeListeners[SearchAction, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDispose(value: Listeners[EventObject[SearchAction]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnElevationChanged(value: ChangeListeners[SearchAction, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnEnabledChanged(value: ChangeListeners[SearchAction, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnExcludeFromLayoutChanged(value: ChangeListeners[SearchAction, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHeightChanged(value: ChangeListeners[SearchAction, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHighlightOnTouchChanged(value: ChangeListeners[SearchAction, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnIdChanged(value: ChangeListeners[SearchAction, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnImageChanged(value: ChangeListeners[SearchAction, image]): Self = StObject.set(x, "onImageChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnInput(value: Listeners[SearchActionInputEvent[SearchAction]]): Self = StObject.set(x, "onInput", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLayoutDataChanged(value: ChangeListeners[SearchAction, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLeftChanged(value: ChangeListeners[SearchAction, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLongPress(value: Listeners[WidgetLongPressEvent[SearchAction]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnMessageChanged(value: ChangeListeners[SearchAction, message]): Self = StObject.set(x, "onMessageChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnOpacityChanged(value: ChangeListeners[SearchAction, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPan(value: Listeners[WidgetPanEvent[SearchAction]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanDown(value: Listeners[WidgetPanEvent[SearchAction]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanHorizontal(value: Listeners[WidgetPanEvent[SearchAction]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanLeft(value: Listeners[WidgetPanEvent[SearchAction]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanRight(value: Listeners[WidgetPanEvent[SearchAction]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanUp(value: Listeners[WidgetPanEvent[SearchAction]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanVertical(value: Listeners[WidgetPanEvent[SearchAction]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPlacementChanged(value: ChangeListeners[SearchAction, placement]): Self = StObject.set(x, "onPlacementChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnProposalsChanged(value: ChangeListeners[SearchAction, proposals]): Self = StObject.set(x, "onProposalsChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnResize(value: Listeners[WidgetResizeEvent[SearchAction]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRightChanged(value: ChangeListeners[SearchAction, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSelect(value: Listeners[EventObject[SearchAction]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[SearchAction]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[SearchAction]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[SearchAction]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[SearchAction]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTap(value: Listeners[WidgetTapEvent[SearchAction]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTextChanged(value: ChangeListeners[SearchAction, text]): Self = StObject.set(x, "onTextChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTitleChanged(value: ChangeListeners[SearchAction, title]): Self = StObject.set(x, "onTitleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTopChanged(value: ChangeListeners[SearchAction, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchCancel(value: Listeners[WidgetTouchEvent[SearchAction]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchEnd(value: Listeners[WidgetTouchEvent[SearchAction]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchMove(value: Listeners[WidgetTouchEvent[SearchAction]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchStart(value: Listeners[WidgetTouchEvent[SearchAction]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTransformChanged(value: ChangeListeners[SearchAction, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnVisibleChanged(value: ChangeListeners[SearchAction, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnWidthChanged(value: ChangeListeners[SearchAction, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParent(value: () => NavigationView[Page, Action]): Self = StObject.set(x, "parent", js.Any.fromFunction0(value))
    
    @scala.inline
    def setPlacement(value: default | navigation | overflow): Self = StObject.set(x, "placement", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProposals(value: js.Array[String]): Self = StObject.set(x, "proposals", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProposalsVarargs(value: String*): Self = StObject.set(x, "proposals", js.Array(value :_*))
    ...
    @scala.inline
    def setSiblings(
      value: /* selector */ js.UndefOr[Selector[Widget, typings.tabris.mod.widgets.Action | Page]] => WidgetCollection[typings.tabris.mod.widgets.Action | Page]
    ...
    @scala.inline
    def setTrigger(value: /* type */ String => SearchAction): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTriggerAsync(value: /* type */ String => js.Promise[SearchAction]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
