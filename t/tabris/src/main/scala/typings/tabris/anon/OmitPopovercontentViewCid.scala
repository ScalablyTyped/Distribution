...
trait OmitPopovercontentViewCid extends StObject {
...
object OmitPopovercontentViewCid {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OmitPopovercontentViewCid]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPopovercontentViewCid] (val x: Self) extends AnyVal {
