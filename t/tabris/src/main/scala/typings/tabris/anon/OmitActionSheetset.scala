...
trait OmitActionSheetset extends StObject {
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): ActionSheet
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): ActionSheet
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
...
object OmitActionSheetset {
  ...
  inline def apply(
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => ActionSheet,
    open: () => ActionSheet,
    title: String,
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitActionSheetset] (val x: Self) extends AnyVal {
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => ActionSheet
