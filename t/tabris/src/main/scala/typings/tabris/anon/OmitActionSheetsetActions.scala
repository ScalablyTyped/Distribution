...
trait OmitActionSheetsetActions extends StObject {
  ...
  def close(): typings.tabris.global.tabris.ActionSheet
  @JSName("close")
  var close_Original: js.Function0[typings.tabris.global.tabris.ActionSheet]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.ActionSheet
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.ActionSheet
  def on(
    `type`: String,
  ...
  var onActionsChanged: ChangeListeners[typings.tabris.global.tabris.ActionSheet, actions]
  
  var onClose: Listeners[ActionSheetCloseEvent[typings.tabris.global.tabris.ActionSheet]]
  
  var onMessageChanged: ChangeListeners[typings.tabris.global.tabris.ActionSheet, message]
  
  var onSelect: Listeners[ActionSheetSelectEvent[typings.tabris.global.tabris.ActionSheet]]
  
  var onTitleChanged: ChangeListeners[typings.tabris.global.tabris.ActionSheet, title]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.ActionSheet
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def open(): typings.tabris.global.tabris.ActionSheet
  @JSName("open")
  var open_Original: js.Function0[typings.tabris.global.tabris.ActionSheet]
  
  var title: String
  
  def trigger(`type`: String): typings.tabris.global.tabris.ActionSheet
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.ActionSheet]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.ActionSheet]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.ActionSheet]
}
object OmitActionSheetsetActions {
  ...
  inline def apply(
    ...
    cid: String,
    close: () => typings.tabris.global.tabris.ActionSheet,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.ActionSheet,
    onActionsChanged: ChangeListeners[typings.tabris.global.tabris.ActionSheet, actions],
    onClose: Listeners[ActionSheetCloseEvent[typings.tabris.global.tabris.ActionSheet]],
    onMessageChanged: ChangeListeners[typings.tabris.global.tabris.ActionSheet, message],
    onSelect: Listeners[ActionSheetSelectEvent[typings.tabris.global.tabris.ActionSheet]],
    onTitleChanged: ChangeListeners[typings.tabris.global.tabris.ActionSheet, title],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.ActionSheet,
    open: () => typings.tabris.global.tabris.ActionSheet,
    title: String,
    trigger: /* type */ String => typings.tabris.global.tabris.ActionSheet,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.ActionSheet]
  ...
  extension [Self <: OmitActionSheetsetActions](x: Self) {
    ...
    inline def setClose(value: () => typings.tabris.global.tabris.ActionSheet): Self = StObject.set(x, "close", js.Any.fromFunction0(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.ActionSheet
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.ActionSheet
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnActionsChanged(value: ChangeListeners[typings.tabris.global.tabris.ActionSheet, actions]): Self = StObject.set(x, "onActionsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClose(value: Listeners[ActionSheetCloseEvent[typings.tabris.global.tabris.ActionSheet]]): Self = StObject.set(x, "onClose", value.asInstanceOf[js.Any])
    
    inline def setOnMessageChanged(value: ChangeListeners[typings.tabris.global.tabris.ActionSheet, message]): Self = StObject.set(x, "onMessageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[ActionSheetSelectEvent[typings.tabris.global.tabris.ActionSheet]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnTitleChanged(value: ChangeListeners[typings.tabris.global.tabris.ActionSheet, title]): Self = StObject.set(x, "onTitleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnce(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.ActionSheet
    ): Self = StObject.set(x, "once", js.Any.fromFunction3(value))
    
    inline def setOpen(value: () => typings.tabris.global.tabris.ActionSheet): Self = StObject.set(x, "open", js.Any.fromFunction0(value))
    
    inline def setTitle(value: String): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
    
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.ActionSheet): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.ActionSheet]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
