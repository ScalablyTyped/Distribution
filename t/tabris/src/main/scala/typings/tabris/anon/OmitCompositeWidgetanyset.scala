...
trait OmitCompositeWidgetanyset[ChildType /* <: AnyWidget */] extends StObject {
  ...
  def appendTo(parent: typings.tabris.mod.Composite[Widget[Any]]): Composite[ChildType]
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ typings.tabris.mod.Composite[Widget[Any]], Composite[ChildType]]
