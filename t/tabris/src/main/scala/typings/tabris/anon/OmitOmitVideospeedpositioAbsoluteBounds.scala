...
trait OmitOmitVideospeedpositioAbsoluteBounds extends StObject {
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[
      Properties[
        ...
        Omit[OmitVideospeedpositiondurAbsoluteBounds, set]
      ]
    ], 
    js.Any
  ]
...
object OmitOmitVideospeedpositioAbsoluteBounds {
  ...
  def apply(
  ...
  ): OmitOmitVideospeedpositioAbsoluteBounds = {
    ...
    __obj.asInstanceOf[OmitOmitVideospeedpositioAbsoluteBounds]
  }
  
  @scala.inline
  implicit class OmitOmitVideospeedpositioAbsoluteBoundsMutableBuilder[Self <: OmitOmitVideospeedpositioAbsoluteBounds] (val x: Self) extends AnyVal {
