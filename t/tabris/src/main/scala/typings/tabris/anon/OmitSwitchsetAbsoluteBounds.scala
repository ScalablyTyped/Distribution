...
trait OmitSwitchsetAbsoluteBounds extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): typings.tabris.global.tabris.widgets.Switch
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], typings.tabris.global.tabris.widgets.Switch]
  ...
  def detach(): typings.tabris.global.tabris.widgets.Switch
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.Switch]
  ...
  def insertAfter(widget: Widget[Any]): typings.tabris.global.tabris.widgets.Switch
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.Switch]
  
  def insertBefore(widget: Widget[Any]): typings.tabris.global.tabris.widgets.Switch
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.Switch]
  ...
  var jsxAttributes: (JSXAttributes[
    typings.tabris.global.tabris.widgets.Switch, 
    Omit[
      typings.tabris.global.tabris.widgets.Switch, 
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.Switch
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Switch
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, centerY]
  
  var onCheckedChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, checked]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Switch]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, id]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, right]
  
  var onSelect: Listeners[SwitchSelectEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onThumbOffColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, thumbOffColor]
  
  var onThumbOnColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, thumbOnColor]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]]
  
  var onTrackOffColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, trackOffColor]
  
  var onTrackOnColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, trackOnColor]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Switch
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.Switch
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.Switch]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.Switch]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.Switch]
  
  var visible: Boolean
  
  var width: Dimension | auto
}
object OmitSwitchsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.Switch,
    ...
    cornerRadius: Double,
    data: Any,
    detach: () => typings.tabris.global.tabris.widgets.Switch,
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Switch,
    insertBefore: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Switch,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[
      typings.tabris.global.tabris.widgets.Switch, 
      Omit[typings.tabris.global.tabris.widgets.Switch, set | jsxAttributes]
    ]) & Children,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Switch,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Switch,
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, centerY],
    onCheckedChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, checked],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Switch]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, id],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Switch]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Switch]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, right],
    onSelect: Listeners[SwitchSelectEvent[typings.tabris.global.tabris.widgets.Switch]],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Switch]],
    onThumbOffColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, thumbOffColor],
    onThumbOnColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, thumbOnColor],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]],
    onTrackOffColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, trackOffColor],
    onTrackOnColorChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, trackOnColor],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Switch,
    opacity: Double,
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.widgets.Switch,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Switch],
    visible: Boolean,
    width: Dimension | auto
  ): OmitSwitchsetAbsoluteBounds = {
  ...
  extension [Self <: OmitSwitchsetAbsoluteBounds](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => typings.tabris.global.tabris.widgets.Switch): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.Switch): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Switch): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Switch): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Switch
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Switch
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCheckedChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, checked]): Self = StObject.set(x, "onCheckedChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[SwitchSelectEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnThumbOffColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, thumbOffColor]): Self = StObject.set(x, "onThumbOffColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnThumbOnColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, thumbOnColor]): Self = StObject.set(x, "onThumbOnColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Switch]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTrackOffColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, trackOffColor]): Self = StObject.set(x, "onTrackOffColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTrackOnColorChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, trackOnColor]): Self = StObject.set(x, "onTrackOnColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Switch, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.Switch): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Switch]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
