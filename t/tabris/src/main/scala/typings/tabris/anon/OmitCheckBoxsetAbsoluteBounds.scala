...
trait OmitCheckBoxsetAbsoluteBounds extends StObject {
  ...
  def appendTo(parent: Composite[Widget]): typings.tabris.global.tabris.widgets.CheckBox
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], typings.tabris.global.tabris.widgets.CheckBox]
  ...
  def insertAfter(widget: Widget): typings.tabris.global.tabris.widgets.CheckBox
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.CheckBox]
  
  def insertBefore(widget: Widget): typings.tabris.global.tabris.widgets.CheckBox
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.CheckBox]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.CheckBox
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.CheckBox
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitCheckBoxsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.CheckBox,
    ...
    id: String,
    insertAfter: /* widget */ Widget => typings.tabris.global.tabris.widgets.CheckBox,
    insertBefore: /* widget */ Widget => typings.tabris.global.tabris.widgets.CheckBox,
    isDisposed: () => Boolean,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.CheckBox,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.CheckBox,
    opacity: Double,
  ...
  extension [Self <: OmitCheckBoxsetAbsoluteBounds](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.CheckBox): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.CheckBox): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.CheckBox): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.CheckBox
