...
object OmitWebViewcanGoBackcanGo {
  ...
  def apply(
    ...
    constructor: /* properties */ js.UndefOr[Properties[Omit[WebView, canGoBack | canGoForward], OmitOmitWebViewcanGoBackc]] => js.Any,
    cornerRadius: Double,
  ...
  @scala.inline
  implicit class OmitWebViewcanGoBackcanGoMutableBuilder[Self <: OmitWebViewcanGoBackcanGo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConstructor(
      value: /* properties */ js.UndefOr[Properties[Omit[WebView, canGoBack | canGoForward], OmitOmitWebViewcanGoBackc]] => js.Any
    ...
    @scala.inline
    def setSet(value: /* properties */ Properties[WebView, Omit[WebView, set]] => WebView): Self = StObject.set(x, "set", js.Any.fromFunction1(value))
