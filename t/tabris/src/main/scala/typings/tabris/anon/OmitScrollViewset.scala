...
trait OmitScrollViewset extends StObject {
  ...
  def _apply[Target](options: `8`[Target], rules: RuleSet[ScrollView]): ScrollView
  @JSName("_apply")
  var _apply_Original: js.Function2[/* options */ `8`[ScrollView], /* rules */ RuleSet[ScrollView], ScrollView]
  ...
  @JSName("apply")
  def apply[Target](options: `8`[Target], rules: RuleSet[ScrollView]): ScrollView
  @JSName("apply")
  var apply_Original: js.Function2[/* options */ `8`[ScrollView], /* rules */ RuleSet[ScrollView], ScrollView]
  ...
  def scrollToX(offset: Double, options: `7`): ScrollView
  @JSName("scrollToX")
  var scrollToX_Original: js.Function2[/* offset */ Double, /* options */ js.UndefOr[`7`], ScrollView]
  
  def scrollToY(offset: Double): ScrollView
  def scrollToY(offset: Double, options: `7`): ScrollView
  @JSName("scrollToY")
  var scrollToY_Original: js.Function2[/* offset */ Double, /* options */ js.UndefOr[`7`], ScrollView]
...
object OmitScrollViewset {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `8`[ScrollView], /* rules */ RuleSet[ScrollView]) => ScrollView,
    _checkDisposed: () => Unit,
    ...
    apply: (/* options */ `8`[ScrollView], /* rules */ RuleSet[ScrollView]) => ScrollView,
    ...
    scrollToX: (/* offset */ Double, /* options */ js.UndefOr[`7`]) => ScrollView,
    scrollToY: (/* offset */ Double, /* options */ js.UndefOr[`7`]) => ScrollView,
  ...
  extension [Self <: OmitScrollViewset](x: Self) {
    ...
    inline def setApply(value: (/* options */ `8`[ScrollView], /* rules */ RuleSet[ScrollView]) => ScrollView): Self = StObject.set(x, "apply", js.Any.fromFunction2(value))
    ...
    inline def setDetach(value: () => ScrollView): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setScrollToX(value: (/* offset */ Double, /* options */ js.UndefOr[`7`]) => ScrollView): Self = StObject.set(x, "scrollToX", js.Any.fromFunction2(value))
    
    inline def setScrollToY(value: (/* offset */ Double, /* options */ js.UndefOr[`7`]) => ScrollView): Self = StObject.set(x, "scrollToY", js.Any.fromFunction2(value))
    ...
    inline def set_apply(value: (/* options */ `8`[ScrollView], /* rules */ RuleSet[ScrollView]) => ScrollView): Self = StObject.set(x, "_apply", js.Any.fromFunction2(value))
