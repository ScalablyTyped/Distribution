...
object OmitScrollViewset {
  ...
  extension [Self <: OmitScrollViewset](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget => ScrollView): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ Composite[Widget] => ScrollView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => ScrollView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => ScrollView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[ScrollView, Omit[ScrollView, set | jsxAttributes]]) & `3`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setScrollToX(value: (/* offset */ Double, /* options */ js.UndefOr[Animate]) => ScrollView): Self = StObject.set(x, "scrollToX", js.Any.fromFunction2(value))
    
    inline def setScrollToY(value: (/* offset */ Double, /* options */ js.UndefOr[Animate]) => ScrollView): Self = StObject.set(x, "scrollToY", js.Any.fromFunction2(value))
