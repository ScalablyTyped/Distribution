...
import typings.tabris.mod.widgets.CameraView
...
trait OmitCameraViewsetAbsoluteBounds extends StObject {
  ...
  def appendTo(parent: Composite[Widget]): typings.tabris.global.tabris.widgets.CameraView
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], typings.tabris.global.tabris.widgets.CameraView]
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[CameraView, Omit[CameraView, set]]], js.Any]
  ...
  def detach(): typings.tabris.global.tabris.widgets.CameraView
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.CameraView]
  ...
  def insertAfter(widget: Widget): typings.tabris.global.tabris.widgets.CameraView
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.CameraView]
  
  def insertBefore(widget: Widget): typings.tabris.global.tabris.widgets.CameraView
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.CameraView]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.CameraView
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.CameraView
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, bounds]
  
  var onCameraChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, camera]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, id]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, right]
  
  var onScaleModeChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, scaleMode]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.CameraView
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.CameraView
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.CameraView]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.CameraView]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.CameraView]
...
object OmitCameraViewsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.CameraView,
    ...
    constructor: /* properties */ js.UndefOr[Properties[CameraView, Omit[CameraView, set]]] => js.Any,
    cornerRadius: Double,
    data: StringDictionary[js.Any],
    detach: () => typings.tabris.global.tabris.widgets.CameraView,
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget => typings.tabris.global.tabris.widgets.CameraView,
    insertBefore: /* widget */ Widget => typings.tabris.global.tabris.widgets.CameraView,
    isDisposed: () => Boolean,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.CameraView,
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, bounds],
    onCameraChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, camera],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.CameraView]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, id],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, right],
    onScaleModeChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, scaleMode],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.CameraView,
    opacity: Double,
  ...
  extension [Self <: OmitCameraViewsetAbsoluteBounds](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.CameraView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[CameraView, Omit[CameraView, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.CameraView): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.CameraView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.CameraView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.CameraView
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.CameraView
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCameraChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, camera]): Self = StObject.set(x, "onCameraChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnScaleModeChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, scaleMode]): Self = StObject.set(x, "onScaleModeChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.CameraView]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.CameraView, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.CameraView): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.CameraView]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
