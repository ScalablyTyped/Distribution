...
trait OmitPopovercontentViewAnchor extends StObject {
...
object OmitPopovercontentViewAnchor {
  ...
  inline def apply(
    ...
    cid: String,
    close: () => Popover,
    constructor: /* properties */ js.UndefOr[Properties[Omit[Popover, contentView], Omit[Omit[Popover, contentView], set]]] => Any,
    height: Dimension,
  ...
  implicit open class MutableBuilder[Self <: OmitPopovercontentViewAnchor] (val x: Self) extends AnyVal {
    ...
    inline def setClose(value: () => Popover): Self = StObject.set(x, "close", js.Any.fromFunction0(value))
    
    inline def setConstructor(
      value: /* properties */ js.UndefOr[Properties[Omit[Popover, contentView], Omit[Omit[Popover, contentView], set]]] => Any
    ...
    inline def setOpen(value: () => Popover): Self = StObject.set(x, "open", js.Any.fromFunction0(value))
