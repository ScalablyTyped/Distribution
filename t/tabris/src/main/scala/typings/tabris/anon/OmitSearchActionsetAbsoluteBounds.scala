...
trait OmitSearchActionsetAbsoluteBounds extends StObject {
  ...
  def detach(): typings.tabris.global.tabris.widgets.SearchAction
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.SearchAction]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.SearchAction
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.SearchAction
  def on(
    `type`: String,
  ...
  var onAccept: Listeners[SearchActionAcceptEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, id]
  
  var onImageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, image]
  
  var onInput: Listeners[SearchActionInputEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onMessageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, message]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onPlacementChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, placement]
  
  var onProposalsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, proposals]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, right]
  
  var onSelect: Listeners[EventObject[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onTextChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, text]
  
  var onTitleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, title]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.SearchAction
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.SearchAction
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.SearchAction]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.SearchAction]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.SearchAction]
...
object OmitSearchActionsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    detach: () => typings.tabris.global.tabris.widgets.SearchAction,
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    message: String,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.SearchAction,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.SearchAction,
    onAccept: Listeners[SearchActionAcceptEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.SearchAction]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, id],
    onImageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, image],
    onInput: Listeners[SearchActionInputEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onMessageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, message],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onPlacementChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, placement],
    onProposalsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, proposals],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, right],
    onSelect: Listeners[EventObject[typings.tabris.global.tabris.widgets.SearchAction]],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onTextChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, text],
    onTitleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, title],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.SearchAction,
    opacity: Double,
    open: () => Unit,
    parent: () => NavigationView[Page, Action],
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.widgets.SearchAction,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.SearchAction],
    visible: Boolean,
  ...
  extension [Self <: OmitSearchActionsetAbsoluteBounds](x: Self) {
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.SearchAction): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.SearchAction
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.SearchAction
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAccept(value: Listeners[SearchActionAcceptEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onAccept", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnImageChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, image]): Self = StObject.set(x, "onImageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnInput(value: Listeners[SearchActionInputEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onInput", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnMessageChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, message]): Self = StObject.set(x, "onMessageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnPlacementChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, placement]): Self = StObject.set(x, "onPlacementChanged", value.asInstanceOf[js.Any])
    
    inline def setOnProposalsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, proposals]): Self = StObject.set(x, "onProposalsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTextChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, text]): Self = StObject.set(x, "onTextChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTitleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, title]): Self = StObject.set(x, "onTitleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.SearchAction]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.SearchAction, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.SearchAction): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.SearchAction]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
