...
trait OmitImageViewsetAbsoluteBounds extends StObject {
  ...
  def appendTo(parent: Composite[Widget]): typings.tabris.global.tabris.widgets.ImageView
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], typings.tabris.global.tabris.widgets.ImageView]
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[ImageView, Omit[ImageView, set]]], js.Any]
  ...
  def insertAfter(widget: Widget): typings.tabris.global.tabris.widgets.ImageView
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.ImageView]
  
  def insertBefore(widget: Widget): typings.tabris.global.tabris.widgets.ImageView
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.ImageView]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.ImageView
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.ImageView
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitImageViewsetAbsoluteBounds {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.ImageView,
    ...
    constructor: /* properties */ js.UndefOr[Properties[ImageView, Omit[ImageView, set]]] => js.Any,
    cornerRadius: Double,
    ...
    id: String,
    insertAfter: /* widget */ Widget => typings.tabris.global.tabris.widgets.ImageView,
    insertBefore: /* widget */ Widget => typings.tabris.global.tabris.widgets.ImageView,
    isDisposed: () => Boolean,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.ImageView,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.ImageView,
    opacity: Double,
  ...
  extension [Self <: OmitImageViewsetAbsoluteBounds](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.ImageView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[ImageView, Omit[ImageView, set]]] => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.ImageView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.ImageView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.ImageView
