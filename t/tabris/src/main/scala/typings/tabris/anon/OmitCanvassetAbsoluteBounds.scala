...
trait OmitCanvassetAbsoluteBounds extends StObject {
  ...
  def _apply[Target](options: `19`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.Canvas]): typings.tabris.global.tabris.widgets.Canvas
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `19`[typings.tabris.global.tabris.widgets.Canvas], 
  ...
  def append(widgets: Widget[Any]*): typings.tabris.global.tabris.widgets.Canvas
  
  def appendTo(parent: Composite[Widget[Any]]): typings.tabris.global.tabris.widgets.Canvas
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], typings.tabris.global.tabris.widgets.Canvas]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget[Any], typings.tabris.global.tabris.widgets.Canvas]
  
  @JSName("apply")
  def apply[Target](options: `19`[Target], rules: RuleSet[typings.tabris.global.tabris.widgets.Canvas]): typings.tabris.global.tabris.widgets.Canvas
  @JSName("apply")
  ...
  def insertAfter(widget: Widget[Any]): typings.tabris.global.tabris.widgets.Canvas
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.Canvas]
  
  def insertBefore(widget: Widget[Any]): typings.tabris.global.tabris.widgets.Canvas
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typings.tabris.global.tabris.widgets.Canvas]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.Canvas, Widget[Any]]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Canvas
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.widgets.Canvas
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
...
object OmitCanvassetAbsoluteBounds {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `19`[typings.tabris.global.tabris.widgets.Canvas], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Canvas]) => typings.tabris.global.tabris.widgets.Canvas,
    _checkDisposed: () => Unit,
    ...
    apply: (/* options */ `19`[typings.tabris.global.tabris.widgets.Canvas], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Canvas]) => typings.tabris.global.tabris.widgets.Canvas,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Canvas,
    insertBefore: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Canvas,
    isDisposed: () => Boolean,
    jsxAttributes: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.Canvas, Widget[Any]],
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Canvas,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Canvas,
    opacity: Double,
  ...
  extension [Self <: OmitCanvassetAbsoluteBounds](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget[Any] => typings.tabris.global.tabris.widgets.Canvas): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    ...
    inline def setApply(
      value: (/* options */ `19`[typings.tabris.global.tabris.widgets.Canvas], /* rules */ RuleSet[typings.tabris.global.tabris.widgets.Canvas]) => typings.tabris.global.tabris.widgets.Canvas
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Canvas): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typings.tabris.global.tabris.widgets.Canvas): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: JSXCompositeAttributes[typings.tabris.global.tabris.widgets.Canvas, Widget[Any]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Canvas
