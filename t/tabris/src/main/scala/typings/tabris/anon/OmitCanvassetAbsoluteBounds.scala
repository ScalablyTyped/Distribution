...
trait OmitCanvassetAbsoluteBounds extends StObject {
  ...
  def _apply[Target](options: `20`[Target]): typings.tabris.global.tabris.widgets.Canvas
  def _apply[Target](
    options: `20`[Target],
    rules: js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.Canvas, 
      StringDictionary[js.Object]
    ]
  ): typings.tabris.global.tabris.widgets.Canvas
  def _apply[Target](options: `20`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.widgets.Canvas
  @JSName("_apply")
  ...
  def append(widgets: Widget*): typings.tabris.global.tabris.widgets.Canvas
  
  def appendTo(parent: Composite[Widget]): typings.tabris.global.tabris.widgets.Canvas
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], typings.tabris.global.tabris.widgets.Canvas]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, typings.tabris.global.tabris.widgets.Canvas]
  
  @JSName("apply")
  def apply[Target](options: `20`[Target]): typings.tabris.global.tabris.widgets.Canvas
  @JSName("apply")
  def apply[Target](
    options: `20`[Target],
    rules: js.Function1[
  ...
  @JSName("apply")
  def apply[Target](options: `20`[Target], rules: StringDictionary[js.Object]): typings.tabris.global.tabris.widgets.Canvas
  @JSName("apply")
  ...
  def detach(): typings.tabris.global.tabris.widgets.Canvas
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.Canvas]
  ...
  def insertAfter(widget: Widget): typings.tabris.global.tabris.widgets.Canvas
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.Canvas]
  
  def insertBefore(widget: Widget): typings.tabris.global.tabris.widgets.Canvas
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, typings.tabris.global.tabris.widgets.Canvas]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.Canvas
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.Canvas
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, data]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, id]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): typings.tabris.global.tabris.widgets.Canvas
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.Canvas
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.Canvas]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.Canvas]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.Canvas]
...
object OmitCanvassetAbsoluteBounds {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `20`[typings.tabris.global.tabris.widgets.Canvas], /* rules */ StringDictionary[js.Object] | (js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.Canvas, 
      StringDictionary[js.Object]
    ]) | Null) => typings.tabris.global.tabris.widgets.Canvas,
    _checkDisposed: () => Unit,
    ...
    append: /* repeated */ Widget => typings.tabris.global.tabris.widgets.Canvas,
    appendTo: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.Canvas,
    apply: (/* options */ `20`[typings.tabris.global.tabris.widgets.Canvas], /* rules */ StringDictionary[js.Object] | (js.Function1[
      /* widget */ typings.tabris.global.tabris.widgets.Canvas, 
      StringDictionary[js.Object]
    ]) | Null) => typings.tabris.global.tabris.widgets.Canvas,
    ...
    detach: () => typings.tabris.global.tabris.widgets.Canvas,
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget => typings.tabris.global.tabris.widgets.Canvas,
    insertBefore: /* widget */ Widget => typings.tabris.global.tabris.widgets.Canvas,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[
      typings.tabris.global.tabris.widgets.Canvas, 
      Omit[typings.tabris.global.tabris.widgets.Canvas, set | jsxAttributes]
    ]) & `3`,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Canvas,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Canvas,
    onAddChild: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, data],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Canvas]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, id],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onRemoveChild: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, right],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]],
    onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, transform],
    onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, visible],
    onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Canvas,
    opacity: Double,
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.widgets.Canvas,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Canvas],
    visible: Boolean,
  ...
  extension [Self <: OmitCanvassetAbsoluteBounds](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget => typings.tabris.global.tabris.widgets.Canvas): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ Composite[Widget] => typings.tabris.global.tabris.widgets.Canvas): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `20`[typings.tabris.global.tabris.widgets.Canvas], /* rules */ StringDictionary[js.Object] | (js.Function1[
          /* widget */ typings.tabris.global.tabris.widgets.Canvas, 
          StringDictionary[js.Object]
        ]) | Null) => typings.tabris.global.tabris.widgets.Canvas
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.Canvas): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.Canvas): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => typings.tabris.global.tabris.widgets.Canvas): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Canvas
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Canvas
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAddChild(value: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Canvas]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Canvas, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.Canvas): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Canvas]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
