...
object OmitCompositeWidgetset {
  ...
  extension [Self <: OmitCompositeWidgetset[?], ChildType /* <: Widget */](x: Self & OmitCompositeWidgetset[ChildType]) {
    ...
    inline def setAppend(value: /* repeated */ Widget => Composite[ChildType]): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ typings.tabris.mod.Composite[Widget] => Composite[ChildType]): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => Composite[ChildType]): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => Composite[ChildType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => Composite[ChildType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setParent(value: () => typings.tabris.mod.Composite[Widget]): Self = StObject.set(x, "parent", js.Any.fromFunction0(value))
    ...
    inline def set_setParent(value: (/* parent */ typings.tabris.mod.Composite[Widget], /* index */ js.UndefOr[Double]) => Unit): Self = StObject.set(x, "_setParent", js.Any.fromFunction2(value))
