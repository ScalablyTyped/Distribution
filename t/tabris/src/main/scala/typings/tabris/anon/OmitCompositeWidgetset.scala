...
/* Inlined tabris.tabris.Omit<tabris.tabris.widgets.Composite<tabris.tabris.Widget>, 'set'> */
trait OmitCompositeWidgetset[ChildType /* <: Widget */] extends StObject {
  ...
  def _apply[Target](options: Trigger[Target]): Composite[ChildType]
  def _apply[Target](
    options: Trigger[Target],
    rules: js.Function1[/* widget */ Composite[ChildType], StringDictionary[js.Object]]
  ): Composite[ChildType]
  def _apply[Target](options: Trigger[Target], rules: StringDictionary[js.Object]): Composite[ChildType]
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ Trigger[Composite[ChildType]], 
    /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Composite[ChildType], StringDictionary[js.Object]]) | Null, 
    Composite[ChildType]
  ]
  ...
  def _setParent(parent: typings.tabris.mod.Composite[Widget]): Unit
  def _setParent(parent: typings.tabris.mod.Composite[Widget], index: Double): Unit
  @JSName("_setParent")
  var _setParent_Original: js.Function2[
    /* parent */ typings.tabris.mod.Composite[Widget], 
  ...
  def append(widgets: Widget*): Composite[ChildType]
  
  def appendTo(parent: typings.tabris.mod.Composite[Widget]): Composite[ChildType]
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ typings.tabris.mod.Composite[Widget], Composite[ChildType]]
  
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, Composite[ChildType]]
  
  @JSName("apply")
  def apply[Target](options: Trigger[Target]): Composite[ChildType]
  @JSName("apply")
  def apply[Target](
    options: Trigger[Target],
    rules: js.Function1[/* widget */ Composite[ChildType], StringDictionary[js.Object]]
  ...
  @JSName("apply")
  def apply[Target](options: Trigger[Target], rules: StringDictionary[js.Object]): Composite[ChildType]
  @JSName("apply")
  ...
  def insertAfter(widget: Widget): Composite[ChildType]
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Composite[ChildType]]
  
  def insertBefore(widget: Widget): Composite[ChildType]
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Composite[ChildType]]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): Composite[ChildType]
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): Composite[ChildType]
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
  ...
  def parent(): typings.tabris.mod.Composite[Widget]
  @JSName("parent")
  var parent_Original: js.Function0[typings.tabris.mod.Composite[Widget]]
...
object OmitCompositeWidgetset {
  
  @scala.inline
  def apply[ChildType /* <: Widget */](
    ...
    _apply: (/* options */ Trigger[Composite[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Composite[ChildType], StringDictionary[js.Object]]) | Null) => Composite[ChildType],
    _checkDisposed: () => Unit,
    ...
    _setParent: (/* parent */ typings.tabris.mod.Composite[Widget], /* index */ js.UndefOr[Double]) => Unit,
    ...
    append: /* repeated */ Widget => Composite[ChildType],
    appendTo: /* parent */ typings.tabris.mod.Composite[Widget] => Composite[ChildType],
    apply: (/* options */ Trigger[Composite[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Composite[ChildType], StringDictionary[js.Object]]) | Null) => Composite[ChildType],
    ...
    constructor: /* properties */ js.UndefOr[Properties[Composite[Widget], Omit[Composite[Widget], set]]] => js.Any,
    cornerRadius: Double,
    data: StringDictionary[js.Any],
    detach: () => Composite[ChildType],
    dispose: () => Unit,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget => Composite[ChildType],
    insertBefore: /* widget */ Widget => Composite[ChildType],
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[Composite[ChildType], Omit[Composite[ChildType], set | jsxAttributes]]) & `3`,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Composite[ChildType],
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Composite[ChildType],
    opacity: Double,
    parent: () => typings.tabris.mod.Composite[Widget],
  ...
  ): OmitCompositeWidgetset[ChildType] = {
    ...
    __obj.asInstanceOf[OmitCompositeWidgetset[ChildType]]
  }
  
  @scala.inline
  implicit class OmitCompositeWidgetsetMutableBuilder[Self <: OmitCompositeWidgetset[?], ChildType /* <: Widget */] (val x: Self & OmitCompositeWidgetset[ChildType]) extends AnyVal {
    ...
    @scala.inline
    def setAppend(value: /* repeated */ Widget => Composite[ChildType]): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    @scala.inline
    def setAppendTo(value: /* parent */ typings.tabris.mod.Composite[Widget] => Composite[ChildType]): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    @scala.inline
    def setApply(
      value: (/* options */ Trigger[Composite[ChildType]], /* rules */ StringDictionary[js.Object] | (js.Function1[/* widget */ Composite[ChildType], StringDictionary[js.Object]]) | Null) => Composite[ChildType]
    ...
    @scala.inline
    def setConstructor(
      value: /* properties */ js.UndefOr[Properties[Composite[Widget], Omit[Composite[Widget], set]]] => js.Any
    ...
    @scala.inline
    def setDetach(value: () => Composite[ChildType]): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setInsertAfter(value: /* widget */ Widget => Composite[ChildType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    @scala.inline
    def setInsertBefore(value: /* widget */ Widget => Composite[ChildType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    def setJsxAttributes(
      value: (JSXAttributes[Composite[ChildType], Omit[Composite[ChildType], set | jsxAttributes]]) & `3`
    ...
    @scala.inline
    def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Composite[ChildType]
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    @scala.inline
    def setOnAddChild(value: Listeners[CompositeAddChildEvent[Composite[ChildType]]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBackgroundChanged(value: ChangeListeners[Composite[ChildType], background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBaselineChanged(value: ChangeListeners[Composite[ChildType], baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBottomChanged(value: ChangeListeners[Composite[ChildType], bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnBoundsChanged(value: ChangeListeners[Composite[ChildType], bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterXChanged(value: ChangeListeners[Composite[ChildType], centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCenterYChanged(value: ChangeListeners[Composite[ChildType], centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassChanged(value: ChangeListeners[Composite[ChildType], `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnClassListChanged(value: ChangeListeners[Composite[ChildType], classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnCornerRadiusChanged(value: ChangeListeners[Composite[ChildType], cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDataChanged(value: ChangeListeners[Composite[ChildType], data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnDispose(value: Listeners[EventObject[Composite[ChildType]]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnElevationChanged(value: ChangeListeners[Composite[ChildType], elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnEnabledChanged(value: ChangeListeners[Composite[ChildType], enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnExcludeFromLayoutChanged(value: ChangeListeners[Composite[ChildType], excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHeightChanged(value: ChangeListeners[Composite[ChildType], height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnHighlightOnTouchChanged(value: ChangeListeners[Composite[ChildType], highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnIdChanged(value: ChangeListeners[Composite[ChildType], id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLayoutDataChanged(value: ChangeListeners[Composite[ChildType], layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLeftChanged(value: ChangeListeners[Composite[ChildType], left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnLongPress(value: Listeners[WidgetLongPressEvent[Composite[ChildType]]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnOpacityChanged(value: ChangeListeners[Composite[ChildType], opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPan(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanDown(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanHorizontal(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanLeft(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanRight(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanUp(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnPanVertical(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[Composite[ChildType]]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnResize(value: Listeners[WidgetResizeEvent[Composite[ChildType]]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnRightChanged(value: ChangeListeners[Composite[ChildType], right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[Composite[ChildType]]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[Composite[ChildType]]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[Composite[ChildType]]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[Composite[ChildType]]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTap(value: Listeners[WidgetTapEvent[Composite[ChildType]]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTopChanged(value: ChangeListeners[Composite[ChildType], top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchCancel(value: Listeners[WidgetTouchEvent[Composite[ChildType]]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchEnd(value: Listeners[WidgetTouchEvent[Composite[ChildType]]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchMove(value: Listeners[WidgetTouchEvent[Composite[ChildType]]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTouchStart(value: Listeners[WidgetTouchEvent[Composite[ChildType]]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnTransformChanged(value: ChangeListeners[Composite[ChildType], transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnVisibleChanged(value: ChangeListeners[Composite[ChildType], visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnWidthChanged(value: ChangeListeners[Composite[ChildType], width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setParent(value: () => typings.tabris.mod.Composite[Widget]): Self = StObject.set(x, "parent", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setTrigger(value: /* type */ String => Composite[ChildType]): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTriggerAsync(value: /* type */ String => js.Promise[Composite[ChildType]]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def set_setParent(value: (/* parent */ typings.tabris.mod.Composite[Widget], /* index */ js.UndefOr[Double]) => Unit): Self = StObject.set(x, "_setParent", js.Any.fromFunction2(value))
