...
trait OmitPagesetAbsoluteBounds extends StObject {
  ...
  @JSName("detach")
  var detach_Original: js.Function0[typings.tabris.global.tabris.widgets.Page]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.widgets.Page
  def off(
    `type`: String,
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onAppear: Listeners[EventObject[typings.tabris.global.tabris.widgets.Page]]
  
  var onAutoDisposeChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, autoDispose]
  
  var onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, background]
  
  var onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, baseline]
  
  var onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, bottom]
  
  var onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, bounds]
  
  var onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, centerX]
  
  var onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, centerY]
  
  var onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, `class`]
  
  var onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, cornerRadius]
  
  var onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, data]
  
  var onDisappear: Listeners[EventObject[typings.tabris.global.tabris.widgets.Page]]
  
  var onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Page]]
  
  var onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, elevation]
  
  var onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, id]
  
  var onImageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, image]
  
  var onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, layoutData]
  
  var onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onTitleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, title]
  
  var onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]]
  
  var onTransformChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, transform]
  
  var onVisibleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, visible]
  
  var onWidthChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, width]
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.widgets.Page
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.widgets.Page]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.widgets.Page]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.widgets.Page]
...
object OmitPagesetAbsoluteBounds {
  ...
  inline def apply(
    ...
    onBackgroundChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, background],
    onBaselineChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, baseline],
    onBottomChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, bottom],
    onBoundsChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, bounds],
    onCenterXChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, centerX],
    onCenterYChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, centerY],
    onClassChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, `class`],
    onClassListChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, classList],
    onCornerRadiusChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, cornerRadius],
    onDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, data],
    onDisappear: Listeners[EventObject[typings.tabris.global.tabris.widgets.Page]],
    onDispose: Listeners[EventObject[typings.tabris.global.tabris.widgets.Page]],
    onElevationChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, elevation],
    onEnabledChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, excludeFromLayout],
    onHeightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, height],
    onHighlightOnTouchChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, highlightOnTouch],
    onIdChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, id],
    onImageChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, image],
    onLayoutDataChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, layoutData],
    onLeftChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, left],
    onLongPress: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Page]],
    onOpacityChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, opacity],
    onPan: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]],
    onPanDown: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]],
    onPanHorizontal: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]],
    onPanLeft: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]],
    onPanRight: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]],
    onPanUp: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]],
    onPanVertical: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]],
    onRemoveChild: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Page]],
    onResize: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Page]],
    onRightChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, right],
    onSwipeDown: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]],
    onTap: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Page]],
    onTitleChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, title],
    onTopChanged: ChangeListeners[typings.tabris.global.tabris.widgets.Page, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]],
    onTouchEnd: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]],
    onTouchMove: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]],
    onTouchStart: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]],
    ...
    trigger: /* type */ String => typings.tabris.global.tabris.widgets.Page,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Page],
    visible: Boolean,
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPagesetAbsoluteBounds] (val x: Self) extends AnyVal {
    ...
    inline def setDetach(value: () => typings.tabris.global.tabris.widgets.Page): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.widgets.Page
    ...
    inline def setOnAppear(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onAppear", value.asInstanceOf[js.Any])
    
    inline def setOnAutoDisposeChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, autoDispose]): Self = StObject.set(x, "onAutoDisposeChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDisappear(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onDisappear", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnImageChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, image]): Self = StObject.set(x, "onImageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTitleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, title]): Self = StObject.set(x, "onTitleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typings.tabris.global.tabris.widgets.Page]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typings.tabris.global.tabris.widgets.Page, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.widgets.Page): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.widgets.Page]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
