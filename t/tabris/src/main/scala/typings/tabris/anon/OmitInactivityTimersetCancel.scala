...
trait OmitInactivityTimersetCancel extends StObject {
  ...
  var jsxAttributes: JSXAttributes[
    typings.tabris.global.tabris.InactivityTimer, 
    Omit[
      typings.tabris.global.tabris.InactivityTimer, 
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typings.tabris.global.tabris.InactivityTimer
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.InactivityTimer
  def on(
    `type`: String,
  ...
  var onDelayChanged: ChangeListeners[typings.tabris.global.tabris.InactivityTimer, delay]
  
  var onTimeout: Listeners[EventObject[typings.tabris.global.tabris.InactivityTimer]]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typings.tabris.global.tabris.InactivityTimer
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typings.tabris.global.tabris.InactivityTimer
  
  def triggerAsync(`type`: String): js.Promise[typings.tabris.global.tabris.InactivityTimer]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typings.tabris.global.tabris.InactivityTimer]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typings.tabris.global.tabris.InactivityTimer]
}
object OmitInactivityTimersetCancel {
  ...
  inline def apply(
    ...
    jsxAttributes: JSXAttributes[
      typings.tabris.global.tabris.InactivityTimer, 
      Omit[typings.tabris.global.tabris.InactivityTimer, set | jsxAttributes]
    ],
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.InactivityTimer,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.InactivityTimer,
    onDelayChanged: ChangeListeners[typings.tabris.global.tabris.InactivityTimer, delay],
    onTimeout: Listeners[EventObject[typings.tabris.global.tabris.InactivityTimer]],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.InactivityTimer,
    start: () => Unit,
    trigger: /* type */ String => typings.tabris.global.tabris.InactivityTimer,
    triggerAsync: /* type */ String => js.Promise[typings.tabris.global.tabris.InactivityTimer]
  ): OmitInactivityTimersetCancel = {
    ...
    __obj.asInstanceOf[OmitInactivityTimersetCancel]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitInactivityTimersetCancel] (val x: Self) extends AnyVal {
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.InactivityTimer
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typings.tabris.global.tabris.InactivityTimer
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnDelayChanged(value: ChangeListeners[typings.tabris.global.tabris.InactivityTimer, delay]): Self = StObject.set(x, "onDelayChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTimeout(value: Listeners[EventObject[typings.tabris.global.tabris.InactivityTimer]]): Self = StObject.set(x, "onTimeout", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typings.tabris.global.tabris.InactivityTimer): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typings.tabris.global.tabris.InactivityTimer]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
