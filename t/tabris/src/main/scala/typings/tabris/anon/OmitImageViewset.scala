...
trait OmitImageViewset extends StObject {
  ...
  def appendTo(parent: Composite[Widget]): ImageView
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], ImageView]
  ...
  def insertAfter(widget: Widget): ImageView
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, ImageView]
  
  def insertBefore(widget: Widget): ImageView
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, ImageView]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: (JSXAttributes[ImageView, Omit[ImageView, set | typings.tabris.tabrisStrings.jsxAttributes]]) & `2`
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): ImageView
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): ImageView
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitImageViewset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget] => ImageView,
    ...
    id: String,
    insertAfter: /* widget */ Widget => ImageView,
    insertBefore: /* widget */ Widget => ImageView,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[ImageView, Omit[ImageView, set | jsxAttributes]]) & `2`,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => ImageView,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => ImageView,
    opacity: Double,
  ...
  extension [Self <: OmitImageViewset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget] => ImageView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget => ImageView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget => ImageView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[ImageView, Omit[ImageView, set | jsxAttributes]]) & `2`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => ImageView
