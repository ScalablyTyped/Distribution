...
trait OmitImageViewset extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): ImageView
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], ImageView]
  ...
  def detach(): ImageView
  @JSName("detach")
  var detach_Original: js.Function0[ImageView]
  ...
  def insertAfter(widget: Widget[Any]): ImageView
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], ImageView]
  
  def insertBefore(widget: Widget[Any]): ImageView
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], ImageView]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: (JSXAttributes[ImageView, Omit[ImageView, set | typings.tabris.tabrisStrings.jsxAttributes]]) & Children
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): ImageView
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): ImageView
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[ImageView, background]
  
  var onBaselineChanged: ChangeListeners[ImageView, baseline]
  
  var onBottomChanged: ChangeListeners[ImageView, bottom]
  
  var onBoundsChanged: ChangeListeners[ImageView, bounds]
  
  var onCenterXChanged: ChangeListeners[ImageView, centerX]
  
  var onCenterYChanged: ChangeListeners[ImageView, centerY]
  
  var onClassChanged: ChangeListeners[ImageView, `class`]
  
  var onClassListChanged: ChangeListeners[ImageView, classList]
  
  var onCornerRadiusChanged: ChangeListeners[ImageView, cornerRadius]
  
  var onDataChanged: ChangeListeners[ImageView, data]
  
  var onDispose: Listeners[EventObject[ImageView]]
  
  var onElevationChanged: ChangeListeners[ImageView, elevation]
  
  var onEnabledChanged: ChangeListeners[ImageView, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[ImageView, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[ImageView, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[ImageView, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[ImageView, id]
  
  var onImageChanged: ChangeListeners[ImageView, image]
  
  var onLayoutDataChanged: ChangeListeners[ImageView, layoutData]
  
  var onLeftChanged: ChangeListeners[ImageView, left]
  
  var onLoad: Listeners[ImageViewLoadEvent[ImageView]]
  
  var onLongPress: Listeners[WidgetLongPressEvent[ImageView]]
  
  var onMaxZoomLevelChanged: ChangeListeners[ImageView, maxZoomLevel]
  
  var onMinZoomLevelChanged: ChangeListeners[ImageView, minZoomLevel]
  
  var onOpacityChanged: ChangeListeners[ImageView, opacity]
  
  var onPan: Listeners[WidgetPanEvent[ImageView]]
  
  var onPanDown: Listeners[WidgetPanEvent[ImageView]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[ImageView]]
  
  var onPanLeft: Listeners[WidgetPanEvent[ImageView]]
  
  var onPanRight: Listeners[WidgetPanEvent[ImageView]]
  
  var onPanUp: Listeners[WidgetPanEvent[ImageView]]
  
  var onPanVertical: Listeners[WidgetPanEvent[ImageView]]
  
  var onResize: Listeners[WidgetResizeEvent[ImageView]]
  
  var onRightChanged: ChangeListeners[ImageView, right]
  
  var onScaleModeChanged: ChangeListeners[ImageView, scaleMode]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[ImageView]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[ImageView]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[ImageView]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[ImageView]]
  
  var onTap: Listeners[WidgetTapEvent[ImageView]]
  
  var onTintColorChanged: ChangeListeners[ImageView, tintColor]
  
  var onTopChanged: ChangeListeners[ImageView, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[ImageView]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[ImageView]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[ImageView]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[ImageView]]
  
  var onTransformChanged: ChangeListeners[ImageView, transform]
  
  var onVisibleChanged: ChangeListeners[ImageView, visible]
  
  var onWidthChanged: ChangeListeners[ImageView, width]
  
  var onZoom: Listeners[ImageViewZoomEvent[ImageView]]
  
  var onZoomEnabledChanged: ChangeListeners[ImageView, zoomEnabled]
  
  var onZoomLevelChanged: ChangeListeners[ImageView, zoomLevel]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): ImageView
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): ImageView
  
  def triggerAsync(`type`: String): js.Promise[ImageView]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[ImageView]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, ImageView]
...
object OmitImageViewset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => ImageView,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => ImageView,
    insertBefore: /* widget */ Widget[Any] => ImageView,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[ImageView, Omit[ImageView, set | jsxAttributes]]) & Children,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    maxZoomLevel: Double,
    minZoomLevel: Double,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => ImageView,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => ImageView,
    onBackgroundChanged: ChangeListeners[ImageView, background],
    onBaselineChanged: ChangeListeners[ImageView, baseline],
    onBottomChanged: ChangeListeners[ImageView, bottom],
    onBoundsChanged: ChangeListeners[ImageView, bounds],
    onCenterXChanged: ChangeListeners[ImageView, centerX],
    onCenterYChanged: ChangeListeners[ImageView, centerY],
    onClassChanged: ChangeListeners[ImageView, `class`],
    onClassListChanged: ChangeListeners[ImageView, classList],
    onCornerRadiusChanged: ChangeListeners[ImageView, cornerRadius],
    onDataChanged: ChangeListeners[ImageView, data],
    onDispose: Listeners[EventObject[ImageView]],
    onElevationChanged: ChangeListeners[ImageView, elevation],
    onEnabledChanged: ChangeListeners[ImageView, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[ImageView, excludeFromLayout],
    onHeightChanged: ChangeListeners[ImageView, height],
    onHighlightOnTouchChanged: ChangeListeners[ImageView, highlightOnTouch],
    onIdChanged: ChangeListeners[ImageView, id],
    onImageChanged: ChangeListeners[ImageView, image],
    onLayoutDataChanged: ChangeListeners[ImageView, layoutData],
    onLeftChanged: ChangeListeners[ImageView, left],
    onLoad: Listeners[ImageViewLoadEvent[ImageView]],
    onLongPress: Listeners[WidgetLongPressEvent[ImageView]],
    onMaxZoomLevelChanged: ChangeListeners[ImageView, maxZoomLevel],
    onMinZoomLevelChanged: ChangeListeners[ImageView, minZoomLevel],
    onOpacityChanged: ChangeListeners[ImageView, opacity],
    onPan: Listeners[WidgetPanEvent[ImageView]],
    onPanDown: Listeners[WidgetPanEvent[ImageView]],
    onPanHorizontal: Listeners[WidgetPanEvent[ImageView]],
    onPanLeft: Listeners[WidgetPanEvent[ImageView]],
    onPanRight: Listeners[WidgetPanEvent[ImageView]],
    onPanUp: Listeners[WidgetPanEvent[ImageView]],
    onPanVertical: Listeners[WidgetPanEvent[ImageView]],
    onResize: Listeners[WidgetResizeEvent[ImageView]],
    onRightChanged: ChangeListeners[ImageView, right],
    onScaleModeChanged: ChangeListeners[ImageView, scaleMode],
    onSwipeDown: Listeners[WidgetSwipeEvent[ImageView]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[ImageView]],
    onSwipeRight: Listeners[WidgetSwipeEvent[ImageView]],
    onSwipeUp: Listeners[WidgetSwipeEvent[ImageView]],
    onTap: Listeners[WidgetTapEvent[ImageView]],
    onTintColorChanged: ChangeListeners[ImageView, tintColor],
    onTopChanged: ChangeListeners[ImageView, top],
    onTouchCancel: Listeners[WidgetTouchEvent[ImageView]],
    onTouchEnd: Listeners[WidgetTouchEvent[ImageView]],
    onTouchMove: Listeners[WidgetTouchEvent[ImageView]],
    onTouchStart: Listeners[WidgetTouchEvent[ImageView]],
    onTransformChanged: ChangeListeners[ImageView, transform],
    onVisibleChanged: ChangeListeners[ImageView, visible],
    onWidthChanged: ChangeListeners[ImageView, width],
    onZoom: Listeners[ImageViewZoomEvent[ImageView]],
    onZoomEnabledChanged: ChangeListeners[ImageView, zoomEnabled],
    onZoomLevelChanged: ChangeListeners[ImageView, zoomLevel],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => ImageView,
    opacity: Double,
    ...
    trigger: /* type */ String => ImageView,
    triggerAsync: /* type */ String => js.Promise[ImageView],
    visible: Boolean,
    ...
    __obj.asInstanceOf[OmitImageViewset]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitImageViewset] (val x: Self) extends AnyVal {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => ImageView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: () => ImageView): Self = StObject.set(x, "detach", js.Any.fromFunction0(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => ImageView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => ImageView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[ImageView, Omit[ImageView, set | jsxAttributes]]) & Children): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => ImageView
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => ImageView
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[ImageView, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[ImageView, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[ImageView, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[ImageView, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[ImageView, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[ImageView, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[ImageView, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[ImageView, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[ImageView, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[ImageView, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[ImageView]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[ImageView, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[ImageView, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[ImageView, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[ImageView, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[ImageView, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[ImageView, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnImageChanged(value: ChangeListeners[ImageView, image]): Self = StObject.set(x, "onImageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[ImageView, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[ImageView, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLoad(value: Listeners[ImageViewLoadEvent[ImageView]]): Self = StObject.set(x, "onLoad", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[ImageView]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnMaxZoomLevelChanged(value: ChangeListeners[ImageView, maxZoomLevel]): Self = StObject.set(x, "onMaxZoomLevelChanged", value.asInstanceOf[js.Any])
    
    inline def setOnMinZoomLevelChanged(value: ChangeListeners[ImageView, minZoomLevel]): Self = StObject.set(x, "onMinZoomLevelChanged", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[ImageView, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[ImageView]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[ImageView]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[ImageView]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[ImageView]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[ImageView]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[ImageView]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[ImageView]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[ImageView]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[ImageView, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnScaleModeChanged(value: ChangeListeners[ImageView, scaleMode]): Self = StObject.set(x, "onScaleModeChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[ImageView]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[ImageView]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[ImageView]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[ImageView]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[ImageView]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTintColorChanged(value: ChangeListeners[ImageView, tintColor]): Self = StObject.set(x, "onTintColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[ImageView, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[ImageView]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[ImageView]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[ImageView]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[ImageView]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[ImageView, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[ImageView, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[ImageView, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    
    inline def setOnZoom(value: Listeners[ImageViewZoomEvent[ImageView]]): Self = StObject.set(x, "onZoom", value.asInstanceOf[js.Any])
    
    inline def setOnZoomEnabledChanged(value: ChangeListeners[ImageView, zoomEnabled]): Self = StObject.set(x, "onZoomEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnZoomLevelChanged(value: ChangeListeners[ImageView, zoomLevel]): Self = StObject.set(x, "onZoomLevelChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => ImageView): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[ImageView]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
