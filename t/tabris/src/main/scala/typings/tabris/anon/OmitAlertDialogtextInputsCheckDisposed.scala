...
trait OmitAlertDialogtextInputsCheckDisposed extends StObject {
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[
      Properties[Omit[AlertDialog, textInputs], OmitOmitAlertDialogtextInCheckDisposed]
    ], 
    Any
  ]
...
object OmitAlertDialogtextInputsCheckDisposed {
  ...
  ): OmitAlertDialogtextInputsCheckDisposed = {
