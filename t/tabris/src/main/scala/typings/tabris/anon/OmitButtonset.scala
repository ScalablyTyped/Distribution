...
trait OmitButtonset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[Button, Omit[Button, set | typings.tabris.tabrisStrings.jsxAttributes]]) & `6`
...
object OmitButtonset {
  ...
  inline def apply(
    ...
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[Button, Omit[Button, set | jsxAttributes]]) & `6`,
  ...
  extension [Self <: OmitButtonset](x: Self) {
    ...
    inline def setJsxAttributes(value: (JSXAttributes[Button, Omit[Button, set | jsxAttributes]]) & `6`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
