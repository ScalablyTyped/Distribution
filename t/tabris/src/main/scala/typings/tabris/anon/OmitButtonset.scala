...
trait OmitButtonset extends StObject {
  ...
  def appendTo(parent: Composite[Widget]): Button
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], Button]
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Button, Omit[Button, set]]], js.Any]
  ...
  def insertAfter(widget: Widget): Button
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Button]
  
  def insertBefore(widget: Widget): Button
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Button]
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): Button
  def on(
    `type`: String,
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], js.Any]): Button
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], js.Any],
    context: js.Object
...
object OmitButtonset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget] => Button,
    ...
    constructor: /* properties */ js.UndefOr[Properties[Button, Omit[Button, set]]] => js.Any,
    cornerRadius: Double,
    ...
    id: String,
    insertAfter: /* widget */ Widget => Button,
    insertBefore: /* widget */ Widget => Button,
    isDisposed: () => Boolean,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Button,
    ...
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], js.Any], /* context */ js.UndefOr[js.Object]) => Button,
    opacity: Double,
