...
import typings.tabris.mod.widgets.Button
...
/* Inlined tabris.tabris.Omit<tabris.tabris.widgets.Button, 'set'> */
trait OmitButtonset extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): Button
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], Button]
  
  var autoCapitalize: default | none | all
  ...
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Button, Omit[Button, set]]], Any]
  ...
  def detach(): Button
  @JSName("detach")
  var detach_Original: js.Function0[Button]
  ...
  var imageTintColor: ColorValue
  
  def insertAfter(widget: Widget[Any]): Button
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], Button]
  
  def insertBefore(widget: Widget[Any]): Button
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], Button]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: (JSXAttributes[Button, Omit[Button, set | typings.tabris.tabrisStrings.jsxAttributes]]) & `7`
  
  var layoutData: LayoutDataValue
  
  var left: ConstraintValue
  
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Button
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Button
  def on(
    `type`: String,
  ...
  var onAlignmentChanged: ChangeListeners[Button, alignment]
  
  var onAutoCapitalizeChanged: ChangeListeners[Button, autoCapitalize]
  
  var onBackgroundChanged: ChangeListeners[Button, background]
  
  var onBaselineChanged: ChangeListeners[Button, baseline]
  
  var onBottomChanged: ChangeListeners[Button, bottom]
  
  var onBoundsChanged: ChangeListeners[Button, bounds]
  
  var onCenterXChanged: ChangeListeners[Button, centerX]
  
  var onCenterYChanged: ChangeListeners[Button, centerY]
  
  var onClassChanged: ChangeListeners[Button, `class`]
  
  var onClassListChanged: ChangeListeners[Button, classList]
  
  var onCornerRadiusChanged: ChangeListeners[Button, cornerRadius]
  
  var onDataChanged: ChangeListeners[Button, data]
  
  var onDispose: Listeners[EventObject[Button]]
  
  var onElevationChanged: ChangeListeners[Button, elevation]
  
  var onEnabledChanged: ChangeListeners[Button, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[Button, excludeFromLayout]
  
  var onFontChanged: ChangeListeners[Button, font]
  
  var onHeightChanged: ChangeListeners[Button, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[Button, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[Button, id]
  
  var onImageChanged: ChangeListeners[Button, image]
  
  var onImageTintColorChanged: ChangeListeners[Button, imageTintColor]
  
  var onLayoutDataChanged: ChangeListeners[Button, layoutData]
  
  var onLeftChanged: ChangeListeners[Button, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[Button]]
  
  var onOpacityChanged: ChangeListeners[Button, opacity]
  
  var onPan: Listeners[WidgetPanEvent[Button]]
  
  var onPanDown: Listeners[WidgetPanEvent[Button]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[Button]]
  
  var onPanLeft: Listeners[WidgetPanEvent[Button]]
  
  var onPanRight: Listeners[WidgetPanEvent[Button]]
  
  var onPanUp: Listeners[WidgetPanEvent[Button]]
  
  var onPanVertical: Listeners[WidgetPanEvent[Button]]
  
  var onResize: Listeners[WidgetResizeEvent[Button]]
  
  var onRightChanged: ChangeListeners[Button, right]
  
  var onSelect: Listeners[EventObject[Button]]
  
  var onStrokeColorChanged: ChangeListeners[Button, strokeColor]
  
  var onStrokeWidthChanged: ChangeListeners[Button, strokeWidth]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[Button]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Button]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[Button]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[Button]]
  
  var onTap: Listeners[WidgetTapEvent[Button]]
  
  var onTextChanged: ChangeListeners[Button, text]
  
  var onTextColorChanged: ChangeListeners[Button, textColor]
  
  var onTopChanged: ChangeListeners[Button, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[Button]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[Button]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[Button]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[Button]]
  
  var onTransformChanged: ChangeListeners[Button, transform]
  
  var onVisibleChanged: ChangeListeners[Button, visible]
  
  var onWidthChanged: ChangeListeners[Button, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Button
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  var strokeColor: ColorValue
  
  var strokeWidth: js.UndefOr[Double | Null] = js.undefined
  
  var style: default | elevate | flat | outline | text
  ...
  def trigger(`type`: String): Button
  
  def triggerAsync(`type`: String): js.Promise[Button]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Button]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Button]
...
object OmitButtonset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => Button,
    ...
    constructor: /* properties */ js.UndefOr[Properties[Button, Omit[Button, set]]] => Any,
    cornerRadius: Double,
    data: Any,
    detach: () => Button,
    dispose: () => Unit,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => Button,
    insertBefore: /* widget */ Widget[Any] => Button,
    isDisposed: () => Boolean,
    jsxAttributes: (JSXAttributes[Button, Omit[Button, set | jsxAttributes]]) & `7`,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Button,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Button,
    onAlignmentChanged: ChangeListeners[Button, alignment],
    onAutoCapitalizeChanged: ChangeListeners[Button, autoCapitalize],
    onBackgroundChanged: ChangeListeners[Button, background],
    onBaselineChanged: ChangeListeners[Button, baseline],
    onBottomChanged: ChangeListeners[Button, bottom],
    onBoundsChanged: ChangeListeners[Button, bounds],
    onCenterXChanged: ChangeListeners[Button, centerX],
    onCenterYChanged: ChangeListeners[Button, centerY],
    onClassChanged: ChangeListeners[Button, `class`],
    onClassListChanged: ChangeListeners[Button, classList],
    onCornerRadiusChanged: ChangeListeners[Button, cornerRadius],
    onDataChanged: ChangeListeners[Button, data],
    onDispose: Listeners[EventObject[Button]],
    onElevationChanged: ChangeListeners[Button, elevation],
    onEnabledChanged: ChangeListeners[Button, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[Button, excludeFromLayout],
    onFontChanged: ChangeListeners[Button, font],
    onHeightChanged: ChangeListeners[Button, height],
    onHighlightOnTouchChanged: ChangeListeners[Button, highlightOnTouch],
    onIdChanged: ChangeListeners[Button, id],
    onImageChanged: ChangeListeners[Button, image],
    onImageTintColorChanged: ChangeListeners[Button, imageTintColor],
    onLayoutDataChanged: ChangeListeners[Button, layoutData],
    onLeftChanged: ChangeListeners[Button, left],
    onLongPress: Listeners[WidgetLongPressEvent[Button]],
    onOpacityChanged: ChangeListeners[Button, opacity],
    onPan: Listeners[WidgetPanEvent[Button]],
    onPanDown: Listeners[WidgetPanEvent[Button]],
    onPanHorizontal: Listeners[WidgetPanEvent[Button]],
    onPanLeft: Listeners[WidgetPanEvent[Button]],
    onPanRight: Listeners[WidgetPanEvent[Button]],
    onPanUp: Listeners[WidgetPanEvent[Button]],
    onPanVertical: Listeners[WidgetPanEvent[Button]],
    onResize: Listeners[WidgetResizeEvent[Button]],
    onRightChanged: ChangeListeners[Button, right],
    onSelect: Listeners[EventObject[Button]],
    onStrokeColorChanged: ChangeListeners[Button, strokeColor],
    onStrokeWidthChanged: ChangeListeners[Button, strokeWidth],
    onSwipeDown: Listeners[WidgetSwipeEvent[Button]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[Button]],
    onSwipeRight: Listeners[WidgetSwipeEvent[Button]],
    onSwipeUp: Listeners[WidgetSwipeEvent[Button]],
    onTap: Listeners[WidgetTapEvent[Button]],
    onTextChanged: ChangeListeners[Button, text],
    onTextColorChanged: ChangeListeners[Button, textColor],
    onTopChanged: ChangeListeners[Button, top],
    onTouchCancel: Listeners[WidgetTouchEvent[Button]],
    onTouchEnd: Listeners[WidgetTouchEvent[Button]],
    onTouchMove: Listeners[WidgetTouchEvent[Button]],
    onTouchStart: Listeners[WidgetTouchEvent[Button]],
    onTransformChanged: ChangeListeners[Button, transform],
    onVisibleChanged: ChangeListeners[Button, visible],
    onWidthChanged: ChangeListeners[Button, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Button,
    opacity: Double,
  ...
  extension [Self <: OmitButtonset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => Button): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[Button, Omit[Button, set]]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => Button): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => Button): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: () => Boolean): Self = StObject.set(x, "isDisposed", js.Any.fromFunction0(value))
    
    inline def setJsxAttributes(value: (JSXAttributes[Button, Omit[Button, set | jsxAttributes]]) & `7`): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Button
