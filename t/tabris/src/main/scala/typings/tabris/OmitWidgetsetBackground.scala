...
@js.native
trait OmitWidgetsetBackground extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], Page] = js.native
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Page] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Page] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: JSXAttributes[Page, Omit[Page, set | typings.tabris.tabrisStrings.jsxAttributes]] = js.native
  ...
  def appendTo(parent: Composite[Widget]): Page = js.native
  def detach(): Page = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): Page = js.native
  def insertBefore(widget: Widget): Page = js.native
