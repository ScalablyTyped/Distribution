...
import typings.tabris.mod.ContentView_
...
/* Inlined tabris.tabris.Omit<tabris.tabris.AlertDialog, 'set'> */
@js.native
trait OmitAlertDialogset extends js.Object {
  ...
  @JSName("close")
  var close_Original: js.Function0[AlertDialog] = js.native
  @JSName("constructor")
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[Properties[AlertDialog, Omit[AlertDialog, set]]], 
    js.Any
  ] = js.native
  ...
  var jsxAttributes: (JSXAttributes[AlertDialog, Omit[AlertDialog, set | typings.tabris.tabrisStrings.jsxAttributes]]) with Anon1 = js.native
  ...
  var onButtonsChanged: ChangeListeners[AlertDialog, buttons] = js.native
  var onClose: Listeners[AlertDialogCloseEvent[AlertDialog]] = js.native
  var onCloseCancel: Listeners[EventObject[AlertDialog]] = js.native
  var onCloseNeutral: Listeners[EventObject[AlertDialog]] = js.native
  var onCloseOk: Listeners[EventObject[AlertDialog]] = js.native
  var onMessageChanged: ChangeListeners[AlertDialog, message] = js.native
  var onTitleChanged: ChangeListeners[AlertDialog, title] = js.native
  @JSName("on")
  ...
  @JSName("open")
  var open_Original: js.Function0[AlertDialog] = js.native
  var textInputs: ContentView_[TextInput] = js.native
  var title: String = js.native
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[AlertDialog]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, AlertDialog] = js.native
  @JSName("$getProperty")
  ...
  def close(): AlertDialog = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): AlertDialog = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): AlertDialog = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): AlertDialog = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): AlertDialog = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): AlertDialog = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): AlertDialog = js.native
  def open(): AlertDialog = js.native
  def trigger(`type`: String): AlertDialog = js.native
  def triggerAsync(`type`: String): js.Promise[AlertDialog] = js.native
}
