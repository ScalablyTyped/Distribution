...
import typings.tabris.mod.ToggleButton
...
trait OmitToggleButtonset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[ToggleButton, Omit[ToggleButton, set | typings.tabris.tabrisStrings.jsxAttributes]]) with AnonChildrenString = js.native
