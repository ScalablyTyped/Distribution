...
import typings.tabris.mod.ResourceBuildConvertOptions
...
@js.native
class Resources[ResourceType, RawType] protected ()
  extends typings.tabris.mod.Resources[ResourceType, RawType] {
...
object Resources {
  ...
  inline def build[ResourceType](options: ResourceBuildOptions[ResourceType]): typings.tabris.mod.ResourceBuilder[ResourceType, ResourceType] = ^.asInstanceOf[js.Dynamic].applyDynamic("build")(options.asInstanceOf[js.Any]).asInstanceOf[typings.tabris.mod.ResourceBuilder[ResourceType, ResourceType]]
  /**
    ...
    */
  inline def build[ResourceType, RawType](options: ResourceBuildConvertOptions[ResourceType, RawType]): typings.tabris.mod.ResourceBuilder[ResourceType, RawType] = ^.asInstanceOf[js.Dynamic].applyDynamic("build")(options.asInstanceOf[js.Any]).asInstanceOf[typings.tabris.mod.ResourceBuilder[ResourceType, RawType]]
}
