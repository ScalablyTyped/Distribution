...
@js.native
trait OmitDateDialogset extends js.Object {
  ...
  @JSName("close")
  var close_Original: js.Function0[DateDialog] = js.native
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[DateDialog, Omit[DateDialog, set]]], js.Any] = js.native
  ...
  var jsxAttributes: JSXAttributes[DateDialog, Omit[DateDialog, set | typings.tabris.tabrisStrings.jsxAttributes]] = js.native
  ...
  var onClose: Listeners[DateDialogCloseEvent[DateDialog]] = js.native
  var onDateChanged: ChangeListeners[DateDialog, date] = js.native
  var onMaxDateChanged: ChangeListeners[DateDialog, maxDate] = js.native
  var onMinDateChanged: ChangeListeners[DateDialog, minDate] = js.native
  var onSelect: Listeners[DateDialogSelectEvent[DateDialog]] = js.native
  @JSName("on")
  ...
  @JSName("open")
  var open_Original: js.Function0[DateDialog] = js.native
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[DateDialog]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, DateDialog] = js.native
  @JSName("$getProperty")
  ...
  def close(): DateDialog = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): DateDialog = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): DateDialog = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): DateDialog = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): DateDialog = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): DateDialog = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): DateDialog = js.native
  def triggerAsync(`type`: String): js.Promise[DateDialog] = js.native
}
