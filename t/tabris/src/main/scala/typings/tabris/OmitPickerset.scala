...
import typings.tabris.mod.Picker
...
trait OmitPickerset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[Picker, Omit[Picker, set | typings.tabris.tabrisStrings.jsxAttributes]]) with js.Object with PartialPickPickeritemText = js.native
