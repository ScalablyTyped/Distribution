...
trait AnonAbsoluteX extends js.Object {
...
object AnonAbsoluteX {
  @scala.inline
  def apply(absoluteX: Double, absoluteY: Double, x: Double, y: Double): AnonAbsoluteX = {
    ...
    __obj.asInstanceOf[AnonAbsoluteX]
  }
}
