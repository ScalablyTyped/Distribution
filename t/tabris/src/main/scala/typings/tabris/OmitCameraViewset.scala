...
import typings.tabris.mod.CameraView
...
trait OmitCameraViewset extends js.Object {
  ...
  var jsxAttributes: JSXAttributes[CameraView, Omit[CameraView, set | typings.tabris.tabrisStrings.jsxAttributes]] = js.native
