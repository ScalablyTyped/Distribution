...
import typings.tabris.mod.WebView
...
trait OmitWebViewset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[WebView, Omit[WebView, set | typings.tabris.tabrisStrings.jsxAttributes]]) with js.Object = js.native
