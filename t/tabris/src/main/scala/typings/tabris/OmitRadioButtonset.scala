...
import typings.tabris.mod.RadioButton
import typings.tabris.mod.RadioButtonSelectEvent
...
trait OmitRadioButtonset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[RadioButton, Omit[RadioButton, set | typings.tabris.tabrisStrings.jsxAttributes]]) with AnonChildrenString = js.native
