...
/* Inlined tabris.tabris.Omit<tabris.tabris.Popover, 'set'> */
@js.native
trait OmitPopoverset extends js.Object {
  ...
  @JSName("close")
  var close_Original: js.Function0[Popover] = js.native
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[Popover, Omit[Popover, set]]], js.Any] = js.native
  var contentView: ContentView_[Widget] = js.native
  ...
  var jsxAttributes: (JSXAttributes[Popover, Omit[Popover, set | typings.tabris.tabrisStrings.jsxAttributes]]) with Anon2 = js.native
  @JSName("off")
  ...
  var onAnchorChanged: ChangeListeners[Popover, anchor] = js.native
  var onClose: Listeners[EventObject[Popover]] = js.native
  var onHeightChanged: ChangeListeners[Popover, height] = js.native
  var onWidthChanged: ChangeListeners[Popover, width] = js.native
  @JSName("on")
  ...
  @JSName("open")
  var open_Original: js.Function0[Popover] = js.native
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Popover]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Popover] = js.native
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Popover = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): Popover = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Popover = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): Popover = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Popover = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): Popover = js.native
  def open(): Popover = js.native
  def trigger(`type`: String): Popover = js.native
  def triggerAsync(`type`: String): js.Promise[Popover] = js.native
}
