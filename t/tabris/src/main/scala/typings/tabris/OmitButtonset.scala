...
import typings.tabris.mod.Button
...
trait OmitButtonset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[Button, Omit[Button, set | typings.tabris.tabrisStrings.jsxAttributes]]) with AnonChildrenString = js.native
