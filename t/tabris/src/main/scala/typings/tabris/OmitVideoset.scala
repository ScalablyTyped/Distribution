...
import typings.tabris.mod.Video
...
trait OmitVideoset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[Video, Omit[Video, set | typings.tabris.tabrisStrings.jsxAttributes]]) with js.Object = js.native
