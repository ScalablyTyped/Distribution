...
@js.native
trait OmitWidgetsetCenterY extends js.Object {
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], Tab] = js.native
  ...
  @JSName("detach")
  var detach_Original: js.Function0[Tab] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, Tab] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, Tab] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: JSXAttributes[Tab, Omit[Tab, set | typings.tabris.tabrisStrings.jsxAttributes]] = js.native
  ...
  var onBackgroundChanged: ChangeListeners[Tab, background] = js.native
  var onBaselineChanged: ChangeListeners[Tab, baseline] = js.native
  var onBottomChanged: ChangeListeners[Tab, bottom] = js.native
  var onBoundsChanged: ChangeListeners[Tab, bounds] = js.native
  var onCenterXChanged: ChangeListeners[Tab, centerX] = js.native
  var onCenterYChanged: ChangeListeners[Tab, centerY] = js.native
  var onClassChanged: ChangeListeners[Tab, `class`] = js.native
  var onClassListChanged: ChangeListeners[Tab, classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[Tab, cornerRadius] = js.native
  var onDispose: Listeners[EventObject[Tab]] = js.native
  var onElevationChanged: ChangeListeners[Tab, elevation] = js.native
  var onEnabledChanged: ChangeListeners[Tab, enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[Tab, excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[Tab, height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[Tab, highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[Tab, id] = js.native
  var onLayoutDataChanged: ChangeListeners[Tab, layoutData] = js.native
  var onLeftChanged: ChangeListeners[Tab, left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[Tab]] = js.native
  var onOpacityChanged: ChangeListeners[Tab, opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[Tab]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[Tab]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[Tab]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[Tab]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[Tab]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[Tab]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[Tab]] = js.native
  var onResize: Listeners[WidgetResizeEvent[Tab]] = js.native
  var onRightChanged: ChangeListeners[Tab, right] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[Tab]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Tab]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[Tab]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[Tab]] = js.native
  var onTap: Listeners[WidgetTapEvent[Tab]] = js.native
  var onTopChanged: ChangeListeners[Tab, top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[Tab]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[Tab]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[Tab]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[Tab]] = js.native
  var onTransformChanged: ChangeListeners[Tab, transform] = js.native
  var onVisibleChanged: ChangeListeners[Tab, visible] = js.native
  var onWidthChanged: ChangeListeners[Tab, width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Tab]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Tab] = js.native
  ...
  def appendTo(parent: Composite[Widget]): Tab = js.native
  def detach(): Tab = js.native
  def dispose(): Unit = js.native
  def insertAfter(widget: Widget): Tab = js.native
  def insertBefore(widget: Widget): Tab = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Tab = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): Tab = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Tab = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): Tab = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): Tab = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): Tab = js.native
  def triggerAsync(`type`: String): js.Promise[Tab] = js.native
}
