...
import typings.tabris.mod.TextView
...
trait OmitTextViewset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[TextView, Omit[TextView, set | typings.tabris.tabrisStrings.jsxAttributes]]) with AnonChildren = js.native
