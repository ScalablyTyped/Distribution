...
import typings.tabris.mod.Slider
...
trait OmitSliderset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[Slider, Omit[Slider, set | typings.tabris.tabrisStrings.jsxAttributes]]) with js.Object = js.native
