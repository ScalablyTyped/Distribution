...
object FontResources {
  ...
  /**
    ...
    */
  @scala.inline
  def from[Data /* <: ResourceDataWithConfig[FontResourceValue] */](data: Data): NamedResources[Font, /* keyof Data */ String] = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(data.asInstanceOf[js.Any]).asInstanceOf[NamedResources[Font, /* keyof Data */ String]]
  /**
