...
object TextResources {
  ...
  /**
    ...
    */
  @scala.inline
  def from[Data /* <: ResourceDataWithConfig[String] */](data: Data): NamedResources[String, /* keyof Data */ String] = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(data.asInstanceOf[js.Any]).asInstanceOf[NamedResources[String, /* keyof Data */ String]]
  /**
