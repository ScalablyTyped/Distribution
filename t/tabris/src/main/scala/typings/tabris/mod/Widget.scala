...
import typings.tabris.OmitWidgetsetCid
...
class Widget protected () extends NativeObject {
  ...
  /**
    ...
    * @param index
    */
  /* protected */ def _setParent(parent: Composite[Widget]): Unit = js.native
  /* protected */ def _setParent(parent: Composite[Widget], index: Double): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def parent[Result /* <: Composite[Widget] */](selector: Selector[Composite[Widget], Result]): Result = js.native
  /**
