...
class NativeObject protected () extends js.Object {
  ...
  /**
    ...
    */
  /* protected */ def _getXMLAttributes(): js.Array[js.Tuple2[String, _]] = js.native
  /**
    * Used by `console.dirxml()` to produce part of the XML representation of this object. May be
  ...
  /**
    ...
    * @param eventType
    */
  /* protected */ def _nativeListen(eventType: String): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[this.type], _]): this.type = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[this.type], _], context: js.Object): this.type = js.native
  /**
  ...
  /**
    ...
    * @param context In the listener function, `this` will point to this object. If not present, the listener will be called in the context of this object.
    */
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[this.type], _]): this.type = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[this.type], _], context: js.Object): this.type = js.native
  /**
...
object NativeObject extends js.Object {
  /* private */ def defineChangeEvent(target: js.Object, propertyName: String): Unit = js.native
  /* private */ def defineEvent(target: js.Object, eventType: String, definition: js.Object): Unit = js.native
  /* private */ def defineEvents(target: js.Object, definitions: js.Array[js.Object]): Unit = js.native
  /* private */ def defineProperties(target: js.Object, definitions: js.Array[js.Object]): Unit = js.native
  /* private */ def defineProperty(target: js.Object, propertyName: String, definition: js.Object): Unit = js.native
  /* private */ def extend(nativeType: String): js.Function = js.native
  /* private */ def extend(nativeType: String, superType: js.Function): js.Function = js.native
}
