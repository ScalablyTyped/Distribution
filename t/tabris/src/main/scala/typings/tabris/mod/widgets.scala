...
object widgets {
  ...
  open class CollectionView[CellWidgetType /* <: Widget[Any] */] ()
    ...
    /**
      ...
      */
    @JSName("jsxAttributes")
    val jsxAttributes_CollectionView: (JSXCompositeAttributes[this.type, Any]) & PartialPickthiscellHeightCellHeight = js.native
  ...
  open class Video () extends Widget[Any] {
    ...
    /**
      ...
      */
    @JSName("jsxAttributes")
    val jsxAttributes_Video: (JSXAttributes[this.type, Omit[this.type, set | typings.tabris.tabrisStrings.jsxAttributes]]) & Children = js.native
