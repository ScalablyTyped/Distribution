...
import typings.tabris.mod.SearchAction
...
trait OmitSearchActionset extends js.Object {
  ...
  var jsxAttributes: (JSXAttributes[SearchAction, Omit[SearchAction, set | typings.tabris.tabrisStrings.jsxAttributes]]) with AnonChildrenString = js.native
