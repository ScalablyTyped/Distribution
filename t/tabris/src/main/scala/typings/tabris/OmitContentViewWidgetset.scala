...
@js.native
trait OmitContentViewWidgetset[ChildType /* <: Widget */] extends js.Object {
  @JSName("$children")
  ...
  var _apply_Original: js.Function1[
    /* properties */ StringDictionary[Properties[Widget, OmitWidgetsetAnimate[ChildType]]], 
  ...
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget], ContentView_[ChildType]] = js.native
  @JSName("append")
  var append_Original: js.Function1[/* repeated */ Widget, ContentView_[ChildType]] = js.native
  @JSName("apply")
  ...
  @JSName("detach")
  var detach_Original: js.Function0[ContentView_[ChildType]] = js.native
  @JSName("dispose")
  ...
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget, ContentView_[ChildType]] = js.native
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget, ContentView_[ChildType]] = js.native
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean] = js.native
  var jsxAttributes: (JSXAttributes[
    ContentView_[ChildType], 
    Omit[ContentView_[ChildType], set | typings.tabris.tabrisStrings.jsxAttributes]
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[ContentView_[ChildType]]] = js.native
  var onBackgroundChanged: ChangeListeners[ContentView_[ChildType], background] = js.native
  var onBaselineChanged: ChangeListeners[ContentView_[ChildType], baseline] = js.native
  var onBottomChanged: ChangeListeners[ContentView_[ChildType], bottom] = js.native
  var onBoundsChanged: ChangeListeners[ContentView_[ChildType], bounds] = js.native
  var onCenterXChanged: ChangeListeners[ContentView_[ChildType], centerX] = js.native
  var onCenterYChanged: ChangeListeners[ContentView_[ChildType], centerY] = js.native
  var onClassChanged: ChangeListeners[ContentView_[ChildType], `class`] = js.native
  var onClassListChanged: ChangeListeners[ContentView_[ChildType], classList] = js.native
  var onCornerRadiusChanged: ChangeListeners[ContentView_[ChildType], cornerRadius] = js.native
  var onDispose: Listeners[EventObject[ContentView_[ChildType]]] = js.native
  var onElevationChanged: ChangeListeners[ContentView_[ChildType], elevation] = js.native
  var onEnabledChanged: ChangeListeners[ContentView_[ChildType], enabled] = js.native
  var onExcludeFromLayoutChanged: ChangeListeners[ContentView_[ChildType], excludeFromLayout] = js.native
  var onHeightChanged: ChangeListeners[ContentView_[ChildType], height] = js.native
  var onHighlightOnTouchChanged: ChangeListeners[ContentView_[ChildType], highlightOnTouch] = js.native
  var onIdChanged: ChangeListeners[ContentView_[ChildType], id] = js.native
  var onLayoutDataChanged: ChangeListeners[ContentView_[ChildType], layoutData] = js.native
  var onLeftChanged: ChangeListeners[ContentView_[ChildType], left] = js.native
  var onLongPress: Listeners[WidgetLongPressEvent[ContentView_[ChildType]]] = js.native
  var onOpacityChanged: ChangeListeners[ContentView_[ChildType], opacity] = js.native
  var onPan: Listeners[WidgetPanEvent[ContentView_[ChildType]]] = js.native
  var onPanDown: Listeners[WidgetPanEvent[ContentView_[ChildType]]] = js.native
  var onPanHorizontal: Listeners[WidgetPanEvent[ContentView_[ChildType]]] = js.native
  var onPanLeft: Listeners[WidgetPanEvent[ContentView_[ChildType]]] = js.native
  var onPanRight: Listeners[WidgetPanEvent[ContentView_[ChildType]]] = js.native
  var onPanUp: Listeners[WidgetPanEvent[ContentView_[ChildType]]] = js.native
  var onPanVertical: Listeners[WidgetPanEvent[ContentView_[ChildType]]] = js.native
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[ContentView_[ChildType]]] = js.native
  var onResize: Listeners[WidgetResizeEvent[ContentView_[ChildType]]] = js.native
  var onRightChanged: ChangeListeners[ContentView_[ChildType], right] = js.native
  var onSwipeDown: Listeners[WidgetSwipeEvent[ContentView_[ChildType]]] = js.native
  var onSwipeLeft: Listeners[WidgetSwipeEvent[ContentView_[ChildType]]] = js.native
  var onSwipeRight: Listeners[WidgetSwipeEvent[ContentView_[ChildType]]] = js.native
  var onSwipeUp: Listeners[WidgetSwipeEvent[ContentView_[ChildType]]] = js.native
  var onTap: Listeners[WidgetTapEvent[ContentView_[ChildType]]] = js.native
  var onTopChanged: ChangeListeners[ContentView_[ChildType], top] = js.native
  var onTouchCancel: Listeners[WidgetTouchEvent[ContentView_[ChildType]]] = js.native
  var onTouchEnd: Listeners[WidgetTouchEvent[ContentView_[ChildType]]] = js.native
  var onTouchMove: Listeners[WidgetTouchEvent[ContentView_[ChildType]]] = js.native
  var onTouchStart: Listeners[WidgetTouchEvent[ContentView_[ChildType]]] = js.native
  var onTransformChanged: ChangeListeners[ContentView_[ChildType], transform] = js.native
  var onVisibleChanged: ChangeListeners[ContentView_[ChildType], visible] = js.native
  var onWidthChanged: ChangeListeners[ContentView_[ChildType], width] = js.native
  @JSName("on")
  ...
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[ContentView_[ChildType]]] = js.native
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, ContentView_[ChildType]] = js.native
  ...
  def _apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetAnimate[ChildType]]]): ContentView_[ChildType] = js.native
  ...
  def append(widgets: Widget*): ContentView_[ChildType] = js.native
  def appendTo(parent: Composite[Widget]): ContentView_[ChildType] = js.native
  @JSName("apply")
  def apply(properties: StringDictionary[Properties[Widget, OmitWidgetsetAnimate[ChildType]]]): ContentView_[ChildType] = js.native
  ...
  def detach(): ContentView_[ChildType] = js.native
  ...
  def insertAfter(widget: Widget): ContentView_[ChildType] = js.native
  def insertBefore(widget: Widget): ContentView_[ChildType] = js.native
  def isDisposed(): Boolean = js.native
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): ContentView_[ChildType] = js.native
  def off(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Unit],
    context: js.Object
  ): ContentView_[ChildType] = js.native
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ContentView_[ChildType] = js.native
  def on(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ): ContentView_[ChildType] = js.native
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], _]): ContentView_[ChildType] = js.native
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], _],
    context: js.Object
  ...
  def trigger(`type`: String): ContentView_[ChildType] = js.native
  def triggerAsync(`type`: String): js.Promise[ContentView_[ChildType]] = js.native
}
