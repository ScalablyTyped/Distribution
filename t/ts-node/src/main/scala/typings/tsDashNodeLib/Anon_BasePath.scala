...
trait Anon_BasePath extends js.Object {
  def apply(json: js.Any, host: typescriptLib.typescriptMod.tsNs.ParseConfigHost, basePath: java.lang.String): typescriptLib.typescriptMod.tsNs.ParsedCommandLine = js.native
  def apply(
    json: js.Any,
