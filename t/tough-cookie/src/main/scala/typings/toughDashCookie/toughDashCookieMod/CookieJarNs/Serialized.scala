...
trait Serialized extends js.Object {
  var cookies: js.Array[typings.toughDashCookie.toughDashCookieMod.CookieNs.Serialized]
...
object Serialized {
  @scala.inline
  def apply(
    cookies: js.Array[typings.toughDashCookie.toughDashCookieMod.CookieNs.Serialized],
