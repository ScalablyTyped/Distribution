...
object Properties {
  ...
  implicit class PropertiesOps[Self <: Properties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreation(value: Date): Self = this.set("creation", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLastAccessed(value: Date): Self = this.set("lastAccessed", value.asInstanceOf[js.Any])
    @scala.inline
