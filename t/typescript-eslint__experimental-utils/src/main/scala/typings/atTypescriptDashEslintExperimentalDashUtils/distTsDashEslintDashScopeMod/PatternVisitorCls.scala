...
import typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintDashScopePatternVisitorMod.PatternVisitor
...
class PatternVisitorCls protected () extends PatternVisitor {
  def this(options: PatternVisitorOptions, rootPattern: BaseNode, callback: PatternVisitorCallback) = this()
}
