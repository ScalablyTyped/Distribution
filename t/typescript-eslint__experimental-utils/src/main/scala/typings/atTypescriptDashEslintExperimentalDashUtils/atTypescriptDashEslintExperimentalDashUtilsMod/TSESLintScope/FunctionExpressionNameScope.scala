...
@JSImport("@typescript-eslint/experimental-utils", "TSESLintScope.FunctionExpressionNameScope")
@js.native
object FunctionExpressionNameScope
  extends TopLevel[
      ScopeConstructor with (ScopeChildConstructorWithUpperScope[
