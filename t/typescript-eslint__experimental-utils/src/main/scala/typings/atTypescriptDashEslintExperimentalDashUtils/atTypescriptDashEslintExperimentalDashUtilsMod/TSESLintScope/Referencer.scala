...
@JSImport("@typescript-eslint/experimental-utils", "TSESLintScope.Referencer")
@js.native
object Referencer
  extends TopLevel[
      Instantiable2[
        ...
        typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintDashScopeReferencerMod.Referencer[ScopeManager]
      ]
    ]
