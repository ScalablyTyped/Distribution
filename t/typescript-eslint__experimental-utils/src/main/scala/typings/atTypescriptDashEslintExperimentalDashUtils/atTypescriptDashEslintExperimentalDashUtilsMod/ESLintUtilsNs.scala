...
import typings.atTypescriptDashEslintExperimentalDashUtils.Anon_Context
...
@JSImport("@typescript-eslint/experimental-utils", "ESLintUtils")
@js.native
object ESLintUtilsNs extends js.Object {
