...
import typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintSourceCodeMod.SourceCodeNs.CursorWithCountOptions
import typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintSourceCodeMod.SourceCodeNs.CursorWithSkipOptions
...
@js.native
class SourceCodeCls protected () extends SourceCode {
...
@js.native
object SourceCode
  extends Instantiable2[/* text */ String, /* ast */ Program, SourceCode]
     with Instantiable1[/* config */ Config, SourceCode] {
