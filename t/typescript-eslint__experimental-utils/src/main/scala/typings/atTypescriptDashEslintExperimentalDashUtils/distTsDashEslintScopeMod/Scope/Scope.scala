...
trait Scope extends js.Object {
  ...
  var upper: typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintScopeMod.Scope.Scope | Null
  var variableScope: typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintScopeMod.Scope.Scope
...
object Scope {
  ...
  def apply(
    ...
    variableScope: typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintScopeMod.Scope.Scope,
    variables: js.Array[Variable],
    upper: typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintScopeMod.Scope.Scope = null
  ): Scope = {
