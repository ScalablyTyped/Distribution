...
trait Reference extends js.Object {
  var from: typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintScopeMod.Scope.Scope
...
object Reference {
  @scala.inline
  def apply(
    from: typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintScopeMod.Scope.Scope,
