...
trait Variable extends js.Object {
  ...
  var scope: typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintScopeMod.Scope.Scope
}
...
object Variable {
  ...
  def apply(
    ...
    scope: typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintScopeMod.Scope.Scope,
