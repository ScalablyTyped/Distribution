...
import typings.atTypescriptDashEslintExperimentalDashUtils.atTypescriptDashEslintExperimentalDashUtilsNumbers.`true`
import typings.atTypescriptDashEslintExperimentalDashUtils.distTsDashEslintRuleMod.RuleFix
...
trait LintMessage extends js.Object {
  ...
  var fix: js.UndefOr[RuleFix] = js.undefined
  var line: Double
  var message: String
  var nodeType: String
