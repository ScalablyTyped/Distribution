...
object twitchDashExtStrings {
  @js.native
  sealed trait CURRENT_USER extends js.Object
  ...
  @js.native
  sealed trait ready_for_review extends js.Object
  ...
  @scala.inline
  def CURRENT_USER: CURRENT_USER = "CURRENT_USER".asInstanceOf[CURRENT_USER]
  @scala.inline
  ...
  @scala.inline
  def ready_for_review: ready_for_review = "ready_for_review".asInstanceOf[ready_for_review]
  @scala.inline
