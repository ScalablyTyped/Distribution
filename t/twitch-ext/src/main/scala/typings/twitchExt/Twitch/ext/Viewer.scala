...
object Viewer {
  ...
  @scala.inline
  implicit class ViewerOps[Self <: Viewer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSubscriptionStatus(value: ViewerSubscriptionStatus): Self = this.set("subscriptionStatus", value.asInstanceOf[js.Any])
