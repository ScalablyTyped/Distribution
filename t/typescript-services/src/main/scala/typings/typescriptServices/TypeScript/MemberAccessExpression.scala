...
object MemberAccessExpression {
  ...
  @scala.inline
  implicit class MemberAccessExpressionOps[Self <: MemberAccessExpression] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStructuralEquals(value: (MemberAccessExpression, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
