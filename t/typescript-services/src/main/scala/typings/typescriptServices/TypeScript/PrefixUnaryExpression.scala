...
@js.native
trait PrefixUnaryExpression extends AST {
  
  var _nodeType: js.Any = js.native
  
  var operand: AST = js.native
  
  def structuralEquals(ast: PrefixUnaryExpression, includingPosition: Boolean): Boolean = js.native
}
object PrefixUnaryExpression {
  ...
  @scala.inline
  implicit class PrefixUnaryExpressionOps[Self <: PrefixUnaryExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOperand(value: AST): Self = this.set("operand", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStructuralEquals(value: (PrefixUnaryExpression, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
}
