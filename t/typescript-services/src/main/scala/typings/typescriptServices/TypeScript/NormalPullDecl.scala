...
object NormalPullDecl {
  ...
  @scala.inline
  implicit class NormalPullDeclOps[Self <: NormalPullDecl] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def set_rootDecl(value: RootPullDecl): Self = this.set("_rootDecl", value.asInstanceOf[js.Any])
    @scala.inline
    def setParentDecl(value: js.Any): Self = this.set("parentDecl", value.asInstanceOf[js.Any])
    @scala.inline
    def setParentPath(value: js.Any): Self = this.set("parentPath", value.asInstanceOf[js.Any])
  }
