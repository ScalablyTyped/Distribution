...
object QualifiedName {
  ...
  implicit class QualifiedNameOps[Self <: QualifiedName] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRight(value: Identifier): Self = this.set("right", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStructuralEquals(value: (QualifiedName, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
}
