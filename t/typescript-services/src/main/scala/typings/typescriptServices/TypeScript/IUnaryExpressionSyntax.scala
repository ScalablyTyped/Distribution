...
trait IUnaryExpressionSyntax extends IExpressionSyntax {
  def isUnaryExpression(): Boolean = js.native
}
...
object IUnaryExpressionSyntax {
  ...
  @scala.inline
  implicit class IUnaryExpressionSyntaxOps[Self <: IUnaryExpressionSyntax] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setIsUnaryExpression(value: () => Boolean): Self = this.set("isUnaryExpression", js.Any.fromFunction0(value))
  }
