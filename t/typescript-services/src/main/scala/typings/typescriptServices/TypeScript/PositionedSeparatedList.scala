...
object PositionedSeparatedList {
  ...
  @scala.inline
  implicit class PositionedSeparatedListOps[Self <: PositionedSeparatedList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setList(value: () => ISeparatedSyntaxList): Self = this.set("list", js.Any.fromFunction0(value))
  }
}
