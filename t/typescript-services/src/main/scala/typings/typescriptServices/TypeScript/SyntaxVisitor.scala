...
@js.native
trait SyntaxVisitor extends ISyntaxVisitor {
  
  def defaultVisit(node: ISyntaxNodeOrToken): js.Any = js.native
}
object SyntaxVisitor {
  ...
  implicit class SyntaxVisitorOps[Self <: SyntaxVisitor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultVisit(value: ISyntaxNodeOrToken => js.Any): Self = this.set("defaultVisit", js.Any.fromFunction1(value))
  }
}
