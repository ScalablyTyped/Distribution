...
@js.native
trait DeleteExpression extends AST {
  
  var expression: AST = js.native
  
  def structuralEquals(ast: DeleteExpression, includingPosition: Boolean): Boolean = js.native
}
object DeleteExpression {
  ...
  def apply(
    ...
    start: () => Double,
    structuralEquals: (DeleteExpression, Boolean) => Boolean,
    syntaxID: () => Double,
  ...
  @scala.inline
  implicit class DeleteExpressionOps[Self <: DeleteExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStructuralEquals(value: (DeleteExpression, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
}
