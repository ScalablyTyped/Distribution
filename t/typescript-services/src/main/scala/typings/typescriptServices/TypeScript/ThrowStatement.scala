...
trait ThrowStatement extends AST {
  ...
  def structuralEquals(ast: ThrowStatement, includingPosition: Boolean): Boolean = js.native
}
...
object ThrowStatement {
  ...
  implicit class ThrowStatementOps[Self <: ThrowStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStructuralEquals(value: (ThrowStatement, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
