...
object SyntaxIndenter {
  ...
  @scala.inline
  implicit class SyntaxIndenterOps[Self <: SyntaxIndenter] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setIndentMultiLineComment(value: (js.Any, js.Any, js.Any) => js.Any): Self = this.set("indentMultiLineComment", js.Any.fromFunction3(value))
    @scala.inline
    def setIndentSegment(value: js.Any => js.Any): Self = this.set("indentSegment", js.Any.fromFunction1(value))
    @scala.inline
    def setIndentSingleLineOrSkippedText(value: (js.Any, js.Any, js.Any) => js.Any): Self = this.set("indentSingleLineOrSkippedText", js.Any.fromFunction3(value))
    @scala.inline
    def setIndentTriviaList(value: ISyntaxTriviaList => ISyntaxTriviaList): Self = this.set("indentTriviaList", js.Any.fromFunction1(value))
    @scala.inline
    def setIndentWhitespace(value: (js.Any, js.Any, js.Any) => js.Any): Self = this.set("indentWhitespace", js.Any.fromFunction3(value))
    @scala.inline
    def setIndentationAmount(value: js.Any): Self = this.set("indentationAmount", value.asInstanceOf[js.Any])
    @scala.inline
    def setIndentationTrivia(value: js.Any): Self = this.set("indentationTrivia", value.asInstanceOf[js.Any])
    @scala.inline
