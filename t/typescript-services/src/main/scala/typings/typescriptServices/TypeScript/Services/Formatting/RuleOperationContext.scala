...
trait RuleOperationContext extends StObject {
  ...
  /* private */ var customContextChecks: js.Any
}
object RuleOperationContext {
  
  inline def apply(InContext: FormattingContext => Boolean, IsAny: () => Boolean, customContextChecks: js.Any): RuleOperationContext = {
  ...
  extension [Self <: RuleOperationContext](x: Self) {
    ...
    inline def setCustomContextChecks(value: js.Any): Self = StObject.set(x, "customContextChecks", value.asInstanceOf[js.Any])
