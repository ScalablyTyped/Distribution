...
trait IPrimaryExpressionSyntax extends IMemberExpressionSyntax {
  def isPrimaryExpression(): Boolean = js.native
}
...
object IPrimaryExpressionSyntax {
  ...
  @scala.inline
  implicit class IPrimaryExpressionSyntaxOps[Self <: IPrimaryExpressionSyntax] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setIsPrimaryExpression(value: () => Boolean): Self = this.set("isPrimaryExpression", js.Any.fromFunction0(value))
  }
