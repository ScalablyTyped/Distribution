...
trait IIterationStatementSyntax extends IStatementSyntax {
  ...
  def isIterationStatement(): Boolean = js.native
}
object IIterationStatementSyntax {
  ...
  @scala.inline
  implicit class IIterationStatementSyntaxOps[Self <: IIterationStatementSyntax] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsIterationStatement(value: () => Boolean): Self = this.set("isIterationStatement", js.Any.fromFunction0(value))
  }
}
