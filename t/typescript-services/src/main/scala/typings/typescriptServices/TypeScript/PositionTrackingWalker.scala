...
object PositionTrackingWalker {
  ...
  @scala.inline
  implicit class PositionTrackingWalkerOps[Self <: PositionTrackingWalker] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def set_position(value: js.Any): Self = this.set("_position", value.asInstanceOf[js.Any])
    @scala.inline
    def setPosition(value: () => Double): Self = this.set("position", js.Any.fromFunction0(value))
    @scala.inline
    def setSkip(value: ISyntaxElement => Unit): Self = this.set("skip", js.Any.fromFunction1(value))
  }
