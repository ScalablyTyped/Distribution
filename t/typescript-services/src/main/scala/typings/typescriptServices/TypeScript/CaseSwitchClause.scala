...
object CaseSwitchClause {
  ...
  @scala.inline
  implicit class CaseSwitchClauseOps[Self <: CaseSwitchClause] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStructuralEquals(value: (CaseSwitchClause, Boolean) => Boolean): Self = this.set("structuralEquals", js.Any.fromFunction2(value))
  }
}
