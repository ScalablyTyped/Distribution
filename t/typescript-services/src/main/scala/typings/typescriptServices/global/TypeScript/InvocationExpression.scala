...
class InvocationExpression protected ()
  extends typings.typescriptServices.TypeScript.InvocationExpression {
  def this(
  ...
  /* CompleteClass */
  override var argumentList: typings.typescriptServices.TypeScript.ArgumentList = js.native
  /* CompleteClass */
