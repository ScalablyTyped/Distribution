...
class CompilationSettings ()
  ...
  /* CompleteClass */
  var codeGenTarget: typings.typescriptServices.TypeScript.LanguageVersion = js.native
  ...
  /* CompleteClass */
  var moduleGenTarget: typings.typescriptServices.TypeScript.ModuleGenTarget = js.native
