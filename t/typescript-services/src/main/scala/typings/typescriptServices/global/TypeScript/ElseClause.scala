...
class ElseClause protected ()
  extends typings.typescriptServices.TypeScript.ElseClause {
  def this(statement: typings.typescriptServices.TypeScript.AST) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ElseClause, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
