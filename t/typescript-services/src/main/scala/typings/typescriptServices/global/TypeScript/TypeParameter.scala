...
class TypeParameter protected ()
  extends typings.typescriptServices.TypeScript.TypeParameter {
  def this(
    identifier: typings.typescriptServices.TypeScript.Identifier,
    constraint: typings.typescriptServices.TypeScript.Constraint
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var constraint: typings.typescriptServices.TypeScript.Constraint = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.TypeParameter, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
