...
class SourceUnit protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.SourceUnit {
  def this(
  ...
  /* CompleteClass */
  var endOfFileTokenLeadingComments: js.Array[typings.typescriptServices.TypeScript.Comment] = js.native
