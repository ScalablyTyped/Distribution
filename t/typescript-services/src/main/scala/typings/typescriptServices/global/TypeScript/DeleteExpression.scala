...
@JSGlobal("TypeScript.DeleteExpression")
@js.native
class DeleteExpression protected ()
  extends typings.typescriptServices.TypeScript.DeleteExpression {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.DeleteExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
