...
class ConditionalExpression protected ()
  extends typings.typescriptServices.TypeScript.ConditionalExpression {
  def this(
    condition: typings.typescriptServices.TypeScript.AST,
    whenTrue: typings.typescriptServices.TypeScript.AST,
    whenFalse: typings.typescriptServices.TypeScript.AST
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var whenFalse: typings.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var whenTrue: typings.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ConditionalExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
