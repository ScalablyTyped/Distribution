...
class ConditionalExpression protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.ConditionalExpression {
  def this(
  ...
  /* CompleteClass */
  var whenFalse: typings.typescriptServices.TypeScript.AST = js.native
  
  /* CompleteClass */
  var whenTrue: typings.typescriptServices.TypeScript.AST = js.native
