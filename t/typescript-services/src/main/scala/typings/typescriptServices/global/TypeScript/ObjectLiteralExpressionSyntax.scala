...
@js.native
open class ObjectLiteralExpressionSyntax protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.ObjectLiteralExpressionSyntax {
  def this(
...
object ObjectLiteralExpressionSyntax {
