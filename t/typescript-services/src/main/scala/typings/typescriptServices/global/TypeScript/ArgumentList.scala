...
class ArgumentList protected ()
  extends typings.typescriptServices.TypeScript.ArgumentList {
  def this(
    typeArgumentList: typings.typescriptServices.TypeScript.TypeArgumentList,
    _arguments: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2,
    closeParenToken: typings.typescriptServices.TypeScript.ASTSpan
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var arguments: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
  override var closeParenToken: typings.typescriptServices.TypeScript.ASTSpan = js.native
  /* CompleteClass */
  override var parent: typings.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var typeArgumentList: typings.typescriptServices.TypeScript.TypeArgumentList = js.native
  /* CompleteClass */
