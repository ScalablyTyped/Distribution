...
class ArgumentList protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.ArgumentList {
  def this(
  ...
  /* CompleteClass */
  var arguments: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  
  /* CompleteClass */
  var closeParenToken: typings.typescriptServices.TypeScript.ASTSpan = js.native
  ...
  /* CompleteClass */
  var typeArgumentList: typings.typescriptServices.TypeScript.TypeArgumentList = js.native
