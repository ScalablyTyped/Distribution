...
class HeritageClause protected ()
  extends typings.typescriptServices.TypeScript.HeritageClause {
  def this(
  ...
  /* CompleteClass */
  override var typeNames: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
