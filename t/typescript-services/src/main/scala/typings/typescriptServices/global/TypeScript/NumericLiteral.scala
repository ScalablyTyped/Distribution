...
class NumericLiteral protected ()
  extends typings.typescriptServices.TypeScript.NumericLiteral {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.NumericLiteral, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
