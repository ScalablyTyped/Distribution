...
@js.native
open class PostfixUnaryExpression protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.PostfixUnaryExpression {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.PostfixUnaryExpression, includingPosition: Boolean): Boolean = js.native
