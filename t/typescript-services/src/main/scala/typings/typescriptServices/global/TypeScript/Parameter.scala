...
open class Parameter protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.Parameter {
  def this(
    dotDotDotToken: typings.typescriptServices.TypeScript.ASTSpan,
  ...
  /* CompleteClass */
  var dotDotDotToken: typings.typescriptServices.TypeScript.ASTSpan = js.native
  ...
  /* CompleteClass */
  var questionToken: typings.typescriptServices.TypeScript.ASTSpan = js.native
