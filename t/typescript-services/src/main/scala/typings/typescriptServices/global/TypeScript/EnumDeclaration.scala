...
@js.native
open class EnumDeclaration protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.EnumDeclaration {
  def this(
  ...
  /* CompleteClass */
  var enumElements: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
