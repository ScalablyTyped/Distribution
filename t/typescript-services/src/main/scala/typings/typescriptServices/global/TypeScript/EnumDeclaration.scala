...
class EnumDeclaration protected ()
  extends typings.typescriptServices.TypeScript.EnumDeclaration {
  def this(
  ...
  /* CompleteClass */
  override var enumElements: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
