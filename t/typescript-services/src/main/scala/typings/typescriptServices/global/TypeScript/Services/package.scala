...
inline def copyDataObject(dst: js.Any, src: js.Any): js.Any = (typings.typescriptServices.global.TypeScript.Services.^.asInstanceOf[js.Dynamic].applyDynamic("copyDataObject")(dst.asInstanceOf[js.Any], src.asInstanceOf[js.Any])).asInstanceOf[js.Any]
...
inline def logInternalError(logger: typings.typescriptServices.TypeScript.ILogger, err: typings.std.Error): scala.Unit = (typings.typescriptServices.global.TypeScript.Services.^.asInstanceOf[js.Dynamic].applyDynamic("logInternalError")(logger.asInstanceOf[js.Any], err.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
