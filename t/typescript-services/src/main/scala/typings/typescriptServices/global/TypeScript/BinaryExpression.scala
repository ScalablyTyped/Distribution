...
class BinaryExpression protected ()
  extends typings.typescriptServices.TypeScript.BinaryExpression {
  def this(
    _nodeType: typings.typescriptServices.TypeScript.SyntaxKind,
    left: typings.typescriptServices.TypeScript.AST,
    right: typings.typescriptServices.TypeScript.AST
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var right: typings.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.BinaryExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
