...
@JSGlobal("TypeScript.PullFunctionExpressionDecl")
@js.native
class PullFunctionExpressionDecl protected ()
  extends typings.typescriptServices.TypeScript.PullFunctionExpressionDecl {
  def this(
  ...
  /* CompleteClass */
  override var _rootDecl: typings.typescriptServices.TypeScript.RootPullDecl = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var functionExpressionName: js.Any = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def getFunctionExpressionName(): String = js.native
  /* CompleteClass */
