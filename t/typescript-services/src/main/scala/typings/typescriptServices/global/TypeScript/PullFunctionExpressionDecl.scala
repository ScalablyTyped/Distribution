...
@js.native
open class PullFunctionExpressionDecl protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.PullFunctionExpressionDecl {
  def this(
  ...
  /* private */ /* CompleteClass */
  var functionExpressionName: Any = js.native
