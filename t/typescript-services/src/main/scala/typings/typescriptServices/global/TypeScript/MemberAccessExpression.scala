...
@js.native
class MemberAccessExpression protected ()
  extends typings.typescriptServices.TypeScript.MemberAccessExpression {
  def this(
    expression: typings.typescriptServices.TypeScript.AST,
    name: typings.typescriptServices.TypeScript.Identifier
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var name: typings.typescriptServices.TypeScript.Identifier = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.MemberAccessExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
