...
@js.native
open class MemberAccessExpression protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.MemberAccessExpression {
  def this(
  ...
  /* CompleteClass */
  var name: typings.typescriptServices.TypeScript.Identifier = js.native
