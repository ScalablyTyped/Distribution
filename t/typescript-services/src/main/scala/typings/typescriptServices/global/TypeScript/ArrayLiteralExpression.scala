...
class ArrayLiteralExpression protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.ArrayLiteralExpression {
  ...
  /* CompleteClass */
  var expressions: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
