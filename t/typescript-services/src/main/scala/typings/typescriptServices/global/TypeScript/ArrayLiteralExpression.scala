...
class ArrayLiteralExpression protected ()
  extends typings.typescriptServices.TypeScript.ArrayLiteralExpression {
  def this(expressions: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var expressions: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ArrayLiteralExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
