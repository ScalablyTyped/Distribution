...
class WithStatement protected ()
  extends typings.typescriptServices.TypeScript.WithStatement {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.WithStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
