...
class VariableDeclaration protected ()
  extends typings.typescriptServices.TypeScript.VariableDeclaration {
  def this(declarators: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var declarators: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.VariableDeclaration, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
