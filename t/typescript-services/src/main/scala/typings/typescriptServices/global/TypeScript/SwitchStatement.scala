...
class SwitchStatement protected ()
  extends typings.typescriptServices.TypeScript.SwitchStatement {
  def this(
    expression: typings.typescriptServices.TypeScript.AST,
    closeParenToken: typings.typescriptServices.TypeScript.ASTSpan,
    switchClauses: typings.typescriptServices.TypeScript.ISyntaxList2
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var switchClauses: typings.typescriptServices.TypeScript.ISyntaxList2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.SwitchStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
