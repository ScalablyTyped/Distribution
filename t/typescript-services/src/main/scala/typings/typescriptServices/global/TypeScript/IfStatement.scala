...
class IfStatement protected ()
  extends typings.typescriptServices.TypeScript.IfStatement {
  def this(
  ...
  /* CompleteClass */
  override var condition: typings.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var elseClause: typings.typescriptServices.TypeScript.ElseClause = js.native
  /* CompleteClass */
