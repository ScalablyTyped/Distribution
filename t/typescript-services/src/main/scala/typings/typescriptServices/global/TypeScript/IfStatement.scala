...
@js.native
open class IfStatement protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.IfStatement {
  def this(
    condition: typings.typescriptServices.TypeScript.AST,
    statement: typings.typescriptServices.TypeScript.AST,
    elseClause: typings.typescriptServices.TypeScript.ElseClause
  ) = this()
  ...
  /* CompleteClass */
  var condition: typings.typescriptServices.TypeScript.AST = js.native
  
  /* CompleteClass */
  var elseClause: typings.typescriptServices.TypeScript.ElseClause = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.IfStatement, includingPosition: Boolean): Boolean = js.native
