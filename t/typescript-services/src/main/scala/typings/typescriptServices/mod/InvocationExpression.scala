...
@js.native
open class InvocationExpression protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.InvocationExpression {
  def this(
  ...
  /* CompleteClass */
  var argumentList: typings.typescriptServices.TypeScript.ArgumentList = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.InvocationExpression, includingPosition: Boolean): Boolean = js.native
