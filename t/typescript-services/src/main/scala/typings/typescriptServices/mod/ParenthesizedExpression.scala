...
class ParenthesizedExpression protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.ParenthesizedExpression {
  def this(
  ...
  /* CompleteClass */
  var openParenTrailingComments: js.Array[typings.typescriptServices.TypeScript.Comment] = js.native
