...
class ParenthesizedExpression protected ()
  extends typings.typescriptServices.TypeScript.ParenthesizedExpression {
  def this(
    openParenTrailingComments: js.Array[typings.typescriptServices.TypeScript.Comment],
  ...
  /* CompleteClass */
  override var openParenTrailingComments: js.Array[typings.typescriptServices.TypeScript.Comment] = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ParenthesizedExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
