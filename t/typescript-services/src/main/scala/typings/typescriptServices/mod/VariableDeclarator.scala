...
@js.native
open class VariableDeclarator protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.VariableDeclarator {
  def this(
  ...
  /* CompleteClass */
  var equalsValueClause: typings.typescriptServices.TypeScript.EqualsValueClause = js.native
