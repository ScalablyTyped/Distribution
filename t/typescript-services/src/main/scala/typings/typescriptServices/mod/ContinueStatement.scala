...
@JSImport("typescript-services", "ContinueStatement")
@js.native
open class ContinueStatement protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.ContinueStatement {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ContinueStatement, includingPosition: Boolean): Boolean = js.native
