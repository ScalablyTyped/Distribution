...
@js.native
open class VariableStatement protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.VariableStatement {
  def this(
  ...
  /* CompleteClass */
  var declaration: typings.typescriptServices.TypeScript.VariableDeclaration = js.native
