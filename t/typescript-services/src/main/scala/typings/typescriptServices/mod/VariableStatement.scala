...
@JSImport("typescript-services", "VariableStatement")
@js.native
class VariableStatement protected ()
  extends typings.typescriptServices.TypeScript.VariableStatement {
  def this(
    modifiers: js.Array[typings.typescriptServices.TypeScript.PullElementFlags],
    declaration: typings.typescriptServices.TypeScript.VariableDeclaration
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var declaration: typings.typescriptServices.TypeScript.VariableDeclaration = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.VariableStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
