...
open class ForStatement protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.ForStatement {
  def this(
  ...
  /* CompleteClass */
  var incrementor: typings.typescriptServices.TypeScript.AST = js.native
  
  /* CompleteClass */
  var initializer: typings.typescriptServices.TypeScript.AST = js.native
