...
class ForStatement protected ()
  extends typings.typescriptServices.TypeScript.ForStatement {
  def this(
    variableDeclaration: typings.typescriptServices.TypeScript.VariableDeclaration,
    initializer: typings.typescriptServices.TypeScript.AST,
    condition: typings.typescriptServices.TypeScript.AST,
    incrementor: typings.typescriptServices.TypeScript.AST,
  ...
  /* CompleteClass */
  override var incrementor: typings.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var initializer: typings.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ForStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
