...
@JSImport("typescript-services", "FinallyClause")
@js.native
open class FinallyClause protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.FinallyClause {
  def this(block: typings.typescriptServices.TypeScript.Block) = this()
