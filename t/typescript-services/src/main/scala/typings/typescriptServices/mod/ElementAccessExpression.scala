...
@JSImport("typescript-services", "ElementAccessExpression")
@js.native
class ElementAccessExpression protected ()
  extends typings.typescriptServices.TypeScript.ElementAccessExpression {
  def this(
    expression: typings.typescriptServices.TypeScript.AST,
    argumentExpression: typings.typescriptServices.TypeScript.AST
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var argumentExpression: typings.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  override var expression: typings.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ElementAccessExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
