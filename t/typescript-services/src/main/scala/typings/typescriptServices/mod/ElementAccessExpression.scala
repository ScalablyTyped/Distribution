...
@js.native
open class ElementAccessExpression protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.ElementAccessExpression {
  def this(
  ...
  /* CompleteClass */
  var argumentExpression: typings.typescriptServices.TypeScript.AST = js.native
  
  /* CompleteClass */
  override def end(): Double = js.native
  
  /* CompleteClass */
  var expression: typings.typescriptServices.TypeScript.AST = js.native
