...
class ClassDeclaration protected ()
  extends typings.typescriptServices.TypeScript.ClassDeclaration {
  def this(
  ...
  /* CompleteClass */
  override var classElements: typings.typescriptServices.TypeScript.ISyntaxList2 = js.native
  /* CompleteClass */
  override var closeBraceToken: typings.typescriptServices.TypeScript.ASTSpan = js.native
  /* CompleteClass */
