...
@JSImport("typescript-services", "WhileStatement")
@js.native
class WhileStatement protected ()
  extends typings.typescriptServices.TypeScript.WhileStatement {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.WhileStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
