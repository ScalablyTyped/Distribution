...
@js.native
open class ReturnStatement protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.ReturnStatement {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ReturnStatement, includingPosition: Boolean): Boolean = js.native
