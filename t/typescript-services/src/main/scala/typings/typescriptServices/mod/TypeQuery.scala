...
class TypeQuery protected ()
  extends typings.typescriptServices.TypeScript.TypeQuery {
  def this(name: typings.typescriptServices.TypeScript.AST) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var name: typings.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.TypeQuery, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
