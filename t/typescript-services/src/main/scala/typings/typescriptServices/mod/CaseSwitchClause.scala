...
@js.native
class CaseSwitchClause protected ()
  extends typings.typescriptServices.TypeScript.CaseSwitchClause {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.CaseSwitchClause, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
