...
@JSImport("typescript-services", "VoidExpression")
@js.native
class VoidExpression protected ()
  extends typings.typescriptServices.TypeScript.VoidExpression {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.VoidExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
