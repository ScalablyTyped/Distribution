...
@js.native
class ObjectCreationExpression protected ()
  extends typings.typescriptServices.TypeScript.ObjectCreationExpression {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ObjectCreationExpression, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
