...
class DoStatement protected ()
  extends typings.typescriptServices.TypeScript.DoStatement {
  def this(
    statement: typings.typescriptServices.TypeScript.AST,
    whileKeyword: typings.typescriptServices.TypeScript.ASTSpan,
  ...
  /* CompleteClass */
  override var whileKeyword: typings.typescriptServices.TypeScript.ASTSpan = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.DoStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
