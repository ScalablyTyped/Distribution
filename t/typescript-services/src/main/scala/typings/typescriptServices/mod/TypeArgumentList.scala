...
class TypeArgumentList protected ()
  extends typings.typescriptServices.TypeScript.TypeArgumentList {
  ...
  /* CompleteClass */
  override var typeArguments: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
