...
@js.native
class ObjectLiteralExpression protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.ObjectLiteralExpression {
  ...
  /* CompleteClass */
  var propertyAssignments: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ObjectLiteralExpression, includingPosition: Boolean): Boolean = js.native
