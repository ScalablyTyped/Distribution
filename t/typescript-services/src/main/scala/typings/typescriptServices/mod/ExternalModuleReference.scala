...
@JSImport("typescript-services", "ExternalModuleReference")
@js.native
class ExternalModuleReference protected ()
  extends typings.typescriptServices.TypeScript.ExternalModuleReference {
  def this(stringLiteral: typings.typescriptServices.TypeScript.StringLiteral) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var stringLiteral: typings.typescriptServices.TypeScript.StringLiteral = js.native
  /* CompleteClass */
