...
@js.native
class ThrowStatement protected ()
  extends typings.typescriptServices.TypeScript.ThrowStatement {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ThrowStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
