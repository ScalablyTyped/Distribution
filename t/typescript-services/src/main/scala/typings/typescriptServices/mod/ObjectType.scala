...
class ObjectType protected ()
  ...
  /* CompleteClass */
  override var typeMembers: typings.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ObjectType, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
