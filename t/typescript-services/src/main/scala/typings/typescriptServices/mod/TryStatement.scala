...
@JSImport("typescript-services", "TryStatement")
@js.native
class TryStatement protected ()
  extends typings.typescriptServices.TypeScript.TryStatement {
  def this(
    block: typings.typescriptServices.TypeScript.Block,
    catchClause: typings.typescriptServices.TypeScript.CatchClause,
    finallyClause: typings.typescriptServices.TypeScript.FinallyClause
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var catchClause: typings.typescriptServices.TypeScript.CatchClause = js.native
  /* CompleteClass */
  override var finallyClause: typings.typescriptServices.TypeScript.FinallyClause = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.TryStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
