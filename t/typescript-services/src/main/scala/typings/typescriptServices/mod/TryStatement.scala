...
class TryStatement protected ()
  ...
  /* CompleteClass */
  var catchClause: typings.typescriptServices.TypeScript.CatchClause = js.native
  ...
  /* CompleteClass */
  var finallyClause: typings.typescriptServices.TypeScript.FinallyClause = js.native
