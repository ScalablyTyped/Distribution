...
class FunctionDeclaration protected ()
  extends typings.typescriptServices.TypeScript.FunctionDeclaration {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.FunctionDeclaration, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
