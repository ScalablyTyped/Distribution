...
@js.native
open class ForInStatement protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.ForInStatement {
  def this(
    variableDeclaration: typings.typescriptServices.TypeScript.VariableDeclaration,
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ForInStatement, includingPosition: Boolean): Boolean = js.native
  ...
  /* CompleteClass */
  var variableDeclaration: typings.typescriptServices.TypeScript.VariableDeclaration = js.native
