...
class ForInStatement protected ()
  extends typings.typescriptServices.TypeScript.ForInStatement {
  def this(
  ...
  /* CompleteClass */
  override var variableDeclaration: typings.typescriptServices.TypeScript.VariableDeclaration = js.native
  /* CompleteClass */
