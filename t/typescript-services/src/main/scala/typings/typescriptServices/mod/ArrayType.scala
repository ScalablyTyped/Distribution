...
class ArrayType protected ()
  extends typings.typescriptServices.TypeScript.ArrayType {
  def this(`type`: typings.typescriptServices.TypeScript.AST) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ArrayType, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
