...
class PositionedElement protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.PositionedElement {
  def this(
...
object PositionedElement {
  ...
  inline def create(
    ...
    element: ISyntaxElement,
    fullStart: Double
  ): typings.typescriptServices.TypeScript.PositionedElement = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(parent.asInstanceOf[js.Any], element.asInstanceOf[js.Any], fullStart.asInstanceOf[js.Any])).asInstanceOf[typings.typescriptServices.TypeScript.PositionedElement]
}
