...
class ImportDeclaration protected ()
  extends typings.typescriptServices.TypeScript.ImportDeclaration {
  def this(
    ...
    moduleReference: typings.typescriptServices.TypeScript.AST
  ) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var moduleReference: typings.typescriptServices.TypeScript.AST = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.ImportDeclaration, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
