...
class BreakStatement protected ()
  extends typings.typescriptServices.TypeScript.BreakStatement {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typings.typescriptServices.TypeScript.BreakStatement, includingPosition: Boolean): Boolean = js.native
  /* CompleteClass */
