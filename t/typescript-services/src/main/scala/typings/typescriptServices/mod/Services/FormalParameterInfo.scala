...
@JSImport("typescript-services", "Services.FormalParameterInfo")
@js.native
open class FormalParameterInfo ()
  extends StObject
     with typings.typescriptServices.TypeScript.Services.FormalParameterInfo {
