...
class MemberVariableDeclaration protected ()
  extends StObject
     with typings.typescriptServices.TypeScript.MemberVariableDeclaration {
  def this(
  ...
  /* CompleteClass */
  var variableDeclarator: typings.typescriptServices.TypeScript.VariableDeclarator = js.native
