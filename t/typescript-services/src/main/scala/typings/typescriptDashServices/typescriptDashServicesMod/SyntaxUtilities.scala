...
object SyntaxUtilities extends js.Object {
  def containsToken(list: ISyntaxList, kind: typings.typescriptDashServices.TypeScript.SyntaxKind): Boolean = js.native
  def getExportKeyword(moduleElement: IModuleElementSyntax): ISyntaxToken = js.native
  def getToken(list: ISyntaxList, kind: typings.typescriptDashServices.TypeScript.SyntaxKind): ISyntaxToken = js.native
