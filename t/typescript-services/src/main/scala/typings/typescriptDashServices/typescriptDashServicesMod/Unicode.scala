...
@js.native
class Unicode ()
  extends typings.typescriptDashServices.TypeScript.Unicode
...
object Unicode extends js.Object {
  ...
  def isIdentifierPart(code: Double, languageVersion: typings.typescriptDashServices.TypeScript.LanguageVersion): Boolean = js.native
  def isIdentifierStart(code: Double, languageVersion: typings.typescriptDashServices.TypeScript.LanguageVersion): Boolean = js.native
