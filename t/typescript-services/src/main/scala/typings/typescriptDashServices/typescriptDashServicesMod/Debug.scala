...
@js.native
class Debug ()
  extends typings.typescriptDashServices.TypeScriptNs.Debug
...
object Debug extends js.Object {
  ...
  def shouldAssert(level: typings.typescriptDashServices.TypeScriptNs.AssertionLevel): Boolean = js.native
}
