...
import typings.typescriptDashServices.Anon_EnclosingTypeWalkerState1
import typings.typescriptDashServices.Anon_IndexSigs1
import typings.typescriptDashServices.Anon_StateWhenStartedWalkingTypes1
...
class PullTypeResolutionContext protected () extends js.Object {
  ...
  def endWalkingTypes(statesWhenStartedWalkingTypes: Anon_StateWhenStartedWalkingTypes1): Unit = js.native
  ...
  def getBothKindOfIndexSignatures(includeAugmentedType1: Boolean, includeAugmentedType2: Boolean): Anon_IndexSigs1 = js.native
  ...
  def resetEnclosingTypeWalkerStates(): Anon_EnclosingTypeWalkerState1 = js.native
  def setEnclosingTypeForSymbols(symbol1: PullSymbol, symbol2: PullSymbol): Anon_EnclosingTypeWalkerState1 = js.native
  def setEnclosingTypeWalkerStates(enclosingTypeWalkerStates: Anon_EnclosingTypeWalkerState1): Unit = js.native
  ...
  def startWalkingTypes(symbol1: PullTypeSymbol, symbol2: PullTypeSymbol): Anon_StateWhenStartedWalkingTypes1 = js.native
  def swapEnclosingTypeWalkers(): Unit = js.native
  def typeCheck(): Boolean = js.native
  def walkIndexSignatureReturnTypes(indexSigs: Anon_IndexSigs1, useStringIndexSignature1: Boolean, useStringIndexSignature2: Boolean): Unit = js.native
  def walkIndexSignatureReturnTypes(
    indexSigs: Anon_IndexSigs1,
