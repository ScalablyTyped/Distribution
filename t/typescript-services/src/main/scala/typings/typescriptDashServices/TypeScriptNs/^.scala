...
object ^ extends js.Object {
  ...
  def getIDForTypeSubstitutions(instantiatingSignature: PullSignatureSymbol, typeArgumentMap: TypeArgumentMap): String = js.native
  def getIDForTypeSubstitutions(instantiatingType: PullTypeSymbol, typeArgumentMap: TypeArgumentMap): String = js.native
  ...
  def getPropertyAssignmentNameTextFromIdentifier(identifier: AST): Anon_ActualText = js.native
  ...
  def getTrimmedTextLines(comment: Comment): js.Array[String] = js.native
  def hasFlag(`val`: Double, flag: Double): Boolean = js.native
  def hasModifier(modifiers: js.Array[PullElementFlags], flag: PullElementFlags): Boolean = js.native
  ...
  def isTypesOnlyLocation(ast: AST): Boolean = js.native
  def lastParameterIsRest(parameterList: ParameterList): Boolean = js.native
  ...
  def structuralEqualsIncludingPosition(ast1: AST, ast2: AST): Boolean = js.native
  def structuralEqualsNotIncludingPosition(ast1: AST, ast2: AST): Boolean = js.native
