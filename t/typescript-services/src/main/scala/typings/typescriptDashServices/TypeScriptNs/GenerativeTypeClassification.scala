...
object GenerativeTypeClassification extends js.Object {
  ...
  /* 2 */ val Closed: typings.typescriptDashServices.TypeScriptNs.GenerativeTypeClassification.Closed with Double = js.native
  /* 3 */ val InfinitelyExpanding: typings.typescriptDashServices.TypeScriptNs.GenerativeTypeClassification.InfinitelyExpanding with Double = js.native
  /* 1 */ val Open: typings.typescriptDashServices.TypeScriptNs.GenerativeTypeClassification.Open with Double = js.native
  /* 0 */ val Unknown: typings.typescriptDashServices.TypeScriptNs.GenerativeTypeClassification.Unknown with Double = js.native
  @JSBracketAccess
