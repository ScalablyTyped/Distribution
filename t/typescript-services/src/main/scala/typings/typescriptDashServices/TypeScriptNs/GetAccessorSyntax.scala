...
- typings.typescriptDashServices.TypeScriptNs.IPropertyAssignmentSyntax because Already inherited- typings.typescriptDashServices.TypeScriptNs.IMemberDeclarationSyntax because Already inherited */ @JSGlobal("TypeScript.GetAccessorSyntax")
@js.native
