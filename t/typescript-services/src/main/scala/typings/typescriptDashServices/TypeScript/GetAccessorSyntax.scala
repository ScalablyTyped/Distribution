...
- typings.typescriptDashServices.TypeScript.IPropertyAssignmentSyntax because Already inherited
- typings.typescriptDashServices.TypeScript.IMemberDeclarationSyntax because Already inherited */ @JSGlobal("TypeScript.GetAccessorSyntax")
@js.native
