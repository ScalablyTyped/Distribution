...
import typings.typescriptDashServices.TypeScript.AST
import typings.typescriptDashServices.TypeScript.Diagnostic
import typings.typescriptDashServices.TypeScript.Document
import typings.typescriptDashServices.TypeScript.EmitOutput
import typings.typescriptDashServices.TypeScript.IScriptSnapshot
import typings.typescriptDashServices.TypeScript.ImmutableCompilationSettings
import typings.typescriptDashServices.TypeScript.PullCallSymbolInfo
import typings.typescriptDashServices.TypeScript.PullDecl
import typings.typescriptDashServices.TypeScript.PullSymbolInfo
