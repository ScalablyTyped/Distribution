...
class ModuleDeclarationSyntax protected ()
  extends typescriptDashServicesLib.TypeScriptNs.ModuleDeclarationSyntax {
  def this(modifiers: typescriptDashServicesLib.TypeScriptNs.ISyntaxList, moduleKeyword: typescriptDashServicesLib.TypeScriptNs.ISyntaxToken, name: typescriptDashServicesLib.TypeScriptNs.INameSyntax, stringLiteral: typescriptDashServicesLib.TypeScriptNs.ISyntaxToken, openBraceToken: typescriptDashServicesLib.TypeScriptNs.ISyntaxToken, moduleElements: typescriptDashServicesLib.TypeScriptNs.ISyntaxList, closeBraceToken: typescriptDashServicesLib.TypeScriptNs.ISyntaxToken, parsedInStrictMode: scala.Boolean) = this()
}
