...
class RulesMap () extends js.Object {
  ...
  var mapRowLength: scala.Double = js.native
  /* private */ def FillRule(rule: js.Any, rulesBucketConstructionStateList: js.Any): js.Any = js.native
  def FillRules(rules: js.Array[Rule], rulesBucketConstructionStateList: js.Array[RulesBucketConstructionState]): scala.Unit = js.native
