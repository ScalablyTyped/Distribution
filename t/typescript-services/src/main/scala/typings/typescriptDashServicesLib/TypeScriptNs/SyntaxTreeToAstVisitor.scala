...
class SyntaxTreeToAstVisitor protected () extends ISyntaxVisitor {
  def this(fileName: java.lang.String, lineMap: LineMap, compilationSettings: ImmutableCompilationSettings) = this()
  ...
  def createTokenSpan(fullStart: scala.Double, element: ISyntaxToken): ASTSpan = js.native
  /* private */ def mergeComments(comments1: js.Any, comments2: js.Any): js.Any = js.native
  def movePast(element: ISyntaxElement): scala.Unit = js.native
  ...
  def setSpan(span: AST, fullStart: scala.Double, element: ISyntaxElement): scala.Unit = js.native
  def setSpan(span: AST, fullStart: scala.Double, element: ISyntaxElement, firstToken: ISyntaxToken): scala.Unit = js.native
  def setSpan(
    span: AST,
  ...
  def setSpanExplicit(span: IASTSpan, start: scala.Double, end: scala.Double): scala.Unit = js.native
  /* CompleteClass */
