...
class ConditionalExpressionSyntax protected ()
  ...
  def this(condition: IExpressionSyntax, questionToken: ISyntaxToken, whenTrue: IExpressionSyntax, colonToken: ISyntaxToken, whenFalse: IExpressionSyntax, parsedInStrictMode: scala.Boolean) = this()
