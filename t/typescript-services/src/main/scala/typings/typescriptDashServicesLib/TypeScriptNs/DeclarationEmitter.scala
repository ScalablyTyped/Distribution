...
class DeclarationEmitter protected () extends js.Object {
  def this(emittingFileName: java.lang.String, document: Document, compiler: TypeScriptCompiler, emitOptions: EmitOptions, semanticInfoChain: SemanticInfoChain) = this()
  ...
  def emitDeclarations(sourceUnit: SourceUnit): scala.Unit = js.native
...
object DeclarationEmitter extends js.Object {
  def getEnclosingContainer(ast: typescriptDashServicesLib.TypeScriptNs.AST): typescriptDashServicesLib.TypeScriptNs.AST = js.native
}
