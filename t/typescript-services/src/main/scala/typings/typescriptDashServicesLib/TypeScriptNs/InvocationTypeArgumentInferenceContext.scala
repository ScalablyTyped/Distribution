...
class InvocationTypeArgumentInferenceContext protected () extends TypeArgumentInferenceContext {
  def this(resolver: PullTypeResolver, context: PullTypeResolutionContext, signatureBeingInferred: PullSignatureSymbol, argumentASTs: ISeparatedSyntaxList2) = this()
