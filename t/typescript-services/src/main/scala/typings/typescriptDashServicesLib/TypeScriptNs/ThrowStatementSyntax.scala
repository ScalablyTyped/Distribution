...
class ThrowStatementSyntax protected ()
  ...
  def this(throwKeyword: ISyntaxToken, expression: IExpressionSyntax, semicolonToken: ISyntaxToken, parsedInStrictMode: scala.Boolean) = this()
...
object ThrowStatementSyntax extends js.Object {
  def create1(expression: typescriptDashServicesLib.TypeScriptNs.IExpressionSyntax): typescriptDashServicesLib.TypeScriptNs.ThrowStatementSyntax = js.native
}
