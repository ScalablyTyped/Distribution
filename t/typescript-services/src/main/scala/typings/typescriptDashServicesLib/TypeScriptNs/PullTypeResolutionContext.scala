...
class PullTypeResolutionContext protected () extends js.Object {
  ...
  def endWalkingTypes(statesWhenStartedWalkingTypes: typescriptDashServicesLib.Anon_StateWhenStartedWalkingTypes1): scala.Unit = js.native
  ...
  def getBothKindOfIndexSignatures(includeAugmentedType1: scala.Boolean, includeAugmentedType2: scala.Boolean): typescriptDashServicesLib.Anon_IndexSigs1 = js.native
  ...
  def resetEnclosingTypeWalkerStates(): typescriptDashServicesLib.Anon_EnclosingTypeWalkerState1 = js.native
  def setEnclosingTypeForSymbols(symbol1: PullSymbol, symbol2: PullSymbol): typescriptDashServicesLib.Anon_EnclosingTypeWalkerState1 = js.native
  def setEnclosingTypeWalkerStates(enclosingTypeWalkerStates: typescriptDashServicesLib.Anon_EnclosingTypeWalkerState1): scala.Unit = js.native
  ...
  def startWalkingTypes(symbol1: PullTypeSymbol, symbol2: PullTypeSymbol): typescriptDashServicesLib.Anon_StateWhenStartedWalkingTypes1 = js.native
  def swapEnclosingTypeWalkers(): scala.Unit = js.native
  def typeCheck(): scala.Boolean = js.native
  def walkIndexSignatureReturnTypes(
    indexSigs: typescriptDashServicesLib.Anon_IndexSigs1,
