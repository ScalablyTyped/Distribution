...
class PullTypeResolver protected () extends js.Object {
  ...
  def _getBothKindsOfIndexSignatures(
    enclosingType: PullTypeSymbol,
    context: PullTypeResolutionContext,
    includeAugmentedType: scala.Boolean
  ): IndexSignatureInfo = js.native
  def _getNamedPropertySymbolOfAugmentedType(symbolName: java.lang.String, parent: PullTypeSymbol): PullSymbol = js.native
  ...
  def getNewErrorTypeSymbol(name: java.lang.String): PullErrorTypeSymbol = js.native
  ...
  def resolveAST(ast: AST, isContextuallyTyped: scala.Boolean, context: PullTypeResolutionContext): PullSymbol = js.native
  ...
  def resolveObjectLiteralExpression(
    ...
    isContextuallyTyped: scala.Boolean,
    context: PullTypeResolutionContext
  ): PullSymbol = js.native
  def resolveObjectLiteralExpression(
    expressionAST: ObjectLiteralExpression,
  ...
  def signatureReturnTypesAreIdentical(s1: PullSignatureSymbol, s2: PullSignatureSymbol, context: PullTypeResolutionContext): scala.Boolean = js.native
  ...
  def signaturesAreIdenticalWithNewEnclosingTypes(s1: PullSignatureSymbol, s2: PullSignatureSymbol, context: PullTypeResolutionContext): scala.Boolean = js.native
  def signaturesAreIdenticalWithNewEnclosingTypes(
    s1: PullSignatureSymbol,
    s2: PullSignatureSymbol,
    context: PullTypeResolutionContext,
    includingReturnType: scala.Boolean
  ): scala.Boolean = js.native
  def signaturesAreIdenticalWorker(s1: PullSignatureSymbol, s2: PullSignatureSymbol, context: PullTypeResolutionContext): scala.Boolean = js.native
  ...
  def typesAreIdentical(t1: PullTypeSymbol, t2: PullTypeSymbol, context: PullTypeResolutionContext): scala.Boolean = js.native
