...
class InterfaceDeclaration protected () extends AST {
  def this(modifiers: js.Array[PullElementFlags], identifier: Identifier, typeParameterList: TypeParameterList, heritageClauses: ISyntaxList2, body: ObjectType) = this()
  ...
  def structuralEquals(ast: InterfaceDeclaration, includingPosition: scala.Boolean): scala.Boolean = js.native
}
