...
class ArgumentListSyntax protected () extends SyntaxNode {
  def this(typeArgumentList: TypeArgumentListSyntax, openParenToken: ISyntaxToken, _arguments: ISeparatedSyntaxList, closeParenToken: ISyntaxToken, parsedInStrictMode: scala.Boolean) = this()
...
object ArgumentListSyntax extends js.Object {
  ...
  def create1(): typescriptDashServicesLib.TypeScriptNs.ArgumentListSyntax = js.native
}
