...
class SyntaxWalker () extends ISyntaxVisitor {
  ...
  def visitList(list: ISyntaxList): scala.Unit = js.native
  /* CompleteClass */
  ...
  def visitNode(node: SyntaxNode): scala.Unit = js.native
  def visitNodeOrToken(nodeOrToken: ISyntaxNodeOrToken): scala.Unit = js.native
  /* CompleteClass */
  ...
  def visitOptionalNode(node: SyntaxNode): scala.Unit = js.native
  def visitOptionalNodeOrToken(nodeOrToken: ISyntaxNodeOrToken): scala.Unit = js.native
  ...
  def visitSeparatedList(list: ISeparatedSyntaxList): scala.Unit = js.native
  /* CompleteClass */
