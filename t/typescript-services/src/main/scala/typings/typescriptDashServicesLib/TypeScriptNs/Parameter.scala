...
class Parameter protected () extends AST {
  def this(dotDotDotToken: ASTSpan, modifiers: js.Array[PullElementFlags], identifier: Identifier, questionToken: ASTSpan, typeAnnotation: TypeAnnotation, equalsValueClause: EqualsValueClause) = this()
