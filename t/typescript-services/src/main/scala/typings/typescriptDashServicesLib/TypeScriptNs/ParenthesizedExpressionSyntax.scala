...
class ParenthesizedExpressionSyntax protected ()
  ...
  def this(openParenToken: ISyntaxToken, expression: IExpressionSyntax, closeParenToken: ISyntaxToken, parsedInStrictMode: scala.Boolean) = this()
...
object ParenthesizedExpressionSyntax extends js.Object {
  def create1(expression: typescriptDashServicesLib.TypeScriptNs.IExpressionSyntax): typescriptDashServicesLib.TypeScriptNs.ParenthesizedExpressionSyntax = js.native
}
