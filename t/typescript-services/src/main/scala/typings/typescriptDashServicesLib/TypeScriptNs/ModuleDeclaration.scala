...
class ModuleDeclaration protected () extends AST {
  def this(modifiers: js.Array[PullElementFlags], name: AST, stringLiteral: StringLiteral, moduleElements: ISyntaxList2, endingToken: ASTSpan) = this()
  ...
  def structuralEquals(ast: ModuleDeclaration, includingPosition: scala.Boolean): scala.Boolean = js.native
}
