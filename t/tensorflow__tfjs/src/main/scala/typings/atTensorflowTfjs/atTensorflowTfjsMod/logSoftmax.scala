...
object logSoftmax extends js.Object {
  ...
  def apply[T /* <: typings.atTensorflowTfjsDashCore.distTensorMod.Tensor[typings.atTensorflowTfjsDashCore.distTypesMod.Rank] */](logits: T, axis: Double): T = js.native
  ...
  def apply[T /* <: typings.atTensorflowTfjsDashCore.distTensorMod.Tensor[typings.atTensorflowTfjsDashCore.distTypesMod.Rank] */](logits: TensorLike, axis: Double): T = js.native
}
