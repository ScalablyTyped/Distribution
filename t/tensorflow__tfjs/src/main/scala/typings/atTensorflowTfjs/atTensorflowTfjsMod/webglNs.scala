...
object webglNs extends js.Object {
  @js.native
  class GPGPUContext ()
    extends typings.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreMod.webglNs.GPGPUContext {
    def this(gl: WebGLRenderingContext) = this()
  }
  
  @js.native
  class MathBackendWebGL ()
    extends typings.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreMod.webglNs.MathBackendWebGL {
