...
object serialization extends js.Object {
  ...
  abstract class Serializable ()
    extends typings.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreMod.serialization.Serializable
  
  @js.native
  class SerializationMap protected ()
    extends typings.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreMod.serialization.SerializationMap
