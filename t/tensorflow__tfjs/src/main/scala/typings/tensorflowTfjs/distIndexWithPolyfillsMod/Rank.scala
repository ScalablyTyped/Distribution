...
@JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "Rank")
@js.native
object Rank extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typings.tensorflowTfjsCore.distTypesMod.Rank & String] = js.native
