...
import typings.tensorflowTfjs.tensorflowTfjsInts.`1`
import typings.tensorflowTfjs.tensorflowTfjsInts.`2`
...
object webglUtil {
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "webgl_util")
  @js.native
