...
object shared {
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.addImpl")
  @js.native
  ...
  inline def bincountReduceImpl_float32[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */](
    xBuf: typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32],
    weightsBuf: typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32],
    size: Double
  ): typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32] = (^.asInstanceOf[js.Dynamic].applyDynamic("bincountReduceImpl")(xBuf.asInstanceOf[js.Any], weightsBuf.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32]]
  inline def bincountReduceImpl_float32[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */](
    xBuf: typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32],
    weightsBuf: typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32],
    size: Double,
    binaryOutput: Boolean
  ): typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32] = (^.asInstanceOf[js.Dynamic].applyDynamic("bincountReduceImpl")(xBuf.asInstanceOf[js.Any], weightsBuf.asInstanceOf[js.Any], size.asInstanceOf[js.Any], binaryOutput.asInstanceOf[js.Any])).asInstanceOf[typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32]]
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.bitwiseAndImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.ceilImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.equalImpl")
  @js.native
  val equalImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.expImpl")
  @js.native
  val expImpl: SimpleUnaryImpl[Double, Double] = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.expm1Impl")
  @js.native
  val expm1Impl: SimpleUnaryImpl[Double, Double] = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.floorDivImpl")
  @js.native
  val floorDivImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.floorImpl")
  @js.native
  val floorImpl: SimpleUnaryImpl[Double, Double] = js.native
  
  inline def gatherNdImpl_float32[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */](
    indicesData: TypedArray,
    paramsBuf: typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32],
    dtype: DataType,
    numSlices: Double,
    sliceRank: Double,
    sliceSize: Double,
    ...
    paramsSize: Double
  ): typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32] = (^.asInstanceOf[js.Dynamic].applyDynamic("gatherNdImpl")(indicesData.asInstanceOf[js.Any], paramsBuf.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any], numSlices.asInstanceOf[js.Any], sliceRank.asInstanceOf[js.Any], sliceSize.asInstanceOf[js.Any], strides.asInstanceOf[js.Any], paramsShape.asInstanceOf[js.Any], paramsSize.asInstanceOf[js.Any])).asInstanceOf[typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32]]
  
  inline def gatherV2Impl[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */, D /* <: DataType */](
    xBuf: typings.tensorflowTfjsCore.mod.TensorBuffer[R, D],
    indicesBuf: typings.tensorflowTfjsCore.mod.TensorBuffer[R, D],
    flattenOutputShape: js.Array[Double]
  ): typings.tensorflowTfjsCore.mod.TensorBuffer[R, D] = (^.asInstanceOf[js.Dynamic].applyDynamic("gatherV2Impl")(xBuf.asInstanceOf[js.Any], indicesBuf.asInstanceOf[js.Any], flattenOutputShape.asInstanceOf[js.Any])).asInstanceOf[typings.tensorflowTfjsCore.mod.TensorBuffer[R, D]]
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.greaterEqualImpl")
  @js.native
  val greaterEqualImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.greaterImpl")
  @js.native
  val greaterImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.lessEqualImpl")
  @js.native
  val lessEqualImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.lessImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.logImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.maximumImpl")
  @js.native
  val maximumImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.minimumImpl")
  @js.native
  val minimumImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.multiplyImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.notEqualImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.rsqrtImpl")
  @js.native
  val rsqrtImpl: SimpleUnaryImpl[Double, Double] = js.native
  
  inline def scatterImpl_int32[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */, D /* <: float32 | int32 | bool | typings.tensorflowTfjs.tensorflowTfjsStrings.string */](
    indices: typings.tensorflowTfjsCore.mod.TensorBuffer[R, int32],
    updates: typings.tensorflowTfjsCore.mod.TensorBuffer[R, D],
  ...
  ): typings.tensorflowTfjsCore.mod.TensorBuffer[R, D] = (^.asInstanceOf[js.Dynamic].applyDynamic("scatterImpl")(indices.asInstanceOf[js.Any], updates.asInstanceOf[js.Any], shape.asInstanceOf[js.Any], outputSize.asInstanceOf[js.Any], sliceSize.asInstanceOf[js.Any], numUpdates.asInstanceOf[js.Any], sliceRank.asInstanceOf[js.Any], strides.asInstanceOf[js.Any], defaultValue.asInstanceOf[js.Any], sumDupeIndices.asInstanceOf[js.Any])).asInstanceOf[typings.tensorflowTfjsCore.mod.TensorBuffer[R, D]]
  inline def scatterImpl_int32[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */, D /* <: float32 | int32 | bool | typings.tensorflowTfjs.tensorflowTfjsStrings.string */](
    indices: typings.tensorflowTfjsCore.mod.TensorBuffer[R, int32],
    updates: typings.tensorflowTfjsCore.mod.TensorBuffer[R, D],
    shape: js.Array[Double],
    ...
    sliceRank: Double,
    strides: js.Array[Double],
    defaultValue: typings.tensorflowTfjsCore.mod.TensorBuffer[R, D],
    sumDupeIndices: Boolean
  ): typings.tensorflowTfjsCore.mod.TensorBuffer[R, D] = (^.asInstanceOf[js.Dynamic].applyDynamic("scatterImpl")(indices.asInstanceOf[js.Any], updates.asInstanceOf[js.Any], shape.asInstanceOf[js.Any], outputSize.asInstanceOf[js.Any], sliceSize.asInstanceOf[js.Any], numUpdates.asInstanceOf[js.Any], sliceRank.asInstanceOf[js.Any], strides.asInstanceOf[js.Any], defaultValue.asInstanceOf[js.Any], sumDupeIndices.asInstanceOf[js.Any])).asInstanceOf[typings.tensorflowTfjsCore.mod.TensorBuffer[R, D]]
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.sigmoidImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.sqrtImpl")
  @js.native
  val sqrtImpl: SimpleUnaryImpl[Double, Double] = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.squaredDifferenceImpl")
  @js.native
  val squaredDifferenceImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.staticRegexReplaceImpl")
  @js.native
  val staticRegexReplaceImpl: SimpleUnaryImpl[String, String] = js.native
  
  inline def stridedSliceImpl_float32[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */](
    outShape: js.Array[Double],
    xBuf: typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32],
    strides: js.Array[Double],
    begin: js.Array[Double]
  ): typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32] = (^.asInstanceOf[js.Dynamic].applyDynamic("stridedSliceImpl")(outShape.asInstanceOf[js.Any], xBuf.asInstanceOf[js.Any], strides.asInstanceOf[js.Any], begin.asInstanceOf[js.Any])).asInstanceOf[typings.tensorflowTfjsCore.mod.TensorBuffer[R, float32]]
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "shared.subImpl")
  @js.native
  val subImpl: SimpleBinaryKernelImpl = js.native
  
  inline def tileImpl[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */](xBuf: typings.tensorflowTfjsCore.mod.TensorBuffer[R, DataType], reps: js.Array[Double]): typings.tensorflowTfjsCore.mod.TensorBuffer[R, DataType] = (^.asInstanceOf[js.Dynamic].applyDynamic("tileImpl")(xBuf.asInstanceOf[js.Any], reps.asInstanceOf[js.Any])).asInstanceOf[typings.tensorflowTfjsCore.mod.TensorBuffer[R, DataType]]
  
  inline def topKImpl[T /* <: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank] */, R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */](x: TypedArray, xShape: js.Array[Double], xDtype: NumericDataType, k: Double, sorted: Boolean): js.Tuple2[
    typings.tensorflowTfjsCore.mod.TensorBuffer[R, NumericDataType], 
    typings.tensorflowTfjsCore.mod.TensorBuffer[R, int32]
  ] = (^.asInstanceOf[js.Dynamic].applyDynamic("topKImpl")(x.asInstanceOf[js.Any], xShape.asInstanceOf[js.Any], xDtype.asInstanceOf[js.Any], k.asInstanceOf[js.Any], sorted.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[
    typings.tensorflowTfjsCore.mod.TensorBuffer[R, NumericDataType], 
    typings.tensorflowTfjsCore.mod.TensorBuffer[R, int32]
  ]]
