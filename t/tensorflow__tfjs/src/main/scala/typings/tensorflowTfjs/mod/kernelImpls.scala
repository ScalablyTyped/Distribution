...
object kernelImpls extends js.Object {
  ...
  def tile[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */](xBuf: typings.tensorflowTfjsCore.tensorMod.TensorBuffer[R, DataType], reps: js.Array[Double]): Tensor[R] = js.native
