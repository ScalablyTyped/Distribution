...
object layers {
  ...
  object Layer {
    ...
    /**
      ...
      */
    @JSImport("@tensorflow/tfjs", "layers.Layer.nodeKey")
    @js.native
    def nodeKey(layer: typings.tensorflowTfjsLayers.topologyMod.Layer, nodeIndex: Double): String = js.native
  }
  
  @JSImport("@tensorflow/tfjs", "layers.RNNCell")
  @js.native
  abstract class RNNCell ()
    extends typings.tensorflowTfjsLayers.mod.layers.RNNCell {
    def this(args: LayerArgs) = this()
  }
  ...
  class RNN_ protected ()
    extends typings.tensorflowTfjsLayers.mod.layers.RNN_ {
  ...
  @JSImport("@tensorflow/tfjs", "layers.add")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "layers.alphaDropout")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "layers.bidirectional")
  @js.native
  def bidirectional(args: BidirectionalLayerArgs): Bidirectional = js.native
  
  @JSImport("@tensorflow/tfjs", "layers.concatenate")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "layers.elu")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "layers.gaussianDropout")
  @js.native
  def gaussianDropout(args: GaussianDropoutArgs): GaussianDropout = js.native
  
  @JSImport("@tensorflow/tfjs", "layers.gaussianNoise")
  @js.native
  def gaussianNoise(args: GaussianNoiseArgs): GaussianNoise = js.native
  
  @JSImport("@tensorflow/tfjs", "layers.globalAveragePooling1d")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "layers.globalAveragePooling2d")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "layers.globalMaxPooling1d")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "layers.inputLayer")
  @js.native
  def inputLayer(args: InputLayerArgs): typings.tensorflowTfjsLayers.topologyMod.Layer = js.native
  
  @JSImport("@tensorflow/tfjs", "layers.layerNormalization")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "layers.leakyReLU")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "layers.minimum")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "layers.multiply")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "layers.reLU")
  @js.native
