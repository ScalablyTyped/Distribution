...
object util {
  ...
  @JSImport("@tensorflow/tfjs", "util.bytesFromStringArray")
  @js.native
  def bytesFromStringArray(arr: js.Array[Uint8Array]): Double = js.native
  
  @JSImport("@tensorflow/tfjs", "util.bytesPerElement")
  @js.native
  def bytesPerElement(dtype: DataType): Double = js.native
  
  @JSImport("@tensorflow/tfjs", "util.checkConversionForErrors")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "util.distSquared")
  @js.native
  def distSquared(a: FlatVector, b: FlatVector): Double = js.native
  
  @JSImport("@tensorflow/tfjs", "util.encodeString")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "util.fetch")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "util.flatten")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "util.getArrayFromDType")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "util.getTypedArrayFromDType")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "util.makeZerosNestedTypedArray")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "util.makeZerosTypedArray")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "util.nearestDivisor")
  @js.native
  def nearestDivisor(size: Double, start: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs", "util.nearestLargerEven")
  @js.native
  def nearestLargerEven(`val`: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs", "util.now")
  @js.native
  def now(): Double = js.native
  
  @JSImport("@tensorflow/tfjs", "util.parseAxisParam")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "util.randUniform")
  @js.native
  def randUniform(a: Double, b: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs", "util.repeatedTry")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "util.rightPad")
  @js.native
  def rightPad(a: String, size: Double): String = js.native
  
  @JSImport("@tensorflow/tfjs", "util.shuffle")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "util.sizeFromShape")
  @js.native
  def sizeFromShape(shape: js.Array[Double]): Double = js.native
  
  @JSImport("@tensorflow/tfjs", "util.sizeToSquarishShape")
  @js.native
  def sizeToSquarishShape(size: Double): js.Tuple2[Double, Double] = js.native
  
  @JSImport("@tensorflow/tfjs", "util.squeezeShape")
  @js.native
