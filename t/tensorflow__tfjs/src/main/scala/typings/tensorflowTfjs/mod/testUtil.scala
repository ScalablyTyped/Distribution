...
object testUtil {
  ...
  @JSImport("@tensorflow/tfjs", "test_util.expectArrayBuffersEqual")
  @js.native
  def expectArrayBuffersEqual(actual: ArrayBuffer, expected: ArrayBuffer): Unit = js.native
  
  @JSImport("@tensorflow/tfjs", "test_util.expectArraysClose")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "test_util.expectArraysEqual")
  @js.native
  def expectArraysEqual(actual: TensorLike, expected: TensorLike): Unit = js.native
  
  @JSImport("@tensorflow/tfjs", "test_util.expectNumbersClose")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "test_util.expectPromiseToFail")
  @js.native
  def expectPromiseToFail(fn: js.Function0[js.Promise[js.Object]], done: DoneFn): Unit = js.native
  
  @JSImport("@tensorflow/tfjs", "test_util.expectValuesInRange")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs", "test_util.testEpsilon")
  @js.native
