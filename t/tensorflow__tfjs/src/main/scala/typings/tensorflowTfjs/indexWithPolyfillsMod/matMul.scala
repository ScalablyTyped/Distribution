...
object matMul extends js.Object {
  ...
  def apply[T /* <: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank] */](a: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank], b: TensorLike, transposeA: Boolean): T = js.native
  def apply[T /* <: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank] */](
    a: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank],
    b: TensorLike,
    transposeA: Boolean,
  ...
  def apply[T /* <: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank] */](a: TensorLike, b: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank], transposeA: Boolean): T = js.native
  def apply[T /* <: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank] */](
    a: TensorLike,
    b: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank],
    transposeA: Boolean,
