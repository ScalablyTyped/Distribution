...
object serialization {
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "serialization.Serializable")
  @js.native
  ...
  object Serializable {
    ...
    /**
      ...
      */
    /** @nocollapse */
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "serialization.Serializable.fromConfig")
    @js.native
  ...
  object SerializationMap {
    ...
    /**
      ...
      */
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "serialization.SerializationMap.getMap")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "serialization.SerializationMap.register")
    @js.native
    def register[T /* <: typings.tensorflowTfjsCore.serializationMod.Serializable */](cls: SerializableConstructor[T]): Unit = js.native
  }
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "serialization.registerClass")
  @js.native
