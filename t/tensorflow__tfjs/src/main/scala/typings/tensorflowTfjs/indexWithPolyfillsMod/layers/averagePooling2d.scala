...
@JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "layers.averagePooling2d")
@js.native
object averagePooling2d extends js.Object {
  def apply(args: Pooling2DLayerArgs): typings.tensorflowTfjsLayers.topologyMod.Layer = js.native
}
