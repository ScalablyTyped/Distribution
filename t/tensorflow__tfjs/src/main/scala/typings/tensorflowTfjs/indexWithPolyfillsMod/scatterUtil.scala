...
object scatterUtil {
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "scatter_util.calculateShapes")
  @js.native
  def calculateShapes(updates: TensorInfo, indices: TensorInfo, shape: js.Array[Double]): ScatterShapeInfo = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "scatter_util.validateInput")
  @js.native
  def validateInput(
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "scatter_util.validateUpdateShape")
  @js.native
