...
object sliceUtil {
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.assertParamsValid")
  @js.native
  def assertParamsValid(input: TensorInfo, begin: js.Array[Double], size: js.Array[Double]): Unit = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.computeFlatOffset")
  @js.native
  def computeFlatOffset(begin: js.Array[Double], strides: js.Array[Double]): Double = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.computeOutShape")
  @js.native
  def computeOutShape(begin: js.Array[Double], end: js.Array[Double], strides: js.Array[Double]): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.getNormalizedAxes")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.isSliceContinous")
  @js.native
  def isSliceContinous(shape: js.Array[Double], begin: js.Array[Double], size: js.Array[Double]): Boolean = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.maskToAxes")
  @js.native
  def maskToAxes(mask: Double): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.parseSliceParams")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.startForAxis")
  @js.native
  def startForAxis(
    beginMask: Double,
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.startIndicesWithElidedDims")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.stopForAxis")
  @js.native
  def stopForAxis(
    endMask: Double,
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.stopIndicesWithElidedDims")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.stridesForAxis")
  @js.native
  def stridesForAxis(strides: js.Array[Double], axis: Double, ellipsisMask: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "slice_util.stridesWithElidedDims")
  @js.native
