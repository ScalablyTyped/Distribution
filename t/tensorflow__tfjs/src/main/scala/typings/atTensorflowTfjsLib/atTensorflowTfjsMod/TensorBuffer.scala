...
@js.native
class TensorBuffer[R /* <: atTensorflowTfjsDashCoreLib.distTypesMod.Rank */, D /* <: atTensorflowTfjsDashCoreLib.distTypesMod.DataType */] protected ()
  extends atTensorflowTfjsDashCoreLib.atTensorflowTfjsDashCoreMod.TensorBuffer[R, D] {
