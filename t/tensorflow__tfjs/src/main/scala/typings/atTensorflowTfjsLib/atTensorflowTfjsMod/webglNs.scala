...
object webglNs extends js.Object {
  @js.native
  class GPGPUContext ()
    extends atTensorflowTfjsDashCoreLib.atTensorflowTfjsDashCoreMod.webglNs.GPGPUContext {
    def this(gl: stdLib.WebGLRenderingContext) = this()
  }
  
  @js.native
  class MathBackendWebGL ()
    extends atTensorflowTfjsDashCoreLib.atTensorflowTfjsDashCoreMod.webglNs.MathBackendWebGL {
  ...
  object webglUnderscoreUtilNs extends js.Object {
    ...
    def isWebGLVersionEnabled_1(webGLVersion: atTensorflowTfjsLib.atTensorflowTfjsLibNumbers.`1`): scala.Boolean = js.native
    @JSName("isWebGLVersionEnabled")
    def isWebGLVersionEnabled_2(webGLVersion: atTensorflowTfjsLib.atTensorflowTfjsLibNumbers.`2`): scala.Boolean = js.native
