...
object layersNs extends js.Object {
  ...
  abstract class Layer protected ()
    extends atTensorflowTfjsDashLayersLib.atTensorflowTfjsDashLayersMod.layersNs.Layer {
    def this(args: atTensorflowTfjsDashLayersLib.distEngineTopologyMod.LayerArgs) = this()
  }
  
  @js.native
  class RNN protected ()
    extends atTensorflowTfjsDashLayersLib.atTensorflowTfjsDashLayersMod.layersNs.RNN {
    def this(args: atTensorflowTfjsDashLayersLib.distLayersRecurrentMod.RNNLayerArgs) = this()
  }
  
  @js.native
  abstract class RNNCell ()
    extends atTensorflowTfjsDashLayersLib.atTensorflowTfjsDashLayersMod.layersNs.RNNCell
