...
object dataNs extends js.Object {
  ...
  class CSVDataset protected ()
    extends atTensorflowTfjsDashDataLib.atTensorflowTfjsDashDataMod.CSVDataset {
    /**
      * Create a `CSVDataset`.
      *
  ...
  abstract class Dataset[T /* <: atTensorflowTfjsDashCoreLib.distTensorUnderscoreTypesMod.TensorContainer */] ()
    extends atTensorflowTfjsDashDataLib.atTensorflowTfjsDashDataMod.Dataset[T]
  
  @js.native
  class FileDataSource protected ()
    extends atTensorflowTfjsDashDataLib.atTensorflowTfjsDashDataMod.FileDataSource {
    /**
  ...
  class TextLineDataset protected ()
    extends atTensorflowTfjsDashDataLib.atTensorflowTfjsDashDataMod.TextLineDataset {
    /**
  ...
  class URLDataSource protected ()
    extends atTensorflowTfjsDashDataLib.atTensorflowTfjsDashDataMod.URLDataSource {
    /**
  ...
  val version_data: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.`1DOT2DOT5` = js.native
  ...
  object Dataset extends js.Object {
    val MAX_BUFFER_SIZE: atTensorflowTfjsLib.atTensorflowTfjsLibNumbers.`10000` = js.native
  }
