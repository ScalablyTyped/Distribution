...
object ^ extends js.Object {
  ...
  val version_converter: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.`1DOT2DOT5` = js.native
  val version_core: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.`1DOT2DOT5` = js.native
  val version_layers: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.`1DOT2DOT5` = js.native
