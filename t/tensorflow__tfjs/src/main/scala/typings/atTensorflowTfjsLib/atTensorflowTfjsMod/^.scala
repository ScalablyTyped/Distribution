...
object ^ extends js.Object {
  ...
  val depthToSpace: js.Function3[
    ...
    /* dataFormat */ js.UndefOr[
      atTensorflowTfjsLib.atTensorflowTfjsLibStrings.NHWC | atTensorflowTfjsLib.atTensorflowTfjsLibStrings.NCHW
    ], 
    atTensorflowTfjsDashCoreLib.distTensorMod.Tensor4D
  ] = js.native
  ...
  val norm: js.Function4[
    /* x */ atTensorflowTfjsDashCoreLib.distTensorMod.Tensor[atTensorflowTfjsDashCoreLib.distTypesMod.Rank] | atTensorflowTfjsDashCoreLib.distTypesMod.TensorLike, 
    /* ord */ js.UndefOr[
      scala.Double | atTensorflowTfjsLib.atTensorflowTfjsLibStrings.euclidean | atTensorflowTfjsLib.atTensorflowTfjsLibStrings.fro
    ], 
    /* axis */ js.UndefOr[scala.Double | js.Array[scala.Double]], 
    /* keepDims */ js.UndefOr[scala.Boolean], 
    atTensorflowTfjsDashCoreLib.distTensorMod.Tensor[atTensorflowTfjsDashCoreLib.distTypesMod.Rank]
  ...
  val version_converter: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.`1DOT2DOT2` = js.native
  val version_core: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.`1DOT2DOT2` = js.native
  val version_layers: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.`1DOT2DOT2` = js.native
  ...
  ): atTensorflowTfjsDashCoreLib.distTensorMod.TensorBuffer[R, atTensorflowTfjsLib.atTensorflowTfjsLibStrings.float32] = js.native
  @JSName("buffer")
  def buffer_bool[R /* <: atTensorflowTfjsDashCoreLib.distTypesMod.Rank */](
    shape: /* import warning: ImportType.apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
    dtype: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.bool
  ): atTensorflowTfjsDashCoreLib.distTensorMod.TensorBuffer[R, atTensorflowTfjsLib.atTensorflowTfjsLibStrings.bool] = js.native
  @JSName("buffer")
  def buffer_bool[R /* <: atTensorflowTfjsDashCoreLib.distTypesMod.Rank */](
    shape: /* import warning: ImportType.apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
    dtype: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.bool,
  ...
  ): atTensorflowTfjsDashCoreLib.distTensorMod.TensorBuffer[R, atTensorflowTfjsLib.atTensorflowTfjsLibStrings.complex64] = js.native
  @JSName("buffer")
  def buffer_complex64[R /* <: atTensorflowTfjsDashCoreLib.distTypesMod.Rank */](
    shape: /* import warning: ImportType.apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
    dtype: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.complex64,
  ...
  ): atTensorflowTfjsDashCoreLib.distTensorMod.TensorBuffer[R, atTensorflowTfjsLib.atTensorflowTfjsLibStrings.int32] = js.native
  @JSName("buffer")
  def buffer_int32[R /* <: atTensorflowTfjsDashCoreLib.distTypesMod.Rank */](
    shape: /* import warning: ImportType.apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
    dtype: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.int32,
  ...
  ): atTensorflowTfjsDashCoreLib.distTensorMod.TensorBuffer[R, atTensorflowTfjsLib.atTensorflowTfjsLibStrings.string] = js.native
  @JSName("buffer")
  def buffer_string[R /* <: atTensorflowTfjsDashCoreLib.distTypesMod.Rank */](
    shape: /* import warning: ImportType.apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
    dtype: atTensorflowTfjsLib.atTensorflowTfjsLibStrings.string,
