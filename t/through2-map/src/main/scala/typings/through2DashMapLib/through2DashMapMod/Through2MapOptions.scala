package typings
package through2DashMapLib.through2DashMapMod
...
object Through2MapOptions {
  ...
  def apply(
    ...
    wantStrings: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    if (!js.isUndefined(wantStrings)) __obj.updateDynamic("wantStrings")(wantStrings)
