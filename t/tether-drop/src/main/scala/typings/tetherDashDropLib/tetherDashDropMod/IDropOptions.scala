...
trait IDropOptions extends js.Object {
  var beforeClose: js.UndefOr[js.Function2[/* event */ stdLib.Event, /* drop */ Drop, scala.Boolean]] = js.undefined
  ...
  var tetherOptions: js.UndefOr[tetherLib.tetherMod.ITetherOptions] = js.undefined
}

object IDropOptions {
  @scala.inline
  def apply(
    beforeClose: (/* event */ stdLib.Event, /* drop */ Drop) => scala.Boolean = null,
    ...
    tetherOptions: tetherLib.tetherMod.ITetherOptions = null
  ): IDropOptions = {
