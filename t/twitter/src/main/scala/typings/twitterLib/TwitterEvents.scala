...
trait TwitterEvents extends js.Object {
  ...
  @JSName("bind")
  def bind_click(
    name: twitterLib.twitterLibStrings.click,
  ...
  @JSName("bind")
  def bind_favorite(
    name: twitterLib.twitterLibStrings.favorite,
    callback: js.Function1[/* ev */ TwitterIntentEvent, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  @JSName("bind")
  def bind_follow(
    name: twitterLib.twitterLibStrings.follow,
    callback: js.Function1[/* ev */ TwitterIntentEvent, scala.Unit]
  ): scala.Unit = js.native
  /**
       ...
       */
  @JSName("bind")
  def bind_loaded(name: twitterLib.twitterLibStrings.loaded, callback: js.Function1[/* ev */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
       ...
       */
  @JSName("bind")
  def bind_rendered(name: twitterLib.twitterLibStrings.rendered, callback: js.Function1[/* ev */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
  ...
  @JSName("bind")
  def bind_retweet(
    name: twitterLib.twitterLibStrings.retweet,
    callback: js.Function1[/* ev */ TwitterIntentEvent, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  @JSName("bind")
  def bind_tweet(
    name: twitterLib.twitterLibStrings.tweet,
    callback: js.Function1[/* ev */ TwitterIntentEvent, scala.Unit]
  ): scala.Unit = js.native
}
