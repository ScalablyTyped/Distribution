...
object global {
  ...
  object Typesetter {
    ...
    @JSGlobal("Typesetter.AbstractMeasurer")
    @js.native
    open class AbstractMeasurer protected ()
      extends typings.typesettable.mod.AbstractMeasurer {
    ...
    object AbstractMeasurer {
      ...
      /**
        ...
        * to override this.
        */
      @JSGlobal("Typesetter.AbstractMeasurer.HEIGHT_TEXT")
      @js.native
    ...
    @JSGlobal("Typesetter.Cache")
    @js.native
    open class Cache[T] protected ()
      extends typings.typesettable.mod.Cache[T] {
      /**
        * @constructor
        *
    ...
    @JSGlobal("Typesetter.CacheCharacterMeasurer")
    @js.native
    open class CacheCharacterMeasurer protected ()
      extends typings.typesettable.mod.CacheCharacterMeasurer {
      def this(ruler: IRuler) = this()
      def this(ruler: IRulerFactoryContext) = this()
    ...
    @JSGlobal("Typesetter.CacheMeasurer")
    @js.native
    open class CacheMeasurer protected ()
      extends typings.typesettable.mod.CacheMeasurer {
      def this(ruler: IRuler) = this()
      def this(ruler: IRulerFactoryContext) = this()
    }
    
    @JSGlobal("Typesetter.CanvasContext")
    @js.native
    open class CanvasContext protected ()
      extends typings.typesettable.mod.CanvasContext {
    ...
    @JSGlobal("Typesetter.CharacterMeasurer")
    @js.native
    open class CharacterMeasurer protected ()
      extends typings.typesettable.mod.CharacterMeasurer {
      def this(ruler: IRuler) = this()
      def this(ruler: IRulerFactoryContext) = this()
      def this(ruler: IRuler, useGuards: Boolean) = this()
      def this(ruler: IRulerFactoryContext, useGuards: Boolean) = this()
    ...
    @JSGlobal("Typesetter.HtmlContext")
    @js.native
    open class HtmlContext protected ()
      extends typings.typesettable.mod.HtmlContext {
      /**
    ...
    @JSGlobal("Typesetter.HtmlUtils")
    @js.native
    open class HtmlUtils ()
      extends typings.typesettable.mod.HtmlUtils
    /* static members */
    object HtmlUtils {
    ...
    @JSGlobal("Typesetter.Measurer")
    @js.native
    open class Measurer protected ()
      extends typings.typesettable.mod.Measurer {
      def this(ruler: IRuler) = this()
      def this(ruler: IRulerFactoryContext) = this()
      def this(ruler: IRuler, useGuards: Boolean) = this()
      def this(ruler: IRulerFactoryContext, useGuards: Boolean) = this()
    ...
    @JSGlobal("Typesetter.Methods")
    @js.native
    open class Methods ()
      extends typings.typesettable.mod.Methods
    /* static members */
    object Methods {
    ...
    @JSGlobal("Typesetter.SingleLineWrapper")
    @js.native
    open class SingleLineWrapper ()
      extends typings.typesettable.mod.SingleLineWrapper
    /* static members */
    object SingleLineWrapper {
      ...
      @JSGlobal("Typesetter.SingleLineWrapper.NO_WRAP_ITERATIONS")
      @js.native
    ...
    @JSGlobal("Typesetter.StringMethods")
    @js.native
    open class StringMethods ()
      extends typings.typesettable.mod.StringMethods
    /* static members */
    ...
    @JSGlobal("Typesetter.SvgContext")
    @js.native
    open class SvgContext protected ()
      extends typings.typesettable.mod.SvgContext {
    ...
    object SvgContext {
      ...
      @JSGlobal("Typesetter.SvgContext.AnchorMap")
      @js.native
    ...
    @JSGlobal("Typesetter.SvgUtils")
    @js.native
    open class SvgUtils ()
      extends typings.typesettable.mod.SvgUtils
    /* static members */
    object SvgUtils {
      ...
      @JSGlobal("Typesetter.SvgUtils.SVG_NS")
      @js.native
    ...
    @JSGlobal("Typesetter.Tokenizer")
    @js.native
    open class Tokenizer ()
      extends typings.typesettable.mod.Tokenizer
    
    @JSGlobal("Typesetter.Typesetter")
    @js.native
    open class Typesetter protected ()
      extends typings.typesettable.mod.Typesetter {
    ...
    @JSGlobal("Typesetter.Wrapper")
    @js.native
    open class Wrapper ()
      extends typings.typesettable.mod.Wrapper
    
    @JSGlobal("Typesetter.Writer")
    @js.native
    open class Writer protected ()
      extends typings.typesettable.mod.Writer {
      def this(
    ...
    object Writer {
      ...
      @JSGlobal("Typesetter.Writer.SupportedRotation")
      @js.native
      ...
      @JSGlobal("Typesetter.Writer.XOffsetFactor")
      @js.native
      ...
      @JSGlobal("Typesetter.Writer.YOffsetFactor")
      @js.native
