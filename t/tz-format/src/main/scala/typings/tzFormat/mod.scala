...
object mod {
  ...
  inline def apply(date: js.Date, offset: Double): String = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[String]
