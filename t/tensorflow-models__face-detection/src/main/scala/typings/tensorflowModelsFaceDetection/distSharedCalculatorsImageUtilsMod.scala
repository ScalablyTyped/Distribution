...
import typings.tensorflowModelsFaceDetection.distSharedCalculatorsInterfacesCommonInterfacesMod.ValueTransform
...
object distSharedCalculatorsImageUtilsMod {
  ...
  @JSImport("@tensorflow-models/face-detection/dist/shared/calculators/image_utils", JSImport.Namespace)
  @js.native
