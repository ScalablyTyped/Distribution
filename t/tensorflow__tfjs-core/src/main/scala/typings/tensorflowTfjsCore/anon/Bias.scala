...
object Bias {
  ...
  @scala.inline
  implicit class BiasOps[Self <: Bias[_], /* <: typings.tensorflowTfjsCore.tensorMod.Tensor3D | typings.tensorflowTfjsCore.tensorMod.Tensor4D */ T] (val x: Self with Bias[T]) extends AnyVal {
    @scala.inline
