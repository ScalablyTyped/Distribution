...
object TfGlobals {
  ...
  inline def apply(_tfGlobals: Map[String, js.Any]): TfGlobals = {
  ...
  extension [Self <: TfGlobals](x: Self) {
    ...
    inline def set_tfGlobals(value: Map[String, js.Any]): Self = StObject.set(x, "_tfGlobals", value.asInstanceOf[js.Any])
  }
}
