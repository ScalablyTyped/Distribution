...
import typings.tensorflowTfjsCore.distBaseMod.^
...
inline def avgPool[T /* <: Tensor3D | Tensor4D */](
  ...
  strides: js.Tuple2[Double, Double],
  pad: same_ | valid_,
  dimRoundingMode: typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.ceil | typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.floor | typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.round
...
): typings.tensorflowTfjsCore.distTensorMod.TensorBuffer[R, typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.string] = (^.asInstanceOf[js.Dynamic].applyDynamic("buffer")(shape.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[typings.tensorflowTfjsCore.distTensorMod.TensorBuffer[R, typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.string]]
inline def buffer[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */](
  shape: /* import warning: importer.ImportType#apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
  dtype: Unit,
...
inline def buffer_string[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */](
  shape: /* import warning: importer.ImportType#apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
  dtype: typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.string
): typings.tensorflowTfjsCore.distTensorMod.TensorBuffer[R, typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.string] = (^.asInstanceOf[js.Dynamic].applyDynamic("buffer")(shape.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any])).asInstanceOf[typings.tensorflowTfjsCore.distTensorMod.TensorBuffer[R, typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.string]]
inline def buffer_string[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */](
  shape: /* import warning: importer.ImportType#apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
  dtype: typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.string,
  values: js.Array[String]
...
inline def meshgrid[T /* <: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank] */](x: T | TensorLike, y: T | TensorLike, param2: Indexing): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("meshgrid")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], param2.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
inline def meshgrid[T /* <: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank] */](x: T | TensorLike, y: Unit, param2: Indexing): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("meshgrid")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], param2.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
...
inline def meshgrid[T /* <: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank] */](x: Unit, y: T | TensorLike, param2: Indexing): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("meshgrid")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], param2.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
inline def meshgrid[T /* <: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank] */](x: Unit, y: Unit, param2: Indexing): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("meshgrid")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], param2.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
