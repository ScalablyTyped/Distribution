...
@JSImport("@tensorflow/tfjs-core/dist/base", "AdamOptimizer")
@js.native
open class AdamOptimizer protected ()
  extends typings.tensorflowTfjsCore.distOptimizersAdamOptimizerMod.AdamOptimizer {
...
object AdamOptimizer {
  ...
  /** @nocollapse */
  @JSImport("@tensorflow/tfjs-core/dist/base", "AdamOptimizer.className")
  @js.native
