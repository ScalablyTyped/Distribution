...
object distOpsTensorOpsUtilMod {
  ...
  inline def makeTensor(values: WebGPUData, shape: js.Array[Double], inferredShape: js.Array[Double]): Tensor[Rank] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeTensor")(values.asInstanceOf[js.Any], shape.asInstanceOf[js.Any], inferredShape.asInstanceOf[js.Any])).asInstanceOf[Tensor[Rank]]
  inline def makeTensor(values: WebGPUData, shape: js.Array[Double], inferredShape: js.Array[Double], dtype: DataType): Tensor[Rank] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeTensor")(values.asInstanceOf[js.Any], shape.asInstanceOf[js.Any], inferredShape.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any])).asInstanceOf[Tensor[Rank]]
}
