...
@js.native
trait SumAttrs extends js.Object {
...
object SumAttrs {
  ...
  @scala.inline
  def apply(axis: Double | js.Array[Double], keepDims: Boolean): SumAttrs = {
  ...
  @scala.inline
  implicit class SumAttrsOps[Self <: SumAttrs] (val x: Self) extends AnyVal {
