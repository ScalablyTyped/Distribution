...
object util {
  ...
  inline def getArrayFromDType_string(dtype: typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.string, size: Double): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getArrayFromDType")(dtype.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  ...
  inline def makeOnesTypedArray_string(size: Double, dtype: typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.string): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeOnesTypedArray")(size.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  ...
  inline def makeZerosNestedTypedArray_string(shape: js.Array[Double], dtype: typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.string): Double | js.Array[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeZerosNestedTypedArray")(shape.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any])).asInstanceOf[Double | js.Array[Any]]
  ...
  inline def makeZerosTypedArray_string(size: Double, dtype: typings.tensorflowTfjsCore.tensorflowTfjsCoreStrings.string): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeZerosTypedArray")(size.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
