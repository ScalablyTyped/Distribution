...
object signal {
  ...
  @JSImport("@tensorflow/tfjs-core/dist/base", "signal.frame")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/base", "signal.hammingWindow")
  @js.native
  def hammingWindow(windowLength: Double): Tensor[R1] = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/base", "signal.hannWindow")
  @js.native
  def hannWindow(windowLength: Double): Tensor[R1] = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/base", "signal.stft")
  @js.native
