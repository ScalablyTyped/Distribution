...
import typings.tensorflowTfjsCore.webglTypesMod.WebGL1DisjointQueryTimerExtension
import typings.tensorflowTfjsCore.webglTypesMod.WebGL2DisjointQueryTimerExtension
