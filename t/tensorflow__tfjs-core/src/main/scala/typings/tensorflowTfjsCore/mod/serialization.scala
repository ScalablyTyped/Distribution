...
object serialization {
  ...
  object Serializable {
    ...
    /**
      ...
      */
    /** @nocollapse */
    @JSImport("@tensorflow/tfjs-core", "serialization.Serializable.fromConfig")
    @js.native
  ...
  object SerializationMap {
    ...
    /**
      ...
      */
    @JSImport("@tensorflow/tfjs-core", "serialization.SerializationMap.getMap")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@tensorflow/tfjs-core", "serialization.SerializationMap.register")
    @js.native
    def register[T /* <: typings.tensorflowTfjsCore.serializationMod.Serializable */](cls: SerializableConstructor[T]): Unit = js.native
  }
  
  @JSImport("@tensorflow/tfjs-core", "serialization.registerClass")
  @js.native
