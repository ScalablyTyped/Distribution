...
object backendUtil {
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.assertAndGetBroadcastShape")
  @js.native
  def assertAndGetBroadcastShape(shapeA: js.Array[Double], shapeB: js.Array[Double]): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs-core", "backend_util.assertAxesAreInnerMostDims")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.axesAreInnerMostDims")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.complexWithEvenIndex")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.computeConv3DInfo")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.computeDefaultPad")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.computeOptimalWindowSize")
  @js.native
  def computeOptimalWindowSize(inSize: Double): Double = js.native
  
  @JSImport("@tensorflow/tfjs-core", "backend_util.computeOutAndReduceShapes")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.computeOutShape")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.getAxesPermutation")
  @js.native
  def getAxesPermutation(axes: js.Array[Double], rank: Double): js.Array[Double] | Null = js.native
  
  @JSImport("@tensorflow/tfjs-core", "backend_util.getBroadcastDims")
  @js.native
  def getBroadcastDims(inShape: js.Array[Double], outShape: js.Array[Double]): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs-core", "backend_util.getComplexWithIndex")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.getFusedDyActivation")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.getImageCenter")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.getInnerMostAxes")
  @js.native
  def getInnerMostAxes(numAxes: Double, rank: Double): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs-core", "backend_util.getPermuted")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.getReductionAxes")
  @js.native
  def getReductionAxes(inShape: js.Array[Double], outShape: js.Array[Double]): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs-core", "backend_util.getReshaped")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.getReshapedPermuted")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.getSliceSize")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.linspaceImpl")
  @js.native
  ...
  object segmentUtil {
    ...
    @JSImport("@tensorflow/tfjs-core", "backend_util.segment_util.collectGatherOpShapeInfo")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-core", "backend_util.segment_util.computeOutShape")
    @js.native
    def computeOutShape(aShape: js.Array[Double], axis: Double, numSegments: Double): js.Array[Double] = js.native
    
    @JSImport("@tensorflow/tfjs-core", "backend_util.segment_util.segOpComputeOptimalWindowSize")
    @js.native
  ...
  object sliceUtil {
    ...
    @JSImport("@tensorflow/tfjs-core", "backend_util.slice_util.isSliceContinous")
    @js.native
    def isSliceContinous(shape: js.Array[Double], begin: js.Array[Double], size: js.Array[Double]): Boolean = js.native
    
    @JSImport("@tensorflow/tfjs-core", "backend_util.slice_util.maskToAxes")
    @js.native
    def maskToAxes(mask: Double): js.Array[Double] = js.native
    
    @JSImport("@tensorflow/tfjs-core", "backend_util.slice_util.parseSliceParams")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-core", "backend_util.slice_util.startForAxis")
    @js.native
    def startForAxis(
      beginMask: Double,
    ...
    @JSImport("@tensorflow/tfjs-core", "backend_util.slice_util.startIndicesWithElidedDims")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-core", "backend_util.slice_util.stopForAxis")
    @js.native
    def stopForAxis(
      endMask: Double,
    ...
    @JSImport("@tensorflow/tfjs-core", "backend_util.slice_util.stopIndicesWithElidedDims")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-core", "backend_util.slice_util.stridesForAxis")
    @js.native
    def stridesForAxis(strides: js.Array[Double], axis: Double, ellipsisMask: Double): Double = js.native
    
    @JSImport("@tensorflow/tfjs-core", "backend_util.slice_util.stridesWithElidedDims")
    @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.splitRealAndImagArrays")
  @js.native
  def splitRealAndImagArrays(complex: Float32Array): Imag = js.native
  
  @JSImport("@tensorflow/tfjs-core", "backend_util.tupleValuesAreOne")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "backend_util.warn")
  @js.native
