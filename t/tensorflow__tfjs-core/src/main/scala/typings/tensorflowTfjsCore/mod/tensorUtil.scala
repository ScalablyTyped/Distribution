...
object tensorUtil {
  ...
  @JSImport("@tensorflow/tfjs-core", "tensor_util.assertTypesMatch")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core", "tensor_util.getTensorsInContainer")
  @js.native
  def getTensorsInContainer(result: TensorContainer): js.Array[Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank]] = js.native
  
  @JSImport("@tensorflow/tfjs-core", "tensor_util.isTensorInList")
  @js.native
  def isTensorInList(
  ...
  @JSImport("@tensorflow/tfjs-core", "tensor_util.makeTypesMatch")
  @js.native
