...
class AdagradOptimizer protected ()
  extends typings.tensorflowTfjsCore.baseMod.AdagradOptimizer {
...
object AdagradOptimizer {
  ...
  /** @nocollapse */
  @JSImport("@tensorflow/tfjs-core", "AdagradOptimizer.className")
  @js.native
  ...
  /** @nocollapse */
  @JSImport("@tensorflow/tfjs-core", "AdagradOptimizer.fromConfig")
  @js.native
