...
trait LogicalXorInputs extends StObject {
  
  var a: js.UndefOr[scala.Any] = js.undefined
  
  var b: js.UndefOr[scala.Any] = js.undefined
}
object LogicalXorInputs {
  
  inline def apply(): LogicalXorInputs = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LogicalXorInputs]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LogicalXorInputs] (val x: Self) extends AnyVal {
