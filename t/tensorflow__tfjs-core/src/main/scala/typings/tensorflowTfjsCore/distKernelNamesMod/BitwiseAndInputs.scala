...
trait BitwiseAndInputs extends StObject {
  
  var a: js.UndefOr[scala.Any] = js.undefined
  
  var b: js.UndefOr[scala.Any] = js.undefined
}
object BitwiseAndInputs {
  
  inline def apply(): BitwiseAndInputs = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BitwiseAndInputs]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BitwiseAndInputs] (val x: Self) extends AnyVal {
