...
import typings.tensorflowTfjsCore.distOptimizersAdadeltaOptimizerMod.AdadeltaOptimizer
import typings.tensorflowTfjsCore.distOptimizersAdagradOptimizerMod.AdagradOptimizer
import typings.tensorflowTfjsCore.distOptimizersAdamOptimizerMod.AdamOptimizer
import typings.tensorflowTfjsCore.distOptimizersAdamaxOptimizerMod.AdamaxOptimizer
import typings.tensorflowTfjsCore.distOptimizersMomentumOptimizerMod.MomentumOptimizer
import typings.tensorflowTfjsCore.distOptimizersOptimizerConstructorsMod.OptimizerConstructors
import typings.tensorflowTfjsCore.distOptimizersRmspropOptimizerMod.RMSPropOptimizer
...
object distTrainMod {
  ...
  @JSImport("@tensorflow/tfjs-core/dist/train", "train")
  @js.native
  open class train () extends OptimizerConstructors
  object train {
