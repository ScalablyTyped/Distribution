...
object tensorflowTfjsCoreStrings {
  ...
  sealed trait BYTES_PER_ELEMENT
    extends StObject
       with DataValues
  inline def BYTES_PER_ELEMENT: BYTES_PER_ELEMENT = "BYTES_PER_ELEMENT".asInstanceOf[BYTES_PER_ELEMENT]
  ...
  sealed trait byteOffset
    extends StObject
       with DataValues
  inline def byteOffset: byteOffset = "byteOffset".asInstanceOf[byteOffset]
  ...
  inline def float16: float16 = "float16".asInstanceOf[float16]
  ...
  sealed trait optimizer
    extends StObject
       with WeightGroup
  inline def optimizer: optimizer = "optimizer".asInstanceOf[optimizer]
  ...
  inline def same_ : same_ = "same".asInstanceOf[same_]
  ...
  sealed trait subarray
    extends StObject
       with DataValues
  inline def subarray: subarray = "subarray".asInstanceOf[subarray]
  ...
  inline def valid_ : valid_ = "valid".asInstanceOf[valid_]
