...
object localResponseNormalizationBackpropMod {
  ...
  @scala.inline
  def localResponseNormalizationBackprop[T /* <: Tensor4D */](x: T, y: T, dy: T): T = (^.asInstanceOf[js.Dynamic].applyDynamic("localResponseNormalizationBackprop")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], dy.asInstanceOf[js.Any])).asInstanceOf[T]
  @scala.inline
  def localResponseNormalizationBackprop[T /* <: Tensor4D */](x: T, y: T, dy: T, depthRadius: Double): T = (^.asInstanceOf[js.Dynamic].applyDynamic("localResponseNormalizationBackprop")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], dy.asInstanceOf[js.Any], depthRadius.asInstanceOf[js.Any])).asInstanceOf[T]
  @scala.inline
