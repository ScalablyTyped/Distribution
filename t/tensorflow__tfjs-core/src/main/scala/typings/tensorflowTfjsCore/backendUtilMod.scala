...
object backendUtilMod {
  
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "ERF_A1")
  @js.native
  val ERF_A1: /* 0.254829592 */ Double = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "ERF_A2")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "ERF_A5")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "applyActivation")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "assertAndGetBroadcastShape")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "assertParamsConsistent")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "combineLocations")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "computeOptimalWindowSize")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "computeOutShape")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "eitherStridesOrDilationsAreOne")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "expandShapeToKeepDim")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "getAxesPermutation")
  @js.native
  def getAxesPermutation(axes: js.Array[Double], rank: Double): js.Array[Double] | Null = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "getBroadcastDims")
  @js.native
  def getBroadcastDims(inShape: js.Array[Double], outShape: js.Array[Double]): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "getComplexWithIndex")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "getPermuted")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "getReductionAxes")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "getReshapedPermuted")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "getSliceBeginCoords")
  @js.native
  def getSliceBeginCoords(crops: js.Array[js.Array[Double]], blockShape: Double): js.Array[Double] = js.native
  
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "getSliceSize")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "getUndoAxesPermutation")
  @js.native
  ...
  object segmentUtil {
    ...
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "segment_util.collectGatherOpShapeInfo")
    @js.native
    def collectGatherOpShapeInfo(x: Tensor[Rank], indices: Tensor[Rank], axis: Double): GatherOpShapeInfo = js.native
    
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "segment_util.computeOutShape")
    @js.native
    def computeOutShape(aShape: js.Array[Double], axis: Double, numSegments: Double): js.Array[Double] = js.native
    
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "segment_util.segOpComputeOptimalWindowSize")
    @js.native
  ...
  object sliceUtil {
    ...
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.assertParamsValid")
    @js.native
    def assertParamsValid(input: TensorInfo, begin: js.Array[Double], size: js.Array[Double]): Unit = js.native
    
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.computeFlatOffset")
    @js.native
    def computeFlatOffset(begin: js.Array[Double], strides: js.Array[Double]): Double = js.native
    
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.computeOutShape")
    @js.native
    def computeOutShape(begin: js.Array[Double], end: js.Array[Double], strides: js.Array[Double]): js.Array[Double] = js.native
    
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.getNormalizedAxes")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.isSliceContinous")
    @js.native
    def isSliceContinous(shape: js.Array[Double], begin: js.Array[Double], size: js.Array[Double]): Boolean = js.native
    
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.maskToAxes")
    @js.native
    def maskToAxes(mask: Double): js.Array[Double] = js.native
    
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.parseSliceParams")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.startForAxis")
    @js.native
    def startForAxis(
      beginMask: Double,
    ...
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.startIndicesWithElidedDims")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.stopForAxis")
    @js.native
    def stopForAxis(
      endMask: Double,
    ...
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.stopIndicesWithElidedDims")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.stridesForAxis")
    @js.native
    def stridesForAxis(strides: js.Array[Double], axis: Double, ellipsisMask: Double): Double = js.native
    
    @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "slice_util.stridesWithElidedDims")
    @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/backends/backend_util", "upcastType")
  @js.native
