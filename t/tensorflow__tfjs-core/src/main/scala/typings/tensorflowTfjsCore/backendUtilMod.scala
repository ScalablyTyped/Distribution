...
object backendUtilMod {
  ...
  inline def castTensor[T /* <: Tensor[Rank] */](x: T, dtype: DataType, backend: KernelBackend): T = (^.asInstanceOf[js.Dynamic].applyDynamic("castTensor")(x.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any], backend.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  inline def prepareAndValidate(tensor: Tensor[Rank], indices: Tensor[Rank]): js.Tuple4[js.Array[Double], Double, Double, js.Array[Double]] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareAndValidate")(tensor.asInstanceOf[js.Any], indices.asInstanceOf[js.Any])).asInstanceOf[js.Tuple4[js.Array[Double], Double, Double, js.Array[Double]]]
  ...
  inline def reshapeTensor[T /* <: Tensor[Rank] */, R /* <: Rank */](
    x: T,
