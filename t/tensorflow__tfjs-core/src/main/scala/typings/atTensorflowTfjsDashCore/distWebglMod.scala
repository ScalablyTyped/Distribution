...
@js.native
object distWebglMod extends js.Object {
  @js.native
  class GPGPUContext ()
    extends typings.atTensorflowTfjsDashCore.distBackendsWebglGpgpuUnderscoreContextMod.GPGPUContext {
    def this(gl: WebGLRenderingContext) = this()
  }
  
  @js.native
  class MathBackendWebGL ()
    extends typings.atTensorflowTfjsDashCore.distBackendsWebglBackendUnderscoreWebglMod.MathBackendWebGL {
