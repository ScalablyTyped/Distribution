...
class Tensor[R /* <: Rank */] protected () extends js.Object {
  ...
  def topk[T /* <: Tensor[Rank] */](): Anon_Indices[T] = js.native
  def topk[T /* <: Tensor[Rank] */](k: Double): Anon_Indices[T] = js.native
  def topk[T /* <: Tensor[Rank] */](k: Double, sorted: Boolean): Anon_Indices[T] = js.native
