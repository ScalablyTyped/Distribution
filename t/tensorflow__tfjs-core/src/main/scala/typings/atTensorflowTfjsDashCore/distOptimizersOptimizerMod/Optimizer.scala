...
abstract class Optimizer () extends Serializable {
  ...
  /**
    ...
    */
  def computeGradients(f: js.Function0[Scalar]): Anon_GradsValue = js.native
  def computeGradients(f: js.Function0[Scalar], varList: js.Array[Variable[Rank]]): Anon_GradsValue = js.native
  /**
