...
import typings.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.GraphDef
import typings.atTensorflowTfjsDashCore.atTensorflowTfjsDashCoreStrings.JSON
