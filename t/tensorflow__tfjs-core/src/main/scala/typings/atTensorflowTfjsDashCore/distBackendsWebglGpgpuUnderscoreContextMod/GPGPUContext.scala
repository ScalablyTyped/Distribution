...
import typings.atTensorflowTfjsDashCore.distBackendsWebglWebglUnderscoreTypesMod.WebGL1DisjointQueryTimerExtension
import typings.atTensorflowTfjsDashCore.distBackendsWebglWebglUnderscoreTypesMod.WebGL2DisjointQueryTimerExtension
