...
object serializationNs extends js.Object {
  ...
  abstract class Serializable ()
    extends typings.atTensorflowTfjsDashCore.distSerializationMod.Serializable
  
  @js.native
  class SerializationMap protected ()
    extends typings.atTensorflowTfjsDashCore.distSerializationMod.SerializationMap
