...
object distGradientsMod extends js.Object {
  ...
  /**
    ...
    */
  /** @doc {heading: 'Training', subheading: 'Gradients'} */
  def valueAndGrad[I /* <: Tensor[Rank] */, O /* <: Tensor[Rank] */](f: js.Function1[/* x */ I, O]): js.Function2[/* x */ I, /* dy */ js.UndefOr[O], Anon_Grad[O, I]] = js.native
  /**
    ...
    */
  /** @doc {heading: 'Training', subheading: 'Gradients'} */
  def valueAndGrads[O /* <: Tensor[Rank] */](f: js.Function1[/* repeated */ Tensor[Rank], O]): js.Function2[/* args */ js.Array[Tensor[Rank]], /* dy */ js.UndefOr[O], Anon_GradsValueArray[O]] = js.native
  /**
  ...
  def variableGrads(f: js.Function0[Scalar], varList: js.Array[Variable[Rank]]): Anon_GradsValue = js.native
}
