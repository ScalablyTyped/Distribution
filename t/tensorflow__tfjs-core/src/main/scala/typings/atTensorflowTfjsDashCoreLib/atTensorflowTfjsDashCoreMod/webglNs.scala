...
@JSImport("@tensorflow/tfjs-core", "webgl")
@js.native
object webglNs extends js.Object {
  @js.native
  class GPGPUContext ()
    extends atTensorflowTfjsDashCoreLib.distWebglMod.GPGPUContext {
    def this(gl: stdLib.WebGLRenderingContext) = this()
  }
  
  @js.native
  class MathBackendWebGL ()
    extends atTensorflowTfjsDashCoreLib.distWebglMod.MathBackendWebGL {
