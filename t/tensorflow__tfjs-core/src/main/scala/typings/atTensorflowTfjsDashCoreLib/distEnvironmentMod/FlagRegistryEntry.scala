...
trait FlagRegistryEntry extends js.Object {
  var setHook: js.UndefOr[js.Function1[/* value */ FlagValue, scala.Unit]] = js.undefined
  def evaluationFn(): FlagValue
}

object FlagRegistryEntry {
  @scala.inline
  def apply(evaluationFn: () => FlagValue, setHook: /* value */ FlagValue => scala.Unit = null): FlagRegistryEntry = {
