...
object atTensorflowTfjsDashCoreLibStrings {
  ...
  @js.native
  sealed trait bool
    extends atTensorflowTfjsDashCoreLib.distTypesMod.DataType
       with atTensorflowTfjsDashCoreLib.distTypesMod.NumericDataType
  ...
  @js.native
  sealed trait linear
    extends atTensorflowTfjsDashCoreLib.distOpsFusedUnderscoreUtilMod.Activation
  ...
  @js.native
  sealed trait model
    extends atTensorflowTfjsDashCoreLib.distIoTypesMod.WeightGroup
