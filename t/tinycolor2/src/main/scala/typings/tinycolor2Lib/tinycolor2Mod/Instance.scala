...
trait Instance extends _ColorInput {
  ...
  /**
    ...
    */
  def toHsl(): tinycolor2Lib.tinycolor2Mod.ColorFormatsNs.HSLA = js.native
  /**
  ...
  /**
    ...
    */
  def toHsv(): tinycolor2Lib.tinycolor2Mod.ColorFormatsNs.HSVA = js.native
  /**
  ...
  /**
    ...
    */
  def toPercentageRgb(): tinycolor2Lib.tinycolor2Mod.ColorFormatsNs.PRGBA = js.native
  /**
  ...
  /**
    * Returns the object as a RGBA object.
    */
  def toRgb(): tinycolor2Lib.tinycolor2Mod.ColorFormatsNs.RGBA = js.native
  /**
