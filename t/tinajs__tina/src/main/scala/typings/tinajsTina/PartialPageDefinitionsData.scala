...
object PartialPageDefinitionsData {
  ...
  def apply(
    ...
    onPageScroll: PartialPageDefinitionsData => Unit = null,
    onPullDownRefresh: PartialPageDefinitionsData => Unit = null,
    onReachBottom: PartialPageDefinitionsData => Unit = null,
    onReady: js.ThisFunction0[PartialPageDefinitionsData, Unit] = null,
    onShareAppMessage: PartialPageDefinitionsData => Unit = null,
