...
object anon {
  ...
  object PartialPageDefinitions {
    ...
    extension [Self <: PartialPageDefinitions](x: Self) {
      ...
      inline def setBeforeLoad(value: js.ThisFunction0[PartialPageDefinitions, Unit]): Self = StObject.set(x, "beforeLoad", value.asInstanceOf[js.Any])
      ...
      inline def setOnHide(value: js.ThisFunction0[PartialPageDefinitions, Unit]): Self = StObject.set(x, "onHide", value.asInstanceOf[js.Any])
      
      inline def setOnHideUndefined: Self = StObject.set(x, "onHide", js.undefined)
      
      inline def setOnLoad(value: js.ThisFunction1[PartialPageDefinitions, /* options */ js.UndefOr[Any], Unit]): Self = StObject.set(x, "onLoad", value.asInstanceOf[js.Any])
      
      inline def setOnLoadUndefined: Self = StObject.set(x, "onLoad", js.undefined)
      
      inline def setOnPageScroll(value: PartialPageDefinitions => Unit): Self = StObject.set(x, "onPageScroll", js.Any.fromFunction1(value))
      
      inline def setOnPageScrollUndefined: Self = StObject.set(x, "onPageScroll", js.undefined)
      
      inline def setOnPullDownRefresh(value: PartialPageDefinitions => Unit): Self = StObject.set(x, "onPullDownRefresh", js.Any.fromFunction1(value))
      
      inline def setOnPullDownRefreshUndefined: Self = StObject.set(x, "onPullDownRefresh", js.undefined)
      
      inline def setOnReachBottom(value: PartialPageDefinitions => Unit): Self = StObject.set(x, "onReachBottom", js.Any.fromFunction1(value))
      
      inline def setOnReachBottomUndefined: Self = StObject.set(x, "onReachBottom", js.undefined)
      
      inline def setOnReady(value: js.ThisFunction0[PartialPageDefinitions, Unit]): Self = StObject.set(x, "onReady", value.asInstanceOf[js.Any])
      
      inline def setOnReadyUndefined: Self = StObject.set(x, "onReady", js.undefined)
      
      inline def setOnShareAppMessage(value: PartialPageDefinitions => Unit): Self = StObject.set(x, "onShareAppMessage", js.Any.fromFunction1(value))
      
      inline def setOnShareAppMessageUndefined: Self = StObject.set(x, "onShareAppMessage", js.undefined)
      
      inline def setOnShow(value: js.ThisFunction0[PartialPageDefinitions, Unit]): Self = StObject.set(x, "onShow", value.asInstanceOf[js.Any])
      
      inline def setOnShowUndefined: Self = StObject.set(x, "onShow", js.undefined)
      
      inline def setOnUnload(value: js.ThisFunction0[PartialPageDefinitions, Unit]): Self = StObject.set(x, "onUnload", value.asInstanceOf[js.Any])
