...
import typings.terraSpacer.spacerMod.SpacerSizes
...
object anon {
  ...
  trait WeakValidationMapSpacerPr extends StObject {
    ...
    var isInlineBlock: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
    ...
    var margin: js.UndefOr[Validator[js.UndefOr[Null | SpacerShorthand]]] = js.undefined
    
    var marginBottom: js.UndefOr[
        Validator[
          js.UndefOr[
            largePlussign2 | `small-2` | `small-1` | none | large | medium | small | largePlussign4 | largePlussign3 | largePlussign1 | Null
          ]
        ]
      ] = js.undefined
    ...
    var padding: js.UndefOr[Validator[js.UndefOr[Null | SpacerShorthand]]] = js.undefined
  ...
  object WeakValidationMapSpacerPr {
    ...
    extension [Self <: WeakValidationMapSpacerPr](x: Self) {
      ...
      inline def setIsInlineBlock(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "isInlineBlock", value.asInstanceOf[js.Any])
      ...
      inline def setMargin(value: Validator[js.UndefOr[Null | SpacerShorthand]]): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
      ...
      inline def setPadding(value: Validator[js.UndefOr[Null | SpacerShorthand]]): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
