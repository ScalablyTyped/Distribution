...
import typings.terraSpacer.spacerShorthandDTsMod.SpacerShorthand
...
object spacerMod {
  ...
  trait SpacerProps
    ...
    /**
      ...
      */
    var margin: js.UndefOr[SpacerShorthand] = js.undefined
    ...
    /**
      ...
      * One of 'none', 'small-2', 'small-1', 'small', 'medium', 'large', 'large+1', 'large+2', 'large+3', 'large+4'.
      */
    var padding: js.UndefOr[SpacerShorthand] = js.undefined
  ...
  object SpacerProps {
    ...
    extension [Self <: SpacerProps](x: Self) {
      ...
      inline def setMargin(value: SpacerShorthand): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
      ...
      inline def setPadding(value: SpacerShorthand): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
