...
object TgfancyOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(kickWithoutBan)) __obj.updateDynamic("kickWithoutBan")(kickWithoutBan.get.asInstanceOf[js.Any])
    if (!js.isUndefined(openshiftWebHook)) __obj.updateDynamic("openshiftWebHook")(openshiftWebHook.get.asInstanceOf[js.Any])
    if (!js.isUndefined(orderedSending)) __obj.updateDynamic("orderedSending")(orderedSending.get.asInstanceOf[js.Any])
    if (ratelimiting != null) __obj.updateDynamic("ratelimiting")(ratelimiting.asInstanceOf[js.Any])
    if (!js.isUndefined(textPaging)) __obj.updateDynamic("textPaging")(textPaging.get.asInstanceOf[js.Any])
