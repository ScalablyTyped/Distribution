...
trait ConstructorOptions
  extends nodeDashTelegramDashBotDashApiLib.nodeDashTelegramDashBotDashApiMod.ConstructorOptions {
...
object ConstructorOptions {
  ...
  def apply(
    ...
    polling: scala.Boolean | nodeDashTelegramDashBotDashApiLib.nodeDashTelegramDashBotDashApiMod.PollingOptions = null,
    request: requestLib.requestMod.Options = null,
    tgfancy: TgfancyOptions = null,
    webHook: scala.Boolean | nodeDashTelegramDashBotDashApiLib.nodeDashTelegramDashBotDashApiMod.WebHookOptions = null
  ): ConstructorOptions = {
