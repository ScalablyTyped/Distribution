...
import typings.tarn.distPendingOperationMod.PendingOperation
import typings.tarn.distPromiseInspectionMod.PromiseInspection
import typings.tarn.distResourceMod.Resource
