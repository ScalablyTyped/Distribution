...
object ToastrOptions {
  ...
  def apply(
    ...
    closeDuration: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(closeDuration)) __obj.updateDynamic("closeDuration")(closeDuration.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(closeOnHover)) __obj.updateDynamic("closeOnHover")(closeOnHover.get.asInstanceOf[js.Any])
