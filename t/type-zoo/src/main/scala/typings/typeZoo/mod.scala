...
object mod {
  ...
  {[ P1 in K1 ]: {[ P2 in K2 ]: T[K1][P2]}}
    */ typings.typeZoo.typeZooStrings.Pick2 with TopLevel[T]
  ...
  {[ P1 in K1 ]: {[ P2 in K2 ]: {[ P3 in K3 ]: T[K1][K2][P3]}}}
    */ typings.typeZoo.typeZooStrings.Pick3 with TopLevel[T]
  ...
  {[ P1 in K1 ]: {[ P2 in K2 ]: {[ P3 in K3 ]: {[ P4 in K4 ]: T[K1][K2][K3][P4]}}}}
    */ typings.typeZoo.typeZooStrings.Pick4 with TopLevel[T]
