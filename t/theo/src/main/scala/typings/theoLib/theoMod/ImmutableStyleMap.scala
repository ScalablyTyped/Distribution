...
trait ImmutableStyleMap
  ...
  @JSName("get")
  def get_global(key: theoLib.theoLibStrings.global): Props = js.native
  @JSName("get")
  def get_imports(key: theoLib.theoLibStrings.imports): js.Array[java.lang.String] = js.native
  @JSName("get")
