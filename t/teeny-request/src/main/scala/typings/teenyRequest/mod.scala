...
object mod {
  ...
  */
  ...
  object Options {
    ...
    inline def OptionsWithUri(uri: String): typings.teenyRequest.mod.OptionsWithUri = {
      val __obj = js.Dynamic.literal(uri = uri.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.teenyRequest.mod.OptionsWithUri]
    }
    
    inline def OptionsWithUrl(url: String): typings.teenyRequest.mod.OptionsWithUrl = {
