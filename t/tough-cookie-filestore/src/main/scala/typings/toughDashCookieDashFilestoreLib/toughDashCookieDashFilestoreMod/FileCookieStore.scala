...
trait FileCookieStore extends js.Object {
  ...
  def updateCookie(oldCookie: Cookie, newCookie: Cookie, cb: js.Function1[/* whatever */ scala.Null, scala.Unit]): scala.Unit
}
...
object FileCookieStore {
  ...
  def apply(
    ...
    findCookie: (java.lang.String, java.lang.String, java.lang.String, js.Function2[/* whatever */ scala.Null, /* cookie */ js.UndefOr[Cookie | scala.Null], scala.Unit]) => scala.Unit,
    findCookies: (java.lang.String, java.lang.String, js.Function2[/* whatever */ scala.Null, /* cookies */ js.Array[Cookie], scala.Unit]) => scala.Unit,
    ...
    putCookie: (Cookie, java.lang.String, java.lang.String, js.Function1[/* whatever */ scala.Null, scala.Unit]) => scala.Unit,
    ...
    updateCookie: (Cookie, Cookie, js.Function1[/* whatever */ scala.Null, scala.Unit]) => scala.Unit
  ): FileCookieStore = {
