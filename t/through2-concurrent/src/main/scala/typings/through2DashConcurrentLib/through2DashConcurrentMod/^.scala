...
object ^ extends js.Object {
  ...
  def apply(opts: Through2ConcurrentOptions): nodeLib.streamMod.Transform = js.native
  def apply(opts: Through2ConcurrentOptions, transform: through2Lib.through2Mod.TransformFunction): nodeLib.streamMod.Transform = js.native
  def apply(
  ...
  def obj(opts: Through2ConcurrentOptions): nodeLib.streamMod.Transform = js.native
  def obj(opts: Through2ConcurrentOptions, transform: through2Lib.through2Mod.TransformFunction): nodeLib.streamMod.Transform = js.native
  def obj(
    opts: Through2ConcurrentOptions,
    transform: through2Lib.through2Mod.TransformFunction,
    flush: through2Lib.through2Mod.FlushCallback
