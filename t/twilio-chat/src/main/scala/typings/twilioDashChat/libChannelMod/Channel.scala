...
import typings.twilioDashChat.libChannelMod.ChannelNs.LastMessage
import typings.twilioDashChat.libChannelMod.ChannelNs.NotificationLevel
import typings.twilioDashChat.libChannelMod.ChannelNs.SendMediaOptions
...
class Channel protected () extends EventEmitter {
  ...
  val lastMessage: LastMessage = js.native
