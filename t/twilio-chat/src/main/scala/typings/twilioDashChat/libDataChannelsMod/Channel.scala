...
import typings.twilioDashChat.libChannelMod.ChannelDescriptor
import typings.twilioDashChat.libChannelMod.ChannelServices
...
class Channel protected ()
  extends typings.twilioDashChat.libChannelMod.Channel {
  /**
