...
trait UpdatedEventArgs extends js.Object {
  ...
  var channel: typings.twilioChat.channelMod.Channel = js.native
...
object UpdatedEventArgs {
  ...
  implicit class UpdatedEventArgsOps[Self <: UpdatedEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChannel(value: typings.twilioChat.channelMod.Channel): Self = this.set("channel", value.asInstanceOf[js.Any])
