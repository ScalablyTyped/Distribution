...
object treeDashKillMod extends js.Object {
  ...
  def apply(pid: Double, signal: String | Double): Unit = js.native
  def apply(pid: Double, signal: String | Double, callback: js.Function1[/* error */ js.UndefOr[Error], Unit]): Unit = js.native
}
