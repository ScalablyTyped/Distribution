...
name := "theme-ui"
version := "0.3-dt-20200130Z-565a3b"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "styled-system__css" % "5.0-dt-20191115Z-e24682",
  "org.scalablytyped" %%% "theme-ui__components" % "0.2-dt-20200210Z-6f4a6a")
