...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "theme-ui__color-modes" % "0.15.7-9e4e85",
  "org.scalablytyped" %%% "theme-ui__components" % "0.15.7-ce9d3f",
  "org.scalablytyped" %%% "theme-ui__core" % "0.15.7-3ea3c3")
