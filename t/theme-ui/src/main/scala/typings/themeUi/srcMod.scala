...
object srcMod {
  ...
  object jsx {
    ...
    object JSX {
      ...
      type Element = typings.themeUiCore.jsxNamespaceMod.ThemeUIJSX.Element
      
      type ElementAttributesProperty = typings.themeUiCore.jsxNamespaceMod.ThemeUIJSX.ElementAttributesProperty
      
      type ElementChildrenAttribute = typings.themeUiCore.jsxNamespaceMod.ThemeUIJSX.ElementChildrenAttribute
      
      type ElementClass = typings.themeUiCore.jsxNamespaceMod.ThemeUIJSX.ElementClass
      
      type IntrinsicAttributes = typings.themeUiCore.jsxNamespaceMod.ThemeUIJSX.IntrinsicAttributes
      
      type IntrinsicClassAttributes[T] = typings.themeUiCore.jsxNamespaceMod.ThemeUIJSX.IntrinsicClassAttributes[T]
      
      type IntrinsicElements = typings.themeUiCore.jsxNamespaceMod.ThemeUIJSX.IntrinsicElements
      
      type LibraryManagedAttributes[C, P] = typings.themeUiCore.jsxNamespaceMod.ThemeUIJSX.LibraryManagedAttributes[C, P]
    }
  }
