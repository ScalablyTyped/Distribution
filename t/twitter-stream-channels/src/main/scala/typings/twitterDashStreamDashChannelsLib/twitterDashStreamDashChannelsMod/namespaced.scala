...
@js.native
class namespaced protected () extends TwitterStreamChannels {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getApiClient(): twitLib.twitMod.namespaced = js.native
  /**
  ...
  ): twitterDashStreamDashChannelsLib.twitterDashStreamDashChannelsMod.TwitterStreamChannelsNs.StreamChannels = js.native
}
