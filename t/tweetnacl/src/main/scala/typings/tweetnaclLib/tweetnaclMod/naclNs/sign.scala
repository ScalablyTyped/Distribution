...
trait sign extends js.Object {
  @JSName("detached")
  var detached_Original: tweetnaclLib.tweetnaclMod.naclNs.signNs.detached = js.native
  @JSName("keyPair")
  var keyPair_Original: tweetnaclLib.tweetnaclMod.naclNs.signNs.keyPair = js.native
