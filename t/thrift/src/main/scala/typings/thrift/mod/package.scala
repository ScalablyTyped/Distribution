...
@scala.inline
def createConnection(host: scala.Unit, port: scala.Double): typings.thrift.mod.Connection = (typings.thrift.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createConnection")(host.asInstanceOf[js.Any], port.asInstanceOf[js.Any])).asInstanceOf[typings.thrift.mod.Connection]
@scala.inline
...
@scala.inline
def createHttpConnection(host: scala.Unit, port: scala.Double): typings.thrift.mod.HttpConnection = (typings.thrift.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createHttpConnection")(host.asInstanceOf[js.Any], port.asInstanceOf[js.Any])).asInstanceOf[typings.thrift.mod.HttpConnection]
@scala.inline
...
@scala.inline
def createSSLConnection(host: scala.Unit, port: scala.Double): typings.thrift.mod.Connection = (typings.thrift.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createSSLConnection")(host.asInstanceOf[js.Any], port.asInstanceOf[js.Any])).asInstanceOf[typings.thrift.mod.Connection]
@scala.inline
...
@scala.inline
def createWSConnection(host: scala.Unit, port: scala.Double): typings.thrift.mod.WSConnection = (typings.thrift.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createWSConnection")(host.asInstanceOf[js.Any], port.asInstanceOf[js.Any])).asInstanceOf[typings.thrift.mod.WSConnection]
@scala.inline
...
@scala.inline
def createXHRConnection(host: scala.Unit, port: scala.Double): typings.thrift.mod.XHRConnection = (typings.thrift.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createXHRConnection")(host.asInstanceOf[js.Any], port.asInstanceOf[js.Any])).asInstanceOf[typings.thrift.mod.XHRConnection]
@scala.inline
