...
import typings.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeStrings.`1DOT2DOT10`
...
object data extends js.Object {
  ...
  class CSVDataset protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.data.CSVDataset {
    /**
      * Create a `CSVDataset`.
      *
  ...
  abstract class Dataset[T /* <: TensorContainer */] ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.data.Dataset[T]
  
  @js.native
  class FileDataSource protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.data.FileDataSource {
  ...
  class TextLineDataset protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.data.TextLineDataset {
    /**
  ...
  class URLDataSource protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.data.URLDataSource {
    /**
  ...
  val version_data: `1DOT2DOT10` = js.native
