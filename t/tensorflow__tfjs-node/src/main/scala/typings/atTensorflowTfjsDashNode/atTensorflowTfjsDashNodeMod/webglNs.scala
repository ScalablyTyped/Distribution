...
object webglNs extends js.Object {
  @js.native
  class GPGPUContext ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.webglNs.GPGPUContext {
    def this(gl: WebGLRenderingContext) = this()
  }
  
  @js.native
  class MathBackendWebGL ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.webglNs.MathBackendWebGL {
