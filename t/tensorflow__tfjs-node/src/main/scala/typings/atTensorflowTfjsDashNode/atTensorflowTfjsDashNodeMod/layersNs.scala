...
object layersNs extends js.Object {
  ...
  abstract class Layer protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.layersNs.Layer {
    def this(args: LayerArgs) = this()
  }
  
  @js.native
  class RNN protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.layersNs.RNN {
    def this(args: RNNLayerArgs) = this()
  }
  
  @js.native
  abstract class RNNCell ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.layersNs.RNNCell
