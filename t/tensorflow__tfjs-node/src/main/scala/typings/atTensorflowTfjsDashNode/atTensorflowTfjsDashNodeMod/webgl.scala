...
import typings.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeNumbers.`1`
import typings.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeNumbers.`2`
...
object webgl extends js.Object {
  @js.native
  class GPGPUContext ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.webgl.GPGPUContext {
    def this(gl: WebGLRenderingContext) = this()
  }
  
  @js.native
  class MathBackendWebGL ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.webgl.MathBackendWebGL {
