...
object serializationNs extends js.Object {
  ...
  abstract class Serializable ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.serializationNs.Serializable
  
  @js.native
  class SerializationMap protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.serializationNs.SerializationMap
