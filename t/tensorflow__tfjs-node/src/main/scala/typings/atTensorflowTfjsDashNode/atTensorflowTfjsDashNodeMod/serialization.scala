...
object serialization extends js.Object {
  ...
  abstract class Serializable ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.serialization.Serializable
  
  @js.native
  class SerializationMap protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.serialization.SerializationMap
