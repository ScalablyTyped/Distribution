...
import typings.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeStrings.avg
import typings.atTensorflowTfjsDashNode.atTensorflowTfjsDashNodeStrings.max
