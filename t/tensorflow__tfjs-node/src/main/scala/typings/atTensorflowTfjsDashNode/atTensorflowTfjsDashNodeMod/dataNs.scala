...
object dataNs extends js.Object {
  ...
  class CSVDataset protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.dataNs.CSVDataset {
    /**
      * Create a `CSVDataset`.
      *
  ...
  abstract class Dataset[T /* <: TensorContainer */] ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.dataNs.Dataset[T]
  
  @js.native
  class FileDataSource protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.dataNs.FileDataSource {
  ...
  class TextLineDataset protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.dataNs.TextLineDataset {
    /**
  ...
  class URLDataSource protected ()
    extends typings.atTensorflowTfjs.atTensorflowTfjsMod.dataNs.URLDataSource {
    /**
