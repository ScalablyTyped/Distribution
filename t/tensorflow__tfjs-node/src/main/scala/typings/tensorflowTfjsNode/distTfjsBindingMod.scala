...
object distTfjsBindingMod {
  ...
  trait TFJSBinding extends StObject {
    ...
    var TFEOpAttr: Instantiable0[typings.tensorflowTfjsNode.distTfjsBindingMod.TFEOpAttr]
    ...
    var TensorMetadata: Instantiable0[typings.tensorflowTfjsNode.distTfjsBindingMod.TensorMetadata]
  ...
  object TFJSBinding {
    ...
    implicit open class MutableBuilder[Self <: TFJSBinding] (val x: Self) extends AnyVal {
      ...
      inline def setGetNumOfTensors(value: () => Double): Self = StObject.set(x, "getNumOfTensors", js.Any.fromFunction0(value))
