package typings.tensorflowTfjsNode.mod.webgl
...
import typings.tensorflowTfjsNode.tensorflowTfjsNodeNumbers.`1`
import typings.tensorflowTfjsNode.tensorflowTfjsNodeNumbers.`2`
