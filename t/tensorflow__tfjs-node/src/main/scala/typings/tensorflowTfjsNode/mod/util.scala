...
object util {
  ...
  inline def checkConversionForErrors_string(
    vals: js.Array[Double | String],
    dtype: typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.string
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("checkConversionForErrors")(vals.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def getArrayFromDType_string(dtype: typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.string, size: Double): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getArrayFromDType")(dtype.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  ...
  inline def makeOnesTypedArray_string(size: Double, dtype: typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.string): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeOnesTypedArray")(size.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  ...
  inline def makeZerosNestedTypedArray_string(shape: js.Array[Double], dtype: typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.string): Double | js.Array[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeZerosNestedTypedArray")(shape.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any])).asInstanceOf[Double | js.Array[Any]]
  ...
  inline def makeZerosTypedArray_string(size: Double, dtype: typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.string): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeZerosTypedArray")(size.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
