...
import typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.left
import typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.reflect
import typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.right
import typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.same
import typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.symmetric
...
inline def avgPool(
  ...
  strides: js.Tuple2[Double, Double],
  pad: same | valid,
  dimRoundingMode: typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.ceil | typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.floor | typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.round
