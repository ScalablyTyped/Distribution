...
object backendUtil {
  ...
  inline def castTensor[T /* <: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank] */](x: T, dtype: DataType, backend: typings.tensorflowTfjsCore.backendMod.KernelBackend): T = (^.asInstanceOf[js.Dynamic].applyDynamic("castTensor")(x.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any], backend.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  inline def linspaceImpl(start: Double, stop: Double, num: Double): Tensor[R1] = (^.asInstanceOf[js.Dynamic].applyDynamic("linspaceImpl")(start.asInstanceOf[js.Any], stop.asInstanceOf[js.Any], num.asInstanceOf[js.Any])).asInstanceOf[Tensor[R1]]
  ...
  inline def reshapeTensor[T /* <: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank] */, R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */](
    x: T,
  ...
  object segmentUtil {
    ...
    inline def collectGatherOpShapeInfo(
      x: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank],
      indices: Tensor[typings.tensorflowTfjsCore.distTypesMod.Rank],
      axis: Double
