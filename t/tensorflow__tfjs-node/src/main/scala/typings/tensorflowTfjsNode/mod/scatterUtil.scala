...
object scatterUtil {
  ...
  @JSImport("@tensorflow/tfjs-node", "scatter_util.calculateShapes")
  @js.native
  def calculateShapes(updates: TensorInfo, indices: TensorInfo, shape: js.Array[Double]): ScatterShapeInfo = js.native
  
  @JSImport("@tensorflow/tfjs-node", "scatter_util.validateInput")
  @js.native
  def validateInput(
  ...
  @JSImport("@tensorflow/tfjs-node", "scatter_util.validateUpdateShape")
  @js.native
