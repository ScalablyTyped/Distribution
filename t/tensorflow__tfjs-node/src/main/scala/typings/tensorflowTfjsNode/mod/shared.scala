...
object shared {
  ...
  @JSImport("@tensorflow/tfjs-node", "shared")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.addImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "shared.bitwiseAndImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "shared.ceilImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "shared.equalImpl")
  @js.native
  val equalImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.expImpl")
  @js.native
  val expImpl: SimpleUnaryImpl[Double, Double] = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.expm1Impl")
  @js.native
  val expm1Impl: SimpleUnaryImpl[Double, Double] = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.floorDivImpl")
  @js.native
  val floorDivImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.floorImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "shared.greaterEqualImpl")
  @js.native
  val greaterEqualImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.greaterImpl")
  @js.native
  val greaterImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.lessEqualImpl")
  @js.native
  val lessEqualImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.lessImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "shared.logImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "shared.maximumImpl")
  @js.native
  val maximumImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.minimumImpl")
  @js.native
  val minimumImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.multiplyImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "shared.notEqualImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "shared.rsqrtImpl")
  @js.native
  val rsqrtImpl: SimpleUnaryImpl[Double, Double] = js.native
  
  inline def scatterImpl_int32[R /* <: typings.tensorflowTfjsCore.distTypesMod.Rank */, D /* <: float32 | int32 | bool | typings.tensorflowTfjsNode.tensorflowTfjsNodeStrings.string */](
  ...
  @JSImport("@tensorflow/tfjs-node", "shared.sigmoidImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "shared.sqrtImpl")
  @js.native
  val sqrtImpl: SimpleUnaryImpl[Double, Double] = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.squaredDifferenceImpl")
  @js.native
  val squaredDifferenceImpl: SimpleBinaryKernelImpl = js.native
  
  @JSImport("@tensorflow/tfjs-node", "shared.staticRegexReplaceImpl")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-node", "shared.subImpl")
  @js.native
