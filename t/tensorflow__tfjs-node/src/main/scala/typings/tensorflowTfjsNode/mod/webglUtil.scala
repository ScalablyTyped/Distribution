...
import typings.tensorflowTfjsNode.tensorflowTfjsNodeInts.`1`
import typings.tensorflowTfjsNode.tensorflowTfjsNodeInts.`2`
...
object webglUtil {
  ...
  @JSImport("@tensorflow/tfjs-node", "webgl_util")
  @js.native
