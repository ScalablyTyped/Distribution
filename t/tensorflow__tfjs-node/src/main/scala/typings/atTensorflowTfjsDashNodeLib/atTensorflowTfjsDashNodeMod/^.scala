...
object ^ extends js.Object {
  ...
  val depthToSpace: js.Function3[
    ...
    /* dataFormat */ js.UndefOr[
      atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.NHWC | atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.NCHW
    ], 
    atTensorflowTfjsDashCoreLib.distTensorMod.Tensor4D
  ] = js.native
  ...
  val norm: js.Function4[
    /* x */ atTensorflowTfjsDashCoreLib.distTensorMod.Tensor[atTensorflowTfjsDashCoreLib.distTypesMod.Rank] | atTensorflowTfjsDashCoreLib.distTypesMod.TensorLike, 
    /* ord */ js.UndefOr[
      scala.Double | atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.euclidean | atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.fro
    ], 
    /* axis */ js.UndefOr[scala.Double | js.Array[scala.Double]], 
    /* keepDims */ js.UndefOr[scala.Boolean], 
    atTensorflowTfjsDashCoreLib.distTensorMod.Tensor[atTensorflowTfjsDashCoreLib.distTypesMod.Rank]
  ...
  val version_converter: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.`1DOT2DOT2` = js.native
  val version_core: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.`1DOT2DOT2` = js.native
  val version_layers: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.`1DOT2DOT2` = js.native
  ...
  ): atTensorflowTfjsDashCoreLib.distTensorMod.TensorBuffer[R, atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.float32] = js.native
  @JSName("buffer")
  ...
  ): atTensorflowTfjsDashCoreLib.distTensorMod.TensorBuffer[R, atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.bool] = js.native
  @JSName("buffer")
  def buffer_bool[R /* <: atTensorflowTfjsDashCoreLib.distTypesMod.Rank */](
    shape: /* import warning: ImportType.apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
    dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.bool,
  ...
  ): atTensorflowTfjsDashCoreLib.distTensorMod.TensorBuffer[R, atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.complex64] = js.native
  @JSName("buffer")
  def buffer_complex64[R /* <: atTensorflowTfjsDashCoreLib.distTypesMod.Rank */](
    shape: /* import warning: ImportType.apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
    dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.complex64,
  ...
  ): atTensorflowTfjsDashCoreLib.distTensorMod.TensorBuffer[R, atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.int32] = js.native
  @JSName("buffer")
  def buffer_int32[R /* <: atTensorflowTfjsDashCoreLib.distTypesMod.Rank */](
    shape: /* import warning: ImportType.apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
    dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.int32,
  ...
  ): atTensorflowTfjsDashCoreLib.distTensorMod.TensorBuffer[R, atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.string] = js.native
  @JSName("buffer")
  def buffer_string[R /* <: atTensorflowTfjsDashCoreLib.distTypesMod.Rank */](
    shape: /* import warning: ImportType.apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
    dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.string,
