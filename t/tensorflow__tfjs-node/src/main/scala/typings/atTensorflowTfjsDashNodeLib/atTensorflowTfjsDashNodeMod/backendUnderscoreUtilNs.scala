...
object backendUnderscoreUtilNs extends js.Object {
  ...
  def computeConv2DInfo(
    ...
    pad: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.same | atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.valid | scala.Double,
    roundingMode: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.floor | atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.round | atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.ceil
  ...
  def computeConv2DInfo(
    ...
    roundingMode: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.floor | atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.round | atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.ceil,
    depthwise: scala.Boolean,
    dataFormat: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.channelsFirst | atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.channelsLast
  ): atTensorflowTfjsDashCoreLib.distOpsConvUnderscoreUtilMod.Conv2DInfo = js.native
  def computeConv2DInfo(
    inShape: js.Tuple4[scala.Double, scala.Double, scala.Double, scala.Double],
    filterShape: js.Tuple4[scala.Double, scala.Double, scala.Double, scala.Double],
  ...
  def computeConv3DInfo(
    ...
    pad: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.same,
    depthwise: scala.Boolean,
    dataFormat: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.channelsFirst
  ...
  def computeConv3DInfo(
    ...
    pad: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.same,
    depthwise: scala.Boolean,
    dataFormat: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.channelsLast
  ): atTensorflowTfjsDashCoreLib.distOpsConvUnderscoreUtilMod.Conv3DInfo = js.native
  def computeConv3DInfo(
    inShape: js.Tuple5[scala.Double, scala.Double, scala.Double, scala.Double, scala.Double],
    filterShape: js.Tuple5[scala.Double, scala.Double, scala.Double, scala.Double, scala.Double],
