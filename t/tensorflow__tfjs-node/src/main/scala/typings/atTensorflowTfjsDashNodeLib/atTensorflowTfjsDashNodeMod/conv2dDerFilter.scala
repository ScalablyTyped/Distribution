...
object conv2dDerFilter extends js.Object {
  ...
  def apply(
    ...
    strides: js.Tuple2[scala.Double, scala.Double],
    pad: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.same,
    dimRoundingMode: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.ceil
  ): atTensorflowTfjsDashCoreLib.distTensorMod.Tensor4D = js.native
  def apply(
    x: atTensorflowTfjsDashCoreLib.distTensorMod.Tensor[
      atTensorflowTfjsDashCoreLib.distTypesMod.Rank.R3 | atTensorflowTfjsDashCoreLib.distTypesMod.Rank.R4
    ...
    strides: js.Tuple2[scala.Double, scala.Double],
    pad: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.same,
    dimRoundingMode: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.floor
  ): atTensorflowTfjsDashCoreLib.distTensorMod.Tensor4D = js.native
  def apply(
    x: atTensorflowTfjsDashCoreLib.distTensorMod.Tensor[
      atTensorflowTfjsDashCoreLib.distTypesMod.Rank.R3 | atTensorflowTfjsDashCoreLib.distTypesMod.Rank.R4
    ...
    strides: js.Tuple2[scala.Double, scala.Double],
    pad: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.same,
    dimRoundingMode: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.round
  ): atTensorflowTfjsDashCoreLib.distTensorMod.Tensor4D = js.native
  def apply(
    x: atTensorflowTfjsDashCoreLib.distTensorMod.Tensor[
      atTensorflowTfjsDashCoreLib.distTypesMod.Rank.R3 | atTensorflowTfjsDashCoreLib.distTypesMod.Rank.R4
