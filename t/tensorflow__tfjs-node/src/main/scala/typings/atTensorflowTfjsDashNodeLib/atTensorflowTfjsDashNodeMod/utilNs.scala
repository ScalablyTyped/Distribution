...
object utilNs extends js.Object {
  ...
  @JSName("getArrayFromDType")
  def getArrayFromDType_float32(dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.float32, size: scala.Double): stdLib.Float32Array = js.native
  @JSName("getArrayFromDType")
  def getArrayFromDType_int32(dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.int32, size: scala.Double): stdLib.Int32Array = js.native
  @JSName("getArrayFromDType")
  def getArrayFromDType_string(dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.string, size: scala.Double): js.Array[java.lang.String] = js.native
  ...
  def makeOnesTypedArray_bool(size: scala.Double, dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.bool): stdLib.Uint8Array = js.native
  @JSName("makeOnesTypedArray")
  ...
  @JSName("makeOnesTypedArray")
  def makeOnesTypedArray_float32(size: scala.Double, dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.float32): stdLib.Float32Array = js.native
  @JSName("makeOnesTypedArray")
  def makeOnesTypedArray_int32(size: scala.Double, dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.int32): stdLib.Int32Array = js.native
  @JSName("makeOnesTypedArray")
  def makeOnesTypedArray_string(size: scala.Double, dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.string): js.Array[java.lang.String] = js.native
  @JSName("makeZerosTypedArray")
  def makeZerosTypedArray_bool(size: scala.Double, dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.bool): stdLib.Uint8Array = js.native
  @JSName("makeZerosTypedArray")
  ...
  @JSName("makeZerosTypedArray")
  def makeZerosTypedArray_float32(size: scala.Double, dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.float32): stdLib.Float32Array = js.native
  @JSName("makeZerosTypedArray")
  def makeZerosTypedArray_int32(size: scala.Double, dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.int32): stdLib.Int32Array = js.native
  @JSName("makeZerosTypedArray")
  def makeZerosTypedArray_string(size: scala.Double, dtype: atTensorflowTfjsDashNodeLib.atTensorflowTfjsDashNodeLibStrings.string): js.Array[java.lang.String] = js.native
