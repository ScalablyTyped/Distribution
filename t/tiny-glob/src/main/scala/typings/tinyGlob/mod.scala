...
object mod {
  ...
  inline def apply(str: String): js.Promise[js.Array[FilePath]] = ^.asInstanceOf[js.Dynamic].apply(str.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[FilePath]]]
  inline def apply(str: String, opts: Options): js.Promise[js.Array[FilePath]] = (^.asInstanceOf[js.Dynamic].apply(str.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[FilePath]]]
  
  @JSImport("tiny-glob", JSImport.Namespace)
  @js.native
