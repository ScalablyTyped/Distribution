...
trait AnonSubGiftUpgradeUserstate
  extends CommonSubUserstate
     with Userstate {
  var `message-type`: js.UndefOr[tmiDotJsLib.tmiDotJsLibStrings.anongiftpaidupgrade] = js.undefined
}
...
object AnonSubGiftUpgradeUserstate {
  ...
  def apply(
    ...
    `message-type`: tmiDotJsLib.tmiDotJsLibStrings.anongiftpaidupgrade = null,
