...
trait SubGiftUpgradeUserstate
  extends CommonSubUserstate
     with Userstate {
  var `message-type`: js.UndefOr[tmiDotJsLib.tmiDotJsLibStrings.giftpaidupgrade] = js.undefined
  var `msg-param-sender-login`: js.UndefOr[java.lang.String] = js.undefined
  var `msg-param-sender-name`: js.UndefOr[java.lang.String] = js.undefined
}
...
object SubGiftUpgradeUserstate {
  ...
  def apply(
    ...
    `message-type`: tmiDotJsLib.tmiDotJsLibStrings.giftpaidupgrade = null,
    mod: js.UndefOr[scala.Boolean] = js.undefined,
    `msg-param-sender-login`: java.lang.String = null,
    `msg-param-sender-name`: java.lang.String = null,
    ...
    if (`msg-param-sender-login` != null) __obj.updateDynamic("msg-param-sender-login")(`msg-param-sender-login`)
    if (`msg-param-sender-name` != null) __obj.updateDynamic("msg-param-sender-name")(`msg-param-sender-name`)
