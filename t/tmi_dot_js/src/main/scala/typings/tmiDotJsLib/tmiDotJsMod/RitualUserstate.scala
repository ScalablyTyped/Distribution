...
trait RitualUserstate
  extends UserNoticeState
     with Userstate {
  var `message-type`: js.UndefOr[tmiDotJsLib.tmiDotJsLibStrings.ritual] = js.undefined
  var `msg-param-ritual-name`: js.UndefOr[tmiDotJsLib.tmiDotJsLibStrings.new_chatter] = js.undefined
}
...
object RitualUserstate {
  ...
  def apply(
    ...
    `message-type`: tmiDotJsLib.tmiDotJsLibStrings.ritual = null,
    mod: js.UndefOr[scala.Boolean] = js.undefined,
    `msg-param-ritual-name`: tmiDotJsLib.tmiDotJsLibStrings.new_chatter = null,
    ...
    if (`msg-param-ritual-name` != null) __obj.updateDynamic("msg-param-ritual-name")(`msg-param-ritual-name`)
