...
trait OverriddenMethods[TEmitter, TEventRecord, TEmitRecord] extends js.Object {
  ...
  def removeEventListener[T](`this`: T, event: String, listener: js.Function1[/* repeated */ js.Any, _]): EEMethodReturnType[TEmitter, typings.tmiDotJs.tmiDotJsStrings.removeEventListener, T, Unit] = js.native
  def removeListener(event: js.Symbol, listener: js.Function1[/* repeated */ js.Any, _]): Unit = js.native
  def removeListener[T](`this`: T, event: String, listener: js.Function1[/* repeated */ js.Any, _]): EEMethodReturnType[TEmitter, typings.tmiDotJs.tmiDotJsStrings.removeListener, T, Unit] = js.native
}
