...
/* Rewritten from type alias, can be one of: 
  - typings.tmiJs.mod.ChatUserstate
  - typings.tmiJs.mod.SubUserstate
  - typings.tmiJs.mod.SubGiftUserstate
  - typings.tmiJs.mod.SubGiftUpgradeUserstate
  - typings.tmiJs.mod.AnonSubGiftUserstate
  - typings.tmiJs.mod.SubMysteryGiftUserstate
