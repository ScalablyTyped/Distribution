...
object ^ extends js.Object {
  ...
  def createReducer[TState, TRootAction /* <: typesafeDashActionsLib.distTypeDashHelpersMod.Action[typesafeDashActionsLib.distTypeDashHelpersMod.TypeConstant] */](initialState: TState, initialHandlers: InitialHandler[TState, TRootAction]): (typesafeDashActionsLib.distTypeDashHelpersMod.Reducer[TState, TRootAction]) with (typesafeDashActionsLib.Anon_Action[TState, TRootAction]) = js.native
}
