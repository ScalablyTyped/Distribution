...
/* Inlined trace-event-lib.trace-event-lib/dist/builder.Simplified<trace-event-lib.trace-event-lib/dist/schema.DurationBeginEvent> */
trait SimplifiedDurationBeginEv extends StObject {
  ...
  var ph: js.UndefOr[B] = js.undefined
...
object SimplifiedDurationBeginEv {
  
  inline def apply(name: String): SimplifiedDurationBeginEv = {
