...
/* Inlined trace-event-lib.trace-event-lib/dist/builder.Simplified<trace-event-lib.trace-event-lib/dist/schema.AsyncEndEvent> */
trait SimplifiedAsyncEndEvent extends StObject {
  ...
  var ph: js.UndefOr[e_] = js.undefined
...
object SimplifiedAsyncEndEvent {
  
  inline def apply(): SimplifiedAsyncEndEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SimplifiedAsyncEndEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SimplifiedAsyncEndEvent] (val x: Self) extends AnyVal {
