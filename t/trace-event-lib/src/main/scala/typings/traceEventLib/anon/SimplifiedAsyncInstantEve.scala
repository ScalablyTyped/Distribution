...
/* Inlined trace-event-lib.trace-event-lib/dist/builder.Simplified<trace-event-lib.trace-event-lib/dist/schema.AsyncInstantEvent> */
trait SimplifiedAsyncInstantEve extends StObject {
  ...
  var ph: js.UndefOr[n] = js.undefined
...
object SimplifiedAsyncInstantEve {
  
  inline def apply(): SimplifiedAsyncInstantEve = {
