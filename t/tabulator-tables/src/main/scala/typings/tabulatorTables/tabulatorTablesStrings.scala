...
import typings.tabulatorTables.Tabulator.Align
...
import typings.tabulatorTables.Tabulator.HistoryAction
import typings.tabulatorTables.Tabulator.HttpMethod
