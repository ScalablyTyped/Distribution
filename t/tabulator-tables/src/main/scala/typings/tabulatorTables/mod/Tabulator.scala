...
open class Tabulator protected () extends StObject {
  ...
  def `import`(data: Any, fileName: String): Any = js.native
...
object Tabulator {
  ...
  @js.native
  def bindModules: js.Function1[/* param0 */ Any, Unit] = js.native
  inline def bindModules_=(x: js.Function1[/* param0 */ Any, Unit]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("bindModules")(x.asInstanceOf[js.Any])
