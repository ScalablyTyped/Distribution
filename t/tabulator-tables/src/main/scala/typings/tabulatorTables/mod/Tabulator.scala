...
import typings.tabulatorTables.mod.Tabulator.AdditionalExportOptions
...
import typings.tabulatorTables.mod.Tabulator.ColumnLayout
import typings.tabulatorTables.mod.Tabulator.ColumnLookup
import typings.tabulatorTables.mod.Tabulator.DownloadOptions
import typings.tabulatorTables.mod.Tabulator.DownloadType
import typings.tabulatorTables.mod.Tabulator.Filter
import typings.tabulatorTables.mod.Tabulator.FilterFunction
import typings.tabulatorTables.mod.Tabulator.FilterParams
import typings.tabulatorTables.mod.Tabulator.FilterType
import typings.tabulatorTables.mod.Tabulator.GroupArg
import typings.tabulatorTables.mod.Tabulator.GroupComponent
import typings.tabulatorTables.mod.Tabulator.GroupValuesArg
import typings.tabulatorTables.mod.Tabulator.RowComponent
import typings.tabulatorTables.mod.Tabulator.RowLookup
...
import typings.tabulatorTables.mod.Tabulator.Sorter
...
open class Tabulator protected () extends StObject {
  ...
  def addFilter(field: String, `type`: FilterType, value: Any, filterParams: FilterParams): Unit = js.native
  /** If you want to add another filter to the existing filters then you can call the addFilter function: */
  @JSName("addFilter")
  ...
  var columnManager: Any = js.native
  ...
  var footerManager: Any = js.native
  ...
  def getCalcResults(): Any = js.native
  ...
  def getData(activeOnly: RowRangeLookup): js.Array[Any] = js.native
  ...
  def getGroupedData(): Any = js.native
  def getGroupedData(activeOnly: Boolean): Any = js.native
  ...
  def getHtml(): Any = js.native
  def getHtml(rowRangeLookup: Unit, style: Boolean): Any = js.native
  def getHtml(rowRangeLookup: Unit, style: Boolean, config: AdditionalExportOptions): Any = js.native
  def getHtml(rowRangeLookup: Unit, style: Unit, config: AdditionalExportOptions): Any = js.native
  def getHtml(rowRangeLookup: RowRangeLookup): Any = js.native
  def getHtml(rowRangeLookup: RowRangeLookup, style: Boolean): Any = js.native
  def getHtml(rowRangeLookup: RowRangeLookup, style: Boolean, config: AdditionalExportOptions): Any = js.native
  def getHtml(rowRangeLookup: RowRangeLookup, style: Unit, config: AdditionalExportOptions): Any = js.native
  ...
  def getLang(): Any = js.native
  def getLang(locale: String): Any = js.native
  ...
  /**
    ...
    */
  def getRowPosition(row: RowLookup): Double | `false` = js.native
  def getRowPosition(row: RowLookup, activeOnly: Boolean): Double | `false` = js.native
  ...
  /**
    ...
    */
  def getSelectedData(): js.Array[Any] = js.native
  ...
  var options: TabulatorOptions = js.native
  ...
  def print(rowRangeLookup: Unit, style: Boolean): Any = js.native
  def print(rowRangeLookup: Unit, style: Boolean, config: AdditionalExportOptions): Any = js.native
  def print(rowRangeLookup: Unit, style: Unit, config: AdditionalExportOptions): Any = js.native
  def print(rowRangeLookup: RowRangeLookup): Any = js.native
  def print(rowRangeLookup: RowRangeLookup, style: Boolean): Any = js.native
  def print(rowRangeLookup: RowRangeLookup, style: Boolean, config: AdditionalExportOptions): Any = js.native
  def print(rowRangeLookup: RowRangeLookup, style: Unit, config: AdditionalExportOptions): Any = js.native
  ...
  def refreshFilters(): Unit = js.native
  
  /** If you want to remove one filter from the current list of filters you can use the removeFilter function: */
  def removeFilter(field: String, `type`: FilterType, value: Any): Unit = js.native
  def removeFilter(field: String, `type`: FilterType, value: Any, filterParams: FilterParams): Unit = js.native
  /** If you want to remove one filter from the current list of filters you can use the removeFilter function: */
  @JSName("removeFilter")
  ...
  def replaceData(data: String, params: Any): js.Promise[Unit] = js.native
  def replaceData(data: String, params: Any, config: Any): js.Promise[Unit] = js.native
  def replaceData(data: String, params: Unit, config: Any): js.Promise[Unit] = js.native
  def replaceData(data: js.Array[js.Object]): js.Promise[Unit] = js.native
  def replaceData(data: js.Array[js.Object], params: Any): js.Promise[Unit] = js.native
  def replaceData(data: js.Array[js.Object], params: Any, config: Any): js.Promise[Unit] = js.native
  def replaceData(data: js.Array[js.Object], params: Unit, config: Any): js.Promise[Unit] = js.native
  def replaceData(data: Unit, params: Any): js.Promise[Unit] = js.native
  def replaceData(data: Unit, params: Any, config: Any): js.Promise[Unit] = js.native
  def replaceData(data: Unit, params: Unit, config: Any): js.Promise[Unit] = js.native
  ...
  def scrollToRow(row: RowLookup, position: ScrollToRowPosition): js.Promise[Unit] = js.native
  def scrollToRow(row: RowLookup, position: ScrollToRowPosition, ifVisible: Boolean): js.Promise[Unit] = js.native
  ...
  def searchData(field: String, `type`: FilterType, value: Any): js.Array[Any] = js.native
  ...
  def searchRows(field: String, `type`: FilterType, value: Any): js.Array[RowComponent] = js.native
  ...
  def setData(data: Any): js.Promise[Unit] = js.native
  def setData(data: Any, params: Any): js.Promise[Unit] = js.native
  def setData(data: Any, params: Any, config: Any): js.Promise[Unit] = js.native
  def setData(data: Any, params: Unit, config: Any): js.Promise[Unit] = js.native
  ...
  def setFilter(p1: String, p2: js.Object, value: Any): Unit = js.native
  def setFilter(p1: String, p2: js.Object, value: Any, filterParams: FilterParams): Unit = js.native
  def setFilter(p1: String, p2: js.Object, value: Unit, filterParams: FilterParams): Unit = js.native
  def setFilter(p1: String, p2: Unit, value: Any): Unit = js.native
  def setFilter(p1: String, p2: Unit, value: Any, filterParams: FilterParams): Unit = js.native
  ...
  def setFilter(p1: String, p2: FilterType, value: Any): Unit = js.native
  def setFilter(p1: String, p2: FilterType, value: Any, filterParams: FilterParams): Unit = js.native
  def setFilter(p1: String, p2: FilterType, value: Unit, filterParams: FilterParams): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter]): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter], p2: js.Object): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter], p2: js.Object, value: Any): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter], p2: js.Object, value: Any, filterParams: FilterParams): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter], p2: js.Object, value: Unit, filterParams: FilterParams): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter], p2: Unit, value: Any): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter], p2: Unit, value: Any, filterParams: FilterParams): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter], p2: Unit, value: Unit, filterParams: FilterParams): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter], p2: FilterType): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter], p2: FilterType, value: Any): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter], p2: FilterType, value: Any, filterParams: FilterParams): Unit = js.native
  def setFilter(p1: js.Array[Any | Filter], p2: FilterType, value: Unit, filterParams: FilterParams): Unit = js.native
  def setFilter(p1: js.Function2[/* data */ Any, /* filterParams */ Any, Boolean]): Unit = js.native
  def setFilter(p1: js.Function2[/* data */ Any, /* filterParams */ Any, Boolean], p2: js.Object): Unit = js.native
  def setFilter(p1: js.Function2[/* data */ Any, /* filterParams */ Any, Boolean], p2: js.Object, value: Any): Unit = js.native
  def setFilter(
    p1: js.Function2[/* data */ Any, /* filterParams */ Any, Boolean],
    p2: js.Object,
    value: Any,
  ...
  def setFilter(p1: js.Function2[/* data */ Any, /* filterParams */ Any, Boolean], p2: Unit, value: Any): Unit = js.native
  def setFilter(
    p1: js.Function2[/* data */ Any, /* filterParams */ Any, Boolean],
    p2: Unit,
    value: Any,
  ...
  def setFilter(p1: js.Function2[/* data */ Any, /* filterParams */ Any, Boolean], p2: FilterType): Unit = js.native
  def setFilter(p1: js.Function2[/* data */ Any, /* filterParams */ Any, Boolean], p2: FilterType, value: Any): Unit = js.native
  def setFilter(
    p1: js.Function2[/* data */ Any, /* filterParams */ Any, Boolean],
    p2: FilterType,
    value: Any,
  ...
  def setGroupBy(groups: GroupArg): Unit = js.native
  
  def setGroupHeader(values: js.Array[js.Function3[/* value */ Any, /* count */ Double, /* data */ Any, String]]): Unit = js.native
  ...
  def setGroupHeader(
    values: js.Function4[/* value */ Any, /* count */ Double, /* data */ Any, /* group */ GroupComponent, String]
  ): Unit = js.native
  
  def setGroupStartOpen(
    values: js.Function4[/* value */ Any, /* count */ Double, /* data */ Any, /* group */ GroupComponent, Boolean]
  ): Unit = js.native
  /**
  ...
  def setPage(page: first | prev | next | last): js.Promise[Unit] = js.native
  /**
...
object Tabulator {
  ...
  @js.native
  def defaultOptions: TabulatorOptions = js.native
  inline def defaultOptions_=(x: TabulatorOptions): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultOptions")(x.asInstanceOf[js.Any])
  ...
  */
  ...
  trait AutoCompleteParams
    ...
    var values: `true` | (js.Array[Any | String]) | JSONRecord | String
    
    var verticalNavigation: js.UndefOr[editor | table | hybrid] = js.undefined
  }
  object AutoCompleteParams {
    
    inline def apply(values: `true` | (js.Array[Any | String]) | JSONRecord | String): AutoCompleteParams = {
    ...
    extension [Self <: AutoCompleteParams](x: Self) {
      ...
      inline def setValues(value: `true` | (js.Array[Any | String]) | JSONRecord | String): Self = StObject.set(x, "values", value.asInstanceOf[js.Any])
      
      inline def setValuesVarargs(value: (Any | String)*): Self = StObject.set(x, "values", js.Array(value*))
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.tabulatorTables.mod.Tabulator.ColumnComponent
    - typings.tabulatorTables.mod.Tabulator.ColumnDefinition
  ...
  */
  ...
  - typings.tabulatorTables.mod.Tabulator._FormatterParams because Already inherited */ trait DateTimeDifferenceParams
    extends StObject
       with DateTimeParams {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.tabulatorTables.mod.Tabulator.DownloadPDF because var conflicts: documentProcessing. Inlined orientation, title, rowGroupStyles, rowCalcStyles, jsPDF, autoTable */ trait DownloadOptions
    extends StObject
       with DownloadCSV
       with DownloadXLXS
       with DownloadHTML {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - js.Function5[
  / * cell * / typings.tabulatorTables.mod.Tabulator.CellComponent, 
  / * onRendered * / typings.tabulatorTables.mod.Tabulator.EmptyCallback, 
  / * success * / typings.tabulatorTables.mod.Tabulator.ValueBooleanCallback, 
  / * cancel * / typings.tabulatorTables.mod.Tabulator.ValueVoidCallback, 
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.tabulatorTables.mod.Tabulator.NumberParams
    - typings.tabulatorTables.mod.Tabulator.CheckboxParams
    - typings.tabulatorTables.mod.Tabulator.SelectParams
    - typings.tabulatorTables.mod.Tabulator.AutoCompleteParams
    - typings.tabulatorTables.mod.Tabulator.InputParams
    - typings.tabulatorTables.mod.Tabulator.TextAreaParams
    - typings.tabulatorTables.mod.Tabulator.DateParams
    - typings.tabulatorTables.mod.Tabulator.TimeParams
    - typings.tabulatorTables.mod.Tabulator.DateTimeEditorParams
    - js.Function1[/ * cell * / typings.tabulatorTables.mod.Tabulator.CellComponent, js.Object]
  */
  ...
  object Filter {
    ...
    inline def apply(field: String, `type`: FilterType, value: Any): Filter = {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.tabulatorTables.mod.Tabulator.MoneyParams
    - typings.tabulatorTables.mod.Tabulator.ImageParams
    - typings.tabulatorTables.mod.Tabulator.LinkParams
    - typings.tabulatorTables.mod.Tabulator.DateTimeParams
    - typings.tabulatorTables.mod.Tabulator.DateTimeDifferenceParams
    - typings.tabulatorTables.mod.Tabulator.TickCrossParams
    - typings.tabulatorTables.mod.Tabulator.TrafficParams
    - typings.tabulatorTables.mod.Tabulator.ProgressBarParams
    - typings.tabulatorTables.mod.Tabulator.StarRatingParams
    - typings.tabulatorTables.mod.Tabulator.RowSelectionParams
    - typings.tabulatorTables.mod.Tabulator.JSONRecord
    - js.Function1[/ * cell * / typings.tabulatorTables.mod.Tabulator.CellComponent, js.Object]
  */
  ...
  */
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.tabulatorTables.mod.Tabulator.CellCallbacks because var conflicts: cellClick, cellContext, cellDblClick, cellDblTap, cellEditCancelled, cellEdited, cellEditing, cellMouseEnter, cellMouseLeave, cellMouseMove, cellMouseOut, cellMouseOver, cellTap, cellTapHold. Inlined 
  - typings.tabulatorTables.mod.Tabulator.OptionsCells because var conflicts: cellClick, cellContext, cellDblClick, cellDblTap, cellEditCancelled, cellEdited, cellEditing, cellMouseEnter, cellMouseLeave, cellMouseMove, cellMouseOut, cellMouseOver, cellTap, cellTapHold. Inlined validationFailed */ trait Options
    extends StObject
       with OptionsGeneral
       with OptionsMenu
       with OptionsHistory
  ...
  object OptionsMenu {
    ...
    extension [Self <: OptionsMenu](x: Self) {
      ...
      inline def setRowClickMenuFunction2(
        value: (/* component */ RowComponent, /* e */ MouseEvent) => MenuObject[RowComponent] | `false` | js.Array[Any]
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.tabulatorTables.mod.Tabulator._FormatterParams because Already inherited */ trait ProgressBarParams
    extends StObject
       with TrafficParams {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.tabulatorTables.tabulatorTablesStrings.virtual
    - typings.tabulatorTables.tabulatorTablesStrings.basic
    - typings.tabulatorTables.mod.Renderer
  */
  ...
  */
  trait ScrollToRowPosition extends StObject
  object ScrollToRowPosition {
  ...
  object SelectParams {
    ...
    extension [Self <: SelectParams](x: Self) {
      ...
      inline def setValuesVarargs(value: (SelectParamsGroup | String)*): Self = StObject.set(x, "values", js.Array(value*))
  ...
  object SelectParamsGroup {
    ...
    extension [Self <: SelectParamsGroup](x: Self) {
      ...
      inline def setOptionsVarargs(value: SelectLabelValue*): Self = StObject.set(x, "options", js.Array(value*))
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.tabulatorTables.tabulatorTablesStrings.remote
    - typings.tabulatorTables.tabulatorTablesStrings.local
  */
  trait SortMode extends StObject
  object SortMode {
    
    inline def local: typings.tabulatorTables.tabulatorTablesStrings.local = "local".asInstanceOf[typings.tabulatorTables.tabulatorTablesStrings.local]
    
    inline def remote: typings.tabulatorTables.tabulatorTablesStrings.remote = "remote".asInstanceOf[typings.tabulatorTables.tabulatorTablesStrings.remote]
  }
  ...
  */
  ...
  object _EditorParams {
    ...
    inline def AutoCompleteParams(values: `true` | (js.Array[Any | String]) | JSONRecord | String): typings.tabulatorTables.mod.Tabulator.AutoCompleteParams = {
      val __obj = js.Dynamic.literal(values = values.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.AutoCompleteParams]
    }
    
    inline def CheckboxParams(): typings.tabulatorTables.mod.Tabulator.CheckboxParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.CheckboxParams]
    }
    
    inline def DateParams(): typings.tabulatorTables.mod.Tabulator.DateParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.DateParams]
    }
    
    inline def DateTimeEditorParams(): typings.tabulatorTables.mod.Tabulator.DateTimeEditorParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.DateTimeEditorParams]
    }
    
    inline def InputParams(): typings.tabulatorTables.mod.Tabulator.InputParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.InputParams]
    }
    
    inline def NumberParams(): typings.tabulatorTables.mod.Tabulator.NumberParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.NumberParams]
    }
    
    inline def SelectParams(values: `true` | (js.Array[SelectParamsGroup | String]) | JSONRecord | String): typings.tabulatorTables.mod.Tabulator.SelectParams = {
      val __obj = js.Dynamic.literal(values = values.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.SelectParams]
    }
    
    inline def TextAreaParams(): typings.tabulatorTables.mod.Tabulator.TextAreaParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.TextAreaParams]
    }
    
    inline def TimeParams(): typings.tabulatorTables.mod.Tabulator.TimeParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.TimeParams]
    }
  }
  ...
  object _FormatterParams {
    ...
    inline def DateTimeDifferenceParams(): typings.tabulatorTables.mod.Tabulator.DateTimeDifferenceParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.DateTimeDifferenceParams]
    }
    
    inline def DateTimeParams(): typings.tabulatorTables.mod.Tabulator.DateTimeParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.DateTimeParams]
    }
    
    inline def ImageParams(): typings.tabulatorTables.mod.Tabulator.ImageParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.ImageParams]
    }
    
    inline def LinkParams(): typings.tabulatorTables.mod.Tabulator.LinkParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.LinkParams]
    }
    
    inline def MoneyParams(): typings.tabulatorTables.mod.Tabulator.MoneyParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.MoneyParams]
    }
    
    inline def ProgressBarParams(): typings.tabulatorTables.mod.Tabulator.ProgressBarParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.ProgressBarParams]
    }
    
    inline def RowSelectionParams(): typings.tabulatorTables.mod.Tabulator.RowSelectionParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.RowSelectionParams]
    }
    
    inline def StarRatingParams(): typings.tabulatorTables.mod.Tabulator.StarRatingParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.StarRatingParams]
    }
    
    inline def TickCrossParams(): typings.tabulatorTables.mod.Tabulator.TickCrossParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.TickCrossParams]
    }
    
    inline def TrafficParams(): typings.tabulatorTables.mod.Tabulator.TrafficParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.tabulatorTables.mod.Tabulator.TrafficParams]
    }
  }
}
