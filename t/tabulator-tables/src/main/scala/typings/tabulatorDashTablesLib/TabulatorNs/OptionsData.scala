...
trait OptionsData extends js.Object {
  ...
  /** When using a request method other than "GET" Tabulator will send any parameters with a content type of form data. You can change the content type with the ajaxContentType option. This will ensure parameters are sent in the format you expect, with the correct headers. * * The ajaxContentType option can take one of two values:
    ...
    */
  var ajaxContentType: js.UndefOr[
    tabulatorDashTablesLib.tabulatorDashTablesLibStrings.form | tabulatorDashTablesLib.tabulatorDashTablesLibStrings.json | AjaxContentType
  ] = js.undefined
  /** The ajaxError callback is triggered there is an error response to an ajax request. */
  var ajaxError: js.UndefOr[
    js.Function3[/* xhr */ js.Any, /* textStatus */ js.Any, /* errorThrown */ js.Any, scala.Unit]
  ] = js.undefined
  /** Send filter config to server instead of processing locally	 */
  var ajaxFiltering: js.UndefOr[scala.Boolean] = js.undefined
  /** Show loader while data is loading, can also take a function that must return a boolean	 */
  var ajaxLoader: js.UndefOr[scala.Boolean | js.Function0[scala.Boolean]] = js.undefined
  /** html for the loader element in the event of an error	 */
  var ajaxLoaderError: js.UndefOr[java.lang.String] = js.undefined
  /** html for loader element	 */
  var ajaxLoaderLoading: js.UndefOr[java.lang.String] = js.undefined
  ...
  var ajaxProgressiveLoad: js.UndefOr[
    tabulatorDashTablesLib.tabulatorDashTablesLibStrings.load | tabulatorDashTablesLib.tabulatorDashTablesLibStrings.scroll
  ] = js.undefined
  ...
  var ajaxProgressiveLoadDelay: js.UndefOr[scala.Double] = js.undefined
  ...
  var ajaxProgressiveLoadScrollMargin: js.UndefOr[scala.Double] = js.undefined
  /** callback function to replace inbuilt ajax request functionality	 */
  var ajaxRequestFunc: js.UndefOr[
    js.Function3[/* url */ java.lang.String, /* config */ js.Any, /* params */ js.Any, js.Promise[_]]
  ] = js.undefined
  /** The ajaxRequesting callback is triggered when ever an ajax request is made. */
  var ajaxRequesting: js.UndefOr[js.Function2[/* url */ java.lang.String, /* params */ js.Any, scala.Boolean]] = js.undefined
  ...
  var ajaxResponse: js.UndefOr[
    js.Function3[/* url */ java.lang.String, /* params */ js.Any, /* response */ js.Any, _]
  ] = js.undefined
  /** Send sorter config to server instead of processing locally	 */
  var ajaxSorting: js.UndefOr[scala.Boolean] = js.undefined
  ...
  var ajaxURLGenerator: js.UndefOr[
    js.Function3[/* url */ java.lang.String, /* config */ js.Any, /* params */ js.Any, java.lang.String]
  ] = js.undefined
