...
object tabulatorDashTablesLibStrings {
  @js.native
  sealed trait `!=`
    extends tabulatorDashTablesLib.TabulatorNs.FilterType
  ...
  @js.native
  sealed trait GET
    extends tabulatorDashTablesLib.TabulatorNs.HttpMethod
  ...
  @js.native
  sealed trait asc
    extends tabulatorDashTablesLib.TabulatorNs.SortDirection
  ...
  @js.native
  sealed trait avg
    extends tabulatorDashTablesLib.TabulatorNs._ColumnCalc
  ...
  @js.native
  sealed trait bottom
    extends tabulatorDashTablesLib.TabulatorNs.ScrollToRowPostition
  ...
  sealed trait cellEdit
    extends tabulatorDashTablesLib.TabulatorNs.HistoryAction
  ...
  @js.native
  sealed trait csv
    extends tabulatorDashTablesLib.TabulatorNs.DownloadType
  ...
  @js.native
  sealed trait float
    extends tabulatorDashTablesLib.TabulatorNs.StandardValidatorType
  ...
  @js.native
  sealed trait middle
    extends tabulatorDashTablesLib.TabulatorNs.ScrollToColumnPosition
