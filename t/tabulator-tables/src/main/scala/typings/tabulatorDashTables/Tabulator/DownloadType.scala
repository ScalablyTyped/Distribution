...
/* Rewritten from type alias, can be one of: 
  - typings.tabulatorDashTables.tabulatorDashTablesStrings.csv
...
object DownloadType {
  ...
  @scala.inline
  def pdf: typings.tabulatorDashTables.tabulatorDashTablesStrings.pdf = this.cast("pdf")
  @scala.inline
  def xlsx: typings.tabulatorDashTables.tabulatorDashTablesStrings.xlsx = this.cast("xlsx")
}
