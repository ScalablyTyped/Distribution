...
import typings.tabulatorDashTables.tabulatorDashTablesStrings.date
import typings.tabulatorDashTables.tabulatorDashTablesStrings.datetime
...
import typings.tabulatorDashTables.tabulatorDashTablesStrings.exists
import typings.tabulatorDashTables.tabulatorDashTablesStrings.flip
import typings.tabulatorDashTables.tabulatorDashTablesStrings.number
import typings.tabulatorDashTables.tabulatorDashTablesStrings.string
import typings.tabulatorDashTables.tabulatorDashTablesStrings.time
...
object _ColumnLookup {
  ...
  def ColumnComponent(
    ...
    getField: () => String,
    getNextColumn: () => typings.tabulatorDashTables.Tabulator.ColumnComponent | `false`,
    getParentColumn: () => typings.tabulatorDashTables.Tabulator.ColumnComponent | `false`,
    getPrevColumn: () => typings.tabulatorDashTables.Tabulator.ColumnComponent | `false`,
    getSubColumns: () => js.Array[typings.tabulatorDashTables.Tabulator.ColumnComponent],
  ...
  def ColumnDefinition(
    ...
    columns: js.Array[typings.tabulatorDashTables.Tabulator.ColumnDefinition] = null,
