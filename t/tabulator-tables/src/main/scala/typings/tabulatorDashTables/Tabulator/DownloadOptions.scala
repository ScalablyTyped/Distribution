...
- typings.tabulatorDashTables.Tabulator.DownloadPDF because var conflicts: documentProcessing. Inlined orientation, title, rowGroupStyles, rowCalcStyles, jsPDF, autoTable */ trait DownloadOptions
  extends DownloadCSV
     with DownloadXLXS
     with DownloadHTML {
