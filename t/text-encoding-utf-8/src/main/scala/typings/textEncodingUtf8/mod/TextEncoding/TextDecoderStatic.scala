...
trait TextDecoderStatic
  extends Instantiable0[TextDecoder]
     ...
     with Instantiable2[js.UndefOr[/* label */ String], /* options */ TextDecoderOptions, TextDecoder] {
  def apply(): TextDecoder = js.native
  def apply(label: js.UndefOr[scala.Nothing], options: TextDecoderOptions): TextDecoder = js.native
