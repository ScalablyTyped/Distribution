...
object touchModMembers extends js.Object {
  def apply[T](filename: java.lang.String): stdLib.Promise[T] = js.native
  def apply[T](
    filename: java.lang.String,
    cb: js.Function1[/* err */ js.UndefOr[nodeLib.NodeJSNs.ErrnoException], T]
  ): stdLib.Promise[T] = js.native
  def apply[T](filename: java.lang.String, options: touchLib.touchMod.touchNs.Options): stdLib.Promise[T] = js.native
  def apply[T](
    filename: java.lang.String,
    options: touchLib.touchMod.touchNs.Options,
    cb: js.Function1[/* err */ js.UndefOr[nodeLib.NodeJSNs.ErrnoException], T]
  ): stdLib.Promise[T] = js.native
  def ftouch[T](fd: scala.Double): stdLib.Promise[T] = js.native
  def ftouch[T](fd: scala.Double, cb: js.Function1[/* err */ js.UndefOr[nodeLib.NodeJSNs.ErrnoException], T]): stdLib.Promise[T] = js.native
  def ftouch[T](fd: scala.Double, options: touchLib.touchMod.touchNs.Options): stdLib.Promise[T] = js.native
  def ftouch[T](
    fd: scala.Double,
    options: touchLib.touchMod.touchNs.Options,
    cb: js.Function1[/* err */ js.UndefOr[nodeLib.NodeJSNs.ErrnoException], T]
