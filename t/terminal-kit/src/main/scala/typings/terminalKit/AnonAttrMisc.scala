...
trait AnonAttrMisc extends js.Object {
  var attr: Double
  var misc: js.Any
  var offset: Double
  var text: String
...
object AnonAttrMisc {
  @scala.inline
  def apply(attr: Double, misc: js.Any, offset: Double, text: String, x: Double, y: Double): AnonAttrMisc = {
    ...
    __obj.asInstanceOf[AnonAttrMisc]
  }
}
