...
object CreateOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(isSSH)) __obj.updateDynamic("isSSH")(isSSH.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isTTY)) __obj.updateDynamic("isTTY")(isTTY.get.asInstanceOf[js.Any])
    if (pid != null) __obj.updateDynamic("pid")(pid.asInstanceOf[js.Any])
    if (!js.isUndefined(preferProcessSigwinch)) __obj.updateDynamic("preferProcessSigwinch")(preferProcessSigwinch.get.asInstanceOf[js.Any])
    if (!js.isUndefined(processSigwinch)) __obj.updateDynamic("processSigwinch")(processSigwinch.get.asInstanceOf[js.Any])
