...
object InputFieldOptions {
  ...
  def apply(
    ...
    tokenHook: (/* token */ java.lang.String, /* isEndOfInput */ scala.Boolean, /* previousTokens */ js.Array[java.lang.String], /* term */ Terminal, /* config */ HookConfig) => java.lang.String | CTerminal | scala.Null | scala.Unit = null,
    tokenRegExp: stdLib.RegExp = null,
    tokenResetHook: (/* term */ Terminal, /* config */ js.UndefOr[HookConfig]) => java.lang.String | CTerminal = null
  ): InputFieldOptions = {
