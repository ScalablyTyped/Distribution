...
import typings.terminalDashKit.Anon_AttrMisc
import typings.terminalDashKit.Anon_Dst_1506794770
import typings.terminalDashKit.Anon_FinalCall
import typings.terminalDashKit.Anon_Height
import typings.terminalDashKit.rectMod.Region
import typings.terminalDashKit.screenBufferMod.Attributes
import typings.terminalDashKit.screenBufferMod.DrawOptions
...
trait TextBuffer extends js.Object {
  ...
  def drawCursor(options: Anon_Dst_1506794770): Unit = js.native
