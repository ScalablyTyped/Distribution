...
import typings.three.srcConstantsMod.FrontFaceDirection
...
import typings.three.srcConstantsMod.PixelType
...
trait TypeofTHREE extends js.Object {
  ...
  var ArcCurve: Instantiable6[
    ...
    /* aEndAngle */ Double, 
    /* aClockwise */ Boolean, 
    typings.three.threeMod.ArcCurve
  ] = js.native
  var ArrayCamera: Instantiable0[typings.three.threeMod.ArrayCamera] = js.native
  var ArrowHelper: Instantiable1[/* dir */ Vector3, typings.three.threeMod.ArrowHelper] = js.native
  var Audio: Instantiable1[/* listener */ AudioListener, typings.three.threeMod.Audio] = js.native
  var AudioAnalyser: Instantiable2[/* audio */ js.Any, /* fftSize */ Double, typings.three.threeMod.AudioAnalyser] = js.native
  var AudioBuffer: Instantiable1[/* context */ js.Any, typings.three.threeMod.AudioBuffer] = js.native
  val AudioContext: typings.std.AudioContext = js.native
  var AudioListener: Instantiable0[typings.three.threeMod.AudioListener] = js.native
  var AudioLoader: Instantiable0[typings.three.threeMod.AudioLoader] = js.native
  var AxesHelper: Instantiable0[typings.three.threeMod.AxesHelper] = js.native
  ...
  var Bone: Instantiable0[typings.three.threeMod.Bone] = js.native
  var BooleanKeyframeTrack: Instantiable3[
    /* name */ String, 
    /* times */ js.Array[js.Any], 
    /* values */ js.Array[js.Any], 
    typings.three.threeMod.BooleanKeyframeTrack
  ] = js.native
  var Box2: Instantiable0[typings.three.threeMod.Box2] = js.native
  var Box3: Instantiable0[typings.three.threeMod.Box3] = js.native
  var Box3Helper: Instantiable1[/* box */ Box3, typings.three.threeMod.Box3Helper] = js.native
  var BoxBufferGeometry: Instantiable6[
    ...
    typings.three.threeMod.BoxBufferGeometry
  ] = js.native
  var BoxGeometry: Instantiable6[
    ...
    js.UndefOr[/* heightSegments */ Double], 
    js.UndefOr[/* depthSegments */ Double], 
    typings.three.threeMod.BoxGeometry
  ] = js.native
  var BoxHelper: Instantiable1[/* object */ Object3D, typings.three.threeMod.BoxHelper] = js.native
  var BufferAttribute: Instantiable2[
    /* array */ ArrayLike[Double], 
    /* itemSize */ Double, 
    typings.three.threeMod.BufferAttribute
  ] = js.native
  ...
  var CanvasTexture: Instantiable9[
    ...
    typings.three.threeMod.CanvasTexture
  ] = js.native
  var CatmullRomCurve3: Instantiable0[typings.three.threeMod.CatmullRomCurve3] = js.native
  val CineonToneMapping: ToneMapping = js.native
  var CircleBufferGeometry: Instantiable0[typings.three.threeMod.CircleBufferGeometry] = js.native
  var CircleGeometry: Instantiable0[typings.three.threeMod.CircleGeometry] = js.native
  val ClampToEdgeWrapping: Wrapping = js.native
  var Clock: Instantiable0[typings.three.threeMod.Clock] = js.native
  var Color: Instantiable0[typings.three.threeMod.Color] = js.native
  ...
  var CompressedTexture: Instantiable12[
    ...
    typings.three.threeMod.CompressedTexture
  ] = js.native
  var CompressedTextureLoader: Instantiable0[typings.three.threeMod.CompressedTextureLoader] = js.native
  var ConeBufferGeometry: Instantiable7[
    ...
    typings.three.threeMod.ConeBufferGeometry
  ] = js.native
  var ConeGeometry: Instantiable7[
    ...
    js.UndefOr[/* thetaStart */ Double], 
    js.UndefOr[/* thetaLength */ Double], 
    typings.three.threeMod.ConeGeometry
  ] = js.native
  var CubeCamera: Instantiable0[typings.three.threeMod.CubeCamera] = js.native
  ...
  var CubeTexture: Instantiable10[
    ...
    js.UndefOr[/* anisotropy */ Double], 
    js.UndefOr[/* encoding */ TextureEncoding], 
    typings.three.threeMod.CubeTexture
  ] = js.native
  var CubeTextureLoader: Instantiable0[typings.three.threeMod.CubeTextureLoader] = js.native
  ...
  var CubicBezierCurve: Instantiable4[
    ...
    /* v2 */ Vector2, 
    /* v3 */ Vector2, 
    typings.three.threeMod.CubicBezierCurve
  ] = js.native
  var CubicBezierCurve3: Instantiable4[
    ...
    /* v2 */ Vector3, 
    /* v3 */ Vector3, 
    typings.three.threeMod.CubicBezierCurve3
  ] = js.native
  var CubicInterpolant: Instantiable3[
    /* parameterPositions */ js.Any, 
    /* samplesValues */ js.Any, 
    /* sampleSize */ Double, 
    typings.three.threeMod.CubicInterpolant
  ] = js.native
  ...
  var CylinderBufferGeometry: Instantiable8[
    ...
    js.UndefOr[/* thetaStart */ Double], 
    js.UndefOr[/* thetaLength */ Double], 
    typings.three.threeMod.CylinderBufferGeometry
  ] = js.native
  var CylinderGeometry: Instantiable8[
    ...
    js.UndefOr[/* thetaStart */ Double], 
    js.UndefOr[/* thetaLength */ Double], 
    typings.three.threeMod.CylinderGeometry
  ] = js.native
  var Cylindrical: Instantiable0[typings.three.threeMod.Cylindrical] = js.native
  var DataTexture: Instantiable12[
    ...
    js.UndefOr[/* anisotropy */ Double], 
    js.UndefOr[/* encoding */ TextureEncoding], 
    typings.three.threeMod.DataTexture
  ] = js.native
  ...
  var DepthTexture: Instantiable9[
    ...
    js.UndefOr[/* minFilter */ TextureFilter], 
    js.UndefOr[/* anisotropy */ Double], 
    typings.three.threeMod.DepthTexture
  ] = js.native
  var DirectGeometry: Instantiable0[typings.three.threeMod.DirectGeometry] = js.native
  var DirectionalLight: Instantiable0[typings.three.threeMod.DirectionalLight] = js.native
  var DirectionalLightHelper: Instantiable1[/* light */ DirectionalLight, typings.three.threeMod.DirectionalLightHelper] = js.native
  var DirectionalLightShadow: Instantiable0[typings.three.threeMod.DirectionalLightShadow] = js.native
  var DiscreteInterpolant: Instantiable3[
    /* parameterPositions */ js.Any, 
    /* samplesValues */ js.Any, 
    /* sampleSize */ Double, 
    typings.three.threeMod.DiscreteInterpolant
  ] = js.native
  var DodecahedronBufferGeometry: Instantiable0[typings.three.threeMod.DodecahedronBufferGeometry] = js.native
  var DodecahedronGeometry: Instantiable0[typings.three.threeMod.DodecahedronGeometry] = js.native
  ...
  var EdgesGeometry: Instantiable1[/* geometry */ BufferGeometry, typings.three.threeMod.EdgesGeometry] = js.native
  ...
  var EventDispatcher: Instantiable0[typings.three.threeMod.EventDispatcher] = js.native
  ...
  var Face3: Instantiable3[/* a */ Double, /* b */ Double, /* c */ Double, typings.three.threeMod.Face3] = js.native
  val FaceColors: Colors = js.native
  var FaceNormalsHelper: Instantiable1[/* object */ Object3D, typings.three.threeMod.FaceNormalsHelper] = js.native
  var FileLoader: Instantiable0[typings.three.threeMod.FileLoader] = js.native
  val FlatShading: Shading = js.native
  var Float32Attribute: Instantiable2[/* array */ js.Any, /* itemSize */ Double, typings.three.threeMod.Float32Attribute] = js.native
  var Float32BufferAttribute: Instantiable2[
    /* array */ Iterable[Double], 
    /* itemSize */ Double, 
    typings.three.threeMod.Float32BufferAttribute
  ] = js.native
  var Float64Attribute: Instantiable2[/* array */ js.Any, /* itemSize */ Double, typings.three.threeMod.Float64Attribute] = js.native
  var Float64BufferAttribute: Instantiable2[
    /* array */ Iterable[Double], 
    /* itemSize */ Double, 
    typings.three.threeMod.Float64BufferAttribute
  ] = js.native
  val FloatType: TextureDataType = js.native
  var Fog: Instantiable1[/* hex */ Double, typings.three.threeMod.Fog] = js.native
  var FogExp2: Instantiable1[/* hex */ Double, typings.three.threeMod.FogExp2] = js.native
  var Font: Instantiable1[/* jsondata */ js.Any, typings.three.threeMod.Font] = js.native
  var FontLoader: Instantiable0[typings.three.threeMod.FontLoader] = js.native
  ...
  var Frustum: Instantiable6[
    ...
    js.UndefOr[/* p4 */ Plane], 
    js.UndefOr[/* p5 */ Plane], 
    typings.three.threeMod.Frustum
  ] = js.native
  ...
  var HemisphereLight: Instantiable0[typings.three.threeMod.HemisphereLight] = js.native
  var HemisphereLightHelper: Instantiable2[
    /* light */ HemisphereLight, 
    /* size */ Double, 
    typings.three.threeMod.HemisphereLightHelper
  ] = js.native
  var HemisphereLightProbe: Instantiable0[typings.three.threeMod.HemisphereLightProbe] = js.native
  var IcosahedronBufferGeometry: Instantiable0[typings.three.threeMod.IcosahedronBufferGeometry] = js.native
  ...
  var InstancedBufferAttribute: Instantiable2[
    /* array */ ArrayLike[Double], 
    /* itemSize */ Double, 
    typings.three.threeMod.InstancedBufferAttribute
  ] = js.native
  var InstancedBufferGeometry: Instantiable0[typings.three.threeMod.InstancedBufferGeometry] = js.native
  var InstancedInterleavedBuffer: Instantiable2[
    /* array */ ArrayLike[Double], 
    /* stride */ Double, 
    typings.three.threeMod.InstancedInterleavedBuffer
  ] = js.native
  var Int16Attribute: Instantiable2[/* array */ js.Any, /* itemSize */ Double, typings.three.threeMod.Int16Attribute] = js.native
  var Int16BufferAttribute: Instantiable2[
    /* array */ Iterable[Double], 
    /* itemSize */ Double, 
    typings.three.threeMod.Int16BufferAttribute
  ] = js.native
  var Int32Attribute: Instantiable2[/* array */ js.Any, /* itemSize */ Double, typings.three.threeMod.Int32Attribute] = js.native
  var Int32BufferAttribute: Instantiable2[
    /* array */ Iterable[Double], 
    /* itemSize */ Double, 
    typings.three.threeMod.Int32BufferAttribute
  ] = js.native
  var Int8Attribute: Instantiable2[/* array */ js.Any, /* itemSize */ Double, typings.three.threeMod.Int8Attribute] = js.native
  var Int8BufferAttribute: Instantiable2[
    /* array */ Iterable[Double], 
    /* itemSize */ Double, 
    typings.three.threeMod.Int8BufferAttribute
  ] = js.native
  val IntType: TextureDataType = js.native
  var InterleavedBuffer: Instantiable2[
    /* array */ ArrayLike[Double], 
    /* stride */ Double, 
    typings.three.threeMod.InterleavedBuffer
  ] = js.native
  var InterleavedBufferAttribute: Instantiable3[
    /* interleavedBuffer */ InterleavedBuffer, 
    /* itemSize */ Double, 
    /* offset */ Double, 
    typings.three.threeMod.InterleavedBufferAttribute
  ] = js.native
  var Interpolant: Instantiable3[
    /* parameterPositions */ js.Any, 
    /* samplesValues */ js.Any, 
    /* sampleSize */ Double, 
    typings.three.threeMod.Interpolant
  ] = js.native
  ...
  var LatheGeometry: Instantiable1[/* points */ js.Array[Vector2], typings.three.threeMod.LatheGeometry] = js.native
  ...
  var Line: Instantiable0[typings.three.threeMod.Line] = js.native
  var Line3: Instantiable0[typings.three.threeMod.Line3] = js.native
  var LineBasicMaterial: Instantiable0[typings.three.threeMod.LineBasicMaterial] = js.native
  var LineCurve: Instantiable2[/* v1 */ Vector2, /* v2 */ Vector2, typings.three.threeMod.LineCurve] = js.native
  var LineCurve3: Instantiable2[/* v1 */ Vector3, /* v2 */ Vector3, typings.three.threeMod.LineCurve3] = js.native
  var LineDashedMaterial: Instantiable0[typings.three.threeMod.LineDashedMaterial] = js.native
  var LineLoop: Instantiable0[typings.three.threeMod.LineLoop] = js.native
  val LinePieces: Double = js.native
  var LineSegments: Instantiable0[typings.three.threeMod.LineSegments] = js.native
  ...
  var LinearInterpolant: Instantiable3[
    ...
    /* samplesValues */ js.Any, 
    /* sampleSize */ Double, 
    typings.three.threeMod.LinearInterpolant
  ] = js.native
  ...
  var Mesh: Instantiable0[typings.three.threeMod.Mesh] = js.native
  var MeshBasicMaterial: Instantiable0[typings.three.threeMod.MeshBasicMaterial] = js.native
  var MeshDepthMaterial: Instantiable0[typings.three.threeMod.MeshDepthMaterial] = js.native
  var MeshDistanceMaterial: Instantiable0[typings.three.threeMod.MeshDistanceMaterial] = js.native
  var MeshLambertMaterial: Instantiable0[typings.three.threeMod.MeshLambertMaterial] = js.native
  var MeshMatcapMaterial: Instantiable0[typings.three.threeMod.MeshMatcapMaterial] = js.native
  var MeshNormalMaterial: Instantiable0[typings.three.threeMod.MeshNormalMaterial] = js.native
  var MeshPhongMaterial: Instantiable0[typings.three.threeMod.MeshPhongMaterial] = js.native
  var MeshPhysicalMaterial: Instantiable1[
    /* parameters */ MeshPhysicalMaterialParameters, 
    typings.three.threeMod.MeshPhysicalMaterial
  ] = js.native
  var MeshStandardMaterial: Instantiable0[typings.three.threeMod.MeshStandardMaterial] = js.native
  var MeshToonMaterial: Instantiable0[typings.three.threeMod.MeshToonMaterial] = js.native
  ...
  var MultiMaterial: Instantiable0[typings.three.threeMod.MultiMaterial] = js.native
  ...
  var NumberKeyframeTrack: Instantiable3[
    ...
    /* times */ js.Array[js.Any], 
    /* values */ js.Array[js.Any], 
    typings.three.threeMod.NumberKeyframeTrack
  ] = js.native
  var Object3D: TypeofClassObject3D = js.native
  var Object3DIdCount: Double = js.native
  var ObjectLoader: Instantiable0[typings.three.threeMod.ObjectLoader] = js.native
  val ObjectSpaceNormalMap: NormalMapTypes = js.native
  var OctahedronBufferGeometry: Instantiable0[typings.three.threeMod.OctahedronBufferGeometry] = js.native
  var OctahedronGeometry: Instantiable0[typings.three.threeMod.OctahedronGeometry] = js.native
  ...
  var OrthographicCamera: Instantiable4[
    ...
    /* top */ Double, 
    /* bottom */ Double, 
    typings.three.threeMod.OrthographicCamera
  ] = js.native
  ...
  var ParametricBufferGeometry: Instantiable3[
    ...
    /* slices */ Double, 
    /* stacks */ Double, 
    typings.three.threeMod.ParametricBufferGeometry
  ] = js.native
  var ParametricGeometry: Instantiable3[
    /* func */ js.Function3[/* u */ Double, /* v */ Double, /* dest */ Vector3, Unit], 
    /* slices */ Double, 
    /* stacks */ Double, 
    typings.three.threeMod.ParametricGeometry
  ] = js.native
  var Path: Instantiable0[typings.three.threeMod.Path] = js.native
  var PerspectiveCamera: Instantiable0[typings.three.threeMod.PerspectiveCamera] = js.native
  var Plane: Instantiable0[typings.three.threeMod.Plane] = js.native
  var PlaneBufferGeometry: Instantiable0[typings.three.threeMod.PlaneBufferGeometry] = js.native
  var PlaneGeometry: Instantiable0[typings.three.threeMod.PlaneGeometry] = js.native
  var PlaneHelper: Instantiable1[/* plane */ Plane, typings.three.threeMod.PlaneHelper] = js.native
  var PointLight: Instantiable0[typings.three.threeMod.PointLight] = js.native
  var PointLightHelper: Instantiable1[/* light */ PointLight, typings.three.threeMod.PointLightHelper] = js.native
  var PointLightShadow: Instantiable0[typings.three.threeMod.PointLightShadow] = js.native
  var Points: Instantiable0[typings.three.threeMod.Points] = js.native
  var PointsMaterial: Instantiable0[typings.three.threeMod.PointsMaterial] = js.native
  var PolarGridHelper: Instantiable6[
    ...
    /* color1 */ Color, 
    /* color2 */ Color, 
    typings.three.threeMod.PolarGridHelper
  ] = js.native
  var PolyhedronBufferGeometry: Instantiable2[
    /* vertices */ js.Array[Double], 
    /* indices */ js.Array[Double], 
    typings.three.threeMod.PolyhedronBufferGeometry
  ] = js.native
  var PolyhedronGeometry: Instantiable2[
    /* vertices */ js.Array[Double], 
    /* indices */ js.Array[Double], 
    typings.three.threeMod.PolyhedronGeometry
  ] = js.native
  ...
  var PropertyMixer: Instantiable3[
    ...
    /* typeName */ String, 
    /* valueSize */ Double, 
    typings.three.threeMod.PropertyMixer
  ] = js.native
  var QuadraticBezierCurve: Instantiable3[
    /* v0 */ Vector2, 
    /* v1 */ Vector2, 
    /* v2 */ Vector2, 
    typings.three.threeMod.QuadraticBezierCurve
  ] = js.native
  var QuadraticBezierCurve3: Instantiable3[
    /* v0 */ Vector3, 
    /* v1 */ Vector3, 
    /* v2 */ Vector3, 
    typings.three.threeMod.QuadraticBezierCurve3
  ] = js.native
  ...
  var QuaternionKeyframeTrack: Instantiable3[
    ...
    /* times */ js.Array[js.Any], 
    /* values */ js.Array[js.Any], 
    typings.three.threeMod.QuaternionKeyframeTrack
  ] = js.native
  var QuaternionLinearInterpolant: Instantiable3[
    /* parameterPositions */ js.Any, 
    /* samplesValues */ js.Any, 
    /* sampleSize */ Double, 
    typings.three.threeMod.QuaternionLinearInterpolant
  ] = js.native
  ...
  var RawShaderMaterial: Instantiable0[typings.three.threeMod.RawShaderMaterial] = js.native
  var Ray: Instantiable0[typings.three.threeMod.Ray] = js.native
  var Raycaster: Instantiable0[typings.three.threeMod.Raycaster] = js.native
  var RectAreaLight: Instantiable0[typings.three.threeMod.RectAreaLight] = js.native
  var RectAreaLightHelper: Instantiable1[/* light */ RectAreaLight, typings.three.threeMod.RectAreaLightHelper] = js.native
  ...
  var RingBufferGeometry: Instantiable6[
    ...
    js.UndefOr[/* thetaStart */ Double], 
    js.UndefOr[/* thetaLength */ Double], 
    typings.three.threeMod.RingBufferGeometry
  ] = js.native
  ...
  var SkinnedMesh: Instantiable0[typings.three.threeMod.SkinnedMesh] = js.native
  val SmoothShading: Shading = js.native
  var Sphere: Instantiable0[typings.three.threeMod.Sphere] = js.native
  var SphereBufferGeometry: Instantiable7[
    ...
    js.UndefOr[/* thetaStart */ Double], 
    js.UndefOr[/* thetaLength */ Double], 
    typings.three.threeMod.SphereBufferGeometry
  ] = js.native
  var SphereGeometry: Instantiable7[
    ...
    js.UndefOr[/* thetaStart */ Double], 
    js.UndefOr[/* thetaLength */ Double], 
    typings.three.threeMod.SphereGeometry
  ] = js.native
  var Spherical: Instantiable0[typings.three.threeMod.Spherical] = js.native
  var SphericalHarmonics3: TypeofClassSphericalHarmonics3 = js.native
  val SphericalReflectionMapping: Mapping = js.native
  var SplineCurve: Instantiable0[typings.three.threeMod.SplineCurve] = js.native
  ...
  var SpotLightHelper: Instantiable1[/* light */ Light, typings.three.threeMod.SpotLightHelper] = js.native
  var SpotLightShadow: Instantiable0[typings.three.threeMod.SpotLightShadow] = js.native
  var Sprite: Instantiable0[typings.three.threeMod.Sprite] = js.native
  var SpriteMaterial: Instantiable0[typings.three.threeMod.SpriteMaterial] = js.native
  ...
  var StereoCamera: Instantiable0[typings.three.threeMod.StereoCamera] = js.native
  var StringKeyframeTrack: Instantiable3[
    /* name */ String, 
    /* times */ js.Array[js.Any], 
    /* values */ js.Array[js.Any], 
    typings.three.threeMod.StringKeyframeTrack
  ] = js.native
  ...
  var TetrahedronBufferGeometry: Instantiable0[typings.three.threeMod.TetrahedronBufferGeometry] = js.native
  var TetrahedronGeometry: Instantiable0[typings.three.threeMod.TetrahedronGeometry] = js.native
  var TextBufferGeometry: Instantiable1[/* text */ String, typings.three.threeMod.TextBufferGeometry] = js.native
  var TextGeometry: Instantiable1[/* text */ String, typings.three.threeMod.TextGeometry] = js.native
  var Texture: TypeofClassTexture = js.native
  var TextureIdCount: Double = js.native
  var TextureLoader: Instantiable0[typings.three.threeMod.TextureLoader] = js.native
  var TorusBufferGeometry: Instantiable0[typings.three.threeMod.TorusBufferGeometry] = js.native
  var TorusGeometry: Instantiable0[typings.three.threeMod.TorusGeometry] = js.native
  var TorusKnotBufferGeometry: Instantiable6[
    ...
    js.UndefOr[/* p */ Double], 
    js.UndefOr[/* q */ Double], 
    typings.three.threeMod.TorusKnotBufferGeometry
  ] = js.native
  var TorusKnotGeometry: Instantiable6[
    ...
    js.UndefOr[/* p */ Double], 
    js.UndefOr[/* q */ Double], 
    typings.three.threeMod.TorusKnotGeometry
  ] = js.native
  ...
  var TubeBufferGeometry: Instantiable1[/* path */ Curve[Vector3], typings.three.threeMod.TubeBufferGeometry] = js.native
  var TubeGeometry: Instantiable1[/* path */ Curve[Vector3], typings.three.threeMod.TubeGeometry] = js.native
  val UVMapping: Mapping = js.native
  var Uint16Attribute: Instantiable2[/* array */ js.Any, /* itemSize */ Double, typings.three.threeMod.Uint16Attribute] = js.native
  var Uint16BufferAttribute: Instantiable2[
    /* array */ Iterable[Double], 
    /* itemSize */ Double, 
    typings.three.threeMod.Uint16BufferAttribute
  ] = js.native
  var Uint32Attribute: Instantiable2[/* array */ js.Any, /* itemSize */ Double, typings.three.threeMod.Uint32Attribute] = js.native
  var Uint32BufferAttribute: Instantiable2[
    /* array */ Iterable[Double], 
    /* itemSize */ Double, 
    typings.three.threeMod.Uint32BufferAttribute
  ] = js.native
  var Uint8Attribute: Instantiable2[/* array */ js.Any, /* itemSize */ Double, typings.three.threeMod.Uint8Attribute] = js.native
  var Uint8BufferAttribute: Instantiable2[
    /* array */ Iterable[Double], 
    /* itemSize */ Double, 
    typings.three.threeMod.Uint8BufferAttribute
  ] = js.native
  var Uint8ClampedAttribute: Instantiable2[
    /* array */ js.Any, 
    /* itemSize */ Double, 
    typings.three.threeMod.Uint8ClampedAttribute
  ] = js.native
  var Uint8ClampedBufferAttribute: Instantiable2[
    /* array */ Iterable[Double], 
    /* itemSize */ Double, 
    typings.three.threeMod.Uint8ClampedBufferAttribute
  ] = js.native
  ...
  var VectorKeyframeTrack: Instantiable3[
    ...
    /* times */ js.Array[js.Any], 
    /* values */ js.Array[js.Any], 
    typings.three.threeMod.VectorKeyframeTrack
  ] = js.native
  val VertexColors: Colors = js.native
  var VertexNormalsHelper: Instantiable1[/* object */ Object3D, typings.three.threeMod.VertexNormalsHelper] = js.native
  var VideoTexture: Instantiable9[
    ...
    js.UndefOr[/* type */ TextureDataType], 
    js.UndefOr[/* anisotropy */ Double], 
    typings.three.threeMod.VideoTexture
  ] = js.native
  var WebGLBufferRenderer: Instantiable3[
    /* _gl */ WebGLRenderingContext, 
    /* extensions */ js.Any, 
    /* _infoRender */ js.Any, 
    typings.three.threeMod.WebGLBufferRenderer
  ] = js.native
  var WebGLCapabilities: Instantiable3[
    /* gl */ WebGLRenderingContext, 
    /* extensions */ js.Any, 
    /* parameters */ WebGLCapabilitiesParameters, 
    typings.three.threeMod.WebGLCapabilities
  ] = js.native
  var WebGLClipping: Instantiable0[typings.three.threeMod.WebGLClipping] = js.native
  var WebGLColorBuffer: Instantiable0[typings.three.threeMod.WebGLColorBuffer] = js.native
  var WebGLDepthBuffer: Instantiable0[typings.three.threeMod.WebGLDepthBuffer] = js.native
  var WebGLExtensions: Instantiable1[/* gl */ WebGLRenderingContext, typings.three.threeMod.WebGLExtensions] = js.native
  var WebGLGeometries: Instantiable3[
    /* gl */ WebGLRenderingContext, 
    /* extensions */ js.Any, 
    /* _infoRender */ js.Any, 
    typings.three.threeMod.WebGLGeometries
  ] = js.native
  var WebGLIndexedBufferRenderer: Instantiable3[
    /* gl */ WebGLRenderingContext, 
    /* properties */ js.Any, 
    /* info */ js.Any, 
    typings.three.threeMod.WebGLIndexedBufferRenderer
  ] = js.native
  var WebGLInfo: Instantiable0[typings.three.threeMod.WebGLInfo] = js.native
  var WebGLLights: Instantiable3[
    /* gl */ WebGLRenderingContext, 
    /* properties */ js.Any, 
    /* info */ js.Any, 
    typings.three.threeMod.WebGLLights
  ] = js.native
  var WebGLMultisampleRenderTarget: Instantiable2[
    /* width */ Double, 
    /* height */ Double, 
    typings.three.threeMod.WebGLMultisampleRenderTarget
  ] = js.native
  ...
  var WebGLPrograms: Instantiable3[
    ...
    typings.three.threeMod.WebGLPrograms
  ] = js.native
  var WebGLProperties: Instantiable0[typings.three.threeMod.WebGLProperties] = js.native
  var WebGLRenderList: Instantiable0[typings.three.threeMod.WebGLRenderList] = js.native
  var WebGLRenderLists: Instantiable0[typings.three.threeMod.WebGLRenderLists] = js.native
  var WebGLRenderTarget: Instantiable2[/* width */ Double, /* height */ Double, typings.three.threeMod.WebGLRenderTarget] = js.native
  var WebGLRenderTargetCube: Instantiable2[
    /* width */ Double, 
    /* height */ Double, 
    typings.three.threeMod.WebGLRenderTargetCube
  ] = js.native
  var WebGLRenderer: Instantiable0[typings.three.threeMod.WebGLRenderer] = js.native
  var WebGLShader: Instantiable3[
    /* gl */ js.Any, 
    /* type */ String, 
    /* string */ String, 
    typings.three.threeMod.WebGLShader
  ] = js.native
  var WebGLShadowMap: Instantiable4[
    ...
    /* capabilities */ js.Any, 
    typings.three.threeMod.WebGLShadowMap
  ] = js.native
  var WebGLState: Instantiable4[
    ...
    /* utils */ js.Any, 
    /* capabilities */ WebGLCapabilities, 
    typings.three.threeMod.WebGLState
  ] = js.native
  var WebGLStencilBuffer: Instantiable0[typings.three.threeMod.WebGLStencilBuffer] = js.native
  ...
  var WireframeGeometry: Instantiable1[/* geometry */ Geometry, typings.three.threeMod.WireframeGeometry] = js.native
