...
trait Anon_AAClockwise extends js.Object {
  ...
  var ExtrudeBufferGeometry: Anon_ShapesWorldUVGenerator = js.native
  var ExtrudeGeometry: Anon_Shapes = js.native
  ...
  var KeyframeTrack: Anon_Json = js.native
  ...
  var LensFlareElement: Anon_Geometry = js.native
