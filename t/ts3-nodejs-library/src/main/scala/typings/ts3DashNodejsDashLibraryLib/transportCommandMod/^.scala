...
class ^ () extends Command {
  /**
    ...
    */
  /* CompleteClass */
  override def build(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def hasError(): scala.Boolean = js.native
  /**
    * Checks wether there are flags used with this command
    */
  /* CompleteClass */
  override def hasFlags(): scala.Boolean = js.native
  /**
    * Checks wether there are options used with this command
    */
  /* CompleteClass */
  override def hasMultiOptions(): scala.Boolean = js.native
  /**
    * Checks wether there are options used with this command
    */
  /* CompleteClass */
  override def hasOptions(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setCommand(cmd: java.lang.String): this.type = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def setError(error: java.lang.String): this.type = js.native
  /**
    * Set TeamSpeak Flags
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setResponse(line: java.lang.String): this.type = js.native
}
...
object ^ extends js.Object {
  /**
    ...
    */
  def parse(data: java.lang.String): js.Any = js.native
  /**
    ...
    * @returns the parsed Data
    */
  def parseValue(k: java.lang.String, v: js.Any): js.Any = js.native
}
