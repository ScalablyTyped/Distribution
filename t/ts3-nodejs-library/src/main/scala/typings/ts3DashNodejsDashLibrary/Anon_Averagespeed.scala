...
import typings.ts3DashNodejsDashLibrary.libTransportCommandMod.Command.ParserArgument
import typings.ts3DashNodejsDashLibrary.libTransportCommandMod.Command.Parsers
...
@js.native
trait Anon_Averagespeed extends Instantiable0[Command] {
