...
object ServerEdit {
  ...
  def apply(
    ...
    if (virtualserver_codec_encryption_mode != null) __obj.updateDynamic("virtualserver_codec_encryption_mode")(virtualserver_codec_encryption_mode)
    ...
    if (virtualserver_hostbanner_gfx_url != null) __obj.updateDynamic("virtualserver_hostbanner_gfx_url")(virtualserver_hostbanner_gfx_url)
    if (virtualserver_hostbanner_mode != null) __obj.updateDynamic("virtualserver_hostbanner_mode")(virtualserver_hostbanner_mode)
    if (virtualserver_hostbanner_url != null) __obj.updateDynamic("virtualserver_hostbanner_url")(virtualserver_hostbanner_url)
    if (virtualserver_hostbutton_gfx_url != null) __obj.updateDynamic("virtualserver_hostbutton_gfx_url")(virtualserver_hostbutton_gfx_url)
    if (virtualserver_hostbutton_tooltip != null) __obj.updateDynamic("virtualserver_hostbutton_tooltip")(virtualserver_hostbutton_tooltip)
    if (virtualserver_hostbutton_url != null) __obj.updateDynamic("virtualserver_hostbutton_url")(virtualserver_hostbutton_url)
    if (virtualserver_hostmessage != null) __obj.updateDynamic("virtualserver_hostmessage")(virtualserver_hostmessage)
    if (virtualserver_hostmessage_mode != null) __obj.updateDynamic("virtualserver_hostmessage_mode")(virtualserver_hostmessage_mode)
    ...
    if (virtualserver_machine_id != null) __obj.updateDynamic("virtualserver_machine_id")(virtualserver_machine_id)
    ...
    if (virtualserver_name != null) __obj.updateDynamic("virtualserver_name")(virtualserver_name)
    if (virtualserver_name_phonetic != null) __obj.updateDynamic("virtualserver_name_phonetic")(virtualserver_name_phonetic)
    ...
    if (virtualserver_password != null) __obj.updateDynamic("virtualserver_password")(virtualserver_password)
    ...
    if (virtualserver_status != null) __obj.updateDynamic("virtualserver_status")(virtualserver_status)
    ...
    if (virtualserver_welcomemessage != null) __obj.updateDynamic("virtualserver_welcomemessage")(virtualserver_welcomemessage)
