...
object libNodeClientMod extends js.Object {
  ...
  class TeamSpeakClient protected () extends Abstract {
    ...
    val away: js.UndefOr[Double] = js.native
    val awayMessage: js.UndefOr[String] = js.native
    val badges: js.UndefOr[String] = js.native
    val channelGroupId: js.UndefOr[Double] = js.native
    val channelGroupInheritedChannelId: js.UndefOr[Double] = js.native
    val cid: Double = js.native
    val clid: Double = js.native
    val connectionClientIp: js.UndefOr[String] = js.native
    val country: js.UndefOr[String] = js.native
    val created: js.UndefOr[Double] = js.native
    val databaseId: Double = js.native
    val flagTalking: js.UndefOr[Double] = js.native
    val idleTime: js.UndefOr[Double] = js.native
    val inputHardware: js.UndefOr[Double] = js.native
    val inputMuted: js.UndefOr[Double] = js.native
    val isChannelCommander: js.UndefOr[Double] = js.native
    val isPrioritySpeaker: js.UndefOr[Double] = js.native
    val isRecording: js.UndefOr[Double] = js.native
    val isTalker: js.UndefOr[Double] = js.native
    val lastconnected: js.UndefOr[Double] = js.native
    val nickname: String = js.native
    val outputHardware: js.UndefOr[Double] = js.native
    val outputMuted: js.UndefOr[Double] = js.native
    val platform: js.UndefOr[String] = js.native
    val servergroups: js.UndefOr[js.Array[Double]] = js.native
    val talkPower: js.UndefOr[Double] = js.native
    val `type`: ClientType = js.native
