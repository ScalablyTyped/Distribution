...
import typings.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryBooleans.`false`
import typings.ts3DashNodejsDashLibrary.ts3DashNodejsDashLibraryBooleans.`true`
