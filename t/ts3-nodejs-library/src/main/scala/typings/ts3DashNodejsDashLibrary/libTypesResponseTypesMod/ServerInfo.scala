...
object ServerInfo {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(virtualserver_antiflood_points_needed_command_block = virtualserver_antiflood_points_needed_command_block, virtualserver_antiflood_points_needed_ip_block = virtualserver_antiflood_points_needed_ip_block, virtualserver_antiflood_points_needed_plugin_block = virtualserver_antiflood_points_needed_plugin_block, virtualserver_antiflood_points_tick_reduce = virtualserver_antiflood_points_tick_reduce, virtualserver_channel_temp_delete_delay_default = virtualserver_channel_temp_delete_delay_default, virtualserver_codec_encryption_mode = virtualserver_codec_encryption_mode, virtualserver_complain_autoban_count = virtualserver_complain_autoban_count, virtualserver_complain_autoban_time = virtualserver_complain_autoban_time, virtualserver_complain_remove_time = virtualserver_complain_remove_time, virtualserver_created = virtualserver_created, virtualserver_default_channel_admin_group = virtualserver_default_channel_admin_group, virtualserver_default_channel_group = virtualserver_default_channel_group, virtualserver_default_server_group = virtualserver_default_server_group, virtualserver_download_quota = virtualserver_download_quota, virtualserver_filebase = virtualserver_filebase, virtualserver_flag_password = virtualserver_flag_password, virtualserver_hostbanner_gfx_interval = virtualserver_hostbanner_gfx_interval, virtualserver_hostbanner_gfx_url = virtualserver_hostbanner_gfx_url, virtualserver_hostbanner_mode = virtualserver_hostbanner_mode, virtualserver_hostbanner_url = virtualserver_hostbanner_url, virtualserver_hostbutton_gfx_url = virtualserver_hostbutton_gfx_url, virtualserver_hostbutton_tooltip = virtualserver_hostbutton_tooltip, virtualserver_hostbutton_url = virtualserver_hostbutton_url, virtualserver_hostmessage = virtualserver_hostmessage, virtualserver_hostmessage_mode = virtualserver_hostmessage_mode, virtualserver_icon_id = virtualserver_icon_id, virtualserver_log_channel = virtualserver_log_channel, virtualserver_log_client = virtualserver_log_client, virtualserver_log_filetransfer = virtualserver_log_filetransfer, virtualserver_log_permissions = virtualserver_log_permissions, virtualserver_log_query = virtualserver_log_query, virtualserver_log_server = virtualserver_log_server, virtualserver_max_download_total_bandwidth = virtualserver_max_download_total_bandwidth, virtualserver_max_upload_total_bandwidth = virtualserver_max_upload_total_bandwidth, virtualserver_maxclients = virtualserver_maxclients, virtualserver_min_android_version = virtualserver_min_android_version, virtualserver_min_client_version = virtualserver_min_client_version, virtualserver_min_clients_in_channel_before_forced_silence = virtualserver_min_clients_in_channel_before_forced_silence, virtualserver_min_ios_version = virtualserver_min_ios_version, virtualserver_name = virtualserver_name, virtualserver_name_phonetic = virtualserver_name_phonetic, virtualserver_needed_identity_security_level = virtualserver_needed_identity_security_level, virtualserver_nickname = virtualserver_nickname, virtualserver_password = virtualserver_password, virtualserver_priority_speaker_dimm_modificator = virtualserver_priority_speaker_dimm_modificator, virtualserver_reserved_slots = virtualserver_reserved_slots, virtualserver_status = virtualserver_status, virtualserver_unique_identifier = virtualserver_unique_identifier, virtualserver_upload_quota = virtualserver_upload_quota, virtualserver_weblist_enabled = virtualserver_weblist_enabled, virtualserver_welcomemessage = virtualserver_welcomemessage)
