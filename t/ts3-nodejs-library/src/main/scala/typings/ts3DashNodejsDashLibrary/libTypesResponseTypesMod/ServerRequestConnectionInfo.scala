...
object ServerRequestConnectionInfo {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(connection_bandwidth_received_last_minute_total = connection_bandwidth_received_last_minute_total, connection_bandwidth_received_last_second_total = connection_bandwidth_received_last_second_total, connection_bandwidth_sent_last_minute_total = connection_bandwidth_sent_last_minute_total, connection_bandwidth_sent_last_second_total = connection_bandwidth_sent_last_second_total, connection_bytes_received_total = connection_bytes_received_total, connection_bytes_sent_total = connection_bytes_sent_total, connection_connected_time = connection_connected_time, connection_filetransfer_bandwidth_received = connection_filetransfer_bandwidth_received, connection_filetransfer_bandwidth_sent = connection_filetransfer_bandwidth_sent, connection_filetransfer_bytes_received_total = connection_filetransfer_bytes_received_total, connection_filetransfer_bytes_sent_total = connection_filetransfer_bytes_sent_total, connection_packetloss_total = connection_packetloss_total, connection_packets_received_total = connection_packets_received_total, connection_packets_sent_total = connection_packets_sent_total, connection_ping = connection_ping)
