...
trait Command extends js.Object {
  ...
  /**
    ...
    */
  def setCommand(cmd: String): this.type
  /**
    ...
    */
  def setError(error: String): this.type
  /**
    * Set TeamSpeak Flags
  ...
  /**
    ...
    */
  def setResponse(line: String): this.type
}
