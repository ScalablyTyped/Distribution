...
object PartialChannelEntry {
  ...
  inline def apply(): PartialChannelEntry = {
  ...
  extension [Self <: PartialChannelEntry](x: Self) {
    ...
    inline def setChannelBannerGfxUrlUndefined: Self = StObject.set(x, "channelBannerGfxUrl", js.undefined)
    
    inline def setChannelBannerMode(value: Double): Self = StObject.set(x, "channelBannerMode", value.asInstanceOf[js.Any])
    
    inline def setChannelBannerModeUndefined: Self = StObject.set(x, "channelBannerMode", js.undefined)
    ...
    inline def setChannelFlagPasswordUndefined: Self = StObject.set(x, "channelFlagPassword", js.undefined)
    ...
    inline def setChannelIconIdUndefined: Self = StObject.set(x, "channelIconId", js.undefined)
    ...
    inline def setChannelNeededSubscribePowerUndefined: Self = StObject.set(x, "channelNeededSubscribePower", js.undefined)
    ...
    inline def setSecondsEmptyUndefined: Self = StObject.set(x, "secondsEmpty", js.undefined)
    ...
    inline def setTotalClientsFamilyUndefined: Self = StObject.set(x, "totalClientsFamily", js.undefined)
    
    inline def setTotalClientsUndefined: Self = StObject.set(x, "totalClients", js.undefined)
  }
}
