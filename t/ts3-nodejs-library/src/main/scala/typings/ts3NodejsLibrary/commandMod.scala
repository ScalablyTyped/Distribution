...
object commandMod {
  ...
  class Command () extends StObject {
    ...
    /* private */ var cmd: js.Any = js.native
    ...
    /* private */ var multiOpts: js.Any = js.native
    ...
    /* private */ var requestParser: js.Any = js.native
    ...
    /* private */ var responseParser: js.Any = js.native
  ...
  object Command {
    ...
    /**
      ...
      */
    inline def parseValue(k: String): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("parseValue")(k.asInstanceOf[js.Any]).asInstanceOf[js.Any]
    inline def parseValue(k: String, v: String): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("parseValue")(k.asInstanceOf[js.Any], v.asInstanceOf[js.Any])).asInstanceOf[js.Any]
