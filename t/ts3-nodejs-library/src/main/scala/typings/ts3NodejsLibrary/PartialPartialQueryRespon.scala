...
/* Inlined std.Partial<std.Partial<ts3-nodejs-library.ts3-nodejs-library/lib/types/QueryResponse.QueryResponseTypes>> */
trait PartialPartialQueryRespon extends js.Object {
...
object PartialPartialQueryRespon {
  @scala.inline
  def apply(
    apikey: String = null,
    ...
    __obj.asInstanceOf[PartialPartialQueryRespon]
  }
}
