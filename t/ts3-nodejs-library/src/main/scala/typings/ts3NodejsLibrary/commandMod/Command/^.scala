...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def buildSnapshotDeploy(data: String, cmd: typings.ts3NodejsLibrary.commandMod.Command, hasVersion: Version): String = js.native
  def buildSnapshotDeploy(
    data: String,
    cmd: typings.ts3NodejsLibrary.commandMod.Command,
    hasVersion: Version,
