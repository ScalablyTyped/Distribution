...
import typings.ts3NodejsLibrary.anon.PartialChannelGroupList
import typings.ts3NodejsLibrary.anon.PartialChannelList
import typings.ts3NodejsLibrary.anon.PartialClientList
import typings.ts3NodejsLibrary.anon.PartialConnectionParams
import typings.ts3NodejsLibrary.anon.PartialServerGroupList
import typings.ts3NodejsLibrary.anon.PartialServerList
...
import typings.ts3NodejsLibrary.responseTypesMod.ChannelClientPermListSid
...
import typings.ts3NodejsLibrary.responseTypesMod.ClientGetIds
...
import typings.ts3NodejsLibrary.responseTypesMod.FTGetFileList
...
import typings.ts3NodejsLibrary.responseTypesMod.FTList
...
import typings.ts3NodejsLibrary.responseTypesMod.MessageList
...
import typings.ts3NodejsLibrary.responseTypesMod.PermOverview
import typings.ts3NodejsLibrary.responseTypesMod.PermissionList
import typings.ts3NodejsLibrary.responseTypesMod.PrivilegeKeyList
import typings.ts3NodejsLibrary.responseTypesMod.QueryLoginAdd
import typings.ts3NodejsLibrary.responseTypesMod.QueryLoginList
...
class TeamSpeak protected () extends EventEmitter {
  ...
  def channelGroupClientList(cgid: Double, cid: Double, cldbid: Double): js.Promise[js.Array[ChannelGroupClientList]] = js.native
  /**
  ...
  /**
    ...
    */
  def clientKick(clid: Double, reasonid: typings.ts3NodejsLibrary.enumMod.ReasonIdentifier, reasonmsg: String): js.Promise[js.Array[QueryResponseTypes]] = js.native
  /**
  ...
  /**
    ...
    */
  def logAdd(loglevel: typings.ts3NodejsLibrary.enumMod.LogLevel, logmsg: String): js.Promise[js.Array[QueryResponseTypes]] = js.native
  /**
  ...
  /**
    ...
    */
  def privilegeKeyAdd(tokentype: typings.ts3NodejsLibrary.enumMod.TokenType, group: Double): js.Promise[Token] = js.native
  def privilegeKeyAdd(tokentype: typings.ts3NodejsLibrary.enumMod.TokenType, group: Double, cid: Double): js.Promise[Token] = js.native
  def privilegeKeyAdd(
    tokentype: typings.ts3NodejsLibrary.enumMod.TokenType,
    group: Double,
    cid: Double,
    description: String
  ...
  /**
    ...
    * @param msg the message the client should receive
    */
  def sendTextMessage(target: Double, targetmode: typings.ts3NodejsLibrary.enumMod.TextMessageTargetMode, msg: String): js.Promise[js.Array[QueryResponseTypes]] = js.native
  /**
  ...
  /**
    ...
    */
  def serverEdit(properties: typings.ts3NodejsLibrary.propertyTypesMod.ServerEdit): js.Promise[js.Array[QueryResponseTypes]] = js.native
