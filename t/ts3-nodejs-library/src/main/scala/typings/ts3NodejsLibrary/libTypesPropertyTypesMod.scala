...
import typings.ts3NodejsLibrary.libTypesEnumMod.CodecEncryptionMode
import typings.ts3NodejsLibrary.libTypesEnumMod.HostBannerMode
import typings.ts3NodejsLibrary.libTypesEnumMod.HostMessageMode
import typings.ts3NodejsLibrary.libTypesEnumMod.VirtualServerStatus
import typings.ts3NodejsLibrary.ts3NodejsLibraryStrings.Asterisk
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libTypesPropertyTypesMod {
