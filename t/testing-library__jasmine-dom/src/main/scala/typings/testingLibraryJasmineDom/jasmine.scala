...
object jasmine {
  ...
  trait Matchers[T] extends StObject {
    ...
    /**
      ...
      */
    def toContainHTML(htmlText: String): Boolean = js.native
    ...
    /**
      ...
      */
    def toHaveAccessibleDescription(expectedAccessibleDescription: String): Boolean = js.native
    def toHaveAccessibleDescription(expectedAccessibleDescription: js.RegExp): Boolean = js.native
    def toHaveAccessibleDescription(expectedAccessibleDescription: AsymmetricMatcher[String]): Boolean = js.native
    ...
    /**
      ...
      */
    def toHaveAccessibleName(expectedAccessibleName: String): Boolean = js.native
    def toHaveAccessibleName(expectedAccessibleName: js.RegExp): Boolean = js.native
    def toHaveAccessibleName(expectedAccessibleName: AsymmetricMatcher[String]): Boolean = js.native
    ...
    /**
      ...
      */
    def toHaveErrorMessage(checkWith: String): Boolean = js.native
    def toHaveErrorMessage(checkWith: js.RegExp): Boolean = js.native
    def toHaveErrorMessage(checkWith: AsymmetricMatcher[String]): Boolean = js.native
