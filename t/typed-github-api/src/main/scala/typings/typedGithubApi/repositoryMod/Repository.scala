...
object Repository {
  ...
  implicit class RepositoryOps[Self <: Repository] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOwner(value: UserSummary): Self = this.set("owner", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPushed_at(value: Date): Self = this.set("pushed_at", value.asInstanceOf[js.Any])
    @scala.inline
