...
object distWebHookMod {
  ...
  open class IssueWebHook protected ()
    extends WebHook[
          IssueWebHookData, 
          typings.typedGithubApi.distApiInterfacesWebHooksMod.IssueWebHookData
        ] {
  ...
  @js.native
  open class WebHook[TData /* <: WebHookData */, TApiData /* <: typings.typedGithubApi.distApiInterfacesWebHooksMod.WebHookData */] protected () extends GitHubRef {
    def this(options: OptionsOrRef) = this()
    def this(secret: String, options: OptionsOrRef) = this()
    def this(secret: Unit, options: OptionsOrRef) = this()
