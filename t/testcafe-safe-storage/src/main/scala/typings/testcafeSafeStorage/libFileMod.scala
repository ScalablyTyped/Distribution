...
object libFileMod {
  ...
  object FILE_TYPE extends StObject {
    ...
    sealed trait AUTH_TAG
      extends StObject
         with FILE_TYPE
    /* 2 */ val AUTH_TAG: typings.testcafeSafeStorage.libFileMod.FILE_TYPE.AUTH_TAG & Double = js.native
    
    @js.native
    sealed trait NONCE
      extends StObject
         with FILE_TYPE
    /* 1 */ val NONCE: typings.testcafeSafeStorage.libFileMod.FILE_TYPE.NONCE & Double = js.native
    
    @js.native
    sealed trait PASSPHRASE
      extends StObject
         with FILE_TYPE
    /* 4 */ val PASSPHRASE: typings.testcafeSafeStorage.libFileMod.FILE_TYPE.PASSPHRASE & Double = js.native
    
    @js.native
    sealed trait PRIVATE_KEY
      extends StObject
         with FILE_TYPE
    /* 3 */ val PRIVATE_KEY: typings.testcafeSafeStorage.libFileMod.FILE_TYPE.PRIVATE_KEY & Double = js.native
    
    @js.native
    sealed trait STORAGE
      extends StObject
         with FILE_TYPE
    /* 0 */ val STORAGE: typings.testcafeSafeStorage.libFileMod.FILE_TYPE.STORAGE & Double = js.native
  }
