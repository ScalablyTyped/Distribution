...
trait Twix extends js.Object {
  def asDuration(period: java.lang.String): momentLib.momentMod.momentNs.Duration = js.native
  def contains(date: java.lang.String): scala.Boolean = js.native
  def contains(date: momentLib.momentMod.momentNs.Moment): scala.Boolean = js.native
  ...
  def iterate(duration: momentLib.momentMod.momentNs.Duration): TwixIter = js.native
  ...
  def split(duration: momentLib.momentMod.momentNs.Duration): js.Array[Twix] = js.native
  def split(num: scala.Double, period: java.lang.String): js.Array[Twix] = js.native
  def split(other: momentLib.momentMod.momentNs.Moment): js.Array[Twix] = js.native
  def split(start: momentLib.momentMod.momentNs.Moment, end: momentLib.momentMod.momentNs.Moment): js.Array[Twix] = js.native
