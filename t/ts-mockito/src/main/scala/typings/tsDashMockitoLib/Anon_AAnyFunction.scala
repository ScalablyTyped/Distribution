...
trait Anon_AAnyFunction extends js.Object {
  ...
  @JSName("resetCalls")
  var resetCalls_Original: Anon_MockedValueT = js.native
  @JSName("reset")
  var reset_Original: Anon_MockedValueT = js.native
  @JSName("spy")
  var spy_Original: Anon_InstanceToSpy = js.native
  @JSName("strictEqual")
  var strictEqual_Original: js.Function1[/* expectedValue */ js.Any, _] = js.native
  @JSName("verify")
  var verify_Original: Anon_Method = js.native
  @JSName("when")
  var when_Original: Anon_MethodAny = js.native
  def anyFunction(): js.Any = js.native
  def anyNumber(): js.Any = js.native
  def anyOfClass[T](expectedClass: Anon_Args[T]): js.Any = js.native
  ...
  def mock[T](clazz: Anon_Args[T]): T = js.native
