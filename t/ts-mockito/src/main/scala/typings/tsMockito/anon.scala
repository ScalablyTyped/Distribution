...
object anon {
  ...
  trait Fn1 extends StObject {
    ...
    def apply[T0](method: js.Function1[/* a */ T0, js.Any]): ArgCaptor1[T0] = js.native
    def apply[T0, T1](method: js.Function2[/* a */ T0, /* b */ T1, js.Any]): ArgCaptor2[T0, T1] = js.native
    def apply[T0, T1, T2](method: js.Function3[/* a */ T0, /* b */ T1, /* c */ T2, js.Any]): ArgCaptor3[T0, T1, T2] = js.native
    def apply[T0, T1, T2, T3](method: js.Function4[/* a */ T0, /* b */ T1, /* c */ T2, /* d */ T3, js.Any]): ArgCaptor4[T0, T1, T2, T3] = js.native
    def apply[T0, T1, T2, T3, T4](method: js.Function5[/* a */ T0, /* b */ T1, /* c */ T2, /* d */ T3, /* e */ T4, js.Any]): ArgCaptor5[T0, T1, T2, T3, T4] = js.native
    def apply[T0, T1, T2, T3, T4, T5](
      method: js.Function6[/* a */ T0, /* b */ T1, /* c */ T2, /* d */ T3, /* e */ T4, /* f */ T5, js.Any]
    ): ArgCaptor6[T0, T1, T2, T3, T4, T5] = js.native
