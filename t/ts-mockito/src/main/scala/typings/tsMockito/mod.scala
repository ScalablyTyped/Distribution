...
object mod {
  ...
  object default {
    ...
    inline def anyFunction(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("anyFunction")().asInstanceOf[js.Any]
    @JSImport("ts-mockito", "default.anyFunction")
    @js.native
    def anyFunction_Fdefault: js.Function0[js.Any] = js.native
    
    inline def anyFunction_Fdefault_=(x: js.Function0[js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("anyFunction")(x.asInstanceOf[js.Any])
    
    inline def anyNumber(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("anyNumber")().asInstanceOf[js.Any]
    @JSImport("ts-mockito", "default.anyNumber")
    @js.native
    def anyNumber_Fdefault: js.Function0[js.Any] = js.native
    
    inline def anyNumber_Fdefault_=(x: js.Function0[js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("anyNumber")(x.asInstanceOf[js.Any])
    
    @JSImport("ts-mockito", "default.anyOfClass")
    @js.native
    def anyOfClass: FnCallExpectedClass = js.native
    inline def anyOfClass[T](expectedClass: Instantiable1[/* args (repeated) */ js.Any, T]): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("anyOfClass")(expectedClass.asInstanceOf[js.Any]).asInstanceOf[js.Any]
    inline def anyOfClass_=(x: FnCallExpectedClass): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("anyOfClass")(x.asInstanceOf[js.Any])
    
    inline def anyString(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("anyString")().asInstanceOf[js.Any]
    @JSImport("ts-mockito", "default.anyString")
    @js.native
    def anyString_Fdefault: js.Function0[js.Any] = js.native
    
    inline def anyString_Fdefault_=(x: js.Function0[js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("anyString")(x.asInstanceOf[js.Any])
    
    inline def anything(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("anything")().asInstanceOf[js.Any]
    @JSImport("ts-mockito", "default.anything")
    @js.native
    def anything_Fdefault: js.Function0[js.Any] = js.native
    
    inline def anything_Fdefault_=(x: js.Function0[js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("anything")(x.asInstanceOf[js.Any])
    
    @JSImport("ts-mockito", "default.between")
    @js.native
    def between: js.Function2[/* min */ Double, /* max */ Double, js.Any] = js.native
    inline def between(min: Double, max: Double): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("between")(min.asInstanceOf[js.Any], max.asInstanceOf[js.Any])).asInstanceOf[js.Any]
    inline def between_=(x: js.Function2[/* min */ Double, /* max */ Double, js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("between")(x.asInstanceOf[js.Any])
    
    @JSImport("ts-mockito", "default.capture")
    @js.native
    def capture: Fn1 = js.native
    inline def capture[T0](method: js.Function1[/* a */ T0, js.Any]): ArgCaptor1[T0] = ^.asInstanceOf[js.Dynamic].applyDynamic("capture")(method.asInstanceOf[js.Any]).asInstanceOf[ArgCaptor1[T0]]
    inline def capture[T0, T1](method: js.Function2[/* a */ T0, /* b */ T1, js.Any]): ArgCaptor2[T0, T1] = ^.asInstanceOf[js.Dynamic].applyDynamic("capture")(method.asInstanceOf[js.Any]).asInstanceOf[ArgCaptor2[T0, T1]]
    inline def capture[T0, T1, T2](method: js.Function3[/* a */ T0, /* b */ T1, /* c */ T2, js.Any]): ArgCaptor3[T0, T1, T2] = ^.asInstanceOf[js.Dynamic].applyDynamic("capture")(method.asInstanceOf[js.Any]).asInstanceOf[ArgCaptor3[T0, T1, T2]]
    inline def capture[T0, T1, T2, T3](method: js.Function4[/* a */ T0, /* b */ T1, /* c */ T2, /* d */ T3, js.Any]): ArgCaptor4[T0, T1, T2, T3] = ^.asInstanceOf[js.Dynamic].applyDynamic("capture")(method.asInstanceOf[js.Any]).asInstanceOf[ArgCaptor4[T0, T1, T2, T3]]
    inline def capture[T0, T1, T2, T3, T4](method: js.Function5[/* a */ T0, /* b */ T1, /* c */ T2, /* d */ T3, /* e */ T4, js.Any]): ArgCaptor5[T0, T1, T2, T3, T4] = ^.asInstanceOf[js.Dynamic].applyDynamic("capture")(method.asInstanceOf[js.Any]).asInstanceOf[ArgCaptor5[T0, T1, T2, T3, T4]]
    inline def capture[T0, T1, T2, T3, T4, T5](
    ...
    inline def `match`(expectedValue: String): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("match")(expectedValue.asInstanceOf[js.Any]).asInstanceOf[js.Any]
    inline def `match`(expectedValue: RegExp): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("match")(expectedValue.asInstanceOf[js.Any]).asInstanceOf[js.Any]
    ...
    inline def mock[T](clazz: js.Any): T = ^.asInstanceOf[js.Dynamic].applyDynamic("mock")(clazz.asInstanceOf[js.Any]).asInstanceOf[T]
    inline def mock[T](clazz: Instantiable1[/* args (repeated) */ js.Any, T]): T = ^.asInstanceOf[js.Dynamic].applyDynamic("mock")(clazz.asInstanceOf[js.Any]).asInstanceOf[T]
    ...
    inline def notNull(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("notNull")().asInstanceOf[js.Any]
    @JSImport("ts-mockito", "default.notNull")
    @js.native
    def notNull_Fdefault: js.Function0[js.Any] = js.native
    
    inline def notNull_Fdefault_=(x: js.Function0[js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("notNull")(x.asInstanceOf[js.Any])
    
    @JSImport("ts-mockito", "default.objectContaining")
    @js.native
    def objectContaining: js.Function1[/* expectedValue */ js.Object, js.Any] = js.native
    inline def objectContaining(expectedValue: js.Object): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("objectContaining")(expectedValue.asInstanceOf[js.Any]).asInstanceOf[js.Any]
    inline def objectContaining_=(x: js.Function1[/* expectedValue */ js.Object, js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("objectContaining")(x.asInstanceOf[js.Any])
    
    @JSImport("ts-mockito", "default.reset")
    @js.native
    def reset: FnCallMockedValues = js.native
    inline def reset[T](mockedValues: T*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("reset")(mockedValues.asInstanceOf[js.Any]).asInstanceOf[Unit]
    
    @JSImport("ts-mockito", "default.resetCalls")
    @js.native
    def resetCalls: FnCallMockedValues = js.native
    inline def resetCalls[T](mockedValues: T*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("resetCalls")(mockedValues.asInstanceOf[js.Any]).asInstanceOf[Unit]
    ...
    inline def strictEqual(expectedValue: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("strictEqual")(expectedValue.asInstanceOf[js.Any]).asInstanceOf[js.Any]
    inline def strictEqual_=(x: js.Function1[/* expectedValue */ js.Any, js.Any]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("strictEqual")(x.asInstanceOf[js.Any])
    ...
    inline def when[T](method: T): MethodStubSetter[T, Unit, Error] = ^.asInstanceOf[js.Dynamic].applyDynamic("when")(method.asInstanceOf[js.Any]).asInstanceOf[MethodStubSetter[T, Unit, Error]]
    inline def when[T](method: js.Promise[T]): MethodStubSetter[js.Promise[T], T, Error] = ^.asInstanceOf[js.Dynamic].applyDynamic("when")(method.asInstanceOf[js.Any]).asInstanceOf[MethodStubSetter[js.Promise[T], T, Error]]
