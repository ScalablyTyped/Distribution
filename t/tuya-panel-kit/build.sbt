...
name := "tuya-panel-kit"
version := "2.0-dt-20201119Z-e2f9e7"
scalaVersion := "3.0.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-native-gesture-handler" % "1.8.0-bfda03",
  "org.scalablytyped" %%% "react-native-safe-area-context" % "3.1.4-bbbca2",
