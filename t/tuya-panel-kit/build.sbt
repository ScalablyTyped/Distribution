...
name := "tuya-panel-kit"
version := "2.0-dt-20201119Z-d92820"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-native-gesture-handler" % "1.8.0-2ad525",
  "org.scalablytyped" %%% "react-native-safe-area-context" % "3.1.4-76876d",
