package typings.tuyaPanelKit.nativeTypesMod

import typings.tuyaPanelKit.anon.InitialRouteName
import typings.tuyaPanelKit.getPathFromStateMod.Options
import typings.tuyaPanelKit.getPathFromStateMod.State
...
object LinkingOptions {
  ...
  implicit class LinkingOptionsOps[Self <: LinkingOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetPathFromState(value: (/* state */ State, /* options */ js.UndefOr[Options]) => String): Self = this.set("getPathFromState", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteGetPathFromState: Self = this.set("getPathFromState", js.undefined)
    
    @scala.inline
    def setGetStateFromPath(
      value: (/* path */ String, /* options */ js.UndefOr[typings.tuyaPanelKit.getStateFromPathMod.Options]) => js.UndefOr[ResultState]
    ): Self = this.set("getStateFromPath", js.Any.fromFunction2(value))
