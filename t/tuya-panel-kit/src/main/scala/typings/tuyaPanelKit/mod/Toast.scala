...
object Toast {
  ...
  inline def Error_=(x: ElementType[ToastErrorProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Error")(x.asInstanceOf[js.Any])
  
  @JSImport("tuya-panel-kit", "Toast.Loading")
  @js.native
  def Loading: ElementType[ToastLoadingProps] = js.native
  inline def Loading_=(x: ElementType[ToastLoadingProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Loading")(x.asInstanceOf[js.Any])
  
  @JSImport("tuya-panel-kit", "Toast.Success")
  @js.native
  def Success: ElementType[ToastSuccessProps] = js.native
  inline def Success_=(x: ElementType[ToastSuccessProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Success")(x.asInstanceOf[js.Any])
  
  @JSImport("tuya-panel-kit", "Toast.Warning")
  @js.native
  def Warning: ElementType[ToastWarningProps] = js.native
  inline def Warning_=(x: ElementType[ToastWarningProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Warning")(x.asInstanceOf[js.Any])
}
