...
object Progress {
  ...
  inline def Compose_=(x: ElementType[ComposeProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Compose")(x.asInstanceOf[js.Any])
  
  @JSImport("tuya-panel-kit", "Progress.Double")
  @js.native
  def Double: ElementType[DoubleProps] = js.native
  inline def Double_=(x: ElementType[DoubleProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Double")(x.asInstanceOf[js.Any])
  
  @JSImport("tuya-panel-kit", "Progress.Space")
  @js.native
  def Space: ElementType[SpaceProps] = js.native
  inline def Space_=(x: ElementType[SpaceProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Space")(x.asInstanceOf[js.Any])
}
