...
trait PopUpListProps extends StObject {
  ...
  /**
    ...
    * @defaultValue () => {}
    */
  var onSelect: js.UndefOr[js.Function2[/* value */ String | Double, /* params */ js.UndefOr[`10`], Unit]] = js.undefined
...
object PopUpListProps {
  ...
  implicit open class MutableBuilder[Self <: PopUpListProps] (val x: Self) extends AnyVal {
    ...
    inline def setOnSelect(value: (/* value */ String | Double, /* params */ js.UndefOr[`10`]) => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction2(value))
