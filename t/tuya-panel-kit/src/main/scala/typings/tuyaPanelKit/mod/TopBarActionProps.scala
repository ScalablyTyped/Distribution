...
- typings.tuyaPanelKit.mod.IconFontProps because var conflicts: color, style. Inlined viewBox, useART, ascent, descent, unitsPerEm, x, y, scaleX, scaleY, scale, spaceOffset, size, hFlip, vFlip, name, width, height, fill, stroke, strokeWidth, strokeJoin, strokeCap, strokeDash, d, opacity */ trait TopBarActionProps
  extends StObject
     with TopBarProps {
...
object TopBarActionProps {
  ...
  inline def apply(): TopBarActionProps = {
