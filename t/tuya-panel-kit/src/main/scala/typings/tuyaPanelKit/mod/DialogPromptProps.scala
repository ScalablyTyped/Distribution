...
@js.native
trait DialogPromptProps extends js.Object {
...
object DialogPromptProps {
  ...
  @scala.inline
  implicit class DialogPromptPropsOps[Self <: DialogPromptProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInputWrapperStyle(value: StyleProp[ViewStyle]): Self = this.set("inputWrapperStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteInputWrapperStyle: Self = this.set("inputWrapperStyle", js.undefined)
    
    @scala.inline
    def setInputWrapperStyleNull: Self = this.set("inputWrapperStyle", null)
    ...
    @scala.inline
    def setOnHelpPress(value: () => Unit): Self = this.set("onHelpPress", js.Any.fromFunction0(value))
    
    @scala.inline
    def deleteOnHelpPress: Self = this.set("onHelpPress", js.undefined)
