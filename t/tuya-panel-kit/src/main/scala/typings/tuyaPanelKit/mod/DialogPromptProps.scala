...
trait DialogPromptProps extends StObject {
  ...
  var inputWrapperStyle: js.UndefOr[StyleProp[ViewStyle]] = js.native
  ...
  var onHelpPress: js.UndefOr[js.Function0[Unit]] = js.native
...
object DialogPromptProps {
  ...
  @scala.inline
  def apply(cancelText: String, confirmText: String, title: String): DialogPromptProps = {
  ...
  @scala.inline
  implicit class DialogPromptPropsMutableBuilder[Self <: DialogPromptProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInputWrapperStyle(value: StyleProp[ViewStyle]): Self = StObject.set(x, "inputWrapperStyle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInputWrapperStyleNull: Self = StObject.set(x, "inputWrapperStyle", null)
    
    @scala.inline
    def setInputWrapperStyleUndefined: Self = StObject.set(x, "inputWrapperStyle", js.undefined)
    ...
    @scala.inline
    def setOnHelpPress(value: () => Unit): Self = StObject.set(x, "onHelpPress", js.Any.fromFunction0(value))
    
    @scala.inline
    def setOnHelpPressUndefined: Self = StObject.set(x, "onHelpPress", js.undefined)
