...
- typings.tuyaPanelKit.mod.CheckboxProps because var conflicts: accessibilityLabel, children, style. Inlined size, disabled, disabledColor, checked, checkedIcon, unCheckedIcon, reverse, hideOnUnselect, color, onChange */ trait TYFlatListCheckbox[ItemT /* <: TYFlatListData */]
  extends StObject
