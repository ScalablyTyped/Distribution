...
@js.native
trait TYFlatListProps[ItemT /* <: TYFlatListData */] extends js.Object {
...
object TYFlatListProps {
  ...
  @scala.inline
  implicit class TYFlatListPropsOps[Self <: TYFlatListProps[_], ItemT /* <: TYFlatListData */] (val x: Self with TYFlatListProps[ItemT]) extends AnyVal {
