...
- Dropped {[ P in std.Exclude<keyof tuya-panel-kit.tuya-panel-kit.PickerViewProps, 'theme' | 'children'> ]: tuya-panel-kit.tuya-panel-kit.PickerViewProps[P]} */ trait PopupPickerProps extends StObject {
  ...
  /**
    ...
    * @defaultValue () => {}
    */
  var onConfirm: js.UndefOr[js.Function3[/* data */ Any, /* idx */ Double, /* args */ `21`, Unit]] = js.undefined
...
object PopupPickerProps {
  ...
  extension [Self <: PopupPickerProps](x: Self) {
    ...
    inline def setOnConfirm(value: (/* data */ Any, /* idx */ Double, /* args */ `21`) => Unit): Self = StObject.set(x, "onConfirm", js.Any.fromFunction3(value))
