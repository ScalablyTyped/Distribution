...
@js.native
trait PopupTimerPickerProps extends js.Object {
...
object PopupTimerPickerProps {
  ...
  @scala.inline
  def apply(): PopupTimerPickerProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PopupTimerPickerProps]
  }
  
  @scala.inline
  implicit class PopupTimerPickerPropsOps[Self <: PopupTimerPickerProps] (val x: Self) extends AnyVal {
