...
object PopupTimerPickerProps {
  ...
  inline def apply(): PopupTimerPickerProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PopupTimerPickerProps]
  }
  
  extension [Self <: PopupTimerPickerProps](x: Self) {
    ...
    inline def setPrefixPositionVarargs(value: String*): Self = StObject.set(x, "prefixPosition", js.Array(value :_*))
