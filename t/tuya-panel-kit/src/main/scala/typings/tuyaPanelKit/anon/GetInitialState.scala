...
object GetInitialState {
  ...
  inline def apply(getInitialState: () => PromiseLike[js.UndefOr[PartialPickReadonlykeystrHistory]]): GetInitialState = {
  ...
  implicit open class MutableBuilder[Self <: GetInitialState] (val x: Self) extends AnyVal {
    ...
    inline def setGetInitialState(value: () => PromiseLike[js.UndefOr[PartialPickReadonlykeystrHistory]]): Self = StObject.set(x, "getInitialState", js.Any.fromFunction0(value))
  }
}
