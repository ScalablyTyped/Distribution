...
@js.native
trait TypeEventName[EventName /* <: String */] extends js.Object {
...
object TypeEventName {
  ...
  @scala.inline
  implicit class TypeEventNameOps[Self <: TypeEventName[_], EventName /* <: String */] (val x: Self with TypeEventName[EventName]) extends AnyVal {
