...
object History {
  ...
  implicit class HistoryMutableBuilder[Self <: History] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRoutes(value: js.Array[KeyName with `0` with `1`]): Self = StObject.set(x, "routes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRoutesVarargs(value: (KeyName with `0` with `1`)*): Self = StObject.set(x, "routes", js.Array(value :_*))
