...
@js.native
trait KeyNameParams[RouteName_4 /* <: String */] extends js.Object {
...
object KeyNameParams {
  ...
  @scala.inline
  implicit class KeyNameParamsOps[Self <: KeyNameParams[_], RouteName_4 /* <: String */] (val x: Self with KeyNameParams[RouteName_4]) extends AnyVal {
