...
object ClosingRouteKeys {
  ...
  implicit class ClosingRouteKeysOps[Self <: ClosingRouteKeys] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPreviousRoutesVarargs(value: (typings.tuyaPanelKit.routersTypesMod.Route[String, js.UndefOr[js.Object]])*): Self = this.set("previousRoutes", js.Array(value :_*))
    
    @scala.inline
    def setPreviousRoutes(value: js.Array[typings.tuyaPanelKit.routersTypesMod.Route[String, js.UndefOr[js.Object]]]): Self = this.set("previousRoutes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRoutesVarargs(value: (typings.tuyaPanelKit.routersTypesMod.Route[String, js.UndefOr[js.Object]])*): Self = this.set("routes", js.Array(value :_*))
    
    @scala.inline
    def setRoutes(value: js.Array[typings.tuyaPanelKit.routersTypesMod.Route[String, js.UndefOr[js.Object]]]): Self = this.set("routes", value.asInstanceOf[js.Any])
  }
}
