...
object ClosingRouteKeys {
  ...
  extension [Self <: ClosingRouteKeys](x: Self) {
    ...
    inline def setPreviousRoutesVarargs(value: (typings.tuyaPanelKit.routersTypesMod.Route[String, js.UndefOr[js.Object]])*): Self = StObject.set(x, "previousRoutes", js.Array(value*))
    ...
    inline def setRoutesVarargs(value: (typings.tuyaPanelKit.routersTypesMod.Route[String, js.UndefOr[js.Object]])*): Self = StObject.set(x, "routes", js.Array(value*))
  }
}
