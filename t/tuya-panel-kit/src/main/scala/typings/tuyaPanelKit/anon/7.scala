...
@js.native
trait `7`[EventMap /* <: EventMapBase */, EventName /* <: Extract[/* keyof EventMap */ String, String] */] extends js.Object {
...
object `7` {
  ...
  @scala.inline
  implicit class `7Ops`[Self <: `7`[_, _], EventMap /* <: EventMapBase */, EventName /* <: Extract[/* keyof EventMap */ String, String] */] (val x: Self with (`7`[EventMap, EventName])) extends AnyVal {
