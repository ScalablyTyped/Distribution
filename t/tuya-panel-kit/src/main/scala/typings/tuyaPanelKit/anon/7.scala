...
object `7` {
  ...
  @scala.inline
  implicit class `7MutableBuilder`[Self <: `7`[?, ?], EventMap /* <: EventMapBase */, EventName /* <: Extract[/* keyof EventMap */ String, String] */] (val x: Self & (`7`[EventMap, EventName])) extends AnyVal {
