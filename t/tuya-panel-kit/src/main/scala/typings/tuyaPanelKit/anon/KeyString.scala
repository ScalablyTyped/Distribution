...
@js.native
trait KeyString[RouteName /* <: /* keyof tuya-panel-kit.tuya-panel-kit/@react-navigation/routers/types.ParamListBase */ String */] extends js.Object {
...
object KeyString {
  ...
  @scala.inline
  implicit class KeyStringOps[Self <: KeyString[_], RouteName /* <: /* keyof tuya-panel-kit.tuya-panel-kit/@react-navigation/routers/types.ParamListBase */ String */] (val x: Self with KeyString[RouteName]) extends AnyVal {
