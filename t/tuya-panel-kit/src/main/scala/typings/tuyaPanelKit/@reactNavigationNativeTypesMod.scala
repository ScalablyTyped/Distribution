...
import typings.tuyaPanelKit.`@reactNavigationCoreGetPathFromStateMod`.Options
import typings.tuyaPanelKit.`@reactNavigationCoreGetPathFromStateMod`.State
...
object `@reactNavigationNativeTypesMod` {
  ...
  trait LinkingOptions extends StObject {
    ...
    var getStateFromPath: js.UndefOr[
        js.Function2[
          /* path */ String, 
          /* options */ js.UndefOr[typings.tuyaPanelKit.`@reactNavigationCoreGetStateFromPathMod`.Options], 
  ...
  object LinkingOptions {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: LinkingOptions] (val x: Self) extends AnyVal {
      ...
      inline def setGetStateFromPath(
        value: (/* path */ String, /* options */ js.UndefOr[typings.tuyaPanelKit.`@reactNavigationCoreGetStateFromPathMod`.Options]) => js.UndefOr[ResultState]
