...
object nativeMod {
  ...
  @scala.inline
  def ThemeProvider(hasValueChildren: typings.tuyaPanelKit.themeProviderMod.Props): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("ThemeProvider")(hasValueChildren.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  @scala.inline
  def useLinkProps(hasToAction: typings.tuyaPanelKit.useLinkPropsMod.Props): AccessibilityRole = ^.asInstanceOf[js.Dynamic].applyDynamic("useLinkProps")(hasToAction.asInstanceOf[js.Any]).asInstanceOf[AccessibilityRole]
