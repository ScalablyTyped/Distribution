...
object tuyaPanelKitStrings {
  ...
  @scala.inline
  def CLOSE_DRAWER: CLOSE_DRAWER = "CLOSE_DRAWER".asInstanceOf[CLOSE_DRAWER]
  ...
  @scala.inline
  def JUMP_TO: JUMP_TO = "JUMP_TO".asInstanceOf[JUMP_TO]
  ...
  @scala.inline
  def OPEN_DRAWER: OPEN_DRAWER = "OPEN_DRAWER".asInstanceOf[OPEN_DRAWER]
  ...
  @scala.inline
  def POP_TO_TOP: POP_TO_TOP = "POP_TO_TOP".asInstanceOf[POP_TO_TOP]
  ...
  @scala.inline
  def PullUp: PullUp = "PullUp".asInstanceOf[PullUp]
  
  @js.native
  sealed trait PushDown extends StObject
  @scala.inline
  def PushDown: PushDown = "PushDown".asInstanceOf[PushDown]
  ...
  @scala.inline
  def SET_PARAMS: SET_PARAMS = "SET_PARAMS".asInstanceOf[SET_PARAMS]
  
  @js.native
  sealed trait ScaleFadeIn extends StObject
  @scala.inline
  def ScaleFadeIn: ScaleFadeIn = "ScaleFadeIn".asInstanceOf[ScaleFadeIn]
  
  @js.native
  sealed trait ScalePullDown extends StObject
  @scala.inline
  def ScalePullDown: ScalePullDown = "ScalePullDown".asInstanceOf[ScalePullDown]
  
  @js.native
  sealed trait ScreenListeners extends StObject
  @scala.inline
  def ScreenListeners: ScreenListeners = "ScreenListeners".asInstanceOf[ScreenListeners]
  ...
  @scala.inline
  def __unsafe_action__ : __unsafe_action__ = "__unsafe_action__".asInstanceOf[__unsafe_action__]
  ...
  @scala.inline
  def addressCityAndState: addressCityAndState = "addressCityAndState".asInstanceOf[addressCityAndState]
  ...
  @scala.inline
  def bluetoothChange: bluetoothChange = "bluetoothChange".asInstanceOf[bluetoothChange]
  ...
  @scala.inline
  def dangerouslyGetParent: dangerouslyGetParent = "dangerouslyGetParent".asInstanceOf[dangerouslyGetParent]
  
  @js.native
  sealed trait dangerouslyGetState extends StObject
  @scala.inline
  def dangerouslyGetState: dangerouslyGetState = "dangerouslyGetState".asInstanceOf[dangerouslyGetState]
  ...
  @scala.inline
  def devInfo_ : devInfo_ = "devInfo".asInstanceOf[devInfo_]
  
  @js.native
  sealed trait deviceDataChange extends StObject
  @scala.inline
  def deviceDataChange: deviceDataChange = "deviceDataChange".asInstanceOf[deviceDataChange]
  
  @js.native
  sealed trait deviceLocalStateChange extends StObject
  @scala.inline
  def deviceLocalStateChange: deviceLocalStateChange = "deviceLocalStateChange".asInstanceOf[deviceLocalStateChange]
  
  @js.native
  sealed trait deviceOnline extends StObject
  @scala.inline
  def deviceOnline: deviceOnline = "deviceOnline".asInstanceOf[deviceOnline]
  ...
  @scala.inline
  def dispatch: dispatch = "dispatch".asInstanceOf[dispatch]
  ...
  @scala.inline
  def dpData: dpData = "dpData".asInstanceOf[dpData]
  ...
  @scala.inline
  def fade_ : fade_ = "fade".asInstanceOf[fade_]
  ...
  @scala.inline
  def gestureCancel: gestureCancel = "gestureCancel".asInstanceOf[gestureCancel]
  
  @js.native
  sealed trait gestureEnd extends StObject
  @scala.inline
  def gestureEnd: gestureEnd = "gestureEnd".asInstanceOf[gestureEnd]
  
  @js.native
  sealed trait gestureStart extends StObject
  @scala.inline
  def gestureStart: gestureStart = "gestureStart".asInstanceOf[gestureStart]
  ...
  @scala.inline
  def goBack: goBack = "goBack".asInstanceOf[goBack]
  ...
  @scala.inline
  def iconfont: iconfont = "iconfont".asInstanceOf[iconfont]
  ...
  @scala.inline
  def initialRouteName: initialRouteName = "initialRouteName".asInstanceOf[initialRouteName]
  ...
  @scala.inline
  def linkageTimeUpdate: linkageTimeUpdate = "linkageTimeUpdate".asInstanceOf[linkageTimeUpdate]
  ...
  @scala.inline
  def navigate_ : navigate_ = "navigate".asInstanceOf[navigate_]
  
  @js.native
  sealed trait networkStateChange extends StObject
  @scala.inline
  def networkStateChange: networkStateChange = "networkStateChange".asInstanceOf[networkStateChange]
  ...
  @scala.inline
  def noSet: noSet = "noSet".asInstanceOf[noSet]
  ...
  @scala.inline
  def pop_ : pop_ = "pop".asInstanceOf[pop_]
  ...
  @scala.inline
  def primaryBorder: primaryBorder = "primaryBorder".asInstanceOf[primaryBorder]
  
  @js.native
  sealed trait primaryGradient extends StObject
  @scala.inline
  def primaryGradient: primaryGradient = "primaryGradient".asInstanceOf[primaryGradient]
  ...
  @scala.inline
  def push_ : push_ = "push".asInstanceOf[push_]
  ...
  @scala.inline
  def reset_ : reset_ = "reset".asInstanceOf[reset_]
  ...
  @scala.inline
  def setParams: setParams = "setParams".asInstanceOf[setParams]
  ...
  @scala.inline
  def singleCancel: singleCancel = "singleCancel".asInstanceOf[singleCancel]
  
  @js.native
  sealed trait singleConfirm extends StObject
  @scala.inline
  def singleConfirm: singleConfirm = "singleConfirm".asInstanceOf[singleConfirm]
  ...
  @scala.inline
  def swiper: swiper = "swiper".asInstanceOf[swiper]
  ...
  @scala.inline
  def warp: warp = "warp".asInstanceOf[warp]
