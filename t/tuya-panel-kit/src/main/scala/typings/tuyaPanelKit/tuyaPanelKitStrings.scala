...
object tuyaPanelKitStrings {
  ...
  sealed trait AY
    extends StObject
       with MobileService
  inline def AY: AY = "AY".asInstanceOf[AY]
  ...
  @js.native
  sealed trait CLOSE_DRAWER extends StObject
  ...
  @js.native
  sealed trait GO_BACK extends StObject
  inline def GO_BACK: GO_BACK = "GO_BACK".asInstanceOf[GO_BACK]
  ...
  @js.native
  sealed trait JUMP_TO extends StObject
  inline def JUMP_TO: JUMP_TO = "JUMP_TO".asInstanceOf[JUMP_TO]
  ...
  @js.native
  sealed trait OPEN_DRAWER extends StObject
  inline def OPEN_DRAWER: OPEN_DRAWER = "OPEN_DRAWER".asInstanceOf[OPEN_DRAWER]
  ...
  @js.native
  sealed trait POP_TO_TOP extends StObject
  inline def POP_TO_TOP: POP_TO_TOP = "POP_TO_TOP".asInstanceOf[POP_TO_TOP]
  ...
  @js.native
  sealed trait PushDown extends StObject
  inline def PushDown: PushDown = "PushDown".asInstanceOf[PushDown]
  ...
  @js.native
  sealed trait SET_PARAMS extends StObject
  inline def SET_PARAMS: SET_PARAMS = "SET_PARAMS".asInstanceOf[SET_PARAMS]
  
  @js.native
  sealed trait ScaleFadeIn extends StObject
  inline def ScaleFadeIn: ScaleFadeIn = "ScaleFadeIn".asInstanceOf[ScaleFadeIn]
  ...
  sealed trait UE
    extends StObject
       with MobileService
  inline def UE: UE = "UE".asInstanceOf[UE]
  ...
  inline def addressCity: addressCity = "addressCity".asInstanceOf[addressCity]
  
  @js.native
  sealed trait addressCityAndState extends StObject
  inline def addressCityAndState: addressCityAndState = "addressCityAndState".asInstanceOf[addressCityAndState]
  
  @js.native
  sealed trait addressState extends StObject
  inline def addressState: addressState = "addressState".asInstanceOf[addressState]
  ...
  sealed trait bitmap
    extends StObject
       with DpType
  inline def bitmap: bitmap = "bitmap".asInstanceOf[bitmap]
  ...
  @js.native
  sealed trait bluetoothChange extends StObject
  inline def bluetoothChange: bluetoothChange = "bluetoothChange".asInstanceOf[bluetoothChange]
  ...
  @js.native
  sealed trait `cc-exp-year` extends StObject
  ...
  inline def countryName: countryName = "countryName".asInstanceOf[countryName]
  
  @js.native
  sealed trait creditCardNumber extends StObject
  ...
  inline def deviceDataChange: deviceDataChange = "deviceDataChange".asInstanceOf[deviceDataChange]
  
  @js.native
  sealed trait deviceLocalStateChange extends StObject
  inline def deviceLocalStateChange: deviceLocalStateChange = "deviceLocalStateChange".asInstanceOf[deviceLocalStateChange]
  ...
  @js.native
  sealed trait dpData extends StObject
  inline def dpData: dpData = "dpData".asInstanceOf[dpData]
  ...
  @js.native
  sealed trait emailAddress extends StObject
  ...
  inline def familyName: familyName = "familyName".asInstanceOf[familyName]
  ...
  inline def gestureCancel: gestureCancel = "gestureCancel".asInstanceOf[gestureCancel]
  
  @js.native
  sealed trait gestureEnd extends StObject
  inline def gestureEnd: gestureEnd = "gestureEnd".asInstanceOf[gestureEnd]
  
  @js.native
  sealed trait gestureStart extends StObject
  inline def gestureStart: gestureStart = "gestureStart".asInstanceOf[gestureStart]
  
  @js.native
  sealed trait givenName extends StObject
  ...
  @js.native
  sealed trait iconfont extends StObject
  inline def iconfont: iconfont = "iconfont".asInstanceOf[iconfont]
  ...
  @js.native
  sealed trait jobTitle extends StObject
  ...
  @js.native
  sealed trait linkageTimeUpdate extends StObject
  inline def linkageTimeUpdate: linkageTimeUpdate = "linkageTimeUpdate".asInstanceOf[linkageTimeUpdate]
  ...
  @js.native
  sealed trait middleName extends StObject
  ...
  @js.native
  sealed trait nameSuffix extends StObject
  inline def nameSuffix: nameSuffix = "nameSuffix".asInstanceOf[nameSuffix]
  ...
  @js.native
  sealed trait networkStateChange extends StObject
  inline def networkStateChange: networkStateChange = "networkStateChange".asInstanceOf[networkStateChange]
  ...
  @js.native
  sealed trait newPassword extends StObject
  inline def newPassword: newPassword = "newPassword".asInstanceOf[newPassword]
  ...
  @js.native
  sealed trait noExcludeDescendants extends StObject
  inline def noExcludeDescendants: noExcludeDescendants = "noExcludeDescendants".asInstanceOf[noExcludeDescendants]
  
  @js.native
  sealed trait noSet extends StObject
  inline def noSet: noSet = "noSet".asInstanceOf[noSet]
  ...
  inline def oneTimeCode: oneTimeCode = "oneTimeCode".asInstanceOf[oneTimeCode]
  ...
  inline def organizationName: organizationName = "organizationName".asInstanceOf[organizationName]
  ...
  @js.native
  sealed trait pop_ extends StObject
  inline def pop_ : pop_ = "pop".asInstanceOf[pop_]
  ...
  @js.native
  sealed trait primaryBorder extends StObject
  inline def primaryBorder: primaryBorder = "primaryBorder".asInstanceOf[primaryBorder]
  
  @js.native
  sealed trait primaryGradient extends StObject
  inline def primaryGradient: primaryGradient = "primaryGradient".asInstanceOf[primaryGradient]
  ...
  @js.native
  sealed trait push_ extends StObject
  inline def push_ : push_ = "push".asInstanceOf[push_]
  ...
  @js.native
  sealed trait reset_ extends StObject
  inline def reset_ : reset_ = "reset".asInstanceOf[reset_]
  ...
  @js.native
  sealed trait routes extends StObject
  ...
  @js.native
  sealed trait singleCancel extends StObject
  inline def singleCancel: singleCancel = "singleCancel".asInstanceOf[singleCancel]
  
  @js.native
  sealed trait singleConfirm extends StObject
  inline def singleConfirm: singleConfirm = "singleConfirm".asInstanceOf[singleConfirm]
  ...
  @js.native
  sealed trait streetAddressLine1 extends StObject
  inline def streetAddressLine1: streetAddressLine1 = "streetAddressLine1".asInstanceOf[streetAddressLine1]
  
  @js.native
  sealed trait streetAddressLine2 extends StObject
  inline def streetAddressLine2: streetAddressLine2 = "streetAddressLine2".asInstanceOf[streetAddressLine2]
  ...
  @js.native
  sealed trait sublocality extends StObject
  ...
  @js.native
  sealed trait `unless-editing` extends StObject
  ...
  @js.native
  sealed trait warp extends StObject
  inline def warp: warp = "warp".asInstanceOf[warp]
  ...
  @js.native
  sealed trait yesExcludeDescendants extends StObject
  inline def yesExcludeDescendants: yesExcludeDescendants = "yesExcludeDescendants".asInstanceOf[yesExcludeDescendants]
}
