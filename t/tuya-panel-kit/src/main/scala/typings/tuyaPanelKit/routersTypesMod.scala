...
import typings.tuyaPanelKit.anon.KeyState
import typings.tuyaPanelKit.anon.KeyStringNameRouteName
import typings.tuyaPanelKit.anon.ParamsReadonly
import typings.tuyaPanelKit.anon.Routes
import typings.tuyaPanelKit.anon.`15`
import typings.tuyaPanelKit.anon.`16`
import typings.tuyaPanelKit.anon.`17`
...
import typings.tuyaPanelKit.tuyaPanelKitStrings.routes
...
object routersTypesMod {
  ...
  object InitialState {
    ...
    inline def apply(routes: js.Array[(Omit[Route[String, js.UndefOr[js.Object]], key]) & `16`]): InitialState = {
