...
import typings.trimblemapsTrimblemapsJs.trimblemapsTrimblemapsJsStrings.linear
import typings.trimblemapsTrimblemapsJs.trimblemapsTrimblemapsJsStrings.nearest
