...
import typings.trimblemapsTrimblemapsJs.trimblemapsTrimblemapsJsStrings.`fill-extrusion`
...
object FillExtrusionLayer {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FillExtrusionLayer] (val x: Self) extends AnyVal {
