...
object GeometryCollection {
  ...
  @scala.inline
  implicit class GeometryCollectionOps[Self <: GeometryCollection[_], /* <: typings.topojsonSpecification.mod.Properties */ P] (val x: Self with GeometryCollection[P]) extends AnyVal {
    @scala.inline
