...
object mod {
  ...
  inline def cssRule(selector: String, objects: NestedCSSProperties*): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("cssRule")(selector.asInstanceOf[js.Any], objects.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def extend_false(objects: (js.UndefOr[NestedCSSProperties | Null | `false`])*): NestedCSSProperties = ^.asInstanceOf[js.Dynamic].applyDynamic("extend")(objects.asInstanceOf[js.Any]).asInstanceOf[NestedCSSProperties]
  
  inline def fontFace(fontFace: FontFace*): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("fontFace")(fontFace.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def media_false(mediaQuery: MediaQuery, objects: (js.UndefOr[`false` | NestedCSSProperties | Null])*): NestedCSSProperties = (^.asInstanceOf[js.Dynamic].applyDynamic("media")(mediaQuery.asInstanceOf[js.Any], objects.asInstanceOf[js.Any])).asInstanceOf[NestedCSSProperties]
  ...
  inline def style(objects: (js.UndefOr[NestedCSSProperties | Null | `false`])*): String = ^.asInstanceOf[js.Dynamic].applyDynamic("style")(objects.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def stylesheet[Classes /* <: Record[String, NestedCSSProperties] */](classes: Classes): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
