...
@JSImport("@typescript-eslint/parser/dist/scope/scopes", JSImport.Namespace)
@js.native
object distScopeScopesMod extends js.Object {
  @js.native
  class EmptyFunctionScope protected () extends Scope {
    def this(scopeManager: ScopeManager, upperScope: Scope) = this()
    def this(scopeManager: ScopeManager, upperScope: Scope, block: TSDeclareFunction) = this()
    /* CompleteClass */
  ...
  @js.native
  class EnumScope protected () extends Scope {
    def this(scopeManager: ScopeManager, upperScope: Scope) = this()
    def this(scopeManager: ScopeManager, upperScope: Scope, block: TSEnumDeclaration) = this()
    /* CompleteClass */
    override var block: Node = js.native
    /* CompleteClass */
    override var childScopes: js.Array[Scope] = js.native
