...
import typings.tensorflowTfjsBackendCpu.anon.AttrsTensorScatterUpdateAttrs
...
object distKernelsTensorScatterUpdateMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/TensorScatterUpdate", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/TensorScatterUpdate", "tensorScatterUpdateConfig")
  @js.native
