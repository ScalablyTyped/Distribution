...
object distBaseMod {
  ...
  open class MathBackendCPU ()
    extends typings.tensorflowTfjsBackendCpu.distBackendCpuMod.MathBackendCPU
  /* static members */
  ...
  object shared {
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu/dist/base", "shared.bitwiseAndImpl")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu/dist/base", "shared.floorDivImpl")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu/dist/base", "shared.staticRegexReplaceImpl")
    @js.native
