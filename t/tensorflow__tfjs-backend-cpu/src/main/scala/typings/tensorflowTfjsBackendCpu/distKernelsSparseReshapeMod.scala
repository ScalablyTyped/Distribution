...
import typings.tensorflowTfjsBackendCpu.anon.InputsSparseReshapeInputs
...
object distKernelsSparseReshapeMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/SparseReshape", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/SparseReshape", "sparseReshapeConfig")
  @js.native
