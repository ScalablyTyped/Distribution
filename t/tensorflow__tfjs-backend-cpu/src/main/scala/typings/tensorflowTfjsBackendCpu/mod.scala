...
object mod {
  ...
  object MathBackendCPU {
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu", "MathBackendCPU.nextDataId")
    @js.native
  ...
  object shared {
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared")
    @js.native
    val ^ : js.Any = js.native
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.bitwiseAndImpl")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.equalImpl")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.floorDivImpl")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.greaterEqualImpl")
    @js.native
    val greaterEqualImpl: SimpleBinaryKernelImpl = js.native
    
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.greaterImpl")
    @js.native
    val greaterImpl: SimpleBinaryKernelImpl = js.native
    
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.lessEqualImpl")
    @js.native
    val lessEqualImpl: SimpleBinaryKernelImpl = js.native
    
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.lessImpl")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.maximumImpl")
    @js.native
    val maximumImpl: SimpleBinaryKernelImpl = js.native
    
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.minimumImpl")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.sigmoidImpl")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.sqrtImpl")
    @js.native
    ...
    @JSImport("@tensorflow/tfjs-backend-cpu", "shared.staticRegexReplaceImpl")
    @js.native
  ...
  @js.native
  val versionCpu: /* "4.5.0" */ String = js.native
}
