...
object avgPoolBackpropMod {
  ...
  inline def avgPoolBackprop(args: Inputs): TensorInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("avgPoolBackprop")(args.asInstanceOf[js.Any]).asInstanceOf[TensorInfo]
