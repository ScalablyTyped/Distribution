...
object fusedConv2DMod {
  ...
  @scala.inline
  def fusedConv2D(args: AttrsFusedConv2DAttrs): TensorInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("fusedConv2D")(args.asInstanceOf[js.Any]).asInstanceOf[TensorInfo]
