...
import typings.tensorflowTfjsBackendCpu.anon.AttrsResizeNearestNeighborGradAttrs
...
object distKernelsResizeNearestNeighborGradMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/ResizeNearestNeighborGrad", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/ResizeNearestNeighborGrad", "resizeNearestNeighborGradConfig")
  @js.native
