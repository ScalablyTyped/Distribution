...
import typings.tensorflowTfjsBackendCpu.anon.InputsSparseFillEmptyRowsInputs
...
object distKernelsSparseFillEmptyRowsMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/SparseFillEmptyRows", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-cpu/dist/kernels/SparseFillEmptyRows", "sparseFillEmptyRowsConfig")
  @js.native
