...
import typings.tensorflowModelsFaceLandmarksDetection.configInterfacesMod.OneEuroFilterConfig
...
object oneEuroFilterMod {
  ...
  @JSImport("@tensorflow-models/face-landmarks-detection/dist/shared/filters/one_euro_filter", "OneEuroFilter")
  @js.native
