...
object distSharedTestUtilMod {
  ...
  @JSImport("@tensorflow-models/face-landmarks-detection/dist/shared/test_util", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@tensorflow-models/face-landmarks-detection/dist/shared/test_util", "KARMA_SERVER")
  @js.native
