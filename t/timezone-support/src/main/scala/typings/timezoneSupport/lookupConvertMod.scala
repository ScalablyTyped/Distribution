...
object lookupConvertMod {
  ...
  @scala.inline
  def populateTimeZones(TimeZoneData: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("populateTimeZones")(TimeZoneData.asInstanceOf[js.Any]).asInstanceOf[Unit]
