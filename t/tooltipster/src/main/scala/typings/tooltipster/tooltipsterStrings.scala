...
object tooltipsterStrings {
  ...
  @js.native
  sealed trait appearing extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait constrained extends StObject
  @scala.inline
  def constrained: constrained = "constrained".asInstanceOf[constrained]
  ...
  @js.native
  sealed trait disappearing extends StObject
  @scala.inline
  ...
  @js.native
  sealed trait elementOrigin extends StObject
  @scala.inline
  def elementOrigin: elementOrigin = "elementOrigin".asInstanceOf[elementOrigin]
  
  @js.native
  sealed trait elementTooltip extends StObject
  @scala.inline
  def elementTooltip: elementTooltip = "elementTooltip".asInstanceOf[elementTooltip]
  ...
  @js.native
  sealed trait triggerHandler extends StObject
  @scala.inline
