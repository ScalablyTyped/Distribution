...
object Click {
  ...
  def apply(
    ...
    if (!js.isUndefined(mouseleave)) __obj.updateDynamic("mouseleave")(mouseleave.get.asInstanceOf[js.Any])
    if (!js.isUndefined(originClick)) __obj.updateDynamic("originClick")(originClick.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(touchleave)) __obj.updateDynamic("touchleave")(touchleave.get.asInstanceOf[js.Any])
