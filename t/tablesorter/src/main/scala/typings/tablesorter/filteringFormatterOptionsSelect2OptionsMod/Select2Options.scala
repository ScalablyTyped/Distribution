package typings.tablesorter.filteringFormatterOptionsSelect2OptionsMod

import typings.select2.select2Mod.AjaxOptions
...
import typings.select2.select2Mod.LoadingData
import typings.select2.select2Mod.OptGroupData
import typings.select2.select2Mod.OptionData
import typings.select2.select2Mod.Options
import typings.select2.select2Mod.SearchOptions
import typings.select2.select2Mod.Translation
