...
object tempDashWriteMod extends js.Object {
  /**
  	...
  	```
  	*/
  def apply(fileContent: java.lang.String): js.Promise[java.lang.String] = js.native
  def apply(fileContent: java.lang.String, filePath: java.lang.String): js.Promise[java.lang.String] = js.native
  def apply(fileContent: nodeLib.Buffer): js.Promise[java.lang.String] = js.native
  def apply(fileContent: nodeLib.Buffer, filePath: java.lang.String): js.Promise[java.lang.String] = js.native
  def apply(fileContent: nodeLib.NodeJSNs.ReadableStream): js.Promise[java.lang.String] = js.native
  def apply(fileContent: nodeLib.NodeJSNs.ReadableStream, filePath: java.lang.String): js.Promise[java.lang.String] = js.native
  /**
  	...
  	```
  	*/
  def sync(fileContent: java.lang.String): java.lang.String = js.native
  def sync(fileContent: java.lang.String, filePath: java.lang.String): java.lang.String = js.native
  def sync(fileContent: nodeLib.Buffer): java.lang.String = js.native
  def sync(fileContent: nodeLib.Buffer, filePath: java.lang.String): java.lang.String = js.native
}
