...
object tldjsMod extends js.Object {
  ...
  def fromUserSettings(options: tldjsLib.Anon_ExtractHostname): tldjsLib.Anon_ExtractHostnameFromUserSettingsGetDomain = js.native
  ...
  def parse(host: java.lang.String): tldjsLib.Anon_Domain = js.native
