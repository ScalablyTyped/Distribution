...
import typings.twilioVideo.localParticipantMod.LocalParticipant
import typings.twilioVideo.localTrackPublicationMod.LocalTrackPublication
import typings.twilioVideo.participantMod.Participant.SID
import typings.twilioVideo.remoteDataTrackMod.RemoteDataTrack
import typings.twilioVideo.remoteParticipantMod.RemoteParticipant
...
import typings.twilioVideo.typesMod.StatsReport
...
object roomMod {
  ...
  open class Room () extends EventEmitter {
    ...
    var sid: typings.twilioVideo.roomMod.Room.SID = js.native
