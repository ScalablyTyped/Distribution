...
import typings.twilioVideo.tsdefParticipantMod.Participant.Identity
...
import typings.twilioVideo.tsdefTypesMod.NetworkQualityLevel
import typings.twilioVideo.tsdefTypesMod.NetworkQualityStats
...
object tsdefParticipantMod {
  ...
  open class Participant () extends EventEmitter {
    ...
    var sid: typings.twilioVideo.tsdefParticipantMod.Participant.SID = js.native
