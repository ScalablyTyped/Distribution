...
package object terserMod {
  ...
  type AST_Atom = AST_Node
  type AST_BlockStatement = AST_Block
  type AST_Boolean = AST_Node
  ...
  type AST_True = AST_Node
  type AST_UnaryPostfix = AST_Unary
  type AST_UnaryPrefix = AST_Unary
  type AST_Undefined = AST_Node
  type AST_Var = AST_Definitions
  type AST_While = AST_DWLoop
  /* Rewritten from type alias, can be one of: 
    - typings.terser.terserMod.AST_SymbolFunarg
    - typings.terser.terserMod.AST_DefaultAssign
    - typings.terser.terserMod.AST_Destructuring
    - typings.terser.terserMod.AST_Expansion
  */
