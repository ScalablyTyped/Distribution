...
object InlineFunctions extends js.Object {
  ...
  /* 0 */ val Disabled: typings.terser.terserMod.InlineFunctions.Disabled with Double = js.native
  /* 1 */ val SimpleFunctions: typings.terser.terserMod.InlineFunctions.SimpleFunctions with Double = js.native
  /* 2 */ val WithArguments: typings.terser.terserMod.InlineFunctions.WithArguments with Double = js.native
  /* 3 */ val WithArgumentsAndVariables: typings.terser.terserMod.InlineFunctions.WithArgumentsAndVariables with Double = js.native
  @JSBracketAccess
