...
object CompressOptions {
  ...
  def apply(
    ...
    top_retain: js.UndefOr[Null | String | js.Array[String] | RegExp] = js.undefined,
    ...
    if (!js.isUndefined(booleans_as_integers)) __obj.updateDynamic("booleans_as_integers")(booleans_as_integers.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(computed_props)) __obj.updateDynamic("computed_props")(computed_props.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(keep_fargs)) __obj.updateDynamic("keep_fargs")(keep_fargs.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(unsafe_arrows)) __obj.updateDynamic("unsafe_arrows")(unsafe_arrows.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(unsafe_methods)) __obj.updateDynamic("unsafe_methods")(unsafe_methods.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(unsafe_symbols)) __obj.updateDynamic("unsafe_symbols")(unsafe_symbols.get.asInstanceOf[js.Any])
