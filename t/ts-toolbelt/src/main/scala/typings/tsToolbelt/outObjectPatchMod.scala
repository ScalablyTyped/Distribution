...
object outObjectPatchMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type PatchDeep[O /* <: js.Object */, O1 /* <: js.Object */, ignore /* <: js.Object */, fill] = PatchProp[O, O1, fill, x, y]
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type PatchDeepChoice[OK, O1K, ignore /* <: js.Object */, fill, OKeys /* <: Key */, K /* <: Key */] = O1K
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type PatchDeepList[L /* <: typings.tsToolbelt.outListListMod.List[Any] */, L1 /* <: typings.tsToolbelt.outListListMod.List[Any] */, ignore /* <: js.Object */, fill] = js.Array[
    PatchDeepChoice[
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type PatchFlat[O /* <: js.Object */, O1 /* <: js.Object */, ignore /* <: js.Object */, fill] = O
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type PatchFlatChoice[O /* <: js.Object */, O1 /* <: js.Object */, ignore /* <: js.Object */, fill] = O
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type PatchFlatList[L /* <: typings.tsToolbelt.outListListMod.List[Any] */, L1 /* <: typings.tsToolbelt.outListListMod.List[Any] */, ignore /* <: js.Object */, fill] = js.Array[
    PatchFlatChoice[
      /* import warning: importer.ImportType#apply Failed type conversion: L[number] */ js.Any, 
      /* import warning: importer.ImportType#apply Failed type conversion: L1[number] */ js.Any, 
      ignore, 
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type PatchProp[OK, O1K, fill, OKeys /* <: Key */, K /* <: Key */] = O1K
}
