...
import typings.tsToolbelt.addMod.AddNegative
import typings.tsToolbelt.addMod.AddPositive
...
object `1AddNegative` {
  ...
  extension [Self <: `1AddNegative`[?, ?], N1 /* <: Iteration */, N2 /* <: Iteration */](x: Self & (`1AddNegative`[N1, N2])) {
