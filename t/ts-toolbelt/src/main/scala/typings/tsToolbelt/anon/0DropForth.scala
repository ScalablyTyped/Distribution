...
import typings.tsToolbelt.dropMod.DropForth
...
trait `0DropForth`[L /* <: typings.tsToolbelt.listMod.List[Any] */, N /* <: Iteration */] extends StObject {
...
object `0DropForth` {
  ...
  inline def apply[L /* <: typings.tsToolbelt.listMod.List[Any] */, N /* <: Iteration */](`0`: DropForth[Tail[L], Prev[N]], `1`: L): `0DropForth`[L, N] = {
  ...
  extension [Self <: `0DropForth`[?, ?], L /* <: typings.tsToolbelt.listMod.List[Any] */, N /* <: Iteration */](x: Self & (`0DropForth`[L, N])) {
