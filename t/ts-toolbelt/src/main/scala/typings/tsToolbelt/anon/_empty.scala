...
trait _empty[L /* <: typings.tsToolbelt.listMod.List[Any] */, N /* <: Iteration */] extends StObject {
...
object _empty {
  ...
  inline def apply[L /* <: typings.tsToolbelt.listMod.List[Any] */, N /* <: Iteration */](`-Greaterthansign`: DropForth[L, N], `Lessthansign-`: DropBack[L, N, Prev[N], js.Array[Any]]): _empty[L, N] = {
  ...
  extension [Self <: _empty[?, ?], L /* <: typings.tsToolbelt.listMod.List[Any] */, N /* <: Iteration */](x: Self & (_empty[L, N])) {
