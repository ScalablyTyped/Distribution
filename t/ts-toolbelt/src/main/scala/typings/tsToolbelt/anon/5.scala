...
trait `5` extends StObject {
  ...
  @JSName("+")
  var Plussign: typings.tsToolbelt.tsToolbeltInts.`1`
...
object `5` {
  ...
  extension [Self <: `5`](x: Self) {
    ...
    inline def setPlussign(value: typings.tsToolbelt.tsToolbeltInts.`1`): Self = StObject.set(x, "+", value.asInstanceOf[js.Any])
