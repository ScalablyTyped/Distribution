...
trait Contains[A /* <: Any */, A1 /* <: Any */] extends StObject {
  ...
  @JSName("<-contains")
  var `Lessthansign-contains`: typings.tsToolbelt.outAnyContainsMod.Contains[A1, A]
  
  @JSName("<-extends")
  var `Lessthansign-extends`: Extends[A1, A]
  
  @JSName("contains->")
  var `contains-Greaterthansign`: typings.tsToolbelt.outAnyContainsMod.Contains[A, A1]
  
  @JSName("equals")
  var equals_FContains: typings.tsToolbelt.outAnyEqualsMod.Equals[A1, A]
...
object Contains {
  ...
  inline def apply[A /* <: Any */, A1 /* <: Any */](
    `Lessthansign-contains`: typings.tsToolbelt.outAnyContainsMod.Contains[A1, A],
    `Lessthansign-extends`: Extends[A1, A],
    `contains-Greaterthansign`: typings.tsToolbelt.outAnyContainsMod.Contains[A, A1],
    default: Extends[A, A1],
    equals_ : typings.tsToolbelt.outAnyEqualsMod.Equals[A1, A],
  ...
  implicit open class MutableBuilder[Self <: Contains[?, ?], A /* <: Any */, A1 /* <: Any */] (val x: Self & (Contains[A, A1])) extends AnyVal {
    ...
    inline def setEquals_(value: typings.tsToolbelt.outAnyEqualsMod.Equals[A1, A]): Self = StObject.set(x, "equals", value.asInstanceOf[js.Any])
    
    inline def `setExtends-Greaterthansign`(value: Extends[A, A1]): Self = StObject.set(x, "extends->", value.asInstanceOf[js.Any])
    
    inline def `setLessthansign-contains`(value: typings.tsToolbelt.outAnyContainsMod.Contains[A1, A]): Self = StObject.set(x, "<-contains", value.asInstanceOf[js.Any])
