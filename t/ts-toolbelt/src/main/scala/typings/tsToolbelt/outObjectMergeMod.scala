...
object outObjectMergeMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type MergeDeep[O /* <: js.Object */, O1 /* <: js.Object */, ignore /* <: js.Object */, fill] = MergeProp[O, O1, fill, x, y]
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type MergeDeepChoice[OK, O1K, ignore /* <: js.Object */, fill, OOKeys /* <: Key */, K /* <: Key */] = O1K
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type MergeDeepList[L /* <: typings.tsToolbelt.outListListMod.List[Any] */, L1 /* <: typings.tsToolbelt.outListListMod.List[Any] */, ignore /* <: js.Object */, fill] = js.Array[
    MergeDeepChoice[
      /* import warning: importer.ImportType#apply Failed type conversion: L[number] */ js.Any, 
      /* import warning: importer.ImportType#apply Failed type conversion: L1[number] */ js.Any, 
      ignore, 
      fill, 
      scala.Nothing, 
      Any
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type MergeFlat[O /* <: js.Object */, O1 /* <: js.Object */, ignore /* <: js.Object */, fill] = O
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type MergeFlatChoice[O /* <: js.Object */, O1 /* <: js.Object */, ignore /* <: js.Object */, fill] = O
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type MergeFlatList[L /* <: typings.tsToolbelt.outListListMod.List[Any] */, L1 /* <: typings.tsToolbelt.outListListMod.List[Any] */, ignore /* <: js.Object */, fill, LOK /* <: Key */] = js.Array[
    MergeFlatChoice[
      /* import warning: importer.ImportType#apply Failed type conversion: L[number] */ js.Any, 
      /* import warning: importer.ImportType#apply Failed type conversion: L1[number] */ js.Any, 
      ignore, 
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  type MergeProp[OK, O1K, fill, OOKeys /* <: Key */, K /* <: Key */] = O1K
}
