...
object tsToolbeltStrings {
  ...
  @js.native
  sealed trait `Lessthansign-contains`
    extends StObject
       with Match
  inline def `Lessthansign-contains`: `Lessthansign-contains` = "<-contains".asInstanceOf[`Lessthansign-contains`]
  
  @js.native
  sealed trait `Lessthansign-extends`
    extends StObject
       with Match
  ...
  @js.native
  sealed trait `contains-Greaterthansign`
    extends StObject
       with Match
  inline def `contains-Greaterthansign`: `contains-Greaterthansign` = "contains->".asInstanceOf[`contains-Greaterthansign`]
  ...
  @js.native
  sealed trait `extends-Greaterthansign`
    extends StObject
       with Match
  inline def `extends-Greaterthansign`: `extends-Greaterthansign` = "extends->".asInstanceOf[`extends-Greaterthansign`]
