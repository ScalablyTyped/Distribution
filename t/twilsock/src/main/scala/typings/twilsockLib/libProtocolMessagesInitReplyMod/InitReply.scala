...
class InitReply protected ()
  ...
  def this(id: java.lang.String, continuationToken: java.lang.String, continuationTokenStatus: ContinuationTokenStatus, offlineStorage: js.Any, initRegistrations: js.Any) = this()
