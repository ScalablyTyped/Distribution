...
object registrationsMod {
  ...
  class Registrations protected () extends EventEmitter {
    ...
    /* private */ var deleteNotificationContext: js.Any = js.native
    
    /* private */ var putNotificationContext: js.Any = js.native
    
    /* private */ val registrations: js.Any = js.native
    
    /* private */ val registrationsInProgress: js.Any = js.native
    ...
    /* private */ var updateRegistration: js.Any = js.native
