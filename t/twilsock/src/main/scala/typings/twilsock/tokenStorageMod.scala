...
object tokenStorageMod {
  ...
  object TokenStorage {
    ...
    inline def getKeyName_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("getKeyName")(x.asInstanceOf[js.Any])
    
    /* static member */
    inline def getStoredToken(productId: String): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getStoredToken")(productId.asInstanceOf[js.Any]).asInstanceOf[js.Any]
    ...
    /* static member */
    inline def storeToken(continuationToken: String, productId: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("storeToken")(continuationToken.asInstanceOf[js.Any], productId.asInstanceOf[js.Any])).asInstanceOf[Unit]
