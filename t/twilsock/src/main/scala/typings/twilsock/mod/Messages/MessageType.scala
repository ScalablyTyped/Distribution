...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.twilsock.twilsockStrings.client_update
*/
trait MessageType extends StObject
object MessageType {
  
  inline def client_update: typings.twilsock.twilsockStrings.client_update = "client_update".asInstanceOf[typings.twilsock.twilsockStrings.client_update]
