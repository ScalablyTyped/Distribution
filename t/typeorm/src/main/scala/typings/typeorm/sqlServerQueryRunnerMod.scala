...
import typings.typeorm.anon.DatabaseName
...
import typings.typeorm.sqlServerDriverMod.SqlServerDriver
...
@JSImport("typeorm/browser/driver/sqlserver/SqlServerQueryRunner", JSImport.Namespace)
@js.native
object sqlServerQueryRunnerMod extends js.Object {
  ...
  class SqlServerQueryRunner protected () extends BaseQueryRunner {
    def this(driver: SqlServerDriver, mode: ReplicationMode) = this()
    ...
    /**
      ...
      */
    /* protected */ def buildCreateColumnSql(table: Table, column: TableColumn, skipIdentity: Boolean, createDefault: Boolean): String = js.native
    ...
    /* protected */ def buildForeignKeyName(fkName: String, schemaName: js.UndefOr[scala.Nothing], dbName: String): String = js.native
    ...
    /**
      ...
      */
    def convertIsolationLevel(isolation: IsolationLevel): js.Any = js.native
    ...
    /**
      ...
      */
    var driver: SqlServerDriver = js.native
    ...
    def dropTable(tableOrName: String, ifExist: js.UndefOr[scala.Nothing], dropForeignKeys: Boolean): js.Promise[Unit] = js.native
    def dropTable(
      tableOrName: String,
      ifExist: js.UndefOr[scala.Nothing],
    ...
    def dropTable(tableOrName: Table, ifExist: js.UndefOr[scala.Nothing], dropForeignKeys: Boolean): js.Promise[Unit] = js.native
    def dropTable(
      tableOrName: Table,
      ifExist: js.UndefOr[scala.Nothing],
      dropForeignKeys: Boolean,
    ...
    /**
      ...
      */
    /* protected */ def mssqlParameterToNativeParameter(parameter: MssqlParameter): js.Any = js.native
    
    /* protected */ def parseTableName(target: String): DatabaseName = js.native
    /* protected */ def parseTableName(target: String, schema: String): DatabaseName = js.native
    /* protected */ def parseTableName(target: Table): DatabaseName = js.native
    /* protected */ def parseTableName(target: Table, schema: String): DatabaseName = js.native
    /* protected */ def parseTableName(target: View): DatabaseName = js.native
    /* protected */ def parseTableName(target: View, schema: String): DatabaseName = js.native
    ...
    /**
      ...
      */
    var queryResponsibilityChain: js.Array[js.Promise[_]] = js.native
    ...
    /**
      ...
      */
    /* protected */ def removeParenthesisFromDefault(defaultValue: String): js.Any = js.native
