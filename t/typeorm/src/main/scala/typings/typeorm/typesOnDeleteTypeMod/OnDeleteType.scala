package typings.typeorm.typesOnDeleteTypeMod
...
/* Rewritten from type alias, can be one of: 
  - typings.typeorm.typeormStrings.RESTRICT
  - typings.typeorm.typeormStrings.CASCADE
  - typings.typeorm.typeormStrings.`SET NULL`
  - typings.typeorm.typeormStrings.DEFAULT
  - typings.typeorm.typeormStrings.`NO ACTION`
*/
trait OnDeleteType extends js.Object
object OnDeleteType {
