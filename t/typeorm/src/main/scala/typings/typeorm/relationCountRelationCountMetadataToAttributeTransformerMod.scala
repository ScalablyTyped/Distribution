...
@JSImport("typeorm/query-builder/relation-count/RelationCountMetadataToAttributeTransformer", JSImport.Namespace)
@js.native
object relationCountRelationCountMetadataToAttributeTransformerMod extends js.Object {
