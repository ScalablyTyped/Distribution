package typings.typeorm.typesTreeTypesMod
...
/* Rewritten from type alias, can be one of: 
  - typings.typeorm.typeormStrings.`adjacency-list`
  - typings.typeorm.typeormStrings.`closure-table`
  - typings.typeorm.typeormStrings.`nested-set`
  - typings.typeorm.typeormStrings.`materialized-path`
*/
