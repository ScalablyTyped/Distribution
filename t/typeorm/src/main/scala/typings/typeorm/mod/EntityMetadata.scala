...
object EntityMetadata {
  ...
  /**
    ...
    */
  @scala.inline
  def createPropertyPath(metadata: typings.typeorm.metadataEntityMetadataMod.EntityMetadata, entity: ObjectLiteral): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("createPropertyPath")(metadata.asInstanceOf[js.Any], entity.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  @scala.inline
