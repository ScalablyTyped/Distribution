...
object Timestamp extends js.Object {
  ...
  var MAX_VALUE: typings.typeorm.mongodbTypingsMod.Timestamp = js.native
  
  var MIN_VALUE: typings.typeorm.mongodbTypingsMod.Timestamp = js.native
  
  var NEG_ONE: typings.typeorm.mongodbTypingsMod.Timestamp = js.native
  
  var ONE: typings.typeorm.mongodbTypingsMod.Timestamp = js.native
  
  var ZERO: typings.typeorm.mongodbTypingsMod.Timestamp = js.native
