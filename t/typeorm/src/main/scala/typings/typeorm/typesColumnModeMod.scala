...
import typings.typeorm.typeormStrings.virtual_
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typesColumnModeMod {
  
  /* Rewritten from type alias, can be one of: 
    - typings.typeorm.typeormStrings.regular
    - typings.typeorm.typeormStrings.virtual_
    - typings.typeorm.typeormStrings.createDate
    - typings.typeorm.typeormStrings.updateDate
    - typings.typeorm.typeormStrings.deleteDate
    - typings.typeorm.typeormStrings.version
    - typings.typeorm.typeormStrings.treeChildrenCount
    - typings.typeorm.typeormStrings.treeLevel
    - typings.typeorm.typeormStrings.objectId
