...
import typings.typeorm.broadcasterResultMod.BroadcasterResult
...
@JSImport("typeorm/browser/subscriber/Broadcaster", JSImport.Namespace)
@js.native
object broadcasterMod extends js.Object {
