...
import typings.typeorm.anon.PartialQueryExpressionMapAliasNamePrefixingEnabled
...
object queryBuilderSelectQueryBuilderMod {
  ...
  class SelectQueryBuilder[Entity] protected ()
    ...
    /**
      ...
      */
    /* protected */ def mergeExpressionMap(expressionMap: PartialQueryExpressionMapAliasNamePrefixingEnabled): this.type = js.native
