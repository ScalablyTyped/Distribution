...
object mysqlConnectionCredentialsOptionsMod {
  ...
  object MysqlConnectionCredentialsOptions {
    ...
    @scala.inline
    def apply(): MysqlConnectionCredentialsOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MysqlConnectionCredentialsOptions]
    }
    
    @scala.inline
    implicit class MysqlConnectionCredentialsOptionsMutableBuilder[Self <: MysqlConnectionCredentialsOptions] (val x: Self) extends AnyVal {
