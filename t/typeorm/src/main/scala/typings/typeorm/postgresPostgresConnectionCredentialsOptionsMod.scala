...
object postgresPostgresConnectionCredentialsOptionsMod {
  ...
  trait PostgresConnectionCredentialsOptions extends StObject {
    ...
    /**
      * Database password.
      */
    val password: js.UndefOr[String | (js.Function0[js.Promise[String] | String])] = js.undefined
  ...
  object PostgresConnectionCredentialsOptions {
    ...
    inline def apply(): PostgresConnectionCredentialsOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PostgresConnectionCredentialsOptions]
    }
    
    extension [Self <: PostgresConnectionCredentialsOptions](x: Self) {
      ...
      inline def setPassword(value: String | (js.Function0[js.Promise[String] | String])): Self = StObject.set(x, "password", value.asInstanceOf[js.Any])
