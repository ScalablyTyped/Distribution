...
object LengthPrecision {
  ...
  inline def apply(): LengthPrecision = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LengthPrecision]
  }
  
  extension [Self <: LengthPrecision](x: Self) {
    ...
    inline def setType(value: ColumnType | String): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
