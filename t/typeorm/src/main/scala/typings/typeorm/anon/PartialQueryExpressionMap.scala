...
trait PartialQueryExpressionMap extends StObject {
  ...
  @JSName("clone")
  var clone_FPartialQueryExpressionMap: js.UndefOr[js.Function0[QueryExpressionMap]] = js.native
  
  var comment: js.UndefOr[String] = js.native
  
  var connection: js.UndefOr[typings.typeorm.connectionMod.Connection] = js.native
  
  var constructor: js.UndefOr[js.Function1[/* connection */ typings.typeorm.connectionMod.Connection, js.Any]] = js.native
  
  var createAlias: js.UndefOr[js.Function1[/* options */ Metadata, Alias]] = js.native
