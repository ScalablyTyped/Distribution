...
@js.native
trait PartialQueryExpressionMap extends js.Object {
...
object PartialQueryExpressionMap {
  ...
  @scala.inline
  implicit class PartialQueryExpressionMapOps[Self <: PartialQueryExpressionMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConstructor(value: /* connection */ typings.typeorm.connectionMod.Connection => js.Any): Self = this.set("constructor", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteConstructor: Self = this.set("constructor", js.undefined)
    
    @scala.inline
    def setCreateAlias(value: /* options */ Metadata => Alias): Self = this.set("createAlias", js.Any.fromFunction1(value))
