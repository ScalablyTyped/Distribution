...
/* Inlined std.Partial<typeorm.typeorm/browser/query-builder/QueryExpressionMap.QueryExpressionMap> */
trait PartialQueryExpressionMap extends StObject {
  ...
  @JSName("clone")
  var clone_FPartialQueryExpressionMap: js.UndefOr[js.Function0[QueryExpressionMap]] = js.undefined
  
  var comment: js.UndefOr[String] = js.undefined
  
  var connection: js.UndefOr[typings.typeorm.connectionMod.Connection] = js.undefined
  
  var constructor: js.UndefOr[js.Function1[/* connection */ typings.typeorm.connectionMod.Connection, js.Any]] = js.undefined
  
  var createAlias: js.UndefOr[js.Function1[/* options */ Metadata, Alias]] = js.undefined
...
object PartialQueryExpressionMap {
  
  @scala.inline
  def apply(): PartialQueryExpressionMap = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialQueryExpressionMap]
  }
  
  @scala.inline
  implicit class PartialQueryExpressionMapMutableBuilder[Self <: PartialQueryExpressionMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConstructor(value: /* connection */ typings.typeorm.connectionMod.Connection => js.Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    @scala.inline
    def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    @scala.inline
    def setCreateAlias(value: /* options */ Metadata => Alias): Self = StObject.set(x, "createAlias", js.Any.fromFunction1(value))
