...
trait PartialRelationIdAttributAlias extends StObject {
  ...
  var junctionMetadata: js.UndefOr[typings.typeorm.metadataEntityMetadataMod.EntityMetadata] = js.undefined
...
object PartialRelationIdAttributAlias {
  ...
  inline def apply(): PartialRelationIdAttributAlias = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRelationIdAttributAlias]
  }
  
  extension [Self <: PartialRelationIdAttributAlias](x: Self) {
    ...
    inline def setJunctionMetadata(value: typings.typeorm.metadataEntityMetadataMod.EntityMetadata): Self = StObject.set(x, "junctionMetadata", value.asInstanceOf[js.Any])
