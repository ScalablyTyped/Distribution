...
@js.native
trait PartialRelationIdAttributAlias extends js.Object {
...
object PartialRelationIdAttributAlias {
  ...
  @scala.inline
  implicit class PartialRelationIdAttributAliasOps[Self <: PartialRelationIdAttributAlias] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setJunctionMetadata(value: typings.typeorm.metadataEntityMetadataMod.EntityMetadata): Self = this.set("junctionMetadata", value.asInstanceOf[js.Any])
