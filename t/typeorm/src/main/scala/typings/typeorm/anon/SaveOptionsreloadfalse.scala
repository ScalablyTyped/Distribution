...
object SaveOptionsreloadfalse {
  ...
  inline def apply(reload: js.UndefOr[Boolean] & `false`): SaveOptionsreloadfalse = {
    val __obj = js.Dynamic.literal(reload = reload.asInstanceOf[js.Any])
    __obj.asInstanceOf[SaveOptionsreloadfalse]
  }
  
  extension [Self <: SaveOptionsreloadfalse](x: Self) {
    ...
    inline def setReload(value: js.UndefOr[Boolean] & `false`): Self = StObject.set(x, "reload", value.asInstanceOf[js.Any])
