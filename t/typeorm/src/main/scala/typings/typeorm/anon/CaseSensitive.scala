...
object CaseSensitive {
  ...
  implicit class CaseSensitiveOps[Self <: CaseSensitive] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set$diacraticSensitive(value: Boolean): Self = this.set("$diacraticSensitive", value.asInstanceOf[js.Any])
    
    @scala.inline
    def delete$diacraticSensitive: Self = this.set("$diacraticSensitive", js.undefined)
