...
@js.native
trait PrecisionScale extends js.Object {
...
object PrecisionScale {
  ...
  @scala.inline
  def apply(`type`: ColumnType): PrecisionScale = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[PrecisionScale]
  }
  
  @scala.inline
  implicit class PrecisionScaleOps[Self <: PrecisionScale] (val x: Self) extends AnyVal {
