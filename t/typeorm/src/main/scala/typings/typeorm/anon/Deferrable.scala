...
object Deferrable {
  ...
  implicit class DeferrableOps[Self <: Deferrable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReferencedEntityMetadata(value: typings.typeorm.metadataEntityMetadataMod.EntityMetadata): Self = this.set("referencedEntityMetadata", value.asInstanceOf[js.Any])
