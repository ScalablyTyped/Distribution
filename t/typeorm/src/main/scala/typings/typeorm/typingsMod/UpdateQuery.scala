...
object UpdateQuery {
  ...
  inline def apply[T](): UpdateQuery[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateQuery[T]]
  }
  
  extension [Self <: UpdateQuery[?], T](x: Self & UpdateQuery[T]) {
    
    inline def set$addToSet(value: Partial[T] | StringDictionary[js.Any]): Self = StObject.set(x, "$addToSet", value.asInstanceOf[js.Any])
    ...
    inline def set$each(value: Partial[T] | StringDictionary[js.Array[js.Any]]): Self = StObject.set(x, "$each", value.asInstanceOf[js.Any])
    ...
    inline def set$pull(value: Partial[T] | (StringDictionary[Condition[T, /* keyof T */ String]])): Self = StObject.set(x, "$pull", value.asInstanceOf[js.Any])
    
    inline def set$pullUndefined: Self = StObject.set(x, "$pull", js.undefined)
    
    inline def set$push(value: Partial[T] | StringDictionary[js.Any]): Self = StObject.set(x, "$push", value.asInstanceOf[js.Any])
    
    inline def set$pushAll(value: Partial[T] | StringDictionary[js.Array[js.Any]]): Self = StObject.set(x, "$pushAll", value.asInstanceOf[js.Any])
    
    inline def set$pushAllUndefined: Self = StObject.set(x, "$pushAll", js.undefined)
    
    inline def set$pushUndefined: Self = StObject.set(x, "$push", js.undefined)
    
    inline def set$rename(value: StringDictionary[/* keyof T */ String]): Self = StObject.set(x, "$rename", value.asInstanceOf[js.Any])
    
    inline def set$renameUndefined: Self = StObject.set(x, "$rename", js.undefined)
    
    inline def set$set(value: Partial[T] | StringDictionary[js.Any]): Self = StObject.set(x, "$set", value.asInstanceOf[js.Any])
    
    inline def set$setOnInsert(value: Partial[T] | StringDictionary[js.Any]): Self = StObject.set(x, "$setOnInsert", value.asInstanceOf[js.Any])
