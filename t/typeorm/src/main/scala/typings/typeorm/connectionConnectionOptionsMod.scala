...
object connectionConnectionOptionsMod {
  ...
  */
  ...
  object ConnectionOptions {
    ...
    inline def AuroraDataApiConnectionOptions(database: String, region: String, resourceArn: String, secretArn: String): typings.typeorm.auroraDataApiAuroraDataApiConnectionOptionsMod.AuroraDataApiConnectionOptions = {
    ...
    inline def AuroraDataApiPostgresConnectionOptions(database: String, region: String, resourceArn: String, secretArn: String): typings.typeorm.auroraDataApiPgAuroraDataApiPostgresConnectionOptionsMod.AuroraDataApiPostgresConnectionOptions = {
      val __obj = js.Dynamic.literal(database = database.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], resourceArn = resourceArn.asInstanceOf[js.Any], secretArn = secretArn.asInstanceOf[js.Any])
    ...
    inline def BetterSqlite3ConnectionOptions(database: String): typings.typeorm.betterSqlite3BetterSqlite3ConnectionOptionsMod.BetterSqlite3ConnectionOptions = {
    ...
    inline def CockroachConnectionOptions(): typings.typeorm.cockroachdbCockroachConnectionOptionsMod.CockroachConnectionOptions = {
    ...
    inline def CordovaConnectionOptions(database: String, location: String): typings.typeorm.cordovaCordovaConnectionOptionsMod.CordovaConnectionOptions = {
    ...
    inline def ExpoConnectionOptions(database: String, driver: js.Any): typings.typeorm.expoExpoConnectionOptionsMod.ExpoConnectionOptions = {
    ...
    inline def MongoConnectionOptions(): typings.typeorm.mongodbMongoConnectionOptionsMod.MongoConnectionOptions = {
      val __obj = js.Dynamic.literal()
    ...
    inline def MysqlConnectionOptions(`type`: mysql | mariadb): typings.typeorm.mysqlMysqlConnectionOptionsMod.MysqlConnectionOptions = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.typeorm.mysqlMysqlConnectionOptionsMod.MysqlConnectionOptions]
    }
    
    inline def NativescriptConnectionOptions(database: String, driver: js.Any): typings.typeorm.nativescriptNativescriptConnectionOptionsMod.NativescriptConnectionOptions = {
      val __obj = js.Dynamic.literal(database = database.asInstanceOf[js.Any], driver = driver.asInstanceOf[js.Any])
    ...
    inline def OracleConnectionOptions(): typings.typeorm.oracleOracleConnectionOptionsMod.OracleConnectionOptions = {
      val __obj = js.Dynamic.literal()
    ...
    inline def PostgresConnectionOptions(): typings.typeorm.postgresPostgresConnectionOptionsMod.PostgresConnectionOptions = {
      val __obj = js.Dynamic.literal()
    ...
    inline def ReactNativeConnectionOptions(database: String, location: String): typings.typeorm.reactNativeReactNativeConnectionOptionsMod.ReactNativeConnectionOptions = {
      val __obj = js.Dynamic.literal(database = database.asInstanceOf[js.Any], location = location.asInstanceOf[js.Any])
    ...
    inline def SapConnectionOptions(): typings.typeorm.sapSapConnectionOptionsMod.SapConnectionOptions = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("sap")
      __obj.asInstanceOf[typings.typeorm.sapSapConnectionOptionsMod.SapConnectionOptions]
    }
    
    inline def SqlServerConnectionOptions(): typings.typeorm.sqlserverSqlServerConnectionOptionsMod.SqlServerConnectionOptions = {
      val __obj = js.Dynamic.literal()
    ...
    inline def SqliteConnectionOptions(database: String): typings.typeorm.sqliteSqliteConnectionOptionsMod.SqliteConnectionOptions = {
      val __obj = js.Dynamic.literal(database = database.asInstanceOf[js.Any])
    ...
    inline def SqljsConnectionOptions(): typings.typeorm.sqljsSqljsConnectionOptionsMod.SqljsConnectionOptions = {
      val __obj = js.Dynamic.literal()
