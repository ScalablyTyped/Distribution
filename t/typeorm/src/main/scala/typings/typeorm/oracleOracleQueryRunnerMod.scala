...
import typings.typeorm.oracleOracleDriverMod.OracleDriver
...
@JSImport("typeorm/driver/oracle/OracleQueryRunner", JSImport.Namespace)
@js.native
object oracleOracleQueryRunnerMod extends js.Object {
  ...
  class OracleQueryRunner protected () extends BaseQueryRunner {
    def this(driver: OracleDriver, mode: ReplicationMode) = this()
    ...
    /**
      ...
      */
    def createSchema(schemas: String): js.Promise[Unit] = js.native
    def createSchema(schemas: String, ifNotExist: Boolean): js.Promise[Unit] = js.native
    ...
    /**
      ...
      */
    /* protected */ def deleteViewDefinitionSql(viewOrPath: View): Query = js.native
    
    /**
      * Database driver used by connection.
      */
    var driver: OracleDriver = js.native
    ...
    /* protected */ def dropIndexSql(indexOrName: String): Query = js.native
    /**
      * Builds drop index sql.
      */
    /* protected */ def dropIndexSql(indexOrName: TableIndex): Query = js.native
    ...
    /* protected */ def insertViewDefinitionSql(view: View): Query = js.native
    ...
    def renameTable(oldTableOrName: String, newTableOrName: String): js.Promise[Unit] = js.native
    def renameTable(oldTableOrName: String, newTableOrName: Table): js.Promise[Unit] = js.native
    /**
      * Renames a table.
      */
    def renameTable(oldTableOrName: Table, newTableOrName: String): js.Promise[Unit] = js.native
    /**
