...
import typings.typeorm.oracleDriverMod.OracleDriver
...
@JSImport("typeorm/browser/driver/oracle/OracleQueryRunner", JSImport.Namespace)
@js.native
object oracleQueryRunnerMod extends js.Object {
