...
object Binary {
  ...
  /**
    ...
    */
  @JSImport("typeorm/driver/mongodb/typings", "Binary.SUBTYPE_BYTE_ARRAY")
  @js.native
  ...
  /**
    * Default BSON type.
    */
  @JSImport("typeorm/driver/mongodb/typings", "Binary.SUBTYPE_DEFAULT")
  @js.native
  ...
  /**
    * Function BSON type.
    */
  @JSImport("typeorm/driver/mongodb/typings", "Binary.SUBTYPE_FUNCTION")
  @js.native
  ...
  /**
    * MD5 BSON type.
    */
  @JSImport("typeorm/driver/mongodb/typings", "Binary.SUBTYPE_MD5")
  @js.native
  ...
  /**
    * User BSON type.
    */
  @JSImport("typeorm/driver/mongodb/typings", "Binary.SUBTYPE_USER_DEFINED")
  @js.native
  ...
  /**
    * UUID BSON type.
    */
  @JSImport("typeorm/driver/mongodb/typings", "Binary.SUBTYPE_UUID")
  @js.native
  ...
  /**
    * OLD UUID BSON type
    */
  @JSImport("typeorm/driver/mongodb/typings", "Binary.SUBTYPE_UUID_OLD")
  @js.native
