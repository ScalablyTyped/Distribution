...
object BulkWriteResult {
  ...
  extension [Self <: BulkWriteResult](x: Self) {
    ...
    inline def setGetUpsertedIdAt(value: scala.Double => js.Object): Self = StObject.set(x, "getUpsertedIdAt", js.Any.fromFunction1(value))
    
    inline def setGetUpsertedIds(value: () => js.Array[Index]): Self = StObject.set(x, "getUpsertedIds", js.Any.fromFunction0(value))
    ...
    inline def setNUpdated(value: scala.Double): Self = StObject.set(x, "nUpdated", value.asInstanceOf[js.Any])
