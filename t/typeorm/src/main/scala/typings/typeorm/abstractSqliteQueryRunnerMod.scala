...
object abstractSqliteQueryRunnerMod {
  ...
  abstract class AbstractSqliteQueryRunner () extends BaseQueryRunner {
    ...
    def changeColumns(tableOrName: String, changedColumns: js.Array[OldColumn]): js.Promise[Unit] = js.native
    /**
      * Changes a column in the table.
    ...
    /**
      ...
      */
    def changeColumns(tableOrName: Table, changedColumns: js.Array[OldColumn]): js.Promise[Unit] = js.native
