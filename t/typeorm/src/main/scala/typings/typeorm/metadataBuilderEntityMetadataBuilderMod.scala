...
import typings.typeorm.metadataBuilderClosureJunctionEntityMetadataBuilderMod.ClosureJunctionEntityMetadataBuilder
import typings.typeorm.metadataBuilderJunctionEntityMetadataBuilderMod.JunctionEntityMetadataBuilder
