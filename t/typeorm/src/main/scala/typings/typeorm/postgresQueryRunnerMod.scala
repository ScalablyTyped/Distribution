...
import typings.typeorm.anon.EnumTypeName
...
object postgresQueryRunnerMod extends js.Object {
  ...
  class PostgresQueryRunner protected () extends BaseQueryRunner {
    ...
    /**
      ...
      */
    /* protected */ def createEnumTypeSql(table: Table, column: TableColumn): Query = js.native
    /* protected */ def createEnumTypeSql(table: Table, column: TableColumn, enumName: String): Query = js.native
    ...
    /**
      ...
      */
    /* protected */ def createExclusionConstraintSql(table: Table, exclusionConstraint: TableExclusion): Query = js.native
    ...
    /**
      ...
      */
    /* protected */ def createUniqueConstraintSql(table: Table, uniqueConstraint: TableUnique): Query = js.native
    ...
    /**
      ...
      */
    var driver: PostgresDriver = js.native
    ...
    /**
      * Builds create ENUM type sql.
      */
    /* protected */ def dropEnumTypeSql(table: Table, column: TableColumn): Query = js.native
    /* protected */ def dropEnumTypeSql(table: Table, column: TableColumn, enumName: String): Query = js.native
    
    /**
      * Drops ENUM type from given schemas.
      */
    /* protected */ def dropEnumTypes(schemaNames: String): js.Promise[Unit] = js.native
    ...
    /* protected */ def dropExclusionConstraintSql(table: Table, exclusionOrName: String): Query = js.native
    /**
      * Builds drop exclusion constraint sql.
      */
    /* protected */ def dropExclusionConstraintSql(table: Table, exclusionOrName: TableExclusion): Query = js.native
    ...
    /**
      ...
      */
    /* protected */ def dropTableSql(tableOrPath: Table): Query = js.native
    ...
    /* protected */ def dropUniqueConstraintSql(table: Table, uniqueOrName: String): Query = js.native
    /**
      * Builds drop unique constraint sql.
      */
    /* protected */ def dropUniqueConstraintSql(table: Table, uniqueOrName: TableUnique): Query = js.native
    ...
    /**
      ...
      */
    /* protected */ def escapeComment(): String = js.native
    /* protected */ def escapeComment(comment: String): String = js.native
    ...
    /* protected */ def extractSchema(target: String): js.UndefOr[String] = js.native
    /**
      * Extracts schema name from given Table object or table name string.
      */
    /* protected */ def extractSchema(target: Table): js.UndefOr[String] = js.native
    ...
    /* protected */ def getEnumTypeName(table: Table, column: TableColumn): js.Promise[EnumTypeName] = js.native
    ...
    /**
      ...
      */
    /* protected */ def hasEnumType(table: Table, column: TableColumn): js.Promise[Boolean] = js.native
    ...
    /**
      ...
      */
    /* protected */ def hasSupportForPartitionedTables(): js.Promise[Boolean] = js.native
