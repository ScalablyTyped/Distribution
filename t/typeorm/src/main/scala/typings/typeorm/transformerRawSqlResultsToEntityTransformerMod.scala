...
@JSImport("typeorm/query-builder/transformer/RawSqlResultsToEntityTransformer", JSImport.Namespace)
@js.native
object transformerRawSqlResultsToEntityTransformerMod extends js.Object {
