package typings.typeorm.relationCountMetadataArgsMod
...
@js.native
trait RelationCountMetadataArgs extends js.Object {
...
object RelationCountMetadataArgs {
  ...
  @scala.inline
  implicit class RelationCountMetadataArgsOps[Self <: RelationCountMetadataArgs] (val x: Self) extends AnyVal {
