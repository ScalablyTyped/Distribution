package typings.typeorm.relationTypesMod
...
/* Rewritten from type alias, can be one of: 
  - typings.typeorm.typeormStrings.`one-to-one`
  - typings.typeorm.typeormStrings.`one-to-many`
  - typings.typeorm.typeormStrings.`many-to-one`
  - typings.typeorm.typeormStrings.`many-to-many`
*/
trait RelationType extends js.Object
object RelationType {
