...
@JSImport("typeorm/browser/logger/AdvancedConsoleLogger", JSImport.Namespace)
@js.native
object advancedConsoleLoggerMod extends js.Object {
  
  @js.native
  class AdvancedConsoleLogger () extends Logger {
