...
object errorUsingJoinTableOnlyOnOneSideAllowedErrorMod {
  
  @JSImport("typeorm/error/UsingJoinTableOnlyOnOneSideAllowedError", "UsingJoinTableOnlyOnOneSideAllowedError")
  @js.native
