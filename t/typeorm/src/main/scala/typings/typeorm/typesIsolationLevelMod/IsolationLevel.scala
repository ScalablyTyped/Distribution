package typings.typeorm.typesIsolationLevelMod
...
/* Rewritten from type alias, can be one of: 
  - typings.typeorm.typeormStrings.`READ UNCOMMITTED`
  - typings.typeorm.typeormStrings.`READ COMMITTED`
  - typings.typeorm.typeormStrings.`REPEATABLE READ`
  - typings.typeorm.typeormStrings.SERIALIZABLE
*/
