...
import typings.typeorm.anon.IsArray
...
import typings.typeorm.dataTypeDefaultsMod.DataTypeDefaults
import typings.typeorm.entityMetadataMod.EntityMetadata
import typings.typeorm.mappedColumnTypesMod.MappedColumnTypes
