...
object connectionOptionsMod {
  ...
  */
  ...
  object ConnectionOptions {
    ...
    inline def AuroraDataApiConnectionOptions(database: String, region: String, resourceArn: String, secretArn: String): typings.typeorm.auroraDataApiConnectionOptionsMod.AuroraDataApiConnectionOptions = {
    ...
    inline def AuroraDataApiPostgresConnectionOptions(database: String, region: String, resourceArn: String, secretArn: String): typings.typeorm.auroraDataApiPostgresConnectionOptionsMod.AuroraDataApiPostgresConnectionOptions = {
      val __obj = js.Dynamic.literal(database = database.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], resourceArn = resourceArn.asInstanceOf[js.Any], secretArn = secretArn.asInstanceOf[js.Any])
    ...
    inline def BetterSqlite3ConnectionOptions(database: String): typings.typeorm.betterSqlite3ConnectionOptionsMod.BetterSqlite3ConnectionOptions = {
    ...
    inline def CockroachConnectionOptions(): typings.typeorm.cockroachConnectionOptionsMod.CockroachConnectionOptions = {
    ...
    inline def CordovaConnectionOptions(database: String, location: String): typings.typeorm.cordovaConnectionOptionsMod.CordovaConnectionOptions = {
    ...
    inline def ExpoConnectionOptions(database: String, driver: js.Any): typings.typeorm.expoConnectionOptionsMod.ExpoConnectionOptions = {
    ...
    inline def MongoConnectionOptions(): typings.typeorm.mongoConnectionOptionsMod.MongoConnectionOptions = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("mongodb")
      __obj.asInstanceOf[typings.typeorm.mongoConnectionOptionsMod.MongoConnectionOptions]
    }
    
    inline def MysqlConnectionOptions(`type`: mysql | mariadb): typings.typeorm.mysqlConnectionOptionsMod.MysqlConnectionOptions = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.typeorm.mysqlConnectionOptionsMod.MysqlConnectionOptions]
    }
    
    inline def NativescriptConnectionOptions(database: String, driver: js.Any): typings.typeorm.nativescriptConnectionOptionsMod.NativescriptConnectionOptions = {
      val __obj = js.Dynamic.literal(database = database.asInstanceOf[js.Any], driver = driver.asInstanceOf[js.Any])
    ...
    inline def OracleConnectionOptions(): typings.typeorm.oracleConnectionOptionsMod.OracleConnectionOptions = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("oracle")
      __obj.asInstanceOf[typings.typeorm.oracleConnectionOptionsMod.OracleConnectionOptions]
    }
    
    inline def PostgresConnectionOptions(): typings.typeorm.postgresConnectionOptionsMod.PostgresConnectionOptions = {
      val __obj = js.Dynamic.literal()
    ...
    inline def ReactNativeConnectionOptions(database: String, location: String): typings.typeorm.reactNativeConnectionOptionsMod.ReactNativeConnectionOptions = {
      val __obj = js.Dynamic.literal(database = database.asInstanceOf[js.Any], location = location.asInstanceOf[js.Any])
    ...
    inline def SapConnectionOptions(): typings.typeorm.sapConnectionOptionsMod.SapConnectionOptions = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("sap")
      __obj.asInstanceOf[typings.typeorm.sapConnectionOptionsMod.SapConnectionOptions]
    }
    
    inline def SqlServerConnectionOptions(): typings.typeorm.sqlServerConnectionOptionsMod.SqlServerConnectionOptions = {
      val __obj = js.Dynamic.literal()
    ...
    inline def SqliteConnectionOptions(database: String): typings.typeorm.sqliteConnectionOptionsMod.SqliteConnectionOptions = {
      val __obj = js.Dynamic.literal(database = database.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("sqlite")
      __obj.asInstanceOf[typings.typeorm.sqliteConnectionOptionsMod.SqliteConnectionOptions]
    }
    
    inline def SqljsConnectionOptions(): typings.typeorm.sqljsConnectionOptionsMod.SqljsConnectionOptions = {
      val __obj = js.Dynamic.literal()
