...
@JSImport("typeorm/commands/MigrationRevertCommand", JSImport.Namespace)
@js.native
object migrationRevertCommandMod extends js.Object {
  ...
  class MigrationRevertCommand () extends js.Object {
