...
import typings.typeorm.typingsMod.MongoClient
...
object mongoQueryRunnerMod {
  ...
  class MongoQueryRunner protected ()
    ...
    def distinct(collectionName: String, key: String, query: ObjectLiteral, options: ReadPreference): js.Promise[js.Any] = js.native
    ...
    def listCollectionIndexes(collectionName: String, options: BatchSize): CommandCursor = js.native
