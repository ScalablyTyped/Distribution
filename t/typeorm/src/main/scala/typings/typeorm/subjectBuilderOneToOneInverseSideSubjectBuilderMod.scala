...
@JSImport("typeorm/persistence/subject-builder/OneToOneInverseSideSubjectBuilder", JSImport.Namespace)
@js.native
object subjectBuilderOneToOneInverseSideSubjectBuilderMod extends js.Object {
