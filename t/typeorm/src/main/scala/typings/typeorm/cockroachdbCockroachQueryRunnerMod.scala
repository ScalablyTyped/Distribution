...
import typings.typeorm.anon.Parameters
import typings.typeorm.anon.Schema
import typings.typeorm.cockroachdbCockroachDriverMod.CockroachDriver
...
@JSImport("typeorm/driver/cockroachdb/CockroachQueryRunner", JSImport.Namespace)
@js.native
object cockroachdbCockroachQueryRunnerMod extends js.Object {
  ...
  class CockroachQueryRunner protected () extends BaseQueryRunner {
    def this(driver: CockroachDriver, mode: ReplicationMode) = this()
    ...
    /* protected */ def createUniqueConstraintSql(table: Table, uniqueConstraint: TableIndex): Query = js.native
    /**
    ...
    /**
      ...
      */
    var driver: CockroachDriver = js.native
    ...
    /* protected */ def dropIndexSql(table: Table, indexOrName: TableUnique): Query = js.native
