...
object EntityMetadata {
  ...
  /**
    ...
    */
  inline def createPropertyPath(metadata: typings.typeorm.entityMetadataMod.EntityMetadata, entity: ObjectLiteral): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("createPropertyPath")(metadata.asInstanceOf[js.Any], entity.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  inline def createPropertyPath(metadata: typings.typeorm.entityMetadataMod.EntityMetadata, entity: ObjectLiteral, prefix: String): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("createPropertyPath")(metadata.asInstanceOf[js.Any], entity.asInstanceOf[js.Any], prefix.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
