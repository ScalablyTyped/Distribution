...
import typings.typeorm.anon.Connection
...
import typings.typeorm.metadataEntityListenerMetadataMod.EntityListenerMetadata
...
import typings.typeorm.metadataRelationCountMetadataMod.RelationCountMetadata
import typings.typeorm.metadataRelationIdMetadataMod.RelationIdMetadata
...
object metadataEntityMetadataMod {
  ...
  class EntityMetadata protected () extends StObject {
    ...
    /* private */ var getInverseEntityMetadata: js.Any = js.native
  ...
  object EntityMetadata {
    ...
    /**
      ...
      */
    inline def createPropertyPath(metadata: EntityMetadata, entity: ObjectLiteral): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("createPropertyPath")(metadata.asInstanceOf[js.Any], entity.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
    inline def createPropertyPath(metadata: EntityMetadata, entity: ObjectLiteral, prefix: String): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("createPropertyPath")(metadata.asInstanceOf[js.Any], entity.asInstanceOf[js.Any], prefix.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
