...
object metadataBuilderMetadataUtilsMod {
  ...
  object MetadataUtils {
    ...
    /**
      ...
      */
    @JSImport("typeorm/metadata-builder/MetadataUtils", "MetadataUtils.filterByTarget")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("typeorm/metadata-builder/MetadataUtils", "MetadataUtils.getInheritanceTree")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("typeorm/metadata-builder/MetadataUtils", "MetadataUtils.isInherited")
    @js.native
