...
import typings.typeorm.sqlserverSqlServerDriverMod.SqlServerDriver
...
@JSImport("typeorm/driver/sqlserver/SqlServerQueryRunner", JSImport.Namespace)
@js.native
object sqlserverSqlServerQueryRunnerMod extends js.Object {
