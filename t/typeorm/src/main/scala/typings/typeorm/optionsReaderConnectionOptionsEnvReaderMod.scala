...
@JSImport("typeorm/connection/options-reader/ConnectionOptionsEnvReader", JSImport.Namespace)
@js.native
object optionsReaderConnectionOptionsEnvReaderMod extends js.Object {
