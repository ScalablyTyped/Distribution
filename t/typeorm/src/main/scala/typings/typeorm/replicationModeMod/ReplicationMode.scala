package typings.typeorm.replicationModeMod
...
/* Rewritten from type alias, can be one of: 
  - typings.typeorm.typeormStrings.master
  - typings.typeorm.typeormStrings.slave
*/
trait ReplicationMode extends js.Object
