package typings.typeorm.mysqlMysqlConnectionOptionsMod
...
object MysqlConnectionOptions {
  ...
  implicit class MysqlConnectionOptionsOps[Self <: MysqlConnectionOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReplication(value: RemoveNodeErrorCount): Self = this.set("replication", value.asInstanceOf[js.Any])
