...
object distLibSetMod {
  ...
  open class default[T] ()
    ...
    var dictionary: typings.typescriptCollections.distLibDictionaryMod.default[T, Any] = js.native
  ...
  trait Set[T] extends StObject {
    ...
    /**
      ...
      * @protected
      */
    /* protected */ var dictionary: typings.typescriptCollections.distLibDictionaryMod.default[T, Any]
  ...
  object Set {
    ...
    inline def apply[T](
      ...
      clear: () => Unit,
      contains: T => Boolean,
      dictionary: typings.typescriptCollections.distLibDictionaryMod.default[T, Any],
    ...
    implicit open class MutableBuilder[Self <: Set[?], T] (val x: Self & Set[T]) extends AnyVal {
      ...
      inline def setDictionary(value: typings.typescriptCollections.distLibDictionaryMod.default[T, Any]): Self = StObject.set(x, "dictionary", value.asInstanceOf[js.Any])
