package typings.typescriptDashCollections.distLibSetMod
...
trait Set[T] extends js.Object {
  /**
    ...
    * @protected
    */
  var dictionary: typings.typescriptDashCollections.distLibDictionaryMod.default[T, _]
  /**
...
object Set {
  ...
  def apply[T](
    ...
    clear: () => Unit,
    contains: T => Boolean,
    dictionary: typings.typescriptDashCollections.distLibDictionaryMod.default[T, _],
