...
import typings.typescriptDashCollections.distLibFactoryDictionaryMod.FactoryDictionary
...
object distLibFactoryDictionaryMod extends js.Object {
  ...
  trait FactoryDictionary[K, V]
    extends typings.typescriptDashCollections.distLibDictionaryMod.default[K, V] {
    /**
