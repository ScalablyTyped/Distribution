...
import typings.typescriptDashCollections.distLibBSTreeKVMod.default
...
object typescriptDashCollectionsMod extends js.Object {
  ...
  /**
    ...
    */
  class Bag[T] ()
    extends typings.typescriptDashCollections.distLibBagMod.default[T] {
    def this(toStrFunction: js.Function1[/* item */ T, String]) = this()
  }
  
  @js.native
  class DefaultDictionary[K, V] protected ()
    extends typings.typescriptDashCollections.distLibFactoryDictionaryMod.default[K, V] {
    /**
  ...
  /**
    ...
    */
  class Heap[T] ()
    extends typings.typescriptDashCollections.distLibHeapMod.default[T] {
    def this(compareFunction: ICompareFunction[T]) = this()
  }
  
  @js.native
  class LinkedDictionary[K, V] ()
    extends typings.typescriptDashCollections.distLibLinkedDictionaryMod.default[K, V] {
    def this(toStrFunction: js.Function1[/* key */ K, String]) = this()
  }
  ...
  /**
    ...
    */
  class LinkedList[T] ()
    extends typings.typescriptDashCollections.distLibLinkedListMod.default[T]
  ...
  class MultiDictionary[K, V] ()
    extends typings.typescriptDashCollections.distLibMultiDictionaryMod.default[K, V] {
    def this(toStrFunction: js.Function1[/* key */ K, String]) = this()
  ...
  @js.native
  class MultiRootTree ()
    extends typings.typescriptDashCollections.distLibMultiRootTreeMod.default {
  ...
  class PriorityQueue[T] ()
    extends typings.typescriptDashCollections.distLibPriorityQueueMod.default[T] {
    def this(compareFunction: ICompareFunction[T]) = this()
  }
  ...
  /**
    ...
    */
  class Queue[T] ()
    extends typings.typescriptDashCollections.distLibQueueMod.default[T]
  ...
  /**
    ...
    */
  class Set[T] ()
    extends typings.typescriptDashCollections.distLibSetMod.default[T] {
  ...
  /**
    ...
    */
  class Stack[T] ()
    extends typings.typescriptDashCollections.distLibStackMod.default[T]
