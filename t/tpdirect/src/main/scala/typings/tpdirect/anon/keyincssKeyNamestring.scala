...
/* Inlined {[ key in tpdirect.cssKeyName ]:? string} */
trait keyincssKeyNamestring extends StObject {
  ...
  var `-webkit-transitio`: js.UndefOr[String] = js.undefined
...
object keyincssKeyNamestring {
  
  inline def apply(): keyincssKeyNamestring = {
  ...
  implicit open class MutableBuilder[Self <: keyincssKeyNamestring] (val x: Self) extends AnyVal {
    ...
    inline def `set-webkit-transitio`(value: String): Self = StObject.set(x, "-webkit-transitio", value.asInstanceOf[js.Any])
    
    inline def `set-webkit-transitioUndefined`: Self = StObject.set(x, "-webkit-transitio", js.undefined)
