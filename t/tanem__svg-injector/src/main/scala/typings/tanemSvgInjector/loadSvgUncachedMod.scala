...
object loadSvgUncachedMod {
  ...
  @scala.inline
  def default(url: String, callback: Errback): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(url.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
