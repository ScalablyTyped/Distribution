...
import typings.tsLoader.tsLoaderStrings.quit
...
object anon {
  ...
  trait Compiler extends StObject {
    ...
    var compiler: js.UndefOr[Typeoftypescript] = js.undefined
    
    var compilerCompatible: Boolean
    
    var compilerDetailsLogMessage: js.UndefOr[String] = js.undefined
  ...
  trait Error extends StObject {
    ...
    var error: js.UndefOr[WebpackError] = js.undefined
    
    var instance: js.UndefOr[TSInstance] = js.undefined
  }
  object Error {
  ...
  trait FnCallPathCallbackPollingIntervalOptions extends StObject {
    ...
    def apply(path: String, callback: FileWatcherCallback, pollingInterval: Double, options: WatchOptions): FileWatcher = js.native
    def apply(path: String, callback: FileWatcherCallback, pollingInterval: Unit, options: WatchOptions): FileWatcher = js.native
  }
  ...
  trait FnCallPathCallbackRecursiveOptions extends StObject {
    ...
    def apply(path: String, callback: DirectoryWatcherCallback, recursive: Boolean, options: WatchOptions): FileWatcher = js.native
    def apply(path: String, callback: DirectoryWatcherCallback, recursive: Unit, options: WatchOptions): FileWatcher = js.native
  }
  ...
  trait OutputFileName extends StObject {
    ...
    /**
      ...
      */
    var project: js.UndefOr[ResolvedProjectReference] = js.undefined
  }
