...
object TvInfoValue extends StObject {
  ...
  sealed trait TV_VIEWER_BG_EXECUTABLE
    extends StObject
       with TvInfoValue
  /* 1 */ val TV_VIEWER_BG_EXECUTABLE: typings.tizenTvWebapis.mod.TvInfoValue.TV_VIEWER_BG_EXECUTABLE & Double = js.native
  ...
  sealed trait TV_VIEWER_BG_NOT_EXECUTABLE
    extends StObject
       with TvInfoValue
  /* 0 */ val TV_VIEWER_BG_NOT_EXECUTABLE: typings.tizenTvWebapis.mod.TvInfoValue.TV_VIEWER_BG_NOT_EXECUTABLE & Double = js.native
}
