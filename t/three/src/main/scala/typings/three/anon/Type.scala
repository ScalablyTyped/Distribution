...
object Type {
  ...
  implicit class TypeOps[Self <: Type] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: XRControllerEventType): Self = this.set("type", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setData(value: XRInputSource): Self = this.set("data", value.asInstanceOf[js.Any])
