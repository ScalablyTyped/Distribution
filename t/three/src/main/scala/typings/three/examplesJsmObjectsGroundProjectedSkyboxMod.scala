...
object examplesJsmObjectsGroundProjectedSkyboxMod {
  
  @JSImport("three/examples/jsm/objects/GroundProjectedSkybox", "GroundProjectedSkybox")
  @js.native
  open class GroundProjectedSkybox protected () extends Mesh[IcosahedronGeometry, ShaderMaterial] {
