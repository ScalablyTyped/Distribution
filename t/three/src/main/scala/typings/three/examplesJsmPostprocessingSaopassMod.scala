...
object examplesJsmPostprocessingSaopassMod {
  ...
  object OUTPUT extends StObject {
    ...
    sealed trait Beauty
      extends StObject
         with OUTPUT
    /* 0 */ val Beauty: typings.three.examplesJsmPostprocessingSaopassMod.OUTPUT.Beauty & Double = js.native
    
    @js.native
    sealed trait Default
      extends StObject
         with OUTPUT
    /* 1 */ val Default: typings.three.examplesJsmPostprocessingSaopassMod.OUTPUT.Default & Double = js.native
    
    @js.native
    sealed trait Depth
      extends StObject
         with OUTPUT
    /* 3 */ val Depth: typings.three.examplesJsmPostprocessingSaopassMod.OUTPUT.Depth & Double = js.native
    
    @js.native
    sealed trait Normal
      extends StObject
         with OUTPUT
    /* 4 */ val Normal: typings.three.examplesJsmPostprocessingSaopassMod.OUTPUT.Normal & Double = js.native
    
    @js.native
    sealed trait SAO
      extends StObject
         with OUTPUT
    /* 2 */ val SAO: typings.three.examplesJsmPostprocessingSaopassMod.OUTPUT.SAO & Double = js.native
  }
