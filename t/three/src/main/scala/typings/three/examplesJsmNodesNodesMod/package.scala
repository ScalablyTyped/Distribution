...
inline def getDistanceAttenuation: typings.three.examplesJsmNodesShadernodeShaderNodeMod.ShaderNode[CutoffDistance, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("getDistanceAttenuation").asInstanceOf[typings.three.examplesJsmNodesShadernodeShaderNodeMod.ShaderNode[CutoffDistance, Node]]
...
inline def mxAastep(): Swizzable[MathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_aastep")().asInstanceOf[Swizzable[MathNode]]
inline def mxAastep(threshold: Unit, value: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_aastep")(threshold.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxAastep(threshold: NodeRepresentation[Node]): Swizzable[MathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_aastep")(threshold.asInstanceOf[js.Any]).asInstanceOf[Swizzable[MathNode]]
inline def mxAastep(threshold: NodeRepresentation[Node], value: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_aastep")(threshold.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]

inline def mxCellNoiseFloat(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_cell_noise_float")().asInstanceOf[Swizzable[Node]]
inline def mxCellNoiseFloat(texcoord: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_cell_noise_float")(texcoord.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]

inline def mxFractalNoiseFloat(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")().asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
  position: Unit,
  octaves: Unit,
  lacunarity: Unit,
  diminish: Unit,
  amplitude: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(position: Unit, octaves: Unit, lacunarity: Unit, diminish: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
  position: Unit,
  octaves: Unit,
  lacunarity: Unit,
  diminish: NodeRepresentation[Node],
  amplitude: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(position: Unit, octaves: Unit, lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
  position: Unit,
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
  diminish: Unit,
  amplitude: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
  ...
  lacunarity: NodeRepresentation[Node],
  diminish: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
  position: Unit,
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseFloat(position: Unit, octaves: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
  position: Unit,
  octaves: NodeRepresentation[Node],
  lacunarity: Unit,
  diminish: Unit,
  amplitude: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
...
inline def mxFractalNoiseFloat(position: Unit, octaves: NodeRepresentation[Node], lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
  position: Unit,
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseFloat(position: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
...
inline def mxFractalNoiseFloat(position: Swizzable[UVNode], octaves: Unit, lacunarity: Unit, diminish: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
  position: Swizzable[UVNode],
  octaves: Unit,
  lacunarity: Unit,
...
inline def mxFractalNoiseFloat(position: Swizzable[UVNode], octaves: Unit, lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
  position: Swizzable[UVNode],
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseFloat(position: Swizzable[UVNode], octaves: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
  position: Swizzable[UVNode],
  octaves: NodeRepresentation[Node],
  lacunarity: Unit,
...
inline def mxFractalNoiseFloat(
  ...
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_float")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseFloat(
  position: Swizzable[UVNode],
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec2(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")().asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(
  position: Unit,
  octaves: Unit,
  lacunarity: Unit,
  diminish: Unit,
  amplitude: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(position: Unit, octaves: Unit, lacunarity: Unit, diminish: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(
  position: Unit,
  octaves: Unit,
  lacunarity: Unit,
...
inline def mxFractalNoiseVec2(position: Unit, octaves: Unit, lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(
  position: Unit,
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec2(
  ...
  lacunarity: NodeRepresentation[Node],
  diminish: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(
  position: Unit,
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec2(position: Unit, octaves: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(
  position: Unit,
  octaves: NodeRepresentation[Node],
  lacunarity: Unit,
...
inline def mxFractalNoiseVec2(position: Unit, octaves: NodeRepresentation[Node], lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(
  position: Unit,
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec2(position: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")(position.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(
  position: Swizzable[UVNode],
  octaves: Unit,
  lacunarity: Unit,
...
inline def mxFractalNoiseVec2(position: Swizzable[UVNode], octaves: Unit, lacunarity: Unit, diminish: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(
  position: Swizzable[UVNode],
  octaves: Unit,
  lacunarity: Unit,
...
inline def mxFractalNoiseVec2(position: Swizzable[UVNode], octaves: Unit, lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(
  position: Swizzable[UVNode],
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec2(position: Swizzable[UVNode], octaves: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(
  position: Swizzable[UVNode],
  octaves: NodeRepresentation[Node],
  lacunarity: Unit,
...
inline def mxFractalNoiseVec2(
  ...
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec2")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec2(
  position: Swizzable[UVNode],
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec3(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")().asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(
  position: Unit,
  octaves: Unit,
  lacunarity: Unit,
  diminish: Unit,
  amplitude: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(position: Unit, octaves: Unit, lacunarity: Unit, diminish: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(
  position: Unit,
  octaves: Unit,
  lacunarity: Unit,
...
inline def mxFractalNoiseVec3(position: Unit, octaves: Unit, lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(
  position: Unit,
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec3(
  ...
  lacunarity: NodeRepresentation[Node],
  diminish: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(
  position: Unit,
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec3(position: Unit, octaves: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(
  position: Unit,
  octaves: NodeRepresentation[Node],
  lacunarity: Unit,
...
inline def mxFractalNoiseVec3(position: Unit, octaves: NodeRepresentation[Node], lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(
  position: Unit,
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec3(position: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")(position.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(
  position: Swizzable[UVNode],
  octaves: Unit,
  lacunarity: Unit,
...
inline def mxFractalNoiseVec3(position: Swizzable[UVNode], octaves: Unit, lacunarity: Unit, diminish: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(
  position: Swizzable[UVNode],
  octaves: Unit,
  lacunarity: Unit,
...
inline def mxFractalNoiseVec3(position: Swizzable[UVNode], octaves: Unit, lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(
  position: Swizzable[UVNode],
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec3(position: Swizzable[UVNode], octaves: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(
  position: Swizzable[UVNode],
  octaves: NodeRepresentation[Node],
  lacunarity: Unit,
...
inline def mxFractalNoiseVec3(
  ...
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec3")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec3(
  position: Swizzable[UVNode],
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec4(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")().asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(
  position: Unit,
  octaves: Unit,
  lacunarity: Unit,
  diminish: Unit,
  amplitude: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(position: Unit, octaves: Unit, lacunarity: Unit, diminish: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(
  position: Unit,
  octaves: Unit,
  lacunarity: Unit,
...
inline def mxFractalNoiseVec4(position: Unit, octaves: Unit, lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(
  position: Unit,
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec4(
  ...
  lacunarity: NodeRepresentation[Node],
  diminish: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(
  position: Unit,
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec4(position: Unit, octaves: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(
  position: Unit,
  octaves: NodeRepresentation[Node],
  lacunarity: Unit,
...
inline def mxFractalNoiseVec4(position: Unit, octaves: NodeRepresentation[Node], lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(
  position: Unit,
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec4(position: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")(position.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(
  position: Swizzable[UVNode],
  octaves: Unit,
  lacunarity: Unit,
...
inline def mxFractalNoiseVec4(position: Swizzable[UVNode], octaves: Unit, lacunarity: Unit, diminish: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any], diminish.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(
  position: Swizzable[UVNode],
  octaves: Unit,
  lacunarity: Unit,
...
inline def mxFractalNoiseVec4(position: Swizzable[UVNode], octaves: Unit, lacunarity: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(
  position: Swizzable[UVNode],
  octaves: Unit,
  lacunarity: NodeRepresentation[Node],
...
inline def mxFractalNoiseVec4(position: Swizzable[UVNode], octaves: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(
  position: Swizzable[UVNode],
  octaves: NodeRepresentation[Node],
  lacunarity: Unit,
...
inline def mxFractalNoiseVec4(
  ...
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node]
): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_fractal_noise_vec4")(position.asInstanceOf[js.Any], octaves.asInstanceOf[js.Any], lacunarity.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxFractalNoiseVec4(
  position: Swizzable[UVNode],
  octaves: NodeRepresentation[Node],
  lacunarity: NodeRepresentation[Node],
...
inline def mxNoiseFloat(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_float")().asInstanceOf[Swizzable[Node]]
inline def mxNoiseFloat(texcoord: Unit, amplitude: Unit, pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_float")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseFloat(texcoord: Unit, amplitude: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_float")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseFloat(texcoord: Unit, amplitude: NodeRepresentation[Node], pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_float")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseFloat(texcoord: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_float")(texcoord.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxNoiseFloat(texcoord: Swizzable[UVNode], amplitude: Unit, pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_float")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseFloat(texcoord: Swizzable[UVNode], amplitude: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_float")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseFloat(texcoord: Swizzable[UVNode], amplitude: NodeRepresentation[Node], pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_float")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]

inline def mxNoiseVec2(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec2")().asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec2(texcoord: Unit, amplitude: Unit, pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec2")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec2(texcoord: Unit, amplitude: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec2")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec2(texcoord: Unit, amplitude: NodeRepresentation[Node], pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec2")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec2(texcoord: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec2")(texcoord.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec2(texcoord: Swizzable[UVNode], amplitude: Unit, pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec2")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec2(texcoord: Swizzable[UVNode], amplitude: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec2")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec2(texcoord: Swizzable[UVNode], amplitude: NodeRepresentation[Node], pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec2")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]

inline def mxNoiseVec3(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec3")().asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec3(texcoord: Unit, amplitude: Unit, pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec3")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec3(texcoord: Unit, amplitude: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec3")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec3(texcoord: Unit, amplitude: NodeRepresentation[Node], pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec3")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec3(texcoord: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec3")(texcoord.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec3(texcoord: Swizzable[UVNode], amplitude: Unit, pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec3")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec3(texcoord: Swizzable[UVNode], amplitude: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec3")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec3(texcoord: Swizzable[UVNode], amplitude: NodeRepresentation[Node], pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec3")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]

inline def mxNoiseVec4(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec4")().asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec4(texcoord: Unit, amplitude: Unit, pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec4")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec4(texcoord: Unit, amplitude: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec4")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec4(texcoord: Unit, amplitude: NodeRepresentation[Node], pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec4")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec4(texcoord: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec4")(texcoord.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec4(texcoord: Swizzable[UVNode], amplitude: Unit, pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec4")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec4(texcoord: Swizzable[UVNode], amplitude: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec4")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxNoiseVec4(texcoord: Swizzable[UVNode], amplitude: NodeRepresentation[Node], pivot: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_noise_vec4")(texcoord.asInstanceOf[js.Any], amplitude.asInstanceOf[js.Any], pivot.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]

inline def mxRamplr(): Swizzable[MathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramplr")().asInstanceOf[Swizzable[MathNode]]
inline def mxRamplr(valuel: Unit, valuer: Unit, texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramplr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxRamplr(valuel: Unit, valuer: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramplr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxRamplr(valuel: Unit, valuer: NodeRepresentation[Node], texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramplr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxRamplr(valuel: NodeRepresentation[Node]): Swizzable[MathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramplr")(valuel.asInstanceOf[js.Any]).asInstanceOf[Swizzable[MathNode]]
inline def mxRamplr(valuel: NodeRepresentation[Node], valuer: Unit, texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramplr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxRamplr(valuel: NodeRepresentation[Node], valuer: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramplr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxRamplr(valuel: NodeRepresentation[Node], valuer: NodeRepresentation[Node], texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramplr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]

inline def mxRamptb(): Swizzable[MathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramptb")().asInstanceOf[Swizzable[MathNode]]
inline def mxRamptb(valuet: Unit, valueb: Unit, texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramptb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxRamptb(valuet: Unit, valueb: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramptb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxRamptb(valuet: Unit, valueb: NodeRepresentation[Node], texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramptb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxRamptb(valuet: NodeRepresentation[Node]): Swizzable[MathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramptb")(valuet.asInstanceOf[js.Any]).asInstanceOf[Swizzable[MathNode]]
inline def mxRamptb(valuet: NodeRepresentation[Node], valueb: Unit, texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramptb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxRamptb(valuet: NodeRepresentation[Node], valueb: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramptb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxRamptb(valuet: NodeRepresentation[Node], valueb: NodeRepresentation[Node], texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_ramptb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
...
inline def mxSplitlr(): Swizzable[MathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")().asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(valuel: Unit, valuer: Unit, center: Unit, texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(valuel: Unit, valuer: Unit, center: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], center.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(valuel: Unit, valuer: Unit, center: NodeRepresentation[Node], texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(valuel: Unit, valuer: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(valuel: Unit, valuer: NodeRepresentation[Node], center: Unit, texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(valuel: Unit, valuer: NodeRepresentation[Node], center: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], center.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(
  valuel: Unit,
  valuer: NodeRepresentation[Node],
  center: NodeRepresentation[Node],
  texcoord: Swizzable[UVNode]
): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(valuel: NodeRepresentation[Node]): Swizzable[MathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any]).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(valuel: NodeRepresentation[Node], valuer: Unit, center: Unit, texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(valuel: NodeRepresentation[Node], valuer: Unit, center: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], center.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(
  valuel: NodeRepresentation[Node],
  valuer: Unit,
  center: NodeRepresentation[Node],
  texcoord: Swizzable[UVNode]
): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(valuel: NodeRepresentation[Node], valuer: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(
  valuel: NodeRepresentation[Node],
  valuer: NodeRepresentation[Node],
  center: Unit,
...
inline def mxSplitlr(
  ...
  valuer: NodeRepresentation[Node],
  center: NodeRepresentation[Node]
): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splitlr")(valuel.asInstanceOf[js.Any], valuer.asInstanceOf[js.Any], center.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplitlr(
  valuel: NodeRepresentation[Node],
  valuer: NodeRepresentation[Node],
  center: NodeRepresentation[Node],
...
inline def mxSplittb(): Swizzable[MathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")().asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(valuet: Unit, valueb: Unit, center: Unit, texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(valuet: Unit, valueb: Unit, center: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], center.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(valuet: Unit, valueb: Unit, center: NodeRepresentation[Node], texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(valuet: Unit, valueb: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(valuet: Unit, valueb: NodeRepresentation[Node], center: Unit, texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(valuet: Unit, valueb: NodeRepresentation[Node], center: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], center.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(
  valuet: Unit,
  valueb: NodeRepresentation[Node],
  center: NodeRepresentation[Node],
  texcoord: Swizzable[UVNode]
): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(valuet: NodeRepresentation[Node]): Swizzable[MathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any]).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(valuet: NodeRepresentation[Node], valueb: Unit, center: Unit, texcoord: Swizzable[UVNode]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(valuet: NodeRepresentation[Node], valueb: Unit, center: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], center.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(
  valuet: NodeRepresentation[Node],
  valueb: Unit,
  center: NodeRepresentation[Node],
  texcoord: Swizzable[UVNode]
): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], center.asInstanceOf[js.Any], texcoord.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(valuet: NodeRepresentation[Node], valueb: NodeRepresentation[Node]): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(
  valuet: NodeRepresentation[Node],
  valueb: NodeRepresentation[Node],
  center: Unit,
...
inline def mxSplittb(
  ...
  valueb: NodeRepresentation[Node],
  center: NodeRepresentation[Node]
): Swizzable[MathNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_splittb")(valuet.asInstanceOf[js.Any], valueb.asInstanceOf[js.Any], center.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MathNode]]
inline def mxSplittb(
  valuet: NodeRepresentation[Node],
  valueb: NodeRepresentation[Node],
  center: NodeRepresentation[Node],
...
inline def mxTransformUv(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_transform_uv")().asInstanceOf[Swizzable[Node]]
inline def mxTransformUv(uv_scale: Unit, uv_offset: Unit, uv_geo: Swizzable[UVNode]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_transform_uv")(uv_scale.asInstanceOf[js.Any], uv_offset.asInstanceOf[js.Any], uv_geo.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxTransformUv(uv_scale: Unit, uv_offset: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_transform_uv")(uv_scale.asInstanceOf[js.Any], uv_offset.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxTransformUv(uv_scale: Unit, uv_offset: NodeRepresentation[Node], uv_geo: Swizzable[UVNode]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_transform_uv")(uv_scale.asInstanceOf[js.Any], uv_offset.asInstanceOf[js.Any], uv_geo.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxTransformUv(uv_scale: NodeRepresentation[Node]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_transform_uv")(uv_scale.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxTransformUv(uv_scale: NodeRepresentation[Node], uv_offset: Unit, uv_geo: Swizzable[UVNode]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_transform_uv")(uv_scale.asInstanceOf[js.Any], uv_offset.asInstanceOf[js.Any], uv_geo.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxTransformUv(uv_scale: NodeRepresentation[Node], uv_offset: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_transform_uv")(uv_scale.asInstanceOf[js.Any], uv_offset.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxTransformUv(uv_scale: NodeRepresentation[Node], uv_offset: NodeRepresentation[Node], uv_geo: Swizzable[UVNode]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_transform_uv")(uv_scale.asInstanceOf[js.Any], uv_offset.asInstanceOf[js.Any], uv_geo.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]

inline def mxWorleyNoiseFloat(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_float")().asInstanceOf[Swizzable[Node]]
inline def mxWorleyNoiseFloat(texcoord: Unit, jitter: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_float")(texcoord.asInstanceOf[js.Any], jitter.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxWorleyNoiseFloat(texcoord: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_float")(texcoord.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxWorleyNoiseFloat(texcoord: Swizzable[UVNode], jitter: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_float")(texcoord.asInstanceOf[js.Any], jitter.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]

inline def mxWorleyNoiseVec2(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_vec2")().asInstanceOf[Swizzable[Node]]
inline def mxWorleyNoiseVec2(texcoord: Unit, jitter: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_vec2")(texcoord.asInstanceOf[js.Any], jitter.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxWorleyNoiseVec2(texcoord: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_vec2")(texcoord.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxWorleyNoiseVec2(texcoord: Swizzable[UVNode], jitter: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_vec2")(texcoord.asInstanceOf[js.Any], jitter.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]

inline def mxWorleyNoiseVec3(): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_vec3")().asInstanceOf[Swizzable[Node]]
inline def mxWorleyNoiseVec3(texcoord: Unit, jitter: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_vec3")(texcoord.asInstanceOf[js.Any], jitter.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
inline def mxWorleyNoiseVec3(texcoord: Swizzable[UVNode]): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_vec3")(texcoord.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
inline def mxWorleyNoiseVec3(texcoord: Swizzable[UVNode], jitter: NodeRepresentation[Node]): Swizzable[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("mx_worley_noise_vec3")(texcoord.asInstanceOf[js.Any], jitter.asInstanceOf[js.Any])).asInstanceOf[Swizzable[Node]]
...
inline def viewportBottomLeft: Swizzable[ViewportNode] = ^.asInstanceOf[js.Dynamic].selectDynamic("viewportBottomLeft").asInstanceOf[Swizzable[ViewportNode]]

inline def viewportBottomRight: Swizzable[ViewportNode] = ^.asInstanceOf[js.Dynamic].selectDynamic("viewportBottomRight").asInstanceOf[Swizzable[ViewportNode]]

inline def viewportCoordinate: Swizzable[ViewportNode] = ^.asInstanceOf[js.Dynamic].selectDynamic("viewportCoordinate").asInstanceOf[Swizzable[ViewportNode]]

inline def viewportResolution: Swizzable[ViewportNode] = ^.asInstanceOf[js.Dynamic].selectDynamic("viewportResolution").asInstanceOf[Swizzable[ViewportNode]]

inline def viewportTopLeft: Swizzable[ViewportNode] = ^.asInstanceOf[js.Dynamic].selectDynamic("viewportTopLeft").asInstanceOf[Swizzable[ViewportNode]]

inline def viewportTopRight: Swizzable[ViewportNode] = ^.asInstanceOf[js.Dynamic].selectDynamic("viewportTopRight").asInstanceOf[Swizzable[ViewportNode]]
