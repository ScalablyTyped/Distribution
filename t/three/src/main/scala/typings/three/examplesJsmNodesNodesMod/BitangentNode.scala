...
import typings.three.examplesJsmNodesAccessorsBitangentNodeMod.BitangentNodeScope
import typings.three.examplesJsmNodesAccessorsBitangentNodeMod.default
...
@JSImport("three/examples/jsm/nodes/Nodes", "BitangentNode")
@js.native
open class BitangentNode () extends default {
  def this(scope: BitangentNodeScope) = this()
}
/* static members */
object BitangentNode {
  
  @JSImport("three/examples/jsm/nodes/Nodes", "BitangentNode")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("three/examples/jsm/nodes/Nodes", "BitangentNode.GEOMETRY")
  @js.native
  ...
  @JSImport("three/examples/jsm/nodes/Nodes", "BitangentNode.LOCAL")
  @js.native
  ...
  @JSImport("three/examples/jsm/nodes/Nodes", "BitangentNode.VIEW")
  @js.native
  def VIEW: view = js.native
  inline def VIEW_=(x: view): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("VIEW")(x.asInstanceOf[js.Any])
  
  @JSImport("three/examples/jsm/nodes/Nodes", "BitangentNode.WORLD")
  @js.native
