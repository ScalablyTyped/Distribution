...
object srcMathColorManagementMod {
  ...
  object ColorManagement {
    ...
    inline def fromWorkingColorSpace(color: Color, targetColorSpace: LinearSRGBColorSpace | SRGBColorSpace): Color = (^.asInstanceOf[js.Dynamic].applyDynamic("fromWorkingColorSpace")(color.asInstanceOf[js.Any], targetColorSpace.asInstanceOf[js.Any])).asInstanceOf[Color]
    ...
    inline def toWorkingColorSpace(color: Color, sourceColorSpace: LinearSRGBColorSpace | SRGBColorSpace): Color = (^.asInstanceOf[js.Dynamic].applyDynamic("toWorkingColorSpace")(color.asInstanceOf[js.Any], sourceColorSpace.asInstanceOf[js.Any])).asInstanceOf[Color]
