...
object curveModifierMod {
  ...
  inline def modifyShader(material: typings.three.threeMod.Material, uniforms: SplineUniform): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("modifyShader")(material.asInstanceOf[js.Any], uniforms.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def modifyShader(material: typings.three.threeMod.Material, uniforms: SplineUniform, numberOfCurves: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("modifyShader")(material.asInstanceOf[js.Any], uniforms.asInstanceOf[js.Any], numberOfCurves.asInstanceOf[js.Any])).asInstanceOf[Unit]
