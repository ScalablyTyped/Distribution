...
object mathUtilsMod {
  ...
  object MathUtils {
    ...
    @JSImport("three/src/math/MathUtils", "MathUtils")
    @js.native
    ...
    @scala.inline
    def setQuaternionFromProperEuler(q: Quaternion, a: Double, b: Double, c: Double, order: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setQuaternionFromProperEuler")(q.asInstanceOf[js.Any], a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any], order.asInstanceOf[js.Any])).asInstanceOf[Unit]
