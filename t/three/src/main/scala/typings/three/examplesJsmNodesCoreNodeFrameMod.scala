...
object examplesJsmNodesCoreNodeFrameMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    override def updateNode(node: typings.three.examplesJsmNodesCoreNodeMod.default): Unit = js.native
  }
  ...
  trait NodeFrame extends StObject {
    ...
    def updateNode(node: typings.three.examplesJsmNodesCoreNodeMod.default): Unit
  }
  object NodeFrame {
    ...
    inline def apply(
      ...
      time: Double,
      update: () => Unit,
      updateNode: typings.three.examplesJsmNodesCoreNodeMod.default => Unit
    ): NodeFrame = {
    ...
    extension [Self <: NodeFrame](x: Self) {
      ...
      inline def setUpdateNode(value: typings.three.examplesJsmNodesCoreNodeMod.default => Unit): Self = StObject.set(x, "updateNode", js.Any.fromFunction1(value))
    }
  }
}
