...
import typings.three.dracoloaderMod.DRACOLoader
...
import typings.three.threeMod.FileLoader
import typings.three.threeMod.Group
import typings.three.threeMod.ImageBitmapLoader
...
object gltfloaderMod {
  ...
  open class GLTFParser () extends StObject {
    ...
    var associations: Map[Object3D[Event] | typings.three.threeMod.Material | Texture, GLTFReference] = js.native
    ...
    ): js.Promise[js.Array[typings.three.threeMod.BufferGeometry]] = js.native
    
    def loadImageSource(sourceIndex: Double, loader: Loader): js.Promise[Texture] = js.native
    
    def loadMaterial(materialIndex: Double): js.Promise[typings.three.threeMod.Material] = js.native
  ...
  trait GLTFLoaderPlugin extends StObject {
    ...
    var getMaterialType: js.UndefOr[
        js.Function1[/* materialIndex */ Double, Instantiable0[typings.three.threeMod.Material] | Null]
      ] = js.undefined
    ...
    var loadMaterial: js.UndefOr[
        js.Function1[/* materialIndex */ Double, js.Promise[typings.three.threeMod.Material] | Null]
      ] = js.undefined
  ...
  object GLTFLoaderPlugin {
    ...
    extension [Self <: GLTFLoaderPlugin](x: Self) {
      ...
      inline def setGetMaterialType(value: /* materialIndex */ Double => Instantiable0[typings.three.threeMod.Material] | Null): Self = StObject.set(x, "getMaterialType", js.Any.fromFunction1(value))
      ...
      inline def setLoadMaterial(value: /* materialIndex */ Double => js.Promise[typings.three.threeMod.Material] | Null): Self = StObject.set(x, "loadMaterial", js.Any.fromFunction1(value))
