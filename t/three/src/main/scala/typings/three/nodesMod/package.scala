...
inline def BRDFLambert: typings.three.shaderNodeBaseElementsMod.ShaderNode[DiffuseColor, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("BRDF_Lambert").asInstanceOf[typings.three.shaderNodeBaseElementsMod.ShaderNode[DiffuseColor, Node]]

inline def BRDF_GGX: typings.three.shaderNodeBaseElementsMod.ShaderNode[F0, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("BRDF_GGX").asInstanceOf[typings.three.shaderNodeBaseElementsMod.ShaderNode[F0, Node]]

// Analytical approximation of the DFG LUT, one half of the
// split-sum approximation used in indirect specular lighting.
// via 'environmentBRDF' from "Physically Based Shading on Mobile"
// https://www.unrealengine.com/blog/physically-based-shading-on-mobile
inline def DFGApprox: typings.three.shaderNodeElementsMod.ShaderNode[Roughness, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("DFGApprox").asInstanceOf[typings.three.shaderNodeElementsMod.ShaderNode[Roughness, Node]]

// Microfacet Models for Refraction through Rough Surfaces - equation (33)
// http://graphicrants.blogspot.com/2013/08/specular-brdf-reference.html
// alpha is "roughness squared" in Disney’s reparameterization
inline def D_GGX: typings.three.shaderNodeBaseElementsMod.ShaderNode[Alpha, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("D_GGX").asInstanceOf[typings.three.shaderNodeBaseElementsMod.ShaderNode[Alpha, Node]]

inline def EPSILON: Swizzable[Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("EPSILON").asInstanceOf[Swizzable[Node]]

inline def FSchlick: typings.three.shaderNodeBaseElementsMod.ShaderNode[DotVH, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("F_Schlick").asInstanceOf[typings.three.shaderNodeBaseElementsMod.ShaderNode[DotVH, Node]]

inline def INFINITY: Swizzable[Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("INFINITY").asInstanceOf[Swizzable[Node]]

inline def VGGXSmithCorrelated: typings.three.shaderNodeBaseElementsMod.ShaderNode[DotNL, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("V_GGX_SmithCorrelated").asInstanceOf[typings.three.shaderNodeBaseElementsMod.ShaderNode[DotNL, Node]]
...
inline def getDistanceAttenuation: typings.three.shaderNodeBaseElementsMod.ShaderNode[CutoffDistance, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("getDistanceAttenuation").asInstanceOf[typings.three.shaderNodeBaseElementsMod.ShaderNode[CutoffDistance, Node]]

inline def getGeometryRoughness: typings.three.shaderNodeBaseElementsMod.ShaderNode[js.Object, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("getGeometryRoughness").asInstanceOf[typings.three.shaderNodeBaseElementsMod.ShaderNode[js.Object, Node]]

inline def getRoughness: typings.three.shaderNodeElementsMod.ShaderNode[Roughness, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("getRoughness").asInstanceOf[typings.three.shaderNodeElementsMod.ShaderNode[Roughness, Node]]
