...
@JSImport("three/build/three.min", "Float16BufferAttribute")
@js.native
open class Float16BufferAttribute protected ()
  extends typings.three.srcThreeMod.Float16BufferAttribute {
  /**
