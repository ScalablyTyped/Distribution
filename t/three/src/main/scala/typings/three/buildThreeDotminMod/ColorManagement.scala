...
object ColorManagement {
  ...
  @JSImport("three/build/three.min", "ColorManagement")
  @js.native
  ...
  /**
    * @default false
    */
  @JSImport("three/build/three.min", "ColorManagement.enabled")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("three/build/three.min", "ColorManagement.workingColorSpace")
  @js.native
