...
@JSImport("three/build/three.min", "Texture")
@js.native
...
object Texture {
  ...
  /**
    ...
    * @defaultValue `1`.
    */
  @JSImport("three/build/three.min", "Texture.DEFAULT_ANISOTROPY")
  @js.native
  ...
  /**
    ...
    * @defaultValue `null`.
    */
  @JSImport("three/build/three.min", "Texture.DEFAULT_IMAGE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("three/build/three.min", "Texture.DEFAULT_MAPPING")
  @js.native
