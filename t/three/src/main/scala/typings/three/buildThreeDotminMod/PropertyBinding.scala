...
@JSImport("three/build/three.min", "PropertyBinding")
@js.native
open class PropertyBinding protected ()
  extends typings.three.srcThreeMod.PropertyBinding {
...
object PropertyBinding {
  ...
  @JSImport("three/build/three.min", "PropertyBinding.Composite")
  @js.native
  open class Composite protected ()
    extends typings.three.srcThreeMod.PropertyBinding.Composite {
