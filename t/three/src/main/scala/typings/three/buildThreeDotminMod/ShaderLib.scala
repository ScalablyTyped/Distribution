...
object ShaderLib {
  ...
  @JSImport("three/build/three.min", "ShaderLib")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("three/build/three.min", "ShaderLib.background")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.basic")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.depth")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.distanceRGBA")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.equirect")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.lambert")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.matcap")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.normal")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.phong")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.physical")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.points")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.shadow")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.sprite")
  @js.native
  ...
  @JSImport("three/build/three.min", "ShaderLib.standard")
  @js.native
