...
@JSImport("three/examples/jsm/libs/fflate.module.min", "AsyncZipDeflate")
@js.native
open class AsyncZipDeflate protected ()
  ...
  @JSName("flag")
  var flag_AsyncZipDeflate: 0 | 1 | 2 | 3 = js.native
  
  @JSName("ondata")
  def ondata_MAsyncZipDeflate(err: js.Error, data: js.typedarray.Uint8Array, `final`: Boolean): Unit = js.native
  @JSName("ondata")
  ...
  @JSName("terminate")
  def terminate_MAsyncZipDeflate(): Unit = js.native
  @JSName("terminate")
