...
import typings.three.nodesMod.ConstNode
import typings.three.nodesMod.Node
import typings.three.nodesMod.NodeBuilder
import typings.three.threeStrings.NodeArray
import typings.three.threeStrings.NodeObjects
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object shaderNodeMod {
  ...
  open class ShaderNode[T, R /* <: Node */] protected () extends StObject {
    ...
    {[ key in keyof T ]: T[key] extends three.three/examples/jsm/nodes/shadernode/ShaderNode.NodeRepresentation<three.three/examples/jsm/nodes/Nodes.Node>? three.three/examples/jsm/nodes/shadernode/ShaderNode.Swizzable<three.three/examples/jsm/nodes/Nodes.Node> | three.three/examples/jsm/nodes/Nodes.Node : T[key]}
      */ typings.three.threeStrings.ShaderNode & TopLevel[Any]
  ...
  /**
    ...
    */
  type ExtractScopes[T /* <: AnyConstructors */] = /* import warning: importer.ImportType#apply Failed type conversion: T['a'][0] */ js.Any
  ...
  trait FilterConstructorsByScope[T /* <: AnyConstructors */, S] extends StObject {
    ...
    var b: js.UndefOr[
        /* import warning: importer.ImportType#apply Failed type conversion: T['b'] */ js.Any
      ] = js.undefined
    
    var c: js.UndefOr[
        /* import warning: importer.ImportType#apply Failed type conversion: T['c'] */ js.Any
      ] = js.undefined
    
    var d: js.UndefOr[
        /* import warning: importer.ImportType#apply Failed type conversion: T['d'] */ js.Any
      ] = js.undefined
  }
  object FilterConstructorsByScope {
    
    inline def apply[T /* <: AnyConstructors */, S](): FilterConstructorsByScope[T, S] = {
    ...
    extension [Self <: FilterConstructorsByScope[?, ?], T /* <: AnyConstructors */, S](x: Self & (FilterConstructorsByScope[T, S])) {
      ...
      inline def setA(value: /* import warning: importer.ImportType#apply Failed type conversion: T['a'] */ js.Any): Self = StObject.set(x, "a", value.asInstanceOf[js.Any])
      
      inline def setAUndefined: Self = StObject.set(x, "a", js.undefined)
      
      inline def setB(value: /* import warning: importer.ImportType#apply Failed type conversion: T['b'] */ js.Any): Self = StObject.set(x, "b", value.asInstanceOf[js.Any])
      
      inline def setBUndefined: Self = StObject.set(x, "b", js.undefined)
      
      inline def setC(value: /* import warning: importer.ImportType#apply Failed type conversion: T['c'] */ js.Any): Self = StObject.set(x, "c", value.asInstanceOf[js.Any])
      
      inline def setCUndefined: Self = StObject.set(x, "c", js.undefined)
      
      inline def setD(value: /* import warning: importer.ImportType#apply Failed type conversion: T['d'] */ js.Any): Self = StObject.set(x, "d", value.asInstanceOf[js.Any])
  ...
  type NodeArray_[T /* <: js.Array[NodeObjectOption] */] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ index in keyof T ]: three.three/examples/jsm/nodes/shadernode/ShaderNode.NodeObject<T[index]>}
    */ NodeArray & TopLevel[T]
  
  type NodeObjectOption = NodeRepresentation[Node] | String
  
  type NodeObject_[T] = T | (Swizzable[ConstNode | T])
  
  type NodeObjects_[T] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ key in keyof T ]: T[key] extends three.three/examples/jsm/nodes/shadernode/ShaderNode.NodeObjectOption? three.three/examples/jsm/nodes/shadernode/ShaderNode.NodeObject<T[key]> : T[key]}
    */ NodeObjects & TopLevel[Any]
  
  /* Rewritten from type alias, can be one of: 
    - typings.three.nodesMod.Node
    - typings.three.constantsMod.NodeTypeOption
  */
  ...
  /**
    ...
    */
  type OverloadedConstructorsOf[T] = Construtors[Any | Unit, Any | Unit, Any | Unit, Any | Unit]
  
  // opposite of NodeObject: node -> node|swizzable|boolean|number, otherwise do nothing
  type Proxied[T] = T | NodeRepresentation[T]
  
  type ProxiedObject[T] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ index in keyof T ]: three.three/examples/jsm/nodes/shadernode/ShaderNode.Proxied<T[index]>}
    */ typings.three.threeStrings.ProxiedObject & TopLevel[T]
  ...
  {[ index in keyof T ]: three.three/examples/jsm/nodes/shadernode/ShaderNode.Proxied<T[index]>}
    */ typings.three.threeStrings.ProxiedTuple & TopLevel[T]
  ]
  ...
  type Swizzable[T /* <: Node */] = T & typings.three.threeStrings.Swizzable & TopLevel[Any]
}
