...
object nodeUniformMod {
  ...
  open class default protected ()
    extends StObject
       with NodeUniform {
    def this(name: String, `type`: String, node: typings.three.inputNodeMod.default) = this()
    def this(name: String, `type`: String, node: typings.three.inputNodeMod.default, needsUpdate: Boolean) = this()
    ...
    /* CompleteClass */
    var node: typings.three.inputNodeMod.default = js.native
  ...
  trait NodeUniform extends StObject {
    ...
    var node: typings.three.inputNodeMod.default
  ...
  object NodeUniform {
    ...
    inline def apply(
      name: String,
      needsUpdate: Boolean,
      node: typings.three.inputNodeMod.default,
      `type`: String,
    ...
    extension [Self <: NodeUniform](x: Self) {
      ...
      inline def setNode(value: typings.three.inputNodeMod.default): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
