...
object examplesJsmNodesCoreFunctionNodeMod {
  ...
  trait FunctionNode[P /* <: js.Array[typings.three.examplesJsmNodesCoreNodeMod.default] | StringDictionary[typings.three.examplesJsmNodesCoreNodeMod.default] */]
    extends typings.three.examplesJsmNodesCoreCodeNodeMod.default {
    
    def call(parameters: P): typings.three.examplesJsmNodesCoreFunctionCallNodeMod.default[P] = js.native
