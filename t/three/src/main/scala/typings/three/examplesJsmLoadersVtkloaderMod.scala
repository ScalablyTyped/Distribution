...
object examplesJsmLoadersVtkloaderMod {
  ...
  open class VTKLoader () extends Loader {
    ...
    def parse(data: String, path: String): BufferGeometry[NormalBufferAttributes] = js.native
    def parse(data: js.typedarray.ArrayBuffer, path: String): BufferGeometry[NormalBufferAttributes] = js.native
  }
}
