...
object shaderNodeBaseElementsMod {
  ...
  open class ShaderNode[T, R /* <: Node */] protected ()
    extends typings.three.shaderNodeMod.ShaderNode[T, R] {
  ...
  type Fn_[P /* <: FunctionNodeArguments */] = js.Array[ProxiedObject[P]] | ProxiedTuple[P]
