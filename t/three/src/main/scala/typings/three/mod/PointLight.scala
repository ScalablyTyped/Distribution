...
@js.native
class PointLight ()
  extends typings.three.pointLightMod.PointLight {
  ...
  def this(color: typings.three.colorMod.Color, intensity: js.UndefOr[scala.Nothing], distance: Double) = this()
  def this(color: typings.three.colorMod.Color, intensity: Double, distance: Double) = this()
  def this(
  ...
  def this(color: typings.three.colorMod.Color, intensity: Double, distance: Double, decay: Double) = this()
}
