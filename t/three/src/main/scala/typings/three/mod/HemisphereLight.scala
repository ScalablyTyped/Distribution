...
class HemisphereLight ()
  ...
  def this(skyColor: js.UndefOr[scala.Nothing], groundColor: typings.three.colorMod.Color) = this()
  ...
  def this(skyColor: js.UndefOr[scala.Nothing], groundColor: typings.three.colorMod.Color, intensity: Double) = this()
  ...
  def this(skyColor: typings.three.colorMod.Color, groundColor: js.UndefOr[scala.Nothing], intensity: Double) = this()
