...
class PointLightHelper protected ()
  ...
  def this(light: typings.three.pointLightMod.PointLight, sphereSize: Unit, color: String) = this()
  def this(light: typings.three.pointLightMod.PointLight, sphereSize: Unit, color: Double) = this()
  def this(
    light: typings.three.pointLightMod.PointLight,
    sphereSize: Unit,
    color: typings.three.colorMod.Color
