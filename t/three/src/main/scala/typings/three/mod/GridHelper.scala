...
class GridHelper protected ()
  ...
  def this(size: Double, divisions: Double, color1: typings.three.colorMod.Color) = this()
  ...
  def this(size: Double, divisions: Double, color1: String, color2: typings.three.colorMod.Color) = this()
  ...
  def this(size: Double, divisions: Double, color1: Double, color2: typings.three.colorMod.Color) = this()
  def this(size: Double, divisions: Double, color1: typings.three.colorMod.Color, color2: String) = this()
  def this(size: Double, divisions: Double, color1: typings.three.colorMod.Color, color2: Double) = this()
  def this(
    size: Double,
    divisions: Double,
    color1: typings.three.colorMod.Color,
    color2: typings.three.colorMod.Color
  ) = this()
}
