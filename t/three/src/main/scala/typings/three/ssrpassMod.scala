...
import typings.three.passMod.FullScreenQuad
import typings.three.passMod.Pass
import typings.three.reflectorForSSRPassMod.ReflectorForSSRPass
...
object ssrpassMod {
  ...
  open class SSRPass protected () extends Pass {
    ...
    def selects: (js.Array[
        Mesh[
          typings.three.bufferGeometryMod.BufferGeometry, 
