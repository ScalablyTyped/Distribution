...
object ColorManagement {
  ...
  @JSImport("three/build/three.module.min", "ColorManagement")
  @js.native
  ...
  /**
    * @default false
    */
  @JSImport("three/build/three.module.min", "ColorManagement.enabled")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("three/build/three.module.min", "ColorManagement.workingColorSpace")
  @js.native
