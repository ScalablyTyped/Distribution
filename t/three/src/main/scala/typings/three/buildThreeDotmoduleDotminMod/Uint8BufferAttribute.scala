...
@JSImport("three/build/three.module.min", "Uint8BufferAttribute")
@js.native
open class Uint8BufferAttribute protected ()
  extends typings.three.srcThreeMod.Uint8BufferAttribute {
  /**
