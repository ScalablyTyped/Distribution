...
object MathUtils {
  ...
  @JSImport("three/build/three.module.min", "MathUtils")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("three/build/three.module.min", "MathUtils.DEG2RAD")
  @js.native
  val DEG2RAD: Double = js.native
  
  @JSImport("three/build/three.module.min", "MathUtils.RAD2DEG")
  @js.native
