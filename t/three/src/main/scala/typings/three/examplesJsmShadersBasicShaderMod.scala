...
object examplesJsmShadersBasicShaderMod {
  
  object BasicShader {
    
    @JSImport("three/examples/jsm/shaders/BasicShader", "BasicShader")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("three/examples/jsm/shaders/BasicShader", "BasicShader.fragmentShader")
    @js.native
    ...
    @JSImport("three/examples/jsm/shaders/BasicShader", "BasicShader.vertexShader")
    @js.native
