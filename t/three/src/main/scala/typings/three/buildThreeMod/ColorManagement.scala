...
object ColorManagement {
  ...
  @JSImport("three/build/three", "ColorManagement")
  @js.native
  ...
  /**
    * @default false
    */
  @JSImport("three/build/three", "ColorManagement.enabled")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("three/build/three", "ColorManagement.workingColorSpace")
  @js.native
