...
object examplesJsmControlsArcballControlsMod {
  ...
  object ArcballControlsMouseActionKeys extends StObject {
    ...
    /* "CTRL" */ val CTRL: typings.three.examplesJsmControlsArcballControlsMod.ArcballControlsMouseActionKeys.CTRL & String = js.native
    
    @js.native
    sealed trait SHIFT
      extends StObject
         with ArcballControlsMouseActionKeys
    /* "SHIFT" */ val SHIFT: typings.three.examplesJsmControlsArcballControlsMod.ArcballControlsMouseActionKeys.SHIFT & String = js.native
  }
  ...
  object ArcballControlsMouseActionOperations extends StObject {
    ...
    /* "FOV" */ val FOV: typings.three.examplesJsmControlsArcballControlsMod.ArcballControlsMouseActionOperations.FOV & String = js.native
    
    @js.native
    sealed trait PAN
      extends StObject
         with ArcballControlsMouseActionOperations
    /* "PAN" */ val PAN: typings.three.examplesJsmControlsArcballControlsMod.ArcballControlsMouseActionOperations.PAN & String = js.native
    
    @js.native
    sealed trait ROTATE
      extends StObject
         with ArcballControlsMouseActionOperations
    /* "ROTATE" */ val ROTATE: typings.three.examplesJsmControlsArcballControlsMod.ArcballControlsMouseActionOperations.ROTATE & String = js.native
