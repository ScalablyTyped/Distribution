...
import typings.three.examplesJsmCsmCsmfrustumMod.default
...
object examplesJsmCsmCsmMod {
  ...
  object CMSMode extends StObject {
    ...
    sealed trait custom
      extends StObject
         with CMSMode
    /* "custom" */ val custom: typings.three.examplesJsmCsmCsmMod.CMSMode.custom & String = js.native
    
    @js.native
    sealed trait logarithmic
      extends StObject
         with CMSMode
    /* "logarithmic" */ val logarithmic: typings.three.examplesJsmCsmCsmMod.CMSMode.logarithmic & String = js.native
    
    @js.native
    sealed trait practical
      extends StObject
         with CMSMode
    /* "practical" */ val practical: typings.three.examplesJsmCsmCsmMod.CMSMode.practical & String = js.native
    
    @js.native
    sealed trait uniform
      extends StObject
         with CMSMode
    /* "uniform" */ val uniform: typings.three.examplesJsmCsmCsmMod.CMSMode.uniform & String = js.native
  }
