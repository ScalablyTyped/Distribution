...
object ssaopassMod {
  ...
  object SSAOPassOUTPUT extends StObject {
    ...
    sealed trait Beauty
      extends StObject
         with SSAOPassOUTPUT
    /* 3 */ val Beauty: typings.three.ssaopassMod.SSAOPassOUTPUT.Beauty & Double = js.native
    
    @js.native
    sealed trait Blur
      extends StObject
         with SSAOPassOUTPUT
    /* 2 */ val Blur: typings.three.ssaopassMod.SSAOPassOUTPUT.Blur & Double = js.native
    
    @js.native
    sealed trait Default
      extends StObject
         with SSAOPassOUTPUT
    /* 0 */ val Default: typings.three.ssaopassMod.SSAOPassOUTPUT.Default & Double = js.native
    
    @js.native
    sealed trait Depth
      extends StObject
         with SSAOPassOUTPUT
    /* 4 */ val Depth: typings.three.ssaopassMod.SSAOPassOUTPUT.Depth & Double = js.native
    
    @js.native
    sealed trait Normal
      extends StObject
         with SSAOPassOUTPUT
    /* 5 */ val Normal: typings.three.ssaopassMod.SSAOPassOUTPUT.Normal & Double = js.native
    
    @js.native
    sealed trait SSAO
      extends StObject
         with SSAOPassOUTPUT
    /* 1 */ val SSAO: typings.three.ssaopassMod.SSAOPassOUTPUT.SSAO & Double = js.native
  }
}
