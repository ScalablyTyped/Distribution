...
@JSImport("three/src/Three", "WebGLArrayRenderTarget")
@js.native
/**
  ...
  */
open class WebGLArrayRenderTarget ()
  extends typings.three.srcRenderersWebGLArrayRenderTargetMod.WebGLArrayRenderTarget {
