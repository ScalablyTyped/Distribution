...
class PointLight ()
  ...
  def this(color: typings.three.colorMod.Color, intensity: Unit, distance: Double) = this()
  ...
  def this(color: typings.three.colorMod.Color, intensity: Double, distance: Unit, decay: Double) = this()
  def this(color: typings.three.colorMod.Color, intensity: Unit, distance: Double, decay: Double) = this()
  def this(color: typings.three.colorMod.Color, intensity: Unit, distance: Unit, decay: Double) = this()
}
