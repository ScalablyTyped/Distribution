...
object animationUtilsMod {
  ...
  object AnimationUtils {
    ...
    @JSImport("three/src/animation/AnimationUtils", "AnimationUtils")
    @js.native
    ...
    @scala.inline
    def makeClipAdditive(targetClip: AnimationClip): AnimationClip = ^.asInstanceOf[js.Dynamic].applyDynamic("makeClipAdditive")(targetClip.asInstanceOf[js.Any]).asInstanceOf[AnimationClip]
    @scala.inline
    def makeClipAdditive(targetClip: AnimationClip, referenceFrame: Double): AnimationClip = (^.asInstanceOf[js.Dynamic].applyDynamic("makeClipAdditive")(targetClip.asInstanceOf[js.Any], referenceFrame.asInstanceOf[js.Any])).asInstanceOf[AnimationClip]
    @scala.inline
    ...
    @scala.inline
    def makeClipAdditive(targetClip: AnimationClip, referenceFrame: Double, referenceClip: AnimationClip): AnimationClip = (^.asInstanceOf[js.Dynamic].applyDynamic("makeClipAdditive")(targetClip.asInstanceOf[js.Any], referenceFrame.asInstanceOf[js.Any], referenceClip.asInstanceOf[js.Any])).asInstanceOf[AnimationClip]
    @scala.inline
    ...
    @scala.inline
    def makeClipAdditive(targetClip: AnimationClip, referenceFrame: Unit, referenceClip: AnimationClip): AnimationClip = (^.asInstanceOf[js.Dynamic].applyDynamic("makeClipAdditive")(targetClip.asInstanceOf[js.Any], referenceFrame.asInstanceOf[js.Any], referenceClip.asInstanceOf[js.Any])).asInstanceOf[AnimationClip]
    @scala.inline
    ...
    @scala.inline
    def subclip(sourceClip: AnimationClip, name: String, startFrame: Double, endFrame: Double): AnimationClip = (^.asInstanceOf[js.Dynamic].applyDynamic("subclip")(sourceClip.asInstanceOf[js.Any], name.asInstanceOf[js.Any], startFrame.asInstanceOf[js.Any], endFrame.asInstanceOf[js.Any])).asInstanceOf[AnimationClip]
    @scala.inline
