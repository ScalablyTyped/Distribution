...
object examplesJsmNodesMathMathNodeMod {
  ...
  object default {
    ...
    @js.native
    def MOD: "mod" = js.native
    inline def MOD_=(x: "mod"): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MOD")(x.asInstanceOf[js.Any])
  ...
  trait MathNode
    ...
    var bNode: typings.three.examplesJsmNodesCoreNodeMod.default | Null = js.native
    
    var cNode: typings.three.examplesJsmNodesCoreNodeMod.default | Null = js.native
