...
class Euler () extends js.Object {
  ...
  def setFromQuaternion(q: threeLib.srcMathQuaternionMod.Quaternion, order: java.lang.String, update: scala.Boolean): Euler = js.native
  ...
  def setFromRotationMatrix(m: threeLib.srcMathMatrix4Mod.Matrix4, order: java.lang.String, update: scala.Boolean): Euler = js.native
