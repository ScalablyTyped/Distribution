...
trait Anon_Lights extends js.Object {
  ...
  var displacementmap: Anon_DisplacementScale
  var emissivemap: Anon_EmissiveMap
  var envmap: Anon_Reflectivity
  var fog: Anon_FogDensity
  var gradientmap: Anon_GradientMap
  var lightmap: Anon_LightMap
  var lights: Anon_HemisphereLights
  var metalnessmap: Anon_MetalnessMap
  var normalmap: Anon_NormalScale
  var points: Anon_Size
