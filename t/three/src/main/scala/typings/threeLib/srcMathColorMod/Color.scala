package typings
package threeLib.srcMathColorMod
...
class Color () extends js.Object {
  ...
  def convertGammaToLinear(gammaFactor: scala.Double): Color = js.native
  /**
  	 * Converts this color from linear to gamma space.
  	 */
  def convertLinearToGamma(): Color = js.native
  def convertLinearToGamma(gammaFactor: scala.Double): Color = js.native
  /**
