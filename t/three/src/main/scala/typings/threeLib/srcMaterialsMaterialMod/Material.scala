...
class Material ()
  ...
  /**
  	 ...
  	 */
  var blendDst: threeLib.srcConstantsMod.BlendingDstFactor = js.native
  /**
  ...
  /**
  	 ...
  	 */
  var blendEquation: threeLib.srcConstantsMod.BlendingEquation = js.native
  /**
  ...
  /**
  	 ...
  	 */
  var blendSrc: threeLib.srcConstantsMod.BlendingSrcFactor | threeLib.srcConstantsMod.BlendingDstFactor = js.native
  /**
  ...
  /**
  	 ...
  	 */
  var blending: threeLib.srcConstantsMod.Blending = js.native
  /**
  ...
  /**
  	 ...
  	 */
  var depthFunc: threeLib.srcConstantsMod.DepthModes = js.native
  /**
  ...
  /**
  	 ...
  	 */
  var side: threeLib.srcConstantsMod.Side = js.native
  /**
  ...
  /**
  	 ...
  	 */
  var vertexColors: threeLib.srcConstantsMod.Colors = js.native
  /**
  	 * Defines whether precomputed vertex tangents are used. Default is false.
  	 */
  var vertexTangents: scala.Boolean = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def onBeforeCompile(
    shader: threeLib.srcRenderersShadersShaderLibMod.Shader,
