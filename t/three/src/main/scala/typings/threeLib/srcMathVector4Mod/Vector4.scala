package typings
package threeLib.srcMathVector4Mod
...
class Vector4 ()
  ...
  /**
  	 ...
  	 */
  def setAxisAngleFromQuaternion(q: threeLib.srcMathQuaternionMod.Quaternion): this.type = js.native
  /**
  	 * http://www.euclideanspace.com/maths/geometry/rotations/conversions/matrixToAngle/index.htm
  	 * @param m assumes the upper 3x3 of m is a pure rotation matrix (i.e, unscaled)
  	 */
  def setAxisAngleFromRotationMatrix(m: threeLib.srcMathMatrix3Mod.Matrix3): this.type = js.native
  /**
