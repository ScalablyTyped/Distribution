...
trait Anon_HemisphereLights extends js.Object {
  var ambientLightColor: threeLib.threeDashCoreMod.IUniform
  var directionalLights: Anon_ValuePropertiesArrayAny
  ...
  var hemisphereLights: Anon_Value
  var pointLights: Anon_ValueProperties
  var pointShadowMap: threeLib.threeDashCoreMod.IUniform
  var pointShadowMatrix: threeLib.threeDashCoreMod.IUniform
  var rectAreaLights: Anon_ValuePropertiesArray
  var spotLights: Anon_ValuePropertiesArrayAnyAnonShadowBiasShadowShadowMapSize
