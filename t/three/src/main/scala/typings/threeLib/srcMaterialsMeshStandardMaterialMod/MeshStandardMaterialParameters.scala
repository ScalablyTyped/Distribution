...
trait MeshStandardMaterialParameters
  ...
  var metalnessMap: js.UndefOr[threeLib.srcTexturesTextureMod.Texture] = js.undefined
  ...
  var roughnessMap: js.UndefOr[threeLib.srcTexturesTextureMod.Texture] = js.undefined
