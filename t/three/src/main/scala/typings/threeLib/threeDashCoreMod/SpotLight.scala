...
class SpotLight protected () extends Light {
  def this(color: js.UndefOr[java.lang.String | scala.Double | Color], intensity: js.UndefOr[scala.Double], distance: js.UndefOr[scala.Double], angle: js.UndefOr[scala.Double], exponent: js.UndefOr[scala.Double], decay: js.UndefOr[scala.Double]) = this()
  /*
