...
@JSImport("three/three-core", "InterleavedBufferAttribute")
@js.native
class InterleavedBufferAttribute protected () extends js.Object {
  def this(interleavedBuffer: InterleavedBuffer, itemSize: scala.Double, offset: scala.Double) = this()
  def this(interleavedBuffer: InterleavedBuffer, itemSize: scala.Double, offset: scala.Double, normalized: scala.Boolean) = this()
