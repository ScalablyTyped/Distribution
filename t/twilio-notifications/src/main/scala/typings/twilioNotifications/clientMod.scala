...
object clientMod {
  ...
  class Client protected () extends EventEmitter {
    ...
    /* private */ var _onNeedReliableTransport: js.Any = js.native
    
    /* private */ var _onRegistrationStateChange: js.Any = js.native
    
    /* private */ var _onTransportStateChange: js.Any = js.native
    
    /**
      * Routes messages to the external subscribers
      * @private
      */
    /* private */ var _routeMessage: js.Any = js.native
    
    /* private */ var _updateTransportState: js.Any = js.native
    ...
    /* private */ val registrar: js.Any = js.native
    
    /* private */ val reliableTransportState: js.Any = js.native
  ...
  */
  ...
  object ConnectionState {
    ...
    inline def connected: typings.twilioNotifications.twilioNotificationsStrings.connected = "connected".asInstanceOf[typings.twilioNotifications.twilioNotificationsStrings.connected]
    
    inline def connecting: typings.twilioNotifications.twilioNotificationsStrings.connecting = "connecting".asInstanceOf[typings.twilioNotifications.twilioNotificationsStrings.connecting]
    
    inline def denied: typings.twilioNotifications.twilioNotificationsStrings.denied = "denied".asInstanceOf[typings.twilioNotifications.twilioNotificationsStrings.denied]
    
    inline def disconnected: typings.twilioNotifications.twilioNotificationsStrings.disconnected = "disconnected".asInstanceOf[typings.twilioNotifications.twilioNotificationsStrings.disconnected]
    
    inline def disconnecting: typings.twilioNotifications.twilioNotificationsStrings.disconnecting = "disconnecting".asInstanceOf[typings.twilioNotifications.twilioNotificationsStrings.disconnecting]
  }
  ...
  object PushNotification {
    ...
    inline def apply(messageType: String, payload: js.Any): PushNotification = {
