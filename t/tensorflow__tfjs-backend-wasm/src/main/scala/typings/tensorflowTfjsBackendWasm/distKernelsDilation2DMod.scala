...
import typings.tensorflowTfjsBackendWasm.anon.AttrsDilation2DAttrs
...
object distKernelsDilation2DMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-wasm/dist/kernels/Dilation2D", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-wasm/dist/kernels/Dilation2D", "dilation2DConfig")
  @js.native
