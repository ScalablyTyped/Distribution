...
import typings.tensorflowTfjsBackendWasm.anon.AttrsMaxPool3DGradAttrs
...
object distKernelsMaxPool3DGradMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-wasm/dist/kernels/MaxPool3DGrad", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-wasm/dist/kernels/MaxPool3DGrad", "maxPool3DGradConfig")
  @js.native
