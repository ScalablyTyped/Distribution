...
object tfjsBackendWasmMod {
  
  @JSImport("@tensorflow/tfjs-backend-wasm/wasm-out/tfjs-backend-wasm", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@tensorflow/tfjs-backend-wasm/wasm-out/tfjs-backend-wasm", JSImport.Default)
  @js.native
  ...
  trait BackendWasmModule
    extends StObject
       with EmscriptenModule {
    
    // Using the tfjs namespace to avoid conflict with emscripten's API.
    var tfjs: Dispose
  }
  object BackendWasmModule {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[BackendWasmModule]
    }
    
    extension [Self <: BackendWasmModule](x: Self) {
      
      inline def setTfjs(value: Dispose): Self = StObject.set(x, "tfjs", value.asInstanceOf[js.Any])
    }
  }
