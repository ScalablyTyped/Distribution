...
import typings.tensorflowTfjsBackendWasm.anon.AttrsLinSpaceAttrs
...
object distKernelsLinSpaceMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-wasm/dist/kernels/LinSpace", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-wasm/dist/kernels/LinSpace", "linSpaceConfig")
  @js.native
