...
import typings.tensorflowTfjsBackendWasm.anon.AttrsMultinomialAttrs
...
object distKernelsMultinomialMod {
  ...
  @JSImport("@tensorflow/tfjs-backend-wasm/dist/kernels/Multinomial", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-backend-wasm/dist/kernels/Multinomial", "multinomialConfig")
  @js.native
