...
object errorMod {
  ...
  inline def error(name: String, format: String, args: Any*): js.Error = (^.asInstanceOf[js.Dynamic].applyDynamic("error")((List(name.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).`++`(args.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[js.Error]
  ...
  inline def throwError(name: String, format: String, args: Any*): scala.Nothing = (^.asInstanceOf[js.Dynamic].applyDynamic("throwError")((List(name.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).`++`(args.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[scala.Nothing]
}
