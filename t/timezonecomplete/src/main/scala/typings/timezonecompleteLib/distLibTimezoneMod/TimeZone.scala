...
class TimeZone protected () extends js.Object {
  ...
  /**
    ...
    */
  var classKind: java.lang.String = js.native
  def abbreviationForUtc(utcTime: timezonecompleteLib.distLibBasicsMod.TimeStruct): java.lang.String = js.native
  def abbreviationForUtc(utcTime: timezonecompleteLib.distLibBasicsMod.TimeStruct, dstDependent: scala.Boolean): java.lang.String = js.native
  /**
  ...
  def abbreviationForUtc(
    ...
    dstDependent: js.UndefOr[scala.Boolean]
  ): java.lang.String = js.native
  def dst(): scala.Boolean = js.native
  /**
    * Equality operator. Maps zero offsets and different names for UTC onto
    * each other. Other time zones are not mapped onto each other.
    */
  def equals(other: TimeZone): scala.Boolean = js.native
  /**
    * Does this zone have Daylight Saving Time at all?
    */
  def hasDst(): scala.Boolean = js.native
  /**
    * Returns true iff the constructor arguments were identical, so UTC !== GMT
    */
  def identical(other: TimeZone): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def normalizeZoneTime(localTime: timezonecompleteLib.distLibBasicsMod.TimeStruct): timezonecompleteLib.distLibBasicsMod.TimeStruct = js.native
  def normalizeZoneTime(
    localTime: timezonecompleteLib.distLibBasicsMod.TimeStruct,
    opt: timezonecompleteLib.distLibTzDashDatabaseMod.NormalizeOption
  ...
  /**
    ...
    */
  def normalizeZoneTime(localUnixMillis: scala.Double): scala.Double = js.native
  def normalizeZoneTime(localUnixMillis: scala.Double, opt: timezonecompleteLib.distLibTzDashDatabaseMod.NormalizeOption): scala.Double = js.native
  /**
    ...
    */
  def offsetForUtc(offsetForUtc: timezonecompleteLib.distLibBasicsMod.TimeStruct): scala.Double = js.native
  def offsetForUtc(
    year: js.UndefOr[scala.Double],
    month: js.UndefOr[scala.Double],
    day: js.UndefOr[scala.Double],
  ...
  /**
    ...
    */
  def offsetForUtcDate(date: stdLib.Date, funcs: timezonecompleteLib.distLibJavascriptMod.DateFunctions): scala.Double = js.native
  /**
    ...
    * @return the offset of this time zone with respect to UTC at the given time, in minutes.
    */
  def offsetForZone(localTime: timezonecompleteLib.distLibBasicsMod.TimeStruct): scala.Double = js.native
  def offsetForZone(
    year: js.UndefOr[scala.Double],
    month: js.UndefOr[scala.Double],
    day: js.UndefOr[scala.Double],
  ...
  /**
    ...
    * @param funcs: the set of functions to use: get() or getUTC()
    */
  def offsetForZoneDate(date: stdLib.Date, funcs: timezonecompleteLib.distLibJavascriptMod.DateFunctions): scala.Double = js.native
  /**
    ...
    */
  def standardOffsetForUtc(offsetForUtc: timezonecompleteLib.distLibBasicsMod.TimeStruct): scala.Double = js.native
