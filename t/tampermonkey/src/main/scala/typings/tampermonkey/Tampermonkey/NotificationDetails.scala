...
object NotificationDetails {
  ...
  inline def HighlightNotification(text: Unit): typings.tampermonkey.Tampermonkey.HighlightNotification = {
  ...
  inline def TextNotification(text: String): typings.tampermonkey.Tampermonkey.TextNotification = {
