...
object actionableOptionsMod {
  ...
  trait ActionableOptions extends StObject {
    ...
    /**
      ...
      */
    var onHeightChanged: js.UndefOr[js.Function1[/* event */ Any, Unit]] = js.undefined
    
    /**
      * Callback function that will be executed once the typeform's active screen changes.
      */
    var onQuestionChanged: js.UndefOr[js.Function1[/* event */ Any, Unit]] = js.undefined
  ...
  object ActionableOptions {
    ...
    extension [Self <: ActionableOptions](x: Self) {
      ...
      inline def setOnHeightChanged(value: /* event */ Any => Unit): Self = StObject.set(x, "onHeightChanged", js.Any.fromFunction1(value))
      
      inline def setOnHeightChangedUndefined: Self = StObject.set(x, "onHeightChanged", js.undefined)
      
      inline def setOnQuestionChanged(value: /* event */ Any => Unit): Self = StObject.set(x, "onQuestionChanged", js.Any.fromFunction1(value))
