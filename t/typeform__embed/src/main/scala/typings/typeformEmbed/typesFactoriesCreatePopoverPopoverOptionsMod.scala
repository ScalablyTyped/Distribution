...
object typesFactoriesCreatePopoverPopoverOptionsMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.typeformEmbed.typesBaseModalWindowOptionsMod.ModalWindowOptions because var conflicts: keepSession. Inlined container, autoClose */ trait PopoverOptions
    extends StObject
       with BaseOptions
       with UrlOptions
