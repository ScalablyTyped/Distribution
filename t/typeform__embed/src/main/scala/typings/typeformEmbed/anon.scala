...
object anon {
  ...
  object EmbedId {
    ...
    inline def apply(embedId: String, focus: () => Unit, iframe: HTMLIFrameElement, refresh: () => Unit): EmbedId = {
      val __obj = js.Dynamic.literal(embedId = embedId.asInstanceOf[js.Any], focus = js.Any.fromFunction0(focus), iframe = iframe.asInstanceOf[js.Any], refresh = js.Any.fromFunction0(refresh))
  ...
  object PartialHTMLIFrameElementW {
    ...
    implicit open class MutableBuilder[Self <: PartialHTMLIFrameElementW] (val x: Self) extends AnyVal {
      ...
      inline def setAddEventListener(
        value: (fullscreenchange, /* listener */ js.ThisFunction1[PartialHTMLIFrameElementW, /* ev */ Event, Any]) => Unit
      ...
      inline def setOnbeforeinput(value: js.ThisFunction1[PartialHTMLIFrameElementW, /* ev */ InputEvent, Any]): Self = StObject.set(x, "onbeforeinput", value.asInstanceOf[js.Any])
      ...
      inline def setOncancel(value: js.ThisFunction1[PartialHTMLIFrameElementW, /* ev */ Event, Any]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
      ...
      inline def setOnprogress(value: js.ThisFunction1[PartialHTMLIFrameElementW, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
