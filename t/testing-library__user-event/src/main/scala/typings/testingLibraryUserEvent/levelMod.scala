...
object levelMod {
  ...
  object ApiLevel extends StObject {
    ...
    sealed trait Call
      extends StObject
         with ApiLevel
    /* 1 */ val Call: typings.testingLibraryUserEvent.levelMod.ApiLevel.Call & Double = js.native
    
    @js.native
    sealed trait Trigger
      extends StObject
         with ApiLevel
    /* 2 */ val Trigger: typings.testingLibraryUserEvent.levelMod.ApiLevel.Trigger & Double = js.native
  }
