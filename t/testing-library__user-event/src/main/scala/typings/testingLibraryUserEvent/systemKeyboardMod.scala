...
object systemKeyboardMod {
  ...
  object DOM_KEY_LOCATION extends StObject {
    ...
    /* 1 */ val LEFT: typings.testingLibraryUserEvent.systemKeyboardMod.DOM_KEY_LOCATION.LEFT & Double = js.native
    
    @js.native
    sealed trait NUMPAD
      extends StObject
         with DOM_KEY_LOCATION
    /* 3 */ val NUMPAD: typings.testingLibraryUserEvent.systemKeyboardMod.DOM_KEY_LOCATION.NUMPAD & Double = js.native
    
    @js.native
    sealed trait RIGHT
      extends StObject
         with DOM_KEY_LOCATION
    /* 2 */ val RIGHT: typings.testingLibraryUserEvent.systemKeyboardMod.DOM_KEY_LOCATION.RIGHT & Double = js.native
    
    @js.native
    sealed trait STANDARD
      extends StObject
         with DOM_KEY_LOCATION
    /* 0 */ val STANDARD: typings.testingLibraryUserEvent.systemKeyboardMod.DOM_KEY_LOCATION.STANDARD & Double = js.native
  }
