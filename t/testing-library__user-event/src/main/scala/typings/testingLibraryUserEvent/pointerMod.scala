...
object pointerMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.testingLibraryUserEvent.pointerMod.PointerPressAction
    - typings.testingLibraryUserEvent.pointerMod.PointerMoveAction
  */
  trait PointerAction
    extends StObject
  ...
  object PointerAction {
    ...
    inline def PointerMoveAction(): typings.testingLibraryUserEvent.pointerMod.PointerMoveAction = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.testingLibraryUserEvent.pointerMod.PointerMoveAction]
    }
    
    inline def PointerPressAction(keyDef: pointerKey, releasePrevious: Boolean, releaseSelf: Boolean): typings.testingLibraryUserEvent.pointerMod.PointerPressAction = {
      ...
      __obj.asInstanceOf[typings.testingLibraryUserEvent.pointerMod.PointerPressAction]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.testingLibraryUserEvent.pointerMod.PointerAction
  */
