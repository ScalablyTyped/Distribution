...
object testingLibraryUserEventStrings {
  ...
  @js.native
  sealed trait animationend_ extends StObject
  inline def animationend_ : animationend_ = "animationend".asInstanceOf[animationend_]
  
  @js.native
  sealed trait animationiteration_ extends StObject
  inline def animationiteration_ : animationiteration_ = "animationiteration".asInstanceOf[animationiteration_]
  
  @js.native
  sealed trait animationstart_ extends StObject
  inline def animationstart_ : animationstart_ = "animationstart".asInstanceOf[animationstart_]
  ...
  @js.native
  sealed trait beforeinput_ extends StObject
  inline def beforeinput_ : beforeinput_ = "beforeinput".asInstanceOf[beforeinput_]
  ...
  @js.native
  sealed trait canplaythrough_ extends StObject
  inline def canplaythrough_ : canplaythrough_ = "canplaythrough".asInstanceOf[canplaythrough_]
  ...
  @js.native
  sealed trait compositionend_ extends StObject
  inline def compositionend_ : compositionend_ = "compositionend".asInstanceOf[compositionend_]
  
  @js.native
  sealed trait compositionstart_ extends StObject
  inline def compositionstart_ : compositionstart_ = "compositionstart".asInstanceOf[compositionstart_]
  
  @js.native
  sealed trait compositionupdate_ extends StObject
  inline def compositionupdate_ : compositionupdate_ = "compositionupdate".asInstanceOf[compositionupdate_]
  ...
  inline def dblclick_ : dblclick_ = "dblclick".asInstanceOf[dblclick_]
  ...
  @js.native
  sealed trait dragend_ extends StObject
  inline def dragend_ : dragend_ = "dragend".asInstanceOf[dragend_]
  
  @js.native
  sealed trait dragenter_ extends StObject
  inline def dragenter_ : dragenter_ = "dragenter".asInstanceOf[dragenter_]
  
  @js.native
  sealed trait dragleave_ extends StObject
  inline def dragleave_ : dragleave_ = "dragleave".asInstanceOf[dragleave_]
  
  @js.native
  sealed trait dragover_ extends StObject
  inline def dragover_ : dragover_ = "dragover".asInstanceOf[dragover_]
  
  @js.native
  sealed trait dragstart_ extends StObject
  inline def dragstart_ : dragstart_ = "dragstart".asInstanceOf[dragstart_]
  ...
  @js.native
  sealed trait durationchange_ extends StObject
  inline def durationchange_ : durationchange_ = "durationchange".asInstanceOf[durationchange_]
  ...
  @js.native
  sealed trait focusin_ extends StObject
  inline def focusin_ : focusin_ = "focusin".asInstanceOf[focusin_]
  
  @js.native
  sealed trait focusout_ extends StObject
  inline def focusout_ : focusout_ = "focusout".asInstanceOf[focusout_]
  ...
  @js.native
  sealed trait gotpointercapture_ extends StObject
  inline def gotpointercapture_ : gotpointercapture_ = "gotpointercapture".asInstanceOf[gotpointercapture_]
  ...
  @js.native
  sealed trait keypress_ extends StObject
  inline def keypress_ : keypress_ = "keypress".asInstanceOf[keypress_]
  ...
  @js.native
  sealed trait loadeddata_ extends StObject
  inline def loadeddata_ : loadeddata_ = "loadeddata".asInstanceOf[loadeddata_]
  
  @js.native
  sealed trait loadedmetadata_ extends StObject
  inline def loadedmetadata_ : loadedmetadata_ = "loadedmetadata".asInstanceOf[loadedmetadata_]
  
  @js.native
  sealed trait loadstart_ extends StObject
  inline def loadstart_ : loadstart_ = "loadstart".asInstanceOf[loadstart_]
  ...
  @js.native
  sealed trait lostpointercapture_ extends StObject
  inline def lostpointercapture_ : lostpointercapture_ = "lostpointercapture".asInstanceOf[lostpointercapture_]
  ...
  @js.native
  sealed trait mouseout_ extends StObject
  inline def mouseout_ : mouseout_ = "mouseout".asInstanceOf[mouseout_]
  
  @js.native
  sealed trait mouseover_ extends StObject
  inline def mouseover_ : mouseover_ = "mouseover".asInstanceOf[mouseover_]
  ...
  @js.native
  sealed trait pointerenter_ extends StObject
  inline def pointerenter_ : pointerenter_ = "pointerenter".asInstanceOf[pointerenter_]
  
  @js.native
  sealed trait pointerleave_ extends StObject
  inline def pointerleave_ : pointerleave_ = "pointerleave".asInstanceOf[pointerleave_]
  ...
  @js.native
  sealed trait pointerout_ extends StObject
  inline def pointerout_ : pointerout_ = "pointerout".asInstanceOf[pointerout_]
  
  @js.native
  sealed trait pointerover_ extends StObject
  inline def pointerover_ : pointerover_ = "pointerover".asInstanceOf[pointerover_]
  ...
  @js.native
  sealed trait ratechange_ extends StObject
  inline def ratechange_ : ratechange_ = "ratechange".asInstanceOf[ratechange_]
  ...
  @js.native
  sealed trait timeupdate_ extends StObject
  inline def timeupdate_ : timeupdate_ = "timeupdate".asInstanceOf[timeupdate_]
  ...
  @js.native
  sealed trait transitioncancel_ extends StObject
  inline def transitioncancel_ : transitioncancel_ = "transitioncancel".asInstanceOf[transitioncancel_]
  
  @js.native
  sealed trait transitionend_ extends StObject
  inline def transitionend_ : transitionend_ = "transitionend".asInstanceOf[transitionend_]
  
  @js.native
  sealed trait transitionrun_ extends StObject
  inline def transitionrun_ : transitionrun_ = "transitionrun".asInstanceOf[transitionrun_]
  
  @js.native
  sealed trait transitionstart_ extends StObject
  inline def transitionstart_ : transitionstart_ = "transitionstart".asInstanceOf[transitionstart_]
  ...
  @js.native
  sealed trait volumechange_ extends StObject
  inline def volumechange_ : volumechange_ = "volumechange".asInstanceOf[volumechange_]
