...
object mod {
  ...
  object PointerEventsCheckLevel extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typings.testingLibraryUserEvent.distTypesOptionsMod.PointerEventsCheckLevel & Double
      ] = js.native
    
    /* 2 */ val EachApiCall: typings.testingLibraryUserEvent.distTypesOptionsMod.PointerEventsCheckLevel.EachApiCall & Double = js.native
    
    /* 1 */ val EachTarget: typings.testingLibraryUserEvent.distTypesOptionsMod.PointerEventsCheckLevel.EachTarget & Double = js.native
    
    /* 4 */ val EachTrigger: typings.testingLibraryUserEvent.distTypesOptionsMod.PointerEventsCheckLevel.EachTrigger & Double = js.native
    
    /* 0 */ val Never: typings.testingLibraryUserEvent.distTypesOptionsMod.PointerEventsCheckLevel.Never & Double = js.native
  }
}
