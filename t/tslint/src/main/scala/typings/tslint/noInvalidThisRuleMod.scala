...
object noInvalidThisRuleMod {
  ...
  object Rule {
    ...
    @scala.inline
    def FAILURE_STRING_INSIDE_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FAILURE_STRING_INSIDE")(x.asInstanceOf[js.Any])
    
    @JSImport("tslint/lib/rules/noInvalidThisRule", "Rule.FAILURE_STRING_OUTSIDE")
    @js.native
    def FAILURE_STRING_OUTSIDE: String = js.native
    @scala.inline
    def FAILURE_STRING_OUTSIDE_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FAILURE_STRING_OUTSIDE")(x.asInstanceOf[js.Any])
