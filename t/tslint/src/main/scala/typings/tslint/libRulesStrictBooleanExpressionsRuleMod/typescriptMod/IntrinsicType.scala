package typings.tslint.libRulesStrictBooleanExpressionsRuleMod.typescriptMod

import typings.typescript.typescriptMod.BaseType
import typings.typescript.typescriptMod.DestructuringPattern
