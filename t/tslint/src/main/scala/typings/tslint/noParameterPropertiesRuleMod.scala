...
object noParameterPropertiesRuleMod {
  ...
  object Rule {
    ...
    @scala.inline
    def FAILURE_STRING_FACTORY(ident: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("FAILURE_STRING_FACTORY")(ident.asInstanceOf[js.Any]).asInstanceOf[String]
