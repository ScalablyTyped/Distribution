...
@scala.inline
def hasModifier(modifiers: scala.Unit, modifierKinds: typings.typescript.mod.SyntaxKind*): scala.Boolean = (typings.tslint.mod.^.asInstanceOf[js.Dynamic].applyDynamic("hasModifier")(modifiers.asInstanceOf[js.Any], modifierKinds.asInstanceOf[js.Any])).asInstanceOf[scala.Boolean]
@scala.inline
def hasModifier(
