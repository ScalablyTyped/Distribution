...
object Configuration {
  ...
  @scala.inline
  def convertRuleOptions(ruleConfiguration: Map[String, PartialIOptions]): js.Array[IOptions] = ^.asInstanceOf[js.Dynamic].applyDynamic("convertRuleOptions")(ruleConfiguration.asInstanceOf[js.Any]).asInstanceOf[js.Array[IOptions]]
  
  @scala.inline
  def extendConfigurationFile(targetConfig: IConfigurationFile, nextConfigSource: IConfigurationFile): IConfigurationFile = (^.asInstanceOf[js.Dynamic].applyDynamic("extendConfigurationFile")(targetConfig.asInstanceOf[js.Any], nextConfigSource.asInstanceOf[js.Any])).asInstanceOf[IConfigurationFile]
  ...
  @scala.inline
  def getRelativePath(): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getRelativePath")().asInstanceOf[js.UndefOr[String]]
  @scala.inline
  def getRelativePath(directory: String): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getRelativePath")(directory.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[String]]
  @scala.inline
  def getRelativePath(directory: String, relativeTo: String): js.UndefOr[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getRelativePath")(directory.asInstanceOf[js.Any], relativeTo.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[String]]
  @scala.inline
  def getRelativePath(directory: Null, relativeTo: String): js.UndefOr[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getRelativePath")(directory.asInstanceOf[js.Any], relativeTo.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[String]]
  @scala.inline
  def getRelativePath(directory: Unit, relativeTo: String): js.UndefOr[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getRelativePath")(directory.asInstanceOf[js.Any], relativeTo.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[String]]
  ...
  @scala.inline
  def isFileExcluded(filepath: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFileExcluded")(filepath.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  @scala.inline
  def isFileExcluded(filepath: String, configFile: IConfigurationFile): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isFileExcluded")(filepath.asInstanceOf[js.Any], configFile.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  @scala.inline
  def parseConfigFile(configFile: RawConfigFile): IConfigurationFile = ^.asInstanceOf[js.Dynamic].applyDynamic("parseConfigFile")(configFile.asInstanceOf[js.Any]).asInstanceOf[IConfigurationFile]
  @scala.inline
  def parseConfigFile(configFile: RawConfigFile, configFileDir: String): IConfigurationFile = (^.asInstanceOf[js.Dynamic].applyDynamic("parseConfigFile")(configFile.asInstanceOf[js.Any], configFileDir.asInstanceOf[js.Any])).asInstanceOf[IConfigurationFile]
  @scala.inline
  def parseConfigFile(
  ...
  @scala.inline
  def readConfigurationFile(filepath: String): RawConfigFile = ^.asInstanceOf[js.Dynamic].applyDynamic("readConfigurationFile")(filepath.asInstanceOf[js.Any]).asInstanceOf[RawConfigFile]
  
  @scala.inline
  def stringifyConfiguration(configFile: IConfigurationFile): String = ^.asInstanceOf[js.Dynamic].applyDynamic("stringifyConfiguration")(configFile.asInstanceOf[js.Any]).asInstanceOf[String]
  
  @scala.inline
  def useAsPath(directory: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("useAsPath")(directory.asInstanceOf[js.Any]).asInstanceOf[Boolean]
}
