...
object libFilesResolutionMod {
  ...
  inline def resolveFilesAndProgram(param0: Options, logger: Logger): Files = (^.asInstanceOf[js.Dynamic].applyDynamic("resolveFilesAndProgram")(param0.asInstanceOf[js.Any], logger.asInstanceOf[js.Any])).asInstanceOf[Files]
