...
object libRulesNoNullUndefinedUnionRuleMod {
  
  @JSImport("tslint/lib/rules/noNullUndefinedUnionRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noNullUndefinedUnionRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noNullUndefinedUnionRule", "Rule.metadata")
    @js.native
