...
object fileslistFormatterMod {
  
  @JSImport("tslint/lib/formatters/fileslistFormatter", "Formatter")
  @js.native
  ...
  object Formatter {
    ...
    @JSImport("tslint/lib/formatters/fileslistFormatter", "Formatter.metadata")
    @js.native
