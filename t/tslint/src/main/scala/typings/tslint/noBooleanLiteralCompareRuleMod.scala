...
object noBooleanLiteralCompareRuleMod {
  ...
  object Rule {
    ...
    @scala.inline
    def FAILURE_STRING(negate: Boolean): String = ^.asInstanceOf[js.Dynamic].applyDynamic("FAILURE_STRING")(negate.asInstanceOf[js.Any]).asInstanceOf[String]
