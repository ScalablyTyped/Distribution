...
object libUtilsMod {
  ...
  */
  ...
  object Encoding {
    ...
    inline def utf16be: typings.tslint.tslintStrings.utf16be = "utf16be".asInstanceOf[typings.tslint.tslintStrings.utf16be]
    
    inline def utf16le: typings.tslint.tslintStrings.utf16le = "utf16le".asInstanceOf[typings.tslint.tslintStrings.utf16le]
    
    inline def utf8: typings.tslint.tslintStrings.utf8 = "utf8".asInstanceOf[typings.tslint.tslintStrings.utf8]
    
    inline def `utf8-bom`: typings.tslint.tslintStrings.`utf8-bom` = "utf8-bom".asInstanceOf[typings.tslint.tslintStrings.`utf8-bom`]
  }
