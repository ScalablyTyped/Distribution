package typings.tslint.strictBooleanExpressionsRuleMod.typescriptAugmentingMod
...
object IntrinsicType {
  ...
  implicit class IntrinsicTypeOps[Self <: IntrinsicType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIntrinsicName(value: String): Self = this.set("intrinsicName", value.asInstanceOf[js.Any])
  }
