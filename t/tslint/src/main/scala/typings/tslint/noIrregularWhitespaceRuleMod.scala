...
object noIrregularWhitespaceRuleMod {
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noIrregularWhitespaceRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noIrregularWhitespaceRule", "Rule.metadata")
    @js.native
