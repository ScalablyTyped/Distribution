...
object noForInArrayRuleMod {
  
  @JSImport("tslint/lib/rules/noForInArrayRule", "Rule")
  @js.native
  ...
  object Rule {
    ...
    @JSImport("tslint/lib/rules/noForInArrayRule", "Rule.FAILURE_STRING")
    @js.native
    ...
    @JSImport("tslint/lib/rules/noForInArrayRule", "Rule.metadata")
    @js.native
