...
abstract class ScopeAwareRuleWalker[T] protected ()
  ...
  def createScope(node: typescriptLib.typescriptMod.tsNs.Node): T = js.native
  def getAllScopes(): js.Array[T] = js.native
  def getCurrentDepth(): scala.Double = js.native
  def getCurrentScope(): T = js.native
  /* protected */ def isScopeBoundary(node: typescriptLib.typescriptMod.tsNs.Node): scala.Boolean = js.native
