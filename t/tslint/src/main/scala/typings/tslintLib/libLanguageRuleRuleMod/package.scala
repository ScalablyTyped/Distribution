...
package object libLanguageRuleRuleMod {
  ...
  type RuleType = tslintLib.tslintLibStrings.functionality | tslintLib.tslintLibStrings.maintainability | tslintLib.tslintLibStrings.style | tslintLib.tslintLibStrings.typescript
}
