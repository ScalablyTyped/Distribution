...
object _TwitterTimelineWidgetDataSource {
  ...
  inline def TwitterTimelineWidgetCollectionDataSource(id: String): typings.twitterForWeb.TwitterTimelineWidgetCollectionDataSource = {
  ...
  inline def TwitterTimelineWidgetUrlDataSource(url: String): typings.twitterForWeb.TwitterTimelineWidgetUrlDataSource = {
