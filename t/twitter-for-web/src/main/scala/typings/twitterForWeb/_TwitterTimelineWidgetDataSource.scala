...
object _TwitterTimelineWidgetDataSource {
  @scala.inline
  def AnonLikes(screenName: String, sourceType: likes): _TwitterTimelineWidgetDataSource = {
  ...
  @scala.inline
  def AnonProfileSourceType(sourceType: profile, userId: String): _TwitterTimelineWidgetDataSource = {
    val __obj = js.Dynamic.literal(sourceType = sourceType.asInstanceOf[js.Any], userId = userId.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[_TwitterTimelineWidgetDataSource]
  }
  @scala.inline
  def AnonList(ownerScreenName: String, slug: String, sourceType: list): _TwitterTimelineWidgetDataSource = {
  ...
  @scala.inline
  def AnonLikesSourceType(sourceType: likes, userId: String): _TwitterTimelineWidgetDataSource = {
    val __obj = js.Dynamic.literal(sourceType = sourceType.asInstanceOf[js.Any], userId = userId.asInstanceOf[js.Any])
  ...
  @scala.inline
  def AnonProfile(screenName: String, sourceType: profile): _TwitterTimelineWidgetDataSource = {
    val __obj = js.Dynamic.literal(screenName = screenName.asInstanceOf[js.Any], sourceType = sourceType.asInstanceOf[js.Any])
