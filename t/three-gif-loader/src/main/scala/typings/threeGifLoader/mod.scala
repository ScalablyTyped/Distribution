...
object mod {
  ...
  trait GifLoader extends StObject {
    ...
    def load(url: String, onLoad: js.Function1[/* reader */ GifReader, Unit]): typings.threeGifLoader.libGifTextureMod.default = js.native
    def load(
      url: String,
      onLoad: js.Function1[/* reader */ GifReader, Unit],
      onProgress: js.Function1[/* request */ ProgressEvent[EventTarget], Unit]
    ): typings.threeGifLoader.libGifTextureMod.default = js.native
    def load(
      url: String,
      onLoad: js.Function1[/* reader */ GifReader, Unit],
      onProgress: js.Function1[/* request */ ProgressEvent[EventTarget], Unit],
