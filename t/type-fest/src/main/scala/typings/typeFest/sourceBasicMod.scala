...
object sourceBasicMod {
  ...
  type AbstractClass[T, Arguments /* <: js.Array[Any] */] = AbstractConstructor[T, Arguments]
  
  type AbstractConstructor[T, Arguments /* <: js.Array[Any] */] = Instantiable1[/* arguments_ */ Arguments, T]
