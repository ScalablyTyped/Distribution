...
object readonlyDeepMod {
  ...
  */
  @js.native
  trait ReadonlyMapDeep[KeyType, ValueType]
    extends StObject
       with ReadonlyMap[ReadonlyDeep[KeyType], ReadonlyDeep[ValueType]]
  ...
  */
  @js.native
  trait ReadonlySetDeep[ItemType]
    extends StObject
       with ReadonlySet[ReadonlyDeep[ItemType]]
}
