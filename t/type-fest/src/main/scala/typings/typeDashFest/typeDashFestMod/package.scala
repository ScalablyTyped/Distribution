...
package object typeDashFestMod {
  ...
  */
  ...
  type RequireAtLeastOne[ObjectType, KeysType /* <: String */] = (/* import warning: ImportType.apply Failed type conversion: {[ Key in KeysType ]: std.Required<std.Pick<ObjectType, Key>>}[KeysType] */ js.Any) with (Omit[ObjectType, KeysType])
