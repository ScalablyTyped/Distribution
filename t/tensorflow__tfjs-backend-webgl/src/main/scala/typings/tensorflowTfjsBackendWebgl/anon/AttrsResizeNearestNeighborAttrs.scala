...
import typings.tensorflowTfjsCore.kernelNamesMod.ResizeNearestNeighborAttrs
import typings.tensorflowTfjsCore.kernelNamesMod.ResizeNearestNeighborInputs
