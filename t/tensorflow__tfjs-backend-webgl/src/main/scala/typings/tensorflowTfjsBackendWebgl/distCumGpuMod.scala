...
object distCumGpuMod {
  ...
  object CumOpType extends StObject {
    ...
    sealed trait Prod
      extends StObject
         with CumOpType
    /* "*" */ val Prod: typings.tensorflowTfjsBackendWebgl.distCumGpuMod.CumOpType.Prod & String = js.native
    
    @js.native
    sealed trait Sum
      extends StObject
         with CumOpType
    /* "+" */ val Sum: typings.tensorflowTfjsBackendWebgl.distCumGpuMod.CumOpType.Sum & String = js.native
  }
