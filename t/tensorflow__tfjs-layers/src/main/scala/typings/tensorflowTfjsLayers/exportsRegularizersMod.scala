...
object exportsRegularizersMod {
  
  @JSImport("@tensorflow/tfjs-layers/dist/exports_regularizers", "l1")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-layers/dist/exports_regularizers", "l1l2")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-layers/dist/exports_regularizers", "l2")
  @js.native
