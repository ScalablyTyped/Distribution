...
@js.native
object getTopologicalSortAndRecipientCountsForOneFetch extends js.Object {
  def apply(fetch: SymbolicTensor, feedDict: FeedDict): typings.tensorflowTfjsLayers.anon.RecipientMap = js.native
}
