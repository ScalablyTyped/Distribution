...
object BaseLayerSerialization {
  @scala.inline
  def apply[/* <: java.lang.String */ N, /* <: typings.tensorflowTfjsLayers.topologyConfigMod.LayerConfig */ C](class_name: N, config: JsonLayer[C], name: String, inbound_nodes: js.Array[NodeConfig] = null): BaseLayerSerialization[N, C] = {
