...
object genericUtilsMod {
  ...
  inline def checkArrayTypeAndLength(x: js.Any, expectedType: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("checkArrayTypeAndLength")(x.asInstanceOf[js.Any], expectedType.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def checkArrayTypeAndLength(x: js.Any, expectedType: String, minLength: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("checkArrayTypeAndLength")(x.asInstanceOf[js.Any], expectedType.asInstanceOf[js.Any], minLength.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def checkArrayTypeAndLength(x: js.Any, expectedType: String, minLength: Double, maxLength: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("checkArrayTypeAndLength")(x.asInstanceOf[js.Any], expectedType.asInstanceOf[js.Any], minLength.asInstanceOf[js.Any], maxLength.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def checkArrayTypeAndLength(x: js.Any, expectedType: String, minLength: Unit, maxLength: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("checkArrayTypeAndLength")(x.asInstanceOf[js.Any], expectedType.asInstanceOf[js.Any], minLength.asInstanceOf[js.Any], maxLength.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def deserializeKerasObject(identifier: String): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeKerasObject")(identifier.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  inline def deserializeKerasObject(identifier: String, moduleObjects: StringDictionary[js.Any]): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("deserializeKerasObject")(identifier.asInstanceOf[js.Any], moduleObjects.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  inline def deserializeKerasObject(identifier: String, moduleObjects: Unit, customObjects: StringDictionary[js.Any]): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("deserializeKerasObject")(identifier.asInstanceOf[js.Any], moduleObjects.asInstanceOf[js.Any], customObjects.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  inline def deserializeKerasObject(
    identifier: String,
    moduleObjects: Unit,
    customObjects: StringDictionary[js.Any],
  ...
  inline def deserializeKerasObject(identifier: ConfigDict): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("deserializeKerasObject")(identifier.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  inline def deserializeKerasObject(identifier: ConfigDict, moduleObjects: StringDictionary[js.Any]): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("deserializeKerasObject")(identifier.asInstanceOf[js.Any], moduleObjects.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  inline def deserializeKerasObject(
  ...
  inline def deserializeKerasObject(identifier: ConfigDict, moduleObjects: Unit, customObjects: StringDictionary[js.Any]): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("deserializeKerasObject")(identifier.asInstanceOf[js.Any], moduleObjects.asInstanceOf[js.Any], customObjects.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  inline def deserializeKerasObject(
    identifier: ConfigDict,
    moduleObjects: Unit,
    customObjects: StringDictionary[js.Any],
  ...
  inline def formatAsFriendlyString(value: js.Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("formatAsFriendlyString")(value.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def numberCompare(a: Double, b: Double): `1` | `0` | `-1` = (^.asInstanceOf[js.Dynamic].applyDynamic("numberCompare")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[`1` | `0` | `-1`]
  
  inline def objectListUid(objs: js.Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("objectListUid")(objs.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def objectListUid(objs: js.Array[js.Any]): String = ^.asInstanceOf[js.Dynamic].applyDynamic("objectListUid")(objs.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def pyListRepeat(value: js.Any, numValues: Double): js.Array[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("pyListRepeat")(value.asInstanceOf[js.Any], numValues.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Any]]
  ...
  inline def toList(x: js.Any): js.Array[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toList")(x.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Any]]
