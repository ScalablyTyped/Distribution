...
object anon {
  ...
  object CallbackList {
    ...
    implicit class CallbackListMutableBuilder[Self <: CallbackList] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCallbackList(value: typings.tensorflowTfjsLayers.baseCallbacksMod.CallbackList): Self = StObject.set(x, "callbackList", value.asInstanceOf[js.Any])
  ...
  object RecipientMap {
    ...
    implicit class RecipientMapMutableBuilder[Self <: RecipientMap] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRecipientMap(value: typings.tensorflowTfjsLayers.executorMod.RecipientMap): Self = StObject.set(x, "recipientMap", value.asInstanceOf[js.Any])
