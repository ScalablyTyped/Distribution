...
object CallbackConstructorRegistry extends js.Object {
  ...
  /**
    ...
    */
  /* protected */ def clear(): scala.Unit = js.native
  /**
    ...
    */
  def createCallbacks(verbosityLevel: scala.Double): js.Array[atTensorflowTfjsDashLayersLib.distBaseUnderscoreCallbacksMod.BaseCallback] = js.native
  /**
