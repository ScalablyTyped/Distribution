...
object layers extends js.Object {
  ...
  abstract class Layer protected ()
    extends typings.atTensorflowTfjsDashLayers.distExportsUnderscoreLayersMod.Layer {
    def this(args: LayerArgs) = this()
  }
  
  @js.native
  class RNN protected ()
    extends typings.atTensorflowTfjsDashLayers.distExportsUnderscoreLayersMod.RNN {
    def this(args: RNNLayerArgs) = this()
  }
  
  @js.native
  abstract class RNNCell ()
    extends typings.atTensorflowTfjsDashLayers.distExportsUnderscoreLayersMod.RNNCell
