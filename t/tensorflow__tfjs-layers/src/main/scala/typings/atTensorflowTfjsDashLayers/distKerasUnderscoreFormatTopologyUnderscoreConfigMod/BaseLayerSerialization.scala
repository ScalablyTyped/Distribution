...
import typings.atTensorflowTfjsDashLayers.distKerasUnderscoreFormatNodeUnderscoreConfigMod.NodeConfig
...
object BaseLayerSerialization {
  ...
  def apply[N /* <: String */, C /* <: LayerConfig */](class_name: N, config: JsonLayer[C], name: String, inbound_nodes: js.Array[NodeConfig] = null): BaseLayerSerialization[N, C] = {
    val __obj = js.Dynamic.literal(class_name = class_name.asInstanceOf[js.Any], config = config.asInstanceOf[js.Any], name = name)
    if (inbound_nodes != null) __obj.updateDynamic("inbound_nodes")(inbound_nodes)
