...
trait telebot extends js.Object {
  ...
  def answerCallbackQuery(callback_query_id: java.lang.String, opt: telebotLib.Anon_Text): scala.Boolean = js.native
  ...
  def answerPreCheckoutQuery(pre_checkout_query_id: java.lang.String, ok: scala.Boolean, opt: telebotLib.Anon_ErrorMessage): scala.Boolean = js.native
  ...
  def answerShippingQuery(shipping_query_id: java.lang.String, ok: scala.Boolean, opt: telebotLib.Anon_ShippingOptions): scala.Boolean = js.native
