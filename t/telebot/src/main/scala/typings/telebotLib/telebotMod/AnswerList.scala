...
class AnswerList protected () extends js.Object {
  ...
  def this(id: java.lang.String, opt: js.Any) = this()
  def add(`type`: java.lang.String): js.Any = js.native
  def add(`type`: java.lang.String, set: js.Any): js.Any = js.native
  ...
  def results(): java.lang.String = js.native
}
