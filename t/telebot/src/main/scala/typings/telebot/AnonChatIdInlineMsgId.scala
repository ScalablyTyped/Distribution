...
trait AnonChatIdInlineMsgId extends js.Object {
  var chatId: Double | String
  var inlineMsgId: js.UndefOr[Double] = js.undefined
  var messageId: Double
}

object AnonChatIdInlineMsgId {
  @scala.inline
  def apply(chatId: Double | String, messageId: Double, inlineMsgId: Int | Double = null): AnonChatIdInlineMsgId = {
    ...
    __obj.asInstanceOf[AnonChatIdInlineMsgId]
  }
}
