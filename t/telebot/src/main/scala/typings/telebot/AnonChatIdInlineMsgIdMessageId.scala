...
trait AnonChatIdInlineMsgIdMessageId extends js.Object {
  var chatId: js.UndefOr[Double | String] = js.undefined
  var inlineMsgId: Double
  var messageId: js.UndefOr[Double] = js.undefined
}

object AnonChatIdInlineMsgIdMessageId {
  @scala.inline
  def apply(inlineMsgId: Double, chatId: Double | String = null, messageId: Int | Double = null): AnonChatIdInlineMsgIdMessageId = {
    ...
    __obj.asInstanceOf[AnonChatIdInlineMsgIdMessageId]
  }
}
