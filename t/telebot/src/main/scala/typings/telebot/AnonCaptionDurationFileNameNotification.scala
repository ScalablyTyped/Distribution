...
trait AnonCaptionDurationFileNameNotification extends js.Object {
...
object AnonCaptionDurationFileNameNotification {
  @scala.inline
  def apply(
    caption: String = null,
  ...
  ): AnonCaptionDurationFileNameNotification = {
    ...
    __obj.asInstanceOf[AnonCaptionDurationFileNameNotification]
  }
}
