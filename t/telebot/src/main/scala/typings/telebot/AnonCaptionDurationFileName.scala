...
trait AnonCaptionDurationFileName extends js.Object {
...
object AnonCaptionDurationFileName {
  @scala.inline
  def apply(
    caption: String = null,
    ...
    __obj.asInstanceOf[AnonCaptionDurationFileName]
  }
}
