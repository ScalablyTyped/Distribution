...
trait AnonChatIdInlineMessageId extends js.Object {
...
object AnonChatIdInlineMessageId {
  @scala.inline
  def apply(chatId: Int | Double = null, inlineMessageId: String = null, messageId: Int | Double = null): AnonChatIdInlineMessageId = {
    ...
    __obj.asInstanceOf[AnonChatIdInlineMessageId]
  }
}
