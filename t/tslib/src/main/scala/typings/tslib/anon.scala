...
object anon {
  ...
  object Has {
    ...
    inline def apply[T /* <: js.Object */, V](has: T => Boolean, set: (T, V) => js.Any): Has[T, V] = {
      val __obj = js.Dynamic.literal(has = js.Any.fromFunction1(has), set = js.Any.fromFunction2(set))
      __obj.asInstanceOf[Has[T, V]]
    }
    
    extension [Self <: Has[?, ?], T /* <: js.Object */, V](x: Self & (Has[T, V])) {
      
      inline def setHas(value: T => Boolean): Self = StObject.set(x, "has", js.Any.fromFunction1(value))
      
      inline def setSet(value: (T, V) => js.Any): Self = StObject.set(x, "set", js.Any.fromFunction2(value))
    }
  }
}
