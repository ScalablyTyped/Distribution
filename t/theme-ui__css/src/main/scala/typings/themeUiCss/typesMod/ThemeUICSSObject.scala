...
- typings.themeUiCss.typesMod.CSSOthersObject because Inheritance from two classes. Inlined  */ trait ThemeUICSSObject
  extends StObject
     with ThemeUICSSProperties
     with CSSPseudoSelectorProps
     with VariantProperty
     with Label
