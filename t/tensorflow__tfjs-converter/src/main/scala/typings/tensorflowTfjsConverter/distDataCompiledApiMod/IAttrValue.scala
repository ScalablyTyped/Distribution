...
import typings.tensorflowTfjsConverter.distDataCompiledApiMod.AttrValue.IListValue
...
object IAttrValue {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IAttrValue] (val x: Self) extends AnyVal {
