...
object tensorUtilsMod {
  ...
  inline def shapesEqualAllowUndefinedSize(n1: js.Array[Double], n2: js.Array[Double]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("shapesEqualAllowUndefinedSize")(n1.asInstanceOf[js.Any], n2.asInstanceOf[js.Any])).asInstanceOf[Boolean]
}
