...
trait NameTensorShape extends StObject {
...
object NameTensorShape {
  
  inline def apply(dtype: String, name: String, tensorShape: DimArray): NameTensorShape = {
    ...
    __obj.asInstanceOf[NameTensorShape]
  }
  
  extension [Self <: NameTensorShape](x: Self) {
