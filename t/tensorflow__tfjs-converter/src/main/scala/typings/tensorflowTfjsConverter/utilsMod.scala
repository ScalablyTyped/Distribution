...
object utilsMod {
  ...
  inline def getNodeNameAndIndex(inputName: String): js.Tuple2[String, Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("getNodeNameAndIndex")(inputName.asInstanceOf[js.Any]).asInstanceOf[js.Tuple2[String, Double]]
  inline def getNodeNameAndIndex(inputName: String, context: ExecutionContext): js.Tuple2[String, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("getNodeNameAndIndex")(inputName.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[String, Double]]
  ...
  inline def parseNodeName(name: String): js.Tuple2[String, Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("parseNodeName")(name.asInstanceOf[js.Any]).asInstanceOf[js.Tuple2[String, Double]]
