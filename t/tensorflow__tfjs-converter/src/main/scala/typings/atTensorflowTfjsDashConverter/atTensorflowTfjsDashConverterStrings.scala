...
import typings.atTensorflowTfjsDashConverter.distSrcOperationsTypesMod.Category
import typings.atTensorflowTfjsDashConverter.distSrcOperationsTypesMod.ParamType
...
object atTensorflowTfjsDashConverterStrings {
  @js.native
  sealed trait `1DOT2DOT11` extends js.Object
  ...
  @scala.inline
  def `1DOT2DOT11`: `1DOT2DOT11` = "1.2.11".asInstanceOf[`1DOT2DOT11`]
  @scala.inline
