...
@JSImport("@tensorflow/tfjs-converter/dist/src/operations/op_list/dynamic", JSImport.Namespace)
@js.native
object distSrcOperationsOpUnderscoreListDynamicMod extends js.Object {
