...
import typings.tinymce.tinymceMod.dom.DOMUtils
import typings.tinymce.tinymceMod.dom.DomQuery
import typings.tinymce.tinymceMod.dom.Selection
import typings.tinymce.tinymceMod.dom.Serializer
import typings.tinymce.tinymceMod.html.DomParser
import typings.tinymce.tinymceMod.html.Schema
...
class Editor protected () extends Observable {
  ...
  var notificationManager: typings.tinymce.tinymceMod.notificationManager = js.native
