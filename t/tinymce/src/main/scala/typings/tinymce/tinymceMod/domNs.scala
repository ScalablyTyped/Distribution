...
import typings.tinymce.tinymceMod.domNs.EventUtils
import typings.tinymce.tinymceMod.domNs.Selection
import typings.tinymce.tinymceMod.domNs.Serializer
...
object domNs extends js.Object {
  ...
  trait TreeWalker extends js.Object {
    def current(): typings.tinymce.tinymceMod.htmlNs.Node
    def next(): typings.tinymce.tinymceMod.htmlNs.Node
    def prev(): typings.tinymce.tinymceMod.htmlNs.Node
  }
