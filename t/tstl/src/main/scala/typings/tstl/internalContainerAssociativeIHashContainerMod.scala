...
import typings.tstl.internalContainerAssociativeIAssociativeContainerMod.IAssociativeContainer
...
@js.native
object internalContainerAssociativeIHashContainerMod extends js.Object {
  @js.native
  trait IHashContainer[Key, T /* <: Elem */, SourceT /* <: IHashContainer[Key, T, SourceT, IteratorT, ReverseIteratorT, Elem] */, IteratorT /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IContainer.Iterator<T, SourceT, IteratorT, ReverseIteratorT, Elem> */ js.Any */, ReverseIteratorT /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IContainer.ReverseIterator<T, SourceT, IteratorT, ReverseIteratorT, Elem> */ js.Any */, Elem] extends IAssociativeContainer[Key, T, SourceT, IteratorT, ReverseIteratorT, Elem] {
    /**
