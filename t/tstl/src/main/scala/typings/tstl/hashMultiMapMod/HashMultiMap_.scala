...
- typings.tstl.ihashmapMod.IHashMap because Inheritance from two classes. Inlined begin, begin, end, end */ @JSImport("tstl/container/HashMultiMap", "HashMultiMap")
@js.native
/**
  * Default Constructor.
  *
  ...
  */
class HashMultiMap_[Key, T] () extends MultiMap[Key, T, HashMultiMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T]] {
  ...
  /**
    ...
    */
  def begin(index: Double): typings.tstl.ihashmapMod.IHashMap.Iterator[Key, T, `false`, HashMultiMap[Key, T]] = js.native
  /**
    * @inheritDoc
    */
  @JSName("begin")
  ...
  /**
    ...
    * @return Iterator from the specific bucket.
    */
  def end(index: Double): typings.tstl.ihashmapMod.IHashMap.Iterator[Key, T, `false`, HashMultiMap[Key, T]] = js.native
  /**
    * @inheritDoc
    */
  @JSName("end")
