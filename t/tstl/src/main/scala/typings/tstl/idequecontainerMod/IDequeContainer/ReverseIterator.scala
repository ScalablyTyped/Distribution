...
object ReverseIterator {
  @scala.inline
  def apply[/* <: ElemT */ T, /* <: typings.tstl.idequecontainerMod.IDequeContainer[T, SourceT, IteratorT, ReverseT, T] */ SourceT, /* <: typings.tstl.idequecontainerMod.IDequeContainer.Iterator[T, SourceT, IteratorT, ReverseT, T] */ IteratorT, /* <: typings.tstl.idequecontainerMod.IDequeContainer.ReverseIterator[T, SourceT, IteratorT, ReverseT, T] */ ReverseT, ElemT](base: () => IteratorT, next: () => ReverseT, prev: () => ReverseT, source: () => SourceT, value: T): ReverseIterator[T, SourceT, IteratorT, ReverseT, ElemT] = {
