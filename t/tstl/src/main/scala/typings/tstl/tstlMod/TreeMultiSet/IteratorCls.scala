package typings.tstl.tstlMod.TreeMultiSet
...
@JSImport("tstl/container", "TreeMultiSet.Iterator")
@js.native
...
typings.tstl.setElementListMod.SetElementList.ReverseIterator[
  ...
  extends typings.tstl.setElementListMod.SetElementList.Iterator[Key, Unique, Source]
