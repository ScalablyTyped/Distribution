...
@JSImport("tstl/module", "experimental")
@js.native
object experimental extends js.Object {
  ...
  /**
    ...
    */
  class FlatMap[Key, T] ()
    extends typings.tstl.experimentalModuleMod.FlatMap[Key, T] {
  ...
  class FlatMultiMap[Key, T] ()
    extends typings.tstl.experimentalModuleMod.FlatMultiMap[Key, T] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  class FlatMultiSet[Key] ()
    extends typings.tstl.experimentalModuleMod.FlatMultiSet[Key] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
  ...
  /**
    ...
    */
  class FlatSet[Key] ()
    extends typings.tstl.experimentalModuleMod.FlatSet[Key] {
    def this(comp: Comparator[Key, Key]) = this()
    /**
      * Initializer Constructor.
      *
