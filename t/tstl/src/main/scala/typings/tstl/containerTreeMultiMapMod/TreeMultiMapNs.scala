...
@js.native
object TreeMultiMapNs extends js.Object {
  ...
  type iterator[Key, T] = typings.tstl.containerTreeMultiMapMod.TreeMultiMapNs.Iterator[Key, T]
  type reverse_iterator[Key, T] = typings.tstl.containerTreeMultiMapMod.TreeMultiMapNs.ReverseIterator[Key, T]
}
