...
@JSImport("tstl/container", "unordered_map")
@js.native
/**
  * Default Constructor.
  *
  ...
  */
class unordered_map[Key, T] ()
  extends typings.tstl.containerHashMapMod.unordered_map[Key, T] {
  ...
  /**
    ...
    */
  def this(obj: typings.tstl.containerHashMapMod.HashMap[Key, T]) = this()
  /**
    * Range Constructor.
    *
