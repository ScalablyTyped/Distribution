package typings.tstl.baseThreadUnderscoreITimedLockableMod
...
trait _ITimedLockable extends ILockable {
  /**
...
object _ITimedLockable {
  ...
  def apply(
    ...
    __obj.asInstanceOf[_ITimedLockable]
  }
}
