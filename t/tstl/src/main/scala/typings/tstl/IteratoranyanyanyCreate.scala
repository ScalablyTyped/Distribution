...
@js.native
trait IteratoranyanyanyCreate extends js.Object {
  /**
    * @internal
    */
  ...
  @JSName("value")
  val value_FIteratoranyanyanyCreate: /* import warning: RewrittenClass.unapply cls was tparam Key */ js.Any = js.native
