...
@js.native
object rangesNumericOperationsMod extends js.Object {
  ...
  type BinaryTransformer[OutputIterator /* <: IForwardIterator[
    typings.tstl.functionalIPointerMod.IPointer.ValueType[OutputIterator], 
    OutputIterator
  ] */] = js.Function2[
    /* x */ typings.tstl.functionalIPointerMod.IPointer.ValueType[OutputIterator], 
    /* y */ typings.tstl.functionalIPointerMod.IPointer.ValueType[OutputIterator], 
    typings.tstl.functionalIPointerMod.IPointer.ValueType[OutputIterator]
  ]
  ...
  type UnaryTransformer[Range /* <: js.Array[_] | IForwardContainer[_] */, OutputIterator /* <: IForwardIterator[
    typings.tstl.functionalIPointerMod.IPointer.ValueType[OutputIterator], 
    OutputIterator
  ] */] = js.Function1[
    /* val */ ValueType[Range], 
