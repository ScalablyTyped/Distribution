...
object arrayReverseIteratorBaseMod extends js.Object {
  ...
  - typings.tstl.ipointerMod.IPointer because var conflicts: value. Inlined 
  - typings.tstl.iforwarditeratorMod.IForwardIterator because var conflicts: value. Inlined 
