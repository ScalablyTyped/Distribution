...
@js.native
object uniqueMapMod extends js.Object {
  @js.native
  abstract class UniqueMap[Key, T, Source /* <: UniqueMap[Key, T, Source, Iterator, Reverse] */, Iterator /* <: Iterator[Key, T, Source, Iterator, Reverse] */, Reverse /* <: ReverseIterator[Key, T, Source, Iterator, Reverse] */] () extends MapContainer[Key, T, `true`, Source, Iterator, Reverse] {
  ...
  @js.native
  object UniqueMap extends js.Object {
    /**
      * Iterator of {@link UniqueMap}
      *
      * @author Jenogho Nam <http://samchon.org>
      */
    type Iterator[Key, T, SourceT /* <: UniqueMap[Key, T, SourceT, IteratorT, ReverseT] */, IteratorT /* <: /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias tstl.tstl/base/container/UniqueMap.UniqueMap.Iterator<Key, T, SourceT, IteratorT, ReverseT> */ js.Object */, ReverseT /* <: ReverseIterator[Key, T, SourceT, IteratorT, ReverseT] */] = typings.tstl.mapContainerMod.MapContainer.Iterator[Key, T, `true`, SourceT, IteratorT, ReverseT]
    /**
      * Reverse iterator of {@link UniqueMap}
      *
      * @author Jenogho Nam <http://samchon.org>
      */
    type ReverseIterator[Key, T, SourceT /* <: UniqueMap[Key, T, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, T, SourceT, IteratorT, ReverseT] */, ReverseT /* <: /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias tstl.tstl/base/container/UniqueMap.UniqueMap.ReverseIterator<Key, T, SourceT, IteratorT, ReverseT> */ js.Object */] = typings.tstl.mapContainerMod.MapContainer.ReverseIterator[Key, T, `true`, SourceT, IteratorT, ReverseT]
  }
