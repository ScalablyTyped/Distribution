...
@js.native
object itreesetMod extends js.Object {
  ...
  trait ITreeSet[Key, Unique /* <: Boolean */, Source /* <: ITreeSet[Key, Unique, Source, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, Unique, Source, IteratorT, ReverseT] */, ReverseT /* <: ReverseIterator[Key, Unique, Source, IteratorT, ReverseT] */] extends SetContainer[Key, Unique, Source, IteratorT, ReverseT] {
    /**
  ...
  @js.native
  object ITreeSet extends js.Object {
    /**
      * Iterator of {@link ITreeSet}
      *
      * @author Jenogho Nam <http://samchon.org>
      */
    type Iterator[Key, Unique /* <: Boolean */, SourceT /* <: ITreeSet[Key, Unique, SourceT, IteratorT, ReverseT] */, IteratorT /* <: /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias tstl.tstl/base/container/ITreeSet.ITreeSet.Iterator<Key, Unique, SourceT, IteratorT, ReverseT> */ js.Object */, ReverseT /* <: ReverseIterator[Key, Unique, SourceT, IteratorT, ReverseT] */] = typings.tstl.setContainerMod.SetContainer.Iterator[Key, Unique, SourceT, IteratorT, ReverseT]
    /**
      * Reverse iterator of {@link ITreeSet}
      *
      * @author Jenogho Nam <http://samchon.org>
      */
    type ReverseIterator[Key, Unique /* <: Boolean */, SourceT /* <: ITreeSet[Key, Unique, SourceT, IteratorT, ReverseT] */, IteratorT /* <: Iterator[Key, Unique, SourceT, IteratorT, ReverseT] */, ReverseT /* <: /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias tstl.tstl/base/container/ITreeSet.ITreeSet.ReverseIterator<Key, Unique, SourceT, IteratorT, ReverseT> */ js.Object */] = typings.tstl.setContainerMod.SetContainer.ReverseIterator[Key, Unique, SourceT, IteratorT, ReverseT]
  }
