...
object HashMultiMapNs extends js.Object {
  ...
  type iterator[Key, T] = typings.tstl.containerHashMultiMapMod.HashMultiMapNs.Iterator[Key, T]
  type reverse_iterator[Key, T] = typings.tstl.containerHashMultiMapMod.HashMultiMapNs.ReverseIterator[Key, T]
}
