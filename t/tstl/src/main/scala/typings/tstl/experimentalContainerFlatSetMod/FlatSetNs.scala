...
object FlatSetNs extends js.Object {
  ...
  type Iterator[Key] = typings.tstl.baseContainerSetElementVectorMod.SetElementVectorNs.Iterator[Key, `true`, FlatSet[Key]]
  type ReverseIterator[Key] = typings.tstl.baseContainerSetElementVectorMod.SetElementVectorNs.ReverseIterator[Key, `true`, FlatSet[Key]]
  type iterator[Key] = typings.tstl.experimentalContainerFlatSetMod.FlatSetNs.Iterator[Key]
  type reverse_iterator[Key] = typings.tstl.experimentalContainerFlatSetMod.FlatSetNs.ReverseIterator[Key]
}
