...
object experimentalContainerFlatMultiSetMod extends js.Object {
  ...
  object FlatMultiSet extends js.Object {
    ...
    type Iterator[Key] = typings.tstl.baseContainerSetElementVectorMod.SetElementVector.Iterator[Key, `false`, FlatMultiSet[Key]]
    type ReverseIterator[Key] = typings.tstl.baseContainerSetElementVectorMod.SetElementVector.ReverseIterator[Key, `false`, FlatMultiSet[Key]]
