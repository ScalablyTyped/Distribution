...
object TreeSetNs extends js.Object {
  ...
  type iterator[Key] = typings.tstl.containerTreeSetMod.TreeSetNs.Iterator[Key]
  type reverse_iterator[Key] = typings.tstl.containerTreeSetMod.TreeSetNs.ReverseIterator[Key]
}
