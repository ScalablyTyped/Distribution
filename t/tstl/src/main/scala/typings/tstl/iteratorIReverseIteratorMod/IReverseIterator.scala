package typings.tstl.iteratorIReverseIteratorMod
...
object IReverseIterator {
  @scala.inline
  def apply[T, Base /* <: IReversableIterator[T, Base, This] */, This /* <: IReverseIterator[T, Base, This] */](base: () => Base, equals: This => Boolean, next: () => This, prev: () => This, value: T): IReverseIterator[T, Base, This] = {
