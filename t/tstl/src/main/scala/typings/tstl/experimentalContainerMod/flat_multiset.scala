package typings.tstl.experimentalContainerMod
...
@JSImport("tstl/experimental/container", "flat_multiset")
@js.native
/**
  * Default Constructor.
  *
...
class flat_multiset[Key] ()
  extends typings.tstl.experimentalContainerFlatMultiSetMod.flat_multiset[Key] {
