...
- Dropped {readonly [ P in keyof tstl.tstl/iterator/IReverseIterator.IReverseIterator<T, Base, This> ]: tstl.tstl/iterator/IReverseIterator.IReverseIterator<T, Base, This>[P]} */ trait IReverseIterator[T /* <: Elem */, Source /* <: IContainer[T, Source, Base, This, Elem] */, Base /* <: Iterator[T, Source, Base, This, Elem] */, This /* <: IReverseIterator[T, Source, Base, This, Elem] */, Elem] extends js.Object {
  /**
