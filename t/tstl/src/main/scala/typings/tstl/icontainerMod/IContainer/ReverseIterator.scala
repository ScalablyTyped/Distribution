...
object ReverseIterator {
  @scala.inline
  def apply[/* <: Elem */ T, /* <: typings.tstl.icontainerMod.IContainer[T, Source, IteratorT, ReverseT, Elem] */ Source, /* <: typings.tstl.icontainerMod.IContainer.Iterator[T, Source, IteratorT, ReverseT, Elem] */ IteratorT, /* <: typings.tstl.icontainerMod.IContainer.ReverseIterator[T, Source, IteratorT, ReverseT, Elem] */ ReverseT, Elem](base: () => IteratorT, next: () => ReverseT, prev: () => ReverseT, source: () => Source, value: T): ReverseIterator[T, Source, IteratorT, ReverseT, Elem] = {
