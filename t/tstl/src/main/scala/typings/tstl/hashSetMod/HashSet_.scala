...
- typings.tstl.ihashsetMod.IHashSet because Inheritance from two classes. Inlined begin, begin, end, end */ @JSImport("tstl/container/HashSet", "HashSet")
@js.native
/**
  * Default Constructor.
  *
  ...
  */
class HashSet_[Key] () extends UniqueSet[Key, HashSet[Key], Iterator[Key], ReverseIterator[Key]] {
