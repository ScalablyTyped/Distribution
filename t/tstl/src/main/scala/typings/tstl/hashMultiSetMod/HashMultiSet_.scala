...
- typings.tstl.ihashsetMod.IHashSet because Inheritance from two classes. Inlined begin, begin, end, end */ @JSImport("tstl/container/HashMultiSet", "HashMultiSet")
@js.native
/**
  * Default Constructor.
  *
  ...
  */
class HashMultiSet_[Key] () extends MultiSet[Key, HashMultiSet[Key], Iterator[Key], ReverseIterator[Key]] {
