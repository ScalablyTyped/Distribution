...
@js.native
trait IteratoranyanyanyanyCreate extends js.Object {
  /**
    * @internal
    */
  ...
  /**
    ...
    */
  @JSName("first")
  val first_FIteratoranyanyanyanyCreate: /* import warning: RewrittenClass.unapply cls was tparam Key */ js.Any = js.native
  ...
  /**
    ...
    */
  @JSName("second")
  var second_FIteratoranyanyanyanyCreate: /* import warning: RewrittenClass.unapply cls was tparam T */ js.Any = js.native
  var value_ : EntryanyanyConstructor = js.native
  @JSName("value")
  val value_FIteratoranyanyanyanyCreate: EntryanyanyConstructor = js.native
