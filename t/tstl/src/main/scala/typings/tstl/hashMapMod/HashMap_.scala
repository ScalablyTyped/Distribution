...
- typings.tstl.ihashmapMod.IHashMap because Inheritance from two classes. Inlined begin, begin, end, end */ @JSImport("tstl/container/HashMap", "HashMap")
@js.native
/**
  * Default Constructor.
  *
  ...
  */
class HashMap_[Key, T] () extends UniqueMap[Key, T, HashMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T]] {
