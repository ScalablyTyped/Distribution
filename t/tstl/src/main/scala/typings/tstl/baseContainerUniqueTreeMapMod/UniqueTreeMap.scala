package typings.tstl.baseContainerUniqueTreeMapMod
...
- typings.tstl.baseContainerUnderscoreITreeContainerMod._ITreeContainer because var conflicts: iterator. Inlined key_comp, value_comp, lower_bound, upper_bound, equal_range */ @JSImport("tstl/base/container/UniqueTreeMap", "UniqueTreeMap")
@js.native
