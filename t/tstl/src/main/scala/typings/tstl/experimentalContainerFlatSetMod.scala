...
import typings.tstl.experimentalContainerFlatSetMod.FlatSet
import typings.tstl.experimentalContainerFlatSetMod.FlatSet.Iterator
import typings.tstl.experimentalContainerFlatSetMod.FlatSet.ReverseIterator
...
object experimentalContainerFlatSetMod extends js.Object {
  ...
  object FlatSet extends js.Object {
    ...
    type Iterator[Key] = typings.tstl.baseContainerSetElementVectorMod.SetElementVector.Iterator[Key, `true`, FlatSet[Key]]
    type ReverseIterator[Key] = typings.tstl.baseContainerSetElementVectorMod.SetElementVector.ReverseIterator[Key, `true`, FlatSet[Key]]
