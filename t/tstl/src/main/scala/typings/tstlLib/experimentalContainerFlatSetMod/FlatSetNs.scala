...
object FlatSetNs extends js.Object {
  ...
  type Iterator[Key] = tstlLib.baseContainerSetElementVectorMod.SetElementVectorNs.Iterator[
    Key, 
    tstlLib.tstlLibNumbers.`true`, 
    tstlLib.experimentalContainerFlatSetMod.FlatSet[Key]
  ]
  type ReverseIterator[Key] = tstlLib.baseContainerSetElementVectorMod.SetElementVectorNs.ReverseIterator[
    Key, 
    tstlLib.tstlLibNumbers.`true`, 
    tstlLib.experimentalContainerFlatSetMod.FlatSet[Key]
  ]
