...
class FlatMultiMap[Key, T] ()
  extends tstlLib.baseContainerMultiTreeMapMod.MultiTreeMap[
      ...
      T, 
      FlatMultiMap[Key, T], 
      tstlLib.experimentalContainerFlatMultiMapMod.FlatMultiMapNs.Iterator[Key, T], 
      tstlLib.experimentalContainerFlatMultiMapMod.FlatMultiMapNs.ReverseIterator[Key, T]
    ] {
  ...
  /**
    * @inheritDoc
    */
  def nth(index: scala.Double): tstlLib.experimentalContainerFlatMultiMapMod.FlatMultiMapNs.Iterator[Key, T] = js.native
}
