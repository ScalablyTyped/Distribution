...
object FlatMultiMapNs extends js.Object {
  ...
  type Iterator[Key, T] = tstlLib.baseContainerMapElementVectorMod.MapElementVectorNs.Iterator[
    Key, 
    T, 
    tstlLib.tstlLibNumbers.`false`, 
    tstlLib.experimentalContainerFlatMultiMapMod.FlatMultiMap[Key, T]
  ]
  type ReverseIterator[Key, T] = tstlLib.baseContainerMapElementVectorMod.MapElementVectorNs.ReverseIterator[
    Key, 
    T, 
    tstlLib.tstlLibNumbers.`false`, 
    tstlLib.experimentalContainerFlatMultiMapMod.FlatMultiMap[Key, T]
