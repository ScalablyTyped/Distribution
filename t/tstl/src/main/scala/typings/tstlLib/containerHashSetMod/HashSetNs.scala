...
@JSImport("tstl/container/HashSet", "HashSet")
@js.native
object HashSetNs extends js.Object {
  ...
  type Iterator[Key] = tstlLib.baseIteratorSetIteratorMod.SetIterator[Key, tstlLib.tstlLibNumbers.`true`, tstlLib.containerHashSetMod.HashSet[Key]]
  type ReverseIterator[Key] = tstlLib.baseIteratorSetIteratorMod.SetReverseIterator[Key, tstlLib.tstlLibNumbers.`true`, tstlLib.containerHashSetMod.HashSet[Key]]
