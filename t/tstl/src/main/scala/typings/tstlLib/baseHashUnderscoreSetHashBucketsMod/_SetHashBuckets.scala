...
class _SetHashBuckets[T, Unique /* <: scala.Boolean */, Source /* <: tstlLib.baseContainerIHashSetMod.IHashSet[T, Unique, Source] */] protected ()
  extends tstlLib.baseHashUnderscoreHashBucketsMod._HashBuckets[
      tstlLib.baseContainerSetElementListMod.SetElementListNs.Iterator[T, Unique, Source]
    ] {
  ...
  def find(`val`: T): tstlLib.baseContainerSetElementListMod.SetElementListNs.Iterator[T, Unique, Source] = js.native
