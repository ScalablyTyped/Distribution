...
@JSImport("tstl/container/HashMultiMap", "HashMultiMap")
@js.native
object HashMultiMapNs extends js.Object {
  ...
  type Iterator[Key, T] = tstlLib.baseIteratorMapIteratorMod.MapIterator[
    Key, 
    T, 
    tstlLib.tstlLibNumbers.`false`, 
    tstlLib.containerHashMultiMapMod.HashMultiMap[Key, T]
  ]
  type ReverseIterator[Key, T] = tstlLib.baseIteratorMapIteratorMod.MapReverseIterator[
    Key, 
    T, 
    tstlLib.tstlLibNumbers.`false`, 
    tstlLib.containerHashMultiMapMod.HashMultiMap[Key, T]
