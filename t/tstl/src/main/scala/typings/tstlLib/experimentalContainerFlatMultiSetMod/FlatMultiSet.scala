...
@JSImport("tstl/experimental/container/FlatMultiSet", "FlatMultiSet")
@js.native
/**
  * Default Constructor.
  *
...
class FlatMultiSet[Key] ()
  extends tstlLib.baseContainerMultiTreeSetMod.MultiTreeSet[
      Key, 
      FlatMultiSet[Key], 
      tstlLib.experimentalContainerFlatMultiSetMod.FlatMultiSetNs.Iterator[Key], 
      tstlLib.experimentalContainerFlatMultiSetMod.FlatMultiSetNs.ReverseIterator[Key]
    ] {
  ...
  /**
    * @inheritDoc
    */
  def nth(index: scala.Double): tstlLib.experimentalContainerFlatMultiSetMod.FlatMultiSetNs.Iterator[Key] = js.native
}
