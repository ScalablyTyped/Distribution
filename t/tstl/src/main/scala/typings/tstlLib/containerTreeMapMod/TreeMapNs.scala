package typings
package tstlLib.containerTreeMapMod
...
@js.native
object TreeMapNs extends js.Object {
  ...
  type Iterator[Key, T] = tstlLib.baseIteratorMapIteratorMod.MapIterator[Key, T, tstlLib.tstlLibNumbers.`true`, tstlLib.containerTreeMapMod.TreeMap[Key, T]]
  type ReverseIterator[Key, T] = tstlLib.baseIteratorMapIteratorMod.MapReverseIterator[Key, T, tstlLib.tstlLibNumbers.`true`, tstlLib.containerTreeMapMod.TreeMap[Key, T]]
