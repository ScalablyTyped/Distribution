...
/**
  ...
  */
class TreeMap[Key, T] ()
  extends tstlLib.baseContainerUniqueMapMod.UniqueMap[Key, T, TreeMap[Key, T]] {
  ...
  /**
    * @inheritDoc
    */
  def lower_bound(key: Key): tstlLib.containerTreeMapMod.TreeMapNs.Iterator[Key, T] = js.native
  /**
    * @inheritDoc
    */
