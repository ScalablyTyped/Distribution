...
object IBidirectionalIterator {
  @scala.inline
  def apply[T, Iterator /* <: IBidirectionalIterator[T, Iterator] */](equals: Iterator => scala.Boolean, next: () => Iterator, prev: () => Iterator, value: T): IBidirectionalIterator[T, Iterator] = {
