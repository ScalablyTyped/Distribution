...
/**
  ...
  */
class TreeSet[Key] ()
  extends tstlLib.baseContainerUniqueSetMod.UniqueSet[Key, TreeSet[Key]] {
  ...
  def equal_range(key: Key): tstlLib.utilityPairMod.Pair[
    tstlLib.containerTreeSetMod.TreeSetNs.Iterator[Key], 
    tstlLib.containerTreeSetMod.TreeSetNs.Iterator[Key]
  ] = js.native
  /**
    * @inheritDoc
  ...
  /**
    * @inheritDoc
    */
  def lower_bound(key: Key): tstlLib.containerTreeSetMod.TreeSetNs.Iterator[Key] = js.native
  /**
    * @inheritDoc
    */
