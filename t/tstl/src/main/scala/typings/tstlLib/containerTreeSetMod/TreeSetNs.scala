package typings
package tstlLib.containerTreeSetMod
...
@js.native
object TreeSetNs extends js.Object {
  ...
  type Iterator[Key] = tstlLib.baseIteratorSetIteratorMod.SetIterator[Key, tstlLib.tstlLibNumbers.`true`, tstlLib.containerTreeSetMod.TreeSet[Key]]
  type ReverseIterator[Key] = tstlLib.baseIteratorSetIteratorMod.SetReverseIterator[Key, tstlLib.tstlLibNumbers.`true`, tstlLib.containerTreeSetMod.TreeSet[Key]]
