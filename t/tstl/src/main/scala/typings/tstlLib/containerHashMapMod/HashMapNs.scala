...
@JSImport("tstl/container/HashMap", "HashMap")
@js.native
object HashMapNs extends js.Object {
  ...
  type Iterator[Key, T] = tstlLib.baseContainerMapElementListMod.MapElementListNs.Iterator[Key, T, tstlLib.tstlLibNumbers.`true`, tstlLib.containerHashMapMod.HashMap[Key, T]]
  type ReverseIterator[Key, T] = tstlLib.baseContainerMapElementListMod.MapElementListNs.ReverseIterator[Key, T, tstlLib.tstlLibNumbers.`true`, tstlLib.containerHashMapMod.HashMap[Key, T]]
