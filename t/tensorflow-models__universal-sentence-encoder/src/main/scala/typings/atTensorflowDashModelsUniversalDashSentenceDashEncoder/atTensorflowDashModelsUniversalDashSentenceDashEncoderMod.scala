...
import typings.atTensorflowDashModelsUniversalDashSentenceDashEncoder.atTensorflowDashModelsUniversalDashSentenceDashEncoderMod.UniversalSentenceEncoder
