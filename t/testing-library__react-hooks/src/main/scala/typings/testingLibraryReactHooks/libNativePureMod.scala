...
import typings.reactTestRenderer.mod.VoidOrUndefinedOnly
import typings.std.Omit
import typings.testingLibraryReactHooks.anon.Render
...
object libNativePureMod {
  
  @JSImport("@testing-library/react-hooks/lib/native/pure", JSImport.Namespace)
  @js.native
