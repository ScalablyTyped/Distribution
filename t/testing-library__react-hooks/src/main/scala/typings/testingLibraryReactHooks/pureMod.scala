...
import typings.testingLibraryReactHooks.anon.Act
import typings.testingLibraryReactHooks.anon.Rerender
import typings.testingLibraryReactHooks.reactMod.RendererOptions
...
object pureMod {
  ...
  @JSImport("@testing-library/react-hooks/lib/dom/pure", JSImport.Namespace)
  @js.native
