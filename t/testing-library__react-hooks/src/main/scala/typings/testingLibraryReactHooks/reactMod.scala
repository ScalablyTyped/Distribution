...
import typings.testingLibraryReactHooks.typesMod.ServerRenderHookResult
import typings.testingLibraryReactHooks.typesMod.ServerRenderer
...
object reactMod {
  ...
  trait RenderHookOptions[TProps]
    extends StObject
       with typings.testingLibraryReactHooks.typesMod.RenderHookOptions[TProps] {
