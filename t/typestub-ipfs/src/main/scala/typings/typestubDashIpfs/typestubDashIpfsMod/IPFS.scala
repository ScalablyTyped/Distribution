...
import typings.typestubDashIpfs.Anon_Message
import typings.typestubDashIpfs.typestubDashIpfsStrings.error
...
trait IPFS extends EventEmitter {
  ...
  @JSName("on")
  def on_error(event: error, callback: js.Function1[/* error */ Anon_Message, Unit]): this.type = js.native
