...
object showParams {
  ...
  implicit class showParamsOps[Self <: showParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtonNamesVarargs(value: java.lang.String*): Self = this.set("buttonNames", js.Array(value :_*))
    @scala.inline
    def setButtonNames(value: js.Array[java.lang.String]): Self = this.set("buttonNames", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOptionsVarargs(value: java.lang.String*): Self = this.set("options", js.Array(value :_*))
    @scala.inline
    def setOptions(value: js.Array[java.lang.String]): Self = this.set("options", value.asInstanceOf[js.Any])
    @scala.inline
