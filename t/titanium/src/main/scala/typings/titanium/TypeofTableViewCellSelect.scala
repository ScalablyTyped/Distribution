...
trait TypeofTableViewCellSelect extends js.Object {
  /**
...
object TypeofTableViewCellSelect {
  @scala.inline
  def apply(
    BLUE: Double,
    GRAY: Double,
    ...
    __obj.asInstanceOf[TypeofTableViewCellSelect]
  }
}
