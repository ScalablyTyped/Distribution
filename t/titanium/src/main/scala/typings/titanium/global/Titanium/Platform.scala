...
object Platform extends js.Object {
  ...
  @js.native
  class DisplayCaps ()
    extends typings.titanium.Titanium.Platform.DisplayCaps
  ...
  /**
    ...
    */
  val displayCaps: typings.titanium.Titanium.Platform.DisplayCaps = js.native
  /**
  ...
  /**
    ...
    */
  def getDisplayCaps(): typings.titanium.Titanium.Platform.DisplayCaps = js.native
  /**
