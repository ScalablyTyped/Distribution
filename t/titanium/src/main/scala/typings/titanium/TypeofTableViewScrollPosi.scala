...
trait TypeofTableViewScrollPosi extends js.Object {
  /**
...
object TypeofTableViewScrollPosi {
  @scala.inline
  def apply(
    BOTTOM: Double,
    MIDDLE: Double,
    ...
    __obj.asInstanceOf[TypeofTableViewScrollPosi]
  }
}
