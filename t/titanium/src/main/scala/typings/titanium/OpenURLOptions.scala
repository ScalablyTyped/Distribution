...
object OpenURLOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(UIApplicationOpenURLOptionUniversalLinksOnly)) __obj.updateDynamic("UIApplicationOpenURLOptionUniversalLinksOnly")(UIApplicationOpenURLOptionUniversalLinksOnly.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(UIApplicationOpenURLOptionsOpenInPlaceKey)) __obj.updateDynamic("UIApplicationOpenURLOptionsOpenInPlaceKey")(UIApplicationOpenURLOptionsOpenInPlaceKey.asInstanceOf[js.Any])
