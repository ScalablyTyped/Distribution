...
object ReverseGeocodeResponse {
  ...
  implicit class ReverseGeocodeResponseOps[Self <: ReverseGeocodeResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPlacesVarargs(value: GeocodedAddress*): Self = this.set("places", js.Array(value :_*))
    @scala.inline
    def setPlaces(value: js.Array[GeocodedAddress]): Self = this.set("places", value.asInstanceOf[js.Any])
    @scala.inline
