...
trait TypeofScrollIndicatorStyle extends js.Object {
  /**
...
object TypeofScrollIndicatorStyle {
  @scala.inline
  def apply(
    BLACK: Double,
    DEFAULT: Double,
