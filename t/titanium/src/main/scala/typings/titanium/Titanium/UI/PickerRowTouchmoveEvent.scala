...
/**
  ...
  */
@js.native
trait PickerRowTouchmoveEvent extends PickerRowBaseEvent {
...
object PickerRowTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerRowTouchmoveEvent]
  }
  
  @scala.inline
  implicit class PickerRowTouchmoveEventMutableBuilder[Self <: PickerRowTouchmoveEvent] (val x: Self) extends AnyVal {
