...
/**
  ...
  */
@js.native
trait ImageViewTouchendEvent extends ImageViewBaseEvent {
...
object ImageViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ImageViewTouchendEvent]
  }
  
  @scala.inline
  implicit class ImageViewTouchendEventMutableBuilder[Self <: ImageViewTouchendEvent] (val x: Self) extends AnyVal {
