...
/**
  ...
  */
@js.native
trait LivePhotoViewTouchstartEvent extends LivePhotoViewBaseEvent {
...
object LivePhotoViewTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[LivePhotoViewTouchstartEvent]
  }
  
  @scala.inline
  implicit class LivePhotoViewTouchstartEventMutableBuilder[Self <: LivePhotoViewTouchstartEvent] (val x: Self) extends AnyVal {
