...
/**
  ...
  */
@js.native
trait TextFieldTouchendEvent extends TextFieldBaseEvent {
...
object TextFieldTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TextFieldTouchendEvent]
  }
  
  @scala.inline
  implicit class TextFieldTouchendEventMutableBuilder[Self <: TextFieldTouchendEvent] (val x: Self) extends AnyVal {
