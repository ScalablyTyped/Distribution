...
/**
  ...
  */
@js.native
trait PickerColumnTouchendEvent extends PickerColumnBaseEvent {
...
object PickerColumnTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerColumnTouchendEvent]
  }
  
  @scala.inline
  implicit class PickerColumnTouchendEventMutableBuilder[Self <: PickerColumnTouchendEvent] (val x: Self) extends AnyVal {
