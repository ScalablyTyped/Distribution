...
/**
  ...
  */
@js.native
trait CoverFlowViewPinchEvent extends CoverFlowViewBaseEvent {
...
object CoverFlowViewPinchEvent {
  ...
  def apply(
    ...
    scale: Double,
    source: CoverFlowView,
    time: Double,
    timeDelta: Double,
    velocity: Double
  ): CoverFlowViewPinchEvent = {
    ...
    __obj.asInstanceOf[CoverFlowViewPinchEvent]
  }
  
  @scala.inline
  implicit class CoverFlowViewPinchEventMutableBuilder[Self <: CoverFlowViewPinchEvent] (val x: Self) extends AnyVal {
