...
/**
  ...
  */
@js.native
trait DrawerLayoutTouchstartEvent extends DrawerLayoutBaseEvent {
...
object DrawerLayoutTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DrawerLayoutTouchstartEvent]
  }
  
  @scala.inline
  implicit class DrawerLayoutTouchstartEventMutableBuilder[Self <: DrawerLayoutTouchstartEvent] (val x: Self) extends AnyVal {
