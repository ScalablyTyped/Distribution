...
/**
  ...
  */
@js.native
trait CardViewTouchcancelEvent extends CardViewBaseEvent {
...
object CardViewTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[CardViewTouchcancelEvent]
  }
  
  @scala.inline
  implicit class CardViewTouchcancelEventMutableBuilder[Self <: CardViewTouchcancelEvent] (val x: Self) extends AnyVal {
