...
/**
  ...
  */
@js.native
trait ListViewPinchEvent extends ListViewBaseEvent {
...
object ListViewPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ListViewPinchEvent]
  }
  
  @scala.inline
  implicit class ListViewPinchEventMutableBuilder[Self <: ListViewPinchEvent] (val x: Self) extends AnyVal {
