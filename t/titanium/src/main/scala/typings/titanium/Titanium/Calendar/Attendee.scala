...
object Attendee {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(addEventListener = js.Any.fromFunction2(addEventListener), apiName = apiName.asInstanceOf[js.Any], applyProperties = js.Any.fromFunction1(applyProperties), bubbleParent = bubbleParent.asInstanceOf[js.Any], email = email.asInstanceOf[js.Any], fireEvent = js.Any.fromFunction2(fireEvent), getApiName = js.Any.fromFunction0(getApiName), getBubbleParent = js.Any.fromFunction0(getBubbleParent), getEmail = js.Any.fromFunction0(getEmail), getIsOrganizer = js.Any.fromFunction0(getIsOrganizer), getName = js.Any.fromFunction0(getName), getRole = js.Any.fromFunction0(getRole), getStatus = js.Any.fromFunction0(getStatus), getType = js.Any.fromFunction0(getType), isOrganizer = isOrganizer.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], removeEventListener = js.Any.fromFunction2(removeEventListener), role = role.asInstanceOf[js.Any], setBubbleParent = js.Any.fromFunction1(setBubbleParent), setEmail = js.Any.fromFunction1(setEmail), setIsOrganizer = js.Any.fromFunction1(setIsOrganizer), setName = js.Any.fromFunction1(setName), setRole = js.Any.fromFunction1(setRole), setStatus = js.Any.fromFunction1(setStatus), setType = js.Any.fromFunction1(setType), status = status.asInstanceOf[js.Any])
