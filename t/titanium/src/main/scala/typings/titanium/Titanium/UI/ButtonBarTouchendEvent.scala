...
/**
  ...
  */
@js.native
trait ButtonBarTouchendEvent extends ButtonBarBaseEvent {
...
object ButtonBarTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ButtonBarTouchendEvent]
  }
  
  @scala.inline
  implicit class ButtonBarTouchendEventMutableBuilder[Self <: ButtonBarTouchendEvent] (val x: Self) extends AnyVal {
