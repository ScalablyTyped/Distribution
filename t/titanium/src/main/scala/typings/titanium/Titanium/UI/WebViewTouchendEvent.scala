...
/**
  ...
  */
@js.native
trait WebViewTouchendEvent extends WebViewBaseEvent {
...
object WebViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[WebViewTouchendEvent]
  }
  
  @scala.inline
  implicit class WebViewTouchendEventMutableBuilder[Self <: WebViewTouchendEvent] (val x: Self) extends AnyVal {
