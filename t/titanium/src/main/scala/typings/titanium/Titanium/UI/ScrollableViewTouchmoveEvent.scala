...
/**
  ...
  */
@js.native
trait ScrollableViewTouchmoveEvent extends ScrollableViewBaseEvent {
...
object ScrollableViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ScrollableViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class ScrollableViewTouchmoveEventMutableBuilder[Self <: ScrollableViewTouchmoveEvent] (val x: Self) extends AnyVal {
