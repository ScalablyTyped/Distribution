...
/**
  ...
  */
@js.native
trait TabGroupTouchstartEvent extends TabGroupBaseEvent {
...
object TabGroupTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabGroupTouchstartEvent]
  }
  
  @scala.inline
  implicit class TabGroupTouchstartEventMutableBuilder[Self <: TabGroupTouchstartEvent] (val x: Self) extends AnyVal {
