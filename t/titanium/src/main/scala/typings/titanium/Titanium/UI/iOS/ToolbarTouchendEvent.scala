...
/**
  ...
  */
@js.native
trait ToolbarTouchendEvent extends ToolbarBaseEvent {
...
object ToolbarTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ToolbarTouchendEvent]
  }
  
  @scala.inline
  implicit class ToolbarTouchendEventMutableBuilder[Self <: ToolbarTouchendEvent] (val x: Self) extends AnyVal {
