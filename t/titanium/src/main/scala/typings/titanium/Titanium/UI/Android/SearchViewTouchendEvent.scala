...
/**
  ...
  */
@js.native
trait SearchViewTouchendEvent extends SearchViewBaseEvent {
...
object SearchViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SearchViewTouchendEvent]
  }
  
  @scala.inline
  implicit class SearchViewTouchendEventMutableBuilder[Self <: SearchViewTouchendEvent] (val x: Self) extends AnyVal {
