...
/**
  ...
  */
@js.native
trait ViewTouchendEvent extends ViewBaseEvent {
...
object ViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ViewTouchendEvent]
  }
  
  @scala.inline
  implicit class ViewTouchendEventMutableBuilder[Self <: ViewTouchendEvent] (val x: Self) extends AnyVal {
