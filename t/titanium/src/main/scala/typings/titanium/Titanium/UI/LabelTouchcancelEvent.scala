...
/**
  ...
  */
@js.native
trait LabelTouchcancelEvent extends LabelBaseEvent {
...
object LabelTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[LabelTouchcancelEvent]
  }
  
  @scala.inline
  implicit class LabelTouchcancelEventMutableBuilder[Self <: LabelTouchcancelEvent] (val x: Self) extends AnyVal {
