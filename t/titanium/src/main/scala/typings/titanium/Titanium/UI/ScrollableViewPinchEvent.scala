...
/**
  ...
  */
@js.native
trait ScrollableViewPinchEvent extends ScrollableViewBaseEvent {
...
object ScrollableViewPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ScrollableViewPinchEvent]
  }
  
  @scala.inline
  implicit class ScrollableViewPinchEventMutableBuilder[Self <: ScrollableViewPinchEvent] (val x: Self) extends AnyVal {
