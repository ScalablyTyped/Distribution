...
/**
  ...
  */
@js.native
trait TextFieldTouchcancelEvent extends TextFieldBaseEvent {
...
object TextFieldTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TextFieldTouchcancelEvent]
  }
  
  @scala.inline
  implicit class TextFieldTouchcancelEventMutableBuilder[Self <: TextFieldTouchcancelEvent] (val x: Self) extends AnyVal {
