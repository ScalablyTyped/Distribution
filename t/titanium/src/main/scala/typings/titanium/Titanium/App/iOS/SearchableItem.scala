...
object SearchableItem {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(addEventListener = js.Any.fromFunction2(addEventListener), apiName = apiName.asInstanceOf[js.Any], applyProperties = js.Any.fromFunction1(applyProperties), attributeSet = attributeSet.asInstanceOf[js.Any], bubbleParent = bubbleParent.asInstanceOf[js.Any], domainIdentifier = domainIdentifier.asInstanceOf[js.Any], expirationDate = expirationDate.asInstanceOf[js.Any], fireEvent = js.Any.fromFunction2(fireEvent), getApiName = js.Any.fromFunction0(getApiName), getBubbleParent = js.Any.fromFunction0(getBubbleParent), getDomainIdentifier = js.Any.fromFunction0(getDomainIdentifier), getExpirationDate = js.Any.fromFunction0(getExpirationDate), getUniqueIdentifier = js.Any.fromFunction0(getUniqueIdentifier), removeEventListener = js.Any.fromFunction2(removeEventListener), setBubbleParent = js.Any.fromFunction1(setBubbleParent), setDomainIdentifier = js.Any.fromFunction1(setDomainIdentifier), setExpirationDate = js.Any.fromFunction1(setExpirationDate), setUniqueIdentifier = js.Any.fromFunction1(setUniqueIdentifier), uniqueIdentifier = uniqueIdentifier.asInstanceOf[js.Any])
