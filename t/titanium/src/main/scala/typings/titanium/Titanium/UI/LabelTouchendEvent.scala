...
object LabelTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[LabelTouchendEvent]
  }
  
  @scala.inline
  implicit class LabelTouchendEventMutableBuilder[Self <: LabelTouchendEvent] (val x: Self) extends AnyVal {
