...
object Animator {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(addBehavior = js.Any.fromFunction1(addBehavior), addEventListener = js.Any.fromFunction2(addEventListener), apiName = apiName.asInstanceOf[js.Any], applyProperties = js.Any.fromFunction1(applyProperties), behaviors = behaviors.asInstanceOf[js.Any], bubbleParent = bubbleParent.asInstanceOf[js.Any], fireEvent = js.Any.fromFunction2(fireEvent), getApiName = js.Any.fromFunction0(getApiName), getBehaviors = js.Any.fromFunction0(getBehaviors), getBubbleParent = js.Any.fromFunction0(getBubbleParent), getReferenceView = js.Any.fromFunction0(getReferenceView), getRunning = js.Any.fromFunction0(getRunning), referenceView = referenceView.asInstanceOf[js.Any], removeAllBehaviors = js.Any.fromFunction0(removeAllBehaviors), removeBehavior = js.Any.fromFunction1(removeBehavior), removeEventListener = js.Any.fromFunction2(removeEventListener), running = running.asInstanceOf[js.Any], setBehaviors = js.Any.fromFunction1(setBehaviors), setBubbleParent = js.Any.fromFunction1(setBubbleParent), setReferenceView = js.Any.fromFunction1(setReferenceView), startAnimator = js.Any.fromFunction0(startAnimator), stopAnimator = js.Any.fromFunction0(stopAnimator), updateItemUsingCurrentState = js.Any.fromFunction1(updateItemUsingCurrentState))
