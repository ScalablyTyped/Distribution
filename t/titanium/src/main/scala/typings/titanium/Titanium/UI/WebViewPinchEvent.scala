...
/**
  ...
  */
@js.native
trait WebViewPinchEvent extends WebViewBaseEvent {
...
object WebViewPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[WebViewPinchEvent]
  }
  
  @scala.inline
  implicit class WebViewPinchEventMutableBuilder[Self <: WebViewPinchEvent] (val x: Self) extends AnyVal {
