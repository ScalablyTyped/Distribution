...
/**
  ...
  */
@js.native
trait LabelPinchEvent extends LabelBaseEvent {
...
object LabelPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[LabelPinchEvent]
  }
  
  @scala.inline
  implicit class LabelPinchEventMutableBuilder[Self <: LabelPinchEvent] (val x: Self) extends AnyVal {
