...
/**
  ...
  */
@js.native
trait ButtonPinchEvent extends ButtonBaseEvent {
...
object ButtonPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ButtonPinchEvent]
  }
  
  @scala.inline
  implicit class ButtonPinchEventMutableBuilder[Self <: ButtonPinchEvent] (val x: Self) extends AnyVal {
