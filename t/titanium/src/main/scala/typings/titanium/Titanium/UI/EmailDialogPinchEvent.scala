...
object EmailDialogPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[EmailDialogPinchEvent]
  }
  
  @scala.inline
  implicit class EmailDialogPinchEventMutableBuilder[Self <: EmailDialogPinchEvent] (val x: Self) extends AnyVal {
