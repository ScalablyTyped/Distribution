...
/**
  ...
  */
@js.native
trait TabPinchEvent extends TabBaseEvent {
...
object TabPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabPinchEvent]
  }
  
  @scala.inline
  implicit class TabPinchEventMutableBuilder[Self <: TabPinchEvent] (val x: Self) extends AnyVal {
