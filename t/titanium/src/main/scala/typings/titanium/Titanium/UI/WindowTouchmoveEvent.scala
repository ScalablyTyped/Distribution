...
/**
  ...
  */
@js.native
trait WindowTouchmoveEvent extends WindowBaseEvent {
...
object WindowTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[WindowTouchmoveEvent]
  }
  
  @scala.inline
  implicit class WindowTouchmoveEventMutableBuilder[Self <: WindowTouchmoveEvent] (val x: Self) extends AnyVal {
