...
/**
  ...
  */
@js.native
trait CardViewPinchEvent extends CardViewBaseEvent {
...
object CardViewPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[CardViewPinchEvent]
  }
  
  @scala.inline
  implicit class CardViewPinchEventMutableBuilder[Self <: CardViewPinchEvent] (val x: Self) extends AnyVal {
