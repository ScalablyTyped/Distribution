...
/**
  ...
  */
@js.native
trait OptionDialogTouchmoveEvent extends OptionDialogBaseEvent {
...
object OptionDialogTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OptionDialogTouchmoveEvent]
  }
  
  @scala.inline
  implicit class OptionDialogTouchmoveEventMutableBuilder[Self <: OptionDialogTouchmoveEvent] (val x: Self) extends AnyVal {
