...
/**
  ...
  */
@js.native
trait BlurViewTouchmoveEvent extends BlurViewBaseEvent {
...
object BlurViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[BlurViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class BlurViewTouchmoveEventMutableBuilder[Self <: BlurViewTouchmoveEvent] (val x: Self) extends AnyVal {
