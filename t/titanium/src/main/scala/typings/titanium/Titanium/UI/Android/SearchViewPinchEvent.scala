...
/**
  ...
  */
@js.native
trait SearchViewPinchEvent extends SearchViewBaseEvent {
...
object SearchViewPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SearchViewPinchEvent]
  }
  
  @scala.inline
  implicit class SearchViewPinchEventMutableBuilder[Self <: SearchViewPinchEvent] (val x: Self) extends AnyVal {
