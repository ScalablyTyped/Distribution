...
/**
  ...
  */
@js.native
trait EmailDialogTouchstartEvent extends EmailDialogBaseEvent {
...
object EmailDialogTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[EmailDialogTouchstartEvent]
  }
  
  @scala.inline
  implicit class EmailDialogTouchstartEventMutableBuilder[Self <: EmailDialogTouchstartEvent] (val x: Self) extends AnyVal {
