...
/**
  ...
  */
@js.native
trait TabGroupTouchmoveEvent extends TabGroupBaseEvent {
...
object TabGroupTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabGroupTouchmoveEvent]
  }
  
  @scala.inline
  implicit class TabGroupTouchmoveEventMutableBuilder[Self <: TabGroupTouchmoveEvent] (val x: Self) extends AnyVal {
