...
/**
  ...
  */
@js.native
trait StepperTouchcancelEvent extends StepperBaseEvent {
...
object StepperTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[StepperTouchcancelEvent]
  }
  
  @scala.inline
  implicit class StepperTouchcancelEventMutableBuilder[Self <: StepperTouchcancelEvent] (val x: Self) extends AnyVal {
