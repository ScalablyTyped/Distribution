...
/**
  ...
  */
@js.native
trait SearchBarTouchendEvent extends SearchBarBaseEvent {
...
object SearchBarTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SearchBarTouchendEvent]
  }
  
  @scala.inline
  implicit class SearchBarTouchendEventMutableBuilder[Self <: SearchBarTouchendEvent] (val x: Self) extends AnyVal {
