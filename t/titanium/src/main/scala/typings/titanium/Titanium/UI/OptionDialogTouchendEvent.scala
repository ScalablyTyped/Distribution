...
/**
  ...
  */
@js.native
trait OptionDialogTouchendEvent extends OptionDialogBaseEvent {
...
object OptionDialogTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OptionDialogTouchendEvent]
  }
  
  @scala.inline
  implicit class OptionDialogTouchendEventMutableBuilder[Self <: OptionDialogTouchendEvent] (val x: Self) extends AnyVal {
