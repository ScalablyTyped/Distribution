...
/**
  ...
  */
@js.native
trait SearchViewTouchmoveEvent extends SearchViewBaseEvent {
...
object SearchViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SearchViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class SearchViewTouchmoveEventMutableBuilder[Self <: SearchViewTouchmoveEvent] (val x: Self) extends AnyVal {
