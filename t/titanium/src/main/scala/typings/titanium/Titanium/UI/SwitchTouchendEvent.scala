...
/**
  ...
  */
@js.native
trait SwitchTouchendEvent extends SwitchBaseEvent {
...
object SwitchTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SwitchTouchendEvent]
  }
  
  @scala.inline
  implicit class SwitchTouchendEventMutableBuilder[Self <: SwitchTouchendEvent] (val x: Self) extends AnyVal {
