...
/**
  ...
  */
@js.native
trait SliderTouchendEvent extends SliderBaseEvent {
...
object SliderTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SliderTouchendEvent]
  }
  
  @scala.inline
  implicit class SliderTouchendEventMutableBuilder[Self <: SliderTouchendEvent] (val x: Self) extends AnyVal {
