...
/**
  ...
  */
@js.native
trait WindowPinchEvent extends WindowBaseEvent {
...
object WindowPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[WindowPinchEvent]
  }
  
  @scala.inline
  implicit class WindowPinchEventMutableBuilder[Self <: WindowPinchEvent] (val x: Self) extends AnyVal {
