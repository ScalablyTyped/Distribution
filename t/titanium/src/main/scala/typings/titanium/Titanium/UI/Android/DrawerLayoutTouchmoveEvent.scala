...
/**
  ...
  */
@js.native
trait DrawerLayoutTouchmoveEvent extends DrawerLayoutBaseEvent {
...
object DrawerLayoutTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DrawerLayoutTouchmoveEvent]
  }
  
  @scala.inline
  implicit class DrawerLayoutTouchmoveEventMutableBuilder[Self <: DrawerLayoutTouchmoveEvent] (val x: Self) extends AnyVal {
