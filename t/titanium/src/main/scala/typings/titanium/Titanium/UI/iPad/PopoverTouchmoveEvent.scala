...
/**
  ...
  */
@js.native
trait PopoverTouchmoveEvent extends PopoverBaseEvent {
...
object PopoverTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PopoverTouchmoveEvent]
  }
  
  @scala.inline
  implicit class PopoverTouchmoveEventMutableBuilder[Self <: PopoverTouchmoveEvent] (val x: Self) extends AnyVal {
