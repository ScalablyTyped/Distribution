...
/**
  ...
  */
@js.native
trait BlurViewPinchEvent extends BlurViewBaseEvent {
...
object BlurViewPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[BlurViewPinchEvent]
  }
  
  @scala.inline
  implicit class BlurViewPinchEventMutableBuilder[Self <: BlurViewPinchEvent] (val x: Self) extends AnyVal {
