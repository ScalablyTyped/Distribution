...
/**
  ...
  */
@js.native
trait PickerPinchEvent extends PickerBaseEvent {
...
object PickerPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerPinchEvent]
  }
  
  @scala.inline
  implicit class PickerPinchEventMutableBuilder[Self <: PickerPinchEvent] (val x: Self) extends AnyVal {
