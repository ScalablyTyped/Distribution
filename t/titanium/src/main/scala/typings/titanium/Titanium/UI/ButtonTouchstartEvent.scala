...
/**
  ...
  */
@js.native
trait ButtonTouchstartEvent extends ButtonBaseEvent {
...
object ButtonTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ButtonTouchstartEvent]
  }
  
  @scala.inline
  implicit class ButtonTouchstartEventMutableBuilder[Self <: ButtonTouchstartEvent] (val x: Self) extends AnyVal {
