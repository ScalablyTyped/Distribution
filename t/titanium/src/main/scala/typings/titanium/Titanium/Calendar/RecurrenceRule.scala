...
object RecurrenceRule {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(addEventListener = js.Any.fromFunction2(addEventListener), apiName = apiName.asInstanceOf[js.Any], applyProperties = js.Any.fromFunction1(applyProperties), bubbleParent = bubbleParent.asInstanceOf[js.Any], calendarID = calendarID.asInstanceOf[js.Any], daysOfTheMonth = daysOfTheMonth.asInstanceOf[js.Any], daysOfTheWeek = daysOfTheWeek.asInstanceOf[js.Any], daysOfTheYear = daysOfTheYear.asInstanceOf[js.Any], end = end.asInstanceOf[js.Any], fireEvent = js.Any.fromFunction2(fireEvent), frequency = frequency.asInstanceOf[js.Any], getApiName = js.Any.fromFunction0(getApiName), getBubbleParent = js.Any.fromFunction0(getBubbleParent), getCalendarID = js.Any.fromFunction0(getCalendarID), getDaysOfTheMonth = js.Any.fromFunction0(getDaysOfTheMonth), getDaysOfTheWeek = js.Any.fromFunction0(getDaysOfTheWeek), getDaysOfTheYear = js.Any.fromFunction0(getDaysOfTheYear), getEnd = js.Any.fromFunction0(getEnd), getFrequency = js.Any.fromFunction0(getFrequency), getInterval = js.Any.fromFunction0(getInterval), getMonthsOfTheYear = js.Any.fromFunction0(getMonthsOfTheYear), getSetPositions = js.Any.fromFunction0(getSetPositions), getWeeksOfTheYear = js.Any.fromFunction0(getWeeksOfTheYear), interval = interval.asInstanceOf[js.Any], monthsOfTheYear = monthsOfTheYear.asInstanceOf[js.Any], removeEventListener = js.Any.fromFunction2(removeEventListener), setBubbleParent = js.Any.fromFunction1(setBubbleParent), setPositions = setPositions.asInstanceOf[js.Any], weeksOfTheYear = weeksOfTheYear.asInstanceOf[js.Any])
