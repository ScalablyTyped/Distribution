...
object Geolocation extends js.Object {
  ...
  object Android extends js.Object {
    /**
    			 ...
    			 */
    @js.native
    class LocationProvider () extends Proxy {
      /**
    ...
    /**
    			 ...
    			 */
    @js.native
    class LocationRule () extends Proxy {
      /**
    ...
    def createLocationProvider(parameters: Dictionary[LocationProvider]): LocationProvider = js.native
    /**
    ...
    def createLocationRule(parameters: Dictionary[LocationRule]): LocationRule = js.native
    /**
    			 * Fires a synthesized event to any registered listeners.
    			 */
    def fireEvent(name: String): Unit = js.native
