...
/**
  ...
  */
@js.native
trait DashboardViewTouchmoveEvent extends DashboardViewBaseEvent {
...
object DashboardViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DashboardViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class DashboardViewTouchmoveEventMutableBuilder[Self <: DashboardViewTouchmoveEvent] (val x: Self) extends AnyVal {
