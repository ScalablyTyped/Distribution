...
/**
  ...
  */
@js.native
trait TextAreaTouchmoveEvent extends TextAreaBaseEvent {
...
object TextAreaTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TextAreaTouchmoveEvent]
  }
  
  @scala.inline
  implicit class TextAreaTouchmoveEventMutableBuilder[Self <: TextAreaTouchmoveEvent] (val x: Self) extends AnyVal {
