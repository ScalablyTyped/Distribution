...
/**
  ...
  */
@js.native
trait NavigationWindowTouchendEvent extends NavigationWindowBaseEvent {
...
object NavigationWindowTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[NavigationWindowTouchendEvent]
  }
  
  @scala.inline
  implicit class NavigationWindowTouchendEventMutableBuilder[Self <: NavigationWindowTouchendEvent] (val x: Self) extends AnyVal {
