...
/**
  ...
  */
@js.native
trait WebViewTouchstartEvent extends WebViewBaseEvent {
...
object WebViewTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[WebViewTouchstartEvent]
  }
  
  @scala.inline
  implicit class WebViewTouchstartEventMutableBuilder[Self <: WebViewTouchstartEvent] (val x: Self) extends AnyVal {
