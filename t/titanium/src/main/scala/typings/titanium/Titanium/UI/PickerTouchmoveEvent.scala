...
/**
  ...
  */
@js.native
trait PickerTouchmoveEvent extends PickerBaseEvent {
...
object PickerTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerTouchmoveEvent]
  }
  
  @scala.inline
  implicit class PickerTouchmoveEventMutableBuilder[Self <: PickerTouchmoveEvent] (val x: Self) extends AnyVal {
