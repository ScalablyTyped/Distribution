...
/**
  ...
  */
@js.native
trait ImageViewTouchmoveEvent extends ImageViewBaseEvent {
...
object ImageViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ImageViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class ImageViewTouchmoveEventMutableBuilder[Self <: ImageViewTouchmoveEvent] (val x: Self) extends AnyVal {
