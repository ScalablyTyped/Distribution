...
/**
  ...
  */
@js.native
trait PickerRowTouchcancelEvent extends PickerRowBaseEvent {
...
object PickerRowTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerRowTouchcancelEvent]
  }
  
  @scala.inline
  implicit class PickerRowTouchcancelEventMutableBuilder[Self <: PickerRowTouchcancelEvent] (val x: Self) extends AnyVal {
