...
/**
  ...
  */
@js.native
trait WindowTouchstartEvent extends WindowBaseEvent {
...
object WindowTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[WindowTouchstartEvent]
  }
  
  @scala.inline
  implicit class WindowTouchstartEventMutableBuilder[Self <: WindowTouchstartEvent] (val x: Self) extends AnyVal {
