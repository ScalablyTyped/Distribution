...
/**
  ...
  */
@js.native
trait ViewTouchmoveEvent extends ViewBaseEvent {
...
object ViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class ViewTouchmoveEventMutableBuilder[Self <: ViewTouchmoveEvent] (val x: Self) extends AnyVal {
