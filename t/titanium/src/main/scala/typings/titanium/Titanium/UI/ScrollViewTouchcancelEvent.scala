...
/**
  ...
  */
@js.native
trait ScrollViewTouchcancelEvent extends ScrollViewBaseEvent {
...
object ScrollViewTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ScrollViewTouchcancelEvent]
  }
  
  @scala.inline
  implicit class ScrollViewTouchcancelEventMutableBuilder[Self <: ScrollViewTouchcancelEvent] (val x: Self) extends AnyVal {
