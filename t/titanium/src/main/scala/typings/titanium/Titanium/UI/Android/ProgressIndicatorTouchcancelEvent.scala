...
/**
  ...
  */
@js.native
trait ProgressIndicatorTouchcancelEvent extends ProgressIndicatorBaseEvent {
...
object ProgressIndicatorTouchcancelEvent {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): ProgressIndicatorTouchcancelEvent = {
    ...
    __obj.asInstanceOf[ProgressIndicatorTouchcancelEvent]
  }
  
  @scala.inline
  implicit class ProgressIndicatorTouchcancelEventMutableBuilder[Self <: ProgressIndicatorTouchcancelEvent] (val x: Self) extends AnyVal {
