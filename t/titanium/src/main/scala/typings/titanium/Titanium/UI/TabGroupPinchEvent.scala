...
/**
  ...
  */
@js.native
trait TabGroupPinchEvent extends TabGroupBaseEvent {
...
object TabGroupPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabGroupPinchEvent]
  }
  
  @scala.inline
  implicit class TabGroupPinchEventMutableBuilder[Self <: TabGroupPinchEvent] (val x: Self) extends AnyVal {
