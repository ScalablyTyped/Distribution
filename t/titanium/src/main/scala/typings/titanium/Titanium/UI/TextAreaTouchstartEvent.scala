...
/**
  ...
  */
@js.native
trait TextAreaTouchstartEvent extends TextAreaBaseEvent {
...
object TextAreaTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TextAreaTouchstartEvent]
  }
  
  @scala.inline
  implicit class TextAreaTouchstartEventMutableBuilder[Self <: TextAreaTouchstartEvent] (val x: Self) extends AnyVal {
