...
/**
  ...
  */
@js.native
trait WindowTouchcancelEvent extends WindowBaseEvent {
...
object WindowTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[WindowTouchcancelEvent]
  }
  
  @scala.inline
  implicit class WindowTouchcancelEventMutableBuilder[Self <: WindowTouchcancelEvent] (val x: Self) extends AnyVal {
