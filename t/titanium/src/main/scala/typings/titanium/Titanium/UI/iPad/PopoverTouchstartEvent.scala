...
/**
  ...
  */
@js.native
trait PopoverTouchstartEvent extends PopoverBaseEvent {
...
object PopoverTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PopoverTouchstartEvent]
  }
  
  @scala.inline
  implicit class PopoverTouchstartEventMutableBuilder[Self <: PopoverTouchstartEvent] (val x: Self) extends AnyVal {
