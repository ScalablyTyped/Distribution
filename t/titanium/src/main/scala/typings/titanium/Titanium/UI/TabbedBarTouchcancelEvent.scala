...
/**
  ...
  */
@js.native
trait TabbedBarTouchcancelEvent extends TabbedBarBaseEvent {
...
object TabbedBarTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabbedBarTouchcancelEvent]
  }
  
  @scala.inline
  implicit class TabbedBarTouchcancelEventMutableBuilder[Self <: TabbedBarTouchcancelEvent] (val x: Self) extends AnyVal {
