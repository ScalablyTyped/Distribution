...
trait QuickSettingsServiceBaseEvent extends js.Object {
...
object QuickSettingsServiceBaseEvent {
  ...
  @scala.inline
  implicit class QuickSettingsServiceBaseEventOps[Self <: QuickSettingsServiceBaseEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSource(value: QuickSettingsService): Self = this.set("source", value.asInstanceOf[js.Any])
  }
}
