...
/**
  ...
  */
@js.native
trait SearchBarTouchmoveEvent extends SearchBarBaseEvent {
...
object SearchBarTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SearchBarTouchmoveEvent]
  }
  
  @scala.inline
  implicit class SearchBarTouchmoveEventMutableBuilder[Self <: SearchBarTouchmoveEvent] (val x: Self) extends AnyVal {
