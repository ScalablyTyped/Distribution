...
/**
  ...
  */
@js.native
trait ToolbarPinchEvent extends ToolbarBaseEvent {
...
object ToolbarPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ToolbarPinchEvent]
  }
  
  @scala.inline
  implicit class ToolbarPinchEventMutableBuilder[Self <: ToolbarPinchEvent] (val x: Self) extends AnyVal {
