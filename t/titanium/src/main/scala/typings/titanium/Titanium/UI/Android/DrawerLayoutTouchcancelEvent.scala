...
/**
  ...
  */
@js.native
trait DrawerLayoutTouchcancelEvent extends DrawerLayoutBaseEvent {
...
object DrawerLayoutTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DrawerLayoutTouchcancelEvent]
  }
  
  @scala.inline
  implicit class DrawerLayoutTouchcancelEventMutableBuilder[Self <: DrawerLayoutTouchcancelEvent] (val x: Self) extends AnyVal {
