...
/**
  ...
  */
@js.native
trait ViewPinchEvent extends ViewBaseEvent {
...
object ViewPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ViewPinchEvent]
  }
  
  @scala.inline
  implicit class ViewPinchEventMutableBuilder[Self <: ViewPinchEvent] (val x: Self) extends AnyVal {
