...
/**
  ...
  */
@js.native
trait OptionDialogTouchcancelEvent extends OptionDialogBaseEvent {
...
object OptionDialogTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OptionDialogTouchcancelEvent]
  }
  
  @scala.inline
  implicit class OptionDialogTouchcancelEventMutableBuilder[Self <: OptionDialogTouchcancelEvent] (val x: Self) extends AnyVal {
