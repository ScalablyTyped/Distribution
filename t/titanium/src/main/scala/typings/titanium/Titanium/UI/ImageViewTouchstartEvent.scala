...
/**
  ...
  */
@js.native
trait ImageViewTouchstartEvent extends ImageViewBaseEvent {
...
object ImageViewTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ImageViewTouchstartEvent]
  }
  
  @scala.inline
  implicit class ImageViewTouchstartEventMutableBuilder[Self <: ImageViewTouchstartEvent] (val x: Self) extends AnyVal {
