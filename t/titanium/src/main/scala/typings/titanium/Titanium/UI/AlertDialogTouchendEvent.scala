...
/**
  ...
  */
@js.native
trait AlertDialogTouchendEvent extends AlertDialogBaseEvent {
...
object AlertDialogTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AlertDialogTouchendEvent]
  }
  
  @scala.inline
  implicit class AlertDialogTouchendEventMutableBuilder[Self <: AlertDialogTouchendEvent] (val x: Self) extends AnyVal {
