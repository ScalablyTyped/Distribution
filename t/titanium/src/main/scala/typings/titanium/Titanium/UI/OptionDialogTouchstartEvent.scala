...
/**
  ...
  */
@js.native
trait OptionDialogTouchstartEvent extends OptionDialogBaseEvent {
...
object OptionDialogTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[OptionDialogTouchstartEvent]
  }
  
  @scala.inline
  implicit class OptionDialogTouchstartEventMutableBuilder[Self <: OptionDialogTouchstartEvent] (val x: Self) extends AnyVal {
