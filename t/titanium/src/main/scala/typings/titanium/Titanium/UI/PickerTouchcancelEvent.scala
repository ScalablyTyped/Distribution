...
/**
  ...
  */
@js.native
trait PickerTouchcancelEvent extends PickerBaseEvent {
...
object PickerTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerTouchcancelEvent]
  }
  
  @scala.inline
  implicit class PickerTouchcancelEventMutableBuilder[Self <: PickerTouchcancelEvent] (val x: Self) extends AnyVal {
