...
/**
  ...
  */
@js.native
trait SplitWindowTouchcancelEvent extends SplitWindowBaseEvent {
...
object SplitWindowTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SplitWindowTouchcancelEvent]
  }
  
  @scala.inline
  implicit class SplitWindowTouchcancelEventMutableBuilder[Self <: SplitWindowTouchcancelEvent] (val x: Self) extends AnyVal {
