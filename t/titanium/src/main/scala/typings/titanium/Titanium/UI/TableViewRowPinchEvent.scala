...
/**
  ...
  */
@js.native
trait TableViewRowPinchEvent extends TableViewRowBaseEvent {
...
object TableViewRowPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TableViewRowPinchEvent]
  }
  
  @scala.inline
  implicit class TableViewRowPinchEventMutableBuilder[Self <: TableViewRowPinchEvent] (val x: Self) extends AnyVal {
