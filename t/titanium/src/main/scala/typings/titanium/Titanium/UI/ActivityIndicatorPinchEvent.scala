...
/**
  ...
  */
@js.native
trait ActivityIndicatorPinchEvent extends ActivityIndicatorBaseEvent {
...
object ActivityIndicatorPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ActivityIndicatorPinchEvent]
  }
  
  @scala.inline
  implicit class ActivityIndicatorPinchEventMutableBuilder[Self <: ActivityIndicatorPinchEvent] (val x: Self) extends AnyVal {
