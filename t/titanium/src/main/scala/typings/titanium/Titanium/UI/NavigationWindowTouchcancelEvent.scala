...
/**
  ...
  */
@js.native
trait NavigationWindowTouchcancelEvent extends NavigationWindowBaseEvent {
...
object NavigationWindowTouchcancelEvent {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): NavigationWindowTouchcancelEvent = {
    ...
    __obj.asInstanceOf[NavigationWindowTouchcancelEvent]
  }
  
  @scala.inline
  implicit class NavigationWindowTouchcancelEventMutableBuilder[Self <: NavigationWindowTouchcancelEvent] (val x: Self) extends AnyVal {
