...
/**
  ...
  */
@js.native
trait CoverFlowViewTouchcancelEvent extends CoverFlowViewBaseEvent {
...
object CoverFlowViewTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[CoverFlowViewTouchcancelEvent]
  }
  
  @scala.inline
  implicit class CoverFlowViewTouchcancelEventMutableBuilder[Self <: CoverFlowViewTouchcancelEvent] (val x: Self) extends AnyVal {
