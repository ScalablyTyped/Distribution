...
/**
  ...
  */
@js.native
trait ButtonBarTouchcancelEvent extends ButtonBarBaseEvent {
...
object ButtonBarTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ButtonBarTouchcancelEvent]
  }
  
  @scala.inline
  implicit class ButtonBarTouchcancelEventMutableBuilder[Self <: ButtonBarTouchcancelEvent] (val x: Self) extends AnyVal {
