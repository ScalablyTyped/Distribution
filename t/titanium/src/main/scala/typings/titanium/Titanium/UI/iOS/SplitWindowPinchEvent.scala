...
/**
  ...
  */
@js.native
trait SplitWindowPinchEvent extends SplitWindowBaseEvent {
...
object SplitWindowPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[SplitWindowPinchEvent]
  }
  
  @scala.inline
  implicit class SplitWindowPinchEventMutableBuilder[Self <: SplitWindowPinchEvent] (val x: Self) extends AnyVal {
