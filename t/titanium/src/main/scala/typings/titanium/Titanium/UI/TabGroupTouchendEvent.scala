...
/**
  ...
  */
@js.native
trait TabGroupTouchendEvent extends TabGroupBaseEvent {
...
object TabGroupTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TabGroupTouchendEvent]
  }
  
  @scala.inline
  implicit class TabGroupTouchendEventMutableBuilder[Self <: TabGroupTouchendEvent] (val x: Self) extends AnyVal {
