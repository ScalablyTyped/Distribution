...
/**
  ...
  */
@js.native
trait ActivityIndicatorTouchendEvent extends ActivityIndicatorBaseEvent {
...
object ActivityIndicatorTouchendEvent {
  ...
  def apply(
    ...
    x: Double,
    y: Double
  ): ActivityIndicatorTouchendEvent = {
    ...
    __obj.asInstanceOf[ActivityIndicatorTouchendEvent]
  }
  
  @scala.inline
  implicit class ActivityIndicatorTouchendEventMutableBuilder[Self <: ActivityIndicatorTouchendEvent] (val x: Self) extends AnyVal {
