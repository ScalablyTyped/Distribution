...
/**
  ...
  */
@js.native
trait ListViewTouchmoveEvent extends ListViewBaseEvent {
...
object ListViewTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ListViewTouchmoveEvent]
  }
  
  @scala.inline
  implicit class ListViewTouchmoveEventMutableBuilder[Self <: ListViewTouchmoveEvent] (val x: Self) extends AnyVal {
