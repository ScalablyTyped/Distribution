...
/**
  ...
  */
@js.native
trait LivePhotoViewTouchcancelEvent extends LivePhotoViewBaseEvent {
...
object LivePhotoViewTouchcancelEvent {
  ...
  def apply(
    ...
    size: Double,
    source: LivePhotoView,
    timestamp: Double,
    x: Double,
    y: Double
  ): LivePhotoViewTouchcancelEvent = {
    ...
    __obj.asInstanceOf[LivePhotoViewTouchcancelEvent]
  }
  
  @scala.inline
  implicit class LivePhotoViewTouchcancelEventMutableBuilder[Self <: LivePhotoViewTouchcancelEvent] (val x: Self) extends AnyVal {
