...
/**
  ...
  */
@js.native
trait ToolbarTouchstartEvent extends ToolbarBaseEvent {
...
object ToolbarTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ToolbarTouchstartEvent]
  }
  
  @scala.inline
  implicit class ToolbarTouchstartEventMutableBuilder[Self <: ToolbarTouchstartEvent] (val x: Self) extends AnyVal {
