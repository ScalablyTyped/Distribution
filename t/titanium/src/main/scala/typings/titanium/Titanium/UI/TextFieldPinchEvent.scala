...
/**
  ...
  */
@js.native
trait TextFieldPinchEvent extends TextFieldBaseEvent {
...
object TextFieldPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TextFieldPinchEvent]
  }
  
  @scala.inline
  implicit class TextFieldPinchEventMutableBuilder[Self <: TextFieldPinchEvent] (val x: Self) extends AnyVal {
