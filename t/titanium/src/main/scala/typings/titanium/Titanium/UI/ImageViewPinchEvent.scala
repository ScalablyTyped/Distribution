...
/**
  ...
  */
@js.native
trait ImageViewPinchEvent extends ImageViewBaseEvent {
...
object ImageViewPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ImageViewPinchEvent]
  }
  
  @scala.inline
  implicit class ImageViewPinchEventMutableBuilder[Self <: ImageViewPinchEvent] (val x: Self) extends AnyVal {
