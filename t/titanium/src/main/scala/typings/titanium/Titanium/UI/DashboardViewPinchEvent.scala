...
/**
  ...
  */
@js.native
trait DashboardViewPinchEvent extends DashboardViewBaseEvent {
...
object DashboardViewPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DashboardViewPinchEvent]
  }
  
  @scala.inline
  implicit class DashboardViewPinchEventMutableBuilder[Self <: DashboardViewPinchEvent] (val x: Self) extends AnyVal {
