...
/**
  ...
  */
@js.native
trait BlurViewTouchstartEvent extends BlurViewBaseEvent {
...
object BlurViewTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[BlurViewTouchstartEvent]
  }
  
  @scala.inline
  implicit class BlurViewTouchstartEventMutableBuilder[Self <: BlurViewTouchstartEvent] (val x: Self) extends AnyVal {
