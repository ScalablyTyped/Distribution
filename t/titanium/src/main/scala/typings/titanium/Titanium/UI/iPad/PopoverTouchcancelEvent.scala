...
/**
  ...
  */
@js.native
trait PopoverTouchcancelEvent extends PopoverBaseEvent {
...
object PopoverTouchcancelEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PopoverTouchcancelEvent]
  }
  
  @scala.inline
  implicit class PopoverTouchcancelEventMutableBuilder[Self <: PopoverTouchcancelEvent] (val x: Self) extends AnyVal {
