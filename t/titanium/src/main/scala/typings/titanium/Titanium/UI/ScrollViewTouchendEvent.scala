...
/**
  ...
  */
@js.native
trait ScrollViewTouchendEvent extends ScrollViewBaseEvent {
...
object ScrollViewTouchendEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ScrollViewTouchendEvent]
  }
  
  @scala.inline
  implicit class ScrollViewTouchendEventMutableBuilder[Self <: ScrollViewTouchendEvent] (val x: Self) extends AnyVal {
