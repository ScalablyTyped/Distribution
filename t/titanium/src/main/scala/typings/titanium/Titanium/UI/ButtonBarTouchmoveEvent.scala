...
/**
  ...
  */
@js.native
trait ButtonBarTouchmoveEvent extends ButtonBarBaseEvent {
...
object ButtonBarTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ButtonBarTouchmoveEvent]
  }
  
  @scala.inline
  implicit class ButtonBarTouchmoveEventMutableBuilder[Self <: ButtonBarTouchmoveEvent] (val x: Self) extends AnyVal {
