...
/**
  ...
  */
@js.native
trait PickerTouchstartEvent extends PickerBaseEvent {
...
object PickerTouchstartEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PickerTouchstartEvent]
  }
  
  @scala.inline
  implicit class PickerTouchstartEventMutableBuilder[Self <: PickerTouchstartEvent] (val x: Self) extends AnyVal {
