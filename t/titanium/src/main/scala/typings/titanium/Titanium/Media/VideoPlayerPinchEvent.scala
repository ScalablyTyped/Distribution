...
/**
  ...
  */
@js.native
trait VideoPlayerPinchEvent extends VideoPlayerBaseEvent {
...
object VideoPlayerPinchEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[VideoPlayerPinchEvent]
  }
  
  @scala.inline
  implicit class VideoPlayerPinchEventMutableBuilder[Self <: VideoPlayerPinchEvent] (val x: Self) extends AnyVal {
