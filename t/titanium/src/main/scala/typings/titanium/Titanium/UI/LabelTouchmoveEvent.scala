...
/**
  ...
  */
@js.native
trait LabelTouchmoveEvent extends LabelBaseEvent {
...
object LabelTouchmoveEvent {
  ...
  def apply(
    ...
    __obj.asInstanceOf[LabelTouchmoveEvent]
  }
  
  @scala.inline
  implicit class LabelTouchmoveEventMutableBuilder[Self <: LabelTouchmoveEvent] (val x: Self) extends AnyVal {
