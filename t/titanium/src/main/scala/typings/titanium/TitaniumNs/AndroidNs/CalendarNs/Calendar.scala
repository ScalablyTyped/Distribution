...
trait Calendar extends Proxy {
  ...
  /**
  				 ...
  				 */
  def createEvent(properties: js.Any): typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event
  /**
  				 * Gets the event with the specified identifier.
  				 */
  def getEventById(id: Double): typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event
  /**
  				 * Gets events that occur between two dates.
  				 */
  def getEventsBetweenDates(date1: Date, date2: Date): js.Array[typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event]
  /**
  				 * Gets events that occur on a specified date.
  				 */
  def getEventsInDate(year: Double, month: Double, day: Double): js.Array[typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event]
  /**
  				 * Gets events that occur during a specified month.
  				 */
  def getEventsInMonth(year: Double, month: Double): js.Array[typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event]
  /**
  				 * Gets all events that occur during a specified year.
  				 */
  def getEventsInYear(year: Double): js.Array[typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event]
  /**
...
object Calendar {
  ...
  def apply(
    ...
    createEvent: js.Any => typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event,
    fireEvent: (String, js.Any) => Unit,
    getApiName: () => String,
    getBubbleParent: () => Boolean,
    getEventById: Double => typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event,
    getEventsBetweenDates: (Date, Date) => js.Array[typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event],
    getEventsInDate: (Double, Double, Double) => js.Array[typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event],
    getEventsInMonth: (Double, Double) => js.Array[typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event],
    getEventsInYear: Double => js.Array[typings.titanium.TitaniumNs.AndroidNs.CalendarNs.Event],
    getHidden: () => Boolean,
    getId: () => String,
    getName: () => String,
    getSelected: () => Boolean,
