...
import typings.titanium.transitionAnimationParam
...
object ^ extends js.Object {
  ...
  /**
  			 ...
  			 */
  def createAttributedString(): typings.titanium.TitaniumNs.UINs.iOSNs.AttributedString = js.native
  def createAttributedString(parameters: js.Any): typings.titanium.TitaniumNs.UINs.iOSNs.AttributedString = js.native
  /**
  ...
  /**
  			 ...
  			 */
  def createCoverFlowView(): typings.titanium.TitaniumNs.UINs.iOSNs.CoverFlowView = js.native
  def createCoverFlowView(parameters: js.Any): typings.titanium.TitaniumNs.UINs.iOSNs.CoverFlowView = js.native
  /**
  ...
  /**
  			 ...
  			 */
  def createNavigationWindow(): typings.titanium.TitaniumNs.UINs.iOSNs.NavigationWindow = js.native
  def createNavigationWindow(parameters: js.Any): typings.titanium.TitaniumNs.UINs.iOSNs.NavigationWindow = js.native
  /**
  ...
  /**
  			 ...
  			 */
  def createTabbedBar(): typings.titanium.TitaniumNs.UINs.iOSNs.TabbedBar = js.native
  def createTabbedBar(parameters: js.Any): typings.titanium.TitaniumNs.UINs.iOSNs.TabbedBar = js.native
  /**
  			 * Creates and returns an instance of <Titanium.UI.iOS.Toolbar>.
  			 */
  def createToolbar(): typings.titanium.TitaniumNs.UINs.iOSNs.Toolbar = js.native
  def createToolbar(parameters: js.Any): typings.titanium.TitaniumNs.UINs.iOSNs.Toolbar = js.native
  /**
