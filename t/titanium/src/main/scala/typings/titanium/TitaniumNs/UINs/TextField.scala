...
trait TextField extends View {
  ...
  /**
  			 ...
  			 */
  var keyboardToolbar: js.Array[View] | typings.titanium.TitaniumNs.UINs.iOSNs.Toolbar = js.native
  /**
  ...
  /**
  			 ...
  			 */
  def getKeyboardToolbar(): js.Array[View] | typings.titanium.TitaniumNs.UINs.iOSNs.Toolbar = js.native
  /**
  ...
  /**
  			 * Sets the value of the <Titanium.UI.TextField.keyboardToolbar> property.
  			 */
  def setKeyboardToolbar(keyboardToolbar: typings.titanium.TitaniumNs.UINs.iOSNs.Toolbar): Unit = js.native
  /**
