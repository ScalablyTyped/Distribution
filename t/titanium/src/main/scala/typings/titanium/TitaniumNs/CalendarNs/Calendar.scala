...
trait Calendar extends Proxy {
  ...
  /**
  			 ...
  			 */
  def createEvent(properties: js.Any): typings.titanium.TitaniumNs.CalendarNs.Event = js.native
  /**
  			 * Gets the event with the specified identifier.
  			 */
  def getEventById(id: Double): typings.titanium.TitaniumNs.CalendarNs.Event = js.native
  def getEventsBetweenDates(date1: String, date2: String): js.Array[typings.titanium.TitaniumNs.CalendarNs.Event] = js.native
  /**
  			 * Gets events that occur between two dates.
  			 */
  def getEventsBetweenDates(date1: String, date2: Date): js.Array[typings.titanium.TitaniumNs.CalendarNs.Event] = js.native
  def getEventsBetweenDates(date1: Date, date2: String): js.Array[typings.titanium.TitaniumNs.CalendarNs.Event] = js.native
  /**
  			 * Gets events that occur between two dates.
  			 */
  def getEventsBetweenDates(date1: Date, date2: Date): js.Array[typings.titanium.TitaniumNs.CalendarNs.Event] = js.native
  /**
  			 * Gets events that occur on a specified date.
  			 */
  def getEventsInDate(year: Double, month: Double, day: Double): js.Array[typings.titanium.TitaniumNs.CalendarNs.Event] = js.native
  /**
  			 * Gets events that occur during a specified month.
  			 */
  def getEventsInMonth(year: Double, month: Double): js.Array[typings.titanium.TitaniumNs.CalendarNs.Event] = js.native
  /**
  			 * Gets all events that occur during a specified year.
  			 */
  def getEventsInYear(year: Double): js.Array[typings.titanium.TitaniumNs.CalendarNs.Event] = js.native
  /**
