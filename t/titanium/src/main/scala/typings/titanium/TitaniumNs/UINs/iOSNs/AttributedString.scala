...
trait AttributedString extends Proxy {
  /**
  				 ...
  				 */
  var attributes: js.Array[typings.titanium.TitaniumNs.UINs.iOSNs.Attribute]
  /**
  ...
  /**
  				 ...
  				 */
  def addAttribute(attribute: typings.titanium.TitaniumNs.UINs.iOSNs.Attribute): Unit
  /**
  				 * Gets the value of the <Titanium.UI.iOS.AttributedString.attributes> property.
  				 */
  def getAttributes(): js.Array[typings.titanium.TitaniumNs.UINs.iOSNs.Attribute]
  /**
  ...
  /**
  				 ...
  				 */
  def setAttributes(attributes: js.Array[typings.titanium.TitaniumNs.UINs.iOSNs.Attribute]): Unit
  /**
...
object AttributedString {
  @scala.inline
  def apply(
    addAttribute: typings.titanium.TitaniumNs.UINs.iOSNs.Attribute => Unit,
    addEventListener: (String, js.Function1[/* param0 */ js.Any, _]) => Unit,
    apiName: String,
    applyProperties: js.Any => Unit,
    attributes: js.Array[typings.titanium.TitaniumNs.UINs.iOSNs.Attribute],
    bubbleParent: Boolean,
    fireEvent: (String, js.Any) => Unit,
    getApiName: () => String,
    getAttributes: () => js.Array[typings.titanium.TitaniumNs.UINs.iOSNs.Attribute],
    getBubbleParent: () => Boolean,
    getText: () => String,
    removeEventListener: (String, js.Function1[/* param0 */ js.Any, _]) => Unit,
    setAttributes: js.Array[typings.titanium.TitaniumNs.UINs.iOSNs.Attribute] => Unit,
