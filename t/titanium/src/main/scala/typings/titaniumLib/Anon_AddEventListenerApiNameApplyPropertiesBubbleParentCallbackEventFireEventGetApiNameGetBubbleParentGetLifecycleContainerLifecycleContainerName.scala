...
@js.native
trait Anon_AddEventListenerApiNameApplyPropertiesBubbleParentCallbackEventFireEventGetApiNameGetBubbleParentGetLifecycleContainerLifecycleContainerName extends js.Object {
  /**
