...
@js.native
trait Anon_ANIMATIONCURVEEASEIN extends js.Object {
  /**
  ...
  /**
  		 ...
  		 */
  val ActivityIndicatorStyleNs: Anon_AddEventListener = js.native
  /**
  		 ...
  		 */
  val AndroidNs: Anon_AddEventListenerApiName = js.native
  /**
  ...
  /**
  		 ...
  		 */
  val ClipboardNs: Anon_AddEventListenerAllowCreation = js.native
  /**
  ...
  /**
  		 ...
  		 */
  val iPadNs: Anon_AddEventListenerApiNameApplyPropertiesBubbleParentCallbackCreateDocumentViewer = js.native
  /**
  		 ...
  		 */
  val iPhoneNs: Anon_ActivityIndicatorStyle = js.native
  /**
