...
@js.native
trait Anon_ADSIZELANDSCAPE extends js.Object {
  /**
  ...
  /**
  			 ...
  			 */
  val AlertDialogStyleNs: Anon_AddEventListenerApiNameApplyProperties = js.native
  /**
  			 ...
  			 */
  val AnimationStyleNs: Anon_AddEventListenerApiNameApplyPropertiesBubbleParent = js.native
  /**
  ...
  /**
  			 ...
  			 */
  val ProgressBarStyleNs: Anon_AddEventListenerApiNameApplyPropertiesBAR = js.native
  /**
  ...
  /**
  			 ...
  			 */
  val RowAnimationStyleNs: Anon_AddEventListenerApiNameApplyPropertiesBOTTOM = js.native
  /**
  ...
  /**
  			 ...
  			 */
  val ScrollIndicatorStyleNs: Anon_AddEventListenerApiNameApplyPropertiesBLACK = js.native
  /**
  			 * A set of constants for the status bar style.
  			 */
  val StatusBarNs: Anon_ANIMATIONSTYLEFADE = js.native
  /**
  			 * A set of constants for creating standard iOS system buttons.
  			 */
  val SystemButtonNs: Anon_ACTION = js.native
  /**
  			 * A set of constants for the system button styles that can be used for the button `style` property.
  			 */
  val SystemButtonStyleNs: Anon_AddEventListenerApiNameApplyPropertiesBORDERED = js.native
  /**
  			 * A set of constants for the system icon styles that can be used on a tab group tab.
  			 */
  val SystemIconNs: Anon_AddEventListenerApiNameApplyPropertiesBOOKMARKS = js.native
  /**
  ...
  /**
  			 ...
  			 */
  val TableViewCellSelectionStyleNs: Anon_AddEventListenerApiNameApplyPropertiesBLUE = js.native
  /**
  			 ...
  			 */
  val TableViewScrollPositionNs: Anon_AddEventListenerApiNameApplyPropertiesBOTTOMBubbleParent = js.native
  /**
  			 * A set of constants for the style that can be used for the button `style` property of
  			 * <Titanium.UI.TableView>.
  			 */
  val TableViewStyleNs: Anon_AddEventListenerApiNameApplyPropertiesBubbleParentCallback = js.native
  /**
