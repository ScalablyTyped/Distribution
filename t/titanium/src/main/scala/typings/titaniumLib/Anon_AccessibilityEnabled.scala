...
@js.native
trait Anon_AccessibilityEnabled extends js.Object {
  /**
  		 * A module used to access Android application resources.
  		 */
  val AndroidNs: Anon_AddEventListenerApiNameAppVersionCode = js.native
  /**
  ...
  /**
  		 ...
  		 */
  val PropertiesNs: Anon_AddEventListenerApiNameApplyPropertiesBubbleParentCallbackDefaultValue = js.native
  /**
  ...
  /**
  		 ...
  		 */
  val iOSNs: Anon_AddEventListenerApiNameApplicationOpenSettingsURL = js.native
  /**
