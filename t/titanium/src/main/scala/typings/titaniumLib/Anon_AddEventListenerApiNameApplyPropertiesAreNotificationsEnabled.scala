...
@js.native
trait Anon_AddEventListenerApiNameApplyPropertiesAreNotificationsEnabled extends js.Object {
  /**
  ...
  /**
  			 ...
  			 */
  def areNotificationsEnabled(): scala.Boolean = js.native
  /**
  ...
  /**
  			 ...
  			 */
  def notify(id: scala.Double, notification: titaniumLib.TitaniumNs.AndroidNs.Notification): scala.Unit = js.native
  /**
