...
@js.native
trait TypeofCodec extends js.Object {
  /**
  ...
  /**
  		 ...
  		 */
  def decodeNumber(options: DecodeNumberDict): scala.Double = js.native
  /**
  		 * Decodes the source buffer into a String using the supplied character set.
  		 */
  def decodeString(options: DecodeStringDict): java.lang.String = js.native
  /**
  		 * Encodes a number and writes it to a buffer.
  		 */
  def encodeNumber(options: EncodeNumberDict): scala.Double = js.native
  /**
