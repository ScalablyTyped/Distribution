...
@js.native
trait Anon_ACTIONAIRPLANEMODECHANGED extends js.Object {
  /**
  ...
  /**
  		 ...
  		 */
  val CalendarNs: Anon_AddEventListenerAllAlerts = js.native
  /**
  ...
  /**
  		 ...
  		 */
  val NotificationManagerNs: Anon_AddEventListenerApiNameApplyPropertiesAreNotificationsEnabled = js.native
  /**
  		 * Not used.
  		 */
  ...
  /**
  		 ...
  		 */
  val RNs: Anon_AddEventListenerAnim = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def createServiceIntent(options: ServiceIntentOptions): titaniumLib.TitaniumNs.AndroidNs.Intent = js.native
  /**
