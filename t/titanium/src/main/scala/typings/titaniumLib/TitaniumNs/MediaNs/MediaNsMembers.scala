...
@js.native
object MediaNsMembers extends js.Object {
  /**
  ...
  /**
  		 ...
  		 */
  val currentRoute: titaniumLib.RouteDescription = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def getCurrentRoute(): titaniumLib.RouteDescription = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def openMusicLibrary(options: titaniumLib.MusicLibraryOptionsType): scala.Unit = js.native
  /**
  		 * Opens the photo gallery image picker.
  		 */
  def openPhotoGallery(options: titaniumLib.PhotoGalleryOptionsType): scala.Unit = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def requestAudioPermissions(callback: js.Function1[/* param0 */ titaniumLib.MediaAuthorizationResponse, _]): scala.Unit = js.native
  /**
  		 * Request the user's permission for audio recording.
  		 */
  def requestAudioRecorderPermissions(callback: js.Function1[/* param0 */ titaniumLib.MediaAuthorizationResponse, _]): scala.Unit = js.native
  /**
  		 * Request the user's permission for audio recording.
  		 */
  def requestAuthorization(callback: js.Function1[/* param0 */ titaniumLib.MediaAuthorizationResponse, _]): scala.Unit = js.native
  /**
  		 * Requests for camera access.
  		 */
  def requestCameraAccess(callback: js.Function1[/* param0 */ titaniumLib.RequestCameraAccessResult, _]): scala.Unit = js.native
  /**
  		 * Requests for camera access.
  		 */
  def requestCameraPermissions(callback: js.Function1[/* param0 */ titaniumLib.RequestCameraAccessResult, _]): scala.Unit = js.native
  /**
  		 * Request permissions for the native music-library.
  		 */
  def requestMusicLibraryPermissions(callback: js.Function1[/* param0 */ titaniumLib.RequestMusicLibraryAccessResult, _]): scala.Unit = js.native
  /**
  		 * Requests for photo gallery permissions.
  		 */
  def requestPhotoGalleryPermissions(callback: js.Function1[/* param0 */ titaniumLib.RequestPhotoGalleryAccessResult, _]): scala.Unit = js.native
  /**
  ...
  /**
  		 * Shows the camera.
  		 */
  def showCamera(options: titaniumLib.CameraOptionsType): scala.Unit = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def takeScreenshot(callback: js.Function1[/* param0 */ titaniumLib.ScreenshotResult, _]): scala.Unit = js.native
  /**
