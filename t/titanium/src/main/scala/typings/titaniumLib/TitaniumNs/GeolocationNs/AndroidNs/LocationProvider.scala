...
object LocationProvider {
  ...
  def apply(
    ...
    __obj.updateDynamic("getMinUpdateDistance")(getMinUpdateDistance)
    __obj.updateDynamic("getMinUpdateTime")(getMinUpdateTime)
    __obj.updateDynamic("getName")(getName)
    __obj.updateDynamic("minUpdateDistance")(minUpdateDistance)
    __obj.updateDynamic("minUpdateTime")(minUpdateTime)
    __obj.updateDynamic("name")(name)
    __obj.updateDynamic("removeEventListener")(removeEventListener)
    __obj.updateDynamic("setBubbleParent")(setBubbleParent)
    __obj.updateDynamic("setMinUpdateDistance")(setMinUpdateDistance)
    __obj.updateDynamic("setMinUpdateTime")(setMinUpdateTime)
