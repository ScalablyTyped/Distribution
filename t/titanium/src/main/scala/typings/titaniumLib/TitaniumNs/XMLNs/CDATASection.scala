...
trait CDATASection
  ...
  /**
  			 ...
  			 */
  def splitText(offset: scala.Double): Text
  /**
...
object CDATASection {
  ...
  def apply(
    ...
    splitText: js.Function1[scala.Double, Text],
