...
object SearchableItem {
  ...
  def apply(
    ...
    __obj.updateDynamic("attributeSet")(attributeSet)
    __obj.updateDynamic("bubbleParent")(bubbleParent)
    __obj.updateDynamic("domainIdentifier")(domainIdentifier)
    __obj.updateDynamic("expirationDate")(expirationDate)
    __obj.updateDynamic("fireEvent")(fireEvent)
    __obj.updateDynamic("getApiName")(getApiName)
    __obj.updateDynamic("getBubbleParent")(getBubbleParent)
    __obj.updateDynamic("getDomainIdentifier")(getDomainIdentifier)
    __obj.updateDynamic("getExpirationDate")(getExpirationDate)
    __obj.updateDynamic("getUniqueIdentifier")(getUniqueIdentifier)
    __obj.updateDynamic("removeEventListener")(removeEventListener)
    __obj.updateDynamic("setBubbleParent")(setBubbleParent)
    __obj.updateDynamic("setDomainIdentifier")(setDomainIdentifier)
    __obj.updateDynamic("setExpirationDate")(setExpirationDate)
    __obj.updateDynamic("setUniqueIdentifier")(setUniqueIdentifier)
