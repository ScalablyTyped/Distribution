...
object DynamicItemBehavior {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(addAngularVelocityForItem = addAngularVelocityForItem, addEventListener = addEventListener, addItem = addItem, addLinearVelocityForItem = addLinearVelocityForItem, allowsRotation = allowsRotation, angularResistance = angularResistance, angularVelocityForItem = angularVelocityForItem, apiName = apiName, applyProperties = applyProperties, bubbleParent = bubbleParent, density = density, elasticity = elasticity, fireEvent = fireEvent, friction = friction, getAllowsRotation = getAllowsRotation, getAngularResistance = getAngularResistance, getApiName = getApiName, getBubbleParent = getBubbleParent, getDensity = getDensity, getElasticity = getElasticity, getFriction = getFriction, getItems = getItems, getResistance = getResistance, items = items, linearVelocityForItem = linearVelocityForItem, removeEventListener = removeEventListener, removeItem = removeItem, resistance = resistance, setAllowsRotation = setAllowsRotation, setAngularResistance = setAngularResistance, setBubbleParent = setBubbleParent, setDensity = setDensity, setElasticity = setElasticity, setFriction = setFriction, setResistance = setResistance)
