...
object UserActivity {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(activityType = activityType, addContentAttributeSet = js.Any.fromFunction1(addContentAttributeSet), addEventListener = js.Any.fromFunction2(addEventListener), apiName = apiName, applyProperties = js.Any.fromFunction1(applyProperties), becomeCurrent = js.Any.fromFunction0(becomeCurrent), bubbleParent = bubbleParent, eligibleForHandoff = eligibleForHandoff, eligibleForPublicIndexing = eligibleForPublicIndexing, eligibleForSearch = eligibleForSearch, expirationDate = expirationDate, fireEvent = js.Any.fromFunction2(fireEvent), getActivityType = js.Any.fromFunction0(getActivityType), getApiName = js.Any.fromFunction0(getApiName), getBubbleParent = js.Any.fromFunction0(getBubbleParent), getEligibleForHandoff = js.Any.fromFunction0(getEligibleForHandoff), getEligibleForPublicIndexing = js.Any.fromFunction0(getEligibleForPublicIndexing), getEligibleForSearch = js.Any.fromFunction0(getEligibleForSearch), getExpirationDate = js.Any.fromFunction0(getExpirationDate), getKeywords = js.Any.fromFunction0(getKeywords), getNeedsSave = js.Any.fromFunction0(getNeedsSave), getRequiredUserInfoKeys = js.Any.fromFunction0(getRequiredUserInfoKeys), getSupported = js.Any.fromFunction0(getSupported), getTitle = js.Any.fromFunction0(getTitle), getUserInfo = js.Any.fromFunction0(getUserInfo), getWebpageURL = js.Any.fromFunction0(getWebpageURL), invalidate = js.Any.fromFunction0(invalidate), isSupported = js.Any.fromFunction0(isSupported), keywords = keywords, needsSave = needsSave, removeEventListener = js.Any.fromFunction2(removeEventListener), requiredUserInfoKeys = requiredUserInfoKeys, resignCurrent = js.Any.fromFunction0(resignCurrent), setActivityType = js.Any.fromFunction1(setActivityType), setBubbleParent = js.Any.fromFunction1(setBubbleParent), setEligibleForHandoff = js.Any.fromFunction1(setEligibleForHandoff), setEligibleForPublicIndexing = js.Any.fromFunction1(setEligibleForPublicIndexing), setEligibleForSearch = js.Any.fromFunction1(setEligibleForSearch), setExpirationDate = js.Any.fromFunction1(setExpirationDate), setKeywords = js.Any.fromFunction1(setKeywords), setNeedsSave = js.Any.fromFunction1(setNeedsSave), setRequiredUserInfoKeys = js.Any.fromFunction1(setRequiredUserInfoKeys), setSupported = js.Any.fromFunction1(setSupported), setTitle = js.Any.fromFunction1(setTitle), setUserInfo = js.Any.fromFunction1(setUserInfo), setWebpageURL = js.Any.fromFunction1(setWebpageURL), supported = supported, title = title, userInfo = userInfo, webpageURL = webpageURL)
