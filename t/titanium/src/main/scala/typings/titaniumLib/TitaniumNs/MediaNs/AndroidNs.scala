...
object AndroidNs extends js.Object {
  ...
  def scanMediaFiles(
    ...
    callback: js.Function1[/* param0 */ titaniumLib.MediaScannerResponse, _]
  ...
  /**
  			 ...
  			 */
  def setSystemWallpaper(image: titaniumLib.TitaniumNs.Blob, scale: scala.Boolean): scala.Unit = js.native
}
