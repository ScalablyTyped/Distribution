...
object NotificationChannel {
  ...
  def apply(
    ...
    __obj.updateDynamic("bypassDnd")(bypassDnd)
    __obj.updateDynamic("description")(description)
    __obj.updateDynamic("enableLights")(enableLights)
    __obj.updateDynamic("enableVibration")(enableVibration)
    __obj.updateDynamic("fireEvent")(fireEvent)
    __obj.updateDynamic("getApiName")(getApiName)
    __obj.updateDynamic("getBubbleParent")(getBubbleParent)
    __obj.updateDynamic("getBypassDnd")(getBypassDnd)
    __obj.updateDynamic("getDescription")(getDescription)
    __obj.updateDynamic("getEnableLights")(getEnableLights)
    __obj.updateDynamic("getEnableVibration")(getEnableVibration)
    __obj.updateDynamic("getGroupId")(getGroupId)
    __obj.updateDynamic("getId")(getId)
    __obj.updateDynamic("getImportance")(getImportance)
    __obj.updateDynamic("getLightColor")(getLightColor)
    __obj.updateDynamic("getLockscreenVisibility")(getLockscreenVisibility)
    __obj.updateDynamic("getShowBadge")(getShowBadge)
    __obj.updateDynamic("getVibratePattern")(getVibratePattern)
    ...
    __obj.updateDynamic("lockscreenVisibility")(lockscreenVisibility)
    __obj.updateDynamic("removeEventListener")(removeEventListener)
    __obj.updateDynamic("setBubbleParent")(setBubbleParent)
    __obj.updateDynamic("setBypassDnd")(setBypassDnd)
    __obj.updateDynamic("setDescription")(setDescription)
    __obj.updateDynamic("setEnableLights")(setEnableLights)
    __obj.updateDynamic("setEnableVibration")(setEnableVibration)
    __obj.updateDynamic("setGroupId")(setGroupId)
    __obj.updateDynamic("setId")(setId)
    __obj.updateDynamic("setImportance")(setImportance)
    __obj.updateDynamic("setLightColor")(setLightColor)
    __obj.updateDynamic("setLockscreenVisibility")(setLockscreenVisibility)
    __obj.updateDynamic("setShowBadge")(setShowBadge)
    __obj.updateDynamic("setVibratePattern")(setVibratePattern)
    __obj.updateDynamic("showBadge")(showBadge)
    __obj.updateDynamic("vibratePattern")(vibratePattern)
