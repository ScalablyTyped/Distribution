...
@js.native
object AlertDialogStyleNs extends js.Object {
  /**
  ...
  /**
  				 ...
  				 */
  val LOGIN_AND_PASSWORD_INPUT: scala.Double = js.native
  /**
  				 * An alert dialog that allows the user to enter text.
  				 */
  val PLAIN_TEXT_INPUT: scala.Double = js.native
  /**
  				 * An alert dialog that allows the user to enter text. The text field is obscured.
  				 */
  val SECURE_TEXT_INPUT: scala.Double = js.native
  /**
