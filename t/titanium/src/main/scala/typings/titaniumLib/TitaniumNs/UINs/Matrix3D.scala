...
object Matrix3D {
  ...
  def apply(
    ...
    rotate: (scala.Double, scala.Double, scala.Double, scala.Double) => Matrix3D,
    scale: (scala.Double, scala.Double, scala.Double) => Matrix3D,
    ...
    translate: (scala.Double, scala.Double, scala.Double) => Matrix3D,
