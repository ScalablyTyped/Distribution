...
object Alert {
  ...
  def apply(
    ...
    __obj.updateDynamic("absoluteDate")(absoluteDate)
    ...
    __obj.updateDynamic("getAbsoluteDate")(getAbsoluteDate)
    ...
    __obj.updateDynamic("getRelativeOffset")(getRelativeOffset)
    __obj.updateDynamic("getState")(getState)
    __obj.updateDynamic("id")(id)
    __obj.updateDynamic("minutes")(minutes)
    __obj.updateDynamic("relativeOffset")(relativeOffset)
    __obj.updateDynamic("removeEventListener")(removeEventListener)
    __obj.updateDynamic("setAbsoluteDate")(setAbsoluteDate)
    __obj.updateDynamic("setBubbleParent")(setBubbleParent)
    __obj.updateDynamic("setRelativeOffset")(setRelativeOffset)
