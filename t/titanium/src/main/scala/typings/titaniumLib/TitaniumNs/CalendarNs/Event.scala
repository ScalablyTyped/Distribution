...
object Event {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(addEventListener = addEventListener, addRecurrenceRule = addRecurrenceRule, alerts = alerts, allDay = allDay, apiName = apiName, applyProperties = applyProperties, attendees = attendees, availability = availability, begin = begin, bubbleParent = bubbleParent, createAlert = createAlert, createRecurrenceRule = createRecurrenceRule, createReminder = createReminder, description = description, end = end, extendedProperties = extendedProperties, fireEvent = fireEvent, getAlerts = getAlerts, getAllDay = getAllDay, getApiName = getApiName, getAttendees = getAttendees, getAvailability = getAvailability, getBegin = getBegin, getBubbleParent = getBubbleParent, getDescription = getDescription, getEnd = getEnd, getExtendedProperties = getExtendedProperties, getExtendedProperty = getExtendedProperty, getHasAlarm = getHasAlarm, getId = getId, getIsDetached = getIsDetached, getLocation = getLocation, getNotes = getNotes, getRecurrenceRules = getRecurrenceRules, getReminders = getReminders, getStatus = getStatus, getTitle = getTitle, getVisibility = getVisibility, hasAlarm = hasAlarm, id = id, isDetached = isDetached, location = location, notes = notes, recurrenceRules = recurrenceRules, refresh = refresh, reminders = reminders, remove = remove, removeEventListener = removeEventListener, removeRecurrenceRule = removeRecurrenceRule, save = save, setAlerts = setAlerts, setAllDay = setAllDay, setBegin = setBegin, setBubbleParent = setBubbleParent, setEnd = setEnd, setExtendedProperty = setExtendedProperty, setLocation = setLocation, setNotes = setNotes, setRecurrenceRules = setRecurrenceRules, setTitle = setTitle, status = status, title = title, visibility = visibility)
