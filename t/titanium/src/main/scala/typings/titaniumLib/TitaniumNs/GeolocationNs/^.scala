package typings
package titaniumLib.TitaniumNs.GeolocationNs
...
object ^ extends js.Object {
  ...
  def forwardGeocoder(
    ...
    callback: js.Function1[/* param0 */ titaniumLib.ForwardGeocodeResponse, _]
  ...
  /**
  		 ...
  		 */
  def getCurrentHeading(callback: js.Function1[/* param0 */ titaniumLib.HeadingResponse, _]): scala.Unit = js.native
  /**
  		 * Retrieves the last known location from the device.
  		 */
  def getCurrentPosition(callback: js.Function1[/* param0 */ titaniumLib.LocationResults, _]): scala.Unit = js.native
  /**
  ...
  def requestLocationPermissions(
    ...
    callback: js.Function1[/* param0 */ titaniumLib.LocationAuthorizationResponse, _]
  ): scala.Unit = js.native
  /**
  ...
  def reverseGeocoder(
    ...
    callback: js.Function1[/* param0 */ titaniumLib.ReverseGeocodeResponse, _]
  ): scala.Unit = js.native
  /**
