...
object StreamNs extends js.Object {
  ...
  /**
  		 ...
  		 */
  def createStream(params: titaniumLib.CreateStreamArgs): titaniumLib.TitaniumNs.IOStream = js.native
  /**
  ...
  def writeStream(
    ...
    outputStream: titaniumLib.TitaniumNs.IOStream,
    maxChunkSize: scala.Double,
    resultsCallback: js.Function1[/* param0 */ titaniumLib.WriteStreamCallbackArgs, _]
  ): scala.Unit = js.native
}
