...
@js.native
trait Anon_ATTENDEEROLECHAIR extends js.Object {
  /**
  ...
  /**
  		 ...
  		 */
  def requestCalendarPermissions(callback: js.Function1[/* param0 */ EventsAuthorizationResponse, _]): scala.Unit = js.native
  /**
  		 * If authorization is unknown, will bring up a dialog requesting permission.
  		 */
  def requestEventsAuthorization(callback: js.Function1[/* param0 */ EventsAuthorizationResponse, _]): scala.Unit = js.native
  /**
