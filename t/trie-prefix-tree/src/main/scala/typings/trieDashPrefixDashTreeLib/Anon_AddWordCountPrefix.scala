...
trait Anon_AddWordCountPrefix extends js.Object {
  /**
    ...
    */
  def addWord(word: java.lang.String): stdLib.ReturnType[js.Function1[/* strings */ js.Array[java.lang.String], Anon_AddWord]] = js.native
  /**
  ...
  /**
    ...
    */
  def removeWord(word: java.lang.String): stdLib.ReturnType[js.Function1[/* strings */ js.Array[java.lang.String], Anon_AddWord]] = js.native
  /**
