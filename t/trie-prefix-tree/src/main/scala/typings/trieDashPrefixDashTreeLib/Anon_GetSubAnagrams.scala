...
@js.native
trait Anon_GetSubAnagrams extends js.Object {
  /**
    * Add a new word to the trie
    */
  def addWord(word: java.lang.String): stdLib.ReturnType[
    /* import warning: ImportType.apply Failed type conversion: typeof trie-prefix-tree.trie-prefix-tree.Trie */ js.Any
  ] = js.native
  /**
