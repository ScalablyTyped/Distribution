...
@js.native
trait Anon_AddWordCountPrefix extends js.Object {
  /**
    * Add a new word to the trie
    */
  def addWord(word: String): ReturnType[js.Function1[/* strings */ js.Array[String], Anon_AddWord]] = js.native
  /**
  ...
  /**
    ...
    */
  def removeWord(word: String): ReturnType[js.Function1[/* strings */ js.Array[String], Anon_AddWord]] = js.native
  /**
