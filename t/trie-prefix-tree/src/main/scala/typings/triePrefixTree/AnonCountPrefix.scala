...
@js.native
trait AnonCountPrefix extends js.Object {
  /**
    * Add a new word to the trie
    */
  def addWord(word: String): ReturnType[js.Function1[/* strings */ js.Array[String], AnonAddWord]] = js.native
  /**
  ...
  /**
    ...
    */
  def removeWord(word: String): ReturnType[js.Function1[/* strings */ js.Array[String], AnonAddWord]] = js.native
  /**
