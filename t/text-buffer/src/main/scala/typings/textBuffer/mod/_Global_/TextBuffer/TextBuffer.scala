...
import typings.textBuffer.mod._Global_.TextBuffer.Events.BufferChanged
import typings.textBuffer.mod._Global_.TextBuffer.Events.BufferChanging
import typings.textBuffer.mod._Global_.TextBuffer.Events.BufferStoppedChanging
import typings.textBuffer.mod._Global_.TextBuffer.Events.BufferWatchError
import typings.textBuffer.mod._Global_.TextBuffer.Events.FileSaved
import typings.textBuffer.mod._Global_.TextBuffer.Options.FindMarker
import typings.textBuffer.mod._Global_.TextBuffer.Options.ScanContext
import typings.textBuffer.mod._Global_.TextBuffer.Structures.BufferScanResult
import typings.textBuffer.mod._Global_.TextBuffer.Structures.ContextualBufferScanResult
...
trait TextBuffer extends js.Object {
  ...
  def addMarkerLayer(options: AnonMaintainHistory): MarkerLayer = js.native
  /** Append text to the end of the buffer. */
  def append(text: String): Range = js.native
  def append(text: String, options: AnonNormalizeLineEndings): Range = js.native
  /**
  ...
  def insert(position: PointCompatible, text: String, options: AnonNormalizeLineEndings): Range = js.native
  ...
  def release(): typings.textBuffer.mod._Global_.TextBuffer.TextBuffer = js.native
  ...
  def retain(): typings.textBuffer.mod._Global_.TextBuffer.TextBuffer = js.native
  /**
  ...
  def setTextInRange(range: RangeCompatible, text: String, options: AnonNormalizeLineEndings): Range = js.native
  /**
