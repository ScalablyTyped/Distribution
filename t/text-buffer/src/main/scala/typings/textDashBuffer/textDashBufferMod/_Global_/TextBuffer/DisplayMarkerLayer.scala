...
import typings.textDashBuffer.Anon_BackwardClipDirectionClosest
import typings.textDashBuffer.Anon_BackwardClipDirectionClosestExclusive
...
trait DisplayMarkerLayer extends js.Object {
  ...
  def markBufferPosition(bufferPosition: PointCompatible, options: Anon_ExclusiveInsideInvalidate): DisplayMarker = js.native
  /** Create a marker with the given buffer range. */
  def markBufferRange(range: RangeCompatible): DisplayMarker = js.native
  def markBufferRange(range: RangeCompatible, options: Anon_ExclusiveInside): DisplayMarker = js.native
  /**
  ...
  def markScreenPosition(screenPosition: PointCompatible, options: Anon_BackwardClipDirectionClosestExclusive): DisplayMarker = js.native
  // Marker creation
  /** Create a marker with the given screen range. */
  def markScreenRange(range: RangeCompatible): DisplayMarker = js.native
  def markScreenRange(range: RangeCompatible, options: Anon_BackwardClipDirectionClosest): DisplayMarker = js.native
  /**
