...
import typings.textDashBuffer.textDashBufferMod.Global.TextBufferNs.OptionsNs.BufferLoad
...
Instantiable0[TextBuffer]
     with /** Create a new buffer with the given starting text. */
Instantiable1[(/* params */ Anon_ShouldDestroyOnFileDelete) | (/* text */ String), TextBuffer] {
  ...
  def load(source: String): js.Promise[TextBuffer] = js.native
  def load(source: String, params: BufferLoad): js.Promise[TextBuffer] = js.native
  /**
  ...
  def loadSync(filePath: String, params: BufferLoad): TextBuffer = js.native
}
