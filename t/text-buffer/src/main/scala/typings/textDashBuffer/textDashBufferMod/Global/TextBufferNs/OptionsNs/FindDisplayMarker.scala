...
import typings.textDashBuffer.textDashBufferMod.Global.TextBufferNs.PointCompatible
import typings.textDashBuffer.textDashBufferMod.Global.TextBufferNs.RangeCompatible
