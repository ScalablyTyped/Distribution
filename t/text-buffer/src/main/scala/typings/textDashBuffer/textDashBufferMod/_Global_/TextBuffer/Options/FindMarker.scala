...
import typings.textDashBuffer.textDashBufferMod._Global_.TextBuffer.PointCompatible
import typings.textDashBuffer.textDashBufferMod._Global_.TextBuffer.RangeCompatible
