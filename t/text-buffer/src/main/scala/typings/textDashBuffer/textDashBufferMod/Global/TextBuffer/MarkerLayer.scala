...
import typings.textDashBuffer.textDashBufferMod.Global.TextBuffer.Options.FindMarker
...
trait MarkerLayer extends js.Object {
  ...
  def markRange(range: RangeCompatible, options: Anon_ExclusiveInside): Marker = js.native
  /**
