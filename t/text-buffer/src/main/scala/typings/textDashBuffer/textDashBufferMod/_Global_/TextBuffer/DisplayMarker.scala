...
import typings.textDashBuffer.Anon_Backward
import typings.textDashBuffer.Anon_BackwardClipDirection
import typings.textDashBuffer.Anon_Reversed
import typings.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Events.DisplayMarkerChanged
import typings.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Options.CopyMarker
import typings.textDashBuffer.textDashBufferMod._Global_.TextBuffer.Options.FindDisplayMarker
...
trait DisplayMarker extends js.Object {
  ...
  def getEndScreenPosition(options: Anon_BackwardClipDirection): Point = js.native
  /** Retrieves the buffer position of the marker's head. */
  def getHeadBufferPosition(): Point = js.native
  /** Retrieves the screen position of the marker's head. */
  def getHeadScreenPosition(): Point = js.native
  def getHeadScreenPosition(options: Anon_BackwardClipDirection): Point = js.native
  /**
  ...
  def getStartScreenPosition(options: Anon_BackwardClipDirection): Point = js.native
  /** Retrieves the buffer position of the marker's tail. */
  def getTailBufferPosition(): Point = js.native
  /** Retrieves the screen position of the marker's tail. */
  def getTailScreenPosition(): Point = js.native
  def getTailScreenPosition(options: Anon_BackwardClipDirection): Point = js.native
  ...
  def setBufferRange(bufferRange: RangeCompatible, properties: Anon_Reversed): Unit = js.native
  ...
  def setHeadScreenPosition(screenPosition: PointCompatible, options: Anon_BackwardClipDirection): Unit = js.native
  ...
  def setScreenRange(screenRange: RangeCompatible, options: Anon_Backward): Unit = js.native
  ...
  def setTailScreenPosition(screenPosition: PointCompatible, options: Anon_BackwardClipDirection): Unit = js.native
}
