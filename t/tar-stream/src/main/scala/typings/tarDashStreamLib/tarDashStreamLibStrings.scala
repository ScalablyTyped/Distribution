...
object tarDashStreamLibStrings {
  @js.native
  ...
  @js.native
  sealed trait `gnu-long-link-path` extends js.Object
  
  @js.native
  sealed trait `gnu-long-path` extends js.Object
  
  @js.native
  sealed trait link extends js.Object
  
  @js.native
  sealed trait `pax-global-header` extends js.Object
  
  @js.native
  sealed trait `pax-header` extends js.Object
