...
object torrentDashSearchDashApiModMembers extends js.Object {
  ...
  def downloadTorrent(torrent: Torrent): js.Promise[java.lang.String] = js.native
  def downloadTorrent(torrent: Torrent, filenamePath: java.lang.String): js.Promise[java.lang.String] = js.native
  ...
  def getMagnet(torrent: Torrent): js.Promise[java.lang.String] = js.native
  ...
  def getTorrentDetails(torrent: Torrent): js.Promise[java.lang.String] = js.native
  ...
  def overrideConfig(providerName: java.lang.String, newConfig: TorrentProvider): js.Promise[java.lang.String] = js.native
  ...
  def search(query: java.lang.String, category: java.lang.String, limit: scala.Double): js.Promise[js.Array[Torrent]] = js.native
}
