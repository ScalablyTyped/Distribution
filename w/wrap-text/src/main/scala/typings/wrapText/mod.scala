...
object mod {
  ...
  inline def apply(input: String, width: Double): String = (^.asInstanceOf[js.Dynamic].apply(input.asInstanceOf[js.Any], width.asInstanceOf[js.Any])).asInstanceOf[String]
  
  @JSImport("wrap-text", JSImport.Namespace)
  @js.native
