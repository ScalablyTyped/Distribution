...
import typings.weappDashApi.Anon_Scale
import typings.weappDashApi.Anon_TapIndex
import typings.weappDashApi.weappDashApiMod.wxNs.AccelerometerChangeCallback
import typings.weappDashApi.weappDashApiMod.wxNs.AccelerometerData
import typings.weappDashApi.weappDashApiMod.wxNs.AccountInfo
import typings.weappDashApi.weappDashApiMod.wxNs.ActionSheetOptions
import typings.weappDashApi.weappDashApiMod.wxNs.ActionSheetSuccessCallback
import typings.weappDashApi.weappDashApiMod.wxNs.Animate
import typings.weappDashApi.weappDashApiMod.wxNs.Animation
import typings.weappDashApi.weappDashApiMod.wxNs.AnimationAction
import typings.weappDashApi.weappDashApiMod.wxNs.AnimationActionOption
import typings.weappDashApi.weappDashApiMod.wxNs.AnimationTransition
import typings.weappDashApi.weappDashApiMod.wxNs.Animator
import typings.weappDashApi.weappDashApiMod.wxNs.AuthSetting
import typings.weappDashApi.weappDashApiMod.wxNs.AuthorizeOptions
import typings.weappDashApi.weappDashApiMod.wxNs.BackgroundAudioPlayerState
import typings.weappDashApi.weappDashApiMod.wxNs.CameraDevice
import typings.weappDashApi.weappDashApiMod.wxNs.CanvasAction
import typings.weappDashApi.weappDashApiMod.wxNs.CanvasContext
import typings.weappDashApi.weappDashApiMod.wxNs.ChooseImageOptions
import typings.weappDashApi.weappDashApiMod.wxNs.ChooseVideoOptions
import typings.weappDashApi.weappDashApiMod.wxNs.CommonCallbackOptions
import typings.weappDashApi.weappDashApiMod.wxNs.CompassChangeCallback
import typings.weappDashApi.weappDashApiMod.wxNs.CompassData
import typings.weappDashApi.weappDashApiMod.wxNs.ConnectSocketOptions
import typings.weappDashApi.weappDashApiMod.wxNs.CreateAnimationOptions
import typings.weappDashApi.weappDashApiMod.wxNs.DataResponse
import typings.weappDashApi.weappDashApiMod.wxNs.DataResponseCallback
import typings.weappDashApi.weappDashApiMod.wxNs.DownloadFileOptions
import typings.weappDashApi.weappDashApiMod.wxNs.DownloadTask
import typings.weappDashApi.weappDashApiMod.wxNs.DrawCanvasOptions
import typings.weappDashApi.weappDashApiMod.wxNs.ErrorCallback
import typings.weappDashApi.weappDashApiMod.wxNs.FontDescOptions
import typings.weappDashApi.weappDashApiMod.wxNs.FontFaceOptions
import typings.weappDashApi.weappDashApiMod.wxNs.GetBackgroundAudioPlayerStateOptions
import typings.weappDashApi.weappDashApiMod.wxNs.GetBackgroundAudioPlayerStateSuccessCallback
import typings.weappDashApi.weappDashApiMod.wxNs.GetCenterLocationSuccCbOptions
import typings.weappDashApi.weappDashApiMod.wxNs.GetLocationOptions
import typings.weappDashApi.weappDashApiMod.wxNs.GetNetworkTypeOptions
import typings.weappDashApi.weappDashApiMod.wxNs.GetReginOptions
import typings.weappDashApi.weappDashApiMod.wxNs.GetReginSuccessCallbackOptions
import typings.weappDashApi.weappDashApiMod.wxNs.GetScaleOptions
import typings.weappDashApi.weappDashApiMod.wxNs.GetStorageOptions
import typings.weappDashApi.weappDashApiMod.wxNs.GetSystemInfoOptions
import typings.weappDashApi.weappDashApiMod.wxNs.GetUserInfoOptions
...
import typings.weappDashApi.weappDashApiMod.wxNs.LoadingOptions
import typings.weappDashApi.weappDashApiMod.wxNs.LocationBaseOptions
import typings.weappDashApi.weappDashApiMod.wxNs.LocationData
import typings.weappDashApi.weappDashApiMod.wxNs.LoginOptions
import typings.weappDashApi.weappDashApiMod.wxNs.LoginResponse
import typings.weappDashApi.weappDashApiMod.wxNs.ModalOptions
import typings.weappDashApi.weappDashApiMod.wxNs.NavigateBackMiniProgramOptions
import typings.weappDashApi.weappDashApiMod.wxNs.NavigateBackOptions
import typings.weappDashApi.weappDashApiMod.wxNs.NavigateToMiniProgramOptions
import typings.weappDashApi.weappDashApiMod.wxNs.NavigationBarColorAnimationOptions
import typings.weappDashApi.weappDashApiMod.wxNs.NavigationBarTitleOptions
import typings.weappDashApi.weappDashApiMod.wxNs.NetworkTypeData
import typings.weappDashApi.weappDashApiMod.wxNs.NoneParamCallback
import typings.weappDashApi.weappDashApiMod.wxNs.OnProgressCallbackOptions
import typings.weappDashApi.weappDashApiMod.wxNs.OneParamCallback
import typings.weappDashApi.weappDashApiMod.wxNs.OpenLocationOptions
import typings.weappDashApi.weappDashApiMod.wxNs.PaymentSignType
import typings.weappDashApi.weappDashApiMod.wxNs.PlayBackgroundAudioOptions
import typings.weappDashApi.weappDashApiMod.wxNs.PlayVoiceOptions
import typings.weappDashApi.weappDashApiMod.wxNs.PreviewImageOptions
import typings.weappDashApi.weappDashApiMod.wxNs.RequestHeader
import typings.weappDashApi.weappDashApiMod.wxNs.RequestOptions
import typings.weappDashApi.weappDashApiMod.wxNs.RequestPaymentOptions
import typings.weappDashApi.weappDashApiMod.wxNs.RequestTask
import typings.weappDashApi.weappDashApiMod.wxNs.ResponseCallback
import typings.weappDashApi.weappDashApiMod.wxNs.SaveFileOptions
import typings.weappDashApi.weappDashApiMod.wxNs.SavedFileData
import typings.weappDashApi.weappDashApiMod.wxNs.Scope
import typings.weappDashApi.weappDashApiMod.wxNs.SeekBackgroundAudioOptions
import typings.weappDashApi.weappDashApiMod.wxNs.SendSocketMessageOptions
import typings.weappDashApi.weappDashApiMod.wxNs.SetNavigationBarTitleOptions
import typings.weappDashApi.weappDashApiMod.wxNs.SetStorageOptions
import typings.weappDashApi.weappDashApiMod.wxNs.SettingOptions
import typings.weappDashApi.weappDashApiMod.wxNs.StartRecordOptions
import typings.weappDashApi.weappDashApiMod.wxNs.StorageInfo
import typings.weappDashApi.weappDashApiMod.wxNs.StorageInfoCallback
import typings.weappDashApi.weappDashApiMod.wxNs.StorageInfoOptions
import typings.weappDashApi.weappDashApiMod.wxNs.SystemInfo
import typings.weappDashApi.weappDashApiMod.wxNs.TabBarAnimationOptions
import typings.weappDashApi.weappDashApiMod.wxNs.TabBarBadgeOptions
import typings.weappDashApi.weappDashApiMod.wxNs.TabBarItemOptions
import typings.weappDashApi.weappDashApiMod.wxNs.TabBarRedDotOptions
import typings.weappDashApi.weappDashApiMod.wxNs.TempFileResponse
import typings.weappDashApi.weappDashApiMod.wxNs.TempFileResponseCallback
import typings.weappDashApi.weappDashApiMod.wxNs.TempFilesData
import typings.weappDashApi.weappDashApiMod.wxNs.TimingFunction
import typings.weappDashApi.weappDashApiMod.wxNs.ToastOptions
import typings.weappDashApi.weappDashApiMod.wxNs.UpdateManager
import typings.weappDashApi.weappDashApiMod.wxNs.UploadFileOptions
import typings.weappDashApi.weappDashApiMod.wxNs.UploadTask
import typings.weappDashApi.weappDashApiMod.wxNs.UserInfo
import typings.weappDashApi.weappDashApiMod.wxNs.UserInfoResponse
import typings.weappDashApi.weappDashApiMod.wxNs.VideoData
import typings.weappDashApi.weappDashApiMod.wxNs.VideoSourceType
import typings.weappDashApi.weappDashApiMod.wxNs.onLaunchCallback
import typings.weappDashApi.weappDashApiMod.wxNs.onLaunchOptions
import typings.weappDashApi.weappDashApiMod.wxNs.onShowOptions
import typings.weappDashApi.weappDashApiMod.wxNs.routerOptions
import typings.weappDashApi.weappDashApiMod.wxNs.translateMarkerOptions
import typings.weappDashApi.weappDashApiMod.wxNs.zoomPointsOptions
...
object wxNs extends js.Object {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.weappDashApi.weappDashApiStrings.front
    - typings.weappDashApi.weappDashApiStrings.back
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.weappDashApi.weappDashApiStrings.original
    - typings.weappDashApi.weappDashApiStrings.compressed
  */
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.weappDashApi.weappDashApiStrings.butt
    - typings.weappDashApi.weappDashApiStrings.round
    - typings.weappDashApi.weappDashApiStrings.square
  */
  ...
  */
  ...
  trait NavigateToMiniProgramOptions extends CommonCallbackOptions {
    ...
    var envVersion: js.UndefOr[typings.weappDashApi.weappDashApiMod.wxNs.envVersion] = js.undefined
  ...
  */
  ...
  trait ToastOptions extends CommonCallbackOptions {
    ...
    var duration: js.UndefOr[Double] = js.undefined
    // 图标，默认值'success'
    var icon: js.UndefOr[typings.weappDashApi.weappDashApiMod.wxNs.icon] = js.undefined
  ...
  */
  ...
  trait onLaunchOptions extends js.Object {
    ...
    var referrerInfo: typings.weappDashApi.weappDashApiMod.wxNs.referrerInfo
    /** 启动小程序的场景值 */
    var scene: Double
  ...
  /**
    *  检查登录态是否过期。
    */
  def checkSession(options: CommonCallbackOptions): Unit = js.native
  /**
    * 从本地相册选择图片或使用相机拍照。
    */
  ...
  /**
    ...
    */
  def getSetting(options: SettingOptions): Unit = js.native
  /**
  ...
  /**
    ...
    * @param options
    */
  def getStorageInfo(options: StorageInfoOptions): Unit = js.native
  /**
    * getStorageInfo的同步版本
    */
  ...
  def hideLoading(options: CommonCallbackOptions): Unit = js.native
  /**
    * 在当前页面隐藏导航条加载动画
    */
  /**
  ...
  def hideNavigationBarLoading(options: CommonCallbackOptions): Unit = js.native
  /**
    * 隐藏tabBar
    */
  def hideTabBar(options: TabBarAnimationOptions): Unit = js.native
  /**
    * 隐藏 tabBar 某一项的右上角的红点
    * @param options
    */
  def hideTabBarRedDot(options: TabBarBadgeOptions): Unit = js.native
  /**
    * 隐藏消息提示框
    * @param options
    */
  def hideToast(): Unit = js.native
  def hideToast(options: CommonCallbackOptions): Unit = js.native
  def loadFontFace(options: FontFaceOptions): Unit = js.native
  /**
  ...
  /**
    ...
    * @param options
    */
  def navigateTo(options: routerOptions): Unit = js.native
  /**
    * 打开另一个小程序
    */
  ...
  /**
    ...
    * @param callback
    */
  def onAppShow(callback: onShowOptions): Unit = js.native
  /** 监听音乐暂停。 */
  def onBackgroundAudioPause(callback: NoneParamCallback): Unit = js.native
  /** 监听音乐播放。 */
  def onBackgroundAudioPlay(callback: NoneParamCallback): Unit = js.native
  /** 监听音乐停止。 */
  def onBackgroundAudioStop(callback: NoneParamCallback): Unit = js.native
  ...
  /** 监听WebSocket关闭。 */
  def onSocketClose(callback: ResponseCallback): Unit = js.native
  /** 监听WebSocket错误。 */
  def onSocketError(callback: ErrorCallback): Unit = js.native
  /**
    * 监听WebSocket接受到服务器的消息事件。
    */
  def onSocketMessage(callback: DataResponseCallback): Unit = js.native
  /** 监听WebSocket连接打开事件。 */
  def onSocketOpen(callback: OneParamCallback): Unit = js.native
  /**
    * 使用微信内置地图查看位置
    */
  ...
  /**
    ...
    */
  def openSetting(options: SettingOptions): Unit = js.native
  /**
    * 将页面滚动到
    */
  ...
  /**
    * 关闭所有页面，打开到应用内的某个页面
    */
  def reLaunch(options: routerOptions): Unit = js.native
  /**
    * 关闭当前页面，跳转到应用内的某个页面。但是不允许跳转到 tabbar 页面。
    */
  def redirectTo(options: routerOptions): Unit = js.native
  /**
    * 移除 tabBar 某一项右上角的文本
    * @param options
    */
  def removeTabBarBadge(options: TabBarRedDotOptions): Unit = js.native
  /**
  ...
  /**
    ...
    * @param options
    */
  def setNavigationBarTitle(options: NavigationBarTitleOptions): Unit = js.native
  /**
    * 动态设置当前页面的标题。
    */
  ...
  /**
    ...
    * @param options
    */
  def setTabBarBadge(options: TabBarBadgeOptions): Unit = js.native
  /**
    * 动态设置 tabBar 某一项的内容
    * @param options
    */
  def setTabBarItem(options: TabBarItemOptions): Unit = js.native
  /**
    * 动态设置tabBar的整体样式
    */
  def setTabBarStyle(options: TabBarItemOptions): Unit = js.native
  /**
    * 显示操作菜单
    */
  ...
  /**
    * 在当前页面显示导航条加载动画
    */
  def showNavigationBarLoading(options: CommonCallbackOptions): Unit = js.native
  /**
    * 显示tabBar
    */
  def showTabBar(options: TabBarAnimationOptions): Unit = js.native
  /**
    * 显示 tabBar 某一项的右上角的红点
    * @param options
    */
  def showTabBarRedDot(options: TabBarRedDotOptions): Unit = js.native
  /**
    * 显示消息提示框
    * @param options
    */
  ...
  def startPullDownRefresh(options: CommonCallbackOptions): Unit = js.native
  /**
  ...
  def stopPullDownRefresh(options: CommonCallbackOptions): Unit = js.native
  /**
    * ​ 主动调用停止录音。
    */
  ...
  /**
    ...
    * @param options
    */
  def switchTab(options: routerOptions): Unit = js.native
  /**
    * 将本地资源上传到开发者服务器。
