...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def clearInterval(timeoutID: Double): Double = js.native
  /**
  ...
  /**
    ...
    */
  def setInterval(callback: js.Any, delay: Double, rest: js.Any): Double = js.native
  // 定时器
  /**
    ...
    * @param rest  param1, param2, ..., paramN 等附加参数，它们会作为参数传递给回调函数。
    */
  def setTimeout(callback: js.Any, delay: Double): Double = js.native
  def setTimeout(callback: js.Any, delay: Double, rest: js.Any): Double = js.native
}
