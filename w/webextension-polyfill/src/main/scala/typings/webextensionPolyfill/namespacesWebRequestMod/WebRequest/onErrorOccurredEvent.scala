...
trait onErrorOccurredEvent
  ...
  /**
    ...
    */
  def addListener(callback: js.Function1[/* details */ OnErrorOccurredDetailsType, Unit], filter: RequestFilter): Unit = js.native
  def addListener(
    callback: js.Function1[/* details */ OnErrorOccurredDetailsType, Unit],
    filter: RequestFilter,
    extraInfoSpec: js.Array[OnErrorOccurredOptions]
  ): Unit = js.native
}
