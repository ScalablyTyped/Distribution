...
trait OnBeforeRequestDetailsType extends StObject {
  ...
  /**
    ...
    * Optional.
    */
  var requestBody: js.UndefOr[OnBeforeRequestDetailsTypeRequestBodyType] = js.undefined
...
object OnBeforeRequestDetailsType {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OnBeforeRequestDetailsType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OnBeforeRequestDetailsType] (val x: Self) extends AnyVal {
    ...
    inline def setRequestBody(value: OnBeforeRequestDetailsTypeRequestBodyType): Self = StObject.set(x, "requestBody", value.asInstanceOf[js.Any])
