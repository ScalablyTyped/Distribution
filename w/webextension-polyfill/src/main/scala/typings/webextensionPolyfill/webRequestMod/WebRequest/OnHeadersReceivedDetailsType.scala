...
trait OnHeadersReceivedDetailsType extends StObject {
...
object OnHeadersReceivedDetailsType {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OnHeadersReceivedDetailsType]
  }
  
  extension [Self <: OnHeadersReceivedDetailsType](x: Self) {
