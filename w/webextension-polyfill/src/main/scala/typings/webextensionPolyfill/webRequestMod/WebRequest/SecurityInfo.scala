...
trait SecurityInfo extends StObject {
  ...
  /**
    ...
    * Optional.
    */
  var protocolVersion: js.UndefOr[SecurityInfoProtocolVersionEnum] = js.undefined
...
object SecurityInfo {
  ...
  inline def apply(certificates: js.Array[CertificateInfo], state: SecurityInfoStateEnum): SecurityInfo = {
  ...
  extension [Self <: SecurityInfo](x: Self) {
    ...
    inline def setProtocolVersion(value: SecurityInfoProtocolVersionEnum): Self = StObject.set(x, "protocolVersion", value.asInstanceOf[js.Any])
    ...
    inline def setState(value: SecurityInfoStateEnum): Self = StObject.set(x, "state", value.asInstanceOf[js.Any])
