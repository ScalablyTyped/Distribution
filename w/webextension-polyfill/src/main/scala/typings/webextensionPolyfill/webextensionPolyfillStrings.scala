...
object webextensionPolyfillStrings {
  ...
  sealed trait GET
    extends StObject
       with DownloadOptionsTypeMethodEnum
  ...
  sealed trait TLSv1
    extends StObject
       with SecurityInfoProtocolVersionEnum
       with TlsVersionRestrictionConfigMaximumEnum
       with TlsVersionRestrictionConfigMinimumEnum
  ...
  sealed trait active
    extends StObject
       with IdleState
       with OnBehaviorRequestedReturnEnum
  ...
  sealed trait activeTab
    extends StObject
       ...
       with OptionalPermissionNoPrompt
  ...
  sealed trait api_call
    extends StObject
       with OnExtensionActivityDetailsTypeTypeEnum
  ...
  sealed trait auto
    extends StObject
       with ThemeTypePropertiesColorSchemeEnum
       with ThemeTypePropertiesContentColorSchemeEnum
  inline def auto: auto = "auto".asInstanceOf[auto]
  
  @js.native
  sealed trait autoConfig
    extends StObject
       with ProxyConfigProxyTypeEnum
  ...
  sealed trait bookmark
    extends StObject
       ...
       with ContextType
       with OverrideContextContextOptionsTypeContextEnum
  ...
  sealed trait bottom
    extends StObject
       with ThemeTypePropertiesAdditionalBackgroundsAlignmentItemEnum
  inline def bottom: bottom = "bottom".asInstanceOf[bottom]
  
  @js.native
  sealed trait broken
    extends StObject
       with SecurityInfoStateEnum
  ...
  sealed trait captive
    extends StObject
       with OnConnectivityAvailableStatusEnum
  ...
  @js.native
  sealed trait dweb extends StObject
  ...
  @js.native
  sealed trait extraHeaders
    extends StObject
       with OnAuthRequiredOptions
       with OnBeforeRedirectOptions
       with OnBeforeRequestOptions
       with OnBeforeSendHeadersOptions
       with OnCompletedOptions
       with OnHeadersReceivedOptions
       with OnResponseStartedOptions
       with OnSendHeadersOptions
  inline def extraHeaders: extraHeaders = "extraHeaders".asInstanceOf[extraHeaders]
  ...
  @js.native
  sealed trait gopher extends StObject
  ...
  @js.native
  sealed trait homepage extends StObject
  ...
  @js.native
  sealed trait ipns extends StObject
  inline def ipns: ipns = "ipns".asInstanceOf[ipns]
  
  @js.native
  sealed trait irc extends StObject
  inline def irc: irc = "irc".asInstanceOf[irc]
  
  @js.native
  sealed trait ircs extends StObject
  ...
  sealed trait jpeg
    extends StObject
       with ImageFormat
       with SetImageDataImageTypeEnum
  ...
  sealed trait locked_portal
    extends StObject
       with OnStateChangedDetailsTypeStateEnum
  ...
  @js.native
  sealed trait magnet extends StObject
  inline def magnet: magnet = "magnet".asInstanceOf[magnet]
  
  @js.native
  sealed trait mailto extends StObject
  ...
  sealed trait menupanel
    extends StObject
       with ActionManifestDefaultAreaEnum
  ...
  @js.native
  sealed trait mms extends StObject
  ...
  @js.native
  sealed trait news extends StObject
  inline def news: news = "news".asInstanceOf[news]
  
  @js.native
  sealed trait newtab extends StObject
  inline def newtab: newtab = "newtab".asInstanceOf[newtab]
  
  @js.native
  sealed trait nntp extends StObject
  inline def nntp: nntp = "nntp".asInstanceOf[nntp]
  
  @js.native
  sealed trait `no-repeat`
    extends StObject
       with ThemeTypePropertiesAdditionalBackgroundsTilingItemEnum
  ...
  sealed trait not_allowed
    extends StObject
       with WebExtensionManifestIncognitoEnum
  ...
  @js.native
  sealed trait pref extends StObject
  ...
  @js.native
  sealed trait purpose extends StObject
  ...
  @js.native
  sealed trait searchbar extends StObject
  ...
  @js.native
  sealed trait smsto extends StObject
  ...
  @js.native
  sealed trait ssb extends StObject
  ...
  @js.native
  sealed trait webcal extends StObject
  ...
  @js.native
  sealed trait wtai extends StObject
  ...
  @js.native
  sealed trait xmpp extends StObject
