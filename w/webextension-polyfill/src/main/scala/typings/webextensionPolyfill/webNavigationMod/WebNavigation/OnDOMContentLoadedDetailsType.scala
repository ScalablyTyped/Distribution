...
trait OnDOMContentLoadedDetailsType extends StObject {
...
object OnDOMContentLoadedDetailsType {
  
  inline def apply(frameId: Double, tabId: Double, timeStamp: Double, url: String): OnDOMContentLoadedDetailsType = {
