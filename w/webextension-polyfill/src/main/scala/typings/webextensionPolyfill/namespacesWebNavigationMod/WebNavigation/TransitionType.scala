...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.webextensionPolyfill.webextensionPolyfillStrings.start_page
...
object TransitionType {
  ...
  inline def start_page: typings.webextensionPolyfill.webextensionPolyfillStrings.start_page = "start_page".asInstanceOf[typings.webextensionPolyfill.webextensionPolyfillStrings.start_page]
