...
/**
  ...
  */
@js.native
trait onCreatedNavigationTargetEvent
  extends StObject
     with Event[js.Function1[/* details */ OnCreatedNavigationTargetDetailsType, Unit]] {
  ...
  /**
    ...
    */
  def addListener(callback: js.Function1[/* details */ OnCreatedNavigationTargetDetailsType, Unit]): Unit = js.native
  def addListener(
    callback: js.Function1[/* details */ OnCreatedNavigationTargetDetailsType, Unit],
