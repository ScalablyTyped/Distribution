...
object namespacesBrowserSettingsMod {
  ...
  object BrowserSettings {
    ...
    */
    ...
    trait Static extends StObject {
      ...
      var colorManagement: typings.webextensionPolyfill.namespacesBrowserSettingsColorManagementMod.BrowserSettingsColorManagement.Static
    ...
    object Static {
      ...
      inline def apply(
        ...
        colorManagement: typings.webextensionPolyfill.namespacesBrowserSettingsColorManagementMod.BrowserSettingsColorManagement.Static,
      ...
      extension [Self <: Static](x: Self) {
        ...
        inline def setColorManagement(
          value: typings.webextensionPolyfill.namespacesBrowserSettingsColorManagementMod.BrowserSettingsColorManagement.Static
