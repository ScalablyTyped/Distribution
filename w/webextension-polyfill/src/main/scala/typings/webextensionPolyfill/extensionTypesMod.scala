...
object extensionTypesMod {
  ...
  object ExtensionTypes {
    ...
    */
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.webextensionPolyfill.extensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC1Type
      - typings.webextensionPolyfill.extensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC2Type
    */
    trait ExtensionFileOrCode extends StObject
    object ExtensionFileOrCode {
      
      inline def ExtensionFileOrCodeC1Type(file: ExtensionURL): typings.webextensionPolyfill.extensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC1Type = {
        val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.webextensionPolyfill.extensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC1Type]
      }
      
      inline def ExtensionFileOrCodeC2Type(code: String): typings.webextensionPolyfill.extensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC2Type = {
        val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.webextensionPolyfill.extensionTypesMod.ExtensionTypes.ExtensionFileOrCodeC2Type]
      }
    }
