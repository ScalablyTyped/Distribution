...
trait UpdateSessionRulesOptionsType extends StObject {
...
object UpdateSessionRulesOptionsType {
  
  inline def apply(): UpdateSessionRulesOptionsType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateSessionRulesOptionsType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateSessionRulesOptionsType] (val x: Self) extends AnyVal {
