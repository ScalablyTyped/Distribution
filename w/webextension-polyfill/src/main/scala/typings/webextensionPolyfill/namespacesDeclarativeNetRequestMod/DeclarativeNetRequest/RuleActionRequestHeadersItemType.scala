...
trait RuleActionRequestHeadersItemType extends StObject {
...
object RuleActionRequestHeadersItemType {
  
  inline def apply(header: String, operation: append | set | remove): RuleActionRequestHeadersItemType = {
    val __obj = js.Dynamic.literal(header = header.asInstanceOf[js.Any], operation = operation.asInstanceOf[js.Any])
    __obj.asInstanceOf[RuleActionRequestHeadersItemType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RuleActionRequestHeadersItemType] (val x: Self) extends AnyVal {
