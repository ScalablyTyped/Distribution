...
/**
  ...
  */
trait TestMatchOutcomeRequestType extends StObject {
...
object TestMatchOutcomeRequestType {
  
  inline def apply(`type`: ResourceType, url: String): TestMatchOutcomeRequestType = {
    val __obj = js.Dynamic.literal(url = url.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[TestMatchOutcomeRequestType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TestMatchOutcomeRequestType] (val x: Self) extends AnyVal {
