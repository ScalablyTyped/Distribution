...
trait URLTransform extends StObject {
  ...
  /**
    ...
    * Optional.
    */
  var queryTransform: js.UndefOr[URLTransformQueryTransformType] = js.undefined
  
  /**
    * The new scheme for the request.
    * Optional.
    */
  var scheme: js.UndefOr[URLTransformSchemeEnum] = js.undefined
...
object URLTransform {
  ...
  implicit open class MutableBuilder[Self <: URLTransform] (val x: Self) extends AnyVal {
    ...
    inline def setQueryTransform(value: URLTransformQueryTransformType): Self = StObject.set(x, "queryTransform", value.asInstanceOf[js.Any])
    
    inline def setQueryTransformUndefined: Self = StObject.set(x, "queryTransform", js.undefined)
    
    inline def setQueryUndefined: Self = StObject.set(x, "query", js.undefined)
    
    inline def setScheme(value: URLTransformSchemeEnum): Self = StObject.set(x, "scheme", value.asInstanceOf[js.Any])
