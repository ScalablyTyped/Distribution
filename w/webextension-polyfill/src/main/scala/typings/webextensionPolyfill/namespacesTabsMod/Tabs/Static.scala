...
import typings.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.ImageDetails
import typings.webextensionPolyfill.namespacesExtensionTypesMod.ExtensionTypes.InjectDetails
import typings.webextensionPolyfill.namespacesRuntimeMod.Runtime.Port
