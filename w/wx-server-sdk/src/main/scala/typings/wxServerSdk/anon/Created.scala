...
object Created {
  ...
  implicit class CreatedOps[Self <: Created] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreated(value: typings.wxServerSdk.wxServerSdkNumbers.`0` | typings.wxServerSdk.wxServerSdkNumbers.`1`): Self = this.set("created", value.asInstanceOf[js.Any])
    @scala.inline
