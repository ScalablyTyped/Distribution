...
object mod {
  ...
  inline def copyDirRecursive(srcDir: String, newDir: String, fn: js.Function1[/* err */ Error, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("copyDirRecursive")(srcDir.asInstanceOf[js.Any], newDir.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def readdirRecursive(baseDir: String, fn: js.Function2[/* err */ Error, /* files */ js.Array[String], Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("readdirRecursive")(baseDir.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def rmdirRecursive(path: String, fn: js.Function1[/* err */ Error, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("rmdirRecursive")(path.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[Unit]
