...
class GridRouter[Node] protected () extends js.Object {
  ...
  /* private */ def avg(a: js.Any): js.Any = js.native
  /* private */ def findAncestorPathBetween(a: js.Any, b: js.Any): js.Any = js.native
  /* private */ def findLineage(v: js.Any): js.Any = js.native
  /* private */ def getDepth(v: js.Any): js.Any = js.native
  /* private */ def getGridLines(axis: js.Any): js.Any = js.native
  /* private */ def midPoints(a: js.Any): js.Any = js.native
