...
object distSrcRectangleMod {
  ...
  @js.native
  open class IndexedVariable protected () extends Variable {
  ...
  open class Projection protected () extends StObject {
    ...
    /* private */ var avoidOverlaps: Any = js.native
    
    /* private */ var createAlignment: Any = js.native
    
    /* private */ var createConstraints: Any = js.native
    
    /* private */ var createSeparation: Any = js.native
    
    /* private */ var groups: Any = js.native
    
    /* private */ var makeFeasible: Any = js.native
    
    /* private */ var nodes: Any = js.native
    
    /* private */ var project: Any = js.native
    
    def projectFunctions(): js.Array[
        js.Function3[/* x0 */ js.Array[Double], /* y0 */ js.Array[Double], /* r */ js.Array[Double], Unit]
      ] = js.native
    
    /* private */ var rootGroup: Any = js.native
    
    /* private */ var setupVariablesAndBounds: Any = js.native
    
    /* private */ var solve: Any = js.native
    
    /* private */ var variables: Any = js.native
    
    /* private */ var xConstraints: Any = js.native
    
    def xProject(x0: js.Array[Double], y0: js.Array[Double], x: js.Array[Double]): Unit = js.native
    
    /* private */ var yConstraints: Any = js.native
  ...
  @js.native
  open class Rectangle protected () extends StObject {
  ...
  object ProjectionGroup {
    ...
    implicit open class MutableBuilder[Self <: ProjectionGroup] (val x: Self) extends AnyVal {
      ...
      inline def setGroupsVarargs(value: ProjectionGroup*): Self = StObject.set(x, "groups", js.Array(value*))
      
      inline def setLeaves(value: js.Array[Leaf]): Self = StObject.set(x, "leaves", value.asInstanceOf[js.Any])
      
      inline def setLeavesVarargs(value: Leaf*): Self = StObject.set(x, "leaves", js.Array(value*))
