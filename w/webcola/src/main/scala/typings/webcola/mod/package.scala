...
@scala.inline
def applyPacking(graphs: js.Array[js.Any], w: js.Any, h: js.Any, node_size: js.Any): scala.Unit = (typings.webcola.mod.^.asInstanceOf[js.Dynamic].applyDynamic("applyPacking")(graphs.asInstanceOf[js.Any], w.asInstanceOf[js.Any], h.asInstanceOf[js.Any], node_size.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
@scala.inline
...
@scala.inline
def d3adaptor(): typings.webcola.layoutMod.Layout & typings.webcola.d3adaptorMod.ID3StyleLayoutAdaptor = typings.webcola.mod.^.asInstanceOf[js.Dynamic].applyDynamic("d3adaptor")().asInstanceOf[typings.webcola.layoutMod.Layout & typings.webcola.d3adaptorMod.ID3StyleLayoutAdaptor]
@scala.inline
...
@scala.inline
def separateGraphs(nodes: js.Any, links: js.Any): js.Array[js.Any] = (typings.webcola.mod.^.asInstanceOf[js.Dynamic].applyDynamic("separateGraphs")(nodes.asInstanceOf[js.Any], links.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Any]]
