...
object mod {
  ...
  object cacheNames {
    ...
    @JSImport("workbox-core", "cacheNames.googleAnalytics")
    @js.native
    val googleAnalytics: String = js.native
    
    @JSImport("workbox-core", "cacheNames.precache")
    @js.native
    val precache: String = js.native
    
    @JSImport("workbox-core", "cacheNames.prefix")
    @js.native
    val prefix: String = js.native
    
    @JSImport("workbox-core", "cacheNames.runtime")
    @js.native
    val runtime: String = js.native
    
    @JSImport("workbox-core", "cacheNames.suffix")
    @js.native
  ...
  object `private` {
    ...
    @JSImport("workbox-core", "_private")
    @js.native
    val ^ : js.Any = js.native
    ...
    open class Deferred[T] ()
      extends typings.workboxCore.privateMod.Deferred[T]
    ...
    open class WorkboxError protected ()
      extends typings.workboxCore.privateMod.WorkboxError {
      /**
        *
