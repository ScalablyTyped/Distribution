...
trait HandlerWillStartCallbackParam extends StObject {
...
object HandlerWillStartCallbackParam {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[HandlerWillStartCallbackParam]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: HandlerWillStartCallbackParam] (val x: Self) extends AnyVal {
