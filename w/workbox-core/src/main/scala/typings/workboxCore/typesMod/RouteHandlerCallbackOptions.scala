...
trait RouteHandlerCallbackOptions
  extends StObject
...
object RouteHandlerCallbackOptions {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[RouteHandlerCallbackOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RouteHandlerCallbackOptions] (val x: Self) extends AnyVal {
