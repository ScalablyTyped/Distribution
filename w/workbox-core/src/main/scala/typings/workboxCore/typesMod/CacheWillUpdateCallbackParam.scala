...
trait CacheWillUpdateCallbackParam extends StObject {
...
object CacheWillUpdateCallbackParam {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CacheWillUpdateCallbackParam]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CacheWillUpdateCallbackParam] (val x: Self) extends AnyVal {
