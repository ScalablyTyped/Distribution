...
/* Inlined workbox-build.workbox-build/build/types.GeneratePartial & {  manifestEntries :std.Array<workbox-build.workbox-build/build/types.ManifestEntry> | undefined} */
trait GeneratePartialmanifestEn extends StObject {
...
object GeneratePartialmanifestEn {
  
  inline def apply(): GeneratePartialmanifestEn = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GeneratePartialmanifestEn]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GeneratePartialmanifestEn] (val x: Self) extends AnyVal {
