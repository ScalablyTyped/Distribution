...
object testkitMod {
  ...
  @scala.inline
  def paginationTestkitFactory(testkitArgs: TestkitArgs): BlurInput = ^.asInstanceOf[js.Dynamic].applyDynamic("paginationTestkitFactory")(testkitArgs.asInstanceOf[js.Any]).asInstanceOf[BlurInput]
