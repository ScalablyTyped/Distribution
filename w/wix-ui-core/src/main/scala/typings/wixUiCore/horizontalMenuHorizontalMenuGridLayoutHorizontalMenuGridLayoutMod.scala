...
object horizontalMenuHorizontalMenuGridLayoutHorizontalMenuGridLayoutMod extends Shortcut {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/horizontal-menu-grid-layout/HorizontalMenuGridLayout", JSImport.Default)
  @js.native
  val default: FC[PickPickHorizontalMenuGri] = js.native
  
  @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/horizontal-menu-grid-layout/HorizontalMenuGridLayout", "HorizontalMenuGridLayout")
  @js.native
  ...
  object HorizontalMenuGridLayout {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/horizontal-menu-grid-layout/HorizontalMenuGridLayout", "HorizontalMenuGridLayout.displayName")
    @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `horizontalMenuHorizontalMenuGridLayoutHorizontalMenuGridLayoutMod.foo` */
