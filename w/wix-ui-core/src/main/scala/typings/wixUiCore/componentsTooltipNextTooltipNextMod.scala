...
object componentsTooltipNextTooltipNextMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/tooltip-next/tooltip-next", "TooltipNext")
  @js.native
  ...
  object TooltipNext {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/tooltip-next/tooltip-next", "TooltipNext.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/tooltip-next/tooltip-next", "TooltipNext.displayName")
    @js.native
