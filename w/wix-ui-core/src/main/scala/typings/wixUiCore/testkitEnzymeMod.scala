...
object testkitEnzymeMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/testkit/enzyme", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/dist/standalone/src/testkit/enzyme", "NavStepperDriver")
  @js.native
  ...
  inline def navStepperTestkitFactory(obj: WrapperData): typings.wixUiCore.navStepperDotdriverMod.NavStepperDriver = ^.asInstanceOf[js.Dynamic].applyDynamic("navStepperTestkitFactory")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.wixUiCore.navStepperDotdriverMod.NavStepperDriver]
  
  inline def paginationTestkitFactory(obj: WrapperData): ChangeInput = ^.asInstanceOf[js.Dynamic].applyDynamic("paginationTestkitFactory")(obj.asInstanceOf[js.Any]).asInstanceOf[ChangeInput]
