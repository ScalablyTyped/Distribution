...
object imageConstsMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/image/consts", "FALLBACK_IMAGE")
  @js.native
  val FALLBACK_IMAGE: String = js.native
  
  @js.native
  sealed trait ImageStatus extends StObject
  @JSImport("wix-ui-core/dist/standalone/src/components/image/consts", "ImageStatus")
  @js.native
