...
object dropdownOptionProtractorDriverMod {
  
  @JSImport("wix-ui-core/dist/src/components/dropdown-option/DropdownOption.protractor.driver", "dropdownOptionDriverFactory")
  @js.native
