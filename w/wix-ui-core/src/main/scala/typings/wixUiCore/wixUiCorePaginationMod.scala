...
object wixUiCorePaginationMod {
  
  @JSImport("wix-ui-core/pagination", "Pagination")
  @js.native
  ...
  object Pagination {
    ...
    @JSImport("wix-ui-core/pagination", "Pagination.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/pagination", "Pagination.displayName")
    @js.native
