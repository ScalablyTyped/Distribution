...
object filePickerButtonFilePickerButtonMod {
  
  @JSImport("wix-ui-core/dist/src/components/file-picker-button/FilePickerButton", "FilePickerButton")
  @js.native
  ...
  object FilePickerButton {
    ...
    @JSImport("wix-ui-core/dist/src/components/file-picker-button/FilePickerButton", "FilePickerButton.defaultProps")
    @js.native
    def defaultProps: Disabled = js.native
    inline def defaultProps_=(x: Disabled): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/dist/src/components/file-picker-button/FilePickerButton", "FilePickerButton.displayName")
    @js.native
