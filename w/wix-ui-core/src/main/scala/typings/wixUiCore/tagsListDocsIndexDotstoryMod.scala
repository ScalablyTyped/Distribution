...
object tagsListDocsIndexDotstoryMod {
  
  object default {
    
    @JSImport("wix-ui-core/src/components/tags-list/docs/index.story", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("wix-ui-core/src/components/tags-list/docs/index.story", "default.category")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/tags-list/docs/index.story", "default.component")
    @js.native
    def component: FunctionComponent[TagsListProps] = js.native
    
    @JSImport("wix-ui-core/src/components/tags-list/docs/index.story", "default.componentPath")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/tags-list/docs/index.story", "default.componentProps")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/tags-list/docs/index.story", "default.sections")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/tags-list/docs/index.story", "default.storyName")
    @js.native
