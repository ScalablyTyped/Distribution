...
object componentsIconWithOptionsIconWithOptionsMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/icon-with-options/IconWithOptions", "IconWithOptions")
  @js.native
