...
object horizontalMenuPrivateUniDriverMod {
  
  @JSImport("wix-ui-core/dist/src/components/horizontal-menu/test/HorizontalMenu.private.uni.driver", JSImport.Namespace)
  @js.native
