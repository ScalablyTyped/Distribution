...
object linearProgressBarProtractorDotDriverMod {
  
  @JSImport("wix-ui-core/src/components/linear-progress-bar/LinearProgressBar.protractor.driver", "linearProgressBarDriverFactory")
  @js.native
