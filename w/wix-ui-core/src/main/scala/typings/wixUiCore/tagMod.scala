...
object tagMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/tags-list/Tag", "FocusableTag")
  @js.native
  ...
  object FocusableTag {
    ...
    @JSImport("wix-ui-core/dist/src/components/tags-list/Tag", "FocusableTag.displayName")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/tags-list/Tag", "FocusableTag.propTypes")
    @js.native
  ...
  @JSImport("wix-ui-core/dist/src/components/tags-list/Tag", "Tag")
  @js.native
  class Tag protected ()
    extends Component[TagProps, js.Object, js.Any] {
    def this(props: TagProps) = this()
  ...
  object Tag {
    ...
    @JSImport("wix-ui-core/dist/src/components/tags-list/Tag", "Tag.displayName")
    @js.native
    def displayName: DisplayNames = js.native
    inline def displayName_=(x: DisplayNames): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/dist/src/components/tags-list/Tag", "Tag.propTypes")
    @js.native
