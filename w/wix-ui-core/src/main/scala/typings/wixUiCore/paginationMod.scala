...
object paginationMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/pagination", "Pagination")
  @js.native
  class Pagination protected ()
    extends typings.wixUiCore.paginationPaginationMod.Pagination {
  ...
  object Pagination {
    ...
    @JSImport("wix-ui-core/dist/src/components/pagination", "Pagination.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/pagination", "Pagination.displayName")
    @js.native
