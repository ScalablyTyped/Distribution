...
object filePickerButtonPrivateUniDriverMod {
  
  @JSImport("wix-ui-core/dist/src/components/file-picker-button/test/FilePickerButton.private.uni.driver", JSImport.Namespace)
  @js.native
