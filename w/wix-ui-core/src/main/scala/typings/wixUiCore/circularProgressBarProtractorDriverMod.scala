...
object circularProgressBarProtractorDriverMod {
  
  @JSImport("wix-ui-core/dist/src/components/circular-progress-bar/CircularProgressBar.protractor.driver", "circularProgressBarDriverFactory")
  @js.native
