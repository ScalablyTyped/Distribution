...
object dropdownOptionMod {
  
  @JSImport("wix-ui-core/dist/src/components/dropdown-option", "DropdownOption")
  @js.native
  val DropdownOption: DropdownOptionType = js.native
  
  object OptionFactory {
    
    @JSImport("wix-ui-core/dist/src/components/dropdown-option", "OptionFactory")
    @js.native
