...
import typings.wixUiCore.dropdownDotProtractorDriverMod.DropdownDriver
import typings.wixUiCore.labelDotProtractorDriverMod.LabelDriver
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object labelWithOptionsDotProtractorDriverMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/label-with-options/LabelWithOptions.protractor.driver", "labelWithOptionsDriverFactory")
  @js.native
