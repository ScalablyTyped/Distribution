...
object componentsAvatarMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/avatar", "Avatar")
  @js.native
  ...
  object Avatar {
    ...
    @JSImport("wix-ui-core/dist/src/components/avatar", "Avatar.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/avatar", "Avatar.displayName")
    @js.native
