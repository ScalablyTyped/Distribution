...
object componentsToggleSwitchToggleSwitchMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/toggle-switch/ToggleSwitch", "ToggleSwitch")
  @js.native
  ...
  object ToggleSwitch {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/toggle-switch/ToggleSwitch", "ToggleSwitch.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/toggle-switch/ToggleSwitch", "ToggleSwitch.displayName")
    @js.native
