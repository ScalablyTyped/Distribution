...
object testAssetsCaptchaTestComponentTestDriverMod {
  
  @JSImport("wix-ui-core/src/components/captcha/test-assets/CaptchaTestComponent.testDriver", JSImport.Namespace)
  @js.native
