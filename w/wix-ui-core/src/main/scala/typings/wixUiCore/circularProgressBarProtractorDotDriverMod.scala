...
object circularProgressBarProtractorDotDriverMod {
  
  @JSImport("wix-ui-core/src/components/circular-progress-bar/CircularProgressBar.protractor.driver", "circularProgressBarDriverFactory")
  @js.native
