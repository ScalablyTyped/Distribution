...
object srcComponentsInputInputMod {
  ...
  */
  ...
  object AriaAutoCompleteType {
    ...
    inline def both: typings.wixUiCore.wixUiCoreStrings.both = "both".asInstanceOf[typings.wixUiCore.wixUiCoreStrings.both]
    
    inline def list: typings.wixUiCore.wixUiCoreStrings.list = "list".asInstanceOf[typings.wixUiCore.wixUiCoreStrings.list]
    
    inline def none: typings.wixUiCore.wixUiCoreStrings.none = "none".asInstanceOf[typings.wixUiCore.wixUiCoreStrings.none]
  }
  ...
  object InputState {
    ...
    inline def apply(focus: Boolean): InputState = {
  ...
  */
  ...
  object OmittedInputProps {
    ...
    inline def prefix: typings.wixUiCore.wixUiCoreStrings.prefix = "prefix".asInstanceOf[typings.wixUiCore.wixUiCoreStrings.prefix]
    
    inline def value: typings.wixUiCore.wixUiCoreStrings.value = "value".asInstanceOf[typings.wixUiCore.wixUiCoreStrings.value]
  }
}
