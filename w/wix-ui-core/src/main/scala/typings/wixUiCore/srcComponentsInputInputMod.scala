...
object srcComponentsInputInputMod {
  
  @JSImport("wix-ui-core/src/components/input/Input", "Input")
  @js.native
  ...
  object Input {
    ...
    @JSImport("wix-ui-core/src/components/input/Input", "Input.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/input/Input", "Input.displayName")
    @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.wixUiCore.wixUiCoreStrings.list
    - typings.wixUiCore.wixUiCoreStrings.none
    - typings.wixUiCore.wixUiCoreStrings.both
  */
  trait AriaAutoCompleteType extends StObject
  object AriaAutoCompleteType {
    
    @scala.inline
    def both: typings.wixUiCore.wixUiCoreStrings.both = "both".asInstanceOf[typings.wixUiCore.wixUiCoreStrings.both]
    
    @scala.inline
    def list: typings.wixUiCore.wixUiCoreStrings.list = "list".asInstanceOf[typings.wixUiCore.wixUiCoreStrings.list]
    
    @scala.inline
    def none: typings.wixUiCore.wixUiCoreStrings.none = "none".asInstanceOf[typings.wixUiCore.wixUiCoreStrings.none]
  }
  
  /* Inlined parent type-zoo.type-zoo.Omit<react.react.InputHTMLAttributes<std.HTMLInputElement>, wix-ui-core.wix-ui-core/src/components/input/Input.OmittedInputProps> */
  trait InputProps extends StObject {
    ...
    var `aria-autocomplete`: js.UndefOr[AriaAutoCompleteType] = js.undefined
    ...
    var onClick: js.UndefOr[EventHandler[MouseEvent[HTMLInputElement, NativeMouseEvent]]] = js.undefined
    ...
    var onDragStart: js.UndefOr[EventHandler[DragEvent[HTMLInputElement]]] = js.undefined
    ...
    var onMouseDown: js.UndefOr[EventHandler[MouseEvent[HTMLInputElement, NativeMouseEvent]]] = js.undefined
    ...
    var onMouseMove: js.UndefOr[EventHandler[MouseEvent[HTMLInputElement, NativeMouseEvent]]] = js.undefined
    ...
    var onMouseUp: js.UndefOr[EventHandler[MouseEvent[HTMLInputElement, NativeMouseEvent]]] = js.undefined
  ...
  object InputProps {
    ...
    implicit class InputPropsMutableBuilder[Self <: InputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def `setAria-autocomplete`(value: AriaAutoCompleteType): Self = StObject.set(x, "aria-autocomplete", value.asInstanceOf[js.Any])
  ...
  object InputState {
    ...
    @scala.inline
    def apply(focus: Boolean): InputState = {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.wixUiCore.wixUiCoreStrings.value
    - typings.wixUiCore.wixUiCoreStrings.prefix
  */
  trait OmittedInputProps extends StObject
  object OmittedInputProps {
    
    @scala.inline
    def prefix: typings.wixUiCore.wixUiCoreStrings.prefix = "prefix".asInstanceOf[typings.wixUiCore.wixUiCoreStrings.prefix]
    
    @scala.inline
    def value: typings.wixUiCore.wixUiCoreStrings.value = "value".asInstanceOf[typings.wixUiCore.wixUiCoreStrings.value]
  }
}
