...
object paginationDriverMod {
  ...
  @scala.inline
  def paginationDriverFactory(hasRootSimulate: Element): BlurInput = ^.asInstanceOf[js.Dynamic].applyDynamic("paginationDriverFactory")(hasRootSimulate.asInstanceOf[js.Any]).asInstanceOf[BlurInput]
