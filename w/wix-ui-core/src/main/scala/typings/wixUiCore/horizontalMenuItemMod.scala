...
object horizontalMenuItemMod {
  
  @JSImport("wix-ui-core/dist/src/components/horizontal-menu/horizontal-menu-item", "HorizontalMenuItem")
  @js.native
  class HorizontalMenuItem protected ()
    extends typings.wixUiCore.horizontalMenuItemHorizontalMenuItemMod.HorizontalMenuItem {
  ...
  object HorizontalMenuItem {
    ...
    @JSImport("wix-ui-core/dist/src/components/horizontal-menu/horizontal-menu-item", "HorizontalMenuItem.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/horizontal-menu/horizontal-menu-item", "HorizontalMenuItem.displayName")
    @js.native
