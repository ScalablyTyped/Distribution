...
object componentsCheckboxCheckboxMod {
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/checkbox/Checkbox", "Checkbox")
  @js.native
  ...
  object Checkbox {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/checkbox/Checkbox", "Checkbox.defaultProps")
    @js.native
    def defaultProps: PartialCheckboxPropsAbout = js.native
    @scala.inline
    def defaultProps_=(x: PartialCheckboxPropsAbout): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/dist/standalone/src/components/checkbox/Checkbox", "Checkbox.displayName")
    @js.native
