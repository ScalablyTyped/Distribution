...
import typings.wixUiCore.anon.AccessKey
...
object componentsAutocompleteAutocompleteMod {
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/autocomplete/Autocomplete", "Autocomplete")
  @js.native
  class Autocomplete protected ()
    ...
    def _createInputProps(): AccessKey = js.native
  ...
  object Autocomplete {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/autocomplete/Autocomplete", "Autocomplete.displayName")
    @js.native
