...
object circularProgressBarDotUniDriverMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/circular-progress-bar/CircularProgressBar.uni.driver", JSImport.Namespace)
  @js.native
