...
object paginationPaginationMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/pagination/Pagination", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/dist/src/components/pagination/Pagination", "Pagination")
  @js.native
  ...
  object Pagination {
    ...
    @JSImport("wix-ui-core/dist/src/components/pagination/Pagination", "Pagination.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/pagination/Pagination", "Pagination.displayName")
    @js.native
