...
object paginationPaginationDriverMod {
  ...
  inline def paginationDriverFactory(hasRootSimulate: Element): ClickNavButton = ^.asInstanceOf[js.Dynamic].applyDynamic("paginationDriverFactory")(hasRootSimulate.asInstanceOf[js.Any]).asInstanceOf[ClickNavButton]
