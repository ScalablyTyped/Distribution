...
object navStepperNavStepperMod {
  
  @JSImport("wix-ui-core/dist/src/components/nav-stepper/NavStepper", "NavStepper")
  @js.native
  ...
  object NavStepper {
    ...
    @JSImport("wix-ui-core/dist/src/components/nav-stepper/NavStepper", "NavStepper.Step")
    @js.native
