...
import typings.wixUiCore.anon.SrcStatus
import typings.wixUiCore.imageConstsMod.ImageStatus
...
object componentsImageImageMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/image/image", "Image")
  @js.native
  class Image protected ()
    ...
    @JSName("state")
    var state_Image: SrcStatus = js.native
  }
