...
object filePickerButtonDotPrivateUniDriverMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/file-picker-button/test/FilePickerButton.private.uni.driver", JSImport.Namespace)
  @js.native
