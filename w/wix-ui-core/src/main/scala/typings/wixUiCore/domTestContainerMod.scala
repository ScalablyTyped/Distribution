...
object domTestContainerMod {
  
  @JSImport("wix-ui-core/dist/standalone/test/dom-test-container", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/dist/standalone/test/dom-test-container", "ReactDOMTestContainer")
  @js.native
