...
object componentsNavStepperNavStepperMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/nav-stepper/NavStepper", "NavStepper")
  @js.native
  ...
  object NavStepper {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/nav-stepper/NavStepper", "NavStepper.Step")
    @js.native
