...
object componentsPopoverNextMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/popover-next", "PopoverNext")
  @js.native
  class PopoverNext protected ()
    extends typings.wixUiCore.componentsPopoverNextPopoverNextMod.PopoverNext {
  ...
  object PopoverNext {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/popover-next", "PopoverNext.Content")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/popover-next", "PopoverNext.Element")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/popover-next", "PopoverNext.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/popover-next", "PopoverNext.displayName")
    @js.native
