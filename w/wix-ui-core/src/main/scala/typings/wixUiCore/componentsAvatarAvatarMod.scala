...
import typings.wixUiCore.componentsAvatarTypesMod.ContentType
...
object componentsAvatarAvatarMod {
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar", "Avatar")
  @js.native
  ...
  object Avatar {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar", "Avatar.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar", "Avatar.displayName")
    @js.native
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar", "AvatarComponent")
  @js.native
  ...
  object AvatarComponent {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar", "AvatarComponent.defaultProps")
    @js.native
    def defaultProps: Placeholder = js.native
    @scala.inline
    def defaultProps_=(x: Placeholder): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar", "AvatarComponent.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
