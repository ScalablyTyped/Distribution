...
object componentsEllipsisTooltipEllipsisTooltipMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/ellipsis-tooltip/EllipsisTooltip", "EllipsisTooltip")
  @js.native
  ...
  object EllipsisTooltip {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/ellipsis-tooltip/EllipsisTooltip", "EllipsisTooltip.defaultProps")
    @js.native
