...
import typings.wixUiCore.captchaTypesMod.CaptchaLang
import typings.wixUiCore.captchaTypesMod.CaptchaType
import typings.wixUiCore.captchaTypesMod.Size
import typings.wixUiCore.captchaTypesMod.Theme
...
object captchaCaptchaMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/captcha/Captcha", "Captcha")
  @js.native
  ...
  object Captcha {
    ...
    @JSImport("wix-ui-core/dist/src/components/captcha/Captcha", "Captcha.displayName")
    @js.native
