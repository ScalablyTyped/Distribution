...
object navStepperProtractorDriverMod {
  
  @JSImport("wix-ui-core/dist/src/components/nav-stepper/NavStepper.protractor.driver", "NavStepperDriver")
  @js.native
  ...
  @JSImport("wix-ui-core/dist/src/components/nav-stepper/NavStepper.protractor.driver", "navStepperDriverFactory")
  @js.native
