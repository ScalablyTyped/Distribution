...
object driversVanillaMod {
  ...
  inline def paginationDriverFactory(hasRootSimulate: typings.wixUiCore.anon.Element): BlurInput = ^.asInstanceOf[js.Dynamic].applyDynamic("paginationDriverFactory")(hasRootSimulate.asInstanceOf[js.Any]).asInstanceOf[BlurInput]
