...
import typings.wixUiCore.anon.TypeofVideo
import typings.wixUiCore.distStoriesUtilsMod.Category
import typings.wixUiCore.videoMod.Video
import typings.wixUiCore.videoVideoMod.IVideoProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object videoStoryMod {
  
  object default {
    
    @JSImport("wix-ui-core/dist/src/components/video/Video.story", JSImport.Default)
    @js.native
