...
object srcComponentsSliderSliderMod {
  
  @JSImport("wix-ui-core/src/components/slider/Slider", "Slider")
  @js.native
  ...
  object Slider {
    ...
    @JSImport("wix-ui-core/src/components/slider/Slider", "Slider.defaultProps")
    @js.native
    def defaultProps: PartialSliderPropsClassName = js.native
    inline def defaultProps_=(x: PartialSliderPropsClassName): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/src/components/slider/Slider", "Slider.displayName")
    @js.native
