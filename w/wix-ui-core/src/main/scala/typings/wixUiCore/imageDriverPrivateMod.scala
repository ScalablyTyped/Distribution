...
object imageDriverPrivateMod {
  
  @JSImport("wix-ui-core/dist/src/components/image/image.driver.private", JSImport.Namespace)
  @js.native
  ...
  trait ImageDriver
    extends StObject
       with typings.wixUiCore.imageUniDriverMod.ImageDriver {
