...
object componentsDropdownContentDropdownContentMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/dropdown-content/DropdownContent", "DropdownContent")
  @js.native
  ...
  object DropdownContent {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/dropdown-content/DropdownContent", "DropdownContent.displayName")
    @js.native
