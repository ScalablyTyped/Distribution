...
@JSImport("wix-ui-core/dist/standalone/src", "EllipsisTooltip")
@js.native
class EllipsisTooltip protected ()
  extends typings.wixUiCore.componentsEllipsisTooltipMod.EllipsisTooltip {
...
object EllipsisTooltip {
  ...
  @JSImport("wix-ui-core/dist/standalone/src", "EllipsisTooltip.defaultProps")
  @js.native
