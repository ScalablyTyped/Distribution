...
@JSImport("wix-ui-core/dist/standalone/src", "HorizontalMenuItem")
@js.native
class HorizontalMenuItem protected ()
  extends typings.wixUiCore.horizontalMenuHorizontalMenuItemMod.HorizontalMenuItem {
...
object HorizontalMenuItem {
  ...
  @JSImport("wix-ui-core/dist/standalone/src", "HorizontalMenuItem.defaultProps")
  @js.native
  ...
  @JSImport("wix-ui-core/dist/standalone/src", "HorizontalMenuItem.displayName")
  @js.native
