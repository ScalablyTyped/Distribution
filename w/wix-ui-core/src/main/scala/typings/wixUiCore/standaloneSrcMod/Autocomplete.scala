...
@JSImport("wix-ui-core/dist/standalone/src", "Autocomplete")
@js.native
class Autocomplete protected ()
  extends typings.wixUiCore.srcComponentsAutocompleteMod.Autocomplete {
...
object Autocomplete {
  ...
  @JSImport("wix-ui-core/dist/standalone/src", "Autocomplete.displayName")
  @js.native
