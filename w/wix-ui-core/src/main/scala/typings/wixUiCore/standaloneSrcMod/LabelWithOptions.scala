...
@JSImport("wix-ui-core/dist/standalone/src", "LabelWithOptions")
@js.native
class LabelWithOptions protected ()
  extends typings.wixUiCore.componentsLabelWithOptionsMod.LabelWithOptions {
...
object LabelWithOptions {
  ...
  @JSImport("wix-ui-core/dist/standalone/src", "LabelWithOptions.defaultProps")
  @js.native
  ...
  @JSImport("wix-ui-core/dist/standalone/src", "LabelWithOptions.displayName")
  @js.native
