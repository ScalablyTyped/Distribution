...
@JSImport("wix-ui-core/dist/standalone/src", "FocusableTag")
@js.native
class FocusableTag protected ()
  extends typings.wixUiCore.componentsTagsListMod.FocusableTag {
...
object FocusableTag {
  ...
  @JSImport("wix-ui-core/dist/standalone/src", "FocusableTag.displayName")
  @js.native
  ...
  @JSImport("wix-ui-core/dist/standalone/src", "FocusableTag.propTypes")
  @js.native
