...
object componentsLabelWithOptionsLabelWithOptionsMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/label-with-options/LabelWithOptions", "LabelWithOptions")
  @js.native
  ...
  object LabelWithOptions {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/label-with-options/LabelWithOptions", "LabelWithOptions.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/label-with-options/LabelWithOptions", "LabelWithOptions.displayName")
    @js.native
