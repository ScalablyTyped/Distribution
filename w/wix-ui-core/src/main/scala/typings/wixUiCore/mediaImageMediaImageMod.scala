...
object mediaImageMediaImageMod {
  
  @JSImport("wix-ui-core/dist/src/components/media-image/media-image", "MediaImage")
  @js.native
  ...
  @JSImport("wix-ui-core/dist/src/components/media-image/media-image", "MediaImageScaling")
  @js.native
  ...
  @JSImport("wix-ui-core/dist/src/components/media-image/media-image", "MediaImageUpscaleMethod")
  @js.native
  object MediaImageUpscaleMethod extends StObject {
    ...
    /* "auto" */ val AUTO: typings.wixUiCore.mediaImageMediaImageMod.MediaImageUpscaleMethod.AUTO & String = js.native
    
    @js.native
    sealed trait CLASSIC
      extends StObject
         with MediaImageUpscaleMethod
    /* "classic" */ val CLASSIC: typings.wixUiCore.mediaImageMediaImageMod.MediaImageUpscaleMethod.CLASSIC & String = js.native
    
    @js.native
    sealed trait SUPER
      extends StObject
         with MediaImageUpscaleMethod
    /* "super" */ val SUPER: typings.wixUiCore.mediaImageMediaImageMod.MediaImageUpscaleMethod.SUPER & String = js.native
  }
