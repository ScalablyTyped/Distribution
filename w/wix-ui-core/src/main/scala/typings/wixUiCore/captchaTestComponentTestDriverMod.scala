...
object captchaTestComponentTestDriverMod {
  
  @JSImport("wix-ui-core/dist/src/components/captcha/test-assets/CaptchaTestComponent.testDriver", JSImport.Namespace)
  @js.native
