...
object signatureInputSignatureInputContextMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/signature-input/SignatureInputContext", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/dist/standalone/src/components/signature-input/SignatureInputContext", "SignatureInputContextProvider")
  @js.native
