...
object horizontalMenuHorizontalMenuItemHorizontalMenuItemContextMod {
  
  @JSImport("wix-ui-core/src/components/horizontal-menu/horizontal-menu-item/HorizontalMenuItemContext", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/src/components/horizontal-menu/horizontal-menu-item/HorizontalMenuItemContext", "HorizontalMenuItemContext")
  @js.native
