...
import typings.wixUiCore.componentsDropdownConstantsMod.OPEN_TRIGGER_TYPE
import typings.wixUiCore.componentsDropdownContentDropdownContentMod.IDOMid
import typings.wixUiCore.componentsPopoverPopoverMod.AppendTo
import typings.wixUiCore.componentsPopoverPopoverMod.Placement
...
object componentsDropdownDropdownMod {
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/dropdown/Dropdown", "Dropdown")
  @js.native
