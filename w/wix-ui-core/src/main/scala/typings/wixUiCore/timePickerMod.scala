...
object timePickerMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePicker")
  @js.native
  class TimePicker protected ()
    extends typings.wixUiCore.timePickerTimePickerMod.TimePicker {
  ...
  object TimePicker {
    ...
    @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePicker.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePicker.displayName")
    @js.native
  ...
  object TimePickerConstants {
    ...
    @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePickerConstants.AmPmOptions")
    @js.native
    ...
    object AmPmStrings {
      ...
      @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePickerConstants.AmPmStrings")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePickerConstants.AmPmStrings.capitalized")
      @js.native
      ...
      @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePickerConstants.AmPmStrings.lowercase")
      @js.native
      ...
      @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePickerConstants.AmPmStrings.uppercase")
      @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePickerConstants.BLANK")
    @js.native
    val BLANK: /* "--" */ String = js.native
    
    @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePickerConstants.FIELD")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePickerConstants.NULL_TIME")
    @js.native
  ...
  object TimePickerUtils {
    ...
    @JSImport("wix-ui-core/dist/src/components/time-picker", "TimePickerUtils")
    @js.native
    val ^ : js.Any = js.native
