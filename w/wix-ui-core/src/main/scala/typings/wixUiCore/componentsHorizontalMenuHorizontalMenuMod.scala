...
object componentsHorizontalMenuHorizontalMenuMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/HorizontalMenu", "HorizontalMenu")
  @js.native
  ...
  object HorizontalMenu {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/HorizontalMenu", "HorizontalMenu.Item")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/HorizontalMenu", "HorizontalMenu.Layout")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/HorizontalMenu", "HorizontalMenu.displayName")
    @js.native
