...
import typings.wixUiCore.videoTypesMod.IMethodsToPlayer
import typings.wixUiCore.videoTypesMod.IPropsToPlayer
...
object playerHOCMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/video/players/playerHOC", JSImport.Namespace)
  @js.native
