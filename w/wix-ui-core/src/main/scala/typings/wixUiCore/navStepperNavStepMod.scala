...
object navStepperNavStepMod {
  ...
  object ExternalNavStepProps {
    ...
    @scala.inline
    def apply(): ExternalNavStepProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ExternalNavStepProps]
    }
    
    @scala.inline
    implicit class ExternalNavStepPropsMutableBuilder[Self <: ExternalNavStepProps] (val x: Self) extends AnyVal {
  ...
  object NavStepProps {
    ...
    @scala.inline
    def apply(active: Boolean & js.UndefOr[Boolean], visited: Boolean & js.UndefOr[Boolean]): NavStepProps = {
    ...
    @scala.inline
    implicit class NavStepPropsMutableBuilder[Self <: NavStepProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActive(value: Boolean & js.UndefOr[Boolean]): Self = StObject.set(x, "active", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setVisited(value: Boolean & js.UndefOr[Boolean]): Self = StObject.set(x, "visited", value.asInstanceOf[js.Any])
