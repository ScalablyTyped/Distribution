...
object srcComponentsLabelWithOptionsMod {
  
  @JSImport("wix-ui-core/src/components/label-with-options", "LabelWithOptions")
  @js.native
  class LabelWithOptions protected ()
    extends typings.wixUiCore.srcComponentsLabelWithOptionsLabelWithOptionsMod.LabelWithOptions {
  ...
  object LabelWithOptions {
    ...
    @JSImport("wix-ui-core/src/components/label-with-options", "LabelWithOptions.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/label-with-options", "LabelWithOptions.displayName")
    @js.native
