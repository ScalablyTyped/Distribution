...
object componentsInputInputMod {
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/input/Input", "Input")
  @js.native
  ...
  object Input {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/input/Input", "Input.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/input/Input", "Input.displayName")
    @js.native
  ...
  */
  ...
  /* Inlined parent type-zoo.type-zoo.Omit<react.react.InputHTMLAttributes<std.HTMLInputElement>, wix-ui-core.wix-ui-core/dist/standalone/src/components/input/Input.OmittedInputProps> */
