...
object testFilePickerButtonTestFixtureMod {
  
  @js.native
  sealed trait DataHook extends StObject
  @JSImport("wix-ui-core/dist/standalone/src/components/file-picker-button/test/FilePickerButtonTestFixture", "DataHook")
  @js.native
  object DataHook extends StObject {
    ...
    sealed trait FileNames
      extends StObject
         with DataHook
    /* "file-names" */ val FileNames: typings.wixUiCore.testFilePickerButtonTestFixtureMod.DataHook.FileNames & String = js.native
    
    @js.native
    sealed trait FilePickerButton
      extends StObject
         with DataHook
    /* "file-picker-button" */ val FilePickerButton: typings.wixUiCore.testFilePickerButtonTestFixtureMod.DataHook.FilePickerButton & String = js.native
    
    @js.native
    sealed trait OnChangeCount
      extends StObject
         with DataHook
    /* "on-change-count" */ val OnChangeCount: typings.wixUiCore.testFilePickerButtonTestFixtureMod.DataHook.OnChangeCount & String = js.native
    
    @js.native
    sealed trait ResetButton
      extends StObject
         with DataHook
    /* "reset-button" */ val ResetButton: typings.wixUiCore.testFilePickerButtonTestFixtureMod.DataHook.ResetButton & String = js.native
  }
  
  @JSImport("wix-ui-core/dist/standalone/src/components/file-picker-button/test/FilePickerButtonTestFixture", "FilePickerButtonTestFixture")
  @js.native
