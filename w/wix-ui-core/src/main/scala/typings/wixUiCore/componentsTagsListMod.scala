...
object componentsTagsListMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/tags-list", "FocusableTag")
  @js.native
  class FocusableTag protected ()
    extends typings.wixUiCore.tagsListTagMod.FocusableTag {
  ...
  object FocusableTag {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/tags-list", "FocusableTag.displayName")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/tags-list", "FocusableTag.propTypes")
    @js.native
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/tags-list", "Tag")
  @js.native
  class Tag protected ()
    extends typings.wixUiCore.tagsListTagMod.Tag {
    def this(props: TagProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
  ...
  object Tag {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/tags-list", "Tag.displayName")
    @js.native
    def displayName: DisplayNames = js.native
    inline def displayName_=(x: DisplayNames): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/dist/standalone/src/components/tags-list", "Tag.propTypes")
    @js.native
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/tags-list", "TagsList")
  @js.native
