...
object srcTestkitEnzymeMod {
  
  @JSImport("wix-ui-core/src/testkit/enzyme", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/src/testkit/enzyme", "NavStepperDriver")
  @js.native
  class NavStepperDriver protected ()
    extends typings.wixUiCore.navStepperNavStepperDriverMod.NavStepperDriver {
  ...
  @scala.inline
  def navStepperTestkitFactory(obj: WrapperData): typings.wixUiCore.navStepperNavStepperDriverMod.NavStepperDriver = ^.asInstanceOf[js.Dynamic].applyDynamic("navStepperTestkitFactory")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.wixUiCore.navStepperNavStepperDriverMod.NavStepperDriver]
  
  @scala.inline
  def paginationTestkitFactory(obj: WrapperData): ClickNavButton = ^.asInstanceOf[js.Dynamic].applyDynamic("paginationTestkitFactory")(obj.asInstanceOf[js.Any]).asInstanceOf[ClickNavButton]
