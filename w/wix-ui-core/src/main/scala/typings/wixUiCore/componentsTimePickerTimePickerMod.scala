...
import typings.wixUiCore.componentsInputMod.Input
import typings.wixUiCore.componentsTimePickerConstantsMod.AmPmOptions
import typings.wixUiCore.componentsTimePickerConstantsMod.FIELD
...
object componentsTimePickerTimePickerMod {
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/time-picker/TimePicker", "TimePicker")
  @js.native
