...
import typings.wixUiCore.anon.TypeofPopoverDisplayName
import typings.wixUiCore.srcComponentsPopoverPopoverMod.Popover
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object docsPopoverStoryMod {
  
  object default {
    
    @JSImport("wix-ui-core/src/components/popover/docs/Popover.story", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("wix-ui-core/src/components/popover/docs/Popover.story", "default.category")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/popover/docs/Popover.story", "default.component")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/popover/docs/Popover.story", "default.component")
    @js.native
    def component: TypeofPopoverDisplayName = js.native
    
    @JSImport("wix-ui-core/src/components/popover/docs/Popover.story", "default.componentPath")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/popover/docs/Popover.story", "default.componentProps")
    @js.native
    ...
    inline def component_=(x: TypeofPopoverDisplayName): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("component")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/src/components/popover/docs/Popover.story", "default.exampleProps")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/popover/docs/Popover.story", "default.sections")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/popover/docs/Popover.story", "default.storyName")
    @js.native
