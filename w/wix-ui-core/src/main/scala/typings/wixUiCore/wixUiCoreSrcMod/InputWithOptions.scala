...
@JSImport("wix-ui-core/src", "InputWithOptions")
@js.native
class InputWithOptions protected ()
  extends typings.wixUiCore.srcComponentsInputWithOptionsMod.InputWithOptions {
...
object InputWithOptions {
  ...
  @JSImport("wix-ui-core/src", "InputWithOptions.bypassDefaultPropsTypecheck")
  @js.native
  ...
  @JSImport("wix-ui-core/src", "InputWithOptions.defaultProps")
  @js.native
  ...
  @JSImport("wix-ui-core/src", "InputWithOptions.displayName")
  @js.native
