...
@JSImport("wix-ui-core/src", "HorizontalMenuColumnsLayout")
@js.native
class HorizontalMenuColumnsLayout protected ()
  extends typings.wixUiCore.componentsHorizontalMenuHorizontalMenuColumnsLayoutMod.HorizontalMenuColumnsLayout {
...
object HorizontalMenuColumnsLayout {
  ...
  @JSImport("wix-ui-core/src", "HorizontalMenuColumnsLayout.defaultProps")
  @js.native
  ...
  @JSImport("wix-ui-core/src", "HorizontalMenuColumnsLayout.displayName")
  @js.native
