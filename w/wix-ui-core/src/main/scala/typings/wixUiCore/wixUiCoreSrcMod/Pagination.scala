...
@JSImport("wix-ui-core/src", "Pagination")
@js.native
class Pagination protected ()
  extends typings.wixUiCore.srcComponentsPaginationMod.Pagination {
...
object Pagination {
  ...
  @JSImport("wix-ui-core/src", "Pagination.defaultProps")
  @js.native
  ...
  @JSImport("wix-ui-core/src", "Pagination.displayName")
  @js.native
