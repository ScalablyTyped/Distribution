...
@JSImport("wix-ui-core/src", "FilePickerButton")
@js.native
class FilePickerButton protected ()
  extends typings.wixUiCore.srcComponentsFilePickerButtonMod.FilePickerButton {
