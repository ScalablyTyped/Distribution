...
@JSImport("wix-ui-core/src", "HorizontalMenuGridLayout")
@js.native
class HorizontalMenuGridLayout protected ()
  extends typings.wixUiCore.componentsHorizontalMenuHorizontalMenuGridLayoutMod.HorizontalMenuGridLayout {
...
object HorizontalMenuGridLayout {
  ...
  @JSImport("wix-ui-core/src", "HorizontalMenuGridLayout.displayName")
  @js.native
