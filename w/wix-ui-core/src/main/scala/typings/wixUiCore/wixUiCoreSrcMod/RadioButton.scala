...
@JSImport("wix-ui-core/src", "RadioButton")
@js.native
class RadioButton protected ()
  extends typings.wixUiCore.srcComponentsRadioButtonMod.RadioButton {
...
object RadioButton {
  ...
  @JSImport("wix-ui-core/src", "RadioButton.bypassDefaultPropsTypecheck")
  @js.native
  ...
  @JSImport("wix-ui-core/src", "RadioButton.defaultProps")
  @js.native
  ...
  @JSImport("wix-ui-core/src", "RadioButton.displayName")
  @js.native
