...
@JSImport("wix-ui-core/src", "HorizontalMenuItem")
@js.native
class HorizontalMenuItem protected ()
  extends typings.wixUiCore.componentsHorizontalMenuHorizontalMenuItemMod.HorizontalMenuItem {
...
object HorizontalMenuItem {
  ...
  @JSImport("wix-ui-core/src", "HorizontalMenuItem.defaultProps")
  @js.native
  ...
  @JSImport("wix-ui-core/src", "HorizontalMenuItem.displayName")
  @js.native
