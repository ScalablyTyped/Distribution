...
@JSImport("wix-ui-core/src", "PopoverNext")
@js.native
class PopoverNext protected ()
  extends typings.wixUiCore.srcComponentsPopoverNextMod.PopoverNext {
...
object PopoverNext {
  ...
  @JSImport("wix-ui-core/src", "PopoverNext.Content")
  @js.native
  ...
  @JSImport("wix-ui-core/src", "PopoverNext.Element")
  @js.native
  ...
  @JSImport("wix-ui-core/src", "PopoverNext.defaultProps")
  @js.native
  ...
  @JSImport("wix-ui-core/src", "PopoverNext.displayName")
  @js.native
