...
import typings.wixUiCore.horizontalMenuHorizontalMenuItemHorizontalMenuItemMod.ExpandSize
import typings.wixUiCore.wixUiCoreStrings.menuItemContext
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object horizontalMenuItemHorizontalMenuItemContextMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/horizontal-menu-item/HorizontalMenuItemContext", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/horizontal-menu-item/HorizontalMenuItemContext", "HorizontalMenuItemContext")
  @js.native
