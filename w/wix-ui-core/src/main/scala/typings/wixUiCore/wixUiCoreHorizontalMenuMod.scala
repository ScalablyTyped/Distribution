...
object wixUiCoreHorizontalMenuMod {
  
  @JSImport("wix-ui-core/horizontal-menu", "HorizontalMenu")
  @js.native
  ...
  object HorizontalMenu {
    ...
    @JSImport("wix-ui-core/horizontal-menu", "HorizontalMenu.Item")
    @js.native
    ...
    @JSImport("wix-ui-core/horizontal-menu", "HorizontalMenu.Layout")
    @js.native
    ...
    @JSImport("wix-ui-core/horizontal-menu", "HorizontalMenu.displayName")
    @js.native
