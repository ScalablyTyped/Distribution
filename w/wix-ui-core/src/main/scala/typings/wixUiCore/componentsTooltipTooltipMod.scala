...
object componentsTooltipTooltipMod {
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/tooltip/Tooltip", "Tooltip")
  @js.native
  ...
  object Tooltip {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/tooltip/Tooltip", "Tooltip.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/tooltip/Tooltip", "Tooltip.displayName")
    @js.native
