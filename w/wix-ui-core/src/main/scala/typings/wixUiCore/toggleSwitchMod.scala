...
object toggleSwitchMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/toggle-switch", "ToggleSwitch")
  @js.native
  class ToggleSwitch protected ()
    extends typings.wixUiCore.toggleSwitchToggleSwitchMod.ToggleSwitch {
  ...
  object ToggleSwitch {
    ...
    @JSImport("wix-ui-core/dist/src/components/toggle-switch", "ToggleSwitch.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/toggle-switch", "ToggleSwitch.displayName")
    @js.native
