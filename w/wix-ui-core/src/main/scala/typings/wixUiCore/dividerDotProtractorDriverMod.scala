...
object dividerDotProtractorDriverMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/deprecated/divider/Divider.protractor.driver", "dividerDriverFactory")
  @js.native
