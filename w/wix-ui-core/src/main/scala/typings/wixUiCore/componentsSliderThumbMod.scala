...
object componentsSliderThumbMod {
  
  @JSImport("wix-ui-core/src/components/slider/Thumb", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/src/components/slider/Thumb", "Thumb")
  @js.native
