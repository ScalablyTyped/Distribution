...
object wixUiCoreAvatarMod {
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("wix-ui-core/src/components/avatar", "Avatar")
  @js.native
  ...
  object Avatar {
    ...
    @JSImport("wix-ui-core/src/components/avatar", "Avatar.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/avatar", "Avatar.displayName")
    @js.native
