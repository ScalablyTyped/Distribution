...
import typings.wixUiCore.anon.`3`
import typings.wixUiCore.signatureInputSignatureInputContextMod.SignatureInputContextValue
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object signatureInputTitleTitleMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/signature-input/title/Title", "Title")
  @js.native
  val Title: FunctionComponent[PickTitlePropschildrenChildren] = js.native
  
  type TitleChildrenFn = js.Function1[/* childrenFn */ `3`, Element]
