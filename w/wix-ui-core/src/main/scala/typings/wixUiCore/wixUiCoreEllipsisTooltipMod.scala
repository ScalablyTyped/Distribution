...
object wixUiCoreEllipsisTooltipMod {
  
  @JSImport("wix-ui-core/ellipsis-tooltip", "EllipsisTooltip")
  @js.native
  class EllipsisTooltip protected ()
    extends typings.wixUiCore.ellipsisTooltipMod.EllipsisTooltip {
  ...
  object EllipsisTooltip {
    ...
    @JSImport("wix-ui-core/ellipsis-tooltip", "EllipsisTooltip.defaultProps")
    @js.native
