...
object inputWithOptionsProtractorDriverMod {
  
  @JSImport("wix-ui-core/dist/src/components/input-with-options/InputWithOptions.protractor.driver", "inputWithOptionsDriverFactory")
  @js.native
