...
object horizontalMenuHorizontalMenuContextMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/HorizontalMenuContext", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/HorizontalMenuContext", "HorizontalMenuContext")
  @js.native
