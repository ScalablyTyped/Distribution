...
object srcComponentsPopoverNextMod {
  
  @JSImport("wix-ui-core/src/components/popover-next", "PopoverNext")
  @js.native
  class PopoverNext protected ()
    extends typings.wixUiCore.srcComponentsPopoverNextPopoverNextMod.PopoverNext {
  ...
  object PopoverNext {
    ...
    @JSImport("wix-ui-core/src/components/popover-next", "PopoverNext.Content")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/popover-next", "PopoverNext.Element")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/popover-next", "PopoverNext.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/popover-next", "PopoverNext.displayName")
    @js.native
