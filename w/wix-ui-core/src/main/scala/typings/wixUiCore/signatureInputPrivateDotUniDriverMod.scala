...
object signatureInputPrivateDotUniDriverMod {
  
  @JSImport("wix-ui-core/src/components/signature-input/test/SignatureInput.private.uni.driver", JSImport.Namespace)
  @js.native
