...
import typings.wixUiCore.componentsSignatureInputSigningPadSigningPadMod.SigningPadOwnProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object signatureInputTestSignatureInputTestFixtureMod {
  
  @JSImport("wix-ui-core/src/components/signature-input/test/SignatureInputTestFixture", "SignatureInputTestFixture")
  @js.native
  ...
  object TEST_IDS {
    ...
    @JSImport("wix-ui-core/src/components/signature-input/test/SignatureInputTestFixture", "TEST_IDS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("wix-ui-core/src/components/signature-input/test/SignatureInputTestFixture", "TEST_IDS.CLEAR_BUTTON")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/signature-input/test/SignatureInputTestFixture", "TEST_IDS.PAD")
    @js.native
    def PAD: String = js.native
    @scala.inline
    def PAD_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PAD")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/src/components/signature-input/test/SignatureInputTestFixture", "TEST_IDS.ROOT")
    @js.native
    def ROOT: String = js.native
    @scala.inline
    def ROOT_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ROOT")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/src/components/signature-input/test/SignatureInputTestFixture", "TEST_IDS.TITLE")
    @js.native
