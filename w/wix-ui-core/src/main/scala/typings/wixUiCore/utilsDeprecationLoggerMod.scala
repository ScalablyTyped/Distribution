...
object utilsDeprecationLoggerMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/utils/deprecation-logger", JSImport.Namespace)
  @js.native
  ...
  @JSImport("wix-ui-core/dist/standalone/src/utils/deprecation-logger", "depLogger")
  @js.native
