...
import typings.wixUiCore.componentsPaginationPaginationMod.PaginationMode
...
object paginationRootMinWidthMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/pagination/root-min-width", JSImport.Namespace)
  @js.native
