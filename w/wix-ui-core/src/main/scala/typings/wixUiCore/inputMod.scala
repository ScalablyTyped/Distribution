...
object inputMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/input", "Input")
  @js.native
  class Input protected ()
    extends typings.wixUiCore.inputInputMod.Input {
  ...
  object Input {
    ...
    @JSImport("wix-ui-core/dist/src/components/input", "Input.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/input", "Input.displayName")
    @js.native
