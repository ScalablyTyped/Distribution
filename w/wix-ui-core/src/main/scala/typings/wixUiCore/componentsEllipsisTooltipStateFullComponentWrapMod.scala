...
object componentsEllipsisTooltipStateFullComponentWrapMod {
  
  @JSImport("wix-ui-core/src/components/ellipsis-tooltip/StateFullComponentWrap", "StateFullComponentWrap")
  @js.native
