...
object inputWithOptionsDotProtractorDriverMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/input-with-options/InputWithOptions.protractor.driver", "inputWithOptionsDriverFactory")
  @js.native
