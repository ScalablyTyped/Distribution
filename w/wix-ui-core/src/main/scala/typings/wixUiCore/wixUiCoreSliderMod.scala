...
object wixUiCoreSliderMod {
  
  @JSImport("wix-ui-core/slider", "Slider")
  @js.native
  ...
  object Slider {
    ...
    @JSImport("wix-ui-core/slider", "Slider.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/slider", "Slider.displayName")
    @js.native
