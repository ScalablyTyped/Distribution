...
object googleMapsIframeClientProtractorDriverMod {
  
  @JSImport("wix-ui-core/dist/src/clients/GoogleMaps/GoogleMapsIframeClient.protractor.driver", "googleMapsIframeClientDriverFactory")
  @js.native
