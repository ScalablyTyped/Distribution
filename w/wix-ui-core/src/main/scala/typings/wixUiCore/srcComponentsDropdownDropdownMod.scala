...
object srcComponentsDropdownDropdownMod {
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("wix-ui-core/src/components/dropdown/Dropdown", "Dropdown")
  @js.native
  ...
  object Dropdown {
    ...
    @JSImport("wix-ui-core/src/components/dropdown/Dropdown", "Dropdown.displayName")
    @js.native
  ...
  @JSImport("wix-ui-core/src/components/dropdown/Dropdown", "DropdownComponent")
  @js.native
  ...
  object DropdownComponent {
    ...
    @JSImport("wix-ui-core/src/components/dropdown/Dropdown", "DropdownComponent.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  ...
  trait DropdownProps extends StObject {
    ...
    var openTrigger: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify OPEN_TRIGGER_TYPE */ js.Any = js.native
