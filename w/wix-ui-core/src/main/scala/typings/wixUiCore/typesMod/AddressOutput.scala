...
object AddressOutput {
  ...
  @scala.inline
  def apply(address: InternalAddress, googleResult: Geocode | PlaceDetails, originValue: String): AddressOutput = {
  ...
  implicit class AddressOutputMutableBuilder[Self <: AddressOutput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddress(value: InternalAddress): Self = StObject.set(x, "address", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGoogleResult(value: Geocode | PlaceDetails): Self = StObject.set(x, "googleResult", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOriginValue(value: String): Self = StObject.set(x, "originValue", value.asInstanceOf[js.Any])
  }
}
