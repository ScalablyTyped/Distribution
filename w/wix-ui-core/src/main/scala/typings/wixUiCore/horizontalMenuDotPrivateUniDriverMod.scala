...
object horizontalMenuDotPrivateUniDriverMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/test/HorizontalMenu.private.uni.driver", JSImport.Namespace)
  @js.native
