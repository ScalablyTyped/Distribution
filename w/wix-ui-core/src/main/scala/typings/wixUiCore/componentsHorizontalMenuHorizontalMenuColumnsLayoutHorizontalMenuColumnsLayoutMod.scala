...
object componentsHorizontalMenuHorizontalMenuColumnsLayoutHorizontalMenuColumnsLayoutMod extends Shortcut {
  
  @JSImport("wix-ui-core/src/components/horizontal-menu/horizontal-menu-columns-layout/HorizontalMenuColumnsLayout", JSImport.Default)
  @js.native
  val default: FC[PickPickHorizontalMenuColColumnGap] = js.native
  
  @js.native
  sealed trait ColumnsAlignment extends StObject
  @JSImport("wix-ui-core/src/components/horizontal-menu/horizontal-menu-columns-layout/HorizontalMenuColumnsLayout", "ColumnsAlignment")
  @js.native
  object ColumnsAlignment extends StObject {
    ...
    /* "center" */ val Center: typings.wixUiCore.componentsHorizontalMenuHorizontalMenuColumnsLayoutHorizontalMenuColumnsLayoutMod.ColumnsAlignment.Center & String = js.native
    
    @js.native
    sealed trait Justify
      extends StObject
         with ColumnsAlignment
    /* "justify" */ val Justify: typings.wixUiCore.componentsHorizontalMenuHorizontalMenuColumnsLayoutHorizontalMenuColumnsLayoutMod.ColumnsAlignment.Justify & String = js.native
    
    @js.native
    sealed trait Left
      extends StObject
         with ColumnsAlignment
    /* "left" */ val Left: typings.wixUiCore.componentsHorizontalMenuHorizontalMenuColumnsLayoutHorizontalMenuColumnsLayoutMod.ColumnsAlignment.Left & String = js.native
    
    @js.native
    sealed trait Right
      extends StObject
         with ColumnsAlignment
    /* "right" */ val Right: typings.wixUiCore.componentsHorizontalMenuHorizontalMenuColumnsLayoutHorizontalMenuColumnsLayoutMod.ColumnsAlignment.Right & String = js.native
  }
  
  @JSImport("wix-ui-core/src/components/horizontal-menu/horizontal-menu-columns-layout/HorizontalMenuColumnsLayout", "HorizontalMenuColumnsLayout")
  @js.native
  ...
  object HorizontalMenuColumnsLayout {
    ...
    @JSImport("wix-ui-core/src/components/horizontal-menu/horizontal-menu-columns-layout/HorizontalMenuColumnsLayout", "HorizontalMenuColumnsLayout.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/horizontal-menu/horizontal-menu-columns-layout/HorizontalMenuColumnsLayout", "HorizontalMenuColumnsLayout.displayName")
    @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `componentsHorizontalMenuHorizontalMenuColumnsLayoutHorizontalMenuColumnsLayoutMod.foo` */
