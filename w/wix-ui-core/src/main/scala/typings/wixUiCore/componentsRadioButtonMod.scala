...
object componentsRadioButtonMod {
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/radio-button", "RadioButton")
  @js.native
  class RadioButton protected ()
    extends typings.wixUiCore.componentsRadioButtonRadioButtonMod.RadioButton {
  ...
  object RadioButton {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/radio-button", "RadioButton.bypassDefaultPropsTypecheck")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/radio-button", "RadioButton.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/radio-button", "RadioButton.displayName")
    @js.native
