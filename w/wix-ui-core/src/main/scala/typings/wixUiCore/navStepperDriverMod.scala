...
object navStepperDriverMod {
  
  @JSImport("wix-ui-core/dist/src/components/nav-stepper/NavStepper.driver", "NavStepperDriver")
  @js.native
  ...
  @JSImport("wix-ui-core/dist/src/components/nav-stepper/NavStepper.driver", "navStepperDriverFactory")
  @js.native
