...
object dropdownOptionDotProtractorDriverMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/dropdown-option/DropdownOption.protractor.driver", "dropdownOptionDriverFactory")
  @js.native
