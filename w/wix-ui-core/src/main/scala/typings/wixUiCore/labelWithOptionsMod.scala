...
object labelWithOptionsMod {
  
  @JSImport("wix-ui-core/dist/src/components/label-with-options", "LabelWithOptions")
  @js.native
  class LabelWithOptions protected ()
    extends typings.wixUiCore.labelWithOptionsLabelWithOptionsMod.LabelWithOptions {
  ...
  object LabelWithOptions {
    ...
    @JSImport("wix-ui-core/dist/src/components/label-with-options", "LabelWithOptions.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/label-with-options", "LabelWithOptions.displayName")
    @js.native
