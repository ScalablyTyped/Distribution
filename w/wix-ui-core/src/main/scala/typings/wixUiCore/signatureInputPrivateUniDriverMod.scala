...
object signatureInputPrivateUniDriverMod {
  
  @JSImport("wix-ui-core/dist/src/components/signature-input/test/SignatureInput.private.uni.driver", JSImport.Namespace)
  @js.native
