...
object avatarDotstoryMod {
  
  object default {
    
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar.story", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar.story", "default.category")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar.story", "default.component")
    @js.native
    class component () extends AvatarComponent
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar.story", "default.component")
    @js.native
    def component: TypeofAvatarComponentInstantiable = js.native
    
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar.story", "default.componentPath")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar.story", "default.componentProps")
    @js.native
    ...
    inline def component_=(x: TypeofAvatarComponentInstantiable): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("component")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar.story", "default.exampleProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/avatar/avatar.story", "default.storyName")
    @js.native
