...
object radioButtonMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/radio-button", "RadioButton")
  @js.native
  class RadioButton protected ()
    extends typings.wixUiCore.radioButtonRadioButtonMod.RadioButton {
  ...
  object RadioButton {
    ...
    @JSImport("wix-ui-core/dist/src/components/radio-button", "RadioButton.bypassDefaultPropsTypecheck")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/radio-button", "RadioButton.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/radio-button", "RadioButton.displayName")
    @js.native
