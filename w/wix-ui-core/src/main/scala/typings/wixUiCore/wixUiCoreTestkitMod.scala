...
import typings.wixUiCore.buttonButtonDriverMod.ButtonDriver
import typings.wixUiCore.buttonNextUniDotDriverMod.ButtonNextDriver
import typings.wixUiCore.circularProgressBarCircularProgressBarDriverMod.CircularProgressBarDriver
import typings.wixUiCore.circularProgressBarUniDotDriverMod.CircularProgressBarUniDriver
import typings.wixUiCore.linearProgressBarLinearProgressBarDriverMod.LinearProgressBarDriver
import typings.wixUiCore.linearProgressBarUniDotDriverMod.LinearProgressBarUniDriver
import typings.wixUiCore.signatureInputUniDotDriverMod.SignatureInputDriver
import typings.wixUiCore.stylableBadgeBadgeDriverMod.BadgeDriver
import typings.wixUiCore.thumbnailThumbnailDriverMod.ThumbnailDriver
import typings.wixUiCore.toggleSwitchUniDotDriverMod.ToggleSwitchUniDriver
import typings.wixUiTestUtils.vanillaVanillaMod.TestkitArgs
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object wixUiCoreTestkitMod {
  
  @JSImport("wix-ui-core/src/testkit", JSImport.Namespace)
  @js.native
  ...
  @scala.inline
  def paginationTestkitFactory(testkitArgs: TestkitArgs): ClickNavButton = ^.asInstanceOf[js.Dynamic].applyDynamic("paginationTestkitFactory")(testkitArgs.asInstanceOf[js.Any]).asInstanceOf[ClickNavButton]
