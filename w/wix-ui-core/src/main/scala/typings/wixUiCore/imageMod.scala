...
object imageMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/image", "FALLBACK_IMAGE")
  @js.native
  val FALLBACK_IMAGE: String = js.native
  
  @JSImport("wix-ui-core/dist/src/components/image", "Image")
  @js.native
  class Image protected ()
    extends typings.wixUiCore.imageImageMod.Image {
  ...
  @JSImport("wix-ui-core/dist/src/components/image", "ImageStatus")
  @js.native
