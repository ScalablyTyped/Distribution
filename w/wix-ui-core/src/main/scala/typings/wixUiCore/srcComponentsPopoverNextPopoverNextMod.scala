...
object srcComponentsPopoverNextPopoverNextMod {
  
  @JSImport("wix-ui-core/src/components/popover-next/popover-next", "PopoverNext")
  @js.native
  ...
  object PopoverNext {
    ...
    @JSImport("wix-ui-core/src/components/popover-next/popover-next", "PopoverNext.Content")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/popover-next/popover-next", "PopoverNext.Element")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/popover-next/popover-next", "PopoverNext.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/popover-next/popover-next", "PopoverNext.displayName")
    @js.native
