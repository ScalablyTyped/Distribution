...
object focusableHOCDotdriverMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/hocs/Focusable/FocusableHOC.driver", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/dist/standalone/src/hocs/Focusable/FocusableHOC.driver", "PureChildComponent")
  @js.native
  ...
  object PureChildComponent {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/hocs/Focusable/FocusableHOC.driver", "PureChildComponent.staticVariable")
    @js.native
  ...
  @JSImport("wix-ui-core/dist/standalone/src/hocs/Focusable/FocusableHOC.driver", "WithFocusableComp")
  @js.native
