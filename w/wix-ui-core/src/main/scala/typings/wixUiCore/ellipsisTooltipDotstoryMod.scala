...
import typings.wixUiCore.anon.TypeofEllipsisTooltipInstantiable
import typings.wixUiCore.componentsEllipsisTooltipMod.EllipsisTooltip
import typings.wixUiCore.storiesUtilsMod.Category
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object ellipsisTooltipDotstoryMod {
  
  object default {
    
    @JSImport("wix-ui-core/dist/standalone/src/components/ellipsis-tooltip/EllipsisTooltip.story", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("wix-ui-core/dist/standalone/src/components/ellipsis-tooltip/EllipsisTooltip.story", "default.category")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/ellipsis-tooltip/EllipsisTooltip.story", "default.component")
    @js.native
    class component () extends EllipsisTooltip
    @JSImport("wix-ui-core/dist/standalone/src/components/ellipsis-tooltip/EllipsisTooltip.story", "default.component")
    @js.native
    def component: TypeofEllipsisTooltipInstantiable = js.native
    
    @JSImport("wix-ui-core/dist/standalone/src/components/ellipsis-tooltip/EllipsisTooltip.story", "default.componentPath")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/ellipsis-tooltip/EllipsisTooltip.story", "default.componentProps")
    @js.native
    ...
    inline def component_=(x: TypeofEllipsisTooltipInstantiable): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("component")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/dist/standalone/src/components/ellipsis-tooltip/EllipsisTooltip.story", "default.exampleProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/ellipsis-tooltip/EllipsisTooltip.story", "default.storyName")
    @js.native
