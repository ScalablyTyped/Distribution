...
object componentsCircularProgressBarCircularProgressBarMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/circular-progress-bar/CircularProgressBar", "CircularProgressBar")
  @js.native
