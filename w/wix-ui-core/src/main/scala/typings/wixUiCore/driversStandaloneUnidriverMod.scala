...
import typings.wixUiCore.labelDotUniDriverMod.LabelDriver
...
import typings.wixUiCore.paginationDotUniDriverMod.PaginationDriver
...
object driversStandaloneUnidriverMod {
  
  @JSImport("wix-ui-core/drivers-standalone/unidriver", JSImport.Namespace)
  @js.native
