...
object wixUiCoreLabelWithOptionsMod {
  
  @JSImport("wix-ui-core/label-with-options", "LabelWithOptions")
  @js.native
  ...
  object LabelWithOptions {
    ...
    @JSImport("wix-ui-core/label-with-options", "LabelWithOptions.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/label-with-options", "LabelWithOptions.displayName")
    @js.native
