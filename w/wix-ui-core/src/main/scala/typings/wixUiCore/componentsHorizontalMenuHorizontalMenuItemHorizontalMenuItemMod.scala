...
object componentsHorizontalMenuHorizontalMenuItemHorizontalMenuItemMod {
  
  @JSImport("wix-ui-core/src/components/horizontal-menu/horizontal-menu-item/HorizontalMenuItem", "HorizontalMenuItem")
  @js.native
  ...
  object HorizontalMenuItem {
    ...
    @JSImport("wix-ui-core/src/components/horizontal-menu/horizontal-menu-item/HorizontalMenuItem", "HorizontalMenuItem.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/horizontal-menu/horizontal-menu-item/HorizontalMenuItem", "HorizontalMenuItem.displayName")
    @js.native
