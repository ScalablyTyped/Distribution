...
import typings.wixUiCore.signatureInputSigningPadSigningPadMod.SigningPadOwnProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object testSignatureInputTestFixtureMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/signature-input/test/SignatureInputTestFixture", "SignatureInputTestFixture")
  @js.native
  ...
  object TEST_IDS {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/signature-input/test/SignatureInputTestFixture", "TEST_IDS")
    @js.native
