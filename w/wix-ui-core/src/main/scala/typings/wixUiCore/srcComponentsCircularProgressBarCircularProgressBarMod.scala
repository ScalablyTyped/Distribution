...
object srcComponentsCircularProgressBarCircularProgressBarMod {
  
  @JSImport("wix-ui-core/src/components/circular-progress-bar/CircularProgressBar", "CircularProgressBar")
  @js.native
