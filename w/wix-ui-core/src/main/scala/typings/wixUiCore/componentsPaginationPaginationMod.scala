...
object componentsPaginationPaginationMod {
  ...
  @JSImport("wix-ui-core/dist/standalone/src/components/pagination/Pagination", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/dist/standalone/src/components/pagination/Pagination", "Pagination")
  @js.native
  ...
  object Pagination {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/pagination/Pagination", "Pagination.defaultProps")
    @js.native
    def defaultProps: PartialPaginationPropsClassName = js.native
    @scala.inline
    def defaultProps_=(x: PartialPaginationPropsClassName): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/dist/standalone/src/components/pagination/Pagination", "Pagination.displayName")
    @js.native
