...
object wixUiCoreAutocompleteMod {
  
  @JSImport("wix-ui-core/src/components/autocomplete", "Autocomplete")
  @js.native
  class Autocomplete protected ()
    extends typings.wixUiCore.srcComponentsAutocompleteAutocompleteMod.Autocomplete {
  ...
  object Autocomplete {
    ...
    @JSImport("wix-ui-core/src/components/autocomplete", "Autocomplete.displayName")
    @js.native
