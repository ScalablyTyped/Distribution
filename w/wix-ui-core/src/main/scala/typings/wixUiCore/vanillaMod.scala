...
object vanillaMod {
  ...
  inline def addressInputDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): Blur = ^.asInstanceOf[js.Dynamic].applyDynamic("addressInputDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[Blur]
  
  inline def autocompleteDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): Click = ^.asInstanceOf[js.Dynamic].applyDynamic("autocompleteDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[Click]
  ...
  inline def checkboxDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): Exists = ^.asInstanceOf[js.Dynamic].applyDynamic("checkboxDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[Exists]
  ...
  inline def dropdownContentDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): GetOptionsCount = ^.asInstanceOf[js.Dynamic].applyDynamic("dropdownContentDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[GetOptionsCount]
  ...
  inline def dropdownOptionDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): ClassName = ^.asInstanceOf[js.Dynamic].applyDynamic("dropdownOptionDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[ClassName]
  ...
  inline def inputDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): Focus = ^.asInstanceOf[js.Dynamic].applyDynamic("inputDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[Focus]
  
  inline def inputWithOptionsDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): Click = ^.asInstanceOf[js.Dynamic].applyDynamic("inputWithOptionsDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[Click]
  
  inline def labelDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): GetForAttribute = ^.asInstanceOf[js.Dynamic].applyDynamic("labelDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[GetForAttribute]
  
  inline def labelWithOptionsDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): CheckboxDriverAt = ^.asInstanceOf[js.Dynamic].applyDynamic("labelWithOptionsDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[CheckboxDriverAt]
  ...
  inline def paginationDriverFactory(hasRootSimulate: typings.wixUiCore.anon.Element): ChangeInput = ^.asInstanceOf[js.Dynamic].applyDynamic("paginationDriverFactory")(hasRootSimulate.asInstanceOf[js.Any]).asInstanceOf[ChangeInput]
  
  inline def popoverDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): GetArrowElement = ^.asInstanceOf[js.Dynamic].applyDynamic("popoverDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[GetArrowElement]
  
  inline def radioButtonDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): IconExists = ^.asInstanceOf[js.Dynamic].applyDynamic("radioButtonDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[IconExists]
  
  inline def sliderDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): AriaLabel = ^.asInstanceOf[js.Dynamic].applyDynamic("sliderDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[AriaLabel]
  ...
  inline def timePickerDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): ClickTickerDown = ^.asInstanceOf[js.Dynamic].applyDynamic("timePickerDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[ClickTickerDown]
  
  inline def toggleSwitchDriverFactory(hasElementEventTrigger: typings.wixUiCore.anon.Element): GetId = ^.asInstanceOf[js.Dynamic].applyDynamic("toggleSwitchDriverFactory")(hasElementEventTrigger.asInstanceOf[js.Any]).asInstanceOf[GetId]
