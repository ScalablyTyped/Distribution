...
object horizontalMenuLayoutCalculatePositioningMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/horizontal-menu/horizontal-menu-layout/calculatePositioning", JSImport.Namespace)
  @js.native
