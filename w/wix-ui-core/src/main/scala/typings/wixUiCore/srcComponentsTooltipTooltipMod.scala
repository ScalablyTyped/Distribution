...
object srcComponentsTooltipTooltipMod {
  
  @JSImport("wix-ui-core/src/components/tooltip/Tooltip", "Tooltip")
  @js.native
  ...
  object Tooltip {
    ...
    @JSImport("wix-ui-core/src/components/tooltip/Tooltip", "Tooltip.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/tooltip/Tooltip", "Tooltip.displayName")
    @js.native
