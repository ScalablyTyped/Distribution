...
object srcComponentsMediaImageMediaImageMod {
  
  @JSImport("wix-ui-core/src/components/media-image/media-image", "MediaImage")
  @js.native
  ...
  object MediaImage {
    ...
    @JSImport("wix-ui-core/src/components/media-image/media-image", "MediaImage.defaultProps")
    @js.native
    def defaultProps: `4` = js.native
    inline def defaultProps_=(x: `4`): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/src/components/media-image/media-image", "MediaImage.displayName")
    @js.native
  ...
  @JSImport("wix-ui-core/src/components/media-image/media-image", "MediaImageScaling")
  @js.native
  ...
  @JSImport("wix-ui-core/src/components/media-image/media-image", "MediaImageUpscaleMethod")
  @js.native
  object MediaImageUpscaleMethod extends StObject {
    ...
    /* "auto" */ val AUTO: typings.wixUiCore.srcComponentsMediaImageMediaImageMod.MediaImageUpscaleMethod.AUTO & String = js.native
    
    @js.native
    sealed trait CLASSIC
      extends StObject
         with MediaImageUpscaleMethod
    /* "classic" */ val CLASSIC: typings.wixUiCore.srcComponentsMediaImageMediaImageMod.MediaImageUpscaleMethod.CLASSIC & String = js.native
    
    @js.native
    sealed trait SUPER
      extends StObject
         with MediaImageUpscaleMethod
    /* "super" */ val SUPER: typings.wixUiCore.srcComponentsMediaImageMediaImageMod.MediaImageUpscaleMethod.SUPER & String = js.native
  }
