...
object tooltipMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/tooltip", "Tooltip")
  @js.native
  class Tooltip protected ()
    extends typings.wixUiCore.tooltipTooltipMod.Tooltip {
  ...
  object Tooltip {
    ...
    @JSImport("wix-ui-core/dist/src/components/tooltip", "Tooltip.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/tooltip", "Tooltip.displayName")
    @js.native
