...
object googleMapsIframeTestUtilsMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/clients/GoogleMaps/IframeTestUtils", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("wix-ui-core/dist/standalone/src/clients/GoogleMaps/IframeTestUtils", "EventEmitterMock")
  @js.native
