...
object srcPaletteMod {
  
  object palette {
    
    @JSImport("wix-ui-core/dist/standalone/src/palette", "palette")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("wix-ui-core/dist/standalone/src/palette", "palette.black")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/palette", "palette.grey")
    @js.native
    def grey: String = js.native
    inline def grey_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("grey")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/dist/standalone/src/palette", "palette.transparent")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/palette", "palette.white")
    @js.native
