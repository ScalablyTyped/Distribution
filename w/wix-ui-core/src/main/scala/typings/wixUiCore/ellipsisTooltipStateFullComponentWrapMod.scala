...
object ellipsisTooltipStateFullComponentWrapMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/ellipsis-tooltip/StateFullComponentWrap", "StateFullComponentWrap")
  @js.native
