...
object popoverNextComponentsPopperMod extends Shortcut {
  
  @JSImport("wix-ui-core/src/components/popover-next/components/Popper", JSImport.Default)
  @js.native
  val default: FC[PopperProps] = js.native
  
  /* Inlined wix-ui-core.wix-ui-core/src/components/popover/utils/getModifiers.ModifiersParams & std.Pick<wix-ui-core.wix-ui-core/src/components/popover-next/popover-next.PopoverNextProps, 'maxWidth' | 'showArrow' | 'zIndex' | 'moveArrowTo' | 'customArrow' | 'id' | 'role'> & {  contentHook :string | undefined, grabScheduleUpdater (scheduler : react-popper.react-popper.PopperChildrenProps['scheduleUpdate']): void} */
  ...
  /* This means you don't have to write `default`, but can instead just say `popoverNextComponentsPopperMod.foo` */
