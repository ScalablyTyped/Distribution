...
import typings.wixUiCore.anon.PadApi
...
object componentsSignatureInputSignatureInputMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/signature-input/SignatureInput", "SignatureInput")
  @js.native
  class SignatureInput protected ()
    ...
    @JSName("state")
    val state_SignatureInput: PadApi = js.native
  }
  /* static members */
