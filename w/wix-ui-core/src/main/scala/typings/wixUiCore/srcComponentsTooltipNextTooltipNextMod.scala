...
object srcComponentsTooltipNextTooltipNextMod {
  
  @JSImport("wix-ui-core/src/components/tooltip-next/tooltip-next", "TooltipNext")
  @js.native
  ...
  object TooltipNext {
    ...
    @JSImport("wix-ui-core/src/components/tooltip-next/tooltip-next", "TooltipNext.defaultProps")
    @js.native
    def defaultProps: PartialTooltipPropsClassName = js.native
    inline def defaultProps_=(x: PartialTooltipPropsClassName): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-ui-core/src/components/tooltip-next/tooltip-next", "TooltipNext.displayName")
    @js.native
