...
import typings.wixUiCore.menuItemUniDotDriverMod.MenuItemDriver
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object menuItemMenuItemDriverMod {
  
  @JSImport("wix-ui-core/src/components/menu-item/menu-item.driver", JSImport.Namespace)
  @js.native
