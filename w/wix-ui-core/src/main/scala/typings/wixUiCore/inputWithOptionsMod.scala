...
object inputWithOptionsMod {
  
  @JSImport("wix-ui-core/dist/src/components/input-with-options", "InputWithOptions")
  @js.native
  class InputWithOptions protected ()
    extends typings.wixUiCore.inputWithOptionsInputWithOptionsMod.InputWithOptions {
  ...
  object InputWithOptions {
    ...
    @JSImport("wix-ui-core/dist/src/components/input-with-options", "InputWithOptions.bypassDefaultPropsTypecheck")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/input-with-options", "InputWithOptions.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/input-with-options", "InputWithOptions.displayName")
    @js.native
