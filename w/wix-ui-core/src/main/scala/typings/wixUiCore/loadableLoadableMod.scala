...
object loadableLoadableMod {
  
  @JSImport("wix-ui-core/dist/src/components/loadable/Loadable", "Loadable")
  @js.native
  ...
  {[ Key in keyof LoadableExports ]:? (): LoadableExports[Key] | wix-ui-core.wix-ui-core/dist/src/components/loadable/Loadable.Module<LoadableExports> | std.Promise<wix-ui-core.wix-ui-core/dist/src/components/loadable/Loadable.Module<LoadableExports>>}
