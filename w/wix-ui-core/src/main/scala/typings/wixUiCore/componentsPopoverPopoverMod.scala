...
object componentsPopoverPopoverMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/popover/Popover", "Popover")
  @js.native
  ...
  object Popover {
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/popover/Popover", "Popover.Content")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/popover/Popover", "Popover.Element")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/popover/Popover", "Popover.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/standalone/src/components/popover/Popover", "Popover.displayName")
    @js.native
