...
object srcComponentsSliderMod {
  
  @JSImport("wix-ui-core/src/components/slider", "Slider")
  @js.native
  class Slider protected ()
    extends typings.wixUiCore.srcComponentsSliderSliderMod.Slider {
  ...
  object Slider {
    ...
    @JSImport("wix-ui-core/src/components/slider", "Slider.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/src/components/slider", "Slider.displayName")
    @js.native
