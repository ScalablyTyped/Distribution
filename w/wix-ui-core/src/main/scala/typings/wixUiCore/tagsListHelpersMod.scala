...
import typings.wixUiCore.wixUiCoreStrings.`tags-list-tag-input`
import typings.wixUiCore.wixUiCoreStrings.`tags-list-tag`
import typings.wixUiCore.wixUiCoreStrings.`tags-list`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object tagsListHelpersMod {
  
  /* Rewritten from type alias, can be one of: 
    - typings.wixUiCore.wixUiCoreStrings.`tags-list`
    - typings.wixUiCore.wixUiCoreStrings.`tags-list-tag`
    - typings.wixUiCore.wixUiCoreStrings.`tags-list-tag-input`
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.wixUiCore.wixUiCoreStrings.Tag
    - typings.wixUiCore.wixUiCoreStrings.TagsList
  */
