...
object popoverMod {
  ...
  @JSImport("wix-ui-core/dist/src/components/popover", "Popover")
  @js.native
  class Popover protected ()
    extends typings.wixUiCore.popoverPopoverMod.Popover {
  ...
  object Popover {
    ...
    @JSImport("wix-ui-core/dist/src/components/popover", "Popover.Content")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/popover", "Popover.Element")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/popover", "Popover.defaultProps")
    @js.native
    ...
    @JSImport("wix-ui-core/dist/src/components/popover", "Popover.displayName")
    @js.native
