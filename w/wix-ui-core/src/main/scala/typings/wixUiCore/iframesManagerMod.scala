...
object iframesManagerMod {
  
  @JSImport("wix-ui-core/dist/src/clients/GoogleMaps/IframesManager/IframesManager", "IframesManager")
  @js.native
  ...
  object IframesManager {
    ...
    @JSImport("wix-ui-core/dist/src/clients/GoogleMaps/IframesManager/IframesManager", "IframesManager.getKey")
    @js.native
