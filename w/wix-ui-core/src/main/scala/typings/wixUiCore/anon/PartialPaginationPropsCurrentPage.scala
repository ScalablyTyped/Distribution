...
object PartialPaginationPropsCurrentPage {
  ...
  @scala.inline
  def apply(): PartialPaginationPropsCurrentPage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPaginationPropsCurrentPage]
  }
  
  @scala.inline
  implicit class PartialPaginationPropsCurrentPageMutableBuilder[Self <: PartialPaginationPropsCurrentPage] (val x: Self) extends AnyVal {
