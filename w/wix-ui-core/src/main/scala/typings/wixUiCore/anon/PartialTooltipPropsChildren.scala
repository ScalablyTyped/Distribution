...
import typings.wixUiCore.componentsTooltipTooltipMod.Point
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Partial<wix-ui-core.wix-ui-core/dist/standalone/src/components/tooltip/Tooltip.TooltipProps> */
trait PartialTooltipPropsChildren extends StObject {
...
object PartialTooltipPropsChildren {
  
  @scala.inline
  def apply(): PartialTooltipPropsChildren = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTooltipPropsChildren]
  }
  
  @scala.inline
  implicit class PartialTooltipPropsChildrenMutableBuilder[Self <: PartialTooltipPropsChildren] (val x: Self) extends AnyVal {
