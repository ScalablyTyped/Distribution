...
import typings.wixUiCore.srcComponentsCheckboxCheckboxMod.OnChangeEvent
...
/* Inlined std.Partial<wix-ui-core.wix-ui-core/src/components/checkbox/Checkbox.CheckboxProps> */
trait PartialCheckboxPropsAccept extends StObject {
...
object PartialCheckboxPropsAccept {
  
  @scala.inline
  def apply(): PartialCheckboxPropsAccept = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCheckboxPropsAccept]
  }
  
  @scala.inline
  implicit class PartialCheckboxPropsAcceptMutableBuilder[Self <: PartialCheckboxPropsAccept] (val x: Self) extends AnyVal {
