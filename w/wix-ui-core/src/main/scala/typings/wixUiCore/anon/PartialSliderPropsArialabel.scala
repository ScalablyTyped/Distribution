...
import typings.wixUiCore.componentsSliderSliderMod.Style
...
/* Inlined std.Partial<wix-ui-core.wix-ui-core/dist/standalone/src/components/slider/Slider.SliderProps> */
trait PartialSliderPropsArialabel extends StObject {
...
object PartialSliderPropsArialabel {
  
  @scala.inline
  def apply(): PartialSliderPropsArialabel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSliderPropsArialabel]
  }
  
  @scala.inline
  implicit class PartialSliderPropsArialabelMutableBuilder[Self <: PartialSliderPropsArialabel] (val x: Self) extends AnyVal {
