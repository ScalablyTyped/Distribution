...
object Geocoder {
  ...
  inline def apply(Geocoder: () => js.Any, GeocoderStatus: OK, Map: () => js.Object, places: AutocompleteService): Geocoder = {
  ...
  extension [Self <: Geocoder](x: Self) {
    ...
    inline def setGeocoder(value: () => js.Any): Self = StObject.set(x, "Geocoder", js.Any.fromFunction0(value))
    
    inline def setGeocoderStatus(value: OK): Self = StObject.set(x, "GeocoderStatus", value.asInstanceOf[js.Any])
    
    inline def setMap(value: () => js.Object): Self = StObject.set(x, "Map", js.Any.fromFunction0(value))
