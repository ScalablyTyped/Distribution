...
import typings.wixUiCore.signatureInputSigningPadSigningPadMod.SignaturePadApi
...
object PickSigningPadPropsrequirAbout {
  
  @scala.inline
  def apply(): PickSigningPadPropsrequirAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickSigningPadPropsrequirAbout]
  }
  
  @scala.inline
  implicit class PickSigningPadPropsrequirAboutMutableBuilder[Self <: PickSigningPadPropsrequirAbout] (val x: Self) extends AnyVal {
