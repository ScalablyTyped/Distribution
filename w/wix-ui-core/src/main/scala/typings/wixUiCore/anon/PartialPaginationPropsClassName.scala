...
/* Inlined std.Partial<wix-ui-core.wix-ui-core/dist/standalone/src/components/pagination/Pagination.PaginationProps> */
trait PartialPaginationPropsClassName extends StObject {
...
object PartialPaginationPropsClassName {
  
  @scala.inline
  def apply(): PartialPaginationPropsClassName = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPaginationPropsClassName]
  }
  
  @scala.inline
  implicit class PartialPaginationPropsClassNameMutableBuilder[Self <: PartialPaginationPropsClassName] (val x: Self) extends AnyVal {
