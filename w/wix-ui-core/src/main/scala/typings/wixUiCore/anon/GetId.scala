...
object GetId {
  ...
  extension [Self <: GetId](x: Self) {
    ...
    inline def setGetKnobIcon(value: () => js.Any): Self = StObject.set(x, "getKnobIcon", js.Any.fromFunction0(value))
    ...
    inline def setGetTabIndex(value: () => js.Any): Self = StObject.set(x, "getTabIndex", js.Any.fromFunction0(value))
    ...
    inline def setIsChecked(value: () => js.Any): Self = StObject.set(x, "isChecked", js.Any.fromFunction0(value))
