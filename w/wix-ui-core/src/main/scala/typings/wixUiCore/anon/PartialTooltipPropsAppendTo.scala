...
import typings.wixUiCore.tooltipTooltipMod.Point
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Partial<wix-ui-core.wix-ui-core/dist/src/components/tooltip/Tooltip.TooltipProps> */
...
object PartialTooltipPropsAppendTo {
  ...
  @scala.inline
  def apply(): PartialTooltipPropsAppendTo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTooltipPropsAppendTo]
  }
  
  @scala.inline
  implicit class PartialTooltipPropsAppendToMutableBuilder[Self <: PartialTooltipPropsAppendTo] (val x: Self) extends AnyVal {
