...
import typings.wixUiCore.signingPadSigningPadMod.SignaturePadApi
...
object PickSigningPadPropsrequir {
  
  @scala.inline
  def apply(): PickSigningPadPropsrequir = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickSigningPadPropsrequir]
  }
  
  @scala.inline
  implicit class PickSigningPadPropsrequirMutableBuilder[Self <: PickSigningPadPropsrequir] (val x: Self) extends AnyVal {
