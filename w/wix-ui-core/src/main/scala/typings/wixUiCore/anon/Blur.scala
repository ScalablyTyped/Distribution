...
trait Blur extends StObject {
  ...
  def clickInput(): js.Any
  
  def clickOutside(): Unit
  
  def doubleClickInput(): js.Any
  ...
  def mouseEnterInput(): js.Any
  
  def mouseLeave(): js.Any
  
  def mouseLeaveInput(): js.Any
...
object Blur {
  ...
  implicit class BlurMutableBuilder[Self <: Blur] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClickInput(value: () => js.Any): Self = StObject.set(x, "clickInput", js.Any.fromFunction0(value))
    
    @scala.inline
    def setClickOutside(value: () => Unit): Self = StObject.set(x, "clickOutside", js.Any.fromFunction0(value))
    
    @scala.inline
    def setDoubleClickInput(value: () => js.Any): Self = StObject.set(x, "doubleClickInput", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setMouseEnterInput(value: () => js.Any): Self = StObject.set(x, "mouseEnterInput", js.Any.fromFunction0(value))
    
    @scala.inline
    def setMouseLeave(value: () => js.Any): Self = StObject.set(x, "mouseLeave", js.Any.fromFunction0(value))
    
    @scala.inline
    def setMouseLeaveInput(value: () => js.Any): Self = StObject.set(x, "mouseLeaveInput", js.Any.fromFunction0(value))
