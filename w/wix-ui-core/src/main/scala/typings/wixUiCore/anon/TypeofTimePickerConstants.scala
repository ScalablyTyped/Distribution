...
object TypeofTimePickerConstants {
  ...
  @scala.inline
  def apply(AmPmStrings: Capitalized, BLANK: /* "--" */ String, NULL_TIME: String): TypeofTimePickerConstants = {
  ...
  @scala.inline
  implicit class TypeofTimePickerConstantsMutableBuilder[Self <: TypeofTimePickerConstants] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAmPmStrings(value: Capitalized): Self = StObject.set(x, "AmPmStrings", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setBLANK(value: /* "--" */ String): Self = StObject.set(x, "BLANK", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setNULL_TIME(value: String): Self = StObject.set(x, "NULL_TIME", value.asInstanceOf[js.Any])
  }
}
