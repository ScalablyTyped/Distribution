...
object PickPickHorizontalMenuColColumnGap {
  ...
  @scala.inline
  def apply(): PickPickHorizontalMenuColColumnGap = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickPickHorizontalMenuColColumnGap]
  }
  
  @scala.inline
  implicit class PickPickHorizontalMenuColColumnGapMutableBuilder[Self <: PickPickHorizontalMenuColColumnGap] (val x: Self) extends AnyVal {
