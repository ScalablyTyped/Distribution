...
object Alt {
  ...
  extension [Self <: Alt](x: Self) {
    ...
    inline def `setAria-current`(value: Boolean | time | location | step | page | date): Self = StObject.set(x, "aria-current", value.asInstanceOf[js.Any])
    ...
    inline def `setAria-haspopup`(value: Boolean | dialog | menu | listbox | tree | grid): Self = StObject.set(x, "aria-haspopup", value.asInstanceOf[js.Any])
    ...
    inline def `setAria-relevant`(value: text | all | additions | (`additions text`) | removals): Self = StObject.set(x, "aria-relevant", value.asInstanceOf[js.Any])
    ...
    inline def setInputMode(value: text | none | url | tel | email | numeric | decimal | search): Self = StObject.set(x, "inputMode", value.asInstanceOf[js.Any])
