...
object AccessKey {
  ...
  implicit class AccessKeyMutableBuilder[Self <: AccessKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `setAria-current`(value: Boolean | time | page | step | location | date): Self = StObject.set(x, "aria-current", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `setAria-dropeffect`(value: link | none | copy | move | execute | popup): Self = StObject.set(x, "aria-dropeffect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `setAria-haspopup`(value: Boolean | dialog | menu | listbox | grid | tree): Self = StObject.set(x, "aria-haspopup", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `setAria-relevant`(value: all | text | additions | (`additions text`) | removals): Self = StObject.set(x, "aria-relevant", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInputMode(value: search | none | text | decimal | numeric | tel | url | email): Self = StObject.set(x, "inputMode", value.asInstanceOf[js.Any])
