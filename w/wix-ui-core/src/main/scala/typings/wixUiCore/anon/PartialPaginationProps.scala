...
import typings.wixUiCore.paginationPaginationMod.PaginationMode
...
/* Inlined std.Partial<wix-ui-core.wix-ui-core/dist/src/components/pagination/Pagination.PaginationProps> */
...
object PartialPaginationProps {
  ...
  implicit class PartialPaginationPropsMutableBuilder[Self <: PartialPaginationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: /* event */ SyntheticEvent[typings.std.Element, typings.std.Event] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
    
    @scala.inline
    def setOnDoubleClick(value: /* event */ SyntheticEvent[typings.std.Element, typings.std.Event] => Unit): Self = StObject.set(x, "onDoubleClick", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnDoubleClickUndefined: Self = StObject.set(x, "onDoubleClick", js.undefined)
    
    @scala.inline
    def setOnMouseEnter(value: /* event */ SyntheticEvent[typings.std.Element, typings.std.Event] => Unit): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction1(value))
    
    @scala.inline
    def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
    
    @scala.inline
    def setOnMouseLeave(value: /* event */ SyntheticEvent[typings.std.Element, typings.std.Event] => Unit): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction1(value))
