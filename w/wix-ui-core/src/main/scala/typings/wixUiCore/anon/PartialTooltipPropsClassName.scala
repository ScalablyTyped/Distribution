...
import typings.wixUiCore.srcComponentsTooltipNextTooltipNextMod.Point
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Partial<wix-ui-core.wix-ui-core/src/components/tooltip-next/tooltip-next.TooltipProps> */
trait PartialTooltipPropsClassName extends StObject {
...
object PartialTooltipPropsClassName {
  
  @scala.inline
  def apply(): PartialTooltipPropsClassName = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTooltipPropsClassName]
  }
  
  @scala.inline
  implicit class PartialTooltipPropsClassNameMutableBuilder[Self <: PartialTooltipPropsClassName] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAppendTo(value: typings.wixUiCore.srcComponentsPopoverPopoverMod.AppendTo): Self = StObject.set(x, "appendTo", value.asInstanceOf[js.Any])
