...
object CheckboxDriverAt {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(checkboxDriverAt = js.Any.fromFunction1(checkboxDriverAt), click = js.Any.fromFunction0(click), clickOutside = js.Any.fromFunction0(clickOutside), dropdownContentDisplayed = js.Any.fromFunction0(dropdownContentDisplayed), exists = js.Any.fromFunction0(exists), getArrowElement = js.Any.fromFunction0(getArrowElement), getArrowOffset = js.Any.fromFunction0(getArrowOffset), getContentElement = js.Any.fromFunction0(getContentElement), getElementId = js.Any.fromFunction0(getElementId), getForAttribute = js.Any.fromFunction0(getForAttribute), getId = js.Any.fromFunction0(getId), getLabelText = js.Any.fromFunction0(getLabelText), getOptionsCount = js.Any.fromFunction0(getOptionsCount), getSelectedOptionsCount = js.Any.fromFunction0(getSelectedOptionsCount), getSuffix = js.Any.fromFunction0(getSuffix), getTargetElement = js.Any.fromFunction0(getTargetElement), hasEllipsis = js.Any.fromFunction0(hasEllipsis), hasStyleState = js.Any.fromFunction1(hasStyleState), inlineStyles = js.Any.fromFunction0(inlineStyles), isContentElementExists = js.Any.fromFunction0(isContentElementExists), isDisabled = js.Any.fromFunction0(isDisabled), isError = js.Any.fromFunction0(isError), isRequired = js.Any.fromFunction0(isRequired), isTargetElementExists = js.Any.fromFunction0(isTargetElementExists), keyDown = js.Any.fromFunction1(keyDown), mouseEnter = js.Any.fromFunction0(mouseEnter), mouseLeave = js.Any.fromFunction0(mouseLeave), optionAt = js.Any.fromFunction1(optionAt), triggerMouseDownOnDropdownContent = js.Any.fromFunction0(triggerMouseDownOnDropdownContent))
