...
import typings.wixUiCore.componentsTooltipNextTooltipNextMod.Point
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Partial<wix-ui-core.wix-ui-core/dist/standalone/src/components/tooltip-next/tooltip-next.TooltipProps> */
trait PartialTooltipPropsAriadescribedby extends StObject {
  
  var appendTo: js.UndefOr[typings.wixUiCore.componentsPopoverPopoverMod.AppendTo] = js.undefined
...
object PartialTooltipPropsAriadescribedby {
  
  @scala.inline
  def apply(): PartialTooltipPropsAriadescribedby = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTooltipPropsAriadescribedby]
  }
  
  @scala.inline
  implicit class PartialTooltipPropsAriadescribedbyMutableBuilder[Self <: PartialTooltipPropsAriadescribedby] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAppendTo(value: typings.wixUiCore.componentsPopoverPopoverMod.AppendTo): Self = StObject.set(x, "appendTo", value.asInstanceOf[js.Any])
