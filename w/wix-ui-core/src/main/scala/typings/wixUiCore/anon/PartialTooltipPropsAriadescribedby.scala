...
object PartialTooltipPropsAriadescribedby {
  ...
  inline def apply(): PartialTooltipPropsAriadescribedby = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTooltipPropsAriadescribedby]
  }
  
  extension [Self <: PartialTooltipPropsAriadescribedby](x: Self) {
    
    inline def setAppendTo(value: typings.wixUiCore.componentsPopoverPopoverMod.AppendTo): Self = StObject.set(x, "appendTo", value.asInstanceOf[js.Any])
