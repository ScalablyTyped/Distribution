...
object linearProgressBarDotdriverMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/linear-progress-bar/LinearProgressBar.driver", "linearProgressBarDriverFactory")
  @js.native
