...
object addressInputDotPrivateDriverMod {
  
  @JSImport("wix-ui-core/dist/standalone/src/components/address-input/AddressInput.private.driver", "AddressInputPrivateDriver")
  @js.native
