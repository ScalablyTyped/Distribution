...
object signatureInputMod {
  
  @JSImport("wix-ui-core/dist/src/components/signature-input", "SignatureInput")
  @js.native
  class SignatureInput protected ()
    extends typings.wixUiCore.signatureInputSignatureInputMod.SignatureInput {
