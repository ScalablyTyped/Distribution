...
trait ListBaseWithMutators[T] extends ListBase[T] {
  ...
  /**
          ...
          **/
  def push(value: T): scala.Double = js.native
  def push(values: T*): scala.Double = js.native
  /**
  ...
  /**
           ...
           * @returns The new length of the list.
          **/
  def unshift(value: T): scala.Double = js.native
  def unshift(values: T*): scala.Double = js.native
}
