...
class FlipView[T] () extends js.Object {
  ...
  /**
    ...
    **/
  var itemSpacing: scala.Double = js.native
  /**
  ...
  /**
    ...
    **/
  def count(): winjsLib.WinJSNs.Promise[scala.Double] = js.native
  /**
  ...
  /**
    ...
    **/
  def ondatasourcecountchanged(eventInfo: stdLib.Event): scala.Unit = js.native
  /**
    ...
    **/
  def onpagecompleted(eventInfo: stdLib.CustomEvent[_]): scala.Unit = js.native
  /**
    * Raised when the FlipView flips to a page.
    * @param eventInfo An object that contains information about the event. The detail property of this object contains the following sub-properties: detail.source.
    **/
  def onpageselected(eventInfo: stdLib.CustomEvent[_]): scala.Unit = js.native
  /**
    ...
    **/
  def onpagevisibilitychanged(eventInfo: stdLib.CustomEvent[_]): scala.Unit = js.native
  /**
