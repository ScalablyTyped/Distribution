...
trait IListBinding[T] extends js.Object {
  ...
  /**
    ...
    **/
  def fromDescription(description: java.lang.String): IItemPromise[IItem[T]] = js.native
  /**
    ...
    **/
  def fromIndex(index: scala.Double): IItemPromise[IItem[T]] = js.native
  /**
    ...
    **/
  def fromKey(key: java.lang.String): IItemPromise[IItem[T]] = js.native
  def fromKey(key: java.lang.String, hints: js.Any): IItemPromise[IItem[T]] = js.native
  /**
  ...
  /**
    ...
    **/
  def releaseItem(item: IItem[T]): scala.Unit = js.native
}
