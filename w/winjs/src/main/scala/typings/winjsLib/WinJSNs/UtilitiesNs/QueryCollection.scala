...
class QueryCollection[T] ()
  ...
  /**
    ...
    **/
  def addClass(name: java.lang.String): QueryCollection[T] = js.native
  /**
    ...
    * @returns This QueryCollection object.
    **/
  def clearStyle(name: java.lang.String): QueryCollection[T] = js.native
  ...
  /**
    ...
    **/
  @JSName("concat")
  def concat_UArray[U /* <: js.Array[T] */](items: U*): js.Array[T] = js.native
  /**
  ...
  /**
    ...
    **/
  def include(items: T): scala.Unit = js.native
  /**
    * Adds a set of items to this QueryCollection.
    * @param items The items to add to the QueryCollection. This may be an array-like object, a document fragment, or a single item.
    **/
  def include(items: js.Array[T]): scala.Unit = js.native
  /**
    * Adds a set of items to this QueryCollection.
    * @param items The items to add to the QueryCollection. This may be an array-like object, a document fragment, or a single item.
    **/
  def include(items: stdLib.HTMLCollection): scala.Unit = js.native
  /**
    ...
    **/
  def listen(eventType: java.lang.String, listener: js.Function): scala.Unit = js.native
  def listen(eventType: java.lang.String, listener: js.Function, capture: scala.Boolean): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @returns This QueryCollection object.
    **/
  def removeClass(name: java.lang.String): QueryCollection[T] = js.native
  /**
    ...
    * @returns This QueryCollection object.
    **/
  def removeEventListener(eventType: java.lang.String, listener: js.Function): QueryCollection[T] = js.native
  def removeEventListener(eventType: java.lang.String, listener: js.Function, capture: scala.Boolean): QueryCollection[T] = js.native
  /**
    ...
    * @returns This QueryCollection object.
    **/
  def setAttribute(name: java.lang.String, value: js.Any): QueryCollection[T] = js.native
  /**
    ...
    * @returns This QueryCollection object.
    **/
  def setStyle(name: java.lang.String, value: js.Any): QueryCollection[T] = js.native
  /**
    ...
    **/
  def template(templateElement: stdLib.HTMLElement, data: js.Any): QueryCollection[T] = js.native
  def template(templateElement: stdLib.HTMLElement, data: js.Any, renderDonePromiseCallback: js.Function): QueryCollection[T] = js.native
  /**
