...
trait IPageControlMembers extends js.Object {
  ...
  /**
    ...
    **/
  var init: js.UndefOr[js.Function2[/* element */ stdLib.HTMLElement, /* options */ js.Any, _]] = js.undefined
  /**
    ...
    **/
  var load: js.UndefOr[js.Function1[/* uri */ java.lang.String, _]] = js.undefined
  /**
    ...
    * @returns A promise that is fulfilled when initialization is complete, if asynchronous processing is necessary. If not, returns nothing.
    **/
  var processed: js.UndefOr[js.Function2[/* element */ stdLib.HTMLElement, /* options */ js.Any, _]] = js.undefined
  /**
    ...
    **/
  var ready: js.UndefOr[js.Function2[/* element */ stdLib.HTMLElement, /* options */ js.Any, _]] = js.undefined
  /**
