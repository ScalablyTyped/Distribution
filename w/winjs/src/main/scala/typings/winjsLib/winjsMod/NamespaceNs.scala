...
@js.native
object NamespaceNs extends js.Object {
  //#region Functions
  /**
  ...
  def define(name: java.lang.String): js.Any = js.native
  def define(name: java.lang.String, members: js.Any): js.Any = js.native
  /**
  ...
  def defineWithParent(parentNamespace: js.Any, name: java.lang.String): js.Any = js.native
  def defineWithParent(parentNamespace: js.Any, name: java.lang.String, members: js.Any): js.Any = js.native
}
