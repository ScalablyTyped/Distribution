...
object ^ extends js.Object {
  ...
  /**
    ...
    **/
  def executeAnimation(element: HTMLElement, animation: js.Any): Promise[_] = js.native
  /**
    ...
    **/
  def executeTransition(element: HTMLElement, transition: js.Any): Promise[_] = js.native
  /**
    ...
    **/
  def getItemsFromRanges[U](dataSource: IListDataSource[U], ranges: js.Array[ISelectionRange]): Promise[IItem[U]] = js.native
  /**
  ...
  /**
    ...
    **/
  def process(element: Element): Promise[_] = js.native
  /**
    ...
    **/
  def processAll(): Promise[_] = js.native
  def processAll(rootElement: Element): Promise[_] = js.native
  def processAll(rootElement: Element, skipRoot: Boolean): Promise[_] = js.native
  /**
