...
object ^ extends js.Object {
  ...
  def processAll(rootElement: Element): Promise[Unit] = js.native
  def processAll(rootElement: Element, dataContext: js.Any): Promise[Unit] = js.native
  def processAll(rootElement: Element, dataContext: js.Any, skipRoot: Boolean): Promise[Unit] = js.native
  def processAll(rootElement: Element, dataContext: js.Any, skipRoot: Boolean, bindingCache: js.Any): Promise[Unit] = js.native
  def processAll(
    rootElement: Element,
    dataContext: js.Any,
    skipRoot: Boolean,
