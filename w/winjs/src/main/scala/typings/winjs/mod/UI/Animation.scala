...
object Animation {
  ...
  /**
    ...
    **/
  inline def continuumBackwardIn(page: js.Any, item: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("continuumBackwardIn")(page.asInstanceOf[js.Any], item.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def continuumBackwardOut(page: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("continuumBackwardOut")(page.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def continuumForwardIn(page: js.Any, itemRoot: js.Any, itemContent: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("continuumForwardIn")(page.asInstanceOf[js.Any], itemRoot.asInstanceOf[js.Any], itemContent.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def continuumForwardOut(page: js.Any, item: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("continuumForwardOut")(page.asInstanceOf[js.Any], item.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    **/
  inline def createAddToListAnimation(added: js.Any, affected: js.Any): IAnimationMethodResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("createAddToListAnimation")(added.asInstanceOf[js.Any], affected.asInstanceOf[js.Any])).asInstanceOf[IAnimationMethodResponse]
  ...
  /**
    ...
    * @returns An object whose execute method is used to execute the animation. The execute method returns a Promise that completes when the animation is finished.
    **/
  inline def createAddToSearchListAnimation(added: js.Any, affected: js.Any): IAnimationMethodResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("createAddToSearchListAnimation")(added.asInstanceOf[js.Any], affected.asInstanceOf[js.Any])).asInstanceOf[IAnimationMethodResponse]
  ...
  /**
    ...
    * @returns An object whose execute method is used to execute the animation. The execute method returns a Promise that completes when the animation is finished.
    **/
  inline def createCollapseAnimation(hidden: js.Any, affected: js.Any): IAnimationMethodResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("createCollapseAnimation")(hidden.asInstanceOf[js.Any], affected.asInstanceOf[js.Any])).asInstanceOf[IAnimationMethodResponse]
  ...
  /**
    ...
    * @returns An object whose execute method is used to execute the animation. The execute method returns a Promise that completes when the animation is finished.
    **/
  inline def createDeleteFromListAnimation(deleted: js.Any, remaining: js.Any): IAnimationMethodResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("createDeleteFromListAnimation")(deleted.asInstanceOf[js.Any], remaining.asInstanceOf[js.Any])).asInstanceOf[IAnimationMethodResponse]
  ...
  /**
    ...
    * @returns An object whose execute method is used to execute the animation. The execute method returns a Promise that completes when the animation is finished.
    **/
  inline def createDeleteFromSearchListAnimation(deleted: js.Any, remaining: js.Any): IAnimationMethodResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("createDeleteFromSearchListAnimation")(deleted.asInstanceOf[js.Any], remaining.asInstanceOf[js.Any])).asInstanceOf[IAnimationMethodResponse]
  ...
  /**
    ...
    * @returns An object whose execute method is used to execute the animation. The execute method returns a Promise that completes when the animation is finished.
    **/
  inline def createExpandAnimation(revealed: js.Any, affected: js.Any): IAnimationMethodResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("createExpandAnimation")(revealed.asInstanceOf[js.Any], affected.asInstanceOf[js.Any])).asInstanceOf[IAnimationMethodResponse]
  ...
  /**
    ...
    * @returns An object whose execute method is used to execute the animation. The execute method returns a Promise that completes when the animation is finished.
    **/
  inline def createPeekAnimation(element: js.Any): IAnimationMethodResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("createPeekAnimation")(element.asInstanceOf[js.Any]).asInstanceOf[IAnimationMethodResponse]
  ...
  /**
    ...
    **/
  inline def createRepositionAnimation(element: js.Any): IAnimationMethodResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("createRepositionAnimation")(element.asInstanceOf[js.Any]).asInstanceOf[IAnimationMethodResponse]
  ...
  /**
    ...
    **/
  inline def crossFade(incoming: js.Any, outgoing: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("crossFade")(incoming.asInstanceOf[js.Any], outgoing.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    **/
  inline def dragBetweenEnter(target: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("dragBetweenEnter")(target.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def dragBetweenEnter(target: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("dragBetweenEnter")(target.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def dragBetweenLeave(target: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("dragBetweenLeave")(target.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def dragSourceEnd(dragSource: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("dragSourceEnd")(dragSource.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def dragSourceEnd(dragSource: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("dragSourceEnd")(dragSource.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  inline def dragSourceEnd(dragSource: js.Any, offset: js.Any, affected: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("dragSourceEnd")(dragSource.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], affected.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  inline def dragSourceEnd(dragSource: js.Any, offset: Unit, affected: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("dragSourceEnd")(dragSource.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], affected.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def dragSourceStart(dragSource: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("dragSourceStart")(dragSource.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def dragSourceStart(dragSource: js.Any, affected: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("dragSourceStart")(dragSource.asInstanceOf[js.Any], affected.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    **/
  inline def drillInIncoming(incomingPage: HTMLElement): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("drillInIncoming")(incomingPage.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns Promise object that completes when the animation is complete.
    **/
  inline def drillInOutgoing(outgoingPage: HTMLElement): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("drillInOutgoing")(outgoingPage.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns Promise object that completes when the animation is complete.
    **/
  inline def drillOutIncoming(incomingPage: HTMLElement): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("drillOutIncoming")(incomingPage.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns Promise object that completes when the animation is complete.
    **/
  inline def drillOutOutgoing(outgoingPage: HTMLElement): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("drillOutOutgoing")(outgoingPage.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def enterContent(incoming: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("enterContent")(incoming.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def enterContent(incoming: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("enterContent")(incoming.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  inline def enterContent(incoming: js.Any, offset: js.Any, options: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("enterContent")(incoming.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  inline def enterContent(incoming: js.Any, offset: Unit, options: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("enterContent")(incoming.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def enterPage(element: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("enterPage")(element.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def enterPage(element: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("enterPage")(element.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def exitContent(outgoing: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("exitContent")(outgoing.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def exitContent(outgoing: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("exitContent")(outgoing.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def exitPage(outgoing: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("exitPage")(outgoing.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def exitPage(outgoing: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("exitPage")(outgoing.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    **/
  inline def fadeIn(shown: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("fadeIn")(shown.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def fadeOut(hidden: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("fadeOut")(hidden.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def hideEdgeUI(element: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("hideEdgeUI")(element.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def hideEdgeUI(element: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("hideEdgeUI")(element.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  inline def hideEdgeUI(element: js.Any, offset: js.Any, options: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("hideEdgeUI")(element.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  inline def hideEdgeUI(element: js.Any, offset: Unit, options: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("hideEdgeUI")(element.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def hidePanel(element: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("hidePanel")(element.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def hidePanel(element: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("hidePanel")(element.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def hidePopup(element: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("hidePopup")(element.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def pointerDown(element: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("pointerDown")(element.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def pointerUp(element: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("pointerUp")(element.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def showEdgeUI(element: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("showEdgeUI")(element.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def showEdgeUI(element: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("showEdgeUI")(element.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  inline def showEdgeUI(element: js.Any, offset: js.Any, options: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("showEdgeUI")(element.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  inline def showEdgeUI(element: js.Any, offset: Unit, options: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("showEdgeUI")(element.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def showPanel(element: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("showPanel")(element.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def showPanel(element: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("showPanel")(element.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def showPopup(element: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("showPopup")(element.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def showPopup(element: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("showPopup")(element.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def slideDown(incoming: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("slideDown")(incoming.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def slideLeftIn(page: js.Any, first: js.Any, second: js.Any, third: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("slideLeftIn")(page.asInstanceOf[js.Any], first.asInstanceOf[js.Any], second.asInstanceOf[js.Any], third.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def slideLeftOut(page: js.Any, first: js.Any, second: js.Any, third: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("slideLeftOut")(page.asInstanceOf[js.Any], first.asInstanceOf[js.Any], second.asInstanceOf[js.Any], third.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def slideRightIn(page: js.Any, first: js.Any, second: js.Any, third: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("slideRightIn")(page.asInstanceOf[js.Any], first.asInstanceOf[js.Any], second.asInstanceOf[js.Any], third.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def slideRightOut(page: js.Any, first: js.Any, second: js.Any, third: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("slideRightOut")(page.asInstanceOf[js.Any], first.asInstanceOf[js.Any], second.asInstanceOf[js.Any], third.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def slideUp(incoming: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("slideUp")(incoming.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def swipeDeselect(deselected: js.Any, selection: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("swipeDeselect")(deselected.asInstanceOf[js.Any], selection.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def swipeReveal(target: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("swipeReveal")(target.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def swipeReveal(target: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("swipeReveal")(target.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def swipeSelect(selected: js.Any, selection: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("swipeSelect")(selected.asInstanceOf[js.Any], selection.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def turnstileBackwardIn(incoming: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("turnstileBackwardIn")(incoming.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def turnstileBackwardOut(outgoing: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("turnstileBackwardOut")(outgoing.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def turnstileForwardIn(incoming: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("turnstileForwardIn")(incoming.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns A Promise that completes when the animation is finished.
    **/
  inline def turnstileForwardOut(outgoing: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("turnstileForwardOut")(outgoing.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  ...
  /**
    ...
    * @returns An object that completes when the animation is finished.
    **/
  inline def updateBadge(incoming: js.Any): Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("updateBadge")(incoming.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Any]]
  inline def updateBadge(incoming: js.Any, offset: js.Any): Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("updateBadge")(incoming.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Promise[js.Any]]
}
