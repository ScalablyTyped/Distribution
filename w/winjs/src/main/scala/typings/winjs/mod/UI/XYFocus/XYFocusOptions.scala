...
trait XYFocusOptions extends js.Object {
  ...
  /**
    ...
    **/
  var historyRect: js.UndefOr[typings.winjs.WinJS.UI.XYFocus.IRect] = js.native
  ...
  /**
    ...
    **/
  var referenceRect: js.UndefOr[typings.winjs.WinJS.UI.XYFocus.IRect] = js.native
}
object XYFocusOptions {
  ...
  implicit class XYFocusOptionsOps[Self <: XYFocusOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHistoryRect(value: typings.winjs.WinJS.UI.XYFocus.IRect): Self = this.set("historyRect", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReferenceRect(value: typings.winjs.WinJS.UI.XYFocus.IRect): Self = this.set("referenceRect", value.asInstanceOf[js.Any])
