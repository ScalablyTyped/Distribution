...
/**
  ...
  **/
@scala.inline
def executeAnimation(element: typings.std.HTMLElement, animation: js.Any): typings.winjs.WinJS.Promise[js.Any] = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("executeAnimation")(element.asInstanceOf[js.Any], animation.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
...
/**
  ...
  **/
@scala.inline
def executeTransition(element: typings.std.HTMLElement, transition: js.Any): typings.winjs.WinJS.Promise[js.Any] = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("executeTransition")(element.asInstanceOf[js.Any], transition.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
...
@scala.inline
def optionsParser(value: java.lang.String, context: scala.Unit, functionContext: js.Any): js.Any = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("optionsParser")(value.asInstanceOf[js.Any], context.asInstanceOf[js.Any], functionContext.asInstanceOf[js.Any])).asInstanceOf[js.Any]
...
/**
  ...
  **/
@scala.inline
def process(element: typings.winjs.Element): typings.winjs.WinJS.Promise[js.Any] = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("process")(element.asInstanceOf[js.Any]).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
...
/**
  ...
  **/
@scala.inline
def processAll(): typings.winjs.WinJS.Promise[js.Any] = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")().asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
@scala.inline
def processAll(rootElement: scala.Unit, skipRoot: scala.Boolean): typings.winjs.WinJS.Promise[js.Any] = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
@scala.inline
def processAll(rootElement: typings.winjs.Element): typings.winjs.WinJS.Promise[js.Any] = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any]).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
@scala.inline
def processAll(rootElement: typings.winjs.Element, skipRoot: scala.Boolean): typings.winjs.WinJS.Promise[js.Any] = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
