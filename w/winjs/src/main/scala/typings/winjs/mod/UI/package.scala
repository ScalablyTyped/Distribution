...
/**
  ...
  **/
inline def disableAnimations(): scala.Unit = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("disableAnimations")().asInstanceOf[scala.Unit]
...
/**
  ...
  **/
inline def enableAnimations(): scala.Unit = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("enableAnimations")().asInstanceOf[scala.Unit]
...
/**
  ...
  **/
inline def eventHandler(handler: js.Any): js.Any = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("eventHandler")(handler.asInstanceOf[js.Any]).asInstanceOf[js.Any]
...
/**
  ...
  **/
inline def executeAnimation(element: typings.std.HTMLElement, animation: js.Any): typings.winjs.WinJS.Promise[js.Any] = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("executeAnimation")(element.asInstanceOf[js.Any], animation.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
...
/**
  ...
  **/
inline def executeTransition(element: typings.std.HTMLElement, transition: js.Any): typings.winjs.WinJS.Promise[js.Any] = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("executeTransition")(element.asInstanceOf[js.Any], transition.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
...
/**
  ...
  **/
inline def isAnimationEnabled(): scala.Boolean = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("isAnimationEnabled")().asInstanceOf[scala.Boolean]

/**
  * * This API supports the WinJS infrastructure and is not intended to be used directly from your code.
  **/
inline def optionsParser(value: java.lang.String): js.Any = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("optionsParser")(value.asInstanceOf[js.Any]).asInstanceOf[js.Any]
inline def optionsParser(value: java.lang.String, context: js.Any): js.Any = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("optionsParser")(value.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[js.Any]
inline def optionsParser(value: java.lang.String, context: js.Any, functionContext: js.Any): js.Any = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("optionsParser")(value.asInstanceOf[js.Any], context.asInstanceOf[js.Any], functionContext.asInstanceOf[js.Any])).asInstanceOf[js.Any]
inline def optionsParser(value: java.lang.String, context: scala.Unit, functionContext: js.Any): js.Any = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("optionsParser")(value.asInstanceOf[js.Any], context.asInstanceOf[js.Any], functionContext.asInstanceOf[js.Any])).asInstanceOf[js.Any]
...
/**
  ...
  **/
inline def process(element: typings.winjs.Element): typings.winjs.WinJS.Promise[js.Any] = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("process")(element.asInstanceOf[js.Any]).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
...
/**
  ...
  **/
inline def processAll(): typings.winjs.WinJS.Promise[js.Any] = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")().asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
inline def processAll(rootElement: scala.Unit, skipRoot: scala.Boolean): typings.winjs.WinJS.Promise[js.Any] = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
inline def processAll(rootElement: typings.winjs.Element): typings.winjs.WinJS.Promise[js.Any] = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any]).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
inline def processAll(rootElement: typings.winjs.Element, skipRoot: scala.Boolean): typings.winjs.WinJS.Promise[js.Any] = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[js.Any]]
...
/**
  ...
  **/
inline def scopedSelect(selector: java.lang.String, element: typings.std.HTMLElement): typings.std.HTMLElement = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("scopedSelect")(selector.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[typings.std.HTMLElement]
...
/**
  ...
  **/
inline def setOptions(control: js.Any): scala.Unit = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("setOptions")(control.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
inline def setOptions(control: js.Any, options: js.Any): scala.Unit = (typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("setOptions")(control.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]

/**
  * This API supports the WinJS infrastructure and is not intended to be used directly from your code.
  **/
inline def simpleItemRenderer(fn: js.Function): js.Function = typings.winjs.mod.UI.^.asInstanceOf[js.Dynamic].applyDynamic("simpleItemRenderer")(fn.asInstanceOf[js.Any]).asInstanceOf[js.Function]
