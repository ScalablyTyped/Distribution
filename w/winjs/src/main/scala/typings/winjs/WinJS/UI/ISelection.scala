...
trait ISelection[T] extends StObject {
  ...
  /**
    ...
    * @returns A Promise that is fulfilled when the operation completes.
    **/
  def remove(items: js.Any): Promise[js.Any]
  ...
  /**
    ...
    * @returns A Promise that is fulfilled when the operation completes.
    **/
  def set(items: js.Any): Promise[js.Any]
}
object ISelection {
  ...
  inline def apply[T](
    ...
    remove: js.Any => Promise[js.Any],
    selectAll: () => Unit,
    set: js.Any => Promise[js.Any]
  ): ISelection[T] = {
