...
object MediaCommand {
  ...
  extension [Self <: MediaCommand](x: Self) {
    ...
    inline def setChapterSkipBack(value: String): Self = StObject.set(x, "chapterSkipBack", value.asInstanceOf[js.Any])
    
    inline def setChapterSkipForward(value: String): Self = StObject.set(x, "chapterSkipForward", value.asInstanceOf[js.Any])
    
    inline def setClosedCaptions(value: String): Self = StObject.set(x, "closedCaptions", value.asInstanceOf[js.Any])
    
    inline def setFastForward(value: String): Self = StObject.set(x, "fastForward", value.asInstanceOf[js.Any])
    
    inline def setGoToLive(value: String): Self = StObject.set(x, "goToLive", value.asInstanceOf[js.Any])
    
    inline def setNextTrack(value: String): Self = StObject.set(x, "nextTrack", value.asInstanceOf[js.Any])
    ...
    inline def setPlayFromBeginning(value: String): Self = StObject.set(x, "playFromBeginning", value.asInstanceOf[js.Any])
    
    inline def setPlaybackRate(value: String): Self = StObject.set(x, "playbackRate", value.asInstanceOf[js.Any])
    
    inline def setPreviousTrack(value: String): Self = StObject.set(x, "previousTrack", value.asInstanceOf[js.Any])
    
    inline def setRewind(value: String): Self = StObject.set(x, "rewind", value.asInstanceOf[js.Any])
    
    inline def setSeek(value: String): Self = StObject.set(x, "seek", value.asInstanceOf[js.Any])
    
    inline def setStop(value: String): Self = StObject.set(x, "stop", value.asInstanceOf[js.Any])
    
    inline def setTimeSkipBack(value: String): Self = StObject.set(x, "timeSkipBack", value.asInstanceOf[js.Any])
    
    inline def setTimeSkipForward(value: String): Self = StObject.set(x, "timeSkipForward", value.asInstanceOf[js.Any])
