...
object BindingNs extends js.Object {
  ...
  /**
    ...
    **/
  class List[T] ()
    extends typings.winjs.WinJSNs.BindingNs.List[T] {
  ...
  class Template protected ()
    extends typings.winjs.WinJSNs.BindingNs.Template {
    //#region Constructors
    /**
  ...
  /**
    ...
    **/
  def processAll(): typings.winjs.WinJSNs.Promise[Unit] = js.native
  def processAll(rootElement: Element): typings.winjs.WinJSNs.Promise[Unit] = js.native
  def processAll(rootElement: Element, dataContext: js.Any): typings.winjs.WinJSNs.Promise[Unit] = js.native
  def processAll(rootElement: Element, dataContext: js.Any, skipRoot: Boolean): typings.winjs.WinJSNs.Promise[Unit] = js.native
  def processAll(rootElement: Element, dataContext: js.Any, skipRoot: Boolean, bindingCache: js.Any): typings.winjs.WinJSNs.Promise[Unit] = js.native
  def processAll(
    rootElement: Element,
    dataContext: js.Any,
    skipRoot: Boolean,
  ...
  ): typings.winjs.WinJSNs.Promise[Unit] = js.native
  /**
  ...
  object Template extends js.Object {
    ...
    /**
      ...
      **/
    def render(href: String, dataContext: js.Any): typings.winjs.WinJSNs.Promise[HTMLElement] = js.native
    def render(href: String, dataContext: js.Any, container: HTMLElement): typings.winjs.WinJSNs.Promise[HTMLElement] = js.native
  }
  ...
  object dynamicObservableMixin extends js.Object {
    ...
    /**
      ...
      **/
    def notify(name: String, newValue: String, oldValue: String): typings.winjs.WinJSNs.Promise[_] = js.native
    /**
    ...
    /**
      ...
      **/
    def updateProperty(name: String, value: js.Any): typings.winjs.WinJSNs.Promise[_] = js.native
  }
  ...
  object observableMixin extends js.Object {
    ...
    /**
      ...
      * @returns A promise that is completed when the notifications are complete.
      **/
    def notify(name: String, newValue: js.Any, oldValue: js.Any): typings.winjs.WinJSNs.Promise[_] = js.native
    /**
      * Removes one or more listeners from the notification list for a given property.
      * @param name The name of the property to unbind. If this parameter is omitted, all listeners for all events are removed.
      * @param action The function to remove from the listener list for the specified property. If this parameter is omitted, all listeners are removed for the specific property.
