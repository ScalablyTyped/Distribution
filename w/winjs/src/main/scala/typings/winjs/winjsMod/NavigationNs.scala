...
object NavigationNs extends js.Object {
  ...
  /**
    ...
    **/
  def back(): typings.winjs.WinJSNs.Promise[Boolean] = js.native
  def back(distance: Double): typings.winjs.WinJSNs.Promise[Boolean] = js.native
  /**
    * Navigates forwards.
    * @param distance The number of entries to go forward.
    * @returns A promise that is completed with a value that indicates whether or not the navigation was successful.
    **/
  def forward(): typings.winjs.WinJSNs.Promise[Boolean] = js.native
  def forward(distance: Double): typings.winjs.WinJSNs.Promise[Boolean] = js.native
  /**
    ...
    **/
  def navigate(location: js.Any): typings.winjs.WinJSNs.Promise[Boolean] = js.native
  def navigate(location: js.Any, initialState: js.Any): typings.winjs.WinJSNs.Promise[Boolean] = js.native
  //#endregion Functions
  //#region Events
  /**
