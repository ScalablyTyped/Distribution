...
package object UI {
  ...
  /**
    ...
    **/
  @scala.inline
  def executeAnimation(element: typings.std.HTMLElement, animation: js.Any): typings.winjs.WinJS.Promise[_] = (typings.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("executeAnimation")(element.asInstanceOf[js.Any], animation.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[_]]
  ...
  /**
    ...
    **/
  @scala.inline
  def executeTransition(element: typings.std.HTMLElement, transition: js.Any): typings.winjs.WinJS.Promise[_] = (typings.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("executeTransition")(element.asInstanceOf[js.Any], transition.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[_]]
  ...
  @scala.inline
  def optionsParser(value: java.lang.String, context: js.UndefOr[scala.Nothing], functionContext: js.Any): js.Any = (typings.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("optionsParser")(value.asInstanceOf[js.Any], context.asInstanceOf[js.Any], functionContext.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  ...
  /**
    ...
    **/
  @scala.inline
  def process(element: typings.winjs.Element): typings.winjs.WinJS.Promise[_] = typings.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("process")(element.asInstanceOf[js.Any]).asInstanceOf[typings.winjs.WinJS.Promise[_]]
  ...
  /**
    ...
    **/
  @scala.inline
  def processAll(): typings.winjs.WinJS.Promise[_] = typings.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")().asInstanceOf[typings.winjs.WinJS.Promise[_]]
  @scala.inline
  def processAll(rootElement: js.UndefOr[scala.Nothing], skipRoot: scala.Boolean): typings.winjs.WinJS.Promise[_] = (typings.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[_]]
  @scala.inline
  def processAll(rootElement: typings.winjs.Element): typings.winjs.WinJS.Promise[_] = typings.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any]).asInstanceOf[typings.winjs.WinJS.Promise[_]]
  @scala.inline
  def processAll(rootElement: typings.winjs.Element, skipRoot: scala.Boolean): typings.winjs.WinJS.Promise[_] = (typings.winjs.global.WinJS.UI.^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[_]]
