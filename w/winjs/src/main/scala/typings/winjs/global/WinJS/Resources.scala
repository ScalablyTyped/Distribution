...
object Resources {
  ...
  inline def processAll(rootElement: HTMLElement): typings.winjs.WinJS.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any]).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
