...
object Binding {
  ...
  open class List[T] ()
    ...
    def this(list: js.Array[T], options: Any) = this()
    def this(list: Unit, options: Any) = this()
  }
  object List {
  ...
  object Template {
    ...
    /**
      ...
      **/
    /* static member */
    inline def render(href: String, dataContext: Any): typings.winjs.WinJS.Promise[HTMLElement] = (^.asInstanceOf[js.Dynamic].applyDynamic("render")(href.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[HTMLElement]]
    inline def render(href: String, dataContext: Any, container: HTMLElement): typings.winjs.WinJS.Promise[HTMLElement] = (^.asInstanceOf[js.Dynamic].applyDynamic("render")(href.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any], container.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[HTMLElement]]
  ...
  /**
    ...
    **/
  inline def addClassOneTime(source: Any, sourceProperties: js.Array[Any], dest: HTMLElement): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("addClassOneTime")(source.asInstanceOf[js.Any], sourceProperties.asInstanceOf[js.Any], dest.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    **/
  inline def bind(observable: Any, bindingDescriptor: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("bind")(observable.asInstanceOf[js.Any], bindingDescriptor.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  /**
    ...
    **/
  inline def defaultBind(source: Any, sourceProperties: Any, dest: Any, destProperties: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("defaultBind")(source.asInstanceOf[js.Any], sourceProperties.asInstanceOf[js.Any], dest.asInstanceOf[js.Any], destProperties.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  /**
    ...
    **/
  inline def define(data: Any): js.Function = ^.asInstanceOf[js.Dynamic].applyDynamic("define")(data.asInstanceOf[js.Any]).asInstanceOf[js.Function]
  ...
  object dynamicObservableMixin {
    ...
    /**
      ...
      **/
    inline def addProperty(name: String, value: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("addProperty")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /**
      ...
      **/
    inline def bind(name: String, action: Any): js.Function = (^.asInstanceOf[js.Dynamic].applyDynamic("bind")(name.asInstanceOf[js.Any], action.asInstanceOf[js.Any])).asInstanceOf[js.Function]
    ...
    /**
      ...
      **/
    inline def getProperty(name: String): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getProperty")(name.asInstanceOf[js.Any]).asInstanceOf[Any]
    ...
    /**
      ...
      **/
    inline def notify_(name: String, newValue: String, oldValue: String): typings.winjs.WinJS.Promise[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("notify")(name.asInstanceOf[js.Any], newValue.asInstanceOf[js.Any], oldValue.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Any]]
    ...
    /**
      ...
      * @returns This object is returned.
      **/
    inline def removeProperty(name: String): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("removeProperty")(name.asInstanceOf[js.Any]).asInstanceOf[Any]
    ...
    /**
      ...
      * @returns This object is returned.
      **/
    inline def setProperty(name: String, value: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setProperty")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    /**
      ...
      * @returns This object is returned.
      **/
    inline def unbind(name: String, action: js.Function): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("unbind")(name.asInstanceOf[js.Any], action.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    /**
      ...
      **/
    inline def updateProperty(name: String, value: Any): typings.winjs.WinJS.Promise[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("updateProperty")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Any]]
  }
  ...
  /**
    ...
    **/
  inline def expandProperties(shape: Any): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("expandProperties")(shape.asInstanceOf[js.Any]).asInstanceOf[Any]
  
  /**
    * This API supports the WinJS infrastructure and is not intended to be used directly from your code.
    **/
  inline def getValue(obj: Any): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getValue")(obj.asInstanceOf[js.Any]).asInstanceOf[Any]
  inline def getValue(obj: Any, path: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("getValue")(obj.asInstanceOf[js.Any], path.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  object mixin {
    ...
    /**
      ...
      * @returns This object is returned.
      **/
    inline def addProperty(name: String, value: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("addProperty")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  object observableMixin {
    ...
    /**
      ...
      **/
    inline def bind(name: String, action: js.Function): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("bind")(name.asInstanceOf[js.Any], action.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    /**
      ...
      * @returns A promise that is completed when the notifications are complete.
      **/
    inline def notify_(name: String, newValue: Any, oldValue: Any): typings.winjs.WinJS.Promise[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("notify")(name.asInstanceOf[js.Any], newValue.asInstanceOf[js.Any], oldValue.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Any]]
  ...
  /**
    ...
    * @returns An object with a cancel method that is used to coalesce bindings.
    **/
  inline def oneTime(source: Any, sourceProperties: Any, dest: Any, destProperties: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("oneTime")(source.asInstanceOf[js.Any], sourceProperties.asInstanceOf[js.Any], dest.asInstanceOf[js.Any], destProperties.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  inline def processAll(rootElement: Unit, dataContext: Any): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  inline def processAll(rootElement: Unit, dataContext: Any, skipRoot: Boolean): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  inline def processAll(rootElement: Unit, dataContext: Any, skipRoot: Boolean, bindingCache: Any): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any], bindingCache.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  ...
  inline def processAll(rootElement: Unit, dataContext: Any, skipRoot: Unit, bindingCache: Any): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any], bindingCache.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  inline def processAll(
    rootElement: Unit,
    dataContext: Any,
    skipRoot: Unit,
  ...
  inline def processAll(rootElement: Unit, dataContext: Unit, skipRoot: Boolean, bindingCache: Any): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any], bindingCache.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  inline def processAll(
    rootElement: Unit,
    dataContext: Unit,
    skipRoot: Boolean,
  ...
  inline def processAll(rootElement: Unit, dataContext: Unit, skipRoot: Unit, bindingCache: Any): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any], bindingCache.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  inline def processAll(
    rootElement: Unit,
    dataContext: Unit,
    skipRoot: Unit,
  ...
  inline def processAll(rootElement: Element, dataContext: Any): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  inline def processAll(rootElement: Element, dataContext: Any, skipRoot: Boolean): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  inline def processAll(rootElement: Element, dataContext: Any, skipRoot: Boolean, bindingCache: Any): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any], bindingCache.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  inline def processAll(
    rootElement: Element,
    dataContext: Any,
    skipRoot: Boolean,
  ...
  inline def processAll(rootElement: Element, dataContext: Any, skipRoot: Unit, bindingCache: Any): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any], bindingCache.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  inline def processAll(
    rootElement: Element,
    dataContext: Any,
    skipRoot: Unit,
  ...
  inline def processAll(rootElement: Element, dataContext: Unit, skipRoot: Boolean, bindingCache: Any): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any], bindingCache.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  inline def processAll(
    rootElement: Element,
    dataContext: Unit,
    skipRoot: Boolean,
  ...
  inline def processAll(rootElement: Element, dataContext: Unit, skipRoot: Unit, bindingCache: Any): typings.winjs.WinJS.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("processAll")(rootElement.asInstanceOf[js.Any], dataContext.asInstanceOf[js.Any], skipRoot.asInstanceOf[js.Any], bindingCache.asInstanceOf[js.Any])).asInstanceOf[typings.winjs.WinJS.Promise[Unit]]
  inline def processAll(
    rootElement: Element,
    dataContext: Unit,
    skipRoot: Unit,
  ...
  /**
    ...
    * @returns An object with a cancel() method that is used to coalesce bindings.
    **/
  inline def setAttribute(source: Any, sourceProperties: js.Array[Any], dest: Element, destProperties: js.Array[Any]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setAttribute")(source.asInstanceOf[js.Any], sourceProperties.asInstanceOf[js.Any], dest.asInstanceOf[js.Any], destProperties.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  /**
    ...
    * @param destProperties The path on the destination object to the destination property. This must be a single name.
    **/
  inline def setAttributeOneTime(source: Any, sourceProperties: js.Array[Any], dest: Element, destProperties: js.Array[Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setAttributeOneTime")(source.asInstanceOf[js.Any], sourceProperties.asInstanceOf[js.Any], dest.asInstanceOf[js.Any], destProperties.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    **/
  inline def unwrap(data: Any): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("unwrap")(data.asInstanceOf[js.Any]).asInstanceOf[Any]
}
