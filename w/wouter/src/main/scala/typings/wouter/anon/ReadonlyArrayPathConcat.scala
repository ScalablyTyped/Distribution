...
trait ReadonlyArrayPathConcat extends StObject {
  ...
  val toLocaleString_FReadonlyArrayPathConcat: js.Function0[String]
  
  @JSName("toString")
  val toString_FReadonlyArrayPathConcat: js.Function0[String]
...
object ReadonlyArrayPathConcat {
  ...
  extension [Self <: ReadonlyArrayPathConcat](x: Self) {
    
    inline def setConcat(value: /* repeated */ js.Array[Path] => js.Array[Path]): Self = StObject.set(x, "concat", js.Any.fromFunction1(value))
    
    inline def setCopyWithin(value: (/* target */ Double, /* start */ Double) => ReadonlyArrayPathConcat): Self = StObject.set(x, "copyWithin", js.Any.fromFunction2(value))
    ...
    inline def setFill(value: /* value */ Path => ReadonlyArrayPathConcat): Self = StObject.set(x, "fill", js.Any.fromFunction1(value))
    ...
    inline def setSort(value: () => ReadonlyArrayPathConcat): Self = StObject.set(x, "sort", js.Any.fromFunction0(value))
