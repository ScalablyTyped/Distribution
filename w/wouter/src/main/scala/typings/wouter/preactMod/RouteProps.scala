...
trait RouteProps extends js.Object {
  var children: js.UndefOr[(js.Function1[/* params */ Params, ComponentChildren]) | ComponentChildren] = js.undefined
...
object RouteProps {
  ...
  def apply(
    path: Path,
    children: (js.Function1[/* params */ Params, ComponentChildren]) | ComponentChildren = null,
