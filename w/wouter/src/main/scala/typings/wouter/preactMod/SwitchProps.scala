...
object SwitchProps {
  ...
  implicit class SwitchPropsOps[Self <: SwitchProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenVarargs(value: VNode[RouteProps[DefaultParams]]*): Self = this.set("children", js.Array(value :_*))
    
    @scala.inline
    def setChildren(value: js.Array[VNode[RouteProps[DefaultParams]]]): Self = this.set("children", value.asInstanceOf[js.Any])
