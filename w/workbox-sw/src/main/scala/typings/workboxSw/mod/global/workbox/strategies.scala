...
object strategies {
  ...
  /**
    ...
    * @memberof workbox-strategies
    */
  /* note: abstract class */ @JSGlobal("workbox.strategies.Strategy")
  @js.native
  /**
    * Creates a new instance of the strategy and sets all documented option
    * properties as public instance properties.
    ...
    */
  open class Strategy ()
    extends typings.workboxStrategies.mod.Strategy {
    def this(options: StrategyOptions) = this()
  }
  ...
  /**
    ...
    * @memberof workbox-strategies
    */
  @JSGlobal("workbox.strategies.StrategyHandler")
  @js.native
  open class StrategyHandler protected ()
    extends typings.workboxStrategies.mod.StrategyHandler {
    /**
