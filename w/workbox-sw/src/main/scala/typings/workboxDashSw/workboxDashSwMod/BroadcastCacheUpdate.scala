...
trait BroadcastCacheUpdate extends js.Object {
  /**
  	 ...
  	 */
  def notifyIfUpdated(options: NotifyIfUpdatedOptions): js.Promise[Unit]
}

object BroadcastCacheUpdate {
  @scala.inline
  def apply(notifyIfUpdated: NotifyIfUpdatedOptions => js.Promise[Unit]): BroadcastCacheUpdate = {
