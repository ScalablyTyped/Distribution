...
trait Router extends js.Object {
  /**
  	 ...
  	 */
  val routes: Map[String, js.Array[Route]]
  /**
  	 ...
  	 * ```
  	 */
  def addCacheListener(): Unit
  /**
  	 * Adds a fetch event listener to respond to events when a route matches
  	 * the event's request.
  	 */
  def addFetchListener(): Unit
  /**
  	 ...
  	 */
  def findMatchingRoute(options: FindMatchingRouteOptions): Partial[FindMatchingRouteResult]
  /**
  ...
  /**
  	 ...
  	 */
  def setDefaultHandler(handler: HandlerCallback): Unit
  /**
  	 * Unregisters a route with the router.
  	 * @param {Route} route - The route to unregister.
  	 */
  def unregisterRoute(route: Route): Unit
}

object Router {
  @scala.inline
  def apply(
    addCacheListener: () => Unit,
    addFetchListener: () => Unit,
    findMatchingRoute: FindMatchingRouteOptions => Partial[FindMatchingRouteResult],
    handleRequest: HandleRequestOptions => js.UndefOr[js.Promise[Response]],
    registerRoute: Route => Unit,
    routes: Map[String, js.Array[Route]],
    setCatchHandler: HandlerCallback => Unit,
    setDefaultHandler: HandlerCallback => Unit,
    unregisterRoute: Route => Unit
  ): Router = {
