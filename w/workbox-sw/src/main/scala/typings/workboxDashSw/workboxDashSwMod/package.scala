...
package object workboxDashSwMod {
  ...
  /**
    ...
    */
  type HandlerCallback = CacheStrategy | (js.Function1[/* context */ HandlerContext, js.Promise[Response]])
  /**
    * To signify a match, return anything other than null. Return null if the route shouldn't match.
    */
  type MatchCallback = js.Function1[/* context */ MatchContext, js.Object | Null]
  /**
    * ===== WorkboxNamespace =====
    */
  /**
  ...
  /**
    * ===== StreamsNamespace =====
    */
  type StreamSource = Response | ReadableStream[js.Any] | BodyInit
  /**
    ...
    */
  type UrlManipulation = js.Function1[/* context */ URLContext, js.Array[URL]]
}
