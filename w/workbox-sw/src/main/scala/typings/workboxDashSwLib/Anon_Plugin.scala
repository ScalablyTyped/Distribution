...
trait Anon_Plugin
  ...
  /**
  	 ...
  	 */
  val Plugin: workboxDashSwLib.workboxDashSwMod.IBackgroundSyncPluginConstructor = js.native
  /**
  	 ...
  	 */
  val Queue: workboxDashSwLib.workboxDashSwMod.IQueueConstructor = js.native
}
