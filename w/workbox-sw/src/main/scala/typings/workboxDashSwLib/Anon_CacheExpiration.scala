...
trait Anon_CacheExpiration
  ...
  /**
  	 ...
  	 */
  val CacheExpiration: workboxDashSwLib.workboxDashSwMod.ICacheExpirationConstructor = js.native
  /**
  	 ...
  	 */
  val Plugin: workboxDashSwLib.workboxDashSwMod.IExpirationPluginConstructor = js.native
}
