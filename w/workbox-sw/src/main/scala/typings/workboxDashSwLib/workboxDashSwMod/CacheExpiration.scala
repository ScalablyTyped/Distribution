...
trait CacheExpiration extends js.Object {
  /**
  	 ...
  	 */
  def expireEntries(): stdLib.Promise[scala.Unit]
  /**
  	 ...
  	 */
  def isURLExpired(url: java.lang.String): stdLib.Promise[scala.Boolean]
  /**
  	 ...
  	 * @returns {Promise<void>}
  	 */
  def updateTimestamp(url: java.lang.String): stdLib.Promise[scala.Unit]
}
