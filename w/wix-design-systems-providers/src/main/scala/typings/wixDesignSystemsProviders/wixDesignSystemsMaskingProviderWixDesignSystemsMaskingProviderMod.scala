...
object wixDesignSystemsMaskingProviderWixDesignSystemsMaskingProviderMod {
  ...
  object WixDesignSystemsMaskingProvider {
    ...
    @JSImport("wix-design-systems-providers/dist/types/WixDesignSystemsMaskingProvider/WixDesignSystemsMaskingProvider", "WixDesignSystemsMaskingProvider.displayName")
    @js.native
