...
object IsBorderless {
  @scala.inline
  def apply[/* <: / * import warning: LimitUnionLength.leaveTypeRef Was union type with length 175 * / js.Any */ T](): IsBorderless[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IsBorderless[T]]
  }
  @scala.inline
  implicit class IsBorderlessOps[Self <: IsBorderless[_], /* <: / * import warning: LimitUnionLength.leaveTypeRef Was union type with length 175 * / js.Any */ T] (val x: Self with IsBorderless[T]) extends AnyVal {
    @scala.inline
