package typings.wordpressComponents.textareaControlMod.TextareaControl
...
/* Inlined parent std.Omit<react.react.HTMLProps<std.HTMLTextAreaElement>, keyof @wordpress/components.@wordpress/components/base-control.default.ControlProps | 'onChange'> */
...
object Props {
  ...
  def apply(
    ...
    ref: js.UndefOr[Null | LegacyRef[HTMLTextAreaElement]] = js.undefined,
    rel: String = null,
