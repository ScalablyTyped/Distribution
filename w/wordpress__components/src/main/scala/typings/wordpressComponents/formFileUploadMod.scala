...
import typings.wordpressComponents.wordpressComponentsStrings.`removals additions`
...
object formFileUploadMod {
  
  object default extends Shortcut {
    
    @JSImport("@wordpress/components/form-file-upload", JSImport.Default)
    @js.native
  ...
  object FormFileUpload {
    ...
    object BaseProps {
      ...
      inline def apply(onChange: ChangeEvent[HTMLInputElement] => Unit): BaseProps = {
    ...
    trait IconButtonProps
      ...
      var render: js.UndefOr[scala.Nothing] = js.undefined
    ...
    object IconButtonProps {
      ...
      inline def apply(onChange: ChangeEvent[HTMLInputElement] => Unit): IconButtonProps = {
        val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction1(onChange))
    ...
    */
    ...
    object Props {
      ...
      inline def IconButtonProps(onChange: ChangeEvent[HTMLInputElement] => Unit): typings.wordpressComponents.formFileUploadMod.FormFileUpload.IconButtonProps = {
        val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction1(onChange))
        __obj.asInstanceOf[typings.wordpressComponents.formFileUploadMod.FormFileUpload.IconButtonProps]
      }
      
      inline def RenderProps(onChange: ChangeEvent[HTMLInputElement] => Unit, render: OpenFileDialog => Element): typings.wordpressComponents.formFileUploadMod.FormFileUpload.RenderProps = {
        val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction1(onChange), render = js.Any.fromFunction1(render))
        __obj.asInstanceOf[typings.wordpressComponents.formFileUploadMod.FormFileUpload.RenderProps]
      }
    }
    ...
    object RenderProps {
      ...
      inline def apply(onChange: ChangeEvent[HTMLInputElement] => Unit, render: OpenFileDialog => Element): RenderProps = {
        val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction1(onChange), render = js.Any.fromFunction1(render))
