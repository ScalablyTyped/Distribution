package typings.wordpressComponents.cardMod.Card
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.wordpressComponents.wordpressComponentsStrings.medium
  - typings.wordpressComponents.wordpressComponentsStrings.small
