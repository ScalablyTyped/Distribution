...
object contextMod extends Shortcut {
  ...
  trait SlotFillContext extends StObject {
    ...
    def getFills(name: String, instance: Component[js.Object, js.Object, js.Any]): js.Array[Componentanyoccurrencenum]
    
    def getSlot(name: String): Component[js.Object, js.Object, js.Any]
    
    // FIXME: instance is not correctly typed. but there's a bug in the code that assumes this type.
    def registerFill(name: String, instance: Component[js.Object, js.Object, js.Any]): Unit
    
    def registerSlot(name: String, instance: Component[js.Object, js.Object, js.Any]): Unit
    
    // FIXME: instance is not correctly typed. but there's a bug in the code that assumes this type.
    def unregisterFill(name: String, instance: Component[js.Object, js.Object, js.Any]): Unit
    
    def unregisterSlot(name: String, instance: Component[js.Object, js.Object, js.Any]): Unit
  }
  object SlotFillContext {
    ...
    def apply(
      ...
      registerSlot: (String, Component[js.Object, js.Object, js.Any]) => Unit,
      unregisterFill: (String, Component[js.Object, js.Object, js.Any]) => Unit,
      unregisterSlot: (String, Component[js.Object, js.Object, js.Any]) => Unit
    ): SlotFillContext = {
