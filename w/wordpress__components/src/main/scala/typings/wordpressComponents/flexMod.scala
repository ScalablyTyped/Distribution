  ...
  object Flex {
    ...
    trait FlexProps extends StObject {
      ...
      /**
        ...
        */
      var align: js.UndefOr[AlignItems | top | bottom] = js.undefined
      ...
      /**
        ...
        */
      var direction: js.UndefOr[FlexDirection] = js.undefined
      ...
      /**
        ...
        */
      var justify: js.UndefOr[JustifyContent] = js.undefined
    ...
    object FlexProps {
      ...
      extension [Self <: FlexProps](x: Self) {
        ...
        inline def setAlign(value: AlignItems | top | bottom): Self = StObject.set(x, "align", value.asInstanceOf[js.Any])
        
        inline def setAlignUndefined: Self = StObject.set(x, "align", js.undefined)
        
        inline def setDirection(value: FlexDirection): Self = StObject.set(x, "direction", value.asInstanceOf[js.Any])
        ...
        inline def setJustify(value: JustifyContent): Self = StObject.set(x, "justify", value.asInstanceOf[js.Any])
    ...
    /* Inlined parent @wordpress/components.@wordpress/components/flex.Flex.FlexProps */
    /* Inlined parent std.Omit<react.react.HTMLProps<std.HTMLDivElement>, 'wrap'> */
