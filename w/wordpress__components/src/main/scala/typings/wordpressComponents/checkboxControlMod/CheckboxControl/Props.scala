package typings.wordpressComponents.checkboxControlMod.CheckboxControl
...
trait Props extends js.Object {
  ...
  /**
    ...
    */
  var heading: js.UndefOr[ReactNode] = js.native
  ...
  /**
    ...
    */
  def onChange(isChecked: Boolean): Unit = js.native
...
object Props {
  ...
  @scala.inline
  def apply(onChange: Boolean => Unit): Props = {
  ...
  implicit class PropsOps[Self <: Props] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeading(value: ReactNode): Self = this.set("heading", value.asInstanceOf[js.Any])
