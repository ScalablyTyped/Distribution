...
version := "0.2-dt-20200925Z-378d0f"
scalaVersion := "3.0.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-autosize-textarea" % "7.1.0-2e3f6f",
  "org.scalablytyped" %%% "react-dom" % "17.0-dt-20201120Z-f7391b",
  "org.scalablytyped" %%% "std" % "4.1-f7e8ab",
  "org.scalablytyped" %%% "tinycolor2" % "1.4-dt-20201002Z-5d42bd",
  "org.scalablytyped" %%% "wordpress__block-editor" % "2.2-dt-20200925Z-75ab0b",
  "org.scalablytyped" %%% "wordpress__blocks" % "6.4-dt-20201013Z-64dd1a",
