...
version := "3.0-dt-20220421Z-18ea79"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "wordpress__block-editor" % "7.0-dt-20220413Z-bc1a92",
  "org.scalablytyped" %%% "wordpress__blocks" % "11.0-dt-20220815Z-3a332e",
