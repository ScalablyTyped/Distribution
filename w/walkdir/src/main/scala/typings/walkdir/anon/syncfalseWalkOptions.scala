...
/* Inlined {  sync ? :false} & walkdir.walkdir/walkdir.WalkOptions */
trait syncfalseWalkOptions extends js.Object {
  /**
  ...
  /**
    ...
    */
  var sync: js.UndefOr[`false` with Boolean] = js.undefined
  /**
...
object syncfalseWalkOptions {
  ...
  def apply(
    ...
    sync: js.UndefOr[`false` with Boolean] = js.undefined,
    track_inodes: js.UndefOr[Boolean] = js.undefined
  ): syncfalseWalkOptions = {
    ...
    __obj.asInstanceOf[syncfalseWalkOptions]
  }
}
