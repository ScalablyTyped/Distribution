...
@js.native
trait synctruereturnobjecttrueW extends js.Object {
...
object synctruereturnobjecttrueW {
  ...
  @scala.inline
  implicit class synctruereturnobjecttrueWOps[Self <: synctruereturnobjecttrueW] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setReturn_object(value: `true` with js.UndefOr[Boolean]): Self = this.set("return_object", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSync(value: `true` with js.UndefOr[Boolean]): Self = this.set("sync", value.asInstanceOf[js.Any])
