...
@js.native
trait syncfalseundefinedWalkOpt extends js.Object {
  /**
...
object syncfalseundefinedWalkOpt {
  ...
  @scala.inline
  implicit class syncfalseundefinedWalkOptOps[Self <: syncfalseundefinedWalkOpt] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSync(value: js.UndefOr[`false`] with js.UndefOr[Boolean]): Self = this.set("sync", value.asInstanceOf[js.Any])
    @scala.inline
    def setFilter(
