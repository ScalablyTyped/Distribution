...
object ISmsBinaryMessage {
  ...
  extension [Self <: ISmsBinaryMessage](x: Self) {
    ...
    inline def setGetData(value: () => Uint8Array): Self = StObject.set(x, "getData", js.Any.fromFunction0(value))
    
    inline def setSetData(value: Uint8Array => Unit): Self = StObject.set(x, "setData", js.Any.fromFunction1(value))
  }
}
