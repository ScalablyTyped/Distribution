...
import typings.winrt.Windows.Graphics.Imaging.BitmapFlip.horizontal
import typings.winrt.Windows.Graphics.Imaging.BitmapFlip.none
import typings.winrt.Windows.Graphics.Imaging.BitmapFlip.vertical
