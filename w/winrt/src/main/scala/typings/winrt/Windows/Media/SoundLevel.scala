...
object SoundLevel extends js.Object {
  ...
  /* 2 */ val full: typings.winrt.Windows.Media.SoundLevel.full with Double = js.native
  /* 1 */ val low: typings.winrt.Windows.Media.SoundLevel.low with Double = js.native
  /* 0 */ val muted: typings.winrt.Windows.Media.SoundLevel.muted with Double = js.native
  @JSBracketAccess
