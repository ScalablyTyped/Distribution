...
object ICompass {
  ...
  @scala.inline
  implicit class ICompassOps[Self <: ICompass] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setGetCurrentReading(value: () => CompassReading): Self = this.set("getCurrentReading", js.Any.fromFunction0(value))
    @scala.inline
