...
object ITextParagraphFormat {
  ...
  implicit open class MutableBuilder[Self <: ITextParagraphFormat] (val x: Self) extends AnyVal {
    ...
    inline def setClearAllTabs(value: () => Unit): Self = StObject.set(x, "clearAllTabs", js.Any.fromFunction0(value))
    
    inline def setDeleteTab(value: Double => Unit): Self = StObject.set(x, "deleteTab", js.Any.fromFunction1(value))
    
    inline def setFirstLineIndent(value: Double): Self = StObject.set(x, "firstLineIndent", value.asInstanceOf[js.Any])
    
    inline def setGetClone(value: () => ITextParagraphFormat): Self = StObject.set(x, "getClone", js.Any.fromFunction0(value))
    ...
    inline def setSetClone(value: ITextParagraphFormat => Unit): Self = StObject.set(x, "setClone", js.Any.fromFunction1(value))
    
    inline def setSetIndents(value: (Double, Double, Double) => Unit): Self = StObject.set(x, "setIndents", js.Any.fromFunction3(value))
    
    inline def setSetLineSpacing(value: (LineSpacingRule, Double) => Unit): Self = StObject.set(x, "setLineSpacing", js.Any.fromFunction2(value))
