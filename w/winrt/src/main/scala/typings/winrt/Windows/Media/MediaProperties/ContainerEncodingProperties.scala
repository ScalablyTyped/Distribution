...
- typings.winrt.Windows.Media.MediaProperties.IMediaEncodingProperties because Already inherited */ @JSGlobal("Windows.Media.MediaProperties.ContainerEncodingProperties")
@js.native
