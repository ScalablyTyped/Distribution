...
object Core {
  ...
  object CoreApplication {
    ...
    inline def getCurrentView(): typings.winrt.Windows.ApplicationModel.Core.CoreApplicationView = ^.asInstanceOf[js.Dynamic].applyDynamic("getCurrentView")().asInstanceOf[typings.winrt.Windows.ApplicationModel.Core.CoreApplicationView]
    ...
    inline def mainView_=(x: typings.winrt.Windows.ApplicationModel.Core.CoreApplicationView): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("mainView")(x.asInstanceOf[js.Any])
    ...
    inline def views_=(x: IVectorView[typings.winrt.Windows.ApplicationModel.Core.CoreApplicationView]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("views")(x.asInstanceOf[js.Any])
  }
