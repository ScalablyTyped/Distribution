...
class GestureRecognizer ()
  ...
  /* CompleteClass */
  override var gestureSettings: typings.winrt.Windows.UI.Input.GestureSettings = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var mouseWheelParameters: typings.winrt.Windows.UI.Input.MouseWheelParameters = js.native
  /* CompleteClass */
