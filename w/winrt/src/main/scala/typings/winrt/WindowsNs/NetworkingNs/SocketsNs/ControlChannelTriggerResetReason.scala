...
object ControlChannelTriggerResetReason extends js.Object {
  ...
  /* 0 */ val fastUserSwitched: typings.winrt.WindowsNs.NetworkingNs.SocketsNs.ControlChannelTriggerResetReason.fastUserSwitched with Double = js.native
  /* 1 */ val lowPowerExit: typings.winrt.WindowsNs.NetworkingNs.SocketsNs.ControlChannelTriggerResetReason.lowPowerExit with Double = js.native
  @JSBracketAccess
