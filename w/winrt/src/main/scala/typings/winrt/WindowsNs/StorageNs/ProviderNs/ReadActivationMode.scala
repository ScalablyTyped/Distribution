...
object ReadActivationMode extends js.Object {
  ...
  /* 1 */ val beforeAccess: typings.winrt.WindowsNs.StorageNs.ProviderNs.ReadActivationMode.beforeAccess with Double = js.native
  /* 0 */ val notNeeded: typings.winrt.WindowsNs.StorageNs.ProviderNs.ReadActivationMode.notNeeded with Double = js.native
  @JSBracketAccess
