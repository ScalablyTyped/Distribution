...
object CompositionType extends js.Object {
  ...
  /* 0 */ val `protected`: typings.winrt.WindowsNs.FoundationNs.MetadataNs.CompositionType.`protected` with Double = js.native
  /* 1 */ val public: typings.winrt.WindowsNs.FoundationNs.MetadataNs.CompositionType.public with Double = js.native
  @JSBracketAccess
