...
object InkRecognitionTarget extends js.Object {
  ...
  /* 0 */ val all: typings.winrt.WindowsNs.UINs.InputNs.InkingNs.InkRecognitionTarget.all with Double = js.native
  /* 2 */ val recent: typings.winrt.WindowsNs.UINs.InputNs.InkingNs.InkRecognitionTarget.recent with Double = js.native
  /* 1 */ val selected: typings.winrt.WindowsNs.UINs.InputNs.InkingNs.InkRecognitionTarget.selected with Double = js.native
  @JSBracketAccess
