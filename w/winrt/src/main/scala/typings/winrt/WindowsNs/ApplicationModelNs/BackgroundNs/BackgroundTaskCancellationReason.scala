...
object BackgroundTaskCancellationReason extends js.Object {
  ...
  /* 0 */ val abort: typings.winrt.WindowsNs.ApplicationModelNs.BackgroundNs.BackgroundTaskCancellationReason.abort with Double = js.native
  /* 2 */ val loggingOff: typings.winrt.WindowsNs.ApplicationModelNs.BackgroundNs.BackgroundTaskCancellationReason.loggingOff with Double = js.native
  /* 3 */ val servicingUpdate: typings.winrt.WindowsNs.ApplicationModelNs.BackgroundNs.BackgroundTaskCancellationReason.servicingUpdate with Double = js.native
  /* 1 */ val terminating: typings.winrt.WindowsNs.ApplicationModelNs.BackgroundNs.BackgroundTaskCancellationReason.terminating with Double = js.native
  @JSBracketAccess
