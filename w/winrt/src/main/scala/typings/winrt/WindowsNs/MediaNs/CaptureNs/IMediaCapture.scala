...
import typings.winrt.WindowsNs.MediaNs.DevicesNs.AudioDeviceController
import typings.winrt.WindowsNs.MediaNs.DevicesNs.VideoDeviceController
import typings.winrt.WindowsNs.MediaNs.IMediaExtension
import typings.winrt.WindowsNs.MediaNs.MediaPropertiesNs.ImageEncodingProperties
