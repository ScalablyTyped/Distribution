...
object ExportOption extends js.Object {
  ...
  /* 1 */ val exportable: typings.winrt.WindowsNs.SecurityNs.CryptographyNs.CertificatesNs.ExportOption.exportable with Double = js.native
  /* 0 */ val notExportable: typings.winrt.WindowsNs.SecurityNs.CryptographyNs.CertificatesNs.ExportOption.notExportable with Double = js.native
  @JSBracketAccess
