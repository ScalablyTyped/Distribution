...
object PowerlineFrequency extends js.Object {
  ...
  /* 0 */ val disabled: typings.winrt.WindowsNs.MediaNs.CaptureNs.PowerlineFrequency.disabled with Double = js.native
  /* 1 */ val fiftyHertz: typings.winrt.WindowsNs.MediaNs.CaptureNs.PowerlineFrequency.fiftyHertz with Double = js.native
  /* 2 */ val sixtyHertz: typings.winrt.WindowsNs.MediaNs.CaptureNs.PowerlineFrequency.sixtyHertz with Double = js.native
  @JSBracketAccess
