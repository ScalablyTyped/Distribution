...
object PointerDeviceType extends js.Object {
  ...
  /* 2 */ val mouse: typings.winrt.WindowsNs.DevicesNs.InputNs.PointerDeviceType.mouse with Double = js.native
  /* 1 */ val pen: typings.winrt.WindowsNs.DevicesNs.InputNs.PointerDeviceType.pen with Double = js.native
  /* 0 */ val touch: typings.winrt.WindowsNs.DevicesNs.InputNs.PointerDeviceType.touch with Double = js.native
  @JSBracketAccess
