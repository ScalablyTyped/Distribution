...
object CaretType extends js.Object {
  ...
  /* 0 */ val normal: typings.winrt.WindowsNs.UINs.TextNs.CaretType.normal with Double = js.native
  /* 1 */ val null_ : typings.winrt.WindowsNs.UINs.TextNs.CaretType.null_ with Double = js.native
  @JSBracketAccess
