...
object FileAccessMode extends js.Object {
  ...
  /* 0 */ val read: typings.winrt.WindowsNs.StorageNs.FileAccessMode.read with Double = js.native
  /* 1 */ val readWrite: typings.winrt.WindowsNs.StorageNs.FileAccessMode.readWrite with Double = js.native
  @JSBracketAccess
