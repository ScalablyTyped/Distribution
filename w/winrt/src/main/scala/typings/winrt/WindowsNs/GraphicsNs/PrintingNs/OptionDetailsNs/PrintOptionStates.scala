...
object PrintOptionStates extends js.Object {
  ...
  /* 2 */ val constrained: typings.winrt.WindowsNs.GraphicsNs.PrintingNs.OptionDetailsNs.PrintOptionStates.constrained with Double = js.native
  /* 1 */ val enabled: typings.winrt.WindowsNs.GraphicsNs.PrintingNs.OptionDetailsNs.PrintOptionStates.enabled with Double = js.native
  /* 0 */ val none: typings.winrt.WindowsNs.GraphicsNs.PrintingNs.OptionDetailsNs.PrintOptionStates.none with Double = js.native
  @JSBracketAccess
