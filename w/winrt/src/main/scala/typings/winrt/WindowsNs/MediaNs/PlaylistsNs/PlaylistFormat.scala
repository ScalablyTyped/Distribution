...
object PlaylistFormat extends js.Object {
  ...
  /* 2 */ val m3u: typings.winrt.WindowsNs.MediaNs.PlaylistsNs.PlaylistFormat.m3u with Double = js.native
  /* 0 */ val windowsMedia: typings.winrt.WindowsNs.MediaNs.PlaylistsNs.PlaylistFormat.windowsMedia with Double = js.native
  /* 1 */ val zune: typings.winrt.WindowsNs.MediaNs.PlaylistsNs.PlaylistFormat.zune with Double = js.native
  @JSBracketAccess
