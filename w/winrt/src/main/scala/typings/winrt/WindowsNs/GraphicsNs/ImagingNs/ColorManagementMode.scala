...
object ColorManagementMode extends js.Object {
  ...
  /* 1 */ val colorManageToSRgb: typings.winrt.WindowsNs.GraphicsNs.ImagingNs.ColorManagementMode.colorManageToSRgb with Double = js.native
  /* 0 */ val doNotColorManage: typings.winrt.WindowsNs.GraphicsNs.ImagingNs.ColorManagementMode.doNotColorManage with Double = js.native
  @JSBracketAccess
