...
object CoreWindowActivationState extends js.Object {
  ...
  /* 0 */ val codeActivated: typings.winrt.WindowsNs.UINs.CoreNs.CoreWindowActivationState.codeActivated with Double = js.native
  /* 1 */ val deactivated: typings.winrt.WindowsNs.UINs.CoreNs.CoreWindowActivationState.deactivated with Double = js.native
  /* 2 */ val pointerActivated: typings.winrt.WindowsNs.UINs.CoreNs.CoreWindowActivationState.pointerActivated with Double = js.native
  @JSBracketAccess
