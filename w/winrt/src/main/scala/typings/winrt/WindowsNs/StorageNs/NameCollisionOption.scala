...
object NameCollisionOption extends js.Object {
  ...
  /* 2 */ val failIfExists: typings.winrt.WindowsNs.StorageNs.NameCollisionOption.failIfExists with Double = js.native
  /* 0 */ val generateUniqueName: typings.winrt.WindowsNs.StorageNs.NameCollisionOption.generateUniqueName with Double = js.native
  /* 1 */ val replaceExisting: typings.winrt.WindowsNs.StorageNs.NameCollisionOption.replaceExisting with Double = js.native
  @JSBracketAccess
