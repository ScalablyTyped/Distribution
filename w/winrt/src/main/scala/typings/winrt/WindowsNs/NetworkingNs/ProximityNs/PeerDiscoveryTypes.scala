...
object PeerDiscoveryTypes extends js.Object {
  ...
  /* 1 */ val browse: typings.winrt.WindowsNs.NetworkingNs.ProximityNs.PeerDiscoveryTypes.browse with Double = js.native
  /* 0 */ val none: typings.winrt.WindowsNs.NetworkingNs.ProximityNs.PeerDiscoveryTypes.none with Double = js.native
  /* 2 */ val triggered: typings.winrt.WindowsNs.NetworkingNs.ProximityNs.PeerDiscoveryTypes.triggered with Double = js.native
  @JSBracketAccess
