...
object BinaryStringEncoding extends js.Object {
  ...
  /* 2 */ val utf16BE: typings.winrt.WindowsNs.SecurityNs.CryptographyNs.BinaryStringEncoding.utf16BE with Double = js.native
  /* 1 */ val utf16LE: typings.winrt.WindowsNs.SecurityNs.CryptographyNs.BinaryStringEncoding.utf16LE with Double = js.native
  /* 0 */ val utf8: typings.winrt.WindowsNs.SecurityNs.CryptographyNs.BinaryStringEncoding.utf8 with Double = js.native
  @JSBracketAccess
