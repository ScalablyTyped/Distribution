...
object JpegSubsamplingMode extends js.Object {
  ...
  /* 0 */ val default: typings.winrt.WindowsNs.GraphicsNs.ImagingNs.JpegSubsamplingMode.default with Double = js.native
  /* 1 */ val y4Cb2Cr0: typings.winrt.WindowsNs.GraphicsNs.ImagingNs.JpegSubsamplingMode.y4Cb2Cr0 with Double = js.native
  /* 2 */ val y4Cb2Cr2: typings.winrt.WindowsNs.GraphicsNs.ImagingNs.JpegSubsamplingMode.y4Cb2Cr2 with Double = js.native
  /* 3 */ val y4Cb4Cr4: typings.winrt.WindowsNs.GraphicsNs.ImagingNs.JpegSubsamplingMode.y4Cb4Cr4 with Double = js.native
  @JSBracketAccess
