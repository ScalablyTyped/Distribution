...
class StorageItemThumbnail ()
  ...
  /* CompleteClass */
  override var originalHeight: scala.Double = js.native
  /* CompleteClass */
  override var originalWidth: scala.Double = js.native
  /* CompleteClass */
  override var position: scala.Double = js.native
  /* CompleteClass */
  override var returnedSmallerCachedSize: scala.Boolean = js.native
  /* CompleteClass */
