...
class CurrencyFormatter protected () extends ICurrencyFormatter {
  ...
  def this(currencyCode: java.lang.String, languages: winrtLib.WindowsNs.FoundationNs.CollectionsNs.IIterable[java.lang.String], geographicRegion: java.lang.String) = this()
  /* CompleteClass */
  override var currency: java.lang.String = js.native
  /* CompleteClass */
