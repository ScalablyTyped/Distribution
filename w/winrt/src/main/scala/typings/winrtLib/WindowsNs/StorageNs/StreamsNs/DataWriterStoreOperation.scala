...
class DataWriterStoreOperation ()
  ...
  @JSName("operation")
  var operation_DataWriterStoreOperation: winrtLib.Anon_AsyncInfoAsyncStatusCompletedGetResultsAsyncOperationCompletedHandlerIAsyncOperationNumber = js.native
  /* CompleteClass */
