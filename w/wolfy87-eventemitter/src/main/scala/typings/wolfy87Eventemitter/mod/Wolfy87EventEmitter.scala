package typings.wolfy87Eventemitter.mod
...
object Wolfy87EventEmitter extends js.Object {
  ...
  trait EventEmitter extends js.Object {
    ...
    /**
      ...
      */
    def addListener(event: String, listener: js.Function): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Adds a listener function to the specified event.
      * The listener will not be added if it is a duplicate.
      * If the listener returns true then it will be removed after it is called.
    ...
    /**
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def addListeners(event: String, listeners: js.Array[js.Function]): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Adds listeners in bulk using the manipulateListeners method.
      * If you pass an object as the second argument you can add to multiple events at once.
      * The object should contain key value pairs of events and listeners or listener arrays.
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def addListeners(event: RegExp, listeners: js.Array[js.Function]): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Adds listeners in bulk using the manipulateListeners method.
      * If you pass an object as the second argument you can add to multiple events at once.
      * The object should contain key value pairs of events and listeners or listener arrays.
    ...
    /**
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def addOnceListener(event: String, listener: js.Function): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Semi-alias of addListener. It will add a listener that will be
      * automatically removed after it's first execution.
      *
    ...
    /**
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def emit(event: String, args: js.Any*): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Subtly different from emitEvent in that it will pass its arguments on to the listeners,
      * as opposed to taking a single array of arguments to pass on.
      * As with emitEvent, you can pass a regex in place of the event name to emit to all events that match it.
    ...
    /**
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def manipulateListeners(remove: Boolean, event: String, listeners: js.Array[js.Function]): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Edits listeners in bulk. The addListeners and removeListeners methods both use this to do their job.
      * You should really use those instead, this is a little lower level.
      * The first argument will determine if the listeners are removed (true) or added (false).
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def manipulateListeners(remove: Boolean, event: RegExp, listeners: js.Array[js.Function]): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Edits listeners in bulk. The addListeners and removeListeners methods both use this to do their job.
      * You should really use those instead, this is a little lower level.
      * The first argument will determine if the listeners are removed (true) or added (false).
    ...
    /**
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def off(event: String, listener: js.Function): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Removes a listener function from the specified event.
      * When passed a regular expression as the event name, it will remove the listener from all events that match it.
      *
    ...
    /**
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def on(event: String, listener: js.Function): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Adds a listener function to the specified event.
      * The listener will not be added if it is a duplicate.
      * If the listener returns true then it will be removed after it is called.
    ...
    /**
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def once(event: String, listener: js.Function): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Semi-alias of addListener. It will add a listener that will be
      * automatically removed after it's first execution.
      *
    ...
    /**
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def removeListener(event: String, listener: js.Function): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Removes a listener function from the specified event.
      * When passed a regular expression as the event name, it will remove the listener from all events that match it.
      *
    ...
    /**
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def removeListeners(event: String, listeners: js.Array[js.Function]): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Removes listeners in bulk using the manipulateListeners method.
      * If you pass an object as the second argument you can remove from multiple events at once.
      * The object should contain key value pairs of events and listeners or listener arrays.
      ...
      * @return {EventEmitter} Current instance of EventEmitter for chaining.
      */
    def removeListeners(event: RegExp, listeners: js.Array[js.Function]): typings.wolfy87Eventemitter.mod.Wolfy87EventEmitter.EventEmitter = js.native
    /**
      * Removes listeners in bulk using the manipulateListeners method.
      * If you pass an object as the second argument you can remove from multiple events at once.
      * The object should contain key value pairs of events and listeners or listener arrays.
