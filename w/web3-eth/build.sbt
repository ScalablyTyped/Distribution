...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "web3-eth-abi" % "1.8.0-286034",
  "org.scalablytyped" %%% "web3-eth-accounts" % "1.8.0-6dc8b7",
  "org.scalablytyped" %%% "web3-eth-contract" % "1.8.0-bf3f41",
  "org.scalablytyped" %%% "web3-eth-ens" % "1.8.0-d9d8d9",
  "org.scalablytyped" %%% "web3-eth-iban" % "1.8.0-428945",
  "org.scalablytyped" %%% "web3-eth-personal" % "1.8.0-947873",
  "org.scalablytyped" %%% "web3-net" % "1.8.0-12f46d",
