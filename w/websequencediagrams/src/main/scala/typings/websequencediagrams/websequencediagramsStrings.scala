...
object websequencediagramsStrings {
  @js.native
  sealed trait default extends Style
  
  @js.native
  sealed trait earth extends Style
  
  @js.native
  sealed trait magazine extends Style
  
  @js.native
  sealed trait `modern-blue` extends Style
  
  @js.native
  sealed trait mscgen extends Style
  
  @js.native
  sealed trait napkin extends Style
  
  @js.native
  sealed trait omegapple extends Style
  
  @js.native
  sealed trait patent extends Style
  
  @js.native
  sealed trait pdf extends OutputType
  
  @js.native
  sealed trait png extends OutputType
  
  @js.native
  sealed trait qsd extends Style
  
  @js.native
  sealed trait rose extends Style
  
  @js.native
  sealed trait roundgreen extends Style
  
  @js.native
  sealed trait svg extends OutputType
  
  @js.native
  sealed trait vs2010 extends Style
