...
type Contextual[T /* <: typings.wordpressApiFetch.mod.Schema.Context */, TAdditional, TEditAdditional] = (typings.wordpressApiFetch.anon.Rendered & TAdditional) | (typings.wordpressApiFetch.anon.Raw & TAdditional & TEditAdditional)
...
{[ k in keyof T ]: T[k] extends @wordpress/api-fetch.@wordpress/api-fetch.Schema.Contextual<any, {}, {}>? string : T[k]}
  */ typings.wordpressApiFetch.wordpressApiFetchStrings.Decontextualize & org.scalablytyped.runtime.TopLevel[js.Any]
...
// prettier-ignore
type PostOrPage[T /* <: typings.wordpressApiFetch.mod.Schema.Context */] = (typings.wordpressApiFetch.mod.Schema.BasePost[T] & typings.std.Partial[typings.wordpressApiFetch.mod.Schema.BasePage[T]]) | ((typings.std.Pick[
typings.wordpressApiFetch.mod.Schema.BasePost[T], 
typings.wordpressApiFetch.mod.Schema.ViewKeys.Post]) & (typings.std.Partial[
typings.std.Pick[
  typings.wordpressApiFetch.mod.Schema.BasePage[T], 
  typings.wordpressApiFetch.mod.Schema.ViewKeys.Page
]])) | ((typings.std.Pick[
typings.wordpressApiFetch.mod.Schema.BasePost[T], 
typings.wordpressApiFetch.mod.Schema.EmbedKeys.Post]) & (typings.std.Partial[
typings.std.Pick[
  typings.wordpressApiFetch.mod.Schema.BasePage[T], 
