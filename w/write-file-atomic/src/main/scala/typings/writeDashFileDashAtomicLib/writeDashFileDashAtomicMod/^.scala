...
object ^ extends js.Object {
  ...
  def sync(filename: java.lang.String, data: java.lang.String, options: Options): scala.Unit = js.native
  def sync(filename: java.lang.String, data: nodeLib.Buffer): scala.Unit = js.native
  def sync(filename: java.lang.String, data: nodeLib.Buffer, options: Options): scala.Unit = js.native
}
