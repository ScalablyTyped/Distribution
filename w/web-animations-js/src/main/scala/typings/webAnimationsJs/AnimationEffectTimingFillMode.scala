...
/* Rewritten from type alias, can be one of: 
  - typings.webAnimationsJs.webAnimationsJsStrings.none
  - typings.webAnimationsJs.webAnimationsJsStrings.forwards
  - typings.webAnimationsJs.webAnimationsJsStrings.backwards
