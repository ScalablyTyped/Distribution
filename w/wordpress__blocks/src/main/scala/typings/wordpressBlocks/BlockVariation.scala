...
trait BlockVariation[Attributes /* <: BlockAttributes */] extends StObject {
  ...
  var isActive: js.UndefOr[
    (js.Function2[/* blockAttributes */ Attributes, /* variationAttributes */ Attributes, Boolean]) | js.Array[String]
  ] = js.undefined
...
object BlockVariation {
  ...
  implicit open class MutableBuilder[Self <: BlockVariation[?], Attributes /* <: BlockAttributes */] (val x: Self & BlockVariation[Attributes]) extends AnyVal {
    ...
    inline def setIsActive(
      value: (js.Function2[/* blockAttributes */ Attributes, /* variationAttributes */ Attributes, Boolean]) | js.Array[String]
    ): Self = StObject.set(x, "isActive", value.asInstanceOf[js.Any])
    
    inline def setIsActiveFunction2(value: (/* blockAttributes */ Attributes, /* variationAttributes */ Attributes) => Boolean): Self = StObject.set(x, "isActive", js.Any.fromFunction2(value))
    
    inline def setIsActiveUndefined: Self = StObject.set(x, "isActive", js.undefined)
    
    inline def setIsActiveVarargs(value: String*): Self = StObject.set(x, "isActive", js.Array(value*))
