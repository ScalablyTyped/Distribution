...
object AttributeSource {
  ...
  */
  ...
  trait Query[T]
    ...
    var query: /* import warning: importer.ImportType#apply Failed type conversion: {[ k in keyof T ]: @wordpress/blocks.BlockAttribute<T[k] extends std.Array<infer U>? U : T[k]>} */ js.Any
  ...
  object Query {
    ...
    inline def apply[T](
      query: /* import warning: importer.ImportType#apply Failed type conversion: {[ k in keyof T ]: @wordpress/blocks.BlockAttribute<T[k] extends std.Array<infer U>? U : T[k]>} */ js.Any,
      selector: String
    ): Query[T] = {
    ...
    implicit open class MutableBuilder[Self <: Query[?], T] (val x: Self & Query[T]) extends AnyVal {
      ...
      inline def setQuery(
        value: /* import warning: importer.ImportType#apply Failed type conversion: {[ k in keyof T ]: @wordpress/blocks.BlockAttribute<T[k] extends std.Array<infer U>? U : T[k]>} */ js.Any
