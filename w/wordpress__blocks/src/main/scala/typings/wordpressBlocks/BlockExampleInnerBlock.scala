...
/**
  ...
  */
/* Inlined std.Partial<@wordpress/blocks.Block<{}>> & std.Pick<@wordpress/blocks.Block<{}>, 'name' | 'attributes'> & {  innerBlocks :std.ReadonlyArray<@wordpress/blocks.BlockExampleInnerBlock> | undefined} */
...
object BlockExampleInnerBlock {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BlockExampleInnerBlock] (val x: Self) extends AnyVal {
