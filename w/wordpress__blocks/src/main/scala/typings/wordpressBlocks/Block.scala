...
trait Block[T /* <: Record[String, Any] */] extends StObject {
  ...
  /**
    ...
    */
  val attributes: /* import warning: importer.ImportType#apply Failed type conversion: {readonly [ k in keyof T ]: @wordpress/blocks.BlockAttribute<T[k] extends std.Array<infer U>? U : T[k]>} */ js.Any
...
object Block {
  ...
  inline def apply[T /* <: Record[String, Any] */](
    attributes: /* import warning: importer.ImportType#apply Failed type conversion: {readonly [ k in keyof T ]: @wordpress/blocks.BlockAttribute<T[k] extends std.Array<infer U>? U : T[k]>} */ js.Any,
    category: String,
