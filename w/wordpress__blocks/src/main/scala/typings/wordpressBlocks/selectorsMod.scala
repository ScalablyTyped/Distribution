...
object selectorsMod {
  ...
  @JSImport("@wordpress/blocks/store/selectors", "getBlockStyles")
  @js.native
  def getBlockStyles(blockName: String): js.UndefOr[js.Array[BlockStyle]] = js.native
  
  @JSImport("@wordpress/blocks/store/selectors", "getBlockSupport")
  @js.native
  ...
  @JSImport("@wordpress/blocks/store/selectors", "getBlockType")
  @js.native
  ...
  @JSImport("@wordpress/blocks/store/selectors", "getBlockTypes")
  @js.native
  def getBlockTypes(): js.Array[Block[_]] = js.native
  
  @JSImport("@wordpress/blocks/store/selectors", "getCategories")
  @js.native
  def getCategories(): js.Array[Category] = js.native
  
  @JSImport("@wordpress/blocks/store/selectors", "getChildBlockNames")
  @js.native
  def getChildBlockNames(blockName: String): js.Array[String] = js.native
  
  @JSImport("@wordpress/blocks/store/selectors", "getDefaultBlockName")
  @js.native
  def getDefaultBlockName(): js.UndefOr[String] = js.native
  
  @JSImport("@wordpress/blocks/store/selectors", "getFreeformFallbackBlockName")
  @js.native
  def getFreeformFallbackBlockName(): js.UndefOr[String] = js.native
  
  @JSImport("@wordpress/blocks/store/selectors", "getGroupingBlockName")
  @js.native
  def getGroupingBlockName(): js.UndefOr[String] = js.native
  
  @JSImport("@wordpress/blocks/store/selectors", "getUnregisteredFallbackBlockName")
  @js.native
  def getUnregisteredFallbackBlockName(): js.UndefOr[String] = js.native
  
  @JSImport("@wordpress/blocks/store/selectors", "hasBlockSupport")
  @js.native
  ...
  @JSImport("@wordpress/blocks/store/selectors", "hasChildBlocks")
  @js.native
  def hasChildBlocks(blockName: String): Boolean = js.native
  
  @JSImport("@wordpress/blocks/store/selectors", "hasChildBlocksWithInserterSupport")
  @js.native
  def hasChildBlocksWithInserterSupport(blockName: String): Boolean = js.native
  
  @JSImport("@wordpress/blocks/store/selectors", "isMatchingSearchTerm")
  @js.native
