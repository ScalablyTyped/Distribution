...
@scala.inline
def cloneBlock[T /* <: typings.std.Record[java.lang.String, js.Any] */](
...
@scala.inline
def createBlock[T /* <: typings.std.Record[java.lang.String, js.Any] */](name: java.lang.String): typings.wordpressBlocks.mod.BlockInstance[T] = typings.wordpressBlocks.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createBlock")(name.asInstanceOf[js.Any]).asInstanceOf[typings.wordpressBlocks.mod.BlockInstance[T]]
@scala.inline
def createBlock[T /* <: typings.std.Record[java.lang.String, js.Any] */](
...
@scala.inline
def doBlocksMatchTemplate(blocks: scala.Unit, template: typings.wordpressBlocks.templatesMod.TemplateArray): scala.Boolean = (typings.wordpressBlocks.mod.^.asInstanceOf[js.Dynamic].applyDynamic("doBlocksMatchTemplate")(blocks.asInstanceOf[js.Any], template.asInstanceOf[js.Any])).asInstanceOf[scala.Boolean]
...
@scala.inline
def getBlockAttributes[T /* <: typings.wordpressBlocks.mod.Block[js.Any] */](blockTypeOrName: T, innerHTML: java.lang.String): js.Any = (typings.wordpressBlocks.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getBlockAttributes")(blockTypeOrName.asInstanceOf[js.Any], innerHTML.asInstanceOf[js.Any])).asInstanceOf[js.Any]
@scala.inline
def getBlockAttributes[T /* <: typings.wordpressBlocks.mod.Block[js.Any] */](
  blockTypeOrName: T,
  innerHTML: java.lang.String,
  attributes: typings.std.Record[java.lang.String, js.Any]
...
@scala.inline
def getBlockTransforms_from[T /* <: typings.std.Record[java.lang.String, js.Any] */](direction: typings.wordpressBlocks.wordpressBlocksStrings.from): js.Array[
...
@scala.inline
def getBlockTransforms_from[T /* <: typings.std.Record[java.lang.String, js.Any] */](direction: typings.wordpressBlocks.wordpressBlocksStrings.from, blockTypeOrName: java.lang.String): js.Array[
...
typings.wordpressBlocks.mod.Transform[T] & typings.wordpressBlocks.anon.BlockName]]
@scala.inline
def getBlockTransforms_from[T /* <: typings.std.Record[java.lang.String, js.Any] */](
...
@scala.inline
def getBlockTransforms_to[T /* <: typings.std.Record[java.lang.String, js.Any] */](direction: typings.wordpressBlocks.wordpressBlocksStrings.to): js.Array[
typings.wordpressBlocks.mod.Transform[T] & typings.wordpressBlocks.anon.BlockName] = typings.wordpressBlocks.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getBlockTransforms")(direction.asInstanceOf[js.Any]).asInstanceOf[js.Array[
typings.wordpressBlocks.mod.Transform[T] & typings.wordpressBlocks.anon.BlockName]]
@scala.inline
def getBlockTransforms_to[T /* <: typings.std.Record[java.lang.String, js.Any] */](direction: typings.wordpressBlocks.wordpressBlocksStrings.to, blockTypeOrName: java.lang.String): js.Array[
typings.wordpressBlocks.mod.Transform[T] & typings.wordpressBlocks.anon.BlockName] = (typings.wordpressBlocks.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getBlockTransforms")(direction.asInstanceOf[js.Any], blockTypeOrName.asInstanceOf[js.Any])).asInstanceOf[js.Array[
typings.wordpressBlocks.mod.Transform[T] & typings.wordpressBlocks.anon.BlockName]]
@scala.inline
def getBlockTransforms_to[T /* <: typings.std.Record[java.lang.String, js.Any] */](
...
@scala.inline
def getBlockTypes(): js.Array[typings.wordpressBlocks.mod.Block[js.Any]] = typings.wordpressBlocks.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getBlockTypes")().asInstanceOf[js.Array[typings.wordpressBlocks.mod.Block[js.Any]]]
...
@scala.inline
def isReusableBlock(blockOrType: typings.wordpressBlocks.mod.Block[js.Any]): scala.Boolean = typings.wordpressBlocks.mod.^.asInstanceOf[js.Dynamic].applyDynamic("isReusableBlock")(blockOrType.asInstanceOf[js.Any]).asInstanceOf[scala.Boolean]
@scala.inline
def isReusableBlock(
...
@scala.inline
def parseWithAttributeSchema[T /* <: typings.std.Record[java.lang.String, typings.wordpressBlocks.parserMod.Source[js.Any]] */](innerHTML: java.lang.String, schema: typings.wordpressBlocks.parserMod.Schema.Query[T]): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
...
@scala.inline
def pasteHandler(options: typings.wordpressBlocks.rawHandlingMod.pasteHandler.Options): (js.Array[
...
typings.wordpressBlocks.mod.BlockInstance[org.scalablytyped.runtime.StringDictionary[js.Any]]]]
@scala.inline
def synchronizeBlocksWithTemplate(blocks: scala.Unit, template: typings.wordpressBlocks.templatesMod.TemplateArray): js.Array[
typings.wordpressBlocks.mod.BlockInstance[org.scalablytyped.runtime.StringDictionary[js.Any]]] = (typings.wordpressBlocks.mod.^.asInstanceOf[js.Dynamic].applyDynamic("synchronizeBlocksWithTemplate")(blocks.asInstanceOf[js.Any], template.asInstanceOf[js.Any])).asInstanceOf[js.Array[
typings.wordpressBlocks.mod.BlockInstance[org.scalablytyped.runtime.StringDictionary[js.Any]]]]
...
@scala.inline
def unregisterBlockType(name: java.lang.String): js.UndefOr[typings.wordpressBlocks.mod.Block[js.Any]] = typings.wordpressBlocks.mod.^.asInstanceOf[js.Dynamic].applyDynamic("unregisterBlockType")(name.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typings.wordpressBlocks.mod.Block[js.Any]]]
...
@scala.inline
def withBlockContentContext[T /* <: typings.react.mod.ComponentType[js.Any] */](wrapped: T): typings.react.mod.ComponentType[
