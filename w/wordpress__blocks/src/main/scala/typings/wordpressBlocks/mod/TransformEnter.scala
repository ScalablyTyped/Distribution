...
object TransformEnter {
  ...
  @scala.inline
  def apply[T /* <: Record[String, js.Any] */](regExp: RegExp, transform: () => BlockInstance[Partial[T]]): TransformEnter[T] = {
  ...
  @scala.inline
  implicit class TransformEnterMutableBuilder[Self <: TransformEnter[?], T /* <: Record[String, js.Any] */] (val x: Self & TransformEnter[T]) extends AnyVal {
