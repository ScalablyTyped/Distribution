...
trait PartialBlockinnerBlocksRe extends StObject {
  ...
  {readonly [ k in keyof {} ]: @wordpress/blocks.@wordpress/blocks.BlockAttribute<{}[k] extends std.Array<infer U>? any : {}[k]>}
    */ typings.wordpressBlocks.wordpressBlocksStrings.PartialBlockinnerBlocksRe & TopLevel[Any]
  ] = js.undefined
  ...
  var example: js.UndefOr[PartialBlock & InnerBlocks] = js.undefined
...
object PartialBlockinnerBlocksRe {
  
  inline def apply(): PartialBlockinnerBlocksRe = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBlockinnerBlocksRe]
  }
  
  extension [Self <: PartialBlockinnerBlocksRe](x: Self) {
    ...
    inline def setExample(value: PartialBlock & InnerBlocks): Self = StObject.set(x, "example", value.asInstanceOf[js.Any])
