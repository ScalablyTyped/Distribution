...
trait WebPageTest extends js.Object {
  ...
  def getLocations(callback: Callback[Anon_Response]): Unit = js.native
  def getLocations(options: Options with RequestOptions, callback: Callback[Anon_Response]): Unit = js.native
