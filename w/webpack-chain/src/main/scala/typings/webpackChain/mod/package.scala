...
package object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - scala.Boolean
  */
  type DevTool = typings.webpackChain.mod._DevTool | scala.Boolean
  
  type LoaderOptions = org.scalablytyped.runtime.StringDictionary[js.Any]
  
  type RuntimeChunkFunction = js.Function1[/* entryPoint */ typings.webpackChain.mod.EntryPoint, java.lang.String]
