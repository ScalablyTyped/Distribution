...
object ^ extends js.Object {
  ...
  var TooltipControl: webixLib.webixMod.TooltipControl = js.native
  ...
  def ajax(url: java.lang.String): Ajax | js.Promise[_] = js.native
  def ajax(url: java.lang.String, params: js.Any): Ajax | js.Promise[_] = js.native
  def alert(text: js.Any): js.Promise[_] = js.native
  def alert(text: js.Any, `type`: java.lang.String): js.Promise[_] = js.native
  def alert(text: js.Any, `type`: java.lang.String, callback: WebixCallback): js.Promise[_] = js.native
  ...
  def confirm(text: js.Any, `type`: java.lang.String): js.Promise[_] = js.native
  def confirm(text: js.Any, `type`: java.lang.String, callback: WebixCallback): js.Promise[_] = js.native
  ...
  def message(content: js.Any): java.lang.String = js.native
  def message(content: js.Any, `type`: java.lang.String): java.lang.String = js.native
  def message(content: js.Any, `type`: java.lang.String, expire: scala.Double): java.lang.String = js.native
  def message(content: js.Any, `type`: java.lang.String, expire: scala.Double, id: java.lang.String): java.lang.String = js.native
  def message(content: js.Any, `type`: java.lang.String, expire: scala.Double, id: scala.Double): java.lang.String = js.native
  def modalbox(text: js.Any): js.Promise[_] = js.native
  def modalbox(text: js.Any, `type`: java.lang.String): js.Promise[_] = js.native
  def modalbox(text: js.Any, `type`: java.lang.String, callback: WebixCallback): js.Promise[_] = js.native
