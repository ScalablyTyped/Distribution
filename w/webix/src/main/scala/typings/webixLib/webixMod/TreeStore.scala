...
trait TreeStore extends js.Object {
  ...
  def each(code: WebixCallback, master: js.Any, all: scala.Boolean, pid: java.lang.String): scala.Unit = js.native
  def eachChild(pid: java.lang.String, code: WebixCallback): scala.Unit = js.native
  def eachChild(pid: java.lang.String, code: WebixCallback, master: js.Any): scala.Unit = js.native
  def eachChild(pid: java.lang.String, code: WebixCallback, master: js.Any, all: scala.Boolean): scala.Unit = js.native
  def eachLeaf(pid: java.lang.String, code: WebixCallback): scala.Unit = js.native
  def eachOpen(code: WebixCallback): scala.Unit = js.native
  def eachOpen(code: WebixCallback, master: js.Any): scala.Unit = js.native
  def eachOpen(code: WebixCallback, master: js.Any, pid: java.lang.String): scala.Unit = js.native
  def eachSubItem(pid: java.lang.String, code: WebixCallback): scala.Unit = js.native
