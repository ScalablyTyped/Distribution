...
trait UIManager extends js.Object {
  def addHotKey(key: java.lang.String, handler: webixLib.WebixCallback): scala.Unit = js.native
  def addHotKey(key: java.lang.String, handler: webixLib.WebixCallback, obj: js.Any): scala.Unit = js.native
  ...
  def removeHotKey(key: java.lang.String, handler: webixLib.WebixCallback): scala.Unit = js.native
  def removeHotKey(key: java.lang.String, handler: webixLib.WebixCallback, obj: js.Any): scala.Unit = js.native
