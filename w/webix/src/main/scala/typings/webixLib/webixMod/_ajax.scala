...
trait _ajax extends js.Object {
  ...
  def del(url: java.lang.String, params: js.Any, callback: webixLib.WebixCallback): js.Promise[_] = js.native
  def get(url: java.lang.String): js.Promise[_] = js.native
  def get(url: java.lang.String, params: js.Any): js.Promise[_] = js.native
  def get(url: java.lang.String, params: js.Any, callback: webixLib.WebixCallback): js.Promise[_] = js.native
  ...
  def post(url: java.lang.String, params: js.Any, callback: webixLib.WebixCallback): js.Promise[_] = js.native
  def put(url: java.lang.String): js.Promise[_] = js.native
  def put(url: java.lang.String, params: js.Any): js.Promise[_] = js.native
  def put(url: java.lang.String, params: js.Any, callback: webixLib.WebixCallback): js.Promise[_] = js.native
  def response(`type`: java.lang.String): _ajax = js.native
