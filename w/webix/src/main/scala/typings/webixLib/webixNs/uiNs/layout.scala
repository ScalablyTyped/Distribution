...
class layout () extends baseview {
  ...
  def attachEvent(`type`: layoutEventName, functor: webixLib.webixNs.WebixCallback): java.lang.String | scala.Double = js.native
  def attachEvent(`type`: layoutEventName, functor: webixLib.webixNs.WebixCallback, id: java.lang.String): java.lang.String | scala.Double = js.native
  ...
  def restore(state: js.Any, factory: webixLib.webixNs.WebixCallback, configOnly: scala.Boolean): scala.Unit = js.native
