...
class excelviewer () extends baseview {
  ...
  def attachEvent(`type`: excelviewerEventName, functor: webixLib.webixNs.WebixCallback): java.lang.String | scala.Double = js.native
  def attachEvent(`type`: excelviewerEventName, functor: webixLib.webixNs.WebixCallback, id: java.lang.String): java.lang.String | scala.Double = js.native
  ...
  def eachRow(handler: webixLib.webixNs.WebixCallback, all: scala.Boolean): scala.Unit = js.native
