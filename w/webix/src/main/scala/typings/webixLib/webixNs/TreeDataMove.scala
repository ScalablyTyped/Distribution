...
trait TreeDataMove extends js.Object {
  ...
  def copy(sid: java.lang.String, tindex: scala.Double, tobj: webixLib.webixNs.uiNs.baseview): scala.Double = js.native
  def copy(sid: java.lang.String, tindex: scala.Double, tobj: webixLib.webixNs.uiNs.baseview, details: js.Any): scala.Double = js.native
  def copy(sid: scala.Double, tindex: scala.Double): scala.Double = js.native
  def copy(sid: scala.Double, tindex: scala.Double, tobj: webixLib.webixNs.uiNs.baseview): scala.Double = js.native
  def copy(sid: scala.Double, tindex: scala.Double, tobj: webixLib.webixNs.uiNs.baseview, details: js.Any): scala.Double = js.native
