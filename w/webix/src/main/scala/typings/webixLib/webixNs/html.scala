...
trait html extends js.Object {
  ...
  def getTextSize(text: java.lang.String): SizeInfo = js.native
  def getTextSize(text: java.lang.String, css: java.lang.String): SizeInfo = js.native
  def getTextSize(text: java.lang.String, css: java.lang.String, width: scala.Double): SizeInfo = js.native
  def getTextSize(text: js.Array[java.lang.String]): SizeInfo = js.native
  def getTextSize(text: js.Array[java.lang.String], css: java.lang.String): SizeInfo = js.native
  def getTextSize(text: js.Array[java.lang.String], css: java.lang.String, width: scala.Double): SizeInfo = js.native
