...
@JSGlobal("webix.ui.daterangesuggest")
@js.native
class daterangesuggest () extends baseview {
  ...
  def attachEvent(`type`: daterangesuggestEventName, functor: webixLib.webixNs.WebixCallback): java.lang.String | scala.Double = js.native
  def attachEvent(`type`: daterangesuggestEventName, functor: webixLib.webixNs.WebixCallback, id: java.lang.String): java.lang.String | scala.Double = js.native
