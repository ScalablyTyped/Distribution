...
object toolbarEventName {
  ...
  inline def onAfterValidation: typings.webix.webixStrings.onAfterValidation = "onAfterValidation".asInstanceOf[typings.webix.webixStrings.onAfterValidation]
  ...
  inline def onBeforeValidate: typings.webix.webixStrings.onBeforeValidate = "onBeforeValidate".asInstanceOf[typings.webix.webixStrings.onBeforeValidate]
  ...
  inline def onValues: typings.webix.webixStrings.onValues = "onValues".asInstanceOf[typings.webix.webixStrings.onValues]
