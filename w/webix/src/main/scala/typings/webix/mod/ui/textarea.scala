...
class textarea ()
  ...
  @JSName("$skin")
  var $skin_Original_textarea: WebixCallback = js.native
  ...
  def attachEvent(`type`: textareaEventName, functor: WebixCallback): String | Double = js.native
  def attachEvent(`type`: textareaEventName, functor: WebixCallback, id: String): String | Double = js.native
