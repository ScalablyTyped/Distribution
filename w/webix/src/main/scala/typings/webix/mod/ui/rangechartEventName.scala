...
object rangechartEventName {
  ...
  inline def onAfterRangeChange: typings.webix.webixStrings.onAfterRangeChange = "onAfterRangeChange".asInstanceOf[typings.webix.webixStrings.onAfterRangeChange]
