...
trait richtextConfig extends StObject {
...
object richtextConfig {
  ...
  @scala.inline
  def apply(): richtextConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[richtextConfig]
  }
  
  @scala.inline
  implicit class richtextConfigMutableBuilder[Self <: richtextConfig] (val x: Self) extends AnyVal {
