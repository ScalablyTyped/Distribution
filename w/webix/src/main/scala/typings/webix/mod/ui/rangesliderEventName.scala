...
*/
trait rangesliderEventName extends StObject
object rangesliderEventName {
  ...
  inline def onSliderDrag: typings.webix.webixStrings.onSliderDrag = "onSliderDrag".asInstanceOf[typings.webix.webixStrings.onSliderDrag]
