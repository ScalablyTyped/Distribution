...
trait toolbarConfig extends StObject {
  ...
  var elements: js.UndefOr[js.Array[js.Any]] = js.undefined
...
object toolbarConfig {
  ...
  implicit class toolbarConfigMutableBuilder[Self <: toolbarConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComplexData(value: Boolean): Self = StObject.set(x, "complexData", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setComplexDataUndefined: Self = StObject.set(x, "complexData", js.undefined)
    ...
    @scala.inline
    def setElementsConfig(value: js.Any): Self = StObject.set(x, "elementsConfig", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setElementsConfigUndefined: Self = StObject.set(x, "elementsConfig", js.undefined)
