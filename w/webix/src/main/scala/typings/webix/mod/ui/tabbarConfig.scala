...
trait tabbarConfig extends StObject {
  ...
  var tabbarPopup: js.UndefOr[String | obj | typings.webix.webix.ui.baseview] = js.undefined
...
object tabbarConfig {
  ...
  extension [Self <: tabbarConfig](x: Self) {
    ...
    inline def setTabbarPopup(value: String | obj | typings.webix.webix.ui.baseview): Self = StObject.set(x, "tabbarPopup", value.asInstanceOf[js.Any])
