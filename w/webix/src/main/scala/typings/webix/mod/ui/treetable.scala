...
open class treetable ()
  ...
  def move(sid: String, tindex: Double, tobj: typings.webix.webix.ui.baseview, details: Any): String | Double = js.native
  ...
  def move(sid: Double, tindex: Double, tobj: typings.webix.webix.ui.baseview, details: Any): String | Double = js.native
