...
trait texthighlightConfig extends StObject {
  ...
  var highlight: js.UndefOr[WebixCallback] = js.undefined
...
object texthighlightConfig {
  
  inline def apply(): texthighlightConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[texthighlightConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: texthighlightConfig] (val x: Self) extends AnyVal {
    ...
    inline def setHighlight(value: WebixCallback): Self = StObject.set(x, "highlight", value.asInstanceOf[js.Any])
