...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.webix.webixStrings.onBeforeShow
  ...
  - typings.webix.webixStrings.onValueSuggest
  - typings.webix.webixStrings.onViewMove
  - typings.webix.webixStrings.onViewMoveEnd
  - typings.webix.webixStrings.onViewResize
  - typings.webix.webixStrings.onViewShow
*/
trait mentionsuggestEventName extends StObject
object mentionsuggestEventName {
  ...
  inline def onBeforeShow: typings.webix.webixStrings.onBeforeShow = "onBeforeShow".asInstanceOf[typings.webix.webixStrings.onBeforeShow]
  ...
  inline def onHide: typings.webix.webixStrings.onHide = "onHide".asInstanceOf[typings.webix.webixStrings.onHide]
  ...
  inline def onShow: typings.webix.webixStrings.onShow = "onShow".asInstanceOf[typings.webix.webixStrings.onShow]
  ...
  inline def onValueSuggest: typings.webix.webixStrings.onValueSuggest = "onValueSuggest".asInstanceOf[typings.webix.webixStrings.onValueSuggest]
  
  inline def onViewMove: typings.webix.webixStrings.onViewMove = "onViewMove".asInstanceOf[typings.webix.webixStrings.onViewMove]
  
  inline def onViewMoveEnd: typings.webix.webixStrings.onViewMoveEnd = "onViewMoveEnd".asInstanceOf[typings.webix.webixStrings.onViewMoveEnd]
