...
object multitextEventName {
  ...
  @scala.inline
  def onSectionAdd: typings.webix.webixStrings.onSectionAdd = "onSectionAdd".asInstanceOf[typings.webix.webixStrings.onSectionAdd]
  @scala.inline
  def onSectionRemove: typings.webix.webixStrings.onSectionRemove = "onSectionRemove".asInstanceOf[typings.webix.webixStrings.onSectionRemove]
  @scala.inline
