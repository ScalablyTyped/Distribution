...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.webix.webixStrings.onDocumentReady
  ...
  - typings.webix.webixStrings.onPageRender
  - typings.webix.webixStrings.onScaleChange
...
object pdfviewerEventName {
  ...
  inline def onDocumentReady: typings.webix.webixStrings.onDocumentReady = "onDocumentReady".asInstanceOf[typings.webix.webixStrings.onDocumentReady]
  ...
  inline def onPageRender: typings.webix.webixStrings.onPageRender = "onPageRender".asInstanceOf[typings.webix.webixStrings.onPageRender]
  
  inline def onScaleChange: typings.webix.webixStrings.onScaleChange = "onScaleChange".asInstanceOf[typings.webix.webixStrings.onScaleChange]
