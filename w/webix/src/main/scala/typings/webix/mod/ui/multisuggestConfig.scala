...
object multisuggestConfig {
  ...
  inline def apply(): multisuggestConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[multisuggestConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: multisuggestConfig] (val x: Self) extends AnyVal {
    ...
    inline def setMaster(value: typings.webix.webix.ui.baseview): Self = StObject.set(x, "master", value.asInstanceOf[js.Any])
