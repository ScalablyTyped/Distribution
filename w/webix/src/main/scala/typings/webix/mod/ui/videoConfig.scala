...
object videoConfig {
  ...
  @scala.inline
  implicit class videoConfigOps[Self <: videoConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSrcVarargs(value: js.Any*): Self = this.set("src", js.Array(value :_*))
    
    @scala.inline
    def setSrc(value: String | js.Array[_]): Self = this.set("src", value.asInstanceOf[js.Any])
