...
trait videoConfig extends StObject {
  ...
  var src: js.UndefOr[String | js.Array[_]] = js.native
...
object videoConfig {
  ...
  @scala.inline
  def apply(): videoConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[videoConfig]
  }
  
  @scala.inline
  implicit class videoConfigMutableBuilder[Self <: videoConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSrc(value: String | js.Array[_]): Self = StObject.set(x, "src", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSrcUndefined: Self = StObject.set(x, "src", js.undefined)
    
    @scala.inline
    def setSrcVarargs(value: js.Any*): Self = StObject.set(x, "src", js.Array(value :_*))
