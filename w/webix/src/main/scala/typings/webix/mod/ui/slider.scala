...
open class slider ()
  ...
  def attachEvent(`type`: sliderEventName, functor: WebixCallback): String | Double = js.native
  def attachEvent(`type`: sliderEventName, functor: WebixCallback, id: String): String | Double = js.native
