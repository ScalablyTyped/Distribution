...
object gridsuggestConfig {
  ...
  @scala.inline
  implicit class gridsuggestConfigMutableBuilder[Self <: gridsuggestConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaster(value: typings.webix.webix.ui.baseview): Self = StObject.set(x, "master", value.asInstanceOf[js.Any])
