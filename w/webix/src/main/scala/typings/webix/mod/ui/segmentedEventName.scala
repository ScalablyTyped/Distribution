...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.webix.webixStrings.onAfterTabClick
  - typings.webix.webixStrings.onBeforeRender
  - typings.webix.webixStrings.onBeforeTabClick
...
object segmentedEventName {
  ...
  inline def onAfterTabClick: typings.webix.webixStrings.onAfterTabClick = "onAfterTabClick".asInstanceOf[typings.webix.webixStrings.onAfterTabClick]
  ...
  inline def onBeforeTabClick: typings.webix.webixStrings.onBeforeTabClick = "onBeforeTabClick".asInstanceOf[typings.webix.webixStrings.onBeforeTabClick]
  ...
  inline def onOptionAdd: typings.webix.webixStrings.onOptionAdd = "onOptionAdd".asInstanceOf[typings.webix.webixStrings.onOptionAdd]
  
  inline def onOptionRemove: typings.webix.webixStrings.onOptionRemove = "onOptionRemove".asInstanceOf[typings.webix.webixStrings.onOptionRemove]
