...
object dbllistConfig {
  ...
  inline def apply(): dbllistConfig = {
  ...
  extension [Self <: dbllistConfig](x: Self) {
    ...
    inline def setButtons(value: String | Boolean): Self = StObject.set(x, "buttons", value.asInstanceOf[js.Any])
    ...
    inline def setLabelBottomLeft(value: String): Self = StObject.set(x, "labelBottomLeft", value.asInstanceOf[js.Any])
    
    inline def setLabelBottomLeftUndefined: Self = StObject.set(x, "labelBottomLeft", js.undefined)
    
    inline def setLabelBottomRight(value: String): Self = StObject.set(x, "labelBottomRight", value.asInstanceOf[js.Any])
    
    inline def setLabelBottomRightUndefined: Self = StObject.set(x, "labelBottomRight", js.undefined)
    
    inline def setLabelLeft(value: String): Self = StObject.set(x, "labelLeft", value.asInstanceOf[js.Any])
    
    inline def setLabelLeftUndefined: Self = StObject.set(x, "labelLeft", js.undefined)
    
    inline def setLabelRight(value: String): Self = StObject.set(x, "labelRight", value.asInstanceOf[js.Any])
    ...
    inline def setValue(value: String | js.Array[js.Any]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
