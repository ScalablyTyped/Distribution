...
object dbllistConfig {
  ...
  @scala.inline
  implicit class dbllistConfigMutableBuilder[Self <: dbllistConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setButtons(value: String | Boolean): Self = StObject.set(x, "buttons", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabelBottomLeft(value: String): Self = StObject.set(x, "labelBottomLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelBottomLeftUndefined: Self = StObject.set(x, "labelBottomLeft", js.undefined)
    
    @scala.inline
    def setLabelBottomRight(value: String): Self = StObject.set(x, "labelBottomRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelBottomRightUndefined: Self = StObject.set(x, "labelBottomRight", js.undefined)
    
    @scala.inline
    def setLabelLeft(value: String): Self = StObject.set(x, "labelLeft", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelLeftUndefined: Self = StObject.set(x, "labelLeft", js.undefined)
    
    @scala.inline
    def setLabelRight(value: String): Self = StObject.set(x, "labelRight", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabelRightUndefined: Self = StObject.set(x, "labelRight", js.undefined)
