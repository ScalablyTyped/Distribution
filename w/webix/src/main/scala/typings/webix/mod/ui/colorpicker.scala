...
class colorpicker ()
  ...
  def attachEvent(`type`: colorpickerEventName, functor: WebixCallback): String | Double = js.native
  def attachEvent(`type`: colorpickerEventName, functor: WebixCallback, id: String): String | Double = js.native
