...
trait diagramEditorConfig extends StObject {
  ...
  var gridStep: js.UndefOr[Double] = js.undefined
  ...
  var save: js.UndefOr[WebixCallback] = js.undefined
...
object diagramEditorConfig {
  
  inline def apply(): diagramEditorConfig = {
  ...
  implicit open class MutableBuilder[Self <: diagramEditorConfig] (val x: Self) extends AnyVal {
    ...
    inline def setGridStep(value: Double): Self = StObject.set(x, "gridStep", value.asInstanceOf[js.Any])
    
    inline def setGridStepUndefined: Self = StObject.set(x, "gridStep", js.undefined)
    ...
    inline def setSave(value: WebixCallback): Self = StObject.set(x, "save", value.asInstanceOf[js.Any])
