...
object contextmenuConfig {
  ...
  inline def apply(): contextmenuConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[contextmenuConfig]
  }
  
  extension [Self <: contextmenuConfig](x: Self) {
    ...
    inline def setSubmenuConfig(value: js.Any): Self = StObject.set(x, "submenuConfig", value.asInstanceOf[js.Any])
