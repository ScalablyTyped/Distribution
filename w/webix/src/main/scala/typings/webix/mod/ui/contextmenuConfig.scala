...
object contextmenuConfig {
  ...
  def apply(
    ...
    subMenuPos: String = null,
    submenuConfig: js.Any = null,
    ...
    if (openAction != null) __obj.updateDynamic("openAction")(openAction.asInstanceOf[js.Any])
    ...
    if (subMenuPos != null) __obj.updateDynamic("subMenuPos")(subMenuPos.asInstanceOf[js.Any])
    if (submenuConfig != null) __obj.updateDynamic("submenuConfig")(submenuConfig.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[contextmenuConfig]
  }
}
