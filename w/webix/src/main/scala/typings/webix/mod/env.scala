...
import typings.webix.anon.Context
import typings.webix.anon.Down
...
trait env extends StObject {
  ...
  var touch: js.UndefOr[Down] = js.undefined
...
object env {
  ...
  extension [Self <: env](x: Self) {
    ...
    inline def setMouse(value: Context): Self = StObject.set(x, "mouse", value.asInstanceOf[js.Any])
    ...
    inline def setTouch(value: Down): Self = StObject.set(x, "touch", value.asInstanceOf[js.Any])
