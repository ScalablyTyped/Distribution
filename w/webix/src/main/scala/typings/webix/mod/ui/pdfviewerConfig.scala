...
trait pdfviewerConfig extends StObject {
...
object pdfviewerConfig {
  ...
  @scala.inline
  implicit class pdfviewerConfigMutableBuilder[Self <: pdfviewerConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDownloadName(value: String): Self = StObject.set(x, "downloadName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDownloadNameUndefined: Self = StObject.set(x, "downloadName", js.undefined)
    ...
    @scala.inline
    def setScale(value: String | Double): Self = StObject.set(x, "scale", value.asInstanceOf[js.Any])
