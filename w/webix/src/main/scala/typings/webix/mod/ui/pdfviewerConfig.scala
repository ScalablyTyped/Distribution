...
object pdfviewerConfig {
  ...
  inline def apply(): pdfviewerConfig = {
  ...
  implicit open class MutableBuilder[Self <: pdfviewerConfig] (val x: Self) extends AnyVal {
    ...
    inline def setDownloadName(value: String): Self = StObject.set(x, "downloadName", value.asInstanceOf[js.Any])
    
    inline def setDownloadNameUndefined: Self = StObject.set(x, "downloadName", js.undefined)
