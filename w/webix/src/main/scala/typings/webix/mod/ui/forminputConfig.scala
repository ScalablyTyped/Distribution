...
trait forminputConfig extends StObject {
...
object forminputConfig {
  ...
  @scala.inline
  def apply(): forminputConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[forminputConfig]
  }
  
  @scala.inline
  implicit class forminputConfigMutableBuilder[Self <: forminputConfig] (val x: Self) extends AnyVal {
    
    @scala.inline
    def set$cssName(value: String): Self = StObject.set(x, "$cssName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def set$cssNameUndefined: Self = StObject.set(x, "$cssName", js.undefined)
    ...
    @scala.inline
    def setBody(value: typings.webix.webix.ui.baseview): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
