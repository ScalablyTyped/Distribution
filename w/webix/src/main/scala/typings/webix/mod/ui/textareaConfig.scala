...
@js.native
trait textareaConfig extends StObject {
...
object textareaConfig {
  ...
  @scala.inline
  def apply(): textareaConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[textareaConfig]
  }
  
  @scala.inline
  implicit class textareaConfigMutableBuilder[Self <: textareaConfig] (val x: Self) extends AnyVal {
