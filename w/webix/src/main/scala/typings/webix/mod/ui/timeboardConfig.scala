...
trait timeboardConfig extends StObject {
  ...
  var value: js.UndefOr[String | obj] = js.undefined
...
object timeboardConfig {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: timeboardConfig] (val x: Self) extends AnyVal {
    ...
    inline def setValue(value: String | obj): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
