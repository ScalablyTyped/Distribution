...
trait treemapConfig extends js.Object {
  var activeItem: js.UndefOr[Boolean] = js.native
  ...
  var subRender: js.UndefOr[Boolean] = js.native
  ...
  var value: js.UndefOr[String | WebixCallback] = js.native
...
object treemapConfig {
  @scala.inline
  def apply(): treemapConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[treemapConfig]
  }
  @scala.inline
  implicit class treemapConfigOps[Self <: treemapConfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setActiveItem(value: Boolean): Self = this.set("activeItem", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSubRender(value: Boolean): Self = this.set("subRender", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSubRender: Self = this.set("subRender", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setValueFunction1(value: /* repeated */ js.Any => js.Any): Self = this.set("value", js.Any.fromFunction1(value))
    @scala.inline
    def setValue(value: String | WebixCallback): Self = this.set("value", value.asInstanceOf[js.Any])
    @scala.inline
