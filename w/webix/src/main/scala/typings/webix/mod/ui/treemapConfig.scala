...
object treemapConfig {
  ...
  @scala.inline
  implicit class treemapConfigMutableBuilder[Self <: treemapConfig] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setActiveItem(value: Boolean): Self = StObject.set(x, "activeItem", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSubRender(value: Boolean): Self = StObject.set(x, "subRender", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSubRenderUndefined: Self = StObject.set(x, "subRender", js.undefined)
    ...
    @scala.inline
    def setValue(value: String | WebixCallback): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
