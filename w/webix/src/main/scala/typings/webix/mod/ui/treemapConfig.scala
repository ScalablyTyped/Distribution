...
object treemapConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(activeItem)) __obj.updateDynamic("activeItem")(activeItem.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(subRender)) __obj.updateDynamic("subRender")(subRender.get.asInstanceOf[js.Any])
