...
open class todo ()
  ...
  @JSName("$skin")
  var $skin_Original_todo: WebixCallback = js.native
  
  def app(app: obj): Unit = js.native
  
  def attachEvent(`type`: todoEventName, functor: WebixCallback): String | Double = js.native
  def attachEvent(`type`: todoEventName, functor: WebixCallback, id: String): String | Double = js.native
  ...
  @JSName("config")
  var config_todo: todoConfig = js.native
