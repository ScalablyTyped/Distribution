...
object radioConfig {
  ...
  implicit class radioConfigMutableBuilder[Self <: radioConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomRadio(value: Boolean): Self = StObject.set(x, "customRadio", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomRadioUndefined: Self = StObject.set(x, "customRadio", js.undefined)
