...
object radioConfig {
  ...
  def apply(
    ...
    on: EventHash = null,
    optionHeight: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(customRadio)) __obj.updateDynamic("customRadio")(customRadio.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(optionHeight)) __obj.updateDynamic("optionHeight")(optionHeight.get.asInstanceOf[js.Any])
