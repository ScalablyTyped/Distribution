...
trait radioConfig extends js.Object {
  ...
  var customRadio: js.UndefOr[Boolean] = js.native
  ...
  var optionHeight: js.UndefOr[Double] = js.native
...
object radioConfig {
  ...
  implicit class radioConfigOps[Self <: radioConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCustomRadio(value: Boolean): Self = this.set("customRadio", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCustomRadio: Self = this.set("customRadio", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setOptionHeight(value: Double): Self = this.set("optionHeight", value.asInstanceOf[js.Any])
    @scala.inline
