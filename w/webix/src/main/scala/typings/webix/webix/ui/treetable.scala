...
trait treetable
  ...
  def serialize(id: String): js.Array[Any] = js.native
  def serialize(id: String, all: Boolean): js.Array[Any] = js.native
  def serialize(id: Double): js.Array[Any] = js.native
  def serialize(id: Double, all: Boolean): js.Array[Any] = js.native
  def serialize(id: Unit, all: Boolean): js.Array[Any] = js.native
