...
trait texthighlight
  ...
  def attachEvent(`type`: texthighlightEventName, functor: WebixCallback): String | Double = js.native
  def attachEvent(`type`: texthighlightEventName, functor: WebixCallback, id: String): String | Double = js.native
  ...
  @JSName("config")
  var config_texthighlight: texthighlightConfig = js.native
