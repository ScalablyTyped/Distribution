...
object datepickerConfig {
  ...
  @scala.inline
  def apply(): datepickerConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[datepickerConfig]
  }
  
  @scala.inline
  implicit class datepickerConfigMutableBuilder[Self <: datepickerConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValue(value: Date | String): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
