...
object chartConfig {
  ...
  def apply(
    ...
    cant: js.UndefOr[Double] = js.undefined,
    ...
    eventRadius: js.UndefOr[Double] = js.undefined,
    fill: String = null,
    ...
    padding: js.Any = null,
    pieHeight: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(cant)) __obj.updateDynamic("cant")(cant.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(disableLines)) __obj.updateDynamic("disableLines")(disableLines.get.asInstanceOf[js.Any])
    if (!js.isUndefined(disabled)) __obj.updateDynamic("disabled")(disabled.get.asInstanceOf[js.Any])
    if (!js.isUndefined(dynamic)) __obj.updateDynamic("dynamic")(dynamic.get.asInstanceOf[js.Any])
    if (!js.isUndefined(eventRadius)) __obj.updateDynamic("eventRadius")(eventRadius.get.asInstanceOf[js.Any])
    if (fill != null) __obj.updateDynamic("fill")(fill.asInstanceOf[js.Any])
    if (!js.isUndefined(fixOverflow)) __obj.updateDynamic("fixOverflow")(fixOverflow.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(pieHeight)) __obj.updateDynamic("pieHeight")(pieHeight.get.asInstanceOf[js.Any])
