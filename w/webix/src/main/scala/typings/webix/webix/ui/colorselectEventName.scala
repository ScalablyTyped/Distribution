...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.webix.webixStrings.onColorSelect
...
*/
trait colorselectEventName extends StObject
object colorselectEventName {
  ...
  inline def onColorSelect: typings.webix.webixStrings.onColorSelect = "onColorSelect".asInstanceOf[typings.webix.webixStrings.onColorSelect]
