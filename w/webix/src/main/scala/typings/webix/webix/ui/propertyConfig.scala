...
trait propertyConfig extends StObject {
  ...
  var elements: js.UndefOr[obj] = js.undefined
...
object propertyConfig {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: propertyConfig] (val x: Self) extends AnyVal {
    ...
    inline def setElements(value: obj): Self = StObject.set(x, "elements", value.asInstanceOf[js.Any])
