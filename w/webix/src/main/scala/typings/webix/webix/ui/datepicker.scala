...
@js.native
trait datepicker extends baseview {
  @JSName("$allowsClear")
  ...
  def attachEvent(`type`: datepickerEventName, functor: WebixCallback): String | Double = js.native
  def attachEvent(`type`: datepickerEventName, functor: WebixCallback, id: String): String | Double = js.native
