...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.webix.webixStrings.onAfterPageChange
  ...
  - typings.webix.webixStrings.onBeforePageChange
...
object pagerEventName {
  ...
  inline def onAfterPageChange: typings.webix.webixStrings.onAfterPageChange = "onAfterPageChange".asInstanceOf[typings.webix.webixStrings.onAfterPageChange]
  ...
  inline def onBeforePageChange: typings.webix.webixStrings.onBeforePageChange = "onBeforePageChange".asInstanceOf[typings.webix.webixStrings.onBeforePageChange]
