...
@js.native
trait scrollviewConfig extends StObject {
...
object scrollviewConfig {
  ...
  @scala.inline
  def apply(): scrollviewConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[scrollviewConfig]
  }
  
  @scala.inline
  implicit class scrollviewConfigMutableBuilder[Self <: scrollviewConfig] (val x: Self) extends AnyVal {
