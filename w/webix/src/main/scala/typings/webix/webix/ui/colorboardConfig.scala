...
object colorboardConfig {
  ...
  inline def apply(): colorboardConfig = {
  ...
  extension [Self <: colorboardConfig](x: Self) {
    ...
    inline def setMaxLightness(value: Double): Self = StObject.set(x, "maxLightness", value.asInstanceOf[js.Any])
    
    inline def setMaxLightnessUndefined: Self = StObject.set(x, "maxLightness", js.undefined)
    ...
    inline def setMinLightness(value: Double): Self = StObject.set(x, "minLightness", value.asInstanceOf[js.Any])
    
    inline def setMinLightnessUndefined: Self = StObject.set(x, "minLightness", js.undefined)
