...
trait todoConfig extends StObject {
  ...
  var hashtags: js.UndefOr[Boolean] = js.undefined
  ...
  var projects: js.UndefOr[js.Array[Any]] = js.undefined
  
  var readonly: js.UndefOr[Boolean] = js.undefined
  
  var url: js.UndefOr[String] = js.undefined
  
  var users: js.UndefOr[js.Array[Any]] = js.undefined
...
object todoConfig {
  ...
  implicit open class MutableBuilder[Self <: todoConfig] (val x: Self) extends AnyVal {
    ...
    inline def setHashtags(value: Boolean): Self = StObject.set(x, "hashtags", value.asInstanceOf[js.Any])
    ...
    inline def setProjects(value: js.Array[Any]): Self = StObject.set(x, "projects", value.asInstanceOf[js.Any])
    
    inline def setProjectsUndefined: Self = StObject.set(x, "projects", js.undefined)
    
    inline def setProjectsVarargs(value: Any*): Self = StObject.set(x, "projects", js.Array(value*))
    ...
    inline def setUsers(value: js.Array[Any]): Self = StObject.set(x, "users", value.asInstanceOf[js.Any])
