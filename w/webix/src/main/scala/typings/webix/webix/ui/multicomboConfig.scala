...
trait multicomboConfig extends js.Object {
  ...
  var tagMode: js.UndefOr[Boolean] = js.undefined
  var tagTemplate: js.UndefOr[WebixCallback] = js.undefined
...
object multicomboConfig {
  ...
  def apply(
    ...
    name: String = null,
    newValues: js.UndefOr[Boolean] = js.undefined,
    on: EventHash = null,
    ...
    suggest: js.Any = null,
    tagMode: js.UndefOr[Boolean] = js.undefined,
    tagTemplate: /* repeated */ js.Any => js.Any = null,
    tooltip: js.Any = null,
    validate: /* repeated */ js.Any => js.Any = null,
    validateEvent: String = null,
    value: Double | String | js.Array[_] = null,
    view: String = null,
    ...
    if (!js.isUndefined(keepText)) __obj.updateDynamic("keepText")(keepText.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(newValues)) __obj.updateDynamic("newValues")(newValues.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(tagMode)) __obj.updateDynamic("tagMode")(tagMode.get.asInstanceOf[js.Any])
    if (tagTemplate != null) __obj.updateDynamic("tagTemplate")(js.Any.fromFunction1(tagTemplate))
