...
object multicomboConfig {
  ...
  inline def apply(): multicomboConfig = {
  ...
  extension [Self <: multicomboConfig](x: Self) {
    ...
    inline def setOptionWidth(value: Double): Self = StObject.set(x, "optionWidth", value.asInstanceOf[js.Any])
    ...
    inline def setTagMode(value: Boolean): Self = StObject.set(x, "tagMode", value.asInstanceOf[js.Any])
    
    inline def setTagModeUndefined: Self = StObject.set(x, "tagMode", js.undefined)
    
    inline def setTagTemplate(value: WebixCallback): Self = StObject.set(x, "tagTemplate", value.asInstanceOf[js.Any])
