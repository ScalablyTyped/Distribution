...
object multicomboConfig {
  ...
  @scala.inline
  implicit class multicomboConfigOps[Self <: multicomboConfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setNewValues(value: Boolean): Self = this.set("newValues", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTagMode(value: Boolean): Self = this.set("tagMode", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTagMode: Self = this.set("tagMode", js.undefined)
    @scala.inline
    def setTagTemplate(value: /* repeated */ js.Any => js.Any): Self = this.set("tagTemplate", js.Any.fromFunction1(value))
    @scala.inline
