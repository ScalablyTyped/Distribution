...
object daterangeConfig {
  ...
  inline def apply(): daterangeConfig = {
  ...
  extension [Self <: daterangeConfig](x: Self) {
    ...
    inline def setCalendarCount(value: Double): Self = StObject.set(x, "calendarCount", value.asInstanceOf[js.Any])
    
    inline def setCalendarCountUndefined: Self = StObject.set(x, "calendarCount", js.undefined)
