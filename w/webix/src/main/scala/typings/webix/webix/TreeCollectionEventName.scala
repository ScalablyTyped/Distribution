...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.webix.webixStrings.onAfterCursorChange
  ...
  - typings.webix.webixStrings.onBeforeCursorChange
  ...
  - typings.webix.webixStrings.onBindUpdate
...
*/
trait TreeCollectionEventName extends js.Object
object TreeCollectionEventName {
  
  @scala.inline
  def onAfterAdd: typings.webix.webixStrings.onAfterAdd = "onAfterAdd".asInstanceOf[typings.webix.webixStrings.onAfterAdd]
  
  @scala.inline
  def onAfterCursorChange: typings.webix.webixStrings.onAfterCursorChange = "onAfterCursorChange".asInstanceOf[typings.webix.webixStrings.onAfterCursorChange]
  ...
  @scala.inline
  def onBeforeCursorChange: typings.webix.webixStrings.onBeforeCursorChange = "onBeforeCursorChange".asInstanceOf[typings.webix.webixStrings.onBeforeCursorChange]
  ...
  @scala.inline
  def onBindUpdate: typings.webix.webixStrings.onBindUpdate = "onBindUpdate".asInstanceOf[typings.webix.webixStrings.onBindUpdate]
