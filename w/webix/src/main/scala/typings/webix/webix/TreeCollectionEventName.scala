...
object TreeCollectionEventName {
  ...
  inline def onAfterCursorChange: typings.webix.webixStrings.onAfterCursorChange = "onAfterCursorChange".asInstanceOf[typings.webix.webixStrings.onAfterCursorChange]
  ...
  inline def onBeforeCursorChange: typings.webix.webixStrings.onBeforeCursorChange = "onBeforeCursorChange".asInstanceOf[typings.webix.webixStrings.onBeforeCursorChange]
  ...
  inline def onBindUpdate: typings.webix.webixStrings.onBindUpdate = "onBindUpdate".asInstanceOf[typings.webix.webixStrings.onBindUpdate]
