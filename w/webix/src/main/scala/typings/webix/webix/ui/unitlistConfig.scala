...
@js.native
trait unitlistConfig extends StObject {
  ...
  var uniteBy: js.UndefOr[WebixCallback] = js.native
...
object unitlistConfig {
  
  @scala.inline
  def apply(): unitlistConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[unitlistConfig]
  }
  
  @scala.inline
  implicit class unitlistConfigMutableBuilder[Self <: unitlistConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUniteBy(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "uniteBy", js.Any.fromFunction1(value))
    
    @scala.inline
    def setUniteByUndefined: Self = StObject.set(x, "uniteBy", js.undefined)
