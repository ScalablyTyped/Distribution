...
object unitlistConfig {
  ...
  inline def apply(): unitlistConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[unitlistConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: unitlistConfig] (val x: Self) extends AnyVal {
    ...
    inline def setUniteBy(value: WebixCallback): Self = StObject.set(x, "uniteBy", value.asInstanceOf[js.Any])
