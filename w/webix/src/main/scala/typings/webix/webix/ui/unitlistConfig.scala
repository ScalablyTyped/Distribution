...
object unitlistConfig {
  ...
  @scala.inline
  implicit class unitlistConfigOps[Self <: unitlistConfig] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUniteBy(value: /* repeated */ js.Any => js.Any): Self = this.set("uniteBy", js.Any.fromFunction1(value))
    @scala.inline
    def deleteUniteBy: Self = this.set("uniteBy", js.undefined)
    @scala.inline
