...
object geochartEventName {
  ...
  inline def onMapError: typings.webix.webixStrings.onMapError = "onMapError".asInstanceOf[typings.webix.webixStrings.onMapError]
  
  inline def onMapReady: typings.webix.webixStrings.onMapReady = "onMapReady".asInstanceOf[typings.webix.webixStrings.onMapReady]
  
  inline def onRegionClick: typings.webix.webixStrings.onRegionClick = "onRegionClick".asInstanceOf[typings.webix.webixStrings.onRegionClick]
