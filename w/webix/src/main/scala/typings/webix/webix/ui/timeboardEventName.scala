...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.webix.webixStrings.onTimeSelect
...
object timeboardEventName {
  ...
  inline def onTimeSelect: typings.webix.webixStrings.onTimeSelect = "onTimeSelect".asInstanceOf[typings.webix.webixStrings.onTimeSelect]
