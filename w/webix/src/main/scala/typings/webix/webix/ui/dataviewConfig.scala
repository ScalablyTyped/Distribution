...
trait dataviewConfig extends js.Object {
  ...
  var sizeToContent: js.UndefOr[Boolean] = js.native
...
object dataviewConfig {
  ...
  @scala.inline
  implicit class dataviewConfigOps[Self <: dataviewConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSizeToContent(value: Boolean): Self = this.set("sizeToContent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSizeToContent: Self = this.set("sizeToContent", js.undefined)
