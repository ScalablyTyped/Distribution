...
@js.native
trait contextmenu extends baseview {
  @JSName("$customPrint")
  ...
  def getMenuItem(id: Double): js.Any = js.native
  ...
  def getSubMenu(id: String): js.Any = js.native
  def getSubMenu(id: Double): js.Any = js.native
