...
trait comments
  ...
  @JSName("$configForm")
  def $configForm(args: Any*): Any = js.native
  @JSName("$configForm")
  var $configForm_Original: WebixCallback = js.native
  
  @JSName("$configList")
  def $configList(args: Any*): Any = js.native
  @JSName("$configList")
  var $configList_Original: WebixCallback = js.native
