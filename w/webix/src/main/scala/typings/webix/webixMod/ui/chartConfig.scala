...
import typings.webix.webixMod.WebixTemplate
...
object chartConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(disableLines)) __obj.updateDynamic("disableLines")(disableLines)
    ...
    if (!js.isUndefined(fixOverflow)) __obj.updateDynamic("fixOverflow")(fixOverflow)
    ...
    if (xValue != null) __obj.updateDynamic("xValue")(xValue)
    if (y != null) __obj.updateDynamic("y")(y.asInstanceOf[js.Any])
    if (yAxis != null) __obj.updateDynamic("yAxis")(yAxis)
    if (yValue != null) __obj.updateDynamic("yValue")(yValue)
