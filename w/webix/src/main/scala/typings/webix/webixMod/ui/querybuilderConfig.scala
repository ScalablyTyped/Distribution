...
object querybuilderConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(columnMode)) __obj.updateDynamic("columnMode")(columnMode)
    if (container != null) __obj.updateDynamic("container")(container.asInstanceOf[js.Any])
    if (css != null) __obj.updateDynamic("css")(css)
    if (!js.isUndefined(disabled)) __obj.updateDynamic("disabled")(disabled)
    if (fields != null) __obj.updateDynamic("fields")(fields)
    if (!js.isUndefined(filtering)) __obj.updateDynamic("filtering")(filtering)
    ...
    if (!js.isUndefined(sorting)) __obj.updateDynamic("sorting")(sorting)
