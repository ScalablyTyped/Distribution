...
object filemanagerConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(legacyUploader)) __obj.updateDynamic("legacyUploader")(legacyUploader)
    ...
    if (!js.isUndefined(noFileCache)) __obj.updateDynamic("noFileCache")(noFileCache)
