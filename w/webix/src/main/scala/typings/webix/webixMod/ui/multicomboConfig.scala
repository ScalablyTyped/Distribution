...
object multicomboConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(newValues)) __obj.updateDynamic("newValues")(newValues.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(tagMode)) __obj.updateDynamic("tagMode")(tagMode.asInstanceOf[js.Any])
