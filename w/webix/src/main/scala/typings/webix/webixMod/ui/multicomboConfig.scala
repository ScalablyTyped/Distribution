...
object multicomboConfig {
  ...
  def apply(
    ...
    if (!js.isUndefined(keepText)) __obj.updateDynamic("keepText")(keepText)
    ...
    if (!js.isUndefined(newValues)) __obj.updateDynamic("newValues")(newValues)
    ...
    if (!js.isUndefined(tagMode)) __obj.updateDynamic("tagMode")(tagMode)
