...
object geochartEventName {
  ...
  @scala.inline
  def onMapError: typings.webix.webixStrings.onMapError = this.cast("onMapError")
  @scala.inline
  def onMapReady: typings.webix.webixStrings.onMapReady = this.cast("onMapReady")
  @scala.inline
  def onRegionClick: typings.webix.webixStrings.onRegionClick = this.cast("onRegionClick")
  @scala.inline
