...
object submenuConfig {
  ...
  def apply(
    ...
    if (openAction != null) __obj.updateDynamic("openAction")(openAction)
    ...
    if (subMenuPos != null) __obj.updateDynamic("subMenuPos")(subMenuPos)
    if (submenuConfig != null) __obj.updateDynamic("submenuConfig")(submenuConfig)
