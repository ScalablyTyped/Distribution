...
object dbllistConfig {
  ...
  def apply(
    ...
    if (labelBottomLeft != null) __obj.updateDynamic("labelBottomLeft")(labelBottomLeft)
    if (labelBottomRight != null) __obj.updateDynamic("labelBottomRight")(labelBottomRight)
    if (labelLeft != null) __obj.updateDynamic("labelLeft")(labelLeft)
