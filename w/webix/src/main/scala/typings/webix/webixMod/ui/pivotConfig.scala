...
object pivotConfig {
  ...
  def apply(
    ...
    if (defaultOperation != null) __obj.updateDynamic("defaultOperation")(defaultOperation)
    if (!js.isUndefined(disabled)) __obj.updateDynamic("disabled")(disabled)
    if (!js.isUndefined(externalProcessing)) __obj.updateDynamic("externalProcessing")(externalProcessing)
    if (fieldMap != null) __obj.updateDynamic("fieldMap")(fieldMap)
    if (filterLabelAlign != null) __obj.updateDynamic("filterLabelAlign")(filterLabelAlign)
    if (filterLabelWidth != null) __obj.updateDynamic("filterLabelWidth")(filterLabelWidth.asInstanceOf[js.Any])
    if (filterMap != null) __obj.updateDynamic("filterMap")(filterMap)
    ...
    if (readonlyTitle != null) __obj.updateDynamic("readonlyTitle")(readonlyTitle)
    ...
    if (!js.isUndefined(separateLabel)) __obj.updateDynamic("separateLabel")(separateLabel)
    if (!js.isUndefined(stableRowId)) __obj.updateDynamic("stableRowId")(stableRowId)
    ...
    if (webWorker != null) __obj.updateDynamic("webWorker")(webWorker)
