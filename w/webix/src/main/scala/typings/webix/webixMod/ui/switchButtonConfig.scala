...
object switchButtonConfig {
  ...
  def apply(
    ...
    if (checkValue != null) __obj.updateDynamic("checkValue")(checkValue)
    if (click != null) __obj.updateDynamic("click")(js.Any.fromFunction1(click))
    if (container != null) __obj.updateDynamic("container")(container.asInstanceOf[js.Any])
    if (css != null) __obj.updateDynamic("css")(css)
    if (!js.isUndefined(customCheckbox)) __obj.updateDynamic("customCheckbox")(customCheckbox)
    ...
    if (labelRight != null) __obj.updateDynamic("labelRight")(labelRight)
    ...
    if (uncheckValue != null) __obj.updateDynamic("uncheckValue")(uncheckValue)
