...
object uploaderEventName {
  ...
  @scala.inline
  def onAfterFileAdd: typings.webix.webixStrings.onAfterFileAdd = this.cast("onAfterFileAdd")
  @scala.inline
  ...
  @scala.inline
  def onBeforeFileAdd: typings.webix.webixStrings.onBeforeFileAdd = this.cast("onBeforeFileAdd")
  @scala.inline
  ...
  @scala.inline
  def onFileUpload: typings.webix.webixStrings.onFileUpload = this.cast("onFileUpload")
  @scala.inline
  def onFileUploadError: typings.webix.webixStrings.onFileUploadError = this.cast("onFileUploadError")
  @scala.inline
  ...
  @scala.inline
  def onUploadComplete: typings.webix.webixStrings.onUploadComplete = this.cast("onUploadComplete")
  @scala.inline
