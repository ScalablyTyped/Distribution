...
object calendarConfig {
  ...
  def apply(
    ...
    if (calendarHeader != null) __obj.updateDynamic("calendarHeader")(calendarHeader)
    if (calendarTime != null) __obj.updateDynamic("calendarTime")(calendarTime)
    if (calendarWeekHeader != null) __obj.updateDynamic("calendarWeekHeader")(calendarWeekHeader)
    ...
    if (!js.isUndefined(monthHeader)) __obj.updateDynamic("monthHeader")(monthHeader)
    if (!js.isUndefined(monthSelect)) __obj.updateDynamic("monthSelect")(monthSelect)
    ...
    if (!js.isUndefined(skipEmptyWeeks)) __obj.updateDynamic("skipEmptyWeeks")(skipEmptyWeeks)
    ...
    if (!js.isUndefined(weekHeader)) __obj.updateDynamic("weekHeader")(weekHeader)
