...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.webix.webixStrings.onSectionAdd
  - typings.webix.webixStrings.onSectionRemove
...
object multitextEventName {
  ...
  @scala.inline
  def onSectionAdd: typings.webix.webixStrings.onSectionAdd = this.cast("onSectionAdd")
  @scala.inline
  def onSectionRemove: typings.webix.webixStrings.onSectionRemove = this.cast("onSectionRemove")
  @scala.inline
