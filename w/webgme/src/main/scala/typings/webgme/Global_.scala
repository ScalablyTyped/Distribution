...
object Global_ {
  ...
  object WebGmeGlobal {
    ...
    @scala.inline
    def apply(getConfig: () => typings.webgme.GmeConfig.GmeConfig, gmeConfig: typings.webgme.GmeConfig.GmeConfig): WebGmeGlobal = {
    ...
    implicit class WebGmeGlobalMutableBuilder[Self <: WebGmeGlobal] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setGetConfig(value: () => typings.webgme.GmeConfig.GmeConfig): Self = StObject.set(x, "getConfig", js.Any.fromFunction0(value))
      ...
      @scala.inline
      def setGmeConfig(value: typings.webgme.GmeConfig.GmeConfig): Self = StObject.set(x, "gmeConfig", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setToolbar(value: typings.webgme.Toolbar.Toolbar): Self = StObject.set(x, "Toolbar", value.asInstanceOf[js.Any])
