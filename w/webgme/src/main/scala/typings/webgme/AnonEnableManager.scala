...
trait AnonEnableManager extends js.Object {
  /**
...
object AnonEnableManager {
  @scala.inline
  def apply(enable: Boolean, manager: memory | redis): AnonEnableManager = {
    val __obj = js.Dynamic.literal(enable = enable.asInstanceOf[js.Any], manager = manager.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[AnonEnableManager]
  }
}
