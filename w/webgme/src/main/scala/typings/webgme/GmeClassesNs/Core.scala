...
import typings.webgme.CoreNs.Constraint
import typings.webgme.CoreNs.DataObject
import typings.webgme.CoreNs.GUID
import typings.webgme.CoreNs.GmePersisted
import typings.webgme.CoreNs.MixinViolation
import typings.webgme.CoreNs.Node
import typings.webgme.CoreNs.RelationRule
...
import typings.webgme.GmeCommonNs.DefObject
...
import typings.webgme.GmeCommonNs.MetaInfo
import typings.webgme.GmeCommonNs.MetaRules
...
import typings.webgme.GmeCommonNs.OutPath
...
trait Core extends js.Object {
  ...
  /**
    ...
    * @param relativePath the relative path - built by relative ids - of the node in question.
    */
  def loadByPath(startNode: Node, relativePath: Path): js.Promise[typings.webgme.GmeCommonNs.DataObject] = js.native
  /**
    * From the given starting node, it loads the path 
    * given as a series of relative ids (separated by '/') and returns the node it finds at the ends of the path. 
    * If there is no node, the function will return null.
  ...
  def loadByPath(
    startNode: Node,
    relativePath: Path,
    callback: ResultCallback[typings.webgme.GmeCommonNs.DataObject]
  ): Unit = js.native
  /**
    * Loads the child of the given parent pointed by the relative id. 
    * Behind the scenes, it means that it actually loads the 
    ...
    * @param relativeId the relative id of the child in question.
    */
  def loadChild(parent: Node, relativeId: String): js.Promise[js.Array[typings.webgme.GmeCommonNs.DataObject]] = js.native
  /**
    * Loads the child of the given parent pointed by the relative id. 
    * Behind the scenes, it means that it actually loads the 
    * data pointed by a hash stored inside the parent under 
  ...
  def loadChild(
    parent: Node,
    relativeId: String,
    callback: ResultCallback[js.Array[typings.webgme.GmeCommonNs.DataObject]]
  ): Unit = js.native
  /**
    * Loads all the children of the given parent. 
    * As it first checks the already reserved relative ids of the parent, 
    ...
    * @see https://github.com/webgme/webgme/wiki/GME-Core-API#containment-methods
    */
  def loadChildren(parent: Node): js.Promise[js.Array[typings.webgme.GmeCommonNs.DataObject]] = js.native
  /**
    * Loads all the children of the given parent. 
    * As it first checks the already reserved relative ids of the parent, 
    * it only loads the already existing children (so no on-demand empty node creation).
    ...
    * @see https://github.com/webgme/webgme/wiki/GME-Core-API#containment-methods
    */
  def loadChildren(parent: Node, callback: ResultCallback[js.Array[typings.webgme.GmeCommonNs.DataObject]]): Unit = js.native
  /**
    * Loads all the source nodes that has such a pointer and its target is the given node.
    * @param target the container node in question.
    * @param pointerName 
    * @return the relative id of the child in question.
    */
  def loadCollection(target: Node, pointerName: Name): js.Promise[js.Array[typings.webgme.GmeCommonNs.DataObject]] = js.native
  /**
    * Loads all the source nodes that has such a pointer and its target is the given node.
    * @param target the container node in question.
    * @param pointerName 
