...
trait Anon_CommitA extends js.Object {
  def apply(commitA: webgmeLib.GmeStorageNs.CommitHash, commitB: webgmeLib.GmeStorageNs.CommitHash): stdLib.Promise[webgmeLib.GmeStorageNs.CommitHash] = js.native
  def apply(
