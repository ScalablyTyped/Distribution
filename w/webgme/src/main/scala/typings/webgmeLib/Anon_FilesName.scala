...
trait Anon_FilesName extends js.Object {
  def apply(files: ScalablyTyped.runtime.StringDictionary[webgmeLib.BlobsNs.ObjectBlob]): stdLib.Promise[js.Array[webgmeLib.GmeCommonNs.MetadataHash]] | stdLib.Promise[java.lang.String] = js.native
  def apply(
