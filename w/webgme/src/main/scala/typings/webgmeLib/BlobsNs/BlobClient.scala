...
class BlobClient protected () extends js.Object {
  ...
  /**
           ...
           * @return resolved with Artifact artifact.
           */
  def getArtifact(metadataHash: webgmeLib.GmeCommonNs.MetadataHash): stdLib.Promise[webgmeLib.GmeClassesNs.Artifact] = js.native
  /**
           * Retrieves the Artifact from the blob storage.
           * @param metadataHash hash associated with the artifact.
           * @return resolved with Artifact artifact.
  ...
  def getMetadata(metadataHash: webgmeLib.GmeCommonNs.MetadataHash): stdLib.Promise[webgmeLib.GmeCommonNs.Metadata] = js.native
  def getMetadata(
    metadataHash: webgmeLib.GmeCommonNs.MetadataHash,
  ...
  def getObject(metadataHash: webgmeLib.GmeCommonNs.MetadataHash, subpath: java.lang.String): stdLib.Promise[webgmeLib.GmeCommonNs.Content] = js.native
  def getObjectAsJSON(metadataHash: webgmeLib.GmeCommonNs.MetadataHash): stdLib.Promise[stdLib.JSON] = js.native
  def getObjectAsJSON(
    metadataHash: webgmeLib.GmeCommonNs.MetadataHash,
    callback: webgmeLib.GmeCommonNs.ResultCallback[stdLib.JSON]
  ): scala.Unit = js.native
  def getObjectAsString(metadataHash: webgmeLib.GmeCommonNs.MetadataHash): stdLib.Promise[webgmeLib.GmeCommonNs.ContentString] = js.native
  ...
  def getSubObject(metadataHash: webgmeLib.GmeCommonNs.MetadataHash, subpath: java.lang.String): stdLib.Promise[webgmeLib.CoreNs.DataObject] = js.native
  def getSubObject(
    metadataHash: webgmeLib.GmeCommonNs.MetadataHash,
    subpath: java.lang.String,
  ...
  def putFile(name: webgmeLib.GmeCommonNs.Name, data: webgmeLib.GmeCommonNs.Payload): stdLib.Promise[webgmeLib.GmeCommonNs.MetadataHash] = js.native
  def putFile(
    name: webgmeLib.GmeCommonNs.Name,
    data: webgmeLib.GmeCommonNs.Payload,
    callback: webgmeLib.GmeCommonNs.ResultCallback[webgmeLib.GmeCommonNs.MetadataHash]
  ): scala.Unit = js.native
  def putFiles(o: ScalablyTyped.runtime.StringDictionary[webgmeLib.GmeCommonNs.Payload]): stdLib.Promise[js.Array[webgmeLib.GmeCommonNs.MetadataHash]] = js.native
  def putFiles(
  ...
  def putMetadata(metadataDescriptor: BlobMetadataDescriptor): stdLib.Promise[webgmeLib.GmeCommonNs.MetadataHash] = js.native
  def putMetadata(
    metadataDescriptor: BlobMetadataDescriptor,
    callback: webgmeLib.GmeCommonNs.ResultCallback[webgmeLib.GmeCommonNs.MetadataHash]
  ): scala.Unit = js.native
  def saveAllArtifacts(): stdLib.Promise[js.Array[webgmeLib.GmeCommonNs.MetadataHash]] = js.native
