...
trait Core extends js.Object {
  /**
    ...
    */
  @JSName("addLibrary")
  var addLibrary_Original: webgmeLib.Fn_CallbackLibraryInfo = js.native
  /**
  ...
  var applyTreeDiff_Original: webgmeLib.Fn_CallbackPatch = js.native
  /**
  ...
  var generateTreeDiff_Original: webgmeLib.Fn_CallbackSourceRoot = js.native
  /**
    ...
    */
  @JSName("loadByPath")
  var loadByPath_Original: webgmeLib.Fn_CallbackRelativePath = js.native
  /**
    ...
    */
  @JSName("loadChild")
  var loadChild_Original: webgmeLib.Fn_CallbackParent = js.native
  /**
    ...
    */
  @JSName("loadChildren")
  var loadChildren_Original: webgmeLib.Fn_CallbackParentArray = js.native
  /**
  ...
  var loadCollection_Original: webgmeLib.Fn_CallbackPointerName = js.native
  /**
    * Loads all the instances of the given node.
    * @param node the node in question.
    */
  @JSName("loadInstances")
  var loadInstances_Original: webgmeLib.Fn_CallbackNode = js.native
  /**
  ...
  var loadOwnChildren_Original: webgmeLib.Fn_CallbackParentErrorOnlyCallback = js.native
  /**
  ...
  var loadOwnSubTree_Original: webgmeLib.Fn_CallbackNode = js.native
  /**
    ...
    */
  @JSName("loadPointer")
  var loadPointer_Original: webgmeLib.Fn_CallbackPointerNameSource = js.native
  /**
    ...
    */
  @JSName("loadRoot")
  var loadRoot_Original: webgmeLib.Fn_CallbackMetadataHashDataObject = js.native
  /**
    * TODO
    * @param node the node in question.
    * @return 
    */
  @JSName("loadSubTree")
  var loadSubTree_Original: webgmeLib.Fn_CallbackNodeDataObject = js.native
  /**
    * TODO
    * @param node the node in question.
    * @return 
    */
  @JSName("loadTree")
  var loadTree_Original: webgmeLib.Fn_CallbackRootHash = js.native
  /**
    * TODO
    * @param node the node in question.
    * @return 
    */
  @JSName("setGuid")
  var setGuid_Original: webgmeLib.Fn_CallbackGuid = js.native
  /**
    * TODO
    * @param node the node in question.
    * @return 
  ...
  var setMemberAttribute_Original: webgmeLib.Fn_MemberPath = js.native
  /**
    * TODO
    ...
    */
  @JSName("traverse")
  var traverse_Original: webgmeLib.Fn_CallbackFinished = js.native
  /**
    * TODO
    * @param node the node in question.
    * @return 
  ...
  var updateLibrary_Original: webgmeLib.Fn_CallbackLibraryInfoLibraryRootHash = js.native
  /**
    * It adds a project as library to your project by copying it over. 
    * The library will be a node with the given name directly 
    * under your project's ROOT. 
