...
trait Anon_StartNumber extends js.Object {
  def apply(start: java.lang.String | webgmeLib.GmeStorageNs.CommitHash, number: scala.Double): js.Promise[js.Array[webgmeLib.GmeStorageNs.CommitObject]] = js.native
  def apply(
