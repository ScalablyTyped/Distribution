...
trait Fn_CallbackFilesName extends js.Object {
  def apply(files: org.scalablytyped.runtime.StringDictionary[webgmeLib.BlobsNs.ObjectBlob]): js.Promise[js.Array[webgmeLib.GmeCommonNs.MetadataHash]] = js.native
  def apply(
