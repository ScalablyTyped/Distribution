...
@js.native
class JudgeUtils ()
  extends typings.wonderDotJs.distEs2015UtilsJudgeUtilsMod.JudgeUtils
...
object JudgeUtils extends js.Object {
  ...
  def isSelf(
    self: typings.wonderDotJs.distEs2015CoreEntityMod.Entity,
    entityObject: typings.wonderDotJs.distEs2015CoreEntityMod.Entity
  ): Boolean = js.native
