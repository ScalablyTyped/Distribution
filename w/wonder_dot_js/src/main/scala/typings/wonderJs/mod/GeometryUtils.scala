...
object GeometryUtils {
  ...
  inline def setThreeComponent(targetData: js.Array[Double], sourceData: typings.wonderJs.vector3Mod.Vector3, index: Double): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setThreeComponent")(targetData.asInstanceOf[js.Any], sourceData.asInstanceOf[js.Any], index.asInstanceOf[js.Any])).asInstanceOf[js.Any]
}
