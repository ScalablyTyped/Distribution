...
object Matrix3 {
  ...
  inline def create(mat: js.typedarray.Float32Array): typings.wonderJs.matrix3Mod.Matrix3 = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(mat.asInstanceOf[js.Any]).asInstanceOf[typings.wonderJs.matrix3Mod.Matrix3]
}
