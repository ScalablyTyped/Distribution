...
object CloneUtils {
  ...
  inline def markNotClone(entityObject: typings.wonderJs.entityObjectMod.EntityObject): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("markNotClone")(entityObject.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
