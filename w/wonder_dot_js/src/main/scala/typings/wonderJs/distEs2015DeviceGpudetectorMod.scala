...
object distEs2015DeviceGpudetectorMod {
  ...
  object EGPUPrecision extends StObject {
    ...
    sealed trait HIGHP
      extends StObject
         with EGPUPrecision
    /* 0 */ val HIGHP: typings.wonderJs.distEs2015DeviceGpudetectorMod.EGPUPrecision.HIGHP & Double = js.native
    
    @js.native
    sealed trait LOWP
      extends StObject
         with EGPUPrecision
    /* 2 */ val LOWP: typings.wonderJs.distEs2015DeviceGpudetectorMod.EGPUPrecision.LOWP & Double = js.native
    
    @js.native
    sealed trait MEDIUMP
      extends StObject
         with EGPUPrecision
    /* 1 */ val MEDIUMP: typings.wonderJs.distEs2015DeviceGpudetectorMod.EGPUPrecision.MEDIUMP & Double = js.native
  }
