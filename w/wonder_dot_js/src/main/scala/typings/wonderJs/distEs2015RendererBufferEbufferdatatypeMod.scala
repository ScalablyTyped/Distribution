...
object distEs2015RendererBufferEbufferdatatypeMod {
  ...
  object EBufferDataType extends StObject {
    ...
    /* 1 */ val INDICE: typings.wonderJs.distEs2015RendererBufferEbufferdatatypeMod.EBufferDataType.INDICE & Double = js.native
    
    @js.native
    sealed trait VERTICE
      extends StObject
         with EBufferDataType
    /* 0 */ val VERTICE: typings.wonderJs.distEs2015RendererBufferEbufferdatatypeMod.EBufferDataType.VERTICE & Double = js.native
  }
}
