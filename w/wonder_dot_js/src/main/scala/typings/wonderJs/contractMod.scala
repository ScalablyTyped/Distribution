...
object contractMod {
  ...
  @scala.inline
  def describe(message: String, func: js.Function): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("describe")(message.asInstanceOf[js.Any], func.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def describe(message: String, func: js.Function, preCondition: js.Function): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("describe")(message.asInstanceOf[js.Any], func.asInstanceOf[js.Any], preCondition.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def describe(message: String, func: js.Function, preCondition: js.Function, context: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("describe")(message.asInstanceOf[js.Any], func.asInstanceOf[js.Any], preCondition.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def describe(message: String, func: js.Function, preCondition: Unit, context: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("describe")(message.asInstanceOf[js.Any], func.asInstanceOf[js.Any], preCondition.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  @scala.inline
  def it(message: String, func: js.Function): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("it")(message.asInstanceOf[js.Any], func.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def it(message: String, func: js.Function, context: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("it")(message.asInstanceOf[js.Any], func.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[Unit]
