...
open class JudgeUtils ()
  extends typings.wonderJs.distEs2015UtilsJudgeUtilsMod.JudgeUtils
/* static members */
object JudgeUtils {
  ...
  inline def isComponenet(component: typings.wonderJs.distEs2015CoreComponentMod.Component): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isComponenet")(component.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  inline def isSelf(
    self: typings.wonderJs.distEs2015CoreEntityMod.Entity,
    entityObject: typings.wonderJs.distEs2015CoreEntityMod.Entity
