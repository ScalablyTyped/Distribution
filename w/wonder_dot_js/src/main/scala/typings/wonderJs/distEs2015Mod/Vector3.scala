...
@js.native
open class Vector3 ()
  extends typings.wonderJs.distEs2015MathVector3Mod.Vector3 {
...
object Vector3 {
  ...
  inline def create(): typings.wonderJs.distEs2015MathVector3Mod.Vector3 = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.wonderJs.distEs2015MathVector3Mod.Vector3]
  inline def create(x: Double, y: Double, z: Double): typings.wonderJs.distEs2015MathVector3Mod.Vector3 = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any])).asInstanceOf[typings.wonderJs.distEs2015MathVector3Mod.Vector3]
