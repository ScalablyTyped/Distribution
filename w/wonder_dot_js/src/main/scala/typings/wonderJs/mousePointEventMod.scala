...
object mousePointEventMod {
  ...
  object MousePointEvent {
    ...
    @scala.inline
    def create(eventName: EEventName): MousePointEvent = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(eventName.asInstanceOf[js.Any]).asInstanceOf[MousePointEvent]
  }
}
