...
object distEs2015CoreEntityObjectSceneCacheBufferTableMod {
  ...
  object BufferTableKey extends StObject {
    ...
    sealed trait PROCEDURAL_INDEX
      extends StObject
         with BufferTableKey
    /* 1 */ val PROCEDURAL_INDEX: typings.wonderJs.distEs2015CoreEntityObjectSceneCacheBufferTableMod.BufferTableKey.PROCEDURAL_INDEX & Double = js.native
    
    @js.native
    sealed trait PROCEDURAL_VERTEX
      extends StObject
         with BufferTableKey
    /* 0 */ val PROCEDURAL_VERTEX: typings.wonderJs.distEs2015CoreEntityObjectSceneCacheBufferTableMod.BufferTableKey.PROCEDURAL_VERTEX & Double = js.native
  }
}
