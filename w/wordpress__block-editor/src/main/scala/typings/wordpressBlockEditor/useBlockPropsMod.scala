...
import typings.wordpressBlockEditor.wordpressBlockEditorStrings.UseBlockProps
...
object useBlockPropsMod {
  ...
  trait UseBlockProps_ extends StObject {
    ...
    def apply[Props /* <: Record[String, Any] */](props: Props & UseBlockProps & TopLevel[Props] & Ref): (Omit[Props, ref]) & Merged & Reserved = js.native
