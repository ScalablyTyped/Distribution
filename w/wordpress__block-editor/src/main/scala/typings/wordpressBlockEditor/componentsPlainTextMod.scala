  ...
  object PlainText {
    ...
    trait Props extends StObject {
      ...
      /**
        ...
        */
      var ref: js.UndefOr[Ref[TypeofTextareaAutosize]] = js.undefined
    ...
    object Props {
      ...
      implicit open class MutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
        ...
        inline def setRef(value: Ref[TypeofTextareaAutosize]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
        
        inline def setRefFunction1(value: /* instance */ TypeofTextareaAutosize | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
