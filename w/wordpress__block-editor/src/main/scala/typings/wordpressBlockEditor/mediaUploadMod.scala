...
object mediaUploadMod {
  ...
  object MediaUpload {
    ...
    object Props {
      ...
      inline def apply[T /* <: Boolean */](onSelect: /* value */ Dictk | js.Array[Dictk] => Unit, render: Open => Element): Props[T] = {
      ...
      extension [Self <: Props[?], T /* <: Boolean */](x: Self & Props[T]) {
        ...
        inline def setOnSelect(value: /* value */ Dictk | js.Array[Dictk] => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
