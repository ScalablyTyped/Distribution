...
object storeMod {
  ...
  object storeConfig {
    ...
    @JSImport("@wordpress/block-editor/store", "storeConfig")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@wordpress/block-editor/store", "storeConfig.actions")
    @js.native
    ...
    @JSImport("@wordpress/block-editor/store", "storeConfig.controls")
    @js.native
    ...
    @JSImport("@wordpress/block-editor/store", "storeConfig.reducer")
    @js.native
    ...
    @JSImport("@wordpress/block-editor/store", "storeConfig.selectors")
    @js.native
