...
version := "11.5-dt-20230427Z-b5ea78"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-autosize-textarea" % "7.1.0-38fee9",
  ...
  "org.scalablytyped" %%% "wordpress__blocks" % "12.5-dt-20230320Z-f8cb73",
  "org.scalablytyped" %%% "wordpress__components" % "23.0-dt-20230327Z-7cec25",
  "org.scalablytyped" %%% "wordpress__data" % "9.3.0-d5fb78",
  "org.scalablytyped" %%% "wordpress__element" % "5.10.0-daa4f0",
  "org.scalablytyped" %%% "wordpress__keycodes" % "3.33.0-1dbb34",
  "org.scalablytyped" %%% "wordpress__notices" % "3.27-dt-20230323Z-cfb245",
  "org.scalablytyped" %%% "wordpress__shortcode" % "2.3-dt-20220817Z-cb7194")
