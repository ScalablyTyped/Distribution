...
object GPUShaderModule {
  ...
  inline def apply(getCompilationInfo: () => js.Promise[GPUCompilationInfo], label: String): GPUShaderModule = {
    val __obj = js.Dynamic.literal(__brand = "GPUShaderModule", getCompilationInfo = js.Any.fromFunction0(getCompilationInfo), label = label.asInstanceOf[js.Any])
