...
trait GPUSupportedLimits extends StObject {
  ...
  /**
    ...
    * @internal
    */
  val __brand: typings.webgpuTypes.webgpuTypesStrings.GPUSupportedLimits
  
  val maxBindGroups: Double
  
  val maxBindGroupsPlusVertexBuffers: Double
...
object GPUSupportedLimits {
  ...
  inline def apply(
    ...
    maxBindGroupsPlusVertexBuffers: Double,
  ...
  implicit open class MutableBuilder[Self <: GPUSupportedLimits] (val x: Self) extends AnyVal {
    ...
    inline def setMaxBindGroupsPlusVertexBuffers(value: Double): Self = StObject.set(x, "maxBindGroupsPlusVertexBuffers", value.asInstanceOf[js.Any])
    ...
    inline def set__brand(value: typings.webgpuTypes.webgpuTypesStrings.GPUSupportedLimits): Self = StObject.set(x, "__brand", value.asInstanceOf[js.Any])
  }
}
