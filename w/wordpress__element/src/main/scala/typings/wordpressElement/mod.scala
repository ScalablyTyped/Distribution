...
object mod extends js.Object {
  ...
  def cloneElement[P /* <: DOMAttributes[T] */, T /* <: typings.std.Element */](element: DOMElement[P, T]): DOMElement[P, T] = js.native
  ...
  def createElement_P_DOMAttributesTT_Element_DOMElement[P /* <: DOMAttributes[T] */, T /* <: typings.std.Element */](`type`: String): DOMElement[P, T] = js.native
  @JSName("createElement")
  def createElement_P_DOMAttributesTT_Element_DOMElement[P /* <: DOMAttributes[T] */, T /* <: typings.std.Element */](`type`: String, children: ReactNode*): DOMElement[P, T] = js.native
  @JSName("createElement")
