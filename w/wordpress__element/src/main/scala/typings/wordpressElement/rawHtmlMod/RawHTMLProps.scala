package typings.wordpressElement.rawHtmlMod
...
@js.native
trait RawHTMLProps extends js.Object {
...
object RawHTMLProps {
  ...
  @scala.inline
  implicit class RawHTMLPropsOps[Self <: RawHTMLProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: String with js.UndefOr[ReactNode]): Self = this.set("children", value.asInstanceOf[js.Any])
