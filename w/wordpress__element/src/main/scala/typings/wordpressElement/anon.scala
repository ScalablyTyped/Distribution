...
object anon {
  ...
  @js.native
  trait childrenstringPickDetaile extends StObject {
  ...
  object childrenstringPickDetaile {
    ...
    @scala.inline
    def apply(children: String with js.UndefOr[ReactNode]): childrenstringPickDetaile = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
      __obj.asInstanceOf[childrenstringPickDetaile]
    }
    
    @scala.inline
    implicit class childrenstringPickDetaileMutableBuilder[Self <: childrenstringPickDetaile] (val x: Self) extends AnyVal {
