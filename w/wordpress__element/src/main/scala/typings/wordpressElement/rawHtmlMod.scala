...
object rawHtmlMod {
  ...
  @js.native
  def default(hasChildrenProps: childrenstringPickDetaile): Element = js.native
  ...
  trait RawHTMLProps extends StObject {
    ...
    var children: String with js.UndefOr[ReactNode] = js.native
  ...
  object RawHTMLProps {
    ...
    @scala.inline
    def apply(children: String with js.UndefOr[ReactNode]): RawHTMLProps = {
    ...
    implicit class RawHTMLPropsMutableBuilder[Self <: RawHTMLProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setChildren(value: String with js.UndefOr[ReactNode]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
