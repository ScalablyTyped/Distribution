...
object rawHtmlMod {
  ...
  inline def default(hasChildrenProps: childrenstringPickDetaile): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(hasChildrenProps.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  object RawHTMLProps {
    ...
    inline def apply(children: String & js.UndefOr[ReactNode]): RawHTMLProps = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
      __obj.asInstanceOf[RawHTMLProps]
    }
    
    extension [Self <: RawHTMLProps](x: Self) {
      ...
      inline def setChildren(value: String & js.UndefOr[ReactNode]): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
