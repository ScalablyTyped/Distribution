...
package object mod {
  ...
  type HookMap[T /* <: js.Function1[/* repeated */ js.Any, _] */] = typings.wordpressHooks.anon.Current[T] with (typings.std.Record[java.lang.String, js.UndefOr[js.Array[typings.wordpressHooks.mod.Hook[T]]]])
