...
import typings.webDashBluetooth.webDashBluetoothStrings.advertisementreceived
import typings.webDashBluetooth.webDashBluetoothStrings.gattserverdisconnected
