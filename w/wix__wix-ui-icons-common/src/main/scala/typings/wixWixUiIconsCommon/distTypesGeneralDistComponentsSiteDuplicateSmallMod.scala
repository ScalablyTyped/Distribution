...
object distTypesGeneralDistComponentsSiteDuplicateSmallMod extends Shortcut {
  ...
  object SiteDuplicateSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SiteDuplicateSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesGeneralDistComponentsSiteDuplicateSmallMod.foo` */
