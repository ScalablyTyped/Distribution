...
object distTypesGeneralDistComponentsPaidPlansSmallMod extends Shortcut {
  ...
  object PaidPlansSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PaidPlansSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesGeneralDistComponentsPaidPlansSmallMod.foo` */
