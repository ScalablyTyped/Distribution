...
object distTypesGeneralDistComponentsEmailOpenMod extends Shortcut {
  ...
  object EmailOpenProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: EmailOpenProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesGeneralDistComponentsEmailOpenMod.foo` */
