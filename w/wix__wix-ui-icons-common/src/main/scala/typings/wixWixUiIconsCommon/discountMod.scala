...
object discountMod extends Shortcut {
  ...
  object DiscountProps {
    ...
    extension [Self <: DiscountProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `discountMod.foo` */
