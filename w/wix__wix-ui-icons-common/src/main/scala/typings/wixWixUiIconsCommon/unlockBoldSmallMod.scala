...
object unlockBoldSmallMod extends Shortcut {
  ...
  object UnlockBoldSmallProps {
    ...
    extension [Self <: UnlockBoldSmallProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `unlockBoldSmallMod.foo` */
