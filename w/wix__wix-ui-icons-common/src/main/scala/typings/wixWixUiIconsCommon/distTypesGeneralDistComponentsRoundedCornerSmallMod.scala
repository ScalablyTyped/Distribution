...
object distTypesGeneralDistComponentsRoundedCornerSmallMod extends Shortcut {
  ...
  object RoundedCornerSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: RoundedCornerSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesGeneralDistComponentsRoundedCornerSmallMod.foo` */
