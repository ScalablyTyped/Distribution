...
object distTypesGeneralDistComponentsLineChartSplitSmallMod extends Shortcut {
  ...
  object LineChartSplitSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: LineChartSplitSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesGeneralDistComponentsLineChartSplitSmallMod.foo` */
