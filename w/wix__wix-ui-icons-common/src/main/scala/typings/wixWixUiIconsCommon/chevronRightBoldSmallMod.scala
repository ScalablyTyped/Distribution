...
object chevronRightBoldSmallMod extends Shortcut {
  ...
  object ChevronRightBoldSmallProps {
    ...
    extension [Self <: ChevronRightBoldSmallProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `chevronRightBoldSmallMod.foo` */
