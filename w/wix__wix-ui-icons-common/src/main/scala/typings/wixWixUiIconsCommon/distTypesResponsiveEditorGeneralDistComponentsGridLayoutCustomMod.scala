...
object distTypesResponsiveEditorGeneralDistComponentsGridLayoutCustomMod extends Shortcut {
  ...
  object GridLayoutCustomProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: GridLayoutCustomProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesResponsiveEditorGeneralDistComponentsGridLayoutCustomMod.foo` */
