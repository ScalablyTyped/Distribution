...
object distTypesResponsiveEditorGeneralDistComponentsGridLayoutOneOnFourMod extends Shortcut {
  ...
  object GridLayoutOneOnFourProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: GridLayoutOneOnFourProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesResponsiveEditorGeneralDistComponentsGridLayoutOneOnFourMod.foo` */
