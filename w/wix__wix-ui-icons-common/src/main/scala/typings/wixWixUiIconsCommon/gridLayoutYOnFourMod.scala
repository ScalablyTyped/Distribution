...
object gridLayoutYOnFourMod extends Shortcut {
  ...
  object GridLayoutYOnFourProps {
    ...
    extension [Self <: GridLayoutYOnFourProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `gridLayoutYOnFourMod.foo` */
