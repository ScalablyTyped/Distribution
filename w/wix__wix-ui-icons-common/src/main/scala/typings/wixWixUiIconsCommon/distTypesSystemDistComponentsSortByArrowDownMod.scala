...
object distTypesSystemDistComponentsSortByArrowDownMod extends Shortcut {
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/system/dist/components/SortByArrowDown", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesSystemDistComponentsSortByArrowDownMod.foo` */
