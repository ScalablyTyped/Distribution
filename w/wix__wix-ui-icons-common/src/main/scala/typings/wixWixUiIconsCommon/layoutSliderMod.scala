...
object layoutSliderMod extends Shortcut {
  ...
  object LayoutSliderProps {
    ...
    extension [Self <: LayoutSliderProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `layoutSliderMod.foo` */
