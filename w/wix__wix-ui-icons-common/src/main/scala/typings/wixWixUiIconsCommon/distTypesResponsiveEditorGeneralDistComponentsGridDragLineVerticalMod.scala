...
object distTypesResponsiveEditorGeneralDistComponentsGridDragLineVerticalMod extends Shortcut {
  ...
  object GridDragLineVerticalProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: GridDragLineVerticalProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesResponsiveEditorGeneralDistComponentsGridDragLineVerticalMod.foo` */
