...
import typings.wixWixUiIconsCommon.typesMod.Category
import typings.wixWixUiIconsCommon.typesMod.CategoryTableRow
...
object categoryListCategoryListMod {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/stories/components/category-list/CategoryList", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@wix/wix-ui-icons-common/dist/types/stories/components/category-list/CategoryList", JSImport.Default)
  @js.native
