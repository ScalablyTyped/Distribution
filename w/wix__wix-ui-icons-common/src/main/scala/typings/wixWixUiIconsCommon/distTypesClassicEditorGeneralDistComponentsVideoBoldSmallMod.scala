...
object distTypesClassicEditorGeneralDistComponentsVideoBoldSmallMod extends Shortcut {
  ...
  object VideoBoldSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: VideoBoldSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesClassicEditorGeneralDistComponentsVideoBoldSmallMod.foo` */
