...
object addCircleMod extends Shortcut {
  ...
  object AddCircleProps {
    ...
    extension [Self <: AddCircleProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `addCircleMod.foo` */
