...
object multiSelectMod extends Shortcut {
  ...
  @JSImport("@wix/wix-ui-icons-common/dist/types/general/dist/components/MultiSelect", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `multiSelectMod.foo` */
