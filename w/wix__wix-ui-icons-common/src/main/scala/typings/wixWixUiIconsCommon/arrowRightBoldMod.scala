...
object arrowRightBoldMod extends Shortcut {
  ...
  object ArrowRightBoldProps {
    ...
    extension [Self <: ArrowRightBoldProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `arrowRightBoldMod.foo` */
