...
object distTypesClassicEditorGeneralDistComponentsLinkPropertiesMod extends Shortcut {
  ...
  object LinkPropertiesProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: LinkPropertiesProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesClassicEditorGeneralDistComponentsLinkPropertiesMod.foo` */
