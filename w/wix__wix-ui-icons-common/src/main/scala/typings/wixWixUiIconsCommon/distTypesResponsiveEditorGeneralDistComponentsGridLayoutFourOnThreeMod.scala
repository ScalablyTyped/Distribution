...
object distTypesResponsiveEditorGeneralDistComponentsGridLayoutFourOnThreeMod extends Shortcut {
  ...
  object GridLayoutFourOnThreeProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: GridLayoutFourOnThreeProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesResponsiveEditorGeneralDistComponentsGridLayoutFourOnThreeMod.foo` */
