...
object TorrentOptions {
  ...
  def apply(
    ...
    getAnnounceOpts: js.Function0[scala.Unit] = null,
    maxWebConns: scala.Int | scala.Double = null,
    name: java.lang.String = null,
    path: java.lang.String = null,
    store: js.Function2[/* chunkLength */ scala.Double, /* storeOpts */ webtorrentLib.Anon_Files, _] = null
  ): TorrentOptions = {
    val __obj = js.Dynamic.literal()
    if (announce != null) __obj.updateDynamic("announce")(announce)
    if (getAnnounceOpts != null) __obj.updateDynamic("getAnnounceOpts")(getAnnounceOpts)
