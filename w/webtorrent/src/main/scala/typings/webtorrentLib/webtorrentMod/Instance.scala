...
trait Instance
  ...
  def add(torrent: parseDashTorrentLib.parseDashTorrentMod.Instance): Torrent = js.native
  def add(
    torrent: parseDashTorrentLib.parseDashTorrentMod.Instance,
    cb: js.Function1[/* torrent */ Torrent, _]
  ): Torrent = js.native
  def add(torrent: parseDashTorrentLib.parseDashTorrentMod.Instance, opts: TorrentOptions): Torrent = js.native
  def add(
    torrent: parseDashTorrentLib.parseDashTorrentMod.Instance,
    opts: TorrentOptions,
    cb: js.Function1[/* torrent */ Torrent, _]
