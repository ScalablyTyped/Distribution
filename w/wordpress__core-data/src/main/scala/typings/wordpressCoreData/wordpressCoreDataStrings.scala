...
import typings.wordpressCoreData.schemaMod.Schema.Context
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.Block
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.Category
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.Comment
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.Media
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.Page
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.Post
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.PostRevision
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.Status
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.Tag
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.Taxonomy
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.Type
import typings.wordpressCoreData.schemaMod.Schema.EmbedKeys.User
import typings.wordpressCoreData.schemaMod.Schema.OpenOrClosed
import typings.wordpressCoreData.schemaMod.Schema.PostFormat
import typings.wordpressCoreData.schemaMod.Schema.PostStatus
...
object wordpressCoreDataStrings {
  ...
  sealed trait categories
    extends StObject
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Post
  ...
  sealed trait comment_status
    extends StObject
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Media
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Page
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Post
  ...
  sealed trait content
    extends StObject
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Block
       with Comment
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Page
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Post
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.PostRevision
  ...
  sealed trait count
    extends StObject
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Category
  ...
  sealed trait date_gmt
    extends StObject
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Block
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Comment
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Media
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Page
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Post
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.PostRevision
  ...
  sealed trait description
    extends StObject
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Category
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Media
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Taxonomy
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Type
       with User
  ...
  sealed trait meta
    extends StObject
       ...
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Page
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Post
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.User
  ...
  sealed trait public
    extends StObject
       with typings.wordpressCoreData.schemaMod.Schema.ViewKeys.Status
