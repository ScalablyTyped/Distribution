...
object BasePost {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BasePost[?], T /* <: Context */] (val x: Self & BasePost[T]) extends AnyVal {
    ...
    inline def setFormat(value: PostFormat): Self = StObject.set(x, "format", value.asInstanceOf[js.Any])
