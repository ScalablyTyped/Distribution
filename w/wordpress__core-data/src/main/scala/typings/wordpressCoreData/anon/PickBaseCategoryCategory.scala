...
/* Inlined std.Pick<@wordpress/core-data.@wordpress/core-data/schema.Schema.BaseCategory, @wordpress/core-data.@wordpress/core-data/schema.Schema.EmbedKeys.Category> */
