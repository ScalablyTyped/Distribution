...
object storeActionsMod {
  ...
  inline def editPost(edits: Record[String, Any]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("editPost")(edits.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def resetEditorBlocks(blocks: js.Array[BlockInstance[StringDictionary[Any]]]): IterableIterator[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("resetEditorBlocks")(blocks.asInstanceOf[js.Any]).asInstanceOf[IterableIterator[Unit]]
  inline def resetEditorBlocks(blocks: js.Array[BlockInstance[StringDictionary[Any]]], options: Record[String, Any]): IterableIterator[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("resetEditorBlocks")(blocks.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[IterableIterator[Unit]]
  
  inline def resetPost(post: Record[String, Any]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("resetPost")(post.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def savePost(options: Record[String, Any]): IterableIterator[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("savePost")(options.asInstanceOf[js.Any]).asInstanceOf[IterableIterator[Unit]]
  ...
  inline def setupEditor(post: Record[String, Any]): IterableIterator[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("setupEditor")(post.asInstanceOf[js.Any]).asInstanceOf[IterableIterator[Unit]]
  inline def setupEditor(post: Record[String, Any], edits: Unit, template: TemplateArray): IterableIterator[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("setupEditor")(post.asInstanceOf[js.Any], edits.asInstanceOf[js.Any], template.asInstanceOf[js.Any])).asInstanceOf[IterableIterator[Unit]]
  inline def setupEditor(post: Record[String, Any], edits: Record[String, Any]): IterableIterator[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("setupEditor")(post.asInstanceOf[js.Any], edits.asInstanceOf[js.Any])).asInstanceOf[IterableIterator[Unit]]
  inline def setupEditor(post: Record[String, Any], edits: Record[String, Any], template: TemplateArray): IterableIterator[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("setupEditor")(post.asInstanceOf[js.Any], edits.asInstanceOf[js.Any], template.asInstanceOf[js.Any])).asInstanceOf[IterableIterator[Unit]]
  
  inline def setupEditorState(post: Record[String, Any]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setupEditorState")(post.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def updatePost(edits: Record[String, Any]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("updatePost")(edits.asInstanceOf[js.Any]).asInstanceOf[Unit]
