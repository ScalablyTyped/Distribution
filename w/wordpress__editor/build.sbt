...
version := "11.0-dt-20220407Z-dc4bce"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "wordpress__core-data" % "2.4-dt-20211202Z-64a677",
  "org.scalablytyped" %%% "wordpress__element" % "4.19.0-153f25",
  "org.scalablytyped" %%% "wordpress__media-utils" % "3.0-dt-20220421Z-9705e7",
