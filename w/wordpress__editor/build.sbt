...
version := "9.4-dt-20200925Z-52c130"
scalaVersion := "3.0.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "wordpress__core-data" % "2.4-dt-20200925Z-ea6482",
  "org.scalablytyped" %%% "wordpress__element" % "2.18.0-b7be65",
  "org.scalablytyped" %%% "wordpress__media-utils" % "0.2-dt-20200925Z-af9ba5",
