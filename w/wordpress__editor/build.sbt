...
version := "11.0-dt-20220407Z-c77943"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "wordpress__core-data" % "2.4-dt-20211202Z-d027d8",
  "org.scalablytyped" %%% "wordpress__element" % "4.19.0-938b4b",
  "org.scalablytyped" %%% "wordpress__media-utils" % "3.0-dt-20220421Z-80fdf7",
