...
version := "9.4-dt-20200611Z-ea7989"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "wordpress__core-data" % "2.4-dt-20200515Z-d7139b",
  "org.scalablytyped" %%% "wordpress__element" % "2.16.0-35329a",
  "org.scalablytyped" %%% "wordpress__media-utils" % "0.2-dt-20200611Z-ab0225",
