...
version := "9.4-dt-20200925Z-b52bab"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "wordpress__core-data" % "2.4-dt-20200925Z-44c007",
  "org.scalablytyped" %%% "wordpress__element" % "2.18.0-aff613",
  "org.scalablytyped" %%% "wordpress__media-utils" % "0.2-dt-20200925Z-c5db0a",
