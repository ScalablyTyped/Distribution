...
version := "9.4-dt-20200925Z-1469f6"
scalaVersion := "3.0.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "wordpress__core-data" % "2.4-dt-20200925Z-99a913",
  "org.scalablytyped" %%% "wordpress__element" % "2.18.0-6ec5e6",
  "org.scalablytyped" %%% "wordpress__media-utils" % "0.2-dt-20200925Z-378d0f",
