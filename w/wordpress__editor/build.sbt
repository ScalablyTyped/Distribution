...
version := "9.4-dt-20200925Z-b9988c"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "wordpress__core-data" % "2.4-dt-20200925Z-a2259f",
  "org.scalablytyped" %%% "wordpress__element" % "2.18.0-033d1a",
  "org.scalablytyped" %%% "wordpress__media-utils" % "0.2-dt-20200925Z-f7daf2",
