...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "testing-library__react" % "13.4.0-88f9c9",
  ...
  "org.scalablytyped" %%% "wix-design-systems-providers" % "1.14.2-37251e",
  "org.scalablytyped" %%% "wix-ui-test-utils" % "1.0.191-fb4bff",
