...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "testing-library__react" % "13.4.0-3aeba8",
  ...
  "org.scalablytyped" %%% "wix-design-systems-providers" % "1.14.2-556e1e",
  "org.scalablytyped" %%% "wix-ui-test-utils" % "1.0.191-c9c373",
