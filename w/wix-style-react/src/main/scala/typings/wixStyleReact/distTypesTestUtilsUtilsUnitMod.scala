...
import typings.testingLibraryReact.anon.Typeofqueries
...
import typings.wixStyleReact.anon.DriverReturnType
...
object distTypesTestUtilsUtilsUnitMod {
  ...
  @js.native
  val screen: Screen_[typings.testingLibraryDom.anon.Typeofqueries] = js.native
