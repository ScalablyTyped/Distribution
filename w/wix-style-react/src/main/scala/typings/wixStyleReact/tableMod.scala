...
object tableMod {
  ...
  object TableProps {
    ...
    extension [Self <: TableProps[?], RowData](x: Self & TableProps[RowData]) {
      ...
      inline def setColumnsVarargs(value: TableColumn[RowData]*): Self = StObject.set(x, "columns", js.Array(value :_*))
      ...
      inline def setSelectedIdsVarargs(value: (Double | String)*): Self = StObject.set(x, "selectedIds", js.Array(value :_*))
      
      inline def setSelectionDisabled(value: Boolean): Self = StObject.set(x, "selectionDisabled", value.asInstanceOf[js.Any])
