...
object calendarMod {
  ...
  object CalendarProps {
    ...
    extension [Self <: CalendarProps](x: Self) {
      ...
      inline def setLocale(value: String | DistanceInWords): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
      ...
      inline def setValue(value: String | Date | From): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
