...
import typings.wixStyleReact.commonMod.InjectedFocusableProps
...
object badgeMod {
  ...
  @JSImport("wix-style-react/dist/es/src/Badge", JSImport.Default)
  @js.native
  class default ()
    extends PureComponent[BadgeProps, js.Object, js.Any]
  
  /* Inlined {[ key in wix-style-react.wix-style-react/dist/es/src/Badge.BadgeSize ]: wix-style-react.wix-style-react/dist/es/src/Badge.BadgeSize} */
  object SIZE {
    
    @JSImport("wix-style-react/dist/es/src/Badge", "SIZE")
    @js.native
  ...
  object SKIN {
    ...
    @JSImport("wix-style-react/dist/es/src/Badge", "SKIN")
    @js.native
    val ^ : js.Any = js.native
  ...
  object TYPE {
    ...
    @JSImport("wix-style-react/dist/es/src/Badge", "TYPE")
    @js.native
    val ^ : js.Any = js.native
