...
object distTypesTestUtilsUtilsEventuallyMod {
  ...
  inline def default(fn: Any, param1: Interval): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(fn.asInstanceOf[js.Any], param1.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
