...
object multiSelectUniDriverMod {
  ...
  object MultiSelectUniDriver {
    ...
    @scala.inline
    implicit class MultiSelectUniDriverMutableBuilder[Self <: MultiSelectUniDriver] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setClick(value: () => js.Promise[Unit]): Self = StObject.set(x, "click", js.Any.fromFunction0(value))
      
      @scala.inline
      def setDriver(value: getMaxHeightPromiseanycli): Self = StObject.set(x, "driver", value.asInstanceOf[js.Any])
