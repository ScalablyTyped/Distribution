...
object inputWithOptionsMod {
  ...
  @JSImport("wix-style-react/dist/es/src/InputWithOptions", JSImport.Default)
  @js.native
  class default[ManualInputFn, OnSelectFn, T /* <: InputWithOptionsProps[ManualInputFn, OnSelectFn] */] () extends InputWithOptions[ManualInputFn, OnSelectFn, T]
  ...
  /* Inlined parent wix-style-react.wix-style-react/dist/es/src/Input.InputProps */
  /* Inlined parent wix-style-react.wix-style-react/dist/es/src/common.OmitPolyfill<wix-style-react.wix-style-react/dist/es/src/DropdownLayout.DropdownLayoutProps, 'onSelect'> */
  ...
  object InputWithOptionsProps {
    ...
    @scala.inline
    def apply[ManualInputFn, OnSelectFn](): InputWithOptionsProps[ManualInputFn, OnSelectFn] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InputWithOptionsProps[ManualInputFn, OnSelectFn]]
    }
    
    @scala.inline
    implicit class InputWithOptionsPropsMutableBuilder[Self <: InputWithOptionsProps[?, ?], ManualInputFn, OnSelectFn] (val x: Self & (InputWithOptionsProps[ManualInputFn, OnSelectFn])) extends AnyVal {
      ...
      @scala.inline
      def setOnManuallyInput(value: ManualInputFn): Self = StObject.set(x, "onManuallyInput", value.asInstanceOf[js.Any])
