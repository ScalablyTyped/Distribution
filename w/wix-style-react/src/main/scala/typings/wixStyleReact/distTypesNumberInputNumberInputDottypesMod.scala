...
object distTypesNumberInputNumberInputDottypesMod {
  ...
  object NumberInputProps {
    ...
    extension [Self <: NumberInputProps](x: Self) {
      ...
      inline def setOnChange(value: (/* value */ Double | Null, /* stringValue */ String) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      ...
      inline def setOnInvalid(value: /* value */ String => Unit): Self = StObject.set(x, "onInvalid", js.Any.fromFunction1(value))
