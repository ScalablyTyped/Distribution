...
import typings.wixStyleReact.anon.ChildrenLocale
...
object distTypesWixStyleReactEnvironmentProviderWixStyleReactEnvironmentProviderMod {
  ...
  object default {
    ...
    inline def apply(param0: ChildrenLocale): Element = ^.asInstanceOf[js.Dynamic].apply(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
