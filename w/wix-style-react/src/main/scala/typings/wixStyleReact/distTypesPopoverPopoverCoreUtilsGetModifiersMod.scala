...
object distTypesPopoverPopoverCoreUtilsGetModifiersMod {
  
  @JSImport("wix-style-react/dist/types/Popover/PopoverCore/utils/getModifiers", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def getModifiers(param0: ModifiersParams): Modifiers = ^.asInstanceOf[js.Dynamic].applyDynamic("getModifiers")(param0.asInstanceOf[js.Any]).asInstanceOf[Modifiers]
