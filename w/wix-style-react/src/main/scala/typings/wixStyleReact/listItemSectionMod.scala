...
object listItemSectionMod {
  
  @JSImport("wix-style-react/dist/es/src/ListItemSection", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("wix-style-react/dist/es/src/ListItemSection", JSImport.Default)
  @js.native
