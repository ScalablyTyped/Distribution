...
@js.native
open class Popover ()
  extends typings.wixStyleReact.distTypesPopoverMod.default
/* static members */
object Popover {
  ...
  @js.native
  def Content: FC[ChildrenReactNode] | FunctionComponent[ElementProps] = js.native
  inline def Content_=(x: FC[ChildrenReactNode] | FunctionComponent[ElementProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Content")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("wix-style-react", "Popover.Element")
  @js.native
  def Element: FC[ChildrenReactNode] | FunctionComponent[ElementProps] = js.native
  inline def Element_=(x: FC[ChildrenReactNode] | FunctionComponent[ElementProps]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Element")(x.asInstanceOf[js.Any])
  
  /* static member */
  object defaultProps {
    
    @JSImport("wix-style-react", "Popover.defaultProps")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("wix-style-react", "Popover.defaultProps.animate")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.defaultProps.appendTo")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.defaultProps.theme")
    @js.native
  ...
  /* static member */
  @JSImport("wix-style-react", "Popover.displayName")
  @js.native
  ...
  object propTypes {
    ...
    @JSImport("wix-style-react", "Popover.propTypes")
    @js.native
    val ^ : js.Any = js.native
    
    /** Adds enter and exit animation */
    @JSImport("wix-style-react", "Popover.propTypes.animate")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.appendTo")
    @js.native
    ...
    /** custom classname */
    @JSImport("wix-style-react", "Popover.propTypes.className")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.contentClassName")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.customArrow")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.dataHook")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.disableClickOutsideWhenClosed")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.dynamicWidth")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.excludeClass")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("wix-style-react", "Popover.propTypes.fixed")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("wix-style-react", "Popover.propTypes.flip")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.fluid")
    @js.native
    ...
    /** Hide Delay in ms */
    @JSImport("wix-style-react", "Popover.propTypes.hideDelay")
    @js.native
    ...
    /** Id */
    @JSImport("wix-style-react", "Popover.propTypes.id")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("wix-style-react", "Popover.propTypes.maxWidth")
    @js.native
    ...
    /**
      ...
      * - `string` value that contains `px`
      */
    @JSImport("wix-style-react", "Popover.propTypes.minWidth")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.moveArrowTo")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.moveBy")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.onClick")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.onClickOutside")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.onKeyDown")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.onMouseEnter")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.onMouseLeave")
    @js.native
    ...
    /** The Popover's placement:
      ...
      *  * left-start
      */
    @JSImport("wix-style-react", "Popover.propTypes.placement")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.role")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.showArrow")
    @js.native
    ...
    /** Show Delay in ms */
    @JSImport("wix-style-react", "Popover.propTypes.showDelay")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.shown")
    @js.native
    ...
    /** Inline style */
    @JSImport("wix-style-react", "Popover.propTypes.style")
    @js.native
    ...
    @JSImport("wix-style-react", "Popover.propTypes.theme")
    @js.native
    ...
    /** Animation timer */
    @JSImport("wix-style-react", "Popover.propTypes.timeout")
    @js.native
    ...
    /**
      ...
      * - `string` value that contains `px`
      */
    @JSImport("wix-style-react", "Popover.propTypes.width")
    @js.native
    ...
    /** popover z-index */
    @JSImport("wix-style-react", "Popover.propTypes.zIndex")
    @js.native
