...
object clients {
  ...
  @scala.inline
  def GoogleMapsClient_=(x: typings.wixStyleReact.clientsMod.GoogleMapsClient): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GoogleMapsClient")(x.asInstanceOf[js.Any])
}
