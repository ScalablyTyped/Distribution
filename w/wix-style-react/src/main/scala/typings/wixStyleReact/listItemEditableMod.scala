...
object listItemEditableMod {
  ...
  inline def listItemEditableBuilder(data: ApproveButtonTooltipContent): IdOverrideOptionStyle = ^.asInstanceOf[js.Dynamic].applyDynamic("listItemEditableBuilder")(data.asInstanceOf[js.Any]).asInstanceOf[IdOverrideOptionStyle]
