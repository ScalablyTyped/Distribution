...
object distTypesSidePanelSidePanelDotuniDotdriverMod {
  ...
  object SidePanelUniDriver {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(click = js.Any.fromFunction0(click), clickClose = js.Any.fromFunction0(clickClose), element = js.Any.fromFunction0(element), exists = js.Any.fromFunction0(exists), getSubtitleText = js.Any.fromFunction0(getSubtitleText), getTitleText = js.Any.fromFunction0(getTitleText), getTooltipContent = js.Any.fromFunction0(getTooltipContent), isCloseButtonExists = js.Any.fromFunction0(isCloseButtonExists), isFooterDividerExists = js.Any.fromFunction0(isFooterDividerExists), isHeaderDividerExists = js.Any.fromFunction0(isHeaderDividerExists))
