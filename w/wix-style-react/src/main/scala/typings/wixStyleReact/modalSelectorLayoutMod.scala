...
object modalSelectorLayoutMod {
  ...
  object ModalSelectorLayoutCommonProps {
    ...
    extension [Self <: ModalSelectorLayoutCommonProps](x: Self) {
      ...
      inline def setDataSource(value: (/* searchQuery */ String, /* offset */ Double, /* limit */ Double) => js.Promise[Items]): Self = StObject.set(x, "dataSource", js.Any.fromFunction3(value))
