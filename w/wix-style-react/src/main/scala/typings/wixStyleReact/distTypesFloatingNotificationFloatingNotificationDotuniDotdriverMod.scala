...
object distTypesFloatingNotificationFloatingNotificationDotuniDotdriverMod {
  ...
  trait FloatingNotificationUniDriver
    ...
    def isButtonAs(
      as: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typings.wixStyleReact.wixStyleReactStrings.a, typings.wixStyleReact.wixStyleReactStrings.abbr, typings.wixStyleReact.wixStyleReactStrings.address */ Any
    ): js.Promise[Boolean]
  ...
  object FloatingNotificationUniDriver {
    ...
    inline def apply(
      ...
      isButtonAs: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typings.wixStyleReact.wixStyleReactStrings.a, typings.wixStyleReact.wixStyleReactStrings.abbr, typings.wixStyleReact.wixStyleReactStrings.address */ Any => js.Promise[Boolean],
      isTextButtonAs: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typings.wixStyleReact.wixStyleReactStrings.a, typings.wixStyleReact.wixStyleReactStrings.abbr, typings.wixStyleReact.wixStyleReactStrings.address */ Any => js.Promise[Boolean]
    ...
    extension [Self <: FloatingNotificationUniDriver](x: Self) {
      ...
      inline def setIsButtonAs(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typings.wixStyleReact.wixStyleReactStrings.a, typings.wixStyleReact.wixStyleReactStrings.abbr, typings.wixStyleReact.wixStyleReactStrings.address */ Any => js.Promise[Boolean]
