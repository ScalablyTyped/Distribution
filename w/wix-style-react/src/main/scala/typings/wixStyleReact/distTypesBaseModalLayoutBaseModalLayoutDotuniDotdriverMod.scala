...
object distTypesBaseModalLayoutBaseModalLayoutDotuniDotdriverMod {
  ...
  object BaseModalLayoutUniDriver {
    ...
    extension [Self <: BaseModalLayoutUniDriver](x: Self) {
      ...
      inline def setGetPrimaryButtonTooltipContent(value: () => js.Promise[String]): Self = StObject.set(x, "getPrimaryButtonTooltipContent", js.Any.fromFunction0(value))
