...
import typings.wixStyleReact.anon.StickyStyle
...
object distTypesPageContentMod {
  ...
  object default {
    ...
    inline def apply(param0: StickyStyle): Any = ^.asInstanceOf[js.Dynamic].apply(param0.asInstanceOf[js.Any]).asInstanceOf[Any]
