...
object distTypesHeadingMod extends Shortcut {
  ...
  */
  ...
  /* Inlined parent react.react.HTMLAttributes<std.HTMLHeadingElement> */
  /* Inlined parent wix-style-react.wix-style-react/dist/types/common.OmitPolyfill<wix-style-react.wix-style-react/dist/types/common/Ellipsis.EllipsisCommonProps, 'size'> */
  trait HeadingProps extends StObject {
    ...
    var as: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 112, starting with typings.wixStyleReact.wixStyleReactStrings.a, typings.wixStyleReact.wixStyleReactStrings.abbr, typings.wixStyleReact.wixStyleReactStrings.address */ Any
      ] = js.undefined
  ...
  object HeadingProps {
    ...
    extension [Self <: HeadingProps](x: Self) {
      ...
      inline def setAs(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 112, starting with typings.wixStyleReact.wixStyleReactStrings.a, typings.wixStyleReact.wixStyleReactStrings.abbr, typings.wixStyleReact.wixStyleReactStrings.address */ Any
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.wixStyleReact.wixStyleReactStrings.extraLarge
    - typings.wixStyleReact.wixStyleReactStrings.large
    - typings.wixStyleReact.wixStyleReactStrings.medium
    - typings.wixStyleReact.wixStyleReactStrings.small
    - typings.wixStyleReact.wixStyleReactStrings.tiny
    - typings.wixStyleReact.wixStyleReactStrings.extraTiny
  */
  trait Size extends StObject
  object Size {
    
    inline def extraLarge: typings.wixStyleReact.wixStyleReactStrings.extraLarge = "extraLarge".asInstanceOf[typings.wixStyleReact.wixStyleReactStrings.extraLarge]
    
    inline def extraTiny: typings.wixStyleReact.wixStyleReactStrings.extraTiny = "extraTiny".asInstanceOf[typings.wixStyleReact.wixStyleReactStrings.extraTiny]
