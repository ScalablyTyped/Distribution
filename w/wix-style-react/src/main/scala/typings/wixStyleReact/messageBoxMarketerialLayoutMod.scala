...
object messageBoxMarketerialLayoutMod {
  ...
  object MessageBoxMarketerialLayoutProps {
    ...
    @scala.inline
    def apply(onClose: MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): MessageBoxMarketerialLayoutProps = {
      val __obj = js.Dynamic.literal(onClose = js.Any.fromFunction1(onClose))
      __obj.asInstanceOf[MessageBoxMarketerialLayoutProps]
    }
    
    @scala.inline
    implicit class MessageBoxMarketerialLayoutPropsMutableBuilder[Self <: MessageBoxMarketerialLayoutProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setImageComponent(value: ReactNode): Self = StObject.set(x, "imageComponent", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnPrimaryButtonClick(value: MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onPrimaryButtonClick", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnPrimaryButtonClickUndefined: Self = StObject.set(x, "onPrimaryButtonClick", js.undefined)
      
      @scala.inline
      def setOnSecondaryButtonClick(value: MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onSecondaryButtonClick", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnSecondaryButtonClickUndefined: Self = StObject.set(x, "onSecondaryButtonClick", js.undefined)
      ...
      @scala.inline
      def setPrimaryButtonLabel(value: String): Self = StObject.set(x, "primaryButtonLabel", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPrimaryButtonLabelUndefined: Self = StObject.set(x, "primaryButtonLabel", js.undefined)
      
      @scala.inline
      def setPrimaryButtonNode(value: ReactNode): Self = StObject.set(x, "primaryButtonNode", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPrimaryButtonNodeUndefined: Self = StObject.set(x, "primaryButtonNode", js.undefined)
      
      @scala.inline
      def setPrimaryButtonTheme(value: MessageBoxMarketerialLayoutThemePrimaryButtonTheme): Self = StObject.set(x, "primaryButtonTheme", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPrimaryButtonThemeUndefined: Self = StObject.set(x, "primaryButtonTheme", js.undefined)
      
      @scala.inline
      def setRemoveButtonsPadding(value: Boolean): Self = StObject.set(x, "removeButtonsPadding", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRemoveButtonsPaddingUndefined: Self = StObject.set(x, "removeButtonsPadding", js.undefined)
      
      @scala.inline
      def setSecondaryButtonLabel(value: String): Self = StObject.set(x, "secondaryButtonLabel", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSecondaryButtonLabelUndefined: Self = StObject.set(x, "secondaryButtonLabel", js.undefined)
      
      @scala.inline
      def setTheme(value: MessageBoxMarketerialLayoutTheme): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
