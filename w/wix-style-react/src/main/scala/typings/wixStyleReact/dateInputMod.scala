...
object dateInputMod {
  ...
  @JSImport("wix-style-react/dist/es/src/DatePicker/DateInput", JSImport.Default)
  @js.native
  class default ()
    extends PureComponent[DateInputProps, js.Object, js.Any]
  
  type DateInput = PureComponent[DateInputProps, js.Object, js.Any]
  
  /* Inlined parent wix-style-react.wix-style-react/dist/es/src/common.OmitPolyfill<wix-style-react.wix-style-react/dist/es/src/Input.InputProps, 'value'> */
  trait DateInputProps extends StObject {
    ...
    var dateFormat: js.UndefOr[String | (js.Function1[/* date */ Date, Unit])] = js.undefined
    
    var dateFormatV2: js.UndefOr[String | (js.Function1[/* date */ Date, Unit])] = js.undefined
    ...
    var value: js.UndefOr[js.Object | String | Double] = js.undefined
  ...
  object DateInputProps {
    ...
    extension [Self <: DateInputProps](x: Self) {
      ...
      inline def setDateFormat(value: String | (js.Function1[/* date */ Date, Unit])): Self = StObject.set(x, "dateFormat", value.asInstanceOf[js.Any])
      
      inline def setDateFormatFunction1(value: /* date */ Date => Unit): Self = StObject.set(x, "dateFormat", js.Any.fromFunction1(value))
      
      inline def setDateFormatUndefined: Self = StObject.set(x, "dateFormat", js.undefined)
      
      inline def setDateFormatV2(value: String | (js.Function1[/* date */ Date, Unit])): Self = StObject.set(x, "dateFormatV2", value.asInstanceOf[js.Any])
      
      inline def setDateFormatV2Function1(value: /* date */ Date => Unit): Self = StObject.set(x, "dateFormatV2", js.Any.fromFunction1(value))
      ...
      inline def setValue(value: js.Object | String | Double): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
