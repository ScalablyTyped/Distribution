...
object dateInputMod {
  ...
  object DateInputProps {
    ...
    implicit class DateInputPropsMutableBuilder[Self <: DateInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDateFormat(value: String | (js.Function1[/* date */ Date, Unit])): Self = StObject.set(x, "dateFormat", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDateFormatFunction1(value: /* date */ Date => Unit): Self = StObject.set(x, "dateFormat", js.Any.fromFunction1(value))
      
      @scala.inline
      def setDateFormatUndefined: Self = StObject.set(x, "dateFormat", js.undefined)
      
      @scala.inline
      def setDateFormatV2(value: String | (js.Function1[/* date */ Date, Unit])): Self = StObject.set(x, "dateFormatV2", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDateFormatV2Function1(value: /* date */ Date => Unit): Self = StObject.set(x, "dateFormatV2", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setValue(value: js.Object | String | Double): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
