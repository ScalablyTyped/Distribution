  ...
  */
  ...
  object FormFieldProps {
    ...
    extension [Self <: FormFieldProps](x: Self) {
      ...
      inline def setChildren(value: ReactNode | (js.Function1[/* data */ SetCharactersLeft, ReactNode])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      inline def setChildrenFunction1(value: /* data */ SetCharactersLeft => ReactNode): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      inline def setLabelPlacement(value: FormFieldLabelPlacement): Self = StObject.set(x, "labelPlacement", value.asInstanceOf[js.Any])
      
      inline def setLabelPlacementUndefined: Self = StObject.set(x, "labelPlacement", js.undefined)
      
      inline def setLabelSize(value: LabelPlacement): Self = StObject.set(x, "labelSize", value.asInstanceOf[js.Any])
