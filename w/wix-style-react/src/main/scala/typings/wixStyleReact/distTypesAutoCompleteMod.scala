...
object distTypesAutoCompleteMod {
  
  @JSImport("wix-style-react/dist/types/AutoComplete", JSImport.Default)
  @js.native
  open class default ()
    extends typings.wixStyleReact.distTypesInputWithOptionsMod.default[ManualInputFnSignature, OnSelectFnSignature, AutoCompleteProps]
  
  type AutoComplete = typings.wixStyleReact.distTypesInputWithOptionsMod.default[ManualInputFnSignature, OnSelectFnSignature, AutoCompleteProps]
  ...
  object AutoCompleteProps {
    ...
    extension [Self <: AutoCompleteProps](x: Self) {
      ...
      inline def setEmptyStateMessage(value: ReactNode): Self = StObject.set(x, "emptyStateMessage", value.asInstanceOf[js.Any])
