...
object distTypesAccordionAccordionItemMod {
  ...
  type AccordionItem = Component[AccordionItemProps & AccordionItemCommonProps, js.Object, Any]
  
  /* Rewritten from type alias, can be one of: 
    - typings.wixStyleReact.wixStyleReactStrings.textButton
    - typings.wixStyleReact.wixStyleReactStrings.button
    - typings.wixStyleReact.wixStyleReactStrings.node
  */
  ...
  object AccordionItemButtonType {
    ...
    inline def node: typings.wixStyleReact.wixStyleReactStrings.node = "node".asInstanceOf[typings.wixStyleReact.wixStyleReactStrings.node]
