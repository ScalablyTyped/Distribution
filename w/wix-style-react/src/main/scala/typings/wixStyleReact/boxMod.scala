...
object boxMod extends Shortcut {
  ...
  @JSImport("wix-style-react/dist/es/src/Box", JSImport.Default)
  @js.native
  val default: SFC[BoxProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typings.wixStyleReact.boxMod.BoxSpacing
    - typings.wixStyleReact.commonMod.Spacing
    - java.lang.String
    - scala.Double
  */
  ...
  */
  ...
  /* Inlined parent wix-style-react.wix-style-react/dist/es/src/common.OmitPolyfill<react.react.CSSProperties, 'direction'> */
