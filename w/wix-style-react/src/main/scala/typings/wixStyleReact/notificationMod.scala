...
object notificationMod {
  ...
  */
  ...
  object ActionButtonProps {
    ...
    inline def ButtonActionButtonProps(): typings.wixStyleReact.notificationMod.ButtonActionButtonProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.wixStyleReact.notificationMod.ButtonActionButtonProps]
    }
    
    inline def TextLinkActionButton(): typings.wixStyleReact.notificationMod.TextLinkActionButton = {
      val __obj = js.Dynamic.literal()
