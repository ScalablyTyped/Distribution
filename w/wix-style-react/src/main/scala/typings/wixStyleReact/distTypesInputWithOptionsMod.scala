...
object distTypesInputWithOptionsMod {
  
  @JSImport("wix-style-react/dist/types/InputWithOptions", JSImport.Default)
  @js.native
  open class default[ManualInputFn, OnSelectFn, T /* <: InputWithOptionsProps[ManualInputFn, OnSelectFn] */] () extends InputWithOptions[ManualInputFn, OnSelectFn, T]
  
  @js.native
  trait InputWithOptions[ManualInputFn, OnSelectFn, T /* <: InputWithOptionsProps[ManualInputFn, OnSelectFn] */]
  ...
  /* Inlined parent wix-style-react.wix-style-react/dist/types/Input.InputProps */
  /* Inlined parent wix-style-react.wix-style-react/dist/types/common.OmitPolyfill<wix-style-react.wix-style-react/dist/types/DropdownLayout.DropdownLayoutProps, 'onSelect'> */
  trait InputWithOptionsProps[ManualInputFn, OnSelectFn] extends StObject {
    ...
    var onManuallyInput: js.UndefOr[ManualInputFn] = js.undefined
  ...
  object InputWithOptionsProps {
    ...
    inline def apply[ManualInputFn, OnSelectFn](): InputWithOptionsProps[ManualInputFn, OnSelectFn] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InputWithOptionsProps[ManualInputFn, OnSelectFn]]
    }
    
    extension [Self <: InputWithOptionsProps[?, ?], ManualInputFn, OnSelectFn](x: Self & (InputWithOptionsProps[ManualInputFn, OnSelectFn])) {
      ...
      inline def setOnManuallyInput(value: ManualInputFn): Self = StObject.set(x, "onManuallyInput", value.asInstanceOf[js.Any])
  ...
  type ManualInputFnSignature = js.Function2[/* inputValue */ String, /* suggestedOption */ DropdownLayoutValueOption, Unit]
  
  type OnSelectFnSignature = js.UndefOr[
