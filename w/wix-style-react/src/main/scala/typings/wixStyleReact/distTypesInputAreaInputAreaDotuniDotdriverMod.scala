...
object distTypesInputAreaInputAreaDotuniDotdriverMod {
  ...
  object InputAreaUniDriver {
    ...
    inline def apply(
      ...
      getCursorLocation: () => js.Promise[Double],
      getDefaultValue: () => js.Promise[Any],
      getDisabled: () => js.Promise[Boolean],
      getHasCounter: () => js.Promise[Boolean],
      getMaxLength: () => js.Promise[Any],
      getName: () => js.Promise[String | Null],
      getPlaceholder: () => js.Promise[Any],
      getReadOnly: () => js.Promise[Any],
      getRequired: () => js.Promise[Boolean],
      getResizable: () => js.Promise[Boolean],
      getRowsCount: () => js.Promise[Any],
      getStatusMessage: () => js.Promise[String | Null],
      getStyle: () => js.Promise[Any],
      getTabIndex: () => js.Promise[Any],
      getTooltipDataHook: () => String,
      getTooltipElement: () => UniDriver[Any],
      ...
      trigger: (/* keyof wix-style-react.anon.TypeofSimulate */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 68, starting with typings.wixStyleReact.wixStyleReactStrings.compositionStart, typings.wixStyleReact.wixStyleReactStrings.encrypted, typings.wixStyleReact.wixStyleReactStrings.canPlayThrough */ Any, SyntheticEventData) => js.Promise[Unit]
    ): InputAreaUniDriver = {
    ...
    extension [Self <: InputAreaUniDriver](x: Self) {
      ...
      inline def setGetCursorLocation(value: () => js.Promise[Double]): Self = StObject.set(x, "getCursorLocation", js.Any.fromFunction0(value))
      
      inline def setGetDefaultValue(value: () => js.Promise[Any]): Self = StObject.set(x, "getDefaultValue", js.Any.fromFunction0(value))
      ...
      inline def setGetMaxLength(value: () => js.Promise[Any]): Self = StObject.set(x, "getMaxLength", js.Any.fromFunction0(value))
      
      inline def setGetName(value: () => js.Promise[String | Null]): Self = StObject.set(x, "getName", js.Any.fromFunction0(value))
      
      inline def setGetPlaceholder(value: () => js.Promise[Any]): Self = StObject.set(x, "getPlaceholder", js.Any.fromFunction0(value))
      
      inline def setGetReadOnly(value: () => js.Promise[Any]): Self = StObject.set(x, "getReadOnly", js.Any.fromFunction0(value))
      ...
      inline def setGetRowsCount(value: () => js.Promise[Any]): Self = StObject.set(x, "getRowsCount", js.Any.fromFunction0(value))
      ...
      inline def setGetStyle(value: () => js.Promise[Any]): Self = StObject.set(x, "getStyle", js.Any.fromFunction0(value))
      
      inline def setGetTabIndex(value: () => js.Promise[Any]): Self = StObject.set(x, "getTabIndex", js.Any.fromFunction0(value))
      
      inline def setGetTooltipDataHook(value: () => String): Self = StObject.set(x, "getTooltipDataHook", js.Any.fromFunction0(value))
      
      inline def setGetTooltipElement(value: () => UniDriver[Any]): Self = StObject.set(x, "getTooltipElement", js.Any.fromFunction0(value))
      ...
      inline def setTrigger(
        value: (/* keyof wix-style-react.anon.TypeofSimulate */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 68, starting with typings.wixStyleReact.wixStyleReactStrings.compositionStart, typings.wixStyleReact.wixStyleReactStrings.encrypted, typings.wixStyleReact.wixStyleReactStrings.canPlayThrough */ Any, SyntheticEventData) => js.Promise[Unit]
