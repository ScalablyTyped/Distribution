...
object distTypesNumberInputMod {
  ...
  object default {
    ...
    @JSImport("wix-style-react/dist/types/NumberInput", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("wix-style-react/dist/types/NumberInput", "default.defaultProps")
    @js.native
    ...
    @JSImport("wix-style-react/dist/types/NumberInput", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-style-react/dist/types/NumberInput", "default.propTypes")
    @js.native
