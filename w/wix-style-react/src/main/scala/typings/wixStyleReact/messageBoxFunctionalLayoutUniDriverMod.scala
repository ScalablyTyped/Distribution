...
object messageBoxFunctionalLayoutUniDriverMod {
  ...
  object MessageBoxFunctionalLayoutUniDriver {
    ...
    def apply(
      ...
      getCancellationButton: () => js.Promise[UniDriver[js.Any] | Null],
      getCancellationButtonText: () => js.Promise[String],
      getChildBySelector: String => js.Promise[UniDriver[js.Any] | Null],
      getConfirmationButton: () => js.Promise[UniDriver[js.Any] | Null],
      getConfirmationButtonText: () => js.Promise[String],
      getFooter: () => js.Promise[UniDriver[js.Any] | Null],
