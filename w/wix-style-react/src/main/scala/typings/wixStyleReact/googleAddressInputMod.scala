...
object googleAddressInputMod {
  ...
  object GoogleAddressInputProps {
    ...
    extension [Self <: GoogleAddressInputProps](x: Self) {
      ...
      inline def setFilterTypes(value: js.Array[js.Any]): Self = StObject.set(x, "filterTypes", value.asInstanceOf[js.Any])
      
      inline def setFilterTypesUndefined: Self = StObject.set(x, "filterTypes", js.undefined)
      
      inline def setFilterTypesVarargs(value: js.Any*): Self = StObject.set(x, "filterTypes", js.Array(value :_*))
      ...
      inline def setPlaceDetailsFields(value: js.Array[js.Any]): Self = StObject.set(x, "placeDetailsFields", value.asInstanceOf[js.Any])
      
      inline def setPlaceDetailsFieldsUndefined: Self = StObject.set(x, "placeDetailsFields", js.undefined)
      
      inline def setPlaceDetailsFieldsVarargs(value: js.Any*): Self = StObject.set(x, "placeDetailsFields", js.Array(value :_*))
      ...
      inline def setTypes(value: js.Array[js.Any]): Self = StObject.set(x, "types", value.asInstanceOf[js.Any])
      
      inline def setTypesUndefined: Self = StObject.set(x, "types", js.undefined)
      
      inline def setTypesVarargs(value: js.Any*): Self = StObject.set(x, "types", js.Array(value :_*))
