...
object distTypesIconButtonIconButtonDotuniDotdriverMod {
  ...
  object IconButtonUniDriver {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(click = js.Any.fromFunction0(click), element = js.Any.fromFunction0(element), exists = js.Any.fromFunction0(exists), isButtonDisabled = js.Any.fromFunction0(isButtonDisabled), isFocused = js.Any.fromFunction0(isFocused))
