...
object floatingHelperContentUniDriverMod {
  ...
  object FloatingHelperContentUniDriver {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(click = js.Any.fromFunction0(click), clickActionButton = js.Any.fromFunction0(clickActionButton), element = js.Any.fromFunction0(element), exists = js.Any.fromFunction0(exists), getActionButtonText = js.Any.fromFunction0(getActionButtonText), getBodyContent = js.Any.fromFunction0(getBodyContent), getFooter = js.Any.fromFunction0(getFooter), getImage = js.Any.fromFunction0(getImage), getTitleContent = js.Any.fromFunction0(getTitleContent), hasActionButton = js.Any.fromFunction0(hasActionButton), hasBody = js.Any.fromFunction0(hasBody), hasFooter = js.Any.fromFunction0(hasFooter), hasImage = js.Any.fromFunction0(hasImage), hasTitle = js.Any.fromFunction0(hasTitle))
