...
object distTypesCarouselWIPMod {
  ...
  type CarouselWIP = Component[CarouselWIPProps, js.Object, Any]
  ...
  */
  ...
  object CarouselWIPImage {
    ...
    extension [Self <: CarouselWIPImage](x: Self) {
      ...
      inline def setAddEventListener(
        value: (fullscreenchange, /* listener */ js.ThisFunction1[CarouselWIPImage, /* ev */ Event, Any]) => Unit
      ...
      inline def setOnprogress(value: js.ThisFunction1[CarouselWIPImage, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.wixStyleReact.wixStyleReactStrings.`align-to-start`
    - typings.wixStyleReact.wixStyleReactStrings.`reveal-one`
    - typings.wixStyleReact.wixStyleReactStrings.`reveal-chunk`
  */
  trait CarouselWIPSlidingType extends StObject
  object CarouselWIPSlidingType {
    
    inline def `align-to-start`: typings.wixStyleReact.wixStyleReactStrings.`align-to-start` = "align-to-start".asInstanceOf[typings.wixStyleReact.wixStyleReactStrings.`align-to-start`]
    
    inline def `reveal-chunk`: typings.wixStyleReact.wixStyleReactStrings.`reveal-chunk` = "reveal-chunk".asInstanceOf[typings.wixStyleReact.wixStyleReactStrings.`reveal-chunk`]
    
    inline def `reveal-one`: typings.wixStyleReact.wixStyleReactStrings.`reveal-one` = "reveal-one".asInstanceOf[typings.wixStyleReact.wixStyleReactStrings.`reveal-one`]
  }
}
