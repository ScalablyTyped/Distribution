...
trait AriaExpanded extends StObject {
  ...
  var size: js.UndefOr[TextButtonSize] = js.undefined
  
  var skin: js.UndefOr[TextButtonSkin] = js.undefined
  
  var suffixIcon: js.UndefOr[IconElement] = js.undefined
  
  var tooltipProps: js.UndefOr[TooltipCommonProps] = js.undefined
  
  var underline: js.UndefOr[TextButtonUnderline] = js.undefined
  
  var weight: js.UndefOr[TextButtonWeight] = js.undefined
}
object AriaExpanded {
  
  inline def apply(): AriaExpanded = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AriaExpanded]
  }
  
  extension [Self <: AriaExpanded](x: Self) {
