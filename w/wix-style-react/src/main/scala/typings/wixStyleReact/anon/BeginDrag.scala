...
trait BeginDrag extends StObject {
  ...
  def getItemDepth(param0: `13`): js.Promise[Double]
  
  def getItemPosition(param0: `13`): js.Promise[Any]
}
object BeginDrag {
  
  inline def apply(
    beginDrag: `13` => js.Promise[Unit],
    dragOver: Offset => js.Promise[Unit],
    endDrag: Any => js.Promise[Any],
    getItemDepth: `13` => js.Promise[Double],
    getItemPosition: `13` => js.Promise[Any]
  ): BeginDrag = {
  ...
  extension [Self <: BeginDrag](x: Self) {
    ...
    inline def setGetItemDepth(value: `13` => js.Promise[Double]): Self = StObject.set(x, "getItemDepth", js.Any.fromFunction1(value))
    
    inline def setGetItemPosition(value: `13` => js.Promise[Any]): Self = StObject.set(x, "getItemPosition", js.Any.fromFunction1(value))
  }
}
