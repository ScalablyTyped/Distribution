...
/* Inlined std.Partial<wix-style-react.wix-style-react/dist/types/Pagination/PaginationCore/PaginationCore.PaginationCoreProps> */
trait PartialPaginationCoreProp extends StObject {
...
object PartialPaginationCoreProp {
  
  inline def apply(): PartialPaginationCoreProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPaginationCoreProp]
  }
  
  extension [Self <: PartialPaginationCoreProp](x: Self) {
