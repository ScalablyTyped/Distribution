...
/* Inlined wix-style-react.wix-style-react/dist/types/common.OmitPolyfill<std.HTMLElementTagNameMap, 'a' | 'span'> */
trait OmitPolyfillHTMLElementTaAbbr extends StObject {
...
object OmitPolyfillHTMLElementTaAbbr {
