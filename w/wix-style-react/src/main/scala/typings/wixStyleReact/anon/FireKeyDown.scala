...
object FireKeyDown {
  ...
  extension [Self <: FireKeyDown](x: Self) {
    ...
    inline def setBlur(value: () => Any): Self = StObject.set(x, "blur", js.Any.fromFunction0(value))
    ...
    inline def setFocus(value: () => Any): Self = StObject.set(x, "focus", js.Any.fromFunction0(value))
