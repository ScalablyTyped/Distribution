...
trait Exiting extends StObject {
...
object Exiting {
  ...
  inline def apply(entered: HeightLeft, entering: BottomHeight, exited: HeightLeft, exiting: LeftWidth): Exiting = {
    ...
    __obj.asInstanceOf[Exiting]
  }
  
  extension [Self <: Exiting](x: Self) {
