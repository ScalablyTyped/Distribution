...
/* Inlined react.react.WeakValidationMap<wix-style-react.wix-style-react/dist/types/BaseModalLayout/LayoutBlocks/Header.HeaderProps> */
trait WeakValidationMapHeaderPr extends StObject {
  ...
  var titleAppearance: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: null extends wix-style-react.wix-style-react/dist/types/BaseModalLayout/LayoutBlocks/Header/ModalHeading.headingAppearance | undefined ? react.react.Validator<wix-style-react.wix-style-react/dist/types/BaseModalLayout/LayoutBlocks/Header/ModalHeading.headingAppearance | undefined | null | undefined> : undefined extends wix-style-react.wix-style-react/dist/types/BaseModalLayout/LayoutBlocks/Header/ModalHeading.headingAppearance | undefined ? react.react.Validator<wix-style-react.wix-style-react/dist/types/BaseModalLayout/LayoutBlocks/Header/ModalHeading.headingAppearance | undefined | null | undefined> : react.react.Validator<wix-style-react.wix-style-react/dist/types/BaseModalLayout/LayoutBlocks/Header/ModalHeading.headingAppearance | undefined> */ js.Any
  ] = js.undefined
}
object WeakValidationMapHeaderPr {
  
  inline def apply(): WeakValidationMapHeaderPr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapHeaderPr]
  }
  
  extension [Self <: WeakValidationMapHeaderPr](x: Self) {
    ...
    inline def setTitleAppearance(
      value: /* import warning: importer.ImportType#apply Failed type conversion: null extends wix-style-react.wix-style-react/dist/types/BaseModalLayout/LayoutBlocks/Header/ModalHeading.headingAppearance | undefined ? react.react.Validator<wix-style-react.wix-style-react/dist/types/BaseModalLayout/LayoutBlocks/Header/ModalHeading.headingAppearance | undefined | null | undefined> : undefined extends wix-style-react.wix-style-react/dist/types/BaseModalLayout/LayoutBlocks/Header/ModalHeading.headingAppearance | undefined ? react.react.Validator<wix-style-react.wix-style-react/dist/types/BaseModalLayout/LayoutBlocks/Header/ModalHeading.headingAppearance | undefined | null | undefined> : react.react.Validator<wix-style-react.wix-style-react/dist/types/BaseModalLayout/LayoutBlocks/Header/ModalHeading.headingAppearance | undefined> */ js.Any
    ): Self = StObject.set(x, "titleAppearance", value.asInstanceOf[js.Any])
