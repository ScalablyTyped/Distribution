...
object Close {
  ...
  extension [Self <: Close](x: Self) {
    ...
    inline def setClose(value: SyntheticEvent[Element, typings.std.Event] => Unit): Self = StObject.set(x, "close", js.Any.fromFunction1(value))
    
    inline def setDelegateKeyDown(value: KeyboardEvent[Element] => Unit): Self = StObject.set(x, "delegateKeyDown", js.Any.fromFunction1(value))
