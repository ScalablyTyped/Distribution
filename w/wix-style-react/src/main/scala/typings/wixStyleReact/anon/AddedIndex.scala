...
object AddedIndex {
  ...
  @scala.inline
  def apply(addedIndex: Double | String, id: js.Any, item: js.Object, removedIndex: Double | String): AddedIndex = {
  ...
  @scala.inline
  implicit class AddedIndexMutableBuilder[Self <: AddedIndex] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAddedIndex(value: Double | String): Self = StObject.set(x, "addedIndex", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRemovedIndex(value: Double | String): Self = StObject.set(x, "removedIndex", value.asInstanceOf[js.Any])
  }
}
