...
object distTypesTagMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.wixStyleReact.wixStyleReactStrings.lightOutlined
  */
  ...
  object TagTheme {
    ...
    inline def lightOutlined: typings.wixStyleReact.wixStyleReactStrings.lightOutlined = "lightOutlined".asInstanceOf[typings.wixStyleReact.wixStyleReactStrings.lightOutlined]
