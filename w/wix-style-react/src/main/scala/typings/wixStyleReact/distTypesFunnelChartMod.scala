...
object distTypesFunnelChartMod {
  
  @JSImport("wix-style-react/dist/types/FunnelChart", JSImport.Default)
  @js.native
  open class default ()
    extends PureComponent[FunnelChartProps, js.Object, Any]
  
  type FunnelChart = PureComponent[FunnelChartProps, js.Object, Any]
  ...
  trait FunnelChartProps extends StObject {
    ...
    var differenceBadgeTooltipContent: js.UndefOr[js.Function1[/* param0 */ percentageDifferenceCbData, String]] = js.undefined
    
    var hideDifferenceBadge: js.UndefOr[Boolean] = js.undefined
    
    var onDifferenceBadgeTooltipShow: js.UndefOr[js.Function1[/* param0 */ percentageDifferenceCbData, Unit]] = js.undefined
  }
  object FunnelChartProps {
    ...
    extension [Self <: FunnelChartProps](x: Self) {
      ...
      inline def setDataVarargs(value: FunnelChartItem*): Self = StObject.set(x, "data", js.Array(value*))
      
      inline def setDifferenceBadgeTooltipContent(value: /* param0 */ percentageDifferenceCbData => String): Self = StObject.set(x, "differenceBadgeTooltipContent", js.Any.fromFunction1(value))
      ...
      inline def setOnDifferenceBadgeTooltipShow(value: /* param0 */ percentageDifferenceCbData => Unit): Self = StObject.set(x, "onDifferenceBadgeTooltipShow", js.Any.fromFunction1(value))
