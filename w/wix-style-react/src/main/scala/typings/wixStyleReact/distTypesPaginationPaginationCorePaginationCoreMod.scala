...
import typings.wixStyleReact.anon.PageInputHasError
import typings.wixStyleReact.anon.PartialPaginationCoreProp
...
object distTypesPaginationPaginationCorePaginationCoreMod {
  
  @JSImport("wix-style-react/dist/types/Pagination/PaginationCore/PaginationCore", JSImport.Default)
  @js.native
  open class default () extends PaginationCore
  /* static members */
  object default {
    ...
    @JSImport("wix-style-react/dist/types/Pagination/PaginationCore/PaginationCore", "default.defaultProps")
    @js.native
    def defaultProps: PartialPaginationCoreProp = js.native
    inline def defaultProps_=(x: PartialPaginationCoreProp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultProps")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-style-react/dist/types/Pagination/PaginationCore/PaginationCore", "default.displayName")
    @js.native
  ...
  @js.native
  trait PaginationCore extends Component[PaginationCoreProps, PaginationCoreState, Any] {
    
    @JSName("UNSAFE_componentWillReceiveProps")
    def UNSAFE_componentWillReceiveProps_MPaginationCore(nextProps: PaginationCoreProps): Unit = js.native
    
    @JSName("componentDidMount")
    def componentDidMount_MPaginationCore(): Unit = js.native
    
    @JSName("componentDidUpdate")
    def componentDidUpdate_MPaginationCore(): Unit = js.native
    ...
    @JSName("state")
    var state_PaginationCore: PageInputHasError = js.native
    
    /* private */ var updateRootMinWidth: Any = js.native
  }
  
  trait PaginationCoreProps extends StObject {
    ...
    var paginationMode: js.UndefOr[pages | input | compact | PaginationCoreMode] = js.undefined
  ...
  object PaginationCoreProps {
    
    inline def apply(totalPages: Double): PaginationCoreProps = {
      val __obj = js.Dynamic.literal(totalPages = totalPages.asInstanceOf[js.Any])
      __obj.asInstanceOf[PaginationCoreProps]
    }
    
    extension [Self <: PaginationCoreProps](x: Self) {
      ...
      inline def setPaginationMode(value: pages | input | compact | PaginationCoreMode): Self = StObject.set(x, "paginationMode", value.asInstanceOf[js.Any])
  ...
  trait PaginationCoreState extends StObject {
    
    var pageInputHasError: Boolean
    
    var pageInputValue: String
  }
  object PaginationCoreState {
    
    inline def apply(pageInputHasError: Boolean, pageInputValue: String): PaginationCoreState = {
      ...
      __obj.asInstanceOf[PaginationCoreState]
    }
    
    extension [Self <: PaginationCoreState](x: Self) {
