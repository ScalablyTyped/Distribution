...
object segmentedToggleMod {
  ...
  object default {
    ...
    inline def Icon_=(x: Instantiable0[SegmentedToggleIcon]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Icon")(x.asInstanceOf[js.Any])
  }
  ...
  object SegmentedToggleButtonProps {
    ...
    inline def apply(value: (js.UndefOr[String | js.Array[String] | Double]) & js.UndefOr[String]): SegmentedToggleButtonProps = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[SegmentedToggleButtonProps]
    }
    
    extension [Self <: SegmentedToggleButtonProps](x: Self) {
      ...
      inline def setFocusableOnBlur(value: FocusEvent[HTMLButtonElement] => Unit): Self = StObject.set(x, "focusableOnBlur", js.Any.fromFunction1(value))
      
      inline def setFocusableOnBlurUndefined: Self = StObject.set(x, "focusableOnBlur", js.undefined)
      
      inline def setFocusableOnFocus(value: FocusEvent[HTMLButtonElement] => Unit): Self = StObject.set(x, "focusableOnFocus", js.Any.fromFunction1(value))
      ...
      inline def setValue(value: (js.UndefOr[String | js.Array[String] | Double]) & js.UndefOr[String]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
  ...
  object SegmentedToggleIconProps {
    ...
    inline def apply(value: (js.UndefOr[String | js.Array[String] | Double]) & js.UndefOr[String]): SegmentedToggleIconProps = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[SegmentedToggleIconProps]
    }
    
    extension [Self <: SegmentedToggleIconProps](x: Self) {
      ...
      inline def `setData-click`(value: String): Self = StObject.set(x, "data-click", value.asInstanceOf[js.Any])
      
      inline def `setData-clickUndefined`: Self = StObject.set(x, "data-click", js.undefined)
  ...
  object SegmentedToggleProps {
    ...
    inline def apply(children: js.Array[js.Any]): SegmentedToggleProps = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
      __obj.asInstanceOf[SegmentedToggleProps]
    }
    
    extension [Self <: SegmentedToggleProps](x: Self) {
      ...
      inline def setDefaultSelected(value: ReactNode): Self = StObject.set(x, "defaultSelected", value.asInstanceOf[js.Any])
      ...
      inline def setOnClick(value: (/* event */ SyntheticEvent[Element, Event], /* value */ String) => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction2(value))
