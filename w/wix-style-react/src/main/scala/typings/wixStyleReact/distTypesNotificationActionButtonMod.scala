...
import typings.wixStyleReact.anon.Link
...
object distTypesNotificationActionButtonMod {
  ...
  object default {
    ...
    inline def apply(param0: Link): Element = ^.asInstanceOf[js.Dynamic].apply(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
