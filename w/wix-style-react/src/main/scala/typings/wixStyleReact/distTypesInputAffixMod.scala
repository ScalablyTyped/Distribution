...
object distTypesInputAffixMod {
  ...
  object default {
    ...
    @JSImport("wix-style-react/dist/types/Input/Affix", "default.displayName")
    @js.native
    val displayName: String = js.native
    
    object propTypes {
      
      @JSImport("wix-style-react/dist/types/Input/Affix", "default.propTypes.children")
      @js.native
      val children: Requireable[ReactNodeLike] = js.native
      
      @JSImport("wix-style-react/dist/types/Input/Affix", "default.propTypes.value")
      @js.native
