...
object distTypesSelectorListContentMod extends Shortcut {
  ...
  trait SelectorListContentProps extends StObject {
    ...
    var topScrollableContent: js.UndefOr[ReactNode] = js.undefined
  }
  object SelectorListContentProps {
    ...
    inline def apply(
      ...
      loadMore: () => Unit,
      onToggle: SelectorListItem => Unit,
      searchValue: String
    ): SelectorListContentProps = {
      val __obj = js.Dynamic.literal(checkIsSelected = js.Any.fromFunction1(checkIsSelected), items = items.asInstanceOf[js.Any], loadMore = js.Any.fromFunction0(loadMore), onToggle = js.Any.fromFunction1(onToggle), searchValue = searchValue.asInstanceOf[js.Any])
    ...
    extension [Self <: SelectorListContentProps](x: Self) {
      ...
      inline def setOnToggle(value: SelectorListItem => Unit): Self = StObject.set(x, "onToggle", js.Any.fromFunction1(value))
      ...
      inline def setTopScrollableContent(value: ReactNode): Self = StObject.set(x, "topScrollableContent", value.asInstanceOf[js.Any])
