...
import typings.wixStyleReact.anon.BulletedListButtonLabel
import typings.wixStyleReact.anon.ConfirmButtonLabel
...
object distTypesRichTextInputAreaMod {
  ...
  trait RichTextInputAreaProps extends StObject {
    ...
    var texts: js.UndefOr[typings.wixStyleReact.distTypesRichTextInputAreaMod.texts] = js.undefined
  }
