...
object distTypesMultiSelectMod {
  ...
  type MultiSelect = typings.wixStyleReact.distTypesInputWithOptionsMod.default[
    js.Function1[/* values */ js.Array[String], Unit], 
    OnSelectFnSignature, 
    MultiSelectProps
  ]
  ...
  object MultiSelectProps {
    ...
    extension [Self <: MultiSelectProps](x: Self) {
      ...
      inline def setOnManuallyInput(value: /* values */ js.Array[String] => Unit): Self = StObject.set(x, "onManuallyInput", js.Any.fromFunction1(value))
      ...
      inline def setOnRemoveTag(value: /* tagId */ String => Unit): Self = StObject.set(x, "onRemoveTag", js.Any.fromFunction1(value))
      
      inline def setOnRemoveTagUndefined: Self = StObject.set(x, "onRemoveTag", js.undefined)
      
      inline def setOnReorder(value: /* data */ RemovedIndex => Unit): Self = StObject.set(x, "onReorder", js.Any.fromFunction1(value))
