...
import typings.wixStyleReact.anon.FnCallOptions
  ...
  */
  ...
  object TickerProps {
    ...
    extension [Self <: TickerProps](x: Self) {
      ...
      inline def setOnDown(value: MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onDown", js.Any.fromFunction1(value))
      ...
      inline def setOnUp(value: MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onUp", js.Any.fromFunction1(value))
