...
object distTypesSocialPostPreviewSocialPostPreviewMod {
  ...
  object default {
    ...
    @JSImport("wix-style-react/dist/types/SocialPostPreview/SocialPostPreview", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("wix-style-react/dist/types/SocialPostPreview/SocialPostPreview", "default.defaultProps")
    @js.native
    ...
    @JSImport("wix-style-react/dist/types/SocialPostPreview/SocialPostPreview", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("wix-style-react/dist/types/SocialPostPreview/SocialPostPreview", "default.propTypes")
    @js.native
