...
object searchMod {
  ...
  @JSImport("wix-style-react/dist/es/src/Search", JSImport.Default)
  @js.native
  class default ()
  ...
  object SearchProps {
    ...
    implicit class SearchPropsMutableBuilder[Self <: SearchProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setExpandWidth(value: String | Double): Self = StObject.set(x, "expandWidth", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setExpandWidthUndefined: Self = StObject.set(x, "expandWidth", js.undefined)
