...
object dropdownLayoutMod {
  ...
  */
  ...
  object DropdownLayoutOption {
    ...
    inline def DropdownLayoutDividerOption(): typings.wixStyleReact.dropdownLayoutMod.DropdownLayoutDividerOption = {
      val __obj = js.Dynamic.literal(value = "-")
      __obj.asInstanceOf[typings.wixStyleReact.dropdownLayoutMod.DropdownLayoutDividerOption]
    }
    
    inline def DropdownLayoutValueOption(id: String | Double): typings.wixStyleReact.dropdownLayoutMod.DropdownLayoutValueOption = {
  ...
  object DropdownLayoutValueOption {
    ...
    extension [Self <: DropdownLayoutValueOption](x: Self) {
      ...
      inline def setValueFunction1(value: /* options */ Hovered => Element): Self = StObject.set(x, "value", js.Any.fromFunction1(value))
