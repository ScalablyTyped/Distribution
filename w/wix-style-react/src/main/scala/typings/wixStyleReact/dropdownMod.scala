...
object dropdownMod {
  ...
  */
  ...
  object DropdownProps {
    ...
    inline def DropdownPropsControlled(): typings.wixStyleReact.dropdownMod.DropdownPropsControlled = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.wixStyleReact.dropdownMod.DropdownPropsControlled]
    }
    
    inline def DropdownPropsUncontrolled(): typings.wixStyleReact.dropdownMod.DropdownPropsUncontrolled = {
      val __obj = js.Dynamic.literal()
