...
object dropdownMod {
  ...
  @JSImport("wix-style-react/dist/es/src/Dropdown", JSImport.Default)
  @js.native
  class default ()
    extends typings.wixStyleReact.inputWithOptionsMod.default[ManualInputFnSignature, OnSelectFnSignature, DropdownProps]
  
  type Dropdown = typings.wixStyleReact.inputWithOptionsMod.default[ManualInputFnSignature, OnSelectFnSignature, DropdownProps]
  
  /* Rewritten from type alias, can be one of: 
    - typings.wixStyleReact.dropdownMod.DropdownPropsControlled
    - typings.wixStyleReact.dropdownMod.DropdownPropsUncontrolled
  */
  trait DropdownProps extends StObject
  object DropdownProps {
    
    @scala.inline
    def DropdownPropsControlled(): typings.wixStyleReact.dropdownMod.DropdownPropsControlled = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.wixStyleReact.dropdownMod.DropdownPropsControlled]
    }
    
    @scala.inline
    def DropdownPropsUncontrolled(): typings.wixStyleReact.dropdownMod.DropdownPropsUncontrolled = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.wixStyleReact.dropdownMod.DropdownPropsUncontrolled]
    }
  }
  ...
  object DropdownPropsControlled {
    ...
    @scala.inline
    def apply(): DropdownPropsControlled = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DropdownPropsControlled]
    }
    
    @scala.inline
    implicit class DropdownPropsControlledMutableBuilder[Self <: DropdownPropsControlled] (val x: Self) extends AnyVal {
  ...
  object DropdownPropsUncontrolled {
    ...
    @scala.inline
    def apply(): DropdownPropsUncontrolled = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DropdownPropsUncontrolled]
    }
    
    @scala.inline
    implicit class DropdownPropsUncontrolledMutableBuilder[Self <: DropdownPropsUncontrolled] (val x: Self) extends AnyVal {
