...
object distTypesPopoverPopoverCoreUtilsGetPopoverTestUtilsMod {
  
  object getPopoverTestUtils {
    
    @JSImport("wix-style-react/dist/types/Popover/PopoverCore/utils/getPopoverTestUtils", "getPopoverTestUtils")
    @js.native
