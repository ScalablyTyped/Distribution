...
object emptyStateDriverMod {
  ...
  object EmptyStateDriver {
    ...
    @scala.inline
    implicit class EmptyStateDriverMutableBuilder[Self <: EmptyStateDriver] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setChildrenContentExists(value: () => Boolean): Self = StObject.set(x, "childrenContentExists", js.Any.fromFunction0(value))
      
      @scala.inline
      def setElement(value: () => HTMLElement): Self = StObject.set(x, "element", js.Any.fromFunction0(value))
      
      @scala.inline
      def setGetImageContainerClassName(value: () => String): Self = StObject.set(x, "getImageContainerClassName", js.Any.fromFunction0(value))
      
      @scala.inline
      def setGetImageUrl(value: () => String): Self = StObject.set(x, "getImageUrl", js.Any.fromFunction0(value))
      
      @scala.inline
      def setGetSubtitleText(value: () => String): Self = StObject.set(x, "getSubtitleText", js.Any.fromFunction0(value))
      
      @scala.inline
      def setGetTitleText(value: () => String): Self = StObject.set(x, "getTitleText", js.Any.fromFunction0(value))
      
      @scala.inline
      def setHasAlign(value: EmptyStateAlign => Boolean): Self = StObject.set(x, "hasAlign", js.Any.fromFunction1(value))
      
      @scala.inline
      def setHasTheme(value: EmptyStateTheme => Boolean): Self = StObject.set(x, "hasTheme", js.Any.fromFunction1(value))
      
      @scala.inline
      def setImageNodeExists(value: () => Boolean): Self = StObject.set(x, "imageNodeExists", js.Any.fromFunction0(value))
    }
  }
}
