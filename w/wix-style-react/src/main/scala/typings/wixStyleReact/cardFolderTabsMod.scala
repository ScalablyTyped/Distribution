...
object cardFolderTabsMod {
  ...
  object CardFolderTabsProps {
    ...
    @scala.inline
    def apply(activeId: String): CardFolderTabsProps = {
      val __obj = js.Dynamic.literal(activeId = activeId.asInstanceOf[js.Any])
      __obj.asInstanceOf[CardFolderTabsProps]
    }
    
    @scala.inline
    implicit class CardFolderTabsPropsMutableBuilder[Self <: CardFolderTabsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMaxTabWidth(value: MaxWidthProperty[String | Double]): Self = StObject.set(x, "maxTabWidth", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMaxTabWidthUndefined: Self = StObject.set(x, "maxTabWidth", js.undefined)
      
      @scala.inline
      def setOnTabChange(value: /* newActiveId */ String => Unit): Self = StObject.set(x, "onTabChange", js.Any.fromFunction1(value))
