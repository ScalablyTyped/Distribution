...
object distTypesSearchMod {
  
  @JSImport("wix-style-react/dist/types/Search", JSImport.Default)
  @js.native
  ...
  trait Search
    ...
    def clear(event: ChangeEvent[HTMLInputElement]): Unit = js.native
  ...
  trait SearchProps extends StObject {
    ...
    var expandWidth: js.UndefOr[String | Double] = js.undefined
  ...
  object SearchProps {
    ...
    extension [Self <: SearchProps](x: Self) {
      ...
      inline def setExpandWidth(value: String | Double): Self = StObject.set(x, "expandWidth", value.asInstanceOf[js.Any])
