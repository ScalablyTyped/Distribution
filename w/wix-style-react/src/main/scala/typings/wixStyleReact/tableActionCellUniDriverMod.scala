...
object tableActionCellUniDriverMod {
  ...
  object TableActionCellUniDriver {
    ...
    extension [Self <: TableActionCellUniDriver](x: Self) {
      ...
      inline def setGetVisibleActionByDataHookTooltipDriver(value: String => js.Promise[ReturnType[js.Function1[/* args */ js.Any, GetElementId]]]): Self = StObject.set(x, "getVisibleActionByDataHookTooltipDriver", js.Any.fromFunction1(value))
      
      inline def setGetVisibleActionTooltipDriver(value: Double => js.Promise[ReturnType[js.Function1[/* args */ js.Any, GetElementId]]]): Self = StObject.set(x, "getVisibleActionTooltipDriver", js.Any.fromFunction1(value))
