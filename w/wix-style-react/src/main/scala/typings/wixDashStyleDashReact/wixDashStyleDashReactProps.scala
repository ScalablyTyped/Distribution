...
trait wixDashStyleDashReactProps {
  ...
  @scala.inline
  def LoaderProps: typings.wixDashStyleDashReact.loaderMod.LoaderProps.type = typings.wixDashStyleDashReact.loaderMod.LoaderProps
  type LoaderProps = typings.wixDashStyleDashReact.loaderMod.LoaderProps
  @scala.inline
