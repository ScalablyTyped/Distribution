...
object Result {
  @scala.inline
  def apply[/* <: typings.write.mod.Data */ T](data: T, path: String): Result[T] = {
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
    __obj.asInstanceOf[Result[T]]
  }
  @scala.inline
  implicit class ResultOps[Self <: Result[_], /* <: typings.write.mod.Data */ T] (val x: Self with Result[T]) extends AnyVal {
    @scala.inline
