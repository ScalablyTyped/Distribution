...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.wechatMiniprogram.wechatMiniprogramStrings.update
  - typings.wechatMiniprogram.wechatMiniprogramStrings.replace
  - typings.wechatMiniprogram.wechatMiniprogramStrings.add
