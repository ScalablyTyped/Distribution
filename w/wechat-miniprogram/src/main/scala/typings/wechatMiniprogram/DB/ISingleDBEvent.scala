...
object ISingleDBEvent {
  ...
  inline def apply(dataType: DataType, doc: Record[String, js.Any], docId: String, id: Double, queueType: QueueType): ISingleDBEvent = {
  ...
  extension [Self <: ISingleDBEvent](x: Self) {
    ...
    inline def setDoc(value: Record[String, js.Any]): Self = StObject.set(x, "doc", value.asInstanceOf[js.Any])
