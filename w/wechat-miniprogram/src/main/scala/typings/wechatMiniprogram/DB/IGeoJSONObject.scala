...
object IGeoJSONObject {
  ...
  @scala.inline
  def IGeoJSONLineString(coordinates: js.Array[js.Tuple2[Double, Double]]): typings.wechatMiniprogram.DB.IGeoJSONLineString = {
  ...
  @scala.inline
  def IGeoJSONMultiLineString(coordinates: js.Array[js.Array[js.Tuple2[Double, Double]]]): typings.wechatMiniprogram.DB.IGeoJSONMultiLineString = {
    val __obj = js.Dynamic.literal(coordinates = coordinates.asInstanceOf[js.Any])
  ...
  @scala.inline
  def IGeoJSONMultiPoint(coordinates: js.Array[js.Tuple2[Double, Double]]): typings.wechatMiniprogram.DB.IGeoJSONMultiPoint = {
    val __obj = js.Dynamic.literal(coordinates = coordinates.asInstanceOf[js.Any])
  ...
  @scala.inline
  def IGeoJSONMultiPolygon(coordinates: js.Array[js.Array[js.Array[js.Tuple2[Double, Double]]]]): typings.wechatMiniprogram.DB.IGeoJSONMultiPolygon = {
    val __obj = js.Dynamic.literal(coordinates = coordinates.asInstanceOf[js.Any])
  ...
  @scala.inline
  def IGeoJSONPoint(coordinates: js.Tuple2[Double, Double]): typings.wechatMiniprogram.DB.IGeoJSONPoint = {
    val __obj = js.Dynamic.literal(coordinates = coordinates.asInstanceOf[js.Any])
  ...
  @scala.inline
  def IGeoJSONPolygon(coordinates: js.Array[js.Array[js.Tuple2[Double, Double]]]): typings.wechatMiniprogram.DB.IGeoJSONPolygon = {
    val __obj = js.Dynamic.literal(coordinates = coordinates.asInstanceOf[js.Any])
