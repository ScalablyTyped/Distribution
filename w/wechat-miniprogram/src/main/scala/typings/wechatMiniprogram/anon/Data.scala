...
object Data {
  @scala.inline
  def apply[/* <: typings.wechatMiniprogram.WechatMiniprogram.Component.DataOption */ TData, /* <: typings.wechatMiniprogram.WechatMiniprogram.Component.PropertyOption */ TProperty](
  ...
  @scala.inline
  implicit class DataOps[Self <: Data[_, _], /* <: typings.wechatMiniprogram.WechatMiniprogram.Component.DataOption */ TData, /* <: typings.wechatMiniprogram.WechatMiniprogram.Component.PropertyOption */ TProperty] (val x: Self with (Data[TData, TProperty])) extends AnyVal {
    @scala.inline
