...
object OptionalRecordcompletesuc {
  ...
  extension [Self <: OptionalRecordcompletesuc](x: Self) {
    ...
    inline def setComplete(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "complete", js.Any.fromFunction1(value))
    
    inline def setCompleteUndefined: Self = StObject.set(x, "complete", js.undefined)
    
    inline def setFail(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "fail", js.Any.fromFunction1(value))
    
    inline def setFailUndefined: Self = StObject.set(x, "fail", js.undefined)
    
    inline def setSuccess(value: /* repeated */ js.Any => js.Any): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
