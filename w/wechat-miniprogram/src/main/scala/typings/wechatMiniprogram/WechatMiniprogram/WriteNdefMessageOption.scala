...
object WriteNdefMessageOption {
  ...
  extension [Self <: WriteNdefMessageOption](x: Self) {
    ...
    inline def setRecords(value: js.Array[js.Any]): Self = StObject.set(x, "records", value.asInstanceOf[js.Any])
    
    inline def setRecordsUndefined: Self = StObject.set(x, "records", js.undefined)
    
    inline def setRecordsVarargs(value: js.Any*): Self = StObject.set(x, "records", js.Array(value :_*))
    
    inline def setSuccess(value: /* res */ GeneralCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
    
    inline def setSuccessUndefined: Self = StObject.set(x, "success", js.undefined)
    
    inline def setTexts(value: js.Array[js.Any]): Self = StObject.set(x, "texts", value.asInstanceOf[js.Any])
    
    inline def setTextsUndefined: Self = StObject.set(x, "texts", js.undefined)
    
    inline def setTextsVarargs(value: js.Any*): Self = StObject.set(x, "texts", js.Array(value :_*))
    
    inline def setUris(value: js.Array[js.Any]): Self = StObject.set(x, "uris", value.asInstanceOf[js.Any])
    
    inline def setUrisUndefined: Self = StObject.set(x, "uris", js.undefined)
    
    inline def setUrisVarargs(value: js.Any*): Self = StObject.set(x, "uris", js.Array(value :_*))
  }
}
