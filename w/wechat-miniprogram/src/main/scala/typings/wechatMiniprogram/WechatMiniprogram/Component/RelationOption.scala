...
@js.native
trait RelationOption extends js.Object {
...
object RelationOption {
  ...
  @scala.inline
  implicit class RelationOptionOps[Self <: RelationOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLinkChanged(value: /* target */ TrivialInstance => Unit): Self = this.set("linkChanged", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteLinkChanged: Self = this.set("linkChanged", js.undefined)
    
    @scala.inline
    def setLinked(value: /* target */ TrivialInstance => Unit): Self = this.set("linked", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setUnlinked(value: /* target */ TrivialInstance => Unit): Self = this.set("unlinked", js.Any.fromFunction1(value))
