...
object GetClipboardDataOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetClipboardDataOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* option */ GetClipboardDataSuccessCallbackOption => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
