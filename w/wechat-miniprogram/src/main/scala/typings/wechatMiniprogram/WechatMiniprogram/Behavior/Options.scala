...
object Options {
  @scala.inline
  def apply[/* <: typings.wechatMiniprogram.WechatMiniprogram.Behavior.DataOption */ TData, /* <: typings.wechatMiniprogram.WechatMiniprogram.Behavior.PropertyOption */ TProperty, /* <: typings.wechatMiniprogram.WechatMiniprogram.Behavior.MethodOption */ TMethod](): Options[TData, TProperty, TMethod] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[TData, TProperty, TMethod]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_, _, _], /* <: typings.wechatMiniprogram.WechatMiniprogram.Behavior.DataOption */ TData, /* <: typings.wechatMiniprogram.WechatMiniprogram.Behavior.PropertyOption */ TProperty, /* <: typings.wechatMiniprogram.WechatMiniprogram.Behavior.MethodOption */ TMethod] (val x: Self with (Options[TData, TProperty, TMethod])) extends AnyVal {
    @scala.inline
