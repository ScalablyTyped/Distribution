...
object NavigateToOption {
  ...
  implicit class NavigateToOptionOps[Self <: NavigateToOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEvents(value: IAnyObject): Self = this.set("events", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSuccess(value: /* result */ NavigateToSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
    @scala.inline
