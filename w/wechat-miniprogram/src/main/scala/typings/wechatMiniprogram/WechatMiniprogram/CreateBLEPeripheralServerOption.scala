...
object CreateBLEPeripheralServerOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateBLEPeripheralServerOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ CreateBLEPeripheralServerSuccessCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
