...
@js.native
trait GetStorageInfoOption extends js.Object {
...
object GetStorageInfoOption {
  ...
  @scala.inline
  implicit class GetStorageInfoOptionOps[Self <: GetStorageInfoOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* option */ GetStorageInfoSuccessCallbackOption => Unit): Self = this.set("success", js.Any.fromFunction1(value))
