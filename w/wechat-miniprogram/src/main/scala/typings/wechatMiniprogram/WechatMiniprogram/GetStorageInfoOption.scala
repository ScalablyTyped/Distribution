...
object GetStorageInfoOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetStorageInfoOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* option */ GetStorageInfoSuccessCallbackOption => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
