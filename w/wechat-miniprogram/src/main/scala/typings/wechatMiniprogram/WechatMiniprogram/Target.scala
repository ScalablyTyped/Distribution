...
object Target {
  ...
  inline def apply[DataSet /* <: IAnyObject */](dataset: DataSet, id: String, offsetLeft: Double, offsetTop: Double): Target[DataSet] = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Target[?], DataSet /* <: IAnyObject */] (val x: Self & Target[DataSet]) extends AnyVal {
