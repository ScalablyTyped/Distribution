...
object ReaddirOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ReaddirOption] (val x: Self) extends AnyVal {
    ...
    inline def setFail(value: /* result */ ReaddirFailCallbackResult => Unit): Self = StObject.set(x, "fail", js.Any.fromFunction1(value))
    
    inline def setFailUndefined: Self = StObject.set(x, "fail", js.undefined)
    
    inline def setSuccess(value: /* result */ ReaddirSuccessCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
