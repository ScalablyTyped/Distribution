...
object GetSelectionTextOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSelectionTextOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ GetSelectionTextSuccessCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
