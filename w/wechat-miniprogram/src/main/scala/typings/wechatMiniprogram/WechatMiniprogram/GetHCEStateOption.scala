...
trait GetHCEStateOption extends StObject {
  ...
  var complete: js.UndefOr[GetHCEStateCompleteCallback] = js.undefined
  
  /** 接口调用失败的回调函数 */
  var fail: js.UndefOr[GetHCEStateFailCallback] = js.undefined
  
  /** 接口调用成功的回调函数 */
  var success: js.UndefOr[GetHCEStateSuccessCallback] = js.undefined
}
object GetHCEStateOption {
  
  inline def apply(): GetHCEStateOption = {
