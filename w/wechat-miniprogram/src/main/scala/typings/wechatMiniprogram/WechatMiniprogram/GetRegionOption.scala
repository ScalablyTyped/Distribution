...
object GetRegionOption {
  ...
  @scala.inline
  implicit class GetRegionOptionOps[Self <: GetRegionOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* result */ GetRegionSuccessCallbackResult => Unit): Self = this.set("success", js.Any.fromFunction1(value))
