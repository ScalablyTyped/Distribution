...
object GetRegionOption {
  ...
  inline def apply(): GetRegionOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetRegionOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetRegionOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ GetRegionSuccessCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
