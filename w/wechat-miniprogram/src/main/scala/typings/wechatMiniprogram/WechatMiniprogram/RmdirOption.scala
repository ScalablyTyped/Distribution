...
object RmdirOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RmdirOption] (val x: Self) extends AnyVal {
    ...
    inline def setFail(value: /* result */ RmdirFailCallbackResult => Unit): Self = StObject.set(x, "fail", js.Any.fromFunction1(value))
