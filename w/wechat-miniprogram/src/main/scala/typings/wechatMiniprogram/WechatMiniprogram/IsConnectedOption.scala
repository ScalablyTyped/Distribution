...
trait IsConnectedOption extends StObject {
  
  /** 接口调用结束的回调函数（调用成功、失败都会执行） */
  var complete: js.UndefOr[IsConnectedCompleteCallback] = js.undefined
  
  /** 接口调用失败的回调函数 */
  var fail: js.UndefOr[IsConnectedFailCallback] = js.undefined
  
  /** 接口调用成功的回调函数 */
  var success: js.UndefOr[IsConnectedSuccessCallback] = js.undefined
}
object IsConnectedOption {
  
  inline def apply(): IsConnectedOption = {
