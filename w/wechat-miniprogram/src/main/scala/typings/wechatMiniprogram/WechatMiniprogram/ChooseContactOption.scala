...
object ChooseContactOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ChooseContactOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* option */ ChooseContactSuccessCallbackOption => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
