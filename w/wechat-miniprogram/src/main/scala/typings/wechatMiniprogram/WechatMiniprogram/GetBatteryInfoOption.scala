...
object GetBatteryInfoOption {
  ...
  inline def apply(): GetBatteryInfoOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetBatteryInfoOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetBatteryInfoOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ GetBatteryInfoSuccessCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
