...
@js.native
trait RemoveMarkersOption extends js.Object {
...
object RemoveMarkersOption {
  ...
  @scala.inline
  implicit class RemoveMarkersOptionOps[Self <: RemoveMarkersOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMarkerIdsVarargs(value: js.Any*): Self = this.set("markerIds", js.Array(value :_*))
    
    @scala.inline
    def setMarkerIds(value: js.Array[_]): Self = this.set("markerIds", value.asInstanceOf[js.Any])
