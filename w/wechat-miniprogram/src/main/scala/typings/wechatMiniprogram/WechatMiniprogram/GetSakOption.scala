...
object GetSakOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSakOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ GetSakSuccessCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
