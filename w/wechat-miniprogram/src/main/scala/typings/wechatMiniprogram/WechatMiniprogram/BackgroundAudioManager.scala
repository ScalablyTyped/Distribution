...
object BackgroundAudioManager {
  ...
  implicit open class MutableBuilder[Self <: BackgroundAudioManager] (val x: Self) extends AnyVal {
    ...
    inline def setOnCanplay(value: OnCanplayCallback => Unit): Self = StObject.set(x, "onCanplay", js.Any.fromFunction1(value))
    
    inline def setOnEnded(value: OnEndedCallback => Unit): Self = StObject.set(x, "onEnded", js.Any.fromFunction1(value))
    ...
    inline def setOnPlay(value: OnPlayCallback => Unit): Self = StObject.set(x, "onPlay", js.Any.fromFunction1(value))
    
    inline def setOnPrev(value: OnPrevCallback => Unit): Self = StObject.set(x, "onPrev", js.Any.fromFunction1(value))
    
    inline def setOnSeeked(value: OnSeekedCallback => Unit): Self = StObject.set(x, "onSeeked", js.Any.fromFunction1(value))
    
    inline def setOnSeeking(value: OnSeekingCallback => Unit): Self = StObject.set(x, "onSeeking", js.Any.fromFunction1(value))
    
    inline def setOnStop(value: InnerAudioContextOnStopCallback => Unit): Self = StObject.set(x, "onStop", js.Any.fromFunction1(value))
    
    inline def setOnTimeUpdate(value: OnTimeUpdateCallback => Unit): Self = StObject.set(x, "onTimeUpdate", js.Any.fromFunction1(value))
    
    inline def setOnWaiting(value: OnWaitingCallback => Unit): Self = StObject.set(x, "onWaiting", js.Any.fromFunction1(value))
