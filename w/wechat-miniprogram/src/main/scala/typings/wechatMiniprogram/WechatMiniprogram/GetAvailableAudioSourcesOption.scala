...
object GetAvailableAudioSourcesOption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetAvailableAudioSourcesOption] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: /* result */ GetAvailableAudioSourcesSuccessCallbackResult => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
