...
object playheadMod {
  ...
  open class default protected () extends PlayheadPlugin {
    def this(params: PlayheadPluginParams, ws: typings.wavesurferJs.wavesurferMod.default) = this()
  }
  /* static members */
  object default {
  ...
  trait PlayheadPlugin
    ...
    val unFuns: js.Array[js.ThisFunction0[/* this */ typings.wavesurferJs.wavesurferMod.default, Unit]] = js.native
