...
object minimapMod {
  ...
  open class default protected () extends MinimapPlugin {
    def this(params: MinimapPluginParams, ws: typings.wavesurferJs.wavesurferMod.default) = this()
  }
  /* static members */
  object default {
  ...
  trait MinimapPlugin
    ...
    val regionsPlugin: typings.wavesurferJs.regionsMod.default | Null = js.native
