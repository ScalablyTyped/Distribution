...
object anon {
  ...
  /* n */ NumberDictionary[RGBA] {
    ...
    def findLast(predicate: js.Function3[/* value */ RGBA, /* index */ Double, /* array */ js.Array[RGBA], Any]): js.UndefOr[RGBA] = js.native
    def findLast(
      predicate: js.Function3[/* value */ RGBA, /* index */ Double, /* array */ js.Array[RGBA], Any],
      thisArg: Any
    ): js.UndefOr[RGBA] = js.native
    ...
    /**
      ...
      */
    /* standard es2023.array */
    def findLastIndex(predicate: js.Function3[/* value */ RGBA, /* index */ Double, /* array */ js.Array[RGBA], Any]): Double = js.native
    def findLastIndex(
      predicate: js.Function3[/* value */ RGBA, /* index */ Double, /* array */ js.Array[RGBA], Any],
      thisArg: Any
    ): Double = js.native
    ...
    @JSName("find")
    def find_S[S /* <: RGBA */](
      predicate: js.Function3[/* value */ RGBA, /* index */ Double, /* obj */ js.Array[RGBA], /* is S */ Boolean]
    ): js.UndefOr[S] = js.native
    @JSName("find")
    def find_S[S /* <: RGBA */](
      predicate: js.Function3[/* value */ RGBA, /* index */ Double, /* obj */ js.Array[RGBA], /* is S */ Boolean],
