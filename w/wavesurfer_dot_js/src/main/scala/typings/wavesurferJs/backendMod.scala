...
object backendMod {
  ...
  @js.native
  abstract class WebAudioBackend protected () extends default {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.wavesurferJs.webaudioMod.default
    - typings.wavesurferJs.mediaelementMod.default
    - typings.wavesurferJs.mediaelementWebaudioMod.default
  */
