...
object srcDrawerDotmulticanvasMod {
  ...
  @js.native
  trait MultiCanvas
    extends typings.wavesurferJs.srcDrawerMod.default {
    
    /** Class used to generate entries. */
    val EntryClass: Instantiable0[typings.wavesurferJs.srcDrawerDotcanvasentryMod.default] = js.native
    
    /** Add a canvas to the canvas list. */
    def addCanvas(): Unit = js.native
    
    /** Set the canvas transforms for a certain entry (wave and progress). */
    def applyCanvasTransforms(entry: typings.wavesurferJs.srcDrawerDotcanvasentryMod.default, vertical: Boolean): Unit = js.native
    ...
    val canvases: js.Array[typings.wavesurferJs.srcDrawerDotcanvasentryMod.default] = js.native
    ...
    def setFillStyles(
      entry: typings.wavesurferJs.srcDrawerDotcanvasentryMod.default,
      waveColor: String,
    ...
    def updateDimensions(entry: typings.wavesurferJs.srcDrawerDotcanvasentryMod.default, width: Double, heihgt: Double): Unit = js.native
