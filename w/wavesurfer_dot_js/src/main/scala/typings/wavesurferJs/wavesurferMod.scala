...
object wavesurferMod {
  ...
  trait WaveSurfer
    ...
    var cursor: typings.wavesurferJs.cursorMod.default = js.native
    ...
    var elan: typings.wavesurferJs.elanMod.default = js.native
    ...
    var markers: typings.wavesurferJs.markersMod.default = js.native
    
    /** Only available in WaveSurfer instances with MediaSessionPlugin. */
    var mediasession: typings.wavesurferJs.mediasessionMod.default = js.native
    
    /** Only available in WaveSurfer instances with MicrophonePlugin. */
    var microphone: typings.wavesurferJs.microphoneMod.default = js.native
    
    /** Only available in WaveSurfer instances with MinimapPlugin. */
    var minimap: typings.wavesurferJs.minimapMod.default = js.native
    ...
    var playhead: typings.wavesurferJs.playheadMod.default = js.native
    
    /** Only available in WaveSurfer instances with RegionsPlugin. */
    var regions: typings.wavesurferJs.regionsMod.default = js.native
    ...
    var spectrogram: typings.wavesurferJs.spectrogramMod.default = js.native
    
    def stop(): Unit = js.native
    
    /** Only available in WaveSurfer instances with TimelinePlugin. */
    var timeline: typings.wavesurferJs.timelineMod.default = js.native
