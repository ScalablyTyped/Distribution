...
object srcPluginRegionsMod {
  
  @JSImport("wavesurfer.js/src/plugin/regions", JSImport.Default)
  @js.native
  open class default protected () extends RegionsPlugin {
    def this(params: RegionsPluginParams, ws: typings.wavesurferJs.srcWavesurferMod.default) = this()
  }
  /* static members */
  object default {
  ...
  open class Region protected ()
    ...
    def this(
      ...
      ws: typings.wavesurferJs.srcWavesurferMod.default
    ) = this()
  ...
  object WavesurferAugmentingMod {
    ...
    trait WaveSurfer extends StObject {
      ...
      def addRegion(regionParams: RegionParams): Unit
      
      def clearRegions(): Unit
      
      def enableDragSelection(options: RegionParams): Unit
    }
    object WaveSurfer {
      
      inline def apply(
        addRegion: RegionParams => Unit,
        clearRegions: () => Unit,
        enableDragSelection: RegionParams => Unit
      ): WaveSurfer = {
        val __obj = js.Dynamic.literal(addRegion = js.Any.fromFunction1(addRegion), clearRegions = js.Any.fromFunction0(clearRegions), enableDragSelection = js.Any.fromFunction1(enableDragSelection))
      ...
      extension [Self <: WaveSurfer](x: Self) {
        ...
        inline def setClearRegions(value: () => Unit): Self = StObject.set(x, "clearRegions", js.Any.fromFunction0(value))
        
        inline def setEnableDragSelection(value: RegionParams => Unit): Self = StObject.set(x, "enableDragSelection", js.Any.fromFunction1(value))
      }
    }
  }
}
