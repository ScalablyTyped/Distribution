...
object webclLibNumbers {
  @js.native
  sealed trait `-1`
    extends webclLib.WEBCLNs.BuildStatus
       with webclLib.WEBCLNs.ErrorCodes
  ...
  sealed trait `0`
    extends webclLib.WEBCLNs.Bool
       with webclLib.WEBCLNs.BuildStatus
       with webclLib.WEBCLNs.ErrorCodes
  
  @js.native
  sealed trait `0x0`
    extends webclLib.WEBCLNs.CommandExecutionStatus
       with webclLib.WEBCLNs.DeviceMemCacheType
  ...
  sealed trait `0x1`
    extends webclLib.WEBCLNs.CommandExecutionStatus
       with webclLib.WEBCLNs.CommandQueueProperties
       with webclLib.WEBCLNs.DeviceFPConfigBits
       with webclLib.WEBCLNs.DeviceLocalMemType
       with webclLib.WEBCLNs.DeviceMemCacheType
       with webclLib.WEBCLNs.DeviceTypeBits
       with webclLib.WEBCLNs.MemFlagsBits
