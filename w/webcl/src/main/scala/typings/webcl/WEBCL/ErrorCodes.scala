...
object ErrorCodes {
  ...
  inline def BUILD_PROGRAM_FAILURE: `-11` = -11.asInstanceOf[`-11`]
  
  inline def COMPILER_NOT_AVAILABLE: `-3` = -3.asInstanceOf[`-3`]
  
  inline def DEVICE_NOT_AVAILABLE: `-2` = -2.asInstanceOf[`-2`]
  
  inline def DEVICE_NOT_FOUND: `-1` = -1.asInstanceOf[`-1`]
  
  inline def EXEC_STATUS_ERROR_FOR_EVENTS_IN_WAIT_LIST: `-14` = -14.asInstanceOf[`-14`]
  
  inline def IMAGE_FORMAT_MISMATCH: `-9` = -9.asInstanceOf[`-9`]
  
  inline def IMAGE_FORMAT_NOT_SUPPORTED: `-10` = -10.asInstanceOf[`-10`]
  
  inline def INVALID_ARG_INDEX: `-49` = -49.asInstanceOf[`-49`]
  
  inline def INVALID_ARG_SIZE: `-51` = -51.asInstanceOf[`-51`]
  
  inline def INVALID_ARG_VALUE: `-50` = -50.asInstanceOf[`-50`]
  
  inline def INVALID_BINARY: `-42` = -42.asInstanceOf[`-42`]
  
  //INVALID_GL_OBJECT                         = -60, // moved to extension
  inline def INVALID_BUFFER_SIZE: `-61` = -61.asInstanceOf[`-61`]
  
  inline def INVALID_BUILD_OPTIONS: `-43` = -43.asInstanceOf[`-43`]
  
  inline def INVALID_COMMAND_QUEUE: `-36` = -36.asInstanceOf[`-36`]
  
  inline def INVALID_CONTEXT: `-34` = -34.asInstanceOf[`-34`]
  
  inline def INVALID_DEVICE: `-33` = -33.asInstanceOf[`-33`]
  
  inline def INVALID_DEVICE_TYPE: `-31` = -31.asInstanceOf[`-31`]
  
  inline def INVALID_EVENT: `-58` = -58.asInstanceOf[`-58`]
  
  inline def INVALID_EVENT_WAIT_LIST: `-57` = -57.asInstanceOf[`-57`]
  
  inline def INVALID_GLOBAL_OFFSET: `-56` = -56.asInstanceOf[`-56`]
  
  //INVALID_MIP_LEVEL                         = -62, // moved to extension
  inline def INVALID_GLOBAL_WORK_SIZE: `-63` = -63.asInstanceOf[`-63`]
  
  inline def INVALID_HOST_PTR: `-37` = -37.asInstanceOf[`-37`]
  
  inline def INVALID_IMAGE_FORMAT_DESCRIPTOR: `-39` = -39.asInstanceOf[`-39`]
  
  inline def INVALID_IMAGE_SIZE: `-40` = -40.asInstanceOf[`-40`]
  
  inline def INVALID_KERNEL: `-48` = -48.asInstanceOf[`-48`]
  
  inline def INVALID_KERNEL_ARGS: `-52` = -52.asInstanceOf[`-52`]
  
  inline def INVALID_KERNEL_DEFINITION: `-47` = -47.asInstanceOf[`-47`]
  
  inline def INVALID_KERNEL_NAME: `-46` = -46.asInstanceOf[`-46`]
  
  inline def INVALID_MEM_OBJECT: `-38` = -38.asInstanceOf[`-38`]
  
  inline def INVALID_OPERATION: `-59` = -59.asInstanceOf[`-59`]
  
  inline def INVALID_PLATFORM: `-32` = -32.asInstanceOf[`-32`]
  
  inline def INVALID_PROGRAM: `-44` = -44.asInstanceOf[`-44`]
  
  inline def INVALID_PROGRAM_EXECUTABLE: `-45` = -45.asInstanceOf[`-45`]
  
  inline def INVALID_PROPERTY: `-64` = -64.asInstanceOf[`-64`]
  
  inline def INVALID_QUEUE_PROPERTIES: `-35` = -35.asInstanceOf[`-35`]
  
  inline def INVALID_SAMPLER: `-41` = -41.asInstanceOf[`-41`]
  
  inline def INVALID_VALUE: `-30` = -30.asInstanceOf[`-30`]
  
  inline def INVALID_WORK_DIMENSION: `-53` = -53.asInstanceOf[`-53`]
  
  inline def INVALID_WORK_GROUP_SIZE: `-54` = -54.asInstanceOf[`-54`]
  
  inline def INVALID_WORK_ITEM_SIZE: `-55` = -55.asInstanceOf[`-55`]
  
  inline def MAP_FAILURE: `-12` = -12.asInstanceOf[`-12`]
  
  inline def MEM_COPY_OVERLAP: `-8` = -8.asInstanceOf[`-8`]
  
  inline def MEM_OBJECT_ALLOCATION_FAILURE: `-4` = -4.asInstanceOf[`-4`]
  
  inline def MISALIGNED_SUB_BUFFER_OFFSET: `-13` = -13.asInstanceOf[`-13`]
  
  inline def OUT_OF_HOST_MEMORY: `-6` = -6.asInstanceOf[`-6`]
  
  inline def OUT_OF_RESOURCES: `-5` = -5.asInstanceOf[`-5`]
  
  inline def PROFILING_INFO_NOT_AVAILABLE: `-7` = -7.asInstanceOf[`-7`]
