...
object ImageInfo {
  ...
  inline def IMAGE_ELEMENT_SIZE: `0x1111` = 0x1111.asInstanceOf[`0x1111`]
  
  inline def IMAGE_FORMAT: `0x1110` = 0x1110.asInstanceOf[`0x1110`]
  
  inline def IMAGE_HEIGHT: `0x1115` = 0x1115.asInstanceOf[`0x1115`]
  
  inline def IMAGE_ROW_PITCH: `0x1112` = 0x1112.asInstanceOf[`0x1112`]
  
  inline def IMAGE_WIDTH: `0x1114` = 0x1114.asInstanceOf[`0x1114`]
}
