...
trait WebCL extends js.Object {
  ...
  def waitForEvents(eventWaitList: js.Array[typings.webcl.WEBCLNs.WebCLEvent]): Unit = js.native
  def waitForEvents(eventWaitList: js.Array[typings.webcl.WEBCLNs.WebCLEvent], whenFinished: WebCLCallback): Unit = js.native
}
