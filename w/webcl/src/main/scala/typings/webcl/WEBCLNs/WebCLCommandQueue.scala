...
trait WebCLCommandQueue extends js.Object {
  ...
  def enqueueCopyBuffer(
    ...
    dstOffset: Double,
    numBytes: Double,
    eventWaitList: js.Array[typings.webcl.WEBCLNs.WebCLEvent]
  ): Unit = js.native
  def enqueueCopyBuffer(
    srcBuffer: WebCLBuffer,
    dstBuffer: WebCLBuffer,
    ...
    numBytes: Double,
    eventWaitList: js.Array[typings.webcl.WEBCLNs.WebCLEvent],
    event: typings.webcl.WEBCLNs.WebCLEvent
  ): Unit = js.native
  ...
  // Synchronization
  //
  def enqueueMarker(event: typings.webcl.WEBCLNs.WebCLEvent): Unit = js.native
  ////////////////////////////////////////////////////////////////////////////
  //
  // Executing kernels
  //
  ...
  def enqueueWaitForEvents(eventWaitList: js.Array[typings.webcl.WEBCLNs.WebCLEvent]): Unit = js.native
  ////////////////////////////////////////////////////////////////////////////
  //
