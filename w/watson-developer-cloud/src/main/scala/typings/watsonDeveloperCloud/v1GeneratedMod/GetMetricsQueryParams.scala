...
import typings.watsonDeveloperCloud.v1GeneratedMod.GetMetricsQueryConstants.ResultType
...
object GetMetricsQueryParams {
  ...
  @scala.inline
  implicit class GetMetricsQueryParamsMutableBuilder[Self <: GetMetricsQueryParams] (val x: Self) extends AnyVal {
