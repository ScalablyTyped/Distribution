...
trait DeleteCollectionParams extends StObject {
...
object DeleteCollectionParams {
  
  @scala.inline
  def apply(collection_id: String, environment_id: String): DeleteCollectionParams = {
  ...
  @scala.inline
  implicit class DeleteCollectionParamsMutableBuilder[Self <: DeleteCollectionParams] (val x: Self) extends AnyVal {
