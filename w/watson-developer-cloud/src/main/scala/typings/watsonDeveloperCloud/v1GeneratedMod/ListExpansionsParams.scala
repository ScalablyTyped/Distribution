...
trait ListExpansionsParams extends StObject {
...
object ListExpansionsParams {
  ...
  @scala.inline
  def apply(collection_id: String, environment_id: String): ListExpansionsParams = {
  ...
  @scala.inline
  implicit class ListExpansionsParamsMutableBuilder[Self <: ListExpansionsParams] (val x: Self) extends AnyVal {
