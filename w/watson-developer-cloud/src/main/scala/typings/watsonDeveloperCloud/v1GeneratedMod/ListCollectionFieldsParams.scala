...
@js.native
trait ListCollectionFieldsParams extends js.Object {
...
object ListCollectionFieldsParams {
  ...
  @scala.inline
  def apply(collection_id: String, environment_id: String): ListCollectionFieldsParams = {
  ...
  @scala.inline
  implicit class ListCollectionFieldsParamsOps[Self <: ListCollectionFieldsParams] (val x: Self) extends AnyVal {
