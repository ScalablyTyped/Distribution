...
object GetEnvironmentParams {
  ...
  @scala.inline
  def apply(environment_id: String): GetEnvironmentParams = {
    val __obj = js.Dynamic.literal(environment_id = environment_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetEnvironmentParams]
  }
  
  @scala.inline
  implicit class GetEnvironmentParamsMutableBuilder[Self <: GetEnvironmentParams] (val x: Self) extends AnyVal {
