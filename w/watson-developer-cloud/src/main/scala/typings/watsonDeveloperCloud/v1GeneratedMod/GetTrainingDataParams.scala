...
object GetTrainingDataParams {
  ...
  @scala.inline
  def apply(collection_id: String, environment_id: String, query_id: String): GetTrainingDataParams = {
  ...
  @scala.inline
  implicit class GetTrainingDataParamsMutableBuilder[Self <: GetTrainingDataParams] (val x: Self) extends AnyVal {
