...
trait DeleteTrainingDataParams extends StObject {
...
object DeleteTrainingDataParams {
  ...
  inline def apply(collection_id: String, environment_id: String, query_id: String): DeleteTrainingDataParams = {
  ...
  extension [Self <: DeleteTrainingDataParams](x: Self) {
