...
object DeleteGatewayParams {
  ...
  @scala.inline
  def apply(environment_id: String, gateway_id: String): DeleteGatewayParams = {
  ...
  @scala.inline
  implicit class DeleteGatewayParamsMutableBuilder[Self <: DeleteGatewayParams] (val x: Self) extends AnyVal {
