...
object DeleteCredentialsParams {
  ...
  @scala.inline
  def apply(credential_id: String, environment_id: String): DeleteCredentialsParams = {
  ...
  @scala.inline
  implicit class DeleteCredentialsParamsMutableBuilder[Self <: DeleteCredentialsParams] (val x: Self) extends AnyVal {
