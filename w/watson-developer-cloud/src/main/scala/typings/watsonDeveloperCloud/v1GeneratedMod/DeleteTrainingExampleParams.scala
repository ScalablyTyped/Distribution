...
object DeleteTrainingExampleParams {
  ...
  inline def apply(collection_id: String, environment_id: String, example_id: String, query_id: String): DeleteTrainingExampleParams = {
  ...
  extension [Self <: DeleteTrainingExampleParams](x: Self) {
