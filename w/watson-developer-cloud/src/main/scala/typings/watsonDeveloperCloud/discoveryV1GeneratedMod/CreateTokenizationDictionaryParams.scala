...
object CreateTokenizationDictionaryParams {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateTokenizationDictionaryParams] (val x: Self) extends AnyVal {
    ...
    inline def setTokenization_rulesVarargs(value: TokenDictRule*): Self = StObject.set(x, "tokenization_rules", js.Array(value*))
  }
}
