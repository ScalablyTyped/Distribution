...
object GetTokenizationDictionaryStatusParams {
  ...
  inline def apply(collection_id: String, environment_id: String): GetTokenizationDictionaryStatusParams = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetTokenizationDictionaryStatusParams] (val x: Self) extends AnyVal {
