...
import typings.watsonDeveloperCloud.discoveryV1GeneratedMod.AddDocumentConstants.FileContentType
...
object AddDocumentParams {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AddDocumentParams] (val x: Self) extends AnyVal {
