...
import typings.watsonDeveloperCloud.discoveryV1GeneratedMod.GetMetricsQueryNoResultsConstants.ResultType
...
object GetMetricsQueryNoResultsParams {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetMetricsQueryNoResultsParams] (val x: Self) extends AnyVal {
