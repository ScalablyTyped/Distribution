...
object HtmlSettings {
  ...
  implicit open class MutableBuilder[Self <: HtmlSettings] (val x: Self) extends AnyVal {
    ...
    inline def setExclude_tag_attributesVarargs(value: String*): Self = StObject.set(x, "exclude_tag_attributes", js.Array(value*))
    ...
    inline def setExclude_tags_completelyVarargs(value: String*): Self = StObject.set(x, "exclude_tags_completely", js.Array(value*))
    ...
    inline def setExclude_tags_keep_contentVarargs(value: String*): Self = StObject.set(x, "exclude_tags_keep_content", js.Array(value*))
    ...
    inline def setKeep_tag_attributesVarargs(value: String*): Self = StObject.set(x, "keep_tag_attributes", js.Array(value*))
  }
}
