...
trait QueryNoticesParams extends StObject {
...
object QueryNoticesParams {
  ...
  inline def apply(collection_id: String, environment_id: String): QueryNoticesParams = {
  ...
  extension [Self <: QueryNoticesParams](x: Self) {
    ...
    inline def setPassages(value: Boolean): Self = StObject.set(x, "passages", value.asInstanceOf[js.Any])
    
    inline def setPassagesUndefined: Self = StObject.set(x, "passages", js.undefined)
    
    inline def setPassages_characters(value: Double): Self = StObject.set(x, "passages_characters", value.asInstanceOf[js.Any])
    
    inline def setPassages_charactersUndefined: Self = StObject.set(x, "passages_characters", js.undefined)
    
    inline def setPassages_count(value: Double): Self = StObject.set(x, "passages_count", value.asInstanceOf[js.Any])
    
    inline def setPassages_countUndefined: Self = StObject.set(x, "passages_count", js.undefined)
    
    inline def setPassages_fields(value: js.Array[String]): Self = StObject.set(x, "passages_fields", value.asInstanceOf[js.Any])
    
    inline def setPassages_fieldsUndefined: Self = StObject.set(x, "passages_fields", js.undefined)
    
    inline def setPassages_fieldsVarargs(value: String*): Self = StObject.set(x, "passages_fields", js.Array(value*))
    ...
    inline def setReturn_fieldsVarargs(value: String*): Self = StObject.set(x, "return_fields", js.Array(value*))
    ...
    inline def setSimilar_document_idsVarargs(value: String*): Self = StObject.set(x, "similar_document_ids", js.Array(value*))
    ...
    inline def setSimilar_fieldsVarargs(value: String*): Self = StObject.set(x, "similar_fields", js.Array(value*))
