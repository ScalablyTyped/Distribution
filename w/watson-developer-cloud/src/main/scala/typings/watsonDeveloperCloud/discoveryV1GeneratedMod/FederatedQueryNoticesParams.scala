...
object FederatedQueryNoticesParams {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FederatedQueryNoticesParams] (val x: Self) extends AnyVal {
    ...
    inline def setCollection_idsVarargs(value: String*): Self = StObject.set(x, "collection_ids", js.Array(value*))
