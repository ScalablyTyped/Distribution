...
trait GetTrainingDataParams extends StObject {
...
object GetTrainingDataParams {
  ...
  inline def apply(collection_id: String, environment_id: String, query_id: String): GetTrainingDataParams = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetTrainingDataParams] (val x: Self) extends AnyVal {
