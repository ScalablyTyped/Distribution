...
import typings.watsonDeveloperCloud.discoveryV1GeneratedMod.GetMetricsQueryEventConstants.ResultType
...
object GetMetricsQueryEventParams {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetMetricsQueryEventParams] (val x: Self) extends AnyVal {
