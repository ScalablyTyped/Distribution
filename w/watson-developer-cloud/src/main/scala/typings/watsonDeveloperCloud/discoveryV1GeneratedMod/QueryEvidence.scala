...
object QueryEvidence {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: QueryEvidence] (val x: Self) extends AnyVal {
    ...
    inline def setEntitiesVarargs(value: QueryEvidenceEntity*): Self = StObject.set(x, "entities", js.Array(value*))
