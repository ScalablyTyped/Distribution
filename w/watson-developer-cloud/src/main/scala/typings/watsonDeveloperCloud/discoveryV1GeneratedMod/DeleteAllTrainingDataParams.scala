...
object DeleteAllTrainingDataParams {
  ...
  inline def apply(collection_id: String, environment_id: String): DeleteAllTrainingDataParams = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteAllTrainingDataParams] (val x: Self) extends AnyVal {
