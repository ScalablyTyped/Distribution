...
trait ListCollectionFieldsParams extends StObject {
...
object ListCollectionFieldsParams {
  
  inline def apply(collection_id: String, environment_id: String): ListCollectionFieldsParams = {
    ...
    __obj.asInstanceOf[ListCollectionFieldsParams]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListCollectionFieldsParams] (val x: Self) extends AnyVal {
