...
object CreateJobParams {
  ...
  inline def apply(audio: ReadableStream | FileObject | Buffer): CreateJobParams = {
  ...
  extension [Self <: CreateJobParams](x: Self) {
    ...
    inline def setEvents(value: Events | String): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
    ...
    inline def setResults_ttl(value: Double): Self = StObject.set(x, "results_ttl", value.asInstanceOf[js.Any])
    
    inline def setResults_ttlUndefined: Self = StObject.set(x, "results_ttl", js.undefined)
