...
@js.native
trait ListAudioParams extends StObject {
...
object ListAudioParams {
  ...
  @scala.inline
  def apply(customization_id: String): ListAudioParams = {
    val __obj = js.Dynamic.literal(customization_id = customization_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListAudioParams]
  }
  
  @scala.inline
  implicit class ListAudioParamsMutableBuilder[Self <: ListAudioParams] (val x: Self) extends AnyVal {
