...
object GetLanguageModelParams {
  ...
  inline def apply(customization_id: String): GetLanguageModelParams = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetLanguageModelParams] (val x: Self) extends AnyVal {
