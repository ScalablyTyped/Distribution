...
trait ListAcousticModelsParams extends StObject {
...
object ListAcousticModelsParams {
  ...
  @scala.inline
  implicit class ListAcousticModelsParamsMutableBuilder[Self <: ListAcousticModelsParams] (val x: Self) extends AnyVal {
