...
object GetCoreMlModelParams {
  ...
  @scala.inline
  def apply(classifier_id: String): GetCoreMlModelParams = {
    val __obj = js.Dynamic.literal(classifier_id = classifier_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetCoreMlModelParams]
  }
  
  @scala.inline
  implicit class GetCoreMlModelParamsMutableBuilder[Self <: GetCoreMlModelParams] (val x: Self) extends AnyVal {
