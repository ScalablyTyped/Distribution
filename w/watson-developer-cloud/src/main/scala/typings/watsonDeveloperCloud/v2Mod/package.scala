...
/* static member */
inline def URL: java.lang.String = typings.watsonDeveloperCloud.v2Mod.^.asInstanceOf[js.Dynamic].selectDynamic("URL").asInstanceOf[java.lang.String]
inline def URL_=(x: java.lang.String): scala.Unit = typings.watsonDeveloperCloud.v2Mod.^.asInstanceOf[js.Dynamic].updateDynamic("URL")(x.asInstanceOf[js.Any])
