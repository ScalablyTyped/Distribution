...
object ToneChatScore {
  ...
  inline def apply(score: Double, tone_id: String, tone_name: String): ToneChatScore = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ToneChatScore] (val x: Self) extends AnyVal {
