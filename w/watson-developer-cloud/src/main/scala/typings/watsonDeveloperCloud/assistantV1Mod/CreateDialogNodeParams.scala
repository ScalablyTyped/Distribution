...
import typings.watsonDeveloperCloud.assistantV1Mod.CreateDialogNodeConstants.DigressIn
import typings.watsonDeveloperCloud.assistantV1Mod.CreateDialogNodeConstants.DigressOut
import typings.watsonDeveloperCloud.assistantV1Mod.CreateDialogNodeConstants.DigressOutSlots
import typings.watsonDeveloperCloud.assistantV1Mod.CreateDialogNodeConstants.EventName
import typings.watsonDeveloperCloud.assistantV1Mod.CreateDialogNodeConstants.NodeType
...
object CreateDialogNodeParams {
  ...
  inline def apply(dialog_node: String, workspace_id: String): CreateDialogNodeParams = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateDialogNodeParams] (val x: Self) extends AnyVal {
    ...
    inline def setDigress_in(value: DigressIn | String): Self = StObject.set(x, "digress_in", value.asInstanceOf[js.Any])
    
    inline def setDigress_inUndefined: Self = StObject.set(x, "digress_in", js.undefined)
    
    inline def setDigress_out(value: DigressOut | String): Self = StObject.set(x, "digress_out", value.asInstanceOf[js.Any])
    
    inline def setDigress_outUndefined: Self = StObject.set(x, "digress_out", js.undefined)
    
    inline def setDigress_out_slots(value: DigressOutSlots | String): Self = StObject.set(x, "digress_out_slots", value.asInstanceOf[js.Any])
    
    inline def setDigress_out_slotsUndefined: Self = StObject.set(x, "digress_out_slots", js.undefined)
    
    inline def setEvent_name(value: EventName | String): Self = StObject.set(x, "event_name", value.asInstanceOf[js.Any])
    ...
    inline def setNode_type(value: NodeType | String): Self = StObject.set(x, "node_type", value.asInstanceOf[js.Any])
