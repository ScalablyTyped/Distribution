...
import typings.watsonDeveloperCloud.assistantV1Mod.CreateValueConstants.ValueType
...
object CreateValueParams {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateValueParams] (val x: Self) extends AnyVal {
