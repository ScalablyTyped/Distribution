...
import typings.watsonDeveloperCloud.assistantV1Mod.UpdateValueConstants.ValueType
...
object UpdateValueParams {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateValueParams] (val x: Self) extends AnyVal {
    ...
    inline def setNew_patternsVarargs(value: String*): Self = StObject.set(x, "new_patterns", js.Array(value*))
    ...
    inline def setNew_synonymsVarargs(value: String*): Self = StObject.set(x, "new_synonyms", js.Array(value*))
