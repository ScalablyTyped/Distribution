...
import typings.watsonDeveloperCloud.assistantV1Mod.ListValuesConstants.Sort
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/** Parameters for the `listValues` operation. */
trait ListValuesParams extends StObject {
...
object ListValuesParams {
  ...
  inline def apply(entity: String, workspace_id: String): ListValuesParams = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListValuesParams] (val x: Self) extends AnyVal {
