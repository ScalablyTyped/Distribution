...
import typings.watsonDeveloperCloud.assistantV1Mod.ListExamplesConstants.Sort
...
object ListExamplesParams {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListExamplesParams] (val x: Self) extends AnyVal {
