...
import typings.watsonDeveloperCloud.assistantV1Mod.ListCounterexamplesConstants.Sort
...
object ListCounterexamplesParams {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListCounterexamplesParams] (val x: Self) extends AnyVal {
