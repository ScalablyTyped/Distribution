package typings.watsonDeveloperCloud.textToSpeechV1GeneratedMod.GetVoiceConstants
...
@JSImport("watson-developer-cloud/text-to-speech/v1-generated", "GetVoiceConstants.Voice")
@js.native
