...
trait CreateSynonymParams extends StObject {
...
object CreateSynonymParams {
  ...
  @scala.inline
  def apply(entity: String, synonym: String, value: String, workspace_id: String): CreateSynonymParams = {
  ...
  @scala.inline
  implicit class CreateSynonymParamsMutableBuilder[Self <: CreateSynonymParams] (val x: Self) extends AnyVal {
