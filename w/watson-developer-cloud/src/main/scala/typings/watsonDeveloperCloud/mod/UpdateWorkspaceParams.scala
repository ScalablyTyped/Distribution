...
object UpdateWorkspaceParams {
  ...
  extension [Self <: UpdateWorkspaceParams](x: Self) {
    ...
    inline def setEntitiesVarargs(value: CreateEntity*): Self = StObject.set(x, "entities", js.Array(value :_*))
    ...
    inline def setIntentsVarargs(value: CreateIntent*): Self = StObject.set(x, "intents", js.Array(value :_*))
