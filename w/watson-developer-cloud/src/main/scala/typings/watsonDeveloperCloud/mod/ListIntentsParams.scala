...
import typings.watsonDeveloperCloud.mod.ListIntentsConstants.Sort
...
object ListIntentsParams {
  ...
  @scala.inline
  def apply(workspace_id: String): ListIntentsParams = {
    val __obj = js.Dynamic.literal(workspace_id = workspace_id.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListIntentsParams]
  }
  
  @scala.inline
  implicit class ListIntentsParamsMutableBuilder[Self <: ListIntentsParams] (val x: Self) extends AnyVal {
