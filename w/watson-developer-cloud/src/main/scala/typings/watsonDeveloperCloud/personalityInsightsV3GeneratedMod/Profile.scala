...
object Profile {
  ...
  extension [Self <: Profile](x: Self) {
    ...
    inline def setBehaviorVarargs(value: Behavior*): Self = StObject.set(x, "behavior", js.Array(value*))
    ...
    inline def setConsumption_preferencesVarargs(value: ConsumptionPreferencesCategory*): Self = StObject.set(x, "consumption_preferences", js.Array(value*))
    
    inline def setNeeds(value: js.Array[Trait]): Self = StObject.set(x, "needs", value.asInstanceOf[js.Any])
    
    inline def setNeedsVarargs(value: Trait*): Self = StObject.set(x, "needs", js.Array(value*))
    
    inline def setPersonality(value: js.Array[Trait]): Self = StObject.set(x, "personality", value.asInstanceOf[js.Any])
    
    inline def setPersonalityVarargs(value: Trait*): Self = StObject.set(x, "personality", js.Array(value*))
    ...
    inline def setValuesVarargs(value: Trait*): Self = StObject.set(x, "values", js.Array(value*))
