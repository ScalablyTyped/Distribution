...
@JSImport("watson-developer-cloud/sdk", "DiscoveryV1.CreateCollectionConstants")
@js.native
object CreateCollectionConstants extends js.Object {
  ...
  object Language extends js.Object {
    ...
    def apply(value: String): js.UndefOr[
        typings.watsonDeveloperCloud.v1GeneratedMod.CreateCollectionConstants.Language with String
      ] = js.native
