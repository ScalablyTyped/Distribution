...
import typings.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.GetPronunciationConstants.Format
...
trait GetPronunciationParams extends js.Object {
  ...
  var voice: js.UndefOr[
    typings.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.GetPronunciationConstants.Voice | String
  ] = js.undefined
}
...
object GetPronunciationParams {
  ...
  def apply(
    ...
    voice: typings.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.GetPronunciationConstants.Voice | String = null
