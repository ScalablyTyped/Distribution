...
trait GetVoiceParams extends js.Object {
  ...
  var voice: typings.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.GetVoiceConstants.Voice | String
}

object GetVoiceParams {
  @scala.inline
  def apply(
    voice: typings.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.GetVoiceConstants.Voice | String,
