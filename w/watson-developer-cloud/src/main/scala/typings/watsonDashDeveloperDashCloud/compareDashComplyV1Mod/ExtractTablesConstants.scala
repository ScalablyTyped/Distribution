...
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.FileContentType.APPLICATION_MSWORD
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.FileContentType.APPLICATION_PDF
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.FileContentType.APPLICATION_VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_DOCUMENT
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.FileContentType.IMAGE_BMP
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.FileContentType.IMAGE_GIF
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.FileContentType.IMAGE_JPEG
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.FileContentType.IMAGE_PNG
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.FileContentType.IMAGE_TIFF
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.FileContentType.TEXT_PLAIN
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.Model
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.Model.CONTRACTS
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.Model.TABLES
