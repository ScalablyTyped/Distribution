...
object ListFeedbackParams {
  ...
  def apply(
    ...
    if (category_added != null) __obj.updateDynamic("category_added")(category_added)
    if (category_not_changed != null) __obj.updateDynamic("category_not_changed")(category_not_changed)
    if (category_removed != null) __obj.updateDynamic("category_removed")(category_removed)
    if (cursor != null) __obj.updateDynamic("cursor")(cursor)
    if (document_title != null) __obj.updateDynamic("document_title")(document_title)
    if (feedback_type != null) __obj.updateDynamic("feedback_type")(feedback_type)
    if (headers != null) __obj.updateDynamic("headers")(headers)
    if (!js.isUndefined(include_total)) __obj.updateDynamic("include_total")(include_total)
    ...
    if (type_added != null) __obj.updateDynamic("type_added")(type_added)
    if (type_not_changed != null) __obj.updateDynamic("type_not_changed")(type_not_changed)
    if (type_removed != null) __obj.updateDynamic("type_removed")(type_removed)
