...
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.FileContentType
import typings.watsonDashDeveloperDashCloud.compareDashComplyV1Mod.ExtractTablesConstants.Model
