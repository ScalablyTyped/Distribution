...
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.UpdateCredentialsConstants.SourceType.BOX
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.UpdateCredentialsConstants.SourceType.CLOUD_OBJECT_STORAGE
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.UpdateCredentialsConstants.SourceType.SALESFORCE
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.UpdateCredentialsConstants.SourceType.SHAREPOINT
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.UpdateCredentialsConstants.SourceType.WEB_CRAWL
