...
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.UpdateDocumentConstants.FileContentType.APPLICATION_JSON
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.UpdateDocumentConstants.FileContentType.APPLICATION_MSWORD
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.UpdateDocumentConstants.FileContentType.APPLICATION_PDF
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.UpdateDocumentConstants.FileContentType.APPLICATION_VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_DOCUMENT
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.UpdateDocumentConstants.FileContentType.APPLICATION_XHTML_XML
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.UpdateDocumentConstants.FileContentType.TEXT_HTML
