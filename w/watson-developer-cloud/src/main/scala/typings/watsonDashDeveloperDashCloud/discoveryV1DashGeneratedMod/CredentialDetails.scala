...
object CredentialDetails {
  ...
  def apply(
    ...
    if (access_key_id != null) __obj.updateDynamic("access_key_id")(access_key_id)
    ...
    if (credential_type != null) __obj.updateDynamic("credential_type")(credential_type)
    if (domain != null) __obj.updateDynamic("domain")(domain)
    if (endpoint != null) __obj.updateDynamic("endpoint")(endpoint)
    if (enterprise_id != null) __obj.updateDynamic("enterprise_id")(enterprise_id)
    if (gateway_id != null) __obj.updateDynamic("gateway_id")(gateway_id)
    if (organization_url != null) __obj.updateDynamic("organization_url")(organization_url)
    if (passphrase != null) __obj.updateDynamic("passphrase")(passphrase)
    if (password != null) __obj.updateDynamic("password")(password)
    if (private_key != null) __obj.updateDynamic("private_key")(private_key)
    if (public_key_id != null) __obj.updateDynamic("public_key_id")(public_key_id)
    if (secret_access_key != null) __obj.updateDynamic("secret_access_key")(secret_access_key)
    if (site_collection_path != null) __obj.updateDynamic("site_collection_path")(site_collection_path)
    if (source_version != null) __obj.updateDynamic("source_version")(source_version)
    if (url != null) __obj.updateDynamic("url")(url)
    if (username != null) __obj.updateDynamic("username")(username)
    if (web_application_url != null) __obj.updateDynamic("web_application_url")(web_application_url)
