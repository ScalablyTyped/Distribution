...
import typings.watsonDashDeveloperDashCloud.languageDashTranslatorV3Mod.Options
import typings.watsonDashDeveloperDashCloud.languageDashTranslatorV3Mod.^
