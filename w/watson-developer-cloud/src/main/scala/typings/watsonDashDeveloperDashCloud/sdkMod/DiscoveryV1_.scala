...
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.Options
import typings.watsonDashDeveloperDashCloud.discoveryV1DashGeneratedMod.^
