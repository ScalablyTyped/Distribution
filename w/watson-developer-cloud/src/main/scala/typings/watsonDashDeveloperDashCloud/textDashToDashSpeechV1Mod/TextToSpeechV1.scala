package typings.watsonDashDeveloperDashCloud.textDashToDashSpeechV1Mod
...
trait TextToSpeechV1
  extends typings.watsonDashDeveloperDashCloud.textDashToDashSpeechV1DashGeneratedMod.^ {
  /**
  ...
  /**
    ...
    */
  def synthesizeUsingWebSocket(params: js.Any): typings.watsonDashDeveloperDashCloud.libSynthesizeDashStreamMod.^ = js.native
}
