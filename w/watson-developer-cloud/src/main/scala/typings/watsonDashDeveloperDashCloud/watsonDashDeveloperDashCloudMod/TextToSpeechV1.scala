...
@js.native
class TextToSpeechV1 protected () extends js.Object {
  ...
  def pronunciation(params: js.Any, callback: js.Any): js.Any = js.native
  def synthesize(params: js.Any, callback: js.Any): js.Any = js.native
  def updateCustomization(params: js.Any, callback: js.Any): js.Any = js.native
  def voice(params: js.Any, callback: js.Any): js.Any = js.native
