...
object CreateJobParams {
  ...
  def apply(
    ...
    if (acoustic_customization_id != null) __obj.updateDynamic("acoustic_customization_id")(acoustic_customization_id)
    if (base_model_version != null) __obj.updateDynamic("base_model_version")(base_model_version)
    if (callback_url != null) __obj.updateDynamic("callback_url")(callback_url)
    ...
    if (grammar_name != null) __obj.updateDynamic("grammar_name")(grammar_name)
    ...
    if (language_customization_id != null) __obj.updateDynamic("language_customization_id")(language_customization_id)
    if (max_alternatives != null) __obj.updateDynamic("max_alternatives")(max_alternatives.asInstanceOf[js.Any])
    if (model != null) __obj.updateDynamic("model")(model.asInstanceOf[js.Any])
    if (!js.isUndefined(profanity_filter)) __obj.updateDynamic("profanity_filter")(profanity_filter)
    if (!js.isUndefined(redaction)) __obj.updateDynamic("redaction")(redaction)
    if (results_ttl != null) __obj.updateDynamic("results_ttl")(results_ttl.asInstanceOf[js.Any])
    if (!js.isUndefined(return_response)) __obj.updateDynamic("return_response")(return_response)
    if (!js.isUndefined(smart_formatting)) __obj.updateDynamic("smart_formatting")(smart_formatting)
    if (!js.isUndefined(speaker_labels)) __obj.updateDynamic("speaker_labels")(speaker_labels)
    ...
    if (!js.isUndefined(word_confidence)) __obj.updateDynamic("word_confidence")(word_confidence)
