...
import typings.watsonDashDeveloperDashCloud.personalityDashInsightsV3DashGeneratedMod.ProfileAsCsvConstants.AcceptLanguage
import typings.watsonDashDeveloperDashCloud.personalityDashInsightsV3DashGeneratedMod.ProfileAsCsvConstants.ContentLanguage
import typings.watsonDashDeveloperDashCloud.personalityDashInsightsV3DashGeneratedMod.ProfileAsCsvConstants.ContentType
...
object ProfileAsCsvParams {
  ...
  def apply(
    ...
    if (!js.isUndefined(consumption_preferences)) __obj.updateDynamic("consumption_preferences")(consumption_preferences)
    ...
    if (!js.isUndefined(csv_headers)) __obj.updateDynamic("csv_headers")(csv_headers)
    if (headers != null) __obj.updateDynamic("headers")(headers)
    if (!js.isUndefined(raw_scores)) __obj.updateDynamic("raw_scores")(raw_scores)
