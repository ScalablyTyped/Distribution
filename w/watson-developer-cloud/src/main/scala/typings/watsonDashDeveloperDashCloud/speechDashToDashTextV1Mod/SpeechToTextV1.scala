package typings.watsonDashDeveloperDashCloud.speechDashToDashTextV1Mod
...
trait SpeechToTextV1
  extends typings.watsonDashDeveloperDashCloud.speechDashToDashTextV1DashGeneratedMod.^ {
  ...
  /**
    ...
    */
  def recognizeUsingWebSocket(params: js.Any): typings.watsonDashDeveloperDashCloud.libRecognizeDashStreamMod.^ = js.native
  /**
