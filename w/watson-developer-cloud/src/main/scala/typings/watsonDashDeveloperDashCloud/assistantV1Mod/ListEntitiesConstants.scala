...
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.ListEntitiesConstants.Sort.ENTITY
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.ListEntitiesConstants.Sort.UPDATED
