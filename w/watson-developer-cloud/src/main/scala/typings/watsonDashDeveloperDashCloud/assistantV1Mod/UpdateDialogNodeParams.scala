...
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.DigressIn
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.DigressOut
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.DigressOutSlots
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.EventName
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.NodeType
...
object UpdateDialogNodeParams {
  ...
  def apply(
    ...
    if (new_actions != null) __obj.updateDynamic("new_actions")(new_actions)
    if (new_conditions != null) __obj.updateDynamic("new_conditions")(new_conditions)
    if (new_context != null) __obj.updateDynamic("new_context")(new_context)
    if (new_description != null) __obj.updateDynamic("new_description")(new_description)
    if (new_dialog_node != null) __obj.updateDynamic("new_dialog_node")(new_dialog_node)
    ...
    if (new_next_step != null) __obj.updateDynamic("new_next_step")(new_next_step)
    if (new_node_type != null) __obj.updateDynamic("new_node_type")(new_node_type.asInstanceOf[js.Any])
    if (new_output != null) __obj.updateDynamic("new_output")(new_output)
    if (new_parent != null) __obj.updateDynamic("new_parent")(new_parent)
    if (new_previous_sibling != null) __obj.updateDynamic("new_previous_sibling")(new_previous_sibling)
    if (new_title != null) __obj.updateDynamic("new_title")(new_title)
    if (new_user_label != null) __obj.updateDynamic("new_user_label")(new_user_label)
    if (new_variable != null) __obj.updateDynamic("new_variable")(new_variable)
