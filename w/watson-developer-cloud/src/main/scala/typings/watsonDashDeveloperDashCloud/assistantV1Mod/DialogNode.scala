...
object DialogNode {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(dialog_node = dialog_node)
    if (actions != null) __obj.updateDynamic("actions")(actions)
    if (conditions != null) __obj.updateDynamic("conditions")(conditions)
    if (context != null) __obj.updateDynamic("context")(context)
    if (created != null) __obj.updateDynamic("created")(created)
    if (description != null) __obj.updateDynamic("description")(description)
    if (digress_in != null) __obj.updateDynamic("digress_in")(digress_in)
    if (digress_out != null) __obj.updateDynamic("digress_out")(digress_out)
    if (digress_out_slots != null) __obj.updateDynamic("digress_out_slots")(digress_out_slots)
    if (!js.isUndefined(disabled)) __obj.updateDynamic("disabled")(disabled)
    if (event_name != null) __obj.updateDynamic("event_name")(event_name)
    if (metadata != null) __obj.updateDynamic("metadata")(metadata)
    if (next_step != null) __obj.updateDynamic("next_step")(next_step)
    if (node_type != null) __obj.updateDynamic("node_type")(node_type)
