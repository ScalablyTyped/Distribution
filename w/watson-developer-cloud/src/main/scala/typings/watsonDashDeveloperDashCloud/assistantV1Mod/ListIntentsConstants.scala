...
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.ListIntentsConstants.Sort.INTENT
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.ListIntentsConstants.Sort.UPDATED
