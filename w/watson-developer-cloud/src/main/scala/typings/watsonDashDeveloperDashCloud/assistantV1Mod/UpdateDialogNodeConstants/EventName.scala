...
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.EventName.DIGRESSION_RETURN_PROMPT
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.EventName.FILLED
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.EventName.FILLED_MULTIPLE
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.EventName.FOCUS
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.EventName.GENERIC
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.EventName.INPUT
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.EventName.NOMATCH
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.EventName.NOMATCH_RESPONSES_DEPLETED
import typings.watsonDashDeveloperDashCloud.assistantV1Mod.UpdateDialogNodeConstants.EventName.VALIDATE
