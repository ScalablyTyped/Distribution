...
version := "3.9-dt-20191127Z-c5c358"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "connect-history-api-fallback" % "1.3-dt-20190819Z-644169",
  "org.scalablytyped" %%% "express" % "4.17-dt-20191101Z-e86cd1",
  "org.scalablytyped" %%% "express-serve-static-core" % "4.17-dt-20191220Z-f5dd1c",
  "org.scalablytyped" %%% "http-proxy" % "1.17-dt-20191115Z-b17afe",
  "org.scalablytyped" %%% "http-proxy-middleware" % "0.19-dt-20190819Z-774d5a",
