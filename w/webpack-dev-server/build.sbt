...
version := "3.9-dt-20191127Z-361bc6"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "connect-history-api-fallback" % "1.3-dt-20190819Z-7b547f",
  ...
  "org.scalablytyped" %%% "http-proxy-middleware" % "0.19-dt-20190819Z-f4fc52",
