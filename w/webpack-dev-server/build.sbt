...
version := "3.1-dt-20190710Z-5e80de"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "connect-history-api-fallback" % "1.3-dt-20190819Z-b89714",
  "org.scalablytyped" %%% "express" % "4.17-dt-20190819Z-2563ef",
  "org.scalablytyped" %%% "express-serve-static-core" % "4.16-dt-20190819Z-c41353",
  "org.scalablytyped" %%% "http-proxy" % "1.17-dt-20190301Z-c1845e",
  "org.scalablytyped" %%% "http-proxy-middleware" % "0.19-dt-20190819Z-01cbc7",
