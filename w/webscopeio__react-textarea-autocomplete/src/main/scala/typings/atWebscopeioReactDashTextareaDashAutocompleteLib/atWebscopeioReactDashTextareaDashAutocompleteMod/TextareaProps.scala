...
- Dropped {[ P in @webscopeio/react-textarea-autocomplete.PickedAttributes ]: react.react.InputHTMLAttributes<react.HTMLTextAreaElement>[P]} */ @js.native
trait TextareaProps[TItem] extends js.Object {
  ...
  /**
    * Gets data props which is already fetched (and displayed) suggestion.
    */
  def loadingComponent(props: js.Object with reactLib.Anon_Children): reactLib.reactMod.ReactNs.ReactElement | scala.Null = js.native
  /**
    * Gets data props which is already fetched (and displayed) suggestion.
    */
  def loadingComponent(props: js.Object with reactLib.Anon_Children, context: js.Any): reactLib.reactMod.ReactNs.ReactElement | scala.Null = js.native
}
