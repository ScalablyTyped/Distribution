...
import typings.webicon.cssIconSetMod.CssIconSet
import typings.webicon.iconLoadedEventHandlerMod.IconLoadedEventHandler
import typings.webicon.imageIconMod.ImageIcon
import typings.webicon.injectorMod.Injector
import typings.webicon.svgCumulativeIconSetMod.SvgCumulativeIconSet
