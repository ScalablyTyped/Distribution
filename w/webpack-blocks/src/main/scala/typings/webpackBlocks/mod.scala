...
object mod {
  ...
  inline def extractText(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("extractText")().asInstanceOf[js.Any]
  inline def extractText(outputFilePattern: String): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("extractText")(outputFilePattern.asInstanceOf[js.Any]).asInstanceOf[js.Any]
