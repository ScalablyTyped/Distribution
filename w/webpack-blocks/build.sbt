...
name := "webpack-blocks"
version := "2.0-dt-20191016Z-19ba24"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-blocks__core" % "2.0-dt-20191016Z-373403",
  ...
  "org.scalablytyped" %%% "webpack-blocks__uglify" % "2.0-dt-20191016Z-4ce8f0",
  "org.scalablytyped" %%% "webpack-blocks__webpack" % "2.0-dt-20191016Z-c60c35",
