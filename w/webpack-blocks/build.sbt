...
name := "webpack-blocks"
version := "2.0-dt-20211202Z-85c28a"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-blocks__core" % "2.0-dt-20221003Z-c085c6",
  ...
  "org.scalablytyped" %%% "webpack-blocks__webpack" % "2.0-dt-20221003Z-876322")
