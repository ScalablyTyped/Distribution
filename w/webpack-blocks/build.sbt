...
name := "webpack-blocks"
version := "2.0-dt-20211202Z-4db31b"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-blocks__core" % "2.0-dt-20221003Z-1feb29",
  ...
  "org.scalablytyped" %%% "webpack-blocks__webpack" % "2.0-dt-20221003Z-8b3b83")
