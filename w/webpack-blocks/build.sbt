...
name := "webpack-blocks"
version := "2.0-dt-20211202Z-71b26d"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-blocks__core" % "2.0-dt-20221003Z-f94f18",
  ...
  "org.scalablytyped" %%% "webpack-blocks__webpack" % "2.0-dt-20221003Z-d67d88")
