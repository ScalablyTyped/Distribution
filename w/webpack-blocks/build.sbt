...
name := "webpack-blocks"
version := "2.0-dt-20191016Z-ef4b63"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-blocks__core" % "2.0-dt-20191016Z-96dff8",
  ...
  "org.scalablytyped" %%% "webpack-blocks__webpack" % "2.0-dt-20191016Z-fe34b8",
