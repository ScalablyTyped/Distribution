...
name := "webpack-blocks"
version := "2.0-dt-20211202Z-bd600b"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-blocks__core" % "2.0-dt-20221003Z-247a91",
  ...
  "org.scalablytyped" %%% "webpack-blocks__webpack" % "2.0-dt-20221003Z-fc3c5e")
