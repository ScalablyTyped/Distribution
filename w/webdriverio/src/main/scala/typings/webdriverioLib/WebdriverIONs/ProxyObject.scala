...
trait ProxyObject extends js.Object {
  ...
  var proxyType: js.UndefOr[
    webdriverioLib.webdriverioLibStrings.pac | webdriverioLib.webdriverioLibStrings.noproxy | webdriverioLib.webdriverioLibStrings.autodetect | webdriverioLib.webdriverioLibStrings.system | webdriverioLib.webdriverioLibStrings.manual
  ] = js.undefined
