...
object mod {
  ...
  object RemoteOptions {
    ...
    extension [Self <: RemoteOptions](x: Self) {
      ...
      inline def setAfterSessionFunction3(value: (RemoteOptions, /* capabilities */ RemoteCapability, /* specs */ js.Array[String]) => Unit): Self = StObject.set(x, "afterSession", js.Any.fromFunction3(value))
      ...
      inline def setOnPrepareFunction2(value: (RemoteOptions, /* capabilities */ RemoteCapabilities) => Unit): Self = StObject.set(x, "onPrepare", js.Any.fromFunction2(value))
      ...
      inline def setOnWorkerStartFunction5(
        value: (/* cid */ String, /* caps */ DesiredCapabilities, /* specs */ js.Array[String], RemoteOptions, /* execArgv */ js.Array[String]) => Unit
