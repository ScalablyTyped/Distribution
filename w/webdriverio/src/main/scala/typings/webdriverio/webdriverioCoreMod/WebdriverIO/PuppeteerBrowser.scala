...
object PuppeteerBrowser {
  ...
  inline def apply(): PuppeteerBrowser = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PuppeteerBrowser]
  }
  
  extension [Self <: PuppeteerBrowser](x: Self) {
    ...
    inline def setBrowserContexts(value: () => js.Array[BrowserContext]): Self = StObject.set(x, "browserContexts", js.Any.fromFunction0(value))
    
    inline def setBrowserContextsUndefined: Self = StObject.set(x, "browserContexts", js.undefined)
    
    inline def setClose(value: () => js.Promise[Unit]): Self = StObject.set(x, "close", js.Any.fromFunction0(value))
    
    inline def setCloseUndefined: Self = StObject.set(x, "close", js.undefined)
    
    inline def setCreateIncognitoBrowserContext(value: () => js.Promise[BrowserContext]): Self = StObject.set(x, "createIncognitoBrowserContext", js.Any.fromFunction0(value))
    
    inline def setCreateIncognitoBrowserContextUndefined: Self = StObject.set(x, "createIncognitoBrowserContext", js.undefined)
    
    inline def setDefaultBrowserContext(value: () => BrowserContext): Self = StObject.set(x, "defaultBrowserContext", js.Any.fromFunction0(value))
    
    inline def setDefaultBrowserContextUndefined: Self = StObject.set(x, "defaultBrowserContext", js.undefined)
    ...
    inline def setNewPage(value: () => js.Promise[Page]): Self = StObject.set(x, "newPage", js.Any.fromFunction0(value))
    ...
    inline def setPages(value: () => js.Promise[js.Array[Page]]): Self = StObject.set(x, "pages", js.Any.fromFunction0(value))
    
    inline def setPagesUndefined: Self = StObject.set(x, "pages", js.undefined)
    
    inline def setProcess(value: () => ChildProcess): Self = StObject.set(x, "process", js.Any.fromFunction0(value))
    ...
    inline def setTarget(value: () => Target): Self = StObject.set(x, "target", js.Any.fromFunction0(value))
    
    inline def setTargetUndefined: Self = StObject.set(x, "target", js.undefined)
    
    inline def setTargets(value: () => js.Promise[js.Array[Target]]): Self = StObject.set(x, "targets", js.Any.fromFunction0(value))
    
    inline def setTargetsUndefined: Self = StObject.set(x, "targets", js.undefined)
    
    inline def setUserAgent(value: () => js.Promise[String]): Self = StObject.set(x, "userAgent", js.Any.fromFunction0(value))
    ...
    inline def setWaitForTarget(value: /* predicate */ js.Function1[/* target */ Target, Boolean] => js.Promise[Target]): Self = StObject.set(x, "waitForTarget", js.Any.fromFunction1(value))
    
    inline def setWaitForTargetUndefined: Self = StObject.set(x, "waitForTarget", js.undefined)
    
    inline def setWsEndpoint(value: () => String): Self = StObject.set(x, "wsEndpoint", js.Any.fromFunction0(value))
    
    inline def setWsEndpointUndefined: Self = StObject.set(x, "wsEndpoint", js.undefined)
  }
}
