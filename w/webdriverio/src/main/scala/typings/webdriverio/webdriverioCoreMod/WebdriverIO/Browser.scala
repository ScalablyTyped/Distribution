...
- Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebDriver.BaseClient * / any */ @js.native
trait Browser extends StObject {
  ...
  /**
    ...
    */
  def addCommand[IsElement /* <: Boolean */](name: String, func: AddCommandFn[IsElement]): Unit = js.native
  def addCommand[IsElement /* <: Boolean */](name: String, func: AddCommandFn[IsElement], attachToElement: IsElement): Unit = js.native
  ...
  def addLocatorStrategy(
    name: String,
    func: js.Function1[/* elementFetchingMethod */ js.Function1[/* selector */ String, js.Any], Unit]
  ): Unit = js.native
  ...
  /**
    ...
    * retrieve all.
    */
  def getCookies(): js.Promise[
    js.Array[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebDriver.Cookie */ js.Any
    ]
  ] = js.native
  def getCookies(names: String): js.Promise[
    js.Array[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebDriver.Cookie */ js.Any
    ]
  ] = js.native
  def getCookies(names: js.Array[String]): js.Promise[
    js.Array[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebDriver.Cookie */ js.Any
    ]
  ] = js.native
  ...
  /**
    ...
    */
  def getPuppeteer(): js.Promise[PuppeteerBrowser] = js.native
  
  /**
    * Returns browser window size (and position for drivers with W3C support).
    */
  def getWindowSize(): js.Promise[
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebDriver.RectReturn */ js.Any
  ] = js.native
  ...
  /**
    ...
    */
  def overwriteCommand[IsElement /* <: Boolean */](
    name: ELEMENT | `element-6066-11e4-a52e-4f735466cecf` | elementId | index | isMultiremote | parent | selector,
    func: OverwriteCommandFn[
      ELEMENT | `element-6066-11e4-a52e-4f735466cecf` | elementId | index | parent | selector, 
      isMultiremote, 
      IsElement
    ]
  ): Unit = js.native
  ...
  /**
    ...
    */
  def savePDF(filepath: String): js.Promise[Buffer] = js.native
  def savePDF(filepath: String, options: PDFPrintOptions): js.Promise[Buffer] = js.native
