...
trait ElementCommandsTypeSync extends StObject {
  ...
  @JSName("getLocation")
  var getLocation_Original: (js.ThisFunction0[/* this */ typings.std.Element, Location]) & (js.ThisFunction1[/* this */ typings.std.Element, /* prop */ x | y, Double]) & (js.ThisFunction1[/* this */ typings.std.Element, /* prop */ js.UndefOr[x | y], Location | Double])
  @JSName("getLocation")
  def getLocation_Union(): Location | Double
  ...
  @JSName("getSize")
  var getSize_Original: (js.ThisFunction0[/* this */ typings.std.Element, Size]) & (js.ThisFunction1[
...
object ElementCommandsTypeSync {
  ...
  inline def apply(
    ...
    getLocation: (js.ThisFunction0[/* this */ typings.std.Element, Location]) & (js.ThisFunction1[/* this */ typings.std.Element, /* prop */ x | y, Double]) & (js.ThisFunction1[/* this */ typings.std.Element, /* prop */ js.UndefOr[x | y], Location | Double]),
    ...
    getSize: (js.ThisFunction0[/* this */ typings.std.Element, Size]) & (js.ThisFunction1[
      /* this */ typings.std.Element, 
      /* keyof @wdio/protocols.@wdio/protocols/build/types.RectReturn */ /* prop */ x | y | width | height, 
      Double
    ]) & (js.ThisFunction1[
  ...
  extension [Self <: ElementCommandsTypeSync](x: Self) {
    ...
    inline def setGetLocation(
      value: (js.ThisFunction0[/* this */ typings.std.Element, Location]) & (js.ThisFunction1[
          /* this */ typings.std.Element, 
    ...
    inline def setGetSize(
      value: (js.ThisFunction0[/* this */ typings.std.Element, Size]) & (js.ThisFunction1[
          /* this */ typings.std.Element, 
