...
type MultiRemoteBrowser[Mode /* <: sync | async */] = (MultiRemoteBrowserReferenceAsync & MultiRemoteBrowserAsync) | (MultiRemoteBrowserReferenceSync & MultiRemoteBrowserSync)
...
type MultiRemoteElement[Mode /* <: sync | async */] = (MultiRemoteElementReferenceAsync & MultiRemoteElementAsync) | (MultiRemoteElementReferenceSync & MultiRemoteElementSync)
