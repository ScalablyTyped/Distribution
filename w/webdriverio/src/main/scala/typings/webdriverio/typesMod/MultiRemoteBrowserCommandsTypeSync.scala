...
object MultiRemoteBrowserCommandsTypeSync {
  ...
  inline def apply(
    ...
    call: /* args */ Parameters[js.Function1[/* fn */ js.Function0[Any], ThenArg[Any]]] => js.Array[ThenArg[ReturnType[js.Function1[/* fn */ js.Function0[Any], ThenArg[Any]]]]],
