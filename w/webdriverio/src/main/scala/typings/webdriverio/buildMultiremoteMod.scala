...
object buildMultiremoteMod {
  ...
  object MultiRemote {
    ...
    inline def apply(
      ...
      commandWrapper: /* keyof @wdio/protocols.@wdio/protocols.ProtocolCommands & webdriverio.webdriverio/build/types.BrowserCommandsType */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 269, starting with typings.webdriverio.webdriverioStrings.getSessionStorage, typings.webdriverio.webdriverioStrings.getGeoLocation, typings.webdriverio.webdriverioStrings.getElementLocationInView */ Any => js.Function1[/* args */ Any, js.Promise[Any]],
      instances: Record[
          String, 
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify WebdriverIO.Browser */ Any
        ],
