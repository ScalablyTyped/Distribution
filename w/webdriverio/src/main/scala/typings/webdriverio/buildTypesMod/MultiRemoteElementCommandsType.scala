...
/* Inlined {[ K in keyof std.Omit<webdriverio.webdriverio/build/types.ElementCommandsType, webdriverio.webdriverio/build/types.ElementCommandNames> ]: (args : std.Parameters<webdriverio.webdriverio/build/types.ElementCommandsType[K]>): std.Promise<std.Array<@wdio/types.@wdio/types.ThenArg<std.ReturnType<webdriverio.webdriverio/build/types.ElementCommandsType[K]>>>>} & webdriverio.webdriverio/build/types.MultiRemoteElementCommands */
trait MultiRemoteElementCommandsType extends StObject {
...
object MultiRemoteElementCommandsType {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[MultiRemoteElementCommandsType]
  }
  
  extension [Self <: MultiRemoteElementCommandsType](x: Self) {
