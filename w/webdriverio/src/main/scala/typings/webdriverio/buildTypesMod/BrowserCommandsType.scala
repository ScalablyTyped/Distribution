...
/* Inlined std.Omit<webdriverio.webdriverio/build/types.$BrowserCommands, keyof webdriverio.webdriverio/build/types.ChainablePrototype> & webdriverio.webdriverio/build/types.ChainablePrototype */
trait BrowserCommandsType extends StObject {
...
object BrowserCommandsType {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal($ = js.Any.fromFunction1($), custom$ = js.Any.fromFunction1(custom$), react$ = js.Any.fromFunction1(react$), shadow$ = js.Any.fromFunction1(shadow$))
