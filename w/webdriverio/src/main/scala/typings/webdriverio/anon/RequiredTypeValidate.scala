...
trait RequiredTypeValidate extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[/* option */ js.UndefOr[Boolean], Unit]] = js.undefined
}
object RequiredTypeValidate {
  
  inline def apply(`type`: string | number | `object` | boolean | function): RequiredTypeValidate = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequiredTypeValidate]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RequiredTypeValidate] (val x: Self) extends AnyVal {
    ...
    inline def setValidate(value: /* option */ js.UndefOr[Boolean] => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
