...
object `13` {
  ...
  inline def apply(`type`: string | number | `object` | boolean | function): `13` = {
  ...
  extension [Self <: `13`](x: Self) {
    ...
    inline def setDefaultFunction2(value: (/* commandName */ String, /* args */ js.Array[Any]) => Unit): Self = StObject.set(x, "default", js.Any.fromFunction2(value))
