...
trait DefaultMatchRequiredType extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[/* option */ js.UndefOr[js.Array[String]], Unit]] = js.undefined
}
object DefaultMatchRequiredType {
  
  inline def apply(`type`: string | number | `object` | boolean | function): DefaultMatchRequiredType = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[DefaultMatchRequiredType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DefaultMatchRequiredType] (val x: Self) extends AnyVal {
    ...
    inline def setValidate(value: /* option */ js.UndefOr[js.Array[String]] => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
