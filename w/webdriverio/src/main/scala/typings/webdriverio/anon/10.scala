...
trait `10` extends StObject {
  ...
  var default: js.UndefOr[local] = js.undefined
  ...
  var validate: js.UndefOr[js.Function1[/* option */ js.UndefOr[local], Unit]] = js.undefined
}
object `10` {
  
  inline def apply(`type`: string | number | `object` | boolean | function): `10` = {
  ...
  implicit open class MutableBuilder[Self <: `10`] (val x: Self) extends AnyVal {
    ...
    inline def setDefault(value: local): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
    ...
    inline def setValidate(value: /* option */ js.UndefOr[local] => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
