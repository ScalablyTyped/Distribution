...
trait RequiredType extends StObject {
  ...
  var default: js.UndefOr[RemoteCapability] = js.undefined
  ...
  var validate: js.UndefOr[js.Function1[/* option */ RemoteCapability, Unit]] = js.undefined
}
object RequiredType {
  ...
  extension [Self <: RequiredType](x: Self) {
    ...
    inline def setDefault(value: RemoteCapability): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
    ...
    inline def setValidate(value: /* option */ RemoteCapability => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
