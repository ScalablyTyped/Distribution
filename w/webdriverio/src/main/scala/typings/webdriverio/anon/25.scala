...
trait `25` extends StObject {
  ...
  var default: js.UndefOr[AutoCompileConfig] = js.undefined
  ...
  var validate: js.UndefOr[js.Function1[/* option */ js.UndefOr[AutoCompileConfig], Unit]] = js.undefined
}
object `25` {
  
  inline def apply(`type`: string | number | `object` | boolean | function): `25` = {
  ...
  extension [Self <: `25`](x: Self) {
    ...
    inline def setDefault(value: AutoCompileConfig): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
    ...
    inline def setValidate(value: /* option */ js.UndefOr[AutoCompileConfig] => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
