...
trait DefaultMatchRequiredTypeValidate extends StObject {
...
object DefaultMatchRequiredTypeValidate {
  
  inline def apply(`type`: string | number | `object` | boolean | function): DefaultMatchRequiredTypeValidate = {
  ...
  implicit open class MutableBuilder[Self <: DefaultMatchRequiredTypeValidate] (val x: Self) extends AnyVal {
    ...
    inline def setDefaultFunction2(value: (/* oldSessionId */ String, /* newSessionId */ String) => Unit): Self = StObject.set(x, "default", js.Any.fromFunction2(value))
