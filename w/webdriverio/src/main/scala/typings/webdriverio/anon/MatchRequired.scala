...
object MatchRequired {
  ...
  implicit open class MutableBuilder[Self <: MatchRequired] (val x: Self) extends AnyVal {
    ...
    inline def setDefaultFunction1(value: /* suite */ Suite => Unit): Self = StObject.set(x, "default", js.Any.fromFunction1(value))
    
    inline def setDefaultUndefined: Self = StObject.set(x, "default", js.undefined)
    
    inline def setDefaultVarargs(value: (NonNullable[js.UndefOr[js.Function1[/* suite */ Suite, Unit]]])*): Self = StObject.set(x, "default", js.Array(value*))
