...
- Dropped {[ P in 'addCommand' | 'overwriteCommand' | 'options' ]: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify WebdriverIO.Browser * / any[P]} */ @js.native
