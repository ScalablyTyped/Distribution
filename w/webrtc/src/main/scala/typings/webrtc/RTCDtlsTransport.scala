...
object RTCDtlsTransport {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(getRemoteCertificates = js.Any.fromFunction0(getRemoteCertificates), transport = transport.asInstanceOf[js.Any], onstatechange = onstatechange.asInstanceOf[js.Any])
