...
package object webrtc {
  ...
  type DataChannelEventHandler[E /* <: typings.std.Event_ */] = (js.ThisFunction1[/* this */ typings.webrtc.RTCDataChannel, /* ev */ E, js.Any]) | scala.Null
  // https://www.w3.org/TR/webrtc/#idl-def-rtcdtlstransport
  type DtlsTransportEventHandler = (js.ThisFunction1[/* this */ typings.webrtc.RTCDtlsTransport, /* ev */ typings.std.Event_, js.Any]) | scala.Null
  // https://www.w3.org/TR/webrtc/#idl-def-rtcicetransport
  type IceTransportEventHandler = (js.ThisFunction1[/* this */ typings.webrtc.RTCIceTransport, /* ev */ typings.std.Event_, js.Any]) | scala.Null
  ...
  type PeerConnectionEventHandler[E /* <: typings.std.Event_ */] = (js.ThisFunction1[/* this */ typings.webrtc.RTCPeerConnection, /* ev */ E, js.Any]) | scala.Null
