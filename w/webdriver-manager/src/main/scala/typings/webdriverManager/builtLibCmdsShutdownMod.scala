...
object builtLibCmdsShutdownMod {
  
  @JSImport("webdriver-manager/built/lib/cmds/shutdown", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("webdriver-manager/built/lib/cmds/shutdown", "program")
  @js.native
