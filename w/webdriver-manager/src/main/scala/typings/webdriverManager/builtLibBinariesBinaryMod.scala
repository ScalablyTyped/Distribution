...
import typings.webdriverManager.builtLibBinariesConfigSourceMod.ConfigSource
...
object builtLibBinariesBinaryMod {
  ...
  object OS extends StObject {
    ...
    sealed trait Darwin
      extends StObject
         with OS
    /* 2 */ val Darwin: typings.webdriverManager.builtLibBinariesBinaryMod.OS.Darwin & Double = js.native
    
    @js.native
    sealed trait Linux
      extends StObject
         with OS
    /* 1 */ val Linux: typings.webdriverManager.builtLibBinariesBinaryMod.OS.Linux & Double = js.native
    
    @js.native
    sealed trait Windows_NT
      extends StObject
         with OS
    /* 0 */ val Windows_NT: typings.webdriverManager.builtLibBinariesBinaryMod.OS.Windows_NT & Double = js.native
  }
