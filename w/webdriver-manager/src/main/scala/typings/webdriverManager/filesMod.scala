...
object filesMod {
  ...
  object FileManager {
    ...
    /**
      ...
      */
    @scala.inline
    def downloadedBinaries(outputDir: String): BinaryMap[typings.webdriverManager.downloadedBinaryMod.DownloadedBinary] = ^.asInstanceOf[js.Dynamic].applyDynamic("downloadedBinaries")(outputDir.asInstanceOf[js.Any]).asInstanceOf[BinaryMap[typings.webdriverManager.downloadedBinaryMod.DownloadedBinary]]
