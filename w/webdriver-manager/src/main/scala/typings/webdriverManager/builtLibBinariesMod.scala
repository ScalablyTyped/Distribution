...
object builtLibBinariesMod {
  
  @JSImport("webdriver-manager/built/lib/binaries", "AndroidSDK")
  @js.native
  open class AndroidSDK ()
    extends typings.webdriverManager.builtLibBinariesAndroidSdkMod.AndroidSDK {
  ...
  @js.native
  open class Appium ()
    extends typings.webdriverManager.builtLibBinariesAppiumMod.Appium {
    def this(alternateCDN: String) = this()
  }
  /* static members */
  object Appium {
  ...
  /* note: abstract class */ @JSImport("webdriver-manager/built/lib/binaries", "Binary")
  @js.native
  open class Binary ()
    extends typings.webdriverManager.builtLibBinariesBinaryMod.Binary {
  ...
  open class ChromeDriver ()
    extends typings.webdriverManager.builtLibBinariesChromeDriverMod.ChromeDriver {
    def this(opt_alternativeCdn: String) = this()
  }
  /* static members */
  object ChromeDriver {
  ...
  open class GeckoDriver ()
    extends typings.webdriverManager.builtLibBinariesGeckoDriverMod.GeckoDriver {
    def this(opt_alternativeCdn: String) = this()
  }
  /* static members */
  object GeckoDriver {
  ...
  @js.native
  open class IEDriver ()
    extends typings.webdriverManager.builtLibBinariesIedriverMod.IEDriver {
    def this(opt_alternativeCdn: String) = this()
  }
  /* static members */
  object IEDriver {
  ...
  object OS extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.webdriverManager.builtLibBinariesBinaryMod.OS & Double] = js.native
  ...
  open class Standalone ()
    extends typings.webdriverManager.builtLibBinariesStandaloneMod.Standalone {
    def this(opt_alternativeCdn: String) = this()
  }
  /* static members */
  object Standalone {
