...
import typings.webdriverManager.builtLibBinariesBinaryMod.BinaryMap
...
object builtLibFilesMod {
  ...
  open class DownloadedBinary protected ()
    extends typings.webdriverManager.builtLibFilesDownloadedBinaryMod.DownloadedBinary {
  ...
  open class Downloader ()
    extends typings.webdriverManager.builtLibFilesDownloaderMod.Downloader
  /* static members */
  object Downloader {
  ...
  open class FileManager ()
    extends typings.webdriverManager.builtLibFilesFileManagerMod.FileManager
  /* static members */
  object FileManager {
    ...
    /**
      ...
      */
    inline def downloadedBinaries(outputDir: String): BinaryMap[typings.webdriverManager.builtLibFilesDownloadedBinaryMod.DownloadedBinary] = ^.asInstanceOf[js.Dynamic].applyDynamic("downloadedBinaries")(outputDir.asInstanceOf[js.Any]).asInstanceOf[BinaryMap[typings.webdriverManager.builtLibFilesDownloadedBinaryMod.DownloadedBinary]]
    ...
    /**
      ...
      */
    inline def downloadedVersions_[T /* <: Binary */](binary: T, osType: String, arch: String, existingFiles: js.Array[String]): typings.webdriverManager.builtLibFilesDownloadedBinaryMod.DownloadedBinary = (^.asInstanceOf[js.Dynamic].applyDynamic("downloadedVersions_")(binary.asInstanceOf[js.Any], osType.asInstanceOf[js.Any], arch.asInstanceOf[js.Any], existingFiles.asInstanceOf[js.Any])).asInstanceOf[typings.webdriverManager.builtLibFilesDownloadedBinaryMod.DownloadedBinary]
