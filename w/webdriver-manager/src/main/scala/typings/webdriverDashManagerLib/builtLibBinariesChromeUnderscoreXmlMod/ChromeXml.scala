package typings
package webdriverDashManagerLib.builtLibBinariesChromeUnderscoreXmlMod
...
@js.native
class ChromeXml ()
  extends webdriverDashManagerLib.builtLibBinariesConfigUnderscoreSourceMod.XmlConfigSource {
  /**
  ...
  /**
    ...
    */
  def getOsTypeName(): java.lang.String = js.native
  /**
