...
object operatorMod {
  ...
  object Operator {
    ...
    @scala.inline
    def createStream(subscribeFunc: js.Any): AnonymousStream = ^.asInstanceOf[js.Dynamic].applyDynamic("createStream")(subscribeFunc.asInstanceOf[js.Any]).asInstanceOf[AnonymousStream]
    
    @scala.inline
    def empty(): AnonymousStream = ^.asInstanceOf[js.Dynamic].applyDynamic("empty")().asInstanceOf[AnonymousStream]
    
    @scala.inline
    def fromArray(array: js.Array[js.Any]): FromArrayStream = ^.asInstanceOf[js.Dynamic].applyDynamic("fromArray")(array.asInstanceOf[js.Any]).asInstanceOf[FromArrayStream]
    @scala.inline
    def fromArray(array: js.Array[js.Any], scheduler: Scheduler): FromArrayStream = (^.asInstanceOf[js.Dynamic].applyDynamic("fromArray")(array.asInstanceOf[js.Any], scheduler.asInstanceOf[js.Any])).asInstanceOf[FromArrayStream]
  }
  ...
  @scala.inline
  def callFunc_=(x: js.Function2[/* func */ js.Function, /* context */ js.UndefOr[js.Any], AnonymousStream]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("callFunc")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def defer_=(x: js.Function1[/* buildStreamFunc */ js.Function, DeferStream]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defer")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def empty_=(x: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof Operator.empty */ js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("empty")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def fromEvent_=(x: js.Function2[/* dom */ HTMLElement, /* eventName */ String, FromEventPatternStream]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fromEvent")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def fromPromise_=(x: js.Function2[/* promise */ js.Any, /* scheduler */ js.UndefOr[Scheduler], FromPromiseStream]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fromPromise")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def intervalRequest_=(x: js.Function1[/* scheduler */ js.UndefOr[Scheduler], IntervalRequestStream]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("intervalRequest")(x.asInstanceOf[js.Any])
  
  @scala.inline
  def interval_=(x: js.Function2[/* interval */ js.Any, /* scheduler */ js.UndefOr[Scheduler], IntervalStream]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("interval")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def just_=(x: js.Function1[/* returnValue */ js.Any, AnonymousStream]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("just")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def timeout_=(x: js.Function2[/* time */ js.Any, /* scheduler */ js.UndefOr[Scheduler], TimeoutStream]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("timeout")(x.asInstanceOf[js.Any])
}
