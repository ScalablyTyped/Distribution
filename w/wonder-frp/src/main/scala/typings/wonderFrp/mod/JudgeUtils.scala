...
object JudgeUtils {
  ...
  inline def isEqual(ob1: typings.wonderFrp.entityMod.Entity, ob2: typings.wonderFrp.entityMod.Entity): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isEqual")(ob1.asInstanceOf[js.Any], ob2.asInstanceOf[js.Any])).asInstanceOf[Boolean]
