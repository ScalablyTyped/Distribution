...
object ^ extends js.Object {
  ...
  var defer: js.Function1[
    ...
    typings.wonderFrp.streamDeferStreamMod.DeferStream
  ] = js.native
  ...
  var fromNodeCallback: js.Function2[
    /* func */ js.Function, 
    /* context */ js.UndefOr[js.Any], 
    js.Function1[/* repeated */ js.Any, typings.wonderFrp.streamAnonymousStreamMod.AnonymousStream]
  ] = js.native
  ...
  var fromReadableStream: js.Function1[/* stream */ js.Any, typings.wonderFrp.streamAnonymousStreamMod.AnonymousStream] = js.native
  var fromStream: js.Function2[
    /* stream */ js.Any, 
    /* finishEventName */ js.UndefOr[String], 
    typings.wonderFrp.streamAnonymousStreamMod.AnonymousStream
  ] = js.native
  var fromTransformStream: js.Function1[/* stream */ js.Any, typings.wonderFrp.streamAnonymousStreamMod.AnonymousStream] = js.native
  var fromWritableStream: js.Function1[/* stream */ js.Any, typings.wonderFrp.streamAnonymousStreamMod.AnonymousStream] = js.native
  var interval: js.Function2[
    /* interval */ js.Any, 
    /* scheduler */ js.UndefOr[typings.wonderFrp.coreSchedulerMod.Scheduler], 
    typings.wonderFrp.streamIntervalStreamMod.IntervalStream
  ] = js.native
  var intervalRequest: js.Function1[
    /* scheduler */ js.UndefOr[typings.wonderFrp.coreSchedulerMod.Scheduler], 
    typings.wonderFrp.streamIntervalRequestStreamMod.IntervalRequestStream
  ] = js.native
