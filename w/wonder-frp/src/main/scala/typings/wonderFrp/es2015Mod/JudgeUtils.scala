...
object JudgeUtils {
  ...
  inline def isEqual(ob1: typings.wonderFrp.coreEntityMod.Entity, ob2: typings.wonderFrp.coreEntityMod.Entity): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isEqual")(ob1.asInstanceOf[js.Any], ob2.asInstanceOf[js.Any])).asInstanceOf[Boolean]
