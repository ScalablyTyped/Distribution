...
open class FromArrayStream protected ()
  ...
  def this(array: js.Array[Any], scheduler: typings.wonderFrp.coreSchedulerMod.Scheduler) = this()
}
/* static members */
