...
class DoObserver protected ()
  extends typings.wonderDashFrp.distCommonjsObserverDoObserverMod.DoObserver {
...
object DoObserver extends js.Object {
  def create(currentObserver: IObserver, prevObserver: IObserver): typings.wonderDashFrp.distCommonjsObserverDoObserverMod.DoObserver = js.native
}
