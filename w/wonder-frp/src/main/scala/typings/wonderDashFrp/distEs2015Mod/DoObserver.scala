...
class DoObserver protected ()
  extends typings.wonderDashFrp.distEs2015ObserverDoObserverMod.DoObserver {
...
object DoObserver extends js.Object {
  def create(currentObserver: IObserver, prevObserver: IObserver): typings.wonderDashFrp.distEs2015ObserverDoObserverMod.DoObserver = js.native
}
