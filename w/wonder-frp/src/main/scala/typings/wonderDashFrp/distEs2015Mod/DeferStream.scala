...
class DeferStream protected ()
  extends typings.wonderDashFrp.distEs2015StreamDeferStreamMod.DeferStream {
...
object DeferStream extends js.Object {
  def create(buildStreamFunc: js.Function): typings.wonderDashFrp.distEs2015StreamDeferStreamMod.DeferStream = js.native
}
