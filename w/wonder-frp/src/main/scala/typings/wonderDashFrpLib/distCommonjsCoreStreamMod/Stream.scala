package typings
package wonderDashFrpLib.distCommonjsCoreStreamMod
...
abstract class Stream protected ()
  ...
  var scheduler: wonderDashFrpLib.distCommonjsCoreSchedulerMod.Scheduler = js.native
  /* private */ def _isSubject(subject: js.Any): js.Any = js.native
  /* private */ def _setSubject(subject: js.Any): js.Any = js.native
  def buildStream(observer: wonderDashFrpLib.distCommonjsObserverIObserverMod.IObserver): wonderDashFrpLib.distCommonjsDisposableIDisposableMod.IDisposable = js.native
  ...
  def subscribe(arg1: wonderDashFrpLib.distCommonjsSubjectSubjectMod.Subject): wonderDashFrpLib.distCommonjsDisposableIDisposableMod.IDisposable = js.native
  def subscribe(arg1: wonderDashFrpLib.distCommonjsSubjectSubjectMod.Subject, onError: js.Function): wonderDashFrpLib.distCommonjsDisposableIDisposableMod.IDisposable = js.native
  def subscribe(
    arg1: wonderDashFrpLib.distCommonjsSubjectSubjectMod.Subject,
    onError: js.Function,
    onCompleted: js.Function
  ): wonderDashFrpLib.distCommonjsDisposableIDisposableMod.IDisposable = js.native
  def subscribeFunc(observer: wonderDashFrpLib.distCommonjsObserverIObserverMod.IObserver): js.Function | scala.Unit = js.native
