...
object webpackEnvStrings {
  ...
  @js.native
  sealed trait `self-accept-error-handler-errored` extends js.Object
  
  @js.native
  sealed trait `self-accept-errored` extends js.Object
  
  @js.native
  sealed trait `self-declined` extends js.Object
  
  @js.native
  sealed trait sync extends js.Object
  
  @js.native
  sealed trait unaccepted extends js.Object
