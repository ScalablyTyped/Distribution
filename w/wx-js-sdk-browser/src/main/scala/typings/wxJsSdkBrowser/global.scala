...
import typings.wxJsSdkBrowser.wx.AddCardConfig
import typings.wxJsSdkBrowser.wx.CheckApiConfig
import typings.wxJsSdkBrowser.wx.ChooseCardConfig
import typings.wxJsSdkBrowser.wx.ChooseImageConfig
import typings.wxJsSdkBrowser.wx.ChooseWXPayConfig
import typings.wxJsSdkBrowser.wx.DownLoadImageConfig
import typings.wxJsSdkBrowser.wx.DownloadVoiceConfig
import typings.wxJsSdkBrowser.wx.GetLocalImgDataConfig
import typings.wxJsSdkBrowser.wx.GetLocationConfig
import typings.wxJsSdkBrowser.wx.GetNetworkTypeConfig
import typings.wxJsSdkBrowser.wx.MenuItemsConfig
import typings.wxJsSdkBrowser.wx.MenuShareQQ
import typings.wxJsSdkBrowser.wx.MenuShareWeibo
import typings.wxJsSdkBrowser.wx.OnSearchBeaconsConfig
import typings.wxJsSdkBrowser.wx.OpenAddressConfig
import typings.wxJsSdkBrowser.wx.OpenCardConfig
import typings.wxJsSdkBrowser.wx.OpenLocationConfig
import typings.wxJsSdkBrowser.wx.OpenProductSpecificViewConfig
import typings.wxJsSdkBrowser.wx.PreviewImageConfig
import typings.wxJsSdkBrowser.wx.ScanQRCodeConfig
import typings.wxJsSdkBrowser.wx.ShareTimelineConfig
import typings.wxJsSdkBrowser.wx.ShareToTimelineConfig
import typings.wxJsSdkBrowser.wx.ShareToUserConfig
import typings.wxJsSdkBrowser.wx.SharedAppMessage
import typings.wxJsSdkBrowser.wx.StartSearchBeaconsConfig
import typings.wxJsSdkBrowser.wx.StopRecordConfig
import typings.wxJsSdkBrowser.wx.StopSearchBeaconsConfig
import typings.wxJsSdkBrowser.wx.UploadImageConfig
import typings.wxJsSdkBrowser.wx.UploadVoiceConfig
import typings.wxJsSdkBrowser.wx.VoicePlayEndConfig
import typings.wxJsSdkBrowser.wx.VoiceRecordEndConfig
import typings.wxJsSdkBrowser.wx.WxConfig
...
object global {
  ...
  object wx {
    ...
    open class OpenCardObj ()
      extends StObject
         with typings.wxJsSdkBrowser.wx.OpenCardObj {
    ...
    /**
      ...
      */
    inline def getNetworkType(config: GetNetworkTypeConfig): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getNetworkType")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
    ...
    /**
      * 停止播放后的回调
      */
    inline def onVoicePlayEnd(config: VoicePlayEndConfig): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onVoicePlayEnd")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
    
    /**
      * 录音时间超过一分钟没有停止的时候会执行回调
      */
    inline def onVoiceRecordEnd(config: VoiceRecordEndConfig): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onVoiceRecordEnd")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
    ...
    /**
      * 停止录音
      */
    inline def stopRecord(config: StopRecordConfig): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("stopRecord")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
