...
object distSrcOnStageGeneralDistComponentsTextStyle1SmallMod extends Shortcut {
  ...
  object TextStyle1SmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TextStyle1SmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcOnStageGeneralDistComponentsTextStyle1SmallMod.foo` */
