package typings.wixUiIconsCommon.circleSmallFilledSmallMod
...
object CircleSmallFilledSmallProps {
  ...
  @scala.inline
  implicit class CircleSmallFilledSmallPropsOps[Self <: CircleSmallFilledSmallProps] (val x: Self) extends AnyVal {
