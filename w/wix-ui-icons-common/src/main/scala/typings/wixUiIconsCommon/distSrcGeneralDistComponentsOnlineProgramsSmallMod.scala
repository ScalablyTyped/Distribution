...
object distSrcGeneralDistComponentsOnlineProgramsSmallMod extends Shortcut {
  ...
  object OnlineProgramsSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: OnlineProgramsSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsOnlineProgramsSmallMod.foo` */
