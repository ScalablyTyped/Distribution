...
object distSrcGeneralDistComponentsTemplateMod extends Shortcut {
  ...
  object TemplateProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TemplateProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsTemplateMod.foo` */
