...
object distSrcGeneralDistComponentsSquareCornerSmallMod extends Shortcut {
  ...
  object SquareCornerSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SquareCornerSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsSquareCornerSmallMod.foo` */
