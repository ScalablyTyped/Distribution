...
object distSrcGeneralDistComponentsDocMovetoSmallMod extends Shortcut {
  ...
  object DocMovetoSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: DocMovetoSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsDocMovetoSmallMod.foo` */
