package typings.wixUiIconsCommon.socialButtonTwitterMod
...
object SocialButtonTwitterProps {
  ...
  @scala.inline
  implicit class SocialButtonTwitterPropsOps[Self <: SocialButtonTwitterProps] (val x: Self) extends AnyVal {
