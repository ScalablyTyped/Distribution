...
object distSrcGeneralDistComponentsCommentAddMod extends Shortcut {
  ...
  object CommentAddProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CommentAddProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsCommentAddMod.foo` */
