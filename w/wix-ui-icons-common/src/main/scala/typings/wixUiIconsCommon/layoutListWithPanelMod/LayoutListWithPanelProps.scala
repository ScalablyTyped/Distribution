package typings.wixUiIconsCommon.layoutListWithPanelMod
...
object LayoutListWithPanelProps {
  ...
  @scala.inline
  implicit class LayoutListWithPanelPropsOps[Self <: LayoutListWithPanelProps] (val x: Self) extends AnyVal {
