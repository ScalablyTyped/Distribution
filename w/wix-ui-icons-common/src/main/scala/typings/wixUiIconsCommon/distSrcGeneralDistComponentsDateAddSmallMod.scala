...
object distSrcGeneralDistComponentsDateAddSmallMod extends Shortcut {
  ...
  object DateAddSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: DateAddSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsDateAddSmallMod.foo` */
