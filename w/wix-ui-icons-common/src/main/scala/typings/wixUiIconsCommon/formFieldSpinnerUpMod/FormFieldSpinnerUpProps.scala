package typings.wixUiIconsCommon.formFieldSpinnerUpMod
...
object FormFieldSpinnerUpProps {
  ...
  @scala.inline
  implicit class FormFieldSpinnerUpPropsOps[Self <: FormFieldSpinnerUpProps] (val x: Self) extends AnyVal {
