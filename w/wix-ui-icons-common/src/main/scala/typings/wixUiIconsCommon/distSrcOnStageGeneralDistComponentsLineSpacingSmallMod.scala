...
object distSrcOnStageGeneralDistComponentsLineSpacingSmallMod extends Shortcut {
  ...
  object LineSpacingSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: LineSpacingSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcOnStageGeneralDistComponentsLineSpacingSmallMod.foo` */
