package typings.wixUiIconsCommon.contentFilterSmallMod
...
object ContentFilterSmallProps {
  ...
  @scala.inline
  implicit class ContentFilterSmallPropsOps[Self <: ContentFilterSmallProps] (val x: Self) extends AnyVal {
