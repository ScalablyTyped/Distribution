...
object distSrcGeneralDistComponentsUserSearchMod extends Shortcut {
  ...
  object UserSearchProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: UserSearchProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsUserSearchMod.foo` */
