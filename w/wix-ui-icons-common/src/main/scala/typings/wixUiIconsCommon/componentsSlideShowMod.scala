...
object componentsSlideShowMod extends Shortcut {
  ...
  object SlideShowProps {
    ...
    extension [Self <: SlideShowProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `componentsSlideShowMod.foo` */
