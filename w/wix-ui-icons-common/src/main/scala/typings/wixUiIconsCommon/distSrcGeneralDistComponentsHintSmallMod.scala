...
object distSrcGeneralDistComponentsHintSmallMod extends Shortcut {
  ...
  object HintSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: HintSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsHintSmallMod.foo` */
