package typings.wixUiIconsCommon.rectangleLargeSmallMod
...
object RectangleLargeSmallProps {
  ...
  @scala.inline
  implicit class RectangleLargeSmallPropsOps[Self <: RectangleLargeSmallProps] (val x: Self) extends AnyVal {
