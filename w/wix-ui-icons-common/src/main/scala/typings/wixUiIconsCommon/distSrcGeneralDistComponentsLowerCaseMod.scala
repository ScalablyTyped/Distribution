...
object distSrcGeneralDistComponentsLowerCaseMod extends Shortcut {
  ...
  object LowerCaseProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: LowerCaseProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsLowerCaseMod.foo` */
