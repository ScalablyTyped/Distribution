...
object distSrcGeneralDistComponentsStatusCompleteFilledMod extends Shortcut {
  ...
  object StatusCompleteFilledProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StatusCompleteFilledProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsStatusCompleteFilledMod.foo` */
