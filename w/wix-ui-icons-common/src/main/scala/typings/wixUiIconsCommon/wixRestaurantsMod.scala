...
import typings.wixUiIconsCommon.componentsWixRestaurantsMod.WixRestaurantsProps
...
object wixRestaurantsMod extends Shortcut {
  ...
  @JSImport("wix-ui-icons-common/classic-editor/WixRestaurants", JSImport.Default)
  @js.native
