...
object distSrcGeneralDistComponentsMoveToSmallMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsMoveToSmallMod.foo` */
