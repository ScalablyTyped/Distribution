...
object componentsMaximizeSmallMod extends Shortcut {
  
  @JSImport("wix-ui-icons-common/dist/src/on-stage/general/dist/components/MaximizeSmall", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `componentsMaximizeSmallMod.foo` */
