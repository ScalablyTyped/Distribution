...
object distSrcGeneralDistComponentsWixFormsSmallMod extends Shortcut {
  ...
  object WixFormsSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: WixFormsSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsWixFormsSmallMod.foo` */
