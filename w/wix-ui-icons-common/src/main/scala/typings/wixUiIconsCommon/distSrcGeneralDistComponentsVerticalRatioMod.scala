...
object distSrcGeneralDistComponentsVerticalRatioMod extends Shortcut {
  ...
  object VerticalRatioProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: VerticalRatioProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsVerticalRatioMod.foo` */
