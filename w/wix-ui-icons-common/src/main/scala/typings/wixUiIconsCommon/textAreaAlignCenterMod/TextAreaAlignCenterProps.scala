package typings.wixUiIconsCommon.textAreaAlignCenterMod
...
object TextAreaAlignCenterProps {
  ...
  @scala.inline
  implicit class TextAreaAlignCenterPropsOps[Self <: TextAreaAlignCenterProps] (val x: Self) extends AnyVal {
