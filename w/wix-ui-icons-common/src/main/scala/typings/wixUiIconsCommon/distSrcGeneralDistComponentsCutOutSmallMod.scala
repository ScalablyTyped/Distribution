...
object distSrcGeneralDistComponentsCutOutSmallMod extends Shortcut {
  ...
  object CutOutSmallProps {
    ...
    extension [Self <: CutOutSmallProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsCutOutSmallMod.foo` */
