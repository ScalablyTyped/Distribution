...
object distSrcGeneralDistComponentsAlignTopMod extends Shortcut {
  ...
  object AlignTopProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: AlignTopProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsAlignTopMod.foo` */
