package typings.wixUiIconsCommon.textAreaBulletListMod
...
object TextAreaBulletListProps {
  ...
  @scala.inline
  implicit class TextAreaBulletListPropsOps[Self <: TextAreaBulletListProps] (val x: Self) extends AnyVal {
