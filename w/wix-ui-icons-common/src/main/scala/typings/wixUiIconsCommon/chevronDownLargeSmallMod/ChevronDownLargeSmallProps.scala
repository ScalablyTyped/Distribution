package typings.wixUiIconsCommon.chevronDownLargeSmallMod
...
object ChevronDownLargeSmallProps {
  ...
  @scala.inline
  implicit class ChevronDownLargeSmallPropsOps[Self <: ChevronDownLargeSmallProps] (val x: Self) extends AnyVal {
