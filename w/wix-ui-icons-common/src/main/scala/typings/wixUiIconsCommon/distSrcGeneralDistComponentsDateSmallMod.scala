...
object distSrcGeneralDistComponentsDateSmallMod extends Shortcut {
  ...
  object DateSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: DateSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsDateSmallMod.foo` */
