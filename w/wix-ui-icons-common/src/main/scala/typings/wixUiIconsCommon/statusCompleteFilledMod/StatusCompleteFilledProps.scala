package typings.wixUiIconsCommon.statusCompleteFilledMod
...
object StatusCompleteFilledProps {
  ...
  @scala.inline
  implicit class StatusCompleteFilledPropsOps[Self <: StatusCompleteFilledProps] (val x: Self) extends AnyVal {
