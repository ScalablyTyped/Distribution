...
object distSrcGeneralDistComponentsHorizontalRatioMod extends Shortcut {
  ...
  object HorizontalRatioProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: HorizontalRatioProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsHorizontalRatioMod.foo` */
