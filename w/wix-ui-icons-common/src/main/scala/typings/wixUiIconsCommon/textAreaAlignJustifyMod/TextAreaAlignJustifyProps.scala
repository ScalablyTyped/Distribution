package typings.wixUiIconsCommon.textAreaAlignJustifyMod
...
object TextAreaAlignJustifyProps {
  ...
  @scala.inline
  implicit class TextAreaAlignJustifyPropsOps[Self <: TextAreaAlignJustifyProps] (val x: Self) extends AnyVal {
