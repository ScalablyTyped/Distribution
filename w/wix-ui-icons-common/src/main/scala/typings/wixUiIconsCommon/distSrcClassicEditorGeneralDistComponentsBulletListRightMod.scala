...
object distSrcClassicEditorGeneralDistComponentsBulletListRightMod extends Shortcut {
  
  @JSImport("wix-ui-icons-common/dist/src/classic-editor/general/dist/components/BulletListRight", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcClassicEditorGeneralDistComponentsBulletListRightMod.foo` */
