...
object distSrcGeneralDistComponentsTemperatureSmallMod extends Shortcut {
  ...
  object TemperatureSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TemperatureSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsTemperatureSmallMod.foo` */
