...
object distSrcGeneralDistComponentsAutomationsFilledSmallMod extends Shortcut {
  ...
  object AutomationsFilledSmallProps {
    ...
    extension [Self <: AutomationsFilledSmallProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsAutomationsFilledSmallMod.foo` */
