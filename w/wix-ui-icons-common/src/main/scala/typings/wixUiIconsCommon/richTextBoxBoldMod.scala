...
import typings.wixUiIconsCommon.componentsRichTextBoxBoldMod.RichTextBoxBoldProps
...
object richTextBoxBoldMod extends Shortcut {
  ...
  @JSImport("wix-ui-icons-common/classic-editor/RichTextBoxBold", JSImport.Default)
  @js.native
