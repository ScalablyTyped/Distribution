package typings.wixUiIconsCommon.textAreaAlignRightMod
...
object TextAreaAlignRightProps {
  ...
  @scala.inline
  implicit class TextAreaAlignRightPropsOps[Self <: TextAreaAlignRightProps] (val x: Self) extends AnyVal {
