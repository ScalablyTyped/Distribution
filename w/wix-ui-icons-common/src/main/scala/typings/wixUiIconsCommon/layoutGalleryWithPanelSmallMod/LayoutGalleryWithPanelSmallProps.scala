package typings.wixUiIconsCommon.layoutGalleryWithPanelSmallMod
...
object LayoutGalleryWithPanelSmallProps {
  ...
  @scala.inline
  implicit class LayoutGalleryWithPanelSmallPropsOps[Self <: LayoutGalleryWithPanelSmallProps] (val x: Self) extends AnyVal {
