...
object distSrcGeneralDistComponentsCutlerySmallMod extends Shortcut {
  ...
  object CutlerySmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CutlerySmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsCutlerySmallMod.foo` */
