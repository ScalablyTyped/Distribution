...
import typings.wixUiIconsCommon.componentsAddressInputBoldMod.AddressInputBoldProps
...
object addressInputBoldMod extends Shortcut {
  ...
  @JSImport("wix-ui-icons-common/classic-editor/AddressInputBold", JSImport.Default)
  @js.native
