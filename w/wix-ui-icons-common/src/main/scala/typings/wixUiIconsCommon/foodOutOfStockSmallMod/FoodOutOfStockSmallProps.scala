package typings.wixUiIconsCommon.foodOutOfStockSmallMod
...
object FoodOutOfStockSmallProps {
  ...
  @scala.inline
  implicit class FoodOutOfStockSmallPropsOps[Self <: FoodOutOfStockSmallProps] (val x: Self) extends AnyVal {
