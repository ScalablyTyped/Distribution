...
object distSrcGeneralDistComponentsSiteDuplicateMod extends Shortcut {
  ...
  object SiteDuplicateProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SiteDuplicateProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsSiteDuplicateMod.foo` */
