package typings.wixUiIconsCommon.distributeGlobeSmallMod
...
object DistributeGlobeSmallProps {
  ...
  @scala.inline
  implicit class DistributeGlobeSmallPropsOps[Self <: DistributeGlobeSmallProps] (val x: Self) extends AnyVal {
