...
object distSrcClassicEditorGeneralDistComponentsConfirmBoldMod extends Shortcut {
  ...
  object ConfirmBoldProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ConfirmBoldProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcClassicEditorGeneralDistComponentsConfirmBoldMod.foo` */
