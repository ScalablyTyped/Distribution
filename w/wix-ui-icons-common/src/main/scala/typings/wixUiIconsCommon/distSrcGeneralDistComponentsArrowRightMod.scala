...
object distSrcGeneralDistComponentsArrowRightMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsArrowRightMod.foo` */
