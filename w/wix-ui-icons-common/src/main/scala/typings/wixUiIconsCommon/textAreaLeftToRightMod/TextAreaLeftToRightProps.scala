package typings.wixUiIconsCommon.textAreaLeftToRightMod
...
object TextAreaLeftToRightProps {
  ...
  @scala.inline
  implicit class TextAreaLeftToRightPropsOps[Self <: TextAreaLeftToRightProps] (val x: Self) extends AnyVal {
