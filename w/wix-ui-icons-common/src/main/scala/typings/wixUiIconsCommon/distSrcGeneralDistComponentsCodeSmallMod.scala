...
object distSrcGeneralDistComponentsCodeSmallMod extends Shortcut {
  ...
  object CodeSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CodeSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsCodeSmallMod.foo` */
