package typings.wixUiIconsCommon.squareRatioCheckedMod
...
object SquareRatioCheckedProps {
  ...
  @scala.inline
  implicit class SquareRatioCheckedPropsOps[Self <: SquareRatioCheckedProps] (val x: Self) extends AnyVal {
