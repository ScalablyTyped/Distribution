...
object distSrcOnStageSystemDistComponentsCommentLargeMod extends Shortcut {
  ...
  object CommentLargeProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CommentLargeProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcOnStageSystemDistComponentsCommentLargeMod.foo` */
