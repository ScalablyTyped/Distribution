...
object distSrcOnStageGeneralDistComponentsTagSmallMod extends Shortcut {
  ...
  object TagSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TagSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcOnStageGeneralDistComponentsTagSmallMod.foo` */
