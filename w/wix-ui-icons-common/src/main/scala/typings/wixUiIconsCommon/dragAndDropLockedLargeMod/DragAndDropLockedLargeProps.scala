package typings.wixUiIconsCommon.dragAndDropLockedLargeMod
...
object DragAndDropLockedLargeProps {
  ...
  @scala.inline
  implicit class DragAndDropLockedLargePropsOps[Self <: DragAndDropLockedLargeProps] (val x: Self) extends AnyVal {
