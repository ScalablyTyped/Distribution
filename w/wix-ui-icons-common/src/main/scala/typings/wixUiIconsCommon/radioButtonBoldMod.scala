...
import typings.wixUiIconsCommon.componentsRadioButtonBoldMod.RadioButtonBoldProps
...
object radioButtonBoldMod extends Shortcut {
  ...
  @JSImport("wix-ui-icons-common/classic-editor/RadioButtonBold", JSImport.Default)
  @js.native
