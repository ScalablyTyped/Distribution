...
object distSrcOnStageGeneralDistComponentsReplySmallMod extends Shortcut {
  ...
  object ReplySmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ReplySmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcOnStageGeneralDistComponentsReplySmallMod.foo` */
