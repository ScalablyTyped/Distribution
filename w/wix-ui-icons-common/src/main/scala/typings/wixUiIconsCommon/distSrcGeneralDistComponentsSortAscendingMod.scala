...
object distSrcGeneralDistComponentsSortAscendingMod extends Shortcut {
  ...
  object SortAscendingProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SortAscendingProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsSortAscendingMod.foo` */
