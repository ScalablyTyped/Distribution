package typings.wixUiIconsCommon.chevronUpLargeSmallMod
...
object ChevronUpLargeSmallProps {
  ...
  @scala.inline
  implicit class ChevronUpLargeSmallPropsOps[Self <: ChevronUpLargeSmallProps] (val x: Self) extends AnyVal {
