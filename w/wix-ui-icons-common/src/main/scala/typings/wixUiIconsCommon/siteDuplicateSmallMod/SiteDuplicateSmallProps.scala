package typings.wixUiIconsCommon.siteDuplicateSmallMod
...
object SiteDuplicateSmallProps {
  ...
  @scala.inline
  implicit class SiteDuplicateSmallPropsOps[Self <: SiteDuplicateSmallProps] (val x: Self) extends AnyVal {
