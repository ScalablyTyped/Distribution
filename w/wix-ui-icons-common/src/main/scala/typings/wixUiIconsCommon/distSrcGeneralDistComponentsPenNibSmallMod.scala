...
object distSrcGeneralDistComponentsPenNibSmallMod extends Shortcut {
  ...
  object PenNibSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PenNibSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsPenNibSmallMod.foo` */
