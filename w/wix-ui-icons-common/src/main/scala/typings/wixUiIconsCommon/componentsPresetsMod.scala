...
object componentsPresetsMod extends Shortcut {
  ...
  object PresetsProps {
    ...
    extension [Self <: PresetsProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `componentsPresetsMod.foo` */
