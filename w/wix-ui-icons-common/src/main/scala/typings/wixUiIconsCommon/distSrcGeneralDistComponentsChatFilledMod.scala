...
object distSrcGeneralDistComponentsChatFilledMod extends Shortcut {
  ...
  object ChatFilledProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ChatFilledProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsChatFilledMod.foo` */
