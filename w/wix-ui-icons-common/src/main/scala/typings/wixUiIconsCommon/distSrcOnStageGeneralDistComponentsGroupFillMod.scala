...
object distSrcOnStageGeneralDistComponentsGroupFillMod extends Shortcut {
  ...
  object GroupFillProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: GroupFillProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcOnStageGeneralDistComponentsGroupFillMod.foo` */
