...
object distSrcClassicEditorGeneralDistComponentsSearchBoldMod extends Shortcut {
  ...
  object SearchBoldProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SearchBoldProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcClassicEditorGeneralDistComponentsSearchBoldMod.foo` */
