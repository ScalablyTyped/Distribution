...
object distSrcGeneralDistComponentsWixFormsFilledSmallMod extends Shortcut {
  ...
  object WixFormsFilledSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: WixFormsFilledSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsWixFormsFilledSmallMod.foo` */
