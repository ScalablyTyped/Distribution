package typings.wixUiIconsCommon.socialButtonInstagramMod
...
object SocialButtonInstagramProps {
  ...
  @scala.inline
  implicit class SocialButtonInstagramPropsOps[Self <: SocialButtonInstagramProps] (val x: Self) extends AnyVal {
