...
object distSrcGeneralDistComponentsChatDisabledMod extends Shortcut {
  ...
  object ChatDisabledProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ChatDisabledProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsChatDisabledMod.foo` */
