...
object componentsSpacingBoldMod extends Shortcut {
  ...
  object SpacingBoldProps {
    ...
    extension [Self <: SpacingBoldProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `componentsSpacingBoldMod.foo` */
