...
object distSrcGeneralDistComponentsSquareRatioMod extends Shortcut {
  ...
  object SquareRatioProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SquareRatioProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsSquareRatioMod.foo` */
