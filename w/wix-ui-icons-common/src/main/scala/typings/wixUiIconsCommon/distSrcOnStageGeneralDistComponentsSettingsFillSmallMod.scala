...
object distSrcOnStageGeneralDistComponentsSettingsFillSmallMod extends Shortcut {
  ...
  object SettingsFillSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SettingsFillSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcOnStageGeneralDistComponentsSettingsFillSmallMod.foo` */
