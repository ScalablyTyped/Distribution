...
object distSrcGeneralDistComponentsRenameSmallMod extends Shortcut {
  ...
  object RenameSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: RenameSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsRenameSmallMod.foo` */
