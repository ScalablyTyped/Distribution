...
object distSrcGeneralDistComponentsSortAscendingSmallMod extends Shortcut {
  ...
  object SortAscendingSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SortAscendingSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsSortAscendingSmallMod.foo` */
