...
object distSrcGeneralDistComponentsVolumeSmallMod extends Shortcut {
  ...
  object VolumeSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: VolumeSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsVolumeSmallMod.foo` */
