package typings.wixUiIconsCommon.documentExpireSmallMod
...
object DocumentExpireSmallProps {
  ...
  @scala.inline
  implicit class DocumentExpireSmallPropsOps[Self <: DocumentExpireSmallProps] (val x: Self) extends AnyVal {
