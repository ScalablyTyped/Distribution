...
object distSrcGeneralDistComponentsLineChartSmallMod extends Shortcut {
  ...
  object LineChartSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: LineChartSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsLineChartSmallMod.foo` */
