...
object distSrcGeneralDistComponentsToolboxSmallMod extends Shortcut {
  ...
  object ToolboxSmallProps {
    ...
    extension [Self <: ToolboxSmallProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsToolboxSmallMod.foo` */
