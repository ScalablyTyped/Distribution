...
object distSrcClassicEditorGeneralDistComponentsImageEffectSmallMod extends Shortcut {
  ...
  object ImageEffectSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ImageEffectSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcClassicEditorGeneralDistComponentsImageEffectSmallMod.foo` */
