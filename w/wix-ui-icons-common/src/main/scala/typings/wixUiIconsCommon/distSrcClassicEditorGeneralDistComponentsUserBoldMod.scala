...
object distSrcClassicEditorGeneralDistComponentsUserBoldMod extends Shortcut {
  ...
  object UserBoldProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: UserBoldProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcClassicEditorGeneralDistComponentsUserBoldMod.foo` */
