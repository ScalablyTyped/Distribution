package typings.wixUiIconsCommon.alignCenterVerticallyMod
...
object AlignCenterVerticallyProps {
  ...
  @scala.inline
  implicit class AlignCenterVerticallyPropsOps[Self <: AlignCenterVerticallyProps] (val x: Self) extends AnyVal {
