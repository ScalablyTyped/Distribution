...
object distSrcGeneralDistComponentsTaskArchiveSmallMod extends Shortcut {
  ...
  object TaskArchiveSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TaskArchiveSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsTaskArchiveSmallMod.foo` */
