...
object distSrcGeneralDistComponentsTabletSmallMod extends Shortcut {
  ...
  object TabletSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TabletSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsTabletSmallMod.foo` */
