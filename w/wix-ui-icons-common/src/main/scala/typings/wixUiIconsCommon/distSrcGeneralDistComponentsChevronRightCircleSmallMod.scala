...
object distSrcGeneralDistComponentsChevronRightCircleSmallMod extends Shortcut {
  ...
  object ChevronRightCircleSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ChevronRightCircleSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsChevronRightCircleSmallMod.foo` */
