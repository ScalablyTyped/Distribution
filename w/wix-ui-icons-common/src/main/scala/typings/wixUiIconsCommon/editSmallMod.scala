...
object editSmallMod extends Shortcut {
  ...
  @js.native
  trait EditSmallProps extends SVGAttributes[SVGElement] {
  ...
  object EditSmallProps {
    ...
    @scala.inline
    def apply(): EditSmallProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[EditSmallProps]
    }
    
    @scala.inline
    implicit class EditSmallPropsMutableBuilder[Self <: EditSmallProps] (val x: Self) extends AnyVal {
