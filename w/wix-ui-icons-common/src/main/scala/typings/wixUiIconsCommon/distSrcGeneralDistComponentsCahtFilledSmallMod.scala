...
object distSrcGeneralDistComponentsCahtFilledSmallMod extends Shortcut {
  ...
  object CahtFilledSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CahtFilledSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsCahtFilledSmallMod.foo` */
