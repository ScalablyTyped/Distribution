...
object distSrcSystemDistComponentsMoveLargeMod extends Shortcut {
  ...
  object MoveLargeProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: MoveLargeProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcSystemDistComponentsMoveLargeMod.foo` */
