...
object distSrcGeneralDistComponentsDocumentExpireMod extends Shortcut {
  ...
  object DocumentExpireProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: DocumentExpireProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsDocumentExpireMod.foo` */
