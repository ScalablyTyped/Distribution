package typings.wixUiIconsCommon.statusCompletetFilledMod
...
object StatusCompletetFilledProps {
  ...
  @scala.inline
  implicit class StatusCompletetFilledPropsOps[Self <: StatusCompletetFilledProps] (val x: Self) extends AnyVal {
