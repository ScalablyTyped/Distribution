...
object distSrcGeneralDistComponentsRoundedCornerMod extends Shortcut {
  
  @JSImport("wix-ui-icons-common/dist/src/general/dist/components/RoundedCorner", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsRoundedCornerMod.foo` */
