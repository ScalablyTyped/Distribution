...
object distSrcGeneralDistComponentsStatusStopSmallMod extends Shortcut {
  ...
  object StatusStopSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StatusStopSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsStatusStopSmallMod.foo` */
