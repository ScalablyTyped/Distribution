package typings.wixUiIconsCommon.accessibilitySmallMod
...
object AccessibilitySmallProps {
  ...
  @scala.inline
  implicit class AccessibilitySmallPropsOps[Self <: AccessibilitySmallProps] (val x: Self) extends AnyVal {
