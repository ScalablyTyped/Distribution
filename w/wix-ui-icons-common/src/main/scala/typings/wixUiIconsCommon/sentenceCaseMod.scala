...
object sentenceCaseMod extends Shortcut {
  ...
  @js.native
  trait SentenceCaseProps extends SVGAttributes[SVGElement] {
  ...
  object SentenceCaseProps {
    ...
    @scala.inline
    def apply(): SentenceCaseProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SentenceCaseProps]
    }
    
    @scala.inline
    implicit class SentenceCasePropsMutableBuilder[Self <: SentenceCaseProps] (val x: Self) extends AnyVal {
