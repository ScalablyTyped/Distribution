...
object distSrcGeneralDistComponentsLayoutListWithPanelSmallMod extends Shortcut {
  ...
  object LayoutListWithPanelSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: LayoutListWithPanelSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsLayoutListWithPanelSmallMod.foo` */
