...
object distSrcGeneralDistComponentsCancelOrderMod extends Shortcut {
  ...
  object CancelOrderProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CancelOrderProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsCancelOrderMod.foo` */
