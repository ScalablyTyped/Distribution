...
object distSrcOnStageSystemDistComponentsImageLargeMod extends Shortcut {
  ...
  object ImageLargeProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ImageLargeProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcOnStageSystemDistComponentsImageLargeMod.foo` */
