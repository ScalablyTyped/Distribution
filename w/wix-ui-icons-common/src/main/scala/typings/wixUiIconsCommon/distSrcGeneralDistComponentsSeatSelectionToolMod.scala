...
object distSrcGeneralDistComponentsSeatSelectionToolMod extends Shortcut {
  ...
  object SeatSelectionToolProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SeatSelectionToolProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsSeatSelectionToolMod.foo` */
