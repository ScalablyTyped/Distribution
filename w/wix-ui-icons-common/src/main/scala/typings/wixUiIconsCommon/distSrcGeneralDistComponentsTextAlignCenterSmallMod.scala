...
object distSrcGeneralDistComponentsTextAlignCenterSmallMod extends Shortcut {
  ...
  object TextAlignCenterSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TextAlignCenterSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsTextAlignCenterSmallMod.foo` */
