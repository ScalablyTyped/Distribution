...
object distSrcOnStageReactionsDistComponentsSmileyTearsSmallMod extends Shortcut {
  ...
  object SmileyTearsSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SmileyTearsSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcOnStageReactionsDistComponentsSmileyTearsSmallMod.foo` */
