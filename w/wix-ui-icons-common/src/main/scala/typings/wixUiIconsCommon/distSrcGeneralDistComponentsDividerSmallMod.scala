...
object distSrcGeneralDistComponentsDividerSmallMod extends Shortcut {
  ...
  object DividerSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: DividerSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsDividerSmallMod.foo` */
