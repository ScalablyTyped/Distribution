...
object distSrcGeneralDistComponentsVerticalRatioSmallMod extends Shortcut {
  ...
  object VerticalRatioSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: VerticalRatioSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsVerticalRatioSmallMod.foo` */
