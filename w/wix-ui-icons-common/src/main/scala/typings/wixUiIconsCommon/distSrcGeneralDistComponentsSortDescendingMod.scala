...
object distSrcGeneralDistComponentsSortDescendingMod extends Shortcut {
  ...
  object SortDescendingProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SortDescendingProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsSortDescendingMod.foo` */
