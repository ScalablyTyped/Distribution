...
object distSrcSystemDistComponentsSocialButtonTwitterMod extends Shortcut {
  ...
  object SocialButtonTwitterProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SocialButtonTwitterProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcSystemDistComponentsSocialButtonTwitterMod.foo` */
