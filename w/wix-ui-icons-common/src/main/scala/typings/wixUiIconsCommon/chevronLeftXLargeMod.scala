...
object chevronLeftXLargeMod extends Shortcut {
  ...
  object ChevronLeftXLargeProps {
    ...
    extension [Self <: ChevronLeftXLargeProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `chevronLeftXLargeMod.foo` */
