...
object distComponentsEsignatureMod extends Shortcut {
  
  @JSImport("wix-ui-icons-common/dist/src/general/dist/components/ESignature", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distComponentsEsignatureMod.foo` */
