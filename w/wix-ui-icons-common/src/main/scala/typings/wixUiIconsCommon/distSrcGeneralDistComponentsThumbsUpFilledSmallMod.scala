...
object distSrcGeneralDistComponentsThumbsUpFilledSmallMod extends Shortcut {
  ...
  object ThumbsUpFilledSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ThumbsUpFilledSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsThumbsUpFilledSmallMod.foo` */
