...
object distSrcGeneralDistComponentsHideSidebarMod extends Shortcut {
  ...
  object HideSidebarProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: HideSidebarProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsHideSidebarMod.foo` */
