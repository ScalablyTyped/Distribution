...
object distSrcGeneralDistComponentsVimeoSmallMod extends Shortcut {
  ...
  object VimeoSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: VimeoSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsVimeoSmallMod.foo` */
