...
object distSrcClassicEditorGeneralDistComponentsPhoneBoldMod extends Shortcut {
  ...
  object PhoneBoldProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PhoneBoldProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcClassicEditorGeneralDistComponentsPhoneBoldMod.foo` */
