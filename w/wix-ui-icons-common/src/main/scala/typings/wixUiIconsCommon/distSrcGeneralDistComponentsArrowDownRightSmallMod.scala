...
object distSrcGeneralDistComponentsArrowDownRightSmallMod extends Shortcut {
  ...
  object ArrowDownRightSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ArrowDownRightSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsArrowDownRightSmallMod.foo` */
