...
import typings.wixUiIconsCommon.componentsLinkPropertiesMod.LinkPropertiesProps
...
object linkPropertiesMod extends Shortcut {
  ...
  @JSImport("wix-ui-icons-common/classic-editor/LinkProperties", JSImport.Default)
  @js.native
