...
object distSrcGeneralDistComponentsPromoteFilledSmallMod extends Shortcut {
  ...
  object PromoteFilledSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PromoteFilledSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsPromoteFilledSmallMod.foo` */
