...
object distSrcGeneralDistComponentsPauseFilledSmallMod extends Shortcut {
  ...
  object PauseFilledSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PauseFilledSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsPauseFilledSmallMod.foo` */
