...
object distSrcGeneralDistComponentsCartSmallMod extends Shortcut {
  ...
  object CartSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CartSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsCartSmallMod.foo` */
