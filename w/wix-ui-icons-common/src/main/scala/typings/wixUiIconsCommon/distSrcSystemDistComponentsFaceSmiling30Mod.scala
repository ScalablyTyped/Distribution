...
object distSrcSystemDistComponentsFaceSmiling30Mod extends Shortcut {
  ...
  object FaceSmiling30Props {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: FaceSmiling30Props] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcSystemDistComponentsFaceSmiling30Mod.foo` */
