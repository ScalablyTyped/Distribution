...
object distSrcGeneralDistComponentsTshirtsmallMod extends Shortcut {
  ...
  object TShirtSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TShirtSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsTshirtsmallMod.foo` */
