...
object unionMod extends Shortcut {
  ...
  @js.native
  trait UnionProps extends SVGAttributes[SVGElement] {
  ...
  object UnionProps {
    ...
    @scala.inline
    def apply(): UnionProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[UnionProps]
    }
    
    @scala.inline
    implicit class UnionPropsMutableBuilder[Self <: UnionProps] (val x: Self) extends AnyVal {
