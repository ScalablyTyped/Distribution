...
object distSrcGeneralDistComponentsEmailFilledSmallMod extends Shortcut {
  ...
  object EmailFilledSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: EmailFilledSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsEmailFilledSmallMod.foo` */
