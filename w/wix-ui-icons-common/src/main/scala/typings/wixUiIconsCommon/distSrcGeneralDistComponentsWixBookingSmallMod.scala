...
object distSrcGeneralDistComponentsWixBookingSmallMod extends Shortcut {
  ...
  object WixBookingSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: WixBookingSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsWixBookingSmallMod.foo` */
