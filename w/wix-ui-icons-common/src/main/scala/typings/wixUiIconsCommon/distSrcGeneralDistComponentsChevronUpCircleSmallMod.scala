...
object distSrcGeneralDistComponentsChevronUpCircleSmallMod extends Shortcut {
  ...
  object ChevronUpCircleSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ChevronUpCircleSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsChevronUpCircleSmallMod.foo` */
