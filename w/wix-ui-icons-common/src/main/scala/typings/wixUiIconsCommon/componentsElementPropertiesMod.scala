...
object componentsElementPropertiesMod extends Shortcut {
  ...
  object ElementPropertiesProps {
    ...
    extension [Self <: ElementPropertiesProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `componentsElementPropertiesMod.foo` */
