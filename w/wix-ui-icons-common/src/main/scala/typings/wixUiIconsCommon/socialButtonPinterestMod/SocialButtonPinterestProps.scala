package typings.wixUiIconsCommon.socialButtonPinterestMod
...
object SocialButtonPinterestProps {
  ...
  @scala.inline
  implicit class SocialButtonPinterestPropsOps[Self <: SocialButtonPinterestProps] (val x: Self) extends AnyVal {
