...
object distSrcClassicEditorGeneralDistComponentsHorizontalMenuMod extends Shortcut {
  ...
  object HorizontalMenuProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: HorizontalMenuProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcClassicEditorGeneralDistComponentsHorizontalMenuMod.foo` */
