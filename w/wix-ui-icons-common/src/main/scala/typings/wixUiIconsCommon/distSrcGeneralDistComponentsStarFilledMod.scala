...
object distSrcGeneralDistComponentsStarFilledMod extends Shortcut {
  ...
  object StarFilledProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StarFilledProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsStarFilledMod.foo` */
