package typings.wixUiIconsCommon.wixChatFilledSmallMod
...
object WixChatFilledSmallProps {
  ...
  @scala.inline
  implicit class WixChatFilledSmallPropsOps[Self <: WixChatFilledSmallProps] (val x: Self) extends AnyVal {
