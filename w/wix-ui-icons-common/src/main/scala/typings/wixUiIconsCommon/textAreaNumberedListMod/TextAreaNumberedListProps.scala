package typings.wixUiIconsCommon.textAreaNumberedListMod
...
object TextAreaNumberedListProps {
  ...
  @scala.inline
  implicit class TextAreaNumberedListPropsOps[Self <: TextAreaNumberedListProps] (val x: Self) extends AnyVal {
