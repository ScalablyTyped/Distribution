...
object distSrcGeneralDistComponentsYoutubeSmallMod extends Shortcut {
  ...
  object YoutubeSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: YoutubeSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsYoutubeSmallMod.foo` */
