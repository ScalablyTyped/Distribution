...
object distSrcClassicEditorGeneralDistComponentsResetShapeBoldMod extends Shortcut {
  ...
  object ResetShapeBoldProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ResetShapeBoldProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcClassicEditorGeneralDistComponentsResetShapeBoldMod.foo` */
