...
import typings.wixUiIconsCommon.componentsColorBucketBoldMod.ColorBucketBoldProps
...
object colorBucketBoldMod extends Shortcut {
  ...
  @JSImport("wix-ui-icons-common/classic-editor/ColorBucketBold", JSImport.Default)
  @js.native
