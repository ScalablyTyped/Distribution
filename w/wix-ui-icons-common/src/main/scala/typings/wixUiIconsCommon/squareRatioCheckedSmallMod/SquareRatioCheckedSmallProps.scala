package typings.wixUiIconsCommon.squareRatioCheckedSmallMod
...
object SquareRatioCheckedSmallProps {
  ...
  @scala.inline
  implicit class SquareRatioCheckedSmallPropsOps[Self <: SquareRatioCheckedSmallProps] (val x: Self) extends AnyVal {
