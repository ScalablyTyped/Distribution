...
object distSrcGeneralDistComponentsEmailFilledMod extends Shortcut {
  ...
  object EmailFilledProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: EmailFilledProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsEmailFilledMod.foo` */
