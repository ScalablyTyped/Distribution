package typings.wixUiIconsCommon.triangleLargeSmallMod
...
object TriangleLargeSmallProps {
  ...
  @scala.inline
  implicit class TriangleLargeSmallPropsOps[Self <: TriangleLargeSmallProps] (val x: Self) extends AnyVal {
