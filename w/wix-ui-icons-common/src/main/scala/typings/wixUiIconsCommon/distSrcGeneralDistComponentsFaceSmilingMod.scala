...
object distSrcGeneralDistComponentsFaceSmilingMod extends Shortcut {
  ...
  object FaceSmilingProps {
    ...
    extension [Self <: FaceSmilingProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcGeneralDistComponentsFaceSmilingMod.foo` */
