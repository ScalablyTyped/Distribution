package typings.wixUiIconsCommon.chevronRightCircleMod
...
object ChevronRightCircleProps {
  ...
  @scala.inline
  implicit class ChevronRightCirclePropsOps[Self <: ChevronRightCircleProps] (val x: Self) extends AnyVal {
