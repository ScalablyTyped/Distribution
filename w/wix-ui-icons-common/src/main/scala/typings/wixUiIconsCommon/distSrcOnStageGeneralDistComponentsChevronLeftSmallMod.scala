...
object distSrcOnStageGeneralDistComponentsChevronLeftSmallMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcOnStageGeneralDistComponentsChevronLeftSmallMod.foo` */
