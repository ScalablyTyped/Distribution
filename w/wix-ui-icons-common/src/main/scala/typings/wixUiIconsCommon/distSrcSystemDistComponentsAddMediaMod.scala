...
object distSrcSystemDistComponentsAddMediaMod extends Shortcut {
  ...
  object AddMediaProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: AddMediaProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcSystemDistComponentsAddMediaMod.foo` */
