...
version := "0.10-dt-20190506Z-0e07aa"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fast-glob" % "2.2.7-3a3c90",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-f42dee",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-de8238",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-73c839",
