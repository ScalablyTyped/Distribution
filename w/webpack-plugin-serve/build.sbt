...
version := "0.10-dt-20190506Z-85e616"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fast-glob" % "2.2.7-9c2f1f",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-92dccc",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-8b20e4",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-e5dbf0",
