...
version := "0.7-dt-20190326Z-e18692"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "connect-history-api-fallback" % "1.3-dt-20190326Z-124f00",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-44561e",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-24922b",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-d92252",
