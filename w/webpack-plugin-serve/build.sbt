...
version := "0.10-dt-20190506Z-468504"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "connect-history-api-fallback" % "1.3-dt-20190326Z-a8ff00",
  ...
  "org.scalablytyped" %%% "fast-glob" % "2.2.6-508ef8",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-5f359c",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-16c99a",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-2d3670",
