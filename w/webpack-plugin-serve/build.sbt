...
version := "0.10-dt-20190506Z-adcbd3"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "connect-history-api-fallback" % "1.3-dt-20190326Z-36df9f",
  ...
  "org.scalablytyped" %%% "fast-glob" % "2.2.7-932c41",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-e265d3",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-a57e88",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-ca2f70",
