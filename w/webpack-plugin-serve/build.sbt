...
version := "0.7-dt-20190326Z-701b85"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "connect-history-api-fallback" % "1.3-dt-20190326Z-d8b910",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-055bd1",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-797007",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-9d97b7",
