...
version := "0.7-dt-20190325Z-a4afbe"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "connect-history-api-fallback" % "1.3-dt-20190325Z-e58736",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190325Z-72e859",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-6967ae",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-a6e010",
