...
version := "0.10-dt-20190506Z-312d2c"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fast-glob" % "2.2.7-b8f203",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-a29a7b",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-f1c779",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-f9d934",
