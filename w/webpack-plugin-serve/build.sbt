...
version := "0.10-dt-20190506Z-4bbfb2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fast-glob" % "2.2.7-25896a",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-a94f76",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-51d988",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-4414cf",
