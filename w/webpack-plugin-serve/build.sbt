...
version := "0.10-dt-20190506Z-afba9d"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fast-glob" % "2.2.7-b92acd",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-4a65c1",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-1db341",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-24f4cf",
