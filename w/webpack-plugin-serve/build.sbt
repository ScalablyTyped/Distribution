...
version := "0.10-dt-20190506Z-c03d9b"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fast-glob" % "2.2.7-2df774",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-657d21",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-1272d7",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-29eb89",
