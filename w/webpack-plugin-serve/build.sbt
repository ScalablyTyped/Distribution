...
version := "0.7-dt-20190326Z-f1ebbc"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "connect-history-api-fallback" % "1.3-dt-20190326Z-fe4fcb",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-6863fe",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-121d38",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-9b8d1f",
