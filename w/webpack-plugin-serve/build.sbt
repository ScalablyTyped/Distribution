...
version := "0.10-dt-20190506Z-f8606f"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fast-glob" % "2.2.7-c6c9a3",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-f54e31",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-5990b4",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-501b39",
