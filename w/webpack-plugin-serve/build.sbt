...
version := "0.7-dt-20190326Z-f926ee"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "connect-history-api-fallback" % "1.3-dt-20190326Z-6c6ec9",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-afa713",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-06f62c",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-b2de03",
