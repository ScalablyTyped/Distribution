...
version := "0.10-dt-20190506Z-b1ae87"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "fast-glob" % "2.2.7-93a46f",
  ...
  "org.scalablytyped" %%% "koa-compress" % "v2.x-dt-20190326Z-c2de7e",
  "org.scalablytyped" %%% "koa-send" % "4.1-dt-20190218Z-6922cc",
  "org.scalablytyped" %%% "koa-static" % "4.0-dt-20190207Z-515b31",
