...
trait StaticObject extends js.Object {
  ...
  var options: js.UndefOr[
    fastDashGlobLib.fastDashGlobMod.Options[fastDashGlobLib.outTypesEntriesMod.EntryItem]
  ] = js.undefined
}
...
object StaticObject {
  ...
  def apply(
    ...
    options: fastDashGlobLib.fastDashGlobMod.Options[fastDashGlobLib.outTypesEntriesMod.EntryItem] = null
  ): StaticObject = {
