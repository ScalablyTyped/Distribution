...
object Options {
  ...
  def apply(
    ...
    filter: /* file */ FileDescriptor => scala.Boolean = null,
    ...
    seed: js.Object = null,
    serialize: /* manifest */ js.Object => java.lang.String = null,
    sort: (/* a */ FileDescriptor, /* b */ FileDescriptor) => scala.Double = null,
