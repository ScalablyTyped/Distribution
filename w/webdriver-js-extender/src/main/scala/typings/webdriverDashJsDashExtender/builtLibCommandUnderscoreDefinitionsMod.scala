...
import typings.webdriverDashJsDashExtender.builtLibCommandUnderscoreDefinitionMod.CommandDefinition
...
@js.native
object builtLibCommandUnderscoreDefinitionsMod extends js.Object {
  ...
  var getGeolocation: CommandDefinition[Anon_Altitude] = js.native
