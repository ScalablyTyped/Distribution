...
object EXTColorBufferHalfFloat {
  ...
  extension [Self <: EXTColorBufferHalfFloat](x: Self) {
    ...
    inline def setFRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE_EXT(value: Double): Self = StObject.set(x, "FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE_EXT", value.asInstanceOf[js.Any])
    
    inline def setRGB16F_EXT(value: Double): Self = StObject.set(x, "RGB16F_EXT", value.asInstanceOf[js.Any])
    
    inline def setRGBA16F_EXT(value: Double): Self = StObject.set(x, "RGBA16F_EXT", value.asInstanceOf[js.Any])
    
    inline def setUNSIGNED_NORMALIZED_EXT(value: Double): Self = StObject.set(x, "UNSIGNED_NORMALIZED_EXT", value.asInstanceOf[js.Any])
  }
}
