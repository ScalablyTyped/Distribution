...
object WEBGL_compressed_texture_atc {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(COMPRESSED_RGBA_ATC_EXPLICIT_ALPHA_WEBGL = COMPRESSED_RGBA_ATC_EXPLICIT_ALPHA_WEBGL, COMPRESSED_RGBA_ATC_INTERPOLATED_ALPHA_WEBGL = COMPRESSED_RGBA_ATC_INTERPOLATED_ALPHA_WEBGL, COMPRESSED_RGB_ATC_WEBGL = COMPRESSED_RGB_ATC_WEBGL)
