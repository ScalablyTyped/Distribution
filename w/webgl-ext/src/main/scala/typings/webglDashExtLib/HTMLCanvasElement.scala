...
trait HTMLCanvasElement extends js.Object {
  @JSName("getContext")
  def getContext_experimentalwebgl(contextId: webglDashExtLib.webglDashExtLibStrings.`experimental-webgl`): (stdLib.WebGLRenderingContext with WebGL1Extensions) | scala.Null = js.native
  @JSName("getContext")
  def getContext_experimentalwebgl(
