...
object ChromeOptions {
  ...
  extension [Self <: ChromeOptions](x: Self) {
    ...
    inline def setLocalState(value: StringDictionary[js.Any]): Self = StObject.set(x, "localState", value.asInstanceOf[js.Any])
    ...
    inline def setMobileEmulation(value: StringDictionary[js.Any]): Self = StObject.set(x, "mobileEmulation", value.asInstanceOf[js.Any])
