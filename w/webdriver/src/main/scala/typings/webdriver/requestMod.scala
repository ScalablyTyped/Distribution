...
object requestMod {
  ...
  @js.native
  abstract class default protected () extends WebDriverRequest {
  ...
  type Agents = typings.wdioTypes.optionsMod.Agents
  
  type RequestLibOptions = typings.wdioTypes.optionsMod.RequestLibOptions
  
  type RequestLibResponse = typings.wdioTypes.optionsMod.RequestLibResponse
  ...
  trait RequestOptions extends StObject {
    ...
    var transformRequest: js.UndefOr[
        js.Function1[
          /* requestOptions */ typings.wdioTypes.optionsMod.RequestLibOptions, 
          typings.wdioTypes.optionsMod.RequestLibOptions
        ]
      ] = js.undefined
    
    var transformResponse: js.UndefOr[
        js.Function2[
          /* response */ typings.wdioTypes.optionsMod.RequestLibResponse, 
          /* requestOptions */ typings.wdioTypes.optionsMod.RequestLibOptions, 
          typings.wdioTypes.optionsMod.RequestLibResponse
        ]
      ] = js.undefined
  ...
  object RequestOptions {
    ...
    extension [Self <: RequestOptions](x: Self) {
      ...
      inline def setTransformRequest(
        value: /* requestOptions */ typings.wdioTypes.optionsMod.RequestLibOptions => typings.wdioTypes.optionsMod.RequestLibOptions
      ...
      inline def setTransformResponse(
        value: (/* response */ typings.wdioTypes.optionsMod.RequestLibResponse, /* requestOptions */ typings.wdioTypes.optionsMod.RequestLibOptions) => typings.wdioTypes.optionsMod.RequestLibResponse
