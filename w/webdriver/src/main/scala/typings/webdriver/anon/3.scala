...
import typings.webdriver.webdriverStrings.headers
...
trait `3` extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[headers, Unit]] = js.undefined
}
object `3` {
  ...
  extension [Self <: `3`](x: Self) {
    ...
    inline def setValidate(value: headers => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
