...
import typings.webdriver.webdriverStrings.queryParams
...
trait `5` extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[queryParams, Unit]] = js.undefined
}
object `5` {
  ...
  extension [Self <: `5`](x: Self) {
    ...
    inline def setValidate(value: queryParams => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
