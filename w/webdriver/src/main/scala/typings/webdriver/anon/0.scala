...
import typings.webdriver.webdriverStrings.connectionRetryTimeout
...
trait `0` extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[connectionRetryTimeout, Unit]] = js.undefined
}
object `0` {
  ...
  extension [Self <: `0`](x: Self) {
    ...
    inline def setValidate(value: connectionRetryTimeout => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
