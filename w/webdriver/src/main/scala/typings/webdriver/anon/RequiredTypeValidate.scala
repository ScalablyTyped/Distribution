...
import typings.webdriver.webdriverStrings.directConnectHost
...
trait RequiredTypeValidate extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[directConnectHost, Unit]] = js.undefined
}
object RequiredTypeValidate {
  ...
  extension [Self <: RequiredTypeValidate](x: Self) {
    ...
    inline def setValidate(value: directConnectHost => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
