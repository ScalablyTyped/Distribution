...
import typings.webdriver.webdriverStrings.path
...
trait DefaultMatchRequiredType extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[path, Unit]] = js.undefined
}
object DefaultMatchRequiredType {
  ...
  extension [Self <: DefaultMatchRequiredType](x: Self) {
    ...
    inline def setValidate(value: path => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
