...
import typings.webdriver.webdriverStrings.requestedCapabilities
...
trait `7` extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[requestedCapabilities, Unit]] = js.undefined
}
object `7` {
  ...
  extension [Self <: `7`](x: Self) {
    ...
    inline def setValidate(value: requestedCapabilities => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
