...
import typings.webdriver.webdriverStrings.user
...
trait `2` extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[user, Unit]] = js.undefined
}
object `2` {
  ...
  extension [Self <: `2`](x: Self) {
    ...
    inline def setValidate(value: user => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
