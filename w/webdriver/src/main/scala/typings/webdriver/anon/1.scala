...
import typings.webdriver.webdriverStrings.hostname
...
trait `1` extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[hostname, Unit]] = js.undefined
}
object `1` {
  ...
  extension [Self <: `1`](x: Self) {
    ...
    inline def setValidate(value: hostname => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
