...
import typings.webdriver.webdriverStrings.connectionRetryCount
...
trait Required extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[connectionRetryCount, Unit]] = js.undefined
}
object Required {
  ...
  extension [Self <: Required](x: Self) {
    ...
    inline def setValidate(value: connectionRetryCount => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
