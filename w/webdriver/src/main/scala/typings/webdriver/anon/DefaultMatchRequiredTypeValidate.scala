...
import typings.webdriver.webdriverStrings.directConnectPath
...
trait DefaultMatchRequiredTypeValidate extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[directConnectPath, Unit]] = js.undefined
}
object DefaultMatchRequiredTypeValidate {
  ...
  extension [Self <: DefaultMatchRequiredTypeValidate](x: Self) {
    ...
    inline def setValidate(value: directConnectPath => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
