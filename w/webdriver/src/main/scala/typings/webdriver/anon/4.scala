...
import typings.webdriver.webdriverStrings.strictSSL
...
trait `4` extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[strictSSL, Unit]] = js.undefined
}
object `4` {
  ...
  extension [Self <: `4`](x: Self) {
    ...
    inline def setValidate(value: strictSSL => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
