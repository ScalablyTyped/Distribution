...
import typings.webdriver.webdriverStrings.protocol
...
trait `6` extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[protocol, Unit]] = js.undefined
}
object `6` {
  ...
  extension [Self <: `6`](x: Self) {
    ...
    inline def setValidate(value: protocol => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
