...
trait MatchRequired extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[/* option */ Boolean, Unit]] = js.undefined
}
object MatchRequired {
  ...
  extension [Self <: MatchRequired](x: Self) {
    ...
    inline def setValidate(value: /* option */ Boolean => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
