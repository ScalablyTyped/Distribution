...
import typings.webdriver.webdriverStrings.directConnectPort
...
trait TypeValidate extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[directConnectPort, Unit]] = js.undefined
}
object TypeValidate {
  ...
  extension [Self <: TypeValidate](x: Self) {
    ...
    inline def setValidate(value: directConnectPort => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
