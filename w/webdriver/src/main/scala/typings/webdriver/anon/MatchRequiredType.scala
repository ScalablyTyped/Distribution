...
import typings.webdriver.webdriverStrings.port
...
trait MatchRequiredType extends StObject {
  ...
  var validate: js.UndefOr[js.Function1[port, Unit]] = js.undefined
}
object MatchRequiredType {
  ...
  extension [Self <: MatchRequiredType](x: Self) {
    ...
    inline def setValidate(value: port => Unit): Self = StObject.set(x, "validate", js.Any.fromFunction1(value))
