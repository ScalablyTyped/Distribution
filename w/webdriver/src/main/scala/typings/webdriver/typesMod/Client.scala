...
trait Client extends BaseClient {
  ...
  def activateApp(appId: Unit, bundleId: String): Unit = js.native
  ...
  /**
    ...
    */
  @JSName("createWindow")
  def createWindow_tab(`type`: tab): WindowHandle = js.native
  @JSName("createWindow")
  def createWindow_window(`type`: window): WindowHandle = js.native
  ...
  /**
    ...
    */
  def getNamedCookie(name: String): typings.webdriver.WebDriver.Cookie = js.native
  ...
  def isAppInstalled(appId: Unit, bundleId: String): Boolean = js.native
  ...
  def queryAppState(appId: Unit, bundleId: String): Double = js.native
  ...
  def removeApp(appId: Unit, bundleId: String): Unit = js.native
  ...
  def terminateApp(appId: Unit, bundleId: String): Unit = js.native
