...
object SelenoidOptions {
  ...
  extension [Self <: SelenoidOptions](x: Self) {
    ...
    inline def setAdditionalNetworksVarargs(value: String*): Self = StObject.set(x, "additionalNetworks", js.Array(value :_*))
    ...
    inline def setApplicationContainersVarargs(value: String*): Self = StObject.set(x, "applicationContainers", js.Array(value :_*))
    ...
    inline def setHostsEntriesVarargs(value: String*): Self = StObject.set(x, "hostsEntries", js.Array(value :_*))
