...
trait Client extends js.Object {
  ...
  def elementEquals(otherElementId: String): Boolean = js.native
  def elementHover(): Unit = js.native
  def elementSendKeys(text: String): Unit = js.native
  def elementSendKeys(text: String, value: js.Array[String]): Unit = js.native
  def elementSendKeys(value: js.Array[String]): Unit = js.native
  def elementSubmit(): Unit = js.native
  ...
  def getElementAttribute(name: String): String | Null = js.native
  @JSName("getElementAttribute")
  def getElementAttribute_String(name: String): String = js.native
  ...
  def getElementValue(): String | Null = js.native
  ...
  def replaceValue(value: String): Unit = js.native
  ...
  def setValueImmediate(value: String): Unit = js.native
