...
import typings.webdriver.anon.Body
  ...
  object RequestOptions {
    ...
    implicit open class MutableBuilder[Self <: RequestOptions] (val x: Self) extends AnyVal {
      ...
      inline def setTransformResponse(
        value: (/* response */ RequestLibResponse, /* requestOptions */ typings.wdioTypes.buildOptionsMod.RequestLibOptions) => RequestLibResponse
