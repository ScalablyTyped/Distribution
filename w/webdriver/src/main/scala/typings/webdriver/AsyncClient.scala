...
trait AsyncClient extends StObject {
  ...
  def clearMockCalls(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<WebDriver.Client[K]> is not an array type */ args: Parameters[js.Function2[/* mockId */ String, /* restore */ js.UndefOr[Boolean], Unit]]
  ): js.Promise[
  ...
  def createWindow(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<WebDriver.Client[K]> is not an array type */ args: Parameters[js.Function1[/* type */ tab | window, WindowHandle]]
  ...
  def getDisplayDensity(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<WebDriver.Client[K]> is not an array type */ args: Parameters[js.Function0[js.Any]]
  ...
  def sendCommandAndGetResult(
    /* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type Parameters<WebDriver.Client[K]> is not an array type */ args: Parameters[js.Function2[/* cmd */ String, /* params */ js.Object, js.Any]]
