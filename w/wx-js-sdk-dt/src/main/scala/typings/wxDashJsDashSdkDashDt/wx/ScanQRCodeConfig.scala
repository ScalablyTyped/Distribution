...
import typings.wxDashJsDashSdkDashDt.Anon_ResultStr
...
trait ScanQRCodeConfig extends WxBaseRequestConfig {
  ...
  /**
    ...
    */
  @JSName("success")
  var success_ScanQRCodeConfig: js.UndefOr[js.Function1[/* res */ Anon_ResultStr, Unit]] = js.undefined
}
...
object ScanQRCodeConfig {
  ...
  def apply(
    ...
    success: /* res */ Anon_ResultStr => Unit = null
  ): ScanQRCodeConfig = {
