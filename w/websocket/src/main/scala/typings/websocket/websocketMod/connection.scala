...
trait connection extends EventEmitter {
  ...
  var outputPaused: Boolean = js.native
  /**
  ...
  def sendCloseFrame(reasonCode: Double, reasonText: String, force: Boolean): Unit = js.native
  /**
  ...
  def sendFrame(frame: frame, cb: js.Function1[/* msg */ String, Unit]): Unit = js.native
  def sendFrame(frame: frame, force: Boolean): Unit = js.native
  def sendFrame(frame: frame, force: Boolean, cb: js.Function1[/* msg */ String, Unit]): Unit = js.native
  /**
