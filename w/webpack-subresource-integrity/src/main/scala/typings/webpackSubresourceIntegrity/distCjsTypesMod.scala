...
object distCjsTypesMod {
  ...
  */
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    T extends webpack-subresource-integrity.webpack-subresource-integrity/dist/cjs/types.ImmutablePrimitive ? T : T extends std.Map<infer K, infer V> ? webpack-subresource-integrity.webpack-subresource-integrity/dist/cjs/types.ImmutableMap<K, V> : T extends std.Set<infer M> ? webpack-subresource-integrity.webpack-subresource-integrity/dist/cjs/types.ImmutableSet<M> : webpack-subresource-integrity.webpack-subresource-integrity/dist/cjs/types.ImmutableObject<T>
    }}}
    */
  type Immutable[T] = T
  ...
  /** NOTE: Mapped type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    {readonly [ P in keyof T ]: webpack-subresource-integrity.webpack-subresource-integrity/dist/cjs/types.Immutable<T[P]>}
    }}}
    */
  @js.native
  ...
  /* Inlined std.Required<webpack-subresource-integrity.webpack-subresource-integrity/dist/cjs/types.SubresourceIntegrityPluginOptions> */
  ...
  /* Inlined {[ key in webpack-subresource-integrity.webpack-subresource-integrity/dist/cjs/types.AssetType ]: std.Array<string>} */
