...
import typings.webpackSubresourceIntegrity.distCjsTypesMod.SubresourceIntegrityPluginOptions
...
object distCjsMod {
  ...
  @JSImport("webpack-subresource-integrity/dist/cjs", "SubresourceIntegrityPlugin")
  @js.native
  /**
