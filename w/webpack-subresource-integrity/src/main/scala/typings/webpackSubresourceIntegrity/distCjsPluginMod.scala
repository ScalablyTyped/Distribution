...
import typings.webpackSubresourceIntegrity.anon.Assets
import typings.webpackSubresourceIntegrity.anon.BodyTags
import typings.webpackSubresourceIntegrity.distCjsReporterMod.Reporter
import typings.webpackSubresourceIntegrity.distCjsTypesMod.HtmlTagObject
import typings.webpackSubresourceIntegrity.distCjsTypesMod.SubresourceIntegrityPluginResolvedOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distCjsPluginMod {
  
  @JSImport("webpack-subresource-integrity/dist/cjs/plugin", "Plugin")
  @js.native
  open class Plugin protected () extends StObject {
    ...
    def handleHwpBodyTags(param0: BodyTags): Unit = js.native
    
    def handleHwpPluginArgs(param0: Assets): Unit = js.native
