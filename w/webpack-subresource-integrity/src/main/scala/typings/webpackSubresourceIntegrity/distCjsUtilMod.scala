...
object distCjsUtilMod {
  ...
  @JSImport("webpack-subresource-integrity/dist/cjs/util", JSImport.Namespace)
  @js.native
  ...
  @JSImport("webpack-subresource-integrity/dist/cjs/util", "placeholderPrefix")
  @js.native
  val placeholderPrefix: /* "*-*-*-CHUNK-SRI-HASH-" */ String = js.native
  
  @JSImport("webpack-subresource-integrity/dist/cjs/util", "placeholderRegex")
  @js.native
  ...
  @JSImport("webpack-subresource-integrity/dist/cjs/util", "sriHashVariableReference")
  @js.native
