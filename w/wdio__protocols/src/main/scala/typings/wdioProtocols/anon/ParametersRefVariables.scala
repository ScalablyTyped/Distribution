...
trait ParametersRefVariables extends StObject {
...
object ParametersRefVariables {
  ...
  ): ParametersRefVariables = {
    val __obj = js.Dynamic.literal(command = command.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any], exampleReferences = exampleReferences.asInstanceOf[js.Any], parameters = parameters.asInstanceOf[js.Any], ref = ref.asInstanceOf[js.Any], variables = variables.asInstanceOf[js.Any])
    __obj.asInstanceOf[ParametersRefVariables]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ParametersRefVariables] (val x: Self) extends AnyVal {
