...
trait CommandDescriptionParametersRefSupport extends StObject {
...
object CommandDescriptionParametersRefSupport {
  ...
  inline def apply(
  ...
  ): CommandDescriptionParametersRefSupport = {
    ...
    __obj.asInstanceOf[CommandDescriptionParametersRefSupport]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommandDescriptionParametersRefSupport] (val x: Self) extends AnyVal {
