...
trait AlternativeCommands extends StObject {
...
object AlternativeCommands {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[AlternativeCommands]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AlternativeCommands] (val x: Self) extends AnyVal {
