...
trait RefSupport extends StObject {
...
object RefSupport {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[RefSupport]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RefSupport] (val x: Self) extends AnyVal {
    ...
    inline def setSupport(value: Android): Self = StObject.set(x, "support", value.asInstanceOf[js.Any])
  }
}
