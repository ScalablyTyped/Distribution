...
trait SupportIosXCUITest extends StObject {
...
object SupportIosXCUITest {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[SupportIosXCUITest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SupportIosXCUITest] (val x: Self) extends AnyVal {
