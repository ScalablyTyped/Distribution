...
trait AndroidIosWindows extends StObject {
...
object AndroidIosWindows {
  
  inline def apply(android: UiAutomator, ios: UIAutomation, windows: Windows): AndroidIosWindows = {
    ...
    __obj.asInstanceOf[AndroidIosWindows]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AndroidIosWindows] (val x: Self) extends AnyVal {
