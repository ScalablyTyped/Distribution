...
trait ExamplesIsHubCommand extends StObject {
...
object ExamplesIsHubCommand {
  ...
  inline def apply(
    ...
    ref: String,
    returns: Name
  ): ExamplesIsHubCommand = {
    val __obj = js.Dynamic.literal(command = command.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any], examples = examples.asInstanceOf[js.Any], isHubCommand = isHubCommand.asInstanceOf[js.Any], parameters = parameters.asInstanceOf[js.Any], ref = ref.asInstanceOf[js.Any], returns = returns.asInstanceOf[js.Any])
    __obj.asInstanceOf[ExamplesIsHubCommand]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ExamplesIsHubCommand] (val x: Self) extends AnyVal {
