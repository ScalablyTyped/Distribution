...
trait SupportIosWindows extends StObject {
...
object SupportIosWindows {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[SupportIosWindows]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SupportIosWindows] (val x: Self) extends AnyVal {
