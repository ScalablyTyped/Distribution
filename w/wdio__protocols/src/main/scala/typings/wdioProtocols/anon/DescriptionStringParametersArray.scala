...
trait DescriptionStringParametersArray extends StObject {
...
object DescriptionStringParametersArray {
  ...
  inline def apply(
  ...
  ): DescriptionStringParametersArray = {
    ...
    __obj.asInstanceOf[DescriptionStringParametersArray]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescriptionStringParametersArray] (val x: Self) extends AnyVal {
