...
trait RefReturnsSupport extends StObject {
...
object RefReturnsSupport {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[RefReturnsSupport]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RefReturnsSupport] (val x: Self) extends AnyVal {
