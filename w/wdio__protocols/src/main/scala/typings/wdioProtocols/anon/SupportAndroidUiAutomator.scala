...
trait SupportAndroidUiAutomator extends StObject {
...
object SupportAndroidUiAutomator {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[SupportAndroidUiAutomator]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SupportAndroidUiAutomator] (val x: Self) extends AnyVal {
