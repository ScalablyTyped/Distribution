...
trait DescriptionParametersRefSupport extends StObject {
  ...
  var support: AndroidIos
}
object DescriptionParametersRefSupport {
  ...
  inline def apply(
    ...
    ref: String,
    support: AndroidIos
  ): DescriptionParametersRefSupport = {
    ...
    __obj.asInstanceOf[DescriptionParametersRefSupport]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescriptionParametersRefSupport] (val x: Self) extends AnyVal {
    ...
    inline def setSupport(value: AndroidIos): Self = StObject.set(x, "support", value.asInstanceOf[js.Any])
  }
}
