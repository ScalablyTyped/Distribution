...
trait ExampleReferences extends StObject {
...
object ExampleReferences {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ExampleReferences]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ExampleReferences] (val x: Self) extends AnyVal {
