...
trait CommandDescriptionParametersRefReturns extends StObject {
...
object CommandDescriptionParametersRefReturns {
  ...
  inline def apply(
  ...
  ): CommandDescriptionParametersRefReturns = {
    ...
    __obj.asInstanceOf[CommandDescriptionParametersRefReturns]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CommandDescriptionParametersRefReturns] (val x: Self) extends AnyVal {
