...
trait ParametersRefSupport extends StObject {
...
object ParametersRefSupport {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ParametersRefSupport]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ParametersRefSupport] (val x: Self) extends AnyVal {
