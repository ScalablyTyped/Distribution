...
trait ReturnsVariables extends StObject {
...
object ReturnsVariables {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ReturnsVariables]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ReturnsVariables] (val x: Self) extends AnyVal {
