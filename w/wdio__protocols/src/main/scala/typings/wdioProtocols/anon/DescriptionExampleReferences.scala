...
trait DescriptionExampleReferences extends StObject {
...
object DescriptionExampleReferences {
  ...
  inline def apply(
    ...
    ref: String,
    returns: Name
  ): DescriptionExampleReferences = {
    val __obj = js.Dynamic.literal(command = command.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any], exampleReferences = exampleReferences.asInstanceOf[js.Any], parameters = parameters.asInstanceOf[js.Any], ref = ref.asInstanceOf[js.Any], returns = returns.asInstanceOf[js.Any])
    __obj.asInstanceOf[DescriptionExampleReferences]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescriptionExampleReferences] (val x: Self) extends AnyVal {
