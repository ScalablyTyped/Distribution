...
trait DescriptionParametersRefReturnsSupport extends StObject {
...
object DescriptionParametersRefReturnsSupport {
  ...
  inline def apply(
  ...
  ): DescriptionParametersRefReturnsSupport = {
    ...
    __obj.asInstanceOf[DescriptionParametersRefReturnsSupport]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescriptionParametersRefReturnsSupport] (val x: Self) extends AnyVal {
