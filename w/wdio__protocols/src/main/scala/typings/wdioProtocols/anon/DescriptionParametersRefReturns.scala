...
trait DescriptionParametersRefReturns extends StObject {
...
object DescriptionParametersRefReturns {
  ...
  inline def apply(
    ...
    ref: String,
    returns: Name
  ): DescriptionParametersRefReturns = {
    ...
    __obj.asInstanceOf[DescriptionParametersRefReturns]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescriptionParametersRefReturns] (val x: Self) extends AnyVal {
