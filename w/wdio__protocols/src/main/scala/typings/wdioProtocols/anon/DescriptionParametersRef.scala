...
trait DescriptionParametersRef extends StObject {
...
object DescriptionParametersRef {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[DescriptionParametersRef]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescriptionParametersRef] (val x: Self) extends AnyVal {
