...
trait AlternativeCommandsCommandDescription extends StObject {
...
object AlternativeCommandsCommandDescription {
  ...
  inline def apply(
  ...
  ): AlternativeCommandsCommandDescription = {
    ...
    __obj.asInstanceOf[AlternativeCommandsCommandDescription]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AlternativeCommandsCommandDescription] (val x: Self) extends AnyVal {
