...
trait RefStringSupportIosUIAutomation extends StObject {
...
object RefStringSupportIosUIAutomation {
  ...
  inline def apply(
  ...
  ): RefStringSupportIosUIAutomation = {
    ...
    __obj.asInstanceOf[RefStringSupportIosUIAutomation]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RefStringSupportIosUIAutomation] (val x: Self) extends AnyVal {
