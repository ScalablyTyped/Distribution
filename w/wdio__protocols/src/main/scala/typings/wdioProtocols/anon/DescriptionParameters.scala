...
trait DescriptionParameters extends StObject {
...
object DescriptionParameters {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[DescriptionParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescriptionParameters] (val x: Self) extends AnyVal {
