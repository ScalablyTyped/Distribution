...
@js.native
object weakModMembers extends js.Object {
  /**
  ...
  /**
       ...
       * @param ref weak reference object
       */
  def isDead(ref: WeakRef[_]): /* is WeakRef */scala.Boolean = js.native
  /**
       ...
       * @param ref weak reference object
       */
  def isNearDeath(ref: WeakRef[_]): /* is WeakRef */scala.Boolean = js.native
  /**
       ...
       */
  def isWeakRef(obj: js.Any): /* is WeakRef */scala.Boolean = js.native
  /**
