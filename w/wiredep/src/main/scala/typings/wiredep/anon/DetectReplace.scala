...
object DetectReplace {
  ...
  inline def apply(block: js.RegExp, detect: Styl, replace: CssStyl): DetectReplace = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DetectReplace] (val x: Self) extends AnyVal {
