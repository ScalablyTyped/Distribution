...
trait StreamTransportInstance
  extends winstonDashTransportLib.winstonDashTransportMod.^
     with org.scalablytyped.runtime.Instantiable0[StreamTransportInstance]
     with org.scalablytyped.runtime.Instantiable1[/* options */ StreamTransportOptions, StreamTransportInstance] {
