...
trait ConsoleTransportInstance
  extends winstonDashTransportLib.winstonDashTransportMod.^
     with org.scalablytyped.runtime.Instantiable0[ConsoleTransportInstance]
     with org.scalablytyped.runtime.Instantiable1[/* options */ ConsoleTransportOptions, ConsoleTransportInstance] {
