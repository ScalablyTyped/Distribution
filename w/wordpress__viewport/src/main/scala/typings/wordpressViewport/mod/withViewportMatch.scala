...
@js.native
object withViewportMatch extends js.Object {
  /**
    ...
    */
  // prettier-ignore
  def apply[T /* <: Record[String, String] */](queries: T): js.Function1[/* component */ ComponentType[_], ComponentType[Omit[_, /* keyof T */ String]]] = js.native
}
