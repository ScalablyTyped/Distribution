...
/* Rewritten from type alias, can be one of: 
  - typings.woosmapMap.woosmap.map.GeometryCollectionElement
  - typings.woosmapMap.woosmap.map.Data_.GeometryCollection
*/
...
object GeometryClasses {
  ...
  inline def GeometryCollection(
    ...
    __obj.asInstanceOf[typings.woosmapMap.woosmap.map.Data_.GeometryCollection]
  }
