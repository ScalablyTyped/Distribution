package typings.wepy.wepyMod

import typings.wepy.Fn_Deep
...
trait DefaultExport extends WxEnhances {
  ...
  @JSName("$createApp")
  var $createApp_Original: js.Function2[/* appClass */ AppConstructor, /* appConfig */ AppConfig, default] = js.native
  @JSName("$createPage")
  ...
  @JSName("$createApp")
  def $createApp(appClass: AppConstructor, appConfig: AppConfig): default = js.native
  @JSName("$createPage")
