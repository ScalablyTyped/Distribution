...
trait WxEnhances extends js.Object {
  ...
  def canvasGetImageData(params: wepyLib.Anon_X, context: js.Any): js.Promise[wepyLib.Anon_Data] = js.native
  def canvasPutImageData(params: wepyLib.Anon_XY, context: js.Any): js.Promise[scala.Unit] = js.native
  def canvasToTempFilePath(params: wepyLib.Anon_DestWidth, context: js.Any): js.Promise[wepyLib.Anon_TempFilePath] = js.native
  ...
  def chooseInvoiceTitle(): js.Promise[wepyLib.Anon_BankName] = js.native
  def chooseLocation(): js.Promise[wepyLib.Anon_Address] = js.native
  def chooseVideo(params: wepyLib.Anon_Compressed): js.Promise[wepyLib.Anon_DurationSize] = js.native
  def clearStorage(): js.Promise[scala.Unit] = js.native
  def createAnimation(params: wepyLib.Anon_TimingFunction): js.Promise[Animation] = js.native
  ...
  def getLocation(params: wepyLib.Anon_Type): js.Promise[wepyLib.Anon_Altitude] = js.native
  def getNetworkType(): js.Promise[wepyLib.Anon_NetworkType] = js.native
  def getSavedFileInfo(params: FilePathParam): js.Promise[wepyLib.Anon_ErrMsgSize] = js.native
  ...
  def getSystemInfo(): js.Promise[wepyLib.Anon_PixelRatio] = js.native
  def getUserInfo(params: wepyLib.Anon_WithCredentials): js.Promise[wepyLib.Anon_EncryptedData] = js.native
  ...
  def openLocation(params: wepyLib.Anon_Name): js.Promise[scala.Unit] = js.native
  ...
  def showModal(params: wepyLib.Anon_ShowCancel): js.Promise[wepyLib.Anon_Cancel] = js.native
  def showNavigationBarLoading(): js.Promise[scala.Unit] = js.native
  def showToast(params: wepyLib.Anon_DurationMask): js.Promise[scala.Unit] = js.native
