...
trait Optimization extends js.Object {
  ...
  var minimizer: js.UndefOr[js.Array[Plugin | typings.tapable.tapableMod.TapableNs.Plugin]] = js.undefined
...
object Optimization {
  ...
  def apply(
    ...
    minimizer: js.Array[Plugin | typings.tapable.tapableMod.TapableNs.Plugin] = null,
