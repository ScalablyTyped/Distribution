...
import typings.webpack.webpackMod.Stats.ToJsonOptions
import typings.webpack.webpackMod.Stats.ToStringOptions
import typings.webpack.webpackMod.compilation.Compilation
import typings.webpack.webpackMod.compilation.CompilerHooks
...
object Compiler extends js.Object {
  ...
  class Watching protected () extends js.Object {
    def this(
      compiler: Compiler,
      watchOptions: typings.webpack.webpackMod.Compiler.Watching.WatchOptions,
      handler: typings.webpack.webpackMod.Compiler.Watching.Handler
    ) = this()
...
object compiler extends js.Object {
  ...
  type WatchOptions = typings.webpack.webpackMod.Compiler.WatchOptions
  /** @deprecated use webpack.Compiler.Watching */
  type Watching = typings.webpack.webpackMod.Compiler.Watching
}
