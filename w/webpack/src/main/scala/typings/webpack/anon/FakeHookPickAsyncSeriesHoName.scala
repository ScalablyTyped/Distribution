...
trait FakeHookPickAsyncSeriesHoName extends StObject {
  ...
  def tap(
    options: String,
    fn: js.Function1[/* args */ AsArray[js.Array[Set[typings.webpack.mod.Chunk]]], Unit]
  ): Unit
  
  def tapAsync(
    options: String,
    fn: js.Function1[
      /* args */ Append[AsArray[js.Array[Set[typings.webpack.mod.Chunk]]], InnerCallback[js.Error, Unit]], 
      Unit
    ]
  ): Unit
  @JSName("tapAsync")
  ...
  def tapPromise(
    options: String,
    fn: js.Function1[/* args */ AsArray[js.Array[Set[typings.webpack.mod.Chunk]]], js.Promise[Unit]]
  ): Unit
  @JSName("tapPromise")
...
object FakeHookPickAsyncSeriesHoName {
  ...
  inline def apply(
    tap: (/* options */ String, /* fn */ js.Function1[/* args */ AsArray[js.Array[Set[typings.webpack.mod.Chunk]]], Unit]) => Unit,
    tapAsync: (/* options */ String, /* fn */ js.Function1[
      /* args */ Append[AsArray[js.Array[Set[typings.webpack.mod.Chunk]]], InnerCallback[js.Error, Unit]], 
      Unit
    ]) => Unit,
    tapPromise: (/* options */ String, /* fn */ js.Function1[/* args */ AsArray[js.Array[Set[typings.webpack.mod.Chunk]]], js.Promise[Unit]]) => Unit
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FakeHookPickAsyncSeriesHoName] (val x: Self) extends AnyVal {
    ...
    inline def setTap(
      value: (/* options */ String, /* fn */ js.Function1[/* args */ AsArray[js.Array[Set[typings.webpack.mod.Chunk]]], Unit]) => Unit
    ...
    inline def setTapPromise(
      value: (/* options */ String, /* fn */ js.Function1[/* args */ AsArray[js.Array[Set[typings.webpack.mod.Chunk]]], js.Promise[Unit]]) => Unit
