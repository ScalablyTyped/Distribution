...
trait ReadonlybuildModuleSyncHo extends StObject {
  ...
  def normalModuleLoader(): SyncHook[js.Tuple2[js.Object, NormalModule], Unit, UnsetAdditionalOptions]
...
object ReadonlybuildModuleSyncHo {
  ...
  extension [Self <: ReadonlybuildModuleSyncHo](x: Self) {
    ...
    inline def setNormalModuleLoader(value: () => SyncHook[js.Tuple2[js.Object, NormalModule], Unit, UnsetAdditionalOptions]): Self = StObject.set(x, "normalModuleLoader", js.Any.fromFunction0(value))
