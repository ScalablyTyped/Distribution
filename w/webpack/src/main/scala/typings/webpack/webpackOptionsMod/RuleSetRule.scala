...
object RuleSetRule {
  ...
  extension [Self <: RuleSetRule](x: Self) {
    ...
    inline def setLoaderVarargs(value: RuleSetUseItem*): Self = StObject.set(x, "loader", js.Array(value :_*))
    ...
    inline def setLoadersVarargs(value: RuleSetUseItem*): Self = StObject.set(x, "loaders", js.Array(value :_*))
    ...
    inline def setOneOfVarargs(value: RuleSetRule*): Self = StObject.set(x, "oneOf", js.Array(value :_*))
    
    inline def setOptions(value: RuleSetQuery): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    
    inline def setOptionsUndefined: Self = StObject.set(x, "options", js.undefined)
    
    inline def setParser(value: StringDictionary[js.Any]): Self = StObject.set(x, "parser", value.asInstanceOf[js.Any])
    ...
    inline def setRulesVarargs(value: RuleSetRule*): Self = StObject.set(x, "rules", js.Array(value :_*))
    ...
    inline def setUseVarargs(value: RuleSetUseItem*): Self = StObject.set(x, "use", js.Array(value :_*))
  }
}
