...
object WebpackOptions {
  ...
  extension [Self <: WebpackOptions](x: Self) {
    ...
    inline def setAmd(value: `false` | StringDictionary[js.Any]): Self = StObject.set(x, "amd", value.asInstanceOf[js.Any])
    ...
    inline def setCache(value: Boolean | StringDictionary[js.Any]): Self = StObject.set(x, "cache", value.asInstanceOf[js.Any])
    ...
    inline def setDevServer(value: StringDictionary[js.Any]): Self = StObject.set(x, "devServer", value.asInstanceOf[js.Any])
    ...
    inline def setLoader(value: StringDictionary[js.Any]): Self = StObject.set(x, "loader", value.asInstanceOf[js.Any])
    ...
    inline def setServe(value: StringDictionary[js.Any]): Self = StObject.set(x, "serve", value.asInstanceOf[js.Any])
