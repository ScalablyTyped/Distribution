...
object IntermediateFileSystemExtras {
  ...
  inline def apply(
    close: (Double, js.Function1[/* arg0 */ js.UndefOr[Null | ErrnoException], Unit]) => Unit,
    createWriteStream: String => WritableStream[Any],
    mkdirSync: String => Unit,
    open: (String, String, js.Function2[/* arg0 */ js.UndefOr[Null | ErrnoException], /* arg1 */ js.UndefOr[Double], Unit]) => Unit,
    read: (Double, Buffer, Double, Double, Double, js.Function2[/* arg0 */ js.UndefOr[Null | ErrnoException], /* arg1 */ js.UndefOr[Double], Unit]) => Unit,
    rename: (String, String, js.Function1[/* arg0 */ js.UndefOr[Null | ErrnoException], Unit]) => Unit
  ...
  extension [Self <: IntermediateFileSystemExtras](x: Self) {
    ...
    inline def setOpen(
      value: (String, String, js.Function2[/* arg0 */ js.UndefOr[Null | ErrnoException], /* arg1 */ js.UndefOr[Double], Unit]) => Unit
    ): Self = StObject.set(x, "open", js.Any.fromFunction3(value))
    
    inline def setRead(
      value: (Double, Buffer, Double, Double, Double, js.Function2[/* arg0 */ js.UndefOr[Null | ErrnoException], /* arg1 */ js.UndefOr[Double], Unit]) => Unit
    ): Self = StObject.set(x, "read", js.Any.fromFunction6(value))
    
    inline def setRename(value: (String, String, js.Function1[/* arg0 */ js.UndefOr[Null | ErrnoException], Unit]) => Unit): Self = StObject.set(x, "rename", js.Any.fromFunction3(value))
  }
}
