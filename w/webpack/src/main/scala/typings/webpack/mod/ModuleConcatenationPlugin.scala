...
object ModuleConcatenationPlugin {
  ...
  inline def apply(apply: Compiler => Unit, options: Any): ModuleConcatenationPlugin = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ModuleConcatenationPlugin] (val x: Self) extends AnyVal {
