package typings.webpack.mod.SourceMapDevToolPlugin
...
object Options {
  ...
  def apply(
    ...
    filename: js.UndefOr[Null | `false` | String] = js.undefined,
    ...
    if (!js.isUndefined(noSources)) __obj.updateDynamic("noSources")(noSources.get.asInstanceOf[js.Any])
