...
trait HashedModuleIdsPluginOptions extends StObject {
  ...
  /**
  	 ...
  	 */
  var hashDigest: js.UndefOr[latin1 | base64 | hex] = js.undefined
...
object HashedModuleIdsPluginOptions {
  ...
  implicit open class MutableBuilder[Self <: HashedModuleIdsPluginOptions] (val x: Self) extends AnyVal {
    ...
    inline def setHashDigest(value: latin1 | base64 | hex): Self = StObject.set(x, "hashDigest", value.asInstanceOf[js.Any])
