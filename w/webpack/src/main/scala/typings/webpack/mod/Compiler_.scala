...
import typings.webpack.mod.compilation.CompilerHooks
...
class Compiler_ ()
  ...
  @JSName("apply")
  override def apply(plugins: ((js.ThisFunction0[/* this */ this.type, _]) | typings.tapable.mod.Tapable.Plugin)*): Unit = js.native
  /**
    * @deprecated Tapable.apply is deprecated. Call apply on the plugin directly instead
  ...
  /* InferMemberOverrides */
  override def watch(watchOptions: typings.webpack.mod.ICompiler.WatchOptions, handler: Handler): Watching = js.native
}
...
object Compiler_ extends js.Object {
  ...
  object Watching extends js.Object {
    type Handler = typings.webpack.mod.ICompiler.Handler
    type WatchOptions = typings.webpack.mod.ICompiler.WatchOptions
  }
