...
trait Optimization extends js.Object {
  ...
  var minimizer: js.UndefOr[js.Array[Plugin | typings.tapable.mod.Tapable.Plugin]] = js.undefined
...
object Optimization {
  ...
  def apply(
    ...
    minimizer: js.Array[Plugin | typings.tapable.mod.Tapable.Plugin] = null,
    ...
    if (!js.isUndefined(concatenateModules)) __obj.updateDynamic("concatenateModules")(concatenateModules.get.asInstanceOf[js.Any])
    if (!js.isUndefined(flagIncludedChunks)) __obj.updateDynamic("flagIncludedChunks")(flagIncludedChunks.get.asInstanceOf[js.Any])
    if (!js.isUndefined(mergeDuplicateChunks)) __obj.updateDynamic("mergeDuplicateChunks")(mergeDuplicateChunks.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(namedChunks)) __obj.updateDynamic("namedChunks")(namedChunks.get.asInstanceOf[js.Any])
    if (!js.isUndefined(namedModules)) __obj.updateDynamic("namedModules")(namedModules.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noEmitOnErrors)) __obj.updateDynamic("noEmitOnErrors")(noEmitOnErrors.get.asInstanceOf[js.Any])
    if (nodeEnv != null) __obj.updateDynamic("nodeEnv")(nodeEnv.asInstanceOf[js.Any])
    if (!js.isUndefined(occurrenceOrder)) __obj.updateDynamic("occurrenceOrder")(occurrenceOrder.get.asInstanceOf[js.Any])
    if (!js.isUndefined(portableRecords)) __obj.updateDynamic("portableRecords")(portableRecords.get.asInstanceOf[js.Any])
    if (!js.isUndefined(providedExports)) __obj.updateDynamic("providedExports")(providedExports.get.asInstanceOf[js.Any])
    if (!js.isUndefined(removeAvailableModules)) __obj.updateDynamic("removeAvailableModules")(removeAvailableModules.get.asInstanceOf[js.Any])
    if (!js.isUndefined(removeEmptyChunks)) __obj.updateDynamic("removeEmptyChunks")(removeEmptyChunks.get.asInstanceOf[js.Any])
