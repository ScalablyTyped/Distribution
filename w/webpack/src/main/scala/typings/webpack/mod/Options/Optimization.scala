...
object Optimization {
  ...
  def apply(
    ...
    if (!js.isUndefined(concatenateModules)) __obj.updateDynamic("concatenateModules")(concatenateModules.asInstanceOf[js.Any])
    if (!js.isUndefined(flagIncludedChunks)) __obj.updateDynamic("flagIncludedChunks")(flagIncludedChunks.asInstanceOf[js.Any])
    if (!js.isUndefined(mergeDuplicateChunks)) __obj.updateDynamic("mergeDuplicateChunks")(mergeDuplicateChunks.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(namedChunks)) __obj.updateDynamic("namedChunks")(namedChunks.asInstanceOf[js.Any])
    if (!js.isUndefined(namedModules)) __obj.updateDynamic("namedModules")(namedModules.asInstanceOf[js.Any])
    if (!js.isUndefined(noEmitOnErrors)) __obj.updateDynamic("noEmitOnErrors")(noEmitOnErrors.asInstanceOf[js.Any])
    if (nodeEnv != null) __obj.updateDynamic("nodeEnv")(nodeEnv.asInstanceOf[js.Any])
    if (!js.isUndefined(occurrenceOrder)) __obj.updateDynamic("occurrenceOrder")(occurrenceOrder.asInstanceOf[js.Any])
    if (!js.isUndefined(portableRecords)) __obj.updateDynamic("portableRecords")(portableRecords.asInstanceOf[js.Any])
    if (!js.isUndefined(providedExports)) __obj.updateDynamic("providedExports")(providedExports.asInstanceOf[js.Any])
    if (!js.isUndefined(removeAvailableModules)) __obj.updateDynamic("removeAvailableModules")(removeAvailableModules.asInstanceOf[js.Any])
    if (!js.isUndefined(removeEmptyChunks)) __obj.updateDynamic("removeEmptyChunks")(removeEmptyChunks.asInstanceOf[js.Any])
