package typings
package webpackLib.webpackMod.ICompilerNs
...
trait WatchOptions extends js.Object {
  ...
  /**
    ...
    */
  var ignored: js.UndefOr[anymatchLib.anymatchMod.Matcher] = js.undefined
...
object WatchOptions {
  ...
  def apply(
    ...
    ignored: anymatchLib.anymatchMod.Matcher = null,
