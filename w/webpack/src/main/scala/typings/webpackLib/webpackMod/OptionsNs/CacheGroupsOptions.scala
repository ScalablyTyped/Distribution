...
trait CacheGroupsOptions extends js.Object {
  ...
  var chunks: js.UndefOr[
    webpackLib.webpackLibStrings.initial | webpackLib.webpackLibStrings.async | webpackLib.webpackLibStrings.all | (js.Function1[/* chunk */ webpackLib.webpackMod.compilationNs.Chunk, scala.Boolean])
  ] = js.undefined
...
object CacheGroupsOptions {
  @scala.inline
  def apply(
    chunks: webpackLib.webpackLibStrings.initial | webpackLib.webpackLibStrings.async | webpackLib.webpackLibStrings.all | (js.Function1[/* chunk */ webpackLib.webpackMod.compilationNs.Chunk, scala.Boolean]) = null,
