...
trait Anon_A extends js.Object {
  ...
  @JSName("createElement")
  def createElement_input(`type`: whyDashDidDashYouDashUpdateLib.whyDashDidDashYouDashUpdateLibStrings.input): reactLib.reactMod.ReactNs.DetailedReactHTMLElement[
