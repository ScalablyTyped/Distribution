...
object anon {
  ...
  trait Typeofreact extends StObject {
    ...
    def createElement[P /* <: HTMLAttributes[T] */, T /* <: HTMLElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 116, starting with typings.whyDidYouUpdate.whyDidYouUpdateStrings.a, typings.whyDidYouUpdate.whyDidYouUpdateStrings.abbr, typings.whyDidYouUpdate.whyDidYouUpdateStrings.address */ Any,
    ...
    def createElement_PT_ReactSVGElement[P /* <: SVGAttributes[T] */, T /* <: SVGElement */](
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55, starting with typings.whyDidYouUpdate.whyDidYouUpdateStrings.animate, typings.whyDidYouUpdate.whyDidYouUpdateStrings.circle, typings.whyDidYouUpdate.whyDidYouUpdateStrings.clipPath */ Any,
      props: ClassAttributes[T] & P,
      children: ReactNode*
