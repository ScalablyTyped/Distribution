...
class ReadableStream[R] () extends js.Object {
  ...
  def pipeTo(dest: WritableStream[R]): stdLib.Promise[scala.Unit] = js.native
  def pipeTo(dest: WritableStream[R], options: PipeOptions): stdLib.Promise[scala.Unit] = js.native
