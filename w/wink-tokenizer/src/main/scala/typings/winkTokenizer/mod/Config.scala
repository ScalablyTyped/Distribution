...
object Config {
  ...
  def apply(
    ...
    if (!js.isUndefined(currency)) __obj.updateDynamic("currency")(currency.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(emoticon)) __obj.updateDynamic("emoticon")(emoticon.get.asInstanceOf[js.Any])
    if (!js.isUndefined(hashtag)) __obj.updateDynamic("hashtag")(hashtag.get.asInstanceOf[js.Any])
    if (!js.isUndefined(mention)) __obj.updateDynamic("mention")(mention.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(quoted_phrase)) __obj.updateDynamic("quoted_phrase")(quoted_phrase.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(word)) __obj.updateDynamic("word")(word.get.asInstanceOf[js.Any])
