...
object PromiseTypeDescription {
  ...
  @scala.inline
  implicit class PromiseTypeDescriptionOps[Self <: PromiseTypeDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGeneric(value: Promise): Self = this.set("generic", value.asInstanceOf[js.Any])
  }
}
