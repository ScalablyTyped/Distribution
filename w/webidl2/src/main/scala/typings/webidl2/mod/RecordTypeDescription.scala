...
object RecordTypeDescription {
  ...
  @scala.inline
  implicit class RecordTypeDescriptionOps[Self <: RecordTypeDescription] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGeneric(value: record): Self = this.set("generic", value.asInstanceOf[js.Any])
