...
trait PerceptionControlSession extends StObject {
  ...
  def addEventListener_controllost(`type`: controllost, listener: TypedEventHandler[PerceptionControlSession, js.Any]): Unit = js.native
  ...
  def oncontrollost(ev: js.Any & WinRTEvent[PerceptionControlSession]): Unit = js.native
  /** Subscribes to the ControlLost event. This event is triggered when control of the session is lost to another client. */
  @JSName("oncontrollost")
  var oncontrollost_Original: TypedEventHandler[PerceptionControlSession, js.Any] = js.native
  
  def removeEventListener(`type`: String, listener: EventHandler[js.Any]): Unit = js.native
  @JSName("removeEventListener")
  def removeEventListener_controllost(`type`: controllost, listener: TypedEventHandler[PerceptionControlSession, js.Any]): Unit = js.native
