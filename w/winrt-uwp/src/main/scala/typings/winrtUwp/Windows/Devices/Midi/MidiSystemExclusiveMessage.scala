...
@js.native
trait MidiSystemExclusiveMessage extends js.Object {
...
object MidiSystemExclusiveMessage {
  ...
  @scala.inline
  implicit class MidiSystemExclusiveMessageOps[Self <: MidiSystemExclusiveMessage] (val x: Self) extends AnyVal {
