...
trait MidiSystemExclusiveMessage extends StObject {
...
object MidiSystemExclusiveMessage {
  
  @scala.inline
  def apply(rawData: IBuffer, timestamp: Double, `type`: MidiMessageType): MidiSystemExclusiveMessage = {
  ...
  @scala.inline
  implicit class MidiSystemExclusiveMessageMutableBuilder[Self <: MidiSystemExclusiveMessage] (val x: Self) extends AnyVal {
