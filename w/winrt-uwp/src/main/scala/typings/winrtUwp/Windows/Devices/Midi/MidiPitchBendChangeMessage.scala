...
object MidiPitchBendChangeMessage {
  ...
  @scala.inline
  implicit class MidiPitchBendChangeMessageOps[Self <: MidiPitchBendChangeMessage] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBend(value: Double): Self = this.set("bend", value.asInstanceOf[js.Any])
    @scala.inline
