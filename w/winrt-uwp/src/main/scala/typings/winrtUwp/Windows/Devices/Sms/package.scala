...
/* ev */ typings.winrtUwp.Windows.Devices.Sms.SmsMessageReceivedEventArgs & typings.winrtUwp.Windows.WinRTEvent[typings.winrtUwp.Windows.Devices.Sms.SmsDevice], 
scala.Unit]
