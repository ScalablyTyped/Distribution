...
object PerceptionColorFrameSource extends js.Object {
  /**
    ...
    */
  def createWatcher(): PerceptionColorFrameSourceWatcher = js.native
  /**
  ...
  /**
    ...
    */
  def fromIdAsync(id: String): IPromiseWithIAsyncOperation[PerceptionColorFrameSource] = js.native
  /**
