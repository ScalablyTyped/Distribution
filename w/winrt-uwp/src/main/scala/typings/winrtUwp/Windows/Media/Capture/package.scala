...
/* ev */ typings.winrtUwp.Windows.Media.Capture.MediaCaptureFailedEventArgs & typings.winrtUwp.Windows.WinRTEvent[typings.winrtUwp.Windows.Media.Capture.MediaCapture], 
scala.Unit]
