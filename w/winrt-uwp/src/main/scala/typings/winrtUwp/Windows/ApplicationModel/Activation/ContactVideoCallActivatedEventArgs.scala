...
trait ContactVideoCallActivatedEventArgs extends StObject {
...
object ContactVideoCallActivatedEventArgs {
  ...
  @scala.inline
  implicit class ContactVideoCallActivatedEventArgsMutableBuilder[Self <: ContactVideoCallActivatedEventArgs] (val x: Self) extends AnyVal {
