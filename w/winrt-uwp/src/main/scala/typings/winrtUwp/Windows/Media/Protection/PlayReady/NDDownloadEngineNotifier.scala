...
object NDDownloadEngineNotifier {
  ...
  implicit open class MutableBuilder[Self <: NDDownloadEngineNotifier] (val x: Self) extends AnyVal {
    ...
    inline def setOnDataReceived(value: (js.Array[Double], Double) => Unit): Self = StObject.set(x, "onDataReceived", js.Any.fromFunction2(value))
    
    inline def setOnEndOfStream(value: () => Unit): Self = StObject.set(x, "onEndOfStream", js.Any.fromFunction0(value))
    
    inline def setOnNetworkError(value: () => Unit): Self = StObject.set(x, "onNetworkError", js.Any.fromFunction0(value))
    
    inline def setOnPlayReadyObjectReceived(value: js.Array[Double] => Unit): Self = StObject.set(x, "onPlayReadyObjectReceived", js.Any.fromFunction1(value))
    
    inline def setOnStreamOpened(value: () => Unit): Self = StObject.set(x, "onStreamOpened", js.Any.fromFunction0(value))
  }
}
