...
@js.native
trait WebUIContactMessageActivatedEventArgs extends js.Object {
...
object WebUIContactMessageActivatedEventArgs {
  ...
  @scala.inline
  implicit class WebUIContactMessageActivatedEventArgsOps[Self <: WebUIContactMessageActivatedEventArgs] (val x: Self) extends AnyVal {
