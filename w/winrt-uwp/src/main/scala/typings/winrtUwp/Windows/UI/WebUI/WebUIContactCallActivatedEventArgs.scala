...
@js.native
trait WebUIContactCallActivatedEventArgs extends StObject {
...
object WebUIContactCallActivatedEventArgs {
  ...
  @scala.inline
  implicit class WebUIContactCallActivatedEventArgsMutableBuilder[Self <: WebUIContactCallActivatedEventArgs] (val x: Self) extends AnyVal {
