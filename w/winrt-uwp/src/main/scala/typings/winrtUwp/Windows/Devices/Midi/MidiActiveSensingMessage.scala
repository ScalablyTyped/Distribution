...
trait MidiActiveSensingMessage extends StObject {
...
object MidiActiveSensingMessage {
  ...
  @scala.inline
  implicit class MidiActiveSensingMessageMutableBuilder[Self <: MidiActiveSensingMessage] (val x: Self) extends AnyVal {
