...
trait PerceptionDepthFrameSource extends StObject {
  ...
  def addEventListener_activechanged(`type`: activechanged, listener: TypedEventHandler[PerceptionDepthFrameSource, js.Any]): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_availablechanged(`type`: availablechanged, listener: TypedEventHandler[PerceptionDepthFrameSource, js.Any]): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_cameraintrinsicschanged(`type`: cameraintrinsicschanged, listener: TypedEventHandler[PerceptionDepthFrameSource, js.Any]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_videoprofilechanged(`type`: videoprofilechanged, listener: TypedEventHandler[PerceptionDepthFrameSource, js.Any]): Unit = js.native
  ...
  def onactivechanged(ev: js.Any & WinRTEvent[PerceptionDepthFrameSource]): Unit = js.native
  /** Subscribes to the ActiveChanged event. */
  @JSName("onactivechanged")
  var onactivechanged_Original: TypedEventHandler[PerceptionDepthFrameSource, js.Any] = js.native
  
  /** Subscribes to the AvailableChanged event. */
  def onavailablechanged(ev: js.Any & WinRTEvent[PerceptionDepthFrameSource]): Unit = js.native
  /** Subscribes to the AvailableChanged event. */
  @JSName("onavailablechanged")
  var onavailablechanged_Original: TypedEventHandler[PerceptionDepthFrameSource, js.Any] = js.native
  
  /** Subscribes to the CameraIntrinsicsChanged event. */
  def oncameraintrinsicschanged(ev: js.Any & WinRTEvent[PerceptionDepthFrameSource]): Unit = js.native
  /** Subscribes to the CameraIntrinsicsChanged event. */
  @JSName("oncameraintrinsicschanged")
  var oncameraintrinsicschanged_Original: TypedEventHandler[PerceptionDepthFrameSource, js.Any] = js.native
  ...
  def onvideoprofilechanged(ev: js.Any & WinRTEvent[PerceptionDepthFrameSource]): Unit = js.native
  /** Subscribes to the VideoProfileChanged event. */
  @JSName("onvideoprofilechanged")
  var onvideoprofilechanged_Original: TypedEventHandler[PerceptionDepthFrameSource, js.Any] = js.native
  ...
  def removeEventListener_activechanged(`type`: activechanged, listener: TypedEventHandler[PerceptionDepthFrameSource, js.Any]): Unit = js.native
  @JSName("removeEventListener")
  def removeEventListener_availablechanged(`type`: availablechanged, listener: TypedEventHandler[PerceptionDepthFrameSource, js.Any]): Unit = js.native
  @JSName("removeEventListener")
  def removeEventListener_cameraintrinsicschanged(`type`: cameraintrinsicschanged, listener: TypedEventHandler[PerceptionDepthFrameSource, js.Any]): Unit = js.native
  @JSName("removeEventListener")
  ...
  @JSName("removeEventListener")
  def removeEventListener_videoprofilechanged(`type`: videoprofilechanged, listener: TypedEventHandler[PerceptionDepthFrameSource, js.Any]): Unit = js.native
