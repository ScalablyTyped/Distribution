...
trait PrintBindingOptionDetails extends StObject {
...
object PrintBindingOptionDetails {
  ...
  @scala.inline
  implicit class PrintBindingOptionDetailsMutableBuilder[Self <: PrintBindingOptionDetails] (val x: Self) extends AnyVal {
