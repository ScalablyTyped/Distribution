...
@js.native
trait XmlProcessingInstruction extends StObject {
...
object XmlProcessingInstruction {
  ...
  @scala.inline
  implicit class XmlProcessingInstructionMutableBuilder[Self <: XmlProcessingInstruction] (val x: Self) extends AnyVal {
