...
trait SmsDevice2 extends StObject {
  ...
  def addEventListener_devicestatuschanged(`type`: devicestatuschanged, listener: TypedEventHandler[SmsDevice2, Any]): Unit = js.native
  ...
  def ondevicestatuschanged(ev: Any & WinRTEvent[SmsDevice2]): Unit = js.native
  /** Sets an event handler to be called when the status of the SMS device changes. */
  @JSName("ondevicestatuschanged")
  var ondevicestatuschanged_Original: TypedEventHandler[SmsDevice2, Any] = js.native
  ...
  def removeEventListener_devicestatuschanged(`type`: devicestatuschanged, listener: TypedEventHandler[SmsDevice2, Any]): Unit = js.native
