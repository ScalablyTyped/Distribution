...
trait Print3DTask extends StObject {
  ...
  @JSName("addEventListener")
  def addEventListener_submitting(`type`: submitting, listener: TypedEventHandler[Print3DTask, js.Any]): Unit = js.native
  ...
  def onsubmitting(ev: js.Any & WinRTEvent[Print3DTask]): Unit = js.native
  /** Occurs when the 3D print package has been submitted to the 3D printer. */
  @JSName("onsubmitting")
  var onsubmitting_Original: TypedEventHandler[Print3DTask, js.Any] = js.native
  ...
  @JSName("removeEventListener")
  def removeEventListener_submitting(`type`: submitting, listener: TypedEventHandler[Print3DTask, js.Any]): Unit = js.native
