...
trait AnonItemsReturnValueNumber extends js.Object {
...
object AnonItemsReturnValueNumber {
  @scala.inline
  def apply(items: TimedMetadataTrack, returnValue: Double): AnonItemsReturnValueNumber = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any], returnValue = returnValue.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[AnonItemsReturnValueNumber]
  }
}
