...
abstract class ClaimedSlipPrinter ()
  extends typings.winrtUwp.Windows.Devices.PointOfService.ClaimedSlipPrinter {
  ...
  /* CompleteClass */
  override var linesNearEndToEnd: Double = js.native
  /** Gets the maximum number of lines that the slip printer station can print on a form. */
  /* CompleteClass */
  override var maxLines: Double = js.native
  ...
  /* CompleteClass */
  override var printSide: typings.winrtUwp.Windows.Devices.PointOfService.PosPrinterPrintSide = js.native
