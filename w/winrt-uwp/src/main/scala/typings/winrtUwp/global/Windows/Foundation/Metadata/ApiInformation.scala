...
object ApiInformation {
  ...
  /* static member */
  @scala.inline
  def isApiContractPresent(contractName: String, majorVersion: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isApiContractPresent")(contractName.asInstanceOf[js.Any], majorVersion.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  /**
  ...
  /* static member */
  @scala.inline
  def isApiContractPresent(contractName: String, majorVersion: Double, minorVersion: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isApiContractPresent")(contractName.asInstanceOf[js.Any], majorVersion.asInstanceOf[js.Any], minorVersion.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /* static member */
  @scala.inline
  def isEnumNamedValuePresent(enumTypeName: String, valueName: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isEnumNamedValuePresent")(enumTypeName.asInstanceOf[js.Any], valueName.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /* static member */
  @scala.inline
  def isEventPresent(typeName: String, eventName: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isEventPresent")(typeName.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /* static member */
  @scala.inline
  def isMethodPresent(typeName: String, methodName: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isMethodPresent")(typeName.asInstanceOf[js.Any], methodName.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  /**
  ...
  /* static member */
  @scala.inline
  def isMethodPresent(typeName: String, methodName: String, inputParameterCount: Double): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isMethodPresent")(typeName.asInstanceOf[js.Any], methodName.asInstanceOf[js.Any], inputParameterCount.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /* static member */
  @scala.inline
  def isPropertyPresent(typeName: String, propertyName: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isPropertyPresent")(typeName.asInstanceOf[js.Any], propertyName.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /* static member */
  @scala.inline
  def isReadOnlyPropertyPresent(typeName: String, propertyName: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isReadOnlyPropertyPresent")(typeName.asInstanceOf[js.Any], propertyName.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /* static member */
  @scala.inline
  def isTypePresent(typeName: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTypePresent")(typeName.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  /* static member */
  @scala.inline
  def isWriteablePropertyPresent(typeName: String, propertyName: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isWriteablePropertyPresent")(typeName.asInstanceOf[js.Any], propertyName.asInstanceOf[js.Any])).asInstanceOf[Boolean]
}
