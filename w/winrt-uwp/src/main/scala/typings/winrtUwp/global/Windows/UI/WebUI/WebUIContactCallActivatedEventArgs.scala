...
/* note: abstract class */ @JSGlobal("Windows.UI.WebUI.WebUIContactCallActivatedEventArgs")
@js.native
open class WebUIContactCallActivatedEventArgs ()
  extends StObject
     with typings.winrtUwp.Windows.UI.WebUI.WebUIContactCallActivatedEventArgs {
