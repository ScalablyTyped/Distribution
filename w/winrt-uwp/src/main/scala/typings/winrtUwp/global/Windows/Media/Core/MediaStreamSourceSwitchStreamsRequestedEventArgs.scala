...
/* note: abstract class */ @JSGlobal("Windows.Media.Core.MediaStreamSourceSwitchStreamsRequestedEventArgs")
@js.native
open class MediaStreamSourceSwitchStreamsRequestedEventArgs ()
  extends StObject
