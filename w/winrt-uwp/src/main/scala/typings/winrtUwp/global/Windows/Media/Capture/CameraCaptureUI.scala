...
class CameraCaptureUI ()
  extends typings.winrtUwp.Windows.Media.Capture.CameraCaptureUI {
  ...
  /* CompleteClass */
  override var photoSettings: typings.winrtUwp.Windows.Media.Capture.CameraCaptureUIPhotoCaptureSettings = js.native
  ...
  /* CompleteClass */
  override var videoSettings: typings.winrtUwp.Windows.Media.Capture.CameraCaptureUIVideoCaptureSettings = js.native
  /**
