...
class EndpointPair protected ()
  ...
  /* CompleteClass */
  override var localHostName: typings.winrtUwp.Windows.Networking.HostName = js.native
  ...
  /* CompleteClass */
  override var remoteHostName: typings.winrtUwp.Windows.Networking.HostName = js.native
