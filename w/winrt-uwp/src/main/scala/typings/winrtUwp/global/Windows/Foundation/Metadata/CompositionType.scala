...
object CompositionType extends js.Object {
  ...
  /* 0 */ val `protected`: typings.winrtUwp.Windows.Foundation.Metadata.CompositionType.`protected` with Double = js.native
  
  /* 1 */ val public: typings.winrtUwp.Windows.Foundation.Metadata.CompositionType.public with Double = js.native
}
