...
/* note: abstract class */ @JSGlobal("Windows.Storage.SystemImageProperties")
@js.native
open class SystemImageProperties ()
  extends StObject
     with typings.winrtUwp.Windows.Storage.SystemImageProperties {
