...
object FileRevocationManager extends js.Object {
  ...
  /**
    ...
    */
  def getStatusAsync(storageItem: IStorageItem): IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus] = js.native
  /**
    ...
    */
  def protectAsync(storageItem: IStorageItem, enterpriseIdentity: String): IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.Security.EnterpriseData.FileProtectionStatus] = js.native
  /**
