...
abstract class ApplicationDataContainer ()
  extends typings.winrtUwp.Windows.Storage.ApplicationDataContainer {
  /** Gets the child application settings containers of this application settings container. */
  /* CompleteClass */
  override var containers: IMapView[String, typings.winrtUwp.Windows.Storage.ApplicationDataContainer] = js.native
  /** Gets the type (local or roaming) of the app data store that is associated with the current settings container. */
  /* CompleteClass */
  override var locality: typings.winrtUwp.Windows.Storage.ApplicationDataLocality = js.native
