...
object PrintCollation extends StObject {
  ...
  /* 2 */ val printerCustom: typings.winrtUwp.Windows.Graphics.Printing.PrintCollation.printerCustom with Double = js.native
  
  /* 4 */ val uncollated: typings.winrtUwp.Windows.Graphics.Printing.PrintCollation.uncollated with Double = js.native
}
