...
object KnownCameraIntrinsicsProperties {
  ...
  inline def focalLength_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("focalLength")(x.asInstanceOf[js.Any])
  ...
  inline def principalPoint_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("principalPoint")(x.asInstanceOf[js.Any])
  ...
  inline def radialDistortion_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("radialDistortion")(x.asInstanceOf[js.Any])
  ...
  inline def tangentialDistortion_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("tangentialDistortion")(x.asInstanceOf[js.Any])
}
