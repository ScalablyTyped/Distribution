...
object PrintColorMode extends StObject {
  ...
  /* 5 */ val monochrome: typings.winrtUwp.Windows.Graphics.Printing.PrintColorMode.monochrome with Double = js.native
  
  /* 1 */ val notAvailable: typings.winrtUwp.Windows.Graphics.Printing.PrintColorMode.notAvailable with Double = js.native
  
  /* 2 */ val printerCustom: typings.winrtUwp.Windows.Graphics.Printing.PrintColorMode.printerCustom with Double = js.native
}
