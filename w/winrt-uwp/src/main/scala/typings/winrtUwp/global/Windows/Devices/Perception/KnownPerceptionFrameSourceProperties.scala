...
object KnownPerceptionFrameSourceProperties {
  ...
  @scala.inline
  def deviceId_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("deviceId")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def deviceModelVersion_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("deviceModelVersion")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def enclosureLocation_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("enclosureLocation")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def frameKind_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("frameKind")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def physicalDeviceIds_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("physicalDeviceIds")(x.asInstanceOf[js.Any])
}
