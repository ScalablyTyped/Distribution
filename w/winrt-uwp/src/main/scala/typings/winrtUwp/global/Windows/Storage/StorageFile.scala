...
object StorageFile {
  ...
  /**
    ...
    */
  /* static member */
  inline def getFileFromApplicationUriAsync(uri: Uri): IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.Storage.StorageFile] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFileFromApplicationUriAsync")(uri.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.Storage.StorageFile]]
  ...
  /**
    ...
    */
  /* static member */
  inline def getFileFromPathAsync(path: String): IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.Storage.StorageFile] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFileFromPathAsync")(path.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.Storage.StorageFile]]
