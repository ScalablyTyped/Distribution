...
abstract class ContactAnnotationList ()
  extends typings.winrtUwp.Windows.ApplicationModel.Contacts.ContactAnnotationList {
  ...
  /* CompleteClass */
  override var providerPackageFamilyName: String = js.native
  /** Gets the ID for the UserDataAccount used by the app. */
  /* CompleteClass */
  override var userDataAccountId: String = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def findAnnotationsAsync(): IPromiseWithIAsyncOperation[IVectorView[_]] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def findAnnotationsByRemoteIdAsync(remoteId: String): IPromiseWithIAsyncOperation[IVectorView[_]] = js.native
  /**
