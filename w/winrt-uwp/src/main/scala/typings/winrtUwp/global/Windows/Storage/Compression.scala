...
object Compression {
  ...
  object CompressAlgorithm extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.winrtUwp.Windows.Storage.Compression.CompressAlgorithm & Double] = js.native
    
    /* 0 */ val invalidAlgorithm: typings.winrtUwp.Windows.Storage.Compression.CompressAlgorithm.invalidAlgorithm & Double = js.native
    
    /* 5 */ val lzms: typings.winrtUwp.Windows.Storage.Compression.CompressAlgorithm.lzms & Double = js.native
    
    /* 2 */ val mszip: typings.winrtUwp.Windows.Storage.Compression.CompressAlgorithm.mszip & Double = js.native
    
    /* 1 */ val nullAlgorithm: typings.winrtUwp.Windows.Storage.Compression.CompressAlgorithm.nullAlgorithm & Double = js.native
    
    /* 3 */ val xpress: typings.winrtUwp.Windows.Storage.Compression.CompressAlgorithm.xpress & Double = js.native
    
    /* 4 */ val xpressHuff: typings.winrtUwp.Windows.Storage.Compression.CompressAlgorithm.xpressHuff & Double = js.native
  }
