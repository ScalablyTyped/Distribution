...
abstract class MobileBroadbandUiccApp ()
  extends typings.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandUiccApp {
  ...
  /* CompleteClass */
  override var kind: typings.winrtUwp.Windows.Networking.NetworkOperators.UiccAppKind = js.native
  /**
