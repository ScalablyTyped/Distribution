...
/* note: abstract class */ @JSGlobal("Windows.Devices.PointOfService.MagneticStripeReaderEncryptionAlgorithms")
@js.native
open class MagneticStripeReaderEncryptionAlgorithms ()
  extends StObject
