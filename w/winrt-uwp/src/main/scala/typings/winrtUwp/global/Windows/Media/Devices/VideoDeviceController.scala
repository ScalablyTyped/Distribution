...
abstract class VideoDeviceController ()
  extends StObject
     with typings.winrtUwp.Windows.Media.Devices.VideoDeviceController {
  
  /** Gets the advanced photo capture control for this video device. */
  /* CompleteClass */
  var advancedPhotoControl: typings.winrtUwp.Windows.Media.Devices.AdvancedPhotoControl = js.native
  
  /** Specifies whether back-light compensation is enabled on the camera. */
  /* CompleteClass */
  var backlightCompensation: typings.winrtUwp.Windows.Media.Devices.MediaDeviceControl = js.native
  
  /** Gets or sets the brightness level on the camera. */
  /* CompleteClass */
  var brightness: typings.winrtUwp.Windows.Media.Devices.MediaDeviceControl = js.native
  
  /** Gets or sets the contrast level on the camera. */
  /* CompleteClass */
  var contrast: typings.winrtUwp.Windows.Media.Devices.MediaDeviceControl = js.native
  ...
  /* CompleteClass */
  var desiredOptimization: typings.winrtUwp.Windows.Media.Devices.MediaCaptureOptimization = js.native
  
  /** Gets or sets the camera's exposure time. */
  /* CompleteClass */
  var exposure: typings.winrtUwp.Windows.Media.Devices.MediaDeviceControl = js.native
  
  /** Gets the exposure compensation control for this video device. */
  /* CompleteClass */
  var exposureCompensationControl: typings.winrtUwp.Windows.Media.Devices.ExposureCompensationControl = js.native
  
  /** Gets the exposure control for this video device. */
  /* CompleteClass */
  var exposureControl: typings.winrtUwp.Windows.Media.Devices.ExposureControl = js.native
  
  /** Gets the ExposurePriorityVideoControl associated with the VideoDeviceController . */
  /* CompleteClass */
  var exposurePriorityVideoControl: typings.winrtUwp.Windows.Media.Devices.ExposurePriorityVideoControl = js.native
  
  /** Gets the flash control for this video device. */
  /* CompleteClass */
  var flashControl: typings.winrtUwp.Windows.Media.Devices.FlashControl = js.native
  
  /** Gets or sets the camera's focus setting. */
  /* CompleteClass */
  var focus: typings.winrtUwp.Windows.Media.Devices.MediaDeviceControl = js.native
  
  /** Gets the focus control for this video device. */
  /* CompleteClass */
  var focusControl: typings.winrtUwp.Windows.Media.Devices.FocusControl = js.native
  ...
  /* CompleteClass */
  var hdrVideoControl: typings.winrtUwp.Windows.Media.Devices.HdrVideoControl = js.native
  
  /** Gets or sets the camera's hue setting. */
  /* CompleteClass */
  var hue: typings.winrtUwp.Windows.Media.Devices.MediaDeviceControl = js.native
  
  /** Gets the ISO film speed control for this video device. */
  /* CompleteClass */
  var isoSpeedControl: typings.winrtUwp.Windows.Media.Devices.IsoSpeedControl = js.native
  
  /** Gets the low shutter lag photo control for this video device. */
  /* CompleteClass */
  var lowLagPhoto: typings.winrtUwp.Windows.Media.Devices.LowLagPhotoControl = js.native
  
  /** Gets the low shutter lag photo sequence control for this video device. */
  /* CompleteClass */
  var lowLagPhotoSequence: typings.winrtUwp.Windows.Media.Devices.LowLagPhotoSequenceControl = js.native
  
  /** Gets the OpticalImageStabilizationControl associated with the VideoDeviceController . */
  /* CompleteClass */
  var opticalImageStabilizationControl: typings.winrtUwp.Windows.Media.Devices.OpticalImageStabilizationControl = js.native
  
  /** Gets or sets the camera's pan setting. */
  /* CompleteClass */
  var pan: typings.winrtUwp.Windows.Media.Devices.MediaDeviceControl = js.native
  
  /** Gets the photo confirmation control for this video device. */
  /* CompleteClass */
  var photoConfirmationControl: typings.winrtUwp.Windows.Media.Devices.PhotoConfirmationControl = js.native
  
  /** Gets or sets the primary use for the device. */
  /* CompleteClass */
  var primaryUse: typings.winrtUwp.Windows.Media.Devices.CaptureUse = js.native
  
  /** Gets the regions of interest control for this video device. */
  /* CompleteClass */
  var regionsOfInterestControl: typings.winrtUwp.Windows.Media.Devices.RegionsOfInterestControl = js.native
  
  /** Gets or sets the camera's roll setting. */
  /* CompleteClass */
  var roll: typings.winrtUwp.Windows.Media.Devices.MediaDeviceControl = js.native
  
  /** Gets the scene mode control for this video device. */
  /* CompleteClass */
  var sceneModeControl: typings.winrtUwp.Windows.Media.Devices.SceneModeControl = js.native
  ...
  /* CompleteClass */
  var tilt: typings.winrtUwp.Windows.Media.Devices.MediaDeviceControl = js.native
  
  /** Gets the torch control for this video device. */
  /* CompleteClass */
  var torchControl: typings.winrtUwp.Windows.Media.Devices.TorchControl = js.native
  ...
  /* CompleteClass */
  var whiteBalance: typings.winrtUwp.Windows.Media.Devices.MediaDeviceControl = js.native
  
  /** Gets the white balance control for this video device. */
  /* CompleteClass */
  var whiteBalanceControl: typings.winrtUwp.Windows.Media.Devices.WhiteBalanceControl = js.native
  
  /** Gets and sets the camera's zoom setting. */
  /* CompleteClass */
  var zoom: typings.winrtUwp.Windows.Media.Devices.MediaDeviceControl = js.native
  
  /** Gets the ZoomControl associated with the VideoDeviceController . */
  /* CompleteClass */
  var zoomControl: typings.winrtUwp.Windows.Media.Devices.ZoomControl = js.native
}
