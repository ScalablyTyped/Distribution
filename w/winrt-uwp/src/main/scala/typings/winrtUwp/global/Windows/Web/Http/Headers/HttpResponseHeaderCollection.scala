...
abstract class HttpResponseHeaderCollection ()
  extends typings.winrtUwp.Windows.Web.Http.Headers.HttpResponseHeaderCollection {
  ...
  /* CompleteClass */
  override var allow: typings.winrtUwp.Windows.Web.Http.Headers.HttpMethodHeaderValueCollection = js.native
  ...
  /* CompleteClass */
  override var cacheControl: typings.winrtUwp.Windows.Web.Http.Headers.HttpCacheDirectiveHeaderValueCollection = js.native
  ...
  /* CompleteClass */
  override var connection: typings.winrtUwp.Windows.Web.Http.Headers.HttpConnectionOptionHeaderValueCollection = js.native
  ...
  /* CompleteClass */
  override var proxyAuthenticate: typings.winrtUwp.Windows.Web.Http.Headers.HttpChallengeHeaderValueCollection = js.native
  ...
  /* CompleteClass */
  override var retryAfter: typings.winrtUwp.Windows.Web.Http.Headers.HttpDateOrDeltaHeaderValue = js.native
  ...
  /* CompleteClass */
  override var transferEncoding: typings.winrtUwp.Windows.Web.Http.Headers.HttpTransferCodingHeaderValueCollection = js.native
  ...
  /* CompleteClass */
  override var wwwAuthenticate: typings.winrtUwp.Windows.Web.Http.Headers.HttpChallengeHeaderValueCollection = js.native
  /**
