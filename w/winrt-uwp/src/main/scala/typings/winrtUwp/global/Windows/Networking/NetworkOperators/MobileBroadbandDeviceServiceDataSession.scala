...
@js.native
abstract class MobileBroadbandDeviceServiceDataSession ()
  extends typings.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandDeviceServiceDataSession
