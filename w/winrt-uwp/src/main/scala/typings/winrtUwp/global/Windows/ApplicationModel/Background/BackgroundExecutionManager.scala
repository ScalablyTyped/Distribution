...
object BackgroundExecutionManager {
  ...
  /**
    ...
    */
  /* static member */
  inline def getAccessStatus(): typings.winrtUwp.Windows.ApplicationModel.Background.BackgroundAccessStatus = ^.asInstanceOf[js.Dynamic].applyDynamic("getAccessStatus")().asInstanceOf[typings.winrtUwp.Windows.ApplicationModel.Background.BackgroundAccessStatus]
  /**
    ...
    */
  /* static member */
  inline def getAccessStatus(applicationId: String): typings.winrtUwp.Windows.ApplicationModel.Background.BackgroundAccessStatus = ^.asInstanceOf[js.Dynamic].applyDynamic("getAccessStatus")(applicationId.asInstanceOf[js.Any]).asInstanceOf[typings.winrtUwp.Windows.ApplicationModel.Background.BackgroundAccessStatus]
  ...
  /**
    ...
    */
  /* static member */
  inline def requestAccessAsync(): IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.ApplicationModel.Background.BackgroundAccessStatus] = ^.asInstanceOf[js.Dynamic].applyDynamic("requestAccessAsync")().asInstanceOf[IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.ApplicationModel.Background.BackgroundAccessStatus]]
  /**
    * Requests access for an app to run background tasks.
