...
object PerceptionColorFrameSource {
  ...
  /* static member */
  @scala.inline
  def createWatcher(): typings.winrtUwp.Windows.Devices.Perception.PerceptionColorFrameSourceWatcher = ^.asInstanceOf[js.Dynamic].applyDynamic("createWatcher")().asInstanceOf[typings.winrtUwp.Windows.Devices.Perception.PerceptionColorFrameSourceWatcher]
