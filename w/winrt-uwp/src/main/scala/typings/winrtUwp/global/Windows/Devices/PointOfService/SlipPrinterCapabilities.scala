...
abstract class SlipPrinterCapabilities ()
  extends typings.winrtUwp.Windows.Devices.PointOfService.SlipPrinterCapabilities {
  ...
  /* CompleteClass */
  override var isBothSidesPrintingSupported: Boolean = js.native
  ...
  /* CompleteClass */
  override var isFullLengthSupported: Boolean = js.native
