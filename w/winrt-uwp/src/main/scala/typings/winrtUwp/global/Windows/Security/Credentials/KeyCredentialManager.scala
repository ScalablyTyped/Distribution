...
object KeyCredentialManager extends js.Object {
  ...
  /**
    ...
    */
  def requestCreateAsync(name: String, option: typings.winrtUwp.Windows.Security.Credentials.KeyCredentialCreationOption): IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.Security.Credentials.KeyCredentialRetrievalResult] = js.native
}
