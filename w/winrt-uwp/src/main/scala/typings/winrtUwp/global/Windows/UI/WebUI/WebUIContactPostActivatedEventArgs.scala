...
/* note: abstract class */ @JSGlobal("Windows.UI.WebUI.WebUIContactPostActivatedEventArgs")
@js.native
open class WebUIContactPostActivatedEventArgs ()
  extends StObject
     with typings.winrtUwp.Windows.UI.WebUI.WebUIContactPostActivatedEventArgs {
