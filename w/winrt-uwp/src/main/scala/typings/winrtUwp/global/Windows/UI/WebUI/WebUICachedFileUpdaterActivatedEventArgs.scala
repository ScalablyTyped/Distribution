...
/* note: abstract class */ @JSGlobal("Windows.UI.WebUI.WebUICachedFileUpdaterActivatedEventArgs")
@js.native
open class WebUICachedFileUpdaterActivatedEventArgs ()
  extends StObject
     with typings.winrtUwp.Windows.UI.WebUI.WebUICachedFileUpdaterActivatedEventArgs {
