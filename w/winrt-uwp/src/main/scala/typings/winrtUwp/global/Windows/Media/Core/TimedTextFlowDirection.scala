...
object TimedTextFlowDirection extends js.Object {
  ...
  /* 0 */ val leftToRight: typings.winrtUwp.Windows.Media.Core.TimedTextFlowDirection.leftToRight with Double = js.native
  
  /* 1 */ val rightToLeft: typings.winrtUwp.Windows.Media.Core.TimedTextFlowDirection.rightToLeft with Double = js.native
}
