...
class EmailQueryOptions ()
  ...
  /* CompleteClass */
  override var kind: typings.winrtUwp.Windows.ApplicationModel.Email.EmailQueryKind = js.native
  /** Gets or sets the direction of the sort for the query results. */
  /* CompleteClass */
  override var sortDirection: typings.winrtUwp.Windows.ApplicationModel.Email.EmailQuerySortDirection = js.native
  /** Gets or sets a Boolean value indicating whether the query results should be sorted. */
  /* CompleteClass */
  override var sortProperty: typings.winrtUwp.Windows.ApplicationModel.Email.EmailQuerySortProperty = js.native
  /** Gets the text to search for. */
  /* CompleteClass */
  override var textSearch: typings.winrtUwp.Windows.ApplicationModel.Email.EmailQueryTextSearch = js.native
}
