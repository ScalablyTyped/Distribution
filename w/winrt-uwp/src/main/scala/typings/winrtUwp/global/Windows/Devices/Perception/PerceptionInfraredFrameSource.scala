...
object PerceptionInfraredFrameSource {
  ...
  /* static member */
  @scala.inline
  def createWatcher(): typings.winrtUwp.Windows.Devices.Perception.PerceptionInfraredFrameSourceWatcher = ^.asInstanceOf[js.Dynamic].applyDynamic("createWatcher")().asInstanceOf[typings.winrtUwp.Windows.Devices.Perception.PerceptionInfraredFrameSourceWatcher]
