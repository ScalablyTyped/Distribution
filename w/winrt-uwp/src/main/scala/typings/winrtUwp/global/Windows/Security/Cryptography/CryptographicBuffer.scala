...
object CryptographicBuffer {
  ...
  /**
    ...
    */
  /* static member */
  inline def convertBinaryToString(encoding: typings.winrtUwp.Windows.Security.Cryptography.BinaryStringEncoding, buffer: IBuffer): String = (^.asInstanceOf[js.Dynamic].applyDynamic("convertBinaryToString")(encoding.asInstanceOf[js.Any], buffer.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  /**
    ...
    */
  /* static member */
  inline def convertStringToBinary(value: String, encoding: typings.winrtUwp.Windows.Security.Cryptography.BinaryStringEncoding): IBuffer = (^.asInstanceOf[js.Dynamic].applyDynamic("convertStringToBinary")(value.asInstanceOf[js.Any], encoding.asInstanceOf[js.Any])).asInstanceOf[IBuffer]
  ...
  /**
    ...
    */
  /* static member */
  inline def copyToByteArray(buffer: IBuffer): js.Array[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("copyToByteArray")(buffer.asInstanceOf[js.Any]).asInstanceOf[js.Array[Double]]
  ...
  /**
    ...
    */
  /* static member */
  inline def createFromByteArray(value: js.Array[Double]): IBuffer = ^.asInstanceOf[js.Dynamic].applyDynamic("createFromByteArray")(value.asInstanceOf[js.Any]).asInstanceOf[IBuffer]
