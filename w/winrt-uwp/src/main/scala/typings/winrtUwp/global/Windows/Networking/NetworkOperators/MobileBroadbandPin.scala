...
abstract class MobileBroadbandPin ()
  extends typings.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPin {
  ...
  /* CompleteClass */
  override var format: typings.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinFormat = js.native
  /** Gets the lock state for a mobile broadband PIN. */
  /* CompleteClass */
  override var lockState: typings.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinLockState = js.native
  ...
  /* CompleteClass */
  override var `type`: typings.winrtUwp.Windows.Networking.NetworkOperators.MobileBroadbandPinType = js.native
  /**
