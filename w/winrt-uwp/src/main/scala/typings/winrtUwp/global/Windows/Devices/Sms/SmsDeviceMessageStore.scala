...
abstract class SmsDeviceMessageStore ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def deleteMessagesAsync(messageFilter: typings.winrtUwp.Windows.Devices.Sms.SmsMessageFilter): IPromiseWithIAsyncAction = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getMessagesAsync(messageFilter: typings.winrtUwp.Windows.Devices.Sms.SmsMessageFilter): IPromiseWithIAsyncOperationWithProgress[IVectorView[_], Double] = js.native
}
