...
object CurrentApp extends js.Object {
  ...
  var licenseInformation: typings.winrtUwp.Windows.ApplicationModel.Store.LicenseInformation = js.native
  ...
  /**
    ...
    */
  def reportConsumableFulfillmentAsync(productId: String, transactionId: String): IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.ApplicationModel.Store.FulfillmentResult] = js.native
  /**
