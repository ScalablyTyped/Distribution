...
object DownloadsFolder {
  ...
  /* static member */
  @scala.inline
  def createFileAsync(desiredName: String): IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.Storage.StorageFile] = ^.asInstanceOf[js.Dynamic].applyDynamic("createFileAsync")(desiredName.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.Storage.StorageFile]]
  /**
  ...
  /* static member */
  @scala.inline
  def createFolderAsync(desiredName: String): IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.Storage.StorageFolder] = ^.asInstanceOf[js.Dynamic].applyDynamic("createFolderAsync")(desiredName.asInstanceOf[js.Any]).asInstanceOf[IPromiseWithIAsyncOperation[typings.winrtUwp.Windows.Storage.StorageFolder]]
  /**
