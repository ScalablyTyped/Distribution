...
abstract class SceneModeControl ()
  extends typings.winrtUwp.Windows.Media.Devices.SceneModeControl {
  /** Gets the scene modes supported on the capture device. */
  /* CompleteClass */
  override var supportedModes: IVectorView[typings.winrtUwp.Windows.Media.Devices.CaptureSceneMode] = js.native
  /** Gets the current scene mod ethe capture device is set to. */
  /* CompleteClass */
  override var value: typings.winrtUwp.Windows.Media.Devices.CaptureSceneMode = js.native
  /**
