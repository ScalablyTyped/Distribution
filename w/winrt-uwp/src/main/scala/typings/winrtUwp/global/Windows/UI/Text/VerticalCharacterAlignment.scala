...
object VerticalCharacterAlignment extends StObject {
  ...
  /* 1 */ val baseline: typings.winrtUwp.Windows.UI.Text.VerticalCharacterAlignment.baseline with Double = js.native
  
  /* 2 */ val bottom: typings.winrtUwp.Windows.UI.Text.VerticalCharacterAlignment.bottom with Double = js.native
  
  /* 0 */ val top: typings.winrtUwp.Windows.UI.Text.VerticalCharacterAlignment.top with Double = js.native
}
