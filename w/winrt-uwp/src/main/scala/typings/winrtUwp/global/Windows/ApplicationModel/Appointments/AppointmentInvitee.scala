...
class AppointmentInvitee ()
  extends StObject
     with typings.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentInvitee {
  ...
  /* CompleteClass */
  var response: typings.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentParticipantResponse = js.native
  ...
  /* CompleteClass */
  var role: typings.winrtUwp.Windows.ApplicationModel.Appointments.AppointmentParticipantRole = js.native
}
