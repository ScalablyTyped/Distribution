...
object Services extends js.Object {
  ...
  abstract class WiFiDirectServiceAutoAcceptSessionConnectedEventArgs ()
    ...
    /* CompleteClass */
    override var session: typings.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceSession = js.native
  ...
  abstract class WiFiDirectServiceSessionRequest ()
    ...
    /* CompleteClass */
    override var provisioningInfo: typings.winrtUwp.Windows.Devices.WiFiDirect.Services.WiFiDirectServiceProvisioningInfo = js.native
