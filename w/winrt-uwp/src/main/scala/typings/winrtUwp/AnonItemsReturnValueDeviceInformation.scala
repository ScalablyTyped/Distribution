...
trait AnonItemsReturnValueDeviceInformation extends js.Object {
...
object AnonItemsReturnValueDeviceInformation {
  @scala.inline
  def apply(items: DeviceInformation, returnValue: Double): AnonItemsReturnValueDeviceInformation = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any], returnValue = returnValue.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[AnonItemsReturnValueDeviceInformation]
  }
}
