...
@js.native
trait ItemsLanguage extends js.Object {
...
object ItemsLanguage {
  ...
  @scala.inline
  implicit class ItemsLanguageOps[Self <: ItemsLanguage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: Language): Self = this.set("items", value.asInstanceOf[js.Any])
