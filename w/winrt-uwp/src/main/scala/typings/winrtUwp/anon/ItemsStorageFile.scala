...
object ItemsStorageFile {
  ...
  @scala.inline
  implicit class ItemsStorageFileOps[Self <: ItemsStorageFile] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItems(value: StorageFile): Self = this.set("items", value.asInstanceOf[js.Any])
    @scala.inline
