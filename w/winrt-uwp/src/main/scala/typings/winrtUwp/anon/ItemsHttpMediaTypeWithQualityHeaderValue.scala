...
object ItemsHttpMediaTypeWithQualityHeaderValue {
  ...
  @scala.inline
  implicit class ItemsHttpMediaTypeWithQualityHeaderValueOps[Self <: ItemsHttpMediaTypeWithQualityHeaderValue] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItems(value: HttpMediaTypeWithQualityHeaderValue): Self = this.set("items", value.asInstanceOf[js.Any])
