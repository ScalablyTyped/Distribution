...
abstract class GpioPin () extends js.Object {
  ...
  var onvaluechanged_Original: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[GpioPin, GpioPinValueChangedEventArgs] = js.native
  /** Gets the pin number of the general-purpose I/O (GPIO) pin. */
  var pinNumber: scala.Double = js.native
