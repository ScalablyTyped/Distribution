...
abstract class SmsDeviceMessageStore () extends js.Object {
  ...
  var maxMessages: scala.Double = js.native
  /**
    ...
    */
  def deleteMessageAsync(messageId: scala.Double): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncAction = js.native
  /**
    ...
    * @return A new message operation object that is used to start and track the asynchronous operation.
    */
  def deleteMessagesAsync(messageFilter: SmsMessageFilter): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncAction = js.native
  /**
    ...
    */
  def getMessageAsync(messageId: scala.Double): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[ISmsMessage] = js.native
  /**
    ...
    * @return Returns a new message operation object that is used to start and track the asynchronous operation.
    */
  def getMessagesAsync(messageFilter: SmsMessageFilter): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperationWithProgress[winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[_], scala.Double] = js.native
}
