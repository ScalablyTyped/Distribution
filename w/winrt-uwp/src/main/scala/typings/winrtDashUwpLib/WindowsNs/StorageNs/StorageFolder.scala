...
abstract class StorageFolder () extends js.Object {
  ...
  /**
    ...
    */
  def createFileAsync(desiredName: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[StorageFile] = js.native
  /**
    ...
    * @return When this method completes, it returns a StorageFile that represents the new file.
    */
  def createFileAsync(desiredName: java.lang.String, options: CreationCollisionOption): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[StorageFile] = js.native
  /**
  ...
  /**
    ...
    */
  def createFolderAsync(desiredName: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[StorageFolder] = js.native
  /**
    ...
    * @return When this method completes, it returns a StorageFolder that represents the new subfolder.
    */
  def createFolderAsync(desiredName: java.lang.String, options: CreationCollisionOption): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[StorageFolder] = js.native
  /**
  ...
  /**
    ...
    */
  def getFileAsync(name: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[StorageFile] = js.native
  /**
  ...
  /**
    ...
    */
  def getFolderAsync(name: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[StorageFolder] = js.native
  /**
  ...
  /**
    ...
    */
  def getItemAsync(name: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[IStorageItem] = js.native
  /**
...
object StorageFolder extends js.Object {
  /**
    ...
    */
  def getFolderFromPathAsync(path: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.StorageNs.StorageFolder] = js.native
}
