...
class QueryOptions () extends js.Object {
  ...
  /**
                   ...
                   */
  def this(query: CommonFileQuery, fileTypeFilter: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IIterable[java.lang.String]) = this()
  ...
  var applicationSearchFilter: java.lang.String = js.native
  ...
  var groupPropertyName: java.lang.String = js.native
  ...
  var sortOrder: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[SortEntry] = js.native
  /** Gets the filter for storage provider identifiers. */
  var storageProviderIdFilter: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[java.lang.String] = js.native
  ...
  var userSearchFilter: java.lang.String = js.native
  /**
                   ...
                   */
  def loadFromString(value: java.lang.String): scala.Unit = js.native
  /**
                   ...
                   */
  def saveToString(): java.lang.String = js.native
  /**
  ...
  def setPropertyPrefetch(
    options: winrtDashUwpLib.WindowsNs.StorageNs.FilePropertiesNs.PropertyPrefetchOptions,
