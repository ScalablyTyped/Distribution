...
class Printing3DMultiplePropertyMaterialGroup protected () extends js.Object {
  ...
  var materialGroupIndices: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[scala.Double] = js.native
  ...
  var multipleProperties: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[Printing3DMultiplePropertyMaterial] = js.native
}
