...
abstract class UsbDevice () extends js.Object {
  ...
  /**
                   ...
                   */
  def sendControlInTransferAsync(setupPacket: UsbSetupPacket): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.StorageNs.StreamsNs.IBuffer] = js.native
  /**
                   ...
                   * @return Returns an IAsyncOperation(IBuffer) object that returns the results of the operation.
                   */
  def sendControlInTransferAsync(setupPacket: UsbSetupPacket, buffer: winrtDashUwpLib.WindowsNs.StorageNs.StreamsNs.IBuffer): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.StorageNs.StreamsNs.IBuffer] = js.native
  /**
                   ...
                   */
  def sendControlOutTransferAsync(setupPacket: UsbSetupPacket): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[scala.Double] = js.native
  /**
...
object UsbDevice extends js.Object {
  /**
                   ...
                   */
  def fromIdAsync(deviceId: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.DevicesNs.UsbNs.UsbDevice] = js.native
  /**
                   ...
                   */
  def getDeviceClassSelector(usbClass: winrtDashUwpLib.WindowsNs.DevicesNs.UsbNs.UsbDeviceClass): java.lang.String = js.native
  /**
                   ...
                   * @return String formatted as an AQS query.
                   */
  def getDeviceSelector(vendorId: scala.Double, productId: scala.Double): java.lang.String = js.native
  /**
                   ...
                   * @return String formatted as an AQS query.
                   */
  def getDeviceSelector(vendorId: scala.Double, productId: scala.Double, winUsbInterfaceClass: java.lang.String): java.lang.String = js.native
  /**
                   ...
                   * @return String formatted as an AQS query.
                   */
  def getDeviceSelector(winUsbInterfaceClass: java.lang.String): java.lang.String = js.native
}
