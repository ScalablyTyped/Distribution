...
abstract class PerceptionDepthFrameSource () extends js.Object {
  ...
  var onactivechanged_Original: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[PerceptionDepthFrameSource, _] = js.native
  /** Subscribes to the AvailableChanged event. */
  @JSName("onavailablechanged")
  var onavailablechanged_Original: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[PerceptionDepthFrameSource, _] = js.native
  /** Subscribes to the CameraIntrinsicsChanged event. */
  @JSName("oncameraintrinsicschanged")
  var oncameraintrinsicschanged_Original: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[PerceptionDepthFrameSource, _] = js.native
  /** Subscribes to the PropertiesChanged event. */
  @JSName("onpropertieschanged")
  var onpropertieschanged_Original: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[PerceptionDepthFrameSource, PerceptionFrameSourcePropertiesChangedEventArgs] = js.native
  /** Subscribes to the VideoProfileChanged event. */
  @JSName("onvideoprofilechanged")
  var onvideoprofilechanged_Original: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[PerceptionDepthFrameSource, _] = js.native
  ...
  def addEventListener_activechanged(
    ...
    listener: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[PerceptionDepthFrameSource, _]
  ...
  def addEventListener_propertieschanged(
    ...
    listener: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[PerceptionDepthFrameSource, PerceptionFrameSourcePropertiesChangedEventArgs]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  ...
  /** Subscribes to the ActiveChanged event. */
  def onactivechanged(ev: js.Any with winrtDashUwpLib.WindowsNs.WinRTEvent[PerceptionDepthFrameSource]): scala.Unit = js.native
  /** Subscribes to the AvailableChanged event. */
  def onavailablechanged(ev: js.Any with winrtDashUwpLib.WindowsNs.WinRTEvent[PerceptionDepthFrameSource]): scala.Unit = js.native
  /** Subscribes to the CameraIntrinsicsChanged event. */
  def oncameraintrinsicschanged(ev: js.Any with winrtDashUwpLib.WindowsNs.WinRTEvent[PerceptionDepthFrameSource]): scala.Unit = js.native
  /** Subscribes to the PropertiesChanged event. */
  def onpropertieschanged(
    ev: PerceptionFrameSourcePropertiesChangedEventArgs with winrtDashUwpLib.WindowsNs.WinRTEvent[PerceptionDepthFrameSource]
  ): scala.Unit = js.native
  /** Subscribes to the VideoProfileChanged event. */
  def onvideoprofilechanged(ev: js.Any with winrtDashUwpLib.WindowsNs.WinRTEvent[PerceptionDepthFrameSource]): scala.Unit = js.native
  /**
...
object PerceptionDepthFrameSource extends js.Object {
  /**
    ...
    */
  def createWatcher(): winrtDashUwpLib.WindowsNs.DevicesNs.PerceptionNs.PerceptionDepthFrameSourceWatcher = js.native
  /**
  ...
  /**
    ...
    */
  def fromIdAsync(id: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.DevicesNs.PerceptionNs.PerceptionDepthFrameSource] = js.native
  /**
