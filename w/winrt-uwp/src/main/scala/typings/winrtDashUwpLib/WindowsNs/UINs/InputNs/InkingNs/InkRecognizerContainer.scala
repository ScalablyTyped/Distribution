...
class InkRecognizerContainer () extends js.Object {
  /**
    ...
    */
  def getRecognizers(): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[InkRecognizer] = js.native
  /**
    ...
    */
  def recognizeAsync(strokeCollection: InkStrokeContainer, recognitionTarget: InkRecognitionTarget): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[_]] = js.native
  /**
    * Sets the default InkRecognizer used for handwriting recognition.
    * @param recognizer The InkRecognizer .
    */
  def setDefaultRecognizer(recognizer: InkRecognizer): scala.Unit = js.native
}
