...
class TimedTextStyle () extends js.Object {
  ...
  var foreground: winrtDashUwpLib.WindowsNs.UINs.Color = js.native
  /** Gets or sets a value indicating if the background color stays visible when no text is being displayed. */
  var isBackgroundAlwaysShown: scala.Boolean = js.native
  ...
  var outlineColor: winrtDashUwpLib.WindowsNs.UINs.Color = js.native
