...
class OnlineIdAuthenticator () extends js.Object {
  ...
  def authenticateUserAsync(
    requests: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IIterable[OnlineIdServiceTicketRequest],
    credentialPromptType: CredentialPromptType
  ): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithOperation[_, UserAuthenticationOperation] = js.native
  /**
                       ...
                       * @return An object representing the authentication operation.
                       */
  def authenticateUserAsync(request: OnlineIdServiceTicketRequest): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithOperation[_, UserAuthenticationOperation] = js.native
  /**
                       ...
                       */
  def signOutUserAsync(): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithOperation[_, SignOutUserOperation] = js.native
}
