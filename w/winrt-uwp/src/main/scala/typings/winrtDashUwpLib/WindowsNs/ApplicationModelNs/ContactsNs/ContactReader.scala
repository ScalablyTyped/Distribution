...
abstract class ContactReader () extends js.Object {
  /**
                   ...
                   */
  def getMatchingPropertiesWithMatchReason(contact: Contact): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[ContactMatchReason] = js.native
  /**
                   ...
                   */
  def readBatchAsync(): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[ContactBatch] = js.native
}
