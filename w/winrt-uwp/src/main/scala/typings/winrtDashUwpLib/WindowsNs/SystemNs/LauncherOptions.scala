...
class LauncherOptions () extends js.Object {
  ...
  var displayApplicationPicker: scala.Boolean = js.native
  ...
  var fallbackUri: winrtDashUwpLib.WindowsNs.FoundationNs.Uri = js.native
  ...
  var preferredApplicationDisplayName: java.lang.String = js.native
  ...
  var preferredApplicationPackageFamilyName: java.lang.String = js.native
  /** The package family name of the target package that should be used to launch a file or URI. This property is optional. */
  var targetApplicationPackageFamilyName: java.lang.String = js.native
  ...
  var treatAsUntrusted: scala.Boolean = js.native
