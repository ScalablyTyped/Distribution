...
class PasswordVault () extends js.Object {
  /**
    ...
    */
  def add(credential: PasswordCredential): scala.Unit = js.native
  /**
    ...
    */
  def findAllByResource(resource: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[PasswordCredential] = js.native
  /**
    ...
    * @return When this method returns, contains an IVectorView of credential objects that match the search criteria.
    */
  def findAllByUserName(userName: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[PasswordCredential] = js.native
  /**
    * Removes a credential from the Credential Locker.
    * @param credential The credential to be removed.
    */
  def remove(credential: PasswordCredential): scala.Unit = js.native
  /**
    ...
    */
  def retrieve(resource: java.lang.String, userName: java.lang.String): PasswordCredential = js.native
  /**
    ...
    */
  def retrieveAll(): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[PasswordCredential] = js.native
}
