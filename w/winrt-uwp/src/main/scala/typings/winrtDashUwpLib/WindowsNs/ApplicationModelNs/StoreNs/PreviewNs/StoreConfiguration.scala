...
object StoreConfiguration extends js.Object {
  ...
  var hardwareManufacturerInfo: winrtDashUwpLib.WindowsNs.ApplicationModelNs.StoreNs.PreviewNs.StoreHardwareManufacturerInfo = js.native
  /** Gets or sets a value that indicates whether the Windows Store prompts the user before making a purchase. */
  var purchasePromptingPolicy: scala.Double = js.native
  /**
  ...
  def filterUnsupportedSystemFeaturesAsync(
    systemFeatures: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IIterable[
      winrtDashUwpLib.WindowsNs.ApplicationModelNs.StoreNs.PreviewNs.StoreSystemFeature
    ]
  ...
  /**
    ...
    */
  def isStoreWebAccountId(webAccountId: java.lang.String): scala.Boolean = js.native
  /**
  ...
  def setMobileOperatorConfiguration(
    mobileOperatorId: java.lang.String,
    appDownloadLimitInMegabytes: scala.Double,
    updateDownloadLimitInMegabytes: scala.Double
  ...
  /**
    ...
    */
  def setStoreWebAccountId(webAccountId: java.lang.String): scala.Unit = js.native
  /**
  ...
  def setSystemConfiguration(
    catalogHardwareManufacturerId: java.lang.String,
    catalogStoreContentModifierId: java.lang.String,
    systemConfigurationExpiration: stdLib.Date,
    catalogHardwareDescriptor: java.lang.String
  ): scala.Unit = js.native
}
