...
abstract class MediaStreamSampleProtectionProperties () extends js.Object {
  /**
                   ...
                   */
  def getInitializationVector(): js.Array[scala.Double] = js.native
  /**
                   ...
                   */
  def getKeyIdentifier(): js.Array[scala.Double] = js.native
  /**
                   ...
                   */
  def getSubSampleMapping(): js.Array[scala.Double] = js.native
  /**
                   ...
                   */
  def setInitializationVector(value: js.Array[scala.Double]): scala.Unit = js.native
  /**
                   ...
                   */
  def setKeyIdentifier(value: js.Array[scala.Double]): scala.Unit = js.native
  /**
                   ...
                   */
  def setSubSampleMapping(value: js.Array[scala.Double]): scala.Unit = js.native
}
