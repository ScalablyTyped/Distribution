...
class BackgroundUploader () extends js.Object {
  ...
  def createUpload(
    ...
    sourceFile: winrtDashUwpLib.WindowsNs.StorageNs.IStorageFile
  ): UploadOperation = js.native
  /**
  ...
  def createUploadAsync(
    uri: winrtDashUwpLib.WindowsNs.FoundationNs.Uri,
    parts: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IIterable[BackgroundTransferContentPart]
  ): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[UploadOperation] = js.native
  /**
  ...
  def createUploadFromStreamAsync(
    uri: winrtDashUwpLib.WindowsNs.FoundationNs.Uri,
    sourceStream: winrtDashUwpLib.WindowsNs.StorageNs.StreamsNs.IInputStream
  ): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[UploadOperation] = js.native
  /**
...
object BackgroundUploader extends js.Object {
  /**
    ...
    */
  def getCurrentUploadsAsync(): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[_]] = js.native
  /**
    ...
    */
  def getCurrentUploadsAsync(group: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[_]] = js.native
  /**
    ...
    */
  def getCurrentUploadsForTransferGroupAsync(group: winrtDashUwpLib.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferGroup): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[_]] = js.native
  /**
  ...
  def requestUnconstrainedUploadsAsync(
    operations: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IIterable[winrtDashUwpLib.WindowsNs.NetworkingNs.BackgroundTransferNs.UploadOperation]
