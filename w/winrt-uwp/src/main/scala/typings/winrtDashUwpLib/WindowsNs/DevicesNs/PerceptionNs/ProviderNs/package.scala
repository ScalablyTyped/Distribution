...
package object ProviderNs {
  ...
  type PerceptionStartFaceAuthenticationHandler = js.Function1[/* sender */ PerceptionFaceAuthenticationGroup, scala.Unit]
  ...
  type PerceptionStopFaceAuthenticationHandler = js.Function1[/* sender */ PerceptionFaceAuthenticationGroup, scala.Unit]
}
