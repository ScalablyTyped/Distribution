...
abstract class DevicePickerFilter () extends js.Object {
  ...
  var supportedDeviceClasses: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[DeviceClass] = js.native
  ...
  var supportedDeviceSelectors: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[java.lang.String] = js.native
}
