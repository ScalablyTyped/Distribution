...
class DeviceServicingTrigger () extends js.Object {
  /**
                   ...
                   */
  def requestAsync(deviceId: java.lang.String, expectedDuration: scala.Double): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[DeviceTriggerResult] = js.native
  /**
                   ...
                   * @return This method returns a DeviceTriggerResult when it completes asynchronously.
                   */
  def requestAsync(deviceId: java.lang.String, expectedDuration: scala.Double, args: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[DeviceTriggerResult] = js.native
}
