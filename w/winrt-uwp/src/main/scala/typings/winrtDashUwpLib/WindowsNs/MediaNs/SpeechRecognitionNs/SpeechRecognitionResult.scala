...
abstract class SpeechRecognitionResult () extends js.Object {
  ...
  var phraseDuration: scala.Double = js.native
  /** Gets the start time of the utterance. */
  var phraseStartTime: stdLib.Date = js.native
  ...
  var rawConfidence: scala.Double = js.native
  /** Gets the hierarchy of rule elements that were triggered to return the recognized phrase. */
  var rulePath: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[java.lang.String] = js.native
