...
abstract class MobileBroadbandNetwork () extends js.Object {
  ...
  var activationNetworkError: scala.Double = js.native
  ...
  var packetAttachNetworkError: scala.Double = js.native
  ...
  var registeredProviderId: java.lang.String = js.native
  /** Gets the provider name for the currently registered mobile network. */
  var registeredProviderName: java.lang.String = js.native
  /** Gets the latest network registration error. */
  var registrationNetworkError: scala.Double = js.native
