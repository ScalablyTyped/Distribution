...
class Geofence protected () extends js.Object {
  ...
  var dwellTime: scala.Double = js.native
  /** The shape of the geofence region. */
  var geoshape: winrtDashUwpLib.WindowsNs.DevicesNs.GeolocationNs.IGeoshape = js.native
  ...
  var singleUse: scala.Boolean = js.native
