...
abstract class PointerPointProperties () extends js.Object {
  ...
  var contactRect: winrtDashUwpLib.WindowsNs.FoundationNs.Rect = js.native
  /** Gets the bounding rectangle of the raw input (typically from touch input). */
  var contactRectRaw: winrtDashUwpLib.WindowsNs.FoundationNs.Rect = js.native
  /** Gets a value that indicates whether the barrel button of the pen/stylus device is pressed. */
  var isBarrelButtonPressed: scala.Boolean = js.native
  ...
  var isRightButtonPressed: scala.Boolean = js.native
  /** Gets the pressed state of the first extended mouse button. */
  var isXButton1Pressed: scala.Boolean = js.native
  /** Gets the pressed state of the second extended mouse button. */
  var isXButton2Pressed: scala.Boolean = js.native
  ...
  var mouseWheelDelta: scala.Double = js.native
  ...
  var touchConfidence: scala.Boolean = js.native
  ...
  var xtilt: scala.Double = js.native
