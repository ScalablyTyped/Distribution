...
class HttpResponseMessage () extends js.Object {
  ...
  var headers: winrtDashUwpLib.WindowsNs.WebNs.HttpNs.HeadersNs.HttpResponseHeaderCollection = js.native
  /** Gets a value that indicates whether the HTTP response was successful. */
  var isSuccessStatusCode: scala.Boolean = js.native
  /** Gets or sets the reason phrase which typically is sent by servers together with the status code. */
  var reasonPhrase: java.lang.String = js.native
