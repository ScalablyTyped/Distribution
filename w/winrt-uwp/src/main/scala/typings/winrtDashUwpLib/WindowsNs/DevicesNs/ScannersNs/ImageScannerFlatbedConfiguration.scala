...
abstract class ImageScannerFlatbedConfiguration () extends js.Object {
  ...
  var brightnessStep: scala.Double = js.native
  ...
  var contrastStep: scala.Double = js.native
  ...
  var maxBrightness: scala.Double = js.native
  /** Gets the maximum contrast level supported by the scanner's Flatbed. */
  var maxContrast: scala.Double = js.native
  ...
  var maxScanArea: winrtDashUwpLib.WindowsNs.FoundationNs.Size = js.native
  /** Gets the minimum brightness level supported by the scanner's Flatbed. */
  var minBrightness: scala.Double = js.native
  /** Gets the minimum contrast level supported by the scanner's Flatbed. */
  var minContrast: scala.Double = js.native
  ...
  var minScanArea: winrtDashUwpLib.WindowsNs.FoundationNs.Size = js.native
