...
abstract class EmailFolder () extends js.Object {
  ...
  var isSyncEnabled: scala.Boolean = js.native
  ...
  var parentFolderId: java.lang.String = js.native
  ...
  /**
                   ...
                   */
  def createFolderAsync(name: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[EmailFolder] = js.native
  /**
  ...
  /**
                   ...
                   */
  def findChildFoldersAsync(): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[_]] = js.native
  /**
  ...
  /**
                   ...
                   */
  def getMessageCountsAsync(): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[EmailItemCounts] = js.native
  /**
  ...
  /**
                   ...
                   * @return An async action indicating that the operation has completed.
                   */
  def saveMessageAsync(message: EmailMessage): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncAction = js.native
  /**
                   ...
                   */
  def tryMoveAsync(newParentFolder: EmailFolder): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[scala.Boolean] = js.native
  /**
                   ...
                   * @return A Boolean value indicating if the move was successful.
                   */
  def tryMoveAsync(newParentFolder: EmailFolder, newFolderName: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[scala.Boolean] = js.native
  /**
                   * Asynchronously attempts to save changes to the folder.
                   * @return A Boolean value indicating if the save was successful.
                   */
  def trySaveAsync(): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[scala.Boolean] = js.native
}
