...
class SelectableWordsSegmenter protected () extends js.Object {
  ...
  /**
    ...
    */
  def getTokenAt(text: java.lang.String, startIndex: scala.Double): SelectableWordSegment = js.native
  /**
    ...
    */
  def getTokens(text: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[SelectableWordSegment] = js.native
  /**
    ...
    */
  def tokenize(text: java.lang.String, startIndex: scala.Double, handler: SelectableWordSegmentsTokenizingHandler): scala.Unit = js.native
}
