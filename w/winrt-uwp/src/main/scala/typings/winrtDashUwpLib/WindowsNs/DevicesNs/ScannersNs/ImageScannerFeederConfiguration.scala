...
abstract class ImageScannerFeederConfiguration () extends js.Object {
  ...
  var autoDetectPageSize: scala.Boolean = js.native
  ...
  var canAutoDetectPageSize: scala.Boolean = js.native
  /** Gets whether the scanner device is capable of scanning ahead from its Feeder. */
  var canScanAhead: scala.Boolean = js.native
  ...
  var canScanDuplex: scala.Boolean = js.native
  ...
  var duplex: scala.Boolean = js.native
  ...
  var maxNumberOfPages: scala.Double = js.native
  ...
  var pageOrientation: winrtDashUwpLib.WindowsNs.GraphicsNs.PrintingNs.PrintOrientation = js.native
  /** Gets or sets the currently selected page size to scan from the Feeder. */
  var pageSize: winrtDashUwpLib.WindowsNs.GraphicsNs.PrintingNs.PrintMediaSize = js.native
  /** Gets the dimensions (width and height) and orientation of the selected page size, in mil units (1/1000"). */
  var pageSizeDimensions: winrtDashUwpLib.WindowsNs.FoundationNs.Size = js.native
  /** Indicates whether or not to scan ahead. */
  var scanAhead: scala.Boolean = js.native
