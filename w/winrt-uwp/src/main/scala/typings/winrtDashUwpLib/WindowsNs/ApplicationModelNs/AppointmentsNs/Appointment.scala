...
class Appointment () extends js.Object {
  ...
  var calendarId: java.lang.String = js.native
  ...
  var hasInvitees: scala.Boolean = js.native
  ...
  var invitees: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[AppointmentInvitee] = js.native
  /** Gets or sets a value that indicates whether the appointment has been cancelled. */
  var isCanceledMeeting: scala.Boolean = js.native
  /** Gets or sets a value that indicates whether the appointment was organized by the current user. */
  var isOrganizedByUser: scala.Boolean = js.native
  ...
  var onlineMeetingLink: java.lang.String = js.native
  ...
  var originalStartTime: stdLib.Date = js.native
  ...
  var reminder: scala.Double = js.native
  ...
  var replyTime: stdLib.Date = js.native
