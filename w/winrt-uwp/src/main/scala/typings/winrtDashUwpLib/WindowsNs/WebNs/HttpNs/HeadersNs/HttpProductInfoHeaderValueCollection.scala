...
abstract class HttpProductInfoHeaderValueCollection ()
  extends stdLib.Array[HttpProductInfoHeaderValue] {
  ...
  /**
    ...
    */
  def append(value: HttpProductInfoHeaderValue): scala.Unit = js.native
  ...
  /**
    ...
    */
  def first(): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IIterator[HttpProductInfoHeaderValue] = js.native
  /**
    ...
    */
  def getAt(index: scala.Double): HttpProductInfoHeaderValue = js.native
  /**
    ...
    */
  def getMany(startIndex: scala.Double): winrtDashUwpLib.Anon_ItemsReturnValueHttpProductInfoHeaderValue = js.native
  /**
    ...
    */
  def getView(): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[HttpProductInfoHeaderValue] = js.native
  def indexOf(value: HttpProductInfoHeaderValue, extra: js.Any*): winrtDashUwpLib.Anon_Index = js.native
  /**
    ...
    */
  @JSName("indexOf")
  def indexOf_Anon_Index(value: HttpProductInfoHeaderValue): winrtDashUwpLib.Anon_Index = js.native
  /**
    ...
    */
  @JSName("indexOf")
  def indexOf_Boolean(item: HttpProductInfoHeaderValue): scala.Boolean = js.native
  /**
    ...
    */
  def insertAt(index: scala.Double, value: HttpProductInfoHeaderValue): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def replaceAll(items: HttpProductInfoHeaderValue): scala.Unit = js.native
  /**
    ...
    */
  def setAt(index: scala.Double, value: HttpProductInfoHeaderValue): scala.Unit = js.native
  /**
