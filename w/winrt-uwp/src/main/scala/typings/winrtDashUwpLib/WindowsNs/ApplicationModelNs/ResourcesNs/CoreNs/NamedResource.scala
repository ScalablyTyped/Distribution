...
abstract class NamedResource () extends js.Object {
  ...
  var candidates: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[ResourceCandidate] = js.native
  ...
  /**
                       ...
                       */
  def resolveAll(): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[ResourceCandidate] = js.native
  /**
                       ...
                       * @return A list of ResourceCandidate objects, in order of preference. The object in first position in the list is the most appropriate candidate for the corresponding context, and the object in last position is the least appropriate.
                       */
  def resolveAll(resourceContext: ResourceContext): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[ResourceCandidate] = js.native
}
