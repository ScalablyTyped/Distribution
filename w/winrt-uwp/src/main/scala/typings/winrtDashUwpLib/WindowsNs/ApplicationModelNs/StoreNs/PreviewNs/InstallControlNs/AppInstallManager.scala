...
class AppInstallManager () extends js.Object {
  ...
  var acquisitionIdentity: java.lang.String = js.native
  /** Retrieves information about all apps that are currently in the installation queue. */
  var appInstallItems: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[AppInstallItem] = js.native
  ...
  var onitemcompleted_Original: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[AppInstallManager, AppInstallManagerItemEventArgs] = js.native
  /** Occurs when the status of an app in the installation queue has changed. */
  @JSName("onitemstatuschanged")
  var onitemstatuschanged_Original: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[AppInstallManager, AppInstallManagerItemEventArgs] = js.native
  def addEventListener(`type`: java.lang.String, listener: winrtDashUwpLib.WindowsNs.FoundationNs.EventHandler[_]): scala.Unit = js.native
  @JSName("addEventListener")
  def addEventListener_itemcompleted(
    `type`: winrtDashUwpLib.winrtDashUwpLibStrings.itemcompleted,
    listener: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[AppInstallManager, AppInstallManagerItemEventArgs]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  def addEventListener_itemstatuschanged(
    `type`: winrtDashUwpLib.winrtDashUwpLibStrings.itemstatuschanged,
    listener: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[AppInstallManager, AppInstallManagerItemEventArgs]
  ): scala.Unit = js.native
  /**
    ...
    */
  def cancel(productId: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def cancel(productId: java.lang.String, correlationVector: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def getIsAppAllowedToInstallAsync(productId: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[scala.Boolean] = js.native
  /**
    ...
    * @return An asynchronous operation that, on successful completion, returns true if the app has permission to be installed; otherwise false.
    */
  def getIsAppAllowedToInstallAsync(
    productId: java.lang.String,
    skuId: java.lang.String,
    catalogId: java.lang.String,
    correlationVector: java.lang.String
  ...
  /**
    ...
    */
  def getIsApplicableAsync(productId: java.lang.String, skuId: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[scala.Boolean] = js.native
  /**
    ...
    * @return An asynchronous operation that, on successful completion, returns true if the app can be installed; otherwise false.
    */
  def isStoreBlockedByPolicyAsync(storeClientName: java.lang.String, storeClientPublisher: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[scala.Boolean] = js.native
  /** Occurs when an app has finished installing. */
  def onitemcompleted(ev: AppInstallManagerItemEventArgs with winrtDashUwpLib.WindowsNs.WinRTEvent[AppInstallManager]): scala.Unit = js.native
  /** Occurs when the status of an app in the installation queue has changed. */
  def onitemstatuschanged(ev: AppInstallManagerItemEventArgs with winrtDashUwpLib.WindowsNs.WinRTEvent[AppInstallManager]): scala.Unit = js.native
  /**
    ...
    */
  def pause(productId: java.lang.String): scala.Unit = js.native
  /**
    * Pauses the installation of the specified app, with the option to generate telemetry data.
    * @param productId The product ID of the app whose installation should be paused.
    * @param correlationVector A correlation vector string that can be used to generate telemetry data.
    */
  def pause(productId: java.lang.String, correlationVector: java.lang.String): scala.Unit = js.native
  ...
  /**
    ...
    */
  def restart(productId: java.lang.String): scala.Unit = js.native
  /**
    * Restarts the installation of the specified app, with the option to generate telemetry data.
    * @param productId The product ID of the app whose installation should be restarted.
    * @param correlationVector A correlation vector string that can be used to generate telemetry data.
    */
  def restart(productId: java.lang.String, correlationVector: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def searchForAllUpdatesAsync(): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[_]] = js.native
  /**
    ...
    * @return An asynchronous operation that, on successful completion, returns the collection of apps that have available updates. If you use Asynchronous programming, the result type is a read-only list/vector of AppInstallItem items. (You can use APIs of IVectorView<AppInstallItem> for C++ or JavaScript, APIs of IReadOnlyList<AppInstallItem> for .NET.)
    */
  def searchForAllUpdatesAsync(correlationVector: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[_]] = js.native
  /**
    ...
    */
  def searchForUpdatesAsync(productId: java.lang.String, skuId: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[AppInstallItem] = js.native
  /**
    ...
    * @return An asynchronous operation that, on successful completion, returns an AppInstallItem that represents the available update.
    */
  def searchForUpdatesAsync(
    productId: java.lang.String,
    skuId: java.lang.String,
    catalogId: java.lang.String,
    correlationVector: java.lang.String
  ): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[AppInstallItem] = js.native
  /**
  ...
  def startAppInstallAsync(
    productId: java.lang.String,
    skuId: java.lang.String,
    repair: scala.Boolean,
    forceUseOfNonRemovableStorage: scala.Boolean
  ): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[AppInstallItem] = js.native
  /**
  ...
  /**
    ...
    */
  def updateAppByPackageFamilyNameAsync(packageFamilyName: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[AppInstallItem] = js.native
  /**
    ...
    * @return An asynchronous operation that, on successful completion, returns an AppInstallItem that represents the app update that was added to the installation queue.
    */
  def updateAppByPackageFamilyNameAsync(packageFamilyName: java.lang.String, correlationVector: java.lang.String): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[AppInstallItem] = js.native
}
