...
abstract class SmsDevice2 () extends js.Object {
  ...
  var ondevicestatuschanged_Original: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[SmsDevice2, _] = js.native
  /** The parent device ID of this device. */
  var parentDeviceId: java.lang.String = js.native
  /** Gets or sets the SMSC address of this device. */
  var smscAddress: java.lang.String = js.native
  def addEventListener(`type`: java.lang.String, listener: winrtDashUwpLib.WindowsNs.FoundationNs.EventHandler[_]): scala.Unit = js.native
  @JSName("addEventListener")
  def addEventListener_devicestatuschanged(
    `type`: winrtDashUwpLib.winrtDashUwpLibStrings.devicestatuschanged,
  ...
  def removeEventListener_devicestatuschanged(
    `type`: winrtDashUwpLib.winrtDashUwpLibStrings.devicestatuschanged,
    listener: winrtDashUwpLib.WindowsNs.FoundationNs.TypedEventHandler[SmsDevice2, _]
  ): scala.Unit = js.native
  /**
