...
object WebAuthenticationBroker extends js.Object {
  /**
    ...
    */
  def authenticateAndContinue(requestUri: winrtDashUwpLib.WindowsNs.FoundationNs.Uri): scala.Unit = js.native
  /**
  ...
  def authenticateAndContinue(
    requestUri: winrtDashUwpLib.WindowsNs.FoundationNs.Uri,
    callbackUri: winrtDashUwpLib.WindowsNs.FoundationNs.Uri
  ...
  def authenticateAndContinue(
    requestUri: winrtDashUwpLib.WindowsNs.FoundationNs.Uri,
    callbackUri: winrtDashUwpLib.WindowsNs.FoundationNs.Uri,
    continuationData: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.ValueSet,
    options: winrtDashUwpLib.WindowsNs.SecurityNs.AuthenticationNs.WebNs.WebAuthenticationOptions
  ): scala.Unit = js.native
  /**
  ...
  def authenticateAsync(
    ...
    winrtDashUwpLib.WindowsNs.SecurityNs.AuthenticationNs.WebNs.WebAuthenticationResult
  ] = js.native
  /**
  ...
  /**
    ...
    * @return The way to query the status and get the results of the authentication operation. If you are getting an invalid parameter error, the most common cause is that you are not using HTTPS for the requestUri parameter.
    */
  def authenticateSilentlyAsync(requestUri: winrtDashUwpLib.WindowsNs.FoundationNs.Uri): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[
    winrtDashUwpLib.WindowsNs.SecurityNs.AuthenticationNs.WebNs.WebAuthenticationResult
  ] = js.native
  /**
  ...
  /**
    ...
    */
  def getCurrentApplicationCallbackUri(): winrtDashUwpLib.WindowsNs.FoundationNs.Uri = js.native
}
