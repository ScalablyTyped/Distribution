...
object AppointmentProperties extends js.Object {
  ...
  var allDay: java.lang.String = js.native
  /** Gets the name of AllowNewTimeProposal the property. */
  var allowNewTimeProposal: java.lang.String = js.native
  /** Gets the name of the BusyStatus property. */
  var busyStatus: java.lang.String = js.native
  /** Gets the current change number of the local version of the Appointment . */
  var changeNumber: java.lang.String = js.native
  /** Gets a list of names for the default appointment properties. */
  var defaultProperties: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[java.lang.String] = js.native
  ...
  var invitees: java.lang.String = js.native
  /** Gets the name of the IsCanceledMeeting property. */
  var isCanceledMeeting: java.lang.String = js.native
  /** Gets the name of the IsOrganizedByUser property. */
  var isOrganizedByUser: java.lang.String = js.native
  /** Gets the name of the IsResponseRequested property. */
  var isResponseRequested: java.lang.String = js.native
  ...
  var organizer: java.lang.String = js.native
  /** Gets the name of the OriginalStartTime property. */
  var originalStartTime: java.lang.String = js.native
  /** Gets the name of the Recurrence property. */
  var recurrence: java.lang.String = js.native
  ...
  var startTime: java.lang.String = js.native
  ...
  var userResponse: java.lang.String = js.native
}
