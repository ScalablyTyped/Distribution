...
class NDStreamParserNotifier () extends js.Object {
  /**
    ...
    */
  def onBeginSetupDecryptor(
    descriptor: winrtDashUwpLib.WindowsNs.MediaNs.CoreNs.IMediaStreamDescriptor,
    keyID: java.lang.String,
    proBytes: js.Array[scala.Double]
  ...
  def onMediaStreamDescriptorCreated(
    audioStreamDescriptors: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[winrtDashUwpLib.WindowsNs.MediaNs.CoreNs.AudioStreamDescriptor],
    videoStreamDescriptors: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[winrtDashUwpLib.WindowsNs.MediaNs.CoreNs.VideoStreamDescriptor]
  ): scala.Unit = js.native
  /**
  ...
  def onSampleParsed(
    ...
    streamSample: winrtDashUwpLib.WindowsNs.MediaNs.CoreNs.MediaStreamSample,
    pts: scala.Double,
    ccFormat: NDClosedCaptionFormat,
    ccDataBytes: js.Array[scala.Double]
  ): scala.Unit = js.native
}
