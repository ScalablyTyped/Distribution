...
class ChatMessage () extends js.Object {
  ...
  var estimatedDownloadSize: scala.Double = js.native
  ...
  var isAutoReply: scala.Boolean = js.native
  /** Gets a Boolean value indicating if forwarding is disabled. */
  var isForwardingDisabled: scala.Boolean = js.native
  ...
  var isReceivedDuringQuietHours: scala.Boolean = js.native
  /** Gets a Boolean value indicating if reply is disabled on the ChatMessage . */
  var isReplyDisabled: scala.Boolean = js.native
  ...
  var isSimMessage: scala.Boolean = js.native
  /** Gets the local timestamp of the message. */
  var localTimestamp: stdLib.Date = js.native
  ...
  var networkTimestamp: stdLib.Date = js.native
  /** Gets the list of send statuses for the message. */
  var recipientSendStatuses: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IMapView[java.lang.String, ChatMessageStatus] = js.native
  /** Gets the list of recipients of the message. */
  var recipients: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[java.lang.String] = js.native
  /** Gets the delivery info for each of the recipients of the ChatMessage . */
  var recipientsDeliveryInfos: winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVector[ChatRecipientDeliveryInfo] = js.native
  ...
  var shouldSuppressNotification: scala.Boolean = js.native
