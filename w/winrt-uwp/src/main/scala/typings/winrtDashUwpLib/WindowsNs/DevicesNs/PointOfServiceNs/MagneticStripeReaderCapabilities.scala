...
abstract class MagneticStripeReaderCapabilities () extends js.Object {
  ...
  var cardAuthentication: java.lang.String = js.native
  /** Indicates whether the device supports ISO cards. */
  var isIsoSupported: scala.Boolean = js.native
  /** Indicates whether device supports JIS Type-I cards. */
  var isJisOneSupported: scala.Boolean = js.native
  /** Indicates whether the device supports JIS Type-II cards. */
  var isJisTwoSupported: scala.Boolean = js.native
  ...
  var isTrackDataMaskingSupported: scala.Boolean = js.native
  /** Indicates whether the devices is able to transmit start and end sentinels. */
  var isTransmitSentinelsSupported: scala.Boolean = js.native
  ...
  var supportedEncryptionAlgorithms: scala.Double = js.native
}
