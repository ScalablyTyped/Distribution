...
abstract class HttpMethodHeaderValueCollection ()
  extends stdLib.Array[winrtDashUwpLib.WindowsNs.WebNs.HttpNs.HttpMethod] {
  ...
  /**
                       ...
                       */
  def append(value: winrtDashUwpLib.WindowsNs.WebNs.HttpNs.HttpMethod): scala.Unit = js.native
  ...
  /**
                       ...
                       */
  def first(): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IIterator[winrtDashUwpLib.WindowsNs.WebNs.HttpNs.HttpMethod] = js.native
  /**
                       ...
                       */
  def getAt(index: scala.Double): winrtDashUwpLib.WindowsNs.WebNs.HttpNs.HttpMethod = js.native
  /**
                       ...
                       */
  def getMany(startIndex: scala.Double): winrtDashUwpLib.Anon_ItemsReturnValueHttpMethod = js.native
  /**
                       * Returns an immutable view of the HttpMethodHeaderValueCollection .
                       * @return The view of the HttpMethodHeaderValueCollection .
                       */
  def getView(): winrtDashUwpLib.WindowsNs.FoundationNs.CollectionsNs.IVectorView[winrtDashUwpLib.WindowsNs.WebNs.HttpNs.HttpMethod] = js.native
  def indexOf(value: winrtDashUwpLib.WindowsNs.WebNs.HttpNs.HttpMethod, extra: js.Any*): winrtDashUwpLib.Anon_Index = js.native
  /**
                       ...
                       */
  @JSName("indexOf")
  def indexOf_Anon_Index(value: winrtDashUwpLib.WindowsNs.WebNs.HttpNs.HttpMethod): winrtDashUwpLib.Anon_Index = js.native
  /**
                       ...
                       */
  def insertAt(index: scala.Double, value: winrtDashUwpLib.WindowsNs.WebNs.HttpNs.HttpMethod): scala.Unit = js.native
  /**
  ...
  /**
                       ...
                       */
  def replaceAll(items: winrtDashUwpLib.WindowsNs.WebNs.HttpNs.HttpMethod): scala.Unit = js.native
  /**
                       ...
                       */
  def setAt(index: scala.Double, value: winrtDashUwpLib.WindowsNs.WebNs.HttpNs.HttpMethod): scala.Unit = js.native
  /**
