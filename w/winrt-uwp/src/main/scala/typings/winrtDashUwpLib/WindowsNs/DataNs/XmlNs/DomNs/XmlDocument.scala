...
class XmlDocument () extends js.Object {
  ...
  var documentUri: java.lang.String = js.native
  ...
  /**
                       ...
                       */
  def createAttribute(name: java.lang.String): XmlAttribute = js.native
  /**
                       ...
                       * @return The newly created attribute.
                       */
  def createAttributeNS(namespaceUri: js.Any, qualifiedName: java.lang.String): XmlAttribute = js.native
  /**
                       ...
                       */
  def createCDataSection(data: java.lang.String): XmlCDataSection = js.native
  /**
                       ...
                       */
  def createComment(data: java.lang.String): XmlComment = js.native
  /**
  ...
  /**
                       ...
                       * @return The newly created object.
                       */
  def createElement(tagName: java.lang.String): XmlElement = js.native
  /**
                       ...
                       * @return The newly created object.
                       */
  def createElementNS(namespaceUri: js.Any, qualifiedName: java.lang.String): XmlElement = js.native
  /**
                       ...
                       * @return The newly created object.
                       */
  def createEntityReference(name: java.lang.String): XmlEntityReference = js.native
  /**
                       ...
                       * @return The newly created object.
                       */
  def createProcessingInstruction(target: java.lang.String, data: java.lang.String): XmlProcessingInstruction = js.native
  /**
                       ...
                       */
  def createTextNode(data: java.lang.String): XmlText = js.native
  /**
                       ...
                       */
  def getElementById(elementId: java.lang.String): XmlElement = js.native
  /**
  ...
  /**
                       ...
                       */
  def importNode(node: IXmlNode, deep: scala.Boolean): IXmlNode = js.native
  /**
  ...
  /**
                       ...
                       */
  def loadXmlFromBuffer(buffer: winrtDashUwpLib.WindowsNs.StorageNs.StreamsNs.IBuffer): scala.Unit = js.native
  /**
                       * Loads an XML document using the buffer. The document is parsed using the settings provided.
                       * @param buffer The buffer to load into this XML document object. This buffer can contain an entire XML document or a well-formed fragment.
                       * @param loadSettings The settings for parsing the document.
                       */
  def loadXmlFromBuffer(buffer: winrtDashUwpLib.WindowsNs.StorageNs.StreamsNs.IBuffer, loadSettings: XmlLoadSettings): scala.Unit = js.native
  ...
  /**
                       ...
                       */
  def saveToFileAsync(file: winrtDashUwpLib.WindowsNs.StorageNs.IStorageFile): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncAction = js.native
  /**
...
object XmlDocument extends js.Object {
  /**
                       ...
                       * @return The object that must be used to start the operation.
                       */
  def loadFromFileAsync(file: winrtDashUwpLib.WindowsNs.StorageNs.IStorageFile): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.DataNs.XmlNs.DomNs.XmlDocument] = js.native
  /**
  ...
  def loadFromFileAsync(
    ...
    loadSettings: winrtDashUwpLib.WindowsNs.DataNs.XmlNs.DomNs.XmlLoadSettings
  ): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.DataNs.XmlNs.DomNs.XmlDocument] = js.native
  /**
                       ...
                       * @return The object that must be used to start the operation.
                       */
  def loadFromUriAsync(uri: winrtDashUwpLib.WindowsNs.FoundationNs.Uri): winrtDashUwpLib.WindowsNs.FoundationNs.IPromiseWithIAsyncOperation[winrtDashUwpLib.WindowsNs.DataNs.XmlNs.DomNs.XmlDocument] = js.native
  /**
