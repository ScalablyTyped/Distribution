...
object HardwareIdentification extends js.Object {
  /**
    ...
    */
  def getPackageSpecificToken(nonce: winrtDashUwpLib.WindowsNs.StorageNs.StreamsNs.IBuffer): winrtDashUwpLib.WindowsNs.SystemNs.ProfileNs.HardwareToken = js.native
}
