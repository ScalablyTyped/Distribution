...
object MinuteFormat extends js.Object {
  ...
  /* 1 */ val default: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.MinuteFormat.default with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.MinuteFormat.none with Double = js.native
  @JSBracketAccess
