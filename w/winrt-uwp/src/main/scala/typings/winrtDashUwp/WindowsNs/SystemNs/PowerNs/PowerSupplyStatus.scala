...
object PowerSupplyStatus extends js.Object {
  ...
  /* 2 */ val adequate: typings.winrtDashUwp.WindowsNs.SystemNs.PowerNs.PowerSupplyStatus.adequate with Double = js.native
  /* 1 */ val inadequate: typings.winrtDashUwp.WindowsNs.SystemNs.PowerNs.PowerSupplyStatus.inadequate with Double = js.native
  /* 0 */ val notPresent: typings.winrtDashUwp.WindowsNs.SystemNs.PowerNs.PowerSupplyStatus.notPresent with Double = js.native
  @JSBracketAccess
