...
import typings.winrtDashUwp.WindowsNs.GraphicsNs.PrintingNs.PrintMediaSize
import typings.winrtDashUwp.WindowsNs.GraphicsNs.PrintingNs.PrintOrientation
