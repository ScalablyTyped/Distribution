...
object SystemTriggerType extends js.Object {
  ...
  /* 13 */ val backgroundWorkCostChange: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.backgroundWorkCostChange with Double = js.native
  /* 5 */ val controlChannelReset: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.controlChannelReset with Double = js.native
  /* 6 */ val internetAvailable: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.internetAvailable with Double = js.native
  /* 0 */ val invalid: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.invalid with Double = js.native
  /* 9 */ val lockScreenApplicationAdded: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.lockScreenApplicationAdded with Double = js.native
  /* 10 */ val lockScreenApplicationRemoved: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.lockScreenApplicationRemoved with Double = js.native
  /* 4 */ val networkStateChange: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.networkStateChange with Double = js.native
  /* 12 */ val onlineIdConnectedStateChange: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.onlineIdConnectedStateChange with Double = js.native
  /* 14 */ val powerStateChange: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.powerStateChange with Double = js.native
  /* 8 */ val servicingComplete: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.servicingComplete with Double = js.native
  /* 7 */ val sessionConnected: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.sessionConnected with Double = js.native
  /* 1 */ val smsReceived: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.smsReceived with Double = js.native
  /* 11 */ val timeZoneChange: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.timeZoneChange with Double = js.native
  /* 3 */ val userAway: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.userAway with Double = js.native
  /* 2 */ val userPresent: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemTriggerType.userPresent with Double = js.native
  @JSBracketAccess
