...
object GeoshapeType extends js.Object {
  ...
  /* 3 */ val geoboundingBox: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.GeoshapeType.geoboundingBox with Double = js.native
  /* 1 */ val geocircle: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.GeoshapeType.geocircle with Double = js.native
  /* 2 */ val geopath: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.GeoshapeType.geopath with Double = js.native
  /* 0 */ val geopoint: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.GeoshapeType.geopoint with Double = js.native
  @JSBracketAccess
