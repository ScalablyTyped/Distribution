...
object AudioEncodingQuality extends js.Object {
  ...
  /* 0 */ val auto: typings.winrtDashUwp.WindowsNs.MediaNs.MediaPropertiesNs.AudioEncodingQuality.auto with Double = js.native
  /* 1 */ val high: typings.winrtDashUwp.WindowsNs.MediaNs.MediaPropertiesNs.AudioEncodingQuality.high with Double = js.native
  /* 3 */ val low: typings.winrtDashUwp.WindowsNs.MediaNs.MediaPropertiesNs.AudioEncodingQuality.low with Double = js.native
  /* 2 */ val medium: typings.winrtDashUwp.WindowsNs.MediaNs.MediaPropertiesNs.AudioEncodingQuality.medium with Double = js.native
  @JSBracketAccess
