...
object I2cSharingMode extends js.Object {
  ...
  /* 0 */ val exclusive: typings.winrtDashUwp.WindowsNs.DevicesNs.I2cNs.I2cSharingMode.exclusive with Double = js.native
  /* 1 */ val shared: typings.winrtDashUwp.WindowsNs.DevicesNs.I2cNs.I2cSharingMode.shared with Double = js.native
  @JSBracketAccess
