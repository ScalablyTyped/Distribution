...
object AsyncStatus extends js.Object {
  ...
  /* 0 */ val canceled: typings.winrtDashUwp.WindowsNs.FoundationNs.AsyncStatus.canceled with Double = js.native
  /* 1 */ val completed: typings.winrtDashUwp.WindowsNs.FoundationNs.AsyncStatus.completed with Double = js.native
  /* 2 */ val error: typings.winrtDashUwp.WindowsNs.FoundationNs.AsyncStatus.error with Double = js.native
  /* 3 */ val started: typings.winrtDashUwp.WindowsNs.FoundationNs.AsyncStatus.started with Double = js.native
  @JSBracketAccess
