...
object UserDataAccountStoreAccessType extends js.Object {
  ...
  /* 0 */ val allAccountsReadOnly: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.UserDataAccountsNs.UserDataAccountStoreAccessType.allAccountsReadOnly with Double = js.native
  /* 1 */ val appAccountsReadWrite: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.UserDataAccountsNs.UserDataAccountStoreAccessType.appAccountsReadWrite with Double = js.native
  @JSBracketAccess
