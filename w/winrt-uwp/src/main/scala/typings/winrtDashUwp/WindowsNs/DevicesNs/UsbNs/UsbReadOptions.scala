...
object UsbReadOptions extends js.Object {
  ...
  /* 4 */ val allowPartialReads: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbReadOptions.allowPartialReads with Double = js.native
  /* 1 */ val autoClearStall: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbReadOptions.autoClearStall with Double = js.native
  /* 3 */ val ignoreShortPacket: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbReadOptions.ignoreShortPacket with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbReadOptions.none with Double = js.native
  /* 2 */ val overrideAutomaticBufferManagement: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbReadOptions.overrideAutomaticBufferManagement with Double = js.native
  @JSBracketAccess
