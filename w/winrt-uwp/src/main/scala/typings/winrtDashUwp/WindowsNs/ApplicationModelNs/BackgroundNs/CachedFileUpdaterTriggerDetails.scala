...
import typings.winrtDashUwp.WindowsNs.StorageNs.ProviderNs.CachedFileTarget
import typings.winrtDashUwp.WindowsNs.StorageNs.ProviderNs.FileUpdateRequest
