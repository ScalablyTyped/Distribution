...
object EmailMailboxOtherAppWriteAccess extends js.Object {
  ...
  /* 1 */ val limited: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxOtherAppWriteAccess.limited with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxOtherAppWriteAccess.none with Double = js.native
  @JSBracketAccess
