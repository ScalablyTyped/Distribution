...
object MagneticStripeReaderStatus extends js.Object {
  ...
  /* 1 */ val authenticated: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.MagneticStripeReaderStatus.authenticated with Double = js.native
  /* 2 */ val extended: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.MagneticStripeReaderStatus.extended with Double = js.native
  /* 0 */ val unauthenticated: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.MagneticStripeReaderStatus.unauthenticated with Double = js.native
  @JSBracketAccess
