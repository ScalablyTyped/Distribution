...
@JSGlobal("Windows.Devices.Bluetooth.BluetoothLEAppearanceSubcategories")
@js.native
abstract class BluetoothLEAppearanceSubcategories () extends js.Object

/* static members */
@JSGlobal("Windows.Devices.Bluetooth.BluetoothLEAppearanceSubcategories")
@js.native
object BluetoothLEAppearanceSubcategories extends js.Object {
  ...
  var barcodeScanner: Double = js.native
  ...
  var bloodPressureArm: Double = js.native
  ...
  var bloodPressureWrist: Double = js.native
  ...
  var cardReader: Double = js.native
  ...
  var cyclingCadenceSensor: Double = js.native
  ...
  var cyclingComputer: Double = js.native
  ...
  var cyclingPowerSensor: Double = js.native
  ...
  var cyclingSpeedCadenceSensor: Double = js.native
  ...
  var cyclingSpeedSensor: Double = js.native
  ...
  var digitalPen: Double = js.native
  ...
  var digitizerTablet: Double = js.native
  ...
  var heartRateBelt: Double = js.native
  ...
  var locationDisplay: Double = js.native
  ...
  var locationNavigationDisplay: Double = js.native
  ...
  var locationNavigationPod: Double = js.native
  ...
  var locationPod: Double = js.native
  ...
  var oximeterFingertip: Double = js.native
  ...
  var oximeterWristWorn: Double = js.native
  ...
  var runningWalkingInShoe: Double = js.native
  ...
  var runningWalkingOnHip: Double = js.native
  ...
  var runningWalkingOnShoe: Double = js.native
  ...
  var sportsWatch: Double = js.native
  ...
  var thermometerEar: Double = js.native
}
