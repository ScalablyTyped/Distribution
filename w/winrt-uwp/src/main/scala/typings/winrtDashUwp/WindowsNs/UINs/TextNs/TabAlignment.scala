...
object TabAlignment extends js.Object {
  ...
  /* 4 */ val bar: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TabAlignment.bar with Double = js.native
  /* 1 */ val center: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TabAlignment.center with Double = js.native
  /* 3 */ val decimal: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TabAlignment.decimal with Double = js.native
  /* 0 */ val left: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TabAlignment.left with Double = js.native
  /* 2 */ val right: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TabAlignment.right with Double = js.native
  @JSBracketAccess
