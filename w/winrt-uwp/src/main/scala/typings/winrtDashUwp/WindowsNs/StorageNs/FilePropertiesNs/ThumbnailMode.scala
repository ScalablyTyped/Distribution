...
object ThumbnailMode extends js.Object {
  ...
  /* 3 */ val documentsView: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailMode.documentsView with Double = js.native
  /* 4 */ val listView: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailMode.listView with Double = js.native
  /* 2 */ val musicView: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailMode.musicView with Double = js.native
  /* 0 */ val picturesView: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailMode.picturesView with Double = js.native
  /* 5 */ val singleItem: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailMode.singleItem with Double = js.native
  /* 1 */ val videosView: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailMode.videosView with Double = js.native
  @JSBracketAccess
