...
object ImageScannerAutoCroppingMode extends js.Object {
  ...
  /* 0 */ val disabled: typings.winrtDashUwp.WindowsNs.DevicesNs.ScannersNs.ImageScannerAutoCroppingMode.disabled with Double = js.native
  /* 2 */ val multipleRegion: typings.winrtDashUwp.WindowsNs.DevicesNs.ScannersNs.ImageScannerAutoCroppingMode.multipleRegion with Double = js.native
  /* 1 */ val singleRegion: typings.winrtDashUwp.WindowsNs.DevicesNs.ScannersNs.ImageScannerAutoCroppingMode.singleRegion with Double = js.native
  @JSBracketAccess
