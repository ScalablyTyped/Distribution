...
object PlayReadyDecryptorSetup extends js.Object {
  ...
  /* 1 */ val onDemand: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.PlayReadyDecryptorSetup.onDemand with Double = js.native
  /* 0 */ val uninitialized: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.PlayReadyDecryptorSetup.uninitialized with Double = js.native
  @JSBracketAccess
