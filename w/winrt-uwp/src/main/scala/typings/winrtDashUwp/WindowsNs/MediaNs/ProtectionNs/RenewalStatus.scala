...
object RenewalStatus extends js.Object {
  ...
  /* 3 */ val appComponentsMayNeedUpdating: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.RenewalStatus.appComponentsMayNeedUpdating with Double = js.native
  /* 4 */ val noComponentsFound: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.RenewalStatus.noComponentsFound with Double = js.native
  /* 0 */ val notStarted: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.RenewalStatus.notStarted with Double = js.native
  /* 1 */ val updatesInProgress: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.RenewalStatus.updatesInProgress with Double = js.native
  /* 2 */ val userCancelled: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.RenewalStatus.userCancelled with Double = js.native
  @JSBracketAccess
