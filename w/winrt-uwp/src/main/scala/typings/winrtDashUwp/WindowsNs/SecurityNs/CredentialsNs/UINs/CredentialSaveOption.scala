...
object CredentialSaveOption extends js.Object {
  ...
  /* 2 */ val hidden: typings.winrtDashUwp.WindowsNs.SecurityNs.CredentialsNs.UINs.CredentialSaveOption.hidden with Double = js.native
  /* 1 */ val selected: typings.winrtDashUwp.WindowsNs.SecurityNs.CredentialsNs.UINs.CredentialSaveOption.selected with Double = js.native
  /* 0 */ val unselected: typings.winrtDashUwp.WindowsNs.SecurityNs.CredentialsNs.UINs.CredentialSaveOption.unselected with Double = js.native
  @JSBracketAccess
