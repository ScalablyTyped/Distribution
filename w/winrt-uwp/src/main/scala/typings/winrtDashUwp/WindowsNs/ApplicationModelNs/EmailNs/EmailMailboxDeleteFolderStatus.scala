...
object EmailMailboxDeleteFolderStatus extends js.Object {
  ...
  /* 5 */ val couldNotDeleteEverything: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxDeleteFolderStatus.couldNotDeleteEverything with Double = js.native
  /* 1 */ val networkError: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxDeleteFolderStatus.networkError with Double = js.native
  /* 2 */ val permissionsError: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxDeleteFolderStatus.permissionsError with Double = js.native
  /* 3 */ val serverError: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxDeleteFolderStatus.serverError with Double = js.native
  /* 0 */ val success: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxDeleteFolderStatus.success with Double = js.native
  /* 4 */ val unknownFailure: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxDeleteFolderStatus.unknownFailure with Double = js.native
  @JSBracketAccess
