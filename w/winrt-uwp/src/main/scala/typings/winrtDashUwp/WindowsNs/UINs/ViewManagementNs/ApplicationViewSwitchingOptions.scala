...
object ApplicationViewSwitchingOptions extends js.Object {
  ...
  /* 2 */ val consolidateViews: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.ApplicationViewSwitchingOptions.consolidateViews with Double = js.native
  /* 0 */ val default: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.ApplicationViewSwitchingOptions.default with Double = js.native
  /* 1 */ val skipAnimation: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.ApplicationViewSwitchingOptions.skipAnimation with Double = js.native
  @JSBracketAccess
