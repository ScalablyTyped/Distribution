...
object WiFiDirectServiceConfigurationMethod extends js.Object {
  ...
  /* 0 */ val default: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.ServicesNs.WiFiDirectServiceConfigurationMethod.default with Double = js.native
  /* 1 */ val pinDisplay: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.ServicesNs.WiFiDirectServiceConfigurationMethod.pinDisplay with Double = js.native
  /* 2 */ val pinEntry: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.ServicesNs.WiFiDirectServiceConfigurationMethod.pinEntry with Double = js.native
  @JSBracketAccess
