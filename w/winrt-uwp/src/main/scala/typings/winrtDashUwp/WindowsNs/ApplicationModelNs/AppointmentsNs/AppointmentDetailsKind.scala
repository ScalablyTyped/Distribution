...
object AppointmentDetailsKind extends js.Object {
  ...
  /* 1 */ val html: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppointmentsNs.AppointmentDetailsKind.html with Double = js.native
  /* 0 */ val plainText: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppointmentsNs.AppointmentDetailsKind.plainText with Double = js.native
  @JSBracketAccess
