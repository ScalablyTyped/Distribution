...
object PrintColorMode extends js.Object {
  ...
  /* 3 */ val color: typings.winrtDashUwp.WindowsNs.GraphicsNs.PrintingNs.PrintColorMode.color with Double = js.native
  /* 0 */ val default: typings.winrtDashUwp.WindowsNs.GraphicsNs.PrintingNs.PrintColorMode.default with Double = js.native
  /* 4 */ val grayscale: typings.winrtDashUwp.WindowsNs.GraphicsNs.PrintingNs.PrintColorMode.grayscale with Double = js.native
  /* 5 */ val monochrome: typings.winrtDashUwp.WindowsNs.GraphicsNs.PrintingNs.PrintColorMode.monochrome with Double = js.native
  /* 1 */ val notAvailable: typings.winrtDashUwp.WindowsNs.GraphicsNs.PrintingNs.PrintColorMode.notAvailable with Double = js.native
  /* 2 */ val printerCustom: typings.winrtDashUwp.WindowsNs.GraphicsNs.PrintingNs.PrintColorMode.printerCustom with Double = js.native
  @JSBracketAccess
