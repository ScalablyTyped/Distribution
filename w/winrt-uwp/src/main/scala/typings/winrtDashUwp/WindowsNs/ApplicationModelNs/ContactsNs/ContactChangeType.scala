...
object ContactChangeType extends js.Object {
  ...
  /* 3 */ val changeTrackingLost: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactChangeType.changeTrackingLost with Double = js.native
  /* 0 */ val created: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactChangeType.created with Double = js.native
  /* 2 */ val deleted: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactChangeType.deleted with Double = js.native
  /* 1 */ val modified: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactChangeType.modified with Double = js.native
  @JSBracketAccess
