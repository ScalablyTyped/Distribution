...
object SetFileNameResult extends js.Object {
  ...
  /* 1 */ val notAllowed: typings.winrtDashUwp.WindowsNs.StorageNs.PickersNs.ProviderNs.SetFileNameResult.notAllowed with Double = js.native
  /* 0 */ val succeeded: typings.winrtDashUwp.WindowsNs.StorageNs.PickersNs.ProviderNs.SetFileNameResult.succeeded with Double = js.native
  /* 2 */ val unavailable: typings.winrtDashUwp.WindowsNs.StorageNs.PickersNs.ProviderNs.SetFileNameResult.unavailable with Double = js.native
  @JSBracketAccess
