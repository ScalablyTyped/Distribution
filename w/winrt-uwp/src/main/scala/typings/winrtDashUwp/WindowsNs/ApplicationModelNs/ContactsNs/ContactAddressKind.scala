...
object ContactAddressKind extends js.Object {
  ...
  /* 0 */ val home: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactAddressKind.home with Double = js.native
  /* 2 */ val other: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactAddressKind.other with Double = js.native
  /* 1 */ val work: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactAddressKind.work with Double = js.native
  @JSBracketAccess
