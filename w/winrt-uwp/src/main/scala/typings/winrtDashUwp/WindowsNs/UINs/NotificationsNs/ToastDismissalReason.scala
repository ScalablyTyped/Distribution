...
object ToastDismissalReason extends js.Object {
  ...
  /* 1 */ val applicationHidden: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.ToastDismissalReason.applicationHidden with Double = js.native
  /* 2 */ val timedOut: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.ToastDismissalReason.timedOut with Double = js.native
  /* 0 */ val userCanceled: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.ToastDismissalReason.userCanceled with Double = js.native
  @JSBracketAccess
