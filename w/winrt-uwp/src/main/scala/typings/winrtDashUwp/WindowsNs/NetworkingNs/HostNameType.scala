...
object HostNameType extends js.Object {
  ...
  /* 3 */ val bluetooth: typings.winrtDashUwp.WindowsNs.NetworkingNs.HostNameType.bluetooth with Double = js.native
  /* 0 */ val domainName: typings.winrtDashUwp.WindowsNs.NetworkingNs.HostNameType.domainName with Double = js.native
  /* 1 */ val ipv4: typings.winrtDashUwp.WindowsNs.NetworkingNs.HostNameType.ipv4 with Double = js.native
  /* 2 */ val ipv6: typings.winrtDashUwp.WindowsNs.NetworkingNs.HostNameType.ipv6 with Double = js.native
  @JSBracketAccess
