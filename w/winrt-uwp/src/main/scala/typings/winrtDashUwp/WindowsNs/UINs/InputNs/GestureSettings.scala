...
object GestureSettings extends js.Object {
  ...
  /* 16 */ val crossSlide: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.crossSlide with Double = js.native
  /* 2 */ val doubleTap: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.doubleTap with Double = js.native
  /* 6 */ val drag: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.drag with Double = js.native
  /* 3 */ val hold: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.hold with Double = js.native
  /* 4 */ val holdWithMouse: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.holdWithMouse with Double = js.native
  /* 17 */ val manipulationMultipleFingerPanning: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.manipulationMultipleFingerPanning with Double = js.native
  /* 11 */ val manipulationRotate: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.manipulationRotate with Double = js.native
  /* 14 */ val manipulationRotateInertia: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.manipulationRotateInertia with Double = js.native
  /* 12 */ val manipulationScale: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.manipulationScale with Double = js.native
  /* 15 */ val manipulationScaleInertia: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.manipulationScaleInertia with Double = js.native
  /* 13 */ val manipulationTranslateInertia: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.manipulationTranslateInertia with Double = js.native
  /* 9 */ val manipulationTranslateRailsX: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.manipulationTranslateRailsX with Double = js.native
  /* 10 */ val manipulationTranslateRailsY: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.manipulationTranslateRailsY with Double = js.native
  /* 7 */ val manipulationTranslateX: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.manipulationTranslateX with Double = js.native
  /* 8 */ val manipulationTranslateY: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.manipulationTranslateY with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.none with Double = js.native
  /* 5 */ val rightTap: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.rightTap with Double = js.native
  /* 1 */ val tap: typings.winrtDashUwp.WindowsNs.UINs.InputNs.GestureSettings.tap with Double = js.native
  @JSBracketAccess
