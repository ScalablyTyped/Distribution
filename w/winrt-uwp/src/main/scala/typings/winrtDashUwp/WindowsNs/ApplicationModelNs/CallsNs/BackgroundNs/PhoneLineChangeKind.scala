...
object PhoneLineChangeKind extends js.Object {
  ...
  /* 0 */ val added: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.BackgroundNs.PhoneLineChangeKind.added with Double = js.native
  /* 2 */ val propertiesChanged: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.BackgroundNs.PhoneLineChangeKind.propertiesChanged with Double = js.native
  /* 1 */ val removed: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.BackgroundNs.PhoneLineChangeKind.removed with Double = js.native
  @JSBracketAccess
