...
import typings.winrtDashUwp.WindowsNs.FoundationNs.AsyncOperationProgressHandler
import typings.winrtDashUwp.WindowsNs.FoundationNs.AsyncOperationWithProgressCompletedHandler
