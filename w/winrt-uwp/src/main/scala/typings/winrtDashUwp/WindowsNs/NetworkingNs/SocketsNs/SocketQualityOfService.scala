...
object SocketQualityOfService extends js.Object {
  ...
  /* 1 */ val lowLatency: typings.winrtDashUwp.WindowsNs.NetworkingNs.SocketsNs.SocketQualityOfService.lowLatency with Double = js.native
  /* 0 */ val normal: typings.winrtDashUwp.WindowsNs.NetworkingNs.SocketsNs.SocketQualityOfService.normal with Double = js.native
  @JSBracketAccess
