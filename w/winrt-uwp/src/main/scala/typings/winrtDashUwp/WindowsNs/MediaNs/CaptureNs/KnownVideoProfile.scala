...
object KnownVideoProfile extends js.Object {
  ...
  /* 2 */ val balancedVideoAndPhoto: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.KnownVideoProfile.balancedVideoAndPhoto with Double = js.native
  /* 1 */ val highQualityPhoto: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.KnownVideoProfile.highQualityPhoto with Double = js.native
  /* 4 */ val photoSequence: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.KnownVideoProfile.photoSequence with Double = js.native
  /* 3 */ val videoConferencing: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.KnownVideoProfile.videoConferencing with Double = js.native
  /* 0 */ val videoRecording: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.KnownVideoProfile.videoRecording with Double = js.native
  @JSBracketAccess
