...
object CausalitySynchronousWork extends js.Object {
  ...
  /* 0 */ val completionNotification: typings.winrtDashUwp.WindowsNs.FoundationNs.DiagnosticsNs.CausalitySynchronousWork.completionNotification with Double = js.native
  /* 2 */ val execution: typings.winrtDashUwp.WindowsNs.FoundationNs.DiagnosticsNs.CausalitySynchronousWork.execution with Double = js.native
  /* 1 */ val progressNotification: typings.winrtDashUwp.WindowsNs.FoundationNs.DiagnosticsNs.CausalitySynchronousWork.progressNotification with Double = js.native
  @JSBracketAccess
