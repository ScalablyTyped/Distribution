...
object SmsMessageFilter extends js.Object {
  ...
  /* 0 */ val all: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsMessageFilter.all with Double = js.native
  /* 4 */ val draft: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsMessageFilter.draft with Double = js.native
  /* 2 */ val read: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsMessageFilter.read with Double = js.native
  /* 3 */ val sent: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsMessageFilter.sent with Double = js.native
  /* 1 */ val unread: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsMessageFilter.unread with Double = js.native
  @JSBracketAccess
