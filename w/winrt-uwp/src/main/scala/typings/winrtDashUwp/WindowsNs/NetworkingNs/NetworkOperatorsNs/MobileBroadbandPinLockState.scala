...
object MobileBroadbandPinLockState extends js.Object {
  ...
  /* 2 */ val pinRequired: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.MobileBroadbandPinLockState.pinRequired with Double = js.native
  /* 3 */ val pinUnblockKeyRequired: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.MobileBroadbandPinLockState.pinUnblockKeyRequired with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.MobileBroadbandPinLockState.unknown with Double = js.native
  /* 1 */ val unlocked: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.MobileBroadbandPinLockState.unlocked with Double = js.native
  @JSBracketAccess
