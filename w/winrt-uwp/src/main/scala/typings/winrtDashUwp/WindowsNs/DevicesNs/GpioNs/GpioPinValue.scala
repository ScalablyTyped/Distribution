...
object GpioPinValue extends js.Object {
  ...
  /* 1 */ val high: typings.winrtDashUwp.WindowsNs.DevicesNs.GpioNs.GpioPinValue.high with Double = js.native
  /* 0 */ val low: typings.winrtDashUwp.WindowsNs.DevicesNs.GpioNs.GpioPinValue.low with Double = js.native
  @JSBracketAccess
