...
object UsbWriteOptions extends js.Object {
  ...
  /* 1 */ val autoClearStall: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbWriteOptions.autoClearStall with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbWriteOptions.none with Double = js.native
  /* 2 */ val shortPacketTerminate: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbWriteOptions.shortPacketTerminate with Double = js.native
  @JSBracketAccess
