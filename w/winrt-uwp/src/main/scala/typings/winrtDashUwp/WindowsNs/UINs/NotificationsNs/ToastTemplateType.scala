...
object ToastTemplateType extends js.Object {
  ...
  /* 0 */ val toastImageAndText01: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.ToastTemplateType.toastImageAndText01 with Double = js.native
  /* 1 */ val toastImageAndText02: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.ToastTemplateType.toastImageAndText02 with Double = js.native
  /* 2 */ val toastImageAndText03: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.ToastTemplateType.toastImageAndText03 with Double = js.native
  /* 3 */ val toastImageAndText04: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.ToastTemplateType.toastImageAndText04 with Double = js.native
  /* 4 */ val toastText01: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.ToastTemplateType.toastText01 with Double = js.native
  /* 5 */ val toastText02: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.ToastTemplateType.toastText02 with Double = js.native
  /* 6 */ val toastText03: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.ToastTemplateType.toastText03 with Double = js.native
  /* 7 */ val toastText04: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.ToastTemplateType.toastText04 with Double = js.native
  @JSBracketAccess
