...
object PositionSource extends js.Object {
  ...
  /* 0 */ val cellular: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.PositionSource.cellular with Double = js.native
  /* 3 */ val ipAddress: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.PositionSource.ipAddress with Double = js.native
  /* 1 */ val satellite: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.PositionSource.satellite with Double = js.native
  /* 4 */ val unknown: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.PositionSource.unknown with Double = js.native
  /* 2 */ val wiFi: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.PositionSource.wiFi with Double = js.native
  @JSBracketAccess
