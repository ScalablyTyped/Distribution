...
object NameCollisionOption extends js.Object {
  ...
  /* 2 */ val failIfExists: typings.winrtDashUwp.WindowsNs.StorageNs.NameCollisionOption.failIfExists with Double = js.native
  /* 0 */ val generateUniqueName: typings.winrtDashUwp.WindowsNs.StorageNs.NameCollisionOption.generateUniqueName with Double = js.native
  /* 1 */ val replaceExisting: typings.winrtDashUwp.WindowsNs.StorageNs.NameCollisionOption.replaceExisting with Double = js.native
  @JSBracketAccess
