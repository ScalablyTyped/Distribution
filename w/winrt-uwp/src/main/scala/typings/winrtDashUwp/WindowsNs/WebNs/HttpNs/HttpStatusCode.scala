...
object HttpStatusCode extends js.Object {
  ...
  /* 6 */ val accepted: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.accepted with Double = js.native
  /* 12 */ val alreadyReported: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.alreadyReported with Double = js.native
  /* 49 */ val badGateway: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.badGateway with Double = js.native
  /* 22 */ val badRequest: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.badRequest with Double = js.native
  /* 31 */ val conflict: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.conflict with Double = js.native
  /* 1 */ val continue: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.continue with Double = js.native
  /* 5 */ val created: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.created with Double = js.native
  /* 39 */ val expectationFailed: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.expectationFailed with Double = js.native
  /* 42 */ val failedDependency: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.failedDependency with Double = js.native
  /* 25 */ val forbidden: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.forbidden with Double = js.native
  /* 16 */ val found: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.found with Double = js.native
  /* 51 */ val gatewayTimeout: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.gatewayTimeout with Double = js.native
  /* 32 */ val gone: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.gone with Double = js.native
  /* 52 */ val httpVersionNotSupported: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.httpVersionNotSupported with Double = js.native
  /* 13 */ val imUsed: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.imUsed with Double = js.native
  /* 54 */ val insufficientStorage: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.insufficientStorage with Double = js.native
  /* 47 */ val internalServerError: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.internalServerError with Double = js.native
  /* 33 */ val lengthRequired: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.lengthRequired with Double = js.native
  /* 41 */ val locked: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.locked with Double = js.native
  /* 55 */ val loopDetected: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.loopDetected with Double = js.native
  /* 27 */ val methodNotAllowed: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.methodNotAllowed with Double = js.native
  /* 15 */ val movedPermanently: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.movedPermanently with Double = js.native
  /* 11 */ val multiStatus: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.multiStatus with Double = js.native
  /* 14 */ val multipleChoices: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.multipleChoices with Double = js.native
  /* 57 */ val networkAuthenticationRequired: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.networkAuthenticationRequired with Double = js.native
  /* 8 */ val noContent: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.noContent with Double = js.native
  /* 7 */ val nonAuthoritativeInformation: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.nonAuthoritativeInformation with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.none with Double = js.native
  /* 28 */ val notAcceptable: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.notAcceptable with Double = js.native
  /* 56 */ val notExtended: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.notExtended with Double = js.native
  /* 26 */ val notFound: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.notFound with Double = js.native
  /* 48 */ val notImplemented: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.notImplemented with Double = js.native
  /* 18 */ val notModified: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.notModified with Double = js.native
  /* 4 */ val ok: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.ok with Double = js.native
  /* 10 */ val partialContent: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.partialContent with Double = js.native
  /* 24 */ val paymentRequired: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.paymentRequired with Double = js.native
  /* 21 */ val permanentRedirect: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.permanentRedirect with Double = js.native
  /* 34 */ val preconditionFailed: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.preconditionFailed with Double = js.native
  /* 44 */ val preconditionRequired: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.preconditionRequired with Double = js.native
  /* 3 */ val processing: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.processing with Double = js.native
  /* 29 */ val proxyAuthenticationRequired: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.proxyAuthenticationRequired with Double = js.native
  /* 35 */ val requestEntityTooLarge: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.requestEntityTooLarge with Double = js.native
  /* 46 */ val requestHeaderFieldsTooLarge: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.requestHeaderFieldsTooLarge with Double = js.native
  /* 30 */ val requestTimeout: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.requestTimeout with Double = js.native
  /* 36 */ val requestUriTooLong: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.requestUriTooLong with Double = js.native
  /* 38 */ val requestedRangeNotSatisfiable: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.requestedRangeNotSatisfiable with Double = js.native
  /* 9 */ val resetContent: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.resetContent with Double = js.native
  /* 17 */ val seeOther: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.seeOther with Double = js.native
  /* 50 */ val serviceUnavailable: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.serviceUnavailable with Double = js.native
  /* 2 */ val switchingProtocols: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.switchingProtocols with Double = js.native
  /* 20 */ val temporaryRedirect: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.temporaryRedirect with Double = js.native
  /* 45 */ val tooManyRequests: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.tooManyRequests with Double = js.native
  /* 23 */ val unauthorized: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.unauthorized with Double = js.native
  /* 40 */ val unprocessableEntity: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.unprocessableEntity with Double = js.native
  /* 37 */ val unsupportedMediaType: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.unsupportedMediaType with Double = js.native
  /* 43 */ val upgradeRequired: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.upgradeRequired with Double = js.native
  /* 19 */ val useProxy: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.useProxy with Double = js.native
  /* 53 */ val variantAlsoNegotiates: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpStatusCode.variantAlsoNegotiates with Double = js.native
  @JSBracketAccess
