...
object Printing3DTextureEdgeBehavior extends js.Object {
  ...
  /* 3 */ val clamp: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DTextureEdgeBehavior.clamp with Double = js.native
  /* 2 */ val mirror: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DTextureEdgeBehavior.mirror with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DTextureEdgeBehavior.none with Double = js.native
  /* 1 */ val wrap: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DTextureEdgeBehavior.wrap with Double = js.native
  @JSBracketAccess
