...
object ProductType extends js.Object {
  ...
  /* 2 */ val consumable: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.StoreNs.ProductType.consumable with Double = js.native
  /* 1 */ val durable: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.StoreNs.ProductType.durable with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.StoreNs.ProductType.unknown with Double = js.native
  @JSBracketAccess
