...
object StorePurchaseStatus extends js.Object {
  ...
  /* 1 */ val alreadyPurchased: typings.winrtDashUwp.WindowsNs.ServicesNs.StoreNs.StorePurchaseStatus.alreadyPurchased with Double = js.native
  /* 3 */ val networkError: typings.winrtDashUwp.WindowsNs.ServicesNs.StoreNs.StorePurchaseStatus.networkError with Double = js.native
  /* 2 */ val notPurchased: typings.winrtDashUwp.WindowsNs.ServicesNs.StoreNs.StorePurchaseStatus.notPurchased with Double = js.native
  /* 4 */ val serverError: typings.winrtDashUwp.WindowsNs.ServicesNs.StoreNs.StorePurchaseStatus.serverError with Double = js.native
  /* 0 */ val succeeded: typings.winrtDashUwp.WindowsNs.ServicesNs.StoreNs.StorePurchaseStatus.succeeded with Double = js.native
  @JSBracketAccess
