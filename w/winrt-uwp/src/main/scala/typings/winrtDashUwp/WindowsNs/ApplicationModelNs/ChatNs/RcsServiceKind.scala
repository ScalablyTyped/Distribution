...
object RcsServiceKind extends js.Object {
  ...
  /* 3 */ val capability: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ChatNs.RcsServiceKind.capability with Double = js.native
  /* 0 */ val chat: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ChatNs.RcsServiceKind.chat with Double = js.native
  /* 2 */ val fileTransfer: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ChatNs.RcsServiceKind.fileTransfer with Double = js.native
  /* 1 */ val groupChat: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ChatNs.RcsServiceKind.groupChat with Double = js.native
  @JSBracketAccess
