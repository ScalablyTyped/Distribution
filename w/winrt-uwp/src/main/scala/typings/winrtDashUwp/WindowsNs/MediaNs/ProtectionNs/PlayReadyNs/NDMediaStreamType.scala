...
object NDMediaStreamType extends js.Object {
  ...
  /* 0 */ val audio: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.NDMediaStreamType.audio with Double = js.native
  /* 1 */ val video: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.NDMediaStreamType.video with Double = js.native
  @JSBracketAccess
