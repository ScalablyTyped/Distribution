...
object MarkerAlignment extends js.Object {
  ...
  /* 2 */ val center: typings.winrtDashUwp.WindowsNs.UINs.TextNs.MarkerAlignment.center with Double = js.native
  /* 1 */ val left: typings.winrtDashUwp.WindowsNs.UINs.TextNs.MarkerAlignment.left with Double = js.native
  /* 3 */ val right: typings.winrtDashUwp.WindowsNs.UINs.TextNs.MarkerAlignment.right with Double = js.native
  /* 0 */ val undefined: typings.winrtDashUwp.WindowsNs.UINs.TextNs.MarkerAlignment.undefined with Double = js.native
  @JSBracketAccess
