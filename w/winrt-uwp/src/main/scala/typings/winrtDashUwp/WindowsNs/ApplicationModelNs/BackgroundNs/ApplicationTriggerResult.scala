...
object ApplicationTriggerResult extends js.Object {
  ...
  /* 0 */ val allowed: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.ApplicationTriggerResult.allowed with Double = js.native
  /* 1 */ val currentlyRunning: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.ApplicationTriggerResult.currentlyRunning with Double = js.native
  /* 2 */ val disabledByPolicy: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.ApplicationTriggerResult.disabledByPolicy with Double = js.native
  /* 3 */ val unknownError: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.ApplicationTriggerResult.unknownError with Double = js.native
  @JSBracketAccess
