...
object TextRangeUnit extends js.Object {
  ...
  /* 21 */ val allCaps: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.allCaps with Double = js.native
  /* 14 */ val bold: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.bold with Double = js.native
  /* 0 */ val character: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.character with Double = js.native
  /* 9 */ val characterFormat: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.characterFormat with Double = js.native
  /* 13 */ val cluster: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.cluster with Double = js.native
  /* 26 */ val disabled: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.disabled with Double = js.native
  /* 30 */ val fontBound: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.fontBound with Double = js.native
  /* 12 */ val hardParagraph: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.hardParagraph with Double = js.native
  /* 22 */ val hidden: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.hidden with Double = js.native
  /* 25 */ val imprint: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.imprint with Double = js.native
  /* 15 */ val italic: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.italic with Double = js.native
  /* 4 */ val line: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.line with Double = js.native
  /* 19 */ val link: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.link with Double = js.native
  /* 31 */ val linkProtected: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.linkProtected with Double = js.native
  /* 11 */ val `object`: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.`object` with Double = js.native
  /* 23 */ val outline: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.outline with Double = js.native
  /* 3 */ val paragraph: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.paragraph with Double = js.native
  /* 10 */ val paragraphFormat: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.paragraphFormat with Double = js.native
  /* 18 */ val protectedText: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.protectedText with Double = js.native
  /* 27 */ val revised: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.revised with Double = js.native
  /* 6 */ val screen: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.screen with Double = js.native
  /* 7 */ val section: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.section with Double = js.native
  /* 2 */ val sentence: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.sentence with Double = js.native
  /* 24 */ val shadow: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.shadow with Double = js.native
  /* 20 */ val smallCaps: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.smallCaps with Double = js.native
  /* 5 */ val story: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.story with Double = js.native
  /* 17 */ val strikethrough: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.strikethrough with Double = js.native
  /* 28 */ val subscript: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.subscript with Double = js.native
  /* 29 */ val superscript: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.superscript with Double = js.native
  /* 16 */ val underline: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.underline with Double = js.native
  /* 8 */ val window: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.window with Double = js.native
  /* 1 */ val word: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextRangeUnit.word with Double = js.native
  @JSBracketAccess
