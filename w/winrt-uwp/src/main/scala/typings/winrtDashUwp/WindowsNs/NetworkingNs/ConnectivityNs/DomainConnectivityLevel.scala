...
object DomainConnectivityLevel extends js.Object {
  ...
  /* 2 */ val authenticated: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.DomainConnectivityLevel.authenticated with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.DomainConnectivityLevel.none with Double = js.native
  /* 1 */ val unauthenticated: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.DomainConnectivityLevel.unauthenticated with Double = js.native
  @JSBracketAccess
