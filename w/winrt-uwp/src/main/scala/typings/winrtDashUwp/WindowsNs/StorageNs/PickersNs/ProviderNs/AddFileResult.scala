...
object AddFileResult extends js.Object {
  ...
  /* 0 */ val added: typings.winrtDashUwp.WindowsNs.StorageNs.PickersNs.ProviderNs.AddFileResult.added with Double = js.native
  /* 1 */ val alreadyAdded: typings.winrtDashUwp.WindowsNs.StorageNs.PickersNs.ProviderNs.AddFileResult.alreadyAdded with Double = js.native
  /* 2 */ val notAllowed: typings.winrtDashUwp.WindowsNs.StorageNs.PickersNs.ProviderNs.AddFileResult.notAllowed with Double = js.native
  /* 3 */ val unavailable: typings.winrtDashUwp.WindowsNs.StorageNs.PickersNs.ProviderNs.AddFileResult.unavailable with Double = js.native
  @JSBracketAccess
