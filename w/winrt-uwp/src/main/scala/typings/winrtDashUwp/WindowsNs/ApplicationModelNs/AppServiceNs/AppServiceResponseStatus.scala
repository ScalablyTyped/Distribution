...
object AppServiceResponseStatus extends js.Object {
  ...
  /* 1 */ val failure: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppServiceNs.AppServiceResponseStatus.failure with Double = js.native
  /* 2 */ val resourceLimitsExceeded: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppServiceNs.AppServiceResponseStatus.resourceLimitsExceeded with Double = js.native
  /* 0 */ val success: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppServiceNs.AppServiceResponseStatus.success with Double = js.native
  /* 3 */ val unknown: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppServiceNs.AppServiceResponseStatus.unknown with Double = js.native
  @JSBracketAccess
