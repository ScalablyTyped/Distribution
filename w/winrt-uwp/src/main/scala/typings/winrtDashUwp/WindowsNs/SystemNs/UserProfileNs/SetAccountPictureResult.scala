...
object SetAccountPictureResult extends js.Object {
  ...
  /* 1 */ val changeDisabled: typings.winrtDashUwp.WindowsNs.SystemNs.UserProfileNs.SetAccountPictureResult.changeDisabled with Double = js.native
  /* 5 */ val failure: typings.winrtDashUwp.WindowsNs.SystemNs.UserProfileNs.SetAccountPictureResult.failure with Double = js.native
  /* 4 */ val fileSizeError: typings.winrtDashUwp.WindowsNs.SystemNs.UserProfileNs.SetAccountPictureResult.fileSizeError with Double = js.native
  /* 2 */ val largeOrDynamicError: typings.winrtDashUwp.WindowsNs.SystemNs.UserProfileNs.SetAccountPictureResult.largeOrDynamicError with Double = js.native
  /* 0 */ val success: typings.winrtDashUwp.WindowsNs.SystemNs.UserProfileNs.SetAccountPictureResult.success with Double = js.native
  /* 3 */ val videoFrameSizeError: typings.winrtDashUwp.WindowsNs.SystemNs.UserProfileNs.SetAccountPictureResult.videoFrameSizeError with Double = js.native
  @JSBracketAccess
