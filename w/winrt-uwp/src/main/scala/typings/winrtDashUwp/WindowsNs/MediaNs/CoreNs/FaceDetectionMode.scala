...
object FaceDetectionMode extends js.Object {
  ...
  /* 1 */ val balanced: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.FaceDetectionMode.balanced with Double = js.native
  /* 0 */ val highPerformance: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.FaceDetectionMode.highPerformance with Double = js.native
  /* 2 */ val highQuality: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.FaceDetectionMode.highQuality with Double = js.native
  @JSBracketAccess
