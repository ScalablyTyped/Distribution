...
object ContactQuerySearchFields extends js.Object {
  ...
  /* 4 */ val all: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactQuerySearchFields.all with Double = js.native
  /* 2 */ val email: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactQuerySearchFields.email with Double = js.native
  /* 1 */ val name: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactQuerySearchFields.name with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactQuerySearchFields.none with Double = js.native
  /* 3 */ val phone: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactQuerySearchFields.phone with Double = js.native
  @JSBracketAccess
