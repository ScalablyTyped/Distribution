...
object TetheringOperationStatus extends js.Object {
  ...
  /* 5 */ val entitlementCheckFailure: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.TetheringOperationStatus.entitlementCheckFailure with Double = js.native
  /* 4 */ val entitlementCheckTimeout: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.TetheringOperationStatus.entitlementCheckTimeout with Double = js.native
  /* 2 */ val mobileBroadbandDeviceOff: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.TetheringOperationStatus.mobileBroadbandDeviceOff with Double = js.native
  /* 6 */ val operationInProgress: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.TetheringOperationStatus.operationInProgress with Double = js.native
  /* 0 */ val success: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.TetheringOperationStatus.success with Double = js.native
  /* 1 */ val unknown: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.TetheringOperationStatus.unknown with Double = js.native
  /* 3 */ val wiFiDeviceOff: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.TetheringOperationStatus.wiFiDeviceOff with Double = js.native
  @JSBracketAccess
