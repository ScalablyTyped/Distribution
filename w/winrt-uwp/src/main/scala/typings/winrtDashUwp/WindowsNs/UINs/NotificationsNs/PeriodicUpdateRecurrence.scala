...
object PeriodicUpdateRecurrence extends js.Object {
  ...
  /* 4 */ val daily: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.PeriodicUpdateRecurrence.daily with Double = js.native
  /* 0 */ val halfHour: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.PeriodicUpdateRecurrence.halfHour with Double = js.native
  /* 1 */ val hour: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.PeriodicUpdateRecurrence.hour with Double = js.native
  /* 2 */ val sixHours: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.PeriodicUpdateRecurrence.sixHours with Double = js.native
  /* 3 */ val twelveHours: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.PeriodicUpdateRecurrence.twelveHours with Double = js.native
  @JSBracketAccess
