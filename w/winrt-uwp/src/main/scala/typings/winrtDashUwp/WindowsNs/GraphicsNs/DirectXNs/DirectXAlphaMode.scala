package typings.winrtDashUwp.WindowsNs.GraphicsNs.DirectXNs
...
object DirectXAlphaMode extends js.Object {
  ...
  /* 3 */ val ignore: typings.winrtDashUwp.WindowsNs.GraphicsNs.DirectXNs.DirectXAlphaMode.ignore with Double = js.native
  /* 1 */ val premultiplied: typings.winrtDashUwp.WindowsNs.GraphicsNs.DirectXNs.DirectXAlphaMode.premultiplied with Double = js.native
  /* 2 */ val straight: typings.winrtDashUwp.WindowsNs.GraphicsNs.DirectXNs.DirectXAlphaMode.straight with Double = js.native
  /* 0 */ val unspecified: typings.winrtDashUwp.WindowsNs.GraphicsNs.DirectXNs.DirectXAlphaMode.unspecified with Double = js.native
  @JSBracketAccess
