...
object BatteryStatus extends js.Object {
  ...
  /* 3 */ val charging: typings.winrtDashUwp.WindowsNs.SystemNs.PowerNs.BatteryStatus.charging with Double = js.native
  /* 1 */ val discharging: typings.winrtDashUwp.WindowsNs.SystemNs.PowerNs.BatteryStatus.discharging with Double = js.native
  /* 2 */ val idle: typings.winrtDashUwp.WindowsNs.SystemNs.PowerNs.BatteryStatus.idle with Double = js.native
  /* 0 */ val notPresent: typings.winrtDashUwp.WindowsNs.SystemNs.PowerNs.BatteryStatus.notPresent with Double = js.native
  @JSBracketAccess
