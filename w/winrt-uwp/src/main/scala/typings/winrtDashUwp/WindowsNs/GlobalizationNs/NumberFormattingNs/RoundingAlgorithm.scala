...
object RoundingAlgorithm extends js.Object {
  ...
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.RoundingAlgorithm.none with Double = js.native
  /* 4 */ val roundAwayFromZero: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.RoundingAlgorithm.roundAwayFromZero with Double = js.native
  /* 1 */ val roundDown: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.RoundingAlgorithm.roundDown with Double = js.native
  /* 8 */ val roundHalfAwayFromZero: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.RoundingAlgorithm.roundHalfAwayFromZero with Double = js.native
  /* 5 */ val roundHalfDown: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.RoundingAlgorithm.roundHalfDown with Double = js.native
  /* 9 */ val roundHalfToEven: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.RoundingAlgorithm.roundHalfToEven with Double = js.native
  /* 10 */ val roundHalfToOdd: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.RoundingAlgorithm.roundHalfToOdd with Double = js.native
  /* 7 */ val roundHalfTowardsZero: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.RoundingAlgorithm.roundHalfTowardsZero with Double = js.native
  /* 6 */ val roundHalfUp: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.RoundingAlgorithm.roundHalfUp with Double = js.native
  /* 3 */ val roundTowardsZero: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.RoundingAlgorithm.roundTowardsZero with Double = js.native
  /* 2 */ val roundUp: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.RoundingAlgorithm.roundUp with Double = js.native
  @JSBracketAccess
