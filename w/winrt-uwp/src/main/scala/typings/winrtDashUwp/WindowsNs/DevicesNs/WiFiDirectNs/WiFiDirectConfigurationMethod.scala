...
object WiFiDirectConfigurationMethod extends js.Object {
  ...
  /* 1 */ val displayPin: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.WiFiDirectConfigurationMethod.displayPin with Double = js.native
  /* 0 */ val providePin: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.WiFiDirectConfigurationMethod.providePin with Double = js.native
  /* 2 */ val pushButton: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.WiFiDirectConfigurationMethod.pushButton with Double = js.native
  @JSBracketAccess
