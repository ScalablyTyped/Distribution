...
import typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.MediaProtectionManager
import typings.winrtDashUwp.WindowsNs.MediaNs.SystemMediaTransportControls
