...
object EmailImportance extends js.Object {
  ...
  /* 1 */ val high: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailImportance.high with Double = js.native
  /* 2 */ val low: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailImportance.low with Double = js.native
  /* 0 */ val normal: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailImportance.normal with Double = js.native
  @JSBracketAccess
