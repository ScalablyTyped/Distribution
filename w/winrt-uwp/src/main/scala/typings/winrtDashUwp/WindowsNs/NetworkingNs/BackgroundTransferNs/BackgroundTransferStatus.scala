...
object BackgroundTransferStatus extends js.Object {
  ...
  /* 6 */ val canceled: typings.winrtDashUwp.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferStatus.canceled with Double = js.native
  /* 5 */ val completed: typings.winrtDashUwp.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferStatus.completed with Double = js.native
  /* 7 */ val error: typings.winrtDashUwp.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferStatus.error with Double = js.native
  /* 0 */ val idle: typings.winrtDashUwp.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferStatus.idle with Double = js.native
  /* 2 */ val pausedByApplication: typings.winrtDashUwp.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferStatus.pausedByApplication with Double = js.native
  /* 3 */ val pausedCostedNetwork: typings.winrtDashUwp.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferStatus.pausedCostedNetwork with Double = js.native
  /* 4 */ val pausedNoNetwork: typings.winrtDashUwp.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferStatus.pausedNoNetwork with Double = js.native
  /* 8 */ val pausedSystemPolicy: typings.winrtDashUwp.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferStatus.pausedSystemPolicy with Double = js.native
  /* 1 */ val running: typings.winrtDashUwp.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferStatus.running with Double = js.native
  @JSBracketAccess
