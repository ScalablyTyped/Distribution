...
object ContactMatchReasonKind extends js.Object {
  ...
  /* 1 */ val emailAddress: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactMatchReasonKind.emailAddress with Double = js.native
  /* 3 */ val jobInfo: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactMatchReasonKind.jobInfo with Double = js.native
  /* 0 */ val name: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactMatchReasonKind.name with Double = js.native
  /* 5 */ val other: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactMatchReasonKind.other with Double = js.native
  /* 2 */ val phoneNumber: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactMatchReasonKind.phoneNumber with Double = js.native
  /* 4 */ val yomiName: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactMatchReasonKind.yomiName with Double = js.native
  @JSBracketAccess
