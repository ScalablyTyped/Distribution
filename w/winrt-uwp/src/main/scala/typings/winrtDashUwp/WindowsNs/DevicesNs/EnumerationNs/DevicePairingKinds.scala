...
object DevicePairingKinds extends js.Object {
  ...
  /* 1 */ val confirmOnly: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DevicePairingKinds.confirmOnly with Double = js.native
  /* 4 */ val confirmPinMatch: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DevicePairingKinds.confirmPinMatch with Double = js.native
  /* 2 */ val displayPin: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DevicePairingKinds.displayPin with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DevicePairingKinds.none with Double = js.native
  /* 3 */ val providePin: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DevicePairingKinds.providePin with Double = js.native
  @JSBracketAccess
