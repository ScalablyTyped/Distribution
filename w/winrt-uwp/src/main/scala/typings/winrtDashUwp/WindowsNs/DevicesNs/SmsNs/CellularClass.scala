...
object CellularClass extends js.Object {
  ...
  /* 2 */ val cdma: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.CellularClass.cdma with Double = js.native
  /* 1 */ val gsm: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.CellularClass.gsm with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.CellularClass.none with Double = js.native
  @JSBracketAccess
