...
object TiffCompressionMode extends js.Object {
  ...
  /* 0 */ val automatic: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.TiffCompressionMode.automatic with Double = js.native
  /* 2 */ val ccitt3: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.TiffCompressionMode.ccitt3 with Double = js.native
  /* 3 */ val ccitt4: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.TiffCompressionMode.ccitt4 with Double = js.native
  /* 4 */ val lzw: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.TiffCompressionMode.lzw with Double = js.native
  /* 7 */ val lzwhDifferencing: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.TiffCompressionMode.lzwhDifferencing with Double = js.native
  /* 1 */ val none: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.TiffCompressionMode.none with Double = js.native
  /* 5 */ val rle: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.TiffCompressionMode.rle with Double = js.native
  /* 6 */ val zip: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.TiffCompressionMode.zip with Double = js.native
  @JSBracketAccess
