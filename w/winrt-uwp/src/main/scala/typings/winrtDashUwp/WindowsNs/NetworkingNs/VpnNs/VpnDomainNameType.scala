...
object VpnDomainNameType extends js.Object {
  ...
  /* 1 */ val fullyQualified: typings.winrtDashUwp.WindowsNs.NetworkingNs.VpnNs.VpnDomainNameType.fullyQualified with Double = js.native
  /* 2 */ val reserved: typings.winrtDashUwp.WindowsNs.NetworkingNs.VpnNs.VpnDomainNameType.reserved with Double = js.native
  /* 0 */ val suffix: typings.winrtDashUwp.WindowsNs.NetworkingNs.VpnNs.VpnDomainNameType.suffix with Double = js.native
  @JSBracketAccess
