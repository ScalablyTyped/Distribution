...
object DataPackageOperation extends js.Object {
  ...
  /* 1 */ val copy: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.DataTransferNs.DataPackageOperation.copy with Double = js.native
  /* 3 */ val link: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.DataTransferNs.DataPackageOperation.link with Double = js.native
  /* 2 */ val move: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.DataTransferNs.DataPackageOperation.move with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.DataTransferNs.DataPackageOperation.none with Double = js.native
  @JSBracketAccess
