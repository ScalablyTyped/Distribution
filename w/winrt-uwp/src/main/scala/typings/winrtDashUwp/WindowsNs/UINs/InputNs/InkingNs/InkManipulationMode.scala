...
object InkManipulationMode extends js.Object {
  ...
  /* 1 */ val erasing: typings.winrtDashUwp.WindowsNs.UINs.InputNs.InkingNs.InkManipulationMode.erasing with Double = js.native
  /* 0 */ val inking: typings.winrtDashUwp.WindowsNs.UINs.InputNs.InkingNs.InkManipulationMode.inking with Double = js.native
  /* 2 */ val selecting: typings.winrtDashUwp.WindowsNs.UINs.InputNs.InkingNs.InkManipulationMode.selecting with Double = js.native
  @JSBracketAccess
