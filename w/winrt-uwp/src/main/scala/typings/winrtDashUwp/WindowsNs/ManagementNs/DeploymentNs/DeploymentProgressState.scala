...
object DeploymentProgressState extends js.Object {
  ...
  /* 1 */ val processing: typings.winrtDashUwp.WindowsNs.ManagementNs.DeploymentNs.DeploymentProgressState.processing with Double = js.native
  /* 0 */ val queued: typings.winrtDashUwp.WindowsNs.ManagementNs.DeploymentNs.DeploymentProgressState.queued with Double = js.native
  @JSBracketAccess
