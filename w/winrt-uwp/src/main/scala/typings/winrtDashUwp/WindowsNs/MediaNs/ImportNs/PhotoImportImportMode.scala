...
object PhotoImportImportMode extends js.Object {
  ...
  /* 2 */ val ignoreSiblings: typings.winrtDashUwp.WindowsNs.MediaNs.ImportNs.PhotoImportImportMode.ignoreSiblings with Double = js.native
  /* 1 */ val ignoreSidecars: typings.winrtDashUwp.WindowsNs.MediaNs.ImportNs.PhotoImportImportMode.ignoreSidecars with Double = js.native
  /* 3 */ val ignoreSidecarsAndSiblings: typings.winrtDashUwp.WindowsNs.MediaNs.ImportNs.PhotoImportImportMode.ignoreSidecarsAndSiblings with Double = js.native
  /* 0 */ val importEverything: typings.winrtDashUwp.WindowsNs.MediaNs.ImportNs.PhotoImportImportMode.importEverything with Double = js.native
  @JSBracketAccess
