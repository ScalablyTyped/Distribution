...
object BackgroundTransferBehavior extends js.Object {
  ...
  /* 0 */ val parallel: typings.winrtDashUwp.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferBehavior.parallel with Double = js.native
  /* 1 */ val serialized: typings.winrtDashUwp.WindowsNs.NetworkingNs.BackgroundTransferNs.BackgroundTransferBehavior.serialized with Double = js.native
  @JSBracketAccess
