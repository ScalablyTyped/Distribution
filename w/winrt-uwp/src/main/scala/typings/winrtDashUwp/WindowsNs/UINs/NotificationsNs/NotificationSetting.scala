...
object NotificationSetting extends js.Object {
  ...
  /* 3 */ val disabledByGroupPolicy: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.NotificationSetting.disabledByGroupPolicy with Double = js.native
  /* 4 */ val disabledByManifest: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.NotificationSetting.disabledByManifest with Double = js.native
  /* 1 */ val disabledForApplication: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.NotificationSetting.disabledForApplication with Double = js.native
  /* 2 */ val disabledForUser: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.NotificationSetting.disabledForUser with Double = js.native
  /* 0 */ val enabled: typings.winrtDashUwp.WindowsNs.UINs.NotificationsNs.NotificationSetting.enabled with Double = js.native
  @JSBracketAccess
