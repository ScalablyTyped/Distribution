...
object TriggeredConnectState extends js.Object {
  ...
  /* 4 */ val canceled: typings.winrtDashUwp.WindowsNs.NetworkingNs.ProximityNs.TriggeredConnectState.canceled with Double = js.native
  /* 3 */ val completed: typings.winrtDashUwp.WindowsNs.NetworkingNs.ProximityNs.TriggeredConnectState.completed with Double = js.native
  /* 2 */ val connecting: typings.winrtDashUwp.WindowsNs.NetworkingNs.ProximityNs.TriggeredConnectState.connecting with Double = js.native
  /* 5 */ val failed: typings.winrtDashUwp.WindowsNs.NetworkingNs.ProximityNs.TriggeredConnectState.failed with Double = js.native
  /* 1 */ val listening: typings.winrtDashUwp.WindowsNs.NetworkingNs.ProximityNs.TriggeredConnectState.listening with Double = js.native
  /* 0 */ val peerFound: typings.winrtDashUwp.WindowsNs.NetworkingNs.ProximityNs.TriggeredConnectState.peerFound with Double = js.native
  @JSBracketAccess
