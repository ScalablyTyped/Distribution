...
object StreamingCaptureMode extends js.Object {
  ...
  /* 1 */ val audio: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.StreamingCaptureMode.audio with Double = js.native
  /* 0 */ val audioAndVideo: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.StreamingCaptureMode.audioAndVideo with Double = js.native
  /* 2 */ val video: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.StreamingCaptureMode.video with Double = js.native
  @JSBracketAccess
