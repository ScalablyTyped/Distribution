...
object AppointmentWeekOfMonth extends js.Object {
  ...
  /* 0 */ val first: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppointmentsNs.AppointmentWeekOfMonth.first with Double = js.native
  /* 3 */ val fourth: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppointmentsNs.AppointmentWeekOfMonth.fourth with Double = js.native
  /* 4 */ val last: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppointmentsNs.AppointmentWeekOfMonth.last with Double = js.native
  /* 1 */ val second: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppointmentsNs.AppointmentWeekOfMonth.second with Double = js.native
  /* 2 */ val third: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppointmentsNs.AppointmentWeekOfMonth.third with Double = js.native
  @JSBracketAccess
