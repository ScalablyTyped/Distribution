...
object PosPrinterMarkFeedCapabilities extends js.Object {
  ...
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterMarkFeedCapabilities.none with Double = js.native
  /* 3 */ val toCurrentTopOfForm: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterMarkFeedCapabilities.toCurrentTopOfForm with Double = js.native
  /* 2 */ val toCutter: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterMarkFeedCapabilities.toCutter with Double = js.native
  /* 4 */ val toNextTopOfForm: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterMarkFeedCapabilities.toNextTopOfForm with Double = js.native
  /* 1 */ val toTakeUp: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterMarkFeedCapabilities.toTakeUp with Double = js.native
  @JSBracketAccess
