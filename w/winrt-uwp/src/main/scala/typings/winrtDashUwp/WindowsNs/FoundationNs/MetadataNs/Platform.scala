...
object Platform extends js.Object {
  ...
  /* 0 */ val windows: typings.winrtDashUwp.WindowsNs.FoundationNs.MetadataNs.Platform.windows with Double = js.native
  /* 1 */ val windowsPhone: typings.winrtDashUwp.WindowsNs.FoundationNs.MetadataNs.Platform.windowsPhone with Double = js.native
  @JSBracketAccess
