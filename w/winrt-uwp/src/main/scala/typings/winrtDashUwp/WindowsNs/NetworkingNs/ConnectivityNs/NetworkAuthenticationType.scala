...
object NetworkAuthenticationType extends js.Object {
  ...
  /* 9 */ val ihv: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkAuthenticationType.ihv with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkAuthenticationType.none with Double = js.native
  /* 2 */ val open80211: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkAuthenticationType.open80211 with Double = js.native
  /* 7 */ val rsna: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkAuthenticationType.rsna with Double = js.native
  /* 8 */ val rsnaPsk: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkAuthenticationType.rsnaPsk with Double = js.native
  /* 3 */ val sharedKey80211: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkAuthenticationType.sharedKey80211 with Double = js.native
  /* 1 */ val unknown: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkAuthenticationType.unknown with Double = js.native
  /* 4 */ val wpa: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkAuthenticationType.wpa with Double = js.native
  /* 6 */ val wpaNone: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkAuthenticationType.wpaNone with Double = js.native
  /* 5 */ val wpaPsk: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkAuthenticationType.wpaPsk with Double = js.native
  @JSBracketAccess
