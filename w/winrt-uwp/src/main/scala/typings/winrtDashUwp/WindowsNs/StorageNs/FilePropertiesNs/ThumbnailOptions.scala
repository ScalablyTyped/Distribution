...
object ThumbnailOptions extends js.Object {
  ...
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailOptions.none with Double = js.native
  /* 2 */ val resizeThumbnail: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailOptions.resizeThumbnail with Double = js.native
  /* 1 */ val returnOnlyIfCached: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailOptions.returnOnlyIfCached with Double = js.native
  /* 3 */ val useCurrentScale: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailOptions.useCurrentScale with Double = js.native
  @JSBracketAccess
