...
object PhoneTriggerType extends js.Object {
  ...
  /* 3 */ val airplaneModeDisabledForEmergencyCall: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.BackgroundNs.PhoneTriggerType.airplaneModeDisabledForEmergencyCall with Double = js.native
  /* 5 */ val callBlocked: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.BackgroundNs.PhoneTriggerType.callBlocked with Double = js.native
  /* 1 */ val callHistoryChanged: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.BackgroundNs.PhoneTriggerType.callHistoryChanged with Double = js.native
  /* 4 */ val callOriginDataRequest: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.BackgroundNs.PhoneTriggerType.callOriginDataRequest with Double = js.native
  /* 2 */ val lineChanged: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.BackgroundNs.PhoneTriggerType.lineChanged with Double = js.native
  /* 0 */ val newVoicemailMessage: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.BackgroundNs.PhoneTriggerType.newVoicemailMessage with Double = js.native
  @JSBracketAccess
