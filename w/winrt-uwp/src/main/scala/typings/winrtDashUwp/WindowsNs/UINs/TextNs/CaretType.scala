...
object CaretType extends js.Object {
  ...
  /* 0 */ val normal: typings.winrtDashUwp.WindowsNs.UINs.TextNs.CaretType.normal with Double = js.native
  /* 1 */ val `null`: typings.winrtDashUwp.WindowsNs.UINs.TextNs.CaretType.`null` with Double = js.native
  @JSBracketAccess
