...
object EmailMessageBodyKind extends js.Object {
  ...
  /* 0 */ val html: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMessageBodyKind.html with Double = js.native
  /* 1 */ val plainText: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMessageBodyKind.plainText with Double = js.native
  @JSBracketAccess
