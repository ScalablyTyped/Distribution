...
object PosPrinterPrintSide extends js.Object {
  ...
  /* 1 */ val side1: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterPrintSide.side1 with Double = js.native
  /* 2 */ val side2: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterPrintSide.side2 with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterPrintSide.unknown with Double = js.native
  @JSBracketAccess
