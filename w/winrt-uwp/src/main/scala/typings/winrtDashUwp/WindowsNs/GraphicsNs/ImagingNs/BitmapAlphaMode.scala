...
object BitmapAlphaMode extends js.Object {
  ...
  /* 2 */ val ignore: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.BitmapAlphaMode.ignore with Double = js.native
  /* 0 */ val premultiplied: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.BitmapAlphaMode.premultiplied with Double = js.native
  /* 1 */ val straight: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.BitmapAlphaMode.straight with Double = js.native
  @JSBracketAccess
