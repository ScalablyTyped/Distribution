...
object Print3DTaskCompletion extends js.Object {
  ...
  /* 0 */ val abandoned: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Print3DTaskCompletion.abandoned with Double = js.native
  /* 1 */ val canceled: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Print3DTaskCompletion.canceled with Double = js.native
  /* 2 */ val failed: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Print3DTaskCompletion.failed with Double = js.native
  /* 3 */ val slicing: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Print3DTaskCompletion.slicing with Double = js.native
  /* 4 */ val submitted: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Print3DTaskCompletion.submitted with Double = js.native
  @JSBracketAccess
