...
object DownloadsFolder extends js.Object {
  ...
  /**
    ...
    * @return When this method completes, it returns the new file as a StorageFile object.
    */
  def createFileAsync(desiredName: String, option: CreationCollisionOption): IPromiseWithIAsyncOperation[StorageFile] = js.native
  /**
    ...
    * @return When this method completes, it returns the new file as a StorageFile object.
    */
  def createFileForUserAsync(user: User, desiredName: String): IPromiseWithIAsyncOperation[StorageFile] = js.native
  /**
    ...
    * @return When this method completes, it returns the new file as a StorageFile object.
    */
  def createFileForUserAsync(user: User, desiredName: String, option: CreationCollisionOption): IPromiseWithIAsyncOperation[StorageFile] = js.native
  /**
  ...
  /**
    ...
    * @return When this method completes, it returns the new subfolder as a StorageFolder .
    */
  def createFolderAsync(desiredName: String, option: CreationCollisionOption): IPromiseWithIAsyncOperation[StorageFolder] = js.native
  /**
    ...
    * @return When this method completes, it returns the new subfolder as a StorageFolder .
    */
  def createFolderForUserAsync(user: User, desiredName: String): IPromiseWithIAsyncOperation[StorageFolder] = js.native
  /**
    ...
    * @return When this method completes, it returns the new subfolder as a StorageFolder .
    */
  def createFolderForUserAsync(user: User, desiredName: String, option: CreationCollisionOption): IPromiseWithIAsyncOperation[StorageFolder] = js.native
}
