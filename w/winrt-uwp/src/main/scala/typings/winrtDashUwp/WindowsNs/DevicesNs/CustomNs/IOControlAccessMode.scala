...
object IOControlAccessMode extends js.Object {
  ...
  /* 0 */ val any: typings.winrtDashUwp.WindowsNs.DevicesNs.CustomNs.IOControlAccessMode.any with Double = js.native
  /* 1 */ val read: typings.winrtDashUwp.WindowsNs.DevicesNs.CustomNs.IOControlAccessMode.read with Double = js.native
  /* 3 */ val readWrite: typings.winrtDashUwp.WindowsNs.DevicesNs.CustomNs.IOControlAccessMode.readWrite with Double = js.native
  /* 2 */ val write: typings.winrtDashUwp.WindowsNs.DevicesNs.CustomNs.IOControlAccessMode.write with Double = js.native
  @JSBracketAccess
