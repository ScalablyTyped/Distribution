...
object DayFormat extends js.Object {
  ...
  /* 1 */ val default: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.DayFormat.default with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.DayFormat.none with Double = js.native
  @JSBracketAccess
