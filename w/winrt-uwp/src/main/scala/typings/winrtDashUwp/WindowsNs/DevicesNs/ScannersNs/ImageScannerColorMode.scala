...
object ImageScannerColorMode extends js.Object {
  ...
  /* 3 */ val autoColor: typings.winrtDashUwp.WindowsNs.DevicesNs.ScannersNs.ImageScannerColorMode.autoColor with Double = js.native
  /* 0 */ val color: typings.winrtDashUwp.WindowsNs.DevicesNs.ScannersNs.ImageScannerColorMode.color with Double = js.native
  /* 1 */ val grayscale: typings.winrtDashUwp.WindowsNs.DevicesNs.ScannersNs.ImageScannerColorMode.grayscale with Double = js.native
  /* 2 */ val monochrome: typings.winrtDashUwp.WindowsNs.DevicesNs.ScannersNs.ImageScannerColorMode.monochrome with Double = js.native
  @JSBracketAccess
