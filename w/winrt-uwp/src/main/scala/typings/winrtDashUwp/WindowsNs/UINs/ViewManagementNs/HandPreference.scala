...
object HandPreference extends js.Object {
  ...
  /* 0 */ val leftHanded: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.HandPreference.leftHanded with Double = js.native
  /* 1 */ val rightHanded: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.HandPreference.rightHanded with Double = js.native
  @JSBracketAccess
