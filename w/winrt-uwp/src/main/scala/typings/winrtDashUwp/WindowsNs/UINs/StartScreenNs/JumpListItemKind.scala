...
object JumpListItemKind extends js.Object {
  ...
  /* 0 */ val arguments: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.JumpListItemKind.arguments with Double = js.native
  /* 1 */ val separator: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.JumpListItemKind.separator with Double = js.native
  @JSBracketAccess
