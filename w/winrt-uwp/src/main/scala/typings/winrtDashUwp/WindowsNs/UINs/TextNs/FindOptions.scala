...
object FindOptions extends js.Object {
  ...
  /* 2 */ val `case`: typings.winrtDashUwp.WindowsNs.UINs.TextNs.FindOptions.`case` with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.UINs.TextNs.FindOptions.none with Double = js.native
  /* 1 */ val word: typings.winrtDashUwp.WindowsNs.UINs.TextNs.FindOptions.word with Double = js.native
  @JSBracketAccess
