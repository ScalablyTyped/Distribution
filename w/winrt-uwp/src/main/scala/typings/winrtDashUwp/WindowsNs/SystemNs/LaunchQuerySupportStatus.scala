...
object LaunchQuerySupportStatus extends js.Object {
  ...
  /* 1 */ val appNotInstalled: typings.winrtDashUwp.WindowsNs.SystemNs.LaunchQuerySupportStatus.appNotInstalled with Double = js.native
  /* 2 */ val appUnavailable: typings.winrtDashUwp.WindowsNs.SystemNs.LaunchQuerySupportStatus.appUnavailable with Double = js.native
  /* 0 */ val available: typings.winrtDashUwp.WindowsNs.SystemNs.LaunchQuerySupportStatus.available with Double = js.native
  /* 3 */ val notSupported: typings.winrtDashUwp.WindowsNs.SystemNs.LaunchQuerySupportStatus.notSupported with Double = js.native
  /* 4 */ val unknown: typings.winrtDashUwp.WindowsNs.SystemNs.LaunchQuerySupportStatus.unknown with Double = js.native
  @JSBracketAccess
