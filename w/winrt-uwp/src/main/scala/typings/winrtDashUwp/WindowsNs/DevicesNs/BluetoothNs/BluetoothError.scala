...
object BluetoothError extends js.Object {
  ...
  /* 3 */ val deviceNotConnected: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.BluetoothError.deviceNotConnected with Double = js.native
  /* 5 */ val disabledByPolicy: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.BluetoothError.disabledByPolicy with Double = js.native
  /* 7 */ val disabledByUser: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.BluetoothError.disabledByUser with Double = js.native
  /* 6 */ val notSupported: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.BluetoothError.notSupported with Double = js.native
  /* 4 */ val otherError: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.BluetoothError.otherError with Double = js.native
  /* 1 */ val radioNotAvailable: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.BluetoothError.radioNotAvailable with Double = js.native
  /* 2 */ val resourceInUse: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.BluetoothError.resourceInUse with Double = js.native
  /* 0 */ val success: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.BluetoothError.success with Double = js.native
  @JSBracketAccess
