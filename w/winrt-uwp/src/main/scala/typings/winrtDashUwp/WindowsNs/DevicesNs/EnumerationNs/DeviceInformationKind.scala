...
object DeviceInformationKind extends js.Object {
  ...
  /* 5 */ val associationEndpoint: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceInformationKind.associationEndpoint with Double = js.native
  /* 6 */ val associationEndpointContainer: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceInformationKind.associationEndpointContainer with Double = js.native
  /* 7 */ val associationEndpointService: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceInformationKind.associationEndpointService with Double = js.native
  /* 3 */ val device: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceInformationKind.device with Double = js.native
  /* 2 */ val deviceContainer: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceInformationKind.deviceContainer with Double = js.native
  /* 1 */ val deviceInterface: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceInformationKind.deviceInterface with Double = js.native
  /* 4 */ val deviceInterfaceClass: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceInformationKind.deviceInterfaceClass with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceInformationKind.unknown with Double = js.native
  @JSBracketAccess
