...
object SetImageFeedResult extends js.Object {
  ...
  /* 1 */ val changeDisabled: typings.winrtDashUwp.WindowsNs.SystemNs.UserProfileNs.SetImageFeedResult.changeDisabled with Double = js.native
  /* 0 */ val success: typings.winrtDashUwp.WindowsNs.SystemNs.UserProfileNs.SetImageFeedResult.success with Double = js.native
  /* 2 */ val userCanceled: typings.winrtDashUwp.WindowsNs.SystemNs.UserProfileNs.SetImageFeedResult.userCanceled with Double = js.native
  @JSBracketAccess
