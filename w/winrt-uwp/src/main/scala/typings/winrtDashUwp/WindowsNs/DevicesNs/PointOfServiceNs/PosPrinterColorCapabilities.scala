...
object PosPrinterColorCapabilities extends js.Object {
  ...
  /* 2 */ val custom1: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.custom1 with Double = js.native
  /* 3 */ val custom2: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.custom2 with Double = js.native
  /* 4 */ val custom3: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.custom3 with Double = js.native
  /* 5 */ val custom4: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.custom4 with Double = js.native
  /* 6 */ val custom5: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.custom5 with Double = js.native
  /* 7 */ val custom6: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.custom6 with Double = js.native
  /* 8 */ val cyan: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.cyan with Double = js.native
  /* 11 */ val full: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.full with Double = js.native
  /* 9 */ val magenta: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.magenta with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.none with Double = js.native
  /* 1 */ val primary: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.primary with Double = js.native
  /* 10 */ val yellow: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterColorCapabilities.yellow with Double = js.native
  @JSBracketAccess
