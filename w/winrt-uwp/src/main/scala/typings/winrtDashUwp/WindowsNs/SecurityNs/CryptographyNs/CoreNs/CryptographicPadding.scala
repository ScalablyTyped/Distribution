...
object CryptographicPadding extends js.Object {
  ...
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.SecurityNs.CryptographyNs.CoreNs.CryptographicPadding.none with Double = js.native
  /* 1 */ val rsaOaep: typings.winrtDashUwp.WindowsNs.SecurityNs.CryptographyNs.CoreNs.CryptographicPadding.rsaOaep with Double = js.native
  /* 2 */ val rsaPkcs1V15: typings.winrtDashUwp.WindowsNs.SecurityNs.CryptographyNs.CoreNs.CryptographicPadding.rsaPkcs1V15 with Double = js.native
  /* 3 */ val rsaPss: typings.winrtDashUwp.WindowsNs.SecurityNs.CryptographyNs.CoreNs.CryptographicPadding.rsaPss with Double = js.native
  @JSBracketAccess
