...
object PosPrinterStatusKind extends js.Object {
  ...
  /* 4 */ val extended: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterStatusKind.extended with Double = js.native
  /* 1 */ val off: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterStatusKind.off with Double = js.native
  /* 3 */ val offOrOffline: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterStatusKind.offOrOffline with Double = js.native
  /* 2 */ val offline: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterStatusKind.offline with Double = js.native
  /* 0 */ val online: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterStatusKind.online with Double = js.native
  @JSBracketAccess
