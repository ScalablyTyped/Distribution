...
object SmsGeographicalScope extends js.Object {
  ...
  /* 4 */ val cell: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsGeographicalScope.cell with Double = js.native
  /* 1 */ val cellWithImmediateDisplay: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsGeographicalScope.cellWithImmediateDisplay with Double = js.native
  /* 2 */ val locationArea: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsGeographicalScope.locationArea with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsGeographicalScope.none with Double = js.native
  /* 3 */ val plmn: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsGeographicalScope.plmn with Double = js.native
  @JSBracketAccess
