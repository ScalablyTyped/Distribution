...
object BluetoothLEAdvertisementType extends js.Object {
  ...
  /* 1 */ val connectableDirected: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.AdvertisementNs.BluetoothLEAdvertisementType.connectableDirected with Double = js.native
  /* 0 */ val connectableUndirected: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.AdvertisementNs.BluetoothLEAdvertisementType.connectableUndirected with Double = js.native
  /* 3 */ val nonConnectableUndirected: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.AdvertisementNs.BluetoothLEAdvertisementType.nonConnectableUndirected with Double = js.native
  /* 4 */ val scanResponse: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.AdvertisementNs.BluetoothLEAdvertisementType.scanResponse with Double = js.native
  /* 2 */ val scannableUndirected: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.AdvertisementNs.BluetoothLEAdvertisementType.scannableUndirected with Double = js.native
  @JSBracketAccess
