...
import typings.winrtDashUwp.winrtDashUwpStrings.policychanged
import typings.winrtDashUwp.winrtDashUwpStrings.protectedaccessresumed
import typings.winrtDashUwp.winrtDashUwpStrings.protectedaccesssuspending
import typings.winrtDashUwp.winrtDashUwpStrings.protectedcontentrevoked
...
object ProtectionPolicyManager extends js.Object {
  ...
  /**
    ...
    */
  def createCurrentThreadNetworkContext(identity: String): ThreadNetworkContext = js.native
  /**
  ...
  /**
    ...
    */
  def getForCurrentView(): ProtectionPolicyManager = js.native
  /**
