...
object SyndicationFormat extends js.Object {
  ...
  /* 5 */ val atom03: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationFormat.atom03 with Double = js.native
  /* 0 */ val atom10: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationFormat.atom10 with Double = js.native
  /* 4 */ val rss091: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationFormat.rss091 with Double = js.native
  /* 3 */ val rss092: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationFormat.rss092 with Double = js.native
  /* 2 */ val rss10: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationFormat.rss10 with Double = js.native
  /* 1 */ val rss20: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationFormat.rss20 with Double = js.native
  @JSBracketAccess
