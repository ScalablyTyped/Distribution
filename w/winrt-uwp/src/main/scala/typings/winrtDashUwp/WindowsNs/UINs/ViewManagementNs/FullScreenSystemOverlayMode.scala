...
object FullScreenSystemOverlayMode extends js.Object {
  ...
  /* 1 */ val minimal: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.FullScreenSystemOverlayMode.minimal with Double = js.native
  /* 0 */ val standard: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.FullScreenSystemOverlayMode.standard with Double = js.native
  @JSBracketAccess
