...
object DeviceWatcherStatus extends js.Object {
  ...
  /* 5 */ val aborted: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceWatcherStatus.aborted with Double = js.native
  /* 0 */ val created: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceWatcherStatus.created with Double = js.native
  /* 2 */ val enumerationCompleted: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceWatcherStatus.enumerationCompleted with Double = js.native
  /* 1 */ val started: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceWatcherStatus.started with Double = js.native
  /* 4 */ val stopped: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceWatcherStatus.stopped with Double = js.native
  /* 3 */ val stopping: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceWatcherStatus.stopping with Double = js.native
  @JSBracketAccess
