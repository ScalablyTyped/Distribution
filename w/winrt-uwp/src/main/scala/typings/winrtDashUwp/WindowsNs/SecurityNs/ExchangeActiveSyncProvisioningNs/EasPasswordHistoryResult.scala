...
object EasPasswordHistoryResult extends js.Object {
  ...
  /* 2 */ val canBeCompliant: typings.winrtDashUwp.WindowsNs.SecurityNs.ExchangeActiveSyncProvisioningNs.EasPasswordHistoryResult.canBeCompliant with Double = js.native
  /* 1 */ val compliant: typings.winrtDashUwp.WindowsNs.SecurityNs.ExchangeActiveSyncProvisioningNs.EasPasswordHistoryResult.compliant with Double = js.native
  /* 4 */ val invalidParameter: typings.winrtDashUwp.WindowsNs.SecurityNs.ExchangeActiveSyncProvisioningNs.EasPasswordHistoryResult.invalidParameter with Double = js.native
  /* 0 */ val notEvaluated: typings.winrtDashUwp.WindowsNs.SecurityNs.ExchangeActiveSyncProvisioningNs.EasPasswordHistoryResult.notEvaluated with Double = js.native
  /* 3 */ val requestedPolicyIsStricter: typings.winrtDashUwp.WindowsNs.SecurityNs.ExchangeActiveSyncProvisioningNs.EasPasswordHistoryResult.requestedPolicyIsStricter with Double = js.native
  @JSBracketAccess
