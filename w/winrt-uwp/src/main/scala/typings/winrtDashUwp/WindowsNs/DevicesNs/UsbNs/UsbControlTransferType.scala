...
object UsbControlTransferType extends js.Object {
  ...
  /* 1 */ val `class`: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbControlTransferType.`class` with Double = js.native
  /* 0 */ val standard: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbControlTransferType.standard with Double = js.native
  /* 2 */ val vendor: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbControlTransferType.vendor with Double = js.native
  @JSBracketAccess
