...
object SpeechRecognitionAudioProblem extends js.Object {
  ...
  /* 2 */ val noSignal: typings.winrtDashUwp.WindowsNs.MediaNs.SpeechRecognitionNs.SpeechRecognitionAudioProblem.noSignal with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.MediaNs.SpeechRecognitionNs.SpeechRecognitionAudioProblem.none with Double = js.native
  /* 5 */ val tooFast: typings.winrtDashUwp.WindowsNs.MediaNs.SpeechRecognitionNs.SpeechRecognitionAudioProblem.tooFast with Double = js.native
  /* 3 */ val tooLoud: typings.winrtDashUwp.WindowsNs.MediaNs.SpeechRecognitionNs.SpeechRecognitionAudioProblem.tooLoud with Double = js.native
  /* 1 */ val tooNoisy: typings.winrtDashUwp.WindowsNs.MediaNs.SpeechRecognitionNs.SpeechRecognitionAudioProblem.tooNoisy with Double = js.native
  /* 4 */ val tooQuiet: typings.winrtDashUwp.WindowsNs.MediaNs.SpeechRecognitionNs.SpeechRecognitionAudioProblem.tooQuiet with Double = js.native
  /* 6 */ val tooSlow: typings.winrtDashUwp.WindowsNs.MediaNs.SpeechRecognitionNs.SpeechRecognitionAudioProblem.tooSlow with Double = js.native
  @JSBracketAccess
