...
object MediaProcessingTriggerResult extends js.Object {
  ...
  /* 0 */ val allowed: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.MediaProcessingTriggerResult.allowed with Double = js.native
  /* 1 */ val currentlyRunning: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.MediaProcessingTriggerResult.currentlyRunning with Double = js.native
  /* 2 */ val disabledByPolicy: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.MediaProcessingTriggerResult.disabledByPolicy with Double = js.native
  /* 3 */ val unknownError: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.MediaProcessingTriggerResult.unknownError with Double = js.native
  @JSBracketAccess
