...
object UsbEndpointType extends js.Object {
  ...
  /* 2 */ val bulk: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbEndpointType.bulk with Double = js.native
  /* 0 */ val control: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbEndpointType.control with Double = js.native
  /* 3 */ val interrupt: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbEndpointType.interrupt with Double = js.native
  /* 1 */ val isochronous: typings.winrtDashUwp.WindowsNs.DevicesNs.UsbNs.UsbEndpointType.isochronous with Double = js.native
  @JSBracketAccess
