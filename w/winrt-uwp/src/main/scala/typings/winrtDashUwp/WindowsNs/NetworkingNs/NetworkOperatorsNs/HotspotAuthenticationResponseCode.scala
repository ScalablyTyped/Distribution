...
object HotspotAuthenticationResponseCode extends js.Object {
  ...
  /* 6 */ val accessGatewayInternalError: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.HotspotAuthenticationResponseCode.accessGatewayInternalError with Double = js.native
  /* 5 */ val loginAborted: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.HotspotAuthenticationResponseCode.loginAborted with Double = js.native
  /* 2 */ val loginFailed: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.HotspotAuthenticationResponseCode.loginFailed with Double = js.native
  /* 1 */ val loginSucceeded: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.HotspotAuthenticationResponseCode.loginSucceeded with Double = js.native
  /* 4 */ val networkAdministratorError: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.HotspotAuthenticationResponseCode.networkAdministratorError with Double = js.native
  /* 0 */ val noError: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.HotspotAuthenticationResponseCode.noError with Double = js.native
  /* 3 */ val radiusServerError: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.HotspotAuthenticationResponseCode.radiusServerError with Double = js.native
  @JSBracketAccess
