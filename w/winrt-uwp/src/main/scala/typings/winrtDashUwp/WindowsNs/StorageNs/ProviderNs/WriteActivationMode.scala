...
object WriteActivationMode extends js.Object {
  ...
  /* 2 */ val afterWrite: typings.winrtDashUwp.WindowsNs.StorageNs.ProviderNs.WriteActivationMode.afterWrite with Double = js.native
  /* 1 */ val notNeeded: typings.winrtDashUwp.WindowsNs.StorageNs.ProviderNs.WriteActivationMode.notNeeded with Double = js.native
  /* 0 */ val readOnly: typings.winrtDashUwp.WindowsNs.StorageNs.ProviderNs.WriteActivationMode.readOnly with Double = js.native
  @JSBracketAccess
