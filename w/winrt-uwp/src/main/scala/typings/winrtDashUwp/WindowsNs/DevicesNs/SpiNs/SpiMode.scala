...
object SpiMode extends js.Object {
  ...
  /* 0 */ val mode0: typings.winrtDashUwp.WindowsNs.DevicesNs.SpiNs.SpiMode.mode0 with Double = js.native
  /* 1 */ val mode1: typings.winrtDashUwp.WindowsNs.DevicesNs.SpiNs.SpiMode.mode1 with Double = js.native
  /* 2 */ val mode2: typings.winrtDashUwp.WindowsNs.DevicesNs.SpiNs.SpiMode.mode2 with Double = js.native
  /* 3 */ val mode3: typings.winrtDashUwp.WindowsNs.DevicesNs.SpiNs.SpiMode.mode3 with Double = js.native
  @JSBracketAccess
