...
object AudioBufferAccessMode extends js.Object {
  ...
  /* 0 */ val read: typings.winrtDashUwp.WindowsNs.MediaNs.AudioBufferAccessMode.read with Double = js.native
  /* 1 */ val readWrite: typings.winrtDashUwp.WindowsNs.MediaNs.AudioBufferAccessMode.readWrite with Double = js.native
  /* 2 */ val write: typings.winrtDashUwp.WindowsNs.MediaNs.AudioBufferAccessMode.write with Double = js.native
  @JSBracketAccess
