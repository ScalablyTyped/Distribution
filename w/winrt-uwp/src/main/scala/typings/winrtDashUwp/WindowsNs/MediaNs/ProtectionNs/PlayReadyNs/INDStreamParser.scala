...
import typings.winrtDashUwp.Anon_ReturnValueStreamType
import typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.IMediaStreamDescriptor
...
trait INDStreamParser extends js.Object {
  ...
  /**
    ...
    */
  def getStreamInformation(descriptor: IMediaStreamDescriptor): Anon_ReturnValueStreamType
  /**
...
object INDStreamParser {
  ...
  def apply(
    beginOfStream: () => Unit,
    endOfStream: () => Unit,
    getStreamInformation: IMediaStreamDescriptor => Anon_ReturnValueStreamType,
