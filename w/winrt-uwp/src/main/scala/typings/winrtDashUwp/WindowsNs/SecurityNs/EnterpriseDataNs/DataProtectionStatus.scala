...
object DataProtectionStatus extends js.Object {
  ...
  /* 5 */ val accessSuspended: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.DataProtectionStatus.accessSuspended with Double = js.native
  /* 4 */ val licenseExpired: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.DataProtectionStatus.licenseExpired with Double = js.native
  /* 1 */ val `protected`: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.DataProtectionStatus.`protected` with Double = js.native
  /* 0 */ val protectedToOtherIdentity: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.DataProtectionStatus.protectedToOtherIdentity with Double = js.native
  /* 2 */ val revoked: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.DataProtectionStatus.revoked with Double = js.native
  /* 3 */ val unprotected: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.DataProtectionStatus.unprotected with Double = js.native
  @JSBracketAccess
