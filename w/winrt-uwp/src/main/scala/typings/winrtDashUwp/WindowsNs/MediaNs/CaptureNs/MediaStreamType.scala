...
object MediaStreamType extends js.Object {
  ...
  /* 2 */ val audio: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.MediaStreamType.audio with Double = js.native
  /* 3 */ val photo: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.MediaStreamType.photo with Double = js.native
  /* 0 */ val videoPreview: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.MediaStreamType.videoPreview with Double = js.native
  /* 1 */ val videoRecord: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.MediaStreamType.videoRecord with Double = js.native
  @JSBracketAccess
