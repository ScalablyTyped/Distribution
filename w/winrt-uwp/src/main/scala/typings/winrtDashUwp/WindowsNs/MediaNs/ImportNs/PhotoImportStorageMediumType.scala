...
object PhotoImportStorageMediumType extends js.Object {
  ...
  /* 1 */ val fixed: typings.winrtDashUwp.WindowsNs.MediaNs.ImportNs.PhotoImportStorageMediumType.fixed with Double = js.native
  /* 2 */ val removable: typings.winrtDashUwp.WindowsNs.MediaNs.ImportNs.PhotoImportStorageMediumType.removable with Double = js.native
  /* 0 */ val undefined: typings.winrtDashUwp.WindowsNs.MediaNs.ImportNs.PhotoImportStorageMediumType.undefined with Double = js.native
  @JSBracketAccess
