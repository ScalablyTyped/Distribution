...
object DialAppState extends js.Object {
  ...
  /* 3 */ val networkFailure: typings.winrtDashUwp.WindowsNs.MediaNs.DialProtocolNs.DialAppState.networkFailure with Double = js.native
  /* 2 */ val running: typings.winrtDashUwp.WindowsNs.MediaNs.DialProtocolNs.DialAppState.running with Double = js.native
  /* 1 */ val stopped: typings.winrtDashUwp.WindowsNs.MediaNs.DialProtocolNs.DialAppState.stopped with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.WindowsNs.MediaNs.DialProtocolNs.DialAppState.unknown with Double = js.native
  @JSBracketAccess
