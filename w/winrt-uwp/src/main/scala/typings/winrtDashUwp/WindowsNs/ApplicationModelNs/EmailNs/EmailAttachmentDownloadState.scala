...
object EmailAttachmentDownloadState extends js.Object {
  ...
  /* 2 */ val downloaded: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailAttachmentDownloadState.downloaded with Double = js.native
  /* 1 */ val downloading: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailAttachmentDownloadState.downloading with Double = js.native
  /* 3 */ val failed: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailAttachmentDownloadState.failed with Double = js.native
  /* 0 */ val notDownloaded: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailAttachmentDownloadState.notDownloaded with Double = js.native
  @JSBracketAccess
