...
object ContactListOtherAppReadAccess extends js.Object {
  ...
  /* 2 */ val full: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactListOtherAppReadAccess.full with Double = js.native
  /* 1 */ val limited: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactListOtherAppReadAccess.limited with Double = js.native
  /* 0 */ val systemOnly: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactListOtherAppReadAccess.systemOnly with Double = js.native
  @JSBracketAccess
