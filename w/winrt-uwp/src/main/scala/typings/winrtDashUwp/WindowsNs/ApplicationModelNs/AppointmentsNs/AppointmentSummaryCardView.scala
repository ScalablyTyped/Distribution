...
object AppointmentSummaryCardView extends js.Object {
  ...
  /* 1 */ val app: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppointmentsNs.AppointmentSummaryCardView.app with Double = js.native
  /* 0 */ val system: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppointmentsNs.AppointmentSummaryCardView.system with Double = js.native
  @JSBracketAccess
