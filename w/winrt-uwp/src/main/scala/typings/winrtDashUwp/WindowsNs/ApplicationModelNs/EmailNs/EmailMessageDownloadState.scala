...
object EmailMessageDownloadState extends js.Object {
  ...
  /* 2 */ val downloaded: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMessageDownloadState.downloaded with Double = js.native
  /* 1 */ val downloading: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMessageDownloadState.downloading with Double = js.native
  /* 3 */ val failed: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMessageDownloadState.failed with Double = js.native
  /* 0 */ val partiallyDownloaded: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMessageDownloadState.partiallyDownloaded with Double = js.native
  @JSBracketAccess
