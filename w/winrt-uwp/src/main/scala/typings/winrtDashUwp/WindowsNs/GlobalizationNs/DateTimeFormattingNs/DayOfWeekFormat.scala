...
object DayOfWeekFormat extends js.Object {
  ...
  /* 2 */ val abbreviated: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.DayOfWeekFormat.abbreviated with Double = js.native
  /* 1 */ val default: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.DayOfWeekFormat.default with Double = js.native
  /* 3 */ val full: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.DayOfWeekFormat.full with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.DayOfWeekFormat.none with Double = js.native
  @JSBracketAccess
