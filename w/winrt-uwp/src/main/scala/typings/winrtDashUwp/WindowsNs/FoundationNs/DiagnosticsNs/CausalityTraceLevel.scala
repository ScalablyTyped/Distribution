...
object CausalityTraceLevel extends js.Object {
  ...
  /* 1 */ val important: typings.winrtDashUwp.WindowsNs.FoundationNs.DiagnosticsNs.CausalityTraceLevel.important with Double = js.native
  /* 0 */ val required: typings.winrtDashUwp.WindowsNs.FoundationNs.DiagnosticsNs.CausalityTraceLevel.required with Double = js.native
  /* 2 */ val verbose: typings.winrtDashUwp.WindowsNs.FoundationNs.DiagnosticsNs.CausalityTraceLevel.verbose with Double = js.native
  @JSBracketAccess
