...
object TimedTextUnit extends js.Object {
  ...
  /* 1 */ val percentage: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.TimedTextUnit.percentage with Double = js.native
  /* 0 */ val pixels: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.TimedTextUnit.pixels with Double = js.native
  @JSBracketAccess
