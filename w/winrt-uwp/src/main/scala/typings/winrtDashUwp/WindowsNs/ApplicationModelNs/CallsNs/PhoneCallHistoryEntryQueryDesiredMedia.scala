...
object PhoneCallHistoryEntryQueryDesiredMedia extends js.Object {
  ...
  /* 3 */ val all: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.PhoneCallHistoryEntryQueryDesiredMedia.all with Double = js.native
  /* 1 */ val audio: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.PhoneCallHistoryEntryQueryDesiredMedia.audio with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.PhoneCallHistoryEntryQueryDesiredMedia.none with Double = js.native
  /* 2 */ val video: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.PhoneCallHistoryEntryQueryDesiredMedia.video with Double = js.native
  @JSBracketAccess
