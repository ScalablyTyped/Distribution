...
object DeviceAccessStatus extends js.Object {
  ...
  /* 1 */ val allowed: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceAccessStatus.allowed with Double = js.native
  /* 3 */ val deniedBySystem: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceAccessStatus.deniedBySystem with Double = js.native
  /* 2 */ val deniedByUser: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceAccessStatus.deniedByUser with Double = js.native
  /* 0 */ val unspecified: typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DeviceAccessStatus.unspecified with Double = js.native
  @JSBracketAccess
