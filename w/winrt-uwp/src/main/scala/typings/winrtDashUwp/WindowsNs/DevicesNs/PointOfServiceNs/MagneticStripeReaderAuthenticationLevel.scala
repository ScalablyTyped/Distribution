...
object MagneticStripeReaderAuthenticationLevel extends js.Object {
  ...
  /* 0 */ val notSupported: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.MagneticStripeReaderAuthenticationLevel.notSupported with Double = js.native
  /* 1 */ val optional: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.MagneticStripeReaderAuthenticationLevel.optional with Double = js.native
  /* 2 */ val required: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.MagneticStripeReaderAuthenticationLevel.required with Double = js.native
  @JSBracketAccess
