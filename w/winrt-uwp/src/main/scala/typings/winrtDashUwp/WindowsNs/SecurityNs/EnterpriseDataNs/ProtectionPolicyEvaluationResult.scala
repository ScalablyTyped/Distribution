...
object ProtectionPolicyEvaluationResult extends js.Object {
  ...
  /* 0 */ val allowed: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.ProtectionPolicyEvaluationResult.allowed with Double = js.native
  /* 1 */ val blocked: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.ProtectionPolicyEvaluationResult.blocked with Double = js.native
  /* 2 */ val consentRequired: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.ProtectionPolicyEvaluationResult.consentRequired with Double = js.native
  @JSBracketAccess
