...
object AlternateNormalizationFormat extends js.Object {
  ...
  /* 2 */ val currency: typings.winrtDashUwp.WindowsNs.DataNs.TextNs.AlternateNormalizationFormat.currency with Double = js.native
  /* 3 */ val date: typings.winrtDashUwp.WindowsNs.DataNs.TextNs.AlternateNormalizationFormat.date with Double = js.native
  /* 0 */ val notNormalized: typings.winrtDashUwp.WindowsNs.DataNs.TextNs.AlternateNormalizationFormat.notNormalized with Double = js.native
  /* 1 */ val number: typings.winrtDashUwp.WindowsNs.DataNs.TextNs.AlternateNormalizationFormat.number with Double = js.native
  /* 4 */ val time: typings.winrtDashUwp.WindowsNs.DataNs.TextNs.AlternateNormalizationFormat.time with Double = js.native
  @JSBracketAccess
