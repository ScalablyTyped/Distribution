...
object ColorManagementMode extends js.Object {
  ...
  /* 1 */ val colorManageToSRgb: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.ColorManagementMode.colorManageToSRgb with Double = js.native
  /* 0 */ val doNotColorManage: typings.winrtDashUwp.WindowsNs.GraphicsNs.ImagingNs.ColorManagementMode.doNotColorManage with Double = js.native
  @JSBracketAccess
