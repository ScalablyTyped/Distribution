...
object Printing3DModelUnit extends js.Object {
  ...
  /* 3 */ val centimeter: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DModelUnit.centimeter with Double = js.native
  /* 5 */ val foot: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DModelUnit.foot with Double = js.native
  /* 4 */ val inch: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DModelUnit.inch with Double = js.native
  /* 0 */ val meter: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DModelUnit.meter with Double = js.native
  /* 1 */ val micron: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DModelUnit.micron with Double = js.native
  /* 2 */ val millimeter: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DModelUnit.millimeter with Double = js.native
  @JSBracketAccess
