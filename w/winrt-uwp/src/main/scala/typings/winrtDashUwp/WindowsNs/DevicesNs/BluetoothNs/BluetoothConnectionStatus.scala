...
object BluetoothConnectionStatus extends js.Object {
  ...
  /* 1 */ val connected: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.BluetoothConnectionStatus.connected with Double = js.native
  /* 0 */ val disconnected: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.BluetoothConnectionStatus.disconnected with Double = js.native
  @JSBracketAccess
