...
object VpnDataPathType extends js.Object {
  ...
  /* 1 */ val receive: typings.winrtDashUwp.WindowsNs.NetworkingNs.VpnNs.VpnDataPathType.receive with Double = js.native
  /* 0 */ val send: typings.winrtDashUwp.WindowsNs.NetworkingNs.VpnNs.VpnDataPathType.send with Double = js.native
  @JSBracketAccess
