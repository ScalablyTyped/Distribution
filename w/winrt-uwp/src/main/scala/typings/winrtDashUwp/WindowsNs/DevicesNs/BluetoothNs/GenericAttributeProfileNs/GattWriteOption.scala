...
object GattWriteOption extends js.Object {
  ...
  /* 0 */ val writeWithResponse: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.GenericAttributeProfileNs.GattWriteOption.writeWithResponse with Double = js.native
  /* 1 */ val writeWithoutResponse: typings.winrtDashUwp.WindowsNs.DevicesNs.BluetoothNs.GenericAttributeProfileNs.GattWriteOption.writeWithoutResponse with Double = js.native
  @JSBracketAccess
