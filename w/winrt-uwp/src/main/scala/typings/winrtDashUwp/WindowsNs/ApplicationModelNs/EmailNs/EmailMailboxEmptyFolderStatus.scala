...
object EmailMailboxEmptyFolderStatus extends js.Object {
  ...
  /* 5 */ val couldNotDeleteEverything: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxEmptyFolderStatus.couldNotDeleteEverything with Double = js.native
  /* 1 */ val networkError: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxEmptyFolderStatus.networkError with Double = js.native
  /* 2 */ val permissionsError: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxEmptyFolderStatus.permissionsError with Double = js.native
  /* 3 */ val serverError: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxEmptyFolderStatus.serverError with Double = js.native
  /* 0 */ val success: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxEmptyFolderStatus.success with Double = js.native
  /* 4 */ val unknownFailure: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailMailboxEmptyFolderStatus.unknownFailure with Double = js.native
  @JSBracketAccess
