...
object SecondFormat extends js.Object {
  ...
  /* 1 */ val default: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.SecondFormat.default with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.SecondFormat.none with Double = js.native
  @JSBracketAccess
