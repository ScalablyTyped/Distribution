...
object BarcodeSymbologies extends js.Object {
  ...
  var gs1128: Double = js.native
  /** Gets the GS1 128 Coupon barcode symbology. */
  var gs1128Coupon: Double = js.native
