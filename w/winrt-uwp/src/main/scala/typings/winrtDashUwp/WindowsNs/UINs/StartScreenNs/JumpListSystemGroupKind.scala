...
object JumpListSystemGroupKind extends js.Object {
  ...
  /* 1 */ val frequent: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.JumpListSystemGroupKind.frequent with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.JumpListSystemGroupKind.none with Double = js.native
  /* 2 */ val recent: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.JumpListSystemGroupKind.recent with Double = js.native
  @JSBracketAccess
