...
object WiFiDirectServiceIPProtocol extends js.Object {
  ...
  /* 0 */ val tcp: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.ServicesNs.WiFiDirectServiceIPProtocol.tcp with Double = js.native
  /* 1 */ val udp: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.ServicesNs.WiFiDirectServiceIPProtocol.udp with Double = js.native
  @JSBracketAccess
