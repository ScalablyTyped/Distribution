...
object XboxLiveEndpointPairCreationBehaviors extends js.Object {
  ...
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.NetworkingNs.XboxLiveNs.XboxLiveEndpointPairCreationBehaviors.none with Double = js.native
  /* 1 */ val reevaluatePath: typings.winrtDashUwp.WindowsNs.NetworkingNs.XboxLiveNs.XboxLiveEndpointPairCreationBehaviors.reevaluatePath with Double = js.native
  @JSBracketAccess
