...
object MediaStreamSourceErrorStatus extends js.Object {
  ...
  /* 4 */ val connectionToServerLost: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaStreamSourceErrorStatus.connectionToServerLost with Double = js.native
  /* 6 */ val decodeError: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaStreamSourceErrorStatus.decodeError with Double = js.native
  /* 3 */ val failedToConnectToServer: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaStreamSourceErrorStatus.failedToConnectToServer with Double = js.native
  /* 2 */ val failedToOpenFile: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaStreamSourceErrorStatus.failedToOpenFile with Double = js.native
  /* 0 */ val other: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaStreamSourceErrorStatus.other with Double = js.native
  /* 1 */ val outOfMemory: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaStreamSourceErrorStatus.outOfMemory with Double = js.native
  /* 5 */ val unspecifiedNetworkError: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaStreamSourceErrorStatus.unspecifiedNetworkError with Double = js.native
  /* 7 */ val unsupportedMediaFormat: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaStreamSourceErrorStatus.unsupportedMediaFormat with Double = js.native
  @JSBracketAccess
