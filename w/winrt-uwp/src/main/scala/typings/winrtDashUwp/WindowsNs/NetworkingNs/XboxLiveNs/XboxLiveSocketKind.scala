...
object XboxLiveSocketKind extends js.Object {
  ...
  /* 1 */ val datagram: typings.winrtDashUwp.WindowsNs.NetworkingNs.XboxLiveNs.XboxLiveSocketKind.datagram with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.NetworkingNs.XboxLiveNs.XboxLiveSocketKind.none with Double = js.native
  /* 2 */ val stream: typings.winrtDashUwp.WindowsNs.NetworkingNs.XboxLiveNs.XboxLiveSocketKind.stream with Double = js.native
  @JSBracketAccess
