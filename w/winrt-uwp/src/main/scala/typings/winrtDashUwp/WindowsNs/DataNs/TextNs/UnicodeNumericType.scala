...
object UnicodeNumericType extends js.Object {
  ...
  /* 1 */ val decimal: typings.winrtDashUwp.WindowsNs.DataNs.TextNs.UnicodeNumericType.decimal with Double = js.native
  /* 2 */ val digit: typings.winrtDashUwp.WindowsNs.DataNs.TextNs.UnicodeNumericType.digit with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.DataNs.TextNs.UnicodeNumericType.none with Double = js.native
  /* 3 */ val numeric: typings.winrtDashUwp.WindowsNs.DataNs.TextNs.UnicodeNumericType.numeric with Double = js.native
  @JSBracketAccess
