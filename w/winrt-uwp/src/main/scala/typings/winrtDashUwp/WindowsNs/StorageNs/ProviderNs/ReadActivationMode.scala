...
object ReadActivationMode extends js.Object {
  ...
  /* 1 */ val beforeAccess: typings.winrtDashUwp.WindowsNs.StorageNs.ProviderNs.ReadActivationMode.beforeAccess with Double = js.native
  /* 0 */ val notNeeded: typings.winrtDashUwp.WindowsNs.StorageNs.ProviderNs.ReadActivationMode.notNeeded with Double = js.native
  @JSBracketAccess
