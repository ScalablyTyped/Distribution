...
object CameraCaptureUIPhotoFormat extends js.Object {
  ...
  /* 0 */ val jpeg: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.CameraCaptureUIPhotoFormat.jpeg with Double = js.native
  /* 2 */ val jpegXR: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.CameraCaptureUIPhotoFormat.jpegXR with Double = js.native
  /* 1 */ val png: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.CameraCaptureUIPhotoFormat.png with Double = js.native
  @JSBracketAccess
