...
object PositionAccuracy extends js.Object {
  ...
  /* 0 */ val default: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.PositionAccuracy.default with Double = js.native
  /* 1 */ val high: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.PositionAccuracy.high with Double = js.native
  @JSBracketAccess
