...
object NetworkCostType extends js.Object {
  ...
  /* 2 */ val fixed: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkCostType.fixed with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkCostType.unknown with Double = js.native
  /* 1 */ val unrestricted: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkCostType.unrestricted with Double = js.native
  /* 3 */ val variable: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.NetworkCostType.variable with Double = js.native
  @JSBracketAccess
