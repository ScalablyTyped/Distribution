...
object UiccAppRecordKind extends js.Object {
  ...
  /* 2 */ val recordOriented: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.UiccAppRecordKind.recordOriented with Double = js.native
  /* 1 */ val transparent: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.UiccAppRecordKind.transparent with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.UiccAppRecordKind.unknown with Double = js.native
  @JSBracketAccess
