...
object UnifiedPosPowerReportingType extends js.Object {
  ...
  /* 2 */ val advanced: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.UnifiedPosPowerReportingType.advanced with Double = js.native
  /* 1 */ val standard: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.UnifiedPosPowerReportingType.standard with Double = js.native
  /* 0 */ val unknownPowerReportingType: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.UnifiedPosPowerReportingType.unknownPowerReportingType with Double = js.native
  @JSBracketAccess
