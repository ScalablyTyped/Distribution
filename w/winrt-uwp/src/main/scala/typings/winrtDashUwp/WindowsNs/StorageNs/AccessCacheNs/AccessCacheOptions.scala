...
object AccessCacheOptions extends js.Object {
  ...
  /* 1 */ val disallowUserInput: typings.winrtDashUwp.WindowsNs.StorageNs.AccessCacheNs.AccessCacheOptions.disallowUserInput with Double = js.native
  /* 2 */ val fastLocationsOnly: typings.winrtDashUwp.WindowsNs.StorageNs.AccessCacheNs.AccessCacheOptions.fastLocationsOnly with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.StorageNs.AccessCacheNs.AccessCacheOptions.none with Double = js.native
  /* 4 */ val suppressAccessTimeUpdate: typings.winrtDashUwp.WindowsNs.StorageNs.AccessCacheNs.AccessCacheOptions.suppressAccessTimeUpdate with Double = js.native
  /* 3 */ val useReadOnlyCachedCopy: typings.winrtDashUwp.WindowsNs.StorageNs.AccessCacheNs.AccessCacheOptions.useReadOnlyCachedCopy with Double = js.native
  @JSBracketAccess
