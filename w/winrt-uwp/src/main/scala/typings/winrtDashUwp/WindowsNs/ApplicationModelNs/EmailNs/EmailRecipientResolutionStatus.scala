...
object EmailRecipientResolutionStatus extends js.Object {
  ...
  /* 2 */ val ambiguousRecipient: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailRecipientResolutionStatus.ambiguousRecipient with Double = js.native
  /* 5 */ val cannotResolveDistributionList: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailRecipientResolutionStatus.cannotResolveDistributionList with Double = js.native
  /* 4 */ val certificateRequestLimitReached: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailRecipientResolutionStatus.certificateRequestLimitReached with Double = js.native
  /* 3 */ val noCertificate: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailRecipientResolutionStatus.noCertificate with Double = js.native
  /* 1 */ val recipientNotFound: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailRecipientResolutionStatus.recipientNotFound with Double = js.native
  /* 6 */ val serverError: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailRecipientResolutionStatus.serverError with Double = js.native
  /* 0 */ val success: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailRecipientResolutionStatus.success with Double = js.native
  /* 7 */ val unknownFailure: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.EmailNs.EmailRecipientResolutionStatus.unknownFailure with Double = js.native
  @JSBracketAccess
