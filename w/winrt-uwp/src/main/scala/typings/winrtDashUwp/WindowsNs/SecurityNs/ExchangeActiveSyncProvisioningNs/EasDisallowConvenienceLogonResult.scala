...
object EasDisallowConvenienceLogonResult extends js.Object {
  ...
  /* 2 */ val canBeCompliant: typings.winrtDashUwp.WindowsNs.SecurityNs.ExchangeActiveSyncProvisioningNs.EasDisallowConvenienceLogonResult.canBeCompliant with Double = js.native
  /* 1 */ val compliant: typings.winrtDashUwp.WindowsNs.SecurityNs.ExchangeActiveSyncProvisioningNs.EasDisallowConvenienceLogonResult.compliant with Double = js.native
  /* 0 */ val notEvaluated: typings.winrtDashUwp.WindowsNs.SecurityNs.ExchangeActiveSyncProvisioningNs.EasDisallowConvenienceLogonResult.notEvaluated with Double = js.native
  /* 3 */ val requestedPolicyIsStricter: typings.winrtDashUwp.WindowsNs.SecurityNs.ExchangeActiveSyncProvisioningNs.EasDisallowConvenienceLogonResult.requestedPolicyIsStricter with Double = js.native
  @JSBracketAccess
