...
object StorageDeleteOption extends js.Object {
  ...
  /* 0 */ val default: typings.winrtDashUwp.WindowsNs.StorageNs.StorageDeleteOption.default with Double = js.native
  /* 1 */ val permanentDelete: typings.winrtDashUwp.WindowsNs.StorageNs.StorageDeleteOption.permanentDelete with Double = js.native
  @JSBracketAccess
