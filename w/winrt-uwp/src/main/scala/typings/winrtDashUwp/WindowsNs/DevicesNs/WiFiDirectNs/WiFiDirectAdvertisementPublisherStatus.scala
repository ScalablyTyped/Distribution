...
object WiFiDirectAdvertisementPublisherStatus extends js.Object {
  ...
  /* 3 */ val aborted: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.WiFiDirectAdvertisementPublisherStatus.aborted with Double = js.native
  /* 0 */ val created: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.WiFiDirectAdvertisementPublisherStatus.created with Double = js.native
  /* 1 */ val started: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.WiFiDirectAdvertisementPublisherStatus.started with Double = js.native
  /* 2 */ val stopped: typings.winrtDashUwp.WindowsNs.DevicesNs.WiFiDirectNs.WiFiDirectAdvertisementPublisherStatus.stopped with Double = js.native
  @JSBracketAccess
