...
object WebAuthenticationOptions extends js.Object {
  ...
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.SecurityNs.AuthenticationNs.WebNs.WebAuthenticationOptions.none with Double = js.native
  /* 1 */ val silentMode: typings.winrtDashUwp.WindowsNs.SecurityNs.AuthenticationNs.WebNs.WebAuthenticationOptions.silentMode with Double = js.native
  /* 4 */ val useCorporateNetwork: typings.winrtDashUwp.WindowsNs.SecurityNs.AuthenticationNs.WebNs.WebAuthenticationOptions.useCorporateNetwork with Double = js.native
  /* 3 */ val useHttpPost: typings.winrtDashUwp.WindowsNs.SecurityNs.AuthenticationNs.WebNs.WebAuthenticationOptions.useHttpPost with Double = js.native
  /* 2 */ val useTitle: typings.winrtDashUwp.WindowsNs.SecurityNs.AuthenticationNs.WebNs.WebAuthenticationOptions.useTitle with Double = js.native
  @JSBracketAccess
