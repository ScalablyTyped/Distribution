...
import typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppServiceNs.AppServiceTriggerDetails
...
import typings.winrtDashUwp.winrtDashUwpStrings.voicecommandcompleted
