...
object NDClosedCaptionFormat extends js.Object {
  ...
  /* 0 */ val atsc: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.NDClosedCaptionFormat.atsc with Double = js.native
  /* 1 */ val scte20: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.NDClosedCaptionFormat.scte20 with Double = js.native
  /* 2 */ val unknown: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.NDClosedCaptionFormat.unknown with Double = js.native
  @JSBracketAccess
