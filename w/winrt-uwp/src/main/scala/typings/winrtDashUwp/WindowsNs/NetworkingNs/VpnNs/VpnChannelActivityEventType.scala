...
object VpnChannelActivityEventType extends js.Object {
  ...
  /* 1 */ val active: typings.winrtDashUwp.WindowsNs.NetworkingNs.VpnNs.VpnChannelActivityEventType.active with Double = js.native
  /* 0 */ val idle: typings.winrtDashUwp.WindowsNs.NetworkingNs.VpnNs.VpnChannelActivityEventType.idle with Double = js.native
  @JSBracketAccess
