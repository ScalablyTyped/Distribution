...
import typings.winrtDashUwp.WindowsNs.GraphicsNs.PrintingNs.PrintPageDescription
import typings.winrtDashUwp.WindowsNs.GraphicsNs.PrintingNs.PrintTaskOptions
