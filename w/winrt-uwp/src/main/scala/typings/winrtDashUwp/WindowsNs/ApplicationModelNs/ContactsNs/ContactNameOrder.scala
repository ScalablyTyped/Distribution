...
object ContactNameOrder extends js.Object {
  ...
  /* 0 */ val firstNameLastName: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactNameOrder.firstNameLastName with Double = js.native
  /* 1 */ val lastNameFirstName: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactNameOrder.lastNameFirstName with Double = js.native
  @JSBracketAccess
