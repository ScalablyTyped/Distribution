...
object IndexerOption extends js.Object {
  ...
  /* 2 */ val doNotUseIndexer: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.IndexerOption.doNotUseIndexer with Double = js.native
  /* 1 */ val onlyUseIndexer: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.IndexerOption.onlyUseIndexer with Double = js.native
  /* 0 */ val useIndexerWhenAvailable: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.IndexerOption.useIndexerWhenAvailable with Double = js.native
  @JSBracketAccess
