...
object AppServiceClosedStatus extends js.Object {
  ...
  /* 1 */ val canceled: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppServiceNs.AppServiceClosedStatus.canceled with Double = js.native
  /* 0 */ val completed: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppServiceNs.AppServiceClosedStatus.completed with Double = js.native
  /* 2 */ val resourceLimitsExceeded: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppServiceNs.AppServiceClosedStatus.resourceLimitsExceeded with Double = js.native
  /* 3 */ val unknown: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.AppServiceNs.AppServiceClosedStatus.unknown with Double = js.native
  @JSBracketAccess
