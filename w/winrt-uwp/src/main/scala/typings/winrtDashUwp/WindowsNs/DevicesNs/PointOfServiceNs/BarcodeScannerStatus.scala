...
object BarcodeScannerStatus extends js.Object {
  ...
  /* 4 */ val extended: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.BarcodeScannerStatus.extended with Double = js.native
  /* 1 */ val off: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.BarcodeScannerStatus.off with Double = js.native
  /* 3 */ val offOrOffline: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.BarcodeScannerStatus.offOrOffline with Double = js.native
  /* 2 */ val offline: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.BarcodeScannerStatus.offline with Double = js.native
  /* 0 */ val online: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.BarcodeScannerStatus.online with Double = js.native
  @JSBracketAccess
