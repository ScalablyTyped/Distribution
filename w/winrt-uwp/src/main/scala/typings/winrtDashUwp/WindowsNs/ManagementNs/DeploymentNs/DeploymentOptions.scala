...
object DeploymentOptions extends js.Object {
  ...
  /* 2 */ val developmentMode: typings.winrtDashUwp.WindowsNs.ManagementNs.DeploymentNs.DeploymentOptions.developmentMode with Double = js.native
  /* 1 */ val forceApplicationShutdown: typings.winrtDashUwp.WindowsNs.ManagementNs.DeploymentNs.DeploymentOptions.forceApplicationShutdown with Double = js.native
  /* 4 */ val forceTargetApplicationShutdown: typings.winrtDashUwp.WindowsNs.ManagementNs.DeploymentNs.DeploymentOptions.forceTargetApplicationShutdown with Double = js.native
  /* 3 */ val installAllResources: typings.winrtDashUwp.WindowsNs.ManagementNs.DeploymentNs.DeploymentOptions.installAllResources with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.ManagementNs.DeploymentNs.DeploymentOptions.none with Double = js.native
  @JSBracketAccess
