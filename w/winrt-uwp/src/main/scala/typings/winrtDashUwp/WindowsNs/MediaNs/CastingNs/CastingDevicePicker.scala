...
import typings.winrtDashUwp.WindowsNs.DevicesNs.EnumerationNs.DevicePickerAppearance
...
import typings.winrtDashUwp.winrtDashUwpStrings.castingdevicepickerdismissed
import typings.winrtDashUwp.winrtDashUwpStrings.castingdeviceselected
