...
object CausalityRelation extends js.Object {
  ...
  /* 0 */ val assignDelegate: typings.winrtDashUwp.WindowsNs.FoundationNs.DiagnosticsNs.CausalityRelation.assignDelegate with Double = js.native
  /* 3 */ val cancel: typings.winrtDashUwp.WindowsNs.FoundationNs.DiagnosticsNs.CausalityRelation.cancel with Double = js.native
  /* 2 */ val choice: typings.winrtDashUwp.WindowsNs.FoundationNs.DiagnosticsNs.CausalityRelation.choice with Double = js.native
  /* 4 */ val error: typings.winrtDashUwp.WindowsNs.FoundationNs.DiagnosticsNs.CausalityRelation.error with Double = js.native
  /* 1 */ val join: typings.winrtDashUwp.WindowsNs.FoundationNs.DiagnosticsNs.CausalityRelation.join with Double = js.native
  @JSBracketAccess
