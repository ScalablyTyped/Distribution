...
object UIStatus extends js.Object {
  ...
  /* 3 */ val complete: typings.winrtDashUwp.WindowsNs.StorageNs.ProviderNs.UIStatus.complete with Double = js.native
  /* 1 */ val hidden: typings.winrtDashUwp.WindowsNs.StorageNs.ProviderNs.UIStatus.hidden with Double = js.native
  /* 0 */ val unavailable: typings.winrtDashUwp.WindowsNs.StorageNs.ProviderNs.UIStatus.unavailable with Double = js.native
  /* 2 */ val visible: typings.winrtDashUwp.WindowsNs.StorageNs.ProviderNs.UIStatus.visible with Double = js.native
  @JSBracketAccess
