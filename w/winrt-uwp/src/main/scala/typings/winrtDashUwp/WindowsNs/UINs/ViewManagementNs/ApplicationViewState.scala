...
object ApplicationViewState extends js.Object {
  ...
  /* 1 */ val filled: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.ApplicationViewState.filled with Double = js.native
  /* 0 */ val fullScreenLandscape: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.ApplicationViewState.fullScreenLandscape with Double = js.native
  /* 3 */ val fullScreenPortrait: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.ApplicationViewState.fullScreenPortrait with Double = js.native
  /* 2 */ val snapped: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.ApplicationViewState.snapped with Double = js.native
  @JSBracketAccess
