...
object BackgroundAccessStatus extends js.Object {
  ...
  /* 2 */ val allowedMayUseActiveRealTimeConnectivity: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.BackgroundAccessStatus.allowedMayUseActiveRealTimeConnectivity with Double = js.native
  /* 1 */ val allowedWithAlwaysOnRealTimeConnectivity: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.BackgroundAccessStatus.allowedWithAlwaysOnRealTimeConnectivity with Double = js.native
  /* 3 */ val denied: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.BackgroundAccessStatus.denied with Double = js.native
  /* 0 */ val unspecified: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.BackgroundAccessStatus.unspecified with Double = js.native
  @JSBracketAccess
