...
object DeprecationType extends js.Object {
  ...
  /* 0 */ val deprecate: typings.winrtDashUwp.WindowsNs.FoundationNs.MetadataNs.DeprecationType.deprecate with Double = js.native
  /* 1 */ val remove: typings.winrtDashUwp.WindowsNs.FoundationNs.MetadataNs.DeprecationType.remove with Double = js.native
  @JSBracketAccess
