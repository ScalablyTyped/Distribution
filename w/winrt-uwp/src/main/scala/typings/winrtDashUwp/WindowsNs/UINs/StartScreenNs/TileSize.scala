...
object TileSize extends js.Object {
  ...
  /* 0 */ val default: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.TileSize.default with Double = js.native
  /* 3 */ val square150x150: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.TileSize.square150x150 with Double = js.native
  /* 1 */ val square30x30: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.TileSize.square30x30 with Double = js.native
  /* 5 */ val square310x310: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.TileSize.square310x310 with Double = js.native
  /* 7 */ val square44x44: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.TileSize.square44x44 with Double = js.native
  /* 2 */ val square70x70: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.TileSize.square70x70 with Double = js.native
  /* 6 */ val square71x71: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.TileSize.square71x71 with Double = js.native
  /* 4 */ val wide310x150: typings.winrtDashUwp.WindowsNs.UINs.StartScreenNs.TileSize.wide310x150 with Double = js.native
  @JSBracketAccess
