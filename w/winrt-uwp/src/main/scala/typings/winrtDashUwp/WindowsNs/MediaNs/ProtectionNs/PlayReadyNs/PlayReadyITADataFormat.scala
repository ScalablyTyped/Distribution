...
object PlayReadyITADataFormat extends js.Object {
  ...
  /* 0 */ val serializedProperties: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.PlayReadyITADataFormat.serializedProperties with Double = js.native
  /* 1 */ val serializedProperties_WithContentProtectionWrapper: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.PlayReadyITADataFormat.serializedProperties_WithContentProtectionWrapper with Double = js.native
  @JSBracketAccess
