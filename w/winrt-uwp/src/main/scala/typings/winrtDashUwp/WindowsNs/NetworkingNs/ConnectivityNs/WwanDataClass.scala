...
object WwanDataClass extends js.Object {
  ...
  /* 8 */ val cdma1xEvdo: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.cdma1xEvdo with Double = js.native
  /* 9 */ val cdma1xEvdoRevA: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.cdma1xEvdoRevA with Double = js.native
  /* 12 */ val cdma1xEvdoRevB: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.cdma1xEvdoRevB with Double = js.native
  /* 10 */ val cdma1xEvdv: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.cdma1xEvdv with Double = js.native
  /* 7 */ val cdma1xRtt: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.cdma1xRtt with Double = js.native
  /* 11 */ val cdma3xRtt: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.cdma3xRtt with Double = js.native
  /* 13 */ val cdmaUmb: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.cdmaUmb with Double = js.native
  /* 14 */ val custom: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.custom with Double = js.native
  /* 2 */ val edge: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.edge with Double = js.native
  /* 1 */ val gprs: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.gprs with Double = js.native
  /* 4 */ val hsdpa: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.hsdpa with Double = js.native
  /* 5 */ val hsupa: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.hsupa with Double = js.native
  /* 6 */ val lteAdvanced: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.lteAdvanced with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.none with Double = js.native
  /* 3 */ val umts: typings.winrtDashUwp.WindowsNs.NetworkingNs.ConnectivityNs.WwanDataClass.umts with Double = js.native
  @JSBracketAccess
