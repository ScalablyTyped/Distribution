...
object HourFormat extends js.Object {
  ...
  /* 1 */ val default: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.HourFormat.default with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.GlobalizationNs.DateTimeFormattingNs.HourFormat.none with Double = js.native
  @JSBracketAccess
