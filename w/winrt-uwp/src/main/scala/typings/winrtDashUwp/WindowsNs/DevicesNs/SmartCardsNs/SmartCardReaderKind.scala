...
object SmartCardReaderKind extends js.Object {
  ...
  /* 0 */ val any: typings.winrtDashUwp.WindowsNs.DevicesNs.SmartCardsNs.SmartCardReaderKind.any with Double = js.native
  /* 1 */ val generic: typings.winrtDashUwp.WindowsNs.DevicesNs.SmartCardsNs.SmartCardReaderKind.generic with Double = js.native
  /* 3 */ val nfc: typings.winrtDashUwp.WindowsNs.DevicesNs.SmartCardsNs.SmartCardReaderKind.nfc with Double = js.native
  /* 2 */ val tpm: typings.winrtDashUwp.WindowsNs.DevicesNs.SmartCardsNs.SmartCardReaderKind.tpm with Double = js.native
  /* 4 */ val uicc: typings.winrtDashUwp.WindowsNs.DevicesNs.SmartCardsNs.SmartCardReaderKind.uicc with Double = js.native
  @JSBracketAccess
