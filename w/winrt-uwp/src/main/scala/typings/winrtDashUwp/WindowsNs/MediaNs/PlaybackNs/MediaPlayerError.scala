...
object MediaPlayerError extends js.Object {
  ...
  /* 1 */ val aborted: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.MediaPlayerError.aborted with Double = js.native
  /* 3 */ val decodingError: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.MediaPlayerError.decodingError with Double = js.native
  /* 2 */ val networkError: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.MediaPlayerError.networkError with Double = js.native
  /* 4 */ val sourceNotSupported: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.MediaPlayerError.sourceNotSupported with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.MediaPlayerError.unknown with Double = js.native
  @JSBracketAccess
