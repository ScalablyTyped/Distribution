...
object MediaTrackKind extends js.Object {
  ...
  /* 0 */ val audio: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaTrackKind.audio with Double = js.native
  /* 2 */ val timedMetadata: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaTrackKind.timedMetadata with Double = js.native
  /* 1 */ val video: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaTrackKind.video with Double = js.native
  @JSBracketAccess
