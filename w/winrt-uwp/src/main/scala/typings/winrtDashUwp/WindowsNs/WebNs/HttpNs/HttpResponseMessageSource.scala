...
object HttpResponseMessageSource extends js.Object {
  ...
  /* 1 */ val cache: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpResponseMessageSource.cache with Double = js.native
  /* 2 */ val network: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpResponseMessageSource.network with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.WebNs.HttpNs.HttpResponseMessageSource.none with Double = js.native
  @JSBracketAccess
