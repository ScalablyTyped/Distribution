...
object UssdResultCode extends js.Object {
  ...
  /* 1 */ val actionRequired: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.UssdResultCode.actionRequired with Double = js.native
  /* 5 */ val networkTimeout: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.UssdResultCode.networkTimeout with Double = js.native
  /* 0 */ val noActionRequired: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.UssdResultCode.noActionRequired with Double = js.native
  /* 4 */ val operationNotSupported: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.UssdResultCode.operationNotSupported with Double = js.native
  /* 3 */ val otherLocalClient: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.UssdResultCode.otherLocalClient with Double = js.native
  /* 2 */ val terminated: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.UssdResultCode.terminated with Double = js.native
  @JSBracketAccess
