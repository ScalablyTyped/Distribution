...
object PointOptions extends js.Object {
  ...
  /* 4 */ val allowOffClient: typings.winrtDashUwp.WindowsNs.UINs.TextNs.PointOptions.allowOffClient with Double = js.native
  /* 3 */ val clientCoordinates: typings.winrtDashUwp.WindowsNs.UINs.TextNs.PointOptions.clientCoordinates with Double = js.native
  /* 1 */ val includeInset: typings.winrtDashUwp.WindowsNs.UINs.TextNs.PointOptions.includeInset with Double = js.native
  /* 6 */ val noHorizontalScroll: typings.winrtDashUwp.WindowsNs.UINs.TextNs.PointOptions.noHorizontalScroll with Double = js.native
  /* 7 */ val noVerticalScroll: typings.winrtDashUwp.WindowsNs.UINs.TextNs.PointOptions.noVerticalScroll with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.UINs.TextNs.PointOptions.none with Double = js.native
  /* 2 */ val start: typings.winrtDashUwp.WindowsNs.UINs.TextNs.PointOptions.start with Double = js.native
  /* 5 */ val transform: typings.winrtDashUwp.WindowsNs.UINs.TextNs.PointOptions.transform with Double = js.native
  @JSBracketAccess
