...
object PosPrinterLineDirection extends js.Object {
  ...
  /* 0 */ val horizontal: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterLineDirection.horizontal with Double = js.native
  /* 1 */ val vertical: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.PosPrinterLineDirection.vertical with Double = js.native
  @JSBracketAccess
