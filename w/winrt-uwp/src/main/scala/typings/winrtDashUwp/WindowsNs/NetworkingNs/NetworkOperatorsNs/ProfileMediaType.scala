...
object ProfileMediaType extends js.Object {
  ...
  /* 0 */ val wlan: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.ProfileMediaType.wlan with Double = js.native
  /* 1 */ val wwan: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.ProfileMediaType.wwan with Double = js.native
  @JSBracketAccess
