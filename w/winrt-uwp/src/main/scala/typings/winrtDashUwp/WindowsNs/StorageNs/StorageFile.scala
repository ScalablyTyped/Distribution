...
import typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.BasicProperties
import typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.StorageItemContentProperties
import typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.StorageItemThumbnail
import typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailMode
import typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.ThumbnailOptions
...
object StorageFile extends js.Object {
  ...
  /**
    ...
    */
  def createStreamedFileFromUriAsync(displayNameWithExtension: String, uri: Uri, thumbnail: IRandomAccessStreamReference): IPromiseWithIAsyncOperation[StorageFile] = js.native
  /**
    ...
    * @return When this method completes, it returns a StorageFile object that represents the URI resource.
    */
  def getFileFromApplicationUriAsync(uri: Uri): IPromiseWithIAsyncOperation[StorageFile] = js.native
  /**
    ...
    */
  def getFileFromPathAsync(path: String): IPromiseWithIAsyncOperation[StorageFile] = js.native
  /**
  ...
  /**
    ...
    */
  def replaceWithStreamedFileFromUriAsync(fileToReplace: IStorageFile, uri: Uri, thumbnail: IRandomAccessStreamReference): IPromiseWithIAsyncOperation[StorageFile] = js.native
}
