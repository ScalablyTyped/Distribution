...
object ApplicationViewBoundsMode extends js.Object {
  ...
  /* 1 */ val useCoreWindow: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.ApplicationViewBoundsMode.useCoreWindow with Double = js.native
  /* 0 */ val useVisible: typings.winrtDashUwp.WindowsNs.UINs.ViewManagementNs.ApplicationViewBoundsMode.useVisible with Double = js.native
  @JSBracketAccess
