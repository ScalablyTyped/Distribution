...
object AudioDeviceRole extends js.Object {
  ...
  /* 1 */ val communications: typings.winrtDashUwp.WindowsNs.MediaNs.DevicesNs.AudioDeviceRole.communications with Double = js.native
  /* 0 */ val default: typings.winrtDashUwp.WindowsNs.MediaNs.DevicesNs.AudioDeviceRole.default with Double = js.native
  @JSBracketAccess
