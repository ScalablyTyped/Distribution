...
object AutoFocusRange extends js.Object {
  ...
  /* 0 */ val fullRange: typings.winrtDashUwp.WindowsNs.MediaNs.DevicesNs.AutoFocusRange.fullRange with Double = js.native
  /* 1 */ val `macro`: typings.winrtDashUwp.WindowsNs.MediaNs.DevicesNs.AutoFocusRange.`macro` with Double = js.native
  /* 2 */ val normal: typings.winrtDashUwp.WindowsNs.MediaNs.DevicesNs.AutoFocusRange.normal with Double = js.native
  @JSBracketAccess
