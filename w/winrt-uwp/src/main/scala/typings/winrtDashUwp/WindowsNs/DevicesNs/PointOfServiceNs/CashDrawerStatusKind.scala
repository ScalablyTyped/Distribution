...
object CashDrawerStatusKind extends js.Object {
  ...
  /* 4 */ val extended: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.CashDrawerStatusKind.extended with Double = js.native
  /* 1 */ val off: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.CashDrawerStatusKind.off with Double = js.native
  /* 3 */ val offOrOffline: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.CashDrawerStatusKind.offOrOffline with Double = js.native
  /* 2 */ val offline: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.CashDrawerStatusKind.offline with Double = js.native
  /* 0 */ val online: typings.winrtDashUwp.WindowsNs.DevicesNs.PointOfServiceNs.CashDrawerStatusKind.online with Double = js.native
  @JSBracketAccess
