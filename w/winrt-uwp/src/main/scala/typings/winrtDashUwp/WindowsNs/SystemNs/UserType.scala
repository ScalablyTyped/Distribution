...
object UserType extends js.Object {
  ...
  /* 2 */ val localGuest: typings.winrtDashUwp.WindowsNs.SystemNs.UserType.localGuest with Double = js.native
  /* 0 */ val localUser: typings.winrtDashUwp.WindowsNs.SystemNs.UserType.localUser with Double = js.native
  /* 3 */ val remoteGuest: typings.winrtDashUwp.WindowsNs.SystemNs.UserType.remoteGuest with Double = js.native
  /* 1 */ val remoteUser: typings.winrtDashUwp.WindowsNs.SystemNs.UserType.remoteUser with Double = js.native
  @JSBracketAccess
