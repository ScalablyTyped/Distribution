...
object FolderDepth extends js.Object {
  ...
  /* 1 */ val deep: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.FolderDepth.deep with Double = js.native
  /* 0 */ val shallow: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.FolderDepth.shallow with Double = js.native
  @JSBracketAccess
