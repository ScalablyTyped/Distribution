...
object PhotoOrientation extends js.Object {
  ...
  /* 2 */ val flipHorizontal: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.PhotoOrientation.flipHorizontal with Double = js.native
  /* 4 */ val flipVertical: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.PhotoOrientation.flipVertical with Double = js.native
  /* 1 */ val normal: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.PhotoOrientation.normal with Double = js.native
  /* 3 */ val rotate180: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.PhotoOrientation.rotate180 with Double = js.native
  /* 6 */ val rotate270: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.PhotoOrientation.rotate270 with Double = js.native
  /* 8 */ val rotate90: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.PhotoOrientation.rotate90 with Double = js.native
  /* 5 */ val transpose: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.PhotoOrientation.transpose with Double = js.native
  /* 7 */ val transverse: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.PhotoOrientation.transverse with Double = js.native
  /* 0 */ val unspecified: typings.winrtDashUwp.WindowsNs.StorageNs.FilePropertiesNs.PhotoOrientation.unspecified with Double = js.native
  @JSBracketAccess
