...
import typings.winrtDashUwp.WindowsNs.UINs.TextNs.TabLeader.equals
...
object TabLeader extends js.Object {
  ...
  /* 2 */ val dashes: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TabLeader.dashes with Double = js.native
  /* 1 */ val dots: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TabLeader.dots with Double = js.native
  /* 5 */ @JSName("equals")
  val equals_FTabLeader: equals with Double = js.native
  /* 3 */ val lines: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TabLeader.lines with Double = js.native
  /* 0 */ val spaces: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TabLeader.spaces with Double = js.native
  /* 4 */ val thickLines: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TabLeader.thickLines with Double = js.native
  @JSBracketAccess
