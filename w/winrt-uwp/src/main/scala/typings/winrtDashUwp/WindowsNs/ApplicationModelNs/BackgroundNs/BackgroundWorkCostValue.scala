...
object BackgroundWorkCostValue extends js.Object {
  ...
  /* 2 */ val high: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.BackgroundWorkCostValue.high with Double = js.native
  /* 0 */ val low: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.BackgroundWorkCostValue.low with Double = js.native
  /* 1 */ val medium: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.BackgroundWorkCostValue.medium with Double = js.native
  @JSBracketAccess
