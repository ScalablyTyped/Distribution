...
object ExtendedExecutionRevokedReason extends js.Object {
  ...
  /* 0 */ val resumed: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ExtendedExecutionNs.ExtendedExecutionRevokedReason.resumed with Double = js.native
  /* 1 */ val systemPolicy: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ExtendedExecutionNs.ExtendedExecutionRevokedReason.systemPolicy with Double = js.native
  @JSBracketAccess
