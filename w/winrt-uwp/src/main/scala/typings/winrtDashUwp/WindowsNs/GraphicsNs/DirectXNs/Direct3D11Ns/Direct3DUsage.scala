...
object Direct3DUsage extends js.Object {
  ...
  /* 0 */ val default: typings.winrtDashUwp.WindowsNs.GraphicsNs.DirectXNs.Direct3D11Ns.Direct3DUsage.default with Double = js.native
  /* 2 */ val dynamic: typings.winrtDashUwp.WindowsNs.GraphicsNs.DirectXNs.Direct3D11Ns.Direct3DUsage.dynamic with Double = js.native
  /* 1 */ val immutable: typings.winrtDashUwp.WindowsNs.GraphicsNs.DirectXNs.Direct3D11Ns.Direct3DUsage.immutable with Double = js.native
  /* 3 */ val staging: typings.winrtDashUwp.WindowsNs.GraphicsNs.DirectXNs.Direct3D11Ns.Direct3DUsage.staging with Double = js.native
  @JSBracketAccess
