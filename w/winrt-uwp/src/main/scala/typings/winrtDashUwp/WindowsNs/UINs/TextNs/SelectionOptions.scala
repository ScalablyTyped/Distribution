...
object SelectionOptions extends js.Object {
  ...
  /* 3 */ val active: typings.winrtDashUwp.WindowsNs.UINs.TextNs.SelectionOptions.active with Double = js.native
  /* 1 */ val atEndOfLine: typings.winrtDashUwp.WindowsNs.UINs.TextNs.SelectionOptions.atEndOfLine with Double = js.native
  /* 2 */ val overtype: typings.winrtDashUwp.WindowsNs.UINs.TextNs.SelectionOptions.overtype with Double = js.native
  /* 4 */ val replace: typings.winrtDashUwp.WindowsNs.UINs.TextNs.SelectionOptions.replace with Double = js.native
  /* 0 */ val startActive: typings.winrtDashUwp.WindowsNs.UINs.TextNs.SelectionOptions.startActive with Double = js.native
  @JSBracketAccess
