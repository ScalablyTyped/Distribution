...
object XboxLiveNetworkAccessKind extends js.Object {
  ...
  /* 1 */ val moderate: typings.winrtDashUwp.WindowsNs.NetworkingNs.XboxLiveNs.XboxLiveNetworkAccessKind.moderate with Double = js.native
  /* 0 */ val open: typings.winrtDashUwp.WindowsNs.NetworkingNs.XboxLiveNs.XboxLiveNetworkAccessKind.open with Double = js.native
  /* 2 */ val strict: typings.winrtDashUwp.WindowsNs.NetworkingNs.XboxLiveNs.XboxLiveNetworkAccessKind.strict with Double = js.native
  @JSBracketAccess
