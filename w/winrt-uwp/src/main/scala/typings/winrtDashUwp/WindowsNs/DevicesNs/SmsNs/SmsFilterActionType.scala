...
object SmsFilterActionType extends js.Object {
  ...
  /* 3 */ val accept: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsFilterActionType.accept with Double = js.native
  /* 0 */ val acceptImmediately: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsFilterActionType.acceptImmediately with Double = js.native
  /* 1 */ val drop: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsFilterActionType.drop with Double = js.native
  /* 2 */ val peek: typings.winrtDashUwp.WindowsNs.DevicesNs.SmsNs.SmsFilterActionType.peek with Double = js.native
  @JSBracketAccess
