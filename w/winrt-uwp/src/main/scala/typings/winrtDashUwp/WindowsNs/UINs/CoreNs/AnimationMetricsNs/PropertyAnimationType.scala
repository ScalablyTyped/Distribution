...
object PropertyAnimationType extends js.Object {
  ...
  /* 2 */ val opacity: typings.winrtDashUwp.WindowsNs.UINs.CoreNs.AnimationMetricsNs.PropertyAnimationType.opacity with Double = js.native
  /* 0 */ val scale: typings.winrtDashUwp.WindowsNs.UINs.CoreNs.AnimationMetricsNs.PropertyAnimationType.scale with Double = js.native
  /* 1 */ val translation: typings.winrtDashUwp.WindowsNs.UINs.CoreNs.AnimationMetricsNs.PropertyAnimationType.translation with Double = js.native
  @JSBracketAccess
