...
object TimedMetadataTrackPresentationMode extends js.Object {
  ...
  /* 2 */ val applicationPresented: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.TimedMetadataTrackPresentationMode.applicationPresented with Double = js.native
  /* 0 */ val disabled: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.TimedMetadataTrackPresentationMode.disabled with Double = js.native
  /* 1 */ val hidden: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.TimedMetadataTrackPresentationMode.hidden with Double = js.native
  /* 3 */ val platformPresented: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.TimedMetadataTrackPresentationMode.platformPresented with Double = js.native
  @JSBracketAccess
