package typings.winrtDashUwp.WindowsNs.DevicesNs.AdcNs.ProviderNs
...
object ProviderAdcChannelMode extends js.Object {
  ...
  /* 1 */ val differential: typings.winrtDashUwp.WindowsNs.DevicesNs.AdcNs.ProviderNs.ProviderAdcChannelMode.differential with Double = js.native
  /* 0 */ val singleEnded: typings.winrtDashUwp.WindowsNs.DevicesNs.AdcNs.ProviderNs.ProviderAdcChannelMode.singleEnded with Double = js.native
  @JSBracketAccess
