...
import typings.winrtDashUwp.winrtDashUwpStrings.aamvacarddatareceived
import typings.winrtDashUwp.winrtDashUwpStrings.bankcarddatareceived
...
import typings.winrtDashUwp.winrtDashUwpStrings.vendorspecificdatareceived
