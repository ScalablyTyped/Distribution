...
object PhoneCallHistoryEntryOtherAppReadAccess extends js.Object {
  ...
  /* 0 */ val full: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.PhoneCallHistoryEntryOtherAppReadAccess.full with Double = js.native
  /* 1 */ val systemOnly: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.CallsNs.PhoneCallHistoryEntryOtherAppReadAccess.systemOnly with Double = js.native
  @JSBracketAccess
