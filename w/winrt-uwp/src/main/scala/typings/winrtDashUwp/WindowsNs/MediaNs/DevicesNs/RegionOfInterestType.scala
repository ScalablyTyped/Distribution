...
object RegionOfInterestType extends js.Object {
  ...
  /* 1 */ val face: typings.winrtDashUwp.WindowsNs.MediaNs.DevicesNs.RegionOfInterestType.face with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.WindowsNs.MediaNs.DevicesNs.RegionOfInterestType.unknown with Double = js.native
  @JSBracketAccess
