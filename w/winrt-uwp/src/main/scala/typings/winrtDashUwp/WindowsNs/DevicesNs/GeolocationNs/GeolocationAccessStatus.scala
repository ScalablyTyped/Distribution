...
object GeolocationAccessStatus extends js.Object {
  ...
  /* 1 */ val allowed: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.GeolocationAccessStatus.allowed with Double = js.native
  /* 2 */ val denied: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.GeolocationAccessStatus.denied with Double = js.native
  /* 0 */ val unspecified: typings.winrtDashUwp.WindowsNs.DevicesNs.GeolocationNs.GeolocationAccessStatus.unspecified with Double = js.native
  @JSBracketAccess
