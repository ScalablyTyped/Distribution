...
object ContactAnnotationStoreAccessType extends js.Object {
  ...
  /* 1 */ val allAnnotationsReadWrite: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactAnnotationStoreAccessType.allAnnotationsReadWrite with Double = js.native
  /* 0 */ val appAnnotationsReadWrite: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.ContactsNs.ContactAnnotationStoreAccessType.appAnnotationsReadWrite with Double = js.native
  @JSBracketAccess
