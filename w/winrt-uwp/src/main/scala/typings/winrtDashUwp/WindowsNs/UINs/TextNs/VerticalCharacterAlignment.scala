...
object VerticalCharacterAlignment extends js.Object {
  ...
  /* 1 */ val baseline: typings.winrtDashUwp.WindowsNs.UINs.TextNs.VerticalCharacterAlignment.baseline with Double = js.native
  /* 2 */ val bottom: typings.winrtDashUwp.WindowsNs.UINs.TextNs.VerticalCharacterAlignment.bottom with Double = js.native
  /* 0 */ val top: typings.winrtDashUwp.WindowsNs.UINs.TextNs.VerticalCharacterAlignment.top with Double = js.native
  @JSBracketAccess
