...
object WebAccountClientViewType extends js.Object {
  ...
  /* 1 */ val idAndProperties: typings.winrtDashUwp.WindowsNs.SecurityNs.AuthenticationNs.WebNs.ProviderNs.WebAccountClientViewType.idAndProperties with Double = js.native
  /* 0 */ val idOnly: typings.winrtDashUwp.WindowsNs.SecurityNs.AuthenticationNs.WebNs.ProviderNs.WebAccountClientViewType.idOnly with Double = js.native
  @JSBracketAccess
