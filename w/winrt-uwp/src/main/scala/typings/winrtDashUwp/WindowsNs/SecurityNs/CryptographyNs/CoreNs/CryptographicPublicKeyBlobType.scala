...
object CryptographicPublicKeyBlobType extends js.Object {
  ...
  /* 4 */ val bcryptEccFullPublicKey: typings.winrtDashUwp.WindowsNs.SecurityNs.CryptographyNs.CoreNs.CryptographicPublicKeyBlobType.bcryptEccFullPublicKey with Double = js.native
  /* 2 */ val bcryptPublicKey: typings.winrtDashUwp.WindowsNs.SecurityNs.CryptographyNs.CoreNs.CryptographicPublicKeyBlobType.bcryptPublicKey with Double = js.native
  /* 3 */ val capi1PublicKey: typings.winrtDashUwp.WindowsNs.SecurityNs.CryptographyNs.CoreNs.CryptographicPublicKeyBlobType.capi1PublicKey with Double = js.native
  /* 1 */ val pkcs1RsaPublicKey: typings.winrtDashUwp.WindowsNs.SecurityNs.CryptographyNs.CoreNs.CryptographicPublicKeyBlobType.pkcs1RsaPublicKey with Double = js.native
  /* 0 */ val x509SubjectPublicKeyInfo: typings.winrtDashUwp.WindowsNs.SecurityNs.CryptographyNs.CoreNs.CryptographicPublicKeyBlobType.x509SubjectPublicKeyInfo with Double = js.native
  @JSBracketAccess
