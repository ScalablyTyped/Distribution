...
object VideoRotation extends js.Object {
  ...
  /* 2 */ val clockwise180Degrees: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.VideoRotation.clockwise180Degrees with Double = js.native
  /* 3 */ val clockwise270Degrees: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.VideoRotation.clockwise270Degrees with Double = js.native
  /* 1 */ val clockwise90Degrees: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.VideoRotation.clockwise90Degrees with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.MediaNs.CaptureNs.VideoRotation.none with Double = js.native
  @JSBracketAccess
