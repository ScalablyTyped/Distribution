...
object VideoFramePrecision extends js.Object {
  ...
  /* 0 */ val nearestFrame: typings.winrtDashUwp.WindowsNs.MediaNs.EditingNs.VideoFramePrecision.nearestFrame with Double = js.native
  /* 1 */ val nearestKeyFrame: typings.winrtDashUwp.WindowsNs.MediaNs.EditingNs.VideoFramePrecision.nearestKeyFrame with Double = js.native
  @JSBracketAccess
