...
object GpioPinEdge extends js.Object {
  ...
  /* 0 */ val fallingEdge: typings.winrtDashUwp.WindowsNs.DevicesNs.GpioNs.GpioPinEdge.fallingEdge with Double = js.native
  /* 1 */ val risingEdge: typings.winrtDashUwp.WindowsNs.DevicesNs.GpioNs.GpioPinEdge.risingEdge with Double = js.native
  @JSBracketAccess
