...
object VpnAppIdType extends js.Object {
  ...
  /* 2 */ val filePath: typings.winrtDashUwp.WindowsNs.NetworkingNs.VpnNs.VpnAppIdType.filePath with Double = js.native
  /* 1 */ val fullyQualifiedBinaryName: typings.winrtDashUwp.WindowsNs.NetworkingNs.VpnNs.VpnAppIdType.fullyQualifiedBinaryName with Double = js.native
  /* 0 */ val packageFamilyName: typings.winrtDashUwp.WindowsNs.NetworkingNs.VpnNs.VpnAppIdType.packageFamilyName with Double = js.native
  @JSBracketAccess
