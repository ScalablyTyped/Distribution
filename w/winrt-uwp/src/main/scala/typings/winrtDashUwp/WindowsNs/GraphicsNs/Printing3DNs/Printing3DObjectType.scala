...
object Printing3DObjectType extends js.Object {
  ...
  /* 0 */ val model: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DObjectType.model with Double = js.native
  /* 2 */ val others: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DObjectType.others with Double = js.native
  /* 1 */ val support: typings.winrtDashUwp.WindowsNs.GraphicsNs.Printing3DNs.Printing3DObjectType.support with Double = js.native
  @JSBracketAccess
