...
object ActivityType extends js.Object {
  ...
  /* 7 */ val biking: typings.winrtDashUwp.WindowsNs.DevicesNs.SensorsNs.ActivityType.biking with Double = js.native
  /* 3 */ val fidgeting: typings.winrtDashUwp.WindowsNs.DevicesNs.SensorsNs.ActivityType.fidgeting with Double = js.native
  /* 1 */ val idle: typings.winrtDashUwp.WindowsNs.DevicesNs.SensorsNs.ActivityType.idle with Double = js.native
  /* 6 */ val inVehicle: typings.winrtDashUwp.WindowsNs.DevicesNs.SensorsNs.ActivityType.inVehicle with Double = js.native
  /* 5 */ val running: typings.winrtDashUwp.WindowsNs.DevicesNs.SensorsNs.ActivityType.running with Double = js.native
  /* 2 */ val stationary: typings.winrtDashUwp.WindowsNs.DevicesNs.SensorsNs.ActivityType.stationary with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.WindowsNs.DevicesNs.SensorsNs.ActivityType.unknown with Double = js.native
  /* 4 */ val walking: typings.winrtDashUwp.WindowsNs.DevicesNs.SensorsNs.ActivityType.walking with Double = js.native
  @JSBracketAccess
