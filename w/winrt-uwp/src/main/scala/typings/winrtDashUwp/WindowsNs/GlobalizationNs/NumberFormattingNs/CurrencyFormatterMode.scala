...
object CurrencyFormatterMode extends js.Object {
  ...
  /* 1 */ val useCurrencyCode: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.CurrencyFormatterMode.useCurrencyCode with Double = js.native
  /* 0 */ val useSymbol: typings.winrtDashUwp.WindowsNs.GlobalizationNs.NumberFormattingNs.CurrencyFormatterMode.useSymbol with Double = js.native
  @JSBracketAccess
