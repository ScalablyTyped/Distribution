...
object SocketActivityConnectedStandbyAction extends js.Object {
  ...
  /* 0 */ val doNotWake: typings.winrtDashUwp.WindowsNs.NetworkingNs.SocketsNs.SocketActivityConnectedStandbyAction.doNotWake with Double = js.native
  /* 1 */ val wake: typings.winrtDashUwp.WindowsNs.NetworkingNs.SocketsNs.SocketActivityConnectedStandbyAction.wake with Double = js.native
  @JSBracketAccess
