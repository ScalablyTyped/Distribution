...
object TextGetOptions extends js.Object {
  ...
  /* 1 */ val adjustCrlf: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextGetOptions.adjustCrlf with Double = js.native
  /* 4 */ val allowFinalEop: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextGetOptions.allowFinalEop with Double = js.native
  /* 7 */ val formatRtf: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextGetOptions.formatRtf with Double = js.native
  /* 6 */ val includeNumbering: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextGetOptions.includeNumbering with Double = js.native
  /* 5 */ val noHidden: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextGetOptions.noHidden with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextGetOptions.none with Double = js.native
  /* 2 */ val useCrlf: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextGetOptions.useCrlf with Double = js.native
  /* 3 */ val useObjectText: typings.winrtDashUwp.WindowsNs.UINs.TextNs.TextGetOptions.useObjectText with Double = js.native
  @JSBracketAccess
