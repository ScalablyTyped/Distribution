...
object NetworkDeviceStatus extends js.Object {
  ...
  /* 5 */ val accountNotActivated: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.NetworkDeviceStatus.accountNotActivated with Double = js.native
  /* 3 */ val badSim: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.NetworkDeviceStatus.badSim with Double = js.native
  /* 7 */ val deviceBlocked: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.NetworkDeviceStatus.deviceBlocked with Double = js.native
  /* 4 */ val deviceHardwareFailure: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.NetworkDeviceStatus.deviceHardwareFailure with Double = js.native
  /* 6 */ val deviceLocked: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.NetworkDeviceStatus.deviceLocked with Double = js.native
  /* 0 */ val deviceNotReady: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.NetworkDeviceStatus.deviceNotReady with Double = js.native
  /* 1 */ val deviceReady: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.NetworkDeviceStatus.deviceReady with Double = js.native
  /* 2 */ val simNotInserted: typings.winrtDashUwp.WindowsNs.NetworkingNs.NetworkOperatorsNs.NetworkDeviceStatus.simNotInserted with Double = js.native
  @JSBracketAccess
