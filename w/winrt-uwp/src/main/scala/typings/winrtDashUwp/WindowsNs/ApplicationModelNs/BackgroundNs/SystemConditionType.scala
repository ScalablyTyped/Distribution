...
object SystemConditionType extends js.Object {
  ...
  /* 8 */ val backgroundWorkCostNotHigh: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemConditionType.backgroundWorkCostNotHigh with Double = js.native
  /* 7 */ val freeNetworkAvailable: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemConditionType.freeNetworkAvailable with Double = js.native
  /* 3 */ val internetAvailable: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemConditionType.internetAvailable with Double = js.native
  /* 4 */ val internetNotAvailable: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemConditionType.internetNotAvailable with Double = js.native
  /* 0 */ val invalid: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemConditionType.invalid with Double = js.native
  /* 5 */ val sessionConnected: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemConditionType.sessionConnected with Double = js.native
  /* 6 */ val sessionDisconnected: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemConditionType.sessionDisconnected with Double = js.native
  /* 2 */ val userNotPresent: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemConditionType.userNotPresent with Double = js.native
  /* 1 */ val userPresent: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.BackgroundNs.SystemConditionType.userPresent with Double = js.native
  @JSBracketAccess
