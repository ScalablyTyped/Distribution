...
object MediaMirroringOptions extends js.Object {
  ...
  /* 1 */ val horizontal: typings.winrtDashUwp.WindowsNs.MediaNs.MediaPropertiesNs.MediaMirroringOptions.horizontal with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.MediaNs.MediaPropertiesNs.MediaMirroringOptions.none with Double = js.native
  /* 2 */ val vertical: typings.winrtDashUwp.WindowsNs.MediaNs.MediaPropertiesNs.MediaMirroringOptions.vertical with Double = js.native
  @JSBracketAccess
