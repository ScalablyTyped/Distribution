...
object PhotoImportContentTypeFilter extends js.Object {
  ...
  /* 2 */ val imagesAndVideos: typings.winrtDashUwp.WindowsNs.MediaNs.ImportNs.PhotoImportContentTypeFilter.imagesAndVideos with Double = js.native
  /* 0 */ val onlyImages: typings.winrtDashUwp.WindowsNs.MediaNs.ImportNs.PhotoImportContentTypeFilter.onlyImages with Double = js.native
  /* 1 */ val onlyVideos: typings.winrtDashUwp.WindowsNs.MediaNs.ImportNs.PhotoImportContentTypeFilter.onlyVideos with Double = js.native
  @JSBracketAccess
