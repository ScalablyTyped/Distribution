...
import typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.AudioStreamDescriptor
import typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.IMediaStreamDescriptor
import typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.MediaStreamSample
import typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.VideoStreamDescriptor
