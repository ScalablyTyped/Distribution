...
object UserDataAccountOtherAppReadAccess extends js.Object {
  ...
  /* 1 */ val full: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.UserDataAccountsNs.UserDataAccountOtherAppReadAccess.full with Double = js.native
  /* 0 */ val systemOnly: typings.winrtDashUwp.WindowsNs.ApplicationModelNs.UserDataAccountsNs.UserDataAccountOtherAppReadAccess.systemOnly with Double = js.native
  @JSBracketAccess
