...
object UserWatcherStatus extends js.Object {
  ...
  /* 5 */ val aborted: typings.winrtDashUwp.WindowsNs.SystemNs.UserWatcherStatus.aborted with Double = js.native
  /* 0 */ val created: typings.winrtDashUwp.WindowsNs.SystemNs.UserWatcherStatus.created with Double = js.native
  /* 2 */ val enumerationCompleted: typings.winrtDashUwp.WindowsNs.SystemNs.UserWatcherStatus.enumerationCompleted with Double = js.native
  /* 1 */ val started: typings.winrtDashUwp.WindowsNs.SystemNs.UserWatcherStatus.started with Double = js.native
  /* 4 */ val stopped: typings.winrtDashUwp.WindowsNs.SystemNs.UserWatcherStatus.stopped with Double = js.native
  /* 3 */ val stopping: typings.winrtDashUwp.WindowsNs.SystemNs.UserWatcherStatus.stopping with Double = js.native
  @JSBracketAccess
