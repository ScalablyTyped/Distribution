...
object MediaPlaybackItemErrorCode extends js.Object {
  ...
  /* 1 */ val aborted: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.MediaPlaybackItemErrorCode.aborted with Double = js.native
  /* 3 */ val decodeError: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.MediaPlaybackItemErrorCode.decodeError with Double = js.native
  /* 5 */ val encryptionError: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.MediaPlaybackItemErrorCode.encryptionError with Double = js.native
  /* 2 */ val networkError: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.MediaPlaybackItemErrorCode.networkError with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.MediaPlaybackItemErrorCode.none with Double = js.native
  /* 4 */ val sourceNotSupportedError: typings.winrtDashUwp.WindowsNs.MediaNs.PlaybackNs.MediaPlaybackItemErrorCode.sourceNotSupportedError with Double = js.native
  @JSBracketAccess
