...
object AudioFileNodeCreationStatus extends js.Object {
  ...
  /* 1 */ val fileNotFound: typings.winrtDashUwp.WindowsNs.MediaNs.AudioNs.AudioFileNodeCreationStatus.fileNotFound with Double = js.native
  /* 3 */ val formatNotSupported: typings.winrtDashUwp.WindowsNs.MediaNs.AudioNs.AudioFileNodeCreationStatus.formatNotSupported with Double = js.native
  /* 2 */ val invalidFileType: typings.winrtDashUwp.WindowsNs.MediaNs.AudioNs.AudioFileNodeCreationStatus.invalidFileType with Double = js.native
  /* 0 */ val success: typings.winrtDashUwp.WindowsNs.MediaNs.AudioNs.AudioFileNodeCreationStatus.success with Double = js.native
  /* 4 */ val unknownFailure: typings.winrtDashUwp.WindowsNs.MediaNs.AudioNs.AudioFileNodeCreationStatus.unknownFailure with Double = js.native
  @JSBracketAccess
