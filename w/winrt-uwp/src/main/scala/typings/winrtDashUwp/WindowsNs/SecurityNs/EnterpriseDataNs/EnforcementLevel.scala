...
object EnforcementLevel extends js.Object {
  ...
  /* 3 */ val block: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.EnforcementLevel.block with Double = js.native
  /* 0 */ val noProtection: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.EnforcementLevel.noProtection with Double = js.native
  /* 2 */ val `override`: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.EnforcementLevel.`override` with Double = js.native
  /* 1 */ val silent: typings.winrtDashUwp.WindowsNs.SecurityNs.EnterpriseDataNs.EnforcementLevel.silent with Double = js.native
  @JSBracketAccess
