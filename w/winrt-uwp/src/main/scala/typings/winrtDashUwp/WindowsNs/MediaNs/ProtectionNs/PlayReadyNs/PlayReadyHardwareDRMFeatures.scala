...
object PlayReadyHardwareDRMFeatures extends js.Object {
  ...
  /* 0 */ val hardwareDRM: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.PlayReadyHardwareDRMFeatures.hardwareDRM with Double = js.native
  /* 1 */ val hevc: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.PlayReadyHardwareDRMFeatures.hevc with Double = js.native
  @JSBracketAccess
