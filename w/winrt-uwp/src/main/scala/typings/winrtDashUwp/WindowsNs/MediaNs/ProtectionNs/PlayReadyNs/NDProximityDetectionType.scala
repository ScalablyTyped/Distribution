...
object NDProximityDetectionType extends js.Object {
  ...
  /* 1 */ val tcp: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.NDProximityDetectionType.tcp with Double = js.native
  /* 2 */ val transportAgnostic: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.NDProximityDetectionType.transportAgnostic with Double = js.native
  /* 0 */ val udp: typings.winrtDashUwp.WindowsNs.MediaNs.ProtectionNs.PlayReadyNs.NDProximityDetectionType.udp with Double = js.native
  @JSBracketAccess
