...
object SyndicationErrorStatus extends js.Object {
  ...
  /* 3 */ val invalidXml: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationErrorStatus.invalidXml with Double = js.native
  /* 2 */ val missingRequiredAttribute: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationErrorStatus.missingRequiredAttribute with Double = js.native
  /* 1 */ val missingRequiredElement: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationErrorStatus.missingRequiredElement with Double = js.native
  /* 4 */ val unexpectedContent: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationErrorStatus.unexpectedContent with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationErrorStatus.unknown with Double = js.native
  /* 5 */ val unsupportedFormat: typings.winrtDashUwp.WindowsNs.WebNs.SyndicationNs.SyndicationErrorStatus.unsupportedFormat with Double = js.native
  @JSBracketAccess
