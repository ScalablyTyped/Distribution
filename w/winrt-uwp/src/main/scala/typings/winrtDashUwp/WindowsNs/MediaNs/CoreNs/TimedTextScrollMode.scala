...
object TimedTextScrollMode extends js.Object {
  ...
  /* 0 */ val popon: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.TimedTextScrollMode.popon with Double = js.native
  /* 1 */ val rollup: typings.winrtDashUwp.WindowsNs.MediaNs.CoreNs.TimedTextScrollMode.rollup with Double = js.native
  @JSBracketAccess
