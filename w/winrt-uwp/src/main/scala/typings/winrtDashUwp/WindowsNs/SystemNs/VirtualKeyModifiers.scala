...
object VirtualKeyModifiers extends js.Object {
  ...
  /* 1 */ val control: typings.winrtDashUwp.WindowsNs.SystemNs.VirtualKeyModifiers.control with Double = js.native
  /* 2 */ val menu: typings.winrtDashUwp.WindowsNs.SystemNs.VirtualKeyModifiers.menu with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.WindowsNs.SystemNs.VirtualKeyModifiers.none with Double = js.native
  /* 3 */ val shift: typings.winrtDashUwp.WindowsNs.SystemNs.VirtualKeyModifiers.shift with Double = js.native
  /* 4 */ val windows: typings.winrtDashUwp.WindowsNs.SystemNs.VirtualKeyModifiers.windows with Double = js.native
  @JSBracketAccess
