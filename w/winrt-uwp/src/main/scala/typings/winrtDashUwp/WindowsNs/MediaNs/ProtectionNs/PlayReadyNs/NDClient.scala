...
import typings.winrtDashUwp.winrtDashUwpStrings.closedcaptiondatareceived
import typings.winrtDashUwp.winrtDashUwpStrings.licensefetchcompleted
import typings.winrtDashUwp.winrtDashUwpStrings.proximitydetectioncompleted
import typings.winrtDashUwp.winrtDashUwpStrings.registrationcompleted
import typings.winrtDashUwp.winrtDashUwpStrings.reregistrationneeded
