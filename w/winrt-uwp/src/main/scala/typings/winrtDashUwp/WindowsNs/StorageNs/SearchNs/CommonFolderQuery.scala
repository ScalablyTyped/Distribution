...
object CommonFolderQuery extends js.Object {
  ...
  /* 0 */ val defaultQuery: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.defaultQuery with Double = js.native
  /* 4 */ val groupByAlbum: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByAlbum with Double = js.native
  /* 5 */ val groupByAlbumArtist: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByAlbumArtist with Double = js.native
  /* 3 */ val groupByArtist: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByArtist with Double = js.native
  /* 11 */ val groupByAuthor: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByAuthor with Double = js.native
  /* 6 */ val groupByComposer: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByComposer with Double = js.native
  /* 7 */ val groupByGenre: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByGenre with Double = js.native
  /* 2 */ val groupByMonth: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByMonth with Double = js.native
  /* 8 */ val groupByPublishedYear: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByPublishedYear with Double = js.native
  /* 9 */ val groupByRating: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByRating with Double = js.native
  /* 10 */ val groupByTag: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByTag with Double = js.native
  /* 12 */ val groupByType: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByType with Double = js.native
  /* 1 */ val groupByYear: typings.winrtDashUwp.WindowsNs.StorageNs.SearchNs.CommonFolderQuery.groupByYear with Double = js.native
  @JSBracketAccess
