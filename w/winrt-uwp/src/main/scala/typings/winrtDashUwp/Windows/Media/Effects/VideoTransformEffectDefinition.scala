...
import typings.winrtDashUwp.Windows.Media.MediaProperties.MediaMirroringOptions
import typings.winrtDashUwp.Windows.Media.MediaProperties.MediaRotation
