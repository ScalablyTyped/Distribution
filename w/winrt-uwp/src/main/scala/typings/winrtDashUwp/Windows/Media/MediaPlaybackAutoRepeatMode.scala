...
import typings.winrtDashUwp.Windows.Media.MediaPlaybackAutoRepeatMode.list
import typings.winrtDashUwp.Windows.Media.MediaPlaybackAutoRepeatMode.none
import typings.winrtDashUwp.Windows.Media.MediaPlaybackAutoRepeatMode.track
