...
object NDCertificateFeature extends js.Object {
  ...
  /* 4 */ val antiRollBackClock: typings.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificateFeature.antiRollBackClock with Double = js.native
  /* 5 */ val crls: typings.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificateFeature.crls with Double = js.native
  /* 6 */ val playReady3Features: typings.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificateFeature.playReady3Features with Double = js.native
  /* 1 */ val receiver: typings.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificateFeature.receiver with Double = js.native
  /* 3 */ val secureClock: typings.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificateFeature.secureClock with Double = js.native
  /* 2 */ val sharedCertificate: typings.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificateFeature.sharedCertificate with Double = js.native
  /* 0 */ val transmitter: typings.winrtDashUwp.Windows.Media.Protection.PlayReady.NDCertificateFeature.transmitter with Double = js.native
  @JSBracketAccess
