...
object EdgeGestureKind extends js.Object {
  ...
  /* 1 */ val keyboard: typings.winrtDashUwp.Windows.UI.Input.EdgeGestureKind.keyboard with Double = js.native
  /* 2 */ val mouse: typings.winrtDashUwp.Windows.UI.Input.EdgeGestureKind.mouse with Double = js.native
  /* 0 */ val touch: typings.winrtDashUwp.Windows.UI.Input.EdgeGestureKind.touch with Double = js.native
  @JSBracketAccess
