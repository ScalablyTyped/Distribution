...
import typings.winrtDashUwp.Windows.Devices.Gpio.GpioSharingMode.exclusive
import typings.winrtDashUwp.Windows.Devices.Gpio.GpioSharingMode.sharedReadOnly
