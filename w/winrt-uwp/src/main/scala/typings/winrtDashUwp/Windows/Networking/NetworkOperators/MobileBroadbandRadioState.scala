...
import typings.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandRadioState.off
import typings.winrtDashUwp.Windows.Networking.NetworkOperators.MobileBroadbandRadioState.on
