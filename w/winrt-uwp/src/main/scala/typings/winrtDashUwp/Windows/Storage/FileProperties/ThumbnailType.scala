...
import typings.winrtDashUwp.Windows.Storage.FileProperties.ThumbnailType.icon
import typings.winrtDashUwp.Windows.Storage.FileProperties.ThumbnailType.image
