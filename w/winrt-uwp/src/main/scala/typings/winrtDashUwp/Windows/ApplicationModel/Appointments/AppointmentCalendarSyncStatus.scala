...
object AppointmentCalendarSyncStatus extends js.Object {
  ...
  /* 3 */ val authenticationError: typings.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.authenticationError with Double = js.native
  /* 0 */ val idle: typings.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.idle with Double = js.native
  /* 6 */ val manualAccountRemovalRequired: typings.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.manualAccountRemovalRequired with Double = js.native
  /* 4 */ val policyError: typings.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.policyError with Double = js.native
  /* 1 */ val syncing: typings.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.syncing with Double = js.native
  /* 5 */ val unknownError: typings.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.unknownError with Double = js.native
  /* 2 */ val upToDate: typings.winrtDashUwp.Windows.ApplicationModel.Appointments.AppointmentCalendarSyncStatus.upToDate with Double = js.native
  @JSBracketAccess
