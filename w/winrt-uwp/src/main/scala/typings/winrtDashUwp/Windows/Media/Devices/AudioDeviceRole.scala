...
import typings.winrtDashUwp.Windows.Media.Devices.AudioDeviceRole.communications
import typings.winrtDashUwp.Windows.Media.Devices.AudioDeviceRole.default
