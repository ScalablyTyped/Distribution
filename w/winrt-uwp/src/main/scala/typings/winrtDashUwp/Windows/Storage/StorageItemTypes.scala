...
object StorageItemTypes extends js.Object {
  ...
  /* 1 */ val file: typings.winrtDashUwp.Windows.Storage.StorageItemTypes.file with Double = js.native
  /* 2 */ val folder: typings.winrtDashUwp.Windows.Storage.StorageItemTypes.folder with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.Windows.Storage.StorageItemTypes.none with Double = js.native
  @JSBracketAccess
