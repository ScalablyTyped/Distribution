...
object SimpleOrientation extends js.Object {
  ...
  /* 5 */ val facedown: typings.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.facedown with Double = js.native
  /* 4 */ val faceup: typings.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.faceup with Double = js.native
  /* 0 */ val notRotated: typings.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.notRotated with Double = js.native
  /* 2 */ val rotated180DegreesCounterclockwise: typings.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.rotated180DegreesCounterclockwise with Double = js.native
  /* 3 */ val rotated270DegreesCounterclockwise: typings.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.rotated270DegreesCounterclockwise with Double = js.native
  /* 1 */ val rotated90DegreesCounterclockwise: typings.winrtDashUwp.Windows.Devices.Sensors.SimpleOrientation.rotated90DegreesCounterclockwise with Double = js.native
  @JSBracketAccess
