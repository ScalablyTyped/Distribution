...
import typings.winrtDashUwp.Windows.Networking.Vpn.VpnChannelActivityEventType.active
import typings.winrtDashUwp.Windows.Networking.Vpn.VpnChannelActivityEventType.idle
