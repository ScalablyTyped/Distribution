...
object PhotoImportPowerSource extends js.Object {
  ...
  /* 1 */ val battery: typings.winrtDashUwp.Windows.Media.Import.PhotoImportPowerSource.battery with Double = js.native
  /* 2 */ val external: typings.winrtDashUwp.Windows.Media.Import.PhotoImportPowerSource.external with Double = js.native
  /* 0 */ val unknown: typings.winrtDashUwp.Windows.Media.Import.PhotoImportPowerSource.unknown with Double = js.native
  @JSBracketAccess
