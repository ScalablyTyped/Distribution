...
object HandPreference extends js.Object {
  ...
  /* 0 */ val leftHanded: typings.winrtDashUwp.Windows.UI.ViewManagement.HandPreference.leftHanded with Double = js.native
  /* 1 */ val rightHanded: typings.winrtDashUwp.Windows.UI.ViewManagement.HandPreference.rightHanded with Double = js.native
  @JSBracketAccess
