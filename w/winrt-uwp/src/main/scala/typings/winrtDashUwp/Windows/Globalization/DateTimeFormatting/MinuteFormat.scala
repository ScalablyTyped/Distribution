...
import typings.winrtDashUwp.Windows.Globalization.DateTimeFormatting.MinuteFormat.default
import typings.winrtDashUwp.Windows.Globalization.DateTimeFormatting.MinuteFormat.none
