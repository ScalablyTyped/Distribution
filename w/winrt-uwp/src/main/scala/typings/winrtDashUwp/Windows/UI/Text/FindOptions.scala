...
import typings.winrtDashUwp.Windows.UI.Text.FindOptions.`case`
import typings.winrtDashUwp.Windows.UI.Text.FindOptions.none
import typings.winrtDashUwp.Windows.UI.Text.FindOptions.word
