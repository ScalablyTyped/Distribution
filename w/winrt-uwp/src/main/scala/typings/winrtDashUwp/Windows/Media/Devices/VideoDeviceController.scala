...
import typings.winrtDashUwp.Windows.Media.Capture.MediaStreamType
import typings.winrtDashUwp.Windows.Media.Capture.PowerlineFrequency
import typings.winrtDashUwp.Windows.Media.Devices.Core.VariablePhotoSequenceController
