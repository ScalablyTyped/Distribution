...
object ContactSelectionMode extends js.Object {
  ...
  /* 0 */ val contacts: typings.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactSelectionMode.contacts with Double = js.native
  /* 1 */ val fields: typings.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactSelectionMode.fields with Double = js.native
  @JSBracketAccess
