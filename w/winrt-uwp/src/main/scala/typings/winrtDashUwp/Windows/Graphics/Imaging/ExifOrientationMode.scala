...
object ExifOrientationMode extends js.Object {
  ...
  /* 0 */ val ignoreExifOrientation: typings.winrtDashUwp.Windows.Graphics.Imaging.ExifOrientationMode.ignoreExifOrientation with Double = js.native
  /* 1 */ val respectExifOrientation: typings.winrtDashUwp.Windows.Graphics.Imaging.ExifOrientationMode.respectExifOrientation with Double = js.native
  @JSBracketAccess
