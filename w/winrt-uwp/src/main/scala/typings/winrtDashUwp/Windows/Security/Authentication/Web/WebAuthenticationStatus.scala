...
import typings.winrtDashUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus.errorHttp
import typings.winrtDashUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus.success
import typings.winrtDashUwp.Windows.Security.Authentication.Web.WebAuthenticationStatus.userCancel
