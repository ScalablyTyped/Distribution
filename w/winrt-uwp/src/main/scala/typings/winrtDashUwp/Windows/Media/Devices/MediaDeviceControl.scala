...
import typings.winrtDashUwp.Anon_ReturnValue
import typings.winrtDashUwp.Anon_ReturnValueValue
...
abstract class MediaDeviceControl () extends js.Object {
  ...
  /**
    ...
    */
  def tryGetAuto(): Anon_ReturnValue = js.native
  /**
    * Gets the value of the camera setting.
    */
  def tryGetValue(): Anon_ReturnValueValue = js.native
  /**
