...
object MediaMemoryTypes extends js.Object {
  ...
  /* 1 */ val cpu: typings.winrtDashUwp.Windows.Media.Effects.MediaMemoryTypes.cpu with Double = js.native
  /* 0 */ val gpu: typings.winrtDashUwp.Windows.Media.Effects.MediaMemoryTypes.gpu with Double = js.native
  /* 2 */ val gpuAndCpu: typings.winrtDashUwp.Windows.Media.Effects.MediaMemoryTypes.gpuAndCpu with Double = js.native
  @JSBracketAccess
