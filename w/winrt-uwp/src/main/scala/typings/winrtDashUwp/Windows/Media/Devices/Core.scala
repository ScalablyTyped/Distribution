...
import typings.winrtDashUwp.Windows.Media.Devices.Core.FrameControlCapabilities
import typings.winrtDashUwp.Windows.Media.Devices.Core.FrameController
import typings.winrtDashUwp.Windows.Media.Devices.Core.FrameExposureCapabilities
import typings.winrtDashUwp.Windows.Media.Devices.Core.FrameExposureCompensationCapabilities
import typings.winrtDashUwp.Windows.Media.Devices.Core.FrameExposureCompensationControl
import typings.winrtDashUwp.Windows.Media.Devices.Core.FrameExposureControl
...
import typings.winrtDashUwp.Windows.Media.Devices.Core.FrameIsoSpeedControl
