...
import typings.winrtDashUwp.Windows.Globalization.DateTimeFormatting.SecondFormat.default
import typings.winrtDashUwp.Windows.Globalization.DateTimeFormatting.SecondFormat.none
