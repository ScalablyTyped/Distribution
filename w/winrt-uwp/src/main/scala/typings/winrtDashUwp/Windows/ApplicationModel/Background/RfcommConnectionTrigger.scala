...
import typings.winrtDashUwp.Windows.Devices.Bluetooth.Background.RfcommInboundConnectionInformation
import typings.winrtDashUwp.Windows.Devices.Bluetooth.Background.RfcommOutboundConnectionInformation
