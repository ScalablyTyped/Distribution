...
object GeofenceMonitorStatus extends js.Object {
  ...
  /* 3 */ val disabled: typings.winrtDashUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.disabled with Double = js.native
  /* 1 */ val initializing: typings.winrtDashUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.initializing with Double = js.native
  /* 2 */ val noData: typings.winrtDashUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.noData with Double = js.native
  /* 5 */ val notAvailable: typings.winrtDashUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.notAvailable with Double = js.native
  /* 4 */ val notInitialized: typings.winrtDashUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.notInitialized with Double = js.native
  /* 0 */ val ready: typings.winrtDashUwp.Windows.Devices.Geolocation.Geofencing.GeofenceMonitorStatus.ready with Double = js.native
  @JSBracketAccess
