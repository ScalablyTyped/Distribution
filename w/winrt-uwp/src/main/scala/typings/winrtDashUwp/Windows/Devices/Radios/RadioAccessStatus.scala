...
object RadioAccessStatus extends js.Object {
  ...
  /* 1 */ val allowed: typings.winrtDashUwp.Windows.Devices.Radios.RadioAccessStatus.allowed with Double = js.native
  /* 3 */ val deniedBySystem: typings.winrtDashUwp.Windows.Devices.Radios.RadioAccessStatus.deniedBySystem with Double = js.native
  /* 2 */ val deniedByUser: typings.winrtDashUwp.Windows.Devices.Radios.RadioAccessStatus.deniedByUser with Double = js.native
  /* 0 */ val unspecified: typings.winrtDashUwp.Windows.Devices.Radios.RadioAccessStatus.unspecified with Double = js.native
  @JSBracketAccess
