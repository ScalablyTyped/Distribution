...
import typings.winrtDashUwp.Anon_Results
...
abstract class PerceptionDepthCorrelatedCameraIntrinsics () extends js.Object {
  /**
    ...
    */
  def unprojectAllPixelsAtCorrelatedDepthAsync(depthFrame: PerceptionDepthFrame): Anon_Results = js.native
  /**
  ...
  /**
    ...
    */
  def unprojectRegionPixelsAtCorrelatedDepthAsync(region: Rect, depthFrame: PerceptionDepthFrame): Anon_Results = js.native
}
