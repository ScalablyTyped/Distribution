...
import typings.winrtDashUwp.Windows.UI.Input.HoldingState.canceled
import typings.winrtDashUwp.Windows.UI.Input.HoldingState.completed
import typings.winrtDashUwp.Windows.UI.Input.HoldingState.started
