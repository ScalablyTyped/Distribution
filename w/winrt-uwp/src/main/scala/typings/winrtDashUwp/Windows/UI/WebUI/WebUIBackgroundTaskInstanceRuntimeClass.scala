...
import typings.winrtDashUwp.Windows.ApplicationModel.Background.BackgroundTaskCanceledEventHandler
import typings.winrtDashUwp.Windows.ApplicationModel.Background.BackgroundTaskCancellationReason
import typings.winrtDashUwp.Windows.ApplicationModel.Background.BackgroundTaskDeferral
import typings.winrtDashUwp.Windows.ApplicationModel.Background.BackgroundTaskRegistration
import typings.winrtDashUwp.Windows.ApplicationModel.Background.IBackgroundTaskInstance
