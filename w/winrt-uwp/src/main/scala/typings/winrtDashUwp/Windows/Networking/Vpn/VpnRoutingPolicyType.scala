...
import typings.winrtDashUwp.Windows.Networking.Vpn.VpnRoutingPolicyType.forceAllTrafficOverVpn
import typings.winrtDashUwp.Windows.Networking.Vpn.VpnRoutingPolicyType.splitRouting
