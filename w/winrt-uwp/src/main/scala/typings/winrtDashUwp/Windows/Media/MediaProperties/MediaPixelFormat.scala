...
import typings.winrtDashUwp.Windows.Media.MediaProperties.MediaPixelFormat.bgra8
import typings.winrtDashUwp.Windows.Media.MediaProperties.MediaPixelFormat.nv12
