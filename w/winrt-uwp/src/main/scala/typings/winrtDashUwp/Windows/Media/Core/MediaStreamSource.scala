...
import typings.winrtDashUwp.Windows.Media.Protection.MediaProtectionManager
...
import typings.winrtDashUwp.winrtDashUwpStrings.paused
import typings.winrtDashUwp.winrtDashUwpStrings.samplerequested
import typings.winrtDashUwp.winrtDashUwpStrings.starting
import typings.winrtDashUwp.winrtDashUwpStrings.switchstreamsrequested
