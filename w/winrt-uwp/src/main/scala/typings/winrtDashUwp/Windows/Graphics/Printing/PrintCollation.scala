...
object PrintCollation extends js.Object {
  ...
  /* 3 */ val collated: typings.winrtDashUwp.Windows.Graphics.Printing.PrintCollation.collated with Double = js.native
  /* 0 */ val default: typings.winrtDashUwp.Windows.Graphics.Printing.PrintCollation.default with Double = js.native
  /* 1 */ val notAvailable: typings.winrtDashUwp.Windows.Graphics.Printing.PrintCollation.notAvailable with Double = js.native
  /* 2 */ val printerCustom: typings.winrtDashUwp.Windows.Graphics.Printing.PrintCollation.printerCustom with Double = js.native
  /* 4 */ val uncollated: typings.winrtDashUwp.Windows.Graphics.Printing.PrintCollation.uncollated with Double = js.native
  @JSBracketAccess
