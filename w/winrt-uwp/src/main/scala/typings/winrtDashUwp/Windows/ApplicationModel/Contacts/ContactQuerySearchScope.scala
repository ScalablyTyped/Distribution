...
import typings.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactQuerySearchScope.local
import typings.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactQuerySearchScope.server
