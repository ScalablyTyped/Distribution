...
import typings.winrtDashUwp.Windows.Media.SoundLevel.full
import typings.winrtDashUwp.Windows.Media.SoundLevel.low
import typings.winrtDashUwp.Windows.Media.SoundLevel.muted
