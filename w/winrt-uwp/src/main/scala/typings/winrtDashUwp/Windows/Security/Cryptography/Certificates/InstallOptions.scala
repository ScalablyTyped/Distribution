...
import typings.winrtDashUwp.Windows.Security.Cryptography.Certificates.InstallOptions.deleteExpired
import typings.winrtDashUwp.Windows.Security.Cryptography.Certificates.InstallOptions.none
