...
object DisplayOrientations extends js.Object {
  ...
  /* 1 */ val landscape: typings.winrtDashUwp.Windows.Graphics.Display.DisplayOrientations.landscape with Double = js.native
  /* 3 */ val landscapeFlipped: typings.winrtDashUwp.Windows.Graphics.Display.DisplayOrientations.landscapeFlipped with Double = js.native
  /* 0 */ val none: typings.winrtDashUwp.Windows.Graphics.Display.DisplayOrientations.none with Double = js.native
  /* 2 */ val portrait: typings.winrtDashUwp.Windows.Graphics.Display.DisplayOrientations.portrait with Double = js.native
  /* 4 */ val portraitFlipped: typings.winrtDashUwp.Windows.Graphics.Display.DisplayOrientations.portraitFlipped with Double = js.native
  @JSBracketAccess
