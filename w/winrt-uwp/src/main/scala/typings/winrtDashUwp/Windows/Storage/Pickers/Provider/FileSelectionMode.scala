...
import typings.winrtDashUwp.Windows.Storage.Pickers.Provider.FileSelectionMode.multiple
import typings.winrtDashUwp.Windows.Storage.Pickers.Provider.FileSelectionMode.single
