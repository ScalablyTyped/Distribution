...
object Print3DWorkflowStatus extends js.Object {
  ...
  /* 0 */ val abandoned: typings.winrtDashUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.abandoned with Double = js.native
  /* 1 */ val canceled: typings.winrtDashUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.canceled with Double = js.native
  /* 2 */ val failed: typings.winrtDashUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.failed with Double = js.native
  /* 3 */ val slicing: typings.winrtDashUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.slicing with Double = js.native
  /* 4 */ val submitted: typings.winrtDashUwp.Windows.Devices.Printers.Extensions.Print3DWorkflowStatus.submitted with Double = js.native
  @JSBracketAccess
