...
object UnicodeEncoding extends js.Object {
  ...
  /* 2 */ val utf16BE: typings.winrtDashUwp.Windows.Storage.Streams.UnicodeEncoding.utf16BE with Double = js.native
  /* 1 */ val utf16LE: typings.winrtDashUwp.Windows.Storage.Streams.UnicodeEncoding.utf16LE with Double = js.native
  /* 0 */ val utf8: typings.winrtDashUwp.Windows.Storage.Streams.UnicodeEncoding.utf8 with Double = js.native
  @JSBracketAccess
