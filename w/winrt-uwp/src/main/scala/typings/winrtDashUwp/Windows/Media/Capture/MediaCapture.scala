...
import typings.winrtDashUwp.Windows.Media.Capture.Core.VariablePhotoSequenceCapture
import typings.winrtDashUwp.Windows.Media.Devices.AudioDeviceController
import typings.winrtDashUwp.Windows.Media.Devices.CameraStreamState
import typings.winrtDashUwp.Windows.Media.Devices.MediaCapturePauseBehavior
import typings.winrtDashUwp.Windows.Media.Devices.VideoDeviceController
...
import typings.winrtDashUwp.Windows.Media.IMediaExtension
import typings.winrtDashUwp.Windows.Media.MediaProperties.IMediaEncodingProperties
import typings.winrtDashUwp.Windows.Media.MediaProperties.ImageEncodingProperties
import typings.winrtDashUwp.Windows.Media.MediaProperties.MediaEncodingProfile
import typings.winrtDashUwp.Windows.Media.MediaProperties.MediaPropertySet
import typings.winrtDashUwp.Windows.Media.VideoFrame
