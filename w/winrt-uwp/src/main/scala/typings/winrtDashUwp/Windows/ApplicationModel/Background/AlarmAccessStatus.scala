...
object AlarmAccessStatus extends js.Object {
  ...
  /* 1 */ val allowedWithWakeupCapability: typings.winrtDashUwp.Windows.ApplicationModel.Background.AlarmAccessStatus.allowedWithWakeupCapability with Double = js.native
  /* 2 */ val allowedWithoutWakeupCapability: typings.winrtDashUwp.Windows.ApplicationModel.Background.AlarmAccessStatus.allowedWithoutWakeupCapability with Double = js.native
  /* 3 */ val denied: typings.winrtDashUwp.Windows.ApplicationModel.Background.AlarmAccessStatus.denied with Double = js.native
  /* 0 */ val unspecified: typings.winrtDashUwp.Windows.ApplicationModel.Background.AlarmAccessStatus.unspecified with Double = js.native
  @JSBracketAccess
