...
object ContactListOtherAppWriteAccess extends js.Object {
  ...
  /* 0 */ val none: typings.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactListOtherAppWriteAccess.none with Double = js.native
  /* 1 */ val systemOnly: typings.winrtDashUwp.Windows.ApplicationModel.Contacts.ContactListOtherAppWriteAccess.systemOnly with Double = js.native
  @JSBracketAccess
