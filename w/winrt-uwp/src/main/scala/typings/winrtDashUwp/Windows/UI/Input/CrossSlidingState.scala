...
object CrossSlidingState extends js.Object {
  ...
  /* 6 */ val completed: typings.winrtDashUwp.Windows.UI.Input.CrossSlidingState.completed with Double = js.native
  /* 1 */ val dragging: typings.winrtDashUwp.Windows.UI.Input.CrossSlidingState.dragging with Double = js.native
  /* 5 */ val rearranging: typings.winrtDashUwp.Windows.UI.Input.CrossSlidingState.rearranging with Double = js.native
  /* 3 */ val selectSpeedBumping: typings.winrtDashUwp.Windows.UI.Input.CrossSlidingState.selectSpeedBumping with Double = js.native
  /* 2 */ val selecting: typings.winrtDashUwp.Windows.UI.Input.CrossSlidingState.selecting with Double = js.native
  /* 4 */ val speedBumping: typings.winrtDashUwp.Windows.UI.Input.CrossSlidingState.speedBumping with Double = js.native
  /* 0 */ val started: typings.winrtDashUwp.Windows.UI.Input.CrossSlidingState.started with Double = js.native
  @JSBracketAccess
