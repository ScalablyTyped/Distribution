...
import typings.winrtDashUwp.Anon_ReturnValueTargetCoordinates
...
abstract class PerceptionDepthCorrelatedCoordinateMapper () extends js.Object {
  /**
    ...
    */
  def mapAllPixelsToTargetAsync(depthFrame: PerceptionDepthFrame): Anon_ReturnValueTargetCoordinates = js.native
  /**
  ...
  /**
    ...
    */
  def mapRegionOfPixelsToTargetAsync(region: Rect, depthFrame: PerceptionDepthFrame): Anon_ReturnValueTargetCoordinates = js.native
}
