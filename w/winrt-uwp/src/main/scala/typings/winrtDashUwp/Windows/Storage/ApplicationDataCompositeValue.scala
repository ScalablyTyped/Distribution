...
import typings.winrtDashUwp.Windows.Foundation.Collections.IMapChangedEventArgs
import typings.winrtDashUwp.Windows.Foundation.Collections.IMapView
import typings.winrtDashUwp.Windows.Foundation.Collections.IObservableMap
import typings.winrtDashUwp.Windows.Foundation.Collections.MapChangedEventHandler
