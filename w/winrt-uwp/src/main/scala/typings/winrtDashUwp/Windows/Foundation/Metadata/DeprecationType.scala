...
import typings.winrtDashUwp.Windows.Foundation.Metadata.DeprecationType.deprecate
import typings.winrtDashUwp.Windows.Foundation.Metadata.DeprecationType.remove
