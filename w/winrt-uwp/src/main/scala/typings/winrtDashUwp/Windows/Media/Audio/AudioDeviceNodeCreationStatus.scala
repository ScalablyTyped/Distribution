...
import typings.winrtDashUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.accessDenied
import typings.winrtDashUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.deviceNotAvailable
import typings.winrtDashUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.formatNotSupported
import typings.winrtDashUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.success
import typings.winrtDashUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.unknownFailure
