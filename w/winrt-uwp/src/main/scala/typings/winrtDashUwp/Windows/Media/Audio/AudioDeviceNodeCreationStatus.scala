...
object AudioDeviceNodeCreationStatus extends js.Object {
  ...
  /* 4 */ val accessDenied: typings.winrtDashUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.accessDenied with Double = js.native
  /* 1 */ val deviceNotAvailable: typings.winrtDashUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.deviceNotAvailable with Double = js.native
  /* 2 */ val formatNotSupported: typings.winrtDashUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.formatNotSupported with Double = js.native
  /* 0 */ val success: typings.winrtDashUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.success with Double = js.native
  /* 3 */ val unknownFailure: typings.winrtDashUwp.Windows.Media.Audio.AudioDeviceNodeCreationStatus.unknownFailure with Double = js.native
  @JSBracketAccess
