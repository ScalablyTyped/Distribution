...
import typings.winrtDashUwp.winrtDashUwpStrings.querychanged
import typings.winrtDashUwp.winrtDashUwpStrings.querysubmitted
import typings.winrtDashUwp.winrtDashUwpStrings.resultsuggestionchosen
import typings.winrtDashUwp.winrtDashUwpStrings.suggestionsrequested
import typings.winrtDashUwp.winrtDashUwpStrings.visibilitychanged
