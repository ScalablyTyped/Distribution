...
object SignatureValidationResult extends js.Object {
  ...
  /* 2 */ val badMessage: typings.winrtDashUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult.badMessage with Double = js.native
  /* 1 */ val invalidParameter: typings.winrtDashUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult.invalidParameter with Double = js.native
  /* 3 */ val invalidSignature: typings.winrtDashUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult.invalidSignature with Double = js.native
  /* 4 */ val otherErrors: typings.winrtDashUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult.otherErrors with Double = js.native
  /* 0 */ val success: typings.winrtDashUwp.Windows.Security.Cryptography.Certificates.SignatureValidationResult.success with Double = js.native
  @JSBracketAccess
