...
object mod {
  ...
  object BufferSourceOptions {
    ...
    inline def apply(): BufferSourceOptions = {
  ...
  object IntegerOptions {
    ...
    inline def apply(): IntegerOptions = {
      val __obj = js.Dynamic.literal()
  ...
  object StringOptions {
    ...
    extension [Self <: StringOptions](x: Self) {
      ...
      inline def setTreatNullAsEmptyStringUndefined: Self = StObject.set(x, "treatNullAsEmptyString", js.undefined)
    }
  }
}
