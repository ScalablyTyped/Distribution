...
object utilsConstantsMod {
  
  @JSImport("workbox-routing/utils/constants", "defaultMethod")
  @js.native
  val defaultMethod: HTTPMethod = js.native
  
  @JSImport("workbox-routing/utils/constants", "validMethods")
  @js.native
  val validMethods: js.Array[HTTPMethod] = js.native
