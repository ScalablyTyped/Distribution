...
/* Rewritten from type alias, can be one of: 
  - typings.w3cScreenOrientation.w3cScreenOrientationStrings.any
  - typings.w3cScreenOrientation.w3cScreenOrientationStrings.natural
  - typings.w3cScreenOrientation.w3cScreenOrientationStrings.landscape
  - typings.w3cScreenOrientation.w3cScreenOrientationStrings.portrait
  - typings.w3cScreenOrientation.w3cScreenOrientationStrings.`portrait-primary`
  - typings.w3cScreenOrientation.w3cScreenOrientationStrings.`portrait-secondary`
