...
object ^ extends js.Object {
  ...
  def attempt[T](f: whenLib.WhenNs.underscoreNs.Fn0[T]): Promise[T] = js.native
  def attempt[A1, T](f: whenLib.WhenNs.underscoreNs.Fn1[A1, T], arg1: A1): Promise[T] = js.native
  def attempt[A1, T](f: whenLib.WhenNs.underscoreNs.Fn1[A1, T], arg1: Promise[A1]): Promise[T] = js.native
  def attempt[A1, A2, T](f: whenLib.WhenNs.underscoreNs.Fn2[A1, A2, T], arg1: A1, arg2: A2): Promise[T] = js.native
  def attempt[A1, A2, T](f: whenLib.WhenNs.underscoreNs.Fn2[A1, A2, T], arg1: A1, arg2: Promise[A2]): Promise[T] = js.native
  def attempt[A1, A2, T](f: whenLib.WhenNs.underscoreNs.Fn2[A1, A2, T], arg1: Promise[A1], arg2: A2): Promise[T] = js.native
  def attempt[A1, A2, T](f: whenLib.WhenNs.underscoreNs.Fn2[A1, A2, T], arg1: Promise[A1], arg2: Promise[A2]): Promise[T] = js.native
  def attempt[A1, A2, A3, T](f: whenLib.WhenNs.underscoreNs.Fn3[A1, A2, A3, T], arg1: A1, arg2: A2, arg3: A3): Promise[T] = js.native
  def attempt[A1, A2, A3, T](f: whenLib.WhenNs.underscoreNs.Fn3[A1, A2, A3, T], arg1: A1, arg2: A2, arg3: Promise[A3]): Promise[T] = js.native
  def attempt[A1, A2, A3, T](f: whenLib.WhenNs.underscoreNs.Fn3[A1, A2, A3, T], arg1: A1, arg2: Promise[A2], arg3: A3): Promise[T] = js.native
  def attempt[A1, A2, A3, T](f: whenLib.WhenNs.underscoreNs.Fn3[A1, A2, A3, T], arg1: A1, arg2: Promise[A2], arg3: Promise[A3]): Promise[T] = js.native
  def attempt[A1, A2, A3, T](f: whenLib.WhenNs.underscoreNs.Fn3[A1, A2, A3, T], arg1: Promise[A1], arg2: A2, arg3: A3): Promise[T] = js.native
  def attempt[A1, A2, A3, T](f: whenLib.WhenNs.underscoreNs.Fn3[A1, A2, A3, T], arg1: Promise[A1], arg2: A2, arg3: Promise[A3]): Promise[T] = js.native
  def attempt[A1, A2, A3, T](f: whenLib.WhenNs.underscoreNs.Fn3[A1, A2, A3, T], arg1: Promise[A1], arg2: Promise[A2], arg3: A3): Promise[T] = js.native
  ...
  def attempt[A1, A2, A3, A4, T](f: whenLib.WhenNs.underscoreNs.Fn4[A1, A2, A3, A4, T], arg1: A1, arg2: A2, arg3: A3, arg4: A4): Promise[T] = js.native
  ...
  def iterate[U](
    ...
    handler: js.Function1[/* value */ U, Promise[_] | scala.Unit],
    seed: U
  ): Promise[U] = js.native
  def iterate[U](
    f: js.Function1[/* seed */ U, U | Promise[U]],
  ...
  def reduce[T](
    promisesOrValues: js.Array[_],
    reduceFunc: js.Function3[/* reduction */ T, /* value */ js.Any, /* index */ scala.Double, T | Promise[T]],
    initialValue: T
  ): Promise[T] = js.native
  /**
  ...
  def unfold[T, U](
    ...
    predicate: js.Function1[/* value */ U, scala.Boolean | Promise[scala.Boolean]],
    handler: js.Function1[/* value */ T, Promise[_] | scala.Unit],
    seed: U
