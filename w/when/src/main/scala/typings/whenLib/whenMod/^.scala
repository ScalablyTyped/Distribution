...
object ^ extends js.Object {
  def apply(): whenLib.WhenNs.Promise[scala.Unit] = js.native
  def apply[T](promiseOrValue: T | whenLib.WhenNs.Promise[T] | whenLib.WhenNs.Thenable[T]): whenLib.WhenNs.Promise[T] = js.native
  def apply[T, U](
    promiseOrValue: T | whenLib.WhenNs.Promise[T] | whenLib.WhenNs.Thenable[T],
    transform: js.Function1[/* val */ T, U]
