...
import typings.when.WhenNs.underscoreNs.NodeFn0
import typings.when.WhenNs.underscoreNs.NodeFn1
import typings.when.WhenNs.underscoreNs.NodeFn2
import typings.when.WhenNs.underscoreNs.NodeFn3
import typings.when.WhenNs.underscoreNs.NodeFn4
import typings.when.WhenNs.underscoreNs.NodeFn5
