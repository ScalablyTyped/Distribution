...
import typings.when.When.`_`.NodeFn0
import typings.when.When.`_`.NodeFn1
import typings.when.When.`_`.NodeFn2
import typings.when.When.`_`.NodeFn3
import typings.when.When.`_`.NodeFn4
import typings.when.When.`_`.NodeFn5
import typings.when.nodeMod.Resolver
