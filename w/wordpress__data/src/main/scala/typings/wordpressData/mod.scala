...
object mod {
  ...
  inline def createRegistryControl[R /* <: DataRegistry */, T](
  ...
  inline def createRegistrySelector[S /* <: js.Function1[/* key */ String, SelectorMap] */, T](
  ...
  inline def dispatch(key: String): DispatcherMap = ^.asInstanceOf[js.Dynamic].applyDynamic("dispatch")(key.asInstanceOf[js.Any]).asInstanceOf[DispatcherMap]
  ...
  inline def registerGenericStore(key: String, config: GenericStoreConfig): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("registerGenericStore")(key.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def select(key: String): SelectorMap = ^.asInstanceOf[js.Dynamic].applyDynamic("select")(key.asInstanceOf[js.Any]).asInstanceOf[SelectorMap]
  
  @JSImport("@wordpress/data", "subscribe")
  @js.native
  val subscribe: Subscriber = js.native
  
  inline def use[T](plugin: Plugin[T], options: T): DataRegistry = (^.asInstanceOf[js.Dynamic].applyDynamic("use")(plugin.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[DataRegistry]
  ...
  inline def useSelect[T](mapSelect: js.Function1[/* s */ js.Function1[/* key */ String, SelectorMap], T]): T = ^.asInstanceOf[js.Dynamic].applyDynamic("useSelect")(mapSelect.asInstanceOf[js.Any]).asInstanceOf[T]
  ...
  object StoreConfig {
    ...
    extension [Self <: StoreConfig[?], S](x: Self & StoreConfig[S]) {
      ...
      inline def setControls(value: StringDictionary[js.Function1[/* action */ AnyAction, js.Any]]): Self = StObject.set(x, "controls", value.asInstanceOf[js.Any])
      ...
      inline def setPersistVarargs(value: (/* keyof S */ String)*): Self = StObject.set(x, "persist", js.Array(value :_*))
      
      inline def setReducer(value: (/* state */ js.UndefOr[S], AnyAction) => S): Self = StObject.set(x, "reducer", js.Any.fromFunction2(value))
      
      inline def setResolvers(value: StringDictionary[js.Function1[/* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "resolvers", value.asInstanceOf[js.Any])
      
      inline def setResolversUndefined: Self = StObject.set(x, "resolvers", js.undefined)
      
      inline def setSelectors(value: StringDictionary[js.Function2[/* state */ S, /* repeated */ js.Any, js.Any]]): Self = StObject.set(x, "selectors", value.asInstanceOf[js.Any])
