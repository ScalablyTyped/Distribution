...
import typings.webpack.mod.compilation.ChunkTemplate
import typings.webpack.mod.compilation.Compilation
import typings.webpack.mod.compilation.ContextModuleFactory
import typings.webpack.mod.compilation.DependenciesBlock
import typings.webpack.mod.compilation.DllModuleFactory
import typings.webpack.mod.compilation.HotUpdateChunkTemplate
...
trait Typeofcompilation extends js.Object {
  var Asset: Instantiable0[typings.webpack.mod.compilation.Asset]
  var Chunk: Instantiable0[typings.webpack.mod.compilation.Chunk]
  var ChunkGroup: Instantiable0[typings.webpack.mod.compilation.ChunkGroup]
  var ChunkHash: Instantiable0[typings.webpack.mod.compilation.ChunkHash]
  var ChunkTemplate: Instantiable0[typings.webpack.mod.compilation.ChunkTemplate]
