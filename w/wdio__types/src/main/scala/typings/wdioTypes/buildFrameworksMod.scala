...
object buildFrameworksMod {
  ...
  object PickleResult {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PickleResult] (val x: Self) extends AnyVal {
  ...
  object PickleStep {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PickleStep] (val x: Self) extends AnyVal {
