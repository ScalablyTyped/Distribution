...
import typings.wdioTypes.optionsMod.Connection
...
trait Capabilities
  ...
  /**
    ...
    */
  var webSocketUrl: js.UndefOr[Boolean] = js.undefined
}
object Capabilities {
  ...
  extension [Self <: Capabilities](x: Self) {
    ...
    inline def setWebSocketUrl(value: Boolean): Self = StObject.set(x, "webSocketUrl", value.asInstanceOf[js.Any])
