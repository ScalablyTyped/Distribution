...
object OmitTestrunnercapabilitieAfter {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitTestrunnercapabilitieAfter] (val x: Self) extends AnyVal {
    ...
    inline def setBeforeSessionFunction4(
      value: (/* config */ Omit[Testrunner, capabilities], /* capabilities */ RemoteCapability, /* specs */ js.Array[String], /* cid */ String) => Any | js.Promise[Any]
    ...
    inline def setOnCompleteFunction4(
      value: (/* exitCode */ Double, /* config */ Omit[Testrunner, capabilities], /* capabilities */ RemoteCapabilities, /* results */ Any) => Any | js.Promise[Any]
