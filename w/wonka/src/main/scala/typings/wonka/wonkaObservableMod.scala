...
object wonkaObservableMod {
  ...
  object JsObservable {
    ...
    inline def apply[T](subscribe: JsObserver[T] => JsSubscription): JsObservable[T] = {
      val __obj = js.Dynamic.literal(subscribe = js.Any.fromFunction1(subscribe))
      __obj.asInstanceOf[JsObservable[T]]
    }
    
    extension [Self <: JsObservable[?], T](x: Self & JsObservable[T]) {
      
      inline def setSubscribe(value: JsObserver[T] => JsSubscription): Self = StObject.set(x, "subscribe", js.Any.fromFunction1(value))
    }
  }
  ...
  object JsObserver {
    ...
    extension [Self <: JsObserver[?], T](x: Self & JsObserver[T]) {
  ...
  object JsSubscription {
    ...
    extension [Self <: JsSubscription](x: Self) {
