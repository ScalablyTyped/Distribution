...
object mod {
  ...
  inline def fromCallbag[T](callbag: typings.wonka.wonkaCallbagMod.Callbag[Unit, T]): Source[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromCallbag")(callbag.asInstanceOf[js.Any]).asInstanceOf[Source[T]]
  ...
  inline def fromObservable[T](observable: typings.wonka.wonkaObservableMod.JsObservable[T]): Source[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObservable")(observable.asInstanceOf[js.Any]).asInstanceOf[Source[T]]
  ...
  inline def pipe_TABCDEF_Source[T, A, B, C, D, E, F](
    source: Source[T],
    op1: UnaryFn[Source[T], Source[A]],
    op2: UnaryFn[Source[A], Source[B]],
    op3: UnaryFn[Source[B], Source[C]],
  ...
  inline def toCallbag[T](source: Source[T]): typings.wonka.wonkaCallbagMod.Callbag[Unit, T] = ^.asInstanceOf[js.Dynamic].applyDynamic("toCallbag")(source.asInstanceOf[js.Any]).asInstanceOf[typings.wonka.wonkaCallbagMod.Callbag[Unit, T]]
  
  inline def toObservable[T](source: Source[T]): typings.wonka.wonkaObservableMod.JsObservable[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObservable")(source.asInstanceOf[js.Any]).asInstanceOf[typings.wonka.wonkaObservableMod.JsObservable[T]]
  ...
  object JsObserver {
    ...
    inline def apply[T](complete: () => Unit, error: js.Any => Unit, next: T => Unit): JsObserver[T] = {
  ...
  object JsSubscription {
    ...
    inline def apply(unsubscribe: () => Unit): JsSubscription = {
