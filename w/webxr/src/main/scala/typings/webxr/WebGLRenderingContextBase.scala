...
trait WebGLRenderingContextBase extends StObject {
  ...
  @JSName("getExtension")
  @scala.annotation.targetName("getExtension_OCULUS_multiview")
  def getExtension(extensionName: "OCULUS_multiview"): OCULUSMultiview | Null
...
object WebGLRenderingContextBase {
  ...
  inline def apply(
    ...
    makeXRCompatible: () => js.Promise[Unit]
