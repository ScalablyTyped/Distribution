...
/* Rewritten from type alias, can be one of: 
  - typings.webxr.webxrStrings.devicechange
  - typings.webxr.webxrStrings.visibilitychange
  - typings.webxr.webxrStrings.end
  - typings.webxr.webxrStrings.inputsourceschange
  - typings.webxr.webxrStrings.select
  - typings.webxr.webxrStrings.selectstart
  - typings.webxr.webxrStrings.selectend
  - typings.webxr.webxrStrings.squeeze
  - typings.webxr.webxrStrings.squeezestart
  - typings.webxr.webxrStrings.squeezeend
  - typings.webxr.webxrStrings.reset
*/
