...
trait DatetimeAttribute extends _Attribute {
  ...
  var defaultsTo: js.UndefOr[Date | DefaultsToFn[Date]] = js.undefined
  ...
  var enum: js.UndefOr[js.Array[Date]] = js.undefined
  @JSName("equals")
  var equals_FDatetimeAttribute: js.UndefOr[AttributeValidation[_]] = js.undefined
  ...
  var `type`: js.UndefOr[String with datetime] = js.undefined
