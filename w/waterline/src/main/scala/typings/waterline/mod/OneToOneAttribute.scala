...
object OneToOneAttribute {
  ...
  implicit class OneToOneAttributeMutableBuilder[Self <: OneToOneAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultsTo(value: js.Any | DefaultsToFn[_]): Self = StObject.set(x, "defaultsTo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultsToFunction0(value: () => _): Self = StObject.set(x, "defaultsTo", js.Any.fromFunction0(value))
