...
object FloatAttribute {
  ...
  @scala.inline
  implicit class FloatAttributeOps[Self <: FloatAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: js.UndefOr[String] with float): Self = this.set("type", value.asInstanceOf[js.Any])
