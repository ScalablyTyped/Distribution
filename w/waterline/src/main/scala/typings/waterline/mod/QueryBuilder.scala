...
trait QueryBuilder[T] extends StObject {
  ...
  def meta(options: Any): QueryBuilder[T] = js.native
  ...
  def populate(association: String, filter: Any): QueryBuilder[T] = js.native
  ...
  def where(condition: Any): QueryBuilder[T] = js.native
}
