...
/* Inlined waterline.waterline.BaseAttribute<any> & {  type :'json'} */
@js.native
trait JsonAttribute extends _Attribute {
  ...
  var `type`: js.UndefOr[String] with json = js.native
...
object JsonAttribute {
  ...
  @scala.inline
  def apply(`type`: js.UndefOr[String] with json): JsonAttribute = {
  ...
  @scala.inline
  implicit class JsonAttributeOps[Self <: JsonAttribute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: js.UndefOr[String] with json): Self = this.set("type", value.asInstanceOf[js.Any])
