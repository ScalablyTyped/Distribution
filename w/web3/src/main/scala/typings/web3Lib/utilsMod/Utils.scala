...
trait Utils extends js.Object {
  ...
  def fromDecimal(`val`: js.Any): java.lang.String = js.native
  ...
  def fromWei(`val`: js.Any): js.Any = js.native
  def fromWei(`val`: js.Any, unit: Unit): js.Any = js.native
  ...
  def hexToNumber(`val`: js.Any): scala.Double = js.native
  ...
  def hexToNumberString(`val`: js.Any): java.lang.String = js.native
  ...
  def numberToHex(`val`: js.Any): java.lang.String = js.native
  ...
  def toWei(`val`: js.Any): js.Any = js.native
  def toWei(`val`: js.Any, unit: Unit): js.Any = js.native
