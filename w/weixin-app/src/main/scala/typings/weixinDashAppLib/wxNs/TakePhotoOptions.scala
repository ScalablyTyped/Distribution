...
trait TakePhotoOptions
  ...
  @JSName("success")
  var success_TakePhotoOptions: js.UndefOr[js.Function1[/* res */ weixinDashAppLib.Anon_TempImagePath, scala.Unit]] = js.undefined
}
...
object TakePhotoOptions {
  ...
  def apply(
    ...
    success: js.Function1[/* res */ weixinDashAppLib.Anon_TempImagePath, scala.Unit] = null
  ): TakePhotoOptions = {
