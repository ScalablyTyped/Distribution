...
trait ComponentOptions[Instance /* <: Component[Data, Props] */, Data, Methods, Props] extends js.Object {
  ...
  /**
  		 ...
  		 * @version 1.9.90
  		 */
  var externalClasses: js.UndefOr[js.Array[java.lang.String]] = js.undefined
  /**
  		 ...
  		 */
  var lifetimes: js.UndefOr[stdLib.Partial[Lifetimes]] = js.undefined
  /**
  ...
  /**
  		 ...
  		 */
  var pageLifetimes: js.UndefOr[stdLib.Partial[PageLifetimes]] = js.undefined
  /**
