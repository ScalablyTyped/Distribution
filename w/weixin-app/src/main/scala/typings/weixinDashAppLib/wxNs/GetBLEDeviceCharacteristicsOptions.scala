...
trait GetBLEDeviceCharacteristicsOptions
  ...
  /**
  		 ...
  		 */
  @JSName("success")
  def success_MGetBLEDeviceCharacteristicsOptions(res: weixinDashAppLib.Anon_Characteristics with ErrMsgResponse): scala.Unit
}
...
object GetBLEDeviceCharacteristicsOptions {
  ...
  def apply(
    ...
    success: js.Function1[weixinDashAppLib.Anon_Characteristics with ErrMsgResponse, scala.Unit],
