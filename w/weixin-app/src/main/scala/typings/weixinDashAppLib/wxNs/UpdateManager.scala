...
object UpdateManager {
  ...
  def apply(
    ...
    onCheckForUpdate: js.Function1[/* result */ weixinDashAppLib.Anon_HasUpdate, scala.Unit] => scala.Unit,
    onUpdateFailed: js.Function1[/* res */ weixinDashAppLib.Anon_ErrMsg, scala.Unit] => scala.Unit,
