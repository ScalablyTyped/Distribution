...
trait ShareAppMessage
  ...
  @JSName("success")
  var success_ShareAppMessage: js.UndefOr[js.Function1[/* res */ weixinDashAppLib.Anon_ShareTickets, scala.Unit]] = js.undefined
  /**
  		 * 分享标题  默认为当前小程序名称
  		 *
  		 */
...
object ShareAppMessage {
  ...
  def apply(
    ...
    success: js.Function1[/* res */ weixinDashAppLib.Anon_ShareTickets, scala.Unit] = null,
