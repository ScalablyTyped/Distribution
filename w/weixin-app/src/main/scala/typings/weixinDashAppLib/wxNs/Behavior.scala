...
object Behavior {
  ...
  def apply[Data, Props, Methods](
    ...
    __obj.updateDynamic("__DO_NOT_USE_INTERNAL_FIELD_DATA")(__DO_NOT_USE_INTERNAL_FIELD_DATA.asInstanceOf[js.Any])
    __obj.updateDynamic("__DO_NOT_USE_INTERNAL_FIELD_METHODS")(__DO_NOT_USE_INTERNAL_FIELD_METHODS.asInstanceOf[js.Any])
    __obj.updateDynamic("__DO_NOT_USE_INTERNAL_FIELD_PROPS")(__DO_NOT_USE_INTERNAL_FIELD_PROPS.asInstanceOf[js.Any])
