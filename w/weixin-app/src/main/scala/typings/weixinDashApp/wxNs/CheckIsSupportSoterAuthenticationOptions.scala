...
import typings.weixinDashApp.Anon_ErrMsgSupportMode
...
trait CheckIsSupportSoterAuthenticationOptions
  ...
  @JSName("success")
  var success_CheckIsSupportSoterAuthenticationOptions: js.UndefOr[js.Function1[/* res */ Anon_ErrMsgSupportMode, Unit]] = js.undefined
}
...
object CheckIsSupportSoterAuthenticationOptions {
  ...
  def apply(
    ...
    success: /* res */ Anon_ErrMsgSupportMode => Unit = null
