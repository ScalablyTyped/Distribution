...
import typings.weixinDashApp.Anon_ErrMsgIsEnrolled
...
trait CheckIsSoterEnrolledInDeviceOptions
  ...
  var checkAuthMode: AuthModes
   // 认证方式
  @JSName("success")
  var success_CheckIsSoterEnrolledInDeviceOptions: js.UndefOr[js.Function1[/* res */ Anon_ErrMsgIsEnrolled, Unit]] = js.undefined
}
