...
import typings.weixinDashApp.Anon_CharacteristicIdDeviceId
...
object ^ extends js.Object {
  ...
  /**
  	 ...
  	 */
  def onBLECharacteristicValueChange(callback: js.Function1[/* res */ Anon_CharacteristicIdDeviceId, Unit]): Unit = js.native
  /**
  	 * 监听低功耗蓝牙连接的错误事件，包括设备丢失，连接异常断开等等。
  	 */
  def onBLEConnectionStateChanged(callback: js.Function1[/* res */ Anon_Connected, Unit]): Unit = js.native
  /**
  	 * 监听音乐暂停。
  	 * @deprecated 1.2.0
  	 */
  ...
  /**
  	 ...
  	 * @version 1.1.0
  	 */
  def onBluetoothDeviceFound(callback: js.Function1[/* res */ Anon_Devices, Unit]): Unit = js.native
  /**
  ...
  /**
  	 ...
  	 * @version 1.1.0
  	 */
  def onNetworkStatusChange(callback: js.Function1[/* res */ Anon_IsConnected, Unit]): Unit = js.native
  /** 监听WebSocket关闭。 */
