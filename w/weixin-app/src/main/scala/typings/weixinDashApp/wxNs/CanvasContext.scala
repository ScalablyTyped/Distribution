...
import typings.weixinDashApp.weixinDashAppStrings.center
import typings.weixinDashApp.weixinDashAppStrings.left
import typings.weixinDashApp.weixinDashAppStrings.right
