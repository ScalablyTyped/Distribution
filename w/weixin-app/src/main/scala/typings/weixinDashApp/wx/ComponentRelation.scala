...
trait ComponentRelation[D, P] extends js.Object {
  ...
  var linkChanged: js.UndefOr[
    js.Function1[/* target */ typings.weixinDashApp.wx.Component[D, P, js.Array[js.Any]], Unit]
  ] = js.undefined
...
object ComponentRelation {
  ...
  def apply[D, P](
    ...
    linkChanged: /* target */ typings.weixinDashApp.wx.Component[D, P, js.Array[js.Any]] => Unit = null,
    linked: /* target */ typings.weixinDashApp.wx.Component[D, P, js.Array[js.Any]] => Unit = null,
    target: String = null,
    unlinked: /* target */ typings.weixinDashApp.wx.Component[D, P, js.Array[js.Any]] => Unit = null
