...
import typings.weixinDashApp.Anon_Bubbles
...
trait Component[D, P, B /* <: js.Array[(Behavior[js.Object, js.Object, js.Object]) | String] */] extends js.Object {
  /**
  		 * 组件数据，包括内部数据和属性值
  		 */
  var data: D with UnboxBehaviorsData[B] with typings.weixinDashApp.weixinDashAppStrings.Component with js.Any = js.native
  /**
  		 * 节点dataset
  		 */
  ...
  /**
  		 ...
  		 */
  var properties: D with UnboxBehaviorsData[B] with typings.weixinDashApp.weixinDashAppStrings.Component with js.Any = js.native
  /**
