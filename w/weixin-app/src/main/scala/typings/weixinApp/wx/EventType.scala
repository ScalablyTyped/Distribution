...
/* Rewritten from type alias, can be one of: 
  - typings.weixinApp.weixinAppStrings.input
  - typings.weixinApp.weixinAppStrings.form
  - typings.weixinApp.weixinAppStrings.submit
  - typings.weixinApp.weixinAppStrings.scroll
  - typings.weixinApp.weixinAppStrings.tap
  - typings.weixinApp.weixinAppStrings.longpress
