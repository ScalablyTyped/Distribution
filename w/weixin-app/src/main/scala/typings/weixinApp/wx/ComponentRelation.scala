...
object ComponentRelation {
  ...
  extension [Self <: ComponentRelation[?, ?], D, P](x: Self & (ComponentRelation[D, P])) {
    ...
    inline def setLinkChanged(value: /* target */ Component[D, P, js.Array[js.Any]] => Unit): Self = StObject.set(x, "linkChanged", js.Any.fromFunction1(value))
    
    inline def setLinkChangedUndefined: Self = StObject.set(x, "linkChanged", js.undefined)
    
    inline def setLinked(value: /* target */ Component[D, P, js.Array[js.Any]] => Unit): Self = StObject.set(x, "linked", js.Any.fromFunction1(value))
    ...
    inline def setUnlinked(value: /* target */ Component[D, P, js.Array[js.Any]] => Unit): Self = StObject.set(x, "unlinked", js.Any.fromFunction1(value))
