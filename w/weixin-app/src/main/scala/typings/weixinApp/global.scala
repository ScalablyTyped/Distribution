...
object global {
  ...
  /**
    ...
    */
  inline def App[T /* <: AppOptions */](app: T & (ThisType[T & typings.weixinApp.wx.App])): Unit = js.Dynamic.global.applyDynamic("App")(app.asInstanceOf[js.Any]).asInstanceOf[Unit]
