...
object global extends js.Object {
  /**
    ...
    */
  def App[T /* <: AppOptions */](app: T with (ThisType[T with typings.weixinApp.wx.App])): Unit = js.native
  /**
    ...
    */
  def Behavior[D, M, P, B /* <: js.Array[(typings.weixinApp.wx.Behavior[js.Object, js.Object, js.Object]) | String] */](): typings.weixinApp.wx.Behavior[
    D with UnboxBehaviorsData[B], 
    P with UnboxBehaviorsProps[B], 
    M with UnboxBehaviorsMethods[B]
  ] = js.native
  def Behavior[D, M, P, B /* <: js.Array[(typings.weixinApp.wx.Behavior[js.Object, js.Object, js.Object]) | String] */](options: ThisTypedComponentOptionsWithRecordProps[Component[D, P, B], D, M, P, B]): typings.weixinApp.wx.Behavior[
    D with UnboxBehaviorsData[B], 
    P with UnboxBehaviorsProps[B], 
    M with UnboxBehaviorsMethods[B]
  ] = js.native
  ...
  /**
    ...
    */
  def Page[T /* <: PageOptions with js.Object */](page: T with (ThisType[T with (typings.weixinApp.wx.Page[js.Object, js.Object])])): Unit = js.native
  /**
    * 获取小程序实例
    */
