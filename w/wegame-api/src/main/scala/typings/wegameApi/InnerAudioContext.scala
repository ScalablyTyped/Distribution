...
object InnerAudioContext {
  ...
  implicit open class MutableBuilder[Self <: InnerAudioContext] (val x: Self) extends AnyVal {
    ...
    inline def setOffCanplay(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "offCanplay", js.Any.fromFunction1(value))
    
    inline def setOffEnded(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "offEnded", js.Any.fromFunction1(value))
    
    inline def setOffError(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "offError", js.Any.fromFunction1(value))
    ...
    inline def setOffSeeked(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "offSeeked", js.Any.fromFunction1(value))
    
    inline def setOffSeeking(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "offSeeking", js.Any.fromFunction1(value))
    
    inline def setOffStop(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "offStop", js.Any.fromFunction1(value))
    
    inline def setOffTimeUpdate(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "offTimeUpdate", js.Any.fromFunction1(value))
    
    inline def setOffWaiting(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "offWaiting", js.Any.fromFunction1(value))
    
    inline def setOnCanplay(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "onCanplay", js.Any.fromFunction1(value))
    ...
    inline def setOnSeeked(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "onSeeked", js.Any.fromFunction1(value))
    
    inline def setOnSeeking(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "onSeeking", js.Any.fromFunction1(value))
    
    inline def setOnStop(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "onStop", js.Any.fromFunction1(value))
    
    inline def setOnTimeUpdate(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "onTimeUpdate", js.Any.fromFunction1(value))
