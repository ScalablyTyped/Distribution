...
import typings.wegameApi.AnonCardListAnonCardExt
import typings.wegameApi.AnonCardListAnonCardExtCardId
...
object addCard extends js.Object {
  /**
    ...
    */
  def apply(param: AnonCardListAnonCardExt with CallbacksWithType[AnonCardListAnonCardExtCardId]): Unit = js.native
}
