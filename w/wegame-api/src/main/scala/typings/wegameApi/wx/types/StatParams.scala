...
object StatParams {
  ...
  @scala.inline
  implicit class StatParamsMutableBuilder[Self <: StatParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSuccess(value: /* res */ Stat => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
