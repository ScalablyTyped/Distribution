...
trait AnonAdUnitIdCount extends js.Object {
  /**
    * 推荐单元 id
    */
  var adUnitId: String
...
object AnonAdUnitIdCount {
  @scala.inline
  def apply(adUnitId: String, count: Double, style: js.Array[AnonAppNameHidden]): AnonAdUnitIdCount = {
    ...
    __obj.asInstanceOf[AnonAdUnitIdCount]
  }
}
