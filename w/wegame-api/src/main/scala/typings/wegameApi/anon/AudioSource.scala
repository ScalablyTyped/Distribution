...
object AudioSource {
  ...
  implicit class AudioSourceOps[Self <: AudioSource] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNumberOfChannels(value: typings.wegameApi.wegameApiNumbers.`1` | typings.wegameApi.wegameApiNumbers.`2`): Self = this.set("numberOfChannels", value.asInstanceOf[js.Any])
    @scala.inline
