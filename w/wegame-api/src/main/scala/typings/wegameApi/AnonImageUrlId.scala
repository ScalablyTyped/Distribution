...
trait AnonImageUrlId extends js.Object {
  /**
...
object AnonImageUrlId {
  @scala.inline
  def apply(openId: String, imageUrl: String = null, imageUrlId: String = null, title: String = null): AnonImageUrlId = {
    ...
    __obj.asInstanceOf[AnonImageUrlId]
  }
}
