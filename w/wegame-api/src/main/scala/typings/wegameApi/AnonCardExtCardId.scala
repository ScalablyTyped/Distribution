...
trait AnonCardExtCardId extends js.Object {
  /**
...
object AnonCardExtCardId {
  @scala.inline
  def apply(cardExt: String, cardId: String, code: String, isSuccess: Boolean): AnonCardExtCardId = {
    ...
    __obj.asInstanceOf[AnonCardExtCardId]
  }
}
