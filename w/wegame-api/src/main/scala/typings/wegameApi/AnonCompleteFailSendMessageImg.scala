...
trait AnonCompleteFailSendMessageImg extends js.Object {
...
object AnonCompleteFailSendMessageImg {
  @scala.inline
  def apply(
    complete: () => Unit = null,
    fail: () => Unit = null,
    ...
    success: () => Unit = null
  ): AnonCompleteFailSendMessageImg = {
    ...
    __obj.asInstanceOf[AnonCompleteFailSendMessageImg]
  }
}
