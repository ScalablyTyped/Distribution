...
trait AnonCompleteFailResShareTicket extends js.Object {
...
object AnonCompleteFailResShareTicket {
  @scala.inline
  def apply(
    shareTicket: String,
    complete: () => Unit = null,
