...
object UpdateManager {
  ...
  implicit open class MutableBuilder[Self <: UpdateManager] (val x: Self) extends AnyVal {
    ...
    inline def setOnCheckForUpdate(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "onCheckForUpdate", js.Any.fromFunction1(value))
    
    inline def setOnUpdateFailed(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "onUpdateFailed", js.Any.fromFunction1(value))
    
    inline def setOnUpdateReady(value: js.Function0[Unit] => Unit): Self = StObject.set(x, "onUpdateReady", js.Any.fromFunction1(value))
  }
}
