...
trait AnonCompleteFailItemColor extends js.Object {
...
object AnonCompleteFailItemColor {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonCompleteFailItemColor]
  }
}
