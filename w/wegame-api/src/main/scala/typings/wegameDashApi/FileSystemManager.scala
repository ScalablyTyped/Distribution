...
import typings.wegameDashApi.wx.types.AccessfileParams
import typings.wegameDashApi.wx.types.AppendfileParams
import typings.wegameDashApi.wx.types.CallbacksWithType
import typings.wegameDashApi.wx.types.CopyfileParams
import typings.wegameDashApi.wx.types.FileContentEncoding
import typings.wegameDashApi.wx.types.FileinfoParams
import typings.wegameDashApi.wx.types.MkdirParams
import typings.wegameDashApi.wx.types.ReaddirParams
import typings.wegameDashApi.wx.types.ReadfileParams
import typings.wegameDashApi.wx.types.RemovefileParams
import typings.wegameDashApi.wx.types.RenameParams
import typings.wegameDashApi.wx.types.RmdirParams
import typings.wegameDashApi.wx.types.SavedfileList
import typings.wegameDashApi.wx.types.SavefileParams
import typings.wegameDashApi.wx.types.StatParams
import typings.wegameDashApi.wx.types.UnlinkParams
import typings.wegameDashApi.wx.types.UnzipParams
import typings.wegameDashApi.wx.types.WritefileParams
