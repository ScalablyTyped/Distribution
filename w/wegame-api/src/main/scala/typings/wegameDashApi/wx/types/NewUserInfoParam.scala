...
import typings.wegameDashApi.Anon_DataReadonlyArray
...
trait NewUserInfoParam extends js.Object {
  ...
  var success: js.UndefOr[js.Function1[/* res */ Anon_DataReadonlyArray, Unit]] = js.undefined
}
...
object NewUserInfoParam {
  ...
  def apply(
    ...
    success: /* res */ Anon_DataReadonlyArray => Unit = null
  ): NewUserInfoParam = {
