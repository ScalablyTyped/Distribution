...
import typings.wegameDashApi.wegameDashApiStrings.contain
import typings.wegameDashApi.wegameDashApiStrings.cover
import typings.wegameDashApi.wegameDashApiStrings.fill
...
class Video () extends js.Object {
  ...
  /**
    * 取消监听视频播放进度更新事件
    */
  def offTimeUpdate(callback: js.Function1[/* res */ Anon_Duration, Unit]): Unit = js.native
  /**
    * 取消监听视频缓冲事件
    */
  ...
  /**
    ...
    */
  def onTimeUpdate(callback: js.Function1[/* res */ Anon_Duration, Unit]): Unit = js.native
  /**
    * 监听视频缓冲事件
    */
