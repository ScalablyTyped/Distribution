...
object buildNodeMod {
  ...
  object default {
    ...
    @JSImport("@wdio/logger/build/node", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@wdio/logger/build/node", "default.clearLogger")
    @js.native
    ...
    @JSImport("@wdio/logger/build/node", "default.setLevel")
    @js.native
    ...
    @JSImport("@wdio/logger/build/node", "default.setLogLevelsConfig")
    @js.native
    ...
    @JSImport("@wdio/logger/build/node", "default.waitForBuffer")
    @js.native
