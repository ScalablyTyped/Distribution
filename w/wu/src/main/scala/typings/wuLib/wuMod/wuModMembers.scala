...
object wuModMembers extends js.Object {
  ...
  def entries[T](obj: ScalablyTyped.runtime.StringDictionary[T]): wuLib.wuMod.wuNs.WuIterable[js.Tuple2[java.lang.String, T]] = js.native
  ...
  def keys(obj: ScalablyTyped.runtime.StringDictionary[js.Any]): wuLib.wuMod.wuNs.WuIterable[java.lang.String] = js.native
  ...
  def values[T](obj: ScalablyTyped.runtime.StringDictionary[T]): wuLib.wuMod.wuNs.WuIterable[T] = js.native
