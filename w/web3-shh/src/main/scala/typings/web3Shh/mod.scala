...
object mod {
  ...
  @js.native
  open class Shh () extends StObject {
    ...
    def newMessageFilter(options: Unit, callback: js.Function2[/* error */ js.Error, /* result */ String, Unit]): js.Promise[String] = js.native
    ...
    def subscribe_messages(
      string: messages,
      options: SubscriptionOptions,
      callback: js.Function3[/* error */ js.Error, /* message */ Notification, /* subscription */ Any, Unit]
    ): Subscribe = js.native
  }
  /* static members */
  object Shh {
