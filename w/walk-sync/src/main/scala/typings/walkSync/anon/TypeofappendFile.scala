...
trait TypeofappendFile extends js.Object {
  ...
  def __promisify__(file: Double, data: String): js.Promise[Unit] = js.native
  def __promisify__(file: Double, data: String, options: WriteFileOptions): js.Promise[Unit] = js.native
  def __promisify__(file: Double, data: Uint8Array): js.Promise[Unit] = js.native
  def __promisify__(file: Double, data: Uint8Array, options: WriteFileOptions): js.Promise[Unit] = js.native
  /**
    ...
    */
  def __promisify__(file: PathLike, data: String): js.Promise[Unit] = js.native
  def __promisify__(file: PathLike, data: String, options: WriteFileOptions): js.Promise[Unit] = js.native
  def __promisify__(file: PathLike, data: Uint8Array): js.Promise[Unit] = js.native
  def __promisify__(file: PathLike, data: Uint8Array, options: WriteFileOptions): js.Promise[Unit] = js.native
}
