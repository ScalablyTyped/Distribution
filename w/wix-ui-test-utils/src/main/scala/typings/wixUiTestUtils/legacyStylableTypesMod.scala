...
object legacyStylableTypesMod {
  
  /* Rewritten from type alias, can be one of: 
    - typings.wixUiTestUtils.legacyStylableTypesMod.LegacyStylesheet
    - typings.wixUiTestUtils.legacyStylableTypesMod.CompatStylesheet
    - typings.wixUiTestUtils.legacyStylableTypesMod.StylesheetV2
  */
