...
object TypeofSimulate {
  ...
  inline def apply(
    ...
    animationStart: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    blur: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    canPlay: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    canPlayThrough: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    change: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    click: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    compositionEnd: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    compositionStart: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    compositionUpdate: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    contextMenu: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    copy: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    cut: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    doubleClick: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    drag: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    dragEnd: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    dragEnter: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    dragExit: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    dragLeave: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    dragOver: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    dragStart: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    drop: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    durationChange: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    emptied: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    encrypted: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    ended: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    error: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    focus: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    input: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    invalid: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    keyDown: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    keyPress: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    keyUp: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    load: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    loadStart: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    loadedData: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    loadedMetadata: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    mouseDown: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    mouseEnter: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    mouseLeave: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    mouseMove: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    mouseOut: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    mouseOver: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    mouseUp: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    paste: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    pause: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    play: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    playing: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    progress: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    rateChange: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    scroll: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    seeked: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    seeking: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    select: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    stalled: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    submit: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    suspend: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    timeUpdate: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    touchCancel: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    touchEnd: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    touchMove: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    touchStart: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    transitionEnd: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    volumeChange: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    waiting: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit,
    wheel: (/* element */ typings.std.Element | (Component[js.Any, js.Object, js.Any]), /* eventData */ js.UndefOr[SyntheticEventData]) => Unit
  ): TypeofSimulate = {
