...
object distSrcUnidriverLegacyStylableTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.wixUiTestUtils.distSrcUnidriverLegacyStylableTypesMod.LegacyStylesheet
    - typings.wixUiTestUtils.distSrcUnidriverLegacyStylableTypesMod.CompatStylesheet
    - typings.wixUiTestUtils.distSrcUnidriverLegacyStylableTypesMod.StylesheetV2
  */
