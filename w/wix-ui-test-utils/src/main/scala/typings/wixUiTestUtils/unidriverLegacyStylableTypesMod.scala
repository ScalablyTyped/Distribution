...
object unidriverLegacyStylableTypesMod {
  
  /* Rewritten from type alias, can be one of: 
    - typings.wixUiTestUtils.unidriverLegacyStylableTypesMod.LegacyStylesheet
    - typings.wixUiTestUtils.unidriverLegacyStylableTypesMod.CompatStylesheet
    - typings.wixUiTestUtils.unidriverLegacyStylableTypesMod.StylesheetV2
  */
