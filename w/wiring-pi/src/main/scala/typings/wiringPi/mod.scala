...
object mod {
  ...
  object PiBoardId_ {
    ...
    @scala.inline
    implicit class PiBoardId_MutableBuilder[Self <: PiBoardId_] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setMaker(value: Double): Self = StObject.set(x, "maker", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMem(value: Double): Self = StObject.set(x, "mem", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setModel(value: Double): Self = StObject.set(x, "model", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOvervolted(value: Double): Self = StObject.set(x, "overvolted", value.asInstanceOf[js.Any])
  ...
  object tcs34725HSV {
    ...
    @scala.inline
    implicit class tcs34725HSVMutableBuilder[Self <: tcs34725HSV] (val x: Self) extends AnyVal {
  ...
  object tcs34725RGBC {
    ...
    @scala.inline
    implicit class tcs34725RGBCMutableBuilder[Self <: tcs34725RGBC] (val x: Self) extends AnyVal {
