package typings.websocketDashAsync.websocketDashAsyncMod

import typings.std.CloseEvent
import typings.std.WebSocket
import typings.websocketDashAsync.Anon_Data
...
trait WebSocketClient extends js.Object {
  ...
  var _receiveCallbacksQueue: js.Array[Anon_Data] = js.native
