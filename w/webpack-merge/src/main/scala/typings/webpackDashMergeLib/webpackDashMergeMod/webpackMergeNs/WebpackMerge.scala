package typings
package webpackDashMergeLib.webpackDashMergeMod.webpackMergeNs
...
trait WebpackMerge extends js.Object {
  ...
  def apply(configs: webpackLib.webpackMod.webpackNs.Configuration*): webpackLib.webpackMod.webpackNs.Configuration = js.native
