...
object urlMod {
  ...
  @scala.inline
  def create(globalObject: js.Object): URL = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(globalObject.asInstanceOf[js.Any]).asInstanceOf[URL]
  @scala.inline
  def create(globalObject: js.Object, hasUrlBase: js.Tuple2[String, js.UndefOr[String]]): URL = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(globalObject.asInstanceOf[js.Any], hasUrlBase.asInstanceOf[js.Any])).asInstanceOf[URL]
  @scala.inline
  def create(globalObject: js.Object, hasUrlBase: js.Tuple2[String, js.UndefOr[String]], privateData: js.Object): URL = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(globalObject.asInstanceOf[js.Any], hasUrlBase.asInstanceOf[js.Any], privateData.asInstanceOf[js.Any])).asInstanceOf[URL]
  @scala.inline
  def create(globalObject: js.Object, hasUrlBase: Unit, privateData: js.Object): URL = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(globalObject.asInstanceOf[js.Any], hasUrlBase.asInstanceOf[js.Any], privateData.asInstanceOf[js.Any])).asInstanceOf[URL]
  ...
  @scala.inline
  def setup[T /* <: URL */](obj: T, globalObject: js.Object): T = (^.asInstanceOf[js.Dynamic].applyDynamic("setup")(obj.asInstanceOf[js.Any], globalObject.asInstanceOf[js.Any])).asInstanceOf[T]
  @scala.inline
  def setup[T /* <: URL */](obj: T, globalObject: js.Object, hasUrlBase: js.Tuple2[String, js.UndefOr[String]]): T = (^.asInstanceOf[js.Dynamic].applyDynamic("setup")(obj.asInstanceOf[js.Any], globalObject.asInstanceOf[js.Any], hasUrlBase.asInstanceOf[js.Any])).asInstanceOf[T]
  @scala.inline
  def setup[T /* <: URL */](
    obj: T,
  ...
  @scala.inline
  def setup[T /* <: URL */](obj: T, globalObject: js.Object, hasUrlBase: Unit, privateData: js.Object): T = (^.asInstanceOf[js.Dynamic].applyDynamic("setup")(obj.asInstanceOf[js.Any], globalObject.asInstanceOf[js.Any], hasUrlBase.asInstanceOf[js.Any], privateData.asInstanceOf[js.Any])).asInstanceOf[T]
}
