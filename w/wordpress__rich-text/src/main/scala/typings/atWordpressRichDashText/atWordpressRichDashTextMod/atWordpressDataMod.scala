...
@JSImport("@wordpress/rich-text", "@wordpress/data")
@js.native
object atWordpressDataMod extends js.Object {
  @JSName("dispatch")
  def dispatch_corerichtext(key: `core/rich-text`): js.Any = js.native
  @JSName("select")
  def select_corerichtext(key: `core/rich-text`): js.Any = js.native
}
