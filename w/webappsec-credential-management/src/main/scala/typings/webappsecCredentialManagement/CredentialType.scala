...
object CredentialType {
  ...
  inline def FederatedCredential(id: String, provider: String): typings.webappsecCredentialManagement.FederatedCredential = {
  ...
  inline def PasswordCredential(id: String, idName: String, passwordName: String): typings.webappsecCredentialManagement.PasswordCredential = {
