...
class PasswordCredential protected ()
  ...
  /**
    ...
    */
  var additionalData: CredentialBodyType | scala.Null = js.native
  /**
    ...
    */
  var idName: java.lang.String = js.native
  /**
    ...
    * @see {@link https://www.w3.org/TR/credential-management-1/#passwordcredential}
    */
  val password: js.UndefOr[java.lang.String] = js.native
  /**
    * Represents the name which will be used for the ID field when submitting
    ...
    */
  var passwordName: java.lang.String = js.native
  @JSName("type")
  val type_PasswordCredential: webappsecDashCredentialDashManagementLib.webappsecDashCredentialDashManagementLibStrings.password = js.native
}
