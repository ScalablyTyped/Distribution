...
trait CredentialsContainer extends js.Object {
  /**
    ...
    */
  def create(options: CredentialCreationOptions): js.Promise[CredentialType | scala.Null] = js.native
  /**
    ...
    */
  def get(): js.Promise[CredentialType | scala.Null] = js.native
  def get(options: CredentialRequestOptions): js.Promise[CredentialType | scala.Null] = js.native
  /**
