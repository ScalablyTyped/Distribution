...
object utilsMod {
  ...
  @scala.inline
  def filterSpecArgs(args: js.Array[js.Any]): js.Array[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("filterSpecArgs")(args.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Any]]
  ...
  @scala.inline
  def overwriteElementCommands(propertiesObject: Dictkey): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("overwriteElementCommands")(propertiesObject.asInstanceOf[js.Any]).asInstanceOf[Unit]
