...
object mod {
  ...
  inline def initialisePlugin(name: String): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("initialisePlugin")(name.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  inline def initialisePlugin(name: String, `type`: String): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("initialisePlugin")(name.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[js.Any]
