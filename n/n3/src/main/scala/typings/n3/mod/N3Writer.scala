...
@js.native
trait N3Writer[Q /* <: typings.rdfJs.mod.BaseQuad */] extends js.Object {
  ...
  def addPrefix(prefix: String, iri: typings.rdfJs.mod.NamedNode): Unit = js.native
  def addPrefix(prefix: String, iri: typings.rdfJs.mod.NamedNode, done: js.Function0[Unit]): Unit = js.native
  def addPrefixes(prefixes: Prefixes[typings.rdfJs.mod.NamedNode | String]): Unit = js.native
  def addPrefixes(prefixes: Prefixes[typings.rdfJs.mod.NamedNode | String], done: js.Function0[Unit]): Unit = js.native
