...
trait IEmailComposerService extends js.Object {
  ...
  def isAvailable(): angularLib.angularMod.IPromise[scala.Boolean]
  def open(properties: IEmailComposerOptions): angularLib.angularMod.IPromise[_]
}
...
object IEmailComposerService {
  ...
  def apply(
    ...
    isAvailable: () => angularLib.angularMod.IPromise[scala.Boolean],
    open: IEmailComposerOptions => angularLib.angularMod.IPromise[_]
