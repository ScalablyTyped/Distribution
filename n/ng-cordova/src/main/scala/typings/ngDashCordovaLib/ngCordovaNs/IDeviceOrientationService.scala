...
trait IDeviceOrientationService extends js.Object {
  ...
  def getCurrentHeading(): angularLib.angularMod.IPromise[IDeviceOrientationHeading]
...
object IDeviceOrientationService {
  ...
  def apply(
    ...
    getCurrentHeading: () => angularLib.angularMod.IPromise[IDeviceOrientationHeading],
