...
import typings.nivoStream.mod.DatumToNumber
import typings.nivoStream.mod.StackFunc
import typings.nivoStream.mod.StreamDotsItem
import typings.nivoStream.mod.TooltipFormatter
import typings.nivoStream.mod.TooltipLabel
...
/* Inlined @nivo/stream.@nivo/stream.StreamProps<T> & @nivo/core.@nivo/core.Dimensions */
trait StreamPropsTDimensions[T] extends js.Object {
...
object StreamPropsTDimensions {
  ...
  def apply[T](
    ...
    __obj.asInstanceOf[StreamPropsTDimensions[T]]
  }
}
