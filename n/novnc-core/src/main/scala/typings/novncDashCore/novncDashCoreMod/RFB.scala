...
import typings.novncDashCore.libInputDevicesMod.Keyboard
import typings.novncDashCore.libInputDevicesMod.Mouse
import typings.novncDashCore.novncDashCoreStrings.error
import typings.novncDashCore.novncDashCoreStrings.normal
...
trait RFB extends js.Object {
  ...
  def get_display(): typings.novncDashCore.libDisplayMod.default = js.native
