...
trait StringSchema extends AnySchema {
  ...
  @JSName("normalize")
  def normalize_NFC(form: natsDashHemeraLib.natsDashHemeraLibStrings.NFC): this.type = js.native
  @JSName("normalize")
  def normalize_NFD(form: natsDashHemeraLib.natsDashHemeraLibStrings.NFD): this.type = js.native
  @JSName("normalize")
  def normalize_NFKC(form: natsDashHemeraLib.natsDashHemeraLibStrings.NFKC): this.type = js.native
  @JSName("normalize")
  def normalize_NFKD(form: natsDashHemeraLib.natsDashHemeraLibStrings.NFKD): this.type = js.native
  /**
  ...
  def regex(pattern: stdLib.RegExp, name: java.lang.String): this.type = js.native
