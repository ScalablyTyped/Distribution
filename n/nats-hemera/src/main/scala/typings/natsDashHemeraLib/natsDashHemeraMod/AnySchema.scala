...
trait AnySchema
  ...
  /**
    ...
    */
  var error: js.UndefOr[js.Function1[/* err */ stdLib.Error | ValidationErrorFunction, this.type]] = js.native
  ...
  def default(value: js.Any, description: java.lang.String): this.type = js.native
  /**
  ...
  /**
    * Annotates the key
    */
  def description(desc: java.lang.String): this.type = js.native
  ...
  /**
    ...
    */
  def label(name: java.lang.String): this.type = js.native
  /**
  ...
  def notes(notes: java.lang.String): this.type = js.native
  /**
    * Annotates the key
    */
  def notes(notes: js.Array[java.lang.String]): this.type = js.native
  ...
  def raw(isRaw: scala.Boolean): this.type = js.native
  /**
  ...
  def tags(notes: java.lang.String): this.type = js.native
  /**
    * Annotates the key
    */
  def tags(notes: js.Array[java.lang.String]): this.type = js.native
  /**
    * Annotates the key with an unit name.
    */
  def unit(name: java.lang.String): this.type = js.native
  /**
