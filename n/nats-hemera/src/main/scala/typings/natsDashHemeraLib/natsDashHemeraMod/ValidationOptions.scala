...
object ValidationOptions {
  ...
  def apply(
    ...
    presence: natsDashHemeraLib.natsDashHemeraLibStrings.optional | natsDashHemeraLib.natsDashHemeraLibStrings.required | natsDashHemeraLib.natsDashHemeraLibStrings.forbidden = null,
    skipFunctions: js.UndefOr[scala.Boolean] = js.undefined,
    stripUnknown: scala.Boolean | natsDashHemeraLib.Anon_Arrays = null
  ): ValidationOptions = {
