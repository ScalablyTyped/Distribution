...
package object HemeraNs {
  ...
  type LanguageOptions = java.lang.String | scala.Boolean | scala.Null | ScalablyTyped.runtime.StringDictionary[js.Object]
  type LanguageRootOptions = natsDashHemeraLib.Anon_Root with (stdLib.Partial[stdLib.Record[Types, LanguageOptions]]) with ScalablyTyped.runtime.StringDictionary[LanguageOptions]
