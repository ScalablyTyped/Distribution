...
trait JOI extends js.Object {
  ...
  def assert(value: js.Any, schema: SchemaLike, message: String): js.UndefOr[scala.Nothing] = js.native
  def assert(value: js.Any, schema: SchemaLike, message: Error): js.UndefOr[scala.Nothing] = js.native
  ...
  def isRef(ref: js.Any): /* is nats-hemera.nats-hemera.Reference */ Boolean = js.native
