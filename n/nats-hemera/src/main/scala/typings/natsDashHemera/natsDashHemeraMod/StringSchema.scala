...
import typings.natsDashHemera.natsDashHemeraStrings.NFC
import typings.natsDashHemera.natsDashHemeraStrings.NFD
import typings.natsDashHemera.natsDashHemeraStrings.NFKC
import typings.natsDashHemera.natsDashHemeraStrings.NFKD
...
trait StringSchema extends AnySchema {
  ...
  def regex(pattern: RegExp, name: String): this.type = js.native
