...
object IResponseBody {
  ...
  def apply(
    ...
    failure: Double,
    success: Double,
    multicast_id: js.UndefOr[Double] = js.undefined,
    results: js.Array[Error] = null
  ): IResponseBody = {
    ...
    if (!js.isUndefined(multicast_id)) __obj.updateDynamic("multicast_id")(multicast_id.get.asInstanceOf[js.Any])
