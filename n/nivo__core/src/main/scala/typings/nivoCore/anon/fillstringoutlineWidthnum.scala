...
/* Inlined {  fill :string,   outlineWidth :number,   outlineColor :string,   outlineOpacity :number} & std.Partial<std.Omit<react.react.CSSProperties, 'fill'>> */
trait fillstringoutlineWidthnum extends StObject {
  ...
  var stroke: js.UndefOr[typings.csstype.mod.Property.Stroke] = js.undefined
...
object fillstringoutlineWidthnum {
  ...
  implicit open class MutableBuilder[Self <: fillstringoutlineWidthnum] (val x: Self) extends AnyVal {
    ...
    inline def setStroke(value: typings.csstype.mod.Property.Stroke): Self = StObject.set(x, "stroke", value.asInstanceOf[js.Any])
