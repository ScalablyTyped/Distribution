...
/* Inlined {  stroke :string,   strokeWidth :number,   outlineWidth :number,   outlineColor :string,   outlineOpacity :number} & std.Partial<std.Omit<react.react.CSSProperties, 'stroke' | 'strokeWidth'>> */
trait strokestringstrokeWidthnu extends StObject {
  ...
  var color: js.UndefOr[typings.csstype.mod.Property.Color] = js.undefined
  ...
  var fill: js.UndefOr[typings.csstype.mod.Property.Fill] = js.undefined
  ...
  var fontSize: js.UndefOr[typings.csstype.mod.Property.FontSize[String | Double]] = js.undefined
  ...
  var hack: js.UndefOr[Any] = js.undefined
  ...
  var left: js.UndefOr[typings.csstype.mod.Property.Left[String | Double]] = js.undefined
...
object strokestringstrokeWidthnu {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(outlineColor = outlineColor.asInstanceOf[js.Any], outlineOpacity = outlineOpacity.asInstanceOf[js.Any], outlineWidth = outlineWidth.asInstanceOf[js.Any], stroke = stroke.asInstanceOf[js.Any], strokeWidth = strokeWidth.asInstanceOf[js.Any])
  ...
  extension [Self <: strokestringstrokeWidthnu](x: Self) {
    ...
    inline def setColor(value: typings.csstype.mod.Property.Color): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    inline def setFill(value: typings.csstype.mod.Property.Fill): Self = StObject.set(x, "fill", value.asInstanceOf[js.Any])
    ...
    inline def setFontSize(value: typings.csstype.mod.Property.FontSize[String | Double]): Self = StObject.set(x, "fontSize", value.asInstanceOf[js.Any])
    ...
    inline def setLeft(value: typings.csstype.mod.Property.Left[String | Double]): Self = StObject.set(x, "left", value.asInstanceOf[js.Any])
