...
@js.native
trait FakeServer extends FakeServerOptions {
  ...
  /**
       ...
       * @param request
       */
  def getHTTPMethod(request: FakeXMLHttpRequest): java.lang.String = js.native
  ...
  def respondWith(args: js.Any*): scala.Unit = js.native
  /**
  ...
  /**
       ...
       * @param fn A Function.
       */
  def respondWith(fn: js.Function1[/* xhr */ FakeXMLHttpRequest, scala.Unit]): scala.Unit = js.native
  /**
  ...
  def respondWith(
    ...
    fn: js.Function1[/* xhr */ FakeXMLHttpRequest, scala.Unit]
  ...
  /**
       * Responds to all requests to given URL, e.g. /posts/1.
       */
  def respondWith(url: java.lang.String, fn: js.Function1[/* xhr */ FakeXMLHttpRequest, scala.Unit]): scala.Unit = js.native
  /**
       * Responds to all requests to given URL, e.g. /posts/1.
       */
  ...
  /**
       ...
       * If the response is a Function, it will be passed any capture groups from the regular expression along with the XMLHttpRequest object:
       */
  def respondWith(url: stdLib.RegExp, fn: js.Function1[/* xhr */ FakeXMLHttpRequest, scala.Unit]): scala.Unit = js.native
  /**
       * URL may be a regular expression, e.g. /\\/post\\//\\d+
       * If the response is a Function, it will be passed any capture groups from the regular expression along with the XMLHttpRequest object:
       */
