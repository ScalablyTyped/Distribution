...
object mod {
  ...
  inline def apply(cleanupHandler: Unit, stderrMessages: CtrlC): Unit = (^.asInstanceOf[js.Dynamic].apply(cleanupHandler.asInstanceOf[js.Any], stderrMessages.asInstanceOf[js.Any])).asInstanceOf[Unit]
