...
object nodeStreamMod {
  ...
  ): typings.std.WritableStream[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("pipeline")((scala.List(stream1.asInstanceOf[js.Any], stream2.asInstanceOf[js.Any])).`++`(streams.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[typings.std.WritableStream[Any]]
  inline def pipeline(
    stream1: typings.std.ReadableStream[Any],
