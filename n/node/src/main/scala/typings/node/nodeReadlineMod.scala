...
object nodeReadlineMod {
  ...
  inline def createInterface(input: ReadableStream[Any]): typings.node.readlineMod.Interface = ^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any]).asInstanceOf[typings.node.readlineMod.Interface]
  inline def createInterface(input: ReadableStream[Any], output: Unit, completer: Unit, terminal: Boolean): typings.node.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], completer.asInstanceOf[js.Any], terminal.asInstanceOf[js.Any])).asInstanceOf[typings.node.readlineMod.Interface]
  ...
  inline def createInterface(input: ReadableStream[Any], output: Unit, completer: Completer): typings.node.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], completer.asInstanceOf[js.Any])).asInstanceOf[typings.node.readlineMod.Interface]
  inline def createInterface(input: ReadableStream[Any], output: Unit, completer: Completer, terminal: Boolean): typings.node.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], completer.asInstanceOf[js.Any], terminal.asInstanceOf[js.Any])).asInstanceOf[typings.node.readlineMod.Interface]
  inline def createInterface(input: ReadableStream[Any], output: WritableStream[Any]): typings.node.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any])).asInstanceOf[typings.node.readlineMod.Interface]
  inline def createInterface(input: ReadableStream[Any], output: WritableStream[Any], completer: Unit, terminal: Boolean): typings.node.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], completer.asInstanceOf[js.Any], terminal.asInstanceOf[js.Any])).asInstanceOf[typings.node.readlineMod.Interface]
  ...
  inline def createInterface(input: ReadableStream[Any], output: WritableStream[Any], completer: Completer): typings.node.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], completer.asInstanceOf[js.Any])).asInstanceOf[typings.node.readlineMod.Interface]
  inline def createInterface(input: ReadableStream[Any], output: WritableStream[Any], completer: Completer, terminal: Boolean): typings.node.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], completer.asInstanceOf[js.Any], terminal.asInstanceOf[js.Any])).asInstanceOf[typings.node.readlineMod.Interface]
