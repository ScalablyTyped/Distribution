...
package object childProcessMod {
  ...
  */
  ...
  def exec(
    command: java.lang.String,
    options: typings.node.fsMod.BaseEncodingOptions with typings.node.childProcessMod.ExecOptions
  ...
  // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
  @scala.inline
  def exec(command: java.lang.String, options: typings.node.childProcessMod.ExecOptions): typings.node.childProcessMod.ChildProcess = (typings.node.childProcessMod.^.asInstanceOf[js.Dynamic].applyDynamic("exec")(command.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.node.childProcessMod.ChildProcess]
  // NOTE: This namespace provides design-time support for util.promisify. Exported members do not exist at runtime.
  @scala.inline
  def exec(
    command: java.lang.String,
    options: typings.node.childProcessMod.ExecOptions,
    callback: js.Function3[
      /* error */ typings.node.childProcessMod.ExecException | scala.Null, 
      /* stdout */ java.lang.String, 
      /* stderr */ java.lang.String, 
  ...
  def execFile(
    file: java.lang.String,
    args: js.UndefOr[scala.Nothing],
    options: typings.node.fsMod.BaseEncodingOptions with typings.node.childProcessMod.ExecFileOptions
  ...
  def execFile(
    file: java.lang.String,
    args: js.UndefOr[scala.Nothing],
    options: typings.node.childProcessMod.ExecFileOptions,
    callback: js.Function3[
      /* error */ typings.node.childProcessMod.ExecException | scala.Null, 
      /* stdout */ java.lang.String, 
      /* stderr */ java.lang.String, 
  ...
  def spawn(
    ...
    typings.node.streamMod.Readable
  ] = (typings.node.childProcessMod.^.asInstanceOf[js.Dynamic].applyDynamic("spawn")(command.asInstanceOf[js.Any], args.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.node.childProcessMod.ChildProcessByStdio[
    typings.node.streamMod.Writable, 
    typings.node.streamMod.Readable, 
    typings.node.streamMod.Readable
  ]]
  ...
  def spawn(
    ...
    typings.node.streamMod.Readable, 
    typings.node.streamMod.Readable
  ] = (typings.node.childProcessMod.^.asInstanceOf[js.Dynamic].applyDynamic("spawn")(command.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.node.childProcessMod.ChildProcessByStdio[
    typings.node.streamMod.Writable, 
    typings.node.streamMod.Readable, 
    typings.node.streamMod.Readable
  ]]
