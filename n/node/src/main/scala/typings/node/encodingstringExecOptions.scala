...
/* Inlined {  encoding  :string} & node.child_process.ExecOptions */
trait encodingstringExecOptions extends js.Object {
...
object encodingstringExecOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[encodingstringExecOptions]
  }
}
