...
/* Inlined std.Function & {  cachedData :node.vm.Script['cachedData'] | undefined,   cachedDataProduced :node.vm.Script['cachedDataProduced'] | undefined,   cachedDataRejected :node.vm.Script['cachedDataRejected'] | undefined} */
@js.native
trait FunctioncachedDataScriptc extends StObject {
  ...
  var cachedData: js.UndefOr[typings.node.bufferMod.global.Buffer] = js.native
