...
trait Stdout extends js.Object {
  var stderr: typings.node.Buffer = js.native
  var stdout: typings.node.Buffer = js.native
}
...
object Stdout {
  ...
  implicit class StdoutOps[Self <: Stdout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStderr(value: typings.node.Buffer): Self = this.set("stderr", value.asInstanceOf[js.Any])
    @scala.inline
    def setStdout(value: typings.node.Buffer): Self = this.set("stdout", value.asInstanceOf[js.Any])
  }
