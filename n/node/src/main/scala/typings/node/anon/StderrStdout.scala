...
trait StderrStdout extends js.Object {
  var stderr: String | typings.node.Buffer = js.native
  var stdout: String | typings.node.Buffer = js.native
}
...
object StderrStdout {
  ...
  implicit class StderrStdoutOps[Self <: StderrStdout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStderr(value: String | typings.node.Buffer): Self = this.set("stderr", value.asInstanceOf[js.Any])
    @scala.inline
    def setStdout(value: String | typings.node.Buffer): Self = this.set("stdout", value.asInstanceOf[js.Any])
  }
