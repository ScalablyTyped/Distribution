...
object RunningCodeOptions {
  
  inline def apply(): RunningCodeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RunningCodeOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RunningCodeOptions] (val x: Self) extends AnyVal {
