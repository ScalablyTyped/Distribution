...
@js.native
/* private */ class Decipher () extends Transform {
  ...
  def update(data: String, input_encoding: Unit, output_encoding: Utf8AsciiBinaryEncoding): String = js.native
  ...
  def update(data: ArrayBufferView, input_encoding: Unit, output_encoding: Utf8AsciiBinaryEncoding): String = js.native
  def update(
