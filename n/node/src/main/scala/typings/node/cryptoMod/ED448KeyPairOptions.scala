...
object ED448KeyPairOptions {
  ...
  @scala.inline
  implicit class ED448KeyPairOptionsMutableBuilder[Self <: ED448KeyPairOptions[?, ?], PubF /* <: KeyFormat */, PrivF /* <: KeyFormat */] (val x: Self & (ED448KeyPairOptions[PubF, PrivF])) extends AnyVal {
