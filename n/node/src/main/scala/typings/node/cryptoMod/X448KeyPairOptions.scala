...
object X448KeyPairOptions {
  ...
  @scala.inline
  implicit class X448KeyPairOptionsMutableBuilder[Self <: X448KeyPairOptions[?, ?], PubF /* <: KeyFormat */, PrivF /* <: KeyFormat */] (val x: Self & (X448KeyPairOptions[PubF, PrivF])) extends AnyVal {
