...
object KeyExportOptions {
  @scala.inline
  def apply[/* <: typings.node.cryptoMod.KeyFormat */ T](format: T, `type`: pkcs1 | spki | pkcs8 | sec1): KeyExportOptions[T] = {
    val __obj = js.Dynamic.literal(format = format.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeyExportOptions[T]]
  }
  @scala.inline
  implicit class KeyExportOptionsOps[Self <: KeyExportOptions[_], /* <: typings.node.cryptoMod.KeyFormat */ T] (val x: Self with KeyExportOptions[T]) extends AnyVal {
    @scala.inline
