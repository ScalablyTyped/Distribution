...
object BufferEncoding {
  ...
  @scala.inline
  def `ucs-2`: typings.node.nodeStrings.`ucs-2` = "ucs-2".asInstanceOf[typings.node.nodeStrings.`ucs-2`]
  
  @scala.inline
  def ucs2: typings.node.nodeStrings.ucs2 = "ucs2".asInstanceOf[typings.node.nodeStrings.ucs2]
  
  @scala.inline
  def `utf-8`: typings.node.nodeStrings.`utf-8` = "utf-8".asInstanceOf[typings.node.nodeStrings.`utf-8`]
