...
import typings.node.inspectorMod.NodeRuntimeNs.NotifyWhenWaitingForDisconnectParameterType
...
import typings.node.inspectorMod.NodeWorkerNs.DetachParameterType
