...
import typings.node.NodeJS.PoorMansUnknown
...
object promisify extends js.Object {
  ...
  def apply(fn: js.Function1[/* callback */ js.Function1[js.UndefOr[PoorMansUnknown], Unit], Unit]): js.Function0[js.Promise[Unit]] = js.native
  def apply[T1](
    fn: js.Function2[/* arg1 */ T1, /* callback */ js.Function1[js.UndefOr[PoorMansUnknown], Unit], Unit]
  ...
  def apply[T1, T2](
    fn: js.Function3[
      /* arg1 */ T1, 
      /* arg2 */ T2, 
      /* callback */ js.Function1[js.UndefOr[PoorMansUnknown], Unit], 
      Unit
    ]
