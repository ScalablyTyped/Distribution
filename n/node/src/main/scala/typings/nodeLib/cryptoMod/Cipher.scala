...
trait Cipher
  ...
  def update(data: Binary, input_encoding: js.Any, output_encoding: HexBase64BinaryEncoding): java.lang.String = js.native
  def update(data: Binary, output_encoding: HexBase64BinaryEncoding): java.lang.String = js.native
}
