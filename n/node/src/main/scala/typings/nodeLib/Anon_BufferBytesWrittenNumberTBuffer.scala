...
trait Anon_BufferBytesWrittenNumberTBuffer[TBuffer /* <: stdLib.Uint8Array */] extends js.Object {
  var buffer: TBuffer
...
object Anon_BufferBytesWrittenNumberTBuffer {
  @scala.inline
  def apply[TBuffer /* <: stdLib.Uint8Array */](buffer: TBuffer, bytesWritten: scala.Double): Anon_BufferBytesWrittenNumberTBuffer[TBuffer] = {
