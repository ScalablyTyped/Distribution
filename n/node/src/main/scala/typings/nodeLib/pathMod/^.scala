...
object ^ extends js.Object {
  /**
    ...
    */
  val delimiter: nodeLib.nodeLibStrings.`;` | nodeLib.nodeLibStrings.`:` = js.native
  /**
    * The platform-specific file separator. '\\' or '/'.
    */
  val sep: nodeLib.nodeLibStrings.BACKSLASHBACKSLASH | nodeLib.nodeLibStrings.`/` = js.native
  /**
