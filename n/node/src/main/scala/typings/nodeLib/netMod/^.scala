...
object ^ extends js.Object {
  ...
  def connect(options: NetConnectOpts, connectionListener: js.Function0[scala.Unit]): Socket = js.native
  def connect(path: java.lang.String): Socket = js.native
  def connect(path: java.lang.String, connectionListener: js.Function0[scala.Unit]): Socket = js.native
  def connect(port: scala.Double): Socket = js.native
  def connect(port: scala.Double, host: java.lang.String): Socket = js.native
  def connect(port: scala.Double, host: java.lang.String, connectionListener: js.Function0[scala.Unit]): Socket = js.native
  def createConnection(options: NetConnectOpts): Socket = js.native
  def createConnection(options: NetConnectOpts, connectionListener: js.Function0[scala.Unit]): Socket = js.native
  def createConnection(path: java.lang.String): Socket = js.native
  def createConnection(path: java.lang.String, connectionListener: js.Function0[scala.Unit]): Socket = js.native
  ...
  def createConnection(port: scala.Double, host: java.lang.String, connectionListener: js.Function0[scala.Unit]): Socket = js.native
