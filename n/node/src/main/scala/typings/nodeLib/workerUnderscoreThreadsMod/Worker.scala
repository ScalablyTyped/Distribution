...
class Worker protected ()
  ...
  @JSName("addListener")
  def addListener_error(event: nodeLib.nodeLibStrings.error, listener: js.Function1[/* err */ js.Any, scala.Unit]): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("emit")
  def emit_error(event: nodeLib.nodeLibStrings.error, err: js.Any): scala.Boolean = js.native
  @JSName("emit")
  ...
  @JSName("off")
  def off_error(event: nodeLib.nodeLibStrings.error, listener: js.Function1[/* err */ js.Any, scala.Unit]): this.type = js.native
  @JSName("off")
  def off_exit(
    event: nodeLib.nodeLibStrings.exit,
    listener: js.Function1[/* exitCode */ scala.Double, scala.Unit]
  ...
  @JSName("on")
  def on_error(event: nodeLib.nodeLibStrings.error, listener: js.Function1[/* err */ js.Any, scala.Unit]): this.type = js.native
  @JSName("on")
  def on_exit(
    event: nodeLib.nodeLibStrings.exit,
    listener: js.Function1[/* exitCode */ scala.Double, scala.Unit]
  ...
  @JSName("once")
  def once_error(event: nodeLib.nodeLibStrings.error, listener: js.Function1[/* err */ js.Any, scala.Unit]): this.type = js.native
  @JSName("once")
  def once_exit(
    event: nodeLib.nodeLibStrings.exit,
    listener: js.Function1[/* exitCode */ scala.Double, scala.Unit]
  ...
  def prependListener_error(event: nodeLib.nodeLibStrings.error, listener: js.Function1[/* err */ js.Any, scala.Unit]): this.type = js.native
  @JSName("prependListener")
  ...
  def prependOnceListener_error(event: nodeLib.nodeLibStrings.error, listener: js.Function1[/* err */ js.Any, scala.Unit]): this.type = js.native
  @JSName("prependOnceListener")
  ...
  def removeListener_error(event: nodeLib.nodeLibStrings.error, listener: js.Function1[/* err */ js.Any, scala.Unit]): this.type = js.native
  @JSName("removeListener")
  ...
  def terminate(callback: js.Function2[/* err */ js.Any, /* exitCode */ scala.Double, scala.Unit]): scala.Unit = js.native
