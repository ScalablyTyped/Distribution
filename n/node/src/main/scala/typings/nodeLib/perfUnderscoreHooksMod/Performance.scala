...
trait Performance extends js.Object {
  ...
  /**
           ...
           * @param name
           */
  def clearFunctions(): scala.Unit = js.native
  /**
           * If name is not provided, removes all PerformanceFunction objects from the Performance Timeline.
           * If name is provided, removes entries with name.
           * @param name
           */
  def clearFunctions(name: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
           ...
           * @param name
           */
  def clearMarks(name: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
           ...
           * If name is provided, removes only objects whose performanceEntry.name matches name.
           */
  def clearMeasures(name: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
           ...
           * @param name
           */
  def mark(name: java.lang.String): scala.Unit = js.native
  /**
           ...
           * @param endMark
           */
  def measure(name: java.lang.String, startMark: java.lang.String, endMark: java.lang.String): scala.Unit = js.native
  /**
