package typings.ngDashFacebook
...
import typings.ngDashFacebook.angularMod.ngFacebook.FBUIParams
import typings.ngDashFacebook.angularMod.ngFacebook.IFacebookProvider
