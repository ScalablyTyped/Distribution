...
object DecryptEncryptOptions {
  ...
  def apply(
    ...
    if (apu != null) __obj.updateDynamic("apu")(apu)
    if (apv != null) __obj.updateDynamic("apv")(apv)
    if (enc != null) __obj.updateDynamic("enc")(enc)
    if (epk != null) __obj.updateDynamic("epk")(epk)
    if (epu != null) __obj.updateDynamic("epu")(epu)
    if (epv != null) __obj.updateDynamic("epv")(epv)
    if (iv != null) __obj.updateDynamic("iv")(iv)
    if (kdata != null) __obj.updateDynamic("kdata")(kdata)
    if (mac != null) __obj.updateDynamic("mac")(mac)
    if (p2c != null) __obj.updateDynamic("p2c")(p2c.asInstanceOf[js.Any])
    if (p2s != null) __obj.updateDynamic("p2s")(p2s)
