...
import typings.nodeDashPgDashMigrate.Anon_After
import typings.nodeDashPgDashMigrate.Anon_Authorization
...
trait MigrationBuilder extends js.Object {
  ...
  def addTypeValue(typeName: Name, value: Value, options: Anon_After): Unit = js.native
  ...
  def createSchema(schemaName: String, schemaOptions: Anon_Authorization): Unit = js.native
  // Sequences
