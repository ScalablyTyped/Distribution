...
type RunnerOption = typings.nodePgMigrate.distTypesMod.RunnerOptionConfig & (typings.nodePgMigrate.distTypesMod.RunnerOptionClient | typings.nodePgMigrate.distTypesMod.RunnerOptionUrl)
