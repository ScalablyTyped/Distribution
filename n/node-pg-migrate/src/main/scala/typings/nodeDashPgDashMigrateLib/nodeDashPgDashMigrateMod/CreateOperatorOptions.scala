...
trait CreateOperatorOptions extends js.Object {
  ...
  var hashes: js.UndefOr[scala.Boolean] = js.undefined
  var join: js.UndefOr[Name] = js.undefined
  var left: js.UndefOr[Name] = js.undefined
  var merges: js.UndefOr[scala.Boolean] = js.undefined
...
object CreateOperatorOptions {
  ...
  def apply(
    ...
    hashes: js.UndefOr[scala.Boolean] = js.undefined,
    join: Name = null,
    left: Name = null,
    merges: js.UndefOr[scala.Boolean] = js.undefined,
    negator: Name = null,
    restrict: Name = null,
    right: Name = null
