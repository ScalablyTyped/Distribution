...
object snippetCacheMod {
  ...
  open class SnippetCache protected ()
    ...
    def addEventListener(`type`: fetch, listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | FetchEvent]): Unit = js.native
    def addEventListener(
      `type`: fetch,
      listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | FetchEvent],
      options: Boolean
    ): Unit = js.native
    def addEventListener(
      `type`: fetch,
    ...
    def addEventListener(`type`: restore, listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | RestoreEvent]): Unit = js.native
    def addEventListener(
      `type`: restore,
      listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | RestoreEvent],
      options: Boolean
    ): Unit = js.native
    def addEventListener(
      `type`: restore,
    ...
    def addEventListener(`type`: store, listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | StoreEvent]): Unit = js.native
    def addEventListener(
      `type`: store,
      listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | StoreEvent],
      options: Boolean
    ): Unit = js.native
    def addEventListener(
      `type`: store,
    ...
    def removeEventListener(
      ...
      listener: TypedEventListener[
          SnippetHandler, 
          CustomEvent[Any] | (/* import warning: importer.ImportType#apply Failed type conversion: naja.naja/dist/core/SnippetCache.SnippetCacheEventMap[string] */ js.Any)
        ],
      options: AddEventListenerOptions
    ): Unit = js.native
    def removeEventListener(`type`: fetch, listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | FetchEvent]): Unit = js.native
    def removeEventListener(
      `type`: fetch,
      listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | FetchEvent],
      options: Boolean
    ...
    def removeEventListener(`type`: restore, listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | RestoreEvent]): Unit = js.native
    def removeEventListener(
      `type`: restore,
      listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | RestoreEvent],
      options: Boolean
    ...
    def removeEventListener(`type`: store, listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | StoreEvent]): Unit = js.native
    def removeEventListener(
      `type`: store,
      listener: TypedEventListener[SnippetHandler, CustomEvent[Any] | StoreEvent],
      options: Boolean
