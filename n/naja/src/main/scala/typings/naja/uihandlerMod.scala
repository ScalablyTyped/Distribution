...
import typings.naja.najaMod.Payload
  ...
  open class UIHandler protected ()
    ...
    def addEventListener_interaction(
      ...
      listener: TypedEventListener[
          UIHandler, 
          CustomEvent[Any] | (/* import warning: importer.ImportType#apply Failed type conversion: naja.naja/dist/core/UIHandler.UIHandlerEventMap[string] */ js.Any)
        ]
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_interaction(
    ...
    @JSName("addEventListener")
    def addEventListener_interaction(`type`: interaction, listener: TypedEventListener[UIHandler, CustomEvent[Any] | InteractionEvent]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_interaction(
      `type`: interaction,
      listener: TypedEventListener[UIHandler, CustomEvent[Any] | InteractionEvent],
      options: Boolean
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_interaction(
    ...
    @JSName("removeEventListener")
    def removeEventListener_interaction(`type`: interaction, listener: TypedEventListener[UIHandler, CustomEvent[Any] | InteractionEvent]): Unit = js.native
    @JSName("removeEventListener")
    def removeEventListener_interaction(
      `type`: interaction,
      listener: TypedEventListener[UIHandler, CustomEvent[Any] | InteractionEvent],
