...
package object mod {
  type NajaEventListener[T /* <: typings.std.Event_ */] = (js.Function1[/* event */ T, js.Promise[scala.Unit] | scala.Unit]) | typings.naja.AnonEventHandleEvent[T]
