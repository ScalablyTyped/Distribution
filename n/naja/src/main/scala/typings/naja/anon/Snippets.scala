...
import typings.naja.historyHandlerMod.HistoryState
import typings.naja.snippetCacheMod.CachedSnippets
...
object Snippets {
  ...
  inline def apply(options: typings.naja.najaMod.Options, snippets: CachedSnippets, state: HistoryState): Snippets = {
