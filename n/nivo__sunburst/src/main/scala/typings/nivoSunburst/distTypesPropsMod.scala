...
object distTypesPropsMod {
  ...
  object defaultProps {
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.animate")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.arcLabel")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.arcLabelsRadiusOffset")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.arcLabelsSkipAngle")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.arcLabelsTextColor")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.borderColor")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.borderWidth")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.childColor")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.colorBy")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.colors")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.cornerRadius")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.defs")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.enableArcLabels")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.fill")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.id")
    @js.native
    def id: String = js.native
    inline def id_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("id")(x.asInstanceOf[js.Any])
    
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.inheritColorFromParent")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.isInteractive")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.layers")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.motionConfig")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.role")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.transitionMode")
    @js.native
    ...
    @JSImport("@nivo/sunburst/dist/types/props", "defaultProps.value")
    @js.native
