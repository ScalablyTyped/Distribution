...
trait IDialogOpenConfirmOptions
  extends typings.ngDashDialog.ngDashDialogMod.angularMod.dialogNs.IDialogOpenOptions {
  @JSName("scope")
  var scope_IDialogOpenConfirmOptions: js.UndefOr[typings.ngDashDialog.ngDashDialogMod.angularMod.dialogNs.IDialogConfirmScope] = js.undefined
}
...
object IDialogOpenConfirmOptions {
  ...
  def apply(
    ...
    scope: typings.ngDashDialog.ngDashDialogMod.angularMod.dialogNs.IDialogConfirmScope = null,
