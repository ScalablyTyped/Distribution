...
trait IDialogOpenOptions
  extends typings.ngDashDialog.ngDashDialogMod.angularMod.dialogNs.IDialogOptions {
  ...
  /**
  			 ...
  			 */
  var scope: js.UndefOr[typings.ngDashDialog.ngDashDialogMod.angularMod.dialogNs.IDialogScope] = js.undefined
  var template: String
}
...
object IDialogOpenOptions {
  ...
  def apply(
    ...
    scope: typings.ngDashDialog.ngDashDialogMod.angularMod.dialogNs.IDialogScope = null,
