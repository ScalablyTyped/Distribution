...
trait IDialogProvider extends IServiceProvider {
  /**
  			 ...
  			 * @returns {}
  			 */
  def setDefaults(defaultOptions: typings.ngDashDialog.ngDashDialogMod.angularMod.dialog.IDialogOptions): Unit
  /**
...
object IDialogProvider {
  ...
  def apply(
    $get: js.Any,
    setDefaults: typings.ngDashDialog.ngDashDialogMod.angularMod.dialog.IDialogOptions => Unit,
