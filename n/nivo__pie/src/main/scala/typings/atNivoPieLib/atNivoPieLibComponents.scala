...
object atNivoPieLibComponents {
  ...
  ] = js.constructorOf[atNivoPieLib.atNivoPieMod.Pie].asInstanceOf[reactLib.reactMod.ComponentType[
  atNivoPieLib.atNivoPieMod.PieSvgProps with atNivoCoreLib.atNivoCoreMod.Dimensions]]
  @scala.inline
  def PieCanvas: reactLib.reactMod.ComponentType[
    atNivoPieLib.atNivoPieMod.PieCanvasProps with atNivoCoreLib.atNivoCoreMod.Dimensions
  ] = js.constructorOf[atNivoPieLib.atNivoPieMod.PieCanvas].asInstanceOf[reactLib.reactMod.ComponentType[
  atNivoPieLib.atNivoPieMod.PieCanvasProps with atNivoCoreLib.atNivoCoreMod.Dimensions]]
  @scala.inline
