...
object PieCanvasProps {
  ...
  implicit class PieCanvasPropsOps[Self <: PieCanvasProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: (/* datum */ PieDatum, /* event */ MouseEvent[HTMLCanvasElement, NativeMouseEvent]) => Unit): Self = this.set("onClick", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnClick: Self = this.set("onClick", js.undefined)
    @scala.inline
    def setOnMouseEnter(value: (/* datum */ PieDatum, /* event */ MouseEvent[HTMLCanvasElement, NativeMouseEvent]) => Unit): Self = this.set("onMouseEnter", js.Any.fromFunction2(value))
    @scala.inline
    def deleteOnMouseEnter: Self = this.set("onMouseEnter", js.undefined)
    @scala.inline
    def setOnMouseLeave(value: (/* datum */ PieDatum, /* event */ MouseEvent[HTMLCanvasElement, NativeMouseEvent]) => Unit): Self = this.set("onMouseLeave", js.Any.fromFunction2(value))
    @scala.inline
