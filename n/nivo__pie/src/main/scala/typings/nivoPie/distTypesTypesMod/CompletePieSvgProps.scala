...
object CompletePieSvgProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CompletePieSvgProps[?], RawDatum] (val x: Self & CompletePieSvgProps[RawDatum]) extends AnyVal {
