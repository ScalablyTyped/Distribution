...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setSplitRegexp(value: RegExp | js.Array[RegExp]): Self = StObject.set(x, "splitRegexp", value.asInstanceOf[js.Any])
      
      inline def setSplitRegexpUndefined: Self = StObject.set(x, "splitRegexp", js.undefined)
      
      inline def setSplitRegexpVarargs(value: RegExp*): Self = StObject.set(x, "splitRegexp", js.Array(value :_*))
      
      inline def setStripRegexp(value: RegExp | js.Array[RegExp]): Self = StObject.set(x, "stripRegexp", value.asInstanceOf[js.Any])
      
      inline def setStripRegexpUndefined: Self = StObject.set(x, "stripRegexp", js.undefined)
      
      inline def setStripRegexpVarargs(value: RegExp*): Self = StObject.set(x, "stripRegexp", js.Array(value :_*))
