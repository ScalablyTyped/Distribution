...
object PurchasedProducts {
  ...
  def apply(
    ...
    originalPurchaseDate: js.UndefOr[Double] = js.undefined
  ): PurchasedProducts = {
    ...
    if (!js.isUndefined(isInIntroOfferPeriod)) __obj.updateDynamic("isInIntroOfferPeriod")(isInIntroOfferPeriod.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isTrialPeriod)) __obj.updateDynamic("isTrialPeriod")(isTrialPeriod.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(originalPurchaseDate)) __obj.updateDynamic("originalPurchaseDate")(originalPurchaseDate.get.asInstanceOf[js.Any])
