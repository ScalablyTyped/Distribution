...
/* Rewritten from type alias, can be one of: 
  - typings.nodeRedEditorClient.nodeRedEditorClientStrings.warning
  - typings.nodeRedEditorClient.nodeRedEditorClientStrings.compact
  - typings.nodeRedEditorClient.nodeRedEditorClientStrings.success
  - typings.nodeRedEditorClient.nodeRedEditorClientStrings.error
*/
