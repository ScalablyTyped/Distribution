...
object nodeRedEditorClientStrings {
  ...
  @scala.inline
  def NodePropertiesDef: NodePropertiesDef = "NodePropertiesDef".asInstanceOf[NodePropertiesDef]
  ...
  @scala.inline
  def addToGroup: addToGroup = "addToGroup".asInstanceOf[addToGroup]
  ...
  @scala.inline
  def createGroup: createGroup = "createGroup".asInstanceOf[createGroup]
  ...
  @scala.inline
  def deleteSubflow: deleteSubflow = "deleteSubflow".asInstanceOf[deleteSubflow]
  ...
  @scala.inline
  def filepath: filepath = "filepath".asInstanceOf[filepath]
  ...
  @scala.inline
  def node_label: node_label = "node_label".asInstanceOf[node_label]
  ...
  @scala.inline
  def removeFromGroup: removeFromGroup = "removeFromGroup".asInstanceOf[removeFromGroup]
