...
trait NockBack extends js.Object {
  ...
  def apply(fixtureName: java.lang.String): js.Promise[nockLib.Anon_Context] = js.native
  def apply(
    fixtureName: java.lang.String,
    nockedFn: js.Function1[/* nockDone */ js.Function0[scala.Unit], scala.Unit]
  ): scala.Unit = js.native
  def apply(fixtureName: java.lang.String, options: NockBackOptions): js.Promise[nockLib.Anon_Context] = js.native
  def apply(
    fixtureName: java.lang.String,
