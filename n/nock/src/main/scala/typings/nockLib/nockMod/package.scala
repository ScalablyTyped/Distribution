...
package object nockMod {
  type HttpHeaders = org.scalablytyped.runtime.StringDictionary[java.lang.String | js.Array[java.lang.String] | nockLib.Fn_BodyReq]
  type InterceptFunction = js.Function3[
    /* uri */ java.lang.String | stdLib.RegExp | nockLib.Fn_Uri, 
  ...
  type RequestBodyMatcher = java.lang.String | nodeLib.Buffer | stdLib.RegExp | POJO | nockLib.Fn_Body
  type RequestHeaderMatcher = org.scalablytyped.runtime.StringDictionary[java.lang.String | stdLib.RegExp | nockLib.Fn_HeaderValue]
}
