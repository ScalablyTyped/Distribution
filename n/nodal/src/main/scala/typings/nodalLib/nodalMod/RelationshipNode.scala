...
class RelationshipNode protected () extends js.Object {
  def this(Graph: RelationshipGraph, mModel: nodalLib.Anon_CalcField) = this()
  ...
  def joinsTo(mModel: nodalLib.Anon_CalcField, options: IOptions): RelationshipEdge | scala.Null = js.native
}
