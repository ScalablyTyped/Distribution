...
import typings.nodal.Anon_As
import typings.nodal.Anon_Columns
import typings.nodal.Anon_Convert
import typings.nodal.Anon_Createdat
import typings.nodal.Anon_Params
...
class Model protected () extends js.Object {
  ...
  var aggregateBy: Anon_Createdat = js.native
  ...
  var schema: Anon_Columns = js.native
  /**
  ...
  def __generateSaveQuery__(): Anon_Params = js.native
  /**
  ...
  /**
    ...
    * @return {string}
    */
  def getDataTypeOf(field: String): Anon_Convert = js.native
  /**
...
object Model extends js.Object {
  ...
  /**
    ...
    */
  def joinsTo(modelClass: TypeofClassModelCalcField, options: Anon_As): RelationshipEdge | Null = js.native
  /**
