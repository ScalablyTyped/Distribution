...
object propsMod {
  ...
  object defaultProps {
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.animate")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.borderColor")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.borderWidth")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.colors")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.defs")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.emptyColor")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.emptyOpacity")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.fill")
    @js.native
    def fill: js.Array[scala.Nothing] = js.native
    
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.fillDirection")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.isInteractive")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.legends")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.motionConfig")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.padding")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.pixelRatio")
    @js.native
    ...
    @JSImport("@nivo/waffle/dist/types/props", "defaultProps.role")
    @js.native
