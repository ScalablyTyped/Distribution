...
import typings.nivoColors.distTypesInheritedColorMod.InheritedColorConfigFromContext
import typings.nivoColors.distTypesScalesOrdinalColorScaleMod.OrdinalColorScaleConfigScheme
...
import typings.nivoWaffle.distTypesTypesMod.HtmlProps
