...
import typings.nivoWaffle.mod.ValueFormatter
import typings.nivoWaffle.mod.WaffleDatum
import typings.nivoWaffle.mod.WaffleFillDirection
import typings.nivoWaffle.mod.WaffleTooltipData
...
/* Inlined @nivo/waffle.@nivo/waffle.WaffleSvgProps & @nivo/core.@nivo/core.Dimensions */
trait WaffleSvgPropsDimensions extends js.Object {
...
object WaffleSvgPropsDimensions {
  @scala.inline
  def apply(
    columns: Double,
    ...
    __obj.asInstanceOf[WaffleSvgPropsDimensions]
  }
}
