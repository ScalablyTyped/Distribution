...
import typings.nodecredstash.AnonContextName
import typings.nodecredstash.AnonContextStartsWith
...
trait Credstash extends js.Object {
  ...
  def getAllSecrets(options: AnonContextStartsWith): js.Promise[StringDictionary[String]] = js.native
  ...
  def getSecret(options: AnonContextName): js.Promise[String] = js.native
