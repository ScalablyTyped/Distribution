...
name := "nookies"
version := "1.1-dt-20181020Z-989746"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "cookie" % "0.3-dt-20181120Z-0d750f",
  "org.scalablytyped" %%% "csstype" % "2.5.8-b451f0",
  "org.scalablytyped" %%% "next" % "7.0-dt-20181116Z-6df17f",
  "org.scalablytyped" %%% "next-server" % "7.0-dt-20181116Z-263229",
