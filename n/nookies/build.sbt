...
name := "nookies"
version := "1.1-dt-20181020Z-139730"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "cookie" % "0.3-dt-20181120Z-088905",
  "org.scalablytyped" %%% "csstype" % "2.5.8-939493",
  "org.scalablytyped" %%% "next" % "7.0-dt-20181116Z-498979",
  "org.scalablytyped" %%% "next-server" % "7.0-dt-20181116Z-d4983a",
