...
name := "nookies"
version := "1.1-dt-20181019Z-f065ab"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "cookie" % "0.3-dt-20181113Z-7f2913",
  "org.scalablytyped" %%% "csstype" % "2.5.8-36deb1",
  "org.scalablytyped" %%% "next" % "7.0-dt-20181222Z-203ad3",
  "org.scalablytyped" %%% "next-server" % "7.0-dt-20190108Z-d93d96",
