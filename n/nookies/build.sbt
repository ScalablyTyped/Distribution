...
name := "nookies"
version := "1.1-dt-20181019Z-353561"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "cookie" % "0.3-dt-20181113Z-40691a",
  "org.scalablytyped" %%% "csstype" % "2.6.3-60f3ea",
  "org.scalablytyped" %%% "next" % "8.0-dt-20190220Z-7c2efc",
  "org.scalablytyped" %%% "next-server" % "7.0-dt-20190220Z-3bfe12",
