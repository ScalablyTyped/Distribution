...
object atNivoChordLibComponents extends atNivoChordLibProps {
  ...
  ] = js.constructorOf[atNivoChordLib.atNivoChordMod.Chord].asInstanceOf[reactLib.reactMod.ComponentType[
  atNivoChordLib.atNivoChordMod.ChordProps with atNivoCoreLib.atNivoCoreMod.Dimensions]]
  @scala.inline
  def ChordCanvas: reactLib.reactMod.ComponentType[
    atNivoChordLib.atNivoChordMod.ChordCanvasProps with atNivoCoreLib.atNivoCoreMod.Dimensions
  ] = js.constructorOf[atNivoChordLib.atNivoChordMod.ChordCanvas].asInstanceOf[reactLib.reactMod.ComponentType[
  atNivoChordLib.atNivoChordMod.ChordCanvasProps with atNivoCoreLib.atNivoCoreMod.Dimensions]]
  @scala.inline
