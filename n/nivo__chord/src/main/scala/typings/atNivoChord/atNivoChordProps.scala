...
trait atNivoChordProps {
  ...
  type ResponsiveChordProps = typings.atNivoChord.atNivoChordMod.ChordProps
  @scala.inline
  def ResponsiveChordCanvasProps: typings.atNivoChord.atNivoChordMod.ChordCanvasProps.type = typings.atNivoChord.atNivoChordMod.ChordCanvasProps
  type ResponsiveChordCanvasProps = typings.atNivoChord.atNivoChordMod.ChordCanvasProps
}
