...
/* Inlined @nivo/chord.@nivo/chord.ChordProps & @nivo/core.@nivo/core.Dimensions */
trait ChordPropsDimensions extends js.Object {
...
object ChordPropsDimensions {
  ...
  def apply(
    ...
    __obj.asInstanceOf[ChordPropsDimensions]
  }
}
