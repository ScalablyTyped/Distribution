...
import typings.atNivoChord.atNivoChordMod.ArcData
import typings.atNivoChord.atNivoChordMod.ChordArcMouseHandler
import typings.atNivoChord.atNivoChordMod.LabelAccessor
import typings.atNivoChord.atNivoChordMod.ValueFormatter
...
/* Inlined @nivo/chord.@nivo/chord.ChordCanvasProps & @nivo/core.@nivo/core.Dimensions */
trait ChordCanvasPropsDimensions extends js.Object {
...
object ChordCanvasPropsDimensions {
  @scala.inline
  def apply(
    height: Double,
  ...
  ): ChordCanvasPropsDimensions = {
    val __obj = js.Dynamic.literal(height = height, keys = keys, layers = layers, matrix = matrix, width = width)
    ...
    __obj.asInstanceOf[ChordCanvasPropsDimensions]
  }
}
