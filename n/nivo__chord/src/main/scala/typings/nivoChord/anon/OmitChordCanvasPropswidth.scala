...
import typings.nivoChord.distTypesTypesMod.CustomCanvasLayer
...
/* Inlined std.Omit<@nivo/chord.@nivo/chord/dist/types/types.ChordCanvasProps, 'width' | 'height'> */
trait OmitChordCanvasPropswidth extends StObject {
...
object OmitChordCanvasPropswidth {
  
  inline def apply(data: js.Array[js.Array[Double]], keys: js.Array[String]): OmitChordCanvasPropswidth = {
