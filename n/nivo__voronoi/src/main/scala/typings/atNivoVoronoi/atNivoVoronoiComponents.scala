...
object atNivoVoronoiComponents extends atNivoVoronoiProps {
  @scala.inline
  def ResponsiveVoroinoi: ComponentType[VoronoiProps] = js.constructorOf[typings.atNivoVoronoi.atNivoVoronoiMod.ResponsiveVoroinoi].asInstanceOf[typings.react.reactMod.ComponentType[typings.atNivoVoronoi.atNivoVoronoiMod.VoronoiProps]]
  @scala.inline
