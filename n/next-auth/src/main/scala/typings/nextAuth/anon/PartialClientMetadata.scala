...
/* Inlined std.Partial<openid-client.openid-client.ClientMetadata> */
trait PartialClientMetadata extends StObject {
...
object PartialClientMetadata {
  
  inline def apply(): PartialClientMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialClientMetadata]
  }
  
  extension [Self <: PartialClientMetadata](x: Self) {
