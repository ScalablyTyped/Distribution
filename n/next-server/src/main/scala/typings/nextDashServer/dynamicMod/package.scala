...
package object dynamicMod {
  ...
  import typings.reactDashLoadable.LoadableExport.LoadableComponent
  ...
  type LoadingComponentProps = typings.reactDashLoadable.LoadableExport.LoadingComponentProps
