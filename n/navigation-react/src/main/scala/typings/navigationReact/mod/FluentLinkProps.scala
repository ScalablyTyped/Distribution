...
object FluentLinkProps {
  ...
  def apply(
    ...
    historyAction: add | replace | typings.navigationReact.navigationReactStrings.none = null,
    href: String = null,
    ...
    if (!js.isUndefined(withContext)) __obj.updateDynamic("withContext")(withContext.get.asInstanceOf[js.Any])
