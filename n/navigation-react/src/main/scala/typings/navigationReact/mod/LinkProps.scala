...
object LinkProps {
  ...
  def apply(
    ...
    `aria-autocomplete`: typings.react.reactStrings.none | `inline` | list | both = null,
    ...
    `aria-dropeffect`: typings.react.reactStrings.none | copy | execute | link | move | popup = null,
    ...
    `aria-sort`: typings.react.reactStrings.none | ascending | descending | other = null,
    ...
    id: String = null,
    inlist: js.Any = null,
    inputMode: typings.react.reactStrings.none | text | tel | url | email | numeric | decimal | search = null,
    is: String = null,
    itemID: String = null,
