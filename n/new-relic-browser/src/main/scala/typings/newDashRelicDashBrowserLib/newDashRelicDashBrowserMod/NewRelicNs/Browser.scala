...
trait Browser extends js.Object {
  ...
  /**
           ...
           */
  def addRelease(releaseName: java.lang.String, releaseId: java.lang.String): scala.Unit = js.native
  /**
           ...
           */
  def addToTrace(eventObject: EventObject): scala.Unit = js.native
  /**
  ...
  /**
           ...
           * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-agent-spa-api/finished
           */
  def finished(timestamp: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
           ...
           */
  def noticeError(error: js.Any): scala.Unit = js.native
  /**
           ...
           */
  def setCurrentRouteName(name: java.lang.String): scala.Unit = js.native
  /**
           ...
           */
  def setCustomAttribute(name: java.lang.String, value: java.lang.String): scala.Unit = js.native
  /**
           ...
           */
  def setErrorHandler(filterCallback: js.Function1[/* err */ js.Any, scala.Boolean]): scala.Unit = js.native
  /**
           ...
           */
  def setPageViewName(name: java.lang.String): scala.Unit = js.native
  /**
           * Groups page views to help URL structure or to capture the URL's routing information.
           *
           * @param name Name of the page you want to use when viewing it in New Relic Browser or Insights.
           ...
           * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-agent-spa-api/set-pageview-name
           */
  def setPageViewName(name: java.lang.String, host: java.lang.String): scala.Unit = js.native
}
