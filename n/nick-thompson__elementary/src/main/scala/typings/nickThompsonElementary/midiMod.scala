...
object midiMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.nickThompsonElementary.midiMod.MidiNoteOnEvent
    - typings.nickThompsonElementary.midiMod.MidiNoteOffEvent
    - typings.nickThompsonElementary.midiMod.MidiControllerEvent
  ...
  // MidiMetaEventEvent |
  typings.nickThompsonElementary.midiMod.MidiRawEvent
  */
  trait MidiEvent extends StObject
  object MidiEvent {
    
    inline def MidiControllerEvent(bytes: String, channel: Double, source: String, target: Double, value: Double): typings.nickThompsonElementary.midiMod.MidiControllerEvent = {
      val __obj = js.Dynamic.literal(bytes = bytes.asInstanceOf[js.Any], channel = channel.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("controller")
      __obj.asInstanceOf[typings.nickThompsonElementary.midiMod.MidiControllerEvent]
    }
    
    inline def MidiNoteOffEvent(bytes: String, noteFrequency: Double, noteName: String, noteNumber: Double, source: String): typings.nickThompsonElementary.midiMod.MidiNoteOffEvent = {
      ...
      __obj.asInstanceOf[typings.nickThompsonElementary.midiMod.MidiNoteOffEvent]
    }
    
    inline def MidiNoteOnEvent(bytes: String, noteFrequency: Double, noteName: String, noteNumber: Double, source: String): typings.nickThompsonElementary.midiMod.MidiNoteOnEvent = {
      val __obj = js.Dynamic.literal(bytes = bytes.asInstanceOf[js.Any], noteFrequency = noteFrequency.asInstanceOf[js.Any], noteName = noteName.asInstanceOf[js.Any], noteNumber = noteNumber.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("noteOn")
      __obj.asInstanceOf[typings.nickThompsonElementary.midiMod.MidiNoteOnEvent]
    }
    
    inline def MidiRawEvent(bytes: String, source: String): typings.nickThompsonElementary.midiMod.MidiRawEvent = {
      ...
      __obj.asInstanceOf[typings.nickThompsonElementary.midiMod.MidiRawEvent]
    }
  }
