...
import typings.nickThompsonElementary.childrenMod.NodeChildren
...
import typings.nickThompsonElementary.propsMod.NodeProps
...
object nodeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.nickThompsonElementary.nodeMod.CompositeNode[T]
    - typings.nickThompsonElementary.nodeMod.NativeNode[T]
  */
  trait ConcreteNode[T /* <: NodeType */] extends StObject
  object ConcreteNode {
    
    inline def CompositeNode[T /* <: NodeType */](DollarDollartypeof: Any): typings.nickThompsonElementary.nodeMod.CompositeNode[T] = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("$$typeof")(DollarDollartypeof.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.nickThompsonElementary.nodeMod.CompositeNode[T]]
    }
    
    inline def NativeNode[T /* <: NodeType */](DollarDollartypeof: Any): typings.nickThompsonElementary.nodeMod.NativeNode[T] = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("$$typeof")(DollarDollartypeof.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.nickThompsonElementary.nodeMod.NativeNode[T]]
    }
  }
