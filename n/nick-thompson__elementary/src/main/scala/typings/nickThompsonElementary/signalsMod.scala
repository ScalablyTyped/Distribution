...
object signalsMod {
  ...
  @JSImport("@nick-thompson/elementary/src/signals", "adsr")
  @js.native
  ...
  @JSImport("@nick-thompson/elementary/src/signals", "hann")
  @js.native
  ...
  @JSImport("@nick-thompson/elementary/src/signals", "latch")
  @js.native
  ...
  @JSImport("@nick-thompson/elementary/src/signals", "seq")
  @js.native
