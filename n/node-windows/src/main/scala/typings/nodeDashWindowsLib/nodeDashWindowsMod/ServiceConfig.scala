...
trait ServiceConfig extends js.Object {
  /**
    ...
    */
  var abortOnError: js.UndefOr[scala.Boolean] = js.undefined
  ...
  var logpath: js.UndefOr[java.lang.String] = js.undefined
  /**
    ...
    */
  var maxRestarts: js.UndefOr[scala.Double] = js.undefined
  /**
  ...
  /**
    ...
    */
  var nodeOptions: js.UndefOr[java.lang.String] = js.undefined
  /**
    * @cfg {String} script
  ...
  /**
    ...
    */
  var stopparentfirst: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    */
  var stoptimeout: js.UndefOr[scala.Double] = js.undefined
  /**
    * @cfg {Number} [wait=1]
    * The initial number of seconds to wait before attempting a restart (after the script stops).
    */
  @JSName("wait")
  var wait_FServiceConfig: js.UndefOr[scala.Double] = js.undefined
}
...
object ServiceConfig {
  ...
  def apply(
    ...
    abortOnError: js.UndefOr[scala.Boolean] = js.undefined,
    description: java.lang.String = null,
    env: EnvironmentPair | js.Array[EnvironmentPair] = null,
    execPath: java.lang.String = null,
    grow: scala.Int | scala.Double = null,
    logmode: LogMode = null,
    logpath: java.lang.String = null,
    maxRestarts: scala.Int | scala.Double = null,
    maxRetries: scala.Int | scala.Double = null,
    name: java.lang.String = null,
    nodeOptions: java.lang.String = null,
    stopparentfirst: js.UndefOr[scala.Boolean] = js.undefined,
    stoptimeout: scala.Int | scala.Double = null,
