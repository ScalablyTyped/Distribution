...
trait NextGenEvents extends js.Object {
  ...
  def addListenerContext(
    contextName: java.lang.String,
    options: nextgenDashEventsLib.nextgenDashEventsMod.NextGenEventsNs.ContextOptions
  ): this.type = js.native
  ...
  def emit(name: java.lang.String, args: js.Any*): nextgenDashEventsLib.nextgenDashEventsMod.NextGenEventsNs.Event = js.native
  def emit(nice: scala.Double, name: java.lang.String, args: js.Any*): nextgenDashEventsLib.nextgenDashEventsMod.NextGenEventsNs.Event = js.native
  def enableListenerContext(contextName: java.lang.String): this.type = js.native
  def getAllStates(): nextgenDashEventsLib.nextgenDashEventsMod.NextGenEventsNs.States = js.native
  ...
  def listeners(eventName: java.lang.String): js.Array[nextgenDashEventsLib.nextgenDashEventsMod.NextGenEventsNs.Func] = js.native
