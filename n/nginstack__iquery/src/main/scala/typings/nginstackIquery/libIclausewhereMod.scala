...
object libIclausewhereMod {
  ...
  trait IClauseWhere extends StObject {
    ...
    var iQuery: typings.nginstackIquery.libIqueryMod.^
  ...
  object IClauseWhere {
    ...
    inline def apply(
      ...
      iQuery: typings.nginstackIquery.libIqueryMod.^,
      isInJoinClause: Any,
      isSubSelect: Boolean,
      likeMode: String,
      operator: String,
    ...
    extension [Self <: IClauseWhere](x: Self) {
      ...
      inline def setIQuery(value: typings.nginstackIquery.libIqueryMod.^): Self = StObject.set(x, "iQuery", value.asInstanceOf[js.Any])
