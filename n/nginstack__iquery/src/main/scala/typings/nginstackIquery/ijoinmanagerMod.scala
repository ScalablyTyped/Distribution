...
object ijoinmanagerMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    override def createExplicitJoin(iQueryJoin: typings.nginstackIquery.iqueryMod.^, `type`: Any): typings.nginstackIquery.iclausejoinMod.^ = js.native
    ...
    /* CompleteClass */
    override def iQueryInJoinList(iQuery: typings.nginstackIquery.iqueryMod.^): Boolean = js.native
  }
  @JSImport("@nginstack/iquery/lib/IJoinManager", JSImport.Namespace)
  @js.native
  ...
  trait IJoinManager extends StObject {
    ...
    def createExplicitJoin(iQueryJoin: typings.nginstackIquery.iqueryMod.^, `type`: Any): typings.nginstackIquery.iclausejoinMod.^
    ...
    def iQueryInJoinList(iQuery: typings.nginstackIquery.iqueryMod.^): Boolean
  }
  object IJoinManager {
    ...
    inline def apply(
      ...
      _joins: Any,
      createExplicitJoin: (typings.nginstackIquery.iqueryMod.^, Any) => typings.nginstackIquery.iclausejoinMod.^,
      createImplicitJoin: (String, Any, Any) => js.Object,
      fieldCanBeNull: String => Boolean,
      getColumnsNames: () => CompleteColumnsNames,
      getJoinSql: () => String,
      getWhereSql: () => String,
      iQueryInJoinList: typings.nginstackIquery.iqueryMod.^ => Boolean
    ): IJoinManager = {
    ...
    extension [Self <: IJoinManager](x: Self) {
      ...
      inline def setCreateExplicitJoin(value: (typings.nginstackIquery.iqueryMod.^, Any) => typings.nginstackIquery.iclausejoinMod.^): Self = StObject.set(x, "createExplicitJoin", js.Any.fromFunction2(value))
      ...
      inline def setIQueryInJoinList(value: typings.nginstackIquery.iqueryMod.^ => Boolean): Self = StObject.set(x, "iQueryInJoinList", js.Any.fromFunction1(value))
