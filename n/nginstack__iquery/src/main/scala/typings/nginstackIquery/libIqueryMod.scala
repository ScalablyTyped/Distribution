...
object libIqueryMod {
  ...
  trait IQuery extends StObject {
    ...
    var clauseFrom: typings.nginstackIquery.libIclausefromMod.^ = js.native
    
    def column(field: typings.nginstackIquery.libIclauseselectMod.^, args: Any*): typings.nginstackIquery.libIclauseselectMod.^ = js.native
    def column(field: Record[Any, Any], args: Any*): typings.nginstackIquery.libIclauseselectMod.^ = js.native
