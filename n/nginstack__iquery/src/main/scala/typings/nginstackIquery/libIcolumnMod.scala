...
object libIcolumnMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var field: String | typings.nginstackIquery.libIclauseselectMod.^ = js.native
  ...
  trait ColumnConfig extends StObject {
    ...
    var field: String | typings.nginstackIquery.libIclauseselectMod.^
  ...
  object ColumnConfig {
    ...
    inline def apply(
      ...
      distinct: Boolean,
      field: String | typings.nginstackIquery.libIclauseselectMod.^,
      isSubQuery: Boolean,
      literal: String,
      show: Boolean,
      useCoalesce: Boolean,
    ...
    extension [Self <: ColumnConfig](x: Self) {
      ...
      inline def setField(value: String | typings.nginstackIquery.libIclauseselectMod.^): Self = StObject.set(x, "field", value.asInstanceOf[js.Any])
