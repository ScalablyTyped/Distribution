...
object iclausejoinMod {
  
  inline def apply(iQuery: Any, iQueryJoin: Any, `type`: String, isRightTableAsSubquery: Any): Unit = (^.asInstanceOf[js.Dynamic].apply(iQuery.asInstanceOf[js.Any], iQueryJoin.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], isRightTableAsSubquery.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    extends StObject
       with IClauseJoin {
    def this(iQuery: Any, iQueryJoin: Any, `type`: String, isRightTableAsSubquery: Any) = this()
    ...
    /* CompleteClass */
    override def getClauseOn(index: Double): Any = js.native
    ...
    /* CompleteClass */
    var iQuery: Any = js.native
    
    /* CompleteClass */
    var iQueryJoin: Any = js.native
  ...
  trait IClauseJoin extends StObject {
    ...
    def getClauseOn(index: Double): Any
  ...
  object IClauseJoin {
    ...
    extension [Self <: IClauseJoin](x: Self) {
      ...
      inline def setGetClauseOn(value: Double => Any): Self = StObject.set(x, "getClauseOn", js.Any.fromFunction1(value))
      ...
      inline def setIQuery(value: Any): Self = StObject.set(x, "iQuery", value.asInstanceOf[js.Any])
      
      inline def setIQueryJoin(value: Any): Self = StObject.set(x, "iQueryJoin", value.asInstanceOf[js.Any])
  ...
  trait RightTableAsSubQueryConfig extends StObject {
    ...
    var clauseSelect: typings.nginstackIquery.iclauseselectMod.^
  ...
  object RightTableAsSubQueryConfig {
    ...
    inline def apply(
      clauseSelect: typings.nginstackIquery.iclauseselectMod.^,
      isEnabled: Boolean,
    ...
    extension [Self <: RightTableAsSubQueryConfig](x: Self) {
      ...
      inline def setClauseSelect(value: typings.nginstackIquery.iclauseselectMod.^): Self = StObject.set(x, "clauseSelect", value.asInstanceOf[js.Any])
