...
object iclausefromMod {
  
  inline def apply(iQuery: typings.nginstackIquery.iqueryMod.^, classKey: Double, alias: String): Unit = (^.asInstanceOf[js.Dynamic].apply(iQuery.asInstanceOf[js.Any], classKey.asInstanceOf[js.Any], alias.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    extends StObject
       with IClauseFrom {
    def this(iQuery: typings.nginstackIquery.iqueryMod.^, classKey: Double, alias: String) = this()
  }
  @JSImport("@nginstack/iquery/lib/IClauseFrom", JSImport.Namespace)
  @js.native
