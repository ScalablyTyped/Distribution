...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(doneOnErr)) __obj.updateDynamic("doneOnErr")(doneOnErr.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(shortName)) __obj.updateDynamic("shortName")(shortName.get.asInstanceOf[js.Any])
