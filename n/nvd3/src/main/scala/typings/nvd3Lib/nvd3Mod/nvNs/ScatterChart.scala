...
trait ScatterChart extends Chart {
  ...
  /**/
  def showDistX(): scala.Boolean = js.native
  /**/
  def showDistX(value: scala.Boolean): this.type = js.native
  /**/
  def showDistY(): scala.Boolean = js.native
  /**/
  def showDistY(value: scala.Boolean): this.type = js.native
  ...
  /**/
  def tooltipXContent(): js.Function1[/* d */ js.Any, java.lang.String] = js.native
  /**/
  def tooltipXContent(func: js.Function1[/* d */ js.Any, java.lang.String]): this.type = js.native
  /**/
  def tooltipYContent(): js.Function1[/* d */ js.Any, java.lang.String] = js.native
  /**/
  def tooltipYContent(func: js.Function1[/* d */ js.Any, java.lang.String]): this.type = js.native
