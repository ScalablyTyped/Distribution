...
trait SparkLine extends Nvd3Element {
  def animate(): scala.Boolean = js.native
  def animate(value: scala.Boolean): this.type = js.native
  ...
  def x(): js.Function2[/* d */ js.Any, /* i */ js.UndefOr[scala.Double], scala.Double] = js.native
  /* Proxy function to return the X value so adjustments can be made if needed. For pie/donut chart this returns the key for the slice.*/
  def x(func: js.Function2[/* d */ js.Any, /* i */ js.UndefOr[scala.Double], scala.Double]): this.type = js.native
  ...
  def y(): js.Function2[/* d */ js.Any, /* i */ js.UndefOr[scala.Double], scala.Double] = js.native
  ...
  def y(func: js.Function2[/* d */ js.Any, /* i */ js.UndefOr[scala.Double], scala.Double]): this.type = js.native
