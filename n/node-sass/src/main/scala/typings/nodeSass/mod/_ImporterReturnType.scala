...
object _ImporterReturnType {
  ...
  inline def Contents(contents: String): typings.nodeSass.anon.Contents = {
    val __obj = js.Dynamic.literal(contents = contents.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.nodeSass.anon.Contents]
  }
  ...
  inline def File(file: String): typings.nodeSass.anon.File = {
    val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.nodeSass.anon.File]
  }
