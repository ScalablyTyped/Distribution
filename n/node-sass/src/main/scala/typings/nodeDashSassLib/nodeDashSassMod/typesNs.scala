...
object typesNs extends js.Object {
  ...
  class ColorCls protected () extends Color {
    /**
    		 ...
    		 */
    def this(hexN: scala.Double) = this()
    /**
    ...
    /**
    		 ...
    		 */
    /* CompleteClass */
    override def getA(): scala.Double = js.native
    /**
    		 * Get the blue component of the color.
    		 * @returns integer between 0 and 255 inclusive;
    		 */
    /* CompleteClass */
    override def getB(): scala.Double = js.native
    /**
    		 * Get the green component of the color.
    		 * @returns integer between 0 and 255 inclusive;
    		 */
    /* CompleteClass */
    override def getG(): scala.Double = js.native
    /**
    		 * Get the red component of the color.
    		 * @returns integer between 0 and 255 inclusive;
    		 */
    /* CompleteClass */
    override def getR(): scala.Double = js.native
    /**
    		 * Set the alpha component of the color.
    		 * @param a number between 0 and 1 inclusive;
    		 */
    /* CompleteClass */
    override def setA(a: scala.Double): scala.Unit = js.native
    /**
    		 * Set the blue component of the color.
    		 * @param b integer between 0 and 255 inclusive;
    		 */
    /* CompleteClass */
    override def setB(b: scala.Double): scala.Unit = js.native
    /**
    		 * Set the green component of the color.
    		 * @param g integer between 0 and 255 inclusive;
    		 */
    /* CompleteClass */
    override def setG(g: scala.Double): scala.Unit = js.native
    /**
    		 * Set the red component of the color.
    		 * @returns integer between 0 and 255 inclusive;
    		 */
    /* CompleteClass */
    override def setR(r: scala.Double): scala.Unit = js.native
  }
  ...
  class ListCls protected () extends List {
    ...
    /* CompleteClass */
    override def getValue(index: scala.Double): Value = js.native
    /* CompleteClass */
    override def setSeparator(isComma: scala.Boolean): scala.Unit = js.native
    /* CompleteClass */
    override def setValue(index: scala.Double, value: Value): scala.Unit = js.native
  }
  ...
  class MapCls protected () extends Map {
    def this(length: scala.Double) = this()
    /* CompleteClass */
    override def getKey(index: scala.Double): Value = js.native
    /* CompleteClass */
    override def getLength(): scala.Double = js.native
    /* CompleteClass */
    override def getValue(index: scala.Double): Value = js.native
    /* CompleteClass */
    override def setKey(index: scala.Double, key: Value): scala.Unit = js.native
    /* CompleteClass */
    override def setValue(index: scala.Double, value: Value): scala.Unit = js.native
  }
  ...
  class NumberCls protected () extends Number {
    ...
    /* CompleteClass */
    override def getValue(): scala.Double = js.native
    /* CompleteClass */
    override def setUnit(u: java.lang.String): scala.Unit = js.native
    /* CompleteClass */
    override def setValue(n: scala.Double): scala.Unit = js.native
  }
  ...
  */
  ...
  class StringCls protected () extends String {
    ...
    /* CompleteClass */
    override def setValue(s: java.lang.String): scala.Unit = js.native
  }
