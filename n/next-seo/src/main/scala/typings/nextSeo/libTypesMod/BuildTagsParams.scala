...
- typings.nextSeo.libTypesMod.NextSeoProps because var conflicts: additionalLinkTags, additionalMetaTags, canonical, defaultTitle, description, facebook, languageAlternates, mobileAlternate, openGraph, robotsProps, title, titleTemplate, twitter. Inlined noindex, nofollow */ trait BuildTagsParams
  extends StObject
