...
trait OpeningHoursSpecification extends StObject {
...
object OpeningHoursSpecification {
  ...
  inline def apply(closes: String, dayOfWeek: String | js.Array[String], opens: String): OpeningHoursSpecification = {
    ...
    __obj.asInstanceOf[OpeningHoursSpecification]
  }
  
  extension [Self <: OpeningHoursSpecification](x: Self) {
