...
trait AreaServed extends StObject {
...
object AreaServed {
  ...
  inline def apply(`@type`: String, contactType: String, telephone: String): AreaServed = {
    ...
    __obj.asInstanceOf[AreaServed]
  }
  
  extension [Self <: AreaServed](x: Self) {
