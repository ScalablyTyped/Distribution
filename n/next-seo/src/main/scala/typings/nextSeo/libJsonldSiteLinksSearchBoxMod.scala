...
object libJsonldSiteLinksSearchBoxMod {
  ...
  inline def default(param0: SiteLinksSearchBoxJsonLdProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
