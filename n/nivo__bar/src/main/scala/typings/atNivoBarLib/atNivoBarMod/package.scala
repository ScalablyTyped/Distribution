...
package object atNivoBarMod {
  ...
  type BarCustomLayer = js.Function1[/* props */ js.Any, reactLib.reactMod.ReactNs.ReactNode]
  ...
  type TooltipProp = reactLib.reactMod.ReactNs.StatelessComponent[BarExtendedDatum]
