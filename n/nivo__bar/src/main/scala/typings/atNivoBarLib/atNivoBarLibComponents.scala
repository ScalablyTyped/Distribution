...
object atNivoBarLibComponents extends atNivoBarLibProps {
  ...
  ] = js.constructorOf[atNivoBarLib.atNivoBarMod.Bar].asInstanceOf[reactLib.reactMod.ComponentType[
  atNivoBarLib.atNivoBarMod.BarSvgProps with atNivoCoreLib.atNivoCoreMod.Dimensions]]
  @scala.inline
  def BarCanvas: reactLib.reactMod.ComponentType[
    atNivoBarLib.atNivoBarMod.BarCanvasProps with atNivoCoreLib.atNivoCoreMod.Dimensions
  ] = js.constructorOf[atNivoBarLib.atNivoBarMod.BarCanvas].asInstanceOf[reactLib.reactMod.ComponentType[
  atNivoBarLib.atNivoBarMod.BarCanvasProps with atNivoCoreLib.atNivoCoreMod.Dimensions]]
  @scala.inline
