...
object BarCanvasProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BarCanvasProps[?], RawDatum /* <: BarDatum */] (val x: Self & BarCanvasProps[RawDatum]) extends AnyVal {
    ...
    inline def setRenderBar(value: (/* context */ CanvasRenderingContext2D, /* props */ RenderBarProps[RawDatum]) => Unit): Self = StObject.set(x, "renderBar", js.Any.fromFunction2(value))
