...
import typings.nivoBar.mod.BarDatum
...
import typings.nivoBar.mod.Layer
...
trait BarSvgPropsDimensions extends js.Object {
  ...
  var defs: js.UndefOr[js.Array[typings.nivoCore.AnonId]] = js.undefined
...
object BarSvgPropsDimensions {
  ...
  def apply(
    ...
    defs: js.Array[typings.nivoCore.AnonId] = null,
