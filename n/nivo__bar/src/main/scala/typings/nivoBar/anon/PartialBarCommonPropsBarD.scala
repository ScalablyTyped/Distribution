...
/* Inlined std.Partial<@nivo/bar.@nivo/bar/dist/types/types.BarCommonProps<@nivo/bar.@nivo/bar/dist/types/types.BarDatum>> & @nivo/bar.@nivo/bar/dist/types/types.DataProps<@nivo/bar.@nivo/bar/dist/types/types.BarDatum> & @nivo/bar.@nivo/bar/dist/types/types.BarHandlers<@nivo/bar.@nivo/bar/dist/types/types.BarDatum, std.HTMLCanvasElement> & @nivo/core.@nivo/core.Dimensions & std.Partial<{  axisBottom :@nivo/axes.@nivo/axes.CanvasAxisProps<any> | null,   axisLeft :@nivo/axes.@nivo/axes.CanvasAxisProps<any> | null,   axisRight :@nivo/axes.@nivo/axes.CanvasAxisProps<any> | null,   axisTop :@nivo/axes.@nivo/axes.CanvasAxisProps<any> | null, renderBar (context : std.CanvasRenderingContext2D, props : @nivo/bar.@nivo/bar/dist/types/types.RenderBarProps<@nivo/bar.@nivo/bar/dist/types/types.BarDatum>): void,   layers :std.Array<@nivo/bar.@nivo/bar/dist/types/types.BarCanvasLayer<@nivo/bar.@nivo/bar/dist/types/types.BarDatum>>,   pixelRatio :number}> & react.react.RefAttributes<std.HTMLCanvasElement> */
trait PartialBarCommonPropsBarD extends StObject {
...
object PartialBarCommonPropsBarD {
  
  inline def apply(data: js.Array[BarDatum], height: Double, width: Double): PartialBarCommonPropsBarD = {
