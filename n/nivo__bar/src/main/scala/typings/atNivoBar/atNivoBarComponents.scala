...
object atNivoBarComponents extends atNivoBarProps {
  @scala.inline
  def Bar: ComponentType[BarSvgProps with Dimensions] = js.constructorOf[typings.atNivoBar.atNivoBarMod.Bar].asInstanceOf[typings.react.reactMod.ComponentType[
  typings.atNivoBar.atNivoBarMod.BarSvgProps with typings.atNivoCore.atNivoCoreMod.Dimensions]]
  @scala.inline
