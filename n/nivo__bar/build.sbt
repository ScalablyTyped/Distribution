...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "nivo__annotations" % "0.80.0-e51097",
  "org.scalablytyped" %%% "nivo__axes" % "0.80.0-540f10",
  ...
  "org.scalablytyped" %%% "nivo__scales" % "0.80.0-23c045",
