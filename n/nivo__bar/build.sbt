...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "nivo__annotations" % "0.80.0-11bf9f",
  "org.scalablytyped" %%% "nivo__axes" % "0.80.0-1508a1",
  ...
  "org.scalablytyped" %%% "nivo__scales" % "0.80.0-45e572",
