...
import typings.nodeHorseman.anon.Format
import typings.nodeHorseman.nodeHorsemanStrings.GET
import typings.nodeHorseman.nodeHorsemanStrings.PNG
import typings.nodeHorseman.nodeHorsemanStrings.loadFinished
import typings.nodeHorseman.nodeHorsemanStrings.pageCreated
import typings.nodeHorseman.nodeHorsemanStrings.resourceReceived
import typings.nodeHorseman.nodeHorsemanStrings.resourceTimeout
import typings.nodeHorseman.nodeHorsemanStrings.tabClosed
import typings.nodeHorseman.nodeHorsemanStrings.tabCreated
import typings.nodeHorseman.nodeHorsemanStrings.timeout
import typings.nodeHorseman.nodeHorsemanStrings.urlChanged
...
object mod {
  ...
  @js.native
  trait horseman extends StObject {
