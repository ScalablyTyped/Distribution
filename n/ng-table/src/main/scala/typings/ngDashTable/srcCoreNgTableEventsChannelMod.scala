...
import typings.ngDashTable.srcCoreNgTableEventsChannelMod.EventSelector
import typings.ngDashTable.srcCoreNgTableEventsChannelMod.IAfterCreatedListener
import typings.ngDashTable.srcCoreNgTableEventsChannelMod.IAfterDataFilteredListener
import typings.ngDashTable.srcCoreNgTableEventsChannelMod.IAfterDataSortedListener
import typings.ngDashTable.srcCoreNgTableEventsChannelMod.IAfterReloadDataListener
import typings.ngDashTable.srcCoreNgTableEventsChannelMod.IDatasetChangedListener
import typings.ngDashTable.srcCoreNgTableEventsChannelMod.IEventSelectorFunc
import typings.ngDashTable.srcCoreNgTableEventsChannelMod.IPagesChangedListener
import typings.ngDashTable.srcCoreNgTableEventsChannelMod.IUnregistrationFunc
