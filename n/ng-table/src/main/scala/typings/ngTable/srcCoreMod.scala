...
object srcCoreMod {
  ...
  open class NgTableDefaultGetDataProvider ()
    extends typings.ngTable.srcCoreDataMod.NgTableDefaultGetDataProvider
  
  @JSImport("ng-table/src/core", "NgTableEventsChannel")
  @js.native
  open class NgTableEventsChannel protected ()
    extends typings.ngTable.srcCoreNgTableEventsChannelMod.NgTableEventsChannel {
  ...
  open class NgTableParams[T] ()
    extends typings.ngTable.srcCoreNgTableParamsMod.NgTableParams[T] {
