...
object scrollResolverMod {
  ...
  inline def isTriggeredScroll(totalToScroll: js.Any, scrollState: IScrollState, isScrollingDown: Boolean): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isTriggeredScroll")(totalToScroll.asInstanceOf[js.Any], scrollState.asInstanceOf[js.Any], isScrollingDown.asInstanceOf[js.Any])).asInstanceOf[Boolean]
