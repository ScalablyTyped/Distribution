...
object xySeriesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.nivoGenerators.xySeriesMod.XYRangeStaticValues
    - typings.nivoGenerators.xySeriesMod.XYRandomNumericValues
  */
  trait XYRangeValues extends StObject
  object XYRangeValues {
    
    inline def XYRandomNumericValues(length: Double, max: Double, min: Double): typings.nivoGenerators.xySeriesMod.XYRandomNumericValues = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any], max = max.asInstanceOf[js.Any], min = min.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.nivoGenerators.xySeriesMod.XYRandomNumericValues]
    }
    
    inline def XYRangeStaticValues(values: js.Array[Double | String]): typings.nivoGenerators.xySeriesMod.XYRangeStaticValues = {
      val __obj = js.Dynamic.literal(values = values.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.nivoGenerators.xySeriesMod.XYRangeStaticValues]
    }
  }
}
