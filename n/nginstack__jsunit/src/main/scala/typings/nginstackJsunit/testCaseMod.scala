...
object testCaseMod {
  ...
  object TestCase {
    ...
    inline def apply(event: Any, getId: () => String, logger_ : Any, methodName: String, name: String, testSuite: Any): TestCase = {
    ...
    extension [Self <: TestCase](x: Self) {
      ...
      inline def setTestSuite(value: Any): Self = StObject.set(x, "testSuite", value.asInstanceOf[js.Any])
    }
  }
}
