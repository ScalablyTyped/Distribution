...
object testRunnerMod {
  
  inline def apply(suite: Any): Unit = ^.asInstanceOf[js.Dynamic].apply(suite.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def apply(suite: Any, opt_trackingId: String): Unit = (^.asInstanceOf[js.Dynamic].apply(suite.asInstanceOf[js.Any], opt_trackingId.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    extends StObject
       with TestRunner {
    def this(suite: Any) = this()
    def this(suite: Any, opt_trackingId: String) = this()
    ...
    /* CompleteClass */
    override def runTest(testName: String): typings.nginstackJsunit.testResultMod.^ = js.native
  ...
  trait TestRunner extends StObject {
    ...
    def runTest(testName: String): typings.nginstackJsunit.testResultMod.^
  ...
  object TestRunner {
    ...
    inline def apply(
      ...
      loadSuite_ : Any,
      logger_ : Any,
      runTest: String => typings.nginstackJsunit.testResultMod.^,
      scriptRunner_ : Any,
      suite_ : Any,
      trackingId_ : Any
    ): TestRunner = {
    ...
    extension [Self <: TestRunner](x: Self) {
      ...
      inline def setRunTest(value: String => typings.nginstackJsunit.testResultMod.^): Self = StObject.set(x, "runTest", js.Any.fromFunction1(value))
