...
object libSimpleLayoutColumnMod {
  ...
  inline def apply(simpleLayout: typings.nginstackWebFramework.libSimpleLayoutSimpleLayoutMod.^, name: String): Unit = (^.asInstanceOf[js.Dynamic].apply(simpleLayout.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def apply(
    simpleLayout: typings.nginstackWebFramework.libSimpleLayoutSimpleLayoutMod.^,
    name: String,
    options: Any
  ...
  open class ^ protected ()
    extends StObject
       with Column {
    def this(simpleLayout: typings.nginstackWebFramework.libSimpleLayoutSimpleLayoutMod.^, name: String) = this()
    def this(
      simpleLayout: typings.nginstackWebFramework.libSimpleLayoutSimpleLayoutMod.^,
      name: String,
      options: Any
  ...
  trait Column extends StObject {
    ...
    var columnGroup: typings.nginstackWebFramework.libSimpleLayoutColumnGroupMod.^ = js.native
    ...
    var onTotal: typings.nginstackEngine.libEventLegacyEventMod.^ = js.native
    ...
    def setCssExtractor(value: typings.nginstackWebFramework.libCssCssExtractorMod.^): Unit = js.native
    ...
    var simpleLayout: typings.nginstackWebFramework.libSimpleLayoutSimpleLayoutMod.^ = js.native
