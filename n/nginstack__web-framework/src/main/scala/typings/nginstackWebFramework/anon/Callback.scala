...
trait Callback extends StObject {
  ...
  var callback: js.UndefOr[js.Function1[/* arg0 */ Any, Any]] = js.undefined
...
object Callback {
  ...
  extension [Self <: Callback](x: Self) {
    ...
    inline def setCallback(value: /* arg0 */ Any => Any): Self = StObject.set(x, "callback", js.Any.fromFunction1(value))
