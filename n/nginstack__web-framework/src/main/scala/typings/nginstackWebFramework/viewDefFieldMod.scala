...
object viewDefFieldMod {
  ...
  type FieldAggregator = typings.nginstackWebFramework.fieldAggregatorMod.^
  
  type Grid = typings.nginstackWebFramework.gridMod.^
  
  type ViewDef = typings.nginstackWebFramework.viewDefMod.^
  ...
  trait ViewDefField extends StObject {
    ...
    var thumbnail: typings.nginstackWebFramework.cellThumbnailMod.^ = js.native
