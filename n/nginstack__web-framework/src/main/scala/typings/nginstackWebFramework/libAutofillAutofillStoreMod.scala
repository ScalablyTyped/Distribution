...
object libAutofillAutofillStoreMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    override def load(): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
  ...
  trait AutofillStore extends StObject {
    ...
    def load(): typings.nginstackEngine.libDatasetDataSetMod.^
  ...
  object AutofillStore {
    ...
    inline def apply(
      ...
      formatFilePath_ : Any,
      isModified: () => Boolean,
      load: () => typings.nginstackEngine.libDatasetDataSetMod.^,
      logger_ : Any,
      modified_ : Any,
    ...
    implicit open class MutableBuilder[Self <: AutofillStore] (val x: Self) extends AnyVal {
      ...
      inline def setLoad(value: () => typings.nginstackEngine.libDatasetDataSetMod.^): Self = StObject.set(x, "load", js.Any.fromFunction0(value))
