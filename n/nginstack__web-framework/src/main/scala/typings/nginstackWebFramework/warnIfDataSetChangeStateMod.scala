...
object warnIfDataSetChangeStateMod {
  ...
  @js.native
  def logger: typings.nginstackEngine.loggerMod.^ = js.native
  
  inline def logger_=(x: typings.nginstackEngine.loggerMod.^): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("logger_")(x.asInstanceOf[js.Any])
