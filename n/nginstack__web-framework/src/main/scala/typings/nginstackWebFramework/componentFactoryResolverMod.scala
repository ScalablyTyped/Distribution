...
object componentFactoryResolverMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    override def registerFactory(componentName: String, factory: Any): Unit = js.native
  ...
  trait ComponentFactoryResolver extends StObject {
    ...
    def registerFactory(componentName: String, factory: Any): Unit
    
    def resolve(componentName: String): Any
  }
  object ComponentFactoryResolver {
    
    inline def apply(factories_ : Any, registerFactory: (String, Any) => Unit, resolve: String => Any): ComponentFactoryResolver = {
    ...
    extension [Self <: ComponentFactoryResolver](x: Self) {
      ...
      inline def setRegisterFactory(value: (String, Any) => Unit): Self = StObject.set(x, "registerFactory", js.Any.fromFunction2(value))
