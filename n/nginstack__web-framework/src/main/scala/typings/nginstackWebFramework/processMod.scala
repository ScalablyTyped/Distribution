...
object processMod {
  ...
  inline def apply(key: Double, id: String, responseObject: Any, sourceClass: typings.nginstackEngine.dbkeyMod.^): Unit = (^.asInstanceOf[js.Dynamic].apply(key.asInstanceOf[js.Any], id.asInstanceOf[js.Any], responseObject.asInstanceOf[js.Any], sourceClass.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    ...
    def this(key: Double, id: String, responseObject: Any, sourceClass: typings.nginstackEngine.dbkeyMod.^) = this()
  }
  @JSImport("@nginstack/web-framework/lib/process/Process", JSImport.Namespace)
  @js.native
  ...
  type Button = typings.nginstackWebFramework.buttonMod.^
  
  type Grid = typings.nginstackWebFramework.gridMod.^
  
  type GridField = typings.nginstackWebFramework.gridFieldMod.^
  ...
  trait Process extends StObject {
    ...
    def action(name: Any, target: Any, order: Any, processKey: Any, newTab: Any): typings.nginstackWebFramework.buttonMod.^ = js.native
    ...
    def activity(
      ...
      args: Any*
    ): typings.nginstackWebFramework.interactionMod.^ = js.native
    def activity(
      name: String,
      func: js.ThisFunction0[/* this */ this.type, Any],
      opt_permKeyWord: String,
    ...
    var currentInteraction: typings.nginstackWebFramework.interactionMod.^ = js.native
    
    var currentTabId: Double = js.native
    
    var dbkey: typings.nginstackEngine.dbkeyMod.^ = js.native
    ...
    def download(files: String, options: typings.nginstackWebFramework.downloadOptionsMod.^): Unit = js.native
    def download(files: String, options: Record[Any, Any]): Unit = js.native
    def download(files: js.Array[String | Double | typings.nginstackEngine.dbkeyMod.^]): Unit = js.native
    def download(
      files: js.Array[String | Double | typings.nginstackEngine.dbkeyMod.^],
      options: typings.nginstackWebFramework.downloadOptionsMod.^
    ): Unit = js.native
    def download(files: js.Array[String | Double | typings.nginstackEngine.dbkeyMod.^], options: Record[Any, Any]): Unit = js.native
    def download(files: Double): Unit = js.native
    def download(files: Double, options: typings.nginstackWebFramework.downloadOptionsMod.^): Unit = js.native
    def download(files: Double, options: Record[Any, Any]): Unit = js.native
    def download(files: typings.nginstackEngine.dbkeyMod.^): Unit = js.native
    def download(
      files: typings.nginstackEngine.dbkeyMod.^,
      options: typings.nginstackWebFramework.downloadOptionsMod.^
    ): Unit = js.native
    def download(files: typings.nginstackEngine.dbkeyMod.^, options: Record[Any, Any]): Unit = js.native
    ...
    var environment: typings.nginstackWebFramework.environmentMod.^ = js.native
    ...
    def getSimpleLayout(skinScriptKeyOrUrl: Any): typings.nginstackWebFramework.simpleLayoutMod.^ = js.native
    ...
    def grid(name: String, opt_ds: typings.nginstackEngine.dataSetMod.^): Grid = js.native
    def grid(name: String, opt_ds: typings.nginstackEngine.dataSetMod.^, opt_classKey: Double): Grid = js.native
    def grid(
      name: String,
      opt_ds: typings.nginstackEngine.dataSetMod.^,
      opt_classKey: Double,
      opt_masterGrid: Grid
    ): Grid = js.native
    def grid(
    ...
    def label(name: String): typings.nginstackWebFramework.labelMod.^ = js.native
    def label(name: String, opt_text: String): typings.nginstackWebFramework.labelMod.^ = js.native
    
    /* private */ var labels: Any = js.native
    
    /* private */ var labelsChanged: Any = js.native
    
    var lastInteraction: typings.nginstackWebFramework.interactionMod.^ = js.native
    ...
    var layoutManager: typings.nginstackWebFramework.layoutManagerMod.^ = js.native
    
    var layoutResponseObject: typings.nginstackEngine.fileMod.^ | typings.nginstackEngine.spoolMod.^ = js.native
    ...
    var sourceClass: typings.nginstackEngine.dbkeyMod.^ = js.native
    ...
    def upload(options: typings.nginstackWebFramework.uploadOptionsMod.^): Any = js.native
