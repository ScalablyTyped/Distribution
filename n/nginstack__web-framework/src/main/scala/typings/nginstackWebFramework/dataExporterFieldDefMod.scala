...
object dataExporterFieldDefMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var onCalculate: typings.nginstackEngine.legacyEventMod.^ = js.native
    
    /* CompleteClass */
    var onLookupDisplay: typings.nginstackEngine.legacyEventMod.^ = js.native
  ...
  trait DataExporterFieldDef extends StObject {
    ...
    var onCalculate: typings.nginstackEngine.legacyEventMod.^
    
    var onLookupDisplay: typings.nginstackEngine.legacyEventMod.^
  ...
  object DataExporterFieldDef {
    ...
    inline def apply(
      ...
      lookupType: Double,
      name: String,
      onCalculate: typings.nginstackEngine.legacyEventMod.^,
      onLookupDisplay: typings.nginstackEngine.legacyEventMod.^,
      `type`: String
    ...
    extension [Self <: DataExporterFieldDef](x: Self) {
      ...
      inline def setOnCalculate(value: typings.nginstackEngine.legacyEventMod.^): Self = StObject.set(x, "onCalculate", value.asInstanceOf[js.Any])
      
      inline def setOnLookupDisplay(value: typings.nginstackEngine.legacyEventMod.^): Self = StObject.set(x, "onLookupDisplay", value.asInstanceOf[js.Any])
