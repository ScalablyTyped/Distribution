...
object accumulatorMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var simpleLayout: Any = js.native
  }
  @JSImport("@nginstack/web-framework/lib/simple-layout/Accumulator", JSImport.Namespace)
  @js.native
  ...
  object Accumulator {
    ...
    extension [Self <: Accumulator](x: Self) {
      ...
      inline def setSimpleLayout(value: Any): Self = StObject.set(x, "simpleLayout", value.asInstanceOf[js.Any])
    }
  }
}
