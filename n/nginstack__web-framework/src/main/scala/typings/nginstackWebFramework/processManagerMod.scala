...
object processManagerMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var ctrlChannel: typings.nginstackWebFramework.controlChannelMod.^ = js.native
    ...
    /* CompleteClass */
    override def getCurrentProcess(): typings.nginstackWebFramework.processMod.^ = js.native
    ...
    /* CompleteClass */
    override def getProcessById(id: String): typings.nginstackWebFramework.processMod.^ = js.native
  ...
  inline def parseLayoutLinkContent(content: Any): typings.nginstackEngine.dbkeyMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("parseLayoutLinkContent")(content.asInstanceOf[js.Any]).asInstanceOf[typings.nginstackEngine.dbkeyMod.^]
  ...
  trait ProcessManager extends StObject {
    ...
    var ctrlChannel: typings.nginstackWebFramework.controlChannelMod.^
    ...
    def getCurrentProcess(): typings.nginstackWebFramework.processMod.^
    ...
    def getProcessById(id: String): typings.nginstackWebFramework.processMod.^
  ...
  object ProcessManager {
    ...
    inline def apply(
      ...
      controller_ : Any,
      createProcess: Any,
      ctrlChannel: typings.nginstackWebFramework.controlChannelMod.^,
      ctrlSessionId: Any,
      currentProcess_ : Any,
      ...
      errorTreatment: Any,
      finalize_ : Any,
      getCurrentProcess: () => typings.nginstackWebFramework.processMod.^,
      getDefaultProcessKeyOfClass: Any,
      getEntityShortcuts: Any,
      getFileContent: Any,
      getFileId: Any,
      getParameterFromRequestObject: Any,
      getProcessById: String => typings.nginstackWebFramework.processMod.^,
    ...
    extension [Self <: ProcessManager](x: Self) {
      ...
      inline def setCtrlChannel(value: typings.nginstackWebFramework.controlChannelMod.^): Self = StObject.set(x, "ctrlChannel", value.asInstanceOf[js.Any])
      ...
      inline def setGetCurrentProcess(value: () => typings.nginstackWebFramework.processMod.^): Self = StObject.set(x, "getCurrentProcess", js.Any.fromFunction0(value))
      ...
      inline def setGetProcessById(value: String => typings.nginstackWebFramework.processMod.^): Self = StObject.set(x, "getProcessById", js.Any.fromFunction1(value))
