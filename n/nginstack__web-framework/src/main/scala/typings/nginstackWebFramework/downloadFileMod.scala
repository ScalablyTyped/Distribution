...
object downloadFileMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    override def openFile(): typings.nginstackEngine.fileMod.^ = js.native
  }
  @JSImport("@nginstack/web-framework/lib/file-loader/DownloadFile", JSImport.Namespace)
  @js.native
  ...
  trait DownloadFile extends StObject {
    ...
    def openFile(): typings.nginstackEngine.fileMod.^
  }
  object DownloadFile {
    
    inline def apply(openFile: () => typings.nginstackEngine.fileMod.^): DownloadFile = {
    ...
    extension [Self <: DownloadFile](x: Self) {
      ...
      inline def setOpenFile(value: () => typings.nginstackEngine.fileMod.^): Self = StObject.set(x, "openFile", js.Any.fromFunction0(value))
    }
  }
}
