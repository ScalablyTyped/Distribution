...
object libGridTreeViewMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var nodes: typings.nginstackEngine.libStringStringListMod.^ = js.native
  ...
  /* private */ open class AbstractTree_ ()
    ...
    /* CompleteClass */
    var onAddition: typings.nginstackEngine.libEventLegacyEventMod.^ = js.native
    
    /* CompleteClass */
    var onCollapse: typings.nginstackEngine.libEventLegacyEventMod.^ = js.native
    
    /* CompleteClass */
    var onDeletion: typings.nginstackEngine.libEventLegacyEventMod.^ = js.native
    
    /* CompleteClass */
    var onExpand: typings.nginstackEngine.libEventLegacyEventMod.^ = js.native
    
    /* CompleteClass */
    var onGetTreeIcon: typings.nginstackEngine.libEventLegacyEventMod.^ = js.native
  ...
  trait AbstractTree extends StObject {
    ...
    var onAddition: typings.nginstackEngine.libEventLegacyEventMod.^
    
    var onCollapse: typings.nginstackEngine.libEventLegacyEventMod.^
    
    var onDeletion: typings.nginstackEngine.libEventLegacyEventMod.^
    
    var onExpand: typings.nginstackEngine.libEventLegacyEventMod.^
    
    var onGetTreeIcon: typings.nginstackEngine.libEventLegacyEventMod.^
  ...
  object AbstractTree {
    ...
    inline def apply(
      ...
      level: Double,
      nId: Double,
      onAddition: typings.nginstackEngine.libEventLegacyEventMod.^,
      onCollapse: typings.nginstackEngine.libEventLegacyEventMod.^,
      onDeletion: typings.nginstackEngine.libEventLegacyEventMod.^,
      onExpand: typings.nginstackEngine.libEventLegacyEventMod.^,
      onGetTreeIcon: typings.nginstackEngine.libEventLegacyEventMod.^,
      parent: Any,
      text: Any,
      treeView: Any,
      value: Any
    ...
    implicit open class MutableBuilder[Self <: AbstractTree] (val x: Self) extends AnyVal {
      ...
      inline def setOnAddition(value: typings.nginstackEngine.libEventLegacyEventMod.^): Self = StObject.set(x, "onAddition", value.asInstanceOf[js.Any])
      
      inline def setOnCollapse(value: typings.nginstackEngine.libEventLegacyEventMod.^): Self = StObject.set(x, "onCollapse", value.asInstanceOf[js.Any])
      
      inline def setOnDeletion(value: typings.nginstackEngine.libEventLegacyEventMod.^): Self = StObject.set(x, "onDeletion", value.asInstanceOf[js.Any])
      
      inline def setOnExpand(value: typings.nginstackEngine.libEventLegacyEventMod.^): Self = StObject.set(x, "onExpand", value.asInstanceOf[js.Any])
      
      inline def setOnGetTreeIcon(value: typings.nginstackEngine.libEventLegacyEventMod.^): Self = StObject.set(x, "onGetTreeIcon", value.asInstanceOf[js.Any])
  ...
  trait TreeView extends StObject {
    ...
    var nodes: typings.nginstackEngine.libStringStringListMod.^
    
    var readOnly: Boolean
  }
  object TreeView {
    
    inline def apply(field: Any, nodes: typings.nginstackEngine.libStringStringListMod.^, readOnly: Boolean): TreeView = {
    ...
    implicit open class MutableBuilder[Self <: TreeView] (val x: Self) extends AnyVal {
      ...
      inline def setNodes(value: typings.nginstackEngine.libStringStringListMod.^): Self = StObject.set(x, "nodes", value.asInstanceOf[js.Any])
