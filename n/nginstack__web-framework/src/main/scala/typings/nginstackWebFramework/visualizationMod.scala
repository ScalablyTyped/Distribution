...
object visualizationMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var footer: typings.nginstackWebFramework.footerMod.^ = js.native
    ...
    /* CompleteClass */
    var header: typings.nginstackWebFramework.headerMod.^ = js.native
  ...
  type DataExporter = typings.nginstackWebFramework.dataExporterMod.^
  ...
  trait Visualization extends StObject {
    ...
    var footer: typings.nginstackWebFramework.footerMod.^
    ...
    var header: typings.nginstackWebFramework.headerMod.^
  ...
  object Visualization {
    ...
    inline def apply(
      ...
      footer: typings.nginstackWebFramework.footerMod.^,
      getDataToExport: Record[String, Any] => scala.Nothing,
      getExportableData: () => js.Array[GetExporter],
      hasData: () => Boolean,
      header: typings.nginstackWebFramework.headerMod.^,
      help: String,
    ...
    extension [Self <: Visualization](x: Self) {
      ...
      inline def setFooter(value: typings.nginstackWebFramework.footerMod.^): Self = StObject.set(x, "footer", value.asInstanceOf[js.Any])
      ...
      inline def setHeader(value: typings.nginstackWebFramework.headerMod.^): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
  ...
  type VisualizationFilters = typings.nginstackWebFramework.visualizationFiltersMod.^
}
