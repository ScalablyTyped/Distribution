...
object libDialogsSimpleDialogMod {
  ...
  inline def apply(process: typings.nginstackWebFramework.libProcessProcessMod.^): Unit = ^.asInstanceOf[js.Dynamic].apply(process.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  open class ^ ()
    extends StObject
       with SimpleDialog {
    def this(process: typings.nginstackWebFramework.libProcessProcessMod.^) = this()
