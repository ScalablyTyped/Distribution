...
object compositeVisualizationSlotMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var visualization: Any = js.native
  ...
  object CompositeVisualizationSlot {
    ...
    inline def apply(height: Double, verticalAlignment: Any, visualization: Any, width: Double): CompositeVisualizationSlot = {
