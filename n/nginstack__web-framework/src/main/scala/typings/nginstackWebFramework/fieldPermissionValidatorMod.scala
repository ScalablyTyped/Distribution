...
object fieldPermissionValidatorMod {
  
  inline def apply(manager: Any, permField: String, classKey: Double, userKey: Double): Unit = (^.asInstanceOf[js.Dynamic].apply(manager.asInstanceOf[js.Any], permField.asInstanceOf[js.Any], classKey.asInstanceOf[js.Any], userKey.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    ...
    def this(manager: Any, permField: String, classKey: Double, userKey: Double) = this()
