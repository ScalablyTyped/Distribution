...
object gridMod {
  ...
  trait Grid extends StObject {
    ...
    var classDefManager: typings.nginstackEngine.classDefManagerMod.^ = js.native
    
    var classDefinition: Any = js.native
    
    var classKey: Double = js.native
    
    var classKeyToValidatePermission: Double | typings.nginstackEngine.dbkeyMod.^ = js.native
    ...
    var ds: typings.nginstackEngine.dataSetMod.^ = js.native
    ...
    def edit(field: typings.nginstackWebFramework.gridFieldMod.^): Unit = js.native
    ...
    def field(name: String, opt_type: String, opt_size: Double, args: Any*): typings.nginstackEngine.fieldMod.^ | ViewDefField = js.native
    def field(name: String, opt_type: String, opt_size: Unit, args: Any*): typings.nginstackEngine.fieldMod.^ | ViewDefField = js.native
    def field(name: String, opt_type: Unit, opt_size: Double, args: Any*): typings.nginstackEngine.fieldMod.^ | ViewDefField = js.native
    def field(name: String, opt_type: Unit, opt_size: Unit, args: Any*): typings.nginstackEngine.fieldMod.^ | ViewDefField = js.native
    ...
    def getKeyField(): typings.nginstackEngine.fieldMod.^ = js.native
    
    /* private */ var getKeyFieldExistInDs: Any = js.native
    
    def getLookupCallerField(): typings.nginstackEngine.fieldMod.^ = js.native
    ...
    /* protected */ def locateField(fieldName: String): typings.nginstackEngine.fieldMod.^ = js.native
    ...
    def lookup(field: typings.nginstackWebFramework.gridFieldMod.^): Unit = js.native
    ...
    /* protected */ def newEvent_(`type`: String): typings.nginstackWebFramework.gridEventMod.^ = js.native
    /* protected */ def newEvent_(`type`: String, opt_options: Cancelable): typings.nginstackWebFramework.gridEventMod.^ = js.native
    ...
    def scroll(action: js.Function1[/* arg0 */ typings.nginstackEngine.dataSetMod.^, Any]): Unit = js.native
    ...
    /* protected */ var tableViewBuffer: typings.nginstackWebFramework.tableViewBufferMod.^ = js.native
    ...
    def toggleFieldVisibility(field: typings.nginstackEngine.fieldMod.^): Unit = js.native
  ...
  type ViewDefField = typings.nginstackWebFramework.viewDefFieldMod.^
}
