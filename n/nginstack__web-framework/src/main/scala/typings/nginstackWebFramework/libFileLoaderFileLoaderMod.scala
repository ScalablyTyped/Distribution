...
object libFileLoaderFileLoaderMod {
  ...
  trait FileLoader extends StObject {
    ...
    def authorizeDownload(files: String, options: typings.nginstackWebFramework.libFileLoaderDownloadOptionsMod.^): String = js.native
    ...
    def authorizeDownload(files: Double, options: typings.nginstackWebFramework.libFileLoaderDownloadOptionsMod.^): String = js.native
    def authorizeDownload(files: Double, options: Record[Any, Any]): String = js.native
    def authorizeDownload(
      files: typings.nginstackEngine.libDbkeyDbkeyMod.^,
      options: typings.nginstackWebFramework.libFileLoaderDownloadOptionsMod.^
    ): String = js.native
    def authorizeDownload(files: typings.nginstackEngine.libDbkeyDbkeyMod.^, options: Record[Any, Any]): String = js.native
    
    def authorizeUpload(options: typings.nginstackWebFramework.libFileLoaderUploadOptionsMod.^): String = js.native
    ...
    def getUploadedFiles(uploadId: String): js.Array[typings.nginstackWebFramework.libFileLoaderUploadedFileMod.^] = js.native
    ...
    def tryGetDownloadFile(downloadId: String): typings.nginstackWebFramework.libFileLoaderDownloadFileMod.^ = js.native
