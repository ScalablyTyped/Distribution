...
object echartsvisualizationdefMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    override def onGetOptions(arg0: Any, arg1: Any): Any = js.native
  ...
  trait EChartsVisualizationDef extends StObject {
    ...
    def onGetOptions(arg0: Any, arg1: Any): Any
  ...
  object EChartsVisualizationDef {
    ...
    extension [Self <: EChartsVisualizationDef](x: Self) {
      ...
      inline def setOnGetOptions(value: (Any, Any) => Any): Self = StObject.set(x, "onGetOptions", js.Any.fromFunction2(value))
