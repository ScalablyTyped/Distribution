...
object gridLocateEventMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var locatedField: Any = js.native
  ...
  object GridLocateEvent {
    ...
    extension [Self <: GridLocateEvent](x: Self) {
      ...
      inline def setLocatedField(value: Any): Self = StObject.set(x, "locatedField", value.asInstanceOf[js.Any])
