...
object libPersonalizationEnvironmentMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var menuBar: typings.nginstackWebFramework.libPersonalizationMenuBarMod.^ = js.native
  ...
  trait Environment extends StObject {
    ...
    var menuBar: typings.nginstackWebFramework.libPersonalizationMenuBarMod.^
  ...
  object Environment {
    ...
    inline def apply(
      ...
      menuBar: typings.nginstackWebFramework.libPersonalizationMenuBarMod.^,
      titleLogon: String
    ): Environment = {
    ...
    implicit open class MutableBuilder[Self <: Environment] (val x: Self) extends AnyVal {
      ...
      inline def setMenuBar(value: typings.nginstackWebFramework.libPersonalizationMenuBarMod.^): Self = StObject.set(x, "menuBar", value.asInstanceOf[js.Any])
