...
object libFileLoaderUploadedFileMod {
  ...
  trait UploadedFile extends StObject {
    ...
    def uploadToLobStorage(classKey: typings.nginstackEngine.libDbkeyDbkeyMod.^): Double = js.native
    def uploadToLobStorage(classKey: typings.nginstackEngine.libDbkeyDbkeyMod.^, options: Key): Double = js.native
