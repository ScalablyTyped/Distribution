...
object libAnchorAnchorMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var onClick: typings.nginstackEngine.libEventLegacyEventMod.^ = js.native
  ...
  trait Anchor extends StObject {
    ...
    var onClick: typings.nginstackEngine.libEventLegacyEventMod.^
  ...
  object Anchor {
    ...
    inline def apply(
      ...
      onClick: typings.nginstackEngine.libEventLegacyEventMod.^,
      parameters_ : Any,
      parent: Any,
    ...
    implicit open class MutableBuilder[Self <: Anchor] (val x: Self) extends AnyVal {
      ...
      inline def setOnClick(value: typings.nginstackEngine.libEventLegacyEventMod.^): Self = StObject.set(x, "onClick", value.asInstanceOf[js.Any])
