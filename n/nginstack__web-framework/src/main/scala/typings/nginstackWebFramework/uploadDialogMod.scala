...
object uploadDialogMod {
  
  inline def apply(): Unit = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[Unit]
  inline def apply(opt_process: Any): Unit = ^.asInstanceOf[js.Dynamic].apply(opt_process.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  trait UploadDialog extends StObject {
    ...
    def open(opt_options: typings.nginstackWebFramework.uploadOptionsMod.^): Any = js.native
  ...
  type UploadedFile = typings.nginstackWebFramework.uploadedFileMod.^
}
