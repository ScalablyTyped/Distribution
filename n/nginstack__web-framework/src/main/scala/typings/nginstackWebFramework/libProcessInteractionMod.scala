...
object libProcessInteractionMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var functions: typings.nginstackEngine.libEventLegacyEventMod.^ = js.native
    ...
    /* CompleteClass */
    var onExit: typings.nginstackEngine.libEventLegacyEventMod.^ = js.native
  ...
  trait Interaction extends StObject {
    ...
    var functions: typings.nginstackEngine.libEventLegacyEventMod.^
    ...
    var onExit: typings.nginstackEngine.libEventLegacyEventMod.^
  ...
  object Interaction {
    ...
    inline def apply(
      close: () => Unit,
      functions: typings.nginstackEngine.libEventLegacyEventMod.^,
      isInteractive: Any,
      lastExecuteOk: Any,
      logger_ : Any,
      name: String,
      onExit: typings.nginstackEngine.libEventLegacyEventMod.^,
    ...
    implicit open class MutableBuilder[Self <: Interaction] (val x: Self) extends AnyVal {
      ...
      inline def setFunctions(value: typings.nginstackEngine.libEventLegacyEventMod.^): Self = StObject.set(x, "functions", value.asInstanceOf[js.Any])
      ...
      inline def setOnExit(value: typings.nginstackEngine.libEventLegacyEventMod.^): Self = StObject.set(x, "onExit", value.asInstanceOf[js.Any])
