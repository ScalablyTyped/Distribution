...
object masterComponentMod {
  
  inline def apply(parent: typings.nginstackWebFramework.componentMod.^): Unit = ^.asInstanceOf[js.Dynamic].apply(parent.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def apply(parent: typings.nginstackWebFramework.componentMod.^, opt_props: Any): Unit = (^.asInstanceOf[js.Dynamic].apply(parent.asInstanceOf[js.Any], opt_props.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    ...
    def this(parent: typings.nginstackWebFramework.componentMod.^) = this()
    def this(parent: typings.nginstackWebFramework.componentMod.^, opt_props: Any) = this()
