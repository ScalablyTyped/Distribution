...
object buttonMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var timer: typings.nginstackWebFramework.buttonTimerMod.^ = js.native
  ...
  trait Button extends StObject {
    ...
    var timer: typings.nginstackWebFramework.buttonTimerMod.^
  ...
  object Button {
    ...
    inline def apply(
      ...
      show: () => Unit,
      timeout: Double,
      timer: typings.nginstackWebFramework.buttonTimerMod.^,
      toString_ : Any,
      visible: Boolean
    ): Button = {
    ...
    extension [Self <: Button](x: Self) {
      ...
      inline def setTimer(value: typings.nginstackWebFramework.buttonTimerMod.^): Self = StObject.set(x, "timer", value.asInstanceOf[js.Any])
