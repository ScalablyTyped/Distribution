...
object navigationTreeMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var classe: typings.nginstackEngine.dataSetMod.^ = js.native
    ...
    /* CompleteClass */
    var collection: typings.nginstackEngine.dataSetMod.^ = js.native
    ...
    /* CompleteClass */
    var ipermission: typings.nginstackEngine.dataSetMod.^ = js.native
    
    /* CompleteClass */
    var ivfs: typings.nginstackEngine.dataSetMod.^ = js.native
  ...
  inline def createEmptyNavigationTreeCollection(): typings.nginstackEngine.dataSetMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("createEmptyNavigationTreeCollection")().asInstanceOf[typings.nginstackEngine.dataSetMod.^]
  ...
  trait NavigationTree extends StObject {
    ...
    var classe: typings.nginstackEngine.dataSetMod.^
    ...
    var collection: typings.nginstackEngine.dataSetMod.^
    ...
    var ipermission: typings.nginstackEngine.dataSetMod.^
    
    var ivfs: typings.nginstackEngine.dataSetMod.^
  ...
  object NavigationTree {
    ...
    inline def apply(
      ...
      initialize: () => Unit,
      ipermission: typings.nginstackEngine.dataSetMod.^,
      ivfs: typings.nginstackEngine.dataSetMod.^,
      logger_ : Any,
    ...
    extension [Self <: NavigationTree](x: Self) {
      ...
      inline def setClasse(value: typings.nginstackEngine.dataSetMod.^): Self = StObject.set(x, "classe", value.asInstanceOf[js.Any])
      ...
      inline def setCollection(value: typings.nginstackEngine.dataSetMod.^): Self = StObject.set(x, "collection", value.asInstanceOf[js.Any])
      ...
      inline def setIpermission(value: typings.nginstackEngine.dataSetMod.^): Self = StObject.set(x, "ipermission", value.asInstanceOf[js.Any])
      
      inline def setIvfs(value: typings.nginstackEngine.dataSetMod.^): Self = StObject.set(x, "ivfs", value.asInstanceOf[js.Any])
