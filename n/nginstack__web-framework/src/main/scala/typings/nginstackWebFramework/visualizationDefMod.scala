...
object visualizationDefMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var footer: typings.nginstackWebFramework.visualizationFooterDefMod.^ = js.native
    
    /* CompleteClass */
    var header: typings.nginstackWebFramework.visualizationHeaderDefMod.^ = js.native
  ...
  trait VisualizationDef extends StObject {
    ...
    var footer: typings.nginstackWebFramework.visualizationFooterDefMod.^
    
    var header: typings.nginstackWebFramework.visualizationHeaderDefMod.^
  ...
  object VisualizationDef {
    ...
    inline def apply(
      ...
      footer: typings.nginstackWebFramework.visualizationFooterDefMod.^,
      header: typings.nginstackWebFramework.visualizationHeaderDefMod.^,
      help: String,
    ...
    extension [Self <: VisualizationDef](x: Self) {
      ...
      inline def setFooter(value: typings.nginstackWebFramework.visualizationFooterDefMod.^): Self = StObject.set(x, "footer", value.asInstanceOf[js.Any])
      
      inline def setHeader(value: typings.nginstackWebFramework.visualizationHeaderDefMod.^): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
