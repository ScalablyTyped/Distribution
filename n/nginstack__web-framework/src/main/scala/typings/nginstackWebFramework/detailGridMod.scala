...
object detailGridMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    override def defaultMasterDetailCreateDataSet(sender: Any): typings.nginstackEngine.dataSetMod.^ = js.native
    ...
    /* CompleteClass */
    var masterDeleteAction: Any = js.native
  ...
  trait DetailGrid extends StObject {
    ...
    def defaultMasterDetailCreateDataSet(sender: Any): typings.nginstackEngine.dataSetMod.^
  ...
  object DetailGrid {
    ...
    inline def apply(
      ...
      defaultMasterDetailCreateDataSet: Any => typings.nginstackEngine.dataSetMod.^,
    ...
    extension [Self <: DetailGrid](x: Self) {
      ...
      inline def setDefaultMasterDetailCreateDataSet(value: Any => typings.nginstackEngine.dataSetMod.^): Self = StObject.set(x, "defaultMasterDetailCreateDataSet", js.Any.fromFunction1(value))
      ...
      inline def setMasterDeleteAction(value: Any): Self = StObject.set(x, "masterDeleteAction", value.asInstanceOf[js.Any])
