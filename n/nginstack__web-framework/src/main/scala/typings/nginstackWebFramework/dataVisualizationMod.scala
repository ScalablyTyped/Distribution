...
object dataVisualizationMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var dataSourceQuery: typings.nginstackDatasource.dataSourceQueryMod.^ = js.native
    
    /* private */ /* CompleteClass */
    var dataSource_ : Any = js.native
    
    /* CompleteClass */
    var filters: typings.nginstackWebFramework.visualizationFiltersMod.^ = js.native
  ...
  trait DataVisualization extends StObject {
    ...
    var dataSourceQuery: typings.nginstackDatasource.dataSourceQueryMod.^
    
    /* private */ var dataSource_ : Any
    
    var filters: typings.nginstackWebFramework.visualizationFiltersMod.^
  ...
  object DataVisualization {
    ...
    inline def apply(
      ...
      dataSourceQuery: typings.nginstackDatasource.dataSourceQueryMod.^,
      dataSource_ : Any,
      filters: typings.nginstackWebFramework.visualizationFiltersMod.^,
    ...
    extension [Self <: DataVisualization](x: Self) {
      ...
      inline def setDataSourceQuery(value: typings.nginstackDatasource.dataSourceQueryMod.^): Self = StObject.set(x, "dataSourceQuery", value.asInstanceOf[js.Any])
      
      inline def setDataSource_(value: Any): Self = StObject.set(x, "dataSource_", value.asInstanceOf[js.Any])
      
      inline def setFilters(value: typings.nginstackWebFramework.visualizationFiltersMod.^): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
