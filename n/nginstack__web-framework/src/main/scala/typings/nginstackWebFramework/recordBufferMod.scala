...
object recordBufferMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    override def field(idx: Double): typings.nginstackWebFramework.fieldBufferMod.^ = js.native
  ...
  trait RecordBuffer extends StObject {
    ...
    def field(idx: Double): typings.nginstackWebFramework.fieldBufferMod.^
  ...
  object RecordBuffer {
    ...
    inline def apply(
      bookmark: Any,
      disabled: Boolean,
      field: Double => typings.nginstackWebFramework.fieldBufferMod.^,
      fieldBuffers_ : Any,
    ...
    extension [Self <: RecordBuffer](x: Self) {
      ...
      inline def setField(value: Double => typings.nginstackWebFramework.fieldBufferMod.^): Self = StObject.set(x, "field", js.Any.fromFunction1(value))
