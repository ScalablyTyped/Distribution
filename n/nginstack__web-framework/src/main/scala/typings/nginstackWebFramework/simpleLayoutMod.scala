...
object simpleLayoutMod {
  ...
  trait SimpleLayout extends StObject {
    ...
    def column(name: String): typings.nginstackWebFramework.columnMod.^ = js.native
    def column(name: String, options: Any): typings.nginstackWebFramework.columnMod.^ = js.native
    
    var columnPadding: String = js.native
    
    var columns: typings.nginstackEngine.stringListMod.^ = js.native
    ...
    def group(name: String, link: typings.nginstackWebFramework.linkMod.^, displayFormat: String): Any = js.native
    
    var groupColors: js.Array[Any] = js.native
    
    var groupExpansionLevel: Double = js.native
    
    var groups: typings.nginstackEngine.stringListMod.^ = js.native
    ...
    var resultSet: typings.nginstackEngine.dataSetMod.^ = js.native
    ...
    var variableGrid: Any = js.native
