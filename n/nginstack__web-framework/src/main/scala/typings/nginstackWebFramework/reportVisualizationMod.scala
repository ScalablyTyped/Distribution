...
object reportVisualizationMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var columns: typings.nginstackWebFramework.reportVisualizationColumnsMod.^ = js.native
    ...
    /* CompleteClass */
    override def getColumn(name: String): typings.nginstackWebFramework.reportVisualizationColumnMod.^ = js.native
  ...
  trait ReportVisualization extends StObject {
    ...
    var columns: typings.nginstackWebFramework.reportVisualizationColumnsMod.^
    ...
    def getColumn(name: String): typings.nginstackWebFramework.reportVisualizationColumnMod.^
  ...
  object ReportVisualization {
    ...
    inline def apply(
      ...
      columns: typings.nginstackWebFramework.reportVisualizationColumnsMod.^,
      ...
      getColumn: String => typings.nginstackWebFramework.reportVisualizationColumnMod.^,
      getColumnDefs_ : Any,
    ...
    extension [Self <: ReportVisualization](x: Self) {
      ...
      inline def setColumns(value: typings.nginstackWebFramework.reportVisualizationColumnsMod.^): Self = StObject.set(x, "columns", value.asInstanceOf[js.Any])
      ...
      inline def setGetColumn(value: String => typings.nginstackWebFramework.reportVisualizationColumnMod.^): Self = StObject.set(x, "getColumn", js.Any.fromFunction1(value))
  ...
  type SimpleLayoutExporter = typings.nginstackWebFramework.simpleLayoutExporterMod.^
}
