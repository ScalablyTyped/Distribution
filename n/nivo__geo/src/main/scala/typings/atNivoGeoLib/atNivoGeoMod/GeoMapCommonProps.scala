...
trait GeoMapCommonProps extends CommonProps {
  var borderColor: js.UndefOr[java.lang.String | (FeatureAccessor[_, scala.Double])] = js.undefined
  var borderWidth: js.UndefOr[scala.Double | (FeatureAccessor[_, scala.Double])] = js.undefined
  var fillColor: js.UndefOr[java.lang.String | (FeatureAccessor[_, java.lang.String])] = js.undefined
