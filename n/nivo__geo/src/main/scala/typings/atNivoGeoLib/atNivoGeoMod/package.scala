...
package object atNivoGeoMod {
  ...
  type ChoroplethTooltip = reactLib.reactMod.FunctionComponent[atNivoGeoLib.Anon_FeatureChoroplethBoundFeature]
  ...
  type GeoMapTooltip = reactLib.reactMod.FunctionComponent[atNivoGeoLib.Anon_Feature]
}
