...
import typings.atNivoGeo.atNivoGeoMod.ChoroplethBoundFeature
import typings.atNivoGeo.atNivoGeoMod.ChoroplethEventHandler
import typings.atNivoGeo.atNivoGeoMod.ChoroplethTooltip
...
object ChoroplethPropsDimensions {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(data = data, domain = domain, features = features, height = height, width = width)
