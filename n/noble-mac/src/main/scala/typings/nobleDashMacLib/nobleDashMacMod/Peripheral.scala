...
class Peripheral ()
  ...
  var state: nobleDashMacLib.nobleDashMacLibStrings.error | nobleDashMacLib.nobleDashMacLibStrings.connecting | nobleDashMacLib.nobleDashMacLibStrings.connected | nobleDashMacLib.nobleDashMacLibStrings.disconnecting | nobleDashMacLib.nobleDashMacLibStrings.disconnected = js.native
  ...
  @JSName("on")
  def on_connect(
    event: nobleDashMacLib.nobleDashMacLibStrings.connect,
    listener: js.Function1[/* error */ java.lang.String, scala.Unit]
  ): this.type = js.native
  @JSName("on")
  def on_disconnect(
    event: nobleDashMacLib.nobleDashMacLibStrings.disconnect,
    listener: js.Function1[/* error */ java.lang.String, scala.Unit]
  ): this.type = js.native
  @JSName("on")
  def on_rssiUpdate(
    event: nobleDashMacLib.nobleDashMacLibStrings.rssiUpdate,
    listener: js.Function1[/* rssi */ scala.Double, scala.Unit]
  ): this.type = js.native
  @JSName("on")
  def on_servicesDiscover(
    event: nobleDashMacLib.nobleDashMacLibStrings.servicesDiscover,
