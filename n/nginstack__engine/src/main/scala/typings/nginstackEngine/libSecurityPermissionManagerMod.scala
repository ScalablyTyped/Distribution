...
object libSecurityPermissionManagerMod {
  ...
  trait PermissionManager extends StObject {
    ...
    def copyFromParent(keys: js.Array[Double]): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def copyFromParent(keys: js.Array[Double], opt_groupUsers: js.Array[Double]): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    /* protected */ def getTable_(tableName: String): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    
    /* private */ var hardCopyPermissions_ : Any = js.native
    
    def insert(assignment: typings.nginstackEngine.libSecurityPermissionAssignmentMod.^): Double = js.native
    ...
    def update(key: Double, assignment: typings.nginstackEngine.libSecurityPermissionAssignmentMod.^): Double = js.native
  }
