...
object configDefMod {
  ...
  open class ^ ()
    ...
    var logger_ : typings.nginstackEngine.loggerMod.^ = js.native
  ...
  trait ConfigDef extends StObject {
    ...
    /* protected */ var logger_ : typings.nginstackEngine.loggerMod.^
    
    /* private */ var vfsToCheckStrictMode_ : Any
  }
  object ConfigDef {
    
    inline def apply(logger_ : typings.nginstackEngine.loggerMod.^, vfsToCheckStrictMode_ : Any): ConfigDef = {
    ...
    extension [Self <: ConfigDef](x: Self) {
      ...
      inline def setLogger_(value: typings.nginstackEngine.loggerMod.^): Self = StObject.set(x, "logger_", value.asInstanceOf[js.Any])
