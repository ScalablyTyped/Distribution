...
object jwsMod {
  ...
  inline def parse(token: String, key: typings.nginstackEngine.cryptoPKeyMod.^): JWS = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(token.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[JWS]
  inline def parse(token: String, key: typings.nginstackEngine.cryptoPKeyMod.^, options: VerifyOptions): JWS = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(token.asInstanceOf[js.Any], key.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[JWS]
  ...
  inline def sign(payload: Any, key: typings.nginstackEngine.cryptoPKeyMod.^): String = (^.asInstanceOf[js.Dynamic].applyDynamic("sign")(payload.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def sign(payload: Any, key: typings.nginstackEngine.cryptoPKeyMod.^, options: Algorithm): String = (^.asInstanceOf[js.Dynamic].applyDynamic("sign")(payload.asInstanceOf[js.Any], key.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def verify(token: String, key: typings.nginstackEngine.cryptoPKeyMod.^): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("verify")(token.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def verify(token: String, key: typings.nginstackEngine.cryptoPKeyMod.^, options: VerifyOptions): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("verify")(token.asInstanceOf[js.Any], key.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
  
  @js.native
  trait JWS extends StObject {
    
    var algorithm: typings.nginstackEngine.algorithmMod.Algorithm = js.native
    ...
    def sign(key: typings.nginstackEngine.cryptoPKeyMod.^): String = js.native
    def sign(key: typings.nginstackEngine.cryptoPKeyMod.^, options: DisableDefaultTimestamp): String = js.native
