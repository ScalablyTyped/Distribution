...
object documentMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    override def createEntityReference(name: String): Any = js.native
  ...
  type CDATASection = typings.nginstackEngine.cdatasectionMod.^
  
  type Comment = typings.nginstackEngine.commentMod.^
  ...
  trait Document extends StObject {
    ...
    def createEntityReference(name: String): Any
  ...
  object Document {
    ...
    inline def apply(
      ...
      createEntityReference: String => Any,
    ...
    extension [Self <: Document](x: Self) {
      ...
      inline def setCreateEntityReference(value: String => Any): Self = StObject.set(x, "createEntityReference", js.Any.fromFunction1(value))
  ...
  type DocumentFragment = typings.nginstackEngine.documentFragmentMod.^
  
  type DocumentType = typings.nginstackEngine.documentTypeMod.^
  
  type Element = typings.nginstackEngine.elementMod.^
  
  type NodeList = typings.nginstackEngine.nodeListMod.^
  
  type ProcessingInstruction = typings.nginstackEngine.processingInstructionMod.^
  
  type Text = typings.nginstackEngine.textMod.^
}
