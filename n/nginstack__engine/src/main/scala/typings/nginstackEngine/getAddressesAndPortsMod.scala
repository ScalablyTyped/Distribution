...
object getAddressesAndPortsMod {
  ...
  inline def apply(key: typings.nginstackEngine.dbkeyMod.^): AddressesAndPorts = ^.asInstanceOf[js.Dynamic].apply(key.asInstanceOf[js.Any]).asInstanceOf[AddressesAndPorts]
