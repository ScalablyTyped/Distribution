...
object serverIdMod {
  ...
  inline def getInstance(): typings.nginstackEngine.serverIdMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("getInstance")().asInstanceOf[typings.nginstackEngine.serverIdMod.^]
