...
object libFileStorageVfsFileStorageMod {
  ...
  trait VfsFileStorage extends StObject {
    ...
    def findFileByName(fileName: String): typings.nginstackEngine.libFileStorageFileInfoMod.^ = js.native
    ...
    def tryGetFileInfo(fileKey: Double): typings.nginstackEngine.libFileStorageFileInfoMod.^ = js.native
