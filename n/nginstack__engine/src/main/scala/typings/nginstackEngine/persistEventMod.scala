...
object persistEventMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var action: typings.nginstackEngine.applyUpdatesActionMod.^ = js.native
  ...
  trait PersistEvent extends StObject {
    ...
    var action: typings.nginstackEngine.applyUpdatesActionMod.^
  ...
  object PersistEvent {
    ...
    inline def apply(action: typings.nginstackEngine.applyUpdatesActionMod.^, classKey: Double, key: Double): PersistEvent = {
    ...
    extension [Self <: PersistEvent](x: Self) {
      ...
      inline def setAction(value: typings.nginstackEngine.applyUpdatesActionMod.^): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
