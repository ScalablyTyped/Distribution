...
object permissionMaintenanceMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var _iPermissionClone: typings.nginstackEngine.dataSetMod.^ = js.native
    ...
    /* CompleteClass */
    var iPermissionChanged: typings.nginstackEngine.dataSetMod.^ = js.native
  ...
  trait PermissionMaintenance extends StObject {
    ...
    var _iPermissionClone: typings.nginstackEngine.dataSetMod.^
    ...
    var iPermissionChanged: typings.nginstackEngine.dataSetMod.^
  ...
  object PermissionMaintenance {
    ...
    inline def apply(
      ...
      _iGroupUser: Any,
      _iPermission: Any,
      _iPermissionClone: typings.nginstackEngine.dataSetMod.^,
      _iVfs: Any,
      ...
      iPermissionChanged: typings.nginstackEngine.dataSetMod.^,
      logger_ : Any,
    ...
    extension [Self <: PermissionMaintenance](x: Self) {
      ...
      inline def setIPermissionChanged(value: typings.nginstackEngine.dataSetMod.^): Self = StObject.set(x, "iPermissionChanged", value.asInstanceOf[js.Any])
      ...
      inline def set_iPermissionClone(value: typings.nginstackEngine.dataSetMod.^): Self = StObject.set(x, "_iPermissionClone", value.asInstanceOf[js.Any])
