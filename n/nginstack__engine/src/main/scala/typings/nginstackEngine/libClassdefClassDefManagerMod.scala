...
object libClassdefClassDefManagerMod {
  ...
  inline def getClassVersion(classKey: typings.nginstackEngine.libDbkeyDbkeyMod.^): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("getClassVersion")(classKey.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  inline def getParentClass(classKey: typings.nginstackEngine.libDbkeyDbkeyMod.^): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("getParentClass")(classKey.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  trait ClassDefManager extends StObject {
    ...
    def getClassDef(classKey: Double): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
    def getClassDef(classKey: Double, opt_ignoredClassKeys: js.Array[Double]): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
    
    var getClassDefBySource: Any = js.native
    
    def getClassDefVersion(classKey: Double): Double = js.native
    
    def getConfig(classKey: Double): typings.nginstackEngine.libClassdefConfigDefMod.^ = js.native
    def getConfig(classKey: Double, opt_options: IgnoredFileKeys): typings.nginstackEngine.libClassdefConfigDefMod.^ = js.native
    def getConfig(classKey: Double, opt_options: Record[Any, Any]): typings.nginstackEngine.libClassdefConfigDefMod.^ = js.native
    
    def getConfigDefBySource(src: String, parent: Double): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
    ...
    def getModelDef(classKey: Double): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
    def getModelDef(classKey: Double, opt_options: ForceStrictMode): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
    def getModelDef(classKey: Double, opt_options: Record[Any, Any]): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
    
    def getModelDefBySource(src: String, parent: Double): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
    def getModelDefBySource(src: String, parent: Double, opt_classKey: Double): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
    
    def getViewDef(classKey: Double): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
    def getViewDef(classKey: Double, opt_options: IgnoredFileKeys): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
    def getViewDef(classKey: Double, opt_options: Record[Any, Any]): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
    
    def getViewDefBySource(src: String, parent: Double): typings.nginstackEngine.libClassdefModelDefMod.^ = js.native
