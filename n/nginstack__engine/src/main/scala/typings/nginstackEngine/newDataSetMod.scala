...
object newDataSetMod {
  
  inline def apply(fields: js.Array[FieldObj]): typings.nginstackEngine.dataSetMod.^ = ^.asInstanceOf[js.Dynamic].apply(fields.asInstanceOf[js.Any]).asInstanceOf[typings.nginstackEngine.dataSetMod.^]
