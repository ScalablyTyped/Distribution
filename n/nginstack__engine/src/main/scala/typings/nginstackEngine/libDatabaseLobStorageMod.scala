...
object libDatabaseLobStorageMod {
  ...
  inline def apply(classKey: typings.nginstackEngine.libDbkeyDbkeyMod.^): Unit = ^.asInstanceOf[js.Dynamic].apply(classKey.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    ...
    def this(classKey: typings.nginstackEngine.libDbkeyDbkeyMod.^) = this()
  }
  @JSImport("@nginstack/engine/lib/database/LobStorage", JSImport.Namespace)
  @js.native
  ...
  trait LobStorage extends StObject {
    ...
    def tryGetLob(key: Double): typings.nginstackEngine.libDatabaseLargeObjectMod.^ = js.native
