...
import typings.nginstackEngine.libSettingsSettingTypeMod.SettingType
...
object libSettingsGeneralSettingsMod {
  ...
  trait GeneralSettings extends StObject {
    ...
    def get(id: typings.nginstackEngine.libDbkeyDbkeyMod.^): Any = js.native
    
    def getDefaultValue(id: String): Any = js.native
    def getDefaultValue(id: Double): Any = js.native
    def getDefaultValue(id: typings.nginstackEngine.libDbkeyDbkeyMod.^): Any = js.native
    ...
    def update(id: typings.nginstackEngine.libDbkeyDbkeyMod.^, value: Any): Double = js.native
    ...
    def validateSettingName(name: String, key: typings.nginstackEngine.libDbkeyDbkeyMod.^): Unit = js.native
  ...
  trait SettingOptions extends StObject {
    ...
    var classKey: js.UndefOr[typings.nginstackEngine.libDbkeyDbkeyMod.^ | Double] = js.undefined
