...
object dbtrackerpoolMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    override def release(tracker: typings.nginstackEngine.dbtrackerMod.^): Unit = js.native
    
    /* CompleteClass */
    override def tryAcquire(): typings.nginstackEngine.dbtrackerMod.^ = js.native
  }
  @JSImport("@nginstack/engine/lib/database/DBTrackerPool", JSImport.Namespace)
  @js.native
  ...
  trait DBTrackerPool extends StObject {
    ...
    def release(tracker: typings.nginstackEngine.dbtrackerMod.^): Unit
    
    def tryAcquire(): typings.nginstackEngine.dbtrackerMod.^
  }
  object DBTrackerPool {
    ...
    inline def apply(
      ...
      getDBTracker_ : Any,
      id: Double,
      release: typings.nginstackEngine.dbtrackerMod.^ => Unit,
      tryAcquire: () => typings.nginstackEngine.dbtrackerMod.^
    ): DBTrackerPool = {
    ...
    extension [Self <: DBTrackerPool](x: Self) {
      ...
      inline def setRelease(value: typings.nginstackEngine.dbtrackerMod.^ => Unit): Self = StObject.set(x, "release", js.Any.fromFunction1(value))
      
      inline def setTryAcquire(value: () => typings.nginstackEngine.dbtrackerMod.^): Self = StObject.set(x, "tryAcquire", js.Any.fromFunction0(value))
    }
  }
}
