...
object libEventLegacyEventMod {
  ...
  trait LegacyEvent extends StObject {
    ...
    var _methods: js.Array[
        typings.nginstackEngine.libEventLegacyMethodMod.^ | (js.Function1[/* arg0 */ Any, Any])
      ] = js.native
    ...
    def set(method: typings.nginstackEngine.libEventLegacyMethodMod.^): Unit = js.native
  }
}
