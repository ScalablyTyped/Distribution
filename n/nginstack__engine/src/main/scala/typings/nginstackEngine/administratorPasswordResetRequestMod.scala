...
object administratorPasswordResetRequestMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    override def authorize(privateKey: Any): String = js.native
  ...
  trait AdministratorPasswordResetRequest extends StObject {
    ...
    def authorize(privateKey: Any): String
  ...
  object AdministratorPasswordResetRequest {
    ...
    extension [Self <: AdministratorPasswordResetRequest](x: Self) {
      ...
      inline def setAuthorize(value: Any => String): Self = StObject.set(x, "authorize", js.Any.fromFunction1(value))
