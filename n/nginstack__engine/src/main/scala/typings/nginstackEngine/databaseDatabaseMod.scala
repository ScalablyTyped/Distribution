...
object databaseDatabaseMod {
  ...
  inline def apply(host: typings.nginstackEngine.connectionConnectionMod.^, dbName: String): Unit = (^.asInstanceOf[js.Dynamic].apply(host.asInstanceOf[js.Any], dbName.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    ...
    def this(host: typings.nginstackEngine.connectionConnectionMod.^, dbName: String) = this()
  }
  @JSImport("@nginstack/engine/lib/database/Database", JSImport.Namespace)
  @js.native
  ...
  inline def fromConfig(key: typings.nginstackEngine.dbkeyMod.^): Database = ^.asInstanceOf[js.Dynamic].applyDynamic("fromConfig")(key.asInstanceOf[js.Any]).asInstanceOf[Database]
  ...
  trait Database extends StObject {
    ...
    def applyUpdates(dataSets: typings.nginstackEngine.dataSetMod.^): Double = js.native
    def applyUpdates(dataSets: typings.nginstackEngine.dataSetMod.^, log: Boolean): Double = js.native
    ...
    def getReferences(key: Double, tableName: String): typings.nginstackEngine.dataSetMod.^ = js.native
    def getReferences(key: Double, tableName: String, maxReturnCount: Double): typings.nginstackEngine.dataSetMod.^ = js.native
    def getReferences(key: Double, tableName: String, maxReturnCount: Double, ignoredTables: String): typings.nginstackEngine.dataSetMod.^ = js.native
    def getReferences(key: Double, tableName: String, maxReturnCount: Unit, ignoredTables: String): typings.nginstackEngine.dataSetMod.^ = js.native
    ...
    def loginBySession(session: Any): Boolean = js.native
    
    def logout(): Unit = js.native
    
    var protocol: String = js.native
    
    def query(sql: String): typings.nginstackEngine.dataSetMod.^ | js.Array[typings.nginstackEngine.dataSetMod.^] = js.native
    def query(sql: String, options: Any): typings.nginstackEngine.dataSetMod.^ | js.Array[typings.nginstackEngine.dataSetMod.^] = js.native
    def query(sql: js.Array[String]): typings.nginstackEngine.dataSetMod.^ | js.Array[typings.nginstackEngine.dataSetMod.^] = js.native
    def query(sql: js.Array[String], options: Any): typings.nginstackEngine.dataSetMod.^ | js.Array[typings.nginstackEngine.dataSetMod.^] = js.native
    ...
    def sendMail(mail: Any): Unit = js.native
