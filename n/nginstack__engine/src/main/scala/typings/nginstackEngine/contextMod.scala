...
import typings.nginstackEngine.contextVendorMod.ThemeColors
import typings.nginstackEngine.libConnectionConnectionMod.^
...
object contextMod {
  ...
  @js.native
  val database: typings.nginstackEngine.libDatabaseDatabaseMod.^ = js.native
  
  @JSImport("@nginstack/engine/context", "dbCache")
  @js.native
  val dbCache: typings.nginstackEngine.libDatabaseDbcacheMod.^ = js.native
  
  @JSImport("@nginstack/engine/context", "engine")
  @js.native
  val engine: typings.nginstackEngine.libEngineEngineMod.^ = js.native
  
  @JSImport("@nginstack/engine/context", "request")
  @js.native
  val request: typings.nginstackEngine.libHttpRequestMod.^ = js.native
  
  @JSImport("@nginstack/engine/context", "response")
  @js.native
  val response: typings.nginstackEngine.libHttpResponseMod.^ = js.native
  
  @JSImport("@nginstack/engine/context", "session")
  @js.native
  val session: typings.nginstackEngine.libSessionSessionMod.^ = js.native
  
  @JSImport("@nginstack/engine/context", "tempDB")
  @js.native
  val tempDB: typings.nginstackEngine.libIdoIdoDBMod.^ = js.native
