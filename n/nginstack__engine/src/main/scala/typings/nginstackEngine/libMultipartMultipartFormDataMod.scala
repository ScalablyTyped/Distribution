...
object libMultipartMultipartFormDataMod {
  ...
  inline def apply(
    ...
    options: typings.nginstackEngine.libMultipartMultipartFormDataOptionsMod.^
  ...
  object MultipartFormData {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: MultipartFormData] (val x: Self) extends AnyVal {
