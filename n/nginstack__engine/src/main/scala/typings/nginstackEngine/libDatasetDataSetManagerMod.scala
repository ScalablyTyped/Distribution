...
object libDatasetDataSetManagerMod {
  ...
  trait DataSetManager extends StObject {
    ...
    def addDataSet(dataSetName: String, dataSet: typings.nginstackEngine.libDatasetDataSetMod.^): Unit = js.native
    ...
    def getDataSet(dataSetName: String): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    def setDataSet(dataSetName: String, dataSet: typings.nginstackEngine.libDatasetDataSetMod.^): Unit = js.native
