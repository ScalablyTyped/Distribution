...
object libClassdefFieldListMod {
  ...
  trait FieldList extends StObject {
    ...
    def add(field: typings.nginstackEngine.libClassdefFieldMod.^): Unit = js.native
    ...
    def field(nameOrIndex: String): typings.nginstackEngine.libClassdefFieldMod.^ = js.native
    def field(nameOrIndex: Double): typings.nginstackEngine.libClassdefFieldMod.^ = js.native
    ...
    def remove(nameOrIndexOrField: String): typings.nginstackEngine.libClassdefFieldMod.^ = js.native
    def remove(nameOrIndexOrField: Double): typings.nginstackEngine.libClassdefFieldMod.^ = js.native
    def remove(nameOrIndexOrField: typings.nginstackEngine.libClassdefFieldMod.^): typings.nginstackEngine.libClassdefFieldMod.^ = js.native
    ...
    def setFieldsProperties(
      fieldNames: String,
      propertyNames: js.Function1[/* arg0 */ typings.nginstackEngine.libClassdefFieldMod.^, Unit],
      args: Any*
    ): Unit = js.native
    def setFieldsProperties(
      fieldNames: js.Array[typings.nginstackEngine.libClassdefFieldMod.^],
