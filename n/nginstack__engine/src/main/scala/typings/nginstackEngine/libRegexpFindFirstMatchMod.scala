...
object libRegexpFindFirstMatchMod {
  ...
  inline def apply(text: String, exp: typings.nginstackEngine.libRegexpRegexMod.^): String = (^.asInstanceOf[js.Dynamic].apply(text.asInstanceOf[js.Any], exp.asInstanceOf[js.Any])).asInstanceOf[String]
