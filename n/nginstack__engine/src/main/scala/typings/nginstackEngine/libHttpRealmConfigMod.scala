...
object libHttpRealmConfigMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var application: typings.nginstackEngine.libDbkeyDbkeyMod.^ | Double = js.native
  ...
  trait RealmConfig extends StObject {
    ...
    var application: typings.nginstackEngine.libDbkeyDbkeyMod.^ | Double
  ...
  object RealmConfig {
    ...
    inline def apply(
      application: typings.nginstackEngine.libDbkeyDbkeyMod.^ | Double,
