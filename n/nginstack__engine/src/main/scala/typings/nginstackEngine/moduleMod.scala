...
object moduleMod {
  ...
  @js.native
  def isAbsolutePathRegex: Any = js.native
  
  inline def isAbsolutePathRegex_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("isAbsolutePathRegex_")(x.asInstanceOf[js.Any])
