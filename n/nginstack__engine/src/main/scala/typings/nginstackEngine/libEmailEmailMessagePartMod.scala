...
object libEmailEmailMessagePartMod {
  
  inline def apply(): Unit = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[Unit]
  
  @JSImport("@nginstack/engine/lib/email/EmailMessagePart", JSImport.Namespace)
  @js.native
  open class ^ ()
    extends StObject
       with EmailMessagePart {
    ...
    /* CompleteClass */
    var ownerMessagePart: EmailMessagePart = js.native
  ...
  trait EmailMessagePart extends StObject {
    ...
    var ownerMessagePart: EmailMessagePart
  ...
  object EmailMessagePart {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[EmailMessagePart]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: EmailMessagePart] (val x: Self) extends AnyVal {
      ...
      inline def setOwnerMessagePart(value: EmailMessagePart): Self = StObject.set(x, "ownerMessagePart", value.asInstanceOf[js.Any])
