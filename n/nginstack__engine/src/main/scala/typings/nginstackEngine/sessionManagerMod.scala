...
object sessionManagerMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    override def getStatistics(): Any = js.native
  ...
  object SessionManager {
    ...
    extension [Self <: SessionManager](x: Self) {
      ...
      inline def setGetStatistics(value: () => Any): Self = StObject.set(x, "getStatistics", js.Any.fromFunction0(value))
