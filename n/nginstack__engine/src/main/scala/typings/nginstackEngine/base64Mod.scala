...
object base64Mod {
  ...
  inline def decode(str: String, opt_decodeFmt: Double): String | js.typedarray.ArrayBuffer = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(str.asInstanceOf[js.Any], opt_decodeFmt.asInstanceOf[js.Any])).asInstanceOf[String | js.typedarray.ArrayBuffer]
  ...
  inline def decode(str: js.typedarray.ArrayBuffer, opt_decodeFmt: Double): String | js.typedarray.ArrayBuffer = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(str.asInstanceOf[js.Any], opt_decodeFmt.asInstanceOf[js.Any])).asInstanceOf[String | js.typedarray.ArrayBuffer]
  
  inline def encode(bin: Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(bin.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def encode(bin: Any, opt_encodeFmt: Double): String = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(bin.asInstanceOf[js.Any], opt_encodeFmt.asInstanceOf[js.Any])).asInstanceOf[String]
