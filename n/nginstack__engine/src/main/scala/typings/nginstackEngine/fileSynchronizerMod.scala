...
object fileSynchronizerMod {
  
  inline def apply(localPath: String, remotePath: String, db: typings.nginstackEngine.connectionConnectionMod.^): Unit = (^.asInstanceOf[js.Dynamic].apply(localPath.asInstanceOf[js.Any], remotePath.asInstanceOf[js.Any], db.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def apply(localPath: String, remotePath: String, db: typings.nginstackEngine.databaseDatabaseMod.^): Unit = (^.asInstanceOf[js.Dynamic].apply(localPath.asInstanceOf[js.Any], remotePath.asInstanceOf[js.Any], db.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    ...
    def this(localPath: String, remotePath: String, db: typings.nginstackEngine.connectionConnectionMod.^) = this()
    def this(localPath: String, remotePath: String, db: typings.nginstackEngine.databaseDatabaseMod.^) = this()
