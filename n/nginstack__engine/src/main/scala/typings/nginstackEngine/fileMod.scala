...
object fileMod {
  ...
  inline def findClose(searchRecord: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("findClose")(searchRecord.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def findFirst(fileName: String): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("findFirst")(fileName.asInstanceOf[js.Any]).asInstanceOf[Any]
  inline def findFirst(fileName: String, opt_attributes: String): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("findFirst")(fileName.asInstanceOf[js.Any], opt_attributes.asInstanceOf[js.Any])).asInstanceOf[Any]
  
  inline def findNext(searchRecord: Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("findNext")(searchRecord.asInstanceOf[js.Any]).asInstanceOf[Boolean]
