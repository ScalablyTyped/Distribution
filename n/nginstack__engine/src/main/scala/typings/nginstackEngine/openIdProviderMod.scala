...
import typings.nginstackEngine.oauth2clientMod.OAuth2ClientConstructorOptions
import typings.nginstackEngine.openIdClientMod.OpenIdClientConstructorOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object openIdProviderMod {
  ...
  inline def fromConfig(key: Any): OpenIdProvider = ^.asInstanceOf[js.Dynamic].applyDynamic("fromConfig")(key.asInstanceOf[js.Any]).asInstanceOf[OpenIdProvider]
  ...
  trait OpenIdProvider extends StObject {
    ...
    def newOAuth2Client(): typings.nginstackEngine.oauth2clientMod.^ = js.native
    def newOAuth2Client(options: OAuth2ClientConstructorOptions): typings.nginstackEngine.oauth2clientMod.^ = js.native
    
    def newOpenIdClient(): typings.nginstackEngine.openIdClientMod.^ = js.native
    def newOpenIdClient(options: OpenIdClientConstructorOptions): typings.nginstackEngine.openIdClientMod.^ = js.native
