...
object libDatabaseClassesMod {
  ...
  trait Classes extends StObject {
    ...
    def getCachedDataSet(classKey: Double): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def getCachedDataSet(classKey: Double, userKey: Double): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def getCachedDataSet(classKey: Double, userKey: Double, securityExtraFilter: String): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def getCachedDataSet(classKey: Double, userKey: Double, securityExtraFilter: js.Array[js.Array[String]]): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def getCachedDataSet(classKey: Double, userKey: Unit, securityExtraFilter: String): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def getCachedDataSet(classKey: Double, userKey: Unit, securityExtraFilter: js.Array[js.Array[String]]): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    def getClassDefinitionSource(classKey: Double, kind: Any, vfs: Unit, classes: typings.nginstackEngine.libDatasetDataSetMod.^): String = js.native
    ...
    def getClassDefinitionSource(classKey: Double, kind: Any, vfs: typings.nginstackEngine.libDatasetDataSetMod.^): String = js.native
    def getClassDefinitionSource(
      classKey: Double,
      kind: Any,
    ...
    def getTabularHierarchy(rootClassKey: Double): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    def getTabularHierarchy(rootClassKey: Double, opt_filters: ExcludeOrphans): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
