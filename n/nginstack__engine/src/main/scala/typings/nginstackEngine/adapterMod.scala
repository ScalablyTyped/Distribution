...
object adapterMod {
  ...
  inline def apply(
    emitter: typings.nginstackEngine.emitterMod.^,
    descriptor: typings.nginstackEngine.adapterDescriptorMod.^
  ): Unit = (^.asInstanceOf[js.Dynamic].apply(emitter.asInstanceOf[js.Any], descriptor.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def apply(emitter: typings.nginstackEngine.emitterMod.^, descriptor: Record[Any, Any]): Unit = (^.asInstanceOf[js.Dynamic].apply(emitter.asInstanceOf[js.Any], descriptor.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ protected ()
    ...
    def this(emitter: typings.nginstackEngine.emitterMod.^, descriptor: Record[Any, Any]) = this()
  }
  @JSImport("@nginstack/engine/lib/event/Adapter", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def adaptEvent(obj: Any, name: String, adapterDescriptor: typings.nginstackEngine.adapterDescriptorMod.^): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("adaptEvent")(obj.asInstanceOf[js.Any], name.asInstanceOf[js.Any], adapterDescriptor.asInstanceOf[js.Any])).asInstanceOf[Unit]
