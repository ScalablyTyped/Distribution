...
object libClassdefModelDefMod {
  ...
  type ClassDefManager = typings.nginstackEngine.libClassdefClassDefManagerMod.^
  ...
  trait ModelDef extends StObject {
    ...
    var cache: typings.nginstackEngine.libClassdefClassDefCacheMod.^ = js.native
    ...
    def field(name: String): typings.nginstackEngine.libClassdefFieldMod.^ = js.native
    def field(name: String, `type`: String): typings.nginstackEngine.libClassdefFieldMod.^ = js.native
    def field(name: String, `type`: String, size: Double): typings.nginstackEngine.libClassdefFieldMod.^ = js.native
    def field(name: String, `type`: Unit, size: Double): typings.nginstackEngine.libClassdefFieldMod.^ = js.native
    ...
    def findField(name: String): typings.nginstackEngine.libClassdefFieldMod.^ = js.native
    ...
    def getExtraFilterFields(): js.Array[typings.nginstackEngine.libClassdefFieldMod.^] = js.native
