...
object libDatabaseDbcacheMod {
  ...
  trait DBCache extends StObject {
    ...
    def copyTableStructure(tableName: String, ds: typings.nginstackEngine.libDatasetDataSetMod.^): Unit = js.native
    ...
    def getTable(tableName: String): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
    ...
    def isFromCache(ds: typings.nginstackEngine.libDatasetDataSetMod.^): Boolean = js.native
    
    def newTableStructure(tableName: String): typings.nginstackEngine.libDatasetDataSetMod.^ = js.native
