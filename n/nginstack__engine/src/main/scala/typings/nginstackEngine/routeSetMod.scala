...
object routeSetMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    override def assign(`def`: typings.nginstackEngine.routeSetDefMod.^): Unit = js.native
    
    /* private */ /* CompleteClass */
    var base_ : Any = js.native
    
    /* CompleteClass */
    override def getAllRoutes(): js.Array[typings.nginstackEngine.routeMod.^] = js.native
  ...
  trait RouteSet extends StObject {
    ...
    def assign(`def`: typings.nginstackEngine.routeSetDefMod.^): Unit
    
    /* private */ var base_ : Any
    
    def getAllRoutes(): js.Array[typings.nginstackEngine.routeMod.^]
  ...
  object RouteSet {
    ...
    inline def apply(
      assign: typings.nginstackEngine.routeSetDefMod.^ => Unit,
      base_ : Any,
      getAllRoutes: () => js.Array[typings.nginstackEngine.routeMod.^],
    ...
    extension [Self <: RouteSet](x: Self) {
      ...
      inline def setAssign(value: typings.nginstackEngine.routeSetDefMod.^ => Unit): Self = StObject.set(x, "assign", js.Any.fromFunction1(value))
      
      inline def setBase_(value: Any): Self = StObject.set(x, "base_", value.asInstanceOf[js.Any])
      
      inline def setGetAllRoutes(value: () => js.Array[typings.nginstackEngine.routeMod.^]): Self = StObject.set(x, "getAllRoutes", js.Any.fromFunction0(value))
