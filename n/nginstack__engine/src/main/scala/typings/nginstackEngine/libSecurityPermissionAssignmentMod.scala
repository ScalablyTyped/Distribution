...
object libSecurityPermissionAssignmentMod {
  ...
  inline def fromDataSet(data: typings.nginstackEngine.libDatasetDataSetMod.^): PermissionAssignment = ^.asInstanceOf[js.Dynamic].applyDynamic("fromDataSet")(data.asInstanceOf[js.Any]).asInstanceOf[PermissionAssignment]
  ...
  trait PermissionAssignment extends StObject {
    ...
    def saveToDataSet(data: typings.nginstackEngine.libDatasetDataSetMod.^): Unit = js.native
