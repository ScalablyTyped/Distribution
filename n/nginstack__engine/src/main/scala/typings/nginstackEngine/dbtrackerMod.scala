...
import typings.nginstackEngine.anon.Database
...
object dbtrackerMod {
  ...
  inline def apply(opt_options: Database): Unit = ^.asInstanceOf[js.Dynamic].apply(opt_options.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  open class ^ ()
    extends StObject
       with DBTracker {
    def this(opt_options: Database) = this()
  ...
  inline def finishAbandoned(opt_database: Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("finishAbandoned")(opt_database.asInstanceOf[js.Any]).asInstanceOf[Double]
