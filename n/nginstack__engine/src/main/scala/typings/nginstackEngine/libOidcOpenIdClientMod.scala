...
import typings.nginstackEngine.libOauth2Oauth2clientMod.TokenResponse
...
object libOidcOpenIdClientMod {
  ...
  type TokenIntrospectionResponse = typings.nginstackEngine.libOauth2Oauth2clientMod.TokenIntrospectionResponse
}
