...
object keysUtilitiesMod {
  ...
  trait KeysUtilities extends StObject {
    ...
    def getKeysFromCode(classKey: Any, code: String, classesFilter: String, ds: typings.nginstackEngine.dataSetMod.^): String = js.native
    def getKeysFromCode(classKey: Any, code: String, classesFilter: Unit, ds: typings.nginstackEngine.dataSetMod.^): String = js.native
    
    def getKeysFromField(dataSet: typings.nginstackEngine.dataSetMod.^, fieldName: String, distinct: Boolean): String = js.native
    ...
    def getKeysFromIncompleteCode(classKey: Any, code: String, classesFilter: String, ds: typings.nginstackEngine.dataSetMod.^): String = js.native
    def getKeysFromIncompleteCode(classKey: Any, code: String, classesFilter: Unit, ds: typings.nginstackEngine.dataSetMod.^): String = js.native
    ...
    def getKeysFromMultipleCode(classKey: Any, code: String, filter: String, ds: typings.nginstackEngine.dataSetMod.^): String = js.native
    def getKeysFromMultipleCode(classKey: Any, code: String, filter: Unit, ds: typings.nginstackEngine.dataSetMod.^): String = js.native
