...
import typings.nginstackEngine.mediaTypeMod.MediaType
import typings.nginstackEngine.statusMod.Status
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object routeResultMod {
  
  inline def apply(opt_base: RouteResult): typings.nginstackEngine.routeResultMod.^ = ^.asInstanceOf[js.Dynamic].apply(opt_base.asInstanceOf[js.Any]).asInstanceOf[typings.nginstackEngine.routeResultMod.^]
  ...
  inline def addTransform(transformer: js.Function2[/* arg0 */ RouteResult, /* arg1 */ Any, RouteResult | js.Array[Any]]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addTransform")(transformer.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def addTransformer(transformer: js.Function2[/* arg0 */ RouteResult, /* arg1 */ Any, RouteResult | js.Array[Any]]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addTransformer")(transformer.asInstanceOf[js.Any]).asInstanceOf[Unit]
