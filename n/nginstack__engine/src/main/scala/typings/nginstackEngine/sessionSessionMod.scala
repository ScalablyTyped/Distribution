...
object sessionSessionMod {
  ...
  trait Session extends StObject {
    ...
    var application: typings.nginstackEngine.dbkeyMod.^ = js.native
    
    def authorizeToken(authToken: typings.nginstackEngine.authTokenMod.^): String = js.native
    ...
    def updateAuthToken(authToken: typings.nginstackEngine.authTokenMod.^): Unit = js.native
