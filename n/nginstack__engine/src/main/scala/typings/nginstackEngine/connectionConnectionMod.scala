...
object connectionConnectionMod {
  ...
  inline def fromConfig(key: typings.nginstackEngine.dbkeyMod.^): Connection = ^.asInstanceOf[js.Dynamic].applyDynamic("fromConfig")(key.asInstanceOf[js.Any]).asInstanceOf[Connection]
  ...
  trait Connection extends StObject {
    ...
    def applyUpdates(ArrayOfDataSets: js.Array[typings.nginstackEngine.dataSetMod.^]): Double = js.native
    def applyUpdates(ArrayOfDataSets: js.Array[typings.nginstackEngine.dataSetMod.^], insertIntoLogTable: Boolean): Double = js.native
    def applyUpdates(ArrayOfDataSets: typings.nginstackEngine.dataSetMod.^): Double = js.native
    def applyUpdates(ArrayOfDataSets: typings.nginstackEngine.dataSetMod.^, insertIntoLogTable: Boolean): Double = js.native
    ...
    def cloneLocalCache(tableName: String): typings.nginstackEngine.dataSetMod.^ = js.native
    
    def cloneLocalCacheByClass(classKey: Double): typings.nginstackEngine.dataSetMod.^ = js.native
    def cloneLocalCacheByClass(classKey: Double, userKeyPermissionViewFilter: Double): typings.nginstackEngine.dataSetMod.^ = js.native
    def cloneLocalCacheByClass(classKey: Double, userKeyPermissionViewFilter: Double, securityExtraFilter: js.Array[Any]): typings.nginstackEngine.dataSetMod.^ = js.native
    def cloneLocalCacheByClass(classKey: Double, userKeyPermissionViewFilter: Unit, securityExtraFilter: js.Array[Any]): typings.nginstackEngine.dataSetMod.^ = js.native
    
    def cloneVfsByClass(classKey: Any, userKeyPermissionViewFilter: Any, securityExtraFilter: Any): typings.nginstackEngine.dataSetMod.^ = js.native
    ...
    def getClassDefinitionSource(
      classKey: typings.nginstackEngine.dbkeyMod.^,
      vfs: Null,
      classes: Null,
      ignoredClassKeys: js.Array[Double]
    ): String = js.native
    ...
    def getDataSet(sqlOrArrayOfSql: String): typings.nginstackEngine.dataSetMod.^ | js.Array[typings.nginstackEngine.dataSetMod.^] = js.native
    def getDataSet(sqlOrArrayOfSql: String, options: Any): typings.nginstackEngine.dataSetMod.^ | js.Array[typings.nginstackEngine.dataSetMod.^] = js.native
    def getDataSet(sqlOrArrayOfSql: js.Array[String]): typings.nginstackEngine.dataSetMod.^ | js.Array[typings.nginstackEngine.dataSetMod.^] = js.native
    def getDataSet(sqlOrArrayOfSql: js.Array[String], options: Any): typings.nginstackEngine.dataSetMod.^ | js.Array[typings.nginstackEngine.dataSetMod.^] = js.native
    
    def getDatabaseNames(): String = js.native
    
    def getExecutionPlan(sqlExpression: String): typings.nginstackEngine.dataSetMod.^ = js.native
    ...
    def getReferences(key: Double, tableName: String, maxReturnCount: Double, ignoredTables: js.Array[String]): typings.nginstackEngine.dataSetMod.^ = js.native
    def getReferences(key: Double, tableName: String, maxReturnCount: Null, ignoredTables: js.Array[String]): typings.nginstackEngine.dataSetMod.^ = js.native
    ...
    def instanceClassDefinition(classKeyOrSource: String): Any = js.native
    def instanceClassDefinition(classKeyOrSource: String, iVfsOrParentKey: Double): Any = js.native
    def instanceClassDefinition(classKeyOrSource: String, iVfsOrParentKey: Double, iClass: typings.nginstackEngine.dataSetMod.^): Any = js.native
    def instanceClassDefinition(classKeyOrSource: String, iVfsOrParentKey: Unit, iClass: typings.nginstackEngine.dataSetMod.^): Any = js.native
    def instanceClassDefinition(classKeyOrSource: String, iVfsOrParentKey: typings.nginstackEngine.dataSetMod.^): Any = js.native
    def instanceClassDefinition(
      classKeyOrSource: String,
      iVfsOrParentKey: typings.nginstackEngine.dataSetMod.^,
      iClass: typings.nginstackEngine.dataSetMod.^
    ): Any = js.native
    def instanceClassDefinition(classKeyOrSource: Double): Any = js.native
    def instanceClassDefinition(classKeyOrSource: Double, iVfsOrParentKey: Double): Any = js.native
    def instanceClassDefinition(classKeyOrSource: Double, iVfsOrParentKey: Double, iClass: typings.nginstackEngine.dataSetMod.^): Any = js.native
    def instanceClassDefinition(classKeyOrSource: Double, iVfsOrParentKey: Unit, iClass: typings.nginstackEngine.dataSetMod.^): Any = js.native
    def instanceClassDefinition(classKeyOrSource: Double, iVfsOrParentKey: typings.nginstackEngine.dataSetMod.^): Any = js.native
    def instanceClassDefinition(
    ...
    def newTask(task: Any): Unit = js.native
    def newTask(task: Any, userName: String): Unit = js.native
    def newTask(task: Any, userName: String, password: String): Unit = js.native
    def newTask(task: Any, userName: Null, password: String): Unit = js.native
    ...
    def scheduledSendMail(mail: Any): Unit = js.native
    def scheduledSendMail(mail: Any, maxSize: Double): Unit = js.native
    ...
    def setPassword(userKey: typings.nginstackEngine.dbkeyMod.^, password: String): Unit = js.native
