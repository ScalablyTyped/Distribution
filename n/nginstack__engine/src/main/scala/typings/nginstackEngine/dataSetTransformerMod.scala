...
object dataSetTransformerMod {
  ...
  object DistinctController {
    ...
    @JSImport("@nginstack/engine/lib/dataset/DataSetTransformer", "DistinctController")
    @js.native
    def apply(ds: typings.nginstackEngine.dataSetMod.^, groupColumns: js.Array[Any]): Unit = js.native
  }
  ...
  trait DataSetTransformer extends StObject {
    ...
    def aggregate(ds: typings.nginstackEngine.dataSetMod.^, groupColumns: js.Array[Any], aggregateColumns: Any): typings.nginstackEngine.dataSetMod.^ = js.native
    
    def calculate(ds: typings.nginstackEngine.dataSetMod.^, exprs: js.Array[Any]): typings.nginstackEngine.dataSetMod.^ = js.native
    def calculate(ds: typings.nginstackEngine.dataSetMod.^, exprs: js.Array[Any], hiddenFields: js.Array[Any]): typings.nginstackEngine.dataSetMod.^ = js.native
    
    def pivot(ds: typings.nginstackEngine.dataSetMod.^, pivotFieldName: String, totalFieldsNames: String): PivotResult = js.native
    def pivot(
      ds: typings.nginstackEngine.dataSetMod.^,
      pivotFieldName: String,
      totalFieldsNames: String,
      options: DefaultDate
    ): PivotResult = js.native
    def pivot(ds: typings.nginstackEngine.dataSetMod.^, pivotFieldName: String, totalFieldsNames: js.Array[Any]): PivotResult = js.native
    def pivot(
      ds: typings.nginstackEngine.dataSetMod.^,
      pivotFieldName: String,
  ...
  trait PivotResult extends StObject {
    ...
    var pivotDS: typings.nginstackEngine.dataSetMod.^
  ...
  object PivotResult {
    ...
    inline def apply(
      ...
      pivotDS: typings.nginstackEngine.dataSetMod.^,
      pivotFieldName: String,
    ...
    extension [Self <: PivotResult](x: Self) {
      ...
      inline def setPivotDS(value: typings.nginstackEngine.dataSetMod.^): Self = StObject.set(x, "pivotDS", value.asInstanceOf[js.Any])
