...
object idoDBMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    override def getTable(tableName: String): Any = js.native
  ...
  trait IdoDB extends StObject {
    ...
    def getTable(tableName: String): Any
  ...
  object IdoDB {
    ...
    extension [Self <: IdoDB](x: Self) {
      ...
      inline def setGetTable(value: String => Any): Self = StObject.set(x, "getTable", js.Any.fromFunction1(value))
