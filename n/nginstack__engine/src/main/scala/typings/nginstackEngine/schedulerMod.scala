...
object schedulerMod {
  ...
  trait Scheduler extends StObject {
    ...
    def saveTasks(tasks: Any, userId: String): Unit = js.native
    def saveTasks(tasks: Any, userId: String, password: String): Unit = js.native
    def saveTasks(tasks: Any, userId: Unit, password: String): Unit = js.native
