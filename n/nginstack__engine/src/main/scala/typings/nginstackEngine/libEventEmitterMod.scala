...
object libEventEmitterMod {
  ...
  trait Emitter extends StObject {
    ...
    def emit(event: typings.nginstackEngine.libEventEventMod.^): Boolean = js.native
    
    def filterListeners(filterFn: js.Function1[/* arg0 */ typings.nginstackEngine.libEventListenerMod.^, Boolean]): Unit = js.native
    def filterListeners(
      filterFn: js.Function1[/* arg0 */ typings.nginstackEngine.libEventListenerMod.^, Boolean],
      opt_type: String
    ): Unit = js.native
    ...
    def listenerHandlers(`type`: String): js.Array[js.Function1[/* arg0 */ typings.nginstackEngine.libEventEventMod.^, Any]] = js.native
    
    def listeners(): js.Array[typings.nginstackEngine.libEventListenerMod.^] = js.native
    def listeners(opt_type: String): js.Array[typings.nginstackEngine.libEventListenerMod.^] = js.native
    
    /* private */ var listenersByType_ : Any = js.native
    
    /* private */ var listeners_ : Any = js.native
    
    def off(`type`: String, listener: js.Function1[/* arg0 */ typings.nginstackEngine.libEventEventMod.^, Any]): Unit = js.native
    def off(`type`: String, listener: typings.nginstackEngine.libEventListenerMod.^): Unit = js.native
    
    def offAll(): Unit = js.native
    def offAll(opt_type: String): Unit = js.native
    
    def on(`type`: String, listener: js.Function1[/* arg0 */ typings.nginstackEngine.libEventEventMod.^, Any]): Unit = js.native
    ...
    def replaceListeners(
      ...
      listener: js.Function2[
          /* arg0 */ typings.nginstackEngine.libEventEventMod.^, 
          /* arg1 */ js.Function1[/* arg0 */ typings.nginstackEngine.libEventEventMod.^, Any], 
          Any
        ]
    ): Unit = js.native
    def replaceListeners(`type`: String, listener: typings.nginstackEngine.libEventListenerMod.^): Unit = js.native
