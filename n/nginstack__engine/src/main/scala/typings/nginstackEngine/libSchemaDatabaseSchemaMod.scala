...
object libSchemaDatabaseSchemaMod {
  ...
  inline def deregisterObserver(observer: typings.nginstackEngine.libSchemaDatabaseSchemaObserverMod.^): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("deregisterObserver")(observer.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def registerObserver(observer: typings.nginstackEngine.libSchemaDatabaseSchemaObserverMod.^): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("registerObserver")(observer.asInstanceOf[js.Any]).asInstanceOf[Unit]
