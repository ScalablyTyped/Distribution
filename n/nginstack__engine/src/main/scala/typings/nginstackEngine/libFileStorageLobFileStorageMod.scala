...
object libFileStorageLobFileStorageMod {
  ...
  trait LobFileStorage extends StObject {
    ...
    def addFile(fileName: String, content: typings.nginstackEngine.libIoFileMod.^): Double = js.native
    def addFile(fileName: String, content: typings.nginstackEngine.libIoMemoryStreamMod.^): Double = js.native
