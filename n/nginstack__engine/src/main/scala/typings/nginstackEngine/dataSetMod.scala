...
object dataSetMod {
  ...
  inline def apply(idoDB: Any): Unit = ^.asInstanceOf[js.Dynamic].apply(idoDB.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  open class ^ ()
    extends StObject
       with DataSet {
    def this(idoDB: Any) = this()
  }
  @JSImport("@nginstack/engine/lib/dataset/DataSet", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def getIntegerDataType(): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getIntegerDataType")().asInstanceOf[Any]
  
  inline def getStringOverflowMode(): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getStringOverflowMode")().asInstanceOf[String]
  
  inline def setIntegerDataType(`type`: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setIntegerDataType")(`type`.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  trait DataSet extends StObject {
    ...
    def dbkey(expr: String): typings.nginstackEngine.dbkeyMod.^ | Null = js.native
    ...
    def getDeltaInspector(): Any = js.native
  ...
  object DataSetFieldDef {
    ...
    inline def apply(name: String, size: Double, `type`: Any): DataSetFieldDef = {
  ...
  trait DataSetFieldDefs extends StObject {
    ...
    def add(defOrName: String, `type`: Any): Unit = js.native
    def add(defOrName: String, `type`: Any, size: Double): Unit = js.native
    def add(defOrName: String, `type`: Unit, size: Double): Unit = js.native
    def add(defOrName: js.Array[DataSetFieldDef]): Unit = js.native
    def add(defOrName: js.Array[DataSetFieldDef], `type`: Any): Unit = js.native
    def add(defOrName: js.Array[DataSetFieldDef], `type`: Any, size: Double): Unit = js.native
    ...
    def add(defOrName: DataSetFieldDef, `type`: Any): Unit = js.native
    def add(defOrName: DataSetFieldDef, `type`: Any, size: Double): Unit = js.native
  ...
  type GetFieldOptions = typings.nginstackEngine.getFieldOptionsMod.^
