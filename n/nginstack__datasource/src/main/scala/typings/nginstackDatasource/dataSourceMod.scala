...
object dataSourceMod {
  ...
  inline def list(): typings.nginstackEngine.dataSetMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("list")().asInstanceOf[typings.nginstackEngine.dataSetMod.^]
  ...
  trait DataSource extends StObject {
    ...
    def createColumns(jsonColumns: js.Array[Any | DataSourceColumnDef]): typings.nginstackDatasource.dataSourceColumnsMod.^ = js.native
    
    def createFilters(jsonFilters: js.Array[Any | DataSourceFilterDef]): typings.nginstackDatasource.dataSourceFiltersMod.^ = js.native
    
    def createFiltersFromMap(filtersMap: StringDictionary[Any]): typings.nginstackDatasource.dataSourceFiltersMod.^ = js.native
    ...
    def getResult(filters: js.Array[Any | DataSourceFilterDef], columns: js.Array[Any | DataSourceColumnDef]): typings.nginstackDatasource.dataSourceResultMod.^ = js.native
    ...
    def mountDataSet(ds: typings.nginstackEngine.dataSetMod.^): typings.nginstackEngine.dataSetMod.^ = js.native
  ...
  type DataSourceColumnDef = typings.nginstackDatasource.dataSourceColumnDefMod.^
  
  type DataSourceDef = typings.nginstackDatasource.dataSourceDefMod.^
  
  type DataSourceFilterDef = typings.nginstackDatasource.dataSourceFilterDefMod.^
}
