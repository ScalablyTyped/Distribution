...
object dataSourceFiltersMod {
  ...
  inline def apply(opt_dataSource: Any, opt_filtersValues: js.Array[Any]): Unit = (^.asInstanceOf[js.Dynamic].apply(opt_dataSource.asInstanceOf[js.Any], opt_filtersValues.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ ()
    ...
    def this(opt_dataSource: Any, opt_filtersValues: js.Array[Any]) = this()
  ...
  trait DataSourceFilters extends StObject {
    ...
    def filter(id: String): typings.nginstackDatasource.dataSourceFilterMod.^ = js.native
    def filter(id: String, opt_type: String): typings.nginstackDatasource.dataSourceFilterMod.^ = js.native
    def filter(id: String, opt_type: String, opt_classKey: Double): typings.nginstackDatasource.dataSourceFilterMod.^ = js.native
    def filter(id: String, opt_type: Unit, opt_classKey: Double): typings.nginstackDatasource.dataSourceFilterMod.^ = js.native
    def filter(id: Double): typings.nginstackDatasource.dataSourceFilterMod.^ = js.native
    def filter(id: Double, opt_type: String): typings.nginstackDatasource.dataSourceFilterMod.^ = js.native
    def filter(id: Double, opt_type: String, opt_classKey: Double): typings.nginstackDatasource.dataSourceFilterMod.^ = js.native
    def filter(id: Double, opt_type: Unit, opt_classKey: Double): typings.nginstackDatasource.dataSourceFilterMod.^ = js.native
    ...
    def getIQueryFilters(filtersSelection: String, conditionalOperator: String, iquery: Any): js.Array[Any] = js.native
    ...
    def map(
      fn: js.Function3[
          /* arg0 */ typings.nginstackDatasource.dataSourceFilterMod.^, 
          /* arg1 */ Double, 
          /* arg2 */ js.Array[typings.nginstackDatasource.dataSourceFilterMod.^], 
          Any
        ]
