...
object dataSourceColumnsMod {
  
  inline def apply(): Unit = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[Unit]
  inline def apply(opt_dataSource: Any): Unit = ^.asInstanceOf[js.Dynamic].apply(opt_dataSource.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def apply(opt_dataSource: Any, opt_colsDefs: js.Array[DataSourceColumnDef]): Unit = (^.asInstanceOf[js.Dynamic].apply(opt_dataSource.asInstanceOf[js.Any], opt_colsDefs.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  open class ^ ()
    ...
    def this(opt_dataSource: Any) = this()
    def this(opt_dataSource: Any, opt_colsDefs: js.Array[DataSourceColumnDef]) = this()
  ...
  trait DataSourceColumns extends StObject {
    ...
    def column(indexOrName: String): typings.nginstackDatasource.dataSourceColumnMod.^ = js.native
    def column(indexOrName: String, opt_type: String): typings.nginstackDatasource.dataSourceColumnMod.^ = js.native
    def column(indexOrName: Double): typings.nginstackDatasource.dataSourceColumnMod.^ = js.native
    def column(indexOrName: Double, opt_type: String): typings.nginstackDatasource.dataSourceColumnMod.^ = js.native
    ...
    def findByAlias(alias: String): typings.nginstackDatasource.dataSourceColumnMod.^ = js.native
    
    def findByName(name: String): typings.nginstackDatasource.dataSourceColumnMod.^ = js.native
