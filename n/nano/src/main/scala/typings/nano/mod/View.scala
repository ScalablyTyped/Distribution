...
object View {
  ...
  @scala.inline
  implicit class ViewMutableBuilder[Self <: View[?], D] (val x: Self & View[D]) extends AnyVal {
    
    @scala.inline
    def setMap(value: String | DocumentInfer[D]): Self = StObject.set(x, "map", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMapFunction1(value: /* doc */ D & Document => Unit): Self = StObject.set(x, "map", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setReduceFunction1(value: /* doc */ D & Document => Unit): Self = StObject.set(x, "reduce", js.Any.fromFunction1(value))
