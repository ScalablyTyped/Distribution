...
trait DocumentViewResponse[V, D] extends js.Object {
  ...
  var rows: js.Array[AnonDocId[V, D]]
...
object DocumentViewResponse {
  @scala.inline
  def apply[V, D](offset: Double, rows: js.Array[AnonDocId[V, D]], total_rows: Double, update_seq: js.Any): DocumentViewResponse[V, D] = {
