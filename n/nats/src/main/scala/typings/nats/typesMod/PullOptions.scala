...
trait PullOptions extends StObject {
...
object PullOptions {
  ...
  inline def apply(batch: Double, expires: Double, no_wait: Boolean): PullOptions = {
    ...
    __obj.asInstanceOf[PullOptions]
  }
  
  extension [Self <: PullOptions](x: Self) {
