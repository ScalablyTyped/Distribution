...
object util {
  ...
  @js.native
  open class ByteStringBuffer () extends StObject {
  ...
  object binary {
    ...
    object base64 {
      ...
      inline def decode(input: Base64): js.typedarray.Uint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(input.asInstanceOf[js.Any]).asInstanceOf[js.typedarray.Uint8Array]
      inline def decode(input: Base64, output: js.typedarray.Uint8Array): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
      inline def decode(input: Base64, output: js.typedarray.Uint8Array, offset: Double): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
      inline def decode(input: Base64, output: Unit, offset: Double): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
      
      inline def encode(input: js.typedarray.Uint8Array): Base64 = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(input.asInstanceOf[js.Any]).asInstanceOf[Base64]
      inline def encode(input: js.typedarray.Uint8Array, maxline: Double): Base64 = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(input.asInstanceOf[js.Any], maxline.asInstanceOf[js.Any])).asInstanceOf[Base64]
    }
    ...
    object hex {
      ...
      inline def decode(hex: Hex): js.typedarray.Uint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(hex.asInstanceOf[js.Any]).asInstanceOf[js.typedarray.Uint8Array]
      inline def decode(hex: Hex, output: js.typedarray.Uint8Array): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(hex.asInstanceOf[js.Any], output.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
      inline def decode(hex: Hex, output: js.typedarray.Uint8Array, offset: Double): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(hex.asInstanceOf[js.Any], output.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
      inline def decode(hex: Hex, output: Unit, offset: Double): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(hex.asInstanceOf[js.Any], output.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
      
      inline def encode(bytes: js.typedarray.ArrayBuffer): Hex = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(bytes.asInstanceOf[js.Any]).asInstanceOf[Hex]
    ...
    object raw {
      ...
      inline def decode(str: Bytes): js.typedarray.Uint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(str.asInstanceOf[js.Any]).asInstanceOf[js.typedarray.Uint8Array]
      inline def decode(str: Bytes, output: js.typedarray.Uint8Array): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(str.asInstanceOf[js.Any], output.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
      inline def decode(str: Bytes, output: js.typedarray.Uint8Array, offset: Double): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(str.asInstanceOf[js.Any], output.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
      inline def decode(str: Bytes, output: Unit, offset: Double): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(str.asInstanceOf[js.Any], output.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
      
      inline def encode(x: js.typedarray.Uint8Array): Bytes = ^.asInstanceOf[js.Dynamic].applyDynamic("encode")(x.asInstanceOf[js.Any]).asInstanceOf[Bytes]
    }
  }
  ...
  inline def createBuffer(input: js.typedarray.ArrayBuffer): ByteBuffer = ^.asInstanceOf[js.Dynamic].applyDynamic("createBuffer")(input.asInstanceOf[js.Any]).asInstanceOf[ByteBuffer]
  inline def createBuffer(input: js.typedarray.ArrayBuffer, encoding: Encoding): ByteBuffer = (^.asInstanceOf[js.Dynamic].applyDynamic("createBuffer")(input.asInstanceOf[js.Any], encoding.asInstanceOf[js.Any])).asInstanceOf[ByteBuffer]
  ...
  inline def isArrayBuffer(x: Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArrayBuffer")(x.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  inline def isArrayBufferView(x: Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isArrayBufferView")(x.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  object text {
    ...
    object utf16 {
      ...
      inline def encode(str: String, output: js.typedarray.Uint8Array): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(str.asInstanceOf[js.Any], output.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
      inline def encode(str: String, output: js.typedarray.Uint8Array, offset: Double): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(str.asInstanceOf[js.Any], output.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
      inline def encode(str: String, output: Unit, offset: Double): js.typedarray.Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("encode")(str.asInstanceOf[js.Any], output.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[js.typedarray.Uint8Array]
    }
    ...
    object utf8 {
      ...
      inline def decode(bytes: js.typedarray.Uint8Array): Utf8 = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(bytes.asInstanceOf[js.Any]).asInstanceOf[Utf8]
  ...
  object ArrayBufferView {
    ...
    inline def apply(buffer: js.typedarray.ArrayBuffer, byteLength: Double): ArrayBufferView = {
