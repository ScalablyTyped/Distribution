...
import typings.nodeForge.Anon3des
...
object toPkcs12Asn1 extends js.Object {
  ...
  def apply(key: PrivateKey, cert: js.Array[Certificate], password: String, options: Anon3des): Asn1 = js.native
  def apply(key: PrivateKey, cert: js.Array[Certificate], password: Null, options: Anon3des): Asn1 = js.native
  ...
  def apply(key: PrivateKey, cert: Certificate, password: String, options: Anon3des): Asn1 = js.native
  def apply(key: PrivateKey, cert: Certificate, password: Null, options: Anon3des): Asn1 = js.native
}
