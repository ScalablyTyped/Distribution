...
@scala.inline
def createSessionCache(cache: scala.Unit, capacity: scala.Double): typings.nodeForge.mod.tls.SessionCache = (typings.nodeForge.mod.tls.^.asInstanceOf[js.Dynamic].applyDynamic("createSessionCache")(cache.asInstanceOf[js.Any], capacity.asInstanceOf[js.Any])).asInstanceOf[typings.nodeForge.mod.tls.SessionCache]
@scala.inline
