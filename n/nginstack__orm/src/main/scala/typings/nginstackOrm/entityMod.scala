...
object entityMod {
  ...
  type ConfigDef = typings.nginstackEngine.configDefMod.^
  
  type DataSet = typings.nginstackEngine.dataSetMod.^
  
  type Emitter = typings.nginstackEngine.emitterMod.^
  ...
  type EntityOptions = typings.nginstackOrm.entityOptionsMod.^
  ...
  type FieldPermissions = typings.nginstackEngine.fieldPermissionsMod.^
