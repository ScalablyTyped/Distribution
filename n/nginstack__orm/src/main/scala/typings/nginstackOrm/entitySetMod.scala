...
object entitySetMod {
  ...
  trait EntitySet extends StObject {
    ...
    def findByKey(key: Double): typings.nginstackOrm.entityMod.^ = js.native
    
    def forEach(callback: js.Function1[/* arg0 */ typings.nginstackOrm.entityMod.^, Any]): Unit = js.native
    def forEach(callback: js.Function1[/* arg0 */ typings.nginstackOrm.entityMod.^, Any], opt_context: Any): Unit = js.native
    ...
    def newEntity(data: Double): typings.nginstackOrm.entityMod.^ = js.native
    def newEntity(data: Record[Any, Any]): typings.nginstackOrm.entityMod.^ = js.native
    
    def persist(): Double = js.native
    
    def remove(entity: Double): Unit = js.native
    def remove(entity: typings.nginstackOrm.entityMod.^): Unit = js.native
    
    def removeAll(): Unit = js.native
    
    def some(callback: js.Function1[/* arg0 */ typings.nginstackOrm.entityMod.^, Boolean]): Boolean = js.native
    def some(callback: js.Function1[/* arg0 */ typings.nginstackOrm.entityMod.^, Boolean], opt_context: Any): Boolean = js.native
  ...
  type EntitySetOptions = typings.nginstackOrm.entitySetOptionsMod.^
  
  type Field = typings.nginstackEngine.fieldMod.^
  
  type ModelDef = typings.nginstackEngine.modelDefMod.^
}
