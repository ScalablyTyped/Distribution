...
class ObservableCollection[T] protected () extends js.Object {
  ...
  def delete(criteriaOrID: java.lang.String): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
  def delete(criteriaOrID: java.lang.String, callback: js.Function1[/* _result */ DeleteAnswer, _]): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
  /**
    * same thing as .remove();
    */
  def delete(criteriaOrID: js.Any): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
  def delete(criteriaOrID: js.Any, callback: js.Function1[/* _result */ DeleteAnswer, _]): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
  def delete(criteriaOrID: scala.Double): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
  def delete(criteriaOrID: scala.Double, callback: js.Function1[/* _result */ DeleteAnswer, _]): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
  ...
  def findAll(tableRules: RawRules): bluebirdLib.bluebirdMod.^[js.Array[T]] = js.native
  def findAll(tableRules: RawRules, callback: js.Function1[/* _results */ js.Array[T], _]): bluebirdLib.bluebirdMod.^[js.Array[T]] = js.native
  ...
  def remove(criteriaOrID: java.lang.String): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
  def remove(criteriaOrID: java.lang.String, callback: js.Function1[/* _result */ DeleteAnswer, _]): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
  def remove(criteriaOrID: js.Any): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
  def remove(criteriaOrID: js.Any, callback: js.Function1[/* _result */ DeleteAnswer, _]): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
  def remove(criteriaOrID: scala.Double): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
  def remove(criteriaOrID: scala.Double, callback: js.Function1[/* _result */ DeleteAnswer, _]): bluebirdLib.bluebirdMod.^[DeleteAnswer] = js.native
