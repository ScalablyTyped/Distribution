...
open class DeleteQuery[T] protected ()
  ...
  def execute(criteriaOrID: String, callback: js.Function1[/* _result */ DeleteAnswer, Any]): typings.bluebird.mod.^[DeleteAnswer] = js.native
  def execute(criteriaOrID: Double): typings.bluebird.mod.^[DeleteAnswer] = js.native
  def execute(criteriaOrID: Double, callback: js.Function1[/* _result */ DeleteAnswer, Any]): typings.bluebird.mod.^[DeleteAnswer] = js.native
}
