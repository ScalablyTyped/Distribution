...
package object mod {
  ...
  @scala.inline
  def observable[T](obj: T): T with typings.nodeMysqlWrapper.mod.ObservableObject = typings.nodeMysqlWrapper.mod.^.asInstanceOf[js.Dynamic].applyDynamic("observable")(obj.asInstanceOf[js.Any]).asInstanceOf[T with typings.nodeMysqlWrapper.mod.ObservableObject]
