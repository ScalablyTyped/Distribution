...
inline def EQUAL_TO_PROPERTY_SYMBOL: java.lang.String = typings.nodeMysqlWrapper.mod.^.asInstanceOf[js.Dynamic].selectDynamic("EQUAL_TO_PROPERTY_SYMBOL").asInstanceOf[java.lang.String]
inline def EQUAL_TO_PROPERTY_SYMBOL_=(x: java.lang.String): scala.Unit = typings.nodeMysqlWrapper.mod.^.asInstanceOf[js.Dynamic].updateDynamic("EQUAL_TO_PROPERTY_SYMBOL")(x.asInstanceOf[js.Any])

inline def TABLE_RULES_PROPERTY: java.lang.String = typings.nodeMysqlWrapper.mod.^.asInstanceOf[js.Dynamic].selectDynamic("TABLE_RULES_PROPERTY").asInstanceOf[java.lang.String]
inline def TABLE_RULES_PROPERTY_=(x: java.lang.String): scala.Unit = typings.nodeMysqlWrapper.mod.^.asInstanceOf[js.Dynamic].updateDynamic("TABLE_RULES_PROPERTY")(x.asInstanceOf[js.Any])
...
inline def observable[T](obj: T): T & typings.nodeMysqlWrapper.mod.ObservableObject = typings.nodeMysqlWrapper.mod.^.asInstanceOf[js.Dynamic].applyDynamic("observable")(obj.asInstanceOf[js.Any]).asInstanceOf[T & typings.nodeMysqlWrapper.mod.ObservableObject]
