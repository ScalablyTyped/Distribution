...
class Connection protected () extends EventEmitter {
  ...
  def this(connection: typings.mysql.mysqlMod.Connection) = this()
  def this(connection: ConnectionConfig) = this()
  /**
    * The real database connection socket.
    */
  var connection: typings.mysql.mysqlMod.Connection = js.native
  /**
  ...
  /**
    ...
    * @return {nothing}
    */
  def attach(connection: typings.mysql.mysqlMod.Connection): Unit = js.native
  /**
  ...
  def create(connection: typings.mysql.mysqlMod.Connection): Unit = js.native
