...
class ObservableCollection[T] protected () extends js.Object {
  ...
  def delete(criteriaOrID: String): ^[DeleteAnswer] = js.native
  def delete(criteriaOrID: String, callback: js.Function1[/* _result */ DeleteAnswer, _]): ^[DeleteAnswer] = js.native
  /**
    * same thing as .remove();
    */
  def delete(criteriaOrID: js.Any): ^[DeleteAnswer] = js.native
  def delete(criteriaOrID: js.Any, callback: js.Function1[/* _result */ DeleteAnswer, _]): ^[DeleteAnswer] = js.native
  def delete(criteriaOrID: Double): ^[DeleteAnswer] = js.native
  def delete(criteriaOrID: Double, callback: js.Function1[/* _result */ DeleteAnswer, _]): ^[DeleteAnswer] = js.native
  def find(): ^[js.Array[T]] = js.native
  ...
  def findOne(criteriaRawJsObject: js.Any): ^[T] = js.native
  def findOne(criteriaRawJsObject: js.Any, callback: js.Function1[/* _result */ T, _]): ^[T] = js.native
  /**
    * .insert() and .update() do the same thing:  .save();
    */
  def insert(criteriaRawJsObject: js.Any): ^[T | _] = js.native
  def insert(criteriaRawJsObject: js.Any, callback: js.Function1[/* _result */ js.Any, _]): ^[T | _] = js.native
  def onCollectionChanged(callback: js.Function1[/* eventArgs */ CollectionChangedEventArgs[T], Unit]): Unit = js.native
  def remove(criteriaOrID: String): ^[DeleteAnswer] = js.native
  def remove(criteriaOrID: String, callback: js.Function1[/* _result */ DeleteAnswer, _]): ^[DeleteAnswer] = js.native
  def remove(criteriaOrID: js.Any): ^[DeleteAnswer] = js.native
  def remove(criteriaOrID: js.Any, callback: js.Function1[/* _result */ DeleteAnswer, _]): ^[DeleteAnswer] = js.native
  def remove(criteriaOrID: Double): ^[DeleteAnswer] = js.native
  def remove(criteriaOrID: Double, callback: js.Function1[/* _result */ DeleteAnswer, _]): ^[DeleteAnswer] = js.native
  def save(criteriaRawJsObject: js.Any): ^[T | _] = js.native
  def save(criteriaRawJsObject: js.Any, callback: js.Function1[/* _result */ js.Any, _]): ^[T | _] = js.native
  def startListeningToDatabase(): Unit = js.native
  def update(criteriaRawJsObject: js.Any): ^[T | _] = js.native
  def update(criteriaRawJsObject: js.Any, callback: js.Function1[/* _result */ js.Any, _]): ^[T | _] = js.native
}
