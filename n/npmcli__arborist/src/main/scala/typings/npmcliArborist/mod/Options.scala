...
/* Inlined parent pacote.pacote.Options */
/* Inlined parent std.Partial<std.Pick<cacache.cacache.get.Options, 'memoize'>> */
trait Options
  extends StObject
  ...
  var lockfileVersion: js.UndefOr[Double | Null] = js.undefined
  ...
  var replaceRegistryHost: js.UndefOr[String] = js.undefined
...
object Options {
  ...
  implicit open class MutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
    ...
    inline def setLockfileVersionUndefined: Self = StObject.set(x, "lockfileVersion", js.undefined)
    ...
    inline def setReplaceRegistryHost(value: String): Self = StObject.set(x, "replaceRegistryHost", value.asInstanceOf[js.Any])
