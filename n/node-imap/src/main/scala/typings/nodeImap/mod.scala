...
import typings.nodeImap.anon.Other
import typings.nodeImap.nodeImapStrings.attributes
import typings.nodeImap.nodeImapStrings.body
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.nodeImap.nodeImapStrings.ARRIVAL
    - typings.nodeImap.nodeImapStrings.`-ARRIVAL`
    - typings.nodeImap.nodeImapStrings.CC
    - typings.nodeImap.nodeImapStrings.`-CC`
    - typings.nodeImap.nodeImapStrings.DATE
    - typings.nodeImap.nodeImapStrings.`-DATE`
    - typings.nodeImap.nodeImapStrings.FROM
    - typings.nodeImap.nodeImapStrings.`-FROM`
    - typings.nodeImap.nodeImapStrings.SIZE
    - typings.nodeImap.nodeImapStrings.`-SIZE`
    - typings.nodeImap.nodeImapStrings.SUBJECT
    - typings.nodeImap.nodeImapStrings.`-SUBJECT`
    - typings.nodeImap.nodeImapStrings.TO
    - typings.nodeImap.nodeImapStrings.`-TO`
  */
  trait SortCriteria extends StObject
  object SortCriteria {
    
    inline def `-ARRIVAL`: typings.nodeImap.nodeImapStrings.`-ARRIVAL` = "-ARRIVAL".asInstanceOf[typings.nodeImap.nodeImapStrings.`-ARRIVAL`]
    
    inline def `-CC`: typings.nodeImap.nodeImapStrings.`-CC` = "-CC".asInstanceOf[typings.nodeImap.nodeImapStrings.`-CC`]
    
    inline def `-DATE`: typings.nodeImap.nodeImapStrings.`-DATE` = "-DATE".asInstanceOf[typings.nodeImap.nodeImapStrings.`-DATE`]
    
    inline def `-FROM`: typings.nodeImap.nodeImapStrings.`-FROM` = "-FROM".asInstanceOf[typings.nodeImap.nodeImapStrings.`-FROM`]
    
    inline def `-SIZE`: typings.nodeImap.nodeImapStrings.`-SIZE` = "-SIZE".asInstanceOf[typings.nodeImap.nodeImapStrings.`-SIZE`]
    
    inline def `-SUBJECT`: typings.nodeImap.nodeImapStrings.`-SUBJECT` = "-SUBJECT".asInstanceOf[typings.nodeImap.nodeImapStrings.`-SUBJECT`]
    
    inline def `-TO`: typings.nodeImap.nodeImapStrings.`-TO` = "-TO".asInstanceOf[typings.nodeImap.nodeImapStrings.`-TO`]
