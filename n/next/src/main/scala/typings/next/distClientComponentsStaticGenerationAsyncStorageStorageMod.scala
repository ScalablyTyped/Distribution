...
object distClientComponentsStaticGenerationAsyncStorageStorageMod {
  
  @JSImport("next/dist/client/components/static-generation-async-storage/storage", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("next/dist/client/components/static-generation-async-storage/storage", "staticGenerationAsyncStorage")
  @js.native
