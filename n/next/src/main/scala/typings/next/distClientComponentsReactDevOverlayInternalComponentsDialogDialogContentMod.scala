...
object distClientComponentsReactDevOverlayInternalComponentsDialogDialogContentMod {
  
  @JSImport("next/dist/client/components/react-dev-overlay/internal/components/Dialog/DialogContent", "DialogContent")
  @js.native
