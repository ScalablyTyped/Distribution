...
object distClientComponentsReactDevOverlayInternalComponentsDialogDialogHeaderMod {
  
  @JSImport("next/dist/client/components/react-dev-overlay/internal/components/Dialog/DialogHeader", "DialogHeader")
  @js.native
