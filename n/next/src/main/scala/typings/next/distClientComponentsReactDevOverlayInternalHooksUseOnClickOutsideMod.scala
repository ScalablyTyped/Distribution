...
object distClientComponentsReactDevOverlayInternalHooksUseOnClickOutsideMod {
  
  @JSImport("next/dist/client/components/react-dev-overlay/internal/hooks/use-on-click-outside", JSImport.Namespace)
  @js.native
