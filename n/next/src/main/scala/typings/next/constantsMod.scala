...
import typings.next.nextStrings.`phase-development-server`
import typings.next.nextStrings.`phase-export`
import typings.next.nextStrings.`phase-production-build`
...
@JSImport("next/constants", JSImport.Namespace)
@js.native
