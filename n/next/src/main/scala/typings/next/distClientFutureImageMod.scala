...
object distClientFutureImageMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.next.distClientFutureImageMod.StaticRequire
    - typings.next.distClientFutureImageMod.StaticImageData
  */
  trait StaticImport extends StObject
  object StaticImport {
    
    inline def StaticImageData(height: Double, src: String, width: Double): typings.next.distClientFutureImageMod.StaticImageData = {
      val __obj = js.Dynamic.literal(height = height.asInstanceOf[js.Any], src = src.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.next.distClientFutureImageMod.StaticImageData]
    }
    
    inline def StaticRequire(default: StaticImageData): typings.next.distClientFutureImageMod.StaticRequire = {
      val __obj = js.Dynamic.literal(default = default.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.next.distClientFutureImageMod.StaticRequire]
    }
  }
