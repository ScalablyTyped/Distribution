...
object distClientComponentsReactDevOverlayInternalComponentsDialogDialogMod {
  
  @JSImport("next/dist/client/components/react-dev-overlay/internal/components/Dialog/Dialog", "Dialog")
  @js.native
