...
object distBuildWebpackPluginsWellknownErrorsPluginWebpackModuleErrorMod {
  ...
  inline def getModuleBuildError(compiler: Compiler, compilation: Compilation, input: Any): js.Promise[SimpleWebpackError | `false`] = (^.asInstanceOf[js.Dynamic].applyDynamic("getModuleBuildError")(compiler.asInstanceOf[js.Any], compilation.asInstanceOf[js.Any], input.asInstanceOf[js.Any])).asInstanceOf[js.Promise[SimpleWebpackError | `false`]]
}
