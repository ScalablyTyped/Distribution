...
package object distNextDashServerLibDynamicMod {
  import org.scalablytyped.runtime.StringDictionary
  import typings.next.Anon_Default
  import typings.next.Anon_HasErrorIsLoadingPastDelay
  import typings.next.Anon_Loaded
  import typings.next.Anon_Loader
