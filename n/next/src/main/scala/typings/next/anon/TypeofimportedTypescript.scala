...
import typings.next.nextStrings.dts
import typings.next.nextStrings.js_
import typings.next.nextStrings.quit
...
@js.native
trait TypeofimportedTypescript extends StObject {
  ...
  def convertCompilerOptionsFromJson(jsonOptions: Any, basePath: String): typings.typescript.anon.Errors = js.native
  def convertCompilerOptionsFromJson(jsonOptions: Any, basePath: String, configFileName: String): typings.typescript.anon.Errors = js.native
  
  def convertToObject(sourceFile: JsonSourceFile, errors: Push[Diagnostic]): Any = js.native
  
  def convertTypeAcquisitionFromJson(jsonOptions: Any, basePath: String): typings.typescript.anon.Options = js.native
  def convertTypeAcquisitionFromJson(jsonOptions: Any, basePath: String, configFileName: String): typings.typescript.anon.Options = js.native
  ...
  def getImpliedNodeFormatForFile(
    fileName: typings.typescript.mod.Path,
  ...
  def getParsedCommandLineOfConfigFile(
    ...
    optionsToExtend: Unit,
    host: ParseConfigFileHost,
    extendedConfigCache: typings.typescript.mod.Map[ExtendedConfigCacheEntry]
  ): js.UndefOr[ParsedCommandLine] = js.native
  def getParsedCommandLineOfConfigFile(
    configFileName: String,
    optionsToExtend: Unit,
  ...
  def parseConfigFileTextToJson(fileName: String, jsonText: String): typings.typescript.anon.Config = js.native
  ...
  def parseJsonConfigFileContent(
    ...
    extraFileExtensions: js.UndefOr[js.Array[FileExtensionInfo]],
    extendedConfigCache: js.UndefOr[typings.typescript.mod.Map[ExtendedConfigCacheEntry]],
  ...
  def readConfigFile(fileName: String, readFile: js.Function1[/* path */ String, js.UndefOr[String]]): typings.typescript.anon.Config = js.native
