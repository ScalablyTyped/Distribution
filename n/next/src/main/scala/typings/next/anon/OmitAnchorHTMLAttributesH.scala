...
import typings.next.nextStrings.`additions removals`
import typings.next.nextStrings.`additions text`
import typings.next.nextStrings.`inline`
import typings.next.nextStrings.`removals additions`
import typings.next.nextStrings.`removals text`
import typings.next.nextStrings.`text additions`
import typings.next.nextStrings.`text removals`
import typings.next.nextStrings.additions
import typings.next.nextStrings.all
import typings.next.nextStrings.ascending
import typings.next.nextStrings.assertive
import typings.next.nextStrings.both
import typings.next.nextStrings.copy
import typings.next.nextStrings.date
import typings.next.nextStrings.decimal
import typings.next.nextStrings.descending
import typings.next.nextStrings.dialog
import typings.next.nextStrings.email
import typings.next.nextStrings.execute
import typings.next.nextStrings.grammar
import typings.next.nextStrings.grid
import typings.next.nextStrings.horizontal
import typings.next.nextStrings.inherit
import typings.next.nextStrings.link
import typings.next.nextStrings.list
import typings.next.nextStrings.listbox
import typings.next.nextStrings.location
import typings.next.nextStrings.menu
import typings.next.nextStrings.mixed
import typings.next.nextStrings.move
import typings.next.nextStrings.no
import typings.next.nextStrings.none
import typings.next.nextStrings.numeric
import typings.next.nextStrings.off
import typings.next.nextStrings.on
import typings.next.nextStrings.other
import typings.next.nextStrings.page_
import typings.next.nextStrings.polite
import typings.next.nextStrings.popup
import typings.next.nextStrings.removals
import typings.next.nextStrings.search
import typings.next.nextStrings.spelling
import typings.next.nextStrings.step
import typings.next.nextStrings.tel
import typings.next.nextStrings.text
import typings.next.nextStrings.time
import typings.next.nextStrings.tree
import typings.next.nextStrings.url
import typings.next.nextStrings.vertical
import typings.next.nextStrings.yes
...
object OmitAnchorHTMLAttributesH {
  ...
  inline def apply(href: typings.next.distClientLinkMod.Url): OmitAnchorHTMLAttributesH = {
  ...
  extension [Self <: OmitAnchorHTMLAttributesH](x: Self) {
    ...
    inline def setAs(value: typings.next.distClientLinkMod.Url): Self = StObject.set(x, "as", value.asInstanceOf[js.Any])
    ...
    inline def setHref(value: typings.next.distClientLinkMod.Url): Self = StObject.set(x, "href", value.asInstanceOf[js.Any])
