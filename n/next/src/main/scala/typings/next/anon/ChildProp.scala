...
import typings.next.distClientComponentsLayoutRouterDotclientMod.ErrorComponent
...
object ChildProp {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(childProp = childProp.asInstanceOf[js.Any], error = error.asInstanceOf[js.Any], parallelRouterKey = parallelRouterKey.asInstanceOf[js.Any], rootLayoutIncluded = rootLayoutIncluded.asInstanceOf[js.Any], segmentPath = segmentPath.asInstanceOf[js.Any])
