...
object distClientComponentsReactDevOverlayInternalComponentsDialogDialogBodyMod {
  
  @JSImport("next/dist/client/components/react-dev-overlay/internal/components/Dialog/DialogBody", "DialogBody")
  @js.native
