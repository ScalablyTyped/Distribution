...
object distEsmBuildBabelLoaderTypesMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify webpack.LoaderContext<{}> * / any */ trait NextJsLoaderContext extends StObject {
    ...
    var currentTraceSpan: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Span */ Any
  ...
  object NextJsLoaderContext {
    ...
    inline def apply(
      currentTraceSpan: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Span */ Any,
      target: String
    ): NextJsLoaderContext = {
