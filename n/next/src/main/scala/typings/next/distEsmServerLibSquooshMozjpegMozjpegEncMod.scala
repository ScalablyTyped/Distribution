...
object distEsmServerLibSquooshMozjpegMozjpegEncMod {
  
  @JSImport("next/dist/esm/server/lib/squoosh/mozjpeg/mozjpeg_enc", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("next/dist/esm/server/lib/squoosh/mozjpeg/mozjpeg_enc", JSImport.Default)
  @js.native
