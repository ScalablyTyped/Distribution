...
object distBuildWebpackLoadersNoopLoaderMod extends Shortcut {
  
  @JSImport("next/dist/build/webpack/loaders/noop-loader", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distBuildWebpackLoadersNoopLoaderMod.foo` */
