...
object distBuildSwcMod {
  
  @JSImport("next/dist/build/swc", JSImport.Namespace)
  @js.native
  ...
  object lockfilePatchPromise {
    ...
    @JSImport("next/dist/build/swc", "lockfilePatchPromise")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("next/dist/build/swc", "lockfilePatchPromise.cur")
    @js.native
