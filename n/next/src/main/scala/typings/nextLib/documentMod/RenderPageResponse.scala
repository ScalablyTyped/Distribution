...
trait RenderPageResponse extends js.Object {
  var head: js.UndefOr[reactLib.reactMod.ReactNode] = js.undefined
  var html: js.UndefOr[java.lang.String] = js.undefined
}

object RenderPageResponse {
  @scala.inline
  def apply(head: reactLib.reactMod.ReactNode = null, html: java.lang.String = null): RenderPageResponse = {
