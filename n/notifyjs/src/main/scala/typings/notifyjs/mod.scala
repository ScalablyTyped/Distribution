...
object mod {
  ...
  object Notify {
    ...
    extension [Self <: Notify](x: Self) {
      ...
      inline def setOnClickNotification(value: () => Unit): Self = StObject.set(x, "onClickNotification", js.Any.fromFunction0(value))
      
      inline def setOnCloseNotification(value: () => Unit): Self = StObject.set(x, "onCloseNotification", js.Any.fromFunction0(value))
      
      inline def setOnErrorNotification(value: () => Unit): Self = StObject.set(x, "onErrorNotification", js.Any.fromFunction0(value))
      
      inline def setOnShowNotification(value: Event => Unit): Self = StObject.set(x, "onShowNotification", js.Any.fromFunction1(value))
