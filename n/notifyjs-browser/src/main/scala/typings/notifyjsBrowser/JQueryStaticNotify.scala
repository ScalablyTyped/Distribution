...
trait JQueryStaticNotify extends StObject {
  ...
  def apply(element: js.Any, notificationdata: Unit, options: NotificationOptions): JQueryStatic = js.native
  def apply(element: Unit, notificationdata: js.Any): JQueryStatic = js.native
  def apply(element: Unit, notificationdata: js.Any, options: NotificationOptions): JQueryStatic = js.native
