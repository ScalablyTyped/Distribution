...
object mod {
  ...
  object Immutable {
    ...
    object Collection {
      ...
      /**
        ...
        */
      inline def apply[I /* <: typings.immutable.mod.Collection[Any, Any] */](collection: I): I = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[I]
      ...
      inline def apply[K, V](): typings.immutable.mod.Collection[K, V] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.immutable.mod.Collection[K, V]]
      ...
      /**
        ...
        * calling `toKeyedSeq`.
        */
      inline def Indexed[T](): typings.immutable.mod.Collection.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")().asInstanceOf[typings.immutable.mod.Collection.Indexed[T]]
      /**
        * Indexed Collections have incrementing numeric keys. They exhibit
        * slightly different behavior than `Collection.Keyed` for some methods in order
        * to better mirror the behavior of JavaScript's `Array`, and add methods
        ...
        * calling `toKeyedSeq`.
        */
      inline def Indexed[T](collection: js.Iterable[T]): typings.immutable.mod.Collection.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Collection.Indexed[T]]
      /**
        * Indexed Collections have incrementing numeric keys. They exhibit
        * slightly different behavior than `Collection.Keyed` for some methods in order
        * to better mirror the behavior of JavaScript's `Array`, and add methods
        ...
        * calling `toKeyedSeq`.
        */
      inline def Indexed[T](collection: ArrayLike[T]): typings.immutable.mod.Collection.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Collection.Indexed[T]]
      ...
      /**
        ...
        * Keyed Collections.
        */
      inline def Keyed[V](obj: StringDictionary[V]): typings.immutable.mod.Collection.Keyed[String, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Collection.Keyed[String, V]]
      /**
      ...
      /**
        ...
        * Keyed Collections.
        */
      inline def Keyed[K, V](): typings.immutable.mod.Collection.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")().asInstanceOf[typings.immutable.mod.Collection.Keyed[K, V]]
      /**
        * Keyed Collections have discrete keys tied to each value.
        *
        * When iterating `Collection.Keyed`, each iteration will yield a `[K, V]`
        ...
        * Keyed Collections.
        */
      inline def Keyed[K, V](collection: js.Iterable[js.Tuple2[K, V]]): typings.immutable.mod.Collection.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Collection.Keyed[K, V]]
      ...
      /**
        ...
        * ```
        */
      inline def Set[T](): typings.immutable.mod.Collection.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")().asInstanceOf[typings.immutable.mod.Collection.Set[T]]
      /**
        * Set Collections only represent values. They have no associated keys or
        * indices. Duplicate values are possible in the lazy `Seq.Set`s, however
        * the concrete `Set` Collection does not allow duplicate values.
        ...
        * ```
        */
      inline def Set[T](collection: js.Iterable[T]): typings.immutable.mod.Collection.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Collection.Set[T]]
      /**
        * Set Collections only represent values. They have no associated keys or
        * indices. Duplicate values are possible in the lazy `Seq.Set`s, however
        * the concrete `Set` Collection does not allow duplicate values.
        ...
        * ```
        */
      inline def Set[T](collection: ArrayLike[T]): typings.immutable.mod.Collection.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Collection.Set[T]]
    ...
    object List {
      ...
      /**
        ...
        * ```
        */
      inline def of[T](values: T*): typings.immutable.mod.List[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("of")(values.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typings.immutable.mod.List[T]]
    }
    ...
    object Map {
      ...
      inline def apply[V](obj: StringDictionary[V]): typings.immutable.mod.Map[String, V] = ^.asInstanceOf[js.Dynamic].apply(obj.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Map[String, V]]
      /**
      ...
      /**
        ...
        */
      inline def of(keyValues: Any*): typings.immutable.mod.Map[Any, Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("of")(keyValues.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typings.immutable.mod.Map[Any, Any]]
    }
    ...
    object OrderedMap {
      ...
      inline def apply[V](obj: StringDictionary[V]): typings.immutable.mod.OrderedMap[String, V] = ^.asInstanceOf[js.Dynamic].apply(obj.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.OrderedMap[String, V]]
      /**
        ...
        */
      inline def apply[K, V](): typings.immutable.mod.OrderedMap[K, V] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.immutable.mod.OrderedMap[K, V]]
      inline def apply[K, V](collection: js.Iterable[js.Tuple2[K, V]]): typings.immutable.mod.OrderedMap[K, V] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.OrderedMap[K, V]]
    ...
    object OrderedSet {
      ...
      /**
        ...
        * the `new` keyword during construction.
        */
      inline def apply[T](): typings.immutable.mod.OrderedSet[T] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.immutable.mod.OrderedSet[T]]
      inline def apply[T](collection: js.Iterable[T]): typings.immutable.mod.OrderedSet[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.OrderedSet[T]]
      inline def apply[T](collection: ArrayLike[T]): typings.immutable.mod.OrderedSet[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.OrderedSet[T]]
      
      @JSImport("nuclear-js", "Immutable.OrderedSet")
      @js.native
      val ^ : js.Any = js.native
      
      inline def fromKeys(obj: StringDictionary[Any]): typings.immutable.mod.OrderedSet[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromKeys")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.OrderedSet[String]]
      /**
        * `OrderedSet.fromKeys()` creates a new immutable OrderedSet containing
        * the keys from this Collection or JavaScript Object.
        */
      inline def fromKeys[T](iter: Collection[T, Any]): typings.immutable.mod.OrderedSet[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromKeys")(iter.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.OrderedSet[T]]
    ...
    @JSImport("nuclear-js", "Immutable.PairSorting")
    @js.native
    ...
    /**
      ...
      * ```
      */
    inline def Range(): typings.immutable.mod.Seq.Indexed[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("Range")().asInstanceOf[typings.immutable.mod.Seq.Indexed[Double]]
    inline def Range(start: Double): typings.immutable.mod.Seq.Indexed[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("Range")(start.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Indexed[Double]]
    inline def Range(start: Double, end: Double): typings.immutable.mod.Seq.Indexed[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("Range")(start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[typings.immutable.mod.Seq.Indexed[Double]]
    inline def Range(start: Double, end: Double, step: Double): typings.immutable.mod.Seq.Indexed[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("Range")(start.asInstanceOf[js.Any], end.asInstanceOf[js.Any], step.asInstanceOf[js.Any])).asInstanceOf[typings.immutable.mod.Seq.Indexed[Double]]
    inline def Range(start: Double, end: Unit, step: Double): typings.immutable.mod.Seq.Indexed[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("Range")(start.asInstanceOf[js.Any], end.asInstanceOf[js.Any], step.asInstanceOf[js.Any])).asInstanceOf[typings.immutable.mod.Seq.Indexed[Double]]
    inline def Range(start: Unit, end: Double): typings.immutable.mod.Seq.Indexed[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("Range")(start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[typings.immutable.mod.Seq.Indexed[Double]]
    inline def Range(start: Unit, end: Double, step: Double): typings.immutable.mod.Seq.Indexed[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("Range")(start.asInstanceOf[js.Any], end.asInstanceOf[js.Any], step.asInstanceOf[js.Any])).asInstanceOf[typings.immutable.mod.Seq.Indexed[Double]]
    inline def Range(start: Unit, end: Unit, step: Double): typings.immutable.mod.Seq.Indexed[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("Range")(start.asInstanceOf[js.Any], end.asInstanceOf[js.Any], step.asInstanceOf[js.Any])).asInstanceOf[typings.immutable.mod.Seq.Indexed[Double]]
    ...
    object Record {
      ...
      /**
        ...
        * ```
        */
      inline def Factory[TProps /* <: js.Object */](): typings.immutable.mod.Record[TProps] & TProps = ^.asInstanceOf[js.Dynamic].applyDynamic("Factory")().asInstanceOf[typings.immutable.mod.Record[TProps] & TProps]
      /**
        * A Record.Factory is created by the `Record()` function. Record instances
        * are created by passing it some of the accepted values for that Record
        * type:
        ...
        * ```
        */
      inline def Factory[TProps /* <: js.Object */](values: js.Iterable[js.Tuple2[String, Any]]): typings.immutable.mod.Record[TProps] & TProps = ^.asInstanceOf[js.Dynamic].applyDynamic("Factory")(values.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Record[TProps] & TProps]
      /**
        * A Record.Factory is created by the `Record()` function. Record instances
        * are created by passing it some of the accepted values for that Record
        * type:
        ...
        * ```
        */
      inline def Factory[TProps /* <: js.Object */](values: Partial[TProps]): typings.immutable.mod.Record[TProps] & TProps = ^.asInstanceOf[js.Dynamic].applyDynamic("Factory")(values.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Record[TProps] & TProps]
      ...
      /**
        ...
        * ```
        */
      inline def getDescriptiveName(record: typings.immutable.mod.Record[Any]): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getDescriptiveName")(record.asInstanceOf[js.Any]).asInstanceOf[String]
    ...
    /**
      ...
      * ```
      */
    inline def Repeat[T](value: T): typings.immutable.mod.Seq.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Repeat")(value.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Indexed[T]]
    inline def Repeat[T](value: T, times: Double): typings.immutable.mod.Seq.Indexed[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("Repeat")(value.asInstanceOf[js.Any], times.asInstanceOf[js.Any])).asInstanceOf[typings.immutable.mod.Seq.Indexed[T]]
    ...
    object Seq {
      ...
      inline def apply[T](collection: js.Iterable[T]): typings.immutable.mod.Seq.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Indexed[T]]
      inline def apply[T](collection: Indexed[T]): typings.immutable.mod.Seq.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Indexed[T]]
      inline def apply[T](collection: Set[T]): typings.immutable.mod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Set[T]]
      inline def apply[T](collection: ArrayLike[T]): typings.immutable.mod.Seq.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Indexed[T]]
      inline def apply[V](obj: StringDictionary[V]): typings.immutable.mod.Seq.Keyed[String, V] = ^.asInstanceOf[js.Dynamic].apply(obj.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Keyed[String, V]]
      /**
        * Creates a Seq.
        *
        ...
        * `new` keyword during construction.
        */
      inline def apply[S /* <: typings.immutable.mod.Seq[Any, Any] */](seq: S): S = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[S]
      inline def apply[K, V](): typings.immutable.mod.Seq[K, V] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.immutable.mod.Seq[K, V]]
      inline def apply[K, V](collection: Keyed[K, V]): typings.immutable.mod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Keyed[K, V]]
      ...
      object Indexed {
        ...
        /**
          ...
          * not use the `new` keyword during construction.
          */
        inline def apply[T](): typings.immutable.mod.Seq.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.immutable.mod.Seq.Indexed[T]]
        inline def apply[T](collection: js.Iterable[T]): typings.immutable.mod.Seq.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Indexed[T]]
        inline def apply[T](collection: ArrayLike[T]): typings.immutable.mod.Seq.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Indexed[T]]
        ...
        /**
          ...
          */
        inline def of[T](values: T*): typings.immutable.mod.Seq.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("of")(values.asInstanceOf[scala.Seq[js.Any]]*).asInstanceOf[typings.immutable.mod.Seq.Indexed[T]]
      }
      
      /**
        * `Seq` which represents key-value pairs.
        */
      inline def Keyed[V](obj: StringDictionary[V]): typings.immutable.mod.Seq.Keyed[String, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Keyed[String, V]]
      /**
      ...
      /**
        * `Seq` which represents key-value pairs.
        */
      inline def Keyed[K, V](): typings.immutable.mod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")().asInstanceOf[typings.immutable.mod.Seq.Keyed[K, V]]
      /**
        * `Seq` which represents key-value pairs.
        */
      inline def Keyed[K, V](collection: js.Iterable[js.Tuple2[K, V]]): typings.immutable.mod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Keyed[K, V]]
      ...
      object Set {
        ...
        /**
          ...
          * use the `new` keyword during construction.
          */
        inline def apply[T](): typings.immutable.mod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.immutable.mod.Seq.Set[T]]
        inline def apply[T](collection: js.Iterable[T]): typings.immutable.mod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Set[T]]
        inline def apply[T](collection: ArrayLike[T]): typings.immutable.mod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Seq.Set[T]]
        ...
        /**
          ...
          */
        inline def of[T](values: T*): typings.immutable.mod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("of")(values.asInstanceOf[scala.Seq[js.Any]]*).asInstanceOf[typings.immutable.mod.Seq.Set[T]]
      }
    ...
    object Set_ {
      ...
      /**
        ...
        * `new` keyword during construction.
        */
      inline def apply[T](): typings.immutable.mod.Set_[T] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.immutable.mod.Set_[T]]
      inline def apply[T](collection: js.Iterable[T]): typings.immutable.mod.Set_[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Set_[T]]
      inline def apply[T](collection: ArrayLike[T]): typings.immutable.mod.Set_[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Set_[T]]
      
      @JSImport("nuclear-js", "Immutable.Set")
      @js.native
      val ^ : js.Any = js.native
      
      inline def fromKeys(obj: StringDictionary[Any]): typings.immutable.mod.Set_[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromKeys")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Set_[String]]
      /**
        * `Set.fromKeys()` creates a new immutable Set containing the keys from
        * this Collection or JavaScript Object.
        */
      inline def fromKeys[T](iter: Collection[T, Any]): typings.immutable.mod.Set_[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromKeys")(iter.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Set_[T]]
      ...
      /**
        ...
        * ```
        */
      inline def intersect[T](sets: js.Iterable[js.Iterable[T]]): typings.immutable.mod.Set_[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("intersect")(sets.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Set_[T]]
      ...
      /**
        ...
        */
      inline def of[T](values: T*): typings.immutable.mod.Set_[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("of")(values.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typings.immutable.mod.Set_[T]]
      ...
      /**
        ...
        * ```
        */
      inline def union[T](sets: js.Iterable[js.Iterable[T]]): typings.immutable.mod.Set_[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("union")(sets.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Set_[T]]
    }
    ...
    object Stack {
      ...
      /**
        ...
        * `new` keyword during construction.
        */
      inline def apply[T](): typings.immutable.mod.Stack[T] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.immutable.mod.Stack[T]]
      inline def apply[T](collection: js.Iterable[T]): typings.immutable.mod.Stack[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Stack[T]]
      inline def apply[T](collection: ArrayLike[T]): typings.immutable.mod.Stack[T] = ^.asInstanceOf[js.Dynamic].apply(collection.asInstanceOf[js.Any]).asInstanceOf[typings.immutable.mod.Stack[T]]
  ...
  object ReactMixin {
    ...
    inline def apply(componentDidMount: () => Unit, componentWillUnmount: () => Unit, getInitialState: () => Any): ReactMixin = {
    ...
    implicit open class MutableBuilder[Self <: ReactMixin] (val x: Self) extends AnyVal {
      ...
      inline def setGetInitialState(value: () => Any): Self = StObject.set(x, "getInitialState", js.Any.fromFunction0(value))
    }
  }
  ...
  object StoreLike {
    ...
    inline def apply[T](getInitialState: () => T, initialize: () => Unit): StoreLike[T] = {
    ...
    implicit open class MutableBuilder[Self <: StoreLike[?], T] (val x: Self & StoreLike[T]) extends AnyVal {
      ...
      inline def setGetInitialState(value: () => T): Self = StObject.set(x, "getInitialState", js.Any.fromFunction0(value))
