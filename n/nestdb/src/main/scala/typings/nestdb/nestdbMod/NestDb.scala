...
import typings.nestdb.Anon_NewDoc
...
trait NestDb[G] extends EventEmitter {
  ...
  def load(cb: js.Function1[/* err */ Error, Unit]): Unit = js.native
  @JSName("off")
  ...
  def updateIndexes[T /* <: G */](updates: js.Array[Anon_NewDoc[T]]): Unit = js.native
  /**
