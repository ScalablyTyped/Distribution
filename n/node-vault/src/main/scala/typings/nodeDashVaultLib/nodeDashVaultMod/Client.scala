...
trait Client extends js.Object {
  ...
  def delete(path: java.lang.String): js.Promise[_] = js.native
  def delete(path: java.lang.String, requestOptions: Option): js.Promise[_] = js.native
  ...
  def gcpLogin(): js.Promise[_] = js.native
  def gcpLogin(options: Option): js.Promise[_] = js.native
  ...
  def help(path: java.lang.String, requestOptions: Option): js.Promise[_] = js.native
  ...
  def ldapLogin(): js.Promise[_] = js.native
  def ldapLogin(options: Option): js.Promise[_] = js.native
  def leader(): js.Promise[_] = js.native
  def leader(options: Option): js.Promise[_] = js.native
  def list(path: java.lang.String): js.Promise[_] = js.native
  def list(path: java.lang.String, requestOptions: Option): js.Promise[_] = js.native
  ...
  def oktaLogin(): js.Promise[_] = js.native
  def oktaLogin(options: Option): js.Promise[_] = js.native
  def policies(): js.Promise[_] = js.native
  def policies(options: Option): js.Promise[_] = js.native
  def radiusLogin(): js.Promise[_] = js.native
  def radiusLogin(options: Option): js.Promise[_] = js.native
  def read(path: java.lang.String): js.Promise[_] = js.native
  def read(path: java.lang.String, requestOptions: Option): js.Promise[_] = js.native
  ...
  def unwrap(): js.Promise[_] = js.native
  def unwrap(options: Option): js.Promise[_] = js.native
  ...
  def write(path: java.lang.String, data: js.Any): js.Promise[_] = js.native
  def write(path: java.lang.String, data: js.Any, requestOptions: Option): js.Promise[_] = js.native
}
