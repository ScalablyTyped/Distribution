...
/* Inlined @nivo/sankey.@nivo/sankey.Data & @nivo/sankey.@nivo/sankey.SankeyProps */
trait DataSankeyProps extends js.Object {
...
object DataSankeyProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DataSankeyProps]
  }
}
