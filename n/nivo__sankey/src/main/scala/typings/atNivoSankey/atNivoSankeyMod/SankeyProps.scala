...
object SankeyProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableLinkGradient)) __obj.updateDynamic("enableLinkGradient")(enableLinkGradient)
    ...
    if (linkBlendMode != null) __obj.updateDynamic("linkBlendMode")(linkBlendMode)
