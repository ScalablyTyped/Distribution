...
trait NightwatchGlobals extends js.Object {
  /**
    ...
    * @default true
    */
  var abortOnAssertionFailure: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * controls the timeout time for async hooks. Expects the done() callback to be invoked within this time
    * or an error is thrown
    * @default 10000
    */
  var asyncHookTimeout: js.UndefOr[scala.Double] = js.undefined
  /**
    * this will cause waitFor commands on elements to throw an error if multiple
    * elements are found using the given locate strategy and selector
    * @default true
    */
  var throwOnMultipleElementsReturned: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * this will overwrite the default polling interval (currently 500ms) for waitFor commands
    * and expect assertions that use retry
    * @default 300
    */
  var waitForConditionPollInterval: js.UndefOr[scala.Double] = js.undefined
  /**
    * default timeout value in milliseconds for waitFor commands and implicit waitFor value for
    * expect assertions
    * @default 5000
    */
  var waitForConditionTimeout: js.UndefOr[scala.Double] = js.undefined
}
