...
trait WebDriverProtocolDocumentHandling extends js.Object {
  def execute[T](body: java.lang.String): this.type = js.native
  def execute[T](body: java.lang.String, args: js.Array[_]): this.type = js.native
  def execute[T](
    body: java.lang.String,
    args: js.Array[_],
    callback: js.ThisFunction1[/* this */ NightwatchAPI, /* result */ NightwatchCallbackResult[T], scala.Unit]
  ): this.type = js.native
  /**
  ...
  def executeAsync[T](script: java.lang.String): this.type = js.native
  def executeAsync[T](script: java.lang.String, args: js.Array[_]): this.type = js.native
  def executeAsync[T](
