...
trait ClientCommands extends js.Object {
  ...
  /**
    ...
    * @see cookie
    */
  def deleteCookie(cookieName: java.lang.String): this.type = js.native
  def deleteCookie(
  ...
  def getCookie(
    ...
    callback: js.ThisFunction1[/* this */ NightwatchAPI, /* result */ NightwatchCallbackResult[Cookie], scala.Unit]
  ): this.type = js.native
  /**
  ...
  def getTitle(
    callback: js.ThisFunction1[/* this */ NightwatchAPI, /* result */ js.UndefOr[java.lang.String], scala.Unit]
  ): this.type = js.native
  /**
  ...
  def isLogAvailable(
    typeString: java.lang.String,
    callback: js.ThisFunction1[/* this */ NightwatchAPI, /* result */ scala.Boolean, scala.Unit]
  ): this.type = js.native
  /**
  ...
  def pause(ms: scala.Double, callback: js.ThisFunction0[/* this */ NightwatchAPI, scala.Unit]): this.type = js.native
  /**
  ...
  def perform(callback: js.Function1[/* done */ js.Function0[scala.Unit], scala.Unit]): this.type = js.native
  def perform(
    callback: js.Function2[/* client */ NightwatchAPI, /* done */ js.Function0[scala.Unit], scala.Unit]
  ): this.type = js.native
  /**
  ...
  def useCss(callback: js.ThisFunction0[/* this */ NightwatchAPI, scala.Unit]): this.type = js.native
  /**
  ...
  def useXpath(callback: js.ThisFunction0[/* this */ NightwatchAPI, scala.Unit]): this.type = js.native
}
