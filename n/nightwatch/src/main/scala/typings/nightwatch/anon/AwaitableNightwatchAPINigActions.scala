...
/* Inlined nightwatch.nightwatch.Awaitable<nightwatch.nightwatch.NightwatchAPI, nightwatch.nightwatch.NightwatchAssertionsResult<any>> */
@js.native
trait AwaitableNightwatchAPINigActions extends StObject {
  ...
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ NightwatchAssertionsResult[Any], TResult1 | PromiseLike[TResult1]]
