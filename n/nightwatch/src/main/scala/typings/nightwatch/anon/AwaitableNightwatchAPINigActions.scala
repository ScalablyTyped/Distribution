...
/* Inlined nightwatch.nightwatch.Awaitable<nightwatch.nightwatch.NightwatchAPI, nightwatch.nightwatch.NightwatchAssertionsResult<string | number>> */
@js.native
trait AwaitableNightwatchAPINigActions extends StObject {
  ...
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[
      /* value */ NightwatchAssertionsResult[String | Double], 
