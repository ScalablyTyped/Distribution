...
/* Inlined nightwatch.nightwatch.Awaitable<nightwatch.nightwatch.NightwatchAPI, string> */
@js.native
trait AwaitableNightwatchAPIstrAcceptAlert extends StObject {
  ...
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ String, TResult1 | PromiseLike[TResult1]]): PromiseLike[TResult1 | TResult2] = js.native
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ String, TResult1 | PromiseLike[TResult1]],
