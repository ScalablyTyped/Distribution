...
/* Inlined nightwatch.nightwatch.Awaitable<nightwatch.nightwatch.NightwatchAPI, selenium-webdriver.selenium-webdriver.WebElement> */
@js.native
trait AwaitableNightwatchAPIWeb extends StObject {
  ...
  def getShadowRoot(selector: Definition): Awaitable[this.type, this.type | Null] = js.native
  def getShadowRoot(
    selector: Definition,
    callback: js.ThisFunction1[
      /* this */ NightwatchAPI, 
      /* result */ NightwatchCallbackResult[this.type | Null], 
      Unit
    ]
  ): Awaitable[this.type, this.type | Null] = js.native
  def getShadowRoot(selector: By): Awaitable[this.type, this.type | Null] = js.native
  def getShadowRoot(
    selector: By,
    callback: js.ThisFunction1[
      /* this */ NightwatchAPI, 
  ...
  def getShadowRoot(selector: WebElement): Awaitable[this.type, this.type | Null] = js.native
  def getShadowRoot(
    selector: WebElement,
    callback: js.ThisFunction1[
      /* this */ NightwatchAPI, 
  ...
  var getShadowRoot_Original: js.Function2[
    ...
    Awaitable[this.type, this.type | Null]
  ] = js.native
  ...
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ WebElement, TResult1 | PromiseLike[TResult1]]): PromiseLike[TResult1 | TResult2] = js.native
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ WebElement, TResult1 | PromiseLike[TResult1]],
