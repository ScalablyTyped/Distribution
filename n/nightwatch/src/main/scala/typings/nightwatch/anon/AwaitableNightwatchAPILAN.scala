...
/* Inlined nightwatch.nightwatch.Awaitable<nightwatch.nightwatch.NightwatchAPI, 'LANDSCAPE' | 'PORTRAIT'> */
@js.native
trait AwaitableNightwatchAPILAN extends StObject {
  ...
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ LANDSCAPE | PORTRAIT, TResult1 | PromiseLike[TResult1]]): PromiseLike[TResult1 | TResult2] = js.native
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ LANDSCAPE | PORTRAIT, TResult1 | PromiseLike[TResult1]],
