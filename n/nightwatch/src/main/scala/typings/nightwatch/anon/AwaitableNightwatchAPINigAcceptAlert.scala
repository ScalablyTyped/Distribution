...
/* Inlined nightwatch.nightwatch.Awaitable<nightwatch.nightwatch.NightwatchAPI, nightwatch.nightwatch.NightwatchAssertionsResult<string>> */
@js.native
trait AwaitableNightwatchAPINigAcceptAlert extends StObject {
  ...
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ NightwatchAssertionsResult[String], TResult1 | PromiseLike[TResult1]]
