...
import typings.nightwatch.mod.AppiumGeolocation
...
/* Inlined nightwatch.nightwatch.Awaitable<nightwatch.nightwatch.NightwatchAPI, nightwatch.nightwatch.AppiumGeolocation> */
@js.native
trait AwaitableNightwatchAPIApp extends StObject {
  ...
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ AppiumGeolocation, TResult1 | PromiseLike[TResult1]]): PromiseLike[TResult1 | TResult2] = js.native
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ AppiumGeolocation, TResult1 | PromiseLike[TResult1]],
