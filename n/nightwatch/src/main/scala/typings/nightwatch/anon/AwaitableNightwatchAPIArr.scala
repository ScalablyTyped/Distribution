...
/* Inlined nightwatch.nightwatch.Awaitable<nightwatch.nightwatch.NightwatchAPI, std.Array<string>> */
@js.native
trait AwaitableNightwatchAPIArr extends StObject {
  ...
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ js.Array[String], TResult1 | PromiseLike[TResult1]]): PromiseLike[TResult1 | TResult2] = js.native
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ js.Array[String], TResult1 | PromiseLike[TResult1]],
