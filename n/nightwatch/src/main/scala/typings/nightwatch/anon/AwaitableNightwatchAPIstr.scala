...
/* Inlined nightwatch.nightwatch.Awaitable<nightwatch.nightwatch.NightwatchAPI, string | null> */
@js.native
trait AwaitableNightwatchAPIstr extends StObject {
  ...
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ String | Null, TResult1 | PromiseLike[TResult1]]): PromiseLike[TResult1 | TResult2] = js.native
  def `then`[TResult1, TResult2](
    onfulfilled: js.Function1[/* value */ String | Null, TResult1 | PromiseLike[TResult1]],
