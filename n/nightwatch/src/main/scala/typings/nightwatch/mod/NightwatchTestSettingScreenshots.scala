...
object NightwatchTestSettingScreenshots {
  ...
  @scala.inline
  implicit class NightwatchTestSettingScreenshotsOps[Self <: NightwatchTestSettingScreenshots] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setScreenshots(value: NightwatchScreenshotOptions): Self = this.set("screenshots", value.asInstanceOf[js.Any])
  }
}
