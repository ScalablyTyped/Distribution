...
import typings.nivoLegends.typesTypesMod.Datum
import typings.nivoLegends.typesTypesMod.EffectProps
...
object typesMod {
  ...
  object RadarCommonProps {
    ...
    extension [Self <: RadarCommonProps[?], D /* <: Record[String, Any] */](x: Self & RadarCommonProps[D]) {
      ...
      inline def setDotLabelFormatFunction1(value: Double => String): Self = StObject.set(x, "dotLabelFormat", js.Any.fromFunction1(value))
      
      inline def setDotLabelFormatFunction2(value: (Double, Unit) => String): Self = StObject.set(x, "dotLabelFormat", js.Any.fromFunction2(value))
