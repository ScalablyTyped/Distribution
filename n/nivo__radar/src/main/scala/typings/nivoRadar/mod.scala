...
object mod {
  ...
  object svgDefaultProps {
    ...
    @JSImport("@nivo/radar", "svgDefaultProps")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@nivo/radar", "svgDefaultProps.animate")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.blendMode")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.borderColor")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.borderWidth")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.colors")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.curve")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.defs")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.dotBorderColor")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.dotBorderWidth")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.dotColor")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.dotLabel")
    @js.native
    def dotLabel: String = js.native
    
    @JSImport("@nivo/radar", "svgDefaultProps.dotLabelYOffset")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.dotSize")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.enableDotLabel")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.enableDots")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.fill")
    @js.native
    def fill: js.Array[scala.Nothing] = js.native
    
    @JSImport("@nivo/radar", "svgDefaultProps.fillOpacity")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.gridLevels")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.gridShape")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.isInteractive")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.layers")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.legends")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.maxValue")
    @js.native
    ...
    @JSImport("@nivo/radar", "svgDefaultProps.motionConfig")
    @js.native
