...
import typings.atNivoRadar.atNivoRadarMod.CustomDotLabel
import typings.atNivoRadar.atNivoRadarMod.CustomDotSymbol
import typings.atNivoRadar.atNivoRadarMod.CustomFormatter
import typings.atNivoRadar.atNivoRadarMod.GridLabelCustomFunction
import typings.atNivoRadar.atNivoRadarMod.IndexByCustomFunctiono
...
object RadarPropsDimensions {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(data = data, height = height, indexBy = indexBy.asInstanceOf[js.Any], keys = keys, legends = legends, width = width)
