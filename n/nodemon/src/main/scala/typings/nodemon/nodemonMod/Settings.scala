...
import typings.nodemon.Anon_Re
...
object Settings {
  ...
  def apply(
    ...
    if (!js.isUndefined(colours)) __obj.updateDynamic("colours")(colours)
    ...
    if (ignoreRoot != null) __obj.updateDynamic("ignoreRoot")(ignoreRoot)
    if (!js.isUndefined(legacyWatch)) __obj.updateDynamic("legacyWatch")(legacyWatch)
    if (!js.isUndefined(noUpdateNotifier)) __obj.updateDynamic("noUpdateNotifier")(noUpdateNotifier)
