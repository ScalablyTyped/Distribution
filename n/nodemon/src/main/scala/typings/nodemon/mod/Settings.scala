...
object Settings {
  ...
  def apply(
    ...
    ext: String = null,
    ignore: js.Array[String | Re] = null,
    ...
    if (!js.isUndefined(noUpdateNotifier)) __obj.updateDynamic("noUpdateNotifier")(noUpdateNotifier.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(spawn)) __obj.updateDynamic("spawn")(spawn.get.asInstanceOf[js.Any])
