...
object atNivoHeatmapLibComponents extends atNivoHeatmapLibProps {
  ...
  ] = js.constructorOf[atNivoHeatmapLib.atNivoHeatmapMod.HeatMap].asInstanceOf[reactLib.reactMod.ComponentType[
  atNivoHeatmapLib.atNivoHeatmapMod.HeatMapSvgProps with atNivoCoreLib.atNivoCoreMod.Dimensions]]
  @scala.inline
  def HeatMapCanvas: reactLib.reactMod.ComponentType[
    atNivoHeatmapLib.atNivoHeatmapMod.HeatMapCanvasProps with atNivoCoreLib.atNivoCoreMod.Dimensions
  ] = js.constructorOf[atNivoHeatmapLib.atNivoHeatmapMod.HeatMapCanvas].asInstanceOf[reactLib.reactMod.ComponentType[
  atNivoHeatmapLib.atNivoHeatmapMod.HeatMapCanvasProps with atNivoCoreLib.atNivoCoreMod.Dimensions]]
  @scala.inline
