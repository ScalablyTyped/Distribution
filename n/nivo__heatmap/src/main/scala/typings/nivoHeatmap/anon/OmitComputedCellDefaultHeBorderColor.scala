...
trait OmitComputedCellDefaultHeBorderColor extends StObject {
...
object OmitComputedCellDefaultHeBorderColor {
  ...
  inline def apply(
    ...
    x: Double,
    y: Double
  ): OmitComputedCellDefaultHeBorderColor = {
    ...
    __obj.asInstanceOf[OmitComputedCellDefaultHeBorderColor]
  }
  
  extension [Self <: OmitComputedCellDefaultHeBorderColor](x: Self) {
