...
trait OmitComputedCellDefaultHeColor extends StObject {
...
object OmitComputedCellDefaultHeColor {
  ...
  inline def apply(
    ...
    x: Double,
    y: Double
  ): OmitComputedCellDefaultHeColor = {
    ...
    __obj.asInstanceOf[OmitComputedCellDefaultHeColor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitComputedCellDefaultHeColor] (val x: Self) extends AnyVal {
