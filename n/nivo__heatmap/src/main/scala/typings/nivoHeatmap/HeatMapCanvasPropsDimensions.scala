...
import typings.nivoHeatmap.mod.HeatMapDatum
import typings.nivoHeatmap.mod.HeatMapDatumWithColor
import typings.nivoHeatmap.mod.IndexByFunc
import typings.nivoHeatmap.mod.NodeData
import typings.nivoHeatmap.mod.ValueFormatter
