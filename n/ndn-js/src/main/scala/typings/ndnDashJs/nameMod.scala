...
import typings.ndnDashJs.nameMod.CompareResult
...
@JSImport("ndn-js/name", JSImport.Namespace)
@js.native
object nameMod extends js.Object {
  /* Rewritten from type alias, can be one of: 
    - typings.ndnDashJs.ndnDashJsNumbers.`-1`
    - typings.ndnDashJs.ndnDashJsNumbers.`0`
    - typings.ndnDashJs.ndnDashJsNumbers.`1`
  */
  trait CompareResult extends js.Object
