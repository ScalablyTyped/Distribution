...
inline def checkHeader(id: scala.Double): js.Promise[java.lang.String] = typings.nyaapi.mod.pantsu.^.asInstanceOf[js.Dynamic].applyDynamic("checkHeader")(id.asInstanceOf[js.Any]).asInstanceOf[js.Promise[java.lang.String]]

inline def checkUser(id: scala.Double): js.Promise[js.Array[typings.nyaapi.mod.pantsu.User]] = typings.nyaapi.mod.pantsu.^.asInstanceOf[js.Dynamic].applyDynamic("checkUser")(id.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typings.nyaapi.mod.pantsu.User]]]

inline def infoRequest(id: scala.Double): js.Promise[typings.nyaapi.mod.pantsu.Torrent] = typings.nyaapi.mod.pantsu.^.asInstanceOf[js.Dynamic].applyDynamic("infoRequest")(id.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.nyaapi.mod.pantsu.Torrent]]
...
inline def search(term: java.lang.String): js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]] = typings.nyaapi.mod.pantsu.^.asInstanceOf[js.Dynamic].applyDynamic("search")(term.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]]]
inline def search(term: java.lang.String, n: scala.Double): js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]] = (typings.nyaapi.mod.pantsu.^.asInstanceOf[js.Dynamic].applyDynamic("search")(term.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]]]
...
inline def search(term: java.lang.String, n: scala.Unit, opts: typings.nyaapi.mod.pantsu.SearchOptions): js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]] = (typings.nyaapi.mod.pantsu.^.asInstanceOf[js.Dynamic].applyDynamic("search")(term.asInstanceOf[js.Any], n.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]]]
inline def search(term: typings.nyaapi.mod.pantsu.SearchOptionsTerm): js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]] = typings.nyaapi.mod.pantsu.^.asInstanceOf[js.Dynamic].applyDynamic("search")(term.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]]]
...
inline def searchAll(term: java.lang.String): js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]] = typings.nyaapi.mod.pantsu.^.asInstanceOf[js.Dynamic].applyDynamic("searchAll")(term.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]]]
...
inline def searchAll(term: typings.nyaapi.mod.pantsu.SearchOptionsTerm): js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]] = typings.nyaapi.mod.pantsu.^.asInstanceOf[js.Dynamic].applyDynamic("searchAll")(term.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typings.nyaapi.mod.pantsu.Torrent]]]
