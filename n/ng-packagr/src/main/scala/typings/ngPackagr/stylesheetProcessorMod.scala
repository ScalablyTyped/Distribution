...
object stylesheetProcessorMod {
  ...
  object CssUrl extends StObject {
    ...
    sealed trait `inline`
      extends StObject
         with CssUrl
    /* "inline" */ val `inline`: typings.ngPackagr.stylesheetProcessorMod.CssUrl.`inline` & String = js.native
    
    @js.native
    sealed trait none
      extends StObject
         with CssUrl
    /* "none" */ val none: typings.ngPackagr.stylesheetProcessorMod.CssUrl.none & String = js.native
  }
