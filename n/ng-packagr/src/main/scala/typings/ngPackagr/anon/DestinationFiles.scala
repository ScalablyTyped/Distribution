...
import typings.ngPackagr.libNgPackageEntryPointEntryPointMod.NgEntryPoint
...
trait DestinationFiles extends StObject {
  ...
  var destinationFiles: typings.ngPackagr.libNgPackageEntryPointEntryPointMod.DestinationFiles
...
object DestinationFiles {
  ...
  inline def apply(
    destinationFiles: typings.ngPackagr.libNgPackageEntryPointEntryPointMod.DestinationFiles,
