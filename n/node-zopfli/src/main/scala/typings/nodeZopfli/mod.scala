...
object mod {
  ...
  */
  ...
  object Format {
    ...
    inline def deflate: typings.nodeZopfli.nodeZopfliStrings.deflate = "deflate".asInstanceOf[typings.nodeZopfli.nodeZopfliStrings.deflate]
    
    inline def gzip: typings.nodeZopfli.nodeZopfliStrings.gzip = "gzip".asInstanceOf[typings.nodeZopfli.nodeZopfliStrings.gzip]
    
    inline def zlib: typings.nodeZopfli.nodeZopfliStrings.zlib = "zlib".asInstanceOf[typings.nodeZopfli.nodeZopfliStrings.zlib]
  }
