...
object TagsInputParams {
  ...
  def apply(
    ...
    if (!js.isUndefined(addFromAutocompleteOnly)) __obj.updateDynamic("addFromAutocompleteOnly")(addFromAutocompleteOnly.get.asInstanceOf[js.Any])
    if (!js.isUndefined(addOnBlur)) __obj.updateDynamic("addOnBlur")(addOnBlur.get.asInstanceOf[js.Any])
    if (!js.isUndefined(addOnComma)) __obj.updateDynamic("addOnComma")(addOnComma.get.asInstanceOf[js.Any])
    if (!js.isUndefined(addOnEnter)) __obj.updateDynamic("addOnEnter")(addOnEnter.get.asInstanceOf[js.Any])
    if (!js.isUndefined(addOnPaste)) __obj.updateDynamic("addOnPaste")(addOnPaste.get.asInstanceOf[js.Any])
    if (!js.isUndefined(addOnSpace)) __obj.updateDynamic("addOnSpace")(addOnSpace.get.asInstanceOf[js.Any])
    if (!js.isUndefined(allowLeftoverText)) __obj.updateDynamic("allowLeftoverText")(allowLeftoverText.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableEditingLastTag)) __obj.updateDynamic("enableEditingLastTag")(enableEditingLastTag.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(replaceSpacesWithDashes)) __obj.updateDynamic("replaceSpacesWithDashes")(replaceSpacesWithDashes.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useStrings)) __obj.updateDynamic("useStrings")(useStrings.get.asInstanceOf[js.Any])
