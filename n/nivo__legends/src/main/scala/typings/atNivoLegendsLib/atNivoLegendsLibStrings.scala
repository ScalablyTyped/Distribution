...
object atNivoLegendsLibStrings {
  @js.native
  sealed trait bottom
    extends atNivoLegendsLib.atNivoLegendsMod.LegendAnchor
  ...
  sealed trait `bottom-to-top`
    extends atNivoLegendsLib.atNivoLegendsMod.LegendItemDirection
  ...
  @js.native
  sealed trait circle
    extends atNivoLegendsLib.atNivoLegendsMod.LegendSymbolShape
  
  @js.native
  sealed trait column
    extends atNivoLegendsLib.atNivoLegendsMod.LegendDirection
