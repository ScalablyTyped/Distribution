...
object Store {
  @scala.inline
  def apply[/* <: js.Object */ S, /* <: typings.redux.mod.Action[_] */ A](store: typings.redux.mod.Store[S, A]): Store[S, A] = {
    val __obj = js.Dynamic.literal(store = store.asInstanceOf[js.Any])
    __obj.asInstanceOf[Store[S, A]]
  }
  @scala.inline
  implicit class StoreOps[Self <: Store[_, _], /* <: js.Object */ S, /* <: typings.redux.mod.Action[_] */ A] (val x: Self with (Store[S, A])) extends AnyVal {
    @scala.inline
