...
package object mod {
  ...
  */
  type Context = typings.nextReduxWrapper.mod._Context | typings.next.libUtilsMod.NextPageContext | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AppContext */ js.Any)
