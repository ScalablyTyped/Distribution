...
object NextPageContext {
  @scala.inline
  def apply[S, /* <: typings.redux.mod.Action[_] */ A](store: Store[S, A]): NextPageContext[S, A] = {
    val __obj = js.Dynamic.literal(store = store.asInstanceOf[js.Any])
    __obj.asInstanceOf[NextPageContext[S, A]]
  }
  @scala.inline
  implicit class NextPageContextOps[Self <: NextPageContext[_, _], S, /* <: typings.redux.mod.Action[_] */ A] (val x: Self with (NextPageContext[S, A])) extends AnyVal {
    @scala.inline
