...
object CreateMacBuiltinOption {
  ...
  def apply(hideEdit: js.UndefOr[Boolean] = js.undefined, hideWindow: js.UndefOr[Boolean] = js.undefined): CreateMacBuiltinOption = {
    ...
    if (!js.isUndefined(hideEdit)) __obj.updateDynamic("hideEdit")(hideEdit.get.asInstanceOf[js.Any])
    if (!js.isUndefined(hideWindow)) __obj.updateDynamic("hideWindow")(hideWindow.get.asInstanceOf[js.Any])
