...
import typings.nwJs.nwJsStrings.added
import typings.nwJs.nwJsStrings.namechanged
import typings.nwJs.nwJsStrings.orderchanged
import typings.nwJs.nwJsStrings.removed
