package typings.nwJs.mod._Global_.nw

import org.scalablytyped.runtime.TopLevel
import typings.node.eventsMod.EventEmitter
import typings.nwJs.mod._Global_.NWJSHelpers.screen
...
trait Screen extends EventEmitter {
  /**
    ...
    */
  var DesktopCaptureMonitor: typings.nwJs.mod._Global_.NWJSHelpers.DesktopCaptureMonitor = js.native
  /**
