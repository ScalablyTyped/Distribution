...
object CookiesGetDetails {
  ...
  inline def apply(name: String, storeId: String, url: String): CookiesGetDetails = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CookiesGetDetails] (val x: Self) extends AnyVal {
