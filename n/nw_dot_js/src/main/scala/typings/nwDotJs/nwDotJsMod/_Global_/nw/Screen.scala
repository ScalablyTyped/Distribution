...
import typings.nwDotJs.nwDotJsMod._Global_.NWJS_Helpers.screen
...
trait Screen extends EventEmitter {
  /**
    ...
    */
  var DesktopCaptureMonitor: typings.nwDotJs.nwDotJsMod._Global_.NWJS_Helpers.DesktopCaptureMonitor = js.native
  /**
