...
import typings.nwDotJs.NWJS_Helpers.EventEmitter
import typings.nwDotJs.NWJS_Helpers.screen
...
trait Screen extends EventEmitter {
  /**
    ...
    */
  var DesktopCaptureMonitor: typings.nwDotJs.NWJS_Helpers.DesktopCaptureMonitor = js.native
  /**
