...
@js.native
trait IdProject extends js.Object {
...
object IdProject {
  ...
  @scala.inline
  implicit class IdProjectOps[Self <: IdProject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setProject(value: js.Object): Self = this.set("project", value.asInstanceOf[js.Any])
