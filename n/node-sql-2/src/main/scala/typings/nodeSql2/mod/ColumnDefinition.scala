...
object ColumnDefinition {
  @scala.inline
  def apply[/* <: java.lang.String */ Name, Type](dataType: String): ColumnDefinition[Name, Type] = {
    val __obj = js.Dynamic.literal(dataType = dataType.asInstanceOf[js.Any])
    __obj.asInstanceOf[ColumnDefinition[Name, Type]]
  }
  @scala.inline
  implicit class ColumnDefinitionOps[Self <: ColumnDefinition[_, _], /* <: java.lang.String */ Name, Type] (val x: Self with (ColumnDefinition[Name, Type])) extends AnyVal {
    @scala.inline
