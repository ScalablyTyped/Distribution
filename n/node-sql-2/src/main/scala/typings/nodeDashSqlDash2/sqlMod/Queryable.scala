...
trait Queryable[T] extends Executable {
  ...
  def select[N1 /* <: String */, T1, N2 /* <: String */, T2](n1: Column[N1, T1], n2: Column[N2, T2]): Query[typings.nodeDashSqlDash2.nodeDashSqlDash2Strings.Queryable with js.Any] = js.native
