...
object inheritedColorMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.nivoColors.inheritedColorMod.InheritedColorConfigStaticColor
    - typings.nivoColors.inheritedColorMod.InheritedColorConfigCustomFunction[Datum]
    - typings.nivoColors.inheritedColorMod.InheritedColorConfigFromTheme
    - typings.nivoColors.inheritedColorMod.InheritedColorConfigFromContext
  */
