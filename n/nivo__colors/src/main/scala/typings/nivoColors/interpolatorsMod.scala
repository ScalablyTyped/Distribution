...
object interpolatorsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.nivoColors.divergingMod.DivergingColorInterpolatorId
    - typings.nivoColors.sequentialMod.SequentialColorInterpolatorId
    - typings.nivoColors.cyclicalMod.CyclicalColorInterpolatorId
  */
