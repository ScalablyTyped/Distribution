...
object quantizeColorScaleMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.nivoColors.quantizeColorScaleMod.QuantizeColorScaleSchemeConfig
    - typings.nivoColors.quantizeColorScaleMod.QuantizeColorScaleColorsConfig
  */
