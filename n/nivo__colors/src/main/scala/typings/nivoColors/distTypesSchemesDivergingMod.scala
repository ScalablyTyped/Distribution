...
object distTypesSchemesDivergingMod {
  
  object divergingColorInterpolators {
    
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorInterpolators")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorInterpolators.brown_blueGreen")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorInterpolators.pink_yellowGreen")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorInterpolators.purple_orange")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorInterpolators.purpleRed_green")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorInterpolators.red_blue")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorInterpolators.red_grey")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorInterpolators.red_yellow_blue")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorInterpolators.red_yellow_green")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorInterpolators.spectral")
    @js.native
  ...
  @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorSchemeIds")
  @js.native
  ...
  object divergingColorSchemes {
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorSchemes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorSchemes.brown_blueGreen")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorSchemes.pink_yellowGreen")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorSchemes.purple_orange")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorSchemes.purpleRed_green")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorSchemes.red_blue")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorSchemes.red_grey")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorSchemes.red_yellow_blue")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorSchemes.red_yellow_green")
    @js.native
    ...
    @JSImport("@nivo/colors/dist/types/schemes/diverging", "divergingColorSchemes.spectral")
    @js.native
  ...
  /* keyof @nivo/colors.anon.BrownblueGreen */ /* Rewritten from type alias, can be one of: 
    ...
    - typings.nivoColors.nivoColorsStrings.purple_orange
    - typings.nivoColors.nivoColorsStrings.red_blue
    - typings.nivoColors.nivoColorsStrings.red_grey
    - typings.nivoColors.nivoColorsStrings.red_yellow_blue
    - typings.nivoColors.nivoColorsStrings.red_yellow_green
    - typings.nivoColors.nivoColorsStrings.spectral
  */
  trait DivergingColorInterpolatorId
    extends StObject
