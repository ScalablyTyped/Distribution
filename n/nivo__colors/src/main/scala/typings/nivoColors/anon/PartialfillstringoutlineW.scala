...
/* Inlined std.Partial<{  fill :string,   outlineWidth :number,   outlineColor :string,   outlineOpacity :number} & std.Partial<std.Omit<react.react.CSSProperties, 'fill'>>> */
trait PartialfillstringoutlineW extends StObject {
...
object PartialfillstringoutlineW {
  
  inline def apply(): PartialfillstringoutlineW = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialfillstringoutlineW]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialfillstringoutlineW] (val x: Self) extends AnyVal {
