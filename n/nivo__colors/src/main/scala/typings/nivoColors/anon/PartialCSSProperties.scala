...
/* Inlined std.Partial<react.react.CSSProperties> */
trait PartialCSSProperties extends StObject {
...
object PartialCSSProperties {
  
  inline def apply(): PartialCSSProperties = {
