...
/* Inlined std.Partial<{  stroke :string,   strokeWidth :number,   outlineWidth :number,   outlineColor :string,   outlineOpacity :number} & std.Partial<std.Omit<react.react.CSSProperties, 'stroke' | 'strokeWidth'>>> */
trait PartialstrokestringstrokeAccentColor extends StObject {
...
object PartialstrokestringstrokeAccentColor {
  
  inline def apply(): PartialstrokestringstrokeAccentColor = {
