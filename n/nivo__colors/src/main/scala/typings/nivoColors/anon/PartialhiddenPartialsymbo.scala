...
trait PartialhiddenPartialsymbo extends StObject {
  ...
  var title: js.UndefOr[PartialtextPartialPartialText] = js.undefined
}
object PartialhiddenPartialsymbo {
  ...
  extension [Self <: PartialhiddenPartialsymbo](x: Self) {
    ...
    inline def setTitle(value: PartialtextPartialPartialText): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
