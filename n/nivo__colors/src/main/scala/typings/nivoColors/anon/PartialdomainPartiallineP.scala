...
trait PartialdomainPartiallineP extends StObject {
  ...
  var legend: js.UndefOr[PartialtextPartialPartialText] = js.undefined
...
object PartialdomainPartiallineP {
  ...
  extension [Self <: PartialdomainPartiallineP](x: Self) {
    ...
    inline def setLegend(value: PartialtextPartialPartialText): Self = StObject.set(x, "legend", value.asInstanceOf[js.Any])
