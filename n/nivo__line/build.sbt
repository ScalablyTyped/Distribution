...
name := "nivo__line"
version := "0.58.0-4c8aff"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.0.0",
  "org.scalablytyped" %%% "csstype" % "2.6.4-b274af",
  "org.scalablytyped" %%% "nivo__axes" % "0.58.0-b2226e",
  ...
  "org.scalablytyped" %%% "nivo__scales" % "0.58.0-6bbb31",
  "org.scalablytyped" %%% "nivo__tooltip" % "0.58.0-7c8bfc",
