...
name := "nivo__line"
version := "0.59.3-a698b9"
scalaVersion := "2.13.1"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "csstype" % "2.6.6-ffacbb",
  "org.scalablytyped" %%% "nivo__axes" % "0.59.2-28eda1",
  ...
  "org.scalablytyped" %%% "nivo__scales" % "0.59.3-9946a3",
  "org.scalablytyped" %%% "nivo__tooltip" % "0.59.1-326b30",
