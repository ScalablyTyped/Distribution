...
object distTypesTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.nivoAnnotations.distTypesTypesMod.CircleAnnotationSpec[Datum]
    - typings.nivoAnnotations.distTypesTypesMod.DotAnnotationSpec[Datum]
    - typings.nivoAnnotations.distTypesTypesMod.RectAnnotationSpec[Datum]
  */
  trait AnnotationSpec[Datum] extends StObject
  object AnnotationSpec {
    
    inline def CircleAnnotationSpec[Datum](note: Note[Datum], noteX: RelativeOrAbsolutePosition, noteY: RelativeOrAbsolutePosition): typings.nivoAnnotations.distTypesTypesMod.CircleAnnotationSpec[Datum] = {
      ...
      __obj.asInstanceOf[typings.nivoAnnotations.distTypesTypesMod.CircleAnnotationSpec[Datum]]
    }
    ...
    inline def DotAnnotationSpec[Datum](
      ...
      __obj.asInstanceOf[typings.nivoAnnotations.distTypesTypesMod.DotAnnotationSpec[Datum]]
    }
    
    inline def RectAnnotationSpec[Datum](note: Note[Datum], noteX: RelativeOrAbsolutePosition, noteY: RelativeOrAbsolutePosition): typings.nivoAnnotations.distTypesTypesMod.RectAnnotationSpec[Datum] = {
      val __obj = js.Dynamic.literal(note = note.asInstanceOf[js.Any], noteX = noteX.asInstanceOf[js.Any], noteY = noteY.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("rect")
      __obj.asInstanceOf[typings.nivoAnnotations.distTypesTypesMod.RectAnnotationSpec[Datum]]
    }
  }
