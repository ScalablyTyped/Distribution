...
/* Inlined @nivo/annotations.@nivo/annotations.CommonAnnotationProps & {  type :'dot',   size :number | undefined} */
@js.native
...
object DotAnnotationProps {
  ...
  implicit class DotAnnotationPropsOps[Self <: DotAnnotationProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: dot): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
