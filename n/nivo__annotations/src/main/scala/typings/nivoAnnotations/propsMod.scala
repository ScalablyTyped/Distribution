...
object propsMod {
  ...
  object defaultProps {
    ...
    @JSImport("@nivo/annotations/dist/types/props", "defaultProps")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@nivo/annotations/dist/types/props", "defaultProps.animate")
    @js.native
    ...
    @JSImport("@nivo/annotations/dist/types/props", "defaultProps.dotSize")
    @js.native
    ...
    @JSImport("@nivo/annotations/dist/types/props", "defaultProps.motionDamping")
    @js.native
    ...
    @JSImport("@nivo/annotations/dist/types/props", "defaultProps.motionStiffness")
    @js.native
    ...
    @JSImport("@nivo/annotations/dist/types/props", "defaultProps.noteTextOffset")
    @js.native
    ...
    @JSImport("@nivo/annotations/dist/types/props", "defaultProps.noteWidth")
    @js.native
