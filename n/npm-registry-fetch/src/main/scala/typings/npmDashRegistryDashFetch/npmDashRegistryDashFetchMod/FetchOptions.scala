...
object FetchOptions {
  ...
  def apply(
    ...
    if (`force-auth` != null) __obj.updateDynamic("force-auth")(`force-auth`)
    if (forceAuth != null) __obj.updateDynamic("forceAuth")(forceAuth)
    if (!js.isUndefined(gzip)) __obj.updateDynamic("gzip")(gzip)
    if (headers != null) __obj.updateDynamic("headers")(headers)
    if (!js.isUndefined(`ignore-body`)) __obj.updateDynamic("ignore-body")(`ignore-body`)
    if (!js.isUndefined(ignoreBody)) __obj.updateDynamic("ignoreBody")(ignoreBody)
    if (integrity != null) __obj.updateDynamic("integrity")(integrity.asInstanceOf[js.Any])
    if (!js.isUndefined(`is-from-ci`)) __obj.updateDynamic("is-from-ci")(`is-from-ci`)
    if (!js.isUndefined(isFromCI)) __obj.updateDynamic("isFromCI")(isFromCI)
    ...
    if (!js.isUndefined(noproxy)) __obj.updateDynamic("noproxy")(noproxy)
    if (`npm-session` != null) __obj.updateDynamic("npm-session")(`npm-session`)
    if (npmSession != null) __obj.updateDynamic("npmSession")(npmSession)
    if (!js.isUndefined(offline)) __obj.updateDynamic("offline")(offline)
    if (!js.isUndefined(`prefer-offline`)) __obj.updateDynamic("prefer-offline")(`prefer-offline`)
    if (!js.isUndefined(`prefer-online`)) __obj.updateDynamic("prefer-online")(`prefer-online`)
    if (`project-scope` != null) __obj.updateDynamic("project-scope")(`project-scope`)
    if (projectScope != null) __obj.updateDynamic("projectScope")(projectScope)
    if (proxy != null) __obj.updateDynamic("proxy")(proxy)
    if (query != null) __obj.updateDynamic("query")(query.asInstanceOf[js.Any])
    if (refer != null) __obj.updateDynamic("refer")(refer)
