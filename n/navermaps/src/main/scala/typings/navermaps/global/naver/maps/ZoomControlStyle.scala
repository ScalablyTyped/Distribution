...
object ZoomControlStyle extends StObject {
  ...
  /* 1 */ val LARGE: typings.navermaps.naver.maps.ZoomControlStyle.LARGE & Double = js.native
  
  /* 0 */ val SMALL: typings.navermaps.naver.maps.ZoomControlStyle.SMALL & Double = js.native
}
