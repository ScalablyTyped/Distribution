...
class Map protected () extends KVO {
  ...
  def morph(coord: Coord): scala.Unit = js.native
  def morph(coord: CoordLiteral): scala.Unit = js.native
  def morph(coord: CoordLiteral, zoom: scala.Double): scala.Unit = js.native
  def morph(coord: CoordLiteral, zoom: scala.Double, transitionOptions: TransitionOptions): scala.Unit = js.native
  def morph(coord: Coord, zoom: scala.Double): scala.Unit = js.native
  def morph(coord: Coord, zoom: scala.Double, transitionOptions: TransitionOptions): scala.Unit = js.native
  def panBy(offset: Point): scala.Unit = js.native
  def panBy(offset: PointLiteral): scala.Unit = js.native
  def panTo(coord: CoordLiteral, transitionOptions: TransitionOptions): scala.Unit = js.native
  def panTo(coord: Coord, transitionOptions: TransitionOptions): scala.Unit = js.native
  def panToBounds(bounds: BoundsLiteral, transitionOptions: TransitionOptions): scala.Unit = js.native
  def panToBounds(bounds: BoundsLiteral, transitionOptions: TransitionOptions, margin: Margin): scala.Unit = js.native
  def panToBounds(bounds: Bounds, transitionOptions: TransitionOptions): scala.Unit = js.native
  def panToBounds(bounds: Bounds, transitionOptions: TransitionOptions, margin: Margin): scala.Unit = js.native
  ...
  def updateBy(coord: CoordLiteral, zoom: scala.Double): scala.Unit = js.native
  def updateBy(coord: Coord, zoom: scala.Double): scala.Unit = js.native
  def zoomBy(deltaZoom: scala.Double): scala.Unit = js.native
  def zoomBy(deltaZoom: scala.Double, zoomOrigin: Coord): scala.Unit = js.native
  def zoomBy(deltaZoom: scala.Double, zoomOrigin: CoordLiteral): scala.Unit = js.native
  def zoomBy(deltaZoom: scala.Double, zoomOrigin: CoordLiteral, effect: scala.Boolean): scala.Unit = js.native
  def zoomBy(deltaZoom: scala.Double, zoomOrigin: Coord, effect: scala.Boolean): scala.Unit = js.native
}
