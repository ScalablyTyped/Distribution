...
class Reference () extends js.Object {
  ...
  def peel(`type`: nodegitLib.objectMod.ObjectNs.TYPE): js.Promise[nodegitLib.objectMod.Object] = js.native
  def rename(newName: java.lang.String, force: scala.Double, logMessage: java.lang.String): js.Promise[Reference] = js.native
  def resolve(): js.Promise[Reference] = js.native
  def setTarget(id: nodegitLib.oidMod.Oid, logMessage: java.lang.String): js.Promise[Reference] = js.native
  def shorthand(): java.lang.String = js.native
  def symbolicSetTarget(target: java.lang.String, logMessage: java.lang.String): js.Promise[Reference] = js.native
