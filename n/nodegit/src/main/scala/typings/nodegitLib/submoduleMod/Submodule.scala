...
class Submodule () extends js.Object {
  def addFinalize(): stdLib.Promise[scala.Double] = js.native
  def addToIndex(writeIndex: scala.Double): stdLib.Promise[scala.Double] = js.native
  ...
  def init(overwrite: scala.Double): stdLib.Promise[scala.Double] = js.native
  def location(): stdLib.Promise[scala.Double] = js.native
  def name(): java.lang.String = js.native
  def open(): stdLib.Promise[nodegitLib.repositoryMod.Repository] = js.native
  ...
  def repoInit(useGitLink: scala.Double): stdLib.Promise[nodegitLib.repositoryMod.Repository] = js.native
  def sync(): stdLib.Promise[scala.Double] = js.native
  /**
       * Updates a submodule
       *
       *
       */
  def update(init: scala.Double): stdLib.Promise[scala.Double] = js.native
  /**
       * Updates a submodule
       *
       *
       */
  def update(init: scala.Double, options: nodegitLib.submoduleDashUpdateDashOptionsMod.SubmoduleUpdateOptions): stdLib.Promise[scala.Double] = js.native
