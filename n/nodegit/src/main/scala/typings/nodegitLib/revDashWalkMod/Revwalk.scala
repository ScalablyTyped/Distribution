...
class Revwalk () extends js.Object {
  def fastWalk(maxCount: scala.Double): stdLib.Promise[_] = js.native
  def fileHistoryWalk(filePath: java.lang.String, maxCount: scala.Double): stdLib.Promise[js.Array[_]] = js.native
  def getCommits(count: scala.Double): stdLib.Promise[js.Array[nodegitLib.commitMod.Commit]] = js.native
  /**
       * Walk the history grabbing commits until the checkFn called with the current commit returns false.
       */
  def getCommitsUntil(checkFn: js.Function): stdLib.Promise[js.Array[_]] = js.native
  ...
  def next(): stdLib.Promise[nodegitLib.oidMod.Oid] = js.native
