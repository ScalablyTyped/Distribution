...
object Diff extends js.Object {
  ...
  def indexToIndex(
    ...
    oldIndex: typings.nodegit.indexUnderscoreMod.Index,
    newIndex: typings.nodegit.indexUnderscoreMod.Index
  ...
  def indexToWorkdir(repo: typings.nodegit.repositoryMod.Repository, index: typings.nodegit.indexUnderscoreMod.Index): js.Promise[typings.nodegit.diffMod.Diff] = js.native
  def indexToWorkdir(
    repo: typings.nodegit.repositoryMod.Repository,
    index: typings.nodegit.indexUnderscoreMod.Index,
    opts: DiffOptions
  ): js.Promise[typings.nodegit.diffMod.Diff] = js.native
