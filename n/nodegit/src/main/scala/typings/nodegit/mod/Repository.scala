...
object Repository {
  ...
  inline def initExt(repoPath: String): js.Promise[typings.nodegit.repositoryMod.Repository] = ^.asInstanceOf[js.Dynamic].applyDynamic("initExt")(repoPath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.nodegit.repositoryMod.Repository]]
  inline def initExt(repoPath: String, options: RepositoryInitOptions): js.Promise[typings.nodegit.repositoryMod.Repository] = (^.asInstanceOf[js.Dynamic].applyDynamic("initExt")(repoPath.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.nodegit.repositoryMod.Repository]]
  
  inline def open(path: String): js.Promise[typings.nodegit.repositoryMod.Repository] = ^.asInstanceOf[js.Dynamic].applyDynamic("open")(path.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.nodegit.repositoryMod.Repository]]
  
  inline def openBare(barePath: String): js.Promise[typings.nodegit.repositoryMod.Repository] = ^.asInstanceOf[js.Dynamic].applyDynamic("openBare")(barePath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.nodegit.repositoryMod.Repository]]
  
  inline def openExt(path: String): js.Promise[typings.nodegit.repositoryMod.Repository] = ^.asInstanceOf[js.Dynamic].applyDynamic("openExt")(path.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.nodegit.repositoryMod.Repository]]
