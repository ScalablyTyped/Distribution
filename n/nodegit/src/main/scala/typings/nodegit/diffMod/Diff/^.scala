...
object ^ extends js.Object {
  ...
  def indexToWorkdir(repo: Repository, index: js.UndefOr[scala.Nothing], opts: DiffOptions): js.Promise[typings.nodegit.diffMod.Diff] = js.native
  ...
  def treeToIndex(repo: Repository, oldTree: js.UndefOr[scala.Nothing], index: Index): js.Promise[typings.nodegit.diffMod.Diff] = js.native
  def treeToIndex(repo: Repository, oldTree: js.UndefOr[scala.Nothing], index: Index, opts: DiffOptions): js.Promise[typings.nodegit.diffMod.Diff] = js.native
  def treeToIndex(repo: Repository, oldTree: Tree): js.Promise[typings.nodegit.diffMod.Diff] = js.native
  def treeToIndex(repo: Repository, oldTree: Tree, index: js.UndefOr[scala.Nothing], opts: DiffOptions): js.Promise[typings.nodegit.diffMod.Diff] = js.native
  ...
  def treeToTree(repo: Repository, oldTree: js.UndefOr[scala.Nothing], new_tree: Tree): js.Promise[typings.nodegit.diffMod.Diff] = js.native
  def treeToTree(repo: Repository, oldTree: js.UndefOr[scala.Nothing], new_tree: Tree, opts: DiffOptions): js.Promise[typings.nodegit.diffMod.Diff] = js.native
  def treeToTree(repo: Repository, oldTree: Tree): js.Promise[typings.nodegit.diffMod.Diff] = js.native
  def treeToTree(repo: Repository, oldTree: Tree, new_tree: js.UndefOr[scala.Nothing], opts: DiffOptions): js.Promise[typings.nodegit.diffMod.Diff] = js.native
  ...
  def treeToWorkdir(repo: Repository, oldTree: js.UndefOr[scala.Nothing], opts: DiffOptions): js.Promise[typings.nodegit.diffMod.Diff] = js.native
  ...
  def treeToWorkdirWithIndex(repo: Repository, oldTree: js.UndefOr[scala.Nothing], opts: DiffOptions): js.Promise[typings.nodegit.diffMod.Diff] = js.native
