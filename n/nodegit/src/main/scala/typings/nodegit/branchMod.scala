...
object branchMod {
  ...
  object Branch {
    ...
    inline def iteratorNew(repo: Repository, listFlags: Double): js.Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("iteratorNew")(repo.asInstanceOf[js.Any], listFlags.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Any]]
