...
trait NodeContextData extends StObject {
  ...
  def get(key: String, storeName: Unit, cb: js.Function2[/* err */ Error, /* value */ js.Any, Unit]): Unit = js.native
  /**
    * Get multiple values from context
    * @param keys
    * @param storeName - store name when multiple context stores are used
    */
  def get(keys: js.Array[String]): js.Array[js.Any] = js.native
  /**
    * Get multiple values from context asynchronously
    */
  def get(keys: js.Array[String], cb: js.Function2[/* err */ Error, /* value */ js.Array[js.Any], Unit]): Unit = js.native
  def get(keys: js.Array[String], storeName: String): js.Array[js.Any] = js.native
  /**
  ...
  def get(
    ...
    storeName: String,
    cb: js.Function2[/* err */ Error, /* value */ js.Array[js.Any], Unit]
  ): Unit = js.native
  def get(
    keys: js.Array[String],
    storeName: Unit,
  ...
  /**
    ...
    */
  def keys(cb: js.Function2[/* err */ Error, /* value */ js.Array[js.Any], Unit]): Unit = js.native
  ...
  /**
    ...
    */
  def keys(storeName: String, cb: js.Function2[/* err */ Error, /* value */ js.Array[js.Any], Unit]): Unit = js.native
  def keys(storeName: Unit, cb: js.Function2[/* err */ Error, /* value */ js.Array[js.Any], Unit]): Unit = js.native
  ...
  def set(key: String, value: js.Any, storeName: Unit, cb: js.Function1[/* err */ Error, Unit]): Unit = js.native
  /**
    ...
    * @param cb - callback for async calls
    */
  def set(keys: js.Array[String], values: js.Array[js.Any]): Unit = js.native
  def set(keys: js.Array[String], values: js.Array[js.Any], cb: js.Function1[/* err */ Error, Unit]): Unit = js.native
  def set(keys: js.Array[String], values: js.Array[js.Any], storeName: String): Unit = js.native
  def set(
    keys: js.Array[String],
