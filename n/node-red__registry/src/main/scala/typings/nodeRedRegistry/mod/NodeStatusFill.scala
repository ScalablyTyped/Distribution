...
/* Rewritten from type alias, can be one of: 
  - typings.nodeRedRegistry.nodeRedRegistryStrings.red
  - typings.nodeRedRegistry.nodeRedRegistryStrings.green
  - typings.nodeRedRegistry.nodeRedRegistryStrings.yellow
  - typings.nodeRedRegistry.nodeRedRegistryStrings.blue
  - typings.nodeRedRegistry.nodeRedRegistryStrings.grey
*/
