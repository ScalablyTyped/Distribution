...
object updateScriptMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var source: typings.nginstackEngine.connectionConnectionMod.^ = js.native
    
    /* CompleteClass */
    var sourceDB: typings.nginstackEngine.databaseDatabaseMod.^ = js.native
    ...
    /* CompleteClass */
    var target: typings.nginstackEngine.connectionConnectionMod.^ = js.native
    
    /* CompleteClass */
    var targetDB: typings.nginstackEngine.databaseDatabaseMod.^ = js.native
  ...
  trait UpdateScript extends StObject {
    ...
    var source: typings.nginstackEngine.connectionConnectionMod.^
    
    var sourceDB: typings.nginstackEngine.databaseDatabaseMod.^
    
    /* private */ var state_ : Any
    
    /* private */ var sysEvent_ : Any
    
    var target: typings.nginstackEngine.connectionConnectionMod.^
    
    var targetDB: typings.nginstackEngine.databaseDatabaseMod.^
  ...
  object UpdateScript {
    ...
    inline def apply(
      ...
      result_ : Any,
      scriptKey: Any,
      source: typings.nginstackEngine.connectionConnectionMod.^,
      sourceDB: typings.nginstackEngine.databaseDatabaseMod.^,
      state_ : Any,
      sysEvent_ : Any,
      target: typings.nginstackEngine.connectionConnectionMod.^,
      targetDB: typings.nginstackEngine.databaseDatabaseMod.^,
      versions_ : Any
    ): UpdateScript = {
    ...
    extension [Self <: UpdateScript](x: Self) {
      ...
      inline def setSource(value: typings.nginstackEngine.connectionConnectionMod.^): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
      
      inline def setSourceDB(value: typings.nginstackEngine.databaseDatabaseMod.^): Self = StObject.set(x, "sourceDB", value.asInstanceOf[js.Any])
      ...
      inline def setTarget(value: typings.nginstackEngine.connectionConnectionMod.^): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
      
      inline def setTargetDB(value: typings.nginstackEngine.databaseDatabaseMod.^): Self = StObject.set(x, "targetDB", value.asInstanceOf[js.Any])
