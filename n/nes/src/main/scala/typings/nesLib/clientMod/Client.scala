...
trait Client extends js.Object {
  ...
  def connect(options: nesLib.clientMod.ClientNs.ClientConnectOptions): js.Promise[_] = js.native
  ...
  def unsubscribe(path: java.lang.String, handler: nesLib.clientMod.ClientNs.Handler): js.Promise[_] = js.native
}
