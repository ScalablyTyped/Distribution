...
object ServerOptions {
  @scala.inline
  def apply(
    adInterval: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(adInterval)) __obj.updateDynamic("adInterval")(adInterval.get.asInstanceOf[js.Any])
    if (!js.isUndefined(allowWildcards)) __obj.updateDynamic("allowWildcards")(allowWildcards.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(suppressRootDeviceAdvertisements)) __obj.updateDynamic("suppressRootDeviceAdvertisements")(suppressRootDeviceAdvertisements.get.asInstanceOf[js.Any])
