...
name := "node-red"
version := "1.2-dt-20220329Z-d4a34b"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-red__editor-api" % "1.1-dt-20211202Z-b72040",
  "org.scalablytyped" %%% "node-red__editor-client" % "1.1-dt-20220914Z-c35988",
