...
name := "node-red"
version := "1.2-dt-20220329Z-445b91"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-red__editor-api" % "1.1-dt-20211202Z-83205d",
  "org.scalablytyped" %%% "node-red__editor-client" % "1.1-dt-20220914Z-de0de6",
