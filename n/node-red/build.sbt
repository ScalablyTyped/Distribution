...
name := "node-red"
version := "1.2-dt-20220329Z-ce6bcc"
scalaVersion := "3.1.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-red__editor-api" % "1.1-dt-20211202Z-06a92a",
  "org.scalablytyped" %%% "node-red__editor-client" % "1.1-dt-20220914Z-97d4a4",
