...
object ChatAction {
  ...
  inline def upload_photo: typings.nodeTelegramBotApi.nodeTelegramBotApiStrings.upload_photo = "upload_photo".asInstanceOf[typings.nodeTelegramBotApi.nodeTelegramBotApiStrings.upload_photo]
