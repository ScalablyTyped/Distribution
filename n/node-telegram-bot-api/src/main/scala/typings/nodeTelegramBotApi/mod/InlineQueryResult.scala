...
object InlineQueryResult {
  ...
  inline def InlineQueryResultArticle(id: String, input_message_content: InputMessageContent, title: String): typings.nodeTelegramBotApi.mod.InlineQueryResultArticle = {
  ...
  inline def InlineQueryResultAudio(audio_url: String, id: String, title: String): typings.nodeTelegramBotApi.mod.InlineQueryResultAudio = {
  ...
  inline def InlineQueryResultCachedAudio(audio_file_id: String, id: String): typings.nodeTelegramBotApi.mod.InlineQueryResultCachedAudio = {
  ...
  inline def InlineQueryResultCachedDocument(document_file_id: String, id: String, title: String): typings.nodeTelegramBotApi.mod.InlineQueryResultCachedDocument = {
  ...
  inline def InlineQueryResultCachedGif(gif_file_id: String, id: String): typings.nodeTelegramBotApi.mod.InlineQueryResultCachedGif = {
  ...
  inline def InlineQueryResultCachedMpeg4Gif(id: String, mpeg4_file_id: String): typings.nodeTelegramBotApi.mod.InlineQueryResultCachedMpeg4Gif = {
  ...
  inline def InlineQueryResultCachedPhoto(id: String, photo_file_id: String): typings.nodeTelegramBotApi.mod.InlineQueryResultCachedPhoto = {
  ...
  inline def InlineQueryResultCachedSticker(id: String, sticker_file_id: String): typings.nodeTelegramBotApi.mod.InlineQueryResultCachedSticker = {
  ...
  inline def InlineQueryResultCachedVideo(id: String, title: String, video_file_id: String): typings.nodeTelegramBotApi.mod.InlineQueryResultCachedVideo = {
  ...
  inline def InlineQueryResultCachedVoice(id: String, title: String, voice_file_id: String): typings.nodeTelegramBotApi.mod.InlineQueryResultCachedVoice = {
  ...
  inline def InlineQueryResultContact(first_name: String, id: String, phone_number: String): typings.nodeTelegramBotApi.mod.InlineQueryResultContact = {
  ...
  inline def InlineQueryResultDocument(document_url: String, id: String, mime_type: String, title: String): typings.nodeTelegramBotApi.mod.InlineQueryResultDocument = {
  ...
  inline def InlineQueryResultGame(game_short_name: String, id: String): typings.nodeTelegramBotApi.mod.InlineQueryResultGame = {
  ...
  inline def InlineQueryResultGif(gif_url: String, id: String): typings.nodeTelegramBotApi.mod.InlineQueryResultGif = {
  ...
  inline def InlineQueryResultLocation(id: String, latitude: Double, longitude: Double, title: String): typings.nodeTelegramBotApi.mod.InlineQueryResultLocation = {
  ...
  inline def InlineQueryResultMpeg4Gif(id: String, mpeg4_url: String): typings.nodeTelegramBotApi.mod.InlineQueryResultMpeg4Gif = {
  ...
  inline def InlineQueryResultPhoto(id: String, photo_url: String, thumb_url: String): typings.nodeTelegramBotApi.mod.InlineQueryResultPhoto = {
  ...
  inline def InlineQueryResultVenue(address: String, id: String, latitude: Double, longitude: Double, title: String): typings.nodeTelegramBotApi.mod.InlineQueryResultVenue = {
  ...
  inline def InlineQueryResultVideo(id: String, mime_type: String, thumb_url: String, title: String, video_url: String): typings.nodeTelegramBotApi.mod.InlineQueryResultVideo = {
  ...
  inline def InlineQueryResultVoice(id: String, title: String, voice_url: String): typings.nodeTelegramBotApi.mod.InlineQueryResultVoice = {
