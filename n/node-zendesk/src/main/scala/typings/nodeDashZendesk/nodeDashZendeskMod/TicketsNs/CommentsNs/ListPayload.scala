package typings.nodeDashZendesk.nodeDashZendeskMod.TicketsNs.CommentsNs
...
trait ListPayload extends PaginablePayload {
  var comments: js.Array[typings.nodeDashZendesk.nodeDashZendeskMod.TicketsNs.CommentsNs.ResponseModel]
}

object ListPayload {
  @scala.inline
  def apply(
    comments: js.Array[typings.nodeDashZendesk.nodeDashZendeskMod.TicketsNs.CommentsNs.ResponseModel],
    count: Double,
