...
trait Methods extends js.Object {
  ...
  /** Get Comment */
  def getComment(requestId: ZendeskID, commentId: ZendeskID, cb: ZendeskCallback[_, _]): typings.nodeDashZendesk.nodeDashZendeskMod.RequestsNs.CommentsNs.ResponsePayload
  /** Viewing Requests */
  ...
  /** Listing Comments */
  def listComments(requestId: ZendeskID, cb: ZendeskCallback[_, _]): typings.nodeDashZendesk.nodeDashZendeskMod.RequestsNs.CommentsNs.ListPayload
...
object Methods {
  ...
  def apply(
    ...
    getComment: (ZendeskID, ZendeskID, ZendeskCallback[_, _]) => typings.nodeDashZendesk.nodeDashZendeskMod.RequestsNs.CommentsNs.ResponsePayload,
    ...
    listComments: (ZendeskID, ZendeskCallback[_, _]) => typings.nodeDashZendesk.nodeDashZendeskMod.RequestsNs.CommentsNs.ListPayload,
