...
trait CreateModel extends js.Object {
  ...
  var comment: typings.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.CreateModel
...
object CreateModel {
  @scala.inline
  def apply(
    comment: typings.nodeDashZendesk.nodeDashZendeskMod.Requests.Comments.CreateModel,
