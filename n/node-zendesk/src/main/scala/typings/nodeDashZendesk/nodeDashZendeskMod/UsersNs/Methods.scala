...
trait Methods extends js.Object {
  ...
  def createMany(users: CreateManyPayload, cb: ZendeskCallback[_, _]): typings.nodeDashZendesk.nodeDashZendeskMod.JobStatusesNs.ResponsePayload
  def createOrUpdate(user: CreatePayload, cb: ZendeskCallback[_, _]): ResponsePayload
  def createOrUpdateMany(users: CreateManyPayload, cb: ZendeskCallback[_, _]): typings.nodeDashZendesk.nodeDashZendeskMod.JobStatusesNs.ResponsePayload
  /** Deleting Users */
  ...
  def updateMany(userIds: UpdateIdPayload, users: UpdateManyPayload, cb: ZendeskCallback[_, _]): typings.nodeDashZendesk.nodeDashZendeskMod.JobStatusesNs.ResponsePayload
}
...
object Methods {
  ...
  def apply(
    ...
    createOrUpdateMany: (CreateManyPayload, ZendeskCallback[_, _]) => typings.nodeDashZendesk.nodeDashZendeskMod.JobStatusesNs.ResponsePayload,
    ...
    updateMany: (UpdateIdPayload, UpdateManyPayload, ZendeskCallback[_, _]) => typings.nodeDashZendesk.nodeDashZendeskMod.JobStatusesNs.ResponsePayload
  ): Methods = {
