package typings.nodeDashZendesk.nodeDashZendeskMod.TicketsNs.CommentsNs.CommentsUsersNs
...
trait ResponseModel
  extends typings.nodeDashZendesk.nodeDashZendeskMod.RequestsNs.CommentsNs.CommentsUsersNs.ResponseModel {
  val role: Role
}
