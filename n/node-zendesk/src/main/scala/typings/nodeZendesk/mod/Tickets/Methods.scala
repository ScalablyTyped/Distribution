...
trait Methods extends StObject {
  ...
  def createMany(tickets: CreateManyPayload, cb: ZendeskCallback[_, _]): typings.nodeZendesk.mod.JobStatuses.ResponsePayload = js.native
  ...
  /** Listing Comments */
  def getComments(requestId: ZendeskID, cb: ZendeskCallback[_, _]): typings.nodeZendesk.mod.Tickets.Comments.ListPayload = js.native
  ...
  def listCollaborators(ticketId: ZendeskID, cb: ZendeskCallback[_, _]): typings.nodeZendesk.mod.Users.ListPayload = js.native
  ...
  def listMetrics(ticketId: ZendeskID, cb: ZendeskCallback[_, _]): typings.nodeZendesk.mod.Tickets.Metrics.ResponsePayload = js.native
  ...
  /** Merging Tickets */
  def merge(ticketId: ZendeskID, mergingTickets: MergePayload, cb: ZendeskCallback[_, _]): typings.nodeZendesk.mod.JobStatuses.ResponsePayload = js.native
  ...
  def updateMany(tickets: UpdateManyPayload, cb: ZendeskCallback[_, _]): typings.nodeZendesk.mod.JobStatuses.ResponsePayload = js.native
}
