...
trait Methods extends StObject {
  ...
  /** Get Comment */
  def getComment(requestId: ZendeskID, commentId: ZendeskID, cb: ZendeskCallback[Any, Any]): typings.nodeZendesk.mod.Requests.Comments.ResponsePayload = js.native
  ...
  /** Listing Comments */
  def listComments(requestId: ZendeskID, cb: ZendeskCallback[Any, Any]): typings.nodeZendesk.mod.Requests.Comments.ListPayload = js.native
