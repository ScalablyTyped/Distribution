...
object _UpdateIdPayload {
  ...
  inline def Externalids(external_ids: js.Array[ZendeskID]): typings.nodeZendesk.anon.Externalids = {
  ...
  inline def Ids(ids: js.Array[ZendeskID]): typings.nodeZendesk.anon.Ids = {
