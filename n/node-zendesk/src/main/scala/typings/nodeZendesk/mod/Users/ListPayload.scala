...
object ListPayload {
  ...
  implicit class ListPayloadOps[Self <: ListPayload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUsersVarargs(value: ResponseModel*): Self = this.set("users", js.Array(value :_*))
    
    @scala.inline
    def setUsers(value: js.Array[ResponseModel]): Self = this.set("users", value.asInstanceOf[js.Any])
  }
}
