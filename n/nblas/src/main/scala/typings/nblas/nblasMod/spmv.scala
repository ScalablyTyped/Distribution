...
object spmv extends js.Object {
  ...
  def apply(ap: Float32Array, x: Float32Array, y: Float32Array, uplo: UPLO, alpha: Double, beta: Double): Unit = js.native
  ...
  def apply(ap: Float64Array, x: Float64Array, y: Float64Array, uplo: UPLO, alpha: Double, beta: Double): Unit = js.native
}
