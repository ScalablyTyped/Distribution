...
object stackFrameMod {
  ...
  inline def getFrameSource(frame: StackFrame): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getFrameSource")(frame.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def getOriginalStackFrame(isServerSide: Boolean, source: StackFrame): js.Promise[OriginalStackFrame] = (^.asInstanceOf[js.Dynamic].applyDynamic("getOriginalStackFrame")(isServerSide.asInstanceOf[js.Any], source.asInstanceOf[js.Any])).asInstanceOf[js.Promise[OriginalStackFrame]]
  
  inline def getOriginalStackFrames(isServerSide: Boolean, frames: js.Array[StackFrame]): js.Promise[js.Array[OriginalStackFrame]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getOriginalStackFrames")(isServerSide.asInstanceOf[js.Any], frames.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[OriginalStackFrame]]]
  ...
  */
  ...
  object OriginalStackFrame {
    ...
    inline def Expanded(originalCodeFrame: Null, originalStackFrame: Null, reason: String, sourceStackFrame: StackFrame): typings.nextReactDevOverlay.anon.Expanded = {
    ...
    inline def External(expanded: Boolean, originalStackFrame: StackFrame, reason: Null, sourceStackFrame: StackFrame): typings.nextReactDevOverlay.anon.External = {
    ...
    inline def OriginalCodeFrame(originalCodeFrame: Null, originalStackFrame: Null, reason: Null, sourceStackFrame: StackFrame): typings.nextReactDevOverlay.anon.OriginalCodeFrame = {
