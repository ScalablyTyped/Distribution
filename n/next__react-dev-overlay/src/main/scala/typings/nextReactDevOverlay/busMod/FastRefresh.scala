...
object FastRefresh {
  ...
  @scala.inline
  implicit class FastRefreshOps[Self <: FastRefresh] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: /* "fast-refresh" */ String): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
