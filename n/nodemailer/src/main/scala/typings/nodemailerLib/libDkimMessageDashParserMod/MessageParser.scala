...
trait MessageParser
  ...
  def addListener_headers(
    event: nodemailerLib.nodemailerLibStrings.headers,
    listener: js.Function1[/* headers */ js.Array[Header], scala.Unit]
  ): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("emit")
  def emit_headers(event: nodemailerLib.nodemailerLibStrings.headers, headers: js.Array[Header]): scala.Boolean = js.native
  @JSName("emit")
