...
trait MailOptions
  ...
  var auth: js.UndefOr[nodemailerLib.libSmtpDashConnectionMod.AuthenticationType] = js.undefined
  var dsn: js.UndefOr[nodemailerLib.libSmtpDashConnectionMod.DSNOptions] = js.undefined
}
