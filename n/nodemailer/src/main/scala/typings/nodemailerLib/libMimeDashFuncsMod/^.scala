...
object ^ extends js.Object {
  def buildHeaderParam(key: java.lang.String, data: java.lang.String): js.Array[ParsedHeaderParam] = js.native
  def buildHeaderParam(key: java.lang.String, data: java.lang.String, maxLength: scala.Double): js.Array[ParsedHeaderParam] = js.native
  def buildHeaderParam(key: java.lang.String, data: nodeLib.Buffer): js.Array[ParsedHeaderParam] = js.native
  def buildHeaderParam(key: java.lang.String, data: nodeLib.Buffer, maxLength: scala.Double): js.Array[ParsedHeaderParam] = js.native
  def buildHeaderValue(structured: HeaderValue): java.lang.String = js.native
  ...
  def parseHeaderValue(str: java.lang.String): ParsedHeaderValue = js.native
