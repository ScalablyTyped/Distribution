...
object AuthenticationType {
  ...
  inline def AuthenticationTypeCustom(method: String, pass: String, `type`: custom__ | Custom_ | CUSTOM, user: String): typings.nodemailer.smtpConnectionMod.AuthenticationTypeCustom = {
  ...
  inline def AuthenticationTypeLogin(pass: String, user: String): typings.nodemailer.smtpConnectionMod.AuthenticationTypeLogin = {
  ...
  inline def AuthenticationTypeOAuth2(): typings.nodemailer.smtpConnectionMod.AuthenticationTypeOAuth2 = {
