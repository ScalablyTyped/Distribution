...
import typings.nodemailer.libSmtpConnectionMod.Credentials
...
object libSmtpTransportMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.nodemailer.libSmtpTransportMod.AuthenticationTypeLogin
    - typings.nodemailer.libSmtpTransportMod.AuthenticationTypeOAuth2
  */
  trait AuthenticationType extends StObject
  object AuthenticationType {
    
    inline def AuthenticationTypeLogin(credentials: Credentials, method: String | `false`, user: String): typings.nodemailer.libSmtpTransportMod.AuthenticationTypeLogin = {
      ...
      __obj.asInstanceOf[typings.nodemailer.libSmtpTransportMod.AuthenticationTypeLogin]
    }
    
    inline def AuthenticationTypeOAuth2(oauth2: typings.nodemailer.libXoauth2Mod.^, user: String): typings.nodemailer.libSmtpTransportMod.AuthenticationTypeOAuth2 = {
      ...
      __obj.asInstanceOf[typings.nodemailer.libSmtpTransportMod.AuthenticationTypeOAuth2]
    }
  }
  ...
  object AuthenticationTypeOAuth2 {
    ...
    inline def apply(oauth2: typings.nodemailer.libXoauth2Mod.^, user: String): AuthenticationTypeOAuth2 = {
      val __obj = js.Dynamic.literal(method = "XOAUTH2", oauth2 = oauth2.asInstanceOf[js.Any], user = user.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("OAUTH2")
    ...
    extension [Self <: AuthenticationTypeOAuth2](x: Self) {
      ...
      inline def setOauth2(value: typings.nodemailer.libXoauth2Mod.^): Self = StObject.set(x, "oauth2", value.asInstanceOf[js.Any])
  ...
  trait MailOptions
    ...
    var auth: js.UndefOr[typings.nodemailer.libSmtpConnectionMod.AuthenticationType] = js.undefined
  ...
  trait SMTPTransport
    ...
    def getAuth(authOpts: typings.nodemailer.libSmtpConnectionMod.AuthenticationTypeLogin): AuthenticationType = js.native
    def getAuth(authOpts: typings.nodemailer.libSmtpConnectionMod.AuthenticationTypeOAuth2): AuthenticationType = js.native
    ...
    @JSName("mailer")
    var mailer_SMTPTransport: typings.nodemailer.libMailerMod.^[SentMessageInfo] = js.native
