...
trait MimeNode extends js.Object {
  def addHeader(headers: js.Array[Anon_KeyValue]): this.type = js.native
  ...
  def setEnvelope(envelope: typings.nodemailer.libMailerMod.Envelope): this.type = js.native
  def setHeader(headers: js.Array[Anon_KeyValue]): this.type = js.native
