...
import typings.nodemailer.AnonKeyValue
...
trait MimeNode extends js.Object {
  def addHeader(headers: js.Array[AnonKeyValue]): this.type = js.native
  ...
  def setHeader(headers: js.Array[AnonKeyValue]): this.type = js.native
