...
object libAddressparserMod {
  ...
  */
  ...
  object AddressOrGroup {
    ...
    inline def Address(address: String, name: String): typings.nodemailer.libAddressparserMod.Address = {
      val __obj = js.Dynamic.literal(address = address.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.nodemailer.libAddressparserMod.Address]
    }
    
    inline def Group(group: js.Array[AddressOrGroup], name: String): typings.nodemailer.libAddressparserMod.Group = {
      val __obj = js.Dynamic.literal(group = group.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.nodemailer.libAddressparserMod.Group]
    }
  }
