...
object libDkimMod {
  ...
  */
  ...
  object Options {
    ...
    inline def MultipleKeysOptions(keys: js.Array[SingleKeyOptions]): typings.nodemailer.libDkimMod.MultipleKeysOptions = {
      val __obj = js.Dynamic.literal(keys = keys.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.nodemailer.libDkimMod.MultipleKeysOptions]
    }
    
    inline def SingleKeyOptions(domainName: String, keySelector: String, privateKey: String | Key): typings.nodemailer.libDkimMod.SingleKeyOptions = {
      ...
      __obj.asInstanceOf[typings.nodemailer.libDkimMod.SingleKeyOptions]
    }
  }
