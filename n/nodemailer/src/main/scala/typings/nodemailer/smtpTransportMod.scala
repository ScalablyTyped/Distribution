  ...
  */
  ...
  object AuthenticationTypeOAuth2 {
    ...
    implicit class AuthenticationTypeOAuth2MutableBuilder[Self <: AuthenticationTypeOAuth2] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOauth2(value: typings.nodemailer.xoauth2Mod.^): Self = StObject.set(x, "oauth2", value.asInstanceOf[js.Any])
  ...
  object MailOptions {
    ...
    implicit class MailOptionsMutableBuilder[Self <: MailOptions] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAuth(value: typings.nodemailer.smtpConnectionMod.AuthenticationType): Self = StObject.set(x, "auth", value.asInstanceOf[js.Any])
