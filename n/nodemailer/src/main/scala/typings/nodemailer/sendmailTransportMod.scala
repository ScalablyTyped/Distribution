...
object sendmailTransportMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    @JSName("mailer")
    var mailer_SendmailTransport: typings.nodemailer.mailerMod.^[SentMessageInfo] = js.native
  ...
  trait SendmailTransport
    ...
    @JSName("mailer")
    var mailer_SendmailTransport: typings.nodemailer.mailerMod.^[SentMessageInfo]
