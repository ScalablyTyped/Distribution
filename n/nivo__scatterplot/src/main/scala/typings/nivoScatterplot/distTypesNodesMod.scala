...
object distTypesNodesMod {
  ...
  inline def Nodes[RawDatum /* <: ScatterPlotDatum */](param0: NodesProps[RawDatum]): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("Nodes")(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
