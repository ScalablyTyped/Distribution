...
object distTypesMeshMod {
  ...
  inline def Mesh[RawDatum /* <: ScatterPlotDatum */](param0: MeshProps[RawDatum]): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("Mesh")(param0.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  object MeshProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: MeshProps[?], RawDatum /* <: ScatterPlotDatum */] (val x: Self & MeshProps[RawDatum]) extends AnyVal {
