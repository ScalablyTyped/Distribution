...
object distTypesComputeMod {
  ...
  inline def computePoints[RawDatum /* <: ScatterPlotDatum */](param0: FormatX[RawDatum]): js.Array[Omit[ScatterPlotNodeData[RawDatum], color | size]] = ^.asInstanceOf[js.Dynamic].applyDynamic("computePoints")(param0.asInstanceOf[js.Any]).asInstanceOf[js.Array[Omit[ScatterPlotNodeData[RawDatum], color | size]]]
