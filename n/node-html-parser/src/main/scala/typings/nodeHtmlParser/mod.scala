...
object mod {
  ...
  object default {
    ...
    open class CommentNode protected ()
      extends typings.nodeHtmlParser.distNodesCommentMod.default {
  ...
  object parse {
    ...
    /* was `typeof imported_html.default` */
    type HTMLElement = typings.nodeHtmlParser.distNodesHtmlMod.default
    
    /* was `typeof imported_node.default` */
    type Node = typings.nodeHtmlParser.distNodesNodeMod.default
    
    /* was `typeof imported_text.default` */
    type TextNode = typings.nodeHtmlParser.distNodesTextMod.default
  }
}
