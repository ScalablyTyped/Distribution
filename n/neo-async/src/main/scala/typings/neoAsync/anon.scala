...
object anon {
  ...
  /* Inlined neo-async.neo-async.RetryOptions & {  arity :number | undefined} */
  ...
  object RetryOptionsaritynumberun {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: RetryOptionsaritynumberun] (val x: Self) extends AnyVal {
