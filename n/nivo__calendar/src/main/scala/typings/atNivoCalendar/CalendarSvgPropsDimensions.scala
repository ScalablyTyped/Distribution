...
import typings.atNivoCalendar.atNivoCalendarMod.CalendarDatum
...
import typings.atNivoCalendar.atNivoCalendarMod.DateOrString
...
object CalendarSvgPropsDimensions {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(data = data, from = from.asInstanceOf[js.Any], height = height, to = to.asInstanceOf[js.Any], width = width)
    if (align != null) __obj.updateDynamic("align")(align)
    if (colors != null) __obj.updateDynamic("colors")(colors)
    if (dayBorderColor != null) __obj.updateDynamic("dayBorderColor")(dayBorderColor)
    ...
    if (monthBorderColor != null) __obj.updateDynamic("monthBorderColor")(monthBorderColor)
