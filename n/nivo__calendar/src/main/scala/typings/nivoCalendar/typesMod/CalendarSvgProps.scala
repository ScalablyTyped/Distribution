...
/* Inlined @nivo/core.@nivo/core.Dimensions & @nivo/calendar.@nivo/calendar/dist/types/types.CalendarData & std.Partial<@nivo/calendar.@nivo/calendar/dist/types/types.CommonCalendarProps & @nivo/calendar.@nivo/calendar/dist/types/types.InteractivityProps<std.Omit<@nivo/calendar.@nivo/calendar/dist/types/types.Datum, 'data' | 'value'> | @nivo/calendar.@nivo/calendar/dist/types/types.Datum, std.SVGRectElement> & {  role :string}> */
trait CalendarSvgProps extends StObject {
...
object CalendarSvgProps {
  ...
  inline def apply(data: js.Array[CalendarDatum], from: DateOrString, height: Double, to: DateOrString, width: Double): CalendarSvgProps = {
