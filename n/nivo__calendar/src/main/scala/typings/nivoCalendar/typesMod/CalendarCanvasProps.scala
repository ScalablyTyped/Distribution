...
object CalendarCanvasProps {
  
  inline def apply(data: js.Array[CalendarDatum], from: DateOrString, height: Double, to: DateOrString, width: Double): CalendarCanvasProps = {
    ...
    __obj.asInstanceOf[CalendarCanvasProps]
  }
  
  extension [Self <: CalendarCanvasProps](x: Self) {
