...
trait PushNotifications extends js.Object {
  def send(registrationIds: js.Array[RegistrationId], data: Data): js.Promise[_] = js.native
  def send(registrationIds: js.Array[RegistrationId], data: Data, cb: Callback): scala.Unit = js.native
  def send(registrationIds: RegistrationId, data: Data): js.Promise[_] = js.native
