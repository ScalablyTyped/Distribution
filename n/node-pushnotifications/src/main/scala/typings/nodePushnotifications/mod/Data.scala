...
object Data {
  ...
  def apply(
    ...
    locKey: String = null,
    mdm: String = null,
    mutableContent: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(truncateAtWordEnd)) __obj.updateDynamic("truncateAtWordEnd")(truncateAtWordEnd.get.asInstanceOf[js.Any])
