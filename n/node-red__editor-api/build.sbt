...
version := "1.1-dt-20211202Z-06a92a"
scalaVersion := "3.1.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-red__runtime" % "1.2-dt-20211202Z-3d2303",
  "org.scalablytyped" %%% "node-red__util" % "1.2-dt-20220624Z-64a2d8",
  "org.scalablytyped" %%% "passport" % "1.0-dt-20220912Z-5d06e8",
