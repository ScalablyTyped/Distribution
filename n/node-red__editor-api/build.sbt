...
version := "1.1-dt-20211202Z-8f7bab"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-red__registry" % "1.2-dt-20220912Z-f7e2f4",
  "org.scalablytyped" %%% "node-red__runtime" % "1.2-dt-20211202Z-56855f",
  "org.scalablytyped" %%% "node-red__util" % "1.2-dt-20220624Z-0380ef",
