...
version := "1.1-dt-20200925Z-811088"
scalaVersion := "3.0.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "cors" % "2.8-dt-20201010Z-7a9993",
  "org.scalablytyped" %%% "express" % "4.17-dt-20201111Z-fb786d",
  "org.scalablytyped" %%% "express-serve-static-core" % "4.17-dt-20200921Z-4e2465",
  "org.scalablytyped" %%% "jsonata" % "1.8.4-0b5aca",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20200722Z-418907",
  "org.scalablytyped" %%% "node" % "14.14-dt-20201119Z-e00132",
  "org.scalablytyped" %%% "node-red__registry" % "1.1-dt-20200925Z-7d637b",
  "org.scalablytyped" %%% "node-red__runtime" % "1.1-dt-20201028Z-e3802d",
  "org.scalablytyped" %%% "node-red__util" % "1.1-dt-20200925Z-292658",
  "org.scalablytyped" %%% "passport" % "1.0-dt-20201112Z-7f3f3e",
