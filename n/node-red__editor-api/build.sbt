...
version := "1.1-dt-20200925Z-5f822e"
scalaVersion := "3.0.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "cors" % "2.8-dt-20201010Z-111a26",
  "org.scalablytyped" %%% "express" % "4.17-dt-20201111Z-2d5437",
  "org.scalablytyped" %%% "express-serve-static-core" % "4.17-dt-20200921Z-44f8de",
  "org.scalablytyped" %%% "jsonata" % "1.8.4-0a165e",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20200722Z-162477",
  "org.scalablytyped" %%% "node" % "14.14-dt-20201119Z-11c649",
  "org.scalablytyped" %%% "node-red__registry" % "1.1-dt-20200925Z-bfed9a",
  "org.scalablytyped" %%% "node-red__runtime" % "1.1-dt-20201028Z-7cdbcb",
  "org.scalablytyped" %%% "node-red__util" % "1.1-dt-20200925Z-c2880f",
  "org.scalablytyped" %%% "passport" % "1.0-dt-20201112Z-82de57",
