...
trait RemovalOptions extends js.Object {
  /**
    ...
    */
  var originTypes: js.UndefOr[typings.chrome.chromeNs.browsingDataNs.OriginTypes] = js.undefined
...
object RemovalOptions {
  @scala.inline
  def apply(originTypes: typings.chrome.chromeNs.browsingDataNs.OriginTypes = null, since: Int | Double = null): RemovalOptions = {
