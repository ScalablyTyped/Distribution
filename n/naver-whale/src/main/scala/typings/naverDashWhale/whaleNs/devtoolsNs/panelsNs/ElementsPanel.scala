...
trait ElementsPanel extends js.Object {
  ...
  var onSelectionChanged: typings.chrome.chromeNs.devtoolsNs.panelsNs.SelectionChangedEvent = js.native
  /**
  ...
  def createSidebarPane(
    ...
    callback: js.Function1[
      /* result */ typings.chrome.chromeNs.devtoolsNs.panelsNs.ExtensionSidebarPane, 
      Unit
    ]
  ): Unit = js.native
}
