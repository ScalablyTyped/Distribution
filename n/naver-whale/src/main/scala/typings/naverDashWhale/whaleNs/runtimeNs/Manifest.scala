...
trait Manifest
  ...
  // Pick one (or none)
  var browser_action: js.UndefOr[typings.chrome.chromeNs.runtimeNs.ManifestAction] = js.undefined
  ...
  var icons: js.UndefOr[typings.chrome.chromeNs.runtimeNs.ManifestIcons] = js.undefined
  ...
  var page_action: js.UndefOr[typings.chrome.chromeNs.runtimeNs.ManifestAction] = js.undefined
...
object Manifest {
  ...
  def apply(
    ...
    browser_action: typings.chrome.chromeNs.runtimeNs.ManifestAction = null,
    ...
    icons: typings.chrome.chromeNs.runtimeNs.ManifestIcons = null,
    ...
    page_action: typings.chrome.chromeNs.runtimeNs.ManifestAction = null,
