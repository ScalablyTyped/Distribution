...
trait Event[T /* <: js.Function */] extends js.Object {
  ...
  /**
    ...
    */
  def addRules(rules: js.Array[typings.chrome.chromeNs.eventsNs.Rule]): Unit = js.native
  def addRules(
    rules: js.Array[typings.chrome.chromeNs.eventsNs.Rule],
    callback: js.Function1[/* rules */ js.Array[typings.chrome.chromeNs.eventsNs.Rule], Unit]
  ): Unit = js.native
  /**
    ...
    * Parameter rules: Rules that were registered, the optional parameters are filled with values.
    */
  def getRules(callback: js.Function1[/* rules */ js.Array[typings.chrome.chromeNs.eventsNs.Rule], Unit]): Unit = js.native
  /**
    * Returns currently registered rules.
