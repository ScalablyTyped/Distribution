...
trait BlockingResponse extends js.Object {
  ...
  var authCredentials: js.UndefOr[typings.chrome.chromeNs.webRequestNs.AuthCredentials] = js.undefined
...
object BlockingResponse {
  @scala.inline
  def apply(
    authCredentials: typings.chrome.chromeNs.webRequestNs.AuthCredentials = null,
