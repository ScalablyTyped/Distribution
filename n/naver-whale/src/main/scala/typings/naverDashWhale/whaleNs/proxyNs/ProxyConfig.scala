...
trait ProxyConfig extends js.Object {
  ...
  var pacScript: js.UndefOr[typings.chrome.chromeNs.proxyNs.PacScript] = js.undefined
  /** Optional. The proxy rules describing this configuration. Use this for 'fixed_servers' mode. */
  var rules: js.UndefOr[typings.chrome.chromeNs.proxyNs.ProxyRules] = js.undefined
}
...
object ProxyConfig {
  ...
  def apply(
    mode: String,
    pacScript: typings.chrome.chromeNs.proxyNs.PacScript = null,
    rules: typings.chrome.chromeNs.proxyNs.ProxyRules = null
  ): ProxyConfig = {
