...
trait ManifestAction extends js.Object {
  var default_icon: js.UndefOr[typings.chrome.chromeNs.runtimeNs.ManifestIcons] = js.undefined
...
object ManifestAction {
  @scala.inline
  def apply(
    default_icon: typings.chrome.chromeNs.runtimeNs.ManifestIcons = null,
