...
trait SetDetails extends js.Object {
  ...
  var resourceIdentifier: js.UndefOr[typings.chrome.chromeNs.contentSettingsNs.ResourceIdentifier] = js.undefined
  /** Optional. Where to set the setting (default: regular).  */
  var scope: js.UndefOr[typings.chrome.chromeNs.contentSettingsNs.ScopeEnum] = js.undefined
