...
trait WebRequestBody extends js.Object {
  ...
  /**
    ...
    */
  var raw: js.UndefOr[js.Array[typings.chrome.chromeNs.webRequestNs.UploadData]] = js.undefined
}
...
object WebRequestBody {
  ...
  def apply(
    ...
    raw: js.Array[typings.chrome.chromeNs.webRequestNs.UploadData] = null
  ): WebRequestBody = {
