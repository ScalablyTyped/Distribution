...
trait SpeakOptions extends js.Object {
  ...
  /**
    ...
    */
  var onEvent: js.UndefOr[js.Function1[/* event */ typings.chrome.chromeNs.ttsNs.TtsEvent, Unit]] = js.undefined
  /**
    * Optional.
...
object SpeakOptions {
  ...
  def apply(
    ...
    gender: String = null,
    lang: String = null,
    onEvent: /* event */ typings.chrome.chromeNs.ttsNs.TtsEvent => Unit = null,
