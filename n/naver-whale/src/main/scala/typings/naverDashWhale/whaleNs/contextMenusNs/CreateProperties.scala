...
trait CreateProperties extends js.Object {
  ...
  var onclick: js.UndefOr[
    js.Function2[/* info */ typings.chrome.chromeNs.contextMenusNs.OnClickData, /* tab */ Tab, Unit]
  ] = js.undefined
...
object CreateProperties {
  ...
  def apply(
    ...
    id: String = null,
    onclick: (/* info */ typings.chrome.chromeNs.contextMenusNs.OnClickData, /* tab */ Tab) => Unit = null,
