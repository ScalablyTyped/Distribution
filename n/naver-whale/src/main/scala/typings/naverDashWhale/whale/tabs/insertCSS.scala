...
object insertCSS extends js.Object {
  ...
  def apply(details: typings.chrome.chrome.tabs.InjectDetails, callback: js.Function): Unit = js.native
  def apply(tabId: Double, details: typings.chrome.chrome.tabs.InjectDetails): Unit = js.native
  def apply(tabId: Double, details: typings.chrome.chrome.tabs.InjectDetails, callback: js.Function): Unit = js.native
}
