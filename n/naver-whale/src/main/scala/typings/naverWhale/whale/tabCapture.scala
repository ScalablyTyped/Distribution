...
object tabCapture {
  ...
  object CaptureOptions {
    ...
    implicit open class MutableBuilder[Self <: CaptureOptions] (val x: Self) extends AnyVal {
      ...
      inline def setAudioConstraints(value: typings.chrome.chrome.tabCapture.MediaStreamConstraint): Self = StObject.set(x, "audioConstraints", value.asInstanceOf[js.Any])
      ...
      inline def setVideoConstraints(value: typings.chrome.chrome.tabCapture.MediaStreamConstraint): Self = StObject.set(x, "videoConstraints", value.asInstanceOf[js.Any])
