...
trait ManifestV3
  ...
  // Optional
  var action: js.UndefOr[typings.chrome.chrome.runtime.ManifestAction] = js.undefined
  ...
  var optional_permissions: js.UndefOr[js.Array[typings.chrome.chrome.runtime.ManifestPermissions]] = js.undefined
  
  var permissions: js.UndefOr[js.Array[typings.chrome.chrome.runtime.ManifestPermissions]] = js.undefined
...
object ManifestV3 {
  ...
  extension [Self <: ManifestV3](x: Self) {
    ...
    inline def setAction(value: typings.chrome.chrome.runtime.ManifestAction): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
    ...
    inline def setOptional_permissions(value: js.Array[typings.chrome.chrome.runtime.ManifestPermissions]): Self = StObject.set(x, "optional_permissions", value.asInstanceOf[js.Any])
    
    inline def setOptional_permissionsUndefined: Self = StObject.set(x, "optional_permissions", js.undefined)
    
    inline def setOptional_permissionsVarargs(value: typings.chrome.chrome.runtime.ManifestPermissions*): Self = StObject.set(x, "optional_permissions", js.Array(value*))
    
    inline def setPermissions(value: js.Array[typings.chrome.chrome.runtime.ManifestPermissions]): Self = StObject.set(x, "permissions", value.asInstanceOf[js.Any])
    
    inline def setPermissionsUndefined: Self = StObject.set(x, "permissions", js.undefined)
    
    inline def setPermissionsVarargs(value: typings.chrome.chrome.runtime.ManifestPermissions*): Self = StObject.set(x, "permissions", js.Array(value*))
