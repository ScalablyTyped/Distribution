...
object permissions {
  ...
  object PermissionsAddedEvent {
    ...
    implicit class PermissionsAddedEventMutableBuilder[Self <: PermissionsAddedEvent] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAddListener(value: js.Function1[/* permissions */ typings.chrome.chrome.permissions.Permissions, Unit] => Unit): Self = StObject.set(x, "addListener", js.Any.fromFunction1(value))
    }
  }
