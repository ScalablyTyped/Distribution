...
object windows {
  ...
  trait CreateData extends StObject {
    ...
    /**
      ...
      * @since Chrome 44.
      */
    var state: js.UndefOr[typings.chrome.chrome.windows.windowStateEnum] = js.undefined
    ...
    var `type`: js.UndefOr[typings.chrome.chrome.windows.createTypeEnum] = js.undefined
  ...
  object CreateData {
    ...
    extension [Self <: CreateData](x: Self) {
      ...
      inline def setState(value: typings.chrome.chrome.windows.windowStateEnum): Self = StObject.set(x, "state", value.asInstanceOf[js.Any])
      ...
      inline def setType(value: typings.chrome.chrome.windows.createTypeEnum): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  trait QueryOptions extends StObject {
    ...
    /**
      ...
      */
    var windowTypes: js.UndefOr[js.Array[typings.chrome.chrome.windows.windowTypeEnum]] = js.undefined
  }
  object QueryOptions {
    ...
    extension [Self <: QueryOptions](x: Self) {
      ...
      inline def setWindowTypesVarargs(value: typings.chrome.chrome.windows.windowTypeEnum*): Self = StObject.set(x, "windowTypes", js.Array(value*))
    }
  }
  ...
  trait Window extends StObject {
    ...
    /**
      ...
      */
    var `type`: js.UndefOr[typings.chrome.chrome.windows.windowTypeEnum] = js.undefined
  ...
  object Window {
    ...
    extension [Self <: Window](x: Self) {
      ...
      inline def setType(value: typings.chrome.chrome.windows.windowTypeEnum): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  trait WindowEventFilter extends StObject {
    ...
    /**
      ...
      */
    var windowTypes: js.Array[typings.chrome.chrome.windows.windowTypeEnum]
  }
  object WindowEventFilter {
    
    inline def apply(windowTypes: js.Array[typings.chrome.chrome.windows.windowTypeEnum]): WindowEventFilter = {
  ...
  trait WindowIdEvent
    ...
    def addListener(
      ...
      filters: typings.chrome.chrome.windows.WindowEventFilter
    ): Unit = js.native
  }
  ...
  trait WindowReferenceEvent
    extends StObject
       with Event[js.Function1[/* window */ typings.chrome.chrome.windows.Window, Unit]] {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.naverWhale.naverWhaleStrings.normal
    - typings.naverWhale.naverWhaleStrings.popup
    - typings.naverWhale.naverWhaleStrings.panel
  */
  trait createTypeEnum extends StObject
  object createTypeEnum {
    
    inline def normal: typings.naverWhale.naverWhaleStrings.normal = "normal".asInstanceOf[typings.naverWhale.naverWhaleStrings.normal]
    
    inline def panel: typings.naverWhale.naverWhaleStrings.panel = "panel".asInstanceOf[typings.naverWhale.naverWhaleStrings.panel]
    
    inline def popup: typings.naverWhale.naverWhaleStrings.popup = "popup".asInstanceOf[typings.naverWhale.naverWhaleStrings.popup]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.naverWhale.naverWhaleStrings.normal
    - typings.naverWhale.naverWhaleStrings.minimized
    - typings.naverWhale.naverWhaleStrings.maximized
    - typings.naverWhale.naverWhaleStrings.fullscreen
    - typings.naverWhale.naverWhaleStrings.`locked-fullscreen`
  */
  trait windowStateEnum extends StObject
  object windowStateEnum {
    
    inline def fullscreen: typings.naverWhale.naverWhaleStrings.fullscreen = "fullscreen".asInstanceOf[typings.naverWhale.naverWhaleStrings.fullscreen]
    
    inline def `locked-fullscreen`: typings.naverWhale.naverWhaleStrings.`locked-fullscreen` = "locked-fullscreen".asInstanceOf[typings.naverWhale.naverWhaleStrings.`locked-fullscreen`]
    
    inline def maximized: typings.naverWhale.naverWhaleStrings.maximized = "maximized".asInstanceOf[typings.naverWhale.naverWhaleStrings.maximized]
    
    inline def minimized: typings.naverWhale.naverWhaleStrings.minimized = "minimized".asInstanceOf[typings.naverWhale.naverWhaleStrings.minimized]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.naverWhale.naverWhaleStrings.popup
    - typings.naverWhale.naverWhaleStrings.panel
    - typings.naverWhale.naverWhaleStrings.app
    - typings.naverWhale.naverWhaleStrings.devtools
  */
  trait windowTypeEnum extends StObject
  object windowTypeEnum {
    
    inline def app: typings.naverWhale.naverWhaleStrings.app = "app".asInstanceOf[typings.naverWhale.naverWhaleStrings.app]
    
    inline def devtools: typings.naverWhale.naverWhaleStrings.devtools = "devtools".asInstanceOf[typings.naverWhale.naverWhaleStrings.devtools]
