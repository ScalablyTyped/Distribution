...
object storage {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.naverWhale.naverWhaleStrings.TRUSTED_AND_UNTRUSTED_CONTEXTS
    - typings.naverWhale.naverWhaleStrings.TRUSTED_CONTEXTS
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.naverWhale.naverWhaleStrings.session
  */
  trait AreaName extends StObject
  object AreaName {
    
    inline def local: typings.naverWhale.naverWhaleStrings.local = "local".asInstanceOf[typings.naverWhale.naverWhaleStrings.local]
    
    inline def managed: typings.naverWhale.naverWhaleStrings.managed = "managed".asInstanceOf[typings.naverWhale.naverWhaleStrings.managed]
    
    inline def session: typings.naverWhale.naverWhaleStrings.session = "session".asInstanceOf[typings.naverWhale.naverWhaleStrings.session]
    
    inline def sync: typings.naverWhale.naverWhaleStrings.sync = "sync".asInstanceOf[typings.naverWhale.naverWhaleStrings.sync]
  }
  ...
  trait StorageArea extends StObject {
    ...
    /**
      ...
      * Parameter items: Object with items in their key-value mappings.
      */
    var onChanged: typings.chrome.chrome.storage.StorageAreaChangedEvent = js.native
  ...
  type StorageAreaChangedEvent = Event[
    js.Function1[/* changes */ StringDictionary[typings.chrome.chrome.storage.StorageChange], Unit]
  ]
