...
trait CookieChangeInfo extends js.Object {
  ...
  var cookie: typings.chrome.chrome.cookies.Cookie = js.native
...
object CookieChangeInfo {
  ...
  implicit class CookieChangeInfoOps[Self <: CookieChangeInfo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCookie(value: typings.chrome.chrome.cookies.Cookie): Self = this.set("cookie", value.asInstanceOf[js.Any])
