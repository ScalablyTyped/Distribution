...
object browserAction {
  ...
  object BadgeBackgroundColorDetails {
    ...
    inline def apply(color: String | typings.chrome.chrome.browserAction.ColorArray): BadgeBackgroundColorDetails = {
    ...
    extension [Self <: BadgeBackgroundColorDetails](x: Self) {
      ...
      inline def setColor(value: String | typings.chrome.chrome.browserAction.ColorArray): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
