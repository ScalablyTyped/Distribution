...
trait NotificationsSetDetails
  ...
  @JSName("setting")
  var setting_NotificationsSetDetails: naverDashWhaleLib.naverDashWhaleLibStrings.allow | naverDashWhaleLib.naverDashWhaleLibStrings.block | naverDashWhaleLib.naverDashWhaleLibStrings.ask
}
