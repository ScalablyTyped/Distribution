...
trait Manifest
  ...
  // Pick one (or none)
  var browser_action: js.UndefOr[chromeLib.chromeNs.runtimeNs.ManifestAction] = js.undefined
  ...
  var icons: js.UndefOr[chromeLib.chromeNs.runtimeNs.ManifestIcons] = js.undefined
  ...
  var page_action: js.UndefOr[chromeLib.chromeNs.runtimeNs.ManifestAction] = js.undefined
...
object Manifest {
  ...
  def apply(
    ...
    browser_action: chromeLib.chromeNs.runtimeNs.ManifestAction = null,
    ...
    icons: chromeLib.chromeNs.runtimeNs.ManifestIcons = null,
    ...
    page_action: chromeLib.chromeNs.runtimeNs.ManifestAction = null,
