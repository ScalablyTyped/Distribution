...
trait LocationSetDetails
  ...
  @JSName("setting")
  var setting_LocationSetDetails: naverDashWhaleLib.naverDashWhaleLibStrings.allow | naverDashWhaleLib.naverDashWhaleLibStrings.block | naverDashWhaleLib.naverDashWhaleLibStrings.ask
}
