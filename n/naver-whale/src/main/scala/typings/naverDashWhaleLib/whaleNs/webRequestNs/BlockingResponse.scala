...
trait BlockingResponse extends js.Object {
  ...
  var authCredentials: js.UndefOr[chromeLib.chromeNs.webRequestNs.AuthCredentials] = js.undefined
...
object BlockingResponse {
  @scala.inline
  def apply(
    authCredentials: chromeLib.chromeNs.webRequestNs.AuthCredentials = null,
