...
trait QueryInfo extends js.Object {
  ...
  var status: js.UndefOr[
    naverDashWhaleLib.naverDashWhaleLibStrings.loading | naverDashWhaleLib.naverDashWhaleLibStrings.complete
  ] = js.undefined
  ...
  var windowType: js.UndefOr[
    naverDashWhaleLib.naverDashWhaleLibStrings.normal | naverDashWhaleLib.naverDashWhaleLibStrings.popup | naverDashWhaleLib.naverDashWhaleLibStrings.panel | naverDashWhaleLib.naverDashWhaleLibStrings.app | naverDashWhaleLib.naverDashWhaleLibStrings.devtools
  ] = js.undefined
}
...
object QueryInfo {
  ...
  def apply(
    ...
    status: naverDashWhaleLib.naverDashWhaleLibStrings.loading | naverDashWhaleLib.naverDashWhaleLibStrings.complete = null,
    title: java.lang.String = null,
    url: java.lang.String | js.Array[java.lang.String] = null,
    windowId: scala.Int | scala.Double = null,
    windowType: naverDashWhaleLib.naverDashWhaleLibStrings.normal | naverDashWhaleLib.naverDashWhaleLibStrings.popup | naverDashWhaleLib.naverDashWhaleLibStrings.panel | naverDashWhaleLib.naverDashWhaleLibStrings.app | naverDashWhaleLib.naverDashWhaleLibStrings.devtools = null
  ): QueryInfo = {
