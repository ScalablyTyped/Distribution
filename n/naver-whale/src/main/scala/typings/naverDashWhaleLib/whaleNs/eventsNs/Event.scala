...
trait Event[T /* <: js.Function */] extends js.Object {
  ...
  /**
    ...
    */
  def addRules(rules: js.Array[chromeLib.chromeNs.eventsNs.Rule]): scala.Unit = js.native
  def addRules(
    rules: js.Array[chromeLib.chromeNs.eventsNs.Rule],
    callback: js.Function1[/* rules */ js.Array[chromeLib.chromeNs.eventsNs.Rule], scala.Unit]
  ...
  /**
    ...
    * Parameter rules: Rules that were registered, the optional parameters are filled with values.
    */
  def getRules(callback: js.Function1[/* rules */ js.Array[chromeLib.chromeNs.eventsNs.Rule], scala.Unit]): scala.Unit = js.native
  /**
    * Returns currently registered rules.
