...
class ImapSimple protected ()
  ...
  def addBox(boxName: java.lang.String): stdLib.Promise[java.lang.String] = js.native
  ...
  def append(message: js.Any, options: imapLib.imapMod.ConnectionNs.AppendOptions): stdLib.Promise[scala.Unit] = js.native
  ...
  def delBox(boxName: java.lang.String): stdLib.Promise[java.lang.String] = js.native
  /** Delete a mailbox, calling the provided callback with signature (err, boxName), or resolves the returned promise with boxName. */
  def delBox(
    boxName: java.lang.String,
    callback: js.Function2[/* err */ nodeLib.Error, /* boxName */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  def delFlags(uid: java.lang.String, flag: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  ...
  def delFlags(uid: java.lang.String, flag: js.Array[java.lang.String]): stdLib.Promise[scala.Unit] = js.native
  /** Removes the provided flag(s) from the specified message(s). uid is the uid of the message you want to remove the flag from or an array of uids. flag is either a string or array of strings indicating the flags to remove. */
  def delFlags(
    uid: java.lang.String,
    flag: js.Array[java.lang.String],
  ...
  def delFlags(uid: js.Array[java.lang.String], flag: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  /** Removes the provided flag(s) from the specified message(s). uid is the uid of the message you want to remove the flag from or an array of uids. flag is either a string or array of strings indicating the flags to remove. */
  def delFlags(
  ...
  def delFlags(uid: js.Array[java.lang.String], flag: js.Array[java.lang.String]): stdLib.Promise[scala.Unit] = js.native
  /** Removes the provided flag(s) from the specified message(s). uid is the uid of the message you want to remove the flag from or an array of uids. flag is either a string or array of strings indicating the flags to remove. */
  def delFlags(
    uid: js.Array[java.lang.String],
    flag: js.Array[java.lang.String],
  ...
  def getBoxes(): stdLib.Promise[imapLib.imapMod.ConnectionNs.MailBoxes] = js.native
