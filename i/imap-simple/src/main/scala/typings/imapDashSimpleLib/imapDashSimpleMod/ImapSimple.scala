...
class ImapSimple protected ()
  ...
  def this(imap: imapLib.imapMod.^) = this()
  ...
  def append(message: js.Any, options: imapLib.imapMod.AppendOptions): js.Promise[scala.Unit] = js.native
  ...
  def append(
    message: js.Any,
    options: imapLib.imapMod.AppendOptions,
    callback: js.Function1[/* err */ stdLib.Error, scala.Unit]
  ): scala.Unit = js.native
  ...
  def getBoxes(): js.Promise[imapLib.imapMod.MailBoxes] = js.native
  ...
  def getBoxes(callback: js.Function2[/* err */ stdLib.Error, /* boxes */ imapLib.imapMod.MailBoxes, scala.Unit]): scala.Unit = js.native
  ...
  def search(searchCriteria: js.Array[_], fetchOptions: imapLib.imapMod.FetchOptions): js.Promise[js.Array[Message]] = js.native
  /** Search for and retrieve mail in the currently open mailbox. */
  def search(
    searchCriteria: js.Array[_],
    fetchOptions: imapLib.imapMod.FetchOptions,
