...
import typings.inversify.dtsInterfacesInterfacesMod.interfaces.Clonable
...
@js.native
object dtsContainerLookupMod extends js.Object {
  @js.native
  class Lookup[T /* <: Clonable[T] */] ()
    extends typings.inversify.dtsInterfacesInterfacesMod.interfaces.Lookup[T] {
