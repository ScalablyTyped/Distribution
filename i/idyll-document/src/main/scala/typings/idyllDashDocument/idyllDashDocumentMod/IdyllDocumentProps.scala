...
import typings.idyllDashDocument.Anon_Children
...
trait IdyllDocumentProps extends js.Object {
  ...
  /**
    ...
    */
  var errorComponent: js.UndefOr[ReactType[Anon_Children]] = js.undefined
...
object IdyllDocumentProps {
  ...
  def apply(
    ...
    errorComponent: ReactType[Anon_Children] = null,
