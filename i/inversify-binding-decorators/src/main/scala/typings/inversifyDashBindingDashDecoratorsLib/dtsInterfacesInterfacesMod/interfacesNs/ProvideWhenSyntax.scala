...
trait ProvideWhenSyntax[T] extends ProvideDoneSyntax {
  def when(constraint: js.Function1[/* request */ stdLib.Request, scala.Boolean]): ProvideOnSyntax[T] = js.native
  ...
  def whenAnyAncestorMatches(constraint: js.Function1[/* request */ stdLib.Request, scala.Boolean]): ProvideOnSyntax[T] = js.native
  ...
  def whenNoAncestorMatches(constraint: js.Function1[/* request */ stdLib.Request, scala.Boolean]): ProvideOnSyntax[T] = js.native
