...
object autoWireMod {
  ...
  @scala.inline
  def default(container: Container, modules: js.Any*): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(container.asInstanceOf[js.Any], modules.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
