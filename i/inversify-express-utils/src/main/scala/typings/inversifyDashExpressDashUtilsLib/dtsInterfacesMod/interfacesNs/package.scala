...
package object interfacesNs {
  ...
  type Middleware = (/* import warning: QualifyReferences.resolveTypeRef Couldn't qualify inversifyInterfaces.ServiceIdentifier<any> */ js.Any) | expressLib.expressMod.eNs.RequestHandler
}
