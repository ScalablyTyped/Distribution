package typings.istanbulDashLibDashInstrument
...
import typings.babelDashTypes.babelDashTypesMod.AssignmentProperty
...
import typings.babelDashTypes.babelDashTypesMod.Comment
...
import typings.babelDashTypes.babelDashTypesMod.FlowTypeAnnotation
...
import typings.babelDashTypes.babelDashTypesMod.ReactHelpers
...
import typings.babelDashTypes.babelDashTypesMod.TSEntityName
import typings.babelDashTypes.babelDashTypesMod.TSEnumMember
import typings.babelDashTypes.babelDashTypesMod.TSExpressionWithTypeArguments
import typings.babelDashTypes.babelDashTypesMod.TSExternalModuleReference
import typings.babelDashTypes.babelDashTypesMod.TSInterfaceBody
import typings.babelDashTypes.babelDashTypesMod.TSModuleBlock
import typings.babelDashTypes.babelDashTypesMod.TSThisType
import typings.babelDashTypes.babelDashTypesMod.TSType
import typings.babelDashTypes.babelDashTypesMod.TSTypeAnnotation
import typings.babelDashTypes.babelDashTypesMod.TSTypeElement
import typings.babelDashTypes.babelDashTypesMod.TSTypeParameter
import typings.babelDashTypes.babelDashTypesMod.TSTypeParameterInstantiation
...
import typings.babelDashTypes.babelDashTypesMod.TypeParameter
...
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.Ampersand
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.AmpersandAmpersand
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.Asterisk
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.AsteriskAsterisk
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.EqualssignEqualssign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.EqualssignEqualssignEqualssign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.Exclamationmark
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.ExclamationmarkEqualssign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.ExclamationmarkEqualssignEqualssign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.Greaterthansign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.GreaterthansignEqualssign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.GreaterthansignGreaterthansign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.GreaterthansignGreaterthansignGreaterthansign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.Lessthansign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.LessthansignEqualssign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.LessthansignLessthansign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.Percentsign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.Plussign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.PlussignPlussign
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.Slash
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.Tilde
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.Verticalline
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.VerticallineVerticalline
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.^
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.`--`
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.`-_`
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.`var`
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.const
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.constructor
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.delete
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.get
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.in
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.instanceof
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.let
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.method
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.set
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.typeof
import typings.istanbulDashLibDashInstrument.istanbulDashLibDashInstrumentStrings.void
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait TypeofbabelTypes extends js.Object {
  val react: ReactHelpers = js.native
  def TSAnyKeyword(): typings.babelDashTypes.babelDashTypesMod.TSAnyKeyword = js.native
  def TSArrayType(elementType: TSType): typings.babelDashTypes.babelDashTypesMod.TSArrayType = js.native
  def TSAsExpression(expression: Expression, typeAnnotation: TSType): typings.babelDashTypes.babelDashTypesMod.TSAsExpression = js.native
  def TSBooleanKeyword(): typings.babelDashTypes.babelDashTypesMod.TSBooleanKeyword = js.native
  def TSCallSignatureDeclaration(): typings.babelDashTypes.babelDashTypesMod.TSCallSignatureDeclaration = js.native
  def TSCallSignatureDeclaration(typeParameters: TypeParameterDeclaration): typings.babelDashTypes.babelDashTypesMod.TSCallSignatureDeclaration = js.native
  def TSCallSignatureDeclaration(typeParameters: TypeParameterDeclaration, parameters: js.Array[Identifier | RestElement]): typings.babelDashTypes.babelDashTypesMod.TSCallSignatureDeclaration = js.native
  def TSCallSignatureDeclaration(
    typeParameters: TypeParameterDeclaration,
    parameters: js.Array[Identifier | RestElement],
    typeAnnotation: TSTypeAnnotation
  ): typings.babelDashTypes.babelDashTypesMod.TSCallSignatureDeclaration = js.native
  ...
  def TSConstructorType(): typings.babelDashTypes.babelDashTypesMod.TSConstructorType = js.native
  def TSConstructorType(typeParameters: TypeParameterDeclaration): typings.babelDashTypes.babelDashTypesMod.TSConstructorType = js.native
  def TSConstructorType(typeParameters: TypeParameterDeclaration, typeAnnotation: TSTypeAnnotation): typings.babelDashTypes.babelDashTypesMod.TSConstructorType = js.native
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: js.UndefOr[scala.Nothing], params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  ...
  ): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: Null, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: Noop, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: TypeParameterDeclaration, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: js.UndefOr[scala.Nothing], params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: Null, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: Noop, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: TypeParameterDeclaration, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier, typeParameters: js.UndefOr[scala.Nothing], params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier, typeParameters: Null, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier, typeParameters: Noop, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier, typeParameters: TypeParameterDeclaration, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareFunction = js.native
  def TSDeclareMethod(
    decorators: js.UndefOr[scala.Nothing],
    key: Expression,
    typeParameters: js.UndefOr[scala.Nothing],
    params: js.Array[LVal]
  ): typings.babelDashTypes.babelDashTypesMod.TSDeclareMethod = js.native
  def TSDeclareMethod(
  ...
  def TSDeclareMethod(decorators: js.Array[Decorator], key: Expression, typeParameters: Null, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareMethod = js.native
  def TSDeclareMethod(decorators: js.Array[Decorator], key: Expression, typeParameters: Noop, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareMethod = js.native
  def TSDeclareMethod(
    decorators: js.Array[Decorator],
    key: Expression,
    typeParameters: TypeParameterDeclaration,
  ...
  def TSDeclareMethod(decorators: Null, key: Expression, typeParameters: Null, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareMethod = js.native
  def TSDeclareMethod(decorators: Null, key: Expression, typeParameters: Noop, params: js.Array[LVal]): typings.babelDashTypes.babelDashTypesMod.TSDeclareMethod = js.native
  def TSDeclareMethod(
    decorators: Null,
    key: Expression,
    typeParameters: TypeParameterDeclaration,
  ...
  def TSEnumDeclaration(id: Identifier, members: js.Array[TSEnumMember]): typings.babelDashTypes.babelDashTypesMod.TSEnumDeclaration = js.native
  def TSEnumMember(id: Identifier): typings.babelDashTypes.babelDashTypesMod.TSEnumMember = js.native
  def TSEnumMember(id: Identifier, initializer: Expression): typings.babelDashTypes.babelDashTypesMod.TSEnumMember = js.native
  def TSEnumMember(id: StringLiteral): typings.babelDashTypes.babelDashTypesMod.TSEnumMember = js.native
  def TSEnumMember(id: StringLiteral, initializer: Expression): typings.babelDashTypes.babelDashTypesMod.TSEnumMember = js.native
  def TSExportAssignment(expression: Expression): typings.babelDashTypes.babelDashTypesMod.TSExportAssignment = js.native
  def TSExpressionWithTypeArguments(expression: TSEntityName): typings.babelDashTypes.babelDashTypesMod.TSExpressionWithTypeArguments = js.native
  def TSExpressionWithTypeArguments(expression: TSEntityName, typeParameters: TypeParameterInstantiation): typings.babelDashTypes.babelDashTypesMod.TSExpressionWithTypeArguments = js.native
  def TSExternalModuleReference(expression: StringLiteral): typings.babelDashTypes.babelDashTypesMod.TSExternalModuleReference = js.native
  def TSFunctionType(): typings.babelDashTypes.babelDashTypesMod.TSFunctionType = js.native
  def TSFunctionType(typeParameters: TypeParameterDeclaration): typings.babelDashTypes.babelDashTypesMod.TSFunctionType = js.native
  def TSFunctionType(typeParameters: TypeParameterDeclaration, typeAnnotation: TSTypeAnnotation): typings.babelDashTypes.babelDashTypesMod.TSFunctionType = js.native
  def TSImportEqualsDeclaration(id: Identifier, moduleReference: TSEntityName): typings.babelDashTypes.babelDashTypesMod.TSImportEqualsDeclaration = js.native
  def TSImportEqualsDeclaration(id: Identifier, moduleReference: TSExternalModuleReference): typings.babelDashTypes.babelDashTypesMod.TSImportEqualsDeclaration = js.native
  def TSIndexSignature(parameters: js.Array[Identifier]): typings.babelDashTypes.babelDashTypesMod.TSIndexSignature = js.native
  def TSIndexSignature(parameters: js.Array[Identifier], typeAnnotation: TSTypeAnnotation): typings.babelDashTypes.babelDashTypesMod.TSIndexSignature = js.native
  def TSIndexedAccessType(objectType: TSType, indexType: TSType): typings.babelDashTypes.babelDashTypesMod.TSIndexedAccessType = js.native
  def TSInterfaceBody(body: js.Array[TSTypeElement]): typings.babelDashTypes.babelDashTypesMod.TSInterfaceBody = js.native
  def TSInterfaceDeclaration(
    id: Identifier,
    typeParameters: js.UndefOr[scala.Nothing],
    extends_ : js.UndefOr[scala.Nothing],
    body: TSInterfaceBody
  ): typings.babelDashTypes.babelDashTypesMod.TSInterfaceDeclaration = js.native
  def TSInterfaceDeclaration(
    id: Identifier,
    typeParameters: js.UndefOr[scala.Nothing],
  ...
  def TSInterfaceDeclaration(id: Identifier, typeParameters: js.UndefOr[scala.Nothing], extends_ : Null, body: TSInterfaceBody): typings.babelDashTypes.babelDashTypesMod.TSInterfaceDeclaration = js.native
  def TSInterfaceDeclaration(id: Identifier, typeParameters: Null, extends_ : js.UndefOr[scala.Nothing], body: TSInterfaceBody): typings.babelDashTypes.babelDashTypesMod.TSInterfaceDeclaration = js.native
  def TSInterfaceDeclaration(
    id: Identifier,
    typeParameters: Null,
    extends_ : js.Array[TSExpressionWithTypeArguments],
  ...
  def TSInterfaceDeclaration(id: Identifier, typeParameters: Null, extends_ : Null, body: TSInterfaceBody): typings.babelDashTypes.babelDashTypesMod.TSInterfaceDeclaration = js.native
  def TSInterfaceDeclaration(
    id: Identifier,
    typeParameters: TypeParameterDeclaration,
    extends_ : js.UndefOr[scala.Nothing],
  ...
  def TSInterfaceDeclaration(id: Identifier, typeParameters: TypeParameterDeclaration, extends_ : Null, body: TSInterfaceBody): typings.babelDashTypes.babelDashTypesMod.TSInterfaceDeclaration = js.native
  def TSIntersectionType(types: js.Array[TSType]): typings.babelDashTypes.babelDashTypesMod.TSIntersectionType = js.native
  def TSLiteralType(literal: BooleanLiteral): typings.babelDashTypes.babelDashTypesMod.TSLiteralType = js.native
  def TSLiteralType(literal: NumericLiteral): typings.babelDashTypes.babelDashTypesMod.TSLiteralType = js.native
  def TSLiteralType(literal: StringLiteral): typings.babelDashTypes.babelDashTypesMod.TSLiteralType = js.native
  def TSMappedType(typeParameter: TypeParameter): typings.babelDashTypes.babelDashTypesMod.TSMappedType = js.native
  def TSMappedType(typeParameter: TypeParameter, typeAnnotation: TSType): typings.babelDashTypes.babelDashTypesMod.TSMappedType = js.native
  def TSMethodSignature(key: Expression): typings.babelDashTypes.babelDashTypesMod.TSMethodSignature = js.native
  def TSMethodSignature(key: Expression, typeParameters: TypeParameterDeclaration): typings.babelDashTypes.babelDashTypesMod.TSMethodSignature = js.native
  def TSMethodSignature(
    key: Expression,
    typeParameters: TypeParameterDeclaration,
    parameters: js.Array[Identifier | RestElement]
  ): typings.babelDashTypes.babelDashTypesMod.TSMethodSignature = js.native
  def TSMethodSignature(
    key: Expression,
    typeParameters: TypeParameterDeclaration,
    parameters: js.Array[Identifier | RestElement],
  ...
  def TSModuleBlock(body: js.Array[Statement]): typings.babelDashTypes.babelDashTypesMod.TSModuleBlock = js.native
  def TSModuleDeclaration(id: Identifier, body: TSModuleBlock): typings.babelDashTypes.babelDashTypesMod.TSModuleDeclaration = js.native
  def TSModuleDeclaration(id: Identifier, body: typings.babelDashTypes.babelDashTypesMod.TSModuleDeclaration): typings.babelDashTypes.babelDashTypesMod.TSModuleDeclaration = js.native
  def TSModuleDeclaration(id: StringLiteral, body: TSModuleBlock): typings.babelDashTypes.babelDashTypesMod.TSModuleDeclaration = js.native
  def TSModuleDeclaration(id: StringLiteral, body: typings.babelDashTypes.babelDashTypesMod.TSModuleDeclaration): typings.babelDashTypes.babelDashTypesMod.TSModuleDeclaration = js.native
  def TSNamespaceExportDeclaration(id: Identifier): typings.babelDashTypes.babelDashTypesMod.TSNamespaceExportDeclaration = js.native
  def TSNeverKeyword(): typings.babelDashTypes.babelDashTypesMod.TSNeverKeyword = js.native
  def TSNonNullExpression(expression: Expression): typings.babelDashTypes.babelDashTypesMod.TSNonNullExpression = js.native
  def TSNullKeyword(): typings.babelDashTypes.babelDashTypesMod.TSNullKeyword = js.native
  def TSNumberKeyword(): typings.babelDashTypes.babelDashTypesMod.TSNumberKeyword = js.native
  def TSObjectKeyword(): typings.babelDashTypes.babelDashTypesMod.TSObjectKeyword = js.native
  def TSParameterProperty(parameter: AssignmentPattern): typings.babelDashTypes.babelDashTypesMod.TSParameterProperty = js.native
  def TSParameterProperty(parameter: Identifier): typings.babelDashTypes.babelDashTypesMod.TSParameterProperty = js.native
  def TSParenthesizedType(typeAnnotation: TSType): typings.babelDashTypes.babelDashTypesMod.TSParenthesizedType = js.native
  def TSPropertySignature(key: Expression): typings.babelDashTypes.babelDashTypesMod.TSPropertySignature = js.native
  def TSPropertySignature(key: Expression, typeAnnotation: TSTypeAnnotation): typings.babelDashTypes.babelDashTypesMod.TSPropertySignature = js.native
  def TSPropertySignature(key: Expression, typeAnnotation: TSTypeAnnotation, initializer: Expression): typings.babelDashTypes.babelDashTypesMod.TSPropertySignature = js.native
  def TSQualifiedName(left: TSEntityName, right: Identifier): typings.babelDashTypes.babelDashTypesMod.TSQualifiedName = js.native
  def TSStringKeyword(): typings.babelDashTypes.babelDashTypesMod.TSStringKeyword = js.native
  def TSSymbolKeyword(): typings.babelDashTypes.babelDashTypesMod.TSSymbolKeyword = js.native
  def TSThisType(): typings.babelDashTypes.babelDashTypesMod.TSThisType = js.native
  def TSTupleType(elementTypes: js.Array[TSType]): typings.babelDashTypes.babelDashTypesMod.TSTupleType = js.native
  def TSTypeAliasDeclaration(id: Identifier, typeParameters: js.UndefOr[scala.Nothing], typeAnnotation: TSType): typings.babelDashTypes.babelDashTypesMod.TSTypeAliasDeclaration = js.native
  def TSTypeAliasDeclaration(id: Identifier, typeParameters: Null, typeAnnotation: TSType): typings.babelDashTypes.babelDashTypesMod.TSTypeAliasDeclaration = js.native
  def TSTypeAliasDeclaration(id: Identifier, typeParameters: TypeParameterDeclaration, typeAnnotation: TSType): typings.babelDashTypes.babelDashTypesMod.TSTypeAliasDeclaration = js.native
  def TSTypeAnnotation(typeAnnotation: TSType): typings.babelDashTypes.babelDashTypesMod.TSTypeAnnotation = js.native
  def TSTypeAssertion(typeAnnotation: TSType, expression: Expression): typings.babelDashTypes.babelDashTypesMod.TSTypeAssertion = js.native
  def TSTypeLiteral(members: js.Array[TSTypeElement]): typings.babelDashTypes.babelDashTypesMod.TSTypeLiteral = js.native
  def TSTypeOperator(typeAnnotation: TSType): typings.babelDashTypes.babelDashTypesMod.TSTypeOperator = js.native
  def TSTypeParameter(): typings.babelDashTypes.babelDashTypesMod.TSTypeParameter = js.native
  def TSTypeParameter(constraint: TSType): typings.babelDashTypes.babelDashTypesMod.TSTypeParameter = js.native
  def TSTypeParameter(constraint: TSType, default_ : TSType): typings.babelDashTypes.babelDashTypesMod.TSTypeParameter = js.native
  def TSTypeParameterDeclaration(params: js.Array[TSTypeParameter]): typings.babelDashTypes.babelDashTypesMod.TSTypeParameterDeclaration = js.native
  def TSTypeParameterInstantiation(params: js.Array[TSType]): typings.babelDashTypes.babelDashTypesMod.TSTypeParameterInstantiation = js.native
  def TSTypePredicate(parameterName: Identifier, typeAnnotation: TSTypeAnnotation): typings.babelDashTypes.babelDashTypesMod.TSTypePredicate = js.native
  def TSTypePredicate(parameterName: TSThisType, typeAnnotation: TSTypeAnnotation): typings.babelDashTypes.babelDashTypesMod.TSTypePredicate = js.native
  def TSTypeQuery(exprName: TSEntityName): typings.babelDashTypes.babelDashTypesMod.TSTypeQuery = js.native
  def TSTypeReference(typeName: TSEntityName): typings.babelDashTypes.babelDashTypesMod.TSTypeReference = js.native
  def TSTypeReference(typeName: TSEntityName, typeParameters: TSTypeParameterInstantiation): typings.babelDashTypes.babelDashTypesMod.TSTypeReference = js.native
  def TSUndefinedKeyword(): typings.babelDashTypes.babelDashTypesMod.TSUndefinedKeyword = js.native
  def TSUnionType(types: js.Array[TSType]): typings.babelDashTypes.babelDashTypesMod.TSUnionType = js.native
  def TSVoidKeyword(): typings.babelDashTypes.babelDashTypesMod.TSVoidKeyword = js.native
  ...
  def arrowFunctionExpression(params: js.Array[LVal], body: BlockStatement, async: Boolean): ArrowFunctionExpression = js.native
  def arrowFunctionExpression(params: js.Array[LVal], body: Expression): ArrowFunctionExpression = js.native
  def arrowFunctionExpression(params: js.Array[LVal], body: Expression, async: Boolean): ArrowFunctionExpression = js.native
  ...
  def assertExistentialTypeParam(node: js.UndefOr[scala.Nothing], opts: js.Object): Unit = js.native
  def assertExistentialTypeParam(node: js.Object): Unit = js.native
  def assertExistentialTypeParam(node: js.Object, opts: js.Object): Unit = js.native
  def assertExistentialTypeParam(node: Null, opts: js.Object): Unit = js.native
  ...
  def assertNumericLiteralTypeAnnotation(node: js.UndefOr[scala.Nothing], opts: js.Object): Unit = js.native
  def assertNumericLiteralTypeAnnotation(node: js.Object): Unit = js.native
  def assertNumericLiteralTypeAnnotation(node: js.Object, opts: js.Object): Unit = js.native
  def assertNumericLiteralTypeAnnotation(node: Null, opts: js.Object): Unit = js.native
  ...
  def assignmentExpression(operator: String): AssignmentExpression = js.native
  def assignmentExpression(operator: String, left: LVal): AssignmentExpression = js.native
  ...
  def functionDeclaration(id: Identifier, params: js.Array[LVal], body: BlockStatement, generator: Boolean): FunctionDeclaration = js.native
  def functionDeclaration(id: Identifier, params: js.Array[LVal], body: BlockStatement, generator: Boolean, async: Boolean): FunctionDeclaration = js.native
  ...
  def functionExpression(id: Identifier, params: js.Array[LVal], body: BlockStatement, generator: Boolean): FunctionExpression = js.native
  def functionExpression(id: Identifier, params: js.Array[LVal], body: BlockStatement, generator: Boolean, async: Boolean): FunctionExpression = js.native
  ...
  def isBindingIdentifier(node: js.UndefOr[scala.Nothing], opts: js.Object): /* is babel-types.babel-types.Identifier */ Boolean = js.native
  ...
  def isExistentialTypeParam(node: js.UndefOr[scala.Nothing], opts: js.Object): /* is babel-types.babel-types.ExistentialTypeParam */ Boolean = js.native
  ...
  def isNumericLiteralTypeAnnotation(node: js.UndefOr[scala.Nothing], opts: js.Object): /* is babel-types.babel-types.NumericLiteralTypeAnnotation */ Boolean = js.native
  ...
  def isReferencedMemberExpression(node: js.UndefOr[scala.Nothing], opts: js.Object): /* is babel-types.babel-types.MemberExpression */ Boolean = js.native
  ...
  def isRestProperty(node: js.UndefOr[scala.Nothing], opts: js.Object): /* is babel-types.babel-types.RestProperty */ Boolean = js.native
  ...
  def isScope(node: js.UndefOr[scala.Nothing], opts: js.Object): /* is babel-types.babel-types.Scopable */ Boolean = js.native
  ...
  def isSpreadProperty(node: js.UndefOr[scala.Nothing], opts: js.Object): /* is babel-types.babel-types.SpreadProperty */ Boolean = js.native
  ...
  def isTSConstructSignatureDeclaration(node: js.UndefOr[scala.Nothing], opts: js.Object): /* is babel-types.babel-types.TSTypeElement */ Boolean = js.native
  ...
  def isVar(node: js.UndefOr[scala.Nothing], opts: js.Object): /* is babel-types.babel-types.VariableDeclaration */ Boolean = js.native
  ...
  def jSXOpeningElement(name: JSXIdentifier, attributes: js.Array[JSXAttribute], selfClosing: Boolean): JSXOpeningElement = js.native
  ...
  def jSXOpeningElement(name: JSXMemberExpression, attributes: js.Array[JSXAttribute], selfClosing: Boolean): JSXOpeningElement = js.native
  ...
  def memberExpression(`object`: Expression, property: Expression, computed: Boolean): MemberExpression = js.native
  ...
  def memberExpression(`object`: Super, property: Expression, computed: Boolean): MemberExpression = js.native
  def metaProperty(): MetaProperty = js.native
  def metaProperty(meta: String): MetaProperty = js.native
  def metaProperty(meta: String, property: String): MetaProperty = js.native
  ...
  @JSName("objectMethod")
  def objectMethod_get(kind: get): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_get(kind: get, key: Expression): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_get(kind: get, key: Expression, params: js.Array[LVal]): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_get(kind: get, key: Expression, params: js.Array[LVal], body: BlockStatement): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_get(kind: get, key: Expression, params: js.Array[LVal], body: BlockStatement, computed: Boolean): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_method(kind: method): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_method(kind: method, key: Expression): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_method(kind: method, key: Expression, params: js.Array[LVal]): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_method(kind: method, key: Expression, params: js.Array[LVal], body: BlockStatement): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_method(kind: method, key: Expression, params: js.Array[LVal], body: BlockStatement, computed: Boolean): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_set(kind: set): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_set(kind: set, key: Expression): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_set(kind: set, key: Expression, params: js.Array[LVal]): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_set(kind: set, key: Expression, params: js.Array[LVal], body: BlockStatement): ObjectMethod = js.native
  @JSName("objectMethod")
  def objectMethod_set(kind: set, key: Expression, params: js.Array[LVal], body: BlockStatement, computed: Boolean): ObjectMethod = js.native
  ...
  def objectProperty(key: Expression, value: Expression, computed: Boolean): ObjectProperty = js.native
  def objectProperty(key: Expression, value: Expression, computed: Boolean, shorthand: Boolean): ObjectProperty = js.native
  def objectProperty(
    key: Expression,
    value: Expression,
    computed: Boolean,
  ...
  def templateElement(value: Anon_CookedRaw): TemplateElement = js.native
  def templateElement(value: Anon_CookedRaw, tail: Boolean): TemplateElement = js.native
  ...
  @JSName("unaryExpression")
  def unaryExpression_typeof(operator: typeof): UnaryExpression = js.native
  @JSName("unaryExpression")
  ...
  @JSName("unaryExpression")
  def unaryExpression_void(operator: void): UnaryExpression = js.native
  @JSName("unaryExpression")
