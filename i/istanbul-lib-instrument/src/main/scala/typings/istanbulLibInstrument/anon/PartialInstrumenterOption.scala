...
object PartialInstrumenterOption {
  ...
  def apply(
    ...
    if (!js.isUndefined(esModules)) __obj.updateDynamic("esModules")(esModules.get.asInstanceOf[js.Any])
    if (!js.isUndefined(preserveComments)) __obj.updateDynamic("preserveComments")(preserveComments.get.asInstanceOf[js.Any])
    if (!js.isUndefined(produceSourceMap)) __obj.updateDynamic("produceSourceMap")(produceSourceMap.get.asInstanceOf[js.Any])
