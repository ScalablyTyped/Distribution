...
object ^ extends js.Object {
  ...
  def isValid(isbn: java.lang.String, groups: isbnDashUtilsLib.isbnDashUtilsMod.IGroups): scala.Boolean = js.native
  def parse(isbn: java.lang.String): isbnDashUtilsLib.isbnDashUtilsMod.ISBN | scala.Null = js.native
  def parse(isbn: java.lang.String, groups: isbnDashUtilsLib.isbnDashUtilsMod.IGroups): isbnDashUtilsLib.isbnDashUtilsMod.ISBN | scala.Null = js.native
}
