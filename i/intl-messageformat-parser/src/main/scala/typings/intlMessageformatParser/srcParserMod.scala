...
object srcParserMod {
  ...
  */
  ...
  object Expectation {
    ...
    inline def IAnyExpectation(): typings.intlMessageformatParser.srcParserMod.IAnyExpectation = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("any")
      __obj.asInstanceOf[typings.intlMessageformatParser.srcParserMod.IAnyExpectation]
    }
    
    inline def IClassExpectation(ignoreCase: Boolean, inverted: Boolean, parts: IClassParts): typings.intlMessageformatParser.srcParserMod.IClassExpectation = {
    ...
    inline def IEndExpectation(): typings.intlMessageformatParser.srcParserMod.IEndExpectation = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("end")
      __obj.asInstanceOf[typings.intlMessageformatParser.srcParserMod.IEndExpectation]
    }
    
    inline def ILiteralExpectation(ignoreCase: Boolean, text: String): typings.intlMessageformatParser.srcParserMod.ILiteralExpectation = {
    ...
    inline def IOtherExpectation(description: String): typings.intlMessageformatParser.srcParserMod.IOtherExpectation = {
