...
object Skeleton {
  ...
  inline def DateTimeSkeleton(parsedOptions: DateTimeFormatOptions, pattern: String): typings.intlMessageformatParser.typesMod.DateTimeSkeleton = {
  ...
  inline def NumberSkeleton(parsedOptions: NumberFormatOptions, tokens: js.Array[NumberSkeletonToken]): typings.intlMessageformatParser.typesMod.NumberSkeleton = {
