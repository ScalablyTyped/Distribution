...
object _MessageFormatElement {
  ...
  inline def PoundElement(`type`: pound): typings.intlMessageformatParser.srcTypesMod.PoundElement = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.intlMessageformatParser.srcTypesMod.PoundElement]
  }
  
  inline def SelectElement(options: Record[String, PluralOrSelectOption], `type`: select, value: String): typings.intlMessageformatParser.srcTypesMod.SelectElement = {
  ...
  inline def TagElement(children: js.Array[MessageFormatElement], `type`: tag, value: String): typings.intlMessageformatParser.srcTypesMod.TagElement = {
