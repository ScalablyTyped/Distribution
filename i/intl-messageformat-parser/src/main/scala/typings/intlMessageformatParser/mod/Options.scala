...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(captureLocation)) __obj.updateDynamic("captureLocation")(captureLocation.get.asInstanceOf[js.Any])
    if (!js.isUndefined(normalizeHashtagInPlural)) __obj.updateDynamic("normalizeHashtagInPlural")(normalizeHashtagInPlural.get.asInstanceOf[js.Any])
