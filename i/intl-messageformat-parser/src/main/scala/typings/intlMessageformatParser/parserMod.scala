...
object parserMod {
  ...
  */
  ...
  object Expectation {
    ...
    @scala.inline
    def IAnyExpectation(`type`: any): typings.intlMessageformatParser.parserMod.IAnyExpectation = {
    ...
    @scala.inline
    def IClassExpectation(ignoreCase: Boolean, inverted: Boolean, parts: IClassParts, `type`: `class`): typings.intlMessageformatParser.parserMod.IClassExpectation = {
    ...
    @scala.inline
    def IEndExpectation(`type`: end): typings.intlMessageformatParser.parserMod.IEndExpectation = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    ...
    @scala.inline
    def ILiteralExpectation(ignoreCase: Boolean, text: String, `type`: literal): typings.intlMessageformatParser.parserMod.ILiteralExpectation = {
    ...
    @scala.inline
    def IOtherExpectation(description: String, `type`: other): typings.intlMessageformatParser.parserMod.IOtherExpectation = {
