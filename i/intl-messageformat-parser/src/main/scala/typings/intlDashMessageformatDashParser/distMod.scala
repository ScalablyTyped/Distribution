...
import typings.intlDashMessageformatDashParser.distSkeletonMod.ExtendedDateTimeFormatOptions
import typings.intlDashMessageformatDashParser.distTypesMod.DateTimeSkeleton
...
import typings.intlDashMessageformatDashParser.distTypesMod.NumberSkeleton
...
object distMod extends js.Object {
  ...
  def isDateTimeSkeleton(): /* is intl-messageformat-parser.intl-messageformat-parser/dist/types.DateTimeSkeleton */ Boolean = js.native
  def isDateTimeSkeleton(el: DateTimeSkeleton | String): /* is intl-messageformat-parser.intl-messageformat-parser/dist/types.DateTimeSkeleton */ Boolean = js.native
  ...
  def isNumberSkeleton(): /* is intl-messageformat-parser.intl-messageformat-parser/dist/types.NumberSkeleton */ Boolean = js.native
  def isNumberSkeleton(el: String): /* is intl-messageformat-parser.intl-messageformat-parser/dist/types.NumberSkeleton */ Boolean = js.native
  def isNumberSkeleton(el: NumberSkeleton): /* is intl-messageformat-parser.intl-messageformat-parser/dist/types.NumberSkeleton */ Boolean = js.native
