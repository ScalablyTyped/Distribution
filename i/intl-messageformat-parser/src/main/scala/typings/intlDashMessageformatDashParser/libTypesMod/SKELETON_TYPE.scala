...
/* Rewritten from type alias, can be one of: 
  - typings.intlDashMessageformatDashParser.intlDashMessageformatDashParserNumbers.`0`
  - typings.intlDashMessageformatDashParser.intlDashMessageformatDashParserNumbers.`1`
*/
