...
object NullableNumberSchema {
  ...
  @scala.inline
  implicit class NullableNumberSchemaOps[Self <: NullableNumberSchema] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTypeVarargs(value: (number | `null`)*): Self = this.set("type", js.Array(value :_*))
    
    @scala.inline
    def setType(value: js.Array[number | `null`]): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
