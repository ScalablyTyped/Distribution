...
object ObjectSchema {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ObjectSchema[?, ?], Properties /* <: Record[String, AnySchema] */, Required /* <: StringKeys[Properties] */] (val x: Self & (ObjectSchema[Properties, Required])) extends AnyVal {
