...
object mod {
  ...
  inline def default[T](source: js.Iterable[T], fn: js.Function1[/* thing */ T, Unit | js.Promise[Unit]]): AsyncGenerator[T, Unit, Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(source.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[AsyncGenerator[T, Unit, Unit]]
