...
object global {
  ...
  inline def ineum_allowedOrigins(command: allowedOrigins, values: js.Array[RegExp]): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def ineum_beaconBatchingTime(command: beaconBatchingTime, durationMillis: Double): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], durationMillis.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def ineum_ignoreErrorMessages(command: ignoreErrorMessages, values: js.Array[RegExp]): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def ineum_ignorePings(command: ignorePings, value: Boolean): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def ineum_ignoreUrls(command: ignoreUrls, values: js.Array[RegExp]): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def ineum_ignoreUserTimings(command: ignoreUserTimings, values: js.Array[RegExp]): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def ineum_key(command: key, value: String): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def ineum_maxMaitForPageLoadMetricsMillis(command: maxMaitForPageLoadMetricsMillis, durationMillis: Double): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], durationMillis.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def ineum_maxWaitForResourceTimingsMillis(command: maxWaitForResourceTimingsMillis, durationMillis: Double): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], durationMillis.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def ineum_page(command: page, value: String): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def ineum_reportError(command: reportError, error: Error): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], error.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def ineum_reportError(command: reportError, error: Error, opts: ComponentStack): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], error.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def ineum_reportingUrl(command: reportingUrl, value: String): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def ineum_traceId(command: traceId, value: String): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def ineum_urlsToCheckForGraphQlInsights(command: urlsToCheckForGraphQlInsights, values: js.Array[RegExp]): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  // tslint:disable-next-line unified-signatures
  inline def ineum_whitelistedOrigins(command: whitelistedOrigins, values: js.Array[RegExp]): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def ineum_wrapEventHandlers(command: wrapEventHandlers, value: Boolean): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def ineum_wrapTimers(command: wrapTimers, value: Boolean): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def ineum_xhrTransmissionTimeout(command: xhrTransmissionTimeout, durationMillis: Double): Unit = (js.Dynamic.global.applyDynamic("ineum")(command.asInstanceOf[js.Any], durationMillis.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
