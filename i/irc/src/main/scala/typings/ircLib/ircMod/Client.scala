...
class Client protected ()
  ...
  def this(server: java.lang.String, nick: java.lang.String, opts: IClientOpts) = this()
  ...
  def connect(retryCount: ircLib.ircMod.handlersNs.IRaw): scala.Unit = js.native
  def connect(retryCount: ircLib.ircMod.handlersNs.IRaw, callback: ircLib.ircMod.handlersNs.IRaw): scala.Unit = js.native
  def connect(retryCount: scala.Double): scala.Unit = js.native
  def connect(retryCount: scala.Double, callback: ircLib.ircMod.handlersNs.IRaw): scala.Unit = js.native
  /**
  ...
  def join(channel: java.lang.String, callback: ircLib.ircMod.handlersNs.IJoinChannel): scala.Unit = js.native
  /**
  ...
  def part(
    ...
    callback: ircLib.ircMod.handlersNs.IPartChannel
  ...
  /**
    ...
    * @param callback
    */
  def whois(nick: java.lang.String, callback: ircLib.ircMod.handlersNs.IWhois): scala.Unit = js.native
}
