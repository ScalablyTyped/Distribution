...
package object handlersNs {
  ...
  type IChannelList = js.Function1[/* list */ js.Array[ircLib.ircMod.NodeIRCNs.IChannel], scala.Unit]
  ...
  type IError = js.Function1[/* message */ ircLib.ircMod.NodeIRCNs.IMessage, scala.Unit]
  ...
  type IJoinChannel = js.Function2[
    /* nick */ java.lang.String, 
    /* message */ ircLib.ircMod.NodeIRCNs.IMessage, 
    scala.Unit
  ]
  ...
  type IRaw = js.Function1[/* message */ ircLib.ircMod.NodeIRCNs.IMessage, scala.Unit]
  ...
  type IRegistered = js.Function1[/* message */ ircLib.ircMod.NodeIRCNs.IMessage, scala.Unit]
  ...
  type IWhois = js.Function1[/* info */ ircLib.ircMod.NodeIRCNs.IWhoisData, scala.Unit]
}
