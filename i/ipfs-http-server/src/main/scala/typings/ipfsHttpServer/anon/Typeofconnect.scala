...
trait Typeofconnect extends StObject {
...
object Typeofconnect {
  ...
  @scala.inline
  def apply(handler: (js.Any, js.Any) => js.Promise[js.Any], options_6: Typeofoptions6): Typeofconnect = {
  ...
  @scala.inline
  implicit class TypeofconnectMutableBuilder[Self <: Typeofconnect] (val x: Self) extends AnyVal {
