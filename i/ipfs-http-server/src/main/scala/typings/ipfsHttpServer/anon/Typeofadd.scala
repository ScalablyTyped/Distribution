...
object Typeofadd {
  ...
  @scala.inline
  def apply(handler: (js.Any, js.Any) => js.Promise[js.Any], options_2: Typeofoptions2): Typeofadd = {
  ...
  @scala.inline
  implicit class TypeofaddMutableBuilder[Self <: Typeofadd] (val x: Self) extends AnyVal {
