...
@js.native
trait Typeofadd extends js.Object {
...
object Typeofadd {
  ...
  @scala.inline
  def apply(handler: (js.Any, js.Any) => js.Promise[_], options_2: Typeofoptions2): Typeofadd = {
  ...
  @scala.inline
  implicit class TypeofaddOps[Self <: Typeofadd] (val x: Self) extends AnyVal {
