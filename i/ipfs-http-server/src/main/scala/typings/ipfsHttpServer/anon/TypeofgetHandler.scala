...
object TypeofgetHandler {
  ...
  @scala.inline
  def apply(handler: (js.Any, js.Any) => js.Promise[js.Any], options: TypeofoptionsPayloadValidate): TypeofgetHandler = {
  ...
  @scala.inline
  implicit class TypeofgetHandlerMutableBuilder[Self <: TypeofgetHandler] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setHandler(value: (js.Any, js.Any) => js.Promise[js.Any]): Self = StObject.set(x, "handler", js.Any.fromFunction2(value))
    
    @scala.inline
    def setOptions(value: TypeofoptionsPayloadValidate): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
  }
}
