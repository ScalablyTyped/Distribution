...
@js.native
trait TypeoffindPeer extends js.Object {
...
object TypeoffindPeer {
  ...
  @scala.inline
  def apply(handler: (js.Any, js.Any) => js.Promise[_], options: Typeofoptions): TypeoffindPeer = {
  ...
  @scala.inline
  implicit class TypeoffindPeerOps[Self <: TypeoffindPeer] (val x: Self) extends AnyVal {
