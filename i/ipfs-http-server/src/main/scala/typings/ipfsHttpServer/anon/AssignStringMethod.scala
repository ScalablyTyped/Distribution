...
@js.native
trait AssignStringMethod extends js.Object {
...
object AssignStringMethod {
  ...
  @scala.inline
  implicit class AssignStringMethodOps[Self <: AssignStringMethod] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMethod(value: (js.Any, js.Any) => js.Promise[DataAny]): Self = this.set("method", js.Any.fromFunction2(value))
  }
}
