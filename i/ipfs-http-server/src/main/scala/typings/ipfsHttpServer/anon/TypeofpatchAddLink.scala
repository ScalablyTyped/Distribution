...
object TypeofpatchAddLink {
  ...
  inline def apply(handler: (js.Any, js.Any) => js.Promise[js.Any], options_16: Typeofoptions16): TypeofpatchAddLink = {
  ...
  extension [Self <: TypeofpatchAddLink](x: Self) {
    
    inline def setHandler(value: (js.Any, js.Any) => js.Promise[js.Any]): Self = StObject.set(x, "handler", js.Any.fromFunction2(value))
    
    inline def setOptions_16(value: Typeofoptions16): Self = StObject.set(x, "options_16", value.asInstanceOf[js.Any])
  }
}
