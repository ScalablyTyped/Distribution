...
trait TypeofoptionsPayload extends StObject {
  ...
  val pre: js.Array[Method]
  
  val validate: Typeofvalidate
}
object TypeofoptionsPayload {
  
  inline def apply(payload: Typeofpayload, pre: js.Array[Method], validate: Typeofvalidate): TypeofoptionsPayload = {
  ...
  extension [Self <: TypeofoptionsPayload](x: Self) {
    
    inline def setPayload(value: Typeofpayload): Self = StObject.set(x, "payload", value.asInstanceOf[js.Any])
    
    inline def setPre(value: js.Array[Method]): Self = StObject.set(x, "pre", value.asInstanceOf[js.Any])
    
    inline def setPreVarargs(value: Method*): Self = StObject.set(x, "pre", js.Array(value :_*))
