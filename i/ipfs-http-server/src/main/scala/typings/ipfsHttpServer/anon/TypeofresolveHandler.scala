...
trait TypeofresolveHandler extends StObject {
  
  def handler(request: js.Any, h: js.Any): js.Promise[js.Any]
  
  val options: Typeofoptions
}
object TypeofresolveHandler {
  
  @scala.inline
  def apply(handler: (js.Any, js.Any) => js.Promise[js.Any], options: Typeofoptions): TypeofresolveHandler = {
    val __obj = js.Dynamic.literal(handler = js.Any.fromFunction2(handler), options = options.asInstanceOf[js.Any])
    __obj.asInstanceOf[TypeofresolveHandler]
  }
  
  @scala.inline
  implicit class TypeofresolveHandlerMutableBuilder[Self <: TypeofresolveHandler] (val x: Self) extends AnyVal {
