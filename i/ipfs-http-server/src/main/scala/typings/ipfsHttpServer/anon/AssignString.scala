...
@js.native
trait AssignString extends js.Object {
...
object AssignString {
  ...
  @scala.inline
  implicit class AssignStringOps[Self <: AssignString] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMethod(value: (js.Any, js.Any) => js.Promise[Format]): Self = this.set("method", js.Any.fromFunction2(value))
  }
}
