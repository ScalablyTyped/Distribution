...
@js.native
trait Typeofstate extends js.Object {
...
object Typeofstate {
  ...
  @scala.inline
  def apply(handler: (js.Any, js.Any) => js.Promise[_], options_4: Typeofoptions4): Typeofstate = {
  ...
  @scala.inline
  implicit class TypeofstateOps[Self <: Typeofstate] (val x: Self) extends AnyVal {
