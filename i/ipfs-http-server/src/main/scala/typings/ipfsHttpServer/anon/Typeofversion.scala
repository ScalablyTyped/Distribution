...
@js.native
trait Typeofversion extends js.Object {
...
object Typeofversion {
  ...
  @scala.inline
  def apply(handler: (js.Any, js.Any) => js.Promise[_], options_2: Typeofoptions2): Typeofversion = {
  ...
  @scala.inline
  implicit class TypeofversionOps[Self <: Typeofversion] (val x: Self) extends AnyVal {
