...
trait Typeofprovide extends StObject {
...
object Typeofprovide {
  ...
  @scala.inline
  def apply(handler: (js.Any, js.Any) => js.Promise[js.Any], options_6: Typeofoptions6): Typeofprovide = {
  ...
  @scala.inline
  implicit class TypeofprovideMutableBuilder[Self <: Typeofprovide] (val x: Self) extends AnyVal {
