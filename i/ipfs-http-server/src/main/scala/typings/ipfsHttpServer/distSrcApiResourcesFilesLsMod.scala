...
object distSrcApiResourcesFilesLsMod {
  
  object lsResource {
    
    @JSImport("ipfs-http-server/dist/src/api/resources/files/ls", "lsResource")
    @js.native
    ...
    object options {
      ...
      object validate {
        ...
        object options1 {
          ...
          @JSImport("ipfs-http-server/dist/src/api/resources/files/ls", "lsResource.options.validate.options_1.allowUnknown")
          @js.native
          val allowUnknown: Boolean = js.native
          
          @JSImport("ipfs-http-server/dist/src/api/resources/files/ls", "lsResource.options.validate.options_1.stripUnknown")
          @js.native
          val stripUnknown: Boolean = js.native
        }
        
        @JSImport("ipfs-http-server/dist/src/api/resources/files/ls", "lsResource.options.validate.query")
        @js.native
