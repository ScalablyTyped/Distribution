...
object routesVersionMod {
  
  @JSImport("ipfs-http-server/dist/src/api/routes/version", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/version", "handler")
  @js.native
  def handler(request: js.Any, h: js.Any): js.Promise[_] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/version", "method")
  @js.native
  def method: String = js.native
  @scala.inline
  def method_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("method")(x.asInstanceOf[js.Any])
  
  @JSImport("ipfs-http-server/dist/src/api/routes/version", "options")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/version", "path")
  @js.native
