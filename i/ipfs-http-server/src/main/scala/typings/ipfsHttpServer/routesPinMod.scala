...
object routesPinMod {
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "concat")
  @js.native
  def concat(items: (js.Array[Path] | Path)*): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "copyWithin")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "entries")
  @js.native
  def entries(): IterableIterator[js.Tuple2[Double, Path]] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "every")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "fill")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "filter")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "find")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "findIndex")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "forEach")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "includes")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "indexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "join")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "keys")
  @js.native
  def keys(): IterableIterator[Double] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "lastIndexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "length")
  @js.native
  def length: Double = js.native
  @scala.inline
  def length_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("length")(x.asInstanceOf[js.Any])
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "map")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "pop")
  @js.native
  def pop(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "push")
  @js.native
  def push(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "reduce")
  @js.native
  def reduce(
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "reduceRight")
  @js.native
  def reduceRight(
    callbackfn: js.Function4[
      /* previousValue */ Path, 
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "reverse")
  @js.native
  def reverse(): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "shift")
  @js.native
  def shift(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "slice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "some")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "sort")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "splice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "toLocaleString")
  @js.native
  def toLocaleString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "toString")
  @js.native
  def toString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "unshift")
  @js.native
  def unshift(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/pin", "values")
  @js.native
