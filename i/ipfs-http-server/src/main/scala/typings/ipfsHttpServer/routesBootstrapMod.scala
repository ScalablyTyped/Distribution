...
object routesBootstrapMod {
  
  @JSImport("ipfs-http-server/dist/src/api/routes/bootstrap", JSImport.Namespace)
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/bootstrap", "length")
  @js.native
