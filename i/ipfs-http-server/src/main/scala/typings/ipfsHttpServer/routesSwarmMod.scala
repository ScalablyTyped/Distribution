...
object routesSwarmMod {
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "concat")
  @js.native
  def concat(items: (js.Array[Path] | Path)*): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "copyWithin")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "entries")
  @js.native
  def entries(): IterableIterator[js.Tuple2[Double, Path]] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "every")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "fill")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "filter")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "find")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "findIndex")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "forEach")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "includes")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "indexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "join")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "keys")
  @js.native
  def keys(): IterableIterator[Double] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "lastIndexOf")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "length")
  @js.native
  def length: Double = js.native
  @scala.inline
  def length_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("length")(x.asInstanceOf[js.Any])
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "map")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "pop")
  @js.native
  def pop(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "push")
  @js.native
  def push(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "reduce")
  @js.native
  def reduce(
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "reduceRight")
  @js.native
  def reduceRight(
    callbackfn: js.Function4[
      /* previousValue */ Path, 
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "reverse")
  @js.native
  def reverse(): js.Array[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "shift")
  @js.native
  def shift(): js.UndefOr[Path] = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "slice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "some")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "sort")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "splice")
  @js.native
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "toLocaleString")
  @js.native
  def toLocaleString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "toString")
  @js.native
  def toString_(): String = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "unshift")
  @js.native
  def unshift(items: Path*): Double = js.native
  
  @JSImport("ipfs-http-server/dist/src/api/routes/swarm", "values")
  @js.native
