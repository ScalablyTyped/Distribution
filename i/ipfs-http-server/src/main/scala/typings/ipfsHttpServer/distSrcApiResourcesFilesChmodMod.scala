...
object distSrcApiResourcesFilesChmodMod {
  
  object chmodResource {
    
    @JSImport("ipfs-http-server/dist/src/api/resources/files/chmod", "chmodResource")
    @js.native
    ...
    object options {
      ...
      object validate {
        ...
        object options1 {
          ...
          @JSImport("ipfs-http-server/dist/src/api/resources/files/chmod", "chmodResource.options.validate.options_1.allowUnknown")
          @js.native
          val allowUnknown: Boolean = js.native
          
          @JSImport("ipfs-http-server/dist/src/api/resources/files/chmod", "chmodResource.options.validate.options_1.stripUnknown")
          @js.native
          val stripUnknown: Boolean = js.native
        }
        
        @JSImport("ipfs-http-server/dist/src/api/resources/files/chmod", "chmodResource.options.validate.query")
        @js.native
