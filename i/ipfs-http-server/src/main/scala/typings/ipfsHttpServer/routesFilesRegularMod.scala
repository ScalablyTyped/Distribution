...
import typings.ipfsHttpServer.anon.MethodOptions
...
object routesFilesRegularMod {
  ...
  @JSImport("ipfs-http-server/dist/src/api/routes/files-regular", JSImport.Namespace)
  @js.native
  ...
  def reduce(
    callbackfn: js.Function4[
      ...
      /* currentValue */ Path | MethodOptions, 
      /* currentIndex */ Double, 
      /* array */ js.Array[Path | MethodOptions], 
      Path | MethodOptions
    ]
