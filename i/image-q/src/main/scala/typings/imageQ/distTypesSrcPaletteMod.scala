...
object distTypesSrcPaletteMod {
  ...
  open class AbstractPaletteQuantizer ()
    extends typings.imageQ.distTypesSrcPalettePaletteQuantizerMod.AbstractPaletteQuantizer
  
  @JSImport("image-q/dist/types/src/palette", "ColorHistogram")
  @js.native
  open class ColorHistogram protected ()
    extends typings.imageQ.distTypesSrcPaletteRgbquantColorHistogramMod.ColorHistogram {
  ...
  open class NeuQuant protected ()
    extends typings.imageQ.distTypesSrcPaletteNeuquantNeuquantMod.NeuQuant {
  ...
  open class NeuQuantFloat protected ()
    extends typings.imageQ.distTypesSrcPaletteNeuquantNeuquantFloatMod.NeuQuantFloat {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
  }
  /* static members */
  ...
  open class RGBQuant protected ()
    extends typings.imageQ.distTypesSrcPaletteRgbquantRgbquantMod.RGBQuant {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
  ...
  open class WuColorCube ()
    extends typings.imageQ.distTypesSrcPaletteWuWuQuantMod.WuColorCube
  
  @JSImport("image-q/dist/types/src/palette", "WuQuant")
  @js.native
  open class WuQuant protected ()
    extends typings.imageQ.distTypesSrcPaletteWuWuQuantMod.WuQuant {
    def this(colorDistanceCalculator: AbstractDistanceCalculator) = this()
    def this(colorDistanceCalculator: AbstractDistanceCalculator, colors: Double) = this()
    def this(
