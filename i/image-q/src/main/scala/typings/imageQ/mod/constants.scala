...
object constants {
  ...
  object bt709 {
    ...
    object Y_ extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.imageQ.bt709Mod.Y_ & Double] = js.native
    ...
    object x extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.imageQ.bt709Mod.x & Double] = js.native
    ...
    object y extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.imageQ.bt709Mod.y & Double] = js.native
