...
object constants {
  ...
  object bt709 {
    ...
    object Y_ extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.imageQ.bt709Mod.Y_ with Double] = js.native
    ...
    object x extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.imageQ.bt709Mod.x with Double] = js.native
