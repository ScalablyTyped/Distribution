...
object distTypesSrcDistanceMod {
  
  /* note: abstract class */ @JSImport("image-q/dist/types/src/distance", "AbstractDistanceCalculator")
  @js.native
  open class AbstractDistanceCalculator ()
    extends typings.imageQ.distTypesSrcDistanceDistanceCalculatorMod.AbstractDistanceCalculator
  
  /* note: abstract class */ @JSImport("image-q/dist/types/src/distance", "AbstractEuclidean")
  @js.native
  open class AbstractEuclidean ()
    extends typings.imageQ.distTypesSrcDistanceEuclideanMod.AbstractEuclidean
  
  /* note: abstract class */ @JSImport("image-q/dist/types/src/distance", "AbstractManhattan")
  @js.native
  open class AbstractManhattan ()
    extends typings.imageQ.distTypesSrcDistanceManhattanMod.AbstractManhattan
  
  @JSImport("image-q/dist/types/src/distance", "CIE94GraphicArts")
  @js.native
  open class CIE94GraphicArts ()
    extends typings.imageQ.distTypesSrcDistanceCie94Mod.CIE94GraphicArts
  
  @JSImport("image-q/dist/types/src/distance", "CIE94Textiles")
  @js.native
  open class CIE94Textiles ()
    extends typings.imageQ.distTypesSrcDistanceCie94Mod.CIE94Textiles
  
  @JSImport("image-q/dist/types/src/distance", "CIEDE2000")
  @js.native
  open class CIEDE2000 ()
    extends typings.imageQ.distTypesSrcDistanceCiede2000Mod.CIEDE2000
  /* static members */
  object CIEDE2000 {
  ...
  @js.native
  open class CMetric ()
    extends typings.imageQ.distTypesSrcDistanceCmetricMod.CMetric
  
  @JSImport("image-q/dist/types/src/distance", "Euclidean")
  @js.native
  open class Euclidean ()
    extends typings.imageQ.distTypesSrcDistanceEuclideanMod.Euclidean
  
  @JSImport("image-q/dist/types/src/distance", "EuclideanBT709")
  @js.native
  open class EuclideanBT709 ()
    extends typings.imageQ.distTypesSrcDistanceEuclideanMod.EuclideanBT709
  
  @JSImport("image-q/dist/types/src/distance", "EuclideanBT709NoAlpha")
  @js.native
  open class EuclideanBT709NoAlpha ()
    extends typings.imageQ.distTypesSrcDistanceEuclideanMod.EuclideanBT709NoAlpha
  
  @JSImport("image-q/dist/types/src/distance", "Manhattan")
  @js.native
  open class Manhattan ()
    extends typings.imageQ.distTypesSrcDistanceManhattanMod.Manhattan
  
  @JSImport("image-q/dist/types/src/distance", "ManhattanBT709")
  @js.native
  open class ManhattanBT709 ()
    extends typings.imageQ.distTypesSrcDistanceManhattanMod.ManhattanBT709
  
  @JSImport("image-q/dist/types/src/distance", "ManhattanNommyde")
  @js.native
  open class ManhattanNommyde ()
    extends typings.imageQ.distTypesSrcDistanceManhattanMod.ManhattanNommyde
  
  @JSImport("image-q/dist/types/src/distance", "PNGQuant")
  @js.native
  open class PNGQuant ()
    extends typings.imageQ.distTypesSrcDistancePngQuantMod.PNGQuant
}
