...
class Database () extends Options {
  ...
  def beginTransaction(): js.Promise[scala.Unit] = js.native
  ...
  def endTransaction(): js.Promise[scala.Unit] = js.native
  ...
  def open(connStr: java.lang.String): js.Promise[ODBCConnection] = js.native
  def open(
  ...
  def prepare(sql: java.lang.String): js.Promise[ODBCStatement] = js.native
  def prepare(
  ...
  def query(query: java.lang.String, params: js.Array[_]): js.Promise[js.Array[_]] = js.native
  def query(
    query: java.lang.String,
    params: js.Array[_],
    cb: js.Function2[/* err */ stdLib.Error, /* res */ js.Array[_], scala.Unit]
  ...
  def queryResult(query: java.lang.String, params: js.Array[_]): js.Promise[ODBCResult] = js.native
  def queryResult(
    query: java.lang.String,
    params: js.Array[_],
    cb: js.Function2[/* err */ stdLib.Error, /* res */ ODBCResult, scala.Unit]
