...
import typings.ibmUnderscoreDb.Anon_Params
...
class Database () extends Options {
  ...
  def query(query: Anon_Params): js.Promise[js.Array[_]] = js.native
  def query(query: Anon_Params, cb: js.Function2[/* err */ Error, /* res */ js.Array[_], Unit]): Unit = js.native
  def query(query: Anon_Params, params: js.Array[_]): js.Promise[js.Array[_]] = js.native
  ...
  def queryResult(query: Anon_Params, cb: js.Function2[/* err */ Error, /* res */ ODBCResult, Unit]): Unit = js.native
  ...
  def queryResultSync(query: Anon_Params): ODBCResult = js.native
  def queryResultSync(query: Anon_Params, params: js.Array[_]): ODBCResult = js.native
  ...
  def querySync(query: Anon_Params): js.Array[_] = js.native
  def querySync(query: Anon_Params, params: js.Array[_]): js.Array[_] = js.native
