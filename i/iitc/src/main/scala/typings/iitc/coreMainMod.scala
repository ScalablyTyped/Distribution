...
import typings.iitc.coreIitctypesMod.IITC.PortalOptions
import typings.iitc.coreIitctypesMod.PortalGUID
import typings.iitc.coreInteltypesMod.Intel.PlayerInfo
import typings.iitc.coreMapDataRequestMod.MapDataRequest
