...
object coreSearchMod {
  ...
  object global {
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.iitc.coreSearchMod.global.SearchResultPosition
      - typings.iitc.coreSearchMod.global.SearchResultBounds
    */
    ...
    object SearchResult {
      ...
      inline def SearchResultBounds(
        ...
        __obj.asInstanceOf[typings.iitc.coreSearchMod.global.SearchResultBounds]
      }
      ...
      inline def SearchResultPosition(
        ...
        __obj.asInstanceOf[typings.iitc.coreSearchMod.global.SearchResultPosition]
      }
    }
