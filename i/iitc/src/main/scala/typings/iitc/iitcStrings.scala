...
object iitcStrings {
  ...
  @scala.inline
  def PLAYER_GENERATED: PLAYER_GENERATED = "PLAYER_GENERATED".asInstanceOf[PLAYER_GENERATED]
  ...
  @scala.inline
  def SYSTEM_BROADCAST: SYSTEM_BROADCAST = "SYSTEM_BROADCAST".asInstanceOf[SYSTEM_BROADCAST]
  
  @js.native
  sealed trait SYSTEM_NARROWCAST extends StObject
  @scala.inline
  def SYSTEM_NARROWCAST: SYSTEM_NARROWCAST = "SYSTEM_NARROWCAST".asInstanceOf[SYSTEM_NARROWCAST]
  ...
  @scala.inline
  def chatalerts: chatalerts = "chatalerts".asInstanceOf[chatalerts]
  
  @js.native
  sealed trait chatall extends StObject
  @scala.inline
  def chatall: chatall = "chatall".asInstanceOf[chatall]
  ...
  @scala.inline
  def factionChatDataAvailable: factionChatDataAvailable = "factionChatDataAvailable".asInstanceOf[factionChatDataAvailable]
  
  @js.native
  sealed trait fieldAdded extends StObject
  @scala.inline
  def fieldAdded: fieldAdded = "fieldAdded".asInstanceOf[fieldAdded]
  
  @js.native
  sealed trait fieldRemoved extends StObject
  @scala.inline
  def fieldRemoved: fieldRemoved = "fieldRemoved".asInstanceOf[fieldRemoved]
  
  @js.native
  sealed trait iitcLoaded extends StObject
  @scala.inline
  def iitcLoaded: iitcLoaded = "iitcLoaded".asInstanceOf[iitcLoaded]
  
  @js.native
  sealed trait linkAdded extends StObject
  @scala.inline
  def linkAdded: linkAdded = "linkAdded".asInstanceOf[linkAdded]
  
  @js.native
  sealed trait linkRemoved extends StObject
  @scala.inline
  def linkRemoved: linkRemoved = "linkRemoved".asInstanceOf[linkRemoved]
  
  @js.native
  sealed trait mapDataEntityInject extends StObject
  @scala.inline
  def mapDataEntityInject: mapDataEntityInject = "mapDataEntityInject".asInstanceOf[mapDataEntityInject]
  
  @js.native
  sealed trait mapDataRefreshEnd extends StObject
  @scala.inline
  def mapDataRefreshEnd: mapDataRefreshEnd = "mapDataRefreshEnd".asInstanceOf[mapDataRefreshEnd]
  
  @js.native
  sealed trait mapDataRefreshStart extends StObject
  @scala.inline
  def mapDataRefreshStart: mapDataRefreshStart = "mapDataRefreshStart".asInstanceOf[mapDataRefreshStart]
  ...
  @scala.inline
  def paneChanged: paneChanged = "paneChanged".asInstanceOf[paneChanged]
  
  @js.native
  sealed trait portalAdded extends StObject
  @scala.inline
  def portalAdded: portalAdded = "portalAdded".asInstanceOf[portalAdded]
  
  @js.native
  sealed trait portalDetailLoaded extends StObject
  @scala.inline
  def portalDetailLoaded: portalDetailLoaded = "portalDetailLoaded".asInstanceOf[portalDetailLoaded]
  
  @js.native
  sealed trait portalDetailsUpdated extends StObject
  @scala.inline
  def portalDetailsUpdated: portalDetailsUpdated = "portalDetailsUpdated".asInstanceOf[portalDetailsUpdated]
  
  @js.native
  sealed trait portalRemoved extends StObject
  @scala.inline
  def portalRemoved: portalRemoved = "portalRemoved".asInstanceOf[portalRemoved]
  
  @js.native
  sealed trait portalSelected extends StObject
  @scala.inline
  def portalSelected: portalSelected = "portalSelected".asInstanceOf[portalSelected]
  
  @js.native
  sealed trait portal_ extends StObject
  @scala.inline
  def portal_ : portal_ = "portal".asInstanceOf[portal_]
