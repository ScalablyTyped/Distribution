...
/* Rewritten from type alias, can be one of: 
  - typings.ipp.ippStrings.`draw-line`
  - typings.ipp.ippStrings.full
  - typings.ipp.ippStrings.partial
  - typings.ipp.ippStrings.perforate
  - typings.ipp.ippStrings.score
  - typings.ipp.ippStrings.tab
*/
trait TrimmingType extends js.Object
