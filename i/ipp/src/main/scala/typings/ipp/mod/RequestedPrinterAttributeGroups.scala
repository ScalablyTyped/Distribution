...
/* Rewritten from type alias, can be one of: 
  - typings.ipp.ippStrings.all
  - typings.ipp.ippStrings.`job-template`
  - typings.ipp.ippStrings.`printer-description`
*/
trait RequestedPrinterAttributeGroups extends js.Object
