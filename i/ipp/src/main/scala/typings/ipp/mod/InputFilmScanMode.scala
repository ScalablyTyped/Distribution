...
/* Rewritten from type alias, can be one of: 
  - typings.ipp.ippStrings.`black-and-white-negative-film`
  - typings.ipp.ippStrings.`color-negative-film`
  - typings.ipp.ippStrings.`color-slide-film`
  - typings.ipp.ippStrings.`not-applicable`
*/
trait InputFilmScanMode extends js.Object
