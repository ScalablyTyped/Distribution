...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.ipp.ippStrings.`job-config-changed`
  - typings.ipp.ippStrings.`job-created`
  - typings.ipp.ippStrings.`job-progress`
  - typings.ipp.ippStrings.`job-state-changed`
  - typings.ipp.ippStrings.`job-stopped`
  - typings.ipp.ippStrings.none
  - typings.ipp.ippStrings.`printer-config-changed`
  - typings.ipp.ippStrings.`printer-finishings-changed`
  - typings.ipp.ippStrings.`printer-media-changed`
  - typings.ipp.ippStrings.`printer-queue-order-changed`
  - typings.ipp.ippStrings.`printer-restarted`
  - typings.ipp.ippStrings.`printer-shutdown`
  - typings.ipp.ippStrings.`printer-state-changed`
