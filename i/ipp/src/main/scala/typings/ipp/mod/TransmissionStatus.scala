...
*/
trait TransmissionStatus extends StObject
object TransmissionStatus {
  ...
  inline def `pending-retry`: typings.ipp.ippStrings.`pending-retry` = "pending-retry".asInstanceOf[typings.ipp.ippStrings.`pending-retry`]
