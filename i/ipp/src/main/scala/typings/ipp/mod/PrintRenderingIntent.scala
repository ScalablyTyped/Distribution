...
/* Rewritten from type alias, can be one of: 
  - typings.ipp.ippStrings.absolute
  - typings.ipp.ippStrings.auto
  - typings.ipp.ippStrings.perceptual
  - typings.ipp.ippStrings.relative
  - typings.ipp.ippStrings.`relative-bpc`
  - typings.ipp.ippStrings.saturation
*/
