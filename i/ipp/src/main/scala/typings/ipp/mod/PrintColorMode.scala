...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.ipp.ippStrings.`auto-monochrome`
  - typings.ipp.ippStrings.`bi-level`
  - typings.ipp.ippStrings.color
  - typings.ipp.ippStrings.highlight
  - typings.ipp.ippStrings.monochrome
  - typings.ipp.ippStrings.`process-bi-level`
  - typings.ipp.ippStrings.`process-monochrome`
*/
