...
object DestinationUriReady {
  ...
  inline def apply(): DestinationUriReady = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DestinationUriReady]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DestinationUriReady] (val x: Self) extends AnyVal {
    ...
    inline def `setDestination-attributes-supported`(value: js.Array[String]): Self = StObject.set(x, "destination-attributes-supported", value.asInstanceOf[js.Any])
    ...
    inline def `setDestination-infoUndefined`: Self = StObject.set(x, "destination-info", js.undefined)
    
    inline def `setDestination-is-directory`(value: Boolean): Self = StObject.set(x, "destination-is-directory", value.asInstanceOf[js.Any])
    
    inline def `setDestination-is-directoryUndefined`: Self = StObject.set(x, "destination-is-directory", js.undefined)
    
    inline def `setDestination-mandatory-access-attributes`(value: js.Array[String]): Self = StObject.set(x, "destination-mandatory-access-attributes", value.asInstanceOf[js.Any])
    ...
    inline def `setDestination-nameUndefined`: Self = StObject.set(x, "destination-name", js.undefined)
    
    inline def `setDestination-oauth-scope`(value: js.Array[String]): Self = StObject.set(x, "destination-oauth-scope", value.asInstanceOf[js.Any])
    ...
    inline def `setDestination-oauth-uriUndefined`: Self = StObject.set(x, "destination-oauth-uri", js.undefined)
