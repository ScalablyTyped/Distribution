...
object TeredoProperties {
  ...
  implicit class TeredoPropertiesOps[Self <: TeredoProperties] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setClient4(value: String): Self = this.set("client4", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setServer4(value: String): Self = this.set("server4", value.asInstanceOf[js.Any])
