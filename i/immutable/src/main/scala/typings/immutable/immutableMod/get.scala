...
object get extends js.Object {
  ...
  def apply[TProps, K /* <: String */](record: Record[TProps], key: K, notSetValue: js.Any): /* import warning: importer.ImportType#apply Failed type conversion: TProps[K] */ js.Any = js.native
