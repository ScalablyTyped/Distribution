...
object RecordNs extends js.Object {
  ...
  trait Factory[TProps /* <: js.Object */]
    extends org.scalablytyped.runtime.Instantiable0[immutableLib.immutableMod.Record[TProps] with TProps]
       with org.scalablytyped.runtime.Instantiable1[
          (/* values */ stdLib.Iterable[js.Tuple2[java.lang.String, js.Any]]) | (/* values */ stdLib.Partial[TProps]), 
          immutableLib.immutableMod.Record[TProps] with TProps
        ] {
    /**
    ...
    def apply(): immutableLib.immutableMod.Record[TProps] with TProps = js.native
    def apply(values: stdLib.Iterable[js.Tuple2[java.lang.String, _]]): immutableLib.immutableMod.Record[TProps] with TProps = js.native
    def apply(values: stdLib.Partial[TProps]): immutableLib.immutableMod.Record[TProps] with TProps = js.native
  }
