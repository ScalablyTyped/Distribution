...
trait Map[K, V]
  ...
  /**
    ...
    * @alias removeAll
    */
  def deleteAll(keys: stdLib.Iterable[K]): this.type = js.native
  /**
  ...
  def merge[C](collections: org.scalablytyped.runtime.StringDictionary[C]*): Map[K | java.lang.String, V | C] = js.native
  /**
    ...
    */
  def mergeDeep(collections: ((stdLib.Iterable[js.Tuple2[K, V]]) | org.scalablytyped.runtime.StringDictionary[V])*): this.type = js.native
  /**
  ...
  def mergeDeepWith(
    ...
    collections: ((stdLib.Iterable[js.Tuple2[K, V]]) | org.scalablytyped.runtime.StringDictionary[V])*
  ): this.type = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("merge")
  def merge_KCVC[KC, VC](collections: (stdLib.Iterable[js.Tuple2[KC, VC]])*): Map[K | KC, V | VC] = js.native
  def remove(key: K): this.type = js.native
  def removeAll(keys: stdLib.Iterable[K]): this.type = js.native
