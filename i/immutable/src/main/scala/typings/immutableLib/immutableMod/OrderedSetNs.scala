...
object OrderedSetNs extends js.Object {
  def fromKeys(obj: ScalablyTyped.runtime.StringDictionary[js.Any]): immutableLib.immutableMod.OrderedSet[java.lang.String] = js.native
  /**
       * `OrderedSet.fromKeys()` creates a new immutable OrderedSet containing
       * the keys from this Iterable or JavaScript Object.
       */
  def fromKeys[T](iter: immutableLib.immutableMod.Iterable[T, _]): immutableLib.immutableMod.OrderedSet[T] = js.native
  /**
