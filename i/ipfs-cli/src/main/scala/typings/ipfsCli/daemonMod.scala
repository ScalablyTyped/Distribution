...
object daemonMod {
  ...
  @JSImport("ipfs-cli/dist/src/commands/daemon", JSImport.Namespace)
  @js.native
  ...
  @JSImport("ipfs-cli/dist/src/commands/daemon", "command")
  @js.native
  val command: String = js.native
  
  @JSImport("ipfs-cli/dist/src/commands/daemon", "describe")
  @js.native
