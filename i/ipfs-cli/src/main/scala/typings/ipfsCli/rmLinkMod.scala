...
object rmLinkMod {
  ...
  @scala.inline
  def handler(hasHasIpfsPrintRootLinkCidBaseTimeout: Link): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("handler")(hasHasIpfsPrintRootLinkCidBaseTimeout.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
}
