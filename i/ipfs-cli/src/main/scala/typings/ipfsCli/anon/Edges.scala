...
object Edges {
  ...
  extension [Self <: Edges](x: Self) {
    ...
    inline def setMaxDepth(value: js.Any): Self = StObject.set(x, "maxDepth", value.asInstanceOf[js.Any])
    
    inline def setRecursive(value: js.Any): Self = StObject.set(x, "recursive", value.asInstanceOf[js.Any])
    
    inline def setTimeout(value: js.Any): Self = StObject.set(x, "timeout", value.asInstanceOf[js.Any])
    
    inline def setUnique(value: js.Any): Self = StObject.set(x, "unique", value.asInstanceOf[js.Any])
  }
}
