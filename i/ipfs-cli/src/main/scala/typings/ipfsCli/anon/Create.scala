...
object Create {
  ...
  implicit class CreateMutableBuilder[Self <: Create] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCtx(value: GetStdinIpfs): Self = StObject.set(x, "ctx", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReduceSingleLeafToSelf(value: js.Any): Self = StObject.set(x, "reduceSingleLeafToSelf", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setShardSplitThreshold(value: js.Any): Self = StObject.set(x, "shardSplitThreshold", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStrategy(value: js.Any): Self = StObject.set(x, "strategy", value.asInstanceOf[js.Any])
