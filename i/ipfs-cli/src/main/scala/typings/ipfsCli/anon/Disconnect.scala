...
object Disconnect {
  ...
  extension [Self <: Disconnect](x: Self) {
    ...
    inline def setAddrs(value: () => js.Promise[scala.Nothing]): Self = StObject.set(x, "addrs", js.Any.fromFunction0(value))
    
    inline def setConnect(value: () => js.Promise[scala.Nothing]): Self = StObject.set(x, "connect", js.Any.fromFunction0(value))
    
    inline def setDisconnect(value: () => js.Promise[scala.Nothing]): Self = StObject.set(x, "disconnect", js.Any.fromFunction0(value))
    
    inline def setLocalAddrs(value: () => js.Promise[js.Any]): Self = StObject.set(x, "localAddrs", js.Any.fromFunction0(value))
    
    inline def setPeers(value: () => js.Promise[scala.Nothing]): Self = StObject.set(x, "peers", js.Any.fromFunction0(value))
  }
}
