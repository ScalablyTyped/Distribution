...
object NumProviders {
  ...
  inline def apply(ctx: Print, key: js.Any, numProviders: js.Any, timeout: js.Any): NumProviders = {
  ...
  extension [Self <: NumProviders](x: Self) {
    
    inline def setCtx(value: Print): Self = StObject.set(x, "ctx", value.asInstanceOf[js.Any])
    
    inline def setKey(value: js.Any): Self = StObject.set(x, "key", value.asInstanceOf[js.Any])
    
    inline def setNumProviders(value: js.Any): Self = StObject.set(x, "numProviders", value.asInstanceOf[js.Any])
