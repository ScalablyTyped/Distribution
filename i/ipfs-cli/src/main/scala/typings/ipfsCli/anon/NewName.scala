...
object NewName {
  ...
  inline def apply(ctx: Print, name: js.Any, newName: js.Any, timeout: js.Any): NewName = {
  ...
  extension [Self <: NewName](x: Self) {
    ...
    inline def setNewName(value: js.Any): Self = StObject.set(x, "newName", value.asInstanceOf[js.Any])
