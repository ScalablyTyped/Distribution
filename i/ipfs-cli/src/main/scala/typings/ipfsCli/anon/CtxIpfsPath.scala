...
object CtxIpfsPath {
  ...
  @scala.inline
  def apply(cidBase: js.Any, ctx: js.Any, ipfsPath: js.Any, recursive: js.Any, timeout: js.Any): CtxIpfsPath = {
  ...
  @scala.inline
  implicit class CtxIpfsPathMutableBuilder[Self <: CtxIpfsPath] (val x: Self) extends AnyVal {
