...
trait BlockWriteConcurrency extends StObject {
  
  var blockWriteConcurrency: js.Any
  ...
  var fileImportConcurrency: js.Any
  ...
  var preserveMode: js.Any
  
  var preserveMtime: js.Any
