...
object mvMod {
  ...
  @scala.inline
  def handler(hasHasIpfsSourceDestParentsRecursiveCidVersionHashAlgFlushShardSplitThresholdTimeout: Parents): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("handler")(hasHasIpfsSourceDestParentsRecursiveCidVersionHashAlgFlushShardSplitThresholdTimeout.asInstanceOf[js.Any]).asInstanceOf[js.Any]
}
