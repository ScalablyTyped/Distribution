...
object objectGetMod {
  ...
  object builder {
    ...
    @scala.inline
    def dataEncoding_=(x: DefaultStringTypeString): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("data-encoding")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def handler(hasHasIpfsPrintKeyDataEncodingCidBaseTimeout: DataEncoding): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("handler")(hasHasIpfsPrintKeyDataEncodingCidBaseTimeout.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
}
