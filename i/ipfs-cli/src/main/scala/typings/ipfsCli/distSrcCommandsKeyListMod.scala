...
object distSrcCommandsKeyListMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/key/list", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsKeyListMod.foo` */
