...
object addrsMod {
  ...
  @JSImport("ipfs-cli/dist/src/commands/swarm/addrs", JSImport.Namespace)
  @js.native
  ...
  @JSImport("ipfs-cli/dist/src/commands/swarm/addrs", "command")
  @js.native
  val command: String = js.native
  
  @JSImport("ipfs-cli/dist/src/commands/swarm/addrs", "describe")
  @js.native
