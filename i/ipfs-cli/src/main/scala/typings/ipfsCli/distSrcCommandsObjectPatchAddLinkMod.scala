...
object distSrcCommandsObjectPatchAddLinkMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/object/patch/add-link", JSImport.Default)
  @js.native
  ...
  trait Argv extends StObject {
    ...
    var ref: CID[Any, Double, Double, Version]
  ...
  object Argv {
    ...
    inline def apply(
      ...
      ctx: Context,
      name: String,
      ref: CID[Any, Double, Double, Version],
      root: CID[Any, Double, Double, Version],
      timeout: Double
    ): Argv = {
      val __obj = js.Dynamic.literal(cidBase = cidBase.asInstanceOf[js.Any], ctx = ctx.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], ref = ref.asInstanceOf[js.Any], root = root.asInstanceOf[js.Any], timeout = timeout.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: Argv] (val x: Self) extends AnyVal {
      ...
      inline def setRef(value: CID[Any, Double, Double, Version]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsObjectPatchAddLinkMod.foo` */
