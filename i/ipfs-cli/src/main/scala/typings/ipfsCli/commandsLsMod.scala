...
object commandsLsMod {
  ...
  object builder {
    ...
    inline def r_=(x: Desc): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("r")(x.asInstanceOf[js.Any])
    
    @JSImport("ipfs-cli/dist/src/commands/ls", "builder.resolve-type")
    @js.native
    def resolveType: DefaultDesc = js.native
    
    inline def resolveType_=(x: DefaultDesc): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("resolve-type")(x.asInstanceOf[js.Any])
    ...
    inline def v_=(x: Desc): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("v")(x.asInstanceOf[js.Any])
  }
  ...
  inline def handler(hasHasIpfsPrintKeyRecursiveHeadersCidBaseTimeout: Headers): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("handler")(hasHasIpfsPrintKeyRecursiveHeadersCidBaseTimeout.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
}
