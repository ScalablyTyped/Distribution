...
object distSrcCommandsBlockGetMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/block/get", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsBlockGetMod.foo` */
