...
object distSrcCommandsDhtMod extends Shortcut {
  
  /** @type {import('yargs').CommandModule} */
  @JSImport("ipfs-cli/dist/src/commands/dht", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsDhtMod.foo` */
