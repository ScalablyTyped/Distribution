...
object chmodMod {
  ...
  object builder {
    ...
    @scala.inline
    def path_=(x: DescribeType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("path")(x.asInstanceOf[js.Any])
    
    @JSImport("ipfs-cli/dist/src/commands/files/chmod", "builder.recursive")
    @js.native
    def recursive: AliasCoerce = js.native
    @scala.inline
    def recursive_=(x: AliasCoerce): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("recursive")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def handler(hasHasIpfsPathModeRecursiveHashAlgFlushShardSplitThresholdTimeout: Flush): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("handler")(hasHasIpfsPathModeRecursiveHashAlgFlushShardSplitThresholdTimeout.asInstanceOf[js.Any]).asInstanceOf[js.Any]
}
