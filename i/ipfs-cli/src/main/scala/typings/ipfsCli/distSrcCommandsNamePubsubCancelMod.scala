...
object distSrcCommandsNamePubsubCancelMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/name/pubsub/cancel", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsNamePubsubCancelMod.foo` */
