...
object filesStatMod {
  ...
  object builder {
    ...
    inline def format_=(x: AliasDefaultDescribeType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("format")(x.asInstanceOf[js.Any])
    
    @JSImport("ipfs-cli/dist/src/commands/files/stat", "builder.hash")
    @js.native
    def hash: AliasCoerce = js.native
    inline def hash_=(x: AliasCoerce): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("hash")(x.asInstanceOf[js.Any])
    
    @JSImport("ipfs-cli/dist/src/commands/files/stat", "builder.size")
    @js.native
    def size: AliasCoerce = js.native
    inline def size_=(x: AliasCoerce): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("size")(x.asInstanceOf[js.Any])
    ...
    inline def withLocal_=(x: AliasCoerce): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("with-local")(x.asInstanceOf[js.Any])
  }
  ...
  inline def handler(hasHasIpfsPrintPathFormatHashSizeWithLocalCidBaseTimeout: Format): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("handler")(hasHasIpfsPrintPathFormatHashSizeWithLocalCidBaseTimeout.asInstanceOf[js.Any]).asInstanceOf[js.Any]
}
