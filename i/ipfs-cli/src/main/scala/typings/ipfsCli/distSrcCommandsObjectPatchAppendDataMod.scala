...
object distSrcCommandsObjectPatchAppendDataMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/object/patch/append-data", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsObjectPatchAppendDataMod.foo` */
