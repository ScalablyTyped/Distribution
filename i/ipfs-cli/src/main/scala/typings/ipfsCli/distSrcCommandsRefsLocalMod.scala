...
object distSrcCommandsRefsLocalMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/refs-local", JSImport.Default)
  @js.native
  ...
  trait Argv extends StObject {
    ...
    var multihash: Boolean
    
    var timeout: Double
  }
  object Argv {
    
    inline def apply(ctx: Context, multihash: Boolean, timeout: Double): Argv = {
    ...
    implicit open class MutableBuilder[Self <: Argv] (val x: Self) extends AnyVal {
      ...
      inline def setMultihash(value: Boolean): Self = StObject.set(x, "multihash", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsRefsLocalMod.foo` */
