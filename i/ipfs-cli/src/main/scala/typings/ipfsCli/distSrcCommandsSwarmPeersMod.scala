...
object distSrcCommandsSwarmPeersMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/swarm/peers", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsSwarmPeersMod.foo` */
