...
object distSrcCommandsShutdownMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/shutdown", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsShutdownMod.foo` */
