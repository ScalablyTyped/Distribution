...
object distSrcCommandsFilesMod extends Shortcut {
  
  /** @type {import('yargs').CommandModule} */
  @JSImport("ipfs-cli/dist/src/commands/files", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsFilesMod.foo` */
