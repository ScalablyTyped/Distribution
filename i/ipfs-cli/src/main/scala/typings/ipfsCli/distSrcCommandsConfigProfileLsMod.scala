...
object distSrcCommandsConfigProfileLsMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/config/profile/ls", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsConfigProfileLsMod.foo` */
