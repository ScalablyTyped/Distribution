...
object keyRmMod {
  ...
  @scala.inline
  def handler(hasHasIpfsPrintNameTimeout: CtxName): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("handler")(hasHasIpfsPrintNameTimeout.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
}
