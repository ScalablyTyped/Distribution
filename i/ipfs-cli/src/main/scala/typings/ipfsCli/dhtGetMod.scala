...
object dhtGetMod {
  ...
  @scala.inline
  def handler(hasHasIpfsPrintKeyTimeout: CtxKey): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("handler")(hasHasIpfsPrintKeyTimeout.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
}
