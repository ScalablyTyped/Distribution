...
object flushMod {
  ...
  inline def handler(hasHasIpfsPrintPathCidBaseTimeout: Path): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("handler")(hasHasIpfsPrintPathCidBaseTimeout.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
}
