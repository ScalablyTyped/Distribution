...
object distSrcCommandsBitswapUnwantMod extends Shortcut {
  ...
  @JSImport("ipfs-cli/dist/src/commands/bitswap/unwant", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distSrcCommandsBitswapUnwantMod.foo` */
