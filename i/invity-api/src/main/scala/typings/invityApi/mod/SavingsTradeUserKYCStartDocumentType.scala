...
/* Rewritten from type alias, can be one of: 
  - typings.invityApi.invityApiStrings.Passport
...
object SavingsTradeUserKYCStartDocumentType {
  
  inline def DrivingLicence: typings.invityApi.invityApiStrings.DrivingLicence = "DrivingLicence".asInstanceOf[typings.invityApi.invityApiStrings.DrivingLicence]
  ...
  inline def WalletVerification: typings.invityApi.invityApiStrings.WalletVerification = "WalletVerification".asInstanceOf[typings.invityApi.invityApiStrings.WalletVerification]
}
