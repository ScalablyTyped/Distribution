...
trait SubprocessBashifyOptions extends js.Object {
  /**
    ...
    * The default is `true`.
    */
  var maskArgv0: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    */
  var maskArgv1: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    * The default is `false`.
    */
  var shiftArgv0: js.UndefOr[scala.Boolean] = js.undefined
}

object SubprocessBashifyOptions {
  @scala.inline
  def apply(
    maskArgv0: js.UndefOr[scala.Boolean] = js.undefined,
    maskArgv1: js.UndefOr[scala.Boolean] = js.undefined,
    shiftArgv0: js.UndefOr[scala.Boolean] = js.undefined
