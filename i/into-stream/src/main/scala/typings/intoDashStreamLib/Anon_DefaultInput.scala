...
trait Anon_DefaultInput extends js.Object {
  ...
  /**
  	...
  	*/
  // TODO: Remove this for the next major release
  def default(input: intoDashStreamLib.intoDashStreamMod.intoStreamNs.Input): nodeLib.streamMod.Readable = js.native
  def default(input: js.Promise[intoDashStreamLib.intoDashStreamMod.intoStreamNs.Input]): nodeLib.streamMod.Readable = js.native
  /**
