...
object mod {
  ...
  inline def `object`(input: js.Promise[InputObject]): Readable = ^.asInstanceOf[js.Dynamic].applyDynamic("object")(input.asInstanceOf[js.Any]).asInstanceOf[Readable]
  /**
  	...
  	*/
  inline def `object`(input: InputObject): Readable = ^.asInstanceOf[js.Dynamic].applyDynamic("object")(input.asInstanceOf[js.Any]).asInstanceOf[Readable]
