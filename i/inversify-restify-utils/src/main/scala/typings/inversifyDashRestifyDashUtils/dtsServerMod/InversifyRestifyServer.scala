package typings.inversifyDashRestifyDashUtils.dtsServerMod

import typings.inversify.dtsInterfacesInterfacesMod.interfacesNs.Container
import typings.inversifyDashRestifyDashUtils.dtsInterfacesMod.interfacesNs.ConfigFunction
...
class InversifyRestifyServer protected () extends js.Object {
  ...
  def this(
    container: Container,
    opts: ServerOptions with typings.inversifyDashRestifyDashUtils.dtsInterfacesMod.interfacesNs.ServerOptions
  ) = this()
