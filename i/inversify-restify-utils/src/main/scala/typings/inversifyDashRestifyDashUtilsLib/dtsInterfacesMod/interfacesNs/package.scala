...
package object interfacesNs {
  ...
  type Middleware = (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify inversifyInterfaces.ServiceIdentifier<any> */ js.Any) | restifyLib.restifyMod.RequestHandler
