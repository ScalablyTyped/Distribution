...
import typings.chalk.mod.BackgroundColor
import typings.chalk.mod.ChalkInstance
import typings.chalk.mod.Color
import typings.chalk.mod.ForegroundColor
import typings.chalk.mod.Modifiers_
...
import typings.chalk.sourceVendorSupportsColorMod.ColorSupport
import typings.chalk.sourceVendorSupportsColorMod.ColorSupportLevel
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object dtsSerializersTextColorsMod {
  ...
  object Chalk extends Shortcut {
    ...
    */
    ...
    @JSImport("inversify-logger-middleware/dts/serializers/text/colors", "Chalk.backgroundColorNames")
    @js.native
    val backgroundColorNames: js.Array[BackgroundColorName] = js.native
    
    @JSImport("inversify-logger-middleware/dts/serializers/text/colors", "Chalk.backgroundColors")
    @js.native
    ...
    @JSImport("inversify-logger-middleware/dts/serializers/text/colors", "Chalk.colorNames")
    @js.native
    val colorNames: js.Array[ColorName] = js.native
    
    @JSImport("inversify-logger-middleware/dts/serializers/text/colors", "Chalk.colors")
    @js.native
    val colors: js.Array[Color] = js.native
    
    @JSImport("inversify-logger-middleware/dts/serializers/text/colors", "Chalk.foregroundColorNames")
    @js.native
    val foregroundColorNames: js.Array[ForegroundColorName] = js.native
    
    @JSImport("inversify-logger-middleware/dts/serializers/text/colors", "Chalk.foregroundColors")
    @js.native
    val foregroundColors: js.Array[ForegroundColor] = js.native
    
    @JSImport("inversify-logger-middleware/dts/serializers/text/colors", "Chalk.modifierNames")
    @js.native
    val modifierNames: js.Array[ModifierName] = js.native
    
    @JSImport("inversify-logger-middleware/dts/serializers/text/colors", "Chalk.modifiers")
    @js.native
