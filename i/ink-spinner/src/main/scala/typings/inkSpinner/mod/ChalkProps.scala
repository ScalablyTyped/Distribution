...
/* Inlined ink-spinner.ink-spinner.BooleansPartial<ink-spinner.ink-spinner.ChalkCommons> & ink-spinner.ink-spinner.StringifyPartial<ink-spinner.ink-spinner.ChalkKeywordsAndHexes> & ink-spinner.ink-spinner.TupleOfNumbersPartial<ink-spinner.ink-spinner.ChalkColorModels> */
@js.native
trait ChalkProps extends js.Object {
  var Instance: js.UndefOr[Boolean] = js.native
  var ansi: js.UndefOr[Boolean] = js.native
  var ansi256: js.UndefOr[Boolean] = js.native
  var bgAnsi: js.UndefOr[Boolean] = js.native
  var bgAnsi256: js.UndefOr[Boolean] = js.native
  ...
  var bgHex: js.UndefOr[String] = js.native
  var bgHsl: js.UndefOr[js.Tuple3[Double, Double, Double]] = js.native
  var bgHsv: js.UndefOr[js.Tuple3[Double, Double, Double]] = js.native
  var bgHwb: js.UndefOr[js.Tuple3[Double, Double, Double]] = js.native
  var bgKeyword: js.UndefOr[String] = js.native
  ...
  var bgRgb: js.UndefOr[js.Tuple3[Double, Double, Double]] = js.native
  ...
  var hsl: js.UndefOr[js.Tuple3[Double, Double, Double]] = js.native
  var hsv: js.UndefOr[js.Tuple3[Double, Double, Double]] = js.native
  var hwb: js.UndefOr[js.Tuple3[Double, Double, Double]] = js.native
  ...
  var rgb: js.UndefOr[js.Tuple3[Double, Double, Double]] = js.native
...
object ChalkProps {
  ...
  implicit class ChalkPropsOps[Self <: ChalkProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnsi256(value: Boolean): Self = this.set("ansi256", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAnsi256: Self = this.set("ansi256", js.undefined)
    @scala.inline
    def setBgAnsi(value: Boolean): Self = this.set("bgAnsi", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteBgAnsi: Self = this.set("bgAnsi", js.undefined)
    @scala.inline
    def setBgAnsi256(value: Boolean): Self = this.set("bgAnsi256", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setBgHex(value: String): Self = this.set("bgHex", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteBgHex: Self = this.set("bgHex", js.undefined)
    @scala.inline
    def setBgHsl(value: js.Tuple3[Double, Double, Double]): Self = this.set("bgHsl", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteBgHsl: Self = this.set("bgHsl", js.undefined)
    @scala.inline
    def setBgHsv(value: js.Tuple3[Double, Double, Double]): Self = this.set("bgHsv", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteBgHsv: Self = this.set("bgHsv", js.undefined)
    @scala.inline
    def setBgHwb(value: js.Tuple3[Double, Double, Double]): Self = this.set("bgHwb", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteBgHwb: Self = this.set("bgHwb", js.undefined)
    @scala.inline
    def setBgKeyword(value: String): Self = this.set("bgKeyword", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setBgRgb(value: js.Tuple3[Double, Double, Double]): Self = this.set("bgRgb", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setHwb(value: js.Tuple3[Double, Double, Double]): Self = this.set("hwb", value.asInstanceOf[js.Any])
    @scala.inline
