...
object IgUpload {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    cancelAllClicked: (/* event */ Event_, /* ui */ CancelAllClickedEventUIParam) => Unit = null,
    ...
    fileExtensionsValidating: (/* event */ Event_, /* ui */ FileExtensionsValidatingEventUIParam) => Unit = null,
    fileSelected: (/* event */ Event_, /* ui */ FileSelectedEventUIParam) => Unit = null,
    fileSelecting: (/* event */ Event_, /* ui */ FileSelectingEventUIParam) => Unit = null,
    fileSizeDecimalDisplay: Int | Double = null,
    fileSizeMetric: js.Any = null,
    fileUploadAborted: (/* event */ Event_, /* ui */ FileUploadAbortedEventUIParam) => Unit = null,
    fileUploaded: (/* event */ Event_, /* ui */ FileUploadedEventUIParam) => Unit = null,
    fileUploading: (/* event */ Event_, /* ui */ FileUploadingEventUIParam) => Unit = null,
    ...
    maxSimultaneousFilesUploads: Int | Double = null,
    maxUploadedFiles: Int | Double = null,
    mode: js.Any = null,
    multipleFiles: js.UndefOr[Boolean] = js.undefined,
    onError: (/* event */ Event_, /* ui */ OnErrorEventUIParam) => Unit = null,
    onFormDataSubmit: (/* event */ Event_, /* ui */ OnFormDataSubmitEventUIParam) => Unit = null,
    onXHRLoad: (/* event */ Event_, /* ui */ OnXHRLoadEventUIParam) => Unit = null,
    ...
    if (!js.isUndefined(autostartupload)) __obj.updateDynamic("autostartupload")(autostartupload.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showFileExtensionIcon)) __obj.updateDynamic("showFileExtensionIcon")(showFileExtensionIcon.asInstanceOf[js.Any])
    if (uploadUrl != null) __obj.updateDynamic("uploadUrl")(uploadUrl.asInstanceOf[js.Any])
    if (!js.isUndefined(useSingleRequest)) __obj.updateDynamic("useSingleRequest")(useSingleRequest.asInstanceOf[js.Any])
