...
object IgGridSelection {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    activeCellChanged: (/* event */ Event_, /* ui */ ActiveCellChangedEventUIParam) => Unit = null,
    activeCellChanging: (/* event */ Event_, /* ui */ ActiveCellChangingEventUIParam) => Unit = null,
    activeRowChanged: (/* event */ Event_, /* ui */ ActiveRowChangedEventUIParam) => Unit = null,
    activeRowChanging: (/* event */ Event_, /* ui */ ActiveRowChangingEventUIParam) => Unit = null,
    allowMultipleRangeSelection: js.UndefOr[Boolean] = js.undefined,
    cellSelectionChanged: (/* event */ Event_, /* ui */ CellSelectionChangedEventUIParam) => Unit = null,
    cellSelectionChanging: (/* event */ Event_, /* ui */ CellSelectionChangingEventUIParam) => Unit = null,
    mode: String = null,
    ...
    rowSelectionChanged: (/* event */ Event_, /* ui */ RowSelectionChangedEventUIParam) => Unit = null,
    rowSelectionChanging: (/* event */ Event_, /* ui */ RowSelectionChangingEventUIParam) => Unit = null,
