...
object IgGridSelection {
  ...
  def apply(
    ...
    if (!js.isUndefined(activation)) __obj.updateDynamic("activation")(activation.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(allowMultipleRangeSelection)) __obj.updateDynamic("allowMultipleRangeSelection")(allowMultipleRangeSelection.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(mouseDragSelect)) __obj.updateDynamic("mouseDragSelect")(mouseDragSelect.get.asInstanceOf[js.Any])
    if (!js.isUndefined(multipleCellSelectOnClick)) __obj.updateDynamic("multipleCellSelectOnClick")(multipleCellSelectOnClick.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(touchDragSelect)) __obj.updateDynamic("touchDragSelect")(touchDragSelect.get.asInstanceOf[js.Any])
