...
@js.native
trait WaitingEventUIParam extends StObject {
...
object WaitingEventUIParam {
  ...
  @scala.inline
  def apply(): WaitingEventUIParam = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WaitingEventUIParam]
  }
  
  @scala.inline
  implicit class WaitingEventUIParamMutableBuilder[Self <: WaitingEventUIParam] (val x: Self) extends AnyVal {
