...
object SelectedRowsCollection {
  ...
  implicit class SelectedRowsCollectionOps[Self <: SelectedRowsCollection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActiveRow(value: () => Unit): Self = this.set("activeRow", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setElementPosition(value: (js.Object, js.Object) => Unit): Self = this.set("elementPosition", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setSelectedDataRows(value: () => Unit): Self = this.set("selectedDataRows", js.Any.fromFunction0(value))
