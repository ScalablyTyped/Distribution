...
object EditorProviderRating {
  ...
  extension [Self <: EditorProviderRating](x: Self) {
    ...
    inline def setInternalValueChange(value: (js.Object, js.Object) => Unit): Self = StObject.set(x, "internalValueChange", js.Any.fromFunction2(value))
    ...
    inline def setValueChange(value: (js.Object, js.Object) => Unit): Self = StObject.set(x, "valueChange", js.Any.fromFunction2(value))
  }
}
