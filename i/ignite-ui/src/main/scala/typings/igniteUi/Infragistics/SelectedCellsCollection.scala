...
object SelectedCellsCollection {
  ...
  implicit open class MutableBuilder[Self <: SelectedCellsCollection] (val x: Self) extends AnyVal {
    ...
    inline def setActiveCell(value: () => Unit): Self = StObject.set(x, "activeCell", js.Any.fromFunction0(value))
    
    inline def setAddSubscriber(value: (js.Object, js.Object) => Unit): Self = StObject.set(x, "addSubscriber", js.Any.fromFunction2(value))
    
    inline def setAtLeastOneSelected(value: (js.Object, js.Object) => Unit): Self = StObject.set(x, "atLeastOneSelected", js.Any.fromFunction2(value))
