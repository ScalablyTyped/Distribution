...
object ShapeDataSource {
  ...
  inline def apply(converter: () => js.Object, dataBind: () => Unit, dataView: () => Unit, isBound: () => Boolean): ShapeDataSource = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ShapeDataSource] (val x: Self) extends AnyVal {
