...
object TriangulationDataSource {
  ...
  inline def apply(converter: () => js.Object, dataBind: () => Unit, dataView: () => Unit, isBound: () => Boolean): TriangulationDataSource = {
  ...
  implicit open class MutableBuilder[Self <: TriangulationDataSource] (val x: Self) extends AnyVal {
    ...
    inline def setDataView(value: () => Unit): Self = StObject.set(x, "dataView", js.Any.fromFunction0(value))
