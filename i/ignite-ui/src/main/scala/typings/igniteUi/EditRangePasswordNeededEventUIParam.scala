...
object EditRangePasswordNeededEventUIParam {
  ...
  extension [Self <: EditRangePasswordNeededEventUIParam](x: Self) {
    ...
    inline def setRanges(value: js.Array[js.Any]): Self = StObject.set(x, "ranges", value.asInstanceOf[js.Any])
    
    inline def setRangesUndefined: Self = StObject.set(x, "ranges", js.undefined)
    
    inline def setRangesVarargs(value: js.Any*): Self = StObject.set(x, "ranges", js.Array(value :_*))
    
    inline def setUnprotect(value: js.Any): Self = StObject.set(x, "unprotect", value.asInstanceOf[js.Any])
