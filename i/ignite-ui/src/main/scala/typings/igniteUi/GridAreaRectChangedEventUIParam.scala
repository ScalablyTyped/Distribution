...
object GridAreaRectChangedEventUIParam {
  ...
  extension [Self <: GridAreaRectChangedEventUIParam](x: Self) {
    ...
    inline def setNewHeight(value: js.Any): Self = StObject.set(x, "newHeight", value.asInstanceOf[js.Any])
    
    inline def setNewHeightUndefined: Self = StObject.set(x, "newHeight", js.undefined)
    
    inline def setNewLeft(value: js.Any): Self = StObject.set(x, "newLeft", value.asInstanceOf[js.Any])
    
    inline def setNewLeftUndefined: Self = StObject.set(x, "newLeft", js.undefined)
    
    inline def setNewTop(value: js.Any): Self = StObject.set(x, "newTop", value.asInstanceOf[js.Any])
    
    inline def setNewTopUndefined: Self = StObject.set(x, "newTop", js.undefined)
    
    inline def setNewWidth(value: js.Any): Self = StObject.set(x, "newWidth", value.asInstanceOf[js.Any])
    
    inline def setNewWidthUndefined: Self = StObject.set(x, "newWidth", js.undefined)
    
    inline def setOldHeight(value: js.Any): Self = StObject.set(x, "oldHeight", value.asInstanceOf[js.Any])
    
    inline def setOldHeightUndefined: Self = StObject.set(x, "oldHeight", js.undefined)
    
    inline def setOldLeft(value: js.Any): Self = StObject.set(x, "oldLeft", value.asInstanceOf[js.Any])
    
    inline def setOldLeftUndefined: Self = StObject.set(x, "oldLeft", js.undefined)
    
    inline def setOldTop(value: js.Any): Self = StObject.set(x, "oldTop", value.asInstanceOf[js.Any])
    
    inline def setOldTopUndefined: Self = StObject.set(x, "oldTop", js.undefined)
    
    inline def setOldWidth(value: js.Any): Self = StObject.set(x, "oldWidth", value.asInstanceOf[js.Any])
