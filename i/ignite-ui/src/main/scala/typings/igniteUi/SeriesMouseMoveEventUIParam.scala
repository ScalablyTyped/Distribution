...
trait SeriesMouseMoveEventUIParam extends StObject {
...
object SeriesMouseMoveEventUIParam {
  ...
  inline def apply(): SeriesMouseMoveEventUIParam = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SeriesMouseMoveEventUIParam]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SeriesMouseMoveEventUIParam] (val x: Self) extends AnyVal {
