...
object IgHtmlEditorPopover {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    apply: (/* event */ Event_, /* ui */ ApplyEventUIParam) => Unit = null,
    cancel: (/* event */ Event_, /* ui */ CancelEventUIParam) => Unit = null,
    hide: (/* event */ Event_, /* ui */ HideEventUIParam) => Unit = null,
    isHidden: js.UndefOr[Boolean] = js.undefined,
    item: js.Any = null,
    language: String = null,
    locale: js.Any = null,
    regional: String | js.Object = null,
    show: (/* event */ Event_, /* ui */ ShowEventUIParam) => Unit = null,
    target: js.Any = null
  ): IgHtmlEditorPopover = {
