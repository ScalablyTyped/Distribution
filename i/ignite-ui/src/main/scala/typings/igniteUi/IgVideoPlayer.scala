...
object IgVideoPlayer {
  ...
  def apply(
    ...
    centerButtonHideDelay: js.UndefOr[Double] = js.undefined,
    ...
    volumeAutohideDelay: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(browserControls)) __obj.updateDynamic("browserControls")(browserControls.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(centerButtonHideDelay)) __obj.updateDynamic("centerButtonHideDelay")(centerButtonHideDelay.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showSeekTime)) __obj.updateDynamic("showSeekTime")(showSeekTime.get.asInstanceOf[js.Any])
    if (sources != null) __obj.updateDynamic("sources")(sources.asInstanceOf[js.Any])
    if (title != null) __obj.updateDynamic("title")(title.asInstanceOf[js.Any])
    if (!js.isUndefined(volume)) __obj.updateDynamic("volume")(volume.get.asInstanceOf[js.Any])
    if (!js.isUndefined(volumeAutohideDelay)) __obj.updateDynamic("volumeAutohideDelay")(volumeAutohideDelay.get.asInstanceOf[js.Any])
