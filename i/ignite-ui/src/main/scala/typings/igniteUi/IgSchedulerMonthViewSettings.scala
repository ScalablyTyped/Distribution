...
object IgSchedulerMonthViewSettings {
  ...
  def apply(
    ...
    if (!js.isUndefined(isAgendaVisible)) __obj.updateDynamic("isAgendaVisible")(isAgendaVisible.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isHorizontalSeparatorVisibile)) __obj.updateDynamic("isHorizontalSeparatorVisibile")(isHorizontalSeparatorVisibile.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isNextMonthShown)) __obj.updateDynamic("isNextMonthShown")(isNextMonthShown.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isPreviousMonthShown)) __obj.updateDynamic("isPreviousMonthShown")(isPreviousMonthShown.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isVerticalSeparatorVisibile)) __obj.updateDynamic("isVerticalSeparatorVisibile")(isVerticalSeparatorVisibile.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isWeekNumberVisible)) __obj.updateDynamic("isWeekNumberVisible")(isWeekNumberVisible.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isWeekdayVisible)) __obj.updateDynamic("isWeekdayVisible")(isWeekdayVisible.get.asInstanceOf[js.Any])
