...
object IgSchedulerDayViewSettings {
  ...
  def apply(
    ...
    dayViewNumberOfDays: js.UndefOr[Double] = js.undefined,
    timeSlotInterval: String = null,
    workingHoursDisplayMode: String = null
  ): IgSchedulerDayViewSettings = {
    val __obj = js.Dynamic.literal()
    if (StringDictionary != null) js.Dynamic.global.Object.assign(__obj, StringDictionary)
    if (!js.isUndefined(dayViewNumberOfDays)) __obj.updateDynamic("dayViewNumberOfDays")(dayViewNumberOfDays.get.asInstanceOf[js.Any])
