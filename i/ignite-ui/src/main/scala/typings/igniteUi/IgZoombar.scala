...
object IgZoombar {
  ...
  def apply(
    ...
    hoverStyleAnimationDuration: js.UndefOr[Double] = js.undefined,
    ...
    windowPanDuration: js.UndefOr[Double] = js.undefined,
    ...
    zoomWindowMinWidth: js.UndefOr[Double] = js.undefined,
    zoomWindowMoveDistance: js.UndefOr[Double] = js.undefined
  ): IgZoombar = {
    ...
    if (!js.isUndefined(hoverStyleAnimationDuration)) __obj.updateDynamic("hoverStyleAnimationDuration")(hoverStyleAnimationDuration.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(windowPanDuration)) __obj.updateDynamic("windowPanDuration")(windowPanDuration.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(zoomWindowMinWidth)) __obj.updateDynamic("zoomWindowMinWidth")(zoomWindowMinWidth.get.asInstanceOf[js.Any])
    if (!js.isUndefined(zoomWindowMoveDistance)) __obj.updateDynamic("zoomWindowMoveDistance")(zoomWindowMoveDistance.get.asInstanceOf[js.Any])
