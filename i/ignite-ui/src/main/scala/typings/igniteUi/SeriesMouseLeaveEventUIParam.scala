...
object SeriesMouseLeaveEventUIParam {
  ...
  extension [Self <: SeriesMouseLeaveEventUIParam](x: Self) {
    ...
    inline def setPositionX(value: js.Any): Self = StObject.set(x, "positionX", value.asInstanceOf[js.Any])
    
    inline def setPositionXUndefined: Self = StObject.set(x, "positionX", js.undefined)
    
    inline def setPositionY(value: js.Any): Self = StObject.set(x, "positionY", value.asInstanceOf[js.Any])
