...
object IgVideoPlayerLocale {
  ...
  def apply(
    ...
    if (!js.isUndefined(adMessage)) __obj.updateDynamic("adMessage")(adMessage.get.asInstanceOf[js.Any])
    if (!js.isUndefined(adMessageLong)) __obj.updateDynamic("adMessageLong")(adMessageLong.get.asInstanceOf[js.Any])
    if (!js.isUndefined(adMessageNoDuration)) __obj.updateDynamic("adMessageNoDuration")(adMessageNoDuration.get.asInstanceOf[js.Any])
    if (!js.isUndefined(adNewWindowTip)) __obj.updateDynamic("adNewWindowTip")(adNewWindowTip.get.asInstanceOf[js.Any])
    if (!js.isUndefined(buffering)) __obj.updateDynamic("buffering")(buffering.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enterFullscreen)) __obj.updateDynamic("enterFullscreen")(enterFullscreen.get.asInstanceOf[js.Any])
    if (!js.isUndefined(exitFullscreen)) __obj.updateDynamic("exitFullscreen")(exitFullscreen.get.asInstanceOf[js.Any])
    if (!js.isUndefined(live)) __obj.updateDynamic("live")(live.get.asInstanceOf[js.Any])
    if (!js.isUndefined(liveStream)) __obj.updateDynamic("liveStream")(liveStream.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(progressLabelLongFormat)) __obj.updateDynamic("progressLabelLongFormat")(progressLabelLongFormat.get.asInstanceOf[js.Any])
    if (!js.isUndefined(progressLabelShortFormat)) __obj.updateDynamic("progressLabelShortFormat")(progressLabelShortFormat.get.asInstanceOf[js.Any])
    if (!js.isUndefined(relatedVideos)) __obj.updateDynamic("relatedVideos")(relatedVideos.get.asInstanceOf[js.Any])
    if (!js.isUndefined(replayButton)) __obj.updateDynamic("replayButton")(replayButton.get.asInstanceOf[js.Any])
    if (!js.isUndefined(replayTooltip)) __obj.updateDynamic("replayTooltip")(replayTooltip.get.asInstanceOf[js.Any])
    if (!js.isUndefined(skipTo)) __obj.updateDynamic("skipTo")(skipTo.get.asInstanceOf[js.Any])
