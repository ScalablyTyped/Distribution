...
object IgCategoryChart {
  ...
  @scala.inline
  implicit class IgCategoryChartOps[Self <: IgCategoryChart] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIsCategoryHighlightingEnabled(value: Boolean): Self = this.set("isCategoryHighlightingEnabled", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIsCategoryHighlightingEnabled: Self = this.set("isCategoryHighlightingEnabled", js.undefined)
    ...
    @scala.inline
    def setIsItemHighlightingEnabled(value: Boolean): Self = this.set("isItemHighlightingEnabled", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIsItemHighlightingEnabled: Self = this.set("isItemHighlightingEnabled", js.undefined)
    ...
    @scala.inline
    def setTransitionInEasingFunction(value: js.Any): Self = this.set("transitionInEasingFunction", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTransitionInEasingFunction: Self = this.set("transitionInEasingFunction", js.undefined)
    ...
    @scala.inline
    def setXAxisGap(value: Double): Self = this.set("xAxisGap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteXAxisGap: Self = this.set("xAxisGap", js.undefined)
    ...
    @scala.inline
    def setXAxisOverlap(value: Double): Self = this.set("xAxisOverlap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteXAxisOverlap: Self = this.set("xAxisOverlap", js.undefined)
