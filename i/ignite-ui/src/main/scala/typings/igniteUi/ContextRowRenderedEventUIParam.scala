...
trait ContextRowRenderedEventUIParam extends StObject {
  ...
  /**
    ...
    */
  var parentRows: js.UndefOr[js.Array[Any]] = js.undefined
}
object ContextRowRenderedEventUIParam {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ContextRowRenderedEventUIParam] (val x: Self) extends AnyVal {
    ...
    inline def setParentRows(value: js.Array[Any]): Self = StObject.set(x, "parentRows", value.asInstanceOf[js.Any])
    
    inline def setParentRowsUndefined: Self = StObject.set(x, "parentRows", js.undefined)
    
    inline def setParentRowsVarargs(value: Any*): Self = StObject.set(x, "parentRows", js.Array(value*))
  }
}
