...
object IgPivotGridDataSourceOptions {
  ...
  implicit class IgPivotGridDataSourceOptionsOps[Self <: IgPivotGridDataSourceOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFlatDataOptions(value: IgPivotGridDataSourceOptionsFlatDataOptions): Self = this.set("flatDataOptions", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setXmlaOptions(value: IgPivotGridDataSourceOptionsXmlaOptions): Self = this.set("xmlaOptions", value.asInstanceOf[js.Any])
    @scala.inline
