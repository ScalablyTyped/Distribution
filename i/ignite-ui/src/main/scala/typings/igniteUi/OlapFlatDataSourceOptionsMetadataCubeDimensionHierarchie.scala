...
object OlapFlatDataSourceOptionsMetadataCubeDimensionHierarchie {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OlapFlatDataSourceOptionsMetadataCubeDimensionHierarchie] (val x: Self) extends AnyVal {
    ...
    inline def setLevelsVarargs(value: OlapFlatDataSourceOptionsMetadataCubeDimensionHierarchieLevel*): Self = StObject.set(x, "levels", js.Array(value*))
