...
object IgCombo {
  ...
  def apply(
    ...
    animationHideDuration: js.UndefOr[Double] = js.undefined,
    animationShowDuration: js.UndefOr[Double] = js.undefined,
    ...
    delayInputChangeProcessing: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(allowCustomValue)) __obj.updateDynamic("allowCustomValue")(allowCustomValue.get.asInstanceOf[js.Any])
    if (!js.isUndefined(animationHideDuration)) __obj.updateDynamic("animationHideDuration")(animationHideDuration.get.asInstanceOf[js.Any])
    if (!js.isUndefined(animationShowDuration)) __obj.updateDynamic("animationShowDuration")(animationShowDuration.get.asInstanceOf[js.Any])
    if (!js.isUndefined(autoComplete)) __obj.updateDynamic("autoComplete")(autoComplete.get.asInstanceOf[js.Any])
    if (!js.isUndefined(autoSelectFirstMatch)) __obj.updateDynamic("autoSelectFirstMatch")(autoSelectFirstMatch.get.asInstanceOf[js.Any])
    if (!js.isUndefined(caseSensitive)) __obj.updateDynamic("caseSensitive")(caseSensitive.get.asInstanceOf[js.Any])
    if (clearButtonTitle != null) __obj.updateDynamic("clearButtonTitle")(clearButtonTitle.asInstanceOf[js.Any])
    if (!js.isUndefined(closeDropDownOnBlur)) __obj.updateDynamic("closeDropDownOnBlur")(closeDropDownOnBlur.get.asInstanceOf[js.Any])
    if (!js.isUndefined(closeDropDownOnSelect)) __obj.updateDynamic("closeDropDownOnSelect")(closeDropDownOnSelect.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(delayInputChangeProcessing)) __obj.updateDynamic("delayInputChangeProcessing")(delayInputChangeProcessing.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(dropDownOnFocus)) __obj.updateDynamic("dropDownOnFocus")(dropDownOnFocus.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableClearButton)) __obj.updateDynamic("enableClearButton")(enableClearButton.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(selectItemBySpaceKey)) __obj.updateDynamic("selectItemBySpaceKey")(selectItemBySpaceKey.get.asInstanceOf[js.Any])
