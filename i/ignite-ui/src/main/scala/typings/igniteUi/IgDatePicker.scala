...
/* optionName */ StringDictionary[Any] {
  ...
  /**
    ...
    *
    */
  var datepickerOptions: js.UndefOr[Any] = js.undefined
...
object IgDatePicker {
  ...
  inline def apply(): IgDatePicker = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IgDatePicker]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: IgDatePicker] (val x: Self) extends AnyVal {
    ...
    inline def setDatepickerOptions(value: Any): Self = StObject.set(x, "datepickerOptions", value.asInstanceOf[js.Any])
    
    inline def setDatepickerOptionsUndefined: Self = StObject.set(x, "datepickerOptions", js.undefined)
    ...
    inline def setItemSelected(value: (/* event */ Event, /* ui */ ItemSelectedEventUIParam) => Unit): Self = StObject.set(x, "itemSelected", js.Any.fromFunction2(value))
