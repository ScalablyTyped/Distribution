...
object IgPivotGridDataSourceOptionsFlatDataOptions {
  ...
  inline def apply(): IgPivotGridDataSourceOptionsFlatDataOptions = {
  ...
  extension [Self <: IgPivotGridDataSourceOptionsFlatDataOptions](x: Self) {
    ...
    inline def setMetadata(value: IgPivotGridDataSourceOptionsFlatDataOptionsMetadata): Self = StObject.set(x, "metadata", value.asInstanceOf[js.Any])
