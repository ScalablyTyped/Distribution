...
object IgPivotGridDataSourceOptionsFlatDataOptions {
  ...
  @scala.inline
  implicit class IgPivotGridDataSourceOptionsFlatDataOptionsOps[Self <: IgPivotGridDataSourceOptionsFlatDataOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMetadata(value: IgPivotGridDataSourceOptionsFlatDataOptionsMetadata): Self = this.set("metadata", value.asInstanceOf[js.Any])
    @scala.inline
