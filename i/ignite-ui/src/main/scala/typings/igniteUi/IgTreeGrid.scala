...
object IgTreeGrid {
  ...
  implicit class IgTreeGridOps[Self <: IgTreeGrid] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAvgColumnWidth(value: js.Any): Self = this.set("avgColumnWidth", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAvgColumnWidth: Self = this.set("avgColumnWidth", js.undefined)
    @scala.inline
    def setAvgRowHeight(value: Double): Self = this.set("avgRowHeight", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setColumnVirtualization(value: js.Any): Self = this.set("columnVirtualization", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDataSourceSettings(value: IgTreeGridDataSourceSettings): Self = this.set("dataSourceSettings", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setForeignKeyRootValue(value: Double | String): Self = this.set("foreignKeyRootValue", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteForeignKeyRootValue: Self = this.set("foreignKeyRootValue", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setInitialIndentationLevel(value: Double): Self = this.set("initialIndentationLevel", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteInitialIndentationLevel: Self = this.set("initialIndentationLevel", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setLocale(value: IgTreeGridLocale): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRenderExpansionCellFunction(value: String | js.Object): Self = this.set("renderExpansionCellFunction", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRenderExpansionCellFunction: Self = this.set("renderExpansionCellFunction", js.undefined)
    @scala.inline
    def setRenderExpansionIndicatorColumn(value: Boolean): Self = this.set("renderExpansionIndicatorColumn", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRenderExpansionIndicatorColumn: Self = this.set("renderExpansionIndicatorColumn", js.undefined)
    @scala.inline
    def setRenderFirstDataCellFunction(value: String | js.Object): Self = this.set("renderFirstDataCellFunction", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRenderFirstDataCellFunction: Self = this.set("renderFirstDataCellFunction", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setRestSettings(value: IgTreeGridRestSettings): Self = this.set("restSettings", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRestSettings: Self = this.set("restSettings", js.undefined)
    @scala.inline
    def setRowCollapsed(value: (/* event */ Event, /* ui */ RowCollapsedEventUIParam) => Unit): Self = this.set("rowCollapsed", js.Any.fromFunction2(value))
    @scala.inline
    def deleteRowCollapsed: Self = this.set("rowCollapsed", js.undefined)
    @scala.inline
    def setRowCollapsing(value: (/* event */ Event, /* ui */ RowCollapsingEventUIParam) => Unit): Self = this.set("rowCollapsing", js.Any.fromFunction2(value))
    @scala.inline
    def deleteRowCollapsing: Self = this.set("rowCollapsing", js.undefined)
    @scala.inline
    def setRowExpanded(value: (/* event */ Event, /* ui */ RowExpandedEventUIParam) => Unit): Self = this.set("rowExpanded", js.Any.fromFunction2(value))
    @scala.inline
    def deleteRowExpanded: Self = this.set("rowExpanded", js.undefined)
    @scala.inline
    def setRowExpanding(value: (/* event */ Event, /* ui */ RowExpandingEventUIParam) => Unit): Self = this.set("rowExpanding", js.Any.fromFunction2(value))
    @scala.inline
    def deleteRowExpanding: Self = this.set("rowExpanding", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setShowExpansionIndicator(value: Boolean): Self = this.set("showExpansionIndicator", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteShowExpansionIndicator: Self = this.set("showExpansionIndicator", js.undefined)
    @scala.inline
