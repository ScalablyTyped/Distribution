...
object IgTreeGrid {
  ...
  def apply(
    ...
    avgRowHeight: js.UndefOr[Double] = js.undefined,
    caption: String = null,
    ...
    initialIndentationLevel: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(avgRowHeight)) __obj.updateDynamic("avgRowHeight")(avgRowHeight.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(initialIndentationLevel)) __obj.updateDynamic("initialIndentationLevel")(initialIndentationLevel.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(renderExpansionIndicatorColumn)) __obj.updateDynamic("renderExpansionIndicatorColumn")(renderExpansionIndicatorColumn.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showExpansionIndicator)) __obj.updateDynamic("showExpansionIndicator")(showExpansionIndicator.get.asInstanceOf[js.Any])
