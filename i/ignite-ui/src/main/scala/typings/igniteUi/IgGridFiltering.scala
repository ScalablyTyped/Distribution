...
object IgGridFiltering {
  ...
  @scala.inline
  implicit class IgGridFilteringOps[Self <: IgGridFiltering] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setLocale(value: IgGridFilteringLocale): Self = this.set("locale", value.asInstanceOf[js.Any])
    @scala.inline
