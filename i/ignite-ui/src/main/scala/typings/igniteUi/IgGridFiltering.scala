...
object IgGridFiltering {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    dataFiltered: (/* event */ Event_, /* ui */ DataFilteredEventUIParam) => Unit = null,
    dataFiltering: (/* event */ Event_, /* ui */ DataFilteringEventUIParam) => Unit = null,
    ...
    filterDialogClosed: (/* event */ Event_, /* ui */ FilterDialogClosedEventUIParam) => Unit = null,
    filterDialogClosing: (/* event */ Event_, /* ui */ FilterDialogClosingEventUIParam) => Unit = null,
    filterDialogColumnDropDownDefaultWidth: String | Double = null,
    filterDialogContainment: String = null,
    filterDialogContentsRendered: (/* event */ Event_, /* ui */ FilterDialogContentsRenderedEventUIParam) => Unit = null,
    filterDialogContentsRendering: (/* event */ Event_, /* ui */ FilterDialogContentsRenderingEventUIParam) => Unit = null,
    filterDialogExprInputDefaultWidth: String | Double = null,
    filterDialogFilterAdded: (/* event */ Event_, /* ui */ FilterDialogFilterAddedEventUIParam) => Unit = null,
    filterDialogFilterAdding: (/* event */ Event_, /* ui */ FilterDialogFilterAddingEventUIParam) => Unit = null,
    ...
    filterDialogFiltering: (/* event */ Event_, /* ui */ FilterDialogFilteringEventUIParam) => Unit = null,
    filterDialogHeight: String | Double = null,
    filterDialogMaxFilterCount: Int | Double = null,
    filterDialogMoving: (/* event */ Event_, /* ui */ FilterDialogMovingEventUIParam) => Unit = null,
    filterDialogOkCancelButtonWidth: String | Double = null,
    filterDialogOpened: (/* event */ Event_, /* ui */ FilterDialogOpenedEventUIParam) => Unit = null,
    filterDialogOpening: (/* event */ Event_, /* ui */ FilterDialogOpeningEventUIParam) => Unit = null,
