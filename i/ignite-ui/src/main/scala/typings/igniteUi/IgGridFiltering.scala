...
object IgGridFiltering {
  ...
  def apply(
    ...
    filterDialogMaxFilterCount: js.UndefOr[Double] = js.undefined,
    ...
    filterDropDownAnimationDuration: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(advancedModeEditorsVisible)) __obj.updateDynamic("advancedModeEditorsVisible")(advancedModeEditorsVisible.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(filterDialogMaxFilterCount)) __obj.updateDynamic("filterDialogMaxFilterCount")(filterDialogMaxFilterCount.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(filterDropDownAnimationDuration)) __obj.updateDynamic("filterDropDownAnimationDuration")(filterDropDownAnimationDuration.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(filterDropDownItemIcons)) __obj.updateDynamic("filterDropDownItemIcons")(filterDropDownItemIcons.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(filterSummaryAlwaysVisible)) __obj.updateDynamic("filterSummaryAlwaysVisible")(filterSummaryAlwaysVisible.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(renderFC)) __obj.updateDynamic("renderFC")(renderFC.get.asInstanceOf[js.Any])
    if (!js.isUndefined(renderFilterButton)) __obj.updateDynamic("renderFilterButton")(renderFilterButton.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showEmptyConditions)) __obj.updateDynamic("showEmptyConditions")(showEmptyConditions.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showNullConditions)) __obj.updateDynamic("showNullConditions")(showNullConditions.get.asInstanceOf[js.Any])
