...
@js.native
trait IgTreeGridMethods extends js.Object {
  /**
  ...
  /**
    ...
    */
  def collapseRow(row: js.Object): Unit = js.native
  def collapseRow(row: js.Object, callback: js.Function): Unit = js.native
  /**
  ...
  /**
    ...
    * @param callback Specifies a custom function to be called when row is expanded/collapsed. The callback has 4 arguments- a reference to the current context(this), object that holds 2 properties(unfixedRow - DOM representation of the unfixed row, fixedRow - DOM representation of the fixed row, if there is no fixed columns it is undefined), reference to the dataRecord, expand - specifies whether row is expanded
    */
  def expandRow(row: js.Object): Unit = js.native
  def expandRow(row: js.Object, callback: js.Function): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def renderNewChild(rec: js.Object): Unit = js.native
  def renderNewChild(rec: js.Object, parentId: String): Unit = js.native
  /**
  ...
  /**
    ...
    * @param callback Specifies a custom function to be called when row is expanded/collapsed. The callback has 4 arguments- a reference to the current context(this), object that holds 2 properties(unfixedRow - DOM representation of the unfixed row, fixedRow - DOM representation of the fixed row, if there is no fixed columns it is undefined), reference to the dataRecord, expand - specifies whether row is expanded
    */
  def toggleRow(row: js.Object): Unit = js.native
  def toggleRow(row: js.Object, callback: js.Function): Unit = js.native
  /**
