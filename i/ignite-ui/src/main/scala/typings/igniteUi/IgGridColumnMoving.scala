...
object IgGridColumnMoving {
  ...
  def apply(
    ...
    dragHelperOpacity: js.UndefOr[Double] = js.undefined,
    ...
    movingAcceptanceTolerance: js.UndefOr[Double] = js.undefined,
    movingDialogAnimationDuration: js.UndefOr[Double] = js.undefined,
    ...
    movingDialogHeight: js.UndefOr[Double] = js.undefined,
    ...
    movingDialogWidth: js.UndefOr[Double] = js.undefined,
    movingScrollTolerance: js.UndefOr[Double] = js.undefined,
    movingToolTipMove: String = null,
    regional: String | js.Object = null,
    scrollDelta: js.UndefOr[Double] = js.undefined,
    scrollSpeedMultiplier: js.UndefOr[Double] = js.undefined
  ): IgGridColumnMoving = {
    val __obj = js.Dynamic.literal()
    if (StringDictionary != null) js.Dynamic.global.Object.assign(__obj, StringDictionary)
    if (!js.isUndefined(addMovingDropdown)) __obj.updateDynamic("addMovingDropdown")(addMovingDropdown.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(dragHelperOpacity)) __obj.updateDynamic("dragHelperOpacity")(dragHelperOpacity.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(hideHeaderContentsDuringDrag)) __obj.updateDynamic("hideHeaderContentsDuringDrag")(hideHeaderContentsDuringDrag.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(movingAcceptanceTolerance)) __obj.updateDynamic("movingAcceptanceTolerance")(movingAcceptanceTolerance.get.asInstanceOf[js.Any])
    if (!js.isUndefined(movingDialogAnimationDuration)) __obj.updateDynamic("movingDialogAnimationDuration")(movingDialogAnimationDuration.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(movingDialogHeight)) __obj.updateDynamic("movingDialogHeight")(movingDialogHeight.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(movingDialogWidth)) __obj.updateDynamic("movingDialogWidth")(movingDialogWidth.get.asInstanceOf[js.Any])
    if (!js.isUndefined(movingScrollTolerance)) __obj.updateDynamic("movingScrollTolerance")(movingScrollTolerance.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(scrollSpeedMultiplier)) __obj.updateDynamic("scrollSpeedMultiplier")(scrollSpeedMultiplier.get.asInstanceOf[js.Any])
