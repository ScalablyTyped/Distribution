...
object IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCubeDimension {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCubeDimension] (val x: Self) extends AnyVal {
    ...
    inline def setHierarchiesVarargs(value: IgPivotGridDataSourceOptionsFlatDataOptionsMetadataCubeDimensionHierarchie*): Self = StObject.set(x, "hierarchies", js.Array(value*))
