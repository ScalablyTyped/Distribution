...
object IgHtmlEditor {
  ...
  def apply(
    ...
    if (!js.isUndefined(showCopyPasteToolbar)) __obj.updateDynamic("showCopyPasteToolbar")(showCopyPasteToolbar.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showFormattingToolbar)) __obj.updateDynamic("showFormattingToolbar")(showFormattingToolbar.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showInsertObjectToolbar)) __obj.updateDynamic("showInsertObjectToolbar")(showInsertObjectToolbar.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showTextToolbar)) __obj.updateDynamic("showTextToolbar")(showTextToolbar.get.asInstanceOf[js.Any])
