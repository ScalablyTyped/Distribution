...
object IgDoughnutChart {
  ...
  def apply(
    ...
    innerExtent: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(allowSliceExplosion)) __obj.updateDynamic("allowSliceExplosion")(allowSliceExplosion.get.asInstanceOf[js.Any])
    if (!js.isUndefined(allowSliceSelection)) __obj.updateDynamic("allowSliceSelection")(allowSliceSelection.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(innerExtent)) __obj.updateDynamic("innerExtent")(innerExtent.get.asInstanceOf[js.Any])
