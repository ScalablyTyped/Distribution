...
object IgGridGroupBy {
  ...
  def apply(
    ...
    groupByLabelWidth: js.UndefOr[Double] = js.undefined,
    ...
    labelDragHelperOpacity: js.UndefOr[Double] = js.undefined,
    ...
    modalDialogDropDownAreaWidth: js.UndefOr[Double] = js.undefined,
    modalDialogDropDownButtonCaption: String = null,
    modalDialogDropDownLabel: String = null,
    modalDialogDropDownWidth: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(expansionIndicatorVisibility)) __obj.updateDynamic("expansionIndicatorVisibility")(expansionIndicatorVisibility.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(groupByLabelWidth)) __obj.updateDynamic("groupByLabelWidth")(groupByLabelWidth.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(initialExpand)) __obj.updateDynamic("initialExpand")(initialExpand.get.asInstanceOf[js.Any])
    if (!js.isUndefined(labelDragHelperOpacity)) __obj.updateDynamic("labelDragHelperOpacity")(labelDragHelperOpacity.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(modalDialogDropDownAreaWidth)) __obj.updateDynamic("modalDialogDropDownAreaWidth")(modalDialogDropDownAreaWidth.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(modalDialogDropDownWidth)) __obj.updateDynamic("modalDialogDropDownWidth")(modalDialogDropDownWidth.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(modalDialogGroupByOnClick)) __obj.updateDynamic("modalDialogGroupByOnClick")(modalDialogGroupByOnClick.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useGridColumnFormatter)) __obj.updateDynamic("useGridColumnFormatter")(useGridColumnFormatter.get.asInstanceOf[js.Any])
