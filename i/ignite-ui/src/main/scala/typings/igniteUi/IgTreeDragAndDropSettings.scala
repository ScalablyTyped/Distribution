...
object IgTreeDragAndDropSettings {
  ...
  def apply(
    ...
    dragStartDelay: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(dragStartDelay)) __obj.updateDynamic("dragStartDelay")(dragStartDelay.get.asInstanceOf[js.Any])
    if (!js.isUndefined(expandDelay)) __obj.updateDynamic("expandDelay")(expandDelay.get.asInstanceOf[js.Any])
    if (!js.isUndefined(expandOnDragOver)) __obj.updateDynamic("expandOnDragOver")(expandOnDragOver.get.asInstanceOf[js.Any])
