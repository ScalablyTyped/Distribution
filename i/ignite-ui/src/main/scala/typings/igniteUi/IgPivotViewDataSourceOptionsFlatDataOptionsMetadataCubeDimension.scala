...
object IgPivotViewDataSourceOptionsFlatDataOptionsMetadataCubeDimension {
  ...
  @scala.inline
  implicit class IgPivotViewDataSourceOptionsFlatDataOptionsMetadataCubeDimensionOps[Self <: IgPivotViewDataSourceOptionsFlatDataOptionsMetadataCubeDimension] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHierarchiesVarargs(value: IgPivotViewDataSourceOptionsFlatDataOptionsMetadataCubeDimensionHierarchie*): Self = this.set("hierarchies", js.Array(value :_*))
    
    @scala.inline
    def setHierarchies(value: js.Array[IgPivotViewDataSourceOptionsFlatDataOptionsMetadataCubeDimensionHierarchie]): Self = this.set("hierarchies", value.asInstanceOf[js.Any])
