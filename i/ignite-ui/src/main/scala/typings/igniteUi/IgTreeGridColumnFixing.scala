...
object IgTreeGridColumnFixing {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    columnFixed: (/* event */ Event_, /* ui */ ColumnFixedEventUIParam) => Unit = null,
    columnFixing: (/* event */ Event_, /* ui */ ColumnFixingEventUIParam) => Unit = null,
    columnFixingRefused: (/* event */ Event_, /* ui */ ColumnFixingRefusedEventUIParam) => Unit = null,
    columnSettings: js.Array[IgGridColumnFixingColumnSetting] = null,
    columnUnfixed: (/* event */ Event_, /* ui */ ColumnUnfixedEventUIParam) => Unit = null,
    columnUnfixing: (/* event */ Event_, /* ui */ ColumnUnfixingEventUIParam) => Unit = null,
    columnUnfixingRefused: (/* event */ Event_, /* ui */ ColumnUnfixingRefusedEventUIParam) => Unit = null,
