...
object IgTreeGridColumnFixing {
  ...
  def apply(
    ...
    if (!js.isUndefined(fixNondataColumns)) __obj.updateDynamic("fixNondataColumns")(fixNondataColumns.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(populateDataRowsAttributes)) __obj.updateDynamic("populateDataRowsAttributes")(populateDataRowsAttributes.get.asInstanceOf[js.Any])
    if (!js.isUndefined(scrollDelta)) __obj.updateDynamic("scrollDelta")(scrollDelta.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showFixButtons)) __obj.updateDynamic("showFixButtons")(showFixButtons.get.asInstanceOf[js.Any])
    if (!js.isUndefined(syncRowHeights)) __obj.updateDynamic("syncRowHeights")(syncRowHeights.get.asInstanceOf[js.Any])
