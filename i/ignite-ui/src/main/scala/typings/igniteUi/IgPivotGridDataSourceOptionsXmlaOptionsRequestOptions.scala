...
object IgPivotGridDataSourceOptionsXmlaOptionsRequestOptions {
  ...
  @scala.inline
  implicit class IgPivotGridDataSourceOptionsXmlaOptionsRequestOptionsOps[Self <: IgPivotGridDataSourceOptionsXmlaOptionsRequestOptions] (val x: Self) extends AnyVal {
