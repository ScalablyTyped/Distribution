...
object IgFinancialChart {
  ...
  implicit open class MutableBuilder[Self <: IgFinancialChart] (val x: Self) extends AnyVal {
    ...
    inline def setApplyCustomIndicators(value: (/* event */ Event, /* ui */ ApplyCustomIndicatorsEventUIParam) => Unit): Self = StObject.set(x, "applyCustomIndicators", js.Any.fromFunction2(value))
