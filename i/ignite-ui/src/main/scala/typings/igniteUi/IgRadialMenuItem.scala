...
object IgRadialMenuItem {
  ...
  def apply(
    ...
    innerAreaStrokeThickness: js.UndefOr[Double] = js.undefined,
    ...
    outerRingButtonStrokeThickness: js.UndefOr[Double] = js.undefined,
    ...
    wedgeIndex: js.UndefOr[Double] = js.undefined,
    wedgeSpan: js.UndefOr[Double] = js.undefined
  ): IgRadialMenuItem = {
    val __obj = js.Dynamic.literal()
    if (StringDictionary != null) js.Dynamic.global.Object.assign(__obj, StringDictionary)
    if (!js.isUndefined(autoRotateChildren)) __obj.updateDynamic("autoRotateChildren")(autoRotateChildren.get.asInstanceOf[js.Any])
    if (!js.isUndefined(autoUpdateRecentItem)) __obj.updateDynamic("autoUpdateRecentItem")(autoUpdateRecentItem.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(innerAreaStrokeThickness)) __obj.updateDynamic("innerAreaStrokeThickness")(innerAreaStrokeThickness.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isToolTipEnabled)) __obj.updateDynamic("isToolTipEnabled")(isToolTipEnabled.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(outerRingButtonStrokeThickness)) __obj.updateDynamic("outerRingButtonStrokeThickness")(outerRingButtonStrokeThickness.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(reserveFirstSlice)) __obj.updateDynamic("reserveFirstSlice")(reserveFirstSlice.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(wedgeIndex)) __obj.updateDynamic("wedgeIndex")(wedgeIndex.get.asInstanceOf[js.Any])
    if (!js.isUndefined(wedgeSpan)) __obj.updateDynamic("wedgeSpan")(wedgeSpan.get.asInstanceOf[js.Any])
