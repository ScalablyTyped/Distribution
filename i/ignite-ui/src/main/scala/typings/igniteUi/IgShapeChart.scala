...
object IgShapeChart {
  ...
  extension [Self <: IgShapeChart](x: Self) {
    ...
    inline def setMarkerCollision(value: String): Self = StObject.set(x, "markerCollision", value.asInstanceOf[js.Any])
    
    inline def setMarkerCollisionUndefined: Self = StObject.set(x, "markerCollision", js.undefined)
    ...
    inline def setXAxisAbbreviateLargeNumbers(value: Boolean): Self = StObject.set(x, "xAxisAbbreviateLargeNumbers", value.asInstanceOf[js.Any])
    
    inline def setXAxisAbbreviateLargeNumbersUndefined: Self = StObject.set(x, "xAxisAbbreviateLargeNumbers", js.undefined)
    ...
    inline def setXAxisIsLogarithmic(value: Boolean): Self = StObject.set(x, "xAxisIsLogarithmic", value.asInstanceOf[js.Any])
    
    inline def setXAxisIsLogarithmicUndefined: Self = StObject.set(x, "xAxisIsLogarithmic", js.undefined)
    ...
    inline def setXAxisLogarithmBase(value: Double): Self = StObject.set(x, "xAxisLogarithmBase", value.asInstanceOf[js.Any])
    
    inline def setXAxisLogarithmBaseUndefined: Self = StObject.set(x, "xAxisLogarithmBase", js.undefined)
    ...
    inline def setXAxisMaximumValue(value: Double): Self = StObject.set(x, "xAxisMaximumValue", value.asInstanceOf[js.Any])
    
    inline def setXAxisMaximumValueUndefined: Self = StObject.set(x, "xAxisMaximumValue", js.undefined)
    
    inline def setXAxisMinimumValue(value: Double): Self = StObject.set(x, "xAxisMinimumValue", value.asInstanceOf[js.Any])
