...
trait IgGridMethods extends js.Object {
  ...
  /**
  	 ...
  	 */
  def calculateAutoFitColumnWidth(columnIndex: scala.Double): scala.Double = js.native
  /**
  	 ...
  	 */
  def cellAt(x: scala.Double, y: scala.Double, isFixed: scala.Boolean): stdLib.Element = js.native
  /**
  	 ...
  	 */
  def cellById(rowId: js.Object, columnKey: java.lang.String): stdLib.Element = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def columnByKey(key: java.lang.String): js.Object = js.native
  /**
  	 ...
  	 */
  def columnByText(text: java.lang.String): js.Object = js.native
  /**
  ...
  /**
  	 ...
  	 * @param internal
  	 */
  def dataBind(internal: js.Object): scala.Unit = js.native
  /**
  	 ...
  	 */
  def dataSourceObject(dataSource: js.Object): scala.Unit = js.native
  /**
  	 ...
  	 */
  def destroy(notToCallDestroy: js.Object): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def fixedFootersTable(): stdLib.Element = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def fixedHeadersTable(): stdLib.Element = js.native
  /**
  	 ...
  	 */
  def fixedRowAt(i: scala.Double): stdLib.Element = js.native
  /**
  ...
  /**
  	 ...
  	 * @return left|right
  	 */
  def fixingDirection(): java.lang.String = js.native
  /**
  	 * Returns the table that contains the footer cells
  	 */
  def footersTable(): stdLib.Element = js.native
  /**
  	 ...
  	 */
  def getCellText(rowId: js.Object, colKey: java.lang.String): java.lang.String = js.native
  /**
  	 ...
  	 */
  def getCellValue(rowId: js.Object, colKey: java.lang.String): js.Object = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def getVisibleIndexByKey(columnKey: java.lang.String, includeDataSkip: scala.Boolean): scala.Double = js.native
  /**
  	 * Returns true if grid has at least one fixed columns(even if a non-data column - like row-selectors column)
  	 */
  def hasFixedColumns(): scala.Boolean = js.native
  /**
  	 * Returns whether grid has non-data fixed columns(e.g. row selectors column)
  	 */
  def hasFixedDataSkippedColumns(): scala.Boolean = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def headersTable(): stdLib.Element = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def isFixedColumn(colKey: js.Object): scala.Boolean = js.native
  /**
  	 * Returns whether the header identified by colKey is multicolumn header(has children)
  	 *
  	 * @param colKey value of the column key
  	 */
  def isGroupHeader(colKey: java.lang.String): js.Object = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def renderMultiColumnHeader(cols: js.Array[_]): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def resizeContainer(): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 * @param i The row index.
  	 */
  def rowAt(i: scala.Double): stdLib.Element = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def scrollContainer(): stdLib.Element = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def setUnboundValueByPK(col: java.lang.String, rowId: java.lang.String, `val`: js.Object, notToRender: js.Object): scala.Unit = js.native
  /**
  	 ...
  	 */
  def setUnboundValues(key: java.lang.String, values: js.Array[_], removeOldValues: js.Object): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def virtualScrollTo(scrollerPosition: js.Object): scala.Unit = js.native
  /**
