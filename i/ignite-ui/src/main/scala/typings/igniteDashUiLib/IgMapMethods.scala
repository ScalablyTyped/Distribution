...
trait IgMapMethods extends js.Object {
  /**
  	 ...
  	 */
  def addItem(item: js.Object, targetName: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def clearTileZoomCache(): scala.Unit = js.native
  /**
  	 * Destroys the widget.
  	 */
  ...
  /**
  	 ...
  	 */
  def endTiledZoomingIfRunning(): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 * @param targetName
  	 */
  def getActualMaximumValue(targetName: js.Object): scala.Unit = js.native
  /**
  	 * Gets the actual minimum value of the target xAxis or yAxis
  	 *
  	 * @param targetName
  	 */
  def getActualMinimumValue(targetName: js.Object): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 * @param targetName The name of the series bound to the data source.
  	 */
  def insertItem(item: js.Object, index: scala.Double, targetName: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def notifyContainerResized(): scala.Unit = js.native
  /**
  	 ...
  	 */
  def notifyInsertItem(dataSource: js.Object, index: scala.Double, newItem: js.Object): js.Object = js.native
  /**
  	 ...
  	 */
  def notifyRemoveItem(dataSource: js.Object, index: scala.Double, oldItem: js.Object): js.Object = js.native
  /**
  	 ...
  	 */
  def notifySetItem(dataSource: js.Object, index: scala.Double, newItem: js.Object, oldItem: js.Object): js.Object = js.native
  ...
  /**
  	 ...
  	 * @param targetName The name of the series bound to the data source.
  	 */
  def removeItem(index: scala.Double, targetName: java.lang.String): scala.Unit = js.native
  /**
  	 ...
  	 */
  def renderSeries(targetName: java.lang.String, animate: scala.Boolean): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def scaleValue(targetName: java.lang.String, unscaledValue: scala.Double): scala.Double = js.native
  /**
  	 ...
  	 */
  def scrollIntoView(targetName: java.lang.String, item: js.Object): js.Object = js.native
  /**
  	 ...
  	 * @param targetName The name of the series bound to the data source.
  	 */
  def setItem(index: scala.Double, item: js.Object, targetName: java.lang.String): scala.Unit = js.native
  /**
  	 * Manually starts a tiled zoom if one isn't already running.
  	 */
  def startTiledZoomingIfNecessary(): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def unscaleValue(targetName: java.lang.String, scaledValue: scala.Double): scala.Double = js.native
  /**
