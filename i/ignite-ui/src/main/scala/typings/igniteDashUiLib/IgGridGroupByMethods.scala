...
trait IgGridGroupByMethods extends js.Object {
  ...
  /**
  	 ...
  	 */
  def checkColumnIsGrouped(key: java.lang.String, layout: java.lang.String): scala.Unit = js.native
  /**
  	 * Close layouts dropdown
  	 */
  def closeDropDown(): scala.Unit = js.native
  /**
  	 * Close groupby modal dialog
  	 */
  def closeGroupByDialog(): scala.Unit = js.native
  /**
  	 * Expand group row with specified id
  	 *
  	 * @param rowId data-id attribute of the group row in the DOM
  	 */
  def collapse(rowId: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 * @param rowId data-id attribute of the group row in the DOM
  	 */
  def expand(rowId: java.lang.String): scala.Unit = js.native
  /**
  	 ...
  	 */
  def getGroupedData(data: js.Array[_], colKey: java.lang.String): js.Array[_] = js.native
  def getGroupedData(data: js.Array[_], colKey: java.lang.String, idval: java.lang.String): js.Array[_] = js.native
  /**
  	 * Groups by a column
  	 *
  	 ...
  	 */
  def groupByColumn(key: java.lang.String): scala.Unit = js.native
  def groupByColumn(key: java.lang.String, layout: java.lang.String): scala.Unit = js.native
  def groupByColumn(key: java.lang.String, layout: java.lang.String, sortingDirection: js.Object): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def openDropDown(): scala.Unit = js.native
  /**
  	 * Open groupby modal dialog
  	 */
  def openGroupByDialog(): scala.Unit = js.native
  /**
  	 * Render groupby modal dialog and its content
  	 */
  def renderGroupByModalDialog(): scala.Unit = js.native
  /**
  	 * Clears the group by columns list and updates the view.
  	 */
  def ungroupAll(): scala.Unit = js.native
  /**
  	 ...
  	 * @param layout Layout is an optional parameter. If set it means the grouped column is not in the root level but is a child layout column.
  	 */
  def ungroupByColumn(key: java.lang.String): scala.Unit = js.native
  def ungroupByColumn(key: java.lang.String, layout: java.lang.String): scala.Unit = js.native
}
