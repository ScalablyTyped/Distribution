...
trait IgFunnelChartMethods extends js.Object {
  ...
  /**
  	 ...
  	 */
  def findIndexOfItem(item: js.Object): scala.Double = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def insertItem(item: js.Object, index: scala.Double): js.Object = js.native
  /**
  	 * Checks if slice is selected.
  	 *
  	 * @param slice Index of slice or reference to slice-data-item.
  	 */
  def isSelected(slice: js.Object): scala.Boolean = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def removeItem(index: scala.Double): js.Object = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def setItem(index: scala.Double, item: js.Object): js.Object = js.native
  /**
