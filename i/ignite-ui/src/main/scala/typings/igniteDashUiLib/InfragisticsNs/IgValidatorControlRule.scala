...
class IgValidatorControlRule protected () extends js.Object {
  ...
  /**
  	 ...
  	 * @param options
  	 */
  def getRuleMessage(options: js.Object): scala.Unit = js.native
  def isValid(options: js.Object): scala.Unit = js.native
  def shouldRun(options: js.Object, value: js.Object): scala.Unit = js.native
}
