...
class SortingExpressionsManager () extends js.Object {
  /**
  	 ...
  	 * @param feature
  	 */
  def addSortingExpression(se: js.Object, expr: js.Object, feature: js.Object): scala.Unit = js.native
  def setFormattersForSortingExprs(exprs: js.Object, grid: js.Object): scala.Unit = js.native
  def setGridInstance(grid: js.Object): scala.Unit = js.native
}
