...
class TreeHierarchicalDataSource protected () extends js.Object {
  def this(settings: igniteDashUiLib.TreeHierarchicalDataSourceSettings) = this()
  /**
  ...
  /**
  	 ...
  	 */
  def clearMatchFiltering(): scala.Unit = js.native
  def clearMatchFiltering(data: js.Object): scala.Unit = js.native
  /**
  ...
  def findRecordByKey(key: js.Object, ds: java.lang.String, objPath: js.Object): js.Object = js.native
  /**
  ...
  def generateFlatData(data: js.Object, level: scala.Double): js.Object = js.native
  /**
  	 * Generates a flat data view from the current (hierarchical)data
  	 */
  def generateFlatDataView(): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def getDataBoundDepth(): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def getExpandStateById(rowId: java.lang.String): scala.Boolean = js.native
  /**
  	 * Gets the count of the filtered records
  	 */
  def getFilteredRecordsCount(): scala.Double = js.native
  /**
  	 * Gets the count of the filtered records in the dataView
  	 */
  def getFilteredRecordsCountFromDataView(): scala.Double = js.native
  /**
  	 ...
  	 */
  def getFilteringMatchRecordsCount(): scala.Double = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def getFlatDataCount(): scala.Double = js.native
  /**
  ...
  def getFlatDataForRecord(record: js.Object, level: scala.Double): js.Object = js.native
  /**
  ...
  /**
  	 ...
  	 * @param record
  	 */
  def getPathBy(record: js.Object): java.lang.String = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def isTransformedToHierarchicalData(): scala.Unit = js.native
  def isTransformedToHierarchicalData(isTransformed: scala.Boolean): scala.Unit = js.native
  /**
  ...
  def processDataPerLevel(data: js.Object, level: scala.Double): js.Object = js.native
  def processDataPerLevel(data: js.Object, level: scala.Double, suppressTransformation: scala.Boolean): js.Object = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def setExpandedStateByPrimaryKey(rowId: java.lang.String, expanded: scala.Boolean, callbackArgs: js.Function): scala.Unit = js.native
  /**
  	 ...
  	 * @param callbackArgs Specifies a custom function to be called when the state of the row is changed.
  	 */
  def setExpandedStateByRowIndex(index: scala.Double, expanded: scala.Boolean, callbackArgs: js.Function): scala.Unit = js.native
  /**
  	 * Gets whether the flat data view should be generated by calling the generateFlatDataView method.
  	 */
  def shouldCallGenerateFlatDataView(): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 * @param direction asc / desc direction
  	 */
  def sortData(data: js.Object, fields: js.Object, direction: java.lang.String): scala.Unit = js.native
  /**
  	 ...
  	 * @param direction asc / desc direction
  	 */
  def sortDataRecursive(data: js.Object, level: scala.Double, fields: js.Object, direction: java.lang.String): scala.Unit = js.native
  /**
  	 * Gets/sets a list of paging settings
  	 *
  ...
  /**
  	 ...
  	 * @param callbackArgs Specifies a custom function to be called when the state of the row is changed.
  	 */
  def toggleRow(rowId: java.lang.String, callbackArgs: js.Function): scala.Unit = js.native
  /**
