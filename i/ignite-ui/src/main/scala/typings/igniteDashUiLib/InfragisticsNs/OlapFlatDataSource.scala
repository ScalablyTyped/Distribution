...
class OlapFlatDataSource protected () extends js.Object {
  def this(options: igniteDashUiLib.OlapFlatDataSourceOptions) = this()
  /**
  	 ...
  	 */
  def addColumnItem(columnItem: js.Object): scala.Unit = js.native
  /**
  	 ...
  	 */
  def addFilterItem(filterItem: js.Object): scala.Unit = js.native
  /**
  	 ...
  	 */
  def addFilterMember(hierarchyUniqueName: java.lang.String, memberUniqueName: java.lang.String): scala.Unit = js.native
  /**
  	 ...
  	 */
  def addMeasureItem(measureItem: js.Object): scala.Unit = js.native
  /**
  	 ...
  	 */
  def addRowItem(rowItem: js.Object): scala.Unit = js.native
  /**
  	 * Clears all pending changes since last time the update() method is called.
  	 */
  def clearPendingChanges(): scala.Unit = js.native
  /**
  	 ...
  	 */
  def collapseTupleMember(axisName: java.lang.String, tupleIndex: scala.Double, memberIndex: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 * @param memberIndex the index of the member in the tuple.
  	 */
  def expandTupleMember(axisName: java.lang.String, tupleIndex: scala.Double, memberIndex: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def getDimension(dimensionUniqueName: java.lang.String): js.Object = js.native
  /**
  	 ...
  	 */
  def getFilterMemberNames(hierarchyUniqueName: java.lang.String): js.Array[_] = js.native
  /**
  	 ...
  	 */
  def getHierarchy(hierarchyUniqueName: java.lang.String): js.Object = js.native
  /**
  	 * Returns $.ig.Level object for the specified unique name.
  	 *
  	 * @param levelUniqueName the unique name of the searched level object.
  	 */
  def getLevel(levelUniqueName: java.lang.String): js.Object = js.native
  /**
  	 ...
  	 */
  def getMeasure(measureUniqueName: java.lang.String): js.Object = js.native
  /**
  ...
  /**
  	 ...
  	 * @param hierarchyUniqueName the unique name of the hierarchy whose active filter members are returned.
  	 */
  def getMembersOfHierarchy(hierarchyUniqueName: java.lang.String): scala.Unit = js.native
  /**
  	 ...
  	 */
  def getMembersOfLevel(levelUniqueName: java.lang.String): scala.Unit = js.native
  /**
  	 ...
  	 */
  def getMembersOfMember(memberUniqueName: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def isUpdating(): scala.Boolean = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def removeAllFilterMembers(hierarchyUniqueName: java.lang.String): scala.Unit = js.native
  /**
  	 ...
  	 */
  def removeColumnItem(columnItem: js.Object): scala.Unit = js.native
  /**
  	 ...
  	 */
  def removeFilterItem(filterItem: js.Object): scala.Unit = js.native
  /**
  	 ...
  	 */
  def removeFilterMember(hierarchyUniqueName: java.lang.String, memberUniqueName: java.lang.String): scala.Unit = js.native
  /**
  	 ...
  	 */
  def removeMeasureItem(measureItem: js.Object): scala.Unit = js.native
  /**
  	 ...
  	 */
  def removeRowItem(rowItem: js.Object): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def setCube(cubeName: java.lang.String): js.Object = js.native
  /**
  	 ...
  	 */
  def setMeasureListIndex(index: scala.Double): scala.Unit = js.native
  /**
  	 * Sets the location of the measure list.
  	 *
  	 * @param location accepted values are 'rows' and 'columns'.
  	 */
  def setMeasureListLocation(location: js.Object): scala.Unit = js.native
  /**
