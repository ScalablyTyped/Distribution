...
class Measure () extends js.Object {
  /**
  	 ...
  	 * @param value
  	 */
  def aggregatorType(value: js.Object): scala.Double = js.native
  /**
  ...
  /**
  	 ...
  	 * @param value
  	 */
  def defaultFormatString(value: js.Object): java.lang.String = js.native
  /**
  ...
  /**
  	 ...
  	 * @param value
  	 */
  def measureDisplayFolder(value: js.Object): java.lang.String = js.native
  /**
  	 * Returns the name of the measure group this measure belongs to.
  	 *
  	 * @param value
  	 */
  def measureGroupName(value: js.Object): java.lang.String = js.native
  /**
