...
class Cube () extends js.Object {
  ...
  /**
  	 ...
  	 * @param value
  	 */
  def cubeType(value: js.Object): scala.Double = js.native
  /**
  	 * Returns a user-friendly description of the cube.
  	 *
  	 * @param value
  	 */
  def description(value: js.Object): java.lang.String = js.native
  /**
  ...
  /**
  	 ...
  	 * @param value
  	 */
  def name(value: js.Object): java.lang.String = js.native
  /**
