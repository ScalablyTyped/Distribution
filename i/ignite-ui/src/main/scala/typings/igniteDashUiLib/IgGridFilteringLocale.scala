...
/* optionName */ org.scalablytyped.runtime.StringDictionary[js.Any] {
  /**
  	 ...
  	 *
  	 */
  var advancedButtonLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * 'After' label that is used for the predefined filtering conditions in the filter dropdowns.
  	 *
  	 */
  var afterLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  ...
  /**
  	 ...
  	 *
  	 */
  var filterDialogAddLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Specifies the All label for the filtering dialog.
  	 *
  	 */
  var filterDialogAllLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Specifies the Any label for the filtering dialog.
  	 *
  	 */
  var filterDialogAnyLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Specifies the dialog's Cancel button label.
  	 *
  	 */
  var filterDialogCancelLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Specifies the filter dialog caption label.
  	 *
  	 */
  var filterDialogCaptionLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Specifies clear all label in the filter dialog.
  	 *
  	 */
  var filterDialogClearAllLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Specifies the Close label for the filtering dialog.
  	 *
  	 */
  var filterDialogCloseLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Specifies the filter condition drop-down label.
  	 *
  	 */
  var filterDialogConditionDropDownLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Specifies the filter condition label.
  	 *
  	 */
  var filterDialogConditionLabel1: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Specifies the filter condition label.
  	 *
  	 */
  var filterDialogConditionLabel2: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Specifies the Error label for the filtering dialog.
  	 *
  	 */
  var filterDialogErrorLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Specifies the dialog's Ok button label.
  	 *
  	 */
  var filterDialogOkLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  ...
  /**
  	 ...
  	 *
  	 */
  var notEmptyNullText: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Not empty null text that will be used for the filter editors.
  	 *
  	 */
  var notNullNullText: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * 'Not On' label that is used for the predefined filtering conditions in the filter dropdowns.
  	 *
  	 */
  var notOnLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Not on null text that will be used for the filter editors.
  	 *
  	 */
  var notOnNullText: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * Not empty null text that will be used for the filter editors.
  	 *
  	 */
  var nullNullText: js.UndefOr[java.lang.String] = js.undefined
  /**
  ...
  /**
  	 ...
  	 *
  	 */
  var onNullText: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * 'Starts with' label that is used for the predefined filtering conditions in the filter dropdowns.
  	 *
  	 */
  var startsWithLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * StartsWith null text that will be used for the filter editors.
  	 *
  	 */
  var startsWithNullText: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * 'This Month' label that is used for the predefined filtering conditions in the filter dropdowns.
  	 *
  	 */
  var thisMonthLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * 'This Year' label that is used for the predefined filtering conditions in the filter dropdowns.
  	 *
  	 */
  var thisYearLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * 'Today' label that is used for the predefined filtering conditions in the filter dropdowns.
  	 *
  	 */
  var todayLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  ...
  /**
  	 ...
  	 *
  	 */
  var trueLabel: js.UndefOr[java.lang.String] = js.undefined
  /**
  	 * 'Yesterday' label that is used for the predefined filtering conditions in the filter dropdowns.
  	 *
  	 */
  var yesterdayLabel: js.UndefOr[java.lang.String] = js.undefined
}
