...
trait IgDataChartMethods extends js.Object {
  ...
  /**
  	 ...
  	 */
  def getActualInterval(targetName: java.lang.String): scala.Unit = js.native
  /**
  	 ...
  	 */
  def getActualMaximumValue(targetName: java.lang.String): scala.Unit = js.native
  /**
  	 ...
  	 */
  def getActualMinimumValue(targetName: java.lang.String): scala.Unit = js.native
  /**
  	 ...
  	 */
  def getItem(targetName: java.lang.String, worldPoint: js.Object): js.Object = js.native
  /**
  	 * Gets the item that is the best match for the specified world coordinates.
  	 *
  	 * @param targetName The name of the series to target.
  	 ...
  	 */
  def getItemFromSeriesPixel(targetName: java.lang.String, seriesPoint: js.Object): js.Object = js.native
  /**
  	 ...
  	 * @param worldPoint The world position (in the form {x: [number from 0 to 1], y: [number from 0 to 1]} ) that represents a position in the space of the axes.
  	 */
  def getItemIndex(targetName: java.lang.String, worldPoint: js.Object): scala.Double = js.native
  /**
  	 ...
  	 */
  def getItemIndexFromSeriesPixel(targetName: java.lang.String, seriesPoint: js.Object): scala.Double = js.native
  /**
  	 ...
  	 * @param targetName The name of the series to target.
  	 */
  def getItemSpan(targetName: java.lang.String): scala.Double = js.native
  /**
  	 * Gets the category width for a series, if applicable.
  	 *
  	 * @param targetName The name of the series to target.
  	 */
  def getSeriesCategoryWidth(targetName: java.lang.String): scala.Double = js.native
  /**
  ...
  /**
  	 ...
  	 * @param skipUnknowns If true, unknown values should be skipped.
  	 */
  def getSeriesHighValueFromSeriesPixel(
    targetName: java.lang.String,
  ...
  /**
  	 ...
  	 * @param skipUnknowns If true, unknown values should be skipped.
  	 */
  def getSeriesHighValuePosition(
    targetName: java.lang.String,
    worldPoint: js.Object,
    useInterpolation: scala.Boolean,
    skipUnknowns: scala.Boolean
  ...
  /**
  	 ...
  	 * @param skipUnknowns If true, unknown values should be skipped.
  	 */
  def getSeriesHighValuePositionFromSeriesPixel(
    targetName: java.lang.String,
    seriesPoint: js.Object,
    useInterpolation: scala.Boolean,
    skipUnknowns: scala.Boolean
  ...
  /**
  	 ...
  	 * @param skipUnknowns If true, unknown values should be skipped.
  	 */
  def getSeriesLowValueFromSeriesPixel(
    targetName: java.lang.String,
    seriesPoint: js.Object,
    useInterpolation: scala.Boolean,
    skipUnknowns: scala.Boolean
  ...
  /**
  	 ...
  	 * @param skipUnknowns If true, unknown values should be skipped.
  	 */
  def getSeriesLowValuePositionFromSeriesPixel(
    targetName: java.lang.String,
    seriesPoint: js.Object,
    useInterpolation: scala.Boolean,
    skipUnknowns: scala.Boolean
  ...
  /**
  	 ...
  	 * @param targetName The name of the series to target.
  	 */
  def getSeriesOffsetValue(targetName: java.lang.String): scala.Double = js.native
  /**
  ...
  /**
  	 ...
  	 * @param worldPoint The world position (in the form {x: [number from 0 to 1], y: [number from 0 to 1]} ) that represents a position in the space of the axes.
  	 */
  def getSeriesValueBoundingBox(targetName: java.lang.String, worldPoint: js.Object): js.Object = js.native
  /**
  	 ...
  	 * @param seriesPoint The series pixel position (in the form {x: [number], y: [number]} ) that represents a position in the pixel space of the series.
  	 */
  def getSeriesValueBoundingBoxFromSeriesPixel(targetName: java.lang.String, seriesPoint: js.Object): js.Object = js.native
  /**
  	 ...
  	 * @param worldPoint The world position (in the form {x: [number from 0 to 1], y: [number from 0 to 1]} ) that represents a position in the space of the axes.
  	 */
  def getSeriesValueFineGrainedBoundingBoxes(targetName: java.lang.String, worldPoint: js.Object): js.Object = js.native
  /**
  	 ...
  	 */
  def getSeriesValueFineGrainedBoundingBoxesFromSeriesPixel(targetName: java.lang.String, worldPoint: js.Object): js.Object = js.native
  /**
  	 * If possible, will return the best available main value of the series for a given world coordinate.
  	 *
  	 * @param targetName The name of the series to target.
  	 ...
  	 * @param skipUnknowns If true, unknown values should be skipped.
  	 */
  def getSeriesValueFromSeriesPixel(
    targetName: java.lang.String,
    seriesPoint: js.Object,
    useInterpolation: scala.Boolean,
    skipUnknowns: scala.Boolean
  ...
  /**
  	 ...
  	 * @param skipUnknowns If true, unknown values should be skipped.
  	 */
  def getSeriesValuePositionFromSeriesPixel(
    targetName: java.lang.String,
    seriesPoint: js.Object,
    useInterpolation: scala.Boolean,
    skipUnknowns: scala.Boolean
  ...
  /**
  	 ...
  	 */
  def moveCursorPoint(targetName: java.lang.String, worldPoint: js.Object): js.Object = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def notifyVisualPropertiesChanged(targetName: java.lang.String): js.Object = js.native
  ...
  /**
  	 ...
  	 * @param targetName The name of the series to target.
  	 */
  def replayTransitionIn(targetName: java.lang.String): js.Object = js.native
  /**
  	 ...
  	 */
  def resetCachedEnhancedInterval(targetName: java.lang.String): js.Object = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def simulateHover(targetName: java.lang.String, seriesPoint: js.Object): js.Object = js.native
  /**
