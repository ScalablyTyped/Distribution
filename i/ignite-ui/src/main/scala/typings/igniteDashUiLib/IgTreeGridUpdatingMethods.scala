...
trait IgTreeGridUpdatingMethods extends js.Object {
  /**
  	 ...
  	 */
  def addChild(values: js.Object, parentId: js.Object): scala.Unit = js.native
  /**
  	 * Adds a new row to the grid. It also creates a transaction and updates the UI.
  	 *
  	 * @param values Pairs of values in the format { column1Key: value1, column2Key: value2, ... } .
  	 */
  def addRow(values: js.Object): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def deleteRow(rowId: js.Object): scala.Unit = js.native
  ...
  /**
  	 ...
  	 */
  def editorForKey(key: java.lang.String): js.Object = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def findInvalid(): java.lang.String = js.native
  /**
  	 * Hides the "Add Child" button.
  	 */
  def hideAddChildButton(): scala.Unit = js.native
  /**
  	 * Hides the delete button.
  	 */
  def hideDeleteButton(): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def setCellValue(rowId: js.Object, colKey: java.lang.String, value: js.Object): scala.Unit = js.native
  /**
  	 * Shows the "Add Child" button for specific row.
  	 *
  	 * @param row A jQuery object of the targeted row.
  	 */
  def showAddChildButtonFor(row: js.Object): scala.Unit = js.native
  /**
  	 * Shows the delete button for specific row.
  	 *
  	 * @param row A jQuery object of the targeted row.
  	 */
  def showDeleteButtonFor(row: js.Object): scala.Unit = js.native
  /**
  	 ...
  	 * @param raiseEvents Specifies whether or not updating events should be raised for this operation.
  	 */
  def startAddChildFor(parentId: js.Object): scala.Unit = js.native
  def startAddChildFor(parentId: js.Object, raiseEvents: js.Object): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 * @param values Pairs of values in the format { column1Key: value1, column2Key: value2, ... } .
  	 */
  def updateRow(rowId: js.Object, values: js.Object): scala.Unit = js.native
}
