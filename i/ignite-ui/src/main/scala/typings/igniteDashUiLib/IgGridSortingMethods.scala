...
@js.native
trait IgGridSortingMethods extends js.Object {
  ...
  /**
  	 ...
  	 */
  def closeMultipleSortingDialog(): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def openMultipleSortingDialog(): scala.Unit = js.native
  /**
  	 * Remove clear button for multiple sorting dialog
  	 */
  def removeDialogClearButton(): scala.Unit = js.native
  /**
  	 * Renders content of multiple sorting dialog - sorted and unsorted columns.
  	 *
  	 * @param isToCallEvents
  	 */
  def renderMultipleSortingDialogContent(isToCallEvents: js.Object): scala.Unit = js.native
  /**
  	 ...
  	 * @param header
  	 */
  def sortColumn(index: js.Object, direction: js.Object, header: js.Object): scala.Unit = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def unsortColumn(index: js.Object, header: js.Object): scala.Unit = js.native
}
