...
trait LegendItemMouseEnterEventUIParam extends js.Object {
  /**
...
object LegendItemMouseEnterEventUIParam {
  @scala.inline
  def apply(
    ...
    legend: js.Any = null,
    series: js.Any = null
  ): LegendItemMouseEnterEventUIParam = {
    ...
    __obj.asInstanceOf[LegendItemMouseEnterEventUIParam]
  }
}
