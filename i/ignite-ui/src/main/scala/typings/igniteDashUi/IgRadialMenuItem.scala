...
object IgRadialMenuItem {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    if (!js.isUndefined(autoRotateChildren)) __obj.updateDynamic("autoRotateChildren")(autoRotateChildren.asInstanceOf[js.Any])
    if (!js.isUndefined(autoUpdateRecentItem)) __obj.updateDynamic("autoUpdateRecentItem")(autoUpdateRecentItem.asInstanceOf[js.Any])
    if (checkBehavior != null) __obj.updateDynamic("checkBehavior")(checkBehavior.asInstanceOf[js.Any])
    if (checked != null) __obj.updateDynamic("checked")(checked.asInstanceOf[js.Any])
    if (checkedHighlightBrush != null) __obj.updateDynamic("checkedHighlightBrush")(checkedHighlightBrush.asInstanceOf[js.Any])
    if (childItemPlacement != null) __obj.updateDynamic("childItemPlacement")(childItemPlacement.asInstanceOf[js.Any])
    ...
    if (colorChanged != null) __obj.updateDynamic("colorChanged")(colorChanged.asInstanceOf[js.Any])
    if (colorWellClick != null) __obj.updateDynamic("colorWellClick")(colorWellClick.asInstanceOf[js.Any])
    if (foreground != null) __obj.updateDynamic("foreground")(foreground.asInstanceOf[js.Any])
    if (groupName != null) __obj.updateDynamic("groupName")(groupName.asInstanceOf[js.Any])
    if (header != null) __obj.updateDynamic("header")(header.asInstanceOf[js.Any])
    if (highlightBrush != null) __obj.updateDynamic("highlightBrush")(highlightBrush.asInstanceOf[js.Any])
    if (iconUri != null) __obj.updateDynamic("iconUri")(iconUri.asInstanceOf[js.Any])
    if (innerAreaFill != null) __obj.updateDynamic("innerAreaFill")(innerAreaFill.asInstanceOf[js.Any])
    if (innerAreaHotTrackFill != null) __obj.updateDynamic("innerAreaHotTrackFill")(innerAreaHotTrackFill.asInstanceOf[js.Any])
    if (innerAreaHotTrackStroke != null) __obj.updateDynamic("innerAreaHotTrackStroke")(innerAreaHotTrackStroke.asInstanceOf[js.Any])
    if (innerAreaStroke != null) __obj.updateDynamic("innerAreaStroke")(innerAreaStroke.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isToolTipEnabled)) __obj.updateDynamic("isToolTipEnabled")(isToolTipEnabled.asInstanceOf[js.Any])
    if (name != null) __obj.updateDynamic("name")(name.asInstanceOf[js.Any])
    if (opened != null) __obj.updateDynamic("opened")(opened.asInstanceOf[js.Any])
    if (outerRingButtonFill != null) __obj.updateDynamic("outerRingButtonFill")(outerRingButtonFill.asInstanceOf[js.Any])
    if (outerRingButtonForeground != null) __obj.updateDynamic("outerRingButtonForeground")(outerRingButtonForeground.asInstanceOf[js.Any])
    if (outerRingButtonHotTrackFill != null) __obj.updateDynamic("outerRingButtonHotTrackFill")(outerRingButtonHotTrackFill.asInstanceOf[js.Any])
    if (outerRingButtonHotTrackForeground != null) __obj.updateDynamic("outerRingButtonHotTrackForeground")(outerRingButtonHotTrackForeground.asInstanceOf[js.Any])
    if (outerRingButtonHotTrackStroke != null) __obj.updateDynamic("outerRingButtonHotTrackStroke")(outerRingButtonHotTrackStroke.asInstanceOf[js.Any])
    if (outerRingButtonStroke != null) __obj.updateDynamic("outerRingButtonStroke")(outerRingButtonStroke.asInstanceOf[js.Any])
    ...
    if (pendingValue != null) __obj.updateDynamic("pendingValue")(pendingValue.asInstanceOf[js.Any])
    if (pendingValueChanged != null) __obj.updateDynamic("pendingValueChanged")(pendingValueChanged.asInstanceOf[js.Any])
    if (pendingValueNeedleBrush != null) __obj.updateDynamic("pendingValueNeedleBrush")(pendingValueNeedleBrush.asInstanceOf[js.Any])
    if (recentItemName != null) __obj.updateDynamic("recentItemName")(recentItemName.asInstanceOf[js.Any])
    if (!js.isUndefined(reserveFirstSlice)) __obj.updateDynamic("reserveFirstSlice")(reserveFirstSlice.asInstanceOf[js.Any])
    ...
    if (trackEndColor != null) __obj.updateDynamic("trackEndColor")(trackEndColor.asInstanceOf[js.Any])
    if (trackStartColor != null) __obj.updateDynamic("trackStartColor")(trackStartColor.asInstanceOf[js.Any])
    if (`type` != null) __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    if (unchecked != null) __obj.updateDynamic("unchecked")(unchecked.asInstanceOf[js.Any])
    if (value != null) __obj.updateDynamic("value")(value.asInstanceOf[js.Any])
    if (valueChanged != null) __obj.updateDynamic("valueChanged")(valueChanged.asInstanceOf[js.Any])
    if (valueNeedleBrush != null) __obj.updateDynamic("valueNeedleBrush")(valueNeedleBrush.asInstanceOf[js.Any])
