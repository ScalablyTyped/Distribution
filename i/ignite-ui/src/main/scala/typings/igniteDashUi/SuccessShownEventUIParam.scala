...
trait SuccessShownEventUIParam extends js.Object {
  /**
...
object SuccessShownEventUIParam {
  @scala.inline
  def apply(fieldOptions: js.Any = null, message: String = null, owner: js.Any = null, target: String = null): SuccessShownEventUIParam = {
    ...
    __obj.asInstanceOf[SuccessShownEventUIParam]
  }
}
