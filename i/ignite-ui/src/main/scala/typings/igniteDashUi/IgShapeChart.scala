...
object IgShapeChart {
  ...
  /* optionName */ StringDictionary[js.Any] = null,
    ...
    if (markerCollision != null) __obj.updateDynamic("markerCollision")(markerCollision)
    ...
    if (!js.isUndefined(xAxisAbbreviateLargeNumbers)) __obj.updateDynamic("xAxisAbbreviateLargeNumbers")(xAxisAbbreviateLargeNumbers)
    ...
    if (!js.isUndefined(xAxisIsLogarithmic)) __obj.updateDynamic("xAxisIsLogarithmic")(xAxisIsLogarithmic)
