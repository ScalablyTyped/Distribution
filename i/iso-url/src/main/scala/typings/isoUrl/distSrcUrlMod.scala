...
object distSrcUrlMod {
  ...
  @JSImport("iso-url/dist/src/url", JSImport.Namespace)
  @js.native
  ...
  /**
    ...
    */
  @JSImport("iso-url/dist/src/url", "URLSearchParams")
  @js.native
  ...
  @JSImport("iso-url/dist/src/url", "URLWithLegacySupport")
  @js.native
  open class URLWithLegacySupport () extends URL_ {
  ...
  @JSImport("iso-url/dist/src/url", "defaultBase")
  @js.native
