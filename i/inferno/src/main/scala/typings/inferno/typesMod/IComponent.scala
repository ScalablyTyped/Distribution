...
trait IComponent[P, S] extends StObject {
  ...
  def setState[K /* <: /* keyof S */ String */](newState: S): Unit = js.native
  def setState[K /* <: /* keyof S */ String */](newState: S, callback: js.Function0[Unit]): Unit = js.native
  ...
  def setState[K /* <: /* keyof S */ String */](newState: Pick[S, K]): Unit = js.native
  def setState[K /* <: /* keyof S */ String */](newState: Pick[S, K], callback: js.Function0[Unit]): Unit = js.native
