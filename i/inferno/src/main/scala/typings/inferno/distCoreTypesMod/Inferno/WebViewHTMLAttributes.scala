...
trait WebViewHTMLAttributes[T]
  ...
  var allowpopups: js.UndefOr[Boolean | Null] = js.undefined
  
  var autoFocus: js.UndefOr[Boolean | Null] = js.undefined
  
  var autosize: js.UndefOr[Boolean | Null] = js.undefined
  
  var blinkfeatures: js.UndefOr[String | Null] = js.undefined
  
  var disableblinkfeatures: js.UndefOr[String | Null] = js.undefined
  
  var disableguestresize: js.UndefOr[Boolean | Null] = js.undefined
  
  var disablewebsecurity: js.UndefOr[Boolean | Null] = js.undefined
  
  var guestinstance: js.UndefOr[String | Null] = js.undefined
  
  var httpreferrer: js.UndefOr[String | Null] = js.undefined
  
  var nodeintegration: js.UndefOr[Boolean | Null] = js.undefined
  
  var partition: js.UndefOr[String | Null] = js.undefined
  
  var plugins: js.UndefOr[Boolean | Null] = js.undefined
  ...
  var webpreferences: js.UndefOr[String | Null] = js.undefined
}
object WebViewHTMLAttributes {
  ...
  implicit open class MutableBuilder[Self <: WebViewHTMLAttributes[?], T] (val x: Self & WebViewHTMLAttributes[T]) extends AnyVal {
    ...
    inline def setAllowpopupsNull: Self = StObject.set(x, "allowpopups", null)
    ...
    inline def setAutosizeNull: Self = StObject.set(x, "autosize", null)
    ...
    inline def setBlinkfeaturesNull: Self = StObject.set(x, "blinkfeatures", null)
    ...
    inline def setDisableblinkfeaturesNull: Self = StObject.set(x, "disableblinkfeatures", null)
    ...
    inline def setDisableguestresizeNull: Self = StObject.set(x, "disableguestresize", null)
    ...
    inline def setDisablewebsecurityNull: Self = StObject.set(x, "disablewebsecurity", null)
    ...
    inline def setGuestinstanceNull: Self = StObject.set(x, "guestinstance", null)
    ...
    inline def setHttpreferrerNull: Self = StObject.set(x, "httpreferrer", null)
    ...
    inline def setNodeintegrationNull: Self = StObject.set(x, "nodeintegration", null)
    ...
    inline def setWebpreferencesNull: Self = StObject.set(x, "webpreferences", null)
