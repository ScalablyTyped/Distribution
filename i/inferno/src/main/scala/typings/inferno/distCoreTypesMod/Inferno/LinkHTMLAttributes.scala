...
trait LinkHTMLAttributes[T]
  ...
  var imageSizes: js.UndefOr[String | Null] = js.undefined
  
  var imageSrcSet: js.UndefOr[String | Null] = js.undefined
...
object LinkHTMLAttributes {
  ...
  implicit open class MutableBuilder[Self <: LinkHTMLAttributes[?], T] (val x: Self & LinkHTMLAttributes[T]) extends AnyVal {
    ...
    inline def setImageSrcSetNull: Self = StObject.set(x, "imageSrcSet", null)
