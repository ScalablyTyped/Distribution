...
object SendOptions {
  ...
  implicit class SendOptionsOps[Self <: SendOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSendAndArchive(value: Boolean): Self = this.set("sendAndArchive", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSendAndArchive: Self = this.set("sendAndArchive", js.undefined)
  }
}
