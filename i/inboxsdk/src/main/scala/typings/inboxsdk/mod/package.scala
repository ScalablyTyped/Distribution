...
package object mod {
  ...
  @scala.inline
  def load(version: scala.Double, appId: js.UndefOr[scala.Nothing], opts: typings.inboxsdk.mod.LoadOptions): js.Promise[typings.inboxsdk.mod.InboxSDKInstance] = (typings.inboxsdk.mod.^.asInstanceOf[js.Dynamic].applyDynamic("load")(version.asInstanceOf[js.Any], appId.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.inboxsdk.mod.InboxSDKInstance]]
  @scala.inline
