...
trait ListsInstance extends StObject {
  ...
  def registerThreadRowViewHandler(handler: js.Function1[/* threadRowView */ ThreadRowView, js.Any]): js.Function0[Unit]
  
  def registerThreadRowViewSelectionHandler(handler: js.Function0[js.Any]): js.Function0[Unit]
}
