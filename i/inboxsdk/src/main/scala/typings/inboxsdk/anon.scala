...
object anon {
  ...
  object Added {
    ...
    implicit class AddedMutableBuilder[Self <: Added] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAdded(value: js.Array[typings.inboxsdk.mod.Common.Contact]): Self = StObject.set(x, "added", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAddedVarargs(value: typings.inboxsdk.mod.Common.Contact*): Self = StObject.set(x, "added", js.Array(value :_*))
      
      @scala.inline
      def setRemoved(value: js.Array[typings.inboxsdk.mod.Common.Contact]): Self = StObject.set(x, "removed", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRemovedVarargs(value: typings.inboxsdk.mod.Common.Contact*): Self = StObject.set(x, "removed", js.Array(value :_*))
    }
  }
  ...
  object Contact {
    ...
    implicit class ContactMutableBuilder[Self <: Contact] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setContact(value: typings.inboxsdk.mod.Common.Contact): Self = StObject.set(x, "contact", value.asInstanceOf[js.Any])
    }
  }
