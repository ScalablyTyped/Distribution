...
object ^ extends js.Object {
  ...
  @JSName("default")
  var default_Original: imageDashTypeLib.Anon_Default = js.native
  /**
  ...
  /**
  	...
  	```
  	*/
  def apply(input: nodeLib.Buffer): ImageTypeResult | scala.Null = js.native
  def apply(input: stdLib.Uint8Array): ImageTypeResult | scala.Null = js.native
  /**
  	Detect the image type of a `Buffer`/`Uint8Array`.
  	@param input - Input to examine to determine the file type. It only needs the first `.minimumBytes` bytes.
  	@example
  	...
  	*/
  // TODO: Remove this for the next major release
  def default(input: nodeLib.Buffer): ImageTypeResult | scala.Null = js.native
  def default(input: stdLib.Uint8Array): ImageTypeResult | scala.Null = js.native
}
