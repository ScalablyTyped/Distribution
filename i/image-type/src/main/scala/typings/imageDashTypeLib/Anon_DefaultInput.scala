...
trait Anon_DefaultInput extends js.Object {
  ...
  /**
  	...
  	*/
  // TODO: Remove this for the next major release
  def default(input: nodeLib.Buffer): imageDashTypeLib.imageDashTypeMod.imageTypeNs.ImageTypeResult | scala.Null = js.native
  def default(input: stdLib.Uint8Array): imageDashTypeLib.imageDashTypeMod.imageTypeNs.ImageTypeResult | scala.Null = js.native
}
