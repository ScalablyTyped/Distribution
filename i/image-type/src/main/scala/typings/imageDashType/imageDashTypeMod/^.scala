...
import typings.imageDashType.Anon_Default
...
object ^ extends js.Object {
  ...
  /**
  	...
  	*/
  // TODO: Remove this for the next major release
  def default(input: Buffer): ImageTypeResult | Null = js.native
  def default(input: Uint8Array): ImageTypeResult | Null = js.native
}
