...
object esLibSdkTestHelpersDotbrowserMod {
  
  @JSImport("ibm-cloud-sdk-core/es/lib/sdk-test-helpers.browser", JSImport.Namespace)
  @js.native
  ...
  inline def getOptions(createRequestMock: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getOptions")(createRequestMock.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
