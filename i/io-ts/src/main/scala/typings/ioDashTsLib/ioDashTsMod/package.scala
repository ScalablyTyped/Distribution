...
package object ioDashTsMod {
  ...
  */
  ...
  type TaggedIntersectionArgument[Tag /* <: java.lang.String */] = (js.Array[Tagged[Tag, js.Any, js.Any]]) | (js.Tuple2[Mixed | (Tagged[Tag, js.Any, js.Any]), Mixed | (Tagged[Tag, js.Any, js.Any])]) | (js.Tuple3[
