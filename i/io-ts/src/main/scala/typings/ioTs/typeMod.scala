...
object typeMod {
  ...
  inline def intersect[B](right: Type_[B]): js.Function1[/* left */ Type_[js.Any], Type_[js.Any & B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("intersect")(right.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* left */ Type_[js.Any], Type_[js.Any & B]]]
  ...
  inline def refine[A, B /* <: A */](refinement: js.Function1[/* a */ A, /* is B */ Boolean], id: String): js.Function1[/* from */ Type_[A], Type_[B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("refine")(refinement.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* from */ Type_[A], Type_[B]]]
