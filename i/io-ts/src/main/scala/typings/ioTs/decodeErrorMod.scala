...
object decodeErrorMod {
  ...
  */
  ...
  object DecodeError {
    ...
    inline def Index_[E](errors: FreeSemigroup[DecodeError[E]], index: Double, kind: Kind): typings.ioTs.decodeErrorMod.Index_[E] = {
    ...
    inline def Key_[E](errors: FreeSemigroup[DecodeError[E]], key: String, kind: Kind): typings.ioTs.decodeErrorMod.Key_[E] = {
    ...
    inline def Lazy_[E](errors: FreeSemigroup[DecodeError[E]], id: String): typings.ioTs.decodeErrorMod.Lazy_[E] = {
    ...
    inline def Member_[E](errors: FreeSemigroup[DecodeError[E]], index: Double): typings.ioTs.decodeErrorMod.Member_[E] = {
    ...
    inline def Wrap_[E](error: E, errors: FreeSemigroup[DecodeError[E]]): typings.ioTs.decodeErrorMod.Wrap_[E] = {
