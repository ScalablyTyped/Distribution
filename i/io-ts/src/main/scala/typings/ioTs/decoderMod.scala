...
object decoderMod {
  ...
  @js.native
  val Schemable: Schemable2C[typings.ioTs.decoderMod.URI, Any] = js.native
  ...
  @js.native
  val WithRefine: WithRefine2C[typings.ioTs.decoderMod.URI, Any] = js.native
  
  @JSImport("io-ts/lib/Decoder", "WithUnion")
  @js.native
  val WithUnion: WithUnion2C[typings.ioTs.decoderMod.URI, Any] = js.native
  
  @JSImport("io-ts/lib/Decoder", "WithUnknownContainers")
  @js.native
  val WithUnknownContainers: WithUnknownContainers2C[typings.ioTs.decoderMod.URI, Any] = js.native
