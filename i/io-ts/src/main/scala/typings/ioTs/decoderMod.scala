...
object decoderMod {
  ...
  @scala.inline
  def alt[I, A](that: js.Function0[Decoder[I, A]]): js.Function1[/* me */ Decoder[I, A], Decoder[I, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("alt")(that.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* me */ Decoder[I, A], Decoder[I, A]]]
  
  @scala.inline
  def array[A](item: Decoder[js.Any, A]): Decoder[js.Any, js.Array[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("array")(item.asInstanceOf[js.Any]).asInstanceOf[Decoder[js.Any, js.Array[A]]]
  ...
  @scala.inline
  def compose[A, B](to: Decoder[A, B]): js.Function1[/* from */ Decoder[js.Any, A], Decoder[js.Any, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("compose")(to.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* from */ Decoder[js.Any, A], Decoder[js.Any, B]]]
  ...
  @scala.inline
  def failure[A](actual: js.Any, message: String): Either_[FreeSemigroup[typings.ioTs.decodeErrorMod.DecodeError[String]], A] = (^.asInstanceOf[js.Dynamic].applyDynamic("failure")(actual.asInstanceOf[js.Any], message.asInstanceOf[js.Any])).asInstanceOf[Either_[FreeSemigroup[typings.ioTs.decodeErrorMod.DecodeError[String]], A]]
  
  @scala.inline
  def fromArray[I, A](item: Decoder[I, A]): Decoder[js.Array[I], js.Array[A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromArray")(item.asInstanceOf[js.Any]).asInstanceOf[Decoder[js.Array[I], js.Array[A]]]
  
  @scala.inline
  def fromGuard[I, A /* <: I */](guard: Guard[I, A], expected: String): Decoder[I, A] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromGuard")(guard.asInstanceOf[js.Any], expected.asInstanceOf[js.Any])).asInstanceOf[Decoder[I, A]]
  
  @scala.inline
  def fromPartial[P /* <: Record[String, Decoder[js.Any, js.Any]] */](properties: P): Decoder[
    Partial[
  ...
  @scala.inline
  def fromRecord[I, A](codomain: Decoder[I, A]): Decoder[Record[String, I], Record[String, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRecord")(codomain.asInstanceOf[js.Any]).asInstanceOf[Decoder[Record[String, I], Record[String, A]]]
  
  @scala.inline
  def fromRefinement[I, A /* <: I */](refinement: Refinement[I, A], expected: String): Decoder[I, A] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromRefinement")(refinement.asInstanceOf[js.Any], expected.asInstanceOf[js.Any])).asInstanceOf[Decoder[I, A]]
  ...
  @scala.inline
  def fromTuple[C /* <: js.Array[Decoder[js.Any, js.Any]] */](
  ...
  @scala.inline
  def fromType[P /* <: Record[String, Decoder[js.Any, js.Any]] */](properties: P): Decoder[
    /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in keyof P ]: io-ts.io-ts/lib/Kleisli.InputOf<'Either', P[K]>}
  ...
  @scala.inline
  def id[A](): Decoder[A, A] = ^.asInstanceOf[js.Dynamic].applyDynamic("id")().asInstanceOf[Decoder[A, A]]
  
  @scala.inline
  def intersect[IB, B](right: Decoder[IB, B]): js.Function1[/* left */ Decoder[js.Any, js.Any], Decoder[js.Any & IB, js.Any & B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("intersect")(right.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* left */ Decoder[js.Any, js.Any], Decoder[js.Any & IB, js.Any & B]]]
  
  @scala.inline
  def `lazy`[I, A](id: String, f: js.Function0[Decoder[I, A]]): Decoder[I, A] = (^.asInstanceOf[js.Dynamic].applyDynamic("lazy")(id.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[Decoder[I, A]]
  ...
  @scala.inline
  def map[A, B](f: js.Function1[/* a */ A, B]): js.Function1[/* fa */ Decoder[js.Any, A], Decoder[js.Any, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("map")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* fa */ Decoder[js.Any, A], Decoder[js.Any, B]]]
  
  @scala.inline
  def mapLeftWithInput[I](f: js.Function2[/* input */ I, /* e */ DecodeError, DecodeError]): js.Function1[/* decoder */ Decoder[I, js.Any], Decoder[I, js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("mapLeftWithInput")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* decoder */ Decoder[I, js.Any], Decoder[I, js.Any]]]
  
  @scala.inline
  def nullable[I, A](or: Decoder[I, A]): Decoder[Null | I, Null | A] = ^.asInstanceOf[js.Dynamic].applyDynamic("nullable")(or.asInstanceOf[js.Any]).asInstanceOf[Decoder[Null | I, Null | A]]
  ...
  @scala.inline
  def parse[A, B](parser: js.Function1[/* a */ A, Either_[DecodeError, B]]): js.Function1[/* from */ Decoder[js.Any, A], Decoder[js.Any, B]] = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(parser.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* from */ Decoder[js.Any, A], Decoder[js.Any, B]]]
  ...
  @scala.inline
  def record[A](codomain: Decoder[js.Any, A]): Decoder[js.Any, Record[String, A]] = ^.asInstanceOf[js.Dynamic].applyDynamic("record")(codomain.asInstanceOf[js.Any]).asInstanceOf[Decoder[js.Any, Record[String, A]]]
  
  @scala.inline
  def refine[A, B /* <: A */](refinement: js.Function1[/* a */ A, /* is B */ Boolean], id: String): js.Function1[/* from */ Decoder[js.Any, A], Decoder[js.Any, B]] = (^.asInstanceOf[js.Dynamic].applyDynamic("refine")(refinement.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* from */ Decoder[js.Any, A], Decoder[js.Any, B]]]
  ...
  @scala.inline
  def success[A](a: A): Either_[DecodeError, A] = ^.asInstanceOf[js.Dynamic].applyDynamic("success")(a.asInstanceOf[js.Any]).asInstanceOf[Either_[DecodeError, A]]
  ...
  @scala.inline
  def union[MS /* <: Array[Decoder[js.Any, js.Any]] */](
  ...
  @scala.inline
  def withMessage[I](message: js.Function2[/* input */ I, /* e */ DecodeError, String]): js.Function1[/* decoder */ Decoder[I, js.Any], Decoder[I, js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("withMessage")(message.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* decoder */ Decoder[I, js.Any], Decoder[I, js.Any]]]
