...
object libTypeMod {
  ...
  @js.native
  val Schemable: Schemable1[typings.ioTs.libTypeMod.URI] = js.native
  ...
  @js.native
  val WithRefine: WithRefine1[typings.ioTs.libTypeMod.URI] = js.native
  
  @JSImport("io-ts/lib/Type", "WithUnion")
  @js.native
  val WithUnion: WithUnion1[typings.ioTs.libTypeMod.URI] = js.native
  
  @JSImport("io-ts/lib/Type", "WithUnknownContainers")
  @js.native
  val WithUnknownContainers: WithUnknownContainers1[typings.ioTs.libTypeMod.URI] = js.native
