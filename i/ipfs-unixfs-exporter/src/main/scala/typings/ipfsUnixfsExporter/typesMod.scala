...
object typesMod {
  ...
  trait Exportable[T] extends StObject {
    ...
    var cid: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify CID */ Any = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.ipfsUnixfsExporter.typesMod.UnixFSFile
    - typings.ipfsUnixfsExporter.typesMod.UnixFSDirectory
    - typings.ipfsUnixfsExporter.typesMod.ObjectNode
    - typings.ipfsUnixfsExporter.typesMod.RawNode
    - typings.ipfsUnixfsExporter.typesMod.IdentityNode
  */
