package typings
package intlDashLocalesDashSupportedLib
...
trait Anon_LocalesOptions
  extends org.scalablytyped.runtime.Instantiable0[stdLib.IntlNs.DateTimeFormat]
     with org.scalablytyped.runtime.Instantiable2[
      js.UndefOr[(/* locales */ js.Array[java.lang.String]) | (/* locales */ java.lang.String)], 
  ...
  def apply(locales: js.UndefOr[scala.Nothing], options: stdLib.IntlNs.DateTimeFormatOptions): stdLib.IntlNs.DateTimeFormat = js.native
