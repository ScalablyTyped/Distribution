...
trait Options extends RenderingOptions {
  ...
  /**
    ...
    */
  var boundList: js.UndefOr[imagemapsterLib.imagemapsterMod.Global.JQuery] = js.undefined
  /**
    ...
    */
  var clickNavigate: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    */
  var configTimeout: js.UndefOr[scala.Double] = js.undefined
  /**
  ...
  /**
    ...
    */
  var listSelectedAttribute: js.UndefOr[java.lang.String] = js.undefined
  /**
    ...
    * the map are changed.
    */
  var listSelectedClass: js.UndefOr[java.lang.String] = js.undefined
  /**
    ...
    */
  var mapKey: js.UndefOr[java.lang.String] = js.undefined
  /**
    ...
    */
  var mapValue: js.UndefOr[java.lang.String] = js.undefined
  /**
    ...
    */
  var mouseoutDelay: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var noHrefIsMask: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onClick: js.UndefOr[js.Function1[/* data */ OnClickData, scala.Unit]] = js.undefined
  /**
    ...
    */
  var onConfigured: js.UndefOr[js.Function1[/* success */ scala.Boolean, scala.Unit]] = js.undefined
  /**
    ...
    * manually.
    */
  var onGetList: js.UndefOr[
    js.Function1[/* data */ OnGetListData, imagemapsterLib.imagemapsterMod.Global.JQuery]
  ] = js.undefined
  /**
    ...
    */
  var onMouseout: js.UndefOr[js.Function1[/* data */ OnMouseData, scala.Unit]] = js.undefined
  /**
    * callback when mouse enters a bound area.
    *
    * This function is called when the mouse enters a bound area.
    */
  var onMouseover: js.UndefOr[js.Function1[/* data */ OnMouseData, scala.Unit]] = js.undefined
  /**
    ...
    * desired.
    */
  var onShowToolTip: js.UndefOr[js.Function1[/* data */ OnShowToolTipData, scala.Unit]] = js.undefined
  /**
    ...
    */
  var onStateChange: js.UndefOr[js.Function1[/* data */ OnStateChangeData, scala.Unit]] = js.undefined
  /**
    ...
    */
  var scaleMap: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * enable tooltips
    *
  ...
  /**
    ...
    */
  var sortList: js.UndefOr[
    scala.Boolean | imagemapsterLib.imagemapsterLibStrings.asc | imagemapsterLib.imagemapsterLibStrings.desc
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var toolTipContainer: js.UndefOr[java.lang.String | imagemapsterLib.imagemapsterMod.Global.JQuery] = js.undefined
  /**
    * add "classname" class to the wrapper created around the image, or
    * copy classes from the image if "true"
    */
  var wrapClass: js.UndefOr[java.lang.String | scala.Boolean] = js.undefined
  /**
