...
import typings.imagemapster.imagemapsterMod.Global.ImageMapsterNs.State
import typings.imagemapster.imagemapsterMod.Global.ImageMapsterNs.ToolTipCloseEvent
