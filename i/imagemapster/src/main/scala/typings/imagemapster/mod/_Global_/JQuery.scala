package typings.imagemapster.mod._Global_

import typings.imagemapster.mod._Global_.ImageMapster.AreaRenderingOptions
import typings.imagemapster.mod._Global_.ImageMapster.Deselect
import typings.imagemapster.mod._Global_.ImageMapster.Get
import typings.imagemapster.mod._Global_.ImageMapster.GetOptions
import typings.imagemapster.mod._Global_.ImageMapster.Highlight
import typings.imagemapster.mod._Global_.ImageMapster.Keys
import typings.imagemapster.mod._Global_.ImageMapster.Options
import typings.imagemapster.mod._Global_.ImageMapster.Rebind
import typings.imagemapster.mod._Global_.ImageMapster.RenderingOptions
import typings.imagemapster.mod._Global_.ImageMapster.Resize
import typings.imagemapster.mod._Global_.ImageMapster.Select
import typings.imagemapster.mod._Global_.ImageMapster.Set
import typings.imagemapster.mod._Global_.ImageMapster.SetOptions
import typings.imagemapster.mod._Global_.ImageMapster.Snapshot
import typings.imagemapster.mod._Global_.ImageMapster.Tooltip
import typings.imagemapster.mod._Global_.ImageMapster.Unbind
