...
trait File
  ...
  /**
    * - File content
    */
  var content: js.UndefOr[AsyncIterable[Uint8Array]] = js.native
...
object File {
  ...
  @scala.inline
  def apply(cid: typings.cids.mod.^, depth: Double, name: String, path: String, size: Double, `type`: file): File = {
  ...
  implicit class FileOps[Self <: File] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContent(value: AsyncIterable[Uint8Array]): Self = this.set("content", value.asInstanceOf[js.Any])
