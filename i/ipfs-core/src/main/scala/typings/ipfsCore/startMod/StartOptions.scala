...
import typings.ipfsCore.initMod.ExperimentalOptions
import typings.ipfsCore.initMod.PreloadOptions
import typings.ipfsCore.initMod.RelayOptions
...
trait StartOptions extends js.Object {
  ...
  /**
    ...
    */
  var init: js.UndefOr[Boolean | typings.ipfsCore.initMod.InitOptions] = js.native
...
object StartOptions {
  ...
  implicit class StartOptionsOps[Self <: StartOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInit(value: Boolean | typings.ipfsCore.initMod.InitOptions): Self = this.set("init", value.asInstanceOf[js.Any])
