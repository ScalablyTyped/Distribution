...
trait InitOptions extends js.Object {
  ...
  /**
    ...
    */
  var privateKey: js.UndefOr[String | typings.peerId.mod.^ ] = js.native
...
object InitOptions {
  ...
  implicit class InitOptionsOps[Self <: InitOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrivateKey(value: String | typings.peerId.mod.^ ): Self = this.set("privateKey", value.asInstanceOf[js.Any])
