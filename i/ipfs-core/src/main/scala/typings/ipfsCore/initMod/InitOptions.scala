...
trait InitOptions extends js.Object {
  ...
  var config: js.UndefOr[typings.ipfsCore.configMod.IPFSConfig] = js.native
...
object InitOptions {
  ...
  implicit class InitOptionsOps[Self <: InitOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConfig(value: typings.ipfsCore.configMod.IPFSConfig): Self = this.set("config", value.asInstanceOf[js.Any])
