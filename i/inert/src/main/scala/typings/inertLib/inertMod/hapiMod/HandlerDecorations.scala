...
trait HandlerDecorations extends js.Object {
  /**
    ...
    */
  var directory: js.UndefOr[inertLib.inertMod.DirectoryHandlerRouteObject] = js.undefined
  /**
    * The file handler
    *
    ...
    */
  var file: js.UndefOr[
    java.lang.String | inertLib.inertMod.RequestHandler[java.lang.String] | inertLib.inertMod.FileHandlerRouteObject
  ] = js.undefined
...
object HandlerDecorations {
  @scala.inline
  def apply(
    directory: inertLib.inertMod.DirectoryHandlerRouteObject = null,
    file: java.lang.String | inertLib.inertMod.RequestHandler[java.lang.String] | inertLib.inertMod.FileHandlerRouteObject = null,
