...
object readlinkNs extends js.Object {
  ...
  def __promisify___buffer(path: nodeLib.fsMod.PathLike, options: atIonicUtilsDashFsLib.atIonicUtilsDashFsLibStrings.buffer): js.Promise[nodeLib.Buffer] = js.native
}
