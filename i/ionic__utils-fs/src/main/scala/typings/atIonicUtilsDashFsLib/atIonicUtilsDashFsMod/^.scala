...
object ^ extends js.Object {
  ...
  @JSName("mkdtempSync")
  def mkdtempSync_buffer(prefix: java.lang.String, options: atIonicUtilsDashFsLib.atIonicUtilsDashFsLibStrings.buffer): nodeLib.Buffer = js.native
  /**
    * Asynchronously creates a unique temporary directory.
    * Generates six random characters to be appended behind a required prefix to create a unique temporary directory.
    * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
  ...
  @JSName("readdirSync")
  def readdirSync_buffer(path: nodeLib.fsMod.PathLike, options: atIonicUtilsDashFsLib.atIonicUtilsDashFsLibStrings.buffer): js.Array[nodeLib.Buffer] = js.native
  @JSName("readdir")
  def readdir_buffer(
    path: nodeLib.fsMod.PathLike,
    options: atIonicUtilsDashFsLib.atIonicUtilsDashFsLibStrings.buffer,
  ...
  @JSName("readlinkSync")
  def readlinkSync_buffer(path: nodeLib.fsMod.PathLike, options: atIonicUtilsDashFsLib.atIonicUtilsDashFsLibStrings.buffer): nodeLib.Buffer = js.native
  @JSName("readlink")
  def readlink_buffer(
    path: nodeLib.fsMod.PathLike,
    options: atIonicUtilsDashFsLib.atIonicUtilsDashFsLibStrings.buffer,
  ...
  @JSName("realpathSync")
  def realpathSync_buffer(path: nodeLib.fsMod.PathLike, options: atIonicUtilsDashFsLib.atIonicUtilsDashFsLibStrings.buffer): nodeLib.Buffer = js.native
  @JSName("realpath")
  def realpath_buffer(
    path: nodeLib.fsMod.PathLike,
    options: atIonicUtilsDashFsLib.atIonicUtilsDashFsLibStrings.buffer,
  ...
  def statSafe(p: java.lang.String): js.Promise[js.UndefOr[fsDashExtraLib.fsDashExtraMod.Stats]] = js.native
  /**
  ...
  def symlink(
    srcpath: java.lang.String,
    dstpath: java.lang.String,
    `type`: fsDashExtraLib.fsDashExtraMod.FsSymlinkType | js.UndefOr[scala.Nothing],
    callback: js.Function1[/* err */ nodeLib.NodeJSNs.ErrnoException, scala.Unit]
  ): scala.Unit = js.native
  def symlink(
    srcpath: java.lang.String,
