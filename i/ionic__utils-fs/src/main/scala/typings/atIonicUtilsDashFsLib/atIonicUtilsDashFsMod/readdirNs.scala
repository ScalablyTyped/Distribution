...
object readdirNs extends js.Object {
  ...
  def __promisify___buffer(path: nodeLib.fsMod.PathLike, options: atIonicUtilsDashFsLib.atIonicUtilsDashFsLibStrings.buffer): js.Promise[js.Array[nodeLib.Buffer]] = js.native
}
