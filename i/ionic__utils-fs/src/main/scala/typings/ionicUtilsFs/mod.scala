...
object mod {
  ...
  @scala.inline
  def cacheFileChecksum(p: String): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("cacheFileChecksum")(p.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  @scala.inline
  def cacheFileChecksum(p: String, checksum: String): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("cacheFileChecksum")(p.asInstanceOf[js.Any], checksum.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
  ...
  @scala.inline
  def compilePaths(filePath: String): js.Array[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("compilePaths")(filePath.asInstanceOf[js.Any]).asInstanceOf[js.Array[String]]
  ...
  @scala.inline
  def fileToString(filePath: String): js.Promise[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("fileToString")(filePath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[String]]
  
  @scala.inline
  def findBaseDirectory(dir: String, file: String): js.Promise[js.UndefOr[String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("findBaseDirectory")(dir.asInstanceOf[js.Any], file.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.UndefOr[String]]]
  ...
  @scala.inline
  def getFileChecksum(filePath: String): js.Promise[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFileChecksum")(filePath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[String]]
  
  @scala.inline
  def getFileChecksums(p: String): js.Promise[js.Tuple2[String, js.UndefOr[String]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFileChecksums")(p.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Tuple2[String, js.UndefOr[String]]]]
  
  @scala.inline
  def getFileTree[RE, DE](dir: String): js.Promise[(RegularFileNode & RE) | (DirectoryNode & DE)] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFileTree")(dir.asInstanceOf[js.Any]).asInstanceOf[js.Promise[(RegularFileNode & RE) | (DirectoryNode & DE)]]
  @scala.inline
  ...
  @scala.inline
  def isExecutableFile(filePath: String): js.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("isExecutableFile")(filePath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Boolean]]
  ...
  @scala.inline
  def pathAccessible(filePath: String, mode: Double): js.Promise[Boolean] = (^.asInstanceOf[js.Dynamic].applyDynamic("pathAccessible")(filePath.asInstanceOf[js.Any], mode.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Boolean]]
  
  @scala.inline
  def pathExecutable(filePath: String): js.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("pathExecutable")(filePath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Boolean]]
  
  @scala.inline
  def pathExists(filePath: String): js.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("pathExists")(filePath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Boolean]]
  ...
  @scala.inline
  def pathReadable(filePath: String): js.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("pathReadable")(filePath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Boolean]]
  
  @scala.inline
  def pathWritable(filePath: String): js.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("pathWritable")(filePath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Boolean]]
  ...
  @scala.inline
  def readdirSafe(dir: String): js.Promise[js.Array[String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("readdirSafe")(dir.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[String]]]
  ...
  @scala.inline
  def readdirp(dir: String): js.Promise[js.Array[String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("readdirp")(dir.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[String]]]
  @scala.inline
  def readdirp(dir: String, hasFilterOnErrorWalkerOptions: ReaddirPOptions): js.Promise[js.Array[String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("readdirp")(dir.asInstanceOf[js.Any], hasFilterOnErrorWalkerOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[String]]]
  ...
  @scala.inline
  def statSafe(p: String): js.Promise[js.UndefOr[typings.fsExtra.mod.Stats]] = ^.asInstanceOf[js.Dynamic].applyDynamic("statSafe")(p.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.UndefOr[typings.fsExtra.mod.Stats]]]
  ...
  @scala.inline
  def tmpfilepath(): String = ^.asInstanceOf[js.Dynamic].applyDynamic("tmpfilepath")().asInstanceOf[String]
  @scala.inline
  def tmpfilepath(prefix: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("tmpfilepath")(prefix.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  @scala.inline
  def walk(p: String): Walker = ^.asInstanceOf[js.Dynamic].applyDynamic("walk")(p.asInstanceOf[js.Any]).asInstanceOf[Walker]
  @scala.inline
  def walk(p: String, options: WalkerOptions): Walker = (^.asInstanceOf[js.Dynamic].applyDynamic("walk")(p.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Walker]
  ...
  @scala.inline
  def writeStreamToFile(stream: ReadableStream, destination: String): js.Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeStreamToFile")(stream.asInstanceOf[js.Any], destination.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Any]]
  ...
  object DirectoryNode {
    ...
    @scala.inline
    def apply(children: js.Array[FileNode], path: String): DirectoryNode = {
  ...
  */
  ...
  object FileNode {
    ...
    @scala.inline
    def DirectoryNode(children: js.Array[FileNode], path: String): typings.ionicUtilsFs.mod.DirectoryNode = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("directory")
    ...
    @scala.inline
    def RegularFileNode(parent: FileNode, path: String): typings.ionicUtilsFs.mod.RegularFileNode = {
  ...
  */
  ...
  object GetFileTreeOptions {
    ...
    @scala.inline
    implicit class GetFileTreeOptionsMutableBuilder[Self <: GetFileTreeOptions[?, ?], RE, DE] (val x: Self & (GetFileTreeOptions[RE, DE])) extends AnyVal {
      
      @scala.inline
      def setOnDirectoryNode(value: /* node */ DirectoryNode => DirectoryNode & DE): Self = StObject.set(x, "onDirectoryNode", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnFileNode(value: /* node */ RegularFileNode => RegularFileNode & RE): Self = StObject.set(x, "onFileNode", js.Any.fromFunction1(value))
  ...
  object RegularFileNode {
    ...
    @scala.inline
    def apply(parent: FileNode, path: String): RegularFileNode = {
      val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("file")
