...
object mod {
  ...
  inline def writeStreamToFile(stream: ReadableStream[Any], destination: String): js.Promise[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeStreamToFile")(stream.asInstanceOf[js.Any], destination.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Any]]
