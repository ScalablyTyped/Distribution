...
@js.native
object iltorbModMembers extends js.Object {
  def compress(buffer: nodeLib.Buffer): stdLib.Promise[nodeLib.Buffer] = js.native
  def compress(buffer: nodeLib.Buffer, callback: IltorbCallback): scala.Unit = js.native
  def compress(buffer: nodeLib.Buffer, options: BrotliEncodeParams): stdLib.Promise[nodeLib.Buffer] = js.native
  ...
  def decompress(buffer: nodeLib.Buffer): stdLib.Promise[nodeLib.Buffer] = js.native
