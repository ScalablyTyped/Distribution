...
object NetworkInfo {
  ...
  def apply(
    ...
    if (!js.isUndefined(isAirplaneMode)) __obj.updateDynamic("isAirplaneMode")(isAirplaneMode.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isNetworkConnected)) __obj.updateDynamic("isNetworkConnected")(isNetworkConnected.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isRoaming)) __obj.updateDynamic("isRoaming")(isRoaming.get.asInstanceOf[js.Any])
