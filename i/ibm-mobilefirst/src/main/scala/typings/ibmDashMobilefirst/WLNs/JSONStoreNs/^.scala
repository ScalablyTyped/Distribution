...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def get(collectionName: String): JSONStoreInstance = js.native
  /**
  ...
  /**
    * @deprecated since version 5.0.6, it is no longer needed if you use WL.JSONStore.init
    */
  def initCollection(name: String, searchFields: js.Any): JSONStoreInstance = js.native
  def initCollection(name: String, searchFields: js.Any, options: InitOptions): JSONStoreInstance = js.native
  /**
