...
object libPromptsNumberMod {
  ...
  open class default[TQuestion /* <: Question */] protected ()
    extends typings.inquirer.libPromptsInputMod.default[TQuestion] {
    /**
  ...
  /**
    ...
    * The options for the question.
    */
  type NumberPrompt[TQuestion /* <: Question */] = typings.inquirer.libPromptsInputMod.default[TQuestion]
