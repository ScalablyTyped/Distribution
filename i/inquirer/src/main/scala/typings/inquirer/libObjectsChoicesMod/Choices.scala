...
trait Choices[T /* <: Answers */] extends js.Object {
  ...
  /**
    ...
    */
  def filter[TElement /* <: typings.inquirer.libObjectsChoiceMod.^[T] | typings.inquirer.libObjectsSeparatorMod.^  */](
    callbackfn: js.Function3[
      /* value */ typings.inquirer.libObjectsChoiceMod.^[T] | typings.inquirer.libObjectsSeparatorMod.^ , 
      /* index */ Double, 
      /* array */ js.Array[
        typings.inquirer.libObjectsChoiceMod.^[T] | typings.inquirer.libObjectsSeparatorMod.^ 
      ], 
      /* is TElement */ Boolean
    ]
  ...
  ): typings.inquirer.libObjectsChoiceMod.^[T] | typings.inquirer.libObjectsSeparatorMod.^  = js.native
  def find(
    predicate: js.Function3[
      /* value */ typings.inquirer.libObjectsChoiceMod.^[T] | typings.inquirer.libObjectsSeparatorMod.^ , 
      /* index */ Double, 
  ...
  /**
    ...
    */
  def indexOf(searchElement: typings.inquirer.libObjectsChoiceMod.^[T]): Double = js.native
  def indexOf(searchElement: typings.inquirer.libObjectsChoiceMod.^[T], fromIndex: Double): Double = js.native
  def indexOf(searchElement: typings.inquirer.libObjectsSeparatorMod.^): Double = js.native
  def indexOf(searchElement: typings.inquirer.libObjectsSeparatorMod.^, fromIndex: Double): Double = js.native
  /**
  ...
  /**
    ...
    */
  def push(items: (typings.inquirer.libObjectsChoiceMod.^[T] | typings.inquirer.libObjectsSeparatorMod.^ )*): Double = js.native
  /**
