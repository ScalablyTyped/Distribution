...
trait PromptModule
  ...
  /**
    ...
    */
  def apply[T](questions: QuestionCollection[T]): js.Promise[T] & Ui = js.native
  def apply[T](questions: QuestionCollection[T], initialAnswers: Partial[T]): js.Promise[T] & Ui = js.native
