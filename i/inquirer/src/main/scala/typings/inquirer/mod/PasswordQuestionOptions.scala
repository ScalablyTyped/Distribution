...
object PasswordQuestionOptions {
  @scala.inline
  def apply[/* <: typings.inquirer.mod.Answers */ T](): PasswordQuestionOptions[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PasswordQuestionOptions[T]]
  }
  @scala.inline
  implicit class PasswordQuestionOptionsOps[Self <: PasswordQuestionOptions[_], /* <: typings.inquirer.mod.Answers */ T] (val x: Self with PasswordQuestionOptions[T]) extends AnyVal {
    @scala.inline
