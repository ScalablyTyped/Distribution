...
trait QuestionOptions[A] extends js.Object {
  ...
  /**
    ...
    */
  var filter: js.UndefOr[js.Function1[/* input */ String, _]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var transformer: js.UndefOr[js.Function3[/* input */ String, /* answers */ A, /* flags */ js.Any, String]] = js.undefined
}
...
object QuestionOptions {
  ...
  def apply[A](
    ...
    transformer: (/* input */ String, /* answers */ A, /* flags */ js.Any) => String = null
  ): QuestionOptions[A] = {
