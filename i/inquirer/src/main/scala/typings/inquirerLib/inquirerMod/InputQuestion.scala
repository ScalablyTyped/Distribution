...
- Dropped {[ P in 'filter' | 'transformer' ]: inquirer.inquirer.QuestionOptions<A>[P]} */ trait InputQuestion[A]
  extends QuestionCommon[A]
     with Question[A] {
  var `type`: js.UndefOr[inquirerLib.inquirerLibStrings.input] = js.undefined
  /**
...
object InputQuestion {
  ...
  def apply[A](
    ...
    `type`: inquirerLib.inquirerLibStrings.input = null,
    validate: (/* input */ java.lang.String, /* answers */ js.UndefOr[A]) => scala.Boolean | java.lang.String | (js.Promise[scala.Boolean | java.lang.String]) = null,
