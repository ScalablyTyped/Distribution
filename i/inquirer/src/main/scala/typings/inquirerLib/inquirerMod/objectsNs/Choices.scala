...
trait Choices
  ...
  var realChoices: js.Array[Choice] = js.native
  var realLength: scala.Double = js.native
  def forEach[T](application: js.Function1[/* choice */ Choice, T]): js.Array[T] = js.native
  /**
    * Get a raw element from the collection
    * @param selector The selected index value
    * @return Return the matched choice or undefined
    */
  def get(selector: scala.Double): Choice = js.native
  /**
    * Get a valid choice from the collection
    * @param selector The selected choice index
    * @return Return the matched choice or undefined
    */
  def getChoice(selector: scala.Double): Choice = js.native
  /**
  ...
  /**
    ...
    */
  def where[U /* <: js.Object */](whereClause: U): js.Array[Choice] = js.native
}
