...
object ^ extends js.Object {
  /**
    ...
    *
    */
  def apply(input: java.lang.String): js.Promise[AST] | AST = js.native
  def apply(input: java.lang.String, options: Options): js.Promise[AST] | AST = js.native
  def apply(input: java.lang.String, options: Options, callback: js.Function0[scala.Unit]): js.Promise[AST] | AST = js.native
}
