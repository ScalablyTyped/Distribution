...
trait IncomingStreamTimeout extends StObject {
  ...
  var statsComputeThrottleMaxQueueSize: Double
  
  var statsComputeThrottleTimeout: Double
...
object IncomingStreamTimeout {
  ...
  inline def apply(
    statsComputeThrottleMaxQueueSize: Double,
    statsComputeThrottleTimeout: Double,
