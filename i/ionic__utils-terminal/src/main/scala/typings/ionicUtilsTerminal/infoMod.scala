...
object infoMod {
  ...
  @JSImport("@ionic/utils-terminal/dist/info", "CI_ENVIRONMENT_VARIABLES")
  @js.native
  val CI_ENVIRONMENT_VARIABLES: js.Array[String] = js.native
  
  @JSImport("@ionic/utils-terminal/dist/info", "CI_ENVIRONMENT_VARIABLES_DETECTED")
  @js.native
  val CI_ENVIRONMENT_VARIABLES_DETECTED: js.Array[String] = js.native
  
  @JSImport("@ionic/utils-terminal/dist/info", "TERMINAL_INFO")
  @js.native
