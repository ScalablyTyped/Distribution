...
trait AnonHourMinuteSecond extends js.Object {
  var hour: String
  var minute: String
  var second: String
...
object AnonHourMinuteSecond {
  @scala.inline
  def apply(hour: String, minute: String, second: String, timeZoneName: String): AnonHourMinuteSecond = {
    ...
    __obj.asInstanceOf[AnonHourMinuteSecond]
  }
}
