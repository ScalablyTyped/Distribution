...
import typings.intlMessageformat.formattersMod.PART_TYPE.`object`
import typings.intlMessageformat.formattersMod.PART_TYPE.literal
...
object formattersMod {
  ...
  */
  ...
  object MessageFormatPart {
    ...
    inline def LiteralPart(`type`: literal, value: String): typings.intlMessageformat.formattersMod.LiteralPart = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.intlMessageformat.formattersMod.LiteralPart]
    }
    
    inline def ObjectPart[T](`type`: `object`, value: T): typings.intlMessageformat.formattersMod.ObjectPart[T] = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
