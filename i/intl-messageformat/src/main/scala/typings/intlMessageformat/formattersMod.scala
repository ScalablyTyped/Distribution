...
object formattersMod {
  ...
  */
  ...
  object MessageFormatPart {
    ...
    inline def LiteralPart(value: String): typings.intlMessageformat.formattersMod.LiteralPart = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(0)
      __obj.asInstanceOf[typings.intlMessageformat.formattersMod.LiteralPart]
    }
    
    inline def ObjectPart[T](value: T): typings.intlMessageformat.formattersMod.ObjectPart[T] = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
