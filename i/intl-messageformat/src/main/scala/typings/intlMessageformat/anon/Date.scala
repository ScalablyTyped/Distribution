...
object Date {
  ...
  implicit class DateOps[Self <: Date] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDate(value: Full): Self = this.set("date", value.asInstanceOf[js.Any])
    @scala.inline
    def setNumber(value: Currency): Self = this.set("number", value.asInstanceOf[js.Any])
    @scala.inline
    def setTime(value: Long): Self = this.set("time", value.asInstanceOf[js.Any])
  }
