...
import typings.intlMessageformat.libSrcFormattersMod.PART_TYPE.`object`
import typings.intlMessageformat.libSrcFormattersMod.PART_TYPE.literal
...
object libSrcFormattersMod {
  
  @JSImport("intl-messageformat/lib/src/formatters", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @js.native
  sealed trait PART_TYPE extends StObject
  @JSImport("intl-messageformat/lib/src/formatters", "PART_TYPE")
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.intlMessageformat.libSrcFormattersMod.LiteralPart
    - typings.intlMessageformat.libSrcFormattersMod.ObjectPart[T]
  */
  trait MessageFormatPart[T] extends StObject
  object MessageFormatPart {
    
    inline def LiteralPart(`type`: literal, value: String): typings.intlMessageformat.libSrcFormattersMod.LiteralPart = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.intlMessageformat.libSrcFormattersMod.LiteralPart]
    }
    
    inline def ObjectPart[T](`type`: `object`, value: T): typings.intlMessageformat.libSrcFormattersMod.ObjectPart[T] = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.intlMessageformat.libSrcFormattersMod.ObjectPart[T]]
    }
  }
