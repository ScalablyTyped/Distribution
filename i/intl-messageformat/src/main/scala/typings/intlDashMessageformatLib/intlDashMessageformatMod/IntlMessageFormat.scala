...
class IntlMessageFormat protected ()
  ...
  def this(message: java.lang.String, locales: java.lang.String, overrideFormats: stdLib.Partial[intlDashMessageformatLib.libFormattersMod.Formats], opts: intlDashMessageformatLib.libCoreMod.Options) = this()
  def this(message: java.lang.String, locales: js.Array[java.lang.String], overrideFormats: stdLib.Partial[intlDashMessageformatLib.libFormattersMod.Formats], opts: intlDashMessageformatLib.libCoreMod.Options) = this()
  def this(message: js.Array[intlDashMessageformatDashParserLib.libTypesMod.MessageFormatElement], locales: java.lang.String, overrideFormats: stdLib.Partial[intlDashMessageformatLib.libFormattersMod.Formats], opts: intlDashMessageformatLib.libCoreMod.Options) = this()
  def this(message: js.Array[intlDashMessageformatDashParserLib.libTypesMod.MessageFormatElement], locales: js.Array[java.lang.String], overrideFormats: stdLib.Partial[intlDashMessageformatLib.libFormattersMod.Formats], opts: intlDashMessageformatLib.libCoreMod.Options) = this()
}
