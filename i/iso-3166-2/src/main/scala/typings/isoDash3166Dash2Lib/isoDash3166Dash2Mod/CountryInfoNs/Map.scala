...
object Map {
  @scala.inline
  def apply(
    StringDictionary: // full data if this country has been retrieved with country() at least once
  /* code */ org.scalablytyped.runtime.StringDictionary[Full | Partial] = null
  ): Map = {
