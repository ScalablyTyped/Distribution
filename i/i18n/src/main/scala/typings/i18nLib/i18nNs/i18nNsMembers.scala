...
object i18nNsMembers extends js.Object {
  ...
  /**
       ...
       */
  def `__`(phraseOrOptions: TranslateOptions, replace: java.lang.String*): java.lang.String = js.native
  /**
       * Translate the given phrase using locale configuration
       * @param phraseOrOptions - The phrase to translate or options for translation
       ...
       * @returns The translated phrase
       */
  def `__`(phraseOrOptions: TranslateOptions, replacements: Replacements): java.lang.String = js.native
  //#region __()
  /**
       * Translate the given phrase using locale configuration
       * @param phraseOrOptions - The phrase to translate or options for translation
  ...
  /**
       ...
       * @returns The translated phrase
       */
  def `__`(phraseOrOptions: java.lang.String, replacements: Replacements): java.lang.String = js.native
  //#endregion
  //#region __h()
  /**
       ...
       */
  def __h(phrase: java.lang.String): js.Array[HashedList] = js.native
  //#endregion
  //#region __l()
  /**
  ...
  /**
       ...
       * @returns The translated phrase
       */
  def __mf(phraseOrOptions: TranslateOptions, replace: js.Any*): java.lang.String = js.native
  /**
       * Translate the given phrase using locale configuration and MessageFormat
       * @param phraseOrOptions - The phrase to translate or options for translation
       * @param replacements - An object containing replacements
       * @returns The translated phrase
       */
  def __mf(phraseOrOptions: TranslateOptions, replacements: Replacements): java.lang.String = js.native
  //#endregion
  //#region __mf()
  /**
       * Translate the given phrase using locale configuration and MessageFormat
  ...
  /**
       ...
       * @returns The translated phrase
       */
  def __mf(phraseOrOptions: java.lang.String, replacements: Replacements): java.lang.String = js.native
  //#endregion
  //#region __n()
  /**
       ...
       * @returns The translated phrase
       */
  def __n(options: PluralOptions): java.lang.String = js.native
  //#endregion
  //#region __n()
  /**
       * Translate with plural condition the given phrase and count using locale configuration
       ...
       * @returns The translated phrase
       */
  def __n(options: PluralOptions, count: scala.Double): java.lang.String = js.native
  /**
       * Translate with plural condition the given phrase and count using locale configuration
  ...
  /**
       ...
       */
  def configure(options: ConfigurationOptions): scala.Unit = js.native
  //#endregion
  //#region Catalog
  /**
  ...
  /**
       ...
       */
  def getCatalog(locale: java.lang.String): LocaleCatalog = js.native
  /**
       ...
       */
  def getCatalog(request: i18nLib.ExpressNs.Request): LocaleCatalog = js.native
  /**
       * Get the current active locale catalog for specified request
       * @param request - The request to get locale catalog for
       * @param [locale] - The locale to get catalog for
       * @returns The current locale catalog for the specified request
       */
  def getCatalog(request: i18nLib.ExpressNs.Request, locale: java.lang.String): LocaleCatalog = js.native
  /**
