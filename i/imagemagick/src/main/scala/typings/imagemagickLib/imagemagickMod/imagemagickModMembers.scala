...
object imagemagickModMembers extends js.Object {
  ...
  def crop(options: Options, callback: js.Function2[/* err */ nodeLib.Error, /* result */ js.Any, scala.Unit]): nodeLib.childUnderscoreProcessMod.ChildProcess = js.native
  def identify(
    path: java.lang.String,
    callback: js.Function2[/* err */ nodeLib.Error, /* features */ Features, scala.Unit]
  ): nodeLib.childUnderscoreProcessMod.ChildProcess = js.native
  def identify(
    path: js.Array[_],
  ...
  def resize(options: Options, callback: js.Function2[/* err */ nodeLib.Error, /* result */ js.Any, scala.Unit]): nodeLib.childUnderscoreProcessMod.ChildProcess = js.native
