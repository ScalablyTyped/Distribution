...
@js.native
object distPublisherModMembers extends js.Object {
  ...
  def prepareInterfaces(interfaces: ScalablyTyped.runtime.StringDictionary[js.Array[nodeLib.osMod.NetworkInterfaceInfo]]): js.Array[Interface] = js.native
}
