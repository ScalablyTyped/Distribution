...
object ^ extends js.Object {
  ...
  def newSilentPublisher(namespace: java.lang.String, name: java.lang.String, port: scala.Double): atIonicDiscoverLib.distPublisherMod.Publisher = js.native
  def prepareInterfaces(
    interfaces: org.scalablytyped.runtime.StringDictionary[js.Array[nodeLib.osMod.NetworkInterfaceInfo]]
  ): js.Array[atIonicDiscoverLib.distPublisherMod.Interface] = js.native
}
