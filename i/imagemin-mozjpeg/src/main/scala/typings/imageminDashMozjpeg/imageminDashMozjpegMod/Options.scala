...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(fastCrush)) __obj.updateDynamic("fastCrush")(fastCrush)
    if (maxMemory != null) __obj.updateDynamic("maxMemory")(maxMemory.asInstanceOf[js.Any])
    if (!js.isUndefined(overshoot)) __obj.updateDynamic("overshoot")(overshoot)
    if (!js.isUndefined(progressive)) __obj.updateDynamic("progressive")(progressive)
    if (quality != null) __obj.updateDynamic("quality")(quality.asInstanceOf[js.Any])
    if (!js.isUndefined(quantBaseline)) __obj.updateDynamic("quantBaseline")(quantBaseline)
    ...
    if (!js.isUndefined(targa)) __obj.updateDynamic("targa")(targa)
    if (!js.isUndefined(trellis)) __obj.updateDynamic("trellis")(trellis)
    if (!js.isUndefined(trellisDC)) __obj.updateDynamic("trellisDC")(trellisDC)
