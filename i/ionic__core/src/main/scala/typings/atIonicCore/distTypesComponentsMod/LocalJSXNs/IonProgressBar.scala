...
trait IonProgressBar extends HTMLAttributes[HTMLIonProgressBarElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonProgressBar: js.UndefOr[Color] = js.undefined
  /**
...
object IonProgressBar {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonProgressBarElement] => Unit = null,
