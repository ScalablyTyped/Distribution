...
import typings.atIonicCore.distTypesComponentsMod.Global.HTMLIonRouterElement
...
trait IonRouter extends HTMLAttributes[HTMLIonRouterElement] {
  /**
...
object IonRouter {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonRouterElement] => Unit = null,
