...
trait IonSearchbar extends HTMLAttributes[HTMLIonSearchbarElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("autocorrect")
  var autocorrect_IonSearchbar: js.UndefOr[on | off] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonSearchbar: js.UndefOr[Color] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("spellcheck")
  var spellcheck_IonSearchbar: js.UndefOr[Boolean] = js.undefined
  /**
...
object IonSearchbar {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonSearchbarElement] => Unit = null,
