...
import typings.atIonicCore.distTypesComponentsMod.ComponentsNs.IonRadio
...
@JSGlobal("HTMLIonRadioElement")
@js.native
object HTMLIonRadioElement extends Instantiable0[HTMLIonRadioElement]
