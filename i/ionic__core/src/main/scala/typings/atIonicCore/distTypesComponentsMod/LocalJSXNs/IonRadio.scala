...
import typings.atIonicCore.distTypesComponentsMod.Global.HTMLIonRadioElement
...
trait IonRadio extends HTMLAttributes[HTMLIonRadioElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonRadio: js.UndefOr[Color] = js.undefined
  /**
...
object IonRadio {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonRadioElement] => Unit = null,
