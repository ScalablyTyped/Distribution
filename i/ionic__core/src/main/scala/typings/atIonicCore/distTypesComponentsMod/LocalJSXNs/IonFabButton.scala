...
trait IonFabButton extends HTMLAttributes[HTMLIonFabButtonElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonFabButton: js.UndefOr[Color] = js.undefined
  /**
...
object IonFabButton {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonFabButtonElement] => Unit = null,
    rel: String = null,
