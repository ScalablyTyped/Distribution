...
import typings.atIonicCore.distTypesComponentsMod.Global.HTMLIonRadioGroupElement
...
trait IonRadioGroup extends HTMLAttributes[HTMLIonRadioGroupElement] {
  /**
...
object IonRadioGroup {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonRadioGroupElement] => Unit = null,
