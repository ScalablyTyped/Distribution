...
import typings.atIonicCore.distTypesComponentsMod.Global.HTMLIonTitleElement
...
trait IonTitle extends HTMLAttributes[HTMLIonTitleElement] {
  /**
    * The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    */
  @JSName("color")
  var color_IonTitle: js.UndefOr[Color] = js.undefined
}
...
object IonTitle {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonTitleElement] => Unit = null,
