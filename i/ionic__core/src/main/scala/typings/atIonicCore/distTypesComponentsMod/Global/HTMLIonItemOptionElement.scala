...
import typings.atIonicCore.distTypesComponentsMod.ComponentsNs.IonItemOption
...
@js.native
trait HTMLIonItemOptionElement
...
@JSGlobal("HTMLIonItemOptionElement")
@js.native
class HTMLIonItemOptionElementCls () extends HTMLIonItemOptionElement {
  /* CompleteClass */
...
@JSGlobal("HTMLIonItemOptionElement")
@js.native
object HTMLIonItemOptionElement extends Instantiable0[HTMLIonItemOptionElement]
