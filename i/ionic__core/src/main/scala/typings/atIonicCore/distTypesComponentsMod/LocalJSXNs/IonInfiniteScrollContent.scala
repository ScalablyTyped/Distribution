...
trait IonInfiniteScrollContent extends HTMLAttributes[HTMLIonInfiniteScrollContentElement] {
  /**
...
object IonInfiniteScrollContent {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonInfiniteScrollContentElement] => Unit = null,
