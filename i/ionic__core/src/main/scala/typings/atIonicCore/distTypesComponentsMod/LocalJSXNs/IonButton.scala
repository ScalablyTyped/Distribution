...
trait IonButton extends HTMLAttributes[HTMLIonButtonElement] {
  /**
    * The type of button.
    */
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonButton: js.UndefOr[Color] = js.undefined
  /**
...
object IonButton {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonButtonElement] => Unit = null,
    rel: String = null,
