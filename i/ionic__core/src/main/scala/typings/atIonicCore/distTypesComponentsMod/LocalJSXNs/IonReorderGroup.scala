...
import typings.atIonicCore.distTypesComponentsMod.Global.HTMLIonReorderGroupElement
...
trait IonReorderGroup extends HTMLAttributes[HTMLIonReorderGroupElement] {
  /**
...
object IonReorderGroup {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonReorderGroupElement] => Unit = null,
