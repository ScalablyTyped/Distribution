...
trait IonRippleEffect extends HTMLAttributes[HTMLIonRippleEffectElement] {
  /**
...
object IonRippleEffect {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonRippleEffectElement] => Unit = null,
