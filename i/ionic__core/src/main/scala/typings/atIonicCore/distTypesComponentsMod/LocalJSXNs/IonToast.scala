...
trait IonToast extends HTMLAttributes[HTMLIonToastElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonToast: js.UndefOr[Color] = js.undefined
  /**
...
object IonToast {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonToastElement] => Unit = null,
