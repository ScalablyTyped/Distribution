...
import typings.atIonicCore.distTypesComponentsMod.Global.HTMLIonNoteElement
...
trait IonNote extends HTMLAttributes[HTMLIonNoteElement] {
  /**
    * The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    */
  @JSName("color")
  var color_IonNote: js.UndefOr[Color] = js.undefined
  /**
...
object IonNote {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonNoteElement] => Unit = null,
