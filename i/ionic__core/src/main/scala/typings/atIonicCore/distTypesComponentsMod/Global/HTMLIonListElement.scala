...
import typings.atIonicCore.distTypesComponentsMod.ComponentsNs.IonList
...
@JSGlobal("HTMLIonListElement")
@js.native
class HTMLIonListElementCls () extends HTMLIonListElement {
  /* CompleteClass */
...
@JSGlobal("HTMLIonListElement")
@js.native
object HTMLIonListElement extends Instantiable0[HTMLIonListElement]
