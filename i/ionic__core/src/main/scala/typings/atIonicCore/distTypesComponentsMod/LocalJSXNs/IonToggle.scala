...
trait IonToggle extends HTMLAttributes[HTMLIonToggleElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonToggle: js.UndefOr[Color] = js.undefined
  /**
...
object IonToggle {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonToggleElement] => Unit = null,
