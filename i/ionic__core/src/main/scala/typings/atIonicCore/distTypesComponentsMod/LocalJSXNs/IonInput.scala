...
trait IonInput extends HTMLAttributes[HTMLIonInputElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("autocorrect")
  var autocorrect_IonInput: js.UndefOr[on | off] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonInput: js.UndefOr[Color] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("spellcheck")
  var spellcheck_IonInput: js.UndefOr[Boolean] = js.undefined
  /**
...
object IonInput {
  ...
  def apply(
    ...
    ref: /* elm */ js.UndefOr[HTMLIonInputElement] => Unit = null,
