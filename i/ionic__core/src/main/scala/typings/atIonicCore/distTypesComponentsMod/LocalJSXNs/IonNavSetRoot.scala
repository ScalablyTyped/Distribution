...
import typings.atIonicCore.distTypesComponentsMod.Global.HTMLIonNavSetRootElement
...
trait IonNavSetRoot extends HTMLAttributes[HTMLIonNavSetRootElement] {
  /**
...
object IonNavSetRoot {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonNavSetRootElement] => Unit = null,
