...
trait IonVirtualScroll extends HTMLAttributes[HTMLIonVirtualScrollElement] {
  /**
...
object IonVirtualScroll {
  ...
  def apply(
    ...
    footerHeight: FooterHeightFn = null,
    headerFn: HeaderFn = null,
    headerHeight: HeaderHeightFn = null,
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonVirtualScrollElement] => Unit = null,
