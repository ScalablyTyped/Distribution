...
import typings.atIonicCore.distTypesComponentsMod.ComponentsNs.IonTab
...
@JSGlobal("HTMLIonTabElement")
@js.native
object HTMLIonTabElement extends Instantiable0[HTMLIonTabElement]
