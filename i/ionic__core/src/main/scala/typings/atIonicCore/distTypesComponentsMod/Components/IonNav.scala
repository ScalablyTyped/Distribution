...
import typings.atIonicCore.atIonicCoreMod.ViewController
...
import typings.atIonicCore.distTypesComponentsNavNavDashInterfaceMod.TransitionDoneFn
...
trait IonNav extends js.Object {
  ...
  def insert(
    insertIndex: Double,
    component: typings.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController
  ): js.Promise[Boolean] = js.native
  def insert(
    insertIndex: Double,
    component: typings.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController,
  ...
  def insert(
    insertIndex: Double,
    component: typings.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController,
    componentProps: ComponentProps[typings.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController]
  ): js.Promise[Boolean] = js.native
  def insert(
    insertIndex: Double,
    component: typings.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController,
  ...
  def push(component: typings.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController): js.Promise[Boolean] = js.native
  def push(
    component: typings.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController,
    componentProps: js.UndefOr[scala.Nothing],
    opts: js.UndefOr[scala.Nothing],
  ...
  def setRoot(component: typings.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController): js.Promise[Boolean] = js.native
  def setRoot(
    component: typings.atIonicCore.distTypesComponentsNavViewDashControllerMod.ViewController,
    componentProps: js.UndefOr[scala.Nothing],
    opts: js.UndefOr[scala.Nothing],
