...
trait IonNav extends js.Object {
  ...
  /**
    ...
    */
  def getByIndex(index: Double): js.Promise[
    js.UndefOr[
      /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ViewController */ _
    ]
  ] = js.native
  ...
  /**
    ...
    */
  def insert[T /* <: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify NavComponent */ js.Any */](insertIndex: Double, component: T): js.Promise[Boolean] = js.native
  ...
  /**
    ...
    * @param done The transition complete function.
    */
  def push[T /* <: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify NavComponent */ js.Any */](component: T): js.Promise[Boolean] = js.native
  ...
  /**
    ...
    * @param done The transition complete function.
    */
  def setRoot[T /* <: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify NavComponent */ js.Any */](component: T): js.Promise[Boolean] = js.native
