...
package object LocalJSXNs {
  ...
  type IonAvatar = HTMLAttributes[HTMLIonAvatarElement]
  type IonButtons = HTMLAttributes[HTMLIonButtonsElement]
  type IonItemGroup = HTMLAttributes[HTMLIonItemGroupElement]
  type IonLoadingController = HTMLAttributes[HTMLIonLoadingControllerElement]
  type IonMenuController = HTMLAttributes[HTMLIonMenuControllerElement]
  type IonModalController = HTMLAttributes[HTMLIonModalControllerElement]
  type IonNavPop = HTMLAttributes[HTMLIonNavPopElement]
  type IonPickerController = HTMLAttributes[HTMLIonPickerControllerElement]
  type IonPopoverController = HTMLAttributes[HTMLIonPopoverControllerElement]
  type IonReorder = HTMLAttributes[HTMLIonReorderElement]
  type IonRow = HTMLAttributes[HTMLIonRowElement]
  type IonSlide = HTMLAttributes[HTMLIonSlideElement]
  type IonThumbnail = HTMLAttributes[HTMLIonThumbnailElement]
  type IonToastController = HTMLAttributes[HTMLIonToastControllerElement]
}
