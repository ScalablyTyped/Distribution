...
import typings.atIonicCore.distTypesComponentsMod.Global.HTMLIonRouteElement
...
trait IonRoute extends HTMLAttributes[HTMLIonRouteElement] {
  /**
...
object IonRoute {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonRouteElement] => Unit = null,
