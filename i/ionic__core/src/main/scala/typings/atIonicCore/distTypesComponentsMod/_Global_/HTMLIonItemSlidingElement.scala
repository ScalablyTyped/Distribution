...
import typings.atIonicCore.distTypesComponentsMod.Components.IonItemSliding
...
@js.native
object HTMLIonItemSlidingElement extends Instantiable0[HTMLIonItemSlidingElement]
