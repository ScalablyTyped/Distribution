...
trait IonCheckbox extends HTMLAttributes[HTMLIonCheckboxElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonCheckbox: js.UndefOr[Color] = js.undefined
  /**
...
object IonCheckbox {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonCheckboxElement] => Unit = null,
