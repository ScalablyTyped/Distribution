...
import typings.atIonicCore.distTypesComponentsMod.Components.IonCardContent
...
@js.native
object HTMLIonCardContentElement extends Instantiable0[HTMLIonCardContentElement]
