...
trait IonMenuButton extends HTMLAttributes[HTMLIonMenuButtonElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonMenuButton: js.UndefOr[Color] = js.undefined
  /**
...
object IonMenuButton {
  ...
  def apply(
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonMenuButtonElement] => Unit = null,
