...
import typings.atIonicCore.distTypesInterfaceMod.StyleEventDetail
...
trait IonSegment extends HTMLAttributes[HTMLIonSegmentElement] {
  /**
    * The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    */
  @JSName("color")
  var color_IonSegment: js.UndefOr[Color] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onIonStyle: js.UndefOr[js.Function1[/* event */ CustomEvent[StyleEventDetail], Unit]] = js.undefined
  /**
...
object IonSegment {
  ...
  def apply(
    ...
    onIonStyle: /* event */ CustomEvent[StyleEventDetail] => Unit = null,
    ...
    radiogroup: String = null,
    ref: /* elm */ js.UndefOr[HTMLIonSegmentElement] => Unit = null,
