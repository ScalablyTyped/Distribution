...
trait IonTextarea extends HTMLAttributes[HTMLIonTextareaElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonTextarea: js.UndefOr[Color] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("spellcheck")
  var spellcheck_IonTextarea: js.UndefOr[Boolean] = js.undefined
  /**
...
object IonTextarea {
  ...
  def apply(
    ...
    ref: /* elm */ js.UndefOr[HTMLIonTextareaElement] => Unit = null,
