package typings.atIonicCore.distTypesUtilsTransitionMod
...
import typings.atIonicCore.distTypesComponentsNavNavDashInterfaceMod.NavOptions
...
trait TransitionOptions extends NavOptions {
  ...
  var progressCallback: js.UndefOr[
    js.Function1[
      /* ani */ js.UndefOr[
        Animation | typings.atIonicCore.distTypesUtilsAnimationOldDashAnimationAnimationDashInterfaceMod.Animation
      ], 
      Unit
    ]
  ] = js.undefined
...
object TransitionOptions {
  ...
  def apply(
    ...
    animationBuilder: (/* Animation */ typings.atIonicCore.distTypesUtilsAnimationOldDashAnimationAnimationDashInterfaceMod.Animation, /* baseEl */ js.Any, /* opts */ js.UndefOr[js.Any]) => js.Promise[
      typings.atIonicCore.distTypesUtilsAnimationOldDashAnimationAnimationDashInterfaceMod.Animation
    ] = null,
