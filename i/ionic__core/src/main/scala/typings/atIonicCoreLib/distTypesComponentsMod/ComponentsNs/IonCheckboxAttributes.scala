...
trait IonCheckboxAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonCheckboxAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonCheckboxAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonCheckboxAttributes]
  }
}
