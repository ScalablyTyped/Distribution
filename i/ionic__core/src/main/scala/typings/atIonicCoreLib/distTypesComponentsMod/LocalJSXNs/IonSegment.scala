...
trait IonSegment
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonSegmentElement] {
  /**
    * The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    */
  @JSName("color")
  var color_IonSegment: js.UndefOr[
  ...
  /**
    ...
    */
  var onIonStyle: js.UndefOr[
    js.Function1[
      /* event */ stdLib.CustomEvent[
        /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify StyleEventDetail */ _
      ], 
      scala.Unit
    ]
  ] = js.undefined
...
object IonSegment {
  ...
  def apply(
    ...
    onIonStyle: /* event */ stdLib.CustomEvent[
      /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify StyleEventDetail */ _
    ] => scala.Unit = null,
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonSegmentElement] => scala.Unit = null,
    ...
    if (onIonStyle != null) __obj.updateDynamic("onIonStyle")(js.Any.fromFunction1(onIonStyle))
