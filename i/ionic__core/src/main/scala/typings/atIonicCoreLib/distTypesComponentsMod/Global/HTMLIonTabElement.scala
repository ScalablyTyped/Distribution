...
trait HTMLIonTabElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonTab {
...
class HTMLIonTabElementCls () extends HTMLIonTabElement {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var tab: java.lang.String = js.native
  /**
    * Set the active component for the tab
    */
  /* CompleteClass */
  override def setActive(): js.Promise[scala.Unit] = js.native
}

@JSGlobal("HTMLIonTabElement")
@js.native
object HTMLIonTabElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonTabElement]
