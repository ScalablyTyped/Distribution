...
trait HTMLIonTabBarElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonTabBar {
...
@JSGlobal("HTMLIonTabBarElement")
@js.native
object HTMLIonTabBarElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonTabBarElement]
