...
trait HTMLIonMenuControllerElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonMenuController {
...
@JSGlobal("HTMLIonMenuControllerElement")
@js.native
object HTMLIonMenuControllerElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonMenuControllerElement]
