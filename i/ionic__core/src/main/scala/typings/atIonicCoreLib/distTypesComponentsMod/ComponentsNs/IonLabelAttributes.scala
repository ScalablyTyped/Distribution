...
trait IonLabelAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonLabelAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonLabelAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonLabelAttributes]
  }
}
