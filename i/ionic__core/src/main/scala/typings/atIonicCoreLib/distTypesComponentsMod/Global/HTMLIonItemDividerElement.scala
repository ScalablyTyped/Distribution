...
trait HTMLIonItemDividerElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonItemDivider {
...
@JSGlobal("HTMLIonItemDividerElement")
@js.native
object HTMLIonItemDividerElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonItemDividerElement]
