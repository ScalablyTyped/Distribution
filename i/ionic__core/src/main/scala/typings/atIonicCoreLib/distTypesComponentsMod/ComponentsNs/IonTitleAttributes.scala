...
trait IonTitleAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonTitleAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.Any
  ] = js.undefined
}

object IonTitleAttributes {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IonTitleAttributes]
  }
}
