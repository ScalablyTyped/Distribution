...
trait IonVirtualScroll
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonVirtualScrollElement] {
  /**
...
object IonVirtualScroll {
  ...
  def apply(
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonVirtualScrollElement] => scala.Unit = null,
    ...
    if (footerHeight != null) __obj.updateDynamic("footerHeight")(footerHeight)
    if (headerFn != null) __obj.updateDynamic("headerFn")(headerFn)
    if (headerHeight != null) __obj.updateDynamic("headerHeight")(headerHeight)
