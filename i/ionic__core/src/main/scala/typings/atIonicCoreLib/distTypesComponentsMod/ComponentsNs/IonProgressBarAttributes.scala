...
trait IonProgressBarAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonProgressBarAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonProgressBarAttributes {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IonProgressBarAttributes]
  }
}
