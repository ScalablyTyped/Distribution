...
trait IonCardHeaderAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonCardHeaderAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonCardHeaderAttributes {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IonCardHeaderAttributes]
  }
}
