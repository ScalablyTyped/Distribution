...
trait IonSegmentAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonSegmentAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonSegmentAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonSegmentAttributes]
  }
}
