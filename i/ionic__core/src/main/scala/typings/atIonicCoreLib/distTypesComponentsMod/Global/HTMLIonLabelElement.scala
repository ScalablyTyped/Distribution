...
trait HTMLIonLabelElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonLabel {
...
@JSGlobal("HTMLIonLabelElement")
@js.native
object HTMLIonLabelElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonLabelElement]
