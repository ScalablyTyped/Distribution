...
trait IonItemDividerAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonItemDividerAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonItemDividerAttributes {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IonItemDividerAttributes]
  }
}
