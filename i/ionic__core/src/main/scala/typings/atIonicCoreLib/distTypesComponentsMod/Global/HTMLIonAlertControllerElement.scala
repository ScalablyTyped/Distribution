...
@js.native
trait HTMLIonAlertControllerElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonAlertController {
...
@JSGlobal("HTMLIonAlertControllerElement")
@js.native
class HTMLIonAlertControllerElementCls () extends HTMLIonAlertControllerElement {
  /* CompleteClass */
...
@JSGlobal("HTMLIonAlertControllerElement")
@js.native
object HTMLIonAlertControllerElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonAlertControllerElement]
