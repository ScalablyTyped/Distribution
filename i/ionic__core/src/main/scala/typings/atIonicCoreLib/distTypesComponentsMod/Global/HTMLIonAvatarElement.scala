...
trait HTMLIonAvatarElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonAvatar {
...
@JSGlobal("HTMLIonAvatarElement")
@js.native
object HTMLIonAvatarElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonAvatarElement]
