...
trait HTMLIonPopoverControllerElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonPopoverController {
...
@JSGlobal("HTMLIonPopoverControllerElement")
@js.native
object HTMLIonPopoverControllerElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonPopoverControllerElement]
