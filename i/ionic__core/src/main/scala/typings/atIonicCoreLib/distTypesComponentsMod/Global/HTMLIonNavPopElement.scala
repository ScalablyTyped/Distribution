...
trait HTMLIonNavPopElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonNavPop {
...
@JSGlobal("HTMLIonNavPopElement")
@js.native
object HTMLIonNavPopElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonNavPopElement]
