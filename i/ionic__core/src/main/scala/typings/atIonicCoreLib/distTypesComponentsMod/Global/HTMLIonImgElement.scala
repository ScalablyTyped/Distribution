...
trait HTMLIonImgElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonImg {
...
@JSGlobal("HTMLIonImgElement")
@js.native
object HTMLIonImgElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonImgElement]
