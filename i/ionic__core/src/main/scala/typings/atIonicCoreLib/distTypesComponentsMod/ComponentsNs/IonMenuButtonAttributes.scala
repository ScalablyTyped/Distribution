...
trait IonMenuButtonAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonMenuButtonAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonMenuButtonAttributes {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IonMenuButtonAttributes]
  }
}
