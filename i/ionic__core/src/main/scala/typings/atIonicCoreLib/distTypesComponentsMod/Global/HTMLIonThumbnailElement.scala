...
trait HTMLIonThumbnailElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonThumbnail {
...
@JSGlobal("HTMLIonThumbnailElement")
@js.native
object HTMLIonThumbnailElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonThumbnailElement]
