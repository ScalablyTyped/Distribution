...
trait HTMLIonTitleElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonTitle {
...
@JSGlobal("HTMLIonTitleElement")
@js.native
object HTMLIonTitleElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonTitleElement]
