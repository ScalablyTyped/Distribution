...
trait HTMLIonPickerControllerElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonPickerController {
...
@JSGlobal("HTMLIonPickerControllerElement")
@js.native
object HTMLIonPickerControllerElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonPickerControllerElement]
