...
trait IonNavAttributes
  ...
  /**
    ...
    */
  var onIonNavDidChange: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[scala.Unit], scala.Unit]] = js.undefined
  /**
    * Event fired when the nav will change components
    */
  var onIonNavWillChange: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[scala.Unit], scala.Unit]] = js.undefined
  /**
...
object IonNavAttributes {
  ...
  def apply(
    ...
    onIonNavDidChange: /* event */ stdLib.CustomEvent[scala.Unit] => scala.Unit = null,
    onIonNavWillChange: /* event */ stdLib.CustomEvent[scala.Unit] => scala.Unit = null,
    ...
    swipeGesture: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    if (rootParams != null) __obj.updateDynamic("rootParams")(rootParams)
    ...
    __obj.asInstanceOf[IonNavAttributes]
  }
}
