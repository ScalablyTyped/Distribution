...
trait IonRadioAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonRadioAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonRadioAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonRadioAttributes]
  }
}
