...
trait IonRadio
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonRadioElement] {
  /**
  ...
  /**
    ...
    */
  var onIonSelect: js.UndefOr[
    js.Function1[
      /* event */ stdLib.CustomEvent[
        /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify RadioChangeEventDetail */ _
      ], 
      scala.Unit
    ]
  ] = js.undefined
...
object IonRadio {
  ...
  def apply(
    ...
    onIonSelect: /* event */ stdLib.CustomEvent[
      /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify RadioChangeEventDetail */ _
    ] => scala.Unit = null,
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonRadioElement] => scala.Unit = null,
