...
@js.native
trait HTMLIonNavSetRootElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonNavSetRoot {
...
@JSGlobal("HTMLIonNavSetRootElement")
@js.native
class HTMLIonNavSetRootElementCls () extends HTMLIonNavSetRootElement {
  /* CompleteClass */
...
@JSGlobal("HTMLIonNavSetRootElement")
@js.native
object HTMLIonNavSetRootElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonNavSetRootElement]
