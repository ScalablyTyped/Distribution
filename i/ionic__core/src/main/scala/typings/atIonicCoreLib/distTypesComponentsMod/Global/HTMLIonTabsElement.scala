...
trait HTMLIonTabsElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonTabs {
...
@JSGlobal("HTMLIonTabsElement")
@js.native
object HTMLIonTabsElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonTabsElement]
