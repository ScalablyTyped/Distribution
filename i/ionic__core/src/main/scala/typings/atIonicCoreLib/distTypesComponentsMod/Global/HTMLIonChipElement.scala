...
trait HTMLIonChipElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonChip {
...
@JSGlobal("HTMLIonChipElement")
@js.native
object HTMLIonChipElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonChipElement]
