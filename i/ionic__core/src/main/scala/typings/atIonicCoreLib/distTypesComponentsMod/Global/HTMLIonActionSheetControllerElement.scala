...
@js.native
trait HTMLIonActionSheetControllerElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonActionSheetController {
...
@JSGlobal("HTMLIonActionSheetControllerElement")
@js.native
class HTMLIonActionSheetControllerElementCls () extends HTMLIonActionSheetControllerElement {
  /* CompleteClass */
...
@JSGlobal("HTMLIonActionSheetControllerElement")
@js.native
object HTMLIonActionSheetControllerElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonActionSheetControllerElement]
