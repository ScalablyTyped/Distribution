...
trait IonTextAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonTextAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonTextAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonTextAttributes]
  }
}
