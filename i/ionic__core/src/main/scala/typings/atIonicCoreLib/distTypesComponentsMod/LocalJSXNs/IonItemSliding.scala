...
trait IonItemSliding
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonItemSlidingElement] {
  /**
  ...
  /**
    ...
    */
  var onIonDrag: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[_], scala.Unit]] = js.undefined
}
...
object IonItemSliding {
  ...
  def apply(
    ...
    onIonDrag: /* event */ stdLib.CustomEvent[_] => scala.Unit = null,
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonItemSlidingElement] => scala.Unit = null,
