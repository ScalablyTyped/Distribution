...
trait IonBackButtonAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonBackButtonAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonBackButtonAttributes {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IonBackButtonAttributes]
  }
}
