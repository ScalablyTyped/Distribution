...
trait IonDatetime
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonDatetimeElement] {
  /**
...
object IonDatetime {
  ...
  def apply(
    ...
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonDatetimeElement] => scala.Unit = null,
