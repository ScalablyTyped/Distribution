...
trait IonToggle
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonToggleElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonToggle: js.UndefOr[
...
object IonToggle {
  ...
  def apply(
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonToggleElement] => scala.Unit = null,
