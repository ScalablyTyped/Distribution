...
trait HTMLIonSelectElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonSelect {
...
@JSGlobal("HTMLIonSelectElement")
@js.native
object HTMLIonSelectElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonSelectElement]
