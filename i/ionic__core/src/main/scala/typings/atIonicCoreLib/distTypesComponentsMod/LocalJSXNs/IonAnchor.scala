...
trait IonAnchor
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonAnchorElement] {
  /**
    * The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    */
  @JSName("color")
  var color_IonAnchor: js.UndefOr[
...
object IonAnchor {
  ...
  def apply(
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonAnchorElement] => scala.Unit = null,
