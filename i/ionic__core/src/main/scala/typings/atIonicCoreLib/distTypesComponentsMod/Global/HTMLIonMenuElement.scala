...
@js.native
trait HTMLIonMenuElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonMenu {
...
@JSGlobal("HTMLIonMenuElement")
@js.native
class HTMLIonMenuElementCls () extends HTMLIonMenuElement {
  /* CompleteClass */
...
@JSGlobal("HTMLIonMenuElement")
@js.native
object HTMLIonMenuElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonMenuElement]
