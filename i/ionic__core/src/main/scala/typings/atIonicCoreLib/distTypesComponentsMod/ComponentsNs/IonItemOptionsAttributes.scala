...
trait IonItemOptionsAttributes
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXElementsNs.HTMLAttributes[stdLib.HTMLElement] {
  /**
    * Emitted when the item has been fully swiped.
    */
  var onIonSwipe: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[_], scala.Unit]] = js.undefined
  /**
...
object IonItemOptionsAttributes {
  @scala.inline
  def apply(
    ...
    onIonSwipe: /* event */ stdLib.CustomEvent[_] => scala.Unit = null,
    ...
    __obj.asInstanceOf[IonItemOptionsAttributes]
  }
}
