...
trait IonTabs
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonTabsElement] {
  /**
    * Emitted when the navigation has finished transitioning to a new component.
    */
  var onIonTabsDidChange: js.UndefOr[
    js.Function1[/* event */ stdLib.CustomEvent[atIonicCoreLib.Anon_Tab], scala.Unit]
  ] = js.undefined
  /**
    * Emitted when the navigation is about to transition to a new component.
    */
  var onIonTabsWillChange: js.UndefOr[
    js.Function1[/* event */ stdLib.CustomEvent[atIonicCoreLib.Anon_Tab], scala.Unit]
  ] = js.undefined
}
...
object IonTabs {
  ...
  def apply(
    ...
    onIonTabsDidChange: /* event */ stdLib.CustomEvent[atIonicCoreLib.Anon_Tab] => scala.Unit = null,
    onIonTabsWillChange: /* event */ stdLib.CustomEvent[atIonicCoreLib.Anon_Tab] => scala.Unit = null,
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonTabsElement] => scala.Unit = null,
