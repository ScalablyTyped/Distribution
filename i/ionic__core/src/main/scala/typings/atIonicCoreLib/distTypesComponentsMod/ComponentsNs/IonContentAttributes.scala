...
trait IonContentAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonContentAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonContentAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonContentAttributes]
  }
}
