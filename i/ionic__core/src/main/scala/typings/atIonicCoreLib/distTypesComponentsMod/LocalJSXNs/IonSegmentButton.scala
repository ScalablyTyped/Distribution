...
trait IonSegmentButton
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonSegmentButtonElement] {
  /**
  ...
  /**
    ...
    */
  var onIonSelect: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[scala.Unit], scala.Unit]] = js.undefined
  /**
...
object IonSegmentButton {
  ...
  def apply(
    ...
    onIonSelect: /* event */ stdLib.CustomEvent[scala.Unit] => scala.Unit = null,
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonSegmentButtonElement] => scala.Unit = null,
