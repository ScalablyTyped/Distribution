...
trait HTMLIonRowElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonRow {
...
@JSGlobal("HTMLIonRowElement")
@js.native
object HTMLIonRowElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonRowElement]
