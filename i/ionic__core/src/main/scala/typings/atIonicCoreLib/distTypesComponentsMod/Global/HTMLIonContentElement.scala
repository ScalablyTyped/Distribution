...
@js.native
trait HTMLIonContentElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonContent {
...
@JSGlobal("HTMLIonContentElement")
@js.native
class HTMLIonContentElementCls () extends HTMLIonContentElement {
  /* CompleteClass */
...
object HTMLIonContentElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonContentElement]
