...
trait IonInput
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonInputElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("autocorrect")
  var autocorrect_IonInput: js.UndefOr[
    atIonicCoreLib.atIonicCoreLibStrings.on | atIonicCoreLib.atIonicCoreLibStrings.off
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("spellcheck")
  var spellcheck_IonInput: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object IonInput {
  ...
  def apply(
    ...
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonInputElement] => scala.Unit = null,
