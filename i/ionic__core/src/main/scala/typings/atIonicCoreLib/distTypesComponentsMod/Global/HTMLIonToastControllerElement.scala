...
@js.native
trait HTMLIonToastControllerElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonToastController {
...
@JSGlobal("HTMLIonToastControllerElement")
@js.native
class HTMLIonToastControllerElementCls () extends HTMLIonToastControllerElement {
  /* CompleteClass */
...
@JSGlobal("HTMLIonToastControllerElement")
@js.native
object HTMLIonToastControllerElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonToastControllerElement]
