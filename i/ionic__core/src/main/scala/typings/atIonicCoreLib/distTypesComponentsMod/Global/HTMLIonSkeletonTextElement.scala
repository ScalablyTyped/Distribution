...
trait HTMLIonSkeletonTextElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonSkeletonText {
...
@JSGlobal("HTMLIonSkeletonTextElement")
@js.native
object HTMLIonSkeletonTextElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonSkeletonTextElement]
