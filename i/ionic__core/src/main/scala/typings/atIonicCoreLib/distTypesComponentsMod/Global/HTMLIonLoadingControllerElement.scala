...
trait HTMLIonLoadingControllerElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonLoadingController {
...
@JSGlobal("HTMLIonLoadingControllerElement")
@js.native
object HTMLIonLoadingControllerElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonLoadingControllerElement]
