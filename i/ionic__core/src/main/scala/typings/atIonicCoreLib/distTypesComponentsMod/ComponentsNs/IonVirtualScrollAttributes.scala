...
trait IonVirtualScrollAttributes
  ...
  /**
    ...
    */
  var approxFooterHeight: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var approxHeaderHeight: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var approxItemHeight: js.UndefOr[scala.Double] = js.undefined
  /**
  ...
  /**
    ...
    */
  var renderFooter: js.UndefOr[js.Function2[/* item */ js.Any, /* index */ scala.Double, _]] = js.undefined
  /**
    * NOTE: only JSX API for stencil.  Provide a render function for the header to be rendered. Returns a JSX virtual-dom.
    */
  var renderHeader: js.UndefOr[js.Function2[/* item */ js.Any, /* index */ scala.Double, _]] = js.undefined
  /**
    * NOTE: only JSX API for stencil.  Provide a render function for the items to be rendered. Returns a JSX virtual-dom.
    */
  var renderItem: js.UndefOr[js.Function2[/* item */ js.Any, /* index */ scala.Double, _]] = js.undefined
}

object IonVirtualScrollAttributes {
  @scala.inline
  def apply(
    about: java.lang.String = null,
    accessKey: java.lang.String = null,
    approxFooterHeight: scala.Int | scala.Double = null,
    approxHeaderHeight: scala.Int | scala.Double = null,
    approxItemHeight: scala.Int | scala.Double = null,
    ...
    renderFooter: (/* item */ js.Any, /* index */ scala.Double) => _ = null,
    renderHeader: (/* item */ js.Any, /* index */ scala.Double) => _ = null,
    renderItem: (/* item */ js.Any, /* index */ scala.Double) => _ = null,
    ...
    if (footerFn != null) __obj.updateDynamic("footerFn")(footerFn)
    if (headerFn != null) __obj.updateDynamic("headerFn")(headerFn)
    ...
    if (nodeRender != null) __obj.updateDynamic("nodeRender")(nodeRender)
    ...
    __obj.asInstanceOf[IonVirtualScrollAttributes]
  }
}
