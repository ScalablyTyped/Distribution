...
trait HTMLIonCardHeaderElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonCardHeader {
...
@JSGlobal("HTMLIonCardHeaderElement")
@js.native
object HTMLIonCardHeaderElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonCardHeaderElement]
