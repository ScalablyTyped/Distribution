...
trait IonMenuButton
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonMenuButtonElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonMenuButton: js.UndefOr[
...
object IonMenuButton {
  ...
  def apply(
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonMenuButtonElement] => scala.Unit = null,
