...
trait IonTabBarAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonTabBarAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonTabBarAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonTabBarAttributes]
  }
}
