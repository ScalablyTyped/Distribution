...
trait IonToggleAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonToggleAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonToggleAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonToggleAttributes]
  }
}
