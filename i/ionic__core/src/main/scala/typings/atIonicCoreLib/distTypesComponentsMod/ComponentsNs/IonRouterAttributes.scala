...
object IonRouterAttributes {
  ...
  def apply(
    ...
    onIonRouteDidChange: /* event */ stdLib.CustomEvent[
      /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify RouterEventDetail */ _
    ] => scala.Unit = null,
    onIonRouteWillChange: /* event */ stdLib.CustomEvent[
      /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify RouterEventDetail */ _
    ] => scala.Unit = null,
    ...
    __obj.asInstanceOf[IonRouterAttributes]
  }
}
