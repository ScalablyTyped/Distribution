...
trait HTMLIonColElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonCol {
...
@JSGlobal("HTMLIonColElement")
@js.native
object HTMLIonColElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonColElement]
