...
trait IonBackdrop
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonBackdropElement] {
  /**
    * Emitted when the backdrop is tapped.
    */
  var onIonBackdropTap: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[scala.Unit], scala.Unit]] = js.undefined
  /**
...
object IonBackdrop {
  ...
  def apply(
    ...
    onIonBackdropTap: /* event */ stdLib.CustomEvent[scala.Unit] => scala.Unit = null,
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonBackdropElement] => scala.Unit = null,
