...
trait IonCardAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonCardAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonCardAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonCardAttributes]
  }
}
