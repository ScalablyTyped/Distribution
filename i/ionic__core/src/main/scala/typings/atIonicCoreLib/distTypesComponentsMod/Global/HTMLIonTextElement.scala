...
trait HTMLIonTextElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonText {
...
@JSGlobal("HTMLIonTextElement")
@js.native
object HTMLIonTextElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonTextElement]
