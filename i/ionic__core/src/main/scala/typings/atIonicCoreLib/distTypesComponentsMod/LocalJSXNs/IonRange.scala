...
trait IonRange
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonRangeElement] {
  /**
    * The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    */
  @JSName("color")
  var color_IonRange: js.UndefOr[
  ...
  /**
    * Show two knobs.
    */
  var dualKnobs: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var pin: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object IonRange {
  ...
  def apply(
    ...
    dualKnobs: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    pin: js.UndefOr[scala.Boolean] = js.undefined,
    prefix: java.lang.String = null,
    property: java.lang.String = null,
    radioGroup: java.lang.String = null,
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonRangeElement] => scala.Unit = null,
