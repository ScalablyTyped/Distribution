...
trait IonProgressBar
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonProgressBarElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonProgressBar: js.UndefOr[
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    atIonicCoreLib.atIonicCoreLibStrings.determinate | atIonicCoreLib.atIonicCoreLibStrings.indeterminate
  ] = js.undefined
  /**
...
object IonProgressBar {
  ...
  def apply(
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonProgressBarElement] => scala.Unit = null,
    ...
    `type`: atIonicCoreLib.atIonicCoreLibStrings.determinate | atIonicCoreLib.atIonicCoreLibStrings.indeterminate = null,
