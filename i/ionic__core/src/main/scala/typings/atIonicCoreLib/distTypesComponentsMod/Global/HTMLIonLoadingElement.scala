...
trait HTMLIonLoadingElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonLoading {
...
@JSGlobal("HTMLIonLoadingElement")
@js.native
object HTMLIonLoadingElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonLoadingElement]
