...
trait HTMLIonRadioElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonRadio {
...
@JSGlobal("HTMLIonRadioElement")
@js.native
object HTMLIonRadioElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonRadioElement]
