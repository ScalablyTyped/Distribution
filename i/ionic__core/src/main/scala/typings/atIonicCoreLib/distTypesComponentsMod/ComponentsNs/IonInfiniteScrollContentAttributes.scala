...
trait IonInfiniteScrollContentAttributes
...
object IonInfiniteScrollContentAttributes {
  @scala.inline
  def apply(
  ...
  ): IonInfiniteScrollContentAttributes = {
    ...
    __obj.asInstanceOf[IonInfiniteScrollContentAttributes]
  }
}
