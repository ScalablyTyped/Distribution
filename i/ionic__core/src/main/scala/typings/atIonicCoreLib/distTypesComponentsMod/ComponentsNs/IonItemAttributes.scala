...
trait IonItemAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonItemAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonItemAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonItemAttributes]
  }
}
