...
trait HTMLIonRouterLinkElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonRouterLink {
...
@JSGlobal("HTMLIonRouterLinkElement")
@js.native
object HTMLIonRouterLinkElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonRouterLinkElement]
