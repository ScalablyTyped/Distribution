...
trait HTMLIonToolbarElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonToolbar {
...
@js.native
class HTMLIonToolbarElementCls () extends HTMLIonToolbarElement {
  /* CompleteClass */
...
object HTMLIonToolbarElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonToolbarElement]
