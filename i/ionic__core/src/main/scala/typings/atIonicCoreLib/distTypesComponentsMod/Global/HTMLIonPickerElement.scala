...
@js.native
trait HTMLIonPickerElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonPicker {
...
@JSGlobal("HTMLIonPickerElement")
@js.native
class HTMLIonPickerElementCls () extends HTMLIonPickerElement {
  /* CompleteClass */
...
@JSGlobal("HTMLIonPickerElement")
@js.native
object HTMLIonPickerElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonPickerElement]
