...
trait HTMLIonNoteElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonNote {
...
@JSGlobal("HTMLIonNoteElement")
@js.native
object HTMLIonNoteElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonNoteElement]
