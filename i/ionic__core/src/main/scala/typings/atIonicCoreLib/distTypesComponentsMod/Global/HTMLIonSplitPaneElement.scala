...
trait HTMLIonSplitPaneElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonSplitPane {
...
@JSGlobal("HTMLIonSplitPaneElement")
@js.native
object HTMLIonSplitPaneElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonSplitPaneElement]
