...
trait HTMLIonSpinnerElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonSpinner {
...
class HTMLIonSpinnerElementCls () extends HTMLIonSpinnerElement {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var paused: scala.Boolean = js.native
  /**
...
@JSGlobal("HTMLIonSpinnerElement")
@js.native
object HTMLIonSpinnerElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonSpinnerElement]
