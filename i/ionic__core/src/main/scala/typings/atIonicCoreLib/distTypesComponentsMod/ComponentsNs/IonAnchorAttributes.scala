...
trait IonAnchorAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonAnchorAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonAnchorAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonAnchorAttributes]
  }
}
