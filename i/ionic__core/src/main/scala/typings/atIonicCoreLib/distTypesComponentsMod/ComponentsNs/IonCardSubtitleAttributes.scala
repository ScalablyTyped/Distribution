...
trait IonCardSubtitleAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonCardSubtitleAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonCardSubtitleAttributes {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IonCardSubtitleAttributes]
  }
}
