...
trait IonMenu
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonMenuElement] {
  /**
  ...
  /**
    ...
    */
  var maxEdgeStart: js.UndefOr[scala.Double] = js.undefined
  /**
    * An id for the menu.
    */
  ...
  /**
    ...
    */
  var onIonDidClose: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[scala.Unit], scala.Unit]] = js.undefined
  /**
    * Emitted when the menu is open.
    */
  var onIonDidOpen: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[scala.Unit], scala.Unit]] = js.undefined
  /**
    * Emitted when the menu is about to be closed.
    */
  var onIonWillClose: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[scala.Unit], scala.Unit]] = js.undefined
  /**
    * Emitted when the menu is about to be opened.
    */
  var onIonWillOpen: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[scala.Unit], scala.Unit]] = js.undefined
  /**
...
object IonMenu {
  ...
  def apply(
    ...
    maxEdgeStart: scala.Int | scala.Double = null,
    ...
    onIonDidClose: /* event */ stdLib.CustomEvent[scala.Unit] => scala.Unit = null,
    onIonDidOpen: /* event */ stdLib.CustomEvent[scala.Unit] => scala.Unit = null,
    onIonWillClose: /* event */ stdLib.CustomEvent[scala.Unit] => scala.Unit = null,
    onIonWillOpen: /* event */ stdLib.CustomEvent[scala.Unit] => scala.Unit = null,
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonMenuElement] => scala.Unit = null,
