...
trait IonToolbarAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonToolbarAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonToolbarAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonToolbarAttributes]
  }
}
