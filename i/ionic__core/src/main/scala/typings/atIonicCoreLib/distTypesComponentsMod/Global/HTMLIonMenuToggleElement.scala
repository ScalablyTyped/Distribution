...
trait HTMLIonMenuToggleElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonMenuToggle {
...
@JSGlobal("HTMLIonMenuToggleElement")
@js.native
object HTMLIonMenuToggleElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonMenuToggleElement]
