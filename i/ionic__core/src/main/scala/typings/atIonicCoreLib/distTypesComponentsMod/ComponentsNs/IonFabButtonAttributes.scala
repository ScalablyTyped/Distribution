...
trait IonFabButtonAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonFabButtonAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonFabButtonAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonFabButtonAttributes]
  }
}
