...
trait HTMLIonModalControllerElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonModalController {
...
@JSGlobal("HTMLIonModalControllerElement")
@js.native
object HTMLIonModalControllerElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonModalControllerElement]
