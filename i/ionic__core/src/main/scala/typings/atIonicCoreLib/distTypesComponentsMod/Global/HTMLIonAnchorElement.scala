...
trait HTMLIonAnchorElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonAnchor {
...
@JSGlobal("HTMLIonAnchorElement")
@js.native
object HTMLIonAnchorElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonAnchorElement]
