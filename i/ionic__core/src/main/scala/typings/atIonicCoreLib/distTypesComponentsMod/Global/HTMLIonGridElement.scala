...
trait HTMLIonGridElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonGrid {
...
@JSGlobal("HTMLIonGridElement")
@js.native
object HTMLIonGridElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonGridElement]
