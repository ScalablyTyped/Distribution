...
trait IonRadioGroup
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonRadioGroupElement] {
  /**
    * If `true`, the radios can be deselected.
    */
  var allowEmptySelection: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object IonRadioGroup {
  ...
  def apply(
    ...
    allowEmptySelection: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonRadioGroupElement] => scala.Unit = null,
