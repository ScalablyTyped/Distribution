...
trait IonCardTitleAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonCardTitleAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonCardTitleAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonCardTitleAttributes]
  }
}
