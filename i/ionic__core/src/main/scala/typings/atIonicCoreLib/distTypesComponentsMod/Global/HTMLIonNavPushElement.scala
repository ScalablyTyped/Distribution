...
trait HTMLIonNavPushElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonNavPush {
...
@JSGlobal("HTMLIonNavPushElement")
@js.native
object HTMLIonNavPushElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonNavPushElement]
