...
trait IonTextarea
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonTextareaElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonTextarea: js.UndefOr[
  ...
  /**
    ...
    */
  @JSName("spellcheck")
  var spellcheck_IonTextarea: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object IonTextarea {
  ...
  def apply(
    ...
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonTextareaElement] => scala.Unit = null,
