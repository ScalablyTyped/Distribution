...
@js.native
trait HTMLIonBadgeElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonBadge {
...
@JSGlobal("HTMLIonBadgeElement")
@js.native
class HTMLIonBadgeElementCls () extends HTMLIonBadgeElement {
  /* CompleteClass */
...
@JSGlobal("HTMLIonBadgeElement")
@js.native
object HTMLIonBadgeElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonBadgeElement]
