...
trait HTMLIonSelectPopoverElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonSelectPopover {
...
@JSGlobal("HTMLIonSelectPopoverElement")
@js.native
object HTMLIonSelectPopoverElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonSelectPopoverElement]
