...
trait IonReorderGroupAttributes
...
object IonReorderGroupAttributes {
  @scala.inline
  def apply(
    ...
    onIonItemReorder: /* event */ stdLib.CustomEvent[
      /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ItemReorderEventDetail */ _
    ] => scala.Unit = null,
    ...
    __obj.asInstanceOf[IonReorderGroupAttributes]
  }
}
