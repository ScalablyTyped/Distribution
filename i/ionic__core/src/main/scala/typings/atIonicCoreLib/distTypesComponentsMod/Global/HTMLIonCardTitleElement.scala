...
@js.native
trait HTMLIonCardTitleElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonCardTitle {
...
@JSGlobal("HTMLIonCardTitleElement")
@js.native
class HTMLIonCardTitleElementCls () extends HTMLIonCardTitleElement {
  /* CompleteClass */
...
@JSGlobal("HTMLIonCardTitleElement")
@js.native
object HTMLIonCardTitleElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonCardTitleElement]
