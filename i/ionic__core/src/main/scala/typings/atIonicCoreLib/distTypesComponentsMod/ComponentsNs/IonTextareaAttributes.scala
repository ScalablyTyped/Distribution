...
trait IonTextareaAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonTextareaAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
  ...
  /**
    ...
    */
  @JSName("spellcheck")
  var spellcheck_IonTextareaAttributes: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object IonTextareaAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonTextareaAttributes]
  }
}
