...
trait IonRouteAttributes
  ...
  /**
    ...
    */
  var onIonRouteDataChanged: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[_], scala.Unit]] = js.undefined
  /**
...
object IonRouteAttributes {
  ...
  def apply(
    ...
    onIonRouteDataChanged: /* event */ stdLib.CustomEvent[_] => scala.Unit = null,
    ...
    __obj.asInstanceOf[IonRouteAttributes]
  }
}
