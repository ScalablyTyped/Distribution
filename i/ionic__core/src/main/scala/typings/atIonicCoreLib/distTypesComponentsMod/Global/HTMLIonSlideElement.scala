...
trait HTMLIonSlideElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonSlide {
...
@JSGlobal("HTMLIonSlideElement")
@js.native
object HTMLIonSlideElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonSlideElement]
