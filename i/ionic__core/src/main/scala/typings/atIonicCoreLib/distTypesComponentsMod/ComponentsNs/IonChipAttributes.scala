...
trait IonChipAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonChipAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonChipAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonChipAttributes]
  }
}
