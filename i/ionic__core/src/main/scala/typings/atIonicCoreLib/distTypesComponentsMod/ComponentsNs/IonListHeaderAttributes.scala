...
trait IonListHeaderAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonListHeaderAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonListHeaderAttributes {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IonListHeaderAttributes]
  }
}
