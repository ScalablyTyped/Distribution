...
trait HTMLIonToastElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonToast {
...
@JSGlobal("HTMLIonToastElement")
@js.native
object HTMLIonToastElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonToastElement]
