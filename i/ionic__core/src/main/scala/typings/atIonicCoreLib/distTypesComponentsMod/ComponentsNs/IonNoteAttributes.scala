...
trait IonNoteAttributes
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonNoteAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
...
object IonNoteAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonNoteAttributes]
  }
}
