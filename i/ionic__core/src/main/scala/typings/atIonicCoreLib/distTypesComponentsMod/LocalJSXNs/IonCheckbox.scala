...
trait IonCheckbox
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonCheckboxElement] {
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonCheckbox: js.UndefOr[
...
object IonCheckbox {
  ...
  def apply(
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonCheckboxElement] => scala.Unit = null,
