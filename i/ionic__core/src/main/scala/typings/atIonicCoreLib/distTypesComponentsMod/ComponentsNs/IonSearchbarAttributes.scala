...
trait IonSearchbarAttributes
  ...
  /**
    ...
    */
  @JSName("autocorrect")
  var autocorrect_IonSearchbarAttributes: js.UndefOr[
    atIonicCoreLib.atIonicCoreLibStrings.on | atIonicCoreLib.atIonicCoreLibStrings.off
  ] = js.undefined
  /**
    * Set the cancel button icon. Only applies to `md` mode.
    */
  var cancelButtonIcon: js.UndefOr[java.lang.String] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonSearchbarAttributes: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Color */ js.UndefOr[
  ...
  /**
    ...
    */
  var onIonClear: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[scala.Unit], scala.Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("spellcheck")
  var spellcheck_IonSearchbarAttributes: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * Set the type of the input.
    */
  var `type`: js.UndefOr[
    atIonicCoreLib.atIonicCoreLibStrings.text | atIonicCoreLib.atIonicCoreLibStrings.password | atIonicCoreLib.atIonicCoreLibStrings.email | atIonicCoreLib.atIonicCoreLibStrings.number | atIonicCoreLib.atIonicCoreLibStrings.search | atIonicCoreLib.atIonicCoreLibStrings.tel | atIonicCoreLib.atIonicCoreLibStrings.url
  ] = js.undefined
  /**
...
object IonSearchbarAttributes {
  ...
  def apply(
    ...
    autosave: java.lang.String = null,
    cancelButtonIcon: java.lang.String = null,
    ...
    onIonClear: /* event */ stdLib.CustomEvent[scala.Unit] => scala.Unit = null,
    ...
    `type`: atIonicCoreLib.atIonicCoreLibStrings.text | atIonicCoreLib.atIonicCoreLibStrings.password | atIonicCoreLib.atIonicCoreLibStrings.email | atIonicCoreLib.atIonicCoreLibStrings.number | atIonicCoreLib.atIonicCoreLibStrings.search | atIonicCoreLib.atIonicCoreLibStrings.tel | atIonicCoreLib.atIonicCoreLibStrings.url = null,
    typeof: java.lang.String = null,
    unselectable: js.UndefOr[scala.Boolean] = js.undefined,
    value: java.lang.String = null,
    vocab: java.lang.String = null
  ): IonSearchbarAttributes = {
    ...
    __obj.asInstanceOf[IonSearchbarAttributes]
  }
}
