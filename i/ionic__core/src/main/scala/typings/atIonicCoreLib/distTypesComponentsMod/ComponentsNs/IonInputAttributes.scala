...
trait IonInputAttributes
  ...
  var autocomplete: js.UndefOr[
    atIonicCoreLib.atIonicCoreLibStrings.on | atIonicCoreLib.atIonicCoreLibStrings.off
  ] = js.undefined
  /**
    * Whether auto correction should be enabled when the user is entering/editing the text value.
    */
  @JSName("autocorrect")
  var autocorrect_IonInputAttributes: js.UndefOr[
    atIonicCoreLib.atIonicCoreLibStrings.on | atIonicCoreLib.atIonicCoreLibStrings.off
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var clearInput: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onIonInput: js.UndefOr[js.Function1[/* event */ stdLib.CustomEvent[stdLib.KeyboardEvent], scala.Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  @JSName("spellcheck")
  var spellcheck_IonInputAttributes: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object IonInputAttributes {
  ...
  def apply(
    ...
    autocapitalize: java.lang.String = null,
    autocomplete: atIonicCoreLib.atIonicCoreLibStrings.on | atIonicCoreLib.atIonicCoreLibStrings.off = null,
    autocorrect: atIonicCoreLib.atIonicCoreLibStrings.on | atIonicCoreLib.atIonicCoreLibStrings.off = null,
    autofocus: js.UndefOr[scala.Boolean] = js.undefined,
    autosave: java.lang.String = null,
    `class`: java.lang.String | org.scalablytyped.runtime.StringDictionary[scala.Boolean] = null,
    clearInput: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    onIonInput: /* event */ stdLib.CustomEvent[stdLib.KeyboardEvent] => scala.Unit = null,
    ...
    __obj.asInstanceOf[IonInputAttributes]
  }
}
