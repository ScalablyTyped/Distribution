...
trait IonButton
  extends atIonicCoreLib.distTypesStencilDotCoreMod.JSXBaseNs.HTMLAttributes[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonButtonElement] {
  /**
    * The type of button.
    */
  ...
  /**
    ...
    */
  @JSName("color")
  var color_IonButton: js.UndefOr[
...
object IonButton {
  ...
  def apply(
    ...
    radiogroup: java.lang.String = null,
    ref: /* elm */ js.UndefOr[atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonButtonElement] => scala.Unit = null,
