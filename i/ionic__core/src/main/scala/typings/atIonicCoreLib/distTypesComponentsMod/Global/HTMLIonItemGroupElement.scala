...
trait HTMLIonItemGroupElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonItemGroup {
...
@JSGlobal("HTMLIonItemGroupElement")
@js.native
object HTMLIonItemGroupElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonItemGroupElement]
