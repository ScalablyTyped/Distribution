...
trait HTMLIonListHeaderElement
  extends atIonicCoreLib.distTypesStencilDotCoreMod.Global.HTMLStencilElement
     with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonListHeader {
...
@JSGlobal("HTMLIonListHeaderElement")
@js.native
object HTMLIonListHeaderElement
  extends org.scalablytyped.runtime.Instantiable0[HTMLIonListHeaderElement]
