...
trait ImgHTMLAttributes[T] extends HTMLAttributes[T] {
  ...
  var decoding: js.UndefOr[
    atIonicCoreLib.atIonicCoreLibStrings.async | atIonicCoreLib.atIonicCoreLibStrings.auto | atIonicCoreLib.atIonicCoreLibStrings.sync
  ] = js.undefined
...
object ImgHTMLAttributes {
  ...
  def apply[T](
    ...
    decoding: atIonicCoreLib.atIonicCoreLibStrings.async | atIonicCoreLib.atIonicCoreLibStrings.auto | atIonicCoreLib.atIonicCoreLibStrings.sync = null,
