package typings
package atIonicCoreLib.distTypesStencilDotCoreMod.JSXElementsNs
...
trait ThHTMLAttributes[T] extends HTMLAttributes[T] {
  ...
  var rowspan: js.UndefOr[scala.Double | java.lang.String] = js.undefined
...
object ThHTMLAttributes {
  ...
  def apply[T](
    ...
    rowspan: scala.Double | java.lang.String = null,
