...
object overlaysMod {
  ...
  inline def connectListeners(doc: Document): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("connectListeners")(doc.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def dismissOverlay(doc: Document, data: js.Any, role: String, overlayTag: String): js.Promise[Boolean] = (^.asInstanceOf[js.Dynamic].applyDynamic("dismissOverlay")(doc.asInstanceOf[js.Any], data.asInstanceOf[js.Any], role.asInstanceOf[js.Any], overlayTag.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Boolean]]
  ...
  inline def dismissOverlay(doc: Document, data: js.Any, role: Unit, overlayTag: String): js.Promise[Boolean] = (^.asInstanceOf[js.Dynamic].applyDynamic("dismissOverlay")(doc.asInstanceOf[js.Any], data.asInstanceOf[js.Any], role.asInstanceOf[js.Any], overlayTag.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Boolean]]
  ...
  inline def safeCall(handler: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("safeCall")(handler.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  inline def safeCall(handler: js.Any, arg: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("safeCall")(handler.asInstanceOf[js.Any], arg.asInstanceOf[js.Any])).asInstanceOf[js.Any]
