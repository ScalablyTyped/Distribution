...
object mod {
  ...
  @js.native
  class Config_ ()
    extends typings.ionicCore.configMod.Config_
  
  @JSImport("@ionic/core", "IonicSafeString")
  @js.native
  class IonicSafeString protected ()
    extends typings.ionicCore.typesMod.IonicSafeString {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.ionicCore.ionicCoreStrings.on
    - typings.ionicCore.ionicCoreStrings.off
    - typings.ionicCore.ionicCoreStrings.name
    - typings.ionicCore.ionicCoreStrings.`honorific-prefix`
    - typings.ionicCore.ionicCoreStrings.`given-name`
    - typings.ionicCore.ionicCoreStrings.`additional-name`
    - typings.ionicCore.ionicCoreStrings.`family-name`
    - typings.ionicCore.ionicCoreStrings.`honorific-suffix`
    - typings.ionicCore.ionicCoreStrings.nickname
    - typings.ionicCore.ionicCoreStrings.email
    - typings.ionicCore.ionicCoreStrings.username
    - typings.ionicCore.ionicCoreStrings.`new-password`
    - typings.ionicCore.ionicCoreStrings.`current-password`
    - typings.ionicCore.ionicCoreStrings.`one-time-code`
    - typings.ionicCore.ionicCoreStrings.`organization-title`
    - typings.ionicCore.ionicCoreStrings.organization
    - typings.ionicCore.ionicCoreStrings.`street-address`
    - typings.ionicCore.ionicCoreStrings.`address-line1`
    - typings.ionicCore.ionicCoreStrings.`address-line2`
    - typings.ionicCore.ionicCoreStrings.`address-line3`
    - typings.ionicCore.ionicCoreStrings.`address-level4`
    - typings.ionicCore.ionicCoreStrings.`address-level3`
    - typings.ionicCore.ionicCoreStrings.`address-level2`
    - typings.ionicCore.ionicCoreStrings.`address-level1`
    - typings.ionicCore.ionicCoreStrings.country
    - typings.ionicCore.ionicCoreStrings.`country-name`
    - typings.ionicCore.ionicCoreStrings.`postal-code`
    - typings.ionicCore.ionicCoreStrings.`cc-name`
    - typings.ionicCore.ionicCoreStrings.`cc-given-name`
    - typings.ionicCore.ionicCoreStrings.`cc-additional-name`
    - typings.ionicCore.ionicCoreStrings.`cc-family-name`
    - typings.ionicCore.ionicCoreStrings.`cc-number`
    - typings.ionicCore.ionicCoreStrings.`cc-exp`
    - typings.ionicCore.ionicCoreStrings.`cc-exp-month`
    - typings.ionicCore.ionicCoreStrings.`cc-exp-year`
    - typings.ionicCore.ionicCoreStrings.`cc-csc`
    - typings.ionicCore.ionicCoreStrings.`cc-type`
    - typings.ionicCore.ionicCoreStrings.`transaction-currency`
    - typings.ionicCore.ionicCoreStrings.`transaction-amount`
    - typings.ionicCore.ionicCoreStrings.language
    - typings.ionicCore.ionicCoreStrings.bday
    - typings.ionicCore.ionicCoreStrings.`bday-day`
    - typings.ionicCore.ionicCoreStrings.`bday-month`
    - typings.ionicCore.ionicCoreStrings.`bday-year`
    - typings.ionicCore.ionicCoreStrings.sex
    - typings.ionicCore.ionicCoreStrings.tel
    - typings.ionicCore.ionicCoreStrings.`tel-country-code`
    - typings.ionicCore.ionicCoreStrings.`tel-national`
    - typings.ionicCore.ionicCoreStrings.`tel-area-code`
    - typings.ionicCore.ionicCoreStrings.`tel-local`
    - typings.ionicCore.ionicCoreStrings.`tel-extension`
    - typings.ionicCore.ionicCoreStrings.impp
    - typings.ionicCore.ionicCoreStrings.url
    - typings.ionicCore.ionicCoreStrings.photo
  */
  ...
  trait BackButtonEventDetail extends StObject {
    ...
    def register(
      priority: Double,
      handler: js.Function1[/* processNextHandler */ js.Function0[Unit], js.Promise[js.Any] | Unit]
    ): Unit
  }
  ...
  trait FrameworkDelegate extends StObject {
    ...
    def attachViewToDom(container: js.Any, component: js.Any, propsOrDataObj: Unit, cssClasses: js.Array[String]): js.Promise[HTMLElement] = js.native
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.ionicCore.ionicCoreStrings.primary
    - typings.ionicCore.ionicCoreStrings.secondary
    - typings.ionicCore.ionicCoreStrings.tertiary
    - typings.ionicCore.ionicCoreStrings.success
    - typings.ionicCore.ionicCoreStrings.warning
    - typings.ionicCore.ionicCoreStrings.danger
    - typings.ionicCore.ionicCoreStrings.light
    - typings.ionicCore.ionicCoreStrings.medium
    - typings.ionicCore.ionicCoreStrings.dark
  */
