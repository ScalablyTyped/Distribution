...
object parserMod {
  ...
  inline def readProp(el: HTMLElement, prop: String): js.UndefOr[String | Null] = (^.asInstanceOf[js.Dynamic].applyDynamic("readProp")(el.asInstanceOf[js.Any], prop.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[String | Null]]
  ...
  inline def readRouteNodes(root: Element): RouteTree = ^.asInstanceOf[js.Dynamic].applyDynamic("readRouteNodes")(root.asInstanceOf[js.Any]).asInstanceOf[RouteTree]
  inline def readRouteNodes(root: Element, node: Element): RouteTree = (^.asInstanceOf[js.Dynamic].applyDynamic("readRouteNodes")(root.asInstanceOf[js.Any], node.asInstanceOf[js.Any])).asInstanceOf[RouteTree]
