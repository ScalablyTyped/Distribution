...
/* Rewritten from type alias, can be one of: 
  - typings.ionicCore.ionicCoreStrings.date
  - typings.ionicCore.ionicCoreStrings.email
  - typings.ionicCore.ionicCoreStrings.number
  - typings.ionicCore.ionicCoreStrings.password
  - typings.ionicCore.ionicCoreStrings.search
  - typings.ionicCore.ionicCoreStrings.tel
