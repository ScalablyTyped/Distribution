...
object animationUtilsMod {
  ...
  inline def generateKeyframeRules(keyframes: js.Array[js.Any]): String = ^.asInstanceOf[js.Dynamic].applyDynamic("generateKeyframeRules")(keyframes.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def getStyleContainer(element: HTMLElement): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getStyleContainer")(element.asInstanceOf[js.Any]).asInstanceOf[js.Any]
