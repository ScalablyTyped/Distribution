...
object InputHTMLAttributes {
  ...
  def apply[T](
    ...
    if (!js.isUndefined(allowdirs)) __obj.updateDynamic("allowdirs")(allowdirs.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(webkitdirectory)) __obj.updateDynamic("webkitdirectory")(webkitdirectory.get.asInstanceOf[js.Any])
