...
object watchOptionsMod {
  ...
  inline def findCheckedOption(el: js.Any, tagName: String): js.UndefOr[HTMLElement] = (^.asInstanceOf[js.Dynamic].applyDynamic("findCheckedOption")(el.asInstanceOf[js.Any], tagName.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[HTMLElement]]
