...
object IonRoute {
  ...
  inline def apply(component: String): IonRoute = {
  ...
  extension [Self <: IonRoute](x: Self) {
    ...
    inline def setOnIonRouteDataChanged(value: /* event */ CustomEvent[js.Any] => Unit): Self = StObject.set(x, "onIonRouteDataChanged", js.Any.fromFunction1(value))
    
    inline def setOnIonRouteDataChangedUndefined: Self = StObject.set(x, "onIonRouteDataChanged", js.undefined)
