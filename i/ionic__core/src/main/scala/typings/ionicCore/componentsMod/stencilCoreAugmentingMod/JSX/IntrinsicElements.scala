...
import typings.ionicCore.componentsMod._Global_.HTMLIonRouteElement
import typings.ionicCore.componentsMod._Global_.HTMLIonRouteRedirectElement
import typings.ionicCore.componentsMod._Global_.HTMLIonRouterElement
