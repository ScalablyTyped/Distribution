...
object IonLabel {
  ...
  @scala.inline
  implicit class IonLabelOps[Self <: IonLabel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPosition(value: fixed | stacked | floating): Self = this.set("position", value.asInstanceOf[js.Any])
