...
object IonActionSheet {
  ...
  implicit class IonActionSheetMutableBuilder[Self <: IonActionSheet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonActionSheetDidDismiss(value: /* event */ CustomEvent[OverlayEventDetail[_]] => Unit): Self = StObject.set(x, "onIonActionSheetDidDismiss", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnIonActionSheetWillDismiss(value: /* event */ CustomEvent[OverlayEventDetail[_]] => Unit): Self = StObject.set(x, "onIonActionSheetWillDismiss", js.Any.fromFunction1(value))
