...
import typings.ionicCore.componentsMod.Components.IonSegmentButton
...
@js.native
object HTMLIonSegmentButtonElement extends Instantiable0[HTMLIonSegmentButtonElement]
