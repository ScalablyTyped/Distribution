...
object IonLoading {
  ...
  extension [Self <: IonLoading](x: Self) {
    ...
    inline def setOnIonLoadingDidDismiss(value: /* event */ CustomEvent[OverlayEventDetail[js.Any]] => Unit): Self = StObject.set(x, "onIonLoadingDidDismiss", js.Any.fromFunction1(value))
    
    inline def setOnIonLoadingDidDismissUndefined: Self = StObject.set(x, "onIonLoadingDidDismiss", js.undefined)
    
    inline def setOnIonLoadingDidPresent(value: /* event */ CustomEvent[Unit] => Unit): Self = StObject.set(x, "onIonLoadingDidPresent", js.Any.fromFunction1(value))
    
    inline def setOnIonLoadingDidPresentUndefined: Self = StObject.set(x, "onIonLoadingDidPresent", js.undefined)
    
    inline def setOnIonLoadingWillDismiss(value: /* event */ CustomEvent[OverlayEventDetail[js.Any]] => Unit): Self = StObject.set(x, "onIonLoadingWillDismiss", js.Any.fromFunction1(value))
    
    inline def setOnIonLoadingWillDismissUndefined: Self = StObject.set(x, "onIonLoadingWillDismiss", js.undefined)
    
    inline def setOnIonLoadingWillPresent(value: /* event */ CustomEvent[Unit] => Unit): Self = StObject.set(x, "onIonLoadingWillPresent", js.Any.fromFunction1(value))
