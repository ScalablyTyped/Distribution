...
object typesSrcUtilMod {
  ...
  inline def createNode(data: js.typedarray.Uint8Array, links: js.Array[typings.ipldDagPb.typesSrcInterfaceMod.PBLink]): PBNode = (^.asInstanceOf[js.Dynamic].applyDynamic("createNode")(data.asInstanceOf[js.Any], links.asInstanceOf[js.Any])).asInstanceOf[PBNode]
