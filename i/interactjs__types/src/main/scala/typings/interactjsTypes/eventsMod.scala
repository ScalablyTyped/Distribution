...
object eventsMod {
  ...
  object interactjsCoreScopeAugmentingMod {
    ...
    object Scope {
      ...
      inline def apply(
        events: ReturnType[
              js.Function1[typings.interactjsTypes.eventsMod.interactjsCoreScopeAugmentingMod.Scope, Add]
            ]
      ): typings.interactjsTypes.eventsMod.interactjsCoreScopeAugmentingMod.Scope = {
        val __obj = js.Dynamic.literal(events = events.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.interactjsTypes.eventsMod.interactjsCoreScopeAugmentingMod.Scope]
      }
      
      extension [Self <: typings.interactjsTypes.eventsMod.interactjsCoreScopeAugmentingMod.Scope](x: Self) {
