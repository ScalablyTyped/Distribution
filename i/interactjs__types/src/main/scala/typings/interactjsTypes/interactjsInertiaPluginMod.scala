...
object interactjsInertiaPluginMod extends Shortcut {
  ...
  open class InertiaState protected () extends StObject {
    ...
    var modification: typings.interactjsTypes.modificationMod.default = js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `interactjsInertiaPluginMod.foo` */
  ...
  object interactjsCoreInteractionAugmentingMod {
    ...
    object Interaction {
      ...
      inline def apply(): typings.interactjsTypes.interactjsInertiaPluginMod.interactjsCoreInteractionAugmentingMod.Interaction = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typings.interactjsTypes.interactjsInertiaPluginMod.interactjsCoreInteractionAugmentingMod.Interaction]
      }
      
      extension [Self <: typings.interactjsTypes.interactjsInertiaPluginMod.interactjsCoreInteractionAugmentingMod.Interaction](x: Self) {
