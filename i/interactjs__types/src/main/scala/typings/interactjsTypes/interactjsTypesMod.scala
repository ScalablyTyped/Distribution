...
object interactjsTypesMod {
  
  @JSImport("@interactjs/types", "DropEvent")
  @js.native
  open class DropEvent protected ()
    extends typings.interactjsTypes.interactjsTypesIndexMod.DropEvent {
    /**
  ...
  open class Interactable protected ()
    extends typings.interactjsTypes.interactjsTypesIndexMod.Interactable {
    def this(
      target: Target,
      options: Any,
