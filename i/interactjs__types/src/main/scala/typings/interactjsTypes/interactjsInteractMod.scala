...
object interactjsInteractMod extends Shortcut {
  
  @JSImport("@interactjs/interact/index", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `interactjsInteractMod.foo` */
