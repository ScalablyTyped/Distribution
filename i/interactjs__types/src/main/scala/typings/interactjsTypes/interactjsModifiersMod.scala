...
object interactjsModifiersMod {
  ...
  object interactjsCoreInteractionAugmentingMod {
    ...
    trait Interaction extends StObject {
      ...
      var modification: js.UndefOr[typings.interactjsTypes.modificationMod.default] = js.undefined
    }
    object Interaction {
      ...
      extension [Self <: Interaction](x: Self) {
        ...
        inline def setModification(value: typings.interactjsTypes.modificationMod.default): Self = StObject.set(x, "modification", value.asInstanceOf[js.Any])
