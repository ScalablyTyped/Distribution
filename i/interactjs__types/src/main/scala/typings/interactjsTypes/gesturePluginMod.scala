...
object gesturePluginMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `gesturePluginMod.foo` */
  ...
  object interactjsCoreInteractionAugmentingMod {
    ...
    object Interaction {
      ...
      inline def apply(): typings.interactjsTypes.gesturePluginMod.interactjsCoreInteractionAugmentingMod.Interaction = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typings.interactjsTypes.gesturePluginMod.interactjsCoreInteractionAugmentingMod.Interaction]
      }
      
      extension [Self <: typings.interactjsTypes.gesturePluginMod.interactjsCoreInteractionAugmentingMod.Interaction](x: Self) {
