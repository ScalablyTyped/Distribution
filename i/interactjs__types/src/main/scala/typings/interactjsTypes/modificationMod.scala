...
object modificationMod {
  ...
  trait Modification extends StObject {
    ...
    var startOffset: typings.interactjsTypes.typesMod.Rect = js.native
  ...
  trait ModificationResult extends StObject {
    ...
    var rectDelta: typings.interactjsTypes.typesMod.Rect
  }
  object ModificationResult {
    ...
    inline def apply(
      ...
      rect: FullRect,
      rectDelta: typings.interactjsTypes.typesMod.Rect
    ): ModificationResult = {
    ...
    extension [Self <: ModificationResult](x: Self) {
      ...
      inline def setRectDelta(value: typings.interactjsTypes.typesMod.Rect): Self = StObject.set(x, "rectDelta", value.asInstanceOf[js.Any])
    }
  }
}
