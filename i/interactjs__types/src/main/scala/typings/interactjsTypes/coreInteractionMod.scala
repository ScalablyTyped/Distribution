...
object coreInteractionMod {
  ...
  open class Interaction[T /* <: ActionName | Null */] protected () extends StObject {
    ...
    def _doPhase(signalArg: (Omit[DoPhaseArg[T, reflow], iEvent]) & `4`[T]): Boolean = js.native
    def _doPhase(signalArg: (Omit[DoPhaseArg[T, resume], iEvent]) & `2`[T]): Boolean = js.native
    def _doPhase(signalArg: (Omit[DoPhaseArg[T, inertiastart], iEvent]) & `3`[T]): Boolean = js.native
    def _doPhase(signalArg: (Omit[DoPhaseArg[T, start], iEvent]) & IEvent[T]): Boolean = js.native
    def _doPhase(signalArg: (Omit[DoPhaseArg[T, end], iEvent]) & `1`[T]): Boolean = js.native
    def _doPhase(signalArg: (Omit[DoPhaseArg[T, move], iEvent]) & `0`[T]): Boolean = js.native
    ...
    def getPointerInfo(pointer: Any): typings.interactjsTypes.corePointerInfoMod.PointerInfo = js.native
    ...
    var modification: js.UndefOr[typings.interactjsTypes.modifiersModificationMod.default] = js.native
    ...
    var pointers: js.Array[typings.interactjsTypes.corePointerInfoMod.PointerInfo] = js.native
  ...
  open class PointerInfo protected ()
    extends typings.interactjsTypes.corePointerInfoMod.PointerInfo {
    def this(
      id: Double,
      pointer: PointerType,
      event: PointerEventType,
  ...
  object ProxyValues extends StObject {
    ...
    sealed trait _proxy
      extends StObject
         with ProxyValues
    /* "" */ val _proxy: typings.interactjsTypes.coreInteractionMod.ProxyValues._proxy & String = js.native
    
    @js.native
    sealed trait element
      extends StObject
         with ProxyValues
    /* "" */ val element: typings.interactjsTypes.coreInteractionMod.ProxyValues.element & String = js.native
    
    @js.native
    sealed trait interactable
      extends StObject
         with ProxyValues
    /* "" */ val interactable: typings.interactjsTypes.coreInteractionMod.ProxyValues.interactable & String = js.native
    
    @js.native
    sealed trait pointerIsDown
      extends StObject
         with ProxyValues
    /* "" */ val pointerIsDown: typings.interactjsTypes.coreInteractionMod.ProxyValues.pointerIsDown & String = js.native
    
    @js.native
    sealed trait pointerWasMoved
      extends StObject
         with ProxyValues
    /* "" */ val pointerWasMoved: typings.interactjsTypes.coreInteractionMod.ProxyValues.pointerWasMoved & String = js.native
    
    @js.native
    sealed trait prepared
      extends StObject
         with ProxyValues
    /* "" */ val prepared: typings.interactjsTypes.coreInteractionMod.ProxyValues.prepared & String = js.native
  }
