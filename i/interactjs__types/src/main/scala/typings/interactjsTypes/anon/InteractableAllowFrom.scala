...
@js.native
trait InteractableAllowFrom extends StObject {
  ...
  def allowFrom(args: Any*): typings.interactjsTypes.interactableMethodsMod.interactjsCoreInteractableAugmentingMod.Interactable = js.native
  ...
  def dropCheck(
    ...
    draggable: typings.interactjsTypes.dropPluginMod.interactjsCoreInteractableAugmentingMod.Interactable,
  ...
  def ignoreFrom(args: Any*): typings.interactjsTypes.interactableMethodsMod.interactjsCoreInteractableAugmentingMod.Interactable = js.native
