...
@js.native
trait InteractableConstructor extends StObject {
  ...
  def _onOff(method: on | off, typeArg: EventTypes): Scope = js.native
  def _onOff(method: on | off, typeArg: EventTypes, listenerArg: Null, options: Any): Scope = js.native
  def _onOff(method: on | off, typeArg: EventTypes, listenerArg: Unit, options: Any): Scope = js.native
  def _onOff(method: on | off, typeArg: EventTypes, listenerArg: ListenersArg): Scope = js.native
  def _onOff(method: on | off, typeArg: EventTypes, listenerArg: ListenersArg, options: Any): Scope = js.native
  ...
  def deltaSource(newValue: DeltaSource): Scope = js.native
  ...
  /**
    ...
    */
  def fire[E /* <: Type */](iEvent: E): Scope = js.native
  ...
  /**
    ...
    * @return {Interactable} This Interactable
    */
  def off(types: String): Scope = js.native
  def off(types: String, listener: Unit, options: Any): Scope = js.native
  def off(types: String, listener: ListenersArg): Scope = js.native
  def off(types: String, listener: ListenersArg, options: Any): Scope = js.native
  def off(types: js.Array[String]): Scope = js.native
  def off(types: js.Array[String], listener: Unit, options: Any): Scope = js.native
  def off(types: js.Array[String], listener: ListenersArg): Scope = js.native
  def off(types: js.Array[String], listener: ListenersArg, options: Any): Scope = js.native
  def off(types: EventTypes): Scope = js.native
  def off(types: EventTypes, listener: Unit, options: Any): Scope = js.native
  def off(types: EventTypes, listener: ListenersArg): Scope = js.native
  def off(types: EventTypes, listener: ListenersArg, options: Any): Scope = js.native
  ...
  /**
    ...
    * @return {Interactable} This Interactable
    */
  def on(types: EventTypes): Scope = js.native
  def on(types: EventTypes, listener: Unit, options: Any): Scope = js.native
  def on(types: EventTypes, listener: ListenersArg): Scope = js.native
  def on(types: EventTypes, listener: ListenersArg, options: Any): Scope = js.native
  ...
  def rectChecker(checker: js.Function1[/* element */ typings.interactjsTypes.coreTypesMod.Element, Any]): Scope = js.native
  ...
  /**
    ...
    */
  def set(options: OptionsArg): Scope = js.native
  
  def setOnEvents(actionName: ActionName, phases: NonNullable[Any]): Scope = js.native
