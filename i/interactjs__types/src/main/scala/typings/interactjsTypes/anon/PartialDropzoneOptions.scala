...
trait PartialDropzoneOptions extends StObject {
  ...
  var accept: js.UndefOr[
    String | typings.interactjsTypes.typesMod.Element | (js.Function1[/* hasDropzoneDraggableElement */ DraggableElement, Boolean])
  ] = js.undefined
...
object PartialDropzoneOptions {
  ...
  extension [Self <: PartialDropzoneOptions](x: Self) {
    ...
    inline def setAccept(
      value: String | typings.interactjsTypes.typesMod.Element | (js.Function1[/* hasDropzoneDraggableElement */ DraggableElement, Boolean])
