...
trait Node extends StObject {
  ...
  var interaction: typings.interactjsTypes.interactionMod.Interaction[Any]
...
object Node {
  ...
  inline def apply(
    ...
    interaction: typings.interactjsTypes.interactionMod.Interaction[Any],
    node: Null,
  ...
  extension [Self <: Node](x: Self) {
    ...
    inline def setInteraction(value: typings.interactjsTypes.interactionMod.Interaction[Any]): Self = StObject.set(x, "interaction", value.asInstanceOf[js.Any])
