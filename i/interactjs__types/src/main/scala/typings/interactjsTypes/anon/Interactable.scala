...
trait Interactable extends StObject {
  ...
  /**
    ...
    */
  def getRect(element: typings.interactjsTypes.coreTypesMod.Element): Required[typings.interactjsTypes.coreTypesMod.Rect] = js.native
  ...
  val options: Required[this.type] = js.native
  ...
  def setPerAction(actionName: ActionName, options: OrBoolean[this.type]): Unit = js.native
