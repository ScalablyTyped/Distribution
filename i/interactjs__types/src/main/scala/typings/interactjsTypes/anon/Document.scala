...
trait Document[T /* <: typings.interactjsTypes.typesMod.Target */] extends StObject {
...
object Document {
  ...
  inline def apply[T /* <: typings.interactjsTypes.typesMod.Target */](): Document[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Document[T]]
  }
  
  extension [Self <: Document[?], T /* <: typings.interactjsTypes.typesMod.Target */](x: Self & Document[T]) {
