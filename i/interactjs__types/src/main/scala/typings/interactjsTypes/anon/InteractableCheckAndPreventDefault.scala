...
import typings.interactjsTypes.coreInteractableSetMod.InteractableSet
...
@js.native
trait InteractableCheckAndPreventDefault extends StObject {
  ...
  def _onOff(method: on | off, typeArg: EventTypes): InteractableSet = js.native
  def _onOff(method: on | off, typeArg: EventTypes, listenerArg: Null, options: Any): InteractableSet = js.native
  def _onOff(method: on | off, typeArg: EventTypes, listenerArg: Unit, options: Any): InteractableSet = js.native
  def _onOff(method: on | off, typeArg: EventTypes, listenerArg: ListenersArg): InteractableSet = js.native
  def _onOff(method: on | off, typeArg: EventTypes, listenerArg: ListenersArg, options: Any): InteractableSet = js.native
  ...
  def deltaSource(newValue: DeltaSource): InteractableSet = js.native
  ...
  /**
    ...
    */
  def fire[E /* <: Type */](iEvent: E): InteractableSet = js.native
  ...
  /**
    ...
    * @return {Interactable} This Interactable
    */
  def off(types: String): InteractableSet = js.native
  def off(types: String, listener: Unit, options: Any): InteractableSet = js.native
  def off(types: String, listener: ListenersArg): InteractableSet = js.native
  def off(types: String, listener: ListenersArg, options: Any): InteractableSet = js.native
  def off(types: js.Array[String]): InteractableSet = js.native
  def off(types: js.Array[String], listener: Unit, options: Any): InteractableSet = js.native
  def off(types: js.Array[String], listener: ListenersArg): InteractableSet = js.native
  def off(types: js.Array[String], listener: ListenersArg, options: Any): InteractableSet = js.native
  def off(types: EventTypes): InteractableSet = js.native
  def off(types: EventTypes, listener: Unit, options: Any): InteractableSet = js.native
  def off(types: EventTypes, listener: ListenersArg): InteractableSet = js.native
  def off(types: EventTypes, listener: ListenersArg, options: Any): InteractableSet = js.native
  ...
  /**
    ...
    * @return {Interactable} This Interactable
    */
  def on(types: EventTypes): InteractableSet = js.native
  def on(types: EventTypes, listener: Unit, options: Any): InteractableSet = js.native
  def on(types: EventTypes, listener: ListenersArg): InteractableSet = js.native
  def on(types: EventTypes, listener: ListenersArg, options: Any): InteractableSet = js.native
  ...
  def rectChecker(checker: js.Function1[/* element */ typings.interactjsTypes.coreTypesMod.Element, Any]): InteractableSet = js.native
  ...
  /**
    ...
    */
  def set(options: OptionsArg): InteractableSet = js.native
  
  def setOnEvents(actionName: ActionName, phases: NonNullable[Any]): InteractableSet = js.native
