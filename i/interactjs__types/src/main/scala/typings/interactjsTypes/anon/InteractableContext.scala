...
@js.native
trait InteractableContext extends StObject {
  ...
  val options: RequiredOptionsContext = js.native
  ...
  def setPerAction(actionName: ActionName, options: OrBooleanOptionsContext): Unit = js.native
