...
trait ElementElementInteractionPartial extends StObject {
  ...
  var interaction: Partial[typings.interactjsTypes.interactionMod.Interaction[resize]]
}
object ElementElementInteractionPartial {
  
  inline def apply(
    element: typings.std.Element,
    interaction: Partial[typings.interactjsTypes.interactionMod.Interaction[resize]]
  ...
  extension [Self <: ElementElementInteractionPartial](x: Self) {
    ...
    inline def setInteraction(value: Partial[typings.interactjsTypes.interactionMod.Interaction[resize]]): Self = StObject.set(x, "interaction", value.asInstanceOf[js.Any])
  }
}
