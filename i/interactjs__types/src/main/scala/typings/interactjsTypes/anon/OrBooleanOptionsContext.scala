...
trait OrBooleanOptionsContext extends StObject {
  ...
  var drop: js.UndefOr[Partial[this.type] | Boolean] = js.undefined
...
object OrBooleanOptionsContext {
  
  inline def apply(): OrBooleanOptionsContext = {
  ...
  extension [Self <: OrBooleanOptionsContext](x: Self) {
    ...
    inline def setDrop(value: Partial[OrBooleanOptionsContext] | Boolean): Self = StObject.set(x, "drop", value.asInstanceOf[js.Any])
