...
trait PartialDropzoneOptionsAllowFrom extends StObject {
  
  var accept: js.UndefOr[
    String | typings.interactjsTypes.typesMod.Element | (js.Function1[/* hasDropzoneDraggableElement */ DraggableElementDropzone, Boolean])
  ] = js.undefined
  ...
  var mouseButtons: js.UndefOr[
    typings.interactjsTypes.interactjsTypesNumbers.`0` | typings.interactjsTypes.interactjsTypesNumbers.`1` | typings.interactjsTypes.interactjsTypesNumbers.`2` | typings.interactjsTypes.interactjsTypesNumbers.`4` | `8` | `16`
  ] = js.undefined
...
object PartialDropzoneOptionsAllowFrom {
  
  inline def apply(): PartialDropzoneOptionsAllowFrom = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialDropzoneOptionsAllowFrom]
  }
  
  extension [Self <: PartialDropzoneOptionsAllowFrom](x: Self) {
    
    inline def setAccept(
      value: String | typings.interactjsTypes.typesMod.Element | (js.Function1[/* hasDropzoneDraggableElement */ DraggableElementDropzone, Boolean])
    ): Self = StObject.set(x, "accept", value.asInstanceOf[js.Any])
    
    inline def setAcceptFunction1(value: /* hasDropzoneDraggableElement */ DraggableElementDropzone => Boolean): Self = StObject.set(x, "accept", js.Any.fromFunction1(value))
