...
object baseMod extends Shortcut {
  ...
  object interactjsCoreScopeAugmentingMod {
    ...
    object Scope {
      ...
      inline def apply(autoStart: AutoStart): typings.interactjsTypes.baseMod.interactjsCoreScopeAugmentingMod.Scope = {
        val __obj = js.Dynamic.literal(autoStart = autoStart.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.interactjsTypes.baseMod.interactjsCoreScopeAugmentingMod.Scope]
      }
      
      extension [Self <: typings.interactjsTypes.baseMod.interactjsCoreScopeAugmentingMod.Scope](x: Self) {
