...
object modifiersNoopMod extends Shortcut {
  
  @JSImport("@interactjs/modifiers/noop", JSImport.Default)
  @js.native
  val default: ModifierFunction[Any, Any, noop] = js.native
  
  type _To = ModifierFunction[Any, Any, noop]
  
  /* This means you don't have to write `default`, but can instead just say `modifiersNoopMod.foo` */
