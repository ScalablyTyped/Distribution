...
object MediaConfigureTimelineOptions {
  ...
  def apply(
    ...
    if (camera_make != null) __obj.updateDynamic("camera_make")(camera_make)
    if (camera_model != null) __obj.updateDynamic("camera_model")(camera_model)
    if (caption != null) __obj.updateDynamic("caption")(caption)
    if (creation_logger_session_id != null) __obj.updateDynamic("creation_logger_session_id")(creation_logger_session_id)
    if (date_time_digitalized != null) __obj.updateDynamic("date_time_digitalized")(date_time_digitalized)
