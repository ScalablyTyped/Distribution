...
trait UserStoryFeedResponseFriendship_status extends js.Object {
...
object UserStoryFeedResponseFriendship_status {
  @scala.inline
  def apply(
    blocking: Boolean,
    followed_by: Boolean,
    ...
    __obj.asInstanceOf[UserStoryFeedResponseFriendship_status]
  }
}
