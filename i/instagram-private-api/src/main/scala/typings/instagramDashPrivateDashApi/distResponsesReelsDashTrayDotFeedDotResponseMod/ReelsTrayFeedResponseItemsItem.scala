...
trait ReelsTrayFeedResponseItemsItem extends js.Object {
  ...
  var code: String
  var creative_config: js.UndefOr[ReelsTrayFeedResponseCreative_config] = js.undefined
  ...
  var id: String
  var image_versions2: ReelsTrayFeedResponseImage_versions2
...
object ReelsTrayFeedResponseItemsItem {
  ...
  def apply(
    ...
    creative_config: ReelsTrayFeedResponseCreative_config = null,
    ...
    if (story_polls != null) __obj.updateDynamic("story_polls")(story_polls)
    if (story_questions != null) __obj.updateDynamic("story_questions")(story_questions)
