...
object InsightsServiceAccountResponseFollowers_unit {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(all_followers_age_graph = all_followers_age_graph, days_hourly_followers_graphs = days_hourly_followers_graphs, followers_delta_from_last_week = followers_delta_from_last_week, followers_top_cities_graph = followers_top_cities_graph, followers_top_countries_graph = followers_top_countries_graph, followers_unit_state = followers_unit_state, gender_graph = gender_graph, men_followers_age_graph = men_followers_age_graph, week_daily_followers_graph = week_daily_followers_graph, women_followers_age_graph = women_followers_age_graph)
