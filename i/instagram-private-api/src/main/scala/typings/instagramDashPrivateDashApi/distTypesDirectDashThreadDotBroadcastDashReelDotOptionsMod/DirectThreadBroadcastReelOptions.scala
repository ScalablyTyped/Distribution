...
import typings.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.photo_
import typings.instagramDashPrivateDashApi.instagramDashPrivateDashApiStrings.video_
