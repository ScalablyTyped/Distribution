...
trait MediaUpdatedMediaResponseUpdated_media extends js.Object {
  ...
  var creative_config: MediaUpdatedMediaResponseCreative_config
  ...
  var id: String
  var image_versions2: MediaUpdatedMediaResponseImage_versions2
...
object MediaUpdatedMediaResponseUpdated_media {
  @scala.inline
  def apply(
    can_reply: Boolean,
    can_reshare: Boolean,
  ...
  ): MediaUpdatedMediaResponseUpdated_media = {
    ...
    __obj.asInstanceOf[MediaUpdatedMediaResponseUpdated_media]
  }
}
