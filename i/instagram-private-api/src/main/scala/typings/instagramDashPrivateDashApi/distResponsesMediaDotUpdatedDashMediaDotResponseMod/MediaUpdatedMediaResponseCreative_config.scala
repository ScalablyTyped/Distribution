...
trait MediaUpdatedMediaResponseCreative_config extends js.Object {
  var camera_facing: String
  var capture_type: String
  var should_render_try_it_on: Boolean
}

object MediaUpdatedMediaResponseCreative_config {
  @scala.inline
  def apply(camera_facing: String, capture_type: String, should_render_try_it_on: Boolean): MediaUpdatedMediaResponseCreative_config = {
    ...
    __obj.asInstanceOf[MediaUpdatedMediaResponseCreative_config]
  }
}
