...
trait StoryPollVotersFeedResponseFriendship_status extends js.Object {
...
object StoryPollVotersFeedResponseFriendship_status {
  @scala.inline
  def apply(
    following: Boolean,
    ...
    __obj.asInstanceOf[StoryPollVotersFeedResponseFriendship_status]
  }
}
