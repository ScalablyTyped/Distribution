...
object MediaConfigureStoryBaseOptions {
  ...
  def apply(
    ...
    if (camera_position != null) __obj.updateDynamic("camera_position")(camera_position)
    if (caption != null) __obj.updateDynamic("caption")(caption)
    if (client_context != null) __obj.updateDynamic("client_context")(client_context)
    if (client_shared_at != null) __obj.updateDynamic("client_shared_at")(client_shared_at)
    if (geotag_enabled != null) __obj.updateDynamic("geotag_enabled")(geotag_enabled.asInstanceOf[js.Any])
    if (internal_features != null) __obj.updateDynamic("internal_features")(internal_features)
    if (mas_opt_in != null) __obj.updateDynamic("mas_opt_in")(mas_opt_in)
    ...
    if (story_media_creation_date != null) __obj.updateDynamic("story_media_creation_date")(story_media_creation_date)
