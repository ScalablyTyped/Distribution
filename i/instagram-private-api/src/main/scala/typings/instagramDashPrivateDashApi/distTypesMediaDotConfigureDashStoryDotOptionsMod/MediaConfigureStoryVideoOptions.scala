...
import typings.instagramDashPrivateDashApi.distTypesMediaDotConfigureDashVideoDotOptionsMod.MediaConfigureVideoOptions
...
object MediaConfigureStoryVideoOptions {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(configure_mode = configure_mode.asInstanceOf[js.Any], height = height, length = length, upload_id = upload_id, width = width)
