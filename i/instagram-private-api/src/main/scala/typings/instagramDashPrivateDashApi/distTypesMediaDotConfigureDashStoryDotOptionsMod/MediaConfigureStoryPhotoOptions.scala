...
import typings.instagramDashPrivateDashApi.distTypesMediaDotConfigureDotOptionsMod.MediaConfigureOptions
...
object MediaConfigureStoryPhotoOptions {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(configure_mode = configure_mode.asInstanceOf[js.Any], upload_id = upload_id)
