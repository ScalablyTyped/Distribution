...
trait SavedFeedResponseMedia extends js.Object {
  ...
  var id: String
  var image_versions2: js.UndefOr[SavedFeedResponseImage_versions2] = js.undefined
  ...
  var product_tags: js.UndefOr[SavedFeedResponseProduct_tags] = js.undefined
...
object SavedFeedResponseMedia {
  ...
  def apply(
    ...
    image_versions2: SavedFeedResponseImage_versions2 = null,
    ...
    product_tags: SavedFeedResponseProduct_tags = null,
    ...
    if (!js.isUndefined(is_external_share_disabled)) __obj.updateDynamic("is_external_share_disabled")(is_external_share_disabled)
    ...
    if (product_tags != null) __obj.updateDynamic("product_tags")(product_tags)
