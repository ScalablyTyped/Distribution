...
trait StoryQuestionResponsesFeedResponseResponder_info extends js.Object {
...
object StoryQuestionResponsesFeedResponseResponder_info {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[StoryQuestionResponsesFeedResponseResponder_info]
  }
}
