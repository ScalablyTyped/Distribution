...
trait HighlightsRepositoryHighlightsTrayResponseCaption extends js.Object {
...
object HighlightsRepositoryHighlightsTrayResponseCaption {
  @scala.inline
  def apply(
    bit_flags: Double,
    content_type: String,
    ...
    __obj.asInstanceOf[HighlightsRepositoryHighlightsTrayResponseCaption]
  }
}
