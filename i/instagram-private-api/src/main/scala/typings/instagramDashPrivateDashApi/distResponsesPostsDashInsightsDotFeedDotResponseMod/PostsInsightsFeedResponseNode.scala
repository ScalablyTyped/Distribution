...
object PostsInsightsFeedResponseNode {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(__typename = __typename)
    ...
    if (inline_insights_node != null) __obj.updateDynamic("inline_insights_node")(inline_insights_node)
    if (instagram_media_id != null) __obj.updateDynamic("instagram_media_id")(instagram_media_id)
    if (instagram_media_type != null) __obj.updateDynamic("instagram_media_type")(instagram_media_type)
    ...
    if (video_view_count != null) __obj.updateDynamic("video_view_count")(video_view_count)
