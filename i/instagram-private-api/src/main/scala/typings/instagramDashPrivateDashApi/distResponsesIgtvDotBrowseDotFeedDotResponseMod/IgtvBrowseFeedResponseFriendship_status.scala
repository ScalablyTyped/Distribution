...
trait IgtvBrowseFeedResponseFriendship_status extends js.Object {
...
object IgtvBrowseFeedResponseFriendship_status {
  @scala.inline
  def apply(
    following: Boolean,
    is_bestie: Boolean,
  ...
  ): IgtvBrowseFeedResponseFriendship_status = {
    ...
    __obj.asInstanceOf[IgtvBrowseFeedResponseFriendship_status]
  }
}
