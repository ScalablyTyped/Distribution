...
trait IgtvChannelFeedResponsePreviewCommentsItem extends js.Object {
...
object IgtvChannelFeedResponsePreviewCommentsItem {
  @scala.inline
  def apply(
    bit_flags: Double,
    content_type: String,
    ...
    __obj.asInstanceOf[IgtvChannelFeedResponsePreviewCommentsItem]
  }
}
