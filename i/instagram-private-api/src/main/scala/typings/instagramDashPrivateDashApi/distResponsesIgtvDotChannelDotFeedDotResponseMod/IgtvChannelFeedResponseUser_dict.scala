...
trait IgtvChannelFeedResponseUser_dict extends js.Object {
  var biography: String
  var biography_with_entities: IgtvChannelFeedResponseBiography_with_entities
  var external_lynx_url: String
  var external_url: String
  var follower_count: Double
  var following_count: Double
  var following_tag_count: Double
  var friendship_status: IgtvChannelFeedResponseFriendship_status
...
object IgtvChannelFeedResponseUser_dict {
  @scala.inline
  def apply(
    biography: String,
    ...
    username: String
  ): IgtvChannelFeedResponseUser_dict = {
    ...
    __obj.asInstanceOf[IgtvChannelFeedResponseUser_dict]
  }
}
