...
object TagFeedResponseItemsItem {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(can_viewer_save = can_viewer_save, caption_is_edited = caption_is_edited, client_cache_key = client_cache_key, code = code, device_timestamp = device_timestamp.asInstanceOf[js.Any], filter_type = filter_type, id = id, media_type = media_type, organic_tracking_token = organic_tracking_token, photo_of_you = photo_of_you, pk = pk, taken_at = taken_at, user = user)
    if (attribution != null) __obj.updateDynamic("attribution")(attribution)
    if (!js.isUndefined(can_reply)) __obj.updateDynamic("can_reply")(can_reply)
    if (!js.isUndefined(can_reshare)) __obj.updateDynamic("can_reshare")(can_reshare)
    ...
    if (!js.isUndefined(has_liked)) __obj.updateDynamic("has_liked")(has_liked)
    ...
    if (!js.isUndefined(is_reel_media)) __obj.updateDynamic("is_reel_media")(is_reel_media)
    ...
    if (likers != null) __obj.updateDynamic("likers")(likers)
    ...
    if (!js.isUndefined(show_one_tap_fb_share_tooltip)) __obj.updateDynamic("show_one_tap_fb_share_tooltip")(show_one_tap_fb_share_tooltip)
    ...
    if (!js.isUndefined(supports_reel_reactions)) __obj.updateDynamic("supports_reel_reactions")(supports_reel_reactions)
