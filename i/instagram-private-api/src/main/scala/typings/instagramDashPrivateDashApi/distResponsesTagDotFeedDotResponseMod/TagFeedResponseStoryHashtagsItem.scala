...
object TagFeedResponseStoryHashtagsItem {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(hashtag = hashtag, height = height.asInstanceOf[js.Any], is_hidden = is_hidden, is_pinned = is_pinned, rotation = rotation.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any], x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any], z = z)
