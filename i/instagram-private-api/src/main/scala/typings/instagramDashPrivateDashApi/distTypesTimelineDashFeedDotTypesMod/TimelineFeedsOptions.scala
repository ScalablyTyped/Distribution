...
object TimelineFeedsOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(pushDisabled)) __obj.updateDynamic("pushDisabled")(pushDisabled)
    if (reason != null) __obj.updateDynamic("reason")(reason)
    if (recoveredFromCrash != null) __obj.updateDynamic("recoveredFromCrash")(recoveredFromCrash)
