...
trait StorySliderVotersFeedResponseResponseFriendship_status extends js.Object {
...
object StorySliderVotersFeedResponseResponseFriendship_status {
  @scala.inline
  def apply(
    following: Boolean,
  ...
  ): StorySliderVotersFeedResponseResponseFriendship_status = {
    ...
    __obj.asInstanceOf[StorySliderVotersFeedResponseResponseFriendship_status]
  }
}
