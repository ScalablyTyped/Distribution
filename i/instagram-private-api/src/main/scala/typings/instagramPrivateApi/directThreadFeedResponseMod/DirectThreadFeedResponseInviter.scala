...
@js.native
trait DirectThreadFeedResponseInviter extends js.Object {
...
object DirectThreadFeedResponseInviter {
  ...
  @scala.inline
  implicit class DirectThreadFeedResponseInviterOps[Self <: DirectThreadFeedResponseInviter] (val x: Self) extends AnyVal {
