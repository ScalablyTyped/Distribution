...
trait DiffSliderStickerInstaSticker extends js.Object {
...
object DiffSliderStickerInstaSticker {
  @scala.inline
  def apply(
    emoji: String,
    question: String,
    ...
    __obj.asInstanceOf[DiffSliderStickerInstaSticker]
  }
}
