...
object ListReelMediaViewerFeedResponseStoryHashtagsItem {
  ...
  extension [Self <: ListReelMediaViewerFeedResponseStoryHashtagsItem](x: Self) {
    
    inline def setHashtag(value: ListReelMediaViewerFeedResponseHashtag): Self = StObject.set(x, "hashtag", value.asInstanceOf[js.Any])
