...
object ListReelMediaViewerFeedResponseStoryLocationsItem {
  ...
  @scala.inline
  implicit class ListReelMediaViewerFeedResponseStoryLocationsItemOps[Self <: ListReelMediaViewerFeedResponseStoryLocationsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocation(value: ListReelMediaViewerFeedResponseLocation): Self = this.set("location", value.asInstanceOf[js.Any])
