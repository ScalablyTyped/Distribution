...
trait TagFeedResponseVideoVersionsItem extends StObject {
...
object TagFeedResponseVideoVersionsItem {
  ...
  inline def apply(height: Double, id: String, `type`: Double, url: String, width: Double): TagFeedResponseVideoVersionsItem = {
  ...
  extension [Self <: TagFeedResponseVideoVersionsItem](x: Self) {
