...
@js.native
trait TagFeedResponseCaption extends StObject {
...
object TagFeedResponseCaption {
  ...
  def apply(
    ...
    __obj.asInstanceOf[TagFeedResponseCaption]
  }
  
  @scala.inline
  implicit class TagFeedResponseCaptionMutableBuilder[Self <: TagFeedResponseCaption] (val x: Self) extends AnyVal {
