...
trait TagFeedResponseUser extends StObject {
...
object TagFeedResponseUser {
  ...
  inline def apply(full_name: String, is_private: Boolean, pk: Double, profile_pic_url: String, username: String): TagFeedResponseUser = {
  ...
  extension [Self <: TagFeedResponseUser](x: Self) {
    
    inline def setFriendship_status(value: TagFeedResponseFriendshipStatus): Self = StObject.set(x, "friendship_status", value.asInstanceOf[js.Any])
