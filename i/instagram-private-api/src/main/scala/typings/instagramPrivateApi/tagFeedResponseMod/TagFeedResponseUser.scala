...
object TagFeedResponseUser {
  ...
  @scala.inline
  implicit class TagFeedResponseUserMutableBuilder[Self <: TagFeedResponseUser] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFriendship_status(value: TagFeedResponseFriendshipStatus): Self = StObject.set(x, "friendship_status", value.asInstanceOf[js.Any])
