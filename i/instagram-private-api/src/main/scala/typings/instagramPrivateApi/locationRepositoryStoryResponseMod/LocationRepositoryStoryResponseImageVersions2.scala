...
object LocationRepositoryStoryResponseImageVersions2 {
  ...
  implicit class LocationRepositoryStoryResponseImageVersions2Ops[Self <: LocationRepositoryStoryResponseImageVersions2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCandidatesVarargs(value: LocationRepositoryStoryResponseCandidatesItem*): Self = this.set("candidates", js.Array(value :_*))
    
    @scala.inline
    def setCandidates(value: js.Array[LocationRepositoryStoryResponseCandidatesItem]): Self = this.set("candidates", value.asInstanceOf[js.Any])
  }
}
