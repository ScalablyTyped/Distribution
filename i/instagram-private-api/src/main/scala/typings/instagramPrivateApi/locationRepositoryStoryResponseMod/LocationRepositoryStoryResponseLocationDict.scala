...
trait LocationRepositoryStoryResponseLocationDict extends StObject {
...
object LocationRepositoryStoryResponseLocationDict {
  ...
  @scala.inline
  implicit class LocationRepositoryStoryResponseLocationDictMutableBuilder[Self <: LocationRepositoryStoryResponseLocationDict] (val x: Self) extends AnyVal {
