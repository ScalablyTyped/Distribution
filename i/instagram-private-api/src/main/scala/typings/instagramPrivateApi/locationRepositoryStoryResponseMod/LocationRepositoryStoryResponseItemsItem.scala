...
object LocationRepositoryStoryResponseItemsItem {
  ...
  @scala.inline
  implicit class LocationRepositoryStoryResponseItemsItemOps[Self <: LocationRepositoryStoryResponseItemsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImage_versions2(value: LocationRepositoryStoryResponseImageVersions2): Self = this.set("image_versions2", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStory_locationsVarargs(value: LocationRepositoryStoryResponseStoryLocationsItem*): Self = this.set("story_locations", js.Array(value :_*))
    
    @scala.inline
    def setStory_locations(value: js.Array[LocationRepositoryStoryResponseStoryLocationsItem]): Self = this.set("story_locations", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setReel_mentionsVarargs(value: LocationRepositoryStoryResponseReelMentionsItem*): Self = this.set("reel_mentions", js.Array(value :_*))
    
    @scala.inline
    def setReel_mentions(value: js.Array[LocationRepositoryStoryResponseReelMentionsItem]): Self = this.set("reel_mentions", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteReel_mentions: Self = this.set("reel_mentions", js.undefined)
    
    @scala.inline
    def setStory_hashtagsVarargs(value: LocationRepositoryStoryResponseStoryHashtagsItem*): Self = this.set("story_hashtags", js.Array(value :_*))
    
    @scala.inline
    def setStory_hashtags(value: js.Array[LocationRepositoryStoryResponseStoryHashtagsItem]): Self = this.set("story_hashtags", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVideo_versionsVarargs(value: LocationRepositoryStoryResponseVideoVersionsItem*): Self = this.set("video_versions", js.Array(value :_*))
    
    @scala.inline
    def setVideo_versions(value: js.Array[LocationRepositoryStoryResponseVideoVersionsItem]): Self = this.set("video_versions", value.asInstanceOf[js.Any])
