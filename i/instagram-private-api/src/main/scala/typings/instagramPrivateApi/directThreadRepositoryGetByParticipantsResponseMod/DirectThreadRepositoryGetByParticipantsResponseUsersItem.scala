...
object DirectThreadRepositoryGetByParticipantsResponseUsersItem {
  ...
  @scala.inline
  implicit class DirectThreadRepositoryGetByParticipantsResponseUsersItemOps[Self <: DirectThreadRepositoryGetByParticipantsResponseUsersItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: DirectThreadRepositoryGetByParticipantsResponseFriendshipStatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
