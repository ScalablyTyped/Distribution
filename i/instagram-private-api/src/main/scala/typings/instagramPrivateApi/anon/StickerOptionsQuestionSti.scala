...
object StickerOptionsQuestionSti {
  ...
  extension [Self <: StickerOptionsQuestionSti](x: Self) {
    ...
    inline def setBottom(value: () => StickerOptionsQuestionSti): Self = StObject.set(x, "bottom", js.Any.fromFunction0(value))
    
    inline def setBottomUndefined: Self = StObject.set(x, "bottom", js.undefined)
    
    inline def setCenter(value: () => StickerOptionsQuestionSti): Self = StObject.set(x, "center", js.Any.fromFunction0(value))
    ...
    inline def setLeft(value: () => StickerOptionsQuestionSti): Self = StObject.set(x, "left", js.Any.fromFunction0(value))
    
    inline def setLeftUndefined: Self = StObject.set(x, "left", js.undefined)
    
    inline def setMoveBackwards(value: /* layers */ js.UndefOr[Double] => StickerOptionsQuestionSti): Self = StObject.set(x, "moveBackwards", js.Any.fromFunction1(value))
    
    inline def setMoveBackwardsUndefined: Self = StObject.set(x, "moveBackwards", js.undefined)
    
    inline def setMoveForward(value: /* layers */ js.UndefOr[Double] => StickerOptionsQuestionSti): Self = StObject.set(x, "moveForward", js.Any.fromFunction1(value))
    
    inline def setMoveForwardUndefined: Self = StObject.set(x, "moveForward", js.undefined)
    
    inline def setProfilePicUrl(value: String): Self = StObject.set(x, "profilePicUrl", value.asInstanceOf[js.Any])
    
    inline def setProfilePicUrlUndefined: Self = StObject.set(x, "profilePicUrl", js.undefined)
    
    inline def setQuestion(value: String): Self = StObject.set(x, "question", value.asInstanceOf[js.Any])
    
    inline def setQuestionType(value: text_ | music): Self = StObject.set(x, "questionType", value.asInstanceOf[js.Any])
    
    inline def setQuestionTypeUndefined: Self = StObject.set(x, "questionType", js.undefined)
    
    inline def setRight(value: () => StickerOptionsQuestionSti): Self = StObject.set(x, "right", js.Any.fromFunction0(value))
    
    inline def setRightUndefined: Self = StObject.set(x, "right", js.undefined)
    
    inline def setRotateDeg(value: /* deg */ Double => StickerOptionsQuestionSti): Self = StObject.set(x, "rotateDeg", js.Any.fromFunction1(value))
    ...
    inline def setScale(value: /* factor */ Double => StickerOptionsQuestionSti): Self = StObject.set(x, "scale", js.Any.fromFunction1(value))
    ...
    inline def setTop(value: () => StickerOptionsQuestionSti): Self = StObject.set(x, "top", js.Any.fromFunction0(value))
    
    inline def setTopUndefined: Self = StObject.set(x, "top", js.undefined)
    
    inline def setViewerCanInteract(value: Boolean): Self = StObject.set(x, "viewerCanInteract", value.asInstanceOf[js.Any])
    
    inline def setViewerCanInteractUndefined: Self = StObject.set(x, "viewerCanInteract", js.undefined)
