...
object StickerOptionsHashtagStic {
  ...
  inline def apply(tagName: String): StickerOptionsHashtagStic = {
    val __obj = js.Dynamic.literal(tagName = tagName.asInstanceOf[js.Any])
    __obj.asInstanceOf[StickerOptionsHashtagStic]
  }
  
  extension [Self <: StickerOptionsHashtagStic](x: Self) {
    ...
    inline def setBottom(value: () => StickerOptionsHashtagStic): Self = StObject.set(x, "bottom", js.Any.fromFunction0(value))
    
    inline def setBottomUndefined: Self = StObject.set(x, "bottom", js.undefined)
    
    inline def setCenter(value: () => StickerOptionsHashtagStic): Self = StObject.set(x, "center", js.Any.fromFunction0(value))
    ...
    inline def setLeft(value: () => StickerOptionsHashtagStic): Self = StObject.set(x, "left", js.Any.fromFunction0(value))
    
    inline def setLeftUndefined: Self = StObject.set(x, "left", js.undefined)
    
    inline def setMoveBackwards(value: /* layers */ js.UndefOr[Double] => StickerOptionsHashtagStic): Self = StObject.set(x, "moveBackwards", js.Any.fromFunction1(value))
    
    inline def setMoveBackwardsUndefined: Self = StObject.set(x, "moveBackwards", js.undefined)
    
    inline def setMoveForward(value: /* layers */ js.UndefOr[Double] => StickerOptionsHashtagStic): Self = StObject.set(x, "moveForward", js.Any.fromFunction1(value))
    
    inline def setMoveForwardUndefined: Self = StObject.set(x, "moveForward", js.undefined)
    
    inline def setRight(value: () => StickerOptionsHashtagStic): Self = StObject.set(x, "right", js.Any.fromFunction0(value))
    
    inline def setRightUndefined: Self = StObject.set(x, "right", js.undefined)
    
    inline def setRotateDeg(value: /* deg */ Double => StickerOptionsHashtagStic): Self = StObject.set(x, "rotateDeg", js.Any.fromFunction1(value))
    ...
    inline def setScale(value: /* factor */ Double => StickerOptionsHashtagStic): Self = StObject.set(x, "scale", js.Any.fromFunction1(value))
    ...
    inline def setTop(value: () => StickerOptionsHashtagStic): Self = StObject.set(x, "top", js.Any.fromFunction0(value))
