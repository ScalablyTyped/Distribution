...
object Androidrelease {
  ...
  inline def apply(android_release: String, android_version: String, manufacturer: String, model: String): Androidrelease = {
  ...
  extension [Self <: Androidrelease](x: Self) {
    
    inline def setAndroid_release(value: String): Self = StObject.set(x, "android_release", value.asInstanceOf[js.Any])
    
    inline def setAndroid_version(value: String): Self = StObject.set(x, "android_version", value.asInstanceOf[js.Any])
