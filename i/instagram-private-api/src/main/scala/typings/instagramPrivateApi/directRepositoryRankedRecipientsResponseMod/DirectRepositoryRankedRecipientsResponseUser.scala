...
@js.native
trait DirectRepositoryRankedRecipientsResponseUser extends js.Object {
...
object DirectRepositoryRankedRecipientsResponseUser {
  ...
  @scala.inline
  implicit class DirectRepositoryRankedRecipientsResponseUserOps[Self <: DirectRepositoryRankedRecipientsResponseUser] (val x: Self) extends AnyVal {
