...
object PendingFriendshipsFeedResponse {
  ...
  implicit class PendingFriendshipsFeedResponseOps[Self <: PendingFriendshipsFeedResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUsersVarargs(value: PendingFriendshipsFeedResponseUsersItem*): Self = this.set("users", js.Array(value :_*))
    
    @scala.inline
    def setUsers(value: js.Array[PendingFriendshipsFeedResponseUsersItem]): Self = this.set("users", value.asInstanceOf[js.Any])
  }
}
