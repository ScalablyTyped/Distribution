...
object SavedFeedResponseVideoVersionsItem {
  ...
  inline def apply(height: Double, id: String, `type`: Double, url: String, width: Double): SavedFeedResponseVideoVersionsItem = {
  ...
  extension [Self <: SavedFeedResponseVideoVersionsItem](x: Self) {
