...
trait SavedFeedResponseCaption extends StObject {
...
object SavedFeedResponseCaption {
  ...
  @scala.inline
  implicit class SavedFeedResponseCaptionMutableBuilder[Self <: SavedFeedResponseCaption] (val x: Self) extends AnyVal {
