...
object MediaInfoResponseUser {
  ...
  @scala.inline
  implicit class MediaInfoResponseUserOps[Self <: MediaInfoResponseUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: MediaInfoResponseFriendshipStatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
