...
object MediaConfigureStoryPhotoOptions {
  ...
  inline def apply(configure_mode: `1` | `2`, upload_id: String): MediaConfigureStoryPhotoOptions = {
  ...
  extension [Self <: MediaConfigureStoryPhotoOptions](x: Self) {
