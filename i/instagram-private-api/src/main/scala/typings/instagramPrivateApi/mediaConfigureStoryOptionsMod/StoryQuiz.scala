...
object StoryQuiz {
  ...
  extension [Self <: StoryQuiz](x: Self) {
    
    inline def setCorrect_answer(value: String): Self = StObject.set(x, "correct_answer", value.asInstanceOf[js.Any])
    
    inline def setEnd_background_color(value: String): Self = StObject.set(x, "end_background_color", value.asInstanceOf[js.Any])
    
    inline def setOptions(value: js.Array[Count]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    
    inline def setOptionsVarargs(value: Count*): Self = StObject.set(x, "options", js.Array(value :_*))
    ...
    inline def setViewer_answer(value: Double): Self = StObject.set(x, "viewer_answer", value.asInstanceOf[js.Any])
