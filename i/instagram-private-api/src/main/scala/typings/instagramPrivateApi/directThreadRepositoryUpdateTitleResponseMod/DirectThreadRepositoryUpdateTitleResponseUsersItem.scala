...
object DirectThreadRepositoryUpdateTitleResponseUsersItem {
  ...
  @scala.inline
  implicit class DirectThreadRepositoryUpdateTitleResponseUsersItemOps[Self <: DirectThreadRepositoryUpdateTitleResponseUsersItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: DirectThreadRepositoryUpdateTitleResponseFriendshipStatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
