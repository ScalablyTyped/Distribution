...
object mediaRepositoryCheckOffensiveCommentResponseMod {
  ...
  object MediaRepositoryCheckOffensiveCommentResponseRootObject {
    ...
    extension [Self <: MediaRepositoryCheckOffensiveCommentResponseRootObject](x: Self) {
      
      inline def setBully_classifier(value: String): Self = StObject.set(x, "bully_classifier", value.asInstanceOf[js.Any])
      
      inline def setHate_classifier(value: String): Self = StObject.set(x, "hate_classifier", value.asInstanceOf[js.Any])
      
      inline def setIs_offensive(value: Boolean): Self = StObject.set(x, "is_offensive", value.asInstanceOf[js.Any])
      
      inline def setSexual_classifier(value: String): Self = StObject.set(x, "sexual_classifier", value.asInstanceOf[js.Any])
      
      inline def setSpam_classifier(value: String): Self = StObject.set(x, "spam_classifier", value.asInstanceOf[js.Any])
