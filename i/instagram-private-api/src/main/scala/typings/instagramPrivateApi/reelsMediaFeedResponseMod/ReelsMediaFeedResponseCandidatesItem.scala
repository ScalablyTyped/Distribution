...
@js.native
trait ReelsMediaFeedResponseCandidatesItem extends js.Object {
...
object ReelsMediaFeedResponseCandidatesItem {
  ...
  @scala.inline
  implicit class ReelsMediaFeedResponseCandidatesItemOps[Self <: ReelsMediaFeedResponseCandidatesItem] (val x: Self) extends AnyVal {
