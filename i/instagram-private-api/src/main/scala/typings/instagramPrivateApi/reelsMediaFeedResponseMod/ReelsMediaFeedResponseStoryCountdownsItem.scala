...
object ReelsMediaFeedResponseStoryCountdownsItem {
  ...
  extension [Self <: ReelsMediaFeedResponseStoryCountdownsItem](x: Self) {
    
    inline def setCountdown_sticker(value: ReelsMediaFeedResponseCountdownSticker): Self = StObject.set(x, "countdown_sticker", value.asInstanceOf[js.Any])
