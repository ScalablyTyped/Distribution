...
object ReelsMediaFeedResponseQuizSticker {
  ...
  extension [Self <: ReelsMediaFeedResponseQuizSticker](x: Self) {
    ...
    inline def setQuiz_id(value: Double): Self = StObject.set(x, "quiz_id", value.asInstanceOf[js.Any])
    ...
    inline def setViewer_answerUndefined: Self = StObject.set(x, "viewer_answer", js.undefined)
