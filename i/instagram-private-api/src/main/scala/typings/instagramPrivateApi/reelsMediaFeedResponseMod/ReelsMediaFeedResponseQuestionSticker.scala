...
object ReelsMediaFeedResponseQuestionSticker {
  ...
  @scala.inline
  implicit class ReelsMediaFeedResponseQuestionStickerOps[Self <: ReelsMediaFeedResponseQuestionSticker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMedia_id(value: Double): Self = this.set("media_id", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setQuestion_id(value: Double): Self = this.set("question_id", value.asInstanceOf[js.Any])
