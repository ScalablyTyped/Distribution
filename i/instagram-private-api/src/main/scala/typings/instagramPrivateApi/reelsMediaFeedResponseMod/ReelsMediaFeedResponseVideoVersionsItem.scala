...
object ReelsMediaFeedResponseVideoVersionsItem {
  ...
  inline def apply(height: Double, id: String, `type`: Double, url: String, width: Double): ReelsMediaFeedResponseVideoVersionsItem = {
  ...
  extension [Self <: ReelsMediaFeedResponseVideoVersionsItem](x: Self) {
