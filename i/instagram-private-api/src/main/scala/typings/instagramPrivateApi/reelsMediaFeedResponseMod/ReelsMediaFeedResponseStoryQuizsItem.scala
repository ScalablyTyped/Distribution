...
object ReelsMediaFeedResponseStoryQuizsItem {
  ...
  @scala.inline
  implicit class ReelsMediaFeedResponseStoryQuizsItemOps[Self <: ReelsMediaFeedResponseStoryQuizsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setQuiz_sticker(value: ReelsMediaFeedResponseQuizSticker): Self = this.set("quiz_sticker", value.asInstanceOf[js.Any])
