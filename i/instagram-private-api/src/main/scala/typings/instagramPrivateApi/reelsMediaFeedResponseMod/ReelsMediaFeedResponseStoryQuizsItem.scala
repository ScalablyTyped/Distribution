...
object ReelsMediaFeedResponseStoryQuizsItem {
  ...
  extension [Self <: ReelsMediaFeedResponseStoryQuizsItem](x: Self) {
    ...
    inline def setQuiz_sticker(value: ReelsMediaFeedResponseQuizSticker): Self = StObject.set(x, "quiz_sticker", value.asInstanceOf[js.Any])
