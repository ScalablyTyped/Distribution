...
object ReelsMediaFeedResponseStorySlidersItem {
  ...
  extension [Self <: ReelsMediaFeedResponseStorySlidersItem](x: Self) {
    ...
    inline def setSlider_sticker(value: ReelsMediaFeedResponseSliderSticker): Self = StObject.set(x, "slider_sticker", value.asInstanceOf[js.Any])
