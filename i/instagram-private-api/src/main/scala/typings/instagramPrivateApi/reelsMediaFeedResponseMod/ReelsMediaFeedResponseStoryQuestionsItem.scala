...
object ReelsMediaFeedResponseStoryQuestionsItem {
  ...
  extension [Self <: ReelsMediaFeedResponseStoryQuestionsItem](x: Self) {
    ...
    inline def setQuestion_sticker(value: ReelsMediaFeedResponseQuestionSticker): Self = StObject.set(x, "question_sticker", value.asInstanceOf[js.Any])
