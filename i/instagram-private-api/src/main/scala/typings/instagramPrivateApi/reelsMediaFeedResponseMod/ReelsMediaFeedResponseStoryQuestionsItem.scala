...
@js.native
trait ReelsMediaFeedResponseStoryQuestionsItem extends StObject {
  ...
  var question_sticker: ReelsMediaFeedResponseQuestionSticker = js.native
...
object ReelsMediaFeedResponseStoryQuestionsItem {
  ...
  @scala.inline
  implicit class ReelsMediaFeedResponseStoryQuestionsItemMutableBuilder[Self <: ReelsMediaFeedResponseStoryQuestionsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setQuestion_sticker(value: ReelsMediaFeedResponseQuestionSticker): Self = StObject.set(x, "question_sticker", value.asInstanceOf[js.Any])
