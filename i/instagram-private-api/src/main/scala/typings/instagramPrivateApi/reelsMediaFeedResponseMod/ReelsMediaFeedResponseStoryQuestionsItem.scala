...
object ReelsMediaFeedResponseStoryQuestionsItem {
  ...
  @scala.inline
  implicit class ReelsMediaFeedResponseStoryQuestionsItemOps[Self <: ReelsMediaFeedResponseStoryQuestionsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setQuestion_sticker(value: ReelsMediaFeedResponseQuestionSticker): Self = this.set("question_sticker", value.asInstanceOf[js.Any])
