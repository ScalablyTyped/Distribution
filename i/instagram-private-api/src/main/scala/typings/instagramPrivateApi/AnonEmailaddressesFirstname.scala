...
trait AnonEmailaddressesFirstname extends js.Object {
...
object AnonEmailaddressesFirstname {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonEmailaddressesFirstname]
  }
}
