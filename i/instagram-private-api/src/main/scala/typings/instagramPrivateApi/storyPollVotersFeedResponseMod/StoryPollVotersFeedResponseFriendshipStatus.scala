...
@js.native
trait StoryPollVotersFeedResponseFriendshipStatus extends js.Object {
...
object StoryPollVotersFeedResponseFriendshipStatus {
  ...
  @scala.inline
  implicit class StoryPollVotersFeedResponseFriendshipStatusOps[Self <: StoryPollVotersFeedResponseFriendshipStatus] (val x: Self) extends AnyVal {
