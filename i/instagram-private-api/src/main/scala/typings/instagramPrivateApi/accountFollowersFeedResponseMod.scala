...
object accountFollowersFeedResponseMod {
  ...
  object AccountFollowersFeedResponse {
    ...
    extension [Self <: AccountFollowersFeedResponse](x: Self) {
      ...
      inline def setUsers(value: js.Array[AccountFollowersFeedResponseUsersItem]): Self = StObject.set(x, "users", value.asInstanceOf[js.Any])
      
      inline def setUsersVarargs(value: AccountFollowersFeedResponseUsersItem*): Self = StObject.set(x, "users", js.Array(value :_*))
    }
  }
}
