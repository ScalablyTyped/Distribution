...
object LiveCommentsResponseUser {
  ...
  implicit class LiveCommentsResponseUserOps[Self <: LiveCommentsResponseUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLive_with_eligibility(value: String): Self = this.set("live_with_eligibility", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLive_with_eligibility: Self = this.set("live_with_eligibility", js.undefined)
  }
}
