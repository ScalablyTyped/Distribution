...
object MediaRepositoryConfigureVideoResponseCandidatesItem {
  ...
  @scala.inline
  implicit class MediaRepositoryConfigureVideoResponseCandidatesItemOps[Self <: MediaRepositoryConfigureVideoResponseCandidatesItem] (val x: Self) extends AnyVal {
