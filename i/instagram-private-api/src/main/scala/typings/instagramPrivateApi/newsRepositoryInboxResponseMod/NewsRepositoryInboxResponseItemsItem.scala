...
object NewsRepositoryInboxResponseItemsItem {
  ...
  extension [Self <: NewsRepositoryInboxResponseItemsItem](x: Self) {
    ...
    inline def setUser(value: NewsRepositoryInboxResponseUser): Self = StObject.set(x, "user", value.asInstanceOf[js.Any])
