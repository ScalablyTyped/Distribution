...
object MediaInlineChildCommentsFeedResponseChildCommentsItem {
  ...
  @scala.inline
  implicit class MediaInlineChildCommentsFeedResponseChildCommentsItemOps[Self <: MediaInlineChildCommentsFeedResponseChildCommentsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUser(value: MediaInlineChildCommentsFeedResponseUser): Self = this.set("user", value.asInstanceOf[js.Any])
