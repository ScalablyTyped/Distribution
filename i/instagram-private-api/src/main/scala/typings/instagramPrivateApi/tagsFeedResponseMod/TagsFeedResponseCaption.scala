...
trait TagsFeedResponseCaption extends StObject {
...
object TagsFeedResponseCaption {
  ...
  @scala.inline
  implicit class TagsFeedResponseCaptionMutableBuilder[Self <: TagsFeedResponseCaption] (val x: Self) extends AnyVal {
