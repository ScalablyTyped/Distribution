...
@js.native
trait TagsFeedResponsePreviewCommentsItem extends StObject {
...
object TagsFeedResponsePreviewCommentsItem {
  ...
  @scala.inline
  implicit class TagsFeedResponsePreviewCommentsItemMutableBuilder[Self <: TagsFeedResponsePreviewCommentsItem] (val x: Self) extends AnyVal {
