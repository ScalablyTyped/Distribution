...
object TagsFeedResponseMedia {
  ...
  implicit class TagsFeedResponseMediaOps[Self <: TagsFeedResponseMedia] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTags(value: TagsFeedResponseTags): Self = this.set("Tags", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPreview_commentsVarargs(value: TagsFeedResponsePreviewCommentsItem*): Self = this.set("preview_comments", js.Array(value :_*))
    
    @scala.inline
    def setPreview_comments(value: js.Array[TagsFeedResponsePreviewCommentsItem]): Self = this.set("preview_comments", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setCaption(value: TagsFeedResponseCaption): Self = this.set("caption", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCaptionNull: Self = this.set("caption", null)
    
    @scala.inline
    def setCarousel_mediaVarargs(value: TagsFeedResponseCarouselMediaItem*): Self = this.set("carousel_media", js.Array(value :_*))
    
    @scala.inline
    def setCarousel_media(value: js.Array[TagsFeedResponseCarouselMediaItem]): Self = this.set("carousel_media", value.asInstanceOf[js.Any])
