...
object TagsFeedResponseExploreItemInfo {
  ...
  inline def apply(aspect_ratio: Double, autoplay: Boolean, num_columns: Double, total_num_columns: Double): TagsFeedResponseExploreItemInfo = {
  ...
  extension [Self <: TagsFeedResponseExploreItemInfo](x: Self) {
