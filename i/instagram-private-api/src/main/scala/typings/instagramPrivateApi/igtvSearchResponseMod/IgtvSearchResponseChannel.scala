...
@js.native
trait IgtvSearchResponseChannel extends js.Object {
...
object IgtvSearchResponseChannel {
  ...
  @scala.inline
  implicit class IgtvSearchResponseChannelOps[Self <: IgtvSearchResponseChannel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSeen_state(value: IgtvSearchResponseSeenState): Self = this.set("seen_state", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUser_dict(value: IgtvSearchResponseUserDict): Self = this.set("user_dict", value.asInstanceOf[js.Any])
  }
}
