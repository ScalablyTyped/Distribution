...
object HighlightsRepositoryEditReelResponseQuizSticker {
  ...
  implicit class HighlightsRepositoryEditReelResponseQuizStickerOps[Self <: HighlightsRepositoryEditReelResponseQuizSticker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTalliesVarargs(value: HighlightsRepositoryEditReelResponseTalliesItem*): Self = this.set("tallies", js.Array(value :_*))
    
    @scala.inline
    def setTallies(value: js.Array[HighlightsRepositoryEditReelResponseTalliesItem]): Self = this.set("tallies", value.asInstanceOf[js.Any])
