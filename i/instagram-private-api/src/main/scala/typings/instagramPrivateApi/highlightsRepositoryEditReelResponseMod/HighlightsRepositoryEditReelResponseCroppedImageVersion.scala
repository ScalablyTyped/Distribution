...
object HighlightsRepositoryEditReelResponseCroppedImageVersion {
  ...
  @scala.inline
  implicit class HighlightsRepositoryEditReelResponseCroppedImageVersionOps[Self <: HighlightsRepositoryEditReelResponseCroppedImageVersion] (val x: Self) extends AnyVal {
