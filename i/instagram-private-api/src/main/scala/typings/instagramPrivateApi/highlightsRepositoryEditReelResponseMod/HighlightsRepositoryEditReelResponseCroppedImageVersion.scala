...
object HighlightsRepositoryEditReelResponseCroppedImageVersion {
  ...
  @scala.inline
  implicit class HighlightsRepositoryEditReelResponseCroppedImageVersionMutableBuilder[Self <: HighlightsRepositoryEditReelResponseCroppedImageVersion] (val x: Self) extends AnyVal {
