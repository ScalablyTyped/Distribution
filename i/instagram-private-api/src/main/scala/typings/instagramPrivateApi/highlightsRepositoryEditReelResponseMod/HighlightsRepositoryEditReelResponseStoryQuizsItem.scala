...
object HighlightsRepositoryEditReelResponseStoryQuizsItem {
  ...
  @scala.inline
  implicit class HighlightsRepositoryEditReelResponseStoryQuizsItemOps[Self <: HighlightsRepositoryEditReelResponseStoryQuizsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setQuiz_sticker(value: HighlightsRepositoryEditReelResponseQuizSticker): Self = this.set("quiz_sticker", value.asInstanceOf[js.Any])
