...
object HighlightsRepositoryEditReelResponseStoryQuizsItem {
  ...
  extension [Self <: HighlightsRepositoryEditReelResponseStoryQuizsItem](x: Self) {
    ...
    inline def setQuiz_sticker(value: HighlightsRepositoryEditReelResponseQuizSticker): Self = StObject.set(x, "quiz_sticker", value.asInstanceOf[js.Any])
