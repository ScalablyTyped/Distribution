...
object TimelineFeedResponseAndroidLinksItem {
  ...
  extension [Self <: TimelineFeedResponseAndroidLinksItem](x: Self) {
    ...
    inline def setIgUserId(value: Null): Self = StObject.set(x, "igUserId", value.asInstanceOf[js.Any])
    
    inline def setLeadGenFormId(value: String | Double): Self = StObject.set(x, "leadGenFormId", value.asInstanceOf[js.Any])
