...
object TimelineFeedResponseCarouselMediaItem {
  ...
  extension [Self <: TimelineFeedResponseCarouselMediaItem](x: Self) {
    ...
    inline def setHeadline(value: TimelineFeedResponseHeadline): Self = StObject.set(x, "headline", value.asInstanceOf[js.Any])
