...
trait TimelineFeedResponseVideoVersionsItem extends StObject {
...
object TimelineFeedResponseVideoVersionsItem {
  ...
  inline def apply(height: Double, id: String, `type`: Double, url: String, width: Double): TimelineFeedResponseVideoVersionsItem = {
  ...
  extension [Self <: TimelineFeedResponseVideoVersionsItem](x: Self) {
