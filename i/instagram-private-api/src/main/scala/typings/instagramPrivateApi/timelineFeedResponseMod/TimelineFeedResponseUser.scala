...
object TimelineFeedResponseUser {
  ...
  extension [Self <: TimelineFeedResponseUser](x: Self) {
    
    inline def setFriendship_status(value: TimelineFeedResponseFriendshipStatus): Self = StObject.set(x, "friendship_status", value.asInstanceOf[js.Any])
