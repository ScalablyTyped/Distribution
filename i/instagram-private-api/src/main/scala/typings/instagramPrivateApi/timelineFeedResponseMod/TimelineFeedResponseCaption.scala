...
trait TimelineFeedResponseCaption extends StObject {
...
object TimelineFeedResponseCaption {
  ...
  @scala.inline
  implicit class TimelineFeedResponseCaptionMutableBuilder[Self <: TimelineFeedResponseCaption] (val x: Self) extends AnyVal {
