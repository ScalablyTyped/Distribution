...
object UsertagsFeedResponsePreviewCommentsItem {
  ...
  @scala.inline
  implicit class UsertagsFeedResponsePreviewCommentsItemOps[Self <: UsertagsFeedResponsePreviewCommentsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUser(value: UsertagsFeedResponseUser): Self = this.set("user", value.asInstanceOf[js.Any])
