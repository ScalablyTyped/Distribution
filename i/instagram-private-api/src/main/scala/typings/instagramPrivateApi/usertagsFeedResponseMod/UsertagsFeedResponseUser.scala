...
object UsertagsFeedResponseUser {
  ...
  @scala.inline
  implicit class UsertagsFeedResponseUserOps[Self <: UsertagsFeedResponseUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: UsertagsFeedResponseFriendshipStatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
