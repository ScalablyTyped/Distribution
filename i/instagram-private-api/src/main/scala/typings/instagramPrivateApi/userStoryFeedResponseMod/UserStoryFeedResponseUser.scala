...
object UserStoryFeedResponseUser {
  ...
  @scala.inline
  implicit class UserStoryFeedResponseUserOps[Self <: UserStoryFeedResponseUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: UserStoryFeedResponseFriendshipStatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
