...
object checkpointResponseMod {
  ...
  object CheckpointResponse {
    ...
    inline def apply(challenge: CheckpointResponseChallenge, error_type: String, message: String, status: String): CheckpointResponse = {
    ...
    extension [Self <: CheckpointResponse](x: Self) {
      
      inline def setChallenge(value: CheckpointResponseChallenge): Self = StObject.set(x, "challenge", value.asInstanceOf[js.Any])
  ...
  object CheckpointResponseChallenge {
    ...
    extension [Self <: CheckpointResponseChallenge](x: Self) {
      
      inline def setApi_path(value: String): Self = StObject.set(x, "api_path", value.asInstanceOf[js.Any])
      
      inline def setHide_webview_header(value: Boolean): Self = StObject.set(x, "hide_webview_header", value.asInstanceOf[js.Any])
      ...
      inline def setNative_flow(value: Boolean): Self = StObject.set(x, "native_flow", value.asInstanceOf[js.Any])
