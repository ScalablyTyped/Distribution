...
object RestrictActionRepositoryRestrictResponseUsersItem {
  ...
  @scala.inline
  implicit class RestrictActionRepositoryRestrictResponseUsersItemOps[Self <: RestrictActionRepositoryRestrictResponseUsersItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: RestrictActionRepositoryRestrictResponseFriendshipStatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
