...
object MediaRepositoryConfigureSidecarResponseCandidatesItem {
  ...
  @scala.inline
  implicit class MediaRepositoryConfigureSidecarResponseCandidatesItemOps[Self <: MediaRepositoryConfigureSidecarResponseCandidatesItem] (val x: Self) extends AnyVal {
