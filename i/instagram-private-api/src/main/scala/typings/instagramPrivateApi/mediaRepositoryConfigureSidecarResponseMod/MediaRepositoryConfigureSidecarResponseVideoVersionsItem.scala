...
object MediaRepositoryConfigureSidecarResponseVideoVersionsItem {
  ...
  @scala.inline
  implicit class MediaRepositoryConfigureSidecarResponseVideoVersionsItemOps[Self <: MediaRepositoryConfigureSidecarResponseVideoVersionsItem] (val x: Self) extends AnyVal {
