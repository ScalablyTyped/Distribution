...
object HighlightsRepositoryCreateReelResponseVideoVersionsItem {
  ...
  @scala.inline
  implicit class HighlightsRepositoryCreateReelResponseVideoVersionsItemOps[Self <: HighlightsRepositoryCreateReelResponseVideoVersionsItem] (val x: Self) extends AnyVal {
