...
@js.native
trait HighlightsRepositoryCreateReelResponseCroppedImageVersion extends js.Object {
...
object HighlightsRepositoryCreateReelResponseCroppedImageVersion {
  ...
  @scala.inline
  implicit class HighlightsRepositoryCreateReelResponseCroppedImageVersionOps[Self <: HighlightsRepositoryCreateReelResponseCroppedImageVersion] (val x: Self) extends AnyVal {
