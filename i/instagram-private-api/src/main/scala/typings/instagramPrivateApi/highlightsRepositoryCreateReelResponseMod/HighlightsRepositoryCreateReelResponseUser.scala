...
@js.native
trait HighlightsRepositoryCreateReelResponseUser extends js.Object {
...
object HighlightsRepositoryCreateReelResponseUser {
  ...
  @scala.inline
  implicit class HighlightsRepositoryCreateReelResponseUserOps[Self <: HighlightsRepositoryCreateReelResponseUser] (val x: Self) extends AnyVal {
