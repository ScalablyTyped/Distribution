...
object StoryServiceSeenInputReels {
  ...
  implicit class StoryServiceSeenInputReelsOps[Self <: StoryServiceSeenInputReels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: StoryServiceSeenInputItems*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[StoryServiceSeenInputItems]): Self = this.set("items", value.asInstanceOf[js.Any])
  }
}
