...
object DirectInboxFeedResponseItemsItem {
  ...
  inline def apply(item_id: String, item_type: String, timestamp: String, user_id: Double): DirectInboxFeedResponseItemsItem = {
  ...
  extension [Self <: DirectInboxFeedResponseItemsItem](x: Self) {
