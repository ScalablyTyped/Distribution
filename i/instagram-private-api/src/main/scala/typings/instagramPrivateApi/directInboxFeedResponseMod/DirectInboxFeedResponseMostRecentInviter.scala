...
@js.native
trait DirectInboxFeedResponseMostRecentInviter extends js.Object {
...
object DirectInboxFeedResponseMostRecentInviter {
  ...
  @scala.inline
  implicit class DirectInboxFeedResponseMostRecentInviterOps[Self <: DirectInboxFeedResponseMostRecentInviter] (val x: Self) extends AnyVal {
