...
@js.native
trait DirectInboxFeedResponseMostRecentInviter extends StObject {
...
object DirectInboxFeedResponseMostRecentInviter {
  ...
  def apply(
    ...
    __obj.asInstanceOf[DirectInboxFeedResponseMostRecentInviter]
  }
  
  @scala.inline
  implicit class DirectInboxFeedResponseMostRecentInviterMutableBuilder[Self <: DirectInboxFeedResponseMostRecentInviter] (val x: Self) extends AnyVal {
