...
object InsightsServiceAccountResponseAccountHashtags {
  ...
  inline def apply(count: Double, nodes: js.Array[js.Any]): InsightsServiceAccountResponseAccountHashtags = {
  ...
  extension [Self <: InsightsServiceAccountResponseAccountHashtags](x: Self) {
