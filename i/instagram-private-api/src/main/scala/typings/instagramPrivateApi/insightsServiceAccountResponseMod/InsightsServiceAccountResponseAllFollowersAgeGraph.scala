...
object InsightsServiceAccountResponseAllFollowersAgeGraph {
  ...
  inline def apply(data_points: js.Array[InsightsServiceAccountResponseDataPointsItem]): InsightsServiceAccountResponseAllFollowersAgeGraph = {
  ...
  extension [Self <: InsightsServiceAccountResponseAllFollowersAgeGraph](x: Self) {
