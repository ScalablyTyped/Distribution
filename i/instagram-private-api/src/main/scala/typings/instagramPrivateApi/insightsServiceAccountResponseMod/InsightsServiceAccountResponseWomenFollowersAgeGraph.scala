...
object InsightsServiceAccountResponseWomenFollowersAgeGraph {
  ...
  inline def apply(data_points: js.Array[InsightsServiceAccountResponseDataPointsItem]): InsightsServiceAccountResponseWomenFollowersAgeGraph = {
  ...
  extension [Self <: InsightsServiceAccountResponseWomenFollowersAgeGraph](x: Self) {
