...
object DiscoverRepositoryChainingResponseUsersItem {
  ...
  implicit class DiscoverRepositoryChainingResponseUsersItemOps[Self <: DiscoverRepositoryChainingResponseUsersItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChaining_info(value: DiscoverRepositoryChainingResponseChainingInfo): Self = this.set("chaining_info", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setProfile_chaining_secondary_label(value: String): Self = this.set("profile_chaining_secondary_label", value.asInstanceOf[js.Any])
