...
trait DiffQuestionStickerInstaSticker extends js.Object {
...
object DiffQuestionStickerInstaSticker {
  @scala.inline
  def apply(
    question: String,
  ...
  ): DiffQuestionStickerInstaSticker = {
    ...
    __obj.asInstanceOf[DiffQuestionStickerInstaSticker]
  }
}
