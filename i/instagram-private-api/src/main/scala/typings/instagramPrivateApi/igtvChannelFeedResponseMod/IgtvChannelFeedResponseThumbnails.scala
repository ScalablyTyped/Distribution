...
object IgtvChannelFeedResponseThumbnails {
  ...
  extension [Self <: IgtvChannelFeedResponseThumbnails](x: Self) {
    ...
    inline def setThumbnail_duration(value: String | Double): Self = StObject.set(x, "thumbnail_duration", value.asInstanceOf[js.Any])
