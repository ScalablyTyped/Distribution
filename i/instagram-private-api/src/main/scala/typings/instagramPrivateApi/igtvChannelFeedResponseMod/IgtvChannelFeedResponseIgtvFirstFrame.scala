...
object IgtvChannelFeedResponseIgtvFirstFrame {
  ...
  inline def apply(height: Double, url: String, width: Double): IgtvChannelFeedResponseIgtvFirstFrame = {
    val __obj = js.Dynamic.literal(height = height.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
    __obj.asInstanceOf[IgtvChannelFeedResponseIgtvFirstFrame]
  }
  
  extension [Self <: IgtvChannelFeedResponseIgtvFirstFrame](x: Self) {
