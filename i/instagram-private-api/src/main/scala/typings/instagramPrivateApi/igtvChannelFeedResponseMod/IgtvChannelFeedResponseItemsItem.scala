...
object IgtvChannelFeedResponseItemsItem {
  ...
  extension [Self <: IgtvChannelFeedResponseItemsItem](x: Self) {
    ...
    inline def setCaption(value: IgtvChannelFeedResponseCaption): Self = StObject.set(x, "caption", value.asInstanceOf[js.Any])
    ...
    inline def setImage_versions2(value: IgtvChannelFeedResponseImageVersions2): Self = StObject.set(x, "image_versions2", value.asInstanceOf[js.Any])
    ...
    inline def setMedia_cropping_info(value: IgtvChannelFeedResponseMediaCroppingInfo): Self = StObject.set(x, "media_cropping_info", value.asInstanceOf[js.Any])
    ...
    inline def setPreview_comments(value: js.Array[IgtvChannelFeedResponsePreviewCommentsItem]): Self = StObject.set(x, "preview_comments", value.asInstanceOf[js.Any])
    
    inline def setPreview_commentsVarargs(value: IgtvChannelFeedResponsePreviewCommentsItem*): Self = StObject.set(x, "preview_comments", js.Array(value :_*))
    ...
    inline def setThumbnails(value: IgtvChannelFeedResponseThumbnails): Self = StObject.set(x, "thumbnails", value.asInstanceOf[js.Any])
    ...
    inline def setVideo_versions(value: js.Array[IgtvChannelFeedResponseVideoVersionsItem]): Self = StObject.set(x, "video_versions", value.asInstanceOf[js.Any])
    
    inline def setVideo_versionsVarargs(value: IgtvChannelFeedResponseVideoVersionsItem*): Self = StObject.set(x, "video_versions", js.Array(value :_*))
