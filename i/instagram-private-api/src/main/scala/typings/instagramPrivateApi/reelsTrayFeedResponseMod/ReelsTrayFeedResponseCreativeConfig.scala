...
object ReelsTrayFeedResponseCreativeConfig {
  ...
  inline def apply(camera_facing: String, capture_type: String, should_render_try_it_on: Boolean): ReelsTrayFeedResponseCreativeConfig = {
  ...
  extension [Self <: ReelsTrayFeedResponseCreativeConfig](x: Self) {
