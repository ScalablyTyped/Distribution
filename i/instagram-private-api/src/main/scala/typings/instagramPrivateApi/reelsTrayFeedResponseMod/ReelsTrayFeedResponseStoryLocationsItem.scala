...
trait ReelsTrayFeedResponseStoryLocationsItem extends js.Object {
  ...
  var location: ReelsTrayFeedResponseLocation = js.native
...
object ReelsTrayFeedResponseStoryLocationsItem {
  ...
  @scala.inline
  implicit class ReelsTrayFeedResponseStoryLocationsItemOps[Self <: ReelsTrayFeedResponseStoryLocationsItem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocation(value: ReelsTrayFeedResponseLocation): Self = this.set("location", value.asInstanceOf[js.Any])
