...
object ReelsTrayFeedResponseStoryLocationsItem {
  ...
  extension [Self <: ReelsTrayFeedResponseStoryLocationsItem](x: Self) {
    ...
    inline def setLocation(value: ReelsTrayFeedResponseLocation): Self = StObject.set(x, "location", value.asInstanceOf[js.Any])
