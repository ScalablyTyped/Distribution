...
object ReelsTrayFeedResponseVideoVersionsItem {
  ...
  inline def apply(height: Double, id: String, `type`: Double, url: String, width: Double): ReelsTrayFeedResponseVideoVersionsItem = {
  ...
  extension [Self <: ReelsTrayFeedResponseVideoVersionsItem](x: Self) {
