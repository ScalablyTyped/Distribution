...
object liveHeartbeatViewerCountResponseMod {
  ...
  object LiveHeartbeatViewerCountResponseRootObject {
    ...
    extension [Self <: LiveHeartbeatViewerCountResponseRootObject](x: Self) {
      
      inline def setBroadcast_status(value: String): Self = StObject.set(x, "broadcast_status", value.asInstanceOf[js.Any])
      
      inline def setCobroadcaster_ids(value: js.Array[js.Any]): Self = StObject.set(x, "cobroadcaster_ids", value.asInstanceOf[js.Any])
      
      inline def setCobroadcaster_idsVarargs(value: js.Any*): Self = StObject.set(x, "cobroadcaster_ids", js.Array(value :_*))
      
      inline def setIs_top_live_eligible(value: Double): Self = StObject.set(x, "is_top_live_eligible", value.asInstanceOf[js.Any])
      
      inline def setOffset_to_video_start(value: Double): Self = StObject.set(x, "offset_to_video_start", value.asInstanceOf[js.Any])
