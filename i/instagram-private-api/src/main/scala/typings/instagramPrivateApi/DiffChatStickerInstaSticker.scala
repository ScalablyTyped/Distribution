...
trait DiffChatStickerInstaSticker extends js.Object {
...
object DiffChatStickerInstaSticker {
  @scala.inline
  def apply(
    text: String,
    ...
    __obj.asInstanceOf[DiffChatStickerInstaSticker]
  }
}
