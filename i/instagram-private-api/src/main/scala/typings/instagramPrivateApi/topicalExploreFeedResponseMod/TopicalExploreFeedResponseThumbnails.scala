...
@js.native
trait TopicalExploreFeedResponseThumbnails extends js.Object {
...
object TopicalExploreFeedResponseThumbnails {
  ...
  @scala.inline
  implicit class TopicalExploreFeedResponseThumbnailsOps[Self <: TopicalExploreFeedResponseThumbnails] (val x: Self) extends AnyVal {
