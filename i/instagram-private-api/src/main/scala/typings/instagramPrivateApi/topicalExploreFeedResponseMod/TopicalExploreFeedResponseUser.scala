...
object TopicalExploreFeedResponseUser {
  ...
  extension [Self <: TopicalExploreFeedResponseUser](x: Self) {
    
    inline def setAccount_badges(value: js.Array[js.Any]): Self = StObject.set(x, "account_badges", value.asInstanceOf[js.Any])
    
    inline def setAccount_badgesUndefined: Self = StObject.set(x, "account_badges", js.undefined)
    
    inline def setAccount_badgesVarargs(value: js.Any*): Self = StObject.set(x, "account_badges", js.Array(value :_*))
    ...
    inline def setCan_be_reported_as_fraudUndefined: Self = StObject.set(x, "can_be_reported_as_fraud", js.undefined)
    
    inline def setFriendship_status(value: TopicalExploreFeedResponseFriendshipStatus): Self = StObject.set(x, "friendship_status", value.asInstanceOf[js.Any])
    ...
    inline def setMerchant_checkout_style(value: String): Self = StObject.set(x, "merchant_checkout_style", value.asInstanceOf[js.Any])
    
    inline def setMerchant_checkout_styleUndefined: Self = StObject.set(x, "merchant_checkout_style", js.undefined)
    ...
    inline def setSeller_shoppable_feed_type(value: String): Self = StObject.set(x, "seller_shoppable_feed_type", value.asInstanceOf[js.Any])
    
    inline def setSeller_shoppable_feed_typeUndefined: Self = StObject.set(x, "seller_shoppable_feed_type", js.undefined)
    
    inline def setShoppable_posts_count(value: Double): Self = StObject.set(x, "shoppable_posts_count", value.asInstanceOf[js.Any])
    
    inline def setShoppable_posts_countUndefined: Self = StObject.set(x, "shoppable_posts_count", js.undefined)
    
    inline def setShow_shoppable_feed(value: Boolean): Self = StObject.set(x, "show_shoppable_feed", value.asInstanceOf[js.Any])
    
    inline def setShow_shoppable_feedUndefined: Self = StObject.set(x, "show_shoppable_feed", js.undefined)
