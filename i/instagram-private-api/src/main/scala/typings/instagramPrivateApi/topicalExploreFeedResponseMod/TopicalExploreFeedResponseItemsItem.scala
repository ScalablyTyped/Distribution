...
@js.native
trait TopicalExploreFeedResponseItemsItem extends js.Object {
  ...
  var is_post_live: Boolean = js.native
  
  var is_shop_the_look_eligible: Boolean = js.native
  
  var max_num_visible_preview_comments: Double = js.native
  
  var media_cropping_info: TopicalExploreFeedResponseMediaCroppingInfo = js.native
  ...
  var thumbnails: TopicalExploreFeedResponseThumbnails = js.native
  ...
  var video_versions: js.Array[TopicalExploreFeedResponseVideoVersionsItem] = js.native
  
  var view_count: Double = js.native
}
object TopicalExploreFeedResponseItemsItem {
  ...
  def apply(
    ...
    media_cropping_info: TopicalExploreFeedResponseMediaCroppingInfo,
    media_type: Double,
    mezql_token: String,
    ...
    video_versions: js.Array[TopicalExploreFeedResponseVideoVersionsItem],
    view_count: Double
  ): TopicalExploreFeedResponseItemsItem = {
    val __obj = js.Dynamic.literal(can_see_insights_as_brand = can_see_insights_as_brand.asInstanceOf[js.Any], can_view_more_preview_comments = can_view_more_preview_comments.asInstanceOf[js.Any], can_viewer_reshare = can_viewer_reshare.asInstanceOf[js.Any], can_viewer_save = can_viewer_save.asInstanceOf[js.Any], caption = caption.asInstanceOf[js.Any], caption_is_edited = caption_is_edited.asInstanceOf[js.Any], client_cache_key = client_cache_key.asInstanceOf[js.Any], code = code.asInstanceOf[js.Any], comment_count = comment_count.asInstanceOf[js.Any], comment_likes_enabled = comment_likes_enabled.asInstanceOf[js.Any], comment_threading_enabled = comment_threading_enabled.asInstanceOf[js.Any], deleted_reason = deleted_reason.asInstanceOf[js.Any], device_timestamp = device_timestamp.asInstanceOf[js.Any], explore = explore.asInstanceOf[js.Any], filter_type = filter_type.asInstanceOf[js.Any], has_audio = has_audio.asInstanceOf[js.Any], has_more_comments = has_more_comments.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], image_versions2 = image_versions2.asInstanceOf[js.Any], is_dash_eligible = is_dash_eligible.asInstanceOf[js.Any], is_in_profile_grid = is_in_profile_grid.asInstanceOf[js.Any], is_post_live = is_post_live.asInstanceOf[js.Any], is_shop_the_look_eligible = is_shop_the_look_eligible.asInstanceOf[js.Any], max_num_visible_preview_comments = max_num_visible_preview_comments.asInstanceOf[js.Any], media_cropping_info = media_cropping_info.asInstanceOf[js.Any], media_type = media_type.asInstanceOf[js.Any], mezql_token = mezql_token.asInstanceOf[js.Any], nearly_complete_copyright_match = nearly_complete_copyright_match.asInstanceOf[js.Any], number_of_qualities = number_of_qualities.asInstanceOf[js.Any], organic_tracking_token = organic_tracking_token.asInstanceOf[js.Any], original_height = original_height.asInstanceOf[js.Any], original_width = original_width.asInstanceOf[js.Any], photo_of_you = photo_of_you.asInstanceOf[js.Any], pk = pk.asInstanceOf[js.Any], preview_comments = preview_comments.asInstanceOf[js.Any], product_type = product_type.asInstanceOf[js.Any], profile_grid_control_enabled = profile_grid_control_enabled.asInstanceOf[js.Any], sharing_friction_info = sharing_friction_info.asInstanceOf[js.Any], taken_at = taken_at.asInstanceOf[js.Any], thumbnails = thumbnails.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any], user = user.asInstanceOf[js.Any], video_codec = video_codec.asInstanceOf[js.Any], video_dash_manifest = video_dash_manifest.asInstanceOf[js.Any], video_duration = video_duration.asInstanceOf[js.Any], video_versions = video_versions.asInstanceOf[js.Any], view_count = view_count.asInstanceOf[js.Any])
    __obj.asInstanceOf[TopicalExploreFeedResponseItemsItem]
  }
  
  @scala.inline
  implicit class TopicalExploreFeedResponseItemsItemOps[Self <: TopicalExploreFeedResponseItemsItem] (val x: Self) extends AnyVal {
