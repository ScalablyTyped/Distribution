...
@js.native
trait TopicalExploreFeedResponseMerchant extends js.Object {
...
object TopicalExploreFeedResponseMerchant {
  ...
  @scala.inline
  implicit class TopicalExploreFeedResponseMerchantOps[Self <: TopicalExploreFeedResponseMerchant] (val x: Self) extends AnyVal {
