...
object TopicalExploreFeedResponseMerchant {
  ...
  inline def apply(pk: Double, profile_pic_url: String, username: String): TopicalExploreFeedResponseMerchant = {
  ...
  extension [Self <: TopicalExploreFeedResponseMerchant](x: Self) {
