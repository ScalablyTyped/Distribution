...
@js.native
trait TopicalExploreFeedResponseCaption extends js.Object {
...
object TopicalExploreFeedResponseCaption {
  ...
  @scala.inline
  implicit class TopicalExploreFeedResponseCaptionOps[Self <: TopicalExploreFeedResponseCaption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIs_covered(value: Boolean): Self = this.set("is_covered", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPrivate_reply_status(value: Double): Self = this.set("private_reply_status", value.asInstanceOf[js.Any])
