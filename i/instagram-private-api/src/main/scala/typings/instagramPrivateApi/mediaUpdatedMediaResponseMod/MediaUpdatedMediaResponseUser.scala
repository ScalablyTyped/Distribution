...
object MediaUpdatedMediaResponseUser {
  ...
  @scala.inline
  implicit class MediaUpdatedMediaResponseUserOps[Self <: MediaUpdatedMediaResponseUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: MediaUpdatedMediaResponseFriendshipStatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
