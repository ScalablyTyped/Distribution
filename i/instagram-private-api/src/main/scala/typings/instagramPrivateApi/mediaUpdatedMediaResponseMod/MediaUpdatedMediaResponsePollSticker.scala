...
object MediaUpdatedMediaResponsePollSticker {
  ...
  implicit class MediaUpdatedMediaResponsePollStickerOps[Self <: MediaUpdatedMediaResponsePollSticker] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTalliesVarargs(value: MediaUpdatedMediaResponseTalliesItem*): Self = this.set("tallies", js.Array(value :_*))
    
    @scala.inline
    def setTallies(value: js.Array[MediaUpdatedMediaResponseTalliesItem]): Self = this.set("tallies", value.asInstanceOf[js.Any])
