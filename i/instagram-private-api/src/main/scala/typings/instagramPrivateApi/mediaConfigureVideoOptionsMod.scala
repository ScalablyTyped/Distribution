...
object mediaConfigureVideoOptionsMod {
  ...
  object MediaConfigureTimelineVideoOptions {
    ...
    inline def apply(height: Double, length: Double, upload_id: String, width: Double): MediaConfigureTimelineVideoOptions = {
    ...
    extension [Self <: MediaConfigureTimelineVideoOptions](x: Self) {
      ...
      inline def setSource_type(value: `4`): Self = StObject.set(x, "source_type", value.asInstanceOf[js.Any])
  ...
  object MediaConfigureVideoOptions {
    ...
    inline def apply(height: Double, length: Double, upload_id: String, width: Double): MediaConfigureVideoOptions = {
      val __obj = js.Dynamic.literal(height = height.asInstanceOf[js.Any], length = length.asInstanceOf[js.Any], upload_id = upload_id.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
      __obj.asInstanceOf[MediaConfigureVideoOptions]
    }
    
    extension [Self <: MediaConfigureVideoOptions](x: Self) {
