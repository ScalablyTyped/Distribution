...
object DirectThreadRepositoryAddUserResponseThread {
  ...
  @scala.inline
  implicit class DirectThreadRepositoryAddUserResponseThreadOps[Self <: DirectThreadRepositoryAddUserResponseThread] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInviter(value: DirectThreadRepositoryAddUserResponseInviter): Self = this.set("inviter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLast_permanent_item(value: DirectThreadRepositoryAddUserResponseLastPermanentItem): Self = this.set("last_permanent_item", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUsersVarargs(value: DirectThreadRepositoryAddUserResponseUsersItem*): Self = this.set("users", js.Array(value :_*))
    
    @scala.inline
    def setUsers(value: js.Array[DirectThreadRepositoryAddUserResponseUsersItem]): Self = this.set("users", value.asInstanceOf[js.Any])
