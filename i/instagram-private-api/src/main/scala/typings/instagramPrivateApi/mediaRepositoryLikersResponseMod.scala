...
object mediaRepositoryLikersResponseMod {
  ...
  object MediaRepositoryLikersResponseRootObject {
    ...
    inline def apply(status: String, user_count: Double, users: js.Array[MediaRepositoryLikersResponseUsersItem]): MediaRepositoryLikersResponseRootObject = {
    ...
    extension [Self <: MediaRepositoryLikersResponseRootObject](x: Self) {
      
      inline def setStatus(value: String): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
      
      inline def setUser_count(value: Double): Self = StObject.set(x, "user_count", value.asInstanceOf[js.Any])
      
      inline def setUsers(value: js.Array[MediaRepositoryLikersResponseUsersItem]): Self = StObject.set(x, "users", value.asInstanceOf[js.Any])
      
      inline def setUsersVarargs(value: MediaRepositoryLikersResponseUsersItem*): Self = StObject.set(x, "users", js.Array(value :_*))
    }
  }
  ...
  object MediaRepositoryLikersResponseUsersItem {
    ...
    extension [Self <: MediaRepositoryLikersResponseUsersItem](x: Self) {
