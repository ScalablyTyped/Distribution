...
object DirectThreadRepositoryApproveParticipantRequestResponseFriendshipStatus {
  ...
  @scala.inline
  implicit class DirectThreadRepositoryApproveParticipantRequestResponseFriendshipStatusOps[Self <: DirectThreadRepositoryApproveParticipantRequestResponseFriendshipStatus] (val x: Self) extends AnyVal {
