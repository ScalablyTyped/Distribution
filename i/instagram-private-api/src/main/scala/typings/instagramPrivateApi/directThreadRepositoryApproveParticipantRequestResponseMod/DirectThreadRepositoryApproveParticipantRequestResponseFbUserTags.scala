...
@js.native
trait DirectThreadRepositoryApproveParticipantRequestResponseFbUserTags extends js.Object {
...
object DirectThreadRepositoryApproveParticipantRequestResponseFbUserTags {
  ...
  @scala.inline
  implicit class DirectThreadRepositoryApproveParticipantRequestResponseFbUserTagsOps[Self <: DirectThreadRepositoryApproveParticipantRequestResponseFbUserTags] (val x: Self) extends AnyVal {
