...
object DirectThreadRepositoryApproveParticipantRequestResponseCandidatesItem {
  ...
  @scala.inline
  implicit class DirectThreadRepositoryApproveParticipantRequestResponseCandidatesItemOps[Self <: DirectThreadRepositoryApproveParticipantRequestResponseCandidatesItem] (val x: Self) extends AnyVal {
