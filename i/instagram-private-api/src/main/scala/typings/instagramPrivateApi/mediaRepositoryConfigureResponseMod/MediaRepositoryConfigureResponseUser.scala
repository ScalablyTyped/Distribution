...
@js.native
trait MediaRepositoryConfigureResponseUser extends js.Object {
...
object MediaRepositoryConfigureResponseUser {
  ...
  @scala.inline
  implicit class MediaRepositoryConfigureResponseUserOps[Self <: MediaRepositoryConfigureResponseUser] (val x: Self) extends AnyVal {
