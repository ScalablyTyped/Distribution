...
object HighlightsRepositoryHighlightsTrayResponseCroppedImageVersion {
  ...
  inline def apply(estimated_scans_sizes: js.Array[Double], height: Double, url: String, width: Double): HighlightsRepositoryHighlightsTrayResponseCroppedImageVersion = {
  ...
  extension [Self <: HighlightsRepositoryHighlightsTrayResponseCroppedImageVersion](x: Self) {
