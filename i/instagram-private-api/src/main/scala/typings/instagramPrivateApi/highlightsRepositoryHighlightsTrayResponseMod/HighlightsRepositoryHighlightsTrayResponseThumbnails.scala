...
object HighlightsRepositoryHighlightsTrayResponseThumbnails {
  ...
  @scala.inline
  implicit class HighlightsRepositoryHighlightsTrayResponseThumbnailsOps[Self <: HighlightsRepositoryHighlightsTrayResponseThumbnails] (val x: Self) extends AnyVal {
