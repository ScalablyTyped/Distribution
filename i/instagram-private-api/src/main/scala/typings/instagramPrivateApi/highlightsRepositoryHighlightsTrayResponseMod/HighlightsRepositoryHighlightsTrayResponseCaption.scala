...
@js.native
trait HighlightsRepositoryHighlightsTrayResponseCaption extends StObject {
...
object HighlightsRepositoryHighlightsTrayResponseCaption {
  ...
  @scala.inline
  implicit class HighlightsRepositoryHighlightsTrayResponseCaptionMutableBuilder[Self <: HighlightsRepositoryHighlightsTrayResponseCaption] (val x: Self) extends AnyVal {
