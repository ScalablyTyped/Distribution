...
object HighlightsRepositoryHighlightsTrayResponseUserDict {
  ...
  extension [Self <: HighlightsRepositoryHighlightsTrayResponseUserDict](x: Self) {
    
    inline def setBiography(value: String): Self = StObject.set(x, "biography", value.asInstanceOf[js.Any])
    
    inline def setBiography_with_entities(value: HighlightsRepositoryHighlightsTrayResponseBiographyWithEntities): Self = StObject.set(x, "biography_with_entities", value.asInstanceOf[js.Any])
