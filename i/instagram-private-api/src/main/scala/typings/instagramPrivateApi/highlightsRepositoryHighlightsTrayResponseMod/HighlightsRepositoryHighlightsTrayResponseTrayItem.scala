...
object HighlightsRepositoryHighlightsTrayResponseTrayItem {
  ...
  extension [Self <: HighlightsRepositoryHighlightsTrayResponseTrayItem](x: Self) {
    
    inline def setCan_reply(value: Boolean): Self = StObject.set(x, "can_reply", value.asInstanceOf[js.Any])
    
    inline def setCan_reshare(value: Null): Self = StObject.set(x, "can_reshare", value.asInstanceOf[js.Any])
    
    inline def setCover_media(value: HighlightsRepositoryHighlightsTrayResponseCoverMedia): Self = StObject.set(x, "cover_media", value.asInstanceOf[js.Any])
