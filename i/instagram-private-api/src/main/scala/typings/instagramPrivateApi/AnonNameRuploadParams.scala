...
trait AnonNameRuploadParams extends js.Object {
  var name: js.Any
  var ruploadParams: js.Any
  var waterfallId: js.Any
}

object AnonNameRuploadParams {
  @scala.inline
  def apply(name: js.Any, ruploadParams: js.Any, waterfallId: js.Any): AnonNameRuploadParams = {
    ...
    __obj.asInstanceOf[AnonNameRuploadParams]
  }
}
