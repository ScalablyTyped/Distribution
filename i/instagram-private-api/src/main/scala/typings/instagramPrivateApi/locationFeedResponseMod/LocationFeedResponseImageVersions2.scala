...
object LocationFeedResponseImageVersions2 {
  ...
  implicit class LocationFeedResponseImageVersions2Ops[Self <: LocationFeedResponseImageVersions2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCandidatesVarargs(value: LocationFeedResponseCandidatesItem*): Self = this.set("candidates", js.Array(value :_*))
    
    @scala.inline
    def setCandidates(value: js.Array[LocationFeedResponseCandidatesItem]): Self = this.set("candidates", value.asInstanceOf[js.Any])
  }
}
