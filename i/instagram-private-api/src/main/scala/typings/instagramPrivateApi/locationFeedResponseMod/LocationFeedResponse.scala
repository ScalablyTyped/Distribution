...
object LocationFeedResponse {
  ...
  implicit class LocationFeedResponseOps[Self <: LocationFeedResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSectionsVarargs(value: LocationFeedResponseSectionsItem*): Self = this.set("sections", js.Array(value :_*))
    
    @scala.inline
    def setSections(value: js.Array[LocationFeedResponseSectionsItem]): Self = this.set("sections", value.asInstanceOf[js.Any])
