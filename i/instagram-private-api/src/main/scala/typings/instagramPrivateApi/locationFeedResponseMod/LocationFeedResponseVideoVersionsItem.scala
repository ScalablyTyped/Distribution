...
object LocationFeedResponseVideoVersionsItem {
  ...
  inline def apply(height: Double, id: String, `type`: Double, url: String, width: Double): LocationFeedResponseVideoVersionsItem = {
  ...
  extension [Self <: LocationFeedResponseVideoVersionsItem](x: Self) {
