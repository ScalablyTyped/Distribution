...
trait LocationFeedResponseCarouselMediaItem extends StObject {
  ...
  var image_versions2: LocationFeedResponseImageVersions2 = js.native
...
object LocationFeedResponseCarouselMediaItem {
  ...
  @scala.inline
  implicit class LocationFeedResponseCarouselMediaItemMutableBuilder[Self <: LocationFeedResponseCarouselMediaItem] (val x: Self) extends AnyVal {
