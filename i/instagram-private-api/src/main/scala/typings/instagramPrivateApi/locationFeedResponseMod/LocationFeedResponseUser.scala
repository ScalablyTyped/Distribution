...
object LocationFeedResponseUser {
  ...
  @scala.inline
  implicit class LocationFeedResponseUserOps[Self <: LocationFeedResponseUser] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFriendship_status(value: LocationFeedResponseFriendshipStatus): Self = this.set("friendship_status", value.asInstanceOf[js.Any])
