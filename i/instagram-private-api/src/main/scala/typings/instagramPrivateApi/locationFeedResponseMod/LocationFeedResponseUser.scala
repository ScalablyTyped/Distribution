...
object LocationFeedResponseUser {
  ...
  @scala.inline
  def apply(full_name: String, is_private: Boolean, pk: Double, profile_pic_url: String, username: String): LocationFeedResponseUser = {
  ...
  @scala.inline
  implicit class LocationFeedResponseUserMutableBuilder[Self <: LocationFeedResponseUser] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFriendship_status(value: LocationFeedResponseFriendshipStatus): Self = StObject.set(x, "friendship_status", value.asInstanceOf[js.Any])
