...
@js.native
trait LocationFeedResponseCandidatesItem extends js.Object {
...
object LocationFeedResponseCandidatesItem {
  ...
  @scala.inline
  implicit class LocationFeedResponseCandidatesItemOps[Self <: LocationFeedResponseCandidatesItem] (val x: Self) extends AnyVal {
