...
trait IgtvBrowseFeedResponseVideoVersionsItem extends StObject {
...
object IgtvBrowseFeedResponseVideoVersionsItem {
  ...
  inline def apply(height: Double, id: String, `type`: Double, url: String, width: Double): IgtvBrowseFeedResponseVideoVersionsItem = {
  ...
  extension [Self <: IgtvBrowseFeedResponseVideoVersionsItem](x: Self) {
