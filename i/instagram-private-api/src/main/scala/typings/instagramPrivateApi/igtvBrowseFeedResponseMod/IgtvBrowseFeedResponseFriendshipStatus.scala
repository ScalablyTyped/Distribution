...
object IgtvBrowseFeedResponseFriendshipStatus {
  ...
  inline def apply(following: Boolean, is_bestie: Boolean, is_restricted: Boolean, outgoing_request: Boolean): IgtvBrowseFeedResponseFriendshipStatus = {
  ...
  extension [Self <: IgtvBrowseFeedResponseFriendshipStatus](x: Self) {
