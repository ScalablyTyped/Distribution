...
object IgtvBrowseFeedResponseItem {
  ...
  extension [Self <: IgtvBrowseFeedResponseItem](x: Self) {
    ...
    inline def setCaption(value: IgtvBrowseFeedResponseCaption): Self = StObject.set(x, "caption", value.asInstanceOf[js.Any])
    ...
    inline def setExplore(value: IgtvBrowseFeedResponseExplore): Self = StObject.set(x, "explore", value.asInstanceOf[js.Any])
    ...
    inline def setImage_versions2(value: IgtvBrowseFeedResponseImageVersions2): Self = StObject.set(x, "image_versions2", value.asInstanceOf[js.Any])
    ...
    inline def setMedia_cropping_info(value: IgtvBrowseFeedResponseMediaCroppingInfo): Self = StObject.set(x, "media_cropping_info", value.asInstanceOf[js.Any])
    ...
    inline def setThumbnails(value: IgtvBrowseFeedResponseThumbnails): Self = StObject.set(x, "thumbnails", value.asInstanceOf[js.Any])
    
    inline def setTitle(value: String): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
    
    inline def setUser(value: IgtvBrowseFeedResponseUser): Self = StObject.set(x, "user", value.asInstanceOf[js.Any])
    ...
    inline def setVideo_versions(value: js.Array[IgtvBrowseFeedResponseVideoVersionsItem]): Self = StObject.set(x, "video_versions", value.asInstanceOf[js.Any])
    
    inline def setVideo_versionsVarargs(value: IgtvBrowseFeedResponseVideoVersionsItem*): Self = StObject.set(x, "video_versions", js.Array(value :_*))
