...
object IgtvBrowseFeedResponseBiographyWithEntities {
  ...
  inline def apply(entities: js.Array[js.Any], raw_text: String): IgtvBrowseFeedResponseBiographyWithEntities = {
  ...
  extension [Self <: IgtvBrowseFeedResponseBiographyWithEntities](x: Self) {
