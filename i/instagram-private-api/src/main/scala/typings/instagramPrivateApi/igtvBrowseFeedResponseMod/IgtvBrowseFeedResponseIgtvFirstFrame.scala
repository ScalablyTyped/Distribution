...
@js.native
trait IgtvBrowseFeedResponseIgtvFirstFrame extends js.Object {
...
object IgtvBrowseFeedResponseIgtvFirstFrame {
  ...
  @scala.inline
  implicit class IgtvBrowseFeedResponseIgtvFirstFrameOps[Self <: IgtvBrowseFeedResponseIgtvFirstFrame] (val x: Self) extends AnyVal {
