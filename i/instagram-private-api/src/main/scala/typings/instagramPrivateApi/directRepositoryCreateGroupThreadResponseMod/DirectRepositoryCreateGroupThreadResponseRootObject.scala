package typings.instagramPrivateApi.directRepositoryCreateGroupThreadResponseMod
...
object DirectRepositoryCreateGroupThreadResponseRootObject {
  ...
  @scala.inline
  implicit class DirectRepositoryCreateGroupThreadResponseRootObjectOps[Self <: DirectRepositoryCreateGroupThreadResponseRootObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInviter(value: DirectRepositoryCreateGroupThreadResponseInviter): Self = this.set("inviter", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLast_activity_at(value: Double): Self = this.set("last_activity_at", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPending_score(value: Double): Self = this.set("pending_score", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUsersVarargs(value: DirectRepositoryCreateGroupThreadResponseUsersItem*): Self = this.set("users", js.Array(value :_*))
    
    @scala.inline
    def setUsers(value: js.Array[DirectRepositoryCreateGroupThreadResponseUsersItem]): Self = this.set("users", value.asInstanceOf[js.Any])
