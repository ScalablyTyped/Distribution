...
trait AnonSegmentlist extends js.Object {
  var segments: js.Array[Segment]
  var `type`: segmentDotlist
}

object AnonSegmentlist {
  @scala.inline
  def apply(segments: js.Array[Segment], `type`: segmentDotlist): AnonSegmentlist = {
    val __obj = js.Dynamic.literal(segments = segments.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonSegmentlist]
  }
}
