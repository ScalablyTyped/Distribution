...
class Users () extends js.Object {
  ...
  def archive(): stdLib.Promise[intercomDashClientLib.userMod.User] = js.native
  ...
  def list(): stdLib.Promise[ApiResponse[intercomDashClientLib.userMod.User]] = js.native
  def list(cb: callback[ApiResponse[intercomDashClientLib.userMod.User]]): scala.Unit = js.native
  ...
  def requestPermanentDeletion(): stdLib.Promise[intercomDashClientLib.Anon_IdNumber] = js.native
  def update(
