...
import typings.ionicAngular.virtualFooterMod.VirtualFooter
import typings.ionicAngular.virtualHeaderMod.VirtualHeader
import typings.ionicAngular.virtualItemMod.VirtualItem
