...
import typings.atIonicAngular.distDirectivesNavigationStackDashUtilsMod.RouteView
...
@js.native
object distDirectivesNavigationStackDashControllerMod extends js.Object {
  @js.native
