...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonSkeletonText * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonSkeletonText")
@js.native
