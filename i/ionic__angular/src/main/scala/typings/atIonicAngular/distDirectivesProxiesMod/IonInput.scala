...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonInput * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonInput")
@js.native
