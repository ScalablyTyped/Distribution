...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonToggle * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonToggle")
@js.native
class IonToggle protected () extends js.Object {
