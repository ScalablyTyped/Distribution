...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonFabButton * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonFabButton")
@js.native
class IonFabButton protected () extends js.Object {
