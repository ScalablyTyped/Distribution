...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonSplitPane * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonSplitPane")
@js.native
