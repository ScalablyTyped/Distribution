...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonRippleEffect * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonRippleEffect")
@js.native
