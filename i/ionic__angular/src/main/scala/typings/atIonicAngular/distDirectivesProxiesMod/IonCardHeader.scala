...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonCardHeader * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonCardHeader")
@js.native
