...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonRange * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonRange")
@js.native
