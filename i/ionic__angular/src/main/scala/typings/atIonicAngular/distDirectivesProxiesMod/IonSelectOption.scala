...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonSelectOption * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonSelectOption")
@js.native
