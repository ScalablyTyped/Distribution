...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonMenu * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonMenu")
@js.native
