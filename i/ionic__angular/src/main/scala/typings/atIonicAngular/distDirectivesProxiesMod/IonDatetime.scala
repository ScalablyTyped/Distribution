...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonDatetime * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonDatetime")
@js.native
class IonDatetime protected () extends js.Object {
