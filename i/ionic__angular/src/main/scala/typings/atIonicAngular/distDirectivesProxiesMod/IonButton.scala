...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonButton * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonButton")
@js.native
class IonButton protected () extends js.Object {
