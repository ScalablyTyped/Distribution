...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonTextarea * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonTextarea")
@js.native
