...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonChip * / any */ @JSImport("@ionic/angular/dist/directives/proxies", "IonChip")
@js.native
