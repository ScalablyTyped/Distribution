...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonTextarea'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonTextarea")
@js.native
class IonTextarea protected () extends js.Object {
