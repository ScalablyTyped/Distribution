...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonListHeader'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonListHeader")
@js.native
