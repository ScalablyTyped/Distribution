...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonToggle'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonToggle")
@js.native
