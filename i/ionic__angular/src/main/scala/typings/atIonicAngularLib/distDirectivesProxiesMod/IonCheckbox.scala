...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonCheckbox'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonCheckbox")
@js.native
class IonCheckbox protected () extends js.Object {
