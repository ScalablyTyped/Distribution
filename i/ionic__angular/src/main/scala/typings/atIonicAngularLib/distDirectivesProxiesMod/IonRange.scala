...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonRange'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonRange")
@js.native
