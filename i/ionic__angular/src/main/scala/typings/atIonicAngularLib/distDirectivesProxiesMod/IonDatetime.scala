...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonDatetime'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonDatetime")
@js.native
