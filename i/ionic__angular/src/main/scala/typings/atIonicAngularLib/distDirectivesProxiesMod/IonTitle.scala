...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonTitle'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonTitle")
@js.native
