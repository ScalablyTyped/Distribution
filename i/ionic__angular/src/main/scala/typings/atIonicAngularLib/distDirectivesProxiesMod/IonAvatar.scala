...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonAvatar'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonAvatar")
@js.native
