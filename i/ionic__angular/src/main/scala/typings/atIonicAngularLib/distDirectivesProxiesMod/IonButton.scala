...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonButton'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonButton")
@js.native
