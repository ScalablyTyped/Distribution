...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonSearchbar'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonSearchbar")
@js.native
