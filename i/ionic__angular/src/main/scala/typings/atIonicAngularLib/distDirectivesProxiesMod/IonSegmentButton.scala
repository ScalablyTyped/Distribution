...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonSegmentButton'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonSegmentButton")
@js.native
