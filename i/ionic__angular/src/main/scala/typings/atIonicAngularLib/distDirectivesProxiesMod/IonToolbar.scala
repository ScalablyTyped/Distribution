...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonToolbar'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonToolbar")
@js.native
