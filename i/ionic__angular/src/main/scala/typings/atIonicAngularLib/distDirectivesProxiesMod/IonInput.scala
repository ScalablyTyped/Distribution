...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonInput'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonInput")
@js.native
class IonInput protected () extends js.Object {
