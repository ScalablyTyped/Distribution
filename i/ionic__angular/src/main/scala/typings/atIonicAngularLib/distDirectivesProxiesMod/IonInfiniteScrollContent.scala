...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonInfiniteScrollContent'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonInfiniteScrollContent")
@js.native
