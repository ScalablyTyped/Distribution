...
- Dropped @ionic/core.@ionic/core/dist/types/stencil.core.Global.StencilElementInterfaces['IonInfiniteScroll'] */ @JSImport("@ionic/angular/dist/directives/proxies", "IonInfiniteScroll")
@js.native
