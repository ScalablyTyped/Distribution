package typings
package atIonicAngularLib.distProvidersPlatformMod
...
class Platform protected () extends js.Object {
  ...
  /**
    ...
    */
  var pause: rxjsLib.rxjsMod.Subject[scala.Unit] = js.native
  /**
    * The resize event emits when the browser window has changed dimensions. This
    * could be from a browser window being physically resized, or from a device
    * changing orientation.
    */
  var resize: rxjsLib.rxjsMod.Subject[scala.Unit] = js.native
  /**
    * The resume event emits when the native platform pulls the application
    * out from the background. This event would emit when a Cordova app comes
    * out from the background, however, it would not fire on a standard web browser.
    */
  var resume: rxjsLib.rxjsMod.Subject[scala.Unit] = js.native
  ...
  /**
    ...
    * ```
    */
  def ready(): js.Promise[java.lang.String] = js.native
