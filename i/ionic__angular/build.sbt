...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "angular__forms" % "8.1.3-8c5df5",
  "org.scalablytyped" %%% "angular__router" % "8.1.3-2741b0",
  "org.scalablytyped" %%% "ionic__core" % "4.7.1-7ce067",
