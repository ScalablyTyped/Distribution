...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "angular__router" % "8.2.14-761c97",
  "org.scalablytyped" %%% "inquirer" % "6.5-dt-20190731Z-68b969",
  "org.scalablytyped" %%% "ionic__core" % "4.11.7-7c324b",
  "org.scalablytyped" %%% "ionicons" % "4.6.3-c9a137",
