...
object distSrcIndexedReaderBrowserMod {
  
  @JSImport("@ipld/car/dist/src/indexed-reader-browser", "CarIndexedReader")
  @js.native
  ...
  @JSImport("@ipld/car/dist/src/indexed-reader-browser", "__browser")
  @js.native
