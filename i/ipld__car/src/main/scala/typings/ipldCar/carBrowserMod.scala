...
import typings.ipldCar.writerBrowserMod.WriterChannel
...
object carBrowserMod {
  ...
  open class CarIndexedReader ()
    extends typings.ipldCar.indexedReaderBrowserMod.CarIndexedReader
  /* static members */
  ...
  open class CarReader protected ()
    extends typings.ipldCar.readerBrowserMod.CarReader {
    /**
  ...
  object CarReader {
    ...
    /**
      ...
      */
    inline def fromBytes(bytes: js.typedarray.Uint8Array): js.Promise[typings.ipldCar.readerBrowserMod.CarReader] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBytes")(bytes.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.ipldCar.readerBrowserMod.CarReader]]
    ...
    /**
      ...
      */
    inline def fromIterable(asyncIterable: AsyncIterable[js.typedarray.Uint8Array]): js.Promise[typings.ipldCar.readerBrowserMod.CarReader] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIterable")(asyncIterable.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.ipldCar.readerBrowserMod.CarReader]]
  }
  
  @JSImport("@ipld/car/types/car-browser", "CarWriter")
  @js.native
  open class CarWriter protected ()
    extends typings.ipldCar.writerBrowserMod.CarWriter {
    /**
      * @param {CID[]} roots
  ...
  object CarWriter {
    ...
    ): WriterChannel = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(roots.asInstanceOf[js.Any]).asInstanceOf[WriterChannel]
    inline def create(
      roots: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify CID */ Any
    ): WriterChannel = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(roots.asInstanceOf[js.Any]).asInstanceOf[WriterChannel]
