...
object typesLibIndexedReaderMod {
  ...
  open class CarIndexedReader protected ()
    ...
    /* CompleteClass */
    override def get(key: CID[Any, Double, Double, Version]): js.Promise[js.UndefOr[typings.ipldCar.typesApiMod.Block]] = js.native
  ...
  type CarReader = typings.ipldCar.typesLibReaderBrowserMod.CarReader
