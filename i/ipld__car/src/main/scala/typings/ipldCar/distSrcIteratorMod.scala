...
object distSrcIteratorMod {
  
  @JSImport("@ipld/car/dist/src/iterator", "CarBlockIterator")
  @js.native
  ...
  @JSImport("@ipld/car/dist/src/iterator", "CarCIDIterator")
  @js.native
  ...
  @JSImport("@ipld/car/dist/src/iterator", "CarIteratorBase")
  @js.native
  open class CarIteratorBase protected ()
    ...
    var _iterable: Unit | AsyncIterable[typings.ipldCar.distSrcApiMod.Block] = js.native
