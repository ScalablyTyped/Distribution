...
import typings.ipldCar.typesApiMod.BlockIterator
import typings.ipldCar.typesApiMod.CIDIterator
...
object typesLibReaderBrowserMod {
  ...
  open class CarReader protected ()
    extends StObject
       with typings.ipldCar.typesApiMod.CarReader {
    /**
    ...
    var _blocks: js.Array[typings.ipldCar.typesApiMod.Block] = js.native
    
    var _header: typings.ipldCar.typesLibCodingMod.CarHeader | typings.ipldCar.typesLibCodingMod.CarV2Header = js.native
    ...
    /* CompleteClass */
    override def get(key: typings.multiformats.cidMod.CID[Any, Double, Double, Version]): js.Promise[js.UndefOr[typings.ipldCar.typesApiMod.Block]] = js.native
