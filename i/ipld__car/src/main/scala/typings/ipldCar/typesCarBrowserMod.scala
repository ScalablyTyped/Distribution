...
import typings.ipldCar.typesLibWriterBrowserMod.WriterChannel
...
object typesCarBrowserMod {
  ...
  open class CarIndexedReader ()
    extends typings.ipldCar.typesLibIndexedReaderBrowserMod.CarIndexedReader
  /* static members */
  ...
  object CarReader {
    ...
    /**
      ...
      */
    inline def fromBytes(bytes: js.typedarray.Uint8Array): js.Promise[typings.ipldCar.typesLibReaderBrowserMod.CarReader] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBytes")(bytes.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.ipldCar.typesLibReaderBrowserMod.CarReader]]
    ...
    /**
      ...
      */
    inline def fromIterable(asyncIterable: AsyncIterable[js.typedarray.Uint8Array]): js.Promise[typings.ipldCar.typesLibReaderBrowserMod.CarReader] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIterable")(asyncIterable.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.ipldCar.typesLibReaderBrowserMod.CarReader]]
  }
