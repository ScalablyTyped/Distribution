...
object writerBrowserMod {
  ...
  open class CarWriter protected ()
    ...
    var _encoder: typings.ipldCar.codingMod.CarEncoder = js.native
    ...
    /* CompleteClass */
    override def put(block: typings.ipldCar.apiMod.Block): js.Promise[Unit] = js.native
  }
  /* static members */
  object CarWriter {
  ...
  type IteratorChannel = typings.ipldCar.codingMod.IteratorChannel[js.typedarray.Uint8Array]
  
  type WriterChannel = typings.ipldCar.apiMod.WriterChannel
}
