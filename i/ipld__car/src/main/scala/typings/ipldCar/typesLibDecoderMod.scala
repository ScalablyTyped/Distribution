...
import typings.ipldCar.typesLibCodingMod.BytesReader
...
object typesLibDecoderMod {
  ...
  type BlockHeader = typings.ipldCar.typesApiMod.BlockHeader
  
  type BlockIndex = typings.ipldCar.typesApiMod.BlockIndex
  
  type BytesReader_ = BytesReader
  
  type CarDecoder = typings.ipldCar.typesLibCodingMod.CarDecoder
  
  type CarHeader = typings.ipldCar.typesLibCodingMod.CarHeader
  
  type CarV2FixedHeader = typings.ipldCar.typesLibCodingMod.CarV2FixedHeader
  
  type CarV2Header = typings.ipldCar.typesLibCodingMod.CarV2Header
}
