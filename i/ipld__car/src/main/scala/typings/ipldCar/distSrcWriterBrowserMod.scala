...
object distSrcWriterBrowserMod {
  
  @JSImport("@ipld/car/dist/src/writer-browser", "CarWriter")
  @js.native
  open class CarWriter protected ()
    extends StObject
       with typings.ipldCar.distSrcApiMod.BlockWriter {
    /**
      * @param {CID[]} roots
    ...
    var _encoder: typings.ipldCar.distSrcCodingMod.CarEncoder = js.native
    ...
    /* CompleteClass */
    override def put(block: typings.ipldCar.distSrcApiMod.Block): js.Promise[Unit] = js.native
  }
  /* static members */
  object CarWriter {
  ...
  @JSImport("@ipld/car/dist/src/writer-browser", "CarWriterOut")
  @js.native
  ...
  @JSImport("@ipld/car/dist/src/writer-browser", "__browser")
  @js.native
  ...
  type IteratorChannel = typings.ipldCar.distSrcCodingMod.IteratorChannel[js.typedarray.Uint8Array]
  
  type WriterChannel = typings.ipldCar.distSrcApiMod.WriterChannel
}
