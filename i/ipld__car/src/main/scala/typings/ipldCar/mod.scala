...
object mod {
  ...
  object CarReader {
    ...
    inline def readRaw(fd: Double, blockIndex: typings.ipldCar.distSrcReaderMod.BlockIndex): js.Promise[typings.ipldCar.distSrcReaderMod.Block] = (^.asInstanceOf[js.Dynamic].applyDynamic("readRaw")(fd.asInstanceOf[js.Any], blockIndex.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.ipldCar.distSrcReaderMod.Block]]
    /**
      ...
      */
    inline def readRaw(fd: FileHandle, blockIndex: typings.ipldCar.distSrcReaderMod.BlockIndex): js.Promise[typings.ipldCar.distSrcReaderMod.Block] = (^.asInstanceOf[js.Dynamic].applyDynamic("readRaw")(fd.asInstanceOf[js.Any], blockIndex.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.ipldCar.distSrcReaderMod.Block]]
  }
