...
import typings.ipldCar.codingMod.BytesReader
...
object decoderMod {
  ...
  type BlockHeader = typings.ipldCar.apiMod.BlockHeader
  
  type BlockIndex = typings.ipldCar.apiMod.BlockIndex
  
  type BytesReader_ = BytesReader
  
  type CarDecoder = typings.ipldCar.codingMod.CarDecoder
  
  type CarHeader = typings.ipldCar.codingMod.CarHeader
  
  type CarV2FixedHeader = typings.ipldCar.codingMod.CarV2FixedHeader
