...
object distSrcWriterMod {
  
  @JSImport("@ipld/car/dist/src/writer", "CarWriter")
  @js.native
  ...
  @JSImport("@ipld/car/dist/src/writer", "__browser")
  @js.native
  val browser: `false` = js.native
  
  type BlockWriter = typings.ipldCar.distSrcApiMod.BlockWriter
  
  type CID = typings.multiformats.distTypesSrcCidMod.CID[Any, Double, Double, Version]
}
