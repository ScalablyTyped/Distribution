...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "3.0.0-b6cd5f",
  "org.scalablytyped" %%% "ionic__cli-framework-prompts" % "1.0.1-131dd0",
  "org.scalablytyped" %%% "ionic__utils-network" % "1.0.5-cec357",
  "org.scalablytyped" %%% "ionic__utils-object" % "1.0.5-7b238a",
  "org.scalablytyped" %%% "ionic__utils-subprocess" % "1.0.9-66734c",
