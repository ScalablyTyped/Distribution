...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "1.6.3-30023c",
  "org.scalablytyped" %%% "ionic__discover" % "1.0.13-52c815",
  "org.scalablytyped" %%% "ionic__utils-array" % "0.0.1-fdd8d0",
  "org.scalablytyped" %%% "ionic__utils-fs" % "1.2.0-689950",
  "org.scalablytyped" %%% "ionic__utils-network" % "0.0.8-54957e",
  ...
  "org.scalablytyped" %%% "opn" % "5.1-dt-20180214Z-de5c83",
  "org.scalablytyped" %%% "os-name" % "2.0-dt-20180214Z-fec9d6",
  ...
  "org.scalablytyped" %%% "tar" % "4.0-dt-20180214Z-d78a97",
