...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "1.6.3-5abf03",
  "org.scalablytyped" %%% "ionic__discover" % "1.0.13-074915",
  "org.scalablytyped" %%% "ionic__utils-array" % "0.0.1-9de01e",
  "org.scalablytyped" %%% "ionic__utils-fs" % "1.2.0-0b9db2",
  "org.scalablytyped" %%% "ionic__utils-network" % "0.0.8-e3ed1e",
  ...
  "org.scalablytyped" %%% "opn" % "5.1-dt-20180214Z-7ece76",
  "org.scalablytyped" %%% "os-name" % "2.0-dt-20180214Z-ba89bd",
  ...
  "org.scalablytyped" %%% "tar" % "4.0-dt-20180214Z-64c1f5",
