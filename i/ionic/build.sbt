...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "1.7.0-ea7f59",
  "org.scalablytyped" %%% "ionic__utils-network" % "0.0.8-e78363",
  "org.scalablytyped" %%% "ionic__utils-object" % "0.0.1-eb7496",
  "org.scalablytyped" %%% "ionic__utils-subprocess" % "0.1.0-8b0c55",
