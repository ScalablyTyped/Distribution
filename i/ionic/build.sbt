...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "1.6.3-f9d09e",
  "org.scalablytyped" %%% "ionic__discover" % "1.0.13-b8e42f",
  "org.scalablytyped" %%% "ionic__utils-array" % "0.0.1-fdd8d0",
  "org.scalablytyped" %%% "ionic__utils-fs" % "1.2.0-ebac8b",
  "org.scalablytyped" %%% "ionic__utils-network" % "0.0.8-ee349b",
  ...
  "org.scalablytyped" %%% "opn" % "5.1-dt-20180214Z-85c5ae",
  "org.scalablytyped" %%% "os-name" % "2.0-dt-20180214Z-f3813b",
  ...
  "org.scalablytyped" %%% "tar" % "4.0-dt-20180214Z-e3bd00",
