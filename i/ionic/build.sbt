...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "1.7.0-666506",
  "org.scalablytyped" %%% "ionic__discover" % "1.0.13-d65143",
  "org.scalablytyped" %%% "ionic__utils-array" % "0.0.1-9de01e",
  "org.scalablytyped" %%% "ionic__utils-fs" % "1.2.0-ab6092",
  "org.scalablytyped" %%% "ionic__utils-network" % "0.0.8-493395",
  ...
  "org.scalablytyped" %%% "opn" % "5.1-dt-20180214Z-2d0306",
  "org.scalablytyped" %%% "os-name" % "2.0-dt-20180214Z-044498",
  ...
  "org.scalablytyped" %%% "tar" % "4.0-dt-20180214Z-516e65",
