...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "ionic__cli-framework" % "1.1.1-2fda2f",
  "com.scalablytyped" %%% "ionic__discover" % "1.0.6-1f41f6",
  "com.scalablytyped" %%% "ionic__utils-fs" % "0.0.3-7b88ce",
  "com.scalablytyped" %%% "ionic__utils-network" % "0.0.3-1d828d",
  ...
  "com.scalablytyped" %%% "opn" % "5.1-dt-20180910Z-4997f1",
  "com.scalablytyped" %%% "os-name" % "2.0-dt-20180910Z-70da35",
  ...
  "com.scalablytyped" %%% "tar" % "4.0-dt-20180910Z-b0073d",
