...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "3.0.2-bb47e5",
  "org.scalablytyped" %%% "ionic__cli-framework-prompts" % "1.0.2-88744b",
  "org.scalablytyped" %%% "ionic__utils-network" % "1.0.5-cfa088",
  "org.scalablytyped" %%% "ionic__utils-object" % "1.0.5-f74e5d",
  "org.scalablytyped" %%% "ionic__utils-subprocess" % "1.0.10-9b0c68",
