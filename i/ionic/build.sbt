...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "3.0.1-81e75e",
  "org.scalablytyped" %%% "ionic__cli-framework-prompts" % "1.0.2-7d2aa1",
  "org.scalablytyped" %%% "ionic__utils-network" % "1.0.5-56d6b7",
  "org.scalablytyped" %%% "ionic__utils-object" % "1.0.5-9af50d",
  "org.scalablytyped" %%% "ionic__utils-subprocess" % "1.0.10-dd9e12",
