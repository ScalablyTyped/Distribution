...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "ionic__cli-framework" % "1.1.1-f6f5d8",
  "com.scalablytyped" %%% "ionic__discover" % "1.0.6-c89f77",
  "com.scalablytyped" %%% "ionic__utils-fs" % "0.0.3-63bcfd",
  "com.scalablytyped" %%% "ionic__utils-network" % "0.0.3-d5e15e",
  ...
  "com.scalablytyped" %%% "opn" % "5.1-dt-20180910Z-f36b1c",
  "com.scalablytyped" %%% "os-name" % "2.0-dt-20180910Z-b9d318",
  ...
  "com.scalablytyped" %%% "tar" % "4.0-dt-20180910Z-f9c568",
