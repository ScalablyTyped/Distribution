...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "1.7.0-f55709",
  "org.scalablytyped" %%% "ionic__utils-network" % "0.0.8-7e9fb2",
  "org.scalablytyped" %%% "ionic__utils-object" % "0.0.1-c08eea",
  "org.scalablytyped" %%% "ionic__utils-subprocess" % "0.1.0-b7be4d",
