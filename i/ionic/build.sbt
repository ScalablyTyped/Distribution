...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "1.7.0-a38647",
  "org.scalablytyped" %%% "ionic__utils-network" % "0.0.8-341c3d",
  "org.scalablytyped" %%% "ionic__utils-object" % "0.0.1-c08eea",
  "org.scalablytyped" %%% "ionic__utils-subprocess" % "0.1.0-0a55de",
