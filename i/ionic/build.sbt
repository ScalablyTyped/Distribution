...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "2.1.2-d673ed",
  "org.scalablytyped" %%% "ionic__utils-network" % "1.0.1-214eb8",
  "org.scalablytyped" %%% "ionic__utils-object" % "1.0.1-4c3f85",
  "org.scalablytyped" %%% "ionic__utils-subprocess" % "1.0.3-3a8af4",
