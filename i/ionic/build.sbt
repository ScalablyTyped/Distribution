...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "elementtree" % "0.1-dt-20180830Z-7d5571",
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "1.5.2-9e7974",
  "org.scalablytyped" %%% "ionic__discover" % "1.0.10-d35c64",
  "org.scalablytyped" %%% "ionic__utils-fs" % "0.0.7-e28736",
  "org.scalablytyped" %%% "ionic__utils-network" % "0.0.6-9627d0",
  ...
  "org.scalablytyped" %%% "opn" % "5.1-dt-20180214Z-fb75e6",
  "org.scalablytyped" %%% "os-name" % "2.0-dt-20180214Z-b38926",
  ...
  "org.scalablytyped" %%% "update-notifier" % "2.5-dt-20181023Z-a5205a",
