...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__cli-framework" % "1.7.0-3bab3e",
  "org.scalablytyped" %%% "ionic__discover" % "1.0.13-b40f2e",
  "org.scalablytyped" %%% "ionic__utils-array" % "0.0.1-9de01e",
  "org.scalablytyped" %%% "ionic__utils-fs" % "1.2.0-b65b11",
  "org.scalablytyped" %%% "ionic__utils-network" % "0.0.8-3fedf3",
  ...
  "org.scalablytyped" %%% "opn" % "5.1-dt-20180214Z-cf6ca1",
  "org.scalablytyped" %%% "os-name" % "2.0-dt-20180214Z-3ab913",
  ...
  "org.scalablytyped" %%% "tar" % "4.0-dt-20180214Z-9ba5aa",
