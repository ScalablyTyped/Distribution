...
import typings.ionic.libIntegrationsCordovaConfigMod.ConfigConfig
...
object libIntegrationsCordovaResourcesMod extends js.Object {
  ...
  def addResourcesToConfigXml(conf: ConfigConfig, platformList: js.Array[KnownPlatform], resourceJson: ResourcesConfig): js.Promise[Unit] = js.native
