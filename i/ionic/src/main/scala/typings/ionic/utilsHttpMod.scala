...
object utilsHttpMod {
  ...
  inline def download(req: SuperAgentRequest, ws: WritableStream[Any], hasProgress: Progress): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("download")(req.asInstanceOf[js.Any], ws.asInstanceOf[js.Any], hasProgress.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
