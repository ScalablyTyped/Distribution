...
@js.native
class CommandSchemaHelpFormatter ()
  extends typings.ionicCliFramework.helpMod.CommandSchemaHelpFormatter[ICommand, INamespace, CommandMetadata, CommandMetadataInput, CommandMetadataOption]
