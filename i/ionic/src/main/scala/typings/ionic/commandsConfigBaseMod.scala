...
object commandsConfigBaseMod {
  ...
  */
  ...
  object ConfigContext {
    ...
    inline def GlobalConfigContext(config: IConfig, force: Boolean, json: Boolean, root: Boolean): typings.ionic.commandsConfigBaseMod.GlobalConfigContext = {
      ...
      __obj.asInstanceOf[typings.ionic.commandsConfigBaseMod.GlobalConfigContext]
    }
    
    inline def ProjectConfigContext(config: BaseConfig[IProjectConfig], force: Boolean, json: Boolean, root: Boolean): typings.ionic.commandsConfigBaseMod.ProjectConfigContext = {
      ...
      __obj.asInstanceOf[typings.ionic.commandsConfigBaseMod.ProjectConfigContext]
    }
  }
