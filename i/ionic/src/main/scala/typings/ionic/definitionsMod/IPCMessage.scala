...
object IPCMessage {
  ...
  inline def TelemetryIPCMessage(data: Args): typings.ionic.definitionsMod.TelemetryIPCMessage = {
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("telemetry")
    __obj.asInstanceOf[typings.ionic.definitionsMod.TelemetryIPCMessage]
  }
  
  inline def UpdateCheckIPCMessage(): typings.ionic.definitionsMod.UpdateCheckIPCMessage = {
