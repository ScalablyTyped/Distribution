...
object ManagedStarterTemplate {
  ...
  @scala.inline
  implicit class ManagedStarterTemplateOps[Self <: ManagedStarterTemplate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: managed): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
