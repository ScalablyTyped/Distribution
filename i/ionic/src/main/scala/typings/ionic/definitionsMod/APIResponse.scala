...
object APIResponse {
  ...
  inline def APIResponseError(error: APIResponseErrorError, meta: APIResponseMeta): typings.ionic.definitionsMod.APIResponseError = {
  ...
  inline def APIResponseSuccess(data: APIResponseData, meta: APIResponseMeta): typings.ionic.definitionsMod.APIResponseSuccess = {
