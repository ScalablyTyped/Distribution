...
object AngularServeOptions {
  ...
  def apply(
    ...
    consolelogsPort: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(consolelogs)) __obj.updateDynamic("consolelogs")(consolelogs.get.asInstanceOf[js.Any])
    if (!js.isUndefined(consolelogsPort)) __obj.updateDynamic("consolelogsPort")(consolelogsPort.get.asInstanceOf[js.Any])
