...
object appScriptsMod {
  ...
  @scala.inline
  def importAppScripts(projectDir: String): js.Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("importAppScripts")(projectDir.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Any]]
}
