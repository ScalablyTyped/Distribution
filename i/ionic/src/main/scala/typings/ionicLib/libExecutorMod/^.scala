...
object ^ extends js.Object {
  def metadataToCmdOptsEnv(metadata: ionicLib.definitionsMod.CommandMetadata, cmdNameParts: js.Array[java.lang.String]): nodeLib.Map[ionicLib.definitionsMod.CommandMetadataOption, java.lang.String] = js.native
