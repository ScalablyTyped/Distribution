...
@js.native
object libProjectModMembers extends js.Object {
  def createProjectFromDetails(details: ProjectDetailsResult, deps: ProjectDeps): stdLib.Promise[ionicLib.definitionsMod.IProject] = js.native
  def createProjectFromDirectory(
    rootDirectory: java.lang.String,
    args: minimistLib.minimistMod.minimistNs.ParsedArgs,
    deps: ProjectDeps
  ): stdLib.Promise[js.UndefOr[ionicLib.definitionsMod.IProject]] = js.native
  def createProjectFromDirectory(
    rootDirectory: java.lang.String,
    args: minimistLib.minimistMod.minimistNs.ParsedArgs,
    deps: ProjectDeps,
  ...
  def findProjectDirectory(cwd: java.lang.String): stdLib.Promise[js.UndefOr[java.lang.String]] = js.native
