...
import typings.isotopeLayout.mod.Elements
import typings.isotopeLayout.mod.IsotopeOptions
...
object global {
  ...
  object Isotope {
    ...
    class Class protected ()
      extends StObject
         with typings.isotopeLayout.mod.Isotope {
    ...
    inline def data(element: String): typings.isotopeLayout.mod.Isotope = ^.asInstanceOf[js.Dynamic].applyDynamic("data")(element.asInstanceOf[js.Any]).asInstanceOf[typings.isotopeLayout.mod.Isotope]
    /**
      ...
      */
    inline def data(element: HTMLElement): typings.isotopeLayout.mod.Isotope = ^.asInstanceOf[js.Dynamic].applyDynamic("data")(element.asInstanceOf[js.Any]).asInstanceOf[typings.isotopeLayout.mod.Isotope]
  }
}
