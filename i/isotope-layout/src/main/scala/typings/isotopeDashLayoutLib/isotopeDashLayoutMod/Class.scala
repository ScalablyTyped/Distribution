...
class Class protected () extends Isotope {
  def this(elementOrSelector: java.lang.String, options: IsotopeOptions) = this()
  def this(elementOrSelector: stdLib.HTMLElement, options: IsotopeOptions) = this()
  /**
    ...
    */
  /* CompleteClass */
  override def addItems(elements: Elements): scala.Unit = js.native
  /**
    * Adds and lays out newly appended item elements to the end of the layout.
    * @param elements Element, jQuery Object, NodeList, or Array of Elements
    */
  /* CompleteClass */
  override def appended(elements: Elements): scala.Unit = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def arrange(options: IsotopeOptions): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def hideItemElements(elements: Elements): scala.Unit = js.native
  /**
    * Appends elements into container element, adds elements as items, and arranges items with filtering and sorting.
    * @param elements Element, jQuery Object, NodeList, or Array of Elements
    */
  /* CompleteClass */
  override def insert(elements: Elements): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def prepended(elements: Elements): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def remove(elements: Elements): scala.Unit = js.native
  /**
    * Reveals hidden items.
    * @param elements Element, jQuery Object, NodeList, or Array of Elements
    */
  /* CompleteClass */
  override def revealItemElements(elements: Elements): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def stamp(elements: Elements): scala.Unit = js.native
  /**
    * Un-stamps elements in the layout, so that Isotope will no longer layout item elements around them.
    * @param elements Element, jQuery Object, NodeList, or Array of Elements
    */
  /* CompleteClass */
  override def unstamp(elements: Elements): scala.Unit = js.native
  /**
    * Updates sort data
    * @param elements Element, jQuery Object, NodeList, or Array of Elements
    */
  /* CompleteClass */
  override def updateSortData(elements: Elements): scala.Unit = js.native
}
