...
import typings.immer.proxyMod.ProxyState
...
object internalMod {
  ...
  @js.native
  open class Immer ()
    extends typings.immer.immerClassMod.Immer {
    def this(config: AutoFreeze) = this()
  }
  
  @JSImport("immer/dist/internal", "NOTHING")
  @js.native
  val NOTHING_ : typings.immer.envMod.Nothing = js.native
  
  @JSImport("immer/dist/internal", "Nothing")
  @js.native
  open class Nothing ()
    extends typings.immer.envMod.Nothing
  
  inline def createProxy[T /* <: Objectish */](immer: typings.immer.immerClassMod.Immer, value: T): Drafted[T, ImmerState] = (^.asInstanceOf[js.Dynamic].applyDynamic("createProxy")(immer.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Drafted[T, ImmerState]]
  inline def createProxy[T /* <: Objectish */](immer: typings.immer.immerClassMod.Immer, value: T, parent: ImmerState): Drafted[T, ImmerState] = (^.asInstanceOf[js.Dynamic].applyDynamic("createProxy")(immer.asInstanceOf[js.Any], value.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Drafted[T, ImmerState]]
