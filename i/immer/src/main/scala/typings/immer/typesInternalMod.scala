...
object typesInternalMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.immer.pluginsMod.ES5ObjectState
    - typings.immer.pluginsMod.ES5ArrayState
    - typings.immer.pluginsMod.MapState
    - typings.immer.pluginsMod.SetState
  */
  ...
  object ImmerState {
    ...
    inline def ES5ArrayState(
      ...
      __obj.asInstanceOf[typings.immer.pluginsMod.ES5ArrayState]
    }
    ...
    inline def ES5ObjectState(
      ...
      __obj.asInstanceOf[typings.immer.pluginsMod.ES5ObjectState]
    }
    ...
    inline def MapState(
      ...
      __obj.asInstanceOf[typings.immer.pluginsMod.MapState]
    }
    ...
    inline def SetState(
      ...
      __obj.asInstanceOf[typings.immer.pluginsMod.SetState]
    }
  }
