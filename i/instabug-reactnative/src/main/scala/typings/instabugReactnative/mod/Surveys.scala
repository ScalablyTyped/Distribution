...
object Surveys {
  ...
  inline def onDismissCallback(didDismissSurveyHandler: js.Function0[Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onDismissCallback")(didDismissSurveyHandler.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def onShowCallback(willShowSurveyHandler: js.Function0[Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onShowCallback")(willShowSurveyHandler.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def setThresholdForReshowingSurveyAfterDismiss(sessionCount: Double, daysCount: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setThresholdForReshowingSurveyAfterDismiss")(sessionCount.asInstanceOf[js.Any], daysCount.asInstanceOf[js.Any])).asInstanceOf[Unit]
