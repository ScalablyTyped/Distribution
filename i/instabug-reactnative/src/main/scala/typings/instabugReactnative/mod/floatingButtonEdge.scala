...
object floatingButtonEdge extends StObject {
  ...
  /* 0 */ val left: typings.instabugReactnative.mod.floatingButtonEdge.left & Double = js.native
  
  @js.native
  sealed trait right
    extends StObject
       with floatingButtonEdge
  /* 1 */ val right: typings.instabugReactnative.mod.floatingButtonEdge.right & Double = js.native
}
