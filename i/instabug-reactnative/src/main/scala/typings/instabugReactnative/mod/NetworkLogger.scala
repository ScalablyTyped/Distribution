...
object NetworkLogger {
  ...
  inline def setNetworkDataObfuscationHandler(handler: js.Function0[Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setNetworkDataObfuscationHandler")(handler.asInstanceOf[js.Any]).asInstanceOf[Unit]
