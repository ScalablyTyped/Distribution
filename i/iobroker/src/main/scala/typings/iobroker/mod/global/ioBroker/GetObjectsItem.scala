...
object GetObjectsItem {
  ...
  @scala.inline
  implicit class GetObjectsItemOps[Self <: GetObjectsItem[_], /* <: typings.iobroker.mod.global.ioBroker.BaseObject */ T] (val x: Self with GetObjectsItem[T]) extends AnyVal {
    @scala.inline
