...
/* Rewritten from type alias, can be one of: 
  - typings.iobroker.iobrokerMod._Global_.ioBroker.PartialStateObject
  - typings.iobroker.iobrokerMod._Global_.ioBroker.PartialChannelObject
  - typings.iobroker.iobrokerMod._Global_.ioBroker.PartialDeviceObject
  - typings.iobroker.iobrokerMod._Global_.ioBroker.PartialOtherObject
*/
