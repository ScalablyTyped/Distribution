...
import typings.iobroker.anon.PartialMetaCommon
...
object PartialMetaObject {
  ...
  @scala.inline
  implicit class PartialMetaObjectOps[Self <: PartialMetaObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommon(value: PartialMetaCommon): Self = this.set("common", value.asInstanceOf[js.Any])
