...
import typings.iobroker.anon.PartialUserCommon
...
trait PartialUserObject
  ...
  var common: js.UndefOr[PartialUserCommon] = js.undefined
  ...
  var `type`: js.UndefOr[user] = js.undefined
  
  var user: js.UndefOr[String] = js.undefined
}
object PartialUserObject {
  
  inline def apply(): PartialUserObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialUserObject]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialUserObject] (val x: Self) extends AnyVal {
    
    inline def setAcl(value: ObjectACL): Self = StObject.set(x, "acl", value.asInstanceOf[js.Any])
    
    inline def setAclUndefined: Self = StObject.set(x, "acl", js.undefined)
    
    inline def setCommon(value: PartialUserCommon): Self = StObject.set(x, "common", value.asInstanceOf[js.Any])
