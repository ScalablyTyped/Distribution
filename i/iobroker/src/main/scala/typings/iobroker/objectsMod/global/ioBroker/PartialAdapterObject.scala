...
@js.native
trait PartialAdapterObject extends PartialObject {
  
  var _id: js.UndefOr[String] = js.native
  
  var acl: js.UndefOr[ObjectACL] = js.native
  
  var common: js.UndefOr[PartialAdapterCommon] = js.native
  ...
  var `type`: js.UndefOr[adapter] = js.native
...
object PartialAdapterObject {
  ...
  @scala.inline
  implicit class PartialAdapterObjectOps[Self <: PartialAdapterObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommon(value: PartialAdapterCommon): Self = this.set("common", value.asInstanceOf[js.Any])
