...
type Object = typings.iobroker.objectsMod.global.ioBroker.AnyObject & typings.iobroker.anon.Common
...
type SettableObjectWorker[T] = (typings.std.Omit[T, typings.iobroker.iobrokerStrings._id | typings.iobroker.iobrokerStrings.acl]) & typings.iobroker.anon.Acl[T]
