...
object PartialEnumObject {
  ...
  @scala.inline
  implicit class PartialEnumObjectOps[Self <: PartialEnumObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommon(value: PartialEnumCommon): Self = this.set("common", value.asInstanceOf[js.Any])
