...
/* Rewritten from type alias, can be one of: 
  - typings.iobroker.iobrokerStrings.none
  - typings.iobroker.iobrokerStrings.daemon
...
object InstanceMode {
  ...
  @scala.inline
  def once: typings.iobroker.iobrokerStrings.once = "once".asInstanceOf[typings.iobroker.iobrokerStrings.once]
  
  @scala.inline
  def schedule: typings.iobroker.iobrokerStrings.schedule = "schedule".asInstanceOf[typings.iobroker.iobrokerStrings.schedule]
  
  @scala.inline
  def subscribe: typings.iobroker.iobrokerStrings.subscribe = "subscribe".asInstanceOf[typings.iobroker.iobrokerStrings.subscribe]
}
