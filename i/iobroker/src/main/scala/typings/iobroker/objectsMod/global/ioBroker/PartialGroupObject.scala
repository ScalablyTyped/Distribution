...
object PartialGroupObject {
  ...
  @scala.inline
  implicit class PartialGroupObjectOps[Self <: PartialGroupObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommon(value: PartialGroupCommon): Self = this.set("common", value.asInstanceOf[js.Any])
