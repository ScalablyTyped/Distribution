...
object PartialStateObject {
  ...
  @scala.inline
  implicit class PartialStateObjectMutableBuilder[Self <: PartialStateObject] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAcl(value: PartialStateACL): Self = StObject.set(x, "acl", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAclUndefined: Self = StObject.set(x, "acl", js.undefined)
    
    @scala.inline
    def setCommon(value: PartialStateCommon): Self = StObject.set(x, "common", value.asInstanceOf[js.Any])
