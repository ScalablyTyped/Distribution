...
import typings.iobroker.anon.PartialScriptCommon
...
/* Inlined parent std.Partial<std.Omit<iobroker.iobroker/objects.<global>.ioBroker.ScriptObject, 'common'>> */
@js.native
trait PartialScriptObject extends PartialObject {
  
  var _id: js.UndefOr[String] = js.native
  
  var acl: js.UndefOr[ObjectACL] = js.native
  
  var common: js.UndefOr[PartialScriptCommon] = js.native
  ...
  var `type`: js.UndefOr[script] = js.native
  
  var user: js.UndefOr[String] = js.native
}
object PartialScriptObject {
  
  @scala.inline
  def apply(): PartialScriptObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialScriptObject]
  }
  
  @scala.inline
  implicit class PartialScriptObjectMutableBuilder[Self <: PartialScriptObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommon(value: PartialScriptCommon): Self = StObject.set(x, "common", value.asInstanceOf[js.Any])
