...
trait PartialScriptObject
  ...
  var common: js.UndefOr[PartialScriptCommon] = js.undefined
  ...
  var `type`: js.UndefOr[script] = js.undefined
  
  var user: js.UndefOr[String] = js.undefined
}
object PartialScriptObject {
  
  inline def apply(): PartialScriptObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialScriptObject]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialScriptObject] (val x: Self) extends AnyVal {
    
    inline def setAcl(value: ObjectACL): Self = StObject.set(x, "acl", value.asInstanceOf[js.Any])
    
    inline def setAclUndefined: Self = StObject.set(x, "acl", js.undefined)
    
    inline def setCommon(value: PartialScriptCommon): Self = StObject.set(x, "common", value.asInstanceOf[js.Any])
