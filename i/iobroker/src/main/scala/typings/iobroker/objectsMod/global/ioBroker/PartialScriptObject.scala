...
object PartialScriptObject {
  ...
  @scala.inline
  implicit class PartialScriptObjectOps[Self <: PartialScriptObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCommon(value: PartialScriptCommon): Self = this.set("common", value.asInstanceOf[js.Any])
