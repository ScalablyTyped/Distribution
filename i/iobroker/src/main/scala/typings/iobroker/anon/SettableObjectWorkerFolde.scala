...
/* Inlined iobroker.iobroker.<global>.ioBroker.SettableObjectWorker<iobroker.iobroker.<global>.ioBroker.FolderObject> */
@js.native
trait SettableObjectWorkerFolde extends SettableObject {
  ...
  var `type`: folder = js.native
}

object SettableObjectWorkerFolde {
  @scala.inline
  def apply(common: OtherCommon, native: Record[String, ObjectField], `type`: folder): SettableObjectWorkerFolde = {
    val __obj = js.Dynamic.literal(common = common.asInstanceOf[js.Any], native = native.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[SettableObjectWorkerFolde]
  }
  @scala.inline
  implicit class SettableObjectWorkerFoldeOps[Self <: SettableObjectWorkerFolde] (val x: Self) extends AnyVal {
    @scala.inline
