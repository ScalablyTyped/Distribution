...
package object immutabilityDashHelperLib {
  ...
  type ObjectSpec[T, C /* <: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify CustomCommands<object> */ js.Any */] = Anon_Toggle[T] | Anon_Unset[T] | Anon_Merge[T] | (immutabilityDashHelperLib.immutabilityDashHelperLibStrings.ObjectSpec with js.Any)
