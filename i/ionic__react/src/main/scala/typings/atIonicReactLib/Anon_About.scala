...
trait Anon_About extends js.Object {
  ...
  var UNSAFE_componentWillReceiveProps: js.UndefOr[
    js.Function2[
      /* nextProps */ Anon_ChildrenEvent with (stdLib.Pick[
        atIonicCoreLib.distTypesComponentsMod.LocalJSXNs.IonModal, 
  ...
  var controller: atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonModalElement = js.native
  ...
  val props: Anon_ChildrenEvent with (stdLib.Pick[
    atIonicCoreLib.distTypesComponentsMod.LocalJSXNs.IonModal, 
    /* import warning: LimitUnionLength.enterTypeRef Was union type with length 179 */ js.Any
  ]) with atIonicReactLib.distTypesComponentsReactPropsMod.ReactProps with Anon_ChildrenReactNode = js.native
