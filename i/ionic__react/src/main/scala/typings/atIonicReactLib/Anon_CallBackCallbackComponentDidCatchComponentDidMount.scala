...
trait Anon_CallBackCallbackComponentDidCatchComponentDidMount extends js.Object {
  ...
  var UNSAFE_componentWillReceiveProps: js.UndefOr[
    js.Function2[
      /* nextProps */ (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonToastAttributes */ js.Any) with Anon_Event, 
      /* nextContext */ js.Any, 
      scala.Unit
    ]
  ] = js.native
  ...
  var getSnapshotBeforeUpdate: js.UndefOr[
    js.Function2[
      /* prevProps */ (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonToastAttributes */ js.Any) with Anon_Event, 
      /* prevState */ js.Object, 
      _
    ]
  ] = js.native
  var id: java.lang.String = js.native
  val props: Anon_ChildrenReactNode with (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonToastAttributes */ js.Any) with Anon_Event = js.native
  ...
  def setState[K /* <: scala.Nothing */](
    state: js.Function2[
      /* prevState */ js.Object, 
      /* props */ (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Components.IonToastAttributes */ js.Any) with Anon_Event, 
