...
trait Anon_CallBackCallbackComponentDidCatchComponentDidMount extends js.Object {
  ...
  var UNSAFE_componentWillReceiveProps: js.UndefOr[
    js.Function2[
      /* nextProps */ atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonToastAttributes with Anon_Event, 
      /* nextContext */ js.Any, 
      scala.Unit
    ]
  ] = js.native
  ...
  var getSnapshotBeforeUpdate: js.UndefOr[
    js.Function2[
      /* prevProps */ atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonToastAttributes with Anon_Event, 
      /* prevState */ js.Object, 
      _
    ]
  ] = js.native
  var id: java.lang.String = js.native
  val props: Anon_ChildrenReactNode with atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonToastAttributes with Anon_Event = js.native
  ...
  def setState[K /* <: scala.Nothing */](
    state: js.Function2[
      /* prevState */ js.Object, 
      /* props */ atIonicCoreLib.distTypesComponentsMod.ComponentsNs.IonToastAttributes with Anon_Event, 
