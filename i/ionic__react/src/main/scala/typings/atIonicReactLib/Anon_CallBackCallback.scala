...
trait Anon_CallBackCallback extends js.Object {
  ...
  var UNSAFE_componentWillReceiveProps: js.UndefOr[
    js.Function2[
      /* nextProps */ atIonicCoreLib.distTypesComponentsMod.LocalJSXNs.IonAlert with Anon_Event, 
      /* nextContext */ js.Any, 
      scala.Unit
    ]
  ] = js.native
  ...
  var controller: atIonicCoreLib.distTypesComponentsMod.Global.HTMLIonAlertElement = js.native
  var getSnapshotBeforeUpdate: js.UndefOr[
    js.Function2[
      /* prevProps */ atIonicCoreLib.distTypesComponentsMod.LocalJSXNs.IonAlert with Anon_Event, 
      /* prevState */ js.Object, 
      _
    ]
  ] = js.native
  var id: java.lang.String = js.native
  val props: atIonicCoreLib.distTypesComponentsMod.LocalJSXNs.IonAlert with Anon_Event with Anon_ChildrenReactNode = js.native
  ...
  def componentDidUpdate(prevProps: atIonicCoreLib.distTypesComponentsMod.LocalJSXNs.IonAlert with Anon_Event): js.Promise[scala.Unit] = js.native
  ...
  def present(prevProps: atIonicCoreLib.distTypesComponentsMod.LocalJSXNs.IonAlert with Anon_Event): js.Promise[scala.Unit] = js.native
  def render(): scala.Null = js.native
  def setState[K /* <: scala.Nothing */](
    state: js.Function2[
      /* prevState */ js.Object, 
      /* props */ atIonicCoreLib.distTypesComponentsMod.LocalJSXNs.IonAlert with Anon_Event, 
