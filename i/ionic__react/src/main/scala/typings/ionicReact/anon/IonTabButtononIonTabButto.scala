...
trait IonTabButtononIonTabButto extends StObject {
  ...
  var onIonTabButtonClick: js.UndefOr[js.Function1[/* e */ CustomEvent[_], Unit]] = js.native
...
object IonTabButtononIonTabButto {
  ...
  implicit class IonTabButtononIonTabButtoMutableBuilder[Self <: IonTabButtononIonTabButto] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnIonTabButtonClick(value: /* e */ CustomEvent[_] => Unit): Self = StObject.set(x, "onIonTabButtonClick", js.Any.fromFunction1(value))
