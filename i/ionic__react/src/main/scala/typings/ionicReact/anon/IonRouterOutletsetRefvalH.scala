...
object IonRouterOutletsetRefvalH {
  ...
  inline def apply(): IonRouterOutletsetRefvalH = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IonRouterOutletsetRefvalH]
  }
  
  extension [Self <: IonRouterOutletsetRefvalH](x: Self) {
    ...
    inline def setSetRef(value: /* val */ HTMLIonRouterOutletElement => Unit): Self = StObject.set(x, "setRef", js.Any.fromFunction1(value))
