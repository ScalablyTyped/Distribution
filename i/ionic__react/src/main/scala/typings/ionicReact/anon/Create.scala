...
object Create {
  ...
  @scala.inline
  implicit class CreateOps[Self <: Create[_, _], /* <: js.Object */ OptionsType, /* <: typings.ionicReact.createControllerComponentMod.OverlayBase */ OverlayType] (val x: Self with (Create[OptionsType, OverlayType])) extends AnyVal {
    @scala.inline
