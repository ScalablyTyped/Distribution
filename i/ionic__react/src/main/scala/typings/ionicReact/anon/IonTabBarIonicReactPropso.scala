...
object IonTabBarIonicReactPropso {
  ...
  implicit class IonTabBarIonicReactPropsoMutableBuilder[Self <: IonTabBarIonicReactPropso] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSlot(value: (js.UndefOr[bottom | top]) & js.UndefOr[String]): Self = StObject.set(x, "slot", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStyle(value: js.UndefOr[StringDictionary[js.Any]] & js.UndefOr[StringDictionary[String]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
