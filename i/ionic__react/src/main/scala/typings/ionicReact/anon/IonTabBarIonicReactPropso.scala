...
trait IonTabBarIonicReactPropso extends js.Object {
  ...
  var slot: js.UndefOr[(js.UndefOr[bottom | top]) with String] = js.undefined
...
object IonTabBarIonicReactPropso {
  ...
  def apply(
    ...
    slot: (js.UndefOr[bottom | top]) with String = null,
