...
object IonDatetimePickHTMLAttrib {
  ...
  @scala.inline
  def apply(placeholder: (js.UndefOr[String | Null]) & js.UndefOr[String]): IonDatetimePickHTMLAttrib = {
  ...
  implicit class IonDatetimePickHTMLAttribMutableBuilder[Self <: IonDatetimePickHTMLAttrib] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPlaceholder(value: (js.UndefOr[String | Null]) & js.UndefOr[String]): Self = StObject.set(x, "placeholder", value.asInstanceOf[js.Any])
