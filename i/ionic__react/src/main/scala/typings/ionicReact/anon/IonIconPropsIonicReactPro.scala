...
object IonIconPropsIonicReactPro {
  
  @scala.inline
  def apply(): IonIconPropsIonicReactPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IonIconPropsIonicReactPro]
  }
  
  @scala.inline
  implicit class IonIconPropsIonicReactProMutableBuilder[Self <: IonIconPropsIonicReactPro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: Ref[HTMLIonIconElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLIonIconElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
