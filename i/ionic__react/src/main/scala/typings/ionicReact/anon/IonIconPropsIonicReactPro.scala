...
@js.native
trait IonIconPropsIonicReactPro extends js.Object {
...
object IonIconPropsIonicReactPro {
  ...
  @scala.inline
  implicit class IonIconPropsIonicReactProOps[Self <: IonIconPropsIonicReactPro] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLIonIconElement | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: Ref[HTMLIonIconElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
