...
object IonIconPropsIonicReactPro {
  ...
  inline def apply(): IonIconPropsIonicReactPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IonIconPropsIonicReactPro]
  }
  
  extension [Self <: IonIconPropsIonicReactPro](x: Self) {
    ...
    inline def setRef(value: Ref[HTMLIonIconElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: /* instance */ HTMLIonIconElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
