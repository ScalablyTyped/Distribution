...
object childrenReactNodeforwardeAnimated {
  ...
  @scala.inline
  implicit class childrenReactNodeforwardeAnimatedMutableBuilder[Self <: childrenReactNodeforwardeAnimated] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedRef(value: RefObject[HTMLIonPopoverElement]): Self = StObject.set(x, "forwardedRef", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRef(value: Ref[HTMLIonPopoverElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLIonPopoverElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
