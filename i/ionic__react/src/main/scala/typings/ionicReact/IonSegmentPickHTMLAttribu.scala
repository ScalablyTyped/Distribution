...
trait IonSegmentPickHTMLAttribu extends js.Object {
  ...
  var onAbort: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onAbortCapture: js.Any
  var onAnimationEnd: js.UndefOr[AnimationEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onAnimationEndCapture: js.Any
  var onAnimationIteration: js.UndefOr[AnimationEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onAnimationIterationCapture: js.Any
  var onAnimationStart: js.UndefOr[AnimationEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onAnimationStartCapture: js.Any
  var onAuxClick: js.UndefOr[MouseEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onAuxClickCapture: js.Any
  var onBeforeInput: js.UndefOr[FormEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onBeforeInputCapture: js.Any
  var onBlur: js.UndefOr[FocusEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onBlurCapture: js.Any
  var onCanPlay: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onCanPlayCapture: js.Any
  var onCanPlayThrough: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onCanPlayThroughCapture: js.Any
  var onChange: js.UndefOr[FormEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onChangeCapture: js.Any
  var onClick: js.UndefOr[MouseEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onClickCapture: js.Any
  var onCompositionEnd: js.UndefOr[CompositionEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onCompositionEndCapture: js.Any
  var onCompositionStart: js.UndefOr[CompositionEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onCompositionStartCapture: js.Any
  var onCompositionUpdate: js.UndefOr[CompositionEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onCompositionUpdateCapture: js.Any
  var onContextMenu: js.UndefOr[MouseEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onContextMenuCapture: js.Any
  var onCopy: js.UndefOr[ClipboardEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onCopyCapture: js.Any
  var onCut: js.UndefOr[ClipboardEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onCutCapture: js.Any
  var onDoubleClick: js.UndefOr[MouseEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onDoubleClickCapture: js.Any
  var onDrag: js.UndefOr[DragEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onDragCapture: js.Any
  var onDragEnd: js.UndefOr[DragEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onDragEndCapture: js.Any
  var onDragEnter: js.UndefOr[DragEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onDragEnterCapture: js.Any
  var onDragExit: js.UndefOr[DragEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onDragExitCapture: js.Any
  var onDragLeave: js.UndefOr[DragEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onDragLeaveCapture: js.Any
  var onDragOver: js.UndefOr[DragEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onDragOverCapture: js.Any
  var onDragStart: js.UndefOr[DragEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onDragStartCapture: js.Any
  var onDrop: js.UndefOr[DragEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onDropCapture: js.Any
  var onDurationChange: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onDurationChangeCapture: js.Any
  var onEmptied: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onEmptiedCapture: js.Any
  var onEncrypted: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onEncryptedCapture: js.Any
  var onEnded: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onEndedCapture: js.Any
  var onError: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onErrorCapture: js.Any
  var onFocus: js.UndefOr[FocusEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onFocusCapture: js.Any
  var onGotPointerCapture: js.Any
  var onGotPointerCaptureCapture: js.Any
  var onInput: js.UndefOr[FormEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onInputCapture: js.Any
  var onInvalid: js.UndefOr[FormEventHandler[HTMLIonSegmentElement]] = js.undefined
  ...
  var onKeyDown: js.UndefOr[KeyboardEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onKeyDownCapture: js.Any
  var onKeyPress: js.UndefOr[KeyboardEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onKeyPressCapture: js.Any
  var onKeyUp: js.UndefOr[KeyboardEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onKeyUpCapture: js.Any
  var onLoad: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onLoadCapture: js.Any
  var onLoadStart: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onLoadStartCapture: js.Any
  var onLoadedData: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onLoadedDataCapture: js.Any
  var onLoadedMetadata: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onLoadedMetadataCapture: js.Any
  var onLostPointerCapture: js.Any
  var onLostPointerCaptureCapture: js.Any
  var onMouseDown: js.UndefOr[MouseEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onMouseDownCapture: js.Any
  var onMouseEnter: js.UndefOr[MouseEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onMouseLeave: js.UndefOr[MouseEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onMouseMove: js.UndefOr[MouseEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onMouseMoveCapture: js.Any
  var onMouseOut: js.UndefOr[MouseEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onMouseOutCapture: js.Any
  var onMouseOver: js.UndefOr[MouseEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onMouseOverCapture: js.Any
  var onMouseUp: js.UndefOr[MouseEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onMouseUpCapture: js.Any
  var onPaste: js.UndefOr[ClipboardEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPasteCapture: js.Any
  var onPause: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPauseCapture: js.Any
  var onPlay: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPlayCapture: js.Any
  var onPlaying: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPlayingCapture: js.Any
  var onPointerCancel: js.UndefOr[PointerEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPointerCancelCapture: js.Any
  var onPointerDown: js.UndefOr[PointerEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPointerDownCapture: js.Any
  var onPointerEnter: js.UndefOr[PointerEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPointerEnterCapture: js.Any
  var onPointerLeave: js.UndefOr[PointerEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPointerLeaveCapture: js.Any
  var onPointerMove: js.UndefOr[PointerEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPointerMoveCapture: js.Any
  var onPointerOut: js.UndefOr[PointerEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPointerOutCapture: js.Any
  var onPointerOver: js.UndefOr[PointerEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPointerOverCapture: js.Any
  var onPointerUp: js.UndefOr[PointerEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onPointerUpCapture: js.Any
  var onProgress: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onProgressCapture: js.Any
  var onRateChange: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onRateChangeCapture: js.Any
  var onReset: js.UndefOr[FormEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onResetCapture: js.Any
  var onScroll: js.UndefOr[UIEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onScrollCapture: js.Any
  var onSeeked: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onSeekedCapture: js.Any
  var onSeeking: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onSeekingCapture: js.Any
  var onSelect: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onSelectCapture: js.Any
  var onStalled: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onStalledCapture: js.Any
  var onSubmit: js.UndefOr[FormEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onSubmitCapture: js.Any
  var onSuspend: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onSuspendCapture: js.Any
  var onTimeUpdate: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onTimeUpdateCapture: js.Any
  var onTouchCancel: js.UndefOr[TouchEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onTouchCancelCapture: js.Any
  var onTouchEnd: js.UndefOr[TouchEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onTouchEndCapture: js.Any
  var onTouchMove: js.UndefOr[TouchEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onTouchMoveCapture: js.Any
  var onTouchStart: js.UndefOr[TouchEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onTouchStartCapture: js.Any
  var onTransitionEnd: js.UndefOr[TransitionEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onTransitionEndCapture: js.Any
  var onVolumeChange: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onVolumeChangeCapture: js.Any
  var onWaiting: js.UndefOr[ReactEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onWaitingCapture: js.Any
  var onWheel: js.UndefOr[WheelEventHandler[HTMLIonSegmentElement]] = js.undefined
  var onWheelCapture: js.Any
  var placeholder: js.UndefOr[String] = js.undefined
  var prefix: js.UndefOr[String] = js.undefined
  var property: js.UndefOr[String] = js.undefined
  var radioGroup: js.UndefOr[String] = js.undefined
  var ref: js.UndefOr[Ref[HTMLIonSegmentElement]] = js.undefined
...
object IonSegmentPickHTMLAttribu {
  @scala.inline
  def apply(
    ...
    lang: String = null,
    mode: ios | md = null,
    onAbort: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onAnimationEnd: AnimationEvent[HTMLIonSegmentElement] => Unit = null,
    onAnimationIteration: AnimationEvent[HTMLIonSegmentElement] => Unit = null,
    onAnimationStart: AnimationEvent[HTMLIonSegmentElement] => Unit = null,
    onAuxClick: MouseEvent[HTMLIonSegmentElement, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[HTMLIonSegmentElement] => Unit = null,
    onBlur: FocusEvent[HTMLIonSegmentElement] => Unit = null,
    onCanPlay: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onChange: FormEvent[HTMLIonSegmentElement] => Unit = null,
    onClick: MouseEvent[HTMLIonSegmentElement, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[HTMLIonSegmentElement] => Unit = null,
    onCompositionStart: CompositionEvent[HTMLIonSegmentElement] => Unit = null,
    onCompositionUpdate: CompositionEvent[HTMLIonSegmentElement] => Unit = null,
    onContextMenu: MouseEvent[HTMLIonSegmentElement, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[HTMLIonSegmentElement] => Unit = null,
    onCut: ClipboardEvent[HTMLIonSegmentElement] => Unit = null,
    onDoubleClick: MouseEvent[HTMLIonSegmentElement, NativeMouseEvent] => Unit = null,
    onDrag: DragEvent[HTMLIonSegmentElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonSegmentElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonSegmentElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonSegmentElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonSegmentElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonSegmentElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonSegmentElement] => Unit = null,
    onDrop: DragEvent[HTMLIonSegmentElement] => Unit = null,
    onDurationChange: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onEmptied: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onEnded: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onError: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onFocus: FocusEvent[HTMLIonSegmentElement] => Unit = null,
    onInput: FormEvent[HTMLIonSegmentElement] => Unit = null,
    onInvalid: FormEvent[HTMLIonSegmentElement] => Unit = null,
    onIonChange: /* event */ CustomEvent[SegmentChangeEventDetail] => Unit = null,
    onKeyDown: KeyboardEvent[HTMLIonSegmentElement] => Unit = null,
    onKeyPress: KeyboardEvent[HTMLIonSegmentElement] => Unit = null,
    onKeyUp: KeyboardEvent[HTMLIonSegmentElement] => Unit = null,
    onLoad: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onMouseDown: MouseEvent[HTMLIonSegmentElement, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[HTMLIonSegmentElement, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[HTMLIonSegmentElement, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[HTMLIonSegmentElement, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[HTMLIonSegmentElement, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[HTMLIonSegmentElement, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[HTMLIonSegmentElement, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[HTMLIonSegmentElement] => Unit = null,
    onPause: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onPlay: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onPlaying: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onPointerCancel: PointerEvent[HTMLIonSegmentElement] => Unit = null,
    onPointerDown: PointerEvent[HTMLIonSegmentElement] => Unit = null,
    onPointerEnter: PointerEvent[HTMLIonSegmentElement] => Unit = null,
    onPointerLeave: PointerEvent[HTMLIonSegmentElement] => Unit = null,
    onPointerMove: PointerEvent[HTMLIonSegmentElement] => Unit = null,
    onPointerOut: PointerEvent[HTMLIonSegmentElement] => Unit = null,
    onPointerOver: PointerEvent[HTMLIonSegmentElement] => Unit = null,
    onPointerUp: PointerEvent[HTMLIonSegmentElement] => Unit = null,
    onProgress: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onRateChange: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onReset: FormEvent[HTMLIonSegmentElement] => Unit = null,
    onScroll: UIEvent[HTMLIonSegmentElement, NativeUIEvent] => Unit = null,
    onSeeked: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onSeeking: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onSelect: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onStalled: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onSubmit: FormEvent[HTMLIonSegmentElement] => Unit = null,
    onSuspend: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onTouchCancel: TouchEvent[HTMLIonSegmentElement] => Unit = null,
    onTouchEnd: TouchEvent[HTMLIonSegmentElement] => Unit = null,
    onTouchMove: TouchEvent[HTMLIonSegmentElement] => Unit = null,
    onTouchStart: TouchEvent[HTMLIonSegmentElement] => Unit = null,
    onTransitionEnd: TransitionEvent[HTMLIonSegmentElement] => Unit = null,
    onVolumeChange: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onWaiting: SyntheticEvent[HTMLIonSegmentElement, Event_] => Unit = null,
    onWheel: WheelEvent[HTMLIonSegmentElement] => Unit = null,
    placeholder: String = null,
    prefix: String = null,
    property: String = null,
    radioGroup: String = null,
    ref: Ref[HTMLIonSegmentElement] = null,
    ...
    __obj.asInstanceOf[IonSegmentPickHTMLAttribu]
  }
}
