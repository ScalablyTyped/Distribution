...
import typings.ionicReact.ionicReactStrings.fixed
import typings.ionicReact.ionicReactStrings.floating
...
import typings.ionicReact.ionicReactStrings.stacked
...
object IonLabelPickHTMLAttribute {
  ...
  def apply(
    ...
    lang: String = null,
    mode: ios | md = null,
    onAbort: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onAnimationEnd: AnimationEvent[HTMLIonLabelElement] => Unit = null,
    onAnimationIteration: AnimationEvent[HTMLIonLabelElement] => Unit = null,
    onAnimationStart: AnimationEvent[HTMLIonLabelElement] => Unit = null,
    onAuxClick: MouseEvent[HTMLIonLabelElement, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[HTMLIonLabelElement] => Unit = null,
    onBlur: FocusEvent[HTMLIonLabelElement] => Unit = null,
    onCanPlay: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onChange: FormEvent[HTMLIonLabelElement] => Unit = null,
    onClick: MouseEvent[HTMLIonLabelElement, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[HTMLIonLabelElement] => Unit = null,
    onCompositionStart: CompositionEvent[HTMLIonLabelElement] => Unit = null,
    onCompositionUpdate: CompositionEvent[HTMLIonLabelElement] => Unit = null,
    onContextMenu: MouseEvent[HTMLIonLabelElement, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[HTMLIonLabelElement] => Unit = null,
    onCut: ClipboardEvent[HTMLIonLabelElement] => Unit = null,
    onDoubleClick: MouseEvent[HTMLIonLabelElement, NativeMouseEvent] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onEmptied: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onEnded: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onError: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onFocus: FocusEvent[HTMLIonLabelElement] => Unit = null,
    onInput: FormEvent[HTMLIonLabelElement] => Unit = null,
    onInvalid: FormEvent[HTMLIonLabelElement] => Unit = null,
    onKeyDown: KeyboardEvent[HTMLIonLabelElement] => Unit = null,
    onKeyPress: KeyboardEvent[HTMLIonLabelElement] => Unit = null,
    onKeyUp: KeyboardEvent[HTMLIonLabelElement] => Unit = null,
    onLoad: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onMouseDown: MouseEvent[HTMLIonLabelElement, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[HTMLIonLabelElement, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[HTMLIonLabelElement, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[HTMLIonLabelElement, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[HTMLIonLabelElement, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[HTMLIonLabelElement, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[HTMLIonLabelElement, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[HTMLIonLabelElement] => Unit = null,
    onPause: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onPlay: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onPlaying: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onPointerCancel: PointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerDown: PointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerEnter: PointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerLeave: PointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerMove: PointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerOut: PointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerOver: PointerEvent[HTMLIonLabelElement] => Unit = null,
    onPointerUp: PointerEvent[HTMLIonLabelElement] => Unit = null,
    ...
    onStalled: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onSubmit: FormEvent[HTMLIonLabelElement] => Unit = null,
    onSuspend: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onTouchCancel: TouchEvent[HTMLIonLabelElement] => Unit = null,
    onTouchEnd: TouchEvent[HTMLIonLabelElement] => Unit = null,
    onTouchMove: TouchEvent[HTMLIonLabelElement] => Unit = null,
    onTouchStart: TouchEvent[HTMLIonLabelElement] => Unit = null,
    onTransitionEnd: TransitionEvent[HTMLIonLabelElement] => Unit = null,
    onVolumeChange: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onWaiting: SyntheticEvent[HTMLIonLabelElement, Event_] => Unit = null,
    onWheel: WheelEvent[HTMLIonLabelElement] => Unit = null,
