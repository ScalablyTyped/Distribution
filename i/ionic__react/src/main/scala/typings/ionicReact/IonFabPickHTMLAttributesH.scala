...
import typings.ionicReact.ionicReactStrings.center
...
trait IonFabPickHTMLAttributesH extends js.Object {
  ...
  var onAbort: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onAbortCapture: js.Any
  var onAnimationEnd: js.UndefOr[AnimationEventHandler[HTMLIonFabElement]] = js.undefined
  var onAnimationEndCapture: js.Any
  var onAnimationIteration: js.UndefOr[AnimationEventHandler[HTMLIonFabElement]] = js.undefined
  var onAnimationIterationCapture: js.Any
  var onAnimationStart: js.UndefOr[AnimationEventHandler[HTMLIonFabElement]] = js.undefined
  var onAnimationStartCapture: js.Any
  var onAuxClick: js.UndefOr[MouseEventHandler[HTMLIonFabElement]] = js.undefined
  var onAuxClickCapture: js.Any
  var onBeforeInput: js.UndefOr[FormEventHandler[HTMLIonFabElement]] = js.undefined
  var onBeforeInputCapture: js.Any
  var onBlur: js.UndefOr[FocusEventHandler[HTMLIonFabElement]] = js.undefined
  var onBlurCapture: js.Any
  var onCanPlay: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onCanPlayCapture: js.Any
  var onCanPlayThrough: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onCanPlayThroughCapture: js.Any
  var onChange: js.UndefOr[FormEventHandler[HTMLIonFabElement]] = js.undefined
  var onChangeCapture: js.Any
  var onClick: js.UndefOr[MouseEventHandler[HTMLIonFabElement]] = js.undefined
  var onClickCapture: js.Any
  var onCompositionEnd: js.UndefOr[CompositionEventHandler[HTMLIonFabElement]] = js.undefined
  var onCompositionEndCapture: js.Any
  var onCompositionStart: js.UndefOr[CompositionEventHandler[HTMLIonFabElement]] = js.undefined
  var onCompositionStartCapture: js.Any
  var onCompositionUpdate: js.UndefOr[CompositionEventHandler[HTMLIonFabElement]] = js.undefined
  var onCompositionUpdateCapture: js.Any
  var onContextMenu: js.UndefOr[MouseEventHandler[HTMLIonFabElement]] = js.undefined
  var onContextMenuCapture: js.Any
  var onCopy: js.UndefOr[ClipboardEventHandler[HTMLIonFabElement]] = js.undefined
  var onCopyCapture: js.Any
  var onCut: js.UndefOr[ClipboardEventHandler[HTMLIonFabElement]] = js.undefined
  var onCutCapture: js.Any
  var onDoubleClick: js.UndefOr[MouseEventHandler[HTMLIonFabElement]] = js.undefined
  var onDoubleClickCapture: js.Any
  var onDrag: js.UndefOr[DragEventHandler[HTMLIonFabElement]] = js.undefined
  var onDragCapture: js.Any
  var onDragEnd: js.UndefOr[DragEventHandler[HTMLIonFabElement]] = js.undefined
  var onDragEndCapture: js.Any
  var onDragEnter: js.UndefOr[DragEventHandler[HTMLIonFabElement]] = js.undefined
  var onDragEnterCapture: js.Any
  var onDragExit: js.UndefOr[DragEventHandler[HTMLIonFabElement]] = js.undefined
  var onDragExitCapture: js.Any
  var onDragLeave: js.UndefOr[DragEventHandler[HTMLIonFabElement]] = js.undefined
  var onDragLeaveCapture: js.Any
  var onDragOver: js.UndefOr[DragEventHandler[HTMLIonFabElement]] = js.undefined
  var onDragOverCapture: js.Any
  var onDragStart: js.UndefOr[DragEventHandler[HTMLIonFabElement]] = js.undefined
  var onDragStartCapture: js.Any
  var onDrop: js.UndefOr[DragEventHandler[HTMLIonFabElement]] = js.undefined
  var onDropCapture: js.Any
  var onDurationChange: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onDurationChangeCapture: js.Any
  var onEmptied: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onEmptiedCapture: js.Any
  var onEncrypted: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onEncryptedCapture: js.Any
  var onEnded: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onEndedCapture: js.Any
  var onError: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onErrorCapture: js.Any
  var onFocus: js.UndefOr[FocusEventHandler[HTMLIonFabElement]] = js.undefined
  var onFocusCapture: js.Any
  var onGotPointerCapture: js.Any
  var onGotPointerCaptureCapture: js.Any
  var onInput: js.UndefOr[FormEventHandler[HTMLIonFabElement]] = js.undefined
  var onInputCapture: js.Any
  var onInvalid: js.UndefOr[FormEventHandler[HTMLIonFabElement]] = js.undefined
  var onInvalidCapture: js.Any
  var onKeyDown: js.UndefOr[KeyboardEventHandler[HTMLIonFabElement]] = js.undefined
  var onKeyDownCapture: js.Any
  var onKeyPress: js.UndefOr[KeyboardEventHandler[HTMLIonFabElement]] = js.undefined
  var onKeyPressCapture: js.Any
  var onKeyUp: js.UndefOr[KeyboardEventHandler[HTMLIonFabElement]] = js.undefined
  var onKeyUpCapture: js.Any
  var onLoad: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onLoadCapture: js.Any
  var onLoadStart: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onLoadStartCapture: js.Any
  var onLoadedData: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onLoadedDataCapture: js.Any
  var onLoadedMetadata: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onLoadedMetadataCapture: js.Any
  var onLostPointerCapture: js.Any
  var onLostPointerCaptureCapture: js.Any
  var onMouseDown: js.UndefOr[MouseEventHandler[HTMLIonFabElement]] = js.undefined
  var onMouseDownCapture: js.Any
  var onMouseEnter: js.UndefOr[MouseEventHandler[HTMLIonFabElement]] = js.undefined
  var onMouseLeave: js.UndefOr[MouseEventHandler[HTMLIonFabElement]] = js.undefined
  var onMouseMove: js.UndefOr[MouseEventHandler[HTMLIonFabElement]] = js.undefined
  var onMouseMoveCapture: js.Any
  var onMouseOut: js.UndefOr[MouseEventHandler[HTMLIonFabElement]] = js.undefined
  var onMouseOutCapture: js.Any
  var onMouseOver: js.UndefOr[MouseEventHandler[HTMLIonFabElement]] = js.undefined
  var onMouseOverCapture: js.Any
  var onMouseUp: js.UndefOr[MouseEventHandler[HTMLIonFabElement]] = js.undefined
  var onMouseUpCapture: js.Any
  var onPaste: js.UndefOr[ClipboardEventHandler[HTMLIonFabElement]] = js.undefined
  var onPasteCapture: js.Any
  var onPause: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onPauseCapture: js.Any
  var onPlay: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onPlayCapture: js.Any
  var onPlaying: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onPlayingCapture: js.Any
  var onPointerCancel: js.UndefOr[PointerEventHandler[HTMLIonFabElement]] = js.undefined
  var onPointerCancelCapture: js.Any
  var onPointerDown: js.UndefOr[PointerEventHandler[HTMLIonFabElement]] = js.undefined
  var onPointerDownCapture: js.Any
  var onPointerEnter: js.UndefOr[PointerEventHandler[HTMLIonFabElement]] = js.undefined
  var onPointerEnterCapture: js.Any
  var onPointerLeave: js.UndefOr[PointerEventHandler[HTMLIonFabElement]] = js.undefined
  var onPointerLeaveCapture: js.Any
  var onPointerMove: js.UndefOr[PointerEventHandler[HTMLIonFabElement]] = js.undefined
  var onPointerMoveCapture: js.Any
  var onPointerOut: js.UndefOr[PointerEventHandler[HTMLIonFabElement]] = js.undefined
  var onPointerOutCapture: js.Any
  var onPointerOver: js.UndefOr[PointerEventHandler[HTMLIonFabElement]] = js.undefined
  var onPointerOverCapture: js.Any
  var onPointerUp: js.UndefOr[PointerEventHandler[HTMLIonFabElement]] = js.undefined
  var onPointerUpCapture: js.Any
  var onProgress: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onProgressCapture: js.Any
  var onRateChange: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onRateChangeCapture: js.Any
  var onReset: js.UndefOr[FormEventHandler[HTMLIonFabElement]] = js.undefined
  var onResetCapture: js.Any
  var onScroll: js.UndefOr[UIEventHandler[HTMLIonFabElement]] = js.undefined
  var onScrollCapture: js.Any
  var onSeeked: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onSeekedCapture: js.Any
  var onSeeking: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onSeekingCapture: js.Any
  var onSelect: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onSelectCapture: js.Any
  var onStalled: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onStalledCapture: js.Any
  var onSubmit: js.UndefOr[FormEventHandler[HTMLIonFabElement]] = js.undefined
  var onSubmitCapture: js.Any
  var onSuspend: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onSuspendCapture: js.Any
  var onTimeUpdate: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onTimeUpdateCapture: js.Any
  var onTouchCancel: js.UndefOr[TouchEventHandler[HTMLIonFabElement]] = js.undefined
  var onTouchCancelCapture: js.Any
  var onTouchEnd: js.UndefOr[TouchEventHandler[HTMLIonFabElement]] = js.undefined
  var onTouchEndCapture: js.Any
  var onTouchMove: js.UndefOr[TouchEventHandler[HTMLIonFabElement]] = js.undefined
  var onTouchMoveCapture: js.Any
  var onTouchStart: js.UndefOr[TouchEventHandler[HTMLIonFabElement]] = js.undefined
  var onTouchStartCapture: js.Any
  var onTransitionEnd: js.UndefOr[TransitionEventHandler[HTMLIonFabElement]] = js.undefined
  var onTransitionEndCapture: js.Any
  var onVolumeChange: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onVolumeChangeCapture: js.Any
  var onWaiting: js.UndefOr[ReactEventHandler[HTMLIonFabElement]] = js.undefined
  var onWaitingCapture: js.Any
  var onWheel: js.UndefOr[WheelEventHandler[HTMLIonFabElement]] = js.undefined
  var onWheelCapture: js.Any
  var placeholder: js.UndefOr[String] = js.undefined
  var prefix: js.UndefOr[String] = js.undefined
  var property: js.UndefOr[String] = js.undefined
  var radioGroup: js.UndefOr[String] = js.undefined
  var ref: js.UndefOr[Ref[HTMLIonFabElement]] = js.undefined
...
object IonFabPickHTMLAttributesH {
  @scala.inline
  def apply(
    ...
    key: Key = null,
    lang: String = null,
    onAbort: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onAnimationEnd: AnimationEvent[HTMLIonFabElement] => Unit = null,
    onAnimationIteration: AnimationEvent[HTMLIonFabElement] => Unit = null,
    onAnimationStart: AnimationEvent[HTMLIonFabElement] => Unit = null,
    onAuxClick: MouseEvent[HTMLIonFabElement, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[HTMLIonFabElement] => Unit = null,
    onBlur: FocusEvent[HTMLIonFabElement] => Unit = null,
    onCanPlay: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onChange: FormEvent[HTMLIonFabElement] => Unit = null,
    onClick: MouseEvent[HTMLIonFabElement, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[HTMLIonFabElement] => Unit = null,
    onCompositionStart: CompositionEvent[HTMLIonFabElement] => Unit = null,
    onCompositionUpdate: CompositionEvent[HTMLIonFabElement] => Unit = null,
    onContextMenu: MouseEvent[HTMLIonFabElement, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[HTMLIonFabElement] => Unit = null,
    onCut: ClipboardEvent[HTMLIonFabElement] => Unit = null,
    onDoubleClick: MouseEvent[HTMLIonFabElement, NativeMouseEvent] => Unit = null,
    onDrag: DragEvent[HTMLIonFabElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonFabElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonFabElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonFabElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonFabElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonFabElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonFabElement] => Unit = null,
    onDrop: DragEvent[HTMLIonFabElement] => Unit = null,
    onDurationChange: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onEmptied: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onEnded: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onError: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onFocus: FocusEvent[HTMLIonFabElement] => Unit = null,
    onInput: FormEvent[HTMLIonFabElement] => Unit = null,
    onInvalid: FormEvent[HTMLIonFabElement] => Unit = null,
    onKeyDown: KeyboardEvent[HTMLIonFabElement] => Unit = null,
    onKeyPress: KeyboardEvent[HTMLIonFabElement] => Unit = null,
    onKeyUp: KeyboardEvent[HTMLIonFabElement] => Unit = null,
    onLoad: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onMouseDown: MouseEvent[HTMLIonFabElement, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[HTMLIonFabElement, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[HTMLIonFabElement, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[HTMLIonFabElement, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[HTMLIonFabElement, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[HTMLIonFabElement, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[HTMLIonFabElement, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[HTMLIonFabElement] => Unit = null,
    onPause: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onPlay: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onPlaying: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onPointerCancel: PointerEvent[HTMLIonFabElement] => Unit = null,
    onPointerDown: PointerEvent[HTMLIonFabElement] => Unit = null,
    onPointerEnter: PointerEvent[HTMLIonFabElement] => Unit = null,
    onPointerLeave: PointerEvent[HTMLIonFabElement] => Unit = null,
    onPointerMove: PointerEvent[HTMLIonFabElement] => Unit = null,
    onPointerOut: PointerEvent[HTMLIonFabElement] => Unit = null,
    onPointerOver: PointerEvent[HTMLIonFabElement] => Unit = null,
    onPointerUp: PointerEvent[HTMLIonFabElement] => Unit = null,
    onProgress: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onRateChange: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onReset: FormEvent[HTMLIonFabElement] => Unit = null,
    onScroll: UIEvent[HTMLIonFabElement, NativeUIEvent] => Unit = null,
    onSeeked: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onSeeking: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onSelect: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onStalled: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onSubmit: FormEvent[HTMLIonFabElement] => Unit = null,
    onSuspend: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onTouchCancel: TouchEvent[HTMLIonFabElement] => Unit = null,
    onTouchEnd: TouchEvent[HTMLIonFabElement] => Unit = null,
    onTouchMove: TouchEvent[HTMLIonFabElement] => Unit = null,
    onTouchStart: TouchEvent[HTMLIonFabElement] => Unit = null,
    onTransitionEnd: TransitionEvent[HTMLIonFabElement] => Unit = null,
    onVolumeChange: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onWaiting: SyntheticEvent[HTMLIonFabElement, Event_] => Unit = null,
    onWheel: WheelEvent[HTMLIonFabElement] => Unit = null,
    placeholder: String = null,
    prefix: String = null,
    property: String = null,
    radioGroup: String = null,
    ref: Ref[HTMLIonFabElement] = null,
    ...
    __obj.asInstanceOf[IonFabPickHTMLAttributesH]
  }
}
