...
import typings.ionicReact.anon.AlertOptionsReactControll
...
import typings.ionicReact.anon.LoadingOptionsReactContro
import typings.ionicReact.anon.PickHTMLAttributesunknown
...
import typings.ionicReact.createAnimationMod.CreateAnimation
import typings.ionicReact.ionBackButtonMod.Props
import typings.ionicReact.ionRedirectMod.IonRedirectProps
import typings.ionicReact.ionRouteMod.IonRouteProps
...
object componentsMod {
  ...
  class IonRoute protected ()
    extends typings.ionicReact.ionRouteMod.IonRoute {
  ...
  class IonTabButton protected ()
    extends typings.ionicReact.ionTabButtonMod.IonTabButton {
    def this(props: typings.ionicReact.ionTabButtonMod.Props) = this()
  }
  ...
  class IonTabs protected ()
    ...
    def this(props: typings.ionicReact.ionTabsMod.Props) = this()
  }
  ...
  class IonicSafeString protected ()
    extends typings.ionicCore.mod.IonicSafeString {
