...
trait IonTitlePickHTMLAttribute extends js.Object {
  ...
  var onAbort: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onAbortCapture: js.Any
  var onAnimationEnd: js.UndefOr[AnimationEventHandler[HTMLIonTitleElement]] = js.undefined
  var onAnimationEndCapture: js.Any
  var onAnimationIteration: js.UndefOr[AnimationEventHandler[HTMLIonTitleElement]] = js.undefined
  var onAnimationIterationCapture: js.Any
  var onAnimationStart: js.UndefOr[AnimationEventHandler[HTMLIonTitleElement]] = js.undefined
  var onAnimationStartCapture: js.Any
  var onAuxClick: js.UndefOr[MouseEventHandler[HTMLIonTitleElement]] = js.undefined
  var onAuxClickCapture: js.Any
  var onBeforeInput: js.UndefOr[FormEventHandler[HTMLIonTitleElement]] = js.undefined
  var onBeforeInputCapture: js.Any
  var onBlur: js.UndefOr[FocusEventHandler[HTMLIonTitleElement]] = js.undefined
  var onBlurCapture: js.Any
  var onCanPlay: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onCanPlayCapture: js.Any
  var onCanPlayThrough: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onCanPlayThroughCapture: js.Any
  var onChange: js.UndefOr[FormEventHandler[HTMLIonTitleElement]] = js.undefined
  var onChangeCapture: js.Any
  var onClick: js.UndefOr[MouseEventHandler[HTMLIonTitleElement]] = js.undefined
  var onClickCapture: js.Any
  var onCompositionEnd: js.UndefOr[CompositionEventHandler[HTMLIonTitleElement]] = js.undefined
  var onCompositionEndCapture: js.Any
  var onCompositionStart: js.UndefOr[CompositionEventHandler[HTMLIonTitleElement]] = js.undefined
  var onCompositionStartCapture: js.Any
  var onCompositionUpdate: js.UndefOr[CompositionEventHandler[HTMLIonTitleElement]] = js.undefined
  var onCompositionUpdateCapture: js.Any
  var onContextMenu: js.UndefOr[MouseEventHandler[HTMLIonTitleElement]] = js.undefined
  var onContextMenuCapture: js.Any
  var onCopy: js.UndefOr[ClipboardEventHandler[HTMLIonTitleElement]] = js.undefined
  var onCopyCapture: js.Any
  var onCut: js.UndefOr[ClipboardEventHandler[HTMLIonTitleElement]] = js.undefined
  var onCutCapture: js.Any
  var onDoubleClick: js.UndefOr[MouseEventHandler[HTMLIonTitleElement]] = js.undefined
  var onDoubleClickCapture: js.Any
  var onDrag: js.UndefOr[DragEventHandler[HTMLIonTitleElement]] = js.undefined
  var onDragCapture: js.Any
  var onDragEnd: js.UndefOr[DragEventHandler[HTMLIonTitleElement]] = js.undefined
  var onDragEndCapture: js.Any
  var onDragEnter: js.UndefOr[DragEventHandler[HTMLIonTitleElement]] = js.undefined
  var onDragEnterCapture: js.Any
  var onDragExit: js.UndefOr[DragEventHandler[HTMLIonTitleElement]] = js.undefined
  var onDragExitCapture: js.Any
  var onDragLeave: js.UndefOr[DragEventHandler[HTMLIonTitleElement]] = js.undefined
  var onDragLeaveCapture: js.Any
  var onDragOver: js.UndefOr[DragEventHandler[HTMLIonTitleElement]] = js.undefined
  var onDragOverCapture: js.Any
  var onDragStart: js.UndefOr[DragEventHandler[HTMLIonTitleElement]] = js.undefined
  var onDragStartCapture: js.Any
  var onDrop: js.UndefOr[DragEventHandler[HTMLIonTitleElement]] = js.undefined
  var onDropCapture: js.Any
  var onDurationChange: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onDurationChangeCapture: js.Any
  var onEmptied: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onEmptiedCapture: js.Any
  var onEncrypted: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onEncryptedCapture: js.Any
  var onEnded: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onEndedCapture: js.Any
  var onError: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onErrorCapture: js.Any
  var onFocus: js.UndefOr[FocusEventHandler[HTMLIonTitleElement]] = js.undefined
  var onFocusCapture: js.Any
  var onGotPointerCapture: js.Any
  var onGotPointerCaptureCapture: js.Any
  var onInput: js.UndefOr[FormEventHandler[HTMLIonTitleElement]] = js.undefined
  var onInputCapture: js.Any
  var onInvalid: js.UndefOr[FormEventHandler[HTMLIonTitleElement]] = js.undefined
  var onInvalidCapture: js.Any
  var onKeyDown: js.UndefOr[KeyboardEventHandler[HTMLIonTitleElement]] = js.undefined
  var onKeyDownCapture: js.Any
  var onKeyPress: js.UndefOr[KeyboardEventHandler[HTMLIonTitleElement]] = js.undefined
  var onKeyPressCapture: js.Any
  var onKeyUp: js.UndefOr[KeyboardEventHandler[HTMLIonTitleElement]] = js.undefined
  var onKeyUpCapture: js.Any
  var onLoad: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onLoadCapture: js.Any
  var onLoadStart: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onLoadStartCapture: js.Any
  var onLoadedData: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onLoadedDataCapture: js.Any
  var onLoadedMetadata: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onLoadedMetadataCapture: js.Any
  var onLostPointerCapture: js.Any
  var onLostPointerCaptureCapture: js.Any
  var onMouseDown: js.UndefOr[MouseEventHandler[HTMLIonTitleElement]] = js.undefined
  var onMouseDownCapture: js.Any
  var onMouseEnter: js.UndefOr[MouseEventHandler[HTMLIonTitleElement]] = js.undefined
  var onMouseLeave: js.UndefOr[MouseEventHandler[HTMLIonTitleElement]] = js.undefined
  var onMouseMove: js.UndefOr[MouseEventHandler[HTMLIonTitleElement]] = js.undefined
  var onMouseMoveCapture: js.Any
  var onMouseOut: js.UndefOr[MouseEventHandler[HTMLIonTitleElement]] = js.undefined
  var onMouseOutCapture: js.Any
  var onMouseOver: js.UndefOr[MouseEventHandler[HTMLIonTitleElement]] = js.undefined
  var onMouseOverCapture: js.Any
  var onMouseUp: js.UndefOr[MouseEventHandler[HTMLIonTitleElement]] = js.undefined
  var onMouseUpCapture: js.Any
  var onPaste: js.UndefOr[ClipboardEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPasteCapture: js.Any
  var onPause: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPauseCapture: js.Any
  var onPlay: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPlayCapture: js.Any
  var onPlaying: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPlayingCapture: js.Any
  var onPointerCancel: js.UndefOr[PointerEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPointerCancelCapture: js.Any
  var onPointerDown: js.UndefOr[PointerEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPointerDownCapture: js.Any
  var onPointerEnter: js.UndefOr[PointerEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPointerEnterCapture: js.Any
  var onPointerLeave: js.UndefOr[PointerEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPointerLeaveCapture: js.Any
  var onPointerMove: js.UndefOr[PointerEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPointerMoveCapture: js.Any
  var onPointerOut: js.UndefOr[PointerEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPointerOutCapture: js.Any
  var onPointerOver: js.UndefOr[PointerEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPointerOverCapture: js.Any
  var onPointerUp: js.UndefOr[PointerEventHandler[HTMLIonTitleElement]] = js.undefined
  var onPointerUpCapture: js.Any
  var onProgress: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onProgressCapture: js.Any
  var onRateChange: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onRateChangeCapture: js.Any
  var onReset: js.UndefOr[FormEventHandler[HTMLIonTitleElement]] = js.undefined
  var onResetCapture: js.Any
  var onScroll: js.UndefOr[UIEventHandler[HTMLIonTitleElement]] = js.undefined
  var onScrollCapture: js.Any
  var onSeeked: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onSeekedCapture: js.Any
  var onSeeking: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onSeekingCapture: js.Any
  var onSelect: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onSelectCapture: js.Any
  var onStalled: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onStalledCapture: js.Any
  var onSubmit: js.UndefOr[FormEventHandler[HTMLIonTitleElement]] = js.undefined
  var onSubmitCapture: js.Any
  var onSuspend: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onSuspendCapture: js.Any
  var onTimeUpdate: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onTimeUpdateCapture: js.Any
  var onTouchCancel: js.UndefOr[TouchEventHandler[HTMLIonTitleElement]] = js.undefined
  var onTouchCancelCapture: js.Any
  var onTouchEnd: js.UndefOr[TouchEventHandler[HTMLIonTitleElement]] = js.undefined
  var onTouchEndCapture: js.Any
  var onTouchMove: js.UndefOr[TouchEventHandler[HTMLIonTitleElement]] = js.undefined
  var onTouchMoveCapture: js.Any
  var onTouchStart: js.UndefOr[TouchEventHandler[HTMLIonTitleElement]] = js.undefined
  var onTouchStartCapture: js.Any
  var onTransitionEnd: js.UndefOr[TransitionEventHandler[HTMLIonTitleElement]] = js.undefined
  var onTransitionEndCapture: js.Any
  var onVolumeChange: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onVolumeChangeCapture: js.Any
  var onWaiting: js.UndefOr[ReactEventHandler[HTMLIonTitleElement]] = js.undefined
  var onWaitingCapture: js.Any
  var onWheel: js.UndefOr[WheelEventHandler[HTMLIonTitleElement]] = js.undefined
  var onWheelCapture: js.Any
  var placeholder: js.UndefOr[String] = js.undefined
  var prefix: js.UndefOr[String] = js.undefined
  var property: js.UndefOr[String] = js.undefined
  var radioGroup: js.UndefOr[String] = js.undefined
  var ref: js.UndefOr[Ref[HTMLIonTitleElement]] = js.undefined
...
object IonTitlePickHTMLAttribute {
  @scala.inline
  def apply(
    ...
    key: Key = null,
    lang: String = null,
    onAbort: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onAnimationEnd: AnimationEvent[HTMLIonTitleElement] => Unit = null,
    onAnimationIteration: AnimationEvent[HTMLIonTitleElement] => Unit = null,
    onAnimationStart: AnimationEvent[HTMLIonTitleElement] => Unit = null,
    onAuxClick: MouseEvent[HTMLIonTitleElement, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[HTMLIonTitleElement] => Unit = null,
    onBlur: FocusEvent[HTMLIonTitleElement] => Unit = null,
    onCanPlay: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onChange: FormEvent[HTMLIonTitleElement] => Unit = null,
    onClick: MouseEvent[HTMLIonTitleElement, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[HTMLIonTitleElement] => Unit = null,
    onCompositionStart: CompositionEvent[HTMLIonTitleElement] => Unit = null,
    onCompositionUpdate: CompositionEvent[HTMLIonTitleElement] => Unit = null,
    onContextMenu: MouseEvent[HTMLIonTitleElement, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[HTMLIonTitleElement] => Unit = null,
    onCut: ClipboardEvent[HTMLIonTitleElement] => Unit = null,
    onDoubleClick: MouseEvent[HTMLIonTitleElement, NativeMouseEvent] => Unit = null,
    onDrag: DragEvent[HTMLIonTitleElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonTitleElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonTitleElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonTitleElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonTitleElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonTitleElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonTitleElement] => Unit = null,
    onDrop: DragEvent[HTMLIonTitleElement] => Unit = null,
    onDurationChange: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onEmptied: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onEnded: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onError: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onFocus: FocusEvent[HTMLIonTitleElement] => Unit = null,
    onInput: FormEvent[HTMLIonTitleElement] => Unit = null,
    onInvalid: FormEvent[HTMLIonTitleElement] => Unit = null,
    onKeyDown: KeyboardEvent[HTMLIonTitleElement] => Unit = null,
    onKeyPress: KeyboardEvent[HTMLIonTitleElement] => Unit = null,
    onKeyUp: KeyboardEvent[HTMLIonTitleElement] => Unit = null,
    onLoad: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onMouseDown: MouseEvent[HTMLIonTitleElement, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[HTMLIonTitleElement, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[HTMLIonTitleElement, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[HTMLIonTitleElement, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[HTMLIonTitleElement, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[HTMLIonTitleElement, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[HTMLIonTitleElement, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[HTMLIonTitleElement] => Unit = null,
    onPause: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onPlay: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onPlaying: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onPointerCancel: PointerEvent[HTMLIonTitleElement] => Unit = null,
    onPointerDown: PointerEvent[HTMLIonTitleElement] => Unit = null,
    onPointerEnter: PointerEvent[HTMLIonTitleElement] => Unit = null,
    onPointerLeave: PointerEvent[HTMLIonTitleElement] => Unit = null,
    onPointerMove: PointerEvent[HTMLIonTitleElement] => Unit = null,
    onPointerOut: PointerEvent[HTMLIonTitleElement] => Unit = null,
    onPointerOver: PointerEvent[HTMLIonTitleElement] => Unit = null,
    onPointerUp: PointerEvent[HTMLIonTitleElement] => Unit = null,
    onProgress: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onRateChange: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onReset: FormEvent[HTMLIonTitleElement] => Unit = null,
    onScroll: UIEvent[HTMLIonTitleElement, NativeUIEvent] => Unit = null,
    onSeeked: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onSeeking: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onSelect: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onStalled: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onSubmit: FormEvent[HTMLIonTitleElement] => Unit = null,
    onSuspend: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onTouchCancel: TouchEvent[HTMLIonTitleElement] => Unit = null,
    onTouchEnd: TouchEvent[HTMLIonTitleElement] => Unit = null,
    onTouchMove: TouchEvent[HTMLIonTitleElement] => Unit = null,
    onTouchStart: TouchEvent[HTMLIonTitleElement] => Unit = null,
    onTransitionEnd: TransitionEvent[HTMLIonTitleElement] => Unit = null,
    onVolumeChange: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onWaiting: SyntheticEvent[HTMLIonTitleElement, Event_] => Unit = null,
    onWheel: WheelEvent[HTMLIonTitleElement] => Unit = null,
    placeholder: String = null,
    prefix: String = null,
    property: String = null,
    radioGroup: String = null,
    ref: Ref[HTMLIonTitleElement] = null,
    ...
    __obj.asInstanceOf[IonTitlePickHTMLAttribute]
  }
}
