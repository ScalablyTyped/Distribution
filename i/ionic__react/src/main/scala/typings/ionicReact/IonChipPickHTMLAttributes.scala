...
trait IonChipPickHTMLAttributes extends js.Object {
  ...
  var ref: js.UndefOr[Ref[HTMLIonChipElement]] = js.undefined
...
object IonChipPickHTMLAttributes {
  @scala.inline
  def apply(
    ...
    lang: String = null,
    mode: ios | md = null,
    onAbort: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onAnimationEnd: AnimationEvent[HTMLIonChipElement] => Unit = null,
    onAnimationIteration: AnimationEvent[HTMLIonChipElement] => Unit = null,
    onAnimationStart: AnimationEvent[HTMLIonChipElement] => Unit = null,
    onAuxClick: MouseEvent[HTMLIonChipElement, NativeMouseEvent] => Unit = null,
    onBeforeInput: FormEvent[HTMLIonChipElement] => Unit = null,
    onBlur: FocusEvent[HTMLIonChipElement] => Unit = null,
    onCanPlay: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onChange: FormEvent[HTMLIonChipElement] => Unit = null,
    onClick: MouseEvent[HTMLIonChipElement, NativeMouseEvent] => Unit = null,
    onCompositionEnd: CompositionEvent[HTMLIonChipElement] => Unit = null,
    onCompositionStart: CompositionEvent[HTMLIonChipElement] => Unit = null,
    onCompositionUpdate: CompositionEvent[HTMLIonChipElement] => Unit = null,
    onContextMenu: MouseEvent[HTMLIonChipElement, NativeMouseEvent] => Unit = null,
    onCopy: ClipboardEvent[HTMLIonChipElement] => Unit = null,
    onCut: ClipboardEvent[HTMLIonChipElement] => Unit = null,
    onDoubleClick: MouseEvent[HTMLIonChipElement, NativeMouseEvent] => Unit = null,
    onDrag: DragEvent[HTMLIonChipElement] => Unit = null,
    onDragEnd: DragEvent[HTMLIonChipElement] => Unit = null,
    onDragEnter: DragEvent[HTMLIonChipElement] => Unit = null,
    onDragExit: DragEvent[HTMLIonChipElement] => Unit = null,
    onDragLeave: DragEvent[HTMLIonChipElement] => Unit = null,
    onDragOver: DragEvent[HTMLIonChipElement] => Unit = null,
    onDragStart: DragEvent[HTMLIonChipElement] => Unit = null,
    onDrop: DragEvent[HTMLIonChipElement] => Unit = null,
    onDurationChange: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onEmptied: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onEncrypted: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onEnded: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onError: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onFocus: FocusEvent[HTMLIonChipElement] => Unit = null,
    onInput: FormEvent[HTMLIonChipElement] => Unit = null,
    onInvalid: FormEvent[HTMLIonChipElement] => Unit = null,
    onKeyDown: KeyboardEvent[HTMLIonChipElement] => Unit = null,
    onKeyPress: KeyboardEvent[HTMLIonChipElement] => Unit = null,
    onKeyUp: KeyboardEvent[HTMLIonChipElement] => Unit = null,
    onLoad: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onLoadStart: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onLoadedData: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onMouseDown: MouseEvent[HTMLIonChipElement, NativeMouseEvent] => Unit = null,
    onMouseEnter: MouseEvent[HTMLIonChipElement, NativeMouseEvent] => Unit = null,
    onMouseLeave: MouseEvent[HTMLIonChipElement, NativeMouseEvent] => Unit = null,
    onMouseMove: MouseEvent[HTMLIonChipElement, NativeMouseEvent] => Unit = null,
    onMouseOut: MouseEvent[HTMLIonChipElement, NativeMouseEvent] => Unit = null,
    onMouseOver: MouseEvent[HTMLIonChipElement, NativeMouseEvent] => Unit = null,
    onMouseUp: MouseEvent[HTMLIonChipElement, NativeMouseEvent] => Unit = null,
    onPaste: ClipboardEvent[HTMLIonChipElement] => Unit = null,
    onPause: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onPlay: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onPlaying: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onPointerCancel: PointerEvent[HTMLIonChipElement] => Unit = null,
    onPointerDown: PointerEvent[HTMLIonChipElement] => Unit = null,
    onPointerEnter: PointerEvent[HTMLIonChipElement] => Unit = null,
    onPointerLeave: PointerEvent[HTMLIonChipElement] => Unit = null,
    onPointerMove: PointerEvent[HTMLIonChipElement] => Unit = null,
    onPointerOut: PointerEvent[HTMLIonChipElement] => Unit = null,
    onPointerOver: PointerEvent[HTMLIonChipElement] => Unit = null,
    onPointerUp: PointerEvent[HTMLIonChipElement] => Unit = null,
    ...
    onStalled: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onSubmit: FormEvent[HTMLIonChipElement] => Unit = null,
    onSuspend: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onTouchCancel: TouchEvent[HTMLIonChipElement] => Unit = null,
    onTouchEnd: TouchEvent[HTMLIonChipElement] => Unit = null,
    onTouchMove: TouchEvent[HTMLIonChipElement] => Unit = null,
    onTouchStart: TouchEvent[HTMLIonChipElement] => Unit = null,
    onTransitionEnd: TransitionEvent[HTMLIonChipElement] => Unit = null,
    onVolumeChange: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onWaiting: SyntheticEvent[HTMLIonChipElement, Event_] => Unit = null,
    onWheel: WheelEvent[HTMLIonChipElement] => Unit = null,
    outline: js.UndefOr[Boolean] = js.undefined,
    placeholder: String = null,
    prefix: String = null,
    property: String = null,
    radioGroup: String = null,
    ref: Ref[HTMLIonChipElement] = null,
    ...
    __obj.asInstanceOf[IonChipPickHTMLAttributes]
  }
}
