package typings.atIonicReact.distTypesContextsIonLifeCycleContextMod
...
@JSImport("@ionic/react/dist/types/contexts/IonLifeCycleContext", "DefaultIonLifeCycleContext")
@js.native
object DefaultIonLifeCycleContext extends Instantiable0[Anon_CallbackComponentCanBeDestroyed]
