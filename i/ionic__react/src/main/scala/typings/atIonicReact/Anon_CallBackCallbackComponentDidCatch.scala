...
@js.native
trait Anon_CallBackCallbackComponentDidCatch extends js.Object {
  var UNSAFE_componentWillMount: js.UndefOr[js.Function0[Unit]] = js.native
  var UNSAFE_componentWillReceiveProps: js.UndefOr[
    js.Function2[
      /* nextProps */ (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify JSX.IonLoading */ js.Any) with Anon_Event, 
      /* nextContext */ js.Any, 
      Unit
    ]
  ] = js.native
  ...
  var controller: HTMLIonLoadingElement = js.native
  var getSnapshotBeforeUpdate: js.UndefOr[
    js.Function2[
      /* prevProps */ (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify JSX.IonLoading */ js.Any) with Anon_Event, 
      /* prevState */ js.Object, 
      _
    ]
  ] = js.native
  var id: String = js.native
  val props: (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify JSX.IonLoading */ js.Any) with Anon_Event with Anon_ChildrenReactNode = js.native
