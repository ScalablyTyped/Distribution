...
trait Anon_AboutAccessKey extends js.Object {
  ...
  var UNSAFE_componentWillReceiveProps: js.UndefOr[
    js.Function2[
      /* nextProps */ Anon_ChildrenEvent with (Pick[
  ...
  var controller: HTMLIonPopoverElement = js.native
  var el: HTMLDivElement = js.native
  var getSnapshotBeforeUpdate: js.UndefOr[
    js.Function2[
      /* prevProps */ Anon_ChildrenEvent with (Pick[
        /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify JSX.IonPopover */ _, 
        /* import warning: LimitUnionLength.enterTypeRef Was union type with length 181 */ js.Any
      ]) with ReactProps, 
      /* prevState */ js.Object, 
  ...
  val props: Anon_ChildrenEvent with (Pick[
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify JSX.IonPopover */ _, 
    /* import warning: LimitUnionLength.enterTypeRef Was union type with length 181 */ js.Any
  ]) with ReactProps with Anon_ChildrenReactNode = js.native
