...
trait Anon_CallBackCallback extends js.Object {
  ...
  var UNSAFE_componentWillReceiveProps: js.UndefOr[
    js.Function2[
      /* nextProps */ (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify JSX.IonAlert */ js.Any) with Anon_Event, 
      /* nextContext */ js.Any, 
      Unit
    ]
  ] = js.native
  ...
  var controller: HTMLIonAlertElement = js.native
  var getSnapshotBeforeUpdate: js.UndefOr[
    js.Function2[
      /* prevProps */ (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify JSX.IonAlert */ js.Any) with Anon_Event, 
      /* prevState */ js.Object, 
      _
    ]
  ] = js.native
  var id: String = js.native
  val props: (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify JSX.IonAlert */ js.Any) with Anon_Event with Anon_ChildrenReactNode = js.native
  ...
  def setState[K /* <: scala.Nothing */](
    state: js.Function2[
      /* prevState */ js.Object, 
      /* props */ (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify JSX.IonAlert */ js.Any) with Anon_Event, 
