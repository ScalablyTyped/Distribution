...
object Props {
  ...
  def apply(
    ...
    onIonTabsDidChange: /* event */ CustomEvent[typings.atIonicCore.Anon_Tab] => Unit = null,
    onIonTabsWillChange: /* event */ CustomEvent[typings.atIonicCore.Anon_Tab] => Unit = null
  ): Props = {
