...
trait Anon_ChildrenRefHTMLIonAppElement extends js.Object {
  ...
  var ref: js.UndefOr[RefObject[HTMLIonAppElement]] = js.undefined
}

object Anon_ChildrenRefHTMLIonAppElement {
  @scala.inline
  def apply(children: ReactNode = null, ref: RefObject[HTMLIonAppElement] = null): Anon_ChildrenRefHTMLIonAppElement = {
