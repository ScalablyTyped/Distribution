...
import typings.ioredisMock.ioredisMockStrings.master
import typings.ioredisMock.ioredisMockStrings.slave
...
object anon {
  ...
  /* Inlined std.Omit<ioredis-mock.ioredis-mock.RedisOptions, 'port' | 'host' | 'path' | 'sentinels' | 'retryStrategy' | 'enableOfflineQueue' | 'readOnly'> */
