...
import typings.ipfsUtils.distSrcFetchMod.Response
...
object distSrcHttpFetchDotnodeMod {
  
  @JSImport("ipfs-utils/dist/src/http/fetch.node", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def fetch(url: String): js.Promise[Response] = ^.asInstanceOf[js.Dynamic].applyDynamic("fetch")(url.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Response]]
  inline def fetch(url: String, options: typings.ipfsUtils.distSrcTypesMod.FetchOptions): js.Promise[Response] = (^.asInstanceOf[js.Dynamic].applyDynamic("fetch")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Response]]
  inline def fetch(url: Request): js.Promise[Response] = ^.asInstanceOf[js.Dynamic].applyDynamic("fetch")(url.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Response]]
  inline def fetch(url: Request, options: typings.ipfsUtils.distSrcTypesMod.FetchOptions): js.Promise[Response] = (^.asInstanceOf[js.Dynamic].applyDynamic("fetch")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Response]]
