...
object mod {
  ...
  inline def parse[T](file: String, callback: js.Function2[/* err */ js.Any, /* data */ T, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(file.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
