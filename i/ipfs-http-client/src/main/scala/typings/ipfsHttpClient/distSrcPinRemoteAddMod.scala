...
object distSrcPinRemoteAddMod {
  ...
  inline def createAdd(client: Client): js.Function2[
    ...
    /* options */ (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_remote.AddOptions */ Any) & AbortOptions & typings.ipfsHttpClient.distSrcTypesMod.HTTPClientExtraOptions, 
    js.Promise[
