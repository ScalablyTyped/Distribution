...
object provideMod {
  ...
  def apply(clientOptions: ClientOptions): js.Function2[
    ...
    /* options */ js.UndefOr[
      (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_dht.ProvideOptions */ js.Any) & HttpOptions
    ], 
    AsyncIterable[
  ...
  @JSImport("ipfs-http-client/dist/src/dht/provide", JSImport.Namespace)
  @js.native
