...
object subscriptionTrackerMod {
  ...
  /* static member */
  inline def singleton(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("singleton")().asInstanceOf[js.Any]
  ...
  object SubscriptionTracker {
    ...
    extension [Self <: SubscriptionTracker](x: Self) {
      
      inline def setSubscribe(value: (js.Any, js.Any, js.Any) => js.Any): Self = StObject.set(x, "subscribe", js.Any.fromFunction3(value))
      
      inline def setUnsubscribe(value: (js.Any, js.Any) => Unit): Self = StObject.set(x, "unsubscribe", js.Any.fromFunction2(value))
      
      inline def set_subs(value: Map[js.Any, js.Any]): Self = StObject.set(x, "_subs", value.asInstanceOf[js.Any])
    }
  }
}
