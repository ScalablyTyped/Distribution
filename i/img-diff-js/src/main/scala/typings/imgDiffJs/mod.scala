...
object mod {
  ...
  inline def registerDecoder(extensions: js.Array[String], decoder: js.Function1[/* filename */ String, js.Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("registerDecoder")(extensions.asInstanceOf[js.Any], decoder.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  object ImgDiffOptions {
    ...
    extension [Self <: ImgDiffOptions](x: Self) {
      ...
      inline def setOptions(value: IncludeAA): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
