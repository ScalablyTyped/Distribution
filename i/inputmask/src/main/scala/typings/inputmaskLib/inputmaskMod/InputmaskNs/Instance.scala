...
trait Instance extends js.Object {
  /**
    ...
    */
  def getemptymask(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def hasMaskedValue(): scala.Boolean = js.native
  /**
  ...
  def mask(selectorOrElement: inputmaskLib.inputmaskMod.Global.HTMLElement): Instance = js.native
  /**
    * Create a mask for the input.
    *
    * @param el Element selector, a single element or an array of elements.
    */
  def mask(selectorOrElement: java.lang.String): Instance = js.native
  def mask(selectorOrElement: stdLib.ArrayLike[inputmaskLib.inputmaskMod.Global.HTMLElement]): Instance = js.native
  /**
  ...
  def option(opts: Options, noremask: scala.Boolean): Instance = js.native
  /**
  ...
  /**
    ...
    */
  def unmaskedvalue(): java.lang.String = js.native
}
