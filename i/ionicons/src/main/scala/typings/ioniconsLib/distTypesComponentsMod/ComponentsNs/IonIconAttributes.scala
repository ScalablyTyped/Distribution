...
trait IonIconAttributes
  extends ioniconsLib.distTypesStencilDotCoreMod.JSXElementsNs.HTMLAttributes[stdLib.HTMLElement] {
  /**
...
object IonIconAttributes {
  ...
  def apply(
    ...
    __obj.asInstanceOf[IonIconAttributes]
  }
}
