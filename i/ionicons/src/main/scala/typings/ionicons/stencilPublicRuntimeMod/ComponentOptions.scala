...
object ComponentOptions {
  ...
  implicit class ComponentOptionsMutableBuilder[Self <: ComponentOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAssetsDir(value: String): Self = StObject.set(x, "assetsDir", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAssetsDirUndefined: Self = StObject.set(x, "assetsDir", js.undefined)
