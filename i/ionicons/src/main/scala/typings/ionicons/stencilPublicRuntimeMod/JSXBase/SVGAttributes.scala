...
object SVGAttributes {
  ...
  implicit class SVGAttributesMutableBuilder[Self <: SVGAttributes[_], T] (val x: Self with SVGAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def `setColor-interpolation-filters`(value: auto | `s-rGB` | `linear-rGB` | inherit): Self = StObject.set(x, "color-interpolation-filters", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def `setEdge-mode`(value: Double | String): Self = StObject.set(x, "edge-mode", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `setEdge-modeUndefined`: Self = StObject.set(x, "edge-mode", js.undefined)
    ...
    @scala.inline
    def `setX-channel-selector`(value: String): Self = StObject.set(x, "x-channel-selector", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `setX-channel-selectorUndefined`: Self = StObject.set(x, "x-channel-selector", js.undefined)
