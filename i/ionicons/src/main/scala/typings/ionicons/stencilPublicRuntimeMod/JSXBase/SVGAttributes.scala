...
import typings.ionicons.ioniconsStrings.`after-edge`
import typings.ionicons.ioniconsStrings.`before-edge`
import typings.ionicons.ioniconsStrings.`linear-rGB`
import typings.ionicons.ioniconsStrings.`s-rGB`
import typings.ionicons.ioniconsStrings.`text-after-edge`
import typings.ionicons.ioniconsStrings.`text-before-edge`
import typings.ionicons.ioniconsStrings.alphabetic
import typings.ionicons.ioniconsStrings.auto
import typings.ionicons.ioniconsStrings.baseline
import typings.ionicons.ioniconsStrings.bevel
import typings.ionicons.ioniconsStrings.butt
import typings.ionicons.ioniconsStrings.central
import typings.ionicons.ioniconsStrings.evenodd
import typings.ionicons.ioniconsStrings.hanging
import typings.ionicons.ioniconsStrings.ideographic
import typings.ionicons.ioniconsStrings.inherit
import typings.ionicons.ioniconsStrings.initial
import typings.ionicons.ioniconsStrings.isolated
import typings.ionicons.ioniconsStrings.mathematical
import typings.ionicons.ioniconsStrings.medial
import typings.ionicons.ioniconsStrings.middle
import typings.ionicons.ioniconsStrings.miter
import typings.ionicons.ioniconsStrings.no
import typings.ionicons.ioniconsStrings.none
import typings.ionicons.ioniconsStrings.nonzero
import typings.ionicons.ioniconsStrings.replace
import typings.ionicons.ioniconsStrings.round
import typings.ionicons.ioniconsStrings.square
import typings.ionicons.ioniconsStrings.sum
import typings.ionicons.ioniconsStrings.terminal
import typings.ionicons.ioniconsStrings.yes
...
trait SVGAttributes[T] extends DOMAttributes[T] {
  ...
  var `color-interpolation-filters`: js.UndefOr[auto | `s-rGB` | `linear-rGB` | inherit] = js.native
  ...
  var `edge-mode`: js.UndefOr[Double | String] = js.native
  ...
  var `x-channel-selector`: js.UndefOr[String] = js.native
...
object SVGAttributes {
  ...
  implicit class SVGAttributesOps[Self <: SVGAttributes[_], T] (val x: Self with SVGAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def `setColor-interpolation-filters`(value: auto | `s-rGB` | `linear-rGB` | inherit): Self = this.set("color-interpolation-filters", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def `setEdge-mode`(value: Double | String): Self = this.set("edge-mode", value.asInstanceOf[js.Any])
    @scala.inline
    def `deleteEdge-mode`: Self = this.set("edge-mode", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def `setStroke-miterlimit`(value: String): Self = this.set("stroke-miterlimit", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def `setX-channel-selector`(value: String): Self = this.set("x-channel-selector", value.asInstanceOf[js.Any])
    @scala.inline
    def `deleteX-channel-selector`: Self = this.set("x-channel-selector", js.undefined)
    @scala.inline
