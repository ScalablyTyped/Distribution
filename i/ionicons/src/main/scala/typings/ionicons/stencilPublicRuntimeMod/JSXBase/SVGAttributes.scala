...
object SVGAttributes {
  ...
  extension [Self <: SVGAttributes[?], T](x: Self & SVGAttributes[T]) {
    ...
    inline def `setColor-interpolation-filters`(value: auto | `s-rGB` | `linear-rGB` | inherit): Self = StObject.set(x, "color-interpolation-filters", value.asInstanceOf[js.Any])
    ...
    inline def `setEdge-mode`(value: Double | String): Self = StObject.set(x, "edge-mode", value.asInstanceOf[js.Any])
    
    inline def `setEdge-modeUndefined`: Self = StObject.set(x, "edge-mode", js.undefined)
    ...
    inline def `setHoriz-adv-x`(value: Double | String): Self = StObject.set(x, "horiz-adv-x", value.asInstanceOf[js.Any])
    
    inline def `setHoriz-adv-xUndefined`: Self = StObject.set(x, "horiz-adv-x", js.undefined)
    ...
    inline def `setX-channel-selector`(value: String): Self = StObject.set(x, "x-channel-selector", value.asInstanceOf[js.Any])
    
    inline def `setX-channel-selectorUndefined`: Self = StObject.set(x, "x-channel-selector", js.undefined)
