...
object distTypesComponentsMod {
  ...
  object global {
    ...
    - typings.ionicons.distTypesStencilPublicRuntimeMod.HTMLStencilElement because Inheritance from two classes. Inlined componentOnReady */ @js.native
  ...
  object LocalJSX {
    ...
    trait IntrinsicElements extends StObject {
      ...
      var `ion-icon`: typings.ionicons.distTypesComponentsMod.LocalJSX.IonIcon
    }
    object IntrinsicElements {
      
      inline def apply(`ion-icon`: typings.ionicons.distTypesComponentsMod.LocalJSX.IonIcon): IntrinsicElements = {
        val __obj = js.Dynamic.literal()
        __obj.updateDynamic("ion-icon")(`ion-icon`.asInstanceOf[js.Any])
    ...
    object IonIcon {
      ...
      inline def apply(): typings.ionicons.distTypesComponentsMod.LocalJSX.IonIcon = {
        val __obj = js.Dynamic.literal()
  ...
  object stencilCoreAugmentingMod {
    ...
    object JSX {
      ...
      trait IntrinsicElements extends StObject {
        ...
        var `ion-icon`: typings.ionicons.distTypesComponentsMod.LocalJSX.IonIcon & HTMLAttributes[HTMLIonIconElement]
      }
      object IntrinsicElements {
        
        inline def apply(
          `ion-icon`: typings.ionicons.distTypesComponentsMod.LocalJSX.IonIcon & HTMLAttributes[HTMLIonIconElement]
        ): IntrinsicElements = {
          val __obj = js.Dynamic.literal()
          __obj.updateDynamic("ion-icon")(`ion-icon`.asInstanceOf[js.Any])
          __obj.asInstanceOf[IntrinsicElements]
