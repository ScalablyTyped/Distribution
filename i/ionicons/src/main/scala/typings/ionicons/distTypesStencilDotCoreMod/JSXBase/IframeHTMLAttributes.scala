package typings.ionicons.distTypesStencilDotCoreMod.JSXBase
...
object IframeHTMLAttributes {
  ...
  def apply[T](
    ...
    allowtransparency: String | Boolean = null,
    ...
    lang: String = null,
    loading: `lazy` | auto | eager = null,
    marginHeight: Int | Double = null,
    marginWidth: Int | Double = null,
    marginheight: String | Double = null,
    marginwidth: String | Double = null,
    name: String = null,
