...
object ^ extends js.Object {
  ...
  def hookLoader(matcherOrRoot: istanbulDashMiddlewareLib.istanbulDashMiddlewareMod.Matcher): scala.Unit = js.native
  def hookLoader(
    matcherOrRoot: istanbulDashMiddlewareLib.istanbulDashMiddlewareMod.Matcher,
    opts: istanbulDashMiddlewareLib.Anon_PostLoadHook
