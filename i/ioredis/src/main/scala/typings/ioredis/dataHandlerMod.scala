...
object dataHandlerMod {
  ...
  trait Condition extends StObject {
    ...
    var subscriber: `false` | typings.ioredis.subscriptionSetMod.default
  }
  object Condition {
    
    inline def apply(auth: String, select: Double, subscriber: `false` | typings.ioredis.subscriptionSetMod.default): Condition = {
    ...
    extension [Self <: Condition](x: Self) {
      ...
      inline def setSubscriber(value: `false` | typings.ioredis.subscriptionSetMod.default): Self = StObject.set(x, "subscriber", value.asInstanceOf[js.Any])
    }
  }
