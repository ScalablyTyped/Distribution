...
object ioredisStrings {
  ...
  inline def NOKEY: NOKEY = "NOKEY".asInstanceOf[NOKEY]
  ...
  inline def count_ : count_ = "count".asInstanceOf[count_]
  ...
  inline def match_ : match_ = "match".asInstanceOf[match_]
  
  @js.native
  sealed trait maxlen_ extends StObject
  inline def maxlen_ : maxlen_ = "maxlen".asInstanceOf[maxlen_]
