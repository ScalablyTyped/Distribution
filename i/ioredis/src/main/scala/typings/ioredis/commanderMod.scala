...
import typings.ioredis.redisCommanderMod.ClientContext
import typings.ioredis.redisCommanderMod.RedisCommander
...
object commanderMod {
  ...
  trait Commander[Context /* <: ClientContext */]
    ...
    /**
      * @ignore
      */
    def sendCommand(command: typings.ioredis.commandMod.default): Any = js.native
    def sendCommand(command: typings.ioredis.commandMod.default, stream: Unit, node: Any): Any = js.native
    def sendCommand(command: typings.ioredis.commandMod.default, stream: WriteableStream): Any = js.native
    def sendCommand(command: typings.ioredis.commandMod.default, stream: WriteableStream, node: Any): Any = js.native
  }
