...
object mod {
  ...
  inline def get(O: js.Object, slot: String): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(O.asInstanceOf[js.Any], slot.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  inline def set(O: js.Object, slot: String, V: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("set")(O.asInstanceOf[js.Any], slot.asInstanceOf[js.Any], V.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
