...
trait Options extends StObject {
  ...
  /**
    ...
    * Default = MOBILE
    */
  var placeholderNumberType: js.UndefOr[typings.intlTelInput.mod.intlTelInputUtils.placeholderNumberType] = js.undefined
...
object Options {
  ...
  extension [Self <: Options](x: Self) {
    ...
    inline def setExcludeCountriesVarargs(value: String*): Self = StObject.set(x, "excludeCountries", js.Array(value :_*))
