...
trait Plugin extends js.Object {
  ...
  def getNumber(numberFormat: intlDashTelDashInputLib.intlDashTelDashInputMod.intlTelInputUtilsNs.numberFormat): java.lang.String = js.native
  /**
    ...
    */
  def getNumberType(): intlDashTelDashInputLib.intlDashTelDashInputMod.intlTelInputUtilsNs.numberType = js.native
  /**
    * Get the country data for the currently selected flag.
    */
  def getSelectedCountryData(): intlDashTelDashInputLib.intlDashTelDashInputMod.intlTelInputUtilsNs.CountryData = js.native
  /**
    ...
    */
  def getValidationError(): intlDashTelDashInputLib.intlDashTelDashInputMod.intlTelInputUtilsNs.validationError = js.native
  /**
  ...
  /**
    ...
    */
  def setPlaceholderNumberType(`type`: intlDashTelDashInputLib.intlDashTelDashInputMod.intlTelInputUtilsNs.placeholderNumberType): scala.Unit = js.native
}
