...
trait JQuery extends js.Object {
  @JSName("intlTelInput")
  var intlTelInput_Original: intlDashTelDashInputLib.IntlTelInputNs.JQueryPlugin = js.native
  /**
  ...
  /**
           ...
           * @param options options that can be provided during initialization.
           */
  def intlTelInput(options: intlDashTelDashInputLib.IntlTelInputNs.Options): js.Any = js.native
  /**
  ...
  /**
           ...
           */
  @JSName("intlTelInput")
  def intlTelInput_getSelectedCountryData(method: intlDashTelDashInputLib.intlDashTelDashInputLibStrings.getSelectedCountryData): intlDashTelDashInputLib.intlTelInputUtilsNs.CountryData = js.native
  /**
  ...
  def intlTelInput_setPlaceholderNumberType(
    ...
    `type`: intlDashTelDashInputLib.intlTelInputUtilsNs.placeholderNumberType
  ): scala.Unit = js.native
}
