...
trait JQuery extends js.Object {
  @JSName("intlTelInput")
  var intlTelInput_Original: intlDashTelDashInputLib.IntlTelInputNs.Plugin = js.native
  /**
       * initialise the plugin with optional options.
       * @param options options that can be provided during initialization.
       */
  def intlTelInput(): jqueryLib.JQueryDeferred[_] = js.native
  def intlTelInput(method: java.lang.String): scala.Unit = js.native
  def intlTelInput(method: java.lang.String, numberFormat: intlDashTelDashInputLib.intlTelInputUtilsNs.numberFormat): java.lang.String = js.native
  def intlTelInput(method: java.lang.String, value: java.lang.String): scala.Unit = js.native
  /**
       * initialise the plugin with optional options.
       * @param options options that can be provided during initialization.
       */
  def intlTelInput(options: intlDashTelDashInputLib.IntlTelInputNs.Options): jqueryLib.JQueryDeferred[_] = js.native
  /**
  ...
  /**
       ...
       */
  @JSName("intlTelInput")
  def intlTelInput_getNumberType(method: intlDashTelDashInputLib.intlDashTelDashInputLibStrings.getNumberType): intlDashTelDashInputLib.intlTelInputUtilsNs.numberType = js.native
  /**
       * Get the country data for the currently selected flag.
       */
  @JSName("intlTelInput")
  def intlTelInput_getSelectedCountryData(method: intlDashTelDashInputLib.intlDashTelDashInputLibStrings.getSelectedCountryData): intlDashTelDashInputLib.IntlTelInputNs.CountryData = js.native
  /**
       ...
       */
  @JSName("intlTelInput")
  def intlTelInput_getValidationError(method: intlDashTelDashInputLib.intlDashTelDashInputLibStrings.getValidationError): intlDashTelDashInputLib.intlTelInputUtilsNs.validationError = js.native
  /**
