...
trait Plugin extends js.Object {
  ...
  def getNumber(numberFormat: intlDashTelDashInputLib.intlTelInputUtilsNs.numberFormat): java.lang.String = js.native
  /**
    ...
    */
  def getNumberType(): intlDashTelDashInputLib.intlTelInputUtilsNs.numberType = js.native
  /**
    * Get the country data for the currently selected flag.
    */
  def getSelectedCountryData(): intlDashTelDashInputLib.intlTelInputUtilsNs.CountryData = js.native
  /**
    ...
    */
  def getValidationError(): intlDashTelDashInputLib.intlTelInputUtilsNs.validationError = js.native
  /**
    ...
    */
  def isValidNumber(): scala.Boolean = js.native
  /**
    * Change the country selection (e.g. when the user is entering their address).
    * @param countryCode country code of the country to be set.
    */
  def setCountry(countryCode: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def setNumber(aNumber: java.lang.String): scala.Unit = js.native
  /**
    * Set the type of the placeholder number
    * @param type Placeholder number type to be set
    */
  def setPlaceholderNumberType(`type`: intlDashTelDashInputLib.intlTelInputUtilsNs.placeholderNumberType): scala.Unit = js.native
}
