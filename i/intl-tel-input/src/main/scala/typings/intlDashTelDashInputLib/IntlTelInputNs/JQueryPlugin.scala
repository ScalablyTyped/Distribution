...
trait JQueryPlugin extends js.Object {
  ...
  /**
    ...
    */
  def apply(method: intlDashTelDashInputLib.intlDashTelDashInputLibStrings.getSelectedCountryData): intlDashTelDashInputLib.intlTelInputUtilsNs.CountryData = js.native
  /**
