...
object Anon_AltKey {
  ...
  def apply(
    ...
    if (iframeContainerStyle != null) __obj.updateDynamic("iframeContainerStyle")(iframeContainerStyle)
    if (iframeStyle != null) __obj.updateDynamic("iframeStyle")(iframeStyle)
    if (lngOverride != null) __obj.updateDynamic("lngOverride")(lngOverride)
    if (lngOverrideQS != null) __obj.updateDynamic("lngOverrideQS")(lngOverrideQS)
