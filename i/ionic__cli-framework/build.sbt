...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "ionic__utils-fs" % "0.0.3-63bcfd",
  ...
  "com.scalablytyped" %%% "string-width" % "2.0-dt-20180910Z-f813ca",
  ...
  "com.scalablytyped" %%% "write-file-atomic" % "2.1-dt-20180910Z-317c5d",
