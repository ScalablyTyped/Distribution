...
version := "1.7.0-3bab3e"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "1.0.0",
  "org.scala-js" %%% "scalajs-dom" % "0.9.6",
  "org.scalablytyped" %%% "ansi-escapes" % "3.0-dt-20190306Z-ae6f17",
  "org.scalablytyped" %%% "ansi-styles" % "3.2.1-dt-20181017Z-052e82",
  "org.scalablytyped" %%% "chalk" % "2.4.2-6d01d0",
  "org.scalablytyped" %%% "cli-cursor" % "2.1-dt-20181224Z-26babf",
  ...
  "org.scalablytyped" %%% "ionic__utils-subprocess" % "0.1.0-95d46a",
  "org.scalablytyped" %%% "ionic__utils-terminal" % "0.0.1-7b4e18",
  "org.scalablytyped" %%% "lodash" % "4.14-dt-20190311Z-601106",
  "org.scalablytyped" %%% "log-update" % "3.1.0-500de5",
  ...
  "org.scalablytyped" %%% "string-width" % "2.0-dt-20180530Z-2b7ddb",
  ...
  "org.scalablytyped" %%% "write-file-atomic" % "2.1-dt-20180214Z-4ed481")
