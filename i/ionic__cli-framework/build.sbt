...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__utils-subprocess" % "0.1.0-b330ca",
  "org.scalablytyped" %%% "ionic__utils-terminal" % "0.0.1-2d4966",
  "org.scalablytyped" %%% "lodash" % "4.14-dt-20190227Z-56553a",
  "org.scalablytyped" %%% "log-update" % "2.0-dt-20180214Z-6cd648",
  ...
  "org.scalablytyped" %%% "string-width" % "2.0-dt-20180530Z-5d49ed",
  ...
  "org.scalablytyped" %%% "write-file-atomic" % "2.1-dt-20180214Z-927056")
