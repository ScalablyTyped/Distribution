...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ionic__utils-subprocess" % "0.1.0-31fc03",
  "org.scalablytyped" %%% "ionic__utils-terminal" % "0.0.1-7b4e18",
  "org.scalablytyped" %%% "lodash" % "4.14-dt-20190311Z-601106",
  "org.scalablytyped" %%% "log-update" % "3.1.0-641900",
  ...
  "org.scalablytyped" %%% "string-width" % "2.0-dt-20180530Z-9f607d",
