...
package object definitionsMod {
  ...
  type HydratedCommandMetadata[C /* <: ICommand[C, N, M, I, O] */, N /* <: INamespace[C, N, M, I, O] */, M /* <: CommandMetadata[I, O] */, I /* <: CommandMetadataInput */, O /* <: CommandMetadataOption */] = M with (atIonicCliDashFrameworkLib.Anon_Aliases[O, C, N, M, I])
  type HydratedCommandMetadataOption[O /* <: CommandMetadataOption */] = stdLib.Required[O]
  type ICommandMap[C /* <: ICommand[C, N, M, I, O] */, N /* <: INamespace[C, N, M, I, O] */, M /* <: CommandMetadata[I, O] */, I /* <: CommandMetadataInput */, O /* <: CommandMetadataOption */] = atIonicUtilsDashObjectLib.atIonicUtilsDashObjectMod.AliasedMap[java.lang.String, CommandMapGetter[C, N, M, I, O]]
  type INamespaceMap[C /* <: ICommand[C, N, M, I, O] */, N /* <: INamespace[C, N, M, I, O] */, M /* <: CommandMetadata[I, O] */, I /* <: CommandMetadataInput */, O /* <: CommandMetadataOption */] = atIonicUtilsDashObjectLib.atIonicUtilsDashObjectMod.AliasedMap[java.lang.String, NamespaceMapGetter[C, N, M, I, O]]
