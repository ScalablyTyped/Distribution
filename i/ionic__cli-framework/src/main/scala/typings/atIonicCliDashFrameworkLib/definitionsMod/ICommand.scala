...
trait ICommand[C /* <: ICommand[C, N, M, I, O] */, N /* <: INamespace[C, N, M, I, O] */, M /* <: CommandMetadata[I, O] */, I /* <: CommandMetadataInput */, O /* <: CommandMetadataOption */] extends js.Object {
  ...
  def getMetadata(runinfo: stdLib.Partial[CommandInstanceInfo[C, N, M, I, O]]): stdLib.Promise[M] = js.native
  def run(inputs: CommandLineInputs, options: CommandLineOptions): stdLib.Promise[scala.Unit] = js.native
  def run(
    inputs: CommandLineInputs,
    options: CommandLineOptions,
    runinfo: stdLib.Partial[CommandInstanceInfo[C, N, M, I, O]]
  ): stdLib.Promise[scala.Unit] = js.native
  def validate(argv: CommandLineInputs): stdLib.Promise[scala.Unit] = js.native
}
