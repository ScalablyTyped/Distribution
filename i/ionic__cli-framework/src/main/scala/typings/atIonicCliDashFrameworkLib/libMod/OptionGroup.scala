...
@JSImport("@ionic/cli-framework/lib", "OptionGroup")
@js.native
object OptionGroup extends js.Object {
  /* "advanced" */ val Advanced: atIonicCliDashFrameworkLib.libHelpMod.OptionGroup.Advanced with java.lang.String = js.native
  /* "beta" */ val Beta: atIonicCliDashFrameworkLib.libHelpMod.OptionGroup.Beta with java.lang.String = js.native
