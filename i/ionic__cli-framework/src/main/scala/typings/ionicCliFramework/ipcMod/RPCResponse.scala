...
object RPCResponse {
  ...
  @scala.inline
  implicit class RPCResponseOps[Self <: RPCResponse[_, _], /* <: typings.ionicCliFramework.ipcMod.RPCRequest[_, _] */ R, /* <: js.Object */ D] (val x: Self with (RPCResponse[R, D])) extends AnyVal {
    @scala.inline
