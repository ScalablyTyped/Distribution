...
object libHelpMod {
  ...
  trait CommandHelpFormatterDeps[C /* <: ICommand[C, N, M, I, O] */, N /* <: INamespace[C, N, M, I, O] */, M /* <: CommandMetadata[I, O] */, I /* <: CommandMetadataInput */, O /* <: CommandMetadataOption */] extends StObject {
    ...
    val colors: js.UndefOr[typings.ionicCliFramework.libColorsMod.Colors] = js.undefined
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteText
    - typings.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteLink
  */
  trait CommandHelpSchemaFootnote extends StObject
  object CommandHelpSchemaFootnote {
    
    inline def CommandHelpSchemaFootnoteLink(id: String | Double, url: String): typings.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteLink = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("link")
      __obj.asInstanceOf[typings.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteLink]
    }
    
    inline def CommandHelpSchemaFootnoteText(id: String | Double, text: String): typings.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteText = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("text")
      __obj.asInstanceOf[typings.ionicCliFramework.libHelpMod.CommandHelpSchemaFootnoteText]
    }
  }
