...
package object definitionsMod {
  ...
  type HydratedCommandMetadata[C /* <: typings.ionicCliFramework.definitionsMod.ICommand[C, N, M, I, O] */, N /* <: typings.ionicCliFramework.definitionsMod.INamespace[C, N, M, I, O] */, M /* <: typings.ionicCliFramework.definitionsMod.CommandMetadata[I, O] */, I /* <: typings.ionicCliFramework.definitionsMod.CommandMetadataInput */, O /* <: typings.ionicCliFramework.definitionsMod.CommandMetadataOption */] = M with (typings.ionicCliFramework.AnonAliases[C, N, M, I, O])
