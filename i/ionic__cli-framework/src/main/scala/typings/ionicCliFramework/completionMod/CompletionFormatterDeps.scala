...
object CompletionFormatterDeps {
  ...
  @scala.inline
  implicit class CompletionFormatterDepsOps[Self <: CompletionFormatterDeps[_, _, _, _, _], C /* <: ICommand[C, N, M, I, O] */, N /* <: INamespace[C, N, M, I, O] */, M /* <: CommandMetadata[I, O] */, I /* <: CommandMetadataInput */, O /* <: CommandMetadataOption */] (val x: Self with (CompletionFormatterDeps[C, N, M, I, O])) extends AnyVal {
