...
object CompletionFormatterDeps {
  ...
  @scala.inline
  implicit class CompletionFormatterDepsOps[Self <: CompletionFormatterDeps[_, _, _, _, _], /* <: typings.ionicCliFramework.definitionsMod.ICommand[C, N, M, I, O] */ C, /* <: typings.ionicCliFramework.definitionsMod.INamespace[C, N, M, I, O] */ N, /* <: typings.ionicCliFramework.definitionsMod.CommandMetadata[I, O] */ M, /* <: typings.ionicCliFramework.definitionsMod.CommandMetadataInput */ I, /* <: typings.ionicCliFramework.definitionsMod.CommandMetadataOption */ O] (val x: Self with (CompletionFormatterDeps[C, N, M, I, O])) extends AnyVal {
    @scala.inline
