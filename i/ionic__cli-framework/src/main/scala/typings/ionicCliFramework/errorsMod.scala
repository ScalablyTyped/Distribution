...
import typings.ionicCliFramework.ionicCliFrameworkStrings.ERR_ICF_COMMAND_NOT_FOUND
import typings.ionicCliFramework.ionicCliFrameworkStrings.ERR_ICF_INPUT_VALIDATION
import typings.ionicCliFramework.ionicCliFrameworkStrings.ERR_ICF_IPC_MODULE_INACCESSIBLE
import typings.ionicCliFramework.ionicCliFrameworkStrings.ERR_ICF_IPC_UNKNOWN_PROCEDURE
...
object errorsMod extends js.Object {
  ...
  class CommandNotFoundError protected () extends BaseError {
    ...
    @JSName("name")
    val name_CommandNotFoundError: typings.ionicCliFramework.ionicCliFrameworkStrings.CommandNotFoundError = js.native
  }
  
  @js.native
  class IPCError () extends BaseError {
    @JSName("name")
    val name_IPCError: typings.ionicCliFramework.ionicCliFrameworkStrings.IPCError = js.native
  }
  ...
  class InputValidationError protected () extends BaseError {
    ...
    @JSName("name")
    val name_InputValidationError: typings.ionicCliFramework.ionicCliFrameworkStrings.InputValidationError = js.native
  }
