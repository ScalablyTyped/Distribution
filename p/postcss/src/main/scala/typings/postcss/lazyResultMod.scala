...
object lazyResultMod {
  ...
  trait LazyResult
    extends StObject
       with PromiseLike[typings.postcss.resultMod.default] {
    ...
    /**
      ...
      */
    def async(): js.Promise[typings.postcss.resultMod.default] = js.native
    ...
    /**
      ...
      * ```
      */
    def `catch`[TResult](): js.Promise[typings.postcss.resultMod.default | TResult] = js.native
    /**
      * Processes input CSS through synchronous and asynchronous plugins
      * and calls onRejected for each error thrown in any plugin.
      *
    ...
    /**
      ...
      * ```
      */
    def `finally`(): js.Promise[typings.postcss.resultMod.default] = js.native
    /**
      * Processes input CSS through synchronous and asynchronous plugins
      * and calls onFinally on any error or when all plugins will finish work.
      *
      ...
      * ```
      */
    def `finally`(onfinally: js.Function0[Unit]): js.Promise[typings.postcss.resultMod.default] = js.native
    /**
      * Processes input CSS through synchronous and asynchronous plugins
      * and calls onFinally on any error or when all plugins will finish work.
      *
    ...
    /**
      ...
      */
    def processor: typings.postcss.processorMod.default = js.native
    ...
    /**
      ...
      * @return Result with output content.
      */
    def sync(): typings.postcss.resultMod.default = js.native
    ...
    /**
      ...
      */
    def warnings(): js.Array[typings.postcss.warningMod.default] = js.native
  }
}
