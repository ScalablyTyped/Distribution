...
@JSImport("postcss", "Stringifier")
@js.native
class Stringifier () extends js.Object {
  def this(builder: postcssLib.postcssMod.StringifierNs.Builder) = this()
  @JSName("builder")
  var builder_Original: postcssLib.postcssMod.StringifierNs.Builder = js.native
