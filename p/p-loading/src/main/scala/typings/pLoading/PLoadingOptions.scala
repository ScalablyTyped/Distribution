...
object PLoadingOptions {
  ...
  extension [Self <: PLoadingOptions](x: Self) {
    ...
    inline def setHideAnimation(value: /* $container */ JQuery => Unit): Self = StObject.set(x, "hideAnimation", js.Any.fromFunction1(value))
    ...
    inline def setOnDestroyContainer(value: /* $container */ JQuery => Unit): Self = StObject.set(x, "onDestroyContainer", js.Any.fromFunction1(value))
    
    inline def setOnDestroyContainerUndefined: Self = StObject.set(x, "onDestroyContainer", js.undefined)
    
    inline def setOnHideContainer(value: (/* $pluginElement */ JQuery, /* $container */ JQuery) => Unit): Self = StObject.set(x, "onHideContainer", js.Any.fromFunction2(value))
    
    inline def setOnHideContainerUndefined: Self = StObject.set(x, "onHideContainer", js.undefined)
    
    inline def setOnShowContainer(value: (/* $pluginElement */ JQuery, /* $container */ JQuery) => Unit): Self = StObject.set(x, "onShowContainer", js.Any.fromFunction2(value))
    ...
    inline def setShowAnimation(value: /* $container */ JQuery => Unit): Self = StObject.set(x, "showAnimation", js.Any.fromFunction1(value))
