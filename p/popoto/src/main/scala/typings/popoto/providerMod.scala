...
import typings.popoto.anon.LinkDEFAULTPROVIDERLinkPr
import typings.popoto.anon.NodeDEFAULTPROVIDERNodePr
import typings.popoto.anon.ReadonlyTEXT0IMAGE1SVG2SY
import typings.popoto.anon.TaxonomyDEFAULTPROVIDERTa
...
object providerMod {
  ...
  object Link {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getCSSClass = js.Any.fromFunction2(getCSSClass), getColor = js.Any.fromFunction3(getColor), getDistance = js.Any.fromFunction1(getDistance), getSemanticValue = js.Any.fromFunction1(getSemanticValue), getTextValue = js.Any.fromFunction1(getTextValue))
  ...
  trait Provider extends StObject {
    ...
    def colorLuminance(hex: String, lum: Double): String
    ...
    /**
      ...
      */
    def colorScale(x: String): js.Array[String] | scala.Nothing
    /**
      * Default color scale generator.
      * Used in getColor link and node providers.
      */
    @JSName("colorScale")
    var colorScale_Original: ScaleOrdinal_[String, js.Array[String], scala.Nothing]
    
    var link: LinkDEFAULTPROVIDERLinkPr
    
    var node: NodeDEFAULTPROVIDERNodePr
    
    var taxonomy: TaxonomyDEFAULTPROVIDERTa
  }
  object Provider {
    
    inline def apply(
      colorLuminance: (String, Double) => String,
      colorScale: ScaleOrdinal_[String, js.Array[String], scala.Nothing],
      link: LinkDEFAULTPROVIDERLinkPr,
      node: NodeDEFAULTPROVIDERNodePr,
      taxonomy: TaxonomyDEFAULTPROVIDERTa
    ): Provider = {
      val __obj = js.Dynamic.literal(colorLuminance = js.Any.fromFunction2(colorLuminance), colorScale = colorScale.asInstanceOf[js.Any], link = link.asInstanceOf[js.Any], node = node.asInstanceOf[js.Any], taxonomy = taxonomy.asInstanceOf[js.Any])
    ...
    extension [Self <: Provider](x: Self) {
      ...
      inline def setColorScale(value: ScaleOrdinal_[String, js.Array[String], scala.Nothing]): Self = StObject.set(x, "colorScale", value.asInstanceOf[js.Any])
      
      inline def setLink(value: LinkDEFAULTPROVIDERLinkPr): Self = StObject.set(x, "link", value.asInstanceOf[js.Any])
      
      inline def setNode(value: NodeDEFAULTPROVIDERNodePr): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
      
      inline def setTaxonomy(value: TaxonomyDEFAULTPROVIDERTa): Self = StObject.set(x, "taxonomy", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Taxonomy {
    ...
    inline def apply(getCSSClass: (String, SVGGElement) => String, getTextValue: String => String): Taxonomy = {
      val __obj = js.Dynamic.literal(getCSSClass = js.Any.fromFunction2(getCSSClass), getTextValue = js.Any.fromFunction1(getTextValue))
