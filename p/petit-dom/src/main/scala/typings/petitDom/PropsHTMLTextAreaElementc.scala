...
object PropsHTMLTextAreaElementc {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTextAreaElementc, /* ev */ Event_, _]) => Unit = null,
    ...
    onprogress: js.ThisFunction1[PropsHTMLTextAreaElementc, /* ev */ ProgressEvent[EventTarget], _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTextAreaElementc, /* ev */ Event_, _]) => Unit = null,
