...
object PropsSVGFECompositeElemen {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFECompositeElemen, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFECompositeElemen, /* ev */ Event_, _]) => Unit = null,
