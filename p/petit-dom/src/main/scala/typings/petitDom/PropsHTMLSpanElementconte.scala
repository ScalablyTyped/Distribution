...
object PropsHTMLSpanElementconte {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLSpanElementconte, /* ev */ Event_, _]) => Unit = null,
    ...
    onprogress: js.ThisFunction1[PropsHTMLSpanElementconte, /* ev */ ProgressEvent[EventTarget], _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLSpanElementconte, /* ev */ Event_, _]) => Unit = null,
