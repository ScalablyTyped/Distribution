...
object PropsHTMLLIElementcontent {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLLIElementcontent, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLLIElementcontent, /* ev */ Event_, _]) => Unit = null,
