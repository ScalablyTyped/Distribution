...
import typings.petitDom.petitDomStrings.bounce
...
object PropsHTMLMarqueeElementco {
  ...
  def apply(
    ...
    addEventListener: (bounce, /* listener */ js.ThisFunction1[PropsHTMLMarqueeElementco, /* ev */ Event_, _]) => Unit = null,
    ...
    onprogress: js.ThisFunction1[PropsHTMLMarqueeElementco, /* ev */ ProgressEvent[EventTarget], _] = null,
    ...
    removeEventListener: (bounce, /* listener */ js.ThisFunction1[PropsHTMLMarqueeElementco, /* ev */ Event_, _]) => Unit = null,
