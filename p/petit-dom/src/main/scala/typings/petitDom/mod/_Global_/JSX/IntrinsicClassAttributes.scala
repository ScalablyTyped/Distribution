...
trait IntrinsicClassAttributes[T] extends js.Object {
  ...
  var firstElementChild: js.UndefOr[typings.std.Element] = js.undefined
  ...
  var getElementsByClassName: js.UndefOr[js.Function1[/* classNames */ String, HTMLCollectionOf[typings.std.Element]]] = js.undefined
  ...
  var lastElementChild: js.UndefOr[typings.std.Element] = js.undefined
  ...
  var nextElementSibling: js.UndefOr[typings.std.Element] = js.undefined
  ...
  var previousElementSibling: js.UndefOr[typings.std.Element] = js.undefined
...
object IntrinsicClassAttributes {
  ...
  def apply[T](
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event_, _]) => Unit = null,
    ...
    firstElementChild: typings.std.Element = null,
    ...
    getElementsByClassName: /* classNames */ String => HTMLCollectionOf[typings.std.Element] = null,
    ...
    insertAdjacentElement: (/* position */ InsertPosition, /* insertedElement */ typings.std.Element) => typings.std.Element | Null = null,
    ...
    lastElementChild: typings.std.Element = null,
    ...
    nextElementSibling: typings.std.Element = null,
    nextSibling: ChildNode = null,
    nodeName: String = null,
    nodeType: Int | Double = null,
    nodeValue: String = null,
    normalize: () => Unit = null,
    onfullscreenchange: js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event_, _] = null,
    onfullscreenerror: js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event_, _] = null,
    ...
    previousElementSibling: typings.std.Element = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[IntrinsicClassAttributes[T], /* ev */ Event_, _]) => Unit = null,
