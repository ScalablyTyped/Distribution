...
object PetitDom {
  ...
  object Component {
    ...
    implicit open class MutableBuilder[Self <: Component[?], P /* <: ComponentProps */] (val x: Self & Component[P]) extends AnyVal {
      ...
      inline def setUnmount(value: Element => Unit): Self = StObject.set(x, "unmount", js.Any.fromFunction1(value))
    }
  }
