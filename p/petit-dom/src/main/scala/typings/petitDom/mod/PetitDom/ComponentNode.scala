...
object ComponentNode {
  ...
  @scala.inline
  def apply[P /* <: ComponentProps */](content: js.Array[VNode], isSVG: Boolean, props: P with IntrinsicProps, `type`: Component[P]): ComponentNode[P] = {
  ...
  @scala.inline
  implicit class ComponentNodeOps[Self <: ComponentNode[_], P /* <: ComponentProps */] (val x: Self with ComponentNode[P]) extends AnyVal {
