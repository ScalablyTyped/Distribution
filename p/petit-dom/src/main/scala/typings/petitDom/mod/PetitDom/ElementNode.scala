...
object ElementNode {
  @scala.inline
  def apply[/* <: / * import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 * / js.Any */ T, /* <: / * import warning: importer.ImportType#apply Failed type conversion: petit-dom.petit-dom.PetitDom.DomElements[T] * / js.Any */ E](content: js.Array[VNode], isSVG: Boolean, props: Props[E], `type`: T): ElementNode[T, E] = {
  ...
  @scala.inline
  implicit class ElementNodeOps[Self <: ElementNode[_, _], /* <: / * import warning: LimitUnionLength.leaveTypeRef Was union type with length 172 * / js.Any */ T, /* <: / * import warning: importer.ImportType#apply Failed type conversion: petit-dom.petit-dom.PetitDom.DomElements[T] * / js.Any */ E] (val x: Self with (ElementNode[T, E])) extends AnyVal {
    @scala.inline
