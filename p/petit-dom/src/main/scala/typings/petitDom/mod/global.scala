...
import typings.petitDom.mod.PetitDom.IntrinsicProps
...
object global {
  ...
  object JSX {
    ...
    trait IntrinsicElements extends StObject {
      ...
      var search: PropsHTMLElementcontentCo
    ...
    object IntrinsicElements {
      ...
      inline def apply(
        ...
        search: PropsHTMLElementcontentCo,
      ...
      implicit open class MutableBuilder[Self <: IntrinsicElements] (val x: Self) extends AnyVal {
        ...
        inline def setSearch(value: PropsHTMLElementcontentCo): Self = StObject.set(x, "search", value.asInstanceOf[js.Any])
