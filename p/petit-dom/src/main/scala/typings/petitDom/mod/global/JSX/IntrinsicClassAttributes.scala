...
trait IntrinsicClassAttributes[T] extends js.Object {
  ...
  var firstElementChild: js.UndefOr[typings.std.Element | Null] = js.native
  ...
  var getElementsByClassName: js.UndefOr[js.Function1[/* classNames */ String, HTMLCollectionOf[typings.std.Element]]] = js.native
  ...
  var lastElementChild: js.UndefOr[typings.std.Element | Null] = js.native
  ...
  var nextElementSibling: js.UndefOr[typings.std.Element | Null] = js.native
  ...
  var previousElementSibling: js.UndefOr[typings.std.Element | Null] = js.native
...
object IntrinsicClassAttributes {
  ...
  implicit class IntrinsicClassAttributesOps[Self <: IntrinsicClassAttributes[_], T] (val x: Self with IntrinsicClassAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def setFirstElementChild(value: typings.std.Element): Self = this.set("firstElementChild", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setGetElementsByClassName(value: /* classNames */ String => HTMLCollectionOf[typings.std.Element]): Self = this.set("getElementsByClassName", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setLastElementChild(value: typings.std.Element): Self = this.set("lastElementChild", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNextElementSibling(value: typings.std.Element): Self = this.set("nextElementSibling", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPreviousElementSibling(value: typings.std.Element): Self = this.set("previousElementSibling", value.asInstanceOf[js.Any])
    @scala.inline
