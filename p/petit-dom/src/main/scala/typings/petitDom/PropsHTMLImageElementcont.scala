...
import typings.petitDom.petitDomStrings.async
...
import typings.petitDom.petitDomStrings.sync
...
object PropsHTMLImageElementcont {
  ...
  def apply(
    ...
    onprogress: js.ThisFunction1[PropsHTMLImageElementcont, /* ev */ ProgressEvent[EventTarget], _] = null,
