...
object PropsHTMLPreElementconten {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLPreElementconten, /* ev */ Event_, _]) => Unit = null,
    ...
    onprogress: js.ThisFunction1[PropsHTMLPreElementconten, /* ev */ ProgressEvent[EventTarget], _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLPreElementconten, /* ev */ Event_, _]) => Unit = null,
