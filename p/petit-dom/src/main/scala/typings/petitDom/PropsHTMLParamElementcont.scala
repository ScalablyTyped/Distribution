...
object PropsHTMLParamElementcont {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLParamElementcont, /* ev */ Event_, _]) => Unit = null,
    ...
    onprogress: js.ThisFunction1[PropsHTMLParamElementcont, /* ev */ ProgressEvent[EventTarget], _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLParamElementcont, /* ev */ Event_, _]) => Unit = null,
