...
object PropsHTMLFrameSetElementc {
  ...
  implicit class PropsHTMLFrameSetElementcOps[Self <: PropsHTMLFrameSetElementc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnmessage(value: js.ThisFunction1[PropsHTMLFrameSetElementc, /* ev */ MessageEvent, _]): Self = this.set("onmessage", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOnmessage: Self = this.set("onmessage", js.undefined)
    @scala.inline
    def setOnmessageNull: Self = this.set("onmessage", null)
    @scala.inline
    def setOnmessageerror(value: js.ThisFunction1[PropsHTMLFrameSetElementc, /* ev */ MessageEvent, _]): Self = this.set("onmessageerror", value.asInstanceOf[js.Any])
    @scala.inline
