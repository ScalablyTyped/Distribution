...
object PropsSVGUseElementcontent {
  ...
  implicit class PropsSVGUseElementcontentMutableBuilder[Self <: PropsSVGUseElementcontent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGUseElementcontent, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
