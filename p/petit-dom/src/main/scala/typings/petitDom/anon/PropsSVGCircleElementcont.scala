...
object PropsSVGCircleElementcont {
  ...
  implicit class PropsSVGCircleElementcontMutableBuilder[Self <: PropsSVGCircleElementcont] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGCircleElementcont, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
