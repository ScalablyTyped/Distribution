...
trait PropsHTMLObjectElementcon extends StObject {
  ...
  var contentWindow: js.UndefOr[WindowProxy | Null] = js.native
...
object PropsHTMLObjectElementcon {
  ...
  implicit class PropsHTMLObjectElementconMutableBuilder[Self <: PropsHTMLObjectElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLObjectElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
