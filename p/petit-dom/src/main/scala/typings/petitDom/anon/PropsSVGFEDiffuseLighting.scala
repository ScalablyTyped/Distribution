...
object PropsSVGFEDiffuseLighting {
  ...
  implicit class PropsSVGFEDiffuseLightingMutableBuilder[Self <: PropsSVGFEDiffuseLighting] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFEDiffuseLighting, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
