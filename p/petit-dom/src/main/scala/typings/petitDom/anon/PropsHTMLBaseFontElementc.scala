...
object PropsHTMLBaseFontElementc {
  ...
  implicit class PropsHTMLBaseFontElementcMutableBuilder[Self <: PropsHTMLBaseFontElementc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLBaseFontElementc, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
