...
object PropsHTMLTableRowElementc {
  ...
  implicit class PropsHTMLTableRowElementcMutableBuilder[Self <: PropsHTMLTableRowElementc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLTableRowElementc, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
