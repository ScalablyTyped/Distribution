...
object PropsHTMLTableDataCellEle {
  ...
  implicit class PropsHTMLTableDataCellEleMutableBuilder[Self <: PropsHTMLTableDataCellEle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLTableDataCellEle, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
