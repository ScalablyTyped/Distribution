...
object PropsHTMLTrackElementcont {
  ...
  implicit class PropsHTMLTrackElementcontMutableBuilder[Self <: PropsHTMLTrackElementcont] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLTrackElementcont, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
