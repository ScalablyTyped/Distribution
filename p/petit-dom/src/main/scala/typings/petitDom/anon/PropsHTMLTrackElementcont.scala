...
trait PropsHTMLTrackElementcont extends StObject {
  ...
  var LOADED: js.UndefOr[`2`] = js.undefined
  
  var LOADING: js.UndefOr[`1`] = js.undefined
...
object PropsHTMLTrackElementcont {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PropsHTMLTrackElementcont] (val x: Self) extends AnyVal {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLTrackElementcont, /* ev */ Event, Any]) => Unit
    ...
    inline def setOnbeforeinput(value: js.ThisFunction1[PropsHTMLTrackElementcont, /* ev */ InputEvent, Any]): Self = StObject.set(x, "onbeforeinput", value.asInstanceOf[js.Any])
    ...
    inline def setOncancel(value: js.ThisFunction1[PropsHTMLTrackElementcont, /* ev */ Event, Any]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsHTMLTrackElementcont, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
