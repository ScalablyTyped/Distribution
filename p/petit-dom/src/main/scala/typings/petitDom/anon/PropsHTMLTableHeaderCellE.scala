...
object PropsHTMLTableHeaderCellE {
  ...
  implicit class PropsHTMLTableHeaderCellEMutableBuilder[Self <: PropsHTMLTableHeaderCellE] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLTableHeaderCellE, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
