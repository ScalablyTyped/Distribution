...
object PropsSVGFEFuncBElementcon {
  ...
  implicit class PropsSVGFEFuncBElementconMutableBuilder[Self <: PropsSVGFEFuncBElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFEFuncBElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
