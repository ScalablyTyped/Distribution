...
object PropsSVGFEGaussianBlurEle {
  ...
  implicit class PropsSVGFEGaussianBlurEleMutableBuilder[Self <: PropsSVGFEGaussianBlurEle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFEGaussianBlurEle, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
