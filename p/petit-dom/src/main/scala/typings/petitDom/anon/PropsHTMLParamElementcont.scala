...
object PropsHTMLParamElementcont {
  ...
  implicit class PropsHTMLParamElementcontMutableBuilder[Self <: PropsHTMLParamElementcont] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLParamElementcont, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
