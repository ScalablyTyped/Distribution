...
object PropsSVGEllipseElementcon {
  ...
  implicit class PropsSVGEllipseElementconMutableBuilder[Self <: PropsSVGEllipseElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGEllipseElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
