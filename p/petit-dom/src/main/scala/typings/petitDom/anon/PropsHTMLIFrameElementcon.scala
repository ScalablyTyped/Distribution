...
object PropsHTMLIFrameElementcon {
  ...
  implicit class PropsHTMLIFrameElementconMutableBuilder[Self <: PropsHTMLIFrameElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLIFrameElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
