...
object PropsHTMLIFrameElementcon {
  ...
  implicit class PropsHTMLIFrameElementconOps[Self <: PropsHTMLIFrameElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentWindow(value: WindowProxy): Self = this.set("contentWindow", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLIFrameElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = this.set("onprogress", value.asInstanceOf[js.Any])
    @scala.inline
