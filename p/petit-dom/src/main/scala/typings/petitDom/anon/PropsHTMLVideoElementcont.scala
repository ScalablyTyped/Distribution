...
import typings.petitDom.petitDomStrings._empty
import typings.petitDom.petitDomStrings.a
import typings.petitDom.petitDomStrings.auto
import typings.petitDom.petitDomStrings.enterpictureinpicture
import typings.petitDom.petitDomStrings.httpColonSlashSlashwwwDotw3DotorgSlash1999Slashxhtml
import typings.petitDom.petitDomStrings.metadata
...
import typings.std.RemotePlayback
...
import typings.std.VideoFrameRequestCallback
...
trait PropsHTMLVideoElementcont extends StObject {
  ...
  var HAVE_CURRENT_DATA: js.UndefOr[`2`] = js.undefined
  
  var HAVE_ENOUGH_DATA: js.UndefOr[`4`] = js.undefined
  
  var HAVE_FUTURE_DATA: js.UndefOr[`3`] = js.undefined
  
  var HAVE_METADATA: js.UndefOr[`1`] = js.undefined
  
  var HAVE_NOTHING: js.UndefOr[`0`] = js.undefined
  
  var NETWORK_EMPTY: js.UndefOr[`0`] = js.undefined
  
  var NETWORK_IDLE: js.UndefOr[`1`] = js.undefined
  
  var NETWORK_LOADING: js.UndefOr[`2`] = js.undefined
  
  var NETWORK_NO_SOURCE: js.UndefOr[`3`] = js.undefined
...
object PropsHTMLVideoElementcont {
  ...
  implicit open class MutableBuilder[Self <: PropsHTMLVideoElementcont] (val x: Self) extends AnyVal {
    ...
    inline def setAddEventListener(
      value: (enterpictureinpicture, /* listener */ js.ThisFunction1[PropsHTMLVideoElementcont, /* ev */ Event, Any]) => Unit
    ...
    inline def setCancelVideoFrameCallback(value: /* handle */ Double => Unit): Self = StObject.set(x, "cancelVideoFrameCallback", js.Any.fromFunction1(value))
    ...
    inline def setOnbeforeinput(value: js.ThisFunction1[PropsHTMLVideoElementcont, /* ev */ InputEvent, Any]): Self = StObject.set(x, "onbeforeinput", value.asInstanceOf[js.Any])
    ...
    inline def setOncancel(value: js.ThisFunction1[PropsHTMLVideoElementcont, /* ev */ Event, Any]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsHTMLVideoElementcont, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
    ...
    inline def setRequestPictureInPicture(value: () => js.Promise[PictureInPictureWindow]): Self = StObject.set(x, "requestPictureInPicture", js.Any.fromFunction0(value))
