...
object PropsSVGPathElementconten {
  ...
  implicit class PropsSVGPathElementcontenMutableBuilder[Self <: PropsSVGPathElementconten] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGPathElementconten, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
