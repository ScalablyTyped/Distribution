...
trait PropsSVGFECompositeElemen extends StObject {
  ...
  var SVG_FECOMPOSITE_OPERATOR_ARITHMETIC: js.UndefOr[`6`] = js.undefined
  
  var SVG_FECOMPOSITE_OPERATOR_ATOP: js.UndefOr[`4`] = js.undefined
  
  var SVG_FECOMPOSITE_OPERATOR_IN: js.UndefOr[`2`] = js.undefined
  
  var SVG_FECOMPOSITE_OPERATOR_OUT: js.UndefOr[`3`] = js.undefined
  
  var SVG_FECOMPOSITE_OPERATOR_OVER: js.UndefOr[`1`] = js.undefined
  
  var SVG_FECOMPOSITE_OPERATOR_UNKNOWN: js.UndefOr[`0`] = js.undefined
  
  var SVG_FECOMPOSITE_OPERATOR_XOR: js.UndefOr[`5`] = js.undefined
...
object PropsSVGFECompositeElemen {
  ...
  implicit open class MutableBuilder[Self <: PropsSVGFECompositeElemen] (val x: Self) extends AnyVal {
    ...
    inline def setSVG_FECOMPOSITE_OPERATOR_ARITHMETIC(value: `6`): Self = StObject.set(x, "SVG_FECOMPOSITE_OPERATOR_ARITHMETIC", value.asInstanceOf[js.Any])
    ...
    inline def setSVG_FECOMPOSITE_OPERATOR_ATOP(value: `4`): Self = StObject.set(x, "SVG_FECOMPOSITE_OPERATOR_ATOP", value.asInstanceOf[js.Any])
    
    inline def setSVG_FECOMPOSITE_OPERATOR_ATOPUndefined: Self = StObject.set(x, "SVG_FECOMPOSITE_OPERATOR_ATOP", js.undefined)
    
    inline def setSVG_FECOMPOSITE_OPERATOR_IN(value: `2`): Self = StObject.set(x, "SVG_FECOMPOSITE_OPERATOR_IN", value.asInstanceOf[js.Any])
    
    inline def setSVG_FECOMPOSITE_OPERATOR_INUndefined: Self = StObject.set(x, "SVG_FECOMPOSITE_OPERATOR_IN", js.undefined)
    
    inline def setSVG_FECOMPOSITE_OPERATOR_OUT(value: `3`): Self = StObject.set(x, "SVG_FECOMPOSITE_OPERATOR_OUT", value.asInstanceOf[js.Any])
    
    inline def setSVG_FECOMPOSITE_OPERATOR_OUTUndefined: Self = StObject.set(x, "SVG_FECOMPOSITE_OPERATOR_OUT", js.undefined)
    
    inline def setSVG_FECOMPOSITE_OPERATOR_OVER(value: `1`): Self = StObject.set(x, "SVG_FECOMPOSITE_OPERATOR_OVER", value.asInstanceOf[js.Any])
    
    inline def setSVG_FECOMPOSITE_OPERATOR_OVERUndefined: Self = StObject.set(x, "SVG_FECOMPOSITE_OPERATOR_OVER", js.undefined)
    
    inline def setSVG_FECOMPOSITE_OPERATOR_UNKNOWN(value: `0`): Self = StObject.set(x, "SVG_FECOMPOSITE_OPERATOR_UNKNOWN", value.asInstanceOf[js.Any])
    ...
    inline def setSVG_FECOMPOSITE_OPERATOR_XOR(value: `5`): Self = StObject.set(x, "SVG_FECOMPOSITE_OPERATOR_XOR", value.asInstanceOf[js.Any])
