...
object PropsSVGPolygonElementcon {
  ...
  implicit class PropsSVGPolygonElementconMutableBuilder[Self <: PropsSVGPolygonElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGPolygonElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
