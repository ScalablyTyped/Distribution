...
object PropsHTMLButtonElementcon {
  ...
  implicit class PropsHTMLButtonElementconMutableBuilder[Self <: PropsHTMLButtonElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLButtonElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
