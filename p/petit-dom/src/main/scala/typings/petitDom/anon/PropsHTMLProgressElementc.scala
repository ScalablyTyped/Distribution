...
object PropsHTMLProgressElementc {
  ...
  implicit class PropsHTMLProgressElementcMutableBuilder[Self <: PropsHTMLProgressElementc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLProgressElementc, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
