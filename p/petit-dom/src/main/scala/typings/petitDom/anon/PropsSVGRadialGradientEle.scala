...
object PropsSVGRadialGradientEle {
  ...
  implicit class PropsSVGRadialGradientEleMutableBuilder[Self <: PropsSVGRadialGradientEle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGRadialGradientEle, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
