...
object PropsSVGRadialGradientEle {
  ...
  implicit open class MutableBuilder[Self <: PropsSVGRadialGradientEle] (val x: Self) extends AnyVal {
    ...
    inline def setSVG_SPREADMETHOD_PAD(value: Double): Self = StObject.set(x, "SVG_SPREADMETHOD_PAD", value.asInstanceOf[js.Any])
    
    inline def setSVG_SPREADMETHOD_PADUndefined: Self = StObject.set(x, "SVG_SPREADMETHOD_PAD", js.undefined)
    
    inline def setSVG_SPREADMETHOD_REFLECT(value: Double): Self = StObject.set(x, "SVG_SPREADMETHOD_REFLECT", value.asInstanceOf[js.Any])
    
    inline def setSVG_SPREADMETHOD_REFLECTUndefined: Self = StObject.set(x, "SVG_SPREADMETHOD_REFLECT", js.undefined)
    
    inline def setSVG_SPREADMETHOD_REPEAT(value: Double): Self = StObject.set(x, "SVG_SPREADMETHOD_REPEAT", value.asInstanceOf[js.Any])
    
    inline def setSVG_SPREADMETHOD_REPEATUndefined: Self = StObject.set(x, "SVG_SPREADMETHOD_REPEAT", js.undefined)
    
    inline def setSVG_SPREADMETHOD_UNKNOWN(value: Double): Self = StObject.set(x, "SVG_SPREADMETHOD_UNKNOWN", value.asInstanceOf[js.Any])
