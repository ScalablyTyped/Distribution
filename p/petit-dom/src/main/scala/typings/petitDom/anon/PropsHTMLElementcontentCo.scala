...
object PropsHTMLElementcontentCo {
  ...
  implicit class PropsHTMLElementcontentCoMutableBuilder[Self <: PropsHTMLElementcontentCo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLElementcontentCo, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
