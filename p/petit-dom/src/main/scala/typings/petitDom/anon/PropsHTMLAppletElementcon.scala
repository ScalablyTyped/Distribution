...
object PropsHTMLAppletElementcon {
  ...
  implicit class PropsHTMLAppletElementconMutableBuilder[Self <: PropsHTMLAppletElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLAppletElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
