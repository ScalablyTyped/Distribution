...
object PropsSVGFEOffsetElementco {
  ...
  implicit class PropsSVGFEOffsetElementcoMutableBuilder[Self <: PropsSVGFEOffsetElementco] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFEOffsetElementco, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
