...
object PropsElement {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsElement, /* ev */ Event, _]) => Unit = null,
    ...
    normalize: () => Unit = null,
    onfullscreenchange: js.ThisFunction1[PropsElement, /* ev */ Event, _] = null,
    onfullscreenerror: js.ThisFunction1[PropsElement, /* ev */ Event, _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsElement, /* ev */ Event, _]) => Unit = null,
