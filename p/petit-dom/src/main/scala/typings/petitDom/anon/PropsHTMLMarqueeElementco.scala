...
object PropsHTMLMarqueeElementco {
  ...
  implicit class PropsHTMLMarqueeElementcoMutableBuilder[Self <: PropsHTMLMarqueeElementco] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLMarqueeElementco, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
