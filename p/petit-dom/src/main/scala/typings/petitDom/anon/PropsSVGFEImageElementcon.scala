...
object PropsSVGFEImageElementcon {
  ...
  implicit class PropsSVGFEImageElementconMutableBuilder[Self <: PropsSVGFEImageElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFEImageElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
