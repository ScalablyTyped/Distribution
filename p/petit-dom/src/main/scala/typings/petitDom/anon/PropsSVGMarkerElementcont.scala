...
object PropsSVGMarkerElementcont {
  ...
  implicit open class MutableBuilder[Self <: PropsSVGMarkerElementcont] (val x: Self) extends AnyVal {
    ...
    inline def setSVG_MARKERUNITS_UNKNOWN(value: Double): Self = StObject.set(x, "SVG_MARKERUNITS_UNKNOWN", value.asInstanceOf[js.Any])
    
    inline def setSVG_MARKERUNITS_UNKNOWNUndefined: Self = StObject.set(x, "SVG_MARKERUNITS_UNKNOWN", js.undefined)
    
    inline def setSVG_MARKERUNITS_USERSPACEONUSE(value: Double): Self = StObject.set(x, "SVG_MARKERUNITS_USERSPACEONUSE", value.asInstanceOf[js.Any])
    
    inline def setSVG_MARKERUNITS_USERSPACEONUSEUndefined: Self = StObject.set(x, "SVG_MARKERUNITS_USERSPACEONUSE", js.undefined)
    
    inline def setSVG_MARKER_ORIENT_ANGLE(value: Double): Self = StObject.set(x, "SVG_MARKER_ORIENT_ANGLE", value.asInstanceOf[js.Any])
    
    inline def setSVG_MARKER_ORIENT_ANGLEUndefined: Self = StObject.set(x, "SVG_MARKER_ORIENT_ANGLE", js.undefined)
    
    inline def setSVG_MARKER_ORIENT_AUTO(value: Double): Self = StObject.set(x, "SVG_MARKER_ORIENT_AUTO", value.asInstanceOf[js.Any])
    
    inline def setSVG_MARKER_ORIENT_AUTOUndefined: Self = StObject.set(x, "SVG_MARKER_ORIENT_AUTO", js.undefined)
    
    inline def setSVG_MARKER_ORIENT_UNKNOWN(value: Double): Self = StObject.set(x, "SVG_MARKER_ORIENT_UNKNOWN", value.asInstanceOf[js.Any])
