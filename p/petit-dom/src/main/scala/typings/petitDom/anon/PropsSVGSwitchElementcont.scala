...
object PropsSVGSwitchElementcont {
  ...
  implicit class PropsSVGSwitchElementcontMutableBuilder[Self <: PropsSVGSwitchElementcont] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGSwitchElementcont, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
