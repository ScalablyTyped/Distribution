...
trait PropsSVGFEMorphologyEleme extends StObject {
  ...
  var SVG_MORPHOLOGY_OPERATOR_DILATE: js.UndefOr[`2`] = js.undefined
  
  var SVG_MORPHOLOGY_OPERATOR_ERODE: js.UndefOr[`1`] = js.undefined
  
  var SVG_MORPHOLOGY_OPERATOR_UNKNOWN: js.UndefOr[`0`] = js.undefined
...
object PropsSVGFEMorphologyEleme {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PropsSVGFEMorphologyEleme] (val x: Self) extends AnyVal {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEMorphologyEleme, /* ev */ Event, Any]) => Unit
    ...
    inline def setOnbeforeinput(value: js.ThisFunction1[PropsSVGFEMorphologyEleme, /* ev */ InputEvent, Any]): Self = StObject.set(x, "onbeforeinput", value.asInstanceOf[js.Any])
    ...
    inline def setOncancel(value: js.ThisFunction1[PropsSVGFEMorphologyEleme, /* ev */ Event, Any]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsSVGFEMorphologyEleme, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
    ...
    inline def setSVG_MORPHOLOGY_OPERATOR_DILATE(value: `2`): Self = StObject.set(x, "SVG_MORPHOLOGY_OPERATOR_DILATE", value.asInstanceOf[js.Any])
    
    inline def setSVG_MORPHOLOGY_OPERATOR_DILATEUndefined: Self = StObject.set(x, "SVG_MORPHOLOGY_OPERATOR_DILATE", js.undefined)
    
    inline def setSVG_MORPHOLOGY_OPERATOR_ERODE(value: `1`): Self = StObject.set(x, "SVG_MORPHOLOGY_OPERATOR_ERODE", value.asInstanceOf[js.Any])
    
    inline def setSVG_MORPHOLOGY_OPERATOR_ERODEUndefined: Self = StObject.set(x, "SVG_MORPHOLOGY_OPERATOR_ERODE", js.undefined)
    
    inline def setSVG_MORPHOLOGY_OPERATOR_UNKNOWN(value: `0`): Self = StObject.set(x, "SVG_MORPHOLOGY_OPERATOR_UNKNOWN", value.asInstanceOf[js.Any])
