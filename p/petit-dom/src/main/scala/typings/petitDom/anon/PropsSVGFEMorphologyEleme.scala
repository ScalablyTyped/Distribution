...
object PropsSVGFEMorphologyEleme {
  ...
  implicit class PropsSVGFEMorphologyElemeMutableBuilder[Self <: PropsSVGFEMorphologyEleme] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFEMorphologyEleme, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
