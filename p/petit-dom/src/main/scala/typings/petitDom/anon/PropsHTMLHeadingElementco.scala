...
object PropsHTMLHeadingElementco {
  ...
  implicit class PropsHTMLHeadingElementcoMutableBuilder[Self <: PropsHTMLHeadingElementco] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLHeadingElementco, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
