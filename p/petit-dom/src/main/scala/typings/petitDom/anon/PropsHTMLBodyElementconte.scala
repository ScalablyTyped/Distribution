...
object PropsHTMLBodyElementconte {
  ...
  implicit open class MutableBuilder[Self <: PropsHTMLBodyElementconte] (val x: Self) extends AnyVal {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ Event, Any]) => Unit
    ...
    inline def setOnbeforeinput(value: js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ InputEvent, Any]): Self = StObject.set(x, "onbeforeinput", value.asInstanceOf[js.Any])
    ...
    inline def setOncancel(value: js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ Event, Any]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
    ...
    inline def setOnmessage(value: js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ MessageEvent[Any], Any]): Self = StObject.set(x, "onmessage", value.asInstanceOf[js.Any])
    ...
    inline def setOnmessageerror(value: js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ MessageEvent[Any], Any]): Self = StObject.set(x, "onmessageerror", value.asInstanceOf[js.Any])
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
