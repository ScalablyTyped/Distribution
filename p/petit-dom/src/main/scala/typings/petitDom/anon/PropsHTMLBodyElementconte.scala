...
object PropsHTMLBodyElementconte {
  ...
  implicit class PropsHTMLBodyElementconteOps[Self <: PropsHTMLBodyElementconte] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnmessage(value: js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ MessageEvent, _]): Self = this.set("onmessage", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOnmessage: Self = this.set("onmessage", js.undefined)
    @scala.inline
    def setOnmessageNull: Self = this.set("onmessage", null)
    @scala.inline
    def setOnmessageerror(value: js.ThisFunction1[PropsHTMLBodyElementconte, /* ev */ MessageEvent, _]): Self = this.set("onmessageerror", value.asInstanceOf[js.Any])
    @scala.inline
