...
object PropsHTMLSelectElementcon {
  ...
  implicit class PropsHTMLSelectElementconMutableBuilder[Self <: PropsHTMLSelectElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLSelectElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
