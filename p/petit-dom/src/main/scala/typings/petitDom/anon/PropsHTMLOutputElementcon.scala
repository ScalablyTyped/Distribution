...
object PropsHTMLOutputElementcon {
  ...
  implicit class PropsHTMLOutputElementconMutableBuilder[Self <: PropsHTMLOutputElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLOutputElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
