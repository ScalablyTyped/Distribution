...
trait PropsSVGFEConvolveMatrixE extends StObject {
  ...
  var SVG_EDGEMODE_DUPLICATE: js.UndefOr[`1`] = js.undefined
  
  var SVG_EDGEMODE_NONE: js.UndefOr[`3`] = js.undefined
  
  var SVG_EDGEMODE_UNKNOWN: js.UndefOr[`0`] = js.undefined
  
  var SVG_EDGEMODE_WRAP: js.UndefOr[`2`] = js.undefined
...
object PropsSVGFEConvolveMatrixE {
  ...
  implicit open class MutableBuilder[Self <: PropsSVGFEConvolveMatrixE] (val x: Self) extends AnyVal {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEConvolveMatrixE, /* ev */ Event, Any]) => Unit
    ...
    inline def setOnbeforeinput(value: js.ThisFunction1[PropsSVGFEConvolveMatrixE, /* ev */ InputEvent, Any]): Self = StObject.set(x, "onbeforeinput", value.asInstanceOf[js.Any])
    ...
    inline def setOncancel(value: js.ThisFunction1[PropsSVGFEConvolveMatrixE, /* ev */ Event, Any]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsSVGFEConvolveMatrixE, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
    ...
    inline def setSVG_EDGEMODE_DUPLICATE(value: `1`): Self = StObject.set(x, "SVG_EDGEMODE_DUPLICATE", value.asInstanceOf[js.Any])
    
    inline def setSVG_EDGEMODE_DUPLICATEUndefined: Self = StObject.set(x, "SVG_EDGEMODE_DUPLICATE", js.undefined)
    
    inline def setSVG_EDGEMODE_NONE(value: `3`): Self = StObject.set(x, "SVG_EDGEMODE_NONE", value.asInstanceOf[js.Any])
    
    inline def setSVG_EDGEMODE_NONEUndefined: Self = StObject.set(x, "SVG_EDGEMODE_NONE", js.undefined)
    
    inline def setSVG_EDGEMODE_UNKNOWN(value: `0`): Self = StObject.set(x, "SVG_EDGEMODE_UNKNOWN", value.asInstanceOf[js.Any])
    
    inline def setSVG_EDGEMODE_UNKNOWNUndefined: Self = StObject.set(x, "SVG_EDGEMODE_UNKNOWN", js.undefined)
    
    inline def setSVG_EDGEMODE_WRAP(value: `2`): Self = StObject.set(x, "SVG_EDGEMODE_WRAP", value.asInstanceOf[js.Any])
