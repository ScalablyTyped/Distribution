...
object PropsSVGFESpotLightElemen {
  ...
  implicit class PropsSVGFESpotLightElemenMutableBuilder[Self <: PropsSVGFESpotLightElemen] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFESpotLightElemen, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
