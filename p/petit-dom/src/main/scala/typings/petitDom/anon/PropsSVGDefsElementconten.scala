...
object PropsSVGDefsElementconten {
  ...
  implicit class PropsSVGDefsElementcontenMutableBuilder[Self <: PropsSVGDefsElementconten] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGDefsElementconten, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
