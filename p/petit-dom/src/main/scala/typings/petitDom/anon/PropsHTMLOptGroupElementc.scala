...
object PropsHTMLOptGroupElementc {
  ...
  implicit class PropsHTMLOptGroupElementcMutableBuilder[Self <: PropsHTMLOptGroupElementc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLOptGroupElementc, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
