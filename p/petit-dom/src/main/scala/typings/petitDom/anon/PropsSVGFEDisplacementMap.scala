...
object PropsSVGFEDisplacementMap {
  ...
  implicit class PropsSVGFEDisplacementMapMutableBuilder[Self <: PropsSVGFEDisplacementMap] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFEDisplacementMap, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
