...
object PropsHTMLMenuElementconte {
  ...
  implicit class PropsHTMLMenuElementconteMutableBuilder[Self <: PropsHTMLMenuElementconte] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLMenuElementconte, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
