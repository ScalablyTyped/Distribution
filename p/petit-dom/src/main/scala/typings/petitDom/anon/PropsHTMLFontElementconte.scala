...
object PropsHTMLFontElementconte {
  ...
  implicit class PropsHTMLFontElementconteMutableBuilder[Self <: PropsHTMLFontElementconte] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLFontElementconte, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
