...
object PropsHTMLCanvasElementcon {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PropsHTMLCanvasElementcon] (val x: Self) extends AnyVal {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLCanvasElementcon, /* ev */ Event, Any]) => Unit
    ...
    inline def setCaptureStream(value: () => MediaStream): Self = StObject.set(x, "captureStream", js.Any.fromFunction0(value))
    ...
    inline def setOnbeforeinput(value: js.ThisFunction1[PropsHTMLCanvasElementcon, /* ev */ InputEvent, Any]): Self = StObject.set(x, "onbeforeinput", value.asInstanceOf[js.Any])
    ...
    inline def setOncancel(value: js.ThisFunction1[PropsHTMLCanvasElementcon, /* ev */ Event, Any]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsHTMLCanvasElementcon, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
