...
object PropsHTMLCanvasElementcon {
  ...
  implicit class PropsHTMLCanvasElementconMutableBuilder[Self <: PropsHTMLCanvasElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLCanvasElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
