...
object PropsHTMLPreElementconten {
  ...
  implicit class PropsHTMLPreElementcontenMutableBuilder[Self <: PropsHTMLPreElementconten] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLPreElementconten, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
