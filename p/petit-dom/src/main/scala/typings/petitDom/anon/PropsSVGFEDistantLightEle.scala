...
object PropsSVGFEDistantLightEle {
  ...
  implicit class PropsSVGFEDistantLightEleMutableBuilder[Self <: PropsSVGFEDistantLightEle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFEDistantLightEle, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
