...
object PropsHTMLTimeElementconte {
  ...
  implicit class PropsHTMLTimeElementconteMutableBuilder[Self <: PropsHTMLTimeElementconte] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLTimeElementconte, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
