...
object PropsSVGTextElementconten {
  ...
  implicit class PropsSVGTextElementcontenMutableBuilder[Self <: PropsSVGTextElementconten] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGTextElementconten, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
