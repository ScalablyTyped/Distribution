...
object PropsHTMLMapElementconten {
  ...
  implicit class PropsHTMLMapElementcontenMutableBuilder[Self <: PropsHTMLMapElementconten] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLMapElementconten, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
