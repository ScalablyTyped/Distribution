...
object PropsHTMLTextAreaElementc {
  ...
  implicit class PropsHTMLTextAreaElementcMutableBuilder[Self <: PropsHTMLTextAreaElementc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLTextAreaElementc, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
