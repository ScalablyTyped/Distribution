...
object PropsHTMLAudioElementcont {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PropsHTMLAudioElementcont] (val x: Self) extends AnyVal {
    ...
    inline def setAddEventListener(
      value: (encrypted, /* listener */ js.ThisFunction1[PropsHTMLAudioElementcont, /* ev */ MediaEncryptedEvent, Any]) => Unit
    ...
    inline def setOnbeforeinput(value: js.ThisFunction1[PropsHTMLAudioElementcont, /* ev */ InputEvent, Any]): Self = StObject.set(x, "onbeforeinput", value.asInstanceOf[js.Any])
    ...
    inline def setOncancel(value: js.ThisFunction1[PropsHTMLAudioElementcont, /* ev */ Event, Any]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsHTMLAudioElementcont, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
