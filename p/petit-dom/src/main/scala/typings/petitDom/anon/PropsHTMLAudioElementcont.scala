...
object PropsHTMLAudioElementcont {
  ...
  implicit class PropsHTMLAudioElementcontMutableBuilder[Self <: PropsHTMLAudioElementcont] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLAudioElementcont, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
