...
object PropsHTMLEmbedElementcont {
  ...
  implicit class PropsHTMLEmbedElementcontMutableBuilder[Self <: PropsHTMLEmbedElementcont] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLEmbedElementcont, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
