...
object PropsHTMLSpanElementconte {
  ...
  implicit class PropsHTMLSpanElementconteMutableBuilder[Self <: PropsHTMLSpanElementconte] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLSpanElementconte, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
