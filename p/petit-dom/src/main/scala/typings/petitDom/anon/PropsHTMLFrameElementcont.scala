...
object PropsHTMLFrameElementcont {
  ...
  implicit class PropsHTMLFrameElementcontMutableBuilder[Self <: PropsHTMLFrameElementcont] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLFrameElementcont, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
