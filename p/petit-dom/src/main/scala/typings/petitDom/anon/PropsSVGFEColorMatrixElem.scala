...
object PropsSVGFEColorMatrixElem {
  ...
  extension [Self <: PropsSVGFEColorMatrixElem](x: Self) {
    ...
    inline def setSVG_FECOLORMATRIX_TYPE_HUEROTATE(value: Double): Self = StObject.set(x, "SVG_FECOLORMATRIX_TYPE_HUEROTATE", value.asInstanceOf[js.Any])
    ...
    inline def setSVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA(value: Double): Self = StObject.set(x, "SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA", value.asInstanceOf[js.Any])
    ...
    inline def setSVG_FECOLORMATRIX_TYPE_MATRIX(value: Double): Self = StObject.set(x, "SVG_FECOLORMATRIX_TYPE_MATRIX", value.asInstanceOf[js.Any])
    
    inline def setSVG_FECOLORMATRIX_TYPE_MATRIXUndefined: Self = StObject.set(x, "SVG_FECOLORMATRIX_TYPE_MATRIX", js.undefined)
    
    inline def setSVG_FECOLORMATRIX_TYPE_SATURATE(value: Double): Self = StObject.set(x, "SVG_FECOLORMATRIX_TYPE_SATURATE", value.asInstanceOf[js.Any])
    
    inline def setSVG_FECOLORMATRIX_TYPE_SATURATEUndefined: Self = StObject.set(x, "SVG_FECOLORMATRIX_TYPE_SATURATE", js.undefined)
    
    inline def setSVG_FECOLORMATRIX_TYPE_UNKNOWN(value: Double): Self = StObject.set(x, "SVG_FECOLORMATRIX_TYPE_UNKNOWN", value.asInstanceOf[js.Any])
