...
object PropsSVGFEColorMatrixElem {
  ...
  implicit class PropsSVGFEColorMatrixElemMutableBuilder[Self <: PropsSVGFEColorMatrixElem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFEColorMatrixElem, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
