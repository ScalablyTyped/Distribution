...
object PropsHTMLHeadElementconte {
  ...
  implicit class PropsHTMLHeadElementconteMutableBuilder[Self <: PropsHTMLHeadElementconte] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLHeadElementconte, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
