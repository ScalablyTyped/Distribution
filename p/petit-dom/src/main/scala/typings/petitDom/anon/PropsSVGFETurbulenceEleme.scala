...
object PropsSVGFETurbulenceEleme {
  ...
  extension [Self <: PropsSVGFETurbulenceEleme](x: Self) {
    ...
    inline def setSVG_STITCHTYPE_NOSTITCH(value: Double): Self = StObject.set(x, "SVG_STITCHTYPE_NOSTITCH", value.asInstanceOf[js.Any])
    
    inline def setSVG_STITCHTYPE_NOSTITCHUndefined: Self = StObject.set(x, "SVG_STITCHTYPE_NOSTITCH", js.undefined)
    
    inline def setSVG_STITCHTYPE_STITCH(value: Double): Self = StObject.set(x, "SVG_STITCHTYPE_STITCH", value.asInstanceOf[js.Any])
    
    inline def setSVG_STITCHTYPE_STITCHUndefined: Self = StObject.set(x, "SVG_STITCHTYPE_STITCH", js.undefined)
    
    inline def setSVG_STITCHTYPE_UNKNOWN(value: Double): Self = StObject.set(x, "SVG_STITCHTYPE_UNKNOWN", value.asInstanceOf[js.Any])
    
    inline def setSVG_STITCHTYPE_UNKNOWNUndefined: Self = StObject.set(x, "SVG_STITCHTYPE_UNKNOWN", js.undefined)
    
    inline def setSVG_TURBULENCE_TYPE_FRACTALNOISE(value: Double): Self = StObject.set(x, "SVG_TURBULENCE_TYPE_FRACTALNOISE", value.asInstanceOf[js.Any])
    ...
    inline def setSVG_TURBULENCE_TYPE_TURBULENCE(value: Double): Self = StObject.set(x, "SVG_TURBULENCE_TYPE_TURBULENCE", value.asInstanceOf[js.Any])
    
    inline def setSVG_TURBULENCE_TYPE_TURBULENCEUndefined: Self = StObject.set(x, "SVG_TURBULENCE_TYPE_TURBULENCE", js.undefined)
    
    inline def setSVG_TURBULENCE_TYPE_UNKNOWN(value: Double): Self = StObject.set(x, "SVG_TURBULENCE_TYPE_UNKNOWN", value.asInstanceOf[js.Any])
