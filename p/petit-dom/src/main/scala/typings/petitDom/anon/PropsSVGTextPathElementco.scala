...
object PropsSVGTextPathElementco {
  ...
  implicit open class MutableBuilder[Self <: PropsSVGTextPathElementco] (val x: Self) extends AnyVal {
    ...
    inline def setTEXTPATH_METHODTYPE_ALIGN(value: Double): Self = StObject.set(x, "TEXTPATH_METHODTYPE_ALIGN", value.asInstanceOf[js.Any])
    
    inline def setTEXTPATH_METHODTYPE_ALIGNUndefined: Self = StObject.set(x, "TEXTPATH_METHODTYPE_ALIGN", js.undefined)
    
    inline def setTEXTPATH_METHODTYPE_STRETCH(value: Double): Self = StObject.set(x, "TEXTPATH_METHODTYPE_STRETCH", value.asInstanceOf[js.Any])
    
    inline def setTEXTPATH_METHODTYPE_STRETCHUndefined: Self = StObject.set(x, "TEXTPATH_METHODTYPE_STRETCH", js.undefined)
    
    inline def setTEXTPATH_METHODTYPE_UNKNOWN(value: Double): Self = StObject.set(x, "TEXTPATH_METHODTYPE_UNKNOWN", value.asInstanceOf[js.Any])
    
    inline def setTEXTPATH_METHODTYPE_UNKNOWNUndefined: Self = StObject.set(x, "TEXTPATH_METHODTYPE_UNKNOWN", js.undefined)
    
    inline def setTEXTPATH_SPACINGTYPE_AUTO(value: Double): Self = StObject.set(x, "TEXTPATH_SPACINGTYPE_AUTO", value.asInstanceOf[js.Any])
    
    inline def setTEXTPATH_SPACINGTYPE_AUTOUndefined: Self = StObject.set(x, "TEXTPATH_SPACINGTYPE_AUTO", js.undefined)
    
    inline def setTEXTPATH_SPACINGTYPE_EXACT(value: Double): Self = StObject.set(x, "TEXTPATH_SPACINGTYPE_EXACT", value.asInstanceOf[js.Any])
    
    inline def setTEXTPATH_SPACINGTYPE_EXACTUndefined: Self = StObject.set(x, "TEXTPATH_SPACINGTYPE_EXACT", js.undefined)
    
    inline def setTEXTPATH_SPACINGTYPE_UNKNOWN(value: Double): Self = StObject.set(x, "TEXTPATH_SPACINGTYPE_UNKNOWN", value.asInstanceOf[js.Any])
