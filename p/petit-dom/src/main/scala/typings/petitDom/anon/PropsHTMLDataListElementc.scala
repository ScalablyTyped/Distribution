...
object PropsHTMLDataListElementc {
  ...
  implicit class PropsHTMLDataListElementcMutableBuilder[Self <: PropsHTMLDataListElementc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLDataListElementc, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
