...
object PropsHTMLInputElementcont {
  ...
  implicit class PropsHTMLInputElementcontMutableBuilder[Self <: PropsHTMLInputElementcont] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLInputElementcont, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
