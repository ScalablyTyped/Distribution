...
trait PropsHTMLInputElementcont extends StObject {
  ...
  var list: js.UndefOr[HTMLDataListElement | Null] = js.undefined
...
object PropsHTMLInputElementcont {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PropsHTMLInputElementcont] (val x: Self) extends AnyVal {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLInputElementcont, /* ev */ Event, Any]) => Unit
    ...
    inline def setList(value: HTMLDataListElement): Self = StObject.set(x, "list", value.asInstanceOf[js.Any])
    ...
    inline def setOnbeforeinput(value: js.ThisFunction1[PropsHTMLInputElementcont, /* ev */ InputEvent, Any]): Self = StObject.set(x, "onbeforeinput", value.asInstanceOf[js.Any])
    ...
    inline def setOncancel(value: js.ThisFunction1[PropsHTMLInputElementcont, /* ev */ Event, Any]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsHTMLInputElementcont, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
