...
object PropsHTMLDListElementcont {
  ...
  implicit class PropsHTMLDListElementcontMutableBuilder[Self <: PropsHTMLDListElementcont] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsHTMLDListElementcont, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
