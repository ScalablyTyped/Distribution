...
object PropsSVGFESpecularLightin {
  ...
  implicit class PropsSVGFESpecularLightinMutableBuilder[Self <: PropsSVGFESpecularLightin] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFESpecularLightin, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
