...
object PropsSVGFEPointLightEleme {
  ...
  implicit class PropsSVGFEPointLightElemeMutableBuilder[Self <: PropsSVGFEPointLightEleme] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFEPointLightEleme, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
