...
object PropsSVGFEMergeElementcon {
  ...
  implicit class PropsSVGFEMergeElementconMutableBuilder[Self <: PropsSVGFEMergeElementcon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGFEMergeElementcon, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
