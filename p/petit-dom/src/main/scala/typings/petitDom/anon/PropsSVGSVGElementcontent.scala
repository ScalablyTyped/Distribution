...
object PropsSVGSVGElementcontent {
  ...
  implicit class PropsSVGSVGElementcontentOps[Self <: PropsSVGSVGElementcontent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateEvent(value: AnimationEvent => typings.std.AnimationEvent): Self = this.set("createEvent", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOnanimationcancel(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ typings.std.AnimationEvent, _]): Self = this.set("onanimationcancel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnanimationend(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ typings.std.AnimationEvent, _]): Self = this.set("onanimationend", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnanimationiteration(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ typings.std.AnimationEvent, _]): Self = this.set("onanimationiteration", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnanimationstart(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ typings.std.AnimationEvent, _]): Self = this.set("onanimationstart", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ ProgressEvent[EventTarget], _]): Self = this.set("onprogress", value.asInstanceOf[js.Any])
