...
trait PropsSVGSVGElementcontent extends StObject {
  ...
  var createEvent: js.UndefOr[js.Function1[AnimationEvent, typings.std.AnimationEvent]] = js.native
  ...
  var onanimationcancel: js.UndefOr[
    (js.ThisFunction1[/* this */ this.type, /* ev */ typings.std.AnimationEvent, _]) | Null
  ] = js.native
...
object PropsSVGSVGElementcontent {
  ...
  implicit class PropsSVGSVGElementcontentMutableBuilder[Self <: PropsSVGSVGElementcontent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnanimationcancel(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ typings.std.AnimationEvent, _]): Self = StObject.set(x, "onanimationcancel", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnanimationend(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ typings.std.AnimationEvent, _]): Self = StObject.set(x, "onanimationend", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnanimationiteration(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ typings.std.AnimationEvent, _]): Self = StObject.set(x, "onanimationiteration", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnanimationstart(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ typings.std.AnimationEvent, _]): Self = StObject.set(x, "onanimationstart", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnprogress(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ ProgressEvent[EventTarget], _]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
