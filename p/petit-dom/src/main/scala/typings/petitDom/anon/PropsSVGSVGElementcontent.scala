...
object PropsSVGSVGElementcontent {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PropsSVGSVGElementcontent] (val x: Self) extends AnyVal {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, Any]) => Unit
    ...
    inline def setCreateSVGMatrix(value: () => DOMMatrix): Self = StObject.set(x, "createSVGMatrix", js.Any.fromFunction0(value))
    ...
    inline def setCreateSVGPoint(value: () => DOMPoint): Self = StObject.set(x, "createSVGPoint", js.Any.fromFunction0(value))
    
    inline def setCreateSVGPointUndefined: Self = StObject.set(x, "createSVGPoint", js.undefined)
    
    inline def setCreateSVGRect(value: () => DOMRect): Self = StObject.set(x, "createSVGRect", js.Any.fromFunction0(value))
    ...
    inline def setCreateSVGTransformFromMatrix(value: () => SVGTransform): Self = StObject.set(x, "createSVGTransformFromMatrix", js.Any.fromFunction0(value))
    ...
    inline def setGetEnclosureList(
      value: /* rect */ DOMRectReadOnly => NodeListOf[
          SVGCircleElement | SVGEllipseElement | SVGImageElement | SVGLineElement | SVGPathElement | SVGPolygonElement | SVGPolylineElement | SVGRectElement | SVGTextElement | SVGUseElement
        ]
    ...
    inline def setOnbeforeinput(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ InputEvent, Any]): Self = StObject.set(x, "onbeforeinput", value.asInstanceOf[js.Any])
    ...
    inline def setOncancel(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ Event, Any]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
    ...
    inline def setOnmessage(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MessageEvent[Any], Any]): Self = StObject.set(x, "onmessage", value.asInstanceOf[js.Any])
    ...
    inline def setOnmessageerror(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ MessageEvent[Any], Any]): Self = StObject.set(x, "onmessageerror", value.asInstanceOf[js.Any])
    ...
    inline def setOnprogress(value: js.ThisFunction1[PropsSVGSVGElementcontent, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
