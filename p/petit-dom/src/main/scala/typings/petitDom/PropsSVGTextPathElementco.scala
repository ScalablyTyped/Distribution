...
object PropsSVGTextPathElementco {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGTextPathElementco, /* ev */ Event_, _]) => Unit = null,
