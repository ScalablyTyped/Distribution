...
import typings.std.HTMLFormControlsCollection
...
object PropsHTMLFormElementconte {
  ...
  def apply(
    ...
    action: String = null,
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLFormElementconte, /* ev */ Event_, _]) => Unit = null,
    ...
    onprogress: js.ThisFunction1[PropsHTMLFormElementconte, /* ev */ ProgressEvent[EventTarget], _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLFormElementconte, /* ev */ Event_, _]) => Unit = null,
    ...
    if (submit != null) __obj.updateDynamic("submit")(js.Any.fromFunction0(submit))
