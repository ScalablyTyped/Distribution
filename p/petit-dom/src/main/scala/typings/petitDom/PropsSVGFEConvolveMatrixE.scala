...
import typings.std.SVGAnimatedBoolean
...
object PropsSVGFEConvolveMatrixE {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEConvolveMatrixE, /* ev */ Event_, _]) => Unit = null,
    ...
    onprogress: js.ThisFunction1[PropsSVGFEConvolveMatrixE, /* ev */ ProgressEvent[EventTarget], _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGFEConvolveMatrixE, /* ev */ Event_, _]) => Unit = null,
