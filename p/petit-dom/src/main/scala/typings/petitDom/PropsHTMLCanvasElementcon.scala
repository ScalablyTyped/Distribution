...
import typings.petitDom.petitDomStrings.`2d`
...
object PropsHTMLCanvasElementcon {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLCanvasElementcon, /* ev */ Event_, _]) => Unit = null,
    ...
    onprogress: js.ThisFunction1[PropsHTMLCanvasElementcon, /* ev */ ProgressEvent[EventTarget], _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsHTMLCanvasElementcon, /* ev */ Event_, _]) => Unit = null,
