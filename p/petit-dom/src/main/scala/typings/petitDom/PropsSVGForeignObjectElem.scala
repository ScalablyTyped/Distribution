...
object PropsSVGForeignObjectElem {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGForeignObjectElem, /* ev */ Event_, _]) => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGForeignObjectElem, /* ev */ Event_, _]) => Unit = null,
