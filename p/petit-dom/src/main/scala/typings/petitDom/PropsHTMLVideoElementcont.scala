...
import typings.petitDom.petitDomStrings.MSVideoFormatChanged
...
import typings.std.VideoPlaybackQuality
...
object PropsHTMLVideoElementcont {
  ...
  def apply(
    ...
    addEventListener: (MSVideoFormatChanged, /* listener */ js.ThisFunction1[PropsHTMLVideoElementcont, /* ev */ Event_, _]) => Unit = null,
    ...
    msFrameStep: /* forward */ Boolean => Unit = null,
    ...
    msInsertVideoEffect: (/* activatableClassId */ String, /* effectRequired */ Boolean) => Unit = null,
    ...
    msSetVideoRectangle: (/* left */ Double, /* top */ Double, /* right */ Double, /* bottom */ Double) => Unit = null,
    ...
    onprogress: js.ThisFunction1[PropsHTMLVideoElementcont, /* ev */ ProgressEvent[EventTarget], _] = null,
    ...
    if (getVideoPlaybackQuality != null) __obj.updateDynamic("getVideoPlaybackQuality")(js.Any.fromFunction0(getVideoPlaybackQuality))
    ...
    if (msFrameStep != null) __obj.updateDynamic("msFrameStep")(js.Any.fromFunction1(msFrameStep))
    ...
    if (msInsertVideoEffect != null) __obj.updateDynamic("msInsertVideoEffect")(js.Any.fromFunction2(msInsertVideoEffect))
    ...
    if (msSetVideoRectangle != null) __obj.updateDynamic("msSetVideoRectangle")(js.Any.fromFunction4(msSetVideoRectangle))
