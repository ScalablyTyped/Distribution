...
object PropsSVGSymbolElementcont {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGSymbolElementcont, /* ev */ Event_, _]) => Unit = null,
    ...
    onprogress: js.ThisFunction1[PropsSVGSymbolElementcont, /* ev */ ProgressEvent[EventTarget], _] = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PropsSVGSymbolElementcont, /* ev */ Event_, _]) => Unit = null,
