...
trait Please extends js.Object {
  /***
    ...
    * @returns {HSV}
    */
  def HEX_to_HSV(hex: java.lang.String): HSV = js.native
  /***
  ...
  /***
    ...
    * @returns {string}
    */
  def HSV_to_HEX(hsv: HSV): java.lang.String = js.native
  /***
  ...
  /***
    ...
    * @returns {HSV}
    */
  def NAME_to_HSV(name: java.lang.String): HSV = js.native
  /***
    * convert color name into RGB
    * @param {string} name
    * @returns {RGB}
  ...
  /***
    ...
    * @returns {string}
    */
  def RGB_to_HEX(rgb: RGB): java.lang.String = js.native
  /***
