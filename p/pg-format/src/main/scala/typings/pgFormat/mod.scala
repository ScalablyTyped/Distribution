...
object mod {
  ...
  inline def apply(fmt: String, args: js.Any*): String = (^.asInstanceOf[js.Dynamic].apply(fmt.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def ident(`val`: js.Array[js.Any]): String = ^.asInstanceOf[js.Dynamic].applyDynamic("ident")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def ident(`val`: Date): String = ^.asInstanceOf[js.Dynamic].applyDynamic("ident")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def literal(`val`: js.Array[js.Any]): String = ^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def literal(`val`: Date): String = ^.asInstanceOf[js.Dynamic].applyDynamic("literal")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def string(`val`: js.Array[js.Any]): String = ^.asInstanceOf[js.Dynamic].applyDynamic("string")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def string(`val`: Date): String = ^.asInstanceOf[js.Dynamic].applyDynamic("string")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def withArray(fmt: String, array: js.Array[js.Any]): String = (^.asInstanceOf[js.Dynamic].applyDynamic("withArray")(fmt.asInstanceOf[js.Any], array.asInstanceOf[js.Any])).asInstanceOf[String]
}
