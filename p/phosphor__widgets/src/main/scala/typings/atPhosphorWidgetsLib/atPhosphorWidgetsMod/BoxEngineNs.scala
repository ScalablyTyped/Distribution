...
@JSImport("@phosphor/widgets", "BoxEngine")
@js.native
object BoxEngineNs extends js.Object {
  /**
    ...
    */
  def adjust(
    sizers: stdLib.ArrayLike[atPhosphorWidgetsLib.libBoxengineMod.BoxSizer],
    index: scala.Double,
    delta: scala.Double
  ...
  /**
    ...
    */
  def calc(sizers: stdLib.ArrayLike[atPhosphorWidgetsLib.libBoxengineMod.BoxSizer], space: scala.Double): scala.Double = js.native
}
