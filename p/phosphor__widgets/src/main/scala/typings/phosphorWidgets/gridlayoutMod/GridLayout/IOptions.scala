package typings.phosphorWidgets.gridlayoutMod.GridLayout

import typings.phosphorWidgets.layoutMod.Layout.FitPolicy
...
/**
  ...
  */
trait IOptions
  extends typings.phosphorWidgets.layoutMod.Layout.IOptions {
  /**
