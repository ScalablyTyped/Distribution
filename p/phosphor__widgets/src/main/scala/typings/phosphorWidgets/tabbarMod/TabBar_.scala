package typings.phosphorWidgets.tabbarMod

import typings.phosphorSignaling.mod.ISignal
import typings.phosphorWidgets.tabbarMod.TabBar.ICurrentChangedArgs
import typings.phosphorWidgets.tabbarMod.TabBar.IOptions
import typings.phosphorWidgets.tabbarMod.TabBar.IRenderer
import typings.phosphorWidgets.tabbarMod.TabBar.ITabActivateRequestedArgs
import typings.phosphorWidgets.tabbarMod.TabBar.ITabCloseRequestedArgs
import typings.phosphorWidgets.tabbarMod.TabBar.ITabDetachRequestedArgs
import typings.phosphorWidgets.tabbarMod.TabBar.ITabMovedArgs
...
class TabBar_[T] () extends Widget {
  ...
  def addTab(value: typings.phosphorWidgets.titleMod.Title.IOptions[T]): Title[T] = js.native
  /**
  ...
  def insertTab(index: Double, value: typings.phosphorWidgets.titleMod.Title.IOptions[T]): Title[T] = js.native
  /**
    * Release the mouse and restore the non-dragged tab positions.
    *
    * #### Notes
