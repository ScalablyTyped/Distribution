...
import typings.phosphorWidgets.boxlayoutMod.BoxLayout.Alignment
import typings.phosphorWidgets.boxlayoutMod.BoxLayout.Direction
...
import typings.phosphorWidgets.menuMod.Menu.ItemType
import typings.phosphorWidgets.scrollbarMod.ScrollBar.Orientation
...
import typings.phosphorWidgets.tabpanelMod.TabPanel.TabPlacement
...
object phosphorWidgetsStrings {
  ...
  sealed trait center
    extends Alignment
       with typings.phosphorWidgets.splitlayoutMod.SplitLayout.Alignment
  ...
  sealed trait horizontal
    extends Orientation
       with typings.phosphorWidgets.splitlayoutMod.SplitLayout.Orientation
       with typings.phosphorWidgets.tabbarMod.TabBar.Orientation
