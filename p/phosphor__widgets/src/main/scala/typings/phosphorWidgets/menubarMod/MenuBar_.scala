package typings.phosphorWidgets.menubarMod

import typings.phosphorWidgets.menuMod.Menu
import typings.phosphorWidgets.menubarMod.MenuBar.IOptions
import typings.phosphorWidgets.menubarMod.MenuBar.IRenderer
