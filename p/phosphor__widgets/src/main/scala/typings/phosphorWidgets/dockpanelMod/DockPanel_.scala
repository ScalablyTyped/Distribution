package typings.phosphorWidgets.dockpanelMod

import typings.phosphorAlgorithm.iterMod.IIterator
import typings.phosphorSignaling.mod.ISignal
import typings.phosphorWidgets.dockpanelMod.DockPanel.IAddOptions
import typings.phosphorWidgets.dockpanelMod.DockPanel.ILayoutConfig
import typings.phosphorWidgets.dockpanelMod.DockPanel.IOptions
