package typings.phosphorWidgets.menuMod

import typings.phosphorCommands.mod.CommandRegistry
import typings.phosphorSignaling.mod.ISignal
import typings.phosphorWidgets.menuMod.Menu.IItem
import typings.phosphorWidgets.menuMod.Menu.IItemOptions
import typings.phosphorWidgets.menuMod.Menu.IOpenOptions
import typings.phosphorWidgets.menuMod.Menu.IOptions
import typings.phosphorWidgets.menuMod.Menu.IRenderer
import typings.phosphorWidgets.phosphorWidgetsStrings.next
import typings.phosphorWidgets.phosphorWidgetsStrings.previous
