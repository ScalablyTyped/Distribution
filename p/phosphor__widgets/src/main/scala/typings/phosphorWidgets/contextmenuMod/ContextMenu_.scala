package typings.phosphorWidgets.contextmenuMod

import typings.phosphorDisposable.mod.IDisposable
import typings.phosphorWidgets.contextmenuMod.ContextMenu.IItemOptions
import typings.phosphorWidgets.contextmenuMod.ContextMenu.IOptions
