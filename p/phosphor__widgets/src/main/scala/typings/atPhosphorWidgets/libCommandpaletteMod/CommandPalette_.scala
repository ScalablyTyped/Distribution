...
import typings.atPhosphorWidgets.libCommandpaletteMod.CommandPalette.IItem
...
import typings.atPhosphorWidgets.libCommandpaletteMod.CommandPalette.IRenderer
