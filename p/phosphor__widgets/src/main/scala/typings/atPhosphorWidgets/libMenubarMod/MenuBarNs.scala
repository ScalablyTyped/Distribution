package typings.atPhosphorWidgets.libMenubarMod
...
import typings.atPhosphorWidgets.libMenubarMod.MenuBarNs.IRenderData
import typings.atPhosphorWidgets.libMenubarMod.MenuBarNs.IRenderer
import typings.atPhosphorWidgets.libMenubarMod.MenuBarNs.Renderer
