...
import typings.atPhosphorWidgets.libTabbarMod.TabBarNs.ICurrentChangedArgs
import typings.atPhosphorWidgets.libTabbarMod.TabBarNs.IOptions
import typings.atPhosphorWidgets.libTabbarMod.TabBarNs.IRenderer
import typings.atPhosphorWidgets.libTabbarMod.TabBarNs.ITabActivateRequestedArgs
import typings.atPhosphorWidgets.libTabbarMod.TabBarNs.ITabCloseRequestedArgs
import typings.atPhosphorWidgets.libTabbarMod.TabBarNs.ITabDetachRequestedArgs
import typings.atPhosphorWidgets.libTabbarMod.TabBarNs.ITabMovedArgs
...
class TabBar[T] () extends Widget {
  ...
  def addTab(value: typings.atPhosphorWidgets.libTitleMod.TitleNs.IOptions[T]): Title[T] = js.native
  /**
  ...
  def insertTab(index: Double, value: typings.atPhosphorWidgets.libTitleMod.TitleNs.IOptions[T]): Title[T] = js.native
  /**
    * Release the mouse and restore the non-dragged tab positions.
    *
    * #### Notes
