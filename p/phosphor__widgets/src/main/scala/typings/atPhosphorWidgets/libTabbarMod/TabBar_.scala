package typings.atPhosphorWidgets.libTabbarMod

import typings.atPhosphorSignaling.atPhosphorSignalingMod.ISignal
import typings.atPhosphorWidgets.libTabbarMod.TabBar.ICurrentChangedArgs
...
import typings.atPhosphorWidgets.libTabbarMod.TabBar.ITabActivateRequestedArgs
import typings.atPhosphorWidgets.libTabbarMod.TabBar.ITabCloseRequestedArgs
import typings.atPhosphorWidgets.libTabbarMod.TabBar.ITabDetachRequestedArgs
import typings.atPhosphorWidgets.libTabbarMod.TabBar.ITabMovedArgs
...
class TabBar_[T] () extends Widget {
  ...
  def addTab(value: typings.atPhosphorWidgets.libTitleMod.Title.IOptions[T]): Title[T] = js.native
  /**
  ...
  def insertTab(index: Double, value: typings.atPhosphorWidgets.libTitleMod.Title.IOptions[T]): Title[T] = js.native
  /**
    * Release the mouse and restore the non-dragged tab positions.
    *
    * #### Notes
