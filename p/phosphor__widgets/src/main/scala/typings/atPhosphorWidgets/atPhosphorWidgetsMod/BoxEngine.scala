...
object BoxEngine extends js.Object {
  /**
    ...
    */
  def adjust(
    sizers: ArrayLike[typings.atPhosphorWidgets.libBoxengineMod.BoxSizer],
    index: Double,
    delta: Double
  ): Unit = js.native
  /**
    ...
    */
  def calc(sizers: ArrayLike[typings.atPhosphorWidgets.libBoxengineMod.BoxSizer], space: Double): Double = js.native
}
