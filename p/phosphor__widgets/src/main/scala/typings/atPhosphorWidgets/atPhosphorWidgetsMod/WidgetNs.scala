...
object WidgetNs extends js.Object {
  ...
  class ChildMessage protected ()
    extends typings.atPhosphorWidgets.libWidgetMod.WidgetNs.ChildMessage {
    /**
  ...
  class ResizeMessage protected ()
    extends typings.atPhosphorWidgets.libWidgetMod.WidgetNs.ResizeMessage {
    /**
  ...
  /**
    ...
    * to the DOM.
    */
  def attach(widget: typings.atPhosphorWidgets.libWidgetMod.Widget, host: HTMLElement): Unit = js.native
  def attach(widget: typings.atPhosphorWidgets.libWidgetMod.Widget, host: HTMLElement, ref: HTMLElement): Unit = js.native
  /**
    ...
    */
  def detach(widget: typings.atPhosphorWidgets.libWidgetMod.Widget): Unit = js.native
  /**
  ...
  object Flag extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.atPhosphorWidgets.libWidgetMod.WidgetNs.Flag with Double] = js.native
  }
  ...
  object ResizeMessageNs extends js.Object {
    /**
      ...
      */
    val UnknownSize: typings.atPhosphorWidgets.libWidgetMod.WidgetNs.ResizeMessage = js.native
  }
