...
import typings.atPhosphorWidgets.libDocklayoutMod.DockLayoutNs.IAddOptions
...
import typings.atPhosphorWidgets.libDocklayoutMod.DockLayoutNs.IRenderer
import typings.atPhosphorWidgets.libDocklayoutMod.DockLayoutNs.ITabAreaGeometry
