...
import typings.atPhosphorWidgets.libDockpanelMod.DockPanelNs.IAddOptions
import typings.atPhosphorWidgets.libDockpanelMod.DockPanelNs.ILayoutConfig
import typings.atPhosphorWidgets.libDockpanelMod.DockPanelNs.IOptions
