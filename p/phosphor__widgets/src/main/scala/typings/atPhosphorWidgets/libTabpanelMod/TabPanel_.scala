package typings.atPhosphorWidgets.libTabpanelMod

import typings.atPhosphorSignaling.atPhosphorSignalingMod.ISignal
import typings.atPhosphorWidgets.libStackedpanelMod.StackedPanel
import typings.atPhosphorWidgets.libTabbarMod.TabBar
import typings.atPhosphorWidgets.libTabpanelMod.TabPanel.ICurrentChangedArgs
