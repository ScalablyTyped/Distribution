...
object SelectionBookmark {
  ...
  @scala.inline
  implicit class SelectionBookmarkOps[Self <: SelectionBookmark[_], /* <: typings.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with SelectionBookmark[S]) extends AnyVal {
    @scala.inline
