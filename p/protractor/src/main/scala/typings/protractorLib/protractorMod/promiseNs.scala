...
object promiseNs extends js.Object {
  ...
  class CancellationError ()
    extends seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.CancellationError {
  ...
  /**
    ...
    */
  class ControlFlow ()
    extends seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.ControlFlow
  ...
  /**
    ...
    */
  class Deferred[T] ()
    extends seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.Deferred[T] {
    def this(opt_flow: seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.ControlFlow) = this()
  }
  ...
  class Promise[T] protected ()
    extends seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.Promise[T] {
    /**
      * @param {function(
    ...
    def this(resolver: js.Function2[
          /* resolve */ seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.IFulfilledCallback[T], 
    ...
    def this(resolver: js.Function2[
          ...
          /* reject */ seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.IRejectedCallback, 
          scala.Unit
        ], opt_flow: seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.ControlFlow) = this()
  }
  ...
  @js.native
  class Thenable[T] ()
    extends seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.Thenable[T]
