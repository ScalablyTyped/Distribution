...
class Plugins protected () extends js.Object {
  ...
  def onPrepare(args: js.Any*): qLib.qMod.Promise[js.Array[_]] = js.native
  /**
  ...
  def postResults(args: js.Any*): qLib.qMod.Promise[js.Array[_]] = js.native
  def postTest(args: js.Any*): qLib.qMod.Promise[js.Array[_]] = js.native
  ...
  /**
    ...
    */
  def setup(args: js.Any*): qLib.qMod.Promise[js.Array[_]] = js.native
  /**
  ...
  def teardown(args: js.Any*): qLib.qMod.Promise[js.Array[_]] = js.native
