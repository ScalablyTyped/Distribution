...
class ProtractorBrowser protected ()
  ...
  def angularAppRoot(value: java.lang.String): js.Promise[java.lang.String] = js.native
  def angularAppRoot(value: js.Promise[java.lang.String]): js.Promise[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    * debugger.
    */
  def debugger(): js.Promise[scala.Unit] = js.native
  /**
    * Helper function for finding elements.
    *
    * @type {function(webdriver.Locator): ElementFinder}
  ...
  def get(destination: java.lang.String, timeout: scala.Double): js.Promise[_] = js.native
  /**
  ...
  def pause(opt_debugPort: scala.Double): js.Promise[_] = js.native
  /**
  ...
  def refresh(opt_timeout: scala.Double): js.Promise[_] = js.native
  /**
  ...
  def waitForAngularEnabled(enabled: js.Promise[scala.Boolean]): js.Promise[scala.Boolean] = js.native
  def waitForAngularEnabled(enabled: scala.Boolean): js.Promise[scala.Boolean] = js.native
}
