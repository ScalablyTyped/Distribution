...
trait AnonArgsJvmArgs extends js.Object {
  /**
...
object AnonArgsJvmArgs {
  @scala.inline
  def apply(args: js.Any = null, jvmArgs: js.Array[String] = null, port: js.Any = null): AnonArgsJvmArgs = {
    val __obj = js.Dynamic.literal()
    if (args != null) __obj.updateDynamic("args")(args.asInstanceOf[js.Any])
    if (jvmArgs != null) __obj.updateDynamic("jvmArgs")(jvmArgs.asInstanceOf[js.Any])
    if (port != null) __obj.updateDynamic("port")(port.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonArgsJvmArgs]
  }
}
