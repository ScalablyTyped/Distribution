...
object builtDriverProvidersDriverProviderMod {
  
  /* note: abstract class */ @JSImport("protractor/built/driverProviders/driverProvider", "DriverProvider")
  @js.native
  open class DriverProvider protected () extends StObject {
