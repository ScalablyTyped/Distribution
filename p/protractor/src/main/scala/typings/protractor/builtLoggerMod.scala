...
object builtLoggerMod {
  ...
  object LogLevel extends StObject {
    ...
    sealed trait DEBUG
      extends StObject
         with LogLevel
    /* 3 */ val DEBUG: typings.protractor.builtLoggerMod.LogLevel.DEBUG & Double = js.native
    
    @js.native
    sealed trait ERROR
      extends StObject
         with LogLevel
    /* 0 */ val ERROR: typings.protractor.builtLoggerMod.LogLevel.ERROR & Double = js.native
    
    @js.native
    sealed trait INFO
      extends StObject
         with LogLevel
    /* 2 */ val INFO: typings.protractor.builtLoggerMod.LogLevel.INFO & Double = js.native
    
    @js.native
    sealed trait WARN
      extends StObject
         with LogLevel
    /* 1 */ val WARN: typings.protractor.builtLoggerMod.LogLevel.WARN & Double = js.native
  }
  ...
  object WriteTo extends StObject {
    ...
    sealed trait BOTH
      extends StObject
         with WriteTo
    /* 2 */ val BOTH: typings.protractor.builtLoggerMod.WriteTo.BOTH & Double = js.native
    
    @js.native
    sealed trait CONSOLE
      extends StObject
         with WriteTo
    /* 0 */ val CONSOLE: typings.protractor.builtLoggerMod.WriteTo.CONSOLE & Double = js.native
    
    @js.native
    sealed trait FILE
      extends StObject
         with WriteTo
    /* 1 */ val FILE: typings.protractor.builtLoggerMod.WriteTo.FILE & Double = js.native
    
    @js.native
    sealed trait NONE
      extends StObject
         with WriteTo
    /* 3 */ val NONE: typings.protractor.builtLoggerMod.WriteTo.NONE & Double = js.native
  }
}
