...
import typings.protractor.Anon_SpecName
import typings.protractor.Anon_SpecNameString
...
trait ProtractorPlugin extends js.Object {
  ...
  var addFailure: js.UndefOr[
    js.Function2[/* message */ js.UndefOr[String], /* info */ js.UndefOr[Anon_SpecName], Unit]
  ] = js.undefined
  /**
    ...
    * @throws {Error} Throws an error if called after results have been reported
    */
  var addSuccess: js.UndefOr[js.Function1[/* info */ js.UndefOr[Anon_SpecNameString], Unit]] = js.undefined
  /**
  ...
  var addWarning: js.UndefOr[
    js.Function2[/* message */ js.UndefOr[String], /* info */ js.UndefOr[Anon_SpecNameString], Unit]
  ] = js.undefined
  /**
...
object ProtractorPlugin {
  @scala.inline
  def apply(
    addFailure: (/* message */ js.UndefOr[String], /* info */ js.UndefOr[Anon_SpecName]) => Unit = null,
    addSuccess: /* info */ js.UndefOr[Anon_SpecNameString] => Unit = null,
    addWarning: (/* message */ js.UndefOr[String], /* info */ js.UndefOr[Anon_SpecNameString]) => Unit = null,
