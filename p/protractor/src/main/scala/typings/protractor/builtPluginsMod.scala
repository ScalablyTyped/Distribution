...
object builtPluginsMod {
  ...
  object PromiseType extends StObject {
    ...
    sealed trait Q
      extends StObject
         with PromiseType
    /* 0 */ val Q: typings.protractor.builtPluginsMod.PromiseType.Q & Double = js.native
    
    @js.native
    sealed trait WEBDRIVER
      extends StObject
         with PromiseType
    /* 1 */ val WEBDRIVER: typings.protractor.builtPluginsMod.PromiseType.WEBDRIVER & Double = js.native
  }
