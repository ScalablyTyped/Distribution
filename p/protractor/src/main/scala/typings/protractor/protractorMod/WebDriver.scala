...
class WebDriver protected ()
  extends typings.seleniumDashWebdriver.seleniumDashWebdriverMod.WebDriver {
  def this(
    session: js.Promise[typings.seleniumDashWebdriver.seleniumDashWebdriverMod.Session],
    executor: Executor
  ) = this()
  // region Constructors
  /**
    ...
    */
  def this(session: typings.seleniumDashWebdriver.seleniumDashWebdriverMod.Session, executor: Executor) = this()
}
...
object WebDriver extends js.Object {
  ...
  def createSession(var_args: js.Any*): typings.seleniumDashWebdriver.seleniumDashWebdriverMod.WebDriver = js.native
}
