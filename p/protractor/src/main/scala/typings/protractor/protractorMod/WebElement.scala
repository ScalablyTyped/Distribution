...
class WebElement protected ()
  extends typings.seleniumDashWebdriver.seleniumDashWebdriverMod.WebElement {
  def this(driver: typings.seleniumDashWebdriver.seleniumDashWebdriverMod.WebDriver, id: String) = this()
  /**
    * @param {!WebDriver} driver the parent WebDriver instance for this element.
    * @param {(!IThenable<string>|string)} id The server-assigned opaque ID for
    *     the underlying DOM element.
    */
  def this(driver: typings.seleniumDashWebdriver.seleniumDashWebdriverMod.WebDriver, id: js.Promise[String]) = this()
}
...
object WebElement extends js.Object {
  ...
  /**
    ...
    */
  def equals(
    a: typings.seleniumDashWebdriver.seleniumDashWebdriverMod.WebElement,
    b: typings.seleniumDashWebdriver.seleniumDashWebdriverMod.WebElement
