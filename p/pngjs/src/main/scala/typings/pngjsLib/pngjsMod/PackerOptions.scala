...
trait PackerOptions extends js.Object {
  var bgColor: js.UndefOr[pngjsLib.Anon_Green] = js.undefined
  ...
  var deflateFactory: js.UndefOr[js.Function1[/* options */ nodeLib.zlibMod.ZlibOptions, nodeLib.zlibMod.Deflate]] = js.undefined
