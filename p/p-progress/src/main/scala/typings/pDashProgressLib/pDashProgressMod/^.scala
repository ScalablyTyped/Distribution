...
object ^ extends js.Object {
  ...
  def all[AllValuesType](promises: stdLib.Iterable[js.Thenable[AllValuesType] | PromiseFactory[AllValuesType]]): PProgress[AllValuesType] = js.native
  def all[AllValuesType](promises: stdLib.Iterable[PromiseFactory[AllValuesType]], options: Options): PProgress[AllValuesType] = js.native
  ...
  /**
  	...
  	*/
  @JSName("fn")
  def fn_ReturnTypeFunction0[ReturnType](input: js.Function1[/* progress */ ProgressNotifier, js.Thenable[ReturnType]]): js.Function0[PProgress[ReturnType]] = js.native
}
