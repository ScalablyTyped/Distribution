...
version := "0.5-dt-20180214Z-2f53df"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "pouchdb" % "6.3-dt-20190212Z-56bd44",
  "org.scalablytyped" %%% "pouchdb-adapter-fruitdown" % "6.1-dt-20190212Z-95362b",
  ...
  "org.scalablytyped" %%% "pouchdb-adapter-leveldb" % "6.1-dt-20190212Z-709523",
  "org.scalablytyped" %%% "pouchdb-adapter-localstorage" % "6.1-dt-20190212Z-45f295",
  "org.scalablytyped" %%% "pouchdb-adapter-memory" % "6.1-dt-20190212Z-cf31c8",
  "org.scalablytyped" %%% "pouchdb-adapter-node-websql" % "6.1-dt-20190212Z-2eb96c",
  "org.scalablytyped" %%% "pouchdb-adapter-websql" % "6.1-dt-20190212Z-bbf378",
  "org.scalablytyped" %%% "pouchdb-browser" % "6.1-dt-20190212Z-bf8bf3",
  "org.scalablytyped" %%% "pouchdb-core" % "7.0-dt-20190212Z-6a7ffb",
  "org.scalablytyped" %%% "pouchdb-find" % "6.3-dt-20190212Z-44cca7",
  "org.scalablytyped" %%% "pouchdb-http" % "6.1-dt-20190212Z-d6683f",
  "org.scalablytyped" %%% "pouchdb-mapreduce" % "6.1-dt-20190212Z-7a39d2",
  "org.scalablytyped" %%% "pouchdb-node" % "6.1-dt-20190212Z-c9b06c",
