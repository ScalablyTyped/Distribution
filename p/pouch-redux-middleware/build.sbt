...
version := "0.5-dt-20180214Z-b2cdfa"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "pouchdb" % "6.3-dt-20180214Z-caeb65",
  "org.scalablytyped" %%% "pouchdb-adapter-fruitdown" % "6.1-dt-20180214Z-318f1c",
  ...
  "org.scalablytyped" %%% "pouchdb-adapter-leveldb" % "6.1-dt-20180214Z-f070e5",
  "org.scalablytyped" %%% "pouchdb-adapter-localstorage" % "6.1-dt-20180214Z-a21bf9",
  "org.scalablytyped" %%% "pouchdb-adapter-memory" % "6.1-dt-20180214Z-728f6b",
  "org.scalablytyped" %%% "pouchdb-adapter-node-websql" % "6.1-dt-20180214Z-4722df",
  "org.scalablytyped" %%% "pouchdb-adapter-websql" % "6.1-dt-20180214Z-37d75d",
  "org.scalablytyped" %%% "pouchdb-browser" % "6.1-dt-20180214Z-c735d5",
  "org.scalablytyped" %%% "pouchdb-core" % "7.0-dt-20181213Z-2e4ddb",
  "org.scalablytyped" %%% "pouchdb-find" % "6.3-dt-20180611Z-f2526a",
  "org.scalablytyped" %%% "pouchdb-http" % "6.1-dt-20180214Z-e74d12",
  "org.scalablytyped" %%% "pouchdb-mapreduce" % "6.1-dt-20180214Z-a9dd24",
  "org.scalablytyped" %%% "pouchdb-node" % "6.1-dt-20180214Z-8520d4",
