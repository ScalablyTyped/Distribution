...
object libGeometryGeometrySystemMod {
  
  @JSImport("@pixi/core/lib/geometry/GeometrySystem", "GeometrySystem")
  @js.native
  open class GeometrySystem protected ()
    ...
    @JSName("destroy")
    def destroy_MGeometrySystem(): Unit = js.native
  ...
  object GeometrySystem {
    ...
    /** @ignore */
    @JSImport("@pixi/core/lib/geometry/GeometrySystem", "GeometrySystem.extension")
    @js.native
