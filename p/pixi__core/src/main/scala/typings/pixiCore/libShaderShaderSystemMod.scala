...
object libShaderShaderSystemMod {
  
  @JSImport("@pixi/core/lib/shader/ShaderSystem", "ShaderSystem")
  @js.native
  open class ShaderSystem protected ()
    ...
    /**
      ...
      */
    /* protected */ def createSyncBufferGroup(group: UniformGroup[Dict[Any]], glProgram: GLProgram, name: String): UniformsSyncCallback = js.native
    
    def createSyncGroups(group: UniformGroup[Dict[Any]]): UniformsSyncCallback = js.native
    
    /** Destroys this System and removes all its textures. */
    @JSName("destroy")
    def destroy_MShaderSystem(): Unit = js.native
    ...
    /**
      ...
      * @private
      */
    /* private */ var systemCheck: Any = js.native
  }
  /* static members */
  object ShaderSystem {
    
    /** @ignore */
    @JSImport("@pixi/core/lib/shader/ShaderSystem", "ShaderSystem.extension")
    @js.native
