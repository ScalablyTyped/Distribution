...
import typings.pixiCore.pixiCoreInts.`0`
import typings.pixiCore.pixiCoreInts.`1`
import typings.pixiCore.pixiCoreStrings.Float32Array
import typings.pixiCore.pixiCoreStrings.Int32Array
import typings.pixiCore.pixiCoreStrings.Uint16Array
import typings.pixiCore.pixiCoreStrings.Uint32Array
import typings.pixiCore.pixiCoreStrings.Uint8Array
...
object utils {
  ...
  @JSImport("@pixi/core", "utils.DATA_URI")
  @js.native
  ...
  @JSImport("@pixi/core", "utils.isMobile")
  @js.native
  ...
  @JSImport("@pixi/core", "utils.path")
  @js.native
  val path: Path_ = js.native
  
  @JSImport("@pixi/core", "utils.premultiplyBlendMode")
  @js.native
  ...
  object url {
    ...
    @JSImport("@pixi/core", "utils.url")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@pixi/core", "utils.url.format")
    @js.native
    ...
    @JSImport("@pixi/core", "utils.url.parse")
    @js.native
    ...
    @JSImport("@pixi/core", "utils.url.resolve")
    @js.native
