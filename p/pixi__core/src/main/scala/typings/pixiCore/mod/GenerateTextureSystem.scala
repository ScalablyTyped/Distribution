...
@JSImport("@pixi/core", "GenerateTextureSystem")
@js.native
open class GenerateTextureSystem protected ()
  extends typings.pixiCore.libSystemsMod.GenerateTextureSystem {
...
object GenerateTextureSystem {
  ...
  /** @ignore */
  @JSImport("@pixi/core", "GenerateTextureSystem.extension")
  @js.native
