...
object libRenderTextureRenderTexturePoolMod {
  
  @JSImport("@pixi/core/lib/renderTexture/RenderTexturePool", "RenderTexturePool")
  @js.native
  /**
  ...
  open class RenderTexturePool () extends StObject {
    ...
    var texturePool: /* import warning: importer.ImportType#apply Failed type conversion: {[ x in string | number ]: std.Array<@pixi/core.@pixi/core/lib/renderTexture/RenderTexture.RenderTexture>} */ js.Any = js.native
  }
  /* static members */
