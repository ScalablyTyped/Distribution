...
import typings.pixiCore.libGeometryAttributeMod.Attribute
...
object libGeometryGeometryMod {
  
  @JSImport("@pixi/core/lib/geometry/Geometry", "Geometry")
  @js.native
  /**
  ...
  open class Geometry () extends StObject {
    ...
    def this(buffers: js.Array[Buffer], attributes: StringDictionary[Attribute]) = this()
    ...
    def addAttribute(
      id: String,
      buffer: Buffer | js.typedarray.Float32Array | js.typedarray.Uint32Array | js.Array[Double],
