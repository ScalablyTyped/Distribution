...
object libTexturesTextureSystemMod {
  
  @JSImport("@pixi/core/lib/textures/TextureSystem", "TextureSystem")
  @js.native
  open class TextureSystem protected ()
    ...
    @JSName("destroy")
    def destroy_MTextureSystem(): Unit = js.native
  ...
  object TextureSystem {
    ...
    /** @ignore */
    @JSImport("@pixi/core/lib/textures/TextureSystem", "TextureSystem.extension")
    @js.native
