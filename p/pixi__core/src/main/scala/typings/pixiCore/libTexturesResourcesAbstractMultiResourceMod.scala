...
object libTexturesResourcesAbstractMultiResourceMod {
  
  /* note: abstract class */ @JSImport("@pixi/core/lib/textures/resources/AbstractMultiResource", "AbstractMultiResource")
  @js.native
