...
object libShaderUniformGroupMod {
  
  @JSImport("@pixi/core/lib/shader/UniformGroup", "UniformGroup")
  @js.native
  open class UniformGroup[LAYOUT] protected () extends StObject {
    ...
    def this(uniforms: Buffer) = this()
    def this(uniforms: LAYOUT, isStatic: Boolean) = this()
    def this(uniforms: Buffer, isStatic: Boolean) = this()
    def this(uniforms: LAYOUT, isStatic: Boolean, isUbo: Boolean) = this()
    def this(uniforms: LAYOUT, isStatic: Unit, isUbo: Boolean) = this()
    def this(uniforms: Buffer, isStatic: Boolean, isUbo: Boolean) = this()
    def this(uniforms: Buffer, isStatic: Unit, isUbo: Boolean) = this()
    ...
    var syncUniforms: Dict[UniformsSyncCallback] = js.native
  ...
  object UniformGroup {
    ...
    inline def from(uniforms: Buffer): UniformGroup[Dict[Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(uniforms.asInstanceOf[js.Any]).asInstanceOf[UniformGroup[Dict[Any]]]
    inline def from(uniforms: Buffer, _static: Boolean): UniformGroup[Dict[Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(uniforms.asInstanceOf[js.Any], _static.asInstanceOf[js.Any])).asInstanceOf[UniformGroup[Dict[Any]]]
    inline def from(uniforms: Buffer, _static: Boolean, _ubo: Boolean): UniformGroup[Dict[Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(uniforms.asInstanceOf[js.Any], _static.asInstanceOf[js.Any], _ubo.asInstanceOf[js.Any])).asInstanceOf[UniformGroup[Dict[Any]]]
    inline def from(uniforms: Buffer, _static: Unit, _ubo: Boolean): UniformGroup[Dict[Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(uniforms.asInstanceOf[js.Any], _static.asInstanceOf[js.Any], _ubo.asInstanceOf[js.Any])).asInstanceOf[UniformGroup[Dict[Any]]]
    ...
    inline def uboFrom(uniforms: Buffer): UniformGroup[Dict[Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("uboFrom")(uniforms.asInstanceOf[js.Any]).asInstanceOf[UniformGroup[Dict[Any]]]
    inline def uboFrom(uniforms: Buffer, _static: Boolean): UniformGroup[Dict[Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("uboFrom")(uniforms.asInstanceOf[js.Any], _static.asInstanceOf[js.Any])).asInstanceOf[UniformGroup[Dict[Any]]]
    /**
