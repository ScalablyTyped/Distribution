...
object libTexturesResourcesResourceMod {
  
  /* note: abstract class */ @JSImport("@pixi/core/lib/textures/resources/Resource", "Resource")
  @js.native
  /**
  ...
  object Resource {
    ...
    @JSImport("@pixi/core/lib/textures/resources/Resource", "Resource")
    @js.native
