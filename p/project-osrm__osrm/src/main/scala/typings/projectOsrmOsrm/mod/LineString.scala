...
trait LineString extends StObject {
  ...
  var `type`: typings.projectOsrmOsrm.projectOsrmOsrmStrings.LineString
}
object LineString {
  ...
  implicit open class MutableBuilder[Self <: LineString] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.projectOsrmOsrm.projectOsrmOsrmStrings.LineString): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
