...
import typings.postcssMergeLonghand.postcssMergeLonghandBooleans.`true`
...
object mod {
  ...
  @JSImport("postcss-merge-longhand", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("postcss-merge-longhand", "postcss")
  @js.native
