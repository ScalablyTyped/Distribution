...
trait Container extends js.Object {
  ...
  /**
    ...
    */
  var command: js.UndefOr[atPulumiPulumiLib.outputMod.Input[js.Array[java.lang.String]]] = js.undefined
  /**
    * Number of CPUs for the container to use. Maps to the Docker `--cpus` option - see
    * https://docs.docker.com/engine/reference/commandline/run.
    */
  var cpu: js.UndefOr[atPulumiPulumiLib.outputMod.Input[scala.Double]] = js.undefined
  /**
  ...
  var dockerLabels: js.UndefOr[
    atPulumiPulumiLib.outputMod.Input[org.scalablytyped.runtime.StringDictionary[java.lang.String]]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var memory: js.UndefOr[atPulumiPulumiLib.outputMod.Input[scala.Double]] = js.undefined
  /**
    ...
    * This should be supplied in MB. i.e. A value of 1024 would equal one gigabyte.
    */
  var memoryReservation: js.UndefOr[atPulumiPulumiLib.outputMod.Input[scala.Double]] = js.undefined
  /**
