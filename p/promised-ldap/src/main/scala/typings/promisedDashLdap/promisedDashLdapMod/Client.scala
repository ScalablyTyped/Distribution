package typings.promisedDashLdap.promisedDashLdapMod

import typings.ldapjs.ldapjsMod.Change
import typings.ldapjs.ldapjsMod.Control
import typings.node.eventsMod.EventEmitter
import typings.promisedDashLdap.Anon_Email
import typings.promisedDashLdap.Anon_Entries
...
trait Client extends EventEmitter {
  def _search(base: String, options: typings.ldapjs.ldapjsMod.SearchOptions): js.Promise[EventEmitter] = js.native
  def _search(base: String, options: typings.ldapjs.ldapjsMod.SearchOptions, _bypass: Boolean): js.Promise[EventEmitter] = js.native
  def _search(base: String, options: typings.ldapjs.ldapjsMod.SearchOptions, controls: js.Array[Control]): js.Promise[EventEmitter] = js.native
  def _search(
    base: String,
    options: typings.ldapjs.ldapjsMod.SearchOptions,
    controls: js.Array[Control],
    _bypass: Boolean
  ): js.Promise[EventEmitter] = js.native
  def _search(base: String, options: typings.ldapjs.ldapjsMod.SearchOptions, controls: Control): js.Promise[EventEmitter] = js.native
  def _search(base: String, options: typings.ldapjs.ldapjsMod.SearchOptions, controls: Control, _bypass: Boolean): js.Promise[EventEmitter] = js.native
  ...
  def authenticateUser(base: String, dn: String, password: String): js.Promise[Anon_Email | Null] = js.native
  ...
  def search(base: String, options: typings.ldapjs.ldapjsMod.SearchOptions): js.Promise[Anon_Entries] = js.native
  def search(base: String, options: typings.ldapjs.ldapjsMod.SearchOptions, controls: js.Array[Control]): js.Promise[Anon_Entries] = js.native
  def search(base: String, options: typings.ldapjs.ldapjsMod.SearchOptions, controls: Control): js.Promise[Anon_Entries] = js.native
