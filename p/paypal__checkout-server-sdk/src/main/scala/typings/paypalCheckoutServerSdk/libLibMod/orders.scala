...
object orders {
  ...
  open class BaseOrderRequest[H /* <: BaseOrderHeaders */, B] protected ()
    extends typings.paypalCheckoutServerSdk.ordersLibMod.BaseOrderRequest[H, B] {
  ...
  open class OrdersAuthorizeRequest protected ()
    extends typings.paypalCheckoutServerSdk.ordersLibMod.OrdersAuthorizeRequest {
    def this(orderId: String) = this()
  }
  ...
  open class OrdersCaptureRequest protected ()
    extends typings.paypalCheckoutServerSdk.ordersLibMod.OrdersCaptureRequest {
    def this(orderId: String) = this()
  }
  ...
  open class OrdersCreateRequest ()
    extends typings.paypalCheckoutServerSdk.ordersLibMod.OrdersCreateRequest
  
  @JSImport("@paypal/checkout-server-sdk/lib/lib", "orders.OrdersGetRequest")
  @js.native
  open class OrdersGetRequest protected ()
    extends typings.paypalCheckoutServerSdk.ordersLibMod.OrdersGetRequest {
    def this(orderId: String) = this()
  }
  ...
  open class OrdersPatchRequest protected ()
    extends typings.paypalCheckoutServerSdk.ordersLibMod.OrdersPatchRequest {
    def this(orderId: String) = this()
  }
  ...
  open class OrdersValidateRequest protected ()
    extends typings.paypalCheckoutServerSdk.ordersLibMod.OrdersValidateRequest {
    def this(orderId: String) = this()
  }
