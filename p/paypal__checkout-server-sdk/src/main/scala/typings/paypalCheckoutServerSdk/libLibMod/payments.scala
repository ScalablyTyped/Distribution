...
object payments {
  ...
  open class AuthorizationsCaptureRequest protected ()
    extends typings.paypalCheckoutServerSdk.paymentsLibMod.AuthorizationsCaptureRequest {
  ...
  open class AuthorizationsGetRequest protected ()
    extends typings.paypalCheckoutServerSdk.paymentsLibMod.AuthorizationsGetRequest {
    def this(authorizationId: String) = this()
  }
  ...
  open class AuthorizationsReauthorizeRequest protected ()
    extends typings.paypalCheckoutServerSdk.paymentsLibMod.AuthorizationsReauthorizeRequest {
    def this(authorizationId: String) = this()
  }
  ...
  open class AuthorizationsVoidRequest protected ()
    extends typings.paypalCheckoutServerSdk.paymentsLibMod.AuthorizationsVoidRequest {
    def this(authorizationId: String) = this()
  }
  ...
  open class BasePaymentRequest[H /* <: BasePaymentHeaders */, D] protected ()
    extends typings.paypalCheckoutServerSdk.paymentsLibMod.BasePaymentRequest[H, D] {
    def this(authorizationId: String) = this()
  }
  ...
  open class CapturesGetRequest protected ()
    extends typings.paypalCheckoutServerSdk.paymentsLibMod.CapturesGetRequest {
    def this(authorizationId: String) = this()
  }
  ...
  open class CapturesRefundRequest protected ()
    extends typings.paypalCheckoutServerSdk.paymentsLibMod.CapturesRefundRequest {
  ...
  open class RefundsGetRequest protected ()
    extends typings.paypalCheckoutServerSdk.paymentsLibMod.RefundsGetRequest {
