...
import typings.paypalCheckoutServerSdk.ordersLibMod.OrdersAuthorize.RequestData
import typings.paypalCheckoutServerSdk.ordersLibMod.OrdersAuthorize.RequestHeaders
