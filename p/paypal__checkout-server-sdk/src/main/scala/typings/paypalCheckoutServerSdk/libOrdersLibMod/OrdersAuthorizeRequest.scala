...
import typings.paypalCheckoutServerSdk.libOrdersLibMod.OrdersAuthorize.RequestData
import typings.paypalCheckoutServerSdk.libOrdersLibMod.OrdersAuthorize.RequestHeaders
