...
import typings.paypalCheckoutServerSdk.libPaymentsLibMod.Payee
import typings.paypalCheckoutServerSdk.libPaymentsLibMod.PaymentInstruction
...
object PurchaseUnitRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PurchaseUnitRequest] (val x: Self) extends AnyVal {
