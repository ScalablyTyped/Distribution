...
import typings.paypalCheckoutServerSdk.libPaymentsLibMod.Capture
import typings.paypalCheckoutServerSdk.libPaymentsLibMod.Refund
...
object PaymentCollection {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PaymentCollection] (val x: Self) extends AnyVal {
