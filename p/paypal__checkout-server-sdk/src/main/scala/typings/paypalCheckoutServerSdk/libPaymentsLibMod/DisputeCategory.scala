...
object DisputeCategory extends StObject {
  ...
  /* "ITEM_NOT_RECEIVED" */ val ITEM_NOT_RECEIVED: typings.paypalCheckoutServerSdk.libPaymentsLibMod.DisputeCategory.ITEM_NOT_RECEIVED & String = js.native
  
  @js.native
  sealed trait UNAUTHORIZED_TRANSACTION
    extends StObject
       with DisputeCategory
  /* "UNAUTHORIZED_TRANSACTION" */ val UNAUTHORIZED_TRANSACTION: typings.paypalCheckoutServerSdk.libPaymentsLibMod.DisputeCategory.UNAUTHORIZED_TRANSACTION & String = js.native
}
