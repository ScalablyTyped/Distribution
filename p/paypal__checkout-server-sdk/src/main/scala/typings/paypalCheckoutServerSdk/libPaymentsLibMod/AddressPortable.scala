...
trait AddressPortable extends StObject {
...
object AddressPortable {
  
  inline def apply(country_code: String): AddressPortable = {
    val __obj = js.Dynamic.literal(country_code = country_code.asInstanceOf[js.Any])
    __obj.asInstanceOf[AddressPortable]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AddressPortable] (val x: Self) extends AnyVal {
