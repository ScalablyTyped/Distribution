...
object CHAR0 {
  ...
  implicit class CHAR0Ops[Self <: CHAR0] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setREGEX_BACKSLASH(value: RegExp): Self = this.set("REGEX_BACKSLASH", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setREGEX_NON_SPECIAL_CHARS(value: RegExp): Self = this.set("REGEX_NON_SPECIAL_CHARS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setREGEX_REMOVE_BACKSLASH(value: RegExp): Self = this.set("REGEX_REMOVE_BACKSLASH", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setREGEX_SPECIAL_CHARS(value: RegExp): Self = this.set("REGEX_SPECIAL_CHARS", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setREGEX_SPECIAL_CHARS_BACKREF(value: RegExp): Self = this.set("REGEX_SPECIAL_CHARS_BACKREF", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setREGEX_SPECIAL_CHARS_GLOBAL(value: RegExp): Self = this.set("REGEX_SPECIAL_CHARS_GLOBAL", value.asInstanceOf[js.Any])
