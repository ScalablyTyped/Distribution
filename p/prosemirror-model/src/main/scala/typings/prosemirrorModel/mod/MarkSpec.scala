...
object MarkSpec {
  ...
  extension [Self <: MarkSpec](x: Self) {
    ...
    inline def setSpanningNull: Self = StObject.set(x, "spanning", null)
    
    inline def setSpanningUndefined: Self = StObject.set(x, "spanning", js.undefined)
    
    inline def setToDOM(value: (/* mark */ Mark[js.Any], /* inline */ Boolean) => DOMOutputSpec): Self = StObject.set(x, "toDOM", js.Any.fromFunction2(value))
