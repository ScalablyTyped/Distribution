...
class Schema[N /* <: String */, M /* <: String */] protected () extends js.Object {
  ...
  /**
    ...
    */
  var marks: typings.prosemirrorDashModel.prosemirrorDashModelStrings.Schema with js.Any with (StringDictionary[MarkType[Schema[N, M]]]) = js.native
  /**
    * An object mapping the schema's node names to node type objects.
    */
  var nodes: typings.prosemirrorDashModel.prosemirrorDashModelStrings.Schema with js.Any with (StringDictionary[NodeType[Schema[N, M]]]) = js.native
  /**
