...
object PhantomCSSOptions {
  ...
  def apply(
    ...
    mismatchTolerance: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(addLabelToFailedImage)) __obj.updateDynamic("addLabelToFailedImage")(addLabelToFailedImage.get.asInstanceOf[js.Any])
    if (casper != null) __obj.updateDynamic("casper")(casper.asInstanceOf[js.Any])
    if (!js.isUndefined(cleanupComparisonImages)) __obj.updateDynamic("cleanupComparisonImages")(cleanupComparisonImages.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(mismatchTolerance)) __obj.updateDynamic("mismatchTolerance")(mismatchTolerance.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(prefixCount)) __obj.updateDynamic("prefixCount")(prefixCount.get.asInstanceOf[js.Any])
