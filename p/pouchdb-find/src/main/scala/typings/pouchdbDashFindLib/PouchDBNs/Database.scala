...
trait Database[Content /* <: js.Object */] extends js.Object {
  ...
  def createIndex(
    ...
    callback: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Core.Callback<Find.CreateIndexResponse<Content>> */ js.Any
  ...
  def deleteIndex(
    ...
    callback: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Core.Callback<Find.DeleteIndexResponse<Content>> */ js.Any
  ): scala.Unit = js.native
  ...
  def find(
    ...
    callback: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Core.Callback<Find.FindResponse<Content>> */ js.Any
  ): scala.Unit = js.native
  ...
  def getIndexes(
    callback: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Core.Callback<Find.GetIndexesResponse<Content>> */ js.Any
  ): scala.Unit = js.native
}
