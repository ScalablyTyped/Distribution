...
@js.native
trait Anon_AbortErrorArguments extends js.Object {
  var AbortError: org.scalablytyped.runtime.Instantiable0[pDashThrottleLib.pDashThrottleMod.AbortErrorClass] = js.native
