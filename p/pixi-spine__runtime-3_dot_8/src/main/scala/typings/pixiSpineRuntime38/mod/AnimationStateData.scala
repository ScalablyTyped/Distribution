...
@JSImport("@pixi-spine/runtime-3.8", "AnimationStateData")
@js.native
open class AnimationStateData protected ()
  ...
  def getMix(from: IAnimation[ITimeline], to: IAnimation[ITimeline]): Double = js.native
  /* CompleteClass */
  ...
  def setMixWith(from: IAnimation[ITimeline], to: IAnimation[ITimeline], duration: Double): Unit = js.native
  /* CompleteClass */
...
object AnimationStateData {
  ...
  @JSImport("@pixi-spine/runtime-3.8", "AnimationStateData.deprecatedWarning1")
  @js.native
