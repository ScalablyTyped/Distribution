...
- typings.pixiSpineBase.mod.IMeshAttachment because var conflicts: id, name, `type`, worldVerticesLength. Inlined triangles, color, regionUVs, region */ @JSImport("@pixi-spine/runtime-3.8", "MeshAttachment")
@js.native
