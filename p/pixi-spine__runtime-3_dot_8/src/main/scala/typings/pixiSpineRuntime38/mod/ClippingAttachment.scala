...
- typings.pixiSpineBase.mod.IClippingAttachment because var conflicts: id, name, `type`, worldVerticesLength. Inlined endSlot */ @JSImport("@pixi-spine/runtime-3.8", "ClippingAttachment")
@js.native
