...
@JSImport("@pixi-spine/runtime-3.8", "PathConstraint")
@js.native
...
object PathConstraint {
  ...
  @JSImport("@pixi-spine/runtime-3.8", "PathConstraint.AFTER")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.8", "PathConstraint.BEFORE")
  @js.native
