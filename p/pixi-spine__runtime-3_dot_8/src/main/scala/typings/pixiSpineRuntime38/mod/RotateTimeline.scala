...
@JSImport("@pixi-spine/runtime-3.8", "RotateTimeline")
@js.native
...
object RotateTimeline {
  ...
  @JSImport("@pixi-spine/runtime-3.8", "RotateTimeline.ENTRIES")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.8", "RotateTimeline.PREV_ROTATION")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.8", "RotateTimeline.PREV_TIME")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.8", "RotateTimeline.ROTATION")
  @js.native
