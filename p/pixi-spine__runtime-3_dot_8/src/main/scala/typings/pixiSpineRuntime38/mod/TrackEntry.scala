...
@JSImport("@pixi-spine/runtime-3.8", "TrackEntry")
@js.native
...
object TrackEntry {
  ...
  @JSImport("@pixi-spine/runtime-3.8", "TrackEntry.deprecatedWarning1")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.8", "TrackEntry.deprecatedWarning2")
  @js.native
