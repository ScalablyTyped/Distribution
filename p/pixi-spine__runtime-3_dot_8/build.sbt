...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "pixi-spine__base" % "3.1.0-133633",
  ...
  "org.scalablytyped" %%% "pixi__graphics" % "6.5.4-758b03",
  "org.scalablytyped" %%% "pixi__math" % "6.5.4-f55c28",
  "org.scalablytyped" %%% "pixi__mesh" % "6.5.4-c64d0b",
  "org.scalablytyped" %%% "pixi__mesh-extras" % "6.5.4-260917",
