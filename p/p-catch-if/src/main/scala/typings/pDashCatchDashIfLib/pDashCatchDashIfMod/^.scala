...
object ^ extends js.Object {
  ...
  // export = pCatchIf;
  @JSName("default")
  var default_Original: pDashCatchDashIfLib.Anon_CatchHandler = js.native
  /**
  	...
  	```
  	*/
  def apply[T](predicate: Predicate, catchHandler: js.Function1[/* error */ stdLib.Error, T]): js.Function1[/* error */ stdLib.Error, T] = js.native
  /**
  	Conditional promise catch handler.
  	@param predicate - Specify either an `Error` constructor, array of `Error` constructors, `boolean`, or function that returns a promise for a `boolean` or a `boolean`. If the function returns a promise, it's awaited.
  	@param catchHandler - Called if `predicate` passes. This is what you would normally pass to `.catch()`.
  ...
  // ): (error: Error) => T;
  // export = pCatchIf;
  def default[T](predicate: Predicate, catchHandler: js.Function1[/* error */ stdLib.Error, T]): js.Function1[/* error */ stdLib.Error, T] = js.native
}
