package typings.pDashCatchDashIf.pDashCatchDashIfMod

import typings.pDashCatchDashIf.Anon_CatchHandler
...
object ^ extends js.Object {
  ...
  // export = pCatchIf;
  @JSName("default")
  var default_Original: Anon_CatchHandler = js.native
  /**
  ...
  // ): (error: Error) => T;
  // export = pCatchIf;
  def default[T](predicate: Predicate, catchHandler: js.Function1[/* error */ Error, T]): js.Function1[/* error */ Error, T] = js.native
}
