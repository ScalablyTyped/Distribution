...
import typings.p5.mod.IMAGE_FIT
...
import typings.p5.mod.X_ALIGN
import typings.p5.mod.Y_ALIGN
...
object globalMod {
  ...
  object global {
    ...
    /**
      ...
      *   @chainable
      */
    inline def ambientMaterial(gray: Double): ^ = js.Dynamic.global.applyDynamic("ambientMaterial")(gray.asInstanceOf[js.Any]).asInstanceOf[^]
    /**
      *   Sets the ambient color of the material. The
      *   ambientMaterial() color is the color the object
      *   will reflect under any lighting.
    ...
    /**
      ...
      */
    inline def angleMode(): UNKNOWN_P5_CONSTANT = js.Dynamic.global.applyDynamic("angleMode")().asInstanceOf[UNKNOWN_P5_CONSTANT]
    /**
      *   Sets the current mode of p5 to the given mode.
      *   Default mode is RADIANS. Calling angleMode() with
      *   no arguments returns current anglemode.
    ...
    /**
      ...
      *   @chainable
      */
    inline def applyMatrix(arr: js.Array[Any]): ^ = js.Dynamic.global.applyDynamic("applyMatrix")(arr.asInstanceOf[js.Any]).asInstanceOf[^]
    /**
      *   Multiplies the current matrix by the one specified
      *   through the parameters. This is a powerful
      *   operation that can perform the equivalent of
    ...
    inline def applyMatrix(
      ...
      o: Double,
      p: Double
    ): ^ = (js.Dynamic.global.applyDynamic("applyMatrix")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any], d.asInstanceOf[js.Any], e.asInstanceOf[js.Any], f.asInstanceOf[js.Any], g.asInstanceOf[js.Any], h.asInstanceOf[js.Any], i.asInstanceOf[js.Any], j.asInstanceOf[js.Any], k.asInstanceOf[js.Any], l.asInstanceOf[js.Any], m.asInstanceOf[js.Any], n.asInstanceOf[js.Any], o.asInstanceOf[js.Any], p.asInstanceOf[js.Any])).asInstanceOf[^]
    ...
    inline def directionalLight(color: String, direction: Vector): ^ = (js.Dynamic.global.applyDynamic("directionalLight")(color.asInstanceOf[js.Any], direction.asInstanceOf[js.Any])).asInstanceOf[^]
    ...
    inline def directionalLight(color: js.Array[Double], direction: Vector): ^ = (js.Dynamic.global.applyDynamic("directionalLight")(color.asInstanceOf[js.Any], direction.asInstanceOf[js.Any])).asInstanceOf[^]
    ...
    /**
      ...
      *   @chainable
      */
    inline def directionalLight(color: Color, direction: Vector): ^ = (js.Dynamic.global.applyDynamic("directionalLight")(color.asInstanceOf[js.Any], direction.asInstanceOf[js.Any])).asInstanceOf[^]
    /**
      *   Creates a directional light with the given color
      *   and direction. Directional light comes from one
      *   direction. The direction is specified as numbers
    ...
    /**
      ...
      *   @chainable
      */
    inline def directionalLight(v1: Double, v2: Double, v3: Double, direction: Vector): ^ = (js.Dynamic.global.applyDynamic("directionalLight")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any], v3.asInstanceOf[js.Any], direction.asInstanceOf[js.Any])).asInstanceOf[^]
    /**
      *   Creates a directional light with the given color
      *   and direction. Directional light comes from one
      *   direction. The direction is specified as numbers
    ...
    /**
      ...
      *   @chainable
      */
    inline def emissiveMaterial(gray: Double): ^ = js.Dynamic.global.applyDynamic("emissiveMaterial")(gray.asInstanceOf[js.Any]).asInstanceOf[^]
    /**
      *   Sets the emissive color of the material. An
      *   emissive material will display the emissive color
      *   at full strength regardless of lighting. This can
    ...
    inline def emissiveMaterial(v1: Double, v2: Double, v3: Double, alpha: Double): ^ = (js.Dynamic.global.applyDynamic("emissiveMaterial")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any], v3.asInstanceOf[js.Any], alpha.asInstanceOf[js.Any])).asInstanceOf[^]
    ...
    /**
      ...
      */
    inline def getTargetFrameRate(): Double = js.Dynamic.global.applyDynamic("getTargetFrameRate")().asInstanceOf[Double]
    ...
    ): Unit = (js.Dynamic.global.applyDynamic("image")(img.asInstanceOf[js.Any], dx.asInstanceOf[js.Any], dy.asInstanceOf[js.Any], dWidth.asInstanceOf[js.Any], dHeight.asInstanceOf[js.Any], sx.asInstanceOf[js.Any], sy.asInstanceOf[js.Any], sWidth.asInstanceOf[js.Any], sHeight.asInstanceOf[js.Any], fit.asInstanceOf[js.Any], xAlign.asInstanceOf[js.Any], yAlign.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /**
      ...
      */
    inline def saveGif(filename: String, duration: Double, options: js.Object): Unit = (js.Dynamic.global.applyDynamic("saveGif")(filename.asInstanceOf[js.Any], duration.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    inline def spotLight(color: String, position: Vector, direction: Vector, angle: Double, concentration: Double): Unit = (js.Dynamic.global.applyDynamic("spotLight")(color.asInstanceOf[js.Any], position.asInstanceOf[js.Any], direction.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def spotLight(color: String, position: Vector, direction: Vector, angle: Unit, concentration: Double): Unit = (js.Dynamic.global.applyDynamic("spotLight")(color.asInstanceOf[js.Any], position.asInstanceOf[js.Any], direction.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    ): Unit = (js.Dynamic.global.applyDynamic("spotLight")(color.asInstanceOf[js.Any], position.asInstanceOf[js.Any], rx.asInstanceOf[js.Any], ry.asInstanceOf[js.Any], rz.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def spotLight(
      color: String,
      position: Vector,
      rx: Double,
    ...
    inline def spotLight(
      ...
      angle: Double,
      concentration: Double
    ): Unit = (js.Dynamic.global.applyDynamic("spotLight")(color.asInstanceOf[js.Any], x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any], direction.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def spotLight(
      color: String,
      x: Double,
      y: Double,
    ...
    inline def spotLight(
      ...
      angle: Double,
      concentration: Double
    ): Unit = (js.Dynamic.global.applyDynamic("spotLight")(color.asInstanceOf[js.Any], x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any], rx.asInstanceOf[js.Any], ry.asInstanceOf[js.Any], rz.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def spotLight(
      color: String,
      x: Double,
      y: Double,
    ...
    inline def spotLight(color: js.Array[Double], position: Vector, direction: Vector, angle: Double, concentration: Double): Unit = (js.Dynamic.global.applyDynamic("spotLight")(color.asInstanceOf[js.Any], position.asInstanceOf[js.Any], direction.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def spotLight(color: js.Array[Double], position: Vector, direction: Vector, angle: Unit, concentration: Double): Unit = (js.Dynamic.global.applyDynamic("spotLight")(color.asInstanceOf[js.Any], position.asInstanceOf[js.Any], direction.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    inline def spotLight(color: Color, position: Vector, direction: Vector, angle: Double, concentration: Double): Unit = (js.Dynamic.global.applyDynamic("spotLight")(color.asInstanceOf[js.Any], position.asInstanceOf[js.Any], direction.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def spotLight(color: Color, position: Vector, direction: Vector, angle: Unit, concentration: Double): Unit = (js.Dynamic.global.applyDynamic("spotLight")(color.asInstanceOf[js.Any], position.asInstanceOf[js.Any], direction.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    /**
      *   Creates a spot light with the given color,
      *   position, light direction, angle, and
      *   concentration. Like a pointLight(), a spotLight()
    ...
    inline def spotLight(
      ...
      angle: Double,
      concentration: Double
    ): Unit = (js.Dynamic.global.applyDynamic("spotLight")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any], v3.asInstanceOf[js.Any], position.asInstanceOf[js.Any], direction.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def spotLight(
      v1: Double,
      v2: Double,
      v3: Double,
    ...
    inline def spotLight(
      ...
      angle: Double,
      concentration: Double
    ): Unit = (js.Dynamic.global.applyDynamic("spotLight")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any], v3.asInstanceOf[js.Any], position.asInstanceOf[js.Any], rx.asInstanceOf[js.Any], ry.asInstanceOf[js.Any], rz.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def spotLight(
      v1: Double,
      v2: Double,
      v3: Double,
    ...
    inline def spotLight(
      ...
      angle: Double,
      concentration: Double
    ): Unit = (js.Dynamic.global.applyDynamic("spotLight")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any], v3.asInstanceOf[js.Any], x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any], direction.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def spotLight(
      v1: Double,
      v2: Double,
      v3: Double,
    ...
    inline def spotLight(
      ...
      angle: Double,
      concentration: Double
    ): ^ = (js.Dynamic.global.applyDynamic("spotLight")(v1.asInstanceOf[js.Any], v2.asInstanceOf[js.Any], v3.asInstanceOf[js.Any], x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any], rx.asInstanceOf[js.Any], ry.asInstanceOf[js.Any], rz.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], concentration.asInstanceOf[js.Any])).asInstanceOf[^]
    inline def spotLight(
      v1: Double,
      v2: Double,
      v3: Double,
    ...
    /**
      ...
      */
    inline def userStartAudio(): js.Promise[Any] = js.Dynamic.global.applyDynamic("userStartAudio")().asInstanceOf[js.Promise[Any]]
    inline def userStartAudio(elements: js.Array[Any]): js.Promise[Any] = js.Dynamic.global.applyDynamic("userStartAudio")(elements.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Any]]
    inline def userStartAudio(elements: js.Array[Any], callback: js.Function1[/* repeated */ Any, Any]): js.Promise[Any] = (js.Dynamic.global.applyDynamic("userStartAudio")(elements.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Any]]
    inline def userStartAudio(elements: Unit, callback: js.Function1[/* repeated */ Any, Any]): js.Promise[Any] = (js.Dynamic.global.applyDynamic("userStartAudio")(elements.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Any]]
    inline def userStartAudio(elements: typings.std.Element): js.Promise[Any] = js.Dynamic.global.applyDynamic("userStartAudio")(elements.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Any]]
    inline def userStartAudio(elements: typings.std.Element, callback: js.Function1[/* repeated */ Any, Any]): js.Promise[Any] = (js.Dynamic.global.applyDynamic("userStartAudio")(elements.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Any]]
    ...
    inline def vertex(x: Double, y: Double, z: Unit, u: Double): ^ = (js.Dynamic.global.applyDynamic("vertex")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any], u.asInstanceOf[js.Any])).asInstanceOf[^]
    inline def vertex(x: Double, y: Double, z: Unit, u: Double, v: Double): ^ = (js.Dynamic.global.applyDynamic("vertex")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any], u.asInstanceOf[js.Any], v.asInstanceOf[js.Any])).asInstanceOf[^]
    inline def vertex(x: Double, y: Double, z: Unit, u: Unit, v: Double): ^ = (js.Dynamic.global.applyDynamic("vertex")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any], u.asInstanceOf[js.Any], v.asInstanceOf[js.Any])).asInstanceOf[^]
