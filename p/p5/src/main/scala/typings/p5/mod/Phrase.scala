...
object Phrase {
  ...
  inline def apply(sequence: js.Array[js.Any]): Phrase = {
  ...
  extension [Self <: Phrase](x: Self) {
    ...
    inline def setSequence(value: js.Array[js.Any]): Self = StObject.set(x, "sequence", value.asInstanceOf[js.Any])
    
    inline def setSequenceVarargs(value: js.Any*): Self = StObject.set(x, "sequence", js.Array(value :_*))
  }
}
