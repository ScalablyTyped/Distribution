...
trait MediaElement extends js.Object {
  ...
  /**
       ...
       *   removeCue(id)
       */
  def addCue(time: scala.Double, callback: js.Function1[/* repeated */js.Any, _]): scala.Double = js.native
  /**
       *   Schedule events to trigger every time a
       *   MediaElement (audio/video) reaches a playback cue
       *   point. Accepts a callback function, a time (in
       ...
       *   removeCue(id)
       */
  def addCue(time: scala.Double, callback: js.Function1[/* repeated */js.Any, _], value: js.Object): scala.Double = js.native
  /**
       ...
       *   @chainable
       */
  def autoplay(autoplay: scala.Boolean): p5Lib.p5Mod.MediaElement = js.native
  /**
       ...
       */
  def clearCues(id: scala.Double): scala.Unit = js.native
  /**
       ...
       */
  def connect(audioNode: js.Object): scala.Unit = js.native
  /**
       *   Send the audio output of this element to a
       *   specified audioNode or p5.sound object. If no
       *   element is provided, connects to p5's master
       ...
       *   or an object from the p5.sound library
       */
  def connect(audioNode: stdLib.AudioNode): scala.Unit = js.native
  /**
  ...
  /**
       ...
       *   @chainable
       */
  def onended(callback: js.Function1[/* repeated */js.Any, _]): p5Lib.p5Mod.MediaElement = js.native
  /**
       *   Pauses an HTML5 media element.
       *   @chainable
       */
  def pause(): p5Lib.p5Mod.MediaElement = js.native
  /**
       *   Play an HTML5 media element.
       *   @chainable
       */
  def play(): p5Lib.p5Mod.MediaElement = js.native
  /**
       *   Remove a callback based on its ID. The ID is
       *   returned by the addCue method.
       *   @param id ID of the cue, as returned by addCue
       */
  def removeCue(id: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
       ...
       *   @chainable
       */
  def speed(speed: scala.Double): p5Lib.p5Mod.MediaElement = js.native
  /**
       *   Stops an HTML5 media element (sets current time to
       *   zero).
       *   @chainable
       */
  def stop(): p5Lib.p5Mod.MediaElement = js.native
  /**
       *   If no arguments are given, returns the current
  ...
  /**
       ...
       *   @chainable
       */
  def time(time: scala.Double): p5Lib.p5Mod.MediaElement = js.native
  /**
  ...
  /**
       ...
       *   @chainable
       */
  def volume(`val`: scala.Double): p5Lib.p5Mod.MediaElement = js.native
}
