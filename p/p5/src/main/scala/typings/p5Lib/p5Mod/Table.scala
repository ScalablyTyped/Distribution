...
trait Table extends js.Object {
  ...
  /**
    ...
    */
  def addColumn(): scala.Unit = js.native
  def addColumn(title: java.lang.String): scala.Unit = js.native
  /**
  ...
  def findRow(value: java.lang.String, column: java.lang.String): TableRow = js.native
  /**
    ...
    *   search
    */
  def findRow(value: java.lang.String, column: scala.Double): TableRow = js.native
  def findRows(value: java.lang.String, column: java.lang.String): js.Array[TableRow] = js.native
  /**
    ...
    */
  def findRows(value: java.lang.String, column: scala.Double): js.Array[TableRow] = js.native
  /**
    ...
    */
  def get(row: scala.Double, column: java.lang.String): java.lang.String | scala.Double = js.native
  def get(row: scala.Double, column: scala.Double): java.lang.String | scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getColumn(column: java.lang.String): js.Array[_] = js.native
  def getColumn(column: scala.Double): js.Array[_] = js.native
  /**
  ...
  /**
    ...
    *   @param column columnName (string) or ID (number)
    */
  def getNum(row: scala.Double, column: java.lang.String): scala.Double = js.native
  def getNum(row: scala.Double, column: scala.Double): scala.Double = js.native
  /**
  ...
  def getObject(headerColumn: java.lang.String): js.Object = js.native
  /**
    ...
    */
  def getRow(rowID: scala.Double): TableRow = js.native
  /**
  ...
  /**
    ...
    *   @param column columnName (string) or ID (number)
    */
  def getString(row: scala.Double, column: java.lang.String): java.lang.String = js.native
  def getString(row: scala.Double, column: scala.Double): java.lang.String = js.native
  /**
    ...
    */
  def matchRow(regexp: java.lang.String, column: java.lang.String): TableRow = js.native
  def matchRow(regexp: java.lang.String, column: scala.Double): TableRow = js.native
  def matchRow(regexp: stdLib.RegExp, column: java.lang.String): TableRow = js.native
  def matchRow(regexp: stdLib.RegExp, column: scala.Double): TableRow = js.native
  /**
    ...
    *   @return An Array of TableRow objects
    */
  def matchRows(regexp: java.lang.String): js.Array[TableRow] = js.native
  def matchRows(regexp: java.lang.String, column: java.lang.String): js.Array[TableRow] = js.native
  def matchRows(regexp: java.lang.String, column: scala.Double): js.Array[TableRow] = js.native
  /**
    ...
    *   @param column columnName (string) or ID (number)
    */
  def removeColumn(column: java.lang.String): scala.Unit = js.native
  def removeColumn(column: scala.Double): scala.Unit = js.native
  /**
    *   Removes a row from the table object.
    *   @param id ID number of the row to remove
    */
  def removeRow(id: scala.Double): scala.Unit = js.native
  /**
    ...
    *   (string)
    */
  def removeTokens(chars: java.lang.String): scala.Unit = js.native
  def removeTokens(chars: java.lang.String, column: java.lang.String): scala.Unit = js.native
  def removeTokens(chars: java.lang.String, column: scala.Double): scala.Unit = js.native
  /**
    ...
    */
  def set(row: scala.Double, column: java.lang.String, value: java.lang.String): scala.Unit = js.native
  def set(row: scala.Double, column: java.lang.String, value: scala.Double): scala.Unit = js.native
  def set(row: scala.Double, column: scala.Double, value: java.lang.String): scala.Unit = js.native
  def set(row: scala.Double, column: scala.Double, value: scala.Double): scala.Unit = js.native
  /**
    ...
    *   @param value value to assign
    */
  def setNum(row: scala.Double, column: java.lang.String, value: scala.Double): scala.Unit = js.native
  def setNum(row: scala.Double, column: scala.Double, value: scala.Double): scala.Unit = js.native
  /**
    ...
    *   @param value value to assign
    */
  def setString(row: scala.Double, column: java.lang.String, value: java.lang.String): scala.Unit = js.native
  def setString(row: scala.Double, column: scala.Double, value: java.lang.String): scala.Unit = js.native
  /**
  ...
  def trim(column: java.lang.String): scala.Unit = js.native
  def trim(column: scala.Double): scala.Unit = js.native
}
