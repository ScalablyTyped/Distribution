...
trait Convolver
  ...
  /**
    ...
    */
  def createConvolver(path: java.lang.String): p5Lib.p5Mod.Convolver = js.native
  def createConvolver(path: java.lang.String, callback: js.Function1[/* repeated */ js.Any, _]): p5Lib.p5Mod.Convolver = js.native
  def createConvolver(
    path: java.lang.String,
    callback: js.Function1[/* repeated */ js.Any, _],
    errorCallback: js.Function1[/* repeated */ js.Any, _]
  ): p5Lib.p5Mod.Convolver = js.native
  /**
