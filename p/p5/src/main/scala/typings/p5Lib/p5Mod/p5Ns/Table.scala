...
trait Table extends js.Object {
  ...
  var rows: js.Array[p5Lib.p5Mod.TableRow] = js.native
  /**
  ...
  /**
    ...
    */
  def addRow(): p5Lib.p5Mod.TableRow = js.native
  def addRow(row: p5Lib.p5Mod.TableRow): p5Lib.p5Mod.TableRow = js.native
  /**
  ...
  def findRow(value: java.lang.String, column: java.lang.String): p5Lib.p5Mod.TableRow = js.native
  /**
    ...
    *   search
    */
  def findRow(value: java.lang.String, column: scala.Double): p5Lib.p5Mod.TableRow = js.native
  def findRows(value: java.lang.String, column: java.lang.String): js.Array[p5Lib.p5Mod.TableRow] = js.native
  /**
    ...
    */
  def findRows(value: java.lang.String, column: scala.Double): js.Array[p5Lib.p5Mod.TableRow] = js.native
  /**
  ...
  /**
    ...
    */
  def getRow(rowID: scala.Double): p5Lib.p5Mod.TableRow = js.native
  /**
  ...
  /**
    ...
    */
  def getRows(): js.Array[p5Lib.p5Mod.TableRow] = js.native
  /**
  ...
  /**
    ...
    */
  def matchRow(regexp: java.lang.String, column: java.lang.String): p5Lib.p5Mod.TableRow = js.native
  def matchRow(regexp: java.lang.String, column: scala.Double): p5Lib.p5Mod.TableRow = js.native
  def matchRow(regexp: stdLib.RegExp, column: java.lang.String): p5Lib.p5Mod.TableRow = js.native
  def matchRow(regexp: stdLib.RegExp, column: scala.Double): p5Lib.p5Mod.TableRow = js.native
  /**
    ...
    *   @return An Array of TableRow objects
    */
  def matchRows(regexp: java.lang.String): js.Array[p5Lib.p5Mod.TableRow] = js.native
  def matchRows(regexp: java.lang.String, column: java.lang.String): js.Array[p5Lib.p5Mod.TableRow] = js.native
  def matchRows(regexp: java.lang.String, column: scala.Double): js.Array[p5Lib.p5Mod.TableRow] = js.native
  /**
