...
trait MediaElement extends js.Object {
  ...
  /**
    ...
    *   @chainable
    */
  def autoplay(autoplay: scala.Boolean): MediaElement = js.native
  /**
  ...
  /**
    ...
    *   @chainable
    */
  def speed(speed: scala.Double): MediaElement = js.native
  /**
  ...
  /**
    ...
    *   @chainable
    */
  def time(time: scala.Double): MediaElement = js.native
  /**
  ...
  /**
    ...
    *   @chainable
    */
  def volume(`val`: scala.Double): MediaElement = js.native
}
