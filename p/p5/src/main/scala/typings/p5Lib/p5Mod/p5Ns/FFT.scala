...
trait FFT extends js.Object {
  ...
  def analyze(bins: scala.Double): js.Array[_] = js.native
  def analyze(bins: scala.Double, scale: scala.Double): js.Array[_] = js.native
  /**
    ...
    */
  def getCentroid(): scala.Double = js.native
  def getEnergy(frequency1: java.lang.String): scala.Double = js.native
  def getEnergy(frequency1: java.lang.String, frequency2: scala.Double): scala.Double = js.native
  /**
    ...
    *   and 255.
    */
  def getEnergy(frequency1: scala.Double): scala.Double = js.native
  def getEnergy(frequency1: scala.Double, frequency2: scala.Double): scala.Double = js.native
  /**
    ...
    *   with their bounds
    */
  def getOctaveBands(N: scala.Double, fCtr0: scala.Double): js.Array[_] = js.native
  /**
    ...
    */
  def linAverages(N: scala.Double): js.Array[_] = js.native
  /**
  ...
  def setInput(source: js.Object): scala.Unit = js.native
  /**
    ...
    *   to 0.8.
    */
  def smooth(smoothing: scala.Double): scala.Unit = js.native
  /**
  ...
  def waveform(bins: scala.Double): js.Array[_] = js.native
  def waveform(bins: scala.Double, precision: java.lang.String): js.Array[_] = js.native
}
