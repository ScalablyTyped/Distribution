...
trait Image extends js.Object {
  ...
  /**
    ...
    *   G, B, A] or p5.Image
    */
  def get(): js.Array[scala.Double] | Color | Image = js.native
  def get(x: scala.Double): js.Array[scala.Double] | Color | Image = js.native
  def get(x: scala.Double, y: scala.Double): js.Array[scala.Double] | Color | Image = js.native
  def get(x: scala.Double, y: scala.Double, w: scala.Double): js.Array[scala.Double] | Color | Image = js.native
  def get(x: scala.Double, y: scala.Double, w: scala.Double, h: scala.Double): js.Array[scala.Double] | Color | Image = js.native
  /**
  ...
  /**
    ...
    *   @param srcImage source image
    */
  def mask(srcImage: Image): scala.Unit = js.native
  /**
