...
trait SoundFile extends js.Object {
  ...
  /**
    ...
    */
  def loadSound(path: java.lang.String): SoundFile = js.native
  def loadSound(path: java.lang.String, successCallback: js.Function1[/* repeated */ js.Any, _]): SoundFile = js.native
  def loadSound(
