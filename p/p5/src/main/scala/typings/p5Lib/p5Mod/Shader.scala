...
trait Shader extends js.Object {
  def setUniform(uniformName: java.lang.String, data: js.Array[scala.Double]): Shader = js.native
  /**
    ...
    *   @chainable
    */
  def setUniform(uniformName: java.lang.String, data: js.Object): Shader = js.native
  def setUniform(uniformName: java.lang.String, data: scala.Boolean): Shader = js.native
  def setUniform(uniformName: java.lang.String, data: scala.Double): Shader = js.native
}
