...
trait Envelope extends js.Object {
  ...
  /**
       ...
       *   output
       */
  def add(number: scala.Double): p5Lib.p5Mod.Envelope = js.native
  /**
       ...
       *   output
       */
  def mult(number: scala.Double): p5Lib.p5Mod.Envelope = js.native
  /**
       ...
       */
  def play(unit: js.Object): scala.Unit = js.native
  /**
       *   Play tells the envelope to start acting on a given
       *   input. If the input is a p5.sound object (i.e.
       *   AudioIn, Oscillator, SoundFile), then Envelope
       ...
       *   releasing the envelope
       */
  def play(unit: js.Object, startTime: scala.Double): scala.Unit = js.native
  /**
       *   Play tells the envelope to start acting on a given
       *   input. If the input is a p5.sound object (i.e.
       *   AudioIn, Oscillator, SoundFile), then Envelope
       ...
       *   releasing the envelope
       */
  def play(unit: js.Object, startTime: scala.Double, sustainTime: scala.Double): scala.Unit = js.native
  /**
       ...
       */
  def ramp(unit: js.Object, secondsFromNow: scala.Double, v: scala.Double): scala.Unit = js.native
  /**
       *   Exponentially ramp to a value using the first two
       *   values from setADSR(attackTime, decayTime) as
       *   time constants for simple exponential ramps. If
       ...
       *   @param [v2] Second target value (optional)
       */
  def ramp(unit: js.Object, secondsFromNow: scala.Double, v: scala.Double, v2: scala.Double): scala.Unit = js.native
  /**
       ...
       *   output
       */
  def scale(inMin: scala.Double, inMax: scala.Double, outMin: scala.Double, outMax: scala.Double): p5Lib.p5Mod.Envelope = js.native
  /**
  ...
  def set(
    ...
    attackLevel: scala.Double,
    decayTime: scala.Double,
    decayLevel: scala.Double,
    releaseTime: scala.Double,
    releaseLevel: scala.Double
  ...
  /**
       ...
       */
  def setExp(isExp: scala.Boolean): scala.Unit = js.native
  /**
  ...
  /**
       ...
       *   Param.
       */
  def setInput(inputs: js.Object): scala.Unit = js.native
  /**
       ...
       */
  def setRange(aLevel: scala.Double, rLevel: scala.Double): scala.Unit = js.native
  /**
       ...
       */
  def triggerAttack(unit: js.Object, secondsFromNow: scala.Double): scala.Unit = js.native
  /**
       ...
       */
  def triggerRelease(unit: js.Object, secondsFromNow: scala.Double): scala.Unit = js.native
}
