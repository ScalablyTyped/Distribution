...
trait Envelope extends js.Object {
  ...
  /**
    ...
    *   output
    */
  def add(number: scala.Double): Envelope = js.native
  /**
    ...
    *   output
    */
  def mult(number: scala.Double): Envelope = js.native
  /**
  ...
  /**
    ...
    *   output
    */
  def scale(inMin: scala.Double, inMax: scala.Double, outMin: scala.Double, outMax: scala.Double): Envelope = js.native
  /**
