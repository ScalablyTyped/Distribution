...
trait Element extends js.Object {
  ...
  /**
    ...
    *   @chainable
    */
  def addClass(theClass: java.lang.String): Element = js.native
  /**
  ...
  /**
    ...
    *   @chainable
    */
  def attribute(attr: java.lang.String, value: java.lang.String): Element = js.native
  /**
  ...
  def center(align: java.lang.String): Element = js.native
  /**
  ...
  def child(child: java.lang.String): Element = js.native
  ...
  /**
    ...
    *   @chainable
    */
  def `class`(theClass: java.lang.String): Element = js.native
  /**
  ...
  def doubleClicked(fxn: scala.Boolean): Element = js.native
  /**
  ...
  def dragLeave(fxn: scala.Boolean): Element = js.native
  /**
  ...
  def dragOver(fxn: scala.Boolean): Element = js.native
  /**
  ...
  def html(html: java.lang.String): Element = js.native
  def html(html: java.lang.String, append: scala.Boolean): Element = js.native
  /**
    *   If an argument is given, sets the inner HTML of
    *   the element, replacing any existing html. If true
    *   is included as a second argument, html is appended
  ...
  /**
    ...
    *   @chainable
    */
  def id(id: java.lang.String): Element = js.native
  /**
  ...
  def mouseClicked(fxn: scala.Boolean): Element = js.native
  /**
  ...
  def mouseMoved(fxn: scala.Boolean): Element = js.native
  /**
  ...
  def mouseOut(fxn: scala.Boolean): Element = js.native
  /**
  ...
  def mouseOver(fxn: scala.Boolean): Element = js.native
  /**
  ...
  def mousePressed(fxn: scala.Boolean): Element = js.native
  /**
  ...
  def mouseReleased(fxn: scala.Boolean): Element = js.native
  /**
  ...
  def mouseWheel(fxn: scala.Boolean): Element = js.native
  /**
  ...
  /**
    ...
    *   @chainable
    */
  def parent(parent: java.lang.String): Element = js.native
  ...
  def position(x: scala.Double): Element = js.native
  def position(x: scala.Double, y: scala.Double): Element = js.native
  /**
    *   Sets the position of the element relative to (0,
    *   0) of the window. Essentially, sets
    *   position:absolute and left and top properties of
  ...
  /**
    ...
    *   @chainable
    */
  def removeAttribute(attr: java.lang.String): Element = js.native
  /**
    *   Removes specified class from the element.
    *   @param class name of class to remove
    *   @chainable
    */
  def removeClass(theClass: java.lang.String): Element = js.native
  /**
  ...
  def size(w: SIZE_W, h: scala.Double): Element = js.native
  /**
    *   Sets the width and height of the element. AUTO can
    *   be used to only adjust one dimension. If no
    *   arguments given returns the width and height of
    ...
    *   @chainable
    */
  def size(w: scala.Double): Element = js.native
  def size(w: scala.Double, h: SIZE_H): Element = js.native
  def size(w: scala.Double, h: scala.Double): Element = js.native
  /**
  ...
  /**
    ...
    *   @chainable
    */
  def style(property: java.lang.String, value: java.lang.String | scala.Double | Color): Element = js.native
  def style(
    property: java.lang.String,
    value: java.lang.String | scala.Double | Color,
    value2: java.lang.String | scala.Double | Color
  ): Element = js.native
  def style(
    property: java.lang.String,
    value: java.lang.String | scala.Double | Color,
    value2: java.lang.String | scala.Double | Color,
    value3: java.lang.String | scala.Double | Color
  ): Element = js.native
  /**
  ...
  def touchEnded(fxn: scala.Boolean): Element = js.native
  /**
  ...
  def touchMoved(fxn: scala.Boolean): Element = js.native
  /**
  ...
  def touchStarted(fxn: scala.Boolean): Element = js.native
  /**
  ...
  /**
    ...
    *   @chainable
    */
  def value(value: java.lang.String): Element = js.native
  def value(value: scala.Double): Element = js.native
}
