...
trait SoundRecorder extends js.Object {
  /**
    ...
    */
  def record(soundFile: SoundFile): scala.Unit = js.native
  def record(soundFile: SoundFile, duration: scala.Double): scala.Unit = js.native
  def record(soundFile: SoundFile, duration: scala.Double, callback: js.Function1[/* repeated */ js.Any, _]): scala.Unit = js.native
  /**
