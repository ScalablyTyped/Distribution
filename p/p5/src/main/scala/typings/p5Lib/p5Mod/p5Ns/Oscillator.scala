...
trait Oscillator extends js.Object {
  /**
    ...
    *   scaled output
    */
  def add(number: scala.Double): p5Lib.p5Mod.Oscillator = js.native
  ...
  /**
    ...
    *   multiplied output
    */
  def mult(number: scala.Double): p5Lib.p5Mod.Oscillator = js.native
  /**
  ...
  /**
    ...
    *   scaled output
    */
  def scale(inMin: scala.Double, inMax: scala.Double, outMin: scala.Double, outMax: scala.Double): p5Lib.p5Mod.Oscillator = js.native
  /**
