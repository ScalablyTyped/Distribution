...
trait Vector extends js.Object {
  ...
  def add(value: js.Array[scala.Double]): Vector = js.native
  /**
  ...
  /**
    ...
    *   @chainable
    */
  def add(x: scala.Double): Vector = js.native
  def add(x: scala.Double, y: scala.Double): Vector = js.native
  def add(x: scala.Double, y: scala.Double, z: scala.Double): Vector = js.native
  /**
    ...
    */
  def angleBetween(the: Vector): scala.Double = js.native
  /**
  ...
  /**
    ...
    *   @return the distance
    */
  def dist(v: Vector): scala.Double = js.native
  /**
    ...
    *   @chainable
    */
  def div(n: scala.Double): Vector = js.native
  /**
    ...
    *   p5.Vector
    */
  def dot(value: Vector): scala.Double = js.native
  /**
    *   Calculates the dot product of two vectors. The
    *   version of the method that computes the dot
    *   product of two independent vectors is a static
  ...
  /**
    ...
    */
  def equals(value: Vector): scala.Boolean = js.native
  ...
  /**
    ...
    *   @chainable
    */
  def lerp(v: Vector, amt: scala.Double): Vector = js.native
  /**
    *   Linear interpolate the vector to another vector
    ...
    *   @chainable
    */
  def lerp(x: scala.Double, y: scala.Double, z: scala.Double, amt: scala.Double): Vector = js.native
  /**
    ...
    *   @chainable
    */
  def limit(max: scala.Double): Vector = js.native
  /**
  ...
  /**
    ...
    *   @chainable
    */
  def mult(n: scala.Double): Vector = js.native
  /**
  ...
  def set(value: js.Array[scala.Double]): Vector = js.native
  /**
    *   Sets the x, y, and z component of the vector using
    *   two or three separate variables, the data from a
    *   p5.Vector, or the values from a float array.
  ...
  def set(x: scala.Double): Vector = js.native
  def set(x: scala.Double, y: scala.Double): Vector = js.native
  def set(x: scala.Double, y: scala.Double, z: scala.Double): Vector = js.native
  /**
    ...
    *   @chainable
    */
  def setMag(len: scala.Double): Vector = js.native
  def sub(value: js.Array[scala.Double]): Vector = js.native
  /**
  ...
  /**
    ...
    *   @chainable
    */
  def sub(x: scala.Double): Vector = js.native
  def sub(x: scala.Double, y: scala.Double): Vector = js.native
  def sub(x: scala.Double, y: scala.Double, z: scala.Double): Vector = js.native
}
