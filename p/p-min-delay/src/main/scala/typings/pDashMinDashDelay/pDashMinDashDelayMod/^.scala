...
import typings.pDashMinDashDelay.Anon_Default
...
object ^ extends js.Object {
  ...
  // ): Promise<ValueType>;
  // export = pMinDelay;
  def default[ValueType](promise: js.Thenable[ValueType], minimumDelay: Double): js.Promise[ValueType] = js.native
  def default[ValueType](promise: js.Thenable[ValueType], minimumDelay: Double, options: Options): js.Promise[ValueType] = js.native
}
