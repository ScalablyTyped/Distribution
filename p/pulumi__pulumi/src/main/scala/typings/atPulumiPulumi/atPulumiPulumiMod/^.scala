...
object ^ extends js.Object {
  ...
  val rootStackResource: typings.atPulumiPulumi.resourceMod.Resource = js.native
  ...
  def createUrn(name: Input[String], `type`: Input[String]): typings.atPulumiPulumi.outputMod.Output[String] = js.native
  def createUrn(name: Input[String], `type`: Input[String], parent: Input[URN]): typings.atPulumiPulumi.outputMod.Output[String] = js.native
  def createUrn(name: Input[String], `type`: Input[String], parent: Input[URN], project: String): typings.atPulumiPulumi.outputMod.Output[String] = js.native
  def createUrn(name: Input[String], `type`: Input[String], parent: Input[URN], project: String, stack: String): typings.atPulumiPulumi.outputMod.Output[String] = js.native
  def createUrn(name: Input[String], `type`: Input[String], parent: typings.atPulumiPulumi.resourceMod.Resource): typings.atPulumiPulumi.outputMod.Output[String] = js.native
  def createUrn(
    name: Input[String],
    `type`: Input[String],
