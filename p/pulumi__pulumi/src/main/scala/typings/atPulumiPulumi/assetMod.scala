...
object assetMod extends js.Object {
  ...
  abstract class Archive ()
    extends typings.atPulumiPulumi.assetArchiveMod.Archive
  
  @js.native
  abstract class Asset ()
    extends typings.atPulumiPulumi.assetAssetMod.Asset
  ...
  class FileArchive protected ()
    extends typings.atPulumiPulumi.assetArchiveMod.FileArchive {
  ...
  class FileAsset protected ()
    extends typings.atPulumiPulumi.assetAssetMod.FileAsset {
    def this(path: String) = this()
    def this(path: js.Promise[String]) = this()
  }
  ...
  class RemoteArchive protected ()
    extends typings.atPulumiPulumi.assetArchiveMod.RemoteArchive {
  ...
  class StringAsset protected ()
    extends typings.atPulumiPulumi.assetAssetMod.StringAsset {
