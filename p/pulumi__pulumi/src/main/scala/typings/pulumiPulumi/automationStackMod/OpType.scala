...
/* Rewritten from type alias, can be one of: 
  - typings.pulumiPulumi.pulumiPulumiStrings.same
  - typings.pulumiPulumi.pulumiPulumiStrings.create
  - typings.pulumiPulumi.pulumiPulumiStrings.update
  - typings.pulumiPulumi.pulumiPulumiStrings.delete
  - typings.pulumiPulumi.pulumiPulumiStrings.replace
