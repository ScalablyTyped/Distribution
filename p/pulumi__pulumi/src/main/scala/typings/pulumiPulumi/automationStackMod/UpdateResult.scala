...
/* Rewritten from type alias, can be one of: 
  - typings.pulumiPulumi.pulumiPulumiStrings.`not-started`
  - typings.pulumiPulumi.pulumiPulumiStrings.`in-progress`
  - typings.pulumiPulumi.pulumiPulumiStrings.succeeded
  - typings.pulumiPulumi.pulumiPulumiStrings.failed
*/
