...
/* Rewritten from type alias, can be one of: 
  - typings.pulumiPulumi.pulumiPulumiStrings.update
  - typings.pulumiPulumi.pulumiPulumiStrings.preview
  - typings.pulumiPulumi.pulumiPulumiStrings.refresh
  - typings.pulumiPulumi.pulumiPulumiStrings.rename
