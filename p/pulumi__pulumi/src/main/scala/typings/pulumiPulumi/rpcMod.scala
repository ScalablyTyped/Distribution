...
object rpcMod {
  ...
  object ResourceModule {
    ...
    inline def apply(construct: (String, String, js.Any, Urn) => Resource): ResourceModule = {
    ...
    extension [Self <: ResourceModule](x: Self) {
      ...
      inline def setConstruct(value: (String, String, js.Any, Urn) => Resource): Self = StObject.set(x, "construct", js.Any.fromFunction4(value))
    }
  }
  ...
  object ResourcePackage {
    ...
    inline def apply(constructProvider: (String, String, js.Any, Urn) => ProviderResource): ResourcePackage = {
    ...
    extension [Self <: ResourcePackage](x: Self) {
      ...
      inline def setConstructProvider(value: (String, String, js.Any, Urn) => ProviderResource): Self = StObject.set(x, "constructProvider", js.Any.fromFunction4(value))
    }
  }
}
