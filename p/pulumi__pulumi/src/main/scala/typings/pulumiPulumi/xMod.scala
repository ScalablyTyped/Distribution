...
object xMod {
  ...
  object automation {
    ...
    @JSImport("@pulumi/pulumi/x", "automation")
    @js.native
    ...
    @js.native
    class CommandError ()
      extends typings.pulumiPulumi.automationMod.CommandError
    
    @JSImport("@pulumi/pulumi/x", "automation.ConcurrentUpdateError")
    @js.native
    class ConcurrentUpdateError ()
      extends typings.pulumiPulumi.automationMod.ConcurrentUpdateError
    ...
    class StackAlreadyExistsError ()
      extends typings.pulumiPulumi.automationMod.StackAlreadyExistsError
