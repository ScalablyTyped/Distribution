...
import typings.pgDashPromise.pgDashPromiseMod.errorsNs.queryResultErrorCode
...
object errorsNs extends js.Object {
  ...
  object queryResultErrorCode extends js.Object {
    ...
    /* 2 */ val multiple: typings.pgDashPromise.pgDashPromiseMod.errorsNs.queryResultErrorCode.multiple with Double = js.native
    /* 0 */ val noData: typings.pgDashPromise.pgDashPromiseMod.errorsNs.queryResultErrorCode.noData with Double = js.native
    /* 1 */ val notEmpty: typings.pgDashPromise.pgDashPromiseMod.errorsNs.queryResultErrorCode.notEmpty with Double = js.native
    @JSBracketAccess
