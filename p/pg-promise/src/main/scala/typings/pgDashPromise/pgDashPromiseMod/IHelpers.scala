...
import typings.pgDashPromise.Anon_EmptyUpdate
import typings.pgDashPromise.Anon_OptionsQuery
...
trait IHelpers extends js.Object {
  var Column: Instantiable1[/* col */ String | IColumnConfig, typings.pgDashPromise.pgDashPromiseMod.Column] = js.native
  var ColumnSet: Instantiable2[
    /* columns */ Column, 
    js.UndefOr[/* options */ IColumnSetOptions], 
    typings.pgDashPromise.pgDashPromiseMod.ColumnSet
  ] = js.native
  var TableName: Instantiable1[/* table */ String | ITable, typings.pgDashPromise.pgDashPromiseMod.TableName] = js.native
