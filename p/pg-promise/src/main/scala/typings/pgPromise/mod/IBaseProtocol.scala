...
trait IBaseProtocol[Ext] extends StObject {
  ...
  def each[T](
    query: QueryParam,
    values: js.Any,
    cb: js.Function3[/* row */ js.Any, /* index */ Double, /* data */ js.Array[js.Any], Unit]
  ...
  def map[T](
    query: QueryParam,
    values: js.Any,
    cb: js.Function3[/* row */ js.Any, /* index */ Double, /* data */ js.Array[js.Any], T]
  ): XPromise[js.Array[T]] = js.native
  def map[T](
    query: QueryParam,
    values: js.Any,
  ...
  def one[T](query: QueryParam, values: js.Any, cb: Unit, thisArg: js.Any): XPromise[T] = js.native
  def one[T](query: QueryParam, values: Unit, cb: js.Function1[/* value */ js.Any, T]): XPromise[T] = js.native
  def one[T](query: QueryParam, values: Unit, cb: js.Function1[/* value */ js.Any, T], thisArg: js.Any): XPromise[T] = js.native
  def one[T](query: QueryParam, values: Unit, cb: Unit, thisArg: js.Any): XPromise[T] = js.native
  ...
  def oneOrNone[T](query: QueryParam, values: js.Any, cb: Unit, thisArg: js.Any): XPromise[T | Null] = js.native
  def oneOrNone[T](query: QueryParam, values: Unit, cb: js.Function1[/* value */ js.Any, T]): XPromise[T | Null] = js.native
  def oneOrNone[T](query: QueryParam, values: Unit, cb: js.Function1[/* value */ js.Any, T], thisArg: js.Any): XPromise[T | Null] = js.native
  def oneOrNone[T](query: QueryParam, values: Unit, cb: Unit, thisArg: js.Any): XPromise[T | Null] = js.native
  ...
  def proc[T](procName: String, values: js.Any, cb: Unit, thisArg: js.Any): XPromise[T | Null] = js.native
  def proc[T](procName: String, values: Unit, cb: js.Function1[/* value */ js.Any, T]): XPromise[T | Null] = js.native
  def proc[T](procName: String, values: Unit, cb: js.Function1[/* value */ js.Any, T], thisArg: js.Any): XPromise[T | Null] = js.native
  def proc[T](procName: String, values: Unit, cb: Unit, thisArg: js.Any): XPromise[T | Null] = js.native
  ...
  def result[T](query: QueryParam, values: js.Any, cb: Unit, thisArg: js.Any): XPromise[T] = js.native
  def result[T](query: QueryParam, values: Unit, cb: js.Function1[/* value */ IResultExt, T]): XPromise[T] = js.native
  def result[T](query: QueryParam, values: Unit, cb: js.Function1[/* value */ IResultExt, T], thisArg: js.Any): XPromise[T] = js.native
  def result[T](query: QueryParam, values: Unit, cb: Unit, thisArg: js.Any): XPromise[T] = js.native
