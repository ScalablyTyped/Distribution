...
object ILostContext {
  @scala.inline
  def apply[/* <: typings.pgPromise.pgSubsetMod.IClient */ C](client: C, cn: String, dc: js.Any, start: Date): ILostContext[C] = {
  ...
  @scala.inline
  implicit class ILostContextOps[Self <: ILostContext[_], /* <: typings.pgPromise.pgSubsetMod.IClient */ C] (val x: Self with ILostContext[C]) extends AnyVal {
    @scala.inline
