...
trait IFormatting extends StObject {
  ...
  def array(arr: js.Array[js.Any]): String = js.native
  def array(arr: js.Array[js.Any], options: CapSQL): String = js.native
  def array(arr: js.Function0[js.Array[js.Any]]): String = js.native
  def array(arr: js.Function0[js.Array[js.Any]], options: CapSQL): String = js.native
  
  def bool(value: js.Any): String = js.native
  def bool(value: js.Function0[js.Any]): String = js.native
  ...
  def csv(values: js.Function0[js.Any]): String = js.native
  ...
  def func(func: js.Function1[/* cc */ js.Any, js.Any]): String = js.native
  def func(func: js.Function1[/* cc */ js.Any, js.Any], raw: Boolean): String = js.native
  def func(func: js.Function1[/* cc */ js.Any, js.Any], raw: Boolean, cc: js.Any): String = js.native
  def func(func: js.Function1[/* cc */ js.Any, js.Any], raw: Unit, cc: js.Any): String = js.native
  
  def json(data: js.Any): String = js.native
  def json(data: js.Any, raw: Boolean): String = js.native
  def json(data: js.Function0[js.Any]): String = js.native
  def json(data: js.Function0[js.Any], raw: Boolean): String = js.native
  
  def name(name: js.Any): String = js.native
  def name(name: js.Function0[js.Any]): String = js.native
  ...
  def text(value: js.Function0[js.Any]): String = js.native
  def text(value: js.Function0[js.Any], raw: Boolean): String = js.native
  
  def value(value: js.Any): String = js.native
  def value(value: js.Function0[js.Any]): String = js.native
}
