...
trait AnonCndModeTag extends js.Object {
...
object AnonCndModeTag {
  @scala.inline
  def apply(cnd: js.Any = null, mode: TransactionMode = null, tag: js.Any = null): AnonCndModeTag = {
    val __obj = js.Dynamic.literal()
    if (cnd != null) __obj.updateDynamic("cnd")(cnd.asInstanceOf[js.Any])
    if (mode != null) __obj.updateDynamic("mode")(mode.asInstanceOf[js.Any])
    if (tag != null) __obj.updateDynamic("tag")(tag.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCndModeTag]
  }
}
