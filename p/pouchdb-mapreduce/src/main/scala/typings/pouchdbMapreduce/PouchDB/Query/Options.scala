...
object Options {
  @scala.inline
  def apply[/* <: js.Object */ Content, Reduction](): Options[Content, Reduction] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Options[Content, Reduction]]
  }
  @scala.inline
  implicit class OptionsOps[Self <: Options[_, _], /* <: js.Object */ Content, Reduction] (val x: Self with (Options[Content, Reduction])) extends AnyVal {
    @scala.inline
