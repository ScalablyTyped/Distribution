...
import typings.pouchdbDashCore.PouchDB.Core.BasicResponse
import typings.pouchdbDashCore.PouchDB.Core.Callback
import typings.pouchdbDashMapreduce.PouchDB.Query.Options
import typings.pouchdbDashMapreduce.PouchDB.Query.Response
