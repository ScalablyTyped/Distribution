...
import typings.pouchdbDashMapreduce.PouchDB.Reducer
import typings.pouchdbDashMapreduce.pouchdbDashMapreduceStrings.ok
import typings.pouchdbDashMapreduce.pouchdbDashMapreduceStrings.update_after
