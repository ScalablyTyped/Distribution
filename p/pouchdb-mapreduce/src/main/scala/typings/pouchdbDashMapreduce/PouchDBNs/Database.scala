...
import typings.pouchdbDashCore.PouchDBNs.CoreNs.BasicResponse
import typings.pouchdbDashCore.PouchDBNs.CoreNs.Callback
import typings.pouchdbDashMapreduce.PouchDBNs.QueryNs.Options
import typings.pouchdbDashMapreduce.PouchDBNs.QueryNs.Response
