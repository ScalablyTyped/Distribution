...
trait AsyncQueryable[TSource] extends AsyncIterableIterator[TSource] {
  ...
  ): AsyncQueryable[TSource] = js.native
  /**
  ...
  transform: js.Function2[/* t */ TSource, /* index */ scala.Double, AsyncQuerySource[TInner]]
  ...
  /**
    ...
    */
  def forEach(f: js.Function1[/* t */ TSource, scala.Unit | js.Promise[scala.Unit]]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def map[TResult](transform: js.Function2[/* t */ TSource, /* i */ scala.Double, TResult | js.Promise[TResult]]): AsyncQueryable[TResult] = js.native
  /**
  ...
  /**
    ...
    */
  def ofType[TResult](typeGuard: js.Function1[/* o */ js.Any, /* is TResult */ scala.Boolean]): AsyncQueryable[TResult] = js.native
  /**
  ...
  /**
    ...
    */
  def skip(n: scala.Double): AsyncQueryable[TSource] = js.native
  /**
  ...
  /**
    ...
    */
  def take(n: scala.Double): AsyncQueryable[TSource] = js.native
  /**
  ...
  /**
    ...
    * resulting `Map`.
    */
  def toMap[TKey, TResult](keySelector: js.Function1[/* t */ TSource, TKey | js.Promise[TKey]]): js.Promise[stdLib.Map[TKey, TResult]] = js.native
