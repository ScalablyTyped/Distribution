...
trait AsyncQueryableGrouping[TKey, TSource] extends GroupedAsyncIterableIterator[TKey, TSource] {
  ...
  /**
    ...
    */
  def all(predicate: js.Function1[TSource, scala.Boolean | js.Promise[scala.Boolean]]): js.Promise[scala.Boolean] = js.native
  /**
    * Retruns `true` if any element of a sequence exists or satisfies `predicate`.
    * @param predicate Boolean function to check against elements of the sequence.
    */
  def any(): js.Promise[scala.Boolean] = js.native
  def any(predicate: js.Function1[TSource, scala.Boolean | js.Promise[scala.Boolean]]): js.Promise[scala.Boolean] = js.native
  /**
    * Averages the numbers of a sequence.
    */
  def average(): js.Promise[scala.Double] = js.native
  def average(selector: js.Function1[TSource, scala.Double | js.Promise[scala.Double]]): js.Promise[scala.Double] = js.native
  /**
  ...
  def count(predicate: js.Function1[TSource, scala.Boolean | js.Promise[scala.Boolean]]): js.Promise[scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  def filter(predicate: js.Function2[TSource, /* i */ scala.Double, scala.Boolean | js.Promise[scala.Boolean]]): AsyncQueryable[TSource] = js.native
  /**
  ...
  def first(predicate: js.Function1[TSource, scala.Boolean | js.Promise[scala.Boolean]]): js.Promise[TSource] = js.native
  /**
  ...
  def firstOrDefault(defaultValue: TSource, predicate: js.Function1[TSource, scala.Boolean | js.Promise[scala.Boolean]]): js.Promise[TSource] = js.native
  /**
  ...
  transform: js.Function2[TSource, /* index */ scala.Double, AsyncQuerySource[TInner]]
  ...
  /**
    ...
    */
  def forEach(f: js.Function1[TSource, scala.Unit | js.Promise[scala.Unit]]): scala.Unit = js.native
  /**
  ...
  def last(predicate: js.Function1[TSource, scala.Boolean | js.Promise[scala.Boolean]]): js.Promise[TSource] = js.native
  /**
  ...
  def lastOrDefault(defaultValue: TSource, predicate: js.Function1[TSource, scala.Boolean | js.Promise[scala.Boolean]]): js.Promise[TSource] = js.native
  /**
    ...
    */
  def map[TResult](transform: js.Function2[TSource, /* i */ scala.Double, TResult | js.Promise[TResult]]): AsyncQueryable[TResult] = js.native
  /**
    * Finds the maximum number in a sequence.
    */
  def max(): js.Promise[scala.Double] = js.native
  def max(selector: js.Function1[TSource, scala.Double | js.Promise[scala.Double]]): js.Promise[scala.Double] = js.native
  /**
    * Finds the minimum number in a sequence.
    */
  def min(): js.Promise[scala.Double] = js.native
  def min(selector: js.Function1[TSource, scala.Double | js.Promise[scala.Double]]): js.Promise[scala.Double] = js.native
  /**
  ...
  def single(predicate: js.Function1[TSource, scala.Boolean | js.Promise[scala.Boolean]]): js.Promise[TSource] = js.native
  /**
  ...
  def singleOrDefault(defaultValue: TSource, predicate: js.Function1[TSource, scala.Boolean | js.Promise[scala.Boolean]]): js.Promise[TSource] = js.native
  /**
  ...
  /**
    ...
    */
  def skipWhile(predicate: js.Function2[TSource, /* i */ scala.Double, scala.Boolean | js.Promise[scala.Boolean]]): AsyncQueryable[TSource] = js.native
  /**
    * Sums all the numbers in a sequence.
    */
  def sum(): js.Promise[scala.Double] = js.native
  def sum(selector: js.Function1[TSource, scala.Double | js.Promise[scala.Double]]): js.Promise[scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  def takeWhile(predicate: js.Function2[TSource, /* i */ scala.Double, scala.Boolean | js.Promise[scala.Boolean]]): AsyncQueryable[TSource] = js.native
  /**
