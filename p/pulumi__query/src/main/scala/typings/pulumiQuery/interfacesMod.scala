...
object interfacesMod {
  ...
  trait AsyncQueryable[TSource]
    ...
    /**
      ...
      */
    def flatMap[TInner, TResult](transform: js.Function2[/* t */ TSource, /* index */ Double, AsyncQuerySource[TInner]]): AsyncQueryable[TResult] = js.native
  ...
  trait AsyncQueryableGrouping[TKey, TSource]
    ...
    /**
      ...
      * await customers.flatMap(customer => customer.orders, (customer, order) => [customer, order]);
      */
    def flatMap[TInner, TResult](transform: js.Function2[TSource, /* index */ Double, AsyncQuerySource[TInner]]): AsyncQueryable[TResult] = js.native
    def flatMap[TInner, TResult](
