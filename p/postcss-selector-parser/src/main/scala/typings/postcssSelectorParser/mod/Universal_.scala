...
trait Universal_
  ...
  @JSName("type")
  var type_Universal_ : typings.postcssSelectorParser.postcssSelectorParserStrings.universal = js.native
}
...
object Universal_ {
  ...
  def apply(
    ...
    sourceIndex: Double,
    spaces: Spaces,
    `type`: typings.postcssSelectorParser.postcssSelectorParserStrings.universal,
    value: String
  ): Universal_ = {
  ...
  @scala.inline
  implicit class Universal_Ops[Self <: Universal_] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: typings.postcssSelectorParser.postcssSelectorParserStrings.universal): Self = this.set("type", value.asInstanceOf[js.Any])
  }
