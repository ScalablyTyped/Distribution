...
trait String_
  ...
  @JSName("type")
  var type_String_ : typings.postcssSelectorParser.postcssSelectorParserStrings.string = js.native
}
object String_ {
  ...
  implicit class String_Ops[Self <: String_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.postcssSelectorParser.postcssSelectorParserStrings.string): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
