...
trait Nesting_
  ...
  @JSName("type")
  var type_Nesting_ : typings.postcssSelectorParser.postcssSelectorParserStrings.nesting = js.native
}
object Nesting_ {
  ...
  def apply(
    ...
    sourceIndex: Double,
    spaces: Spaces,
    `type`: typings.postcssSelectorParser.postcssSelectorParserStrings.nesting,
    value: String
  ): Nesting_ = {
  ...
  @scala.inline
  implicit class Nesting_Ops[Self <: Nesting_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.postcssSelectorParser.postcssSelectorParserStrings.nesting): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
