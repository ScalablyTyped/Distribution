...
object TaggedFlatObject {
  ...
  @scala.inline
  implicit class TaggedFlatObjectOps[Self <: TaggedFlatObject[_], /* <: typings.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with TaggedFlatObject[S]) extends AnyVal {
    @scala.inline
