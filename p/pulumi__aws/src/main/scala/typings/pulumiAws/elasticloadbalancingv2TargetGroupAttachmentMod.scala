...
object elasticloadbalancingv2TargetGroupAttachmentMod {
  ...
  object TargetGroupAttachment {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elasticloadbalancingv2/targetGroupAttachment", "TargetGroupAttachment.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elasticloadbalancingv2/targetGroupAttachment", "TargetGroupAttachment.isInstance")
    @js.native
