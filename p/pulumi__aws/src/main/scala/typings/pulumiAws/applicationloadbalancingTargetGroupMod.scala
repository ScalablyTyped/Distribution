...
import typings.pulumiAws.outputMod.applicationloadbalancing.TargetGroupHealthCheck
import typings.pulumiAws.outputMod.applicationloadbalancing.TargetGroupStickiness
...
object applicationloadbalancingTargetGroupMod {
  ...
  object TargetGroup {
    ...
    /**
      ...
      */
    @scala.inline
    def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/applicationloadbalancing/targetGroup.TargetGroup */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/aws.@pulumi/aws/applicationloadbalancing/targetGroup.TargetGroup */ Boolean]
  }
  ...
  trait TargetGroupArgs extends StObject {
    ...
    val healthCheck: js.UndefOr[
        Input[typings.pulumiAws.inputMod.applicationloadbalancing.TargetGroupHealthCheck]
      ] = js.undefined
    ...
    /**
      * A Stickiness block. Stickiness blocks are documented below.
      */
    val stickiness: js.UndefOr[Input[typings.pulumiAws.inputMod.applicationloadbalancing.TargetGroupStickiness]] = js.undefined
  ...
  object TargetGroupArgs {
    ...
    implicit class TargetGroupArgsMutableBuilder[Self <: TargetGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHealthCheck(value: Input[typings.pulumiAws.inputMod.applicationloadbalancing.TargetGroupHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStickiness(value: Input[typings.pulumiAws.inputMod.applicationloadbalancing.TargetGroupStickiness]): Self = StObject.set(x, "stickiness", value.asInstanceOf[js.Any])
