...
object applicationloadbalancingTargetGroupMod {
  ...
  object TargetGroup {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/applicationloadbalancing/targetGroup", "TargetGroup.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/applicationloadbalancing/targetGroup", "TargetGroup.isInstance")
    @js.native
  ...
  trait TargetGroupArgs extends StObject {
    ...
    /**
      * A Stickiness block. Stickiness blocks are documented below.
      */
    val stickiness: js.UndefOr[Input[typings.pulumiAws.inputMod.applicationloadbalancing.TargetGroupStickiness]] = js.native
