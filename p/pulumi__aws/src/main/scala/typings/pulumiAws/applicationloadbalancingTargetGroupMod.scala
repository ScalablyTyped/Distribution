...
object applicationloadbalancingTargetGroupMod {
  ...
  object TargetGroupArgs {
    ...
    extension [Self <: TargetGroupArgs](x: Self) {
      ...
      inline def setHealthCheck(value: Input[typings.pulumiAws.inputMod.applicationloadbalancing.TargetGroupHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      inline def setStickiness(value: Input[typings.pulumiAws.inputMod.applicationloadbalancing.TargetGroupStickiness]): Self = StObject.set(x, "stickiness", value.asInstanceOf[js.Any])
