...
import typings.pulumiAws.inputMod.opsworks.NodejsAppLayerEbsVolume
...
object NodejsAppLayerArgs {
  ...
  @scala.inline
  implicit class NodejsAppLayerArgsOps[Self <: NodejsAppLayerArgs] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEbsVolumesVarargs(value: Input[NodejsAppLayerEbsVolume]*): Self = this.set("ebsVolumes", js.Array(value :_*))
    @scala.inline
    def setEbsVolumes(value: Input[js.Array[Input[NodejsAppLayerEbsVolume]]]): Self = this.set("ebsVolumes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setNodejsVersion(value: Input[String]): Self = this.set("nodejsVersion", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteNodejsVersion: Self = this.set("nodejsVersion", js.undefined)
    @scala.inline
