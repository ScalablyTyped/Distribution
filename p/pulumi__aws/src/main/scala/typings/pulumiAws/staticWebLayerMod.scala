...
object staticWebLayerMod {
  ...
  object StaticWebLayer {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): StaticWebLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[StaticWebLayer]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): StaticWebLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[StaticWebLayer]
    inline def get(name: String, id: Input[ID], state: StaticWebLayerState): StaticWebLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[StaticWebLayer]
    inline def get(name: String, id: Input[ID], state: StaticWebLayerState, opts: CustomResourceOptions): StaticWebLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[StaticWebLayer]
  ...
  trait StaticWebLayerArgs extends StObject {
    ...
    val ebsVolumes: js.UndefOr[
        Input[js.Array[Input[typings.pulumiAws.inputMod.opsworks.StaticWebLayerEbsVolume]]]
      ] = js.undefined
  ...
  object StaticWebLayerArgs {
    ...
    inline def apply(stackId: Input[String]): StaticWebLayerArgs = {
      val __obj = js.Dynamic.literal(stackId = stackId.asInstanceOf[js.Any])
      __obj.asInstanceOf[StaticWebLayerArgs]
    }
    
    extension [Self <: StaticWebLayerArgs](x: Self) {
      ...
      inline def setEbsVolumes(value: Input[js.Array[Input[typings.pulumiAws.inputMod.opsworks.StaticWebLayerEbsVolume]]]): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      inline def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      inline def setEbsVolumesVarargs(value: Input[typings.pulumiAws.inputMod.opsworks.StaticWebLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
  ...
  object StaticWebLayerState {
    ...
    inline def apply(): StaticWebLayerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StaticWebLayerState]
    }
    
    extension [Self <: StaticWebLayerState](x: Self) {
