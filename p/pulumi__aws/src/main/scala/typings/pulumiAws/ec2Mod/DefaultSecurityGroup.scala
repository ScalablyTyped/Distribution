...
import typings.pulumiAws.defaultSecurityGroupMod.DefaultSecurityGroupArgs
import typings.pulumiAws.defaultSecurityGroupMod.DefaultSecurityGroupState
...
class DefaultSecurityGroup protected ()
  extends typings.pulumiAws.defaultSecurityGroupMod.DefaultSecurityGroup {
  /**
...
object DefaultSecurityGroup extends js.Object {
  ...
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.pulumiAws.defaultSecurityGroupMod.DefaultSecurityGroup = js.native
