...
object VpcEndpointConnectionNotification {
  ...
  @js.native
  def get(name: String, id: Input[ID]): typings.pulumiAws.vpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotification = js.native
  @JSImport("@pulumi/aws/ec2", "VpcEndpointConnectionNotification.get")
  @js.native
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typings.pulumiAws.vpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotification = js.native
  @JSImport("@pulumi/aws/ec2", "VpcEndpointConnectionNotification.get")
  @js.native
  def get(name: String, id: Input[ID], state: VpcEndpointConnectionNotificationState): typings.pulumiAws.vpcEndpointConnectionNotificationMod.VpcEndpointConnectionNotification = js.native
  @JSImport("@pulumi/aws/ec2", "VpcEndpointConnectionNotification.get")
  @js.native
  def get(
    name: String,
