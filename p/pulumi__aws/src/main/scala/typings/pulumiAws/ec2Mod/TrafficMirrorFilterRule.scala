...
object TrafficMirrorFilterRule {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.trafficMirrorFilterRuleMod.TrafficMirrorFilterRule = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.trafficMirrorFilterRuleMod.TrafficMirrorFilterRule]
  @scala.inline
