...
class LaunchTemplate protected ()
  extends typings.pulumiAws.launchTemplateMod.LaunchTemplate {
  /**
...
object LaunchTemplate {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.launchTemplateMod.LaunchTemplate = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.launchTemplateMod.LaunchTemplate]
  @scala.inline
  ...
  @scala.inline
  def get(name: String, id: Input[ID], state: LaunchTemplateState): typings.pulumiAws.launchTemplateMod.LaunchTemplate = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.launchTemplateMod.LaunchTemplate]
  @scala.inline
