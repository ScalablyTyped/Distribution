...
object NetworkInterface {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.networkInterfaceMod.NetworkInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.networkInterfaceMod.NetworkInterface]
  ...
  inline def get(name: String, id: Input[ID], state: NetworkInterfaceState): typings.pulumiAws.networkInterfaceMod.NetworkInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.networkInterfaceMod.NetworkInterface]
  inline def get(name: String, id: Input[ID], state: NetworkInterfaceState, opts: CustomResourceOptions): typings.pulumiAws.networkInterfaceMod.NetworkInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.networkInterfaceMod.NetworkInterface]
