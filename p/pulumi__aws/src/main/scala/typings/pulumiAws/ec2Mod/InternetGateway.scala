...
object InternetGateway {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.internetGatewayMod.InternetGateway = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.internetGatewayMod.InternetGateway]
  ...
  inline def get(name: String, id: Input[ID], state: InternetGatewayState): typings.pulumiAws.internetGatewayMod.InternetGateway = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.internetGatewayMod.InternetGateway]
