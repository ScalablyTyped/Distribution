...
object SnapshotCreateVolumePermission {
  ...
  /**
    ...
    */
  @JSImport("@pulumi/aws/ec2", "SnapshotCreateVolumePermission.get")
  @js.native
  def get(name: String, id: Input[ID]): typings.pulumiAws.snapshotCreateVolumePermissionMod.SnapshotCreateVolumePermission = js.native
  @JSImport("@pulumi/aws/ec2", "SnapshotCreateVolumePermission.get")
  @js.native
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typings.pulumiAws.snapshotCreateVolumePermissionMod.SnapshotCreateVolumePermission = js.native
  @JSImport("@pulumi/aws/ec2", "SnapshotCreateVolumePermission.get")
  @js.native
  def get(name: String, id: Input[ID], state: SnapshotCreateVolumePermissionState): typings.pulumiAws.snapshotCreateVolumePermissionMod.SnapshotCreateVolumePermission = js.native
  @JSImport("@pulumi/aws/ec2", "SnapshotCreateVolumePermission.get")
  @js.native
  def get(
    name: String,
  ...
  /**
    ...
    */
  @JSImport("@pulumi/aws/ec2", "SnapshotCreateVolumePermission.isInstance")
  @js.native
