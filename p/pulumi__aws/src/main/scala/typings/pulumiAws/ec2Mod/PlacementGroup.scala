...
object PlacementGroup {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.placementGroupMod.PlacementGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.placementGroupMod.PlacementGroup]
  @scala.inline
  ...
  @scala.inline
  def get(name: String, id: Input[ID], state: PlacementGroupState): typings.pulumiAws.placementGroupMod.PlacementGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.placementGroupMod.PlacementGroup]
  @scala.inline
