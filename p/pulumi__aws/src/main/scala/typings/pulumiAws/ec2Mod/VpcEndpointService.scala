...
object VpcEndpointService extends js.Object {
  ...
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typings.pulumiAws.vpcEndpointServiceMod.VpcEndpointService = js.native
