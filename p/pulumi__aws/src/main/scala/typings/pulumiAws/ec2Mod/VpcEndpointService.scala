...
object VpcEndpointService {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.vpcEndpointServiceMod.VpcEndpointService = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.vpcEndpointServiceMod.VpcEndpointService]
  @scala.inline
