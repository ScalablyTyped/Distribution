...
object DefaultNetworkAcl {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.defaultNetworkAclMod.DefaultNetworkAcl = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.defaultNetworkAclMod.DefaultNetworkAcl]
  @scala.inline
