...
class DefaultNetworkAcl protected ()
  extends typings.pulumiAws.defaultNetworkAclMod.DefaultNetworkAcl {
  /**
...
object DefaultNetworkAcl extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.pulumiAws.defaultNetworkAclMod.DefaultNetworkAcl = js.native
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typings.pulumiAws.defaultNetworkAclMod.DefaultNetworkAcl = js.native
  def get(name: String, id: Input[ID], state: DefaultNetworkAclState): typings.pulumiAws.defaultNetworkAclMod.DefaultNetworkAcl = js.native
  def get(name: String, id: Input[ID], state: DefaultNetworkAclState, opts: CustomResourceOptions): typings.pulumiAws.defaultNetworkAclMod.DefaultNetworkAcl = js.native
  /**
