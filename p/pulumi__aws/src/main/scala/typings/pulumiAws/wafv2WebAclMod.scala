...
object wafv2WebAclMod {
  ...
  object WebAclArgs {
    ...
    implicit class WebAclArgsMutableBuilder[Self <: WebAclArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultAction(value: Input[typings.pulumiAws.inputMod.wafv2.WebAclDefaultAction]): Self = StObject.set(x, "defaultAction", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRules(value: Input[js.Array[Input[typings.pulumiAws.inputMod.wafv2.WebAclRule]]]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRulesUndefined: Self = StObject.set(x, "rules", js.undefined)
      
      @scala.inline
      def setRulesVarargs(value: Input[typings.pulumiAws.inputMod.wafv2.WebAclRule]*): Self = StObject.set(x, "rules", js.Array(value :_*))
      ...
      @scala.inline
      def setVisibilityConfig(value: Input[typings.pulumiAws.inputMod.wafv2.WebAclVisibilityConfig]): Self = StObject.set(x, "visibilityConfig", value.asInstanceOf[js.Any])
    }
  }
