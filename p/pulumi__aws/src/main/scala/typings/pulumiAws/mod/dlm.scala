...
object dlm {
  ...
  object LifecyclePolicy {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): typings.pulumiAws.lifecyclePolicyMod.LifecyclePolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.lifecyclePolicyMod.LifecyclePolicy]
    ...
    inline def get(name: String, id: Input[ID], state: LifecyclePolicyState): typings.pulumiAws.lifecyclePolicyMod.LifecyclePolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.lifecyclePolicyMod.LifecyclePolicy]
