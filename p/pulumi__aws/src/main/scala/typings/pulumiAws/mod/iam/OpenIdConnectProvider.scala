...
class OpenIdConnectProvider protected ()
  extends typings.pulumiAws.iamMod.OpenIdConnectProvider {
  /**
...
object OpenIdConnectProvider {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.openIdConnectProviderMod.OpenIdConnectProvider = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.openIdConnectProviderMod.OpenIdConnectProvider]
  inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): typings.pulumiAws.openIdConnectProviderMod.OpenIdConnectProvider = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.openIdConnectProviderMod.OpenIdConnectProvider]
  inline def get(name: String, id: Input[ID], state: OpenIdConnectProviderState): typings.pulumiAws.openIdConnectProviderMod.OpenIdConnectProvider = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.openIdConnectProviderMod.OpenIdConnectProvider]
  inline def get(name: String, id: Input[ID], state: OpenIdConnectProviderState, opts: CustomResourceOptions): typings.pulumiAws.openIdConnectProviderMod.OpenIdConnectProvider = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.openIdConnectProviderMod.OpenIdConnectProvider]
