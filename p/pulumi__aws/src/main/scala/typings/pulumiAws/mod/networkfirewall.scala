...
@JSImport("@pulumi/aws", "networkfirewall")
@js.native
object networkfirewall extends js.Object {
  
  @js.native
  class Firewall protected ()
    extends typings.pulumiAws.networkfirewallMod.Firewall {
    /**
  ...
  class FirewallPolicy protected ()
    extends typings.pulumiAws.networkfirewallMod.FirewallPolicy {
    /**
  ...
  class LoggingConfiguration protected ()
    extends typings.pulumiAws.networkfirewallMod.LoggingConfiguration {
    /**
  ...
  class RuleGroup protected ()
    extends typings.pulumiAws.networkfirewallMod.RuleGroup {
    /**
