...
class VpcIpv4CidrBlockAssociation protected ()
  extends typings.pulumiAws.ec2Mod.VpcIpv4CidrBlockAssociation {
  /**
...
object VpcIpv4CidrBlockAssociation {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.vpcIpv4CidrBlockAssociationMod.VpcIpv4CidrBlockAssociation = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.vpcIpv4CidrBlockAssociationMod.VpcIpv4CidrBlockAssociation]
