...
object elb {
  ...
  object AppCookieStickinessPolicy {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): typings.pulumiAws.elbAppCookieStickinessPolicyMod.AppCookieStickinessPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.elbAppCookieStickinessPolicyMod.AppCookieStickinessPolicy]
    @scala.inline
  ...
  object Attachment {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): typings.pulumiAws.elbAttachmentMod.Attachment = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.elbAttachmentMod.Attachment]
    @scala.inline
    ...
    @scala.inline
    def get(name: String, id: Input[ID], state: AttachmentState): typings.pulumiAws.elbAttachmentMod.Attachment = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.elbAttachmentMod.Attachment]
    @scala.inline
  ...
  object ListenerPolicy {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): typings.pulumiAws.elbListenerPolicyMod.ListenerPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.elbListenerPolicyMod.ListenerPolicy]
    @scala.inline
    ...
    @scala.inline
    def get(name: String, id: Input[ID], state: ListenerPolicyState): typings.pulumiAws.elbListenerPolicyMod.ListenerPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.elbListenerPolicyMod.ListenerPolicy]
    @scala.inline
    ...
    /**
      ...
      */
    @scala.inline
    def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/elb/listenerPolicy.ListenerPolicy */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/aws.@pulumi/aws/elb/listenerPolicy.ListenerPolicy */ Boolean]
  }
  ...
  object LoadBalancer {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): typings.pulumiAws.elbLoadBalancerMod.LoadBalancer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.elbLoadBalancerMod.LoadBalancer]
    @scala.inline
    ...
    @scala.inline
    def get(name: String, id: Input[ID], state: LoadBalancerState): typings.pulumiAws.elbLoadBalancerMod.LoadBalancer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.elbLoadBalancerMod.LoadBalancer]
    @scala.inline
  ...
  object LoadBalancerPolicy {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): typings.pulumiAws.elbLoadBalancerPolicyMod.LoadBalancerPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.elbLoadBalancerPolicyMod.LoadBalancerPolicy]
    @scala.inline
  ...
  object SslNegotiationPolicy {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): typings.pulumiAws.elbSslNegotiationPolicyMod.SslNegotiationPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.elbSslNegotiationPolicyMod.SslNegotiationPolicy]
    @scala.inline
    ...
    /**
      ...
      */
    @scala.inline
    def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/elb/sslNegotiationPolicy.SslNegotiationPolicy */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/aws.@pulumi/aws/elb/sslNegotiationPolicy.SslNegotiationPolicy */ Boolean]
  }
