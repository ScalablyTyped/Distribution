...
@scala.inline
def getPolicyDocument(args: scala.Unit, opts: typings.pulumiPulumi.invokeMod.InvokeOptions): js.Promise[typings.pulumiAws.getPolicyDocumentMod.GetPolicyDocumentResult] = (typings.pulumiAws.mod.iam.^.asInstanceOf[js.Dynamic].applyDynamic("getPolicyDocument")(args.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.pulumiAws.getPolicyDocumentMod.GetPolicyDocumentResult]]
@scala.inline
