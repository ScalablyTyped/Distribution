...
object MethodSettings {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.methodSettingsMod.MethodSettings = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.methodSettingsMod.MethodSettings]
  @scala.inline
  ...
  @scala.inline
  def get(name: String, id: Input[ID], state: MethodSettingsState): typings.pulumiAws.methodSettingsMod.MethodSettings = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.methodSettingsMod.MethodSettings]
  @scala.inline
