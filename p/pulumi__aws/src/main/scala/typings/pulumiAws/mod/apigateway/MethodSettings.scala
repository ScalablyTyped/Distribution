...
object MethodSettings extends js.Object {
  ...
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typings.pulumiAws.methodSettingsMod.MethodSettings = js.native
