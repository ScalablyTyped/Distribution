...
object guardduty {
  ...
  class Detector protected ()
    extends typings.pulumiAws.guarddutyMod.Detector {
    /**
  ...
  class Filter protected ()
    extends typings.pulumiAws.guarddutyMod.Filter {
    /**
  ...
  class IPSet protected ()
    extends typings.pulumiAws.guarddutyMod.IPSet {
    /**
  ...
  class InviteAccepter protected ()
    extends typings.pulumiAws.guarddutyMod.InviteAccepter {
    /**
  ...
  class Member protected ()
    extends typings.pulumiAws.guarddutyMod.Member {
    /**
  ...
  class OrganizationAdminAccount protected ()
    extends typings.pulumiAws.guarddutyMod.OrganizationAdminAccount {
    /**
  ...
  class OrganizationConfiguration protected ()
    extends typings.pulumiAws.guarddutyMod.OrganizationConfiguration {
    /**
  ...
  class PublishingDestination protected ()
    extends typings.pulumiAws.guarddutyMod.PublishingDestination {
    /**
  ...
  class ThreatIntelSet protected ()
    extends typings.pulumiAws.guarddutyMod.ThreatIntelSet {
    /**
