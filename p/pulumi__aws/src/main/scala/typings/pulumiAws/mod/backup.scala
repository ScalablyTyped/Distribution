...
object backup {
  ...
  class Plan protected ()
    extends typings.pulumiAws.backupMod.Plan {
    /**
  ...
  class Selection protected ()
    extends typings.pulumiAws.backupMod.Selection {
    /**
  ...
  class Vault protected ()
    extends typings.pulumiAws.backupMod.Vault {
    /**
  ...
  class VaultNotifications protected ()
    extends typings.pulumiAws.backupMod.VaultNotifications {
    /**
  ...
  class VaultPolicy protected ()
    extends typings.pulumiAws.backupMod.VaultPolicy {
    /**
