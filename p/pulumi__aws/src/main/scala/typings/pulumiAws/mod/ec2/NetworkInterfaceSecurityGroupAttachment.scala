...
class NetworkInterfaceSecurityGroupAttachment protected ()
  extends typings.pulumiAws.ec2Mod.NetworkInterfaceSecurityGroupAttachment {
  /**
...
object NetworkInterfaceSecurityGroupAttachment {
  ...
  /**
    ...
    */
  @JSImport("@pulumi/aws", "ec2.NetworkInterfaceSecurityGroupAttachment.get")
  @js.native
  def get(name: String, id: Input[ID]): typings.pulumiAws.networkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachment = js.native
  @JSImport("@pulumi/aws", "ec2.NetworkInterfaceSecurityGroupAttachment.get")
  @js.native
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typings.pulumiAws.networkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachment = js.native
  @JSImport("@pulumi/aws", "ec2.NetworkInterfaceSecurityGroupAttachment.get")
  @js.native
  def get(name: String, id: Input[ID], state: NetworkInterfaceSecurityGroupAttachmentState): typings.pulumiAws.networkInterfaceSecurityGroupAttachmentMod.NetworkInterfaceSecurityGroupAttachment = js.native
  @JSImport("@pulumi/aws", "ec2.NetworkInterfaceSecurityGroupAttachment.get")
  @js.native
  def get(
    name: String,
  ...
  /**
    ...
    */
  @JSImport("@pulumi/aws", "ec2.NetworkInterfaceSecurityGroupAttachment.isInstance")
  @js.native
