...
object PolicyAttachment {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.policyAttachmentMod.PolicyAttachment = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.policyAttachmentMod.PolicyAttachment]
  @scala.inline
  ...
  @scala.inline
  def get(name: String, id: Input[ID], state: PolicyAttachmentState): typings.pulumiAws.policyAttachmentMod.PolicyAttachment = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.policyAttachmentMod.PolicyAttachment]
  @scala.inline
