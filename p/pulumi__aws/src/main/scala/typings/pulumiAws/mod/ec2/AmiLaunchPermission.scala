...
class AmiLaunchPermission protected ()
  extends typings.pulumiAws.ec2Mod.AmiLaunchPermission {
  /**
...
object AmiLaunchPermission {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.amiLaunchPermissionMod.AmiLaunchPermission = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.amiLaunchPermissionMod.AmiLaunchPermission]
  @scala.inline
