...
object AvailabilityZoneGroup {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.availabilityZoneGroupMod.AvailabilityZoneGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.availabilityZoneGroupMod.AvailabilityZoneGroup]
  @scala.inline
