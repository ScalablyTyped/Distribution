...
object AvailabilityZoneGroup {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.availabilityZoneGroupMod.AvailabilityZoneGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.availabilityZoneGroupMod.AvailabilityZoneGroup]
  inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): typings.pulumiAws.availabilityZoneGroupMod.AvailabilityZoneGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.availabilityZoneGroupMod.AvailabilityZoneGroup]
  inline def get(name: String, id: Input[ID], state: AvailabilityZoneGroupState): typings.pulumiAws.availabilityZoneGroupMod.AvailabilityZoneGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.availabilityZoneGroupMod.AvailabilityZoneGroup]
  inline def get(name: String, id: Input[ID], state: AvailabilityZoneGroupState, opts: CustomResourceOptions): typings.pulumiAws.availabilityZoneGroupMod.AvailabilityZoneGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.availabilityZoneGroupMod.AvailabilityZoneGroup]
