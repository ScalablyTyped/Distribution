...
object EipAssociation {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.eipAssociationMod.EipAssociation = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.eipAssociationMod.EipAssociation]
  ...
  inline def get(name: String, id: Input[ID], state: EipAssociationState): typings.pulumiAws.eipAssociationMod.EipAssociation = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.eipAssociationMod.EipAssociation]
