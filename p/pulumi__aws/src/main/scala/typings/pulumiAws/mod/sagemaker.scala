...
object sagemaker {
  ...
  class CodeRepository protected ()
    extends typings.pulumiAws.sagemakerMod.CodeRepository {
    /**
  ...
  class Endpoint protected ()
    extends typings.pulumiAws.sagemakerMod.Endpoint {
    /**
  ...
  class EndpointConfiguration protected ()
    extends typings.pulumiAws.sagemakerMod.EndpointConfiguration {
    /**
  ...
  class Model protected ()
    extends typings.pulumiAws.sagemakerMod.Model {
    /**
  ...
  class NotebookInstance protected ()
    extends typings.pulumiAws.sagemakerMod.NotebookInstance {
    /**
  ...
  class NotebookInstanceLifecycleConfiguration protected ()
    extends typings.pulumiAws.sagemakerMod.NotebookInstanceLifecycleConfiguration {
    /**
