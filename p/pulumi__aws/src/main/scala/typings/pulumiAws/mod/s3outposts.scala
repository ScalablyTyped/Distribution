...
object s3outposts {
  ...
  object Endpoint {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): typings.pulumiAws.s3outpostsEndpointMod.Endpoint = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.s3outpostsEndpointMod.Endpoint]
    ...
    inline def get(name: String, id: Input[ID], state: EndpointState): typings.pulumiAws.s3outpostsEndpointMod.Endpoint = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.s3outpostsEndpointMod.Endpoint]
