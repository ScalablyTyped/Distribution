...
object ClientCertificate extends js.Object {
  ...
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.pulumiAws.clientCertificateMod.ClientCertificate = js.native
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typings.pulumiAws.clientCertificateMod.ClientCertificate = js.native
  def get(name: String, id: Input[ID], state: ClientCertificateState): typings.pulumiAws.clientCertificateMod.ClientCertificate = js.native
  def get(name: String, id: Input[ID], state: ClientCertificateState, opts: CustomResourceOptions): typings.pulumiAws.clientCertificateMod.ClientCertificate = js.native
