...
object config {
  ...
  inline def region_=(x: js.UndefOr[typings.pulumiAws.enumsMod.Region]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("region")(x.asInstanceOf[js.Any])
  
  inline def requireRegion(): typings.pulumiAws.enumsMod.Region = ^.asInstanceOf[js.Dynamic].applyDynamic("requireRegion")().asInstanceOf[typings.pulumiAws.enumsMod.Region]
