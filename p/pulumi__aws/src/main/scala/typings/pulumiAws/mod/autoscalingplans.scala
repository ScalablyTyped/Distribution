...
object autoscalingplans {
  ...
  object ScalingPlan {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): typings.pulumiAws.scalingPlanMod.ScalingPlan = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.scalingPlanMod.ScalingPlan]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): typings.pulumiAws.scalingPlanMod.ScalingPlan = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.scalingPlanMod.ScalingPlan]
    inline def get(name: String, id: Input[ID], state: ScalingPlanState): typings.pulumiAws.scalingPlanMod.ScalingPlan = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.scalingPlanMod.ScalingPlan]
    inline def get(name: String, id: Input[ID], state: ScalingPlanState, opts: CustomResourceOptions): typings.pulumiAws.scalingPlanMod.ScalingPlan = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.scalingPlanMod.ScalingPlan]
