...
object autoscalingplans {
  ...
  object ScalingPlan {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): typings.pulumiAws.scalingPlanMod.ScalingPlan = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.scalingPlanMod.ScalingPlan]
    @scala.inline
    ...
    @scala.inline
    def get(name: String, id: Input[ID], state: ScalingPlanState): typings.pulumiAws.scalingPlanMod.ScalingPlan = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.scalingPlanMod.ScalingPlan]
    @scala.inline
