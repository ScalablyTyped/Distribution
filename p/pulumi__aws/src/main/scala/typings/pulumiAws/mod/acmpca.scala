...
object acmpca {
  ...
  object CertificateAuthority {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): typings.pulumiAws.certificateAuthorityMod.CertificateAuthority = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.certificateAuthorityMod.CertificateAuthority]
