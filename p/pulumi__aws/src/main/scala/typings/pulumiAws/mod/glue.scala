...
object glue {
  ...
  class DataCatalogEncryptionSettings protected ()
    extends typings.pulumiAws.glueMod.DataCatalogEncryptionSettings {
    /**
  ...
  class ResourcePolicy protected ()
    extends typings.pulumiAws.glueMod.ResourcePolicy {
    /**
  ...
  class UserDefinedFunction protected ()
    extends typings.pulumiAws.glueMod.UserDefinedFunction {
    /**
