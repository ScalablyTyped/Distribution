...
object UserPolicy {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.userPolicyMod.UserPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.userPolicyMod.UserPolicy]
  @scala.inline
  ...
  @scala.inline
  def get(name: String, id: Input[ID], state: UserPolicyState): typings.pulumiAws.userPolicyMod.UserPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.userPolicyMod.UserPolicy]
  @scala.inline
