...
class ProxyProtocolPolicy protected ()
  extends typings.pulumiAws.ec2Mod.ProxyProtocolPolicy {
  /**
...
object ProxyProtocolPolicy {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.proxyProtocolPolicyMod.ProxyProtocolPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.proxyProtocolPolicyMod.ProxyProtocolPolicy]
