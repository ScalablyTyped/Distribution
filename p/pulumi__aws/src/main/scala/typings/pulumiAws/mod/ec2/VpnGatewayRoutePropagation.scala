...
object VpnGatewayRoutePropagation {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.vpnGatewayRoutePropagationMod.VpnGatewayRoutePropagation = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.vpnGatewayRoutePropagationMod.VpnGatewayRoutePropagation]
  ...
  /**
    ...
    */
  inline def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/ec2/vpnGatewayRoutePropagation.VpnGatewayRoutePropagation */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/aws.@pulumi/aws/ec2/vpnGatewayRoutePropagation.VpnGatewayRoutePropagation */ Boolean]
}
