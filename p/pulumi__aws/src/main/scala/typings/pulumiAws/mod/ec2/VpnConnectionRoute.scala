...
object VpnConnectionRoute {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.vpnConnectionRouteMod.VpnConnectionRoute = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.vpnConnectionRouteMod.VpnConnectionRoute]
  @scala.inline
