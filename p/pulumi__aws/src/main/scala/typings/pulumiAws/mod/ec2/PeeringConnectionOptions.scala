...
class PeeringConnectionOptions protected ()
  extends typings.pulumiAws.ec2Mod.PeeringConnectionOptions {
  /**
...
object PeeringConnectionOptions {
  ...
  @js.native
  def get(name: String, id: Input[ID]): typings.pulumiAws.peeringConnectionOptionsMod.PeeringConnectionOptions = js.native
  @JSImport("@pulumi/aws", "ec2.PeeringConnectionOptions.get")
  @js.native
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typings.pulumiAws.peeringConnectionOptionsMod.PeeringConnectionOptions = js.native
  @JSImport("@pulumi/aws", "ec2.PeeringConnectionOptions.get")
  @js.native
  def get(name: String, id: Input[ID], state: PeeringConnectionOptionsState): typings.pulumiAws.peeringConnectionOptionsMod.PeeringConnectionOptions = js.native
  @JSImport("@pulumi/aws", "ec2.PeeringConnectionOptions.get")
  @js.native
  def get(name: String, id: Input[ID], state: PeeringConnectionOptionsState, opts: CustomResourceOptions): typings.pulumiAws.peeringConnectionOptionsMod.PeeringConnectionOptions = js.native
