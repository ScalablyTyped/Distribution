...
object DefaultVpc {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.defaultVpcMod.DefaultVpc = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.defaultVpcMod.DefaultVpc]
  @scala.inline
  ...
  @scala.inline
  def get(name: String, id: Input[ID], state: DefaultVpcState): typings.pulumiAws.defaultVpcMod.DefaultVpc = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.defaultVpcMod.DefaultVpc]
  @scala.inline
