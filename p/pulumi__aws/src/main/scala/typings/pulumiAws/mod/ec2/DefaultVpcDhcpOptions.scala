...
object DefaultVpcDhcpOptions {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.defaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.defaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions]
  @scala.inline
