...
object DefaultVpcDhcpOptions {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.defaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.defaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions]
  inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): typings.pulumiAws.defaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.defaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions]
  inline def get(name: String, id: Input[ID], state: DefaultVpcDhcpOptionsState): typings.pulumiAws.defaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.defaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions]
  inline def get(name: String, id: Input[ID], state: DefaultVpcDhcpOptionsState, opts: CustomResourceOptions): typings.pulumiAws.defaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.defaultVpcDhcpOptionsMod.DefaultVpcDhcpOptions]
