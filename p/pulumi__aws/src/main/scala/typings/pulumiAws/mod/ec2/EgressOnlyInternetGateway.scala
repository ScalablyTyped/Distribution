...
object EgressOnlyInternetGateway {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.egressOnlyInternetGatewayMod.EgressOnlyInternetGateway = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.egressOnlyInternetGatewayMod.EgressOnlyInternetGateway]
  @scala.inline
