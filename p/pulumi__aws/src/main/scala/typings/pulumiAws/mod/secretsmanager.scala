...
object secretsmanager {
  ...
  class Secret protected ()
    extends typings.pulumiAws.secretsmanagerMod.Secret {
    /**
  ...
  class SecretPolicy protected ()
    extends typings.pulumiAws.secretsmanagerMod.SecretPolicy {
    /**
  ...
  class SecretVersion protected ()
    extends typings.pulumiAws.secretsmanagerMod.SecretVersion {
    /**
