...
object codecommitRepositoryMod {
  ...
  object Repository {
    ...
    /**
      ...
      */
    inline def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/codecommit/repository.Repository */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/aws.@pulumi/aws/codecommit/repository.Repository */ Boolean]
  }
  ...
  object RepositoryArgs {
    ...
    inline def apply(repositoryName: Input[String]): RepositoryArgs = {
    ...
    extension [Self <: RepositoryArgs](x: Self) {
      ...
      inline def setDefaultBranch(value: Input[String]): Self = StObject.set(x, "defaultBranch", value.asInstanceOf[js.Any])
  ...
  object RepositoryState {
    ...
    extension [Self <: RepositoryState](x: Self) {
      ...
      inline def setCloneUrlHttp(value: Input[String]): Self = StObject.set(x, "cloneUrlHttp", value.asInstanceOf[js.Any])
      
      inline def setCloneUrlHttpUndefined: Self = StObject.set(x, "cloneUrlHttp", js.undefined)
      
      inline def setCloneUrlSsh(value: Input[String]): Self = StObject.set(x, "cloneUrlSsh", value.asInstanceOf[js.Any])
      ...
      inline def setRepositoryId(value: Input[String]): Self = StObject.set(x, "repositoryId", value.asInstanceOf[js.Any])
