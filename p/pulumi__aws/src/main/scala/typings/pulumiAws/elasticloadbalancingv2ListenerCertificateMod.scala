...
object elasticloadbalancingv2ListenerCertificateMod {
  ...
  object ListenerCertificate {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elasticloadbalancingv2/listenerCertificate", "ListenerCertificate.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elasticloadbalancingv2/listenerCertificate", "ListenerCertificate.isInstance")
    @js.native
