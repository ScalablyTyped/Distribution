...
trait RuleGroupRuleStatementAndStatementStatementAndStatement extends js.Object {
  ...
  /**
    ...
    */
  var statements: js.Array[RuleGroupRuleStatementAndStatementStatementAndStatementStatement] = js.native
}
object RuleGroupRuleStatementAndStatementStatementAndStatement {
  ...
  implicit class RuleGroupRuleStatementAndStatementStatementAndStatementOps[Self <: RuleGroupRuleStatementAndStatementStatementAndStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStatementsVarargs(value: RuleGroupRuleStatementAndStatementStatementAndStatementStatement*): Self = this.set("statements", js.Array(value :_*))
    
    @scala.inline
    def setStatements(value: js.Array[RuleGroupRuleStatementAndStatementStatementAndStatementStatement]): Self = this.set("statements", value.asInstanceOf[js.Any])
  }
}
