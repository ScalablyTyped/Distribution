...
object FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptions {
  ...
  inline def apply(): FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptions]
  }
  
  extension [Self <: FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptions](x: Self) {
