...
object DeploymentGroupDeploymentStyle {
  ...
  implicit class DeploymentGroupDeploymentStyleOps[Self <: DeploymentGroupDeploymentStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeploymentOption(value: String): Self = this.set("deploymentOption", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDeploymentOption: Self = this.set("deploymentOption", js.undefined)
    @scala.inline
    def setDeploymentType(value: String): Self = this.set("deploymentType", value.asInstanceOf[js.Any])
    @scala.inline
