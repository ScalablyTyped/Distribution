...
object WebAclRuleStatementAndStatementStatementRegexPatternSetReferenceStatement {
  ...
  implicit class WebAclRuleStatementAndStatementStatementRegexPatternSetReferenceStatementOps[Self <: WebAclRuleStatementAndStatementStatementRegexPatternSetReferenceStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementAndStatementStatementRegexPatternSetReferenceStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
