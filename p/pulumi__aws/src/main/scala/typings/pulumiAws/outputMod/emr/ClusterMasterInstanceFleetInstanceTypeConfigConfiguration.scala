...
@js.native
trait ClusterMasterInstanceFleetInstanceTypeConfigConfiguration extends js.Object {
...
object ClusterMasterInstanceFleetInstanceTypeConfigConfiguration {
  ...
  @scala.inline
  implicit class ClusterMasterInstanceFleetInstanceTypeConfigConfigurationOps[Self <: ClusterMasterInstanceFleetInstanceTypeConfigConfiguration] (val x: Self) extends AnyVal {
