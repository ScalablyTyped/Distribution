...
object RuleGroupRuleStatementOrStatementStatementOrStatementStatementXssMatchStatement {
  ...
  implicit class RuleGroupRuleStatementOrStatementStatementOrStatementStatementXssMatchStatementOps[Self <: RuleGroupRuleStatementOrStatementStatementOrStatementStatementXssMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: RuleGroupRuleStatementOrStatementStatementOrStatementStatementXssMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
