...
object WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatement {
  ...
  implicit class WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatementMutableBuilder[Self <: WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatement] (val x: Self) extends AnyVal {
    ...
    def setByteMatchStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatementByteMatchStatement
    ...
    def setGeoMatchStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatementGeoMatchStatement
    ...
    def setIpSetReferenceStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatementIpSetReferenceStatement
    ...
    def setRegexPatternSetReferenceStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatementRegexPatternSetReferenceStatement
    ...
    def setSizeConstraintStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatementSizeConstraintStatement
    ...
    def setSqliMatchStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatementSqliMatchStatement
    ...
    def setXssMatchStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementAndStatementStatementXssMatchStatement
