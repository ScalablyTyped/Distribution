...
object WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementByteMatchStatement {
  ...
  extension [Self <: WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementByteMatchStatement](x: Self) {
    ...
    inline def setFieldToMatch(
      value: WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementByteMatchStatementFieldToMatch
    ...
    inline def setTextTransformationsVarargs(
      value: WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementByteMatchStatementTextTransformation*
