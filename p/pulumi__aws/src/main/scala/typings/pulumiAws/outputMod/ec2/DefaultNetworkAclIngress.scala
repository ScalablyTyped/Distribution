...
object DefaultNetworkAclIngress {
  ...
  inline def apply(action: String, fromPort: Double, protocol: String, ruleNo: Double, toPort: Double): DefaultNetworkAclIngress = {
  ...
  extension [Self <: DefaultNetworkAclIngress](x: Self) {
