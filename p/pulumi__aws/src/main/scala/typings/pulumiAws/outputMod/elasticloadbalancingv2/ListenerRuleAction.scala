...
trait ListenerRuleAction extends StObject {
  ...
  /**
    ...
    */
  var forward: js.UndefOr[ListenerRuleActionForward] = js.undefined
...
object ListenerRuleAction {
  ...
  inline def apply(order: Double, `type`: String): ListenerRuleAction = {
    val __obj = js.Dynamic.literal(order = order.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListenerRuleAction]
  }
  
  extension [Self <: ListenerRuleAction](x: Self) {
    
    inline def setAuthenticateCognito(value: ListenerRuleActionAuthenticateCognito): Self = StObject.set(x, "authenticateCognito", value.asInstanceOf[js.Any])
    
    inline def setAuthenticateCognitoUndefined: Self = StObject.set(x, "authenticateCognito", js.undefined)
    
    inline def setAuthenticateOidc(value: ListenerRuleActionAuthenticateOidc): Self = StObject.set(x, "authenticateOidc", value.asInstanceOf[js.Any])
    
    inline def setAuthenticateOidcUndefined: Self = StObject.set(x, "authenticateOidc", js.undefined)
    
    inline def setFixedResponse(value: ListenerRuleActionFixedResponse): Self = StObject.set(x, "fixedResponse", value.asInstanceOf[js.Any])
    
    inline def setFixedResponseUndefined: Self = StObject.set(x, "fixedResponse", js.undefined)
    
    inline def setForward(value: ListenerRuleActionForward): Self = StObject.set(x, "forward", value.asInstanceOf[js.Any])
    
    inline def setForwardUndefined: Self = StObject.set(x, "forward", js.undefined)
    
    inline def setOrder(value: Double): Self = StObject.set(x, "order", value.asInstanceOf[js.Any])
    
    inline def setRedirect(value: ListenerRuleActionRedirect): Self = StObject.set(x, "redirect", value.asInstanceOf[js.Any])
