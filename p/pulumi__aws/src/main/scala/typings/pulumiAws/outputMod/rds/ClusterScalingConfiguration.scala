...
object ClusterScalingConfiguration {
  ...
  implicit class ClusterScalingConfigurationOps[Self <: ClusterScalingConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMinCapacity(value: Double): Self = this.set("minCapacity", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMinCapacity: Self = this.set("minCapacity", js.undefined)
    @scala.inline
    def setSecondsUntilAutoPause(value: Double): Self = this.set("secondsUntilAutoPause", value.asInstanceOf[js.Any])
    @scala.inline
