...
@js.native
trait RuleGroupRuleStatementAndStatementStatementSizeConstraintStatement extends js.Object {
  ...
  /**
    ...
    */
  var fieldToMatch: js.UndefOr[RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch] = js.native
...
object RuleGroupRuleStatementAndStatementStatementSizeConstraintStatement {
  ...
  @scala.inline
  implicit class RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementOps[Self <: RuleGroupRuleStatementAndStatementStatementSizeConstraintStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextTransformationsVarargs(value: RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementTextTransformation*): Self = this.set("textTransformations", js.Array(value :_*))
    ...
    @scala.inline
    def setFieldToMatch(value: RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
