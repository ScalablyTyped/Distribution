...
trait RouteSpecHttp2RouteTimeout extends js.Object {
  ...
  /**
    ...
    */
  var idle: js.UndefOr[RouteSpecHttp2RouteTimeoutIdle] = js.native
  
  /**
    * The per request timeout.
    */
  var perRequest: js.UndefOr[RouteSpecHttp2RouteTimeoutPerRequest] = js.native
}
object RouteSpecHttp2RouteTimeout {
  ...
  implicit class RouteSpecHttp2RouteTimeoutOps[Self <: RouteSpecHttp2RouteTimeout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIdle(value: RouteSpecHttp2RouteTimeoutIdle): Self = this.set("idle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIdle: Self = this.set("idle", js.undefined)
    
    @scala.inline
    def setPerRequest(value: RouteSpecHttp2RouteTimeoutPerRequest): Self = this.set("perRequest", value.asInstanceOf[js.Any])
