...
trait RouteSpecHttp2RouteMatch extends js.Object {
  ...
  /**
    ...
    */
  var headers: js.UndefOr[js.Array[RouteSpecHttp2RouteMatchHeader]] = js.native
...
object RouteSpecHttp2RouteMatch {
  ...
  implicit class RouteSpecHttp2RouteMatchOps[Self <: RouteSpecHttp2RouteMatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeadersVarargs(value: RouteSpecHttp2RouteMatchHeader*): Self = this.set("headers", js.Array(value :_*))
    
    @scala.inline
    def setHeaders(value: js.Array[RouteSpecHttp2RouteMatchHeader]): Self = this.set("headers", value.asInstanceOf[js.Any])
