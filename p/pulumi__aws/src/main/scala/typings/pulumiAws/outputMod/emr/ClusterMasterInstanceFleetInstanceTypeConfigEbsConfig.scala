...
@js.native
trait ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig extends js.Object {
...
object ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig {
  ...
  @scala.inline
  def apply(size: Double, `type`: String): ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig = {
  ...
  @scala.inline
  implicit class ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigOps[Self <: ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig] (val x: Self) extends AnyVal {
