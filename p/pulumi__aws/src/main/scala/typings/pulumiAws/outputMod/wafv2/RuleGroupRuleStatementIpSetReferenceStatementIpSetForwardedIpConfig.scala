...
object RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig {
  ...
  inline def apply(fallbackBehavior: String, headerName: String, position: String): RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig = {
  ...
  extension [Self <: RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig](x: Self) {
