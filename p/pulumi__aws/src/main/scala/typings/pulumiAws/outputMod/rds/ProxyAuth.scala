...
object ProxyAuth {
  ...
  implicit class ProxyAuthOps[Self <: ProxyAuth] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthScheme(value: String): Self = this.set("authScheme", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setIamAuth(value: String): Self = this.set("iamAuth", value.asInstanceOf[js.Any])
