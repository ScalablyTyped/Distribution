...
object IntentFollowUpPromptPrompt {
  ...
  implicit class IntentFollowUpPromptPromptOps[Self <: IntentFollowUpPromptPrompt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessagesVarargs(value: IntentFollowUpPromptPromptMessage*): Self = this.set("messages", js.Array(value :_*))
    
    @scala.inline
    def setMessages(value: js.Array[IntentFollowUpPromptPromptMessage]): Self = this.set("messages", value.asInstanceOf[js.Any])
