...
object FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions {
  ...
  inline def apply(): FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions]
  }
  
  extension [Self <: FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions](x: Self) {
