...
object RouteSpecGrpcRouteMatch {
  ...
  implicit class RouteSpecGrpcRouteMatchOps[Self <: RouteSpecGrpcRouteMatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMetadatasVarargs(value: RouteSpecGrpcRouteMatchMetadata*): Self = this.set("metadatas", js.Array(value :_*))
    
    @scala.inline
    def setMetadatas(value: js.Array[RouteSpecGrpcRouteMatchMetadata]): Self = this.set("metadatas", value.asInstanceOf[js.Any])
