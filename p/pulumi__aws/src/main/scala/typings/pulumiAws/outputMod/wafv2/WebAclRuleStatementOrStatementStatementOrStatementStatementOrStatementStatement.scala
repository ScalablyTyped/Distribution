...
object WebAclRuleStatementOrStatementStatementOrStatementStatementOrStatementStatement {
  ...
  implicit class WebAclRuleStatementOrStatementStatementOrStatementStatementOrStatementStatementMutableBuilder[Self <: WebAclRuleStatementOrStatementStatementOrStatementStatementOrStatementStatement] (val x: Self) extends AnyVal {
    ...
    def setByteMatchStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementOrStatementStatementByteMatchStatement
    ...
    def setGeoMatchStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementOrStatementStatementGeoMatchStatement
    ...
    def setIpSetReferenceStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementOrStatementStatementIpSetReferenceStatement
    ...
    def setRegexPatternSetReferenceStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementOrStatementStatementRegexPatternSetReferenceStatement
    ...
    def setSizeConstraintStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementOrStatementStatementSizeConstraintStatement
    ...
    def setSqliMatchStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementOrStatementStatementSqliMatchStatement
    ...
    def setXssMatchStatement(
      value: WebAclRuleStatementOrStatementStatementOrStatementStatementOrStatementStatementXssMatchStatement
