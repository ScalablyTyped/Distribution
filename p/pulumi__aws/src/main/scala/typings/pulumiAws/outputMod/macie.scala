...
object macie {
  ...
  object S3BucketAssociationClassificationType {
    ...
    extension [Self <: S3BucketAssociationClassificationType](x: Self) {
      ...
      inline def setContinuous(value: String): Self = StObject.set(x, "continuous", value.asInstanceOf[js.Any])
      
      inline def setContinuousUndefined: Self = StObject.set(x, "continuous", js.undefined)
      
      inline def setOneTime(value: String): Self = StObject.set(x, "oneTime", value.asInstanceOf[js.Any])
