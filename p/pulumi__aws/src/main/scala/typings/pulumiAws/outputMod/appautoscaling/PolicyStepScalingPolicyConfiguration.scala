...
object PolicyStepScalingPolicyConfiguration {
  ...
  implicit class PolicyStepScalingPolicyConfigurationOps[Self <: PolicyStepScalingPolicyConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdjustmentType(value: String): Self = this.set("adjustmentType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMetricAggregationType(value: String): Self = this.set("metricAggregationType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMetricAggregationType: Self = this.set("metricAggregationType", js.undefined)
    
    @scala.inline
    def setMinAdjustmentMagnitude(value: Double): Self = this.set("minAdjustmentMagnitude", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMinAdjustmentMagnitude: Self = this.set("minAdjustmentMagnitude", js.undefined)
    
    @scala.inline
    def setStepAdjustmentsVarargs(value: PolicyStepScalingPolicyConfigurationStepAdjustment*): Self = this.set("stepAdjustments", js.Array(value :_*))
    
    @scala.inline
    def setStepAdjustments(value: js.Array[PolicyStepScalingPolicyConfigurationStepAdjustment]): Self = this.set("stepAdjustments", value.asInstanceOf[js.Any])
