...
@js.native
trait RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatch extends js.Object {
...
object RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatch {
  ...
  @scala.inline
  implicit class RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchOps[Self <: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchBody): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBody: Self = this.set("body", js.undefined)
    
    @scala.inline
    def setMethod(value: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchMethod): Self = this.set("method", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMethod: Self = this.set("method", js.undefined)
    
    @scala.inline
    def setQueryString(value: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchQueryString): Self = this.set("queryString", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteQueryString: Self = this.set("queryString", js.undefined)
    
    @scala.inline
    def setSingleHeader(value: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchSingleHeader): Self = this.set("singleHeader", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUriPath(value: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchUriPath): Self = this.set("uriPath", value.asInstanceOf[js.Any])
