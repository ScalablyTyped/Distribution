...
trait RuleGroupRuleStatementOrStatementStatementSizeConstraintStatement extends StObject {
  ...
  /**
    ...
    */
  var fieldToMatch: js.UndefOr[RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatch] = js.undefined
...
object RuleGroupRuleStatementOrStatementStatementSizeConstraintStatement {
  ...
  extension [Self <: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatement](x: Self) {
    ...
    inline def setFieldToMatch(value: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatch): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
    ...
    inline def setTextTransformationsVarargs(value: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementTextTransformation*): Self = StObject.set(x, "textTransformations", js.Array(value :_*))
  }
}
