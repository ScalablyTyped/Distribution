...
trait InstanceFleetInstanceTypeConfig extends StObject {
  ...
  /**
    ...
    */
  var configurations: js.UndefOr[js.Array[InstanceFleetInstanceTypeConfigConfiguration]] = js.undefined
  
  /**
    * Configuration block(s) for EBS volumes attached to each instance in the instance group. Detailed below.
    */
  var ebsConfigs: js.Array[InstanceFleetInstanceTypeConfigEbsConfig]
