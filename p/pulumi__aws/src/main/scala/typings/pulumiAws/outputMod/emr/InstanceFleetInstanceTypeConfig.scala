...
trait InstanceFleetInstanceTypeConfig extends js.Object {
  ...
  /**
    ...
    */
  var configurations: js.UndefOr[js.Array[InstanceFleetInstanceTypeConfigConfiguration]] = js.native
  
  /**
    * Configuration block(s) for EBS volumes attached to each instance in the instance group. Detailed below.
    */
  var ebsConfigs: js.Array[InstanceFleetInstanceTypeConfigEbsConfig] = js.native
...
object InstanceFleetInstanceTypeConfig {
  ...
  implicit class InstanceFleetInstanceTypeConfigOps[Self <: InstanceFleetInstanceTypeConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEbsConfigsVarargs(value: InstanceFleetInstanceTypeConfigEbsConfig*): Self = this.set("ebsConfigs", js.Array(value :_*))
    
    @scala.inline
    def setEbsConfigs(value: js.Array[InstanceFleetInstanceTypeConfigEbsConfig]): Self = this.set("ebsConfigs", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setConfigurationsVarargs(value: InstanceFleetInstanceTypeConfigConfiguration*): Self = this.set("configurations", js.Array(value :_*))
    
    @scala.inline
    def setConfigurations(value: js.Array[InstanceFleetInstanceTypeConfigConfiguration]): Self = this.set("configurations", value.asInstanceOf[js.Any])
