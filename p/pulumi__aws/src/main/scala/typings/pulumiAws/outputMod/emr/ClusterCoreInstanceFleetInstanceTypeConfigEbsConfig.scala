...
object ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig {
  ...
  inline def apply(size: Double, `type`: String): ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig = {
    val __obj = js.Dynamic.literal(size = size.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig]
  }
  
  extension [Self <: ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig](x: Self) {
