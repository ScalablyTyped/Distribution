...
object WebAclRuleStatementNotStatementStatementOrStatementStatementByteMatchStatement {
  ...
  implicit class WebAclRuleStatementNotStatementStatementOrStatementStatementByteMatchStatementOps[Self <: WebAclRuleStatementNotStatementStatementOrStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementNotStatementStatementOrStatementStatementByteMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
