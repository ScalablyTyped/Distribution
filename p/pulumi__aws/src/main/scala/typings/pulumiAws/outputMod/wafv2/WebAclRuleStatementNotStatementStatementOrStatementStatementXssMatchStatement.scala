...
object WebAclRuleStatementNotStatementStatementOrStatementStatementXssMatchStatement {
  ...
  implicit class WebAclRuleStatementNotStatementStatementOrStatementStatementXssMatchStatementOps[Self <: WebAclRuleStatementNotStatementStatementOrStatementStatementXssMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementNotStatementStatementOrStatementStatementXssMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
