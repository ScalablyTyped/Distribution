...
object RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatement {
  ...
  inline def apply(arn: String): RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatement = {
    val __obj = js.Dynamic.literal(arn = arn.asInstanceOf[js.Any])
    __obj.asInstanceOf[RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatement]
  }
  
  extension [Self <: RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatement](x: Self) {
    
    inline def setArn(value: String): Self = StObject.set(x, "arn", value.asInstanceOf[js.Any])
    
    inline def setIpSetForwardedIpConfig(value: RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig): Self = StObject.set(x, "ipSetForwardedIpConfig", value.asInstanceOf[js.Any])
