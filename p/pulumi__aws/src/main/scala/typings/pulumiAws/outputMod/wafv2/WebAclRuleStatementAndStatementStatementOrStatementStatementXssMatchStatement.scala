...
@js.native
trait WebAclRuleStatementAndStatementStatementOrStatementStatementXssMatchStatement extends js.Object {
...
object WebAclRuleStatementAndStatementStatementOrStatementStatementXssMatchStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementOps[Self <: WebAclRuleStatementAndStatementStatementOrStatementStatementXssMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementAndStatementStatementOrStatementStatementXssMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
