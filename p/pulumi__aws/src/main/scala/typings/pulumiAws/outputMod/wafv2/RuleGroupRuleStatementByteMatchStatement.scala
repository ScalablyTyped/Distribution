...
trait RuleGroupRuleStatementByteMatchStatement extends StObject {
  ...
  /**
    ...
    */
  var fieldToMatch: js.UndefOr[RuleGroupRuleStatementByteMatchStatementFieldToMatch] = js.undefined
  ...
  /**
    ...
    */
  var textTransformations: js.Array[RuleGroupRuleStatementByteMatchStatementTextTransformation]
}
