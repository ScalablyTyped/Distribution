...
@js.native
trait WebAclRuleStatementAndStatementStatementOrStatementStatementByteMatchStatement extends js.Object {
...
object WebAclRuleStatementAndStatementStatementOrStatementStatementByteMatchStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementAndStatementStatementOrStatementStatementByteMatchStatementOps[Self <: WebAclRuleStatementAndStatementStatementOrStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementAndStatementStatementOrStatementStatementByteMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
