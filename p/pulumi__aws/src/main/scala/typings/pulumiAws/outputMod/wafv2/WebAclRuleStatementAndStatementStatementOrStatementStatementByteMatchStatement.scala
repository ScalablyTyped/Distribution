...
object WebAclRuleStatementAndStatementStatementOrStatementStatementByteMatchStatement {
  ...
  extension [Self <: WebAclRuleStatementAndStatementStatementOrStatementStatementByteMatchStatement](x: Self) {
    
    inline def setFieldToMatch(value: WebAclRuleStatementAndStatementStatementOrStatementStatementByteMatchStatementFieldToMatch): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
