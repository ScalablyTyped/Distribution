...
object WebAclRuleStatementNotStatementStatementOrStatementStatementNotStatementStatementByteMatchStatement {
  ...
  extension [Self <: WebAclRuleStatementNotStatementStatementOrStatementStatementNotStatementStatementByteMatchStatement](x: Self) {
    
    inline def setFieldToMatch(
      value: WebAclRuleStatementNotStatementStatementOrStatementStatementNotStatementStatementByteMatchStatementFieldToMatch
    ...
    inline def setTextTransformationsVarargs(
      value: WebAclRuleStatementNotStatementStatementOrStatementStatementNotStatementStatementByteMatchStatementTextTransformation*
