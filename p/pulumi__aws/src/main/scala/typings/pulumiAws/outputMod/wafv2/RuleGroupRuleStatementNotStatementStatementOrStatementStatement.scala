...
trait RuleGroupRuleStatementNotStatementStatementOrStatementStatement extends StObject {
  ...
  /**
    ...
    */
  var geoMatchStatement: js.UndefOr[RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatement] = js.undefined
  ...
  /**
    ...
    */
  var xssMatchStatement: js.UndefOr[RuleGroupRuleStatementNotStatementStatementOrStatementStatementXssMatchStatement] = js.undefined
}
object RuleGroupRuleStatementNotStatementStatementOrStatementStatement {
  ...
  extension [Self <: RuleGroupRuleStatementNotStatementStatementOrStatementStatement](x: Self) {
    ...
    inline def setByteMatchStatement(value: RuleGroupRuleStatementNotStatementStatementOrStatementStatementByteMatchStatement): Self = StObject.set(x, "byteMatchStatement", value.asInstanceOf[js.Any])
    
    inline def setByteMatchStatementUndefined: Self = StObject.set(x, "byteMatchStatement", js.undefined)
    
    inline def setGeoMatchStatement(value: RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatement): Self = StObject.set(x, "geoMatchStatement", value.asInstanceOf[js.Any])
    
    inline def setGeoMatchStatementUndefined: Self = StObject.set(x, "geoMatchStatement", js.undefined)
    
    inline def setIpSetReferenceStatement(value: RuleGroupRuleStatementNotStatementStatementOrStatementStatementIpSetReferenceStatement): Self = StObject.set(x, "ipSetReferenceStatement", value.asInstanceOf[js.Any])
    ...
    inline def setSizeConstraintStatement(value: RuleGroupRuleStatementNotStatementStatementOrStatementStatementSizeConstraintStatement): Self = StObject.set(x, "sizeConstraintStatement", value.asInstanceOf[js.Any])
    
    inline def setSizeConstraintStatementUndefined: Self = StObject.set(x, "sizeConstraintStatement", js.undefined)
    
    inline def setSqliMatchStatement(value: RuleGroupRuleStatementNotStatementStatementOrStatementStatementSqliMatchStatement): Self = StObject.set(x, "sqliMatchStatement", value.asInstanceOf[js.Any])
    
    inline def setSqliMatchStatementUndefined: Self = StObject.set(x, "sqliMatchStatement", js.undefined)
    
    inline def setXssMatchStatement(value: RuleGroupRuleStatementNotStatementStatementOrStatementStatementXssMatchStatement): Self = StObject.set(x, "xssMatchStatement", value.asInstanceOf[js.Any])
