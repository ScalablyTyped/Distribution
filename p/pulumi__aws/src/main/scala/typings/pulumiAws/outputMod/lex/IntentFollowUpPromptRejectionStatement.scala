...
object IntentFollowUpPromptRejectionStatement {
  ...
  implicit class IntentFollowUpPromptRejectionStatementOps[Self <: IntentFollowUpPromptRejectionStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessagesVarargs(value: IntentFollowUpPromptRejectionStatementMessage*): Self = this.set("messages", js.Array(value :_*))
    
    @scala.inline
    def setMessages(value: js.Array[IntentFollowUpPromptRejectionStatementMessage]): Self = this.set("messages", value.asInstanceOf[js.Any])
