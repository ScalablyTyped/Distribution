...
trait RouteSpecGrpcRouteMatchMetadataMatch extends StObject {
  ...
  /**
    ...
    */
  var range: js.UndefOr[RouteSpecGrpcRouteMatchMetadataMatchRange] = js.undefined
...
object RouteSpecGrpcRouteMatchMetadataMatch {
  ...
  extension [Self <: RouteSpecGrpcRouteMatchMetadataMatch](x: Self) {
    ...
    inline def setRange(value: RouteSpecGrpcRouteMatchMetadataMatchRange): Self = StObject.set(x, "range", value.asInstanceOf[js.Any])
