...
object WebAclRuleStatementOrStatementStatementRegexPatternSetReferenceStatement {
  ...
  implicit class WebAclRuleStatementOrStatementStatementRegexPatternSetReferenceStatementOps[Self <: WebAclRuleStatementOrStatementStatementRegexPatternSetReferenceStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextTransformationsVarargs(value: WebAclRuleStatementOrStatementStatementRegexPatternSetReferenceStatementTextTransformation*): Self = this.set("textTransformations", js.Array(value :_*))
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementOrStatementStatementRegexPatternSetReferenceStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
