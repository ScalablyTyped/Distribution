...
object UserPoolDeviceConfiguration {
  ...
  implicit class UserPoolDeviceConfigurationOps[Self <: UserPoolDeviceConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChallengeRequiredOnNewDevice(value: Boolean): Self = this.set("challengeRequiredOnNewDevice", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteChallengeRequiredOnNewDevice: Self = this.set("challengeRequiredOnNewDevice", js.undefined)
    
    @scala.inline
    def setDeviceOnlyRememberedOnUserPrompt(value: Boolean): Self = this.set("deviceOnlyRememberedOnUserPrompt", value.asInstanceOf[js.Any])
