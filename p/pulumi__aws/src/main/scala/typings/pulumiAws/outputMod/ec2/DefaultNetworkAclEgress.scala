...
object DefaultNetworkAclEgress {
  ...
  inline def apply(action: String, fromPort: Double, protocol: String, ruleNo: Double, toPort: Double): DefaultNetworkAclEgress = {
  ...
  extension [Self <: DefaultNetworkAclEgress](x: Self) {
