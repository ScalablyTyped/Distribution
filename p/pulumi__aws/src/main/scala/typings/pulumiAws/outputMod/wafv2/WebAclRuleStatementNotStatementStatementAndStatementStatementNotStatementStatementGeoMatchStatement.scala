...
@js.native
trait WebAclRuleStatementNotStatementStatementAndStatementStatementNotStatementStatementGeoMatchStatement extends js.Object {
...
object WebAclRuleStatementNotStatementStatementAndStatementStatementNotStatementStatementGeoMatchStatement {
  ...
  @scala.inline
  def apply(countryCodes: js.Array[String]): WebAclRuleStatementNotStatementStatementAndStatementStatementNotStatementStatementGeoMatchStatement = {
  ...
  @scala.inline
  implicit class WebAclRuleStatementNotStatementStatementAndStatementStatementNotStatementStatementGeoMatchStatementOps[Self <: WebAclRuleStatementNotStatementStatementAndStatementStatementNotStatementStatementGeoMatchStatement] (val x: Self) extends AnyVal {
    ...
    def setForwardedIpConfig(
      value: WebAclRuleStatementNotStatementStatementAndStatementStatementNotStatementStatementGeoMatchStatementForwardedIpConfig
