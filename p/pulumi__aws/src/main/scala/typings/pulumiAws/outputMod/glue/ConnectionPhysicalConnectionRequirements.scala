...
object ConnectionPhysicalConnectionRequirements {
  ...
  extension [Self <: ConnectionPhysicalConnectionRequirements](x: Self) {
    ...
    inline def setSecurityGroupIdLists(value: js.Array[String]): Self = StObject.set(x, "securityGroupIdLists", value.asInstanceOf[js.Any])
    
    inline def setSecurityGroupIdListsUndefined: Self = StObject.set(x, "securityGroupIdLists", js.undefined)
    
    inline def setSecurityGroupIdListsVarargs(value: String*): Self = StObject.set(x, "securityGroupIdLists", js.Array(value :_*))
