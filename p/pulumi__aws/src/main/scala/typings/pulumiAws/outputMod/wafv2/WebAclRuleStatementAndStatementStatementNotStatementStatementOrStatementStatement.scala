...
object WebAclRuleStatementAndStatementStatementNotStatementStatementOrStatementStatement {
  ...
  inline def apply(): WebAclRuleStatementAndStatementStatementNotStatementStatementOrStatementStatement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WebAclRuleStatementAndStatementStatementNotStatementStatementOrStatementStatement]
  }
  
  extension [Self <: WebAclRuleStatementAndStatementStatementNotStatementStatementOrStatementStatement](x: Self) {
