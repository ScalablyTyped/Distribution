...
trait IntentRejectionStatement extends StObject {
  ...
  /**
    ...
    */
  var messages: js.Array[IntentRejectionStatementMessage]
...
object IntentRejectionStatement {
  ...
  inline def apply(messages: js.Array[IntentRejectionStatementMessage]): IntentRejectionStatement = {
  ...
  extension [Self <: IntentRejectionStatement](x: Self) {
    ...
    inline def setMessages(value: js.Array[IntentRejectionStatementMessage]): Self = StObject.set(x, "messages", value.asInstanceOf[js.Any])
    
    inline def setMessagesVarargs(value: IntentRejectionStatementMessage*): Self = StObject.set(x, "messages", js.Array(value :_*))
