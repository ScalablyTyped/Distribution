...
object WebAclRuleStatementOrStatementStatementAndStatementStatementXssMatchStatement {
  ...
  extension [Self <: WebAclRuleStatementOrStatementStatementAndStatementStatementXssMatchStatement](x: Self) {
    ...
    inline def setFieldToMatch(value: WebAclRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatch): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
