...
object RuleGroupRuleStatementNotStatementStatementAndStatementStatementByteMatchStatement {
  ...
  extension [Self <: RuleGroupRuleStatementNotStatementStatementAndStatementStatementByteMatchStatement](x: Self) {
    
    inline def setFieldToMatch(
      value: RuleGroupRuleStatementNotStatementStatementAndStatementStatementByteMatchStatementFieldToMatch
    ...
    inline def setTextTransformationsVarargs(
      value: RuleGroupRuleStatementNotStatementStatementAndStatementStatementByteMatchStatementTextTransformation*
