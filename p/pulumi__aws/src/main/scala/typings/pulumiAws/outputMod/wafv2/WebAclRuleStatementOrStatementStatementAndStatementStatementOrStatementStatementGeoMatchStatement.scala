...
object WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementGeoMatchStatement {
  ...
  inline def apply(countryCodes: js.Array[String]): WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementGeoMatchStatement = {
  ...
  extension [Self <: WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementGeoMatchStatement](x: Self) {
    ...
    inline def setForwardedIpConfig(
      value: WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementGeoMatchStatementForwardedIpConfig
