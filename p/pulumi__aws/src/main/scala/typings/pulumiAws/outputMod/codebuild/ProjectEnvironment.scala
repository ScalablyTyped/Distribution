...
trait ProjectEnvironment extends StObject {
  ...
  /**
    ...
    */
  var environmentVariables: js.UndefOr[js.Array[ProjectEnvironmentEnvironmentVariable]] = js.undefined
...
object ProjectEnvironment {
  ...
  inline def apply(computeType: String, image: String, `type`: String): ProjectEnvironment = {
  ...
  extension [Self <: ProjectEnvironment](x: Self) {
    ...
    inline def setComputeType(value: String): Self = StObject.set(x, "computeType", value.asInstanceOf[js.Any])
    
    inline def setEnvironmentVariables(value: js.Array[ProjectEnvironmentEnvironmentVariable]): Self = StObject.set(x, "environmentVariables", value.asInstanceOf[js.Any])
    
    inline def setEnvironmentVariablesUndefined: Self = StObject.set(x, "environmentVariables", js.undefined)
    
    inline def setEnvironmentVariablesVarargs(value: ProjectEnvironmentEnvironmentVariable*): Self = StObject.set(x, "environmentVariables", js.Array(value :_*))
    
    inline def setImage(value: String): Self = StObject.set(x, "image", value.asInstanceOf[js.Any])
    
    inline def setImagePullCredentialsType(value: String): Self = StObject.set(x, "imagePullCredentialsType", value.asInstanceOf[js.Any])
    ...
    inline def setRegistryCredential(value: ProjectEnvironmentRegistryCredential): Self = StObject.set(x, "registryCredential", value.asInstanceOf[js.Any])
