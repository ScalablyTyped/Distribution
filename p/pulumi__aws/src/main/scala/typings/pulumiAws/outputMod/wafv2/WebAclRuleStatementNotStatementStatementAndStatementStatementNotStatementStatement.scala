...
object WebAclRuleStatementNotStatementStatementAndStatementStatementNotStatementStatement {
  ...
  inline def apply(): WebAclRuleStatementNotStatementStatementAndStatementStatementNotStatementStatement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WebAclRuleStatementNotStatementStatementAndStatementStatementNotStatementStatement]
  }
  
  extension [Self <: WebAclRuleStatementNotStatementStatementAndStatementStatementNotStatementStatement](x: Self) {
