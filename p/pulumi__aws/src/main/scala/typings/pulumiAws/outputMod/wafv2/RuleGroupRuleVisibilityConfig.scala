...
@js.native
trait RuleGroupRuleVisibilityConfig extends js.Object {
...
object RuleGroupRuleVisibilityConfig {
  ...
  @scala.inline
  implicit class RuleGroupRuleVisibilityConfigOps[Self <: RuleGroupRuleVisibilityConfig] (val x: Self) extends AnyVal {
