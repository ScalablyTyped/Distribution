...
trait RuleGroupRuleStatementOrStatementStatementNotStatementStatement extends StObject {
  ...
  /**
    ...
    */
  var geoMatchStatement: js.UndefOr[RuleGroupRuleStatementOrStatementStatementNotStatementStatementGeoMatchStatement] = js.undefined
  ...
  /**
    ...
    */
  var xssMatchStatement: js.UndefOr[RuleGroupRuleStatementOrStatementStatementNotStatementStatementXssMatchStatement] = js.undefined
}
object RuleGroupRuleStatementOrStatementStatementNotStatementStatement {
  ...
  extension [Self <: RuleGroupRuleStatementOrStatementStatementNotStatementStatement](x: Self) {
    ...
    inline def setByteMatchStatement(value: RuleGroupRuleStatementOrStatementStatementNotStatementStatementByteMatchStatement): Self = StObject.set(x, "byteMatchStatement", value.asInstanceOf[js.Any])
    
    inline def setByteMatchStatementUndefined: Self = StObject.set(x, "byteMatchStatement", js.undefined)
    
    inline def setGeoMatchStatement(value: RuleGroupRuleStatementOrStatementStatementNotStatementStatementGeoMatchStatement): Self = StObject.set(x, "geoMatchStatement", value.asInstanceOf[js.Any])
    
    inline def setGeoMatchStatementUndefined: Self = StObject.set(x, "geoMatchStatement", js.undefined)
    
    inline def setIpSetReferenceStatement(value: RuleGroupRuleStatementOrStatementStatementNotStatementStatementIpSetReferenceStatement): Self = StObject.set(x, "ipSetReferenceStatement", value.asInstanceOf[js.Any])
    ...
    inline def setSizeConstraintStatement(value: RuleGroupRuleStatementOrStatementStatementNotStatementStatementSizeConstraintStatement): Self = StObject.set(x, "sizeConstraintStatement", value.asInstanceOf[js.Any])
    
    inline def setSizeConstraintStatementUndefined: Self = StObject.set(x, "sizeConstraintStatement", js.undefined)
    
    inline def setSqliMatchStatement(value: RuleGroupRuleStatementOrStatementStatementNotStatementStatementSqliMatchStatement): Self = StObject.set(x, "sqliMatchStatement", value.asInstanceOf[js.Any])
    
    inline def setSqliMatchStatementUndefined: Self = StObject.set(x, "sqliMatchStatement", js.undefined)
    
    inline def setXssMatchStatement(value: RuleGroupRuleStatementOrStatementStatementNotStatementStatementXssMatchStatement): Self = StObject.set(x, "xssMatchStatement", value.asInstanceOf[js.Any])
