...
@js.native
trait WebAclRuleStatementNotStatementStatementOrStatementStatementSqliMatchStatement extends js.Object {
...
object WebAclRuleStatementNotStatementStatementOrStatementStatementSqliMatchStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementNotStatementStatementOrStatementStatementSqliMatchStatementOps[Self <: WebAclRuleStatementNotStatementStatementOrStatementStatementSqliMatchStatement] (val x: Self) extends AnyVal {
    ...
    def setTextTransformationsVarargs(
      value: WebAclRuleStatementNotStatementStatementOrStatementStatementSqliMatchStatementTextTransformation*
    ...
    @scala.inline
    def setFieldToMatch(value: WebAclRuleStatementNotStatementStatementOrStatementStatementSqliMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
