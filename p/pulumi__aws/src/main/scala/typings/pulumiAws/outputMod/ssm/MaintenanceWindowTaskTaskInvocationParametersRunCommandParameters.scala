...
object MaintenanceWindowTaskTaskInvocationParametersRunCommandParameters {
  ...
  extension [Self <: MaintenanceWindowTaskTaskInvocationParametersRunCommandParameters](x: Self) {
    ...
    inline def setDocumentHash(value: String): Self = StObject.set(x, "documentHash", value.asInstanceOf[js.Any])
    
    inline def setDocumentHashType(value: String): Self = StObject.set(x, "documentHashType", value.asInstanceOf[js.Any])
    ...
    inline def setNotificationConfig(value: MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersNotificationConfig): Self = StObject.set(x, "notificationConfig", value.asInstanceOf[js.Any])
    ...
    inline def setOutputS3KeyPrefix(value: String): Self = StObject.set(x, "outputS3KeyPrefix", value.asInstanceOf[js.Any])
    
    inline def setOutputS3KeyPrefixUndefined: Self = StObject.set(x, "outputS3KeyPrefix", js.undefined)
    
    inline def setParameters(value: js.Array[MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameter]): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    
    inline def setParametersUndefined: Self = StObject.set(x, "parameters", js.undefined)
    
    inline def setParametersVarargs(value: MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersParameter*): Self = StObject.set(x, "parameters", js.Array(value :_*))
