...
object InventoryDestination {
  ...
  inline def apply(bucket: InventoryDestinationBucket): InventoryDestination = {
  ...
  extension [Self <: InventoryDestination](x: Self) {
    ...
    inline def setBucket(value: InventoryDestinationBucket): Self = StObject.set(x, "bucket", value.asInstanceOf[js.Any])
  }
}
