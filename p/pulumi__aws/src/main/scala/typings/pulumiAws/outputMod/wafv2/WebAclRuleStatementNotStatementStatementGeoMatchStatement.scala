...
trait WebAclRuleStatementNotStatementStatementGeoMatchStatement extends StObject {
  ...
  /**
    ...
    */
  var forwardedIpConfig: js.UndefOr[WebAclRuleStatementNotStatementStatementGeoMatchStatementForwardedIpConfig] = js.undefined
}
