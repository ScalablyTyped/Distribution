...
@js.native
trait WebAclRuleStatementNotStatementStatementGeoMatchStatement extends js.Object {
  ...
  /**
    ...
    */
  var forwardedIpConfig: js.UndefOr[WebAclRuleStatementNotStatementStatementGeoMatchStatementForwardedIpConfig] = js.native
}
object WebAclRuleStatementNotStatementStatementGeoMatchStatement {
  ...
  @scala.inline
  implicit class WebAclRuleStatementNotStatementStatementGeoMatchStatementOps[Self <: WebAclRuleStatementNotStatementStatementGeoMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedIpConfig(value: WebAclRuleStatementNotStatementStatementGeoMatchStatementForwardedIpConfig): Self = this.set("forwardedIpConfig", value.asInstanceOf[js.Any])
