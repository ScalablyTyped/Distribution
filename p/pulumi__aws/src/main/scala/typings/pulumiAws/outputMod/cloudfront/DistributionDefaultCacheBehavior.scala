...
object DistributionDefaultCacheBehavior {
  ...
  extension [Self <: DistributionDefaultCacheBehavior](x: Self) {
    ...
    inline def setForwardedValues(value: DistributionDefaultCacheBehaviorForwardedValues): Self = StObject.set(x, "forwardedValues", value.asInstanceOf[js.Any])
    
    inline def setLambdaFunctionAssociations(value: js.Array[DistributionDefaultCacheBehaviorLambdaFunctionAssociation]): Self = StObject.set(x, "lambdaFunctionAssociations", value.asInstanceOf[js.Any])
    
    inline def setLambdaFunctionAssociationsUndefined: Self = StObject.set(x, "lambdaFunctionAssociations", js.undefined)
    
    inline def setLambdaFunctionAssociationsVarargs(value: DistributionDefaultCacheBehaviorLambdaFunctionAssociation*): Self = StObject.set(x, "lambdaFunctionAssociations", js.Array(value :_*))
