...
object BucketReplicationConfigurationRuleSourceSelectionCriteria {
  ...
  extension [Self <: BucketReplicationConfigurationRuleSourceSelectionCriteria](x: Self) {
    ...
    inline def setSseKmsEncryptedObjects(value: BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjects): Self = StObject.set(x, "sseKmsEncryptedObjects", value.asInstanceOf[js.Any])
