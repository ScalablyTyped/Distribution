...
object ClusterRestoreToPointInTime {
  ...
  implicit class ClusterRestoreToPointInTimeOps[Self <: ClusterRestoreToPointInTime] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSourceClusterIdentifier(value: String): Self = this.set("sourceClusterIdentifier", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRestoreToTime(value: String): Self = this.set("restoreToTime", value.asInstanceOf[js.Any])
