...
object cloudtrail {
  ...
  object TrailEventSelector {
    ...
    extension [Self <: TrailEventSelector](x: Self) {
      ...
      inline def setDataResources(value: js.Array[TrailEventSelectorDataResource]): Self = StObject.set(x, "dataResources", value.asInstanceOf[js.Any])
      
      inline def setDataResourcesUndefined: Self = StObject.set(x, "dataResources", js.undefined)
      
      inline def setDataResourcesVarargs(value: TrailEventSelectorDataResource*): Self = StObject.set(x, "dataResources", js.Array(value :_*))
      ...
      inline def setReadWriteType(value: String): Self = StObject.set(x, "readWriteType", value.asInstanceOf[js.Any])
  ...
  object TrailEventSelectorDataResource {
    ...
    inline def apply(`type`: String, values: js.Array[String]): TrailEventSelectorDataResource = {
  ...
  object TrailInsightSelector {
    ...
    inline def apply(insightType: String): TrailInsightSelector = {
    ...
    extension [Self <: TrailInsightSelector](x: Self) {
      ...
      inline def setInsightType(value: String): Self = StObject.set(x, "insightType", value.asInstanceOf[js.Any])
    }
  }
}
