...
object WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig {
  ...
  inline def apply(fallbackBehavior: String, headerName: String, position: String): WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig = {
  ...
  extension [Self <: WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig](x: Self) {
