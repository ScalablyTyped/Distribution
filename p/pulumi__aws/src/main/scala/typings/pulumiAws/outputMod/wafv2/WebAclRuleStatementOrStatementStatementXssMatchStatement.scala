...
trait WebAclRuleStatementOrStatementStatementXssMatchStatement extends StObject {
  ...
  /**
    ...
    */
  var fieldToMatch: js.UndefOr[WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatch] = js.undefined
  
  /**
    * Text transformations eliminate some of the unusual formatting that attackers use in web requests in an effort to bypass detection. See Text Transformation below for details.
    */
  var textTransformations: js.Array[WebAclRuleStatementOrStatementStatementXssMatchStatementTextTransformation]
}
