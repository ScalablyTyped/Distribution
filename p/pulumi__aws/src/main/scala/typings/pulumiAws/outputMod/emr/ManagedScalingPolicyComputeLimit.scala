...
object ManagedScalingPolicyComputeLimit {
  ...
  inline def apply(maximumCapacityUnits: Double, minimumCapacityUnits: Double, unitType: String): ManagedScalingPolicyComputeLimit = {
  ...
  extension [Self <: ManagedScalingPolicyComputeLimit](x: Self) {
    ...
    inline def setMaximumCapacityUnits(value: Double): Self = StObject.set(x, "maximumCapacityUnits", value.asInstanceOf[js.Any])
    
    inline def setMaximumCoreCapacityUnits(value: Double): Self = StObject.set(x, "maximumCoreCapacityUnits", value.asInstanceOf[js.Any])
    
    inline def setMaximumCoreCapacityUnitsUndefined: Self = StObject.set(x, "maximumCoreCapacityUnits", js.undefined)
    
    inline def setMaximumOndemandCapacityUnits(value: Double): Self = StObject.set(x, "maximumOndemandCapacityUnits", value.asInstanceOf[js.Any])
    
    inline def setMaximumOndemandCapacityUnitsUndefined: Self = StObject.set(x, "maximumOndemandCapacityUnits", js.undefined)
    
    inline def setMinimumCapacityUnits(value: Double): Self = StObject.set(x, "minimumCapacityUnits", value.asInstanceOf[js.Any])
