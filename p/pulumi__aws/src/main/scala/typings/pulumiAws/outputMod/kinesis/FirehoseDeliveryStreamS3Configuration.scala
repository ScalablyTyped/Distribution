...
object FirehoseDeliveryStreamS3Configuration {
  ...
  implicit class FirehoseDeliveryStreamS3ConfigurationOps[Self <: FirehoseDeliveryStreamS3Configuration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCloudwatchLoggingOptions(value: FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptions): Self = this.set("cloudwatchLoggingOptions", value.asInstanceOf[js.Any])
