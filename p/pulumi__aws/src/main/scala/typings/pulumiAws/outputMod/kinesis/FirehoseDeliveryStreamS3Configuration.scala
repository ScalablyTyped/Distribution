...
object FirehoseDeliveryStreamS3Configuration {
  ...
  @scala.inline
  implicit class FirehoseDeliveryStreamS3ConfigurationMutableBuilder[Self <: FirehoseDeliveryStreamS3Configuration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCloudwatchLoggingOptions(value: FirehoseDeliveryStreamS3ConfigurationCloudwatchLoggingOptions): Self = StObject.set(x, "cloudwatchLoggingOptions", value.asInstanceOf[js.Any])
