...
@js.native
trait WebAclRuleStatementRateBasedStatementForwardedIpConfig extends js.Object {
...
object WebAclRuleStatementRateBasedStatementForwardedIpConfig {
  ...
  @scala.inline
  def apply(fallbackBehavior: String, headerName: String): WebAclRuleStatementRateBasedStatementForwardedIpConfig = {
  ...
  @scala.inline
  implicit class WebAclRuleStatementRateBasedStatementForwardedIpConfigOps[Self <: WebAclRuleStatementRateBasedStatementForwardedIpConfig] (val x: Self) extends AnyVal {
