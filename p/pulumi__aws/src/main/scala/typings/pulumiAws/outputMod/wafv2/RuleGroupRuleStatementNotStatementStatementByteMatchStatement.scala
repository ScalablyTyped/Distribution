...
object RuleGroupRuleStatementNotStatementStatementByteMatchStatement {
  ...
  @scala.inline
  implicit class RuleGroupRuleStatementNotStatementStatementByteMatchStatementMutableBuilder[Self <: RuleGroupRuleStatementNotStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFieldToMatch(value: RuleGroupRuleStatementNotStatementStatementByteMatchStatementFieldToMatch): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTextTransformations(value: js.Array[RuleGroupRuleStatementNotStatementStatementByteMatchStatementTextTransformation]): Self = StObject.set(x, "textTransformations", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTextTransformationsVarargs(value: RuleGroupRuleStatementNotStatementStatementByteMatchStatementTextTransformation*): Self = StObject.set(x, "textTransformations", js.Array(value :_*))
  }
}
