...
object RuleGroupRuleStatementNotStatementStatementByteMatchStatement {
  ...
  extension [Self <: RuleGroupRuleStatementNotStatementStatementByteMatchStatement](x: Self) {
    
    inline def setFieldToMatch(value: RuleGroupRuleStatementNotStatementStatementByteMatchStatementFieldToMatch): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
    ...
    inline def setTextTransformations(value: js.Array[RuleGroupRuleStatementNotStatementStatementByteMatchStatementTextTransformation]): Self = StObject.set(x, "textTransformations", value.asInstanceOf[js.Any])
    
    inline def setTextTransformationsVarargs(value: RuleGroupRuleStatementNotStatementStatementByteMatchStatementTextTransformation*): Self = StObject.set(x, "textTransformations", js.Array(value :_*))
  }
}
