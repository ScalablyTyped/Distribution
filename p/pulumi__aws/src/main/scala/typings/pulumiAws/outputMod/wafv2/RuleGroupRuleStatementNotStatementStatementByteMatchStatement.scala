...
@js.native
trait RuleGroupRuleStatementNotStatementStatementByteMatchStatement extends js.Object {
...
object RuleGroupRuleStatementNotStatementStatementByteMatchStatement {
  ...
  def apply(
    ...
    searchString: String,
    textTransformations: js.Array[RuleGroupRuleStatementNotStatementStatementByteMatchStatementTextTransformation]
    ...
    __obj.asInstanceOf[RuleGroupRuleStatementNotStatementStatementByteMatchStatement]
  }
  
  @scala.inline
  implicit class RuleGroupRuleStatementNotStatementStatementByteMatchStatementOps[Self <: RuleGroupRuleStatementNotStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextTransformationsVarargs(value: RuleGroupRuleStatementNotStatementStatementByteMatchStatementTextTransformation*): Self = this.set("textTransformations", js.Array(value :_*))
    
    @scala.inline
    def setTextTransformations(value: js.Array[RuleGroupRuleStatementNotStatementStatementByteMatchStatementTextTransformation]): Self = this.set("textTransformations", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFieldToMatch(value: RuleGroupRuleStatementNotStatementStatementByteMatchStatementFieldToMatch): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
