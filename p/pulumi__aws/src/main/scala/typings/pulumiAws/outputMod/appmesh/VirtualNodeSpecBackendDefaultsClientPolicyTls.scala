...
object VirtualNodeSpecBackendDefaultsClientPolicyTls {
  ...
  inline def apply(validation: VirtualNodeSpecBackendDefaultsClientPolicyTlsValidation): VirtualNodeSpecBackendDefaultsClientPolicyTls = {
  ...
  extension [Self <: VirtualNodeSpecBackendDefaultsClientPolicyTls](x: Self) {
    ...
    inline def setValidation(value: VirtualNodeSpecBackendDefaultsClientPolicyTlsValidation): Self = StObject.set(x, "validation", value.asInstanceOf[js.Any])
  }
}
