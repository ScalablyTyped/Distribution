...
object RuleGroupRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig {
  ...
  inline def apply(fallbackBehavior: String, headerName: String, position: String): RuleGroupRuleStatementOrStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig = {
