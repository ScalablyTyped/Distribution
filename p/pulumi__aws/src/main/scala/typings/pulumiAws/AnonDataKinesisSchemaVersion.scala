...
@js.native
trait AnonDataKinesisSchemaVersion extends js.Object {
...
object AnonDataKinesisSchemaVersion {
  @scala.inline
  def apply(data: String, kinesisSchemaVersion: String, partitionKey: String, sequenceNumber: String): AnonDataKinesisSchemaVersion = {
    ...
    __obj.asInstanceOf[AnonDataKinesisSchemaVersion]
  }
}
