...
object baiduChannelMod {
  ...
  object BaiduChannel {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): BaiduChannel = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[BaiduChannel]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): BaiduChannel = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[BaiduChannel]
    inline def get(name: String, id: Input[ID], state: BaiduChannelState): BaiduChannel = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[BaiduChannel]
    inline def get(name: String, id: Input[ID], state: BaiduChannelState, opts: CustomResourceOptions): BaiduChannel = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[BaiduChannel]
  ...
  object BaiduChannelArgs {
    ...
    inline def apply(apiKey: Input[String], applicationId: Input[String], secretKey: Input[String]): BaiduChannelArgs = {
    ...
    extension [Self <: BaiduChannelArgs](x: Self) {
  ...
  object BaiduChannelState {
    ...
    inline def apply(): BaiduChannelState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[BaiduChannelState]
    }
    
    extension [Self <: BaiduChannelState](x: Self) {
