...
object virtualServiceMod {
  ...
  trait VirtualServiceArgs extends StObject {
    ...
    /**
      * The virtual service specification to apply.
      */
    val spec: Input[typings.pulumiAws.inputMod.appmesh.VirtualServiceSpec] = js.native
  ...
  trait VirtualServiceState extends StObject {
    ...
    /**
      * The virtual service specification to apply.
      */
    val spec: js.UndefOr[Input[typings.pulumiAws.inputMod.appmesh.VirtualServiceSpec]] = js.native
