...
object sizeConstraintSetMod {
  ...
  object SizeConstraintSetArgs {
    ...
    implicit class SizeConstraintSetArgsMutableBuilder[Self <: SizeConstraintSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSizeConstraintsVarargs(value: Input[typings.pulumiAws.inputMod.wafregional.SizeConstraintSetSizeConstraint]*): Self = StObject.set(x, "sizeConstraints", js.Array(value :_*))
    }
  }
