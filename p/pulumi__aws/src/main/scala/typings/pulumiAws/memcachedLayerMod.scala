...
object memcachedLayerMod {
  ...
  object MemcachedLayer {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): MemcachedLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[MemcachedLayer]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): MemcachedLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[MemcachedLayer]
    inline def get(name: String, id: Input[ID], state: MemcachedLayerState): MemcachedLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[MemcachedLayer]
    inline def get(name: String, id: Input[ID], state: MemcachedLayerState, opts: CustomResourceOptions): MemcachedLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[MemcachedLayer]
  ...
  object MemcachedLayerArgs {
    ...
    inline def apply(stackId: Input[String]): MemcachedLayerArgs = {
      val __obj = js.Dynamic.literal(stackId = stackId.asInstanceOf[js.Any])
      __obj.asInstanceOf[MemcachedLayerArgs]
    }
    
    extension [Self <: MemcachedLayerArgs](x: Self) {
      
      inline def setAllocatedMemory(value: Input[Double]): Self = StObject.set(x, "allocatedMemory", value.asInstanceOf[js.Any])
      
      inline def setAllocatedMemoryUndefined: Self = StObject.set(x, "allocatedMemory", js.undefined)
      ...
      inline def setEbsVolumes(value: Input[js.Array[Input[typings.pulumiAws.inputMod.opsworks.MemcachedLayerEbsVolume]]]): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      inline def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      inline def setEbsVolumesVarargs(value: Input[typings.pulumiAws.inputMod.opsworks.MemcachedLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
  ...
  object MemcachedLayerState {
    ...
    inline def apply(): MemcachedLayerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MemcachedLayerState]
    }
    
    extension [Self <: MemcachedLayerState](x: Self) {
