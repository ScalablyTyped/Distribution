...
object emrMod {
  ...
  class Cluster protected ()
    extends typings.pulumiAws.emrClusterMod.Cluster {
    /**
  ...
  class InstanceFleet protected ()
    extends typings.pulumiAws.instanceFleetMod.InstanceFleet {
    /**
  ...
  class InstanceGroup protected ()
    extends typings.pulumiAws.instanceGroupMod.InstanceGroup {
    /**
  ...
  class ManagedScalingPolicy protected ()
    extends typings.pulumiAws.managedScalingPolicyMod.ManagedScalingPolicy {
    /**
  ...
  class SecurityConfiguration protected ()
    extends typings.pulumiAws.securityConfigurationMod.SecurityConfiguration {
    /**
