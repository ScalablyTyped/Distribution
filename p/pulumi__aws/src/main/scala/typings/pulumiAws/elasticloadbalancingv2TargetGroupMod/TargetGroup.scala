...
import typings.pulumiAws.outputMod.elasticloadbalancingv2.TargetGroupHealthCheck
import typings.pulumiAws.outputMod.elasticloadbalancingv2.TargetGroupStickiness
