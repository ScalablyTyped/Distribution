...
object listenerRuleMod {
  ...
  trait ListenerRuleArgs extends StObject {
    ...
    /**
      * An Action block. Action blocks are documented below.
      */
    val actions: Input[js.Array[Input[typings.pulumiAws.inputMod.alb.ListenerRuleAction]]] = js.native
    
    /**
      * A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
      */
    val conditions: Input[js.Array[Input[typings.pulumiAws.inputMod.alb.ListenerRuleCondition]]] = js.native
  ...
  object ListenerRuleArgs {
    ...
    implicit class ListenerRuleArgsMutableBuilder[Self <: ListenerRuleArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActions(value: Input[js.Array[Input[typings.pulumiAws.inputMod.alb.ListenerRuleAction]]]): Self = StObject.set(x, "actions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setActionsVarargs(value: Input[typings.pulumiAws.inputMod.alb.ListenerRuleAction]*): Self = StObject.set(x, "actions", js.Array(value :_*))
      
      @scala.inline
      def setConditions(value: Input[js.Array[Input[typings.pulumiAws.inputMod.alb.ListenerRuleCondition]]]): Self = StObject.set(x, "conditions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setConditionsVarargs(value: Input[typings.pulumiAws.inputMod.alb.ListenerRuleCondition]*): Self = StObject.set(x, "conditions", js.Array(value :_*))
  ...
  trait ListenerRuleState extends StObject {
    ...
    /**
      * An Action block. Action blocks are documented below.
      */
    val actions: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.alb.ListenerRuleAction]]]] = js.native
    ...
    /**
      * A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
      */
    val conditions: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.alb.ListenerRuleCondition]]]] = js.native
