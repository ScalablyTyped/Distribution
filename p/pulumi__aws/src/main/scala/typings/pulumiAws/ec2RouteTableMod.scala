...
object ec2RouteTableMod {
  ...
  object RouteTableArgs {
    ...
    inline def apply(vpcId: Input[String]): RouteTableArgs = {
    ...
    extension [Self <: RouteTableArgs](x: Self) {
      ...
      inline def setRoutes(value: Input[js.Array[Input[typings.pulumiAws.inputMod.ec2.RouteTableRoute]]]): Self = StObject.set(x, "routes", value.asInstanceOf[js.Any])
      
      inline def setRoutesUndefined: Self = StObject.set(x, "routes", js.undefined)
      
      inline def setRoutesVarargs(value: Input[typings.pulumiAws.inputMod.ec2.RouteTableRoute]*): Self = StObject.set(x, "routes", js.Array(value :_*))
