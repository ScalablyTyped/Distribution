package typings.pulumiAws.accountPublicAccessBlockMod
...
object AccountPublicAccessBlockArgs {
  ...
  @scala.inline
  implicit class AccountPublicAccessBlockArgsOps[Self <: AccountPublicAccessBlockArgs] (val x: Self) extends AnyVal {
    @scala.inline
