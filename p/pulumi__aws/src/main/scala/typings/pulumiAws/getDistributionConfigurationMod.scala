...
object getDistributionConfigurationMod {
  ...
  object GetDistributionConfigurationArgs {
    ...
    inline def apply(arn: String): GetDistributionConfigurationArgs = {
      val __obj = js.Dynamic.literal(arn = arn.asInstanceOf[js.Any])
      __obj.asInstanceOf[GetDistributionConfigurationArgs]
    }
    
    extension [Self <: GetDistributionConfigurationArgs](x: Self) {
  ...
  object GetDistributionConfigurationResult {
    ...
    extension [Self <: GetDistributionConfigurationResult](x: Self) {
      ...
      inline def setDistributions(value: js.Array[GetDistributionConfigurationDistribution]): Self = StObject.set(x, "distributions", value.asInstanceOf[js.Any])
      
      inline def setDistributionsVarargs(value: GetDistributionConfigurationDistribution*): Self = StObject.set(x, "distributions", js.Array(value :_*))
