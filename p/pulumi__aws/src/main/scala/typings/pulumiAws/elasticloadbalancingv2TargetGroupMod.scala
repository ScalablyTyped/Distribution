...
object elasticloadbalancingv2TargetGroupMod {
  ...
  object TargetGroup {
    ...
    /**
      ...
      */
    inline def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/elasticloadbalancingv2/targetGroup.TargetGroup */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/aws.@pulumi/aws/elasticloadbalancingv2/targetGroup.TargetGroup */ Boolean]
  }
  ...
  object TargetGroupArgs {
    ...
    extension [Self <: TargetGroupArgs](x: Self) {
      ...
      inline def setHealthCheck(value: Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.TargetGroupHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      inline def setStickiness(value: Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.TargetGroupStickiness]): Self = StObject.set(x, "stickiness", value.asInstanceOf[js.Any])
