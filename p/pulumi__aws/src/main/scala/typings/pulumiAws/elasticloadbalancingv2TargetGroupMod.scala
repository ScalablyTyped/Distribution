...
object elasticloadbalancingv2TargetGroupMod {
  ...
  object TargetGroupArgs {
    ...
    implicit class TargetGroupArgsMutableBuilder[Self <: TargetGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHealthCheck(value: Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.TargetGroupHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStickiness(value: Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.TargetGroupStickiness]): Self = StObject.set(x, "stickiness", value.asInstanceOf[js.Any])
