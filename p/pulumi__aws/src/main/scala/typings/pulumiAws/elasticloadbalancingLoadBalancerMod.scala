...
object elasticloadbalancingLoadBalancerMod {
  ...
  object LoadBalancerArgs {
    ...
    extension [Self <: LoadBalancerArgs](x: Self) {
      ...
      inline def setAccessLogs(value: Input[typings.pulumiAws.inputMod.elasticloadbalancing.LoadBalancerAccessLogs]): Self = StObject.set(x, "accessLogs", value.asInstanceOf[js.Any])
      ...
      inline def setHealthCheck(value: Input[typings.pulumiAws.inputMod.elasticloadbalancing.LoadBalancerHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      inline def setListenersVarargs(value: Input[typings.pulumiAws.inputMod.elasticloadbalancing.LoadBalancerListener]*): Self = StObject.set(x, "listeners", js.Array(value :_*))
