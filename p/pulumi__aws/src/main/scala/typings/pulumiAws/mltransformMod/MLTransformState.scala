...
import typings.pulumiAws.inputMod.glue.MLTransformSchema
...
@js.native
trait MLTransformState extends js.Object {
  ...
  /**
    ...
    */
  val inputRecordTables: js.UndefOr[Input[js.Array[Input[MLTransformInputRecordTable]]]] = js.native
  ...
  /**
    ...
    */
  val parameters: js.UndefOr[Input[MLTransformParameters]] = js.native
  ...
  /**
    ...
    */
  val schemas: js.UndefOr[Input[js.Array[Input[MLTransformSchema]]]] = js.native
...
object MLTransformState {
  ...
  @scala.inline
  implicit class MLTransformStateOps[Self <: MLTransformState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLabelCount(value: Input[Double]): Self = this.set("labelCount", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSchemasVarargs(value: Input[MLTransformSchema]*): Self = this.set("schemas", js.Array(value :_*))
    
    @scala.inline
    def setSchemas(value: Input[js.Array[Input[MLTransformSchema]]]): Self = this.set("schemas", value.asInstanceOf[js.Any])
