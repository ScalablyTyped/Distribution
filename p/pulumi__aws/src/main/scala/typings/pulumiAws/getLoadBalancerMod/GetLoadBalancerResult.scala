package typings.pulumiAws.getLoadBalancerMod

import org.scalablytyped.runtime.StringDictionary
import typings.pulumiAws.outputMod.alb.GetLoadBalancerAccessLogs
import typings.pulumiAws.outputMod.alb.GetLoadBalancerSubnetMapping
