...
object rdsParameterGroupMod {
  ...
  object ParameterGroup {
    ...
    /**
      ...
      */
    inline def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/rds/parameterGroup.ParameterGroup */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/aws.@pulumi/aws/rds/parameterGroup.ParameterGroup */ Boolean]
  }
  ...
  object ParameterGroupArgs {
    ...
    extension [Self <: ParameterGroupArgs](x: Self) {
      ...
      inline def setParameters(value: Input[js.Array[Input[typings.pulumiAws.inputMod.rds.ParameterGroupParameter]]]): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
      
      inline def setParametersUndefined: Self = StObject.set(x, "parameters", js.undefined)
      
      inline def setParametersVarargs(value: Input[typings.pulumiAws.inputMod.rds.ParameterGroupParameter]*): Self = StObject.set(x, "parameters", js.Array(value :_*))
