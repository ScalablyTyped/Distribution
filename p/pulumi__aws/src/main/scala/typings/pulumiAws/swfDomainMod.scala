...
object swfDomainMod {
  ...
  object Domain {
    ...
    /**
      ...
      */
    inline def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/swf/domain.Domain */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/aws.@pulumi/aws/swf/domain.Domain */ Boolean]
  }
  ...
  object DomainArgs {
    ...
    inline def apply(workflowExecutionRetentionPeriodInDays: Input[String]): DomainArgs = {
    ...
    extension [Self <: DomainArgs](x: Self) {
      ...
      inline def setWorkflowExecutionRetentionPeriodInDays(value: Input[String]): Self = StObject.set(x, "workflowExecutionRetentionPeriodInDays", value.asInstanceOf[js.Any])
    }
  }
  ...
  object DomainState {
    ...
    extension [Self <: DomainState](x: Self) {
      ...
      inline def setWorkflowExecutionRetentionPeriodInDaysUndefined: Self = StObject.set(x, "workflowExecutionRetentionPeriodInDays", js.undefined)
    }
  }
}
