...
object listenerMod {
  ...
  trait ListenerArgs extends StObject {
    ...
    /**
      * An Action block. Action blocks are documented below.
      */
    val defaultActions: Input[js.Array[Input[typings.pulumiAws.inputMod.alb.ListenerDefaultAction]]] = js.native
  ...
  object ListenerArgs {
    ...
    implicit class ListenerArgsMutableBuilder[Self <: ListenerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultActions(value: Input[js.Array[Input[typings.pulumiAws.inputMod.alb.ListenerDefaultAction]]]): Self = StObject.set(x, "defaultActions", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDefaultActionsVarargs(value: Input[typings.pulumiAws.inputMod.alb.ListenerDefaultAction]*): Self = StObject.set(x, "defaultActions", js.Array(value :_*))
  ...
  trait ListenerState extends StObject {
    ...
    /**
      * An Action block. Action blocks are documented below.
      */
    val defaultActions: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.alb.ListenerDefaultAction]]]] = js.native
