package typings.pulumiAws.lbGetTargetGroupMod

import org.scalablytyped.runtime.StringDictionary
import typings.pulumiAws.outputMod.lb.GetTargetGroupHealthCheck
import typings.pulumiAws.outputMod.lb.GetTargetGroupStickiness
