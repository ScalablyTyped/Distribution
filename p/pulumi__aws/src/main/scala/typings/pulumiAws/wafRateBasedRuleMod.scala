...
object wafRateBasedRuleMod {
  ...
  object RateBasedRule {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/waf/rateBasedRule", "RateBasedRule.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/waf/rateBasedRule", "RateBasedRule.isInstance")
    @js.native
  ...
  trait RateBasedRuleArgs extends StObject {
    ...
    /**
      * The objects to include in a rule (documented below).
      */
    val predicates: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.waf.RateBasedRulePredicate]]]] = js.native
