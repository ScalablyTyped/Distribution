...
object hostedPublicVirtualInterfaceMod {
  ...
  object HostedPublicVirtualInterface {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): HostedPublicVirtualInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[HostedPublicVirtualInterface]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): HostedPublicVirtualInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[HostedPublicVirtualInterface]
    inline def get(name: String, id: Input[ID], state: HostedPublicVirtualInterfaceState): HostedPublicVirtualInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[HostedPublicVirtualInterface]
  ...
  object HostedPublicVirtualInterfaceArgs {
    ...
    extension [Self <: HostedPublicVirtualInterfaceArgs](x: Self) {
  ...
  object HostedPublicVirtualInterfaceState {
    ...
    inline def apply(): HostedPublicVirtualInterfaceState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[HostedPublicVirtualInterfaceState]
    }
    
    extension [Self <: HostedPublicVirtualInterfaceState](x: Self) {
