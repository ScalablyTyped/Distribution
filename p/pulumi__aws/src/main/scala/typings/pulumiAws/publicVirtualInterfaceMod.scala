...
object publicVirtualInterfaceMod {
  ...
  object PublicVirtualInterface {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): PublicVirtualInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[PublicVirtualInterface]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): PublicVirtualInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PublicVirtualInterface]
    inline def get(name: String, id: Input[ID], state: PublicVirtualInterfaceState): PublicVirtualInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[PublicVirtualInterface]
    inline def get(name: String, id: Input[ID], state: PublicVirtualInterfaceState, opts: CustomResourceOptions): PublicVirtualInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PublicVirtualInterface]
  ...
  object PublicVirtualInterfaceArgs {
    ...
    extension [Self <: PublicVirtualInterfaceArgs](x: Self) {
      ...
      inline def setRouteFilterPrefixes(value: Input[js.Array[Input[String]]]): Self = StObject.set(x, "routeFilterPrefixes", value.asInstanceOf[js.Any])
      
      inline def setRouteFilterPrefixesVarargs(value: Input[String]*): Self = StObject.set(x, "routeFilterPrefixes", js.Array(value :_*))
  ...
  object PublicVirtualInterfaceState {
    ...
    inline def apply(): PublicVirtualInterfaceState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PublicVirtualInterfaceState]
    }
    
    extension [Self <: PublicVirtualInterfaceState](x: Self) {
