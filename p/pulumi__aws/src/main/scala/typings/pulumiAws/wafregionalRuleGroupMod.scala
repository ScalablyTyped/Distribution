...
object wafregionalRuleGroupMod {
  ...
  object RuleGroupArgs {
    ...
    implicit class RuleGroupArgsMutableBuilder[Self <: RuleGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActivatedRules(value: Input[js.Array[Input[typings.pulumiAws.inputMod.wafregional.RuleGroupActivatedRule]]]): Self = StObject.set(x, "activatedRules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setActivatedRulesUndefined: Self = StObject.set(x, "activatedRules", js.undefined)
      
      @scala.inline
      def setActivatedRulesVarargs(value: Input[typings.pulumiAws.inputMod.wafregional.RuleGroupActivatedRule]*): Self = StObject.set(x, "activatedRules", js.Array(value :_*))
