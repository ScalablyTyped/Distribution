...
object elasticloadbalancingv2ListenerRuleMod {
  ...
  object ListenerRuleArgs {
    ...
    extension [Self <: ListenerRuleArgs](x: Self) {
      ...
      inline def setActionsVarargs(value: Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.ListenerRuleAction]*): Self = StObject.set(x, "actions", js.Array(value :_*))
      ...
      inline def setConditionsVarargs(value: Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.ListenerRuleCondition]*): Self = StObject.set(x, "conditions", js.Array(value :_*))
