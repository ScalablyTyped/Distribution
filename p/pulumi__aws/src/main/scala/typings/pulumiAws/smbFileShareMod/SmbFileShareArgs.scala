...
import typings.pulumiAws.inputMod.storagegateway.SmbFileShareCacheAttributes
...
object SmbFileShareArgs {
  ...
  @scala.inline
  implicit class SmbFileShareArgsOps[Self <: SmbFileShareArgs] (val x: Self) extends AnyVal {
