...
object fmsMod {
  ...
  object AdminAccount {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): typings.pulumiAws.adminAccountMod.AdminAccount = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.adminAccountMod.AdminAccount]
    ...
    inline def get(name: String, id: Input[ID], state: AdminAccountState): typings.pulumiAws.adminAccountMod.AdminAccount = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.adminAccountMod.AdminAccount]
