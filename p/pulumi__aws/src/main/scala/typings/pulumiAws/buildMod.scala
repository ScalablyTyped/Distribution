...
object buildMod {
  ...
  object Build {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): Build = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[Build]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): Build = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Build]
    inline def get(name: String, id: Input[ID], state: BuildState): Build = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Build]
    inline def get(name: String, id: Input[ID], state: BuildState, opts: CustomResourceOptions): Build = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Build]
  ...
  object BuildArgs {
    ...
    extension [Self <: BuildArgs](x: Self) {
      ...
      inline def setStorageLocation(value: Input[typings.pulumiAws.inputMod.gamelift.BuildStorageLocation]): Self = StObject.set(x, "storageLocation", value.asInstanceOf[js.Any])
  ...
  object BuildState {
    ...
    inline def apply(): BuildState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[BuildState]
    }
    
    extension [Self <: BuildState](x: Self) {
