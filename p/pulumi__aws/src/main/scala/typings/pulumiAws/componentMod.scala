...
object componentMod {
  ...
  object Component {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): Component = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[Component]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): Component = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Component]
    inline def get(name: String, id: Input[ID], state: ComponentState): Component = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Component]
    inline def get(name: String, id: Input[ID], state: ComponentState, opts: CustomResourceOptions): Component = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Component]
  ...
  object ComponentArgs {
    ...
    inline def apply(platform: Input[String], version: Input[String]): ComponentArgs = {
    ...
    extension [Self <: ComponentArgs](x: Self) {
      
      inline def setChangeDescription(value: Input[String]): Self = StObject.set(x, "changeDescription", value.asInstanceOf[js.Any])
      ...
      inline def setSupportedOsVersions(value: Input[js.Array[Input[String]]]): Self = StObject.set(x, "supportedOsVersions", value.asInstanceOf[js.Any])
      
      inline def setSupportedOsVersionsUndefined: Self = StObject.set(x, "supportedOsVersions", js.undefined)
      
      inline def setSupportedOsVersionsVarargs(value: Input[String]*): Self = StObject.set(x, "supportedOsVersions", js.Array(value :_*))
