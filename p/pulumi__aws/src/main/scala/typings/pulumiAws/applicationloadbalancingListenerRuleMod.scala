...
object applicationloadbalancingListenerRuleMod {
  ...
  object ListenerRuleArgs {
    ...
    implicit class ListenerRuleArgsMutableBuilder[Self <: ListenerRuleArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActionsVarargs(value: Input[typings.pulumiAws.inputMod.applicationloadbalancing.ListenerRuleAction]*): Self = StObject.set(x, "actions", js.Array(value :_*))
      ...
      @scala.inline
      def setConditionsVarargs(value: Input[typings.pulumiAws.inputMod.applicationloadbalancing.ListenerRuleCondition]*): Self = StObject.set(x, "conditions", js.Array(value :_*))
