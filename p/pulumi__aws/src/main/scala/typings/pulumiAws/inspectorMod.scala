...
object inspectorMod {
  ...
  class AssessmentTarget protected ()
    extends typings.pulumiAws.assessmentTargetMod.AssessmentTarget {
    /**
  ...
  class AssessmentTemplate protected ()
    extends typings.pulumiAws.assessmentTemplateMod.AssessmentTemplate {
    /**
  ...
  class ResourceGroup protected ()
    extends typings.pulumiAws.resourceGroupMod.ResourceGroup {
    /**
