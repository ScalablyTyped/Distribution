...
object aliasMod {
  ...
  object AliasArgs {
    ...
    @scala.inline
    def apply(routingStrategy: Input[typings.pulumiAws.inputMod.gamelift.AliasRoutingStrategy]): AliasArgs = {
    ...
    implicit class AliasArgsMutableBuilder[Self <: AliasArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRoutingStrategy(value: Input[typings.pulumiAws.inputMod.gamelift.AliasRoutingStrategy]): Self = StObject.set(x, "routingStrategy", value.asInstanceOf[js.Any])
