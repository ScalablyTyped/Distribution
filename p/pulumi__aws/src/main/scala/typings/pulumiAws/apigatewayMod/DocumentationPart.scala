...
object DocumentationPart {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.documentationPartMod.DocumentationPart = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.documentationPartMod.DocumentationPart]
  inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): typings.pulumiAws.documentationPartMod.DocumentationPart = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.documentationPartMod.DocumentationPart]
  inline def get(name: String, id: Input[ID], state: DocumentationPartState): typings.pulumiAws.documentationPartMod.DocumentationPart = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.documentationPartMod.DocumentationPart]
  inline def get(name: String, id: Input[ID], state: DocumentationPartState, opts: CustomResourceOptions): typings.pulumiAws.documentationPartMod.DocumentationPart = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.documentationPartMod.DocumentationPart]
