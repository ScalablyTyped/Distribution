...
object Response {
  ...
  @js.native
  def get(name: String, id: Input[ID]): typings.pulumiAws.responseMod.Response = js.native
  @JSImport("@pulumi/aws/apigateway", "Response.get")
  @js.native
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typings.pulumiAws.responseMod.Response = js.native
  @JSImport("@pulumi/aws/apigateway", "Response.get")
  @js.native
  def get(name: String, id: Input[ID], state: ResponseState): typings.pulumiAws.responseMod.Response = js.native
  @JSImport("@pulumi/aws/apigateway", "Response.get")
  @js.native
  def get(name: String, id: Input[ID], state: ResponseState, opts: CustomResourceOptions): typings.pulumiAws.responseMod.Response = js.native
