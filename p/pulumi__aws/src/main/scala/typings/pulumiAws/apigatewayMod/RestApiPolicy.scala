...
import typings.pulumiAws.restApiPolicyMod.RestApiPolicyArgs
import typings.pulumiAws.restApiPolicyMod.RestApiPolicyState
...
class RestApiPolicy protected ()
  extends typings.pulumiAws.restApiPolicyMod.RestApiPolicy {
  /**
