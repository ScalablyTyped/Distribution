...
object BasePathMapping extends js.Object {
  ...
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.pulumiAws.basePathMappingMod.BasePathMapping = js.native
  def get(name: String, id: Input[ID], state: js.UndefOr[scala.Nothing], opts: CustomResourceOptions): typings.pulumiAws.basePathMappingMod.BasePathMapping = js.native
  def get(name: String, id: Input[ID], state: BasePathMappingState): typings.pulumiAws.basePathMappingMod.BasePathMapping = js.native
  def get(name: String, id: Input[ID], state: BasePathMappingState, opts: CustomResourceOptions): typings.pulumiAws.basePathMappingMod.BasePathMapping = js.native
