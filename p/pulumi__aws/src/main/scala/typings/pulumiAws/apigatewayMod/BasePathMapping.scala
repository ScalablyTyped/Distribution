...
object BasePathMapping {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.basePathMappingMod.BasePathMapping = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.basePathMappingMod.BasePathMapping]
  ...
  inline def get(name: String, id: Input[ID], state: BasePathMappingState): typings.pulumiAws.basePathMappingMod.BasePathMapping = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.basePathMappingMod.BasePathMapping]
