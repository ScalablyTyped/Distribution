...
object Stage {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.apigatewayStageMod.Stage = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.apigatewayStageMod.Stage]
  @scala.inline
  ...
  @scala.inline
  def get(name: String, id: Input[ID], state: StageState): typings.pulumiAws.apigatewayStageMod.Stage = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.apigatewayStageMod.Stage]
  @scala.inline
