...
object applicationloadbalancingListenerMod {
  ...
  object ListenerArgs {
    ...
    extension [Self <: ListenerArgs](x: Self) {
      ...
      inline def setDefaultActionsVarargs(value: Input[typings.pulumiAws.inputMod.applicationloadbalancing.ListenerDefaultAction]*): Self = StObject.set(x, "defaultActions", js.Array(value :_*))
