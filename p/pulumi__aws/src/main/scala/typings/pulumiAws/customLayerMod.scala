...
object customLayerMod {
  ...
  object CustomLayer {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): CustomLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[CustomLayer]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): CustomLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[CustomLayer]
    inline def get(name: String, id: Input[ID], state: CustomLayerState): CustomLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[CustomLayer]
    inline def get(name: String, id: Input[ID], state: CustomLayerState, opts: CustomResourceOptions): CustomLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[CustomLayer]
  ...
  object CustomLayerArgs {
    ...
    inline def apply(shortName: Input[String], stackId: Input[String]): CustomLayerArgs = {
    ...
    extension [Self <: CustomLayerArgs](x: Self) {
      ...
      inline def setEbsVolumes(value: Input[js.Array[Input[typings.pulumiAws.inputMod.opsworks.CustomLayerEbsVolume]]]): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      inline def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      inline def setEbsVolumesVarargs(value: Input[typings.pulumiAws.inputMod.opsworks.CustomLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
  ...
  object CustomLayerState {
    ...
    inline def apply(): CustomLayerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CustomLayerState]
    }
    
    extension [Self <: CustomLayerState](x: Self) {
