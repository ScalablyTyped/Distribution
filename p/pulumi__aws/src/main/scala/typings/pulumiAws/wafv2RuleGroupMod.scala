...
object wafv2RuleGroupMod {
  ...
  trait RuleGroupArgs extends StObject {
    ...
    /**
      * The rule blocks used to identify the web requests that you want to `allow`, `block`, or `count`. See Rules below for details.
      */
    val rules: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.wafv2.RuleGroupRule]]]] = js.native
    ...
    /**
      * Defines and enables Amazon CloudWatch metrics and web request sample collection. See Visibility Configuration below for details.
      */
    val visibilityConfig: Input[typings.pulumiAws.inputMod.wafv2.RuleGroupVisibilityConfig] = js.native
  }
  object RuleGroupArgs {
    ...
    implicit class RuleGroupArgsMutableBuilder[Self <: RuleGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRules(value: Input[js.Array[Input[typings.pulumiAws.inputMod.wafv2.RuleGroupRule]]]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRulesUndefined: Self = StObject.set(x, "rules", js.undefined)
      
      @scala.inline
      def setRulesVarargs(value: Input[typings.pulumiAws.inputMod.wafv2.RuleGroupRule]*): Self = StObject.set(x, "rules", js.Array(value :_*))
      ...
      @scala.inline
      def setVisibilityConfig(value: Input[typings.pulumiAws.inputMod.wafv2.RuleGroupVisibilityConfig]): Self = StObject.set(x, "visibilityConfig", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait RuleGroupState extends StObject {
    ...
    /**
      * Defines and enables Amazon CloudWatch metrics and web request sample collection. See Visibility Configuration below for details.
      */
    val visibilityConfig: js.UndefOr[Input[typings.pulumiAws.inputMod.wafv2.RuleGroupVisibilityConfig]] = js.native
  }
