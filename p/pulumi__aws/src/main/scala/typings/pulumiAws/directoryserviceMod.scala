...
object directoryserviceMod {
  ...
  class ConditionalForwader protected ()
    extends typings.pulumiAws.conditionalForwaderMod.ConditionalForwader {
    /**
  ...
  object ConditionalForwader {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): typings.pulumiAws.conditionalForwaderMod.ConditionalForwader = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.conditionalForwaderMod.ConditionalForwader]
  ...
  class Directory protected ()
    extends typings.pulumiAws.directoryMod.Directory {
    /**
  ...
  object Directory {
    ...
    /**
      ...
      * @param opts Optional settings to control the behavior of the CustomResource.
      */
    inline def get(name: String, id: Input[ID]): typings.pulumiAws.directoryMod.Directory = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.directoryMod.Directory]
    ...
    inline def get(name: String, id: Input[ID], state: DirectoryState): typings.pulumiAws.directoryMod.Directory = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.directoryMod.Directory]
  ...
  class LogService protected ()
    extends typings.pulumiAws.logServiceMod.LogService {
    /**
  ...
  object LogService {
    ...
    /**
      ...
      * @param opts Optional settings to control the behavior of the CustomResource.
      */
    inline def get(name: String, id: Input[ID]): typings.pulumiAws.logServiceMod.LogService = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.logServiceMod.LogService]
    ...
    inline def get(name: String, id: Input[ID], state: LogServiceState): typings.pulumiAws.logServiceMod.LogService = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.logServiceMod.LogService]
