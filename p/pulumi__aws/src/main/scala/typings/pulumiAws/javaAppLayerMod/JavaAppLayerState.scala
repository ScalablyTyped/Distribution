...
object JavaAppLayerState {
  @scala.inline
  def apply(): JavaAppLayerState = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[JavaAppLayerState]
  }
  @scala.inline
  implicit class JavaAppLayerStateOps[Self <: JavaAppLayerState] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAppServerVersion(value: Input[String]): Self = this.set("appServerVersion", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteAppServerVersion: Self = this.set("appServerVersion", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setEbsVolumesVarargs(value: Input[JavaAppLayerEbsVolume]*): Self = this.set("ebsVolumes", js.Array(value :_*))
    @scala.inline
    def setEbsVolumes(value: Input[js.Array[Input[JavaAppLayerEbsVolume]]]): Self = this.set("ebsVolumes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setJvmOptions(value: Input[String]): Self = this.set("jvmOptions", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteJvmOptions: Self = this.set("jvmOptions", js.undefined)
    @scala.inline
    def setJvmType(value: Input[String]): Self = this.set("jvmType", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteJvmType: Self = this.set("jvmType", js.undefined)
    @scala.inline
    def setJvmVersion(value: Input[String]): Self = this.set("jvmVersion", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteJvmVersion: Self = this.set("jvmVersion", js.undefined)
    @scala.inline
