...
object servicecatalogMod {
  ...
  object Portfolio {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): typings.pulumiAws.portfolioMod.Portfolio = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.portfolioMod.Portfolio]
    @scala.inline
    ...
    @scala.inline
    def get(name: String, id: Input[ID], state: PortfolioState): typings.pulumiAws.portfolioMod.Portfolio = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.portfolioMod.Portfolio]
    @scala.inline
