...
object StaticWebLayerArgs {
  @scala.inline
  def apply(stackId: Input[String]): StaticWebLayerArgs = {
    val __obj = js.Dynamic.literal(stackId = stackId.asInstanceOf[js.Any])
    __obj.asInstanceOf[StaticWebLayerArgs]
  }
  @scala.inline
  implicit class StaticWebLayerArgsOps[Self <: StaticWebLayerArgs] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEbsVolumesVarargs(value: Input[StaticWebLayerEbsVolume]*): Self = this.set("ebsVolumes", js.Array(value :_*))
    @scala.inline
    def setEbsVolumes(value: Input[js.Array[Input[StaticWebLayerEbsVolume]]]): Self = this.set("ebsVolumes", value.asInstanceOf[js.Any])
    @scala.inline
