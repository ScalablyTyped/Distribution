...
object managedPoliciesMod {
  ...
  object ManagedPolicies {
    ...
    @JSImport("@pulumi/aws/iam/managedPolicies", "ManagedPolicies.AmazonMachineLearningCreateOnlyAccess")
    @js.native
    val AmazonMachineLearningCreateOnlyAccess: ARN = js.native
    
    /** Use ManagedPolicy.AmazonMachineLearningFullAccess instead. */
    @JSImport("@pulumi/aws/iam/managedPolicies", "ManagedPolicies.AmazonMachineLearningFullAccess")
    @js.native
    ...
    @JSImport("@pulumi/aws/iam/managedPolicies", "ManagedPolicies.AmazonMachineLearningManageRealTimeEndpointOnlyAccess")
    @js.native
    ...
    @JSImport("@pulumi/aws/iam/managedPolicies", "ManagedPolicies.AmazonMachineLearningReadOnlyAccess")
    @js.native
    ...
    @JSImport("@pulumi/aws/iam/managedPolicies", "ManagedPolicies.AmazonMachineLearningRealTimePredictionOnlyAccess")
    @js.native
