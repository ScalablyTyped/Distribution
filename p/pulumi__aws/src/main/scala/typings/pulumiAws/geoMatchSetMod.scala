...
object geoMatchSetMod {
  ...
  object GeoMatchSetArgs {
    ...
    extension [Self <: GeoMatchSetArgs](x: Self) {
      ...
      inline def setGeoMatchConstraints(
        value: Input[
              js.Array[Input[typings.pulumiAws.inputMod.wafregional.GeoMatchSetGeoMatchConstraint]]
            ]
      ...
      inline def setGeoMatchConstraintsVarargs(value: Input[typings.pulumiAws.inputMod.wafregional.GeoMatchSetGeoMatchConstraint]*): Self = StObject.set(x, "geoMatchConstraints", js.Array(value :_*))
