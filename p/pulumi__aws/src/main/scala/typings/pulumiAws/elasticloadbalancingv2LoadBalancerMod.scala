...
object elasticloadbalancingv2LoadBalancerMod {
  ...
  object LoadBalancer {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elasticloadbalancingv2/loadBalancer", "LoadBalancer.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/elasticloadbalancingv2/loadBalancer", "LoadBalancer.isInstance")
    @js.native
  ...
  trait LoadBalancerArgs extends StObject {
    ...
    /**
      * An Access Logs block. Access Logs documented below.
      */
    val accessLogs: js.UndefOr[Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerAccessLogs]] = js.native
  ...
  object LoadBalancerArgs {
    ...
    implicit class LoadBalancerArgsMutableBuilder[Self <: LoadBalancerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccessLogs(value: Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerAccessLogs]): Self = StObject.set(x, "accessLogs", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSubnetMappingsVarargs(value: Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerSubnetMapping]*): Self = StObject.set(x, "subnetMappings", js.Array(value :_*))
