...
import typings.pulumiAws.outputMod.elasticloadbalancingv2.LoadBalancerAccessLogs
import typings.pulumiAws.outputMod.elasticloadbalancingv2.LoadBalancerSubnetMapping
...
object elasticloadbalancingv2LoadBalancerMod {
  ...
  object LoadBalancer {
    ...
    /**
      ...
      */
    inline def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/elasticloadbalancingv2/loadBalancer.LoadBalancer */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/aws.@pulumi/aws/elasticloadbalancingv2/loadBalancer.LoadBalancer */ Boolean]
  }
  ...
  trait LoadBalancerArgs extends StObject {
    ...
    /**
      * An Access Logs block. Access Logs documented below.
      */
    val accessLogs: js.UndefOr[Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerAccessLogs]] = js.undefined
    ...
    val subnetMappings: js.UndefOr[
        Input[
          js.Array[
            Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerSubnetMapping]
          ]
        ]
      ] = js.undefined
  ...
  object LoadBalancerArgs {
    ...
    extension [Self <: LoadBalancerArgs](x: Self) {
      ...
      inline def setAccessLogs(value: Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerAccessLogs]): Self = StObject.set(x, "accessLogs", value.asInstanceOf[js.Any])
      ...
      inline def setLoadBalancerType(value: Input[String]): Self = StObject.set(x, "loadBalancerType", value.asInstanceOf[js.Any])
      ...
      inline def setSubnetMappingsVarargs(value: Input[typings.pulumiAws.inputMod.elasticloadbalancingv2.LoadBalancerSubnetMapping]*): Self = StObject.set(x, "subnetMappings", js.Array(value :_*))
