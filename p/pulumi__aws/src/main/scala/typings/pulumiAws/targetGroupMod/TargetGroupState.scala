package typings.pulumiAws.targetGroupMod

import org.scalablytyped.runtime.StringDictionary
import typings.pulumiAws.inputMod.alb.TargetGroupHealthCheck
import typings.pulumiAws.inputMod.alb.TargetGroupStickiness
