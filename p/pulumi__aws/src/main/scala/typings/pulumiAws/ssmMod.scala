...
object ssmMod extends js.Object {
  ...
  class Activation protected ()
    extends typings.pulumiAws.activationMod.Activation {
    /**
  ...
  class Association protected ()
    extends typings.pulumiAws.ssmAssociationMod.Association {
    /**
  ...
  class Document protected ()
    extends typings.pulumiAws.documentMod.Document {
    /**
  ...
  class MaintenanceWindow protected ()
    extends typings.pulumiAws.maintenanceWindowMod.MaintenanceWindow {
    /**
  ...
  class MaintenanceWindowTarget protected ()
    extends typings.pulumiAws.maintenanceWindowTargetMod.MaintenanceWindowTarget {
    /**
  ...
  class Parameter protected ()
    extends typings.pulumiAws.parameterMod.Parameter {
    /**
  ...
  class PatchBaseline protected ()
    extends typings.pulumiAws.patchBaselineMod.PatchBaseline {
    /**
