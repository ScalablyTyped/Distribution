...
object lbLoadBalancerMod {
  ...
  trait LoadBalancerArgs extends StObject {
    ...
    /**
      * An Access Logs block. Access Logs documented below.
      */
    val accessLogs: js.UndefOr[Input[typings.pulumiAws.inputMod.lb.LoadBalancerAccessLogs]] = js.undefined
    ...
    /**
      * A subnet mapping block as documented below.
      */
    val subnetMappings: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.lb.LoadBalancerSubnetMapping]]]] = js.undefined
  ...
  object LoadBalancerArgs {
    ...
    extension [Self <: LoadBalancerArgs](x: Self) {
      ...
      inline def setAccessLogs(value: Input[typings.pulumiAws.inputMod.lb.LoadBalancerAccessLogs]): Self = StObject.set(x, "accessLogs", value.asInstanceOf[js.Any])
      ...
      inline def setSubnetMappings(value: Input[js.Array[Input[typings.pulumiAws.inputMod.lb.LoadBalancerSubnetMapping]]]): Self = StObject.set(x, "subnetMappings", value.asInstanceOf[js.Any])
      
      inline def setSubnetMappingsUndefined: Self = StObject.set(x, "subnetMappings", js.undefined)
      
      inline def setSubnetMappingsVarargs(value: Input[typings.pulumiAws.inputMod.lb.LoadBalancerSubnetMapping]*): Self = StObject.set(x, "subnetMappings", js.Array(value :_*))
