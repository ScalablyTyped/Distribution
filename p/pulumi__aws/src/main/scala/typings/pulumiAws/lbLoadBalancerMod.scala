...
object lbLoadBalancerMod {
  ...
  trait LoadBalancerArgs extends StObject {
    ...
    /**
      * An Access Logs block. Access Logs documented below.
      */
    val accessLogs: js.UndefOr[Input[typings.pulumiAws.inputMod.lb.LoadBalancerAccessLogs]] = js.native
    ...
    /**
      * A subnet mapping block as documented below.
      */
    val subnetMappings: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.lb.LoadBalancerSubnetMapping]]]] = js.native
