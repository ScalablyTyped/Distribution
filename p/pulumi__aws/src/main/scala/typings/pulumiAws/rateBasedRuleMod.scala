...
object rateBasedRuleMod {
  ...
  object RateBasedRuleArgs {
    ...
    extension [Self <: RateBasedRuleArgs](x: Self) {
      ...
      inline def setPredicates(value: Input[js.Array[Input[typings.pulumiAws.inputMod.wafregional.RateBasedRulePredicate]]]): Self = StObject.set(x, "predicates", value.asInstanceOf[js.Any])
      
      inline def setPredicatesUndefined: Self = StObject.set(x, "predicates", js.undefined)
      
      inline def setPredicatesVarargs(value: Input[typings.pulumiAws.inputMod.wafregional.RateBasedRulePredicate]*): Self = StObject.set(x, "predicates", js.Array(value :_*))
