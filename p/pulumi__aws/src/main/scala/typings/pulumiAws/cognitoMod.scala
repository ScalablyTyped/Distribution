...
object cognitoMod extends js.Object {
  ...
  class IdentityPool protected ()
    extends typings.pulumiAws.identityPoolMod.IdentityPool {
    /**
  ...
  class IdentityPoolRoleAttachment protected ()
    extends typings.pulumiAws.identityPoolRoleAttachmentMod.IdentityPoolRoleAttachment {
    /**
  ...
  class IdentityProvider protected ()
    extends typings.pulumiAws.identityProviderMod.IdentityProvider {
    /**
  ...
  class ResourceServer protected ()
    extends typings.pulumiAws.resourceServerMod.ResourceServer {
    /**
  ...
  class UserGroup protected ()
    extends typings.pulumiAws.userGroupMod.UserGroup {
    /**
  ...
  class UserPool protected ()
    extends typings.pulumiAws.userPoolMod.UserPool {
    /**
  ...
  class UserPoolClient protected ()
    extends typings.pulumiAws.userPoolClientMod.UserPoolClient {
    /**
  ...
  class UserPoolDomain protected ()
    extends typings.pulumiAws.userPoolDomainMod.UserPoolDomain {
    /**
