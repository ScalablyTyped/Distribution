...
object webAclMod {
  ...
  trait WebAclArgs extends StObject {
    ...
    /**
      * The action that you want AWS WAF Regional to take when a request doesn't match the criteria in any of the rules that are associated with the web ACL.
      */
    val defaultAction: Input[typings.pulumiAws.inputMod.wafregional.WebAclDefaultAction] = js.native
    
    /**
      * Configuration block to enable WAF logging. Detailed below.
      */
    val loggingConfiguration: js.UndefOr[Input[typings.pulumiAws.inputMod.wafregional.WebAclLoggingConfiguration]] = js.native
    ...
    /**
      * Set of configuration blocks containing rules for the web ACL. Detailed below.
      */
    val rules: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.wafregional.WebAclRule]]]] = js.native
  ...
  object WebAclArgs {
    ...
    implicit class WebAclArgsMutableBuilder[Self <: WebAclArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDefaultAction(value: Input[typings.pulumiAws.inputMod.wafregional.WebAclDefaultAction]): Self = StObject.set(x, "defaultAction", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLoggingConfiguration(value: Input[typings.pulumiAws.inputMod.wafregional.WebAclLoggingConfiguration]): Self = StObject.set(x, "loggingConfiguration", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setRules(value: Input[js.Array[Input[typings.pulumiAws.inputMod.wafregional.WebAclRule]]]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRulesUndefined: Self = StObject.set(x, "rules", js.undefined)
      
      @scala.inline
      def setRulesVarargs(value: Input[typings.pulumiAws.inputMod.wafregional.WebAclRule]*): Self = StObject.set(x, "rules", js.Array(value :_*))
  ...
  trait WebAclState extends StObject {
    ...
    /**
      * The action that you want AWS WAF Regional to take when a request doesn't match the criteria in any of the rules that are associated with the web ACL.
      */
    val defaultAction: js.UndefOr[Input[typings.pulumiAws.inputMod.wafregional.WebAclDefaultAction]] = js.native
