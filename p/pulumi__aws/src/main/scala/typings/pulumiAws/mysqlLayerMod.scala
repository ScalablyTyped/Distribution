...
object mysqlLayerMod {
  ...
  object MysqlLayerArgs {
    ...
    implicit class MysqlLayerArgsMutableBuilder[Self <: MysqlLayerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsVolumes(value: Input[js.Array[Input[typings.pulumiAws.inputMod.opsworks.MysqlLayerEbsVolume]]]): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      @scala.inline
      def setEbsVolumesVarargs(value: Input[typings.pulumiAws.inputMod.opsworks.MysqlLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
