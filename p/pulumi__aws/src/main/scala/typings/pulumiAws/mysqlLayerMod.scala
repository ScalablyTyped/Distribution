...
import typings.pulumiAws.outputMod.opsworks.MysqlLayerEbsVolume
...
object mysqlLayerMod {
  ...
  object MysqlLayer {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): MysqlLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[MysqlLayer]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): MysqlLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[MysqlLayer]
    inline def get(name: String, id: Input[ID], state: MysqlLayerState): MysqlLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[MysqlLayer]
    inline def get(name: String, id: Input[ID], state: MysqlLayerState, opts: CustomResourceOptions): MysqlLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[MysqlLayer]
  ...
  object MysqlLayerArgs {
    ...
    inline def apply(stackId: Input[String]): MysqlLayerArgs = {
      val __obj = js.Dynamic.literal(stackId = stackId.asInstanceOf[js.Any])
      __obj.asInstanceOf[MysqlLayerArgs]
    }
    
    extension [Self <: MysqlLayerArgs](x: Self) {
      ...
      inline def setEbsVolumes(value: Input[js.Array[Input[typings.pulumiAws.inputMod.opsworks.MysqlLayerEbsVolume]]]): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      inline def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      inline def setEbsVolumesVarargs(value: Input[typings.pulumiAws.inputMod.opsworks.MysqlLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
      ...
      inline def setRootPassword(value: Input[String]): Self = StObject.set(x, "rootPassword", value.asInstanceOf[js.Any])
      
      inline def setRootPasswordOnAllInstances(value: Input[Boolean]): Self = StObject.set(x, "rootPasswordOnAllInstances", value.asInstanceOf[js.Any])
      
      inline def setRootPasswordOnAllInstancesUndefined: Self = StObject.set(x, "rootPasswordOnAllInstances", js.undefined)
  ...
  object MysqlLayerState {
    ...
    inline def apply(): MysqlLayerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[MysqlLayerState]
    }
    
    extension [Self <: MysqlLayerState](x: Self) {
