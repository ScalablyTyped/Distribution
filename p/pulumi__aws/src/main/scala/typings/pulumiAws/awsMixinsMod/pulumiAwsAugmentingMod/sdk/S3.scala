...
object S3 {
  ...
  @JSImport("@pulumi/aws", "sdk.S3.ManagedUpload")
  @js.native
  ...
  object ManagedUpload {
    ...
    /**
      * Default value: 10000
      */
    @JSImport("@pulumi/aws", "sdk.S3.ManagedUpload.maxTotalParts")
    @js.native
    ...
    /**
      ...
      * 1024 * 5
      */
    @JSImport("@pulumi/aws", "sdk.S3.ManagedUpload.minPartSize")
    @js.native
  ...
  @JSImport("@pulumi/aws", "sdk.S3.PresignedPost")
  @js.native
  class PresignedPost ()
