...
object ruleGroupMod {
  ...
  object RuleGroupArgs {
    ...
    inline def apply(capacity: Input[Double], `type`: Input[String]): RuleGroupArgs = {
    ...
    extension [Self <: RuleGroupArgs](x: Self) {
      ...
      inline def setRuleGroup(value: Input[typings.pulumiAws.inputMod.networkfirewall.RuleGroupRuleGroup]): Self = StObject.set(x, "ruleGroup", value.asInstanceOf[js.Any])
      
      inline def setRuleGroupUndefined: Self = StObject.set(x, "ruleGroup", js.undefined)
      
      inline def setRules(value: Input[String]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
