...
object mskClusterMod {
  ...
  trait ClusterArgs extends StObject {
    ...
    /**
      * Configuration block for the broker nodes of the Kafka cluster.
      */
    val brokerNodeGroupInfo: Input[typings.pulumiAws.inputMod.msk.ClusterBrokerNodeGroupInfo] = js.native
    
    /**
      * Configuration block for specifying a client authentication. See below.
      */
    val clientAuthentication: js.UndefOr[Input[typings.pulumiAws.inputMod.msk.ClusterClientAuthentication]] = js.native
    ...
    /**
      * Configuration block for specifying a MSK Configuration to attach to Kafka brokers. See below.
      */
    val configurationInfo: js.UndefOr[Input[typings.pulumiAws.inputMod.msk.ClusterConfigurationInfo]] = js.native
    
    /**
      * Configuration block for specifying encryption. See below.
      */
    val encryptionInfo: js.UndefOr[Input[typings.pulumiAws.inputMod.msk.ClusterEncryptionInfo]] = js.native
    ...
    /**
      * Configuration block for streaming broker logs to Cloudwatch/S3/Kinesis Firehose. See below.
      */
    val loggingInfo: js.UndefOr[Input[typings.pulumiAws.inputMod.msk.ClusterLoggingInfo]] = js.native
    ...
    /**
      * Configuration block for JMX and Node monitoring for the MSK cluster. See below.
      */
    val openMonitoring: js.UndefOr[Input[typings.pulumiAws.inputMod.msk.ClusterOpenMonitoring]] = js.native
  ...
  trait ClusterState extends StObject {
    ...
    /**
      * Configuration block for the broker nodes of the Kafka cluster.
      */
    val brokerNodeGroupInfo: js.UndefOr[Input[typings.pulumiAws.inputMod.msk.ClusterBrokerNodeGroupInfo]] = js.native
