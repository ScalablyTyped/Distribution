...
object hostedTransitVirtualInterfaceMod {
  ...
  object HostedTransitVirtualInterface {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): HostedTransitVirtualInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[HostedTransitVirtualInterface]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): HostedTransitVirtualInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[HostedTransitVirtualInterface]
    inline def get(name: String, id: Input[ID], state: HostedTransitVirtualInterfaceState): HostedTransitVirtualInterface = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[HostedTransitVirtualInterface]
    inline def get(
      name: String,
      id: Input[ID],
  ...
  object HostedTransitVirtualInterfaceArgs {
    ...
    extension [Self <: HostedTransitVirtualInterfaceArgs](x: Self) {
  ...
  object HostedTransitVirtualInterfaceState {
    ...
    inline def apply(): HostedTransitVirtualInterfaceState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[HostedTransitVirtualInterfaceState]
    }
    
    extension [Self <: HostedTransitVirtualInterfaceState](x: Self) {
