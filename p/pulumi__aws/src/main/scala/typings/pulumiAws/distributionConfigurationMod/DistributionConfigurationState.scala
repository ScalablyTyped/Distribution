...
@js.native
trait DistributionConfigurationState extends js.Object {
  ...
  /**
    ...
    */
  val distributions: js.UndefOr[Input[js.Array[Input[DistributionConfigurationDistribution]]]] = js.native
...
object DistributionConfigurationState {
  ...
  @scala.inline
  implicit class DistributionConfigurationStateOps[Self <: DistributionConfigurationState] (val x: Self) extends AnyVal {
