...
import typings.pulumiAws.inputMod.appmesh.VirtualGatewaySpec
...
@js.native
trait VirtualGatewayState extends js.Object {
  ...
  /**
    ...
    */
  val spec: js.UndefOr[Input[VirtualGatewaySpec]] = js.native
...
object VirtualGatewayState {
  ...
  @scala.inline
  implicit class VirtualGatewayStateOps[Self <: VirtualGatewayState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpec(value: Input[VirtualGatewaySpec]): Self = this.set("spec", value.asInstanceOf[js.Any])
