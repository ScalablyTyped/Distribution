...
import typings.pulumiAws.outputMod.elasticloadbalancingv2.GetLoadBalancerAccessLogs
import typings.pulumiAws.outputMod.elasticloadbalancingv2.GetLoadBalancerSubnetMapping
