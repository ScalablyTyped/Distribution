...
object placementGroupMod {
  ...
  object PlacementGroup {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): PlacementGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[PlacementGroup]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): PlacementGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PlacementGroup]
    inline def get(name: String, id: Input[ID], state: PlacementGroupState): PlacementGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[PlacementGroup]
    inline def get(name: String, id: Input[ID], state: PlacementGroupState, opts: CustomResourceOptions): PlacementGroup = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PlacementGroup]
  ...
  object PlacementGroupArgs {
    ...
    inline def apply(strategy: Input[PlacementStrategy]): PlacementGroupArgs = {
      val __obj = js.Dynamic.literal(strategy = strategy.asInstanceOf[js.Any])
      __obj.asInstanceOf[PlacementGroupArgs]
    }
    
    extension [Self <: PlacementGroupArgs](x: Self) {
      
      inline def setName(value: Input[String]): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
      
      inline def setNameUndefined: Self = StObject.set(x, "name", js.undefined)
      
      inline def setStrategy(value: Input[PlacementStrategy]): Self = StObject.set(x, "strategy", value.asInstanceOf[js.Any])
  ...
  object PlacementGroupState {
    ...
    inline def apply(): PlacementGroupState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PlacementGroupState]
    }
    
    extension [Self <: PlacementGroupState](x: Self) {
      ...
      inline def setPlacementGroupId(value: Input[String]): Self = StObject.set(x, "placementGroupId", value.asInstanceOf[js.Any])
