...
object repositoryPolicyMod {
  ...
  object RepositoryPolicy {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): RepositoryPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[RepositoryPolicy]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): RepositoryPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[RepositoryPolicy]
    inline def get(name: String, id: Input[ID], state: RepositoryPolicyState): RepositoryPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[RepositoryPolicy]
    inline def get(name: String, id: Input[ID], state: RepositoryPolicyState, opts: CustomResourceOptions): RepositoryPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[RepositoryPolicy]
  ...
  object RepositoryPolicyArgs {
    ...
    inline def apply(policy: Input[String | PolicyDocument], repository: Input[String]): RepositoryPolicyArgs = {
    ...
    extension [Self <: RepositoryPolicyArgs](x: Self) {
  ...
  object RepositoryPolicyState {
    ...
    inline def apply(): RepositoryPolicyState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[RepositoryPolicyState]
    }
    
    extension [Self <: RepositoryPolicyState](x: Self) {
