...
object slotTypeMod {
  ...
  trait SlotTypeArgs extends StObject {
    ...
    /**
      ...
      * documented under enumeration_value.
      */
    val enumerationValues: Input[js.Array[Input[typings.pulumiAws.inputMod.lex.SlotTypeEnumerationValue]]] = js.native
  ...
  trait SlotTypeState extends StObject {
    ...
    /**
      ...
      * documented under enumeration_value.
      */
    val enumerationValues: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.lex.SlotTypeEnumerationValue]]]] = js.native
