...
object applicationloadbalancingLoadBalancerMod {
  ...
  object LoadBalancer {
    ...
    /**
      ...
      */
    @scala.inline
    def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/applicationloadbalancing/loadBalancer.LoadBalancer */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/aws.@pulumi/aws/applicationloadbalancing/loadBalancer.LoadBalancer */ Boolean]
  }
  ...
  object LoadBalancerArgs {
    ...
    implicit class LoadBalancerArgsMutableBuilder[Self <: LoadBalancerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAccessLogs(value: Input[typings.pulumiAws.inputMod.applicationloadbalancing.LoadBalancerAccessLogs]): Self = StObject.set(x, "accessLogs", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSubnetMappingsVarargs(value: Input[typings.pulumiAws.inputMod.applicationloadbalancing.LoadBalancerSubnetMapping]*): Self = StObject.set(x, "subnetMappings", js.Array(value :_*))
