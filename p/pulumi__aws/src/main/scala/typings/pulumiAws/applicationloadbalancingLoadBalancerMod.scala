...
object applicationloadbalancingLoadBalancerMod {
  ...
  object LoadBalancer {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/applicationloadbalancing/loadBalancer", "LoadBalancer.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/applicationloadbalancing/loadBalancer", "LoadBalancer.isInstance")
    @js.native
