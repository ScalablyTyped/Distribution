...
object lbListenerRuleMod {
  ...
  trait ListenerRuleArgs extends StObject {
    ...
    /**
      * An Action block. Action blocks are documented below.
      */
    val actions: Input[js.Array[Input[typings.pulumiAws.inputMod.lb.ListenerRuleAction]]] = js.native
    
    /**
      * A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
      */
    val conditions: Input[js.Array[Input[typings.pulumiAws.inputMod.lb.ListenerRuleCondition]]] = js.native
  ...
  trait ListenerRuleState extends StObject {
    ...
    /**
      * An Action block. Action blocks are documented below.
      */
    val actions: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.lb.ListenerRuleAction]]]] = js.native
    ...
    /**
      * A Condition block. Multiple condition blocks of different types can be set and all must be satisfied for the rule to match. Condition blocks are documented below.
      */
    val conditions: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.lb.ListenerRuleCondition]]]] = js.native
