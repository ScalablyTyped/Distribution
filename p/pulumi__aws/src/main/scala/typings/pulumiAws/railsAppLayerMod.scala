...
object railsAppLayerMod {
  ...
  object RailsAppLayer {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): RailsAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[RailsAppLayer]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): RailsAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[RailsAppLayer]
    inline def get(name: String, id: Input[ID], state: RailsAppLayerState): RailsAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[RailsAppLayer]
    inline def get(name: String, id: Input[ID], state: RailsAppLayerState, opts: CustomResourceOptions): RailsAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[RailsAppLayer]
  ...
  object RailsAppLayerArgs {
    ...
    inline def apply(stackId: Input[String]): RailsAppLayerArgs = {
      val __obj = js.Dynamic.literal(stackId = stackId.asInstanceOf[js.Any])
      __obj.asInstanceOf[RailsAppLayerArgs]
    }
    
    extension [Self <: RailsAppLayerArgs](x: Self) {
      ...
      inline def setBundlerVersion(value: Input[String]): Self = StObject.set(x, "bundlerVersion", value.asInstanceOf[js.Any])
      
      inline def setBundlerVersionUndefined: Self = StObject.set(x, "bundlerVersion", js.undefined)
      ...
      inline def setEbsVolumes(value: Input[js.Array[Input[typings.pulumiAws.inputMod.opsworks.RailsAppLayerEbsVolume]]]): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      inline def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      inline def setEbsVolumesVarargs(value: Input[typings.pulumiAws.inputMod.opsworks.RailsAppLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
      ...
      inline def setManageBundler(value: Input[Boolean]): Self = StObject.set(x, "manageBundler", value.asInstanceOf[js.Any])
      
      inline def setManageBundlerUndefined: Self = StObject.set(x, "manageBundler", js.undefined)
      
      inline def setName(value: Input[String]): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
      
      inline def setNameUndefined: Self = StObject.set(x, "name", js.undefined)
      
      inline def setPassengerVersion(value: Input[String]): Self = StObject.set(x, "passengerVersion", value.asInstanceOf[js.Any])
      
      inline def setPassengerVersionUndefined: Self = StObject.set(x, "passengerVersion", js.undefined)
      
      inline def setRubyVersion(value: Input[String]): Self = StObject.set(x, "rubyVersion", value.asInstanceOf[js.Any])
      
      inline def setRubyVersionUndefined: Self = StObject.set(x, "rubyVersion", js.undefined)
      
      inline def setRubygemsVersion(value: Input[String]): Self = StObject.set(x, "rubygemsVersion", value.asInstanceOf[js.Any])
      
      inline def setRubygemsVersionUndefined: Self = StObject.set(x, "rubygemsVersion", js.undefined)
  ...
  object RailsAppLayerState {
    ...
    inline def apply(): RailsAppLayerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[RailsAppLayerState]
    }
    
    extension [Self <: RailsAppLayerState](x: Self) {
