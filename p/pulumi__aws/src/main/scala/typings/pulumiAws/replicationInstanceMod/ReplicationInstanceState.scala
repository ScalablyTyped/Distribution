...
object ReplicationInstanceState {
  ...
  implicit class ReplicationInstanceStateOps[Self <: ReplicationInstanceState] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def deleteReplicationInstanceId: Self = this.set("replicationInstanceId", js.undefined)
    @scala.inline
    def setReplicationInstancePrivateIpsVarargs(value: Input[String]*): Self = this.set("replicationInstancePrivateIps", js.Array(value :_*))
    @scala.inline
    def setReplicationInstancePrivateIps(value: Input[js.Array[Input[String]]]): Self = this.set("replicationInstancePrivateIps", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteReplicationInstancePrivateIps: Self = this.set("replicationInstancePrivateIps", js.undefined)
    @scala.inline
    def setReplicationInstancePublicIpsVarargs(value: Input[String]*): Self = this.set("replicationInstancePublicIps", js.Array(value :_*))
    @scala.inline
    def setReplicationInstancePublicIps(value: Input[js.Array[Input[String]]]): Self = this.set("replicationInstancePublicIps", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteReplicationInstancePublicIps: Self = this.set("replicationInstancePublicIps", js.undefined)
    @scala.inline
