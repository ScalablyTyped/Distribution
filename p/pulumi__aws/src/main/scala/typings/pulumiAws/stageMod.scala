...
object stageMod {
  ...
  trait StageArgs extends StObject {
    ...
    /**
      ...
      * Use the `aws.apigateway.Account` resource to configure [permissions for CloudWatch Logging](https://docs.aws.amazon.com/apigateway/latest/developerguide/set-up-logging.html#set-up-access-logging-permissions).
      */
    val accessLogSettings: js.UndefOr[Input[typings.pulumiAws.inputMod.apigatewayv2.StageAccessLogSettings]] = js.native
    ...
    /**
      * The default route settings for the stage.
      */
    val defaultRouteSettings: js.UndefOr[Input[typings.pulumiAws.inputMod.apigatewayv2.StageDefaultRouteSettings]] = js.native
