...
object proxyMod {
  ...
  trait ProxyArgs extends StObject {
    ...
    /**
      * Configuration block(s) with authorization mechanisms to connect to the associated instances or clusters. Described below.
      */
    val auths: Input[js.Array[Input[typings.pulumiAws.inputMod.rds.ProxyAuth]]] = js.native
  ...
  trait ProxyState extends StObject {
    ...
    /**
      * Configuration block(s) with authorization mechanisms to connect to the associated instances or clusters. Described below.
      */
    val auths: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.rds.ProxyAuth]]]] = js.native
