...
object GangliaLayerState {
  ...
  @scala.inline
  implicit class GangliaLayerStateOps[Self <: GangliaLayerState] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEbsVolumesVarargs(value: Input[GangliaLayerEbsVolume]*): Self = this.set("ebsVolumes", js.Array(value :_*))
    @scala.inline
    def setEbsVolumes(value: Input[js.Array[Input[GangliaLayerEbsVolume]]]): Self = this.set("ebsVolumes", value.asInstanceOf[js.Any])
    @scala.inline
