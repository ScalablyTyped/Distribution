...
object MysqlLayerArgs {
  @scala.inline
  def apply(stackId: Input[String]): MysqlLayerArgs = {
    val __obj = js.Dynamic.literal(stackId = stackId.asInstanceOf[js.Any])
    __obj.asInstanceOf[MysqlLayerArgs]
  }
  @scala.inline
  implicit class MysqlLayerArgsOps[Self <: MysqlLayerArgs] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEbsVolumesVarargs(value: Input[MysqlLayerEbsVolume]*): Self = this.set("ebsVolumes", js.Array(value :_*))
    @scala.inline
    def setEbsVolumes(value: Input[js.Array[Input[MysqlLayerEbsVolume]]]): Self = this.set("ebsVolumes", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRootPassword(value: Input[String]): Self = this.set("rootPassword", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRootPassword: Self = this.set("rootPassword", js.undefined)
    @scala.inline
    def setRootPasswordOnAllInstances(value: Input[Boolean]): Self = this.set("rootPasswordOnAllInstances", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRootPasswordOnAllInstances: Self = this.set("rootPasswordOnAllInstances", js.undefined)
    @scala.inline
