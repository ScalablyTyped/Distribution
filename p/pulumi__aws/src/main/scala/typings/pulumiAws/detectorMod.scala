...
object detectorMod {
  ...
  object Detector {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): Detector = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[Detector]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): Detector = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Detector]
    inline def get(name: String, id: Input[ID], state: DetectorState): Detector = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Detector]
    inline def get(name: String, id: Input[ID], state: DetectorState, opts: CustomResourceOptions): Detector = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Detector]
  ...
  object DetectorArgs {
    ...
    inline def apply(): DetectorArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DetectorArgs]
    }
    
    extension [Self <: DetectorArgs](x: Self) {
      
      inline def setEnable(value: Input[Boolean]): Self = StObject.set(x, "enable", value.asInstanceOf[js.Any])
      
      inline def setEnableUndefined: Self = StObject.set(x, "enable", js.undefined)
      
      inline def setFindingPublishingFrequency(value: Input[String]): Self = StObject.set(x, "findingPublishingFrequency", value.asInstanceOf[js.Any])
  ...
  object DetectorState {
    ...
    inline def apply(): DetectorState = {
      val __obj = js.Dynamic.literal()
