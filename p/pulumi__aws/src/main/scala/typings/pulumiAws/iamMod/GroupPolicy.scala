...
object GroupPolicy {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.groupPolicyMod.GroupPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.groupPolicyMod.GroupPolicy]
  @scala.inline
  ...
  @scala.inline
  def get(name: String, id: Input[ID], state: GroupPolicyState): typings.pulumiAws.groupPolicyMod.GroupPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.groupPolicyMod.GroupPolicy]
  @scala.inline
