...
object AccountPasswordPolicy {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiAws.accountPasswordPolicyMod.AccountPasswordPolicy = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.accountPasswordPolicyMod.AccountPasswordPolicy]
