...
object AccessKey {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiAws.accessKeyMod.AccessKey = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.accessKeyMod.AccessKey]
  @scala.inline
  ...
  @scala.inline
  def get(name: String, id: Input[ID], state: AccessKeyState): typings.pulumiAws.accessKeyMod.AccessKey = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiAws.accessKeyMod.AccessKey]
  @scala.inline
