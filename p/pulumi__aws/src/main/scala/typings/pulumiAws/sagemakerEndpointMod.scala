...
object sagemakerEndpointMod {
  ...
  object EndpointArgs {
    ...
    inline def apply(endpointConfigName: Input[String]): EndpointArgs = {
    ...
    extension [Self <: EndpointArgs](x: Self) {
      ...
      inline def setEndpointConfigName(value: Input[String]): Self = StObject.set(x, "endpointConfigName", value.asInstanceOf[js.Any])
