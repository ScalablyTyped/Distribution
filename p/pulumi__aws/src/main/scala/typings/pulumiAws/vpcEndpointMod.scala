...
object vpcEndpointMod {
  ...
  object VpcEndpoint {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): VpcEndpoint = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[VpcEndpoint]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): VpcEndpoint = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[VpcEndpoint]
    inline def get(name: String, id: Input[ID], state: VpcEndpointState): VpcEndpoint = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[VpcEndpoint]
    inline def get(name: String, id: Input[ID], state: VpcEndpointState, opts: CustomResourceOptions): VpcEndpoint = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[VpcEndpoint]
    
    /**
      * Returns true if the given object is an instance of VpcEndpoint.  This is designed to work even
      * when multiple copies of the Pulumi SDK have been loaded into the same process.
      */
    inline def isInstance(obj: js.Any): /* is @pulumi/aws.@pulumi/aws/ec2/vpcEndpoint.VpcEndpoint */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/aws.@pulumi/aws/ec2/vpcEndpoint.VpcEndpoint */ Boolean]
  }
  ...
  object VpcEndpointArgs {
    ...
    inline def apply(serviceName: Input[String], vpcId: Input[String]): VpcEndpointArgs = {
    ...
    extension [Self <: VpcEndpointArgs](x: Self) {
      ...
      inline def setPrivateDnsEnabled(value: Input[Boolean]): Self = StObject.set(x, "privateDnsEnabled", value.asInstanceOf[js.Any])
      
      inline def setPrivateDnsEnabledUndefined: Self = StObject.set(x, "privateDnsEnabled", js.undefined)
      
      inline def setRouteTableIds(value: Input[js.Array[Input[String]]]): Self = StObject.set(x, "routeTableIds", value.asInstanceOf[js.Any])
      
      inline def setRouteTableIdsUndefined: Self = StObject.set(x, "routeTableIds", js.undefined)
      
      inline def setRouteTableIdsVarargs(value: Input[String]*): Self = StObject.set(x, "routeTableIds", js.Array(value :_*))
      ...
      inline def setVpcEndpointType(value: Input[String]): Self = StObject.set(x, "vpcEndpointType", value.asInstanceOf[js.Any])
  ...
  object VpcEndpointState {
    ...
    inline def apply(): VpcEndpointState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[VpcEndpointState]
    }
    
    extension [Self <: VpcEndpointState](x: Self) {
      ...
      inline def setDnsEntries(value: Input[js.Array[Input[typings.pulumiAws.inputMod.ec2.VpcEndpointDnsEntry]]]): Self = StObject.set(x, "dnsEntries", value.asInstanceOf[js.Any])
      
      inline def setDnsEntriesUndefined: Self = StObject.set(x, "dnsEntries", js.undefined)
      
      inline def setDnsEntriesVarargs(value: Input[typings.pulumiAws.inputMod.ec2.VpcEndpointDnsEntry]*): Self = StObject.set(x, "dnsEntries", js.Array(value :_*))
      ...
      inline def setPrefixListId(value: Input[String]): Self = StObject.set(x, "prefixListId", value.asInstanceOf[js.Any])
      ...
      inline def setRequesterManaged(value: Input[Boolean]): Self = StObject.set(x, "requesterManaged", value.asInstanceOf[js.Any])
