...
object phpAppLayerMod {
  ...
  object PhpAppLayer {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): PhpAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[PhpAppLayer]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): PhpAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PhpAppLayer]
    inline def get(name: String, id: Input[ID], state: PhpAppLayerState): PhpAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[PhpAppLayer]
    inline def get(name: String, id: Input[ID], state: PhpAppLayerState, opts: CustomResourceOptions): PhpAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PhpAppLayer]
  ...
  object PhpAppLayerArgs {
    ...
    inline def apply(stackId: Input[String]): PhpAppLayerArgs = {
      val __obj = js.Dynamic.literal(stackId = stackId.asInstanceOf[js.Any])
      __obj.asInstanceOf[PhpAppLayerArgs]
    }
    
    extension [Self <: PhpAppLayerArgs](x: Self) {
      ...
      inline def setEbsVolumes(value: Input[js.Array[Input[typings.pulumiAws.inputMod.opsworks.PhpAppLayerEbsVolume]]]): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      inline def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      inline def setEbsVolumesVarargs(value: Input[typings.pulumiAws.inputMod.opsworks.PhpAppLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
  ...
  object PhpAppLayerState {
    ...
    inline def apply(): PhpAppLayerState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PhpAppLayerState]
    }
    
    extension [Self <: PhpAppLayerState](x: Self) {
