...
object phpAppLayerMod {
  ...
  object PhpAppLayer {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/opsworks/phpAppLayer", "PhpAppLayer.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/opsworks/phpAppLayer", "PhpAppLayer.isInstance")
    @js.native
  ...
  trait PhpAppLayerArgs extends StObject {
    ...
    /**
      * `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
      */
    val ebsVolumes: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.opsworks.PhpAppLayerEbsVolume]]]] = js.native
