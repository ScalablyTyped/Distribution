...
import typings.pulumiAws.outputMod.opsworks.PhpAppLayerEbsVolume
...
object phpAppLayerMod {
  ...
  object PhpAppLayer {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): PhpAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[PhpAppLayer]
    @scala.inline
    def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): PhpAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PhpAppLayer]
    @scala.inline
    def get(name: String, id: Input[ID], state: PhpAppLayerState): PhpAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[PhpAppLayer]
    @scala.inline
    def get(name: String, id: Input[ID], state: PhpAppLayerState, opts: CustomResourceOptions): PhpAppLayer = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PhpAppLayer]
  ...
  trait PhpAppLayerArgs extends StObject {
    ...
    /**
      * `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
      */
    val ebsVolumes: js.UndefOr[Input[js.Array[Input[typings.pulumiAws.inputMod.opsworks.PhpAppLayerEbsVolume]]]] = js.undefined
  ...
  object PhpAppLayerArgs {
    ...
    @scala.inline
    def apply(stackId: Input[String]): PhpAppLayerArgs = {
      val __obj = js.Dynamic.literal(stackId = stackId.asInstanceOf[js.Any])
      __obj.asInstanceOf[PhpAppLayerArgs]
    }
    
    @scala.inline
    implicit class PhpAppLayerArgsMutableBuilder[Self <: PhpAppLayerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEbsVolumes(value: Input[js.Array[Input[typings.pulumiAws.inputMod.opsworks.PhpAppLayerEbsVolume]]]): Self = StObject.set(x, "ebsVolumes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setEbsVolumesUndefined: Self = StObject.set(x, "ebsVolumes", js.undefined)
      
      @scala.inline
      def setEbsVolumesVarargs(value: Input[typings.pulumiAws.inputMod.opsworks.PhpAppLayerEbsVolume]*): Self = StObject.set(x, "ebsVolumes", js.Array(value :_*))
  ...
  trait PhpAppLayerState extends StObject {
  ...
  object PhpAppLayerState {
    ...
    @scala.inline
    implicit class PhpAppLayerStateMutableBuilder[Self <: PhpAppLayerState] (val x: Self) extends AnyVal {
