...
object targetGroupMod {
  ...
  object TargetGroup {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/alb/targetGroup", "TargetGroup.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/aws/alb/targetGroup", "TargetGroup.isInstance")
    @js.native
  ...
  trait TargetGroupArgs extends StObject {
    ...
    /**
      * A Health Check block. Health Check blocks are documented below.
      */
    val healthCheck: js.UndefOr[Input[typings.pulumiAws.inputMod.alb.TargetGroupHealthCheck]] = js.native
    ...
    /**
      * A Stickiness block. Stickiness blocks are documented below.
      */
    val stickiness: js.UndefOr[Input[typings.pulumiAws.inputMod.alb.TargetGroupStickiness]] = js.native
  ...
  object TargetGroupArgs {
    ...
    implicit class TargetGroupArgsMutableBuilder[Self <: TargetGroupArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHealthCheck(value: Input[typings.pulumiAws.inputMod.alb.TargetGroupHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setStickiness(value: Input[typings.pulumiAws.inputMod.alb.TargetGroupStickiness]): Self = StObject.set(x, "stickiness", value.asInstanceOf[js.Any])
