...
import typings.pulumiAws.outputMod.alb.TargetGroupHealthCheck
import typings.pulumiAws.outputMod.alb.TargetGroupStickiness
...
object targetGroupMod {
  ...
  trait TargetGroupArgs extends StObject {
    ...
    /**
      * A Health Check block. Health Check blocks are documented below.
      */
    val healthCheck: js.UndefOr[Input[typings.pulumiAws.inputMod.alb.TargetGroupHealthCheck]] = js.undefined
    ...
    /**
      * A Stickiness block. Stickiness blocks are documented below.
      */
    val stickiness: js.UndefOr[Input[typings.pulumiAws.inputMod.alb.TargetGroupStickiness]] = js.undefined
  ...
  object TargetGroupArgs {
    ...
    extension [Self <: TargetGroupArgs](x: Self) {
      ...
      inline def setHealthCheck(value: Input[typings.pulumiAws.inputMod.alb.TargetGroupHealthCheck]): Self = StObject.set(x, "healthCheck", value.asInstanceOf[js.Any])
      ...
      inline def setStickiness(value: Input[typings.pulumiAws.inputMod.alb.TargetGroupStickiness]): Self = StObject.set(x, "stickiness", value.asInstanceOf[js.Any])
