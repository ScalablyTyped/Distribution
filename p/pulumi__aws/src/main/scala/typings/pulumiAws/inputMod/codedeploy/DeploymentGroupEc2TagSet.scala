...
object DeploymentGroupEc2TagSet {
  ...
  extension [Self <: DeploymentGroupEc2TagSet](x: Self) {
    ...
    inline def setEc2TagFilters(value: Input[js.Array[Input[DeploymentGroupEc2TagSetEc2TagFilter]]]): Self = StObject.set(x, "ec2TagFilters", value.asInstanceOf[js.Any])
    
    inline def setEc2TagFiltersUndefined: Self = StObject.set(x, "ec2TagFilters", js.undefined)
    
    inline def setEc2TagFiltersVarargs(value: Input[DeploymentGroupEc2TagSetEc2TagFilter]*): Self = StObject.set(x, "ec2TagFilters", js.Array(value :_*))
  }
}
