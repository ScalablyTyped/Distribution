...
trait ClusterMasterInstanceFleetInstanceTypeConfig extends StObject {
  ...
  /**
    ...
    */
  var ebsConfigs: js.UndefOr[Input[js.Array[Input[ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig]]]] = js.undefined
...
object ClusterMasterInstanceFleetInstanceTypeConfig {
  ...
  inline def apply(instanceType: Input[String]): ClusterMasterInstanceFleetInstanceTypeConfig = {
  ...
  extension [Self <: ClusterMasterInstanceFleetInstanceTypeConfig](x: Self) {
    ...
    inline def setConfigurations(value: Input[js.Array[Input[ClusterMasterInstanceFleetInstanceTypeConfigConfiguration]]]): Self = StObject.set(x, "configurations", value.asInstanceOf[js.Any])
    
    inline def setConfigurationsUndefined: Self = StObject.set(x, "configurations", js.undefined)
    
    inline def setConfigurationsVarargs(value: Input[ClusterMasterInstanceFleetInstanceTypeConfigConfiguration]*): Self = StObject.set(x, "configurations", js.Array(value :_*))
    
    inline def setEbsConfigs(value: Input[js.Array[Input[ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig]]]): Self = StObject.set(x, "ebsConfigs", value.asInstanceOf[js.Any])
    
    inline def setEbsConfigsUndefined: Self = StObject.set(x, "ebsConfigs", js.undefined)
    
    inline def setEbsConfigsVarargs(value: Input[ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig]*): Self = StObject.set(x, "ebsConfigs", js.Array(value :_*))
