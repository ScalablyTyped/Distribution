...
object RouteSpecGrpcRouteRetryPolicy {
  ...
  inline def apply(maxRetries: Input[Double], perRetryTimeout: Input[RouteSpecGrpcRouteRetryPolicyPerRetryTimeout]): RouteSpecGrpcRouteRetryPolicy = {
  ...
  extension [Self <: RouteSpecGrpcRouteRetryPolicy](x: Self) {
    
    inline def setGrpcRetryEvents(value: Input[js.Array[Input[String]]]): Self = StObject.set(x, "grpcRetryEvents", value.asInstanceOf[js.Any])
    
    inline def setGrpcRetryEventsUndefined: Self = StObject.set(x, "grpcRetryEvents", js.undefined)
    
    inline def setGrpcRetryEventsVarargs(value: Input[String]*): Self = StObject.set(x, "grpcRetryEvents", js.Array(value :_*))
    ...
    inline def setPerRetryTimeout(value: Input[RouteSpecGrpcRouteRetryPolicyPerRetryTimeout]): Self = StObject.set(x, "perRetryTimeout", value.asInstanceOf[js.Any])
