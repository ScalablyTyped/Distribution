...
object InstanceRestoreToPointInTime {
  ...
  implicit class InstanceRestoreToPointInTimeOps[Self <: InstanceRestoreToPointInTime] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRestoreTime(value: Input[String]): Self = this.set("restoreTime", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRestoreTime: Self = this.set("restoreTime", js.undefined)
    
    @scala.inline
    def setSourceDbInstanceIdentifier(value: Input[String]): Self = this.set("sourceDbInstanceIdentifier", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSourceDbInstanceIdentifier: Self = this.set("sourceDbInstanceIdentifier", js.undefined)
    
    @scala.inline
    def setSourceDbiResourceId(value: Input[String]): Self = this.set("sourceDbiResourceId", value.asInstanceOf[js.Any])
