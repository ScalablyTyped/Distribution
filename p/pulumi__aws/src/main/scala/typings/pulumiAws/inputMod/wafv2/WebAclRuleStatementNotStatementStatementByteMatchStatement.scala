...
trait WebAclRuleStatementNotStatementStatementByteMatchStatement extends js.Object {
  ...
  /**
    ...
    */
  var fieldToMatch: js.UndefOr[Input[WebAclRuleStatementNotStatementStatementByteMatchStatementFieldToMatch]] = js.native
...
object WebAclRuleStatementNotStatementStatementByteMatchStatement {
  ...
  implicit class WebAclRuleStatementNotStatementStatementByteMatchStatementOps[Self <: WebAclRuleStatementNotStatementStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextTransformationsVarargs(value: Input[WebAclRuleStatementNotStatementStatementByteMatchStatementTextTransformation]*): Self = this.set("textTransformations", js.Array(value :_*))
    ...
    @scala.inline
    def setFieldToMatch(value: Input[WebAclRuleStatementNotStatementStatementByteMatchStatementFieldToMatch]): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
