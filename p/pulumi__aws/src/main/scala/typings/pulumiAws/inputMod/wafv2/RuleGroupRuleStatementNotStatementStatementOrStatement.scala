...
object RuleGroupRuleStatementNotStatementStatementOrStatement {
  ...
  implicit class RuleGroupRuleStatementNotStatementStatementOrStatementOps[Self <: RuleGroupRuleStatementNotStatementStatementOrStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStatementsVarargs(value: Input[RuleGroupRuleStatementNotStatementStatementOrStatementStatement]*): Self = this.set("statements", js.Array(value :_*))
    
    @scala.inline
    def setStatements(value: Input[js.Array[Input[RuleGroupRuleStatementNotStatementStatementOrStatementStatement]]]): Self = this.set("statements", value.asInstanceOf[js.Any])
  }
}
