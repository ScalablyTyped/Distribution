...
object RuleGroupRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatch {
  ...
  inline def apply(): RuleGroupRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RuleGroupRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatch]
  }
  
  extension [Self <: RuleGroupRuleStatementOrStatementStatementAndStatementStatementXssMatchStatementFieldToMatch](x: Self) {
