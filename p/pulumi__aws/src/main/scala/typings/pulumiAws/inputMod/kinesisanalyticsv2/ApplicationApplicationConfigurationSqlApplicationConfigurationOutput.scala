...
object ApplicationApplicationConfigurationSqlApplicationConfigurationOutput {
  ...
  extension [Self <: ApplicationApplicationConfigurationSqlApplicationConfigurationOutput](x: Self) {
    ...
    inline def setDestinationSchema(
      value: Input[
          ApplicationApplicationConfigurationSqlApplicationConfigurationOutputDestinationSchema
        ]
    ): Self = StObject.set(x, "destinationSchema", value.asInstanceOf[js.Any])
    
    inline def setKinesisFirehoseOutput(
      value: Input[
          ApplicationApplicationConfigurationSqlApplicationConfigurationOutputKinesisFirehoseOutput
        ]
    ...
    inline def setKinesisStreamsOutput(
      value: Input[
          ApplicationApplicationConfigurationSqlApplicationConfigurationOutputKinesisStreamsOutput
        ]
    ...
    inline def setLambdaOutput(value: Input[ApplicationApplicationConfigurationSqlApplicationConfigurationOutputLambdaOutput]): Self = StObject.set(x, "lambdaOutput", value.asInstanceOf[js.Any])
    
    inline def setLambdaOutputUndefined: Self = StObject.set(x, "lambdaOutput", js.undefined)
    
    inline def setName(value: Input[String]): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    
    inline def setOutputId(value: Input[String]): Self = StObject.set(x, "outputId", value.asInstanceOf[js.Any])
