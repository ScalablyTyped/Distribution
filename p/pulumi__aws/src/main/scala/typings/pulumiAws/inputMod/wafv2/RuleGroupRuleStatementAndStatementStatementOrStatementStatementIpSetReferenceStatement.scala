...
object RuleGroupRuleStatementAndStatementStatementOrStatementStatementIpSetReferenceStatement {
  ...
  inline def apply(arn: Input[String]): RuleGroupRuleStatementAndStatementStatementOrStatementStatementIpSetReferenceStatement = {
    val __obj = js.Dynamic.literal(arn = arn.asInstanceOf[js.Any])
    __obj.asInstanceOf[RuleGroupRuleStatementAndStatementStatementOrStatementStatementIpSetReferenceStatement]
  }
  
  extension [Self <: RuleGroupRuleStatementAndStatementStatementOrStatementStatementIpSetReferenceStatement](x: Self) {
