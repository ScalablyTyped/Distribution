...
object WebAclRuleStatementNotStatementStatementSizeConstraintStatement {
  ...
  extension [Self <: WebAclRuleStatementNotStatementStatementSizeConstraintStatement](x: Self) {
    ...
    inline def setFieldToMatch(value: Input[WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatch]): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
