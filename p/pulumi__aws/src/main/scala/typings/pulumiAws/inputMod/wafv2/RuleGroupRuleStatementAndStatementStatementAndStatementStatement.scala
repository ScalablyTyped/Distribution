...
object RuleGroupRuleStatementAndStatementStatementAndStatementStatement {
  ...
  inline def apply(): RuleGroupRuleStatementAndStatementStatementAndStatementStatement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RuleGroupRuleStatementAndStatementStatementAndStatementStatement]
  }
  
  extension [Self <: RuleGroupRuleStatementAndStatementStatementAndStatementStatement](x: Self) {
