...
object WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatch {
  ...
  inline def apply(): WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatch]
  }
  
  extension [Self <: WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatch](x: Self) {
    ...
    inline def setBody(value: Input[WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchBody]): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
    
    inline def setBodyUndefined: Self = StObject.set(x, "body", js.undefined)
    
    inline def setMethod(value: Input[WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchMethod]): Self = StObject.set(x, "method", value.asInstanceOf[js.Any])
    
    inline def setMethodUndefined: Self = StObject.set(x, "method", js.undefined)
    
    inline def setQueryString(value: Input[WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchQueryString]): Self = StObject.set(x, "queryString", value.asInstanceOf[js.Any])
    
    inline def setQueryStringUndefined: Self = StObject.set(x, "queryString", js.undefined)
    
    inline def setSingleHeader(value: Input[WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchSingleHeader]): Self = StObject.set(x, "singleHeader", value.asInstanceOf[js.Any])
    ...
    inline def setUriPath(value: Input[WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchUriPath]): Self = StObject.set(x, "uriPath", value.asInstanceOf[js.Any])
