...
object ApplicationApplicationConfigurationFlinkApplicationConfigurationCheckpointConfiguration {
  ...
  inline def apply(configurationType: Input[String]): ApplicationApplicationConfigurationFlinkApplicationConfigurationCheckpointConfiguration = {
  ...
  extension [Self <: ApplicationApplicationConfigurationFlinkApplicationConfigurationCheckpointConfiguration](x: Self) {
    ...
    inline def setCheckpointInterval(value: Input[Double]): Self = StObject.set(x, "checkpointInterval", value.asInstanceOf[js.Any])
    
    inline def setCheckpointIntervalUndefined: Self = StObject.set(x, "checkpointInterval", js.undefined)
    
    inline def setCheckpointingEnabled(value: Input[Boolean]): Self = StObject.set(x, "checkpointingEnabled", value.asInstanceOf[js.Any])
    ...
    inline def setMinPauseBetweenCheckpoints(value: Input[Double]): Self = StObject.set(x, "minPauseBetweenCheckpoints", value.asInstanceOf[js.Any])
