...
trait VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrust extends StObject {
  ...
  /**
    ...
    */
  var acm: js.UndefOr[Input[VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustAcm]] = js.undefined
  
  /**
    * The TLS validation context trust for a local file.
    */
  var file: js.UndefOr[Input[VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustFile]] = js.undefined
}
object VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrust {
  ...
  extension [Self <: VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrust](x: Self) {
    ...
    inline def setAcm(value: Input[VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustAcm]): Self = StObject.set(x, "acm", value.asInstanceOf[js.Any])
    
    inline def setAcmUndefined: Self = StObject.set(x, "acm", js.undefined)
    
    inline def setFile(value: Input[VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustFile]): Self = StObject.set(x, "file", value.asInstanceOf[js.Any])
