...
object globalaccelerator {
  ...
  object AcceleratorAttributes {
    ...
    extension [Self <: AcceleratorAttributes](x: Self) {
      ...
      inline def setFlowLogsEnabled(value: Input[Boolean]): Self = StObject.set(x, "flowLogsEnabled", value.asInstanceOf[js.Any])
      
      inline def setFlowLogsEnabledUndefined: Self = StObject.set(x, "flowLogsEnabled", js.undefined)
      
      inline def setFlowLogsS3Bucket(value: Input[String]): Self = StObject.set(x, "flowLogsS3Bucket", value.asInstanceOf[js.Any])
      
      inline def setFlowLogsS3BucketUndefined: Self = StObject.set(x, "flowLogsS3Bucket", js.undefined)
      
      inline def setFlowLogsS3Prefix(value: Input[String]): Self = StObject.set(x, "flowLogsS3Prefix", value.asInstanceOf[js.Any])
  ...
  object AcceleratorIpSet {
    ...
    inline def apply(): AcceleratorIpSet = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: AcceleratorIpSet](x: Self) {
      ...
      inline def setIpAddresses(value: Input[js.Array[Input[String]]]): Self = StObject.set(x, "ipAddresses", value.asInstanceOf[js.Any])
      
      inline def setIpAddressesUndefined: Self = StObject.set(x, "ipAddresses", js.undefined)
      
      inline def setIpAddressesVarargs(value: Input[String]*): Self = StObject.set(x, "ipAddresses", js.Array(value :_*))
  ...
  trait EndpointGroupEndpointConfiguration extends StObject {
    ...
    var clientIpPreservationEnabled: js.UndefOr[Input[Boolean]] = js.undefined
  ...
  object EndpointGroupEndpointConfiguration {
    ...
    inline def apply(): EndpointGroupEndpointConfiguration = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: EndpointGroupEndpointConfiguration](x: Self) {
      ...
      inline def setClientIpPreservationEnabled(value: Input[Boolean]): Self = StObject.set(x, "clientIpPreservationEnabled", value.asInstanceOf[js.Any])
  ...
  trait EndpointGroupPortOverride extends StObject {
    ...
    /**
      ...
      */
    var endpointPort: Input[Double]
    
    /**
      * The listener port that you want to map to a specific endpoint port. This is the port that user traffic arrives to the Global Accelerator on.
      */
    var listenerPort: Input[Double]
  }
  object EndpointGroupPortOverride {
    
    inline def apply(endpointPort: Input[Double], listenerPort: Input[Double]): EndpointGroupPortOverride = {
    ...
    extension [Self <: EndpointGroupPortOverride](x: Self) {
      ...
      inline def setEndpointPort(value: Input[Double]): Self = StObject.set(x, "endpointPort", value.asInstanceOf[js.Any])
      
      inline def setListenerPort(value: Input[Double]): Self = StObject.set(x, "listenerPort", value.asInstanceOf[js.Any])
    }
  }
