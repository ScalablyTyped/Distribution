...
trait WebAclRuleStatementRateBasedStatement extends StObject {
  ...
  /**
    ...
    */
  var aggregateKeyType: js.UndefOr[Input[String]] = js.undefined
  ...
  /**
    ...
    */
  var forwardedIpConfig: js.UndefOr[Input[WebAclRuleStatementRateBasedStatementForwardedIpConfig]] = js.undefined
  ...
  /**
    ...
    */
  var scopeDownStatement: js.UndefOr[Input[WebAclRuleStatementRateBasedStatementScopeDownStatement]] = js.undefined
}
object WebAclRuleStatementRateBasedStatement {
  
  inline def apply(limit: Input[Double]): WebAclRuleStatementRateBasedStatement = {
  ...
  extension [Self <: WebAclRuleStatementRateBasedStatement](x: Self) {
    ...
    inline def setAggregateKeyType(value: Input[String]): Self = StObject.set(x, "aggregateKeyType", value.asInstanceOf[js.Any])
    
    inline def setAggregateKeyTypeUndefined: Self = StObject.set(x, "aggregateKeyType", js.undefined)
    
    inline def setForwardedIpConfig(value: Input[WebAclRuleStatementRateBasedStatementForwardedIpConfig]): Self = StObject.set(x, "forwardedIpConfig", value.asInstanceOf[js.Any])
    ...
    inline def setScopeDownStatement(value: Input[WebAclRuleStatementRateBasedStatementScopeDownStatement]): Self = StObject.set(x, "scopeDownStatement", value.asInstanceOf[js.Any])
