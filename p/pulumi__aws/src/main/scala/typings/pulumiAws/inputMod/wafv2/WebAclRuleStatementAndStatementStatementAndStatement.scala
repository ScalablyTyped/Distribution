...
object WebAclRuleStatementAndStatementStatementAndStatement {
  ...
  implicit class WebAclRuleStatementAndStatementStatementAndStatementOps[Self <: WebAclRuleStatementAndStatementStatementAndStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStatementsVarargs(value: Input[WebAclRuleStatementAndStatementStatementAndStatementStatement]*): Self = this.set("statements", js.Array(value :_*))
    
    @scala.inline
    def setStatements(value: Input[js.Array[Input[WebAclRuleStatementAndStatementStatementAndStatementStatement]]]): Self = this.set("statements", value.asInstanceOf[js.Any])
  }
}
