...
object pinpoint {
  ...
  object AppCampaignHook {
    ...
    extension [Self <: AppCampaignHook](x: Self) {
      ...
      inline def setLambdaFunctionName(value: Input[String]): Self = StObject.set(x, "lambdaFunctionName", value.asInstanceOf[js.Any])
      ...
      inline def setWebUrl(value: Input[String]): Self = StObject.set(x, "webUrl", value.asInstanceOf[js.Any])
  ...
  object AppLimits {
    ...
    extension [Self <: AppLimits](x: Self) {
      ...
      inline def setDaily(value: Input[Double]): Self = StObject.set(x, "daily", value.asInstanceOf[js.Any])
      
      inline def setDailyUndefined: Self = StObject.set(x, "daily", js.undefined)
      
      inline def setMaximumDuration(value: Input[Double]): Self = StObject.set(x, "maximumDuration", value.asInstanceOf[js.Any])
      ...
      inline def setTotal(value: Input[Double]): Self = StObject.set(x, "total", value.asInstanceOf[js.Any])
  ...
  object AppQuietTime {
    ...
    extension [Self <: AppQuietTime](x: Self) {
      ...
      inline def setEnd(value: Input[String]): Self = StObject.set(x, "end", value.asInstanceOf[js.Any])
      
      inline def setEndUndefined: Self = StObject.set(x, "end", js.undefined)
      
      inline def setStart(value: Input[String]): Self = StObject.set(x, "start", value.asInstanceOf[js.Any])
