...
object RecordGeolocationRoutingPolicy {
  ...
  implicit class RecordGeolocationRoutingPolicyOps[Self <: RecordGeolocationRoutingPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContinent(value: Input[String]): Self = this.set("continent", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSubdivision(value: Input[String]): Self = this.set("subdivision", value.asInstanceOf[js.Any])
    @scala.inline
