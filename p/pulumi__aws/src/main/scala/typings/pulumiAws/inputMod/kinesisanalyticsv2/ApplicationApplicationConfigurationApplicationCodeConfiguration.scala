...
object ApplicationApplicationConfigurationApplicationCodeConfiguration {
  ...
  implicit class ApplicationApplicationConfigurationApplicationCodeConfigurationOps[Self <: ApplicationApplicationConfigurationApplicationCodeConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCodeContentType(value: Input[String]): Self = this.set("codeContentType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCodeContent(value: Input[ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContent]): Self = this.set("codeContent", value.asInstanceOf[js.Any])
