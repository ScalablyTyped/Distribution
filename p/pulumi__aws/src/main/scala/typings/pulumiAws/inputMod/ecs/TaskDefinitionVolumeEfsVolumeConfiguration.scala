...
trait TaskDefinitionVolumeEfsVolumeConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var authorizationConfig: js.UndefOr[Input[TaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfig]] = js.native
  ...
  /**
    ...
    */
  var transitEncryption: js.UndefOr[Input[String]] = js.native
  ...
  /**
    ...
    */
  var transitEncryptionPort: js.UndefOr[Input[Double]] = js.native
}
object TaskDefinitionVolumeEfsVolumeConfiguration {
  ...
  implicit class TaskDefinitionVolumeEfsVolumeConfigurationOps[Self <: TaskDefinitionVolumeEfsVolumeConfiguration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAuthorizationConfig(value: Input[TaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfig]): Self = this.set("authorizationConfig", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAuthorizationConfig: Self = this.set("authorizationConfig", js.undefined)
    
    @scala.inline
    def setRootDirectory(value: Input[String]): Self = this.set("rootDirectory", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRootDirectory: Self = this.set("rootDirectory", js.undefined)
    
    @scala.inline
    def setTransitEncryption(value: Input[String]): Self = this.set("transitEncryption", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTransitEncryption: Self = this.set("transitEncryption", js.undefined)
    
    @scala.inline
    def setTransitEncryptionPort(value: Input[Double]): Self = this.set("transitEncryptionPort", value.asInstanceOf[js.Any])
