...
object UserPoolLambdaConfig {
  ...
  implicit class UserPoolLambdaConfigMutableBuilder[Self <: UserPoolLambdaConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreateAuthChallenge(value: Input[String]): Self = StObject.set(x, "createAuthChallenge", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCreateAuthChallengeUndefined: Self = StObject.set(x, "createAuthChallenge", js.undefined)
    
    @scala.inline
    def setCustomMessage(value: Input[String]): Self = StObject.set(x, "customMessage", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCustomMessageUndefined: Self = StObject.set(x, "customMessage", js.undefined)
    
    @scala.inline
    def setDefineAuthChallenge(value: Input[String]): Self = StObject.set(x, "defineAuthChallenge", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefineAuthChallengeUndefined: Self = StObject.set(x, "defineAuthChallenge", js.undefined)
    
    @scala.inline
    def setPostAuthentication(value: Input[String]): Self = StObject.set(x, "postAuthentication", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPostAuthenticationUndefined: Self = StObject.set(x, "postAuthentication", js.undefined)
    
    @scala.inline
    def setPostConfirmation(value: Input[String]): Self = StObject.set(x, "postConfirmation", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPostConfirmationUndefined: Self = StObject.set(x, "postConfirmation", js.undefined)
    
    @scala.inline
    def setPreAuthentication(value: Input[String]): Self = StObject.set(x, "preAuthentication", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPreAuthenticationUndefined: Self = StObject.set(x, "preAuthentication", js.undefined)
    
    @scala.inline
    def setPreSignUp(value: Input[String]): Self = StObject.set(x, "preSignUp", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPreSignUpUndefined: Self = StObject.set(x, "preSignUp", js.undefined)
    
    @scala.inline
    def setPreTokenGeneration(value: Input[String]): Self = StObject.set(x, "preTokenGeneration", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPreTokenGenerationUndefined: Self = StObject.set(x, "preTokenGeneration", js.undefined)
    
    @scala.inline
    def setUserMigration(value: Input[String]): Self = StObject.set(x, "userMigration", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUserMigrationUndefined: Self = StObject.set(x, "userMigration", js.undefined)
    
    @scala.inline
    def setVerifyAuthChallengeResponse(value: Input[String]): Self = StObject.set(x, "verifyAuthChallengeResponse", value.asInstanceOf[js.Any])
