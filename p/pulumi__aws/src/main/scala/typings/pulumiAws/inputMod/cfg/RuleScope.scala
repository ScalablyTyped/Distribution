...
object RuleScope {
  ...
  implicit class RuleScopeOps[Self <: RuleScope] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComplianceResourceId(value: Input[String]): Self = this.set("complianceResourceId", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteComplianceResourceId: Self = this.set("complianceResourceId", js.undefined)
    
    @scala.inline
    def setComplianceResourceTypesVarargs(value: Input[String]*): Self = this.set("complianceResourceTypes", js.Array(value :_*))
    
    @scala.inline
    def setComplianceResourceTypes(value: Input[js.Array[Input[String]]]): Self = this.set("complianceResourceTypes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteComplianceResourceTypes: Self = this.set("complianceResourceTypes", js.undefined)
    
    @scala.inline
    def setTagKey(value: Input[String]): Self = this.set("tagKey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTagKey: Self = this.set("tagKey", js.undefined)
    
    @scala.inline
    def setTagValue(value: Input[String]): Self = this.set("tagValue", value.asInstanceOf[js.Any])
