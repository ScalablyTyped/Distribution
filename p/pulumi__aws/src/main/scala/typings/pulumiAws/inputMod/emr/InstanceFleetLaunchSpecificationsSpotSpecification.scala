...
@js.native
trait InstanceFleetLaunchSpecificationsSpotSpecification extends js.Object {
...
object InstanceFleetLaunchSpecificationsSpotSpecification {
  ...
  @scala.inline
  implicit class InstanceFleetLaunchSpecificationsSpotSpecificationOps[Self <: InstanceFleetLaunchSpecificationsSpotSpecification] (val x: Self) extends AnyVal {
