...
object WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatch {
  ...
  extension [Self <: WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatch](x: Self) {
    ...
    inline def setBody(value: Input[WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchBody]): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
    
    inline def setBodyUndefined: Self = StObject.set(x, "body", js.undefined)
    
    inline def setMethod(value: Input[WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchMethod]): Self = StObject.set(x, "method", value.asInstanceOf[js.Any])
    
    inline def setMethodUndefined: Self = StObject.set(x, "method", js.undefined)
    
    inline def setQueryString(value: Input[WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchQueryString]): Self = StObject.set(x, "queryString", value.asInstanceOf[js.Any])
    ...
    inline def setUriPath(value: Input[WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchUriPath]): Self = StObject.set(x, "uriPath", value.asInstanceOf[js.Any])
