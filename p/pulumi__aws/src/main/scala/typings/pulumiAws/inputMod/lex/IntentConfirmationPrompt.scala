...
object IntentConfirmationPrompt {
  ...
  implicit class IntentConfirmationPromptOps[Self <: IntentConfirmationPrompt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessagesVarargs(value: Input[IntentConfirmationPromptMessage]*): Self = this.set("messages", js.Array(value :_*))
    
    @scala.inline
    def setMessages(value: Input[js.Array[Input[IntentConfirmationPromptMessage]]]): Self = this.set("messages", value.asInstanceOf[js.Any])
