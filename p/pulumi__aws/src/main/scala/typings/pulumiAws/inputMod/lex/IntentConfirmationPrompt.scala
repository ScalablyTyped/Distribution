...
trait IntentConfirmationPrompt extends StObject {
  ...
  /**
    ...
    */
  var messages: Input[js.Array[Input[IntentConfirmationPromptMessage]]] = js.native
...
object IntentConfirmationPrompt {
  ...
  @scala.inline
  def apply(maxAttempts: Input[Double], messages: Input[js.Array[Input[IntentConfirmationPromptMessage]]]): IntentConfirmationPrompt = {
  ...
  implicit class IntentConfirmationPromptMutableBuilder[Self <: IntentConfirmationPrompt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessages(value: Input[js.Array[Input[IntentConfirmationPromptMessage]]]): Self = StObject.set(x, "messages", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMessagesVarargs(value: Input[IntentConfirmationPromptMessage]*): Self = StObject.set(x, "messages", js.Array(value :_*))
