...
trait WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatch extends StObject {
  ...
  /**
    ...
    */
  var body: js.UndefOr[
    Input[WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchBody]
  ] = js.native
...
object WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatch {
  ...
  implicit class WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchMutableBuilder[Self <: WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Input[WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchBody]): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
