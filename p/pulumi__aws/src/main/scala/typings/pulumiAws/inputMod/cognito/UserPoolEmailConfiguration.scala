...
object UserPoolEmailConfiguration {
  ...
  extension [Self <: UserPoolEmailConfiguration](x: Self) {
    ...
    inline def setEmailSendingAccount(value: Input[String]): Self = StObject.set(x, "emailSendingAccount", value.asInstanceOf[js.Any])
    
    inline def setEmailSendingAccountUndefined: Self = StObject.set(x, "emailSendingAccount", js.undefined)
    
    inline def setFromEmailAddress(value: Input[String]): Self = StObject.set(x, "fromEmailAddress", value.asInstanceOf[js.Any])
    
    inline def setFromEmailAddressUndefined: Self = StObject.set(x, "fromEmailAddress", js.undefined)
    
    inline def setReplyToEmailAddress(value: Input[String]): Self = StObject.set(x, "replyToEmailAddress", value.asInstanceOf[js.Any])
