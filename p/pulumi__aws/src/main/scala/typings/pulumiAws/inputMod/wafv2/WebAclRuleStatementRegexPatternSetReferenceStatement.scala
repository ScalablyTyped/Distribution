...
object WebAclRuleStatementRegexPatternSetReferenceStatement {
  ...
  implicit class WebAclRuleStatementRegexPatternSetReferenceStatementOps[Self <: WebAclRuleStatementRegexPatternSetReferenceStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextTransformationsVarargs(value: Input[WebAclRuleStatementRegexPatternSetReferenceStatementTextTransformation]*): Self = this.set("textTransformations", js.Array(value :_*))
    ...
    @scala.inline
    def setFieldToMatch(value: Input[WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatch]): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
