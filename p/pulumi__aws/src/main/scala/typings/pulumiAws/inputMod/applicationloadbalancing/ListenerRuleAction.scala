...
trait ListenerRuleAction extends StObject {
  ...
  /**
    ...
    */
  var forward: js.UndefOr[Input[ListenerRuleActionForward]] = js.undefined
...
object ListenerRuleAction {
  ...
  inline def apply(`type`: Input[String]): ListenerRuleAction = {
  ...
  extension [Self <: ListenerRuleAction](x: Self) {
    ...
    inline def setAuthenticateCognito(value: Input[ListenerRuleActionAuthenticateCognito]): Self = StObject.set(x, "authenticateCognito", value.asInstanceOf[js.Any])
    
    inline def setAuthenticateCognitoUndefined: Self = StObject.set(x, "authenticateCognito", js.undefined)
    
    inline def setAuthenticateOidc(value: Input[ListenerRuleActionAuthenticateOidc]): Self = StObject.set(x, "authenticateOidc", value.asInstanceOf[js.Any])
    
    inline def setAuthenticateOidcUndefined: Self = StObject.set(x, "authenticateOidc", js.undefined)
    
    inline def setFixedResponse(value: Input[ListenerRuleActionFixedResponse]): Self = StObject.set(x, "fixedResponse", value.asInstanceOf[js.Any])
    
    inline def setFixedResponseUndefined: Self = StObject.set(x, "fixedResponse", js.undefined)
    
    inline def setForward(value: Input[ListenerRuleActionForward]): Self = StObject.set(x, "forward", value.asInstanceOf[js.Any])
    ...
    inline def setRedirect(value: Input[ListenerRuleActionRedirect]): Self = StObject.set(x, "redirect", value.asInstanceOf[js.Any])
