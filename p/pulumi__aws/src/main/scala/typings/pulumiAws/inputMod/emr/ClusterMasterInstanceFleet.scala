...
trait ClusterMasterInstanceFleet extends StObject {
  ...
  /**
    ...
    */
  var instanceTypeConfigs: js.UndefOr[Input[js.Array[Input[ClusterMasterInstanceFleetInstanceTypeConfig]]]] = js.undefined
  
  /**
    * Configuration block for launch specification
    */
  var launchSpecifications: js.UndefOr[Input[ClusterMasterInstanceFleetLaunchSpecifications]] = js.undefined
...
object ClusterMasterInstanceFleet {
  ...
  inline def apply(): ClusterMasterInstanceFleet = {
  ...
  extension [Self <: ClusterMasterInstanceFleet](x: Self) {
    ...
    inline def setInstanceTypeConfigs(value: Input[js.Array[Input[ClusterMasterInstanceFleetInstanceTypeConfig]]]): Self = StObject.set(x, "instanceTypeConfigs", value.asInstanceOf[js.Any])
    
    inline def setInstanceTypeConfigsUndefined: Self = StObject.set(x, "instanceTypeConfigs", js.undefined)
    
    inline def setInstanceTypeConfigsVarargs(value: Input[ClusterMasterInstanceFleetInstanceTypeConfig]*): Self = StObject.set(x, "instanceTypeConfigs", js.Array(value :_*))
    
    inline def setLaunchSpecifications(value: Input[ClusterMasterInstanceFleetLaunchSpecifications]): Self = StObject.set(x, "launchSpecifications", value.asInstanceOf[js.Any])
