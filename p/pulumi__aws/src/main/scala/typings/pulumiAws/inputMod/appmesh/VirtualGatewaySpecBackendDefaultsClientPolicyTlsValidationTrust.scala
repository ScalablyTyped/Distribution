...
object VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrust {
  ...
  implicit class VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustOps[Self <: VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrust] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAcm(value: Input[VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustAcm]): Self = this.set("acm", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAcm: Self = this.set("acm", js.undefined)
    
    @scala.inline
    def setFile(value: Input[VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustFile]): Self = this.set("file", value.asInstanceOf[js.Any])
