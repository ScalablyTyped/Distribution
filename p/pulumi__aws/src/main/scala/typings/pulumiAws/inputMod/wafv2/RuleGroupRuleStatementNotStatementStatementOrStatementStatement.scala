...
object RuleGroupRuleStatementNotStatementStatementOrStatementStatement {
  ...
  inline def apply(): RuleGroupRuleStatementNotStatementStatementOrStatementStatement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RuleGroupRuleStatementNotStatementStatementOrStatementStatement]
  }
  
  extension [Self <: RuleGroupRuleStatementNotStatementStatementOrStatementStatement](x: Self) {
    ...
    inline def setGeoMatchStatement(value: Input[RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatement]): Self = StObject.set(x, "geoMatchStatement", value.asInstanceOf[js.Any])
    ...
    inline def setXssMatchStatement(value: Input[RuleGroupRuleStatementNotStatementStatementOrStatementStatementXssMatchStatement]): Self = StObject.set(x, "xssMatchStatement", value.asInstanceOf[js.Any])
