...
object RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatch {
  ...
  implicit class RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchOps[Self <: RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Input[RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchBody]): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBody: Self = this.set("body", js.undefined)
    
    @scala.inline
    def setMethod(value: Input[RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchMethod]): Self = this.set("method", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUriPath(value: Input[RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchUriPath]): Self = this.set("uriPath", value.asInstanceOf[js.Any])
