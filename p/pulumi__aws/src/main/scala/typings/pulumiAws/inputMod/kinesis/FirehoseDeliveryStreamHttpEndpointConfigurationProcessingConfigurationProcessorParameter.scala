...
@js.native
trait FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorParameter extends js.Object {
...
object FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorParameter {
  ...
  @scala.inline
  implicit class FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorParameterOps[Self <: FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorParameter] (val x: Self) extends AnyVal {
