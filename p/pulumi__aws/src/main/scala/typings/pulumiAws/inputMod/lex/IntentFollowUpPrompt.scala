...
object IntentFollowUpPrompt {
  ...
  implicit class IntentFollowUpPromptOps[Self <: IntentFollowUpPrompt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrompt(value: Input[IntentFollowUpPromptPrompt]): Self = this.set("prompt", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRejectionStatement(value: Input[IntentFollowUpPromptRejectionStatement]): Self = this.set("rejectionStatement", value.asInstanceOf[js.Any])
  }
}
