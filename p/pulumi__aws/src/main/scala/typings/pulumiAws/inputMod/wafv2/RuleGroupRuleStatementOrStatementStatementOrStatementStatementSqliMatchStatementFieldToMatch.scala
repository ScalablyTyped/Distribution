...
object RuleGroupRuleStatementOrStatementStatementOrStatementStatementSqliMatchStatementFieldToMatch {
  ...
  inline def apply(): RuleGroupRuleStatementOrStatementStatementOrStatementStatementSqliMatchStatementFieldToMatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RuleGroupRuleStatementOrStatementStatementOrStatementStatementSqliMatchStatementFieldToMatch]
  }
  
  extension [Self <: RuleGroupRuleStatementOrStatementStatementOrStatementStatementSqliMatchStatementFieldToMatch](x: Self) {
