...
object BotAbortStatement {
  ...
  implicit class BotAbortStatementOps[Self <: BotAbortStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessagesVarargs(value: Input[BotAbortStatementMessage]*): Self = this.set("messages", js.Array(value :_*))
    
    @scala.inline
    def setMessages(value: Input[js.Array[Input[BotAbortStatementMessage]]]): Self = this.set("messages", value.asInstanceOf[js.Any])
