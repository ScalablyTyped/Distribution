...
object AcceleratorAttributes {
  ...
  implicit class AcceleratorAttributesOps[Self <: AcceleratorAttributes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFlowLogsEnabled(value: Input[Boolean]): Self = this.set("flowLogsEnabled", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFlowLogsEnabled: Self = this.set("flowLogsEnabled", js.undefined)
    @scala.inline
    def setFlowLogsS3Bucket(value: Input[String]): Self = this.set("flowLogsS3Bucket", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteFlowLogsS3Bucket: Self = this.set("flowLogsS3Bucket", js.undefined)
    @scala.inline
    def setFlowLogsS3Prefix(value: Input[String]): Self = this.set("flowLogsS3Prefix", value.asInstanceOf[js.Any])
    @scala.inline
