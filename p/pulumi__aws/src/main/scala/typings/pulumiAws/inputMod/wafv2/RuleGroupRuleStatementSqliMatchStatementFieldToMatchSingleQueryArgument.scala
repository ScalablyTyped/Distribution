...
object RuleGroupRuleStatementSqliMatchStatementFieldToMatchSingleQueryArgument {
  ...
  inline def apply(name: Input[String]): RuleGroupRuleStatementSqliMatchStatementFieldToMatchSingleQueryArgument = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[RuleGroupRuleStatementSqliMatchStatementFieldToMatchSingleQueryArgument]
  }
  
  extension [Self <: RuleGroupRuleStatementSqliMatchStatementFieldToMatchSingleQueryArgument](x: Self) {
