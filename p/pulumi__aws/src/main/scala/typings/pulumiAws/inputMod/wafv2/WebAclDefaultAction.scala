...
object WebAclDefaultAction {
  ...
  extension [Self <: WebAclDefaultAction](x: Self) {
    ...
    inline def setAllow(value: Input[WebAclDefaultActionAllow]): Self = StObject.set(x, "allow", value.asInstanceOf[js.Any])
    
    inline def setAllowUndefined: Self = StObject.set(x, "allow", js.undefined)
    
    inline def setBlock(value: Input[WebAclDefaultActionBlock]): Self = StObject.set(x, "block", value.asInstanceOf[js.Any])
