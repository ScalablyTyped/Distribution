...
trait RouteSpecHttpRouteMatchHeaderMatch extends StObject {
  ...
  /**
    ...
    */
  var range: js.UndefOr[Input[RouteSpecHttpRouteMatchHeaderMatchRange]] = js.undefined
...
object RouteSpecHttpRouteMatchHeaderMatch {
  ...
  extension [Self <: RouteSpecHttpRouteMatchHeaderMatch](x: Self) {
    ...
    inline def setRange(value: Input[RouteSpecHttpRouteMatchHeaderMatchRange]): Self = StObject.set(x, "range", value.asInstanceOf[js.Any])
