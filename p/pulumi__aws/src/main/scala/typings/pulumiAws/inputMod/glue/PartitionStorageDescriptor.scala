...
object PartitionStorageDescriptor {
  ...
  extension [Self <: PartitionStorageDescriptor](x: Self) {
    ...
    inline def setColumns(value: Input[js.Array[Input[PartitionStorageDescriptorColumn]]]): Self = StObject.set(x, "columns", value.asInstanceOf[js.Any])
    
    inline def setColumnsUndefined: Self = StObject.set(x, "columns", js.undefined)
    
    inline def setColumnsVarargs(value: Input[PartitionStorageDescriptorColumn]*): Self = StObject.set(x, "columns", js.Array(value :_*))
    ...
    inline def setSerDeInfo(value: Input[PartitionStorageDescriptorSerDeInfo]): Self = StObject.set(x, "serDeInfo", value.asInstanceOf[js.Any])
    
    inline def setSerDeInfoUndefined: Self = StObject.set(x, "serDeInfo", js.undefined)
    
    inline def setSkewedInfo(value: Input[PartitionStorageDescriptorSkewedInfo]): Self = StObject.set(x, "skewedInfo", value.asInstanceOf[js.Any])
    
    inline def setSkewedInfoUndefined: Self = StObject.set(x, "skewedInfo", js.undefined)
    
    inline def setSortColumns(value: Input[js.Array[Input[PartitionStorageDescriptorSortColumn]]]): Self = StObject.set(x, "sortColumns", value.asInstanceOf[js.Any])
    
    inline def setSortColumnsUndefined: Self = StObject.set(x, "sortColumns", js.undefined)
    
    inline def setSortColumnsVarargs(value: Input[PartitionStorageDescriptorSortColumn]*): Self = StObject.set(x, "sortColumns", js.Array(value :_*))
