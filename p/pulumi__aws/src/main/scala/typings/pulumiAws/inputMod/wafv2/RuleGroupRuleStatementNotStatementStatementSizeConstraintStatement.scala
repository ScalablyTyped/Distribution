...
object RuleGroupRuleStatementNotStatementStatementSizeConstraintStatement {
  ...
  extension [Self <: RuleGroupRuleStatementNotStatementStatementSizeConstraintStatement](x: Self) {
    ...
    inline def setFieldToMatch(value: Input[RuleGroupRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatch]): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
