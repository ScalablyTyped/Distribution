...
object RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatch {
  ...
  inline def apply(): RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatch]
  }
  
  extension [Self <: RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatch](x: Self) {
    ...
    inline def setBody(value: Input[RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatchBody]): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
    
    inline def setBodyUndefined: Self = StObject.set(x, "body", js.undefined)
    
    inline def setMethod(value: Input[RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatchMethod]): Self = StObject.set(x, "method", value.asInstanceOf[js.Any])
    ...
    inline def setUriPath(value: Input[RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatchUriPath]): Self = StObject.set(x, "uriPath", value.asInstanceOf[js.Any])
