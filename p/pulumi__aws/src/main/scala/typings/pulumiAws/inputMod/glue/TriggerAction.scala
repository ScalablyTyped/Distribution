...
object TriggerAction {
  ...
  extension [Self <: TriggerAction](x: Self) {
    ...
    inline def setArguments(value: Input[StringDictionary[Input[String]]]): Self = StObject.set(x, "arguments", value.asInstanceOf[js.Any])
    ...
    inline def setNotificationProperty(value: Input[TriggerActionNotificationProperty]): Self = StObject.set(x, "notificationProperty", value.asInstanceOf[js.Any])
