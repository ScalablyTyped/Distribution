...
@js.native
trait WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementGeoMatchStatement extends js.Object {
...
object WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementGeoMatchStatement {
  ...
  @scala.inline
  def apply(countryCodes: Input[js.Array[Input[String]]]): WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementGeoMatchStatement = {
  ...
  @scala.inline
  implicit class WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementGeoMatchStatementOps[Self <: WebAclRuleStatementOrStatementStatementAndStatementStatementOrStatementStatementGeoMatchStatement] (val x: Self) extends AnyVal {
