...
object ProjectCache {
  ...
  implicit class ProjectCacheMutableBuilder[Self <: ProjectCache] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModes(value: Input[js.Array[Input[String]]]): Self = StObject.set(x, "modes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setModesUndefined: Self = StObject.set(x, "modes", js.undefined)
    
    @scala.inline
    def setModesVarargs(value: Input[String]*): Self = StObject.set(x, "modes", js.Array(value :_*))
