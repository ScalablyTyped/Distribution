...
object ProjectCache {
  ...
  implicit class ProjectCacheOps[Self <: ProjectCache] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setModesVarargs(value: Input[String]*): Self = this.set("modes", js.Array(value :_*))
    @scala.inline
    def setModes(value: Input[js.Array[Input[String]]]): Self = this.set("modes", value.asInstanceOf[js.Any])
    @scala.inline
