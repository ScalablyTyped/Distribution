...
object RuleGroupRuleStatementAndStatementStatementByteMatchStatement {
  ...
  extension [Self <: RuleGroupRuleStatementAndStatementStatementByteMatchStatement](x: Self) {
    ...
    inline def setFieldToMatch(value: Input[RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatch]): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
    ...
    inline def setTextTransformationsVarargs(value: Input[RuleGroupRuleStatementAndStatementStatementByteMatchStatementTextTransformation]*): Self = StObject.set(x, "textTransformations", js.Array(value :_*))
  }
}
