...
trait GangliaLayerEbsVolume extends StObject {
...
object GangliaLayerEbsVolume {
  ...
  inline def apply(mountPoint: Input[String], numberOfDisks: Input[Double], size: Input[Double]): GangliaLayerEbsVolume = {
  ...
  extension [Self <: GangliaLayerEbsVolume](x: Self) {
