...
object ClusterCoreInstanceGroup {
  ...
  implicit class ClusterCoreInstanceGroupOps[Self <: ClusterCoreInstanceGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEbsConfigsVarargs(value: Input[ClusterCoreInstanceGroupEbsConfig]*): Self = this.set("ebsConfigs", js.Array(value :_*))
    @scala.inline
    def setEbsConfigs(value: Input[js.Array[Input[ClusterCoreInstanceGroupEbsConfig]]]): Self = this.set("ebsConfigs", value.asInstanceOf[js.Any])
    @scala.inline
