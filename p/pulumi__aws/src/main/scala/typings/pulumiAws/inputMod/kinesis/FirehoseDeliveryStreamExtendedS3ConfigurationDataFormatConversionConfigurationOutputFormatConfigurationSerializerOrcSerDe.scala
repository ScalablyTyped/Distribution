...
object FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfigurationSerializerOrcSerDe {
  ...
  inline def apply(): FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfigurationSerializerOrcSerDe = {
  ...
  extension [Self <: FirehoseDeliveryStreamExtendedS3ConfigurationDataFormatConversionConfigurationOutputFormatConfigurationSerializerOrcSerDe](x: Self) {
    ...
    inline def setBloomFilterColumns(value: Input[js.Array[Input[String]]]): Self = StObject.set(x, "bloomFilterColumns", value.asInstanceOf[js.Any])
    
    inline def setBloomFilterColumnsUndefined: Self = StObject.set(x, "bloomFilterColumns", js.undefined)
    
    inline def setBloomFilterColumnsVarargs(value: Input[String]*): Self = StObject.set(x, "bloomFilterColumns", js.Array(value :_*))
    
    inline def setBloomFilterFalsePositiveProbability(value: Input[Double]): Self = StObject.set(x, "bloomFilterFalsePositiveProbability", value.asInstanceOf[js.Any])
    ...
    inline def setDictionaryKeyThreshold(value: Input[Double]): Self = StObject.set(x, "dictionaryKeyThreshold", value.asInstanceOf[js.Any])
    
    inline def setDictionaryKeyThresholdUndefined: Self = StObject.set(x, "dictionaryKeyThreshold", js.undefined)
    
    inline def setEnablePadding(value: Input[Boolean]): Self = StObject.set(x, "enablePadding", value.asInstanceOf[js.Any])
    
    inline def setEnablePaddingUndefined: Self = StObject.set(x, "enablePadding", js.undefined)
    
    inline def setFormatVersion(value: Input[String]): Self = StObject.set(x, "formatVersion", value.asInstanceOf[js.Any])
    
    inline def setFormatVersionUndefined: Self = StObject.set(x, "formatVersion", js.undefined)
    
    inline def setPaddingTolerance(value: Input[Double]): Self = StObject.set(x, "paddingTolerance", value.asInstanceOf[js.Any])
    
    inline def setPaddingToleranceUndefined: Self = StObject.set(x, "paddingTolerance", js.undefined)
    
    inline def setRowIndexStride(value: Input[Double]): Self = StObject.set(x, "rowIndexStride", value.asInstanceOf[js.Any])
    
    inline def setRowIndexStrideUndefined: Self = StObject.set(x, "rowIndexStride", js.undefined)
    
    inline def setStripeSizeBytes(value: Input[Double]): Self = StObject.set(x, "stripeSizeBytes", value.asInstanceOf[js.Any])
