...
object RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatement {
  ...
  inline def apply(countryCodes: Input[js.Array[Input[String]]]): RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatement = {
  ...
  extension [Self <: RuleGroupRuleStatementNotStatementStatementOrStatementStatementGeoMatchStatement](x: Self) {
