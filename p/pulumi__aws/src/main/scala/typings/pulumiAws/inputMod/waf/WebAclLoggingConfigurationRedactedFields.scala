...
object WebAclLoggingConfigurationRedactedFields {
  ...
  implicit class WebAclLoggingConfigurationRedactedFieldsOps[Self <: WebAclLoggingConfigurationRedactedFields] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatchesVarargs(value: Input[WebAclLoggingConfigurationRedactedFieldsFieldToMatch]*): Self = this.set("fieldToMatches", js.Array(value :_*))
    @scala.inline
    def setFieldToMatches(value: Input[js.Array[Input[WebAclLoggingConfigurationRedactedFieldsFieldToMatch]]]): Self = this.set("fieldToMatches", value.asInstanceOf[js.Any])
  }
