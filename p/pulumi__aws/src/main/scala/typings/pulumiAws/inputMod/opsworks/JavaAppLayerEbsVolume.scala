...
object JavaAppLayerEbsVolume {
  ...
  inline def apply(mountPoint: Input[String], numberOfDisks: Input[Double], size: Input[Double]): JavaAppLayerEbsVolume = {
  ...
  extension [Self <: JavaAppLayerEbsVolume](x: Self) {
