...
object WebAclRuleStatementNotStatementStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig {
  ...
  inline def apply(fallbackBehavior: Input[String], headerName: Input[String], position: Input[String]): WebAclRuleStatementNotStatementStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig = {
  ...
  extension [Self <: WebAclRuleStatementNotStatementStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig](x: Self) {
