...
object RuleGroupRuleStatementOrStatementStatementNotStatementStatement {
  ...
  @scala.inline
  implicit class RuleGroupRuleStatementOrStatementStatementNotStatementStatementMutableBuilder[Self <: RuleGroupRuleStatementOrStatementStatementNotStatementStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGeoMatchStatement(value: Input[RuleGroupRuleStatementOrStatementStatementNotStatementStatementGeoMatchStatement]): Self = StObject.set(x, "geoMatchStatement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setXssMatchStatement(value: Input[RuleGroupRuleStatementOrStatementStatementNotStatementStatementXssMatchStatement]): Self = StObject.set(x, "xssMatchStatement", value.asInstanceOf[js.Any])
