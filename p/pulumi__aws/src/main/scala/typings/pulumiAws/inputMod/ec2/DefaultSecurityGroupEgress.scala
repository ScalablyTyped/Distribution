...
object DefaultSecurityGroupEgress {
  ...
  inline def apply(fromPort: Input[Double], protocol: Input[String], toPort: Input[Double]): DefaultSecurityGroupEgress = {
  ...
  extension [Self <: DefaultSecurityGroupEgress](x: Self) {
