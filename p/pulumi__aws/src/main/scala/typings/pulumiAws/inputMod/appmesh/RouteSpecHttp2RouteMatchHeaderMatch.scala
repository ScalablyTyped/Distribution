...
trait RouteSpecHttp2RouteMatchHeaderMatch extends StObject {
  ...
  /**
    ...
    */
  var range: js.UndefOr[Input[RouteSpecHttp2RouteMatchHeaderMatchRange]] = js.undefined
...
object RouteSpecHttp2RouteMatchHeaderMatch {
  ...
  extension [Self <: RouteSpecHttp2RouteMatchHeaderMatch](x: Self) {
    ...
    inline def setRange(value: Input[RouteSpecHttp2RouteMatchHeaderMatchRange]): Self = StObject.set(x, "range", value.asInstanceOf[js.Any])
