...
object WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatch {
  ...
  implicit class WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchOps[Self <: WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatch] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: Input[WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchBody]): Self = this.set("body", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBody: Self = this.set("body", js.undefined)
    
    @scala.inline
    def setMethod(value: Input[WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchMethod]): Self = this.set("method", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setUriPath(value: Input[WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchUriPath]): Self = this.set("uriPath", value.asInstanceOf[js.Any])
