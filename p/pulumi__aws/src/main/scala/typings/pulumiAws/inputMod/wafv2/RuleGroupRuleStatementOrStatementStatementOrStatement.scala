...
object RuleGroupRuleStatementOrStatementStatementOrStatement {
  ...
  implicit class RuleGroupRuleStatementOrStatementStatementOrStatementOps[Self <: RuleGroupRuleStatementOrStatementStatementOrStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStatementsVarargs(value: Input[RuleGroupRuleStatementOrStatementStatementOrStatementStatement]*): Self = this.set("statements", js.Array(value :_*))
    
    @scala.inline
    def setStatements(value: Input[js.Array[Input[RuleGroupRuleStatementOrStatementStatementOrStatementStatement]]]): Self = this.set("statements", value.asInstanceOf[js.Any])
  }
}
