...
trait RuleGroupRuleStatementOrStatementStatementAndStatement extends js.Object {
  ...
  /**
    ...
    */
  var statements: Input[js.Array[Input[RuleGroupRuleStatementOrStatementStatementAndStatementStatement]]] = js.native
}
object RuleGroupRuleStatementOrStatementStatementAndStatement {
  ...
  implicit class RuleGroupRuleStatementOrStatementStatementAndStatementOps[Self <: RuleGroupRuleStatementOrStatementStatementAndStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStatementsVarargs(value: Input[RuleGroupRuleStatementOrStatementStatementAndStatementStatement]*): Self = this.set("statements", js.Array(value :_*))
    
    @scala.inline
    def setStatements(value: Input[js.Array[Input[RuleGroupRuleStatementOrStatementStatementAndStatementStatement]]]): Self = this.set("statements", value.asInstanceOf[js.Any])
  }
}
