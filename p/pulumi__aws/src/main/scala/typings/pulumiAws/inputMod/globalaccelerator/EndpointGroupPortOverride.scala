...
object EndpointGroupPortOverride {
  ...
  implicit class EndpointGroupPortOverrideOps[Self <: EndpointGroupPortOverride] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEndpointPort(value: Input[Double]): Self = this.set("endpointPort", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setListenerPort(value: Input[Double]): Self = this.set("listenerPort", value.asInstanceOf[js.Any])
  }
}
