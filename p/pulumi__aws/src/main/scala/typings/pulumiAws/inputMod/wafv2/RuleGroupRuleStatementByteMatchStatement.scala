...
trait RuleGroupRuleStatementByteMatchStatement extends StObject {
  ...
  /**
    ...
    */
  var fieldToMatch: js.UndefOr[Input[RuleGroupRuleStatementByteMatchStatementFieldToMatch]] = js.native
  ...
  /**
    ...
    */
  var textTransformations: Input[js.Array[Input[RuleGroupRuleStatementByteMatchStatementTextTransformation]]] = js.native
}
object RuleGroupRuleStatementByteMatchStatement {
  ...
  implicit class RuleGroupRuleStatementByteMatchStatementMutableBuilder[Self <: RuleGroupRuleStatementByteMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: Input[RuleGroupRuleStatementByteMatchStatementFieldToMatch]): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTextTransformations(value: Input[js.Array[Input[RuleGroupRuleStatementByteMatchStatementTextTransformation]]]): Self = StObject.set(x, "textTransformations", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTextTransformationsVarargs(value: Input[RuleGroupRuleStatementByteMatchStatementTextTransformation]*): Self = StObject.set(x, "textTransformations", js.Array(value :_*))
  }
}
