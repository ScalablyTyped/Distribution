...
trait RuleGroupRuleStatementByteMatchStatement extends StObject {
  ...
  /**
    ...
    */
  var fieldToMatch: js.UndefOr[Input[RuleGroupRuleStatementByteMatchStatementFieldToMatch]] = js.undefined
  ...
  /**
    ...
    */
  var textTransformations: Input[js.Array[Input[RuleGroupRuleStatementByteMatchStatementTextTransformation]]]
}
object RuleGroupRuleStatementByteMatchStatement {
  ...
  inline def apply(
    ...
    textTransformations: Input[js.Array[Input[RuleGroupRuleStatementByteMatchStatementTextTransformation]]]
  ...
  extension [Self <: RuleGroupRuleStatementByteMatchStatement](x: Self) {
    ...
    inline def setFieldToMatch(value: Input[RuleGroupRuleStatementByteMatchStatementFieldToMatch]): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
    ...
    inline def setTextTransformations(value: Input[js.Array[Input[RuleGroupRuleStatementByteMatchStatementTextTransformation]]]): Self = StObject.set(x, "textTransformations", value.asInstanceOf[js.Any])
    
    inline def setTextTransformationsVarargs(value: Input[RuleGroupRuleStatementByteMatchStatementTextTransformation]*): Self = StObject.set(x, "textTransformations", js.Array(value :_*))
  }
}
