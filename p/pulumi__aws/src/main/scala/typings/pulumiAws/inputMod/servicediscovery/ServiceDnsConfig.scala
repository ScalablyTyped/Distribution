...
object ServiceDnsConfig {
  ...
  implicit class ServiceDnsConfigOps[Self <: ServiceDnsConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDnsRecordsVarargs(value: Input[ServiceDnsConfigDnsRecord]*): Self = this.set("dnsRecords", js.Array(value :_*))
    @scala.inline
    def setDnsRecords(value: Input[js.Array[Input[ServiceDnsConfigDnsRecord]]]): Self = this.set("dnsRecords", value.asInstanceOf[js.Any])
    @scala.inline
    def setNamespaceId(value: Input[String]): Self = this.set("namespaceId", value.asInstanceOf[js.Any])
    @scala.inline
    def setRoutingPolicy(value: Input[String]): Self = this.set("routingPolicy", value.asInstanceOf[js.Any])
    @scala.inline
