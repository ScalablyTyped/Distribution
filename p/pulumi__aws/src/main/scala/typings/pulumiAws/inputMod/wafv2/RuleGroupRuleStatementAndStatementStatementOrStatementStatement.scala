...
object RuleGroupRuleStatementAndStatementStatementOrStatementStatement {
  ...
  extension [Self <: RuleGroupRuleStatementAndStatementStatementOrStatementStatement](x: Self) {
    ...
    inline def setGeoMatchStatement(value: Input[RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatement]): Self = StObject.set(x, "geoMatchStatement", value.asInstanceOf[js.Any])
    ...
    inline def setXssMatchStatement(value: Input[RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatement]): Self = StObject.set(x, "xssMatchStatement", value.asInstanceOf[js.Any])
