...
@js.native
trait RuleGroupRuleStatementAndStatementStatementOrStatementStatement extends js.Object {
  ...
  var geoMatchStatement: js.UndefOr[
    Input[RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatement]
  ] = js.native
  ...
  var xssMatchStatement: js.UndefOr[
    Input[RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatement]
  ] = js.native
}
object RuleGroupRuleStatementAndStatementStatementOrStatementStatement {
  ...
  @scala.inline
  implicit class RuleGroupRuleStatementAndStatementStatementOrStatementStatementOps[Self <: RuleGroupRuleStatementAndStatementStatementOrStatementStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGeoMatchStatement(value: Input[RuleGroupRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatement]): Self = this.set("geoMatchStatement", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setXssMatchStatement(value: Input[RuleGroupRuleStatementAndStatementStatementOrStatementStatementXssMatchStatement]): Self = this.set("xssMatchStatement", value.asInstanceOf[js.Any])
