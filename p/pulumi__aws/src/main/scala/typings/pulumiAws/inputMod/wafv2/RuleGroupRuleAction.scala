...
trait RuleGroupRuleAction extends StObject {
  ...
  /**
    ...
    */
  var allow: js.UndefOr[Input[RuleGroupRuleActionAllow]] = js.undefined
  
  /**
    * Instructs AWS WAF to block the web request.
    */
  var block: js.UndefOr[Input[RuleGroupRuleActionBlock]] = js.undefined
  
  /**
    * Instructs AWS WAF to count the web request and allow it.
    */
  var count: js.UndefOr[Input[RuleGroupRuleActionCount]] = js.undefined
}
