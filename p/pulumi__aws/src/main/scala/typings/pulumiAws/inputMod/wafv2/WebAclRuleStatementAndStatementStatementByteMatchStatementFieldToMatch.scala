...
object WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatch {
  ...
  extension [Self <: WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatch](x: Self) {
    ...
    inline def setBody(value: Input[WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchBody]): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
    
    inline def setBodyUndefined: Self = StObject.set(x, "body", js.undefined)
    
    inline def setMethod(value: Input[WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchMethod]): Self = StObject.set(x, "method", value.asInstanceOf[js.Any])
    ...
    inline def setUriPath(value: Input[WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchUriPath]): Self = StObject.set(x, "uriPath", value.asInstanceOf[js.Any])
