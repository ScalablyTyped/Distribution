...
object UserPoolSchemaNumberAttributeConstraints {
  ...
  implicit class UserPoolSchemaNumberAttributeConstraintsOps[Self <: UserPoolSchemaNumberAttributeConstraints] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxValue(value: Input[String]): Self = this.set("maxValue", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMaxValue: Self = this.set("maxValue", js.undefined)
    @scala.inline
    def setMinValue(value: Input[String]): Self = this.set("minValue", value.asInstanceOf[js.Any])
    @scala.inline
