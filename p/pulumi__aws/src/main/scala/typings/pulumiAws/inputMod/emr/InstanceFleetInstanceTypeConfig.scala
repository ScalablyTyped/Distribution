...
object InstanceFleetInstanceTypeConfig {
  ...
  implicit class InstanceFleetInstanceTypeConfigMutableBuilder[Self <: InstanceFleetInstanceTypeConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConfigurations(value: Input[js.Array[Input[InstanceFleetInstanceTypeConfigConfiguration]]]): Self = StObject.set(x, "configurations", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setConfigurationsUndefined: Self = StObject.set(x, "configurations", js.undefined)
    
    @scala.inline
    def setConfigurationsVarargs(value: Input[InstanceFleetInstanceTypeConfigConfiguration]*): Self = StObject.set(x, "configurations", js.Array(value :_*))
    
    @scala.inline
    def setEbsConfigs(value: Input[js.Array[Input[InstanceFleetInstanceTypeConfigEbsConfig]]]): Self = StObject.set(x, "ebsConfigs", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEbsConfigsUndefined: Self = StObject.set(x, "ebsConfigs", js.undefined)
    
    @scala.inline
    def setEbsConfigsVarargs(value: Input[InstanceFleetInstanceTypeConfigEbsConfig]*): Self = StObject.set(x, "ebsConfigs", js.Array(value :_*))
