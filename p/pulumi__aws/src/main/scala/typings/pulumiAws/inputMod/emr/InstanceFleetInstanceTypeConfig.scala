...
@js.native
trait InstanceFleetInstanceTypeConfig extends js.Object {
  ...
  /**
    ...
    */
  var configurations: js.UndefOr[Input[js.Array[Input[InstanceFleetInstanceTypeConfigConfiguration]]]] = js.native
  
  /**
    * Configuration block(s) for EBS volumes attached to each instance in the instance group. Detailed below.
    */
  var ebsConfigs: js.UndefOr[Input[js.Array[Input[InstanceFleetInstanceTypeConfigEbsConfig]]]] = js.native
...
object InstanceFleetInstanceTypeConfig {
  ...
  @scala.inline
  def apply(instanceType: Input[String]): InstanceFleetInstanceTypeConfig = {
  ...
  @scala.inline
  implicit class InstanceFleetInstanceTypeConfigOps[Self <: InstanceFleetInstanceTypeConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConfigurationsVarargs(value: Input[InstanceFleetInstanceTypeConfigConfiguration]*): Self = this.set("configurations", js.Array(value :_*))
    
    @scala.inline
    def setConfigurations(value: Input[js.Array[Input[InstanceFleetInstanceTypeConfigConfiguration]]]): Self = this.set("configurations", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteConfigurations: Self = this.set("configurations", js.undefined)
    
    @scala.inline
    def setEbsConfigsVarargs(value: Input[InstanceFleetInstanceTypeConfigEbsConfig]*): Self = this.set("ebsConfigs", js.Array(value :_*))
    
    @scala.inline
    def setEbsConfigs(value: Input[js.Array[Input[InstanceFleetInstanceTypeConfigEbsConfig]]]): Self = this.set("ebsConfigs", value.asInstanceOf[js.Any])
