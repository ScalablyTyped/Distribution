...
object MemcachedLayerEbsVolume {
  ...
  inline def apply(mountPoint: Input[String], numberOfDisks: Input[Double], size: Input[Double]): MemcachedLayerEbsVolume = {
  ...
  extension [Self <: MemcachedLayerEbsVolume](x: Self) {
