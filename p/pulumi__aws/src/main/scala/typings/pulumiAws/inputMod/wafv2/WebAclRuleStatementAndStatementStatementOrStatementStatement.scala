...
trait WebAclRuleStatementAndStatementStatementOrStatementStatement extends StObject {
  ...
  /**
    ...
    */
  var andStatement: js.UndefOr[Input[WebAclRuleStatementAndStatementStatementOrStatementStatementAndStatement]] = js.undefined
  ...
  /**
    ...
    */
  var notStatement: js.UndefOr[Input[WebAclRuleStatementAndStatementStatementOrStatementStatementNotStatement]] = js.undefined
  
  /**
    * A logical rule statement used to combine other rule statements with OR logic. See OR Statement below for details.
    */
  var orStatement: js.UndefOr[Input[WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatement]] = js.undefined
...
object WebAclRuleStatementAndStatementStatementOrStatementStatement {
  ...
  extension [Self <: WebAclRuleStatementAndStatementStatementOrStatementStatement](x: Self) {
    ...
    inline def setAndStatement(value: Input[WebAclRuleStatementAndStatementStatementOrStatementStatementAndStatement]): Self = StObject.set(x, "andStatement", value.asInstanceOf[js.Any])
    
    inline def setAndStatementUndefined: Self = StObject.set(x, "andStatement", js.undefined)
    
    inline def setByteMatchStatement(value: Input[WebAclRuleStatementAndStatementStatementOrStatementStatementByteMatchStatement]): Self = StObject.set(x, "byteMatchStatement", value.asInstanceOf[js.Any])
    
    inline def setByteMatchStatementUndefined: Self = StObject.set(x, "byteMatchStatement", js.undefined)
    
    inline def setGeoMatchStatement(value: Input[WebAclRuleStatementAndStatementStatementOrStatementStatementGeoMatchStatement]): Self = StObject.set(x, "geoMatchStatement", value.asInstanceOf[js.Any])
    ...
    inline def setNotStatement(value: Input[WebAclRuleStatementAndStatementStatementOrStatementStatementNotStatement]): Self = StObject.set(x, "notStatement", value.asInstanceOf[js.Any])
    
    inline def setNotStatementUndefined: Self = StObject.set(x, "notStatement", js.undefined)
    
    inline def setOrStatement(value: Input[WebAclRuleStatementAndStatementStatementOrStatementStatementOrStatement]): Self = StObject.set(x, "orStatement", value.asInstanceOf[js.Any])
    ...
    inline def setSqliMatchStatement(value: Input[WebAclRuleStatementAndStatementStatementOrStatementStatementSqliMatchStatement]): Self = StObject.set(x, "sqliMatchStatement", value.asInstanceOf[js.Any])
    
    inline def setSqliMatchStatementUndefined: Self = StObject.set(x, "sqliMatchStatement", js.undefined)
    
    inline def setXssMatchStatement(value: Input[WebAclRuleStatementAndStatementStatementOrStatementStatementXssMatchStatement]): Self = StObject.set(x, "xssMatchStatement", value.asInstanceOf[js.Any])
