...
object FirehoseDeliveryStreamElasticsearchConfiguration {
  ...
  inline def apply(indexName: Input[String], roleArn: Input[String]): FirehoseDeliveryStreamElasticsearchConfiguration = {
  ...
  extension [Self <: FirehoseDeliveryStreamElasticsearchConfiguration](x: Self) {
    ...
    inline def setCloudwatchLoggingOptions(value: Input[FirehoseDeliveryStreamElasticsearchConfigurationCloudwatchLoggingOptions]): Self = StObject.set(x, "cloudwatchLoggingOptions", value.asInstanceOf[js.Any])
    
    inline def setCloudwatchLoggingOptionsUndefined: Self = StObject.set(x, "cloudwatchLoggingOptions", js.undefined)
    
    inline def setClusterEndpoint(value: Input[String]): Self = StObject.set(x, "clusterEndpoint", value.asInstanceOf[js.Any])
    
    inline def setClusterEndpointUndefined: Self = StObject.set(x, "clusterEndpoint", js.undefined)
    
    inline def setDomainArn(value: Input[String]): Self = StObject.set(x, "domainArn", value.asInstanceOf[js.Any])
    
    inline def setDomainArnUndefined: Self = StObject.set(x, "domainArn", js.undefined)
    
    inline def setIndexName(value: Input[String]): Self = StObject.set(x, "indexName", value.asInstanceOf[js.Any])
    
    inline def setIndexRotationPeriod(value: Input[String]): Self = StObject.set(x, "indexRotationPeriod", value.asInstanceOf[js.Any])
    
    inline def setIndexRotationPeriodUndefined: Self = StObject.set(x, "indexRotationPeriod", js.undefined)
    
    inline def setProcessingConfiguration(value: Input[FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfiguration]): Self = StObject.set(x, "processingConfiguration", value.asInstanceOf[js.Any])
    ...
    inline def setTypeName(value: Input[String]): Self = StObject.set(x, "typeName", value.asInstanceOf[js.Any])
    
    inline def setTypeNameUndefined: Self = StObject.set(x, "typeName", js.undefined)
    
    inline def setVpcConfig(value: Input[FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig]): Self = StObject.set(x, "vpcConfig", value.asInstanceOf[js.Any])
