...
object RuleGroupRuleGroupRulesSourceRulesSourceList {
  ...
  implicit class RuleGroupRuleGroupRulesSourceRulesSourceListOps[Self <: RuleGroupRuleGroupRulesSourceRulesSourceList] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGeneratedRulesType(value: Input[String]): Self = this.set("generatedRulesType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTargetTypesVarargs(value: Input[String]*): Self = this.set("targetTypes", js.Array(value :_*))
    
    @scala.inline
    def setTargetTypes(value: Input[js.Array[Input[String]]]): Self = this.set("targetTypes", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTargetsVarargs(value: Input[String]*): Self = this.set("targets", js.Array(value :_*))
    
    @scala.inline
    def setTargets(value: Input[js.Array[Input[String]]]): Self = this.set("targets", value.asInstanceOf[js.Any])
  }
}
