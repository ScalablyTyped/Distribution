...
trait FilterFindingCriteria extends js.Object {
  ...
  var criterions: Input[js.Array[Input[FilterFindingCriteriaCriterion]]] = js.native
}
object FilterFindingCriteria {
  ...
  implicit class FilterFindingCriteriaOps[Self <: FilterFindingCriteria] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCriterionsVarargs(value: Input[FilterFindingCriteriaCriterion]*): Self = this.set("criterions", js.Array(value :_*))
    
    @scala.inline
    def setCriterions(value: Input[js.Array[Input[FilterFindingCriteriaCriterion]]]): Self = this.set("criterions", value.asInstanceOf[js.Any])
  }
}
