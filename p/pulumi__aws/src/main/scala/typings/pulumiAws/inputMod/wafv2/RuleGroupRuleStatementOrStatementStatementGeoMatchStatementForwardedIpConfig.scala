...
trait RuleGroupRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfig extends StObject {
...
object RuleGroupRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfig {
  ...
  inline def apply(fallbackBehavior: Input[String], headerName: Input[String]): RuleGroupRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfig = {
