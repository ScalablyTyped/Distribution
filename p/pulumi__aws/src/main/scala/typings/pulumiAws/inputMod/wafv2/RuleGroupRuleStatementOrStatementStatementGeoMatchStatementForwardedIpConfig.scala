...
@js.native
trait RuleGroupRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfig extends js.Object {
...
object RuleGroupRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfig {
  ...
  @scala.inline
  def apply(fallbackBehavior: Input[String], headerName: Input[String]): RuleGroupRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfig = {
  ...
  @scala.inline
  implicit class RuleGroupRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfigOps[Self <: RuleGroupRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfig] (val x: Self) extends AnyVal {
