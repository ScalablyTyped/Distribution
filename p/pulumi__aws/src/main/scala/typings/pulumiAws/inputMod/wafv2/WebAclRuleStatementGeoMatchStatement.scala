...
object WebAclRuleStatementGeoMatchStatement {
  ...
  @scala.inline
  def apply(countryCodes: Input[js.Array[Input[String]]]): WebAclRuleStatementGeoMatchStatement = {
  ...
  implicit class WebAclRuleStatementGeoMatchStatementMutableBuilder[Self <: WebAclRuleStatementGeoMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedIpConfig(value: Input[WebAclRuleStatementGeoMatchStatementForwardedIpConfig]): Self = StObject.set(x, "forwardedIpConfig", value.asInstanceOf[js.Any])
