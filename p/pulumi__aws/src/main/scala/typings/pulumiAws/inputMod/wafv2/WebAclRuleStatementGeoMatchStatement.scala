...
trait WebAclRuleStatementGeoMatchStatement extends StObject {
  ...
  /**
    ...
    */
  var forwardedIpConfig: js.UndefOr[Input[WebAclRuleStatementGeoMatchStatementForwardedIpConfig]] = js.undefined
}
object WebAclRuleStatementGeoMatchStatement {
  
  inline def apply(countryCodes: Input[js.Array[Input[String]]]): WebAclRuleStatementGeoMatchStatement = {
  ...
  extension [Self <: WebAclRuleStatementGeoMatchStatement](x: Self) {
    ...
    inline def setForwardedIpConfig(value: Input[WebAclRuleStatementGeoMatchStatementForwardedIpConfig]): Self = StObject.set(x, "forwardedIpConfig", value.asInstanceOf[js.Any])
