...
object WebAclRuleStatementAndStatementStatementSizeConstraintStatement {
  ...
  extension [Self <: WebAclRuleStatementAndStatementStatementSizeConstraintStatement](x: Self) {
    ...
    inline def setFieldToMatch(value: Input[WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatch]): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
