...
object IntentFollowUpPromptRejectionStatementMessage {
  ...
  @scala.inline
  implicit class IntentFollowUpPromptRejectionStatementMessageMutableBuilder[Self <: IntentFollowUpPromptRejectionStatementMessage] (val x: Self) extends AnyVal {
