...
@js.native
trait IntentFollowUpPromptRejectionStatementMessage extends js.Object {
...
object IntentFollowUpPromptRejectionStatementMessage {
  ...
  @scala.inline
  def apply(content: Input[String], contentType: Input[String]): IntentFollowUpPromptRejectionStatementMessage = {
    val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], contentType = contentType.asInstanceOf[js.Any])
    __obj.asInstanceOf[IntentFollowUpPromptRejectionStatementMessage]
  }
  
  @scala.inline
  implicit class IntentFollowUpPromptRejectionStatementMessageOps[Self <: IntentFollowUpPromptRejectionStatementMessage] (val x: Self) extends AnyVal {
