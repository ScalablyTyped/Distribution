...
object VirtualNodeSpecListenerTimeoutHttp2 {
  ...
  implicit class VirtualNodeSpecListenerTimeoutHttp2Ops[Self <: VirtualNodeSpecListenerTimeoutHttp2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIdle(value: Input[VirtualNodeSpecListenerTimeoutHttp2Idle]): Self = this.set("idle", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteIdle: Self = this.set("idle", js.undefined)
    
    @scala.inline
    def setPerRequest(value: Input[VirtualNodeSpecListenerTimeoutHttp2PerRequest]): Self = this.set("perRequest", value.asInstanceOf[js.Any])
