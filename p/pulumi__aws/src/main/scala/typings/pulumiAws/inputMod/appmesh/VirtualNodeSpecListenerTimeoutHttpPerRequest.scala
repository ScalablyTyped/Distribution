...
object VirtualNodeSpecListenerTimeoutHttpPerRequest {
  ...
  inline def apply(unit: Input[String], value: Input[Double]): VirtualNodeSpecListenerTimeoutHttpPerRequest = {
    val __obj = js.Dynamic.literal(unit = unit.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[VirtualNodeSpecListenerTimeoutHttpPerRequest]
  }
  
  extension [Self <: VirtualNodeSpecListenerTimeoutHttpPerRequest](x: Self) {
