...
object RuleGroupRuleStatementOrStatementStatementGeoMatchStatement {
  ...
  @scala.inline
  def apply(countryCodes: Input[js.Array[Input[String]]]): RuleGroupRuleStatementOrStatementStatementGeoMatchStatement = {
  ...
  implicit class RuleGroupRuleStatementOrStatementStatementGeoMatchStatementMutableBuilder[Self <: RuleGroupRuleStatementOrStatementStatementGeoMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedIpConfig(value: Input[RuleGroupRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfig]): Self = StObject.set(x, "forwardedIpConfig", value.asInstanceOf[js.Any])
