...
object RuleGroupRuleStatementOrStatementStatementGeoMatchStatement {
  ...
  implicit class RuleGroupRuleStatementOrStatementStatementGeoMatchStatementOps[Self <: RuleGroupRuleStatementOrStatementStatementGeoMatchStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedIpConfig(value: Input[RuleGroupRuleStatementOrStatementStatementGeoMatchStatementForwardedIpConfig]): Self = this.set("forwardedIpConfig", value.asInstanceOf[js.Any])
