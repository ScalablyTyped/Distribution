...
@js.native
trait RuleGroupRuleStatementOrStatementStatementSizeConstraintStatement extends js.Object {
  ...
  var fieldToMatch: js.UndefOr[
    Input[RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatch]
  ] = js.native
...
object RuleGroupRuleStatementOrStatementStatementSizeConstraintStatement {
  ...
  @scala.inline
  implicit class RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementOps[Self <: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFieldToMatch(value: Input[RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatch]): Self = this.set("fieldToMatch", value.asInstanceOf[js.Any])
