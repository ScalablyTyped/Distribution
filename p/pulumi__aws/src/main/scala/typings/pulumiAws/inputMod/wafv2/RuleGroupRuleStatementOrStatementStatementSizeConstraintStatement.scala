...
object RuleGroupRuleStatementOrStatementStatementSizeConstraintStatement {
  ...
  extension [Self <: RuleGroupRuleStatementOrStatementStatementSizeConstraintStatement](x: Self) {
    
    inline def setComparisonOperator(value: Input[String]): Self = StObject.set(x, "comparisonOperator", value.asInstanceOf[js.Any])
    
    inline def setFieldToMatch(value: Input[RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatch]): Self = StObject.set(x, "fieldToMatch", value.asInstanceOf[js.Any])
