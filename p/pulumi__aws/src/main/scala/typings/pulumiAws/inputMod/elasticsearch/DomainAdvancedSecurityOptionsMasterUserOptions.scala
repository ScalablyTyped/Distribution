...
object DomainAdvancedSecurityOptionsMasterUserOptions {
  ...
  implicit class DomainAdvancedSecurityOptionsMasterUserOptionsOps[Self <: DomainAdvancedSecurityOptionsMasterUserOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMasterUserArn(value: Input[String]): Self = this.set("masterUserArn", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMasterUserPassword(value: Input[String]): Self = this.set("masterUserPassword", value.asInstanceOf[js.Any])
    @scala.inline
