...
object DistributionOrderedCacheBehavior {
  ...
  @scala.inline
  implicit class DistributionOrderedCacheBehaviorOps[Self <: DistributionOrderedCacheBehavior] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setForwardedValues(value: Input[DistributionOrderedCacheBehaviorForwardedValues]): Self = this.set("forwardedValues", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPathPattern(value: Input[String]): Self = this.set("pathPattern", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLambdaFunctionAssociationsVarargs(value: Input[DistributionOrderedCacheBehaviorLambdaFunctionAssociation]*): Self = this.set("lambdaFunctionAssociations", js.Array(value :_*))
    
    @scala.inline
    def setLambdaFunctionAssociations(value: Input[js.Array[Input[DistributionOrderedCacheBehaviorLambdaFunctionAssociation]]]): Self = this.set("lambdaFunctionAssociations", value.asInstanceOf[js.Any])
