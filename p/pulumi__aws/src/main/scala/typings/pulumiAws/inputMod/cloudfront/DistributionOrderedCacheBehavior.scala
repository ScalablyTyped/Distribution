...
object DistributionOrderedCacheBehavior {
  ...
  extension [Self <: DistributionOrderedCacheBehavior](x: Self) {
    ...
    inline def setForwardedValues(value: Input[DistributionOrderedCacheBehaviorForwardedValues]): Self = StObject.set(x, "forwardedValues", value.asInstanceOf[js.Any])
    
    inline def setLambdaFunctionAssociations(value: Input[js.Array[Input[DistributionOrderedCacheBehaviorLambdaFunctionAssociation]]]): Self = StObject.set(x, "lambdaFunctionAssociations", value.asInstanceOf[js.Any])
    
    inline def setLambdaFunctionAssociationsUndefined: Self = StObject.set(x, "lambdaFunctionAssociations", js.undefined)
    
    inline def setLambdaFunctionAssociationsVarargs(value: Input[DistributionOrderedCacheBehaviorLambdaFunctionAssociation]*): Self = StObject.set(x, "lambdaFunctionAssociations", js.Array(value :_*))
    ...
    inline def setPathPattern(value: Input[String]): Self = StObject.set(x, "pathPattern", value.asInstanceOf[js.Any])
