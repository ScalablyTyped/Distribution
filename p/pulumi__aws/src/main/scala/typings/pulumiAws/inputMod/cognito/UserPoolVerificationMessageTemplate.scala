...
object UserPoolVerificationMessageTemplate {
  ...
  inline def apply(): UserPoolVerificationMessageTemplate = {
  ...
  extension [Self <: UserPoolVerificationMessageTemplate](x: Self) {
    ...
    inline def setDefaultEmailOption(value: Input[String]): Self = StObject.set(x, "defaultEmailOption", value.asInstanceOf[js.Any])
    ...
    inline def setEmailMessageByLink(value: Input[String]): Self = StObject.set(x, "emailMessageByLink", value.asInstanceOf[js.Any])
    ...
    inline def setEmailSubjectByLink(value: Input[String]): Self = StObject.set(x, "emailSubjectByLink", value.asInstanceOf[js.Any])
