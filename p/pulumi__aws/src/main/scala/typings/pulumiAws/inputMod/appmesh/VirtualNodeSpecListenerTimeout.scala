...
object VirtualNodeSpecListenerTimeout {
  ...
  implicit class VirtualNodeSpecListenerTimeoutOps[Self <: VirtualNodeSpecListenerTimeout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGrpc(value: Input[VirtualNodeSpecListenerTimeoutGrpc]): Self = this.set("grpc", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGrpc: Self = this.set("grpc", js.undefined)
    
    @scala.inline
    def setHttp(value: Input[VirtualNodeSpecListenerTimeoutHttp]): Self = this.set("http", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHttp: Self = this.set("http", js.undefined)
    
    @scala.inline
    def setHttp2(value: Input[VirtualNodeSpecListenerTimeoutHttp2]): Self = this.set("http2", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHttp2: Self = this.set("http2", js.undefined)
    
    @scala.inline
    def setTcp(value: Input[VirtualNodeSpecListenerTimeoutTcp]): Self = this.set("tcp", value.asInstanceOf[js.Any])
