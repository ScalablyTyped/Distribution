...
object VirtualNodeSpecListenerTimeout {
  ...
  extension [Self <: VirtualNodeSpecListenerTimeout](x: Self) {
    ...
    inline def setGrpc(value: Input[VirtualNodeSpecListenerTimeoutGrpc]): Self = StObject.set(x, "grpc", value.asInstanceOf[js.Any])
    
    inline def setGrpcUndefined: Self = StObject.set(x, "grpc", js.undefined)
    
    inline def setHttp(value: Input[VirtualNodeSpecListenerTimeoutHttp]): Self = StObject.set(x, "http", value.asInstanceOf[js.Any])
    
    inline def setHttp2(value: Input[VirtualNodeSpecListenerTimeoutHttp2]): Self = StObject.set(x, "http2", value.asInstanceOf[js.Any])
    
    inline def setHttp2Undefined: Self = StObject.set(x, "http2", js.undefined)
    
    inline def setHttpUndefined: Self = StObject.set(x, "http", js.undefined)
    
    inline def setTcp(value: Input[VirtualNodeSpecListenerTimeoutTcp]): Self = StObject.set(x, "tcp", value.asInstanceOf[js.Any])
