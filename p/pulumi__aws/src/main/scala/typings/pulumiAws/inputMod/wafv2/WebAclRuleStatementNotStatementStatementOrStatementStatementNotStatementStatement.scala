...
object WebAclRuleStatementNotStatementStatementOrStatementStatementNotStatementStatement {
  ...
  inline def apply(): WebAclRuleStatementNotStatementStatementOrStatementStatementNotStatementStatement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WebAclRuleStatementNotStatementStatementOrStatementStatementNotStatementStatement]
  }
  
  extension [Self <: WebAclRuleStatementNotStatementStatementOrStatementStatementNotStatementStatement](x: Self) {
