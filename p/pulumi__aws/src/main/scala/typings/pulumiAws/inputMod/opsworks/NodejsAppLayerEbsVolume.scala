...
object NodejsAppLayerEbsVolume {
  ...
  inline def apply(mountPoint: Input[String], numberOfDisks: Input[Double], size: Input[Double]): NodejsAppLayerEbsVolume = {
  ...
  extension [Self <: NodejsAppLayerEbsVolume](x: Self) {
