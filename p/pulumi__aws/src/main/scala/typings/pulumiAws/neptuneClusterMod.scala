...
object neptuneClusterMod {
  ...
  object ClusterArgs {
    ...
    extension [Self <: ClusterArgs](x: Self) {
      ...
      inline def setEnableCloudwatchLogsExports(value: Input[js.Array[Input[String]]]): Self = StObject.set(x, "enableCloudwatchLogsExports", value.asInstanceOf[js.Any])
      
      inline def setEnableCloudwatchLogsExportsUndefined: Self = StObject.set(x, "enableCloudwatchLogsExports", js.undefined)
      
      inline def setEnableCloudwatchLogsExportsVarargs(value: Input[String]*): Self = StObject.set(x, "enableCloudwatchLogsExports", js.Array(value :_*))
      ...
      inline def setNeptuneClusterParameterGroupName(value: Input[String]): Self = StObject.set(x, "neptuneClusterParameterGroupName", value.asInstanceOf[js.Any])
      
      inline def setNeptuneClusterParameterGroupNameUndefined: Self = StObject.set(x, "neptuneClusterParameterGroupName", js.undefined)
