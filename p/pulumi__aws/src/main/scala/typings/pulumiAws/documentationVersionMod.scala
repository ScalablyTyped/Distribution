...
object documentationVersionMod {
  ...
  object DocumentationVersion {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): DocumentationVersion = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[DocumentationVersion]
    inline def get(name: String, id: Input[ID], state: Unit, opts: CustomResourceOptions): DocumentationVersion = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[DocumentationVersion]
    inline def get(name: String, id: Input[ID], state: DocumentationVersionState): DocumentationVersion = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[DocumentationVersion]
    inline def get(name: String, id: Input[ID], state: DocumentationVersionState, opts: CustomResourceOptions): DocumentationVersion = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], state.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[DocumentationVersion]
  ...
  object DocumentationVersionArgs {
    ...
    inline def apply(restApiId: Input[String], version: Input[String]): DocumentationVersionArgs = {
    ...
    extension [Self <: DocumentationVersionArgs](x: Self) {
  ...
  object DocumentationVersionState {
    ...
    inline def apply(): DocumentationVersionState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[DocumentationVersionState]
    }
    
    extension [Self <: DocumentationVersionState](x: Self) {
