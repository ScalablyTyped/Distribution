...
trait JavaAppLayerArgs extends js.Object {
  /**
    * Keyword for the application container to use. Defaults to "tomcat".
    */
  val appServer: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
    * Version of the selected application container to use. Defaults to "7".
    */
  val appServerVersion: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val jvmOptions: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
    * Keyword for the type of JVM to use. Defaults to `openjdk`.
    */
  val jvmType: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
    * Version of JVM to use. Defaults to "7".
    */
  val jvmVersion: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
...
object JavaAppLayerArgs {
  ...
  def apply(
    ...
    appServer: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null,
    appServerVersion: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null,
    ...
    jvmOptions: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null,
    jvmType: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null,
    jvmVersion: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null,
