...
class JavaAppLayer protected ()
  ...
  /**
    ...
    */
  val appServerVersion: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val jvmOptions: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * Keyword for the type of JVM to use. Defaults to `openjdk`.
    */
  val jvmType: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * Version of JVM to use. Defaults to "7".
    */
  val jvmVersion: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
