...
trait JobState extends js.Object {
  ...
  /**
    ...
    */
  val command: js.UndefOr[atPulumiPulumiLib.outputMod.Input[atPulumiAwsLib.Anon_NameScriptLocationInput]] = js.undefined
  /**
...
object JobState {
  ...
  def apply(
    ...
    command: atPulumiPulumiLib.outputMod.Input[atPulumiAwsLib.Anon_NameScriptLocationInput] = null,
