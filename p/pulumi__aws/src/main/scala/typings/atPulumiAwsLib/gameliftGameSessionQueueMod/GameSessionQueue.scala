...
class GameSessionQueue protected ()
  ...
  /**
    ...
    */
  val destinations: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[js.Array[java.lang.String]]] = js.native
  /**
  ...
  /**
    ...
    */
  val playerLatencyPolicies: atPulumiPulumiLib.pulumiMod.Output[
    js.UndefOr[js.Array[atPulumiAwsLib.Anon_MaximumIndividualPlayerLatencyMilliseconds]]
  ] = js.native
  /**
    * Maximum time a game session request can remain in the queue.
    */
  val timeoutInSeconds: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Double]] = js.native
}
