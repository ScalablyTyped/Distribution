...
class SslNegotiationPolicy protected ()
  extends atPulumiAwsLib.elasticloadbalancingSslNegotiationPolicyMod.SslNegotiationPolicy {
  /**
    ...
    */
  def this(name: java.lang.String, args: atPulumiAwsLib.elasticloadbalancingSslNegotiationPolicyMod.SslNegotiationPolicyArgs) = this()
...
object SslNegotiationPolicy extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.resourceMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.elasticloadbalancingSslNegotiationPolicyMod.SslNegotiationPolicy = js.native
  def get(
