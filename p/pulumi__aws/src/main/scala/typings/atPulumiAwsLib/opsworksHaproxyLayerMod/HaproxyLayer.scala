...
class HaproxyLayer protected ()
  ...
  /**
    ...
    */
  val healthcheckMethod: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * URL path to use for instance healthchecks. Defaults to "/".
    */
  val healthcheckUrl: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val statsEnabled: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * The password to use for HAProxy stats.
    */
  val statsPassword: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * The HAProxy stats URL. Defaults to "/haproxy?stats".
    */
  val statsUrl: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * The username for HAProxy stats. Defaults to "opsworks".
    */
  val statsUser: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
