...
class HaproxyLayer protected ()
  ...
  /**
    ...
    */
  val healthcheckMethod: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * URL path to use for instance healthchecks. Defaults to "/".
    */
  val healthcheckUrl: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val statsEnabled: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * The password to use for HAProxy stats.
    */
  val statsPassword: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The HAProxy stats URL. Defaults to "/haproxy?stats".
    */
  val statsUrl: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * The username for HAProxy stats. Defaults to "opsworks".
    */
  val statsUser: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
