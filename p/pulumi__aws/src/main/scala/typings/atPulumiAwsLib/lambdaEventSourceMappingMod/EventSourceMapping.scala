...
class EventSourceMapping protected ()
  ...
  /**
    ...
    */
  val batchSize: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
  ...
  /**
    ...
    */
  val eventSourceArn: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * The the ARN of the Lambda function the event source mapping is sending events to. (Note: this is a computed value that differs from `function_name` above.)
    */
  val functionArn: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * The name or the ARN of the Lambda function that will be subscribing to events.
    */
  val functionName: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val lastProcessingResult: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * The position in the stream where AWS Lambda should start reading. Must be one of `AT_TIMESTAMP` (Kinesis only), `LATEST` or `TRIM_HORIZON` if getting events from Kinesis or DynamoDB. Must not be provided if getting events from SQS. More information about these positions can be found in the [AWS DynamoDB Streams API Reference](https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_streams_GetShardIterator.html) and [AWS Kinesis API Reference](https://docs.aws.amazon.com/kinesis/latest/APIReference/API_GetShardIterator.html#Kinesis-GetShardIterator-request-ShardIteratorType).
    */
  val startingPosition: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * A timestamp in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8) of the data record which to start reading when using `starting_position` set to `AT_TIMESTAMP`. If a record with this exact timestamp does not exist, the next later record is chosen. If the timestamp is older than the current trim horizon, the oldest available record is chosen.
    */
  val startingPositionTimestamp: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val stateTransitionReason: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * The UUID of the created event source mapping.
    */
  val uuid: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
}
