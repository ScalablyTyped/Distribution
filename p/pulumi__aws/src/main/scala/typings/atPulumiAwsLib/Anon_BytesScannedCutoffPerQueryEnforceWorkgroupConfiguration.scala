...
trait Anon_BytesScannedCutoffPerQueryEnforceWorkgroupConfiguration extends js.Object {
  var bytesScannedCutoffPerQuery: js.UndefOr[atPulumiPulumiLib.outputMod.Input[scala.Double]] = js.undefined
  var enforceWorkgroupConfiguration: js.UndefOr[atPulumiPulumiLib.outputMod.Input[scala.Boolean]] = js.undefined
  var publishCloudwatchMetricsEnabled: js.UndefOr[atPulumiPulumiLib.outputMod.Input[scala.Boolean]] = js.undefined
  var resultConfiguration: js.UndefOr[atPulumiPulumiLib.outputMod.Input[Anon_EncryptionConfigurationOutputLocation]] = js.undefined
}

object Anon_BytesScannedCutoffPerQueryEnforceWorkgroupConfiguration {
  @scala.inline
  def apply(
    bytesScannedCutoffPerQuery: atPulumiPulumiLib.outputMod.Input[scala.Double] = null,
    enforceWorkgroupConfiguration: atPulumiPulumiLib.outputMod.Input[scala.Boolean] = null,
    publishCloudwatchMetricsEnabled: atPulumiPulumiLib.outputMod.Input[scala.Boolean] = null,
    resultConfiguration: atPulumiPulumiLib.outputMod.Input[Anon_EncryptionConfigurationOutputLocation] = null
