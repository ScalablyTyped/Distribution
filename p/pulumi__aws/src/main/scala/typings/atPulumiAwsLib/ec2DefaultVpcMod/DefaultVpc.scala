...
class DefaultVpc protected ()
  ...
  /**
    ...
    */
  val assignGeneratedIpv6CidrBlock: atPulumiPulumiLib.pulumiMod.Output[scala.Boolean] = js.native
  /**
  ...
  /**
    ...
    */
  val instanceTenancy: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
