...
object ^ extends js.Object {
  ...
  def getAvailabilityZones(args: GetAvailabilityZonesArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetAvailabilityZonesResult] with GetAvailabilityZonesResult = js.native
}
