...
object ^ extends js.Object {
  ...
  def getCertificateAuthority(args: GetCertificateAuthorityArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetCertificateAuthorityResult] with GetCertificateAuthorityResult = js.native
}
