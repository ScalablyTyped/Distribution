...
@js.native
object batchGetJobQueueModMembers extends js.Object {
  def getJobQueue(args: GetJobQueueArgs): js.Promise[GetJobQueueResult] = js.native
  def getJobQueue(args: GetJobQueueArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetJobQueueResult] = js.native
}
