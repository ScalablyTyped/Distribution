...
trait Anon_EncryptionConfiguration extends js.Object {
  ...
  var outputLocation: js.UndefOr[java.lang.String] = js.undefined
}

object Anon_EncryptionConfiguration {
  @scala.inline
  def apply(
    encryptionConfiguration: Anon_EncryptionOptionKmsKeyArn = null,
    outputLocation: java.lang.String = null
  ): Anon_EncryptionConfiguration = {
