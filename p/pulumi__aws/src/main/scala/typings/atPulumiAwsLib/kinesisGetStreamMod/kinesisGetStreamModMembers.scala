...
@js.native
object kinesisGetStreamModMembers extends js.Object {
  def getStream(args: GetStreamArgs): js.Promise[GetStreamResult] = js.native
  def getStream(args: GetStreamArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetStreamResult] = js.native
}
