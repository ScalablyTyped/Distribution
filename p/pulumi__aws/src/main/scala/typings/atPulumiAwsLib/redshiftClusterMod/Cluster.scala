...
class Cluster protected ()
  ...
  /**
    ...
    */
  val allowVersionUpgrade: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * The number of days that automated snapshots are retained. If the value is 0, automated snapshots are disabled. Even if automated snapshots are disabled, you can still create manual snapshots when you want with create-cluster-snapshot. Default is 1.
    */
  val automatedSnapshotRetentionPeriod: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
  ...
  /**
    ...
    */
  val clusterParameterGroupName: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The public key for the cluster
    */
  val clusterPublicKey: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The specific revision number of the database in the cluster
    */
  val clusterRevisionNumber: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * A list of security groups to be associated with this cluster.
    */
  val clusterSecurityGroups: atPulumiPulumiLib.pulumiMod.Output[js.Array[java.lang.String]] = js.native
  /**
    * The name of a cluster subnet group to be associated with this cluster. If this parameter is not provided the resulting cluster will be deployed outside virtual private cloud (VPC).
    */
  val clusterSubnetGroupName: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The cluster type to use. Either `single-node` or `multi-node`.
    */
  val clusterType: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The version of the Amazon Redshift engine software that you want to deploy on the cluster.
    * The version selected runs on all the nodes in the cluster.
    */
  val clusterVersion: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val elasticIp: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  val enableLogging: atPulumiPulumiLib.pulumiMod.Output[scala.Boolean] = js.native
  /**
  ...
  /**
    ...
    */
  val enhancedVpcRouting: atPulumiPulumiLib.pulumiMod.Output[scala.Boolean] = js.native
  /**
  ...
  /**
    ...
    */
  val iamRoles: atPulumiPulumiLib.pulumiMod.Output[js.Array[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val masterPassword: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * Username for the master DB user.
    */
  val masterUsername: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val numberOfNodes: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
    * The AWS customer account used to create or copy the snapshot. Required if you are restoring a snapshot you do not own, optional if you own the snapshot.
    */
  val ownerAccount: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val s3KeyPrefix: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val snapshotClusterIdentifier: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
