...
trait LaunchConfigurationArgs extends js.Object {
  ...
  /**
    ...
    */
  val enableMonitoring: js.UndefOr[atPulumiPulumiLib.outputMod.Input[scala.Boolean]] = js.undefined
  /**
  ...
  /**
    ...
    * for more details
    */
  val placementTenancy: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val vpcClassicLinkId: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
