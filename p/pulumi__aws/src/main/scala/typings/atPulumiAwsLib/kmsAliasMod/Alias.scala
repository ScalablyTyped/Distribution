...
class Alias protected ()
  ...
  /**
    ...
    */
  val targetKeyArn: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * Identifier for the key for which the alias is for, can be either an ARN or key_id.
    */
  val targetKeyId: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
}
