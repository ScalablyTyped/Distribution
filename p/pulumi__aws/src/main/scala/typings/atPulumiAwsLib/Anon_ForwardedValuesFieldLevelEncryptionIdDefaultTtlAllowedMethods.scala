...
trait Anon_ForwardedValuesFieldLevelEncryptionIdDefaultTtlAllowedMethods extends js.Object {
  ...
  var forwardedValues: atPulumiPulumiLib.resourceMod.Input[Anon_QueryStringCookies]
  var lambdaFunctionAssociations: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[Anon_LambdaArnIncludeBody]]]
  ] = js.undefined
