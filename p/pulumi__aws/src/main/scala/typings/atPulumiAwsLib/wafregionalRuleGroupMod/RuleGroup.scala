...
class RuleGroup protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: RuleGroupArgs) = this()
  def this(name: java.lang.String, args: RuleGroupArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
