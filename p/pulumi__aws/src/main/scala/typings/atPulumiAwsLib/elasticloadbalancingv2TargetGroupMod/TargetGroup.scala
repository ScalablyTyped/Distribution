...
class TargetGroup protected ()
  ...
  /**
    ...
    */
  val deregistrationDelay: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
  ...
  /**
    ...
    */
  val proxyProtocolV2: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * The amount time for targets to warm up before the load balancer sends them a full share of requests. The range is 30-900 seconds or 0 to disable. The default value is 0 seconds.
    */
  val slowStart: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
    * A Stickiness block. Stickiness blocks are documented below. `stickiness` is only valid if used with Load Balancers of type `Application`
    */
  val stickiness: atPulumiPulumiLib.outputMod.Output[atPulumiAwsLib.Anon_CookieDurationEnabled] = js.native
  /**
  ...
  /**
    ...
    */
  val targetType: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    ...
    */
  val vpcId: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
}
