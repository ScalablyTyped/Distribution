...
class Instance protected ()
  ...
  /**
    ...
    */
  val ami: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val associatePublicIpAddress: atPulumiPulumiLib.pulumiMod.Output[scala.Boolean] = js.native
  /**
  ...
  /**
    ...
    */
  val cpuCoreCount: atPulumiPulumiLib.pulumiMod.Output[scala.Double] = js.native
  /**
    * If set to to 1, hyperthreading is disabled on the launched instance. Defaults to 2 if not set. See [Optimizing CPU Options](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-optimize-cpu.html) for more information.
    */
  val cpuThreadsPerCore: atPulumiPulumiLib.pulumiMod.Output[scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  val getPasswordData: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * The Id of a dedicated host that the instance will be assigned to. Use when an instance is to be launched on a specific dedicated host.
    */
  val hostId: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  val instanceState: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  val ipv6AddressCount: atPulumiPulumiLib.pulumiMod.Output[scala.Double] = js.native
  /**
    * Specify one or more IPv6 addresses from the range of the subnet to associate with the primary network interface
    */
  val ipv6Addresses: atPulumiPulumiLib.pulumiMod.Output[js.Array[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val monitoring: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
  ...
  /**
    ...
    */
  val networkInterfaces: atPulumiPulumiLib.pulumiMod.Output[js.Array[atPulumiAwsLib.Anon_DeleteOnTerminationDeviceIndex]] = js.native
  /**
    ...
    */
  val passwordData: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The Placement Group to start the instance in.
    */
  val placementGroup: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The ID of the instance's primary network interface.
    */
  val primaryNetworkInterfaceId: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val volumeTags: atPulumiPulumiLib.pulumiMod.Output[org.scalablytyped.runtime.StringDictionary[_]] = js.native
  /**
