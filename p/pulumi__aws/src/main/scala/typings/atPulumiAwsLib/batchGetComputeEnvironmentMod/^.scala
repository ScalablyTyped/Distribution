...
object ^ extends js.Object {
  ...
  def getComputeEnvironment(args: GetComputeEnvironmentArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetComputeEnvironmentResult] with GetComputeEnvironmentResult = js.native
}
