...
object ^ extends js.Object {
  ...
  def getNetworkInterfaces(args: GetNetworkInterfacesArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetNetworkInterfacesResult] with GetNetworkInterfacesResult = js.native
}
