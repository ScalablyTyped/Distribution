...
class PhpAppLayer protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: PhpAppLayerArgs) = this()
  def this(name: java.lang.String, args: PhpAppLayerArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
