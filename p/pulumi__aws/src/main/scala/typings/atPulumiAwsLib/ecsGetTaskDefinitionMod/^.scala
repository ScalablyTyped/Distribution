...
object ^ extends js.Object {
  ...
  def getTaskDefinition(args: GetTaskDefinitionArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetTaskDefinitionResult] with GetTaskDefinitionResult = js.native
}
