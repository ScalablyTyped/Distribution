...
class ConfigurationAggregator protected ()
  ...
  def this(name: java.lang.String, args: ConfigurationAggregatorArgs) = this()
  def this(name: java.lang.String, args: ConfigurationAggregatorArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
