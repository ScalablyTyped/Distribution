...
object ^ extends js.Object {
  ...
  def getInstanceProfile(args: GetInstanceProfileArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetInstanceProfileResult] with GetInstanceProfileResult = js.native
}
