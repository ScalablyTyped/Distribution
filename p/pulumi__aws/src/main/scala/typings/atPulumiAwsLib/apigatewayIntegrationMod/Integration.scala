...
class Integration protected ()
  ...
  /**
    ...
    */
  val cacheKeyParameters: atPulumiPulumiLib.outputMod.Output[js.UndefOr[js.Array[java.lang.String]]] = js.native
  /**
    * The integration's cache namespace.
    */
  val cacheNamespace: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * The id of the VpcLink used for the integration. **Required** if `connection_type` is `VPC_LINK`
    */
  val connectionId: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val credentials: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val integrationHttpMethod: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * The integration passthrough behavior (`WHEN_NO_MATCH`, `WHEN_NO_TEMPLATES`, `NEVER`).  **Required** if `request_templates` is used.
    */
  val passthroughBehavior: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val timeoutMilliseconds: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
  ...
  /**
    ...
    */
  val uri: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
}
