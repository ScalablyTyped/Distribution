...
trait ServiceState extends js.Object {
  ...
  /**
    ...
    */
  val taskDefinition: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
...
object ServiceState {
  ...
  def apply(
    ...
    taskDefinition: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null,
