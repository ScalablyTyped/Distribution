...
class Service protected ()
  ...
  /**
    ...
    */
  val cluster: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val deploymentMaximumPercent: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
    * The lower limit (as a percentage of the service's desiredCount) of the number of running tasks that must remain running and healthy in a service during a deployment.
    */
  val deploymentMinimumHealthyPercent: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
    * The number of instances of the task definition to place and keep running. Defaults to 0. Do not specify if using the `DAEMON` scheduling strategy.
    */
  val desiredCount: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
    * Specifies whether to enable Amazon ECS managed tags for the tasks within the service.
    */
  val enableEcsManagedTags: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    ...
    */
  val healthCheckGracePeriodSeconds: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
  ...
  /**
    ...
    */
  val launchType: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * A load balancer block. Load balancers documented below.
    */
  val loadBalancers: atPulumiPulumiLib.outputMod.Output[js.UndefOr[js.Array[atPulumiAwsLib.Anon_ContainerName]]] = js.native
  /**
  ...
  /**
    ...
    */
  val networkConfiguration: atPulumiPulumiLib.outputMod.Output[js.UndefOr[atPulumiAwsLib.Anon_AssignPublicIp]] = js.native
  /**
    ...
    */
  val orderedPlacementStrategies: atPulumiPulumiLib.outputMod.Output[js.UndefOr[js.Array[atPulumiAwsLib.Anon_FieldType]]] = js.native
  /**
  ...
  /**
    ...
    */
  val placementStrategies: atPulumiPulumiLib.outputMod.Output[js.UndefOr[js.Array[atPulumiAwsLib.Anon_FieldType]]] = js.native
  /**
  ...
  /**
    ...
    */
  val propagateTags: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    ...
    */
  val schedulingStrategy: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * The service discovery registries for the service. The maximum number of `service_registries` blocks is `1`.
    */
  val serviceRegistries: atPulumiPulumiLib.outputMod.Output[js.UndefOr[atPulumiAwsLib.Anon_ContainerNameContainerPort]] = js.native
  /**
