...
class AmiCopy protected ()
  ...
  /**
    ...
    */
  val architecture: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val ebsBlockDevices: atPulumiPulumiLib.atPulumiPulumiMod.Output[js.Array[atPulumiAwsLib.Anon_DeleteOnTerminationDeviceNameEncrypted]] = js.native
  /**
    * Specifies whether enhanced networking with ENA is enabled. Defaults to `false`.
    */
  val enaSupport: atPulumiPulumiLib.atPulumiPulumiMod.Output[scala.Boolean] = js.native
  /**
  ...
  /**
    ...
    */
  val kernelId: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    * created instances.
    */
  val ramdiskId: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
    * The name of the root device (for example, `/dev/sda1`, or `/dev/xvda`).
    */
  val rootDeviceName: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  val rootSnapshotId: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
    * The id of the AMI to copy. This id must be valid in the region
    * given by `source_ami_region`.
    */
  val sourceAmiId: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
    * The region from which the AMI will be copied. This may be the
    * same as the AWS provider region in order to create a copy within the same region.
    */
  val sourceAmiRegion: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
