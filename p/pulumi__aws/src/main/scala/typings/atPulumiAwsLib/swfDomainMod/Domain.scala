...
class Domain protected ()
  ...
  /**
    ...
    */
  val workflowExecutionRetentionPeriodInDays: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
}
...
object Domain extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.outputMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.swfDomainMod.Domain = js.native
  def get(
