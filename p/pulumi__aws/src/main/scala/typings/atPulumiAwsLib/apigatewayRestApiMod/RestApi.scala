...
class RestApi protected ()
  ...
  /**
    ...
    */
  val apiKeySource: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * The list of binary media types supported by the RestApi. By default, the RestApi supports only UTF-8-encoded text payloads.
    */
  val binaryMediaTypes: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[js.Array[java.lang.String]]] = js.native
  /**
    * An OpenAPI specification that defines the set of routes and integrations to create as part of the REST API.
    */
  val body: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val endpointConfiguration: atPulumiPulumiLib.pulumiMod.Output[atPulumiAwsLib.Anon_Types] = js.native
  /**
  ...
  /**
    ...
    */
  val minimumCompressionSize: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
  ...
  /**
    ...
    */
  val rootResourceId: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
}
