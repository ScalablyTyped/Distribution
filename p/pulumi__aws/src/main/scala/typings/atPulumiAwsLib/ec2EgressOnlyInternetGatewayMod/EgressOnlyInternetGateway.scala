...
class EgressOnlyInternetGateway protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: EgressOnlyInternetGatewayArgs) = this()
  def this(name: java.lang.String, args: EgressOnlyInternetGatewayArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
