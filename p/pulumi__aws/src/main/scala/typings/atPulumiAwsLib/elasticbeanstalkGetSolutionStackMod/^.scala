...
object ^ extends js.Object {
  ...
  def getSolutionStack(args: GetSolutionStackArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetSolutionStackResult] with GetSolutionStackResult = js.native
}
