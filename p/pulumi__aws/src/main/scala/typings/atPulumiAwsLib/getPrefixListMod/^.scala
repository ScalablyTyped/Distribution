...
object ^ extends js.Object {
  ...
  def getPrefixList(args: GetPrefixListArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetPrefixListResult] with GetPrefixListResult = js.native
}
