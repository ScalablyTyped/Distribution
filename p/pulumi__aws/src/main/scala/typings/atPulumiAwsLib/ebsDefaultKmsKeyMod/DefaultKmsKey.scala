...
class DefaultKmsKey protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: DefaultKmsKeyArgs) = this()
  def this(name: java.lang.String, args: DefaultKmsKeyArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
    * The ARN of the AWS Key Management Service (AWS KMS) customer master key (CMK) to use to encrypt the EBS volume.
    */
  val keyArn: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
}
