...
trait Anon_LocationReportBuildStatusInsecureSslGitCloneDepth extends js.Object {
  var auths: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[Anon_ResourceTypeInput]]]
  ] = js.undefined
