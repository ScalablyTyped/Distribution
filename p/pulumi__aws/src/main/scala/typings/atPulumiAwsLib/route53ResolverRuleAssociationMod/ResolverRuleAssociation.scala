...
class ResolverRuleAssociation protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: ResolverRuleAssociationArgs) = this()
  def this(name: java.lang.String, args: ResolverRuleAssociationArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
  ...
  /**
    ...
    */
  val resolverRuleId: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
