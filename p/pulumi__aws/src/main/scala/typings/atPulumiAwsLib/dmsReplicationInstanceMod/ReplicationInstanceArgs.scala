...
trait ReplicationInstanceArgs extends js.Object {
  ...
  /**
    ...
    */
  val replicationInstanceClass: atPulumiPulumiLib.outputMod.Input[java.lang.String]
  /**
    * The replication instance identifier. This parameter is stored as a lowercase string.
    */
  val replicationInstanceId: atPulumiPulumiLib.outputMod.Input[java.lang.String]
  /**
...
object ReplicationInstanceArgs {
  @scala.inline
  def apply(
    replicationInstanceClass: atPulumiPulumiLib.outputMod.Input[java.lang.String],
    replicationInstanceId: atPulumiPulumiLib.outputMod.Input[java.lang.String],
