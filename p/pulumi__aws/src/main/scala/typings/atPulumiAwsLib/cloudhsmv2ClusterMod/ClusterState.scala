...
trait ClusterState extends js.Object {
  ...
  val clusterCertificates: js.UndefOr[
    atPulumiPulumiLib.outputMod.Input[atPulumiAwsLib.Anon_AwsHardwareCertificateClusterCertificate]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  val hsmType: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
