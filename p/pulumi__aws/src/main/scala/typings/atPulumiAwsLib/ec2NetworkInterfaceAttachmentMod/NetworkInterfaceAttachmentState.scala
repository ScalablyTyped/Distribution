...
trait NetworkInterfaceAttachmentState extends js.Object {
  /**
    ...
    */
  val attachmentId: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
    * Network interface index (int).
    */
  val deviceIndex: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[scala.Double]] = js.undefined
  /**
