...
object ^ extends js.Object {
  ...
  def getServiceAccount(args: GetServiceAccountArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetServiceAccountResult] with GetServiceAccountResult = js.native
}
