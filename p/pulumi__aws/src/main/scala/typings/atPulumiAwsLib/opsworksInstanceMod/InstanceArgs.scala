...
trait InstanceArgs extends js.Object {
  ...
  /**
    ...
    */
  val layerIds: atPulumiPulumiLib.outputMod.Input[js.Array[atPulumiPulumiLib.outputMod.Input[java.lang.String]]]
  /**
...
object InstanceArgs {
  @scala.inline
  def apply(
    layerIds: atPulumiPulumiLib.outputMod.Input[js.Array[atPulumiPulumiLib.outputMod.Input[java.lang.String]]],
