...
class Cluster protected ()
  ...
  /**
    ...
    */
  val cacheNodes: atPulumiPulumiLib.outputMod.Output[js.Array[atPulumiAwsLib.Anon_Address]] = js.native
  /**
    * (Memcached only) The DNS name of the cache cluster without the port appended.
    */
  val clusterAddress: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val configurationEndpoint: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val numCacheNodes: atPulumiPulumiLib.outputMod.Output[scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  val preferredAvailabilityZones: atPulumiPulumiLib.outputMod.Output[js.UndefOr[js.Array[java.lang.String]]] = js.native
  /**
