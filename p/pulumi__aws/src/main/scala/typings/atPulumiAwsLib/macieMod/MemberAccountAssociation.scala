...
class MemberAccountAssociation protected ()
  extends atPulumiAwsLib.macieMemberAccountAssociationMod.MemberAccountAssociation {
  /**
...
object MemberAccountAssociation extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.outputMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.macieMemberAccountAssociationMod.MemberAccountAssociation = js.native
  def get(
