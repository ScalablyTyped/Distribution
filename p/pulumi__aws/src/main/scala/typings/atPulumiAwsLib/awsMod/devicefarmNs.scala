...
object devicefarmNs extends js.Object {
  ...
  class Project protected ()
    extends atPulumiAwsLib.devicefarmMod.Project {
    /**
    ...
    def this(name: java.lang.String, args: atPulumiAwsLib.devicefarmProjectMod.ProjectArgs) = this()
  ...
  object Project extends js.Object {
    /**
      ...
      */
    def get(name: java.lang.String, id: atPulumiPulumiLib.resourceMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.devicefarmProjectMod.Project = js.native
    def get(
