...
object cloud9Ns extends js.Object {
  ...
  class EnvironmentEC2 protected ()
    extends atPulumiAwsLib.cloud9Mod.EnvironmentEC2 {
    /**
  ...
  object EnvironmentEC2 extends js.Object {
    /**
      ...
      */
    def get(name: java.lang.String, id: atPulumiPulumiLib.resourceMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.cloud9EnvironmentEC2Mod.EnvironmentEC2 = js.native
    def get(
