...
object ^ extends js.Object {
  ...
  def getVpcPeeringConnection(args: GetVpcPeeringConnectionArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetVpcPeeringConnectionResult] with GetVpcPeeringConnectionResult = js.native
}
