...
object ramNs extends js.Object {
  ...
  object ResourceShare extends js.Object {
    /**
      ...
      */
    def get(name: java.lang.String, id: atPulumiPulumiLib.resourceMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.ramResourceShareMod.ResourceShare = js.native
    def get(
