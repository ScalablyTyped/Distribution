...
object ecsNs extends js.Object {
  ...
  def getCluster(args: atPulumiAwsLib.ecsGetClusterMod.GetClusterArgs): js.Promise[atPulumiAwsLib.ecsGetClusterMod.GetClusterResult] with atPulumiAwsLib.ecsGetClusterMod.GetClusterResult = js.native
  def getCluster(
    args: atPulumiAwsLib.ecsGetClusterMod.GetClusterArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.ecsGetClusterMod.GetClusterResult] with atPulumiAwsLib.ecsGetClusterMod.GetClusterResult = js.native
  def getContainerDefinition(args: atPulumiAwsLib.ecsGetContainerDefinitionMod.GetContainerDefinitionArgs): js.Promise[atPulumiAwsLib.ecsGetContainerDefinitionMod.GetContainerDefinitionResult] with atPulumiAwsLib.ecsGetContainerDefinitionMod.GetContainerDefinitionResult = js.native
  def getContainerDefinition(
    args: atPulumiAwsLib.ecsGetContainerDefinitionMod.GetContainerDefinitionArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.ecsGetContainerDefinitionMod.GetContainerDefinitionResult] with atPulumiAwsLib.ecsGetContainerDefinitionMod.GetContainerDefinitionResult = js.native
  def getService(args: atPulumiAwsLib.ecsGetServiceMod.GetServiceArgs): js.Promise[atPulumiAwsLib.ecsGetServiceMod.GetServiceResult] with atPulumiAwsLib.ecsGetServiceMod.GetServiceResult = js.native
  def getService(
    args: atPulumiAwsLib.ecsGetServiceMod.GetServiceArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.ecsGetServiceMod.GetServiceResult] with atPulumiAwsLib.ecsGetServiceMod.GetServiceResult = js.native
  def getTaskDefinition(args: atPulumiAwsLib.ecsGetTaskDefinitionMod.GetTaskDefinitionArgs): js.Promise[atPulumiAwsLib.ecsGetTaskDefinitionMod.GetTaskDefinitionResult] with atPulumiAwsLib.ecsGetTaskDefinitionMod.GetTaskDefinitionResult = js.native
  def getTaskDefinition(
    args: atPulumiAwsLib.ecsGetTaskDefinitionMod.GetTaskDefinitionArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.ecsGetTaskDefinitionMod.GetTaskDefinitionResult] with atPulumiAwsLib.ecsGetTaskDefinitionMod.GetTaskDefinitionResult = js.native
  /* static members */
  @js.native
