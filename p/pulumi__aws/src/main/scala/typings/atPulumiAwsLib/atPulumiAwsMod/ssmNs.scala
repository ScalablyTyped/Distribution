...
object ssmNs extends js.Object {
  ...
  def getDocument(args: atPulumiAwsLib.ssmGetDocumentMod.GetDocumentArgs): js.Promise[atPulumiAwsLib.ssmGetDocumentMod.GetDocumentResult] with atPulumiAwsLib.ssmGetDocumentMod.GetDocumentResult = js.native
  def getDocument(
    args: atPulumiAwsLib.ssmGetDocumentMod.GetDocumentArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.ssmGetDocumentMod.GetDocumentResult] with atPulumiAwsLib.ssmGetDocumentMod.GetDocumentResult = js.native
  def getParameter(args: atPulumiAwsLib.ssmGetParameterMod.GetParameterArgs): js.Promise[atPulumiAwsLib.ssmGetParameterMod.GetParameterResult] with atPulumiAwsLib.ssmGetParameterMod.GetParameterResult = js.native
  def getParameter(
    args: atPulumiAwsLib.ssmGetParameterMod.GetParameterArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.ssmGetParameterMod.GetParameterResult] with atPulumiAwsLib.ssmGetParameterMod.GetParameterResult = js.native
  /* static members */
  @js.native
