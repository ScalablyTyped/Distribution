...
object ebsNs extends js.Object {
  ...
  def getDefaultKmsKey(): js.Promise[atPulumiAwsLib.ebsGetDefaultKmsKeyMod.GetDefaultKmsKeyResult] with atPulumiAwsLib.ebsGetDefaultKmsKeyMod.GetDefaultKmsKeyResult = js.native
  def getDefaultKmsKey(opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[atPulumiAwsLib.ebsGetDefaultKmsKeyMod.GetDefaultKmsKeyResult] with atPulumiAwsLib.ebsGetDefaultKmsKeyMod.GetDefaultKmsKeyResult = js.native
  def getEncryptionByDefault(): js.Promise[atPulumiAwsLib.ebsGetEncryptionByDefaultMod.GetEncryptionByDefaultResult] with atPulumiAwsLib.ebsGetEncryptionByDefaultMod.GetEncryptionByDefaultResult = js.native
  def getEncryptionByDefault(opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[atPulumiAwsLib.ebsGetEncryptionByDefaultMod.GetEncryptionByDefaultResult] with atPulumiAwsLib.ebsGetEncryptionByDefaultMod.GetEncryptionByDefaultResult = js.native
  def getSnapshot(): js.Promise[atPulumiAwsLib.ebsGetSnapshotMod.GetSnapshotResult] with atPulumiAwsLib.ebsGetSnapshotMod.GetSnapshotResult = js.native
  def getSnapshot(args: atPulumiAwsLib.ebsGetSnapshotMod.GetSnapshotArgs): js.Promise[atPulumiAwsLib.ebsGetSnapshotMod.GetSnapshotResult] with atPulumiAwsLib.ebsGetSnapshotMod.GetSnapshotResult = js.native
  def getSnapshot(
    args: atPulumiAwsLib.ebsGetSnapshotMod.GetSnapshotArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.ebsGetSnapshotMod.GetSnapshotResult] with atPulumiAwsLib.ebsGetSnapshotMod.GetSnapshotResult = js.native
  def getSnapshotIds(): js.Promise[atPulumiAwsLib.ebsGetSnapshotIdsMod.GetSnapshotIdsResult] with atPulumiAwsLib.ebsGetSnapshotIdsMod.GetSnapshotIdsResult = js.native
  def getSnapshotIds(args: atPulumiAwsLib.ebsGetSnapshotIdsMod.GetSnapshotIdsArgs): js.Promise[atPulumiAwsLib.ebsGetSnapshotIdsMod.GetSnapshotIdsResult] with atPulumiAwsLib.ebsGetSnapshotIdsMod.GetSnapshotIdsResult = js.native
  def getSnapshotIds(
    args: atPulumiAwsLib.ebsGetSnapshotIdsMod.GetSnapshotIdsArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.ebsGetSnapshotIdsMod.GetSnapshotIdsResult] with atPulumiAwsLib.ebsGetSnapshotIdsMod.GetSnapshotIdsResult = js.native
  def getVolume(): js.Promise[atPulumiAwsLib.ebsGetVolumeMod.GetVolumeResult] with atPulumiAwsLib.ebsGetVolumeMod.GetVolumeResult = js.native
  def getVolume(args: atPulumiAwsLib.ebsGetVolumeMod.GetVolumeArgs): js.Promise[atPulumiAwsLib.ebsGetVolumeMod.GetVolumeResult] with atPulumiAwsLib.ebsGetVolumeMod.GetVolumeResult = js.native
  def getVolume(
    args: atPulumiAwsLib.ebsGetVolumeMod.GetVolumeArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.ebsGetVolumeMod.GetVolumeResult] with atPulumiAwsLib.ebsGetVolumeMod.GetVolumeResult = js.native
  /* static members */
  @js.native
