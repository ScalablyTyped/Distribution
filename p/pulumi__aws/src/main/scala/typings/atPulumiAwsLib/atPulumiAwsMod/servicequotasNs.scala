...
object servicequotasNs extends js.Object {
  ...
  class ServiceQuota protected ()
    extends atPulumiAwsLib.servicequotasMod.ServiceQuota {
    /**
  ...
  def getService(args: atPulumiAwsLib.servicequotasGetServiceMod.GetServiceArgs): js.Promise[atPulumiAwsLib.servicequotasGetServiceMod.GetServiceResult] with atPulumiAwsLib.servicequotasGetServiceMod.GetServiceResult = js.native
  def getService(
    args: atPulumiAwsLib.servicequotasGetServiceMod.GetServiceArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.servicequotasGetServiceMod.GetServiceResult] with atPulumiAwsLib.servicequotasGetServiceMod.GetServiceResult = js.native
  def getServiceQuota(args: atPulumiAwsLib.servicequotasGetServiceQuotaMod.GetServiceQuotaArgs): js.Promise[atPulumiAwsLib.servicequotasGetServiceQuotaMod.GetServiceQuotaResult] with atPulumiAwsLib.servicequotasGetServiceQuotaMod.GetServiceQuotaResult = js.native
  def getServiceQuota(
    args: atPulumiAwsLib.servicequotasGetServiceQuotaMod.GetServiceQuotaArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.servicequotasGetServiceQuotaMod.GetServiceQuotaResult] with atPulumiAwsLib.servicequotasGetServiceQuotaMod.GetServiceQuotaResult = js.native
  /* static members */
  @js.native
