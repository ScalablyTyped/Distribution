...
object kmsNs extends js.Object {
  ...
  def getAlias(args: atPulumiAwsLib.kmsGetAliasMod.GetAliasArgs): js.Promise[atPulumiAwsLib.kmsGetAliasMod.GetAliasResult] with atPulumiAwsLib.kmsGetAliasMod.GetAliasResult = js.native
  def getAlias(args: atPulumiAwsLib.kmsGetAliasMod.GetAliasArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[atPulumiAwsLib.kmsGetAliasMod.GetAliasResult] with atPulumiAwsLib.kmsGetAliasMod.GetAliasResult = js.native
  def getCipherText(args: atPulumiAwsLib.kmsGetCipherTextMod.GetCipherTextArgs): js.Promise[atPulumiAwsLib.kmsGetCipherTextMod.GetCipherTextResult] with atPulumiAwsLib.kmsGetCipherTextMod.GetCipherTextResult = js.native
  def getCipherText(
    args: atPulumiAwsLib.kmsGetCipherTextMod.GetCipherTextArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.kmsGetCipherTextMod.GetCipherTextResult] with atPulumiAwsLib.kmsGetCipherTextMod.GetCipherTextResult = js.native
  def getKey(args: atPulumiAwsLib.kmsGetKeyMod.GetKeyArgs): js.Promise[atPulumiAwsLib.kmsGetKeyMod.GetKeyResult] with atPulumiAwsLib.kmsGetKeyMod.GetKeyResult = js.native
  def getKey(args: atPulumiAwsLib.kmsGetKeyMod.GetKeyArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[atPulumiAwsLib.kmsGetKeyMod.GetKeyResult] with atPulumiAwsLib.kmsGetKeyMod.GetKeyResult = js.native
  def getSecret(args: atPulumiAwsLib.kmsGetSecretMod.GetSecretArgs): js.Promise[atPulumiAwsLib.kmsGetSecretMod.GetSecretResult] with atPulumiAwsLib.kmsGetSecretMod.GetSecretResult = js.native
  def getSecret(
    args: atPulumiAwsLib.kmsGetSecretMod.GetSecretArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.kmsGetSecretMod.GetSecretResult] with atPulumiAwsLib.kmsGetSecretMod.GetSecretResult = js.native
  def getSecrets(args: atPulumiAwsLib.kmsGetSecretsMod.GetSecretsArgs): js.Promise[atPulumiAwsLib.kmsGetSecretsMod.GetSecretsResult] with atPulumiAwsLib.kmsGetSecretsMod.GetSecretsResult = js.native
  def getSecrets(
    args: atPulumiAwsLib.kmsGetSecretsMod.GetSecretsArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.kmsGetSecretsMod.GetSecretsResult] with atPulumiAwsLib.kmsGetSecretsMod.GetSecretsResult = js.native
  /* static members */
  @js.native
