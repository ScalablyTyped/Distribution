...
object mskNs extends js.Object {
  ...
  def getCluster(args: atPulumiAwsLib.mskGetClusterMod.GetClusterArgs): js.Promise[atPulumiAwsLib.mskGetClusterMod.GetClusterResult] with atPulumiAwsLib.mskGetClusterMod.GetClusterResult = js.native
  def getCluster(
    args: atPulumiAwsLib.mskGetClusterMod.GetClusterArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.mskGetClusterMod.GetClusterResult] with atPulumiAwsLib.mskGetClusterMod.GetClusterResult = js.native
  def getConfiguration(args: atPulumiAwsLib.mskGetConfigurationMod.GetConfigurationArgs): js.Promise[atPulumiAwsLib.mskGetConfigurationMod.GetConfigurationResult] with atPulumiAwsLib.mskGetConfigurationMod.GetConfigurationResult = js.native
  def getConfiguration(
    args: atPulumiAwsLib.mskGetConfigurationMod.GetConfigurationArgs,
    opts: atPulumiPulumiLib.invokeMod.InvokeOptions
  ): js.Promise[atPulumiAwsLib.mskGetConfigurationMod.GetConfigurationResult] with atPulumiAwsLib.mskGetConfigurationMod.GetConfigurationResult = js.native
  /* static members */
  @js.native
