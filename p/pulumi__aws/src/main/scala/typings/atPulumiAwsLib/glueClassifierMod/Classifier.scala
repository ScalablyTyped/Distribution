...
class Classifier protected ()
  ...
  def this(name: java.lang.String, args: ClassifierArgs) = this()
  def this(name: java.lang.String, args: ClassifierArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
