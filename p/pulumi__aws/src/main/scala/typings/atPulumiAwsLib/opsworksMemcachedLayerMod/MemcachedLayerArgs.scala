...
trait MemcachedLayerArgs extends js.Object {
  /**
    ...
    */
  val allocatedMemory: js.UndefOr[atPulumiPulumiLib.outputMod.Input[scala.Double]] = js.undefined
  /**
...
object MemcachedLayerArgs {
  ...
  def apply(
    ...
    allocatedMemory: atPulumiPulumiLib.outputMod.Input[scala.Double] = null,
