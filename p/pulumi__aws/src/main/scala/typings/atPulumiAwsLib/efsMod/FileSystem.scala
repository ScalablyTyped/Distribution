...
object FileSystem extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.resourceMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.efsFileSystemMod.FileSystem = js.native
  def get(
