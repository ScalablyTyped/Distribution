...
object ^ extends js.Object {
  ...
  def getEventCategories(args: GetEventCategoriesArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetEventCategoriesResult] with GetEventCategoriesResult = js.native
}
