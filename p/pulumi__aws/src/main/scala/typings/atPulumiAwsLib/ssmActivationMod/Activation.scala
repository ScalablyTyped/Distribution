...
class Activation protected ()
  ...
  /**
    ...
    */
  val activationCode: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val expirationDate: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * If the current activation has expired.
    */
  val expired: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val registrationCount: atPulumiPulumiLib.pulumiMod.Output[scala.Double] = js.native
  /**
    * The maximum number of managed instances you want to register. The default value is 1 instance.
    */
  val registrationLimit: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Double]] = js.native
}
