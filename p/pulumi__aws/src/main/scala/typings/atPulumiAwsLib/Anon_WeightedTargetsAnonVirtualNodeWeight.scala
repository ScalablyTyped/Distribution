...
trait Anon_WeightedTargetsAnonVirtualNodeWeight extends js.Object {
  var weightedTargets: atPulumiPulumiLib.outputMod.Input[js.Array[atPulumiPulumiLib.outputMod.Input[Anon_VirtualNodeWeight]]]
}

object Anon_WeightedTargetsAnonVirtualNodeWeight {
  @scala.inline
  def apply(
