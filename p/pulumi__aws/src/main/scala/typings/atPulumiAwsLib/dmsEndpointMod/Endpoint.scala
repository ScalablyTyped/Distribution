...
class Endpoint protected ()
  ...
  /**
    ...
    */
  val databaseName: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * The Amazon Resource Name (ARN) for the endpoint.
    */
  val endpointArn: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The database endpoint identifier.
    */
  val endpointId: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The type of endpoint. Can be one of `source | target`.
    */
  val endpointType: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val extraConnectionAttributes: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val mongodbSettings: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[atPulumiAwsLib.Anon_AuthTypeExtractDocId]] = js.native
  /**
  ...
  /**
    ...
    */
  val s3Settings: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[atPulumiAwsLib.Anon_ExternalTableDefinitionCsvDelimiter]] = js.native
  /**
    * The host name of the server.
    */
  val serverName: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * The Amazon Resource Name (ARN) used by the service access IAM role for dynamodb endpoints.
    */
  val serviceAccessRole: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * The SSL mode to use for the connection. Can be one of `none | require | verify-ca | verify-full`
    */
  val sslMode: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val username: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
}
