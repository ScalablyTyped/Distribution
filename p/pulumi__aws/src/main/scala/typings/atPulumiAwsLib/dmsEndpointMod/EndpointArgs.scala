...
trait EndpointArgs extends js.Object {
  ...
  /**
    ...
    */
  val endpointId: atPulumiPulumiLib.outputMod.Input[java.lang.String]
  /**
...
object EndpointArgs {
  @scala.inline
  def apply(
    endpointId: atPulumiPulumiLib.outputMod.Input[java.lang.String],
    endpointType: atPulumiPulumiLib.outputMod.Input[java.lang.String],
