...
trait CustomLayerArgs extends js.Object {
  ...
  /**
    ...
    */
  val shortName: atPulumiPulumiLib.outputMod.Input[java.lang.String]
  /**
...
object CustomLayerArgs {
  @scala.inline
  def apply(
    shortName: atPulumiPulumiLib.outputMod.Input[java.lang.String],
    ...
    __obj.updateDynamic("shortName")(shortName.asInstanceOf[js.Any])
