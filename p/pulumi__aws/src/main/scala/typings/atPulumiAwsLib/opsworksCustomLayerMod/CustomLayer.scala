...
class CustomLayer protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: CustomLayerArgs) = this()
  def this(name: java.lang.String, args: CustomLayerArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
