...
trait Anon_NumberOfBuckets extends js.Object {
  var bucketColumns: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[java.lang.String]]]
  ] = js.undefined
  var columns: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[Anon_Comment]]]
  ] = js.undefined
  ...
  var serDeInfo: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[Anon_Parameters]] = js.undefined
  var skewedInfo: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[Anon_SkewedColumnValues]] = js.undefined
  var sortColumns: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[Anon_Column]]]
  ] = js.undefined
