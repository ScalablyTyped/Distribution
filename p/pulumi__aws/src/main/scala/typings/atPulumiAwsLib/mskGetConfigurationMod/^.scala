...
object ^ extends js.Object {
  ...
  def getConfiguration(args: GetConfigurationArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetConfigurationResult] with GetConfigurationResult = js.native
}
