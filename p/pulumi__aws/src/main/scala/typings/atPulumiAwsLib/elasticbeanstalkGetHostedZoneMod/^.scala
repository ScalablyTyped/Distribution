...
object ^ extends js.Object {
  ...
  def getHostedZone(args: GetHostedZoneArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetHostedZoneResult] with GetHostedZoneResult = js.native
}
