...
trait PipelineState extends js.Object {
  ...
  /**
    ...
    */
  val contentConfig: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_BucketStorageClass]] = js.undefined
  /**
    * The permissions for the `content_config` object. (documented below)
    */
  val contentConfigPermissions: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[js.Array[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_Accesses]]]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  val notifications: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_Warning]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val thumbnailConfig: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_BucketStorageClass]] = js.undefined
  /**
