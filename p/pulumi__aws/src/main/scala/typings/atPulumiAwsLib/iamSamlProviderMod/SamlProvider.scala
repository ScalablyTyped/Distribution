...
class SamlProvider protected ()
  ...
  /**
    ...
    */
  val samlMetadataDocument: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The expiration date and time for the SAML provider in RFC1123 format, e.g. `Mon, 02 Jan 2006 15:04:05 MST`.
    */
  val validUntil: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
}
