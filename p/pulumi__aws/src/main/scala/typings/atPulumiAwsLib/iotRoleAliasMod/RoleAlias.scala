...
class RoleAlias protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: RoleAliasArgs) = this()
  def this(name: java.lang.String, args: RoleAliasArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
