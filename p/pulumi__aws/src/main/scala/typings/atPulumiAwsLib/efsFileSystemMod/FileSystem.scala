...
class FileSystem protected ()
  ...
  /**
    ...
    */
  val creationToken: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val performanceMode: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
    * The throughput, measured in MiB/s, that you want to provision for the file system. Only applicable with `throughput_mode` set to `provisioned`.
    */
  val provisionedThroughputInMibps: atPulumiPulumiLib.atPulumiPulumiMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
    ...
    */
  val referenceName: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
