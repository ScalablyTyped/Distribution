...
class InternetGateway protected ()
  ...
  def this(name: java.lang.String, args: InternetGatewayArgs) = this()
  def this(name: java.lang.String, args: InternetGatewayArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
