...
object ^ extends js.Object {
  ...
  def getReplicationGroup(args: GetReplicationGroupArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetReplicationGroupResult] with GetReplicationGroupResult = js.native
}
