...
class DefaultVpcDhcpOptions protected ()
  ...
  val domainNameServers: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
  ...
  val ntpServers: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
