...
trait Anon_AutoscalingPolicyBidPriceEbsConfigs extends js.Object {
...
object Anon_AutoscalingPolicyBidPriceEbsConfigs {
  @scala.inline
  def apply(
  ...
  ): Anon_AutoscalingPolicyBidPriceEbsConfigs = {
    ...
    __obj.asInstanceOf[Anon_AutoscalingPolicyBidPriceEbsConfigs]
  }
}
