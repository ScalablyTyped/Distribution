...
class GangliaLayer protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: GangliaLayerArgs) = this()
  def this(name: java.lang.String, args: GangliaLayerArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
