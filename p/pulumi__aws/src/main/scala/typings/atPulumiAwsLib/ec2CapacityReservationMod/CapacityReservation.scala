...
class CapacityReservation protected ()
  ...
  /**
    ...
    */
  val endDate: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * Indicates the way in which the Capacity Reservation ends. Specify either `unlimited` or `limited`.
    */
  val endDateType: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * Indicates whether the Capacity Reservation supports instances with temporary, block-level storage.
    */
  val ephemeralStorage: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * The number of instances for which to reserve capacity.
    */
  val instanceCount: atPulumiPulumiLib.pulumiMod.Output[scala.Double] = js.native
  /**
    * Indicates the type of instance launches that the Capacity Reservation accepts. Specify either `open` or `targeted`.
    */
  val instanceMatchCriteria: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * The type of operating system for which to reserve capacity. Valid options are `Linux/UNIX`, `Red Hat Enterprise Linux`, `SUSE Linux`, `Windows`, `Windows with SQL Server`, `Windows with SQL Server Enterprise`, `Windows with SQL Server Standard` or `Windows with SQL Server Web`.
    */
  val instancePlatform: atPulumiPulumiLib.pulumiMod.Output[atPulumiAwsLib.ec2InstancePlatformMod.InstancePlatform] = js.native
  /**
    * The instance type for which to reserve capacity.
    */
  val instanceType: atPulumiPulumiLib.pulumiMod.Output[atPulumiAwsLib.ec2InstanceTypeMod.InstanceType] = js.native
  /**
  ...
  /**
    ...
    */
  val tenancy: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[atPulumiAwsLib.ec2TenancyMod.Tenancy]] = js.native
}
