...
class CapacityReservation protected ()
  ...
  /**
    ...
    */
  val endDateType: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * Indicates whether the Capacity Reservation supports instances with temporary, block-level storage.
    */
  val ephemeralStorage: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * The number of instances for which to reserve capacity.
    */
  val instanceCount: atPulumiPulumiLib.outputMod.Output[scala.Double] = js.native
  /**
    * Indicates the type of instance launches that the Capacity Reservation accepts. Specify either `open` or `targeted`.
    */
  val instanceMatchCriteria: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * The type of operating system for which to reserve capacity. Valid options are `Linux/UNIX`, `Red Hat Enterprise Linux`, `SUSE Linux`, `Windows`, `Windows with SQL Server`, `Windows with SQL Server Enterprise`, `Windows with SQL Server Standard` or `Windows with SQL Server Web`.
    */
  val instancePlatform: atPulumiPulumiLib.outputMod.Output[atPulumiAwsLib.ec2InstancePlatformMod.InstancePlatform] = js.native
  /**
  ...
  /**
    ...
    */
  val tenancy: atPulumiPulumiLib.outputMod.Output[js.UndefOr[atPulumiAwsLib.ec2TenancyMod.Tenancy]] = js.native
}
