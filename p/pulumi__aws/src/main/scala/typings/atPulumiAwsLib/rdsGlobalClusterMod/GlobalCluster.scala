...
class GlobalCluster protected ()
  ...
  val globalClusterIdentifier: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * AWS Region-unique, immutable identifier for the global database cluster. This identifier is found in AWS CloudTrail log entries whenever the AWS KMS key for the DB cluster is accessed
    */
  val globalClusterResourceId: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
