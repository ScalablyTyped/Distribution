...
trait DomainState extends js.Object {
  ...
  /**
    ...
    */
  val domainId: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
    * Name of the domain.
    */
  ...
  /**
    ...
    */
  val kibanaEndpoint: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
...
object DomainState {
  ...
  def apply(
    ...
    domainId: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null,
    ...
    kibanaEndpoint: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null,
