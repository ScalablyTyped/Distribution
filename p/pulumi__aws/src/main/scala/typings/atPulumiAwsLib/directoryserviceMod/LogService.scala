...
class LogService protected ()
  extends atPulumiAwsLib.directoryserviceLogServiceMod.LogService {
  /**
    ...
    */
  def this(name: java.lang.String, args: atPulumiAwsLib.directoryserviceLogServiceMod.LogServiceArgs) = this()
  def this(name: java.lang.String, args: atPulumiAwsLib.directoryserviceLogServiceMod.LogServiceArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
}
