...
class AmiFromInstance protected ()
  ...
  /**
    ...
    */
  val snapshotWithoutReboot: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * The id of the instance to use as the basis of the AMI.
    */
  val sourceInstanceId: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
