...
trait AmiFromInstanceState extends js.Object {
  ...
  /**
    ...
    */
  val sourceInstanceId: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
  /**
...
object AmiFromInstanceState {
  ...
  def apply(
    ...
    sourceInstanceId: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null,
