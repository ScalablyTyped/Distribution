...
class App protected ()
  ...
  /**
    ...
    */
  val campaignHook: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[atPulumiAwsLib.Anon_ModeLambdaFunctionName]] = js.native
  /**
    * The default campaign limits for the app. These limits apply to each campaign for the app, unless the campaign overrides the default with limits of its own
    */
  val limits: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[atPulumiAwsLib.Anon_MessagesPerSecond]] = js.native
  /**
  ...
  /**
    ...
    */
  val quietTime: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[atPulumiAwsLib.Anon_End]] = js.native
}
