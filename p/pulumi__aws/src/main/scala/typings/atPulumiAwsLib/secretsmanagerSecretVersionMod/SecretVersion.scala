...
class SecretVersion protected ()
  ...
  /**
    ...
    */
  val secretBinary: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * Specifies the secret to which you want to add a new version. You can specify either the Amazon Resource Name (ARN) or the friendly name of the secret. The secret must already exist.
    */
  val secretId: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * Specifies text data that you want to encrypt and store in this version of the secret. This is required if secret_binary is not set.
    */
  val secretString: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val versionStages: atPulumiPulumiLib.outputMod.Output[js.Array[java.lang.String]] = js.native
}
