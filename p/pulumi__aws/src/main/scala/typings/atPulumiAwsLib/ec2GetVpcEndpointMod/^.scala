...
object ^ extends js.Object {
  ...
  def getVpcEndpoint(args: GetVpcEndpointArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetVpcEndpointResult] with GetVpcEndpointResult = js.native
}
