...
@js.native
object ec2GetVpcEndpointModMembers extends js.Object {
  ...
  def getVpcEndpoint(args: GetVpcEndpointArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetVpcEndpointResult] = js.native
}
