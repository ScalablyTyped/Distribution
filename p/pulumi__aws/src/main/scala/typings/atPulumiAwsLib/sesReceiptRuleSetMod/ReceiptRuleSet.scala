...
class ReceiptRuleSet protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: ReceiptRuleSetArgs) = this()
  def this(name: java.lang.String, args: ReceiptRuleSetArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
