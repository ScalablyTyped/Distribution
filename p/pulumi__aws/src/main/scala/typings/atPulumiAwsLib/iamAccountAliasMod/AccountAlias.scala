...
class AccountAlias protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: AccountAliasArgs) = this()
  def this(name: java.lang.String, args: AccountAliasArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
    * The account alias
    */
  val accountAlias: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
}
