...
class KeyPair protected ()
  ...
  /**
    ...
    * private key
    */
  val encryptedFingerprint: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
    * the private key material, base 64 encoded and
    * encrypted with the given `pgp_key`. This is only populated when creating a new
    * key and `pgp_key` is supplied
    */
  val encryptedPrivateKey: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
