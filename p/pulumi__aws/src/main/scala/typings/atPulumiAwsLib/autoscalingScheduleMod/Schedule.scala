...
class Schedule protected ()
  ...
  /**
    ...
    */
  val endTime: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val recurrence: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The name of this scaling action.
    */
  val scheduledActionName: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The time for this action to start, in "YYYY-MM-DDThh:mm:ssZ" format in UTC/GMT only (for example, 2014-06-01T00:00:00Z ).
    * If you try to schedule your action in the past, Auto Scaling returns an error message.
    */
  val startTime: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
}
