...
object ^ extends js.Object {
  ...
  def getPolicyDocument(args: GetPolicyDocumentArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetPolicyDocumentResult] with GetPolicyDocumentResult = js.native
}
