package typings
package atPulumiAwsLib.budgetsMod
...
class Budget protected ()
  extends atPulumiAwsLib.budgetsBudgetMod.Budget {
  /**
...
object Budget extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.outputMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.budgetsBudgetMod.Budget = js.native
  def get(
