...
trait GroupArgs extends js.Object {
  ...
  val initialLifecycleHooks: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[
      js.Array[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_NameHeartbeatTimeout]]
    ]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  val launchTemplate: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_NameId]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val mixedInstancesPolicy: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.Anon_InstancesDistribution]] = js.undefined
  /**
