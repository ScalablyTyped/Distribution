...
class Subnet protected ()
  ...
  /**
    ...
    */
  val assignIpv6AddressOnCreation: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
  ...
  /**
    ...
    */
  val mapPublicIpOnLaunch: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
