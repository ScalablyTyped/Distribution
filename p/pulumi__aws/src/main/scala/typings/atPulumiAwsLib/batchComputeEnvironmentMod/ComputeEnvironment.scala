...
class ComputeEnvironment protected ()
  ...
  /**
    ...
    */
  val computeEnvironmentName: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * Details of the compute resources managed by the compute environment. This parameter is required for managed compute environments. See details below.
    */
  val computeResources: atPulumiPulumiLib.outputMod.Output[js.UndefOr[atPulumiAwsLib.Anon_BidPercentage]] = js.native
  val eccClusterArn: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val statusReason: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
