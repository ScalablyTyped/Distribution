...
class XssMatchSet protected ()
  ...
  def this(name: java.lang.String, args: XssMatchSetArgs) = this()
  def this(name: java.lang.String, args: XssMatchSetArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
    * The name of the set
    */
