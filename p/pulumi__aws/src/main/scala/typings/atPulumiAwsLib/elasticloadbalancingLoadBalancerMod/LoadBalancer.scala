...
class LoadBalancer protected ()
  ...
  /**
    ...
    */
  val accessLogs: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[atPulumiAwsLib.Anon_BucketBucketPrefixEnabled]] = js.native
  /**
    * The ARN of the ELB
    */
  ...
  /**
    ...
    */
  val healthCheck: atPulumiPulumiLib.pulumiMod.Output[atPulumiAwsLib.Anon_HealthyThresholdIntervalTarget] = js.native
  /**
  ...
  /**
    ...
    */
  val listeners: atPulumiPulumiLib.pulumiMod.Output[js.Array[atPulumiAwsLib.Anon_InstancePortInstanceProtocol]] = js.native
  /**
