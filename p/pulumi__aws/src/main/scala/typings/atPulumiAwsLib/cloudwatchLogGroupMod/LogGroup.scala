...
class LogGroup protected ()
  ...
  /**
    ...
    */
  val retentionInDays: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
...
object LogGroup extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.outputMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.cloudwatchLogGroupMod.LogGroup = js.native
  def get(
    name: java.lang.String,
