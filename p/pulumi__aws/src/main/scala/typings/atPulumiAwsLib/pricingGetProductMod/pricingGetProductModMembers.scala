...
@js.native
object pricingGetProductModMembers extends js.Object {
  def getProduct(args: GetProductArgs): js.Promise[GetProductResult] = js.native
  def getProduct(args: GetProductArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetProductResult] = js.native
}
