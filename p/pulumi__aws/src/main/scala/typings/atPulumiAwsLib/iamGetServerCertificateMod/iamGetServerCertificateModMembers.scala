...
@js.native
object iamGetServerCertificateModMembers extends js.Object {
  ...
  def getServerCertificate(args: GetServerCertificateArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetServerCertificateResult] = js.native
}
