...
object ^ extends js.Object {
  ...
  def getCertificate(args: GetCertificateArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetCertificateResult] with GetCertificateResult = js.native
}
