...
object Anon_OrcSerDeParquetSerDe {
  @scala.inline
  def apply(
    orcSerDe: atPulumiPulumiLib.outputMod.Input[Anon_BlockSizeBytesBloomFilterColumns] = null,
    parquetSerDe: atPulumiPulumiLib.outputMod.Input[Anon_BlockSizeBytesCompressionEnableDictionaryCompression] = null
