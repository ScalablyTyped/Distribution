...
class ClusterInstance protected ()
  ...
  /**
    ...
    */
  val dbParameterGroupName: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val performanceInsightsEnabled: atPulumiPulumiLib.pulumiMod.Output[scala.Boolean] = js.native
  /**
    ...
    */
  val performanceInsightsKmsKeyId: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * The database port
    */
