...
class FlowLog protected ()
  ...
  /**
    ...
    */
  val eniId: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val logDestination: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * The type of the logging destination. Valid values: `cloud-watch-logs`, `s3`. Default: `cloud-watch-logs`.
    */
  val logDestinationType: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val trafficType: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * VPC ID to attach to
    */
