...
class Cluster protected ()
  ...
  /**
    ...
    */
  val nodes: atPulumiPulumiLib.outputMod.Output[js.Array[atPulumiAwsLib.Anon_Address]] = js.native
  /**
  ...
  /**
    ...
    * replicas
    */
  val replicationFactor: atPulumiPulumiLib.outputMod.Output[scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  val serverSideEncryption: atPulumiPulumiLib.outputMod.Output[js.UndefOr[atPulumiAwsLib.Anon_EnabledBoolean]] = js.native
  /**
