...
class Cluster protected ()
  ...
  /**
    ...
    * lowercase
    */
  val clusterName: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val iamRoleArn: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val nodes: atPulumiPulumiLib.pulumiMod.Output[js.Array[atPulumiAwsLib.Anon_Address]] = js.native
  /**
  ...
  /**
    ...
    * replicas
    */
  val replicationFactor: atPulumiPulumiLib.pulumiMod.Output[scala.Double] = js.native
  /**
