...
class Attachment protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: AttachmentArgs) = this()
  def this(name: java.lang.String, args: AttachmentArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
...
object Attachment extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.resourceMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.autoscalingAttachmentMod.Attachment = js.native
  def get(
