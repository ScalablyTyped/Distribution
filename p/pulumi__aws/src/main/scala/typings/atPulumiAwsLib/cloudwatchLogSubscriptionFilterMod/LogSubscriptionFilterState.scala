...
trait LogSubscriptionFilterState extends js.Object {
  /**
    ...
    */
  val destinationArn: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val filterPattern: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[java.lang.String]] = js.undefined
  /**
    * The name of the log group to associate the subscription filter with
    */
  val logGroup: js.UndefOr[
    atPulumiPulumiLib.resourceMod.Input[atPulumiAwsLib.cloudwatchLogGroupMod.LogGroup]
  ] = js.undefined
  /**
