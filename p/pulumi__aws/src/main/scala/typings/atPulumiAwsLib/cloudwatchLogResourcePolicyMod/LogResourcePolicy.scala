...
class LogResourcePolicy protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: LogResourcePolicyArgs) = this()
  def this(name: java.lang.String, args: LogResourcePolicyArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
