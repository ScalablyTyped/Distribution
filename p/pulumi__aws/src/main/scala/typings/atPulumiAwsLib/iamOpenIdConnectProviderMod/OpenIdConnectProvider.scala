...
class OpenIdConnectProvider protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: OpenIdConnectProviderArgs) = this()
  def this(name: java.lang.String, args: OpenIdConnectProviderArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
  ...
  /**
    ...
    */
  val clientIdLists: atPulumiPulumiLib.outputMod.Output[js.Array[java.lang.String]] = js.native
  /**
    * A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider's server certificate(s).
    */
  val thumbprintLists: atPulumiPulumiLib.outputMod.Output[js.Array[java.lang.String]] = js.native
  /**
