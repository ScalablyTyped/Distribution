...
class Alias protected ()
  ...
  /**
    ...
    */
  val functionVersion: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val routingConfig: atPulumiPulumiLib.outputMod.Output[js.UndefOr[atPulumiAwsLib.Anon_AdditionalVersionWeights]] = js.native
}
