...
class AccountPasswordPolicy protected ()
  ...
  /**
    ...
    */
  val allowUsersToChangePassword: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * Indicates whether passwords in the account expire.
    * Returns `true` if `max_password_age` contains a value greater than `0`.
    * Returns `false` if it is `0` or _not present_.
    */
  val expirePasswords: atPulumiPulumiLib.pulumiMod.Output[scala.Boolean] = js.native
  /**
    * Whether users are prevented from setting a new password after their password has expired
    * (i.e. require administrator reset)
    */
  val hardExpiry: atPulumiPulumiLib.pulumiMod.Output[scala.Boolean] = js.native
  /**
    * The number of days that an user password is valid.
    */
  val maxPasswordAge: atPulumiPulumiLib.pulumiMod.Output[scala.Double] = js.native
  /**
    * Minimum length to require for user passwords.
    */
  val minimumPasswordLength: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
    * The number of previous passwords that users are prevented from reusing.
    */
  val passwordReusePrevention: atPulumiPulumiLib.pulumiMod.Output[scala.Double] = js.native
  /**
    * Whether to require lowercase characters for user passwords.
    */
  val requireLowercaseCharacters: atPulumiPulumiLib.pulumiMod.Output[scala.Boolean] = js.native
  /**
    * Whether to require numbers for user passwords.
    */
  val requireNumbers: atPulumiPulumiLib.pulumiMod.Output[scala.Boolean] = js.native
  /**
    * Whether to require symbols for user passwords.
    */
  val requireSymbols: atPulumiPulumiLib.pulumiMod.Output[scala.Boolean] = js.native
  /**
    * Whether to require uppercase characters for user passwords.
    */
  val requireUppercaseCharacters: atPulumiPulumiLib.pulumiMod.Output[scala.Boolean] = js.native
}
