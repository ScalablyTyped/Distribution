...
class SpotFleetRequest protected ()
  ...
  /**
    ...
    * `lowestPrice`.
    */
  val allocationStrategy: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  val clientToken: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val fleetType: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    ...
    */
  val iamFleetRole: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * Indicates whether a Spot
    * instance stops or terminates when it is interrupted. Default is
    * `terminate`.
    */
  val instanceInterruptionBehaviour: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    *
    ...
    */
  val instancePoolsToUseCount: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
    * Used to define the launch configuration of the
    * spot-fleet request. Can be specified multiple times to define different bids
    * across different markets and instance types.
    */
  val launchSpecifications: atPulumiPulumiLib.outputMod.Output[js.Array[atPulumiAwsLib.Anon_Ami]] = js.native
  /**
  ...
  /**
    ...
    */
  val spotRequestState: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * The number of units to request. You can choose to set the
    * target capacity in terms of instances or a performance characteristic that is
    * important to your application workload, such as vCPUs, memory, or I/O.
    */
  val targetCapacity: atPulumiPulumiLib.outputMod.Output[scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  val validFrom: atPulumiPulumiLib.outputMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
