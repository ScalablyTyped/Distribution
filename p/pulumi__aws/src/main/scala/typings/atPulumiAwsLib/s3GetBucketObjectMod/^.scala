...
object ^ extends js.Object {
  ...
  def getBucketObject(args: GetBucketObjectArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetBucketObjectResult] with GetBucketObjectResult = js.native
}
