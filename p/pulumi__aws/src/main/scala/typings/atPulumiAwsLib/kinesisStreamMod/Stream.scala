...
object Stream extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.resourceMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.kinesisStreamMod.Stream = js.native
  def get(
    name: java.lang.String,
