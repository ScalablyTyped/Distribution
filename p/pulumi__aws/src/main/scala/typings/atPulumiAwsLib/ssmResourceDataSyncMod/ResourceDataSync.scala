...
class ResourceDataSync protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: ResourceDataSyncArgs) = this()
  def this(name: java.lang.String, args: ResourceDataSyncArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
