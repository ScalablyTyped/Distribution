...
object MetricAlarmState {
  ...
  def apply(
    ...
    comparisonOperator: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null,
    ...
    evaluationPeriods: atPulumiPulumiLib.outputMod.Input[scala.Double] = null,
    ...
    threshold: atPulumiPulumiLib.outputMod.Input[scala.Double] = null,
