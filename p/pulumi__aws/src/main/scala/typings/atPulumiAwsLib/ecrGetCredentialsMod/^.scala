...
object ^ extends js.Object {
  ...
  def getCredentials(args: GetCredentialsArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetCredentialsResult] with GetCredentialsResult = js.native
}
