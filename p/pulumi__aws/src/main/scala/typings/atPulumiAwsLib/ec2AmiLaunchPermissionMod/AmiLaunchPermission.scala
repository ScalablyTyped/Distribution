...
class AmiLaunchPermission protected ()
  ...
  /**
    ...
    */
  def this(name: java.lang.String, args: AmiLaunchPermissionArgs) = this()
  def this(name: java.lang.String, args: AmiLaunchPermissionArgs, opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions) = this()
  /**
