...
trait RecordArgs extends js.Object {
  ...
  /**
    ...
    */
  val `type`: atPulumiPulumiLib.outputMod.Input[java.lang.String | atPulumiAwsLib.route53RecordTypeMod.RecordType]
  /**
...
object RecordArgs {
  @scala.inline
  def apply(
    `type`: atPulumiPulumiLib.outputMod.Input[java.lang.String | atPulumiAwsLib.route53RecordTypeMod.RecordType],
