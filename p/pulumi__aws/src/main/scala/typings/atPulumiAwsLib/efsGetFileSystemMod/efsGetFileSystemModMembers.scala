...
@js.native
object efsGetFileSystemModMembers extends js.Object {
  ...
  def getFileSystem(args: GetFileSystemArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetFileSystemResult] = js.native
}
