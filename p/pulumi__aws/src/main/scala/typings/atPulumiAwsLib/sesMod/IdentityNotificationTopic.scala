...
class IdentityNotificationTopic protected ()
  extends atPulumiAwsLib.sesIdentityNotificationTopicMod.IdentityNotificationTopic {
  /**
    ...
    */
  def this(name: java.lang.String, args: atPulumiAwsLib.sesIdentityNotificationTopicMod.IdentityNotificationTopicArgs) = this()
...
object IdentityNotificationTopic extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.resourceMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.sesIdentityNotificationTopicMod.IdentityNotificationTopic = js.native
  def get(
