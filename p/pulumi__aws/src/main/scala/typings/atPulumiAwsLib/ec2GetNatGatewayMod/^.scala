...
object ^ extends js.Object {
  ...
  def getNatGateway(args: GetNatGatewayArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetNatGatewayResult] with GetNatGatewayResult = js.native
}
