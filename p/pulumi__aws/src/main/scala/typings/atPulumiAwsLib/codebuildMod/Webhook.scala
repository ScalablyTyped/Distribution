...
class Webhook protected ()
  extends atPulumiAwsLib.codebuildWebhookMod.Webhook {
  /**
...
object Webhook extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.outputMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.codebuildWebhookMod.Webhook = js.native
  def get(
