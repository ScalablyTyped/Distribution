...
object DirectoryState {
  @scala.inline
  def apply(
    accessUrl: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null,
    ...
    dnsIpAddresses: atPulumiPulumiLib.outputMod.Input[js.Array[atPulumiPulumiLib.outputMod.Input[java.lang.String]]] = null,
