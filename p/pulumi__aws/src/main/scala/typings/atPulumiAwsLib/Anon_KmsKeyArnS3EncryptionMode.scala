...
trait Anon_KmsKeyArnS3EncryptionMode extends js.Object {
  ...
  var s3EncryptionMode: js.UndefOr[atPulumiPulumiLib.outputMod.Input[java.lang.String]] = js.undefined
}
...
object Anon_KmsKeyArnS3EncryptionMode {
  ...
  def apply(
    ...
    s3EncryptionMode: atPulumiPulumiLib.outputMod.Input[java.lang.String] = null
