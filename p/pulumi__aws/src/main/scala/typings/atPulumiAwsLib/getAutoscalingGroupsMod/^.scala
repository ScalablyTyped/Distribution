...
object ^ extends js.Object {
  ...
  def getAutoscalingGroups(args: GetAutoscalingGroupsArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetAutoscalingGroupsResult] with GetAutoscalingGroupsResult = js.native
}
