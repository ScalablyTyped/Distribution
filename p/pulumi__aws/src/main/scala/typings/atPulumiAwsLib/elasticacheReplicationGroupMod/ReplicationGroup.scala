...
class ReplicationGroup protected ()
  ...
  /**
    ...
    */
  val atRestEncryptionEnabled: atPulumiPulumiLib.atPulumiPulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * The password used to access a password protected server. Can be specified only if `transit_encryption_enabled = true`.
    */
  val authToken: atPulumiPulumiLib.atPulumiPulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val automaticFailoverEnabled: atPulumiPulumiLib.atPulumiPulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
  ...
  /**
    ...
    */
  val clusterMode: atPulumiPulumiLib.atPulumiPulumiMod.Output[atPulumiAwsLib.Anon_NumNodeGroups] = js.native
  /**
    * The address of the replication group configuration endpoint when cluster mode is enabled.
    */
  val configurationEndpointAddress: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val memberClusters: atPulumiPulumiLib.atPulumiPulumiMod.Output[js.Array[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val numberCacheClusters: atPulumiPulumiLib.atPulumiPulumiMod.Output[scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  val primaryEndpointAddress: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
    * A user-created description for the replication group.
    */
  val replicationGroupDescription: atPulumiPulumiLib.atPulumiPulumiMod.Output[java.lang.String] = js.native
  /**
