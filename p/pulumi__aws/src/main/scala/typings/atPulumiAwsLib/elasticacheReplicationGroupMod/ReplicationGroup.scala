...
class ReplicationGroup protected ()
  ...
  /**
    ...
    */
  val atRestEncryptionEnabled: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * The password used to access a password protected server. Can be specified only if `transit_encryption_enabled = true`.
    */
  val authToken: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val automaticFailoverEnabled: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
  ...
  /**
    ...
    */
  val configurationEndpointAddress: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val memberClusters: atPulumiPulumiLib.pulumiMod.Output[js.Array[java.lang.String]] = js.native
  /**
  ...
  /**
    ...
    */
  val numberCacheClusters: atPulumiPulumiLib.pulumiMod.Output[scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  val primaryEndpointAddress: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
    * A user-created description for the replication group.
    */
  val replicationGroupDescription: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  val transitEncryptionEnabled: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
}
