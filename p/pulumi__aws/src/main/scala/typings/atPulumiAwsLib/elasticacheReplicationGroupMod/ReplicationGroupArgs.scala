...
trait ReplicationGroupArgs extends js.Object {
  ...
  /**
    ...
    */
  val replicationGroupDescription: atPulumiPulumiLib.outputMod.Input[java.lang.String]
  /**
...
object ReplicationGroupArgs {
  @scala.inline
  def apply(
    replicationGroupDescription: atPulumiPulumiLib.outputMod.Input[java.lang.String],
