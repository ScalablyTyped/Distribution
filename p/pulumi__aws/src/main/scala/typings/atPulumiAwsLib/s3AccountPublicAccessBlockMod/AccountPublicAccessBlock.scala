...
class AccountPublicAccessBlock protected ()
  ...
  /**
    ...
    */
  val blockPublicAcls: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
    * Whether Amazon S3 should block public bucket policies for buckets in this account. Defaults to `false`. Enabling this setting does not affect existing bucket policies. When set to `true` causes Amazon S3 to:
    * * Reject calls to PUT Bucket policy if the specified bucket policy allows public access.
    */
  val blockPublicPolicy: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
  ...
  /**
    ...
    */
  val restrictPublicBuckets: atPulumiPulumiLib.outputMod.Output[js.UndefOr[scala.Boolean]] = js.native
}
