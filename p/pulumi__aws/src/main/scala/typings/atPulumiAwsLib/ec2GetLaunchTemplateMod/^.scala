...
object ^ extends js.Object {
  ...
  def getLaunchTemplate(args: GetLaunchTemplateArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetLaunchTemplateResult] with GetLaunchTemplateResult = js.native
}
