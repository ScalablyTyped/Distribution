...
class EventRule protected ()
  ...
  /**
    ...
    */
  val eventPattern: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
    * Whether the rule should be enabled (defaults to `true`).
    */
  val isEnabled: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Boolean]] = js.native
  /**
  ...
  /**
    ...
    */
  val scheduleExpression: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[java.lang.String]] = js.native
  /**
...
object EventRule extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.resourceMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiAwsLib.cloudwatchEventRuleMod.EventRule = js.native
  def get(
    name: java.lang.String,
