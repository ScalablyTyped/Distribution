...
class OriginAccessIdentity protected ()
  ...
  /**
    ...
    */
  val cloudfrontAccessIdentityPath: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    * E2QWRUHAPOMQZL`.
    */
  val iamArn: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
  /**
    * The Amazon S3 canonical user ID for the origin
    * access identity, which you use when giving the origin access identity read
    * permission to an object in Amazon S3.
    */
  val s3CanonicalUserId: atPulumiPulumiLib.outputMod.Output[java.lang.String] = js.native
}
