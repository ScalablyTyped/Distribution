...
trait Anon_DisableScaleIn extends js.Object {
  var customizedMetricSpecification: js.UndefOr[atPulumiPulumiLib.resourceMod.Input[Anon_Statistic]] = js.undefined
