...
class Policy protected ()
  ...
  /**
    ...
    */
  val estimatedInstanceWarmup: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
    * The aggregation type for the policy's metrics. Valid values are "Minimum", "Maximum", and "Average". Without a value, AWS will treat the aggregation type as "Average".
    */
  val metricAggregationType: atPulumiPulumiLib.pulumiMod.Output[java.lang.String] = js.native
  ...
  /**
    ...
    */
  val minAdjustmentStep: atPulumiPulumiLib.pulumiMod.Output[js.UndefOr[scala.Double]] = js.native
  /**
