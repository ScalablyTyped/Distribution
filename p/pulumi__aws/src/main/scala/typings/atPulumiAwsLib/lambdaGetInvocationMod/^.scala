...
object ^ extends js.Object {
  ...
  def getInvocation(args: GetInvocationArgs, opts: atPulumiPulumiLib.invokeMod.InvokeOptions): js.Promise[GetInvocationResult] with GetInvocationResult = js.native
}
