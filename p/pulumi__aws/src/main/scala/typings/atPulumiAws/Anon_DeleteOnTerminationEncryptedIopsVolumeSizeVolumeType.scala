...
trait Anon_DeleteOnTerminationEncryptedIopsVolumeSizeVolumeType extends js.Object {
...
object Anon_DeleteOnTerminationEncryptedIopsVolumeSizeVolumeType {
  @scala.inline
  def apply(
  ...
  ): Anon_DeleteOnTerminationEncryptedIopsVolumeSizeVolumeType = {
    ...
    __obj.asInstanceOf[Anon_DeleteOnTerminationEncryptedIopsVolumeSizeVolumeType]
  }
}
