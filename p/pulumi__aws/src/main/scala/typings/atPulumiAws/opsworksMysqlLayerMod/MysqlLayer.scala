...
@js.native
class MysqlLayer protected () extends CustomResource {
  /**
  ...
  /**
    ...
    */
  val ebsVolumes: Output[js.UndefOr[js.Array[MysqlLayerEbsVolume]]] = js.native
  /**
  ...
  /**
    ...
    */
  val rootPassword: Output[js.UndefOr[String]] = js.native
  /**
    * Whether to set the root user password to all instances in the stack so they can access the instances in this layer.
    */
  val rootPasswordOnAllInstances: Output[js.UndefOr[Boolean]] = js.native
  /**
