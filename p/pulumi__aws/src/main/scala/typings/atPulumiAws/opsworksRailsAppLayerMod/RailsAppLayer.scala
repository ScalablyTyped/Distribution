...
class RailsAppLayer protected () extends CustomResource {
  ...
  /**
    ...
    */
  val bundlerVersion: Output[js.UndefOr[String]] = js.native
  ...
  /**
    ...
    */
  val manageBundler: Output[js.UndefOr[Boolean]] = js.native
  /**
  ...
  /**
    ...
    */
  val passengerVersion: Output[js.UndefOr[String]] = js.native
  /**
    * The version of Ruby to use. Defaults to "2.0.0".
    */
  val rubyVersion: Output[js.UndefOr[String]] = js.native
  /**
    * The version of RubyGems to use. Defaults to "2.2.2".
    */
  val rubygemsVersion: Output[js.UndefOr[String]] = js.native
  /**
