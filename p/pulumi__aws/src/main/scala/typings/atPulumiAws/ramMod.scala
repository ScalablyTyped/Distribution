...
object ramMod extends js.Object {
  ...
  class PrincipalAssociation protected ()
    extends typings.atPulumiAws.ramPrincipalAssociationMod.PrincipalAssociation {
    /**
  ...
  class ResourceShare protected ()
    extends typings.atPulumiAws.ramResourceShareMod.ResourceShare {
    /**
  ...
  class ResourceShareAccepter protected ()
    extends typings.atPulumiAws.ramResourceShareAccepterMod.ResourceShareAccepter {
    /**
