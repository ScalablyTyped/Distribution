...
import typings.atPulumiAws.typesInputMod.opsworksNs.PhpAppLayerEbsVolume
...
trait PhpAppLayerState extends js.Object {
  ...
  /**
    ...
    */
  val ebsVolumes: js.UndefOr[Input[js.Array[Input[PhpAppLayerEbsVolume]]]] = js.undefined
  /**
