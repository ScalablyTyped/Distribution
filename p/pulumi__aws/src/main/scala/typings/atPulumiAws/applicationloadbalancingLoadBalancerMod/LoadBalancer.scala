...
import typings.atPulumiAws.typesOutputMod.applicationloadbalancing.LoadBalancerAccessLogs
import typings.atPulumiAws.typesOutputMod.applicationloadbalancing.LoadBalancerSubnetMapping
