...
trait Anon_AutoscalingPolicyBidPriceEbsConfigsId extends js.Object {
...
object Anon_AutoscalingPolicyBidPriceEbsConfigsId {
  @scala.inline
  def apply(
  ...
  ): Anon_AutoscalingPolicyBidPriceEbsConfigsId = {
    ...
    __obj.asInstanceOf[Anon_AutoscalingPolicyBidPriceEbsConfigsId]
  }
}
