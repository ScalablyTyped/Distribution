...
object elasticacheMod extends js.Object {
  ...
  class Cluster protected ()
    extends typings.atPulumiAws.elasticacheClusterMod.Cluster {
    /**
  ...
  class ParameterGroup protected ()
    extends typings.atPulumiAws.elasticacheParameterGroupMod.ParameterGroup {
    /**
  ...
  class SecurityGroup protected ()
    extends typings.atPulumiAws.elasticacheSecurityGroupMod.SecurityGroup {
    /**
  ...
  class SubnetGroup protected ()
    extends typings.atPulumiAws.elasticacheSubnetGroupMod.SubnetGroup {
    /**
