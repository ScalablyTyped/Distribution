...
object route53Mod extends js.Object {
  ...
  class DelegationSet protected ()
    extends typings.atPulumiAws.route53DelegationSetMod.DelegationSet {
    /**
  ...
  class ResolverEndpoint protected ()
    extends typings.atPulumiAws.route53ResolverEndpointMod.ResolverEndpoint {
    /**
  ...
  class Zone protected ()
    extends typings.atPulumiAws.route53ZoneMod.Zone {
    /**
