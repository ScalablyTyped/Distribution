...
import typings.atPulumiAws.directconnectHostedTransitVirtualInterfaceMod.HostedTransitVirtualInterfaceArgs
import typings.atPulumiAws.directconnectHostedTransitVirtualInterfaceMod.HostedTransitVirtualInterfaceState
...
class HostedTransitVirtualInterface protected ()
  extends typings.atPulumiAws.directconnectHostedTransitVirtualInterfaceMod.HostedTransitVirtualInterface {
  /**
...
object HostedTransitVirtualInterface extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiAws.directconnectHostedTransitVirtualInterfaceMod.HostedTransitVirtualInterface = js.native
  def get(name: String, id: Input[ID], state: HostedTransitVirtualInterfaceState): typings.atPulumiAws.directconnectHostedTransitVirtualInterfaceMod.HostedTransitVirtualInterface = js.native
  def get(
    name: String,
    id: Input[ID],
    state: HostedTransitVirtualInterfaceState,
    opts: CustomResourceOptions
  ): typings.atPulumiAws.directconnectHostedTransitVirtualInterfaceMod.HostedTransitVirtualInterface = js.native
  /**
