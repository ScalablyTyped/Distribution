...
trait ProjectState extends js.Object {
  ...
  /**
    ...
    */
  val environment: js.UndefOr[Input[Anon_CertificateComputeType]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val source: js.UndefOr[Input[Anon_AuthsBuildspecGitCloneDepthInsecureSsl]] = js.undefined
  /**
...
object ProjectState {
  ...
  def apply(
    ...
    artifacts: Input[Anon_EncryptionDisabledLocationName] = null,
    ...
    environment: Input[Anon_CertificateComputeType] = null,
    ...
    source: Input[Anon_AuthsBuildspecGitCloneDepthInsecureSsl] = null,
