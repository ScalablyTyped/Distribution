...
import typings.atPulumiAws.typesOutputMod.autoscaling.PolicyStepAdjustment
import typings.atPulumiAws.typesOutputMod.autoscaling.PolicyTargetTrackingConfiguration
