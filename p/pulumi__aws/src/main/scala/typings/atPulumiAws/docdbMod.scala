...
object docdbMod extends js.Object {
  ...
  class ClusterInstance protected ()
    extends typings.atPulumiAws.docdbClusterInstanceMod.ClusterInstance {
    /**
  ...
  class ClusterParameterGroup protected ()
    extends typings.atPulumiAws.docdbClusterParameterGroupMod.ClusterParameterGroup {
    /**
  ...
  class ClusterSnapshot protected ()
    extends typings.atPulumiAws.docdbClusterSnapshotMod.ClusterSnapshot {
    /**
  ...
  class SubnetGroup protected ()
    extends typings.atPulumiAws.docdbSubnetGroupMod.SubnetGroup {
    /**
