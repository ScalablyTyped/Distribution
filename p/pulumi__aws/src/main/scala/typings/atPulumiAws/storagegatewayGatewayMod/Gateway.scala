...
class Gateway protected () extends CustomResource {
  ...
  /**
    * Name of the gateway.
    */
  val gatewayName: Output[String] = js.native
  /**
    * Time zone for the gateway. The time zone is of the format "GMT", "GMT-hr:mm", or "GMT+hr:mm". For example, `GMT-4:00` indicates the time is 4 hours behind GMT. The time zone is used, for example, for scheduling snapshots and your gateway's maintenance schedule.
    */
  val gatewayTimezone: Output[String] = js.native
  /**
    * Type of the gateway. The default value is `STORED`. Valid values: `CACHED`, `FILE_S3`, `STORED`, `VTL`.
    */
  val gatewayType: Output[js.UndefOr[String]] = js.native
  val mediumChangerType: Output[js.UndefOr[String]] = js.native
  /**
