...
class PatchBaseline protected () extends CustomResource {
  ...
  /**
    ...
    */
  val approvedPatches: Output[js.UndefOr[js.Array[String]]] = js.native
  /**
    * Defines the compliance level for approved patches. This means that if an approved patch is reported as missing, this is the severity of the compliance violation. Valid compliance levels include the following: `CRITICAL`, `HIGH`, `MEDIUM`, `LOW`, `INFORMATIONAL`, `UNSPECIFIED`. The default value is `UNSPECIFIED`.
    */
  val approvedPatchesComplianceLevel: Output[js.UndefOr[String]] = js.native
  /**
  ...
  /**
    ...
    */
  val operatingSystem: Output[js.UndefOr[String]] = js.native
  /**
    * A list of rejected patches.
    */
  val rejectedPatches: Output[js.UndefOr[js.Array[String]]] = js.native
