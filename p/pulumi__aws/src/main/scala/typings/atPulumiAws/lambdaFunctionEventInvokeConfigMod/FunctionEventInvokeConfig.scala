...
import typings.atPulumiAws.typesOutputMod.lambda.FunctionEventInvokeConfigDestinationConfig
...
class FunctionEventInvokeConfig protected () extends CustomResource {
  ...
  /**
    ...
    */
  val destinationConfig: Output[js.UndefOr[FunctionEventInvokeConfigDestinationConfig]] = js.native
  /**
  ...
  /**
    ...
    */
  val maximumEventAgeInSeconds: Output[js.UndefOr[Double]] = js.native
  /**
    * Maximum number of times to retry when the function returns an error. Valid values between 0 and 2. Defaults to 2.
    */
  val maximumRetryAttempts: Output[js.UndefOr[Double]] = js.native
  /**
