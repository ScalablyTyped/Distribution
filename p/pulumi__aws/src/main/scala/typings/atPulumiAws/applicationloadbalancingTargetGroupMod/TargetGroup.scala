...
import typings.atPulumiAws.typesOutputMod.applicationloadbalancingNs.TargetGroupHealthCheck
import typings.atPulumiAws.typesOutputMod.applicationloadbalancingNs.TargetGroupStickiness
