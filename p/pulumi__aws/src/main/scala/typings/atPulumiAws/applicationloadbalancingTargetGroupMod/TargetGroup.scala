...
import typings.atPulumiAws.typesOutputMod.applicationloadbalancing.TargetGroupHealthCheck
import typings.atPulumiAws.typesOutputMod.applicationloadbalancing.TargetGroupStickiness
