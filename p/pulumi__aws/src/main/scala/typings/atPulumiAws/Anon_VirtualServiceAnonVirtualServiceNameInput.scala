...
trait Anon_VirtualServiceAnonVirtualServiceNameInput extends js.Object {
  var virtualService: js.UndefOr[Input[Anon_VirtualServiceNameInput]] = js.undefined
}

object Anon_VirtualServiceAnonVirtualServiceNameInput {
  @scala.inline
  def apply(virtualService: Input[Anon_VirtualServiceNameInput] = null): Anon_VirtualServiceAnonVirtualServiceNameInput = {
