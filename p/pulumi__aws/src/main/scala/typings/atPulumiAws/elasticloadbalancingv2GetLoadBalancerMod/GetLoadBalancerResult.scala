...
import typings.atPulumiAws.typesOutputMod.elasticloadbalancingv2Ns.GetLoadBalancerAccessLogs
import typings.atPulumiAws.typesOutputMod.elasticloadbalancingv2Ns.GetLoadBalancerSubnetMapping
