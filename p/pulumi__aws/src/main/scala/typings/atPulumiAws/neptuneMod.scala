...
object neptuneMod extends js.Object {
  ...
  class Cluster protected ()
    extends typings.atPulumiAws.neptuneClusterMod.Cluster {
    /**
  ...
  class ClusterParameterGroup protected ()
    extends typings.atPulumiAws.neptuneClusterParameterGroupMod.ClusterParameterGroup {
    /**
  ...
  class EventSubscription protected ()
    extends typings.atPulumiAws.neptuneEventSubscriptionMod.EventSubscription {
    /**
  ...
  class ParameterGroup protected ()
    extends typings.atPulumiAws.neptuneParameterGroupMod.ParameterGroup {
    /**
  ...
  class SubnetGroup protected ()
    extends typings.atPulumiAws.neptuneSubnetGroupMod.SubnetGroup {
    /**
