...
import typings.atPulumiAws.typesInputMod.s3.BucketCorsRule
import typings.atPulumiAws.typesInputMod.s3.BucketLifecycleRule
import typings.atPulumiAws.typesInputMod.s3.BucketLogging
import typings.atPulumiAws.typesInputMod.s3.BucketObjectLockConfiguration
import typings.atPulumiAws.typesInputMod.s3.BucketReplicationConfiguration
import typings.atPulumiAws.typesInputMod.s3.BucketServerSideEncryptionConfiguration
import typings.atPulumiAws.typesInputMod.s3.BucketVersioning
import typings.atPulumiAws.typesInputMod.s3.BucketWebsite
