...
import typings.atPulumiAws.typesInputMod.opsworksNs.JavaAppLayerEbsVolume
...
trait JavaAppLayerArgs extends js.Object {
  ...
  /**
    ...
    */
  val ebsVolumes: js.UndefOr[Input[js.Array[Input[JavaAppLayerEbsVolume]]]] = js.undefined
  /**
