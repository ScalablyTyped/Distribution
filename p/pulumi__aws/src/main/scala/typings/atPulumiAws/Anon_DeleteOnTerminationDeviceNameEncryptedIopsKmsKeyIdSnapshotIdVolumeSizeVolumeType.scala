...
trait Anon_DeleteOnTerminationDeviceNameEncryptedIopsKmsKeyIdSnapshotIdVolumeSizeVolumeType extends js.Object {
...
object Anon_DeleteOnTerminationDeviceNameEncryptedIopsKmsKeyIdSnapshotIdVolumeSizeVolumeType {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_DeleteOnTerminationDeviceNameEncryptedIopsKmsKeyIdSnapshotIdVolumeSizeVolumeType]
  }
}
