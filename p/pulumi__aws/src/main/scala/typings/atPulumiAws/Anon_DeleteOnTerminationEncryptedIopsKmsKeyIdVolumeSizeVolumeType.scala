...
trait Anon_DeleteOnTerminationEncryptedIopsKmsKeyIdVolumeSizeVolumeType extends js.Object {
...
object Anon_DeleteOnTerminationEncryptedIopsKmsKeyIdVolumeSizeVolumeType {
  @scala.inline
  def apply(
  ...
  ): Anon_DeleteOnTerminationEncryptedIopsKmsKeyIdVolumeSizeVolumeType = {
    ...
    __obj.asInstanceOf[Anon_DeleteOnTerminationEncryptedIopsKmsKeyIdVolumeSizeVolumeType]
  }
}
