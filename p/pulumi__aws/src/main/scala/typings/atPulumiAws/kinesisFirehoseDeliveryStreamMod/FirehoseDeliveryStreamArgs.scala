...
import typings.atPulumiAws.typesInputMod.kinesis.FirehoseDeliveryStreamElasticsearchConfiguration
import typings.atPulumiAws.typesInputMod.kinesis.FirehoseDeliveryStreamExtendedS3Configuration
import typings.atPulumiAws.typesInputMod.kinesis.FirehoseDeliveryStreamKinesisSourceConfiguration
import typings.atPulumiAws.typesInputMod.kinesis.FirehoseDeliveryStreamRedshiftConfiguration
import typings.atPulumiAws.typesInputMod.kinesis.FirehoseDeliveryStreamS3Configuration
import typings.atPulumiAws.typesInputMod.kinesis.FirehoseDeliveryStreamServerSideEncryption
import typings.atPulumiAws.typesInputMod.kinesis.FirehoseDeliveryStreamSplunkConfiguration
