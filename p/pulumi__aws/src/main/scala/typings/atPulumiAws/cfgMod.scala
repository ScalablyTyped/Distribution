...
object cfgMod extends js.Object {
  ...
  class ConfigurationAggregator protected ()
    extends typings.atPulumiAws.cfgConfigurationAggregatorMod.ConfigurationAggregator {
    /**
  ...
  class DeliveryChannel protected ()
    extends typings.atPulumiAws.cfgDeliveryChannelMod.DeliveryChannel {
    /**
  ...
  class Rule protected ()
    extends typings.atPulumiAws.cfgRuleMod.Rule {
    /**
