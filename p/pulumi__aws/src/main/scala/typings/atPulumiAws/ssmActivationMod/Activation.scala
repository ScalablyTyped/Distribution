package typings.atPulumiAws.ssmActivationMod
...
class Activation protected () extends CustomResource {
  ...
  /**
    ...
    */
  val activationCode: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val expirationDate: Output[js.UndefOr[String]] = js.native
  /**
    * If the current activation has expired.
    */
  val expired: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val registrationCount: Output[Double] = js.native
  /**
    * The maximum number of managed instances you want to register. The default value is 1 instance.
    */
  val registrationLimit: Output[js.UndefOr[Double]] = js.native
  /**
