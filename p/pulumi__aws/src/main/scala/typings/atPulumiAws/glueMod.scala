...
object glueMod extends js.Object {
  ...
  class CatalogTable protected ()
    extends typings.atPulumiAws.glueCatalogTableMod.CatalogTable {
    /**
  ...
  class Connection protected ()
    extends typings.atPulumiAws.glueConnectionMod.Connection {
    /**
  ...
  class Crawler protected ()
    extends typings.atPulumiAws.glueCrawlerMod.Crawler {
    /**
  ...
  @js.native
  class Job protected ()
    extends typings.atPulumiAws.glueJobMod.Job {
    /**
  ...
  class Trigger protected ()
    extends typings.atPulumiAws.glueTriggerMod.Trigger {
    /**
