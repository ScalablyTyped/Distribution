...
import typings.atPulumiAws.typesOutputMod.codepipeline.WebhookAuthenticationConfiguration
import typings.atPulumiAws.typesOutputMod.codepipeline.WebhookFilter
...
class Webhook protected () extends CustomResource {
  ...
  /**
    ...
    */
  val authentication: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val targetAction: Output[String] = js.native
  /**
    * The name of the pipeline.
    */
  val targetPipeline: Output[String] = js.native
  /**
