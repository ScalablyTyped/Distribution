...
object lbMod extends js.Object {
  ...
  class Listener protected ()
    extends typings.atPulumiAws.lbListenerMod.Listener {
    /**
  ...
  class ListenerRule protected ()
    extends typings.atPulumiAws.lbListenerRuleMod.ListenerRule {
    /**
  ...
  class LoadBalancer protected ()
    extends typings.atPulumiAws.lbLoadBalancerMod.LoadBalancer {
    /**
  ...
  class TargetGroupAttachment protected ()
    extends typings.atPulumiAws.lbTargetGroupAttachmentMod.TargetGroupAttachment {
    /**
