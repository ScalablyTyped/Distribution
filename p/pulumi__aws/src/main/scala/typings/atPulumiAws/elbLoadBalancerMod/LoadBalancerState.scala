...
import typings.atPulumiAws.typesInputMod.elbNs.LoadBalancerAccessLogs
import typings.atPulumiAws.typesInputMod.elbNs.LoadBalancerHealthCheck
import typings.atPulumiAws.typesInputMod.elbNs.LoadBalancerListener
...
trait LoadBalancerState extends js.Object {
  ...
  /**
    ...
    */
  val healthCheck: js.UndefOr[Input[LoadBalancerHealthCheck]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val listeners: js.UndefOr[Input[js.Array[Input[LoadBalancerListener]]]] = js.undefined
  /**
...
object LoadBalancerState {
  ...
  def apply(
    ...
    listeners: Input[js.Array[Input[LoadBalancerListener]]] = null,
