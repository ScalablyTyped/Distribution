...
import typings.atPulumiAws.typesOutputMod.ec2.AmiFromInstanceEbsBlockDevice
import typings.atPulumiAws.typesOutputMod.ec2.AmiFromInstanceEphemeralBlockDevice
