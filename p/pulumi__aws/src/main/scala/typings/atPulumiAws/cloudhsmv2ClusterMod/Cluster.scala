...
import typings.atPulumiAws.typesOutputMod.cloudhsmv2.ClusterClusterCertificates
...
class Cluster protected () extends CustomResource {
  ...
  /**
    ...
    */
  val hsmType: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val sourceBackupIdentifier: Output[js.UndefOr[String]] = js.native
  /**
