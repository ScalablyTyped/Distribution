...
object redshiftMod extends js.Object {
  ...
  class Cluster protected ()
    extends typings.atPulumiAws.redshiftClusterMod.Cluster {
    /**
  ...
  class EventSubscription protected ()
    extends typings.atPulumiAws.redshiftEventSubscriptionMod.EventSubscription {
    /**
  ...
  class SecurityGroup protected ()
    extends typings.atPulumiAws.redshiftSecurityGroupMod.SecurityGroup {
    /**
  ...
  class SnapshotSchedule protected ()
    extends typings.atPulumiAws.redshiftSnapshotScheduleMod.SnapshotSchedule {
    /**
