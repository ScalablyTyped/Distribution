...
trait Anon_AwsCloudMapDns extends js.Object {
  var awsCloudMap: js.UndefOr[Input[Anon_AttributesKey]] = js.undefined
  var dns: js.UndefOr[Input[Anon_HostnameInput]] = js.undefined
}

object Anon_AwsCloudMapDns {
  @scala.inline
  def apply(awsCloudMap: Input[Anon_AttributesKey] = null, dns: Input[Anon_HostnameInput] = null): Anon_AwsCloudMapDns = {
