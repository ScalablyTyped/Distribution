...
trait FleetState extends js.Object {
  ...
  /**
    ...
    */
  val launchTemplateConfig: js.UndefOr[Input[Anon_LaunchTemplateSpecificationOverridesAnonAvailabilityZoneInstanceType]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val targetCapacitySpecification: js.UndefOr[Input[Anon_DefaultTargetCapacityTypeOnDemandTargetCapacity]] = js.undefined
  /**
...
object FleetState {
  ...
  def apply(
    ...
    launchTemplateConfig: Input[Anon_LaunchTemplateSpecificationOverridesAnonAvailabilityZoneInstanceType] = null,
    ...
    targetCapacitySpecification: Input[Anon_DefaultTargetCapacityTypeOnDemandTargetCapacity] = null,
