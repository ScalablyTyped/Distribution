...
object applicationloadbalancingMod extends js.Object {
  ...
  class ListenerRule protected ()
    extends typings.atPulumiAws.applicationloadbalancingListenerRuleMod.ListenerRule {
    /**
  ...
  class LoadBalancer protected ()
    extends typings.atPulumiAws.applicationloadbalancingLoadBalancerMod.LoadBalancer {
    /**
  ...
  class TargetGroup protected ()
    extends typings.atPulumiAws.applicationloadbalancingTargetGroupMod.TargetGroup {
    /**
