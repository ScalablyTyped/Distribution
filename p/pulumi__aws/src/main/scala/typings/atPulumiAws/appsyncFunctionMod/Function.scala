...
class Function protected () extends CustomResource {
  ...
  /**
    ...
    */
  val dataSource: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val functionId: Output[String] = js.native
  /**
    * The version of the request mapping template. Currently the supported value is `2018-05-29`.
    */
  val functionVersion: Output[js.UndefOr[String]] = js.native
  /**
  ...
  /**
    ...
    */
  val requestMappingTemplate: Output[String] = js.native
  /**
    * The Function response mapping template.
    */
  val responseMappingTemplate: Output[String] = js.native
}
