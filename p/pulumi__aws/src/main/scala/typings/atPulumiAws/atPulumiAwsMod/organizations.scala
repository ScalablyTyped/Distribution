...
object organizations extends js.Object {
  ...
  class Account protected ()
    extends typings.atPulumiAws.organizationsMod.Account {
    /**
  ...
  class Organization protected ()
    extends typings.atPulumiAws.organizationsMod.Organization {
    /**
  ...
  class OrganizationalUnit protected ()
    extends typings.atPulumiAws.organizationsMod.OrganizationalUnit {
    /**
  ...
  class Policy protected ()
    extends typings.atPulumiAws.organizationsMod.Policy {
    /**
  ...
  class PolicyAttachment protected ()
    extends typings.atPulumiAws.organizationsMod.PolicyAttachment {
    /**
