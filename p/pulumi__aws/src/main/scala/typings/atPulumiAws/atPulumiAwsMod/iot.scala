...
object iot extends js.Object {
  ...
  class Certificate protected ()
    extends typings.atPulumiAws.iotMod.Certificate {
    /**
  ...
  class Policy protected ()
    extends typings.atPulumiAws.iotMod.Policy {
    /**
  ...
  class PolicyAttachment protected ()
    extends typings.atPulumiAws.iotMod.PolicyAttachment {
    /**
  ...
  class RoleAlias protected ()
    extends typings.atPulumiAws.iotMod.RoleAlias {
    /**
  ...
  class Thing protected ()
    extends typings.atPulumiAws.iotMod.Thing {
    /**
  ...
  class ThingPrincipalAttachment protected ()
    extends typings.atPulumiAws.iotMod.ThingPrincipalAttachment {
    /**
  ...
  class ThingType protected ()
    extends typings.atPulumiAws.iotMod.ThingType {
    /**
  ...
  class TopicRule protected ()
    extends typings.atPulumiAws.iotMod.TopicRule {
    /**
