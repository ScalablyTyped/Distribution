...
import typings.atPulumiAws.cloudfrontDistributionMod.DistributionArgs
import typings.atPulumiAws.cloudfrontDistributionMod.DistributionState
...
object cloudfront extends js.Object {
  ...
  class Distribution protected ()
    extends typings.atPulumiAws.cloudfrontMod.Distribution {
    /**
  ...
  class OriginAccessIdentity protected ()
    extends typings.atPulumiAws.cloudfrontMod.OriginAccessIdentity {
    /**
  ...
  class PublicKey protected ()
    extends typings.atPulumiAws.cloudfrontMod.PublicKey {
    /**
  ...
  object Distribution extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typings.atPulumiAws.cloudfrontDistributionMod.Distribution = js.native
    def get(name: String, id: Input[ID], state: DistributionState): typings.atPulumiAws.cloudfrontDistributionMod.Distribution = js.native
    def get(name: String, id: Input[ID], state: DistributionState, opts: CustomResourceOptions): typings.atPulumiAws.cloudfrontDistributionMod.Distribution = js.native
    /**
