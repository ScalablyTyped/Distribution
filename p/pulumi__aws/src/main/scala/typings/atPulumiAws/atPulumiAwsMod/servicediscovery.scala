...
object servicediscovery extends js.Object {
  ...
  class HttpNamespace protected ()
    extends typings.atPulumiAws.servicediscoveryMod.HttpNamespace {
    /**
  ...
  class PrivateDnsNamespace protected ()
    extends typings.atPulumiAws.servicediscoveryMod.PrivateDnsNamespace {
    /**
  ...
  class PublicDnsNamespace protected ()
    extends typings.atPulumiAws.servicediscoveryMod.PublicDnsNamespace {
    /**
  ...
  class Service protected ()
    extends typings.atPulumiAws.servicediscoveryMod.Service {
    /**
