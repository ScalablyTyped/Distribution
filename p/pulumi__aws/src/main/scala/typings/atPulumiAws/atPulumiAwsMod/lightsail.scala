...
object lightsail extends js.Object {
  ...
  class Domain protected ()
    extends typings.atPulumiAws.lightsailMod.Domain {
    /**
  ...
  class Instance protected ()
    extends typings.atPulumiAws.lightsailMod.Instance {
    /**
  ...
  class KeyPair protected ()
    extends typings.atPulumiAws.lightsailMod.KeyPair {
    /**
  ...
  class StaticIp protected ()
    extends typings.atPulumiAws.lightsailMod.StaticIp {
    /**
  ...
  class StaticIpAttachment protected ()
    extends typings.atPulumiAws.lightsailMod.StaticIpAttachment {
    /**
