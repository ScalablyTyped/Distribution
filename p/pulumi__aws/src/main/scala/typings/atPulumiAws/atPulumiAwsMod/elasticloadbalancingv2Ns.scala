...
object elasticloadbalancingv2Ns extends js.Object {
  ...
  class Listener protected ()
    extends typings.atPulumiAws.elasticloadbalancingv2Mod.Listener {
    /**
  ...
  class ListenerCertificate protected ()
    extends typings.atPulumiAws.elasticloadbalancingv2Mod.ListenerCertificate {
    /**
  ...
  class ListenerRule protected ()
    extends typings.atPulumiAws.elasticloadbalancingv2Mod.ListenerRule {
    /**
  ...
  class LoadBalancer protected ()
    extends typings.atPulumiAws.elasticloadbalancingv2Mod.LoadBalancer {
    /**
  ...
  class TargetGroup protected ()
    extends typings.atPulumiAws.elasticloadbalancingv2Mod.TargetGroup {
    /**
  ...
  class TargetGroupAttachment protected ()
    extends typings.atPulumiAws.elasticloadbalancingv2Mod.TargetGroupAttachment {
    /**
