...
object batch extends js.Object {
  ...
  class ComputeEnvironment protected ()
    extends typings.atPulumiAws.batchMod.ComputeEnvironment {
    /**
  ...
  class JobDefinition protected ()
    extends typings.atPulumiAws.batchMod.JobDefinition {
    /**
  ...
  class JobQueue protected ()
    extends typings.atPulumiAws.batchMod.JobQueue {
    /**
