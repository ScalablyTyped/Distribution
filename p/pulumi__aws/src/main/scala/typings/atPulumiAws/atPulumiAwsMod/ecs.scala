...
object ecs extends js.Object {
  ...
  class CapacityProvider protected ()
    extends typings.atPulumiAws.ecsMod.CapacityProvider {
    /**
  ...
  class Cluster protected ()
    extends typings.atPulumiAws.ecsMod.Cluster {
    /**
  ...
  class Service protected ()
    extends typings.atPulumiAws.ecsMod.Service {
    /**
  ...
  class TaskDefinition protected ()
    extends typings.atPulumiAws.ecsMod.TaskDefinition {
    /**
