...
object inspector extends js.Object {
  ...
  class AssessmentTarget protected ()
    extends typings.atPulumiAws.inspectorMod.AssessmentTarget {
    /**
  ...
  class AssessmentTemplate protected ()
    extends typings.atPulumiAws.inspectorMod.AssessmentTemplate {
    /**
  ...
  class ResourceGroup protected ()
    extends typings.atPulumiAws.inspectorMod.ResourceGroup {
    /**
