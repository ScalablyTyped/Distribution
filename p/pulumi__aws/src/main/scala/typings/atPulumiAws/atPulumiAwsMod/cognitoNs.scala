...
object cognitoNs extends js.Object {
  ...
  class IdentityPool protected ()
    extends typings.atPulumiAws.cognitoMod.IdentityPool {
    /**
  ...
  class IdentityPoolRoleAttachment protected ()
    extends typings.atPulumiAws.cognitoMod.IdentityPoolRoleAttachment {
    /**
  ...
  class IdentityProvider protected ()
    extends typings.atPulumiAws.cognitoMod.IdentityProvider {
    /**
  ...
  class ResourceServer protected ()
    extends typings.atPulumiAws.cognitoMod.ResourceServer {
    /**
  ...
  class UserGroup protected ()
    extends typings.atPulumiAws.cognitoMod.UserGroup {
    /**
  ...
  class UserPool protected ()
    extends typings.atPulumiAws.cognitoMod.UserPool {
    /**
  ...
  class UserPoolClient protected ()
    extends typings.atPulumiAws.cognitoMod.UserPoolClient {
    /**
  ...
  class UserPoolDomain protected ()
    extends typings.atPulumiAws.cognitoMod.UserPoolDomain {
    /**
