...
import typings.atPulumiAws.xraySamplingRuleMod.SamplingRuleArgs
import typings.atPulumiAws.xraySamplingRuleMod.SamplingRuleState
...
@JSImport("@pulumi/aws", "xray")
@js.native
object xrayNs extends js.Object {
  @js.native
  class SamplingRule protected ()
    extends typings.atPulumiAws.xrayMod.SamplingRule {
    /**
  ...
  object SamplingRule extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typings.atPulumiAws.xraySamplingRuleMod.SamplingRule = js.native
    def get(name: String, id: Input[ID], state: SamplingRuleState): typings.atPulumiAws.xraySamplingRuleMod.SamplingRule = js.native
    def get(name: String, id: Input[ID], state: SamplingRuleState, opts: CustomResourceOptions): typings.atPulumiAws.xraySamplingRuleMod.SamplingRule = js.native
    /**
