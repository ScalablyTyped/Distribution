...
object elbNs extends js.Object {
  ...
  class AppCookieStickinessPolicy protected ()
    extends typings.atPulumiAws.elbMod.AppCookieStickinessPolicy {
    /**
  ...
  class Attachment protected ()
    extends typings.atPulumiAws.elbMod.Attachment {
    /**
  ...
  class ListenerPolicy protected ()
    extends typings.atPulumiAws.elbMod.ListenerPolicy {
    /**
  ...
  class LoadBalancer protected ()
    extends typings.atPulumiAws.elbMod.LoadBalancer {
    /**
  ...
  class LoadBalancerBackendServerPolicy protected ()
    extends typings.atPulumiAws.elbMod.LoadBalancerBackendServerPolicy {
    /**
  ...
  class LoadBalancerCookieStickinessPolicy protected ()
    extends typings.atPulumiAws.elbMod.LoadBalancerCookieStickinessPolicy {
    /**
  ...
  class LoadBalancerPolicy protected ()
    extends typings.atPulumiAws.elbMod.LoadBalancerPolicy {
    /**
  ...
  class SslNegotiationPolicy protected ()
    extends typings.atPulumiAws.elbMod.SslNegotiationPolicy {
    /**
