...
trait Anon_DeleteOnTerminationEncryptedIopsKmsKeyIdSnapshotIdVolumeSize extends js.Object {
...
object Anon_DeleteOnTerminationEncryptedIopsKmsKeyIdSnapshotIdVolumeSize {
  @scala.inline
  def apply(
  ...
  ): Anon_DeleteOnTerminationEncryptedIopsKmsKeyIdSnapshotIdVolumeSize = {
    ...
    __obj.asInstanceOf[Anon_DeleteOnTerminationEncryptedIopsKmsKeyIdSnapshotIdVolumeSize]
  }
}
