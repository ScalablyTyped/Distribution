package typings.atPulumiAws.sesTemplateMod
...
class Template protected () extends CustomResource {
  ...
  /**
    ...
    */
  val html: Output[js.UndefOr[String]] = js.native
  /**
  ...
  /**
    ...
    */
  val subject: Output[js.UndefOr[String]] = js.native
  /**
    * The email body that will be visible to recipients whose email clients do not display HTML. Must be less than 500KB in size, including both the text and HTML parts.
    */
  val text: Output[js.UndefOr[String]] = js.native
}
