...
object autoscalingMod extends js.Object {
  ...
  class Group protected ()
    extends typings.atPulumiAws.autoscalingGroupMod.Group {
    /**
  ...
  class Notification protected ()
    extends typings.atPulumiAws.autoscalingNotificationMod.Notification {
    /**
  ...
  class Policy protected ()
    extends typings.atPulumiAws.autoscalingPolicyMod.Policy {
    /**
