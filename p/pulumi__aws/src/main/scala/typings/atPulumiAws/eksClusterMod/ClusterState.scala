...
trait ClusterState extends js.Object {
  ...
  /**
    ...
    */
  val certificateAuthority: js.UndefOr[Input[ClusterCertificateAuthority]] = js.undefined
  ...
  /**
    ...
    */
  val identities: js.UndefOr[Input[js.Array[Input[ClusterIdentity]]]] = js.undefined
  /**
    * Name of the cluster.
    */
  ...
  /**
    ...
    */
  val vpcConfig: js.UndefOr[Input[ClusterVpcConfig]] = js.undefined
}
