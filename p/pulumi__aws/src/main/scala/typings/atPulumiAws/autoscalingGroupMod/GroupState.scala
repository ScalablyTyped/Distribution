...
import typings.atPulumiAws.Anon_DefaultResultHeartbeatTimeout
import typings.atPulumiAws.Anon_IdName
import typings.atPulumiAws.Anon_InstancesDistributionLaunchTemplate
import typings.atPulumiAws.Anon_KeyPropagateAtLaunch
...
trait GroupState extends js.Object {
  ...
  /**
    ...
    */
  val initialLifecycleHooks: js.UndefOr[Input[js.Array[Input[Anon_DefaultResultHeartbeatTimeout]]]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val launchTemplate: js.UndefOr[Input[Anon_IdName]] = js.undefined
  /**
  ...
  /**
    ...
    */
  val mixedInstancesPolicy: js.UndefOr[Input[Anon_InstancesDistributionLaunchTemplate]] = js.undefined
  ...
  /**
    ...
    */
  val tags: js.UndefOr[Input[js.Array[Input[Anon_KeyPropagateAtLaunch]]]] = js.undefined
  /**
...
object GroupState {
  ...
  def apply(
    ...
    initialLifecycleHooks: Input[js.Array[Input[Anon_DefaultResultHeartbeatTimeout]]] = null,
    launchConfiguration: Input[String | LaunchConfiguration] = null,
    launchTemplate: Input[Anon_IdName] = null,
    ...
    mixedInstancesPolicy: Input[Anon_InstancesDistributionLaunchTemplate] = null,
    ...
    tags: Input[js.Array[Input[Anon_KeyPropagateAtLaunch]]] = null,
