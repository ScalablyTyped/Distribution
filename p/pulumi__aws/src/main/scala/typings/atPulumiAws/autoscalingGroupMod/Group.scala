...
import typings.atPulumiAws.Anon_DefaultResult
import typings.atPulumiAws.Anon_Id
import typings.atPulumiAws.Anon_InstancesDistribution
import typings.atPulumiAws.Anon_Key
...
class Group protected () extends CustomResource {
  ...
  /**
    ...
    */
  val mixedInstancesPolicy: Output[js.UndefOr[Anon_InstancesDistribution]] = js.native
  ...
  /**
    ...
    */
  val tags: Output[js.UndefOr[js.Array[Anon_Key]]] = js.native
  /**
