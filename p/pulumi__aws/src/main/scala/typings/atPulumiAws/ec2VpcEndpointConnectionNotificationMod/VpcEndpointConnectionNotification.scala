...
class VpcEndpointConnectionNotification protected () extends CustomResource {
  ...
  /**
    ...
    */
  val connectionEvents: Output[js.Array[String]] = js.native
  /**
    * The ARN of the SNS topic for the notifications.
    */
  val connectionNotificationArn: Output[String] = js.native
  /**
  ...
  /**
    ...
    */
  val vpcEndpointId: Output[js.UndefOr[String]] = js.native
  /**
    * The ID of the VPC Endpoint Service to receive notifications for.
    */
  val vpcEndpointServiceId: Output[js.UndefOr[String]] = js.native
}
