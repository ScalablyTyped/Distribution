...
import typings.atPulumiAws.typesInputMod.elasticloadbalancingv2.TargetGroupHealthCheck
import typings.atPulumiAws.typesInputMod.elasticloadbalancingv2.TargetGroupStickiness
