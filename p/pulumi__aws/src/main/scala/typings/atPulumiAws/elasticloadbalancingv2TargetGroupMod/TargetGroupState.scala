...
import typings.atPulumiAws.typesInputMod.elasticloadbalancingv2Ns.TargetGroupHealthCheck
import typings.atPulumiAws.typesInputMod.elasticloadbalancingv2Ns.TargetGroupStickiness
