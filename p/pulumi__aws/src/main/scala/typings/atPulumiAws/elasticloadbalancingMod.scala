...
object elasticloadbalancingMod extends js.Object {
  ...
  class LoadBalancerBackendServerPolicy protected ()
    extends typings.atPulumiAws.elasticloadbalancingLoadBalancerBackendServerPolicyMod.LoadBalancerBackendServerPolicy {
    /**
  ...
  class LoadBalancerPolicy protected ()
    extends typings.atPulumiAws.elasticloadbalancingLoadBalancerPolicyMod.LoadBalancerPolicy {
    /**
