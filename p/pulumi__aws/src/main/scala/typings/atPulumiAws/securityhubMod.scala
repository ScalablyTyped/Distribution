...
object securityhubMod extends js.Object {
  ...
  class Account protected ()
    extends typings.atPulumiAws.securityhubAccountMod.Account {
    /**
  ...
  class ProductSubscription protected ()
    extends typings.atPulumiAws.securityhubProductSubscriptionMod.ProductSubscription {
    /**
  ...
  class StandardsSubscription protected ()
    extends typings.atPulumiAws.securityhubStandardsSubscriptionMod.StandardsSubscription {
    /**
