...
object elasticbeanstalkMod extends js.Object {
  ...
  class Application protected ()
    extends typings.atPulumiAws.elasticbeanstalkApplicationMod.Application {
    /**
  ...
  class ApplicationVersion protected ()
    extends typings.atPulumiAws.elasticbeanstalkApplicationVersionMod.ApplicationVersion {
    /**
