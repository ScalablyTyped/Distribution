...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "aws-sdk" % "2.420.0-9d88c2",
  ...
  "org.scalablytyped" %%% "pulumi__pulumi" % "0.17.1-cc0f34",
  ...
  "org.scalablytyped" %%% "ts-node" % "7.0.1-450d87",
  ...
  "org.scalablytyped" %%% "xml2js" % "0.4-dt-20180606Z-0210f1",
