...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "buffer-from" % "1.1-dt-20180616Z-923a6a",
  ...
  "org.scalablytyped" %%% "pulumi__pulumi" % "0.17.4-52cf5f",
  ...
  "org.scalablytyped" %%% "ts-node" % "7.0.1-252ad8",
