...
@js.native
trait Anon_SchemeReds extends js.Object {
  ...
  val lab: d3DashColorLib.d3DashColorMod.LabColorFactory = js.native
  val lch: d3DashColorLib.d3DashColorMod.LCHColorFactory = js.native
  val namespaces: d3DashSelectionLib.d3DashSelectionMod.NamespaceMap = js.native
  val randomBates: d3DashRandomLib.d3DashRandomMod.RandomBates = js.native
  val randomExponential: d3DashRandomLib.d3DashRandomMod.RandomExponential = js.native
  val randomIrwinHall: d3DashRandomLib.d3DashRandomMod.RandomIrwinHall = js.native
  val randomLogNormal: d3DashRandomLib.d3DashRandomMod.RandomLogNormal = js.native
  ...
  val selection: d3DashSelectionLib.d3DashSelectionMod.SelectionFn = js.native
