...
object LayoutAxis {
  ...
  implicit open class MutableBuilder[Self <: LayoutAxis] (val x: Self) extends AnyVal {
    ...
    inline def setL2p(value: Datum => Double): Self = StObject.set(x, "l2p", js.Any.fromFunction1(value))
