...
object d3 {
  ...
  inline def Adder_=(x: Instantiable0[typings.d3.mod.Adder]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Adder")(x.asInstanceOf[js.Any])
  ...
  inline def Delaunay_=(x: js.Any | TypeofDelaunay): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Delaunay")(x.asInstanceOf[js.Any])
  ...
  inline def FormatSpecifier__=(x: Instantiable1[/* specifier */ FormatSpecifierObject, FormatSpecifier_]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FormatSpecifier")(x.asInstanceOf[js.Any])
  ...
  inline def Voronoi_=(x: Instantiable0[typings.d3.mod.Voronoi[js.Object]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Voronoi")(x.asInstanceOf[js.Any])
  ...
  inline def axisBottom[Domain /* <: AxisDomain */](scale: AxisScale[Domain]): typings.d3Axis.mod.Axis[Domain] = ^.asInstanceOf[js.Dynamic].applyDynamic("axisBottom")(scale.asInstanceOf[js.Any]).asInstanceOf[typings.d3Axis.mod.Axis[Domain]]
  
  inline def axisLeft[Domain /* <: AxisDomain */](scale: AxisScale[Domain]): typings.d3Axis.mod.Axis[Domain] = ^.asInstanceOf[js.Dynamic].applyDynamic("axisLeft")(scale.asInstanceOf[js.Any]).asInstanceOf[typings.d3Axis.mod.Axis[Domain]]
  
  inline def axisRight[Domain /* <: AxisDomain */](scale: AxisScale[Domain]): typings.d3Axis.mod.Axis[Domain] = ^.asInstanceOf[js.Dynamic].applyDynamic("axisRight")(scale.asInstanceOf[js.Any]).asInstanceOf[typings.d3Axis.mod.Axis[Domain]]
  
  inline def axisTop[Domain /* <: AxisDomain */](scale: AxisScale[Domain]): typings.d3Axis.mod.Axis[Domain] = ^.asInstanceOf[js.Dynamic].applyDynamic("axisTop")(scale.asInstanceOf[js.Any]).asInstanceOf[typings.d3Axis.mod.Axis[Domain]]
  ...
  inline def `bin_DatumValue_UnionDate<undefined>_HistogramGeneratorDate`[Datum, Value /* <: js.UndefOr[Date] */](): HistogramGeneratorDate[Datum, Value] = ^.asInstanceOf[js.Dynamic].applyDynamic("bin")().asInstanceOf[HistogramGeneratorDate[Datum, Value]]
  ...
  inline def bisectCenter(array: ArrayLike[Date], x: Date): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectCenter")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def bisectCenter(array: ArrayLike[Date], x: Date, lo: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectCenter")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def bisectCenter(array: ArrayLike[Date], x: Date, lo: Double, hi: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectCenter")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def bisectCenter(array: ArrayLike[Date], x: Date, lo: Unit, hi: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectCenter")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def bisectLeft(array: ArrayLike[Date], x: Date): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectLeft")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def bisectLeft(array: ArrayLike[Date], x: Date, lo: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectLeft")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def bisectLeft(array: ArrayLike[Date], x: Date, lo: Double, hi: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectLeft")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def bisectLeft(array: ArrayLike[Date], x: Date, lo: Unit, hi: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectLeft")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def bisectRight(array: ArrayLike[Date], x: Date): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectRight")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def bisectRight(array: ArrayLike[Date], x: Date, lo: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectRight")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def bisectRight(array: ArrayLike[Date], x: Date, lo: Double, hi: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectRight")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def bisectRight(array: ArrayLike[Date], x: Date, lo: Unit, hi: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("bisectRight")(array.asInstanceOf[js.Any], x.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def color(color: ColorCommonInstance): RGBColor | HSLColor = ^.asInstanceOf[js.Dynamic].applyDynamic("color")(color.asInstanceOf[js.Any]).asInstanceOf[RGBColor | HSLColor]
  /**
    * Converts the provided color instance and returns an RGB or HSL color.
    *
    * @param color A permissible color space instance.
    */
  inline def color(color: ColorSpaceObject): RGBColor | HSLColor = ^.asInstanceOf[js.Dynamic].applyDynamic("color")(color.asInstanceOf[js.Any]).asInstanceOf[RGBColor | HSLColor]
  /**
    ...
    */
  inline def color(cssColorSpecifier: String): RGBColor | HSLColor | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("color")(cssColorSpecifier.asInstanceOf[js.Any]).asInstanceOf[RGBColor | HSLColor | Null]
  ...
  inline def count[TObject](iterable: Iterable[TObject]): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("count")(iterable.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  inline def create_applet(name: applet): Selection_[HTMLAppletElement, Unit, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[Selection_[HTMLAppletElement, Unit, Null, Unit]]
  ...
  inline def create_b(name: b_): Selection_[HTMLElement, Unit, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[Selection_[HTMLElement, Unit, Null, Unit]]
  ...
  inline def create_basefont(name: basefont): Selection_[HTMLBaseFontElement, Unit, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[Selection_[HTMLBaseFontElement, Unit, Null, Unit]]
  ...
  inline def create_dir(name: dir): Selection_[HTMLDirectoryElement, Unit, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[Selection_[HTMLDirectoryElement, Unit, Null, Unit]]
  ...
  inline def create_font(name: font): Selection_[HTMLFontElement, Unit, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[Selection_[HTMLFontElement, Unit, Null, Unit]]
  ...
  inline def create_frame(name: frame): Selection_[HTMLFrameElement, Unit, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[Selection_[HTMLFrameElement, Unit, Null, Unit]]
  
  inline def create_frameset(name: frameset): Selection_[HTMLFrameSetElement, Unit, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[Selection_[HTMLFrameSetElement, Unit, Null, Unit]]
  ...
  inline def create_marquee(name: marquee): Selection_[HTMLMarqueeElement, Unit, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[Selection_[HTMLMarqueeElement, Unit, Null, Unit]]
  ...
  inline def create_param(name: param): Selection_[HTMLParamElement, Unit, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[Selection_[HTMLParamElement, Unit, Null, Unit]]
  ...
  inline def create_td(name: td): Selection_[HTMLTableDataCellElement, Unit, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[Selection_[HTMLTableDataCellElement, Unit, Null, Unit]]
  ...
  inline def create_th(name: th): Selection_[HTMLTableHeaderCellElement, Unit, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(name.asInstanceOf[js.Any]).asInstanceOf[Selection_[HTMLTableHeaderCellElement, Unit, Null, Unit]]
  ...
  inline def creator_applet(name: applet): js.ThisFunction0[/* this */ BaseType, HTMLAppletElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("creator")(name.asInstanceOf[js.Any]).asInstanceOf[js.ThisFunction0[/* this */ BaseType, HTMLAppletElement]]
  ...
  inline def creator_b(name: b_): js.ThisFunction0[/* this */ BaseType, HTMLElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("creator")(name.asInstanceOf[js.Any]).asInstanceOf[js.ThisFunction0[/* this */ BaseType, HTMLElement]]
  ...
  inline def creator_basefont(name: basefont): js.ThisFunction0[/* this */ BaseType, HTMLBaseFontElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("creator")(name.asInstanceOf[js.Any]).asInstanceOf[js.ThisFunction0[/* this */ BaseType, HTMLBaseFontElement]]
  ...
  inline def creator_dir(name: dir): js.ThisFunction0[/* this */ BaseType, HTMLDirectoryElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("creator")(name.asInstanceOf[js.Any]).asInstanceOf[js.ThisFunction0[/* this */ BaseType, HTMLDirectoryElement]]
  ...
  inline def creator_font(name: font): js.ThisFunction0[/* this */ BaseType, HTMLFontElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("creator")(name.asInstanceOf[js.Any]).asInstanceOf[js.ThisFunction0[/* this */ BaseType, HTMLFontElement]]
  ...
  inline def creator_frame(name: frame): js.ThisFunction0[/* this */ BaseType, HTMLFrameElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("creator")(name.asInstanceOf[js.Any]).asInstanceOf[js.ThisFunction0[/* this */ BaseType, HTMLFrameElement]]
  
  inline def creator_frameset(name: frameset): js.ThisFunction0[/* this */ BaseType, HTMLFrameSetElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("creator")(name.asInstanceOf[js.Any]).asInstanceOf[js.ThisFunction0[/* this */ BaseType, HTMLFrameSetElement]]
  ...
  inline def creator_marquee(name: marquee): js.ThisFunction0[/* this */ BaseType, HTMLMarqueeElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("creator")(name.asInstanceOf[js.Any]).asInstanceOf[js.ThisFunction0[/* this */ BaseType, HTMLMarqueeElement]]
  ...
  inline def creator_param(name: param): js.ThisFunction0[/* this */ BaseType, HTMLParamElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("creator")(name.asInstanceOf[js.Any]).asInstanceOf[js.ThisFunction0[/* this */ BaseType, HTMLParamElement]]
  ...
  inline def creator_td(name: td): js.ThisFunction0[/* this */ BaseType, HTMLTableDataCellElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("creator")(name.asInstanceOf[js.Any]).asInstanceOf[js.ThisFunction0[/* this */ BaseType, HTMLTableDataCellElement]]
  ...
  inline def creator_th(name: th): js.ThisFunction0[/* this */ BaseType, HTMLTableHeaderCellElement] = ^.asInstanceOf[js.Dynamic].applyDynamic("creator")(name.asInstanceOf[js.Any]).asInstanceOf[js.ThisFunction0[/* this */ BaseType, HTMLTableHeaderCellElement]]
  ...
  inline def cross[S, T](a: Iterable[S], b: Iterable[T]): js.Array[js.Tuple2[S, T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("cross")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Tuple2[S, T]]]
  inline def cross[S, T, U](a: Iterable[S], b: Iterable[T], reducer: js.Function2[/* a */ S, /* b */ T, U]): js.Array[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("cross")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], reducer.asInstanceOf[js.Any])).asInstanceOf[js.Array[U]]
  ...
  inline def cubehelix(color: ColorCommonInstance): CubehelixColor = ^.asInstanceOf[js.Dynamic].applyDynamic("cubehelix")(color.asInstanceOf[js.Any]).asInstanceOf[CubehelixColor]
  /**
    ...
    * @param color A permissible color space instance.
    */
  inline def cubehelix(color: ColorSpaceObject): CubehelixColor = ^.asInstanceOf[js.Dynamic].applyDynamic("cubehelix")(color.asInstanceOf[js.Any]).asInstanceOf[CubehelixColor]
  /**
    ...
    * @param cssColorSpecifier A CSS Color Module Level 3 specifier string.
    */
  inline def cubehelix(cssColorSpecifier: String): CubehelixColor = ^.asInstanceOf[js.Dynamic].applyDynamic("cubehelix")(cssColorSpecifier.asInstanceOf[js.Any]).asInstanceOf[CubehelixColor]
  /**
    ...
    */
  inline def cubehelix(h: Double, s: Double, l: Double): CubehelixColor = (^.asInstanceOf[js.Dynamic].applyDynamic("cubehelix")(h.asInstanceOf[js.Any], s.asInstanceOf[js.Any], l.asInstanceOf[js.Any])).asInstanceOf[CubehelixColor]
  inline def cubehelix(h: Double, s: Double, l: Double, opacity: Double): CubehelixColor = (^.asInstanceOf[js.Dynamic].applyDynamic("cubehelix")(h.asInstanceOf[js.Any], s.asInstanceOf[js.Any], l.asInstanceOf[js.Any], opacity.asInstanceOf[js.Any])).asInstanceOf[CubehelixColor]
  
  inline def cumsum[T /* <: Numeric */](iterable: Iterable[js.UndefOr[T | Null]]): Float64Array = ^.asInstanceOf[js.Dynamic].applyDynamic("cumsum")(iterable.asInstanceOf[js.Any]).asInstanceOf[Float64Array]
  inline def cumsum[T](
    iterable: Iterable[T],
  ...
  /**
    ...
    */
  inline def curveBasis(context: Path_): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveBasis")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  /**
    * Returns a curve generator which renders to the specified context.
    *
    * @param context A rendering context.
    */
  inline def curveBasis(context: CanvasRenderingContext2D): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveBasis")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  ...
  /**
    ...
    * @param context A rendering context.
    */
  inline def curveBasisClosed(context: Path_): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveBasisClosed")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  /**
    * Returns a curve generator which renders to the specified context.
    *
    * @param context A rendering context.
    */
  inline def curveBasisClosed(context: CanvasRenderingContext2D): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveBasisClosed")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  ...
  /**
    ...
    * @param context A rendering context.
    */
  inline def curveBasisOpen(context: Path_): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveBasisOpen")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  /**
    * Returns a curve generator which renders to the specified context.
    *
    * @param context A rendering context.
    */
  inline def curveBasisOpen(context: CanvasRenderingContext2D): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveBasisOpen")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  ...
  /**
    ...
    * @param context A rendering context.
    */
  inline def curveLinear(context: Path_): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveLinear")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  /**
    * Returns a curve generator which renders to the specified context.
    *
    * @param context A rendering context.
    */
  inline def curveLinear(context: CanvasRenderingContext2D): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveLinear")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  ...
  /**
    ...
    * @param context A rendering context.
    */
  inline def curveLinearClosed(context: Path_): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveLinearClosed")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  /**
    * Returns a curve generator which renders to the specified context.
    *
    * @param context A rendering context.
    */
  inline def curveLinearClosed(context: CanvasRenderingContext2D): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveLinearClosed")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  ...
  /**
    ...
    * @param context A rendering context.
    */
  inline def curveMonotoneX(context: Path_): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveMonotoneX")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  /**
    * Returns a curve generator which renders to the specified context.
    *
    * @param context A rendering context.
    */
  inline def curveMonotoneX(context: CanvasRenderingContext2D): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveMonotoneX")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  ...
  /**
    ...
    * @param context A rendering context.
    */
  inline def curveMonotoneY(context: Path_): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveMonotoneY")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  /**
    * Returns a curve generator which renders to the specified context.
    *
    * @param context A rendering context.
    */
  inline def curveMonotoneY(context: CanvasRenderingContext2D): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveMonotoneY")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  ...
  /**
    ...
    * @param context A rendering context.
    */
  inline def curveNatural(context: Path_): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveNatural")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  /**
    * Returns a curve generator which renders to the specified context.
    *
    * @param context A rendering context.
    */
  inline def curveNatural(context: CanvasRenderingContext2D): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveNatural")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  ...
  /**
    ...
    * @param context A rendering context.
    */
  inline def curveStep(context: Path_): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveStep")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  /**
    * Returns a curve generator which renders to the specified context.
    *
    * @param context A rendering context.
    */
  inline def curveStep(context: CanvasRenderingContext2D): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveStep")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  ...
  /**
    ...
    * @param context A rendering context.
    */
  inline def curveStepAfter(context: Path_): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveStepAfter")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  /**
    * Returns a curve generator which renders to the specified context.
    *
    * @param context A rendering context.
    */
  inline def curveStepAfter(context: CanvasRenderingContext2D): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveStepAfter")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  ...
  /**
    ...
    * @param context A rendering context.
    */
  inline def curveStepBefore(context: Path_): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveStepBefore")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  /**
    * Returns a curve generator which renders to the specified context.
    *
    * @param context A rendering context.
    */
  inline def curveStepBefore(context: CanvasRenderingContext2D): CurveGenerator = ^.asInstanceOf[js.Dynamic].applyDynamic("curveStepBefore")(context.asInstanceOf[js.Any]).asInstanceOf[CurveGenerator]
  ...
  inline def deviation[T /* <: Numeric */](iterable: Iterable[js.UndefOr[T | Null]]): js.UndefOr[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("deviation")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Double]]
  ...
  inline def difference[T](iterable: Iterable[T], others: Iterable[T]*): Set[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("difference")(iterable.asInstanceOf[js.Any], others.asInstanceOf[js.Any])).asInstanceOf[Set[T]]
  
  inline def disjoint[T](a: Iterable[T], b: Iterable[T]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("disjoint")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def easeBack(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easeBack")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    * @param normalizedTime Normalized time typically in the range [0, 1]
    */
  inline def easeBackIn(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easeBackIn")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    * @param normalizedTime Normalized time typically in the range [0, 1]
    */
  inline def easeBackInOut(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easeBackInOut")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    * @param normalizedTime Normalized time typically in the range [0, 1]
    */
  inline def easeBackOut(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easeBackOut")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    * @param normalizedTime Normalized time typically in the range [0, 1]
    */
  inline def easeElastic(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easeElastic")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    * @param normalizedTime Normalized time typically in the range [0, 1]
    */
  inline def easeElasticIn(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easeElasticIn")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    * @param normalizedTime Normalized time typically in the range [0, 1]
    */
  inline def easeElasticInOut(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easeElasticInOut")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    * @param normalizedTime Normalized time typically in the range [0, 1]
    */
  inline def easeElasticOut(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easeElasticOut")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    * @param normalizedTime Normalized time typically in the range [0, 1]
    */
  inline def easePoly(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easePoly")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    * @param normalizedTime Normalized time typically in the range [0, 1]
    */
  inline def easePolyIn(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easePolyIn")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    * @param normalizedTime Normalized time typically in the range [0, 1]
    */
  inline def easePolyInOut(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easePolyInOut")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  /**
    ...
    * @param normalizedTime Normalized time typically in the range [0, 1]
    */
  inline def easePolyOut(normalizedTime: Double): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("easePolyOut")(normalizedTime.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  inline def extent(iterable: Iterable[String]): js.Tuple2[String | Unit, String | Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("extent")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.Tuple2[String | Unit, String | Unit]]
  inline def extent[T](
    iterable: Iterable[T],
  ...
  inline def extent_T_Numeric[T /* <: Numeric */](iterable: Iterable[T]): js.Tuple2[T | Unit, T | Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("extent")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.Tuple2[T | Unit, T | Unit]]
  ...
  inline def formatSpecifier(specifier: String): typings.d3Format.mod.FormatSpecifier_ = ^.asInstanceOf[js.Dynamic].applyDynamic("formatSpecifier")(specifier.asInstanceOf[js.Any]).asInstanceOf[typings.d3Format.mod.FormatSpecifier_]
  
  inline def fsum[T /* <: Numeric */](values: Iterable[js.UndefOr[T | Null]]): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("fsum")(values.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def fsum[T](
    values: Iterable[T],
    accessor: js.Function3[/* datum */ T, /* index */ Double, /* array */ Iterable[T], js.UndefOr[Double | Null]]
  ...
  /**
    ...
    * @param opacity Optional opacity value, defaults to 1.
    */
  inline def gray(l: Double): LabColor = ^.asInstanceOf[js.Dynamic].applyDynamic("gray")(l.asInstanceOf[js.Any]).asInstanceOf[LabColor]
  /**
    * Constructs a new CIELAB color with the specified l value and a = b = 0.
    *
    * @param l Lightness typically in the range [0, 100].
    * @param opacity Optional opacity value, defaults to 1.
    */
  inline def gray(l: Double, opacity: Double): LabColor = (^.asInstanceOf[js.Dynamic].applyDynamic("gray")(l.asInstanceOf[js.Any], opacity.asInstanceOf[js.Any])).asInstanceOf[LabColor]
  
  inline def greatest[T](iterable: Iterable[T]): js.UndefOr[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("greatest")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[T]]
  inline def greatest[T](iterable: Iterable[T], comparator: js.Function2[/* a */ T, /* b */ T, Double]): js.UndefOr[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("greatest")(iterable.asInstanceOf[js.Any], comparator.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[T]]
  inline def greatest[T, U](iterable: Iterable[T], accessor: js.Function1[/* a */ T, U]): js.UndefOr[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("greatest")(iterable.asInstanceOf[js.Any], accessor.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[T]]
  
  inline def greatestIndex[T](iterable: Iterable[T]): js.UndefOr[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("greatestIndex")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Double]]
  inline def greatestIndex[T](iterable: Iterable[T], comparator: js.Function2[/* a */ T, /* b */ T, Double]): js.UndefOr[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("greatestIndex")(iterable.asInstanceOf[js.Any], comparator.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Double]]
  inline def greatestIndex[T, U](iterable: Iterable[T], accessor: js.Function1[/* a */ T, U]): js.UndefOr[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("greatestIndex")(iterable.asInstanceOf[js.Any], accessor.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Double]]
  
  inline def group[TObject, TKey](iterable: Iterable[TObject], key: js.Function1[/* value */ TObject, TKey]): Map[TKey, js.Array[TObject]] = (^.asInstanceOf[js.Dynamic].applyDynamic("group")(iterable.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[Map[TKey, js.Array[TObject]]]
  ...
  inline def groups[TObject, TKey](iterable: Iterable[TObject], key: js.Function1[/* value */ TObject, TKey]): js.Array[js.Tuple2[TKey, js.Array[TObject]]] = (^.asInstanceOf[js.Dynamic].applyDynamic("groups")(iterable.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Tuple2[TKey, js.Array[TObject]]]]
  ...
  inline def hcl(color: ColorCommonInstance): HCLColor = ^.asInstanceOf[js.Dynamic].applyDynamic("hcl")(color.asInstanceOf[js.Any]).asInstanceOf[HCLColor]
  /**
    ...
    * @param color A permissible color space instance.
    */
  inline def hcl(color: ColorSpaceObject): HCLColor = ^.asInstanceOf[js.Dynamic].applyDynamic("hcl")(color.asInstanceOf[js.Any]).asInstanceOf[HCLColor]
  /**
    ...
    * @param cssColorSpecifier A CSS Color Module Level 3 specifier string.
    */
  inline def hcl(cssColorSpecifier: String): HCLColor = ^.asInstanceOf[js.Dynamic].applyDynamic("hcl")(cssColorSpecifier.asInstanceOf[js.Any]).asInstanceOf[HCLColor]
  /**
    ...
    * @param opacity Optional opacity value, defaults to 1.
    */
  inline def hcl(h: Double, c: Double, l: Double): HCLColor = (^.asInstanceOf[js.Dynamic].applyDynamic("hcl")(h.asInstanceOf[js.Any], c.asInstanceOf[js.Any], l.asInstanceOf[js.Any])).asInstanceOf[HCLColor]
  inline def hcl(h: Double, c: Double, l: Double, opacity: Double): HCLColor = (^.asInstanceOf[js.Dynamic].applyDynamic("hcl")(h.asInstanceOf[js.Any], c.asInstanceOf[js.Any], l.asInstanceOf[js.Any], opacity.asInstanceOf[js.Any])).asInstanceOf[HCLColor]
  ...
  inline def `histogram_DatumValue_UnionDate<undefined>_HistogramGeneratorDate`[Datum, Value /* <: js.UndefOr[Date] */](): HistogramGeneratorDate[Datum, Value] = ^.asInstanceOf[js.Dynamic].applyDynamic("histogram")().asInstanceOf[HistogramGeneratorDate[Datum, Value]]
  ...
  inline def hsl(color: ColorCommonInstance): HSLColor = ^.asInstanceOf[js.Dynamic].applyDynamic("hsl")(color.asInstanceOf[js.Any]).asInstanceOf[HSLColor]
  /**
    ...
    * @param color A permissible color space instance.
    */
  inline def hsl(color: ColorSpaceObject): HSLColor = ^.asInstanceOf[js.Dynamic].applyDynamic("hsl")(color.asInstanceOf[js.Any]).asInstanceOf[HSLColor]
  /**
    ...
    * @param cssColorSpecifier A CSS Color Module Level 3 specifier string.
    */
  inline def hsl(cssColorSpecifier: String): HSLColor = ^.asInstanceOf[js.Dynamic].applyDynamic("hsl")(cssColorSpecifier.asInstanceOf[js.Any]).asInstanceOf[HSLColor]
  /**
    ...
    * @param opacity Optional opacity value, defaults to 1.
    */
  inline def hsl(h: Double, s: Double, l: Double): HSLColor = (^.asInstanceOf[js.Dynamic].applyDynamic("hsl")(h.asInstanceOf[js.Any], s.asInstanceOf[js.Any], l.asInstanceOf[js.Any])).asInstanceOf[HSLColor]
  inline def hsl(h: Double, s: Double, l: Double, opacity: Double): HSLColor = (^.asInstanceOf[js.Dynamic].applyDynamic("hsl")(h.asInstanceOf[js.Any], s.asInstanceOf[js.Any], l.asInstanceOf[js.Any], opacity.asInstanceOf[js.Any])).asInstanceOf[HSLColor]
  ...
  inline def index[TObject, TKey](iterable: Iterable[TObject], key: js.Function1[/* value */ TObject, TKey]): Map[TKey, TObject] = (^.asInstanceOf[js.Dynamic].applyDynamic("index")(iterable.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[Map[TKey, TObject]]
  ...
  inline def indexes[TObject, TKey](iterable: Iterable[TObject], key: js.Function1[/* value */ TObject, TKey]): js.Array[js.Tuple2[TKey, TObject]] = (^.asInstanceOf[js.Dynamic].applyDynamic("indexes")(iterable.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Tuple2[TKey, TObject]]]
  ...
  inline def interpolate(a: Double, b: typings.d3Interpolate.anon.ValueOf): js.Function1[/* t */ Double, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolate")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, Double]]
  ...
  inline def interpolate(a: typings.d3Interpolate.anon.ValueOf, b: Double): js.Function1[/* t */ Double, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolate")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, Double]]
  inline def interpolate(a: typings.d3Interpolate.anon.ValueOf, b: typings.d3Interpolate.anon.ValueOf): js.Function1[/* t */ Double, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolate")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, Double]]
  ...
  inline def interpolateCubehelix(a: String, b: String): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateCubehelix")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  inline def interpolateCubehelix(a: String, b: ColorCommonInstance): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateCubehelix")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  inline def interpolateCubehelix(a: ColorCommonInstance, b: String): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateCubehelix")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  inline def interpolateCubehelix(a: ColorCommonInstance, b: ColorCommonInstance): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateCubehelix")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  ...
  inline def interpolateCubehelixLong(a: String, b: String): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateCubehelixLong")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  inline def interpolateCubehelixLong(a: String, b: ColorCommonInstance): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateCubehelixLong")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  inline def interpolateCubehelixLong(a: ColorCommonInstance, b: String): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateCubehelixLong")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  inline def interpolateCubehelixLong(a: ColorCommonInstance, b: ColorCommonInstance): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateCubehelixLong")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  ...
  inline def interpolateNumber(a: Double, b: typings.d3Interpolate.anon.ValueOf): js.Function1[/* t */ Double, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateNumber")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, Double]]
  inline def interpolateNumber(a: typings.d3Interpolate.anon.ValueOf, b: Double): js.Function1[/* t */ Double, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateNumber")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, Double]]
  inline def interpolateNumber(a: typings.d3Interpolate.anon.ValueOf, b: typings.d3Interpolate.anon.ValueOf): js.Function1[/* t */ Double, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateNumber")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, Double]]
  ...
  inline def interpolateRgb(a: String, b: String): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateRgb")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  inline def interpolateRgb(a: String, b: ColorCommonInstance): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateRgb")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  inline def interpolateRgb(a: ColorCommonInstance, b: String): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateRgb")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  inline def interpolateRgb(a: ColorCommonInstance, b: ColorCommonInstance): js.Function1[/* t */ Double, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateRgb")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, String]]
  ...
  inline def interpolateRound(a: Double, b: typings.d3Interpolate.anon.ValueOf): js.Function1[/* t */ Double, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateRound")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, Double]]
  inline def interpolateRound(a: typings.d3Interpolate.anon.ValueOf, b: Double): js.Function1[/* t */ Double, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateRound")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, Double]]
  inline def interpolateRound(a: typings.d3Interpolate.anon.ValueOf, b: typings.d3Interpolate.anon.ValueOf): js.Function1[/* t */ Double, Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("interpolateRound")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* t */ Double, Double]]
  ...
  inline def intersection[T](iterables: Iterable[T]*): Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("intersection")(iterables.asInstanceOf[js.Any]).asInstanceOf[Set[T]]
  ...
  inline def lab(color: ColorCommonInstance): LabColor = ^.asInstanceOf[js.Dynamic].applyDynamic("lab")(color.asInstanceOf[js.Any]).asInstanceOf[LabColor]
  /**
    ...
    * @param color A permissible color space instance.
    */
  inline def lab(color: ColorSpaceObject): LabColor = ^.asInstanceOf[js.Dynamic].applyDynamic("lab")(color.asInstanceOf[js.Any]).asInstanceOf[LabColor]
  /**
    ...
    * @param cssColorSpecifier A CSS Color Module Level 3 specifier string.
    */
  inline def lab(cssColorSpecifier: String): LabColor = ^.asInstanceOf[js.Dynamic].applyDynamic("lab")(cssColorSpecifier.asInstanceOf[js.Any]).asInstanceOf[LabColor]
  /**
    ...
    * @param opacity Optional opacity value, defaults to 1.
    */
  inline def lab(l: Double, a: Double, b: Double): LabColor = (^.asInstanceOf[js.Dynamic].applyDynamic("lab")(l.asInstanceOf[js.Any], a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[LabColor]
  inline def lab(l: Double, a: Double, b: Double, opacity: Double): LabColor = (^.asInstanceOf[js.Dynamic].applyDynamic("lab")(l.asInstanceOf[js.Any], a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], opacity.asInstanceOf[js.Any])).asInstanceOf[LabColor]
  
  inline def lch(color: ColorCommonInstance): HCLColor = ^.asInstanceOf[js.Dynamic].applyDynamic("lch")(color.asInstanceOf[js.Any]).asInstanceOf[HCLColor]
  /**
    * Converts the provided color instance and returns an HCL color.
    * The color instance is converted to the RGB color space using color.rgb and then converted to HCL.
    * (Colors already in the HCL color space skip the conversion to RGB,
    ...
    * @param color A permissible color space instance.
    */
  inline def lch(color: ColorSpaceObject): HCLColor = ^.asInstanceOf[js.Dynamic].applyDynamic("lch")(color.asInstanceOf[js.Any]).asInstanceOf[HCLColor]
  /**
    * Parses the specified CSS Color Module Level 3 specifier string, returning an HCL color.
    * If the specifier was not valid, null is returned.
    *
    * @param cssColorSpecifier A CSS color Module Level 3 specifier string.
    */
  inline def lch(cssColorSpecifier: String): HCLColor = ^.asInstanceOf[js.Dynamic].applyDynamic("lch")(cssColorSpecifier.asInstanceOf[js.Any]).asInstanceOf[HCLColor]
  /**
    * Constructs a new HCL color based on the specified channel values and opacity.
    *
    * @param l Luminance channel value typically in the range [0, 100].
    ...
    * @param opacity Optional opacity value, defaults to 1.
    */
  inline def lch(l: Double, c: Double, h: Double): HCLColor = (^.asInstanceOf[js.Dynamic].applyDynamic("lch")(l.asInstanceOf[js.Any], c.asInstanceOf[js.Any], h.asInstanceOf[js.Any])).asInstanceOf[HCLColor]
  inline def lch(l: Double, c: Double, h: Double, opacity: Double): HCLColor = (^.asInstanceOf[js.Dynamic].applyDynamic("lch")(l.asInstanceOf[js.Any], c.asInstanceOf[js.Any], h.asInstanceOf[js.Any], opacity.asInstanceOf[js.Any])).asInstanceOf[HCLColor]
  
  inline def least[T](iterable: Iterable[T]): js.UndefOr[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("least")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[T]]
  inline def least[T](iterable: Iterable[T], comparator: js.Function2[/* a */ T, /* b */ T, Double]): js.UndefOr[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("least")(iterable.asInstanceOf[js.Any], comparator.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[T]]
  inline def least[T, U](iterable: Iterable[T], accessor: js.Function1[/* a */ T, U]): js.UndefOr[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("least")(iterable.asInstanceOf[js.Any], accessor.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[T]]
  
  inline def leastIndex[T](iterable: Iterable[T]): js.UndefOr[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("leastIndex")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Double]]
  inline def leastIndex[T](iterable: Iterable[T], comparator: js.Function2[/* a */ T, /* b */ T, Double]): js.UndefOr[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("leastIndex")(iterable.asInstanceOf[js.Any], comparator.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Double]]
  inline def leastIndex[T, U](iterable: Iterable[T], accessor: js.Function1[/* a */ T, U]): js.UndefOr[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("leastIndex")(iterable.asInstanceOf[js.Any], accessor.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Double]]
  ...
  inline def max(iterable: Iterable[String]): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("max")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[String]]
  inline def max[T](
    iterable: Iterable[T],
    accessor: js.Function3[/* datum */ T, /* index */ Double, /* array */ Iterable[T], js.UndefOr[String | Null]]
  ...
  inline def maxIndex[T](iterable: Iterable[T]): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("maxIndex")(iterable.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def maxIndex[TDatum, U](
  ...
  inline def max_T_Numeric[T /* <: Numeric */](iterable: Iterable[T]): js.UndefOr[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("max")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[T]]
  
  inline def mean[T /* <: Numeric */](iterable: Iterable[js.UndefOr[T | Null]]): js.UndefOr[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("mean")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Double]]
  inline def mean[T](
    iterable: Iterable[T],
    accessor: js.Function3[/* datum */ T, /* index */ Double, /* array */ Iterable[T], js.UndefOr[Double | Null]]
  ...
  inline def median[T /* <: Numeric */](iterable: Iterable[js.UndefOr[T | Null]]): js.UndefOr[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("median")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Double]]
  inline def median[T](
    iterable: Iterable[T],
    accessor: js.Function3[/* element */ T, /* i */ Double, /* array */ Iterable[T], js.UndefOr[Double | Null]]
  ...
  inline def merge[T](iterables: Iterable[Iterable[T]]): js.Array[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("merge")(iterables.asInstanceOf[js.Any]).asInstanceOf[js.Array[T]]
  
  inline def min(iterable: Iterable[String]): js.UndefOr[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("min")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[String]]
  inline def min[T](
    iterable: Iterable[T],
    accessor: js.Function3[/* datum */ T, /* index */ Double, /* array */ Iterable[T], js.UndefOr[String | Null]]
  ...
  inline def minIndex[T](iterable: Iterable[T]): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("minIndex")(iterable.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def minIndex[TDatum, U](
    iterable: Iterable[TDatum],
    accessor: js.Function3[
      /* datum */ TDatum, 
      /* index */ Double, 
  ...
  inline def min_T_Numeric[T /* <: Numeric */](iterable: Iterable[T]): js.UndefOr[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("min")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[T]]
  ...
  inline def pairs[T](iterable: Iterable[T]): js.Array[js.Tuple2[T, T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("pairs")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Tuple2[T, T]]]
  inline def pairs[T, U](iterable: Iterable[T], reducer: js.Function2[/* a */ T, /* b */ T, U]): js.Array[U] = (^.asInstanceOf[js.Dynamic].applyDynamic("pairs")(iterable.asInstanceOf[js.Any], reducer.asInstanceOf[js.Any])).asInstanceOf[js.Array[U]]
  ...
  inline def permute[T](source: NumberDictionary[T], keys: Iterable[Double]): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("permute")(source.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
  inline def permute[T, K /* <: /* keyof T */ String */](source: T, keys: Iterable[K]): js.Array[
  ...
  inline def pie(): Pie_[js.Any, Double | typings.d3Shape.anon.ValueOf] = ^.asInstanceOf[js.Dynamic].applyDynamic("pie")().asInstanceOf[Pie_[js.Any, Double | typings.d3Shape.anon.ValueOf]]
  ...
  inline def quantile[T /* <: Numeric */](iterable: Iterable[js.UndefOr[T | Null]], p: Double): js.UndefOr[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("quantile")(iterable.asInstanceOf[js.Any], p.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Double]]
  ...
  inline def quantileSorted[T /* <: Numeric */](array: js.Array[js.UndefOr[T | Null]], p: Double): js.UndefOr[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("quantileSorted")(array.asInstanceOf[js.Any], p.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[Double]]
  ...
  /**
    ...
    */
  inline def randomBates(n: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomBates")(n.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    * @param p p
    */
  inline def randomBernoulli(p: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomBernoulli")(p.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    */
  inline def randomBeta(alpha: Double, beta: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomBeta")(alpha.asInstanceOf[js.Any], beta.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    */
  inline def randomBinomial(p: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomBinomial")(p.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    */
  inline def randomCauchy(): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomCauchy")().asInstanceOf[js.Function0[Double]]
  inline def randomCauchy(a: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomCauchy")(a.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  inline def randomCauchy(a: Double, b: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomCauchy")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  inline def randomCauchy(a: Unit, b: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomCauchy")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    */
  inline def randomExponential(lambda: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomExponential")(lambda.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    */
  inline def randomGamma(k: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomGamma")(k.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  inline def randomGamma(k: Double, theta: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomGamma")(k.asInstanceOf[js.Any], theta.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    * @param p Success probability
    */
  inline def randomGeometric(p: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomGeometric")(p.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    */
  inline def randomInt(max: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomInt")(max.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  /**
    * Returns a function for generating random integers with a uniform distribution.
    * The minimum allowed value of a returned number is ⌊min⌋ (inclusive), and the maximum is ⌊max - 1⌋ (inclusive)
    *
  ...
  inline def randomInt(min: Double, max: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomInt")(min.asInstanceOf[js.Any], max.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    * @param n Number of independent random variables to use.
    */
  inline def randomIrwinHall(n: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomIrwinHall")(n.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    */
  inline def randomLogNormal(): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomLogNormal")().asInstanceOf[js.Function0[Double]]
  inline def randomLogNormal(mu: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomLogNormal")(mu.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  inline def randomLogNormal(mu: Double, sigma: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomLogNormal")(mu.asInstanceOf[js.Any], sigma.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  inline def randomLogNormal(mu: Unit, sigma: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomLogNormal")(mu.asInstanceOf[js.Any], sigma.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    * @param b Scale parameter
    */
  inline def randomLogistic(): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomLogistic")().asInstanceOf[js.Function0[Double]]
  inline def randomLogistic(a: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomLogistic")(a.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  inline def randomLogistic(a: Double, b: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomLogistic")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  inline def randomLogistic(a: Unit, b: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomLogistic")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    * @param sigma Standard deviation, defaults to 1.
    */
  inline def randomNormal(): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomNormal")().asInstanceOf[js.Function0[Double]]
  inline def randomNormal(mu: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomNormal")(mu.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  inline def randomNormal(mu: Double, sigma: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomNormal")(mu.asInstanceOf[js.Any], sigma.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  inline def randomNormal(mu: Unit, sigma: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomNormal")(mu.asInstanceOf[js.Any], sigma.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    * @param alpha alpha
    */
  inline def randomPareto(alpha: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomPareto")(alpha.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    * @param lambda Mean
    */
  inline def randomPoisson(lambda: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomPoisson")(lambda.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    */
  inline def randomUniform(): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomUniform")().asInstanceOf[js.Function0[Double]]
  inline def randomUniform(max: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomUniform")(max.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  /**
    * Returns a function for generating random numbers with a uniform distribution.
    * The minimum allowed value of a returned number is min (inclusive), and the maximum is max (exclusive).
    *
    ...
    */
  // tslint:disable-next-line:unified-signatures
  inline def randomUniform(min: Double, max: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomUniform")(min.asInstanceOf[js.Any], max.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  ...
  /**
    ...
    * @param b Scale parameter
    */
  inline def randomWeibull(k: Double): js.Function0[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("randomWeibull")(k.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Double]]
  inline def randomWeibull(k: Double, a: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomWeibull")(k.asInstanceOf[js.Any], a.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  inline def randomWeibull(k: Double, a: Double, b: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomWeibull")(k.asInstanceOf[js.Any], a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  inline def randomWeibull(k: Double, a: Unit, b: Double): js.Function0[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("randomWeibull")(k.asInstanceOf[js.Any], a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Double]]
  ...
  inline def reverse[T](iterable: Iterable[T]): js.Array[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("reverse")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.Array[T]]
  
  @JSImport("plotly.js", "d3.rgb")
  @js.native
  val rgb: RGBColorFactory = js.native
  inline def rgb(color: ColorCommonInstance): RGBColor = ^.asInstanceOf[js.Dynamic].applyDynamic("rgb")(color.asInstanceOf[js.Any]).asInstanceOf[RGBColor]
  /**
    ...
    * @param color A permissible color space instance.
    */
  inline def rgb(color: ColorSpaceObject): RGBColor = ^.asInstanceOf[js.Dynamic].applyDynamic("rgb")(color.asInstanceOf[js.Any]).asInstanceOf[RGBColor]
  /**
    ...
    * @param cssColorSpecifier A CSS Color Module Level 3 specifier string.
    */
  inline def rgb(cssColorSpecifier: String): RGBColor = ^.asInstanceOf[js.Dynamic].applyDynamic("rgb")(cssColorSpecifier.asInstanceOf[js.Any]).asInstanceOf[RGBColor]
  /**
    ...
    * @param opacity Optional opacity value, defaults to 1.
    */
  inline def rgb(r: Double, g: Double, b: Double): RGBColor = (^.asInstanceOf[js.Dynamic].applyDynamic("rgb")(r.asInstanceOf[js.Any], g.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[RGBColor]
  inline def rgb(r: Double, g: Double, b: Double, opacity: Double): RGBColor = (^.asInstanceOf[js.Dynamic].applyDynamic("rgb")(r.asInstanceOf[js.Any], g.asInstanceOf[js.Any], b.asInstanceOf[js.Any], opacity.asInstanceOf[js.Any])).asInstanceOf[RGBColor]
  ...
  inline def scaleBand[Domain /* <: typings.d3Scale.anon.ToString */](): ScaleBand_[Domain] = ^.asInstanceOf[js.Dynamic].applyDynamic("scaleBand")().asInstanceOf[ScaleBand_[Domain]]
  inline def scaleBand[Domain /* <: typings.d3Scale.anon.ToString */](domain: Iterable[Domain], range: Iterable[NumberValue]): ScaleBand_[Domain] = (^.asInstanceOf[js.Dynamic].applyDynamic("scaleBand")(domain.asInstanceOf[js.Any], range.asInstanceOf[js.Any])).asInstanceOf[ScaleBand_[Domain]]
  inline def scaleBand[Domain /* <: typings.d3Scale.anon.ToString */](range: Iterable[NumberValue]): ScaleBand_[Domain] = ^.asInstanceOf[js.Dynamic].applyDynamic("scaleBand")(range.asInstanceOf[js.Any]).asInstanceOf[ScaleBand_[Domain]]
  ...
  inline def scaleOrdinal[Domain /* <: typings.d3Scale.anon.ToString */, Range, Unknown](domain: Iterable[Domain], range: Iterable[Range]): ScaleOrdinal_[Domain, Range, Unknown] = (^.asInstanceOf[js.Dynamic].applyDynamic("scaleOrdinal")(domain.asInstanceOf[js.Any], range.asInstanceOf[js.Any])).asInstanceOf[ScaleOrdinal_[Domain, Range, Unknown]]
  ...
  inline def scaleOrdinal_Domain_ToStringRangeUnknown[Domain /* <: typings.d3Scale.anon.ToString */, Range, Unknown](range: Iterable[Range]): ScaleOrdinal_[Domain, Range, Unknown] = ^.asInstanceOf[js.Dynamic].applyDynamic("scaleOrdinal")(range.asInstanceOf[js.Any]).asInstanceOf[ScaleOrdinal_[Domain, Range, Unknown]]
  ...
  inline def scalePoint[Domain /* <: typings.d3Scale.anon.ToString */](domain: Iterable[Domain], range: Iterable[NumberValue]): ScalePoint_[Domain] = (^.asInstanceOf[js.Dynamic].applyDynamic("scalePoint")(domain.asInstanceOf[js.Any], range.asInstanceOf[js.Any])).asInstanceOf[ScalePoint_[Domain]]
  inline def scalePoint[Domain /* <: typings.d3Scale.anon.ToString */](range: Iterable[NumberValue]): ScalePoint_[Domain] = ^.asInstanceOf[js.Dynamic].applyDynamic("scalePoint")(range.asInstanceOf[js.Any]).asInstanceOf[ScalePoint_[Domain]]
  ...
  inline def selectAll[GElement /* <: BaseType */, OldDatum](nodes: typings.d3Selection.mod.ArrayLike[GElement]): Selection_[GElement, OldDatum, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("selectAll")(nodes.asInstanceOf[js.Any]).asInstanceOf[Selection_[GElement, OldDatum, Null, Unit]]
  ...
  inline def selection(): Selection_[HTMLElement, js.Any, Null, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("selection")().asInstanceOf[Selection_[HTMLElement, js.Any, Null, Unit]]
  ...
  inline def shuffle(array: Float32Array): Float32Array = ^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any]).asInstanceOf[Float32Array]
  inline def shuffle(array: Float32Array, lo: Double): Float32Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Float32Array]
  inline def shuffle(array: Float32Array, lo: Double, hi: Double): Float32Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Float32Array]
  inline def shuffle(array: Float32Array, lo: Unit, hi: Double): Float32Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Float32Array]
  inline def shuffle(array: Float64Array): Float64Array = ^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any]).asInstanceOf[Float64Array]
  inline def shuffle(array: Float64Array, lo: Double): Float64Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Float64Array]
  inline def shuffle(array: Float64Array, lo: Double, hi: Double): Float64Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Float64Array]
  inline def shuffle(array: Float64Array, lo: Unit, hi: Double): Float64Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Float64Array]
  inline def shuffle(array: Int16Array): Int16Array = ^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any]).asInstanceOf[Int16Array]
  inline def shuffle(array: Int16Array, lo: Double): Int16Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Int16Array]
  inline def shuffle(array: Int16Array, lo: Double, hi: Double): Int16Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Int16Array]
  inline def shuffle(array: Int16Array, lo: Unit, hi: Double): Int16Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Int16Array]
  inline def shuffle(array: Int32Array): Int32Array = ^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any]).asInstanceOf[Int32Array]
  inline def shuffle(array: Int32Array, lo: Double): Int32Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Int32Array]
  inline def shuffle(array: Int32Array, lo: Double, hi: Double): Int32Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Int32Array]
  inline def shuffle(array: Int32Array, lo: Unit, hi: Double): Int32Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Int32Array]
  inline def shuffle(array: Int8Array): Int8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any]).asInstanceOf[Int8Array]
  inline def shuffle(array: Int8Array, lo: Double): Int8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Int8Array]
  inline def shuffle(array: Int8Array, lo: Double, hi: Double): Int8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Int8Array]
  inline def shuffle(array: Int8Array, lo: Unit, hi: Double): Int8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Int8Array]
  inline def shuffle(array: Uint16Array): Uint16Array = ^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any]).asInstanceOf[Uint16Array]
  inline def shuffle(array: Uint16Array, lo: Double): Uint16Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Uint16Array]
  inline def shuffle(array: Uint16Array, lo: Double, hi: Double): Uint16Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Uint16Array]
  inline def shuffle(array: Uint16Array, lo: Unit, hi: Double): Uint16Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Uint16Array]
  inline def shuffle(array: Uint32Array): Uint32Array = ^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any]).asInstanceOf[Uint32Array]
  inline def shuffle(array: Uint32Array, lo: Double): Uint32Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Uint32Array]
  inline def shuffle(array: Uint32Array, lo: Double, hi: Double): Uint32Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Uint32Array]
  inline def shuffle(array: Uint32Array, lo: Unit, hi: Double): Uint32Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Uint32Array]
  inline def shuffle(array: Uint8Array): Uint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any]).asInstanceOf[Uint8Array]
  inline def shuffle(array: Uint8Array, lo: Double): Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Uint8Array]
  inline def shuffle(array: Uint8Array, lo: Double, hi: Double): Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Uint8Array]
  inline def shuffle(array: Uint8Array, lo: Unit, hi: Double): Uint8Array = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Uint8Array]
  inline def shuffle(array: Uint8ClampedArray): Uint8ClampedArray = ^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any]).asInstanceOf[Uint8ClampedArray]
  inline def shuffle(array: Uint8ClampedArray, lo: Double): Uint8ClampedArray = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any])).asInstanceOf[Uint8ClampedArray]
  inline def shuffle(array: Uint8ClampedArray, lo: Double, hi: Double): Uint8ClampedArray = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Uint8ClampedArray]
  inline def shuffle(array: Uint8ClampedArray, lo: Unit, hi: Double): Uint8ClampedArray = (^.asInstanceOf[js.Dynamic].applyDynamic("shuffle")(array.asInstanceOf[js.Any], lo.asInstanceOf[js.Any], hi.asInstanceOf[js.Any])).asInstanceOf[Uint8ClampedArray]
  ...
  inline def sort[T](iterable: Iterable[T]): js.Array[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("sort")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.Array[T]]
  inline def sort[T](iterable: Iterable[T], comparator: js.Function2[/* a */ T, /* b */ T, Double]): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("sort")(iterable.asInstanceOf[js.Any], comparator.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
  ...
  inline def subset[T](a: Iterable[T], b: Iterable[T]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("subset")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  inline def sum[T /* <: Numeric */](iterable: Iterable[js.UndefOr[T | Null]]): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("sum")(iterable.asInstanceOf[js.Any]).asInstanceOf[Double]
  inline def sum[T](
    iterable: Iterable[T],
    accessor: js.Function3[/* datum */ T, /* index */ Double, /* array */ Iterable[T], js.UndefOr[Double | Null]]
  ...
  inline def superset[T](a: Iterable[T], b: Iterable[T]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("superset")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def timeDay(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeDay")().asInstanceOf[Date]
  inline def timeDay(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeDay")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeFriday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeFriday")().asInstanceOf[Date]
  inline def timeFriday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeFriday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeHour(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeHour")().asInstanceOf[Date]
  inline def timeHour(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeHour")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeMillisecond(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeMillisecond")().asInstanceOf[Date]
  inline def timeMillisecond(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeMillisecond")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeMinute(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeMinute")().asInstanceOf[Date]
  inline def timeMinute(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeMinute")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeMonday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeMonday")().asInstanceOf[Date]
  inline def timeMonday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeMonday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeMonth(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeMonth")().asInstanceOf[Date]
  inline def timeMonth(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeMonth")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeSaturday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeSaturday")().asInstanceOf[Date]
  inline def timeSaturday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeSaturday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeSecond(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeSecond")().asInstanceOf[Date]
  inline def timeSecond(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeSecond")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeSunday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeSunday")().asInstanceOf[Date]
  inline def timeSunday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeSunday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeThursday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeThursday")().asInstanceOf[Date]
  inline def timeThursday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeThursday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeTuesday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeTuesday")().asInstanceOf[Date]
  inline def timeTuesday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeTuesday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeWednesday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeWednesday")().asInstanceOf[Date]
  inline def timeWednesday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeWednesday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeWeek(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeWeek")().asInstanceOf[Date]
  inline def timeWeek(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeWeek")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def timeYear(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeYear")().asInstanceOf[Date]
  inline def timeYear(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("timeYear")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  inline def treemapResquarify(node: HierarchyRectangularNode[js.Any], x0: Double, y0: Double, x1: Double, y1: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("treemapResquarify")(node.asInstanceOf[js.Any], x0.asInstanceOf[js.Any], y0.asInstanceOf[js.Any], x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def treemapSquarify(node: HierarchyRectangularNode[js.Any], x0: Double, y0: Double, x1: Double, y1: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("treemapSquarify")(node.asInstanceOf[js.Any], x0.asInstanceOf[js.Any], y0.asInstanceOf[js.Any], x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def union[T](iterables: Iterable[T]*): Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("union")(iterables.asInstanceOf[js.Any]).asInstanceOf[Set[T]]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcDay(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcDay")().asInstanceOf[Date]
  inline def utcDay(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcDay")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcFriday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcFriday")().asInstanceOf[Date]
  inline def utcFriday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcFriday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcHour(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcHour")().asInstanceOf[Date]
  inline def utcHour(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcHour")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcMillisecond(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcMillisecond")().asInstanceOf[Date]
  inline def utcMillisecond(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcMillisecond")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcMinute(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcMinute")().asInstanceOf[Date]
  inline def utcMinute(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcMinute")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcMonday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcMonday")().asInstanceOf[Date]
  inline def utcMonday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcMonday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcMonth(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcMonth")().asInstanceOf[Date]
  inline def utcMonth(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcMonth")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcSaturday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcSaturday")().asInstanceOf[Date]
  inline def utcSaturday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcSaturday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcSecond(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcSecond")().asInstanceOf[Date]
  inline def utcSecond(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcSecond")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcSunday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcSunday")().asInstanceOf[Date]
  inline def utcSunday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcSunday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcThursday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcThursday")().asInstanceOf[Date]
  inline def utcThursday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcThursday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcTuesday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcTuesday")().asInstanceOf[Date]
  inline def utcTuesday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcTuesday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcWednesday(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcWednesday")().asInstanceOf[Date]
  inline def utcWednesday(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcWednesday")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcWeek(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcWeek")().asInstanceOf[Date]
  inline def utcWeek(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcWeek")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  /**
    ...
    * @param date A date object.
    */
  inline def utcYear(): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcYear")().asInstanceOf[Date]
  inline def utcYear(date: Date): Date = ^.asInstanceOf[js.Dynamic].applyDynamic("utcYear")(date.asInstanceOf[js.Any]).asInstanceOf[Date]
  ...
  inline def variance[T /* <: Numeric */](iterable: Iterable[js.UndefOr[T | Null]]): js.UndefOr[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("variance")(iterable.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Double]]
  ...
  inline def zip[T](arrays: ArrayLike[T]*): js.Array[js.Array[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("zip")(arrays.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Array[T]]]
