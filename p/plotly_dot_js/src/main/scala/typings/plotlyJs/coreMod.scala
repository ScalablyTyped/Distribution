...
object coreMod {
  ...
  inline def downloadImage(root: Root, opts: DownloadImgopts): js.Promise[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("downloadImage")(root.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[String]]
  ...
  inline def plot(root: Root, data: js.Array[Data]): js.Promise[PlotlyHTMLElement] = (^.asInstanceOf[js.Dynamic].applyDynamic("plot")(root.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[js.Promise[PlotlyHTMLElement]]
  inline def plot(root: Root, data: js.Array[Data], layout: Unit, config: PartialConfig): js.Promise[PlotlyHTMLElement] = (^.asInstanceOf[js.Dynamic].applyDynamic("plot")(root.asInstanceOf[js.Any], data.asInstanceOf[js.Any], layout.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[js.Promise[PlotlyHTMLElement]]
  inline def plot(root: Root, data: js.Array[Data], layout: PartialLayout): js.Promise[PlotlyHTMLElement] = (^.asInstanceOf[js.Dynamic].applyDynamic("plot")(root.asInstanceOf[js.Any], data.asInstanceOf[js.Any], layout.asInstanceOf[js.Any])).asInstanceOf[js.Promise[PlotlyHTMLElement]]
  inline def plot(root: Root, data: js.Array[Data], layout: PartialLayout, config: PartialConfig): js.Promise[PlotlyHTMLElement] = (^.asInstanceOf[js.Dynamic].applyDynamic("plot")(root.asInstanceOf[js.Any], data.asInstanceOf[js.Any], layout.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[js.Promise[PlotlyHTMLElement]]
  ...
  inline def toImage(root: Root, opts: ToImgopts): js.Promise[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("toImage")(root.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[js.Promise[String]]
