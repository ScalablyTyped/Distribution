...
object Partialrowsnumberroworder {
  ...
  @scala.inline
  implicit class PartialrowsnumberroworderMutableBuilder[Self <: Partialrowsnumberroworder] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDomain(value: PartialxArraynumberyArray): Self = StObject.set(x, "domain", value.asInstanceOf[js.Any])
