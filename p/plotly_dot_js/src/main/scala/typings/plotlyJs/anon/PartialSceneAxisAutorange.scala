...
object PartialSceneAxisAutorange {
  ...
  implicit class PartialSceneAxisAutorangeOps[Self <: PartialSceneAxisAutorange] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTickfont(value: Partial[typings.plotlyJs.mod.Font]): Self = this.set("tickfont", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitle(value: String | Partial[DataTitle]): Self = this.set("title", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTitle: Self = this.set("title", js.undefined)
    
    @scala.inline
    def setTitlefont(value: Partial[typings.plotlyJs.mod.Font]): Self = this.set("titlefont", value.asInstanceOf[js.Any])
