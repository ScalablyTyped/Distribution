...
object PartialSceneAxisAutorange {
  ...
  def apply(
    ...
    backgroundcolor: typings.plotlyJs.mod.Color = null,
    ...
    if (!js.isUndefined(showaxeslabels)) __obj.updateDynamic("showaxeslabels")(showaxeslabels.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(spikesides)) __obj.updateDynamic("spikesides")(spikesides.get.asInstanceOf[js.Any])
