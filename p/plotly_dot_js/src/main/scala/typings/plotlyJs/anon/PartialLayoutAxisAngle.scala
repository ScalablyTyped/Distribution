...
object PartialLayoutAxisAngle {
  ...
  @scala.inline
  implicit class PartialLayoutAxisAngleOps[Self <: PartialLayoutAxisAngle] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRangeselector(value: Partial[RangeSelector]): Self = this.set("rangeselector", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRangeselector: Self = this.set("rangeselector", js.undefined)
    @scala.inline
    def setRangeslider(value: Partial[RangeSlider]): Self = this.set("rangeslider", value.asInstanceOf[js.Any])
    @scala.inline
