...
@js.native
trait PartialLayoutAxisAngle extends StObject {
  ...
  var rangeselector: js.UndefOr[Partial[RangeSelector]] = js.native
  
  var rangeslider: js.UndefOr[Partial[RangeSlider]] = js.native
...
object PartialLayoutAxisAngle {
  ...
  @scala.inline
  def apply(): PartialLayoutAxisAngle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialLayoutAxisAngle]
  }
  
  @scala.inline
  implicit class PartialLayoutAxisAngleMutableBuilder[Self <: PartialLayoutAxisAngle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRangeselector(value: Partial[RangeSelector]): Self = StObject.set(x, "rangeselector", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRangeselectorUndefined: Self = StObject.set(x, "rangeselector", js.undefined)
    
    @scala.inline
    def setRangeslider(value: Partial[RangeSlider]): Self = StObject.set(x, "rangeslider", value.asInstanceOf[js.Any])
