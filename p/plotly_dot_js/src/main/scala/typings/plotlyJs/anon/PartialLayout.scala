...
object PartialLayout {
  ...
  implicit open class MutableBuilder[Self <: PartialLayout] (val x: Self) extends AnyVal {
    ...
    inline def setPaper_bgcolor(value: typings.plotlyJs.mod.Color): Self = StObject.set(x, "paper_bgcolor", value.asInstanceOf[js.Any])
    ...
    inline def setPlot_bgcolor(value: typings.plotlyJs.mod.Color): Self = StObject.set(x, "plot_bgcolor", value.asInstanceOf[js.Any])
