...
trait PartialPlotData extends js.Object {
  ...
  var marker: js.UndefOr[PartialPlotMarkerAutocolorscale] = js.native
  @JSName("marker.color")
...
object PartialPlotData {
  ...
  implicit class PartialPlotDataOps[Self <: PartialPlotData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMarker(value: PartialPlotMarkerAutocolorscale): Self = this.set("marker", value.asInstanceOf[js.Any])
    @scala.inline
