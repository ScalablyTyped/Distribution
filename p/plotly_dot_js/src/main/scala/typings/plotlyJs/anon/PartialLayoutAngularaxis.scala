...
object PartialLayoutAngularaxis {
  ...
  extension [Self <: PartialLayoutAngularaxis](x: Self) {
    ...
    inline def setShapesVarargs(value: PartialShapeFillcolor*): Self = StObject.set(x, "shapes", js.Array(value :_*))
    ...
    inline def setSlidersVarargs(value: PartialSliderActivebgcolor*): Self = StObject.set(x, "sliders", js.Array(value :_*))
