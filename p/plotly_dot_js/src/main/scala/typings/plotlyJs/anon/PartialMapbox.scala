...
trait PartialMapbox extends js.Object {
  ...
  var layers: js.UndefOr[js.Array[PartialMapboxLayers]] = js.native
...
object PartialMapbox {
  ...
  @scala.inline
  implicit class PartialMapboxOps[Self <: PartialMapbox] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLayersVarargs(value: PartialMapboxLayers*): Self = this.set("layers", js.Array(value :_*))
    
    @scala.inline
    def setLayers(value: js.Array[PartialMapboxLayers]): Self = this.set("layers", value.asInstanceOf[js.Any])
