...
object PartialSceneAxisBackgroundcolor {
  ...
  @scala.inline
  def apply(): PartialSceneAxisBackgroundcolor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSceneAxisBackgroundcolor]
  }
  
  @scala.inline
  implicit class PartialSceneAxisBackgroundcolorMutableBuilder[Self <: PartialSceneAxisBackgroundcolor] (val x: Self) extends AnyVal {
