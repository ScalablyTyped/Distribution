...
object PartialLayoutAxis {
  ...
  @scala.inline
  implicit class PartialLayoutAxisMutableBuilder[Self <: PartialLayoutAxis] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRangeselector(value: PartialRangeSelector): Self = StObject.set(x, "rangeselector", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitle(value: String | PartialDataTitle): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
