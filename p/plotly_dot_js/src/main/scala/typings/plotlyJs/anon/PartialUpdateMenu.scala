...
trait PartialUpdateMenu extends StObject {
  ...
  var buttons: js.UndefOr[js.Array[PartialUpdateMenuButton]] = js.undefined
...
object PartialUpdateMenu {
  
  inline def apply(): PartialUpdateMenu = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialUpdateMenu]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialUpdateMenu] (val x: Self) extends AnyVal {
