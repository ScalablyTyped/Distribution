...
trait PartialPlotMarkerCauto extends StObject {
...
object PartialPlotMarkerCauto {
  
  inline def apply(): PartialPlotMarkerCauto = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPlotMarkerCauto]
  }
  
  extension [Self <: PartialPlotMarkerCauto](x: Self) {
    ...
    inline def setLine(value: Partial[ScatterMarkerLine]): Self = StObject.set(x, "line", value.asInstanceOf[js.Any])
