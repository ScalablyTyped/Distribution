...
object PartialBoxPlotData {
  ...
  @scala.inline
  implicit class PartialBoxPlotDataMutableBuilder[Self <: PartialBoxPlotData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGauge(value: PartialGaugeAxis): Self = StObject.set(x, "gauge", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLineDotcolor(value: typings.plotlyJs.mod.Color): Self = StObject.set(x, "line.color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMarkerDotcolor(value: typings.plotlyJs.mod.Color): Self = StObject.set(x, "marker.color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMarkerDotlineDotcolor(value: typings.plotlyJs.mod.Color): Self = StObject.set(x, "marker.line.color", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setQuartilemethodUndefined: Self = StObject.set(x, "quartilemethod", js.undefined)
    ...
    @scala.inline
    def setXy(value: Float32Array): Self = StObject.set(x, "xy", value.asInstanceOf[js.Any])
