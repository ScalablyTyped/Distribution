...
trait PartialBoxPlotData
  ...
  var quartilemethod: js.UndefOr[linear | exclusive | inclusive] = js.undefined
  ...
  var `type`: js.UndefOr[box] = js.undefined
  ...
  var x0: js.UndefOr[js.Any] = js.undefined
  ...
  var y0: js.UndefOr[js.Any] = js.undefined
...
object PartialBoxPlotData {
  ...
  inline def apply(): PartialBoxPlotData = {
  ...
  extension [Self <: PartialBoxPlotData](x: Self) {
    ...
    inline def setQuartilemethodUndefined: Self = StObject.set(x, "quartilemethod", js.undefined)
