...
import typings.plotlyJs.plotlyJsStrings.inclusive
import typings.plotlyJs.plotlyJsStrings.inside
import typings.plotlyJs.plotlyJsStrings.interpolate
...
import typings.plotlyJs.plotlyJsStrings.textPlussignmarkers
...
import typings.plotlyJs.plotlyJsStrings.tonext
...
import typings.plotlyJs.plotlyJsStrings.xPlussigny
import typings.plotlyJs.plotlyJsStrings.xPlussignyPlussignname
import typings.plotlyJs.plotlyJsStrings.xPlussignyPlussigntext
import typings.plotlyJs.plotlyJsStrings.xPlussignyPlussignz
import typings.plotlyJs.plotlyJsStrings.xPlussignyPlussignzPlussignname
import typings.plotlyJs.plotlyJsStrings.xPlussignyPlussignzPlussigntext
import typings.plotlyJs.plotlyJsStrings.y
import typings.plotlyJs.plotlyJsStrings.yPlussignname
import typings.plotlyJs.plotlyJsStrings.yPlussigntext
import typings.plotlyJs.plotlyJsStrings.yPlussignx
import typings.plotlyJs.plotlyJsStrings.yPlussignxPlussignname
import typings.plotlyJs.plotlyJsStrings.yPlussignxPlussigntext
import typings.plotlyJs.plotlyJsStrings.yPlussignxPlussignz
import typings.plotlyJs.plotlyJsStrings.yPlussignxPlussignzPlussignname
import typings.plotlyJs.plotlyJsStrings.yPlussignxPlussignzPlussigntext
import typings.plotlyJs.plotlyJsStrings.yPlussignz
import typings.plotlyJs.plotlyJsStrings.yPlussignzPlussignname
import typings.plotlyJs.plotlyJsStrings.yPlussignzPlussigntext
import typings.plotlyJs.plotlyJsStrings.z
import typings.plotlyJs.plotlyJsStrings.zPlussignx
import typings.plotlyJs.plotlyJsStrings.zPlussignxPlussignname
import typings.plotlyJs.plotlyJsStrings.zPlussignxPlussigntext
import typings.plotlyJs.plotlyJsStrings.zPlussignxPlussigny
import typings.plotlyJs.plotlyJsStrings.zPlussignxPlussignyPlussignname
import typings.plotlyJs.plotlyJsStrings.zPlussignxPlussignyPlussigntext
...
/* Inlined std.Partial<plotly.js.plotly.js/lib/traces/box.BoxPlotData> */
@js.native
trait PartialBoxPlotData extends Data {
  ...
  var number: js.UndefOr[PartialPlotNumberFont] = js.native
  ...
  var quartilemethod: js.UndefOr[linear | exclusive | inclusive] = js.native
  ...
  var x0: js.UndefOr[js.Any] = js.native
  ...
  var y0: js.UndefOr[js.Any] = js.native
...
object PartialBoxPlotData {
  
  @scala.inline
  def apply(): PartialBoxPlotData = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBoxPlotData]
  }
  
  @scala.inline
  implicit class PartialBoxPlotDataOps[Self <: PartialBoxPlotData] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def deleteAutobinx: Self = this.set("autobinx", js.undefined)
    
    @scala.inline
    def setBoxmean(value: Boolean | sd): Self = this.set("boxmean", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBoxmean: Self = this.set("boxmean", js.undefined)
    
    @scala.inline
    def setBoxpoints(value: all | outliers | suspectedoutliers | `false`): Self = this.set("boxpoints", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBoxpoints: Self = this.set("boxpoints", js.undefined)
    
    @scala.inline
    def setBranchvalues(value: total | remainder): Self = this.set("branchvalues", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBranchvalues: Self = this.set("branchvalues", js.undefined)
    ...
    @scala.inline
    def deleteConnectgaps: Self = this.set("connectgaps", js.undefined)
    
    @scala.inline
    def setCustomdataVarargs(value: (js.Array[Datum] | Datum)*): Self = this.set("customdata", js.Array(value :_*))
    
    @scala.inline
    def setCustomdata(value: js.Array[js.Array[Datum] | Datum]): Self = this.set("customdata", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def deleteError_x: Self = this.set("error_x", js.undefined)
    
    @scala.inline
    def setError_y(value: ErrorBar): Self = this.set("error_y", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteError_y: Self = this.set("error_y", js.undefined)
    ...
    @scala.inline
    def setGauge(value: PartialGaugeAxis): Self = this.set("gauge", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGauge: Self = this.set("gauge", js.undefined)
    
    @scala.inline
    def setGroupnorm(value: _empty | fraction | percent): Self = this.set("groupnorm", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteGroupnorm: Self = this.set("groupnorm", js.undefined)
    
    @scala.inline
    def setHistfunc(value: count | sum | avg | min | max): Self = this.set("histfunc", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHistfunc: Self = this.set("histfunc", js.undefined)
    ...
    @scala.inline
    def setHoverinfo(
      value: all | name | none | skip | text | typings.plotlyJs.plotlyJsStrings.x | xPlussigntext | xPlussignname | xPlussigny | xPlussignyPlussigntext | xPlussignyPlussignname | xPlussignyPlussignz | xPlussignyPlussignzPlussigntext | xPlussignyPlussignzPlussignname | y | yPlussignname | yPlussignx | yPlussigntext | yPlussignxPlussigntext | yPlussignxPlussignname | yPlussignz | yPlussignzPlussigntext | yPlussignzPlussignname | yPlussignxPlussignz | yPlussignxPlussignzPlussigntext | yPlussignxPlussignzPlussignname | z | zPlussignx | zPlussignxPlussigntext | zPlussignxPlussignname | zPlussignyPlussignx | zPlussignyPlussignxPlussigntext | zPlussignyPlussignxPlussignname | zPlussignxPlussigny | zPlussignxPlussignyPlussigntext | zPlussignxPlussignyPlussignname
    ): Self = this.set("hoverinfo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteHoverinfo: Self = this.set("hoverinfo", js.undefined)
    ...
    @scala.inline
    def setI(value: TypedArray): Self = this.set("i", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setJ(value: TypedArray): Self = this.set("j", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setK(value: TypedArray): Self = this.set("k", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def deleteLegendgroup: Self = this.set("legendgroup", js.undefined)
    ...
    @scala.inline
    def setLineDotcolor(value: typings.plotlyJs.mod.Color): Self = this.set("line.color", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLineDotcolor: Self = this.set("line.color", js.undefined)
    
    @scala.inline
    def setLineDotdash(value: Dash): Self = this.set("line.dash", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLineDotdash: Self = this.set("line.dash", js.undefined)
    
    @scala.inline
    def setLineDotshape(value: linear | spline | hv | vh | hvh | vhv): Self = this.set("line.shape", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLineDotshape: Self = this.set("line.shape", js.undefined)
    
    @scala.inline
    def setLineDotsimplify(value: Boolean): Self = this.set("line.simplify", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLineDotsimplify: Self = this.set("line.simplify", js.undefined)
    
    @scala.inline
    def setLineDotsmoothing(value: Double): Self = this.set("line.smoothing", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLineDotsmoothing: Self = this.set("line.smoothing", js.undefined)
    
    @scala.inline
    def setLineDotwidth(value: Double): Self = this.set("line.width", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLineDotwidth: Self = this.set("line.width", js.undefined)
    ...
    @scala.inline
    def setMarkerDotcolor(value: typings.plotlyJs.mod.Color): Self = this.set("marker.color", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMarkerDotcolor: Self = this.set("marker.color", js.undefined)
    
    @scala.inline
    def setMarkerDotcolorbar(value: js.Object): Self = this.set("marker.colorbar", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMarkerDotcolorbar: Self = this.set("marker.colorbar", js.undefined)
    ...
    @scala.inline
    def deleteMarkerDotcolorscale: Self = this.set("marker.colorscale", js.undefined)
    
    @scala.inline
    def setMarkerDotline(value: PartialScatterMarkerLine): Self = this.set("marker.line", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMarkerDotline: Self = this.set("marker.line", js.undefined)
    ...
    @scala.inline
    def setMarkerDotlineDotcolor(value: typings.plotlyJs.mod.Color): Self = this.set("marker.line.color", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMarkerDotlineDotcolor: Self = this.set("marker.line.color", js.undefined)
    ...
    @scala.inline
    def deleteMarkerDotlineDotcolorscale: Self = this.set("marker.line.colorscale", js.undefined)
    
    @scala.inline
    def setMarkerDotmaxdisplayed(value: Double): Self = this.set("marker.maxdisplayed", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMarkerDotmaxdisplayed: Self = this.set("marker.maxdisplayed", js.undefined)
    ...
    @scala.inline
    def deleteMarkerDotsymbol: Self = this.set("marker.symbol", js.undefined)
    ...
    @scala.inline
    def setNumber(value: PartialPlotNumberFont): Self = this.set("number", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def deleteQuartilemethod: Self = this.set("quartilemethod", js.undefined)
    ...
    @scala.inline
    def setSelectedpointsVarargs(value: Datum*): Self = this.set("selectedpoints", js.Array(value :_*))
    
    @scala.inline
    def setSelectedpoints(value: js.Array[Datum]): Self = this.set("selectedpoints", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteSelectedpoints: Self = this.set("selectedpoints", js.undefined)
    ...
    @scala.inline
    def setStackgaps(value: (`infer zero`) | interpolate): Self = this.set("stackgaps", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteStackgaps: Self = this.set("stackgaps", js.undefined)
    
    @scala.inline
    def setStackgroup(value: String): Self = this.set("stackgroup", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteStackgroup: Self = this.set("stackgroup", js.undefined)
    ...
    @scala.inline
    def deleteTextinfo: Self = this.set("textinfo", js.undefined)
    ...
    @scala.inline
    def deleteXbins: Self = this.set("xbins", js.undefined)
    ...
    @scala.inline
    def setXy(value: Float32Array): Self = this.set("xy", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def deleteZsmooth: Self = this.set("zsmooth", js.undefined)
  }
}
