...
trait Partialcoloringfillheatma extends StObject {
  
  var coloring: js.UndefOr[fill | heatmap | lines | none] = js.undefined
  
  var end: js.UndefOr[Double] = js.undefined
  
  var labelfont: js.UndefOr[Partial[Font]] = js.undefined
...
object Partialcoloringfillheatma {
  
  inline def apply(): Partialcoloringfillheatma = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Partialcoloringfillheatma]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Partialcoloringfillheatma] (val x: Self) extends AnyVal {
    ...
    inline def setLabelfont(value: Partial[Font]): Self = StObject.set(x, "labelfont", value.asInstanceOf[js.Any])
