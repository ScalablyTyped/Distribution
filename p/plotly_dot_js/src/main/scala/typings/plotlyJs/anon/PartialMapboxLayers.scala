...
object PartialMapboxLayers {
  ...
  @scala.inline
  implicit class PartialMapboxLayersOps[Self <: PartialMapboxLayers] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSymbol(value: PartialMapboxSymbol): Self = this.set("symbol", value.asInstanceOf[js.Any])
    @scala.inline
