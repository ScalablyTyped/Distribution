...
object libTracesOhlcMod {
  ...
  */
  ...
  trait OhlcData extends StObject {
  ...
  object OhlcData {
    ...
    inline def apply(
      ...
      __obj.updateDynamic("type")("ohlc")
      __obj.asInstanceOf[OhlcData]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: OhlcData] (val x: Self) extends AnyVal {
