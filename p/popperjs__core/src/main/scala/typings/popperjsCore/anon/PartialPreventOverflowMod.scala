...
object PartialPreventOverflowMod {
  ...
  @scala.inline
  implicit class PartialPreventOverflowModOps[Self <: PartialPreventOverflowMod] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: preventOverflow): Self = this.set("name", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteName: Self = this.set("name", js.undefined)
    
    @scala.inline
    def setOptions(value: PartialOptionsAltAxis): Self = this.set("options", value.asInstanceOf[js.Any])
