...
object PartialApplyStylesModifie {
  ...
  @scala.inline
  implicit class PartialApplyStylesModifieMutableBuilder[Self <: PartialApplyStylesModifie] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: applyStyles): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
