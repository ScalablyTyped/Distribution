...
object PartialComputeStylesModif {
  ...
  @scala.inline
  implicit class PartialComputeStylesModifOps[Self <: PartialComputeStylesModif] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: computeStyles): Self = this.set("name", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteName: Self = this.set("name", js.undefined)
    
    @scala.inline
    def setOptions(value: PartialOptionsAdaptive): Self = this.set("options", value.asInstanceOf[js.Any])
