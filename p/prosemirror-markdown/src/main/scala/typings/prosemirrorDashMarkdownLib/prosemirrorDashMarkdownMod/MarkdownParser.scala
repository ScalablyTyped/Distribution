...
@js.native
class MarkdownParser[S /* <: prosemirrorDashModelLib.prosemirrorDashModelMod.Schema[_, _] */] protected () extends js.Object {
  /**
  ...
  /**
     ...
     * rules.
     */
  def parse(text: java.lang.String): prosemirrorDashModelLib.prosemirrorDashModelMod.Node[S] = js.native
}
