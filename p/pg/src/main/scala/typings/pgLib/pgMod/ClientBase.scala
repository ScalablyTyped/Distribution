...
class ClientBase ()
  ...
  def connect(callback: js.Function1[/* err */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  ...
  @JSName("on")
  def on_notice(event: pgLib.pgLibStrings.notice, listener: js.Function1[/* err */ stdLib.Error, scala.Unit]): this.type = js.native
  @JSName("on")
  def on_notification(
  ...
  def query(
    ...
    callback: js.Function2[/* err */ stdLib.Error, /* result */ QueryArrayResult, scala.Unit]
  ): Query = js.native
  ...
  def query(
    ...
    callback: js.Function2[/* err */ stdLib.Error, /* result */ QueryResult, scala.Unit]
  ): Query = js.native
