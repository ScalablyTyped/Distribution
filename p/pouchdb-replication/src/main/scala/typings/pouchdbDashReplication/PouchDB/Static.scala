...
trait Static extends js.Object {
  /**
    ...
    */
  def replicate[Content](source: String, target: String): typings.pouchdbDashReplication.PouchDB.Replication.Replication[Content] = js.native
  def replicate[Content](source: String, target: String, options: ReplicateOptions): typings.pouchdbDashReplication.PouchDB.Replication.Replication[Content] = js.native
  def replicate[Content](
    source: String,
    target: String,
    options: ReplicateOptions,
    callback: Callback[ReplicationResultComplete[Content]]
  ): typings.pouchdbDashReplication.PouchDB.Replication.Replication[Content] = js.native
  def replicate[Content](source: String, target: Database[Content]): typings.pouchdbDashReplication.PouchDB.Replication.Replication[Content] = js.native
  def replicate[Content](source: String, target: Database[Content], options: ReplicateOptions): typings.pouchdbDashReplication.PouchDB.Replication.Replication[Content] = js.native
  def replicate[Content](
    source: String,
  ...
  def replicate[Content](source: Database[Content], target: String): typings.pouchdbDashReplication.PouchDB.Replication.Replication[Content] = js.native
  def replicate[Content](source: Database[Content], target: String, options: ReplicateOptions): typings.pouchdbDashReplication.PouchDB.Replication.Replication[Content] = js.native
  def replicate[Content](
  ...
  def replicate[Content](source: Database[Content], target: Database[Content]): typings.pouchdbDashReplication.PouchDB.Replication.Replication[Content] = js.native
  def replicate[Content](source: Database[Content], target: Database[Content], options: ReplicateOptions): typings.pouchdbDashReplication.PouchDB.Replication.Replication[Content] = js.native
  def replicate[Content](
    source: Database[Content],
    target: Database[Content],
    options: ReplicateOptions,
