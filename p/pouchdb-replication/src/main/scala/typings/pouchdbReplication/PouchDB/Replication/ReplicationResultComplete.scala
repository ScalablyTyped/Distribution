...
object ReplicationResultComplete {
  ...
  @scala.inline
  implicit class ReplicationResultCompleteOps[Self <: ReplicationResultComplete[_], /* <: js.Object */ Content] (val x: Self with ReplicationResultComplete[Content]) extends AnyVal {
    @scala.inline
