...
trait Nfc extends Util {
  /**
           ...
           */
  def addMimeTypeListener(mimeType: java.lang.String, callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.addMimeTypeListener registers the callback for ndef-mime events.
           * A ndef-mime event occurs when a Ndef.TNF_MIME_MEDIA tag is read and matches the specified MIME type.
           * This function can be called multiple times to register different MIME types. You should use the same handler for all MIME messages.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def addMimeTypeListener(mimeType: java.lang.String, callback: js.Function0[scala.Unit], win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.addMimeTypeListener registers the callback for ndef-mime events.
           * A ndef-mime event occurs when a Ndef.TNF_MIME_MEDIA tag is read and matches the specified MIME type.
           * This function can be called multiple times to register different MIME types. You should use the same handler for all MIME messages.
  ...
  /**
           ...
           * @param fail The callback that is called if there was an error.
           */
  def addNdefFormatableListener(callback: js.Function1[/* event */ NdefTagEvent, scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.addNdefFormatableListener registers the callback for ndef-formatable events.
           * A ndef-formatable event occurs when a tag is read that can be NDEF formatted.
           * This is not fired for tags that are already formatted as NDEF.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def addNdefFormatableListener(callback: js.Function1[/* event */ NdefTagEvent, scala.Unit], win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.addNdefFormatableListener registers the callback for ndef-formatable events.
           * A ndef-formatable event occurs when a tag is read that can be NDEF formatted.
           * This is not fired for tags that are already formatted as NDEF.
  ...
  def addNdefFormatableListener(
    callback: js.Function1[/* event */ NdefTagEvent, scala.Unit],
    win: js.Function0[scala.Unit],
    fail: js.Function0[scala.Unit]
  ): scala.Unit = js.native
  /**
           ...
           * @param fail The callback that is called if there was an error.
           */
  def addNdefListener(callback: js.Function1[/* event */ NdefTagEvent, scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.addNdefListener registers the callback for ndef events.
           * A ndef event is fired when a NDEF tag is read.
           * For BlackBerry 10, you must configure the type of tags your application will read with an invoke-target in config.xml.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def addNdefListener(callback: js.Function1[/* event */ NdefTagEvent, scala.Unit], win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.addNdefListener registers the callback for ndef events.
           * A ndef event is fired when a NDEF tag is read.
           * For BlackBerry 10, you must configure the type of tags your application will read with an invoke-target in config.xml.
  ...
  /**
           ...
           * @param fail The callback that is called if there was an error.
           */
  def addTagDiscoveredListener(callback: js.Function1[/* event */ TagEvent, scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.addTagDiscoveredListener registers the callback for tag events.
           * This event occurs when any tag is detected by the phone
           * @param callback The callback that is called when a tag is detected.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def addTagDiscoveredListener(callback: js.Function1[/* event */ TagEvent, scala.Unit], win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.addTagDiscoveredListener registers the callback for tag events.
           * This event occurs when any tag is detected by the phone
           * @param callback The callback that is called when a tag is detected.
  ...
  def addTagDiscoveredListener(
    callback: js.Function1[/* event */ TagEvent, scala.Unit],
    win: js.Function0[scala.Unit],
    fail: js.Function0[scala.Unit]
  ): scala.Unit = js.native
  /**
           ...
           */
  def enabled(): scala.Unit = js.native
  /**
           * Function nfc.enabled explicitly checks to see if the phone has NFC and if NFC is enabled.
           * If everything is OK, the success callback is called.
           * If there is a problem, the failure callback will be called with a reason code.
           ...
           * @param fail The callback that is called when NFC is disabled or missing.
           */
  def enabled(win: js.Function1[/* status */ java.lang.String, scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.enabled explicitly checks to see if the phone has NFC and if NFC is enabled.
           * If everything is OK, the success callback is called.
           * If there is a problem, the failure callback will be called with a reason code.
           ...
           */
  def enabled(
    win: js.Function1[/* status */ java.lang.String, scala.Unit],
    fail: js.Function1[/* status */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  /**
           ...
           * @param fail The callback that is called if there was an error.
           */
  def erase(win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.erase erases a tag by writing an empty message.
           * Will format unformatted tags before writing.
           * This method must be called from within an NDEF TagEvent Handler.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def erase(win: js.Function0[scala.Unit], fail: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           ...
           * @param fail The callback that is called if there was an error.
           */
  def handover(uris: java.lang.String): scala.Unit = js.native
  /**
           * Function nfc.handover shares files to a NFC peer using handover. Files are sent by specifying a file:// or context:// URI or a list of URIs.
           * The file transfer is initiated with NFC but the transfer is completed with over Bluetooth or WiFi which is handled by a NFC handover request.
           * The Android code is responsible for building the handover NFC Message.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def handover(uris: java.lang.String, win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.handover shares files to a NFC peer using handover. Files are sent by specifying a file:// or context:// URI or a list of URIs.
           * The file transfer is initiated with NFC but the transfer is completed with over Bluetooth or WiFi which is handled by a NFC handover request.
           * The Android code is responsible for building the handover NFC Message.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def handover(uris: java.lang.String, win: js.Function0[scala.Unit], fail: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.handover shares files to a NFC peer using handover. Files are sent by specifying a file:// or context:// URI or a list of URIs.
           * The file transfer is initiated with NFC but the transfer is completed with over Bluetooth or WiFi which is handled by a NFC handover request.
           * The Android code is responsible for building the handover NFC Message.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def handover(uris: js.Array[java.lang.String]): scala.Unit = js.native
  /**
           * Function nfc.handover shares files to a NFC peer using handover. Files are sent by specifying a file:// or context:// URI or a list of URIs.
           * The file transfer is initiated with NFC but the transfer is completed with over Bluetooth or WiFi which is handled by a NFC handover request.
           * The Android code is responsible for building the handover NFC Message.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def handover(uris: js.Array[java.lang.String], win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.handover shares files to a NFC peer using handover. Files are sent by specifying a file:// or context:// URI or a list of URIs.
           * The file transfer is initiated with NFC but the transfer is completed with over Bluetooth or WiFi which is handled by a NFC handover request.
           * The Android code is responsible for building the handover NFC Message.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def handover(uris: js.Array[java.lang.String], win: js.Function0[scala.Unit], fail: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           ...
           * @param fail The callback that is called if there was an error.
           */
  def makeReadOnly(): scala.Unit = js.native
  /**
           * Function nfc.makeReadOnly make a NFC tag read only.
           * Warning this is permanent and can not be undone.
           * On Android this method must be called from within an NDEF TagEvent Handler.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def makeReadOnly(win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.makeReadOnly make a NFC tag read only.
           * Warning this is permanent and can not be undone.
           * On Android this method must be called from within an NDEF TagEvent Handler.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def makeReadOnly(win: js.Function0[scala.Unit], fail: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           ...
           */
  def removeMimeTypeListener(mimeType: java.lang.String, callback: js.Function1[/* event */ TagEvent, scala.Unit]): scala.Unit = js.native
  /**
           * Removes the previously registered event listener added via nfc.addMimeTypeListener
           * @param mimeType The MIME type to filter for messages.
           * @param callback The previously registered callback.
  ...
  /**
           ...
           * @param fail The callback that is called if there was an error during removal.
           */
  def removeNdefListener(callback: js.Function1[/* event */ TagEvent, scala.Unit]): scala.Unit = js.native
  /**
           * Removes the previously registered event listener for NDEF tags added via nfc.addNdefListener.
           * @param callback The previously registered callback.
           * @param win The callback that is called when the listener is successfully removed.
           * @param fail The callback that is called if there was an error during removal.
           */
  def removeNdefListener(callback: js.Function1[/* event */ TagEvent, scala.Unit], win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Removes the previously registered event listener for NDEF tags added via nfc.addNdefListener.
           * @param callback The previously registered callback.
           * @param win The callback that is called when the listener is successfully removed.
  ...
  /**
           ...
           * @param fail The callback that is called if there was an error during removal.
           */
  def removeTagDiscoveredListener(callback: js.Function1[/* event */ TagEvent, scala.Unit]): scala.Unit = js.native
  /**
           * Removes the previously registered event listener added via nfc.addTagDiscoveredListener
           * @param callback The previously registered callback.
           * @param win The callback that is called when the listener is successfully removed.
           * @param fail The callback that is called if there was an error during removal.
           */
  def removeTagDiscoveredListener(callback: js.Function1[/* event */ TagEvent, scala.Unit], win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Removes the previously registered event listener added via nfc.addTagDiscoveredListener
           * @param callback The previously registered callback.
           * @param win The callback that is called when the listener is successfully removed.
  ...
  /**
           ...
           * @param fail The callback that is called if there was an error.
           */
  def share(ndefMessage: js.Array[NdefRecord]): scala.Unit = js.native
  /**
           * Function nfc.share writes an NdefMessage via peer-to-peer.
           * This should appear as an NFC tag to another device.
           * @param ndefMessage An array of NDEF Records.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def share(ndefMessage: js.Array[NdefRecord], win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.share writes an NdefMessage via peer-to-peer.
           * This should appear as an NFC tag to another device.
           * @param ndefMessage An array of NDEF Records.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def share(ndefMessage: js.Array[NdefRecord], win: js.Function0[scala.Unit], fail: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           ...
           */
  def showSettings(): scala.Unit = js.native
  /**
           * Function showSettings opens the NFC settings for the operating system.
           * @param win Success callback function
           * @param fail Error callback function, invoked when error occurs.
           */
  def showSettings(win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function showSettings opens the NFC settings for the operating system.
           * @param win Success callback function
           * @param fail Error callback function, invoked when error occurs.
           */
  def showSettings(win: js.Function0[scala.Unit], fail: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.stopHandover stops sharing data via peer-to-peer.
           * @param win The callback that is called when sharing stops.
           * @param fail The callback that is called if there was an error.
           */
  def stopHandover(): scala.Unit = js.native
  /**
           * Function nfc.stopHandover stops sharing data via peer-to-peer.
           * @param win The callback that is called when sharing stops.
           * @param fail The callback that is called if there was an error.
           */
  def stopHandover(win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.stopHandover stops sharing data via peer-to-peer.
           * @param win The callback that is called when sharing stops.
           * @param fail The callback that is called if there was an error.
           */
  def stopHandover(win: js.Function0[scala.Unit], fail: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.unshare stops sharing data via peer-to-peer.
           * @param win The callback that is called when sharing stops.
           * @param fail The callback that is called if there was an error.
           */
  def unshare(): scala.Unit = js.native
  /**
           * Function nfc.unshare stops sharing data via peer-to-peer.
           * @param win The callback that is called when sharing stops.
           * @param fail The callback that is called if there was an error.
           */
  def unshare(win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.unshare stops sharing data via peer-to-peer.
           * @param win The callback that is called when sharing stops.
           * @param fail The callback that is called if there was an error.
           */
  def unshare(win: js.Function0[scala.Unit], fail: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           ...
           * @param fail The callback that is called if there was an error.
           */
  def write(ndefMessage: js.Array[NdefRecord]): scala.Unit = js.native
  /**
           * Function nfc.write writes an NdefMessage to a NFC tag.
           * On Android this method must be called from within an NDEF TagEvent Handler.
           * On Windows this method may be called from within the NDEF TagEvent Handler.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def write(ndefMessage: js.Array[NdefRecord], win: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
           * Function nfc.write writes an NdefMessage to a NFC tag.
           * On Android this method must be called from within an NDEF TagEvent Handler.
           * On Windows this method may be called from within the NDEF TagEvent Handler.
           ...
           * @param fail The callback that is called if there was an error.
           */
  def write(ndefMessage: js.Array[NdefRecord], win: js.Function0[scala.Unit], fail: js.Function0[scala.Unit]): scala.Unit = js.native
}
