...
object global {
  ...
  object paypal {
    ...
    @JSGlobal("paypal.Button")
    @js.native
    val Button: ButtonRenderer = js.native
    
    @JSGlobal("paypal.ButtonColorOption")
    @js.native
    ...
    @JSGlobal("paypal.ButtonShapeOption")
    @js.native
    ...
    @JSGlobal("paypal.ButtonSizeOption")
    @js.native
    ...
    @JSGlobal("paypal.ShippingOptionType")
    @js.native
