...
import typings.atPhosphorCoreutils.libJsonMod.ReadonlyJSONArray
...
@js.native
object atPhosphorCoreutilsMod extends js.Object {
  @js.native
  class MimeData ()
    extends typings.atPhosphorCoreutils.libMimeMod.MimeData
  ...
  class PromiseDelegate[T] ()
    extends typings.atPhosphorCoreutils.libPromiseMod.PromiseDelegate[T]
  
  @js.native
  class Token[T] protected ()
    extends typings.atPhosphorCoreutils.libTokenMod.Token[T] {
    /**
