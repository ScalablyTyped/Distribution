...
object libCjsLaunchMod {
  
  @JSImport("@puppeteer/browsers/lib/cjs/launch", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@puppeteer/browsers/lib/cjs/launch", "CDP_WEBSOCKET_ENDPOINT_REGEX")
  @js.native
  val CDP_WEBSOCKET_ENDPOINT_REGEX: js.RegExp = js.native
  
  @JSImport("@puppeteer/browsers/lib/cjs/launch", "Process")
  @js.native
  ...
  @JSImport("@puppeteer/browsers/lib/cjs/launch", "TimeoutError")
  @js.native
  /**
    * @internal
    */
  ...
  @JSImport("@puppeteer/browsers/lib/cjs/launch", "WEBDRIVER_BIDI_WEBSOCKET_ENDPOINT_REGEX")
  @js.native
  ...
  inline def isErrorLike(obj: Any): /* is @puppeteer/browsers.@puppeteer/browsers/lib/cjs/launch.ErrorLike */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isErrorLike")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @puppeteer/browsers.@puppeteer/browsers/lib/cjs/launch.ErrorLike */ Boolean]
