...
object libCjsBrowserDataChromedriverMod {
  
  @JSImport("@puppeteer/browsers/lib/cjs/browser-data/chromedriver", JSImport.Namespace)
  @js.native
  ...
  inline def resolveBuildId(channel: ChromeReleaseChannel): js.Promise[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolveBuildId")(channel.asInstanceOf[js.Any]).asInstanceOf[js.Promise[String]]
