...
object libEsmDebugMod {
  ...
  object debug {
    ...
    @JSImport("@puppeteer/browsers/lib/esm/debug", "debug")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@puppeteer/browsers/lib/esm/debug", "debug.default")
    @js.native
    ...
    @JSImport("@puppeteer/browsers/lib/esm/debug", "debug.debug")
    @js.native
    ...
    @JSImport("@puppeteer/browsers/lib/esm/debug", "debug.formatters")
    @js.native
    ...
    @JSImport("@puppeteer/browsers/lib/esm/debug", "debug.humanize")
    @js.native
    ...
    @JSImport("@puppeteer/browsers/lib/esm/debug", "debug.names")
    @js.native
    ...
    @JSImport("@puppeteer/browsers/lib/esm/debug", "debug.skips")
    @js.native
