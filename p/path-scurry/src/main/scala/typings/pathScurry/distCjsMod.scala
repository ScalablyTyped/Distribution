...
object distCjsMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify LRUCache<PathBase, Children> * / any */ @JSImport("path-scurry/dist/cjs", "ChildrenCache")
  @js.native
  open class ChildrenCache () extends StObject {
    def this(maxSize: Double) = this()
  }
  
  @JSImport("path-scurry/dist/cjs", "Path")
  @js.native
  ...
  /* note: abstract class */ @JSImport("path-scurry/dist/cjs", "PathBase")
  @js.native
  ...
  @JSImport("path-scurry/dist/cjs", "PathPosix")
  @js.native
  ...
  @JSImport("path-scurry/dist/cjs", "PathScurry")
  @js.native
  ...
  /* note: abstract class */ @JSImport("path-scurry/dist/cjs", "PathScurryBase")
  @js.native
  open class PathScurryBase protected () extends StObject {
    ...
    def chdir(path: typings.pathScurry.distCjsMod.Path): Unit = js.native
    ...
    def depth(path: typings.pathScurry.distCjsMod.Path): Double = js.native
    ...
    def stream(): Minipass[
        PathBase, 
        /* import warning: importer.ImportType#apply Failed type conversion: path-scurry.path-scurry/dist/cjs.PathBase extends minipass.minipass.Minipass.BufferOrString ? minipass.minipass.Minipass.ContiguousData : path-scurry.path-scurry/dist/cjs.PathBase */ js.Any, 
        Events[PathBase]
      ] = js.native
    ...
    def stream(opts: WalkOptions): Minipass[
        String | PathBase, 
        /* import warning: importer.ImportType#apply Failed type conversion: string | path-scurry.path-scurry/dist/cjs.PathBase extends minipass.minipass.Minipass.BufferOrString ? minipass.minipass.Minipass.ContiguousData : string | path-scurry.path-scurry/dist/cjs.PathBase */ js.Any, 
  ...
  @JSImport("path-scurry/dist/cjs", "PathScurryDarwin")
  @js.native
  ...
  @JSImport("path-scurry/dist/cjs", "PathScurryPosix")
  @js.native
  ...
  @JSImport("path-scurry/dist/cjs", "PathScurryWin32")
  @js.native
  ...
  @JSImport("path-scurry/dist/cjs", "PathWin32")
  @js.native
  ...
  /* import warning: RemoveDifficultInheritance.summarizeChanges 
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify LRUCache<string, string> * / any */ @JSImport("path-scurry/dist/cjs", "ResolveCache")
  @js.native
