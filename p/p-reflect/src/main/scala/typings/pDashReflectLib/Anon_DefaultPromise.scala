...
@js.native
trait Anon_DefaultPromise extends js.Object {
  ...
  // ): Promise<pReflect.PromiseResult<ValueType>>;
  // export = pReflect;
  def default[ValueType](promise: js.Thenable[ValueType]): js.Promise[pDashReflectLib.pDashReflectMod.pReflectNs.PromiseResult[ValueType]] = js.native
}
