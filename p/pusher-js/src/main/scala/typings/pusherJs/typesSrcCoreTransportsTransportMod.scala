...
object typesSrcCoreTransportsTransportMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    override def createConnection(name: String, priority: Double, key: String, options: Any): typings.pusherJs.typesSrcCoreTransportsTransportConnectionMod.default = js.native
  ...
  trait Transport extends StObject {
    ...
    def createConnection(name: String, priority: Double, key: String, options: Any): typings.pusherJs.typesSrcCoreTransportsTransportConnectionMod.default
  ...
  object Transport {
    ...
    inline def apply(
      createConnection: (String, Double, String, Any) => typings.pusherJs.typesSrcCoreTransportsTransportConnectionMod.default,
    ...
    implicit open class MutableBuilder[Self <: Transport] (val x: Self) extends AnyVal {
      ...
      inline def setCreateConnection(
        value: (String, Double, String, Any) => typings.pusherJs.typesSrcCoreTransportsTransportConnectionMod.default
