...
import typings.pusherJs.typesSrcCoreAuthAuthTransportsMod.AuthTransports
import typings.pusherJs.typesSrcCoreConfigMod.Config
import typings.pusherJs.typesSrcCoreHttpAjaxMod.Ajax
import typings.pusherJs.typesSrcCoreHttpHttpFactoryMod.HTTPFactory
import typings.pusherJs.typesSrcCoreReachabilityMod.Reachability
...
import typings.pusherJs.typesSrcCoreTimelineTimelineTransportMod.TimelineTransport
import typings.pusherJs.typesSrcCoreTransportsTransportsTableMod.TransportsTable
...
object typesSrcRuntimesInterfaceMod {
  ...
  trait Runtime extends StObject {
    ...
    var HTTPFactory: typings.pusherJs.typesSrcCoreHttpHttpFactoryMod.HTTPFactory
    
    var ScriptReceivers: js.UndefOr[Any] = js.undefined
    
    var TimelineTransport: typings.pusherJs.typesSrcCoreTimelineTimelineTransportMod.TimelineTransport
    ...
    def createSocketRequest(method: String, url: String): typings.pusherJs.typesSrcCoreHttpHttpRequestMod.default
  ...
  object Runtime {
    ...
    inline def apply(
      ...
      createSocketRequest: (String, String) => typings.pusherJs.typesSrcCoreHttpHttpRequestMod.default,
    ...
    implicit open class MutableBuilder[Self <: Runtime] (val x: Self) extends AnyVal {
      ...
      inline def setCreateSocketRequest(value: (String, String) => typings.pusherJs.typesSrcCoreHttpHttpRequestMod.default): Self = StObject.set(x, "createSocketRequest", js.Any.fromFunction2(value))
