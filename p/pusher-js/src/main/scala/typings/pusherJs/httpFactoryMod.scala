...
import typings.pusherJs.httpSocketMod.default
...
object httpFactoryMod {
  
  trait HTTPFactory extends StObject {
    
    def createPollingSocket(url: String): default
    
    def createRequest(hooks: RequestHooks, method: String, url: String): typings.pusherJs.httpRequestMod.default
    ...
    var createXDR: js.UndefOr[
        js.Function2[/* method */ String, /* url */ String, typings.pusherJs.httpRequestMod.default]
      ] = js.undefined
    
    def createXHR(method: String, url: String): typings.pusherJs.httpRequestMod.default
  }
  object HTTPFactory {
    
    inline def apply(
      createPollingSocket: String => default,
      createRequest: (RequestHooks, String, String) => typings.pusherJs.httpRequestMod.default,
      createSocket: (SocketHooks, String) => default,
      createStreamingSocket: String => default,
      createXHR: (String, String) => typings.pusherJs.httpRequestMod.default
    ): HTTPFactory = {
    ...
    extension [Self <: HTTPFactory](x: Self) {
      ...
      inline def setCreateRequest(value: (RequestHooks, String, String) => typings.pusherJs.httpRequestMod.default): Self = StObject.set(x, "createRequest", js.Any.fromFunction3(value))
      ...
      inline def setCreateXDR(value: (/* method */ String, /* url */ String) => typings.pusherJs.httpRequestMod.default): Self = StObject.set(x, "createXDR", js.Any.fromFunction2(value))
      
      inline def setCreateXDRUndefined: Self = StObject.set(x, "createXDR", js.undefined)
      
      inline def setCreateXHR(value: (String, String) => typings.pusherJs.httpRequestMod.default): Self = StObject.set(x, "createXHR", js.Any.fromFunction2(value))
    }
  }
}
