...
object optionsMod {
  ...
  object AuthRequestType extends StObject {
    ...
    /* "channel-authorization" */ val ChannelAuthorization: typings.pusherJs.optionsMod.AuthRequestType.ChannelAuthorization & String = js.native
    
    @js.native
    sealed trait UserAuthentication
      extends StObject
         with AuthRequestType
    /* "user-authentication" */ val UserAuthentication: typings.pusherJs.optionsMod.AuthRequestType.UserAuthentication & String = js.native
  }
