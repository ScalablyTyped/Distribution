...
object typesSrcRuntimesWebDefaultStrategyMod {
  
  @JSImport("pusher-js/types/src/runtimes/web/default_strategy", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("pusher-js/types/src/runtimes/web/default_strategy", JSImport.Default)
  @js.native
