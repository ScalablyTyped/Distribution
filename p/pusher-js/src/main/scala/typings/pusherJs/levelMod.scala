...
object levelMod {
  ...
  object default extends StObject {
    ...
    /* 7 */ val DEBUG: typings.pusherJs.levelMod.TimelineLevel.DEBUG & Double = js.native
    
    /* 3 */ val ERROR: typings.pusherJs.levelMod.TimelineLevel.ERROR & Double = js.native
    
    /* 6 */ val INFO: typings.pusherJs.levelMod.TimelineLevel.INFO & Double = js.native
  }
