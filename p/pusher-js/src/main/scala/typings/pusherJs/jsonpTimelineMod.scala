...
object jsonpTimelineMod {
  
  object default {
    
    @JSImport("pusher-js/types/src/runtimes/web/timeline/jsonp_timeline", JSImport.Default)
    @js.native
    ...
    @JSImport("pusher-js/types/src/runtimes/web/timeline/jsonp_timeline", "default.name")
    @js.native
