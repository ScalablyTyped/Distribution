...
object jsonpRequestMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var request: typings.pusherJs.scriptRequestMod.default = js.native
  ...
  trait JSONPRequest extends StObject {
    ...
    var request: typings.pusherJs.scriptRequestMod.default
  ...
  object JSONPRequest {
    ...
    inline def apply(
      cleanup: () => Unit,
      data: Any,
      request: typings.pusherJs.scriptRequestMod.default,
    ...
    extension [Self <: JSONPRequest](x: Self) {
      ...
      inline def setRequest(value: typings.pusherJs.scriptRequestMod.default): Self = StObject.set(x, "request", value.asInstanceOf[js.Any])
