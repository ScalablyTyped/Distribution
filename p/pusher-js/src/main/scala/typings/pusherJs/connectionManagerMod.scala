...
import typings.pusherJs.callbacksMod.ConnectionCallbacks
import typings.pusherJs.callbacksMod.ErrorCallbacks
import typings.pusherJs.callbacksMod.HandshakeCallbacks
...
object connectionManagerMod {
  ...
  trait ConnectionManager
    ...
    var connection: typings.pusherJs.connectionMod.default = js.native
