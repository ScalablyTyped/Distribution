...
object withEncryptionMod {
  
  @JSImport("pusher-js/with-encryption", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    @JSImport("pusher-js/with-encryption", "default.DependenciesReceivers")
    @js.native
    ...
    @JSImport("pusher-js/with-encryption", "default.Runtime")
    @js.native
    ...
    @JSImport("pusher-js/with-encryption", "default.ScriptReceivers")
    @js.native
    ...
    @JSImport("pusher-js/with-encryption", "default.auth_callbacks")
    @js.native
    ...
    @JSImport("pusher-js/with-encryption", "default.getClientFeatures")
    @js.native
    ...
    @JSImport("pusher-js/with-encryption", "default.instances")
    @js.native
    ...
    @JSImport("pusher-js/with-encryption", "default.isReady")
    @js.native
    ...
    @JSImport("pusher-js/with-encryption", "default.logToConsole")
    @js.native
  ...
  @JSImport("pusher-js/with-encryption", "Channel")
  @js.native
  ...
  @JSImport("pusher-js/with-encryption", "ConnectionManager")
  @js.native
  ...
  @JSImport("pusher-js/with-encryption", "Members")
  @js.native
  open class Members ()
    extends typings.pusherJs.typesSrcCoreChannelsMembersMod.default
  
  @JSImport("pusher-js/with-encryption", "PresenceChannel")
  @js.native
