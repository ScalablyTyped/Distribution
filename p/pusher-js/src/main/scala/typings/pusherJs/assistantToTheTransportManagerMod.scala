...
object assistantToTheTransportManagerMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    override def createConnection(name: String, priority: Double, key: String, options: js.Object): typings.pusherJs.transportConnectionMod.default = js.native
    
    /* CompleteClass */
    override def isSupported(environment: String): Boolean = js.native
    
    /* CompleteClass */
    var manager: typings.pusherJs.transportManagerMod.default = js.native
  ...
  trait AssistantToTheTransportManager extends StObject {
    ...
    def createConnection(name: String, priority: Double, key: String, options: js.Object): typings.pusherJs.transportConnectionMod.default
    
    def isSupported(environment: String): Boolean
    
    var manager: typings.pusherJs.transportManagerMod.default
  ...
  object AssistantToTheTransportManager {
    ...
    inline def apply(
      createConnection: (String, Double, String, js.Object) => typings.pusherJs.transportConnectionMod.default,
    ...
    extension [Self <: AssistantToTheTransportManager](x: Self) {
      ...
      inline def setCreateConnection(value: (String, Double, String, js.Object) => typings.pusherJs.transportConnectionMod.default): Self = StObject.set(x, "createConnection", js.Any.fromFunction4(value))
      
      inline def setIsSupported(value: String => Boolean): Self = StObject.set(x, "isSupported", js.Any.fromFunction1(value))
      
      inline def setManager(value: typings.pusherJs.transportManagerMod.default): Self = StObject.set(x, "manager", value.asInstanceOf[js.Any])
