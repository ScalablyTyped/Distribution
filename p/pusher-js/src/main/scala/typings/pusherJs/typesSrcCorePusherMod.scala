...
import typings.pusherJs.typesSrcCoreUtilsTimersMod.PeriodicTimer
...
object typesSrcCorePusherMod {
  ...
  trait Pusher extends StObject {
    ...
    def allChannels(): js.Array[typings.pusherJs.typesSrcCoreChannelsChannelMod.default] = js.native
    ...
    def channel(name: String): typings.pusherJs.typesSrcCoreChannelsChannelMod.default = js.native
    
    var channels: typings.pusherJs.typesSrcCoreChannelsChannelsMod.default = js.native
    
    var config: Config = js.native
    
    def connect(): Unit = js.native
    
    var connection: typings.pusherJs.typesSrcCoreConnectionConnectionManagerMod.default = js.native
    
    def disconnect(): Unit = js.native
    
    var global_emitter: typings.pusherJs.typesSrcCoreEventsDispatcherMod.default = js.native
    ...
    def subscribe(channel_name: String): typings.pusherJs.typesSrcCoreChannelsChannelMod.default = js.native
    
    def subscribeAll(): Unit = js.native
    
    var timeline: typings.pusherJs.typesSrcCoreTimelineTimelineMod.default = js.native
    
    var timelineSender: typings.pusherJs.typesSrcCoreTimelineTimelineSenderMod.default = js.native
    ...
    var user: typings.pusherJs.typesSrcCoreUserMod.default = js.native
  }
}
