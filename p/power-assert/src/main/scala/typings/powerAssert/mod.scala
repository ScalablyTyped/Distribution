...
object mod {
  ...
  @scala.inline
  def customize(options: Options): TypeofpowerAssert = ^.asInstanceOf[js.Dynamic].applyDynamic("customize")(options.asInstanceOf[js.Any]).asInstanceOf[TypeofpowerAssert]
  ...
  @scala.inline
  def deepStrictEqual(actual: js.Any, expected: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("deepStrictEqual")(actual.asInstanceOf[js.Any], expected.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def deepStrictEqual(actual: js.Any, expected: js.Any, message: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("deepStrictEqual")(actual.asInstanceOf[js.Any], expected.asInstanceOf[js.Any], message.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  object strict {
    ...
    @scala.inline
    def customize(options: Options): /* import warning: importer.ImportType#apply Failed type conversion: typeof assert */ js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("customize")(options.asInstanceOf[js.Any]).asInstanceOf[/* import warning: importer.ImportType#apply Failed type conversion: typeof assert */ js.Any]
