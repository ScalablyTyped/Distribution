...
import typings.pixiTextHtml.libHtmltextstyleMod.HTMLTextStyleWhiteSpace
...
object anon {
  ...
  /* Inlined std.Partial<@pixi/text-html.@pixi/text-html/lib/HTMLTextStyle.IHTMLTextStyle> */
  trait PartialIHTMLTextStyle extends StObject {
    ...
    var whiteSpace: js.UndefOr[HTMLTextStyleWhiteSpace] = js.undefined
    
    var wordWrap: js.UndefOr[Boolean] = js.undefined
    
    var wordWrapWidth: js.UndefOr[Double] = js.undefined
  }
  object PartialIHTMLTextStyle {
    
    inline def apply(): PartialIHTMLTextStyle = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PartialIHTMLTextStyle]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PartialIHTMLTextStyle] (val x: Self) extends AnyVal {
  ...
  /* Inlined std.Partial<std.Pick<@pixi/text-html.@pixi/text-html/lib/HTMLTextStyle.IHTMLFont, 'weight' | 'style' | 'family'>> */
  trait PartialPickIHTMLFontweigh extends StObject {
    
    var family: js.UndefOr[String] = js.undefined
    
    var style: js.UndefOr[TextStyleFontStyle] = js.undefined
    
    var weight: js.UndefOr[TextStyleFontWeight] = js.undefined
  }
  object PartialPickIHTMLFontweigh {
    
    inline def apply(): PartialPickIHTMLFontweigh = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PartialPickIHTMLFontweigh]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PartialPickIHTMLFontweigh] (val x: Self) extends AnyVal {
  ...
  trait Resolution extends StObject {
    ...
    var style: js.UndefOr[HTMLTextStyle] = js.undefined
  ...
  object Resolution {
    ...
    implicit open class MutableBuilder[Self <: Resolution] (val x: Self) extends AnyVal {
      ...
      inline def setStyle(value: HTMLTextStyle): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
