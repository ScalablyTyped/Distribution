...
object testBuffersMod {
  ...
  object default {
    ...
    inline def errorOrNotice(fields: Any): typings.pgPacketStream.bufferListMod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("errorOrNotice")(fields.asInstanceOf[js.Any]).asInstanceOf[typings.pgPacketStream.bufferListMod.default]
