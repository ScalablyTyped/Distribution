...
@JSImport("pg-packet-stream/dist/testing/test-buffers", JSImport.Namespace)
@js.native
object testBuffersMod extends js.Object {
  ...
  object default extends js.Object {
    ...
    def errorOrNotice(fields: js.Any): typings.pgPacketStream.bufferListMod.default = js.native
