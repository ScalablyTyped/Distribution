...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "pixi-spine__loader-base" % "3.1.0-594ac7",
  "org.scalablytyped" %%% "pixi-spine__loader-uni" % "3.1.0-5841ed",
  "org.scalablytyped" %%% "pixi-spine__runtime-4_dot_1" % "3.1.0-e96aac",
