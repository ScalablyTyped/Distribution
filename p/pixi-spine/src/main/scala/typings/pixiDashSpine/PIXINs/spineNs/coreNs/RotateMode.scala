...
object RotateMode extends js.Object {
  ...
  /* 1 */ val Chain: typings.pixiDashSpine.PIXINs.spineNs.coreNs.RotateMode.Chain with Double = js.native
  /* 2 */ val ChainScale: typings.pixiDashSpine.PIXINs.spineNs.coreNs.RotateMode.ChainScale with Double = js.native
  /* 0 */ val Tangent: typings.pixiDashSpine.PIXINs.spineNs.coreNs.RotateMode.Tangent with Double = js.native
  @JSBracketAccess
