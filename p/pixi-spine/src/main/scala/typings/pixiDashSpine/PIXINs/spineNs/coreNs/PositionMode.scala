...
object PositionMode extends js.Object {
  ...
  /* 0 */ val Fixed: typings.pixiDashSpine.PIXINs.spineNs.coreNs.PositionMode.Fixed with Double = js.native
  /* 1 */ val Percent: typings.pixiDashSpine.PIXINs.spineNs.coreNs.PositionMode.Percent with Double = js.native
  @JSBracketAccess
