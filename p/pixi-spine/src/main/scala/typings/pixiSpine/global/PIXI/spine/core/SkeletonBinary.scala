...
object SkeletonBinary {
  ...
  @scala.inline
  def BlendModeValues_=(x: js.Array[typings.pixiSpine.PIXI.spine.core.BlendMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BlendModeValues")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def PositionModeValues_=(x: js.Array[typings.pixiSpine.PIXI.spine.core.PositionMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PositionModeValues")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def RotateModeValues_=(x: js.Array[typings.pixiSpine.PIXI.spine.core.RotateMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RotateModeValues")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def SpacingModeValues_=(x: js.Array[typings.pixiSpine.PIXI.spine.core.SpacingMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SpacingModeValues")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def TransformModeValues_=(x: js.Array[typings.pixiSpine.PIXI.spine.core.TransformMode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TransformModeValues")(x.asInstanceOf[js.Any])
}
