...
abstract class Component[P, S] () extends js.Object {
  ...
  var componentDidUpdate: js.UndefOr[
    js.Function3[
      /* previousProps */ stdLib.Readonly[P], 
      /* previousState */ stdLib.Readonly[S], 
      /* previousContext */ js.Any, 
      scala.Unit
    ]
  ] = js.native
  ...
  def render(props: RenderableProps[P, _], state: stdLib.Readonly[S]): ComponentChild = js.native
  def render(props: RenderableProps[P, _], state: stdLib.Readonly[S], context: js.Any): ComponentChild = js.native
