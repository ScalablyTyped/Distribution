...
package object JSXNs {
  ...
  type Element = preactLib.preactMod.VNode[js.Any]
  type ElementClass = preactLib.preactMod.Component[js.Any, js.Any]
  ...
  type LibraryManagedAttributes[Component, Props] = Props | (preactLib.preactMod.Defaultize[Props, js.Any])
