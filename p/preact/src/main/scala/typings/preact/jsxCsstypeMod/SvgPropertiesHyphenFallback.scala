...
object SvgPropertiesHyphenFallback {
  ...
  @scala.inline
  implicit class SvgPropertiesHyphenFallbackMutableBuilder[Self <: SvgPropertiesHyphenFallback[?], TLength] (val x: Self & SvgPropertiesHyphenFallback[TLength]) extends AnyVal {
