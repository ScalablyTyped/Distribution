...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.both
  - typings.preact.preactStrings.clear
  - typings.preact.preactStrings.end
  - typings.preact.preactStrings.maximum
...
*/
trait MsWrapFlowProperty extends StObject
object MsWrapFlowProperty {
  ...
  inline def end: typings.preact.preactStrings.end = "end".asInstanceOf[typings.preact.preactStrings.end]
  ...
  inline def maximum: typings.preact.preactStrings.maximum = "maximum".asInstanceOf[typings.preact.preactStrings.maximum]
  
  inline def revert: typings.preact.preactStrings.revert = "revert".asInstanceOf[typings.preact.preactStrings.revert]
  
  inline def start: typings.preact.preactStrings.start = "start".asInstanceOf[typings.preact.preactStrings.start]
