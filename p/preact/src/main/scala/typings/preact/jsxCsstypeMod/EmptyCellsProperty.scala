...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.hide
  - typings.preact.preactStrings.show
...
object EmptyCellsProperty {
  ...
  @scala.inline
  def hide: typings.preact.preactStrings.hide = "hide".asInstanceOf[typings.preact.preactStrings.hide]
  ...
  @scala.inline
  def show: typings.preact.preactStrings.show = "show".asInstanceOf[typings.preact.preactStrings.show]
