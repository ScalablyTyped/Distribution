...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.`close-quote`
  - typings.preact.preactStrings.`no-close-quote`
  - typings.preact.preactStrings.`no-open-quote`
  - typings.preact.preactStrings.`open-quote`
*/
trait Quote
  extends StObject
     with _ContentList
