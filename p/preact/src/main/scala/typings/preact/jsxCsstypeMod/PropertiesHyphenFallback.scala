...
object PropertiesHyphenFallback {
  ...
  @scala.inline
  implicit class PropertiesHyphenFallbackMutableBuilder[Self <: PropertiesHyphenFallback[?], TLength] (val x: Self & PropertiesHyphenFallback[TLength]) extends AnyVal {
