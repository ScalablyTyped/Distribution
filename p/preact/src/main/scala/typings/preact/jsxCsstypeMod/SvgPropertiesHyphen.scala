...
object SvgPropertiesHyphen {
  ...
  extension [Self <: SvgPropertiesHyphen[?], TLength](x: Self & SvgPropertiesHyphen[TLength]) {
    ...
    inline def `setText-decoration`(value: TextDecorationProperty[TLength]): Self = StObject.set(x, "text-decoration", value.asInstanceOf[js.Any])
