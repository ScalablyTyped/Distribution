...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.balance
...
*/
trait ColumnFillProperty extends js.Object
object ColumnFillProperty {
  ...
  @scala.inline
  def balance: typings.preact.preactStrings.balance = "balance".asInstanceOf[typings.preact.preactStrings.balance]
