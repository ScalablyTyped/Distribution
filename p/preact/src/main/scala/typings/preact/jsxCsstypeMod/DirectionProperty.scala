...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.ltr
  - typings.preact.preactStrings.rtl
...
object DirectionProperty {
  ...
  inline def ltr: typings.preact.preactStrings.ltr = "ltr".asInstanceOf[typings.preact.preactStrings.ltr]
  
  inline def revert: typings.preact.preactStrings.revert = "revert".asInstanceOf[typings.preact.preactStrings.revert]
  
  inline def rtl: typings.preact.preactStrings.rtl = "rtl".asInstanceOf[typings.preact.preactStrings.rtl]
