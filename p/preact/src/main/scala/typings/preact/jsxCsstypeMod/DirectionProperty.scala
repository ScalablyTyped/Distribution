...
object DirectionProperty {
  ...
  @scala.inline
  def ltr: typings.preact.preactStrings.ltr = "ltr".asInstanceOf[typings.preact.preactStrings.ltr]
  
  @scala.inline
  def revert: typings.preact.preactStrings.revert = "revert".asInstanceOf[typings.preact.preactStrings.revert]
  
  @scala.inline
  def rtl: typings.preact.preactStrings.rtl = "rtl".asInstanceOf[typings.preact.preactStrings.rtl]
