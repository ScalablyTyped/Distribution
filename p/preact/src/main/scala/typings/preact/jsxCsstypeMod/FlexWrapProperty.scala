...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.`wrap-reverse`
...
object FlexWrapProperty {
  ...
  inline def nowrap: typings.preact.preactStrings.nowrap = "nowrap".asInstanceOf[typings.preact.preactStrings.nowrap]
  ...
  inline def `wrap-reverse`: typings.preact.preactStrings.`wrap-reverse` = "wrap-reverse".asInstanceOf[typings.preact.preactStrings.`wrap-reverse`]
}
