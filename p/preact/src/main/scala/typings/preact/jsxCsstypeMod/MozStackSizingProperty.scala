...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.`stretch-to-fit`
...
object MozStackSizingProperty {
  ...
  inline def ignore: typings.preact.preactStrings.ignore = "ignore".asInstanceOf[typings.preact.preactStrings.ignore]
  ...
  inline def `stretch-to-fit`: typings.preact.preactStrings.`stretch-to-fit` = "stretch-to-fit".asInstanceOf[typings.preact.preactStrings.`stretch-to-fit`]
