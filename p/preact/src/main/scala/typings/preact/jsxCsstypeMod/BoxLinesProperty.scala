...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.single
...
object BoxLinesProperty {
  ...
  inline def multiple: typings.preact.preactStrings.multiple = "multiple".asInstanceOf[typings.preact.preactStrings.multiple]
  
  inline def revert: typings.preact.preactStrings.revert = "revert".asInstanceOf[typings.preact.preactStrings.revert]
  
  inline def single: typings.preact.preactStrings.single = "single".asInstanceOf[typings.preact.preactStrings.single]
