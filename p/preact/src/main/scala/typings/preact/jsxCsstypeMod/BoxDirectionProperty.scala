...
*/
trait BoxDirectionProperty extends js.Object
object BoxDirectionProperty {
  ...
  @scala.inline
  def reverse: typings.preact.preactStrings.reverse = "reverse".asInstanceOf[typings.preact.preactStrings.reverse]
