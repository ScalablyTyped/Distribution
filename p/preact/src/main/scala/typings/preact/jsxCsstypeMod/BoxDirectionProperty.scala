...
*/
trait BoxDirectionProperty extends StObject
object BoxDirectionProperty {
  ...
  inline def reverse: typings.preact.preactStrings.reverse = "reverse".asInstanceOf[typings.preact.preactStrings.reverse]
