...
object ViewportFallback {
  ...
  extension [Self <: ViewportFallback[?], TLength](x: Self & ViewportFallback[TLength]) {
    ...
    inline def setMaxHeightVarargs(value: ViewportMaxHeightProperty[TLength]*): Self = StObject.set(x, "maxHeight", js.Array(value :_*))
    ...
    inline def setMaxWidthVarargs(value: ViewportMaxWidthProperty[TLength]*): Self = StObject.set(x, "maxWidth", js.Array(value :_*))
    ...
    inline def setMaxZoomVarargs(value: ViewportMaxZoomProperty*): Self = StObject.set(x, "maxZoom", js.Array(value :_*))
    ...
    inline def setMinHeightVarargs(value: ViewportMinHeightProperty[TLength]*): Self = StObject.set(x, "minHeight", js.Array(value :_*))
    ...
    inline def setMinWidthVarargs(value: ViewportMinWidthProperty[TLength]*): Self = StObject.set(x, "minWidth", js.Array(value :_*))
    ...
    inline def setMinZoomVarargs(value: ViewportMinZoomProperty*): Self = StObject.set(x, "minZoom", js.Array(value :_*))
    ...
    inline def setMsHeightVarargs(value: ViewportHeightProperty[TLength]*): Self = StObject.set(x, "msHeight", js.Array(value :_*))
    ...
    inline def setMsMaxHeightVarargs(value: ViewportMaxHeightProperty[TLength]*): Self = StObject.set(x, "msMaxHeight", js.Array(value :_*))
    ...
    inline def setMsMaxWidthVarargs(value: ViewportMaxWidthProperty[TLength]*): Self = StObject.set(x, "msMaxWidth", js.Array(value :_*))
    ...
    inline def setMsMaxZoomVarargs(value: ViewportMaxZoomProperty*): Self = StObject.set(x, "msMaxZoom", js.Array(value :_*))
    ...
    inline def setMsMinHeightVarargs(value: ViewportMinHeightProperty[TLength]*): Self = StObject.set(x, "msMinHeight", js.Array(value :_*))
    ...
    inline def setMsMinWidthVarargs(value: ViewportMinWidthProperty[TLength]*): Self = StObject.set(x, "msMinWidth", js.Array(value :_*))
    ...
    inline def setMsMinZoomVarargs(value: ViewportMinZoomProperty*): Self = StObject.set(x, "msMinZoom", js.Array(value :_*))
    ...
    inline def setMsOrientationVarargs(value: ViewportOrientationProperty*): Self = StObject.set(x, "msOrientation", js.Array(value :_*))
    ...
    inline def setMsUserZoomVarargs(value: ViewportUserZoomProperty*): Self = StObject.set(x, "msUserZoom", js.Array(value :_*))
    ...
    inline def setMsWidthVarargs(value: ViewportWidthProperty[TLength]*): Self = StObject.set(x, "msWidth", js.Array(value :_*))
    ...
    inline def setMsZoomVarargs(value: ViewportZoomProperty*): Self = StObject.set(x, "msZoom", js.Array(value :_*))
    ...
    inline def setOOrientationVarargs(value: ViewportOrientationProperty*): Self = StObject.set(x, "OOrientation", js.Array(value :_*))
    ...
    inline def setUserZoomVarargs(value: ViewportUserZoomProperty*): Self = StObject.set(x, "userZoom", js.Array(value :_*))
