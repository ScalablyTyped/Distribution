...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.`block-end`
  - typings.preact.preactStrings.`block-start`
  - typings.preact.preactStrings.bottom
  - typings.preact.preactStrings.`inline-end`
  - typings.preact.preactStrings.`inline-start`
  - typings.preact.preactStrings.top
...
object CaptionSideProperty {
  ...
  @scala.inline
  def `block-end`: typings.preact.preactStrings.`block-end` = "block-end".asInstanceOf[typings.preact.preactStrings.`block-end`]
  
  @scala.inline
  def `block-start`: typings.preact.preactStrings.`block-start` = "block-start".asInstanceOf[typings.preact.preactStrings.`block-start`]
  
  @scala.inline
  def bottom: typings.preact.preactStrings.bottom = "bottom".asInstanceOf[typings.preact.preactStrings.bottom]
  ...
  @scala.inline
  def top: typings.preact.preactStrings.top = "top".asInstanceOf[typings.preact.preactStrings.top]
