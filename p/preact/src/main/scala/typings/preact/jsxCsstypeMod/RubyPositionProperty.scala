...
object RubyPositionProperty {
  ...
  @scala.inline
  def over: typings.preact.preactStrings.over = "over".asInstanceOf[typings.preact.preactStrings.over]
  
  @scala.inline
  def revert: typings.preact.preactStrings.revert = "revert".asInstanceOf[typings.preact.preactStrings.revert]
  
  @scala.inline
  def under: typings.preact.preactStrings.under = "under".asInstanceOf[typings.preact.preactStrings.under]
