...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.over
  - typings.preact.preactStrings.under
...
object RubyPositionProperty {
  ...
  inline def over: typings.preact.preactStrings.over = "over".asInstanceOf[typings.preact.preactStrings.over]
  
  inline def revert: typings.preact.preactStrings.revert = "revert".asInstanceOf[typings.preact.preactStrings.revert]
  
  inline def under: typings.preact.preactStrings.under = "under".asInstanceOf[typings.preact.preactStrings.under]
