...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.touch
...
*/
trait WebkitOverflowScrollingProperty extends StObject
object WebkitOverflowScrollingProperty {
  ...
  inline def touch: typings.preact.preactStrings.touch = "touch".asInstanceOf[typings.preact.preactStrings.touch]
