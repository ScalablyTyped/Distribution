...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.collapse
  - typings.preact.preactStrings.separate
...
object BorderCollapseProperty {
  ...
  inline def separate: typings.preact.preactStrings.separate = "separate".asInstanceOf[typings.preact.preactStrings.separate]
