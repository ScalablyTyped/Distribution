...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.justify
...
object TextAlignLastProperty {
  ...
  inline def center: typings.preact.preactStrings.center = "center".asInstanceOf[typings.preact.preactStrings.center]
  ...
  inline def justify: typings.preact.preactStrings.justify = "justify".asInstanceOf[typings.preact.preactStrings.justify]
