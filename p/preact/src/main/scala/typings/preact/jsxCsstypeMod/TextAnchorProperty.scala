...
*/
trait TextAnchorProperty extends StObject
object TextAnchorProperty {
  ...
  inline def middle: typings.preact.preactStrings.middle = "middle".asInstanceOf[typings.preact.preactStrings.middle]
