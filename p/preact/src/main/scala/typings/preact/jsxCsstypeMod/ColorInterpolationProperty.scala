...
object ColorInterpolationProperty {
  ...
  @scala.inline
  def linearRGB: typings.preact.preactStrings.linearRGB = "linearRGB".asInstanceOf[typings.preact.preactStrings.linearRGB]
  
  @scala.inline
  def revert: typings.preact.preactStrings.revert = "revert".asInstanceOf[typings.preact.preactStrings.revert]
  
  @scala.inline
  def sRGB: typings.preact.preactStrings.sRGB = "sRGB".asInstanceOf[typings.preact.preactStrings.sRGB]
