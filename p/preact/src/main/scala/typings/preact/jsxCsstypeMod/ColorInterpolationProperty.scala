...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.linearRGB
  - typings.preact.preactStrings.sRGB
...
object ColorInterpolationProperty {
  ...
  inline def linearRGB: typings.preact.preactStrings.linearRGB = "linearRGB".asInstanceOf[typings.preact.preactStrings.linearRGB]
  
  inline def revert: typings.preact.preactStrings.revert = "revert".asInstanceOf[typings.preact.preactStrings.revert]
  
  inline def sRGB: typings.preact.preactStrings.sRGB = "sRGB".asInstanceOf[typings.preact.preactStrings.sRGB]
