...
object CounterStyleHyphenFallback {
  ...
  extension [Self <: CounterStyleHyphenFallback](x: Self) {
    ...
    inline def `setAdditive-symbolsVarargs`(value: String*): Self = StObject.set(x, "additive-symbols", js.Array(value :_*))
    ...
    inline def `setSpeak-asVarargs`(value: CounterStyleSpeakAsProperty*): Self = StObject.set(x, "speak-as", js.Array(value :_*))
