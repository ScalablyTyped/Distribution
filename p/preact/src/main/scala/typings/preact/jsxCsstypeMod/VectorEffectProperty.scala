...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.`non-scaling-stroke`
...
object VectorEffectProperty {
  ...
  inline def `non-scaling-stroke`: typings.preact.preactStrings.`non-scaling-stroke` = "non-scaling-stroke".asInstanceOf[typings.preact.preactStrings.`non-scaling-stroke`]
