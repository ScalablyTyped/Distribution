...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.large
  - typings.preact.preactStrings.medium
  - typings.preact.preactStrings.small
  - typings.preact.preactStrings.`x-large`
  - typings.preact.preactStrings.`x-small`
  - typings.preact.preactStrings.`xx-large`
  - typings.preact.preactStrings.`xx-small`
  - typings.preact.preactStrings.`xxx-large`
*/
trait AbsoluteSize
