...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.`-ms-autohiding-scrollbar`
  - typings.preact.preactStrings.auto
  - typings.preact.preactStrings.none
  - typings.preact.preactStrings.scrollbar_
...
object MsOverflowStyleProperty {
  ...
  @scala.inline
  def `-ms-autohiding-scrollbar`: typings.preact.preactStrings.`-ms-autohiding-scrollbar` = "-ms-autohiding-scrollbar".asInstanceOf[typings.preact.preactStrings.`-ms-autohiding-scrollbar`]
