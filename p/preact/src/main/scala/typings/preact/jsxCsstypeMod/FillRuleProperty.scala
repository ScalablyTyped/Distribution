...
object FillRuleProperty {
  ...
  @scala.inline
  def evenodd: typings.preact.preactStrings.evenodd = "evenodd".asInstanceOf[typings.preact.preactStrings.evenodd]
  ...
  @scala.inline
  def nonzero: typings.preact.preactStrings.nonzero = "nonzero".asInstanceOf[typings.preact.preactStrings.nonzero]
