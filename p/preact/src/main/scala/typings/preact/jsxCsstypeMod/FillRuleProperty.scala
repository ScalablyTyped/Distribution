...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.evenodd
  - typings.preact.preactStrings.nonzero
...
object FillRuleProperty {
  ...
  inline def evenodd: typings.preact.preactStrings.evenodd = "evenodd".asInstanceOf[typings.preact.preactStrings.evenodd]
  ...
  inline def nonzero: typings.preact.preactStrings.nonzero = "nonzero".asInstanceOf[typings.preact.preactStrings.nonzero]
