...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.cursive
  - typings.preact.preactStrings.fantasy
  - typings.preact.preactStrings.monospace
  - typings.preact.preactStrings.`sans-serif`
  - typings.preact.preactStrings.serif
*/
