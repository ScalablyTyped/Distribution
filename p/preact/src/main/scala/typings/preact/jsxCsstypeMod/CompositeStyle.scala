...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.`destination-atop`
  - typings.preact.preactStrings.`destination-in`
  - typings.preact.preactStrings.`destination-out`
  - typings.preact.preactStrings.`destination-over`
  - typings.preact.preactStrings.`source-atop`
  - typings.preact.preactStrings.`source-in`
  - typings.preact.preactStrings.`source-out`
