...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.`@counter-style`
  - typings.preact.preactStrings.`@document`
  - typings.preact.preactStrings.`@font-face`
  - typings.preact.preactStrings.`@font-feature-values`
  - typings.preact.preactStrings.`@import`
  - typings.preact.preactStrings.`@keyframes`
  - typings.preact.preactStrings.`@media`
  - typings.preact.preactStrings.`@namespace`
