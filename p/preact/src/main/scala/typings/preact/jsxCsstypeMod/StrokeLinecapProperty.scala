...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.butt
  - typings.preact.preactStrings.round
  - typings.preact.preactStrings.square
...
object StrokeLinecapProperty {
  ...
  @scala.inline
  def butt: typings.preact.preactStrings.butt = "butt".asInstanceOf[typings.preact.preactStrings.butt]
  ...
  @scala.inline
  def square: typings.preact.preactStrings.square = "square".asInstanceOf[typings.preact.preactStrings.square]
