...
object MsScrollTranslationProperty {
  ...
  @scala.inline
  def `vertical-to-horizontal`: typings.preact.preactStrings.`vertical-to-horizontal` = "vertical-to-horizontal".asInstanceOf[typings.preact.preactStrings.`vertical-to-horizontal`]
}
