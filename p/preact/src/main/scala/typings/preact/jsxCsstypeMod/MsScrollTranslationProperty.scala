...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.`vertical-to-horizontal`
...
object MsScrollTranslationProperty {
  ...
  inline def `vertical-to-horizontal`: typings.preact.preactStrings.`vertical-to-horizontal` = "vertical-to-horizontal".asInstanceOf[typings.preact.preactStrings.`vertical-to-horizontal`]
}
