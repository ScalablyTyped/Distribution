...
*/
trait TextJustifyProperty extends js.Object
object TextJustifyProperty {
  ...
  @scala.inline
  def `inter-character`: typings.preact.preactStrings.`inter-character` = "inter-character".asInstanceOf[typings.preact.preactStrings.`inter-character`]
  
  @scala.inline
  def `inter-word`: typings.preact.preactStrings.`inter-word` = "inter-word".asInstanceOf[typings.preact.preactStrings.`inter-word`]
