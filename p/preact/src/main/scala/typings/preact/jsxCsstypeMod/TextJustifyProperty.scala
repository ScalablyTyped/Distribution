...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.preact.preactStrings.`inter-character`
  - typings.preact.preactStrings.`inter-word`
...
*/
trait TextJustifyProperty extends StObject
object TextJustifyProperty {
  ...
  inline def `inter-character`: typings.preact.preactStrings.`inter-character` = "inter-character".asInstanceOf[typings.preact.preactStrings.`inter-character`]
  
  inline def `inter-word`: typings.preact.preactStrings.`inter-word` = "inter-word".asInstanceOf[typings.preact.preactStrings.`inter-word`]
