...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.`-moz-none`
...
object UserSelectProperty {
  ...
  inline def `-moz-none`: typings.preact.preactStrings.`-moz-none` = "-moz-none".asInstanceOf[typings.preact.preactStrings.`-moz-none`]
