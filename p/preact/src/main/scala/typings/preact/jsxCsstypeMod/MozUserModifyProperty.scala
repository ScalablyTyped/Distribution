...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.`read-only`
  - typings.preact.preactStrings.`read-write`
  - typings.preact.preactStrings.`write-only`
...
*/
trait MozUserModifyProperty extends js.Object
object MozUserModifyProperty {
  ...
  @scala.inline
  def `read-only`: typings.preact.preactStrings.`read-only` = "read-only".asInstanceOf[typings.preact.preactStrings.`read-only`]
  
  @scala.inline
  def `read-write`: typings.preact.preactStrings.`read-write` = "read-write".asInstanceOf[typings.preact.preactStrings.`read-write`]
  ...
  @scala.inline
  def `write-only`: typings.preact.preactStrings.`write-only` = "write-only".asInstanceOf[typings.preact.preactStrings.`write-only`]
}
