...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.clone
  - typings.preact.preactStrings.slice
...
object BoxDecorationBreakProperty {
  ...
  inline def slice: typings.preact.preactStrings.slice = "slice".asInstanceOf[typings.preact.preactStrings.slice]
