...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.`-ms-inline-flexbox`
  - typings.preact.preactStrings.`-ms-inline-grid`
  - typings.preact.preactStrings.`-webkit-inline-flex`
  - typings.preact.preactStrings.`inline-block`
  - typings.preact.preactStrings.`inline-flex`
  - typings.preact.preactStrings.`inline-grid`
  - typings.preact.preactStrings.`inline-list-item`
  - typings.preact.preactStrings.`inline-table`
*/
