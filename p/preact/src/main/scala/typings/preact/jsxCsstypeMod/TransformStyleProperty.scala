...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.flat
  - typings.preact.preactStrings.`preserve-3d`
...
object TransformStyleProperty {
  ...
  inline def flat: typings.preact.preactStrings.flat = "flat".asInstanceOf[typings.preact.preactStrings.flat]
  ...
  inline def `preserve-3d`: typings.preact.preactStrings.`preserve-3d` = "preserve-3d".asInstanceOf[typings.preact.preactStrings.`preserve-3d`]
