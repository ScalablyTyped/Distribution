...
object TransformStyleProperty {
  ...
  @scala.inline
  def flat: typings.preact.preactStrings.flat = "flat".asInstanceOf[typings.preact.preactStrings.flat]
  ...
  @scala.inline
  def `preserve-3d`: typings.preact.preactStrings.`preserve-3d` = "preserve-3d".asInstanceOf[typings.preact.preactStrings.`preserve-3d`]
