...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.mixed
  - typings.preact.preactStrings.sideways
  - typings.preact.preactStrings.upright
...
*/
trait TextOrientationProperty extends js.Object
