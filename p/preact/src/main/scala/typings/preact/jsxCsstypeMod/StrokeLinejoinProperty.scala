...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.bevel
  - typings.preact.preactStrings.miter
...
object StrokeLinejoinProperty {
  ...
  @scala.inline
  def bevel: typings.preact.preactStrings.bevel = "bevel".asInstanceOf[typings.preact.preactStrings.bevel]
  ...
  @scala.inline
  def miter: typings.preact.preactStrings.miter = "miter".asInstanceOf[typings.preact.preactStrings.miter]
