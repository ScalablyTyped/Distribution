...
/* Rewritten from type alias, can be one of: 
  - typings.preact.preactStrings.mandatory
  - typings.preact.preactStrings.none
  - typings.preact.preactStrings.proximity
...
object MsScrollSnapTypeProperty {
  ...
  inline def mandatory: typings.preact.preactStrings.mandatory = "mandatory".asInstanceOf[typings.preact.preactStrings.mandatory]
  
  inline def none: typings.preact.preactStrings.none = "none".asInstanceOf[typings.preact.preactStrings.none]
  
  inline def proximity: typings.preact.preactStrings.proximity = "proximity".asInstanceOf[typings.preact.preactStrings.proximity]
