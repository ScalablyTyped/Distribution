...
*/
trait MsScrollSnapTypeProperty extends js.Object
object MsScrollSnapTypeProperty {
  ...
  @scala.inline
  def mandatory: typings.preact.preactStrings.mandatory = "mandatory".asInstanceOf[typings.preact.preactStrings.mandatory]
  
  @scala.inline
  def none: typings.preact.preactStrings.none = "none".asInstanceOf[typings.preact.preactStrings.none]
  
  @scala.inline
  def proximity: typings.preact.preactStrings.proximity = "proximity".asInstanceOf[typings.preact.preactStrings.proximity]
