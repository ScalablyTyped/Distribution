...
object TargetedTransitionEvent {
  ...
  @scala.inline
  implicit class TargetedTransitionEventMutableBuilder[Self <: TargetedTransitionEvent[?], Target /* <: EventTarget */] (val x: Self & TargetedTransitionEvent[Target]) extends AnyVal {
