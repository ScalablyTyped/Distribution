...
object TargetedCompositionEvent {
  ...
  @scala.inline
  implicit class TargetedCompositionEventMutableBuilder[Self <: TargetedCompositionEvent[?], Target /* <: EventTarget */] (val x: Self & TargetedCompositionEvent[Target]) extends AnyVal {
