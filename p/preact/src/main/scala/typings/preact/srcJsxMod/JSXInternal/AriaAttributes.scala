...
import typings.preact.preactStrings.`additions removals`
import typings.preact.preactStrings.`additions text`
import typings.preact.preactStrings.`inline`
import typings.preact.preactStrings.`removals additions`
import typings.preact.preactStrings.`removals text`
import typings.preact.preactStrings.`text additions`
import typings.preact.preactStrings.`text removals`
import typings.preact.preactStrings.additions
import typings.preact.preactStrings.all
import typings.preact.preactStrings.ascending
import typings.preact.preactStrings.assertive
import typings.preact.preactStrings.both
import typings.preact.preactStrings.copy
import typings.preact.preactStrings.date
import typings.preact.preactStrings.descending
import typings.preact.preactStrings.dialog
import typings.preact.preactStrings.execute
import typings.preact.preactStrings.grammar
import typings.preact.preactStrings.grid
import typings.preact.preactStrings.horizontal
import typings.preact.preactStrings.link
import typings.preact.preactStrings.list
import typings.preact.preactStrings.listbox
import typings.preact.preactStrings.location
import typings.preact.preactStrings.menu
import typings.preact.preactStrings.mixed
import typings.preact.preactStrings.move
import typings.preact.preactStrings.none
import typings.preact.preactStrings.off
import typings.preact.preactStrings.other
import typings.preact.preactStrings.page
import typings.preact.preactStrings.polite
import typings.preact.preactStrings.popup
import typings.preact.preactStrings.removals
import typings.preact.preactStrings.spelling
import typings.preact.preactStrings.step
import typings.preact.preactStrings.text
import typings.preact.preactStrings.time
import typings.preact.preactStrings.tree
import typings.preact.preactStrings.vertical
import typings.preact.srcJsxMod.Booleanish
...
trait AriaAttributes extends StObject {
  ...
  var `aria-live`: js.UndefOr[Signalish[js.UndefOr[off | assertive | polite]]] = js.undefined
...
object AriaAttributes {
  ...
  inline def apply(): AriaAttributes = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AriaAttributes]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AriaAttributes] (val x: Self) extends AnyVal {
    ...
    inline def `setAria-live`(value: Signalish[js.UndefOr[off | assertive | polite]]): Self = StObject.set(x, "aria-live", value.asInstanceOf[js.Any])
