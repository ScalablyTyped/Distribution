package typings.preact.srcMod.hNs.JSXNs
...
trait HTMLAttributes
  extends ClassAttributes[js.Any]
     with typings.preact.srcJsxMod.JSXInternalNs.DOMAttributes {
  // RDFa Attributes
...
object HTMLAttributes {
  ...
  def apply(
    ...
    DOMAttributes: typings.preact.srcJsxMod.JSXInternalNs.DOMAttributes = null,
    about: String = null,
    accept: String = null,
