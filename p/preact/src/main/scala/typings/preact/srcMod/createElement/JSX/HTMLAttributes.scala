package typings.preact.srcMod.createElement.JSX
...
object HTMLAttributes {
  ...
  def apply[RefType /* <: EventTarget */](
    ...
    DOMAttributes: typings.preact.srcJsxMod.JSXInternal.DOMAttributes[RefType] = null,
    about: String = null,
    accept: String = null,
    ...
    style: String | (StringDictionary[String | Double]) = null,
    summary: String = null,
    ...
    if (!js.isUndefined(disableRemotePlayback)) __obj.updateDynamic("disableRemotePlayback")(disableRemotePlayback)
