...
object TargetedAnimationEvent {
  ...
  @scala.inline
  implicit class TargetedAnimationEventMutableBuilder[Self <: TargetedAnimationEvent[?], Target /* <: EventTarget */] (val x: Self & TargetedAnimationEvent[Target]) extends AnyVal {
