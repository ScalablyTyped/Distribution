...
): typings.preact.mod.VNode[js.Any] = (typings.preact.mod.h.^.asInstanceOf[js.Dynamic].apply(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typings.preact.mod.VNode[js.Any]]
@scala.inline
def apply(`type`: java.lang.String, props: scala.Null, children: typings.preact.mod.ComponentChildren*): typings.preact.mod.VNode[js.Any] = (typings.preact.mod.h.^.asInstanceOf[js.Dynamic].apply(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any], children.asInstanceOf[js.Any])).asInstanceOf[typings.preact.mod.VNode[js.Any]]
@scala.inline
def apply[P](
