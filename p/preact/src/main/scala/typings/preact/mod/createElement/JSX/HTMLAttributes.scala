...
object HTMLAttributes {
  ...
  @scala.inline
  implicit class HTMLAttributesOps[Self <: HTMLAttributes[_], RefType /* <: EventTarget */] (val x: Self with HTMLAttributes[RefType]) extends AnyVal {
    ...
    @scala.inline
    def setStyle(value: String | typings.preact.jsxMod.JSXInternal.CSSProperties): Self = this.set("style", value.asInstanceOf[js.Any])
