...
trait HTMLAttributes[RefType /* <: EventTarget */]
  ...
  var style: js.UndefOr[String | typings.preact.jsxMod.JSXInternal.CSSProperties] = js.undefined
...
object HTMLAttributes {
  ...
  @scala.inline
  implicit class HTMLAttributesMutableBuilder[Self <: HTMLAttributes[?], RefType /* <: EventTarget */] (val x: Self & HTMLAttributes[RefType]) extends AnyVal {
