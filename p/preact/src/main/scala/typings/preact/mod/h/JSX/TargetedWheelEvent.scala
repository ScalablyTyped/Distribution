...
object TargetedWheelEvent {
  ...
  @scala.inline
  implicit class TargetedWheelEventMutableBuilder[Self <: TargetedWheelEvent[?], Target /* <: EventTarget */] (val x: Self & TargetedWheelEvent[Target]) extends AnyVal {
    ...
    @scala.inline
    def setDOM_DELTA_LINE(value: Double): Self = StObject.set(x, "DOM_DELTA_LINE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDOM_DELTA_PAGE(value: Double): Self = StObject.set(x, "DOM_DELTA_PAGE", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDOM_DELTA_PIXEL(value: Double): Self = StObject.set(x, "DOM_DELTA_PIXEL", value.asInstanceOf[js.Any])
