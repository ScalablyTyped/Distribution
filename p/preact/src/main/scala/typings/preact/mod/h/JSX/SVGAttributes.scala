...
object SVGAttributes {
  @scala.inline
  def apply[/* <: typings.std.EventTarget */ Target](): SVGAttributes[Target] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SVGAttributes[Target]]
  }
  @scala.inline
  implicit class SVGAttributesOps[Self <: SVGAttributes[_], /* <: typings.std.EventTarget */ Target] (val x: Self with SVGAttributes[Target]) extends AnyVal {
    @scala.inline
