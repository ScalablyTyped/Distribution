...
package object JSX {
  ...
  type TargetedEvent[Target /* <: typings.std.EventTarget */, TypedEvent /* <: typings.std.Event */] = (typings.std.Omit[TypedEvent, typings.preact.preactStrings.currentTarget]) with typings.preact.anon.CurrentTarget[Target]
