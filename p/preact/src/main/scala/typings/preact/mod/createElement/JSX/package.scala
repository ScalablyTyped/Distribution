...
type CSSProperties = typings.preact.jsxCsstypeMod.Properties[java.lang.String | scala.Double]
...
type EventHandler[E /* <: typings.preact.anon.TargetedEventEventTargetE */] = js.ThisFunction1[
...
type GenericEventHandler[Target /* <: typings.std.EventTarget */] = typings.preact.jsxMod.JSXInternal.EventHandler[typings.preact.jsxMod.JSXInternal.TargetedEvent[Target, typings.std.Event]]
...
type TargetedEvent[Target /* <: typings.std.EventTarget */, TypedEvent /* <: typings.std.Event */] = (typings.std.Omit[TypedEvent, typings.preact.preactStrings.currentTarget]) & typings.preact.anon.CurrentTarget[Target]
