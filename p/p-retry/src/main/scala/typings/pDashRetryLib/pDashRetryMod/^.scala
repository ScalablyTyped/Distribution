...
object ^ extends js.Object {
  var AbortError: org.scalablytyped.runtime.Instantiable1[/* message */ java.lang.String | stdLib.Error, AbortErrorClass] = js.native
  // TODO: remove this in the next major version
  @JSName("default")
  var default_Original: pDashRetryLib.Anon_AbortError = js.native
  /**
  ...
  def apply[T](input: js.Function1[/* attemptCount */ scala.Double, js.Thenable[T] | T], options: Options): js.Promise[T] = js.native
  /**
  	Returns a `Promise` that is fulfilled when calling `input` returns a fulfilled promise. If calling `input` returns a rejected promise, `input` is called again until the max retries are reached, it then rejects with the last rejection reason.
  	It doesn't retry on `TypeError` as that's a user error.
  	@param input - Receives the number of attempts as the first argument and is expected to return a `Promise` or any value.
