...
class Client protected () extends js.Object {
  def this(serverKey: String) = this()
  def this(serverKey: String, options: Partial[Options]) = this()
  def activateBounce(id: Double): js.UndefOr[scala.Nothing] = js.native
  def activateBounce(id: Double, callback: PostmarkCallback[ActivatedBounceResult]): js.UndefOr[scala.Nothing] = js.native
  @JSName("activateBounce")
  def activateBounce_Promise(id: Double): js.Promise[ActivatedBounceResult] = js.native
  ...
  def bypassBlockedInboundMessage(id: Double): js.UndefOr[scala.Nothing] = js.native
  def bypassBlockedInboundMessage(id: Double, callback: PostmarkCallback[GenericResult]): js.UndefOr[scala.Nothing] = js.native
  @JSName("bypassBlockedInboundMessage")
  def bypassBlockedInboundMessage_Promise(id: Double): js.Promise[GenericResult] = js.native
  def createTemplate(template: Partial[Template]): js.UndefOr[scala.Nothing] = js.native
  def createTemplate(template: Partial[Template], callback: PostmarkCallback[TemplateBase]): js.UndefOr[scala.Nothing] = js.native
  @JSName("createTemplate")
  def createTemplate_Promise(template: Partial[Template]): js.Promise[TemplateBase] = js.native
  def deleteTemplate(id: Double): js.UndefOr[scala.Nothing] = js.native
  def deleteTemplate(id: Double, callback: PostmarkCallback[GenericResult]): js.UndefOr[scala.Nothing] = js.native
  @JSName("deleteTemplate")
  def deleteTemplate_Promise(id: Double): js.Promise[GenericResult] = js.native
  def editServer(server: Partial[Server]): js.UndefOr[scala.Nothing] = js.native
  def editServer(server: Partial[Server], callback: PostmarkCallback[Server]): js.UndefOr[scala.Nothing] = js.native
  @JSName("editServer")
  def editServer_Promise(server: Partial[Server]): js.Promise[Server] = js.native
  def editTemplate(template: Partial[Template]): js.UndefOr[scala.Nothing] = js.native
  def editTemplate(template: Partial[Template], callback: PostmarkCallback[TemplateBase]): js.UndefOr[scala.Nothing] = js.native
  @JSName("editTemplate")
  def editTemplate_Promise(template: Partial[Template]): js.Promise[TemplateBase] = js.native
  def getBounce(id: Double): js.UndefOr[scala.Nothing] = js.native
  def getBounce(id: Double, callback: PostmarkCallback[Bounce]): js.UndefOr[scala.Nothing] = js.native
  def getBounceDump(id: Double): js.UndefOr[scala.Nothing] = js.native
  def getBounceDump(id: Double, callback: PostmarkCallback[BounceDump]): js.UndefOr[scala.Nothing] = js.native
  @JSName("getBounceDump")
  def getBounceDump_Promise(id: Double): js.Promise[BounceDump] = js.native
  def getBounceTags(): js.UndefOr[scala.Nothing] = js.native
  def getBounceTags(callback: PostmarkCallback[js.Array[String]]): js.UndefOr[scala.Nothing] = js.native
  @JSName("getBounceTags")
  def getBounceTags_Promise(): js.Promise[js.Array[String]] = js.native
  @JSName("getBounce")
  def getBounce_Promise(id: Double): js.Promise[Bounce] = js.native
  ...
  def getInboundMessageDetails(id: Double): js.UndefOr[scala.Nothing] = js.native
  def getInboundMessageDetails(id: Double, callback: PostmarkCallback[InboundMessage]): js.UndefOr[scala.Nothing] = js.native
  @JSName("getInboundMessageDetails")
  def getInboundMessageDetails_Promise(id: Double): js.Promise[InboundMessage] = js.native
  ...
  def getMessageOpensForSingleMessage(id: Double, filter: Filter): js.UndefOr[scala.Nothing] = js.native
  def getMessageOpensForSingleMessage(id: Double, filter: Filter, callback: PostmarkCallback[MessageOpensResult]): js.UndefOr[scala.Nothing] = js.native
  @JSName("getMessageOpensForSingleMessage")
  def getMessageOpensForSingleMessage_Promise(id: Double, filter: Filter): js.Promise[MessageOpensResult] = js.native
  ...
  def getOutboundMessageDetails(id: Double): js.UndefOr[scala.Nothing] = js.native
  def getOutboundMessageDetails(id: Double, callback: PostmarkCallback[OutboundMessage]): js.UndefOr[scala.Nothing] = js.native
  @JSName("getOutboundMessageDetails")
  def getOutboundMessageDetails_Promise(id: Double): js.Promise[OutboundMessage] = js.native
  ...
  def getTemplate(id: Double): js.UndefOr[scala.Nothing] = js.native
  def getTemplate(id: Double, callback: PostmarkCallback[Template]): js.UndefOr[scala.Nothing] = js.native
  // templates
  @JSName("getTemplate")
  def getTemplate_Promise(id: Double): js.Promise[Template] = js.native
  ...
  def retryInboundHookForMessage(id: Double): js.UndefOr[scala.Nothing] = js.native
  def retryInboundHookForMessage(id: Double, callback: PostmarkCallback[GenericResult]): js.UndefOr[scala.Nothing] = js.native
  @JSName("retryInboundHookForMessage")
  def retryInboundHookForMessage_Promise(id: Double): js.Promise[GenericResult] = js.native
  ...
  def validateTemplate_T_Object_Promise[T /* <: js.Object */](templateObject: TemplateValidator[T]): js.Promise[TemplateValidationResult[T]] = js.native
}
