...
@JSImport("postmark/dist/client/models", "ServerDeliveryTypes")
@js.native
object ServerDeliveryTypes extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typings.postmark.messageSupportingTypesMod.ServerDeliveryTypes & String] = js.native
