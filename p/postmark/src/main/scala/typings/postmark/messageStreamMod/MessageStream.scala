...
@js.native
trait MessageStream extends js.Object {
...
object MessageStream {
  ...
  @scala.inline
  implicit class MessageStreamOps[Self <: MessageStream] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setArchivedAt(value: String): Self = this.set("ArchivedAt", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteArchivedAt: Self = this.set("ArchivedAt", js.undefined)
