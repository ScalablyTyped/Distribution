...
- postmarkLib.postmarkMod.DomainBase because var conflicts: DKIMVerified, SPFVerified, WeakDKIM. Inlined ID, Name, ReturnPathDomainVerified */ trait Domain extends VerificationDetails {
  var ID: scala.Double
