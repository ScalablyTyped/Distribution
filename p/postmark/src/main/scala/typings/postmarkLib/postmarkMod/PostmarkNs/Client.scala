...
trait Client extends js.Object {
  ...
  def activateBounce_Promise(id: scala.Double): stdLib.Promise[ActivatedBounceResult] = js.native
  def batch(message: js.Array[PostmarkMessage]): stdLib.Promise[js.Array[SendStatus]] = js.native
  ...
  def bypassBlockedInboundMessage_Promise(id: scala.Double): stdLib.Promise[GenericResult] = js.native
  ...
  def createTemplate_Promise(template: stdLib.Partial[Template]): stdLib.Promise[TemplateBase] = js.native
  ...
  def deleteTemplate_Promise(id: scala.Double): stdLib.Promise[GenericResult] = js.native
  ...
  @JSName("editServer")
  def editServer_Promise(server: stdLib.Partial[Server]): stdLib.Promise[Server] = js.native
  ...
  @JSName("editTemplate")
  def editTemplate_Promise(template: stdLib.Partial[Template]): stdLib.Promise[TemplateBase] = js.native
  ...
  def getBounceDump_Promise(id: scala.Double): stdLib.Promise[BounceDump] = js.native
  ...
  def getBounceTags_Promise(): stdLib.Promise[js.Array[java.lang.String]] = js.native
  @JSName("getBounce")
  def getBounce_Promise(id: scala.Double): stdLib.Promise[Bounce] = js.native
  ...
  // bounces
  @JSName("getBounces")
  def getBounces_Promise(filter: BounceFilter): stdLib.Promise[BouncesResult] = js.native
  // stats
  def getDeliveryStatistics(): stdLib.Promise[DeliveryStats] = js.native
  ...
  def getInboundMessageDetails_Promise(id: scala.Double): stdLib.Promise[InboundMessage] = js.native
  ...
  def getInboundMessages_Promise(filter: InboundMessageFilter): stdLib.Promise[InboundMessagesResult] = js.native
  ...
  def getMessageOpensForSingleMessage_Promise(id: scala.Double, filter: Filter): stdLib.Promise[MessageOpensResult] = js.native
  @JSName("getMessageOpens")
  def getMessageOpens_Promise(filter: OpenMessageFilter): stdLib.Promise[MessageOpensResult] = js.native
  ...
  def getOuboundOverview_Promise(filter: BaseFilter): stdLib.Promise[OutboundOverview] = js.native
  ...
  def getOutboundMessageDetails_Promise(id: scala.Double): stdLib.Promise[OutboundMessage] = js.native
  ...
  def getOutboundMessages_Promise(filter: OutboundMessageFilter): stdLib.Promise[OutboundMessagesResult] = js.native
  ...
  // server
  @JSName("getServer")
  def getServer_Promise(): stdLib.Promise[Server] = js.native
  ...
  // templates
  @JSName("getTemplate")
  def getTemplate_Promise(id: scala.Double): stdLib.Promise[Template] = js.native
  ...
  @JSName("getTemplates")
  def getTemplates_Promise(filter: Filter): stdLib.Promise[TemplatesResult] = js.native
  ...
  def retryInboundHookForMessage_Promise(id: scala.Double): stdLib.Promise[GenericResult] = js.native
  def send(message: PostmarkMessage): stdLib.Promise[SendStatus] = js.native
  def send(message: PostmarkMessage, callback: PostmarkCallback[SendStatus]): js.UndefOr[scala.Nothing] = js.native
  def sendEmail(message: PostmarkMessage): stdLib.Promise[SendStatus] = js.native
  def sendEmail(message: PostmarkMessage, callback: PostmarkCallback[SendStatus]): js.UndefOr[scala.Nothing] = js.native
  def sendEmailBatch(message: js.Array[PostmarkMessage]): stdLib.Promise[js.Array[SendStatus]] = js.native
  ...
  def sendEmailWithTemplate(message: PostmarkMessageWithTemplate): stdLib.Promise[SendStatus] = js.native
  ...
  def validateTemplate[T /* <: js.Object */](templateObject: TemplateValidator[T]): stdLib.Promise[TemplateValidationResult[T]] = js.native
