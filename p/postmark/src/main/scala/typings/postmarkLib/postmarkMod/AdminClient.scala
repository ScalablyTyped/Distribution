...
class AdminClient protected () extends js.Object {
  def this(apiKey: java.lang.String, options: stdLib.Partial[Options]) = this()
  ...
  @JSName("deleteDomain")
  def deleteDomain_Promise(id: scala.Double): js.Promise[GenericResult] = js.native
  ...
  def deleteSenderSignature_Promise(id: scala.Double): js.Promise[GenericResult] = js.native
  ...
  @JSName("deleteServer")
  def deleteServer_Promise(id: scala.Double): js.Promise[GenericResult] = js.native
  ...
  @JSName("editDomain")
  def editDomain_Promise(id: scala.Double, options: stdLib.Partial[CreateDomain]): js.Promise[Domain] = js.native
  ...
  def editSenderSignature_Promise(id: scala.Double, options: UpdateSignature): js.Promise[SenderSignature] = js.native
  ...
  @JSName("editServer")
  def editServer_Promise(id: scala.Double, options: stdLib.Partial[CreateServer]): js.Promise[Server] = js.native
  ...
  @JSName("getDomain")
  def getDomain_Promise(id: scala.Double): js.Promise[Domain] = js.native
  ...
  // servers
  @JSName("getServer")
  def getServer_Promise(id: scala.Double): js.Promise[Server] = js.native
  ...
  def requestNewDKIMForSenderSignature_Promise(id: scala.Double): js.Promise[GenericResult] = js.native
  ...
  def resendSenderSignatureConfirmation_Promise(id: scala.Double): js.Promise[GenericResult] = js.native
  ...
  def rotateDKIMForDomain_Promise(id: scala.Double): js.Promise[RotateDKIMResult] = js.native
  ...
  def verifyDomainSPF_Promise(id: scala.Double): js.Promise[SenderSignature] = js.native
  ...
  def verifySenderSignatureSPF_Promise(id: scala.Double): js.Promise[SenderSignature] = js.native
}
