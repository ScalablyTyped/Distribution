package typings.pDashWaterfall.pDashWaterfallMod

import typings.pDashWaterfall.Anon_Default
...
object ^ extends js.Object {
  ...
  // TODO: Remove this for the next major release
  def default(tasks: Iterable[Task[_, _]]): js.Promise[_] = js.native
  def default(tasks: Iterable[Task[_, _]], initialValue: js.Any): js.Promise[_] = js.native
  /**
  	Run promise-returning & async functions in series, each passing its result to the next.
  	@param tasks - Functions are expected to return a value. If a `Promise` is returned, it's awaited before continuing with the next task.
  	@param initialValue - Value to use as `previousValue` in the first task.
