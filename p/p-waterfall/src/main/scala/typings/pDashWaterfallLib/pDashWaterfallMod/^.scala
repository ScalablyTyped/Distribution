...
object ^ extends js.Object {
  ...
  @JSName("default")
  var default_Original: pDashWaterfallLib.Anon_Default = js.native
  def apply(tasks: stdLib.Iterable[Task[_, _]]): js.Promise[_] = js.native
  def apply(tasks: stdLib.Iterable[Task[_, _]], initialValue: js.Any): js.Promise[_] = js.native
  /**
  ...
  // TODO: Remove this for the next major release
  def default(tasks: stdLib.Iterable[Task[_, _]]): js.Promise[_] = js.native
  def default(tasks: stdLib.Iterable[Task[_, _]], initialValue: js.Any): js.Promise[_] = js.native
  /**
  	Run promise-returning & async functions in series, each passing its result to the next.
  	@param tasks - Functions are expected to return a value. If a `Promise` is returned, it's awaited before continuing with the next task.
  	@param initialValue - Value to use as `previousValue` in the first task.
  	...
  	*/
  // TODO: Remove this for the next major release
  def default[ReturnType](tasks: js.Array[InitialTask[ReturnType]]): js.Promise[ReturnType] = js.native
  // TODO: Remove this for the next major release
  def default[ValueType1, ReturnType](tasks: js.Array[Task[ValueType1, ReturnType]], initialValue: ValueType1): js.Promise[ReturnType] = js.native
  // TODO: Remove this for the next major release
  def default[ValueType1, ReturnType](tasks: js.Tuple2[InitialTask[ValueType1], Task[ValueType1, ReturnType]]): js.Promise[ReturnType] = js.native
  // TODO: Remove this for the next major release
