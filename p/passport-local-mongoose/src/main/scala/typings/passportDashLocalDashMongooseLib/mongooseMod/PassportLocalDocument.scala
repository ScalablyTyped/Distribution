...
trait PassportLocalDocument
  ...
  def authenticate(password: java.lang.String): js.Promise[AuthenticationResult] = js.native
  def authenticate(
    password: java.lang.String,
    cb: js.Function3[/* err */ js.Any, /* user */ js.Any, /* error */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  def changePassword(oldPassword: java.lang.String, newPassword: java.lang.String): js.Promise[PassportLocalDocument] = js.native
  def changePassword(
  ...
  def setPassword(password: java.lang.String): js.Promise[PassportLocalDocument] = js.native
