...
version := "4.0.0-dt-20181119Z-b8a4a4"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-080b96",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-fabeac",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-a3bc30",
