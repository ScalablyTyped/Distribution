...
version := "4.0.0-dt-20190322Z-49d5f6"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-4c817a",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-e4baef",
