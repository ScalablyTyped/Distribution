...
version := "4.0.0-dt-20181120Z-20aaec"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180910Z-5a23c0",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180910Z-b008eb",
