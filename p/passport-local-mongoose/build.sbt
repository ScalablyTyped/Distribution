...
version := "4.0.0-dt-20181120Z-05d7f9"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "0.4-dt-20181104Z-175edc",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180910Z-329475",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180910Z-f51ad9",
