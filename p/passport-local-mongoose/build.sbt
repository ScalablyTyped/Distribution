...
version := "4.0.0-dt-20181119Z-a7301b"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-f8d495",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-7369bd",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-e038a0",
