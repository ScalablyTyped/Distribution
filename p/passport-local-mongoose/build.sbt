...
version := "4.0.0-dt-20190322Z-098319"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-ae16e4",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-37034d",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-0a2064",
