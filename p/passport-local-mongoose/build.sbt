...
version := "4.0.0-dt-20181119Z-9cc41f"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-4de52c",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-112aac",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-3057b5",
