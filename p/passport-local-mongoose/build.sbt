...
version := "4.0.0-dt-20190322Z-0d3d5c"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20190524Z-cb513e",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-f8b15f",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-cd795a",
