...
version := "4.0.0-dt-20190322Z-9e6aa2"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-09aa8f",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-796547",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-801dce",
