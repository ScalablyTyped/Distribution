...
version := "4.0.0-dt-20191014Z-f4cd37"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20191119Z-fa5b69",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-4e72c1",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-834fbf",
