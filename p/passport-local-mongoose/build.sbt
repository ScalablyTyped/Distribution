...
version := "4.0.0-dt-20190322Z-1f9821"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-ad36ae",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-fdeed6",
