...
version := "4.0.0-dt-20181119Z-c0193e"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-6f9c7a",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-235576",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-8dc406",
