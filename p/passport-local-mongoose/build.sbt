...
version := "4.0.0-dt-20191014Z-025504"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20190822Z-d30c4c",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-495355",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-537d7a",
