...
version := "4.0.0-dt-20190322Z-beefa5"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-d5477f",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-a64153",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-4e23ee",
