...
version := "4.0.0-dt-20181119Z-9b139c"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-669bf8",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-741872",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-f86205",
