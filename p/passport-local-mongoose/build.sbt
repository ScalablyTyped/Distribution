...
version := "4.0.0-dt-20190322Z-3a459b"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-e52d44",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-4e095d",
