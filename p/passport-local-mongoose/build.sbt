...
version := "4.0.0-dt-20191014Z-a2f5ae"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20191119Z-c941a3",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-22d2cd",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-c3f7c2",
