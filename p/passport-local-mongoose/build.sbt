...
version := "4.0.0-dt-20191014Z-a5c4be"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20191119Z-c9e8ba",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-7e3a3c",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-d12087",
