...
version := "4.0.0-dt-20190322Z-6cbd81"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-2b5f26",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-2122be",
