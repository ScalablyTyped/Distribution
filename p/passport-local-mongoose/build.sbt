...
version := "4.0.0-dt-20191014Z-e028f9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20190822Z-fcbe2a",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-aba525",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-bd006f",
