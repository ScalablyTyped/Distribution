...
version := "4.0.0-dt-20181119Z-e19cf0"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "mongoose" % "5.3.4-dt-20190318Z-8445a2",
  "org.scalablytyped" %%% "node" % "11.11-dt-20190319Z-4635bc",
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-0111e0",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-5104c8",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-99e0aa",
