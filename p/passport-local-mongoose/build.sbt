...
version := "4.0.0-dt-20181119Z-57d4aa"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-a9ec2b",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-8e7e18",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-d2d582",
