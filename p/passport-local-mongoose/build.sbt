...
version := "4.0.0-dt-20181120Z-e930bb"
scalaVersion := "2.12.7"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "runtime" % "1.0.0-M1",
  "com.scalablytyped" %%% "body-parser" % "1.17-dt-20180910Z-6ca2c5",
  "com.scalablytyped" %%% "bson" % "1.0.6-dt-20180910Z-520075",
  ...
  "com.scalablytyped" %%% "mongodb" % "v3.1-dt-20181028Z-f23994",
  "com.scalablytyped" %%% "mongoose" % "5.3.4-dt-20181120Z-2ae889",
  "com.scalablytyped" %%% "node" % "10.12-dt-20181116Z-cadd20",
  "com.scalablytyped" %%% "passport" % "0.4-dt-20181104Z-1d7d4a",
  "com.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180910Z-bcf424",
  "com.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180910Z-6450bf",
