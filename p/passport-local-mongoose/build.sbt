...
version := "4.0.0-dt-20181119Z-d3cee5"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-db778e",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-e1ea0a",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-f5ec68",
