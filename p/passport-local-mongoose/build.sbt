...
version := "4.0.0-dt-20181119Z-c92810"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-64c111",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-f5ecc6",
