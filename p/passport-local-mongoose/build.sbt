...
version := "4.0.0-dt-20181119Z-df747e"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-c797e9",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-3c6080",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-1e885a",
