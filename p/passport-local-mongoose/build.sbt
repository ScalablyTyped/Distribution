...
version := "4.0.0-dt-20191014Z-dfe3ca"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20191119Z-abf2b1",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-2a6b75",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-12a43a",
