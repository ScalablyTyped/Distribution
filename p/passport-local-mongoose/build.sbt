...
version := "4.0.0-dt-20191014Z-526861"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20190822Z-6be147",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-124a2f",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-71b34b",
