...
version := "4.0.0-dt-20191014Z-d0998b"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20191119Z-989f5e",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-4a3798",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-305ecf",
