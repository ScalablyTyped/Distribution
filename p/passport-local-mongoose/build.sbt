...
version := "4.0.0-dt-20190322Z-011384"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-050947",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-eb206b",
