...
version := "4.0.0-dt-20191014Z-036f7f"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20190822Z-64d690",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-928fed",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-c122ac",
