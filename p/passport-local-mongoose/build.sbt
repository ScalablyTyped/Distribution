...
version := "4.0.0-dt-20181119Z-d4bc1f"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-1c05ca",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-2b3f98",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-fa828a",
