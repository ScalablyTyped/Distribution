...
version := "4.0.0-dt-20181120Z-2b4d20"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180910Z-c574bd",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180910Z-d8fc3d",
