...
version := "4.0.0-dt-20190322Z-0fcd21"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-b04d56",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-ca81b8",
