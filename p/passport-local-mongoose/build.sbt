...
version := "4.0.0-dt-20190322Z-da4918"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20190524Z-5ee97f",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-65ba58",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-2898df",
