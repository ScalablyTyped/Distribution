...
version := "4.0.0-dt-20191014Z-d2103e"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20191119Z-343994",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-f8f265",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-a9d71f",
