...
version := "4.0.0-dt-20190322Z-111658"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-c5d8de",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-5fb386",
