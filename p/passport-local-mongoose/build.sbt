...
version := "4.0.0-dt-20190322Z-2882c0"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20190322Z-a27f44",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20190322Z-a87447",
