...
version := "4.0.0-dt-20181119Z-eef496"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "passport" % "1.0-dt-20181215Z-6a2366",
  "org.scalablytyped" %%% "passport-local" % "1.0.0-dt-20180328Z-a2953c",
  "org.scalablytyped" %%% "passport-strategy" % "v0.2.0-dt-20180815Z-2fbe8c",
