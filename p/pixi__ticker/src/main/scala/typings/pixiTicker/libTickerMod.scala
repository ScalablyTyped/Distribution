...
import typings.pixiTicker.libConstMod.UPDATE_PRIORITY
...
object libTickerMod {
  ...
  @JSImport("@pixi/ticker/lib/Ticker", "Ticker")
  @js.native
  ...
  object Ticker {
    ...
    @JSImport("@pixi/ticker/lib/Ticker", "Ticker._shared")
    @js.native
    ...
    @JSImport("@pixi/ticker/lib/Ticker", "Ticker._system")
    @js.native
