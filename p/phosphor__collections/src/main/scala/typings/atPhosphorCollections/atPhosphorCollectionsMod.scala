...
import typings.atPhosphorCollections.libLinkedlistMod.LinkedList.INode
...
@js.native
object atPhosphorCollectionsMod extends js.Object {
  @js.native
  ...
  /**
    ...
    */
  class LinkedList[T] ()
    extends typings.atPhosphorCollections.libLinkedlistMod.LinkedList[T]
  ...
  object BPlusTree extends js.Object {
    /**
      ...
      * `O(n log32 n)`
      */
    def from[T](items: IterableOrArrayLike[T], cmp: js.Function2[/* a */ T, /* b */ T, Double]): typings.atPhosphorCollections.libBplustreeMod.BPlusTree[T] = js.native
  }
  ...
  object LinkedList extends js.Object {
    ...
    class ForwardNodeIterator[T] ()
      extends typings.atPhosphorCollections.libLinkedlistMod.LinkedList.ForwardNodeIterator[T] {
      /**
    ...
    class ForwardValueIterator[T] ()
      extends typings.atPhosphorCollections.libLinkedlistMod.LinkedList.ForwardValueIterator[T] {
      /**
    ...
    class RetroNodeIterator[T] ()
      extends typings.atPhosphorCollections.libLinkedlistMod.LinkedList.RetroNodeIterator[T] {
      /**
    ...
    class RetroValueIterator[T] ()
      extends typings.atPhosphorCollections.libLinkedlistMod.LinkedList.RetroValueIterator[T] {
      /**
