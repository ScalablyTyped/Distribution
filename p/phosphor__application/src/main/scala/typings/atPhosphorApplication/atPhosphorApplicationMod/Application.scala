package typings.atPhosphorApplication.atPhosphorApplicationMod

import typings.atPhosphorApplication.atPhosphorApplicationMod.ApplicationNs.IOptions
import typings.atPhosphorApplication.atPhosphorApplicationMod.ApplicationNs.IStartOptions
import typings.atPhosphorCommands.atPhosphorCommandsMod.CommandRegistry
import typings.atPhosphorCoreutils.atPhosphorCoreutilsMod.Token
import typings.atPhosphorWidgets.atPhosphorWidgetsMod.ContextMenu
...
@js.native
class Application[T /* <: Widget */] protected () extends js.Object {
  /**
