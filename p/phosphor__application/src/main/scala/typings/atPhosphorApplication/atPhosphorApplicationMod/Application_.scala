...
import typings.atPhosphorApplication.atPhosphorApplicationMod.Application.IOptions
import typings.atPhosphorApplication.atPhosphorApplicationMod.Application.IStartOptions
