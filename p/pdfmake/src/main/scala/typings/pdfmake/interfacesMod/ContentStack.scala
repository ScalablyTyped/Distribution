...
/* Inlined parent pdfmake.pdfmake/interfaces.ForbidOtherElementProperties<'stack'> */
trait ContentStack
  extends StObject
     with _Content {
...
object ContentStack {
  ...
  extension [Self <: ContentStack](x: Self) {
    ...
    inline def setStackVarargs(value: Content*): Self = StObject.set(x, "stack", js.Array(value*))
