...
/* Inlined parent pdfmake.pdfmake/interfaces.ForbidOtherElementProperties<'columns'> */
...
object ContentColumns {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ContentColumns] (val x: Self) extends AnyVal {
