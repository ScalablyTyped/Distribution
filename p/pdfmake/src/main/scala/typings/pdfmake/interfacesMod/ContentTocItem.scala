...
object ContentTocItem {
  ...
  def apply(
    ...
    tocItem: Boolean | String | js.Array[String],
    ...
    tocMargin: Margins = null,
    tocNumberStyle: String | js.Array[String] | Style = null,
    tocStyle: String | js.Array[String] | Style = null
  ): ContentTocItem = {
    ...
    if (tocMargin != null) __obj.updateDynamic("tocMargin")(tocMargin.asInstanceOf[js.Any])
    if (tocNumberStyle != null) __obj.updateDynamic("tocNumberStyle")(tocNumberStyle.asInstanceOf[js.Any])
    if (tocStyle != null) __obj.updateDynamic("tocStyle")(tocStyle.asInstanceOf[js.Any])
