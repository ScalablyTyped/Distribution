...
trait ContentTocItem
  ...
  /**
    ...
    * table of contents.
    */
  var text: String | ContentTocItem | (js.Array[String | ContentTocItem])
  ...
  /**
    ...
    *   without an `id`)
    */
  var tocItem: Boolean | String | (js.Array[String | Boolean])
  ...
  /**
    ...
    */
  var tocNumberStyle: js.UndefOr[StyleReference] = js.undefined
  
  /**
    * Style or style reference that is applied to the reference for this element
    * in the table of contents.
    */
  var tocStyle: js.UndefOr[StyleReference] = js.undefined
...
object ContentTocItem {
  ...
  inline def apply(
    text: String | ContentTocItem | (js.Array[String | ContentTocItem]),
    tocItem: Boolean | String | (js.Array[String | Boolean])
  ): ContentTocItem = {
  ...
  extension [Self <: ContentTocItem](x: Self) {
    ...
    inline def setText(value: String | ContentTocItem | (js.Array[String | ContentTocItem])): Self = StObject.set(x, "text", value.asInstanceOf[js.Any])
    
    inline def setTextVarargs(value: (String | ContentTocItem)*): Self = StObject.set(x, "text", js.Array(value*))
    
    inline def setTocItem(value: Boolean | String | (js.Array[String | Boolean])): Self = StObject.set(x, "tocItem", value.asInstanceOf[js.Any])
    
    inline def setTocItemVarargs(value: (String | Boolean)*): Self = StObject.set(x, "tocItem", js.Array(value*))
    ...
    inline def setTocNumberStyle(value: StyleReference): Self = StObject.set(x, "tocNumberStyle", value.asInstanceOf[js.Any])
    
    inline def setTocNumberStyleUndefined: Self = StObject.set(x, "tocNumberStyle", js.undefined)
    
    inline def setTocNumberStyleVarargs(value: (String | Style)*): Self = StObject.set(x, "tocNumberStyle", js.Array(value*))
    
    inline def setTocStyle(value: StyleReference): Self = StObject.set(x, "tocStyle", value.asInstanceOf[js.Any])
    
    inline def setTocStyleUndefined: Self = StObject.set(x, "tocStyle", js.undefined)
    
    inline def setTocStyleVarargs(value: (String | Style)*): Self = StObject.set(x, "tocStyle", js.Array(value*))
