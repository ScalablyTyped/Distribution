...
object GlobalMixins {
  ...
  /* Inlined parent std.Partial<@pixi/text-bitmap.GlobalMixins.IBitmapFontResourceMetadata> */
  ...
  // eslint-disable-next-line @typescript-eslint/no-empty-interface
  /* Inlined parent std.Partial<@pixi/text-bitmap.GlobalMixins.IBitmapFontResource> */
