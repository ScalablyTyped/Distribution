...
object DirectEditorProps {
  ...
  @scala.inline
  implicit class DirectEditorPropsOps[Self <: DirectEditorProps[_], /* <: typings.prosemirrorModel.mod.Schema[_, _] */ S] (val x: Self with DirectEditorProps[S]) extends AnyVal {
    @scala.inline
