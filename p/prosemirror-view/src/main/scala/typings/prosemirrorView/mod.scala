...
object mod {
  ...
  */
  ...
  open class EditorView protected () extends StObject {
    ...
    {[ event in keyof prosemirror-view.prosemirror-view.DOMEventMap ]:? (this : any, view : this, event : prosemirror-view.prosemirror-view.DOMEventMap[event]): boolean | void}
      */ typings.prosemirrorView.prosemirrorViewStrings.EditorView & TopLevel[DOMEventMap]
          ]
        ]
      ] = js.native
    /**
  ...
  */
  trait EditorProps[P] extends StObject {
    ...
    var handleDOMEvents: js.UndefOr[
        /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ event in keyof prosemirror-view.prosemirror-view.DOMEventMap ]:? (this : P, view : prosemirror-view.prosemirror-view.EditorView, event : prosemirror-view.prosemirror-view.DOMEventMap[event]): boolean | void}
      */ typings.prosemirrorView.prosemirrorViewStrings.EditorProps & TopLevel[DOMEventMap]
      ] = js.undefined
