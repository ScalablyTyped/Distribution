...
import typings.prosemirrorDashView.Anon_Bottom
import typings.prosemirrorDashView.Anon_Inside
import typings.prosemirrorDashView.Anon_Left
import typings.prosemirrorDashView.Anon_Mount
import typings.prosemirrorDashView.Anon_Move
import typings.prosemirrorDashView.Anon_Node
import typings.prosemirrorDashView.prosemirrorDashViewStrings.backward
import typings.prosemirrorDashView.prosemirrorDashViewStrings.down
import typings.prosemirrorDashView.prosemirrorDashViewStrings.forward
import typings.prosemirrorDashView.prosemirrorDashViewStrings.left
import typings.prosemirrorDashView.prosemirrorDashViewStrings.right
import typings.prosemirrorDashView.prosemirrorDashViewStrings.up
...
class EditorView[S /* <: Schema[_, _] */] protected () extends js.Object {
  ...
  def this(place: Anon_Mount, props: DirectEditorProps[S]) = this()
  /**
  ...
  /**
    ...
    */
  def coordsAtPos(pos: Double): Anon_Bottom = js.native
  /**
  ...
  /**
    ...
    * necessary).
    */
  def domAtPos(pos: Double): Anon_Node = js.native
  ...
  /**
    ...
    */
  def posAtCoords(coords: Anon_Left): js.UndefOr[Anon_Inside | Null] = js.native
  /**
