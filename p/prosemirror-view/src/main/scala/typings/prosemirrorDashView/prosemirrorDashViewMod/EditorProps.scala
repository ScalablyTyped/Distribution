...
trait EditorProps[S /* <: Schema[_, _] */] extends js.Object {
  ...
  var handlePaste: js.UndefOr[
    (js.Function3[/* view */ EditorView[S], /* event */ Event, /* slice */ Slice[S], Boolean]) | Null
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var scrollMargin: js.UndefOr[Double | Anon_BottomLeft | Null] = js.undefined
  /**
    * Determines the distance (in pixels) between the cursor and the
    * end of the visible viewport at which point, when scrolling the
    * cursor into view, scrolling takes place. Defaults to 0.
    */
  var scrollThreshold: js.UndefOr[Double | Anon_BottomLeft | Null] = js.undefined
  /**
