...
import typings.prosemirrorDashModel.prosemirrorDashModelMod.DOMParser
import typings.prosemirrorDashModel.prosemirrorDashModelMod.DOMSerializer
...
import typings.prosemirrorDashView.Anon_BottomLeft
...
object DirectEditorProps {
  ...
  def apply[S /* <: Schema[_, _] */](
    ...
    scrollMargin: Double | Anon_BottomLeft = null,
    scrollThreshold: Double | Anon_BottomLeft = null,
