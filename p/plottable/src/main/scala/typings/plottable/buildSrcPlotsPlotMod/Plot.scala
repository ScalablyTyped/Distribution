package typings.plottable.buildSrcPlotsPlotMod
...
class Plot () extends Component {
  ...
  /**
    ...
    */
  /* protected */ def _createNodesForDataset(dataset: Dataset): typings.plottable.buildSrcDrawersMod.ProxyDrawer = js.native
  ...
  /* protected */ def _getDataToDraw(): typings.plottable.buildSrcUtilsMod.Map[Dataset, js.Array[_]] = js.native
  /**
