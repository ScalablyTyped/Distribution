package typings.plottable.buildSrcDispatchersMouseDispatcherMod
...
object Mouse extends js.Object {
  ...
  /**
    ...
    */
  def getDispatcher(component: Component): typings.plottable.buildSrcDispatchersMod.Mouse = js.native
}
