...
object buildSrcUtilsMod {
  ...
  open class Bucket protected ()
    extends typings.plottable.buildSrcUtilsBucketMod.Bucket {
  ...
  open class EntityStore[T /* <: IPositionedEntity */] ()
    extends typings.plottable.buildSrcUtilsEntityStoreMod.EntityStore[T]
  
  @JSImport("plottable/build/src/utils", "Map")
  @js.native
  open class Map[K, V] ()
    extends typings.plottable.buildSrcUtilsMapMod.Map[K, V]
  ...
  @js.native
  open class Set[T] ()
    extends typings.plottable.buildSrcUtilsSetMod.Set[T]
  ...
  inline def getTranslator(component: Component): typings.plottable.buildSrcUtilsTransformAwareTranslatorMod.Translator = ^.asInstanceOf[js.Dynamic].applyDynamic("getTranslator")(component.asInstanceOf[js.Any]).asInstanceOf[typings.plottable.buildSrcUtilsTransformAwareTranslatorMod.Translator]
}
