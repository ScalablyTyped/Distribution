package typings.plottable.buildSrcPlotsBarPlotMod

import typings.plottable.Anon_HeightWidthX
...
class Bar[X, Y] () extends XYPlot[X, Y] {
  ...
  /**
    ...
    * bar.
    */
  /* protected */ def _pixelBounds(datum: js.Any, index: Double, dataset: Dataset): Anon_HeightWidthX = js.native
