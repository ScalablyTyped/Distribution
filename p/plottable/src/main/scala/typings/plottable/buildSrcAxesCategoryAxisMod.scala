...
object buildSrcAxesCategoryAxisMod {
  ...
  open class Category protected () extends Axis[String] {
    ...
    def getDownsampleInfo(scale: typings.plottable.buildSrcScalesMod.Category): IDownsampleInfo = js.native
    def getDownsampleInfo(scale: typings.plottable.buildSrcScalesMod.Category, domain: js.Array[String]): IDownsampleInfo = js.native
