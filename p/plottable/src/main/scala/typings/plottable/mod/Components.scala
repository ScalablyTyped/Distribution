...
object Components {
  ...
  class Gridlines ()
    ...
    def this(xScale: typings.plottable.scaleMod.Scale[_, _]) = this()
    def this(xScale: Null, yScale: typings.plottable.scaleMod.Scale[_, _]) = this()
    def this(xScale: typings.plottable.scaleMod.Scale[_, _], yScale: typings.plottable.scaleMod.Scale[_, _]) = this()
  }
