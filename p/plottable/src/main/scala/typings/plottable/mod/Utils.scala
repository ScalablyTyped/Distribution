...
object Utils {
  ...
  object Translator {
    ...
    /**
      ...
      */
    @scala.inline
    def isEventInside(component: typings.plottable.componentMod.Component, e: Event): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isEventInside")(component.asInstanceOf[js.Any], e.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  }
  ...
  @scala.inline
  def getTranslator(component: typings.plottable.componentMod.Component): typings.plottable.transformAwareTranslatorMod.Translator = ^.asInstanceOf[js.Dynamic].applyDynamic("getTranslator")(component.asInstanceOf[js.Any]).asInstanceOf[typings.plottable.transformAwareTranslatorMod.Translator]
}
