...
import typings.plottable.Anon_ValueOf
...
class SelectionBoxLayer () extends Component {
  ...
  /* protected */ def _setXExtent(xExtent: js.Array[Double | Anon_ValueOf]): Unit = js.native
  /* protected */ def _setYExtent(yExtent: js.Array[Double | Anon_ValueOf]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def xExtent(): js.Array[Double | Anon_ValueOf] = js.native
  /**
    * Sets the data values backing the left and right edges of the box.
    */
  def xExtent(xExtent: js.Array[Double | Anon_ValueOf]): this.type = js.native
  /**
    * Gets the x scale for this SelectionBoxLayer.
    */
  def xScale(): QuantitativeScale[Double | Anon_ValueOf] = js.native
  /**
    * Sets the x scale for this SelectionBoxLayer.
    *
    * @returns {SelectionBoxLayer} The calling SelectionBoxLayer.
    */
  def xScale(xScale: QuantitativeScale[Double | Anon_ValueOf]): this.type = js.native
  /**
    * Gets the data values backing the top and bottom edges of the box.
    *
    * Returns an undefined array if the edges are not backed by a scale.
    */
  def yExtent(): js.Array[Double | Anon_ValueOf] = js.native
  /**
    * Sets the data values backing the top and bottom edges of the box.
    */
  def yExtent(yExtent: js.Array[Double | Anon_ValueOf]): this.type = js.native
  /**
    * Gets the y scale for this SelectionBoxLayer.
    */
  def yScale(): QuantitativeScale[Double | Anon_ValueOf] = js.native
  /**
    * Sets the y scale for this SelectionBoxLayer.
    *
    * @returns {SelectionBoxLayer} The calling SelectionBoxLayer.
    */
  def yScale(yScale: QuantitativeScale[Double | Anon_ValueOf]): this.type = js.native
}
