package typings.plottable.buildSrcComponentsComponentMod

import typings.d3DashSelection.d3DashSelectionMod.Selection
import typings.plottable.Anon_Height
...
class Component () extends js.Object {
  ...
  /* protected */ def _sizeFromOffer(availableWidth: Double, availableHeight: Double): Anon_Height = js.native
  /**
  ...
  /**
    ...
    * @returns {Component} The calling Component.
    */
  def anchor(selection: Selection[HTMLElement, _, _, _]): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def element(): Selection[HTMLElement, _, _, _] = js.native
  /**
  ...
  def renderTo(element: Selection[HTMLElement, _, _, _]): this.type = js.native
