...
@js.native
object buildSrcDrawersMod extends js.Object {
  @js.native
  class ArcOutlineSVGDrawer ()
    extends typings.plottable.buildSrcDrawersArcOutlineDrawerMod.ArcOutlineSVGDrawer
  
  @js.native
  class ArcSVGDrawer ()
    extends typings.plottable.buildSrcDrawersArcDrawerMod.ArcSVGDrawer
  
  @js.native
  class AreaSVGDrawer ()
    extends typings.plottable.buildSrcDrawersAreaDrawerMod.AreaSVGDrawer
  ...
  @js.native
  class LineSVGDrawer ()
    extends typings.plottable.buildSrcDrawersLineDrawerMod.LineSVGDrawer
  ...
  class RectangleCanvasDrawer protected ()
    extends typings.plottable.buildSrcDrawersRectangleDrawerMod.RectangleCanvasDrawer {
    def this(ctx: CanvasRenderingContext2D) = this()
  }
  
  @js.native
  class RectangleSVGDrawer ()
    extends typings.plottable.buildSrcDrawersRectangleDrawerMod.RectangleSVGDrawer {
    def this(_rootClassName: String) = this()
  }
  
  @js.native
  class SVGDrawer protected ()
    extends typings.plottable.buildSrcDrawersSvgDrawerMod.SVGDrawer {
    /**
  ...
  class SegmentSVGDrawer ()
    extends typings.plottable.buildSrcDrawersSegmentDrawerMod.SegmentSVGDrawer
  
  @js.native
  class SymbolSVGDrawer ()
    extends typings.plottable.buildSrcDrawersSymbolDrawerMod.SymbolSVGDrawer
