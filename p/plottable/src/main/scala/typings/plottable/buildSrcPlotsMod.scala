...
object buildSrcPlotsMod {
  ...
  /**
    ...
    */
  open class Area[X] ()
    extends typings.plottable.buildSrcPlotsAreaPlotMod.Area[X]
  /* static members */
  object Area {
  ...
  /**
    ...
    */
  open class Bar[X, Y] ()
    extends typings.plottable.buildSrcPlotsBarPlotMod.Bar[X, Y] {
  ...
  /**
    ...
    */
  open class Line[X] ()
    extends typings.plottable.buildSrcPlotsLinePlotMod.Line[X]
  ...
  open class Scatter[X, Y] ()
    extends typings.plottable.buildSrcPlotsScatterPlotMod.Scatter[X, Y]
  /* static members */
  object Scatter {
  ...
  open class Segment[X, Y] ()
    extends typings.plottable.buildSrcPlotsSegmentPlotMod.Segment[X, Y]
  /* static members */
  object Segment {
  ...
  open class Waterfall[X, Y] ()
    extends typings.plottable.buildSrcPlotsWaterfallPlotMod.Waterfall[X, Y]
  /* static members */
  object Waterfall {
