...
object buildSrcDispatchersMouseDispatcherMod {
  ...
  object Mouse {
    ...
    /**
      ...
      */
    inline def getDispatcher(component: Component): typings.plottable.buildSrcDispatchersMod.Mouse = ^.asInstanceOf[js.Dynamic].applyDynamic("getDispatcher")(component.asInstanceOf[js.Any]).asInstanceOf[typings.plottable.buildSrcDispatchersMod.Mouse]
  }
