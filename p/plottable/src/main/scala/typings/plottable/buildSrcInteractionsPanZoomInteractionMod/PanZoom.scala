package typings.plottable.buildSrcInteractionsPanZoomInteractionMod

import typings.plottable.Anon_CenterValue
...
class PanZoom () extends Interaction {
  ...
  /**
    ...
    * values. Default true.
    */
  def zoom(zoomAmount: Double): Anon_CenterValue = js.native
  def zoom(zoomAmount: Double, centerValue: Point): Anon_CenterValue = js.native
  def zoom(zoomAmount: Double, centerValue: Point, constrained: Boolean): Anon_CenterValue = js.native
}
