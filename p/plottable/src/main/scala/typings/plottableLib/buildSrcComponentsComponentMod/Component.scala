package typings
package plottableLib.buildSrcComponentsComponentMod
...
class Component () extends js.Object {
  ...
  var _isAnchored: scala.Boolean = js.native
  var _isSetup: scala.Boolean = js.native
  ...
  /**
    ...
    */
  var _overflowHidden: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def addClass(cssClass: java.lang.String): this.type = js.native
  /**
    ...
    * @returns {Component} The calling Component.
    */
  def anchor(selection: d3DashSelectionLib.d3DashSelectionMod.Selection[stdLib.HTMLElement, _, _, _]): this.type = js.native
  /**
    ...
    */
  def background(): plottableLib.buildSrcCoreInterfacesMod.SimpleSelection[scala.Unit] = js.native
  /**
    ...
    */
  def bounds(): plottableLib.buildSrcCoreInterfacesMod.Bounds = js.native
  /**
  ...
  def computeLayout(origin: plottableLib.buildSrcCoreInterfacesMod.Point): this.type = js.native
  def computeLayout(origin: plottableLib.buildSrcCoreInterfacesMod.Point, availableWidth: scala.Double): this.type = js.native
  def computeLayout(
    origin: plottableLib.buildSrcCoreInterfacesMod.Point,
  ...
  /**
    ...
    */
  def content(): plottableLib.buildSrcCoreInterfacesMod.SimpleSelection[scala.Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def element(): d3DashSelectionLib.d3DashSelectionMod.Selection[stdLib.HTMLElement, _, _, _] = js.native
  /**
    * Checks if the Component has a fixed height or if it grows to fill available space.
    * Returns false by default on the base Component class.
    */
  def fixedHeight(): scala.Boolean = js.native
  /**
    * Checks if the Component has a fixed width or if it grows to fill available space.
    * Returns false by default on the base Component class.
    */
  def fixedWidth(): scala.Boolean = js.native
  /**
    ...
    * @return {d3.Selection}
    */
  def foreground(): plottableLib.buildSrcCoreInterfacesMod.SimpleSelection[scala.Unit] = js.native
  /**
    * Checks if the Component has a given CSS class.
    *
    * @param {string} cssClass The CSS class to check for.
    */
  def hasClass(cssClass: java.lang.String): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @return {Point}
    */
  def origin(): plottableLib.buildSrcCoreInterfacesMod.Point = js.native
  /**
    * Gets the origin of the Component relative to the root Component.
    *
    * @return {Point}
    */
  def originToRoot(): plottableLib.buildSrcCoreInterfacesMod.Point = js.native
  /**
    * Gets the parent ComponentContainer for this Component.
    */
  def parent(): plottableLib.buildSrcComponentsComponentContainerMod.ComponentContainer = js.native
  /**
    ...
    */
  def parent(parent: plottableLib.buildSrcComponentsComponentContainerMod.ComponentContainer): this.type = js.native
  /**
  ...
  /**
    ...
    * @returns {Component} The calling Component.
    */
  def removeClass(cssClass: java.lang.String): this.type = js.native
  /**
  ...
  def renderTo(element: d3DashSelectionLib.d3DashSelectionMod.Selection[stdLib.HTMLElement, _, _, _]): this.type = js.native
  /**
    ...
    * @returns {Component} The calling Component.
    */
  def renderTo(element: java.lang.String): this.type = js.native
  def renderTo(element: stdLib.HTMLElement): this.type = js.native
  /**
    ...
    */
  def requestedSpace(availableWidth: scala.Double, availableHeight: scala.Double): plottableLib.buildSrcCoreInterfacesMod.SpaceRequest = js.native
  /**
  ...
  /**
    ...
    */
  def rootElement(): plottableLib.buildSrcCoreInterfacesMod.SimpleSelection[scala.Unit] = js.native
  /**
    ...
    */
  def setBounds(width: scala.Double, height: scala.Double): this.type = js.native
  def setBounds(width: scala.Double, height: scala.Double, originX: scala.Double): this.type = js.native
  def setBounds(width: scala.Double, height: scala.Double, originX: scala.Double, originY: scala.Double): this.type = js.native
  /**
