package typings
package plottableLib.buildSrcComponentsGuideLineLayerMod
...
class GuideLineLayer[D] protected ()
  ...
  /* protected */ def _isVertical(): scala.Boolean = js.native
  /* protected */ def _setPixelPositionWithoutChangingMode(pixelPosition: scala.Double): scala.Unit = js.native
  ...
  /**
       ...
       * @return {number}
       */
  def pixelPosition(): scala.Double = js.native
  /**
       ...
       */
  def pixelPosition(pixelPosition: scala.Double): this.type = js.native
  /**
       * Gets the QuantitativeScale on the GuideLineLayer.
       *
       * @return {QuantitativeScale<D>}
       */
  def scale(): plottableLib.buildSrcScalesQuantitativeScaleMod.QuantitativeScale[D] = js.native
  /**
       ...
       * @return {GuideLineLayer<D>} The calling GuideLineLayer.
       */
  def scale(scale: plottableLib.buildSrcScalesQuantitativeScaleMod.QuantitativeScale[D]): this.type = js.native
  /**
