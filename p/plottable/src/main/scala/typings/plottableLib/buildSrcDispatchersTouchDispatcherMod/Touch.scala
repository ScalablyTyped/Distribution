package typings
package plottableLib.buildSrcDispatchersTouchDispatcherMod
...
class Touch protected ()
  ...
  def eventInside(component: plottableLib.buildSrcComponentsComponentMod.Component, event: stdLib.TouchEvent): scala.Boolean = js.native
  /**
