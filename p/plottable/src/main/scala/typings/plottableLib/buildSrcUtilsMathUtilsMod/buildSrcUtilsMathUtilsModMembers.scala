...
@js.native
object buildSrcUtilsMathUtilsModMembers extends js.Object {
  def applyTransform(a: ICssTransformMatrix, p: plottableLib.buildSrcCoreInterfacesMod.Point): plottableLib.buildSrcCoreInterfacesMod.Point = js.native
  ...
  def getCumulativeTransform(element: stdLib.Element): ICssTransformMatrix = js.native
