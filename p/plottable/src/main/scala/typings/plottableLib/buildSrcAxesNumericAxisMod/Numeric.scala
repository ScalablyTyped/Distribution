package typings
package plottableLib.buildSrcAxesNumericAxisMod
...
class Numeric protected ()
  extends plottableLib.buildSrcAxesAxisMod.Axis[scala.Double] {
  /**
  ...
  /**
       ...
       */
  def tickLabelPosition(): java.lang.String = js.native
  /**
       ...
       */
  def tickLabelPosition(position: java.lang.String): this.type = js.native
  /**
       * Gets the approximate text width setting.
       *
       * @returns {boolean} The current text width approximation setting.
       */
  def usesTextWidthApproximation(): scala.Boolean = js.native
  /**
       ...
       */
  def usesTextWidthApproximation(enable: scala.Boolean): this.type = js.native
}
