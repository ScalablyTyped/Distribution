...
name := "poi"
version := "12.5-dt-20190414Z-6592ff"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "html-webpack-plugin" % "3.2-dt-20190712Z-a3899b",
  ...
  "org.scalablytyped" %%% "webpack-chain" % "6.0.0-dfcb04",
  "org.scalablytyped" %%% "webpack-dev-server" % "3.1-dt-20190710Z-fa1746",
