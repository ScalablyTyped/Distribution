...
name := "poi"
version := "12.5-dt-20190414Z-c7f6ea"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "clean-css" % "4.2-dt-20190130Z-73a986",
  ...
  "org.scalablytyped" %%% "html-minifier" % "3.5-dt-20190212Z-40148f",
  "org.scalablytyped" %%% "html-webpack-plugin" % "3.2-dt-20190712Z-6200e8",
  ...
  "org.scalablytyped" %%% "webpack-chain" % "6.0.0-6377f7",
  "org.scalablytyped" %%% "webpack-dev-server" % "3.4-dt-20191022Z-e6081b",
