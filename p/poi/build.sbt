...
name := "poi"
version := "12.5-dt-20190414Z-0dc43c"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "clean-css" % "4.2-dt-20190130Z-5edca5",
  ...
  "org.scalablytyped" %%% "html-minifier" % "3.5-dt-20190212Z-c1dfdf",
  "org.scalablytyped" %%% "html-webpack-plugin" % "3.2-dt-20190712Z-a5d077",
  ...
  "org.scalablytyped" %%% "webpack-chain" % "6.3.0-7769a5",
  "org.scalablytyped" %%% "webpack-dev-server" % "3.9-dt-20191127Z-c5c358",
