...
name := "poi"
version := "12.5-dt-20190414Z-80f0bc"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "html-webpack-plugin" % "3.2-dt-20190712Z-202b5d",
  ...
  "org.scalablytyped" %%% "webpack-chain" % "6.0.0-af1e4c",
  "org.scalablytyped" %%% "webpack-dev-server" % "3.1-dt-20190710Z-5e80de",
