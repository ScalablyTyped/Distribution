...
name := "poi"
version := "12.5-dt-20190414Z-64731b"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "html-webpack-plugin" % "3.2-dt-20190712Z-6744ef",
  ...
  "org.scalablytyped" %%% "webpack-chain" % "6.0.0-f1194e",
  "org.scalablytyped" %%% "webpack-dev-server" % "3.4-dt-20191022Z-4bb54d",
