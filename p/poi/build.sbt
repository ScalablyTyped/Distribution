...
name := "poi"
version := "12.5-dt-20190414Z-0f81cf"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "html-webpack-plugin" % "3.2-dt-20190712Z-beaffb",
  ...
  "org.scalablytyped" %%% "webpack-chain" % "6.0.0-e90e37",
  "org.scalablytyped" %%% "webpack-dev-server" % "3.1-dt-20190710Z-76e0c0",
