...
name := "poi"
version := "12.5-dt-20190414Z-40f254"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "clean-css" % "4.2-dt-20190130Z-7ae9d8",
  ...
  "org.scalablytyped" %%% "html-minifier" % "3.5-dt-20190212Z-6b9021",
  "org.scalablytyped" %%% "html-webpack-plugin" % "3.2-dt-20190712Z-543e0e",
  ...
  "org.scalablytyped" %%% "webpack-chain" % "6.0.0-137b2b",
  "org.scalablytyped" %%% "webpack-dev-server" % "3.1-dt-20190710Z-0d1dd2",
