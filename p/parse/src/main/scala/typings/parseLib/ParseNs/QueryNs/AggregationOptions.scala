...
trait AggregationOptions extends js.Object {
  ...
  var `match`: js.UndefOr[ScalablyTyped.runtime.StringDictionary[js.Any]] = js.undefined
  var project: js.UndefOr[ScalablyTyped.runtime.StringDictionary[js.Any]] = js.undefined
  var skip: js.UndefOr[scala.Double] = js.undefined
  // Sort documentation https://docs.mongodb.com/v3.2/reference/operator/aggregation/sort/#pipe._S_sort
  var sort: js.UndefOr[
    ScalablyTyped.runtime.StringDictionary[parseLib.parseLibNumbers.`1` | parseLib.parseLibNumbers.`-1`]
  ] = js.undefined
}
