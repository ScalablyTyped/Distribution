...
trait User[T /* <: Attributes */] extends Object[T] {
  ...
  def _linkWith(provider: String, options: typings.parse.anon.AuthData): js.Promise[this.type] = js.native
  def _linkWith(provider: String, options: typings.parse.anon.AuthData, saveOpts: FullOptions): js.Promise[this.type] = js.native
  def _linkWith(provider: AuthProvider, options: typings.parse.anon.AuthData): js.Promise[this.type] = js.native
  def _linkWith(provider: AuthProvider, options: typings.parse.anon.AuthData, saveOpts: FullOptions): js.Promise[this.type] = js.native
