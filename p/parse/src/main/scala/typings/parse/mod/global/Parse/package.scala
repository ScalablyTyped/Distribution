package typings.parse.mod.global
...
package object Parse {
  ...
  @scala.inline
  def Installation: typings.parse.mod.global.Parse.InstallationConstructor = typings.parse.mod.global.Parse.^.asInstanceOf[js.Dynamic].selectDynamic("Installation").asInstanceOf[typings.parse.mod.global.Parse.InstallationConstructor]
  
  @scala.inline
  def Role: typings.parse.mod.global.Parse.RoleConstructor = typings.parse.mod.global.Parse.^.asInstanceOf[js.Dynamic].selectDynamic("Role").asInstanceOf[typings.parse.mod.global.Parse.RoleConstructor]
  
  @scala.inline
  def Session: typings.parse.mod.global.Parse.SessionConstructor = typings.parse.mod.global.Parse.^.asInstanceOf[js.Dynamic].selectDynamic("Session").asInstanceOf[typings.parse.mod.global.Parse.SessionConstructor]
  
  @scala.inline
  def User: typings.parse.mod.global.Parse.UserConstructor = typings.parse.mod.global.Parse.^.asInstanceOf[js.Dynamic].selectDynamic("User").asInstanceOf[typings.parse.mod.global.Parse.UserConstructor]
  ...
  /**
    ...
    */
  @scala.inline
  def dumpLocalDatastore(): js.Promise[org.scalablytyped.runtime.StringDictionary[_]] = typings.parse.mod.global.Parse.^.asInstanceOf[js.Dynamic].applyDynamic("dumpLocalDatastore")().asInstanceOf[js.Promise[org.scalablytyped.runtime.StringDictionary[_]]]
  ...
  ): scala.Unit = (typings.parse.mod.global.Parse.^.asInstanceOf[js.Dynamic].applyDynamic("initialize")(applicationId.asInstanceOf[js.Any], javaScriptKey.asInstanceOf[js.Any], masterKey.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
