...
import typings.parse.mod._Global_.Parse.Schema.Index
...
object Schema extends js.Object {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - scala.Boolean
    - typings.std.Date
    - typings.parse.mod._Global_.Parse.File
    - typings.parse.mod._Global_.Parse.GeoPoint
    - js.Array[js.Any]
    - js.Object
    - typings.parse.mod._Global_.Parse.Pointer
    - typings.parse.mod._Global_.Parse.Relation[
  typings.parse.mod._Global_.Parse.Object[typings.parse.mod._Global_.Parse.Attributes], 
  typings.parse.mod._Global_.Parse.Object[typings.parse.mod._Global_.Parse.Attributes]]
  */
