...
import typings.parse.mod.global.Parse.Cloud.^
...
import typings.parse.mod.global.Parse.Session
...
inline def afterLogin(func: js.Function1[/* request */ TriggerRequest[User[Attributes]], js.Thenable[Unit] | Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("afterLogin")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
inline def afterLogin(
  func: js.Function1[/* request */ TriggerRequest[User[Attributes]], js.Thenable[Unit] | Unit],
  validator: js.Function1[/* request */ FunctionRequest[Params], Any]
...
inline def afterLogout(func: js.Function1[/* request */ TriggerRequest[Session[Attributes]], js.Thenable[Unit] | Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("afterLogout")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
inline def afterLogout(
  func: js.Function1[/* request */ TriggerRequest[Session[Attributes]], js.Thenable[Unit] | Unit],
  validator: js.Function1[/* request */ FunctionRequest[Params], Any]
...
inline def beforeLogin(func: js.Function1[/* request */ TriggerRequest[User[Attributes]], js.Thenable[Unit] | Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("beforeLogin")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
...
inline def beforeSaveFile(func: js.Function1[/* request */ FileTriggerRequest, js.Thenable[File] | Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("beforeSaveFile")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
inline def beforeSaveFile(
  func: js.Function1[/* request */ FileTriggerRequest, js.Thenable[File] | Unit],
  validator: js.Function1[/* request */ FunctionRequest[Params], Any]
...
{[ P in keyof std.Parameters<T>[0] ]: std.Parameters<T>[0][P]}
  */ /* param */ typings.parse.parseStrings.define & TopLevel[Parameters[T]], 
Any] */](
  name: String,
  func: js.Function1[
...
/* import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ P in keyof std.Parameters<T>[0] ]: std.Parameters<T>[0][P]}
  */ /* param */ typings.parse.parseStrings.run & TopLevel[Parameters[T]], 
Any] */](
  name: String,
