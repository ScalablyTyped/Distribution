...
trait User[T /* <: Attributes */] extends Object[T] {
  def _linkWith(provider: js.Any, options: Anon_AuthData): js.Promise[User[Attributes]] = js.native
  def _linkWith(provider: js.Any, options: Anon_AuthData, saveOpts: FullOptions): js.Promise[User[Attributes]] = js.native
