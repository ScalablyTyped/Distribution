...
import typings.parse.parseMod._Global_.Parse.Schema.Index
import typings.parse.parseMod._Global_.Parse.Schema.TYPE
...
object Schema extends js.Object {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - scala.Boolean
    - typings.std.Date
    - typings.parse.parseMod._Global_.Parse.File
    - typings.parse.parseMod._Global_.Parse.GeoPoint
    - js.Array[js.Any]
    - js.Object
    - typings.parse.parseMod._Global_.Parse.Pointer
    - typings.parse.parseMod._Global_.Parse.Relation[
  typings.parse.parseMod._Global_.Parse.Object[typings.parse.parseMod._Global_.Parse.Attributes], 
  typings.parse.parseMod._Global_.Parse.Object[typings.parse.parseMod._Global_.Parse.Attributes]]
  */
