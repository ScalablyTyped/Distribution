...
object reactNativeMod {
  ...
  object ErrorCode extends StObject {
    ...
    /* 159 */ val DUPLICATE_REQUEST: typings.parse.mod.ErrorCode.DUPLICATE_REQUEST & Double = js.native
    ...
    /* 161 */ val FILE_DELETE_UNNAMED_ERROR: typings.parse.mod.ErrorCode.FILE_DELETE_UNNAMED_ERROR & Double = js.native
    ...
    /* 255 */ val INVALID_SCHEMA_OPERATION: typings.parse.mod.ErrorCode.INVALID_SCHEMA_OPERATION & Double = js.native
    ...
    /* 210 */ val MFA_ERROR: typings.parse.mod.ErrorCode.MFA_ERROR & Double = js.native
    
    /* 211 */ val MFA_TOKEN_REQUIRED: typings.parse.mod.ErrorCode.MFA_TOKEN_REQUIRED & Double = js.native
  ...
  object EventuallyQueue {
    ...
    @JSImport("parse/react-native", "EventuallyQueue")
    @js.native
    val ^ : js.Any = js.native
  ...
  object LiveQuery {
    ...
    @JSImport("parse/react-native", "LiveQuery")
    @js.native
    val ^ : js.Any = js.native
