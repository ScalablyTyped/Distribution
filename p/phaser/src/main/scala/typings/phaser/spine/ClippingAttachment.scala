...
trait ClippingAttachment extends VertexAttachment {
  ...
  var endSlot: SlotData = js.native
}
...
object ClippingAttachment {
  ...
  @scala.inline
  implicit class ClippingAttachmentOps[Self <: ClippingAttachment] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEndSlot(value: SlotData): Self = this.set("endSlot", value.asInstanceOf[js.Any])
  }
