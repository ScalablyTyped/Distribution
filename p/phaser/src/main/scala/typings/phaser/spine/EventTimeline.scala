...
object EventTimeline {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EventTimeline] (val x: Self) extends AnyVal {
    ...
    inline def setSetFrame(value: (Double, Event) => Unit): Self = StObject.set(x, "setFrame", js.Any.fromFunction2(value))
  }
}
