...
object ICollisionPair {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ICollisionPair] (val x: Self) extends AnyVal {
    ...
    inline def setCollision(value: ICollisionData): Self = StObject.set(x, "collision", value.asInstanceOf[js.Any])
