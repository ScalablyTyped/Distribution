...
@js.native
trait VerticesFactory extends StObject {
  ...
  /**
    ...
    * @param {body} body
    */
  def create(points: js.Array[Vector], body: BodyType): js.Array[Vector] = js.native
  ...
  /**
    ...
    * @return {vertices} vertices
    */
  def fromPath(path: String, body: BodyType): js.Array[Vector] = js.native
