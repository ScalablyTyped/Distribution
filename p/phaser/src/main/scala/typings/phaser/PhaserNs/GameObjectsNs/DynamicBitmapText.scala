...
import typings.phaser.PhaserNs.TypesNs.GameObjectsNs.BitmapTextNs.DisplayCallback
import typings.phaser.PhaserNs.TypesNs.GameObjectsNs.BitmapTextNs.DisplayCallbackConfig
