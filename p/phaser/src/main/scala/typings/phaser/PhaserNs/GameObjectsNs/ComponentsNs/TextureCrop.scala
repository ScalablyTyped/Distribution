...
trait TextureCrop extends js.Object {
  ...
  def setCrop(x: typings.phaser.PhaserNs.GeomNs.Rectangle): this.type = js.native
  def setCrop(x: typings.phaser.PhaserNs.GeomNs.Rectangle, y: Double): this.type = js.native
  def setCrop(x: typings.phaser.PhaserNs.GeomNs.Rectangle, y: Double, width: Double): this.type = js.native
  def setCrop(x: typings.phaser.PhaserNs.GeomNs.Rectangle, y: Double, width: Double, height: Double): this.type = js.native
  /**
