...
import typings.phaser.PhaserNs.TypesNs.GameObjectsNs.ParticlesNs.EmitterOpOnEmitCallback
import typings.phaser.PhaserNs.TypesNs.GameObjectsNs.ParticlesNs.EmitterOpOnUpdateCallback
