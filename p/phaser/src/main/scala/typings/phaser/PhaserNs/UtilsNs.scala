...
object UtilsNs extends js.Object {
  ...
  object StringNs extends js.Object {
    /**
      ...
      */
    def Format(string: String, values: js.Array[_]): String = js.native
    /**
      ...
      */
    def Pad(str: String): String = js.native
    def Pad(str: String, len: integer): String = js.native
    def Pad(str: String, len: integer, pad: String): String = js.native
    def Pad(str: String, len: integer, pad: String, dir: integer): String = js.native
    /**
      * Takes the given string and reverses it, returning the reversed string.
      * For example if given the string `Atari 520ST` it would return `TS025 iratA`.
      * @param string The string to be reversed.
      */
    def Reverse(string: String): String = js.native
    /**
