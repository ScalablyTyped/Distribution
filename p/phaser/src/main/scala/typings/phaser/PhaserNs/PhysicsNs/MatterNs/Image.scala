...
import typings.phaser.PhaserNs.PhysicsNs.MatterNs.ComponentsNs.Force
...
import typings.phaser.PhaserNs.PhysicsNs.MatterNs.ComponentsNs.SetBody
...
import typings.phaser.PhaserNs.PhysicsNs.MatterNs.ComponentsNs.Velocity
...
- typings.phaser.PhaserNs.GameObjectsNs.ComponentsNs.Texture because var conflicts: frame, texture. Inlined - typings.phaser.PhaserNs.PhysicsNs.MatterNs.ComponentsNs.Transform because var conflicts: angle, rotation, scaleX, scaleY, x, y. Inlined setFixedRotation */ @JSGlobal("Phaser.Physics.Matter.Image")
@js.native
