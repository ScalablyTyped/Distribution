...
import typings.phaser.PhaserNs.TypesNs.GameObjectsNs.BitmapTextNs.BitmapFontData
import typings.phaser.PhaserNs.TypesNs.GameObjectsNs.BitmapTextNs.BitmapTextSize
