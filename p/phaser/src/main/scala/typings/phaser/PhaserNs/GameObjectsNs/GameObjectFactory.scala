...
class GameObjectFactory protected () extends js.Object {
  ...
  def curve(x: Double, y: Double, curve: typings.phaser.PhaserNs.CurvesNs.Curve): Curve = js.native
  def curve(x: Double, y: Double, curve: typings.phaser.PhaserNs.CurvesNs.Curve, fillColor: Double): Curve = js.native
  def curve(
    x: Double,
    y: Double,
