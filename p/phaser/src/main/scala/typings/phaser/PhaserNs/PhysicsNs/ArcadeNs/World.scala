...
import typings.phaser.PhaserNs.StructsNs.ProcessQueue
import typings.phaser.PhaserNs.StructsNs.RTree
...
import typings.phaser.PhaserNs.TypesNs.PhysicsNs.ArcadeNs.ArcadeWorldDefaults
import typings.phaser.PhaserNs.TypesNs.PhysicsNs.ArcadeNs.ArcadeWorldTreeMinMax
import typings.phaser.PhaserNs.TypesNs.PhysicsNs.ArcadeNs.CheckCollisionObject
...
class World protected () extends EventEmitter {
  ...
  def disable(`object`: js.Array[GameObject | typings.phaser.PhaserNs.GameObjectsNs.Group]): Unit = js.native
  /**
  ...
  def disable(`object`: typings.phaser.PhaserNs.GameObjectsNs.Group): Unit = js.native
  /**
  ...
  def enable(`object`: js.Array[GameObject | typings.phaser.PhaserNs.GameObjectsNs.Group]): Unit = js.native
  def enable(`object`: js.Array[GameObject | typings.phaser.PhaserNs.GameObjectsNs.Group], bodyType: integer): Unit = js.native
  /**
  ...
  def enable(`object`: typings.phaser.PhaserNs.GameObjectsNs.Group): Unit = js.native
  def enable(`object`: typings.phaser.PhaserNs.GameObjectsNs.Group, bodyType: integer): Unit = js.native
  /**
