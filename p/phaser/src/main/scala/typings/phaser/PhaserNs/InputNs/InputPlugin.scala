...
import typings.phaser.PhaserNs.InputNs.GamepadNs.GamepadPlugin
import typings.phaser.PhaserNs.InputNs.KeyboardNs.KeyboardPlugin
...
import typings.phaser.PhaserNs.TypesNs.InputNs.InputConfiguration
