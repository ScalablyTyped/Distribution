...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def ToXY(index: integer, width: integer, height: integer): Vector2 = js.native
  def ToXY(index: integer, width: integer, height: integer, out: Vector2): Vector2 = js.native
  /**
