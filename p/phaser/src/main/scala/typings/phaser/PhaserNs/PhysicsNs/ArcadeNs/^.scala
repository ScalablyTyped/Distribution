...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def GetOverlapX(body1: Body, body2: Body, overlapOnly: Boolean, bias: Double): Double = js.native
  /**
    ...
    * @param bias A value added to the delta values during collision checks. Increase it to prevent sprite tunneling(sprites passing through another instead of colliding).
    */
  def GetOverlapY(body1: Body, body2: Body, overlapOnly: Boolean, bias: Double): Double = js.native
  /**
    ...
    */
  def SeparateX(body1: Body, body2: Body, overlapOnly: Boolean, bias: Double): Boolean = js.native
  /**
    ...
    * @param bias A value to add to the delta value during overlap checking. Used to prevent sprite tunneling.
    */
  def SeparateY(body1: Body, body2: Body, overlapOnly: Boolean, bias: Double): Boolean = js.native
}
