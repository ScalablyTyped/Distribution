...
@js.native
class TransformConstraintTimeline protected ()
  extends StObject
...
object TransformConstraintTimeline {
  ...
  @scala.inline
  def PREV_SCALE_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PREV_SCALE")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def PREV_SHEAR_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PREV_SHEAR")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def SCALE_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SCALE")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def SHEAR_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SHEAR")(x.asInstanceOf[js.Any])
