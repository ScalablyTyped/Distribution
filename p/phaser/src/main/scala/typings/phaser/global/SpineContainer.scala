...
@JSGlobal("SpineContainer")
@js.native
open class SpineContainer protected ()
  extends StObject
     with typings.phaser.SpineContainer {
  def this(scene: Scene, pluginManager: typings.phaser.SpinePlugin) = this()
  def this(scene: Scene, pluginManager: typings.phaser.SpinePlugin, x: Double) = this()
  def this(scene: Scene, pluginManager: typings.phaser.SpinePlugin, x: Double, y: Double) = this()
  def this(scene: Scene, pluginManager: typings.phaser.SpinePlugin, x: Unit, y: Double) = this()
  def this(
    scene: Scene,
    pluginManager: typings.phaser.SpinePlugin,
    x: Double,
    y: Double,
    children: js.Array[typings.phaser.SpineGameObject]
  ) = this()
  def this(
    scene: Scene,
    pluginManager: typings.phaser.SpinePlugin,
