...
class HTMLTextureFile protected ()
  ...
  def this(loader: LoaderPlugin, key: String, url: js.UndefOr[scala.Nothing], width: integer) = this()
  def this(loader: LoaderPlugin, key: String, url: String, width: integer) = this()
  def this(loader: LoaderPlugin, key: HTMLTextureFileConfig, url: js.UndefOr[scala.Nothing], width: integer) = this()
  ...
  def this(loader: LoaderPlugin, key: String, url: js.UndefOr[scala.Nothing], width: integer, height: integer) = this()
  def this(loader: LoaderPlugin, key: String, url: String, width: js.UndefOr[scala.Nothing], height: integer) = this()
