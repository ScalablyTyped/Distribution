...
object RetroFont {
  ...
  /**
    ...
    */
  @scala.inline
  def Parse(scene: Scene, config: RetroFontConfig): js.Object = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(scene.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[js.Object]
  
  /**
    * Text Set 1 =  !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~
    */
  @JSGlobal("Phaser.GameObjects.RetroFont.TEXT_SET1")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.GameObjects.RetroFont.TEXT_SET10")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.GameObjects.RetroFont.TEXT_SET11")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.GameObjects.RetroFont.TEXT_SET2")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.GameObjects.RetroFont.TEXT_SET3")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.GameObjects.RetroFont.TEXT_SET4")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.GameObjects.RetroFont.TEXT_SET5")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.GameObjects.RetroFont.TEXT_SET6")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.GameObjects.RetroFont.TEXT_SET7")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.GameObjects.RetroFont.TEXT_SET8")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.GameObjects.RetroFont.TEXT_SET9")
  @js.native
