...
object Textures {
  ...
  /**
    ...
    * for Canvas.
    */
  @JSGlobal("Phaser.Textures.DynamicTexture")
  @js.native
  ...
  object Events {
    ...
    /**
      ...
      */
    @JSGlobal("Phaser.Textures.Events.ADD_KEY")
    @js.native
    ...
    /**
      ...
      * errors the next time they try to render. Be sure to clear all use of the texture in this event handler.
      */
    @JSGlobal("Phaser.Textures.Events.REMOVE_KEY")
    @js.native
  ...
  object Parsers {
    ...
    @JSGlobal("Phaser.Textures.Parsers")
    @js.native
