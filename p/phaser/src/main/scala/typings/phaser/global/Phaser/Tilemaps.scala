...
object Tilemaps {
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.Tilemaps.DynamicTilemapLayer")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.Tilemaps.ParseToTilemap")
  @js.native
  def ParseToTilemap(
    scene: typings.phaser.Phaser.Scene,
  ...
  object Parsers {
    ...
    object Impact {
      ...
      /**
        ...
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Impact.ParseTileLayers")
      @js.native
      ...
      /**
        ...
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Impact.ParseTilesets")
      @js.native
    ...
    /**
      ...
      * the default value set.
      */
    @JSGlobal("Phaser.Tilemaps.Parsers.Parse2DArray")
    @js.native
    def Parse2DArray(
      name: String,
      data: js.Array[js.Array[integer]],
    ...
    /**
      ...
      * the default value set.
      */
    @JSGlobal("Phaser.Tilemaps.Parsers.ParseCSV")
    @js.native
    ...
    object Tiled {
      ...
      /**
        ...
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled.AssignTileProperties")
      @js.native
      ...
      /**
        ...
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled.Base64Decode")
      @js.native
      ...
      /**
        ...
        * @param mapData The Map Data object.
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled.BuildTilesetIndex")
      @js.native
      ...
      /**
        ...
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled.CreateGroupLayer")
      @js.native
      ...
      /**
        ...
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled.ParseGID")
      @js.native
      ...
      /**
        ...
        * @param json The Tiled JSON object.
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled.ParseImageLayers")
      @js.native
      ...
      /**
        ...
        * the default value set.
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled.ParseJSONTiled")
      @js.native
      ...
      /**
        ...
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled.ParseObject")
      @js.native
      ...
      /**
        ...
        * @param json The Tiled JSON object.
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled.ParseObjectLayers")
      @js.native
      ...
      /**
        ...
        * data are handled (see {@link Phaser.Tilemaps.Parsers.Tiled.ParseJSONTiled}).
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled.ParseTileLayers")
      @js.native
      def ParseTileLayers(json: js.Object, insertNull: Boolean): js.Array[typings.phaser.Phaser.Tilemaps.LayerData] = js.native
      ...
      /**
        ...
        */
      @JSGlobal("Phaser.Tilemaps.Parsers.Tiled.ParseTilesets")
      @js.native
  ...
  /**
    ...
    */
  @JSGlobal("Phaser.Tilemaps.StaticTilemapLayer")
  @js.native
