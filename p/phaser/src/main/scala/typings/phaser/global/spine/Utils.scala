...
object Utils {
  ...
  /* static member */
  inline def webkit602BugfixHelper(alpha: Double, blend: typings.phaser.spine.MixBlend): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("webkit602BugfixHelper")(alpha.asInstanceOf[js.Any], blend.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
