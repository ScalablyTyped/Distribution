...
class Container protected ()
  ...
  def this(scene: Scene, x: Double, y: Unit, children: js.Array[typings.phaser.Phaser.GameObjects.GameObject]) = this()
  def this(scene: Scene, x: Unit, y: Double, children: js.Array[typings.phaser.Phaser.GameObjects.GameObject]) = this()
  def this(scene: Scene, x: Unit, y: Unit, children: js.Array[typings.phaser.Phaser.GameObjects.GameObject]) = this()
