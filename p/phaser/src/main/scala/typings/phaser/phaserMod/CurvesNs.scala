...
object CurvesNs extends js.Object {
  ...
  class CubicBezier protected ()
    extends typings.phaser.PhaserNs.CurvesNs.CubicBezier {
  ...
  class Curve protected ()
    extends typings.phaser.PhaserNs.CurvesNs.Curve {
    /**
      * 
  ...
  class Ellipse protected ()
    extends typings.phaser.PhaserNs.CurvesNs.Ellipse {
    /**
      * 
  ...
  class Line protected ()
    extends typings.phaser.PhaserNs.CurvesNs.Line {
  ...
  /**
    ...
    */
  class MoveTo ()
    extends typings.phaser.PhaserNs.CurvesNs.MoveTo {
  ...
  /**
    ...
    */
  class Path ()
    extends typings.phaser.PhaserNs.CurvesNs.Path {
    def this(x: Double) = this()
    def this(x: Double, y: Double) = this()
  }
  ...
  class QuadraticBezier protected ()
    extends typings.phaser.PhaserNs.CurvesNs.QuadraticBezier {
  ...
  /**
    ...
    */
  class Spline ()
    extends typings.phaser.PhaserNs.CurvesNs.Spline {
  ...
  object CubicBezier extends js.Object {
    /**
      ...
      */
    def fromJSON(data: JSONCurve): typings.phaser.PhaserNs.CurvesNs.CubicBezier = js.native
  }
  ...
  object Ellipse extends js.Object {
    /**
      ...
      * @param data The JSON object containing this curve data.
      */
    def fromJSON(data: JSONEllipseCurve): typings.phaser.PhaserNs.CurvesNs.Ellipse = js.native
  }
  ...
  object Line extends js.Object {
    /**
      ...
      * @param data The JSON object containing this curve data.
      */
    def fromJSON(data: JSONCurve): typings.phaser.PhaserNs.CurvesNs.Line = js.native
  }
  ...
  object QuadraticBezier extends js.Object {
    /**
      ...
      * @param data The JSON object containing this curve data.
      */
    def fromJSON(data: JSONCurve): typings.phaser.PhaserNs.CurvesNs.QuadraticBezier = js.native
  }
  ...
  object Spline extends js.Object {
    /**
      ...
      * @param data The JSON object containing this curve data.
      */
    def fromJSON(data: JSONCurve): typings.phaser.PhaserNs.CurvesNs.Spline = js.native
  }
