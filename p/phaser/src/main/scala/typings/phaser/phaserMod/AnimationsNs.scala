...
@js.native
object AnimationsNs extends js.Object {
  /**
  ...
  class Animation protected ()
    extends typings.phaser.PhaserNs.AnimationsNs.Animation {
    /**
      * 
      ...
      */
    def this(
      manager: typings.phaser.PhaserNs.AnimationsNs.AnimationManager,
      key: String,
  ...
  class AnimationFrame protected ()
    extends typings.phaser.PhaserNs.AnimationsNs.AnimationFrame {
    /**
      * 
  ...
  class AnimationManager protected ()
    extends typings.phaser.PhaserNs.AnimationsNs.AnimationManager {
    /**
      * 
