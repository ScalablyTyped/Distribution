...
import typings.phaser.PhaserNs.TypesNs.PluginsNs.CorePluginContainer
import typings.phaser.PhaserNs.TypesNs.PluginsNs.CustomPluginContainer
...
object PluginsNs extends js.Object {
  ...
  class BasePlugin protected ()
    extends typings.phaser.PhaserNs.PluginsNs.BasePlugin {
    /**
      * 
      * @param pluginManager A reference to the Plugin Manager.
      */
    def this(pluginManager: typings.phaser.PhaserNs.PluginsNs.PluginManager) = this()
  }
  ...
  class PluginManager protected ()
    extends typings.phaser.PhaserNs.PluginsNs.PluginManager {
    /**
      * 
  ...
  class ScenePlugin protected ()
    extends typings.phaser.PhaserNs.PluginsNs.ScenePlugin {
    /**
      * 
    ...
    def this(
      ...
      pluginManager: typings.phaser.PhaserNs.PluginsNs.PluginManager
    ) = this()
  }
