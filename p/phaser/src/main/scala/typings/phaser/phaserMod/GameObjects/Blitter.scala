...
class Blitter protected ()
  ...
  def this(scene: Scene, x: js.UndefOr[scala.Nothing], y: js.UndefOr[scala.Nothing], texture: String) = this()
  def this(scene: Scene, x: js.UndefOr[scala.Nothing], y: Double, texture: String) = this()
  def this(scene: Scene, x: Double, y: js.UndefOr[scala.Nothing], texture: String) = this()
  ...
  def this(scene: Scene, x: js.UndefOr[scala.Nothing], y: Double, texture: String, frame: String) = this()
  def this(scene: Scene, x: js.UndefOr[scala.Nothing], y: Double, texture: String, frame: integer) = this()
  def this(
    scene: Scene,
    x: Double,
    y: js.UndefOr[scala.Nothing],
  ...
  def this(scene: Scene, x: Double, y: js.UndefOr[scala.Nothing], texture: String, frame: String) = this()
  def this(scene: Scene, x: Double, y: js.UndefOr[scala.Nothing], texture: String, frame: integer) = this()
  def this(scene: Scene, x: Double, y: Double, texture: js.UndefOr[scala.Nothing], frame: String) = this()
  def this(scene: Scene, x: Double, y: Double, texture: js.UndefOr[scala.Nothing], frame: integer) = this()
