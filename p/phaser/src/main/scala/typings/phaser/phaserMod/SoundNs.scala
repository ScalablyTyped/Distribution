...
object SoundNs extends js.Object {
  ...
  class BaseSound protected ()
    extends typings.phaser.PhaserNs.SoundNs.BaseSound {
    /**
      * 
      ...
      */
    def this(manager: typings.phaser.PhaserNs.SoundNs.BaseSoundManager, key: String) = this()
    def this(manager: typings.phaser.PhaserNs.SoundNs.BaseSoundManager, key: String, config: SoundConfig) = this()
  }
  ...
  class BaseSoundManager protected ()
    extends typings.phaser.PhaserNs.SoundNs.BaseSoundManager {
    /**
      * 
  ...
  class HTML5AudioSound protected ()
    extends typings.phaser.PhaserNs.SoundNs.HTML5AudioSound {
    /**
      * 
      * @param manager Reference to the current sound manager instance.
      * @param key Asset key for the sound.
      ...
      */
    def this(manager: typings.phaser.PhaserNs.SoundNs.HTML5AudioSoundManager, key: String) = this()
    def this(manager: typings.phaser.PhaserNs.SoundNs.HTML5AudioSoundManager, key: String, config: SoundConfig) = this()
  }
  ...
  class HTML5AudioSoundManager protected ()
    extends typings.phaser.PhaserNs.SoundNs.HTML5AudioSoundManager {
    /**
      * 
      * @param game Reference to the current game instance.
      */
  ...
  class NoAudioSound protected ()
    extends typings.phaser.PhaserNs.SoundNs.NoAudioSound {
    /**
      * 
      * @param manager Reference to the current sound manager instance.
      * @param key Asset key for the sound.
      * @param config An optional config object containing default sound settings. Default {}.
      */
    def this(manager: typings.phaser.PhaserNs.SoundNs.NoAudioSoundManager, key: String) = this()
    def this(manager: typings.phaser.PhaserNs.SoundNs.NoAudioSoundManager, key: String, config: SoundConfig) = this()
  }
  ...
  class NoAudioSoundManager protected ()
    extends typings.phaser.PhaserNs.SoundNs.NoAudioSoundManager {
    /**
      * 
      * @param game Reference to the current game instance.
      */
  ...
  class WebAudioSound protected ()
    extends typings.phaser.PhaserNs.SoundNs.WebAudioSound {
    /**
      * 
      * @param manager Reference to the current sound manager instance.
      * @param key Asset key for the sound.
      * @param config An optional config object containing default sound settings. Default {}.
      */
    def this(manager: typings.phaser.PhaserNs.SoundNs.WebAudioSoundManager, key: String) = this()
    def this(manager: typings.phaser.PhaserNs.SoundNs.WebAudioSoundManager, key: String, config: SoundConfig) = this()
  }
  ...
  class WebAudioSoundManager protected ()
    extends typings.phaser.PhaserNs.SoundNs.WebAudioSoundManager {
    /**
      * 
      * @param game Reference to the current game instance.
      */
  ...
  /**
    ...
    * @param game Reference to the current game instance.
    */
  def SoundManagerCreator(game: typings.phaser.PhaserNs.Game): Unit = js.native
  @JSName("Events")
  @js.native
