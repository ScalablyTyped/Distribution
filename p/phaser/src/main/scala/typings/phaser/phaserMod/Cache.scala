...
object Cache extends js.Object {
  ...
  class CacheManager protected ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override var audio: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all binary files, typically added via the Loader.
      */
    /* CompleteClass */
    override var binary: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all bitmap font data files, typically added via the Loader.
      * Only the font data is stored in this cache, the textures are part of the Texture Manager.
      */
    /* CompleteClass */
    override var bitmapFont: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * An object that contains your own custom BaseCache entries.
      * Add to this via the `addCustom` method.
      */
    /* CompleteClass */
    override var custom: StringDictionary[typings.phaser.Phaser.Cache.BaseCache] = js.native
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override var html: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all JSON data files, typically added via the Loader.
      */
    /* CompleteClass */
    override var json: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all WaveFront OBJ files, typically added via the Loader.
      */
    /* CompleteClass */
    override var obj: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all physics data files, typically added via the Loader.
      */
    /* CompleteClass */
    override var physics: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all shader source files, typically added via the Loader.
      */
    /* CompleteClass */
    override var shader: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all text files, typically added via the Loader.
      */
    /* CompleteClass */
    override var text: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all tilemap data files, typically added via the Loader.
      * Only the data is stored in this cache, the textures are part of the Texture Manager.
      */
    /* CompleteClass */
    override var tilemap: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all non-streaming video files, typically added via the Loader.
      */
    /* CompleteClass */
    override var video: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
      * A Cache storing all xml data files, typically added via the Loader.
      */
    /* CompleteClass */
    override var xml: typings.phaser.Phaser.Cache.BaseCache = js.native
    /**
