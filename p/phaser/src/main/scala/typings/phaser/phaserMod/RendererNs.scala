...
object RendererNs extends js.Object {
  ...
  object CanvasNs extends js.Object {
    ...
    class CanvasRenderer protected ()
      extends typings.phaser.PhaserNs.RendererNs.CanvasNs.CanvasRenderer {
      /**
        * 
    ...
    /**
      ...
      */
    def SetTransform(
      renderer: typings.phaser.PhaserNs.RendererNs.CanvasNs.CanvasRenderer,
  ...
  object WebGLNs extends js.Object {
    ...
    class WebGLPipeline protected ()
      extends typings.phaser.PhaserNs.RendererNs.WebGLNs.WebGLPipeline {
      /**
        * 
    ...
    class WebGLRenderer protected ()
      extends typings.phaser.PhaserNs.RendererNs.WebGLNs.WebGLRenderer {
      /**
        * 
    ...
    object PipelinesNs extends js.Object {
      ...
      class BitmapMaskPipeline protected ()
        extends typings.phaser.PhaserNs.RendererNs.WebGLNs.PipelinesNs.BitmapMaskPipeline {
        /**
          * 
      ...
      class ForwardDiffuseLightPipeline protected ()
        extends typings.phaser.PhaserNs.RendererNs.WebGLNs.PipelinesNs.ForwardDiffuseLightPipeline {
        /**
          * 
      ...
      class TextureTintPipeline protected ()
        extends typings.phaser.PhaserNs.RendererNs.WebGLNs.PipelinesNs.TextureTintPipeline {
        /**
          * 
