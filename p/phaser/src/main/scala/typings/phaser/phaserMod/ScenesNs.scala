...
object ScenesNs extends js.Object {
  ...
  class SceneManager protected ()
    extends typings.phaser.PhaserNs.ScenesNs.SceneManager {
    /**
      * 
      * @param game The Phaser.Game instance this Scene Manager belongs to.
      * @param sceneConfig Scene specific configuration settings.
      */
    def this(game: typings.phaser.PhaserNs.Game, sceneConfig: js.Object) = this()
  }
  ...
  class ScenePlugin protected ()
    extends typings.phaser.PhaserNs.ScenesNs.ScenePlugin {
    /**
      * 
  ...
  class Systems protected ()
    extends typings.phaser.PhaserNs.ScenesNs.Systems {
    /**
      * 
      * @param scene The Scene that owns this Systems instance.
      * @param config Scene specific configuration settings.
      */
    def this(scene: typings.phaser.PhaserNs.Scene, config: String) = this()
    def this(scene: typings.phaser.PhaserNs.Scene, config: SettingsConfig) = this()
  }
  ...
  /**
    ...
    */
  def GetPhysicsPlugins(sys: typings.phaser.PhaserNs.ScenesNs.Systems): js.Array[_] = js.native
  /**
    ...
    */
  def GetScenePlugins(sys: typings.phaser.PhaserNs.ScenesNs.Systems): js.Array[_] = js.native
  @JSName("Events")
  @js.native
