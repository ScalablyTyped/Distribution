...
object InputNs extends js.Object {
  ...
  class InputManager protected ()
    extends typings.phaser.PhaserNs.InputNs.InputManager {
    /**
      * 
      ...
      */
    def this(game: typings.phaser.PhaserNs.Game, config: js.Object) = this()
  }
  ...
  class InputPlugin protected ()
    extends typings.phaser.PhaserNs.InputNs.InputPlugin {
    /**
      * 
  ...
  class Pointer protected ()
    extends typings.phaser.PhaserNs.InputNs.Pointer {
    /**
      * 
      * @param manager A reference to the Input Manager.
      * @param id The internal ID of this Pointer.
      */
    def this(manager: typings.phaser.PhaserNs.InputNs.InputManager, id: integer) = this()
  }
  ...
  object GamepadNs extends js.Object {
    ...
    class Axis protected ()
      extends typings.phaser.PhaserNs.InputNs.GamepadNs.Axis {
      /**
        * 
        * @param pad A reference to the Gamepad that this Axis belongs to.
        * @param index The index of this Axis.
        */
      def this(pad: typings.phaser.PhaserNs.InputNs.GamepadNs.Gamepad, index: integer) = this()
    }
    ...
    class Button protected ()
      extends typings.phaser.PhaserNs.InputNs.GamepadNs.Button {
      /**
        * 
    ...
    class Gamepad protected ()
      extends typings.phaser.PhaserNs.InputNs.GamepadNs.Gamepad {
      /**
        * 
        * @param manager A reference to the Gamepad Plugin.
        * @param pad The Gamepad object, as extracted from GamepadEvent.
        */
      def this(manager: typings.phaser.PhaserNs.InputNs.GamepadNs.GamepadPlugin, pad: Pad) = this()
    }
    ...
    class GamepadPlugin protected ()
      extends typings.phaser.PhaserNs.InputNs.GamepadNs.GamepadPlugin {
      /**
        * 
        * @param sceneInputPlugin A reference to the Scene Input Plugin that the KeyboardPlugin belongs to.
        */
      def this(sceneInputPlugin: typings.phaser.PhaserNs.InputNs.InputPlugin) = this()
    }
  ...
  object KeyboardNs extends js.Object {
    ...
    @js.native
    class Key protected ()
      extends typings.phaser.PhaserNs.InputNs.KeyboardNs.Key {
      /**
        * 
        * @param plugin The Keyboard Plugin instance that owns this Key object.
        * @param keyCode The keycode of this key.
        */
      def this(plugin: typings.phaser.PhaserNs.InputNs.KeyboardNs.KeyboardPlugin, keyCode: integer) = this()
    }
    ...
    class KeyCombo protected ()
      extends typings.phaser.PhaserNs.InputNs.KeyboardNs.KeyCombo {
      /**
        * 
        ...
        */
      def this(keyboardPlugin: typings.phaser.PhaserNs.InputNs.KeyboardNs.KeyboardPlugin, keys: String) = this()
      def this(
        keyboardPlugin: typings.phaser.PhaserNs.InputNs.KeyboardNs.KeyboardPlugin,
    ...
    class KeyboardManager protected ()
      extends typings.phaser.PhaserNs.InputNs.KeyboardNs.KeyboardManager {
      /**
        * 
        * @param inputManager A reference to the Input Manager.
        */
      def this(inputManager: typings.phaser.PhaserNs.InputNs.InputManager) = this()
    }
    ...
    class KeyboardPlugin protected ()
      extends typings.phaser.PhaserNs.InputNs.KeyboardNs.KeyboardPlugin {
      /**
        * 
        * @param sceneInputPlugin A reference to the Scene Input Plugin that the KeyboardPlugin belongs to.
        */
    ...
    /**
      ...
      */
    def DownDuration(key: typings.phaser.PhaserNs.InputNs.KeyboardNs.Key): Boolean = js.native
    def DownDuration(key: typings.phaser.PhaserNs.InputNs.KeyboardNs.Key, duration: integer): Boolean = js.native
    /**
      ...
      */
    def JustDown(key: typings.phaser.PhaserNs.InputNs.KeyboardNs.Key): Boolean = js.native
    /**
      ...
      */
    def JustUp(key: typings.phaser.PhaserNs.InputNs.KeyboardNs.Key): Boolean = js.native
    /**
      ...
      */
    def UpDuration(key: typings.phaser.PhaserNs.InputNs.KeyboardNs.Key): Boolean = js.native
    def UpDuration(key: typings.phaser.PhaserNs.InputNs.KeyboardNs.Key, duration: integer): Boolean = js.native
    @JSName("Events")
    @js.native
    object EventsNs extends js.Object {
      /**
  ...
  object MouseNs extends js.Object {
    ...
    class MouseManager protected ()
      extends typings.phaser.PhaserNs.InputNs.MouseNs.MouseManager {
      /**
        * 
        * @param inputManager A reference to the Input Manager.
        */
  ...
  object TouchNs extends js.Object {
    ...
    class TouchManager protected ()
      extends typings.phaser.PhaserNs.InputNs.TouchNs.TouchManager {
      /**
        * 
        * @param inputManager A reference to the Input Manager.
        */
