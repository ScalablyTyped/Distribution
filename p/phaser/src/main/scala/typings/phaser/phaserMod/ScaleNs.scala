...
object ScaleNs extends js.Object {
  ...
  class ScaleManager protected ()
    extends typings.phaser.PhaserNs.ScaleNs.ScaleManager {
    /**
      * 
  ...
  object Center extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.phaser.PhaserNs.ScaleNs.Center with Double] = js.native
  }
  ...
  object Orientation extends js.Object {
    /* 0 */ val LANDSCAPE: typings.phaser.PhaserNs.ScaleNs.Orientation.LANDSCAPE with Double = js.native
    /* 1 */ val PORTRAIT: typings.phaser.PhaserNs.ScaleNs.Orientation.PORTRAIT with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.phaser.PhaserNs.ScaleNs.Orientation with Double] = js.native
  }
  ...
  object Zoom extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.phaser.PhaserNs.ScaleNs.Zoom with Double] = js.native
  }
