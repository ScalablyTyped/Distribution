...
object Physics {
  ...
  object Arcade {
    ...
    /**
      ...
      */
    @JSImport("phaser", "Physics.Arcade.GetOverlapX")
    @js.native
    def GetOverlapX(
    ...
    /**
      ...
      * @param bias A value added to the delta values during collision checks. Increase it to prevent sprite tunneling(sprites passing through another instead of colliding).
      */
    @JSImport("phaser", "Physics.Arcade.GetOverlapY")
    @js.native
    def GetOverlapY(
      body1: typings.phaser.Phaser.Physics.Arcade.Body,
      body2: typings.phaser.Phaser.Physics.Arcade.Body,
    ...
    /**
      ...
      */
    @JSImport("phaser", "Physics.Arcade.SeparateX")
    @js.native
    def SeparateX(
      body1: typings.phaser.Phaser.Physics.Arcade.Body,
      body2: typings.phaser.Phaser.Physics.Arcade.Body,
    ...
    /**
      ...
      * @param bias A value to add to the delta value during overlap checking. Used to prevent sprite tunneling.
      */
    @JSImport("phaser", "Physics.Arcade.SeparateY")
    @js.native
    def SeparateY(
      body1: typings.phaser.Phaser.Physics.Arcade.Body,
      body2: typings.phaser.Phaser.Physics.Arcade.Body,
    ...
    object Tilemap {
      ...
      /**
        ...
        */
      @JSImport("phaser", "Physics.Arcade.Tilemap.ProcessTileCallbacks")
      @js.native
      ...
      /**
        ...
        */
      @JSImport("phaser", "Physics.Arcade.Tilemap.ProcessTileSeparationX")
      @js.native
      ...
      /**
        ...
        */
      @JSImport("phaser", "Physics.Arcade.Tilemap.ProcessTileSeparationY")
      @js.native
      ...
      /**
        ...
        */
      @JSImport("phaser", "Physics.Arcade.Tilemap.SeparateTile")
      @js.native
      def SeparateTile(
        i: Double,
      ...
      /**
        ...
        * @param isLayer Is this check coming from a TilemapLayer or an array of tiles?
        */
      @JSImport("phaser", "Physics.Arcade.Tilemap.TileCheckX")
      @js.native
      def TileCheckX(
        body: typings.phaser.Phaser.Physics.Arcade.Body,
        tile: Tile,
      ...
      /**
        ...
        * @param isLayer Is this check coming from a TilemapLayer or an array of tiles?
        */
      @JSImport("phaser", "Physics.Arcade.Tilemap.TileCheckY")
      @js.native
      def TileCheckY(
        body: typings.phaser.Phaser.Physics.Arcade.Body,
        tile: Tile,
      ...
      /**
        ...
        */
      @JSImport("phaser", "Physics.Arcade.Tilemap.TileIntersectsBody")
      @js.native
  ...
  object Matter {
    ...
    /**
      ...
      */
    @JSImport("phaser", "Physics.Matter.MatterGameObject")
    @js.native
    ...
    object PhysicsEditorParser {
      ...
      /**
        ...
        * @param options An optional Body configuration object that is used to set initial Body properties on creation.
        */
      @JSImport("phaser", "Physics.Matter.PhysicsEditorParser.parseBody")
      @js.native
      ...
      /**
        ...
        */
      @JSImport("phaser", "Physics.Matter.PhysicsEditorParser.parseFixture")
      @js.native
      ...
      /**
        ...
        * @param options An optional Body configuration object that is used to set initial Body properties on creation.
        */
      @JSImport("phaser", "Physics.Matter.PhysicsEditorParser.parseVertices")
      @js.native
    ...
    object PhysicsJSONParser {
      ...
      /**
        ...
        * @param options An optional Body configuration object that is used to set initial Body properties on creation.
        */
      @JSImport("phaser", "Physics.Matter.PhysicsJSONParser.parseBody")
      @js.native
      def parseBody(x: Double, y: Double, config: js.Object): BodyType = js.native
      @JSImport("phaser", "Physics.Matter.PhysicsJSONParser.parseBody")
      @js.native
