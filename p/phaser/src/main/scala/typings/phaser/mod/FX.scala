...
object FX {
  ...
  /**
    * The Color Matrix FX.
    */
  @JSImport("phaser", "FX.COLOR_MATRIX")
  @js.native
  ...
  /**
    ...
    * ```
    */
  @JSImport("phaser", "FX.ColorMatrix")
  @js.native
  ...
  /**
    * The Displacement FX.
    */
  @JSImport("phaser", "FX.DISPLACEMENT")
  @js.native
