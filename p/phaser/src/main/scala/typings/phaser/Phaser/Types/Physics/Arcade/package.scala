...
package object Arcade {
  ...
  */
  ...
  type GameObjectWithBody = typings.phaser.Phaser.GameObjects.GameObject
  type GameObjectWithDynamicBody = typings.phaser.Phaser.GameObjects.GameObject
  type GameObjectWithStaticBody = typings.phaser.Phaser.GameObjects.GameObject
  type ImageWithDynamicBody = typings.phaser.Phaser.Physics.Arcade.Image
  type ImageWithStaticBody = typings.phaser.Phaser.Physics.Arcade.Image
  type SpriteWithDynamicBody = typings.phaser.Phaser.Physics.Arcade.Sprite
  type SpriteWithStaticBody = typings.phaser.Phaser.Physics.Arcade.Sprite
}
