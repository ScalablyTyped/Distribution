...
object WebGLPipeline {
  ...
  implicit class WebGLPipelineOps[Self <: WebGLPipeline] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSetFloat1v(value: (String, Float32Array) => WebGLPipeline): Self = this.set("setFloat1v", js.Any.fromFunction2(value))
    
    @scala.inline
    def setSetFloat2(value: (String, Double, Double) => WebGLPipeline): Self = this.set("setFloat2", js.Any.fromFunction3(value))
    
    @scala.inline
    def setSetFloat2v(value: (String, Float32Array) => WebGLPipeline): Self = this.set("setFloat2v", js.Any.fromFunction2(value))
    
    @scala.inline
    def setSetFloat3(value: (String, Double, Double, Double) => WebGLPipeline): Self = this.set("setFloat3", js.Any.fromFunction4(value))
    
    @scala.inline
    def setSetFloat3v(value: (String, Float32Array) => WebGLPipeline): Self = this.set("setFloat3v", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setSetFloat4v(value: (String, Float32Array) => WebGLPipeline): Self = this.set("setFloat4v", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setSetMatrix2(value: (String, Boolean, Float32Array) => WebGLPipeline): Self = this.set("setMatrix2", js.Any.fromFunction3(value))
    
    @scala.inline
    def setSetMatrix3(value: (String, Boolean, Float32Array) => WebGLPipeline): Self = this.set("setMatrix3", js.Any.fromFunction3(value))
    
    @scala.inline
    def setSetMatrix4(value: (String, Boolean, Float32Array) => WebGLPipeline): Self = this.set("setMatrix4", js.Any.fromFunction3(value))
    ...
    @scala.inline
    def setVertexData(value: ArrayBuffer): Self = this.set("vertexData", value.asInstanceOf[js.Any])
