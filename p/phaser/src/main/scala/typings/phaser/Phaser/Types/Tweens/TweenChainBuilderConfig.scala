...
trait TweenChainBuilderConfig
  ...
  /**
    ...
    */
  var tweens: js.UndefOr[js.Array[TweenBuilderConfig]] = js.undefined
}
object TweenChainBuilderConfig {
  
  inline def apply(targets: Any): TweenChainBuilderConfig = {
    val __obj = js.Dynamic.literal(targets = targets.asInstanceOf[js.Any])
    __obj.asInstanceOf[TweenChainBuilderConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TweenChainBuilderConfig] (val x: Self) extends AnyVal {
    ...
    inline def setTweens(value: js.Array[TweenBuilderConfig]): Self = StObject.set(x, "tweens", value.asInstanceOf[js.Any])
    
    inline def setTweensUndefined: Self = StObject.set(x, "tweens", js.undefined)
    
    inline def setTweensVarargs(value: TweenBuilderConfig*): Self = StObject.set(x, "tweens", js.Array(value*))
  }
}
