...
object CamerasNs extends js.Object {
  ...
  object ControlsNs extends js.Object {
    ...
    class FixedKeyControl protected ()
      extends phaserLib.PhaserNs.CamerasNs.ControlsNs.FixedKeyControl {
      /**
        * 
    ...
    class SmoothedKeyControl protected ()
      extends phaserLib.PhaserNs.CamerasNs.ControlsNs.SmoothedKeyControl {
      /**
        * 
  ...
  object Scene2DNs extends js.Object {
    ...
    class BaseCamera protected ()
      extends phaserLib.PhaserNs.CamerasNs.Scene2DNs.BaseCamera {
      /**
        * 
    ...
    class Camera protected ()
      extends phaserLib.PhaserNs.CamerasNs.Scene2DNs.Camera {
      /**
        * 
        * @param x The x position of the Camera, relative to the top-left of the game canvas.
        * @param y The y position of the Camera, relative to the top-left of the game canvas.
    ...
    class CameraManager protected ()
      extends phaserLib.PhaserNs.CamerasNs.Scene2DNs.CameraManager {
      /**
        * 
    ...
    object EffectsNs extends js.Object {
      ...
      class Fade protected ()
        extends phaserLib.PhaserNs.CamerasNs.Scene2DNs.EffectsNs.Fade {
        /**
          * 
      ...
      class Flash protected ()
        extends phaserLib.PhaserNs.CamerasNs.Scene2DNs.EffectsNs.Flash {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      @js.native
      class Pan protected ()
        extends phaserLib.PhaserNs.CamerasNs.Scene2DNs.EffectsNs.Pan {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      class Shake protected ()
        extends phaserLib.PhaserNs.CamerasNs.Scene2DNs.EffectsNs.Shake {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
      ...
      class Zoom protected ()
        extends phaserLib.PhaserNs.CamerasNs.Scene2DNs.EffectsNs.Zoom {
        /**
          * 
          * @param camera The camera this effect is acting upon.
          */
