...
object TilemapsNs extends js.Object {
  ...
  class DynamicTilemapLayer protected ()
    extends phaserLib.PhaserNs.TilemapsNs.DynamicTilemapLayer {
    /**
      * 
      ...
      */
    def this(scene: phaserLib.PhaserNs.Scene, tilemap: phaserLib.PhaserNs.TilemapsNs.Tilemap, layerIndex: phaserLib.integer, tileset: java.lang.String) = this()
    def this(scene: phaserLib.PhaserNs.Scene, tilemap: phaserLib.PhaserNs.TilemapsNs.Tilemap, layerIndex: phaserLib.integer, tileset: js.Array[java.lang.String | phaserLib.PhaserNs.TilemapsNs.Tileset]) = this()
    def this(scene: phaserLib.PhaserNs.Scene, tilemap: phaserLib.PhaserNs.TilemapsNs.Tilemap, layerIndex: phaserLib.integer, tileset: phaserLib.PhaserNs.TilemapsNs.Tileset) = this()
    def this(scene: phaserLib.PhaserNs.Scene, tilemap: phaserLib.PhaserNs.TilemapsNs.Tilemap, layerIndex: phaserLib.integer, tileset: java.lang.String, x: scala.Double) = this()
    def this(scene: phaserLib.PhaserNs.Scene, tilemap: phaserLib.PhaserNs.TilemapsNs.Tilemap, layerIndex: phaserLib.integer, tileset: js.Array[java.lang.String | phaserLib.PhaserNs.TilemapsNs.Tileset], x: scala.Double) = this()
    def this(scene: phaserLib.PhaserNs.Scene, tilemap: phaserLib.PhaserNs.TilemapsNs.Tilemap, layerIndex: phaserLib.integer, tileset: phaserLib.PhaserNs.TilemapsNs.Tileset, x: scala.Double) = this()
    def this(scene: phaserLib.PhaserNs.Scene, tilemap: phaserLib.PhaserNs.TilemapsNs.Tilemap, layerIndex: phaserLib.integer, tileset: java.lang.String, x: scala.Double, y: scala.Double) = this()
    def this(scene: phaserLib.PhaserNs.Scene, tilemap: phaserLib.PhaserNs.TilemapsNs.Tilemap, layerIndex: phaserLib.integer, tileset: js.Array[java.lang.String | phaserLib.PhaserNs.TilemapsNs.Tileset], x: scala.Double, y: scala.Double) = this()
    def this(scene: phaserLib.PhaserNs.Scene, tilemap: phaserLib.PhaserNs.TilemapsNs.Tilemap, layerIndex: phaserLib.integer, tileset: phaserLib.PhaserNs.TilemapsNs.Tileset, x: scala.Double, y: scala.Double) = this()
  }
  ...
  class ImageCollection protected ()
    extends phaserLib.PhaserNs.TilemapsNs.ImageCollection {
    /**
      * 
  ...
  /**
    ...
    */
  class LayerData ()
    extends phaserLib.PhaserNs.TilemapsNs.LayerData {
  ...
  /**
    ...
    */
  class MapData ()
    extends phaserLib.PhaserNs.TilemapsNs.MapData {
  ...
  class StaticTilemapLayer protected ()
    extends phaserLib.PhaserNs.TilemapsNs.StaticTilemapLayer {
    /**
      * 
      * @param scene The Scene to which this Game Object belongs.
      * @param tilemap The Tilemap this layer is a part of.
  ...
  class Tile protected ()
    extends phaserLib.PhaserNs.TilemapsNs.Tile {
    /**
      * 
      ...
      * base tile height.
      */
    def this(layer: phaserLib.PhaserNs.TilemapsNs.LayerData, index: phaserLib.integer, x: phaserLib.integer, y: phaserLib.integer, width: phaserLib.integer, height: phaserLib.integer, baseWidth: phaserLib.integer, baseHeight: phaserLib.integer) = this()
  }
  ...
  class Tilemap protected ()
    extends phaserLib.PhaserNs.TilemapsNs.Tilemap {
    /**
      * 
      * @param scene The Scene to which this Tilemap belongs.
      * @param mapData A MapData instance containing Tilemap data.
      */
    def this(scene: phaserLib.PhaserNs.Scene, mapData: phaserLib.PhaserNs.TilemapsNs.MapData) = this()
  }
  ...
  class Tileset protected ()
    extends phaserLib.PhaserNs.TilemapsNs.Tileset {
    /**
      * 
  ...
  object FormatsNs extends js.Object {
    /**
      * 2D Array Map Type
      */
    var ARRAY_2D: scala.Double = js.native
    /**
      * CSV Map Type
      */
    var CSV: scala.Double = js.native
    /**
      * Tiled JSON Map Type
      */
    var TILED_JSON: scala.Double = js.native
    /**
      * Weltmeister (Impact.js) Map Type
      */
    var WELTMEISTER: scala.Double = js.native
  }
