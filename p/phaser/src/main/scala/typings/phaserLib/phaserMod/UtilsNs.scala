...
object UtilsNs extends js.Object {
  ...
  object ArrayNs extends js.Object {
    ...
    def Add(array: js.Array[_], item: js.Any, limit: phaserLib.integer): js.Array[_] = js.native
    def Add(array: js.Array[_], item: js.Any, limit: phaserLib.integer, callback: js.Function): js.Array[_] = js.native
    def Add(
      array: js.Array[_],
      item: js.Any,
      limit: phaserLib.integer,
      callback: js.Function,
      context: js.Object
    ): js.Array[_] = js.native
    def Add(array: js.Array[_], item: js.Array[_]): js.Array[_] = js.native
    def Add(array: js.Array[_], item: js.Array[_], limit: phaserLib.integer): js.Array[_] = js.native
    def Add(array: js.Array[_], item: js.Array[_], limit: phaserLib.integer, callback: js.Function): js.Array[_] = js.native
    def Add(
      array: js.Array[_],
      item: js.Array[_],
      limit: phaserLib.integer,
    ...
    def AddAt(array: js.Array[_], item: js.Any, index: phaserLib.integer): js.Array[_] = js.native
    def AddAt(array: js.Array[_], item: js.Any, index: phaserLib.integer, limit: phaserLib.integer): js.Array[_] = js.native
    def AddAt(
      array: js.Array[_],
      item: js.Any,
    ...
    def AddAt(array: js.Array[_], item: js.Array[_], index: phaserLib.integer): js.Array[_] = js.native
    def AddAt(array: js.Array[_], item: js.Array[_], index: phaserLib.integer, limit: phaserLib.integer): js.Array[_] = js.native
    def AddAt(
      array: js.Array[_],
      item: js.Array[_],
      index: phaserLib.integer,
    ...
    /**
      ...
      */
    def CountAllMatching(array: js.Array[_], property: java.lang.String, value: js.Any): phaserLib.integer = js.native
    def CountAllMatching(array: js.Array[_], property: java.lang.String, value: js.Any, startIndex: phaserLib.integer): phaserLib.integer = js.native
    ...
    /**
      ...
      */
    def FindClosestInSorted(value: scala.Double, array: js.Array[_]): scala.Double | js.Any = js.native
    def FindClosestInSorted(value: scala.Double, array: js.Array[_], key: java.lang.String): scala.Double | js.Any = js.native
    /**
    ...
    def GetAll(array: js.Array[_], property: java.lang.String): js.Array[_] = js.native
    def GetAll(array: js.Array[_], property: java.lang.String, value: js.Any): js.Array[_] = js.native
    def GetAll(array: js.Array[_], property: java.lang.String, value: js.Any, startIndex: phaserLib.integer): js.Array[_] = js.native
    def GetAll(
      array: js.Array[_],
      property: java.lang.String,
      value: js.Any,
    ...
    def GetFirst(array: js.Array[_], property: java.lang.String): js.Object = js.native
    def GetFirst(array: js.Array[_], property: java.lang.String, value: js.Any): js.Object = js.native
    def GetFirst(array: js.Array[_], property: java.lang.String, value: js.Any, startIndex: phaserLib.integer): js.Object = js.native
    def GetFirst(
      array: js.Array[_],
      property: java.lang.String,
      value: js.Any,
    ...
    def GetRandom(array: js.Array[_], startIndex: phaserLib.integer): js.Any = js.native
    def GetRandom(array: js.Array[_], startIndex: phaserLib.integer, length: phaserLib.integer): js.Any = js.native
    /**
    ...
    /**
      ...
      */
    def MoveTo(array: js.Array[_], item: js.Any, index: phaserLib.integer): js.Any = js.native
    /**
    ...
    /**
      ...
      */
    def NumberArrayStep(): js.Array[scala.Double] = js.native
    def NumberArrayStep(start: scala.Double): js.Array[scala.Double] = js.native
    def NumberArrayStep(start: scala.Double, end: scala.Double): js.Array[scala.Double] = js.native
    def NumberArrayStep(start: scala.Double, end: scala.Double, step: scala.Double): js.Array[scala.Double] = js.native
    /**
      ...
      */
    def QuickSelect(arr: js.Array[_], k: phaserLib.integer): scala.Unit = js.native
    def QuickSelect(arr: js.Array[_], k: phaserLib.integer, left: phaserLib.integer): scala.Unit = js.native
    def QuickSelect(arr: js.Array[_], k: phaserLib.integer, left: phaserLib.integer, right: phaserLib.integer): scala.Unit = js.native
    def QuickSelect(
      arr: js.Array[_],
      k: phaserLib.integer,
      left: phaserLib.integer,
      right: phaserLib.integer,
      compare: js.Function
    ...
    /**
      ...
      * @param context The context in which the callback is invoked.
      */
    def RemoveAt(array: js.Array[_], index: phaserLib.integer): js.Any = js.native
    def RemoveAt(array: js.Array[_], index: phaserLib.integer, callback: js.Function): js.Any = js.native
    def RemoveAt(array: js.Array[_], index: phaserLib.integer, callback: js.Function, context: js.Object): js.Any = js.native
    /**
      ...
      * @param context The context in which the callback is invoked.
      */
    def RemoveBetween(array: js.Array[_], startIndex: phaserLib.integer, endIndex: phaserLib.integer): js.Array[_] = js.native
    def RemoveBetween(
      array: js.Array[_],
      startIndex: phaserLib.integer,
      endIndex: phaserLib.integer,
    ...
    def RemoveRandomElement(array: js.Array[_], start: phaserLib.integer): js.Object = js.native
    def RemoveRandomElement(array: js.Array[_], start: phaserLib.integer, length: phaserLib.integer): js.Object = js.native
    /**
      ...
      */
    def Replace(oldChild: js.Any, newChild: js.Any): scala.Boolean = js.native
    /**
    ...
    def RotateLeft(array: js.Array[_], total: phaserLib.integer): js.Any = js.native
    /**
    ...
    def RotateRight(array: js.Array[_], total: phaserLib.integer): js.Any = js.native
    /**
      ...
      */
    def SafeRange(array: js.Array[_], startIndex: phaserLib.integer, endIndex: phaserLib.integer): scala.Boolean = js.native
    def SafeRange(
      array: js.Array[_],
      startIndex: phaserLib.integer,
      endIndex: phaserLib.integer,
      throwError: scala.Boolean
    ...
    /**
      ...
      * @param endIndex An optional end index to search to.
      */
    def SetAll(array: js.Array[_], property: java.lang.String, value: js.Any): js.Array[_] = js.native
    def SetAll(array: js.Array[_], property: java.lang.String, value: js.Any, startIndex: phaserLib.integer): js.Array[_] = js.native
    def SetAll(
      array: js.Array[_],
      property: java.lang.String,
      value: js.Any,
    ...
    /**
      ...
      */
    def SpliceOne(array: js.Array[_], index: phaserLib.integer): js.Any = js.native
    /**
    ...
    @JSName("Matrix")
    @js.native
    object MatrixNs extends js.Object {
      /**
        ...
        */
      def CheckMatrix[T](): scala.Boolean = js.native
      def CheckMatrix[T](matrix: js.Array[js.Array[T]]): scala.Boolean = js.native
      /**
        * Generates a string (which you can pass to console.log) from the given Array Matrix.
        * @param matrix A 2-dimensional array.
        */
      def MatrixToString[T](): java.lang.String = js.native
      def MatrixToString[T](matrix: js.Array[js.Array[T]]): java.lang.String = js.native
      /**
      ...
      def RotateMatrix[T](matrix: js.Array[js.Array[T]], direction: java.lang.String): js.Array[js.Array[T]] = js.native
      def RotateMatrix[T](matrix: js.Array[js.Array[T]], direction: scala.Double): js.Array[js.Array[T]] = js.native
      /**
        * Rotates the array matrix to the left (or -90 degrees)
        * @param matrix The array to rotate.
        */
    ...
    @JSName("StableSortFunctions")
    @js.native
    object StableSortFunctionsNs extends js.Object {
      /**
  ...
  object ObjectsNs extends js.Object {
    ...
    /**
      ...
      */
    def GetAdvancedValue(source: js.Object, key: java.lang.String, defaultValue: js.Any): js.Any = js.native
    /**
      ...
      */
    def GetFastValue(source: js.Object, key: java.lang.String): js.Any = js.native
    def GetFastValue(source: js.Object, key: java.lang.String, defaultValue: js.Any): js.Any = js.native
    /**
    ...
    /**
      ...
      * @param defaultValue The value to return if the `key` isn't found in the `source` object.
      */
    def GetValue(source: js.Object, key: java.lang.String, defaultValue: js.Any): js.Any = js.native
    /**
      ...
      */
    def HasAll(source: js.Object, keys: js.Array[java.lang.String]): scala.Boolean = js.native
    /**
      * Verifies that an object contains at least one of the requested keys
      * @param source an object on which to check for key existence
      * @param keys an array of keys to search the object for
      */
    def HasAny(source: js.Object, keys: js.Array[java.lang.String]): scala.Boolean = js.native
    /**
      ...
      */
    def HasValue(source: js.Object, key: java.lang.String): scala.Boolean = js.native
    /**
      * This is a slightly modified version of jQuery.isPlainObject.
      * A plain object is an object whose internal class property is [object Object].
      * @param obj The object to inspect.
      */
    def IsPlainObject(obj: js.Object): scala.Boolean = js.native
    /**
    ...
    /**
      ...
      */
    def SetValue(source: js.Object, key: java.lang.String, value: js.Any): scala.Boolean = js.native
  }
  ...
  object StringNs extends js.Object {
    ...
    def Pad(str: java.lang.String, len: phaserLib.integer): java.lang.String = js.native
    def Pad(str: java.lang.String, len: phaserLib.integer, pad: java.lang.String): java.lang.String = js.native
    def Pad(str: java.lang.String, len: phaserLib.integer, pad: java.lang.String, dir: phaserLib.integer): java.lang.String = js.native
    /**
