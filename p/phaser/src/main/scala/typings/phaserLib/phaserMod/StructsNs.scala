...
object StructsNs extends js.Object {
  ...
  class List[T] protected ()
    extends phaserLib.PhaserNs.StructsNs.List[T] {
    /**
      * 
  ...
  class Map[K, V] protected ()
    extends phaserLib.PhaserNs.StructsNs.Map[K, V] {
    /**
      * 
  ...
  class ProcessQueue[T] ()
    extends phaserLib.PhaserNs.StructsNs.ProcessQueue[T]
  ...
  @js.native
  class RTree ()
    extends phaserLib.PhaserNs.StructsNs.RTree
  ...
  /**
    ...
    */
  class Set[T] ()
    extends phaserLib.PhaserNs.StructsNs.Set[T] {
  ...
  /**
    ...
    */
  class Size ()
    extends phaserLib.PhaserNs.StructsNs.Size {
    def this(width: scala.Double) = this()
    def this(width: scala.Double, height: scala.Double) = this()
    def this(width: scala.Double, height: scala.Double, aspectMode: phaserLib.integer) = this()
    def this(width: scala.Double, height: scala.Double, aspectMode: phaserLib.integer, parent: js.Any) = this()
  }
