...
@js.native
object SoundNs extends js.Object {
  /**
  ...
  class BaseSound protected ()
    extends phaserLib.PhaserNs.SoundNs.BaseSound {
    /**
      * 
      ...
      */
    def this(manager: phaserLib.PhaserNs.SoundNs.BaseSoundManager, key: java.lang.String) = this()
    def this(manager: phaserLib.PhaserNs.SoundNs.BaseSoundManager, key: java.lang.String, config: phaserLib.PhaserNs.TypesNs.SoundNs.SoundConfig) = this()
  }
  ...
  class BaseSoundManager protected ()
    extends phaserLib.PhaserNs.SoundNs.BaseSoundManager {
    /**
      * 
  ...
  class HTML5AudioSound protected ()
    extends phaserLib.PhaserNs.SoundNs.HTML5AudioSound {
    /**
      * 
      * @param manager Reference to the current sound manager instance.
      * @param key Asset key for the sound.
      ...
      */
    def this(manager: phaserLib.PhaserNs.SoundNs.HTML5AudioSoundManager, key: java.lang.String) = this()
    def this(manager: phaserLib.PhaserNs.SoundNs.HTML5AudioSoundManager, key: java.lang.String, config: phaserLib.PhaserNs.TypesNs.SoundNs.SoundConfig) = this()
  }
  ...
  class HTML5AudioSoundManager protected ()
    extends phaserLib.PhaserNs.SoundNs.HTML5AudioSoundManager {
    /**
      * 
      * @param game Reference to the current game instance.
      */
  ...
  class NoAudioSound protected ()
    extends phaserLib.PhaserNs.SoundNs.NoAudioSound {
    /**
      * 
      * @param manager Reference to the current sound manager instance.
      * @param key Asset key for the sound.
      * @param config An optional config object containing default sound settings. Default {}.
      */
    def this(manager: phaserLib.PhaserNs.SoundNs.NoAudioSoundManager, key: java.lang.String) = this()
    def this(manager: phaserLib.PhaserNs.SoundNs.NoAudioSoundManager, key: java.lang.String, config: phaserLib.PhaserNs.TypesNs.SoundNs.SoundConfig) = this()
  }
  ...
  class NoAudioSoundManager protected ()
    extends phaserLib.PhaserNs.SoundNs.NoAudioSoundManager {
    /**
      * 
      * @param game Reference to the current game instance.
      */
  ...
  class WebAudioSound protected ()
    extends phaserLib.PhaserNs.SoundNs.WebAudioSound {
    /**
      * 
      * @param manager Reference to the current sound manager instance.
      * @param key Asset key for the sound.
      * @param config An optional config object containing default sound settings. Default {}.
      */
    def this(manager: phaserLib.PhaserNs.SoundNs.WebAudioSoundManager, key: java.lang.String) = this()
    def this(manager: phaserLib.PhaserNs.SoundNs.WebAudioSoundManager, key: java.lang.String, config: phaserLib.PhaserNs.TypesNs.SoundNs.SoundConfig) = this()
  }
  ...
  class WebAudioSoundManager protected ()
    extends phaserLib.PhaserNs.SoundNs.WebAudioSoundManager {
    /**
      * 
      * @param game Reference to the current game instance.
      */
  ...
  /**
    ...
    * @param game Reference to the current game instance.
    */
  def SoundManagerCreator(game: phaserLib.PhaserNs.Game): scala.Unit = js.native
  @JSName("Events")
  @js.native
