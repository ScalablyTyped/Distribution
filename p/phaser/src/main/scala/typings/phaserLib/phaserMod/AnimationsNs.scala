...
object AnimationsNs extends js.Object {
  ...
  class Animation protected ()
    extends phaserLib.PhaserNs.AnimationsNs.Animation {
    /**
      * 
      ...
      */
    def this(manager: phaserLib.PhaserNs.AnimationsNs.AnimationManager, key: java.lang.String, config: phaserLib.PhaserNs.TypesNs.AnimationsNs.Animation) = this()
  }
  ...
  class AnimationFrame protected ()
    extends phaserLib.PhaserNs.AnimationsNs.AnimationFrame {
    /**
      * 
  ...
  class AnimationManager protected ()
    extends phaserLib.PhaserNs.AnimationsNs.AnimationManager {
    /**
      * 
