...
trait Collision extends js.Object {
  def setCollidesWith(categories: js.Array[scala.Double]): phaserLib.PhaserNs.GameObjectsNs.GameObject = js.native
  /**
    ...
    */
  def setCollidesWith(categories: scala.Double): phaserLib.PhaserNs.GameObjectsNs.GameObject = js.native
  /**
    ...
    */
  def setCollisionCategory(value: scala.Double): phaserLib.PhaserNs.GameObjectsNs.GameObject = js.native
  /**
    ...
    */
  def setCollisionGroup(value: scala.Double): phaserLib.PhaserNs.GameObjectsNs.GameObject = js.native
}
