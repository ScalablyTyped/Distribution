...
class TweenManager protected () extends js.Object {
  ...
  /**
    ...
    */
  def each(callback: js.Function): scala.Unit = js.native
  def each(callback: js.Function, scope: js.Object, args: js.Any*): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getGlobalTimeScale(): scala.Double = js.native
  ...
  /**
    ...
    */
  def setGlobalTimeScale(value: scala.Double): TweenManager = js.native
  /**
  ...
  /**
    ...
    */
  def update(timestamp: scala.Double, delta: scala.Double): scala.Unit = js.native
}
