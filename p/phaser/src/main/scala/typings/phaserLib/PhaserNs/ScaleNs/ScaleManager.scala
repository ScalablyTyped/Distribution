...
class ScaleManager protected ()
  ...
  /**
    ...
    */
  var autoRound: scala.Boolean = js.native
  /**
    ...
    */
  var baseSize: phaserLib.PhaserNs.StructsNs.Size = js.native
  /**
  ...
  /**
    ...
    */
  var canvasBounds: phaserLib.PhaserNs.GeomNs.Rectangle = js.native
  /**
  ...
  /**
    ...
    */
  var displayScale: phaserLib.PhaserNs.MathNs.Vector2 = js.native
  /**
    * The Display Size component.
    * 
    * The size used for the canvas style, factoring in the scale mode, parent and other values.
    */
  var displaySize: phaserLib.PhaserNs.StructsNs.Size = js.native
  /**
    * A reference to the Device.Fullscreen object.
    */
  var fullscreen: phaserLib.PhaserNs.DeviceNs.Fullscreen = js.native
  /**
  ...
  /**
    ...
    */
  var gameSize: phaserLib.PhaserNs.StructsNs.Size = js.native
  /**
    * The game height.
    * 
  ...
  /**
    ...
    */
  val isGameLandscape: scala.Boolean = js.native
  /**
    ...
    */
  val isGamePortrait: scala.Boolean = js.native
  /**
    ...
    */
  val isLandscape: scala.Boolean = js.native
  /**
    * Is the device in a portrait orientation as reported by the Orientation API?
    * This value is usually only available on mobile devices.
    */
  val isPortrait: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  var parentIsWindow: scala.Boolean = js.native
  /**
    * The Parent Size component.
    */
  var parentSize: phaserLib.PhaserNs.StructsNs.Size = js.native
  /**
    ...
    * checked here.
    */
  var resizeInterval: phaserLib.integer = js.native
  /**
  ...
  /**
    ...
    */
  def lockOrientation(orientation: java.lang.String): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @param config The Game configuration object.
    */
  /* protected */ def parseConfig(config: phaserLib.PhaserNs.TypesNs.CoreNs.GameConfig): scala.Unit = js.native
  /**
    * Called _before_ the canvas object is created and added to the DOM.
    */
  /* protected */ def preBoot(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def removeFullscreenTarget(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param height The new height of the game.
    */
  def setGameSize(width: scala.Double, height: scala.Double): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def setParentSize(width: scala.Double, height: scala.Double): this.type = js.native
  /**
    * Sets the zoom value of the Scale Manager.
    * @param value The new zoom value of the game.
    */
  def setZoom(value: phaserLib.integer): this.type = js.native
  /**
  ...
  def startFullscreen(fullscreenOptions: js.Object): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def stopFullscreen(): scala.Unit = js.native
  /**
