...
class Set[T] () extends js.Object {
  ...
  /**
    ...
    */
  var size: phaserLib.integer = js.native
  /**
  ...
  /**
    ...
    */
  def each(callback: phaserLib.EachSetCallback[T]): Set[T] = js.native
  def each(callback: phaserLib.EachSetCallback[T], callbackScope: js.Any): Set[T] = js.native
  /**
    ...
    */
  def get(property: java.lang.String, value: T): T = js.native
  /**
  ...
  /**
    ...
    * @param callbackScope The scope of the callback.
    */
  def iterate(callback: phaserLib.EachSetCallback[T]): Set[T] = js.native
  def iterate(callback: phaserLib.EachSetCallback[T], callbackScope: js.Any): Set[T] = js.native
  /**
    ...
    */
  def iterateLocal(callbackKey: java.lang.String, args: js.Any*): Set[T] = js.native
  /**
