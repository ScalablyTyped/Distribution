...
class Container protected ()
  ...
  def this(scene: phaserLib.PhaserNs.Scene, x: scala.Double, y: scala.Double, children: js.Array[GameObject]) = this()
  /**
  ...
  /**
    ...
    */
  val displayOriginX: scala.Double = js.native
  /**
    * Internal value to allow Containers to be used for input and physics.
    * Do not change this value. It has no effect other than to break things.
    */
  val displayOriginY: scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  var localTransform: phaserLib.PhaserNs.GameObjectsNs.ComponentsNs.TransformMatrix = js.native
  /**
  ...
  /**
    ...
    * Do not change this value. It has no effect other than to break things.
    */
  val originX: scala.Double = js.native
  /**
    * Internal value to allow Containers to be used for input and physics.
    * Do not change this value. It has no effect other than to break things.
    */
  val originY: scala.Double = js.native
  /**
    * The cursor position.
    */
  ...
  def addAt(child: js.Array[GameObject], index: phaserLib.integer): Container = js.native
  /**
  ...
  def addAt(child: GameObject, index: phaserLib.integer): Container = js.native
  /**
  ...
  /**
    ...
    */
  def count(property: java.lang.String, value: js.Any): phaserLib.integer = js.native
  def count(property: java.lang.String, value: js.Any, startIndex: phaserLib.integer): phaserLib.integer = js.native
  def count(
    property: java.lang.String,
    value: js.Any,
    startIndex: phaserLib.integer,
    endIndex: phaserLib.integer
  ): phaserLib.integer = js.native
  /**
  ...
  /**
    ...
    */
  def exists(child: GameObject): scala.Boolean = js.native
  /**
  ...
  def getAll(property: java.lang.String): js.Array[GameObject] = js.native
  def getAll(property: java.lang.String, value: js.Any): js.Array[GameObject] = js.native
  def getAll(property: java.lang.String, value: js.Any, startIndex: phaserLib.integer): js.Array[GameObject] = js.native
  def getAll(
    property: java.lang.String,
    value: js.Any,
    startIndex: phaserLib.integer,
  ...
  /**
    ...
    */
  def getAt(index: phaserLib.integer): GameObject = js.native
  /**
  ...
  def getBounds(output: phaserLib.PhaserNs.GeomNs.Rectangle): phaserLib.PhaserNs.GeomNs.Rectangle = js.native
  /**
    * Returns the world transform matrix as used for Bounds checks.
    * 
    * The returned matrix is temporal and shouldn't be stored.
    */
  def getBoundsTransformMatrix(): phaserLib.PhaserNs.GameObjectsNs.ComponentsNs.TransformMatrix = js.native
  /**
    * Searches for the first instance of a child with its `name` property matching the given argument.
    * Should more than one child have the same name only the first is returned.
    * @param name The name to search for.
    */
  def getByName(name: java.lang.String): GameObject = js.native
  /**
    ...
    * @param endIndex An optional end index to search up to (but not included) Default Container.length.
    */
  def getFirst(property: java.lang.String, value: js.Any): GameObject = js.native
  def getFirst(property: java.lang.String, value: js.Any, startIndex: phaserLib.integer): GameObject = js.native
  def getFirst(
    property: java.lang.String,
    value: js.Any,
    startIndex: phaserLib.integer,
  ...
  /**
    ...
    */
  def getIndex(child: GameObject): phaserLib.integer = js.native
  /**
  ...
  def getRandom(startIndex: phaserLib.integer): GameObject = js.native
  def getRandom(startIndex: phaserLib.integer, length: phaserLib.integer): GameObject = js.native
  /**
    * Passes all Game Objects in this Container to the given callback.
    * 
  ...
  /**
    ...
    */
  def moveTo(child: GameObject, index: phaserLib.integer): Container = js.native
  /**
  ...
  /**
    ...
    */
  def pointToContainer(source: js.Object): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def pointToContainer(source: js.Object, output: js.Object): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def pointToContainer(source: js.Object, output: phaserLib.PhaserNs.GeomNs.Point): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def pointToContainer(source: js.Object, output: phaserLib.PhaserNs.MathNs.Vector2): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def pointToContainer(source: phaserLib.PhaserNs.GeomNs.Point): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def pointToContainer(source: phaserLib.PhaserNs.GeomNs.Point, output: js.Object): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def pointToContainer(source: phaserLib.PhaserNs.GeomNs.Point, output: phaserLib.PhaserNs.GeomNs.Point): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def pointToContainer(source: phaserLib.PhaserNs.GeomNs.Point, output: phaserLib.PhaserNs.MathNs.Vector2): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def pointToContainer(source: phaserLib.PhaserNs.MathNs.Vector2): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def pointToContainer(source: phaserLib.PhaserNs.MathNs.Vector2, output: js.Object): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def pointToContainer(source: phaserLib.PhaserNs.MathNs.Vector2, output: phaserLib.PhaserNs.GeomNs.Point): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def pointToContainer(source: phaserLib.PhaserNs.MathNs.Vector2, output: phaserLib.PhaserNs.MathNs.Vector2): js.Object | phaserLib.PhaserNs.GeomNs.Point | phaserLib.PhaserNs.MathNs.Vector2 = js.native
  /**
    * Internal destroy handler, called as part of the destroy process.
    */
  /* protected */ def preDestroy(): scala.Unit = js.native
  def remove(child: js.Array[GameObject]): Container = js.native
  def remove(child: js.Array[GameObject], destroyChild: scala.Boolean): Container = js.native
  /**
  ...
  def remove(child: GameObject, destroyChild: scala.Boolean): Container = js.native
  /**
  ...
  def removeAll(destroyChild: scala.Boolean): Container = js.native
  /**
    ...
    */
  def removeAt(index: phaserLib.integer): Container = js.native
  def removeAt(index: phaserLib.integer, destroyChild: scala.Boolean): Container = js.native
  /**
  ...
  def removeBetween(startIndex: phaserLib.integer): Container = js.native
  def removeBetween(startIndex: phaserLib.integer, endIndex: phaserLib.integer): Container = js.native
  def removeBetween(startIndex: phaserLib.integer, endIndex: phaserLib.integer, destroyChild: scala.Boolean): Container = js.native
  /**
  ...
  def replace(oldChild: GameObject, newChild: GameObject, destroyChild: scala.Boolean): Container = js.native
  /**
  ...
  /**
    ...
    * @param endIndex An optional end index to search up to (but not included) Default Container.length.
    */
  def setAll(property: java.lang.String, value: js.Any): Container = js.native
  def setAll(property: java.lang.String, value: js.Any, startIndex: phaserLib.integer): Container = js.native
  def setAll(
    property: java.lang.String,
    value: js.Any,
    startIndex: phaserLib.integer,
  ...
  def setExclusive(value: scala.Boolean): Container = js.native
  /**
    ...
    */
  def setScrollFactor(x: scala.Double): this.type = js.native
  def setScrollFactor(x: scala.Double, y: scala.Double): this.type = js.native
  def setScrollFactor(x: scala.Double, y: scala.Double, updateChildren: scala.Boolean): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def sort(property: java.lang.String): Container = js.native
  def sort(property: java.lang.String, handler: js.Function): Container = js.native
  /**
