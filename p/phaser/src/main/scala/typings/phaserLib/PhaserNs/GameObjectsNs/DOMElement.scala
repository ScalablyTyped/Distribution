...
class DOMElement protected ()
  ...
  /**
    ...
    */
  var cache: phaserLib.PhaserNs.CacheNs.BaseCache = js.native
  /**
  ...
  /**
    ...
    */
  var rotate3d: phaserLib.PhaserNs.MathNs.Vector4 = js.native
  /**
    ...
    * https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function/rotate3d
    */
  var rotate3dAngle: java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  var transformOnly: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def addListener(events: java.lang.String): this.type = js.native
  /**
    ...
    */
  def createElement(tagName: java.lang.String): this.type = js.native
  def createElement(tagName: java.lang.String, style: java.lang.String): this.type = js.native
  def createElement(tagName: java.lang.String, style: java.lang.String, innerText: java.lang.String): this.type = js.native
  def createElement(tagName: java.lang.String, style: js.Any): this.type = js.native
  def createElement(tagName: java.lang.String, style: js.Any, innerText: java.lang.String): this.type = js.native
  /**
    ...
    */
  def createFromCache(The: java.lang.String): this.type = js.native
  def createFromCache(The: java.lang.String, tagName: java.lang.String): this.type = js.native
  /**
    ...
    */
  def createFromHTML(A: java.lang.String): this.type = js.native
  def createFromHTML(A: java.lang.String, tagName: java.lang.String): this.type = js.native
  /**
    ...
    */
  def getChildByID(id: java.lang.String): stdLib.Element = js.native
  /**
    * Gets all children from this DOM Elements node, using `querySelectorAll('*')` and then iterates through
    ...
    */
  def getChildByName(name: java.lang.String): stdLib.Element = js.native
  /**
    * Gets all children from this DOM Elements node, using `querySelectorAll('*')` and then iterates through
    ...
    */
  def getChildByProperty(property: java.lang.String, value: java.lang.String): stdLib.Element = js.native
  /**
  ...
  /**
    ...
    */
  def setClassName(className: java.lang.String): this.type = js.native
  /**
    * The depth of this Game Object within the Scene.
    * 
    * The depth is also known as the 'z-index' in some environments, and allows you to change the rendering order
  ...
  /**
    ...
    * @param innerText A DOMString that holds the text that will be set as the innerText of the created element.
    */
  def setElement(element: java.lang.String): this.type = js.native
  def setElement(element: java.lang.String, style: java.lang.String): this.type = js.native
  def setElement(element: java.lang.String, style: java.lang.String, innerText: java.lang.String): this.type = js.native
  def setElement(element: java.lang.String, style: js.Any): this.type = js.native
  def setElement(element: java.lang.String, style: js.Any, innerText: java.lang.String): this.type = js.native
  def setElement(element: stdLib.Element): this.type = js.native
  def setElement(element: stdLib.Element, style: java.lang.String): this.type = js.native
  def setElement(element: stdLib.Element, style: java.lang.String, innerText: java.lang.String): this.type = js.native
  def setElement(element: stdLib.Element, style: js.Any): this.type = js.native
  def setElement(element: stdLib.Element, style: js.Any, innerText: java.lang.String): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def setPerspective(value: scala.Double): this.type = js.native
  /**
  ...
  def setSkew(x: scala.Double): this.type = js.native
  def setSkew(x: scala.Double, y: scala.Double): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def willRender(): scala.Boolean = js.native
}
