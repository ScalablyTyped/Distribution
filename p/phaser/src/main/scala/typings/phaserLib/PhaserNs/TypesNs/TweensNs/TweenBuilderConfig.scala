...
trait TweenBuilderConfig extends js.Object {
  ...
  var props: js.UndefOr[
    org.scalablytyped.runtime.StringDictionary[scala.Double | java.lang.String | GetEndCallback | TweenPropConfig]
  ] = js.undefined
  /**
...
object TweenBuilderConfig {
  ...
  def apply(
    ...
    props: org.scalablytyped.runtime.StringDictionary[scala.Double | java.lang.String | GetEndCallback | TweenPropConfig] = null,
