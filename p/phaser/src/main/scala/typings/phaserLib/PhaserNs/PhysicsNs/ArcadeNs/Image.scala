...
- phaserLib.PhaserNs.TypesNs.PhysicsNs.ArcadeNs._ArcadeColliderType because Already inherited- phaserLib.PhaserNs.GameObjectsNs.ComponentsNs.Texture because var conflicts: frame, texture. Inlined  */ @JSGlobal("Phaser.Physics.Arcade.Image")
@js.native
class Image protected ()
  ...
  /**
    ...
    */
  @JSName("body")
  var body_Image: Body | StaticBody = js.native
  /**
