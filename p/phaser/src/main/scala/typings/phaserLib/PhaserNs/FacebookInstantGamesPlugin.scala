...
class FacebookInstantGamesPlugin protected ()
  ...
  /**
    ...
    */
  var ads: js.Array[phaserLib.AdInstance] = js.native
  /**
    * The set of products that are registered to the game.
    */
  var catalog: js.Array[phaserLib.Product] = js.native
  /**
  ...
  /**
    ...
    * This value is populated automatically during boot.
    */
  var contextType: java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  var dataLocked: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  var paymentsReady: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  var playerCanSubscribeBot: scala.Boolean = js.native
  /**
    ...
    */
  var playerID: java.lang.String = js.native
  /**
    * The player's localized display name.
    * This value is populated automatically during boot if the API is supported.
    */
  var playerName: java.lang.String = js.native
  /**
    ...
    * This value is populated automatically during boot if the API is supported.
    */
  var playerPhotoURL: java.lang.String = js.native
  /**
    ...
    */
  var purchases: js.Array[phaserLib.Purchase] = js.native
  /**
    ...
    * This value is populated automatically during boot.
    */
  var supportedAPIs: js.Array[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  def checkAPI(api: java.lang.String): scala.Boolean = js.native
  /**
    ...
    */
  def chooseContext(contextID: java.lang.String): this.type = js.native
  /**
    ...
    */
  def consumePurchase(purchaseToken: java.lang.String): this.type = js.native
  /**
    ...
    */
  def createContext(playerID: java.lang.String): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def gameStarted(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getData(keys: java.lang.String): this.type = js.native
  def getData(keys: js.Array[java.lang.String]): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def getLeaderboard(name: java.lang.String): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def getPlatform(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getPlayerPhotoURL(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getProduct(productID: java.lang.String): phaserLib.Product = js.native
  /**
  ...
  def getStats(keys: js.Array[java.lang.String]): this.type = js.native
  /**
  ...
  def isSizeBetween(min: phaserLib.integer): js.Object = js.native
  def isSizeBetween(min: phaserLib.integer, max: phaserLib.integer): js.Object = js.native
  /**
    ...
    */
  def loadPlayerPhoto(scene: Scene, key: java.lang.String): this.type = js.native
  /**
    ...
    */
  def log(name: java.lang.String): this.type = js.native
  def log(name: java.lang.String, value: scala.Double): this.type = js.native
  def log(name: java.lang.String, value: scala.Double, params: js.Object): this.type = js.native
  /**
  ...
  def matchPlayer(matchTag: java.lang.String): this.type = js.native
  def matchPlayer(matchTag: java.lang.String, switchImmediately: scala.Boolean): this.type = js.native
  /**
    ...
    */
  def openChallenge(text: java.lang.String, key: java.lang.String): this.type = js.native
  def openChallenge(text: java.lang.String, key: java.lang.String, frame: java.lang.String): this.type = js.native
  def openChallenge(text: java.lang.String, key: java.lang.String, frame: java.lang.String, sessionData: js.Object): this.type = js.native
  /**
    ...
    * @param sessionData A blob of data to attach to the share.
    */
  def openInvite(text: java.lang.String, key: java.lang.String): this.type = js.native
  def openInvite(text: java.lang.String, key: java.lang.String, frame: java.lang.String): this.type = js.native
  def openInvite(text: java.lang.String, key: java.lang.String, frame: java.lang.String, sessionData: js.Object): this.type = js.native
  /**
    * This invokes a dialog to let the user share specified content, either as a message in Messenger or as a post on the user's timeline.
    * 
    * A blob of data can be attached to the share which every game session launched from the share will be able to access via the `this.entryPointData` property.
    ...
    * @param sessionData A blob of data to attach to the share.
    */
  def openRequest(text: java.lang.String, key: java.lang.String): this.type = js.native
  def openRequest(text: java.lang.String, key: java.lang.String, frame: java.lang.String): this.type = js.native
  def openRequest(text: java.lang.String, key: java.lang.String, frame: java.lang.String, sessionData: js.Object): this.type = js.native
  /**
    * This invokes a dialog to let the user share specified content, either as a message in Messenger or as a post on the user's timeline.
    * 
    * A blob of data can be attached to the share which every game session launched from the share will be able to access via the `this.entryPointData` property.
    ...
    * @param sessionData A blob of data to attach to the share.
    */
  def openShare(text: java.lang.String, key: java.lang.String): this.type = js.native
  def openShare(text: java.lang.String, key: java.lang.String, frame: java.lang.String): this.type = js.native
  def openShare(text: java.lang.String, key: java.lang.String, frame: java.lang.String, sessionData: js.Object): this.type = js.native
  /**
    ...
    */
  def preloadAds(placementID: java.lang.String): this.type = js.native
  def preloadAds(placementID: js.Array[java.lang.String]): this.type = js.native
  /**
    ...
    * @param placementID The ad placement ID, or an array of IDs, as created in your Audience Network settings within Facebook.
    */
  def preloadVideoAds(placementID: java.lang.String): this.type = js.native
  def preloadVideoAds(placementID: js.Array[java.lang.String]): this.type = js.native
  /**
    ...
    */
  def purchase(productID: java.lang.String): this.type = js.native
  def purchase(productID: java.lang.String, developerPayload: java.lang.String): this.type = js.native
  /**
    * Quits the game.
    */
  ...
  /**
    ...
    */
  def showAd(placementID: java.lang.String): this.type = js.native
  /**
  ...
  /**
    ...
    * @param placementID The ad placement ID to display.
    */
  def showVideo(placementID: java.lang.String): this.type = js.native
  /**
  ...
  /**
    ...
    * @param contextID The ID of the desired context.
    */
  def switchContext(contextID: java.lang.String): this.type = js.native
  /**
    ...
    */
  def switchGame(appID: java.lang.String): this.type = js.native
  def switchGame(appID: java.lang.String, data: js.Object): this.type = js.native
  /**
    ...
    */
  def update(
    cta: java.lang.String,
    text: js.Object,
    key: java.lang.String,
    frame: java.lang.String,
    template: java.lang.String,
    updateData: js.Object
  ): this.type = js.native
  def update(
    cta: java.lang.String,
    text: js.Object,
