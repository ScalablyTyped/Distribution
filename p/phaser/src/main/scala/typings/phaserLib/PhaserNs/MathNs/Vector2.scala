...
class Vector2 () extends js.Object {
  ...
  /**
    ...
    */
  def cross(src: Vector2): scala.Double = js.native
  /**
    * Calculate the distance between this Vector and the given Vector.
    * @param src The Vector to calculate the distance to.
    */
  def distance(src: Vector2): scala.Double = js.native
  /**
    * Calculate the distance between this Vector and the given Vector, squared.
    * @param src The Vector to calculate the distance to.
    */
  def distanceSq(src: Vector2): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def dot(src: Vector2): scala.Double = js.native
  /**
  ...
  def lerp(src: Vector2, t: scala.Double): Vector2 = js.native
  /**
  ...
  /**
    ...
    */
  def setFromObject(obj: phaserLib.PhaserNs.TypesNs.MathNs.Vector2Like): Vector2 = js.native
  /**
    * This method is an alias for `Vector2.set`.
    * @param x The x value to set for this Vector.
    * @param y The y value to set for this Vector. Default x.
    */
  def setTo(x: scala.Double): Vector2 = js.native
  def setTo(x: scala.Double, y: scala.Double): Vector2 = js.native
  /**
    * Sets the `x` and `y` values of this object from a given polar coordinate.
    * @param azimuth The angular coordinate, in radians.
    * @param radius The radial coordinate (length). Default 1.
    */
  def setToPolar(azimuth: scala.Double): Vector2 = js.native
  def setToPolar(azimuth: scala.Double, radius: scala.Double): Vector2 = js.native
  /**
