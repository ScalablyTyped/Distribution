...
class BitmapMaskPipeline protected ()
  ...
  /**
    * Size of the batch.
    */
  var maxQuads: scala.Double = js.native
  /**
    * Dirty flag to check if resolution properties need to be updated on the 
    * masking shader.
    */
  var resolutionDirty: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def endMask(mask: phaserLib.PhaserNs.GameObjectsNs.GameObject): scala.Unit = js.native
}
