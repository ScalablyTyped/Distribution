...
trait Angular extends js.Object {
  /**
    ...
    */
  def setAngularAcceleration(value: scala.Double): this.type
  /**
    * Sets the angular drag of the body. Drag is applied to the current velocity, providing a form of deceleration.
    * @param value The amount of drag.
    */
  def setAngularDrag(value: scala.Double): this.type
  /**
    ...
    */
  def setAngularVelocity(value: scala.Double): this.type
}

object Angular {
  @scala.inline
  def apply(
    setAngularAcceleration: scala.Double => Angular,
    setAngularDrag: scala.Double => Angular,
    setAngularVelocity: scala.Double => Angular
  ): Angular = {
