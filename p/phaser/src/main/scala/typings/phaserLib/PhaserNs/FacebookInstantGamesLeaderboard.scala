...
class FacebookInstantGamesLeaderboard protected () extends js.Object {
  ...
  /**
    ...
    */
  var contextID: java.lang.String = js.native
  /**
    ...
    */
  var entryCount: phaserLib.integer = js.native
  /**
  ...
  /**
    ...
    */
  var playerScore: phaserLib.LeaderboardScore = js.native
  /**
  ...
  /**
    ...
    */
  var scores: js.Array[phaserLib.LeaderboardScore] = js.native
  /**
  ...
  def getConnectedScores(count: phaserLib.integer): this.type = js.native
  def getConnectedScores(count: phaserLib.integer, offset: phaserLib.integer): this.type = js.native
  /**
  ...
  def getScores(count: phaserLib.integer): this.type = js.native
  def getScores(count: phaserLib.integer, offset: phaserLib.integer): this.type = js.native
  /**
    ...
    */
  def setScore(score: phaserLib.integer): this.type = js.native
  def setScore(score: phaserLib.integer, data: java.lang.String): this.type = js.native
  def setScore(score: phaserLib.integer, data: js.Any): this.type = js.native
}
