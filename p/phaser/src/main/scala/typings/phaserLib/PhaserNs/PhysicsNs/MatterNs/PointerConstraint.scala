...
class PointerConstraint protected () extends js.Object {
  /**
    ...
    */
  def this(scene: phaserLib.PhaserNs.Scene, world: World) = this()
  def this(scene: phaserLib.PhaserNs.Scene, world: World, options: js.Object) = this()
  /**
  ...
  /**
    ...
    */
  var part: phaserLib.MatterJSNs.Body = js.native
  /**
  ...
  /**
    ...
    * body.
    */
  def getBody(): scala.Boolean = js.native
  /**
    ...
    */
  def hitTestBody(body: phaserLib.MatterJSNs.Body, position: phaserLib.PhaserNs.MathNs.Vector2): scala.Boolean = js.native
  /**
    ...
    */
  def onDown(pointer: phaserLib.PhaserNs.InputNs.Pointer): scala.Unit = js.native
  /**
    ...
    */
  def stopDrag(): scala.Unit = js.native
  /**
