...
class Matrix4 () extends js.Object {
  ...
  def makeRotationAxis(axis: Vector4, angle: scala.Double): Matrix4 = js.native
  /**
  ...
  /**
    ...
    * @param far Far bound of the frustum.
    */
  def perspectiveLH(width: scala.Double, height: scala.Double, near: scala.Double, far: scala.Double): Matrix4 = js.native
  /**
    * Apply a rotation transformation to this Matrix.
    * @param rad The angle in radians to rotate by.
    * @param axis The axis to rotate upon.
    */
  def rotate(rad: scala.Double, axis: Vector3): Matrix4 = js.native
  /**
    * Rotate this matrix on its X axis.
    * @param rad The angle in radians to rotate by.
    */
  def rotateX(rad: scala.Double): Matrix4 = js.native
  /**
    * Rotate this matrix on its Y axis.
    * @param rad The angle to rotate by, in radians.
    */
  def rotateY(rad: scala.Double): Matrix4 = js.native
  /**
    * Rotate this matrix on its Z axis.
    * @param rad The angle to rotate by, in radians.
    */
  def rotateZ(rad: scala.Double): Matrix4 = js.native
  /**
  ...
  /**
    ...
    */
  def scaleXYZ(x: scala.Double, y: scala.Double, z: scala.Double): Matrix4 = js.native
  /**
    ...
    */
  def scaling(x: scala.Double, y: scala.Double, z: scala.Double): Matrix4 = js.native
  /**
  ...
  /**
    ...
    * @param z The z component.
    */
  def translateXYZ(x: scala.Double, y: scala.Double, z: scala.Double): Matrix4 = js.native
  /**
  ...
  /**
    ...
    * @param z The z value.
    */
  def xyz(x: scala.Double, y: scala.Double, z: scala.Double): Matrix4 = js.native
  /**
    ...
    */
  def yawPitchRoll(yaw: scala.Double, pitch: scala.Double, roll: scala.Double): Matrix4 = js.native
  /**
    * Reset this Matrix.
    * 
