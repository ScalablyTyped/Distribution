...
trait Drag extends js.Object {
  /**
    ...
    */
  def setDamping(value: scala.Boolean): this.type = js.native
  /**
    ...
    */
  def setDrag(x: scala.Double): this.type = js.native
  def setDrag(x: scala.Double, y: scala.Double): this.type = js.native
  /**
    ...
    */
  def setDragX(value: scala.Double): this.type = js.native
  /**
    ...
    */
  def setDragY(value: scala.Double): this.type = js.native
}
