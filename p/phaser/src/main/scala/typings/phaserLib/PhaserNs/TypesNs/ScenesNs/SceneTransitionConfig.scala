...
trait SceneTransitionConfig extends js.Object {
  ...
  /**
    ...
    */
  var moveAbove: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * Move the target Scene to be below this one before the transition starts.
    */
  var moveBelow: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var sleep: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object SceneTransitionConfig {
  ...
  def apply(
    ...
    allowInput: js.UndefOr[scala.Boolean] = js.undefined,
    data: js.Any = null,
    duration: js.UndefOr[phaserLib.integer] = js.undefined,
    moveAbove: js.UndefOr[scala.Boolean] = js.undefined,
    moveBelow: js.UndefOr[scala.Boolean] = js.undefined,
    onUpdate: js.Function = null,
    onUpdateScope: js.Any = null,
    sleep: js.UndefOr[scala.Boolean] = js.undefined
