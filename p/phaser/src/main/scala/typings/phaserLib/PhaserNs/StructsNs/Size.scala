...
class Size () extends js.Object {
  ...
  /**
    ...
    */
  val aspectMode: phaserLib.integer = js.native
  /**
  ...
  /**
    ...
    */
  val snapTo: phaserLib.PhaserNs.MathNs.Vector2 = js.native
  /**
  ...
  def constrain(width: scala.Double): this.type = js.native
  def constrain(width: scala.Double, height: scala.Double): this.type = js.native
  def constrain(width: scala.Double, height: scala.Double, fit: scala.Boolean): this.type = js.native
  /**
  ...
  def envelop(width: scala.Double): this.type = js.native
  def envelop(width: scala.Double, height: scala.Double): this.type = js.native
  /**
    * The current `width` and `height` are adjusted to fit inside the given dimensions, while keeping the aspect ratio.
    * 
  ...
  def fitTo(width: scala.Double): this.type = js.native
  def fitTo(width: scala.Double, height: scala.Double): this.type = js.native
  /**
    ...
    */
  def getNewHeight(value: scala.Double): scala.Double = js.native
  def getNewHeight(value: scala.Double, checkParent: scala.Boolean): scala.Double = js.native
  /**
    * Takes a new width and passes it through the min/max clamp and then checks it doesn't exceed the parent width.
    * @param value The value to clamp and check.
    * @param checkParent Check the given value against the parent, if set. Default true.
    */
  def getNewWidth(value: scala.Double): scala.Double = js.native
  def getNewWidth(value: scala.Double, checkParent: scala.Boolean): scala.Double = js.native
  /**
  ...
  def setAspectMode(value: phaserLib.integer): this.type = js.native
  /**
    ...
    */
  def setAspectRatio(ratio: scala.Double): this.type = js.native
  /**
    ...
    */
  def setCSS(element: stdLib.HTMLElement): scala.Unit = js.native
  /**
    ...
    */
  def setHeight(height: scala.Double): this.type = js.native
  /**
  ...
  def setMax(width: scala.Double): this.type = js.native
  def setMax(width: scala.Double, height: scala.Double): this.type = js.native
  /**
  ...
  def setMin(width: scala.Double): this.type = js.native
  def setMin(width: scala.Double, height: scala.Double): this.type = js.native
  /**
  ...
  def setSize(width: scala.Double): this.type = js.native
  ...
  def setSnap(snapWidth: scala.Double): this.type = js.native
  def setSnap(snapWidth: scala.Double, snapHeight: scala.Double): this.type = js.native
  /**
    ...
    * @param width The new width of the Size component.
    */
  def setWidth(width: scala.Double): this.type = js.native
}
