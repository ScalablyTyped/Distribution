...
class PluginManager protected () extends js.Object {
  ...
  /**
    ...
    */
  var plugins: js.Array[phaserLib.PhaserNs.TypesNs.PluginsNs.GlobalPlugin] = js.native
  /**
    * A list of plugin keys that should be installed into Scenes as well as the Core Plugins.
    */
  var scenePlugins: js.Array[java.lang.String] = js.native
  /**
    ...
    */
  /* protected */ def addToScene(sys: phaserLib.PhaserNs.ScenesNs.Systems, globalPlugins: js.Array[_], scenePlugins: js.Array[_]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def get(key: java.lang.String): BasePlugin | js.Function = js.native
  def get(key: java.lang.String, autoStart: scala.Boolean): BasePlugin | js.Function = js.native
  /**
    * Returns the plugin class from the cache.
    * Used internally by the Plugin Manager.
    * @param key The key of the plugin to get.
    */
  def getClass(key: java.lang.String): BasePlugin = js.native
  /**
    * Called by the Scene Systems class. Returns a list of plugins to be installed.
    */
  /* protected */ def getDefaultScenePlugins(): js.Array[java.lang.String] = js.native
  /**
    * Gets a global plugin based on the given key.
    * @param key The unique plugin key.
    */
  /* protected */ def getEntry(key: java.lang.String): phaserLib.PhaserNs.TypesNs.PluginsNs.GlobalPlugin = js.native
  /**
    * Gets an index of a global plugin based on the given key.
    * @param key The unique plugin key.
    */
  /* protected */ def getIndex(key: java.lang.String): phaserLib.integer = js.native
  /**
    ...
    */
  def install(key: java.lang.String, plugin: js.Function): BasePlugin = js.native
  def install(key: java.lang.String, plugin: js.Function, start: scala.Boolean): BasePlugin = js.native
  def install(key: java.lang.String, plugin: js.Function, start: scala.Boolean, mapping: java.lang.String): BasePlugin = js.native
  def install(
  ...
  /**
    ...
    */
  def installScenePlugin(key: java.lang.String, plugin: js.Function): scala.Unit = js.native
  def installScenePlugin(key: java.lang.String, plugin: js.Function, mapping: java.lang.String): scala.Unit = js.native
  def installScenePlugin(
    key: java.lang.String,
    plugin: js.Function,
    mapping: java.lang.String,
    addToScene: phaserLib.PhaserNs.Scene
  ...
  /**
    ...
    */
  def registerFileType(key: java.lang.String, callback: js.Function): scala.Unit = js.native
  def registerFileType(key: java.lang.String, callback: js.Function, addToScene: phaserLib.PhaserNs.Scene): scala.Unit = js.native
  /**
    ...
    */
  def registerGameObject(key: java.lang.String): scala.Unit = js.native
  def registerGameObject(key: java.lang.String, factoryCallback: js.Function): scala.Unit = js.native
  def registerGameObject(key: java.lang.String, factoryCallback: js.Function, creatorCallback: js.Function): scala.Unit = js.native
  /**
    ...
    */
  def removeGlobalPlugin(key: java.lang.String): scala.Unit = js.native
  /**
    ...
    * @param key The key of the plugin to remove.
    */
  def removeScenePlugin(key: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def start(key: java.lang.String): BasePlugin = js.native
  def start(key: java.lang.String, runAs: java.lang.String): BasePlugin = js.native
  /**
    ...
    */
  def stop(key: java.lang.String): PluginManager = js.native
}
