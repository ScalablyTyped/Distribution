...
trait PluginObject extends js.Object {
  /**
    ...
    */
  var default: js.UndefOr[js.Array[java.lang.String]] = js.undefined
  /**
    * Plugins to *add* to the default set of scene plugins.
    */
  var defaultMerge: js.UndefOr[js.Array[java.lang.String]] = js.undefined
  /**
...
object PluginObject {
  @scala.inline
  def apply(
    default: js.Array[java.lang.String] = null,
    defaultMerge: js.Array[java.lang.String] = null,
