...
object ^ extends js.Object {
  /**
    ...
    */
  def DownDuration(key: Key): scala.Boolean = js.native
  def DownDuration(key: Key, duration: phaserLib.integer): scala.Boolean = js.native
  /**
    ...
    */
  def JustDown(key: Key): scala.Boolean = js.native
  /**
    ...
    */
  def JustUp(key: Key): scala.Boolean = js.native
  /**
    ...
    */
  def UpDuration(key: Key): scala.Boolean = js.native
  def UpDuration(key: Key, duration: phaserLib.integer): scala.Boolean = js.native
}
