...
class Vector4 () extends js.Object {
  ...
  def distance(v: Vector4): scala.Double = js.native
  /**
  ...
  def distanceSq(v: Vector4): scala.Double = js.native
  /**
  ...
  def lerp(v: Vector4, t: scala.Double): Vector4 = js.native
  /**
  ...
  def set(x: js.Object, y: scala.Double, z: scala.Double, w: scala.Double): Vector4 = js.native
  /**
