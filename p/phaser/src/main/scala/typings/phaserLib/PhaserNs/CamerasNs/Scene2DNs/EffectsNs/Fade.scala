...
class Fade protected () extends js.Object {
  ...
  /**
    ...
    */
  val direction: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def postRenderCanvas(ctx: stdLib.CanvasRenderingContext2D): scala.Boolean = js.native
  /**
    ...
    */
  def postRenderWebGL(
    pipeline: phaserLib.PhaserNs.RendererNs.WebGLNs.PipelinesNs.TextureTintPipeline,
    getTintFunction: js.Function
  ...
  /**
    ...
    */
  def start(
    direction: js.UndefOr[scala.Boolean],
    ...
    callback: js.UndefOr[phaserLib.PhaserNs.TypesNs.CamerasNs.Scene2DNs.CameraFadeCallback],
