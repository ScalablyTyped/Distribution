...
class Text protected ()
  ...
  /**
    ...
    */
  def advancedWordWrap(text: java.lang.String, context: stdLib.CanvasRenderingContext2D, wordWrapWidth: scala.Double): java.lang.String = js.native
  /**
    ...
    * @param wordWrapWidth The word wrap width.
    */
  def basicWordWrap(text: java.lang.String, context: stdLib.CanvasRenderingContext2D, wordWrapWidth: scala.Double): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getWrappedText(text: java.lang.String): js.Array[java.lang.String] = js.native
  /**
    * Initialize right to left text.
    */
  def initRTL(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def setLineSpacing(value: scala.Double): Text = js.native
  /**
  ...
  /**
    ...
    */
  def setPadding(left: scala.Double, top: scala.Double, right: scala.Double, bottom: scala.Double): Text = js.native
  /**
  ...
  /**
    ...
    */
  def setText(value: java.lang.String): Text = js.native
  def setText(value: js.Array[java.lang.String]): Text = js.native
  /**
