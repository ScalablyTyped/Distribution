...
trait DOMContainerConfig extends js.Object {
  /**
    ...
    */
  var behindCanvas: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    */
  var createContainer: js.UndefOr[scala.Boolean] = js.undefined
}

object DOMContainerConfig {
  @scala.inline
  def apply(
    behindCanvas: js.UndefOr[scala.Boolean] = js.undefined,
    createContainer: js.UndefOr[scala.Boolean] = js.undefined
  ): DOMContainerConfig = {
