...
class HTML5AudioSound protected () extends BaseSound {
  /**
    ...
    */
  def this(manager: HTML5AudioSoundManager, key: java.lang.String) = this()
  def this(manager: HTML5AudioSoundManager, key: java.lang.String, config: phaserLib.PhaserNs.TypesNs.SoundNs.SoundConfig) = this()
  /**
  ...
  /**
    ...
    */
  var seek: scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def setDetune(value: scala.Double): HTML5AudioSound = js.native
  /**
    * Sets the loop state of this Sound.
    * @param value `true` to loop this sound, `false` to not loop it.
    */
  def setLoop(value: scala.Boolean): HTML5AudioSound = js.native
  /**
    * Sets the muted state of this Sound.
    * @param value `true` to mute this sound, `false` to unmute it.
    */
  def setMute(value: scala.Boolean): HTML5AudioSound = js.native
  /**
    ...
    */
  def setRate(value: scala.Double): HTML5AudioSound = js.native
  /**
    * Seeks to a specific point in this sound.
    * @param value The point in the sound to seek to.
    */
  def setSeek(value: scala.Double): HTML5AudioSound = js.native
  /**
    * Sets the volume of this Sound.
    * @param value The volume of the sound.
    */
  def setVolume(value: scala.Double): HTML5AudioSound = js.native
}
