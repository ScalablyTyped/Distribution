...
class ArcadePhysics protected () extends js.Object {
  ...
  /**
    ...
    */
  def accelerateTo(gameObject: phaserLib.PhaserNs.GameObjectsNs.GameObject, x: scala.Double, y: scala.Double): scala.Double = js.native
  def accelerateTo(
  ...
  def accelerateToObject(
    gameObject: phaserLib.PhaserNs.GameObjectsNs.GameObject,
    destination: phaserLib.PhaserNs.GameObjectsNs.GameObject
  ): scala.Double = js.native
  def accelerateToObject(
    gameObject: phaserLib.PhaserNs.GameObjectsNs.GameObject,
    destination: phaserLib.PhaserNs.GameObjectsNs.GameObject,
  ...
  /**
    ...
    */
  def moveTo(gameObject: phaserLib.PhaserNs.GameObjectsNs.GameObject, x: scala.Double, y: scala.Double): scala.Double = js.native
  def moveTo(
    gameObject: phaserLib.PhaserNs.GameObjectsNs.GameObject,
    x: scala.Double,
    y: scala.Double,
  ...
  /**
    ...
    * @param maxTime Time given in milliseconds (1000 = 1 sec). If set the speed is adjusted so the object will arrive at destination in the given number of ms. Default 0.
    */
  def moveToObject(gameObject: phaserLib.PhaserNs.GameObjectsNs.GameObject, destination: js.Object): scala.Double = js.native
  def moveToObject(
    gameObject: phaserLib.PhaserNs.GameObjectsNs.GameObject,
    destination: js.Object,
    speed: scala.Double
  ): scala.Double = js.native
  def moveToObject(
    gameObject: phaserLib.PhaserNs.GameObjectsNs.GameObject,
  ...
  /**
    ...
    */
  def velocityFromAngle(angle: scala.Double): phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def velocityFromAngle(angle: scala.Double, speed: scala.Double): phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def velocityFromAngle(angle: scala.Double, speed: scala.Double, vec2: phaserLib.PhaserNs.MathNs.Vector2): phaserLib.PhaserNs.MathNs.Vector2 = js.native
  /**
    ...
    * @param vec2 The Vector2 in which the x and y properties will be set to the calculated velocity.
    */
  def velocityFromRotation(rotation: scala.Double): phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def velocityFromRotation(rotation: scala.Double, speed: scala.Double): phaserLib.PhaserNs.MathNs.Vector2 = js.native
  def velocityFromRotation(rotation: scala.Double, speed: scala.Double, vec2: phaserLib.PhaserNs.MathNs.Vector2): phaserLib.PhaserNs.MathNs.Vector2 = js.native
}
