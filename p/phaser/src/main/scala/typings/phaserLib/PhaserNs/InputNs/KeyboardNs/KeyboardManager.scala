...
class KeyboardManager protected () extends js.Object {
  ...
  /**
    ...
    */
  var captures: js.Array[phaserLib.integer] = js.native
  /**
  ...
  /**
    ...
    */
  def addCapture(keycode: java.lang.String): scala.Unit = js.native
  def addCapture(keycode: js.Array[_ | phaserLib.integer]): scala.Unit = js.native
  def addCapture(keycode: phaserLib.integer): scala.Unit = js.native
  /**
    * Removes all keyboard captures and sets the `preventDefault` property to `false`.
    */
  def clearCaptures(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def removeCapture(keycode: java.lang.String): scala.Unit = js.native
  def removeCapture(keycode: js.Array[_ | phaserLib.integer]): scala.Unit = js.native
  def removeCapture(keycode: phaserLib.integer): scala.Unit = js.native
  /**
