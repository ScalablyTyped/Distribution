...
class NoAudioSound protected () extends BaseSound {
  /**
    ...
    */
  def this(manager: NoAudioSoundManager, key: java.lang.String) = this()
  def this(manager: NoAudioSoundManager, key: java.lang.String, config: phaserLib.PhaserNs.TypesNs.SoundNs.SoundConfig) = this()
}
