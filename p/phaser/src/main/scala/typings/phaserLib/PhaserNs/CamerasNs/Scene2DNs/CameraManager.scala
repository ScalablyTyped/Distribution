...
class CameraManager protected () extends js.Object {
  ...
  /**
    ...
    */
  def add(
    x: js.UndefOr[phaserLib.integer],
    y: js.UndefOr[phaserLib.integer],
    width: js.UndefOr[phaserLib.integer],
    height: js.UndefOr[phaserLib.integer],
    makeMain: js.UndefOr[scala.Boolean],
  ...
  def addExisting(camera: Camera, makeMain: scala.Boolean): Camera = js.native
  def fromJSON(config: js.Array[phaserLib.PhaserNs.TypesNs.CamerasNs.Scene2DNs.CameraConfig]): CameraManager = js.native
  /**
    ...
    */
  def fromJSON(config: phaserLib.PhaserNs.TypesNs.CamerasNs.Scene2DNs.CameraConfig): CameraManager = js.native
  /**
    ...
    */
  def getCamera(name: java.lang.String): Camera = js.native
  /**
    ...
    */
  def getCamerasBelowPointer(pointer: phaserLib.PhaserNs.InputNs.Pointer): js.Array[Camera] = js.native
  /**
  ...
  /**
    ...
    */
  def remove(camera: Camera): phaserLib.integer = js.native
  def remove(camera: Camera, runDestroy: scala.Boolean): phaserLib.integer = js.native
  /**
