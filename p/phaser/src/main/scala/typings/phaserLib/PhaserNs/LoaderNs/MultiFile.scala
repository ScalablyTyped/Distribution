...
class MultiFile protected () extends js.Object {
  /**
    ...
    */
  def this(loader: LoaderPlugin, `type`: java.lang.String, key: java.lang.String, files: js.Array[File]) = this()
  /**
  ...
  /**
    ...
    */
  var failed: phaserLib.integer = js.native
  /**
  ...
  /**
    ...
    */
  def isReadyToProcess(): scala.Boolean = js.native
  /**
    * Called by each File when it finishes loading.
    * @param file The File that has completed processing.
    */
  def onFileComplete(file: File): scala.Unit = js.native
  /**
    * Called by each File that fails to load.
    * @param file The File that has failed to load.
    */
  def onFileFailed(file: File): scala.Unit = js.native
}
