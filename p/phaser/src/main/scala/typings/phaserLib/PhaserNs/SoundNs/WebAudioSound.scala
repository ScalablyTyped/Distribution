...
class WebAudioSound protected () extends BaseSound {
  /**
    ...
    */
  def this(manager: WebAudioSoundManager, key: java.lang.String) = this()
  def this(manager: WebAudioSoundManager, key: java.lang.String, config: phaserLib.PhaserNs.TypesNs.SoundNs.SoundConfig) = this()
  /**
  ...
  /**
    ...
    */
  def setDetune(value: scala.Double): WebAudioSound = js.native
  /**
    * Sets the loop state of this Sound.
    * @param value `true` to loop this sound, `false` to not loop it.
    */
  def setLoop(value: scala.Boolean): WebAudioSound = js.native
  /**
    * Sets the muted state of this Sound.
    * @param value `true` to mute this sound, `false` to unmute it.
    */
  def setMute(value: scala.Boolean): WebAudioSound = js.native
  /**
    ...
    */
  def setRate(value: scala.Double): WebAudioSound = js.native
  /**
    * Seeks to a specific point in this sound.
    * @param value The point in the sound to seek to.
    */
  def setSeek(value: scala.Double): WebAudioSound = js.native
  /**
    * Sets the volume of this Sound.
    * @param value The volume of the sound.
    */
  def setVolume(value: scala.Double): WebAudioSound = js.native
}
