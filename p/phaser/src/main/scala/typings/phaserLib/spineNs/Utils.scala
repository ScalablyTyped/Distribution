...
object Utils extends js.Object {
  ...
  def arrayCopy[T](
    source: phaserLib.spineNs.ArrayLike[T],
    sourceStart: scala.Double,
    dest: phaserLib.spineNs.ArrayLike[T],
  ...
  def newFloatArray(size: scala.Double): phaserLib.spineNs.ArrayLike[scala.Double] = js.native
  def newShortArray(size: scala.Double): phaserLib.spineNs.ArrayLike[scala.Double] = js.native
  ...
  def webkit602BugfixHelper(alpha: scala.Double, pose: phaserLib.spineNs.MixPose): scala.Unit = js.native
}
