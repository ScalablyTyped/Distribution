package typings.pahoMqtt.mod.global.Paho
...
package object MQTT {
  /**
    ...
    *  <li>errorMessage
    */
  type OnConnectionLostHandler = js.Function1[/* error */ typings.pahoMqtt.mod.global.Paho.MQTT.MQTTError, scala.Unit]
  /**
  ...
  type OnFailureCallback = js.Function1[
    /* e */ typings.pahoMqtt.mod.global.Paho.MQTT.ErrorWithInvocationContext, 
    scala.Unit
  ]
  /**
    ...
    */
  type OnMessageHandler = js.Function1[/* message */ typings.pahoMqtt.mod.global.Paho.MQTT.Message, scala.Unit]
  /**
    ...
    *  <li><code>invocationContext</code> as passed in with the corresponding field in the connectOptions.
    */
  type OnSubscribeSuccessCallback = js.Function1[/* o */ typings.pahoMqtt.mod.global.Paho.MQTT.OnSubscribeSuccessParams, scala.Unit]
  /**
    ...
    *  <li><code>invocationContext</code> as passed in with the corresponding field in the connectOptions.
    */
  type OnSuccessCallback = js.Function1[/* o */ typings.pahoMqtt.mod.global.Paho.MQTT.WithInvocationContext, scala.Unit]
  type TraceFunction = js.Function1[/* element */ typings.pahoMqtt.mod.global.Paho.MQTT.TraceElement, scala.Unit]
