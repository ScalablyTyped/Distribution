package typings.pahoDashMqtt.pahoDashMqttMod.Global

import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.ConnectionOptions
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.ErrorWithInvocationContext
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.MQTTError
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.OnConnectionLostHandler
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.OnFailureCallback
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.OnMessageHandler
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.OnSubscribeSuccessCallback
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.OnSubscribeSuccessParams
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.OnSuccessCallback
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.Qos
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.SubscribeOptions
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.TraceElement
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.TraceFunction
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.TypedArray
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.UnsubscribeOptions
import typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.WithInvocationContext
  ...
  object MQTTNs extends js.Object {
    ...
    class Client protected () extends js.Object {
      ...
      /**
        ...
        * <li> {@link Paho.MQTT.Message} that has arrived.
        */
      def onMessageArrived(message: typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.Message): Unit = js.native
      /**
        * called when a message has been delivered.
        * All processing that this Client will ever do has been completed. So, for example,
        * in the case of a Qos=2 message sent by this client, the PubComp flow has been received from the server
        ...
        * <li>{@link Paho.MQTT.Message} that was delivered.
        */
      def onMessageDelivered(message: typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.Message): Unit = js.native
      /**
        ...
        */
      def send(message: typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.Message): Unit = js.native
      /**
        * Send a message to the consumers of the destination in the Message.
        *
    ...
    trait ConnectionOptions extends js.Object {
      ...
      var willMessage: js.UndefOr[typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.Message] = js.undefined
    }
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.pahoDashMqtt.pahoDashMqttNumbers.`0`
      - typings.pahoDashMqtt.pahoDashMqttNumbers.`1`
      - typings.pahoDashMqtt.pahoDashMqttNumbers.`2`
    */
    ...
    type OnMessageHandler = js.Function1[
        /* message */ typings.pahoDashMqtt.pahoDashMqttMod.Global.PahoNs.MQTTNs.Message, 
        Unit
      ]
    /**
      * Called when the subscribe acknowledgement has been received from the server.
