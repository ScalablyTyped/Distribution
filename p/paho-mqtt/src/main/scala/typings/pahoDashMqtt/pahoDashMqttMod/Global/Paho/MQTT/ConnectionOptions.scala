...
trait ConnectionOptions extends js.Object {
  ...
  var willMessage: js.UndefOr[typings.pahoDashMqtt.pahoDashMqttMod.Global.Paho.MQTT.Message] = js.undefined
}
...
object ConnectionOptions {
  ...
  def apply(
    ...
    willMessage: typings.pahoDashMqtt.pahoDashMqttMod.Global.Paho.MQTT.Message = null
  ): ConnectionOptions = {
