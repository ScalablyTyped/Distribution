package typings.pahoDashMqtt.pahoDashMqttMod.Global.Paho
...
package object MQTT {
  ...
  /**
    ...
    */
  type OnMessageHandler = js.Function1[/* message */ typings.pahoDashMqtt.pahoDashMqttMod.Global.Paho.MQTT.Message, Unit]
  /**
