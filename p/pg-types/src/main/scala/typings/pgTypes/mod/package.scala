...
@scala.inline
def arrayParser(source: java.lang.String, transform: js.Function1[/* entry */ js.Any, js.Any]): js.Array[js.Any] = (typings.pgTypes.mod.^.asInstanceOf[js.Dynamic].applyDynamic("arrayParser")(source.asInstanceOf[js.Any], transform.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Any]]
...
@scala.inline
def setTypeParser(id: typings.pgTypes.mod.TypeId, parseFn: js.Function1[/* value */ java.lang.String, js.Any]): scala.Unit = (typings.pgTypes.mod.^.asInstanceOf[js.Dynamic].applyDynamic("setTypeParser")(id.asInstanceOf[js.Any], parseFn.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
