...
/**
  ...
  **/
@js.native
trait InteractiveViewModel extends StObject {
  ...
  def completeScrub(time: Double): Unit = js.native
  ...
  def fastForward(): Unit = js.native
  ...
  def skipPrevious(): Unit = js.native
  ...
  def startScrub(time: Double): Unit = js.native
  ...
  def toggleMutted(): Unit = js.native
  
  def toggleZoom(): Unit = js.native
  ...
  def updateScrub(time: Double): Unit = js.native
