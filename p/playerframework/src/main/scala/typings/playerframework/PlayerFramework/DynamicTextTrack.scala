...
object DynamicTextTrack {
  ...
  inline def apply(augmentPayload: (js.Any, Double, Double) => Unit, label: String, language: String, stream: js.Any): DynamicTextTrack = {
  ...
  extension [Self <: DynamicTextTrack](x: Self) {
    ...
    inline def setAugmentPayload(value: (js.Any, Double, Double) => Unit): Self = StObject.set(x, "augmentPayload", js.Any.fromFunction3(value))
