...
object ^ extends js.Object {
  /**
  	...
  	```
  	*/
  def v4(): CancelablePromise[java.lang.String] = js.native
  def v4(options: Options): CancelablePromise[java.lang.String] = js.native
  /**
  	Get your public IP address - very fast!
  	In Node.js, it queries the DNS records of OpenDNS which has an entry with your IP address. In browsers, it uses the excellent [icanhaz](https://github.com/major/icanhaz) service through HTTPS.
  	...
  	```
  	*/
  def v6(): CancelablePromise[java.lang.String] = js.native
  def v6(options: Options): CancelablePromise[java.lang.String] = js.native
}
