...
/**
  ...
  */
class TextRenderer ()
  extends typings.atPhosphorDatagrid.libTextrendererMod.TextRenderer {
...
object TextRenderer extends js.Object {
  ...
  object formatPrecision extends js.Object {
    /**
      ...
      */
    def apply(): FormatFunc = js.native
    def apply(options: typings.atPhosphorDatagrid.libTextrendererMod.TextRenderer.formatPrecision.IOptions): FormatFunc = js.native
  }
