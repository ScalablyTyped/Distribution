...
@JSImport("@phosphor/datagrid/lib/textrenderer", "TextRenderer.formatISODateTime")
@js.native
object ^ extends js.Object {
  ...
  def apply(options: typings.atPhosphorDatagrid.libTextrendererMod.TextRenderer.formatISODateTime.IOptions): FormatFunc = js.native
}
