...
object DataRepetitionKind {
  ...
  inline def RoleWildcard: `0` = 0.asInstanceOf[`0`]
  
  inline def ScopeIdentity: `1` = 1.asInstanceOf[`1`]
  
  inline def ScopeTotal: `2` = 2.asInstanceOf[`2`]
  
  inline def ScopeWildcard: `3` = 3.asInstanceOf[`3`]
}
