...
@js.native
trait Anon_ArgumentsAsyncFunction extends js.Object {
  ...
  /**
  	...
  	*/
  // TODO: Remove this for the next major release
  def default[ArgumentsType /* <: js.Array[_] */, ReturnType](asyncFunction: js.Function1[/* arguments */ ArgumentsType, js.Thenable[ReturnType]]): js.Function1[
    /* arguments */ ArgumentsType, 
    pDashTimeLib.pDashTimeMod.pTimeNs.PromiseWithTime[ReturnType]
  ] = js.native
  /**
