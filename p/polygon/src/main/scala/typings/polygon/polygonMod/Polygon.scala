package typings.polygon.polygonMod

import typings.polygon.Anon_H
import typings.polygon.Anon_Height
import typings.polygon.Anon_Position
import typings.polygon.Anon_X1
...
trait Polygon extends js.Object {
  ...
  val points: js.Array[typings.vec2.vec2Mod.^] = js.native
  /**
  ...
  /**
    ...
    */
  def center(): typings.vec2.vec2Mod.^ = js.native
  /**
  ...
  /**
    ...
    */
  def closestPointTo(vec2: typings.vec2.vec2Mod.^): typings.vec2.vec2Mod.^ = js.native
  /**
    ...
    */
  def contains(thing: js.Array[typings.vec2.vec2Mod.^]): Boolean = js.native
  ...
  /**
    ...
    */
  def containsPoint(vec2: typings.vec2.vec2Mod.^): Boolean = js.native
  /**
  ...
  def each(
    fn: js.Function4[
      /* prev */ typings.vec2.vec2Mod.^, 
      /* current */ typings.vec2.vec2Mod.^, 
      /* next */ typings.vec2.vec2Mod.^, 
      /* idx */ Double, 
      _
    ]
  ): Polygon = js.native
  ...
  /**
    ...
    */
  def insert(vec2: typings.vec2.vec2Mod.^, index: Double): Unit = js.native
  /**
    * Return an array `[startpoint, endpoint]` representing the line at the specified `index`
    */
  def line(index: Double): js.Tuple2[typings.vec2.vec2Mod.^, typings.vec2.vec2Mod.^] = js.native
  /**
    * Iterate over the lines in this polygon
    */
  def lines(
    fn: js.Function3[
      /* start */ typings.vec2.vec2Mod.^, 
      /* end */ typings.vec2.vec2Mod.^, 
      /* index */ Double, 
      _
    ]
  ): Polygon = js.native
  ...
  /**
    ...
    */
  def point(idx: Double): typings.vec2.vec2Mod.^ = js.native
  /**
  ...
  /**
    ...
    */
  def remove(vecOrIndex: typings.vec2.vec2Mod.^): Polygon = js.native
  /**
  ...
  /**
    ...
    */
  def rotate(rads: Double, vec2: typings.vec2.vec2Mod.^): Polygon = js.native
  def rotate(rads: Double, vec2: typings.vec2.vec2Mod.^, returnNew: Boolean): Polygon = js.native
  /**
    * Scales this polygon around `origin` (default is `this.center()`) and will return a new polygon if requested with `returnNew`
    */
  def scale(amount: Double, origin: typings.vec2.vec2Mod.^): Polygon = js.native
  def scale(amount: Double, origin: typings.vec2.vec2Mod.^, returnNew: Boolean): Polygon = js.native
  /**
  ...
  /**
    ...
    */
  def translate(vec2: typings.vec2.vec2Mod.^): Polygon = js.native
  def translate(vec2: typings.vec2.vec2Mod.^, returnNew: Boolean): Polygon = js.native
  /**
