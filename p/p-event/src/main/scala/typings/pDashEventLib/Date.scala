...
trait Date extends js.Object {
  ...
  var toPrimitive: (js.Function1[pDashEventLib.pDashEventLibStrings.default, java.lang.String]) with (js.Function1[pDashEventLib.pDashEventLibStrings.string, java.lang.String]) with (js.Function1[pDashEventLib.pDashEventLibStrings.number, scala.Double]) with (js.Function1[/* hint */ java.lang.String, java.lang.String | scala.Double]) = js.native
  ...
  def toLocaleDateString(locales: java.lang.String, options: pDashEventLib.IntlNs.DateTimeFormatOptions): java.lang.String = js.native
  def toLocaleDateString(locales: Array[java.lang.String]): java.lang.String = js.native
  def toLocaleDateString(locales: Array[java.lang.String], options: pDashEventLib.IntlNs.DateTimeFormatOptions): java.lang.String = js.native
  def toLocaleString(locales: java.lang.String): java.lang.String = js.native
  def toLocaleString(locales: java.lang.String, options: pDashEventLib.IntlNs.DateTimeFormatOptions): java.lang.String = js.native
  def toLocaleString(locales: Array[java.lang.String]): java.lang.String = js.native
  def toLocaleString(locales: Array[java.lang.String], options: pDashEventLib.IntlNs.DateTimeFormatOptions): java.lang.String = js.native
  ...
  def toLocaleTimeString(locales: java.lang.String, options: pDashEventLib.IntlNs.DateTimeFormatOptions): java.lang.String = js.native
  def toLocaleTimeString(locales: Array[java.lang.String]): java.lang.String = js.native
  def toLocaleTimeString(locales: Array[java.lang.String], options: pDashEventLib.IntlNs.DateTimeFormatOptions): java.lang.String = js.native
