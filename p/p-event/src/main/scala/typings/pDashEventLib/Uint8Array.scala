...
trait Uint8Array
  ...
  val toStringTag: pDashEventLib.pDashEventLibStrings.UInt8Array = js.native
  /**
  ...
  def slice(start: scala.Double): Uint8Array = js.native
  def slice(start: scala.Double, end: scala.Double): Uint8Array = js.native
  /**
  ...
  /**
    ...
    */
  def subarray(begin: scala.Double): Uint8Array = js.native
  def subarray(begin: scala.Double, end: scala.Double): Uint8Array = js.native
  /**
