...
trait DataView extends js.Object {
  ...
  /**
    ...
    */
  def getBigInt64(byteOffset: scala.Double): stdLib.BigInt = js.native
  def getBigInt64(byteOffset: scala.Double, littleEndian: scala.Boolean): stdLib.BigInt = js.native
  /**
    * Gets the BigUint64 value at the specified byte offset from the start of the view. There is
    * no alignment constraint; multi-byte values may be fetched from any offset.
    * @param byteOffset The place in the buffer at which the value should be retrieved.
    */
  def getBigUint64(byteOffset: scala.Double): stdLib.BigInt = js.native
  def getBigUint64(byteOffset: scala.Double, littleEndian: scala.Boolean): stdLib.BigInt = js.native
  /**
  ...
  /**
    ...
    */
  def setBigInt64(byteOffset: scala.Double, value: stdLib.BigInt): scala.Unit = js.native
  def setBigInt64(byteOffset: scala.Double, value: stdLib.BigInt, littleEndian: scala.Boolean): scala.Unit = js.native
  /**
    ...
    * otherwise a little-endian value should be written.
    */
  def setBigUint64(byteOffset: scala.Double, value: stdLib.BigInt): scala.Unit = js.native
  def setBigUint64(byteOffset: scala.Double, value: stdLib.BigInt, littleEndian: scala.Boolean): scala.Unit = js.native
  /**
