...
trait String
  ...
  def localeCompare(that: java.lang.String, locales: java.lang.String, options: pDashEventLib.IntlNs.CollatorOptions): scala.Double = js.native
  ...
  /**
    ...
    */
  def `match`(
    matcher: /* import warning: ImportType.apply Failed type conversion: {[Symbol.match] : (string : string): p-event.RegExpMatchArray | null} */ js.Any
  ...
  /**
    ...
    */
  @JSName("normalize")
  def normalize_NFC(form: pDashEventLib.pDashEventLibStrings.NFC): java.lang.String = js.native
  @JSName("normalize")
  def normalize_NFD(form: pDashEventLib.pDashEventLibStrings.NFD): java.lang.String = js.native
  @JSName("normalize")
  def normalize_NFKC(form: pDashEventLib.pDashEventLibStrings.NFKC): java.lang.String = js.native
  @JSName("normalize")
  def normalize_NFKD(form: pDashEventLib.pDashEventLibStrings.NFKD): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def split(
    splitter: /* import warning: ImportType.apply Failed type conversion: {[Symbol.split] : (string : string, limit? : number): p-event.Array<string>} */ js.Any
