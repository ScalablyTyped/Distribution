...
trait Number extends js.Object {
  ...
  def toLocaleString(locales: java.lang.String, options: pDashEventLib.IntlNs.NumberFormatOptions): java.lang.String = js.native
  def toLocaleString(locales: Array[java.lang.String]): java.lang.String = js.native
  def toLocaleString(locales: Array[java.lang.String], options: pDashEventLib.IntlNs.NumberFormatOptions): java.lang.String = js.native
  /**
