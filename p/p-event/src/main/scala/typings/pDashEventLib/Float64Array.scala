...
trait Float64Array
  ...
  val toStringTag: pDashEventLib.pDashEventLibStrings.Float64Array = js.native
  /**
  ...
  def slice(start: scala.Double): Float64Array = js.native
  def slice(start: scala.Double, end: scala.Double): Float64Array = js.native
  /**
  ...
  /**
    ...
    */
  def subarray(begin: scala.Double): Float64Array = js.native
  def subarray(begin: scala.Double, end: scala.Double): Float64Array = js.native
  /**
