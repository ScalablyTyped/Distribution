...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def default[EmittedType /* <: js.Array[_] */](
  ...
  def default[EmittedType](emitter: Emitter[js.Array[EmittedType]], event: js.Array[java.lang.String | js.Symbol]): CancelablePromise[EmittedType] = js.native
  def default[EmittedType](
    emitter: Emitter[js.Array[EmittedType]],
  ...
  def default[EmittedType /* <: js.Array[_] */](emitter: Emitter[EmittedType], event: js.Symbol, options: MultiArgumentsOptions[EmittedType]): CancelablePromise[EmittedType] = js.native
  ...
  def iterator[EmittedType](emitter: Emitter[js.Array[EmittedType]], event: java.lang.String): stdLib.AsyncIterableIterator[EmittedType] = js.native
  def iterator[EmittedType](
    emitter: Emitter[js.Array[EmittedType]],
    event: java.lang.String,
    filter: FilterFunction[js.Array[EmittedType]]
  ): stdLib.AsyncIterableIterator[EmittedType] = js.native
  def iterator[EmittedType /* <: js.Array[_] */](
    emitter: Emitter[EmittedType],
    event: java.lang.String,
  ...
  def iterator[EmittedType](emitter: Emitter[js.Array[EmittedType]], event: js.Array[java.lang.String | js.Symbol]): stdLib.AsyncIterableIterator[EmittedType] = js.native
  def iterator[EmittedType](
    emitter: Emitter[js.Array[EmittedType]],
    event: js.Array[java.lang.String | js.Symbol],
    filter: FilterFunction[js.Array[EmittedType]]
  ...
  def iterator[EmittedType](emitter: Emitter[js.Array[EmittedType]], event: js.Symbol): stdLib.AsyncIterableIterator[EmittedType] = js.native
  def iterator[EmittedType](
    emitter: Emitter[js.Array[EmittedType]],
    event: js.Symbol,
    filter: FilterFunction[js.Array[EmittedType]]
  ...
  def multiple[EmittedType /* <: js.Array[_] */](
    emitter: Emitter[EmittedType],
    event: java.lang.String,
