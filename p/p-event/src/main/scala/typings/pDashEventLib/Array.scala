...
trait Array[T]
  ...
  /**
    ...
    * @param depth The maximum recursion depth
    */
  def flat[U](`this`: Array[U], depth: pDashEventLib.pDashEventLibNumbers.`0`): Array[U] = js.native
  def flat[U](`this`: Array[Array[U]], depth: pDashEventLib.pDashEventLibNumbers.`1`): Array[U] = js.native
  /**
    * Returns a new array with all sub-array elements concatenated into it recursively up to the
    * specified depth.
    *
    * @param depth The maximum recursion depth
    */
  def flat[U](`this`: Array[Array[Array[U]]], depth: pDashEventLib.pDashEventLibNumbers.`2`): Array[U] = js.native
  /**
    * Returns a new array with all sub-array elements concatenated into it recursively up to the
    * specified depth.
    *
    * @param depth The maximum recursion depth
    */
  def flat[U](`this`: Array[Array[Array[Array[U]]]], depth: pDashEventLib.pDashEventLibNumbers.`3`): Array[U] = js.native
  /**
    * Returns a new array with all sub-array elements concatenated into it recursively up to the
    * specified depth.
    *
    * @param depth The maximum recursion depth
    */
  def flat[U](`this`: Array[Array[Array[Array[Array[U]]]]], depth: pDashEventLib.pDashEventLibNumbers.`4`): Array[U] = js.native
  /**
    * Returns a new array with all sub-array elements concatenated into it recursively up to the
    * specified depth.
    *
    * @param depth The maximum recursion depth
    */
  def flat[U](`this`: Array[Array[Array[Array[Array[Array[U]]]]]], depth: pDashEventLib.pDashEventLibNumbers.`5`): Array[U] = js.native
  /**
    * Returns a new array with all sub-array elements concatenated into it recursively up to the
    * specified depth.
    *
    ...
    */
  def flat[U](
    `this`: Array[Array[Array[Array[Array[Array[Array[U]]]]]]],
    depth: pDashEventLib.pDashEventLibNumbers.`6`
  ): Array[U] = js.native
  /**
    * Returns a new array with all sub-array elements concatenated into it recursively up to the
    * specified depth.
    ...
    */
  def flat[U](
    `this`: Array[Array[Array[Array[Array[Array[Array[Array[U]]]]]]]],
    depth: pDashEventLib.pDashEventLibNumbers.`7`
  ): Array[U] = js.native
  /**
