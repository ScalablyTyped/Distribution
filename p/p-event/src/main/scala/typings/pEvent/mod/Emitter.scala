...
object Emitter {
  @scala.inline
  def apply[/* <: java.lang.String | js.Symbol */ EventName, /* <: js.Array[_] */ EmittedType](): Emitter[EventName, EmittedType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Emitter[EventName, EmittedType]]
  }
  @scala.inline
  implicit class EmitterOps[Self <: Emitter[_, _], /* <: java.lang.String | js.Symbol */ EventName, /* <: js.Array[_] */ EmittedType] (val x: Self with (Emitter[EventName, EmittedType])) extends AnyVal {
    @scala.inline
