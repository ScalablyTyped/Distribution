...
trait PromiseSftp extends js.Object {
  ...
  def chmod(path: String, mode: String): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    ...
    */
  def chmod(path: String, mode: Double): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    ...
    */
  def chown(path: String, uid: Double, gid: Double): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    * Close a resource on the server.
    * @param handle - A file handle returned from `#open()` or `#opendir()`.
    */
  def close(handle: Buffer): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def createReadStream(path: String): typings.bluebird.bluebirdMod.^[ReadableStream] = js.native
  def createReadStream(path: String, options: String): typings.bluebird.bluebirdMod.^[ReadableStream] = js.native
  def createReadStream(path: String, options: Anon_AutoClose): typings.bluebird.bluebirdMod.^[ReadableStream] = js.native
  /**
    ...
    */
  def createWriteStream(path: String): typings.bluebird.bluebirdMod.^[WritableStream] = js.native
  def createWriteStream(path: String, options: String): typings.bluebird.bluebirdMod.^[WritableStream] = js.native
  def createWriteStream(path: String, options: Anon_AutoClose): typings.bluebird.bluebirdMod.^[WritableStream] = js.native
  /**
  ...
  /**
    ...
    */
  def end(): typings.bluebird.bluebirdMod.^[Boolean] = js.native
  /**
    * **OpenSSH extension**
    * Perform POSIX fstatvfs(2) on a resource on the server.
    * @param handle - A resource handle returned from `#open()` or `#fopen()`.
    */
  def ext_openssh_fstatvfs(handle: Buffer): typings.bluebird.bluebirdMod.^[Statvfs] = js.native
  /**
    * **OpenSSH extension**
    * Perform POSIX fsync(3) on a resource on the server.
    * @param handle - A resource handle returned from `#open()` or `#fopen()`.
    */
  def ext_openssh_fsync(handle: Buffer): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    * **OpenSSH extension**
    ...
    */
  def ext_openssh_hardlink(targetPath: String, linkPath: String): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    * **OpenSSH extension**
    ...
    */
  def ext_openssh_rename(srcPath: String, destPath: String): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    * **OpenSSH extension**
    * Perform POSIX fstatvfs(2) on a resource on the server.
    * @param path - The path to get the statvfs of.
    */
  def ext_openssh_statvfs(path: String): typings.bluebird.bluebirdMod.^[Statvfs] = js.native
  /**
    ...
    */
  def fastGet(remotePath: String, localPath: String): typings.bluebird.bluebirdMod.^[Unit] = js.native
  def fastGet(remotePath: String, localPath: String, options: FastOptions): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    ...
    */
  def fastPut(localPath: String, remotePath: String): typings.bluebird.bluebirdMod.^[Unit] = js.native
  def fastPut(localPath: String, remotePath: String, options: FastOptions): typings.bluebird.bluebirdMod.^[Unit] = js.native
  def fchmod(handle: Buffer, mode: String): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    * Set the mode for a resource on the server.
    * @param handle - A resource handle returned from `#open()` or `#fopen()`.
    * @param mode - The new mode, a number or a string with an octal number.
    */
  def fchmod(handle: Buffer, mode: Double): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    * Set the ownership for a resource on the server.
    * @param handle - A resource handle returned from `#open()` or `#fopen()`.
    * @param uid - The id of the new owner user.
    * @param gid - The id of the new owner group.
    */
  def fchown(handle: Buffer, uid: Double, gid: Double): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    * Set the attributes for a resource on the server.
    * @param handle - A resource handle returned from `#open()` or `#fopen()`.
    */
  def fsetstat(handle: Buffer, attributes: Attributes): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    * Retrieves attributes from a resource on the server.
    * @param handle - A file handle returned from `#open()` or `#opendir()`
    */
  def fstat(handle: Buffer): typings.bluebird.bluebirdMod.^[Stats] = js.native
  def futimes(handle: Buffer, atime: Double, mtime: Double): typings.bluebird.bluebirdMod.^[Unit] = js.native
  def futimes(handle: Buffer, atime: Double, mtime: Date): typings.bluebird.bluebirdMod.^[Unit] = js.native
  def futimes(handle: Buffer, atime: Date, mtime: Double): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    ...
    */
  def futimes(handle: Buffer, atime: Date, mtime: Date): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def lstat(path: String): typings.bluebird.bluebirdMod.^[Stats] = js.native
  /**
  ...
  def mkdir(path: String, attributes: InputAttributes): typings.bluebird.bluebirdMod.^[Unit] = js.native
  def mkdir(path: String, recursive: Boolean): typings.bluebird.bluebirdMod.^[Unit] = js.native
  def mkdir(path: String, recursive: Boolean, attributes: InputAttributes): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    ...
    */
  def open(filename: String, mode: String): typings.bluebird.bluebirdMod.^[Buffer] = js.native
  def open(filename: String, mode: String, attributes: InputAttributes): typings.bluebird.bluebirdMod.^[Buffer] = js.native
  def open(filename: String, mode: Double): typings.bluebird.bluebirdMod.^[Buffer] = js.native
  def open(filename: String, mode: Double, attributes: InputAttributes): typings.bluebird.bluebirdMod.^[Buffer] = js.native
  /**
    * Open a directory on the server.
    * @param path - The path of the directory to open.
    * @returns a buffer with the handle of the opened directory.
    */
  def opendir(path: String): typings.bluebird.bluebirdMod.^[Buffer] = js.native
  ...
  /**
    ...
    */
  def read(handle: Buffer, buffer: Buffer, offset: Double, length: Double, position: Double): typings.bluebird.bluebirdMod.^[Anon_Buffer] = js.native
  def readdir(location: String): typings.bluebird.bluebirdMod.^[Anon_Attrs] = js.native
  /**
    * Read a directory on the server.
    * @param location - The path of the directory to read or a handle returned from `#opendir()`.
    */
  def readdir(location: Buffer): typings.bluebird.bluebirdMod.^[Anon_Attrs] = js.native
  /**
    * Read the target of a symlink on the server.
    * @param path - The path of the symlink to read the target of.
    */
  def readlink(path: String): typings.bluebird.bluebirdMod.^[String] = js.native
  /**
    * Get the absolute path from a relative path on the server.
    * @param path - The path to get the absolute path of.
    */
  def realpath(path: String): typings.bluebird.bluebirdMod.^[String] = js.native
  /**
  ...
  /** Alias for `#unlink()` */
  def remove(path: String): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def setstat(path: String, attributes: Attributes): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
  ...
  /**
    ...
    * @param path - The path to the resource to retrieve the attributes of.
    */
  def stat(path: String): typings.bluebird.bluebirdMod.^[Stats] = js.native
  /**
    ...
    */
  def symlink(targetPath: String, linkPath: String): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    * Remove a file or symlink on the server.
    * @param path - The path of the file/symlink to remove.
    */
  def unlink(path: String): typings.bluebird.bluebirdMod.^[Unit] = js.native
  def utimes(path: String, atime: Double, mtime: Double): typings.bluebird.bluebirdMod.^[Unit] = js.native
  def utimes(path: String, atime: Double, mtime: Date): typings.bluebird.bluebirdMod.^[Unit] = js.native
  def utimes(path: String, atime: Date, mtime: Double): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
    * Set the access and modified times for a resource on the server.
    ...
    * @param mtime - A Date or unix timestamp representing the new modify time for the resource
    */
  def utimes(path: String, atime: Date, mtime: Date): typings.bluebird.bluebirdMod.^[Unit] = js.native
}
