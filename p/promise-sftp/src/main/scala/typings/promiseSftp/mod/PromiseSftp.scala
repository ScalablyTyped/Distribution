...
import typings.promiseSftp.AnonAttrs
import typings.promiseSftp.AnonAutoClose
import typings.promiseSftp.AnonBuffer
...
trait PromiseSftp extends js.Object {
  ...
  def createReadStream(path: String, options: AnonAutoClose): typings.bluebird.mod.^[ReadableStream] = js.native
  /**
  ...
  def createWriteStream(path: String, options: AnonAutoClose): typings.bluebird.mod.^[WritableStream] = js.native
  /**
  ...
  /**
    ...
    */
  def read(handle: Buffer, buffer: Buffer, offset: Double, length: Double, position: Double): typings.bluebird.mod.^[AnonBuffer] = js.native
  def readdir(location: String): typings.bluebird.mod.^[AnonAttrs] = js.native
  /**
    * Read a directory on the server.
    * @param location - The path of the directory to read or a handle returned from `#opendir()`.
    */
  def readdir(location: Buffer): typings.bluebird.mod.^[AnonAttrs] = js.native
  /**
