...
trait AnonAutoReconnect extends js.Object {
  /**
...
object AnonAutoReconnect {
  ...
  def apply(
    ...
    tryKeyboard: (/* name */ String, /* instructions */ String, /* instructionsLang */ String, /* prompts */ js.Array[AnonEcho]) => (js.Array[String | ^[String]]) | ^[js.Array[String]] = null,
    user: String = null
  ): AnonAutoReconnect = {
    ...
    __obj.asInstanceOf[AnonAutoReconnect]
  }
}
