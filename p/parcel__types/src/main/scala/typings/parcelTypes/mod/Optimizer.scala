...
trait Optimizer[ConfigType, BundleConfigType] extends StObject {
  ...
  def optimize(arg0: BundleConfig[ConfigType, BundleConfigType]): Async[BundleResult]
}
object Optimizer {
  
  inline def apply[ConfigType, BundleConfigType](optimize: BundleConfig[ConfigType, BundleConfigType] => Async[BundleResult]): Optimizer[ConfigType, BundleConfigType] = {
  ...
  extension [Self <: Optimizer[?, ?], ConfigType, BundleConfigType](x: Self & (Optimizer[ConfigType, BundleConfigType])) {
    ...
    inline def setOptimize(value: BundleConfig[ConfigType, BundleConfigType] => Async[BundleResult]): Self = StObject.set(x, "optimize", js.Any.fromFunction1(value))
  }
}
