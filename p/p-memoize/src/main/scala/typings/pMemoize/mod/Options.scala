...
/* Inlined mem.mem.Options<ArgumentsType, CacheKeyType, ReturnType> & { readonly cachePromiseRejection :boolean | undefined} */
@js.native
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options[_, _, _], /* <: js.Array[_] */ ArgumentsType, CacheKeyType, ReturnType] (val x: Self with (Options[ArgumentsType, CacheKeyType, ReturnType])) extends AnyVal {
    ...
    @scala.inline
    def setCachePromiseRejection(value: Boolean): Self = this.set("cachePromiseRejection", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCachePromiseRejection: Self = this.set("cachePromiseRejection", js.undefined)
    @scala.inline
