package typings.pouchdbDashAdapterDashWebsql.PouchDB.Core

import typings.pouchdbDashAdapterDashWebsql.pouchdbDashAdapterDashWebsqlStrings.`UTF-16`
import typings.pouchdbDashAdapterDashWebsql.pouchdbDashAdapterDashWebsqlStrings.`UTF-8`
