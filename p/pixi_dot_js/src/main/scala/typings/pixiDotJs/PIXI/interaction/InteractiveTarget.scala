...
import typings.pixiDotJs.PIXI.Circle
import typings.pixiDotJs.PIXI.Ellipse
import typings.pixiDotJs.PIXI.HitArea
import typings.pixiDotJs.PIXI.Polygon
import typings.pixiDotJs.PIXI.Rectangle
import typings.pixiDotJs.PIXI.RoundedRectangle
