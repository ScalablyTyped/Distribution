...
import typings.pixiDotJs.PIXI.core.ParticleContainer
import typings.pixiDotJs.PIXI.extras.AnimatedSprite
import typings.pixiDotJs.PIXI.loaders.Loader
...
object core extends js.Object {
  ...
  /**
    ...
    * @deprecated since version 3.0.0
    */
  type BitmapText = typings.pixiDotJs.PIXI.extras.BitmapText
  /**
    * @static
    * @constant
  ...
  /**
    ...
    */
  type ParticleContainer = typings.pixiDotJs.PIXI.particles.ParticleContainer
  /**
    * @static
    * @constant
  ...
  /**
    ...
    * @deprecated since version 3.0.0
    */
  type Rope = typings.pixiDotJs.PIXI.mesh.Rope
  /**
    * @static
    * @constant
  ...
  /**
    ...
    * @deprecated since version 3.0.0
    */
  type TilingSprite = typings.pixiDotJs.PIXI.extras.TilingSprite
  /**
    * @class
    * @private
