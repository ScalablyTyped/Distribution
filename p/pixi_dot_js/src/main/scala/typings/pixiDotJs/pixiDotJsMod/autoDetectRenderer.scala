...
object autoDetectRenderer extends js.Object {
  /**
    ...
    */
  def apply(): typings.pixiDotJs.PIXI.WebGLRenderer | typings.pixiDotJs.PIXI.CanvasRenderer = js.native
  def apply(options: RendererOptions): typings.pixiDotJs.PIXI.WebGLRenderer | typings.pixiDotJs.PIXI.CanvasRenderer = js.native
  def apply(width: Double, height: Double): typings.pixiDotJs.PIXI.WebGLRenderer | typings.pixiDotJs.PIXI.CanvasRenderer = js.native
  def apply(width: Double, height: Double, options: RendererOptions): typings.pixiDotJs.PIXI.WebGLRenderer | typings.pixiDotJs.PIXI.CanvasRenderer = js.native
  def apply(width: Double, height: Double, options: RendererOptions, forceCanvas: Boolean): typings.pixiDotJs.PIXI.WebGLRenderer | typings.pixiDotJs.PIXI.CanvasRenderer = js.native
}
