...
class RoundedRectangle ()
  ...
  def this(x: js.UndefOr[scala.Nothing], y: Double, width: Double, height: Double, radius: Double) = this()
  def this(
    x: Double,
    y: js.UndefOr[scala.Nothing],
    width: js.UndefOr[scala.Nothing],
  ...
  def this(x: Double, y: js.UndefOr[scala.Nothing], width: Double, height: Double, radius: Double) = this()
  def this(
    x: Double,
    y: Double,
    width: js.UndefOr[scala.Nothing],
  ...
  def this(x: Double, y: Double, width: js.UndefOr[scala.Nothing], height: Double, radius: Double) = this()
