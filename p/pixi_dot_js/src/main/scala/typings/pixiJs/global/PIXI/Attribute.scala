...
object Attribute extends js.Object {
  ...
  def from(buffer: String, size: Double, normalized: Boolean, start: Double): typings.pixiJs.PIXI.Attribute = js.native
  def from(buffer: String, size: Double, normalized: Boolean, start: Double, `type`: Double): typings.pixiJs.PIXI.Attribute = js.native
  def from(buffer: String, size: Double, normalized: Boolean, start: Double, `type`: Double, stride: Double): typings.pixiJs.PIXI.Attribute = js.native
}
