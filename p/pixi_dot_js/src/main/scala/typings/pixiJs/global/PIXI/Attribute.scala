...
object Attribute {
  ...
  /**
    ...
    */
  /* static member */
  inline def from(buffer: String): typings.pixiJs.PIXI.Attribute = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(buffer.asInstanceOf[js.Any]).asInstanceOf[typings.pixiJs.PIXI.Attribute]
  inline def from(buffer: String, size: Double): typings.pixiJs.PIXI.Attribute = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(buffer.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[typings.pixiJs.PIXI.Attribute]
  inline def from(buffer: String, size: Double, normalized: Boolean): typings.pixiJs.PIXI.Attribute = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(buffer.asInstanceOf[js.Any], size.asInstanceOf[js.Any], normalized.asInstanceOf[js.Any])).asInstanceOf[typings.pixiJs.PIXI.Attribute]
  inline def from(buffer: String, size: Double, normalized: Boolean, `type`: Double): typings.pixiJs.PIXI.Attribute = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(buffer.asInstanceOf[js.Any], size.asInstanceOf[js.Any], normalized.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[typings.pixiJs.PIXI.Attribute]
  ...
  inline def from(buffer: String, size: Double, normalized: Unit, `type`: Double): typings.pixiJs.PIXI.Attribute = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(buffer.asInstanceOf[js.Any], size.asInstanceOf[js.Any], normalized.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[typings.pixiJs.PIXI.Attribute]
  ...
  inline def from(buffer: String, size: Unit, normalized: Boolean): typings.pixiJs.PIXI.Attribute = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(buffer.asInstanceOf[js.Any], size.asInstanceOf[js.Any], normalized.asInstanceOf[js.Any])).asInstanceOf[typings.pixiJs.PIXI.Attribute]
  inline def from(buffer: String, size: Unit, normalized: Boolean, `type`: Double): typings.pixiJs.PIXI.Attribute = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(buffer.asInstanceOf[js.Any], size.asInstanceOf[js.Any], normalized.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[typings.pixiJs.PIXI.Attribute]
  ...
  inline def from(buffer: String, size: Unit, normalized: Unit, `type`: Double): typings.pixiJs.PIXI.Attribute = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(buffer.asInstanceOf[js.Any], size.asInstanceOf[js.Any], normalized.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[typings.pixiJs.PIXI.Attribute]
