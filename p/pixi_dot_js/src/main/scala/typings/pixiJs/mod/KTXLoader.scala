...
@JSImport("pixi.js", "KTXLoader")
@js.native
open class KTXLoader ()
  extends typings.pixiCompressedTextures.mod.KTXLoader
/* static members */
object KTXLoader {
  ...
  /** @ignore */
  @JSImport("pixi.js", "KTXLoader.extension")
  @js.native
  ...
  /**
    ...
    * using it.
    */
  @JSImport("pixi.js", "KTXLoader.loadKeyValueData")
  @js.native
