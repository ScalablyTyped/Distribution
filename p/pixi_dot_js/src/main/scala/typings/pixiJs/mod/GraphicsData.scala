...
class GraphicsData protected ()
  extends StObject
     with typings.pixiJs.PIXI.GraphicsData {
  ...
  def this(shape: typings.pixiJs.PIXI.Circle, fillStyle: Unit, lineStyle: typings.pixiJs.PIXI.LineStyle) = this()
  def this(
    shape: typings.pixiJs.PIXI.Circle,
    fillStyle: typings.pixiJs.PIXI.FillStyle,
    lineStyle: typings.pixiJs.PIXI.LineStyle
  ) = this()
  def this(shape: typings.pixiJs.PIXI.Ellipse, fillStyle: Unit, lineStyle: typings.pixiJs.PIXI.LineStyle) = this()
  def this(
    shape: typings.pixiJs.PIXI.Ellipse,
    fillStyle: typings.pixiJs.PIXI.FillStyle,
    lineStyle: typings.pixiJs.PIXI.LineStyle
  ) = this()
  def this(shape: typings.pixiJs.PIXI.Polygon, fillStyle: Unit, lineStyle: typings.pixiJs.PIXI.LineStyle) = this()
  def this(
    shape: typings.pixiJs.PIXI.Polygon,
    fillStyle: typings.pixiJs.PIXI.FillStyle,
    lineStyle: typings.pixiJs.PIXI.LineStyle
  ) = this()
  def this(shape: typings.pixiJs.PIXI.Rectangle, fillStyle: Unit, lineStyle: typings.pixiJs.PIXI.LineStyle) = this()
  def this(
  ...
  /**
    ...
    */
  /* CompleteClass */
  var fillStyle: typings.pixiJs.PIXI.FillStyle = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var holes: js.Array[typings.pixiJs.PIXI.GraphicsData] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var lineStyle: typings.pixiJs.PIXI.LineStyle = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var shape: typings.pixiJs.PIXI.Circle | typings.pixiJs.PIXI.Ellipse | typings.pixiJs.PIXI.Polygon | typings.pixiJs.PIXI.Rectangle | typings.pixiJs.PIXI.RoundedRectangle = js.native
