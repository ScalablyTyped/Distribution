...
object BitmapFont {
  ...
  inline def from(name: String, textStyle: typings.pixiText.mod.TextStyle): typings.pixiTextBitmap.libBitmapFontMod.BitmapFont = (^.asInstanceOf[js.Dynamic].applyDynamic("from")(name.asInstanceOf[js.Any], textStyle.asInstanceOf[js.Any])).asInstanceOf[typings.pixiTextBitmap.libBitmapFontMod.BitmapFont]
  ...
  inline def install(
    data: String,
    textures: typings.pixiCore.mod.Texture[typings.pixiCore.libTexturesResourcesResourceMod.Resource]
  ): typings.pixiTextBitmap.libBitmapFontMod.BitmapFont = (^.asInstanceOf[js.Dynamic].applyDynamic("install")(data.asInstanceOf[js.Any], textures.asInstanceOf[js.Any])).asInstanceOf[typings.pixiTextBitmap.libBitmapFontMod.BitmapFont]
  inline def install(
    data: String,
    textures: typings.pixiCore.mod.Texture[typings.pixiCore.libTexturesResourcesResourceMod.Resource],
