...
class BaseRenderTexture () extends BaseTexture {
  ...
  var _canvasRenderTarget: org.scalablytyped.runtime.NumberDictionary[stdLib.WebGLTexture] = js.native
  var _glRenderTargets: org.scalablytyped.runtime.NumberDictionary[stdLib.WebGLTexture] = js.native
