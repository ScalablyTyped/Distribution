...
class TextMetrics protected () extends js.Object {
  def this(text: java.lang.String, style: TextStyle, width: scala.Double, height: scala.Double, lines: js.Array[scala.Double], lineWidths: js.Array[scala.Double], lineHeight: scala.Double, maxLineWidth: scala.Double, fontProperties: js.Any) = this()
  var fontProperties: js.Any = js.native
  var height: scala.Double = js.native
  var lineHeight: scala.Double = js.native
  var lineWidths: js.Array[scala.Double] = js.native
  var lines: js.Array[scala.Double] = js.native
