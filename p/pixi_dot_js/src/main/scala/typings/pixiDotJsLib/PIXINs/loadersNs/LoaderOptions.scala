...
trait LoaderOptions extends js.Object {
  ...
  var loadType: js.UndefOr[pixiDotJsLib.PIXINs.loadersNs.ResourceNs.LOAD_TYPE] = js.undefined
  var metadata: js.UndefOr[IMetadata] = js.undefined
  var onComplete: js.UndefOr[OnCompleteSignal] = js.undefined
  var timeout: js.UndefOr[scala.Double] = js.undefined
  var xhrType: js.UndefOr[pixiDotJsLib.PIXINs.loadersNs.ResourceNs.XHR_RESPONSE_TYPE] = js.undefined
}
...
object LoaderOptions {
  ...
  def apply(
    ...
    loadType: pixiDotJsLib.PIXINs.loadersNs.ResourceNs.LOAD_TYPE = null,
    metadata: IMetadata = null,
    onComplete: OnCompleteSignal = null,
    timeout: scala.Int | scala.Double = null,
    xhrType: pixiDotJsLib.PIXINs.loadersNs.ResourceNs.XHR_RESPONSE_TYPE = null
  ): LoaderOptions = {
