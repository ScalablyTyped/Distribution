...
@JSImport("@pixi-spine/runtime-4.1", "RGBTimeline")
@js.native
open class RGBTimeline protected ()
  extends CurveTimeline
     with SlotTimeline {
  def this(frameCount: Double, bezierCount: Double, slotIndex: Double) = this()
  
  /** Sets the time in seconds, red, green, blue, and alpha for the specified key frame. */
  def setFrame(frame: Double, time: Double, r: Double, g: Double, b: Double): Unit = js.native
