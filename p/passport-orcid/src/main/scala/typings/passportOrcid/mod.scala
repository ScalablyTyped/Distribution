...
import typings.passportOrcid.anon.OmitStrategyOptionspassRe
import typings.passportOrcid.anon.Sandbox
import typings.passportOrcid.passportOrcidBooleans.`false`
import typings.passportOrcid.passportOrcidBooleans.`true`
import typings.passportOrcid.passportOrcidStrings.authorizationURL
import typings.passportOrcid.passportOrcidStrings.orcid
import typings.passportOrcid.passportOrcidStrings.tokenURL
...
object mod {
  ...
  type VerifyFunction = typings.passportOauth2.mod.VerifyFunction
  
  type VerifyFunctionWithRequest = typings.passportOauth2.mod.VerifyFunctionWithRequest
}
