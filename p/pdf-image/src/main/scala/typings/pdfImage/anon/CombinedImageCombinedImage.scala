...
object CombinedImageCombinedImage {
  ...
  @scala.inline
  implicit class CombinedImageCombinedImageOps[Self <: CombinedImageCombinedImage[_], /* <: scala.Boolean */ CombinedImage] (val x: Self with CombinedImageCombinedImage[CombinedImage]) extends AnyVal {
    @scala.inline
