...
object anon {
  ...
  object `0` {
    ...
    implicit class `0MutableBuilder`[Self <: `0`[_], CombinedImage /* <: Boolean */] (val x: Self with `0`[CombinedImage]) extends AnyVal {
      ...
      @scala.inline
      def setCombinedImageUndefined: Self = StObject.set(x, "combinedImage", js.undefined)
    }
  }
  ...
  object ReadonlyConvertOptions {
    ...
    @scala.inline
    def apply(): ReadonlyConvertOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ReadonlyConvertOptions]
    }
    
    @scala.inline
    implicit class ReadonlyConvertOptionsMutableBuilder[Self <: ReadonlyConvertOptions] (val x: Self) extends AnyVal {
