...
@js.native
trait Anon_ConfigDefault extends js.Object {
  ...
  /**
  	...
  	*/
  // TODO: Remove this for the next major release
  def default[ConfigType /* <: pkgDashConfLib.pkgDashConfMod.pkgConfNs.Config */](namespace: java.lang.String): js.Promise[ConfigType with pkgDashConfLib.pkgDashConfMod.pkgConfNs.Config] = js.native
  def default[ConfigType /* <: pkgDashConfLib.pkgDashConfMod.pkgConfNs.Config */](namespace: java.lang.String, options: pkgDashConfLib.pkgDashConfMod.pkgConfNs.Options[ConfigType]): js.Promise[ConfigType with pkgDashConfLib.pkgDashConfMod.pkgConfNs.Config] = js.native
  /**
