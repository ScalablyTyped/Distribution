...
object ^ extends js.Object {
  ...
  @JSName("default")
  var default_Original: pkgDashConfLib.Anon_Config = js.native
  /**
  	...
  	```
  	*/
  def apply[ConfigType /* <: Config */](namespace: java.lang.String): js.Promise[ConfigType with Config] = js.native
  def apply[ConfigType /* <: Config */](namespace: java.lang.String, options: Options[ConfigType]): js.Promise[ConfigType with Config] = js.native
  /**
  	It [walks up](https://github.com/sindresorhus/find-up) parent directories until a `package.json` can be found, reads it, and returns the user specified namespace or an empty object if not found.
  	@param namespace - The `package.json` namespace you want.
  	@returns A `Promise` for the config.
