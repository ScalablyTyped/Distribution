...
object ^ extends js.Object {
  def apply(pid: scala.Double | java.lang.String): js.Promise[Stat] = js.native
  def apply(
    pid: scala.Double | java.lang.String,
    callback: js.Function2[/* err */ stdLib.Error | scala.Null, /* stats */ Stat, scala.Unit]
  ): scala.Unit = js.native
  def apply(pid: scala.Double | java.lang.String, options: org.scalablytyped.runtime.StringDictionary[js.Any]): js.Promise[Stat] = js.native
  def apply(
    pid: scala.Double | java.lang.String,
    options: org.scalablytyped.runtime.StringDictionary[js.Any],
    callback: js.Function2[/* err */ stdLib.Error | scala.Null, /* stats */ Stat, scala.Unit]
  ): scala.Unit = js.native
  def apply(pids: js.Array[scala.Double | java.lang.String]): js.Promise[org.scalablytyped.runtime.StringDictionary[Stat]] = js.native
  def apply(
  ...
  def apply(
    pids: js.Array[scala.Double | java.lang.String],
    options: org.scalablytyped.runtime.StringDictionary[js.Any]
  ): js.Promise[org.scalablytyped.runtime.StringDictionary[Stat]] = js.native
  def apply(
    pids: js.Array[scala.Double | java.lang.String],
    options: org.scalablytyped.runtime.StringDictionary[js.Any],
    callback: js.Function2[
