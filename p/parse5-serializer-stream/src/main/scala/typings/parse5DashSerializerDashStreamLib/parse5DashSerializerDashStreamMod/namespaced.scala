package typings
package parse5DashSerializerDashStreamLib.parse5DashSerializerDashStreamMod
...
@js.native
class namespaced protected () extends SerializerStream {
  /**
       ...
       */
  def this(node: parse5Lib.parse5Mod.Node) = this()
  /**
       * Streaming AST node to an HTML serializer. A readable stream.
       *
       * @param node - Node to serialize.
       * @param options - Serialization options.
       */
  def this(node: parse5Lib.parse5Mod.Node, options: parse5Lib.parse5Mod.SerializerOptions) = this()
}
