package typings.parchment.storeMod
...
trait AttributorStore extends js.Object {
  ...
  var domNode: js.Any
  def attribute(attribute: typings.parchment.attributorMod.default, value: js.Any): Unit
  def build(): Unit
...
object AttributorStore {
  @scala.inline
  def apply(
    attribute: (typings.parchment.attributorMod.default, js.Any) => Unit,
    attributes: js.Any,
    build: () => Unit,
