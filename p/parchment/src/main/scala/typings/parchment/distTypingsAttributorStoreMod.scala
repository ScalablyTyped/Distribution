...
import typings.parchment.distTypingsBlotAbstractBlotMod.Formattable
...
object distTypingsAttributorStoreMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    override def attribute(attribute: typings.parchment.distTypingsAttributorAttributorMod.default, value: Any): Unit = js.native
  ...
  trait AttributorStore extends StObject {
    ...
    def attribute(attribute: typings.parchment.distTypingsAttributorAttributorMod.default, value: Any): Unit
  ...
  object AttributorStore {
    ...
    inline def apply(
      attribute: (typings.parchment.distTypingsAttributorAttributorMod.default, Any) => Unit,
      attributes: Any,
      build: () => Unit,
