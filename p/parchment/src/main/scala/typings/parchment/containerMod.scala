...
object containerMod {
  ...
  trait ContainerBlot
    ...
    @JSName("next")
    var next_ContainerBlot: typings.parchment.blockMod.default | ContainerBlot | Null = js.native
    
    @JSName("prev")
    var prev_ContainerBlot: typings.parchment.blockMod.default | ContainerBlot | Null = js.native
  }
}
