...
import typings.parchment.distTypingsCollectionLinkedListMod.default
import typings.parchment.distTypingsCollectionLinkedNodeMod.LinkedNode
...
object distTypingsBlotAbstractBlotMod {
