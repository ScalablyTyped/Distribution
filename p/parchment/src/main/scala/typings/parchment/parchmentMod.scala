...
object parchmentMod extends js.Object {
  ...
  object default extends js.Object {
    ...
    var query_Original: js.Function2[
        ...
        typings.parchment.distSrcAttributorAttributorMod.default | BlotConstructor | Null
      ] = js.native
    @JSName("register")
    ...
    def query(query: String): typings.parchment.distSrcAttributorAttributorMod.default | BlotConstructor | Null = js.native
    def query(query: String, scope: Scope): typings.parchment.distSrcAttributorAttributorMod.default | BlotConstructor | Null = js.native
    def query(query: Scope): typings.parchment.distSrcAttributorAttributorMod.default | BlotConstructor | Null = js.native
    def query(query: Scope, scope: Scope): typings.parchment.distSrcAttributorAttributorMod.default | BlotConstructor | Null = js.native
    def query(query: Node): typings.parchment.distSrcAttributorAttributorMod.default | BlotConstructor | Null = js.native
    def query(query: Node, scope: Scope): typings.parchment.distSrcAttributorAttributorMod.default | BlotConstructor | Null = js.native
