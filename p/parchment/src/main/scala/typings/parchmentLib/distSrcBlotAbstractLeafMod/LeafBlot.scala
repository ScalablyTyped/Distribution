...
/* RemoveMultipleInheritance: Dropped parents List(parchmentLib.distSrcBlotAbstractBlotMod.Leaf because Would inherit conflicting mutable fields List(prev, next, parent, scroll, domNode))*/
@js.native
trait LeafBlot
