...
/* RemoveMultipleInheritance: Dropped parents List(parchmentLib.distSrcBlotAbstractBlotMod.Parent because Would inherit conflicting mutable fields List(prev, next, parent, scroll, domNode))*/
@js.native
trait ContainerBlot
