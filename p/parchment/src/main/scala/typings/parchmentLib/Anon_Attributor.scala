...
@js.native
trait Anon_Attributor extends js.Object {
  var Attributor: Anon_AttributeClass = js.native
  var Block: Anon_BlotNameDomNode = js.native
  var Container: Anon_AllowedChildren = js.native
  var Embed: Anon_DomNodeFormats = js.native
  var Format: Anon_DomNode = js.native
  var Inline: Anon_BlotNameDomNodeFormats = js.native
  var Leaf: Anon_DomNodeScope = js.native
  ...
  var Text: Anon_BlotNameCreate = js.native
  @JSName("create")
