...
trait PushNotification extends js.Object {
  /**
  		 ...
  		 */
  def clearAllNotifications(successHandler: js.Function0[_], errorHandler: js.Function0[_]): scala.Unit = js.native
  /**
  		 * iOS only
  ...
  /**
  		 ...
  		 * @param errorHandler
  		 */
  def getApplicationIconBadgeNumber(successHandler: js.Function1[/* count */ scala.Double, _], errorHandler: js.Function0[_]): scala.Unit = js.native
  /**
  		 ...
  		 * @param callback
  		 */
  def off(event: java.lang.String, callback: js.Function1[/* response */ EventResponse, _]): scala.Unit = js.native
  @JSName("off")
  def off_error(
    event: phonegapDashPluginDashPushLib.phonegapDashPluginDashPushLibStrings.error,
    callback: js.Function1[/* response */ stdLib.Error, _]
  ): scala.Unit = js.native
  @JSName("off")
  def off_notification(
    event: phonegapDashPluginDashPushLib.phonegapDashPluginDashPushLibStrings.notification,
    callback: js.Function1[/* response */ NotificationEventResponse, _]
  ): scala.Unit = js.native
  @JSName("off")
  def off_registration(
    event: phonegapDashPluginDashPushLib.phonegapDashPluginDashPushLibStrings.registration,
    callback: js.Function1[/* response */ RegistrationEventResponse, _]
  ): scala.Unit = js.native
  /**
  		 *
  		 ...
  		 * @param callback
  		 */
  def on(event: java.lang.String, callback: js.Function1[/* response */ EventResponse, _]): scala.Unit = js.native
  /**
  ...
  /**
  		 ...
  		 * @param count
  		 */
  def setApplicationIconBadgeNumber(successHandler: js.Function0[_], errorHandler: js.Function0[_], count: scala.Double): scala.Unit = js.native
  /**
  		 ...
  		 */
  def subscribe(topic: java.lang.String, successHandler: js.Function0[_], errorHandler: js.Function0[_]): scala.Unit = js.native
  /**
  ...
  /**
  		 ...
  		 * @param errorHandler Is called when the api encounters an error while unregistering.
  		 */
  def unsubscribe(topic: java.lang.String, successHandler: js.Function0[_], errorHandler: js.Function0[_]): scala.Unit = js.native
}
