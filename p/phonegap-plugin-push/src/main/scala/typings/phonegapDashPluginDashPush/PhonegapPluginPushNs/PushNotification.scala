...
import typings.phonegapDashPluginDashPush.phonegapDashPluginDashPushStrings.error
import typings.phonegapDashPluginDashPush.phonegapDashPluginDashPushStrings.notification
import typings.phonegapDashPluginDashPush.phonegapDashPluginDashPushStrings.registration
