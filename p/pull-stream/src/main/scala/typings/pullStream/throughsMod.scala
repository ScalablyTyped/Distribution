...
object throughsMod {
  ...
  inline def asyncMap[In, Out](fn: js.Function2[/* data */ In, /* cb */ SourceCallback[Out], js.Any]): Through_[In, Out] = ^.asInstanceOf[js.Dynamic].applyDynamic("asyncMap")(fn.asInstanceOf[js.Any]).asInstanceOf[Through_[In, Out]]
  ...
  inline def flatten[Out](): Through_[js.Array[Out | Source[Out] | (Through_[js.Any, Out])], Out] = ^.asInstanceOf[js.Dynamic].applyDynamic("flatten")().asInstanceOf[Through_[js.Array[Out | Source[Out] | (Through_[js.Any, Out])], Out]]
  ...
  inline def nonUnique[InOut](prop: js.Function1[/* data */ InOut, js.Any]): Through_[InOut, InOut] = ^.asInstanceOf[js.Dynamic].applyDynamic("nonUnique")(prop.asInstanceOf[js.Any]).asInstanceOf[Through_[InOut, InOut]]
  ...
  inline def through[InOut](op: js.Function1[/* data */ InOut, js.Any]): Through_[InOut, InOut] = ^.asInstanceOf[js.Dynamic].applyDynamic("through")(op.asInstanceOf[js.Any]).asInstanceOf[Through_[InOut, InOut]]
  inline def through[InOut](op: js.Function1[/* data */ InOut, js.Any], onEnd: js.Function1[/* err */ EndOrError, js.Any]): Through_[InOut, InOut] = (^.asInstanceOf[js.Dynamic].applyDynamic("through")(op.asInstanceOf[js.Any], onEnd.asInstanceOf[js.Any])).asInstanceOf[Through_[InOut, InOut]]
  inline def through[InOut](op: Unit, onEnd: js.Function1[/* err */ EndOrError, js.Any]): Through_[InOut, InOut] = (^.asInstanceOf[js.Dynamic].applyDynamic("through")(op.asInstanceOf[js.Any], onEnd.asInstanceOf[js.Any])).asInstanceOf[Through_[InOut, InOut]]
  ...
  inline def unique[InOut](prop: js.Function1[/* data */ InOut, js.Any]): Through_[InOut, InOut] = ^.asInstanceOf[js.Dynamic].applyDynamic("unique")(prop.asInstanceOf[js.Any]).asInstanceOf[Through_[InOut, InOut]]
}
