...
object asyncMapMod {
  ...
  /**
    ...
    */
  @scala.inline
  def apply[In, Out](fn: js.Function2[/* data */ In, /* cb */ SourceCallback[Out], js.Any]): Through_[In, Out] = ^.asInstanceOf[js.Dynamic].apply(fn.asInstanceOf[js.Any]).asInstanceOf[Through_[In, Out]]
