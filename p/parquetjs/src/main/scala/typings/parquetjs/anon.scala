...
object anon {
  ...
  object Codec {
    ...
    inline def apply(encoding_stats: js.Any, statistics: js.Any): Codec = {
    ...
    extension [Self <: Codec](x: Self) {
      ...
      inline def setEncoding_stats(value: js.Any): Self = StObject.set(x, "encoding_stats", value.asInstanceOf[js.Any])
      ...
      inline def setEncodingsVarargs(value: Double*): Self = StObject.set(x, "encodings", js.Array(value :_*))
      ...
      inline def setPath_in_schemaVarargs(value: (js.Array[String] | String)*): Self = StObject.set(x, "path_in_schema", js.Array(value :_*))
      
      inline def setStatistics(value: js.Any): Self = StObject.set(x, "statistics", value.asInstanceOf[js.Any])
  ...
  object Columns {
    ...
    inline def apply(columns: js.Any, num_rows: Double, total_byte_size: Double): Columns = {
    ...
    extension [Self <: Columns](x: Self) {
      ...
      inline def setSorting_columnsVarargs(value: String*): Self = StObject.set(x, "sorting_columns", js.Array(value :_*))
  ...
  object Count {
    ...
    extension [Self <: Count](x: Self) {
      ...
      inline def setDlevelsVarargs(value: Double*): Self = StObject.set(x, "dlevels", js.Array(value :_*))
      
      inline def setRlevels(value: js.Array[Double]): Self = StObject.set(x, "rlevels", value.asInstanceOf[js.Any])
      
      inline def setRlevelsVarargs(value: Double*): Self = StObject.set(x, "rlevels", js.Array(value :_*))
      
      inline def setValues(value: js.Array[Buffer]): Self = StObject.set(x, "values", value.asInstanceOf[js.Any])
      
      inline def setValuesVarargs(value: Buffer*): Self = StObject.set(x, "values", js.Array(value :_*))
    }
  }
