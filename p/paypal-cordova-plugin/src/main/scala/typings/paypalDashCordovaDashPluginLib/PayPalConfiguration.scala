...
class PayPalConfiguration () extends js.Object {
  ...
  /**
    ...
    * Defaults to true.
    */
  var acceptCreditCards: scala.Boolean = js.native
  /**
    * Will be overridden by email used in most recent PayPal login.
    */
  var defaultUserEmail: java.lang.String = js.native
  /**
    * Will be overridden by phone country code used in most recent PayPal login
    */
  var defaultUserPhoneCountryCode: java.lang.String = js.native
  /**
    ...
    */
  var defaultUserPhoneNumber: java.lang.String = js.native
  /**
    ...
    * Defaults to false.
    */
  var disableBlurWhenBackgrounding: scala.Boolean = js.native
  /**
    ...
    * Defaults to false.
    */
  var forceDefaultsInSandbox: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * Defaults to true.
    */
  var rememberUser: scala.Boolean = js.native
  /**
    * Password to use for sandbox if 'forceDefaultsInSandbox' is set.
    */
  var sandboxUserPassword: java.lang.String = js.native
  /**
    * PIN to use for sandbox if 'forceDefaultsInSandbox' is set.
    */
  var sandboxUserPin: java.lang.String = js.native
}
