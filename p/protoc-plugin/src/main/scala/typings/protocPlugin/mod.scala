...
import typings.googleProtobuf.googleProtobufDescriptorPbMod.SourceCodeInfo.Location.AsObject
...
object mod {
  ...
  inline def CodeGeneratorRequest(): js.Promise[typings.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorRequest] = ^.asInstanceOf[js.Dynamic].applyDynamic("CodeGeneratorRequest")().asInstanceOf[js.Promise[typings.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorRequest]]
  inline def CodeGeneratorRequest(stdin: Readable): js.Promise[typings.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorRequest] = ^.asInstanceOf[js.Dynamic].applyDynamic("CodeGeneratorRequest")(stdin.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorRequest]]
