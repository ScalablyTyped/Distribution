...
trait ParserStream[TDocument]
  ...
  @JSName("on")
  def on_script(
    event: parse5DashParserDashStreamLib.parse5DashParserDashStreamLibStrings.script,
    listener: js.Function3[
      /* scriptElement */ parse5Lib.parse5Mod.Element, 
      /* documentWrite */ js.Function1[/* html */ java.lang.String, scala.Unit], 
