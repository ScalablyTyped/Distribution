...
object distCjsMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Writable * / any */ @JSImport("parse5-parser-stream/dist/cjs", "ParserStream")
  @js.native
  /**
  ...
  object ParserStream {
    ...
    @JSImport("parse5-parser-stream/dist/cjs", "ParserStream")
    @js.native
