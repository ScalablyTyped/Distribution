...
object SaveOptions extends StObject {
  ...
  sealed trait DONOTSAVECHANGES
    extends StObject
       with SaveOptions
  /* 0 */ val DONOTSAVECHANGES: typings.photoshop.constantsMod.SaveOptions.DONOTSAVECHANGES & Double = js.native
  ...
  sealed trait PROMPTTOSAVECHANGES
    extends StObject
       with SaveOptions
  /* 1 */ val PROMPTTOSAVECHANGES: typings.photoshop.constantsMod.SaveOptions.PROMPTTOSAVECHANGES & Double = js.native
  ...
  sealed trait SAVECHANGES
    extends StObject
       with SaveOptions
  /* 2 */ val SAVECHANGES: typings.photoshop.constantsMod.SaveOptions.SAVECHANGES & Double = js.native
}
