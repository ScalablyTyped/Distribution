...
object colorTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.photoshop.colorTypesMod.RGBColorDescriptor
    - typings.photoshop.colorTypesMod.HSBColorDescriptor
    - typings.photoshop.colorTypesMod.CMYKColorDescriptor
    - typings.photoshop.colorTypesMod.LabColorDescriptor
    - typings.photoshop.colorTypesMod.GrayscaleColorDescriptor
  */
  trait ColorDescriptor extends StObject
  object ColorDescriptor {
    
    inline def CMYKColorDescriptor(black: Double, cyan: Double, magenta: Double, yellow: Double): typings.photoshop.colorTypesMod.CMYKColorDescriptor = {
      val __obj = js.Dynamic.literal(_obj = "CMYKColorClass", black = black.asInstanceOf[js.Any], cyan = cyan.asInstanceOf[js.Any], magenta = magenta.asInstanceOf[js.Any], yellow = yellow.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.photoshop.colorTypesMod.CMYKColorDescriptor]
    }
    
    inline def GrayscaleColorDescriptor(gray: Double): typings.photoshop.colorTypesMod.GrayscaleColorDescriptor = {
      val __obj = js.Dynamic.literal(_obj = "grayscale", gray = gray.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.photoshop.colorTypesMod.GrayscaleColorDescriptor]
    }
    
    inline def HSBColorDescriptor(brightness: Double, hue: Unit, saturation: Double): typings.photoshop.colorTypesMod.HSBColorDescriptor = {
      ...
      __obj.asInstanceOf[typings.photoshop.colorTypesMod.HSBColorDescriptor]
    }
    
    inline def LabColorDescriptor(a: Double, b: Double, luminance: Double): typings.photoshop.colorTypesMod.LabColorDescriptor = {
      ...
      __obj.asInstanceOf[typings.photoshop.colorTypesMod.LabColorDescriptor]
    }
    
    inline def RGBColorDescriptor(blue: Double, green: Double, red: Double): typings.photoshop.colorTypesMod.RGBColorDescriptor = {
      ...
      __obj.asInstanceOf[typings.photoshop.colorTypesMod.RGBColorDescriptor]
    }
  }
