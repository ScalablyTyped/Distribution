...
import typings.photoshop.actionsMod.ActionSet
import typings.photoshop.constantsMod.DialogModes
...
import typings.photoshop.documentsMod.Documents
import typings.photoshop.solidColorMod.SolidColor
import typings.photoshop.textFontsMod.TextFonts
import typings.photoshop.toolMod.Tool
...
object photoshopMod {
  ...
  open class Photoshop () extends StObject {
    ...
    /**
      ...
      * Allows for polyfills into the Action class
      */
    var Action: Instantiable1[/* id */ Double, typings.photoshop.actionsMod.Action] = js.native
    
    /**
      * @ignore
      * Allows for polyfills into the Action Set class
      */
    var ActionSet: Instantiable1[/* id */ Any, typings.photoshop.actionsMod.ActionSet] = js.native
    
    /**
      * @ignore
      * Allows for polyfills into the Document class
      */
    var Document: Instantiable1[/* id */ Double, typings.photoshop.documentMod.Document] = js.native
    
    /**
      * @ignore
      * Allows for polyfills into the Layer class
      */
    var Layer: Instantiable2[/* id */ Double, /* docId */ Double, typings.photoshop.layerMod.Layer] = js.native
    
    /**
      * @ignore
      * Allows for polyfills into the Application object
      */
    var Photoshop: Instantiable0[typings.photoshop.photoshopMod.Photoshop] = js.native
    
    /**
      * @ignore
      * Exposes SolidColor class for constructing objects
      */
    var SolidColor: Instantiable0[typings.photoshop.solidColorMod.SolidColor] = js.native
