...
trait Anon_DefaultOptions extends js.Object {
  ...
  // ): Promise<pSettle.PromiseResult<ValueType>[]>;
  // export = pSettle;
  def default[ValueType](promises: js.Array[ValueType | js.Thenable[ValueType]]): js.Promise[js.Array[pDashSettleLib.pDashSettleMod.pSettleNs.PromiseResult[ValueType]]] = js.native
