...
import typings.parse5.distCjsCommonTokenMod.ElementLocation
...
object distCjsTreeAdaptersDefaultMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.parse5.distCjsTreeAdaptersDefaultMod.Element
    - typings.parse5.distCjsTreeAdaptersDefaultMod.Template
    - typings.parse5.distCjsTreeAdaptersDefaultMod.CommentNode
    - typings.parse5.distCjsTreeAdaptersDefaultMod.TextNode
    - typings.parse5.distCjsTreeAdaptersDefaultMod.DocumentType
  */
  trait ChildNode
    extends StObject
       with Node
  object ChildNode {
    ...
    inline def CommentNode(data: String): typings.parse5.distCjsTreeAdaptersDefaultMod.CommentNode = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], nodeName = "#comment", parentNode = null)
      __obj.asInstanceOf[typings.parse5.distCjsTreeAdaptersDefaultMod.CommentNode]
    }
    
    inline def DocumentType(name: String, publicId: String, systemId: String): typings.parse5.distCjsTreeAdaptersDefaultMod.DocumentType = {
      ...
      __obj.asInstanceOf[typings.parse5.distCjsTreeAdaptersDefaultMod.DocumentType]
    }
    ...
    inline def Element(
      ...
      __obj.asInstanceOf[typings.parse5.distCjsTreeAdaptersDefaultMod.Element]
    }
    ...
    inline def Template(
      ...
      __obj.asInstanceOf[typings.parse5.distCjsTreeAdaptersDefaultMod.Template]
    }
    
    inline def TextNode(value: String): typings.parse5.distCjsTreeAdaptersDefaultMod.TextNode = {
      val __obj = js.Dynamic.literal(nodeName = "#text", value = value.asInstanceOf[js.Any], parentNode = null)
      __obj.asInstanceOf[typings.parse5.distCjsTreeAdaptersDefaultMod.TextNode]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.parse5.distCjsTreeAdaptersDefaultMod.ParentNode
    - typings.parse5.distCjsTreeAdaptersDefaultMod.ChildNode
  */
  ...
  object Node {
    ...
    inline def Document(childNodes: js.Array[ChildNode], mode: DOCUMENT_MODE): typings.parse5.distCjsTreeAdaptersDefaultMod.Document = {
      val __obj = js.Dynamic.literal(childNodes = childNodes.asInstanceOf[js.Any], mode = mode.asInstanceOf[js.Any], nodeName = "#document")
      __obj.asInstanceOf[typings.parse5.distCjsTreeAdaptersDefaultMod.Document]
    }
    
    inline def DocumentFragment(childNodes: js.Array[ChildNode]): typings.parse5.distCjsTreeAdaptersDefaultMod.DocumentFragment = {
      val __obj = js.Dynamic.literal(childNodes = childNodes.asInstanceOf[js.Any], nodeName = "#document-fragment")
      __obj.asInstanceOf[typings.parse5.distCjsTreeAdaptersDefaultMod.DocumentFragment]
    }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.parse5.distCjsTreeAdaptersDefaultMod.Document
    - typings.parse5.distCjsTreeAdaptersDefaultMod.DocumentFragment
    - typings.parse5.distCjsTreeAdaptersDefaultMod.Element
    - typings.parse5.distCjsTreeAdaptersDefaultMod.Template
  */
  trait ParentNode
  ...
  - typings.parse5.distCjsTreeAdaptersDefaultMod.Node because Already inherited
  - typings.parse5.distCjsTreeAdaptersDefaultMod.ParentNode because Already inherited
  - typings.parse5.distCjsTreeAdaptersDefaultMod.ChildNode because Already inherited */ trait Template
    extends StObject
       with Element {
