...
@js.native
sealed trait TAG_ID extends StObject
@JSImport("parse5/dist/cjs/common/html", "TAG_ID")
@js.native
object TAG_ID extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[TAG_ID & Double] = js.native
