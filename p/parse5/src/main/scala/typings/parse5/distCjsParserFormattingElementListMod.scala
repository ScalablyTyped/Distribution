...
import typings.parse5.distCjsParserFormattingElementListMod.EntryType.Element
import typings.parse5.distCjsParserFormattingElementListMod.EntryType.Marker
...
object distCjsParserFormattingElementListMod {
  ...
  object EntryType extends StObject {
    ...
    sealed trait Element
      extends StObject
         with EntryType
    /* 1 */ val Element: typings.parse5.distCjsParserFormattingElementListMod.EntryType.Element & Double = js.native
    
    @js.native
    sealed trait Marker
      extends StObject
         with EntryType
    /* 0 */ val Marker: typings.parse5.distCjsParserFormattingElementListMod.EntryType.Marker & Double = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.parse5.distCjsParserFormattingElementListMod.MarkerEntry
    - typings.parse5.distCjsParserFormattingElementListMod.ElementEntry[T]
  */
  ...
  object Entry {
    ...
    inline def ElementEntry[T /* <: TreeAdapterTypeMap[Any, Any, Any, Any, Any, Any, Any, Any, Any, Any] */](
      ...
      val __obj = js.Dynamic.literal(element = element.asInstanceOf[js.Any], token = token.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.parse5.distCjsParserFormattingElementListMod.ElementEntry[T]]
    }
    
    inline def MarkerEntry(`type`: Marker): typings.parse5.distCjsParserFormattingElementListMod.MarkerEntry = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.parse5.distCjsParserFormattingElementListMod.MarkerEntry]
    }
  }
