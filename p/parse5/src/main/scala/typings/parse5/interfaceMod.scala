...
import typings.parse5.anon.PartialElementLocation
import typings.parse5.htmlMod.DOCUMENT_MODE
import typings.parse5.htmlMod.NS
import typings.parse5.tokenMod.Attribute
import typings.parse5.tokenMod.ElementLocation
...
object interfaceMod {
  ...
  trait TreeAdapter[T /* <: TreeAdapterTypeMap[Any, Any, Any, Any, Any, Any, Any, Any, Any, Any] */] extends StObject {
    ...
    def updateNodeSourceCodeLocation_node(
      node: /* import warning: importer.ImportType#apply Failed type conversion: T['node'] */ js.Any,
      location: PartialElementLocation
    ): Unit = js.native
  }
