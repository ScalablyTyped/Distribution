...
import typings.parse5.anon.BeforeElement
...
import typings.parse5.distCjsCommonTokenMod.LocationWithAttributes
import typings.parse5.distCjsCommonTokenMod.TagToken
import typings.parse5.distCjsCommonTokenMod.Token
import typings.parse5.distCjsParserFormattingElementListMod.FormattingElementList
import typings.parse5.distCjsParserOpenElementStackMod.OpenElementStack
import typings.parse5.distCjsParserOpenElementStackMod.StackHandler
import typings.parse5.distCjsTokenizerMod.TokenHandler
import typings.parse5.distCjsTokenizerMod.Tokenizer
...
object distCjsParserMod {
  
  @js.native
  sealed trait InsertionMode extends StObject
  @JSImport("parse5/dist/cjs/parser", "InsertionMode")
  @js.native
  ...
  @JSImport("parse5/dist/cjs/parser", "Parser")
  @js.native
  open class Parser[T /* <: TreeAdapterTypeMap[Any, Any, Any, Any, Any, Any, Any, Any, Any, Any] */] ()
    ...
    def _findFosterParentingLocation(): BeforeElement[T] = js.native
