...
object defaultMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.parse5.defaultMod.Element
    - typings.parse5.defaultMod.Template
    - typings.parse5.defaultMod.CommentNode
    - typings.parse5.defaultMod.TextNode
    - typings.parse5.defaultMod.DocumentType
  */
  trait ChildNode
    extends StObject
       with Node
  object ChildNode {
    ...
    inline def CommentNode(data: String): typings.parse5.defaultMod.CommentNode = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], nodeName = "#comment", parentNode = null)
      __obj.asInstanceOf[typings.parse5.defaultMod.CommentNode]
    }
    
    inline def DocumentType(name: String, publicId: String, systemId: String): typings.parse5.defaultMod.DocumentType = {
      ...
      __obj.asInstanceOf[typings.parse5.defaultMod.DocumentType]
    }
    ...
    inline def Element(
      ...
      __obj.asInstanceOf[typings.parse5.defaultMod.Element]
    }
    ...
    inline def Template(
      ...
      __obj.asInstanceOf[typings.parse5.defaultMod.Template]
    }
    
    inline def TextNode(value: String): typings.parse5.defaultMod.TextNode = {
      val __obj = js.Dynamic.literal(nodeName = "#text", value = value.asInstanceOf[js.Any], parentNode = null)
      __obj.asInstanceOf[typings.parse5.defaultMod.TextNode]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.parse5.defaultMod.ParentNode
    - typings.parse5.defaultMod.ChildNode
  */
  ...
  object Node {
    ...
    inline def Document(childNodes: js.Array[ChildNode], mode: DOCUMENT_MODE): typings.parse5.defaultMod.Document = {
      val __obj = js.Dynamic.literal(childNodes = childNodes.asInstanceOf[js.Any], mode = mode.asInstanceOf[js.Any], nodeName = "#document")
      __obj.asInstanceOf[typings.parse5.defaultMod.Document]
    }
    
    inline def DocumentFragment(childNodes: js.Array[ChildNode]): typings.parse5.defaultMod.DocumentFragment = {
      val __obj = js.Dynamic.literal(childNodes = childNodes.asInstanceOf[js.Any], nodeName = "#document-fragment")
      __obj.asInstanceOf[typings.parse5.defaultMod.DocumentFragment]
    }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.parse5.defaultMod.Document
    - typings.parse5.defaultMod.DocumentFragment
    - typings.parse5.defaultMod.Element
    - typings.parse5.defaultMod.Template
  */
  trait ParentNode
  ...
  - typings.parse5.defaultMod.Node because Already inherited
  - typings.parse5.defaultMod.ParentNode because Already inherited
  - typings.parse5.defaultMod.ChildNode because Already inherited */ trait Template
    extends StObject
       with Element {
