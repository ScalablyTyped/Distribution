...
trait Anon_FuncMax extends js.Object {
  var func: Anon_01ArgCountFFuncMax
...
object Anon_FuncMax {
  @scala.inline
  def apply(func: Anon_01ArgCountFFuncMax, regSymbol: maxBackslashb, symbol: max): Anon_FuncMax = {
    ...
    __obj.asInstanceOf[Anon_FuncMax]
  }
}
