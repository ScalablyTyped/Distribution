...
trait Anon_01ArgCountFFuncNotation extends js.Object {
  var argCount: `1`
...
object Anon_01ArgCountFFuncNotation {
  @scala.inline
  def apply(
    argCount: `1`,
    ...
    __obj.asInstanceOf[Anon_01ArgCountFFuncNotation]
  }
}
