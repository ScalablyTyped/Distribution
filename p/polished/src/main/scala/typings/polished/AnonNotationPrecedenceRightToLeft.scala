...
trait AnonNotationPrecedenceRightToLeft extends js.Object {
  var argCount: `1`
...
object AnonNotationPrecedenceRightToLeft {
  @scala.inline
  def apply(
    argCount: `1`,
    ...
    rightToLeft: `0`,
    symbol: max
  ): AnonNotationPrecedenceRightToLeft = {
    ...
    __obj.asInstanceOf[AnonNotationPrecedenceRightToLeft]
  }
}
