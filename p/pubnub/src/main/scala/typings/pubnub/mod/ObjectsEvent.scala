...
import typings.pubnub.anon.DataUUIDMetadataObject
...
object ObjectsEvent {
  ...
  inline def RemoveChannelMetadataEvent(channel: String, message: Event, timetoken: Double): typings.pubnub.mod.RemoveChannelMetadataEvent = {
  ...
  inline def RemoveMembershipEvent(channel: String, message: DataEvent, timetoken: Double): typings.pubnub.mod.RemoveMembershipEvent = {
    val __obj = js.Dynamic.literal(channel = channel.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], timetoken = timetoken.asInstanceOf[js.Any], subscription = null)
    __obj.asInstanceOf[typings.pubnub.mod.RemoveMembershipEvent]
  }
  
  inline def RemoveUUIDMetadataEvent(channel: String, message: EventType, timetoken: Double): typings.pubnub.mod.RemoveUUIDMetadataEvent = {
    val __obj = js.Dynamic.literal(channel = channel.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], timetoken = timetoken.asInstanceOf[js.Any], subscription = null)
    __obj.asInstanceOf[typings.pubnub.mod.RemoveUUIDMetadataEvent]
  }
  
  inline def SetChannelMetadataEvent[ChannelCustom /* <: ObjectCustom */](channel: String, message: DataEventType[ChannelCustom], timetoken: Double): typings.pubnub.mod.SetChannelMetadataEvent[ChannelCustom] = {
    val __obj = js.Dynamic.literal(channel = channel.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], timetoken = timetoken.asInstanceOf[js.Any], subscription = null)
    __obj.asInstanceOf[typings.pubnub.mod.SetChannelMetadataEvent[ChannelCustom]]
  }
  
  inline def SetMembershipEvent[MembershipCustom /* <: ObjectCustom */](channel: String, message: DataCustom[MembershipCustom], timetoken: Double): typings.pubnub.mod.SetMembershipEvent[MembershipCustom] = {
    val __obj = js.Dynamic.literal(channel = channel.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], timetoken = timetoken.asInstanceOf[js.Any], subscription = null)
    __obj.asInstanceOf[typings.pubnub.mod.SetMembershipEvent[MembershipCustom]]
  }
  
  inline def SetUUIDMetadataEvent[UUIDCustom /* <: ObjectCustom */](channel: String, message: DataUUIDMetadataObject[UUIDCustom], timetoken: Double): typings.pubnub.mod.SetUUIDMetadataEvent[UUIDCustom] = {
    val __obj = js.Dynamic.literal(channel = channel.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], timetoken = timetoken.asInstanceOf[js.Any], subscription = null)
