...
object SetChannelMembersParameters {
  @scala.inline
  def apply[/* <: typings.pubnub.mod.ObjectCustom */ Custom](channel: String, uuids: js.Array[String | SetCustom[Custom]]): SetChannelMembersParameters[Custom] = {
  ...
  @scala.inline
  implicit class SetChannelMembersParametersOps[Self <: SetChannelMembersParameters[_], /* <: typings.pubnub.mod.ObjectCustom */ Custom] (val x: Self with SetChannelMembersParameters[Custom]) extends AnyVal {
    @scala.inline
