...
object SetChannelMetadataParameters {
  @scala.inline
  def apply[/* <: typings.pubnub.mod.ObjectCustom */ Custom](channel: String, data: ChannelMetadata[Custom]): SetChannelMetadataParameters[Custom] = {
  ...
  @scala.inline
  implicit class SetChannelMetadataParametersOps[Self <: SetChannelMetadataParameters[_], /* <: typings.pubnub.mod.ObjectCustom */ Custom] (val x: Self with SetChannelMetadataParameters[Custom]) extends AnyVal {
    @scala.inline
