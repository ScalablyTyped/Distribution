...
object SetChannelMetadataParameters {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SetChannelMetadataParameters[?], Custom /* <: ObjectCustom */] (val x: Self & SetChannelMetadataParameters[Custom]) extends AnyVal {
