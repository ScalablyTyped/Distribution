...
trait Pebble extends js.Object {
  /**
           ...
           */
  def addEventListener(`type`: java.lang.String, callback: js.Function1[/* e */ Event, scala.Unit]): scala.Unit = js.native
  /**
  ...
  def appGlanceReload(
    ...
    onSuccess: js.Function1[/* appGlanceSlices */ js.Array[AppGlanceSlice], scala.Unit],
    onFailure: js.Function1[/* appGlanceSlices */ js.Array[AppGlanceSlice], scala.Unit]
  ...
  /**
           ...
           * @return string
           */
  def getWatchToken(): java.lang.String = js.native
  /**
  ...
  /**
           ...
           * @see addEventListener
           */
  def off(`type`: java.lang.String, callback: js.Function1[/* e */ Event, scala.Unit]): scala.Unit = js.native
  /**
           ...
           * @param callback  A developer-defined function to receive any events of the type specified that occur.
           */
  def on(`type`: java.lang.String, callback: js.Function1[/* e */ Event, scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
           ...
           * @see addEventListener
           */
  def removeEventListener(`type`: java.lang.String, callback: js.Function1[/* e */ Event, scala.Unit]): scala.Unit = js.native
  /**
           ...
           * @return string
           */
  def sendAppMessage(jsonAppMessage: js.Object): java.lang.String = js.native
  /**
           * Send an AppMessage to the app running on the watch.
           * Messages should be in the form of JSON objects containing key-value pairs.
           * @param jsonAppMessage        A JSON object containing key-value pairs to send to the watch.
           ...
           * @return string
           */
  def sendAppMessage(jsonAppMessage: js.Object, callbackForAck: js.Function1[/* e */ AppMessageEvent, scala.Unit]): java.lang.String = js.native
  /**
           * Send an AppMessage to the app running on the watch.
           * Messages should be in the form of JSON objects containing key-value pairs.
           * @param jsonAppMessage        A JSON object containing key-value pairs to send to the watch.
  ...
  def sendAppMessage(
    ...
    callbackForAck: js.Function1[/* e */ AppMessageEvent, scala.Unit],
    callbackForNack: js.Function1[/* e */ AppMessageEvent, scala.Unit]
  ...
  /**
           ...
           */
  def showSimpleNotificationOnPebble(title: java.lang.String, body: java.lang.String): scala.Unit = js.native
  /**
  ...
  def timelineSubscribe(
    ...
    errorCb: js.Function1[/* errorString */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  def timelineSubscriptions(
    successCb: js.Function1[/* topics */ js.Array[java.lang.String], scala.Unit],
    errorCb: js.Function1[/* errorString */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  /**
