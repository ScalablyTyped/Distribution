package typings
package passportDashSamlLib.multiSamlStrategyMod.MultiSamlStrategyNs
...
trait MultiSamlConfig
  ...
  def getSamlOptions(req: expressLib.expressMod.eNs.Request, callback: SamlOptionsCallback): scala.Unit
}

object MultiSamlConfig {
  @scala.inline
  def apply(
    getSamlOptions: (expressLib.expressMod.eNs.Request, SamlOptionsCallback) => scala.Unit,
