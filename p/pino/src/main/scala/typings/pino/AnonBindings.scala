...
import typings.pino.mod.Bindings
...
trait AnonBindings extends js.Object {
  /**
    ...
    */
  var bindings: js.UndefOr[js.Function1[/* bindings */ Bindings, js.Object]] = js.undefined
  /**
...
object AnonBindings {
  @scala.inline
  def apply(
    bindings: /* bindings */ Bindings => js.Object = null,
